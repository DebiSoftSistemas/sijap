...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_del_proveedor"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_del_proveedor"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_del_proveedor']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_del_proveedor']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_del_proveedor']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_del_proveedor']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_del_proveedor']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_del_proveedor</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_del_proveedor']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_del_proveedor']['embutida_filho'] as $ind => $sc_init)
          {
