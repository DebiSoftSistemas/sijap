  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_fac_config_recargos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_fac_config_recargos_form();
	}
...
?>
  ...
  // ---------- Validate cr_id_
  function do_ajax_form_fac_config_recargos_validate_cr_id_(iNumLinha)
  {
    var nomeCampo_cr_id_ = "cr_id_" + iNumLinha;
    var var_cr_id_ = scAjaxGetFieldHidden(nomeCampo_cr_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_config_recargos_validate_cr_id_(var_cr_id_, iNumLinha, var_script_case_init, do_ajax_form_fac_config_recargos_validate_cr_id__cb);
  } // do_ajax_form_fac_config_recargos_validate_cr_id_

  function do_ajax_form_fac_config_recargos_validate_cr_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "cr_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "cr_id_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "cr_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "cr_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_config_recargos_validate_cr_id__cb

  // ---------- Validate cr_producto_
  function do_ajax_form_fac_config_recargos_validate_cr_producto_(iNumLinha)
  {
    var nomeCampo_cr_producto_ = "cr_producto_" + iNumLinha;
    var var_cr_producto_ = scAjaxGetFieldSelect(nomeCampo_cr_producto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_config_recargos_validate_cr_producto_(var_cr_producto_, iNumLinha, var_script_case_init, do_ajax_form_fac_config_recargos_validate_cr_producto__cb);
  } // do_ajax_form_fac_config_recargos_validate_cr_producto_

  function do_ajax_form_fac_config_recargos_validate_cr_producto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "cr_producto_" + iLineNumber;
    }
    else
    {
      sFieldValid = "cr_producto_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "cr_producto_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "cr_producto_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_config_recargos_validate_cr_producto__cb

  // ---------- Validate cr_motivo_
  function do_ajax_form_fac_config_recargos_validate_cr_motivo_(iNumLinha)
  {
    var nomeCampo_cr_motivo_ = "cr_motivo_" + iNumLinha;
    var var_cr_motivo_ = scAjaxGetFieldSelect(nomeCampo_cr_motivo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_config_recargos_validate_cr_motivo_(var_cr_motivo_, iNumLinha, var_script_case_init, do_ajax_form_fac_config_recargos_validate_cr_motivo__cb);
  } // do_ajax_form_fac_config_recargos_validate_cr_motivo_

  function do_ajax_form_fac_config_recargos_validate_cr_motivo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "cr_motivo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "cr_motivo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "cr_motivo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "cr_motivo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_config_recargos_validate_cr_motivo__cb

  // ---------- Validate cr_mes_
  function do_ajax_form_fac_config_recargos_validate_cr_mes_(iNumLinha)
  {
    var nomeCampo_cr_mes_ = "cr_mes_" + iNumLinha;
    var var_cr_mes_ = scAjaxGetFieldSelect(nomeCampo_cr_mes_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_config_recargos_validate_cr_mes_(var_cr_mes_, iNumLinha, var_script_case_init, do_ajax_form_fac_config_recargos_validate_cr_mes__cb);
  } // do_ajax_form_fac_config_recargos_validate_cr_mes_

  function do_ajax_form_fac_config_recargos_validate_cr_mes__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "cr_mes_" + iLineNumber;
    }
    else
    {
      sFieldValid = "cr_mes_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "cr_mes_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "cr_mes_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_config_recargos_validate_cr_mes__cb

  // ---------- Validate cr_anio_
  function do_ajax_form_fac_config_recargos_validate_cr_anio_(iNumLinha)
  {
    var nomeCampo_cr_anio_ = "cr_anio_" + iNumLinha;
    var var_cr_anio_ = scAjaxGetFieldSelect(nomeCampo_cr_anio_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_config_recargos_validate_cr_anio_(var_cr_anio_, iNumLinha, var_script_case_init, do_ajax_form_fac_config_recargos_validate_cr_anio__cb);
  } // do_ajax_form_fac_config_recargos_validate_cr_anio_

  function do_ajax_form_fac_config_recargos_validate_cr_anio__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "cr_anio_" + iLineNumber;
    }
    else
    {
      sFieldValid = "cr_anio_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "cr_anio_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "cr_anio_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_config_recargos_validate_cr_anio__cb

  // ---------- Validate cr_valor_
  function do_ajax_form_fac_config_recargos_validate_cr_valor_(iNumLinha)
  {
    var nomeCampo_cr_valor_ = "cr_valor_" + iNumLinha;
    var var_cr_valor_ = scAjaxGetFieldText(nomeCampo_cr_valor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_config_recargos_validate_cr_valor_(var_cr_valor_, iNumLinha, var_script_case_init, do_ajax_form_fac_config_recargos_validate_cr_valor__cb);
  } // do_ajax_form_fac_config_recargos_validate_cr_valor_

  function do_ajax_form_fac_config_recargos_validate_cr_valor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "cr_valor_" + iLineNumber;
    }
    else
    {
      sFieldValid = "cr_valor_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "cr_valor_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "cr_valor_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_config_recargos_validate_cr_valor__cb

  // ---------- Validate cr_tipo_
  function do_ajax_form_fac_config_recargos_validate_cr_tipo_(iNumLinha)
  {
    var nomeCampo_cr_tipo_ = "cr_tipo_" + iNumLinha;
    var var_cr_tipo_ = scAjaxGetFieldSelect(nomeCampo_cr_tipo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_config_recargos_validate_cr_tipo_(var_cr_tipo_, iNumLinha, var_script_case_init, do_ajax_form_fac_config_recargos_validate_cr_tipo__cb);
  } // do_ajax_form_fac_config_recargos_validate_cr_tipo_

  function do_ajax_form_fac_config_recargos_validate_cr_tipo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "cr_tipo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "cr_tipo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "cr_tipo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "cr_tipo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_config_recargos_validate_cr_tipo__cb

  // ---------- Validate cr_producto_aplica_
  function do_ajax_form_fac_config_recargos_validate_cr_producto_aplica_(iNumLinha)
  {
    var nomeCampo_cr_producto_aplica_ = "cr_producto_aplica_" + iNumLinha;
    var var_cr_producto_aplica_ = scAjaxGetFieldSelect(nomeCampo_cr_producto_aplica_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_config_recargos_validate_cr_producto_aplica_(var_cr_producto_aplica_, iNumLinha, var_script_case_init, do_ajax_form_fac_config_recargos_validate_cr_producto_aplica__cb);
  } // do_ajax_form_fac_config_recargos_validate_cr_producto_aplica_

  function do_ajax_form_fac_config_recargos_validate_cr_producto_aplica__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "cr_producto_aplica_" + iLineNumber;
    }
    else
    {
      sFieldValid = "cr_producto_aplica_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "cr_producto_aplica_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "cr_producto_aplica_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_config_recargos_validate_cr_producto_aplica__cb

  // ---------- Validate cr_estado_
  function do_ajax_form_fac_config_recargos_validate_cr_estado_(iNumLinha)
  {
    var nomeCampo_cr_estado_ = "cr_estado_" + iNumLinha;
    var var_cr_estado_ = scAjaxGetFieldSelect(nomeCampo_cr_estado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_config_recargos_validate_cr_estado_(var_cr_estado_, iNumLinha, var_script_case_init, do_ajax_form_fac_config_recargos_validate_cr_estado__cb);
  } // do_ajax_form_fac_config_recargos_validate_cr_estado_

  function do_ajax_form_fac_config_recargos_validate_cr_estado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "cr_estado_" + iLineNumber;
    }
    else
    {
      sFieldValid = "cr_estado_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "cr_estado_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "cr_estado_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_config_recargos_validate_cr_estado__cb

  // ---------- Validate cr_empresa_
  function do_ajax_form_fac_config_recargos_validate_cr_empresa_(iNumLinha)
  {
    var nomeCampo_cr_empresa_ = "cr_empresa_" + iNumLinha;
    var var_cr_empresa_ = scAjaxGetFieldText(nomeCampo_cr_empresa_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_config_recargos_validate_cr_empresa_(var_cr_empresa_, iNumLinha, var_script_case_init, do_ajax_form_fac_config_recargos_validate_cr_empresa__cb);
  } // do_ajax_form_fac_config_recargos_validate_cr_empresa_

  function do_ajax_form_fac_config_recargos_validate_cr_empresa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "cr_empresa_" + iLineNumber;
    }
    else
    {
      sFieldValid = "cr_empresa_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "cr_empresa_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "cr_empresa_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_config_recargos_validate_cr_empresa__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_fac_config_recargos_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_fac_config_recargos_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_fac_config_recargos_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_fac_config_recargos_add_new_line_cb);
  } // do_ajax_form_fac_config_recargos_add_new_line

  function do_ajax_form_fac_config_recargos_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_fac_config_recargos_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_fac_config_recargos_backup_line(iNumLinha)
  {
    var var_cr_id_ = scAjaxGetFieldHidden("cr_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_config_recargos_backup_line(var_cr_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_fac_config_recargos_backup_line_cb);
  } // do_ajax_form_fac_config_recargos_backup_line

  function do_ajax_form_fac_config_recargos_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_fac_config_recargos_backup_line_cb

  function do_ajax_form_fac_config_recargos_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_fac_config_recargos_cancel_insert

  function do_ajax_form_fac_config_recargos_cancel_update(iSeqVert)
  {
    do_ajax_form_fac_config_recargos_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_fac_config_recargos_cancel_update

  function do_ajax_form_fac_config_recargos_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_fac_config_recargos_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_fac_config_recargos_table_refresh()
  {
    var var_cr_id_ = document.F2.cr_id_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_fac_config_recargos_table_refresh(var_cr_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_config_recargos_table_refresh_cb);
  } //  do_ajax_form_fac_config_recargos_table_refresh

  function do_ajax_form_fac_config_recargos_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.cr_id_.value = scAjaxGetKeyValue("cr_id_");
    ...
    scAjaxAlert(do_ajax_form_fac_config_recargos_table_refresh_cb_after_alert);
  } // do_ajax_form_fac_config_recargos_table_refresh_cb
  function do_ajax_form_fac_config_recargos_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_fac_config_recargos_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_fac_config_recargos_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_fac_config_recargos_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_cr_id_ = scAjaxGetFieldHidden("cr_id_" + iNumLinha);
    var var_cr_producto_ = scAjaxGetFieldSelect("cr_producto_" + iNumLinha);
    var var_cr_motivo_ = scAjaxGetFieldSelect("cr_motivo_" + iNumLinha);
    var var_cr_mes_ = scAjaxGetFieldSelect("cr_mes_" + iNumLinha);
    var var_cr_anio_ = scAjaxGetFieldSelect("cr_anio_" + iNumLinha);
    var var_cr_valor_ = scAjaxGetFieldText("cr_valor_" + iNumLinha);
    var var_cr_tipo_ = scAjaxGetFieldSelect("cr_tipo_" + iNumLinha);
    var var_cr_producto_aplica_ = scAjaxGetFieldSelect("cr_producto_aplica_" + iNumLinha);
    var var_cr_estado_ = scAjaxGetFieldSelect("cr_estado_" + iNumLinha);
    var var_cr_empresa_ = scAjaxGetFieldText("cr_empresa_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_fac_config_recargos_submit_form(var_cr_id_, var_cr_producto_, var_cr_motivo_, var_cr_mes_, var_cr_anio_, var_cr_valor_, var_cr_tipo_, var_cr_producto_aplica_, var_cr_estado_, var_cr_empresa_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_fac_config_recargos_submit_form_cb);
  } // do_ajax_form_fac_config_recargos_submit_form

  function do_ajax_form_fac_config_recargos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("cr_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("cr_producto_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("cr_motivo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("cr_mes_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("cr_anio_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("cr_valor_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("cr_tipo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("cr_producto_aplica_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("cr_estado_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("cr_empresa_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_fac_config_recargos_submit_form_cb_after_alert);
  } // do_ajax_form_fac_config_recargos_submit_form_cb
  function do_ajax_form_fac_config_recargos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_fac_config_recargos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_fac_config_recargos_navigate_form()
  {
    perform_ajax_form_fac_config_recargos_navigate_form();
  }

  function perform_ajax_form_fac_config_recargos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_fac_config_recargos_cancel_insert(sc_form_fac_config_recargos_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("cr_id_" + iNavForm);
      scAjaxHideErrorDisplay("cr_producto_" + iNavForm);
      scAjaxHideErrorDisplay("cr_motivo_" + iNavForm);
      scAjaxHideErrorDisplay("cr_mes_" + iNavForm);
      scAjaxHideErrorDisplay("cr_anio_" + iNavForm);
      scAjaxHideErrorDisplay("cr_valor_" + iNavForm);
      scAjaxHideErrorDisplay("cr_tipo_" + iNavForm);
      scAjaxHideErrorDisplay("cr_producto_aplica_" + iNavForm);
      scAjaxHideErrorDisplay("cr_estado_" + iNavForm);
      scAjaxHideErrorDisplay("cr_empresa_" + iNavForm);
    }
    var var_cr_id_ = document.F2.cr_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_fac_config_recargos_navigate_form(var_cr_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_config_recargos_navigate_form_cb);
  } // do_ajax_form_fac_config_recargos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_config_recargos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_fac_config_recargos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.cr_id_.value = scAjaxGetKeyValue("cr_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_fac_config_recargos_navigate_form_cb_after_alert);
  } // do_ajax_form_fac_config_recargos_navigate_form_cb
  function do_ajax_form_fac_config_recargos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_fac_config_recargos_navigate_form_cb_after_alert

    function sc_form_fac_config_recargos_get_last_line_number()
    {
    ...
    } //sc_form_fac_config_recargos_get_last_line_number

  function sc_hide_form_fac_config_recargos_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "cr_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "cr_producto_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "cr_motivo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "cr_mes_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "cr_anio_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "cr_valor_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "cr_tipo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "cr_producto_aplica_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "cr_estado_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "cr_empresa_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["cr_id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["cr_producto_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_producto'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["cr_motivo_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_motivo'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["cr_mes_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_per_month'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["cr_anio_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_srch_year'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["cr_valor_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_valor'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["cr_tipo_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tipo'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["cr_producto_aplica_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_producto_aplica'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["cr_estado_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["cr_empresa_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_empresa'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["cr_id_"][iNumLinha] = "cr_id_" + iNumLinha;
    ajax_field_mult["cr_producto_"][iNumLinha] = "cr_producto_" + iNumLinha;
    ajax_field_mult["cr_motivo_"][iNumLinha] = "cr_motivo_" + iNumLinha;
    ajax_field_mult["cr_mes_"][iNumLinha] = "cr_mes_" + iNumLinha;
    ajax_field_mult["cr_anio_"][iNumLinha] = "cr_anio_" + iNumLinha;
    ajax_field_mult["cr_valor_"][iNumLinha] = "cr_valor_" + iNumLinha;
    ajax_field_mult["cr_tipo_"][iNumLinha] = "cr_tipo_" + iNumLinha;
    ajax_field_mult["cr_producto_aplica_"][iNumLinha] = "cr_producto_aplica_" + iNumLinha;
    ajax_field_mult["cr_estado_"][iNumLinha] = "cr_estado_" + iNumLinha;
    ajax_field_mult["cr_empresa_"][iNumLinha] = "cr_empresa_" + iNumLinha;
    ajax_field_id["cr_producto_" + iNumLinha] = new Array("hidden_field_label_cr_producto_", "hidden_field_data_cr_producto_" + iNumLinha);
    ajax_field_id["cr_motivo_" + iNumLinha] = new Array("hidden_field_label_cr_motivo_", "hidden_field_data_cr_motivo_" + iNumLinha);
    ajax_field_id["cr_mes_" + iNumLinha] = new Array("hidden_field_label_cr_mes_", "hidden_field_data_cr_mes_" + iNumLinha);
    ajax_field_id["cr_anio_" + iNumLinha] = new Array("hidden_field_label_cr_anio_", "hidden_field_data_cr_anio_" + iNumLinha);
    ajax_field_id["cr_valor_" + iNumLinha] = new Array("hidden_field_label_cr_valor_", "hidden_field_data_cr_valor_" + iNumLinha);
    ajax_field_id["cr_tipo_" + iNumLinha] = new Array("hidden_field_label_cr_tipo_", "hidden_field_data_cr_tipo_" + iNumLinha);
    ajax_field_id["cr_producto_aplica_" + iNumLinha] = new Array("hidden_field_label_cr_producto_aplica_", "hidden_field_data_cr_producto_aplica_" + iNumLinha);
    ajax_field_id["cr_estado_" + iNumLinha] = new Array("hidden_field_label_cr_estado_", "hidden_field_data_cr_estado_" + iNumLinha);
    ajax_error_count["cr_id_" + iNumLinha] = "off";
    ajax_error_count["cr_producto_" + iNumLinha] = "off";
    ajax_error_count["cr_motivo_" + iNumLinha] = "off";
    ajax_error_count["cr_mes_" + iNumLinha] = "off";
    ajax_error_count["cr_anio_" + iNumLinha] = "off";
    ajax_error_count["cr_valor_" + iNumLinha] = "off";
    ajax_error_count["cr_tipo_" + iNumLinha] = "off";
    ajax_error_count["cr_producto_aplica_" + iNumLinha] = "off";
    ajax_error_count["cr_estado_" + iNumLinha] = "off";
    ajax_error_count["cr_empresa_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["cr_id_" + iNumLinha] = "on";
    ajax_read_only["cr_producto_" + iNumLinha] = "off";
    ajax_read_only["cr_motivo_" + iNumLinha] = "off";
    ajax_read_only["cr_mes_" + iNumLinha] = "off";
    ajax_read_only["cr_anio_" + iNumLinha] = "off";
    ajax_read_only["cr_valor_" + iNumLinha] = "off";
    ajax_read_only["cr_tipo_" + iNumLinha] = "off";
    ajax_read_only["cr_producto_aplica_" + iNumLinha] = "off";
    ajax_read_only["cr_estado_" + iNumLinha] = "off";
    ajax_read_only["cr_empresa_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["cr_id_" + iNumLinha] = "on";
    ajax_read_only["cr_producto_" + iNumLinha] = "on";
    ajax_read_only["cr_motivo_" + iNumLinha] = "on";
    ajax_read_only["cr_mes_" + iNumLinha] = "on";
    ajax_read_only["cr_anio_" + iNumLinha] = "on";
    ajax_read_only["cr_valor_" + iNumLinha] = "on";
    ajax_read_only["cr_tipo_" + iNumLinha] = "on";
    ajax_read_only["cr_producto_aplica_" + iNumLinha] = "on";
    ajax_read_only["cr_estado_" + iNumLinha] = "on";
    ajax_read_only["cr_empresa_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["cr_id_" + iNumLinha] = null;
    ajax_error_list["cr_producto_" + iNumLinha] = null;
    ajax_error_list["cr_motivo_" + iNumLinha] = null;
    ajax_error_list["cr_mes_" + iNumLinha] = null;
    ajax_error_list["cr_anio_" + iNumLinha] = null;
    ajax_error_list["cr_valor_" + iNumLinha] = null;
    ajax_error_list["cr_tipo_" + iNumLinha] = null;
    ajax_error_list["cr_producto_aplica_" + iNumLinha] = null;
    ajax_error_list["cr_estado_" + iNumLinha] = null;
    ajax_error_list["cr_empresa_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "cr_id_": new Array(),
    "cr_producto_": new Array(),
    "cr_motivo_": new Array(),
    "cr_mes_": new Array(),
    "cr_anio_": new Array(),
    "cr_valor_": new Array(),
    "cr_tipo_": new Array(),
    "cr_producto_aplica_": new Array(),
    "cr_estado_": new Array(),
    "cr_empresa_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["cr_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["cr_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["cr_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["cr_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["cr_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["cr_producto_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["cr_producto_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["cr_producto_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["cr_producto_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["cr_producto_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["cr_motivo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["cr_motivo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["cr_motivo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["cr_motivo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["cr_motivo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["cr_mes_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["cr_mes_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["cr_mes_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["cr_mes_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["cr_mes_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["cr_anio_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["cr_anio_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["cr_anio_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["cr_anio_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["cr_anio_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["cr_valor_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["cr_valor_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["cr_valor_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["cr_valor_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["cr_valor_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["cr_tipo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["cr_tipo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["cr_tipo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["cr_tipo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["cr_tipo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["cr_producto_aplica_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["cr_producto_aplica_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["cr_producto_aplica_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["cr_producto_aplica_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["cr_producto_aplica_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["cr_estado_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["cr_estado_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["cr_estado_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["cr_estado_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["cr_estado_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["cr_empresa_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["cr_empresa_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["cr_empresa_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["cr_empresa_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["cr_empresa_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['cr_id_'])) ? $this->nmgp_cmp_readonly['cr_id_'] : 'on';
?>
    scAjaxFieldRead("cr_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['cr_producto_'])) ? $this->nmgp_cmp_readonly['cr_producto_'] : 'off';
?>
    scAjaxFieldRead("cr_producto_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['cr_motivo_'])) ? $this->nmgp_cmp_readonly['cr_motivo_'] : 'off';
?>
    scAjaxFieldRead("cr_motivo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['cr_mes_'])) ? $this->nmgp_cmp_readonly['cr_mes_'] : 'off';
?>
    scAjaxFieldRead("cr_mes_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['cr_anio_'])) ? $this->nmgp_cmp_readonly['cr_anio_'] : 'off';
?>
    scAjaxFieldRead("cr_anio_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['cr_valor_'])) ? $this->nmgp_cmp_readonly['cr_valor_'] : 'off';
?>
    scAjaxFieldRead("cr_valor_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['cr_tipo_'])) ? $this->nmgp_cmp_readonly['cr_tipo_'] : 'off';
?>
    scAjaxFieldRead("cr_tipo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['cr_producto_aplica_'])) ? $this->nmgp_cmp_readonly['cr_producto_aplica_'] : 'off';
?>
    scAjaxFieldRead("cr_producto_aplica_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['cr_estado_'])) ? $this->nmgp_cmp_readonly['cr_estado_'] : 'off';
?>
    scAjaxFieldRead("cr_estado_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['cr_empresa_'])) ? $this->nmgp_cmp_readonly['cr_empresa_'] : 'off';
?>
    scAjaxFieldRead("cr_empresa_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("cr_id_" + iSeq, "on");
    scAjaxFieldRead("cr_producto_" + iSeq, "on");
    scAjaxFieldRead("cr_motivo_" + iSeq, "on");
    scAjaxFieldRead("cr_mes_" + iSeq, "on");
    scAjaxFieldRead("cr_anio_" + iSeq, "on");
    scAjaxFieldRead("cr_valor_" + iSeq, "on");
    scAjaxFieldRead("cr_tipo_" + iSeq, "on");
    scAjaxFieldRead("cr_producto_aplica_" + iSeq, "on");
    scAjaxFieldRead("cr_estado_" + iSeq, "on");
    scAjaxFieldRead("cr_empresa_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["cr_id_" + iRow] || "on" == ajax_error_count["cr_producto_" + iRow] || "on" == ajax_error_count["cr_motivo_" + iRow] || "on" == ajax_error_count["cr_mes_" + iRow] || "on" == ajax_error_count["cr_anio_" + iRow] || "on" == ajax_error_count["cr_valor_" + iRow] || "on" == ajax_error_count["cr_tipo_" + iRow] || "on" == ajax_error_count["cr_producto_aplica_" + iRow] || "on" == ajax_error_count["cr_estado_" + iRow] || "on" == ajax_error_count["cr_empresa_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_cr_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_cr_producto_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_cr_motivo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_cr_mes_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_cr_anio_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_cr_valor_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_cr_tipo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_cr_producto_aplica_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_cr_estado_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_cr_empresa_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["cr_id_" + iRow] && "off" == ajax_error_count["cr_producto_" + iRow] && "off" == ajax_error_count["cr_motivo_" + iRow] && "off" == ajax_error_count["cr_mes_" + iRow] && "off" == ajax_error_count["cr_anio_" + iRow] && "off" == ajax_error_count["cr_valor_" + iRow] && "off" == ajax_error_count["cr_tipo_" + iRow] && "off" == ajax_error_count["cr_producto_aplica_" + iRow] && "off" == ajax_error_count["cr_estado_" + iRow] && "off" == ajax_error_count["cr_empresa_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["cr_id_" + iRow] = "off";
        ajax_error_count["cr_producto_" + iRow] = "off";
        ajax_error_count["cr_motivo_" + iRow] = "off";
        ajax_error_count["cr_mes_" + iRow] = "off";
        ajax_error_count["cr_anio_" + iRow] = "off";
        ajax_error_count["cr_valor_" + iRow] = "off";
        ajax_error_count["cr_tipo_" + iRow] = "off";
        ajax_error_count["cr_producto_aplica_" + iRow] = "off";
        ajax_error_count["cr_estado_" + iRow] = "off";
        ajax_error_count["cr_empresa_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_cr_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_cr_producto_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_cr_motivo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_cr_mes_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_cr_anio_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_cr_valor_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_cr_tipo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_cr_producto_aplica_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_cr_estado_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_cr_empresa_" + iRow).removeClass("scFormErrorLine");
    }
  }
