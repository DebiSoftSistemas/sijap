<?php
@session_start() ;
$_SESSION['scriptcase']['grid_sis_tipo_firma']['sc_process_barr'] = true;
require_once('../grid_sis_tipo_firma/index.php');
unset($_SESSION['scriptcase']['grid_sis_tipo_firma']['sc_process_barr']);
$ExportCtrl = new grid_sis_tipo_firma_export_control;
$ExportCtrl->Export_barr();

class grid_sis_tipo_firma_export_control
{
