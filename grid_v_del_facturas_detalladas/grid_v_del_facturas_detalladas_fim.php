...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_v_del_facturas_detalladas"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_v_del_facturas_detalladas"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_v_del_facturas_detalladas']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_v_del_facturas_detalladas']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_v_del_facturas_detalladas']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_v_del_facturas_detalladas']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_v_del_facturas_detalladas']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_v_del_facturas_detalladas</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_v_del_facturas_detalladas']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_v_del_facturas_detalladas']['embutida_filho'] as $ind => $sc_init)
          {
