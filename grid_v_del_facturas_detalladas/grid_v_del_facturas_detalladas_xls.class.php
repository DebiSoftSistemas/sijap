...
class grid_v_del_facturas_detalladas_xls
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_v_del_facturas_detalladas/grid_v_del_facturas_detalladas_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              ...
              $this->Res_xls = new grid_v_del_facturas_detalladas_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_v_del_facturas_detalladas.zip";
          $this->Arquivo   .= "_grid_v_del_facturas_detalladas" . $this->Xls_tp;
          $this->Tit_doc    = "grid_v_del_facturas_detalladas" . $this->Xls_tp;
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
...
$_SESSION['scriptcase']['grid_v_del_facturas_detalladas']['contr_erro'] = 'off';
      ...
      while (!$rs->EOF)
      {
         ...
         $this->fac_asiento = $rs->fields[25] ;  
         $this->fac_usuario = $rs->fields[26] ;  
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['SC_Gb_Free_orig']))
         {
             foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['SC_Gb_Free_orig'] as $Cmp_clone => $Cmp_orig)
             {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['SC_Ind_Groupby'] == "sc_free_group_by")
         {
             ...
             {
                 $Cmp_orig = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
         ...
         $this->arg_sum_fac_usuario = " = " . $this->Db->qstr($this->fac_usuario);
          ...
          {  
              $SC_arg_Gby = array();
              $SC_arg_Sql = array();
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['SC_Gb_Free_cmp'] as $cmp => $sql)
              {
                  $Cmp_orig   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['SC_Gb_Free_orig'][$cmp])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['SC_Gb_Free_orig'][$cmp] : $cmp;
              ...
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['SC_Gb_Free_cmp'] as $cmp => $sql)
              {
                  $Format_tst = $this->Ini->Get_Gb_date_format('sc_free_group_by', $cmp);
                  $SC_arg_Sql[$cmp] = $sql;
                  $Fun_GB  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['SC_Gb_Free_orig'][$cmp])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['SC_Gb_Free_orig'][$cmp] : $cmp;
                  if (!empty($Format_tst))
                  {
                      $temp = $this->$cmp;
                      if (!empty($temp))
              ...
              $this->Nivel_gbBot = count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['SC_Gb_Free_cmp']);
              krsort ($SC_lst_Gby);
              foreach ($SC_lst_Gby as $Ind => $cmp)
              {
                  ...
                  $sql_where = "";
                  $cmp_qb     = $this->$cmp;
                  foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['SC_Gb_Free_cmp'] as $Col_Gb => $Sql)
                  {
                      $tmp        = "arg_sum_" . $Col_Gb;
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['embutida'])
      { 
      ...
      if ($this->groupby_show == "S") {
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['SC_Ind_Groupby'] == "sc_free_group_by")
       {
          ...
          $this->Xls_col = 0;
          $this->Xls_row++;
          $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['SC_Ind_Groupby'] . "_bot";
          $this->$Gb_geral();
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['embutida'])
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['nolabel'])
       {
 ...
 function quebra_anio_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
 ...
 function quebra_fac_secuencial_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   $this->sum_fac_secuencial_df_subtotal = $tot_fac_secuencial[2];
   $this->sum_fac_secuencial_df_descuento = $tot_fac_secuencial[3];
   $this->sum_fac_secuencial_df_base_iva = $tot_fac_secuencial[4];
   $this->sum_fac_secuencial_df_valor_iva = $tot_fac_secuencial[5];
   $this->sum_fac_secuencial_df_total = $tot_fac_secuencial[6];
   $this->sum_fac_secuencial_df_valor_ice = $tot_fac_secuencial[7];
   $this->sum_fac_secuencial_df_valor_irbpnr = $tot_fac_secuencial[8];
   $Temp_cmp_quebra = array(); 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
 ...
 function quebra_fac_usuario_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
     ...
     foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
     {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['field_order'] as $Cada_cmp)
       {
           ...
           elseif (!isset($this->NM_cmp_hidden[$Cada_cmp]) || $this->NM_cmp_hidden[$Cada_cmp] != "off")
           {
               ...
               elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['embutida']) {
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
     ...
     foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
     {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['field_order'] as $Cada_cmp)
       {
           if (isset($NM_cmp_tot['df_subtotal'][$Tipo_Sum]) && $Cada_cmp == "df_subtotal" && (!isset($this->NM_cmp_hidden['df_subtotal']) || $this->NM_cmp_hidden['df_subtotal'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_subtotal'][$Tipo_Sum] . "fac_secuencial_df_subtotal";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_descuento'][$Tipo_Sum]) && $Cada_cmp == "df_descuento" && (!isset($this->NM_cmp_hidden['df_descuento']) || $this->NM_cmp_hidden['df_descuento'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_descuento'][$Tipo_Sum] . "fac_secuencial_df_descuento";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_base_iva'][$Tipo_Sum]) && $Cada_cmp == "df_base_iva" && (!isset($this->NM_cmp_hidden['df_base_iva']) || $this->NM_cmp_hidden['df_base_iva'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_base_iva'][$Tipo_Sum] . "fac_secuencial_df_base_iva";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_valor_iva'][$Tipo_Sum]) && $Cada_cmp == "df_valor_iva" && (!isset($this->NM_cmp_hidden['df_valor_iva']) || $this->NM_cmp_hidden['df_valor_iva'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_valor_iva'][$Tipo_Sum] . "fac_secuencial_df_valor_iva";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_total'][$Tipo_Sum]) && $Cada_cmp == "df_total" && (!isset($this->NM_cmp_hidden['df_total']) || $this->NM_cmp_hidden['df_total'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_total'][$Tipo_Sum] . "fac_secuencial_df_total";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_valor_ice'][$Tipo_Sum]) && $Cada_cmp == "df_valor_ice" && (!isset($this->NM_cmp_hidden['df_valor_ice']) || $this->NM_cmp_hidden['df_valor_ice'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_valor_ice'][$Tipo_Sum] . "fac_secuencial_df_valor_ice";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['df_valor_irbpnr'][$Tipo_Sum]) && $Cada_cmp == "df_valor_irbpnr" && (!isset($this->NM_cmp_hidden['df_valor_irbpnr']) || $this->NM_cmp_hidden['df_valor_irbpnr'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['df_valor_irbpnr'][$Tipo_Sum] . "fac_secuencial_df_valor_irbpnr";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['embutida']) {
   ...
   function quebra_geral_sc_free_group_by_bot()
   {
       ...
       $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . '');
       $mens_tot_base = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['tot_geral'][1] . ")";
       $prim_lin_tot  = true;
     foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
     {
       $mens_tot      = $mens_tot_base . " - " . $Tit_sum;
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['field_order'] as $Cada_cmp)
       {
           if (isset($NM_cmp_tot['df_subtotal'][$Tipo_Sum]) && $Cada_cmp == "df_subtotal" && (!isset($this->NM_cmp_hidden['df_subtotal']) || $this->NM_cmp_hidden['df_subtotal'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['tot_geral'][$NM_cmp_tot['df_subtotal'][$Tipo_Sum]];
               $prim_cmp = false;
           ...
           elseif (isset($NM_cmp_tot['df_descuento'][$Tipo_Sum]) && $Cada_cmp == "df_descuento" && (!isset($this->NM_cmp_hidden['df_descuento']) || $this->NM_cmp_hidden['df_descuento'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['tot_geral'][$NM_cmp_tot['df_descuento'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           elseif (isset($NM_cmp_tot['df_base_iva'][$Tipo_Sum]) && $Cada_cmp == "df_base_iva" && (!isset($this->NM_cmp_hidden['df_base_iva']) || $this->NM_cmp_hidden['df_base_iva'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['tot_geral'][$NM_cmp_tot['df_base_iva'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           elseif (isset($NM_cmp_tot['df_valor_iva'][$Tipo_Sum]) && $Cada_cmp == "df_valor_iva" && (!isset($this->NM_cmp_hidden['df_valor_iva']) || $this->NM_cmp_hidden['df_valor_iva'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['tot_geral'][$NM_cmp_tot['df_valor_iva'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           elseif (isset($NM_cmp_tot['df_total'][$Tipo_Sum]) && $Cada_cmp == "df_total" && (!isset($this->NM_cmp_hidden['df_total']) || $this->NM_cmp_hidden['df_total'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['tot_geral'][$NM_cmp_tot['df_total'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           elseif (isset($NM_cmp_tot['df_valor_ice'][$Tipo_Sum]) && $Cada_cmp == "df_valor_ice" && (!isset($this->NM_cmp_hidden['df_valor_ice']) || $this->NM_cmp_hidden['df_valor_ice'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['tot_geral'][$NM_cmp_tot['df_valor_ice'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           elseif (isset($NM_cmp_tot['df_valor_irbpnr'][$Tipo_Sum]) && $Cada_cmp == "df_valor_irbpnr" && (!isset($this->NM_cmp_hidden['df_valor_irbpnr']) || $this->NM_cmp_hidden['df_valor_irbpnr'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['tot_geral'][$NM_cmp_tot['df_valor_irbpnr'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['xls_file'] = $this->Xls_f;
      }
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_facturas_detalladas']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
