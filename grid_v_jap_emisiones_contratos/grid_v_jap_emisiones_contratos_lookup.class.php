<?php
class grid_v_jap_emisiones_contratos_lookup
{
//  
   function lookup_mes_periodo(&$conteudo , $mes_periodo) 
   {   
      static $save_conteudo = "" ; 
      static $save_conteudo1 = "" ; 
      $tst_cache = $mes_periodo; 
      ...
      $nm_comando = "select dec_nombre from v_sis_meses where dec_id = '" . substr($this->Db->qstr($mes_periodo), 1 , -1) . "' order by dec_nombre" ; 
      $conteudo = "" ; 
...
//  
   function lookup_sc_free_group_by_mes_periodo(&$conteudo , $mes_periodo) 
   {   
      static $save_conteudo = "" ; 
      static $save_conteudo1 = "" ; 
      $tst_cache = $mes_periodo; 
