...
class grid_v_jap_emisiones_contratos_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_v_jap_emisiones_contratos']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_v_jap_emisiones_contratos']['campos_busca']))
      { 
   ...
   {
      global $nm_lang, $detalle_deuda;
      $this->nm_data = new nm_data("es");
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['sql_tot_res']);
      ...
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('anio_periodo' => "anio_periodo",'mes_periodo' => "mes_periodo",'cl_nombre' => "cl_nombre",'cl_identificacion' => "cl_identificacion",'cl_telefono' => "cl_telefono",'cl_celular' => "cl_celular",'cl_email' => "cl_email",'con_ruta' => "con_ruta",'op_estado' => "op_estado");
      $cmps_quebra_atual = array();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['SC_Gb_Free_cmp'] as $cmp => $resto)
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['arr_total'] = array();
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['arr_total'][$cmp_gb] = $this->$Arr_tot_name;
      }
   }
   ...
   function Res_Totaliza_sc_free_group_by($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def, $res_export)
   {
      ...
      $cmp_sql_tp_num = array('con_tipo_contrato' => 'N','con_ruta' => 'N','con_propietario' => 'N','con_id' => 'N','con_tipo_servicio' => 'N','con_condicion_contrato' => 'N','total' => 'N','op_operacion' => 'N');
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['sql_tot_res']))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['sql_tot_res'] = str_replace("#@#cmps_quebras#@#", "", $comando);
      }
      $comando  = str_replace("#@#cmps_quebras#@#", "," . $cmps_quebras, $comando);
      $comando .= " group by " . $cmps_quebras . " order by " .  $cmps_quebras;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['Res_search_metric_use']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['Res_search_metric_use']))
      {
          $comando = $cmd_simp;
          $cmps_S  = "";
      ...
      $format_dimensions['anio_periodo']['reg'] = "S";
      $format_dimensions['anio_periodo']['msk'] = "";
      $format_dimensions['mes_periodo']['reg'] = "S";
      $format_dimensions['mes_periodo']['msk'] = "";
      ...
      while (!$rt->EOF)
      {
          ...
          foreach ($Cmp_dim as $Cada_dim => $Ind_sql)
          {
              ...
              if ($Cada_dim == "anio_periodo") {
              }
              if ($Cada_dim == "mes_periodo") {
                  $this->Lookup->lookup_sc_free_group_by_mes_periodo($$Cada_dim,  $mes_periodo);
              }
   ...
   {
      global $nada, $nm_lang , $mes_periodo, $op_estado, $con_tipo_contrato, $con_ruta, $con_tipo_servicio, $con_condicion_contrato;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(total) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['where_pesq']; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*), sum(total) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['where_pesq']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $rt->fields[1] = (string)$rt->fields[1]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['tot_geral'][2] = $rt->fields[1]; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['contr_total_geral'] = "OK";
   } 

   //-----  anio_periodo
   function quebra_anio_periodo_sc_free_group_by($anio_periodo, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb, $mes_periodo, $op_estado, $con_tipo_contrato, $con_ruta, $con_tipo_servicio, $con_condicion_contrato;
      $tot_anio_periodo = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(total) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['where_pesq']; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
          $tot_anio_periodo[0] = NM_encode_input(sc_strip_script($anio_periodo));
      }
      else {
          $tot_anio_periodo[0] = sc_strip_script($anio_periodo) ; 
      }
      $tot_anio_periodo[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_anio_periodo[2] = (string)$rt->fields[1]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_anio_periodo;
   } 

   //-----  mes_periodo
   function quebra_mes_periodo_sc_free_group_by($mes_periodo, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb, $mes_periodo, $op_estado, $con_tipo_contrato, $con_ruta, $con_tipo_servicio, $con_condicion_contrato;
      $tot_mes_periodo = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(total) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['where_pesq']; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
          $tot_mes_periodo[0] = NM_encode_input(sc_strip_script($mes_periodo));
      }
      else {
          $tot_mes_periodo[0] = sc_strip_script($mes_periodo) ; 
      }
      $tot_mes_periodo[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_mes_periodo[2] = (string)$rt->fields[1]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_mes_periodo;
   } 
