...
class grid_v_jap_emisiones_contratos_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $array_total_anio_periodo;
   var $array_total_mes_periodo;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_anio_periodo      = array();
      $this->array_total_mes_periodo       = array();
      ...
      $this->array_total_con_ruta          = array();
...
SCEOT;
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_v_jap_emisiones_contratos']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_v_jap_emisiones_contratos']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['orig_pesq'] = "resumo";
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['where_resumo'] = "";
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              ...
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['arr_total']['anio_periodo'] = $this->array_total_anio_periodo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['arr_total']['mes_periodo'] = $this->array_total_mes_periodo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['arr_total']['cl_nombre'] = $this->array_total_cl_nombre;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['arr_total']['cl_identificacion'] = $this->array_total_cl_identificacion;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['arr_total']['cl_telefono'] = $this->array_total_cl_telefono;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['arr_total']['cl_celular'] = $this->array_total_cl_celular;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['arr_total']['cl_email'] = $this->array_total_cl_email;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['arr_total']['con_ruta'] = $this->array_total_con_ruta;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['arr_total']['op_estado'] = $this->array_total_op_estado;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['json_use_label'])
       {
          $Lab_anio_periodo = "anio_periodo";
          $Lab_mes_periodo = "mes_periodo";
          ...
          $Lab_con_ruta = "con_ruta";
          $Lab_op_estado = "op_estado";
       }
       else
       {
       $Lab_anio_periodo = "" . $this->Ini->Nm_lang['lang_srch_year'] . "";
       $Lab_mes_periodo = "" . $this->Ini->Nm_lang['lang_srch_mnth'] . "";
       ...
       $Lab_cl_email = "" . $this->Ini->Nm_lang['lang_lot_email'] . "";
       $Lab_con_ruta = "" . $this->Ini->Nm_lang['lang_ruta'] . "";
       $Lab_op_estado = "" . $this->Ini->Nm_lang['lang_estado_deudas'] . "";
       }
       $prep_field = array();
       $prep_field['anio_periodo'] = $Lab_anio_periodo;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['anio_periodo'] = $Lab_anio_periodo; 
       $prep_field['mes_periodo'] = $Lab_mes_periodo;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['mes_periodo'] = $Lab_mes_periodo; 
       $prep_field['cl_nombre'] = $Lab_cl_nombre;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['cl_nombre'] = $Lab_cl_nombre; 
       $prep_field['cl_identificacion'] = $Lab_cl_identificacion;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['cl_identificacion'] = $Lab_cl_identificacion; 
       $prep_field['cl_telefono'] = $Lab_cl_telefono;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['cl_telefono'] = $Lab_cl_telefono; 
       $prep_field['cl_celular'] = $Lab_cl_celular;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['cl_celular'] = $Lab_cl_celular; 
       $prep_field['cl_email'] = $Lab_cl_email;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['cl_email'] = $Lab_cl_email; 
       $prep_field['con_ruta'] = $Lab_con_ruta;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['con_ruta'] = $Lab_con_ruta; 
       $prep_field['op_estado'] = $Lab_op_estado;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['op_estado'] = $Lab_op_estado; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['anio_periodo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['anio_periodo'] = "" . $this->Ini->Nm_lang['lang_srch_year'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['mes_periodo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['mes_periodo'] = "" . $this->Ini->Nm_lang['lang_srch_mnth'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['op_comentario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['op_comentario'] = "" . $this->Ini->Nm_lang['lang_comentario'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['total'] = "" . $this->Ini->Nm_lang['lang_total'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['op_estado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['op_estado'] = "" . $this->Ini->Nm_lang['lang_estado_deudas'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['detalle_deuda']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['detalle_deuda'] = "" . $this->Ini->Nm_lang['lang_detalle'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['op_fecha_emision']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['op_fecha_emision'] = "" . $this->Ini->Nm_lang['lang_fecha_emision'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['con_tipo_contrato']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['con_tipo_contrato'] = "" . $this->Ini->Nm_lang['lang_tipo_contrato'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['con_ruta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['con_ruta'] = "" . $this->Ini->Nm_lang['lang_ruta'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['cl_nombre']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['cl_nombre'] = "" . $this->Ini->Nm_lang['lang_nombre'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['cl_identificacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['cl_identificacion'] = "" . $this->Ini->Nm_lang['lang_lot_identificacion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['cl_telefono']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['cl_telefono'] = "" . $this->Ini->Nm_lang['lang_lot_telefono'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['cl_celular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['cl_celular'] = "" . $this->Ini->Nm_lang['lang_celular'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['cl_email']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['cl_email'] = "" . $this->Ini->Nm_lang['lang_lot_email'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['con_direccion_predio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['con_direccion_predio'] = "" . $this->Ini->Nm_lang['lang_direccion_predio'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['con_tipo_servicio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['con_tipo_servicio'] = "" . $this->Ini->Nm_lang['lang_tipo_servicio'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['con_condicion_contrato']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['con_condicion_contrato'] = "" . $this->Ini->Nm_lang['lang_condicion_contrato'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['con_numero_contrato']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['con_numero_contrato'] = "" . $this->Ini->Nm_lang['lang_numero_contrato'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['con_numero_medidor']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['con_numero_medidor'] = "" . $this->Ini->Nm_lang['lang_numero_medidor'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['op_asiento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['op_asiento'] = "" . $this->Ini->Nm_lang['lang_asiento_emision'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['op_asiento_reversa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['op_asiento_reversa'] = "" . $this->Ini->Nm_lang['lang_asiento_reverso'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['op_asiento_ingreso']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['op_asiento_ingreso'] = "" . $this->Ini->Nm_lang['lang_asiento_ingreso'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['op_empresa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['op_empresa'] = "" . $this->Ini->Nm_lang['lang_empresa'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['con_propietario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['con_propietario'] = "" . $this->Ini->Nm_lang['lang_propietario'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['con_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['con_id'] = "" . $this->Ini->Nm_lang['lang_contrato'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['op_operacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['labels']['op_operacion'] = "" . $this->Ini->Nm_lang['lang_operacion'] . ""; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       //-----
       $this->comp_sum = array(
           2 => "" .  $this->Ini->Nm_lang['lang_total'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['anio_periodo']['alin'] = "''";
       $Arr_parms['anio_periodo']['link'] = "S";
       $Arr_parms['mes_periodo']['alin'] = "''";
       $Arr_parms['mes_periodo']['link'] = "S";
       ...
       $Arr_parms['con_ruta']['alin'] = "''";
       $Arr_parms['con_ruta']['link'] = "S";
       $Arr_parms['op_estado']['alin'] = "''";
       $Arr_parms['op_estado']['link'] = "S";
       $Arr_parms['anio_periodo']['fill'] = "true";
       $Arr_parms['anio_periodo']['order'] = "label";
       $Arr_parms['anio_periodo']['order_start'] = 'asc';
       $Arr_parms['anio_periodo']['order_invert'] = 'false';
       $Arr_parms['anio_periodo']['order_enabled'] = 'true';
       $Arr_parms['anio_periodo']['order_datatype'] = 'text';
       $Arr_parms['anio_periodo']['rating_function'] = '';
       $Arr_parms['mes_periodo']['fill'] = "true";
       $Arr_parms['mes_periodo']['order'] = "label";
       $Arr_parms['mes_periodo']['order_start'] = 'asc';
       $Arr_parms['mes_periodo']['order_invert'] = 'false';
       $Arr_parms['mes_periodo']['order_enabled'] = 'true';
       $Arr_parms['mes_periodo']['order_datatype'] = 'text';
       $Arr_parms['mes_periodo']['rating_function'] = '';
       ...
       $Arr_parms['con_ruta']['fill'] = "true";
       $Arr_parms['con_ruta']['order'] = "label";
       $Arr_parms['con_ruta']['order_start'] = 'asc';
       $Arr_parms['con_ruta']['order_invert'] = 'false';
       $Arr_parms['con_ruta']['order_enabled'] = 'true';
       $Arr_parms['con_ruta']['order_datatype'] = 'int4';
       $Arr_parms['con_ruta']['rating_function'] = '';
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['anio_periodo'] = array(0 => 'anio_periodo', 1 => '@aspass@');
       $prep_links_fl['mes_periodo'] = array(0 => 'mes_periodo', 1 => '@aspass@');
       ...
       $prep_links_fl['con_ruta'] = array(0 => 'con_ruta', 1 => '');
       $prep_links_fl['op_estado'] = array(0 => 'op_estado', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_v_jap_emisiones_contratos@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_v_jap_emisiones_contratos_total.class.php"); 
      }
      ...
      $this->Total   = new grid_v_jap_emisiones_contratos_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['doc_word'])
{
      ...
      { 
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['ajax_nav']) {  
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_jap_emisiones_contratos_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_v_jap_emisiones_contratos_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_jap_emisiones_contratos_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_v_jap_emisiones_contratos/grid_v_jap_emisiones_contratos_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_v_jap_emisiones_contratos/grid_v_jap_emisiones_contratos_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_v_jap_emisiones_contratos&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid,resume&nm_all_modules=grid,resume&password=n&summary_export_columns=S&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + P)", "thickbox", "" . $this->Ini->path_link . "grid_v_jap_emisiones_contratos/grid_v_jap_emisiones_contratos_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid,resume&nm_all_modules=grid,resume&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
             $this->nm_btn_exist['groupby'][] = "sel_groupby_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_v_jap_emisiones_contratos/grid_v_jap_emisiones_contratos_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_v_jap_emisiones_contratos/grid_v_jap_emisiones_contratos_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + G)", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_v_jap_emisiones_contratos_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_v_jap_emisiones_contratos']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_v_jap_emisiones_contratos']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_v_jap_emisiones_contratos_config_pivot.php?nome_apl=grid_v_jap_emisiones_contratos&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"grid_v_jap_emisiones_contratos_iframe.php\";\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_jap_emisiones_contratos_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_v_jap_emisiones_contratos/grid_v_jap_emisiones_contratos_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $con_tipo_contrato = (isset($Busca_temp['con_tipo_contrato'])) ? $Busca_temp['con_tipo_contrato'] : ""; 
          $tmp_pos = (is_string($con_tipo_contrato)) ? strpos($con_tipo_contrato, "##@@") : false;
          if ($tmp_pos !== false && !is_array($con_tipo_contrato))
          {
              $con_tipo_contrato = substr($con_tipo_contrato, 0, $tmp_pos);
          }
          $anio_periodo = (isset($Busca_temp['anio_periodo'])) ? $Busca_temp['anio_periodo'] : ""; 
          $tmp_pos = (is_string($anio_periodo)) ? strpos($anio_periodo, "##@@") : false;
          if ($tmp_pos !== false && !is_array($anio_periodo))
          {
              $anio_periodo = substr($anio_periodo, 0, $tmp_pos);
          }
          $mes_periodo = (isset($Busca_temp['mes_periodo'])) ? $Busca_temp['mes_periodo'] : ""; 
          $tmp_pos = (is_string($mes_periodo)) ? strpos($mes_periodo, "##@@") : false;
          if ($tmp_pos !== false && !is_array($mes_periodo))
          {
              $mes_periodo = substr($mes_periodo, 0, $tmp_pos);
          }
          $con_ruta = (isset($Busca_temp['con_ruta'])) ? $Busca_temp['con_ruta'] : ""; 
          $tmp_pos = (is_string($con_ruta)) ? strpos($con_ruta, "##@@") : false;
          if ($tmp_pos !== false && !is_array($con_ruta))
          {
              $con_ruta = substr($con_ruta, 0, $tmp_pos);
          }
          ...
          $con_numero_medidor = (isset($Busca_temp['con_numero_medidor'])) ? $Busca_temp['con_numero_medidor'] : ""; 
          $tmp_pos = (is_string($con_numero_medidor)) ? strpos($con_numero_medidor, "##@@") : false;
          if ($tmp_pos !== false && !is_array($con_numero_medidor))
          {
   ...
   //---- 
   function adiciona_registro($sum_total, $quebra_anio_periodo, $quebra_mes_periodo, $quebra_cl_nombre, $quebra_cl_identificacion, $quebra_cl_telefono, $quebra_cl_celular, $quebra_cl_email, $quebra_con_ruta, $quebra_op_estado, $quebra_anio_periodo_orig, $quebra_mes_periodo_orig, $quebra_cl_nombre_orig, $quebra_cl_identificacion_orig, $quebra_cl_telefono_orig, $quebra_cl_celular_orig, $quebra_cl_email_orig, $quebra_con_ruta_orig, $quebra_op_estado_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_contratos']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
       ...
       $this->con_tipo_contrato = $Busca_temp['con_tipo_contrato']; 
       $this->con_tipo_contrato = (isset($Busca_temp['con_tipo_contrato'])) ? $Busca_temp['con_tipo_contrato'] : ""; 
       $tmp_pos = (is_string($this->con_tipo_contrato)) ? strpos($this->con_tipo_contrato, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->con_tipo_contrato))
       {
       ...
       $this->anio_periodo = $Busca_temp['anio_periodo']; 
       $this->anio_periodo = (isset($Busca_temp['anio_periodo'])) ? $Busca_temp['anio_periodo'] : ""; 
       $tmp_pos = (is_string($this->anio_periodo)) ? strpos($this->anio_periodo, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->anio_periodo))
       {
       ...
       $this->mes_periodo = $Busca_temp['mes_periodo']; 
       $this->mes_periodo = (isset($Busca_temp['mes_periodo'])) ? $Busca_temp['mes_periodo'] : ""; 
       $tmp_pos = (is_string($this->mes_periodo)) ? strpos($this->mes_periodo, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->mes_periodo))
       {
       ...
       $this->con_ruta = $Busca_temp['con_ruta']; 
       $this->con_ruta = (isset($Busca_temp['con_ruta'])) ? $Busca_temp['con_ruta'] : ""; 
       $tmp_pos = (is_string($this->con_ruta)) ? strpos($this->con_ruta, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->con_ruta))
       {
       ...
       $this->con_numero_medidor = $Busca_temp['con_numero_medidor']; 
       $this->con_numero_medidor = (isset($Busca_temp['con_numero_medidor'])) ? $Busca_temp['con_numero_medidor'] : ""; 
       $tmp_pos = (is_string($this->con_numero_medidor)) ? strpos($this->con_numero_medidor, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->con_numero_medidor))
       {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->anio_periodo = $rs_res->fields[0] ;  
            $this->mes_periodo = $rs_res->fields[1] ;  
            $this->op_comentario = $rs_res->fields[2] ;  
            $this->total = $rs_res->fields[3] ;  
            $this->op_estado = $rs_res->fields[4] ;  
            $this->op_fecha_emision = $rs_res->fields[5] ;  
            $this->con_tipo_contrato = $rs_res->fields[6] ;  
            $this->con_ruta = $rs_res->fields[7] ;  
            $this->cl_nombre = $rs_res->fields[8] ;  
            $this->cl_identificacion = $rs_res->fields[9] ;  
            ...
            $this->con_tipo_servicio = $rs_res->fields[14] ;  
            $this->con_condicion_contrato = $rs_res->fields[15] ;  
            $this->con_numero_contrato = $rs_res->fields[16] ;  
            $this->con_numero_medidor = $rs_res->fields[17] ;  
            $this->op_asiento = $rs_res->fields[18] ;  
            $this->op_asiento_reversa = $rs_res->fields[19] ;  
            $this->op_asiento_ingreso = $rs_res->fields[20] ;  
            $this->con_id = $rs_res->fields[21] ;  
            $this->op_operacion = $rs_res->fields[22] ;  
            $this->anio_periodo_orig = $this->anio_periodo;
            $this->mes_periodo_orig = $this->mes_periodo;
            ...
            $this->con_ruta_orig = $this->con_ruta;
            $this->op_estado_orig = $this->op_estado;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->total, $this->anio_periodo, $this->mes_periodo, $this->cl_nombre, $this->cl_identificacion, $this->cl_telefono, $this->cl_celular, $this->cl_email, $this->con_ruta, $this->op_estado, $this->anio_periodo_orig,  $this->mes_periodo_orig,  $this->cl_nombre_orig,  $this->cl_identificacion_orig,  $this->cl_telefono_orig,  $this->cl_celular_orig,  $this->cl_email_orig,  $this->con_ruta_orig,  $this->op_estado_orig);
            }
   }
//
