...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_recaudacion_x_contrato/form_recaudacion_x_contrato_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_recaudacion_x_contrato_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['recarga'];
}
if ('' != $this->contrato)
{
    $this->lookup_contrato($look_rpc_contrato);
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['link_info']['remove_border']) {
...
<?php
 include_once("form_recaudacion_x_contrato_js0.php");
?>
<script type="text/javascript" src="<?php  echo $this->Ini->path_js . "/jsrsClient.js" ?>"> 
</script> 
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_recaudacion_x_contrato'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_recaudacion_x_contrato'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['btn_disabled']['btn_salir']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['btn_disabled']['btn_salir']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['btn_label']['btn_salir']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['btn_label']['btn_salir']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['btn_label']['btn_salir'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['btn_disabled']['actualizar_cliente']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['btn_disabled']['actualizar_cliente']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['btn_label']['actualizar_cliente']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['btn_label']['actualizar_cliente']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['btn_label']['actualizar_cliente'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['btn_disabled']['facturar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['btn_disabled']['facturar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['btn_label']['facturar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['btn_label']['facturar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['btn_label']['facturar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['btn_disabled']['seleccionar_todo']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['btn_disabled']['seleccionar_todo']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['btn_label']['seleccionar_todo']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['btn_label']['seleccionar_todo']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['btn_label']['seleccionar_todo'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['btn_label']['exit'];
        }
?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['Lookup_usar_compensacion'][] = 'S'; ?>
<?php  if (in_array("S", $this->usar_compensacion_1))  { echo " checked" ;} ?> onClick="do_ajax_form_recaudacion_x_contrato_event_usar_compensacion_onclick();" ><span></span>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_operaciones2'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_operaciones2'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['grid_fac_operacion_contrato_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_operaciones2'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['grid_fac_operacion_contrato_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 if (isset($this->Ini->sc_lig_md5["grid_fac_operacion_contrato"]) && $this->Ini->sc_lig_md5["grid_fac_operacion_contrato"] == "S") {
     ...
     $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_recaudacion_x_contrato@SC_par@" . md5($Parms_Lig);
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
 } else {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_recaudacion_x_contrato_empty.htm' : $this->Ini->link_grid_fac_operacion_contrato_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y' . $parms_lig_cons;
if (isset($this->Ini->sc_lig_target['C_@scinf_operaciones2']) && 'nmsc_iframe_liga_grid_fac_operacion_contrato' != $this->Ini->sc_lig_target['C_@scinf_operaciones2'])
{
    ...
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_operaciones2'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['grid_fac_operacion_contrato_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_recaudacion_x_contrato");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_recaudacion_x_contrato");
 parent.scAjaxDetailHeight("form_recaudacion_x_contrato", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_x_contrato']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
