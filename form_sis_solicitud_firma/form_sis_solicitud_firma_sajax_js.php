  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_solicitud_firma" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sis_solicitud_firma_form();
	}
...
?>
  ...
  // ---------- Validate sf_id
  function do_ajax_form_sis_solicitud_firma_validate_sf_id()
  {
    var nomeCampo_sf_id = "sf_id";
    var var_sf_id = scAjaxGetFieldHidden(nomeCampo_sf_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_solicitud_firma_validate_sf_id(var_sf_id, var_script_case_init, do_ajax_form_sis_solicitud_firma_validate_sf_id_cb);
  } // do_ajax_form_sis_solicitud_firma_validate_sf_id

  function do_ajax_form_sis_solicitud_firma_validate_sf_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_solicitud_firma_validate_sf_id_cb

  // ---------- Validate sf_comisionista
  function do_ajax_form_sis_solicitud_firma_validate_sf_comisionista()
  {
    var nomeCampo_sf_comisionista = "sf_comisionista";
    var var_sf_comisionista = scAjaxGetFieldSelect(nomeCampo_sf_comisionista);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_solicitud_firma_validate_sf_comisionista(var_sf_comisionista, var_script_case_init, do_ajax_form_sis_solicitud_firma_validate_sf_comisionista_cb);
  } // do_ajax_form_sis_solicitud_firma_validate_sf_comisionista

  function do_ajax_form_sis_solicitud_firma_validate_sf_comisionista_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_solicitud_firma_validate_sf_comisionista_cb

  // ---------- Validate sf_tipo_firma
  function do_ajax_form_sis_solicitud_firma_validate_sf_tipo_firma()
  {
    var nomeCampo_sf_tipo_firma = "sf_tipo_firma";
    var var_sf_tipo_firma = scAjaxGetFieldSelect(nomeCampo_sf_tipo_firma);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_solicitud_firma_validate_sf_tipo_firma(var_sf_tipo_firma, var_script_case_init, do_ajax_form_sis_solicitud_firma_validate_sf_tipo_firma_cb);
  } // do_ajax_form_sis_solicitud_firma_validate_sf_tipo_firma

  function do_ajax_form_sis_solicitud_firma_validate_sf_tipo_firma_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_solicitud_firma_validate_sf_tipo_firma_cb

  // ---------- Validate sf_duracion
  function do_ajax_form_sis_solicitud_firma_validate_sf_duracion()
  {
    var nomeCampo_sf_duracion = "sf_duracion";
    var var_sf_duracion = scAjaxGetFieldSelect(nomeCampo_sf_duracion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_solicitud_firma_validate_sf_duracion(var_sf_duracion, var_script_case_init, do_ajax_form_sis_solicitud_firma_validate_sf_duracion_cb);
  } // do_ajax_form_sis_solicitud_firma_validate_sf_duracion

  function do_ajax_form_sis_solicitud_firma_validate_sf_duracion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_solicitud_firma_validate_sf_duracion_cb

  // ---------- Validate sf_tipo_identificacion
  function do_ajax_form_sis_solicitud_firma_validate_sf_tipo_identificacion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_solicitud_firma_validate_sf_tipo_identificacion(var_sf_tipo_identificacion, var_script_case_init, do_ajax_form_sis_solicitud_firma_validate_sf_tipo_identificacion_cb);
  } // do_ajax_form_sis_solicitud_firma_validate_sf_tipo_identificacion

  function do_ajax_form_sis_solicitud_firma_validate_sf_tipo_identificacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_solicitud_firma_validate_sf_tipo_identificacion_cb

  // ---------- Validate sf_identificacion
  function do_ajax_form_sis_solicitud_firma_validate_sf_identificacion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_solicitud_firma_validate_sf_identificacion(var_sf_identificacion, var_script_case_init, do_ajax_form_sis_solicitud_firma_validate_sf_identificacion_cb);
  } // do_ajax_form_sis_solicitud_firma_validate_sf_identificacion

  function do_ajax_form_sis_solicitud_firma_validate_sf_identificacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_solicitud_firma_validate_sf_identificacion_cb

  // ---------- Validate sf_nombre
  function do_ajax_form_sis_solicitud_firma_validate_sf_nombre()
  {
    var nomeCampo_sf_nombre = "sf_nombre";
    var var_sf_nombre = scAjaxGetFieldText(nomeCampo_sf_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_solicitud_firma_validate_sf_nombre(var_sf_nombre, var_script_case_init, do_ajax_form_sis_solicitud_firma_validate_sf_nombre_cb);
  } // do_ajax_form_sis_solicitud_firma_validate_sf_nombre

  function do_ajax_form_sis_solicitud_firma_validate_sf_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_solicitud_firma_validate_sf_nombre_cb

  // ---------- Validate sf_direcccion
  function do_ajax_form_sis_solicitud_firma_validate_sf_direcccion()
  {
    var nomeCampo_sf_direcccion = "sf_direcccion";
    var var_sf_direcccion = scAjaxGetFieldText(nomeCampo_sf_direcccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_solicitud_firma_validate_sf_direcccion(var_sf_direcccion, var_script_case_init, do_ajax_form_sis_solicitud_firma_validate_sf_direcccion_cb);
  } // do_ajax_form_sis_solicitud_firma_validate_sf_direcccion

  function do_ajax_form_sis_solicitud_firma_validate_sf_direcccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_solicitud_firma_validate_sf_direcccion_cb

  // ---------- Validate sf_telefono
  function do_ajax_form_sis_solicitud_firma_validate_sf_telefono()
  {
    var nomeCampo_sf_telefono = "sf_telefono";
    var var_sf_telefono = scAjaxGetFieldText(nomeCampo_sf_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_solicitud_firma_validate_sf_telefono(var_sf_telefono, var_script_case_init, do_ajax_form_sis_solicitud_firma_validate_sf_telefono_cb);
  } // do_ajax_form_sis_solicitud_firma_validate_sf_telefono

  function do_ajax_form_sis_solicitud_firma_validate_sf_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_solicitud_firma_validate_sf_telefono_cb

  // ---------- Validate sf_email
  function do_ajax_form_sis_solicitud_firma_validate_sf_email()
  {
    var nomeCampo_sf_email = "sf_email";
    var var_sf_email = scAjaxGetFieldText(nomeCampo_sf_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_solicitud_firma_validate_sf_email(var_sf_email, var_script_case_init, do_ajax_form_sis_solicitud_firma_validate_sf_email_cb);
  } // do_ajax_form_sis_solicitud_firma_validate_sf_email

  function do_ajax_form_sis_solicitud_firma_validate_sf_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_solicitud_firma_validate_sf_email_cb

  // ---------- Validate sf_estado
  function do_ajax_form_sis_solicitud_firma_validate_sf_estado()
  {
    var nomeCampo_sf_estado = "sf_estado";
    var var_sf_estado = scAjaxGetFieldSelect(nomeCampo_sf_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_solicitud_firma_validate_sf_estado(var_sf_estado, var_script_case_init, do_ajax_form_sis_solicitud_firma_validate_sf_estado_cb);
  } // do_ajax_form_sis_solicitud_firma_validate_sf_estado

  function do_ajax_form_sis_solicitud_firma_validate_sf_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_solicitud_firma_validate_sf_estado_cb

  // ---------- Validate documentos
  function do_ajax_form_sis_solicitud_firma_validate_documentos()
  {
    var nomeCampo_documentos = "documentos";
    var var_documentos = scAjaxGetFieldText(nomeCampo_documentos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_solicitud_firma_validate_documentos(var_documentos, var_script_case_init, do_ajax_form_sis_solicitud_firma_validate_documentos_cb);
  } // do_ajax_form_sis_solicitud_firma_validate_documentos

  function do_ajax_form_sis_solicitud_firma_validate_documentos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_solicitud_firma_validate_documentos_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_sis_solicitud_firma_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_sis_solicitud_firma_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_sis_solicitud_firma_submit_form(var_sf_id, var_sf_comisionista, var_sf_tipo_firma, var_sf_duracion, var_sf_tipo_identificacion, var_sf_identificacion, var_sf_nombre, var_sf_direcccion, var_sf_telefono, var_sf_email, var_sf_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_solicitud_firma_submit_form_cb);
  } // do_ajax_form_sis_solicitud_firma_submit_form

  function do_ajax_form_sis_solicitud_firma_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_sis_solicitud_firma_submit_form_cb_after_alert);
  } // do_ajax_form_sis_solicitud_firma_submit_form_cb
  function do_ajax_form_sis_solicitud_firma_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_solicitud_firma_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_sis_documentos_solicitud_firma"] = "off";

  function do_ajax_form_sis_solicitud_firma_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_sis_solicitud_firma_navigate_form, function() {});
    } else {
      perform_ajax_form_sis_solicitud_firma_navigate_form();
    }
  }

  function perform_ajax_form_sis_solicitud_firma_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_sis_documentos_solicitud_firma"] = "on";
    x_ajax_form_sis_solicitud_firma_navigate_form(var_sf_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_solicitud_firma_navigate_form_cb);
  } // do_ajax_form_sis_solicitud_firma_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_solicitud_firma_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_sis_documentos_solicitud_firma"] && "nmsc_iframe_liga_form_sis_documentos_solicitud_firma" != scMasterDetailIframe["nmsc_iframe_liga_form_sis_documentos_solicitud_firma"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_sis_documentos_solicitud_firma"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_sis_documentos_solicitud_firma').contentWindow.nm_move('apl_detalhe', true, '320');
        document.getElementById('nmsc_iframe_liga_form_sis_documentos_solicitud_firma').style.height = "320";
        document.getElementById('nmsc_iframe_liga_form_sis_documentos_solicitud_firma').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_solicitud_firma_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_solicitud_firma_navigate_form_cb
  function do_ajax_form_sis_solicitud_firma_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_sis_solicitud_firma_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_sis_solicitud_firma_navigate_form_cb_after_alert

  function sc_hide_form_sis_solicitud_firma_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_sis_documentos_solicitud_firma"])
    {
      return true;
    }
    return false;
