...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_sis_solicitud_firma/form_sis_solicitud_firma_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_sis_solicitud_firma_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_sis_solicitud_firma_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['link_info']['remove_border']) {
...
<?php
 include_once("form_sis_solicitud_firma_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_sis_solicitud_firma'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_sis_solicitud_firma'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['btn_disabled']['']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['btn_disabled']['']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['btn_label']['']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['btn_label']['']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['btn_label'][''];
        }
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-3';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_sf_id_label" id="hidden_field_label_sf_id" style="<?php echo $sStyleHidden_sf_id; ?>"><span id="id_label_sf_id"><?php echo $this->nm_new_label['sf_id']; ?></span></TD>
    <TD class="scFormDataOdd css_sf_id_line" id="hidden_field_data_sf_id" style="<?php echo $sStyleHidden_sf_id; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sf_id_line" style="vertical-align: top;padding: 0px">
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { 
 ?>
<span id="id_read_on_sf_id" css_sf_id_line" style="<?php echo $sStyleReadLab_sf_id; ?>"><?php echo $this->form_format_readonly("sf_id", $this->form_encode_input($this->sf_id)); ?></span><span id="id_read_off_sf_id" class="css_read_off_sf_id" style="<?php echo $sStyleReadInp_sf_id; ?>"><input type="hidden" name="sf_id" value="<?php echo $this->form_encode_input($sf_id) . "\">"?><span id="id_ajax_label_sf_id"><?php echo nl2br($sf_id); ?></span>
</span><?php } else { ?>
&nbsp;
<?php } ?>
</span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_sf_id_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_sf_id_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_sf_comisionista_label" id="hidden_field_label_sf_comisionista" style="<?php echo $sStyleHidden_sf_comisionista; ?>"><span id="id_label_sf_comisionista"><?php echo $this->nm_new_label['sf_comisionista']; ?></span></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_sf_tipo_firma_label" id="hidden_field_label_sf_tipo_firma" style="<?php echo $sStyleHidden_sf_tipo_firma; ?>"><span id="id_label_sf_tipo_firma"><?php echo $this->nm_new_label['sf_tipo_firma']; ?></span></TD>
    <TD class="scFormDataOdd css_sf_tipo_firma_line" id="hidden_field_data_sf_tipo_firma" style="<?php echo $sStyleHidden_sf_tipo_firma; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sf_tipo_firma_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_sf_duracion_label" id="hidden_field_label_sf_duracion" style="<?php echo $sStyleHidden_sf_duracion; ?>"><span id="id_label_sf_duracion"><?php echo $this->nm_new_label['sf_duracion']; ?></span></TD>
    <TD class="scFormDataOdd css_sf_duracion_line" id="hidden_field_data_sf_duracion" style="<?php echo $sStyleHidden_sf_duracion; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sf_duracion_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_sf_tipo_identificacion_label" id="hidden_field_label_sf_tipo_identificacion" style="<?php echo $sStyleHidden_sf_tipo_identificacion; ?>"><span id="id_label_sf_tipo_identificacion"><?php echo $this->nm_new_label['sf_tipo_identificacion']; ?></span></TD>
    <TD class="scFormDataOdd css_sf_tipo_identificacion_line" id="hidden_field_data_sf_tipo_identificacion" style="<?php echo $sStyleHidden_sf_tipo_identificacion; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sf_tipo_identificacion_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_sf_identificacion_label" id="hidden_field_label_sf_identificacion" style="<?php echo $sStyleHidden_sf_identificacion; ?>"><span id="id_label_sf_identificacion"><?php echo $this->nm_new_label['sf_identificacion']; ?></span></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_sf_nombre_label" id="hidden_field_label_sf_nombre" style="<?php echo $sStyleHidden_sf_nombre; ?>"><span id="id_label_sf_nombre"><?php echo $this->nm_new_label['sf_nombre']; ?></span></TD>
    <TD class="scFormDataOdd css_sf_nombre_line" id="hidden_field_data_sf_nombre" style="<?php echo $sStyleHidden_sf_nombre; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sf_nombre_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_sf_direcccion_label" id="hidden_field_label_sf_direcccion" style="<?php echo $sStyleHidden_sf_direcccion; ?>"><span id="id_label_sf_direcccion"><?php echo $this->nm_new_label['sf_direcccion']; ?></span></TD>
    <TD class="scFormDataOdd css_sf_direcccion_line" id="hidden_field_data_sf_direcccion" style="<?php echo $sStyleHidden_sf_direcccion; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sf_direcccion_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_sf_telefono_label" id="hidden_field_label_sf_telefono" style="<?php echo $sStyleHidden_sf_telefono; ?>"><span id="id_label_sf_telefono"><?php echo $this->nm_new_label['sf_telefono']; ?></span></TD>
    <TD class="scFormDataOdd css_sf_telefono_line" id="hidden_field_data_sf_telefono" style="<?php echo $sStyleHidden_sf_telefono; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sf_telefono_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_sf_email_label" id="hidden_field_label_sf_email" style="<?php echo $sStyleHidden_sf_email; ?>"><span id="id_label_sf_email"><?php echo $this->nm_new_label['sf_email']; ?></span></TD>
    <TD class="scFormDataOdd css_sf_email_line" id="hidden_field_data_sf_email" style="<?php echo $sStyleHidden_sf_email; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sf_email_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_sf_estado_label" id="hidden_field_label_sf_estado" style="<?php echo $sStyleHidden_sf_estado; ?>"><span id="id_label_sf_estado"><?php echo $this->nm_new_label['sf_estado']; ?></span></TD>
    <TD class="scFormDataOdd css_sf_estado_line" id="hidden_field_data_sf_estado" style="<?php echo $sStyleHidden_sf_estado; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sf_estado_line" style="vertical-align: top;padding: 0px">
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Documentos'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Documentos'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['form_sis_documentos_solicitud_firma_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Documentos'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['form_sis_documentos_solicitud_firma_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['form_sis_documentos_solicitud_firma_script_case_init'] ]['form_sis_documentos_solicitud_firma']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['form_sis_documentos_solicitud_firma_script_case_init'] ]['form_sis_documentos_solicitud_firma']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['form_sis_documentos_solicitud_firma_script_case_init'] ]['form_sis_documentos_solicitud_firma']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['form_sis_documentos_solicitud_firma_script_case_init'] ]['form_sis_documentos_solicitud_firma']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['form_sis_documentos_solicitud_firma_script_case_init'] ]['form_sis_documentos_solicitud_firma']['embutida_liga_form_insert'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['form_sis_documentos_solicitud_firma_script_case_init'] ]['form_sis_documentos_solicitud_firma']['embutida_liga_form_update'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['form_sis_documentos_solicitud_firma_script_case_init'] ]['form_sis_documentos_solicitud_firma']['embutida_liga_form_delete'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['form_sis_documentos_solicitud_firma_script_case_init'] ]['form_sis_documentos_solicitud_firma']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['form_sis_documentos_solicitud_firma_script_case_init'] ]['form_sis_documentos_solicitud_firma']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['form_sis_documentos_solicitud_firma_script_case_init'] ]['form_sis_documentos_solicitud_firma']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['form_sis_documentos_solicitud_firma_script_case_init'] ]['form_sis_documentos_solicitud_firma']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['form_sis_documentos_solicitud_firma_script_case_init'] ]['form_sis_documentos_solicitud_firma']['embutida_liga_tp_pag'] = 'parcial';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['form_sis_documentos_solicitud_firma_script_case_init'] ]['form_sis_documentos_solicitud_firma']['embutida_parms'] = "var_identificacion*scin" . $this->nmgp_dados_form['sf_identificacion'] . "*scoutNM_btn_insert*scinN*scoutNM_btn_update*scinN*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinN*scoutlink_remove_margin*scinok*scoutlink_remove_border*scinok*scout";
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['form_sis_documentos_solicitud_firma_script_case_init'] ]['form_sis_solicitud_firma']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_sis_solicitud_firma_empty.htm' : $this->Ini->link_form_sis_documentos_solicitud_firma_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y&sc_ifr_height=320';
if (isset($this->Ini->sc_lig_target['C_@scinf_Documentos']) && 'nmsc_iframe_liga_form_sis_documentos_solicitud_firma' != $this->Ini->sc_lig_target['C_@scinf_Documentos'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_Documentos'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['form_sis_documentos_solicitud_firma_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_sis_documentos_solicitud_firma"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="320" width="100%" name="nmsc_iframe_liga_form_sis_documentos_solicitud_firma"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_sis_solicitud_firma");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_sis_solicitud_firma");
 parent.scAjaxDetailHeight("form_sis_solicitud_firma", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
