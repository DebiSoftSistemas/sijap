...
function displayChange_field_documentos(row, status) {
    var fieldId;
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_sis_documentos_solicitud_firma_mob")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_sis_documentos_solicitud_firma_mob")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_sis_solicitud_firma_mob_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_sis_solicitud_firma_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
