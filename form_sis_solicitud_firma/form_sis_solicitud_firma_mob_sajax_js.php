  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_solicitud_firma_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sis_solicitud_firma_mob_form();
	}
...
?>
  ...
  // ---------- Validate sf_id
  function do_ajax_form_sis_solicitud_firma_mob_validate_sf_id()
  {
    var nomeCampo_sf_id = "sf_id";
    var var_sf_id = scAjaxGetFieldHidden(nomeCampo_sf_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_solicitud_firma_mob_validate_sf_id(var_sf_id, var_script_case_init, do_ajax_form_sis_solicitud_firma_mob_validate_sf_id_cb);
  } // do_ajax_form_sis_solicitud_firma_mob_validate_sf_id

  function do_ajax_form_sis_solicitud_firma_mob_validate_sf_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_solicitud_firma_mob_validate_sf_id_cb

  // ---------- Validate sf_comisionista
  function do_ajax_form_sis_solicitud_firma_mob_validate_sf_comisionista()
  {
    var nomeCampo_sf_comisionista = "sf_comisionista";
    var var_sf_comisionista = scAjaxGetFieldSelect(nomeCampo_sf_comisionista);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_solicitud_firma_mob_validate_sf_comisionista(var_sf_comisionista, var_script_case_init, do_ajax_form_sis_solicitud_firma_mob_validate_sf_comisionista_cb);
  } // do_ajax_form_sis_solicitud_firma_mob_validate_sf_comisionista

  function do_ajax_form_sis_solicitud_firma_mob_validate_sf_comisionista_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sf_comisionista";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_solicitud_firma_mob_validate_sf_comisionista_cb

  // ---------- Validate sf_tipo_firma
  function do_ajax_form_sis_solicitud_firma_mob_validate_sf_tipo_firma()
  {
    var nomeCampo_sf_tipo_firma = "sf_tipo_firma";
    var var_sf_tipo_firma = scAjaxGetFieldSelect(nomeCampo_sf_tipo_firma);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_solicitud_firma_mob_validate_sf_tipo_firma(var_sf_tipo_firma, var_script_case_init, do_ajax_form_sis_solicitud_firma_mob_validate_sf_tipo_firma_cb);
  } // do_ajax_form_sis_solicitud_firma_mob_validate_sf_tipo_firma

  function do_ajax_form_sis_solicitud_firma_mob_validate_sf_tipo_firma_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sf_tipo_firma";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_solicitud_firma_mob_validate_sf_tipo_firma_cb

  // ---------- Validate sf_duracion
  function do_ajax_form_sis_solicitud_firma_mob_validate_sf_duracion()
  {
    var nomeCampo_sf_duracion = "sf_duracion";
    var var_sf_duracion = scAjaxGetFieldSelect(nomeCampo_sf_duracion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_solicitud_firma_mob_validate_sf_duracion(var_sf_duracion, var_script_case_init, do_ajax_form_sis_solicitud_firma_mob_validate_sf_duracion_cb);
  } // do_ajax_form_sis_solicitud_firma_mob_validate_sf_duracion

  function do_ajax_form_sis_solicitud_firma_mob_validate_sf_duracion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sf_duracion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_solicitud_firma_mob_validate_sf_duracion_cb

  // ---------- Validate sf_tipo_identificacion
  function do_ajax_form_sis_solicitud_firma_mob_validate_sf_tipo_identificacion()
  {
    var nomeCampo_sf_tipo_identificacion = "sf_tipo_identificacion";
    var var_sf_tipo_identificacion = scAjaxGetFieldSelect(nomeCampo_sf_tipo_identificacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_solicitud_firma_mob_validate_sf_tipo_identificacion(var_sf_tipo_identificacion, var_script_case_init, do_ajax_form_sis_solicitud_firma_mob_validate_sf_tipo_identificacion_cb);
  } // do_ajax_form_sis_solicitud_firma_mob_validate_sf_tipo_identificacion

  function do_ajax_form_sis_solicitud_firma_mob_validate_sf_tipo_identificacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sf_tipo_identificacion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_solicitud_firma_mob_validate_sf_tipo_identificacion_cb

  // ---------- Validate sf_identificacion
  function do_ajax_form_sis_solicitud_firma_mob_validate_sf_identificacion()
  {
    var nomeCampo_sf_identificacion = "sf_identificacion";
    var var_sf_identificacion = scAjaxGetFieldText(nomeCampo_sf_identificacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_solicitud_firma_mob_validate_sf_identificacion(var_sf_identificacion, var_script_case_init, do_ajax_form_sis_solicitud_firma_mob_validate_sf_identificacion_cb);
  } // do_ajax_form_sis_solicitud_firma_mob_validate_sf_identificacion

  function do_ajax_form_sis_solicitud_firma_mob_validate_sf_identificacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sf_identificacion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_solicitud_firma_mob_validate_sf_identificacion_cb

  // ---------- Validate sf_nombre
  function do_ajax_form_sis_solicitud_firma_mob_validate_sf_nombre()
  {
    var nomeCampo_sf_nombre = "sf_nombre";
    var var_sf_nombre = scAjaxGetFieldText(nomeCampo_sf_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_solicitud_firma_mob_validate_sf_nombre(var_sf_nombre, var_script_case_init, do_ajax_form_sis_solicitud_firma_mob_validate_sf_nombre_cb);
  } // do_ajax_form_sis_solicitud_firma_mob_validate_sf_nombre

  function do_ajax_form_sis_solicitud_firma_mob_validate_sf_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sf_nombre";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_solicitud_firma_mob_validate_sf_nombre_cb

  // ---------- Validate sf_direcccion
  function do_ajax_form_sis_solicitud_firma_mob_validate_sf_direcccion()
  {
    var nomeCampo_sf_direcccion = "sf_direcccion";
    var var_sf_direcccion = scAjaxGetFieldText(nomeCampo_sf_direcccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_solicitud_firma_mob_validate_sf_direcccion(var_sf_direcccion, var_script_case_init, do_ajax_form_sis_solicitud_firma_mob_validate_sf_direcccion_cb);
  } // do_ajax_form_sis_solicitud_firma_mob_validate_sf_direcccion

  function do_ajax_form_sis_solicitud_firma_mob_validate_sf_direcccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sf_direcccion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_solicitud_firma_mob_validate_sf_direcccion_cb

  // ---------- Validate sf_telefono
  function do_ajax_form_sis_solicitud_firma_mob_validate_sf_telefono()
  {
    var nomeCampo_sf_telefono = "sf_telefono";
    var var_sf_telefono = scAjaxGetFieldText(nomeCampo_sf_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_solicitud_firma_mob_validate_sf_telefono(var_sf_telefono, var_script_case_init, do_ajax_form_sis_solicitud_firma_mob_validate_sf_telefono_cb);
  } // do_ajax_form_sis_solicitud_firma_mob_validate_sf_telefono

  function do_ajax_form_sis_solicitud_firma_mob_validate_sf_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sf_telefono";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_solicitud_firma_mob_validate_sf_telefono_cb

  // ---------- Validate sf_email
  function do_ajax_form_sis_solicitud_firma_mob_validate_sf_email()
  {
    var nomeCampo_sf_email = "sf_email";
    var var_sf_email = scAjaxGetFieldText(nomeCampo_sf_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_solicitud_firma_mob_validate_sf_email(var_sf_email, var_script_case_init, do_ajax_form_sis_solicitud_firma_mob_validate_sf_email_cb);
  } // do_ajax_form_sis_solicitud_firma_mob_validate_sf_email

  function do_ajax_form_sis_solicitud_firma_mob_validate_sf_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sf_email";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_solicitud_firma_mob_validate_sf_email_cb

  // ---------- Validate sf_estado
  function do_ajax_form_sis_solicitud_firma_mob_validate_sf_estado()
  {
    var nomeCampo_sf_estado = "sf_estado";
    var var_sf_estado = scAjaxGetFieldSelect(nomeCampo_sf_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_solicitud_firma_mob_validate_sf_estado(var_sf_estado, var_script_case_init, do_ajax_form_sis_solicitud_firma_mob_validate_sf_estado_cb);
  } // do_ajax_form_sis_solicitud_firma_mob_validate_sf_estado

  function do_ajax_form_sis_solicitud_firma_mob_validate_sf_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sf_estado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_solicitud_firma_mob_validate_sf_estado_cb

  // ---------- Validate documentos
  function do_ajax_form_sis_solicitud_firma_mob_validate_documentos()
  {
    var nomeCampo_documentos = "documentos";
    var var_documentos = scAjaxGetFieldText(nomeCampo_documentos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_solicitud_firma_mob_validate_documentos(var_documentos, var_script_case_init, do_ajax_form_sis_solicitud_firma_mob_validate_documentos_cb);
  } // do_ajax_form_sis_solicitud_firma_mob_validate_documentos

  function do_ajax_form_sis_solicitud_firma_mob_validate_documentos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_solicitud_firma_mob_validate_documentos_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_sis_solicitud_firma_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_sis_solicitud_firma_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_sf_id = scAjaxGetFieldHidden("sf_id");
    var var_sf_comisionista = scAjaxGetFieldSelect("sf_comisionista");
    var var_sf_tipo_firma = scAjaxGetFieldSelect("sf_tipo_firma");
    var var_sf_duracion = scAjaxGetFieldSelect("sf_duracion");
    var var_sf_tipo_identificacion = scAjaxGetFieldSelect("sf_tipo_identificacion");
    var var_sf_identificacion = scAjaxGetFieldText("sf_identificacion");
    var var_sf_nombre = scAjaxGetFieldText("sf_nombre");
    var var_sf_direcccion = scAjaxGetFieldText("sf_direcccion");
    var var_sf_telefono = scAjaxGetFieldText("sf_telefono");
    var var_sf_email = scAjaxGetFieldText("sf_email");
    var var_sf_estado = scAjaxGetFieldSelect("sf_estado");
    ...
    scAjaxProcOn();
    x_ajax_form_sis_solicitud_firma_mob_submit_form(var_sf_id, var_sf_comisionista, var_sf_tipo_firma, var_sf_duracion, var_sf_tipo_identificacion, var_sf_identificacion, var_sf_nombre, var_sf_direcccion, var_sf_telefono, var_sf_email, var_sf_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_solicitud_firma_mob_submit_form_cb);
  } // do_ajax_form_sis_solicitud_firma_mob_submit_form

  function do_ajax_form_sis_solicitud_firma_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("sf_id");
      scAjaxHideErrorDisplay("sf_comisionista");
      scAjaxHideErrorDisplay("sf_tipo_firma");
      scAjaxHideErrorDisplay("sf_duracion");
      scAjaxHideErrorDisplay("sf_tipo_identificacion");
      scAjaxHideErrorDisplay("sf_identificacion");
      scAjaxHideErrorDisplay("sf_nombre");
      scAjaxHideErrorDisplay("sf_direcccion");
      scAjaxHideErrorDisplay("sf_telefono");
      scAjaxHideErrorDisplay("sf_email");
      scAjaxHideErrorDisplay("sf_estado");
      scAjaxHideErrorDisplay("documentos");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_sis_solicitud_firma_mob_submit_form_cb_after_alert);
  } // do_ajax_form_sis_solicitud_firma_mob_submit_form_cb
  function do_ajax_form_sis_solicitud_firma_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_solicitud_firma_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_sis_documentos_solicitud_firma_mob"] = "off";

  function do_ajax_form_sis_solicitud_firma_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_sis_solicitud_firma_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_sis_solicitud_firma_mob_navigate_form();
    }
  }

  function perform_ajax_form_sis_solicitud_firma_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("sf_estado");
    scAjaxHideErrorDisplay("documentos");
    var var_sf_id = document.F2.sf_id.value;
    ...
    scAjaxProcOn();
    scStatusDetail["form_sis_documentos_solicitud_firma_mob"] = "on";
    x_ajax_form_sis_solicitud_firma_mob_navigate_form(var_sf_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_solicitud_firma_mob_navigate_form_cb);
  } // do_ajax_form_sis_solicitud_firma_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_solicitud_firma_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_solicitud_firma_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.sf_id.value = scAjaxGetKeyValue("sf_id");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_sis_documentos_solicitud_firma_mob"] && "nmsc_iframe_liga_form_sis_documentos_solicitud_firma_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_sis_documentos_solicitud_firma_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_sis_documentos_solicitud_firma_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_sis_documentos_solicitud_firma_mob').contentWindow.nm_move('apl_detalhe', true, '320');
        document.getElementById('nmsc_iframe_liga_form_sis_documentos_solicitud_firma_mob').style.height = "320";
        document.getElementById('nmsc_iframe_liga_form_sis_documentos_solicitud_firma_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_solicitud_firma_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_solicitud_firma_mob_navigate_form_cb
  function do_ajax_form_sis_solicitud_firma_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_sis_solicitud_firma_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_sis_solicitud_firma_mob_navigate_form_cb_after_alert

  function sc_hide_form_sis_solicitud_firma_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_sis_documentos_solicitud_firma_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "sf_id";
  ajax_field_list[1] = "sf_comisionista";
  ajax_field_list[2] = "sf_tipo_firma";
  ajax_field_list[3] = "sf_duracion";
  ajax_field_list[4] = "sf_tipo_identificacion";
  ajax_field_list[5] = "sf_identificacion";
  ajax_field_list[6] = "sf_nombre";
  ajax_field_list[7] = "sf_direcccion";
  ajax_field_list[8] = "sf_telefono";
  ajax_field_list[9] = "sf_email";
  ajax_field_list[10] = "sf_estado";
  ajax_field_list[11] = "documentos";
  ...
  var ajax_error_list = {
    "sf_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sf_comisionista": {"label": "<?php echo $this->Ini->Nm_lang['lang_comisionistas'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sf_tipo_firma": {"label": "<?php echo $this->Ini->Nm_lang['lang_tipo_firma'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sf_duracion": {"label": "<?php echo $this->Ini->Nm_lang['lang_duracion_firma'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sf_tipo_identificacion": {"label": "<?php echo $this->Ini->Nm_lang['lang_tipo_identificacion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sf_identificacion": {"label": "<?php echo $this->Ini->Nm_lang['lang_lot_identificacion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sf_nombre": {"label": "<?php echo $this->Ini->Nm_lang['lang_nombre'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sf_direcccion": {"label": "<?php echo $this->Ini->Nm_lang['lang_direccion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sf_telefono": {"label": "<?php echo $this->Ini->Nm_lang['lang_lot_telefono'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sf_email": {"label": "<?php echo $this->Ini->Nm_lang['lang_email'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sf_estado": {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "documentos": {"label": "<?php echo $this->Ini->Nm_lang['lang_documentos'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "sf_id": new Array(),
    "sf_comisionista": new Array(),
    "sf_tipo_firma": new Array(),
    "sf_duracion": new Array(),
    "sf_tipo_identificacion": new Array(),
    "sf_identificacion": new Array(),
    "sf_nombre": new Array(),
    "sf_direcccion": new Array(),
    "sf_telefono": new Array(),
    "sf_email": new Array(),
    "sf_estado": new Array(),
    "documentos": new Array()
  };
  ajax_field_mult["sf_id"][1] = "sf_id";
  ajax_field_mult["sf_comisionista"][1] = "sf_comisionista";
  ajax_field_mult["sf_tipo_firma"][1] = "sf_tipo_firma";
  ajax_field_mult["sf_duracion"][1] = "sf_duracion";
  ajax_field_mult["sf_tipo_identificacion"][1] = "sf_tipo_identificacion";
  ajax_field_mult["sf_identificacion"][1] = "sf_identificacion";
  ajax_field_mult["sf_nombre"][1] = "sf_nombre";
  ajax_field_mult["sf_direcccion"][1] = "sf_direcccion";
  ajax_field_mult["sf_telefono"][1] = "sf_telefono";
  ajax_field_mult["sf_email"][1] = "sf_email";
  ajax_field_mult["sf_estado"][1] = "sf_estado";
  ajax_field_mult["documentos"][1] = "documentos";

  var ajax_field_id = {
    "sf_comisionista": new Array("hidden_field_label_sf_comisionista", "hidden_field_data_sf_comisionista"),
    "sf_tipo_firma": new Array("hidden_field_label_sf_tipo_firma", "hidden_field_data_sf_tipo_firma"),
    "sf_duracion": new Array("hidden_field_label_sf_duracion", "hidden_field_data_sf_duracion"),
    "sf_tipo_identificacion": new Array("hidden_field_label_sf_tipo_identificacion", "hidden_field_data_sf_tipo_identificacion"),
    "sf_identificacion": new Array("hidden_field_label_sf_identificacion", "hidden_field_data_sf_identificacion"),
    "sf_nombre": new Array("hidden_field_label_sf_nombre", "hidden_field_data_sf_nombre"),
    "sf_direcccion": new Array("hidden_field_label_sf_direcccion", "hidden_field_data_sf_direcccion"),
    "sf_telefono": new Array("hidden_field_label_sf_telefono", "hidden_field_data_sf_telefono"),
    "sf_email": new Array("hidden_field_label_sf_email", "hidden_field_data_sf_email"),
    "sf_estado": new Array("hidden_field_label_sf_estado", "hidden_field_data_sf_estado"),
  ...
  var ajax_read_only = {
    ...
    "sf_tipo_firma": "off",
    "sf_duracion": "off",
    "sf_tipo_identificacion": "off",
    "sf_identificacion": "off",
    "sf_nombre": "off",
    "sf_direcccion": "off",
    "sf_telefono": "off",
    "sf_email": "off",
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("sf_tipo_identificacion" == sIndex)
    {
      scAjaxSetFieldSelect(sIndex, aValue, null);
      updateHeaderFooter(sIndex, aValue);
