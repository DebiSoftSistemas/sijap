  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_punto_emision_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_punto_emision_mob_form();
	}
...
?>
  ...
  // ---------- Validate pem_id
  function do_ajax_form_del_punto_emision_mob_validate_pem_id()
  {
    var nomeCampo_pem_id = "pem_id";
    var var_pem_id = scAjaxGetFieldHidden(nomeCampo_pem_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_emision_mob_validate_pem_id(var_pem_id, var_script_case_init, do_ajax_form_del_punto_emision_mob_validate_pem_id_cb);
  } // do_ajax_form_del_punto_emision_mob_validate_pem_id

  function do_ajax_form_del_punto_emision_mob_validate_pem_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_emision_mob_validate_pem_id_cb

  // ---------- Validate pem_establecimiento
  function do_ajax_form_del_punto_emision_mob_validate_pem_establecimiento()
  {
    var nomeCampo_pem_establecimiento = "pem_establecimiento";
    var var_pem_establecimiento = scAjaxGetFieldSelect(nomeCampo_pem_establecimiento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_emision_mob_validate_pem_establecimiento(var_pem_establecimiento, var_script_case_init, do_ajax_form_del_punto_emision_mob_validate_pem_establecimiento_cb);
  } // do_ajax_form_del_punto_emision_mob_validate_pem_establecimiento

  function do_ajax_form_del_punto_emision_mob_validate_pem_establecimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pem_establecimiento";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_emision_mob_validate_pem_establecimiento_cb

  // ---------- Validate pem_nombre
  function do_ajax_form_del_punto_emision_mob_validate_pem_nombre()
  {
    var nomeCampo_pem_nombre = "pem_nombre";
    var var_pem_nombre = scAjaxGetFieldText(nomeCampo_pem_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_emision_mob_validate_pem_nombre(var_pem_nombre, var_script_case_init, do_ajax_form_del_punto_emision_mob_validate_pem_nombre_cb);
  } // do_ajax_form_del_punto_emision_mob_validate_pem_nombre

  function do_ajax_form_del_punto_emision_mob_validate_pem_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pem_nombre";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_emision_mob_validate_pem_nombre_cb

  // ---------- Validate pen_serie
  function do_ajax_form_del_punto_emision_mob_validate_pen_serie()
  {
    var nomeCampo_pen_serie = "pen_serie";
    var var_pen_serie = scAjaxGetFieldText(nomeCampo_pen_serie);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_emision_mob_validate_pen_serie(var_pen_serie, var_script_case_init, do_ajax_form_del_punto_emision_mob_validate_pen_serie_cb);
  } // do_ajax_form_del_punto_emision_mob_validate_pen_serie

  function do_ajax_form_del_punto_emision_mob_validate_pen_serie_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pen_serie";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_emision_mob_validate_pen_serie_cb

  // ---------- Validate pem_estado
  function do_ajax_form_del_punto_emision_mob_validate_pem_estado()
  {
    var nomeCampo_pem_estado = "pem_estado";
    var var_pem_estado = scAjaxGetFieldSelect(nomeCampo_pem_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_emision_mob_validate_pem_estado(var_pem_estado, var_script_case_init, do_ajax_form_del_punto_emision_mob_validate_pem_estado_cb);
  } // do_ajax_form_del_punto_emision_mob_validate_pem_estado

  function do_ajax_form_del_punto_emision_mob_validate_pem_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pem_estado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_emision_mob_validate_pem_estado_cb

  // ---------- Validate pem_empresa
  function do_ajax_form_del_punto_emision_mob_validate_pem_empresa()
  {
    var nomeCampo_pem_empresa = "pem_empresa";
    var var_pem_empresa = scAjaxGetFieldText(nomeCampo_pem_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_emision_mob_validate_pem_empresa(var_pem_empresa, var_script_case_init, do_ajax_form_del_punto_emision_mob_validate_pem_empresa_cb);
  } // do_ajax_form_del_punto_emision_mob_validate_pem_empresa

  function do_ajax_form_del_punto_emision_mob_validate_pem_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pem_empresa";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_emision_mob_validate_pem_empresa_cb

  // ---------- Validate pem_tipo
  function do_ajax_form_del_punto_emision_mob_validate_pem_tipo()
  {
    var nomeCampo_pem_tipo = "pem_tipo";
    var var_pem_tipo = scAjaxGetFieldText(nomeCampo_pem_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_emision_mob_validate_pem_tipo(var_pem_tipo, var_script_case_init, do_ajax_form_del_punto_emision_mob_validate_pem_tipo_cb);
  } // do_ajax_form_del_punto_emision_mob_validate_pem_tipo

  function do_ajax_form_del_punto_emision_mob_validate_pem_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pem_tipo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_emision_mob_validate_pem_tipo_cb

  // ---------- Validate libretines
  function do_ajax_form_del_punto_emision_mob_validate_libretines()
  {
    var nomeCampo_libretines = "libretines";
    var var_libretines = scAjaxGetFieldText(nomeCampo_libretines);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_emision_mob_validate_libretines(var_libretines, var_script_case_init, do_ajax_form_del_punto_emision_mob_validate_libretines_cb);
  } // do_ajax_form_del_punto_emision_mob_validate_libretines

  function do_ajax_form_del_punto_emision_mob_validate_libretines_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "libretines";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_emision_mob_validate_libretines_cb

  // ---------- Validate libretin_sinpago
  function do_ajax_form_del_punto_emision_mob_validate_libretin_sinpago()
  {
    var nomeCampo_libretin_sinpago = "libretin_sinpago";
    var var_libretin_sinpago = scAjaxGetFieldText(nomeCampo_libretin_sinpago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_emision_mob_validate_libretin_sinpago(var_libretin_sinpago, var_script_case_init, do_ajax_form_del_punto_emision_mob_validate_libretin_sinpago_cb);
  } // do_ajax_form_del_punto_emision_mob_validate_libretin_sinpago

  function do_ajax_form_del_punto_emision_mob_validate_libretin_sinpago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "libretin_sinpago";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_emision_mob_validate_libretin_sinpago_cb

  // ---------- Validate usuarios
  function do_ajax_form_del_punto_emision_mob_validate_usuarios()
  {
    var nomeCampo_usuarios = "usuarios";
    var var_usuarios = scAjaxGetFieldText(nomeCampo_usuarios);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_punto_emision_mob_validate_usuarios(var_usuarios, var_script_case_init, do_ajax_form_del_punto_emision_mob_validate_usuarios_cb);
  } // do_ajax_form_del_punto_emision_mob_validate_usuarios

  function do_ajax_form_del_punto_emision_mob_validate_usuarios_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_punto_emision_mob_validate_usuarios_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_punto_emision_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_punto_emision_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_pem_id = scAjaxGetFieldHidden("pem_id");
    var var_pem_establecimiento = scAjaxGetFieldSelect("pem_establecimiento");
    var var_pem_nombre = scAjaxGetFieldText("pem_nombre");
    var var_pen_serie = scAjaxGetFieldText("pen_serie");
    var var_pem_estado = scAjaxGetFieldSelect("pem_estado");
    var var_pem_empresa = scAjaxGetFieldText("pem_empresa");
    var var_pem_tipo = scAjaxGetFieldText("pem_tipo");
    ...
    scAjaxProcOn();
    x_ajax_form_del_punto_emision_mob_submit_form(var_pem_id, var_pem_establecimiento, var_pem_nombre, var_pen_serie, var_pem_estado, var_pem_empresa, var_pem_tipo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_punto_emision_mob_submit_form_cb);
  } // do_ajax_form_del_punto_emision_mob_submit_form

  function do_ajax_form_del_punto_emision_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("pem_id");
      scAjaxHideErrorDisplay("pem_establecimiento");
      scAjaxHideErrorDisplay("pem_nombre");
      scAjaxHideErrorDisplay("pen_serie");
      scAjaxHideErrorDisplay("pem_estado");
      scAjaxHideErrorDisplay("pem_empresa");
      scAjaxHideErrorDisplay("pem_tipo");
      scAjaxHideErrorDisplay("libretines");
      scAjaxHideErrorDisplay("libretin_sinpago");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_punto_emision_mob_submit_form_cb_after_alert);
  } // do_ajax_form_del_punto_emision_mob_submit_form_cb
  function do_ajax_form_del_punto_emision_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_punto_emision_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["grid_del_libretin"] = "off";
  scStatusDetail["form_del_libretin_sinpago_mob"] = "off";
  scStatusDetail["form_del_usuario_punto_emision_mob"] = "off";

  function do_ajax_form_del_punto_emision_mob_navigate_form()
  {
    perform_ajax_form_del_punto_emision_mob_navigate_form();
  }

  function perform_ajax_form_del_punto_emision_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("libretin_sinpago");
    scAjaxHideErrorDisplay("usuarios");
    var var_pem_id = document.F2.pem_id.value;
    ...
    scAjaxProcOn();
    scStatusDetail["grid_del_libretin"] = "on";
    scStatusDetail["form_del_libretin_sinpago_mob"] = "on";
    scStatusDetail["form_del_usuario_punto_emision_mob"] = "on";
    x_ajax_form_del_punto_emision_mob_navigate_form(var_pem_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_punto_emision_mob_navigate_form_cb);
  } // do_ajax_form_del_punto_emision_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_punto_emision_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_punto_emision_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.pem_id.value = scAjaxGetKeyValue("pem_id");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_grid_del_libretin"] && "nmsc_iframe_liga_grid_del_libretin" != scMasterDetailIframe["nmsc_iframe_liga_grid_del_libretin"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_grid_del_libretin"]);
    }
    else {
        if (oResp["navSummary"].reg_tot != 0) {
            document.getElementById('nmsc_iframe_liga_grid_del_libretin').contentWindow.nm_move('apl_detalhe', true, '400');
        }
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_del_libretin_sinpago_mob"] && "nmsc_iframe_liga_form_del_libretin_sinpago_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_del_libretin_sinpago_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_del_libretin_sinpago_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_del_libretin_sinpago_mob').contentWindow.nm_move('apl_detalhe', true, '400');
        document.getElementById('nmsc_iframe_liga_form_del_libretin_sinpago_mob').style.height = "400";
        document.getElementById('nmsc_iframe_liga_form_del_libretin_sinpago_mob').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_del_usuario_punto_emision_mob"] && "nmsc_iframe_liga_form_del_usuario_punto_emision_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_del_usuario_punto_emision_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_del_usuario_punto_emision_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_del_usuario_punto_emision_mob').contentWindow.nm_move('apl_detalhe', true, '400');
        document.getElementById('nmsc_iframe_liga_form_del_usuario_punto_emision_mob').style.height = "400";
        document.getElementById('nmsc_iframe_liga_form_del_usuario_punto_emision_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_punto_emision_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_del_punto_emision_mob_navigate_form_cb
  function do_ajax_form_del_punto_emision_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_del_punto_emision_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_del_punto_emision_mob_navigate_form_cb_after_alert

  function sc_hide_form_del_punto_emision_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["grid_del_libretin"] && "off" == scStatusDetail["form_del_libretin_sinpago_mob"] && "off" == scStatusDetail["form_del_usuario_punto_emision_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "pem_id";
  ajax_field_list[1] = "pem_establecimiento";
  ajax_field_list[2] = "pem_nombre";
  ajax_field_list[3] = "pen_serie";
  ajax_field_list[4] = "pem_estado";
  ajax_field_list[5] = "pem_empresa";
  ajax_field_list[6] = "pem_tipo";
  ajax_field_list[7] = "libretines";
  ajax_field_list[8] = "libretin_sinpago";
  ajax_field_list[9] = "usuarios";
  ...
  var ajax_error_list = {
    "pem_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pem_establecimiento": {"label": "<?php echo $this->Ini->Nm_lang['lang_establecimiento'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pem_nombre": {"label": "<?php echo $this->Ini->Nm_lang['lang_nombre'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pen_serie": {"label": "<?php echo $this->Ini->Nm_lang['lang_punto_emision'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pem_estado": {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pem_empresa": {"label": "<?php echo $this->Ini->Nm_lang['lang_empresa'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pem_tipo": {"label": "<?php echo $this->Ini->Nm_lang['lang_tipo'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "libretines": {"label": "libretines", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "libretin_sinpago": {"label": "libretin_sinpago", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "pem_id": new Array(),
    "pem_establecimiento": new Array(),
    "pem_nombre": new Array(),
    "pen_serie": new Array(),
    "pem_estado": new Array(),
    "pem_empresa": new Array(),
    "pem_tipo": new Array(),
    "libretines": new Array(),
    "libretin_sinpago": new Array(),
    "usuarios": new Array()
  };
  ajax_field_mult["pem_id"][1] = "pem_id";
  ajax_field_mult["pem_establecimiento"][1] = "pem_establecimiento";
  ajax_field_mult["pem_nombre"][1] = "pem_nombre";
  ajax_field_mult["pen_serie"][1] = "pen_serie";
  ajax_field_mult["pem_estado"][1] = "pem_estado";
  ajax_field_mult["pem_empresa"][1] = "pem_empresa";
  ajax_field_mult["pem_tipo"][1] = "pem_tipo";
  ajax_field_mult["libretines"][1] = "libretines";
  ajax_field_mult["libretin_sinpago"][1] = "libretin_sinpago";
  ajax_field_mult["usuarios"][1] = "usuarios";

  var ajax_field_id = {
    "pem_establecimiento": new Array("hidden_field_label_pem_establecimiento", "hidden_field_data_pem_establecimiento"),
    "pem_nombre": new Array("hidden_field_label_pem_nombre", "hidden_field_data_pem_nombre"),
    "pen_serie": new Array("hidden_field_label_pen_serie", "hidden_field_data_pen_serie"),
    "pem_estado": new Array("hidden_field_label_pem_estado", "hidden_field_data_pem_estado"),
    "libretines": new Array("hidden_field_label_libretines", "hidden_field_data_libretines"),
    "libretin_sinpago": new Array("hidden_field_label_libretin_sinpago", "hidden_field_data_libretin_sinpago"),
    "usuarios": new Array("hidden_field_label_usuarios", "hidden_field_data_usuarios")
  };

  var ajax_read_only = {
    "pem_id": "on",
    "pem_establecimiento": "off",
    "pem_nombre": "off",
    "pen_serie": "off",
    "pem_estado": "off",
    "pem_empresa": "off",
