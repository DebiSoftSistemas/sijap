  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_jap_registro_lecturas" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_jap_registro_lecturas_form();
	}
...
?>
  ...
  // ---------- Validate esc_id
  function do_ajax_form_jap_registro_lecturas_validate_esc_id()
  {
    var nomeCampo_esc_id = "esc_id";
    var var_esc_id = scAjaxGetFieldHidden(nomeCampo_esc_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_registro_lecturas_validate_esc_id(var_esc_id, var_script_case_init, do_ajax_form_jap_registro_lecturas_validate_esc_id_cb);
  } // do_ajax_form_jap_registro_lecturas_validate_esc_id

  function do_ajax_form_jap_registro_lecturas_validate_esc_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_registro_lecturas_validate_esc_id_cb

  // ---------- Validate esc_tipo_deuda
  function do_ajax_form_jap_registro_lecturas_validate_esc_tipo_deuda()
  {
    var nomeCampo_esc_tipo_deuda = "esc_tipo_deuda";
    var var_esc_tipo_deuda = scAjaxGetFieldSelect(nomeCampo_esc_tipo_deuda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_registro_lecturas_validate_esc_tipo_deuda(var_esc_tipo_deuda, var_script_case_init, do_ajax_form_jap_registro_lecturas_validate_esc_tipo_deuda_cb);
  } // do_ajax_form_jap_registro_lecturas_validate_esc_tipo_deuda

  function do_ajax_form_jap_registro_lecturas_validate_esc_tipo_deuda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_registro_lecturas_validate_esc_tipo_deuda_cb

  // ---------- Validate esc_mes_periodo
  function do_ajax_form_jap_registro_lecturas_validate_esc_mes_periodo()
  {
    var nomeCampo_esc_mes_periodo = "esc_mes_periodo";
    var var_esc_mes_periodo = scAjaxGetFieldSelect(nomeCampo_esc_mes_periodo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_registro_lecturas_validate_esc_mes_periodo(var_esc_mes_periodo, var_script_case_init, do_ajax_form_jap_registro_lecturas_validate_esc_mes_periodo_cb);
  } // do_ajax_form_jap_registro_lecturas_validate_esc_mes_periodo

  function do_ajax_form_jap_registro_lecturas_validate_esc_mes_periodo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_registro_lecturas_validate_esc_mes_periodo_cb

  // ---------- Validate esc_anio_periodo
  function do_ajax_form_jap_registro_lecturas_validate_esc_anio_periodo()
  {
    var nomeCampo_esc_anio_periodo = "esc_anio_periodo";
    var var_esc_anio_periodo = scAjaxGetFieldSelect(nomeCampo_esc_anio_periodo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_registro_lecturas_validate_esc_anio_periodo(var_esc_anio_periodo, var_script_case_init, do_ajax_form_jap_registro_lecturas_validate_esc_anio_periodo_cb);
  } // do_ajax_form_jap_registro_lecturas_validate_esc_anio_periodo

  function do_ajax_form_jap_registro_lecturas_validate_esc_anio_periodo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_registro_lecturas_validate_esc_anio_periodo_cb

  // ---------- Validate esc_ruta
  function do_ajax_form_jap_registro_lecturas_validate_esc_ruta()
  {
    var nomeCampo_esc_ruta = "esc_ruta";
    var var_esc_ruta = scAjaxGetFieldSelect(nomeCampo_esc_ruta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_registro_lecturas_validate_esc_ruta(var_esc_ruta, var_script_case_init, do_ajax_form_jap_registro_lecturas_validate_esc_ruta_cb);
  } // do_ajax_form_jap_registro_lecturas_validate_esc_ruta

  function do_ajax_form_jap_registro_lecturas_validate_esc_ruta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_registro_lecturas_validate_esc_ruta_cb

  // ---------- Validate esc_total
  function do_ajax_form_jap_registro_lecturas_validate_esc_total()
  {
    var nomeCampo_esc_total = "esc_total";
    var var_esc_total = scAjaxGetFieldText(nomeCampo_esc_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_registro_lecturas_validate_esc_total(var_esc_total, var_script_case_init, do_ajax_form_jap_registro_lecturas_validate_esc_total_cb);
  } // do_ajax_form_jap_registro_lecturas_validate_esc_total

  function do_ajax_form_jap_registro_lecturas_validate_esc_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_registro_lecturas_validate_esc_total_cb

  // ---------- Validate esc_estado
  function do_ajax_form_jap_registro_lecturas_validate_esc_estado()
  {
    var nomeCampo_esc_estado = "esc_estado";
    var var_esc_estado = scAjaxGetFieldText(nomeCampo_esc_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_registro_lecturas_validate_esc_estado(var_esc_estado, var_script_case_init, do_ajax_form_jap_registro_lecturas_validate_esc_estado_cb);
  } // do_ajax_form_jap_registro_lecturas_validate_esc_estado

  function do_ajax_form_jap_registro_lecturas_validate_esc_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_registro_lecturas_validate_esc_estado_cb

  // ---------- Validate detalles
  function do_ajax_form_jap_registro_lecturas_validate_detalles()
  {
    var nomeCampo_detalles = "detalles";
    var var_detalles = scAjaxGetFieldText(nomeCampo_detalles);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_registro_lecturas_validate_detalles(var_detalles, var_script_case_init, do_ajax_form_jap_registro_lecturas_validate_detalles_cb);
  } // do_ajax_form_jap_registro_lecturas_validate_detalles

  function do_ajax_form_jap_registro_lecturas_validate_detalles_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_registro_lecturas_validate_detalles_cb

  // ---------- Validate esc_empresa
  function do_ajax_form_jap_registro_lecturas_validate_esc_empresa()
  {
    var nomeCampo_esc_empresa = "esc_empresa";
    var var_esc_empresa = scAjaxGetFieldText(nomeCampo_esc_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_registro_lecturas_validate_esc_empresa(var_esc_empresa, var_script_case_init, do_ajax_form_jap_registro_lecturas_validate_esc_empresa_cb);
  } // do_ajax_form_jap_registro_lecturas_validate_esc_empresa

  function do_ajax_form_jap_registro_lecturas_validate_esc_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_registro_lecturas_validate_esc_empresa_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_jap_registro_lecturas_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_jap_registro_lecturas_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_jap_registro_lecturas_submit_form(var_esc_id, var_esc_tipo_deuda, var_esc_mes_periodo, var_esc_anio_periodo, var_esc_ruta, var_esc_total, var_esc_estado, var_esc_empresa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_jap_registro_lecturas_submit_form_cb);
  } // do_ajax_form_jap_registro_lecturas_submit_form

  function do_ajax_form_jap_registro_lecturas_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_jap_registro_lecturas_submit_form_cb_after_alert);
  } // do_ajax_form_jap_registro_lecturas_submit_form_cb
  function do_ajax_form_jap_registro_lecturas_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_jap_registro_lecturas_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_jap_registro_deuda_lectura"] = "off";

  function do_ajax_form_jap_registro_lecturas_navigate_form()
  {
    perform_ajax_form_jap_registro_lecturas_navigate_form();
  }

  function perform_ajax_form_jap_registro_lecturas_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_jap_registro_lecturas_navigate_form(var_esc_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jap_registro_lecturas_navigate_form_cb);
  } // do_ajax_form_jap_registro_lecturas_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_registro_lecturas']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_jap_registro_lecturas_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_jap_registro_deuda_lectura"] && "nmsc_iframe_liga_form_jap_registro_deuda_lectura" != scMasterDetailIframe["nmsc_iframe_liga_form_jap_registro_deuda_lectura"]) {
        ...
        document.getElementById('nmsc_iframe_liga_form_jap_registro_deuda_lectura').contentWindow.nm_move('apl_detalhe', true, '400');
        document.getElementById('nmsc_iframe_liga_form_jap_registro_deuda_lectura').style.height = "400";
        document.getElementById('nmsc_iframe_liga_form_jap_registro_deuda_lectura').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_jap_registro_lecturas_navigate_form_cb_after_alert);
  } // do_ajax_form_jap_registro_lecturas_navigate_form_cb
  function do_ajax_form_jap_registro_lecturas_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_jap_registro_lecturas_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_jap_registro_lecturas_navigate_form_cb_after_alert

  function sc_hide_form_jap_registro_lecturas_form()
  {
