...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "con_propietario";$Nm_numeric[] = "con_comunidad";$Nm_numeric[] = "con_sector";$Nm_numeric[] = "con_propietario";$Nm_numeric[] = "con_comunidad";$Nm_numeric[] = "con_sector";
...
?>
   <span id="idAjaxSelect_con_comunidad">
      <SELECT class="scFilterObjectOdd" id="SC_con_comunidad" name="con_comunidad[]"  size="7" multiple>
<?php
...
?>
 ...
 function limpa_form()
 {
   ...
   {
      if (document.F1.elements[i].name == 'con_comunidad[]')
      {
...
<?php
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "con_comunidad" : return ('class="scFilterObjectOdd"'); break;
         default       : return ("");
      }
   }
