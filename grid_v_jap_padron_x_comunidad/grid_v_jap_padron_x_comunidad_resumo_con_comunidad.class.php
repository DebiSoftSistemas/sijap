...
SCEOT;
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_con_comunidad = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_comunidad']['arr_total']['con_comunidad'];
      }
      else
      {
          $this->array_total_con_comunidad = array();
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_comunidad']['summarizing_fields_order']['con_comunidad']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_comunidad']['summarizing_fields_order']['con_comunidad'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_comunidad']['summarizing_fields_order']['con_comunidad'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_comunidad']['summarizing_fields_display']['con_comunidad'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_comunidad']['summarizing_fields_display']['con_comunidad'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_comunidad']['summarizing_fields_display']['con_comunidad'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_comunidad']['summarizing_fields_display']['con_comunidad'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_comunidad']['summarizing_fields_display']['con_comunidad'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_comunidad']['summarizing_fields_display']['con_comunidad'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_comunidad']['summarizing_fields_display']['con_comunidad'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_con_comunidad as $i_con_comunidad => $d_con_comunidad) {
           if (!isset($i_con_comunidad, $this->comp_label[0]) || !in_array($i_con_comunidad, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_con_comunidad[2] ] = $d_con_comunidad[1];
               $this->comp_label[0][ $d_con_comunidad[2] ] = $d_con_comunidad[1];
           }
       }
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_con_comunidad => $l_con_comunidad) {
           if (isset($this->array_total_con_comunidad[$i_con_comunidad])) {
               $this->comp_group[$i_con_comunidad] = array();
           }
       }
     }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_con_comunidad;
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_comunidad']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_comunidad']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_con_comunidad("res", $this->NM_export);
      ...
      if (is_array($this->array_total_con_comunidad)) {
          ksort($this->array_total_con_comunidad);
      }
   }
...
{ 
   ...
   //---- 
   function adiciona_registro($quebra_con_comunidad, $quebra_con_comunidad_orig)
   {
      //----- con_comunidad
      if (!isset($this->array_total_con_comunidad[$quebra_con_comunidad_orig]))
      {
         $this->array_total_con_comunidad[$quebra_con_comunidad_orig][0] = 1;
         $this->array_total_con_comunidad[$quebra_con_comunidad_orig][1] = $quebra_con_comunidad;
         $this->array_total_con_comunidad[$quebra_con_comunidad_orig][2] = $quebra_con_comunidad_orig;
      }
      else
      {
         $this->array_total_con_comunidad[$quebra_con_comunidad_orig][0]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('con_comunidad', 'con_comunidad');
     $campos_order = $this->Ini->Get_date_order_groupby("con_comunidad", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->con_comunidad = $this->look_con_comunidad ;
            $this->con_sector = $this->look_con_sector ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->con_comunidad, $this->con_comunidad_orig);
            }
   }
//
