  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_autorizar_comisionista_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_autorizar_comisionista_mob_form();
	}
...
?>
  ...
  // ---------- Validate com_ruc
  function do_ajax_form_del_autorizar_comisionista_mob_validate_com_ruc()
  {
    var nomeCampo_com_ruc = "com_ruc";
    var var_com_ruc = scAjaxGetFieldText(nomeCampo_com_ruc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_autorizar_comisionista_mob_validate_com_ruc(var_com_ruc, var_script_case_init, do_ajax_form_del_autorizar_comisionista_mob_validate_com_ruc_cb);
  } // do_ajax_form_del_autorizar_comisionista_mob_validate_com_ruc

  function do_ajax_form_del_autorizar_comisionista_mob_validate_com_ruc_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_autorizar_comisionista_mob_validate_com_ruc_cb

  // ---------- Validate com_razon_social
  function do_ajax_form_del_autorizar_comisionista_mob_validate_com_razon_social()
  {
    var nomeCampo_com_razon_social = "com_razon_social";
    var var_com_razon_social = scAjaxGetFieldText(nomeCampo_com_razon_social);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_autorizar_comisionista_mob_validate_com_razon_social(var_com_razon_social, var_script_case_init, do_ajax_form_del_autorizar_comisionista_mob_validate_com_razon_social_cb);
  } // do_ajax_form_del_autorizar_comisionista_mob_validate_com_razon_social

  function do_ajax_form_del_autorizar_comisionista_mob_validate_com_razon_social_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "com_razon_social";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_autorizar_comisionista_mob_validate_com_razon_social_cb

  // ---------- Validate com_nombre_comercial
  function do_ajax_form_del_autorizar_comisionista_mob_validate_com_nombre_comercial()
  {
    var nomeCampo_com_nombre_comercial = "com_nombre_comercial";
    var var_com_nombre_comercial = scAjaxGetFieldText(nomeCampo_com_nombre_comercial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_autorizar_comisionista_mob_validate_com_nombre_comercial(var_com_nombre_comercial, var_script_case_init, do_ajax_form_del_autorizar_comisionista_mob_validate_com_nombre_comercial_cb);
  } // do_ajax_form_del_autorizar_comisionista_mob_validate_com_nombre_comercial

  function do_ajax_form_del_autorizar_comisionista_mob_validate_com_nombre_comercial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "com_nombre_comercial";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_autorizar_comisionista_mob_validate_com_nombre_comercial_cb

  // ---------- Validate com_actividad
  function do_ajax_form_del_autorizar_comisionista_mob_validate_com_actividad()
  {
    var nomeCampo_com_actividad = "com_actividad";
    var var_com_actividad = scAjaxGetFieldSelect(nomeCampo_com_actividad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_autorizar_comisionista_mob_validate_com_actividad(var_com_actividad, var_script_case_init, do_ajax_form_del_autorizar_comisionista_mob_validate_com_actividad_cb);
  } // do_ajax_form_del_autorizar_comisionista_mob_validate_com_actividad

  function do_ajax_form_del_autorizar_comisionista_mob_validate_com_actividad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "com_actividad";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_autorizar_comisionista_mob_validate_com_actividad_cb

  // ---------- Validate com_direccion
  function do_ajax_form_del_autorizar_comisionista_mob_validate_com_direccion()
  {
    var nomeCampo_com_direccion = "com_direccion";
    var var_com_direccion = scAjaxGetFieldText(nomeCampo_com_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_autorizar_comisionista_mob_validate_com_direccion(var_com_direccion, var_script_case_init, do_ajax_form_del_autorizar_comisionista_mob_validate_com_direccion_cb);
  } // do_ajax_form_del_autorizar_comisionista_mob_validate_com_direccion

  function do_ajax_form_del_autorizar_comisionista_mob_validate_com_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "com_direccion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_autorizar_comisionista_mob_validate_com_direccion_cb

  // ---------- Validate com_telefono
  function do_ajax_form_del_autorizar_comisionista_mob_validate_com_telefono()
  {
    var nomeCampo_com_telefono = "com_telefono";
    var var_com_telefono = scAjaxGetFieldText(nomeCampo_com_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_autorizar_comisionista_mob_validate_com_telefono(var_com_telefono, var_script_case_init, do_ajax_form_del_autorizar_comisionista_mob_validate_com_telefono_cb);
  } // do_ajax_form_del_autorizar_comisionista_mob_validate_com_telefono

  function do_ajax_form_del_autorizar_comisionista_mob_validate_com_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "com_telefono";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_autorizar_comisionista_mob_validate_com_telefono_cb

  // ---------- Validate com_email
  function do_ajax_form_del_autorizar_comisionista_mob_validate_com_email()
  {
    var nomeCampo_com_email = "com_email";
    var var_com_email = scAjaxGetFieldText(nomeCampo_com_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_autorizar_comisionista_mob_validate_com_email(var_com_email, var_script_case_init, do_ajax_form_del_autorizar_comisionista_mob_validate_com_email_cb);
  } // do_ajax_form_del_autorizar_comisionista_mob_validate_com_email

  function do_ajax_form_del_autorizar_comisionista_mob_validate_com_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "com_email";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_autorizar_comisionista_mob_validate_com_email_cb

  // ---------- Validate com_porcentaje_comision
  function do_ajax_form_del_autorizar_comisionista_mob_validate_com_porcentaje_comision()
  {
    var nomeCampo_com_porcentaje_comision = "com_porcentaje_comision";
    var var_com_porcentaje_comision = scAjaxGetFieldSelect(nomeCampo_com_porcentaje_comision);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_autorizar_comisionista_mob_validate_com_porcentaje_comision(var_com_porcentaje_comision, var_script_case_init, do_ajax_form_del_autorizar_comisionista_mob_validate_com_porcentaje_comision_cb);
  } // do_ajax_form_del_autorizar_comisionista_mob_validate_com_porcentaje_comision

  function do_ajax_form_del_autorizar_comisionista_mob_validate_com_porcentaje_comision_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "com_porcentaje_comision";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_autorizar_comisionista_mob_validate_com_porcentaje_comision_cb

  // ---------- Validate com_estado
  function do_ajax_form_del_autorizar_comisionista_mob_validate_com_estado()
  {
    var nomeCampo_com_estado = "com_estado";
    var var_com_estado = scAjaxGetFieldSelect(nomeCampo_com_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_autorizar_comisionista_mob_validate_com_estado(var_com_estado, var_script_case_init, do_ajax_form_del_autorizar_comisionista_mob_validate_com_estado_cb);
  } // do_ajax_form_del_autorizar_comisionista_mob_validate_com_estado

  function do_ajax_form_del_autorizar_comisionista_mob_validate_com_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "com_estado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_autorizar_comisionista_mob_validate_com_estado_cb

  // ---------- Event onblur com_ruc
  function do_ajax_form_del_autorizar_comisionista_mob_event_com_ruc_onblur()
  {
    var var_com_ruc = scAjaxGetFieldText("com_ruc");
    var var_com_razon_social = scAjaxGetFieldText("com_razon_social");
    var var_com_direccion = scAjaxGetFieldText("com_direccion");
    var var_com_email = scAjaxGetFieldText("com_email");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_autorizar_comisionista_mob_event_com_ruc_onblur(var_com_ruc, var_com_razon_social, var_com_direccion, var_com_email, var_script_case_init, do_ajax_form_del_autorizar_comisionista_mob_event_com_ruc_onblur_cb);
  } // do_ajax_form_del_autorizar_comisionista_mob_event_com_ruc_onblur

  function do_ajax_form_del_autorizar_comisionista_mob_event_com_ruc_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "com_ruc";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_autorizar_comisionista_mob_event_com_ruc_onblur_cb_after_alert);
  } // do_ajax_form_del_autorizar_comisionista_mob_event_com_ruc_onblur_cb
  function do_ajax_form_del_autorizar_comisionista_mob_event_com_ruc_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_autorizar_comisionista_mob_event_com_ruc_onblur_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_autorizar_comisionista_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_autorizar_comisionista_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_com_ruc = scAjaxGetFieldText("com_ruc");
    var var_com_razon_social = scAjaxGetFieldText("com_razon_social");
    var var_com_nombre_comercial = scAjaxGetFieldText("com_nombre_comercial");
    var var_com_actividad = scAjaxGetFieldSelect("com_actividad");
    var var_com_direccion = scAjaxGetFieldText("com_direccion");
    var var_com_telefono = scAjaxGetFieldText("com_telefono");
    var var_com_email = scAjaxGetFieldText("com_email");
    var var_com_porcentaje_comision = scAjaxGetFieldSelect("com_porcentaje_comision");
    var var_com_estado = scAjaxGetFieldSelect("com_estado");
    ...
    scAjaxProcOn();
    x_ajax_form_del_autorizar_comisionista_mob_submit_form(var_com_ruc, var_com_razon_social, var_com_nombre_comercial, var_com_actividad, var_com_direccion, var_com_telefono, var_com_email, var_com_porcentaje_comision, var_com_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_autorizar_comisionista_mob_submit_form_cb);
  } // do_ajax_form_del_autorizar_comisionista_mob_submit_form

  function do_ajax_form_del_autorizar_comisionista_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("com_ruc");
      scAjaxHideErrorDisplay("com_razon_social");
      scAjaxHideErrorDisplay("com_nombre_comercial");
      scAjaxHideErrorDisplay("com_actividad");
      scAjaxHideErrorDisplay("com_direccion");
      scAjaxHideErrorDisplay("com_telefono");
      scAjaxHideErrorDisplay("com_email");
      scAjaxHideErrorDisplay("com_porcentaje_comision");
      scAjaxHideErrorDisplay("com_estado");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_autorizar_comisionista_mob_submit_form_cb_after_alert);
  } // do_ajax_form_del_autorizar_comisionista_mob_submit_form_cb
  function do_ajax_form_del_autorizar_comisionista_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_autorizar_comisionista_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_autorizar_comisionista_mob_navigate_form()
  {
    perform_ajax_form_del_autorizar_comisionista_mob_navigate_form();
  }

  function perform_ajax_form_del_autorizar_comisionista_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("com_porcentaje_comision");
    scAjaxHideErrorDisplay("com_estado");
    var var_com_ruc = document.F2.com_ruc.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_autorizar_comisionista_mob_navigate_form(var_com_ruc, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_autorizar_comisionista_mob_navigate_form_cb);
  } // do_ajax_form_del_autorizar_comisionista_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_autorizar_comisionista_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_autorizar_comisionista_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.com_ruc.value = scAjaxGetKeyValue("com_ruc");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_autorizar_comisionista_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_del_autorizar_comisionista_mob_navigate_form_cb
  function do_ajax_form_del_autorizar_comisionista_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_del_autorizar_comisionista_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_autorizar_comisionista_mob_navigate_form_cb_after_alert

  function sc_hide_form_del_autorizar_comisionista_mob_form()
  {
  ...
  ajax_field_list[0] = "com_ruc";
  ajax_field_list[1] = "com_razon_social";
  ajax_field_list[2] = "com_nombre_comercial";
  ajax_field_list[3] = "com_actividad";
  ajax_field_list[4] = "com_direccion";
  ajax_field_list[5] = "com_telefono";
  ajax_field_list[6] = "com_email";
  ajax_field_list[7] = "com_porcentaje_comision";
  ajax_field_list[8] = "com_estado";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "com_ruc": {"label": "<?php echo $this->Ini->Nm_lang['lang_ruc'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "com_razon_social": {"label": "<?php echo $this->Ini->Nm_lang['lang_razon_social'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "com_nombre_comercial": {"label": "<?php echo $this->Ini->Nm_lang['lang_nombre_comercial'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "com_actividad": {"label": "<?php echo $this->Ini->Nm_lang['lang_actividad_economica'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "com_direccion": {"label": "<?php echo $this->Ini->Nm_lang['lang_direccion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "com_telefono": {"label": "<?php echo $this->Ini->Nm_lang['lang_lot_telefono'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "com_email": {"label": "<?php echo $this->Ini->Nm_lang['lang_email'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "com_porcentaje_comision": {"label": "<?php echo $this->Ini->Nm_lang['lang_porcentaje_insentivo'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "com_estado": {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "com_ruc": new Array(),
    "com_razon_social": new Array(),
    "com_nombre_comercial": new Array(),
    "com_actividad": new Array(),
    "com_direccion": new Array(),
    "com_telefono": new Array(),
    "com_email": new Array(),
    "com_porcentaje_comision": new Array(),
    "com_estado": new Array()
  };
  ajax_field_mult["com_ruc"][1] = "com_ruc";
  ajax_field_mult["com_razon_social"][1] = "com_razon_social";
  ajax_field_mult["com_nombre_comercial"][1] = "com_nombre_comercial";
  ajax_field_mult["com_actividad"][1] = "com_actividad";
  ajax_field_mult["com_direccion"][1] = "com_direccion";
  ajax_field_mult["com_telefono"][1] = "com_telefono";
  ajax_field_mult["com_email"][1] = "com_email";
  ajax_field_mult["com_porcentaje_comision"][1] = "com_porcentaje_comision";
  ajax_field_mult["com_estado"][1] = "com_estado";

  var ajax_field_id = {
    "com_ruc": new Array("hidden_field_label_com_ruc", "hidden_field_data_com_ruc"),
    "com_razon_social": new Array("hidden_field_label_com_razon_social", "hidden_field_data_com_razon_social"),
    "com_nombre_comercial": new Array("hidden_field_label_com_nombre_comercial", "hidden_field_data_com_nombre_comercial"),
    "com_actividad": new Array("hidden_field_label_com_actividad", "hidden_field_data_com_actividad"),
    "com_direccion": new Array("hidden_field_label_com_direccion", "hidden_field_data_com_direccion"),
    "com_telefono": new Array("hidden_field_label_com_telefono", "hidden_field_data_com_telefono"),
    "com_email": new Array("hidden_field_label_com_email", "hidden_field_data_com_email"),
    "com_porcentaje_comision": new Array("hidden_field_label_com_porcentaje_comision", "hidden_field_data_com_porcentaje_comision"),
    "com_estado": new Array("hidden_field_label_com_estado", "hidden_field_data_com_estado")
  };

  var ajax_read_only = {
    "com_ruc": "on",
    "com_razon_social": "off",
    "com_nombre_comercial": "off",
    "com_actividad": "off",
    "com_direccion": "off",
    "com_telefono": "off",
    "com_email": "off",
    "com_porcentaje_comision": "off",
    "com_estado": "off"
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("com_nombre_comercial" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("com_porcentaje_comision" == sIndex)
    {
      scAjaxSetFieldSelect(sIndex, aValue, null);
      updateHeaderFooter(sIndex, aValue);
