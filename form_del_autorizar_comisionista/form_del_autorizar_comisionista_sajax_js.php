  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_autorizar_comisionista" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_autorizar_comisionista_form();
	}
...
?>
  ...
  // ---------- Validate com_ruc
  function do_ajax_form_del_autorizar_comisionista_validate_com_ruc()
  {
    var nomeCampo_com_ruc = "com_ruc";
    var var_com_ruc = scAjaxGetFieldText(nomeCampo_com_ruc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_autorizar_comisionista_validate_com_ruc(var_com_ruc, var_script_case_init, do_ajax_form_del_autorizar_comisionista_validate_com_ruc_cb);
  } // do_ajax_form_del_autorizar_comisionista_validate_com_ruc

  function do_ajax_form_del_autorizar_comisionista_validate_com_ruc_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_autorizar_comisionista_validate_com_ruc_cb

  // ---------- Validate com_razon_social
  function do_ajax_form_del_autorizar_comisionista_validate_com_razon_social()
  {
    var nomeCampo_com_razon_social = "com_razon_social";
    var var_com_razon_social = scAjaxGetFieldText(nomeCampo_com_razon_social);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_autorizar_comisionista_validate_com_razon_social(var_com_razon_social, var_script_case_init, do_ajax_form_del_autorizar_comisionista_validate_com_razon_social_cb);
  } // do_ajax_form_del_autorizar_comisionista_validate_com_razon_social

  function do_ajax_form_del_autorizar_comisionista_validate_com_razon_social_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_autorizar_comisionista_validate_com_razon_social_cb

  // ---------- Validate com_nombre_comercial
  function do_ajax_form_del_autorizar_comisionista_validate_com_nombre_comercial()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_autorizar_comisionista_validate_com_nombre_comercial(var_com_nombre_comercial, var_script_case_init, do_ajax_form_del_autorizar_comisionista_validate_com_nombre_comercial_cb);
  } // do_ajax_form_del_autorizar_comisionista_validate_com_nombre_comercial

  function do_ajax_form_del_autorizar_comisionista_validate_com_nombre_comercial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_autorizar_comisionista_validate_com_nombre_comercial_cb

  // ---------- Validate com_actividad
  function do_ajax_form_del_autorizar_comisionista_validate_com_actividad()
  {
    var nomeCampo_com_actividad = "com_actividad";
    var var_com_actividad = scAjaxGetFieldSelect(nomeCampo_com_actividad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_autorizar_comisionista_validate_com_actividad(var_com_actividad, var_script_case_init, do_ajax_form_del_autorizar_comisionista_validate_com_actividad_cb);
  } // do_ajax_form_del_autorizar_comisionista_validate_com_actividad

  function do_ajax_form_del_autorizar_comisionista_validate_com_actividad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_autorizar_comisionista_validate_com_actividad_cb

  // ---------- Validate com_direccion
  function do_ajax_form_del_autorizar_comisionista_validate_com_direccion()
  {
    var nomeCampo_com_direccion = "com_direccion";
    var var_com_direccion = scAjaxGetFieldText(nomeCampo_com_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_autorizar_comisionista_validate_com_direccion(var_com_direccion, var_script_case_init, do_ajax_form_del_autorizar_comisionista_validate_com_direccion_cb);
  } // do_ajax_form_del_autorizar_comisionista_validate_com_direccion

  function do_ajax_form_del_autorizar_comisionista_validate_com_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_autorizar_comisionista_validate_com_direccion_cb

  // ---------- Validate com_telefono
  function do_ajax_form_del_autorizar_comisionista_validate_com_telefono()
  {
    var nomeCampo_com_telefono = "com_telefono";
    var var_com_telefono = scAjaxGetFieldText(nomeCampo_com_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_autorizar_comisionista_validate_com_telefono(var_com_telefono, var_script_case_init, do_ajax_form_del_autorizar_comisionista_validate_com_telefono_cb);
  } // do_ajax_form_del_autorizar_comisionista_validate_com_telefono

  function do_ajax_form_del_autorizar_comisionista_validate_com_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_autorizar_comisionista_validate_com_telefono_cb

  // ---------- Validate com_email
  function do_ajax_form_del_autorizar_comisionista_validate_com_email()
  {
    var nomeCampo_com_email = "com_email";
    var var_com_email = scAjaxGetFieldText(nomeCampo_com_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_autorizar_comisionista_validate_com_email(var_com_email, var_script_case_init, do_ajax_form_del_autorizar_comisionista_validate_com_email_cb);
  } // do_ajax_form_del_autorizar_comisionista_validate_com_email

  function do_ajax_form_del_autorizar_comisionista_validate_com_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_autorizar_comisionista_validate_com_email_cb

  // ---------- Validate com_porcentaje_comision
  function do_ajax_form_del_autorizar_comisionista_validate_com_porcentaje_comision()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_autorizar_comisionista_validate_com_porcentaje_comision(var_com_porcentaje_comision, var_script_case_init, do_ajax_form_del_autorizar_comisionista_validate_com_porcentaje_comision_cb);
  } // do_ajax_form_del_autorizar_comisionista_validate_com_porcentaje_comision

  function do_ajax_form_del_autorizar_comisionista_validate_com_porcentaje_comision_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_autorizar_comisionista_validate_com_porcentaje_comision_cb

  // ---------- Validate com_estado
  function do_ajax_form_del_autorizar_comisionista_validate_com_estado()
  {
    var nomeCampo_com_estado = "com_estado";
    var var_com_estado = scAjaxGetFieldSelect(nomeCampo_com_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_autorizar_comisionista_validate_com_estado(var_com_estado, var_script_case_init, do_ajax_form_del_autorizar_comisionista_validate_com_estado_cb);
  } // do_ajax_form_del_autorizar_comisionista_validate_com_estado

  function do_ajax_form_del_autorizar_comisionista_validate_com_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_autorizar_comisionista_validate_com_estado_cb

  // ---------- Event onblur com_ruc
  function do_ajax_form_del_autorizar_comisionista_event_com_ruc_onblur()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_del_autorizar_comisionista_event_com_ruc_onblur(var_com_ruc, var_com_razon_social, var_com_direccion, var_com_email, var_script_case_init, do_ajax_form_del_autorizar_comisionista_event_com_ruc_onblur_cb);
  } // do_ajax_form_del_autorizar_comisionista_event_com_ruc_onblur

  function do_ajax_form_del_autorizar_comisionista_event_com_ruc_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "com_ruc";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_autorizar_comisionista_event_com_ruc_onblur_cb_after_alert);
  } // do_ajax_form_del_autorizar_comisionista_event_com_ruc_onblur_cb
  function do_ajax_form_del_autorizar_comisionista_event_com_ruc_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_autorizar_comisionista_event_com_ruc_onblur_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_autorizar_comisionista_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_autorizar_comisionista_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_com_ruc = scAjaxGetFieldText("com_ruc");
    ...
    scAjaxProcOn();
    x_ajax_form_del_autorizar_comisionista_submit_form(var_com_ruc, var_com_razon_social, var_com_nombre_comercial, var_com_actividad, var_com_direccion, var_com_telefono, var_com_email, var_com_porcentaje_comision, var_com_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_autorizar_comisionista_submit_form_cb);
  } // do_ajax_form_del_autorizar_comisionista_submit_form

  function do_ajax_form_del_autorizar_comisionista_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_autorizar_comisionista_submit_form_cb_after_alert);
  } // do_ajax_form_del_autorizar_comisionista_submit_form_cb
  function do_ajax_form_del_autorizar_comisionista_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_autorizar_comisionista_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_autorizar_comisionista_navigate_form()
  {
    perform_ajax_form_del_autorizar_comisionista_navigate_form();
  }

  function perform_ajax_form_del_autorizar_comisionista_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_autorizar_comisionista_navigate_form(var_com_ruc, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_autorizar_comisionista_navigate_form_cb);
  } // do_ajax_form_del_autorizar_comisionista_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_autorizar_comisionista']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_autorizar_comisionista_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_autorizar_comisionista_navigate_form_cb_after_alert);
  } // do_ajax_form_del_autorizar_comisionista_navigate_form_cb
  function do_ajax_form_del_autorizar_comisionista_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_del_autorizar_comisionista_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_autorizar_comisionista_navigate_form_cb_after_alert

  function sc_hide_form_del_autorizar_comisionista_form()
  {
