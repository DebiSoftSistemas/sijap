  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_fac_operaciones_convenio" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_fac_operaciones_convenio_form();
	}
...
?>
  ...
  // ---------- Validate oc_solicitud_
  function do_ajax_form_fac_operaciones_convenio_validate_oc_solicitud_(iNumLinha)
  {
    var nomeCampo_oc_solicitud_ = "oc_solicitud_" + iNumLinha;
    var var_oc_solicitud_ = scAjaxGetFieldText(nomeCampo_oc_solicitud_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operaciones_convenio_validate_oc_solicitud_(var_oc_solicitud_, iNumLinha, var_script_case_init, do_ajax_form_fac_operaciones_convenio_validate_oc_solicitud__cb);
  } // do_ajax_form_fac_operaciones_convenio_validate_oc_solicitud_

  function do_ajax_form_fac_operaciones_convenio_validate_oc_solicitud__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "oc_solicitud_" + iLineNumber;
    }
    else
    {
      sFieldValid = "oc_solicitud_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "oc_solicitud_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "oc_solicitud_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operaciones_convenio_validate_oc_solicitud__cb

  // ---------- Validate oc_operacion_
  function do_ajax_form_fac_operaciones_convenio_validate_oc_operacion_(iNumLinha)
  {
    var nomeCampo_oc_operacion_ = "oc_operacion_" + iNumLinha;
    var var_oc_operacion_ = scAjaxGetFieldText(nomeCampo_oc_operacion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operaciones_convenio_validate_oc_operacion_(var_oc_operacion_, iNumLinha, var_script_case_init, do_ajax_form_fac_operaciones_convenio_validate_oc_operacion__cb);
  } // do_ajax_form_fac_operaciones_convenio_validate_oc_operacion_

  function do_ajax_form_fac_operaciones_convenio_validate_oc_operacion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "oc_operacion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "oc_operacion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "oc_operacion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "oc_operacion_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operaciones_convenio_validate_oc_operacion__cb

  // ---------- Validate oc_tipo_cartera_
  function do_ajax_form_fac_operaciones_convenio_validate_oc_tipo_cartera_(iNumLinha)
  {
    var nomeCampo_oc_tipo_cartera_ = "oc_tipo_cartera_" + iNumLinha;
    var var_oc_tipo_cartera_ = scAjaxGetFieldSelect(nomeCampo_oc_tipo_cartera_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operaciones_convenio_validate_oc_tipo_cartera_(var_oc_tipo_cartera_, iNumLinha, var_script_case_init, do_ajax_form_fac_operaciones_convenio_validate_oc_tipo_cartera__cb);
  } // do_ajax_form_fac_operaciones_convenio_validate_oc_tipo_cartera_

  function do_ajax_form_fac_operaciones_convenio_validate_oc_tipo_cartera__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "oc_tipo_cartera_" + iLineNumber;
    }
    else
    {
      sFieldValid = "oc_tipo_cartera_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "oc_tipo_cartera_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "oc_tipo_cartera_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operaciones_convenio_validate_oc_tipo_cartera__cb

  // ---------- Validate oc_comentario_
  function do_ajax_form_fac_operaciones_convenio_validate_oc_comentario_(iNumLinha)
  {
    var nomeCampo_oc_comentario_ = "oc_comentario_" + iNumLinha;
    var var_oc_comentario_ = scAjaxGetFieldText(nomeCampo_oc_comentario_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operaciones_convenio_validate_oc_comentario_(var_oc_comentario_, iNumLinha, var_script_case_init, do_ajax_form_fac_operaciones_convenio_validate_oc_comentario__cb);
  } // do_ajax_form_fac_operaciones_convenio_validate_oc_comentario_

  function do_ajax_form_fac_operaciones_convenio_validate_oc_comentario__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "oc_comentario_" + iLineNumber;
    }
    else
    {
      sFieldValid = "oc_comentario_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "oc_comentario_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "oc_comentario_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operaciones_convenio_validate_oc_comentario__cb

  // ---------- Validate oc_referencia_
  function do_ajax_form_fac_operaciones_convenio_validate_oc_referencia_(iNumLinha)
  {
    var nomeCampo_oc_referencia_ = "oc_referencia_" + iNumLinha;
    var var_oc_referencia_ = scAjaxGetFieldText(nomeCampo_oc_referencia_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operaciones_convenio_validate_oc_referencia_(var_oc_referencia_, iNumLinha, var_script_case_init, do_ajax_form_fac_operaciones_convenio_validate_oc_referencia__cb);
  } // do_ajax_form_fac_operaciones_convenio_validate_oc_referencia_

  function do_ajax_form_fac_operaciones_convenio_validate_oc_referencia__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "oc_referencia_" + iLineNumber;
    }
    else
    {
      sFieldValid = "oc_referencia_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "oc_referencia_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "oc_referencia_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operaciones_convenio_validate_oc_referencia__cb

  // ---------- Validate oc_saldo_
  function do_ajax_form_fac_operaciones_convenio_validate_oc_saldo_(iNumLinha)
  {
    var nomeCampo_oc_saldo_ = "oc_saldo_" + iNumLinha;
    var var_oc_saldo_ = scAjaxGetFieldText(nomeCampo_oc_saldo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operaciones_convenio_validate_oc_saldo_(var_oc_saldo_, iNumLinha, var_script_case_init, do_ajax_form_fac_operaciones_convenio_validate_oc_saldo__cb);
  } // do_ajax_form_fac_operaciones_convenio_validate_oc_saldo_

  function do_ajax_form_fac_operaciones_convenio_validate_oc_saldo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "oc_saldo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "oc_saldo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "oc_saldo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "oc_saldo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operaciones_convenio_validate_oc_saldo__cb

  // ---------- Validate oc_estado_
  function do_ajax_form_fac_operaciones_convenio_validate_oc_estado_(iNumLinha)
  {
    var nomeCampo_oc_estado_ = "oc_estado_" + iNumLinha;
    var var_oc_estado_ = scAjaxGetFieldText(nomeCampo_oc_estado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operaciones_convenio_validate_oc_estado_(var_oc_estado_, iNumLinha, var_script_case_init, do_ajax_form_fac_operaciones_convenio_validate_oc_estado__cb);
  } // do_ajax_form_fac_operaciones_convenio_validate_oc_estado_

  function do_ajax_form_fac_operaciones_convenio_validate_oc_estado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "oc_estado_" + iLineNumber;
    }
    else
    {
      sFieldValid = "oc_estado_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "oc_estado_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "oc_estado_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operaciones_convenio_validate_oc_estado__cb

  // ---------- Validate oc_id_
  function do_ajax_form_fac_operaciones_convenio_validate_oc_id_(iNumLinha)
  {
    var nomeCampo_oc_id_ = "oc_id_" + iNumLinha;
    var var_oc_id_ = scAjaxGetFieldHidden(nomeCampo_oc_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operaciones_convenio_validate_oc_id_(var_oc_id_, iNumLinha, var_script_case_init, do_ajax_form_fac_operaciones_convenio_validate_oc_id__cb);
  } // do_ajax_form_fac_operaciones_convenio_validate_oc_id_

  function do_ajax_form_fac_operaciones_convenio_validate_oc_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "oc_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "oc_id_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "oc_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "oc_id_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operaciones_convenio_validate_oc_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_fac_operaciones_convenio_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_fac_operaciones_convenio_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_fac_operaciones_convenio_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_fac_operaciones_convenio_add_new_line_cb);
  } // do_ajax_form_fac_operaciones_convenio_add_new_line

  function do_ajax_form_fac_operaciones_convenio_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_fac_operaciones_convenio_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_fac_operaciones_convenio_backup_line(iNumLinha)
  {
    var var_oc_id_ = scAjaxGetFieldHidden("oc_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operaciones_convenio_backup_line(var_oc_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_fac_operaciones_convenio_backup_line_cb);
  } // do_ajax_form_fac_operaciones_convenio_backup_line

  function do_ajax_form_fac_operaciones_convenio_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_fac_operaciones_convenio_backup_line_cb

  function do_ajax_form_fac_operaciones_convenio_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_fac_operaciones_convenio_cancel_insert

  function do_ajax_form_fac_operaciones_convenio_cancel_update(iSeqVert)
  {
    do_ajax_form_fac_operaciones_convenio_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_fac_operaciones_convenio_cancel_update

  function do_ajax_form_fac_operaciones_convenio_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_fac_operaciones_convenio_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_fac_operaciones_convenio_table_refresh()
  {
    var var_oc_id_ = document.F2.oc_id_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_fac_operaciones_convenio_table_refresh(var_oc_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_operaciones_convenio_table_refresh_cb);
  } //  do_ajax_form_fac_operaciones_convenio_table_refresh

  function do_ajax_form_fac_operaciones_convenio_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.oc_id_.value = scAjaxGetKeyValue("oc_id_");
    ...
    scAjaxAlert(do_ajax_form_fac_operaciones_convenio_table_refresh_cb_after_alert);
  } // do_ajax_form_fac_operaciones_convenio_table_refresh_cb
  function do_ajax_form_fac_operaciones_convenio_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_fac_operaciones_convenio_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_fac_operaciones_convenio_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_fac_operaciones_convenio_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_oc_solicitud_ = scAjaxGetFieldText("oc_solicitud_" + iNumLinha);
    var var_oc_operacion_ = scAjaxGetFieldText("oc_operacion_" + iNumLinha);
    var var_oc_tipo_cartera_ = scAjaxGetFieldSelect("oc_tipo_cartera_" + iNumLinha);
    var var_oc_comentario_ = scAjaxGetFieldText("oc_comentario_" + iNumLinha);
    var var_oc_referencia_ = scAjaxGetFieldText("oc_referencia_" + iNumLinha);
    var var_oc_saldo_ = scAjaxGetFieldText("oc_saldo_" + iNumLinha);
    var var_oc_estado_ = scAjaxGetFieldText("oc_estado_" + iNumLinha);
    var var_oc_id_ = scAjaxGetFieldHidden("oc_id_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_fac_operaciones_convenio_submit_form(var_oc_solicitud_, var_oc_operacion_, var_oc_tipo_cartera_, var_oc_comentario_, var_oc_referencia_, var_oc_saldo_, var_oc_estado_, var_oc_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_fac_operaciones_convenio_submit_form_cb);
  } // do_ajax_form_fac_operaciones_convenio_submit_form

  function do_ajax_form_fac_operaciones_convenio_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("oc_solicitud_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("oc_operacion_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("oc_tipo_cartera_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("oc_comentario_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("oc_referencia_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("oc_saldo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("oc_estado_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("oc_id_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_fac_operaciones_convenio_submit_form_cb_after_alert);
  } // do_ajax_form_fac_operaciones_convenio_submit_form_cb
  function do_ajax_form_fac_operaciones_convenio_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_fac_operaciones_convenio_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_fac_operaciones_convenio_navigate_form()
  {
    perform_ajax_form_fac_operaciones_convenio_navigate_form();
  }

  function perform_ajax_form_fac_operaciones_convenio_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_fac_operaciones_convenio_cancel_insert(sc_form_fac_operaciones_convenio_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("oc_solicitud_" + iNavForm);
      scAjaxHideErrorDisplay("oc_operacion_" + iNavForm);
      scAjaxHideErrorDisplay("oc_tipo_cartera_" + iNavForm);
      scAjaxHideErrorDisplay("oc_comentario_" + iNavForm);
      scAjaxHideErrorDisplay("oc_referencia_" + iNavForm);
      scAjaxHideErrorDisplay("oc_saldo_" + iNavForm);
      scAjaxHideErrorDisplay("oc_estado_" + iNavForm);
      scAjaxHideErrorDisplay("oc_id_" + iNavForm);
    }
    var var_oc_id_ = document.F2.oc_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_fac_operaciones_convenio_navigate_form(var_oc_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_operaciones_convenio_navigate_form_cb);
  } // do_ajax_form_fac_operaciones_convenio_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_operaciones_convenio']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_fac_operaciones_convenio_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.oc_id_.value = scAjaxGetKeyValue("oc_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_fac_operaciones_convenio_navigate_form_cb_after_alert);
  } // do_ajax_form_fac_operaciones_convenio_navigate_form_cb
  function do_ajax_form_fac_operaciones_convenio_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_fac_operaciones_convenio_navigate_form_cb_after_alert

    function sc_form_fac_operaciones_convenio_get_last_line_number()
    {
    ...
    } //sc_form_fac_operaciones_convenio_get_last_line_number

  function sc_hide_form_fac_operaciones_convenio_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "oc_solicitud_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "oc_operacion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "oc_tipo_cartera_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "oc_comentario_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "oc_referencia_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "oc_saldo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "oc_estado_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "oc_id_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["oc_solicitud_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_solicitud'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["oc_operacion_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_operacion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["oc_tipo_cartera_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tipo_cartera'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["oc_comentario_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_comentario'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["oc_referencia_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_referencia'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["oc_saldo_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_saldo'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["oc_estado_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["oc_id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["oc_solicitud_"][iNumLinha] = "oc_solicitud_" + iNumLinha;
    ajax_field_mult["oc_operacion_"][iNumLinha] = "oc_operacion_" + iNumLinha;
    ajax_field_mult["oc_tipo_cartera_"][iNumLinha] = "oc_tipo_cartera_" + iNumLinha;
    ajax_field_mult["oc_comentario_"][iNumLinha] = "oc_comentario_" + iNumLinha;
    ajax_field_mult["oc_referencia_"][iNumLinha] = "oc_referencia_" + iNumLinha;
    ajax_field_mult["oc_saldo_"][iNumLinha] = "oc_saldo_" + iNumLinha;
    ajax_field_mult["oc_estado_"][iNumLinha] = "oc_estado_" + iNumLinha;
    ajax_field_mult["oc_id_"][iNumLinha] = "oc_id_" + iNumLinha;
    ajax_field_id["oc_tipo_cartera_" + iNumLinha] = new Array("hidden_field_label_oc_tipo_cartera_", "hidden_field_data_oc_tipo_cartera_" + iNumLinha);
    ajax_field_id["oc_comentario_" + iNumLinha] = new Array("hidden_field_label_oc_comentario_", "hidden_field_data_oc_comentario_" + iNumLinha);
    ajax_field_id["oc_saldo_" + iNumLinha] = new Array("hidden_field_label_oc_saldo_", "hidden_field_data_oc_saldo_" + iNumLinha);
    ajax_field_id["oc_estado_" + iNumLinha] = new Array("hidden_field_label_oc_estado_", "hidden_field_data_oc_estado_" + iNumLinha);
    ajax_error_count["oc_solicitud_" + iNumLinha] = "off";
    ajax_error_count["oc_operacion_" + iNumLinha] = "off";
    ajax_error_count["oc_tipo_cartera_" + iNumLinha] = "off";
    ajax_error_count["oc_comentario_" + iNumLinha] = "off";
    ajax_error_count["oc_referencia_" + iNumLinha] = "off";
    ajax_error_count["oc_saldo_" + iNumLinha] = "off";
    ajax_error_count["oc_estado_" + iNumLinha] = "off";
    ajax_error_count["oc_id_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["oc_solicitud_" + iNumLinha] = "off";
    ajax_read_only["oc_operacion_" + iNumLinha] = "off";
    ajax_read_only["oc_tipo_cartera_" + iNumLinha] = "off";
    ajax_read_only["oc_comentario_" + iNumLinha] = "off";
    ajax_read_only["oc_referencia_" + iNumLinha] = "off";
    ajax_read_only["oc_saldo_" + iNumLinha] = "off";
    ajax_read_only["oc_estado_" + iNumLinha] = "off";
    ajax_read_only["oc_id_" + iNumLinha] = "on";
<?php
}
else
{
?>
    ajax_read_only["oc_solicitud_" + iNumLinha] = "on";
    ajax_read_only["oc_operacion_" + iNumLinha] = "on";
    ajax_read_only["oc_tipo_cartera_" + iNumLinha] = "on";
    ajax_read_only["oc_comentario_" + iNumLinha] = "on";
    ajax_read_only["oc_referencia_" + iNumLinha] = "on";
    ajax_read_only["oc_saldo_" + iNumLinha] = "on";
    ajax_read_only["oc_estado_" + iNumLinha] = "on";
    ajax_read_only["oc_id_" + iNumLinha] = "on";
<?php
}
?>
  ...
  {
    ajax_error_list["oc_solicitud_" + iNumLinha] = null;
    ajax_error_list["oc_operacion_" + iNumLinha] = null;
    ajax_error_list["oc_tipo_cartera_" + iNumLinha] = null;
    ajax_error_list["oc_comentario_" + iNumLinha] = null;
    ajax_error_list["oc_referencia_" + iNumLinha] = null;
    ajax_error_list["oc_saldo_" + iNumLinha] = null;
    ajax_error_list["oc_estado_" + iNumLinha] = null;
    ajax_error_list["oc_id_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "oc_solicitud_": new Array(),
    "oc_operacion_": new Array(),
    "oc_tipo_cartera_": new Array(),
    "oc_comentario_": new Array(),
    "oc_referencia_": new Array(),
    "oc_saldo_": new Array(),
    "oc_estado_": new Array(),
    "oc_id_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["oc_solicitud_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["oc_solicitud_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["oc_solicitud_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["oc_solicitud_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["oc_solicitud_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["oc_operacion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["oc_operacion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["oc_operacion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["oc_operacion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["oc_operacion_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["oc_tipo_cartera_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["oc_tipo_cartera_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["oc_tipo_cartera_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["oc_tipo_cartera_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["oc_tipo_cartera_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["oc_comentario_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["oc_comentario_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["oc_comentario_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["oc_comentario_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["oc_comentario_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["oc_referencia_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["oc_referencia_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["oc_referencia_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["oc_referencia_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["oc_referencia_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["oc_saldo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["oc_saldo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["oc_saldo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["oc_saldo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["oc_saldo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["oc_estado_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["oc_estado_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["oc_estado_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["oc_estado_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["oc_estado_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["oc_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["oc_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["oc_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["oc_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["oc_id_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['oc_solicitud_'])) ? $this->nmgp_cmp_readonly['oc_solicitud_'] : 'off';
?>
    scAjaxFieldRead("oc_solicitud_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['oc_operacion_'])) ? $this->nmgp_cmp_readonly['oc_operacion_'] : 'off';
?>
    scAjaxFieldRead("oc_operacion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['oc_tipo_cartera_'])) ? $this->nmgp_cmp_readonly['oc_tipo_cartera_'] : 'off';
?>
    scAjaxFieldRead("oc_tipo_cartera_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['oc_comentario_'])) ? $this->nmgp_cmp_readonly['oc_comentario_'] : 'off';
?>
    scAjaxFieldRead("oc_comentario_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['oc_referencia_'])) ? $this->nmgp_cmp_readonly['oc_referencia_'] : 'off';
?>
    scAjaxFieldRead("oc_referencia_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['oc_saldo_'])) ? $this->nmgp_cmp_readonly['oc_saldo_'] : 'off';
?>
    scAjaxFieldRead("oc_saldo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['oc_estado_'])) ? $this->nmgp_cmp_readonly['oc_estado_'] : 'off';
?>
    scAjaxFieldRead("oc_estado_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['oc_id_'])) ? $this->nmgp_cmp_readonly['oc_id_'] : 'on';
?>
    scAjaxFieldRead("oc_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("oc_solicitud_" + iSeq, "on");
    scAjaxFieldRead("oc_operacion_" + iSeq, "on");
    scAjaxFieldRead("oc_tipo_cartera_" + iSeq, "on");
    scAjaxFieldRead("oc_comentario_" + iSeq, "on");
    scAjaxFieldRead("oc_referencia_" + iSeq, "on");
    scAjaxFieldRead("oc_saldo_" + iSeq, "on");
    scAjaxFieldRead("oc_estado_" + iSeq, "on");
    scAjaxFieldRead("oc_id_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["oc_solicitud_" + iRow] || "on" == ajax_error_count["oc_operacion_" + iRow] || "on" == ajax_error_count["oc_tipo_cartera_" + iRow] || "on" == ajax_error_count["oc_comentario_" + iRow] || "on" == ajax_error_count["oc_referencia_" + iRow] || "on" == ajax_error_count["oc_saldo_" + iRow] || "on" == ajax_error_count["oc_estado_" + iRow] || "on" == ajax_error_count["oc_id_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_oc_solicitud_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_oc_operacion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_oc_tipo_cartera_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_oc_comentario_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_oc_referencia_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_oc_saldo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_oc_estado_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_oc_id_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["oc_solicitud_" + iRow] && "off" == ajax_error_count["oc_operacion_" + iRow] && "off" == ajax_error_count["oc_tipo_cartera_" + iRow] && "off" == ajax_error_count["oc_comentario_" + iRow] && "off" == ajax_error_count["oc_referencia_" + iRow] && "off" == ajax_error_count["oc_saldo_" + iRow] && "off" == ajax_error_count["oc_estado_" + iRow] && "off" == ajax_error_count["oc_id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["oc_solicitud_" + iRow] = "off";
        ajax_error_count["oc_operacion_" + iRow] = "off";
        ajax_error_count["oc_tipo_cartera_" + iRow] = "off";
        ajax_error_count["oc_comentario_" + iRow] = "off";
        ajax_error_count["oc_referencia_" + iRow] = "off";
        ajax_error_count["oc_saldo_" + iRow] = "off";
        ajax_error_count["oc_estado_" + iRow] = "off";
        ajax_error_count["oc_id_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_oc_solicitud_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_oc_operacion_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_oc_tipo_cartera_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_oc_comentario_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_oc_referencia_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_oc_saldo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_oc_estado_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_oc_id_" + iRow).removeClass("scFormErrorLine");
    }
  }
