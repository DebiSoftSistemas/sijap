  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sri_sustento_tributario_gasto_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sri_sustento_tributario_gasto_mob_form();
	}
...
?>
  ...
  // ---------- Validate stg_codigo
  function do_ajax_form_sri_sustento_tributario_gasto_mob_validate_stg_codigo()
  {
    var nomeCampo_stg_codigo = "stg_codigo";
    var var_stg_codigo = scAjaxGetFieldText(nomeCampo_stg_codigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_sustento_tributario_gasto_mob_validate_stg_codigo(var_stg_codigo, var_script_case_init, do_ajax_form_sri_sustento_tributario_gasto_mob_validate_stg_codigo_cb);
  } // do_ajax_form_sri_sustento_tributario_gasto_mob_validate_stg_codigo

  function do_ajax_form_sri_sustento_tributario_gasto_mob_validate_stg_codigo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "stg_codigo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_sustento_tributario_gasto_mob_validate_stg_codigo_cb

  // ---------- Validate stg_descripcion
  function do_ajax_form_sri_sustento_tributario_gasto_mob_validate_stg_descripcion()
  {
    var nomeCampo_stg_descripcion = "stg_descripcion";
    var var_stg_descripcion = scAjaxGetFieldText(nomeCampo_stg_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_sustento_tributario_gasto_mob_validate_stg_descripcion(var_stg_descripcion, var_script_case_init, do_ajax_form_sri_sustento_tributario_gasto_mob_validate_stg_descripcion_cb);
  } // do_ajax_form_sri_sustento_tributario_gasto_mob_validate_stg_descripcion

  function do_ajax_form_sri_sustento_tributario_gasto_mob_validate_stg_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "stg_descripcion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_sustento_tributario_gasto_mob_validate_stg_descripcion_cb

  // ---------- Validate stg_estado
  function do_ajax_form_sri_sustento_tributario_gasto_mob_validate_stg_estado()
  {
    var nomeCampo_stg_estado = "stg_estado";
    var var_stg_estado = scAjaxGetFieldSelect(nomeCampo_stg_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_sustento_tributario_gasto_mob_validate_stg_estado(var_stg_estado, var_script_case_init, do_ajax_form_sri_sustento_tributario_gasto_mob_validate_stg_estado_cb);
  } // do_ajax_form_sri_sustento_tributario_gasto_mob_validate_stg_estado

  function do_ajax_form_sri_sustento_tributario_gasto_mob_validate_stg_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "stg_estado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_sustento_tributario_gasto_mob_validate_stg_estado_cb

  // ---------- Validate tipos_documentos
  function do_ajax_form_sri_sustento_tributario_gasto_mob_validate_tipos_documentos()
  {
    var nomeCampo_tipos_documentos = "tipos_documentos";
    var var_tipos_documentos = scAjaxGetFieldText(nomeCampo_tipos_documentos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_sustento_tributario_gasto_mob_validate_tipos_documentos(var_tipos_documentos, var_script_case_init, do_ajax_form_sri_sustento_tributario_gasto_mob_validate_tipos_documentos_cb);
  } // do_ajax_form_sri_sustento_tributario_gasto_mob_validate_tipos_documentos

  function do_ajax_form_sri_sustento_tributario_gasto_mob_validate_tipos_documentos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipos_documentos";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_sustento_tributario_gasto_mob_validate_tipos_documentos_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_sri_sustento_tributario_gasto_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_sri_sustento_tributario_gasto_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_stg_codigo = scAjaxGetFieldText("stg_codigo");
    var var_stg_descripcion = scAjaxGetFieldText("stg_descripcion");
    var var_stg_estado = scAjaxGetFieldSelect("stg_estado");
    ...
    scAjaxProcOn();
    x_ajax_form_sri_sustento_tributario_gasto_mob_submit_form(var_stg_codigo, var_stg_descripcion, var_stg_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sri_sustento_tributario_gasto_mob_submit_form_cb);
  } // do_ajax_form_sri_sustento_tributario_gasto_mob_submit_form

  function do_ajax_form_sri_sustento_tributario_gasto_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("stg_codigo");
      scAjaxHideErrorDisplay("stg_descripcion");
      scAjaxHideErrorDisplay("stg_estado");
      scAjaxHideErrorDisplay("tipos_documentos");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_sri_sustento_tributario_gasto_mob_submit_form_cb_after_alert);
  } // do_ajax_form_sri_sustento_tributario_gasto_mob_submit_form_cb
  function do_ajax_form_sri_sustento_tributario_gasto_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sri_sustento_tributario_gasto_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_sri_comprobante_sustento_mob"] = "off";

  function do_ajax_form_sri_sustento_tributario_gasto_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_sri_sustento_tributario_gasto_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_sri_sustento_tributario_gasto_mob_navigate_form();
    }
  }

  function perform_ajax_form_sri_sustento_tributario_gasto_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("stg_estado");
    scAjaxHideErrorDisplay("tipos_documentos");
    var var_stg_codigo = document.F2.stg_codigo.value;
    ...
    scAjaxProcOn();
    scStatusDetail["form_sri_comprobante_sustento_mob"] = "on";
    x_ajax_form_sri_sustento_tributario_gasto_mob_navigate_form(var_stg_codigo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sri_sustento_tributario_gasto_mob_navigate_form_cb);
  } // do_ajax_form_sri_sustento_tributario_gasto_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sri_sustento_tributario_gasto_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sri_sustento_tributario_gasto_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.stg_codigo.value = scAjaxGetKeyValue("stg_codigo");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_sri_comprobante_sustento_mob"] && "nmsc_iframe_liga_form_sri_comprobante_sustento_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_sri_comprobante_sustento_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_sri_comprobante_sustento_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_sri_comprobante_sustento_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_sri_comprobante_sustento_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_sri_comprobante_sustento_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sri_sustento_tributario_gasto_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_sri_sustento_tributario_gasto_mob_navigate_form_cb
  function do_ajax_form_sri_sustento_tributario_gasto_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_sri_sustento_tributario_gasto_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_sri_sustento_tributario_gasto_mob_navigate_form_cb_after_alert

  function sc_hide_form_sri_sustento_tributario_gasto_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_sri_comprobante_sustento_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "stg_codigo";
  ajax_field_list[1] = "stg_descripcion";
  ajax_field_list[2] = "stg_estado";
  ajax_field_list[3] = "tipos_documentos";
  ...
  var ajax_error_list = {
    "stg_codigo": {"label": "<?php echo $this->Ini->Nm_lang['lang_codigo'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "stg_descripcion": {"label": "<?php echo $this->Ini->Nm_lang['lang_descripcion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "stg_estado": {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tipos_documentos": {"label": "tipos_documentos", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "stg_codigo": new Array(),
    "stg_descripcion": new Array(),
    "stg_estado": new Array(),
    "tipos_documentos": new Array()
  };
  ajax_field_mult["stg_codigo"][1] = "stg_codigo";
  ajax_field_mult["stg_descripcion"][1] = "stg_descripcion";
  ajax_field_mult["stg_estado"][1] = "stg_estado";
  ajax_field_mult["tipos_documentos"][1] = "tipos_documentos";

  var ajax_field_id = {
    "stg_codigo": new Array("hidden_field_label_stg_codigo", "hidden_field_data_stg_codigo"),
    "stg_descripcion": new Array("hidden_field_label_stg_descripcion", "hidden_field_data_stg_descripcion"),
    "stg_estado": new Array("hidden_field_label_stg_estado", "hidden_field_data_stg_estado"),
    "tipos_documentos": new Array("hidden_field_label_tipos_documentos", "hidden_field_data_tipos_documentos")
  };
