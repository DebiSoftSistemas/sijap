  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sri_sustento_tributario_gasto" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sri_sustento_tributario_gasto_form();
	}
...
?>
  ...
  // ---------- Validate stg_codigo
  function do_ajax_form_sri_sustento_tributario_gasto_validate_stg_codigo()
  {
    var nomeCampo_stg_codigo = "stg_codigo";
    var var_stg_codigo = scAjaxGetFieldText(nomeCampo_stg_codigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_sustento_tributario_gasto_validate_stg_codigo(var_stg_codigo, var_script_case_init, do_ajax_form_sri_sustento_tributario_gasto_validate_stg_codigo_cb);
  } // do_ajax_form_sri_sustento_tributario_gasto_validate_stg_codigo

  function do_ajax_form_sri_sustento_tributario_gasto_validate_stg_codigo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_sustento_tributario_gasto_validate_stg_codigo_cb

  // ---------- Validate stg_descripcion
  function do_ajax_form_sri_sustento_tributario_gasto_validate_stg_descripcion()
  {
    var nomeCampo_stg_descripcion = "stg_descripcion";
    var var_stg_descripcion = scAjaxGetFieldText(nomeCampo_stg_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_sustento_tributario_gasto_validate_stg_descripcion(var_stg_descripcion, var_script_case_init, do_ajax_form_sri_sustento_tributario_gasto_validate_stg_descripcion_cb);
  } // do_ajax_form_sri_sustento_tributario_gasto_validate_stg_descripcion

  function do_ajax_form_sri_sustento_tributario_gasto_validate_stg_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_sustento_tributario_gasto_validate_stg_descripcion_cb

  // ---------- Validate stg_estado
  function do_ajax_form_sri_sustento_tributario_gasto_validate_stg_estado()
  {
    var nomeCampo_stg_estado = "stg_estado";
    var var_stg_estado = scAjaxGetFieldSelect(nomeCampo_stg_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_sustento_tributario_gasto_validate_stg_estado(var_stg_estado, var_script_case_init, do_ajax_form_sri_sustento_tributario_gasto_validate_stg_estado_cb);
  } // do_ajax_form_sri_sustento_tributario_gasto_validate_stg_estado

  function do_ajax_form_sri_sustento_tributario_gasto_validate_stg_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_sustento_tributario_gasto_validate_stg_estado_cb

  // ---------- Validate tipos_documentos
  function do_ajax_form_sri_sustento_tributario_gasto_validate_tipos_documentos()
  {
    var nomeCampo_tipos_documentos = "tipos_documentos";
    var var_tipos_documentos = scAjaxGetFieldText(nomeCampo_tipos_documentos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_sustento_tributario_gasto_validate_tipos_documentos(var_tipos_documentos, var_script_case_init, do_ajax_form_sri_sustento_tributario_gasto_validate_tipos_documentos_cb);
  } // do_ajax_form_sri_sustento_tributario_gasto_validate_tipos_documentos

  function do_ajax_form_sri_sustento_tributario_gasto_validate_tipos_documentos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_sustento_tributario_gasto_validate_tipos_documentos_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_sri_sustento_tributario_gasto_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_sri_sustento_tributario_gasto_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_sri_sustento_tributario_gasto_submit_form(var_stg_codigo, var_stg_descripcion, var_stg_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sri_sustento_tributario_gasto_submit_form_cb);
  } // do_ajax_form_sri_sustento_tributario_gasto_submit_form

  function do_ajax_form_sri_sustento_tributario_gasto_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_sri_sustento_tributario_gasto_submit_form_cb_after_alert);
  } // do_ajax_form_sri_sustento_tributario_gasto_submit_form_cb
  function do_ajax_form_sri_sustento_tributario_gasto_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sri_sustento_tributario_gasto_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_sri_comprobante_sustento"] = "off";

  function do_ajax_form_sri_sustento_tributario_gasto_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_sri_sustento_tributario_gasto_navigate_form, function() {});
    } else {
      perform_ajax_form_sri_sustento_tributario_gasto_navigate_form();
    }
  }

  function perform_ajax_form_sri_sustento_tributario_gasto_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_sri_comprobante_sustento"] = "on";
    x_ajax_form_sri_sustento_tributario_gasto_navigate_form(var_stg_codigo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sri_sustento_tributario_gasto_navigate_form_cb);
  } // do_ajax_form_sri_sustento_tributario_gasto_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sri_sustento_tributario_gasto']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sri_sustento_tributario_gasto_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_sri_comprobante_sustento"] && "nmsc_iframe_liga_form_sri_comprobante_sustento" != scMasterDetailIframe["nmsc_iframe_liga_form_sri_comprobante_sustento"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_sri_comprobante_sustento"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_sri_comprobante_sustento').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_sri_comprobante_sustento').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_sri_comprobante_sustento').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sri_sustento_tributario_gasto_navigate_form_cb_after_alert);
  } // do_ajax_form_sri_sustento_tributario_gasto_navigate_form_cb
  function do_ajax_form_sri_sustento_tributario_gasto_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_sri_sustento_tributario_gasto_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_sri_sustento_tributario_gasto_navigate_form_cb_after_alert

  function sc_hide_form_sri_sustento_tributario_gasto_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_sri_comprobante_sustento"])
    {
      return true;
    }
    return false;
