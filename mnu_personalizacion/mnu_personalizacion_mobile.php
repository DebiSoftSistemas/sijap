...
<html>
    <head>
        ...
        <title>{lang_personalizacion}</title>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["mnu_personalizacion"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile.min.css" />
        <link rel="stylesheet"  href="<?php echo $this->url_css; ?>Debifact/Debifact_menuMobile.css" />
        <link rel="stylesheet"  href="<?php echo $this->url_css; ?>Debifact/Debifact_menuMobile<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" />
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["mnu_personalizacion"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["mnu_personalizacion"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile.min.js"></script>
    <style>
    <?php
    if(isset($mnu_personalizacion_menuData["data"]) && is_array($mnu_personalizacion_menuData["data"]) && !empty($mnu_personalizacion_menuData["data"]))
    {
        foreach($mnu_personalizacion_menuData["data"] as $arr_item)
        {
   ...
   <TABLE width="100%" class="scMenuHHeader">
    ...
    <?php
        escreveMenuMobile($mnu_personalizacion_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
