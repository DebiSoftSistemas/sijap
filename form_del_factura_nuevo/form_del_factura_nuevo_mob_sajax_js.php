  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_factura_nuevo_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_factura_nuevo_mob_form();
	}
...
?>
  ...
  // ---------- Validate fac_fecha
  function do_ajax_form_del_factura_nuevo_mob_validate_fac_fecha()
  {
    var nomeCampo_fac_fecha = "fac_fecha";
    var var_fac_fecha = scAjaxGetFieldText(nomeCampo_fac_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_nuevo_mob_validate_fac_fecha(var_fac_fecha, var_script_case_init, do_ajax_form_del_factura_nuevo_mob_validate_fac_fecha_cb);
  } // do_ajax_form_del_factura_nuevo_mob_validate_fac_fecha

  function do_ajax_form_del_factura_nuevo_mob_validate_fac_fecha_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_nuevo_mob_validate_fac_fecha_cb

  // ---------- Validate fac_establecimiento
  function do_ajax_form_del_factura_nuevo_mob_validate_fac_establecimiento()
  {
    var nomeCampo_fac_establecimiento = "fac_establecimiento";
    var var_fac_establecimiento = scAjaxGetFieldSelect(nomeCampo_fac_establecimiento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_nuevo_mob_validate_fac_establecimiento(var_fac_establecimiento, var_script_case_init, do_ajax_form_del_factura_nuevo_mob_validate_fac_establecimiento_cb);
  } // do_ajax_form_del_factura_nuevo_mob_validate_fac_establecimiento

  function do_ajax_form_del_factura_nuevo_mob_validate_fac_establecimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_nuevo_mob_validate_fac_establecimiento_cb

  // ---------- Validate fac_punto_emision
  function do_ajax_form_del_factura_nuevo_mob_validate_fac_punto_emision()
  {
    var nomeCampo_fac_punto_emision = "fac_punto_emision";
    var var_fac_punto_emision = scAjaxGetFieldSelect(nomeCampo_fac_punto_emision);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_nuevo_mob_validate_fac_punto_emision(var_fac_punto_emision, var_script_case_init, do_ajax_form_del_factura_nuevo_mob_validate_fac_punto_emision_cb);
  } // do_ajax_form_del_factura_nuevo_mob_validate_fac_punto_emision

  function do_ajax_form_del_factura_nuevo_mob_validate_fac_punto_emision_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_nuevo_mob_validate_fac_punto_emision_cb

  // ---------- Validate fac_secuencial
  function do_ajax_form_del_factura_nuevo_mob_validate_fac_secuencial()
  {
    var nomeCampo_fac_secuencial = "fac_secuencial";
    var var_fac_secuencial = scAjaxGetFieldText(nomeCampo_fac_secuencial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_nuevo_mob_validate_fac_secuencial(var_fac_secuencial, var_script_case_init, do_ajax_form_del_factura_nuevo_mob_validate_fac_secuencial_cb);
  } // do_ajax_form_del_factura_nuevo_mob_validate_fac_secuencial

  function do_ajax_form_del_factura_nuevo_mob_validate_fac_secuencial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_nuevo_mob_validate_fac_secuencial_cb

  // ---------- Validate fac_serie_guia
  function do_ajax_form_del_factura_nuevo_mob_validate_fac_serie_guia()
  {
    var nomeCampo_fac_serie_guia = "fac_serie_guia";
    var var_fac_serie_guia = scAjaxGetFieldText(nomeCampo_fac_serie_guia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_nuevo_mob_validate_fac_serie_guia(var_fac_serie_guia, var_script_case_init, do_ajax_form_del_factura_nuevo_mob_validate_fac_serie_guia_cb);
  } // do_ajax_form_del_factura_nuevo_mob_validate_fac_serie_guia

  function do_ajax_form_del_factura_nuevo_mob_validate_fac_serie_guia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_nuevo_mob_validate_fac_serie_guia_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_factura_nuevo_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_factura_nuevo_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_fac_fecha = scAjaxGetFieldText("fac_fecha");
    var var_fac_establecimiento = scAjaxGetFieldSelect("fac_establecimiento");
    var var_fac_punto_emision = scAjaxGetFieldSelect("fac_punto_emision");
    ...
    scAjaxProcOn();
    x_ajax_form_del_factura_nuevo_mob_submit_form(var_fac_fecha, var_fac_establecimiento, var_fac_punto_emision, var_fac_secuencial, var_fac_serie_guia, var_fac_numero, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_factura_nuevo_mob_submit_form_cb);
  } // do_ajax_form_del_factura_nuevo_mob_submit_form

  function do_ajax_form_del_factura_nuevo_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_factura_nuevo_mob_submit_form_cb_after_alert);
  } // do_ajax_form_del_factura_nuevo_mob_submit_form_cb
  function do_ajax_form_del_factura_nuevo_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_factura_nuevo_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_factura_nuevo_mob_navigate_form()
  {
    perform_ajax_form_del_factura_nuevo_mob_navigate_form();
  }

  function perform_ajax_form_del_factura_nuevo_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_del_factura_nuevo_mob_navigate_form(var_fac_numero, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_factura_nuevo_mob_navigate_form_cb);
  } // do_ajax_form_del_factura_nuevo_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_nuevo_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_factura_nuevo_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_factura_nuevo_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_del_factura_nuevo_mob_navigate_form_cb
  function do_ajax_form_del_factura_nuevo_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_del_factura_nuevo_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_factura_nuevo_mob_navigate_form_cb_after_alert

  function sc_hide_form_del_factura_nuevo_mob_form()
  {
  ...
  ajax_field_list[0] = "fac_fecha";
  ajax_field_list[1] = "fac_establecimiento";
  ajax_field_list[2] = "fac_punto_emision";
  ajax_field_list[3] = "fac_secuencial";
  ajax_field_list[4] = "fac_serie_guia";
  ...
  var ajax_field_id = {
    ...
    "fac_establecimiento": new Array("hidden_field_label_fac_establecimiento", "hidden_field_data_fac_establecimiento"),
    "fac_punto_emision": new Array("hidden_field_label_fac_punto_emision", "hidden_field_data_fac_punto_emision"),
  ...
  var ajax_read_only = {
    "fac_fecha": "on",
    "fac_establecimiento": "on",
    "fac_punto_emision": "on",
    "fac_secuencial": "on",
    "fac_serie_guia": "on"
  };
