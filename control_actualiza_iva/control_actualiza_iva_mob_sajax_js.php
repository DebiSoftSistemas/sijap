  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_actualiza_iva_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_actualiza_iva_mob_form();
	}
...
?>
  ...
  // ---------- Validate sri_tarifa_iva_actual
  function do_ajax_control_actualiza_iva_mob_validate_sri_tarifa_iva_actual()
  {
    var nomeCampo_sri_tarifa_iva_actual = "sri_tarifa_iva_actual";
    var var_sri_tarifa_iva_actual = scAjaxGetFieldSelect(nomeCampo_sri_tarifa_iva_actual);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_actualiza_iva_mob_validate_sri_tarifa_iva_actual(var_sri_tarifa_iva_actual, var_script_case_init, do_ajax_control_actualiza_iva_mob_validate_sri_tarifa_iva_actual_cb);
  } // do_ajax_control_actualiza_iva_mob_validate_sri_tarifa_iva_actual

  function do_ajax_control_actualiza_iva_mob_validate_sri_tarifa_iva_actual_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sri_tarifa_iva_actual";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_actualiza_iva_mob_validate_sri_tarifa_iva_actual_cb

  // ---------- Validate sri_tarifa_iva
  function do_ajax_control_actualiza_iva_mob_validate_sri_tarifa_iva()
  {
    var nomeCampo_sri_tarifa_iva = "sri_tarifa_iva";
    var var_sri_tarifa_iva = scAjaxGetFieldSelect(nomeCampo_sri_tarifa_iva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_actualiza_iva_mob_validate_sri_tarifa_iva(var_sri_tarifa_iva, var_script_case_init, do_ajax_control_actualiza_iva_mob_validate_sri_tarifa_iva_cb);
  } // do_ajax_control_actualiza_iva_mob_validate_sri_tarifa_iva

  function do_ajax_control_actualiza_iva_mob_validate_sri_tarifa_iva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sri_tarifa_iva";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_actualiza_iva_mob_validate_sri_tarifa_iva_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_actualiza_iva_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_actualiza_iva_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_sri_tarifa_iva_actual = scAjaxGetFieldSelect("sri_tarifa_iva_actual");
    var var_sri_tarifa_iva = scAjaxGetFieldSelect("sri_tarifa_iva");
    ...
    scAjaxProcOn();
    x_ajax_control_actualiza_iva_mob_submit_form(var_sri_tarifa_iva_actual, var_sri_tarifa_iva, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_actualiza_iva_mob_submit_form_cb);
  } // do_ajax_control_actualiza_iva_mob_submit_form

  function do_ajax_control_actualiza_iva_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_actualiza_iva_mob_submit_form_cb_after_alert);
  } // do_ajax_control_actualiza_iva_mob_submit_form_cb
  function do_ajax_control_actualiza_iva_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_actualiza_iva_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_actualiza_iva_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_control_actualiza_iva_mob_navigate_form, function() {});
    } else {
      perform_ajax_control_actualiza_iva_mob_navigate_form();
    }
  }

  function perform_ajax_control_actualiza_iva_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_actualiza_iva_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_actualiza_iva_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_actualiza_iva_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_actualiza_iva_mob_navigate_form_cb_after_alert);
  } // do_ajax_control_actualiza_iva_mob_navigate_form_cb
  function do_ajax_control_actualiza_iva_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_actualiza_iva_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_actualiza_iva_mob_navigate_form_cb_after_alert

  function sc_hide_control_actualiza_iva_mob_form()
  {
  ...
  ajax_field_list[0] = "sri_tarifa_iva_actual";
  ajax_field_list[1] = "sri_tarifa_iva";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "sri_tarifa_iva_actual": {"label": "<?php echo $this->Ini->Nm_lang['lang_tarifa_iva'] ?> Actual", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "sri_tarifa_iva": {"label": "<?php echo $this->Ini->Nm_lang['lang_tarifa_iva'] ?> Nueva", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    "sri_tarifa_iva_actual": new Array(),
    "sri_tarifa_iva": new Array()
  };
  ajax_field_mult["sri_tarifa_iva_actual"][1] = "sri_tarifa_iva_actual";
  ajax_field_mult["sri_tarifa_iva"][1] = "sri_tarifa_iva";

  var ajax_field_id = {
    "sri_tarifa_iva_actual": new Array("hidden_field_label_sri_tarifa_iva_actual", "hidden_field_data_sri_tarifa_iva_actual"),
    "sri_tarifa_iva": new Array("hidden_field_label_sri_tarifa_iva", "hidden_field_data_sri_tarifa_iva")
  };

  var ajax_read_only = {
    "sri_tarifa_iva_actual": "off",
    "sri_tarifa_iva": "off"
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("sri_tarifa_iva_actual" == sIndex)
    {
