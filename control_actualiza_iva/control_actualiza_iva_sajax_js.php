  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_actualiza_iva" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_actualiza_iva_form();
	}
...
?>
  ...
  function do_ajax_control_actualiza_iva_validate_sri_tarifa_iva_actual()
  {
    ...
    x_ajax_control_actualiza_iva_validate_sri_tarifa_iva_actual(var_sri_tarifa_iva_actual, var_script_case_init, do_ajax_control_actualiza_iva_validate_sri_tarifa_iva_actual_cb);
  } // do_ajax_control_actualiza_iva_validate_sri_tarifa_iva_actual

  function do_ajax_control_actualiza_iva_validate_sri_tarifa_iva_actual_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_actualiza_iva_validate_sri_tarifa_iva_actual_cb

  // ---------- Validate sri_tarifa_iva
  function do_ajax_control_actualiza_iva_validate_sri_tarifa_iva()
  {
    var nomeCampo_sri_tarifa_iva = "sri_tarifa_iva";
    var var_sri_tarifa_iva = scAjaxGetFieldSelect(nomeCampo_sri_tarifa_iva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_actualiza_iva_validate_sri_tarifa_iva(var_sri_tarifa_iva, var_script_case_init, do_ajax_control_actualiza_iva_validate_sri_tarifa_iva_cb);
  } // do_ajax_control_actualiza_iva_validate_sri_tarifa_iva

  function do_ajax_control_actualiza_iva_validate_sri_tarifa_iva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_actualiza_iva_validate_sri_tarifa_iva_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_actualiza_iva_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_actualiza_iva_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_control_actualiza_iva_submit_form(var_sri_tarifa_iva_actual, var_sri_tarifa_iva, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_actualiza_iva_submit_form_cb);
  } // do_ajax_control_actualiza_iva_submit_form

  function do_ajax_control_actualiza_iva_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_actualiza_iva_submit_form_cb_after_alert);
  } // do_ajax_control_actualiza_iva_submit_form_cb
  function do_ajax_control_actualiza_iva_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_actualiza_iva_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_actualiza_iva_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_control_actualiza_iva_navigate_form, function() {});
    } else {
      perform_ajax_control_actualiza_iva_navigate_form();
    }
  }

  function perform_ajax_control_actualiza_iva_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_actualiza_iva_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_actualiza_iva']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_actualiza_iva_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_actualiza_iva_navigate_form_cb_after_alert);
  } // do_ajax_control_actualiza_iva_navigate_form_cb
  function do_ajax_control_actualiza_iva_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_actualiza_iva_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_actualiza_iva_navigate_form_cb_after_alert

  function sc_hide_control_actualiza_iva_form()
  {
