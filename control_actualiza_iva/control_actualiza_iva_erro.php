...
$old_error_handler = set_error_handler("control_actualiza_iva_scriptcase_error_handler");

function control_actualiza_iva_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['control_actualiza_iva']['contr_erro']) && $_SESSION['scriptcase']['control_actualiza_iva']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_control_actualiza_iva->contr_control_actualiza_iva->Apl_com_erro = true;
            if ($inicial_control_actualiza_iva->contr_control_actualiza_iva->NM_ajax_flag)
            {
                $inicial_control_actualiza_iva->contr_control_actualiza_iva->NM_ajax_info['errList']['geral_control_actualiza_iva'][] = $msg;
                return;
            }
            control_actualiza_iva_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function control_actualiza_iva_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['control_actualiza_iva'])  && '' != $_SESSION['scriptcase']['error_icon']['control_actualiza_iva'])  ? $_SESSION['scriptcase']['error_icon']['control_actualiza_iva']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['control_actualiza_iva']) && '' != $_SESSION['scriptcase']['error_span_title']['control_actualiza_iva']) ? $_SESSION['scriptcase']['error_span_title']['control_actualiza_iva'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['control_actualiza_iva']) && '' != $_SESSION['scriptcase']['error_icon_title']['control_actualiza_iva']) ? $_SESSION['scriptcase']['error_icon_title']['control_actualiza_iva'] : '';
?>
