...
class grid_fac_operacion_descuento_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
...
SCEOT;
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_fac_operacion_descuento']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_fac_operacion_descuento']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['where_resumo'] = "";
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['contr_total_geral'] == "OK")
      {
          $this->array_total_op_contrato = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['arr_total']['op_contrato'];
      }
      else
      {
          $this->array_total_op_contrato = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['tot_geral'][2];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['tot_geral'][3];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['tot_geral'][4];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['arr_total']['op_contrato'] = $this->array_total_op_contrato;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['json_use_label'])
       {
          $Lab_op_contrato = "op_contrato";
       }
       else
       {
       $Lab_op_contrato = "Contrato";
       }
       $this->comp_field = array(
           $Lab_op_contrato,
       );

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_fecha_ini']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_fecha_ini'] = "" . $this->Ini->Nm_lang['lang_fecha'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_comentario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_comentario'] = "" . $this->Ini->Nm_lang['lang_comentario'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_subtotal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_subtotal'] = "" . $this->Ini->Nm_lang['lang_subtotal'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_iva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_iva'] = "" . $this->Ini->Nm_lang['lang_iva'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_total'] = "" . $this->Ini->Nm_lang['lang_total'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['detalles']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['detalles'] = "detalles"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_operacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_operacion'] = "Op Operacion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_empresa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_empresa'] = "Op Empresa"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_fecha_emision']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_fecha_emision'] = "Op Fecha Emision"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_fecha_fin']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_fecha_fin'] = "Op Fecha Fin"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_modulo_genera']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_modulo_genera'] = "Op Modulo Genera"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_tipo_cartera']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_tipo_cartera'] = "Op Tipo Cartera"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_propietario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_propietario'] = "Op Propietario"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_subtotal_cero']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_subtotal_cero'] = "Op Subtotal Cero"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_escenario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_escenario'] = "Op Escenario"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_usuario_emite']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_usuario_emite'] = "Op Usuario Emite"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_convenio_pago']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_convenio_pago'] = "Op Convenio Pago"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_dias_vencido']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_dias_vencido'] = "Op Dias Vencido"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_motivo_baja']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_motivo_baja'] = "Op Motivo Baja"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_fecha_baja']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_fecha_baja'] = "Op Fecha Baja"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_usuario_baja']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_usuario_baja'] = "Op Usuario Baja"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_terminal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_terminal'] = "Op Terminal"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_asiento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_asiento'] = "Op Asiento"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_tipo_comprobante']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_tipo_comprobante'] = "Op Tipo Comprobante"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_estado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_estado'] = "Op Estado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_contrato']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_contrato'] = "Op Contrato"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_seleccion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_seleccion'] = "Op Seleccion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_usuario_selecciona']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_usuario_selecciona'] = "Op Usuario Selecciona"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_factura']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_factura'] = "Op Factura"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_asiento_anula']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_asiento_anula'] = "Op Asiento Anula"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_subtotal_iva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_subtotal_iva'] = "Op Subtotal Iva"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_total_descuento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_total_descuento'] = "Op Total Descuento"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_fecha_factura']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['labels']['op_fecha_factura'] = "Op Fecha Factura"; 
       }
       //-----
       $this->comp_field_nm = array(
           'op_contrato' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['summarizing_fields_order']['contrato']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['summarizing_fields_order']['contrato'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['summarizing_fields_order']['contrato'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['summarizing_fields_display']['contrato'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['summarizing_fields_display']['contrato'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['summarizing_fields_display']['contrato'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['summarizing_fields_display']['contrato'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['summarizing_fields_display']['contrato'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['summarizing_fields_display']['contrato'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['summarizing_fields_display']['contrato'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_op_contrato as $i_op_contrato => $d_op_contrato) {
           if (!isset($i_op_contrato, $this->comp_label[0]) || !in_array($i_op_contrato, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_op_contrato[5] ] = $d_op_contrato[4];
               $this->comp_label[0][ $d_op_contrato[5] ] = $d_op_contrato[4];
           }
       }
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_fac_operacion_descuento@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['proc_pdf_vert']){ 
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_fac_operacion_descuento_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['doc_word'])
{
      ...
      { 
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['ajax_nav']) {  
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_fac_operacion_descuento_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_fac_operacion_descuento_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_fac_operacion_descuento_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_fac_operacion_descuento/grid_fac_operacion_descuento_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_fac_operacion_descuento/grid_fac_operacion_descuento_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_fac_operacion_descuento&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid&nm_all_modules=grid&password=n&summary_export_columns=S&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_fac_operacion_descuento_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_fac_operacion_descuento']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_fac_operacion_descuento']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_fac_operacion_descuento_config_pivot.php?nome_apl=grid_fac_operacion_descuento&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("                  action=\"grid_fac_operacion_descuento_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("               document.Fprint.action = \"grid_fac_operacion_descuento_export_ctrl.php\";\r\n");
      $nm_saida->saida("           }\r\n");
      $nm_saida->saida("           else\r\n");
      $nm_saida->saida("           {\r\n");
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"grid_fac_operacion_descuento_iframe.php\";\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_fac_operacion_descuento_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_fac_operacion_descuento/grid_fac_operacion_descuento_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['cond_pesq'], 0, $trab_pos);
   ...
   //---- 
   function adiciona_registro($sum_op_subtotal, $sum_op_iva, $sum_op_total, $quebra_op_contrato, $quebra_op_contrato_orig)
   {
      //----- Op Contrato
      if (!isset($this->array_total_op_contrato[$quebra_op_contrato_orig]))
      {
         $this->array_total_op_contrato[$quebra_op_contrato_orig][0] = 1;
         $this->array_total_op_contrato[$quebra_op_contrato_orig][1] = $sum_op_subtotal;
         $this->array_total_op_contrato[$quebra_op_contrato_orig][2] = $sum_op_iva;
         $this->array_total_op_contrato[$quebra_op_contrato_orig][3] = $sum_op_total;
         $this->array_total_op_contrato[$quebra_op_contrato_orig][4] = $quebra_op_contrato;
         $this->array_total_op_contrato[$quebra_op_contrato_orig][5] = $quebra_op_contrato_orig;
      }
      else
      {
         $this->array_total_op_contrato[$quebra_op_contrato_orig][0]++;
         $this->array_total_op_contrato[$quebra_op_contrato_orig][1] = bcadd($this->array_total_op_contrato[$quebra_op_contrato_orig][1], $sum_op_subtotal, 10);
         $this->array_total_op_contrato[$quebra_op_contrato_orig][2] = bcadd($this->array_total_op_contrato[$quebra_op_contrato_orig][2], $sum_op_iva, 10);
         $this->array_total_op_contrato[$quebra_op_contrato_orig][3] = bcadd($this->array_total_op_contrato[$quebra_op_contrato_orig][3], $sum_op_total, 10);
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('contrato', 'op_contrato');
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->op_comentario = $rs_res->fields[1] ;  
            $this->op_subtotal = $rs_res->fields[2] ;  
            $this->op_iva = $rs_res->fields[3] ;  
            $this->op_total = $rs_res->fields[4] ;  
            $this->op_operacion = $rs_res->fields[5] ;  
            $this->op_empresa = $rs_res->fields[6] ;  
            $this->op_fecha_emision = $rs_res->fields[7] ;  
...
$_SESSION['scriptcase']['grid_fac_operacion_descuento']['contr_erro'] = 'off'; 
            ...
            nmgp_Form_Num_Val($this->op_contrato, "", ",", "0", "S", "2", "", "N:", "-") ; 
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->op_subtotal, $this->op_iva, $this->op_total, $this->op_contrato, $this->op_contrato_orig);
            }
   }
//
