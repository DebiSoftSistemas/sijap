...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_fac_operacion_descuento"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_fac_operacion_descuento"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_fac_operacion_descuento']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_fac_operacion_descuento']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_fac_operacion_descuento']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_fac_operacion_descuento']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_fac_operacion_descuento']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_fac_operacion_descuento</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_fac_operacion_descuento']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_fac_operacion_descuento']['embutida_filho'] as $ind => $sc_init)
          {
