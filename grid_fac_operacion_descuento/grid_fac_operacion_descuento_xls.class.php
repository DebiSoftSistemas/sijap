...
class grid_fac_operacion_descuento_xls
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_fac_operacion_descuento/grid_fac_operacion_descuento_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "grid_fac_operacion_descuento_res_xls.class.php");
              $this->Res_xls = new grid_fac_operacion_descuento_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_fac_operacion_descuento.zip";
          $this->Arquivo   .= "_grid_fac_operacion_descuento" . $this->Xls_tp;
          $this->Tit_doc    = "grid_fac_operacion_descuento" . $this->Xls_tp;
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      while (!$rs->EOF)
      {
         ...
         $this->arg_sum_op_contrato = ($this->op_contrato == "") ? " is null " : " = " . $this->op_contrato;
          ...
          {  
              ...
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['embutida'] && !$prim_gb && $this->groupby_show == "S") {
...
$_SESSION['scriptcase']['grid_fac_operacion_descuento']['contr_erro'] = 'off'; 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['nolabel'])
       {
 ...
 function quebra_op_contrato_contrato($op_contrato) 
 {
     ...
     foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
     {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['field_order'] as $Cada_cmp)
       {
           if (isset($NM_cmp_tot['op_subtotal'][$Tipo_Sum]) && $Cada_cmp == "op_subtotal" && (!isset($this->NM_cmp_hidden['op_subtotal']) || $this->NM_cmp_hidden['op_subtotal'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['op_subtotal'][$Tipo_Sum] . "op_contrato_op_subtotal";
           ...
           elseif (isset($NM_cmp_tot['op_iva'][$Tipo_Sum]) && $Cada_cmp == "op_iva" && (!isset($this->NM_cmp_hidden['op_iva']) || $this->NM_cmp_hidden['op_iva'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['op_iva'][$Tipo_Sum] . "op_contrato_op_iva";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['embutida']) {
           ...
           elseif (!isset($this->NM_cmp_hidden[$Cada_cmp]) || $this->NM_cmp_hidden[$Cada_cmp] != "off")
           {
               ...
               elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['embutida']) {
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
   ...
   function quebra_geral_contrato_bot()
   {
       ...
       $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . '');
       $mens_tot_base = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['tot_geral'][0];
       $prim_lin_tot  = true;
     foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
     {
       $mens_tot      = $mens_tot_base . " - " . $Tit_sum;
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['field_order'] as $Cada_cmp)
       {
           if (isset($NM_cmp_tot['op_subtotal'][$Tipo_Sum]) && $Cada_cmp == "op_subtotal" && (!isset($this->NM_cmp_hidden['op_subtotal']) || $this->NM_cmp_hidden['op_subtotal'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['tot_geral'][$NM_cmp_tot['op_subtotal'][$Tipo_Sum]];
               $prim_cmp = false;
           ...
           elseif (isset($NM_cmp_tot['op_iva'][$Tipo_Sum]) && $Cada_cmp == "op_iva" && (!isset($this->NM_cmp_hidden['op_iva']) || $this->NM_cmp_hidden['op_iva'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['tot_geral'][$NM_cmp_tot['op_iva'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           elseif (isset($NM_cmp_tot['op_total'][$Tipo_Sum]) && $Cada_cmp == "op_total" && (!isset($this->NM_cmp_hidden['op_total']) || $this->NM_cmp_hidden['op_total'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['tot_geral'][$NM_cmp_tot['op_total'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['xls_file'] = $this->Xls_f;
      }
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_descuento']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
