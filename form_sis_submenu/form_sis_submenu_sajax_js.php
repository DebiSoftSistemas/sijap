  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_submenu" == sTestField)
        {
...
?>
  ...
  // ---------- Validate sm_id_
  function do_ajax_form_sis_submenu_validate_sm_id_(iNumLinha)
  {
    var nomeCampo_sm_id_ = "sm_id_" + iNumLinha;
    var var_sm_id_ = scAjaxGetFieldHidden(nomeCampo_sm_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_submenu_validate_sm_id_(var_sm_id_, iNumLinha, var_script_case_init, do_ajax_form_sis_submenu_validate_sm_id__cb);
  } // do_ajax_form_sis_submenu_validate_sm_id_

  function do_ajax_form_sis_submenu_validate_sm_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "sm_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "sm_id_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "sm_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "sm_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_submenu_validate_sm_id__cb

  // ---------- Validate sm_menu_
  function do_ajax_form_sis_submenu_validate_sm_menu_(iNumLinha)
  {
    var nomeCampo_sm_menu_ = "sm_menu_" + iNumLinha;
    var var_sm_menu_ = scAjaxGetFieldText(nomeCampo_sm_menu_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_submenu_validate_sm_menu_(var_sm_menu_, iNumLinha, var_script_case_init, do_ajax_form_sis_submenu_validate_sm_menu__cb);
  } // do_ajax_form_sis_submenu_validate_sm_menu_

  function do_ajax_form_sis_submenu_validate_sm_menu__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "sm_menu_" + iLineNumber;
    }
    else
    {
      sFieldValid = "sm_menu_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "sm_menu_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "sm_menu_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_submenu_validate_sm_menu__cb

  // ---------- Validate sm_descripcion_
  function do_ajax_form_sis_submenu_validate_sm_descripcion_(iNumLinha)
  {
    var nomeCampo_sm_descripcion_ = "sm_descripcion_" + iNumLinha;
    var var_sm_descripcion_ = scAjaxGetFieldText(nomeCampo_sm_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_submenu_validate_sm_descripcion_(var_sm_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_sis_submenu_validate_sm_descripcion__cb);
  } // do_ajax_form_sis_submenu_validate_sm_descripcion_

  function do_ajax_form_sis_submenu_validate_sm_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "sm_descripcion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "sm_descripcion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "sm_descripcion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "sm_descripcion_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_submenu_validate_sm_descripcion__cb

  // ---------- Validate aplicaciones_
  function do_ajax_form_sis_submenu_validate_aplicaciones_(iNumLinha)
  {
  } // do_ajax_form_sis_submenu_validate_aplicaciones_

  function do_ajax_form_sis_submenu_validate_aplicaciones__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "aplicaciones_" + iLineNumber;
    }
    else
    {
      sFieldValid = "aplicaciones_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "aplicaciones_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "aplicaciones_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_submenu_validate_aplicaciones__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_sis_submenu_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_sis_submenu_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sis_submenu_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_sis_submenu_add_new_line_cb);
  } // do_ajax_form_sis_submenu_add_new_line

  function do_ajax_form_sis_submenu_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_sis_submenu_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_sis_submenu_backup_line(iNumLinha)
  {
    var var_sm_id_ = scAjaxGetFieldHidden("sm_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_submenu_backup_line(var_sm_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_sis_submenu_backup_line_cb);
  } // do_ajax_form_sis_submenu_backup_line

  function do_ajax_form_sis_submenu_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_sis_submenu_backup_line_cb

  function do_ajax_form_sis_submenu_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_sis_submenu_cancel_insert

  function do_ajax_form_sis_submenu_cancel_update(iSeqVert)
  {
    do_ajax_form_sis_submenu_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_sis_submenu_cancel_update

  function do_ajax_form_sis_submenu_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_sis_submenu_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_sis_submenu_table_refresh()
  {
    var var_sm_id_ = document.F2.sm_id_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_sis_submenu_table_refresh(var_sm_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_submenu_table_refresh_cb);
  } //  do_ajax_form_sis_submenu_table_refresh

  function do_ajax_form_sis_submenu_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.sm_id_.value = scAjaxGetKeyValue("sm_id_");
    ...
    scAjaxAlert(do_ajax_form_sis_submenu_table_refresh_cb_after_alert);
  } // do_ajax_form_sis_submenu_table_refresh_cb
  function do_ajax_form_sis_submenu_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_sis_submenu_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_sis_submenu_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_sis_submenu_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_sm_id_ = scAjaxGetFieldHidden("sm_id_" + iNumLinha);
    var var_sm_menu_ = scAjaxGetFieldText("sm_menu_" + iNumLinha);
    var var_sm_descripcion_ = scAjaxGetFieldText("sm_descripcion_" + iNumLinha);
    var var_aplicaciones_ = scAjaxGetFieldHidden("aplicaciones_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_sis_submenu_submit_form(var_sm_id_, var_sm_menu_, var_sm_descripcion_, var_aplicaciones_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_submenu_submit_form_cb);
  } // do_ajax_form_sis_submenu_submit_form

  function do_ajax_form_sis_submenu_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("sm_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("sm_menu_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("sm_descripcion_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("aplicaciones_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sis_submenu_submit_form_cb_after_alert);
  } // do_ajax_form_sis_submenu_submit_form_cb
  function do_ajax_form_sis_submenu_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_submenu_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sis_submenu_navigate_form()
  {
    perform_ajax_form_sis_submenu_navigate_form();
  }

  function perform_ajax_form_sis_submenu_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_sis_submenu_cancel_insert(sc_form_sis_submenu_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("sm_id_" + iNavForm);
      scAjaxHideErrorDisplay("sm_menu_" + iNavForm);
      scAjaxHideErrorDisplay("sm_descripcion_" + iNavForm);
      scAjaxHideErrorDisplay("aplicaciones_" + iNavForm);
    }
    var var_sm_id_ = document.F2.sm_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sis_submenu_navigate_form(var_sm_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_submenu_navigate_form_cb);
  } // do_ajax_form_sis_submenu_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_submenu']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_submenu_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.sm_id_.value = scAjaxGetKeyValue("sm_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_submenu_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_submenu_navigate_form_cb
  function do_ajax_form_sis_submenu_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_sis_submenu_navigate_form_cb_after_alert

    function sc_form_sis_submenu_get_last_line_number()
    {
    ...
    } //sc_form_sis_submenu_get_last_line_number

  function sc_hide_form_sis_submenu_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "sm_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "sm_menu_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "sm_descripcion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "aplicaciones_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["sm_id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["sm_menu_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_menu'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["sm_descripcion_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_submenu'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["aplicaciones_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_aplicaciones'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["sm_id_"][iNumLinha] = "sm_id_" + iNumLinha;
    ajax_field_mult["sm_menu_"][iNumLinha] = "sm_menu_" + iNumLinha;
    ajax_field_mult["sm_descripcion_"][iNumLinha] = "sm_descripcion_" + iNumLinha;
    ajax_field_mult["aplicaciones_"][iNumLinha] = "aplicaciones_" + iNumLinha;
    ajax_field_id["sm_descripcion_" + iNumLinha] = new Array("hidden_field_label_sm_descripcion_", "hidden_field_data_sm_descripcion_" + iNumLinha);
    ajax_field_id["aplicaciones_" + iNumLinha] = new Array("hidden_field_label_aplicaciones_", "hidden_field_data_aplicaciones_" + iNumLinha);
    ajax_error_count["sm_id_" + iNumLinha] = "off";
    ajax_error_count["sm_menu_" + iNumLinha] = "off";
    ajax_error_count["sm_descripcion_" + iNumLinha] = "off";
    ajax_error_count["aplicaciones_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["sm_id_" + iNumLinha] = "on";
    ajax_read_only["sm_menu_" + iNumLinha] = "off";
    ajax_read_only["sm_descripcion_" + iNumLinha] = "off";
    ajax_read_only["aplicaciones_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["sm_id_" + iNumLinha] = "on";
    ajax_read_only["sm_menu_" + iNumLinha] = "on";
    ajax_read_only["sm_descripcion_" + iNumLinha] = "on";
    ajax_read_only["aplicaciones_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["sm_id_" + iNumLinha] = null;
    ajax_error_list["sm_menu_" + iNumLinha] = null;
    ajax_error_list["sm_descripcion_" + iNumLinha] = null;
    ajax_error_list["aplicaciones_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "sm_id_": new Array(),
    "sm_menu_": new Array(),
    "sm_descripcion_": new Array(),
    "aplicaciones_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["sm_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["sm_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["sm_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["sm_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["sm_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["sm_menu_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["sm_menu_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["sm_menu_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["sm_menu_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["sm_menu_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["sm_descripcion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["sm_descripcion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["sm_descripcion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["sm_descripcion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["sm_descripcion_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["aplicaciones_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["aplicaciones_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["aplicaciones_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["aplicaciones_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["aplicaciones_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['sm_id_'])) ? $this->nmgp_cmp_readonly['sm_id_'] : 'on';
?>
    scAjaxFieldRead("sm_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['sm_menu_'])) ? $this->nmgp_cmp_readonly['sm_menu_'] : 'off';
?>
    scAjaxFieldRead("sm_menu_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['sm_descripcion_'])) ? $this->nmgp_cmp_readonly['sm_descripcion_'] : 'off';
?>
    scAjaxFieldRead("sm_descripcion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['aplicaciones_'])) ? $this->nmgp_cmp_readonly['aplicaciones_'] : 'off';
?>
    scAjaxFieldRead("aplicaciones_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("sm_id_" + iSeq, "on");
    scAjaxFieldRead("sm_menu_" + iSeq, "on");
    scAjaxFieldRead("sm_descripcion_" + iSeq, "on");
    scAjaxFieldRead("aplicaciones_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["sm_id_" + iRow] || "on" == ajax_error_count["sm_menu_" + iRow] || "on" == ajax_error_count["sm_descripcion_" + iRow] || "on" == ajax_error_count["aplicaciones_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sm_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sm_menu_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sm_descripcion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_aplicaciones_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["sm_id_" + iRow] && "off" == ajax_error_count["sm_menu_" + iRow] && "off" == ajax_error_count["sm_descripcion_" + iRow] && "off" == ajax_error_count["aplicaciones_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["sm_id_" + iRow] = "off";
        ajax_error_count["sm_menu_" + iRow] = "off";
        ajax_error_count["sm_descripcion_" + iRow] = "off";
        ajax_error_count["aplicaciones_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_sm_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_sm_menu_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_sm_descripcion_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_aplicaciones_" + iRow).removeClass("scFormErrorLine");
    }
  }
