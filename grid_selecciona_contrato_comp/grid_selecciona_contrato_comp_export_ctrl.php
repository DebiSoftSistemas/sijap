<?php
@session_start() ;
$_SESSION['scriptcase']['grid_selecciona_contrato_comp']['sc_process_barr'] = true;
require_once('../grid_selecciona_contrato_comp/index.php');
unset($_SESSION['scriptcase']['grid_selecciona_contrato_comp']['sc_process_barr']);
$ExportCtrl = new grid_selecciona_contrato_comp_export_control;
$ExportCtrl->Export_barr();

class grid_selecciona_contrato_comp_export_control
{
