...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "gc_id";$Nm_numeric[] = "gc_id";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_gc_id_cond" name="gc_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_gc_id'), this, 'gc_id')">
      ...
      <br><span id="id_hide_gc_id"  <?php echo $str_hide_gc_id?>><INPUT  type="text" id="SC_gc_id" name="gc_id" value="<?php echo NM_encode_input($gc_id) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_gc_empresa_cond" name="gc_empresa_cond" onChange="nm_campos_between(document.getElementById('id_vis_gc_empresa'), this, 'gc_empresa')">
      ...
      <br><span id="id_hide_gc_empresa"  <?php echo $str_hide_gc_empresa?>><?php
      if ($gc_empresa != "")
      {
      $gc_empresa_look = (is_string($gc_empresa) ? substr($this->Db->qstr($gc_empresa), 1, -1) : $gc_empresa); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_gc_descripcion_cond" name="gc_descripcion_cond" onChange="nm_campos_between(document.getElementById('id_vis_gc_descripcion'), this, 'gc_descripcion')">
      ...
      <br><span id="id_hide_gc_descripcion"  <?php echo $str_hide_gc_descripcion?>><?php
      if ($gc_descripcion != "")
      {
      $gc_descripcion_look = (is_string($gc_descripcion) ? substr($this->Db->qstr($gc_descripcion), 1, -1) : $gc_descripcion); 
      $nmgp_def_dados = array(); 
