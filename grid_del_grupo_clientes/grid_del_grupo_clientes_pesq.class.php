...
class grid_del_grupo_clientes_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_del_grupo_clientes_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_del_grupo_clientes_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_del_grupo_clientes_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_gc_empresa')
      {
          $gc_empresa = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_gc_empresa($gc_empresa);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_gc_descripcion')
      {
          $gc_descripcion = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_gc_descripcion($gc_descripcion);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$campo_join]);
              return;
          }
         $nm_ini_lower = "";
         $nm_fim_lower = "";
      ...
      else
      {
         ...
         $nome_sum = "del_grupo_clientes.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> del_grupo_clientes</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_del_grupo_clientes/grid_del_grupo_clientes_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_del_grupo_clientes_ajax_search.js"></script>
 <script type="text/javascript" src="grid_del_grupo_clientes_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_del_grupo_clientes_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_del_grupo_clientes']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_del_grupo_clientes']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_gc_id_cond#NMF#' + search_get_sel_txt('SC_gc_id_cond') + '@NMF@';
  str_out += 'SC_gc_id#NMF#' + search_get_text('SC_gc_id') + '@NMF@';
  str_out += 'SC_gc_empresa_cond#NMF#' + search_get_sel_txt('SC_gc_empresa_cond') + '@NMF@';
  str_out += 'SC_gc_empresa#NMF#' + search_get_text('SC_gc_empresa') + '@NMF@';
  str_out += 'id_ac_gc_empresa#NMF#' + search_get_title('select2-id_ac_gc_empresa-container') + '@NMF@';
  str_out += 'SC_gc_descripcion_cond#NMF#' + search_get_sel_txt('SC_gc_descripcion_cond') + '@NMF@';
  str_out += 'SC_gc_descripcion#NMF#' + search_get_text('SC_gc_descripcion') + '@NMF@';
  str_out += 'id_ac_gc_descripcion#NMF#' + search_get_title('select2-id_ac_gc_descripcion-container') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-gc_descripcion").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_gc_descripcion",
      max_itens: "10",
   ...
   $("#SC_gc_descripcion").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-gc_empresa").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_gc_empresa",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_gc_empresa").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      global 
             $gc_id_cond, $gc_id,
             $gc_empresa_cond, $gc_empresa, $gc_empresa_autocomp,
             $gc_descripcion_cond, $gc_descripcion, $gc_descripcion_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $gc_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['campos_busca']['gc_id']; 
          $gc_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['campos_busca']['gc_id_cond']; 
          $gc_empresa = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['campos_busca']['gc_empresa']; 
          $gc_empresa_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['campos_busca']['gc_empresa_cond']; 
          $gc_descripcion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['campos_busca']['gc_descripcion']; 
          $gc_descripcion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['campos_busca']['gc_descripcion_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['campos_busca']['NM_operador']; 
          if (strtoupper($gc_id_cond) != "II" && strtoupper($gc_id_cond) != "QP" && strtoupper($gc_id_cond) != "NP" && strtoupper($gc_id_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($gc_id, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($gc_id_cond) || empty($gc_id_cond))
      {
         $gc_id_cond = "gt";
      }
      if (!isset($gc_empresa_cond) || empty($gc_empresa_cond))
      {
         $gc_empresa_cond = "qp";
      }
      if (!isset($gc_descripcion_cond) || empty($gc_descripcion_cond))
      {
         $gc_descripcion_cond = "qp";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_gc_id = (in_array($gc_id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_gc_empresa = (in_array($gc_empresa_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_gc_descripcion = (in_array($gc_descripcion_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($gc_id) || $gc_id == "")
      {
          $gc_id = "";
      }
      if (isset($gc_id) && !empty($gc_id))
      {
         $tmp_pos = (is_string($gc_id)) ? strpos($gc_id, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $gc_id = substr($gc_id, 0, $tmp_pos);
         }
      }
      if (!isset($gc_empresa) || $gc_empresa == "")
      {
          $gc_empresa = "";
      }
      if (isset($gc_empresa) && !empty($gc_empresa))
      {
         $tmp_pos = (is_string($gc_empresa)) ? strpos($gc_empresa, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $gc_empresa = substr($gc_empresa, 0, $tmp_pos);
         }
      }
      if (!isset($gc_descripcion) || $gc_descripcion == "")
      {
          $gc_descripcion = "";
      }
      if (isset($gc_descripcion) && !empty($gc_descripcion))
      {
         $tmp_pos = (is_string($gc_descripcion)) ? strpos($gc_descripcion, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $gc_descripcion = substr($gc_descripcion, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_gc_id_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['gc_id'])) ? $this->New_label['gc_id'] : "Gc Id"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_gc_id_cond" name="gc_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_gc_id'), this, 'gc_id')">
       <OPTION value="gt" <?php if ("gt" == $gc_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $gc_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $gc_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_gc_id" <?php echo $str_hide_gc_id?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['gc_id'])) ? $this->New_label['gc_id'] : "Gc Id";
 $nmgp_tab_label .= "gc_id?#?" . $SC_Label . "?@?";
...
?>
<INPUT  type="text" id="SC_gc_id" name="gc_id" value="<?php echo NM_encode_input($gc_id) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_gc_empresa_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['gc_empresa'])) ? $this->New_label['gc_empresa'] : "Gc Empresa"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_gc_empresa_cond" name="gc_empresa_cond" onChange="nm_campos_between(document.getElementById('id_vis_gc_empresa'), this, 'gc_empresa')">
       <OPTION value="qp" <?php if ("qp" == $gc_empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $gc_empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $gc_empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $gc_empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_gc_empresa" <?php echo $str_hide_gc_empresa?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['gc_empresa'])) ? $this->New_label['gc_empresa'] : "Gc Empresa";
 $nmgp_tab_label .= "gc_empresa?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $gc_empresa;
      }
?>
<INPUT  type="text" id="SC_gc_empresa" name="gc_empresa" value="<?php echo NM_encode_input($gc_empresa) ?>"  size=13 alt="{datatype: 'text', maxLength: 13, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-gc_empresa" id="id_ac_gc_empresa" name="gc_empresa_autocomp"><?php if ('' !=  $gc_empresa) { ?><option value="<?php echo $gc_empresa ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_gc_descripcion_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['gc_descripcion'])) ? $this->New_label['gc_descripcion'] : "" . $this->Ini->Nm_lang['lang_grupo_clientes'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_gc_descripcion_cond" name="gc_descripcion_cond" onChange="nm_campos_between(document.getElementById('id_vis_gc_descripcion'), this, 'gc_descripcion')">
       <OPTION value="qp" <?php if ("qp" == $gc_descripcion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $gc_descripcion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $gc_descripcion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $gc_descripcion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_gc_descripcion" <?php echo $str_hide_gc_descripcion?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['gc_descripcion'])) ? $this->New_label['gc_descripcion'] : "" . $this->Ini->Nm_lang['lang_grupo_clientes'] . "";
 $nmgp_tab_label .= "gc_descripcion?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $gc_descripcion;
      }
?>
<INPUT  type="text" id="SC_gc_descripcion" name="gc_descripcion" value="<?php echo NM_encode_input($gc_descripcion) ?>"  size=50 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-gc_descripcion" id="id_ac_gc_descripcion" name="gc_descripcion_autocomp"><?php if ('' !=  $gc_descripcion) { ?><option value="<?php echo $gc_descripcion ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_del_grupo_clientes_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_del_grupo_clientes']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_del_grupo_clientes']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.gc_id_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_gc_id'), document.F1.gc_id_cond, 'gc_id');
   document.F1.gc_id.value = "";
   document.F1.gc_empresa_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_gc_empresa'), document.F1.gc_empresa_cond, 'gc_empresa');
   document.F1.gc_empresa.value = "";
   document.F1.gc_empresa_autocomp.value = "";
   $('#select2-id_ac_gc_empresa-container').html('<?php echo $this->Val_init_gc_empresa['desc'] ?>');;
   document.F1.gc_descripcion_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_gc_descripcion'), document.F1.gc_descripcion_cond, 'gc_descripcion');
   document.F1.gc_descripcion.value = "";
   document.F1.gc_descripcion_autocomp.value = "";
   $('#select2-id_ac_gc_descripcion-container').html('<?php echo $this->Val_init_gc_descripcion['desc'] ?>');;
   Sc_carga_select2('all');
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_del_grupo_clientes/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_gc_id_cond'] = 'cond';
      $tp_fields['SC_gc_id'] = 'text';
      $tp_fields['SC_gc_empresa_cond'] = 'cond';
      $tp_fields['SC_gc_empresa'] = 'text_aut';
      $tp_fields['id_ac_gc_empresa'] = 'select2_aut';
      $tp_fields['SC_gc_descripcion_cond'] = 'cond';
      $tp_fields['SC_gc_descripcion'] = 'text_aut';
      $tp_fields['id_ac_gc_descripcion'] = 'select2_aut';
   ...
   {
      global $gc_id_cond, $gc_id,
             $gc_empresa_cond, $gc_empresa, $gc_empresa_autocomp,
             $gc_descripcion_cond, $gc_descripcion, $gc_descripcion_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($gc_empresa_autocomp) && empty($gc_empresa))
      {
          $gc_empresa = $gc_empresa_autocomp;
      }
      if (!empty($gc_descripcion_autocomp) && empty($gc_descripcion))
      {
          $gc_descripcion = $gc_descripcion_autocomp;
      }
      $gc_id_cond_salva = $gc_id_cond; 
      if (!isset($gc_id_input_2) || $gc_id_input_2 == "")
      {
          $gc_id_input_2 = $gc_id;
      }
      $gc_empresa_cond_salva = $gc_empresa_cond; 
      if (!isset($gc_empresa_input_2) || $gc_empresa_input_2 == "")
      {
          $gc_empresa_input_2 = $gc_empresa;
      }
      $gc_descripcion_cond_salva = $gc_descripcion_cond; 
      if (!isset($gc_descripcion_input_2) || $gc_descripcion_input_2 == "")
      {
          $gc_descripcion_input_2 = $gc_descripcion;
      }
      if ($gc_id_cond != "in")
      {
          nm_limpa_numero($gc_id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['campos_busca']['gc_id'] = $gc_id; 
      if (is_array($gc_id) && !empty($gc_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['Grid_search'][$I_Grid]['val'][0] = $gc_id;
      }
      elseif ($gc_id_cond_salva == "nu" || $gc_id_cond_salva == "nn" || $gc_id_cond_salva == "ep" || $gc_id_cond_salva == "ne" || !empty($gc_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['Grid_search'][$I_Grid]['val'][0][0] = $gc_id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['campos_busca']['gc_id_cond'] = $gc_id_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['Grid_search'][$I_Grid]['cmp'] = "gc_id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['Grid_search'][$I_Grid]['opc'] = $gc_id_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq']['gc_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['campos_busca']['gc_empresa'] = $gc_empresa; 
      if (is_array($gc_empresa) && !empty($gc_empresa))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['Grid_search'][$I_Grid]['val'][0] = $gc_empresa;
      }
      elseif ($gc_empresa_cond_salva == "nu" || $gc_empresa_cond_salva == "nn" || $gc_empresa_cond_salva == "ep" || $gc_empresa_cond_salva == "ne" || !empty($gc_empresa))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['Grid_search'][$I_Grid]['val'][0][0] = $gc_empresa;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['campos_busca']['gc_empresa_cond'] = $gc_empresa_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['Grid_search'][$I_Grid]['cmp'] = "gc_empresa"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['Grid_search'][$I_Grid]['opc'] = $gc_empresa_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq']['gc_empresa'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['campos_busca']['gc_descripcion'] = $gc_descripcion; 
      if (is_array($gc_descripcion) && !empty($gc_descripcion))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['Grid_search'][$I_Grid]['val'][0] = $gc_descripcion;
      }
      elseif ($gc_descripcion_cond_salva == "nu" || $gc_descripcion_cond_salva == "nn" || $gc_descripcion_cond_salva == "ep" || $gc_descripcion_cond_salva == "ne" || !empty($gc_descripcion))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['Grid_search'][$I_Grid]['val'][0][0] = $gc_descripcion;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['campos_busca']['gc_descripcion_cond'] = $gc_descripcion_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['Grid_search'][$I_Grid]['cmp'] = "gc_descripcion"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['Grid_search'][$I_Grid]['opc'] = $gc_descripcion_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['grid_pesq']['gc_descripcion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $this->cmp_formatado['gc_id'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($gc_empresa != '') {
      $gc_empresa_look = (is_string($gc_empresa) ? substr($this->Db->qstr($gc_empresa), 1, -1) : $gc_empresa); 
      $nmgp_def_dados = array(); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['gc_empresa'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['gc_empresa'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['gc_empresa'] = $gc_empresa;
      }
      $nmgp_def_dados = array();
    if ($gc_descripcion != '') {
      $gc_descripcion_look = (is_string($gc_descripcion) ? substr($this->Db->qstr($gc_descripcion), 1, -1) : $gc_descripcion); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['gc_descripcion'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['gc_descripcion'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['gc_descripcion'] = $gc_descripcion;
      }

      //----- $gc_id
      $this->Date_part = false;
      if (isset($gc_id) || $gc_id_cond == "nu" || $gc_id_cond == "nn" || $gc_id_cond == "ep" || $gc_id_cond == "ne")
      {
         $this->monta_condicao("gc_id", $gc_id_cond, $gc_id, "", "gc_id", "INT4", false);
      }

      //----- $gc_empresa
      $this->Date_part = false;
      if (isset($gc_empresa) || $gc_empresa_cond == "nu" || $gc_empresa_cond == "nn" || $gc_empresa_cond == "ep" || $gc_empresa_cond == "ne")
      {
         $this->monta_condicao("gc_empresa", $gc_empresa_cond, $gc_empresa, "", "gc_empresa", "VARCHAR", false);
      }

      //----- $gc_descripcion
      $this->Date_part = false;
      if (isset($gc_descripcion) || $gc_descripcion_cond == "nu" || $gc_descripcion_cond == "nn" || $gc_descripcion_cond == "ep" || $gc_descripcion_cond == "ne")
      {
         $this->monta_condicao("gc_descripcion", $gc_descripcion_cond, $gc_descripcion, "", "gc_descripcion", "VARCHAR", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
    $this->Sel_case_sensitive($this->comando);
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_grupo_clientes']['cond_pesq'] .= $this->NM_operador;
