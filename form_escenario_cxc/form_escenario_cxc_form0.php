...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_escenario_cxc/form_escenario_cxc_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_escenario_cxc_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['link_info']['remove_border']) {
...
<?php
 include_once("form_escenario_cxc_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_escenario_cxc'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_escenario_cxc'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-1';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_disabled']['']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_disabled']['']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_label']['']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_label']['']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_label'][''];
        }
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_disabled']['anular']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_disabled']['anular']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_label']['anular']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_label']['anular']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['btn_label']['anular'];
        }
?>
...
<script type="text/javascript">
var pag_ativa = "form_escenario_cxc_form0";
</script>
<ul class="scTabLine sc-ui-page-tab-line">
<?php
    $this->tabCssClass = array(
        'form_escenario_cxc_form0' => array(
            'title' => "{lang_factura}",
            'class' => empty($nmgp_num_form) || $nmgp_num_form == "form_escenario_cxc_form0" ? "scTabActive" : "scTabInactive",
        ),
        'form_escenario_cxc_form1' => array(
            'title' => "{lang_clientes}",
            'class' => $nmgp_num_form == "form_escenario_cxc_form1" ? "scTabActive" : "scTabInactive",
        ),
    );
    if (!empty($this->Ini->nm_hidden_pages)) {
        foreach ($this->Ini->nm_hidden_pages as $pageName => $pageStatus) {
            if ('{lang_factura}' == $pageName && 'off' == $pageStatus) {
                $this->tabCssClass['form_escenario_cxc_form0']['class'] = 'scTabInactive';
            }
            if ('{lang_clientes}' == $pageName && 'off' == $pageStatus) {
                $this->tabCssClass['form_escenario_cxc_form1']['class'] = 'scTabInactive';
            }
        }
...
?>
<?php
    $css_celula = $this->tabCssClass["form_escenario_cxc_form0"]['class'];
?>
   <li id="id_form_escenario_cxc_form0" class="sc-form-page sc-tab-click <?php echo $css_celula; ?>" data-tab-name="form_escenario_cxc_form0">
...
<?php
    $css_celula = $this->tabCssClass["form_escenario_cxc_form1"]['class'];
?>
   <li id="id_form_escenario_cxc_form1" class="sc-form-page sc-tab-click <?php echo $css_celula; ?>" data-tab-name="form_escenario_cxc_form1">
...
<div id="form_escenario_cxc_form0" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fac_numero_line" id="hidden_field_data_fac_numero" style="<?php echo $sStyleHidden_fac_numero; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fac_numero_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fac_numero_label" style=""><span id="id_label_fac_numero"><?php echo $this->nm_new_label['fac_numero']; ?></span></span><br>
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { 
 ?>
<span id="id_read_on_fac_numero" css_fac_numero_line" style="<?php echo $sStyleReadLab_fac_numero; ?>"><?php echo $this->form_format_readonly("fac_numero", $this->form_encode_input($this->fac_numero)); ?></span><span id="id_read_off_fac_numero" class="css_read_off_fac_numero" style="<?php echo $sStyleReadInp_fac_numero; ?>"><input type="hidden" name="fac_numero" value="<?php echo $this->form_encode_input($fac_numero) . "\">"?><span id="id_ajax_label_fac_numero"><?php echo nl2br($fac_numero); ?></span>
</span><?php } else { ?>
&nbsp;
<?php } ?>
</span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_fac_numero_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_fac_numero_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php $sStyleHidden_fac_tipo_cartera_dumb = ('' == $sStyleHidden_fac_tipo_cartera) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_fac_tipo_cartera_dumb" style="<?php echo $sStyleHidden_fac_tipo_cartera_dumb; ?>"></TD>
...
<?php $sStyleHidden_fac_dias_vigencia_dumb = ('' == $sStyleHidden_fac_dias_vigencia) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_fac_dias_vigencia_dumb" style="<?php echo $sStyleHidden_fac_dias_vigencia_dumb; ?>"></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fac_comentario_label" id="hidden_field_label_fac_comentario" style="<?php echo $sStyleHidden_fac_comentario; ?>"><span id="id_label_fac_comentario"><?php echo $this->nm_new_label['fac_comentario']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['php_cmp_required']['fac_comentario']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['php_cmp_required']['fac_comentario'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalle'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalle'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['form_detalle_escenario_cxc_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalle'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['form_detalle_escenario_cxc_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['form_detalle_escenario_cxc_script_case_init'] ]['form_detalle_escenario_cxc']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['form_detalle_escenario_cxc_script_case_init'] ]['form_detalle_escenario_cxc']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['form_detalle_escenario_cxc_script_case_init'] ]['form_detalle_escenario_cxc']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['form_detalle_escenario_cxc_script_case_init'] ]['form_detalle_escenario_cxc']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['form_detalle_escenario_cxc_script_case_init'] ]['form_detalle_escenario_cxc']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['form_detalle_escenario_cxc_script_case_init'] ]['form_detalle_escenario_cxc']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['form_detalle_escenario_cxc_script_case_init'] ]['form_detalle_escenario_cxc']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['form_detalle_escenario_cxc_script_case_init'] ]['form_detalle_escenario_cxc']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['form_detalle_escenario_cxc_script_case_init'] ]['form_detalle_escenario_cxc']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['form_detalle_escenario_cxc_script_case_init'] ]['form_detalle_escenario_cxc']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['form_detalle_escenario_cxc_script_case_init'] ]['form_detalle_escenario_cxc']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['form_detalle_escenario_cxc_script_case_init'] ]['form_detalle_escenario_cxc']['embutida_liga_tp_pag'] = 'total';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['form_detalle_escenario_cxc_script_case_init'] ]['form_detalle_escenario_cxc']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['form_detalle_escenario_cxc_script_case_init'] ]['form_escenario_cxc']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_escenario_cxc_empty.htm' : $this->Ini->link_form_detalle_escenario_cxc_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y&sc_ifr_height=450';
if (isset($this->Ini->sc_lig_target['C_@scinf_detalle']) && 'nmsc_iframe_liga_form_detalle_escenario_cxc' != $this->Ini->sc_lig_target['C_@scinf_detalle'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_detalle'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc']['form_detalle_escenario_cxc_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_detalle_escenario_cxc"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="450" width="100%" name="nmsc_iframe_liga_form_detalle_escenario_cxc"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
