  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_escenario_cxc_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_escenario_cxc_mob_form();
	}
...
?>
  ...
  // ---------- Validate titulo
  function do_ajax_form_escenario_cxc_mob_validate_titulo()
  {
    var nomeCampo_titulo = "titulo";
    var var_titulo = scAjaxGetFieldHidden(nomeCampo_titulo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_escenario_cxc_mob_validate_titulo(var_titulo, var_script_case_init, do_ajax_form_escenario_cxc_mob_validate_titulo_cb);
  } // do_ajax_form_escenario_cxc_mob_validate_titulo

  function do_ajax_form_escenario_cxc_mob_validate_titulo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_escenario_cxc_mob_validate_titulo_cb

  // ---------- Validate fac_fecha
  function do_ajax_form_escenario_cxc_mob_validate_fac_fecha()
  {
    ...
    setTimeout(function() {
      var var_fac_fecha = scAjaxGetFieldText(nomeCampo_fac_fecha);
      x_ajax_form_escenario_cxc_mob_validate_fac_fecha(var_fac_fecha, var_script_case_init, do_ajax_form_escenario_cxc_mob_validate_fac_fecha_cb);
    }, 200);
  } // do_ajax_form_escenario_cxc_mob_validate_fac_fecha

  function do_ajax_form_escenario_cxc_mob_validate_fac_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_escenario_cxc_mob_validate_fac_fecha_cb

  // ---------- Validate fac_tipo_cartera
  function do_ajax_form_escenario_cxc_mob_validate_fac_tipo_cartera()
  {
    var nomeCampo_fac_tipo_cartera = "fac_tipo_cartera";
    var var_fac_tipo_cartera = scAjaxGetFieldSelect(nomeCampo_fac_tipo_cartera);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_escenario_cxc_mob_validate_fac_tipo_cartera(var_fac_tipo_cartera, var_script_case_init, do_ajax_form_escenario_cxc_mob_validate_fac_tipo_cartera_cb);
  } // do_ajax_form_escenario_cxc_mob_validate_fac_tipo_cartera

  function do_ajax_form_escenario_cxc_mob_validate_fac_tipo_cartera_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fac_tipo_cartera";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_escenario_cxc_mob_validate_fac_tipo_cartera_cb

  // ---------- Validate fac_tipo_comprobante
  function do_ajax_form_escenario_cxc_mob_validate_fac_tipo_comprobante()
  {
    var nomeCampo_fac_tipo_comprobante = "fac_tipo_comprobante";
    var var_fac_tipo_comprobante = scAjaxGetFieldSelect(nomeCampo_fac_tipo_comprobante);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_escenario_cxc_mob_validate_fac_tipo_comprobante(var_fac_tipo_comprobante, var_script_case_init, do_ajax_form_escenario_cxc_mob_validate_fac_tipo_comprobante_cb);
  } // do_ajax_form_escenario_cxc_mob_validate_fac_tipo_comprobante

  function do_ajax_form_escenario_cxc_mob_validate_fac_tipo_comprobante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_escenario_cxc_mob_validate_fac_tipo_comprobante_cb

  // ---------- Validate fac_dias_vigencia
  function do_ajax_form_escenario_cxc_mob_validate_fac_dias_vigencia()
  {
    var nomeCampo_fac_dias_vigencia = "fac_dias_vigencia";
    var var_fac_dias_vigencia = scAjaxGetFieldText(nomeCampo_fac_dias_vigencia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_escenario_cxc_mob_validate_fac_dias_vigencia(var_fac_dias_vigencia, var_script_case_init, do_ajax_form_escenario_cxc_mob_validate_fac_dias_vigencia_cb);
  } // do_ajax_form_escenario_cxc_mob_validate_fac_dias_vigencia

  function do_ajax_form_escenario_cxc_mob_validate_fac_dias_vigencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fac_dias_vigencia";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_escenario_cxc_mob_validate_fac_dias_vigencia_cb

  // ---------- Validate fac_numero
  function do_ajax_form_escenario_cxc_mob_validate_fac_numero()
  {
    var nomeCampo_fac_numero = "fac_numero";
    var var_fac_numero = scAjaxGetFieldHidden(nomeCampo_fac_numero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_escenario_cxc_mob_validate_fac_numero(var_fac_numero, var_script_case_init, do_ajax_form_escenario_cxc_mob_validate_fac_numero_cb);
  } // do_ajax_form_escenario_cxc_mob_validate_fac_numero

  function do_ajax_form_escenario_cxc_mob_validate_fac_numero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_escenario_cxc_mob_validate_fac_numero_cb

  // ---------- Validate fac_comentario
  function do_ajax_form_escenario_cxc_mob_validate_fac_comentario()
  {
    var nomeCampo_fac_comentario = "fac_comentario";
    var var_fac_comentario = scAjaxGetFieldText(nomeCampo_fac_comentario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_escenario_cxc_mob_validate_fac_comentario(var_fac_comentario, var_script_case_init, do_ajax_form_escenario_cxc_mob_validate_fac_comentario_cb);
  } // do_ajax_form_escenario_cxc_mob_validate_fac_comentario

  function do_ajax_form_escenario_cxc_mob_validate_fac_comentario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_escenario_cxc_mob_validate_fac_comentario_cb

  // ---------- Validate detalle
  function do_ajax_form_escenario_cxc_mob_validate_detalle()
  {
    var nomeCampo_detalle = "detalle";
    var var_detalle = scAjaxGetFieldText(nomeCampo_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_escenario_cxc_mob_validate_detalle(var_detalle, var_script_case_init, do_ajax_form_escenario_cxc_mob_validate_detalle_cb);
  } // do_ajax_form_escenario_cxc_mob_validate_detalle

  function do_ajax_form_escenario_cxc_mob_validate_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detalle";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_escenario_cxc_mob_validate_detalle_cb

  // ---------- Validate fac_subtotal
  function do_ajax_form_escenario_cxc_mob_validate_fac_subtotal()
  {
    var nomeCampo_fac_subtotal = "fac_subtotal";
    var var_fac_subtotal = scAjaxGetFieldText(nomeCampo_fac_subtotal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_escenario_cxc_mob_validate_fac_subtotal(var_fac_subtotal, var_script_case_init, do_ajax_form_escenario_cxc_mob_validate_fac_subtotal_cb);
  } // do_ajax_form_escenario_cxc_mob_validate_fac_subtotal

  function do_ajax_form_escenario_cxc_mob_validate_fac_subtotal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_escenario_cxc_mob_validate_fac_subtotal_cb

  // ---------- Validate fac_subtotal_iva
  function do_ajax_form_escenario_cxc_mob_validate_fac_subtotal_iva()
  {
    var nomeCampo_fac_subtotal_iva = "fac_subtotal_iva";
    var var_fac_subtotal_iva = scAjaxGetFieldText(nomeCampo_fac_subtotal_iva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_escenario_cxc_mob_validate_fac_subtotal_iva(var_fac_subtotal_iva, var_script_case_init, do_ajax_form_escenario_cxc_mob_validate_fac_subtotal_iva_cb);
  } // do_ajax_form_escenario_cxc_mob_validate_fac_subtotal_iva

  function do_ajax_form_escenario_cxc_mob_validate_fac_subtotal_iva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_escenario_cxc_mob_validate_fac_subtotal_iva_cb

  // ---------- Validate fac_subtotal_cero
  function do_ajax_form_escenario_cxc_mob_validate_fac_subtotal_cero()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_escenario_cxc_mob_validate_fac_subtotal_cero(var_fac_subtotal_cero, var_script_case_init, do_ajax_form_escenario_cxc_mob_validate_fac_subtotal_cero_cb);
  } // do_ajax_form_escenario_cxc_mob_validate_fac_subtotal_cero

  function do_ajax_form_escenario_cxc_mob_validate_fac_subtotal_cero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_escenario_cxc_mob_validate_fac_subtotal_cero_cb

  // ---------- Validate fac_subtotal_no_objeto
  function do_ajax_form_escenario_cxc_mob_validate_fac_subtotal_no_objeto()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_escenario_cxc_mob_validate_fac_subtotal_no_objeto(var_fac_subtotal_no_objeto, var_script_case_init, do_ajax_form_escenario_cxc_mob_validate_fac_subtotal_no_objeto_cb);
  } // do_ajax_form_escenario_cxc_mob_validate_fac_subtotal_no_objeto

  function do_ajax_form_escenario_cxc_mob_validate_fac_subtotal_no_objeto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_escenario_cxc_mob_validate_fac_subtotal_no_objeto_cb

  // ---------- Validate fac_subtotal_excento
  function do_ajax_form_escenario_cxc_mob_validate_fac_subtotal_excento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_escenario_cxc_mob_validate_fac_subtotal_excento(var_fac_subtotal_excento, var_script_case_init, do_ajax_form_escenario_cxc_mob_validate_fac_subtotal_excento_cb);
  } // do_ajax_form_escenario_cxc_mob_validate_fac_subtotal_excento

  function do_ajax_form_escenario_cxc_mob_validate_fac_subtotal_excento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_escenario_cxc_mob_validate_fac_subtotal_excento_cb

  // ---------- Validate fac_total_descuento
  function do_ajax_form_escenario_cxc_mob_validate_fac_total_descuento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_escenario_cxc_mob_validate_fac_total_descuento(var_fac_total_descuento, var_script_case_init, do_ajax_form_escenario_cxc_mob_validate_fac_total_descuento_cb);
  } // do_ajax_form_escenario_cxc_mob_validate_fac_total_descuento

  function do_ajax_form_escenario_cxc_mob_validate_fac_total_descuento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_escenario_cxc_mob_validate_fac_total_descuento_cb

  // ---------- Validate fac_valor_ice
  function do_ajax_form_escenario_cxc_mob_validate_fac_valor_ice()
  {
    var nomeCampo_fac_valor_ice = "fac_valor_ice";
    var var_fac_valor_ice = scAjaxGetFieldText(nomeCampo_fac_valor_ice);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_escenario_cxc_mob_validate_fac_valor_ice(var_fac_valor_ice, var_script_case_init, do_ajax_form_escenario_cxc_mob_validate_fac_valor_ice_cb);
  } // do_ajax_form_escenario_cxc_mob_validate_fac_valor_ice

  function do_ajax_form_escenario_cxc_mob_validate_fac_valor_ice_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_escenario_cxc_mob_validate_fac_valor_ice_cb

  // ---------- Validate fac_valor_iva
  function do_ajax_form_escenario_cxc_mob_validate_fac_valor_iva()
  {
    var nomeCampo_fac_valor_iva = "fac_valor_iva";
    var var_fac_valor_iva = scAjaxGetFieldText(nomeCampo_fac_valor_iva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_escenario_cxc_mob_validate_fac_valor_iva(var_fac_valor_iva, var_script_case_init, do_ajax_form_escenario_cxc_mob_validate_fac_valor_iva_cb);
  } // do_ajax_form_escenario_cxc_mob_validate_fac_valor_iva

  function do_ajax_form_escenario_cxc_mob_validate_fac_valor_iva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_escenario_cxc_mob_validate_fac_valor_iva_cb

  // ---------- Validate fac_valor_irbpnr
  function do_ajax_form_escenario_cxc_mob_validate_fac_valor_irbpnr()
  {
    var nomeCampo_fac_valor_irbpnr = "fac_valor_irbpnr";
    var var_fac_valor_irbpnr = scAjaxGetFieldText(nomeCampo_fac_valor_irbpnr);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_escenario_cxc_mob_validate_fac_valor_irbpnr(var_fac_valor_irbpnr, var_script_case_init, do_ajax_form_escenario_cxc_mob_validate_fac_valor_irbpnr_cb);
  } // do_ajax_form_escenario_cxc_mob_validate_fac_valor_irbpnr

  function do_ajax_form_escenario_cxc_mob_validate_fac_valor_irbpnr_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_escenario_cxc_mob_validate_fac_valor_irbpnr_cb

  // ---------- Validate fac_total
  function do_ajax_form_escenario_cxc_mob_validate_fac_total()
  {
    var nomeCampo_fac_total = "fac_total";
    var var_fac_total = scAjaxGetFieldText(nomeCampo_fac_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_escenario_cxc_mob_validate_fac_total(var_fac_total, var_script_case_init, do_ajax_form_escenario_cxc_mob_validate_fac_total_cb);
  } // do_ajax_form_escenario_cxc_mob_validate_fac_total

  function do_ajax_form_escenario_cxc_mob_validate_fac_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_escenario_cxc_mob_validate_fac_total_cb

  // ---------- Validate fac_estado
  function do_ajax_form_escenario_cxc_mob_validate_fac_estado()
  {
    var nomeCampo_fac_estado = "fac_estado";
    var var_fac_estado = scAjaxGetFieldText(nomeCampo_fac_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_escenario_cxc_mob_validate_fac_estado(var_fac_estado, var_script_case_init, do_ajax_form_escenario_cxc_mob_validate_fac_estado_cb);
  } // do_ajax_form_escenario_cxc_mob_validate_fac_estado

  function do_ajax_form_escenario_cxc_mob_validate_fac_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_escenario_cxc_mob_validate_fac_estado_cb

  // ---------- Validate clientes
  function do_ajax_form_escenario_cxc_mob_validate_clientes()
  {
    var nomeCampo_clientes = "clientes";
    var var_clientes = scAjaxGetFieldText(nomeCampo_clientes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_escenario_cxc_mob_validate_clientes(var_clientes, var_script_case_init, do_ajax_form_escenario_cxc_mob_validate_clientes_cb);
  } // do_ajax_form_escenario_cxc_mob_validate_clientes

  function do_ajax_form_escenario_cxc_mob_validate_clientes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_escenario_cxc_mob_validate_clientes_cb

  // ---------- Event onblur fac_valor_entrega
  function do_ajax_form_escenario_cxc_mob_event_fac_valor_entrega_onblur()
  {
    var var_fac_total = scAjaxGetFieldText("fac_total");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_escenario_cxc_mob_event_fac_valor_entrega_onblur(var_fac_total, var_script_case_init, do_ajax_form_escenario_cxc_mob_event_fac_valor_entrega_onblur_cb);
  } // do_ajax_form_escenario_cxc_mob_event_fac_valor_entrega_onblur

  function do_ajax_form_escenario_cxc_mob_event_fac_valor_entrega_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_escenario_cxc_mob_event_fac_valor_entrega_onblur_cb_after_alert);
  } // do_ajax_form_escenario_cxc_mob_event_fac_valor_entrega_onblur_cb
  function do_ajax_form_escenario_cxc_mob_event_fac_valor_entrega_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_escenario_cxc_mob_event_fac_valor_entrega_onblur_cb_after_alert

  // ---------- Event onchange fac_aplica_propina
  function do_ajax_form_escenario_cxc_mob_event_fac_aplica_propina_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_escenario_cxc_mob_event_fac_aplica_propina_onchange(var_fac_numero, var_fac_subtotal, var_fac_subtotal_iva, var_fac_subtotal_cero, var_fac_subtotal_no_objeto, var_fac_subtotal_excento, var_fac_total_descuento, var_fac_valor_ice, var_fac_valor_iva, var_fac_valor_irbpnr, var_fac_total, var_script_case_init, do_ajax_form_escenario_cxc_mob_event_fac_aplica_propina_onchange_cb);
  } // do_ajax_form_escenario_cxc_mob_event_fac_aplica_propina_onchange

  function do_ajax_form_escenario_cxc_mob_event_fac_aplica_propina_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_escenario_cxc_mob_event_fac_aplica_propina_onchange_cb_after_alert);
  } // do_ajax_form_escenario_cxc_mob_event_fac_aplica_propina_onchange_cb
  function do_ajax_form_escenario_cxc_mob_event_fac_aplica_propina_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_escenario_cxc_mob_event_fac_aplica_propina_onchange_cb_after_alert

  // ---------- Event onblur fac_libretin
  function do_ajax_form_escenario_cxc_mob_event_fac_libretin_onblur()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_escenario_cxc_mob_event_fac_libretin_onblur(var_script_case_init, do_ajax_form_escenario_cxc_mob_event_fac_libretin_onblur_cb);
  } // do_ajax_form_escenario_cxc_mob_event_fac_libretin_onblur

  function do_ajax_form_escenario_cxc_mob_event_fac_libretin_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_escenario_cxc_mob_event_fac_libretin_onblur_cb_after_alert);
  } // do_ajax_form_escenario_cxc_mob_event_fac_libretin_onblur_cb
  function do_ajax_form_escenario_cxc_mob_event_fac_libretin_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_escenario_cxc_mob_event_fac_libretin_onblur_cb_after_alert

  // ---------- Event onchange fac_libretin
  function do_ajax_form_escenario_cxc_mob_event_fac_libretin_onchange()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_escenario_cxc_mob_event_fac_libretin_onchange(var_script_case_init, do_ajax_form_escenario_cxc_mob_event_fac_libretin_onchange_cb);
  } // do_ajax_form_escenario_cxc_mob_event_fac_libretin_onchange

  function do_ajax_form_escenario_cxc_mob_event_fac_libretin_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "fac_libretin";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_escenario_cxc_mob_event_fac_libretin_onchange_cb_after_alert);
  } // do_ajax_form_escenario_cxc_mob_event_fac_libretin_onchange_cb
  function do_ajax_form_escenario_cxc_mob_event_fac_libretin_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_escenario_cxc_mob_event_fac_libretin_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_escenario_cxc_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_escenario_cxc_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_titulo = scAjaxGetFieldHidden("titulo");
    var var_fac_fecha = scAjaxGetFieldText("fac_fecha");
    var var_fac_tipo_cartera = scAjaxGetFieldSelect("fac_tipo_cartera");
    var var_fac_tipo_comprobante = scAjaxGetFieldSelect("fac_tipo_comprobante");
    var var_fac_dias_vigencia = scAjaxGetFieldText("fac_dias_vigencia");
    var var_fac_numero = scAjaxGetFieldHidden("fac_numero");
    ...
    scAjaxProcOn();
    x_ajax_form_escenario_cxc_mob_submit_form(var_titulo, var_fac_fecha, var_fac_tipo_cartera, var_fac_tipo_comprobante, var_fac_dias_vigencia, var_fac_numero, var_fac_comentario, var_fac_subtotal, var_fac_subtotal_iva, var_fac_subtotal_cero, var_fac_subtotal_no_objeto, var_fac_subtotal_excento, var_fac_total_descuento, var_fac_valor_ice, var_fac_valor_iva, var_fac_valor_irbpnr, var_fac_total, var_fac_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_escenario_cxc_mob_submit_form_cb);
  } // do_ajax_form_escenario_cxc_mob_submit_form

  function do_ajax_form_escenario_cxc_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("fac_tipo_cartera");
      scAjaxHideErrorDisplay("fac_tipo_comprobante");
      scAjaxHideErrorDisplay("fac_dias_vigencia");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_escenario_cxc_mob_submit_form_cb_after_alert);
  } // do_ajax_form_escenario_cxc_mob_submit_form_cb
  function do_ajax_form_escenario_cxc_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_escenario_cxc_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_detalle_escenario_cxc_mob"] = "off";
  scStatusDetail["grid_cliente_escenario_cxc"] = "off";

  function do_ajax_form_escenario_cxc_mob_navigate_form()
  {
    perform_ajax_form_escenario_cxc_mob_navigate_form();
  }

  function perform_ajax_form_escenario_cxc_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_detalle_escenario_cxc_mob"] = "on";
    scStatusDetail["grid_cliente_escenario_cxc"] = "on";
    x_ajax_form_escenario_cxc_mob_navigate_form(var_fac_numero, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_escenario_cxc_mob_navigate_form_cb);
  } // do_ajax_form_escenario_cxc_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_escenario_cxc_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_detalle_escenario_cxc_mob"] && "nmsc_iframe_liga_form_detalle_escenario_cxc_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_detalle_escenario_cxc_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_detalle_escenario_cxc_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_detalle_escenario_cxc_mob').contentWindow.nm_move('apl_detalhe', true, '450');
        document.getElementById('nmsc_iframe_liga_form_detalle_escenario_cxc_mob').style.height = "450";
        document.getElementById('nmsc_iframe_liga_form_detalle_escenario_cxc_mob').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_grid_cliente_escenario_cxc"] && "nmsc_iframe_liga_grid_cliente_escenario_cxc" != scMasterDetailIframe["nmsc_iframe_liga_grid_cliente_escenario_cxc"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_grid_cliente_escenario_cxc"]);
    }
    else {
        if (oResp["navSummary"].reg_tot != 0) {
            document.getElementById('nmsc_iframe_liga_grid_cliente_escenario_cxc').contentWindow.nm_move('apl_detalhe', true, '450');
        }
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_escenario_cxc_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_escenario_cxc_mob_navigate_form_cb
  function do_ajax_form_escenario_cxc_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_escenario_cxc_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_escenario_cxc_mob_navigate_form_cb_after_alert

  function sc_hide_form_escenario_cxc_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_detalle_escenario_cxc_mob"] && "off" == scStatusDetail["grid_cliente_escenario_cxc"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[1] = "fac_fecha";
  ajax_field_list[2] = "fac_tipo_cartera";
  ajax_field_list[3] = "fac_tipo_comprobante";
  ajax_field_list[4] = "fac_dias_vigencia";
  ajax_field_list[5] = "fac_numero";
  ajax_field_list[6] = "fac_comentario";
  ajax_field_list[7] = "detalle";
  ajax_field_list[8] = "fac_subtotal";
  ajax_field_list[9] = "fac_subtotal_iva";
  ajax_field_list[10] = "fac_subtotal_cero";
  ajax_field_list[11] = "fac_subtotal_no_objeto";
  ajax_field_list[12] = "fac_subtotal_excento";
  ajax_field_list[13] = "fac_total_descuento";
  ajax_field_list[14] = "fac_valor_ice";
  ajax_field_list[15] = "fac_valor_iva";
  ajax_field_list[16] = "fac_valor_irbpnr";
  ajax_field_list[17] = "fac_total";
  ajax_field_list[18] = "fac_estado";
  ajax_field_list[19] = "clientes";
  ...
  var ajax_error_list = {
    ...
    "fac_tipo_cartera": {"label": "<?php echo $this->Ini->Nm_lang['lang_tipo_cartera'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "fac_dias_vigencia": {"label": "Dias de Vigencia", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "titulo": new Array(),
    "fac_fecha": new Array(),
    "fac_tipo_cartera": new Array(),
    "fac_tipo_comprobante": new Array(),
    "fac_dias_vigencia": new Array(),
  ...
  ajax_field_mult["fac_tipo_cartera"][1] = "fac_tipo_cartera";
  ajax_field_mult["fac_tipo_comprobante"][1] = "fac_tipo_comprobante";
  ajax_field_mult["fac_dias_vigencia"][1] = "fac_dias_vigencia";
  ...
  var ajax_field_id = {
    ...
    "fac_tipo_cartera": new Array("hidden_field_label_fac_tipo_cartera", "hidden_field_data_fac_tipo_cartera"),
    "fac_tipo_comprobante": new Array("hidden_field_label_fac_tipo_comprobante", "hidden_field_data_fac_tipo_comprobante"),
    "fac_dias_vigencia": new Array("hidden_field_label_fac_dias_vigencia", "hidden_field_data_fac_dias_vigencia"),
  ...
  var ajax_read_only = {
    ...
    "fac_fecha": "on",
    "fac_tipo_cartera": "on",
    "fac_tipo_comprobante": "on",
    "fac_dias_vigencia": "on",
    "fac_numero": "on",
    "fac_comentario": "on",
    "detalle": "off",
    "fac_subtotal": "off",
