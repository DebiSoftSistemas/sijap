...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc_mob']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc_mob']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_escenario_cxc_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function sc_btn_Anular_ok()
{
    ...
    document.F1.action = "form_escenario_cxc_mob.php";
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc_mob']['where_detal']))
  {
?>  
...
{
    document.getElementById('form_escenario_cxc_mob_form0').style.width='1px';
    document.getElementById('form_escenario_cxc_mob_form0').style.height='0px';
    document.getElementById('form_escenario_cxc_mob_form0').style.display='none';
    document.getElementById('form_escenario_cxc_mob_form0').style.overflow='scroll';
    document.getElementById('form_escenario_cxc_mob_form1').style.width='1px';
    document.getElementById('form_escenario_cxc_mob_form1').style.height='0px';
    document.getElementById('form_escenario_cxc_mob_form1').style.display='none';
    document.getElementById('form_escenario_cxc_mob_form1').style.overflow='scroll';
<?php
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_escenario_cxc_mob']['pdf_view']) {
?>
...
?>
   ...
   if ("form_escenario_cxc_mob_form0" == N_pagina) {
     scAjaxDetailHeight("form_detalle_escenario_cxc", "450");
    }
   if ("form_escenario_cxc_mob_form1" == N_pagina) {
