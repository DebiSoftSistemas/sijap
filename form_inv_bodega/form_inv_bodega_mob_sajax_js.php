  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_inv_bodega_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_inv_bodega_mob_form();
	}
...
?>
  ...
  // ---------- Validate bo_id
  function do_ajax_form_inv_bodega_mob_validate_bo_id()
  {
    var nomeCampo_bo_id = "bo_id";
    var var_bo_id = scAjaxGetFieldHidden(nomeCampo_bo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_bodega_mob_validate_bo_id(var_bo_id, var_script_case_init, do_ajax_form_inv_bodega_mob_validate_bo_id_cb);
  } // do_ajax_form_inv_bodega_mob_validate_bo_id

  function do_ajax_form_inv_bodega_mob_validate_bo_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_bodega_mob_validate_bo_id_cb

  // ---------- Validate bo_empresa
  function do_ajax_form_inv_bodega_mob_validate_bo_empresa()
  {
    var nomeCampo_bo_empresa = "bo_empresa";
    var var_bo_empresa = scAjaxGetFieldText(nomeCampo_bo_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_bodega_mob_validate_bo_empresa(var_bo_empresa, var_script_case_init, do_ajax_form_inv_bodega_mob_validate_bo_empresa_cb);
  } // do_ajax_form_inv_bodega_mob_validate_bo_empresa

  function do_ajax_form_inv_bodega_mob_validate_bo_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "bo_empresa";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_bodega_mob_validate_bo_empresa_cb

  // ---------- Validate bo_establecimiento
  function do_ajax_form_inv_bodega_mob_validate_bo_establecimiento()
  {
    var nomeCampo_bo_establecimiento = "bo_establecimiento";
    var var_bo_establecimiento = scAjaxGetFieldSelect(nomeCampo_bo_establecimiento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_bodega_mob_validate_bo_establecimiento(var_bo_establecimiento, var_script_case_init, do_ajax_form_inv_bodega_mob_validate_bo_establecimiento_cb);
  } // do_ajax_form_inv_bodega_mob_validate_bo_establecimiento

  function do_ajax_form_inv_bodega_mob_validate_bo_establecimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "bo_establecimiento";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_bodega_mob_validate_bo_establecimiento_cb

  // ---------- Validate bo_nombre
  function do_ajax_form_inv_bodega_mob_validate_bo_nombre()
  {
    var nomeCampo_bo_nombre = "bo_nombre";
    var var_bo_nombre = scAjaxGetFieldText(nomeCampo_bo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_bodega_mob_validate_bo_nombre(var_bo_nombre, var_script_case_init, do_ajax_form_inv_bodega_mob_validate_bo_nombre_cb);
  } // do_ajax_form_inv_bodega_mob_validate_bo_nombre

  function do_ajax_form_inv_bodega_mob_validate_bo_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "bo_nombre";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_bodega_mob_validate_bo_nombre_cb

  // ---------- Validate bo_direccion
  function do_ajax_form_inv_bodega_mob_validate_bo_direccion()
  {
    var nomeCampo_bo_direccion = "bo_direccion";
    var var_bo_direccion = scAjaxGetFieldText(nomeCampo_bo_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_bodega_mob_validate_bo_direccion(var_bo_direccion, var_script_case_init, do_ajax_form_inv_bodega_mob_validate_bo_direccion_cb);
  } // do_ajax_form_inv_bodega_mob_validate_bo_direccion

  function do_ajax_form_inv_bodega_mob_validate_bo_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "bo_direccion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_bodega_mob_validate_bo_direccion_cb

  // ---------- Validate bo_responsable
  function do_ajax_form_inv_bodega_mob_validate_bo_responsable()
  {
    var nomeCampo_bo_responsable = "bo_responsable";
    var var_bo_responsable = scAjaxGetFieldSelect(nomeCampo_bo_responsable);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_bodega_mob_validate_bo_responsable(var_bo_responsable, var_script_case_init, do_ajax_form_inv_bodega_mob_validate_bo_responsable_cb);
  } // do_ajax_form_inv_bodega_mob_validate_bo_responsable

  function do_ajax_form_inv_bodega_mob_validate_bo_responsable_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "bo_responsable";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_bodega_mob_validate_bo_responsable_cb

  // ---------- Validate bo_estado
  function do_ajax_form_inv_bodega_mob_validate_bo_estado()
  {
    var nomeCampo_bo_estado = "bo_estado";
    var var_bo_estado = scAjaxGetFieldSelect(nomeCampo_bo_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_bodega_mob_validate_bo_estado(var_bo_estado, var_script_case_init, do_ajax_form_inv_bodega_mob_validate_bo_estado_cb);
  } // do_ajax_form_inv_bodega_mob_validate_bo_estado

  function do_ajax_form_inv_bodega_mob_validate_bo_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "bo_estado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_bodega_mob_validate_bo_estado_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_inv_bodega_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_inv_bodega_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_bo_id = scAjaxGetFieldHidden("bo_id");
    var var_bo_empresa = scAjaxGetFieldText("bo_empresa");
    var var_bo_establecimiento = scAjaxGetFieldSelect("bo_establecimiento");
    var var_bo_nombre = scAjaxGetFieldText("bo_nombre");
    var var_bo_direccion = scAjaxGetFieldText("bo_direccion");
    var var_bo_responsable = scAjaxGetFieldSelect("bo_responsable");
    var var_bo_estado = scAjaxGetFieldSelect("bo_estado");
    ...
    scAjaxProcOn();
    x_ajax_form_inv_bodega_mob_submit_form(var_bo_id, var_bo_empresa, var_bo_establecimiento, var_bo_nombre, var_bo_direccion, var_bo_responsable, var_bo_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_inv_bodega_mob_submit_form_cb);
  } // do_ajax_form_inv_bodega_mob_submit_form

  function do_ajax_form_inv_bodega_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("bo_id");
      scAjaxHideErrorDisplay("bo_empresa");
      scAjaxHideErrorDisplay("bo_establecimiento");
      scAjaxHideErrorDisplay("bo_nombre");
      scAjaxHideErrorDisplay("bo_direccion");
      scAjaxHideErrorDisplay("bo_responsable");
      scAjaxHideErrorDisplay("bo_estado");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_inv_bodega_mob_submit_form_cb_after_alert);
  } // do_ajax_form_inv_bodega_mob_submit_form_cb
  function do_ajax_form_inv_bodega_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_inv_bodega_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_inv_bodega_mob_navigate_form()
  {
    perform_ajax_form_inv_bodega_mob_navigate_form();
  }

  function perform_ajax_form_inv_bodega_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("bo_responsable");
    scAjaxHideErrorDisplay("bo_estado");
    var var_bo_id = document.F2.bo_id.value;
    ...
    scAjaxProcOn();
    x_ajax_form_inv_bodega_mob_navigate_form(var_bo_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_inv_bodega_mob_navigate_form_cb);
  } // do_ajax_form_inv_bodega_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_bodega_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_inv_bodega_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.bo_id.value = scAjaxGetKeyValue("bo_id");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_inv_bodega_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_inv_bodega_mob_navigate_form_cb
  function do_ajax_form_inv_bodega_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_inv_bodega_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_inv_bodega_mob_navigate_form_cb_after_alert

  function sc_hide_form_inv_bodega_mob_form()
  {
  ...
  ajax_field_list[0] = "bo_id";
  ajax_field_list[1] = "bo_empresa";
  ajax_field_list[2] = "bo_establecimiento";
  ajax_field_list[3] = "bo_nombre";
  ajax_field_list[4] = "bo_direccion";
  ajax_field_list[5] = "bo_responsable";
  ajax_field_list[6] = "bo_estado";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "bo_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "bo_empresa": {"label": "<?php echo $this->Ini->Nm_lang['lang_empresa'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "bo_establecimiento": {"label": "<?php echo $this->Ini->Nm_lang['lang_establecimiento'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "bo_nombre": {"label": "<?php echo $this->Ini->Nm_lang['lang_nombre'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "bo_direccion": {"label": "<?php echo $this->Ini->Nm_lang['lang_direccion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "bo_responsable": {"label": "<?php echo $this->Ini->Nm_lang['lang_responsable'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "bo_estado": {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "bo_id": new Array(),
    "bo_empresa": new Array(),
    "bo_establecimiento": new Array(),
    "bo_nombre": new Array(),
    "bo_direccion": new Array(),
    "bo_responsable": new Array(),
    "bo_estado": new Array()
  };
  ajax_field_mult["bo_id"][1] = "bo_id";
  ajax_field_mult["bo_empresa"][1] = "bo_empresa";
  ajax_field_mult["bo_establecimiento"][1] = "bo_establecimiento";
  ajax_field_mult["bo_nombre"][1] = "bo_nombre";
  ajax_field_mult["bo_direccion"][1] = "bo_direccion";
  ajax_field_mult["bo_responsable"][1] = "bo_responsable";
  ajax_field_mult["bo_estado"][1] = "bo_estado";

  var ajax_field_id = {
    "bo_establecimiento": new Array("hidden_field_label_bo_establecimiento", "hidden_field_data_bo_establecimiento"),
    "bo_nombre": new Array("hidden_field_label_bo_nombre", "hidden_field_data_bo_nombre"),
    "bo_direccion": new Array("hidden_field_label_bo_direccion", "hidden_field_data_bo_direccion"),
    "bo_responsable": new Array("hidden_field_label_bo_responsable", "hidden_field_data_bo_responsable"),
    "bo_estado": new Array("hidden_field_label_bo_estado", "hidden_field_data_bo_estado")
  };

  var ajax_read_only = {
    "bo_id": "on",
    "bo_empresa": "off",
    "bo_establecimiento": "off",
    "bo_nombre": "off",
    "bo_direccion": "off",
    "bo_responsable": "off",
    "bo_estado": "off"
