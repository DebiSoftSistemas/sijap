  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_catalogo_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sis_catalogo_mob_form();
	}
...
?>
  ...
  // ---------- Validate cat_id
  function do_ajax_form_sis_catalogo_mob_validate_cat_id()
  {
    var nomeCampo_cat_id = "cat_id";
    var var_cat_id = scAjaxGetFieldHidden(nomeCampo_cat_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_catalogo_mob_validate_cat_id(var_cat_id, var_script_case_init, do_ajax_form_sis_catalogo_mob_validate_cat_id_cb);
  } // do_ajax_form_sis_catalogo_mob_validate_cat_id

  function do_ajax_form_sis_catalogo_mob_validate_cat_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_catalogo_mob_validate_cat_id_cb

  // ---------- Validate cat_nombre
  function do_ajax_form_sis_catalogo_mob_validate_cat_nombre()
  {
    var nomeCampo_cat_nombre = "cat_nombre";
    var var_cat_nombre = scAjaxGetFieldText(nomeCampo_cat_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_catalogo_mob_validate_cat_nombre(var_cat_nombre, var_script_case_init, do_ajax_form_sis_catalogo_mob_validate_cat_nombre_cb);
  } // do_ajax_form_sis_catalogo_mob_validate_cat_nombre

  function do_ajax_form_sis_catalogo_mob_validate_cat_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cat_nombre";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_catalogo_mob_validate_cat_nombre_cb

  // ---------- Validate cat_vista_bdd
  function do_ajax_form_sis_catalogo_mob_validate_cat_vista_bdd()
  {
    var nomeCampo_cat_vista_bdd = "cat_vista_bdd";
    var var_cat_vista_bdd = scAjaxGetFieldText(nomeCampo_cat_vista_bdd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_catalogo_mob_validate_cat_vista_bdd(var_cat_vista_bdd, var_script_case_init, do_ajax_form_sis_catalogo_mob_validate_cat_vista_bdd_cb);
  } // do_ajax_form_sis_catalogo_mob_validate_cat_vista_bdd

  function do_ajax_form_sis_catalogo_mob_validate_cat_vista_bdd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cat_vista_bdd";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_catalogo_mob_validate_cat_vista_bdd_cb

  // ---------- Validate detalle_catalogo
  function do_ajax_form_sis_catalogo_mob_validate_detalle_catalogo()
  {
    var nomeCampo_detalle_catalogo = "detalle_catalogo";
    var var_detalle_catalogo = scAjaxGetFieldText(nomeCampo_detalle_catalogo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_catalogo_mob_validate_detalle_catalogo(var_detalle_catalogo, var_script_case_init, do_ajax_form_sis_catalogo_mob_validate_detalle_catalogo_cb);
  } // do_ajax_form_sis_catalogo_mob_validate_detalle_catalogo

  function do_ajax_form_sis_catalogo_mob_validate_detalle_catalogo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detalle_catalogo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_catalogo_mob_validate_detalle_catalogo_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_sis_catalogo_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_sis_catalogo_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_cat_id = scAjaxGetFieldHidden("cat_id");
    var var_cat_nombre = scAjaxGetFieldText("cat_nombre");
    var var_cat_vista_bdd = scAjaxGetFieldText("cat_vista_bdd");
    ...
    scAjaxProcOn();
    x_ajax_form_sis_catalogo_mob_submit_form(var_cat_id, var_cat_nombre, var_cat_vista_bdd, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_catalogo_mob_submit_form_cb);
  } // do_ajax_form_sis_catalogo_mob_submit_form

  function do_ajax_form_sis_catalogo_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("cat_id");
      scAjaxHideErrorDisplay("cat_nombre");
      scAjaxHideErrorDisplay("cat_vista_bdd");
      scAjaxHideErrorDisplay("detalle_catalogo");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_sis_catalogo_mob_submit_form_cb_after_alert);
  } // do_ajax_form_sis_catalogo_mob_submit_form_cb
  function do_ajax_form_sis_catalogo_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_catalogo_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_sis_detalle_catalogo_mob"] = "off";

  function do_ajax_form_sis_catalogo_mob_navigate_form()
  {
    perform_ajax_form_sis_catalogo_mob_navigate_form();
  }

  function perform_ajax_form_sis_catalogo_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("cat_vista_bdd");
    scAjaxHideErrorDisplay("detalle_catalogo");
    var var_cat_id = document.F2.cat_id.value;
    ...
    scAjaxProcOn();
    scStatusDetail["form_sis_detalle_catalogo_mob"] = "on";
    x_ajax_form_sis_catalogo_mob_navigate_form(var_cat_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_catalogo_mob_navigate_form_cb);
  } // do_ajax_form_sis_catalogo_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_catalogo_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_catalogo_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.cat_id.value = scAjaxGetKeyValue("cat_id");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_sis_detalle_catalogo_mob"] && "nmsc_iframe_liga_form_sis_detalle_catalogo_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_sis_detalle_catalogo_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_sis_detalle_catalogo_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_sis_detalle_catalogo_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_sis_detalle_catalogo_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_sis_detalle_catalogo_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_catalogo_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_catalogo_mob_navigate_form_cb
  function do_ajax_form_sis_catalogo_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_sis_catalogo_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_sis_catalogo_mob_navigate_form_cb_after_alert

  function sc_hide_form_sis_catalogo_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_sis_detalle_catalogo_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "cat_id";
  ajax_field_list[1] = "cat_nombre";
  ajax_field_list[2] = "cat_vista_bdd";
  ajax_field_list[3] = "detalle_catalogo";
  ...
  var ajax_error_list = {
    "cat_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cat_nombre": {"label": "<?php echo $this->Ini->Nm_lang['lang_nombre'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cat_vista_bdd": {"label": "<?php echo $this->Ini->Nm_lang['lang_vista_bdd'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "detalle_catalogo": {"label": "<?php echo $this->Ini->Nm_lang['lang_detalle_catalogo'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "cat_id": new Array(),
    "cat_nombre": new Array(),
    "cat_vista_bdd": new Array(),
    "detalle_catalogo": new Array()
  };
  ajax_field_mult["cat_id"][1] = "cat_id";
  ajax_field_mult["cat_nombre"][1] = "cat_nombre";
  ajax_field_mult["cat_vista_bdd"][1] = "cat_vista_bdd";
  ajax_field_mult["detalle_catalogo"][1] = "detalle_catalogo";

  var ajax_field_id = {
    "cat_id": new Array("hidden_field_label_cat_id", "hidden_field_data_cat_id"),
    "cat_nombre": new Array("hidden_field_label_cat_nombre", "hidden_field_data_cat_nombre"),
    "cat_vista_bdd": new Array("hidden_field_label_cat_vista_bdd", "hidden_field_data_cat_vista_bdd"),
    "detalle_catalogo": new Array("hidden_field_label_detalle_catalogo", "hidden_field_data_detalle_catalogo")
  };
