  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_catalogo" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sis_catalogo_form();
	}
...
?>
  ...
  // ---------- Validate cat_id
  function do_ajax_form_sis_catalogo_validate_cat_id()
  {
    var nomeCampo_cat_id = "cat_id";
    var var_cat_id = scAjaxGetFieldHidden(nomeCampo_cat_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_catalogo_validate_cat_id(var_cat_id, var_script_case_init, do_ajax_form_sis_catalogo_validate_cat_id_cb);
  } // do_ajax_form_sis_catalogo_validate_cat_id

  function do_ajax_form_sis_catalogo_validate_cat_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_catalogo_validate_cat_id_cb

  // ---------- Validate cat_nombre
  function do_ajax_form_sis_catalogo_validate_cat_nombre()
  {
    var nomeCampo_cat_nombre = "cat_nombre";
    var var_cat_nombre = scAjaxGetFieldText(nomeCampo_cat_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_catalogo_validate_cat_nombre(var_cat_nombre, var_script_case_init, do_ajax_form_sis_catalogo_validate_cat_nombre_cb);
  } // do_ajax_form_sis_catalogo_validate_cat_nombre

  function do_ajax_form_sis_catalogo_validate_cat_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_catalogo_validate_cat_nombre_cb

  // ---------- Validate cat_vista_bdd
  function do_ajax_form_sis_catalogo_validate_cat_vista_bdd()
  {
    var nomeCampo_cat_vista_bdd = "cat_vista_bdd";
    var var_cat_vista_bdd = scAjaxGetFieldText(nomeCampo_cat_vista_bdd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_catalogo_validate_cat_vista_bdd(var_cat_vista_bdd, var_script_case_init, do_ajax_form_sis_catalogo_validate_cat_vista_bdd_cb);
  } // do_ajax_form_sis_catalogo_validate_cat_vista_bdd

  function do_ajax_form_sis_catalogo_validate_cat_vista_bdd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_catalogo_validate_cat_vista_bdd_cb

  // ---------- Validate detalle_catalogo
  function do_ajax_form_sis_catalogo_validate_detalle_catalogo()
  {
    var nomeCampo_detalle_catalogo = "detalle_catalogo";
    var var_detalle_catalogo = scAjaxGetFieldText(nomeCampo_detalle_catalogo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_catalogo_validate_detalle_catalogo(var_detalle_catalogo, var_script_case_init, do_ajax_form_sis_catalogo_validate_detalle_catalogo_cb);
  } // do_ajax_form_sis_catalogo_validate_detalle_catalogo

  function do_ajax_form_sis_catalogo_validate_detalle_catalogo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_catalogo_validate_detalle_catalogo_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_sis_catalogo_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_sis_catalogo_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_sis_catalogo_submit_form(var_cat_id, var_cat_nombre, var_cat_vista_bdd, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_catalogo_submit_form_cb);
  } // do_ajax_form_sis_catalogo_submit_form

  function do_ajax_form_sis_catalogo_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_sis_catalogo_submit_form_cb_after_alert);
  } // do_ajax_form_sis_catalogo_submit_form_cb
  function do_ajax_form_sis_catalogo_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_catalogo_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_sis_detalle_catalogo"] = "off";

  function do_ajax_form_sis_catalogo_navigate_form()
  {
    perform_ajax_form_sis_catalogo_navigate_form();
  }

  function perform_ajax_form_sis_catalogo_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_sis_detalle_catalogo"] = "on";
    x_ajax_form_sis_catalogo_navigate_form(var_cat_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_catalogo_navigate_form_cb);
  } // do_ajax_form_sis_catalogo_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_catalogo']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_catalogo_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_sis_detalle_catalogo"] && "nmsc_iframe_liga_form_sis_detalle_catalogo" != scMasterDetailIframe["nmsc_iframe_liga_form_sis_detalle_catalogo"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_sis_detalle_catalogo"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_sis_detalle_catalogo').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_sis_detalle_catalogo').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_sis_detalle_catalogo').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_catalogo_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_catalogo_navigate_form_cb
  function do_ajax_form_sis_catalogo_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_sis_catalogo_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_sis_catalogo_navigate_form_cb_after_alert

  function sc_hide_form_sis_catalogo_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_sis_detalle_catalogo"])
    {
      return true;
    }
    return false;
