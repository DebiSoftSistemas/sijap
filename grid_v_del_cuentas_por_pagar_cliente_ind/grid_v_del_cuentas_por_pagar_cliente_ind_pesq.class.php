...
class grid_v_del_cuentas_por_pagar_cliente_ind_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_v_del_cuentas_por_pagar_cliente_ind_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_v_del_cuentas_por_pagar_cliente_ind_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_v_del_cuentas_por_pagar_cliente_ind_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_cxp_empresa')
      {
          $cxp_empresa = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_cxp_empresa($cxp_empresa);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "cxp_cliente";$Nm_numeric[] = "cxp_valor";
      $campo_join = strtolower(str_replace(".", "_", $nome));
      if (in_array($campo_join, $Nm_numeric))
      {
          if ($condicao == "EP" || $condicao == "NE")
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$campo_join]);
              return;
          }
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      else
      {
         ...
         $nome_sum = "v_del_cuentas_por_pagar_cliente.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_cuentas_por_pagar'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_v_del_cuentas_por_pagar_cliente_ind/grid_v_del_cuentas_por_pagar_cliente_ind_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_v_del_cuentas_por_pagar_cliente_ind_ajax_search.js"></script>
 <script type="text/javascript" src="grid_v_del_cuentas_por_pagar_cliente_ind_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_v_del_cuentas_por_pagar_cliente_ind_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_v_del_cuentas_por_pagar_cliente_ind']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_v_del_cuentas_por_pagar_cliente_ind']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_cxp_empresa_cond#NMF#' + search_get_sel_txt('SC_cxp_empresa_cond') + '@NMF@';
  str_out += 'SC_cxp_empresa#NMF#' + search_get_text('SC_cxp_empresa') + '@NMF@';
  str_out += 'id_ac_cxp_empresa#NMF#' + search_get_title('select2-id_ac_cxp_empresa-container') + '@NMF@';
  str_out += 'SC_cxp_cliente_cond#NMF#' + search_get_sel_txt('SC_cxp_cliente_cond') + '@NMF@';
  str_out += 'SC_cxp_cliente#NMF#' + search_get_text('SC_cxp_cliente') + '@NMF@';
  str_out += 'SC_cxp_valor_cond#NMF#' + search_get_sel_txt('SC_cxp_valor_cond') + '@NMF@';
  str_out += 'SC_cxp_valor#NMF#' + search_get_text('SC_cxp_valor') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  ...
  $(".sc-ui-autocomp-cxp_empresa").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_cxp_empresa",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_cxp_empresa").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $cxp_empresa_cond, $cxp_empresa, $cxp_empresa_autocomp,
             $cxp_cliente_cond, $cxp_cliente,
             $cxp_valor_cond, $cxp_valor,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $cxp_empresa = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['campos_busca']['cxp_empresa']; 
          $cxp_empresa_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['campos_busca']['cxp_empresa_cond']; 
          $cxp_cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['campos_busca']['cxp_cliente']; 
          $cxp_cliente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['campos_busca']['cxp_cliente_cond']; 
          $cxp_valor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['campos_busca']['cxp_valor']; 
          $cxp_valor_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['campos_busca']['cxp_valor_cond']; 
          $cl_identificacion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['campos_busca']['cl_identificacion']; 
          $cl_identificacion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['campos_busca']['cl_identificacion_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['campos_busca']['NM_operador']; 
          if (strtoupper($cxp_cliente_cond) != "II" && strtoupper($cxp_cliente_cond) != "QP" && strtoupper($cxp_cliente_cond) != "NP" && strtoupper($cxp_cliente_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($cxp_cliente, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($cxp_valor_cond) != "II" && strtoupper($cxp_valor_cond) != "QP" && strtoupper($cxp_valor_cond) != "NP" && strtoupper($cxp_valor_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($cxp_valor, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "65535", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($cxp_empresa_cond) || empty($cxp_empresa_cond))
      {
         $cxp_empresa_cond = "qp";
      }
      if (!isset($cxp_cliente_cond) || empty($cxp_cliente_cond))
      {
         $cxp_cliente_cond = "gt";
      }
      if (!isset($cxp_valor_cond) || empty($cxp_valor_cond))
      {
         $cxp_valor_cond = "gt";
      }
      if (!isset($cl_identificacion_cond) || empty($cl_identificacion_cond))
      {
         $cl_identificacion_cond = "qp";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_cxp_empresa = (in_array($cxp_empresa_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_cxp_cliente = (in_array($cxp_cliente_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_cxp_valor = (in_array($cxp_valor_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_cl_identificacion = (in_array($cl_identificacion_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($cxp_empresa) || $cxp_empresa == "")
      {
          $cxp_empresa = "";
      }
      if (isset($cxp_empresa) && !empty($cxp_empresa))
      {
         $tmp_pos = (is_string($cxp_empresa)) ? strpos($cxp_empresa, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $cxp_empresa = substr($cxp_empresa, 0, $tmp_pos);
         }
      }
      if (!isset($cxp_cliente) || $cxp_cliente == "")
      {
          $cxp_cliente = "";
      }
      if (isset($cxp_cliente) && !empty($cxp_cliente))
      {
         $tmp_pos = (is_string($cxp_cliente)) ? strpos($cxp_cliente, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $cxp_cliente = substr($cxp_cliente, 0, $tmp_pos);
         }
      }
      if (!isset($cxp_valor) || $cxp_valor == "")
      {
          $cxp_valor = "";
      }
      if (isset($cxp_valor) && !empty($cxp_valor))
      {
         $tmp_pos = (is_string($cxp_valor)) ? strpos($cxp_valor, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $cxp_valor = substr($cxp_valor, 0, $tmp_pos);
         }
      }
...
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_cxp_empresa_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['cxp_empresa'])) ? $this->New_label['cxp_empresa'] : "" . $this->Ini->Nm_lang['lang_empresa'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_cxp_empresa_cond" name="cxp_empresa_cond" onChange="nm_campos_between(document.getElementById('id_vis_cxp_empresa'), this, 'cxp_empresa')">
       <OPTION value="qp" <?php if ("qp" == $cxp_empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $cxp_empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $cxp_empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $cxp_empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cxp_empresa" <?php echo $str_hide_cxp_empresa?> valign="top">
 ...
 $nmgp_tab_label .= "cxp_empresa?#?" . $SC_Label . "?@?";
...
<?php
      ...
      {
          $sAutocompValue = $cxp_empresa;
      }
?>
<INPUT  type="text" id="SC_cxp_empresa" name="cxp_empresa" value="<?php echo NM_encode_input($cxp_empresa) ?>"  size=13 alt="{datatype: 'text', maxLength: 13, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-cxp_empresa" id="id_ac_cxp_empresa" name="cxp_empresa_autocomp"><?php if ('' !=  $cxp_empresa) { ?><option value="<?php echo $cxp_empresa ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_cxp_cliente_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['cxp_cliente'])) ? $this->New_label['cxp_cliente'] : "Cxp Cliente"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_cxp_cliente_cond" name="cxp_cliente_cond" onChange="nm_campos_between(document.getElementById('id_vis_cxp_cliente'), this, 'cxp_cliente')">
       <OPTION value="gt" <?php if ("gt" == $cxp_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $cxp_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $cxp_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cxp_cliente" <?php echo $str_hide_cxp_cliente?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['cxp_cliente'])) ? $this->New_label['cxp_cliente'] : "Cxp Cliente";
 $nmgp_tab_label .= "cxp_cliente?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_cxp_cliente" name="cxp_cliente" value="<?php echo NM_encode_input($cxp_cliente) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_cxp_valor_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['cxp_valor'])) ? $this->New_label['cxp_valor'] : "" . $this->Ini->Nm_lang['lang_valor'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_cxp_valor_cond" name="cxp_valor_cond" onChange="nm_campos_between(document.getElementById('id_vis_cxp_valor'), this, 'cxp_valor')">
       <OPTION value="gt" <?php if ("gt" == $cxp_valor_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $cxp_valor_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $cxp_valor_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cxp_valor" <?php echo $str_hide_cxp_valor?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['cxp_valor'])) ? $this->New_label['cxp_valor'] : "" . $this->Ini->Nm_lang['lang_valor'] . "";
 $nmgp_tab_label .= "cxp_valor?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_cxp_valor" name="cxp_valor" value="<?php echo NM_encode_input($cxp_valor) ?>" size=18 alt="{datatype: 'decimal', maxLength: 18, precision: 65535, decimalSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['dec_num'] ?>', thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
     ...
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_cl_identificacion_cond" name="cl_identificacion_cond" onChange="nm_campos_between(document.getElementById('id_vis_cl_identificacion'), this, 'cl_identificacion')">
       <OPTION value="qp" <?php if ("qp" == $cl_identificacion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $cl_identificacion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $cl_identificacion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $cl_identificacion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_v_del_cuentas_por_pagar_cliente_ind_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_v_del_cuentas_por_pagar_cliente_ind']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_v_del_cuentas_por_pagar_cliente_ind']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.cxp_empresa_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_cxp_empresa'), document.F1.cxp_empresa_cond, 'cxp_empresa');
   document.F1.cxp_empresa.value = "";
   document.F1.cxp_empresa_autocomp.value = "";
   $('#select2-id_ac_cxp_empresa-container').html('<?php echo $this->Val_init_cxp_empresa['desc'] ?>');;
   document.F1.cxp_cliente_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_cxp_cliente'), document.F1.cxp_cliente_cond, 'cxp_cliente');
   document.F1.cxp_cliente.value = "";
   document.F1.cxp_valor_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_cxp_valor'), document.F1.cxp_valor_cond, 'cxp_valor');
   document.F1.cxp_valor.value = "";
   document.F1.cl_identificacion_cond.value = 'qp';
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_v_del_cuentas_por_pagar_cliente_ind/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_cxp_empresa_cond'] = 'cond';
      $tp_fields['SC_cxp_empresa'] = 'text_aut';
      $tp_fields['id_ac_cxp_empresa'] = 'select2_aut';
      $tp_fields['SC_cxp_cliente_cond'] = 'cond';
      $tp_fields['SC_cxp_cliente'] = 'text';
      $tp_fields['SC_cxp_valor_cond'] = 'cond';
      $tp_fields['SC_cxp_valor'] = 'text';
   ...
   {
      global $cxp_empresa_cond, $cxp_empresa, $cxp_empresa_autocomp,
             $cxp_cliente_cond, $cxp_cliente,
             $cxp_valor_cond, $cxp_valor,
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($cxp_empresa_autocomp) && empty($cxp_empresa))
      {
          $cxp_empresa = $cxp_empresa_autocomp;
      }
      if (!empty($cl_identificacion_autocomp) && empty($cl_identificacion))
      {
          $cl_identificacion = $cl_identificacion_autocomp;
      }
      $cxp_empresa_cond_salva = $cxp_empresa_cond; 
      if (!isset($cxp_empresa_input_2) || $cxp_empresa_input_2 == "")
      {
          $cxp_empresa_input_2 = $cxp_empresa;
      }
      $cxp_cliente_cond_salva = $cxp_cliente_cond; 
      if (!isset($cxp_cliente_input_2) || $cxp_cliente_input_2 == "")
      {
          $cxp_cliente_input_2 = $cxp_cliente;
      }
      $cxp_valor_cond_salva = $cxp_valor_cond; 
      if (!isset($cxp_valor_input_2) || $cxp_valor_input_2 == "")
      {
          $cxp_valor_input_2 = $cxp_valor;
      }
      ...
      if ($cxp_cliente_cond != "in")
      {
          nm_limpa_numero($cxp_cliente, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($cxp_valor_cond != "in")
      {
          if ($C_formatado)
          {
              nm_limpa_valor($cxp_valor, $_SESSION['scriptcase']['reg_conf']['dec_num'], $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['campos_busca']['cxp_empresa'] = $cxp_empresa; 
      if (is_array($cxp_empresa) && !empty($cxp_empresa))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['Grid_search'][$I_Grid]['val'][0] = $cxp_empresa;
      }
      elseif ($cxp_empresa_cond_salva == "nu" || $cxp_empresa_cond_salva == "nn" || $cxp_empresa_cond_salva == "ep" || $cxp_empresa_cond_salva == "ne" || !empty($cxp_empresa))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['Grid_search'][$I_Grid]['val'][0][0] = $cxp_empresa;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['campos_busca']['cxp_empresa_cond'] = $cxp_empresa_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['Grid_search'][$I_Grid]['cmp'] = "cxp_empresa"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['Grid_search'][$I_Grid]['opc'] = $cxp_empresa_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq']['cxp_empresa'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['campos_busca']['cxp_cliente'] = $cxp_cliente; 
      if (is_array($cxp_cliente) && !empty($cxp_cliente))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['Grid_search'][$I_Grid]['val'][0] = $cxp_cliente;
      }
      elseif ($cxp_cliente_cond_salva == "nu" || $cxp_cliente_cond_salva == "nn" || $cxp_cliente_cond_salva == "ep" || $cxp_cliente_cond_salva == "ne" || !empty($cxp_cliente))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['Grid_search'][$I_Grid]['val'][0][0] = $cxp_cliente;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['campos_busca']['cxp_cliente_cond'] = $cxp_cliente_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['Grid_search'][$I_Grid]['cmp'] = "cxp_cliente"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['Grid_search'][$I_Grid]['opc'] = $cxp_cliente_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq']['cxp_cliente'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['campos_busca']['cxp_valor'] = $cxp_valor; 
      if (is_array($cxp_valor) && !empty($cxp_valor))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['Grid_search'][$I_Grid]['val'][0] = $cxp_valor;
      }
      elseif ($cxp_valor_cond_salva == "nu" || $cxp_valor_cond_salva == "nn" || $cxp_valor_cond_salva == "ep" || $cxp_valor_cond_salva == "ne" || !empty($cxp_valor))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['Grid_search'][$I_Grid]['val'][0][0] = $cxp_valor;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['campos_busca']['cxp_valor_cond'] = $cxp_valor_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['Grid_search'][$I_Grid]['cmp'] = "cxp_valor"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['Grid_search'][$I_Grid]['opc'] = $cxp_valor_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq']['cxp_valor'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['campos_busca']['cl_identificacion'] = $cl_identificacion; 
      if (is_array($cl_identificacion) && !empty($cl_identificacion))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['Grid_search'][$I_Grid]['val'][0] = $cl_identificacion;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['Grid_search'][$I_Grid]['val'][0][0] = $cl_identificacion;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['campos_busca']['cl_identificacion_cond'] = $cl_identificacion_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['Grid_search'][$I_Grid]['cmp'] = "cl_identificacion"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['Grid_search'][$I_Grid]['opc'] = $cl_identificacion_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['grid_pesq']['cl_identificacion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['campos_busca'] = $Temp_Busca;
      }
      if ($cxp_valor_cond != "in" && $cxp_valor_cond != "bw" && !empty($cxp_valor) && !is_numeric($cxp_valor))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : " . $this->Ini->Nm_lang['lang_valor'] . "";
      }
      if ($cxp_valor_cond == "bw" && ((!empty($cxp_valor) && !is_numeric($cxp_valor)) || (!empty($cxp_valor_input_2) && !is_numeric($cxp_valor_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : " . $this->Ini->Nm_lang['lang_valor'] . "";
      }
      if (!empty($this->Campos_Mens_erro)) 
    ...
    if ($cxp_empresa != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['cxp_empresa'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['cxp_empresa'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['cxp_empresa'] = $cxp_empresa;
      }
      $Conteudo = $cxp_cliente;
      if (strtoupper($cxp_cliente_cond) != "II" && strtoupper($cxp_cliente_cond) != "QP" && strtoupper($cxp_cliente_cond) != "NP" && strtoupper($cxp_cliente_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['cxp_cliente'] = $Conteudo;
      $Conteudo = $cxp_valor;
      if (strtoupper($cxp_valor_cond) != "II" && strtoupper($cxp_valor_cond) != "QP" && strtoupper($cxp_valor_cond) != "NP" && strtoupper($cxp_valor_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "65535", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['cxp_valor'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($cl_identificacion != '') {
      $cl_identificacion_look = (is_string($cl_identificacion) ? substr($this->Db->qstr($cl_identificacion), 1, -1) : $cl_identificacion); 
      $nmgp_def_dados = array(); 
      ...
      if (isset($cxp_empresa) || $cxp_empresa_cond == "nu" || $cxp_empresa_cond == "nn" || $cxp_empresa_cond == "ep" || $cxp_empresa_cond == "ne")
      {
         $this->monta_condicao("cxp_empresa", $cxp_empresa_cond, $cxp_empresa, "", "cxp_empresa", "VARCHAR", false);
      }

      //----- $cxp_cliente
      $this->Date_part = false;
      if (isset($cxp_cliente) || $cxp_cliente_cond == "nu" || $cxp_cliente_cond == "nn" || $cxp_cliente_cond == "ep" || $cxp_cliente_cond == "ne")
      {
         $this->monta_condicao("cxp_cliente", $cxp_cliente_cond, $cxp_cliente, "", "cxp_cliente", "INT4", false);
      }

      //----- $cxp_valor
      $this->Date_part = false;
      if (isset($cxp_valor) || $cxp_valor_cond == "nu" || $cxp_valor_cond == "nn" || $cxp_valor_cond == "ep" || $cxp_valor_cond == "ne")
      {
         $this->monta_condicao("cxp_valor", $cxp_valor_cond, $cxp_valor, "", "cxp_valor", "NUMERIC", false);
      }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['where_pesq'] = $this->comando;
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['cond_dyn_search'] = "";
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_cuentas_por_pagar_cliente_ind']['cond_pesq'] .= $this->NM_operador;
