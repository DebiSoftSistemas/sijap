<?php
@session_start() ;
$_SESSION['scriptcase']['grid_v_del_cuentas_por_pagar_cliente_ind']['sc_process_barr'] = true;
require_once('../grid_v_del_cuentas_por_pagar_cliente_ind/index.php');
unset($_SESSION['scriptcase']['grid_v_del_cuentas_por_pagar_cliente_ind']['sc_process_barr']);
$ExportCtrl = new grid_v_del_cuentas_por_pagar_cliente_ind_export_control;
$ExportCtrl->Export_barr();

class grid_v_del_cuentas_por_pagar_cliente_ind_export_control
{
