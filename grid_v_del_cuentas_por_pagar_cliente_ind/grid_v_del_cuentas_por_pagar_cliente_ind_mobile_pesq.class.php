...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "cxp_cliente";$Nm_numeric[] = "cxp_valor";$Nm_numeric[] = "cxp_cliente";$Nm_numeric[] = "cxp_valor";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_cxp_empresa_cond" name="cxp_empresa_cond" onChange="nm_campos_between(document.getElementById('id_vis_cxp_empresa'), this, 'cxp_empresa')">
      ...
      <br><span id="id_hide_cxp_empresa"  <?php echo $str_hide_cxp_empresa?>><?php
      if ($cxp_empresa != "")
      {
      $cxp_empresa_look = (is_string($cxp_empresa) ? substr($this->Db->qstr($cxp_empresa), 1, -1) : $cxp_empresa); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_cxp_cliente_cond" name="cxp_cliente_cond" onChange="nm_campos_between(document.getElementById('id_vis_cxp_cliente'), this, 'cxp_cliente')">
      ...
      <br><span id="id_hide_cxp_cliente"  <?php echo $str_hide_cxp_cliente?>><INPUT  type="text" id="SC_cxp_cliente" name="cxp_cliente" value="<?php echo NM_encode_input($cxp_cliente) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_cxp_valor_cond" name="cxp_valor_cond" onChange="nm_campos_between(document.getElementById('id_vis_cxp_valor'), this, 'cxp_valor')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_cl_identificacion_cond" name="cl_identificacion_cond" onChange="nm_campos_between(document.getElementById('id_vis_cl_identificacion'), this, 'cl_identificacion')">
      ...
      <br><span id="id_hide_cl_identificacion"  <?php echo $str_hide_cl_identificacion?>><?php
