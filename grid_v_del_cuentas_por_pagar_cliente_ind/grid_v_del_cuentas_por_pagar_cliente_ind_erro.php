...
function scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="")
{
    ...
    if (isset($_SESSION['scriptcase']['grid_v_del_cuentas_por_pagar_cliente_ind']['contr_erro']) && $_SESSION['scriptcase']['grid_v_del_cuentas_por_pagar_cliente_ind']['contr_erro'] == 'on')
    {
