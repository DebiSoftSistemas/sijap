<?php
@session_start() ;
$_SESSION['scriptcase']['grid_inv_bodega']['sc_process_barr'] = true;
require_once('../grid_inv_bodega/index.php');
unset($_SESSION['scriptcase']['grid_inv_bodega']['sc_process_barr']);
$ExportCtrl = new grid_inv_bodega_export_control;
$ExportCtrl->Export_barr();

class grid_inv_bodega_export_control
{
