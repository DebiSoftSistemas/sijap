  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_config_tienda_config_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_config_tienda_config_mob_form();
	}
...
?>
  ...
  // ---------- Validate ct_empresa
  function do_ajax_form_del_config_tienda_config_mob_validate_ct_empresa()
  {
    var nomeCampo_ct_empresa = "ct_empresa";
    var var_ct_empresa = scAjaxGetFieldText(nomeCampo_ct_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_config_tienda_config_mob_validate_ct_empresa(var_ct_empresa, var_script_case_init, do_ajax_form_del_config_tienda_config_mob_validate_ct_empresa_cb);
  } // do_ajax_form_del_config_tienda_config_mob_validate_ct_empresa

  function do_ajax_form_del_config_tienda_config_mob_validate_ct_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ct_empresa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_config_tienda_config_mob_validate_ct_empresa_cb

  // ---------- Validate ct_convenio_debi
  function do_ajax_form_del_config_tienda_config_mob_validate_ct_convenio_debi()
  {
    var nomeCampo_ct_convenio_debi = "ct_convenio_debi";
    var var_ct_convenio_debi = scAjaxGetFieldSelect(nomeCampo_ct_convenio_debi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_config_tienda_config_mob_validate_ct_convenio_debi(var_ct_convenio_debi, var_script_case_init, do_ajax_form_del_config_tienda_config_mob_validate_ct_convenio_debi_cb);
  } // do_ajax_form_del_config_tienda_config_mob_validate_ct_convenio_debi

  function do_ajax_form_del_config_tienda_config_mob_validate_ct_convenio_debi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ct_convenio_debi";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_config_tienda_config_mob_validate_ct_convenio_debi_cb

  // ---------- Validate ct_url_debi
  function do_ajax_form_del_config_tienda_config_mob_validate_ct_url_debi()
  {
    var nomeCampo_ct_url_debi = "ct_url_debi";
    var var_ct_url_debi = scAjaxGetFieldText(nomeCampo_ct_url_debi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_config_tienda_config_mob_validate_ct_url_debi(var_ct_url_debi, var_script_case_init, do_ajax_form_del_config_tienda_config_mob_validate_ct_url_debi_cb);
  } // do_ajax_form_del_config_tienda_config_mob_validate_ct_url_debi

  function do_ajax_form_del_config_tienda_config_mob_validate_ct_url_debi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ct_url_debi";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_config_tienda_config_mob_validate_ct_url_debi_cb

  // ---------- Validate ct_usuario_debi
  function do_ajax_form_del_config_tienda_config_mob_validate_ct_usuario_debi()
  {
    var nomeCampo_ct_usuario_debi = "ct_usuario_debi";
    var var_ct_usuario_debi = scAjaxGetFieldSelect(nomeCampo_ct_usuario_debi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_config_tienda_config_mob_validate_ct_usuario_debi(var_ct_usuario_debi, var_script_case_init, do_ajax_form_del_config_tienda_config_mob_validate_ct_usuario_debi_cb);
  } // do_ajax_form_del_config_tienda_config_mob_validate_ct_usuario_debi

  function do_ajax_form_del_config_tienda_config_mob_validate_ct_usuario_debi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ct_usuario_debi";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_config_tienda_config_mob_validate_ct_usuario_debi_cb

  // ---------- Validate ct_pass_debi
  function do_ajax_form_del_config_tienda_config_mob_validate_ct_pass_debi()
  {
    var nomeCampo_ct_pass_debi = "ct_pass_debi";
    var var_ct_pass_debi = scAjaxGetFieldText(nomeCampo_ct_pass_debi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_config_tienda_config_mob_validate_ct_pass_debi(var_ct_pass_debi, var_script_case_init, do_ajax_form_del_config_tienda_config_mob_validate_ct_pass_debi_cb);
  } // do_ajax_form_del_config_tienda_config_mob_validate_ct_pass_debi

  function do_ajax_form_del_config_tienda_config_mob_validate_ct_pass_debi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ct_pass_debi";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_config_tienda_config_mob_validate_ct_pass_debi_cb

  // ---------- Validate ct_url_tienda
  function do_ajax_form_del_config_tienda_config_mob_validate_ct_url_tienda()
  {
    var nomeCampo_ct_url_tienda = "ct_url_tienda";
    var var_ct_url_tienda = scAjaxGetFieldText(nomeCampo_ct_url_tienda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_config_tienda_config_mob_validate_ct_url_tienda(var_ct_url_tienda, var_script_case_init, do_ajax_form_del_config_tienda_config_mob_validate_ct_url_tienda_cb);
  } // do_ajax_form_del_config_tienda_config_mob_validate_ct_url_tienda

  function do_ajax_form_del_config_tienda_config_mob_validate_ct_url_tienda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ct_url_tienda";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_config_tienda_config_mob_validate_ct_url_tienda_cb

  // ---------- Validate ct_usuario_tienda
  function do_ajax_form_del_config_tienda_config_mob_validate_ct_usuario_tienda()
  {
    var nomeCampo_ct_usuario_tienda = "ct_usuario_tienda";
    var var_ct_usuario_tienda = scAjaxGetFieldText(nomeCampo_ct_usuario_tienda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_config_tienda_config_mob_validate_ct_usuario_tienda(var_ct_usuario_tienda, var_script_case_init, do_ajax_form_del_config_tienda_config_mob_validate_ct_usuario_tienda_cb);
  } // do_ajax_form_del_config_tienda_config_mob_validate_ct_usuario_tienda

  function do_ajax_form_del_config_tienda_config_mob_validate_ct_usuario_tienda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ct_usuario_tienda";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_config_tienda_config_mob_validate_ct_usuario_tienda_cb

  // ---------- Validate ct_pass_tienda
  function do_ajax_form_del_config_tienda_config_mob_validate_ct_pass_tienda()
  {
    var nomeCampo_ct_pass_tienda = "ct_pass_tienda";
    var var_ct_pass_tienda = scAjaxGetFieldText(nomeCampo_ct_pass_tienda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_config_tienda_config_mob_validate_ct_pass_tienda(var_ct_pass_tienda, var_script_case_init, do_ajax_form_del_config_tienda_config_mob_validate_ct_pass_tienda_cb);
  } // do_ajax_form_del_config_tienda_config_mob_validate_ct_pass_tienda

  function do_ajax_form_del_config_tienda_config_mob_validate_ct_pass_tienda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ct_pass_tienda";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_config_tienda_config_mob_validate_ct_pass_tienda_cb

  // ---------- Validate ct_estado
  function do_ajax_form_del_config_tienda_config_mob_validate_ct_estado()
  {
    var nomeCampo_ct_estado = "ct_estado";
    var var_ct_estado = scAjaxGetFieldSelect(nomeCampo_ct_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_config_tienda_config_mob_validate_ct_estado(var_ct_estado, var_script_case_init, do_ajax_form_del_config_tienda_config_mob_validate_ct_estado_cb);
  } // do_ajax_form_del_config_tienda_config_mob_validate_ct_estado

  function do_ajax_form_del_config_tienda_config_mob_validate_ct_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ct_estado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_config_tienda_config_mob_validate_ct_estado_cb

  // ---------- Validate ct_usuario_debi_md5
  function do_ajax_form_del_config_tienda_config_mob_validate_ct_usuario_debi_md5()
  {
    var nomeCampo_ct_usuario_debi_md5 = "ct_usuario_debi_md5";
    var var_ct_usuario_debi_md5 = scAjaxGetFieldText(nomeCampo_ct_usuario_debi_md5);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_config_tienda_config_mob_validate_ct_usuario_debi_md5(var_ct_usuario_debi_md5, var_script_case_init, do_ajax_form_del_config_tienda_config_mob_validate_ct_usuario_debi_md5_cb);
  } // do_ajax_form_del_config_tienda_config_mob_validate_ct_usuario_debi_md5

  function do_ajax_form_del_config_tienda_config_mob_validate_ct_usuario_debi_md5_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ct_usuario_debi_md5";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_config_tienda_config_mob_validate_ct_usuario_debi_md5_cb

  // ---------- Event onchange ct_usuario_debi
  function do_ajax_form_del_config_tienda_config_mob_event_ct_usuario_debi_onchange()
  {
    var var_ct_usuario_debi = scAjaxGetFieldSelect("ct_usuario_debi");
    var var_ct_usuario_debi_md5 = scAjaxGetFieldText("ct_usuario_debi_md5");
    var var_ct_pass_debi = scAjaxGetFieldText("ct_pass_debi");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_config_tienda_config_mob_event_ct_usuario_debi_onchange(var_ct_usuario_debi, var_ct_usuario_debi_md5, var_ct_pass_debi, var_script_case_init, do_ajax_form_del_config_tienda_config_mob_event_ct_usuario_debi_onchange_cb);
  } // do_ajax_form_del_config_tienda_config_mob_event_ct_usuario_debi_onchange

  function do_ajax_form_del_config_tienda_config_mob_event_ct_usuario_debi_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "ct_usuario_debi";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_config_tienda_config_mob_event_ct_usuario_debi_onchange_cb_after_alert);
  } // do_ajax_form_del_config_tienda_config_mob_event_ct_usuario_debi_onchange_cb
  function do_ajax_form_del_config_tienda_config_mob_event_ct_usuario_debi_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_config_tienda_config_mob_event_ct_usuario_debi_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_config_tienda_config_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_config_tienda_config_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_ct_empresa = scAjaxGetFieldText("ct_empresa");
    var var_ct_convenio_debi = scAjaxGetFieldSelect("ct_convenio_debi");
    var var_ct_url_debi = scAjaxGetFieldText("ct_url_debi");
    var var_ct_usuario_debi = scAjaxGetFieldSelect("ct_usuario_debi");
    var var_ct_pass_debi = scAjaxGetFieldText("ct_pass_debi");
    var var_ct_url_tienda = scAjaxGetFieldText("ct_url_tienda");
    var var_ct_usuario_tienda = scAjaxGetFieldText("ct_usuario_tienda");
    var var_ct_pass_tienda = scAjaxGetFieldText("ct_pass_tienda");
    var var_ct_estado = scAjaxGetFieldSelect("ct_estado");
    var var_ct_usuario_debi_md5 = scAjaxGetFieldText("ct_usuario_debi_md5");
    ...
    scAjaxProcOn();
    x_ajax_form_del_config_tienda_config_mob_submit_form(var_ct_empresa, var_ct_convenio_debi, var_ct_url_debi, var_ct_usuario_debi, var_ct_pass_debi, var_ct_url_tienda, var_ct_usuario_tienda, var_ct_pass_tienda, var_ct_estado, var_ct_usuario_debi_md5, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_config_tienda_config_mob_submit_form_cb);
  } // do_ajax_form_del_config_tienda_config_mob_submit_form

  function do_ajax_form_del_config_tienda_config_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("ct_empresa");
      scAjaxHideErrorDisplay("ct_convenio_debi");
      scAjaxHideErrorDisplay("ct_url_debi");
      scAjaxHideErrorDisplay("ct_usuario_debi");
      scAjaxHideErrorDisplay("ct_pass_debi");
      scAjaxHideErrorDisplay("ct_url_tienda");
      scAjaxHideErrorDisplay("ct_usuario_tienda");
      scAjaxHideErrorDisplay("ct_pass_tienda");
      scAjaxHideErrorDisplay("ct_estado");
      scAjaxHideErrorDisplay("ct_usuario_debi_md5");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_config_tienda_config_mob_submit_form_cb_after_alert);
  } // do_ajax_form_del_config_tienda_config_mob_submit_form_cb
  function do_ajax_form_del_config_tienda_config_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_config_tienda_config_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_config_tienda_config_mob_navigate_form()
  {
    perform_ajax_form_del_config_tienda_config_mob_navigate_form();
  }

  function perform_ajax_form_del_config_tienda_config_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("ct_estado");
    scAjaxHideErrorDisplay("ct_usuario_debi_md5");
    var var_ct_empresa = document.F2.ct_empresa.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_config_tienda_config_mob_navigate_form(var_ct_empresa, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_config_tienda_config_mob_navigate_form_cb);
  } // do_ajax_form_del_config_tienda_config_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_config_tienda_config_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_config_tienda_config_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.ct_empresa.value = scAjaxGetKeyValue("ct_empresa");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_config_tienda_config_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_del_config_tienda_config_mob_navigate_form_cb
  function do_ajax_form_del_config_tienda_config_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_del_config_tienda_config_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_config_tienda_config_mob_navigate_form_cb_after_alert

  function sc_hide_form_del_config_tienda_config_mob_form()
  {
  ...
  ajax_field_list[0] = "ct_empresa";
  ajax_field_list[1] = "ct_convenio_debi";
  ajax_field_list[2] = "ct_url_debi";
  ajax_field_list[3] = "ct_usuario_debi";
  ajax_field_list[4] = "ct_pass_debi";
  ajax_field_list[5] = "ct_url_tienda";
  ajax_field_list[6] = "ct_usuario_tienda";
  ajax_field_list[7] = "ct_pass_tienda";
  ajax_field_list[8] = "ct_estado";
  ajax_field_list[9] = "ct_usuario_debi_md5";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "ct_empresa": {"label": "<?php echo $this->Ini->Nm_lang['lang_empresa'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ct_convenio_debi": {"label": "<?php echo $this->Ini->Nm_lang['lang_convenio_debi'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ct_url_debi": {"label": "<?php echo $this->Ini->Nm_lang['lang_url_debi'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ct_usuario_debi": {"label": "<?php echo $this->Ini->Nm_lang['lang_usuario_debi'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ct_pass_debi": {"label": "<?php echo $this->Ini->Nm_lang['lang_password_debi'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ct_url_tienda": {"label": "<?php echo $this->Ini->Nm_lang['lang_url_tienda'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ct_usuario_tienda": {"label": "<?php echo $this->Ini->Nm_lang['lang_usuario_tienda'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ct_pass_tienda": {"label": "<?php echo $this->Ini->Nm_lang['lang_clave_tienda'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ct_estado": {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ct_usuario_debi_md5": {"label": "Ct Usuario Debi Md 5", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "ct_empresa": new Array(),
    "ct_convenio_debi": new Array(),
    "ct_url_debi": new Array(),
    "ct_usuario_debi": new Array(),
    "ct_pass_debi": new Array(),
    "ct_url_tienda": new Array(),
    "ct_usuario_tienda": new Array(),
    "ct_pass_tienda": new Array(),
    "ct_estado": new Array(),
    "ct_usuario_debi_md5": new Array()
  };
  ajax_field_mult["ct_empresa"][1] = "ct_empresa";
  ajax_field_mult["ct_convenio_debi"][1] = "ct_convenio_debi";
  ajax_field_mult["ct_url_debi"][1] = "ct_url_debi";
  ajax_field_mult["ct_usuario_debi"][1] = "ct_usuario_debi";
  ajax_field_mult["ct_pass_debi"][1] = "ct_pass_debi";
  ajax_field_mult["ct_url_tienda"][1] = "ct_url_tienda";
  ajax_field_mult["ct_usuario_tienda"][1] = "ct_usuario_tienda";
  ajax_field_mult["ct_pass_tienda"][1] = "ct_pass_tienda";
  ajax_field_mult["ct_estado"][1] = "ct_estado";
  ajax_field_mult["ct_usuario_debi_md5"][1] = "ct_usuario_debi_md5";

  var ajax_field_id = {
    "ct_convenio_debi": new Array("hidden_field_label_ct_convenio_debi", "hidden_field_data_ct_convenio_debi"),
    "ct_url_debi": new Array("hidden_field_label_ct_url_debi", "hidden_field_data_ct_url_debi"),
    "ct_usuario_debi": new Array("hidden_field_label_ct_usuario_debi", "hidden_field_data_ct_usuario_debi"),
    "ct_estado": new Array("hidden_field_label_ct_estado", "hidden_field_data_ct_estado")
  };

  var ajax_read_only = {
    "ct_empresa": "on",
    "ct_convenio_debi": "off",
    "ct_url_debi": "off",
    "ct_usuario_debi": "off",
    "ct_pass_debi": "on",
    "ct_url_tienda": "off",
    "ct_usuario_tienda": "off",
    "ct_pass_tienda": "off",
    "ct_estado": "off",
    "ct_usuario_debi_md5": "off"
  };
