  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_config_tienda_config" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_config_tienda_config_form();
	}
...
?>
  ...
  // ---------- Validate ct_empresa
  function do_ajax_form_del_config_tienda_config_validate_ct_empresa()
  {
    var nomeCampo_ct_empresa = "ct_empresa";
    var var_ct_empresa = scAjaxGetFieldText(nomeCampo_ct_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_config_tienda_config_validate_ct_empresa(var_ct_empresa, var_script_case_init, do_ajax_form_del_config_tienda_config_validate_ct_empresa_cb);
  } // do_ajax_form_del_config_tienda_config_validate_ct_empresa

  function do_ajax_form_del_config_tienda_config_validate_ct_empresa_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_config_tienda_config_validate_ct_empresa_cb

  // ---------- Validate ct_convenio_debi
  function do_ajax_form_del_config_tienda_config_validate_ct_convenio_debi()
  {
    var nomeCampo_ct_convenio_debi = "ct_convenio_debi";
    var var_ct_convenio_debi = scAjaxGetFieldSelect(nomeCampo_ct_convenio_debi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_config_tienda_config_validate_ct_convenio_debi(var_ct_convenio_debi, var_script_case_init, do_ajax_form_del_config_tienda_config_validate_ct_convenio_debi_cb);
  } // do_ajax_form_del_config_tienda_config_validate_ct_convenio_debi

  function do_ajax_form_del_config_tienda_config_validate_ct_convenio_debi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_config_tienda_config_validate_ct_convenio_debi_cb

  // ---------- Validate ct_url_debi
  function do_ajax_form_del_config_tienda_config_validate_ct_url_debi()
  {
    var nomeCampo_ct_url_debi = "ct_url_debi";
    var var_ct_url_debi = scAjaxGetFieldText(nomeCampo_ct_url_debi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_config_tienda_config_validate_ct_url_debi(var_ct_url_debi, var_script_case_init, do_ajax_form_del_config_tienda_config_validate_ct_url_debi_cb);
  } // do_ajax_form_del_config_tienda_config_validate_ct_url_debi

  function do_ajax_form_del_config_tienda_config_validate_ct_url_debi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_config_tienda_config_validate_ct_url_debi_cb

  // ---------- Validate ct_usuario_debi
  function do_ajax_form_del_config_tienda_config_validate_ct_usuario_debi()
  {
    var nomeCampo_ct_usuario_debi = "ct_usuario_debi";
    var var_ct_usuario_debi = scAjaxGetFieldSelect(nomeCampo_ct_usuario_debi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_config_tienda_config_validate_ct_usuario_debi(var_ct_usuario_debi, var_script_case_init, do_ajax_form_del_config_tienda_config_validate_ct_usuario_debi_cb);
  } // do_ajax_form_del_config_tienda_config_validate_ct_usuario_debi

  function do_ajax_form_del_config_tienda_config_validate_ct_usuario_debi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_config_tienda_config_validate_ct_usuario_debi_cb

  // ---------- Validate ct_pass_debi
  function do_ajax_form_del_config_tienda_config_validate_ct_pass_debi()
  {
    var nomeCampo_ct_pass_debi = "ct_pass_debi";
    var var_ct_pass_debi = scAjaxGetFieldText(nomeCampo_ct_pass_debi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_config_tienda_config_validate_ct_pass_debi(var_ct_pass_debi, var_script_case_init, do_ajax_form_del_config_tienda_config_validate_ct_pass_debi_cb);
  } // do_ajax_form_del_config_tienda_config_validate_ct_pass_debi

  function do_ajax_form_del_config_tienda_config_validate_ct_pass_debi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_config_tienda_config_validate_ct_pass_debi_cb

  // ---------- Validate ct_url_tienda
  function do_ajax_form_del_config_tienda_config_validate_ct_url_tienda()
  {
    var nomeCampo_ct_url_tienda = "ct_url_tienda";
    var var_ct_url_tienda = scAjaxGetFieldText(nomeCampo_ct_url_tienda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_config_tienda_config_validate_ct_url_tienda(var_ct_url_tienda, var_script_case_init, do_ajax_form_del_config_tienda_config_validate_ct_url_tienda_cb);
  } // do_ajax_form_del_config_tienda_config_validate_ct_url_tienda

  function do_ajax_form_del_config_tienda_config_validate_ct_url_tienda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_config_tienda_config_validate_ct_url_tienda_cb

  // ---------- Validate ct_usuario_tienda
  function do_ajax_form_del_config_tienda_config_validate_ct_usuario_tienda()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_config_tienda_config_validate_ct_usuario_tienda(var_ct_usuario_tienda, var_script_case_init, do_ajax_form_del_config_tienda_config_validate_ct_usuario_tienda_cb);
  } // do_ajax_form_del_config_tienda_config_validate_ct_usuario_tienda

  function do_ajax_form_del_config_tienda_config_validate_ct_usuario_tienda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_config_tienda_config_validate_ct_usuario_tienda_cb

  // ---------- Validate ct_pass_tienda
  function do_ajax_form_del_config_tienda_config_validate_ct_pass_tienda()
  {
    var nomeCampo_ct_pass_tienda = "ct_pass_tienda";
    var var_ct_pass_tienda = scAjaxGetFieldText(nomeCampo_ct_pass_tienda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_config_tienda_config_validate_ct_pass_tienda(var_ct_pass_tienda, var_script_case_init, do_ajax_form_del_config_tienda_config_validate_ct_pass_tienda_cb);
  } // do_ajax_form_del_config_tienda_config_validate_ct_pass_tienda

  function do_ajax_form_del_config_tienda_config_validate_ct_pass_tienda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_config_tienda_config_validate_ct_pass_tienda_cb

  // ---------- Validate ct_estado
  function do_ajax_form_del_config_tienda_config_validate_ct_estado()
  {
    var nomeCampo_ct_estado = "ct_estado";
    var var_ct_estado = scAjaxGetFieldSelect(nomeCampo_ct_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_config_tienda_config_validate_ct_estado(var_ct_estado, var_script_case_init, do_ajax_form_del_config_tienda_config_validate_ct_estado_cb);
  } // do_ajax_form_del_config_tienda_config_validate_ct_estado

  function do_ajax_form_del_config_tienda_config_validate_ct_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_config_tienda_config_validate_ct_estado_cb

  // ---------- Validate ct_usuario_debi_md5
  function do_ajax_form_del_config_tienda_config_validate_ct_usuario_debi_md5()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_config_tienda_config_validate_ct_usuario_debi_md5(var_ct_usuario_debi_md5, var_script_case_init, do_ajax_form_del_config_tienda_config_validate_ct_usuario_debi_md5_cb);
  } // do_ajax_form_del_config_tienda_config_validate_ct_usuario_debi_md5

  function do_ajax_form_del_config_tienda_config_validate_ct_usuario_debi_md5_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_config_tienda_config_validate_ct_usuario_debi_md5_cb

  // ---------- Event onchange ct_usuario_debi
  function do_ajax_form_del_config_tienda_config_event_ct_usuario_debi_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_del_config_tienda_config_event_ct_usuario_debi_onchange(var_ct_usuario_debi, var_ct_usuario_debi_md5, var_ct_pass_debi, var_script_case_init, do_ajax_form_del_config_tienda_config_event_ct_usuario_debi_onchange_cb);
  } // do_ajax_form_del_config_tienda_config_event_ct_usuario_debi_onchange

  function do_ajax_form_del_config_tienda_config_event_ct_usuario_debi_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "ct_usuario_debi";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_config_tienda_config_event_ct_usuario_debi_onchange_cb_after_alert);
  } // do_ajax_form_del_config_tienda_config_event_ct_usuario_debi_onchange_cb
  function do_ajax_form_del_config_tienda_config_event_ct_usuario_debi_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_config_tienda_config_event_ct_usuario_debi_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_config_tienda_config_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_config_tienda_config_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_del_config_tienda_config_submit_form(var_ct_empresa, var_ct_convenio_debi, var_ct_url_debi, var_ct_usuario_debi, var_ct_pass_debi, var_ct_url_tienda, var_ct_usuario_tienda, var_ct_pass_tienda, var_ct_estado, var_ct_usuario_debi_md5, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_config_tienda_config_submit_form_cb);
  } // do_ajax_form_del_config_tienda_config_submit_form

  function do_ajax_form_del_config_tienda_config_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_config_tienda_config_submit_form_cb_after_alert);
  } // do_ajax_form_del_config_tienda_config_submit_form_cb
  function do_ajax_form_del_config_tienda_config_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_config_tienda_config_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_config_tienda_config_navigate_form()
  {
    perform_ajax_form_del_config_tienda_config_navigate_form();
  }

  function perform_ajax_form_del_config_tienda_config_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_config_tienda_config_navigate_form(var_ct_empresa, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_config_tienda_config_navigate_form_cb);
  } // do_ajax_form_del_config_tienda_config_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_config_tienda_config']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_config_tienda_config_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_config_tienda_config_navigate_form_cb_after_alert);
  } // do_ajax_form_del_config_tienda_config_navigate_form_cb
  function do_ajax_form_del_config_tienda_config_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_del_config_tienda_config_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_config_tienda_config_navigate_form_cb_after_alert

  function sc_hide_form_del_config_tienda_config_form()
  {
