...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____chart_del_detalle_retencion"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____chart_del_detalle_retencion"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_del_detalle_retencion']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_del_detalle_retencion']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_del_detalle_retencion']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_del_detalle_retencion']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['chart_del_detalle_retencion']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>chart_del_detalle_retencion</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_del_detalle_retencion']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_del_detalle_retencion']['embutida_filho'] as $ind => $sc_init)
          {
