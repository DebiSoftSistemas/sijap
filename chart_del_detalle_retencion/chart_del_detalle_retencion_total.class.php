...
class chart_del_detalle_retencion_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['chart_del_detalle_retencion']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['chart_del_detalle_retencion']['campos_busca']))
      { 
   ...
   function Calc_resumo_sc_free_group_by($destino_resumo, $res_export=false)
   {
      global $nm_lang;
      $this->nm_data = new nm_data("es");
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_detalle_retencion']['sql_tot_res']);
      ...
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_detalle_retencion']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('del_detalle_retencion_dr_fecha_emision_doc_sustento' => "del_detalle_retencion.dr_fecha_emision_doc_sustento",'sri_impuesto_retener_imr_descripcion' => "sri_impuesto_retener.imr_descripcion");
      $cmps_quebra_atual = array();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_detalle_retencion']['SC_Gb_Free_cmp'] as $cmp => $resto)
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_detalle_retencion']['arr_total'] = array();
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_detalle_retencion']['arr_total'][$cmp_gb] = $this->$Arr_tot_name;
      }
   }
   ...
   function Res_Totaliza_sc_free_group_by($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def, $res_export)
   {
      ...
      $cmp_sql_tp_num = array('del_detalle_retencion_dr_id' => 'N','del_detalle_retencion_dr_retencion' => 'N','del_detalle_retencion_dr_impuesto' => 'N','del_detalle_retencion_dr_codigo_retencion' => 'N','del_detalle_retencion_dr_base_imponible' => 'N','del_detalle_retencion_dr_porcentaje_retencion' => 'N','del_detalle_retencion_dr_valor_retenido' => 'N','del_detalle_retencion_dr_secuencia_doc_sustento' => 'N');
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
         $cmd_simp = "select count(*), sum(del_detalle_retencion.dr_valor_retenido)#@#cmps_quebras#@# from " . $this->Ini->nm_tabela . " " . $where_ok;
         $comando  = "select count(*), sum(SC_metric1)#@#cmps_quebras#@# from (";
         $comando .= "select del_detalle_retencion.dr_valor_retenido as SC_metric1, " . $cmps_quebras1 . " from " . $this->Ini->nm_tabela . " " .  $where_ok . ") SC_sel1 INNER JOIN (";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_detalle_retencion']['sql_tot_res']))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_detalle_retencion']['sql_tot_res'] = str_replace("#@#cmps_quebras#@#", "", $comando);
      }
      $comando  = str_replace("#@#cmps_quebras#@#", "," . $cmps_quebras, $comando);
      $comando .= " group by " . $cmps_quebras . " order by " .  $cmps_quebras;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_detalle_retencion']['Res_search_metric_use']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_detalle_retencion']['Res_search_metric_use']))
      {
          $comando = $cmd_simp;
          $cmps_S  = "";
      ...
      $format_dimensions['del_detalle_retencion_dr_fecha_emision_doc_sustento']['reg'] = "N";
      $format_dimensions['del_detalle_retencion_dr_fecha_emision_doc_sustento']['msk'] = "F/Y";
      $format_dimensions['sri_impuesto_retener_imr_descripcion']['reg'] = "S";
      $format_dimensions['sri_impuesto_retener_imr_descripcion']['msk'] = "";
      while (!$rt->EOF)
      {
          $sql_where = "";
          foreach ($Cmp_dim as $Cada_dim => $Ind_sql)
          {
              ...
              if ($Cada_dim == "sri_impuesto_retener_imr_descripcion") {
              }
              if (null === $$Cada_dim)
              {
                  $$Cada_dim = '';
   ...
   {
      global $nada, $nm_lang ;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_detalle_retencion']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_detalle_retencion']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(del_detalle_retencion.dr_valor_retenido) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_detalle_retencion']['where_pesq']; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*), sum(del_detalle_retencion.dr_valor_retenido) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_detalle_retencion']['where_pesq']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_detalle_retencion']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_detalle_retencion']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $rt->fields[1] = (string)$rt->fields[1]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_detalle_retencion']['tot_geral'][2] = $rt->fields[1]; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_detalle_retencion']['contr_total_geral'] = "OK";
   } 

   //-----  del_detalle_retencion_dr_fecha_emision_doc_sustento
   function quebra_del_detalle_retencion_dr_fecha_emision_doc_sustento_sc_free_group_by($del_detalle_retencion_dr_fecha_emision_doc_sustento, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb;
      $tot_del_detalle_retencion_dr_fecha_emision_doc_sustento = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(del_detalle_retencion.dr_valor_retenido) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_detalle_retencion']['where_pesq']; 
      } 
      ...
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_detalle_retencion']['where_pesq'])) 
      { 
      ...
      $tot_del_detalle_retencion_dr_fecha_emision_doc_sustento[0] = NM_encode_input(sc_strip_script($del_detalle_retencion_dr_fecha_emision_doc_sustento)) ; 
      $tot_del_detalle_retencion_dr_fecha_emision_doc_sustento[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_del_detalle_retencion_dr_fecha_emision_doc_sustento[2] = (string)$rt->fields[1]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_del_detalle_retencion_dr_fecha_emision_doc_sustento;
   } 

   //-----  sri_impuesto_retener_imr_descripcion
   function quebra_sri_impuesto_retener_imr_descripcion_sc_free_group_by($sri_impuesto_retener_imr_descripcion, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb;
      $tot_sri_impuesto_retener_imr_descripcion = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(del_detalle_retencion.dr_valor_retenido) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_detalle_retencion']['where_pesq']; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_del_detalle_retencion']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
          $tot_sri_impuesto_retener_imr_descripcion[0] = NM_encode_input(sc_strip_script($sri_impuesto_retener_imr_descripcion));
      }
      else {
          $tot_sri_impuesto_retener_imr_descripcion[0] = sc_strip_script($sri_impuesto_retener_imr_descripcion) ; 
      }
      $tot_sri_impuesto_retener_imr_descripcion[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_sri_impuesto_retener_imr_descripcion[2] = (string)$rt->fields[1]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_sri_impuesto_retener_imr_descripcion;
   } 
