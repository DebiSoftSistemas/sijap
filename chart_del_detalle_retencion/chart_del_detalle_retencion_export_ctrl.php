<?php
@session_start() ;
$_SESSION['scriptcase']['chart_del_detalle_retencion']['sc_process_barr'] = true;
require_once('../chart_del_detalle_retencion/index.php');
unset($_SESSION['scriptcase']['chart_del_detalle_retencion']['sc_process_barr']);
$ExportCtrl = new chart_del_detalle_retencion_export_control;
$ExportCtrl->Export_barr();

class chart_del_detalle_retencion_export_control
{
