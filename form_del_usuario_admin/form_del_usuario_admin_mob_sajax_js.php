  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_usuario_admin_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_usuario_admin_mob_form();
	}
...
?>
  ...
  function do_ajax_form_del_usuario_admin_mob_validate_usu_empresa()
  {
    var nomeCampo_usu_empresa = "usu_empresa";
    var var_usu_empresa = scAjaxGetFieldText(nomeCampo_usu_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_usuario_admin_mob_validate_usu_empresa(var_usu_empresa, var_script_case_init, do_ajax_form_del_usuario_admin_mob_validate_usu_empresa_cb);
  } // do_ajax_form_del_usuario_admin_mob_validate_usu_empresa

  function do_ajax_form_del_usuario_admin_mob_validate_usu_empresa_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_usuario_admin_mob_validate_usu_empresa_cb

  // ---------- Validate usu_usuario
  function do_ajax_form_del_usuario_admin_mob_validate_usu_usuario()
  {
    var nomeCampo_usu_usuario = "usu_usuario";
    var var_usu_usuario = scAjaxGetFieldText(nomeCampo_usu_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_usuario_admin_mob_validate_usu_usuario(var_usu_usuario, var_script_case_init, do_ajax_form_del_usuario_admin_mob_validate_usu_usuario_cb);
  } // do_ajax_form_del_usuario_admin_mob_validate_usu_usuario

  function do_ajax_form_del_usuario_admin_mob_validate_usu_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_usuario_admin_mob_validate_usu_usuario_cb

  // ---------- Validate usu_nombre
  function do_ajax_form_del_usuario_admin_mob_validate_usu_nombre()
  {
    var nomeCampo_usu_nombre = "usu_nombre";
    var var_usu_nombre = scAjaxGetFieldText(nomeCampo_usu_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_usuario_admin_mob_validate_usu_nombre(var_usu_nombre, var_script_case_init, do_ajax_form_del_usuario_admin_mob_validate_usu_nombre_cb);
  } // do_ajax_form_del_usuario_admin_mob_validate_usu_nombre

  function do_ajax_form_del_usuario_admin_mob_validate_usu_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_usuario_admin_mob_validate_usu_nombre_cb

  // ---------- Validate usu_cedula
  function do_ajax_form_del_usuario_admin_mob_validate_usu_cedula()
  {
    var nomeCampo_usu_cedula = "usu_cedula";
    var var_usu_cedula = scAjaxGetFieldText(nomeCampo_usu_cedula);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_usuario_admin_mob_validate_usu_cedula(var_usu_cedula, var_script_case_init, do_ajax_form_del_usuario_admin_mob_validate_usu_cedula_cb);
  } // do_ajax_form_del_usuario_admin_mob_validate_usu_cedula

  function do_ajax_form_del_usuario_admin_mob_validate_usu_cedula_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_usuario_admin_mob_validate_usu_cedula_cb

  // ---------- Validate usu_direccion
  function do_ajax_form_del_usuario_admin_mob_validate_usu_direccion()
  {
    var nomeCampo_usu_direccion = "usu_direccion";
    var var_usu_direccion = scAjaxGetFieldText(nomeCampo_usu_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_usuario_admin_mob_validate_usu_direccion(var_usu_direccion, var_script_case_init, do_ajax_form_del_usuario_admin_mob_validate_usu_direccion_cb);
  } // do_ajax_form_del_usuario_admin_mob_validate_usu_direccion

  function do_ajax_form_del_usuario_admin_mob_validate_usu_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_usuario_admin_mob_validate_usu_direccion_cb

  // ---------- Validate usu_telefono
  function do_ajax_form_del_usuario_admin_mob_validate_usu_telefono()
  {
    var nomeCampo_usu_telefono = "usu_telefono";
    var var_usu_telefono = scAjaxGetFieldText(nomeCampo_usu_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_usuario_admin_mob_validate_usu_telefono(var_usu_telefono, var_script_case_init, do_ajax_form_del_usuario_admin_mob_validate_usu_telefono_cb);
  } // do_ajax_form_del_usuario_admin_mob_validate_usu_telefono

  function do_ajax_form_del_usuario_admin_mob_validate_usu_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_usuario_admin_mob_validate_usu_telefono_cb

  // ---------- Validate usu_email
  function do_ajax_form_del_usuario_admin_mob_validate_usu_email()
  {
    var nomeCampo_usu_email = "usu_email";
    var var_usu_email = scAjaxGetFieldText(nomeCampo_usu_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_usuario_admin_mob_validate_usu_email(var_usu_email, var_script_case_init, do_ajax_form_del_usuario_admin_mob_validate_usu_email_cb);
  } // do_ajax_form_del_usuario_admin_mob_validate_usu_email

  function do_ajax_form_del_usuario_admin_mob_validate_usu_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_usuario_admin_mob_validate_usu_email_cb

  // ---------- Validate usu_estado
  function do_ajax_form_del_usuario_admin_mob_validate_usu_estado()
  {
    var nomeCampo_usu_estado = "usu_estado";
    var var_usu_estado = scAjaxGetFieldSelect(nomeCampo_usu_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_usuario_admin_mob_validate_usu_estado(var_usu_estado, var_script_case_init, do_ajax_form_del_usuario_admin_mob_validate_usu_estado_cb);
  } // do_ajax_form_del_usuario_admin_mob_validate_usu_estado

  function do_ajax_form_del_usuario_admin_mob_validate_usu_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_usuario_admin_mob_validate_usu_estado_cb

  // ---------- Validate usu_ruc_empresa
  function do_ajax_form_del_usuario_admin_mob_validate_usu_ruc_empresa()
  {
    var nomeCampo_usu_ruc_empresa = "usu_ruc_empresa";
    var var_usu_ruc_empresa = scAjaxGetFieldSelect(nomeCampo_usu_ruc_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_usuario_admin_mob_validate_usu_ruc_empresa(var_usu_ruc_empresa, var_script_case_init, do_ajax_form_del_usuario_admin_mob_validate_usu_ruc_empresa_cb);
  } // do_ajax_form_del_usuario_admin_mob_validate_usu_ruc_empresa

  function do_ajax_form_del_usuario_admin_mob_validate_usu_ruc_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_usuario_admin_mob_validate_usu_ruc_empresa_cb

  // ---------- Validate usu_establecimiento_empresa
  function do_ajax_form_del_usuario_admin_mob_validate_usu_establecimiento_empresa()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_usuario_admin_mob_validate_usu_establecimiento_empresa(var_usu_establecimiento_empresa, var_script_case_init, do_ajax_form_del_usuario_admin_mob_validate_usu_establecimiento_empresa_cb);
  } // do_ajax_form_del_usuario_admin_mob_validate_usu_establecimiento_empresa

  function do_ajax_form_del_usuario_admin_mob_validate_usu_establecimiento_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_usuario_admin_mob_validate_usu_establecimiento_empresa_cb

  // ---------- Validate usu_punto_emision
  function do_ajax_form_del_usuario_admin_mob_validate_usu_punto_emision()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_usuario_admin_mob_validate_usu_punto_emision(var_usu_punto_emision, var_script_case_init, do_ajax_form_del_usuario_admin_mob_validate_usu_punto_emision_cb);
  } // do_ajax_form_del_usuario_admin_mob_validate_usu_punto_emision

  function do_ajax_form_del_usuario_admin_mob_validate_usu_punto_emision_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_usuario_admin_mob_validate_usu_punto_emision_cb

  // ---------- Refresh usu_ruc_empresa
  function do_ajax_form_del_usuario_admin_mob_refresh_usu_ruc_empresa()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_del_usuario_admin_mob_refresh_usu_ruc_empresa(var_usu_ruc_empresa, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_del_usuario_admin_mob_refresh_usu_ruc_empresa_cb);
  } // do_ajax_form_del_usuario_admin_mob_refresh_usu_ruc_empresa

  function do_ajax_form_del_usuario_admin_mob_refresh_usu_ruc_empresa_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    do_ajax_form_del_usuario_admin_mob_refresh_usu_establecimiento_empresa();
    scAjaxShowDebug();
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_usuario_admin_mob_refresh_usu_ruc_empresa_cb

  // ---------- Refresh usu_establecimiento_empresa
  function do_ajax_form_del_usuario_admin_mob_refresh_usu_establecimiento_empresa()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_usuario_admin_mob_refresh_usu_establecimiento_empresa(var_usu_establecimiento_empresa, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_del_usuario_admin_mob_refresh_usu_establecimiento_empresa_cb);
  } // do_ajax_form_del_usuario_admin_mob_refresh_usu_establecimiento_empresa

  function do_ajax_form_del_usuario_admin_mob_refresh_usu_establecimiento_empresa_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_usuario_admin_mob_refresh_usu_establecimiento_empresa_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_usuario_admin_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_usuario_admin_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_del_usuario_admin_mob_submit_form(var_usu_empresa, var_usu_usuario, var_usu_nombre, var_usu_cedula, var_usu_direccion, var_usu_telefono, var_usu_email, var_usu_estado, var_usu_ruc_empresa, var_usu_establecimiento_empresa, var_usu_punto_emision, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_usuario_admin_mob_submit_form_cb);
  } // do_ajax_form_del_usuario_admin_mob_submit_form

  function do_ajax_form_del_usuario_admin_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_usuario_admin_mob_submit_form_cb_after_alert);
  } // do_ajax_form_del_usuario_admin_mob_submit_form_cb
  function do_ajax_form_del_usuario_admin_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_usuario_admin_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_usuario_admin_mob_navigate_form()
  {
    perform_ajax_form_del_usuario_admin_mob_navigate_form();
  }

  function perform_ajax_form_del_usuario_admin_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_usuario_admin_mob_navigate_form(var_usu_usuario, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_usuario_admin_mob_navigate_form_cb);
  } // do_ajax_form_del_usuario_admin_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_usuario_admin_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_usuario_admin_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_usuario_admin_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_del_usuario_admin_mob_navigate_form_cb
  function do_ajax_form_del_usuario_admin_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_del_usuario_admin_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_usuario_admin_mob_navigate_form_cb_after_alert

  function sc_hide_form_del_usuario_admin_mob_form()
  {
  ...
  ajax_field_list[8] = "usu_ruc_empresa";
  ajax_field_list[9] = "usu_establecimiento_empresa";
  ajax_field_list[10] = "usu_punto_emision";
