  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_pedido_preparandose" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_pedido_preparandose_form();
	}
...
?>
  ...
  // ---------- Validate titulo
  function do_ajax_form_del_pedido_preparandose_validate_titulo()
  {
    var nomeCampo_titulo = "titulo";
    var var_titulo = scAjaxGetFieldHidden(nomeCampo_titulo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_pedido_preparandose_validate_titulo(var_titulo, var_script_case_init, do_ajax_form_del_pedido_preparandose_validate_titulo_cb);
  } // do_ajax_form_del_pedido_preparandose_validate_titulo

  function do_ajax_form_del_pedido_preparandose_validate_titulo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_pedido_preparandose_validate_titulo_cb

  // ---------- Validate prof_fecha
  function do_ajax_form_del_pedido_preparandose_validate_prof_fecha()
  {
    var nomeCampo_prof_fecha = "prof_fecha";
    var var_prof_fecha = scAjaxGetFieldText(nomeCampo_prof_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_pedido_preparandose_validate_prof_fecha(var_prof_fecha, var_script_case_init, do_ajax_form_del_pedido_preparandose_validate_prof_fecha_cb);
  } // do_ajax_form_del_pedido_preparandose_validate_prof_fecha

  function do_ajax_form_del_pedido_preparandose_validate_prof_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_pedido_preparandose_validate_prof_fecha_cb

  // ---------- Validate prof_establecimiento
  function do_ajax_form_del_pedido_preparandose_validate_prof_establecimiento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_pedido_preparandose_validate_prof_establecimiento(var_prof_establecimiento, var_script_case_init, do_ajax_form_del_pedido_preparandose_validate_prof_establecimiento_cb);
  } // do_ajax_form_del_pedido_preparandose_validate_prof_establecimiento

  function do_ajax_form_del_pedido_preparandose_validate_prof_establecimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_pedido_preparandose_validate_prof_establecimiento_cb

  // ---------- Validate secuencial
  function do_ajax_form_del_pedido_preparandose_validate_secuencial()
  {
    var nomeCampo_secuencial = "secuencial";
    var var_secuencial = scAjaxGetFieldText(nomeCampo_secuencial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_pedido_preparandose_validate_secuencial(var_secuencial, var_script_case_init, do_ajax_form_del_pedido_preparandose_validate_secuencial_cb);
  } // do_ajax_form_del_pedido_preparandose_validate_secuencial

  function do_ajax_form_del_pedido_preparandose_validate_secuencial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_pedido_preparandose_validate_secuencial_cb

  // ---------- Validate prof_tipo_entrega
  function do_ajax_form_del_pedido_preparandose_validate_prof_tipo_entrega()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_pedido_preparandose_validate_prof_tipo_entrega(var_prof_tipo_entrega, var_script_case_init, do_ajax_form_del_pedido_preparandose_validate_prof_tipo_entrega_cb);
  } // do_ajax_form_del_pedido_preparandose_validate_prof_tipo_entrega

  function do_ajax_form_del_pedido_preparandose_validate_prof_tipo_entrega_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_pedido_preparandose_validate_prof_tipo_entrega_cb

  // ---------- Validate prof_secuencial
  function do_ajax_form_del_pedido_preparandose_validate_prof_secuencial()
  {
    var nomeCampo_prof_secuencial = "prof_secuencial";
    var var_prof_secuencial = scAjaxGetFieldHidden(nomeCampo_prof_secuencial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_pedido_preparandose_validate_prof_secuencial(var_prof_secuencial, var_script_case_init, do_ajax_form_del_pedido_preparandose_validate_prof_secuencial_cb);
  } // do_ajax_form_del_pedido_preparandose_validate_prof_secuencial

  function do_ajax_form_del_pedido_preparandose_validate_prof_secuencial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_pedido_preparandose_validate_prof_secuencial_cb

  // ---------- Validate prof_numero
  function do_ajax_form_del_pedido_preparandose_validate_prof_numero()
  {
    var nomeCampo_prof_numero = "prof_numero";
    var var_prof_numero = scAjaxGetFieldText(nomeCampo_prof_numero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_pedido_preparandose_validate_prof_numero(var_prof_numero, var_script_case_init, do_ajax_form_del_pedido_preparandose_validate_prof_numero_cb);
  } // do_ajax_form_del_pedido_preparandose_validate_prof_numero

  function do_ajax_form_del_pedido_preparandose_validate_prof_numero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_pedido_preparandose_validate_prof_numero_cb

  // ---------- Validate prof_code_order
  function do_ajax_form_del_pedido_preparandose_validate_prof_code_order()
  {
    var nomeCampo_prof_code_order = "prof_code_order";
    var var_prof_code_order = scAjaxGetFieldText(nomeCampo_prof_code_order);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_pedido_preparandose_validate_prof_code_order(var_prof_code_order, var_script_case_init, do_ajax_form_del_pedido_preparandose_validate_prof_code_order_cb);
  } // do_ajax_form_del_pedido_preparandose_validate_prof_code_order

  function do_ajax_form_del_pedido_preparandose_validate_prof_code_order_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_pedido_preparandose_validate_prof_code_order_cb

  // ---------- Validate detalles
  function do_ajax_form_del_pedido_preparandose_validate_detalles()
  {
    var nomeCampo_detalles = "detalles";
    var var_detalles = scAjaxGetFieldText(nomeCampo_detalles);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_pedido_preparandose_validate_detalles(var_detalles, var_script_case_init, do_ajax_form_del_pedido_preparandose_validate_detalles_cb);
  } // do_ajax_form_del_pedido_preparandose_validate_detalles

  function do_ajax_form_del_pedido_preparandose_validate_detalles_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_pedido_preparandose_validate_detalles_cb

  // ---------- Event onchange prof_cliente
  function do_ajax_form_del_pedido_preparandose_event_prof_cliente_onchange()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_pedido_preparandose_event_prof_cliente_onchange(var_script_case_init, do_ajax_form_del_pedido_preparandose_event_prof_cliente_onchange_cb);
  } // do_ajax_form_del_pedido_preparandose_event_prof_cliente_onchange

  function do_ajax_form_del_pedido_preparandose_event_prof_cliente_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_pedido_preparandose_event_prof_cliente_onchange_cb_after_alert);
  } // do_ajax_form_del_pedido_preparandose_event_prof_cliente_onchange_cb
  function do_ajax_form_del_pedido_preparandose_event_prof_cliente_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_pedido_preparandose_event_prof_cliente_onchange_cb_after_alert

  // ---------- Event onclick scajaxbutton_solicitar_delivery
  function do_ajax_form_del_pedido_preparandose_event_scajaxbutton_solicitar_delivery_onclick()
  {
    var var_prof_code_order = scAjaxGetFieldText("prof_code_order");
    var var_prof_numero = scAjaxGetFieldText("prof_numero");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_pedido_preparandose_event_scajaxbutton_solicitar_delivery_onclick(var_prof_code_order, var_prof_numero, var_script_case_init, do_ajax_form_del_pedido_preparandose_event_scajaxbutton_solicitar_delivery_onclick_cb);
  } // do_ajax_form_del_pedido_preparandose_event_scajaxbutton_solicitar_delivery_onclick

  function do_ajax_form_del_pedido_preparandose_event_scajaxbutton_solicitar_delivery_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_pedido_preparandose_event_scajaxbutton_solicitar_delivery_onclick_cb_after_alert);
  } // do_ajax_form_del_pedido_preparandose_event_scajaxbutton_solicitar_delivery_onclick_cb
  function do_ajax_form_del_pedido_preparandose_event_scajaxbutton_solicitar_delivery_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_pedido_preparandose_event_scajaxbutton_solicitar_delivery_onclick_cb_after_alert

  // ---------- Event onclick scajaxbutton_asignar_delivery
  function do_ajax_form_del_pedido_preparandose_event_scajaxbutton_asignar_delivery_onclick()
  {
    var var_prof_numero = scAjaxGetFieldText("prof_numero");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_pedido_preparandose_event_scajaxbutton_asignar_delivery_onclick(var_prof_numero, var_script_case_init, do_ajax_form_del_pedido_preparandose_event_scajaxbutton_asignar_delivery_onclick_cb);
  } // do_ajax_form_del_pedido_preparandose_event_scajaxbutton_asignar_delivery_onclick

  function do_ajax_form_del_pedido_preparandose_event_scajaxbutton_asignar_delivery_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_pedido_preparandose_event_scajaxbutton_asignar_delivery_onclick_cb_after_alert);
  } // do_ajax_form_del_pedido_preparandose_event_scajaxbutton_asignar_delivery_onclick_cb
  function do_ajax_form_del_pedido_preparandose_event_scajaxbutton_asignar_delivery_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_pedido_preparandose_event_scajaxbutton_asignar_delivery_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_pedido_preparandose_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_pedido_preparandose_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_del_pedido_preparandose_submit_form(var_titulo, var_prof_fecha, var_prof_establecimiento, var_secuencial, var_prof_tipo_entrega, var_prof_secuencial, var_prof_numero, var_prof_code_order, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_pedido_preparandose_submit_form_cb);
  } // do_ajax_form_del_pedido_preparandose_submit_form

  function do_ajax_form_del_pedido_preparandose_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_pedido_preparandose_submit_form_cb_after_alert);
  } // do_ajax_form_del_pedido_preparandose_submit_form_cb
  function do_ajax_form_del_pedido_preparandose_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_pedido_preparandose_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_del_detalle_pedido"] = "off";

  function do_ajax_form_del_pedido_preparandose_navigate_form()
  {
    perform_ajax_form_del_pedido_preparandose_navigate_form();
  }

  function perform_ajax_form_del_pedido_preparandose_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_del_pedido_preparandose_navigate_form(var_prof_numero, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_pedido_preparandose_navigate_form_cb);
  } // do_ajax_form_del_pedido_preparandose_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_preparandose']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_pedido_preparandose_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_pedido_preparandose_navigate_form_cb_after_alert);
  } // do_ajax_form_del_pedido_preparandose_navigate_form_cb
  function do_ajax_form_del_pedido_preparandose_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_del_pedido_preparandose_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_pedido_preparandose_navigate_form_cb_after_alert

  function sc_hide_form_del_pedido_preparandose_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_del_detalle_pedido"])
    {
      return true;
    }
    return false;
