  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_config_contrasenia_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_config_contrasenia_mob_form();
	}
...
?>
  ...
  function do_ajax_form_del_config_contrasenia_mob_validate_coc_digitos()
  {
    var nomeCampo_coc_digitos = "coc_digitos";
    var var_coc_digitos = scAjaxGetFieldCheckbox(nomeCampo_coc_digitos, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_config_contrasenia_mob_validate_coc_digitos(var_coc_digitos, var_script_case_init, do_ajax_form_del_config_contrasenia_mob_validate_coc_digitos_cb);
  } // do_ajax_form_del_config_contrasenia_mob_validate_coc_digitos

  function do_ajax_form_del_config_contrasenia_mob_validate_coc_digitos_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_config_contrasenia_mob_validate_coc_digitos_cb

  // ---------- Validate coc_especiales
  function do_ajax_form_del_config_contrasenia_mob_validate_coc_especiales()
  {
    var nomeCampo_coc_especiales = "coc_especiales";
    var var_coc_especiales = scAjaxGetFieldCheckbox(nomeCampo_coc_especiales, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_config_contrasenia_mob_validate_coc_especiales(var_coc_especiales, var_script_case_init, do_ajax_form_del_config_contrasenia_mob_validate_coc_especiales_cb);
  } // do_ajax_form_del_config_contrasenia_mob_validate_coc_especiales

  function do_ajax_form_del_config_contrasenia_mob_validate_coc_especiales_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_config_contrasenia_mob_validate_coc_especiales_cb

  // ---------- Validate coc_mayusculas
  function do_ajax_form_del_config_contrasenia_mob_validate_coc_mayusculas()
  {
    var nomeCampo_coc_mayusculas = "coc_mayusculas";
    var var_coc_mayusculas = scAjaxGetFieldCheckbox(nomeCampo_coc_mayusculas, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_config_contrasenia_mob_validate_coc_mayusculas(var_coc_mayusculas, var_script_case_init, do_ajax_form_del_config_contrasenia_mob_validate_coc_mayusculas_cb);
  } // do_ajax_form_del_config_contrasenia_mob_validate_coc_mayusculas

  function do_ajax_form_del_config_contrasenia_mob_validate_coc_mayusculas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_config_contrasenia_mob_validate_coc_mayusculas_cb

  // ---------- Validate coc_minimo_carater
  function do_ajax_form_del_config_contrasenia_mob_validate_coc_minimo_carater()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_config_contrasenia_mob_validate_coc_minimo_carater(var_coc_minimo_carater, var_script_case_init, do_ajax_form_del_config_contrasenia_mob_validate_coc_minimo_carater_cb);
  } // do_ajax_form_del_config_contrasenia_mob_validate_coc_minimo_carater

  function do_ajax_form_del_config_contrasenia_mob_validate_coc_minimo_carater_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_config_contrasenia_mob_validate_coc_minimo_carater_cb

  // ---------- Validate coc_tiempo_validez
  function do_ajax_form_del_config_contrasenia_mob_validate_coc_tiempo_validez()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_config_contrasenia_mob_validate_coc_tiempo_validez(var_coc_tiempo_validez, var_script_case_init, do_ajax_form_del_config_contrasenia_mob_validate_coc_tiempo_validez_cb);
  } // do_ajax_form_del_config_contrasenia_mob_validate_coc_tiempo_validez

  function do_ajax_form_del_config_contrasenia_mob_validate_coc_tiempo_validez_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_config_contrasenia_mob_validate_coc_tiempo_validez_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_config_contrasenia_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_config_contrasenia_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_coc_digitos = scAjaxGetFieldCheckbox("coc_digitos", ";");
    var var_coc_especiales = scAjaxGetFieldCheckbox("coc_especiales", ";");
    var var_coc_mayusculas = scAjaxGetFieldCheckbox("coc_mayusculas", ";");
    ...
    var var_coc_empresa = scAjaxGetFieldText("coc_empresa");
    ...
    scAjaxProcOn();
    x_ajax_form_del_config_contrasenia_mob_submit_form(var_coc_digitos, var_coc_especiales, var_coc_mayusculas, var_coc_minimo_carater, var_coc_tiempo_validez, var_coc_empresa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_config_contrasenia_mob_submit_form_cb);
  } // do_ajax_form_del_config_contrasenia_mob_submit_form

  function do_ajax_form_del_config_contrasenia_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_config_contrasenia_mob_submit_form_cb_after_alert);
  } // do_ajax_form_del_config_contrasenia_mob_submit_form_cb
  function do_ajax_form_del_config_contrasenia_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_config_contrasenia_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_config_contrasenia_mob_navigate_form()
  {
    perform_ajax_form_del_config_contrasenia_mob_navigate_form();
  }

  function perform_ajax_form_del_config_contrasenia_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_del_config_contrasenia_mob_navigate_form(var_coc_empresa, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_config_contrasenia_mob_navigate_form_cb);
  } // do_ajax_form_del_config_contrasenia_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_config_contrasenia_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_config_contrasenia_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_config_contrasenia_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_del_config_contrasenia_mob_navigate_form_cb
  function do_ajax_form_del_config_contrasenia_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_del_config_contrasenia_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_config_contrasenia_mob_navigate_form_cb_after_alert

  function sc_hide_form_del_config_contrasenia_mob_form()
  {
  ...
  ajax_field_list[0] = "coc_digitos";
  ajax_field_list[1] = "coc_especiales";
  ajax_field_list[2] = "coc_mayusculas";
  ajax_field_list[3] = "coc_minimo_carater";
  ajax_field_list[4] = "coc_tiempo_validez";
