  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_rol_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate rol_id
  function do_ajax_form_del_rol_mob_validate_rol_id()
  {
    var nomeCampo_rol_id = "rol_id";
    var var_rol_id = scAjaxGetFieldHidden(nomeCampo_rol_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_rol_mob_validate_rol_id(var_rol_id, var_script_case_init, do_ajax_form_del_rol_mob_validate_rol_id_cb);
  } // do_ajax_form_del_rol_mob_validate_rol_id

  function do_ajax_form_del_rol_mob_validate_rol_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_rol_mob_validate_rol_id_cb

  // ---------- Validate rol_nombre
  function do_ajax_form_del_rol_mob_validate_rol_nombre()
  {
    var nomeCampo_rol_nombre = "rol_nombre";
    var var_rol_nombre = scAjaxGetFieldText(nomeCampo_rol_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_rol_mob_validate_rol_nombre(var_rol_nombre, var_script_case_init, do_ajax_form_del_rol_mob_validate_rol_nombre_cb);
  } // do_ajax_form_del_rol_mob_validate_rol_nombre

  function do_ajax_form_del_rol_mob_validate_rol_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_rol_mob_validate_rol_nombre_cb

  // ---------- Validate rol_estado
  function do_ajax_form_del_rol_mob_validate_rol_estado()
  {
    var nomeCampo_rol_estado = "rol_estado";
    var var_rol_estado = scAjaxGetFieldSelect(nomeCampo_rol_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_rol_mob_validate_rol_estado(var_rol_estado, var_script_case_init, do_ajax_form_del_rol_mob_validate_rol_estado_cb);
  } // do_ajax_form_del_rol_mob_validate_rol_estado

  function do_ajax_form_del_rol_mob_validate_rol_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_rol_mob_validate_rol_estado_cb

  // ---------- Validate rol_empresa
  function do_ajax_form_del_rol_mob_validate_rol_empresa()
  {
    var nomeCampo_rol_empresa = "rol_empresa";
    var var_rol_empresa = scAjaxGetFieldText(nomeCampo_rol_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_rol_mob_validate_rol_empresa(var_rol_empresa, var_script_case_init, do_ajax_form_del_rol_mob_validate_rol_empresa_cb);
  } // do_ajax_form_del_rol_mob_validate_rol_empresa

  function do_ajax_form_del_rol_mob_validate_rol_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "rol_empresa";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_rol_mob_validate_rol_empresa_cb

  // ---------- Validate permisos
  function do_ajax_form_del_rol_mob_validate_permisos()
  {
    var nomeCampo_permisos = "permisos";
    var var_permisos = scAjaxGetFieldText(nomeCampo_permisos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_rol_mob_validate_permisos(var_permisos, var_script_case_init, do_ajax_form_del_rol_mob_validate_permisos_cb);
  } // do_ajax_form_del_rol_mob_validate_permisos

  function do_ajax_form_del_rol_mob_validate_permisos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_rol_mob_validate_permisos_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_rol_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_rol_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_rol_empresa = scAjaxGetFieldText("rol_empresa");
    ...
    scAjaxProcOn();
    x_ajax_form_del_rol_mob_submit_form(var_rol_id, var_rol_nombre, var_rol_estado, var_rol_empresa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_rol_mob_submit_form_cb);
  } // do_ajax_form_del_rol_mob_submit_form

  function do_ajax_form_del_rol_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("rol_empresa");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_rol_mob_submit_form_cb_after_alert);
  } // do_ajax_form_del_rol_mob_submit_form_cb
  function do_ajax_form_del_rol_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_rol_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_v_del_permiso_rol_mob"] = "off";

  function do_ajax_form_del_rol_mob_navigate_form()
  {
    perform_ajax_form_del_rol_mob_navigate_form();
  }

  function perform_ajax_form_del_rol_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_v_del_permiso_rol_mob"] = "on";
    x_ajax_form_del_rol_mob_navigate_form(var_rol_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_rol_mob_navigate_form_cb);
  } // do_ajax_form_del_rol_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_rol_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_rol_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_v_del_permiso_rol_mob"] && "nmsc_iframe_liga_form_v_del_permiso_rol_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_v_del_permiso_rol_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_v_del_permiso_rol_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_v_del_permiso_rol_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_v_del_permiso_rol_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_v_del_permiso_rol_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_rol_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_del_rol_mob_navigate_form_cb
  function do_ajax_form_del_rol_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_del_rol_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_rol_mob_navigate_form_cb_after_alert

  function sc_hide_form_del_rol_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_v_del_permiso_rol_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[3] = "rol_empresa";
  ajax_field_list[4] = "permisos";
  ...
  var ajax_error_list = {
    "rol_id": {"label": "Rol Id", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "rol_empresa": {"label": "Rol Empresa", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "permisos": {"label": "permisos", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
