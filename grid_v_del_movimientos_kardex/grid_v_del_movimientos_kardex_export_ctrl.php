<?php
@session_start() ;
$_SESSION['scriptcase']['grid_v_del_movimientos_kardex']['sc_process_barr'] = true;
require_once('../grid_v_del_movimientos_kardex/index.php');
unset($_SESSION['scriptcase']['grid_v_del_movimientos_kardex']['sc_process_barr']);
$ExportCtrl = new grid_v_del_movimientos_kardex_export_control;
$ExportCtrl->Export_barr();

class grid_v_del_movimientos_kardex_export_control
{
