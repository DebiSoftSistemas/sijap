...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_v_del_movimientos_kardex"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_v_del_movimientos_kardex"]);
   }
