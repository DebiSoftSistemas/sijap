...
$old_error_handler = set_error_handler("form_del_detalle_nota_debito_scriptcase_error_handler");

function form_del_detalle_nota_debito_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['form_del_detalle_nota_debito']['contr_erro']) && $_SESSION['scriptcase']['form_del_detalle_nota_debito']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_del_detalle_nota_debito->contr_form_del_detalle_nota_debito->Apl_com_erro = true;
            if ($inicial_form_del_detalle_nota_debito->contr_form_del_detalle_nota_debito->NM_ajax_flag)
            {
                $inicial_form_del_detalle_nota_debito->contr_form_del_detalle_nota_debito->NM_ajax_info['errList']['geral_form_del_detalle_nota_debito'][] = $msg;
                return;
            }
            form_del_detalle_nota_debito_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_del_detalle_nota_debito_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_del_detalle_nota_debito'])  && '' != $_SESSION['scriptcase']['error_icon']['form_del_detalle_nota_debito'])  ? $_SESSION['scriptcase']['error_icon']['form_del_detalle_nota_debito']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_del_detalle_nota_debito']) && '' != $_SESSION['scriptcase']['error_span_title']['form_del_detalle_nota_debito']) ? $_SESSION['scriptcase']['error_span_title']['form_del_detalle_nota_debito'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_del_detalle_nota_debito']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_del_detalle_nota_debito']) ? $_SESSION['scriptcase']['error_icon_title']['form_del_detalle_nota_debito'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_del_detalle_nota_debito']['error_buffer'] .= ob_get_flush();
}
