  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sri_porcentaje_retencion_impuestos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sri_porcentaje_retencion_impuestos_form();
	}
...
?>
  ...
  // ---------- Validate pri_id_
  function do_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_id_(iNumLinha)
  {
    var nomeCampo_pri_id_ = "pri_id_" + iNumLinha;
    var var_pri_id_ = scAjaxGetFieldHidden(nomeCampo_pri_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_id_(var_pri_id_, iNumLinha, var_script_case_init, do_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_id__cb);
  } // do_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_id_

  function do_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "pri_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pri_id_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "pri_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pri_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_id__cb

  // ---------- Validate pri_impuesto_
  function do_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_impuesto_(iNumLinha)
  {
    var nomeCampo_pri_impuesto_ = "pri_impuesto_" + iNumLinha;
    var var_pri_impuesto_ = scAjaxGetFieldSelect(nomeCampo_pri_impuesto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_impuesto_(var_pri_impuesto_, iNumLinha, var_script_case_init, do_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_impuesto__cb);
  } // do_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_impuesto_

  function do_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_impuesto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "pri_impuesto_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pri_impuesto_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "pri_impuesto_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pri_impuesto_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_impuesto__cb

  // ---------- Validate pri_codigo_
  function do_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_codigo_(iNumLinha)
  {
    var nomeCampo_pri_codigo_ = "pri_codigo_" + iNumLinha;
    var var_pri_codigo_ = scAjaxGetFieldText(nomeCampo_pri_codigo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_codigo_(var_pri_codigo_, iNumLinha, var_script_case_init, do_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_codigo__cb);
  } // do_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_codigo_

  function do_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_codigo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "pri_codigo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pri_codigo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "pri_codigo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pri_codigo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_codigo__cb

  // ---------- Validate pri_descripcion_
  function do_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_descripcion_(iNumLinha)
  {
    var nomeCampo_pri_descripcion_ = "pri_descripcion_" + iNumLinha;
    var var_pri_descripcion_ = scAjaxGetFieldText(nomeCampo_pri_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_descripcion_(var_pri_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_descripcion__cb);
  } // do_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_descripcion_

  function do_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "pri_descripcion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pri_descripcion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "pri_descripcion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pri_descripcion_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_descripcion__cb

  // ---------- Validate pri_porcentaje_
  function do_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_porcentaje_(iNumLinha)
  {
    var nomeCampo_pri_porcentaje_ = "pri_porcentaje_" + iNumLinha;
    var var_pri_porcentaje_ = scAjaxGetFieldText(nomeCampo_pri_porcentaje_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_porcentaje_(var_pri_porcentaje_, iNumLinha, var_script_case_init, do_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_porcentaje__cb);
  } // do_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_porcentaje_

  function do_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_porcentaje__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "pri_porcentaje_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pri_porcentaje_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "pri_porcentaje_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pri_porcentaje_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_porcentaje__cb

  // ---------- Validate pri_estado_
  function do_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_estado_(iNumLinha)
  {
    var nomeCampo_pri_estado_ = "pri_estado_" + iNumLinha;
    var var_pri_estado_ = scAjaxGetFieldSelect(nomeCampo_pri_estado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_estado_(var_pri_estado_, iNumLinha, var_script_case_init, do_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_estado__cb);
  } // do_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_estado_

  function do_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_estado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "pri_estado_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pri_estado_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "pri_estado_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pri_estado_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_estado__cb

  // ---------- Validate pri_editable_
  function do_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_editable_(iNumLinha)
  {
    var nomeCampo_pri_editable_ = "pri_editable_" + iNumLinha;
    var var_pri_editable_ = scAjaxGetFieldSelect(nomeCampo_pri_editable_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_editable_(var_pri_editable_, iNumLinha, var_script_case_init, do_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_editable__cb);
  } // do_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_editable_

  function do_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_editable__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "pri_editable_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pri_editable_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "pri_editable_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pri_editable_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_porcentaje_retencion_impuestos_validate_pri_editable__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_sri_porcentaje_retencion_impuestos_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_sri_porcentaje_retencion_impuestos_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sri_porcentaje_retencion_impuestos_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_sri_porcentaje_retencion_impuestos_add_new_line_cb);
  } // do_ajax_form_sri_porcentaje_retencion_impuestos_add_new_line

  function do_ajax_form_sri_porcentaje_retencion_impuestos_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_sri_porcentaje_retencion_impuestos_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_sri_porcentaje_retencion_impuestos_backup_line(iNumLinha)
  {
    var var_pri_id_ = scAjaxGetFieldHidden("pri_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_porcentaje_retencion_impuestos_backup_line(var_pri_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_sri_porcentaje_retencion_impuestos_backup_line_cb);
  } // do_ajax_form_sri_porcentaje_retencion_impuestos_backup_line

  function do_ajax_form_sri_porcentaje_retencion_impuestos_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_sri_porcentaje_retencion_impuestos_backup_line_cb

  function do_ajax_form_sri_porcentaje_retencion_impuestos_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_sri_porcentaje_retencion_impuestos_cancel_insert

  function do_ajax_form_sri_porcentaje_retencion_impuestos_cancel_update(iSeqVert)
  {
    do_ajax_form_sri_porcentaje_retencion_impuestos_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_sri_porcentaje_retencion_impuestos_cancel_update

  function do_ajax_form_sri_porcentaje_retencion_impuestos_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_sri_porcentaje_retencion_impuestos_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_sri_porcentaje_retencion_impuestos_table_refresh()
  {
    var var_pri_id_ = document.F2.pri_id_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_sri_porcentaje_retencion_impuestos_table_refresh(var_pri_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sri_porcentaje_retencion_impuestos_table_refresh_cb);
  } //  do_ajax_form_sri_porcentaje_retencion_impuestos_table_refresh

  function do_ajax_form_sri_porcentaje_retencion_impuestos_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.pri_id_.value = scAjaxGetKeyValue("pri_id_");
    ...
    scAjaxAlert(do_ajax_form_sri_porcentaje_retencion_impuestos_table_refresh_cb_after_alert);
  } // do_ajax_form_sri_porcentaje_retencion_impuestos_table_refresh_cb
  function do_ajax_form_sri_porcentaje_retencion_impuestos_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_sri_porcentaje_retencion_impuestos_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_sri_porcentaje_retencion_impuestos_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_sri_porcentaje_retencion_impuestos_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_pri_id_ = scAjaxGetFieldHidden("pri_id_" + iNumLinha);
    var var_pri_impuesto_ = scAjaxGetFieldSelect("pri_impuesto_" + iNumLinha);
    var var_pri_codigo_ = scAjaxGetFieldText("pri_codigo_" + iNumLinha);
    var var_pri_descripcion_ = scAjaxGetFieldText("pri_descripcion_" + iNumLinha);
    var var_pri_porcentaje_ = scAjaxGetFieldText("pri_porcentaje_" + iNumLinha);
    var var_pri_estado_ = scAjaxGetFieldSelect("pri_estado_" + iNumLinha);
    var var_pri_editable_ = scAjaxGetFieldSelect("pri_editable_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_sri_porcentaje_retencion_impuestos_submit_form(var_pri_id_, var_pri_impuesto_, var_pri_codigo_, var_pri_descripcion_, var_pri_porcentaje_, var_pri_estado_, var_pri_editable_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sri_porcentaje_retencion_impuestos_submit_form_cb);
  } // do_ajax_form_sri_porcentaje_retencion_impuestos_submit_form

  function do_ajax_form_sri_porcentaje_retencion_impuestos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("pri_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("pri_impuesto_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("pri_codigo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("pri_descripcion_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("pri_porcentaje_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("pri_estado_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("pri_editable_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sri_porcentaje_retencion_impuestos_submit_form_cb_after_alert);
  } // do_ajax_form_sri_porcentaje_retencion_impuestos_submit_form_cb
  function do_ajax_form_sri_porcentaje_retencion_impuestos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sri_porcentaje_retencion_impuestos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sri_porcentaje_retencion_impuestos_navigate_form()
  {
    perform_ajax_form_sri_porcentaje_retencion_impuestos_navigate_form();
  }

  function perform_ajax_form_sri_porcentaje_retencion_impuestos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_sri_porcentaje_retencion_impuestos_cancel_insert(sc_form_sri_porcentaje_retencion_impuestos_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("pri_id_" + iNavForm);
      scAjaxHideErrorDisplay("pri_impuesto_" + iNavForm);
      scAjaxHideErrorDisplay("pri_codigo_" + iNavForm);
      scAjaxHideErrorDisplay("pri_descripcion_" + iNavForm);
      scAjaxHideErrorDisplay("pri_porcentaje_" + iNavForm);
      scAjaxHideErrorDisplay("pri_estado_" + iNavForm);
      scAjaxHideErrorDisplay("pri_editable_" + iNavForm);
    }
    var var_pri_id_ = document.F2.pri_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sri_porcentaje_retencion_impuestos_navigate_form(var_pri_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sri_porcentaje_retencion_impuestos_navigate_form_cb);
  } // do_ajax_form_sri_porcentaje_retencion_impuestos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sri_porcentaje_retencion_impuestos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sri_porcentaje_retencion_impuestos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.pri_id_.value = scAjaxGetKeyValue("pri_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sri_porcentaje_retencion_impuestos_navigate_form_cb_after_alert);
  } // do_ajax_form_sri_porcentaje_retencion_impuestos_navigate_form_cb
  function do_ajax_form_sri_porcentaje_retencion_impuestos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_sri_porcentaje_retencion_impuestos_navigate_form_cb_after_alert

    function sc_form_sri_porcentaje_retencion_impuestos_get_last_line_number()
    {
    ...
    } //sc_form_sri_porcentaje_retencion_impuestos_get_last_line_number

  function sc_hide_form_sri_porcentaje_retencion_impuestos_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "pri_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pri_impuesto_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pri_codigo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pri_descripcion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pri_porcentaje_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pri_estado_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pri_editable_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["pri_id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pri_impuesto_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_impuesto'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pri_codigo_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_codigo'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pri_descripcion_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_descripcion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pri_porcentaje_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_porcentaje_retencion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pri_estado_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pri_editable_" + iNumLinha] = {"label": "Editable<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["pri_id_"][iNumLinha] = "pri_id_" + iNumLinha;
    ajax_field_mult["pri_impuesto_"][iNumLinha] = "pri_impuesto_" + iNumLinha;
    ajax_field_mult["pri_codigo_"][iNumLinha] = "pri_codigo_" + iNumLinha;
    ajax_field_mult["pri_descripcion_"][iNumLinha] = "pri_descripcion_" + iNumLinha;
    ajax_field_mult["pri_porcentaje_"][iNumLinha] = "pri_porcentaje_" + iNumLinha;
    ajax_field_mult["pri_estado_"][iNumLinha] = "pri_estado_" + iNumLinha;
    ajax_field_mult["pri_editable_"][iNumLinha] = "pri_editable_" + iNumLinha;
    ajax_field_id["pri_impuesto_" + iNumLinha] = new Array("hidden_field_label_pri_impuesto_", "hidden_field_data_pri_impuesto_" + iNumLinha);
    ajax_field_id["pri_codigo_" + iNumLinha] = new Array("hidden_field_label_pri_codigo_", "hidden_field_data_pri_codigo_" + iNumLinha);
    ajax_field_id["pri_descripcion_" + iNumLinha] = new Array("hidden_field_label_pri_descripcion_", "hidden_field_data_pri_descripcion_" + iNumLinha);
    ajax_field_id["pri_porcentaje_" + iNumLinha] = new Array("hidden_field_label_pri_porcentaje_", "hidden_field_data_pri_porcentaje_" + iNumLinha);
    ajax_field_id["pri_estado_" + iNumLinha] = new Array("hidden_field_label_pri_estado_", "hidden_field_data_pri_estado_" + iNumLinha);
    ajax_field_id["pri_editable_" + iNumLinha] = new Array("hidden_field_label_pri_editable_", "hidden_field_data_pri_editable_" + iNumLinha);
    ajax_error_count["pri_id_" + iNumLinha] = "off";
    ajax_error_count["pri_impuesto_" + iNumLinha] = "off";
    ajax_error_count["pri_codigo_" + iNumLinha] = "off";
    ajax_error_count["pri_descripcion_" + iNumLinha] = "off";
    ajax_error_count["pri_porcentaje_" + iNumLinha] = "off";
    ajax_error_count["pri_estado_" + iNumLinha] = "off";
    ajax_error_count["pri_editable_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["pri_id_" + iNumLinha] = "on";
    ajax_read_only["pri_impuesto_" + iNumLinha] = "off";
    ajax_read_only["pri_codigo_" + iNumLinha] = "off";
    ajax_read_only["pri_descripcion_" + iNumLinha] = "off";
    ajax_read_only["pri_porcentaje_" + iNumLinha] = "off";
    ajax_read_only["pri_estado_" + iNumLinha] = "off";
    ajax_read_only["pri_editable_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["pri_id_" + iNumLinha] = "on";
    ajax_read_only["pri_impuesto_" + iNumLinha] = "on";
    ajax_read_only["pri_codigo_" + iNumLinha] = "on";
    ajax_read_only["pri_descripcion_" + iNumLinha] = "on";
    ajax_read_only["pri_porcentaje_" + iNumLinha] = "on";
    ajax_read_only["pri_estado_" + iNumLinha] = "on";
    ajax_read_only["pri_editable_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["pri_id_" + iNumLinha] = null;
    ajax_error_list["pri_impuesto_" + iNumLinha] = null;
    ajax_error_list["pri_codigo_" + iNumLinha] = null;
    ajax_error_list["pri_descripcion_" + iNumLinha] = null;
    ajax_error_list["pri_porcentaje_" + iNumLinha] = null;
    ajax_error_list["pri_estado_" + iNumLinha] = null;
    ajax_error_list["pri_editable_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "pri_id_": new Array(),
    "pri_impuesto_": new Array(),
    "pri_codigo_": new Array(),
    "pri_descripcion_": new Array(),
    "pri_porcentaje_": new Array(),
    "pri_estado_": new Array(),
    "pri_editable_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["pri_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pri_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pri_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pri_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pri_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["pri_impuesto_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pri_impuesto_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pri_impuesto_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pri_impuesto_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pri_impuesto_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["pri_codigo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pri_codigo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pri_codigo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pri_codigo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pri_codigo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["pri_descripcion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pri_descripcion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pri_descripcion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pri_descripcion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pri_descripcion_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["pri_porcentaje_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pri_porcentaje_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pri_porcentaje_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pri_porcentaje_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pri_porcentaje_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["pri_estado_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pri_estado_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pri_estado_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pri_estado_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pri_estado_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["pri_editable_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pri_editable_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pri_editable_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pri_editable_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pri_editable_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pri_id_'])) ? $this->nmgp_cmp_readonly['pri_id_'] : 'on';
?>
    scAjaxFieldRead("pri_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pri_impuesto_'])) ? $this->nmgp_cmp_readonly['pri_impuesto_'] : 'off';
?>
    scAjaxFieldRead("pri_impuesto_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pri_codigo_'])) ? $this->nmgp_cmp_readonly['pri_codigo_'] : 'off';
?>
    scAjaxFieldRead("pri_codigo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pri_descripcion_'])) ? $this->nmgp_cmp_readonly['pri_descripcion_'] : 'off';
?>
    scAjaxFieldRead("pri_descripcion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pri_porcentaje_'])) ? $this->nmgp_cmp_readonly['pri_porcentaje_'] : 'off';
?>
    scAjaxFieldRead("pri_porcentaje_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pri_estado_'])) ? $this->nmgp_cmp_readonly['pri_estado_'] : 'off';
?>
    scAjaxFieldRead("pri_estado_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pri_editable_'])) ? $this->nmgp_cmp_readonly['pri_editable_'] : 'off';
?>
    scAjaxFieldRead("pri_editable_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("pri_id_" + iSeq, "on");
    scAjaxFieldRead("pri_impuesto_" + iSeq, "on");
    scAjaxFieldRead("pri_codigo_" + iSeq, "on");
    scAjaxFieldRead("pri_descripcion_" + iSeq, "on");
    scAjaxFieldRead("pri_porcentaje_" + iSeq, "on");
    scAjaxFieldRead("pri_estado_" + iSeq, "on");
    scAjaxFieldRead("pri_editable_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["pri_id_" + iRow] || "on" == ajax_error_count["pri_impuesto_" + iRow] || "on" == ajax_error_count["pri_codigo_" + iRow] || "on" == ajax_error_count["pri_descripcion_" + iRow] || "on" == ajax_error_count["pri_porcentaje_" + iRow] || "on" == ajax_error_count["pri_estado_" + iRow] || "on" == ajax_error_count["pri_editable_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pri_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pri_impuesto_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pri_codigo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pri_descripcion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pri_porcentaje_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pri_estado_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pri_editable_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["pri_id_" + iRow] && "off" == ajax_error_count["pri_impuesto_" + iRow] && "off" == ajax_error_count["pri_codigo_" + iRow] && "off" == ajax_error_count["pri_descripcion_" + iRow] && "off" == ajax_error_count["pri_porcentaje_" + iRow] && "off" == ajax_error_count["pri_estado_" + iRow] && "off" == ajax_error_count["pri_editable_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["pri_id_" + iRow] = "off";
        ajax_error_count["pri_impuesto_" + iRow] = "off";
        ajax_error_count["pri_codigo_" + iRow] = "off";
        ajax_error_count["pri_descripcion_" + iRow] = "off";
        ajax_error_count["pri_porcentaje_" + iRow] = "off";
        ajax_error_count["pri_estado_" + iRow] = "off";
        ajax_error_count["pri_editable_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_pri_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_pri_impuesto_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_pri_codigo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_pri_descripcion_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_pri_porcentaje_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_pri_estado_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_pri_editable_" + iRow).removeClass("scFormErrorLine");
    }
  }
