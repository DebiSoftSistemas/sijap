...
<?php
   ...
   $Ord_Cmp = new grid_facturas_credito_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_facturas_credito_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_facturas_credito']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_facturas_credito']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["fac_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturas_credito']['labels']["fac_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturas_credito']['labels']["fac_fecha"] : "" . $this->Nm_lang['lang_fecha'] . "";
   $tab_ger_campos['factura'] = "on";
   $tab_def_campos['factura'] = "factura";
   $tab_labels["factura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturas_credito']['labels']["factura"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturas_credito']['labels']["factura"] : "" . $this->Nm_lang['lang_factura'] . "";
   $tab_ger_campos['fac_cliente'] = "on";
   $tab_def_campos['fac_cliente'] = "fac_cliente";
   $tab_labels["fac_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturas_credito']['labels']["fac_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturas_credito']['labels']["fac_cliente"] : "" . $this->Nm_lang['lang_cliente'] . "";
   $tab_ger_campos['fac_comentario'] = "on";
   $tab_def_campos['fac_comentario'] = "fac_comentario";
   $tab_labels["fac_comentario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturas_credito']['labels']["fac_comentario"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturas_credito']['labels']["fac_comentario"] : "" . $this->Nm_lang['lang_comentario'] . "";
   $tab_ger_campos['fp_valor'] = "on";
   $tab_def_campos['fp_valor'] = "fp_valor";
   $tab_labels["fp_valor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturas_credito']['labels']["fp_valor"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturas_credito']['labels']["fp_valor"] : "" . $this->Nm_lang['lang_monto_inicial'] . "";
   $tab_ger_campos['fp_valor_pago'] = "on";
   $tab_def_campos['fp_valor_pago'] = "fp_valor_pago";
   $tab_labels["fp_valor_pago"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturas_credito']['labels']["fp_valor_pago"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturas_credito']['labels']["fp_valor_pago"] : "" . $this->Nm_lang['lang_valor_pagado'] . "";
   $tab_ger_campos['fp_saldo'] = "on";
   $tab_def_campos['fp_saldo'] = "fp_saldo";
   $tab_labels["fp_saldo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturas_credito']['labels']["fp_saldo"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturas_credito']['labels']["fp_saldo"] : "" . $this->Nm_lang['lang_saldo'] . "";
   ...
   $tab_labels["pagos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturas_credito']['labels']["pagos"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturas_credito']['labels']["pagos"] : "" . $this->Nm_lang['lang_pago'] . "s";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_facturas_credito']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_facturas_credito']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_facturas_credito']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_facturas_credito']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_facturas_credito']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_facturas_credito']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_facturas_credito']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_facturas_credito']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_facturas_credito']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_facturas_credito']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_facturas_credito']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_facturas_credito']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_facturas_credito_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_facturas_credito']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_facturas_credito']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_facturas_credito']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_facturas_credito']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_facturas_credito']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
