...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>control_nueva_venta/control_nueva_venta_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("control_nueva_venta_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('control_nueva_venta_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['link_info']['remove_border']) {
...
<?php
 include_once("control_nueva_venta_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_nueva_venta'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_nueva_venta'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['empty_filter'] = true;
       }
  }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fac_fecha_label" id="hidden_field_label_fac_fecha" style="<?php echo $sStyleHidden_fac_fecha; ?>"><span id="id_label_fac_fecha"><?php echo $this->nm_new_label['fac_fecha']; ?></span></TD>
    <TD class="scFormDataOdd css_fac_fecha_line" id="hidden_field_data_fac_fecha" style="<?php echo $sStyleHidden_fac_fecha; ?>"><input type="hidden" name="fac_fecha" value="<?php echo $this->form_encode_input($fac_fecha); ?>"><span id="id_ajax_label_fac_fecha"><?php echo nl2br($fac_fecha); ?></span>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fac_secuencial_line" id="hidden_field_data_fac_secuencial" style="<?php echo $sStyleHidden_fac_secuencial; ?>"><input type="hidden" name="fac_secuencial" value="<?php echo $this->form_encode_input($fac_secuencial); ?>"><span id="id_ajax_label_fac_secuencial"><?php echo nl2br($fac_secuencial); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fac_moneda_label" id="hidden_field_label_fac_moneda" style="<?php echo $sStyleHidden_fac_moneda; ?>"><span id="id_label_fac_moneda"><?php echo $this->nm_new_label['fac_moneda']; ?></span></TD>
    <TD class="scFormDataOdd css_fac_moneda_line" id="hidden_field_data_fac_moneda" style="<?php echo $sStyleHidden_fac_moneda; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fac_serie_guia_label" id="hidden_field_label_fac_serie_guia" style="<?php echo $sStyleHidden_fac_serie_guia; ?>"><span id="id_label_fac_serie_guia"><?php echo $this->nm_new_label['fac_serie_guia']; ?></span></TD>
    <TD class="scFormDataOdd css_fac_serie_guia_line" id="hidden_field_data_fac_serie_guia" style="<?php echo $sStyleHidden_fac_serie_guia; ?>">
...
<span id="id_read_on_fac_serie_guia" class="sc-ui-readonly-fac_serie_guia css_fac_serie_guia_line" style="<?php echo $sStyleReadLab_fac_serie_guia; ?>"><?php echo $this->form_format_readonly("fac_serie_guia", $this->form_encode_input($this->fac_serie_guia)); ?></span><span id="id_read_off_fac_serie_guia" class="css_read_off_fac_serie_guia<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_fac_serie_guia; ?>">
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=17"; } ?> maxlength=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '<?php echo $this->allowedCharsCharset("0123456789-") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '001-001-000000001', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</TD>
   <?php }?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['btn_disabled']['ok']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['btn_disabled']['ok']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['btn_label']['ok']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['btn_label']['ok']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['btn_label']['ok'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['btn_label']['help'];
        }
?>
...
<?php
    if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['nm_run_menu'] != 1))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['btn_label']['exit'];
        }
?>
...
<?php
    if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("control_nueva_venta");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("control_nueva_venta");
 parent.scAjaxDetailHeight("control_nueva_venta", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
