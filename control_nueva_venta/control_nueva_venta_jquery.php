...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_fac_fecha' + iSeqRow).bind('blur', function() { sc_control_nueva_venta_fac_fecha_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_control_nueva_venta_fac_fecha_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_control_nueva_venta_fac_fecha_onfocus(this, iSeqRow) });
  $('#id_sc_field_fac_libretin' + iSeqRow).bind('blur', function() { sc_control_nueva_venta_fac_libretin_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_control_nueva_venta_fac_libretin_onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_control_nueva_venta_fac_libretin_onfocus(this, iSeqRow) });
  $('#id_sc_field_fac_secuencial' + iSeqRow).bind('blur', function() { sc_control_nueva_venta_fac_secuencial_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_control_nueva_venta_fac_secuencial_onchange(this, iSeqRow) })
                                            .bind('focus', function() { sc_control_nueva_venta_fac_secuencial_onfocus(this, iSeqRow) });
  $('#id_sc_field_fac_moneda' + iSeqRow).bind('blur', function() { sc_control_nueva_venta_fac_moneda_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_control_nueva_venta_fac_moneda_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_control_nueva_venta_fac_moneda_onfocus(this, iSeqRow) });
  $('#id_sc_field_fac_serie_guia' + iSeqRow).bind('blur', function() { sc_control_nueva_venta_fac_serie_guia_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_control_nueva_venta_fac_serie_guia_onchange(this, iSeqRow) })
                                            .bind('focus', function() { sc_control_nueva_venta_fac_serie_guia_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_control_nueva_venta_fac_fecha_onblur(oThis, iSeqRow) {
  do_ajax_control_nueva_venta_validate_fac_fecha();
  scCssBlur(oThis);
}

function sc_control_nueva_venta_fac_fecha_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_control_nueva_venta_fac_fecha_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_control_nueva_venta_fac_libretin_onblur(oThis, iSeqRow) {
  do_ajax_control_nueva_venta_validate_fac_libretin();
  scCssBlur(oThis);
}

function sc_control_nueva_venta_fac_libretin_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_control_nueva_venta_event_fac_libretin_onchange();
}

function sc_control_nueva_venta_fac_libretin_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_control_nueva_venta_fac_secuencial_onblur(oThis, iSeqRow) {
  do_ajax_control_nueva_venta_validate_fac_secuencial();
  scCssBlur(oThis);
}

function sc_control_nueva_venta_fac_secuencial_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_control_nueva_venta_fac_secuencial_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_control_nueva_venta_fac_moneda_onblur(oThis, iSeqRow) {
  do_ajax_control_nueva_venta_validate_fac_moneda();
  scCssBlur(oThis);
}

function sc_control_nueva_venta_fac_moneda_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_control_nueva_venta_fac_moneda_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_control_nueva_venta_fac_serie_guia_onblur(oThis, iSeqRow) {
  do_ajax_control_nueva_venta_validate_fac_serie_guia();
  scCssBlur(oThis);
}

function sc_control_nueva_venta_fac_serie_guia_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_control_nueva_venta_fac_serie_guia_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_control_nueva_venta_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'control_nueva_venta')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
