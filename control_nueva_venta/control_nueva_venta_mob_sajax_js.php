  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_nueva_venta_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_nueva_venta_mob_form();
	}
...
?>
  ...
  // ---------- Validate fac_fecha
  function do_ajax_control_nueva_venta_mob_validate_fac_fecha()
  {
    var nomeCampo_fac_fecha = "fac_fecha";
    var var_fac_fecha = scAjaxGetFieldHidden(nomeCampo_fac_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_nueva_venta_mob_validate_fac_fecha(var_fac_fecha, var_script_case_init, do_ajax_control_nueva_venta_mob_validate_fac_fecha_cb);
  } // do_ajax_control_nueva_venta_mob_validate_fac_fecha

  function do_ajax_control_nueva_venta_mob_validate_fac_fecha_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_nueva_venta_mob_validate_fac_fecha_cb

  // ---------- Validate fac_libretin
  function do_ajax_control_nueva_venta_mob_validate_fac_libretin()
  {
    var nomeCampo_fac_libretin = "fac_libretin";
    var var_fac_libretin = scAjaxGetFieldSelect(nomeCampo_fac_libretin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_nueva_venta_mob_validate_fac_libretin(var_fac_libretin, var_script_case_init, do_ajax_control_nueva_venta_mob_validate_fac_libretin_cb);
  } // do_ajax_control_nueva_venta_mob_validate_fac_libretin

  function do_ajax_control_nueva_venta_mob_validate_fac_libretin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_nueva_venta_mob_validate_fac_libretin_cb

  // ---------- Validate fac_secuencial
  function do_ajax_control_nueva_venta_mob_validate_fac_secuencial()
  {
    var nomeCampo_fac_secuencial = "fac_secuencial";
    var var_fac_secuencial = scAjaxGetFieldHidden(nomeCampo_fac_secuencial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_nueva_venta_mob_validate_fac_secuencial(var_fac_secuencial, var_script_case_init, do_ajax_control_nueva_venta_mob_validate_fac_secuencial_cb);
  } // do_ajax_control_nueva_venta_mob_validate_fac_secuencial

  function do_ajax_control_nueva_venta_mob_validate_fac_secuencial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_nueva_venta_mob_validate_fac_secuencial_cb

  // ---------- Validate fac_moneda
  function do_ajax_control_nueva_venta_mob_validate_fac_moneda()
  {
    var nomeCampo_fac_moneda = "fac_moneda";
    var var_fac_moneda = scAjaxGetFieldSelect(nomeCampo_fac_moneda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_nueva_venta_mob_validate_fac_moneda(var_fac_moneda, var_script_case_init, do_ajax_control_nueva_venta_mob_validate_fac_moneda_cb);
  } // do_ajax_control_nueva_venta_mob_validate_fac_moneda

  function do_ajax_control_nueva_venta_mob_validate_fac_moneda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_nueva_venta_mob_validate_fac_moneda_cb

  // ---------- Validate fac_serie_guia
  function do_ajax_control_nueva_venta_mob_validate_fac_serie_guia()
  {
    var nomeCampo_fac_serie_guia = "fac_serie_guia";
    var var_fac_serie_guia = scAjaxGetFieldText(nomeCampo_fac_serie_guia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_nueva_venta_mob_validate_fac_serie_guia(var_fac_serie_guia, var_script_case_init, do_ajax_control_nueva_venta_mob_validate_fac_serie_guia_cb);
  } // do_ajax_control_nueva_venta_mob_validate_fac_serie_guia

  function do_ajax_control_nueva_venta_mob_validate_fac_serie_guia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_nueva_venta_mob_validate_fac_serie_guia_cb

  // ---------- Event onchange fac_libretin
  function do_ajax_control_nueva_venta_mob_event_fac_libretin_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_control_nueva_venta_mob_event_fac_libretin_onchange(var_fac_libretin, var_fac_secuencial, var_script_case_init, do_ajax_control_nueva_venta_mob_event_fac_libretin_onchange_cb);
  } // do_ajax_control_nueva_venta_mob_event_fac_libretin_onchange

  function do_ajax_control_nueva_venta_mob_event_fac_libretin_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "fac_libretin";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_control_nueva_venta_mob_event_fac_libretin_onchange_cb_after_alert);
  } // do_ajax_control_nueva_venta_mob_event_fac_libretin_onchange_cb
  function do_ajax_control_nueva_venta_mob_event_fac_libretin_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_control_nueva_venta_mob_event_fac_libretin_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_nueva_venta_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_nueva_venta_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_fac_fecha = scAjaxGetFieldHidden("fac_fecha");
    var var_fac_libretin = scAjaxGetFieldSelect("fac_libretin");
    var var_fac_secuencial = scAjaxGetFieldHidden("fac_secuencial");
    ...
    scAjaxProcOn();
    x_ajax_control_nueva_venta_mob_submit_form(var_fac_fecha, var_fac_libretin, var_fac_secuencial, var_fac_moneda, var_fac_serie_guia, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_nueva_venta_mob_submit_form_cb);
  } // do_ajax_control_nueva_venta_mob_submit_form

  function do_ajax_control_nueva_venta_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_nueva_venta_mob_submit_form_cb_after_alert);
  } // do_ajax_control_nueva_venta_mob_submit_form_cb
  function do_ajax_control_nueva_venta_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_nueva_venta_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_nueva_venta_mob_navigate_form()
  {
    perform_ajax_control_nueva_venta_mob_navigate_form();
  }

  function perform_ajax_control_nueva_venta_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_nueva_venta_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_venta_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_nueva_venta_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_nueva_venta_mob_navigate_form_cb_after_alert);
  } // do_ajax_control_nueva_venta_mob_navigate_form_cb
  function do_ajax_control_nueva_venta_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_nueva_venta_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_nueva_venta_mob_navigate_form_cb_after_alert

  function sc_hide_control_nueva_venta_mob_form()
  {
  ...
  ajax_field_list[2] = "fac_secuencial";
  ajax_field_list[3] = "fac_moneda";
