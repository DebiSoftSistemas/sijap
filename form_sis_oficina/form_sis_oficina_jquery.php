...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_ofi_id' + iSeqRow).bind('change', function() { sc_form_sis_oficina_ofi_id_onchange(this, iSeqRow) });
  ...
  $('#id_sc_field_ofi_nombre' + iSeqRow).bind('blur', function() { sc_form_sis_oficina_ofi_nombre_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_sis_oficina_ofi_nombre_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_ofi_representante' + iSeqRow).bind('blur', function() { sc_form_sis_oficina_ofi_representante_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_form_sis_oficina_ofi_representante_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_ofi_serie_sri' + iSeqRow).bind('blur', function() { sc_form_sis_oficina_ofi_serie_sri_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_sis_oficina_ofi_serie_sri_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_ofi_ciudad' + iSeqRow).bind('blur', function() { sc_form_sis_oficina_ofi_ciudad_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_sis_oficina_ofi_ciudad_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_ofi_sector' + iSeqRow).bind('blur', function() { sc_form_sis_oficina_ofi_sector_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_sis_oficina_ofi_sector_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_ofi_calle_principal' + iSeqRow).bind('blur', function() { sc_form_sis_oficina_ofi_calle_principal_onblur(this, iSeqRow) })
                                                 .bind('change', function() { sc_form_sis_oficina_ofi_calle_principal_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_ofi_numero' + iSeqRow).bind('blur', function() { sc_form_sis_oficina_ofi_numero_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_sis_oficina_ofi_numero_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_ofi_calle_secundaria' + iSeqRow).bind('blur', function() { sc_form_sis_oficina_ofi_calle_secundaria_onblur(this, iSeqRow) })
                                                  .bind('change', function() { sc_form_sis_oficina_ofi_calle_secundaria_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_ofi_referencia' + iSeqRow).bind('blur', function() { sc_form_sis_oficina_ofi_referencia_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_sis_oficina_ofi_referencia_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_ofi_sucursal' + iSeqRow).bind('blur', function() { sc_form_sis_oficina_ofi_sucursal_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_sis_oficina_ofi_sucursal_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_ofi_estado' + iSeqRow).bind('blur', function() { sc_form_sis_oficina_ofi_estado_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_sis_oficina_ofi_estado_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_sis_oficina_ofi_estado_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_sis_oficina_ofi_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_sis_oficina_ofi_nombre_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_sis_oficina_ofi_representante_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_sis_oficina_ofi_serie_sri_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_sis_oficina_ofi_ciudad_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_sis_oficina_ofi_sector_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_sis_oficina_ofi_calle_principal_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_sis_oficina_ofi_numero_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_sis_oficina_ofi_calle_secundaria_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_sis_oficina_ofi_referencia_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_sis_oficina_ofi_sucursal_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_sis_oficina_ofi_estado_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_form_sis_oficina_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_sis_oficina')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
