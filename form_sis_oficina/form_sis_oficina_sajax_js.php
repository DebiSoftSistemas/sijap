  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_oficina" == sTestField)
        {
...
?>
  ...
  // ---------- Validate ofi_filial
  function do_ajax_form_sis_oficina_validate_ofi_filial()
  {
    var nomeCampo_ofi_filial = "ofi_filial";
    var var_ofi_filial = scAjaxGetFieldSelect(nomeCampo_ofi_filial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_oficina_validate_ofi_filial(var_ofi_filial, var_script_case_init, do_ajax_form_sis_oficina_validate_ofi_filial_cb);
  } // do_ajax_form_sis_oficina_validate_ofi_filial

  function do_ajax_form_sis_oficina_validate_ofi_filial_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_oficina_validate_ofi_filial_cb

  // ---------- Validate ofi_sucursal
  function do_ajax_form_sis_oficina_validate_ofi_sucursal()
  {
    var nomeCampo_ofi_sucursal = "ofi_sucursal";
    var var_ofi_sucursal = scAjaxGetFieldSelect(nomeCampo_ofi_sucursal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_oficina_validate_ofi_sucursal(var_ofi_sucursal, var_script_case_init, do_ajax_form_sis_oficina_validate_ofi_sucursal_cb);
  } // do_ajax_form_sis_oficina_validate_ofi_sucursal

  function do_ajax_form_sis_oficina_validate_ofi_sucursal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_oficina_validate_ofi_sucursal_cb

  // ---------- Validate ofi_nombre
  function do_ajax_form_sis_oficina_validate_ofi_nombre()
  {
    var nomeCampo_ofi_nombre = "ofi_nombre";
    var var_ofi_nombre = scAjaxGetFieldText(nomeCampo_ofi_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_oficina_validate_ofi_nombre(var_ofi_nombre, var_script_case_init, do_ajax_form_sis_oficina_validate_ofi_nombre_cb);
  } // do_ajax_form_sis_oficina_validate_ofi_nombre

  function do_ajax_form_sis_oficina_validate_ofi_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_oficina_validate_ofi_nombre_cb

  // ---------- Validate ofi_representante
  function do_ajax_form_sis_oficina_validate_ofi_representante()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_oficina_validate_ofi_representante(var_ofi_representante, var_script_case_init, do_ajax_form_sis_oficina_validate_ofi_representante_cb);
  } // do_ajax_form_sis_oficina_validate_ofi_representante

  function do_ajax_form_sis_oficina_validate_ofi_representante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_oficina_validate_ofi_representante_cb

  // ---------- Validate ofi_serie_sri
  function do_ajax_form_sis_oficina_validate_ofi_serie_sri()
  {
    var nomeCampo_ofi_serie_sri = "ofi_serie_sri";
    var var_ofi_serie_sri = scAjaxGetFieldText(nomeCampo_ofi_serie_sri);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_oficina_validate_ofi_serie_sri(var_ofi_serie_sri, var_script_case_init, do_ajax_form_sis_oficina_validate_ofi_serie_sri_cb);
  } // do_ajax_form_sis_oficina_validate_ofi_serie_sri

  function do_ajax_form_sis_oficina_validate_ofi_serie_sri_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_oficina_validate_ofi_serie_sri_cb

  // ---------- Validate ofi_estado
  function do_ajax_form_sis_oficina_validate_ofi_estado()
  {
    var nomeCampo_ofi_estado = "ofi_estado";
    var var_ofi_estado = scAjaxGetFieldSelect(nomeCampo_ofi_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_oficina_validate_ofi_estado(var_ofi_estado, var_script_case_init, do_ajax_form_sis_oficina_validate_ofi_estado_cb);
  } // do_ajax_form_sis_oficina_validate_ofi_estado

  function do_ajax_form_sis_oficina_validate_ofi_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_oficina_validate_ofi_estado_cb

  // ---------- Validate ofi_pais
  function do_ajax_form_sis_oficina_validate_ofi_pais()
  {
    var nomeCampo_ofi_pais = "ofi_pais";
    var var_ofi_pais = scAjaxGetFieldSelect(nomeCampo_ofi_pais);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_oficina_validate_ofi_pais(var_ofi_pais, var_script_case_init, do_ajax_form_sis_oficina_validate_ofi_pais_cb);
  } // do_ajax_form_sis_oficina_validate_ofi_pais

  function do_ajax_form_sis_oficina_validate_ofi_pais_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_oficina_validate_ofi_pais_cb

  // ---------- Validate ofi_provincia
  function do_ajax_form_sis_oficina_validate_ofi_provincia()
  {
    var nomeCampo_ofi_provincia = "ofi_provincia";
    var var_ofi_provincia = scAjaxGetFieldSelect(nomeCampo_ofi_provincia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_oficina_validate_ofi_provincia(var_ofi_provincia, var_script_case_init, do_ajax_form_sis_oficina_validate_ofi_provincia_cb);
  } // do_ajax_form_sis_oficina_validate_ofi_provincia

  function do_ajax_form_sis_oficina_validate_ofi_provincia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_oficina_validate_ofi_provincia_cb

  // ---------- Validate ofi_ciudad
  function do_ajax_form_sis_oficina_validate_ofi_ciudad()
  {
    var nomeCampo_ofi_ciudad = "ofi_ciudad";
    var var_ofi_ciudad = scAjaxGetFieldSelect(nomeCampo_ofi_ciudad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_oficina_validate_ofi_ciudad(var_ofi_ciudad, var_script_case_init, do_ajax_form_sis_oficina_validate_ofi_ciudad_cb);
  } // do_ajax_form_sis_oficina_validate_ofi_ciudad

  function do_ajax_form_sis_oficina_validate_ofi_ciudad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_oficina_validate_ofi_ciudad_cb

  // ---------- Validate ofi_sector
  function do_ajax_form_sis_oficina_validate_ofi_sector()
  {
    var nomeCampo_ofi_sector = "ofi_sector";
    var var_ofi_sector = scAjaxGetFieldText(nomeCampo_ofi_sector);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_oficina_validate_ofi_sector(var_ofi_sector, var_script_case_init, do_ajax_form_sis_oficina_validate_ofi_sector_cb);
  } // do_ajax_form_sis_oficina_validate_ofi_sector

  function do_ajax_form_sis_oficina_validate_ofi_sector_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_oficina_validate_ofi_sector_cb

  // ---------- Validate ofi_calle_principal
  function do_ajax_form_sis_oficina_validate_ofi_calle_principal()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_oficina_validate_ofi_calle_principal(var_ofi_calle_principal, var_script_case_init, do_ajax_form_sis_oficina_validate_ofi_calle_principal_cb);
  } // do_ajax_form_sis_oficina_validate_ofi_calle_principal

  function do_ajax_form_sis_oficina_validate_ofi_calle_principal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_oficina_validate_ofi_calle_principal_cb

  // ---------- Validate ofi_numero
  function do_ajax_form_sis_oficina_validate_ofi_numero()
  {
    var nomeCampo_ofi_numero = "ofi_numero";
    var var_ofi_numero = scAjaxGetFieldText(nomeCampo_ofi_numero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_oficina_validate_ofi_numero(var_ofi_numero, var_script_case_init, do_ajax_form_sis_oficina_validate_ofi_numero_cb);
  } // do_ajax_form_sis_oficina_validate_ofi_numero

  function do_ajax_form_sis_oficina_validate_ofi_numero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_oficina_validate_ofi_numero_cb

  // ---------- Validate ofi_calle_secundaria
  function do_ajax_form_sis_oficina_validate_ofi_calle_secundaria()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_oficina_validate_ofi_calle_secundaria(var_ofi_calle_secundaria, var_script_case_init, do_ajax_form_sis_oficina_validate_ofi_calle_secundaria_cb);
  } // do_ajax_form_sis_oficina_validate_ofi_calle_secundaria

  function do_ajax_form_sis_oficina_validate_ofi_calle_secundaria_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_oficina_validate_ofi_calle_secundaria_cb

  // ---------- Validate ofi_referencia
  function do_ajax_form_sis_oficina_validate_ofi_referencia()
  {
    var nomeCampo_ofi_referencia = "ofi_referencia";
    var var_ofi_referencia = scAjaxGetFieldText(nomeCampo_ofi_referencia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_oficina_validate_ofi_referencia(var_ofi_referencia, var_script_case_init, do_ajax_form_sis_oficina_validate_ofi_referencia_cb);
  } // do_ajax_form_sis_oficina_validate_ofi_referencia

  function do_ajax_form_sis_oficina_validate_ofi_referencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_oficina_validate_ofi_referencia_cb

  // ---------- Refresh ofi_filial
  function do_ajax_form_sis_oficina_refresh_ofi_filial()
  {
    var var_ofi_filial = scAjaxGetFieldSelect("ofi_filial");
    var var_nmgp_refresh_fields = "ofi_sucursal";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sis_oficina_refresh_ofi_filial(var_ofi_filial, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_sis_oficina_refresh_ofi_filial_cb);
  } // do_ajax_form_sis_oficina_refresh_ofi_filial

  function do_ajax_form_sis_oficina_refresh_ofi_filial_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_oficina_refresh_ofi_filial_cb

  // ---------- Refresh ofi_pais
  function do_ajax_form_sis_oficina_refresh_ofi_pais()
  {
    var var_ofi_pais = scAjaxGetFieldSelect("ofi_pais");
    var var_nmgp_refresh_fields = "ofi_provincia";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sis_oficina_refresh_ofi_pais(var_ofi_pais, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_sis_oficina_refresh_ofi_pais_cb);
  } // do_ajax_form_sis_oficina_refresh_ofi_pais

  function do_ajax_form_sis_oficina_refresh_ofi_pais_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
    do_ajax_form_sis_oficina_refresh_ofi_provincia();
    scAjaxShowDebug();
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_oficina_refresh_ofi_pais_cb

  // ---------- Refresh ofi_provincia
  function do_ajax_form_sis_oficina_refresh_ofi_provincia()
  {
    var var_ofi_provincia = scAjaxGetFieldSelect("ofi_provincia");
    var var_nmgp_refresh_fields = "ofi_ciudad";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sis_oficina_refresh_ofi_provincia(var_ofi_provincia, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_sis_oficina_refresh_ofi_provincia_cb);
  } // do_ajax_form_sis_oficina_refresh_ofi_provincia

  function do_ajax_form_sis_oficina_refresh_ofi_provincia_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_oficina_refresh_ofi_provincia_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_sis_oficina_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_sis_oficina_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_ofi_filial = scAjaxGetFieldSelect("ofi_filial");
    ...
    scAjaxProcOn();
    x_ajax_form_sis_oficina_submit_form(var_ofi_filial, var_ofi_sucursal, var_ofi_nombre, var_ofi_representante, var_ofi_serie_sri, var_ofi_estado, var_ofi_pais, var_ofi_provincia, var_ofi_ciudad, var_ofi_sector, var_ofi_calle_principal, var_ofi_numero, var_ofi_calle_secundaria, var_ofi_referencia, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_oficina_submit_form_cb);
  } // do_ajax_form_sis_oficina_submit_form

  function do_ajax_form_sis_oficina_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_sis_oficina_submit_form_cb_after_alert);
  } // do_ajax_form_sis_oficina_submit_form_cb
  function do_ajax_form_sis_oficina_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_oficina_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sis_oficina_navigate_form()
  {
    perform_ajax_form_sis_oficina_navigate_form();
  }

  function perform_ajax_form_sis_oficina_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sis_oficina_navigate_form(var_ofi_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_oficina_navigate_form_cb);
  } // do_ajax_form_sis_oficina_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_oficina']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_oficina_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_oficina_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_oficina_navigate_form_cb
  function do_ajax_form_sis_oficina_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_sis_oficina_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_sis_oficina_navigate_form_cb_after_alert

  function sc_hide_form_sis_oficina_form()
  {
