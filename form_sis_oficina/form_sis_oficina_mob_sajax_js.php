  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_oficina_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sis_oficina_mob_form();
	}
...
?>
  ...
  // ---------- Validate ofi_filial
  function do_ajax_form_sis_oficina_mob_validate_ofi_filial()
  {
    var nomeCampo_ofi_filial = "ofi_filial";
    var var_ofi_filial = scAjaxGetFieldSelect(nomeCampo_ofi_filial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_oficina_mob_validate_ofi_filial(var_ofi_filial, var_script_case_init, do_ajax_form_sis_oficina_mob_validate_ofi_filial_cb);
  } // do_ajax_form_sis_oficina_mob_validate_ofi_filial

  function do_ajax_form_sis_oficina_mob_validate_ofi_filial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ofi_filial";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_oficina_mob_validate_ofi_filial_cb

  // ---------- Validate ofi_sucursal
  function do_ajax_form_sis_oficina_mob_validate_ofi_sucursal()
  {
    var nomeCampo_ofi_sucursal = "ofi_sucursal";
    var var_ofi_sucursal = scAjaxGetFieldSelect(nomeCampo_ofi_sucursal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_oficina_mob_validate_ofi_sucursal(var_ofi_sucursal, var_script_case_init, do_ajax_form_sis_oficina_mob_validate_ofi_sucursal_cb);
  } // do_ajax_form_sis_oficina_mob_validate_ofi_sucursal

  function do_ajax_form_sis_oficina_mob_validate_ofi_sucursal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ofi_sucursal";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_oficina_mob_validate_ofi_sucursal_cb

  // ---------- Validate ofi_nombre
  function do_ajax_form_sis_oficina_mob_validate_ofi_nombre()
  {
    var nomeCampo_ofi_nombre = "ofi_nombre";
    var var_ofi_nombre = scAjaxGetFieldText(nomeCampo_ofi_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_oficina_mob_validate_ofi_nombre(var_ofi_nombre, var_script_case_init, do_ajax_form_sis_oficina_mob_validate_ofi_nombre_cb);
  } // do_ajax_form_sis_oficina_mob_validate_ofi_nombre

  function do_ajax_form_sis_oficina_mob_validate_ofi_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ofi_nombre";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_oficina_mob_validate_ofi_nombre_cb

  // ---------- Validate ofi_representante
  function do_ajax_form_sis_oficina_mob_validate_ofi_representante()
  {
    var nomeCampo_ofi_representante = "ofi_representante";
    var var_ofi_representante = scAjaxGetFieldText(nomeCampo_ofi_representante);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_oficina_mob_validate_ofi_representante(var_ofi_representante, var_script_case_init, do_ajax_form_sis_oficina_mob_validate_ofi_representante_cb);
  } // do_ajax_form_sis_oficina_mob_validate_ofi_representante

  function do_ajax_form_sis_oficina_mob_validate_ofi_representante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ofi_representante";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_oficina_mob_validate_ofi_representante_cb

  // ---------- Validate ofi_serie_sri
  function do_ajax_form_sis_oficina_mob_validate_ofi_serie_sri()
  {
    var nomeCampo_ofi_serie_sri = "ofi_serie_sri";
    var var_ofi_serie_sri = scAjaxGetFieldText(nomeCampo_ofi_serie_sri);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_oficina_mob_validate_ofi_serie_sri(var_ofi_serie_sri, var_script_case_init, do_ajax_form_sis_oficina_mob_validate_ofi_serie_sri_cb);
  } // do_ajax_form_sis_oficina_mob_validate_ofi_serie_sri

  function do_ajax_form_sis_oficina_mob_validate_ofi_serie_sri_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ofi_serie_sri";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_oficina_mob_validate_ofi_serie_sri_cb

  // ---------- Validate ofi_estado
  function do_ajax_form_sis_oficina_mob_validate_ofi_estado()
  {
    var nomeCampo_ofi_estado = "ofi_estado";
    var var_ofi_estado = scAjaxGetFieldSelect(nomeCampo_ofi_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_oficina_mob_validate_ofi_estado(var_ofi_estado, var_script_case_init, do_ajax_form_sis_oficina_mob_validate_ofi_estado_cb);
  } // do_ajax_form_sis_oficina_mob_validate_ofi_estado

  function do_ajax_form_sis_oficina_mob_validate_ofi_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ofi_estado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_oficina_mob_validate_ofi_estado_cb

  // ---------- Validate ofi_pais
  function do_ajax_form_sis_oficina_mob_validate_ofi_pais()
  {
    var nomeCampo_ofi_pais = "ofi_pais";
    var var_ofi_pais = scAjaxGetFieldSelect(nomeCampo_ofi_pais);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_oficina_mob_validate_ofi_pais(var_ofi_pais, var_script_case_init, do_ajax_form_sis_oficina_mob_validate_ofi_pais_cb);
  } // do_ajax_form_sis_oficina_mob_validate_ofi_pais

  function do_ajax_form_sis_oficina_mob_validate_ofi_pais_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ofi_pais";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_oficina_mob_validate_ofi_pais_cb

  // ---------- Validate ofi_provincia
  function do_ajax_form_sis_oficina_mob_validate_ofi_provincia()
  {
    var nomeCampo_ofi_provincia = "ofi_provincia";
    var var_ofi_provincia = scAjaxGetFieldSelect(nomeCampo_ofi_provincia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_oficina_mob_validate_ofi_provincia(var_ofi_provincia, var_script_case_init, do_ajax_form_sis_oficina_mob_validate_ofi_provincia_cb);
  } // do_ajax_form_sis_oficina_mob_validate_ofi_provincia

  function do_ajax_form_sis_oficina_mob_validate_ofi_provincia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ofi_provincia";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_oficina_mob_validate_ofi_provincia_cb

  // ---------- Validate ofi_ciudad
  function do_ajax_form_sis_oficina_mob_validate_ofi_ciudad()
  {
    var nomeCampo_ofi_ciudad = "ofi_ciudad";
    var var_ofi_ciudad = scAjaxGetFieldSelect(nomeCampo_ofi_ciudad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_oficina_mob_validate_ofi_ciudad(var_ofi_ciudad, var_script_case_init, do_ajax_form_sis_oficina_mob_validate_ofi_ciudad_cb);
  } // do_ajax_form_sis_oficina_mob_validate_ofi_ciudad

  function do_ajax_form_sis_oficina_mob_validate_ofi_ciudad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ofi_ciudad";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_oficina_mob_validate_ofi_ciudad_cb

  // ---------- Validate ofi_sector
  function do_ajax_form_sis_oficina_mob_validate_ofi_sector()
  {
    var nomeCampo_ofi_sector = "ofi_sector";
    var var_ofi_sector = scAjaxGetFieldText(nomeCampo_ofi_sector);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_oficina_mob_validate_ofi_sector(var_ofi_sector, var_script_case_init, do_ajax_form_sis_oficina_mob_validate_ofi_sector_cb);
  } // do_ajax_form_sis_oficina_mob_validate_ofi_sector

  function do_ajax_form_sis_oficina_mob_validate_ofi_sector_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ofi_sector";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_oficina_mob_validate_ofi_sector_cb

  // ---------- Validate ofi_calle_principal
  function do_ajax_form_sis_oficina_mob_validate_ofi_calle_principal()
  {
    var nomeCampo_ofi_calle_principal = "ofi_calle_principal";
    var var_ofi_calle_principal = scAjaxGetFieldText(nomeCampo_ofi_calle_principal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_oficina_mob_validate_ofi_calle_principal(var_ofi_calle_principal, var_script_case_init, do_ajax_form_sis_oficina_mob_validate_ofi_calle_principal_cb);
  } // do_ajax_form_sis_oficina_mob_validate_ofi_calle_principal

  function do_ajax_form_sis_oficina_mob_validate_ofi_calle_principal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ofi_calle_principal";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_oficina_mob_validate_ofi_calle_principal_cb

  // ---------- Validate ofi_numero
  function do_ajax_form_sis_oficina_mob_validate_ofi_numero()
  {
    var nomeCampo_ofi_numero = "ofi_numero";
    var var_ofi_numero = scAjaxGetFieldText(nomeCampo_ofi_numero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_oficina_mob_validate_ofi_numero(var_ofi_numero, var_script_case_init, do_ajax_form_sis_oficina_mob_validate_ofi_numero_cb);
  } // do_ajax_form_sis_oficina_mob_validate_ofi_numero

  function do_ajax_form_sis_oficina_mob_validate_ofi_numero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ofi_numero";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_oficina_mob_validate_ofi_numero_cb

  // ---------- Validate ofi_calle_secundaria
  function do_ajax_form_sis_oficina_mob_validate_ofi_calle_secundaria()
  {
    var nomeCampo_ofi_calle_secundaria = "ofi_calle_secundaria";
    var var_ofi_calle_secundaria = scAjaxGetFieldText(nomeCampo_ofi_calle_secundaria);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_oficina_mob_validate_ofi_calle_secundaria(var_ofi_calle_secundaria, var_script_case_init, do_ajax_form_sis_oficina_mob_validate_ofi_calle_secundaria_cb);
  } // do_ajax_form_sis_oficina_mob_validate_ofi_calle_secundaria

  function do_ajax_form_sis_oficina_mob_validate_ofi_calle_secundaria_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ofi_calle_secundaria";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_oficina_mob_validate_ofi_calle_secundaria_cb

  // ---------- Validate ofi_referencia
  function do_ajax_form_sis_oficina_mob_validate_ofi_referencia()
  {
    var nomeCampo_ofi_referencia = "ofi_referencia";
    var var_ofi_referencia = scAjaxGetFieldText(nomeCampo_ofi_referencia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_oficina_mob_validate_ofi_referencia(var_ofi_referencia, var_script_case_init, do_ajax_form_sis_oficina_mob_validate_ofi_referencia_cb);
  } // do_ajax_form_sis_oficina_mob_validate_ofi_referencia

  function do_ajax_form_sis_oficina_mob_validate_ofi_referencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ofi_referencia";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_oficina_mob_validate_ofi_referencia_cb

  // ---------- Refresh ofi_filial
  function do_ajax_form_sis_oficina_mob_refresh_ofi_filial()
  {
    var var_ofi_filial = scAjaxGetFieldSelect("ofi_filial");
    var var_nmgp_refresh_fields = "ofi_sucursal";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sis_oficina_mob_refresh_ofi_filial(var_ofi_filial, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_sis_oficina_mob_refresh_ofi_filial_cb);
  } // do_ajax_form_sis_oficina_mob_refresh_ofi_filial

  function do_ajax_form_sis_oficina_mob_refresh_ofi_filial_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_oficina_mob_refresh_ofi_filial_cb

  // ---------- Refresh ofi_pais
  function do_ajax_form_sis_oficina_mob_refresh_ofi_pais()
  {
    var var_ofi_pais = scAjaxGetFieldSelect("ofi_pais");
    var var_nmgp_refresh_fields = "ofi_provincia";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sis_oficina_mob_refresh_ofi_pais(var_ofi_pais, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_sis_oficina_mob_refresh_ofi_pais_cb);
  } // do_ajax_form_sis_oficina_mob_refresh_ofi_pais

  function do_ajax_form_sis_oficina_mob_refresh_ofi_pais_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_oficina_mob_refresh_ofi_pais_cb

  // ---------- Refresh ofi_provincia
  function do_ajax_form_sis_oficina_mob_refresh_ofi_provincia()
  {
    var var_ofi_provincia = scAjaxGetFieldSelect("ofi_provincia");
    var var_nmgp_refresh_fields = "ofi_ciudad";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sis_oficina_mob_refresh_ofi_provincia(var_ofi_provincia, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_sis_oficina_mob_refresh_ofi_provincia_cb);
  } // do_ajax_form_sis_oficina_mob_refresh_ofi_provincia

  function do_ajax_form_sis_oficina_mob_refresh_ofi_provincia_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_oficina_mob_refresh_ofi_provincia_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_sis_oficina_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_sis_oficina_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_ofi_filial = scAjaxGetFieldSelect("ofi_filial");
    var var_ofi_sucursal = scAjaxGetFieldSelect("ofi_sucursal");
    var var_ofi_nombre = scAjaxGetFieldText("ofi_nombre");
    var var_ofi_representante = scAjaxGetFieldText("ofi_representante");
    var var_ofi_serie_sri = scAjaxGetFieldText("ofi_serie_sri");
    var var_ofi_estado = scAjaxGetFieldSelect("ofi_estado");
    var var_ofi_pais = scAjaxGetFieldSelect("ofi_pais");
    var var_ofi_provincia = scAjaxGetFieldSelect("ofi_provincia");
    var var_ofi_ciudad = scAjaxGetFieldSelect("ofi_ciudad");
    var var_ofi_sector = scAjaxGetFieldText("ofi_sector");
    var var_ofi_calle_principal = scAjaxGetFieldText("ofi_calle_principal");
    var var_ofi_numero = scAjaxGetFieldText("ofi_numero");
    var var_ofi_calle_secundaria = scAjaxGetFieldText("ofi_calle_secundaria");
    var var_ofi_referencia = scAjaxGetFieldText("ofi_referencia");
    var var_ofi_id = scAjaxGetFieldText("ofi_id");
    ...
    scAjaxProcOn();
    x_ajax_form_sis_oficina_mob_submit_form(var_ofi_filial, var_ofi_sucursal, var_ofi_nombre, var_ofi_representante, var_ofi_serie_sri, var_ofi_estado, var_ofi_pais, var_ofi_provincia, var_ofi_ciudad, var_ofi_sector, var_ofi_calle_principal, var_ofi_numero, var_ofi_calle_secundaria, var_ofi_referencia, var_ofi_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_oficina_mob_submit_form_cb);
  } // do_ajax_form_sis_oficina_mob_submit_form

  function do_ajax_form_sis_oficina_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("ofi_filial");
      scAjaxHideErrorDisplay("ofi_sucursal");
      scAjaxHideErrorDisplay("ofi_nombre");
      scAjaxHideErrorDisplay("ofi_representante");
      scAjaxHideErrorDisplay("ofi_serie_sri");
      scAjaxHideErrorDisplay("ofi_estado");
      scAjaxHideErrorDisplay("ofi_pais");
      scAjaxHideErrorDisplay("ofi_provincia");
      scAjaxHideErrorDisplay("ofi_ciudad");
      scAjaxHideErrorDisplay("ofi_sector");
      scAjaxHideErrorDisplay("ofi_calle_principal");
      scAjaxHideErrorDisplay("ofi_numero");
      scAjaxHideErrorDisplay("ofi_calle_secundaria");
      scAjaxHideErrorDisplay("ofi_referencia");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_sis_oficina_mob_submit_form_cb_after_alert);
  } // do_ajax_form_sis_oficina_mob_submit_form_cb
  function do_ajax_form_sis_oficina_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_oficina_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sis_oficina_mob_navigate_form()
  {
    perform_ajax_form_sis_oficina_mob_navigate_form();
  }

  function perform_ajax_form_sis_oficina_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("ofi_calle_secundaria");
    scAjaxHideErrorDisplay("ofi_referencia");
    var var_ofi_id = document.F2.ofi_id.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sis_oficina_mob_navigate_form(var_ofi_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_oficina_mob_navigate_form_cb);
  } // do_ajax_form_sis_oficina_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_oficina_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_oficina_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.ofi_id.value = scAjaxGetKeyValue("ofi_id");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_oficina_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_oficina_mob_navigate_form_cb
  function do_ajax_form_sis_oficina_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_sis_oficina_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_sis_oficina_mob_navigate_form_cb_after_alert

  function sc_hide_form_sis_oficina_mob_form()
  {
  ...
  ajax_field_list[0] = "ofi_filial";
  ajax_field_list[1] = "ofi_sucursal";
  ajax_field_list[2] = "ofi_nombre";
  ajax_field_list[3] = "ofi_representante";
  ajax_field_list[4] = "ofi_serie_sri";
  ajax_field_list[5] = "ofi_estado";
  ajax_field_list[6] = "ofi_pais";
  ajax_field_list[7] = "ofi_provincia";
  ajax_field_list[8] = "ofi_ciudad";
  ajax_field_list[9] = "ofi_sector";
  ajax_field_list[10] = "ofi_calle_principal";
  ajax_field_list[11] = "ofi_numero";
  ajax_field_list[12] = "ofi_calle_secundaria";
  ajax_field_list[13] = "ofi_referencia";
  ...
  var ajax_error_list = {
    "ofi_filial": {"label": "<?php echo $this->Ini->Nm_lang['lang_filial'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ofi_sucursal": {"label": "<?php echo $this->Ini->Nm_lang['lang_sucursal'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ofi_nombre": {"label": "<?php echo $this->Ini->Nm_lang['lang_oficina'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ofi_representante": {"label": "<?php echo $this->Ini->Nm_lang['lang_representante'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ofi_serie_sri": {"label": "<?php echo $this->Ini->Nm_lang['lang_serie_sri'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ofi_estado": {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ofi_pais": {"label": "<?php echo $this->Ini->Nm_lang['lang_pais'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ofi_provincia": {"label": "<?php echo $this->Ini->Nm_lang['lang_provincia'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ofi_ciudad": {"label": "<?php echo $this->Ini->Nm_lang['lang_ciudad'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ofi_sector": {"label": "<?php echo $this->Ini->Nm_lang['lang_sector'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ofi_calle_principal": {"label": "<?php echo $this->Ini->Nm_lang['lang_calle_principal'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ofi_numero": {"label": "<?php echo $this->Ini->Nm_lang['lang_numero'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ofi_calle_secundaria": {"label": "<?php echo $this->Ini->Nm_lang['lang_calle_secundaria'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ofi_referencia": {"label": "<?php echo $this->Ini->Nm_lang['lang_referencia'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "ofi_filial": new Array(),
    "ofi_sucursal": new Array(),
    "ofi_nombre": new Array(),
    "ofi_representante": new Array(),
    "ofi_serie_sri": new Array(),
    "ofi_estado": new Array(),
    "ofi_pais": new Array(),
    "ofi_provincia": new Array(),
    "ofi_ciudad": new Array(),
    "ofi_sector": new Array(),
    "ofi_calle_principal": new Array(),
    "ofi_numero": new Array(),
    "ofi_calle_secundaria": new Array(),
    "ofi_referencia": new Array()
  };
  ajax_field_mult["ofi_filial"][1] = "ofi_filial";
  ajax_field_mult["ofi_sucursal"][1] = "ofi_sucursal";
  ajax_field_mult["ofi_nombre"][1] = "ofi_nombre";
  ajax_field_mult["ofi_representante"][1] = "ofi_representante";
  ajax_field_mult["ofi_serie_sri"][1] = "ofi_serie_sri";
  ajax_field_mult["ofi_estado"][1] = "ofi_estado";
  ajax_field_mult["ofi_pais"][1] = "ofi_pais";
  ajax_field_mult["ofi_provincia"][1] = "ofi_provincia";
  ajax_field_mult["ofi_ciudad"][1] = "ofi_ciudad";
  ajax_field_mult["ofi_sector"][1] = "ofi_sector";
  ajax_field_mult["ofi_calle_principal"][1] = "ofi_calle_principal";
  ajax_field_mult["ofi_numero"][1] = "ofi_numero";
  ajax_field_mult["ofi_calle_secundaria"][1] = "ofi_calle_secundaria";
  ajax_field_mult["ofi_referencia"][1] = "ofi_referencia";

  var ajax_field_id = {
    "ofi_filial": new Array("hidden_field_label_ofi_filial", "hidden_field_data_ofi_filial"),
    "ofi_sucursal": new Array("hidden_field_label_ofi_sucursal", "hidden_field_data_ofi_sucursal"),
    "ofi_nombre": new Array("hidden_field_label_ofi_nombre", "hidden_field_data_ofi_nombre"),
    "ofi_representante": new Array("hidden_field_label_ofi_representante", "hidden_field_data_ofi_representante"),
    "ofi_serie_sri": new Array("hidden_field_label_ofi_serie_sri", "hidden_field_data_ofi_serie_sri"),
    "ofi_estado": new Array("hidden_field_label_ofi_estado", "hidden_field_data_ofi_estado"),
    "ofi_pais": new Array("hidden_field_label_ofi_pais", "hidden_field_data_ofi_pais"),
    "ofi_provincia": new Array("hidden_field_label_ofi_provincia", "hidden_field_data_ofi_provincia"),
    "ofi_ciudad": new Array("hidden_field_label_ofi_ciudad", "hidden_field_data_ofi_ciudad"),
    "ofi_sector": new Array("hidden_field_label_ofi_sector", "hidden_field_data_ofi_sector"),
    "ofi_calle_principal": new Array("hidden_field_label_ofi_calle_principal", "hidden_field_data_ofi_calle_principal"),
    "ofi_numero": new Array("hidden_field_label_ofi_numero", "hidden_field_data_ofi_numero"),
    "ofi_calle_secundaria": new Array("hidden_field_label_ofi_calle_secundaria", "hidden_field_data_ofi_calle_secundaria"),
    "ofi_referencia": new Array("hidden_field_label_ofi_referencia", "hidden_field_data_ofi_referencia")
  };
  ...
  var ajax_read_only = {
    ...
    "ofi_ciudad": "off",
    "ofi_sector": "off",
    "ofi_calle_principal": "off",
    "ofi_numero": "off",
    "ofi_calle_secundaria": "off",
    "ofi_referencia": "off"
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("ofi_calle_secundaria" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
