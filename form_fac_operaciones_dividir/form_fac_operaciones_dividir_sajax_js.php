  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_fac_operaciones_dividir" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_fac_operaciones_dividir_form();
	}
...
?>
  ...
  // ---------- Validate od_id_
  function do_ajax_form_fac_operaciones_dividir_validate_od_id_(iNumLinha)
  {
    var nomeCampo_od_id_ = "od_id_" + iNumLinha;
    var var_od_id_ = scAjaxGetFieldHidden(nomeCampo_od_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operaciones_dividir_validate_od_id_(var_od_id_, iNumLinha, var_script_case_init, do_ajax_form_fac_operaciones_dividir_validate_od_id__cb);
  } // do_ajax_form_fac_operaciones_dividir_validate_od_id_

  function do_ajax_form_fac_operaciones_dividir_validate_od_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "od_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "od_id_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "od_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "od_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operaciones_dividir_validate_od_id__cb

  // ---------- Validate od_solicitud_
  function do_ajax_form_fac_operaciones_dividir_validate_od_solicitud_(iNumLinha)
  {
    var nomeCampo_od_solicitud_ = "od_solicitud_" + iNumLinha;
    var var_od_solicitud_ = scAjaxGetFieldText(nomeCampo_od_solicitud_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operaciones_dividir_validate_od_solicitud_(var_od_solicitud_, iNumLinha, var_script_case_init, do_ajax_form_fac_operaciones_dividir_validate_od_solicitud__cb);
  } // do_ajax_form_fac_operaciones_dividir_validate_od_solicitud_

  function do_ajax_form_fac_operaciones_dividir_validate_od_solicitud__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "od_solicitud_" + iLineNumber;
    }
    else
    {
      sFieldValid = "od_solicitud_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "od_solicitud_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "od_solicitud_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operaciones_dividir_validate_od_solicitud__cb

  // ---------- Validate od_operacion_
  function do_ajax_form_fac_operaciones_dividir_validate_od_operacion_(iNumLinha)
  {
    var nomeCampo_od_operacion_ = "od_operacion_" + iNumLinha;
    var var_od_operacion_ = scAjaxGetFieldText(nomeCampo_od_operacion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operaciones_dividir_validate_od_operacion_(var_od_operacion_, iNumLinha, var_script_case_init, do_ajax_form_fac_operaciones_dividir_validate_od_operacion__cb);
  } // do_ajax_form_fac_operaciones_dividir_validate_od_operacion_

  function do_ajax_form_fac_operaciones_dividir_validate_od_operacion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "od_operacion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "od_operacion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "od_operacion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "od_operacion_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operaciones_dividir_validate_od_operacion__cb

  // ---------- Validate od_tipo_cartera_
  function do_ajax_form_fac_operaciones_dividir_validate_od_tipo_cartera_(iNumLinha)
  {
    var nomeCampo_od_tipo_cartera_ = "od_tipo_cartera_" + iNumLinha;
    var var_od_tipo_cartera_ = scAjaxGetFieldText(nomeCampo_od_tipo_cartera_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operaciones_dividir_validate_od_tipo_cartera_(var_od_tipo_cartera_, iNumLinha, var_script_case_init, do_ajax_form_fac_operaciones_dividir_validate_od_tipo_cartera__cb);
  } // do_ajax_form_fac_operaciones_dividir_validate_od_tipo_cartera_

  function do_ajax_form_fac_operaciones_dividir_validate_od_tipo_cartera__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "od_tipo_cartera_" + iLineNumber;
    }
    else
    {
      sFieldValid = "od_tipo_cartera_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "od_tipo_cartera_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "od_tipo_cartera_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operaciones_dividir_validate_od_tipo_cartera__cb

  // ---------- Validate od_comentario_
  function do_ajax_form_fac_operaciones_dividir_validate_od_comentario_(iNumLinha)
  {
    var nomeCampo_od_comentario_ = "od_comentario_" + iNumLinha;
    var var_od_comentario_ = scAjaxGetFieldText(nomeCampo_od_comentario_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operaciones_dividir_validate_od_comentario_(var_od_comentario_, iNumLinha, var_script_case_init, do_ajax_form_fac_operaciones_dividir_validate_od_comentario__cb);
  } // do_ajax_form_fac_operaciones_dividir_validate_od_comentario_

  function do_ajax_form_fac_operaciones_dividir_validate_od_comentario__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "od_comentario_" + iLineNumber;
    }
    else
    {
      sFieldValid = "od_comentario_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "od_comentario_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "od_comentario_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operaciones_dividir_validate_od_comentario__cb

  // ---------- Validate od_saldo_
  function do_ajax_form_fac_operaciones_dividir_validate_od_saldo_(iNumLinha)
  {
    var nomeCampo_od_saldo_ = "od_saldo_" + iNumLinha;
    var var_od_saldo_ = scAjaxGetFieldText(nomeCampo_od_saldo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operaciones_dividir_validate_od_saldo_(var_od_saldo_, iNumLinha, var_script_case_init, do_ajax_form_fac_operaciones_dividir_validate_od_saldo__cb);
  } // do_ajax_form_fac_operaciones_dividir_validate_od_saldo_

  function do_ajax_form_fac_operaciones_dividir_validate_od_saldo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "od_saldo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "od_saldo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "od_saldo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "od_saldo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operaciones_dividir_validate_od_saldo__cb

  // ---------- Validate od_estado_
  function do_ajax_form_fac_operaciones_dividir_validate_od_estado_(iNumLinha)
  {
    var nomeCampo_od_estado_ = "od_estado_" + iNumLinha;
    var var_od_estado_ = scAjaxGetFieldText(nomeCampo_od_estado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operaciones_dividir_validate_od_estado_(var_od_estado_, iNumLinha, var_script_case_init, do_ajax_form_fac_operaciones_dividir_validate_od_estado__cb);
  } // do_ajax_form_fac_operaciones_dividir_validate_od_estado_

  function do_ajax_form_fac_operaciones_dividir_validate_od_estado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "od_estado_" + iLineNumber;
    }
    else
    {
      sFieldValid = "od_estado_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "od_estado_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "od_estado_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operaciones_dividir_validate_od_estado__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_fac_operaciones_dividir_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_fac_operaciones_dividir_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_fac_operaciones_dividir_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_fac_operaciones_dividir_add_new_line_cb);
  } // do_ajax_form_fac_operaciones_dividir_add_new_line

  function do_ajax_form_fac_operaciones_dividir_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_fac_operaciones_dividir_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_fac_operaciones_dividir_backup_line(iNumLinha)
  {
    var var_od_id_ = scAjaxGetFieldHidden("od_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operaciones_dividir_backup_line(var_od_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_fac_operaciones_dividir_backup_line_cb);
  } // do_ajax_form_fac_operaciones_dividir_backup_line

  function do_ajax_form_fac_operaciones_dividir_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_fac_operaciones_dividir_backup_line_cb

  function do_ajax_form_fac_operaciones_dividir_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_fac_operaciones_dividir_cancel_insert

  function do_ajax_form_fac_operaciones_dividir_cancel_update(iSeqVert)
  {
    do_ajax_form_fac_operaciones_dividir_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_fac_operaciones_dividir_cancel_update

  function do_ajax_form_fac_operaciones_dividir_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_fac_operaciones_dividir_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_fac_operaciones_dividir_table_refresh()
  {
    var var_od_id_ = document.F2.od_id_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_fac_operaciones_dividir_table_refresh(var_od_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_operaciones_dividir_table_refresh_cb);
  } //  do_ajax_form_fac_operaciones_dividir_table_refresh

  function do_ajax_form_fac_operaciones_dividir_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.od_id_.value = scAjaxGetKeyValue("od_id_");
    ...
    scAjaxAlert(do_ajax_form_fac_operaciones_dividir_table_refresh_cb_after_alert);
  } // do_ajax_form_fac_operaciones_dividir_table_refresh_cb
  function do_ajax_form_fac_operaciones_dividir_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_fac_operaciones_dividir_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_fac_operaciones_dividir_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_fac_operaciones_dividir_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_od_id_ = scAjaxGetFieldHidden("od_id_" + iNumLinha);
    var var_od_solicitud_ = scAjaxGetFieldText("od_solicitud_" + iNumLinha);
    var var_od_operacion_ = scAjaxGetFieldText("od_operacion_" + iNumLinha);
    var var_od_tipo_cartera_ = scAjaxGetFieldText("od_tipo_cartera_" + iNumLinha);
    var var_od_comentario_ = scAjaxGetFieldText("od_comentario_" + iNumLinha);
    var var_od_saldo_ = scAjaxGetFieldText("od_saldo_" + iNumLinha);
    var var_od_estado_ = scAjaxGetFieldText("od_estado_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_fac_operaciones_dividir_submit_form(var_od_id_, var_od_solicitud_, var_od_operacion_, var_od_tipo_cartera_, var_od_comentario_, var_od_saldo_, var_od_estado_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_fac_operaciones_dividir_submit_form_cb);
  } // do_ajax_form_fac_operaciones_dividir_submit_form

  function do_ajax_form_fac_operaciones_dividir_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("od_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("od_solicitud_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("od_operacion_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("od_tipo_cartera_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("od_comentario_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("od_saldo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("od_estado_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_fac_operaciones_dividir_submit_form_cb_after_alert);
  } // do_ajax_form_fac_operaciones_dividir_submit_form_cb
  function do_ajax_form_fac_operaciones_dividir_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_fac_operaciones_dividir_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_fac_operaciones_dividir_navigate_form()
  {
    perform_ajax_form_fac_operaciones_dividir_navigate_form();
  }

  function perform_ajax_form_fac_operaciones_dividir_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_fac_operaciones_dividir_cancel_insert(sc_form_fac_operaciones_dividir_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("od_id_" + iNavForm);
      scAjaxHideErrorDisplay("od_solicitud_" + iNavForm);
      scAjaxHideErrorDisplay("od_operacion_" + iNavForm);
      scAjaxHideErrorDisplay("od_tipo_cartera_" + iNavForm);
      scAjaxHideErrorDisplay("od_comentario_" + iNavForm);
      scAjaxHideErrorDisplay("od_saldo_" + iNavForm);
      scAjaxHideErrorDisplay("od_estado_" + iNavForm);
    }
    var var_od_id_ = document.F2.od_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_fac_operaciones_dividir_navigate_form(var_od_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_operaciones_dividir_navigate_form_cb);
  } // do_ajax_form_fac_operaciones_dividir_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_operaciones_dividir']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_fac_operaciones_dividir_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.od_id_.value = scAjaxGetKeyValue("od_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_fac_operaciones_dividir_navigate_form_cb_after_alert);
  } // do_ajax_form_fac_operaciones_dividir_navigate_form_cb
  function do_ajax_form_fac_operaciones_dividir_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_fac_operaciones_dividir_navigate_form_cb_after_alert

    function sc_form_fac_operaciones_dividir_get_last_line_number()
    {
    ...
    } //sc_form_fac_operaciones_dividir_get_last_line_number

  function sc_hide_form_fac_operaciones_dividir_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "od_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "od_solicitud_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "od_operacion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "od_tipo_cartera_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "od_comentario_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "od_saldo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "od_estado_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["od_id_" + iNumLinha] = {"label": "Od Id<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["od_solicitud_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_solicitud'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["od_operacion_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_operacion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["od_tipo_cartera_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tipo_cartera'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["od_comentario_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_comentario'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["od_saldo_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_saldo'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["od_estado_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["od_id_"][iNumLinha] = "od_id_" + iNumLinha;
    ajax_field_mult["od_solicitud_"][iNumLinha] = "od_solicitud_" + iNumLinha;
    ajax_field_mult["od_operacion_"][iNumLinha] = "od_operacion_" + iNumLinha;
    ajax_field_mult["od_tipo_cartera_"][iNumLinha] = "od_tipo_cartera_" + iNumLinha;
    ajax_field_mult["od_comentario_"][iNumLinha] = "od_comentario_" + iNumLinha;
    ajax_field_mult["od_saldo_"][iNumLinha] = "od_saldo_" + iNumLinha;
    ajax_field_mult["od_estado_"][iNumLinha] = "od_estado_" + iNumLinha;
    ajax_field_id["od_operacion_" + iNumLinha] = new Array("hidden_field_label_od_operacion_", "hidden_field_data_od_operacion_" + iNumLinha);
    ajax_field_id["od_comentario_" + iNumLinha] = new Array("hidden_field_label_od_comentario_", "hidden_field_data_od_comentario_" + iNumLinha);
    ajax_field_id["od_saldo_" + iNumLinha] = new Array("hidden_field_label_od_saldo_", "hidden_field_data_od_saldo_" + iNumLinha);
    ajax_field_id["od_estado_" + iNumLinha] = new Array("hidden_field_label_od_estado_", "hidden_field_data_od_estado_" + iNumLinha);
    ajax_error_count["od_id_" + iNumLinha] = "off";
    ajax_error_count["od_solicitud_" + iNumLinha] = "off";
    ajax_error_count["od_operacion_" + iNumLinha] = "off";
    ajax_error_count["od_tipo_cartera_" + iNumLinha] = "off";
    ajax_error_count["od_comentario_" + iNumLinha] = "off";
    ajax_error_count["od_saldo_" + iNumLinha] = "off";
    ajax_error_count["od_estado_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["od_id_" + iNumLinha] = "on";
    ajax_read_only["od_solicitud_" + iNumLinha] = "off";
    ajax_read_only["od_operacion_" + iNumLinha] = "off";
    ajax_read_only["od_tipo_cartera_" + iNumLinha] = "off";
    ajax_read_only["od_comentario_" + iNumLinha] = "off";
    ajax_read_only["od_saldo_" + iNumLinha] = "off";
    ajax_read_only["od_estado_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["od_id_" + iNumLinha] = "on";
    ajax_read_only["od_solicitud_" + iNumLinha] = "on";
    ajax_read_only["od_operacion_" + iNumLinha] = "on";
    ajax_read_only["od_tipo_cartera_" + iNumLinha] = "on";
    ajax_read_only["od_comentario_" + iNumLinha] = "on";
    ajax_read_only["od_saldo_" + iNumLinha] = "on";
    ajax_read_only["od_estado_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["od_id_" + iNumLinha] = null;
    ajax_error_list["od_solicitud_" + iNumLinha] = null;
    ajax_error_list["od_operacion_" + iNumLinha] = null;
    ajax_error_list["od_tipo_cartera_" + iNumLinha] = null;
    ajax_error_list["od_comentario_" + iNumLinha] = null;
    ajax_error_list["od_saldo_" + iNumLinha] = null;
    ajax_error_list["od_estado_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "od_id_": new Array(),
    "od_solicitud_": new Array(),
    "od_operacion_": new Array(),
    "od_tipo_cartera_": new Array(),
    "od_comentario_": new Array(),
    "od_saldo_": new Array(),
    "od_estado_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["od_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["od_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["od_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["od_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["od_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["od_solicitud_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["od_solicitud_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["od_solicitud_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["od_solicitud_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["od_solicitud_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["od_operacion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["od_operacion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["od_operacion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["od_operacion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["od_operacion_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["od_tipo_cartera_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["od_tipo_cartera_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["od_tipo_cartera_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["od_tipo_cartera_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["od_tipo_cartera_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["od_comentario_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["od_comentario_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["od_comentario_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["od_comentario_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["od_comentario_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["od_saldo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["od_saldo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["od_saldo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["od_saldo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["od_saldo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["od_estado_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["od_estado_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["od_estado_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["od_estado_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["od_estado_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['od_id_'])) ? $this->nmgp_cmp_readonly['od_id_'] : 'on';
?>
    scAjaxFieldRead("od_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['od_solicitud_'])) ? $this->nmgp_cmp_readonly['od_solicitud_'] : 'off';
?>
    scAjaxFieldRead("od_solicitud_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['od_operacion_'])) ? $this->nmgp_cmp_readonly['od_operacion_'] : 'off';
?>
    scAjaxFieldRead("od_operacion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['od_tipo_cartera_'])) ? $this->nmgp_cmp_readonly['od_tipo_cartera_'] : 'off';
?>
    scAjaxFieldRead("od_tipo_cartera_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['od_comentario_'])) ? $this->nmgp_cmp_readonly['od_comentario_'] : 'off';
?>
    scAjaxFieldRead("od_comentario_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['od_saldo_'])) ? $this->nmgp_cmp_readonly['od_saldo_'] : 'off';
?>
    scAjaxFieldRead("od_saldo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['od_estado_'])) ? $this->nmgp_cmp_readonly['od_estado_'] : 'off';
?>
    scAjaxFieldRead("od_estado_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("od_id_" + iSeq, "on");
    scAjaxFieldRead("od_solicitud_" + iSeq, "on");
    scAjaxFieldRead("od_operacion_" + iSeq, "on");
    scAjaxFieldRead("od_tipo_cartera_" + iSeq, "on");
    scAjaxFieldRead("od_comentario_" + iSeq, "on");
    scAjaxFieldRead("od_saldo_" + iSeq, "on");
    scAjaxFieldRead("od_estado_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["od_id_" + iRow] || "on" == ajax_error_count["od_solicitud_" + iRow] || "on" == ajax_error_count["od_operacion_" + iRow] || "on" == ajax_error_count["od_tipo_cartera_" + iRow] || "on" == ajax_error_count["od_comentario_" + iRow] || "on" == ajax_error_count["od_saldo_" + iRow] || "on" == ajax_error_count["od_estado_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_od_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_od_solicitud_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_od_operacion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_od_tipo_cartera_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_od_comentario_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_od_saldo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_od_estado_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["od_id_" + iRow] && "off" == ajax_error_count["od_solicitud_" + iRow] && "off" == ajax_error_count["od_operacion_" + iRow] && "off" == ajax_error_count["od_tipo_cartera_" + iRow] && "off" == ajax_error_count["od_comentario_" + iRow] && "off" == ajax_error_count["od_saldo_" + iRow] && "off" == ajax_error_count["od_estado_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["od_id_" + iRow] = "off";
        ajax_error_count["od_solicitud_" + iRow] = "off";
        ajax_error_count["od_operacion_" + iRow] = "off";
        ajax_error_count["od_tipo_cartera_" + iRow] = "off";
        ajax_error_count["od_comentario_" + iRow] = "off";
        ajax_error_count["od_saldo_" + iRow] = "off";
        ajax_error_count["od_estado_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_od_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_od_solicitud_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_od_operacion_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_od_tipo_cartera_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_od_comentario_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_od_saldo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_od_estado_" + iRow).removeClass("scFormErrorLine");
    }
  }
