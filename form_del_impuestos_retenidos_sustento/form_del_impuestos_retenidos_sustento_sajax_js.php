  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_impuestos_retenidos_sustento" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_impuestos_retenidos_sustento_form();
	}
...
?>
  ...
  // ---------- Validate irs_id_
  function do_ajax_form_del_impuestos_retenidos_sustento_validate_irs_id_(iNumLinha)
  {
    var nomeCampo_irs_id_ = "irs_id_" + iNumLinha;
    var var_irs_id_ = scAjaxGetFieldHidden(nomeCampo_irs_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_impuestos_retenidos_sustento_validate_irs_id_(var_irs_id_, iNumLinha, var_script_case_init, do_ajax_form_del_impuestos_retenidos_sustento_validate_irs_id__cb);
  } // do_ajax_form_del_impuestos_retenidos_sustento_validate_irs_id_

  function do_ajax_form_del_impuestos_retenidos_sustento_validate_irs_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "irs_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "irs_id_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "irs_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "irs_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_impuestos_retenidos_sustento_validate_irs_id__cb

  // ---------- Validate irs_sustento_
  function do_ajax_form_del_impuestos_retenidos_sustento_validate_irs_sustento_(iNumLinha)
  {
    var nomeCampo_irs_sustento_ = "irs_sustento_" + iNumLinha;
    var var_irs_sustento_ = scAjaxGetFieldText(nomeCampo_irs_sustento_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_impuestos_retenidos_sustento_validate_irs_sustento_(var_irs_sustento_, iNumLinha, var_script_case_init, do_ajax_form_del_impuestos_retenidos_sustento_validate_irs_sustento__cb);
  } // do_ajax_form_del_impuestos_retenidos_sustento_validate_irs_sustento_

  function do_ajax_form_del_impuestos_retenidos_sustento_validate_irs_sustento__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "irs_sustento_" + iLineNumber;
    }
    else
    {
      sFieldValid = "irs_sustento_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "irs_sustento_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "irs_sustento_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_impuestos_retenidos_sustento_validate_irs_sustento__cb

  // ---------- Validate irs_impuesto_
  function do_ajax_form_del_impuestos_retenidos_sustento_validate_irs_impuesto_(iNumLinha)
  {
    var nomeCampo_irs_impuesto_ = "irs_impuesto_" + iNumLinha;
    var var_irs_impuesto_ = scAjaxGetFieldSelect(nomeCampo_irs_impuesto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_impuestos_retenidos_sustento_validate_irs_impuesto_(var_irs_impuesto_, iNumLinha, var_script_case_init, do_ajax_form_del_impuestos_retenidos_sustento_validate_irs_impuesto__cb);
  } // do_ajax_form_del_impuestos_retenidos_sustento_validate_irs_impuesto_

  function do_ajax_form_del_impuestos_retenidos_sustento_validate_irs_impuesto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "irs_impuesto_" + iLineNumber;
    }
    else
    {
      sFieldValid = "irs_impuesto_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "irs_impuesto_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "irs_impuesto_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_impuestos_retenidos_sustento_validate_irs_impuesto__cb

  // ---------- Validate irs_codigo_retencion_
  function do_ajax_form_del_impuestos_retenidos_sustento_validate_irs_codigo_retencion_(iNumLinha)
  {
    var nomeCampo_irs_codigo_retencion_ = "irs_codigo_retencion_" + iNumLinha;
    var var_irs_codigo_retencion_ = scAjaxGetFieldSelect(nomeCampo_irs_codigo_retencion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_impuestos_retenidos_sustento_validate_irs_codigo_retencion_(var_irs_codigo_retencion_, iNumLinha, var_script_case_init, do_ajax_form_del_impuestos_retenidos_sustento_validate_irs_codigo_retencion__cb);
  } // do_ajax_form_del_impuestos_retenidos_sustento_validate_irs_codigo_retencion_

  function do_ajax_form_del_impuestos_retenidos_sustento_validate_irs_codigo_retencion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "irs_codigo_retencion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "irs_codigo_retencion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "irs_codigo_retencion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "irs_codigo_retencion_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_impuestos_retenidos_sustento_validate_irs_codigo_retencion__cb

  // ---------- Validate irs_base_imponible_
  function do_ajax_form_del_impuestos_retenidos_sustento_validate_irs_base_imponible_(iNumLinha)
  {
    var nomeCampo_irs_base_imponible_ = "irs_base_imponible_" + iNumLinha;
    var var_irs_base_imponible_ = scAjaxGetFieldText(nomeCampo_irs_base_imponible_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_impuestos_retenidos_sustento_validate_irs_base_imponible_(var_irs_base_imponible_, iNumLinha, var_script_case_init, do_ajax_form_del_impuestos_retenidos_sustento_validate_irs_base_imponible__cb);
  } // do_ajax_form_del_impuestos_retenidos_sustento_validate_irs_base_imponible_

  function do_ajax_form_del_impuestos_retenidos_sustento_validate_irs_base_imponible__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "irs_base_imponible_" + iLineNumber;
    }
    else
    {
      sFieldValid = "irs_base_imponible_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "irs_base_imponible_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "irs_base_imponible_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_impuestos_retenidos_sustento_validate_irs_base_imponible__cb

  // ---------- Validate irs_porcentaje_retencion_
  function do_ajax_form_del_impuestos_retenidos_sustento_validate_irs_porcentaje_retencion_(iNumLinha)
  {
    var nomeCampo_irs_porcentaje_retencion_ = "irs_porcentaje_retencion_" + iNumLinha;
    var var_irs_porcentaje_retencion_ = scAjaxGetFieldText(nomeCampo_irs_porcentaje_retencion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_impuestos_retenidos_sustento_validate_irs_porcentaje_retencion_(var_irs_porcentaje_retencion_, iNumLinha, var_script_case_init, do_ajax_form_del_impuestos_retenidos_sustento_validate_irs_porcentaje_retencion__cb);
  } // do_ajax_form_del_impuestos_retenidos_sustento_validate_irs_porcentaje_retencion_

  function do_ajax_form_del_impuestos_retenidos_sustento_validate_irs_porcentaje_retencion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "irs_porcentaje_retencion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "irs_porcentaje_retencion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "irs_porcentaje_retencion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "irs_porcentaje_retencion_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_impuestos_retenidos_sustento_validate_irs_porcentaje_retencion__cb

  // ---------- Validate irs_valor_retenido_
  function do_ajax_form_del_impuestos_retenidos_sustento_validate_irs_valor_retenido_(iNumLinha)
  {
    var nomeCampo_irs_valor_retenido_ = "irs_valor_retenido_" + iNumLinha;
    var var_irs_valor_retenido_ = scAjaxGetFieldText(nomeCampo_irs_valor_retenido_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_impuestos_retenidos_sustento_validate_irs_valor_retenido_(var_irs_valor_retenido_, iNumLinha, var_script_case_init, do_ajax_form_del_impuestos_retenidos_sustento_validate_irs_valor_retenido__cb);
  } // do_ajax_form_del_impuestos_retenidos_sustento_validate_irs_valor_retenido_

  function do_ajax_form_del_impuestos_retenidos_sustento_validate_irs_valor_retenido__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "irs_valor_retenido_" + iLineNumber;
    }
    else
    {
      sFieldValid = "irs_valor_retenido_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "irs_valor_retenido_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "irs_valor_retenido_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_impuestos_retenidos_sustento_validate_irs_valor_retenido__cb

  // ---------- Refresh irs_impuesto_
  function do_ajax_form_del_impuestos_retenidos_sustento_refresh_irs_impuesto_(iSeqForm)
  {
    var var_irs_impuesto_ = scAjaxGetFieldSelect("irs_impuesto_" + iSeqForm);
    var var_nmgp_refresh_row = iSeqForm;
    var var_nmgp_refresh_fields = "irs_codigo_retencion_";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_impuestos_retenidos_sustento_refresh_irs_impuesto_(var_irs_impuesto_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_del_impuestos_retenidos_sustento_refresh_irs_impuesto__cb);
  } // do_ajax_form_del_impuestos_retenidos_sustento_refresh_irs_impuesto_

  function do_ajax_form_del_impuestos_retenidos_sustento_refresh_irs_impuesto__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_impuestos_retenidos_sustento_refresh_irs_impuesto__cb

  // ---------- Event onchange irs_base_imponible_
  function do_ajax_form_del_impuestos_retenidos_sustento_event_irs_base_imponible__onchange(iSeqForm)
  {
    var var_irs_base_imponible_ = scAjaxGetFieldText("irs_base_imponible_" + iSeqForm);
    var var_irs_porcentaje_retencion_ = scAjaxGetFieldText("irs_porcentaje_retencion_" + iSeqForm);
    var var_irs_valor_retenido_ = scAjaxGetFieldText("irs_valor_retenido_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_del_impuestos_retenidos_sustento_event_irs_base_imponible__onchange(var_irs_base_imponible_, var_irs_porcentaje_retencion_, var_irs_valor_retenido_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_del_impuestos_retenidos_sustento_event_irs_base_imponible__onchange_cb);
  } // do_ajax_form_del_impuestos_retenidos_sustento_event_irs_base_imponible__onchange

  function do_ajax_form_del_impuestos_retenidos_sustento_event_irs_base_imponible__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_impuestos_retenidos_sustento_event_irs_base_imponible__onchange_cb_after_alert);
  } // do_ajax_form_del_impuestos_retenidos_sustento_event_irs_base_imponible__onchange_cb
  function do_ajax_form_del_impuestos_retenidos_sustento_event_irs_base_imponible__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_impuestos_retenidos_sustento_event_irs_base_imponible__onchange_cb_after_alert

  // ---------- Event onchange irs_codigo_retencion_
  function do_ajax_form_del_impuestos_retenidos_sustento_event_irs_codigo_retencion__onchange(iSeqForm)
  {
    var var_irs_codigo_retencion_ = scAjaxGetFieldSelect("irs_codigo_retencion_" + iSeqForm);
    var var_irs_porcentaje_retencion_ = scAjaxGetFieldText("irs_porcentaje_retencion_" + iSeqForm);
    var var_irs_base_imponible_ = scAjaxGetFieldText("irs_base_imponible_" + iSeqForm);
    var var_irs_valor_retenido_ = scAjaxGetFieldText("irs_valor_retenido_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_del_impuestos_retenidos_sustento_event_irs_codigo_retencion__onchange(var_irs_codigo_retencion_, var_irs_porcentaje_retencion_, var_irs_base_imponible_, var_irs_valor_retenido_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_del_impuestos_retenidos_sustento_event_irs_codigo_retencion__onchange_cb);
  } // do_ajax_form_del_impuestos_retenidos_sustento_event_irs_codigo_retencion__onchange

  function do_ajax_form_del_impuestos_retenidos_sustento_event_irs_codigo_retencion__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_impuestos_retenidos_sustento_event_irs_codigo_retencion__onchange_cb_after_alert);
  } // do_ajax_form_del_impuestos_retenidos_sustento_event_irs_codigo_retencion__onchange_cb
  function do_ajax_form_del_impuestos_retenidos_sustento_event_irs_codigo_retencion__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_impuestos_retenidos_sustento_event_irs_codigo_retencion__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_del_impuestos_retenidos_sustento_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_del_impuestos_retenidos_sustento_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_impuestos_retenidos_sustento_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_del_impuestos_retenidos_sustento_add_new_line_cb);
  } // do_ajax_form_del_impuestos_retenidos_sustento_add_new_line

  function do_ajax_form_del_impuestos_retenidos_sustento_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_del_impuestos_retenidos_sustento_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_del_impuestos_retenidos_sustento_backup_line(iNumLinha)
  {
    var var_irs_id_ = scAjaxGetFieldHidden("irs_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_impuestos_retenidos_sustento_backup_line(var_irs_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_del_impuestos_retenidos_sustento_backup_line_cb);
  } // do_ajax_form_del_impuestos_retenidos_sustento_backup_line

  function do_ajax_form_del_impuestos_retenidos_sustento_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_del_impuestos_retenidos_sustento_backup_line_cb

  function do_ajax_form_del_impuestos_retenidos_sustento_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_del_impuestos_retenidos_sustento_cancel_insert

  function do_ajax_form_del_impuestos_retenidos_sustento_cancel_update(iSeqVert)
  {
    do_ajax_form_del_impuestos_retenidos_sustento_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_del_impuestos_retenidos_sustento_cancel_update

  function do_ajax_form_del_impuestos_retenidos_sustento_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_del_impuestos_retenidos_sustento_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_del_impuestos_retenidos_sustento_table_refresh()
  {
    var var_irs_id_ = document.F2.irs_id_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_impuestos_retenidos_sustento_table_refresh(var_irs_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_impuestos_retenidos_sustento_table_refresh_cb);
  } //  do_ajax_form_del_impuestos_retenidos_sustento_table_refresh

  function do_ajax_form_del_impuestos_retenidos_sustento_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.irs_id_.value = scAjaxGetKeyValue("irs_id_");
    ...
    scAjaxAlert(do_ajax_form_del_impuestos_retenidos_sustento_table_refresh_cb_after_alert);
  } // do_ajax_form_del_impuestos_retenidos_sustento_table_refresh_cb
  function do_ajax_form_del_impuestos_retenidos_sustento_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_del_impuestos_retenidos_sustento_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_del_impuestos_retenidos_sustento_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_del_impuestos_retenidos_sustento_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_irs_id_ = scAjaxGetFieldHidden("irs_id_" + iNumLinha);
    var var_irs_sustento_ = scAjaxGetFieldText("irs_sustento_" + iNumLinha);
    var var_irs_impuesto_ = scAjaxGetFieldSelect("irs_impuesto_" + iNumLinha);
    var var_irs_codigo_retencion_ = scAjaxGetFieldSelect("irs_codigo_retencion_" + iNumLinha);
    var var_irs_base_imponible_ = scAjaxGetFieldText("irs_base_imponible_" + iNumLinha);
    var var_irs_porcentaje_retencion_ = scAjaxGetFieldText("irs_porcentaje_retencion_" + iNumLinha);
    var var_irs_valor_retenido_ = scAjaxGetFieldText("irs_valor_retenido_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_del_impuestos_retenidos_sustento_submit_form(var_irs_id_, var_irs_sustento_, var_irs_impuesto_, var_irs_codigo_retencion_, var_irs_base_imponible_, var_irs_porcentaje_retencion_, var_irs_valor_retenido_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_impuestos_retenidos_sustento_submit_form_cb);
  } // do_ajax_form_del_impuestos_retenidos_sustento_submit_form

  function do_ajax_form_del_impuestos_retenidos_sustento_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("irs_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("irs_sustento_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("irs_impuesto_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("irs_codigo_retencion_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("irs_base_imponible_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("irs_porcentaje_retencion_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("irs_valor_retenido_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_impuestos_retenidos_sustento_submit_form_cb_after_alert);
  } // do_ajax_form_del_impuestos_retenidos_sustento_submit_form_cb
  function do_ajax_form_del_impuestos_retenidos_sustento_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_impuestos_retenidos_sustento_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_impuestos_retenidos_sustento_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_del_impuestos_retenidos_sustento_navigate_form, function() {});
    } else {
      perform_ajax_form_del_impuestos_retenidos_sustento_navigate_form();
    }
  }

  function perform_ajax_form_del_impuestos_retenidos_sustento_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_del_impuestos_retenidos_sustento_cancel_insert(sc_form_del_impuestos_retenidos_sustento_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("irs_id_" + iNavForm);
      scAjaxHideErrorDisplay("irs_sustento_" + iNavForm);
      scAjaxHideErrorDisplay("irs_impuesto_" + iNavForm);
      scAjaxHideErrorDisplay("irs_codigo_retencion_" + iNavForm);
      scAjaxHideErrorDisplay("irs_base_imponible_" + iNavForm);
      scAjaxHideErrorDisplay("irs_porcentaje_retencion_" + iNavForm);
      scAjaxHideErrorDisplay("irs_valor_retenido_" + iNavForm);
    }
    var var_irs_id_ = document.F2.irs_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_impuestos_retenidos_sustento_navigate_form(var_irs_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_impuestos_retenidos_sustento_navigate_form_cb);
  } // do_ajax_form_del_impuestos_retenidos_sustento_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_impuestos_retenidos_sustento']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_impuestos_retenidos_sustento_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.irs_id_.value = scAjaxGetKeyValue("irs_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_impuestos_retenidos_sustento_navigate_form_cb_after_alert);
  } // do_ajax_form_del_impuestos_retenidos_sustento_navigate_form_cb
  function do_ajax_form_del_impuestos_retenidos_sustento_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_del_impuestos_retenidos_sustento_navigate_form_cb_after_alert

    function sc_form_del_impuestos_retenidos_sustento_get_last_line_number()
    {
    ...
    } //sc_form_del_impuestos_retenidos_sustento_get_last_line_number

  function sc_hide_form_del_impuestos_retenidos_sustento_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "irs_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "irs_sustento_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "irs_impuesto_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "irs_codigo_retencion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "irs_base_imponible_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "irs_porcentaje_retencion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "irs_valor_retenido_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["irs_id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["irs_sustento_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_documento_sustento'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["irs_impuesto_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_impuesto'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["irs_codigo_retencion_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_sustento'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["irs_base_imponible_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_base_imponible'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["irs_porcentaje_retencion_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_porcentaje_retencion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["irs_valor_retenido_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_valor_retenido'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["irs_id_"][iNumLinha] = "irs_id_" + iNumLinha;
    ajax_field_mult["irs_sustento_"][iNumLinha] = "irs_sustento_" + iNumLinha;
    ajax_field_mult["irs_impuesto_"][iNumLinha] = "irs_impuesto_" + iNumLinha;
    ajax_field_mult["irs_codigo_retencion_"][iNumLinha] = "irs_codigo_retencion_" + iNumLinha;
    ajax_field_mult["irs_base_imponible_"][iNumLinha] = "irs_base_imponible_" + iNumLinha;
    ajax_field_mult["irs_porcentaje_retencion_"][iNumLinha] = "irs_porcentaje_retencion_" + iNumLinha;
    ajax_field_mult["irs_valor_retenido_"][iNumLinha] = "irs_valor_retenido_" + iNumLinha;
    ajax_field_id["irs_impuesto_" + iNumLinha] = new Array("hidden_field_label_irs_impuesto_", "hidden_field_data_irs_impuesto_" + iNumLinha);
    ajax_field_id["irs_codigo_retencion_" + iNumLinha] = new Array("hidden_field_label_irs_codigo_retencion_", "hidden_field_data_irs_codigo_retencion_" + iNumLinha);
    ajax_field_id["irs_base_imponible_" + iNumLinha] = new Array("hidden_field_label_irs_base_imponible_", "hidden_field_data_irs_base_imponible_" + iNumLinha);
    ajax_field_id["irs_porcentaje_retencion_" + iNumLinha] = new Array("hidden_field_label_irs_porcentaje_retencion_", "hidden_field_data_irs_porcentaje_retencion_" + iNumLinha);
    ajax_field_id["irs_valor_retenido_" + iNumLinha] = new Array("hidden_field_label_irs_valor_retenido_", "hidden_field_data_irs_valor_retenido_" + iNumLinha);
    ajax_error_count["irs_id_" + iNumLinha] = "off";
    ajax_error_count["irs_sustento_" + iNumLinha] = "off";
    ajax_error_count["irs_impuesto_" + iNumLinha] = "off";
    ajax_error_count["irs_codigo_retencion_" + iNumLinha] = "off";
    ajax_error_count["irs_base_imponible_" + iNumLinha] = "off";
    ajax_error_count["irs_porcentaje_retencion_" + iNumLinha] = "off";
    ajax_error_count["irs_valor_retenido_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["irs_id_" + iNumLinha] = "on";
    ajax_read_only["irs_sustento_" + iNumLinha] = "off";
    ajax_read_only["irs_impuesto_" + iNumLinha] = "off";
    ajax_read_only["irs_codigo_retencion_" + iNumLinha] = "off";
    ajax_read_only["irs_base_imponible_" + iNumLinha] = "off";
    ajax_read_only["irs_porcentaje_retencion_" + iNumLinha] = "off";
    ajax_read_only["irs_valor_retenido_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["irs_id_" + iNumLinha] = "on";
    ajax_read_only["irs_sustento_" + iNumLinha] = "on";
    ajax_read_only["irs_impuesto_" + iNumLinha] = "on";
    ajax_read_only["irs_codigo_retencion_" + iNumLinha] = "on";
    ajax_read_only["irs_base_imponible_" + iNumLinha] = "on";
    ajax_read_only["irs_porcentaje_retencion_" + iNumLinha] = "on";
    ajax_read_only["irs_valor_retenido_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["irs_id_" + iNumLinha] = null;
    ajax_error_list["irs_sustento_" + iNumLinha] = null;
    ajax_error_list["irs_impuesto_" + iNumLinha] = null;
    ajax_error_list["irs_codigo_retencion_" + iNumLinha] = null;
    ajax_error_list["irs_base_imponible_" + iNumLinha] = null;
    ajax_error_list["irs_porcentaje_retencion_" + iNumLinha] = null;
    ajax_error_list["irs_valor_retenido_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "irs_id_": new Array(),
    "irs_sustento_": new Array(),
    "irs_impuesto_": new Array(),
    "irs_codigo_retencion_": new Array(),
    "irs_base_imponible_": new Array(),
    "irs_porcentaje_retencion_": new Array(),
    "irs_valor_retenido_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["irs_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["irs_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["irs_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["irs_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["irs_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["irs_sustento_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["irs_sustento_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["irs_sustento_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["irs_sustento_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["irs_sustento_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["irs_impuesto_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["irs_impuesto_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["irs_impuesto_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["irs_impuesto_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["irs_impuesto_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["irs_codigo_retencion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["irs_codigo_retencion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["irs_codigo_retencion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["irs_codigo_retencion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["irs_codigo_retencion_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["irs_base_imponible_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["irs_base_imponible_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["irs_base_imponible_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["irs_base_imponible_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["irs_base_imponible_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["irs_porcentaje_retencion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["irs_porcentaje_retencion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["irs_porcentaje_retencion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["irs_porcentaje_retencion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["irs_porcentaje_retencion_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["irs_valor_retenido_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["irs_valor_retenido_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["irs_valor_retenido_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["irs_valor_retenido_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["irs_valor_retenido_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['irs_id_'])) ? $this->nmgp_cmp_readonly['irs_id_'] : 'on';
?>
    scAjaxFieldRead("irs_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['irs_sustento_'])) ? $this->nmgp_cmp_readonly['irs_sustento_'] : 'off';
?>
    scAjaxFieldRead("irs_sustento_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['irs_impuesto_'])) ? $this->nmgp_cmp_readonly['irs_impuesto_'] : 'off';
?>
    scAjaxFieldRead("irs_impuesto_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['irs_codigo_retencion_'])) ? $this->nmgp_cmp_readonly['irs_codigo_retencion_'] : 'off';
?>
    scAjaxFieldRead("irs_codigo_retencion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['irs_base_imponible_'])) ? $this->nmgp_cmp_readonly['irs_base_imponible_'] : 'off';
?>
    scAjaxFieldRead("irs_base_imponible_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['irs_porcentaje_retencion_'])) ? $this->nmgp_cmp_readonly['irs_porcentaje_retencion_'] : 'off';
?>
    scAjaxFieldRead("irs_porcentaje_retencion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['irs_valor_retenido_'])) ? $this->nmgp_cmp_readonly['irs_valor_retenido_'] : 'off';
?>
    scAjaxFieldRead("irs_valor_retenido_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("irs_id_" + iSeq, "on");
    scAjaxFieldRead("irs_sustento_" + iSeq, "on");
    scAjaxFieldRead("irs_impuesto_" + iSeq, "on");
    scAjaxFieldRead("irs_codigo_retencion_" + iSeq, "on");
    scAjaxFieldRead("irs_base_imponible_" + iSeq, "on");
    scAjaxFieldRead("irs_porcentaje_retencion_" + iSeq, "on");
    scAjaxFieldRead("irs_valor_retenido_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["irs_id_" + iRow] || "on" == ajax_error_count["irs_sustento_" + iRow] || "on" == ajax_error_count["irs_impuesto_" + iRow] || "on" == ajax_error_count["irs_codigo_retencion_" + iRow] || "on" == ajax_error_count["irs_base_imponible_" + iRow] || "on" == ajax_error_count["irs_porcentaje_retencion_" + iRow] || "on" == ajax_error_count["irs_valor_retenido_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_irs_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_irs_sustento_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_irs_impuesto_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_irs_codigo_retencion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_irs_base_imponible_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_irs_porcentaje_retencion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_irs_valor_retenido_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["irs_id_" + iRow] && "off" == ajax_error_count["irs_sustento_" + iRow] && "off" == ajax_error_count["irs_impuesto_" + iRow] && "off" == ajax_error_count["irs_codigo_retencion_" + iRow] && "off" == ajax_error_count["irs_base_imponible_" + iRow] && "off" == ajax_error_count["irs_porcentaje_retencion_" + iRow] && "off" == ajax_error_count["irs_valor_retenido_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["irs_id_" + iRow] = "off";
        ajax_error_count["irs_sustento_" + iRow] = "off";
        ajax_error_count["irs_impuesto_" + iRow] = "off";
        ajax_error_count["irs_codigo_retencion_" + iRow] = "off";
        ajax_error_count["irs_base_imponible_" + iRow] = "off";
        ajax_error_count["irs_porcentaje_retencion_" + iRow] = "off";
        ajax_error_count["irs_valor_retenido_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_irs_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_irs_sustento_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_irs_impuesto_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_irs_codigo_retencion_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_irs_base_imponible_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_irs_porcentaje_retencion_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_irs_valor_retenido_" + iRow).removeClass("scFormErrorLine");
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("irs_codigo_retencion_" == sIndex)
    {
      scAjaxSetFieldSelect(sIndex, aValue, null);
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("irs_porcentaje_retencion_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
