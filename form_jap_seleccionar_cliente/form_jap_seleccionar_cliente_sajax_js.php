  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_jap_seleccionar_cliente" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_jap_seleccionar_cliente_form();
	}
...
?>
  ...
  // ---------- Validate cl_id_
  function do_ajax_form_jap_seleccionar_cliente_validate_cl_id_(iNumLinha)
  {
    var nomeCampo_cl_id_ = "cl_id_" + iNumLinha;
    var var_cl_id_ = scAjaxGetFieldText(nomeCampo_cl_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_seleccionar_cliente_validate_cl_id_(var_cl_id_, iNumLinha, var_script_case_init, do_ajax_form_jap_seleccionar_cliente_validate_cl_id__cb);
  } // do_ajax_form_jap_seleccionar_cliente_validate_cl_id_

  function do_ajax_form_jap_seleccionar_cliente_validate_cl_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_seleccionar_cliente_validate_cl_id__cb

  // ---------- Validate seleccionar_
  function do_ajax_form_jap_seleccionar_cliente_validate_seleccionar_(iNumLinha)
  {
    var nomeCampo_seleccionar_ = "seleccionar_" + iNumLinha;
    var var_seleccionar_ = scAjaxGetFieldCheckbox(nomeCampo_seleccionar_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_seleccionar_cliente_validate_seleccionar_(var_seleccionar_, iNumLinha, var_script_case_init, do_ajax_form_jap_seleccionar_cliente_validate_seleccionar__cb);
  } // do_ajax_form_jap_seleccionar_cliente_validate_seleccionar_

  function do_ajax_form_jap_seleccionar_cliente_validate_seleccionar__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_seleccionar_cliente_validate_seleccionar__cb

  // ---------- Validate cl_nombre_
  function do_ajax_form_jap_seleccionar_cliente_validate_cl_nombre_(iNumLinha)
  {
    var nomeCampo_cl_nombre_ = "cl_nombre_" + iNumLinha;
    var var_cl_nombre_ = scAjaxGetFieldHidden(nomeCampo_cl_nombre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_seleccionar_cliente_validate_cl_nombre_(var_cl_nombre_, iNumLinha, var_script_case_init, do_ajax_form_jap_seleccionar_cliente_validate_cl_nombre__cb);
  } // do_ajax_form_jap_seleccionar_cliente_validate_cl_nombre_

  function do_ajax_form_jap_seleccionar_cliente_validate_cl_nombre__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_seleccionar_cliente_validate_cl_nombre__cb

  // ---------- Validate cl_identificacion_
  function do_ajax_form_jap_seleccionar_cliente_validate_cl_identificacion_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_seleccionar_cliente_validate_cl_identificacion_(var_cl_identificacion_, iNumLinha, var_script_case_init, do_ajax_form_jap_seleccionar_cliente_validate_cl_identificacion__cb);
  } // do_ajax_form_jap_seleccionar_cliente_validate_cl_identificacion_

  function do_ajax_form_jap_seleccionar_cliente_validate_cl_identificacion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_seleccionar_cliente_validate_cl_identificacion__cb

  // ---------- Validate cl_direccion_
  function do_ajax_form_jap_seleccionar_cliente_validate_cl_direccion_(iNumLinha)
  {
    var nomeCampo_cl_direccion_ = "cl_direccion_" + iNumLinha;
    var var_cl_direccion_ = scAjaxGetFieldHidden(nomeCampo_cl_direccion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_seleccionar_cliente_validate_cl_direccion_(var_cl_direccion_, iNumLinha, var_script_case_init, do_ajax_form_jap_seleccionar_cliente_validate_cl_direccion__cb);
  } // do_ajax_form_jap_seleccionar_cliente_validate_cl_direccion_

  function do_ajax_form_jap_seleccionar_cliente_validate_cl_direccion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_seleccionar_cliente_validate_cl_direccion__cb

  // ---------- Validate cl_telefono_
  function do_ajax_form_jap_seleccionar_cliente_validate_cl_telefono_(iNumLinha)
  {
    var nomeCampo_cl_telefono_ = "cl_telefono_" + iNumLinha;
    var var_cl_telefono_ = scAjaxGetFieldHidden(nomeCampo_cl_telefono_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_seleccionar_cliente_validate_cl_telefono_(var_cl_telefono_, iNumLinha, var_script_case_init, do_ajax_form_jap_seleccionar_cliente_validate_cl_telefono__cb);
  } // do_ajax_form_jap_seleccionar_cliente_validate_cl_telefono_

  function do_ajax_form_jap_seleccionar_cliente_validate_cl_telefono__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_seleccionar_cliente_validate_cl_telefono__cb

  // ---------- Validate cl_celular_
  function do_ajax_form_jap_seleccionar_cliente_validate_cl_celular_(iNumLinha)
  {
    var nomeCampo_cl_celular_ = "cl_celular_" + iNumLinha;
    var var_cl_celular_ = scAjaxGetFieldHidden(nomeCampo_cl_celular_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_seleccionar_cliente_validate_cl_celular_(var_cl_celular_, iNumLinha, var_script_case_init, do_ajax_form_jap_seleccionar_cliente_validate_cl_celular__cb);
  } // do_ajax_form_jap_seleccionar_cliente_validate_cl_celular_

  function do_ajax_form_jap_seleccionar_cliente_validate_cl_celular__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_seleccionar_cliente_validate_cl_celular__cb

  // ---------- Validate cl_email_
  function do_ajax_form_jap_seleccionar_cliente_validate_cl_email_(iNumLinha)
  {
    var nomeCampo_cl_email_ = "cl_email_" + iNumLinha;
    var var_cl_email_ = scAjaxGetFieldHidden(nomeCampo_cl_email_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_seleccionar_cliente_validate_cl_email_(var_cl_email_, iNumLinha, var_script_case_init, do_ajax_form_jap_seleccionar_cliente_validate_cl_email__cb);
  } // do_ajax_form_jap_seleccionar_cliente_validate_cl_email_

  function do_ajax_form_jap_seleccionar_cliente_validate_cl_email__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_seleccionar_cliente_validate_cl_email__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_jap_seleccionar_cliente_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_jap_seleccionar_cliente_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_jap_seleccionar_cliente_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_jap_seleccionar_cliente_add_new_line_cb);
  } // do_ajax_form_jap_seleccionar_cliente_add_new_line

  function do_ajax_form_jap_seleccionar_cliente_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_jap_seleccionar_cliente_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_jap_seleccionar_cliente_backup_line(iNumLinha)
  {
    var var_cl_id_ = scAjaxGetFieldText("cl_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_seleccionar_cliente_backup_line(var_cl_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_jap_seleccionar_cliente_backup_line_cb);
  } // do_ajax_form_jap_seleccionar_cliente_backup_line

  function do_ajax_form_jap_seleccionar_cliente_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_jap_seleccionar_cliente_backup_line_cb

  function do_ajax_form_jap_seleccionar_cliente_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_jap_seleccionar_cliente_cancel_insert

  function do_ajax_form_jap_seleccionar_cliente_cancel_update(iSeqVert)
  {
    do_ajax_form_jap_seleccionar_cliente_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_jap_seleccionar_cliente_cancel_update

  function do_ajax_form_jap_seleccionar_cliente_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_jap_seleccionar_cliente_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_jap_seleccionar_cliente_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_jap_seleccionar_cliente_table_refresh(var_cl_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jap_seleccionar_cliente_table_refresh_cb);
  } //  do_ajax_form_jap_seleccionar_cliente_table_refresh

  function do_ajax_form_jap_seleccionar_cliente_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_jap_seleccionar_cliente_table_refresh_cb_after_alert);
  } // do_ajax_form_jap_seleccionar_cliente_table_refresh_cb
  function do_ajax_form_jap_seleccionar_cliente_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_jap_seleccionar_cliente_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_jap_seleccionar_cliente_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_jap_seleccionar_cliente_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_jap_seleccionar_cliente_submit_form(var_cl_id_, var_seleccionar_, var_cl_nombre_, var_cl_identificacion_, var_cl_direccion_, var_cl_telefono_, var_cl_celular_, var_cl_email_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_jap_seleccionar_cliente_submit_form_cb);
  } // do_ajax_form_jap_seleccionar_cliente_submit_form

  function do_ajax_form_jap_seleccionar_cliente_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_jap_seleccionar_cliente_submit_form_cb_after_alert);
  } // do_ajax_form_jap_seleccionar_cliente_submit_form_cb
  function do_ajax_form_jap_seleccionar_cliente_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_jap_seleccionar_cliente_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_jap_seleccionar_cliente_navigate_form()
  {
    perform_ajax_form_jap_seleccionar_cliente_navigate_form();
  }

  function perform_ajax_form_jap_seleccionar_cliente_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_jap_seleccionar_cliente_navigate_form(var_cl_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jap_seleccionar_cliente_navigate_form_cb);
  } // do_ajax_form_jap_seleccionar_cliente_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_seleccionar_cliente']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_jap_seleccionar_cliente_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_jap_seleccionar_cliente_navigate_form_cb_after_alert);
  } // do_ajax_form_jap_seleccionar_cliente_navigate_form_cb
  function do_ajax_form_jap_seleccionar_cliente_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_jap_seleccionar_cliente_navigate_form_cb_after_alert

    function sc_form_jap_seleccionar_cliente_get_last_line_number()
    {
    ...
    } //sc_form_jap_seleccionar_cliente_get_last_line_number

  function sc_hide_form_jap_seleccionar_cliente_form()
  {
