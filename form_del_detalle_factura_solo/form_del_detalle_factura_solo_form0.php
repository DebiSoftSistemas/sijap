...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_del_detalle_factura_solo/form_del_detalle_factura_solo_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_del_detalle_factura_solo_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_del_detalle_factura_solo_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['link_info']['remove_border']) {
...
<?php
 include_once("form_del_detalle_factura_solo_js0.php");
?>
<script type="text/javascript"> 
nmdg_enter_tab = true;
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_del_detalle_factura_solo'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_del_detalle_factura_solo'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_disabled']['']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_disabled']['']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_label']['']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_label']['']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_label'][''];
        }
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-6';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_df_id_label" id="hidden_field_label_df_id" style="<?php echo $sStyleHidden_df_id; ?>"><span id="id_label_df_id"><?php echo $this->nm_new_label['df_id']; ?></span></TD>
    <TD class="scFormDataOdd css_df_id_line" id="hidden_field_data_df_id" style="<?php echo $sStyleHidden_df_id; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_df_id_line" style="vertical-align: top;padding: 0px"><span id="id_read_on_df_id" class="css_df_id_line" style="<?php echo $sStyleReadLab_df_id; ?>"><?php echo $this->form_format_readonly("df_id", $this->form_encode_input($this->df_id)); ?></span><span id="id_read_off_df_id" class="css_read_off_df_id" style="<?php echo $sStyleReadInp_df_id; ?>"><input type="hidden" name="df_id" value="<?php echo $this->form_encode_input($df_id) . "\">"?><span id="id_ajax_label_df_id"><?php echo nl2br($df_id); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_df_factura_label" id="hidden_field_label_df_factura" style="<?php echo $sStyleHidden_df_factura; ?>"><span id="id_label_df_factura"><?php echo $this->nm_new_label['df_factura']; ?></span></TD>
    <TD class="scFormDataOdd css_df_factura_line" id="hidden_field_data_df_factura" style="<?php echo $sStyleHidden_df_factura; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_df_factura_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_df_producto_label" id="hidden_field_label_df_producto" style="<?php echo $sStyleHidden_df_producto; ?>"><span id="id_label_df_producto"><?php echo $this->nm_new_label['df_producto']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['php_cmp_required']['df_producto']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['php_cmp_required']['df_producto'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_df_producto_line" id="hidden_field_data_df_producto" style="<?php echo $sStyleHidden_df_producto; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_df_producto_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_df_descripcion_label" id="hidden_field_label_df_descripcion" style="<?php echo $sStyleHidden_df_descripcion; ?>"><span id="id_label_df_descripcion"><?php echo $this->nm_new_label['df_descripcion']; ?></span></TD>
    <TD class="scFormDataOdd css_df_descripcion_line" id="hidden_field_data_df_descripcion" style="<?php echo $sStyleHidden_df_descripcion; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_df_descripcion_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_df_cantidad_label" id="hidden_field_label_df_cantidad" style="<?php echo $sStyleHidden_df_cantidad; ?>"><span id="id_label_df_cantidad"><?php echo $this->nm_new_label['df_cantidad']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['php_cmp_required']['df_cantidad']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['php_cmp_required']['df_cantidad'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_df_cantidad_line" id="hidden_field_data_df_cantidad" style="<?php echo $sStyleHidden_df_cantidad; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_df_cantidad_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_df_precio_unitario_label" id="hidden_field_label_df_precio_unitario" style="<?php echo $sStyleHidden_df_precio_unitario; ?>"><span id="id_label_df_precio_unitario"><?php echo $this->nm_new_label['df_precio_unitario']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['php_cmp_required']['df_precio_unitario']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['php_cmp_required']['df_precio_unitario'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_df_precio_unitario_line" id="hidden_field_data_df_precio_unitario" style="<?php echo $sStyleHidden_df_precio_unitario; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_df_precio_unitario_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_df_descuento_label" id="hidden_field_label_df_descuento" style="<?php echo $sStyleHidden_df_descuento; ?>"><span id="id_label_df_descuento"><?php echo $this->nm_new_label['df_descuento']; ?></span></TD>
    <TD class="scFormDataOdd css_df_descuento_line" id="hidden_field_data_df_descuento" style="<?php echo $sStyleHidden_df_descuento; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_df_descuento_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_df_subtotal_label" id="hidden_field_label_df_subtotal" style="<?php echo $sStyleHidden_df_subtotal; ?>"><span id="id_label_df_subtotal"><?php echo $this->nm_new_label['df_subtotal']; ?></span></TD>
    <TD class="scFormDataOdd css_df_subtotal_line" id="hidden_field_data_df_subtotal" style="<?php echo $sStyleHidden_df_subtotal; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_df_subtotal_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_df_base_ice_label" id="hidden_field_label_df_base_ice" style="<?php echo $sStyleHidden_df_base_ice; ?>"><span id="id_label_df_base_ice"><?php echo $this->nm_new_label['df_base_ice']; ?></span></TD>
    <TD class="scFormDataOdd css_df_base_ice_line" id="hidden_field_data_df_base_ice" style="<?php echo $sStyleHidden_df_base_ice; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_df_base_ice_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_df_porcentaje_ice_label" id="hidden_field_label_df_porcentaje_ice" style="<?php echo $sStyleHidden_df_porcentaje_ice; ?>"><span id="id_label_df_porcentaje_ice"><?php echo $this->nm_new_label['df_porcentaje_ice']; ?></span></TD>
    <TD class="scFormDataOdd css_df_porcentaje_ice_line" id="hidden_field_data_df_porcentaje_ice" style="<?php echo $sStyleHidden_df_porcentaje_ice; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_df_porcentaje_ice_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_df_valor_ice_label" id="hidden_field_label_df_valor_ice" style="<?php echo $sStyleHidden_df_valor_ice; ?>"><span id="id_label_df_valor_ice"><?php echo $this->nm_new_label['df_valor_ice']; ?></span></TD>
    <TD class="scFormDataOdd css_df_valor_ice_line" id="hidden_field_data_df_valor_ice" style="<?php echo $sStyleHidden_df_valor_ice; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_df_valor_ice_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_df_base_iva_label" id="hidden_field_label_df_base_iva" style="<?php echo $sStyleHidden_df_base_iva; ?>"><span id="id_label_df_base_iva"><?php echo $this->nm_new_label['df_base_iva']; ?></span></TD>
    <TD class="scFormDataOdd css_df_base_iva_line" id="hidden_field_data_df_base_iva" style="<?php echo $sStyleHidden_df_base_iva; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_df_base_iva_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_df_porcentaje_iva_label" id="hidden_field_label_df_porcentaje_iva" style="<?php echo $sStyleHidden_df_porcentaje_iva; ?>"><span id="id_label_df_porcentaje_iva"><?php echo $this->nm_new_label['df_porcentaje_iva']; ?></span></TD>
    <TD class="scFormDataOdd css_df_porcentaje_iva_line" id="hidden_field_data_df_porcentaje_iva" style="<?php echo $sStyleHidden_df_porcentaje_iva; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_df_porcentaje_iva_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_df_valor_iva_label" id="hidden_field_label_df_valor_iva" style="<?php echo $sStyleHidden_df_valor_iva; ?>"><span id="id_label_df_valor_iva"><?php echo $this->nm_new_label['df_valor_iva']; ?></span></TD>
    <TD class="scFormDataOdd css_df_valor_iva_line" id="hidden_field_data_df_valor_iva" style="<?php echo $sStyleHidden_df_valor_iva; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_df_valor_iva_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_df_base_irbpnr_label" id="hidden_field_label_df_base_irbpnr" style="<?php echo $sStyleHidden_df_base_irbpnr; ?>"><span id="id_label_df_base_irbpnr"><?php echo $this->nm_new_label['df_base_irbpnr']; ?></span></TD>
    <TD class="scFormDataOdd css_df_base_irbpnr_line" id="hidden_field_data_df_base_irbpnr" style="<?php echo $sStyleHidden_df_base_irbpnr; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_df_base_irbpnr_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_df_porcentaje_irbpnr_label" id="hidden_field_label_df_porcentaje_irbpnr" style="<?php echo $sStyleHidden_df_porcentaje_irbpnr; ?>"><span id="id_label_df_porcentaje_irbpnr"><?php echo $this->nm_new_label['df_porcentaje_irbpnr']; ?></span></TD>
    <TD class="scFormDataOdd css_df_porcentaje_irbpnr_line" id="hidden_field_data_df_porcentaje_irbpnr" style="<?php echo $sStyleHidden_df_porcentaje_irbpnr; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_df_porcentaje_irbpnr_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_df_valor_irbpnr_label" id="hidden_field_label_df_valor_irbpnr" style="<?php echo $sStyleHidden_df_valor_irbpnr; ?>"><span id="id_label_df_valor_irbpnr"><?php echo $this->nm_new_label['df_valor_irbpnr']; ?></span></TD>
    <TD class="scFormDataOdd css_df_valor_irbpnr_line" id="hidden_field_data_df_valor_irbpnr" style="<?php echo $sStyleHidden_df_valor_irbpnr; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_df_valor_irbpnr_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_df_total_label" id="hidden_field_label_df_total" style="<?php echo $sStyleHidden_df_total; ?>"><span id="id_label_df_total"><?php echo $this->nm_new_label['df_total']; ?></span></TD>
    <TD class="scFormDataOdd css_df_total_line" id="hidden_field_data_df_total" style="<?php echo $sStyleHidden_df_total; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_df_total_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_df_cantidad_nc_label" id="hidden_field_label_df_cantidad_nc" style="<?php echo $sStyleHidden_df_cantidad_nc; ?>"><span id="id_label_df_cantidad_nc"><?php echo $this->nm_new_label['df_cantidad_nc']; ?></span></TD>
    <TD class="scFormDataOdd css_df_cantidad_nc_line" id="hidden_field_data_df_cantidad_nc" style="<?php echo $sStyleHidden_df_cantidad_nc; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_df_cantidad_nc_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_df_precio_sin_subsidio_label" id="hidden_field_label_df_precio_sin_subsidio" style="<?php echo $sStyleHidden_df_precio_sin_subsidio; ?>"><span id="id_label_df_precio_sin_subsidio"><?php echo $this->nm_new_label['df_precio_sin_subsidio']; ?></span></TD>
    <TD class="scFormDataOdd css_df_precio_sin_subsidio_line" id="hidden_field_data_df_precio_sin_subsidio" style="<?php echo $sStyleHidden_df_precio_sin_subsidio; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_df_precio_sin_subsidio_line" style="vertical-align: top;padding: 0px">
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_del_detalle_factura_solo");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_del_detalle_factura_solo");
 parent.scAjaxDetailHeight("form_del_detalle_factura_solo", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_solo']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
