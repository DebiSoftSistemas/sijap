  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_nueva_transferencia_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_nueva_transferencia_mob_form();
	}
...
?>
  ...
  // ---------- Validate tr_fecha
  function do_ajax_control_nueva_transferencia_mob_validate_tr_fecha()
  {
    var nomeCampo_tr_fecha = "tr_fecha";
    var var_tr_fecha = scAjaxGetFieldHidden(nomeCampo_tr_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_nueva_transferencia_mob_validate_tr_fecha(var_tr_fecha, var_script_case_init, do_ajax_control_nueva_transferencia_mob_validate_tr_fecha_cb);
  } // do_ajax_control_nueva_transferencia_mob_validate_tr_fecha

  function do_ajax_control_nueva_transferencia_mob_validate_tr_fecha_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_nueva_transferencia_mob_validate_tr_fecha_cb

  // ---------- Validate tr_establecimiento_origen
  function do_ajax_control_nueva_transferencia_mob_validate_tr_establecimiento_origen()
  {
    var nomeCampo_tr_establecimiento_origen = "tr_establecimiento_origen";
    var var_tr_establecimiento_origen = scAjaxGetFieldSelect(nomeCampo_tr_establecimiento_origen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_nueva_transferencia_mob_validate_tr_establecimiento_origen(var_tr_establecimiento_origen, var_script_case_init, do_ajax_control_nueva_transferencia_mob_validate_tr_establecimiento_origen_cb);
  } // do_ajax_control_nueva_transferencia_mob_validate_tr_establecimiento_origen

  function do_ajax_control_nueva_transferencia_mob_validate_tr_establecimiento_origen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tr_establecimiento_origen";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_nueva_transferencia_mob_validate_tr_establecimiento_origen_cb

  // ---------- Validate tr_bodega_origen
  function do_ajax_control_nueva_transferencia_mob_validate_tr_bodega_origen()
  {
    var nomeCampo_tr_bodega_origen = "tr_bodega_origen";
    var var_tr_bodega_origen = scAjaxGetFieldSelect(nomeCampo_tr_bodega_origen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_nueva_transferencia_mob_validate_tr_bodega_origen(var_tr_bodega_origen, var_script_case_init, do_ajax_control_nueva_transferencia_mob_validate_tr_bodega_origen_cb);
  } // do_ajax_control_nueva_transferencia_mob_validate_tr_bodega_origen

  function do_ajax_control_nueva_transferencia_mob_validate_tr_bodega_origen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_nueva_transferencia_mob_validate_tr_bodega_origen_cb

  // ---------- Validate tr_establecimiento_destino
  function do_ajax_control_nueva_transferencia_mob_validate_tr_establecimiento_destino()
  {
    var nomeCampo_tr_establecimiento_destino = "tr_establecimiento_destino";
    var var_tr_establecimiento_destino = scAjaxGetFieldSelect(nomeCampo_tr_establecimiento_destino);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_nueva_transferencia_mob_validate_tr_establecimiento_destino(var_tr_establecimiento_destino, var_script_case_init, do_ajax_control_nueva_transferencia_mob_validate_tr_establecimiento_destino_cb);
  } // do_ajax_control_nueva_transferencia_mob_validate_tr_establecimiento_destino

  function do_ajax_control_nueva_transferencia_mob_validate_tr_establecimiento_destino_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tr_establecimiento_destino";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_nueva_transferencia_mob_validate_tr_establecimiento_destino_cb

  // ---------- Validate tr_bodega_destino
  function do_ajax_control_nueva_transferencia_mob_validate_tr_bodega_destino()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_nueva_transferencia_mob_validate_tr_bodega_destino(var_tr_bodega_destino, var_script_case_init, do_ajax_control_nueva_transferencia_mob_validate_tr_bodega_destino_cb);
  } // do_ajax_control_nueva_transferencia_mob_validate_tr_bodega_destino

  function do_ajax_control_nueva_transferencia_mob_validate_tr_bodega_destino_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_nueva_transferencia_mob_validate_tr_bodega_destino_cb

  // ---------- Validate tr_comentario
  function do_ajax_control_nueva_transferencia_mob_validate_tr_comentario()
  {
    var nomeCampo_tr_comentario = "tr_comentario";
    var var_tr_comentario = scAjaxGetFieldText(nomeCampo_tr_comentario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_nueva_transferencia_mob_validate_tr_comentario(var_tr_comentario, var_script_case_init, do_ajax_control_nueva_transferencia_mob_validate_tr_comentario_cb);
  } // do_ajax_control_nueva_transferencia_mob_validate_tr_comentario

  function do_ajax_control_nueva_transferencia_mob_validate_tr_comentario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tr_comentario";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_nueva_transferencia_mob_validate_tr_comentario_cb

  // ---------- Refresh tr_establecimiento_origen
  function do_ajax_control_nueva_transferencia_mob_refresh_tr_establecimiento_origen()
  {
    var var_tr_establecimiento_origen = scAjaxGetFieldSelect("tr_establecimiento_origen");
    var var_nmgp_refresh_fields = "tr_bodega_origen";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_control_nueva_transferencia_mob_refresh_tr_establecimiento_origen(var_tr_establecimiento_origen, var_nmgp_refresh_fields, var_script_case_init, do_ajax_control_nueva_transferencia_mob_refresh_tr_establecimiento_origen_cb);
  } // do_ajax_control_nueva_transferencia_mob_refresh_tr_establecimiento_origen

  function do_ajax_control_nueva_transferencia_mob_refresh_tr_establecimiento_origen_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    do_ajax_control_nueva_transferencia_mob_refresh_tr_bodega_origen();
    scAjaxShowDebug();
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_nueva_transferencia_mob_refresh_tr_establecimiento_origen_cb

  // ---------- Refresh tr_bodega_origen
  function do_ajax_control_nueva_transferencia_mob_refresh_tr_bodega_origen()
  {
    var var_tr_bodega_origen = scAjaxGetFieldSelect("tr_bodega_origen");
    var var_tr_establecimiento_destino = scAjaxGetFieldSelect("tr_establecimiento_destino");
    var var_nmgp_refresh_fields = "tr_establecimiento_destino_#fld#_tr_bodega_destino";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_control_nueva_transferencia_mob_refresh_tr_bodega_origen(var_tr_bodega_origen, var_tr_establecimiento_destino, var_nmgp_refresh_fields, var_script_case_init, do_ajax_control_nueva_transferencia_mob_refresh_tr_bodega_origen_cb);
  } // do_ajax_control_nueva_transferencia_mob_refresh_tr_bodega_origen

  function do_ajax_control_nueva_transferencia_mob_refresh_tr_bodega_origen_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
    do_ajax_control_nueva_transferencia_mob_refresh_tr_establecimiento_destino();
    scAjaxShowDebug();
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_nueva_transferencia_mob_refresh_tr_bodega_origen_cb

  // ---------- Refresh tr_establecimiento_destino
  function do_ajax_control_nueva_transferencia_mob_refresh_tr_establecimiento_destino()
  {
    var var_tr_establecimiento_destino = scAjaxGetFieldSelect("tr_establecimiento_destino");
    var var_tr_bodega_origen = scAjaxGetFieldSelect("tr_bodega_origen");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_control_nueva_transferencia_mob_refresh_tr_establecimiento_destino(var_tr_establecimiento_destino, var_tr_bodega_origen, var_nmgp_refresh_fields, var_script_case_init, do_ajax_control_nueva_transferencia_mob_refresh_tr_establecimiento_destino_cb);
  } // do_ajax_control_nueva_transferencia_mob_refresh_tr_establecimiento_destino

  function do_ajax_control_nueva_transferencia_mob_refresh_tr_establecimiento_destino_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_nueva_transferencia_mob_refresh_tr_establecimiento_destino_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_nueva_transferencia_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_nueva_transferencia_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_tr_fecha = scAjaxGetFieldHidden("tr_fecha");
    var var_tr_establecimiento_origen = scAjaxGetFieldSelect("tr_establecimiento_origen");
    var var_tr_bodega_origen = scAjaxGetFieldSelect("tr_bodega_origen");
    var var_tr_establecimiento_destino = scAjaxGetFieldSelect("tr_establecimiento_destino");
    var var_tr_bodega_destino = scAjaxGetFieldSelect("tr_bodega_destino");
    var var_tr_comentario = scAjaxGetFieldText("tr_comentario");
    ...
    scAjaxProcOn();
    x_ajax_control_nueva_transferencia_mob_submit_form(var_tr_fecha, var_tr_establecimiento_origen, var_tr_bodega_origen, var_tr_establecimiento_destino, var_tr_bodega_destino, var_tr_comentario, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_nueva_transferencia_mob_submit_form_cb);
  } // do_ajax_control_nueva_transferencia_mob_submit_form

  function do_ajax_control_nueva_transferencia_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_nueva_transferencia_mob_submit_form_cb_after_alert);
  } // do_ajax_control_nueva_transferencia_mob_submit_form_cb
  function do_ajax_control_nueva_transferencia_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_nueva_transferencia_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_nueva_transferencia_mob_navigate_form()
  {
    perform_ajax_control_nueva_transferencia_mob_navigate_form();
  }

  function perform_ajax_control_nueva_transferencia_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_nueva_transferencia_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_transferencia_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_nueva_transferencia_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_nueva_transferencia_mob_navigate_form_cb_after_alert);
  } // do_ajax_control_nueva_transferencia_mob_navigate_form_cb
  function do_ajax_control_nueva_transferencia_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_nueva_transferencia_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_nueva_transferencia_mob_navigate_form_cb_after_alert

  function sc_hide_control_nueva_transferencia_mob_form()
  {
  ...
  ajax_field_list[1] = "tr_establecimiento_origen";
  ajax_field_list[2] = "tr_bodega_origen";
  ajax_field_list[3] = "tr_establecimiento_destino";
  ajax_field_list[4] = "tr_bodega_destino";
  ajax_field_list[5] = "tr_comentario";
  ...
  var ajax_error_list = {
    ...
    "tr_establecimiento_origen": {"label": "<?php echo $this->Ini->Nm_lang['lang_establecimiento'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "tr_establecimiento_destino": {"label": "<?php echo $this->Ini->Nm_lang['lang_establecimiento'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "tr_comentario": {"label": "<?php echo $this->Ini->Nm_lang['lang_comentario'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "tr_fecha": new Array(),
    "tr_establecimiento_origen": new Array(),
    "tr_bodega_origen": new Array(),
    "tr_establecimiento_destino": new Array(),
    "tr_bodega_destino": new Array(),
    "tr_comentario": new Array()
  };
  ajax_field_mult["tr_fecha"][1] = "tr_fecha";
  ajax_field_mult["tr_establecimiento_origen"][1] = "tr_establecimiento_origen";
  ajax_field_mult["tr_bodega_origen"][1] = "tr_bodega_origen";
  ajax_field_mult["tr_establecimiento_destino"][1] = "tr_establecimiento_destino";
  ajax_field_mult["tr_bodega_destino"][1] = "tr_bodega_destino";
  ajax_field_mult["tr_comentario"][1] = "tr_comentario";

  var ajax_field_id = {
    "tr_fecha": new Array("hidden_field_label_tr_fecha", "hidden_field_data_tr_fecha"),
    "tr_establecimiento_origen": new Array("hidden_field_label_tr_establecimiento_origen", "hidden_field_data_tr_establecimiento_origen"),
    "tr_bodega_origen": new Array("hidden_field_label_tr_bodega_origen", "hidden_field_data_tr_bodega_origen"),
    "tr_establecimiento_destino": new Array("hidden_field_label_tr_establecimiento_destino", "hidden_field_data_tr_establecimiento_destino"),
    "tr_bodega_destino": new Array("hidden_field_label_tr_bodega_destino", "hidden_field_data_tr_bodega_destino"),
    "tr_comentario": new Array("hidden_field_label_tr_comentario", "hidden_field_data_tr_comentario")
  };

  var ajax_read_only = {
    "tr_fecha": "off",
    "tr_establecimiento_origen": "off",
    "tr_bodega_origen": "off",
    "tr_establecimiento_destino": "off",
    "tr_bodega_destino": "off",
    "tr_comentario": "off"
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("tr_establecimiento_origen" == sIndex)
    {
    ...
    if ("tr_establecimiento_destino" == sIndex)
    {
      scAjaxSetFieldSelect(sIndex, aValue, null);
      updateHeaderFooter(sIndex, aValue);
