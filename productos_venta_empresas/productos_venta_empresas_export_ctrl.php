<?php
@session_start() ;
$_SESSION['scriptcase']['productos_venta_empresas']['sc_process_barr'] = true;
require_once('../productos_venta_empresas/index.php');
unset($_SESSION['scriptcase']['productos_venta_empresas']['sc_process_barr']);
$ExportCtrl = new productos_venta_empresas_export_control;
$ExportCtrl->Export_barr();

class productos_venta_empresas_export_control
{
