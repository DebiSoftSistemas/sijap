  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_libretin_fisico_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_libretin_fisico_mob_form();
	}
...
?>
  ...
  // ---------- Validate lib_id
  function do_ajax_form_del_libretin_fisico_mob_validate_lib_id()
  {
    var nomeCampo_lib_id = "lib_id";
    var var_lib_id = scAjaxGetFieldHidden(nomeCampo_lib_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_libretin_fisico_mob_validate_lib_id(var_lib_id, var_script_case_init, do_ajax_form_del_libretin_fisico_mob_validate_lib_id_cb);
  } // do_ajax_form_del_libretin_fisico_mob_validate_lib_id

  function do_ajax_form_del_libretin_fisico_mob_validate_lib_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_libretin_fisico_mob_validate_lib_id_cb

  // ---------- Validate lib_punto_emision
  function do_ajax_form_del_libretin_fisico_mob_validate_lib_punto_emision()
  {
    var nomeCampo_lib_punto_emision = "lib_punto_emision";
    var var_lib_punto_emision = scAjaxGetFieldHidden(nomeCampo_lib_punto_emision);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_libretin_fisico_mob_validate_lib_punto_emision(var_lib_punto_emision, var_script_case_init, do_ajax_form_del_libretin_fisico_mob_validate_lib_punto_emision_cb);
  } // do_ajax_form_del_libretin_fisico_mob_validate_lib_punto_emision

  function do_ajax_form_del_libretin_fisico_mob_validate_lib_punto_emision_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_libretin_fisico_mob_validate_lib_punto_emision_cb

  // ---------- Validate lib_tipo_comprobante
  function do_ajax_form_del_libretin_fisico_mob_validate_lib_tipo_comprobante()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_libretin_fisico_mob_validate_lib_tipo_comprobante(var_lib_tipo_comprobante, var_script_case_init, do_ajax_form_del_libretin_fisico_mob_validate_lib_tipo_comprobante_cb);
  } // do_ajax_form_del_libretin_fisico_mob_validate_lib_tipo_comprobante

  function do_ajax_form_del_libretin_fisico_mob_validate_lib_tipo_comprobante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_libretin_fisico_mob_validate_lib_tipo_comprobante_cb

  // ---------- Validate lib_desde
  function do_ajax_form_del_libretin_fisico_mob_validate_lib_desde()
  {
    var nomeCampo_lib_desde = "lib_desde";
    var var_lib_desde = scAjaxGetFieldText(nomeCampo_lib_desde);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_libretin_fisico_mob_validate_lib_desde(var_lib_desde, var_script_case_init, do_ajax_form_del_libretin_fisico_mob_validate_lib_desde_cb);
  } // do_ajax_form_del_libretin_fisico_mob_validate_lib_desde

  function do_ajax_form_del_libretin_fisico_mob_validate_lib_desde_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_libretin_fisico_mob_validate_lib_desde_cb

  // ---------- Validate lib_hasta
  function do_ajax_form_del_libretin_fisico_mob_validate_lib_hasta()
  {
    var nomeCampo_lib_hasta = "lib_hasta";
    var var_lib_hasta = scAjaxGetFieldText(nomeCampo_lib_hasta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_libretin_fisico_mob_validate_lib_hasta(var_lib_hasta, var_script_case_init, do_ajax_form_del_libretin_fisico_mob_validate_lib_hasta_cb);
  } // do_ajax_form_del_libretin_fisico_mob_validate_lib_hasta

  function do_ajax_form_del_libretin_fisico_mob_validate_lib_hasta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_libretin_fisico_mob_validate_lib_hasta_cb

  // ---------- Validate lib_secuencial
  function do_ajax_form_del_libretin_fisico_mob_validate_lib_secuencial()
  {
    var nomeCampo_lib_secuencial = "lib_secuencial";
    var var_lib_secuencial = scAjaxGetFieldText(nomeCampo_lib_secuencial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_libretin_fisico_mob_validate_lib_secuencial(var_lib_secuencial, var_script_case_init, do_ajax_form_del_libretin_fisico_mob_validate_lib_secuencial_cb);
  } // do_ajax_form_del_libretin_fisico_mob_validate_lib_secuencial

  function do_ajax_form_del_libretin_fisico_mob_validate_lib_secuencial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_libretin_fisico_mob_validate_lib_secuencial_cb

  // ---------- Validate lib_autorizacion
  function do_ajax_form_del_libretin_fisico_mob_validate_lib_autorizacion()
  {
    var nomeCampo_lib_autorizacion = "lib_autorizacion";
    var var_lib_autorizacion = scAjaxGetFieldText(nomeCampo_lib_autorizacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_libretin_fisico_mob_validate_lib_autorizacion(var_lib_autorizacion, var_script_case_init, do_ajax_form_del_libretin_fisico_mob_validate_lib_autorizacion_cb);
  } // do_ajax_form_del_libretin_fisico_mob_validate_lib_autorizacion

  function do_ajax_form_del_libretin_fisico_mob_validate_lib_autorizacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_libretin_fisico_mob_validate_lib_autorizacion_cb

  // ---------- Validate lib_fecha_caducidad
  function do_ajax_form_del_libretin_fisico_mob_validate_lib_fecha_caducidad()
  {
    ...
    setTimeout(function() {
      var var_lib_fecha_caducidad = scAjaxGetFieldText(nomeCampo_lib_fecha_caducidad);
      x_ajax_form_del_libretin_fisico_mob_validate_lib_fecha_caducidad(var_lib_fecha_caducidad, var_script_case_init, do_ajax_form_del_libretin_fisico_mob_validate_lib_fecha_caducidad_cb);
    }, 200);
  } // do_ajax_form_del_libretin_fisico_mob_validate_lib_fecha_caducidad

  function do_ajax_form_del_libretin_fisico_mob_validate_lib_fecha_caducidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_libretin_fisico_mob_validate_lib_fecha_caducidad_cb

  // ---------- Validate lib_estado
  function do_ajax_form_del_libretin_fisico_mob_validate_lib_estado()
  {
    var nomeCampo_lib_estado = "lib_estado";
    var var_lib_estado = scAjaxGetFieldText(nomeCampo_lib_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_libretin_fisico_mob_validate_lib_estado(var_lib_estado, var_script_case_init, do_ajax_form_del_libretin_fisico_mob_validate_lib_estado_cb);
  } // do_ajax_form_del_libretin_fisico_mob_validate_lib_estado

  function do_ajax_form_del_libretin_fisico_mob_validate_lib_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_libretin_fisico_mob_validate_lib_estado_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_libretin_fisico_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_libretin_fisico_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_lib_id = scAjaxGetFieldHidden("lib_id");
    var var_lib_punto_emision = scAjaxGetFieldHidden("lib_punto_emision");
    ...
    var var_lib_estado = scAjaxGetFieldText("lib_estado");
    ...
    scAjaxProcOn();
    x_ajax_form_del_libretin_fisico_mob_submit_form(var_lib_id, var_lib_punto_emision, var_lib_tipo_comprobante, var_lib_desde, var_lib_hasta, var_lib_secuencial, var_lib_autorizacion, var_lib_fecha_caducidad, var_lib_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_libretin_fisico_mob_submit_form_cb);
  } // do_ajax_form_del_libretin_fisico_mob_submit_form

  function do_ajax_form_del_libretin_fisico_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_libretin_fisico_mob_submit_form_cb_after_alert);
  } // do_ajax_form_del_libretin_fisico_mob_submit_form_cb
  function do_ajax_form_del_libretin_fisico_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_libretin_fisico_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_libretin_fisico_mob_navigate_form()
  {
    perform_ajax_form_del_libretin_fisico_mob_navigate_form();
  }

  function perform_ajax_form_del_libretin_fisico_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_del_libretin_fisico_mob_navigate_form(var_lib_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_libretin_fisico_mob_navigate_form_cb);
  } // do_ajax_form_del_libretin_fisico_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin_fisico_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_libretin_fisico_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_libretin_fisico_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_del_libretin_fisico_mob_navigate_form_cb
  function do_ajax_form_del_libretin_fisico_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_del_libretin_fisico_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_libretin_fisico_mob_navigate_form_cb_after_alert

  function sc_hide_form_del_libretin_fisico_mob_form()
  {
  ...
  ajax_field_list[1] = "lib_punto_emision";
  ajax_field_list[2] = "lib_tipo_comprobante";
  ajax_field_list[3] = "lib_desde";
  ajax_field_list[4] = "lib_hasta";
  ajax_field_list[5] = "lib_secuencial";
  ajax_field_list[6] = "lib_autorizacion";
  ajax_field_list[7] = "lib_fecha_caducidad";
  ajax_field_list[8] = "lib_estado";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "lib_id": {"label": "Lib Id", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
