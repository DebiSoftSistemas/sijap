  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_jap_parametros" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_jap_parametros_form();
	}
...
?>
  ...
  // ---------- Validate par_id_
  function do_ajax_form_jap_parametros_validate_par_id_(iNumLinha)
  {
    var nomeCampo_par_id_ = "par_id_" + iNumLinha;
    var var_par_id_ = scAjaxGetFieldHidden(nomeCampo_par_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_parametros_validate_par_id_(var_par_id_, iNumLinha, var_script_case_init, do_ajax_form_jap_parametros_validate_par_id__cb);
  } // do_ajax_form_jap_parametros_validate_par_id_

  function do_ajax_form_jap_parametros_validate_par_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_parametros_validate_par_id__cb

  // ---------- Validate par_pametro_
  function do_ajax_form_jap_parametros_validate_par_pametro_(iNumLinha)
  {
    var nomeCampo_par_pametro_ = "par_pametro_" + iNumLinha;
    var var_par_pametro_ = scAjaxGetFieldSelect(nomeCampo_par_pametro_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_parametros_validate_par_pametro_(var_par_pametro_, iNumLinha, var_script_case_init, do_ajax_form_jap_parametros_validate_par_pametro__cb);
  } // do_ajax_form_jap_parametros_validate_par_pametro_

  function do_ajax_form_jap_parametros_validate_par_pametro__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_parametros_validate_par_pametro__cb

  // ---------- Validate par_valor_
  function do_ajax_form_jap_parametros_validate_par_valor_(iNumLinha)
  {
    var nomeCampo_par_valor_ = "par_valor_" + iNumLinha;
    var var_par_valor_ = scAjaxGetFieldText(nomeCampo_par_valor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_parametros_validate_par_valor_(var_par_valor_, iNumLinha, var_script_case_init, do_ajax_form_jap_parametros_validate_par_valor__cb);
  } // do_ajax_form_jap_parametros_validate_par_valor_

  function do_ajax_form_jap_parametros_validate_par_valor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_parametros_validate_par_valor__cb

  // ---------- Validate par_tipo_
  function do_ajax_form_jap_parametros_validate_par_tipo_(iNumLinha)
  {
    var nomeCampo_par_tipo_ = "par_tipo_" + iNumLinha;
    var var_par_tipo_ = scAjaxGetFieldSelect(nomeCampo_par_tipo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_parametros_validate_par_tipo_(var_par_tipo_, iNumLinha, var_script_case_init, do_ajax_form_jap_parametros_validate_par_tipo__cb);
  } // do_ajax_form_jap_parametros_validate_par_tipo_

  function do_ajax_form_jap_parametros_validate_par_tipo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_parametros_validate_par_tipo__cb

  // ---------- Validate par_empresa_
  function do_ajax_form_jap_parametros_validate_par_empresa_(iNumLinha)
  {
    var nomeCampo_par_empresa_ = "par_empresa_" + iNumLinha;
    var var_par_empresa_ = scAjaxGetFieldText(nomeCampo_par_empresa_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_parametros_validate_par_empresa_(var_par_empresa_, iNumLinha, var_script_case_init, do_ajax_form_jap_parametros_validate_par_empresa__cb);
  } // do_ajax_form_jap_parametros_validate_par_empresa_

  function do_ajax_form_jap_parametros_validate_par_empresa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_parametros_validate_par_empresa__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_jap_parametros_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_jap_parametros_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_jap_parametros_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_jap_parametros_add_new_line_cb);
  } // do_ajax_form_jap_parametros_add_new_line

  function do_ajax_form_jap_parametros_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_jap_parametros_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_jap_parametros_backup_line(iNumLinha)
  {
    var var_par_id_ = scAjaxGetFieldHidden("par_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_parametros_backup_line(var_par_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_jap_parametros_backup_line_cb);
  } // do_ajax_form_jap_parametros_backup_line

  function do_ajax_form_jap_parametros_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_jap_parametros_backup_line_cb

  function do_ajax_form_jap_parametros_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_jap_parametros_cancel_insert

  function do_ajax_form_jap_parametros_cancel_update(iSeqVert)
  {
    do_ajax_form_jap_parametros_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_jap_parametros_cancel_update

  function do_ajax_form_jap_parametros_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_jap_parametros_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_jap_parametros_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_jap_parametros_table_refresh(var_par_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jap_parametros_table_refresh_cb);
  } //  do_ajax_form_jap_parametros_table_refresh

  function do_ajax_form_jap_parametros_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_jap_parametros_table_refresh_cb_after_alert);
  } // do_ajax_form_jap_parametros_table_refresh_cb
  function do_ajax_form_jap_parametros_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_jap_parametros_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_jap_parametros_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_jap_parametros_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_jap_parametros_submit_form(var_par_id_, var_par_pametro_, var_par_valor_, var_par_tipo_, var_par_empresa_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_jap_parametros_submit_form_cb);
  } // do_ajax_form_jap_parametros_submit_form

  function do_ajax_form_jap_parametros_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_jap_parametros_submit_form_cb_after_alert);
  } // do_ajax_form_jap_parametros_submit_form_cb
  function do_ajax_form_jap_parametros_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_jap_parametros_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_jap_parametros_navigate_form()
  {
    perform_ajax_form_jap_parametros_navigate_form();
  }

  function perform_ajax_form_jap_parametros_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_jap_parametros_cancel_insert(sc_form_jap_parametros_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_jap_parametros_navigate_form(var_par_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jap_parametros_navigate_form_cb);
  } // do_ajax_form_jap_parametros_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_parametros']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_jap_parametros_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_jap_parametros_navigate_form_cb_after_alert);
  } // do_ajax_form_jap_parametros_navigate_form_cb
  function do_ajax_form_jap_parametros_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_jap_parametros_navigate_form_cb_after_alert

    function sc_form_jap_parametros_get_last_line_number()
    {
    ...
    } //sc_form_jap_parametros_get_last_line_number

  function sc_hide_form_jap_parametros_form()
  {
