...
*/
    ...
    $SC_apl_proc = "chart_del_factura_compra";
    $SC_ver_93   = true;
    $SC_conf_opt = explode(",","cor_imp,papel,orientacao,bookmarks,all_cab,page_break");
/* sc_apl_default */
...
// Charts
        ...
        $isMultiSeriesChart = $is_chart_app && (!isset($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['summarizing_drill_down']) || !$_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['summarizing_drill_down']);
        $isAnalitic         = isset($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['graf_opc_atual']) && 2 == $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['graf_opc_atual'];

if ($ver_93 == "n")
{
          $sDisplay = !isset($_SESSION['sc_session']['chart_del_factura_compra']['show_skip_charts_option']) ||
                     !$_SESSION['sc_session']['chart_del_factura_compra']['show_skip_charts_option'] ||
                     (isset($_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['SC_Ind_Groupby']) && '_NM_SC_' == $_SESSION['sc_session'][$script_case_init]['chart_del_factura_compra']['SC_Ind_Groupby']) ||
                     $isMultiSeriesChart ||
                     $isAnalitic ||
                     ($opc == 'pdf_det')
                     ? ' style="display: none"' : '';
...
<?php
        ...
        {
         $sDisplay =
//                    !isset($_SESSION['sc_session']['chart_del_factura_compra']['show_skip_charts_option']) ||
//                    !$_SESSION['sc_session']['chart_del_factura_compra']['show_skip_charts_option'] ||
                    $isMultiSeriesChart ||
                    $isAnalitic ||
