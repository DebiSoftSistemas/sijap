...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_fac_cuotas_convenio"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_fac_cuotas_convenio"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_fac_cuotas_convenio'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_fac_cuotas_convenio']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_fac_cuotas_convenio']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_fac_cuotas_convenio']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_fac_cuotas_convenio']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_fac_cuotas_convenio']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_fac_cuotas_convenio</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_fac_cuotas_convenio']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_fac_cuotas_convenio']['embutida_filho'] as $ind => $sc_init)
          {
