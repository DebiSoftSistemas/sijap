...
class grid_fac_cuotas_convenio_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_fac_cuotas_convenio.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['rtf_name']);
      }
   ...
   function NM_export_cc_cuota()
   {
         ...
         $this->cc_cuota = str_replace('<', '&lt;', $this->cc_cuota);
         $this->cc_cuota = str_replace('>', '&gt;', $this->cc_cuota);
         $this->Texto_tag .= "<td>" . $this->cc_cuota . "</td>\r\n";
   }
   //----- cc_fecha
   function NM_export_cc_fecha()
   {
         ...
         $this->cc_fecha = NM_charset_to_utf8($this->cc_fecha);
         $this->cc_fecha = str_replace('<', '&lt;', $this->cc_fecha);
         $this->cc_fecha = str_replace('>', '&gt;', $this->cc_fecha);
         $this->Texto_tag .= "<td>" . $this->cc_fecha . "</td>\r\n";
   }
   //----- cc_producto
   function NM_export_cc_producto()
   {
         ...
         $this->look_cc_producto = str_replace('<', '&lt;', $this->look_cc_producto);
         $this->look_cc_producto = str_replace('>', '&gt;', $this->look_cc_producto);
         $this->Texto_tag .= "<td>" . $this->look_cc_producto . "</td>\r\n";
   }
   //----- cc_capital
   function NM_export_cc_capital()
   {
         ...
         $this->cc_capital = str_replace('>', '&gt;', $this->cc_capital);
         $this->Texto_tag .= "<td>" . $this->cc_capital . "</td>\r\n";
   }
   //----- cc_interes
   function NM_export_cc_interes()
   {
         ...
         $this->cc_interes = str_replace('>', '&gt;', $this->cc_interes);
         $this->Texto_tag .= "<td>" . $this->cc_interes . "</td>\r\n";
   }
   //----- cc_valor_iva
   function NM_export_cc_valor_iva()
   {
         ...
         $this->cc_valor_iva = str_replace('<', '&lt;', $this->cc_valor_iva);
         $this->cc_valor_iva = str_replace('>', '&gt;', $this->cc_valor_iva);
         $this->Texto_tag .= "<td>" . $this->cc_valor_iva . "</td>\r\n";
   }
   //----- cc_valor_cuota
   function NM_export_cc_valor_cuota()
   {
         ...
         $this->cc_valor_cuota = str_replace('>', '&gt;', $this->cc_valor_cuota);
         $this->Texto_tag .= "<td>" . $this->cc_valor_cuota . "</td>\r\n";
   }
   //----- cc_id
   function NM_export_cc_id()
   {
         ...
         $this->cc_id = str_replace('<', '&lt;', $this->cc_id);
         $this->cc_id = str_replace('>', '&gt;', $this->cc_id);
         $this->Texto_tag .= "<td>" . $this->cc_id . "</td>\r\n";
   }
   //----- cc_convenio
   function NM_export_cc_convenio()
   {
         ...
         $this->cc_convenio = str_replace('<', '&lt;', $this->cc_convenio);
         $this->cc_convenio = str_replace('>', '&gt;', $this->cc_convenio);
         $this->Texto_tag .= "<td>" . $this->cc_convenio . "</td>\r\n";
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> fac_cuotas_convenio :: RTF</TITLE>
