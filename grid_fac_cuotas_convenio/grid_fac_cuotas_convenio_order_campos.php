...
<?php
   ...
   $Ord_Cmp = new grid_fac_cuotas_convenio_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_fac_cuotas_convenio_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_convenio']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_convenio']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['cc_cuota'] = "cc_cuota";
   $tab_labels["cc_cuota"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_convenio']['labels']["cc_cuota"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_convenio']['labels']["cc_cuota"] : "" . $this->Nm_lang['lang_cuota_nro'] . "";
   $tab_ger_campos['cc_fecha'] = "on";
   $tab_def_campos['cc_fecha'] = "cc_fecha";
   $tab_labels["cc_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_convenio']['labels']["cc_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_convenio']['labels']["cc_fecha"] : "" . $this->Nm_lang['lang_fecha'] . "";
   $tab_ger_campos['cc_producto'] = "on";
   $tab_def_campos['cc_producto'] = "cc_producto";
   $tab_labels["cc_producto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_convenio']['labels']["cc_producto"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_convenio']['labels']["cc_producto"] : "" . $this->Nm_lang['lang_producto'] . "";
   $tab_ger_campos['cc_capital'] = "on";
   $tab_def_campos['cc_capital'] = "cc_capital";
   $tab_labels["cc_capital"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_convenio']['labels']["cc_capital"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_convenio']['labels']["cc_capital"] : "" . $this->Nm_lang['lang_capital'] . "";
   $tab_ger_campos['cc_interes'] = "on";
   $tab_def_campos['cc_interes'] = "cc_interes";
   $tab_labels["cc_interes"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_convenio']['labels']["cc_interes"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_convenio']['labels']["cc_interes"] : "" . $this->Nm_lang['lang_interes'] . "";
   $tab_ger_campos['cc_valor_iva'] = "on";
   $tab_def_campos['cc_valor_iva'] = "cc_valor_iva";
   $tab_labels["cc_valor_iva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_convenio']['labels']["cc_valor_iva"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_convenio']['labels']["cc_valor_iva"] : "" . $this->Nm_lang['lang_iva'] . "";
   $tab_ger_campos['cc_valor_cuota'] = "on";
   $tab_def_campos['cc_valor_cuota'] = "cc_valor_cuota";
   $tab_labels["cc_valor_cuota"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_convenio']['labels']["cc_valor_cuota"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_convenio']['labels']["cc_valor_cuota"] : "" . $this->Nm_lang['lang_valor_pago'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_convenio']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_convenio']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_convenio']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_convenio']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_convenio']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_convenio']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_convenio']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_convenio']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_convenio']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_convenio']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_convenio']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_convenio']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_fac_cuotas_convenio_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_convenio']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_convenio']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_convenio']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_convenio']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_convenio']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
