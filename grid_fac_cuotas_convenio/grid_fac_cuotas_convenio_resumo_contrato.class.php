...
class grid_fac_cuotas_convenio_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $array_total_cc_contrato;
   var $array_total_cc_cuota;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_cc_contrato = array();
      $this->array_total_cc_cuota    = array();
...
SCEOT;
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_fac_cuotas_convenio']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_fac_cuotas_convenio']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['where_resumo'] = "";
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['contr_total_geral'] == "OK")
      {
          $this->array_total_cc_contrato = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['arr_total']['cc_contrato'];
          $this->array_total_cc_cuota = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['arr_total']['cc_cuota'];
      }
      else
      {
          $this->array_total_cc_contrato = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['tot_geral'][2];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['tot_geral'][3];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['tot_geral'][4];
      $this->array_total_geral[3] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['tot_geral'][5];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['arr_total']['cc_contrato'] = $this->array_total_cc_contrato;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['arr_total']['cc_cuota'] = $this->array_total_cc_cuota;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['json_use_label'])
       {
          $Lab_cc_contrato = "cc_contrato";
          $Lab_cc_cuota = "cc_cuota";
       }
       else
       {
       $Lab_cc_contrato = "Cc Contrato";
       $Lab_cc_cuota = "" . $this->Ini->Nm_lang['lang_cuota_nro'] . "";
       }
       $this->comp_field = array(
           $Lab_cc_contrato,
           $Lab_cc_cuota,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['labels']['cc_cuota']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['labels']['cc_cuota'] = "" . $this->Ini->Nm_lang['lang_cuota_nro'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['labels']['cc_fecha']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['labels']['cc_fecha'] = "" . $this->Ini->Nm_lang['lang_fecha'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['labels']['cc_producto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['labels']['cc_producto'] = "" . $this->Ini->Nm_lang['lang_producto'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['labels']['cc_capital']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['labels']['cc_capital'] = "" . $this->Ini->Nm_lang['lang_capital'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['labels']['cc_interes']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['labels']['cc_interes'] = "" . $this->Ini->Nm_lang['lang_interes'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['labels']['cc_valor_iva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['labels']['cc_valor_iva'] = "" . $this->Ini->Nm_lang['lang_iva'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['labels']['cc_valor_cuota']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['labels']['cc_valor_cuota'] = "" . $this->Ini->Nm_lang['lang_valor_pago'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['labels']['cc_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['labels']['cc_id'] = "Cc Id"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['labels']['cc_convenio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['labels']['cc_convenio'] = "Cc Convenio"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['labels']['cc_porcentaje_iva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['labels']['cc_porcentaje_iva'] = "Cc Porcentaje Iva"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['labels']['cc_contrato']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['labels']['cc_contrato'] = "Cc Contrato"; 
       }
       //-----
       $this->comp_field_nm = array(
           'cc_contrato' => 0,
       ...
       //-----
       $this->comp_sum = array(
           2 => "" .  $this->Ini->Nm_lang['lang_capital'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           3 => "" .  $this->Ini->Nm_lang['lang_interes'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           4 => "" .  $this->Ini->Nm_lang['lang_iva'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           5 => "" .  $this->Ini->Nm_lang['lang_valor_pago'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['summarizing_fields_order']['contrato']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['summarizing_fields_order']['contrato'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['summarizing_fields_order']['contrato'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['summarizing_fields_display']['contrato'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['summarizing_fields_display']['contrato'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['summarizing_fields_display']['contrato'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['summarizing_fields_display']['contrato'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['summarizing_fields_display']['contrato'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['summarizing_fields_display']['contrato'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['summarizing_fields_display']['contrato'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "cc_capital", 'show' => true),
           3 => array('field' => "cc_interes", 'show' => true),
           4 => array('field' => "cc_valor_iva", 'show' => true),
           5 => array('field' => "cc_valor_cuota", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "css_cc_capital_sum",
           3 => "css_cc_interes_sum",
           4 => "css_cc_valor_iva_sum",
           5 => "css_cc_valor_cuota_sum",
       );
       ...
       $this->comp_sum_nm = array(
           ...
           3 => "cc_interes_sum",
           4 => "cc_valor_iva_sum",
           5 => "cc_valor_cuota_sum",
       );

       //-----
       foreach ($this->array_total_cc_contrato as $i_cc_contrato => $d_cc_contrato) {
           if (!isset($i_cc_contrato, $this->comp_label[0]) || !in_array($i_cc_contrato, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_cc_contrato[6] ] = $d_cc_contrato[5];
               $this->comp_label[0][ $d_cc_contrato[6] ] = $d_cc_contrato[5];
           }
           foreach ($this->array_total_cc_cuota[$i_cc_contrato] as $i_cc_cuota => $d_cc_cuota) {
               if (!isset($i_cc_cuota, $this->comp_label[1][ $d_cc_contrato[6] ]) || !in_array($i_cc_cuota, $this->comp_label[1][ $d_cc_contrato[6] ], true)) {
                   $this->comp_index[1][ $d_cc_cuota[6] ] = $d_cc_cuota[5];
                   $this->comp_label[1][ $d_cc_contrato[6] ][ $d_cc_cuota[6] ] = $d_cc_cuota[5];
               }
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'cc_contrato', 'prot' => ''),
           array('name' => 'cc_cuota', 'prot' => ''),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_tabular_label'];
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_cc_contrato => $l_cc_contrato) {
           if (isset($this->array_total_cc_contrato[$i_cc_contrato])) {
               $this->comp_group[$i_cc_contrato] = array();
           }
           foreach ($this->comp_label[1][$i_cc_contrato] as $i_cc_cuota => $l_cc_cuota) {
               if (isset($this->array_total_cc_cuota[$i_cc_contrato][$i_cc_cuota])) {
                   $this->comp_group[$i_cc_contrato][$i_cc_cuota] = array();
               }
           }
       }
     }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_cc_contrato;
       }
       elseif (1 == $level) {
           $return = $this->array_total_cc_cuota;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_fac_cuotas_convenio@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_fac_cuotas_convenio_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['arr_total'][$cmp_gb];
      }
      if (is_array($this->array_total_cc_contrato)) {
          ksort($this->array_total_cc_contrato);
      }
      if (is_array($this->array_total_cc_cuota)) {
          ksort($this->array_total_cc_cuota);
      }
   }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['dashboard_refresh_after_chart'] = 'resumo';
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>" . $this->Ini->Nm_lang['lang_othr_smry_title'] . " fac_cuotas_convenio</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['doc_word'])
{
      ...
      { 
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['ajax_nav']) {  
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_fac_cuotas_convenio_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_fac_cuotas_convenio_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_fac_cuotas_convenio_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_fac_cuotas_convenio/grid_fac_cuotas_convenio_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "grid_fac_cuotas_convenio/grid_fac_cuotas_convenio_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid&nm_all_modules=grid&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_fac_cuotas_convenio/grid_fac_cuotas_convenio_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_fac_cuotas_convenio&nm_tp_xls=xlsx&nm_tot_xls=N&nm_tot_xls=N&nm_res_cons=s&nm_ini_xls_res=grid&nm_all_modules=grid&password=n&summary_export_columns=S&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_fac_cuotas_convenio_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_fac_cuotas_convenio']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_fac_cuotas_convenio']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_fac_cuotas_convenio_config_pivot.php?nome_apl=grid_fac_cuotas_convenio&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"grid_fac_cuotas_convenio_iframe.php\";\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_fac_cuotas_convenio_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_fac_cuotas_convenio/grid_fac_cuotas_convenio_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_convenio']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $cc_id = (isset($Busca_temp['cc_id'])) ? $Busca_temp['cc_id'] : ""; 
          $tmp_pos = (is_string($cc_id)) ? strpos($cc_id, "##@@") : false;
          if ($tmp_pos !== false && !is_array($cc_id))
          {
              $cc_id = substr($cc_id, 0, $tmp_pos);
          }
          $cc_convenio = (isset($Busca_temp['cc_convenio'])) ? $Busca_temp['cc_convenio'] : ""; 
          $tmp_pos = (is_string($cc_convenio)) ? strpos($cc_convenio, "##@@") : false;
          if ($tmp_pos !== false && !is_array($cc_convenio))
          {
              $cc_convenio = substr($cc_convenio, 0, $tmp_pos);
          }
          $cc_cuota = (isset($Busca_temp['cc_cuota'])) ? $Busca_temp['cc_cuota'] : ""; 
          $tmp_pos = (is_string($cc_cuota)) ? strpos($cc_cuota, "##@@") : false;
          if ($tmp_pos !== false && !is_array($cc_cuota))
          {
              $cc_cuota = substr($cc_cuota, 0, $tmp_pos);
          }
          $cc_fecha = (isset($Busca_temp['cc_fecha'])) ? $Busca_temp['cc_fecha'] : ""; 
          $tmp_pos = (is_string($cc_fecha)) ? strpos($cc_fecha, "##@@") : false;
          if ($tmp_pos !== false && !is_array($cc_fecha))
          {
              $cc_fecha = substr($cc_fecha, 0, $tmp_pos);
          }
      } 
   ...
   //---- 
   function adiciona_registro($sum_cc_capital, $sum_cc_interes, $sum_cc_valor_iva, $sum_cc_valor_cuota, $quebra_cc_contrato, $quebra_cc_cuota, $quebra_cc_contrato_orig, $quebra_cc_cuota_orig)
   {
      //----- Cc Contrato
      if (!isset($this->array_total_cc_contrato[$quebra_cc_contrato_orig]))
      {
         $this->array_total_cc_contrato[$quebra_cc_contrato_orig][0] = 1;
         $this->array_total_cc_contrato[$quebra_cc_contrato_orig][1] = $sum_cc_capital;
         $this->array_total_cc_contrato[$quebra_cc_contrato_orig][2] = $sum_cc_interes;
         $this->array_total_cc_contrato[$quebra_cc_contrato_orig][3] = $sum_cc_valor_iva;
         $this->array_total_cc_contrato[$quebra_cc_contrato_orig][4] = $sum_cc_valor_cuota;
         $this->array_total_cc_contrato[$quebra_cc_contrato_orig][5] = $quebra_cc_contrato;
         $this->array_total_cc_contrato[$quebra_cc_contrato_orig][6] = $quebra_cc_contrato_orig;
      }
      else
      {
         $this->array_total_cc_contrato[$quebra_cc_contrato_orig][0]++;
         $this->array_total_cc_contrato[$quebra_cc_contrato_orig][1] = bcadd($this->array_total_cc_contrato[$quebra_cc_contrato_orig][1], $sum_cc_capital, 10);
         $this->array_total_cc_contrato[$quebra_cc_contrato_orig][2] = bcadd($this->array_total_cc_contrato[$quebra_cc_contrato_orig][2], $sum_cc_interes, 10);
         $this->array_total_cc_contrato[$quebra_cc_contrato_orig][3] = bcadd($this->array_total_cc_contrato[$quebra_cc_contrato_orig][3], $sum_cc_valor_iva, 10);
         $this->array_total_cc_contrato[$quebra_cc_contrato_orig][4] = bcadd($this->array_total_cc_contrato[$quebra_cc_contrato_orig][4], $sum_cc_valor_cuota, 10);
      }
      //----- cc_cuota
      if (!isset($this->array_total_cc_cuota[$quebra_cc_contrato_orig][$quebra_cc_cuota_orig]))
      {
         $this->array_total_cc_cuota[$quebra_cc_contrato_orig][$quebra_cc_cuota_orig][0] = 1;
         $this->array_total_cc_cuota[$quebra_cc_contrato_orig][$quebra_cc_cuota_orig][1] = $sum_cc_capital;
         $this->array_total_cc_cuota[$quebra_cc_contrato_orig][$quebra_cc_cuota_orig][2] = $sum_cc_interes;
         $this->array_total_cc_cuota[$quebra_cc_contrato_orig][$quebra_cc_cuota_orig][3] = $sum_cc_valor_iva;
         $this->array_total_cc_cuota[$quebra_cc_contrato_orig][$quebra_cc_cuota_orig][4] = $sum_cc_valor_cuota;
         $this->array_total_cc_cuota[$quebra_cc_contrato_orig][$quebra_cc_cuota_orig][5] = $quebra_cc_cuota;
         $this->array_total_cc_cuota[$quebra_cc_contrato_orig][$quebra_cc_cuota_orig][6] = $quebra_cc_cuota_orig;
      }
      else
      {
         $this->array_total_cc_cuota[$quebra_cc_contrato_orig][$quebra_cc_cuota_orig][0]++;
         $this->array_total_cc_cuota[$quebra_cc_contrato_orig][$quebra_cc_cuota_orig][1] = bcadd($this->array_total_cc_cuota[$quebra_cc_contrato_orig][$quebra_cc_cuota_orig][1], $sum_cc_capital, 10);
         $this->array_total_cc_cuota[$quebra_cc_contrato_orig][$quebra_cc_cuota_orig][2] = bcadd($this->array_total_cc_cuota[$quebra_cc_contrato_orig][$quebra_cc_cuota_orig][2], $sum_cc_interes, 10);
         $this->array_total_cc_cuota[$quebra_cc_contrato_orig][$quebra_cc_cuota_orig][3] = bcadd($this->array_total_cc_cuota[$quebra_cc_contrato_orig][$quebra_cc_cuota_orig][3], $sum_cc_valor_iva, 10);
         $this->array_total_cc_cuota[$quebra_cc_contrato_orig][$quebra_cc_cuota_orig][4] = bcadd($this->array_total_cc_cuota[$quebra_cc_contrato_orig][$quebra_cc_cuota_orig][4], $sum_cc_valor_cuota, 10);
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
       ...
       $this->cc_convenio = $Busca_temp['cc_convenio']; 
       $this->cc_convenio = (isset($Busca_temp['cc_convenio'])) ? $Busca_temp['cc_convenio'] : ""; 
       $tmp_pos = (is_string($this->cc_convenio)) ? strpos($this->cc_convenio, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->cc_convenio))
       {
       ...
       $this->cc_cuota = $Busca_temp['cc_cuota']; 
       $this->cc_cuota = (isset($Busca_temp['cc_cuota'])) ? $Busca_temp['cc_cuota'] : ""; 
       $tmp_pos = (is_string($this->cc_cuota)) ? strpos($this->cc_cuota, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->cc_cuota))
       {
       ...
       $this->cc_fecha = $Busca_temp['cc_fecha']; 
       $this->cc_fecha = (isset($Busca_temp['cc_fecha'])) ? $Busca_temp['cc_fecha'] : ""; 
       $tmp_pos = (is_string($this->cc_fecha)) ? strpos($this->cc_fecha, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->cc_fecha))
       {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('contrato', 'cc_contrato');
     $campos_order = $this->Ini->Get_date_order_groupby("cc_contrato", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('contrato', 'cc_cuota');
     $campos_order = $this->Ini->Get_date_order_groupby("cc_cuota", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->cc_cuota = $rs_res->fields[0] ;  
            $this->cc_fecha = $rs_res->fields[1] ;  
            $this->cc_producto = $rs_res->fields[2] ;  
            $this->cc_capital = $rs_res->fields[3] ;  
            $this->cc_interes = $rs_res->fields[4] ;  
            $this->cc_valor_iva = $rs_res->fields[5] ;  
            $this->cc_valor_cuota = $rs_res->fields[6] ;  
            $this->cc_id = $rs_res->fields[7] ;  
            $this->cc_convenio = $rs_res->fields[8] ;  
            $this->cc_contrato = $rs_res->fields[9] ;  
            $this->cc_contrato_orig = $this->cc_contrato;
            $this->cc_cuota_orig = $this->cc_cuota;
            nmgp_Form_Num_Val($this->cc_contrato, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
            nmgp_Form_Num_Val($this->cc_cuota, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->cc_capital, $this->cc_interes, $this->cc_valor_iva, $this->cc_valor_cuota, $this->cc_contrato, $this->cc_cuota, $this->cc_contrato_orig,  $this->cc_cuota_orig);
            }
   }
//
