  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_negociacion_libretines_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_negociacion_libretines_mob_form();
	}
...
?>
  ...
  // ---------- Validate emp_ruc
  function do_ajax_form_negociacion_libretines_mob_validate_emp_ruc()
  {
    var nomeCampo_emp_ruc = "emp_ruc";
    var var_emp_ruc = scAjaxGetFieldText(nomeCampo_emp_ruc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_negociacion_libretines_mob_validate_emp_ruc(var_emp_ruc, var_script_case_init, do_ajax_form_negociacion_libretines_mob_validate_emp_ruc_cb);
  } // do_ajax_form_negociacion_libretines_mob_validate_emp_ruc

  function do_ajax_form_negociacion_libretines_mob_validate_emp_ruc_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_negociacion_libretines_mob_validate_emp_ruc_cb

  // ---------- Validate emp_contribuyente_especial
  function do_ajax_form_negociacion_libretines_mob_validate_emp_contribuyente_especial()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_negociacion_libretines_mob_validate_emp_contribuyente_especial(var_emp_contribuyente_especial, var_script_case_init, do_ajax_form_negociacion_libretines_mob_validate_emp_contribuyente_especial_cb);
  } // do_ajax_form_negociacion_libretines_mob_validate_emp_contribuyente_especial

  function do_ajax_form_negociacion_libretines_mob_validate_emp_contribuyente_especial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_negociacion_libretines_mob_validate_emp_contribuyente_especial_cb

  // ---------- Validate emp_razon_social
  function do_ajax_form_negociacion_libretines_mob_validate_emp_razon_social()
  {
    var nomeCampo_emp_razon_social = "emp_razon_social";
    var var_emp_razon_social = scAjaxGetFieldText(nomeCampo_emp_razon_social);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_negociacion_libretines_mob_validate_emp_razon_social(var_emp_razon_social, var_script_case_init, do_ajax_form_negociacion_libretines_mob_validate_emp_razon_social_cb);
  } // do_ajax_form_negociacion_libretines_mob_validate_emp_razon_social

  function do_ajax_form_negociacion_libretines_mob_validate_emp_razon_social_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_negociacion_libretines_mob_validate_emp_razon_social_cb

  // ---------- Validate emp_nombre_comercial
  function do_ajax_form_negociacion_libretines_mob_validate_emp_nombre_comercial()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_negociacion_libretines_mob_validate_emp_nombre_comercial(var_emp_nombre_comercial, var_script_case_init, do_ajax_form_negociacion_libretines_mob_validate_emp_nombre_comercial_cb);
  } // do_ajax_form_negociacion_libretines_mob_validate_emp_nombre_comercial

  function do_ajax_form_negociacion_libretines_mob_validate_emp_nombre_comercial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_negociacion_libretines_mob_validate_emp_nombre_comercial_cb

  // ---------- Validate emp_direccion_matriz
  function do_ajax_form_negociacion_libretines_mob_validate_emp_direccion_matriz()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_negociacion_libretines_mob_validate_emp_direccion_matriz(var_emp_direccion_matriz, var_script_case_init, do_ajax_form_negociacion_libretines_mob_validate_emp_direccion_matriz_cb);
  } // do_ajax_form_negociacion_libretines_mob_validate_emp_direccion_matriz

  function do_ajax_form_negociacion_libretines_mob_validate_emp_direccion_matriz_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_negociacion_libretines_mob_validate_emp_direccion_matriz_cb

  // ---------- Validate emp_email
  function do_ajax_form_negociacion_libretines_mob_validate_emp_email()
  {
    var nomeCampo_emp_email = "emp_email";
    var var_emp_email = scAjaxGetFieldText(nomeCampo_emp_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_negociacion_libretines_mob_validate_emp_email(var_emp_email, var_script_case_init, do_ajax_form_negociacion_libretines_mob_validate_emp_email_cb);
  } // do_ajax_form_negociacion_libretines_mob_validate_emp_email

  function do_ajax_form_negociacion_libretines_mob_validate_emp_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_negociacion_libretines_mob_validate_emp_email_cb

  // ---------- Validate libretines
  function do_ajax_form_negociacion_libretines_mob_validate_libretines()
  {
    var nomeCampo_libretines = "libretines";
    var var_libretines = scAjaxGetFieldText(nomeCampo_libretines);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_negociacion_libretines_mob_validate_libretines(var_libretines, var_script_case_init, do_ajax_form_negociacion_libretines_mob_validate_libretines_cb);
  } // do_ajax_form_negociacion_libretines_mob_validate_libretines

  function do_ajax_form_negociacion_libretines_mob_validate_libretines_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_negociacion_libretines_mob_validate_libretines_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_negociacion_libretines_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_negociacion_libretines_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_negociacion_libretines_mob_submit_form(var_emp_ruc, var_emp_contribuyente_especial, var_emp_razon_social, var_emp_nombre_comercial, var_emp_direccion_matriz, var_emp_email, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_negociacion_libretines_mob_submit_form_cb);
  } // do_ajax_form_negociacion_libretines_mob_submit_form

  function do_ajax_form_negociacion_libretines_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_negociacion_libretines_mob_submit_form_cb_after_alert);
  } // do_ajax_form_negociacion_libretines_mob_submit_form_cb
  function do_ajax_form_negociacion_libretines_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_negociacion_libretines_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_del_compra_libretines_mob"] = "off";

  function do_ajax_form_negociacion_libretines_mob_navigate_form()
  {
    perform_ajax_form_negociacion_libretines_mob_navigate_form();
  }

  function perform_ajax_form_negociacion_libretines_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_del_compra_libretines_mob"] = "on";
    x_ajax_form_negociacion_libretines_mob_navigate_form(var_emp_ruc, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_negociacion_libretines_mob_navigate_form_cb);
  } // do_ajax_form_negociacion_libretines_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_negociacion_libretines_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_negociacion_libretines_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_del_compra_libretines_mob"] && "nmsc_iframe_liga_form_del_compra_libretines_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_del_compra_libretines_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_del_compra_libretines_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_del_compra_libretines_mob').contentWindow.nm_move('apl_detalhe', true, '500');
        document.getElementById('nmsc_iframe_liga_form_del_compra_libretines_mob').style.height = "500";
        document.getElementById('nmsc_iframe_liga_form_del_compra_libretines_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_negociacion_libretines_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_negociacion_libretines_mob_navigate_form_cb
  function do_ajax_form_negociacion_libretines_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_negociacion_libretines_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_negociacion_libretines_mob_navigate_form_cb_after_alert

  function sc_hide_form_negociacion_libretines_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_del_compra_libretines_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "emp_ruc";
  ajax_field_list[1] = "emp_contribuyente_especial";
  ajax_field_list[2] = "emp_razon_social";
  ajax_field_list[3] = "emp_nombre_comercial";
  ajax_field_list[4] = "emp_direccion_matriz";
  ajax_field_list[5] = "emp_email";
  ajax_field_list[6] = "libretines";
  ...
  var ajax_error_list = {
    ...
    "emp_contribuyente_especial": {"label": "Emp Contribuyente Especial", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
