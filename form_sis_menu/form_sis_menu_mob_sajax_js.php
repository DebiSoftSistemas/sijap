  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_menu_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sis_menu_mob_form();
	}
...
?>
  ...
  // ---------- Validate mm_modulo
  function do_ajax_form_sis_menu_mob_validate_mm_modulo()
  {
    var nomeCampo_mm_modulo = "mm_modulo";
    var var_mm_modulo = scAjaxGetFieldHidden(nomeCampo_mm_modulo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_menu_mob_validate_mm_modulo(var_mm_modulo, var_script_case_init, do_ajax_form_sis_menu_mob_validate_mm_modulo_cb);
  } // do_ajax_form_sis_menu_mob_validate_mm_modulo

  function do_ajax_form_sis_menu_mob_validate_mm_modulo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mm_modulo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_menu_mob_validate_mm_modulo_cb

  // ---------- Validate mm_descripcion
  function do_ajax_form_sis_menu_mob_validate_mm_descripcion()
  {
    var nomeCampo_mm_descripcion = "mm_descripcion";
    var var_mm_descripcion = scAjaxGetFieldHidden(nomeCampo_mm_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_menu_mob_validate_mm_descripcion(var_mm_descripcion, var_script_case_init, do_ajax_form_sis_menu_mob_validate_mm_descripcion_cb);
  } // do_ajax_form_sis_menu_mob_validate_mm_descripcion

  function do_ajax_form_sis_menu_mob_validate_mm_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mm_descripcion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_menu_mob_validate_mm_descripcion_cb

  // ---------- Validate submenu
  function do_ajax_form_sis_menu_mob_validate_submenu()
  {
    var nomeCampo_submenu = "submenu";
    var var_submenu = scAjaxGetFieldText(nomeCampo_submenu);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_menu_mob_validate_submenu(var_submenu, var_script_case_init, do_ajax_form_sis_menu_mob_validate_submenu_cb);
  } // do_ajax_form_sis_menu_mob_validate_submenu

  function do_ajax_form_sis_menu_mob_validate_submenu_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "submenu";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_menu_mob_validate_submenu_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_sis_menu_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_sis_menu_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_mm_modulo = scAjaxGetFieldHidden("mm_modulo");
    var var_mm_descripcion = scAjaxGetFieldHidden("mm_descripcion");
    var var_mm_id = scAjaxGetFieldText("mm_id");
    ...
    scAjaxProcOn();
    x_ajax_form_sis_menu_mob_submit_form(var_mm_modulo, var_mm_descripcion, var_mm_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_menu_mob_submit_form_cb);
  } // do_ajax_form_sis_menu_mob_submit_form

  function do_ajax_form_sis_menu_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("mm_modulo");
      scAjaxHideErrorDisplay("mm_descripcion");
      scAjaxHideErrorDisplay("submenu");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_sis_menu_mob_submit_form_cb_after_alert);
  } // do_ajax_form_sis_menu_mob_submit_form_cb
  function do_ajax_form_sis_menu_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_menu_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_sis_submenu_mob"] = "off";

  function do_ajax_form_sis_menu_mob_navigate_form()
  {
    perform_ajax_form_sis_menu_mob_navigate_form();
  }

  function perform_ajax_form_sis_menu_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("mm_descripcion");
    scAjaxHideErrorDisplay("submenu");
    var var_mm_id = document.F2.mm_id.value;
    ...
    scAjaxProcOn();
    scStatusDetail["form_sis_submenu_mob"] = "on";
    x_ajax_form_sis_menu_mob_navigate_form(var_mm_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_menu_mob_navigate_form_cb);
  } // do_ajax_form_sis_menu_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_menu_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_menu_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.mm_id.value = scAjaxGetKeyValue("mm_id");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_sis_submenu_mob"] && "nmsc_iframe_liga_form_sis_submenu_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_sis_submenu_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_sis_submenu_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_sis_submenu_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_sis_submenu_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_sis_submenu_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_menu_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_menu_mob_navigate_form_cb
  function do_ajax_form_sis_menu_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_sis_menu_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_sis_menu_mob_navigate_form_cb_after_alert

  function sc_hide_form_sis_menu_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_sis_submenu_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "mm_modulo";
  ajax_field_list[1] = "mm_descripcion";
  ajax_field_list[2] = "submenu";
  ...
  var ajax_error_list = {
    "mm_modulo": {"label": "<?php echo $this->Ini->Nm_lang['lang_modulo'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "mm_descripcion": {"label": "<?php echo $this->Ini->Nm_lang['lang_description'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "submenu": {"label": "<?php echo $this->Ini->Nm_lang['lang_submenu'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "mm_modulo": new Array(),
    "mm_descripcion": new Array(),
    "submenu": new Array()
  };
  ajax_field_mult["mm_modulo"][1] = "mm_modulo";
  ajax_field_mult["mm_descripcion"][1] = "mm_descripcion";
  ajax_field_mult["submenu"][1] = "submenu";

  var ajax_field_id = {
    "mm_modulo": new Array("hidden_field_label_mm_modulo", "hidden_field_data_mm_modulo"),
    "mm_descripcion": new Array("hidden_field_label_mm_descripcion", "hidden_field_data_mm_descripcion"),
    "submenu": new Array("hidden_field_label_submenu", "hidden_field_data_submenu")
  };
