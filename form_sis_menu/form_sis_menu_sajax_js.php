  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_menu" == sTestField)
        {
...
?>
  ...
  // ---------- Validate mm_modulo
  function do_ajax_form_sis_menu_validate_mm_modulo()
  {
    var nomeCampo_mm_modulo = "mm_modulo";
    var var_mm_modulo = scAjaxGetFieldHidden(nomeCampo_mm_modulo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_menu_validate_mm_modulo(var_mm_modulo, var_script_case_init, do_ajax_form_sis_menu_validate_mm_modulo_cb);
  } // do_ajax_form_sis_menu_validate_mm_modulo

  function do_ajax_form_sis_menu_validate_mm_modulo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_menu_validate_mm_modulo_cb

  // ---------- Validate mm_descripcion
  function do_ajax_form_sis_menu_validate_mm_descripcion()
  {
    var nomeCampo_mm_descripcion = "mm_descripcion";
    var var_mm_descripcion = scAjaxGetFieldHidden(nomeCampo_mm_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_menu_validate_mm_descripcion(var_mm_descripcion, var_script_case_init, do_ajax_form_sis_menu_validate_mm_descripcion_cb);
  } // do_ajax_form_sis_menu_validate_mm_descripcion

  function do_ajax_form_sis_menu_validate_mm_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_menu_validate_mm_descripcion_cb

  // ---------- Validate submenu
  function do_ajax_form_sis_menu_validate_submenu()
  {
    var nomeCampo_submenu = "submenu";
    var var_submenu = scAjaxGetFieldText(nomeCampo_submenu);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_menu_validate_submenu(var_submenu, var_script_case_init, do_ajax_form_sis_menu_validate_submenu_cb);
  } // do_ajax_form_sis_menu_validate_submenu

  function do_ajax_form_sis_menu_validate_submenu_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "submenu";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_menu_validate_submenu_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_sis_menu_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_sis_menu_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_sis_menu_submit_form(var_mm_modulo, var_mm_descripcion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_menu_submit_form_cb);
  } // do_ajax_form_sis_menu_submit_form

  function do_ajax_form_sis_menu_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_sis_menu_submit_form_cb_after_alert);
  } // do_ajax_form_sis_menu_submit_form_cb
  function do_ajax_form_sis_menu_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_menu_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_sis_submenu"] = "off";

  function do_ajax_form_sis_menu_navigate_form()
  {
    perform_ajax_form_sis_menu_navigate_form();
  }

  function perform_ajax_form_sis_menu_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_sis_submenu"] = "on";
    x_ajax_form_sis_menu_navigate_form(var_mm_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_menu_navigate_form_cb);
  } // do_ajax_form_sis_menu_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_menu']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_menu_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_sis_submenu"] && "nmsc_iframe_liga_form_sis_submenu" != scMasterDetailIframe["nmsc_iframe_liga_form_sis_submenu"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_sis_submenu"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_sis_submenu').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_sis_submenu').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_sis_submenu').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_menu_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_menu_navigate_form_cb
  function do_ajax_form_sis_menu_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_sis_menu_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_sis_menu_navigate_form_cb_after_alert

  function sc_hide_form_sis_menu_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_sis_submenu"])
    {
      return true;
    }
    return false;
