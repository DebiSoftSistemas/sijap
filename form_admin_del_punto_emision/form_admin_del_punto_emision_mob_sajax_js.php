  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_admin_del_punto_emision_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_admin_del_punto_emision_mob_form();
	}
...
?>
  ...
  // ---------- Validate pem_id
  function do_ajax_form_admin_del_punto_emision_mob_validate_pem_id()
  {
    var nomeCampo_pem_id = "pem_id";
    var var_pem_id = scAjaxGetFieldHidden(nomeCampo_pem_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_admin_del_punto_emision_mob_validate_pem_id(var_pem_id, var_script_case_init, do_ajax_form_admin_del_punto_emision_mob_validate_pem_id_cb);
  } // do_ajax_form_admin_del_punto_emision_mob_validate_pem_id

  function do_ajax_form_admin_del_punto_emision_mob_validate_pem_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_admin_del_punto_emision_mob_validate_pem_id_cb

  // ---------- Validate pem_establecimiento
  function do_ajax_form_admin_del_punto_emision_mob_validate_pem_establecimiento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_admin_del_punto_emision_mob_validate_pem_establecimiento(var_pem_establecimiento, var_script_case_init, do_ajax_form_admin_del_punto_emision_mob_validate_pem_establecimiento_cb);
  } // do_ajax_form_admin_del_punto_emision_mob_validate_pem_establecimiento

  function do_ajax_form_admin_del_punto_emision_mob_validate_pem_establecimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_admin_del_punto_emision_mob_validate_pem_establecimiento_cb

  // ---------- Validate pem_nombre
  function do_ajax_form_admin_del_punto_emision_mob_validate_pem_nombre()
  {
    var nomeCampo_pem_nombre = "pem_nombre";
    var var_pem_nombre = scAjaxGetFieldText(nomeCampo_pem_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_admin_del_punto_emision_mob_validate_pem_nombre(var_pem_nombre, var_script_case_init, do_ajax_form_admin_del_punto_emision_mob_validate_pem_nombre_cb);
  } // do_ajax_form_admin_del_punto_emision_mob_validate_pem_nombre

  function do_ajax_form_admin_del_punto_emision_mob_validate_pem_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_admin_del_punto_emision_mob_validate_pem_nombre_cb

  // ---------- Validate pen_serie
  function do_ajax_form_admin_del_punto_emision_mob_validate_pen_serie()
  {
    var nomeCampo_pen_serie = "pen_serie";
    var var_pen_serie = scAjaxGetFieldText(nomeCampo_pen_serie);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_admin_del_punto_emision_mob_validate_pen_serie(var_pen_serie, var_script_case_init, do_ajax_form_admin_del_punto_emision_mob_validate_pen_serie_cb);
  } // do_ajax_form_admin_del_punto_emision_mob_validate_pen_serie

  function do_ajax_form_admin_del_punto_emision_mob_validate_pen_serie_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_admin_del_punto_emision_mob_validate_pen_serie_cb

  // ---------- Validate pem_estado
  function do_ajax_form_admin_del_punto_emision_mob_validate_pem_estado()
  {
    var nomeCampo_pem_estado = "pem_estado";
    var var_pem_estado = scAjaxGetFieldSelect(nomeCampo_pem_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_admin_del_punto_emision_mob_validate_pem_estado(var_pem_estado, var_script_case_init, do_ajax_form_admin_del_punto_emision_mob_validate_pem_estado_cb);
  } // do_ajax_form_admin_del_punto_emision_mob_validate_pem_estado

  function do_ajax_form_admin_del_punto_emision_mob_validate_pem_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_admin_del_punto_emision_mob_validate_pem_estado_cb

  // ---------- Validate libretines
  function do_ajax_form_admin_del_punto_emision_mob_validate_libretines()
  {
    var nomeCampo_libretines = "libretines";
    var var_libretines = scAjaxGetFieldText(nomeCampo_libretines);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_admin_del_punto_emision_mob_validate_libretines(var_libretines, var_script_case_init, do_ajax_form_admin_del_punto_emision_mob_validate_libretines_cb);
  } // do_ajax_form_admin_del_punto_emision_mob_validate_libretines

  function do_ajax_form_admin_del_punto_emision_mob_validate_libretines_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_admin_del_punto_emision_mob_validate_libretines_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_admin_del_punto_emision_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_admin_del_punto_emision_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_admin_del_punto_emision_mob_submit_form(var_pem_id, var_pem_establecimiento, var_pem_nombre, var_pen_serie, var_pem_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_admin_del_punto_emision_mob_submit_form_cb);
  } // do_ajax_form_admin_del_punto_emision_mob_submit_form

  function do_ajax_form_admin_del_punto_emision_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_admin_del_punto_emision_mob_submit_form_cb_after_alert);
  } // do_ajax_form_admin_del_punto_emision_mob_submit_form_cb
  function do_ajax_form_admin_del_punto_emision_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_admin_del_punto_emision_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_admin_del_libretin_mob"] = "off";

  function do_ajax_form_admin_del_punto_emision_mob_navigate_form()
  {
    perform_ajax_form_admin_del_punto_emision_mob_navigate_form();
  }

  function perform_ajax_form_admin_del_punto_emision_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_admin_del_libretin_mob"] = "on";
    x_ajax_form_admin_del_punto_emision_mob_navigate_form(var_pem_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_admin_del_punto_emision_mob_navigate_form_cb);
  } // do_ajax_form_admin_del_punto_emision_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_del_punto_emision_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_admin_del_punto_emision_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_admin_del_libretin_mob"] && "nmsc_iframe_liga_form_admin_del_libretin_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_admin_del_libretin_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_admin_del_libretin_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_admin_del_libretin_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_admin_del_libretin_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_admin_del_libretin_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_admin_del_punto_emision_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_admin_del_punto_emision_mob_navigate_form_cb
  function do_ajax_form_admin_del_punto_emision_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_admin_del_punto_emision_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_admin_del_punto_emision_mob_navigate_form_cb_after_alert

  function sc_hide_form_admin_del_punto_emision_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_admin_del_libretin_mob"])
    {
      return true;
    }
    return false;
