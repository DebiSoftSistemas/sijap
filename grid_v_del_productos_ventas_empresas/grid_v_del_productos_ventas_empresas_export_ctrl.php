<?php
@session_start() ;
$_SESSION['scriptcase']['grid_v_del_productos_ventas_empresas']['sc_process_barr'] = true;
require_once('../grid_v_del_productos_ventas_empresas/index.php');
unset($_SESSION['scriptcase']['grid_v_del_productos_ventas_empresas']['sc_process_barr']);
$ExportCtrl = new grid_v_del_productos_ventas_empresas_export_control;
$ExportCtrl->Export_barr();

class grid_v_del_productos_ventas_empresas_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> v_del_productos_ventas_empresas</TITLE>
