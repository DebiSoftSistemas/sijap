  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_grupo_clientes_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_grupo_clientes_mob_form();
	}
...
?>
  ...
  // ---------- Validate gc_id
  function do_ajax_form_del_grupo_clientes_mob_validate_gc_id()
  {
    var nomeCampo_gc_id = "gc_id";
    var var_gc_id = scAjaxGetFieldHidden(nomeCampo_gc_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_grupo_clientes_mob_validate_gc_id(var_gc_id, var_script_case_init, do_ajax_form_del_grupo_clientes_mob_validate_gc_id_cb);
  } // do_ajax_form_del_grupo_clientes_mob_validate_gc_id

  function do_ajax_form_del_grupo_clientes_mob_validate_gc_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_grupo_clientes_mob_validate_gc_id_cb

  // ---------- Validate gc_empresa
  function do_ajax_form_del_grupo_clientes_mob_validate_gc_empresa()
  {
    var nomeCampo_gc_empresa = "gc_empresa";
    var var_gc_empresa = scAjaxGetFieldText(nomeCampo_gc_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_grupo_clientes_mob_validate_gc_empresa(var_gc_empresa, var_script_case_init, do_ajax_form_del_grupo_clientes_mob_validate_gc_empresa_cb);
  } // do_ajax_form_del_grupo_clientes_mob_validate_gc_empresa

  function do_ajax_form_del_grupo_clientes_mob_validate_gc_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "gc_empresa";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_grupo_clientes_mob_validate_gc_empresa_cb

  // ---------- Validate gc_descripcion
  function do_ajax_form_del_grupo_clientes_mob_validate_gc_descripcion()
  {
    var nomeCampo_gc_descripcion = "gc_descripcion";
    var var_gc_descripcion = scAjaxGetFieldText(nomeCampo_gc_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_grupo_clientes_mob_validate_gc_descripcion(var_gc_descripcion, var_script_case_init, do_ajax_form_del_grupo_clientes_mob_validate_gc_descripcion_cb);
  } // do_ajax_form_del_grupo_clientes_mob_validate_gc_descripcion

  function do_ajax_form_del_grupo_clientes_mob_validate_gc_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "gc_descripcion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_grupo_clientes_mob_validate_gc_descripcion_cb

  // ---------- Validate clientes
  function do_ajax_form_del_grupo_clientes_mob_validate_clientes()
  {
    var nomeCampo_clientes = "clientes";
    var var_clientes = scAjaxGetFieldText(nomeCampo_clientes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_grupo_clientes_mob_validate_clientes(var_clientes, var_script_case_init, do_ajax_form_del_grupo_clientes_mob_validate_clientes_cb);
  } // do_ajax_form_del_grupo_clientes_mob_validate_clientes

  function do_ajax_form_del_grupo_clientes_mob_validate_clientes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_grupo_clientes_mob_validate_clientes_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_grupo_clientes_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_grupo_clientes_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_gc_id = scAjaxGetFieldHidden("gc_id");
    var var_gc_empresa = scAjaxGetFieldText("gc_empresa");
    var var_gc_descripcion = scAjaxGetFieldText("gc_descripcion");
    ...
    scAjaxProcOn();
    x_ajax_form_del_grupo_clientes_mob_submit_form(var_gc_id, var_gc_empresa, var_gc_descripcion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_grupo_clientes_mob_submit_form_cb);
  } // do_ajax_form_del_grupo_clientes_mob_submit_form

  function do_ajax_form_del_grupo_clientes_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("gc_id");
      scAjaxHideErrorDisplay("gc_empresa");
      scAjaxHideErrorDisplay("gc_descripcion");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_grupo_clientes_mob_submit_form_cb_after_alert);
  } // do_ajax_form_del_grupo_clientes_mob_submit_form_cb
  function do_ajax_form_del_grupo_clientes_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_grupo_clientes_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["grid_del_cliente_grupo_cliente"] = "off";

  function do_ajax_form_del_grupo_clientes_mob_navigate_form()
  {
    perform_ajax_form_del_grupo_clientes_mob_navigate_form();
  }

  function perform_ajax_form_del_grupo_clientes_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("gc_descripcion");
    scAjaxHideErrorDisplay("clientes");
    var var_gc_id = document.F2.gc_id.value;
    ...
    scAjaxProcOn();
    scStatusDetail["grid_del_cliente_grupo_cliente"] = "on";
    x_ajax_form_del_grupo_clientes_mob_navigate_form(var_gc_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_grupo_clientes_mob_navigate_form_cb);
  } // do_ajax_form_del_grupo_clientes_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_grupo_clientes_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_grupo_clientes_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.gc_id.value = scAjaxGetKeyValue("gc_id");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_grid_del_cliente_grupo_cliente"] && "nmsc_iframe_liga_grid_del_cliente_grupo_cliente" != scMasterDetailIframe["nmsc_iframe_liga_grid_del_cliente_grupo_cliente"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_grid_del_cliente_grupo_cliente"]);
    }
    else {
        if (oResp["navSummary"].reg_tot != 0) {
            document.getElementById('nmsc_iframe_liga_grid_del_cliente_grupo_cliente').contentWindow.nm_move('apl_detalhe', true, '600');
        }
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_grupo_clientes_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_del_grupo_clientes_mob_navigate_form_cb
  function do_ajax_form_del_grupo_clientes_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_del_grupo_clientes_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_del_grupo_clientes_mob_navigate_form_cb_after_alert

  function sc_hide_form_del_grupo_clientes_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["grid_del_cliente_grupo_cliente"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "gc_id";
  ajax_field_list[1] = "gc_empresa";
  ajax_field_list[2] = "gc_descripcion";
  ajax_field_list[3] = "clientes";
  ...
  var ajax_error_list = {
    "gc_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "gc_empresa": {"label": "<?php echo $this->Ini->Nm_lang['lang_empresa'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "gc_descripcion": {"label": "<?php echo $this->Ini->Nm_lang['lang_descripcion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "clientes": {"label": "<?php echo $this->Ini->Nm_lang['lang_clientes'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "gc_id": new Array(),
    "gc_empresa": new Array(),
    "gc_descripcion": new Array(),
    "clientes": new Array()
  };
  ajax_field_mult["gc_id"][1] = "gc_id";
  ajax_field_mult["gc_empresa"][1] = "gc_empresa";
  ajax_field_mult["gc_descripcion"][1] = "gc_descripcion";
  ajax_field_mult["clientes"][1] = "clientes";

  var ajax_field_id = {
    "gc_descripcion": new Array("hidden_field_label_gc_descripcion", "hidden_field_data_gc_descripcion"),
