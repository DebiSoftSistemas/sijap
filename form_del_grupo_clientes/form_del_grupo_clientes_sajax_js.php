  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_grupo_clientes" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_grupo_clientes_form();
	}
...
?>
  ...
  // ---------- Validate gc_id
  function do_ajax_form_del_grupo_clientes_validate_gc_id()
  {
    var nomeCampo_gc_id = "gc_id";
    var var_gc_id = scAjaxGetFieldHidden(nomeCampo_gc_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_grupo_clientes_validate_gc_id(var_gc_id, var_script_case_init, do_ajax_form_del_grupo_clientes_validate_gc_id_cb);
  } // do_ajax_form_del_grupo_clientes_validate_gc_id

  function do_ajax_form_del_grupo_clientes_validate_gc_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_grupo_clientes_validate_gc_id_cb

  // ---------- Validate gc_empresa
  function do_ajax_form_del_grupo_clientes_validate_gc_empresa()
  {
    var nomeCampo_gc_empresa = "gc_empresa";
    var var_gc_empresa = scAjaxGetFieldText(nomeCampo_gc_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_grupo_clientes_validate_gc_empresa(var_gc_empresa, var_script_case_init, do_ajax_form_del_grupo_clientes_validate_gc_empresa_cb);
  } // do_ajax_form_del_grupo_clientes_validate_gc_empresa

  function do_ajax_form_del_grupo_clientes_validate_gc_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_grupo_clientes_validate_gc_empresa_cb

  // ---------- Validate gc_descripcion
  function do_ajax_form_del_grupo_clientes_validate_gc_descripcion()
  {
    var nomeCampo_gc_descripcion = "gc_descripcion";
    var var_gc_descripcion = scAjaxGetFieldText(nomeCampo_gc_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_grupo_clientes_validate_gc_descripcion(var_gc_descripcion, var_script_case_init, do_ajax_form_del_grupo_clientes_validate_gc_descripcion_cb);
  } // do_ajax_form_del_grupo_clientes_validate_gc_descripcion

  function do_ajax_form_del_grupo_clientes_validate_gc_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_grupo_clientes_validate_gc_descripcion_cb

  // ---------- Validate clientes
  function do_ajax_form_del_grupo_clientes_validate_clientes()
  {
    var nomeCampo_clientes = "clientes";
    var var_clientes = scAjaxGetFieldText(nomeCampo_clientes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_grupo_clientes_validate_clientes(var_clientes, var_script_case_init, do_ajax_form_del_grupo_clientes_validate_clientes_cb);
  } // do_ajax_form_del_grupo_clientes_validate_clientes

  function do_ajax_form_del_grupo_clientes_validate_clientes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_grupo_clientes_validate_clientes_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_grupo_clientes_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_grupo_clientes_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_del_grupo_clientes_submit_form(var_gc_id, var_gc_empresa, var_gc_descripcion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_grupo_clientes_submit_form_cb);
  } // do_ajax_form_del_grupo_clientes_submit_form

  function do_ajax_form_del_grupo_clientes_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_grupo_clientes_submit_form_cb_after_alert);
  } // do_ajax_form_del_grupo_clientes_submit_form_cb
  function do_ajax_form_del_grupo_clientes_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_grupo_clientes_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["grid_del_cliente_grupo_cliente"] = "off";

  function do_ajax_form_del_grupo_clientes_navigate_form()
  {
    perform_ajax_form_del_grupo_clientes_navigate_form();
  }

  function perform_ajax_form_del_grupo_clientes_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_del_grupo_clientes_navigate_form(var_gc_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_grupo_clientes_navigate_form_cb);
  } // do_ajax_form_del_grupo_clientes_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_grupo_clientes']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_grupo_clientes_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_grupo_clientes_navigate_form_cb_after_alert);
  } // do_ajax_form_del_grupo_clientes_navigate_form_cb
  function do_ajax_form_del_grupo_clientes_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_del_grupo_clientes_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_del_grupo_clientes_navigate_form_cb_after_alert

  function sc_hide_form_del_grupo_clientes_form()
  {
