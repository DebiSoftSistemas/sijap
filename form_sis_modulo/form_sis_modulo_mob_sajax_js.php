  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_modulo_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sis_modulo_mob_form();
	}
...
?>
  ...
  // ---------- Validate opm_imagen
  function do_ajax_form_sis_modulo_mob_validate_opm_imagen()
  {
    var nomeCampo_opm_imagen = "opm_imagen";
    var var_opm_imagen = scAjaxGetFieldText(nomeCampo_opm_imagen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_modulo_mob_validate_opm_imagen(var_opm_imagen, var_script_case_init, do_ajax_form_sis_modulo_mob_validate_opm_imagen_cb);
  } // do_ajax_form_sis_modulo_mob_validate_opm_imagen

  function do_ajax_form_sis_modulo_mob_validate_opm_imagen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "opm_imagen";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_modulo_mob_validate_opm_imagen_cb

  // ---------- Validate opm_sistema
  function do_ajax_form_sis_modulo_mob_validate_opm_sistema()
  {
    var nomeCampo_opm_sistema = "opm_sistema";
    var var_opm_sistema = scAjaxGetFieldSelect(nomeCampo_opm_sistema);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_modulo_mob_validate_opm_sistema(var_opm_sistema, var_script_case_init, do_ajax_form_sis_modulo_mob_validate_opm_sistema_cb);
  } // do_ajax_form_sis_modulo_mob_validate_opm_sistema

  function do_ajax_form_sis_modulo_mob_validate_opm_sistema_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "opm_sistema";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_modulo_mob_validate_opm_sistema_cb

  // ---------- Validate opm_nombre
  function do_ajax_form_sis_modulo_mob_validate_opm_nombre()
  {
    var nomeCampo_opm_nombre = "opm_nombre";
    var var_opm_nombre = scAjaxGetFieldText(nomeCampo_opm_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_modulo_mob_validate_opm_nombre(var_opm_nombre, var_script_case_init, do_ajax_form_sis_modulo_mob_validate_opm_nombre_cb);
  } // do_ajax_form_sis_modulo_mob_validate_opm_nombre

  function do_ajax_form_sis_modulo_mob_validate_opm_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "opm_nombre";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_modulo_mob_validate_opm_nombre_cb

  // ---------- Validate opm_estado
  function do_ajax_form_sis_modulo_mob_validate_opm_estado()
  {
    var nomeCampo_opm_estado = "opm_estado";
    var var_opm_estado = scAjaxGetFieldSelect(nomeCampo_opm_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_modulo_mob_validate_opm_estado(var_opm_estado, var_script_case_init, do_ajax_form_sis_modulo_mob_validate_opm_estado_cb);
  } // do_ajax_form_sis_modulo_mob_validate_opm_estado

  function do_ajax_form_sis_modulo_mob_validate_opm_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "opm_estado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_modulo_mob_validate_opm_estado_cb

  // ---------- Validate opm_etiqueta
  function do_ajax_form_sis_modulo_mob_validate_opm_etiqueta()
  {
    var nomeCampo_opm_etiqueta = "opm_etiqueta";
    var var_opm_etiqueta = scAjaxGetFieldText(nomeCampo_opm_etiqueta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_modulo_mob_validate_opm_etiqueta(var_opm_etiqueta, var_script_case_init, do_ajax_form_sis_modulo_mob_validate_opm_etiqueta_cb);
  } // do_ajax_form_sis_modulo_mob_validate_opm_etiqueta

  function do_ajax_form_sis_modulo_mob_validate_opm_etiqueta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "opm_etiqueta";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_modulo_mob_validate_opm_etiqueta_cb

  // ---------- Validate opm_enlace
  function do_ajax_form_sis_modulo_mob_validate_opm_enlace()
  {
    var nomeCampo_opm_enlace = "opm_enlace";
    var var_opm_enlace = scAjaxGetFieldText(nomeCampo_opm_enlace);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_modulo_mob_validate_opm_enlace(var_opm_enlace, var_script_case_init, do_ajax_form_sis_modulo_mob_validate_opm_enlace_cb);
  } // do_ajax_form_sis_modulo_mob_validate_opm_enlace

  function do_ajax_form_sis_modulo_mob_validate_opm_enlace_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "opm_enlace";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_modulo_mob_validate_opm_enlace_cb

  // ---------- Validate opm_orden
  function do_ajax_form_sis_modulo_mob_validate_opm_orden()
  {
    var nomeCampo_opm_orden = "opm_orden";
    var var_opm_orden = scAjaxGetFieldText(nomeCampo_opm_orden);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_modulo_mob_validate_opm_orden(var_opm_orden, var_script_case_init, do_ajax_form_sis_modulo_mob_validate_opm_orden_cb);
  } // do_ajax_form_sis_modulo_mob_validate_opm_orden

  function do_ajax_form_sis_modulo_mob_validate_opm_orden_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "opm_orden";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_modulo_mob_validate_opm_orden_cb

  // ---------- Validate opciones
  function do_ajax_form_sis_modulo_mob_validate_opciones()
  {
    var nomeCampo_opciones = "opciones";
    var var_opciones = scAjaxGetFieldText(nomeCampo_opciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_modulo_mob_validate_opciones(var_opciones, var_script_case_init, do_ajax_form_sis_modulo_mob_validate_opciones_cb);
  } // do_ajax_form_sis_modulo_mob_validate_opciones

  function do_ajax_form_sis_modulo_mob_validate_opciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "opciones";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_modulo_mob_validate_opciones_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_sis_modulo_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_sis_modulo_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_opm_imagen = scAjaxGetFieldText("opm_imagen");
    var var_opm_sistema = scAjaxGetFieldSelect("opm_sistema");
    var var_opm_nombre = scAjaxGetFieldText("opm_nombre");
    var var_opm_estado = scAjaxGetFieldSelect("opm_estado");
    var var_opm_etiqueta = scAjaxGetFieldText("opm_etiqueta");
    var var_opm_enlace = scAjaxGetFieldText("opm_enlace");
    var var_opm_orden = scAjaxGetFieldText("opm_orden");
    var var_opm_id = scAjaxGetFieldText("opm_id");
    var var_opm_imagen_ul_name = scAjaxSpecCharProtect(document.F1.opm_imagen_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_opm_imagen_ul_type = document.F1.opm_imagen_ul_type.value;
    var var_opm_imagen_salva = scAjaxSpecCharProtect(document.F1.opm_imagen_salva.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_opm_imagen_limpa = document.F1.opm_imagen_limpa.checked ? "S" : "N";
    ...
    scAjaxProcOn();
    x_ajax_form_sis_modulo_mob_submit_form(var_opm_imagen, var_opm_sistema, var_opm_nombre, var_opm_estado, var_opm_etiqueta, var_opm_enlace, var_opm_orden, var_opm_id, var_opm_imagen_ul_name, var_opm_imagen_ul_type, var_opm_imagen_salva, var_opm_imagen_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_modulo_mob_submit_form_cb);
  } // do_ajax_form_sis_modulo_mob_submit_form

  function do_ajax_form_sis_modulo_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("opm_imagen");
      scAjaxHideErrorDisplay("opm_sistema");
      scAjaxHideErrorDisplay("opm_nombre");
      scAjaxHideErrorDisplay("opm_estado");
      scAjaxHideErrorDisplay("opm_etiqueta");
      scAjaxHideErrorDisplay("opm_enlace");
      scAjaxHideErrorDisplay("opm_orden");
      scAjaxHideErrorDisplay("opciones");
      scLigEditLookupCall();
<?php
...
?>
    ...
    if (!scAjaxHasError())
    {
      ...
      if (document.F1.opm_imagen_limpa && document.F1.opm_imagen_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldImage("opm_imagen", oImgTemp, "", "", "", "N");
      }
    document.F1.opm_imagen_ul_name.value = '';
    document.F1.opm_imagen_ul_type.value = '';
    }
    scAjaxShowDebug();
    scAjaxSetDisplay();
    scBtnDisabled();
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_sis_modulo_mob_submit_form_cb_after_alert);
  } // do_ajax_form_sis_modulo_mob_submit_form_cb
  function do_ajax_form_sis_modulo_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_modulo_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_sis_menu_modulo_mob"] = "off";

  function do_ajax_form_sis_modulo_mob_navigate_form()
  {
    perform_ajax_form_sis_modulo_mob_navigate_form();
  }

  function perform_ajax_form_sis_modulo_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("opm_orden");
    scAjaxHideErrorDisplay("opciones");
    var var_opm_id = document.F2.opm_id.value;
    ...
    scAjaxProcOn();
    scStatusDetail["form_sis_menu_modulo_mob"] = "on";
    x_ajax_form_sis_modulo_mob_navigate_form(var_opm_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_modulo_mob_navigate_form_cb);
  } // do_ajax_form_sis_modulo_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_modulo_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_modulo_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.opm_id.value = scAjaxGetKeyValue("opm_id");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_sis_menu_modulo_mob"] && "nmsc_iframe_liga_form_sis_menu_modulo_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_sis_menu_modulo_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_sis_menu_modulo_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_sis_menu_modulo_mob').contentWindow.nm_move('apl_detalhe', true, '600');
        document.getElementById('nmsc_iframe_liga_form_sis_menu_modulo_mob').style.height = "600";
        document.getElementById('nmsc_iframe_liga_form_sis_menu_modulo_mob').style.display = "none";
    }
    document.F1.opm_imagen_ul_name.value = '';
    document.F1.opm_imagen_ul_type.value = '';
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_modulo_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_modulo_mob_navigate_form_cb
  function do_ajax_form_sis_modulo_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_sis_modulo_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_sis_modulo_mob_navigate_form_cb_after_alert

  function sc_hide_form_sis_modulo_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_sis_menu_modulo_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "opm_imagen";
  ajax_field_list[1] = "opm_sistema";
  ajax_field_list[2] = "opm_nombre";
  ajax_field_list[3] = "opm_estado";
  ajax_field_list[4] = "opm_etiqueta";
  ajax_field_list[5] = "opm_enlace";
  ajax_field_list[6] = "opm_orden";
  ajax_field_list[7] = "opciones";
  ...
  var ajax_error_list = {
    "opm_imagen": {"label": "<?php echo $this->Ini->Nm_lang['lang_imagen_menu'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "opm_sistema": {"label": "<?php echo $this->Ini->Nm_lang['lang_sistema'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "opm_nombre": {"label": "<?php echo $this->Ini->Nm_lang['lang_modulo'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "opm_estado": {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "opm_etiqueta": {"label": "<?php echo $this->Ini->Nm_lang['lang_etiqueta'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "opm_enlace": {"label": "<?php echo $this->Ini->Nm_lang['lang_enlace'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "opm_orden": {"label": "<?php echo $this->Ini->Nm_lang['lang_orden_ingreso'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "opciones": {"label": "opciones", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "opm_imagen": new Array(),
    "opm_sistema": new Array(),
    "opm_nombre": new Array(),
    "opm_estado": new Array(),
    "opm_etiqueta": new Array(),
    "opm_enlace": new Array(),
    "opm_orden": new Array(),
    "opciones": new Array()
  };
  ajax_field_mult["opm_imagen"][1] = "opm_imagen";
  ajax_field_mult["opm_sistema"][1] = "opm_sistema";
  ajax_field_mult["opm_nombre"][1] = "opm_nombre";
  ajax_field_mult["opm_estado"][1] = "opm_estado";
  ajax_field_mult["opm_etiqueta"][1] = "opm_etiqueta";
  ajax_field_mult["opm_enlace"][1] = "opm_enlace";
  ajax_field_mult["opm_orden"][1] = "opm_orden";
  ajax_field_mult["opciones"][1] = "opciones";

  var ajax_field_id = {
    "opm_imagen": new Array("hidden_field_label_opm_imagen", "hidden_field_data_opm_imagen"),
    "opm_sistema": new Array("hidden_field_label_opm_sistema", "hidden_field_data_opm_sistema"),
    "opm_nombre": new Array("hidden_field_label_opm_nombre", "hidden_field_data_opm_nombre"),
    "opm_estado": new Array("hidden_field_label_opm_estado", "hidden_field_data_opm_estado"),
    "opm_etiqueta": new Array("hidden_field_label_opm_etiqueta", "hidden_field_data_opm_etiqueta"),
    "opm_enlace": new Array("hidden_field_label_opm_enlace", "hidden_field_data_opm_enlace"),
    "opm_orden": new Array("hidden_field_label_opm_orden", "hidden_field_data_opm_orden"),
    "opciones": new Array("hidden_field_label_opciones", "hidden_field_data_opciones")
  };
