  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_modulo" == sTestField)
        {
...
?>
  ...
  // ---------- Validate opm_imagen
  function do_ajax_form_sis_modulo_validate_opm_imagen()
  {
    var nomeCampo_opm_imagen = "opm_imagen";
    var var_opm_imagen = scAjaxGetFieldText(nomeCampo_opm_imagen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_modulo_validate_opm_imagen(var_opm_imagen, var_script_case_init, do_ajax_form_sis_modulo_validate_opm_imagen_cb);
  } // do_ajax_form_sis_modulo_validate_opm_imagen

  function do_ajax_form_sis_modulo_validate_opm_imagen_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_modulo_validate_opm_imagen_cb

  // ---------- Validate opm_sistema
  function do_ajax_form_sis_modulo_validate_opm_sistema()
  {
    var nomeCampo_opm_sistema = "opm_sistema";
    var var_opm_sistema = scAjaxGetFieldSelect(nomeCampo_opm_sistema);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_modulo_validate_opm_sistema(var_opm_sistema, var_script_case_init, do_ajax_form_sis_modulo_validate_opm_sistema_cb);
  } // do_ajax_form_sis_modulo_validate_opm_sistema

  function do_ajax_form_sis_modulo_validate_opm_sistema_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_modulo_validate_opm_sistema_cb

  // ---------- Validate opm_nombre
  function do_ajax_form_sis_modulo_validate_opm_nombre()
  {
    var nomeCampo_opm_nombre = "opm_nombre";
    var var_opm_nombre = scAjaxGetFieldText(nomeCampo_opm_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_modulo_validate_opm_nombre(var_opm_nombre, var_script_case_init, do_ajax_form_sis_modulo_validate_opm_nombre_cb);
  } // do_ajax_form_sis_modulo_validate_opm_nombre

  function do_ajax_form_sis_modulo_validate_opm_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_modulo_validate_opm_nombre_cb

  // ---------- Validate opm_estado
  function do_ajax_form_sis_modulo_validate_opm_estado()
  {
    var nomeCampo_opm_estado = "opm_estado";
    var var_opm_estado = scAjaxGetFieldSelect(nomeCampo_opm_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_modulo_validate_opm_estado(var_opm_estado, var_script_case_init, do_ajax_form_sis_modulo_validate_opm_estado_cb);
  } // do_ajax_form_sis_modulo_validate_opm_estado

  function do_ajax_form_sis_modulo_validate_opm_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_modulo_validate_opm_estado_cb

  // ---------- Validate opm_etiqueta
  function do_ajax_form_sis_modulo_validate_opm_etiqueta()
  {
    var nomeCampo_opm_etiqueta = "opm_etiqueta";
    var var_opm_etiqueta = scAjaxGetFieldText(nomeCampo_opm_etiqueta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_modulo_validate_opm_etiqueta(var_opm_etiqueta, var_script_case_init, do_ajax_form_sis_modulo_validate_opm_etiqueta_cb);
  } // do_ajax_form_sis_modulo_validate_opm_etiqueta

  function do_ajax_form_sis_modulo_validate_opm_etiqueta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_modulo_validate_opm_etiqueta_cb

  // ---------- Validate opm_enlace
  function do_ajax_form_sis_modulo_validate_opm_enlace()
  {
    var nomeCampo_opm_enlace = "opm_enlace";
    var var_opm_enlace = scAjaxGetFieldText(nomeCampo_opm_enlace);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_modulo_validate_opm_enlace(var_opm_enlace, var_script_case_init, do_ajax_form_sis_modulo_validate_opm_enlace_cb);
  } // do_ajax_form_sis_modulo_validate_opm_enlace

  function do_ajax_form_sis_modulo_validate_opm_enlace_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_modulo_validate_opm_enlace_cb

  // ---------- Validate opm_orden
  function do_ajax_form_sis_modulo_validate_opm_orden()
  {
    var nomeCampo_opm_orden = "opm_orden";
    var var_opm_orden = scAjaxGetFieldText(nomeCampo_opm_orden);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_modulo_validate_opm_orden(var_opm_orden, var_script_case_init, do_ajax_form_sis_modulo_validate_opm_orden_cb);
  } // do_ajax_form_sis_modulo_validate_opm_orden

  function do_ajax_form_sis_modulo_validate_opm_orden_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_modulo_validate_opm_orden_cb

  // ---------- Validate opciones
  function do_ajax_form_sis_modulo_validate_opciones()
  {
    var nomeCampo_opciones = "opciones";
    var var_opciones = scAjaxGetFieldText(nomeCampo_opciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_modulo_validate_opciones(var_opciones, var_script_case_init, do_ajax_form_sis_modulo_validate_opciones_cb);
  } // do_ajax_form_sis_modulo_validate_opciones

  function do_ajax_form_sis_modulo_validate_opciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_modulo_validate_opciones_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_sis_modulo_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_sis_modulo_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_sis_modulo_submit_form(var_opm_imagen, var_opm_sistema, var_opm_nombre, var_opm_estado, var_opm_etiqueta, var_opm_enlace, var_opm_orden, var_opm_imagen_ul_name, var_opm_imagen_ul_type, var_opm_imagen_salva, var_opm_imagen_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_modulo_submit_form_cb);
  } // do_ajax_form_sis_modulo_submit_form

  function do_ajax_form_sis_modulo_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_sis_modulo_submit_form_cb_after_alert);
  } // do_ajax_form_sis_modulo_submit_form_cb
  function do_ajax_form_sis_modulo_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_modulo_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_sis_menu_modulo"] = "off";

  function do_ajax_form_sis_modulo_navigate_form()
  {
    perform_ajax_form_sis_modulo_navigate_form();
  }

  function perform_ajax_form_sis_modulo_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_sis_menu_modulo"] = "on";
    x_ajax_form_sis_modulo_navigate_form(var_opm_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_modulo_navigate_form_cb);
  } // do_ajax_form_sis_modulo_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_modulo']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_modulo_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_sis_menu_modulo"] && "nmsc_iframe_liga_form_sis_menu_modulo" != scMasterDetailIframe["nmsc_iframe_liga_form_sis_menu_modulo"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_sis_menu_modulo"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_sis_menu_modulo').contentWindow.nm_move('apl_detalhe', true, '600');
        document.getElementById('nmsc_iframe_liga_form_sis_menu_modulo').style.height = "600";
        document.getElementById('nmsc_iframe_liga_form_sis_menu_modulo').style.display = "none";
    }
    document.F1.opm_imagen_ul_name.value = '';
    document.F1.opm_imagen_ul_type.value = '';
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_modulo_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_modulo_navigate_form_cb
  function do_ajax_form_sis_modulo_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_sis_modulo_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_sis_modulo_navigate_form_cb_after_alert

  function sc_hide_form_sis_modulo_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_sis_menu_modulo"])
    {
      return true;
    }
    return false;
