...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_jap_registro_lecturas"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_jap_registro_lecturas"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_jap_registro_lecturas'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_jap_registro_lecturas']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_jap_registro_lecturas']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_jap_registro_lecturas']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_jap_registro_lecturas']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_jap_registro_lecturas']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_jap_registro_lecturas</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_jap_registro_lecturas']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_jap_registro_lecturas']['embutida_filho'] as $ind => $sc_init)
          {
