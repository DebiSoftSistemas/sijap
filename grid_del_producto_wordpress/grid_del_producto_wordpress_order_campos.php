...
<?php
   ...
   $Ord_Cmp = new grid_del_producto_wordpress_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_del_producto_wordpress_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_del_producto_wordpress']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_del_producto_wordpress']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['pw_id'] = "pw_id";
   $tab_labels["pw_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_del_producto_wordpress']['labels']["pw_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_del_producto_wordpress']['labels']["pw_id"] : "" . $this->Nm_lang['lang_id'] . "";
   $tab_ger_campos['pw_sku'] = "on";
   $tab_def_campos['pw_sku'] = "pw_sku";
   $tab_labels["pw_sku"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_del_producto_wordpress']['labels']["pw_sku"])) ? $_SESSION['sc_session'][$sc_init]['grid_del_producto_wordpress']['labels']["pw_sku"] : "" . $this->Nm_lang['lang_sku'] . "";
   $tab_ger_campos['pw_producto_debi'] = "on";
   $tab_def_campos['pw_producto_debi'] = "pw_producto_debi";
   $tab_labels["pw_producto_debi"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_del_producto_wordpress']['labels']["pw_producto_debi"])) ? $_SESSION['sc_session'][$sc_init]['grid_del_producto_wordpress']['labels']["pw_producto_debi"] : "" . $this->Nm_lang['lang_producto_debi'] . "";
   $tab_ger_campos['pw_descripcion'] = "on";
   $tab_def_campos['pw_descripcion'] = "pw_descripcion";
   $tab_labels["pw_descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_del_producto_wordpress']['labels']["pw_descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_del_producto_wordpress']['labels']["pw_descripcion"] : "" . $this->Nm_lang['lang_descripcion'] . "";
   $tab_ger_campos['pw_descripcion_corta'] = "on";
   $tab_def_campos['pw_descripcion_corta'] = "pw_descripcion_corta";
   $tab_labels["pw_descripcion_corta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_del_producto_wordpress']['labels']["pw_descripcion_corta"])) ? $_SESSION['sc_session'][$sc_init]['grid_del_producto_wordpress']['labels']["pw_descripcion_corta"] : "" . $this->Nm_lang['lang_descripcion_corta'] . "";
   $tab_ger_campos['pw_tipo'] = "on";
   $tab_def_campos['pw_tipo'] = "pw_tipo";
   $tab_labels["pw_tipo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_del_producto_wordpress']['labels']["pw_tipo"])) ? $_SESSION['sc_session'][$sc_init]['grid_del_producto_wordpress']['labels']["pw_tipo"] : "" . $this->Nm_lang['lang_tipo'] . "";
   $tab_ger_campos['pw_estado'] = "on";
   $tab_def_campos['pw_estado'] = "pw_estado";
   $tab_labels["pw_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_del_producto_wordpress']['labels']["pw_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_del_producto_wordpress']['labels']["pw_estado"] : "" . $this->Nm_lang['lang_estado'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_del_producto_wordpress']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_del_producto_wordpress']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_del_producto_wordpress']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_del_producto_wordpress']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_del_producto_wordpress']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_del_producto_wordpress']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_del_producto_wordpress']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_del_producto_wordpress']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_del_producto_wordpress']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_del_producto_wordpress']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_del_producto_wordpress']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_del_producto_wordpress']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_del_producto_wordpress_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_del_producto_wordpress']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_del_producto_wordpress']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_del_producto_wordpress']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_del_producto_wordpress']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_del_producto_wordpress']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
