<?php
class form_inv_productos_transferencia_recibir_old_form extends form_inv_productos_transferencia_recibir_old_apl
{
function Form_Init()
{
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['sc_redir_atualiz'] == 'ok')
{
?>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_inv_productos_transferencia_recibir_old/form_inv_productos_transferencia_recibir_old_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_inv_productos_transferencia_recibir_old_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_inv_productos_transferencia_recibir_old_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['recarga'];
}
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    $opcao_botoes = 'inicio';
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['link_info']['remove_border']) {
...
<?php
 include_once("form_inv_productos_transferencia_recibir_old_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_inv_productos_transferencia_recibir_old'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_inv_productos_transferencia_recibir_old'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['run_iframe'] != "R")
{
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['fast_search'][2] : "";
...
<?php 
          ...
          $SC_Label_atu['pt_producto_'] = (isset($this->nm_new_label['pt_producto_'])) ? $this->nm_new_label['pt_producto_'] : '' . $this->Ini->Nm_lang['lang_producto'] . ''; 
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_inv_productos_transferencia_recibir_old);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_inv_productos_transferencia_recibir_old = $this->form_vert_form_inv_productos_transferencia_recibir_old;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_inv_productos_transferencia_recibir_old))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_form_inv_productos_transferencia_recibir_old as $sc_seq_vert => $sc_lixo)
   {
       $this->form_fixed_column_no = 0;
       $this->loadRecordState($sc_seq_vert);
       $this->pt_bodegadestino_ = $this->form_vert_form_inv_productos_transferencia_recibir_old[$sc_seq_vert]['pt_bodegadestino_'];
       $this->pt_bodegaorigen_ = $this->form_vert_form_inv_productos_transferencia_recibir_old[$sc_seq_vert]['pt_bodegaorigen_'];
       $this->pt_estado_ = $this->form_vert_form_inv_productos_transferencia_recibir_old[$sc_seq_vert]['pt_estado_'];
       $this->pt_stock_origen_ = $this->form_vert_form_inv_productos_transferencia_recibir_old[$sc_seq_vert]['pt_stock_origen_'];
       $this->pt_stock_destino_ = $this->form_vert_form_inv_productos_transferencia_recibir_old[$sc_seq_vert]['pt_stock_destino_'];
       $this->pt_saldo_origen_ = $this->form_vert_form_inv_productos_transferencia_recibir_old[$sc_seq_vert]['pt_saldo_origen_'];
       $this->pt_saldo_destino_ = $this->form_vert_form_inv_productos_transferencia_recibir_old[$sc_seq_vert]['pt_saldo_destino_'];
       ...
       elseif ($Line_Add)
       {
        ...
        $this->pt_id_ = $this->form_vert_form_inv_productos_transferencia_recibir_old[$sc_seq_vert]['pt_id_']; 
       $pt_id_ = $this->pt_id_; 
       if (!isset($this->nmgp_cmp_hidden['pt_id_']))
       {
           $this->nmgp_cmp_hidden['pt_id_'] = 'off';
       ...
       $this->pt_transferencia_ = $this->form_vert_form_inv_productos_transferencia_recibir_old[$sc_seq_vert]['pt_transferencia_']; 
       ...
       $this->pt_producto_ = $this->form_vert_form_inv_productos_transferencia_recibir_old[$sc_seq_vert]['pt_producto_']; 
       ...
       $this->pt_stock_solicitado_ = $this->form_vert_form_inv_productos_transferencia_recibir_old[$sc_seq_vert]['pt_stock_solicitado_']; 
       ...
       $this->pt_cantidad_recibida_ = $this->form_vert_form_inv_productos_transferencia_recibir_old[$sc_seq_vert]['pt_cantidad_recibida_']; 
       ...
       $this->pt_unidad_ = $this->form_vert_form_inv_productos_transferencia_recibir_old[$sc_seq_vert]['pt_unidad_']; 
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_inv_productos_transferencia_recibir_old_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_inv_productos_transferencia_recibir_old_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_inv_productos_transferencia_recibir_old_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_inv_productos_transferencia_recibir_old_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_inv_productos_transferencia_recibir_old_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_inv_productos_transferencia_recibir_old_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
<?php   
   ...
   { 
       ...
       $this->form_vert_form_inv_productos_transferencia_recibir_old = $guarda_form_vert_form_inv_productos_transferencia_recibir_old;
   } 
   if ($Table_refresh) 
   { 
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_disabled']['birpara']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_disabled']['birpara']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_label']['birpara']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_label']['birpara']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_label']['birpara'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_disabled']['']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_disabled']['']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_label']['']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_label']['']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_label'][''];
        }
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_label']['last'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['btn_label']['exit'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_inv_productos_transferencia_recibir_old");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_inv_productos_transferencia_recibir_old");
 parent.scAjaxDetailHeight("form_inv_productos_transferencia_recibir_old", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
