  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_inv_productos_transferencia_recibir_old" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_inv_productos_transferencia_recibir_old_form();
	}
...
?>
  ...
  // ---------- Validate pt_id_
  function do_ajax_form_inv_productos_transferencia_recibir_old_validate_pt_id_(iNumLinha)
  {
    var nomeCampo_pt_id_ = "pt_id_" + iNumLinha;
    var var_pt_id_ = scAjaxGetFieldHidden(nomeCampo_pt_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_productos_transferencia_recibir_old_validate_pt_id_(var_pt_id_, iNumLinha, var_script_case_init, do_ajax_form_inv_productos_transferencia_recibir_old_validate_pt_id__cb);
  } // do_ajax_form_inv_productos_transferencia_recibir_old_validate_pt_id_

  function do_ajax_form_inv_productos_transferencia_recibir_old_validate_pt_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_productos_transferencia_recibir_old_validate_pt_id__cb

  // ---------- Validate pt_transferencia_
  function do_ajax_form_inv_productos_transferencia_recibir_old_validate_pt_transferencia_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_productos_transferencia_recibir_old_validate_pt_transferencia_(var_pt_transferencia_, iNumLinha, var_script_case_init, do_ajax_form_inv_productos_transferencia_recibir_old_validate_pt_transferencia__cb);
  } // do_ajax_form_inv_productos_transferencia_recibir_old_validate_pt_transferencia_

  function do_ajax_form_inv_productos_transferencia_recibir_old_validate_pt_transferencia__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_productos_transferencia_recibir_old_validate_pt_transferencia__cb

  // ---------- Validate pt_producto_
  function do_ajax_form_inv_productos_transferencia_recibir_old_validate_pt_producto_(iNumLinha)
  {
    var nomeCampo_pt_producto_ = "pt_producto_" + iNumLinha;
    var var_pt_producto_ = scAjaxGetFieldSelect(nomeCampo_pt_producto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_productos_transferencia_recibir_old_validate_pt_producto_(var_pt_producto_, iNumLinha, var_script_case_init, do_ajax_form_inv_productos_transferencia_recibir_old_validate_pt_producto__cb);
  } // do_ajax_form_inv_productos_transferencia_recibir_old_validate_pt_producto_

  function do_ajax_form_inv_productos_transferencia_recibir_old_validate_pt_producto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_productos_transferencia_recibir_old_validate_pt_producto__cb

  // ---------- Validate pt_stock_solicitado_
  function do_ajax_form_inv_productos_transferencia_recibir_old_validate_pt_stock_solicitado_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_productos_transferencia_recibir_old_validate_pt_stock_solicitado_(var_pt_stock_solicitado_, iNumLinha, var_script_case_init, do_ajax_form_inv_productos_transferencia_recibir_old_validate_pt_stock_solicitado__cb);
  } // do_ajax_form_inv_productos_transferencia_recibir_old_validate_pt_stock_solicitado_

  function do_ajax_form_inv_productos_transferencia_recibir_old_validate_pt_stock_solicitado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_productos_transferencia_recibir_old_validate_pt_stock_solicitado__cb

  // ---------- Validate pt_cantidad_recibida_
  function do_ajax_form_inv_productos_transferencia_recibir_old_validate_pt_cantidad_recibida_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_productos_transferencia_recibir_old_validate_pt_cantidad_recibida_(var_pt_cantidad_recibida_, iNumLinha, var_script_case_init, do_ajax_form_inv_productos_transferencia_recibir_old_validate_pt_cantidad_recibida__cb);
  } // do_ajax_form_inv_productos_transferencia_recibir_old_validate_pt_cantidad_recibida_

  function do_ajax_form_inv_productos_transferencia_recibir_old_validate_pt_cantidad_recibida__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_productos_transferencia_recibir_old_validate_pt_cantidad_recibida__cb

  // ---------- Validate pt_unidad_
  function do_ajax_form_inv_productos_transferencia_recibir_old_validate_pt_unidad_(iNumLinha)
  {
    var nomeCampo_pt_unidad_ = "pt_unidad_" + iNumLinha;
    var var_pt_unidad_ = scAjaxGetFieldSelect(nomeCampo_pt_unidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_productos_transferencia_recibir_old_validate_pt_unidad_(var_pt_unidad_, iNumLinha, var_script_case_init, do_ajax_form_inv_productos_transferencia_recibir_old_validate_pt_unidad__cb);
  } // do_ajax_form_inv_productos_transferencia_recibir_old_validate_pt_unidad_

  function do_ajax_form_inv_productos_transferencia_recibir_old_validate_pt_unidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_productos_transferencia_recibir_old_validate_pt_unidad__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_inv_productos_transferencia_recibir_old_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_inv_productos_transferencia_recibir_old_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_inv_productos_transferencia_recibir_old_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_inv_productos_transferencia_recibir_old_add_new_line_cb);
  } // do_ajax_form_inv_productos_transferencia_recibir_old_add_new_line

  function do_ajax_form_inv_productos_transferencia_recibir_old_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_inv_productos_transferencia_recibir_old_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_inv_productos_transferencia_recibir_old_backup_line(iNumLinha)
  {
    var var_pt_id_ = scAjaxGetFieldHidden("pt_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_productos_transferencia_recibir_old_backup_line(var_pt_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_inv_productos_transferencia_recibir_old_backup_line_cb);
  } // do_ajax_form_inv_productos_transferencia_recibir_old_backup_line

  function do_ajax_form_inv_productos_transferencia_recibir_old_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_inv_productos_transferencia_recibir_old_backup_line_cb

  function do_ajax_form_inv_productos_transferencia_recibir_old_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_inv_productos_transferencia_recibir_old_cancel_insert

  function do_ajax_form_inv_productos_transferencia_recibir_old_cancel_update(iSeqVert)
  {
    do_ajax_form_inv_productos_transferencia_recibir_old_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_inv_productos_transferencia_recibir_old_cancel_update

  function do_ajax_form_inv_productos_transferencia_recibir_old_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_inv_productos_transferencia_recibir_old_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_inv_productos_transferencia_recibir_old_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_inv_productos_transferencia_recibir_old_table_refresh(var_pt_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_inv_productos_transferencia_recibir_old_table_refresh_cb);
  } //  do_ajax_form_inv_productos_transferencia_recibir_old_table_refresh

  function do_ajax_form_inv_productos_transferencia_recibir_old_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_inv_productos_transferencia_recibir_old_table_refresh_cb_after_alert);
  } // do_ajax_form_inv_productos_transferencia_recibir_old_table_refresh_cb
  function do_ajax_form_inv_productos_transferencia_recibir_old_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_inv_productos_transferencia_recibir_old_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_inv_productos_transferencia_recibir_old_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_inv_productos_transferencia_recibir_old_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_inv_productos_transferencia_recibir_old_submit_form(var_pt_id_, var_pt_transferencia_, var_pt_producto_, var_pt_stock_solicitado_, var_pt_cantidad_recibida_, var_pt_unidad_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_inv_productos_transferencia_recibir_old_submit_form_cb);
  } // do_ajax_form_inv_productos_transferencia_recibir_old_submit_form

  function do_ajax_form_inv_productos_transferencia_recibir_old_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_inv_productos_transferencia_recibir_old_submit_form_cb_after_alert);
  } // do_ajax_form_inv_productos_transferencia_recibir_old_submit_form_cb
  function do_ajax_form_inv_productos_transferencia_recibir_old_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_inv_productos_transferencia_recibir_old_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_inv_productos_transferencia_recibir_old_navigate_form()
  {
    perform_ajax_form_inv_productos_transferencia_recibir_old_navigate_form();
  }

  function perform_ajax_form_inv_productos_transferencia_recibir_old_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_inv_productos_transferencia_recibir_old_navigate_form(var_pt_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_inv_productos_transferencia_recibir_old_navigate_form_cb);
  } // do_ajax_form_inv_productos_transferencia_recibir_old_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_productos_transferencia_recibir_old']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_inv_productos_transferencia_recibir_old_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_inv_productos_transferencia_recibir_old_navigate_form_cb_after_alert);
  } // do_ajax_form_inv_productos_transferencia_recibir_old_navigate_form_cb
  function do_ajax_form_inv_productos_transferencia_recibir_old_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_inv_productos_transferencia_recibir_old_navigate_form_cb_after_alert

    function sc_form_inv_productos_transferencia_recibir_old_get_last_line_number()
    {
    ...
    } //sc_form_inv_productos_transferencia_recibir_old_get_last_line_number

  function sc_hide_form_inv_productos_transferencia_recibir_old_form()
  {
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["pt_id_" + iRow] || "on" == ajax_error_count["pt_transferencia_" + iRow] || "on" == ajax_error_count["pt_producto_" + iRow] || "on" == ajax_error_count["pt_stock_solicitado_" + iRow] || "on" == ajax_error_count["pt_cantidad_recibida_" + iRow] || "on" == ajax_error_count["pt_unidad_" + iRow]))
    {
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["pt_id_" + iRow] && "off" == ajax_error_count["pt_transferencia_" + iRow] && "off" == ajax_error_count["pt_producto_" + iRow] && "off" == ajax_error_count["pt_stock_solicitado_" + iRow] && "off" == ajax_error_count["pt_cantidad_recibida_" + iRow] && "off" == ajax_error_count["pt_unidad_" + iRow]))
    {
      if (bErrorRow)
      {
