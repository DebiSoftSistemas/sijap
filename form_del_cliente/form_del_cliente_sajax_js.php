...
?>
  ...
  function do_ajax_form_del_cliente_event_cl_identificacion_onblur()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_cliente_event_cl_identificacion_onblur(var_cl_identificacion, var_cl_tipo_identificacion, var_cl_nombre, var_cl_direccion, var_cl_email, var_cl_telefono, var_cl_pais, var_cl_provincia, var_cl_ciudad, var_script_case_init, do_ajax_form_del_cliente_event_cl_identificacion_onblur_cb);
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_del_cliente_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_del_cliente_submit_form(var_cl_id, var_cl_empresa, var_cl_tipo_identificacion, var_cl_identificacion, var_cl_nombre, var_cl_email, var_cl_telefono, var_cl_celular, var_cl_fecha_nacimientos, var_cl_reteoncion_iva, var_cl_estado, var_cl_pais, var_cl_provincia, var_cl_ciudad, var_cl_direccion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_cliente_submit_form_cb);
