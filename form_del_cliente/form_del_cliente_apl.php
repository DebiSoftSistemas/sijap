...
;
   ...
   if (isset($this->Field_no_validate['cl_estado'])) {
       return;
               ...
               if (!empty($this->cl_estado) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Lookup_cl_estado']) && !in_array($this->cl_estado, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cliente']['Lookup_cl_estado']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['cl_estado']['valList'][$i] = form_del_cliente_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
