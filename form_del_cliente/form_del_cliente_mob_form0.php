...
<?php $sStyleHidden_cl_estado_dumb = ('' == $sStyleHidden_cl_estado) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_cl_estado_dumb" style="<?php echo $sStyleHidden_cl_estado_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
