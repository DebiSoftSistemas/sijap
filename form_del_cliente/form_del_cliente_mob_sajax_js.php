...
?>
  ...
  function do_ajax_form_del_cliente_mob_validate_cl_estado()
  {
    ...
    var var_cl_estado = scAjaxGetFieldSelect(nomeCampo_cl_estado);
    var var_script_case_init = document.F1.script_case_init.value;
  ...
  function do_ajax_form_del_cliente_mob_event_cl_identificacion_onblur()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_cliente_mob_event_cl_identificacion_onblur(var_cl_identificacion, var_cl_tipo_identificacion, var_cl_nombre, var_cl_direccion, var_cl_email, var_cl_telefono, var_cl_pais, var_cl_provincia, var_cl_ciudad, var_script_case_init, do_ajax_form_del_cliente_mob_event_cl_identificacion_onblur_cb);
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_del_cliente_mob_submit_form()
  {
    ...
    var var_cl_estado = scAjaxGetFieldSelect("cl_estado");
    var var_cl_pais = scAjaxGetFieldSelect("cl_pais");
    var var_cl_provincia = scAjaxGetFieldSelect("cl_provincia");
    var var_cl_ciudad = scAjaxGetFieldSelect("cl_ciudad");
    var var_cl_direccion = scAjaxGetFieldText("cl_direccion");
    ...
    scAjaxProcOn();
    x_ajax_form_del_cliente_mob_submit_form(var_cl_id, var_cl_empresa, var_cl_tipo_identificacion, var_cl_identificacion, var_cl_nombre, var_cl_email, var_cl_telefono, var_cl_celular, var_cl_fecha_nacimientos, var_cl_reteoncion_iva, var_cl_estado, var_cl_pais, var_cl_provincia, var_cl_ciudad, var_cl_direccion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_cliente_mob_submit_form_cb);
...
?>
  ...
  ajax_field_list[10] = "cl_estado";
  ajax_field_list[11] = "cl_pais";
  ajax_field_list[12] = "cl_provincia";
  ajax_field_list[13] = "cl_ciudad";
  ajax_field_list[14] = "cl_direccion";
  ...
  var ajax_error_list = {
    ...
    "cl_estado": {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
