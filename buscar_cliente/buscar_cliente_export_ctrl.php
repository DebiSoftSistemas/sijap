<?php
@session_start() ;
$_SESSION['scriptcase']['buscar_cliente']['sc_process_barr'] = true;
require_once('../buscar_cliente/index.php');
unset($_SESSION['scriptcase']['buscar_cliente']['sc_process_barr']);
$ExportCtrl = new buscar_cliente_export_control;
$ExportCtrl->Export_barr();

class buscar_cliente_export_control
{
