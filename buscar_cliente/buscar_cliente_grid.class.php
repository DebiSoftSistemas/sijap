       ...
       foreach ($nmgp_def_dados as $Ind => $Lista)
       {
          if (is_array($Lista))
          {
              foreach ($Lista as $Cod => $Valor)
              {
                  ...
                  if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente']['dyn_search_aut_comp']['cmp'], $Cmp_select2))
                  {
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       { 
           ...
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"buscar_cliente_jquery_563.js\"></script>\r\n");
...
$nm_saida->saida("    </style>\r\n");
   ...
   function grid_search_add_tag()
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente']['grid_pesq']) && count($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente']['grid_pesq']) < 2)
       {
