  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_fac_producto" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_fac_producto_form();
	}
...
?>
  ...
  // ---------- Validate pro_imagen
  function do_ajax_form_fac_producto_validate_pro_imagen()
  {
    var nomeCampo_pro_imagen = "pro_imagen";
    var var_pro_imagen = scAjaxGetFieldText(nomeCampo_pro_imagen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_producto_validate_pro_imagen(var_pro_imagen, var_script_case_init, do_ajax_form_fac_producto_validate_pro_imagen_cb);
  } // do_ajax_form_fac_producto_validate_pro_imagen

  function do_ajax_form_fac_producto_validate_pro_imagen_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_producto_validate_pro_imagen_cb

  // ---------- Validate pro_codigo
  function do_ajax_form_fac_producto_validate_pro_codigo()
  {
    var nomeCampo_pro_codigo = "pro_codigo";
    var var_pro_codigo = scAjaxGetFieldText(nomeCampo_pro_codigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_producto_validate_pro_codigo(var_pro_codigo, var_script_case_init, do_ajax_form_fac_producto_validate_pro_codigo_cb);
  } // do_ajax_form_fac_producto_validate_pro_codigo

  function do_ajax_form_fac_producto_validate_pro_codigo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_producto_validate_pro_codigo_cb

  // ---------- Validate pro_codigo_secundario
  function do_ajax_form_fac_producto_validate_pro_codigo_secundario()
  {
    var nomeCampo_pro_codigo_secundario = "pro_codigo_secundario";
    var var_pro_codigo_secundario = scAjaxGetFieldText(nomeCampo_pro_codigo_secundario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_producto_validate_pro_codigo_secundario(var_pro_codigo_secundario, var_script_case_init, do_ajax_form_fac_producto_validate_pro_codigo_secundario_cb);
  } // do_ajax_form_fac_producto_validate_pro_codigo_secundario

  function do_ajax_form_fac_producto_validate_pro_codigo_secundario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pro_codigo_secundario";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_producto_validate_pro_codigo_secundario_cb

  // ---------- Validate pro_nombre
  function do_ajax_form_fac_producto_validate_pro_nombre()
  {
    var nomeCampo_pro_nombre = "pro_nombre";
    var var_pro_nombre = scAjaxGetFieldText(nomeCampo_pro_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_producto_validate_pro_nombre(var_pro_nombre, var_script_case_init, do_ajax_form_fac_producto_validate_pro_nombre_cb);
  } // do_ajax_form_fac_producto_validate_pro_nombre

  function do_ajax_form_fac_producto_validate_pro_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pro_nombre";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_producto_validate_pro_nombre_cb

  // ---------- Validate pro_precio_uni
  function do_ajax_form_fac_producto_validate_pro_precio_uni()
  {
    var nomeCampo_pro_precio_uni = "pro_precio_uni";
    var var_pro_precio_uni = scAjaxGetFieldText(nomeCampo_pro_precio_uni);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_producto_validate_pro_precio_uni(var_pro_precio_uni, var_script_case_init, do_ajax_form_fac_producto_validate_pro_precio_uni_cb);
  } // do_ajax_form_fac_producto_validate_pro_precio_uni

  function do_ajax_form_fac_producto_validate_pro_precio_uni_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pro_precio_uni";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_producto_validate_pro_precio_uni_cb

  // ---------- Validate pro_tipo_comprobante
  function do_ajax_form_fac_producto_validate_pro_tipo_comprobante()
  {
    var nomeCampo_pro_tipo_comprobante = "pro_tipo_comprobante";
    var var_pro_tipo_comprobante = scAjaxGetFieldSelect(nomeCampo_pro_tipo_comprobante);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_producto_validate_pro_tipo_comprobante(var_pro_tipo_comprobante, var_script_case_init, do_ajax_form_fac_producto_validate_pro_tipo_comprobante_cb);
  } // do_ajax_form_fac_producto_validate_pro_tipo_comprobante

  function do_ajax_form_fac_producto_validate_pro_tipo_comprobante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pro_tipo_comprobante";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_producto_validate_pro_tipo_comprobante_cb

  // ---------- Validate pro_estado
  function do_ajax_form_fac_producto_validate_pro_estado()
  {
    var nomeCampo_pro_estado = "pro_estado";
    var var_pro_estado = scAjaxGetFieldSelect(nomeCampo_pro_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_producto_validate_pro_estado(var_pro_estado, var_script_case_init, do_ajax_form_fac_producto_validate_pro_estado_cb);
  } // do_ajax_form_fac_producto_validate_pro_estado

  function do_ajax_form_fac_producto_validate_pro_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_producto_validate_pro_estado_cb

  // ---------- Validate pro_iva
  function do_ajax_form_fac_producto_validate_pro_iva()
  {
    var nomeCampo_pro_iva = "pro_iva";
    var var_pro_iva = scAjaxGetFieldHidden(nomeCampo_pro_iva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_producto_validate_pro_iva(var_pro_iva, var_script_case_init, do_ajax_form_fac_producto_validate_pro_iva_cb);
  } // do_ajax_form_fac_producto_validate_pro_iva

  function do_ajax_form_fac_producto_validate_pro_iva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pro_iva";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_producto_validate_pro_iva_cb

  // ---------- Validate pro_por_iva
  function do_ajax_form_fac_producto_validate_pro_por_iva()
  {
    var nomeCampo_pro_por_iva = "pro_por_iva";
    var var_pro_por_iva = scAjaxGetFieldSelect(nomeCampo_pro_por_iva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_producto_validate_pro_por_iva(var_pro_por_iva, var_script_case_init, do_ajax_form_fac_producto_validate_pro_por_iva_cb);
  } // do_ajax_form_fac_producto_validate_pro_por_iva

  function do_ajax_form_fac_producto_validate_pro_por_iva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_producto_validate_pro_por_iva_cb

  // ---------- Validate pro_ice
  function do_ajax_form_fac_producto_validate_pro_ice()
  {
    var nomeCampo_pro_ice = "pro_ice";
    var var_pro_ice = scAjaxGetFieldHidden(nomeCampo_pro_ice);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_producto_validate_pro_ice(var_pro_ice, var_script_case_init, do_ajax_form_fac_producto_validate_pro_ice_cb);
  } // do_ajax_form_fac_producto_validate_pro_ice

  function do_ajax_form_fac_producto_validate_pro_ice_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pro_ice";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_producto_validate_pro_ice_cb

  // ---------- Validate pro_por_ice
  function do_ajax_form_fac_producto_validate_pro_por_ice()
  {
    var nomeCampo_pro_por_ice = "pro_por_ice";
    var var_pro_por_ice = scAjaxGetFieldSelect(nomeCampo_pro_por_ice);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_producto_validate_pro_por_ice(var_pro_por_ice, var_script_case_init, do_ajax_form_fac_producto_validate_pro_por_ice_cb);
  } // do_ajax_form_fac_producto_validate_pro_por_ice

  function do_ajax_form_fac_producto_validate_pro_por_ice_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_producto_validate_pro_por_ice_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_fac_producto_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_fac_producto_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_pro_imagen = scAjaxGetFieldText("pro_imagen");
    var var_pro_codigo = scAjaxGetFieldText("pro_codigo");
    var var_pro_codigo_secundario = scAjaxGetFieldText("pro_codigo_secundario");
    var var_pro_nombre = scAjaxGetFieldText("pro_nombre");
    var var_pro_precio_uni = scAjaxGetFieldText("pro_precio_uni");
    var var_pro_tipo_comprobante = scAjaxGetFieldSelect("pro_tipo_comprobante");
    var var_pro_estado = scAjaxGetFieldSelect("pro_estado");
    var var_pro_iva = scAjaxGetFieldHidden("pro_iva");
    var var_pro_por_iva = scAjaxGetFieldSelect("pro_por_iva");
    var var_pro_ice = scAjaxGetFieldHidden("pro_ice");
    ...
    scAjaxProcOn();
    x_ajax_form_fac_producto_submit_form(var_pro_imagen, var_pro_codigo, var_pro_codigo_secundario, var_pro_nombre, var_pro_precio_uni, var_pro_tipo_comprobante, var_pro_estado, var_pro_iva, var_pro_por_iva, var_pro_ice, var_pro_por_ice, var_pro_imagen_ul_name, var_pro_imagen_ul_type, var_pro_imagen_salva, var_pro_imagen_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_fac_producto_submit_form_cb);
  } // do_ajax_form_fac_producto_submit_form

  function do_ajax_form_fac_producto_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("pro_codigo_secundario");
      scAjaxHideErrorDisplay("pro_nombre");
      scAjaxHideErrorDisplay("pro_precio_uni");
      scAjaxHideErrorDisplay("pro_tipo_comprobante");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_fac_producto_submit_form_cb_after_alert);
  } // do_ajax_form_fac_producto_submit_form_cb
  function do_ajax_form_fac_producto_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_fac_producto_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_fac_producto_navigate_form()
  {
    perform_ajax_form_fac_producto_navigate_form();
  }

  function perform_ajax_form_fac_producto_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_fac_producto_navigate_form(var_pro_codigo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_producto_navigate_form_cb);
  } // do_ajax_form_fac_producto_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_producto']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_fac_producto_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_fac_producto_navigate_form_cb_after_alert);
  } // do_ajax_form_fac_producto_navigate_form_cb
  function do_ajax_form_fac_producto_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_fac_producto_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_fac_producto_navigate_form_cb_after_alert

  function sc_hide_form_fac_producto_form()
  {
  ...
  ajax_field_list[1] = "pro_codigo";
  ajax_field_list[2] = "pro_codigo_secundario";
  ajax_field_list[3] = "pro_nombre";
  ajax_field_list[4] = "pro_precio_uni";
  ajax_field_list[5] = "pro_tipo_comprobante";
  ajax_field_list[6] = "pro_estado";
  ajax_field_list[7] = "pro_iva";
  ajax_field_list[8] = "pro_por_iva";
  ajax_field_list[9] = "pro_ice";
  ajax_field_list[10] = "pro_por_ice";
  ...
  var ajax_error_list = {
    ...
    "pro_codigo_secundario": {"label": "<?php echo $this->Ini->Nm_lang['lang_codigo_secundario'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pro_nombre": {"label": "<?php echo $this->Ini->Nm_lang['lang_descripcion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pro_precio_uni": {"label": "<?php echo $this->Ini->Nm_lang['lang_precio_unitario'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pro_tipo_comprobante": {"label": "<?php echo $this->Ini->Nm_lang['lang_tipo_comprobante'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "pro_por_iva": {"label": "<?php echo $this->Ini->Nm_lang['lang_porcentaje_iva'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "pro_por_ice": {"label": "<?php echo $this->Ini->Nm_lang['lang_porcentaje_ice'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "pro_codigo_secundario": new Array(),
    "pro_nombre": new Array(),
    "pro_precio_uni": new Array(),
    "pro_tipo_comprobante": new Array(),
  ...
  ajax_field_mult["pro_codigo_secundario"][1] = "pro_codigo_secundario";
  ajax_field_mult["pro_nombre"][1] = "pro_nombre";
  ajax_field_mult["pro_precio_uni"][1] = "pro_precio_uni";
  ajax_field_mult["pro_tipo_comprobante"][1] = "pro_tipo_comprobante";
  ...
  var ajax_field_id = {
    ...
    "pro_codigo_secundario": new Array("hidden_field_label_pro_codigo_secundario", "hidden_field_data_pro_codigo_secundario"),
    "pro_nombre": new Array("hidden_field_label_pro_nombre", "hidden_field_data_pro_nombre"),
    "pro_precio_uni": new Array("hidden_field_label_pro_precio_uni", "hidden_field_data_pro_precio_uni"),
    "pro_tipo_comprobante": new Array("hidden_field_label_pro_tipo_comprobante", "hidden_field_data_pro_tipo_comprobante"),
    "pro_estado": new Array("hidden_field_label_pro_estado", "hidden_field_data_pro_estado"),
    "pro_iva": new Array("hidden_field_label_pro_iva", "hidden_field_data_pro_iva"),
    "pro_por_iva": new Array("hidden_field_label_pro_por_iva", "hidden_field_data_pro_por_iva"),
    "pro_ice": new Array("hidden_field_label_pro_ice", "hidden_field_data_pro_ice"),
  ...
  var ajax_read_only = {
    "pro_imagen": "off",
    "pro_codigo": "on",
    "pro_codigo_secundario": "off",
    "pro_nombre": "off",
    "pro_precio_uni": "off",
    "pro_tipo_comprobante": "off",
    "pro_estado": "off",
    "pro_iva": "off",
    "pro_por_iva": "off",
    "pro_ice": "off",
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("pro_codigo_secundario" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("pro_tipo_comprobante" == sIndex)
    {
