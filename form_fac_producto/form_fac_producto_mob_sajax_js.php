  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_fac_producto_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_fac_producto_mob_form();
	}
...
?>
  ...
  // ---------- Validate pro_imagen
  function do_ajax_form_fac_producto_mob_validate_pro_imagen()
  {
    var nomeCampo_pro_imagen = "pro_imagen";
    var var_pro_imagen = scAjaxGetFieldText(nomeCampo_pro_imagen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_producto_mob_validate_pro_imagen(var_pro_imagen, var_script_case_init, do_ajax_form_fac_producto_mob_validate_pro_imagen_cb);
  } // do_ajax_form_fac_producto_mob_validate_pro_imagen

  function do_ajax_form_fac_producto_mob_validate_pro_imagen_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_producto_mob_validate_pro_imagen_cb

  // ---------- Validate pro_codigo
  function do_ajax_form_fac_producto_mob_validate_pro_codigo()
  {
    var nomeCampo_pro_codigo = "pro_codigo";
    var var_pro_codigo = scAjaxGetFieldText(nomeCampo_pro_codigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_producto_mob_validate_pro_codigo(var_pro_codigo, var_script_case_init, do_ajax_form_fac_producto_mob_validate_pro_codigo_cb);
  } // do_ajax_form_fac_producto_mob_validate_pro_codigo

  function do_ajax_form_fac_producto_mob_validate_pro_codigo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_producto_mob_validate_pro_codigo_cb

  // ---------- Validate pro_codigo_secundario
  function do_ajax_form_fac_producto_mob_validate_pro_codigo_secundario()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_producto_mob_validate_pro_codigo_secundario(var_pro_codigo_secundario, var_script_case_init, do_ajax_form_fac_producto_mob_validate_pro_codigo_secundario_cb);
  } // do_ajax_form_fac_producto_mob_validate_pro_codigo_secundario

  function do_ajax_form_fac_producto_mob_validate_pro_codigo_secundario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_producto_mob_validate_pro_codigo_secundario_cb

  // ---------- Validate pro_nombre
  function do_ajax_form_fac_producto_mob_validate_pro_nombre()
  {
    var nomeCampo_pro_nombre = "pro_nombre";
    var var_pro_nombre = scAjaxGetFieldText(nomeCampo_pro_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_producto_mob_validate_pro_nombre(var_pro_nombre, var_script_case_init, do_ajax_form_fac_producto_mob_validate_pro_nombre_cb);
  } // do_ajax_form_fac_producto_mob_validate_pro_nombre

  function do_ajax_form_fac_producto_mob_validate_pro_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_producto_mob_validate_pro_nombre_cb

  // ---------- Validate pro_precio_uni
  function do_ajax_form_fac_producto_mob_validate_pro_precio_uni()
  {
    var nomeCampo_pro_precio_uni = "pro_precio_uni";
    var var_pro_precio_uni = scAjaxGetFieldText(nomeCampo_pro_precio_uni);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_producto_mob_validate_pro_precio_uni(var_pro_precio_uni, var_script_case_init, do_ajax_form_fac_producto_mob_validate_pro_precio_uni_cb);
  } // do_ajax_form_fac_producto_mob_validate_pro_precio_uni

  function do_ajax_form_fac_producto_mob_validate_pro_precio_uni_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_producto_mob_validate_pro_precio_uni_cb

  // ---------- Validate pro_tipo_comprobante
  function do_ajax_form_fac_producto_mob_validate_pro_tipo_comprobante()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_producto_mob_validate_pro_tipo_comprobante(var_pro_tipo_comprobante, var_script_case_init, do_ajax_form_fac_producto_mob_validate_pro_tipo_comprobante_cb);
  } // do_ajax_form_fac_producto_mob_validate_pro_tipo_comprobante

  function do_ajax_form_fac_producto_mob_validate_pro_tipo_comprobante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_producto_mob_validate_pro_tipo_comprobante_cb

  // ---------- Validate pro_estado
  function do_ajax_form_fac_producto_mob_validate_pro_estado()
  {
    var nomeCampo_pro_estado = "pro_estado";
    var var_pro_estado = scAjaxGetFieldSelect(nomeCampo_pro_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_producto_mob_validate_pro_estado(var_pro_estado, var_script_case_init, do_ajax_form_fac_producto_mob_validate_pro_estado_cb);
  } // do_ajax_form_fac_producto_mob_validate_pro_estado

  function do_ajax_form_fac_producto_mob_validate_pro_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_producto_mob_validate_pro_estado_cb

  // ---------- Validate pro_iva
  function do_ajax_form_fac_producto_mob_validate_pro_iva()
  {
    var nomeCampo_pro_iva = "pro_iva";
    var var_pro_iva = scAjaxGetFieldHidden(nomeCampo_pro_iva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_producto_mob_validate_pro_iva(var_pro_iva, var_script_case_init, do_ajax_form_fac_producto_mob_validate_pro_iva_cb);
  } // do_ajax_form_fac_producto_mob_validate_pro_iva

  function do_ajax_form_fac_producto_mob_validate_pro_iva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pro_iva";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_producto_mob_validate_pro_iva_cb

  // ---------- Validate pro_por_iva
  function do_ajax_form_fac_producto_mob_validate_pro_por_iva()
  {
    var nomeCampo_pro_por_iva = "pro_por_iva";
    var var_pro_por_iva = scAjaxGetFieldSelect(nomeCampo_pro_por_iva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_producto_mob_validate_pro_por_iva(var_pro_por_iva, var_script_case_init, do_ajax_form_fac_producto_mob_validate_pro_por_iva_cb);
  } // do_ajax_form_fac_producto_mob_validate_pro_por_iva

  function do_ajax_form_fac_producto_mob_validate_pro_por_iva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_producto_mob_validate_pro_por_iva_cb

  // ---------- Validate pro_ice
  function do_ajax_form_fac_producto_mob_validate_pro_ice()
  {
    var nomeCampo_pro_ice = "pro_ice";
    var var_pro_ice = scAjaxGetFieldHidden(nomeCampo_pro_ice);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_producto_mob_validate_pro_ice(var_pro_ice, var_script_case_init, do_ajax_form_fac_producto_mob_validate_pro_ice_cb);
  } // do_ajax_form_fac_producto_mob_validate_pro_ice

  function do_ajax_form_fac_producto_mob_validate_pro_ice_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pro_ice";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_producto_mob_validate_pro_ice_cb

  // ---------- Validate pro_por_ice
  function do_ajax_form_fac_producto_mob_validate_pro_por_ice()
  {
    var nomeCampo_pro_por_ice = "pro_por_ice";
    var var_pro_por_ice = scAjaxGetFieldSelect(nomeCampo_pro_por_ice);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_producto_mob_validate_pro_por_ice(var_pro_por_ice, var_script_case_init, do_ajax_form_fac_producto_mob_validate_pro_por_ice_cb);
  } // do_ajax_form_fac_producto_mob_validate_pro_por_ice

  function do_ajax_form_fac_producto_mob_validate_pro_por_ice_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_producto_mob_validate_pro_por_ice_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_fac_producto_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_fac_producto_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_fac_producto_mob_submit_form(var_pro_imagen, var_pro_codigo, var_pro_codigo_secundario, var_pro_nombre, var_pro_precio_uni, var_pro_tipo_comprobante, var_pro_estado, var_pro_iva, var_pro_por_iva, var_pro_ice, var_pro_por_ice, var_pro_imagen_ul_name, var_pro_imagen_ul_type, var_pro_imagen_salva, var_pro_imagen_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_fac_producto_mob_submit_form_cb);
  } // do_ajax_form_fac_producto_mob_submit_form

  function do_ajax_form_fac_producto_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_fac_producto_mob_submit_form_cb_after_alert);
  } // do_ajax_form_fac_producto_mob_submit_form_cb
  function do_ajax_form_fac_producto_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_fac_producto_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_fac_producto_mob_navigate_form()
  {
    perform_ajax_form_fac_producto_mob_navigate_form();
  }

  function perform_ajax_form_fac_producto_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_fac_producto_mob_navigate_form(var_pro_codigo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_producto_mob_navigate_form_cb);
  } // do_ajax_form_fac_producto_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_producto_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_fac_producto_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_fac_producto_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_fac_producto_mob_navigate_form_cb
  function do_ajax_form_fac_producto_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_fac_producto_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_fac_producto_mob_navigate_form_cb_after_alert

  function sc_hide_form_fac_producto_mob_form()
  {
