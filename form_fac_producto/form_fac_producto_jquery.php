...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_pro_filial' + iSeqRow).bind('change', function() { sc_form_fac_producto_pro_filial_onchange(this, iSeqRow) });
  $('#id_sc_field_pro_codigo' + iSeqRow).bind('blur', function() { sc_form_fac_producto_pro_codigo_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_fac_producto_pro_codigo_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pro_codigo_secundario' + iSeqRow).bind('blur', function() { sc_form_fac_producto_pro_codigo_secundario_onblur(this, iSeqRow) })
                                                   .bind('change', function() { sc_form_fac_producto_pro_codigo_secundario_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pro_imagen' + iSeqRow).bind('blur', function() { sc_form_fac_producto_pro_imagen_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_fac_producto_pro_imagen_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pro_nombre' + iSeqRow).bind('blur', function() { sc_form_fac_producto_pro_nombre_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_fac_producto_pro_nombre_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pro_precio_uni' + iSeqRow).bind('blur', function() { sc_form_fac_producto_pro_precio_uni_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_fac_producto_pro_precio_uni_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pro_por_iva' + iSeqRow).bind('blur', function() { sc_form_fac_producto_pro_por_iva_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_fac_producto_pro_por_iva_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pro_por_ice' + iSeqRow).bind('blur', function() { sc_form_fac_producto_pro_por_ice_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_fac_producto_pro_por_ice_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_fac_producto_pro_por_ice_onfocus(this, iSeqRow) });
  $('#id_sc_field_pro_usuario' + iSeqRow).bind('change', function() { sc_form_fac_producto_pro_usuario_onchange(this, iSeqRow) });
  $('#id_sc_field_pro_terminal' + iSeqRow).bind('change', function() { sc_form_fac_producto_pro_terminal_onchange(this, iSeqRow) });
  $('#id_sc_field_pro_fecha' + iSeqRow).bind('change', function() { sc_form_fac_producto_pro_fecha_onchange(this, iSeqRow) });
  $('#id_sc_field_pro_estado' + iSeqRow).bind('blur', function() { sc_form_fac_producto_pro_estado_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_fac_producto_pro_estado_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pro_tipo_comprobante' + iSeqRow).bind('blur', function() { sc_form_fac_producto_pro_tipo_comprobante_onblur(this, iSeqRow) })
                                                  .bind('change', function() { sc_form_fac_producto_pro_tipo_comprobante_onchange(this, iSeqRow) })
                                                  .bind('focus', function() { sc_form_fac_producto_pro_tipo_comprobante_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_fac_producto_pro_filial_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_fac_producto_pro_codigo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_fac_producto_pro_codigo_secundario_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_fac_producto_pro_imagen_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_fac_producto_pro_nombre_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_fac_producto_pro_precio_uni_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_fac_producto_pro_por_iva_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_fac_producto_pro_por_ice_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_fac_producto_pro_usuario_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_fac_producto_pro_terminal_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_fac_producto_pro_fecha_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_fac_producto_pro_estado_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_fac_producto_pro_tipo_comprobante_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_form_fac_producto_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_pro_fecha" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_fac_producto_validate_pro_fecha(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_pro_imagen" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_fac_producto_ul_save.php",
    dropZone: "",
    formData: function() {
      return [
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_fac_producto')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
