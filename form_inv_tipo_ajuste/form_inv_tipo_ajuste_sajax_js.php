...
?>
  ...
  // ---------- Validate ta_registra_costo_
  function do_ajax_form_inv_tipo_ajuste_validate_ta_registra_costo_(iNumLinha)
  {
    var nomeCampo_ta_registra_costo_ = "ta_registra_costo_" + iNumLinha;
    var var_ta_registra_costo_ = scAjaxGetFieldCheckbox(nomeCampo_ta_registra_costo_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_tipo_ajuste_validate_ta_registra_costo_(var_ta_registra_costo_, iNumLinha, var_script_case_init, do_ajax_form_inv_tipo_ajuste_validate_ta_registra_costo__cb);
  } // do_ajax_form_inv_tipo_ajuste_validate_ta_registra_costo_

  function do_ajax_form_inv_tipo_ajuste_validate_ta_registra_costo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "ta_registra_costo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ta_registra_costo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "ta_registra_costo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ta_registra_costo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_tipo_ajuste_validate_ta_registra_costo__cb

  // ---------- Validate ta_estado_
  function do_ajax_form_inv_tipo_ajuste_validate_ta_estado_(iNumLinha)
  {
    var nomeCampo_ta_estado_ = "ta_estado_" + iNumLinha;
    var var_ta_estado_ = scAjaxGetFieldSelect(nomeCampo_ta_estado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_tipo_ajuste_validate_ta_estado_(var_ta_estado_, iNumLinha, var_script_case_init, do_ajax_form_inv_tipo_ajuste_validate_ta_estado__cb);
  } // do_ajax_form_inv_tipo_ajuste_validate_ta_estado_

  function do_ajax_form_inv_tipo_ajuste_validate_ta_estado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_tipo_ajuste_validate_ta_estado__cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_inv_tipo_ajuste_submit_form(iNumLinha, indexTR)
  {
    ...
    var var_ta_registra_costo_ = scAjaxGetFieldCheckbox("ta_registra_costo_" + iNumLinha, ";");
...
?>
    x_ajax_form_inv_tipo_ajuste_submit_form(var_ta_id_, var_ta_descripcion_, var_ta_tipo_, var_ta_movimiento_kardex_, var_ta_empresa_, var_ta_registra_costo_, var_ta_estado_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_inv_tipo_ajuste_submit_form_cb);
...
?>
      ...
      scAjaxHideErrorDisplay("ta_registra_costo_" + sc_num_ult_line);
...
?>
  ...
  function perform_ajax_form_inv_tipo_ajuste_navigate_form()
  {
    ...
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("ta_registra_costo_" + iNavForm);
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "ta_registra_costo_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["ta_registra_costo_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_registra_costo'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["ta_registra_costo_"][iNumLinha] = "ta_registra_costo_" + iNumLinha;
    ...
    ajax_field_id["ta_registra_costo_" + iNumLinha] = new Array("hidden_field_label_ta_registra_costo_", "hidden_field_data_ta_registra_costo_" + iNumLinha);
    ...
    ajax_error_count["ta_registra_costo_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["ta_registra_costo_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["ta_registra_costo_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["ta_registra_costo_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["ta_registra_costo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ta_registra_costo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ta_registra_costo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ta_registra_costo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ta_registra_costo_" + iNumLinha]["onfocus"] = new Array();
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ta_registra_costo_'])) ? $this->nmgp_cmp_readonly['ta_registra_costo_'] : 'off';
?>
    scAjaxFieldRead("ta_registra_costo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("ta_registra_costo_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["ta_id_" + iRow] || "on" == ajax_error_count["ta_descripcion_" + iRow] || "on" == ajax_error_count["ta_tipo_" + iRow] || "on" == ajax_error_count["ta_movimiento_kardex_" + iRow] || "on" == ajax_error_count["ta_empresa_" + iRow] || "on" == ajax_error_count["ta_registra_costo_" + iRow] || "on" == ajax_error_count["ta_estado_" + iRow]))
    {
      ...
      $("#hidden_field_data_ta_registra_costo_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["ta_id_" + iRow] && "off" == ajax_error_count["ta_descripcion_" + iRow] && "off" == ajax_error_count["ta_tipo_" + iRow] && "off" == ajax_error_count["ta_movimiento_kardex_" + iRow] && "off" == ajax_error_count["ta_empresa_" + iRow] && "off" == ajax_error_count["ta_registra_costo_" + iRow] && "off" == ajax_error_count["ta_estado_" + iRow]))
    {
      if (bErrorRow)
      {
        ...
        ajax_error_count["ta_registra_costo_" + iRow] = "off";
      ...
      $("#hidden_field_data_ta_registra_costo_" + iRow).removeClass("scFormErrorLine");
