...
class grid_v_cartera_anulada_ind_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_op_contrato = array();
...
SCEOT;
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_v_cartera_anulada_ind']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_v_cartera_anulada_ind']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['orig_pesq'] = "resumo";
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['where_resumo'] = "";
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['contr_total_geral'] == "OK")
      {
          $this->array_total_op_contrato = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['arr_total']['op_contrato'];
      }
      else
      {
          $this->array_total_op_contrato = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['arr_total']['op_contrato'] = $this->array_total_op_contrato;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['json_use_label'])
       {
          $Lab_op_contrato = "op_contrato";
       }
       else
       {
       $Lab_op_contrato = "" . $this->Ini->Nm_lang['lang_contrato'] . "";
       }
       $this->comp_field = array(
           $Lab_op_contrato,
       );

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_fecha_ini']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_fecha_ini'] = "" . $this->Ini->Nm_lang['lang_fecha_inicio'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['cl_nombre']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['cl_nombre'] = "" . $this->Ini->Nm_lang['lang_nombre'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['con_numero_contrato']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['con_numero_contrato'] = "" . $this->Ini->Nm_lang['lang_numero_contrato'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['con_numero_medidor']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['con_numero_medidor'] = "" . $this->Ini->Nm_lang['lang_numero_medidor'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_comentario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_comentario'] = "" . $this->Ini->Nm_lang['lang_descripcion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_total'] = "" . $this->Ini->Nm_lang['lang_total'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_fecha_baja']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_fecha_baja'] = "" . $this->Ini->Nm_lang['lang_fecha_baja'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_motivo_baja']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_motivo_baja'] = "" . $this->Ini->Nm_lang['lang_motivo_anulacion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_estado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_estado'] = "" . $this->Ini->Nm_lang['lang_estado'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_operacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_operacion'] = "" . $this->Ini->Nm_lang['lang_operacion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_empresa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_empresa'] = "" . $this->Ini->Nm_lang['lang_empresa'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_fecha_emision']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_fecha_emision'] = "" . $this->Ini->Nm_lang['lang_fecha_emision'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_fecha_fin']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_fecha_fin'] = "" . $this->Ini->Nm_lang['lang_calendar_fld_end_date'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_propietario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_propietario'] = "" . $this->Ini->Nm_lang['lang_propietario'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['cl_identificacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['cl_identificacion'] = "" . $this->Ini->Nm_lang['lang_lot_identificacion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['cl_direccion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['cl_direccion'] = "" . $this->Ini->Nm_lang['lang_direccion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['cl_telefono']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['cl_telefono'] = "" . $this->Ini->Nm_lang['lang_lot_telefono'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['cl_celular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['cl_celular'] = "" . $this->Ini->Nm_lang['lang_celular'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['cl_email']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['cl_email'] = "" . $this->Ini->Nm_lang['lang_email'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_subtotal_iva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_subtotal_iva'] = "" . $this->Ini->Nm_lang['lang_subtotal_iva'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_subtotal_cero']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_subtotal_cero'] = "" . $this->Ini->Nm_lang['lang_subtotal_cero'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_total_descuento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_total_descuento'] = "" . $this->Ini->Nm_lang['lang_descuento'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_subtotal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_subtotal'] = "" . $this->Ini->Nm_lang['lang_subtotal'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_iva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_iva'] = "" . $this->Ini->Nm_lang['lang_iva'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_asiento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_asiento'] = "" . $this->Ini->Nm_lang['lang_asiento_emision'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_contrato']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_contrato'] = "" . $this->Ini->Nm_lang['lang_contrato'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['con_direccion_predio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['con_direccion_predio'] = "" . $this->Ini->Nm_lang['lang_direccion_predio'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['con_ruta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['con_ruta'] = "" . $this->Ini->Nm_lang['lang_ruta'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['con_toma_administrativa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['con_toma_administrativa'] = "" . $this->Ini->Nm_lang['lang_toma_administrativa'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['con_toma_operativa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['con_toma_operativa'] = "" . $this->Ini->Nm_lang['lang_toma_operativa'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['con_tipo_servicio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['con_tipo_servicio'] = "" . $this->Ini->Nm_lang['lang_tipo_servicio'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['con_condicion_contrato']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['con_condicion_contrato'] = "" . $this->Ini->Nm_lang['lang_condicion_contrato'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_asiento_anula']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_asiento_anula'] = "" . $this->Ini->Nm_lang['lang_asiento_anulacion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_factura']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['op_factura'] = "" . $this->Ini->Nm_lang['lang_factura'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['fac_tipo_comprobante']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['fac_tipo_comprobante'] = "" . $this->Ini->Nm_lang['lang_tipo_comprobante'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['serie']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['serie'] = "" . $this->Ini->Nm_lang['lang_serie_sri'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['secuencial']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['secuencial'] = "" . $this->Ini->Nm_lang['lang_secuencial'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['fac_fecha']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['fac_fecha'] = "" . $this->Ini->Nm_lang['lang_fecha'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['fac_subtotal_iva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['fac_subtotal_iva'] = "" . $this->Ini->Nm_lang['lang_subtotal_iva'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['fac_subtotal_cero']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['fac_subtotal_cero'] = "" . $this->Ini->Nm_lang['lang_subtotal_cero'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['fac_subtotal_no_objeto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['fac_subtotal_no_objeto'] = "" . $this->Ini->Nm_lang['lang_subtotal_no_objeto'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['fac_subtotal_excento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['fac_subtotal_excento'] = "" . $this->Ini->Nm_lang['lang_subtotal_exento'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['fac_subtotal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['fac_subtotal'] = "" . $this->Ini->Nm_lang['lang_subtotal'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['fac_total_descuento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['fac_total_descuento'] = "" . $this->Ini->Nm_lang['lang_descuento'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['fac_valor_ice']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['fac_valor_ice'] = "" . $this->Ini->Nm_lang['lang_ice'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['fac_valor_iva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['fac_valor_iva'] = "" . $this->Ini->Nm_lang['lang_iva'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['fac_valor_irbpnr']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['fac_valor_irbpnr'] = "" . $this->Ini->Nm_lang['lang_irbpnr'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['fac_propina']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['fac_propina'] = "" . $this->Ini->Nm_lang['lang_propina'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['fac_total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['fac_total'] = "" . $this->Ini->Nm_lang['lang_total'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['fac_estado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['fac_estado'] = "" . $this->Ini->Nm_lang['lang_estado'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['fac_estado_sri']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['labels']['fac_estado_sri'] = "" . $this->Ini->Nm_lang['lang_estado'] . " SRI"; 
       }
       //-----
       $this->comp_field_nm = array(
           'op_contrato' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['summarizing_fields_order']['con_numero_contrato']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['summarizing_fields_order']['con_numero_contrato'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['summarizing_fields_order']['con_numero_contrato'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['summarizing_fields_display']['con_numero_contrato'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['summarizing_fields_display']['con_numero_contrato'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['summarizing_fields_display']['con_numero_contrato'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['summarizing_fields_display']['con_numero_contrato'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['summarizing_fields_display']['con_numero_contrato'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['summarizing_fields_display']['con_numero_contrato'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['summarizing_fields_display']['con_numero_contrato'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "op_total", 'show' => true),
       );
       ...
       //-----
       foreach ($this->array_total_op_contrato as $i_op_contrato => $d_op_contrato) {
           if (!isset($i_op_contrato, $this->comp_label[0]) || !in_array($i_op_contrato, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_op_contrato[3] ] = $d_op_contrato[2];
               $this->comp_label[0][ $d_op_contrato[3] ] = $d_op_contrato[2];
           }
       }
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_tabular_label'];
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_op_contrato => $l_op_contrato) {
           if (isset($this->array_total_op_contrato[$i_op_contrato])) {
               $this->comp_group[$i_op_contrato] = array();
           }
       }
     }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_op_contrato;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_v_cartera_anulada_ind@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['proc_pdf_vert']){ 
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_v_cartera_anulada_ind_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_con_numero_contrato("res", $this->NM_export);
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['arr_total'][$cmp_gb];
      }
      if (is_array($this->array_total_op_contrato)) {
          ksort($this->array_total_op_contrato);
      }
   }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_cartera_anulada_ind_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_v_cartera_anulada_ind_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_cartera_anulada_ind_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_v_cartera_anulada_ind/grid_v_cartera_anulada_ind_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_v_cartera_anulada_ind/grid_v_cartera_anulada_ind_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid&nm_all_modules=grid&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_v_cartera_anulada_ind/grid_v_cartera_anulada_ind_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_v_cartera_anulada_ind&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid&nm_all_modules=grid&password=n&summary_export_columns=S&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_v_cartera_anulada_ind/grid_v_cartera_anulada_ind_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid&nm_all_modules=grid&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_v_cartera_anulada_ind_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_v_cartera_anulada_ind']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_v_cartera_anulada_ind']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_v_cartera_anulada_ind_config_pivot.php?nome_apl=grid_v_cartera_anulada_ind&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"grid_v_cartera_anulada_ind_iframe.php\";\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_cartera_anulada_ind_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_v_cartera_anulada_ind/grid_v_cartera_anulada_ind_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $op_fecha_ini = (isset($Busca_temp['op_fecha_ini'])) ? $Busca_temp['op_fecha_ini'] : ""; 
          $tmp_pos = (is_string($op_fecha_ini)) ? strpos($op_fecha_ini, "##@@") : false;
          if ($tmp_pos !== false && !is_array($op_fecha_ini))
          {
              $op_fecha_ini = substr($op_fecha_ini, 0, $tmp_pos);
          }
          $op_fecha_ini_2 = (isset($Busca_temp['op_fecha_ini_input_2'])) ? $Busca_temp['op_fecha_ini_input_2'] : ""; 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada_ind']['cond_pesq'], 0, $trab_pos);
   ...
   //---- 
   function adiciona_registro($sum_op_total, $quebra_op_contrato, $quebra_op_contrato_orig)
   {
      //----- op_contrato
      if (!isset($this->array_total_op_contrato[$quebra_op_contrato_orig]))
      {
         $this->array_total_op_contrato[$quebra_op_contrato_orig][0] = 1;
         $this->array_total_op_contrato[$quebra_op_contrato_orig][1] = $sum_op_total;
         $this->array_total_op_contrato[$quebra_op_contrato_orig][2] = $quebra_op_contrato;
         $this->array_total_op_contrato[$quebra_op_contrato_orig][3] = $quebra_op_contrato_orig;
      }
      else
      {
         $this->array_total_op_contrato[$quebra_op_contrato_orig][0]++;
         $this->array_total_op_contrato[$quebra_op_contrato_orig][1] = bcadd($this->array_total_op_contrato[$quebra_op_contrato_orig][1], $sum_op_total, 10);
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
       ...
       $this->op_fecha_ini = $Busca_temp['op_fecha_ini']; 
       $this->op_fecha_ini = (isset($Busca_temp['op_fecha_ini'])) ? $Busca_temp['op_fecha_ini'] : ""; 
       $tmp_pos = (is_string($this->op_fecha_ini)) ? strpos($this->op_fecha_ini, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->op_fecha_ini))
       {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('con_numero_contrato', 'op_contrato');
     $campos_order = $this->Ini->Get_date_order_groupby("op_contrato", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->op_fecha_ini = $rs_res->fields[0] ;  
            $this->cl_nombre = $rs_res->fields[1] ;  
            $this->con_numero_contrato = $rs_res->fields[2] ;  
            $this->con_numero_medidor = $rs_res->fields[3] ;  
            $this->op_comentario = $rs_res->fields[4] ;  
            $this->op_total = $rs_res->fields[5] ;  
            $this->op_fecha_baja = $rs_res->fields[6] ;  
            $this->op_motivo_baja = $rs_res->fields[7] ;  
            $this->op_estado = $rs_res->fields[8] ;  
            $this->op_operacion = $rs_res->fields[9] ;  
            $this->op_empresa = $rs_res->fields[10] ;  
            $this->op_fecha_emision = $rs_res->fields[11] ;  
            $this->op_fecha_fin = $rs_res->fields[12] ;  
            $this->op_propietario = $rs_res->fields[13] ;  
            $this->op_subtotal_iva = $rs_res->fields[14] ;  
            $this->op_subtotal_iva =  str_replace(",", ".", $this->op_subtotal_iva);
            $this->op_subtotal_cero = $rs_res->fields[15] ;  
            $this->op_subtotal_cero =  str_replace(",", ".", $this->op_subtotal_cero);
            $this->op_subtotal = $rs_res->fields[16] ;  
            $this->op_subtotal =  str_replace(",", ".", $this->op_subtotal);
            $this->op_iva = $rs_res->fields[17] ;  
            $this->op_iva =  str_replace(",", ".", $this->op_iva);
            $this->op_contrato = $rs_res->fields[18] ;  
            $this->op_contrato_orig = $this->op_contrato;
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->op_total, $this->op_contrato, $this->op_contrato_orig);
            }
   }
//
