<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_v_cartera_anulada_ind']['glo_nm_path_imag_temp'] . "/sc_apl_default_SIJAP.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_v_cartera_anulada_ind_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_v_cartera_anulada_ind_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_anulada_ind']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_cartera_anulada_ind']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["op_fecha_ini"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_anulada_ind']['labels']["op_fecha_ini"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_cartera_anulada_ind']['labels']["op_fecha_ini"] : "" . $this->Nm_lang['lang_fecha_inicio'] . "";
   $tab_ger_campos['cl_nombre'] = "on";
   $tab_def_campos['cl_nombre'] = "cl_nombre";
   $tab_labels["cl_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_anulada_ind']['labels']["cl_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_cartera_anulada_ind']['labels']["cl_nombre"] : "" . $this->Nm_lang['lang_nombre'] . "";
   $tab_ger_campos['con_numero_contrato'] = "on";
   $tab_def_campos['con_numero_contrato'] = "con_numero_contrato";
   $tab_labels["con_numero_contrato"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_anulada_ind']['labels']["con_numero_contrato"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_cartera_anulada_ind']['labels']["con_numero_contrato"] : "" . $this->Nm_lang['lang_numero_contrato'] . "";
   $tab_ger_campos['con_numero_medidor'] = "on";
   $tab_def_campos['con_numero_medidor'] = "con_numero_medidor";
   $tab_labels["con_numero_medidor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_anulada_ind']['labels']["con_numero_medidor"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_cartera_anulada_ind']['labels']["con_numero_medidor"] : "" . $this->Nm_lang['lang_numero_medidor'] . "";
   $tab_ger_campos['op_comentario'] = "on";
   $tab_def_campos['op_comentario'] = "op_comentario";
   $tab_labels["op_comentario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_anulada_ind']['labels']["op_comentario"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_cartera_anulada_ind']['labels']["op_comentario"] : "" . $this->Nm_lang['lang_descripcion'] . "";
   $tab_ger_campos['op_total'] = "on";
   $tab_def_campos['op_total'] = "op_total";
   $tab_labels["op_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_anulada_ind']['labels']["op_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_cartera_anulada_ind']['labels']["op_total"] : "" . $this->Nm_lang['lang_total'] . "";
   $tab_ger_campos['op_fecha_baja'] = "on";
   $tab_def_campos['op_fecha_baja'] = "op_fecha_baja";
   $tab_labels["op_fecha_baja"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_anulada_ind']['labels']["op_fecha_baja"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_cartera_anulada_ind']['labels']["op_fecha_baja"] : "" . $this->Nm_lang['lang_fecha_baja'] . "";
   $tab_ger_campos['op_motivo_baja'] = "on";
   $tab_def_campos['op_motivo_baja'] = "op_motivo_baja";
   $tab_labels["op_motivo_baja"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_anulada_ind']['labels']["op_motivo_baja"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_cartera_anulada_ind']['labels']["op_motivo_baja"] : "" . $this->Nm_lang['lang_motivo_anulacion'] . "";
   $tab_ger_campos['op_estado'] = "on";
   $tab_def_campos['op_estado'] = "op_estado";
   $tab_labels["op_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_anulada_ind']['labels']["op_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_cartera_anulada_ind']['labels']["op_estado"] : "" . $this->Nm_lang['lang_estado'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_anulada_ind']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_v_cartera_anulada_ind']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_v_cartera_anulada_ind']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_anulada_ind']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_cartera_anulada_ind']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_v_cartera_anulada_ind']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_v_cartera_anulada_ind']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_v_cartera_anulada_ind']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_anulada_ind']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_v_cartera_anulada_ind']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_v_cartera_anulada_ind']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_v_cartera_anulada_ind']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_v_cartera_anulada_ind_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_v_cartera_anulada_ind']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_v_cartera_anulada_ind']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_anulada_ind']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_v_cartera_anulada_ind']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_v_cartera_anulada_ind']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
