<?php
@session_start() ;
$_SESSION['scriptcase']['grid_fac_operacion_contrato']['sc_process_barr'] = true;
require_once('../grid_fac_operacion_contrato/index.php');
unset($_SESSION['scriptcase']['grid_fac_operacion_contrato']['sc_process_barr']);
$ExportCtrl = new grid_fac_operacion_contrato_export_control;
$ExportCtrl->Export_barr();

class grid_fac_operacion_contrato_export_control
{
