  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_jap_ruta_contrato" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_jap_ruta_contrato_form();
	}
...
?>
  ...
  // ---------- Validate rc_id
  function do_ajax_form_jap_ruta_contrato_validate_rc_id()
  {
    var nomeCampo_rc_id = "rc_id";
    var var_rc_id = scAjaxGetFieldHidden(nomeCampo_rc_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_ruta_contrato_validate_rc_id(var_rc_id, var_script_case_init, do_ajax_form_jap_ruta_contrato_validate_rc_id_cb);
  } // do_ajax_form_jap_ruta_contrato_validate_rc_id

  function do_ajax_form_jap_ruta_contrato_validate_rc_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_ruta_contrato_validate_rc_id_cb

  // ---------- Validate rc_ruta
  function do_ajax_form_jap_ruta_contrato_validate_rc_ruta()
  {
    var nomeCampo_rc_ruta = "rc_ruta";
    var var_rc_ruta = scAjaxGetFieldText(nomeCampo_rc_ruta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_ruta_contrato_validate_rc_ruta(var_rc_ruta, var_script_case_init, do_ajax_form_jap_ruta_contrato_validate_rc_ruta_cb);
  } // do_ajax_form_jap_ruta_contrato_validate_rc_ruta

  function do_ajax_form_jap_ruta_contrato_validate_rc_ruta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "rc_ruta";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_ruta_contrato_validate_rc_ruta_cb

  // ---------- Validate rc_orden
  function do_ajax_form_jap_ruta_contrato_validate_rc_orden()
  {
    var nomeCampo_rc_orden = "rc_orden";
    var var_rc_orden = scAjaxGetFieldText(nomeCampo_rc_orden);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_ruta_contrato_validate_rc_orden(var_rc_orden, var_script_case_init, do_ajax_form_jap_ruta_contrato_validate_rc_orden_cb);
  } // do_ajax_form_jap_ruta_contrato_validate_rc_orden

  function do_ajax_form_jap_ruta_contrato_validate_rc_orden_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_ruta_contrato_validate_rc_orden_cb

  // ---------- Validate rc_contrato
  function do_ajax_form_jap_ruta_contrato_validate_rc_contrato()
  {
    var nomeCampo_rc_contrato = "rc_contrato";
    var var_rc_contrato = scAjaxGetFieldHidden(nomeCampo_rc_contrato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_ruta_contrato_validate_rc_contrato(var_rc_contrato, var_script_case_init, do_ajax_form_jap_ruta_contrato_validate_rc_contrato_cb);
  } // do_ajax_form_jap_ruta_contrato_validate_rc_contrato

  function do_ajax_form_jap_ruta_contrato_validate_rc_contrato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_ruta_contrato_validate_rc_contrato_cb

  // ---------- Validate rc_num_contrato
  function do_ajax_form_jap_ruta_contrato_validate_rc_num_contrato()
  {
    var nomeCampo_rc_num_contrato = "rc_num_contrato";
    var var_rc_num_contrato = scAjaxGetFieldHidden(nomeCampo_rc_num_contrato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_ruta_contrato_validate_rc_num_contrato(var_rc_num_contrato, var_script_case_init, do_ajax_form_jap_ruta_contrato_validate_rc_num_contrato_cb);
  } // do_ajax_form_jap_ruta_contrato_validate_rc_num_contrato

  function do_ajax_form_jap_ruta_contrato_validate_rc_num_contrato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_ruta_contrato_validate_rc_num_contrato_cb

  // ---------- Validate rc_cedula
  function do_ajax_form_jap_ruta_contrato_validate_rc_cedula()
  {
    var nomeCampo_rc_cedula = "rc_cedula";
    var var_rc_cedula = scAjaxGetFieldHidden(nomeCampo_rc_cedula);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_ruta_contrato_validate_rc_cedula(var_rc_cedula, var_script_case_init, do_ajax_form_jap_ruta_contrato_validate_rc_cedula_cb);
  } // do_ajax_form_jap_ruta_contrato_validate_rc_cedula

  function do_ajax_form_jap_ruta_contrato_validate_rc_cedula_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_ruta_contrato_validate_rc_cedula_cb

  // ---------- Validate rc_usuario
  function do_ajax_form_jap_ruta_contrato_validate_rc_usuario()
  {
    var nomeCampo_rc_usuario = "rc_usuario";
    var var_rc_usuario = scAjaxGetFieldHidden(nomeCampo_rc_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_ruta_contrato_validate_rc_usuario(var_rc_usuario, var_script_case_init, do_ajax_form_jap_ruta_contrato_validate_rc_usuario_cb);
  } // do_ajax_form_jap_ruta_contrato_validate_rc_usuario

  function do_ajax_form_jap_ruta_contrato_validate_rc_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_ruta_contrato_validate_rc_usuario_cb

  // ---------- Validate rc_num_medidor
  function do_ajax_form_jap_ruta_contrato_validate_rc_num_medidor()
  {
    var nomeCampo_rc_num_medidor = "rc_num_medidor";
    var var_rc_num_medidor = scAjaxGetFieldHidden(nomeCampo_rc_num_medidor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_ruta_contrato_validate_rc_num_medidor(var_rc_num_medidor, var_script_case_init, do_ajax_form_jap_ruta_contrato_validate_rc_num_medidor_cb);
  } // do_ajax_form_jap_ruta_contrato_validate_rc_num_medidor

  function do_ajax_form_jap_ruta_contrato_validate_rc_num_medidor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_ruta_contrato_validate_rc_num_medidor_cb

  // ---------- Validate rc_registra_danio
  function do_ajax_form_jap_ruta_contrato_validate_rc_registra_danio()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_ruta_contrato_validate_rc_registra_danio(var_rc_registra_danio, var_script_case_init, do_ajax_form_jap_ruta_contrato_validate_rc_registra_danio_cb);
  } // do_ajax_form_jap_ruta_contrato_validate_rc_registra_danio

  function do_ajax_form_jap_ruta_contrato_validate_rc_registra_danio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_ruta_contrato_validate_rc_registra_danio_cb

  // ---------- Event onchange rc_contrato
  function do_ajax_form_jap_ruta_contrato_event_rc_contrato_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_jap_ruta_contrato_event_rc_contrato_onchange(var_rc_contrato, var_rc_cedula, var_rc_usuario, var_rc_num_medidor, var_rc_num_contrato, var_script_case_init, do_ajax_form_jap_ruta_contrato_event_rc_contrato_onchange_cb);
  } // do_ajax_form_jap_ruta_contrato_event_rc_contrato_onchange

  function do_ajax_form_jap_ruta_contrato_event_rc_contrato_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "rc_contrato";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_jap_ruta_contrato_event_rc_contrato_onchange_cb_after_alert);
  } // do_ajax_form_jap_ruta_contrato_event_rc_contrato_onchange_cb
  function do_ajax_form_jap_ruta_contrato_event_rc_contrato_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_jap_ruta_contrato_event_rc_contrato_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_jap_ruta_contrato_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_jap_ruta_contrato_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_jap_ruta_contrato_submit_form(var_rc_id, var_rc_ruta, var_rc_orden, var_rc_contrato, var_rc_num_contrato, var_rc_cedula, var_rc_usuario, var_rc_num_medidor, var_rc_registra_danio, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_jap_ruta_contrato_submit_form_cb);
  } // do_ajax_form_jap_ruta_contrato_submit_form

  function do_ajax_form_jap_ruta_contrato_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_jap_ruta_contrato_submit_form_cb_after_alert);
  } // do_ajax_form_jap_ruta_contrato_submit_form_cb
  function do_ajax_form_jap_ruta_contrato_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_jap_ruta_contrato_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_jap_ruta_contrato_navigate_form()
  {
    perform_ajax_form_jap_ruta_contrato_navigate_form();
  }

  function perform_ajax_form_jap_ruta_contrato_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_jap_ruta_contrato_navigate_form(var_rc_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jap_ruta_contrato_navigate_form_cb);
  } // do_ajax_form_jap_ruta_contrato_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_ruta_contrato']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_jap_ruta_contrato_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_jap_ruta_contrato_navigate_form_cb_after_alert);
  } // do_ajax_form_jap_ruta_contrato_navigate_form_cb
  function do_ajax_form_jap_ruta_contrato_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_jap_ruta_contrato_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_jap_ruta_contrato_navigate_form_cb_after_alert

  function sc_hide_form_jap_ruta_contrato_form()
  {
