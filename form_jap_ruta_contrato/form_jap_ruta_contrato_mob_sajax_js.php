  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_jap_ruta_contrato_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_jap_ruta_contrato_mob_form();
	}
...
?>
  ...
  // ---------- Validate rc_id
  function do_ajax_form_jap_ruta_contrato_mob_validate_rc_id()
  {
    var nomeCampo_rc_id = "rc_id";
    var var_rc_id = scAjaxGetFieldHidden(nomeCampo_rc_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_ruta_contrato_mob_validate_rc_id(var_rc_id, var_script_case_init, do_ajax_form_jap_ruta_contrato_mob_validate_rc_id_cb);
  } // do_ajax_form_jap_ruta_contrato_mob_validate_rc_id

  function do_ajax_form_jap_ruta_contrato_mob_validate_rc_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_ruta_contrato_mob_validate_rc_id_cb

  // ---------- Validate rc_ruta
  function do_ajax_form_jap_ruta_contrato_mob_validate_rc_ruta()
  {
    var nomeCampo_rc_ruta = "rc_ruta";
    var var_rc_ruta = scAjaxGetFieldText(nomeCampo_rc_ruta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_ruta_contrato_mob_validate_rc_ruta(var_rc_ruta, var_script_case_init, do_ajax_form_jap_ruta_contrato_mob_validate_rc_ruta_cb);
  } // do_ajax_form_jap_ruta_contrato_mob_validate_rc_ruta

  function do_ajax_form_jap_ruta_contrato_mob_validate_rc_ruta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "rc_ruta";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_ruta_contrato_mob_validate_rc_ruta_cb

  // ---------- Validate rc_orden
  function do_ajax_form_jap_ruta_contrato_mob_validate_rc_orden()
  {
    var nomeCampo_rc_orden = "rc_orden";
    var var_rc_orden = scAjaxGetFieldText(nomeCampo_rc_orden);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_ruta_contrato_mob_validate_rc_orden(var_rc_orden, var_script_case_init, do_ajax_form_jap_ruta_contrato_mob_validate_rc_orden_cb);
  } // do_ajax_form_jap_ruta_contrato_mob_validate_rc_orden

  function do_ajax_form_jap_ruta_contrato_mob_validate_rc_orden_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "rc_orden";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_ruta_contrato_mob_validate_rc_orden_cb

  // ---------- Validate rc_contrato
  function do_ajax_form_jap_ruta_contrato_mob_validate_rc_contrato()
  {
    var nomeCampo_rc_contrato = "rc_contrato";
    var var_rc_contrato = scAjaxGetFieldHidden(nomeCampo_rc_contrato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_ruta_contrato_mob_validate_rc_contrato(var_rc_contrato, var_script_case_init, do_ajax_form_jap_ruta_contrato_mob_validate_rc_contrato_cb);
  } // do_ajax_form_jap_ruta_contrato_mob_validate_rc_contrato

  function do_ajax_form_jap_ruta_contrato_mob_validate_rc_contrato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "rc_contrato";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_ruta_contrato_mob_validate_rc_contrato_cb

  // ---------- Validate rc_num_contrato
  function do_ajax_form_jap_ruta_contrato_mob_validate_rc_num_contrato()
  {
    var nomeCampo_rc_num_contrato = "rc_num_contrato";
    var var_rc_num_contrato = scAjaxGetFieldHidden(nomeCampo_rc_num_contrato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_ruta_contrato_mob_validate_rc_num_contrato(var_rc_num_contrato, var_script_case_init, do_ajax_form_jap_ruta_contrato_mob_validate_rc_num_contrato_cb);
  } // do_ajax_form_jap_ruta_contrato_mob_validate_rc_num_contrato

  function do_ajax_form_jap_ruta_contrato_mob_validate_rc_num_contrato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "rc_num_contrato";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_ruta_contrato_mob_validate_rc_num_contrato_cb

  // ---------- Validate rc_cedula
  function do_ajax_form_jap_ruta_contrato_mob_validate_rc_cedula()
  {
    var nomeCampo_rc_cedula = "rc_cedula";
    var var_rc_cedula = scAjaxGetFieldHidden(nomeCampo_rc_cedula);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_ruta_contrato_mob_validate_rc_cedula(var_rc_cedula, var_script_case_init, do_ajax_form_jap_ruta_contrato_mob_validate_rc_cedula_cb);
  } // do_ajax_form_jap_ruta_contrato_mob_validate_rc_cedula

  function do_ajax_form_jap_ruta_contrato_mob_validate_rc_cedula_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "rc_cedula";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_ruta_contrato_mob_validate_rc_cedula_cb

  // ---------- Validate rc_usuario
  function do_ajax_form_jap_ruta_contrato_mob_validate_rc_usuario()
  {
    var nomeCampo_rc_usuario = "rc_usuario";
    var var_rc_usuario = scAjaxGetFieldHidden(nomeCampo_rc_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_ruta_contrato_mob_validate_rc_usuario(var_rc_usuario, var_script_case_init, do_ajax_form_jap_ruta_contrato_mob_validate_rc_usuario_cb);
  } // do_ajax_form_jap_ruta_contrato_mob_validate_rc_usuario

  function do_ajax_form_jap_ruta_contrato_mob_validate_rc_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "rc_usuario";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_ruta_contrato_mob_validate_rc_usuario_cb

  // ---------- Validate rc_num_medidor
  function do_ajax_form_jap_ruta_contrato_mob_validate_rc_num_medidor()
  {
    var nomeCampo_rc_num_medidor = "rc_num_medidor";
    var var_rc_num_medidor = scAjaxGetFieldHidden(nomeCampo_rc_num_medidor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_ruta_contrato_mob_validate_rc_num_medidor(var_rc_num_medidor, var_script_case_init, do_ajax_form_jap_ruta_contrato_mob_validate_rc_num_medidor_cb);
  } // do_ajax_form_jap_ruta_contrato_mob_validate_rc_num_medidor

  function do_ajax_form_jap_ruta_contrato_mob_validate_rc_num_medidor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "rc_num_medidor";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_ruta_contrato_mob_validate_rc_num_medidor_cb

  // ---------- Validate rc_registra_danio
  function do_ajax_form_jap_ruta_contrato_mob_validate_rc_registra_danio()
  {
    var nomeCampo_rc_registra_danio = "rc_registra_danio";
    var var_rc_registra_danio = scAjaxGetFieldCheckbox(nomeCampo_rc_registra_danio, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_ruta_contrato_mob_validate_rc_registra_danio(var_rc_registra_danio, var_script_case_init, do_ajax_form_jap_ruta_contrato_mob_validate_rc_registra_danio_cb);
  } // do_ajax_form_jap_ruta_contrato_mob_validate_rc_registra_danio

  function do_ajax_form_jap_ruta_contrato_mob_validate_rc_registra_danio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "rc_registra_danio";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_ruta_contrato_mob_validate_rc_registra_danio_cb

  // ---------- Event onchange rc_contrato
  function do_ajax_form_jap_ruta_contrato_mob_event_rc_contrato_onchange()
  {
    var var_rc_contrato = scAjaxGetFieldHidden("rc_contrato");
    var var_rc_cedula = scAjaxGetFieldHidden("rc_cedula");
    var var_rc_usuario = scAjaxGetFieldHidden("rc_usuario");
    var var_rc_num_medidor = scAjaxGetFieldHidden("rc_num_medidor");
    var var_rc_num_contrato = scAjaxGetFieldHidden("rc_num_contrato");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_jap_ruta_contrato_mob_event_rc_contrato_onchange(var_rc_contrato, var_rc_cedula, var_rc_usuario, var_rc_num_medidor, var_rc_num_contrato, var_script_case_init, do_ajax_form_jap_ruta_contrato_mob_event_rc_contrato_onchange_cb);
  } // do_ajax_form_jap_ruta_contrato_mob_event_rc_contrato_onchange

  function do_ajax_form_jap_ruta_contrato_mob_event_rc_contrato_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "rc_contrato";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_jap_ruta_contrato_mob_event_rc_contrato_onchange_cb_after_alert);
  } // do_ajax_form_jap_ruta_contrato_mob_event_rc_contrato_onchange_cb
  function do_ajax_form_jap_ruta_contrato_mob_event_rc_contrato_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_jap_ruta_contrato_mob_event_rc_contrato_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_jap_ruta_contrato_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_jap_ruta_contrato_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_rc_id = scAjaxGetFieldHidden("rc_id");
    var var_rc_ruta = scAjaxGetFieldText("rc_ruta");
    var var_rc_orden = scAjaxGetFieldText("rc_orden");
    var var_rc_contrato = scAjaxGetFieldHidden("rc_contrato");
    var var_rc_num_contrato = scAjaxGetFieldHidden("rc_num_contrato");
    var var_rc_cedula = scAjaxGetFieldHidden("rc_cedula");
    var var_rc_usuario = scAjaxGetFieldHidden("rc_usuario");
    var var_rc_num_medidor = scAjaxGetFieldHidden("rc_num_medidor");
    var var_rc_registra_danio = scAjaxGetFieldCheckbox("rc_registra_danio", ";");
    ...
    scAjaxProcOn();
    x_ajax_form_jap_ruta_contrato_mob_submit_form(var_rc_id, var_rc_ruta, var_rc_orden, var_rc_contrato, var_rc_num_contrato, var_rc_cedula, var_rc_usuario, var_rc_num_medidor, var_rc_registra_danio, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_jap_ruta_contrato_mob_submit_form_cb);
  } // do_ajax_form_jap_ruta_contrato_mob_submit_form

  function do_ajax_form_jap_ruta_contrato_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("rc_id");
      scAjaxHideErrorDisplay("rc_ruta");
      scAjaxHideErrorDisplay("rc_orden");
      scAjaxHideErrorDisplay("rc_contrato");
      scAjaxHideErrorDisplay("rc_num_contrato");
      scAjaxHideErrorDisplay("rc_cedula");
      scAjaxHideErrorDisplay("rc_usuario");
      scAjaxHideErrorDisplay("rc_num_medidor");
      scAjaxHideErrorDisplay("rc_registra_danio");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_jap_ruta_contrato_mob_submit_form_cb_after_alert);
  } // do_ajax_form_jap_ruta_contrato_mob_submit_form_cb
  function do_ajax_form_jap_ruta_contrato_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_jap_ruta_contrato_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_jap_ruta_contrato_mob_navigate_form()
  {
    perform_ajax_form_jap_ruta_contrato_mob_navigate_form();
  }

  function perform_ajax_form_jap_ruta_contrato_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("rc_num_medidor");
    scAjaxHideErrorDisplay("rc_registra_danio");
    var var_rc_id = document.F2.rc_id.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_jap_ruta_contrato_mob_navigate_form(var_rc_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jap_ruta_contrato_mob_navigate_form_cb);
  } // do_ajax_form_jap_ruta_contrato_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_ruta_contrato_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_jap_ruta_contrato_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.rc_id.value = scAjaxGetKeyValue("rc_id");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_jap_ruta_contrato_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_jap_ruta_contrato_mob_navigate_form_cb
  function do_ajax_form_jap_ruta_contrato_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_jap_ruta_contrato_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_jap_ruta_contrato_mob_navigate_form_cb_after_alert

  function sc_hide_form_jap_ruta_contrato_mob_form()
  {
  ...
  ajax_field_list[0] = "rc_id";
  ajax_field_list[1] = "rc_ruta";
  ajax_field_list[2] = "rc_orden";
  ajax_field_list[3] = "rc_contrato";
  ajax_field_list[4] = "rc_num_contrato";
  ajax_field_list[5] = "rc_cedula";
  ajax_field_list[6] = "rc_usuario";
  ajax_field_list[7] = "rc_num_medidor";
  ajax_field_list[8] = "rc_registra_danio";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "rc_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "rc_ruta": {"label": "<?php echo $this->Ini->Nm_lang['lang_ruta'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "rc_orden": {"label": "<?php echo $this->Ini->Nm_lang['lang_orden_ingreso'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "rc_contrato": {"label": "<?php echo $this->Ini->Nm_lang['lang_contrato'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "rc_num_contrato": {"label": "<?php echo $this->Ini->Nm_lang['lang_contrato'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "rc_cedula": {"label": "<?php echo $this->Ini->Nm_lang['lang_lot_identificacion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "rc_usuario": {"label": "<?php echo $this->Ini->Nm_lang['lang_cliente'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "rc_num_medidor": {"label": "<?php echo $this->Ini->Nm_lang['lang_numero_medidor'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "rc_registra_danio": {"label": "<?php echo $this->Ini->Nm_lang['lang_registra_danio'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "rc_ruta": new Array(),
    "rc_orden": new Array(),
    "rc_contrato": new Array(),
    "rc_num_contrato": new Array(),
    "rc_cedula": new Array(),
    "rc_usuario": new Array(),
    "rc_num_medidor": new Array(),
    "rc_registra_danio": new Array()
  };
  ajax_field_mult["rc_id"][1] = "rc_id";
  ajax_field_mult["rc_ruta"][1] = "rc_ruta";
  ajax_field_mult["rc_orden"][1] = "rc_orden";
  ajax_field_mult["rc_contrato"][1] = "rc_contrato";
  ajax_field_mult["rc_num_contrato"][1] = "rc_num_contrato";
  ajax_field_mult["rc_cedula"][1] = "rc_cedula";
  ajax_field_mult["rc_usuario"][1] = "rc_usuario";
  ajax_field_mult["rc_num_medidor"][1] = "rc_num_medidor";
  ajax_field_mult["rc_registra_danio"][1] = "rc_registra_danio";

  var ajax_field_id = {
    "rc_orden": new Array("hidden_field_label_rc_orden", "hidden_field_data_rc_orden"),
    "rc_contrato": new Array("hidden_field_label_rc_contrato", "hidden_field_data_rc_contrato"),
    "rc_num_contrato": new Array("hidden_field_label_rc_num_contrato", "hidden_field_data_rc_num_contrato"),
    "rc_cedula": new Array("hidden_field_label_rc_cedula", "hidden_field_data_rc_cedula"),
    "rc_usuario": new Array("hidden_field_label_rc_usuario", "hidden_field_data_rc_usuario"),
    "rc_num_medidor": new Array("hidden_field_label_rc_num_medidor", "hidden_field_data_rc_num_medidor"),
    "rc_registra_danio": new Array("hidden_field_label_rc_registra_danio", "hidden_field_data_rc_registra_danio")
  };
