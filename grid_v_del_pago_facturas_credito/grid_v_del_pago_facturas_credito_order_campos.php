...
<?php
   ...
   $Ord_Cmp = new grid_v_del_pago_facturas_credito_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_v_del_pago_facturas_credito_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_del_pago_facturas_credito']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_del_pago_facturas_credito']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['tc_nombre'] = "tc_nombre";
   $tab_labels["tc_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_pago_facturas_credito']['labels']["tc_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_pago_facturas_credito']['labels']["tc_nombre"] : "" . $this->Nm_lang['lang_tipo_comprobante'] . "";
   $tab_ger_campos['fac_fecha'] = "on";
   $tab_def_campos['fac_fecha'] = "fac_fecha";
   $tab_labels["fac_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_pago_facturas_credito']['labels']["fac_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_pago_facturas_credito']['labels']["fac_fecha"] : "" . $this->Nm_lang['lang_fecha'] . "";
   $tab_ger_campos['factura'] = "on";
   $tab_def_campos['factura'] = "factura";
   $tab_labels["factura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_pago_facturas_credito']['labels']["factura"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_pago_facturas_credito']['labels']["factura"] : "Factura";
   $tab_ger_campos['fac_comentario'] = "on";
   $tab_def_campos['fac_comentario'] = "fac_comentario";
   $tab_labels["fac_comentario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_pago_facturas_credito']['labels']["fac_comentario"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_pago_facturas_credito']['labels']["fac_comentario"] : "" . $this->Nm_lang['lang_comentario'] . "";
   $tab_ger_campos['fac_total'] = "on";
   $tab_def_campos['fac_total'] = "fac_total";
   $tab_labels["fac_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_pago_facturas_credito']['labels']["fac_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_pago_facturas_credito']['labels']["fac_total"] : "" . $this->Nm_lang['lang_total'] . "";
   $tab_ger_campos['fac_estado'] = "on";
   $tab_def_campos['fac_estado'] = "fac_estado";
   $tab_labels["fac_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_pago_facturas_credito']['labels']["fac_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_pago_facturas_credito']['labels']["fac_estado"] : "" . $this->Nm_lang['lang_estado'] . "";
   $tab_ger_campos['baucher'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['baucher'] = "baucher";
   }
   else
   {
       $tab_def_campos['baucher'] = "";
   }
   $tab_labels["baucher"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_pago_facturas_credito']['labels']["baucher"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_pago_facturas_credito']['labels']["baucher"] : "" . $this->Nm_lang['lang_baucher'] . "";
   $tab_ger_campos['baucher'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_pago_facturas_credito']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_v_del_pago_facturas_credito']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_v_del_pago_facturas_credito']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_del_pago_facturas_credito']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_del_pago_facturas_credito']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_v_del_pago_facturas_credito']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_v_del_pago_facturas_credito']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_v_del_pago_facturas_credito']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_pago_facturas_credito']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_v_del_pago_facturas_credito']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_v_del_pago_facturas_credito']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_v_del_pago_facturas_credito']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_v_del_pago_facturas_credito_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_pago_facturas_credito']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_v_del_pago_facturas_credito']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_pago_facturas_credito']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_v_del_pago_facturas_credito']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_v_del_pago_facturas_credito']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
