  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_producto_nota_debito" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_producto_nota_debito_form();
	}
...
?>
  ...
  function do_ajax_form_del_producto_nota_debito_validate_pro_codigo_(iNumLinha)
  {
    var nomeCampo_pro_codigo_ = "pro_codigo_" + iNumLinha;
    var var_pro_codigo_ = scAjaxGetFieldText(nomeCampo_pro_codigo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_producto_nota_debito_validate_pro_codigo_(var_pro_codigo_, iNumLinha, var_script_case_init, do_ajax_form_del_producto_nota_debito_validate_pro_codigo__cb);
  } // do_ajax_form_del_producto_nota_debito_validate_pro_codigo_

  function do_ajax_form_del_producto_nota_debito_validate_pro_codigo__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_producto_nota_debito_validate_pro_codigo__cb

  // ---------- Validate pro_empresa_
  function do_ajax_form_del_producto_nota_debito_validate_pro_empresa_(iNumLinha)
  {
    var nomeCampo_pro_empresa_ = "pro_empresa_" + iNumLinha;
    var var_pro_empresa_ = scAjaxGetFieldText(nomeCampo_pro_empresa_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_producto_nota_debito_validate_pro_empresa_(var_pro_empresa_, iNumLinha, var_script_case_init, do_ajax_form_del_producto_nota_debito_validate_pro_empresa__cb);
  } // do_ajax_form_del_producto_nota_debito_validate_pro_empresa_

  function do_ajax_form_del_producto_nota_debito_validate_pro_empresa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "pro_empresa_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pro_empresa_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "pro_empresa_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pro_empresa_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_producto_nota_debito_validate_pro_empresa__cb

  // ---------- Validate pro_descripcion_
  function do_ajax_form_del_producto_nota_debito_validate_pro_descripcion_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_producto_nota_debito_validate_pro_descripcion_(var_pro_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_del_producto_nota_debito_validate_pro_descripcion__cb);
  } // do_ajax_form_del_producto_nota_debito_validate_pro_descripcion_

  function do_ajax_form_del_producto_nota_debito_validate_pro_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_producto_nota_debito_validate_pro_descripcion__cb

  // ---------- Validate pro_precio_
  function do_ajax_form_del_producto_nota_debito_validate_pro_precio_(iNumLinha)
  {
    var nomeCampo_pro_precio_ = "pro_precio_" + iNumLinha;
    var var_pro_precio_ = scAjaxGetFieldText(nomeCampo_pro_precio_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_producto_nota_debito_validate_pro_precio_(var_pro_precio_, iNumLinha, var_script_case_init, do_ajax_form_del_producto_nota_debito_validate_pro_precio__cb);
  } // do_ajax_form_del_producto_nota_debito_validate_pro_precio_

  function do_ajax_form_del_producto_nota_debito_validate_pro_precio__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_producto_nota_debito_validate_pro_precio__cb

  // ---------- Validate pro_iva_
  function do_ajax_form_del_producto_nota_debito_validate_pro_iva_(iNumLinha)
  {
    var nomeCampo_pro_iva_ = "pro_iva_" + iNumLinha;
    var var_pro_iva_ = scAjaxGetFieldText(nomeCampo_pro_iva_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_producto_nota_debito_validate_pro_iva_(var_pro_iva_, iNumLinha, var_script_case_init, do_ajax_form_del_producto_nota_debito_validate_pro_iva__cb);
  } // do_ajax_form_del_producto_nota_debito_validate_pro_iva_

  function do_ajax_form_del_producto_nota_debito_validate_pro_iva__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "pro_iva_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pro_iva_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "pro_iva_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pro_iva_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_producto_nota_debito_validate_pro_iva__cb

  // ---------- Validate pro_por_iva_
  function do_ajax_form_del_producto_nota_debito_validate_pro_por_iva_(iNumLinha)
  {
    var nomeCampo_pro_por_iva_ = "pro_por_iva_" + iNumLinha;
    var var_pro_por_iva_ = scAjaxGetFieldSelect(nomeCampo_pro_por_iva_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_producto_nota_debito_validate_pro_por_iva_(var_pro_por_iva_, iNumLinha, var_script_case_init, do_ajax_form_del_producto_nota_debito_validate_pro_por_iva__cb);
  } // do_ajax_form_del_producto_nota_debito_validate_pro_por_iva_

  function do_ajax_form_del_producto_nota_debito_validate_pro_por_iva__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_producto_nota_debito_validate_pro_por_iva__cb

  // ---------- Validate pro_ice_
  function do_ajax_form_del_producto_nota_debito_validate_pro_ice_(iNumLinha)
  {
    var nomeCampo_pro_ice_ = "pro_ice_" + iNumLinha;
    var var_pro_ice_ = scAjaxGetFieldText(nomeCampo_pro_ice_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_producto_nota_debito_validate_pro_ice_(var_pro_ice_, iNumLinha, var_script_case_init, do_ajax_form_del_producto_nota_debito_validate_pro_ice__cb);
  } // do_ajax_form_del_producto_nota_debito_validate_pro_ice_

  function do_ajax_form_del_producto_nota_debito_validate_pro_ice__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "pro_ice_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pro_ice_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "pro_ice_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pro_ice_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_producto_nota_debito_validate_pro_ice__cb

  // ---------- Validate pro_por_ice_
  function do_ajax_form_del_producto_nota_debito_validate_pro_por_ice_(iNumLinha)
  {
    var nomeCampo_pro_por_ice_ = "pro_por_ice_" + iNumLinha;
    var var_pro_por_ice_ = scAjaxGetFieldSelect(nomeCampo_pro_por_ice_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_producto_nota_debito_validate_pro_por_ice_(var_pro_por_ice_, iNumLinha, var_script_case_init, do_ajax_form_del_producto_nota_debito_validate_pro_por_ice__cb);
  } // do_ajax_form_del_producto_nota_debito_validate_pro_por_ice_

  function do_ajax_form_del_producto_nota_debito_validate_pro_por_ice__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_producto_nota_debito_validate_pro_por_ice__cb

  // ---------- Validate pro_estado_
  function do_ajax_form_del_producto_nota_debito_validate_pro_estado_(iNumLinha)
  {
    var nomeCampo_pro_estado_ = "pro_estado_" + iNumLinha;
    var var_pro_estado_ = scAjaxGetFieldText(nomeCampo_pro_estado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_producto_nota_debito_validate_pro_estado_(var_pro_estado_, iNumLinha, var_script_case_init, do_ajax_form_del_producto_nota_debito_validate_pro_estado__cb);
  } // do_ajax_form_del_producto_nota_debito_validate_pro_estado_

  function do_ajax_form_del_producto_nota_debito_validate_pro_estado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "pro_estado_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pro_estado_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "pro_estado_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pro_estado_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_producto_nota_debito_validate_pro_estado__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_del_producto_nota_debito_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_del_producto_nota_debito_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_producto_nota_debito_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_del_producto_nota_debito_add_new_line_cb);
  } // do_ajax_form_del_producto_nota_debito_add_new_line

  function do_ajax_form_del_producto_nota_debito_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_del_producto_nota_debito_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_del_producto_nota_debito_backup_line(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_producto_nota_debito_backup_line(var_pro_codigo_, var_pro_empresa_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_del_producto_nota_debito_backup_line_cb);
  } // do_ajax_form_del_producto_nota_debito_backup_line

  function do_ajax_form_del_producto_nota_debito_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_del_producto_nota_debito_backup_line_cb

  function do_ajax_form_del_producto_nota_debito_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_del_producto_nota_debito_cancel_insert

  function do_ajax_form_del_producto_nota_debito_cancel_update(iSeqVert)
  {
    do_ajax_form_del_producto_nota_debito_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_del_producto_nota_debito_cancel_update

  function do_ajax_form_del_producto_nota_debito_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_del_producto_nota_debito_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_del_producto_nota_debito_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_del_producto_nota_debito_table_refresh(var_pro_codigo_, var_pro_empresa_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_producto_nota_debito_table_refresh_cb);
  } //  do_ajax_form_del_producto_nota_debito_table_refresh

  function do_ajax_form_del_producto_nota_debito_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_del_producto_nota_debito_table_refresh_cb_after_alert);
  } // do_ajax_form_del_producto_nota_debito_table_refresh_cb
  function do_ajax_form_del_producto_nota_debito_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_del_producto_nota_debito_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_del_producto_nota_debito_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_del_producto_nota_debito_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_pro_iva_ = scAjaxGetFieldText("pro_iva_" + iNumLinha);
    var var_pro_por_iva_ = scAjaxGetFieldSelect("pro_por_iva_" + iNumLinha);
    var var_pro_ice_ = scAjaxGetFieldText("pro_ice_" + iNumLinha);
    var var_pro_por_ice_ = scAjaxGetFieldSelect("pro_por_ice_" + iNumLinha);
    var var_pro_estado_ = scAjaxGetFieldText("pro_estado_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_del_producto_nota_debito_submit_form(var_pro_codigo_, var_pro_empresa_, var_pro_descripcion_, var_pro_precio_, var_pro_iva_, var_pro_por_iva_, var_pro_ice_, var_pro_por_ice_, var_pro_estado_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_producto_nota_debito_submit_form_cb);
  } // do_ajax_form_del_producto_nota_debito_submit_form

  function do_ajax_form_del_producto_nota_debito_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_producto_nota_debito_submit_form_cb_after_alert);
  } // do_ajax_form_del_producto_nota_debito_submit_form_cb
  function do_ajax_form_del_producto_nota_debito_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_producto_nota_debito_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_producto_nota_debito_navigate_form()
  {
    perform_ajax_form_del_producto_nota_debito_navigate_form();
  }

  function perform_ajax_form_del_producto_nota_debito_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_del_producto_nota_debito_cancel_insert(sc_form_del_producto_nota_debito_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_producto_nota_debito_navigate_form(var_pro_codigo_, var_pro_empresa_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_producto_nota_debito_navigate_form_cb);
  } // do_ajax_form_del_producto_nota_debito_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_nota_debito']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_producto_nota_debito_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_producto_nota_debito_navigate_form_cb_after_alert);
  } // do_ajax_form_del_producto_nota_debito_navigate_form_cb
  function do_ajax_form_del_producto_nota_debito_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_del_producto_nota_debito_navigate_form_cb_after_alert

    function sc_form_del_producto_nota_debito_get_last_line_number()
    {
    ...
    } //sc_form_del_producto_nota_debito_get_last_line_number

  function sc_hide_form_del_producto_nota_debito_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pro_empresa_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pro_descripcion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pro_precio_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pro_iva_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pro_por_iva_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pro_ice_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pro_por_ice_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pro_estado_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["pro_codigo_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_codigo'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pro_empresa_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_empresa'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pro_descripcion_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_razon_modificacion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pro_precio_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_valor'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pro_iva_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_impuesto'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pro_por_iva_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tarifa_iva'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pro_ice_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_impuesto'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pro_por_ice_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tarifa_ice'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pro_estado_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["pro_codigo_"][iNumLinha] = "pro_codigo_" + iNumLinha;
    ajax_field_mult["pro_empresa_"][iNumLinha] = "pro_empresa_" + iNumLinha;
    ...
    ajax_field_mult["pro_iva_"][iNumLinha] = "pro_iva_" + iNumLinha;
    ajax_field_mult["pro_por_iva_"][iNumLinha] = "pro_por_iva_" + iNumLinha;
    ajax_field_mult["pro_ice_"][iNumLinha] = "pro_ice_" + iNumLinha;
    ajax_field_mult["pro_por_ice_"][iNumLinha] = "pro_por_ice_" + iNumLinha;
    ajax_field_mult["pro_estado_"][iNumLinha] = "pro_estado_" + iNumLinha;
    ...
    ajax_error_count["pro_empresa_" + iNumLinha] = "off";
    ajax_error_count["pro_descripcion_" + iNumLinha] = "off";
    ajax_error_count["pro_precio_" + iNumLinha] = "off";
    ajax_error_count["pro_iva_" + iNumLinha] = "off";
    ajax_error_count["pro_por_iva_" + iNumLinha] = "off";
    ajax_error_count["pro_ice_" + iNumLinha] = "off";
    ajax_error_count["pro_por_ice_" + iNumLinha] = "off";
    ajax_error_count["pro_estado_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["pro_codigo_" + iNumLinha] = "on";
    ajax_read_only["pro_empresa_" + iNumLinha] = "on";
    ajax_read_only["pro_descripcion_" + iNumLinha] = "off";
    ajax_read_only["pro_precio_" + iNumLinha] = "off";
    ajax_read_only["pro_iva_" + iNumLinha] = "off";
    ajax_read_only["pro_por_iva_" + iNumLinha] = "off";
    ajax_read_only["pro_ice_" + iNumLinha] = "off";
    ajax_read_only["pro_por_ice_" + iNumLinha] = "off";
    ajax_read_only["pro_estado_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["pro_iva_" + iNumLinha] = "on";
    ajax_read_only["pro_por_iva_" + iNumLinha] = "on";
    ajax_read_only["pro_ice_" + iNumLinha] = "on";
    ajax_read_only["pro_por_ice_" + iNumLinha] = "on";
    ajax_read_only["pro_estado_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["pro_empresa_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pro_empresa_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pro_empresa_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pro_empresa_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pro_empresa_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["pro_iva_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pro_iva_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pro_iva_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pro_iva_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pro_iva_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["pro_ice_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pro_ice_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pro_ice_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pro_ice_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pro_ice_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["pro_estado_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pro_estado_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pro_estado_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pro_estado_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pro_estado_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pro_empresa_'])) ? $this->nmgp_cmp_readonly['pro_empresa_'] : 'on';
?>
    scAjaxFieldRead("pro_empresa_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pro_descripcion_'])) ? $this->nmgp_cmp_readonly['pro_descripcion_'] : 'off';
?>
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pro_iva_'])) ? $this->nmgp_cmp_readonly['pro_iva_'] : 'off';
?>
    scAjaxFieldRead("pro_iva_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pro_ice_'])) ? $this->nmgp_cmp_readonly['pro_ice_'] : 'off';
?>
    scAjaxFieldRead("pro_ice_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pro_estado_'])) ? $this->nmgp_cmp_readonly['pro_estado_'] : 'off';
?>
    scAjaxFieldRead("pro_estado_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("pro_codigo_" + iSeq, "on");
    scAjaxFieldRead("pro_empresa_" + iSeq, "on");
    scAjaxFieldRead("pro_descripcion_" + iSeq, "on");
    scAjaxFieldRead("pro_precio_" + iSeq, "on");
    scAjaxFieldRead("pro_iva_" + iSeq, "on");
    scAjaxFieldRead("pro_por_iva_" + iSeq, "on");
    scAjaxFieldRead("pro_ice_" + iSeq, "on");
    scAjaxFieldRead("pro_por_ice_" + iSeq, "on");
    scAjaxFieldRead("pro_estado_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["pro_codigo_" + iRow] || "on" == ajax_error_count["pro_empresa_" + iRow] || "on" == ajax_error_count["pro_descripcion_" + iRow] || "on" == ajax_error_count["pro_precio_" + iRow] || "on" == ajax_error_count["pro_iva_" + iRow] || "on" == ajax_error_count["pro_por_iva_" + iRow] || "on" == ajax_error_count["pro_ice_" + iRow] || "on" == ajax_error_count["pro_por_ice_" + iRow] || "on" == ajax_error_count["pro_estado_" + iRow]))
    {
      ...
      $("#hidden_field_data_pro_empresa_" + iRow).addClass("scFormErrorLine");
      ...
      $("#hidden_field_data_pro_iva_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pro_por_iva_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pro_ice_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pro_por_ice_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pro_estado_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["pro_codigo_" + iRow] && "off" == ajax_error_count["pro_empresa_" + iRow] && "off" == ajax_error_count["pro_descripcion_" + iRow] && "off" == ajax_error_count["pro_precio_" + iRow] && "off" == ajax_error_count["pro_iva_" + iRow] && "off" == ajax_error_count["pro_por_iva_" + iRow] && "off" == ajax_error_count["pro_ice_" + iRow] && "off" == ajax_error_count["pro_por_ice_" + iRow] && "off" == ajax_error_count["pro_estado_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["pro_codigo_" + iRow] = "off";
        ajax_error_count["pro_empresa_" + iRow] = "off";
        ajax_error_count["pro_descripcion_" + iRow] = "off";
        ajax_error_count["pro_precio_" + iRow] = "off";
        ajax_error_count["pro_iva_" + iRow] = "off";
        ajax_error_count["pro_por_iva_" + iRow] = "off";
        ajax_error_count["pro_ice_" + iRow] = "off";
        ajax_error_count["pro_por_ice_" + iRow] = "off";
        ajax_error_count["pro_estado_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_pro_empresa_" + iRow).removeClass("scFormErrorLine");
      ...
      $("#hidden_field_data_pro_iva_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_pro_por_iva_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_pro_ice_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_pro_por_ice_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_pro_estado_" + iRow).removeClass("scFormErrorLine");
    }
  }
