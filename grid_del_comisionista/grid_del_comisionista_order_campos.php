...
<?php
   ...
   $Ord_Cmp = new grid_del_comisionista_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_del_comisionista_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_del_comisionista']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_del_comisionista']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["com_ruc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_del_comisionista']['labels']["com_ruc"])) ? $_SESSION['sc_session'][$sc_init]['grid_del_comisionista']['labels']["com_ruc"] : "" . $this->Nm_lang['lang_ruc'] . "";
   $tab_ger_campos['com_razon_social'] = "on";
   $tab_def_campos['com_razon_social'] = "com_razon_social";
   $tab_labels["com_razon_social"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_del_comisionista']['labels']["com_razon_social"])) ? $_SESSION['sc_session'][$sc_init]['grid_del_comisionista']['labels']["com_razon_social"] : "" . $this->Nm_lang['lang_razon_social'] . "";
   $tab_ger_campos['com_direccion'] = "on";
   $tab_def_campos['com_direccion'] = "com_direccion";
   $tab_labels["com_direccion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_del_comisionista']['labels']["com_direccion"])) ? $_SESSION['sc_session'][$sc_init]['grid_del_comisionista']['labels']["com_direccion"] : "" . $this->Nm_lang['lang_direccion'] . "";
   $tab_ger_campos['com_telefono'] = "on";
   $tab_def_campos['com_telefono'] = "com_telefono";
   $tab_labels["com_telefono"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_del_comisionista']['labels']["com_telefono"])) ? $_SESSION['sc_session'][$sc_init]['grid_del_comisionista']['labels']["com_telefono"] : "" . $this->Nm_lang['lang_lot_telefono'] . "";
   $tab_ger_campos['com_email'] = "on";
   $tab_def_campos['com_email'] = "com_email";
   $tab_labels["com_email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_del_comisionista']['labels']["com_email"])) ? $_SESSION['sc_session'][$sc_init]['grid_del_comisionista']['labels']["com_email"] : "" . $this->Nm_lang['lang_email'] . "";
   $tab_ger_campos['com_porcentaje_comision'] = "on";
   $tab_def_campos['com_porcentaje_comision'] = "com_porcentaje_comision";
   $tab_labels["com_porcentaje_comision"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_del_comisionista']['labels']["com_porcentaje_comision"])) ? $_SESSION['sc_session'][$sc_init]['grid_del_comisionista']['labels']["com_porcentaje_comision"] : "" . $this->Nm_lang['lang_porcentaje_comision'] . "";
   $tab_ger_campos['com_estado'] = "on";
   $tab_def_campos['com_estado'] = "com_estado";
   $tab_labels["com_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_del_comisionista']['labels']["com_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_del_comisionista']['labels']["com_estado"] : "" . $this->Nm_lang['lang_estado'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_del_comisionista']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_del_comisionista']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_del_comisionista']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_del_comisionista']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_del_comisionista']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_del_comisionista']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_del_comisionista']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_del_comisionista']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_del_comisionista']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_del_comisionista']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_del_comisionista']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_del_comisionista']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_del_comisionista_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_del_comisionista']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_del_comisionista']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_del_comisionista']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_del_comisionista']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_del_comisionista']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
