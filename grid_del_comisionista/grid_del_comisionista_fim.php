...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_del_comisionista"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_del_comisionista"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_del_autorizar_comisionista'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_del_comisionista']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_del_comisionista']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_del_comisionista']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_del_comisionista']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_del_comisionista']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_del_comisionista</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_del_comisionista']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_del_comisionista']['embutida_filho'] as $ind => $sc_init)
          {
