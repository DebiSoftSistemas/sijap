  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_parametro" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sis_parametro_form();
	}
...
?>
  ...
  // ---------- Validate par_id_
  function do_ajax_form_sis_parametro_validate_par_id_(iNumLinha)
  {
    var nomeCampo_par_id_ = "par_id_" + iNumLinha;
    var var_par_id_ = scAjaxGetFieldText(nomeCampo_par_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_parametro_validate_par_id_(var_par_id_, iNumLinha, var_script_case_init, do_ajax_form_sis_parametro_validate_par_id__cb);
  } // do_ajax_form_sis_parametro_validate_par_id_

  function do_ajax_form_sis_parametro_validate_par_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_parametro_validate_par_id__cb

  // ---------- Validate par_nombre_
  function do_ajax_form_sis_parametro_validate_par_nombre_(iNumLinha)
  {
    var nomeCampo_par_nombre_ = "par_nombre_" + iNumLinha;
    var var_par_nombre_ = scAjaxGetFieldText(nomeCampo_par_nombre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_parametro_validate_par_nombre_(var_par_nombre_, iNumLinha, var_script_case_init, do_ajax_form_sis_parametro_validate_par_nombre__cb);
  } // do_ajax_form_sis_parametro_validate_par_nombre_

  function do_ajax_form_sis_parametro_validate_par_nombre__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "par_nombre_" + iLineNumber;
    }
    else
    {
      sFieldValid = "par_nombre_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "par_nombre_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "par_nombre_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_parametro_validate_par_nombre__cb

  // ---------- Validate par_valor_
  function do_ajax_form_sis_parametro_validate_par_valor_(iNumLinha)
  {
    var nomeCampo_par_valor_ = "par_valor_" + iNumLinha;
    var var_par_valor_ = scAjaxGetFieldText(nomeCampo_par_valor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_parametro_validate_par_valor_(var_par_valor_, iNumLinha, var_script_case_init, do_ajax_form_sis_parametro_validate_par_valor__cb);
  } // do_ajax_form_sis_parametro_validate_par_valor_

  function do_ajax_form_sis_parametro_validate_par_valor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_parametro_validate_par_valor__cb

  // ---------- Validate par_tipo_
  function do_ajax_form_sis_parametro_validate_par_tipo_(iNumLinha)
  {
    var nomeCampo_par_tipo_ = "par_tipo_" + iNumLinha;
    var var_par_tipo_ = scAjaxGetFieldSelect(nomeCampo_par_tipo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_parametro_validate_par_tipo_(var_par_tipo_, iNumLinha, var_script_case_init, do_ajax_form_sis_parametro_validate_par_tipo__cb);
  } // do_ajax_form_sis_parametro_validate_par_tipo_

  function do_ajax_form_sis_parametro_validate_par_tipo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_parametro_validate_par_tipo__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_sis_parametro_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_sis_parametro_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sis_parametro_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_sis_parametro_add_new_line_cb);
  } // do_ajax_form_sis_parametro_add_new_line

  function do_ajax_form_sis_parametro_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_sis_parametro_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_sis_parametro_backup_line(iNumLinha)
  {
    var var_par_id_ = scAjaxGetFieldText("par_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_parametro_backup_line(var_par_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_sis_parametro_backup_line_cb);
  } // do_ajax_form_sis_parametro_backup_line

  function do_ajax_form_sis_parametro_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_sis_parametro_backup_line_cb

  function do_ajax_form_sis_parametro_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_sis_parametro_cancel_insert

  function do_ajax_form_sis_parametro_cancel_update(iSeqVert)
  {
    do_ajax_form_sis_parametro_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_sis_parametro_cancel_update

  function do_ajax_form_sis_parametro_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_sis_parametro_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_sis_parametro_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_sis_parametro_table_refresh(var_par_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_parametro_table_refresh_cb);
  } //  do_ajax_form_sis_parametro_table_refresh

  function do_ajax_form_sis_parametro_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_sis_parametro_table_refresh_cb_after_alert);
  } // do_ajax_form_sis_parametro_table_refresh_cb
  function do_ajax_form_sis_parametro_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_sis_parametro_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_sis_parametro_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_sis_parametro_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_par_id_ = scAjaxGetFieldText("par_id_" + iNumLinha);
    var var_par_nombre_ = scAjaxGetFieldText("par_nombre_" + iNumLinha);
...
?>
    x_ajax_form_sis_parametro_submit_form(var_par_id_, var_par_nombre_, var_par_valor_, var_par_tipo_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_parametro_submit_form_cb);
  } // do_ajax_form_sis_parametro_submit_form

  function do_ajax_form_sis_parametro_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("par_nombre_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sis_parametro_submit_form_cb_after_alert);
  } // do_ajax_form_sis_parametro_submit_form_cb
  function do_ajax_form_sis_parametro_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_parametro_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sis_parametro_navigate_form()
  {
    perform_ajax_form_sis_parametro_navigate_form();
  }

  function perform_ajax_form_sis_parametro_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_sis_parametro_cancel_insert(sc_form_sis_parametro_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("par_nombre_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sis_parametro_navigate_form(var_par_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_parametro_navigate_form_cb);
  } // do_ajax_form_sis_parametro_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_parametro']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_parametro_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_parametro_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_parametro_navigate_form_cb
  function do_ajax_form_sis_parametro_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_sis_parametro_navigate_form_cb_after_alert

    function sc_form_sis_parametro_get_last_line_number()
    {
    ...
    } //sc_form_sis_parametro_get_last_line_number

  function sc_hide_form_sis_parametro_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "par_nombre_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["par_nombre_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_descripcion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["par_nombre_"][iNumLinha] = "par_nombre_" + iNumLinha;
    ajax_field_mult["par_valor_"][iNumLinha] = "par_valor_" + iNumLinha;
    ajax_field_mult["par_tipo_"][iNumLinha] = "par_tipo_" + iNumLinha;
    ajax_field_id["par_id_" + iNumLinha] = new Array("hidden_field_label_par_id_", "hidden_field_data_par_id_" + iNumLinha);
    ajax_field_id["par_nombre_" + iNumLinha] = new Array("hidden_field_label_par_nombre_", "hidden_field_data_par_nombre_" + iNumLinha);
    ...
    ajax_error_count["par_nombre_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["par_nombre_" + iNumLinha] = "off";
...
?>
    ajax_read_only["par_id_" + iNumLinha] = "on";
    ajax_read_only["par_nombre_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["par_nombre_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["par_nombre_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["par_nombre_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["par_nombre_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["par_nombre_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["par_nombre_" + iNumLinha]["onfocus"] = new Array();
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['par_nombre_'])) ? $this->nmgp_cmp_readonly['par_nombre_'] : 'off';
?>
    scAjaxFieldRead("par_nombre_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("par_nombre_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["par_id_" + iRow] || "on" == ajax_error_count["par_nombre_" + iRow] || "on" == ajax_error_count["par_valor_" + iRow] || "on" == ajax_error_count["par_tipo_" + iRow]))
    {
      ...
      $("#hidden_field_data_par_nombre_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["par_id_" + iRow] && "off" == ajax_error_count["par_nombre_" + iRow] && "off" == ajax_error_count["par_valor_" + iRow] && "off" == ajax_error_count["par_tipo_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["par_id_" + iRow] = "off";
        ajax_error_count["par_nombre_" + iRow] = "off";
      ...
      $("#hidden_field_data_par_nombre_" + iRow).removeClass("scFormErrorLine");
