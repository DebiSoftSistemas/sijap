<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_v_jap_instalacion_contratos_ind']['glo_nm_path_imag_temp'] . "/sc_apl_default_SIJAP.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_v_jap_instalacion_contratos_ind_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_v_jap_instalacion_contratos_ind_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['labels']["fecha"] : "" . $this->Nm_lang['lang_fecha'] . "";
   $tab_ger_campos['con_numero_contrato'] = "on";
   $tab_def_campos['con_numero_contrato'] = "con_numero_contrato";
   $tab_labels["con_numero_contrato"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['labels']["con_numero_contrato"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['labels']["con_numero_contrato"] : "" . $this->Nm_lang['lang_numero_contrato'] . "";
   $tab_ger_campos['cl_identificacion'] = "on";
   $tab_def_campos['cl_identificacion'] = "cl_identificacion";
   $tab_labels["cl_identificacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['labels']["cl_identificacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['labels']["cl_identificacion"] : "" . $this->Nm_lang['lang_lot_identificacion'] . "";
   $tab_ger_campos['cl_nombre'] = "on";
   $tab_def_campos['cl_nombre'] = "cl_nombre";
   $tab_labels["cl_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['labels']["cl_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['labels']["cl_nombre"] : "" . $this->Nm_lang['lang_nombre'] . "";
   $tab_ger_campos['con_ruta'] = "on";
   $tab_def_campos['con_ruta'] = "con_ruta";
   $tab_labels["con_ruta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['labels']["con_ruta"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['labels']["con_ruta"] : "" . $this->Nm_lang['lang_ruta'] . "";
   $tab_ger_campos['con_tipo_servicio'] = "on";
   $tab_def_campos['con_tipo_servicio'] = "con_tipo_servicio";
   $tab_labels["con_tipo_servicio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['labels']["con_tipo_servicio"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['labels']["con_tipo_servicio"] : "" . $this->Nm_lang['lang_tipo_servicio'] . "";
   $tab_ger_campos['con_condicion_contrato'] = "on";
   $tab_def_campos['con_condicion_contrato'] = "con_condicion_contrato";
   $tab_labels["con_condicion_contrato"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['labels']["con_condicion_contrato"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['labels']["con_condicion_contrato"] : "" . $this->Nm_lang['lang_condicion_contrato'] . "";
   $tab_ger_campos['con_numero_medidor'] = "on";
   $tab_def_campos['con_numero_medidor'] = "con_numero_medidor";
   $tab_labels["con_numero_medidor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['labels']["con_numero_medidor"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['labels']["con_numero_medidor"] : "" . $this->Nm_lang['lang_numero_medidor'] . "";
   $tab_ger_campos['valor'] = "on";
   $tab_def_campos['valor'] = "valor";
   $tab_labels["valor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['labels']["valor"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['labels']["valor"] : "" . $this->Nm_lang['lang_valor'] . "";
   $tab_ger_campos['detalles'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['detalles'] = "detalles";
   }
   else
   {
       $tab_def_campos['detalles'] = "";
   }
   $tab_labels["detalles"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['labels']["detalles"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['labels']["detalles"] : "" . $this->Nm_lang['lang_materiales'] . "";
   $tab_ger_campos['detalles'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_v_jap_instalacion_contratos_ind_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_v_jap_instalacion_contratos_ind']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
