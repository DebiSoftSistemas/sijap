...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_dec_id_cond" name="dec_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_dec_id'), this, 'dec_id')">
      ...
      <br><span id="id_hide_dec_id"  <?php echo $str_hide_dec_id?>><?php
      if ($dec_id != "")
      {
      $dec_id_look = (is_string($dec_id) ? substr($this->Db->qstr($dec_id), 1, -1) : $dec_id); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_dec_nombre_cond" name="dec_nombre_cond" onChange="nm_campos_between(document.getElementById('id_vis_dec_nombre'), this, 'dec_nombre')">
      ...
      <br><span id="id_hide_dec_nombre"  <?php echo $str_hide_dec_nombre?>><?php
      if ($dec_nombre != "")
      {
      $dec_nombre_look = (is_string($dec_nombre) ? substr($this->Db->qstr($dec_nombre), 1, -1) : $dec_nombre); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_dec_estado_cond" name="dec_estado_cond" onChange="nm_campos_between(document.getElementById('id_vis_dec_estado'), this, 'dec_estado')">
      ...
      <br><span id="id_hide_dec_estado"  <?php echo $str_hide_dec_estado?>><?php
      if ($dec_estado != "")
      {
      $dec_estado_look = (is_string($dec_estado) ? substr($this->Db->qstr($dec_estado), 1, -1) : $dec_estado); 
      $nmgp_def_dados = array(); 
