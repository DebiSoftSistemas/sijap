...
class grid_v_jap_funciones_disponibles_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_v_jap_funciones_disponibles_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_v_jap_funciones_disponibles_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_v_jap_funciones_disponibles_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_dec_id')
      {
          $dec_id = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_dec_id($dec_id);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_dec_nombre')
      {
          $dec_nombre = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_dec_nombre($dec_nombre);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_dec_estado')
      {
          $dec_estado = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_dec_estado($dec_estado);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      else
      {
         ...
         $nome_sum = "v_jar_funciones_disponibles.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_funciones_disponibles'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_v_jap_funciones_disponibles/grid_v_jap_funciones_disponibles_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_v_jap_funciones_disponibles_ajax_search.js"></script>
 <script type="text/javascript" src="grid_v_jap_funciones_disponibles_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_v_jap_funciones_disponibles_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_v_jap_funciones_disponibles']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_v_jap_funciones_disponibles']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_dec_id_cond#NMF#' + search_get_sel_txt('SC_dec_id_cond') + '@NMF@';
  str_out += 'SC_dec_id#NMF#' + search_get_text('SC_dec_id') + '@NMF@';
  str_out += 'id_ac_dec_id#NMF#' + search_get_title('select2-id_ac_dec_id-container') + '@NMF@';
  str_out += 'SC_dec_nombre_cond#NMF#' + search_get_sel_txt('SC_dec_nombre_cond') + '@NMF@';
  str_out += 'SC_dec_nombre#NMF#' + search_get_text('SC_dec_nombre') + '@NMF@';
  str_out += 'id_ac_dec_nombre#NMF#' + search_get_title('select2-id_ac_dec_nombre-container') + '@NMF@';
  str_out += 'SC_dec_estado_cond#NMF#' + search_get_sel_txt('SC_dec_estado_cond') + '@NMF@';
  str_out += 'SC_dec_estado#NMF#' + search_get_text('SC_dec_estado') + '@NMF@';
  str_out += 'id_ac_dec_estado#NMF#' + search_get_title('select2-id_ac_dec_estado-container') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-dec_id").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_dec_id",
      max_itens: "10",
   ...
   $("#SC_dec_id").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-dec_nombre").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_dec_nombre",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_dec_nombre").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-dec_estado").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_dec_estado",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_dec_estado").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $dec_id_cond, $dec_id, $dec_id_autocomp,
             $dec_nombre_cond, $dec_nombre, $dec_nombre_autocomp,
             $dec_estado_cond, $dec_estado, $dec_estado_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $dec_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['campos_busca']['dec_id']; 
          $dec_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['campos_busca']['dec_id_cond']; 
          $dec_nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['campos_busca']['dec_nombre']; 
          $dec_nombre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['campos_busca']['dec_nombre_cond']; 
          $dec_estado = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['campos_busca']['dec_estado']; 
          $dec_estado_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['campos_busca']['dec_estado_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['campos_busca']['NM_operador']; 
      } 
      if (!isset($dec_id_cond) || empty($dec_id_cond))
      {
         $dec_id_cond = "qp";
      }
      if (!isset($dec_nombre_cond) || empty($dec_nombre_cond))
      {
         $dec_nombre_cond = "qp";
      }
      if (!isset($dec_estado_cond) || empty($dec_estado_cond))
      {
         $dec_estado_cond = "qp";
      }
      ...
      $str_hide_dec_id = (in_array($dec_id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_dec_nombre = (in_array($dec_nombre_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_dec_estado = (in_array($dec_estado_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($dec_id) || $dec_id == "")
      {
          $dec_id = "";
      }
      if (isset($dec_id) && !empty($dec_id))
      {
         $tmp_pos = (is_string($dec_id)) ? strpos($dec_id, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $dec_id = substr($dec_id, 0, $tmp_pos);
         }
      }
      if (!isset($dec_nombre) || $dec_nombre == "")
      {
          $dec_nombre = "";
      }
      if (isset($dec_nombre) && !empty($dec_nombre))
      {
         $tmp_pos = (is_string($dec_nombre)) ? strpos($dec_nombre, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $dec_nombre = substr($dec_nombre, 0, $tmp_pos);
         }
      }
      if (!isset($dec_estado) || $dec_estado == "")
      {
          $dec_estado = "";
      }
      if (isset($dec_estado) && !empty($dec_estado))
      {
         $tmp_pos = (is_string($dec_estado)) ? strpos($dec_estado, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $dec_estado = substr($dec_estado, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_dec_id_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['dec_id'])) ? $this->New_label['dec_id'] : "" . $this->Ini->Nm_lang['lang_formula'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_dec_id_cond" name="dec_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_dec_id'), this, 'dec_id')">
       <OPTION value="qp" <?php if ("qp" == $dec_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $dec_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $dec_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $dec_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_dec_id" <?php echo $str_hide_dec_id?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['dec_id'])) ? $this->New_label['dec_id'] : "" . $this->Ini->Nm_lang['lang_formula'] . "";
 $nmgp_tab_label .= "dec_id?#?" . $SC_Label . "?@?";
...
<?php
      ...
      {
          $sAutocompValue = $dec_id;
      }
?>
<INPUT  type="text" id="SC_dec_id" name="dec_id" value="<?php echo NM_encode_input($dec_id) ?>"  size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-dec_id" id="id_ac_dec_id" name="dec_id_autocomp"><?php if ('' !=  $dec_id) { ?><option value="<?php echo $dec_id ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_dec_nombre_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['dec_nombre'])) ? $this->New_label['dec_nombre'] : "" . $this->Ini->Nm_lang['lang_descripcion'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_dec_nombre_cond" name="dec_nombre_cond" onChange="nm_campos_between(document.getElementById('id_vis_dec_nombre'), this, 'dec_nombre')">
       <OPTION value="qp" <?php if ("qp" == $dec_nombre_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $dec_nombre_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $dec_nombre_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $dec_nombre_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_dec_nombre" <?php echo $str_hide_dec_nombre?> valign="top">
 ...
 $nmgp_tab_label .= "dec_nombre?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $dec_nombre;
      }
?>
<INPUT  type="text" id="SC_dec_nombre" name="dec_nombre" value="<?php echo NM_encode_input($dec_nombre) ?>"  size=50 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-dec_nombre" id="id_ac_dec_nombre" name="dec_nombre_autocomp"><?php if ('' !=  $dec_nombre) { ?><option value="<?php echo $dec_nombre ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_dec_estado_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['dec_estado'])) ? $this->New_label['dec_estado'] : "" . $this->Ini->Nm_lang['lang_estado'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_dec_estado_cond" name="dec_estado_cond" onChange="nm_campos_between(document.getElementById('id_vis_dec_estado'), this, 'dec_estado')">
       <OPTION value="qp" <?php if ("qp" == $dec_estado_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $dec_estado_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $dec_estado_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $dec_estado_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_dec_estado" <?php echo $str_hide_dec_estado?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['dec_estado'])) ? $this->New_label['dec_estado'] : "" . $this->Ini->Nm_lang['lang_estado'] . "";
 $nmgp_tab_label .= "dec_estado?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $dec_estado;
      }
?>
<INPUT  type="text" id="SC_dec_estado" name="dec_estado" value="<?php echo NM_encode_input($dec_estado) ?>"  size=2 alt="{datatype: 'text', maxLength: 2, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-dec_estado" id="id_ac_dec_estado" name="dec_estado_autocomp"><?php if ('' !=  $dec_estado) { ?><option value="<?php echo $dec_estado ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_v_jap_funciones_disponibles_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_v_jap_funciones_disponibles']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_v_jap_funciones_disponibles']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.dec_id_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_dec_id'), document.F1.dec_id_cond, 'dec_id');
   document.F1.dec_id.value = "";
   document.F1.dec_id_autocomp.value = "";
   $('#select2-id_ac_dec_id-container').html('<?php echo $this->Val_init_dec_id['desc'] ?>');;
   document.F1.dec_nombre_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_dec_nombre'), document.F1.dec_nombre_cond, 'dec_nombre');
   document.F1.dec_nombre.value = "";
   document.F1.dec_nombre_autocomp.value = "";
   $('#select2-id_ac_dec_nombre-container').html('<?php echo $this->Val_init_dec_nombre['desc'] ?>');;
   document.F1.dec_estado_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_dec_estado'), document.F1.dec_estado_cond, 'dec_estado');
   document.F1.dec_estado.value = "";
   document.F1.dec_estado_autocomp.value = "";
   $('#select2-id_ac_dec_estado-container').html('<?php echo $this->Val_init_dec_estado['desc'] ?>');;
   Sc_carga_select2('all');
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_v_jap_funciones_disponibles/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_dec_id_cond'] = 'cond';
      $tp_fields['SC_dec_id'] = 'text_aut';
      $tp_fields['id_ac_dec_id'] = 'select2_aut';
      $tp_fields['SC_dec_nombre_cond'] = 'cond';
      $tp_fields['SC_dec_nombre'] = 'text_aut';
      $tp_fields['id_ac_dec_nombre'] = 'select2_aut';
      $tp_fields['SC_dec_estado_cond'] = 'cond';
      $tp_fields['SC_dec_estado'] = 'text_aut';
      $tp_fields['id_ac_dec_estado'] = 'select2_aut';
   ...
   {
      global $dec_id_cond, $dec_id, $dec_id_autocomp,
             $dec_nombre_cond, $dec_nombre, $dec_nombre_autocomp,
             $dec_estado_cond, $dec_estado, $dec_estado_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($dec_id_autocomp) && empty($dec_id))
      {
          $dec_id = $dec_id_autocomp;
      }
      if (!empty($dec_nombre_autocomp) && empty($dec_nombre))
      {
          $dec_nombre = $dec_nombre_autocomp;
      }
      if (!empty($dec_estado_autocomp) && empty($dec_estado))
      {
          $dec_estado = $dec_estado_autocomp;
      }
      $dec_id_cond_salva = $dec_id_cond; 
      if (!isset($dec_id_input_2) || $dec_id_input_2 == "")
      {
          $dec_id_input_2 = $dec_id;
      }
      $dec_nombre_cond_salva = $dec_nombre_cond; 
      if (!isset($dec_nombre_input_2) || $dec_nombre_input_2 == "")
      {
          $dec_nombre_input_2 = $dec_nombre;
      }
      $dec_estado_cond_salva = $dec_estado_cond; 
      if (!isset($dec_estado_input_2) || $dec_estado_input_2 == "")
      {
          $dec_estado_input_2 = $dec_estado;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['campos_busca']['dec_id'] = $dec_id; 
      if (is_array($dec_id) && !empty($dec_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['Grid_search'][$I_Grid]['val'][0] = $dec_id;
      }
      elseif ($dec_id_cond_salva == "nu" || $dec_id_cond_salva == "nn" || $dec_id_cond_salva == "ep" || $dec_id_cond_salva == "ne" || !empty($dec_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['Grid_search'][$I_Grid]['val'][0][0] = $dec_id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['campos_busca']['dec_id_cond'] = $dec_id_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['Grid_search'][$I_Grid]['cmp'] = "dec_id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['Grid_search'][$I_Grid]['opc'] = $dec_id_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq']['dec_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['campos_busca']['dec_nombre'] = $dec_nombre; 
      if (is_array($dec_nombre) && !empty($dec_nombre))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['Grid_search'][$I_Grid]['val'][0] = $dec_nombre;
      }
      elseif ($dec_nombre_cond_salva == "nu" || $dec_nombre_cond_salva == "nn" || $dec_nombre_cond_salva == "ep" || $dec_nombre_cond_salva == "ne" || !empty($dec_nombre))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['Grid_search'][$I_Grid]['val'][0][0] = $dec_nombre;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['campos_busca']['dec_nombre_cond'] = $dec_nombre_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['Grid_search'][$I_Grid]['cmp'] = "dec_nombre"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['Grid_search'][$I_Grid]['opc'] = $dec_nombre_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq']['dec_nombre'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['campos_busca']['dec_estado'] = $dec_estado; 
      if (is_array($dec_estado) && !empty($dec_estado))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['Grid_search'][$I_Grid]['val'][0] = $dec_estado;
      }
      elseif ($dec_estado_cond_salva == "nu" || $dec_estado_cond_salva == "nn" || $dec_estado_cond_salva == "ep" || $dec_estado_cond_salva == "ne" || !empty($dec_estado))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['Grid_search'][$I_Grid]['val'][0][0] = $dec_estado;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['campos_busca']['dec_estado_cond'] = $dec_estado_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['Grid_search'][$I_Grid]['cmp'] = "dec_estado"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['Grid_search'][$I_Grid]['opc'] = $dec_estado_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['grid_pesq']['dec_estado'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($dec_id != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['dec_id'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['dec_id'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['dec_id'] = $dec_id;
      }
      $nmgp_def_dados = array();
    if ($dec_nombre != '') {
      $dec_nombre_look = (is_string($dec_nombre) ? substr($this->Db->qstr($dec_nombre), 1, -1) : $dec_nombre); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['dec_nombre'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['dec_nombre'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['dec_nombre'] = $dec_nombre;
      }
      $nmgp_def_dados = array();
    if ($dec_estado != '') {
      $dec_estado_look = (is_string($dec_estado) ? substr($this->Db->qstr($dec_estado), 1, -1) : $dec_estado); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['dec_estado'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['dec_estado'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['dec_estado'] = $dec_estado;
      }

      //----- $dec_id
      $this->Date_part = false;
      if (isset($dec_id) || $dec_id_cond == "nu" || $dec_id_cond == "nn" || $dec_id_cond == "ep" || $dec_id_cond == "ne")
      {
         $this->monta_condicao("dec_id", $dec_id_cond, $dec_id, "", "dec_id", "VARCHAR", false);
      }

      //----- $dec_nombre
      $this->Date_part = false;
      if (isset($dec_nombre) || $dec_nombre_cond == "nu" || $dec_nombre_cond == "nn" || $dec_nombre_cond == "ep" || $dec_nombre_cond == "ne")
      {
         $this->monta_condicao("dec_nombre", $dec_nombre_cond, $dec_nombre, "", "dec_nombre", "VARCHAR", false);
      }

      //----- $dec_estado
      $this->Date_part = false;
      if (isset($dec_estado) || $dec_estado_cond == "nu" || $dec_estado_cond == "nn" || $dec_estado_cond == "ep" || $dec_estado_cond == "ne")
      {
         $this->monta_condicao("dec_estado", $dec_estado_cond, $dec_estado, "", "dec_estado", "VARCHAR", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
    $this->Sel_case_sensitive($this->comando);
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_funciones_disponibles']['cond_pesq'] .= $this->NM_operador;
