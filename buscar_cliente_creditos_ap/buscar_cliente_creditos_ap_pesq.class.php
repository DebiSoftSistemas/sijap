...
class buscar_cliente_creditos_ap_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . buscar_cliente_creditos_ap_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . buscar_cliente_creditos_ap_pack_protect_string($Tipo_filter[0]) . "\">.." . buscar_cliente_creditos_ap_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         $nm_ini_lower = "";
         $nm_fim_lower = "";
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_ventas_credito'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>buscar_cliente_creditos_ap/buscar_cliente_creditos_ap_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="buscar_cliente_creditos_ap_ajax_search.js"></script>
 <script type="text/javascript" src="buscar_cliente_creditos_ap_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="buscar_cliente_creditos_ap_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['buscar_cliente_creditos_ap']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['buscar_cliente_creditos_ap']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
if ((isset($this->nm_mens_alert) && count($this->nm_mens_alert)) || (isset($this->Ini->nm_mens_alert) && count($this->Ini->nm_mens_alert))) {
   ...
   if (isset($this->nm_mens_alert) && !empty($this->nm_mens_alert))
   {
       foreach ($this->nm_mens_alert as $i_alert => $mensagem)
       {
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['ajax_nav'])
           { 
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['dashboard_info']['compact_mode'])
      {
          return;
      }
      ...
      <TABLE style="padding: 0px; border-spacing: 0px; border-width: 0px;" width="100%">
       <TR valign="middle">
        ...
        <TD align="left" class="scFilterHeaderFont">
          <?php echo $this->Ini->Nm_lang['lang_ventas_credito'] ?>
        </TD>
...
<?php
   ...
   function monta_form()
   {
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['buscar_cliente_creditos_ap']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['buscar_cliente_creditos_ap']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['buscar_cliente_creditos_ap']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("buscar_cliente_creditos_ap", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $cl_nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['campos_busca']['cl_nombre']; 
          $cl_nombre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['campos_busca']['cl_nombre_cond']; 
          $cl_identificacion = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['campos_busca']['cl_identificacion']; 
          $cl_identificacion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['campos_busca']['cl_identificacion_cond']; 
          $con_numero_contrato = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['campos_busca']['con_numero_contrato']; 
          $con_numero_contrato_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['campos_busca']['con_numero_contrato_cond']; 
          $con_numero_medidor = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['campos_busca']['con_numero_medidor']; 
          $con_numero_medidor_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['campos_busca']['con_numero_medidor_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['campos_busca']['NM_operador']; 
      } 
...
?>
<?php
   if (is_file("buscar_cliente_creditos_ap_help.txt"))
   {
      $Arq_WebHelp = file("buscar_cliente_creditos_ap_help.txt"); 
...
<?php
   ...
   elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['dashboard_info']['under_dashboard'])
   { }
   else
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['orig_pesq'] == "grid")
   {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "SIJAP/buscar_cliente_creditos_ap";
   ...
   function inicializa_vars()
   {
      ...
      $this->redir_modal = "";
      $this->nm_data = new nm_data("es");
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['cond_pesq'] = "";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "buscar_cliente_creditos_ap/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function trata_campos()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['campos_busca']['cl_nombre'] = $cl_nombre; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['campos_busca']['cl_nombre_cond'] = $cl_nombre_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['campos_busca']['cl_identificacion'] = $cl_identificacion; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['campos_busca']['cl_identificacion_cond'] = $cl_identificacion_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['campos_busca']['con_numero_contrato'] = $con_numero_contrato; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['campos_busca']['con_numero_contrato_cond'] = $con_numero_contrato_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['campos_busca']['con_numero_medidor'] = $con_numero_medidor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['campos_busca']['con_numero_medidor_cond'] = $con_numero_medidor_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['campos_busca'] = $Temp_Busca;
      }
      $_SESSION['scriptcase']['buscar_cliente_creditos_ap']['contr_erro'] = 'on';
 ...
 if($cl_nombre <>'' or $cl_identificacion <>'' or $con_numero_medidor <>'' or $con_numero_contrato <>''){
	...
	if(isset($rs[0][0]) ){
		$update_sql="UPDATE  del_forma_pago_factura 
				SET 
				fp_seleccion='N',
				fp_usuario_selecciona=''
				WHERE fp_factura in (SELECT fac_numero FROM del_factura WHERE fac_cliente=".$rs[0][0].");";
...
$this->nmgp_redireciona_form($redir_app, $this->nm_location, $redir_param,"$redir_target", 440, 630, "ret_self");
			...
			$redir_app    = 'grid_selecciona_contrato_credito';
			$redir_target = '_self';
			$redir_param  = array(  
...
$_SESSION['scriptcase']['buscar_cliente_creditos_ap']['contr_erro'] = 'off'; 
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['cond_dyn_search'] = "";
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['where_filtro'] = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['where_filter'] = $this->comando_filtro;
      $this->retorna_pesq();
   }
   function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $alt_modal=0, $larg_modal=0, $opc="")
   {
      if (is_array($nm_apl_parms))
      {
          ...
          foreach ($nm_apl_parms as $par => $val)
          {
              ...
              elseif (substr($val, 0, 1) == "[")
              {
                  $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap'][substr($val, 1, -1)];
              }
              else
              {
                  $tmp_parms .= $val;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['iframe_print']) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_cliente_creditos_ap']['iframe_print'] )
      {
          $target = "_parent";
      }
   ?>
