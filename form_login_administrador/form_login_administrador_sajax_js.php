  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_login_administrador" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_login_administrador_form();
	}
...
?>
  ...
  // ---------- Validate imagen
  function do_ajax_form_login_administrador_validate_imagen()
  {
  } // do_ajax_form_login_administrador_validate_imagen

  function do_ajax_form_login_administrador_validate_imagen_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_login_administrador_validate_imagen_cb

  // ---------- Validate filial
  function do_ajax_form_login_administrador_validate_filial()
  {
    var nomeCampo_filial = "filial";
    var var_filial = scAjaxGetFieldSelect(nomeCampo_filial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_login_administrador_validate_filial(var_filial, var_script_case_init, do_ajax_form_login_administrador_validate_filial_cb);
  } // do_ajax_form_login_administrador_validate_filial

  function do_ajax_form_login_administrador_validate_filial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "filial";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_login_administrador_validate_filial_cb

  // ---------- Validate oficina
  function do_ajax_form_login_administrador_validate_oficina()
  {
    var nomeCampo_oficina = "oficina";
    var var_oficina = scAjaxGetFieldSelect(nomeCampo_oficina);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_login_administrador_validate_oficina(var_oficina, var_script_case_init, do_ajax_form_login_administrador_validate_oficina_cb);
  } // do_ajax_form_login_administrador_validate_oficina

  function do_ajax_form_login_administrador_validate_oficina_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "oficina";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_login_administrador_validate_oficina_cb

  // ---------- Validate login
  function do_ajax_form_login_administrador_validate_login()
  {
    var nomeCampo_login = "login";
    var var_login = scAjaxGetFieldText(nomeCampo_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_login_administrador_validate_login(var_login, var_script_case_init, do_ajax_form_login_administrador_validate_login_cb);
  } // do_ajax_form_login_administrador_validate_login

  function do_ajax_form_login_administrador_validate_login_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "login";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_login_administrador_validate_login_cb

  // ---------- Validate password
  function do_ajax_form_login_administrador_validate_password()
  {
    var nomeCampo_password = "password";
    var var_password = scAjaxGetFieldText(nomeCampo_password);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_login_administrador_validate_password(var_password, var_script_case_init, do_ajax_form_login_administrador_validate_password_cb);
  } // do_ajax_form_login_administrador_validate_password

  function do_ajax_form_login_administrador_validate_password_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_login_administrador_validate_password_cb

  // ---------- Validate idioma
  function do_ajax_form_login_administrador_validate_idioma()
  {
    var nomeCampo_idioma = "idioma";
    var var_idioma = scAjaxGetFieldText(nomeCampo_idioma);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_login_administrador_validate_idioma(var_idioma, var_script_case_init, do_ajax_form_login_administrador_validate_idioma_cb);
  } // do_ajax_form_login_administrador_validate_idioma

  function do_ajax_form_login_administrador_validate_idioma_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idioma";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_login_administrador_validate_idioma_cb

  // ---------- Refresh filial
  function do_ajax_form_login_administrador_refresh_filial()
  {
    var var_filial = scAjaxGetFieldSelect("filial");
    var var_nmgp_refresh_fields = "oficina";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_login_administrador_refresh_filial(var_filial, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_login_administrador_refresh_filial_cb);
  } // do_ajax_form_login_administrador_refresh_filial

  function do_ajax_form_login_administrador_refresh_filial_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_login_administrador_refresh_filial_cb

  // ---------- Event onchange filial
  function do_ajax_form_login_administrador_event_filial_onchange()
  {
    var var_filial = scAjaxGetFieldSelect("filial");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_login_administrador_event_filial_onchange(var_filial, var_script_case_init, do_ajax_form_login_administrador_event_filial_onchange_cb);
  } // do_ajax_form_login_administrador_event_filial_onchange

  function do_ajax_form_login_administrador_event_filial_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "filial";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_login_administrador_event_filial_onchange_cb_after_alert);
  } // do_ajax_form_login_administrador_event_filial_onchange_cb
  function do_ajax_form_login_administrador_event_filial_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_login_administrador_refresh_filial();
    scAjaxRedir();
  } // do_ajax_form_login_administrador_event_filial_onchange_cb_after_alert

  // ---------- Event onclick mostrar
  function do_ajax_form_login_administrador_event_mostrar_onclick()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_login_administrador_event_mostrar_onclick(var_script_case_init, do_ajax_form_login_administrador_event_mostrar_onclick_cb);
  } // do_ajax_form_login_administrador_event_mostrar_onclick

  function do_ajax_form_login_administrador_event_mostrar_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "mostrar";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_login_administrador_event_mostrar_onclick_cb_after_alert);
  } // do_ajax_form_login_administrador_event_mostrar_onclick_cb
  function do_ajax_form_login_administrador_event_mostrar_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_login_administrador_event_mostrar_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_login_administrador_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_login_administrador_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_login_administrador_submit_form(var_imagen, var_filial, var_oficina, var_login, var_password, var_idioma, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_login_administrador_submit_form_cb);
  } // do_ajax_form_login_administrador_submit_form

  function do_ajax_form_login_administrador_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_login_administrador_submit_form_cb_after_alert);
  } // do_ajax_form_login_administrador_submit_form_cb
  function do_ajax_form_login_administrador_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_login_administrador_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_login_administrador_navigate_form()
  {
    perform_ajax_form_login_administrador_navigate_form();
  }

  function perform_ajax_form_login_administrador_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_form_login_administrador_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_login_administrador']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_login_administrador_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_login_administrador_navigate_form_cb_after_alert);
  } // do_ajax_form_login_administrador_navigate_form_cb
  function do_ajax_form_login_administrador_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scFocusField('login');
...
{
?>
    do_ajax_form_login_administrador_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_login_administrador_navigate_form_cb_after_alert

  function sc_hide_form_login_administrador_form()
  {
