...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_login_administrador']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_login_administrador']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_login_administrador"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
?> 
function sc_btn_Resetear()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_Resetear(); }, 500);
      return;
    }
    sc_btn_Resetear_ok();
}
function sc_btn_Resetear_cancel()
{
}
function sc_btn_Resetear_ok()
{
  nm_gp_submit('<?php echo $this->Ini->link_form_resetear_contrasenia_edit; ?>', '<?php echo $this->Ini->path_link . "" . SC_dir_app_name('form_login') . "/"; ?>', '<?php echo "par_filial*scin{Filial}*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout"; ?>', '', '_self', '0', '0', 'form_resetear_contrasenia');
}
 NM_tp_critica(1);
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_login_administrador']['where_detal']))
  {
?>  
...
function nm_saida_glo()
{
  ...
  document.F4.action = "form_login_administrador_fim.php";
  document.F4.submit();
}
