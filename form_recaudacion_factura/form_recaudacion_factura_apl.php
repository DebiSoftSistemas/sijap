<?php
//
class form_recaudacion_factura_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_recaudacion_factura']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_recaudacion_factura']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_recaudacion_factura']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_recaudacion_factura']['embutida_parms'];
          unset($_SESSION['sc_session'][$script_case_init]['form_recaudacion_factura']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_form_recaudacion_factura($cadapar[1]);
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_recaudacion_factura']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_recaudacion_factura']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_recaudacion_factura']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_recaudacion_factura']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (!isset($this->Igtech_RucEmpresa) && isset($this->igtech_rucempresa)) 
          {
              $this->Igtech_RucEmpresa = $this->igtech_rucempresa;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_recaudacion_factura']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['form_recaudacion_factura']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_recaudacion_factura']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_recaudacion_factura']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_recaudacion_factura']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_recaudacion_factura']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_recaudacion_factura']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_recaudacion_factura']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_recaudacion_factura']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_recaudacion_factura']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_recaudacion_factura_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_recaudacion_factura']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_recaudacion_factura']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_recaudacion_factura'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_recaudacion_factura']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_recaudacion_factura']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_recaudacion_factura') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_recaudacion_factura']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " del_cliente";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_recaudacion_factura")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_recaudacion_factura']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_recaudacion_factura'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_factura']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_factura']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_factura']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_factura']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_factura']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_factura']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_factura']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_factura']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_factura']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_factura']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_recaudacion_factura'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_recaudacion_factura'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_factura']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_factura']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_factura']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_factura']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_factura']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_factura']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_factura']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_factura']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_factura']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_factura']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_factura']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_factura']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_factura']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_factura']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_factura']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_factura']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_factura']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_factura']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_factura']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_recaudacion_factura", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_recaudacion_factura_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_recaudacion_factura_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_recaudacion_factura/form_recaudacion_factura_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_recaudacion_factura_erro.class.php"); 
      }
      $this->Erro      = new form_recaudacion_factura_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['opcao']))
         { 
             if ($this->cl_id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_factura']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_factura']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_factura']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['opc_ant'] : "";
      } 
      ...
      {
          $this->nmgp_botoes['actualizar_cliente'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['botoes']['actualizar_cliente'];
          $this->nmgp_botoes['facturar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['botoes']['facturar'];
          $this->nmgp_botoes['seleccionar_todo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['botoes']['seleccionar_todo'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_recaudacion_factura']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_recaudacion_factura']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_select'];
     }
   }
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['Gera_log_access'] = false;
      }
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          form_recaudacion_factura_pack_ajax_response();
          exit;
      }
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6))
      {
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          ...
          $this->nm_tira_formatacao();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_select']['cl_identificacion']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->cl_identificacion = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_select']['cl_identificacion'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_select']['cl_nombre']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->cl_nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_select']['cl_nombre'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_select']['cl_direccion']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->cl_direccion = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_select']['cl_direccion'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_select']['cl_telefono']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->cl_telefono = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_select']['cl_telefono'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_select']['cl_email']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->cl_email = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_select']['cl_email'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_select']['tesoreria']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tesoreria = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_select']['tesoreria'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_select']['total']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->total = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_select']['total'];
          } 
      ...
      if ($this->nmgp_opcao == "incluir" || $this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "excluir") 
      {
          ...
          $_SESSION['scriptcase']['form_recaudacion_factura']['contr_erro'] = 'off';
          if ($Campos_Crit != "") 
          {
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_recaudacion_factura.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_recaudacion_factura_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_recaudacion_factura"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_recaudacion_factura', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sis_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'form_recaudacion_factura', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_recaudacion_factura', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
<?php
include_once("form_recaudacion_factura_sajax_js.php");
?>
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['opc_ant'] == "incluir")
      {
      ...
      {
          if (!isset($this->forma_pago) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_form']['forma_pago']))
          {
              $varloc_btn_php['forma_pago'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_form']['forma_pago'];
          }
          if (!isset($this->libretin) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_form']['libretin']))
          {
              $varloc_btn_php['libretin'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_form']['libretin'];
          }
          if (!isset($this->cl_email) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_form']['cl_email']))
          {
              $varloc_btn_php['cl_email'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_form']['cl_email'];
          }
          if (!isset($this->cl_telefono) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_form']['cl_telefono']))
          {
              $varloc_btn_php['cl_telefono'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_form']['cl_telefono'];
          }
          if (!isset($this->cl_direccion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_form']['cl_direccion']))
          {
              $varloc_btn_php['cl_direccion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_form']['cl_direccion'];
          }
          if (!isset($this->cl_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_form']['cl_id']))
          {
              $varloc_btn_php['cl_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_form']['cl_id'];
          }
          if (!isset($this->libretin) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_form']['libretin']))
          {
              $varloc_btn_php['libretin'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_form']['libretin'];
          }
          if (!isset($this->tesoreria) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_form']['tesoreria']))
          {
              $varloc_btn_php['tesoreria'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_form']['tesoreria'];
          }
          if (!isset($this->saldo_por_pagar) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_form']['saldo_por_pagar']))
          {
              $varloc_btn_php['saldo_por_pagar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_form']['saldo_por_pagar'];
          }
          if (!isset($this->forma_pago) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_form']['forma_pago']))
          {
              $varloc_btn_php['forma_pago'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_form']['forma_pago'];
          }
          if (!isset($this->valor_pago) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_form']['valor_pago']))
          {
              $varloc_btn_php['valor_pago'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_form']['valor_pago'];
          }
          if (!isset($this->documento) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_form']['documento']))
          {
              $varloc_btn_php['documento'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_form']['documento'];
          }
          if (!isset($this->cl_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_form']['cl_id']))
          {
              $varloc_btn_php['cl_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_form']['cl_id'];
          }
          if (!isset($this->rs_operacion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_form']['rs_operacion']))
          {
              $varloc_btn_php['rs_operacion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_form']['rs_operacion'];
          }
          if (!isset($this->rs_operacion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_form']['rs_operacion']))
          {
              $varloc_btn_php['rs_operacion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_form']['rs_operacion'];
      ...
      $_SESSION['scriptcase']['form_recaudacion_factura']['contr_erro'] = 'on';
...
if ($this->forma_pago ==''){
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_recaudacion_factura';
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_recaudacion_factura']) || !is_array($this->NM_ajax_info['errList']['geral_form_recaudacion_factura']))
              {
                  $this->NM_ajax_info['errList']['geral_form_recaudacion_factura'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_recaudacion_factura'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
   ...
   if (isset($this->Field_no_validate['tesoreria'])) {
       return;
               ...
               if (!empty($this->tesoreria) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['Lookup_tesoreria']) && !in_array($this->tesoreria, $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['Lookup_tesoreria']))
               {
                   $hasError = true;
   ...
   if (isset($this->Field_no_validate['forma_pago'])) {
       return;
               ...
               if (!empty($this->forma_pago) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['Lookup_forma_pago']) && !in_array($this->forma_pago, $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['Lookup_forma_pago']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['libretin'])) {
       return;
               ...
               if (!empty($this->libretin) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['Lookup_libretin']) && !in_array($this->libretin, $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['Lookup_libretin']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['cl_id']['keyVal'] = form_recaudacion_factura_pack_protect_string($this->nmgp_dados_form['cl_id']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['grid_fac_operacion_script_case_init'] ]['grid_fac_operacion']['embutida_form_full'] = false;
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['grid_fac_operacion_script_case_init'] ]['grid_fac_operacion']['embutida_form']       = true;
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['grid_fac_operacion_script_case_init'] ]['grid_fac_operacion']['embutida_pai']        = "form_recaudacion_factura";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['grid_fac_operacion_script_case_init'] ]['grid_fac_operacion']['embutida_form_parms'] = "var_propietario*scin" . $this->nmgp_dados_form['cl_id'] . "*scoutNMSC_inicial*scininicio*scoutNMSC_paginacao*scinFULL*scout";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['grid_fac_operacion_script_case_init'] ]['grid_fac_operacion']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['grid_fac_operacion_script_case_init'] ]['grid_fac_operacion']['total']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['Lookup_tesoreria']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['Lookup_tesoreria'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['Lookup_tesoreria']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['Lookup_tesoreria'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_recaudacion_factura_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_recaudacion_factura_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['Lookup_tesoreria'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tesoreria']['valList'][$i] = form_recaudacion_factura_pack_protect_string($v);
          }
...
$aLookup[] = array(form_recaudacion_factura_pack_protect_string('S') => str_replace('<', '&lt;',form_recaudacion_factura_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['Lookup_usar_compensacion'][] = 'S';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['usar_compensacion']['valList'][$i] = form_recaudacion_factura_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['Lookup_forma_pago']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['Lookup_forma_pago'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['Lookup_forma_pago']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['Lookup_forma_pago'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['Lookup_forma_pago'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['forma_pago']['valList'][$i] = form_recaudacion_factura_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['Lookup_libretin']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['Lookup_libretin'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['Lookup_libretin']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['Lookup_libretin'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['Lookup_libretin'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['libretin']['valList'][$i] = form_recaudacion_factura_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_operaciones2($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['Field_no_validate'] = array();
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->cl_id)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['opcao'] = '';
   ...
   { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['total']);
              }
              ...
              $this->NM_gera_log_new();
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['parms'] = "cl_id?#?$this->cl_id?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['select'] = ""; 
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_select'] = $this->nmgp_dados_select;
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dados_select'];
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_recaudacion_factura_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_recaudacion_factura = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['total'] = $qt_geral_reg_form_recaudacion_factura;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_recaudacion_factura_pack_ajax_response();
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_recaudacion_factura_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_recaudacion_factura_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['retorno_edit'] = "";
   }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_factura']['ordem_ord'] == " desc") {
