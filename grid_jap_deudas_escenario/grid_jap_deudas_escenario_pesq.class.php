...
class grid_jap_deudas_escenario_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_jap_deudas_escenario_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_jap_deudas_escenario_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_jap_deudas_escenario_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "jap_deudas_escenario_des_id";$Nm_numeric[] = "jap_deudas_escenario_des_escenario";$Nm_numeric[] = "jap_deudas_escenario_des_propietario";$Nm_numeric[] = "jap_deudas_escenario_des_contrato";$Nm_numeric[] = "jap_deudas_escenario_des_lectura_anterior";$Nm_numeric[] = "jap_deudas_escenario_des_lectura_actual";$Nm_numeric[] = "jap_deudas_escenario_des_consumo_base";$Nm_numeric[] = "jap_deudas_escenario_des_consumo_excedente";$Nm_numeric[] = "jap_deudas_escenario_des_valor_base";$Nm_numeric[] = "jap_deudas_escenario_des_valor_excedente";$Nm_numeric[] = "jap_deudas_escenario_des_total";$Nm_numeric[] = "jap_deudas_escenario_des_operacion";$Nm_numeric[] = "jap_deudas_escenario_des_consumo";$Nm_numeric[] = "jap_deudas_escenario_des_orden";$Nm_numeric[] = "jap_deudas_escenario_des_ruta";
      $campo_join = strtolower(str_replace(".", "_", $nome));
      if (in_array($campo_join, $Nm_numeric))
      {
          if ($condicao == "EP" || $condicao == "NE")
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$campo_join]);
              return;
          }
         $nm_ini_lower = "";
         $nm_fim_lower = "";
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> jap_deudas_escenario</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_jap_deudas_escenario/grid_jap_deudas_escenario_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_jap_deudas_escenario_ajax_search.js"></script>
 <script type="text/javascript" src="grid_jap_deudas_escenario_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_jap_deudas_escenario_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_jap_deudas_escenario']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_jap_deudas_escenario']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_jap_deudas_escenario_des_propietario_cond#NMF#' + search_get_sel_txt('SC_jap_deudas_escenario_des_propietario_cond') + '@NMF@';
  str_out += 'SC_jap_deudas_escenario_des_propietario#NMF#' + search_get_select('SC_jap_deudas_escenario_des_propietario') + '@NMF@';
  str_out += 'SC_jap_deudas_escenario_des_contrato_cond#NMF#' + search_get_sel_txt('SC_jap_deudas_escenario_des_contrato_cond') + '@NMF@';
  str_out += 'SC_jap_deudas_escenario_des_contrato#NMF#' + search_get_select('SC_jap_deudas_escenario_des_contrato') + '@NMF@';
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $jap_deudas_escenario_des_propietario_cond, $jap_deudas_escenario_des_propietario,
             $jap_deudas_escenario_des_contrato_cond, $jap_deudas_escenario_des_contrato,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $jap_deudas_escenario_des_propietario = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['campos_busca']['jap_deudas_escenario_des_propietario']; 
          $jap_deudas_escenario_des_propietario_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['campos_busca']['jap_deudas_escenario_des_propietario_cond']; 
          $jap_deudas_escenario_des_contrato = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['campos_busca']['jap_deudas_escenario_des_contrato']; 
          $jap_deudas_escenario_des_contrato_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['campos_busca']['jap_deudas_escenario_des_contrato_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['campos_busca']['NM_operador']; 
      } 
      if (!isset($jap_deudas_escenario_des_propietario_cond) || empty($jap_deudas_escenario_des_propietario_cond))
      {
         $jap_deudas_escenario_des_propietario_cond = "eq";
      }
      if (!isset($jap_deudas_escenario_des_contrato_cond) || empty($jap_deudas_escenario_des_contrato_cond))
      {
         $jap_deudas_escenario_des_contrato_cond = "eq";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_jap_deudas_escenario_des_propietario = (in_array($jap_deudas_escenario_des_propietario_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_jap_deudas_escenario_des_contrato = (in_array($jap_deudas_escenario_des_contrato_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($jap_deudas_escenario_des_propietario) || $jap_deudas_escenario_des_propietario == "")
      {
          $jap_deudas_escenario_des_propietario = "";
      }
      if (isset($jap_deudas_escenario_des_propietario) && !empty($jap_deudas_escenario_des_propietario))
      {
         $tmp_pos = (is_string($jap_deudas_escenario_des_propietario)) ? strpos($jap_deudas_escenario_des_propietario, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $jap_deudas_escenario_des_propietario = substr($jap_deudas_escenario_des_propietario, 0, $tmp_pos);
         }
      }
      if (!isset($jap_deudas_escenario_des_contrato) || $jap_deudas_escenario_des_contrato == "")
      {
          $jap_deudas_escenario_des_contrato = "";
      }
      if (isset($jap_deudas_escenario_des_contrato) && !empty($jap_deudas_escenario_des_contrato))
      {
         $tmp_pos = (is_string($jap_deudas_escenario_des_contrato)) ? strpos($jap_deudas_escenario_des_contrato, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $jap_deudas_escenario_des_contrato = substr($jap_deudas_escenario_des_contrato, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_jap_deudas_escenario_des_propietario_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['jap_deudas_escenario_des_propietario'])) ? $this->New_label['jap_deudas_escenario_des_propietario'] : "" . $this->Ini->Nm_lang['lang_propietario'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_jap_deudas_escenario_des_propietario_cond" name="jap_deudas_escenario_des_propietario_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_jap_deudas_escenario_des_propietario" <?php echo $str_hide_jap_deudas_escenario_des_propietario?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['jap_deudas_escenario_des_propietario'])) ? $this->New_label['jap_deudas_escenario_des_propietario'] : "" . $this->Ini->Nm_lang['lang_propietario'] . "";
 $nmgp_tab_label .= "jap_deudas_escenario_des_propietario?#?" . $SC_Label . "?@?";
...
?>
   <span id="idAjaxSelect_jap_deudas_escenario_des_propietario">
      <SELECT class="scFilterObjectOdd" id="SC_jap_deudas_escenario_des_propietario" name="jap_deudas_escenario_des_propietario"  size="1">
...
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $jap_deudas_escenario_des_propietario)
            {
                    $jap_deudas_escenario_des_propietario_sel = ($nm_opc_cod === $jap_deudas_escenario_des_propietario) ? "selected" : "";
            }
            else
            {
...
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $jap_deudas_escenario_des_propietario_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
?>
      ...
      <TD id='SC_jap_deudas_escenario_des_contrato_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['jap_deudas_escenario_des_contrato'])) ? $this->New_label['jap_deudas_escenario_des_contrato'] : " " . $this->Ini->Nm_lang['lang_numero_contrato'] . "-" . $this->Ini->Nm_lang['lang_numero_medidor'] . " "; ?></TD>
      
      <INPUT type="hidden" id="SC_jap_deudas_escenario_des_contrato_cond" name="jap_deudas_escenario_des_contrato_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_jap_deudas_escenario_des_contrato" <?php echo $str_hide_jap_deudas_escenario_des_contrato?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['jap_deudas_escenario_des_contrato'])) ? $this->New_label['jap_deudas_escenario_des_contrato'] : " " . $this->Ini->Nm_lang['lang_numero_contrato'] . "-" . $this->Ini->Nm_lang['lang_numero_medidor'] . " ";
 $nmgp_tab_label .= "jap_deudas_escenario_des_contrato?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
   <span id="idAjaxSelect_jap_deudas_escenario_des_contrato">
      <SELECT class="scFilterObjectEven" id="SC_jap_deudas_escenario_des_contrato" name="jap_deudas_escenario_des_contrato"  size="1">
       <OPTION value=""><?php echo $this->Ini->Nm_lang['lang_seleccione'] ?></OPTION>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            list($nm_opc_val, $nm_opc_cod, $nm_opc_sel) = $temp_bug_list;
            if ($nm_opc_cod == "@ ") {$nm_opc_cod = trim($nm_opc_cod); }
            if ("" != $jap_deudas_escenario_des_contrato)
            {
                    $jap_deudas_escenario_des_contrato_sel = ($nm_opc_cod === $jap_deudas_escenario_des_contrato) ? "selected" : "";
            }
            else
            {
            ...
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $jap_deudas_escenario_des_contrato_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_jap_deudas_escenario_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_jap_deudas_escenario']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_jap_deudas_escenario']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.jap_deudas_escenario_des_propietario_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_jap_deudas_escenario_des_propietario'), document.F1.jap_deudas_escenario_des_propietario_cond, 'jap_deudas_escenario_des_propietario');
   document.F1.jap_deudas_escenario_des_propietario.value = "";
   document.F1.jap_deudas_escenario_des_contrato_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_jap_deudas_escenario_des_contrato'), document.F1.jap_deudas_escenario_des_contrato_cond, 'jap_deudas_escenario_des_contrato');
   document.F1.jap_deudas_escenario_des_contrato.value = "";
   Sc_carga_select2('all');
 }
 function Sc_carga_select2(Field)
 {
    if (Field == 'all' || Field == 'jap_deudas_escenario_des_propietario') {
       Sc_carga_select2_jap_deudas_escenario_des_propietario();
    }
    if (Field == 'all' || Field == 'jap_deudas_escenario_des_contrato') {
       Sc_carga_select2_jap_deudas_escenario_des_contrato();
    }
 }
 function Sc_carga_select2_jap_deudas_escenario_des_propietario()
 {
  $("#SC_jap_deudas_escenario_des_propietario").select2(
    {
      language: {
        noResults: function() {
 ...
 function Sc_carga_select2_jap_deudas_escenario_des_contrato()
 {
  $("#SC_jap_deudas_escenario_des_contrato").select2(
    {
      language: {
        noResults: function() {
          return "<?php echo $this->Ini->Nm_lang['lang_autocomp_notfound'] ?>";
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_jap_deudas_escenario/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_jap_deudas_escenario_des_propietario_cond'] = 'cond';
      $tp_fields['SC_jap_deudas_escenario_des_propietario'] = 'select';
      $tp_fields['SC_jap_deudas_escenario_des_contrato_cond'] = 'cond';
      $tp_fields['SC_jap_deudas_escenario_des_contrato'] = 'select';
   ...
   {
      global $jap_deudas_escenario_des_propietario_cond, $jap_deudas_escenario_des_propietario,
             $jap_deudas_escenario_des_contrato_cond, $jap_deudas_escenario_des_contrato, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $jap_deudas_escenario_des_propietario_cond_salva = $jap_deudas_escenario_des_propietario_cond; 
      if (!isset($jap_deudas_escenario_des_propietario_input_2) || $jap_deudas_escenario_des_propietario_input_2 == "")
      {
          $jap_deudas_escenario_des_propietario_input_2 = $jap_deudas_escenario_des_propietario;
      }
      $jap_deudas_escenario_des_contrato_cond_salva = $jap_deudas_escenario_des_contrato_cond; 
      if (!isset($jap_deudas_escenario_des_contrato_input_2) || $jap_deudas_escenario_des_contrato_input_2 == "")
      {
          $jap_deudas_escenario_des_contrato_input_2 = $jap_deudas_escenario_des_contrato;
      }
      $tmp_pos = (is_string($jap_deudas_escenario_des_propietario)) ? strpos($jap_deudas_escenario_des_propietario, "##@@") : false;
      if ($tmp_pos === false) {
          $L_lookup = $jap_deudas_escenario_des_propietario;
      }
      else {
          $L_lookup = substr($jap_deudas_escenario_des_propietario, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['psq_check_ret']['jap_deudas_escenario_des_propietario'])) {
      ...
      $tmp_pos = (is_string($jap_deudas_escenario_des_contrato)) ? strpos($jap_deudas_escenario_des_contrato, "##@@") : false;
      if ($tmp_pos === false) {
          $L_lookup = $jap_deudas_escenario_des_contrato;
      }
      else {
          $L_lookup = substr($jap_deudas_escenario_des_contrato, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['psq_check_ret']['jap_deudas_escenario_des_contrato'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= " " . $this->Ini->Nm_lang['lang_numero_contrato'] . "-" . $this->Ini->Nm_lang['lang_numero_medidor'] . "  : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['campos_busca']['jap_deudas_escenario_des_propietario'] = $jap_deudas_escenario_des_propietario; 
      if (is_array($jap_deudas_escenario_des_propietario) && !empty($jap_deudas_escenario_des_propietario))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['Grid_search'][$I_Grid]['val'][0] = $jap_deudas_escenario_des_propietario;
      }
      elseif ($jap_deudas_escenario_des_propietario_cond_salva == "nu" || $jap_deudas_escenario_des_propietario_cond_salva == "nn" || $jap_deudas_escenario_des_propietario_cond_salva == "ep" || $jap_deudas_escenario_des_propietario_cond_salva == "ne" || !empty($jap_deudas_escenario_des_propietario))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['Grid_search'][$I_Grid]['val'][0][0] = $jap_deudas_escenario_des_propietario;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['campos_busca']['jap_deudas_escenario_des_propietario_cond'] = $jap_deudas_escenario_des_propietario_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['Grid_search'][$I_Grid]['cmp'] = "jap_deudas_escenario_des_propietario"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['Grid_search'][$I_Grid]['opc'] = $jap_deudas_escenario_des_propietario_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq']['jap_deudas_escenario_des_propietario'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['campos_busca']['jap_deudas_escenario_des_contrato'] = $jap_deudas_escenario_des_contrato; 
      if (is_array($jap_deudas_escenario_des_contrato) && !empty($jap_deudas_escenario_des_contrato))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['Grid_search'][$I_Grid]['val'][0] = $jap_deudas_escenario_des_contrato;
      }
      elseif ($jap_deudas_escenario_des_contrato_cond_salva == "nu" || $jap_deudas_escenario_des_contrato_cond_salva == "nn" || $jap_deudas_escenario_des_contrato_cond_salva == "ep" || $jap_deudas_escenario_des_contrato_cond_salva == "ne" || !empty($jap_deudas_escenario_des_contrato))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['Grid_search'][$I_Grid]['val'][0][0] = $jap_deudas_escenario_des_contrato;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['campos_busca']['jap_deudas_escenario_des_contrato_cond'] = $jap_deudas_escenario_des_contrato_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['Grid_search'][$I_Grid]['cmp'] = "jap_deudas_escenario_des_contrato"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['Grid_search'][$I_Grid]['opc'] = $jap_deudas_escenario_des_contrato_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['grid_pesq']['jap_deudas_escenario_des_contrato'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $Conteudo = $jap_deudas_escenario_des_propietario;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      }
      $this->cmp_formatado['jap_deudas_escenario_des_propietario'] = $Conteudo;
      $Conteudo = $jap_deudas_escenario_des_contrato;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      }
      $this->cmp_formatado['jap_deudas_escenario_des_contrato'] = $Conteudo;

      //----- $jap_deudas_escenario_des_propietario
      $this->Date_part = false;
      if (isset($jap_deudas_escenario_des_propietario))
      {
         $this->monta_condicao("jap_deudas_escenario.des_propietario", $jap_deudas_escenario_des_propietario_cond, $jap_deudas_escenario_des_propietario, "", "jap_deudas_escenario_des_propietario", "INT4", false);
      }

      //----- $jap_deudas_escenario_des_contrato
      $this->Date_part = false;
      if (isset($jap_deudas_escenario_des_contrato))
      {
         $this->monta_condicao("jap_deudas_escenario.des_contrato", $jap_deudas_escenario_des_contrato_cond, $jap_deudas_escenario_des_contrato, "", "jap_deudas_escenario_des_contrato", "INT4", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
    $this->Sel_case_sensitive($this->comando);
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['where_pesq'] = $this->comando;
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['cond_dyn_search'] = "";
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_deudas_escenario']['cond_pesq'] .= $this->NM_operador;
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "jap_deudas_escenario_des_propietario" : return ('class="scFilterObjectOdd"'); break;
         case "jap_deudas_escenario_des_contrato" : return ('class="scFilterObjectEven"'); break;
         default       : return ("");
      }
   }
