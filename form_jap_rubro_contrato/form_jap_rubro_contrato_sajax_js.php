  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_jap_rubro_contrato" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_jap_rubro_contrato_form();
	}
...
?>
  ...
  function do_ajax_form_jap_rubro_contrato_validate_rc_contrato_(iNumLinha)
  {
    var nomeCampo_rc_contrato_ = "rc_contrato_" + iNumLinha;
    var var_rc_contrato_ = scAjaxGetFieldText(nomeCampo_rc_contrato_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_rubro_contrato_validate_rc_contrato_(var_rc_contrato_, iNumLinha, var_script_case_init, do_ajax_form_jap_rubro_contrato_validate_rc_contrato__cb);
  } // do_ajax_form_jap_rubro_contrato_validate_rc_contrato_

  function do_ajax_form_jap_rubro_contrato_validate_rc_contrato__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_rubro_contrato_validate_rc_contrato__cb

  // ---------- Validate rc_producto_
  function do_ajax_form_jap_rubro_contrato_validate_rc_producto_(iNumLinha)
  {
    var nomeCampo_rc_producto_ = "rc_producto_" + iNumLinha;
    var var_rc_producto_ = scAjaxGetFieldSelect(nomeCampo_rc_producto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_rubro_contrato_validate_rc_producto_(var_rc_producto_, iNumLinha, var_script_case_init, do_ajax_form_jap_rubro_contrato_validate_rc_producto__cb);
  } // do_ajax_form_jap_rubro_contrato_validate_rc_producto_

  function do_ajax_form_jap_rubro_contrato_validate_rc_producto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rc_producto_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rc_producto_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rc_producto_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rc_producto_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_rubro_contrato_validate_rc_producto__cb

  // ---------- Validate rc_valor_
  function do_ajax_form_jap_rubro_contrato_validate_rc_valor_(iNumLinha)
  {
    var nomeCampo_rc_valor_ = "rc_valor_" + iNumLinha;
    var var_rc_valor_ = scAjaxGetFieldText(nomeCampo_rc_valor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_rubro_contrato_validate_rc_valor_(var_rc_valor_, iNumLinha, var_script_case_init, do_ajax_form_jap_rubro_contrato_validate_rc_valor__cb);
  } // do_ajax_form_jap_rubro_contrato_validate_rc_valor_

  function do_ajax_form_jap_rubro_contrato_validate_rc_valor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rc_valor_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rc_valor_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rc_valor_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rc_valor_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_rubro_contrato_validate_rc_valor__cb

  // ---------- Validate rc_por_iva_
  function do_ajax_form_jap_rubro_contrato_validate_rc_por_iva_(iNumLinha)
  {
    var nomeCampo_rc_por_iva_ = "rc_por_iva_" + iNumLinha;
    var var_rc_por_iva_ = scAjaxGetFieldText(nomeCampo_rc_por_iva_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_rubro_contrato_validate_rc_por_iva_(var_rc_por_iva_, iNumLinha, var_script_case_init, do_ajax_form_jap_rubro_contrato_validate_rc_por_iva__cb);
  } // do_ajax_form_jap_rubro_contrato_validate_rc_por_iva_

  function do_ajax_form_jap_rubro_contrato_validate_rc_por_iva__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rc_por_iva_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rc_por_iva_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rc_por_iva_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rc_por_iva_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_rubro_contrato_validate_rc_por_iva__cb

  // ---------- Validate rc_iva_
  function do_ajax_form_jap_rubro_contrato_validate_rc_iva_(iNumLinha)
  {
    var nomeCampo_rc_iva_ = "rc_iva_" + iNumLinha;
    var var_rc_iva_ = scAjaxGetFieldHidden(nomeCampo_rc_iva_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_rubro_contrato_validate_rc_iva_(var_rc_iva_, iNumLinha, var_script_case_init, do_ajax_form_jap_rubro_contrato_validate_rc_iva__cb);
  } // do_ajax_form_jap_rubro_contrato_validate_rc_iva_

  function do_ajax_form_jap_rubro_contrato_validate_rc_iva__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rc_iva_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rc_iva_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rc_iva_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rc_iva_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_rubro_contrato_validate_rc_iva__cb

  // ---------- Validate rc_total_
  function do_ajax_form_jap_rubro_contrato_validate_rc_total_(iNumLinha)
  {
    var nomeCampo_rc_total_ = "rc_total_" + iNumLinha;
    var var_rc_total_ = scAjaxGetFieldHidden(nomeCampo_rc_total_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_rubro_contrato_validate_rc_total_(var_rc_total_, iNumLinha, var_script_case_init, do_ajax_form_jap_rubro_contrato_validate_rc_total__cb);
  } // do_ajax_form_jap_rubro_contrato_validate_rc_total_

  function do_ajax_form_jap_rubro_contrato_validate_rc_total__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rc_total_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rc_total_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rc_total_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rc_total_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_rubro_contrato_validate_rc_total__cb

  // ---------- Validate rc_estado_
  function do_ajax_form_jap_rubro_contrato_validate_rc_estado_(iNumLinha)
  {
    var nomeCampo_rc_estado_ = "rc_estado_" + iNumLinha;
    var var_rc_estado_ = scAjaxGetFieldHidden(nomeCampo_rc_estado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_rubro_contrato_validate_rc_estado_(var_rc_estado_, iNumLinha, var_script_case_init, do_ajax_form_jap_rubro_contrato_validate_rc_estado__cb);
  } // do_ajax_form_jap_rubro_contrato_validate_rc_estado_

  function do_ajax_form_jap_rubro_contrato_validate_rc_estado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rc_estado_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rc_estado_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rc_estado_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rc_estado_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_rubro_contrato_validate_rc_estado__cb

  // ---------- Event onblur rc_producto_
  function do_ajax_form_jap_rubro_contrato_event_rc_producto__onblur(iSeqForm)
  {
        if (!_scCalculatorBlurOk["id_sc_field_rc_valor_"]) {
          setTimeout(function() { scEventControl_onCalculator_rc_valor_(); }, 500);
          return;
        }
    var var_rc_producto_ = scAjaxGetFieldSelect("rc_producto_" + iSeqForm);
    var var_rc_por_iva_ = scAjaxGetFieldText("rc_por_iva_" + iSeqForm);
    var var_rc_valor_ = scAjaxGetFieldText("rc_valor_" + iSeqForm);
    var var_rc_iva_ = scAjaxGetFieldHidden("rc_iva_" + iSeqForm);
    var var_rc_total_ = scAjaxGetFieldHidden("rc_total_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_jap_rubro_contrato_event_rc_producto__onblur(var_rc_producto_, var_rc_por_iva_, var_rc_valor_, var_rc_iva_, var_rc_total_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_jap_rubro_contrato_event_rc_producto__onblur_cb);
  } // do_ajax_form_jap_rubro_contrato_event_rc_producto__onblur

  function do_ajax_form_jap_rubro_contrato_event_rc_producto__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_jap_rubro_contrato_event_rc_producto__onblur_cb_after_alert);
  } // do_ajax_form_jap_rubro_contrato_event_rc_producto__onblur_cb
  function do_ajax_form_jap_rubro_contrato_event_rc_producto__onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_jap_rubro_contrato_event_rc_producto__onblur_cb_after_alert

  // ---------- Event onchange rc_producto_
  function do_ajax_form_jap_rubro_contrato_event_rc_producto__onchange(iSeqForm)
  {
    var var_rc_producto_ = scAjaxGetFieldSelect("rc_producto_" + iSeqForm);
    var var_rc_por_iva_ = scAjaxGetFieldText("rc_por_iva_" + iSeqForm);
    var var_rc_valor_ = scAjaxGetFieldText("rc_valor_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_jap_rubro_contrato_event_rc_producto__onchange(var_rc_producto_, var_rc_por_iva_, var_rc_valor_, var_rc_iva_, var_rc_total_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_jap_rubro_contrato_event_rc_producto__onchange_cb);
  } // do_ajax_form_jap_rubro_contrato_event_rc_producto__onchange

  function do_ajax_form_jap_rubro_contrato_event_rc_producto__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_jap_rubro_contrato_event_rc_producto__onchange_cb_after_alert);
  } // do_ajax_form_jap_rubro_contrato_event_rc_producto__onchange_cb
  function do_ajax_form_jap_rubro_contrato_event_rc_producto__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_jap_rubro_contrato_event_rc_producto__onchange_cb_after_alert

  // ---------- Event onblur rc_valor_
  function do_ajax_form_jap_rubro_contrato_event_rc_valor__onblur(iSeqForm)
  {
        if (!_scCalculatorBlurOk["id_sc_field_rc_valor_"]) {
          setTimeout(function() { scEventControl_onCalculator_rc_valor_(); }, 500);
          return;
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_jap_rubro_contrato_event_rc_valor__onblur(var_rc_producto_, var_rc_valor_, var_rc_iva_, var_rc_total_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_jap_rubro_contrato_event_rc_valor__onblur_cb);
  } // do_ajax_form_jap_rubro_contrato_event_rc_valor__onblur

  function do_ajax_form_jap_rubro_contrato_event_rc_valor__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_jap_rubro_contrato_event_rc_valor__onblur_cb_after_alert);
  } // do_ajax_form_jap_rubro_contrato_event_rc_valor__onblur_cb
  function do_ajax_form_jap_rubro_contrato_event_rc_valor__onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_jap_rubro_contrato_event_rc_valor__onblur_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_jap_rubro_contrato_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_jap_rubro_contrato_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_jap_rubro_contrato_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_jap_rubro_contrato_add_new_line_cb);
  } // do_ajax_form_jap_rubro_contrato_add_new_line

  function do_ajax_form_jap_rubro_contrato_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_jap_rubro_contrato_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_jap_rubro_contrato_backup_line(iNumLinha)
  {
    var var_rc_contrato_ = scAjaxGetFieldText("rc_contrato_" + iNumLinha);
    var var_rc_producto_ = scAjaxGetFieldSelect("rc_producto_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_rubro_contrato_backup_line(var_rc_contrato_, var_rc_producto_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_jap_rubro_contrato_backup_line_cb);
  } // do_ajax_form_jap_rubro_contrato_backup_line

  function do_ajax_form_jap_rubro_contrato_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_jap_rubro_contrato_backup_line_cb

  function do_ajax_form_jap_rubro_contrato_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_jap_rubro_contrato_cancel_insert

  function do_ajax_form_jap_rubro_contrato_cancel_update(iSeqVert)
  {
    do_ajax_form_jap_rubro_contrato_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_jap_rubro_contrato_cancel_update

  function do_ajax_form_jap_rubro_contrato_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_jap_rubro_contrato_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_jap_rubro_contrato_table_refresh()
  {
    var var_rc_contrato_ = document.F2.rc_contrato_.value;
    var var_rc_producto_ = document.F2.rc_producto_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_jap_rubro_contrato_table_refresh(var_rc_contrato_, var_rc_producto_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jap_rubro_contrato_table_refresh_cb);
  } //  do_ajax_form_jap_rubro_contrato_table_refresh

  function do_ajax_form_jap_rubro_contrato_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.rc_contrato_.value = scAjaxGetKeyValue("rc_contrato_");
    document.F2.rc_producto_.value = scAjaxGetKeyValue("rc_producto_");
    ...
    scAjaxAlert(do_ajax_form_jap_rubro_contrato_table_refresh_cb_after_alert);
  } // do_ajax_form_jap_rubro_contrato_table_refresh_cb
  function do_ajax_form_jap_rubro_contrato_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_jap_rubro_contrato_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_jap_rubro_contrato_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_jap_rubro_contrato_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_rc_contrato_ = scAjaxGetFieldText("rc_contrato_" + iNumLinha);
    var var_rc_producto_ = scAjaxGetFieldSelect("rc_producto_" + iNumLinha);
    var var_rc_valor_ = scAjaxGetFieldText("rc_valor_" + iNumLinha);
    var var_rc_por_iva_ = scAjaxGetFieldText("rc_por_iva_" + iNumLinha);
    var var_rc_iva_ = scAjaxGetFieldHidden("rc_iva_" + iNumLinha);
    var var_rc_total_ = scAjaxGetFieldHidden("rc_total_" + iNumLinha);
    var var_rc_estado_ = scAjaxGetFieldHidden("rc_estado_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_jap_rubro_contrato_submit_form(var_rc_contrato_, var_rc_producto_, var_rc_valor_, var_rc_por_iva_, var_rc_iva_, var_rc_total_, var_rc_estado_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_jap_rubro_contrato_submit_form_cb);
  } // do_ajax_form_jap_rubro_contrato_submit_form

  function do_ajax_form_jap_rubro_contrato_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("rc_producto_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("rc_valor_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("rc_por_iva_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("rc_iva_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("rc_total_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("rc_estado_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_jap_rubro_contrato_submit_form_cb_after_alert);
  } // do_ajax_form_jap_rubro_contrato_submit_form_cb
  function do_ajax_form_jap_rubro_contrato_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_jap_rubro_contrato_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_jap_rubro_contrato_navigate_form()
  {
    perform_ajax_form_jap_rubro_contrato_navigate_form();
  }

  function perform_ajax_form_jap_rubro_contrato_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_jap_rubro_contrato_cancel_insert(sc_form_jap_rubro_contrato_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("rc_producto_" + iNavForm);
      scAjaxHideErrorDisplay("rc_valor_" + iNavForm);
      scAjaxHideErrorDisplay("rc_por_iva_" + iNavForm);
      scAjaxHideErrorDisplay("rc_iva_" + iNavForm);
      scAjaxHideErrorDisplay("rc_total_" + iNavForm);
      scAjaxHideErrorDisplay("rc_estado_" + iNavForm);
    }
    var var_rc_contrato_ = document.F2.rc_contrato_.value;
    var var_rc_producto_ = document.F2.rc_producto_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_jap_rubro_contrato_navigate_form(var_rc_contrato_, var_rc_producto_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jap_rubro_contrato_navigate_form_cb);
  } // do_ajax_form_jap_rubro_contrato_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_rubro_contrato']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_jap_rubro_contrato_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.rc_contrato_.value = scAjaxGetKeyValue("rc_contrato_" + var_last_index);
    document.F2.rc_producto_.value = scAjaxGetKeyValue("rc_producto_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_jap_rubro_contrato_navigate_form_cb_after_alert);
  } // do_ajax_form_jap_rubro_contrato_navigate_form_cb
  function do_ajax_form_jap_rubro_contrato_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_jap_rubro_contrato_navigate_form_cb_after_alert

    function sc_form_jap_rubro_contrato_get_last_line_number()
    {
    ...
    } //sc_form_jap_rubro_contrato_get_last_line_number

  function sc_hide_form_jap_rubro_contrato_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rc_producto_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rc_valor_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rc_por_iva_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rc_iva_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rc_total_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rc_estado_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["rc_producto_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_producto'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["rc_valor_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_valor'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["rc_por_iva_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_porcentaje_iva'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["rc_iva_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_iva'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["rc_total_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_othr_chrt_totl'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["rc_estado_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["rc_contrato_"][iNumLinha] = "rc_contrato_" + iNumLinha;
    ajax_field_mult["rc_producto_"][iNumLinha] = "rc_producto_" + iNumLinha;
    ajax_field_mult["rc_valor_"][iNumLinha] = "rc_valor_" + iNumLinha;
    ajax_field_mult["rc_por_iva_"][iNumLinha] = "rc_por_iva_" + iNumLinha;
    ajax_field_mult["rc_iva_"][iNumLinha] = "rc_iva_" + iNumLinha;
    ajax_field_mult["rc_total_"][iNumLinha] = "rc_total_" + iNumLinha;
    ajax_field_mult["rc_estado_"][iNumLinha] = "rc_estado_" + iNumLinha;
    ajax_field_id["rc_producto_" + iNumLinha] = new Array("hidden_field_label_rc_producto_", "hidden_field_data_rc_producto_" + iNumLinha);
    ajax_field_id["rc_valor_" + iNumLinha] = new Array("hidden_field_label_rc_valor_", "hidden_field_data_rc_valor_" + iNumLinha);
    ajax_field_id["rc_iva_" + iNumLinha] = new Array("hidden_field_label_rc_iva_", "hidden_field_data_rc_iva_" + iNumLinha);
    ajax_field_id["rc_total_" + iNumLinha] = new Array("hidden_field_label_rc_total_", "hidden_field_data_rc_total_" + iNumLinha);
    ajax_error_count["rc_contrato_" + iNumLinha] = "off";
    ajax_error_count["rc_producto_" + iNumLinha] = "off";
    ajax_error_count["rc_valor_" + iNumLinha] = "off";
    ajax_error_count["rc_por_iva_" + iNumLinha] = "off";
    ajax_error_count["rc_iva_" + iNumLinha] = "off";
    ajax_error_count["rc_total_" + iNumLinha] = "off";
    ajax_error_count["rc_estado_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["rc_contrato_" + iNumLinha] = "on";
    ajax_read_only["rc_producto_" + iNumLinha] = "on";
    ajax_read_only["rc_valor_" + iNumLinha] = "off";
    ajax_read_only["rc_por_iva_" + iNumLinha] = "on";
    ajax_read_only["rc_iva_" + iNumLinha] = "off";
    ajax_read_only["rc_total_" + iNumLinha] = "off";
    ajax_read_only["rc_estado_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["rc_contrato_" + iNumLinha] = "on";
    ajax_read_only["rc_producto_" + iNumLinha] = "on";
    ajax_read_only["rc_valor_" + iNumLinha] = "on";
    ajax_read_only["rc_por_iva_" + iNumLinha] = "on";
    ajax_read_only["rc_iva_" + iNumLinha] = "on";
    ajax_read_only["rc_total_" + iNumLinha] = "on";
    ajax_read_only["rc_estado_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["rc_producto_" + iNumLinha] = null;
    ajax_error_list["rc_valor_" + iNumLinha] = null;
    ajax_error_list["rc_por_iva_" + iNumLinha] = null;
    ajax_error_list["rc_iva_" + iNumLinha] = null;
    ajax_error_list["rc_total_" + iNumLinha] = null;
    ajax_error_list["rc_estado_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    ...
    "rc_producto_": new Array(),
    "rc_valor_": new Array(),
    "rc_por_iva_": new Array(),
    "rc_iva_": new Array(),
    "rc_total_": new Array(),
    "rc_estado_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["rc_producto_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rc_producto_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rc_producto_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rc_producto_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rc_producto_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["rc_valor_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rc_valor_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rc_valor_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rc_valor_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rc_valor_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["rc_por_iva_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rc_por_iva_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rc_por_iva_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rc_por_iva_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rc_por_iva_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["rc_iva_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rc_iva_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rc_iva_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rc_iva_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rc_iva_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["rc_total_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rc_total_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rc_total_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rc_total_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rc_total_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["rc_estado_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rc_estado_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rc_estado_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rc_estado_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rc_estado_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rc_contrato_'])) ? $this->nmgp_cmp_readonly['rc_contrato_'] : 'on';
?>
    scAjaxFieldRead("rc_contrato_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rc_producto_'])) ? $this->nmgp_cmp_readonly['rc_producto_'] : 'on';
?>
    scAjaxFieldRead("rc_producto_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rc_valor_'])) ? $this->nmgp_cmp_readonly['rc_valor_'] : 'off';
?>
    scAjaxFieldRead("rc_valor_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rc_por_iva_'])) ? $this->nmgp_cmp_readonly['rc_por_iva_'] : 'on';
?>
    scAjaxFieldRead("rc_por_iva_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rc_iva_'])) ? $this->nmgp_cmp_readonly['rc_iva_'] : 'off';
?>
    scAjaxFieldRead("rc_iva_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rc_total_'])) ? $this->nmgp_cmp_readonly['rc_total_'] : 'off';
?>
    scAjaxFieldRead("rc_total_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rc_estado_'])) ? $this->nmgp_cmp_readonly['rc_estado_'] : 'off';
?>
    scAjaxFieldRead("rc_estado_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("rc_contrato_" + iSeq, "on");
    scAjaxFieldRead("rc_producto_" + iSeq, "on");
    scAjaxFieldRead("rc_valor_" + iSeq, "on");
    scAjaxFieldRead("rc_por_iva_" + iSeq, "on");
    scAjaxFieldRead("rc_iva_" + iSeq, "on");
    scAjaxFieldRead("rc_total_" + iSeq, "on");
    scAjaxFieldRead("rc_estado_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["rc_contrato_" + iRow] || "on" == ajax_error_count["rc_producto_" + iRow] || "on" == ajax_error_count["rc_valor_" + iRow] || "on" == ajax_error_count["rc_por_iva_" + iRow] || "on" == ajax_error_count["rc_iva_" + iRow] || "on" == ajax_error_count["rc_total_" + iRow] || "on" == ajax_error_count["rc_estado_" + iRow]))
    {
      ...
      $("#hidden_field_data_rc_producto_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rc_valor_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rc_por_iva_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rc_iva_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rc_total_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rc_estado_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["rc_contrato_" + iRow] && "off" == ajax_error_count["rc_producto_" + iRow] && "off" == ajax_error_count["rc_valor_" + iRow] && "off" == ajax_error_count["rc_por_iva_" + iRow] && "off" == ajax_error_count["rc_iva_" + iRow] && "off" == ajax_error_count["rc_total_" + iRow] && "off" == ajax_error_count["rc_estado_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["rc_contrato_" + iRow] = "off";
        ajax_error_count["rc_producto_" + iRow] = "off";
        ajax_error_count["rc_valor_" + iRow] = "off";
        ajax_error_count["rc_por_iva_" + iRow] = "off";
        ajax_error_count["rc_iva_" + iRow] = "off";
        ajax_error_count["rc_total_" + iRow] = "off";
        ajax_error_count["rc_estado_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_rc_producto_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_rc_valor_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_rc_por_iva_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_rc_iva_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_rc_total_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_rc_estado_" + iRow).removeClass("scFormErrorLine");
    }
  }
