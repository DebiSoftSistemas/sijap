...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_sis_filial']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_sis_filial']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_sis_filial']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_sis_filial']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_sis_filial']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_sis_filial']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_sis_filial']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_sis_filial']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_sis_filial']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_sis_filial']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_sis_filial']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_sis_filial']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_sis_filial']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_sis_filial']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_sis_filial']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_sis_filial']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_sis_filial']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_sis_filial_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_sis_filial']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_sis_filial']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_sis_filial'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_sis_filial']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_sis_filial']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_sis_filial') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_sis_filial']['label'] = "" . $this->Ini->Nm_lang['lang_configuracion'] . "-" . $this->Ini->Nm_lang['lang_filial'] . "";
      ...
      $_SESSION['scriptcase']['error_icon']['form_sis_filial']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_sis_filial'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_sis_filial']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_sis_filial']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_sis_filial']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_sis_filial']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_sis_filial']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_sis_filial']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_sis_filial']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_sis_filial']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_sis_filial']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sis_filial']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_sis_filial'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_sis_filial'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_sis_filial']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_sis_filial']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_sis_filial']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_sis_filial']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_sis_filial']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_sis_filial']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_sis_filial']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_sis_filial']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_sis_filial']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_sis_filial", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_sis_filial_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_sis_filial_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_sis_filial/form_sis_filial_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_sis_filial_erro.class.php"); 
      }
      $this->Erro      = new form_sis_filial_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['opcao']))
         { 
             if ($this->fil_id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_sis_filial']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_sis_filial']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_sis_filial']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['opc_ant'] : "";
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_insert_on = false;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_sis_filial']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_sis_filial']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['dados_select'];
     }
   }
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['Gera_log_access'] = false;
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_sis_filial.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_sis_filial_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_sis_filial"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_sis_filial', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sis_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'form_sis_filial', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_sis_filial', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_sis_filial']) || !is_array($this->NM_ajax_info['errList']['geral_form_sis_filial']))
              {
                  $this->NM_ajax_info['errList']['geral_form_sis_filial'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_sis_filial'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
   ...
   if (isset($this->Field_no_validate['fil_empresa'])) {
       return;
               ...
               if (!empty($this->fil_empresa) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['Lookup_fil_empresa']) && !in_array($this->fil_empresa, $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['Lookup_fil_empresa']))
               {
                   $hasError = true;
   ...
   if (isset($this->Field_no_validate['fil_actividad_economica'])) {
       return;
               ...
               if (!empty($this->fil_actividad_economica) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['Lookup_fil_actividad_economica']) && !in_array($this->fil_actividad_economica, $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['Lookup_fil_actividad_economica']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['fil_obligado_contabilidad'])) {
       return;
               ...
               if (!empty($this->fil_obligado_contabilidad) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['Lookup_fil_obligado_contabilidad']) && !in_array($this->fil_obligado_contabilidad, $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['Lookup_fil_obligado_contabilidad']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['fil_ambiente_sri'])) {
       return;
               ...
               if (!empty($this->fil_ambiente_sri) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['Lookup_fil_ambiente_sri']) && !in_array($this->fil_ambiente_sri, $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['Lookup_fil_ambiente_sri']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['fil_estado'])) {
       return;
               ...
               if (!empty($this->fil_estado) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['Lookup_fil_estado']) && !in_array($this->fil_estado, $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['Lookup_fil_estado']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['fil_pais'])) {
       return;
               ...
               if (!empty($this->fil_pais) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['Lookup_fil_pais']) && !in_array($this->fil_pais, $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['Lookup_fil_pais']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['fil_provincia'])) {
       return;
               ...
               if (!empty($this->fil_provincia) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['Lookup_fil_provincia']) && !in_array($this->fil_provincia, $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['Lookup_fil_provincia']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['fil_ciudad'])) {
       return;
               ...
               if (!empty($this->fil_ciudad) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['Lookup_fil_ciudad']) && !in_array($this->fil_ciudad, $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['Lookup_fil_ciudad']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['fil_parroquia'])) {
       return;
               ...
               if (!empty($this->fil_parroquia) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['Lookup_fil_parroquia']) && !in_array($this->fil_parroquia, $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['Lookup_fil_parroquia']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['fil_id']['keyVal'] = form_sis_filial_pack_protect_string($this->nmgp_dados_form['fil_id']);
          }
   } // ajax_return_values
...
else
{
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_sis_filial_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_sis_filial_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['fil_empresa']['valList'][$i] = form_sis_filial_pack_protect_string($v);
          }
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['fil_actividad_economica']['valList'][$i] = form_sis_filial_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['fil_obligado_contabilidad']['valList'][$i] = form_sis_filial_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_sis_filial_pack_protect_string('S') => str_replace('<', '&lt;',form_sis_filial_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['Lookup_fil_padronrimpe'][] = 'S';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['fil_padronrimpe']['valList'][$i] = form_sis_filial_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['fil_ambiente_sri']['valList'][$i] = form_sis_filial_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['fil_estado']['valList'][$i] = form_sis_filial_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['fil_pais']['valList'][$i] = form_sis_filial_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['fil_provincia']['valList'][$i] = form_sis_filial_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['fil_ciudad']['valList'][$i] = form_sis_filial_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['fil_parroquia']['valList'][$i] = form_sis_filial_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_fil_referencia($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['Field_no_validate'] = array();
      $this->nm_guardar_campos();
...
//----------- 
   ...
   function return_after_insert()
   {
      ...
      if ('' != $this->fil_id)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['reg_start'] = $rsc->fields[0];
          $rsc->Close();
      }
   }
   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['total']);
              }
              ...
              $this->NM_gera_log_new();
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['reg_start'] = 0; 
              }
    ...
    if ("insert" == $this->sc_evento && $this->nmgp_opcao != "nada") {
        $_SESSION['scriptcase']['form_sis_filial']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['form_sis_filial']['contr_erro'] = 'off'; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['parms'] = "fil_id?#?$this->fil_id?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['run_iframe'] == "R")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_form_sis_filial = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['total'] = $qt_geral_reg_form_sis_filial;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->fil_id))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_sis_filial = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['reg_start'] > $qt_geral_reg_form_sis_filial)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['reg_start'] = $qt_geral_reg_form_sis_filial; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_sis_filial) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['reg_start']) ;  
              } 
          } 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['reg_start'] < $qt_geral_reg_form_sis_filial;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['opcao']   = '';
          }
      } 
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['dados_select'];
...
// 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['reg_start'] + 1;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_sis_filial_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['csrf_token'];
    }
...
{ 
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_sis_filial = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['total'] = $qt_geral_reg_form_sis_filial;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_sis_filial_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_sis_filial_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_sis_filial_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['masterValue']))
{
...
<?php
  exit;
    ...
    function displayAppHeader()
    {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_filial']['ordem_ord'] == " desc") {
