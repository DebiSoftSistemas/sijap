<?php
@session_start() ;
$_SESSION['scriptcase']['grid_guias_na']['sc_process_barr'] = true;
require_once('../grid_guias_na/index.php');
unset($_SESSION['scriptcase']['grid_guias_na']['sc_process_barr']);
$ExportCtrl = new grid_guias_na_export_control;
$ExportCtrl->Export_barr();

class grid_guias_na_export_control
{
