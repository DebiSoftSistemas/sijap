...
<?php
   ...
   $Ord_Cmp = new grid_fac_cuenta_bancaria_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_fac_cuenta_bancaria_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_fac_cuenta_bancaria']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_fac_cuenta_bancaria']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['cb_banco'] = "cb_banco";
   $tab_labels["cb_banco"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_cuenta_bancaria']['labels']["cb_banco"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_cuenta_bancaria']['labels']["cb_banco"] : "" . $this->Nm_lang['lang_banco'] . "";
   $tab_ger_campos['cb_tipo_cuenta'] = "on";
   $tab_def_campos['cb_tipo_cuenta'] = "cb_tipo_cuenta";
   $tab_labels["cb_tipo_cuenta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_cuenta_bancaria']['labels']["cb_tipo_cuenta"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_cuenta_bancaria']['labels']["cb_tipo_cuenta"] : "" . $this->Nm_lang['lang_tipo_cuenta'] . "";
   $tab_ger_campos['cb_numero_cuenta'] = "on";
   $tab_def_campos['cb_numero_cuenta'] = "cb_numero_cuenta";
   $tab_labels["cb_numero_cuenta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_cuenta_bancaria']['labels']["cb_numero_cuenta"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_cuenta_bancaria']['labels']["cb_numero_cuenta"] : "" . $this->Nm_lang['lang_numero_cuenta'] . "";
   $tab_ger_campos['cb_cuenta_contable'] = "on";
   $tab_def_campos['cb_cuenta_contable'] = "cb_cuenta_contable";
   $tab_labels["cb_cuenta_contable"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_cuenta_bancaria']['labels']["cb_cuenta_contable"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_cuenta_bancaria']['labels']["cb_cuenta_contable"] : "" . $this->Nm_lang['lang_cuenta_contable'] . "";
   $tab_ger_campos['cb_estado'] = "on";
   $tab_def_campos['cb_estado'] = "cb_estado";
   $tab_labels["cb_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_cuenta_bancaria']['labels']["cb_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_cuenta_bancaria']['labels']["cb_estado"] : "" . $this->Nm_lang['lang_estado'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_cuenta_bancaria']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_fac_cuenta_bancaria']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_fac_cuenta_bancaria']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_fac_cuenta_bancaria']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_fac_cuenta_bancaria']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_fac_cuenta_bancaria']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_fac_cuenta_bancaria']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_fac_cuenta_bancaria']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_cuenta_bancaria']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_fac_cuenta_bancaria']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_fac_cuenta_bancaria']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_fac_cuenta_bancaria']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_fac_cuenta_bancaria_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_fac_cuenta_bancaria']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_fac_cuenta_bancaria']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_cuenta_bancaria']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_fac_cuenta_bancaria']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_fac_cuenta_bancaria']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
