...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_fac_cuenta_bancaria"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_fac_cuenta_bancaria"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_fac_cuenta_bancaria'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_fac_cuenta_bancaria']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_fac_cuenta_bancaria']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_fac_cuenta_bancaria']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_fac_cuenta_bancaria']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_fac_cuenta_bancaria']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_fac_cuenta_bancaria</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_fac_cuenta_bancaria']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_fac_cuenta_bancaria']['embutida_filho'] as $ind => $sc_init)
          {
