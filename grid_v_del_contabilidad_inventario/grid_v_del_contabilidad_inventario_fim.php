...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_v_del_contabilidad_inventario"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_v_del_contabilidad_inventario"]);
   }
