<?php
@session_start() ;
$_SESSION['scriptcase']['grid_fac_producto']['sc_process_barr'] = true;
require_once('../grid_fac_producto/index.php');
unset($_SESSION['scriptcase']['grid_fac_producto']['sc_process_barr']);
$ExportCtrl = new grid_fac_producto_export_control;
$ExportCtrl->Export_barr();

class grid_fac_producto_export_control
{
