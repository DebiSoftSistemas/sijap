<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_fac_producto']['glo_nm_path_imag_temp'] . "/sc_apl_default_debi_doc_electronicos.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_fac_producto_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_fac_producto_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_fac_producto']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_fac_producto']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['pro_imagen'] = "pro_imagen";
   $tab_labels["pro_imagen"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_producto']['labels']["pro_imagen"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_producto']['labels']["pro_imagen"] : "" . $this->Nm_lang['lang_btns_img'] . "";
   $tab_ger_campos['pro_codigo'] = "on";
   $tab_def_campos['pro_codigo'] = "pro_codigo";
   $tab_labels["pro_codigo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_producto']['labels']["pro_codigo"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_producto']['labels']["pro_codigo"] : "" . $this->Nm_lang['lang_codigo'] . "";
   $tab_ger_campos['pro_codigo_secundario'] = "on";
   $tab_def_campos['pro_codigo_secundario'] = "pro_codigo_secundario";
   $tab_labels["pro_codigo_secundario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_producto']['labels']["pro_codigo_secundario"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_producto']['labels']["pro_codigo_secundario"] : "" . $this->Nm_lang['lang_codigo_secundario'] . "";
   $tab_ger_campos['pro_nombre'] = "on";
   $tab_def_campos['pro_nombre'] = "pro_nombre";
   $tab_labels["pro_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_producto']['labels']["pro_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_producto']['labels']["pro_nombre"] : "" . $this->Nm_lang['lang_descripcion'] . "";
   $tab_ger_campos['pro_precio_uni'] = "on";
   $tab_def_campos['pro_precio_uni'] = "pro_precio_uni";
   $tab_labels["pro_precio_uni"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_producto']['labels']["pro_precio_uni"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_producto']['labels']["pro_precio_uni"] : "" . $this->Nm_lang['lang_precio_unitario'] . "";
   $tab_ger_campos['pro_por_iva'] = "on";
   $tab_def_campos['pro_por_iva'] = "pro_por_iva";
   $tab_labels["pro_por_iva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_producto']['labels']["pro_por_iva"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_producto']['labels']["pro_por_iva"] : "" . $this->Nm_lang['lang_porcentaje_iva'] . "";
   $tab_ger_campos['pro_por_ice'] = "on";
   $tab_def_campos['pro_por_ice'] = "pro_por_ice";
   $tab_labels["pro_por_ice"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_producto']['labels']["pro_por_ice"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_producto']['labels']["pro_por_ice"] : "" . $this->Nm_lang['lang_porcentaje_ice'] . "";
   $tab_ger_campos['pro_estado'] = "on";
   $tab_def_campos['pro_estado'] = "pro_estado";
   $tab_labels["pro_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_producto']['labels']["pro_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_producto']['labels']["pro_estado"] : "" . $this->Nm_lang['lang_estado'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_producto']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_fac_producto']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_fac_producto']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_fac_producto']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_fac_producto']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_fac_producto']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_fac_producto']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_fac_producto']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_producto']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_fac_producto']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_fac_producto']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_fac_producto']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_fac_producto_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_fac_producto']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_fac_producto']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_producto']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_fac_producto']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_fac_producto']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
