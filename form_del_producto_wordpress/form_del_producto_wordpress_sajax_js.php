  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_producto_wordpress" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_producto_wordpress_form();
	}
...
?>
  ...
  // ---------- Validate pw_empresa
  function do_ajax_form_del_producto_wordpress_validate_pw_empresa()
  {
    var nomeCampo_pw_empresa = "pw_empresa";
    var var_pw_empresa = scAjaxGetFieldText(nomeCampo_pw_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_producto_wordpress_validate_pw_empresa(var_pw_empresa, var_script_case_init, do_ajax_form_del_producto_wordpress_validate_pw_empresa_cb);
  } // do_ajax_form_del_producto_wordpress_validate_pw_empresa

  function do_ajax_form_del_producto_wordpress_validate_pw_empresa_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_producto_wordpress_validate_pw_empresa_cb

  // ---------- Validate pw_id
  function do_ajax_form_del_producto_wordpress_validate_pw_id()
  {
    var nomeCampo_pw_id = "pw_id";
    var var_pw_id = scAjaxGetFieldText(nomeCampo_pw_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_producto_wordpress_validate_pw_id(var_pw_id, var_script_case_init, do_ajax_form_del_producto_wordpress_validate_pw_id_cb);
  } // do_ajax_form_del_producto_wordpress_validate_pw_id

  function do_ajax_form_del_producto_wordpress_validate_pw_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pw_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_producto_wordpress_validate_pw_id_cb

  // ---------- Validate pw_sku
  function do_ajax_form_del_producto_wordpress_validate_pw_sku()
  {
    var nomeCampo_pw_sku = "pw_sku";
    var var_pw_sku = scAjaxGetFieldText(nomeCampo_pw_sku);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_producto_wordpress_validate_pw_sku(var_pw_sku, var_script_case_init, do_ajax_form_del_producto_wordpress_validate_pw_sku_cb);
  } // do_ajax_form_del_producto_wordpress_validate_pw_sku

  function do_ajax_form_del_producto_wordpress_validate_pw_sku_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pw_sku";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_producto_wordpress_validate_pw_sku_cb

  // ---------- Validate pw_producto_debi
  function do_ajax_form_del_producto_wordpress_validate_pw_producto_debi()
  {
    var nomeCampo_pw_producto_debi = "pw_producto_debi";
    var var_pw_producto_debi = scAjaxGetFieldSelect(nomeCampo_pw_producto_debi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_producto_wordpress_validate_pw_producto_debi(var_pw_producto_debi, var_script_case_init, do_ajax_form_del_producto_wordpress_validate_pw_producto_debi_cb);
  } // do_ajax_form_del_producto_wordpress_validate_pw_producto_debi

  function do_ajax_form_del_producto_wordpress_validate_pw_producto_debi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_producto_wordpress_validate_pw_producto_debi_cb

  // ---------- Validate pw_tipo
  function do_ajax_form_del_producto_wordpress_validate_pw_tipo()
  {
    var nomeCampo_pw_tipo = "pw_tipo";
    var var_pw_tipo = scAjaxGetFieldSelect(nomeCampo_pw_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_producto_wordpress_validate_pw_tipo(var_pw_tipo, var_script_case_init, do_ajax_form_del_producto_wordpress_validate_pw_tipo_cb);
  } // do_ajax_form_del_producto_wordpress_validate_pw_tipo

  function do_ajax_form_del_producto_wordpress_validate_pw_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pw_tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_producto_wordpress_validate_pw_tipo_cb

  // ---------- Validate pw_descripcion
  function do_ajax_form_del_producto_wordpress_validate_pw_descripcion()
  {
    var nomeCampo_pw_descripcion = "pw_descripcion";
    var var_pw_descripcion = scAjaxGetFieldText(nomeCampo_pw_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_producto_wordpress_validate_pw_descripcion(var_pw_descripcion, var_script_case_init, do_ajax_form_del_producto_wordpress_validate_pw_descripcion_cb);
  } // do_ajax_form_del_producto_wordpress_validate_pw_descripcion

  function do_ajax_form_del_producto_wordpress_validate_pw_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_producto_wordpress_validate_pw_descripcion_cb

  // ---------- Validate pw_descripcion_corta
  function do_ajax_form_del_producto_wordpress_validate_pw_descripcion_corta()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_producto_wordpress_validate_pw_descripcion_corta(var_pw_descripcion_corta, var_script_case_init, do_ajax_form_del_producto_wordpress_validate_pw_descripcion_corta_cb);
  } // do_ajax_form_del_producto_wordpress_validate_pw_descripcion_corta

  function do_ajax_form_del_producto_wordpress_validate_pw_descripcion_corta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_producto_wordpress_validate_pw_descripcion_corta_cb

  // ---------- Validate pw_precio_regular
  function do_ajax_form_del_producto_wordpress_validate_pw_precio_regular()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_producto_wordpress_validate_pw_precio_regular(var_pw_precio_regular, var_script_case_init, do_ajax_form_del_producto_wordpress_validate_pw_precio_regular_cb);
  } // do_ajax_form_del_producto_wordpress_validate_pw_precio_regular

  function do_ajax_form_del_producto_wordpress_validate_pw_precio_regular_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_producto_wordpress_validate_pw_precio_regular_cb

  // ---------- Validate pw_estado_impuestos
  function do_ajax_form_del_producto_wordpress_validate_pw_estado_impuestos()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_producto_wordpress_validate_pw_estado_impuestos(var_pw_estado_impuestos, var_script_case_init, do_ajax_form_del_producto_wordpress_validate_pw_estado_impuestos_cb);
  } // do_ajax_form_del_producto_wordpress_validate_pw_estado_impuestos

  function do_ajax_form_del_producto_wordpress_validate_pw_estado_impuestos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_producto_wordpress_validate_pw_estado_impuestos_cb

  // ---------- Validate pw_maneja_stock
  function do_ajax_form_del_producto_wordpress_validate_pw_maneja_stock()
  {
    var nomeCampo_pw_maneja_stock = "pw_maneja_stock";
    var var_pw_maneja_stock = scAjaxGetFieldCheckbox(nomeCampo_pw_maneja_stock, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_producto_wordpress_validate_pw_maneja_stock(var_pw_maneja_stock, var_script_case_init, do_ajax_form_del_producto_wordpress_validate_pw_maneja_stock_cb);
  } // do_ajax_form_del_producto_wordpress_validate_pw_maneja_stock

  function do_ajax_form_del_producto_wordpress_validate_pw_maneja_stock_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_producto_wordpress_validate_pw_maneja_stock_cb

  // ---------- Validate pw_cantidad_stock
  function do_ajax_form_del_producto_wordpress_validate_pw_cantidad_stock()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_producto_wordpress_validate_pw_cantidad_stock(var_pw_cantidad_stock, var_script_case_init, do_ajax_form_del_producto_wordpress_validate_pw_cantidad_stock_cb);
  } // do_ajax_form_del_producto_wordpress_validate_pw_cantidad_stock

  function do_ajax_form_del_producto_wordpress_validate_pw_cantidad_stock_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_producto_wordpress_validate_pw_cantidad_stock_cb

  // ---------- Validate pw_estado
  function do_ajax_form_del_producto_wordpress_validate_pw_estado()
  {
    var nomeCampo_pw_estado = "pw_estado";
    var var_pw_estado = scAjaxGetFieldSelect(nomeCampo_pw_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_producto_wordpress_validate_pw_estado(var_pw_estado, var_script_case_init, do_ajax_form_del_producto_wordpress_validate_pw_estado_cb);
  } // do_ajax_form_del_producto_wordpress_validate_pw_estado

  function do_ajax_form_del_producto_wordpress_validate_pw_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_producto_wordpress_validate_pw_estado_cb

  // ---------- Validate pw_categoria
  function do_ajax_form_del_producto_wordpress_validate_pw_categoria()
  {
    var nomeCampo_pw_categoria = "pw_categoria";
    var var_pw_categoria = scAjaxGetFieldSelect(nomeCampo_pw_categoria);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_producto_wordpress_validate_pw_categoria(var_pw_categoria, var_script_case_init, do_ajax_form_del_producto_wordpress_validate_pw_categoria_cb);
  } // do_ajax_form_del_producto_wordpress_validate_pw_categoria

  function do_ajax_form_del_producto_wordpress_validate_pw_categoria_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_producto_wordpress_validate_pw_categoria_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_producto_wordpress_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_producto_wordpress_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_del_producto_wordpress_submit_form(var_pw_empresa, var_pw_id, var_pw_sku, var_pw_producto_debi, var_pw_tipo, var_pw_descripcion, var_pw_descripcion_corta, var_pw_precio_regular, var_pw_estado_impuestos, var_pw_maneja_stock, var_pw_cantidad_stock, var_pw_estado, var_pw_categoria, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_producto_wordpress_submit_form_cb);
  } // do_ajax_form_del_producto_wordpress_submit_form

  function do_ajax_form_del_producto_wordpress_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_producto_wordpress_submit_form_cb_after_alert);
  } // do_ajax_form_del_producto_wordpress_submit_form_cb
  function do_ajax_form_del_producto_wordpress_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_producto_wordpress_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_producto_wordpress_navigate_form()
  {
    perform_ajax_form_del_producto_wordpress_navigate_form();
  }

  function perform_ajax_form_del_producto_wordpress_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_del_producto_wordpress_navigate_form(var_pw_empresa, var_pw_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_producto_wordpress_navigate_form_cb);
  } // do_ajax_form_del_producto_wordpress_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_wordpress']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_producto_wordpress_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_producto_wordpress_navigate_form_cb_after_alert);
  } // do_ajax_form_del_producto_wordpress_navigate_form_cb
  function do_ajax_form_del_producto_wordpress_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_del_producto_wordpress_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_producto_wordpress_navigate_form_cb_after_alert

  function sc_hide_form_del_producto_wordpress_form()
  {
