  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_producto_wordpress_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_producto_wordpress_mob_form();
	}
...
?>
  ...
  // ---------- Validate pw_empresa
  function do_ajax_form_del_producto_wordpress_mob_validate_pw_empresa()
  {
    var nomeCampo_pw_empresa = "pw_empresa";
    var var_pw_empresa = scAjaxGetFieldText(nomeCampo_pw_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_producto_wordpress_mob_validate_pw_empresa(var_pw_empresa, var_script_case_init, do_ajax_form_del_producto_wordpress_mob_validate_pw_empresa_cb);
  } // do_ajax_form_del_producto_wordpress_mob_validate_pw_empresa

  function do_ajax_form_del_producto_wordpress_mob_validate_pw_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pw_empresa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_producto_wordpress_mob_validate_pw_empresa_cb

  // ---------- Validate pw_id
  function do_ajax_form_del_producto_wordpress_mob_validate_pw_id()
  {
    var nomeCampo_pw_id = "pw_id";
    var var_pw_id = scAjaxGetFieldText(nomeCampo_pw_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_producto_wordpress_mob_validate_pw_id(var_pw_id, var_script_case_init, do_ajax_form_del_producto_wordpress_mob_validate_pw_id_cb);
  } // do_ajax_form_del_producto_wordpress_mob_validate_pw_id

  function do_ajax_form_del_producto_wordpress_mob_validate_pw_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pw_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_producto_wordpress_mob_validate_pw_id_cb

  // ---------- Validate pw_sku
  function do_ajax_form_del_producto_wordpress_mob_validate_pw_sku()
  {
    var nomeCampo_pw_sku = "pw_sku";
    var var_pw_sku = scAjaxGetFieldText(nomeCampo_pw_sku);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_producto_wordpress_mob_validate_pw_sku(var_pw_sku, var_script_case_init, do_ajax_form_del_producto_wordpress_mob_validate_pw_sku_cb);
  } // do_ajax_form_del_producto_wordpress_mob_validate_pw_sku

  function do_ajax_form_del_producto_wordpress_mob_validate_pw_sku_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pw_sku";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_producto_wordpress_mob_validate_pw_sku_cb

  // ---------- Validate pw_producto_debi
  function do_ajax_form_del_producto_wordpress_mob_validate_pw_producto_debi()
  {
    var nomeCampo_pw_producto_debi = "pw_producto_debi";
    var var_pw_producto_debi = scAjaxGetFieldSelect(nomeCampo_pw_producto_debi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_producto_wordpress_mob_validate_pw_producto_debi(var_pw_producto_debi, var_script_case_init, do_ajax_form_del_producto_wordpress_mob_validate_pw_producto_debi_cb);
  } // do_ajax_form_del_producto_wordpress_mob_validate_pw_producto_debi

  function do_ajax_form_del_producto_wordpress_mob_validate_pw_producto_debi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pw_producto_debi";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_producto_wordpress_mob_validate_pw_producto_debi_cb

  // ---------- Validate pw_tipo
  function do_ajax_form_del_producto_wordpress_mob_validate_pw_tipo()
  {
    var nomeCampo_pw_tipo = "pw_tipo";
    var var_pw_tipo = scAjaxGetFieldSelect(nomeCampo_pw_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_producto_wordpress_mob_validate_pw_tipo(var_pw_tipo, var_script_case_init, do_ajax_form_del_producto_wordpress_mob_validate_pw_tipo_cb);
  } // do_ajax_form_del_producto_wordpress_mob_validate_pw_tipo

  function do_ajax_form_del_producto_wordpress_mob_validate_pw_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pw_tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_producto_wordpress_mob_validate_pw_tipo_cb

  // ---------- Validate pw_descripcion
  function do_ajax_form_del_producto_wordpress_mob_validate_pw_descripcion()
  {
    var nomeCampo_pw_descripcion = "pw_descripcion";
    var var_pw_descripcion = scAjaxGetFieldText(nomeCampo_pw_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_producto_wordpress_mob_validate_pw_descripcion(var_pw_descripcion, var_script_case_init, do_ajax_form_del_producto_wordpress_mob_validate_pw_descripcion_cb);
  } // do_ajax_form_del_producto_wordpress_mob_validate_pw_descripcion

  function do_ajax_form_del_producto_wordpress_mob_validate_pw_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pw_descripcion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_producto_wordpress_mob_validate_pw_descripcion_cb

  // ---------- Validate pw_descripcion_corta
  function do_ajax_form_del_producto_wordpress_mob_validate_pw_descripcion_corta()
  {
    var nomeCampo_pw_descripcion_corta = "pw_descripcion_corta";
    var var_pw_descripcion_corta = scAjaxGetFieldText(nomeCampo_pw_descripcion_corta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_producto_wordpress_mob_validate_pw_descripcion_corta(var_pw_descripcion_corta, var_script_case_init, do_ajax_form_del_producto_wordpress_mob_validate_pw_descripcion_corta_cb);
  } // do_ajax_form_del_producto_wordpress_mob_validate_pw_descripcion_corta

  function do_ajax_form_del_producto_wordpress_mob_validate_pw_descripcion_corta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pw_descripcion_corta";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_producto_wordpress_mob_validate_pw_descripcion_corta_cb

  // ---------- Validate pw_precio_regular
  function do_ajax_form_del_producto_wordpress_mob_validate_pw_precio_regular()
  {
    var nomeCampo_pw_precio_regular = "pw_precio_regular";
    var var_pw_precio_regular = scAjaxGetFieldText(nomeCampo_pw_precio_regular);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_producto_wordpress_mob_validate_pw_precio_regular(var_pw_precio_regular, var_script_case_init, do_ajax_form_del_producto_wordpress_mob_validate_pw_precio_regular_cb);
  } // do_ajax_form_del_producto_wordpress_mob_validate_pw_precio_regular

  function do_ajax_form_del_producto_wordpress_mob_validate_pw_precio_regular_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pw_precio_regular";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_producto_wordpress_mob_validate_pw_precio_regular_cb

  // ---------- Validate pw_estado_impuestos
  function do_ajax_form_del_producto_wordpress_mob_validate_pw_estado_impuestos()
  {
    var nomeCampo_pw_estado_impuestos = "pw_estado_impuestos";
    var var_pw_estado_impuestos = scAjaxGetFieldSelect(nomeCampo_pw_estado_impuestos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_producto_wordpress_mob_validate_pw_estado_impuestos(var_pw_estado_impuestos, var_script_case_init, do_ajax_form_del_producto_wordpress_mob_validate_pw_estado_impuestos_cb);
  } // do_ajax_form_del_producto_wordpress_mob_validate_pw_estado_impuestos

  function do_ajax_form_del_producto_wordpress_mob_validate_pw_estado_impuestos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pw_estado_impuestos";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_producto_wordpress_mob_validate_pw_estado_impuestos_cb

  // ---------- Validate pw_maneja_stock
  function do_ajax_form_del_producto_wordpress_mob_validate_pw_maneja_stock()
  {
    var nomeCampo_pw_maneja_stock = "pw_maneja_stock";
    var var_pw_maneja_stock = scAjaxGetFieldCheckbox(nomeCampo_pw_maneja_stock, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_producto_wordpress_mob_validate_pw_maneja_stock(var_pw_maneja_stock, var_script_case_init, do_ajax_form_del_producto_wordpress_mob_validate_pw_maneja_stock_cb);
  } // do_ajax_form_del_producto_wordpress_mob_validate_pw_maneja_stock

  function do_ajax_form_del_producto_wordpress_mob_validate_pw_maneja_stock_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pw_maneja_stock";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_producto_wordpress_mob_validate_pw_maneja_stock_cb

  // ---------- Validate pw_cantidad_stock
  function do_ajax_form_del_producto_wordpress_mob_validate_pw_cantidad_stock()
  {
    var nomeCampo_pw_cantidad_stock = "pw_cantidad_stock";
    var var_pw_cantidad_stock = scAjaxGetFieldText(nomeCampo_pw_cantidad_stock);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_producto_wordpress_mob_validate_pw_cantidad_stock(var_pw_cantidad_stock, var_script_case_init, do_ajax_form_del_producto_wordpress_mob_validate_pw_cantidad_stock_cb);
  } // do_ajax_form_del_producto_wordpress_mob_validate_pw_cantidad_stock

  function do_ajax_form_del_producto_wordpress_mob_validate_pw_cantidad_stock_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pw_cantidad_stock";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_producto_wordpress_mob_validate_pw_cantidad_stock_cb

  // ---------- Validate pw_estado
  function do_ajax_form_del_producto_wordpress_mob_validate_pw_estado()
  {
    var nomeCampo_pw_estado = "pw_estado";
    var var_pw_estado = scAjaxGetFieldSelect(nomeCampo_pw_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_producto_wordpress_mob_validate_pw_estado(var_pw_estado, var_script_case_init, do_ajax_form_del_producto_wordpress_mob_validate_pw_estado_cb);
  } // do_ajax_form_del_producto_wordpress_mob_validate_pw_estado

  function do_ajax_form_del_producto_wordpress_mob_validate_pw_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pw_estado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_producto_wordpress_mob_validate_pw_estado_cb

  // ---------- Validate pw_categoria
  function do_ajax_form_del_producto_wordpress_mob_validate_pw_categoria()
  {
    var nomeCampo_pw_categoria = "pw_categoria";
    var var_pw_categoria = scAjaxGetFieldSelect(nomeCampo_pw_categoria);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_producto_wordpress_mob_validate_pw_categoria(var_pw_categoria, var_script_case_init, do_ajax_form_del_producto_wordpress_mob_validate_pw_categoria_cb);
  } // do_ajax_form_del_producto_wordpress_mob_validate_pw_categoria

  function do_ajax_form_del_producto_wordpress_mob_validate_pw_categoria_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pw_categoria";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_producto_wordpress_mob_validate_pw_categoria_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_producto_wordpress_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_producto_wordpress_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_pw_empresa = scAjaxGetFieldText("pw_empresa");
    var var_pw_id = scAjaxGetFieldText("pw_id");
    var var_pw_sku = scAjaxGetFieldText("pw_sku");
    var var_pw_producto_debi = scAjaxGetFieldSelect("pw_producto_debi");
    var var_pw_tipo = scAjaxGetFieldSelect("pw_tipo");
    var var_pw_descripcion = scAjaxGetFieldText("pw_descripcion");
    var var_pw_descripcion_corta = scAjaxGetFieldText("pw_descripcion_corta");
    var var_pw_precio_regular = scAjaxGetFieldText("pw_precio_regular");
    var var_pw_estado_impuestos = scAjaxGetFieldSelect("pw_estado_impuestos");
    var var_pw_maneja_stock = scAjaxGetFieldCheckbox("pw_maneja_stock", ";");
    var var_pw_cantidad_stock = scAjaxGetFieldText("pw_cantidad_stock");
    var var_pw_estado = scAjaxGetFieldSelect("pw_estado");
    var var_pw_categoria = scAjaxGetFieldSelect("pw_categoria");
    ...
    scAjaxProcOn();
    x_ajax_form_del_producto_wordpress_mob_submit_form(var_pw_empresa, var_pw_id, var_pw_sku, var_pw_producto_debi, var_pw_tipo, var_pw_descripcion, var_pw_descripcion_corta, var_pw_precio_regular, var_pw_estado_impuestos, var_pw_maneja_stock, var_pw_cantidad_stock, var_pw_estado, var_pw_categoria, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_producto_wordpress_mob_submit_form_cb);
  } // do_ajax_form_del_producto_wordpress_mob_submit_form

  function do_ajax_form_del_producto_wordpress_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("pw_empresa");
      scAjaxHideErrorDisplay("pw_id");
      scAjaxHideErrorDisplay("pw_sku");
      scAjaxHideErrorDisplay("pw_producto_debi");
      scAjaxHideErrorDisplay("pw_tipo");
      scAjaxHideErrorDisplay("pw_descripcion");
      scAjaxHideErrorDisplay("pw_descripcion_corta");
      scAjaxHideErrorDisplay("pw_precio_regular");
      scAjaxHideErrorDisplay("pw_estado_impuestos");
      scAjaxHideErrorDisplay("pw_maneja_stock");
      scAjaxHideErrorDisplay("pw_cantidad_stock");
      scAjaxHideErrorDisplay("pw_estado");
      scAjaxHideErrorDisplay("pw_categoria");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_producto_wordpress_mob_submit_form_cb_after_alert);
  } // do_ajax_form_del_producto_wordpress_mob_submit_form_cb
  function do_ajax_form_del_producto_wordpress_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_producto_wordpress_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_producto_wordpress_mob_navigate_form()
  {
    perform_ajax_form_del_producto_wordpress_mob_navigate_form();
  }

  function perform_ajax_form_del_producto_wordpress_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("pw_estado");
    scAjaxHideErrorDisplay("pw_categoria");
    var var_pw_empresa = document.F2.pw_empresa.value;
    var var_pw_id = document.F2.pw_id.value;
    ...
    scAjaxProcOn();
    x_ajax_form_del_producto_wordpress_mob_navigate_form(var_pw_empresa, var_pw_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_producto_wordpress_mob_navigate_form_cb);
  } // do_ajax_form_del_producto_wordpress_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_wordpress_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_producto_wordpress_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.pw_empresa.value = scAjaxGetKeyValue("pw_empresa");
    document.F2.pw_id.value = scAjaxGetKeyValue("pw_id");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_producto_wordpress_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_del_producto_wordpress_mob_navigate_form_cb
  function do_ajax_form_del_producto_wordpress_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_del_producto_wordpress_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_producto_wordpress_mob_navigate_form_cb_after_alert

  function sc_hide_form_del_producto_wordpress_mob_form()
  {
  ...
  ajax_field_list[0] = "pw_empresa";
  ajax_field_list[1] = "pw_id";
  ajax_field_list[2] = "pw_sku";
  ajax_field_list[3] = "pw_producto_debi";
  ajax_field_list[4] = "pw_tipo";
  ajax_field_list[5] = "pw_descripcion";
  ajax_field_list[6] = "pw_descripcion_corta";
  ajax_field_list[7] = "pw_precio_regular";
  ajax_field_list[8] = "pw_estado_impuestos";
  ajax_field_list[9] = "pw_maneja_stock";
  ajax_field_list[10] = "pw_cantidad_stock";
  ajax_field_list[11] = "pw_estado";
  ajax_field_list[12] = "pw_categoria";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "pw_empresa": {"label": "<?php echo $this->Ini->Nm_lang['lang_empresa'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pw_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pw_sku": {"label": "<?php echo $this->Ini->Nm_lang['lang_sku'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pw_producto_debi": {"label": "<?php echo $this->Ini->Nm_lang['lang_producto_debi'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pw_tipo": {"label": "<?php echo $this->Ini->Nm_lang['lang_tipo'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pw_descripcion": {"label": "<?php echo $this->Ini->Nm_lang['lang_descripcion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pw_descripcion_corta": {"label": "<?php echo $this->Ini->Nm_lang['lang_descripcion_corta'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pw_precio_regular": {"label": "<?php echo $this->Ini->Nm_lang['lang_precio'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pw_estado_impuestos": {"label": "<?php echo $this->Ini->Nm_lang['lang_estado_impuestos'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pw_maneja_stock": {"label": "<?php echo $this->Ini->Nm_lang['lang_maneja_stock'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pw_cantidad_stock": {"label": "<?php echo $this->Ini->Nm_lang['lang_stock'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pw_estado": {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pw_categoria": {"label": "<?php echo $this->Ini->Nm_lang['lang_categoria'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "pw_empresa": new Array(),
    "pw_id": new Array(),
    "pw_sku": new Array(),
    "pw_producto_debi": new Array(),
    "pw_tipo": new Array(),
    "pw_descripcion": new Array(),
    "pw_descripcion_corta": new Array(),
    "pw_precio_regular": new Array(),
    "pw_estado_impuestos": new Array(),
    "pw_maneja_stock": new Array(),
    "pw_cantidad_stock": new Array(),
    "pw_estado": new Array(),
    "pw_categoria": new Array()
  };
  ajax_field_mult["pw_empresa"][1] = "pw_empresa";
  ajax_field_mult["pw_id"][1] = "pw_id";
  ajax_field_mult["pw_sku"][1] = "pw_sku";
  ajax_field_mult["pw_producto_debi"][1] = "pw_producto_debi";
  ajax_field_mult["pw_tipo"][1] = "pw_tipo";
  ajax_field_mult["pw_descripcion"][1] = "pw_descripcion";
  ajax_field_mult["pw_descripcion_corta"][1] = "pw_descripcion_corta";
  ajax_field_mult["pw_precio_regular"][1] = "pw_precio_regular";
  ajax_field_mult["pw_estado_impuestos"][1] = "pw_estado_impuestos";
  ajax_field_mult["pw_maneja_stock"][1] = "pw_maneja_stock";
  ajax_field_mult["pw_cantidad_stock"][1] = "pw_cantidad_stock";
  ajax_field_mult["pw_estado"][1] = "pw_estado";
  ajax_field_mult["pw_categoria"][1] = "pw_categoria";

  var ajax_field_id = {
    "pw_empresa": new Array("hidden_field_label_pw_empresa", "hidden_field_data_pw_empresa"),
    "pw_id": new Array("hidden_field_label_pw_id", "hidden_field_data_pw_id"),
    "pw_sku": new Array("hidden_field_label_pw_sku", "hidden_field_data_pw_sku"),
    "pw_producto_debi": new Array("hidden_field_label_pw_producto_debi", "hidden_field_data_pw_producto_debi"),
    "pw_tipo": new Array("hidden_field_label_pw_tipo", "hidden_field_data_pw_tipo"),
    "pw_descripcion": new Array("hidden_field_label_pw_descripcion", "hidden_field_data_pw_descripcion"),
    "pw_descripcion_corta": new Array("hidden_field_label_pw_descripcion_corta", "hidden_field_data_pw_descripcion_corta"),
    "pw_precio_regular": new Array("hidden_field_label_pw_precio_regular", "hidden_field_data_pw_precio_regular"),
    "pw_estado_impuestos": new Array("hidden_field_label_pw_estado_impuestos", "hidden_field_data_pw_estado_impuestos"),
    "pw_maneja_stock": new Array("hidden_field_label_pw_maneja_stock", "hidden_field_data_pw_maneja_stock"),
    "pw_cantidad_stock": new Array("hidden_field_label_pw_cantidad_stock", "hidden_field_data_pw_cantidad_stock"),
    "pw_estado": new Array("hidden_field_label_pw_estado", "hidden_field_data_pw_estado"),
    "pw_categoria": new Array("hidden_field_label_pw_categoria", "hidden_field_data_pw_categoria")
  };
  ...
  var ajax_read_only = {
    ...
    "pw_id": "on",
    "pw_sku": "off",
    "pw_producto_debi": "off",
    "pw_tipo": "off",
    "pw_descripcion": "off",
    "pw_descripcion_corta": "off",
    "pw_precio_regular": "off",
    "pw_estado_impuestos": "off",
    "pw_maneja_stock": "off",
    "pw_cantidad_stock": "off",
    "pw_estado": "off",
    "pw_categoria": "off"
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("pw_descripcion_corta" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
