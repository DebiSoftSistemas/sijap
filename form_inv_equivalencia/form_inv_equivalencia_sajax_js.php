  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_inv_equivalencia" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_inv_equivalencia_form();
	}
...
?>
  ...
  // ---------- Validate eq_id_
  function do_ajax_form_inv_equivalencia_validate_eq_id_(iNumLinha)
  {
    var nomeCampo_eq_id_ = "eq_id_" + iNumLinha;
    var var_eq_id_ = scAjaxGetFieldHidden(nomeCampo_eq_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_equivalencia_validate_eq_id_(var_eq_id_, iNumLinha, var_script_case_init, do_ajax_form_inv_equivalencia_validate_eq_id__cb);
  } // do_ajax_form_inv_equivalencia_validate_eq_id_

  function do_ajax_form_inv_equivalencia_validate_eq_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "eq_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "eq_id_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "eq_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "eq_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_equivalencia_validate_eq_id__cb

  // ---------- Validate eq_unidad_origen_
  function do_ajax_form_inv_equivalencia_validate_eq_unidad_origen_(iNumLinha)
  {
    var nomeCampo_eq_unidad_origen_ = "eq_unidad_origen_" + iNumLinha;
    var var_eq_unidad_origen_ = scAjaxGetFieldText(nomeCampo_eq_unidad_origen_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_equivalencia_validate_eq_unidad_origen_(var_eq_unidad_origen_, iNumLinha, var_script_case_init, do_ajax_form_inv_equivalencia_validate_eq_unidad_origen__cb);
  } // do_ajax_form_inv_equivalencia_validate_eq_unidad_origen_

  function do_ajax_form_inv_equivalencia_validate_eq_unidad_origen__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "eq_unidad_origen_" + iLineNumber;
    }
    else
    {
      sFieldValid = "eq_unidad_origen_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "eq_unidad_origen_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "eq_unidad_origen_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_equivalencia_validate_eq_unidad_origen__cb

  // ---------- Validate eq_factor_
  function do_ajax_form_inv_equivalencia_validate_eq_factor_(iNumLinha)
  {
    var nomeCampo_eq_factor_ = "eq_factor_" + iNumLinha;
    var var_eq_factor_ = scAjaxGetFieldText(nomeCampo_eq_factor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_equivalencia_validate_eq_factor_(var_eq_factor_, iNumLinha, var_script_case_init, do_ajax_form_inv_equivalencia_validate_eq_factor__cb);
  } // do_ajax_form_inv_equivalencia_validate_eq_factor_

  function do_ajax_form_inv_equivalencia_validate_eq_factor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "eq_factor_" + iLineNumber;
    }
    else
    {
      sFieldValid = "eq_factor_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "eq_factor_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "eq_factor_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_equivalencia_validate_eq_factor__cb

  // ---------- Validate eq_unidad_destino_
  function do_ajax_form_inv_equivalencia_validate_eq_unidad_destino_(iNumLinha)
  {
    var nomeCampo_eq_unidad_destino_ = "eq_unidad_destino_" + iNumLinha;
    var var_eq_unidad_destino_ = scAjaxGetFieldSelect(nomeCampo_eq_unidad_destino_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_equivalencia_validate_eq_unidad_destino_(var_eq_unidad_destino_, iNumLinha, var_script_case_init, do_ajax_form_inv_equivalencia_validate_eq_unidad_destino__cb);
  } // do_ajax_form_inv_equivalencia_validate_eq_unidad_destino_

  function do_ajax_form_inv_equivalencia_validate_eq_unidad_destino__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "eq_unidad_destino_" + iLineNumber;
    }
    else
    {
      sFieldValid = "eq_unidad_destino_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "eq_unidad_destino_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "eq_unidad_destino_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_equivalencia_validate_eq_unidad_destino__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_inv_equivalencia_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_inv_equivalencia_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_inv_equivalencia_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_inv_equivalencia_add_new_line_cb);
  } // do_ajax_form_inv_equivalencia_add_new_line

  function do_ajax_form_inv_equivalencia_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_inv_equivalencia_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_inv_equivalencia_backup_line(iNumLinha)
  {
    var var_eq_id_ = scAjaxGetFieldHidden("eq_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_equivalencia_backup_line(var_eq_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_inv_equivalencia_backup_line_cb);
  } // do_ajax_form_inv_equivalencia_backup_line

  function do_ajax_form_inv_equivalencia_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_inv_equivalencia_backup_line_cb

  function do_ajax_form_inv_equivalencia_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_inv_equivalencia_cancel_insert

  function do_ajax_form_inv_equivalencia_cancel_update(iSeqVert)
  {
    do_ajax_form_inv_equivalencia_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_inv_equivalencia_cancel_update

  function do_ajax_form_inv_equivalencia_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_inv_equivalencia_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_inv_equivalencia_table_refresh()
  {
    var var_eq_id_ = document.F2.eq_id_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_inv_equivalencia_table_refresh(var_eq_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_inv_equivalencia_table_refresh_cb);
  } //  do_ajax_form_inv_equivalencia_table_refresh

  function do_ajax_form_inv_equivalencia_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.eq_id_.value = scAjaxGetKeyValue("eq_id_");
    ...
    scAjaxAlert(do_ajax_form_inv_equivalencia_table_refresh_cb_after_alert);
  } // do_ajax_form_inv_equivalencia_table_refresh_cb
  function do_ajax_form_inv_equivalencia_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_inv_equivalencia_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_inv_equivalencia_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_inv_equivalencia_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_eq_id_ = scAjaxGetFieldHidden("eq_id_" + iNumLinha);
    var var_eq_unidad_origen_ = scAjaxGetFieldText("eq_unidad_origen_" + iNumLinha);
    var var_eq_factor_ = scAjaxGetFieldText("eq_factor_" + iNumLinha);
    var var_eq_unidad_destino_ = scAjaxGetFieldSelect("eq_unidad_destino_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_inv_equivalencia_submit_form(var_eq_id_, var_eq_unidad_origen_, var_eq_factor_, var_eq_unidad_destino_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_inv_equivalencia_submit_form_cb);
  } // do_ajax_form_inv_equivalencia_submit_form

  function do_ajax_form_inv_equivalencia_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("eq_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("eq_unidad_origen_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("eq_factor_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("eq_unidad_destino_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_inv_equivalencia_submit_form_cb_after_alert);
  } // do_ajax_form_inv_equivalencia_submit_form_cb
  function do_ajax_form_inv_equivalencia_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_inv_equivalencia_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_inv_equivalencia_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_inv_equivalencia_navigate_form, function() {});
    } else {
      perform_ajax_form_inv_equivalencia_navigate_form();
    }
  }

  function perform_ajax_form_inv_equivalencia_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_inv_equivalencia_cancel_insert(sc_form_inv_equivalencia_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("eq_id_" + iNavForm);
      scAjaxHideErrorDisplay("eq_unidad_origen_" + iNavForm);
      scAjaxHideErrorDisplay("eq_factor_" + iNavForm);
      scAjaxHideErrorDisplay("eq_unidad_destino_" + iNavForm);
    }
    var var_eq_id_ = document.F2.eq_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_inv_equivalencia_navigate_form(var_eq_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_inv_equivalencia_navigate_form_cb);
  } // do_ajax_form_inv_equivalencia_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_equivalencia']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_inv_equivalencia_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.eq_id_.value = scAjaxGetKeyValue("eq_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_inv_equivalencia_navigate_form_cb_after_alert);
  } // do_ajax_form_inv_equivalencia_navigate_form_cb
  function do_ajax_form_inv_equivalencia_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_inv_equivalencia_navigate_form_cb_after_alert

    function sc_form_inv_equivalencia_get_last_line_number()
    {
    ...
    } //sc_form_inv_equivalencia_get_last_line_number

  function sc_hide_form_inv_equivalencia_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "eq_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "eq_unidad_origen_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "eq_factor_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "eq_unidad_destino_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["eq_id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["eq_unidad_origen_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_unidad_origen'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["eq_factor_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_factor'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["eq_unidad_destino_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_unidad_destino'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["eq_id_"][iNumLinha] = "eq_id_" + iNumLinha;
    ajax_field_mult["eq_unidad_origen_"][iNumLinha] = "eq_unidad_origen_" + iNumLinha;
    ajax_field_mult["eq_factor_"][iNumLinha] = "eq_factor_" + iNumLinha;
    ajax_field_mult["eq_unidad_destino_"][iNumLinha] = "eq_unidad_destino_" + iNumLinha;
    ajax_field_id["eq_factor_" + iNumLinha] = new Array("hidden_field_label_eq_factor_", "hidden_field_data_eq_factor_" + iNumLinha);
    ajax_field_id["eq_unidad_destino_" + iNumLinha] = new Array("hidden_field_label_eq_unidad_destino_", "hidden_field_data_eq_unidad_destino_" + iNumLinha);
    ajax_error_count["eq_id_" + iNumLinha] = "off";
    ajax_error_count["eq_unidad_origen_" + iNumLinha] = "off";
    ajax_error_count["eq_factor_" + iNumLinha] = "off";
    ajax_error_count["eq_unidad_destino_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["eq_id_" + iNumLinha] = "on";
    ajax_read_only["eq_unidad_origen_" + iNumLinha] = "off";
    ajax_read_only["eq_factor_" + iNumLinha] = "off";
    ajax_read_only["eq_unidad_destino_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["eq_id_" + iNumLinha] = "on";
    ajax_read_only["eq_unidad_origen_" + iNumLinha] = "on";
    ajax_read_only["eq_factor_" + iNumLinha] = "on";
    ajax_read_only["eq_unidad_destino_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["eq_id_" + iNumLinha] = null;
    ajax_error_list["eq_unidad_origen_" + iNumLinha] = null;
    ajax_error_list["eq_factor_" + iNumLinha] = null;
    ajax_error_list["eq_unidad_destino_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "eq_id_": new Array(),
    "eq_unidad_origen_": new Array(),
    "eq_factor_": new Array(),
    "eq_unidad_destino_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["eq_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["eq_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["eq_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["eq_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["eq_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["eq_unidad_origen_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["eq_unidad_origen_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["eq_unidad_origen_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["eq_unidad_origen_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["eq_unidad_origen_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["eq_factor_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["eq_factor_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["eq_factor_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["eq_factor_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["eq_factor_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["eq_unidad_destino_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["eq_unidad_destino_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["eq_unidad_destino_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["eq_unidad_destino_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["eq_unidad_destino_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['eq_id_'])) ? $this->nmgp_cmp_readonly['eq_id_'] : 'on';
?>
    scAjaxFieldRead("eq_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['eq_unidad_origen_'])) ? $this->nmgp_cmp_readonly['eq_unidad_origen_'] : 'off';
?>
    scAjaxFieldRead("eq_unidad_origen_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['eq_factor_'])) ? $this->nmgp_cmp_readonly['eq_factor_'] : 'off';
?>
    scAjaxFieldRead("eq_factor_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['eq_unidad_destino_'])) ? $this->nmgp_cmp_readonly['eq_unidad_destino_'] : 'off';
?>
    scAjaxFieldRead("eq_unidad_destino_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("eq_id_" + iSeq, "on");
    scAjaxFieldRead("eq_unidad_origen_" + iSeq, "on");
    scAjaxFieldRead("eq_factor_" + iSeq, "on");
    scAjaxFieldRead("eq_unidad_destino_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["eq_id_" + iRow] || "on" == ajax_error_count["eq_unidad_origen_" + iRow] || "on" == ajax_error_count["eq_factor_" + iRow] || "on" == ajax_error_count["eq_unidad_destino_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_eq_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_eq_unidad_origen_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_eq_factor_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_eq_unidad_destino_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["eq_id_" + iRow] && "off" == ajax_error_count["eq_unidad_origen_" + iRow] && "off" == ajax_error_count["eq_factor_" + iRow] && "off" == ajax_error_count["eq_unidad_destino_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["eq_id_" + iRow] = "off";
        ajax_error_count["eq_unidad_origen_" + iRow] = "off";
        ajax_error_count["eq_factor_" + iRow] = "off";
        ajax_error_count["eq_unidad_destino_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_eq_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_eq_unidad_origen_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_eq_factor_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_eq_unidad_destino_" + iRow).removeClass("scFormErrorLine");
    }
  }
