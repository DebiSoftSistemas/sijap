...
$old_error_handler = set_error_handler("form_inv_equivalencia_scriptcase_error_handler");

function form_inv_equivalencia_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['form_inv_equivalencia']['contr_erro']) && $_SESSION['scriptcase']['form_inv_equivalencia']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_inv_equivalencia->contr_form_inv_equivalencia->Apl_com_erro = true;
            if ($inicial_form_inv_equivalencia->contr_form_inv_equivalencia->NM_ajax_flag)
            {
                $inicial_form_inv_equivalencia->contr_form_inv_equivalencia->NM_ajax_info['errList']['geral_form_inv_equivalencia'][] = $msg;
                return;
            }
            form_inv_equivalencia_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_inv_equivalencia_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_inv_equivalencia'])  && '' != $_SESSION['scriptcase']['error_icon']['form_inv_equivalencia'])  ? $_SESSION['scriptcase']['error_icon']['form_inv_equivalencia']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_inv_equivalencia']) && '' != $_SESSION['scriptcase']['error_span_title']['form_inv_equivalencia']) ? $_SESSION['scriptcase']['error_span_title']['form_inv_equivalencia'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_inv_equivalencia']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_inv_equivalencia']) ? $_SESSION['scriptcase']['error_icon_title']['form_inv_equivalencia'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_inv_equivalencia']['error_buffer'] .= ob_get_flush();
}
