...
<?php
   ...
   $Ord_Cmp = new grid_del_admin_empresas_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_del_admin_empresas_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_del_admin_empresas']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_del_admin_empresas']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['emp_logo'] = "on";
   $tab_def_campos['emp_logo'] = "emp_logo";
   $tab_labels["emp_logo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_del_admin_empresas']['labels']["emp_logo"])) ? $_SESSION['sc_session'][$sc_init]['grid_del_admin_empresas']['labels']["emp_logo"] : "" . $this->Nm_lang['lang_logotipo'] . "";
   $tab_ger_campos['emp_ruc'] = "on";
   $tab_def_campos['emp_ruc'] = "emp_ruc";
   $tab_labels["emp_ruc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_del_admin_empresas']['labels']["emp_ruc"])) ? $_SESSION['sc_session'][$sc_init]['grid_del_admin_empresas']['labels']["emp_ruc"] : "" . $this->Nm_lang['lang_ruc'] . "";
   $tab_ger_campos['emp_razon_social'] = "on";
   $tab_def_campos['emp_razon_social'] = "emp_razon_social";
   $tab_labels["emp_razon_social"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_del_admin_empresas']['labels']["emp_razon_social"])) ? $_SESSION['sc_session'][$sc_init]['grid_del_admin_empresas']['labels']["emp_razon_social"] : "" . $this->Nm_lang['lang_razon_social'] . "";
   $tab_ger_campos['emp_nombre_comercial'] = "on";
   $tab_def_campos['emp_nombre_comercial'] = "emp_nombre_comercial";
   $tab_labels["emp_nombre_comercial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_del_admin_empresas']['labels']["emp_nombre_comercial"])) ? $_SESSION['sc_session'][$sc_init]['grid_del_admin_empresas']['labels']["emp_nombre_comercial"] : "" . $this->Nm_lang['lang_nombre_comercial'] . "";
   $tab_ger_campos['emp_representante_legal'] = "on";
   $tab_def_campos['emp_representante_legal'] = "emp_representante_legal";
   $tab_labels["emp_representante_legal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_del_admin_empresas']['labels']["emp_representante_legal"])) ? $_SESSION['sc_session'][$sc_init]['grid_del_admin_empresas']['labels']["emp_representante_legal"] : "" . $this->Nm_lang['lang_nombre_representante'] . "";
   $tab_ger_campos['emp_direccion_matriz'] = "on";
   $tab_def_campos['emp_direccion_matriz'] = "emp_direccion_matriz";
   $tab_labels["emp_direccion_matriz"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_del_admin_empresas']['labels']["emp_direccion_matriz"])) ? $_SESSION['sc_session'][$sc_init]['grid_del_admin_empresas']['labels']["emp_direccion_matriz"] : "" . $this->Nm_lang['lang_direccion'] . "";
   $tab_ger_campos['emp_telefono'] = "on";
   $tab_def_campos['emp_telefono'] = "emp_telefono";
   $tab_labels["emp_telefono"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_del_admin_empresas']['labels']["emp_telefono"])) ? $_SESSION['sc_session'][$sc_init]['grid_del_admin_empresas']['labels']["emp_telefono"] : "" . $this->Nm_lang['lang_lot_telefono'] . "";
   $tab_ger_campos['emp_email'] = "on";
   $tab_def_campos['emp_email'] = "emp_email";
   $tab_labels["emp_email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_del_admin_empresas']['labels']["emp_email"])) ? $_SESSION['sc_session'][$sc_init]['grid_del_admin_empresas']['labels']["emp_email"] : "" . $this->Nm_lang['lang_email'] . "";
   $tab_ger_campos['emp_tipo_suscripcion'] = "on";
   $tab_def_campos['emp_tipo_suscripcion'] = "emp_tipo_suscripcion";
   $tab_labels["emp_tipo_suscripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_del_admin_empresas']['labels']["emp_tipo_suscripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_del_admin_empresas']['labels']["emp_tipo_suscripcion"] : "" . $this->Nm_lang['lang_tipo_suscripcion'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_del_admin_empresas']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_del_admin_empresas']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_del_admin_empresas']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_del_admin_empresas']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_del_admin_empresas']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_del_admin_empresas']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_del_admin_empresas']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_del_admin_empresas']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_del_admin_empresas']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_del_admin_empresas']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_del_admin_empresas']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_del_admin_empresas']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_del_admin_empresas_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_del_admin_empresas']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_del_admin_empresas']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_del_admin_empresas']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_del_admin_empresas']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_del_admin_empresas']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
