...
{
    db_conect_devel($_SESSION['scriptcase']['mnu_administracion']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['mnu_administracion']['glo_nm_path_prod'], 'SIJAP', 2); 
}
...
{ 
   $this->Db = db_conect_devel($_SESSION['scriptcase']['mnu_administracion']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['mnu_administracion']['glo_nm_path_prod'], 'SIJAP'); 
} 
else 
{ 
...
if (is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/form_del_conexion_debi_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/form_del_conexion_debi_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_del_conexion_debi']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['form_del_conexion_debi'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_del_conexion_debi']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_del_conexion_debi']) == "on")
{
    $mnu_administracion_menuData['data'] .= "item_34|..|" . $this->Nm_lang['lang_conexion_debi'] . "|mnu_administracion_form_php.php?sc_item_menu=item_34&sc_apl_menu=form_del_conexion_debi&sc_apl_link=" . urlencode($mnu_administracion_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_administracion']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[5] . "||" . $this->mnu_administracion_target('_self') . "|" . "\n";
}
else
{
    $mnu_administracion_menuData['data'] .= "item_34|..|" . $this->Nm_lang['lang_conexion_debi'] . "||||_self|disabled\n";
}
$mnu_administracion_menuData['data'] .= "item_12|.|" . $this->Nm_lang['lang_organizacion'] . "||" . $nm_var_hint[6] . "|grp__NM__ico__NM__orgamizacion.png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_del_empresa']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_del_empresa']) == "on")
{
    $mnu_administracion_menuData['data'] .= "item_4|..|" . $this->Nm_lang['lang_empresa'] . "|mnu_administracion_form_php.php?sc_item_menu=item_4&sc_apl_menu=form_del_empresa&sc_apl_link=" . urlencode($mnu_administracion_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_administracion']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[7] . "||" . $this->mnu_administracion_target('_self') . "|" . "\n";
}
else
{
...
{
    $mnu_administracion_menuData['data'] .= "item_5|..|" . $this->Nm_lang['lang_establecimiento'] . "|mnu_administracion_form_php.php?sc_item_menu=item_5&sc_apl_menu=grid_del_establecimiento&sc_apl_link=" . urlencode($mnu_administracion_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_administracion']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[8] . "||" . $this->mnu_administracion_target('_self') . "|" . "\n";
}
else
{
...
{
    $mnu_administracion_menuData['data'] .= "item_6|..|" . $this->Nm_lang['lang_punto_emision'] . "|mnu_administracion_form_php.php?sc_item_menu=item_6&sc_apl_menu=grid_del_punto_emision&sc_apl_link=" . urlencode($mnu_administracion_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_administracion']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[9] . "||" . $this->mnu_administracion_target('_self') . "|" . "\n";
}
else
{
    $mnu_administracion_menuData['data'] .= "item_6|..|" . $this->Nm_lang['lang_punto_emision'] . "||||_self|disabled\n";
}
$mnu_administracion_menuData['data'] .= "item_2|.|" . $this->Nm_lang['lang_usuario'] . "||" . $nm_var_hint[10] . "|grp__NM__ico__NM__usuario.png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_del_usuario']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_del_usuario']) == "on")
{
    $mnu_administracion_menuData['data'] .= "item_24|..|" . $this->Nm_lang['lang_usuario'] . "|mnu_administracion_form_php.php?sc_item_menu=item_24&sc_apl_menu=grid_del_usuario&sc_apl_link=" . urlencode($mnu_administracion_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_administracion']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[11] . "||" . $this->mnu_administracion_target('_self') . "|" . "\n";
}
else
{
...
{
    $mnu_administracion_menuData['data'] .= "item_31|..|" . $this->Nm_lang['lang_cargo'] . "|mnu_administracion_form_php.php?sc_item_menu=item_31&sc_apl_menu=form_sis_cargo&sc_apl_link=" . urlencode($mnu_administracion_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_administracion']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[12] . "||" . $this->mnu_administracion_target('_self') . "|" . "\n";
}
else
{
...
{
    $mnu_administracion_menuData['data'] .= "item_20|..|" . $this->Nm_lang['lang_roles'] . "|mnu_administracion_form_php.php?sc_item_menu=item_20&sc_apl_menu=grid_del_rol&sc_apl_link=" . urlencode($mnu_administracion_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_administracion']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[13] . "||" . $this->mnu_administracion_target('_self') . "|" . "\n";
}
else
{
    $mnu_administracion_menuData['data'] .= "item_20|..|" . $this->Nm_lang['lang_roles'] . "||||_self|disabled\n";
}
$mnu_administracion_menuData['data'] .= "item_3|.|" . $this->Nm_lang['lang_reporte'] . "||" . $nm_var_hint[14] . "|grp__NM__ico__NM__reportes.png|_self|\n";
...
$str_disabled = "N";
$str_link = "mnu_administracion_form_php.php?sc_item_menu=item_34&sc_apl_menu=form_del_conexion_debi&sc_apl_link=" . urlencode($mnu_administracion_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['mnu_administracion']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_del_conexion_debi']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_del_conexion_debi']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $mnu_administracion_menuData['data'][] = array(
        'label'    => "" . $this->Nm_lang['lang_conexion_debi'] . "",
        'level'    => "1",
        'link'     => $str_link,
        'hint'     => "" . $nm_var_hint[5] . "",
        'id'       => "item_34",
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['mnu_administracion']['glo_nm_path_imag_temp'] . "/sc_apl_default_SIJAP.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['mnu_administracion']['glo_nm_path_imag_temp'] . "/sc_apl_default_SIJAP.txt"));
    }
    if (isset($apl_def)) {
        ...
        if (isset($_COOKIE['sc_actual_lang_SIJAP'])) {
            $_SESSION['scriptcase']['mnu_administracion']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_SIJAP'];
        }
    }
}
