  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_cuentas_por_pagar" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_cuentas_por_pagar_form();
	}
...
?>
  ...
  // ---------- Validate cxp_fecha
  function do_ajax_form_del_cuentas_por_pagar_validate_cxp_fecha()
  {
    var nomeCampo_cxp_fecha = "cxp_fecha";
    var var_cxp_fecha = scAjaxGetFieldText(nomeCampo_cxp_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cuentas_por_pagar_validate_cxp_fecha(var_cxp_fecha, var_script_case_init, do_ajax_form_del_cuentas_por_pagar_validate_cxp_fecha_cb);
  } // do_ajax_form_del_cuentas_por_pagar_validate_cxp_fecha

  function do_ajax_form_del_cuentas_por_pagar_validate_cxp_fecha_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cuentas_por_pagar_validate_cxp_fecha_cb

  // ---------- Validate cxp_tipo_documento
  function do_ajax_form_del_cuentas_por_pagar_validate_cxp_tipo_documento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cuentas_por_pagar_validate_cxp_tipo_documento(var_cxp_tipo_documento, var_script_case_init, do_ajax_form_del_cuentas_por_pagar_validate_cxp_tipo_documento_cb);
  } // do_ajax_form_del_cuentas_por_pagar_validate_cxp_tipo_documento

  function do_ajax_form_del_cuentas_por_pagar_validate_cxp_tipo_documento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cuentas_por_pagar_validate_cxp_tipo_documento_cb

  // ---------- Validate cxp_documento
  function do_ajax_form_del_cuentas_por_pagar_validate_cxp_documento()
  {
    var nomeCampo_cxp_documento = "cxp_documento";
    var var_cxp_documento = scAjaxGetFieldText(nomeCampo_cxp_documento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cuentas_por_pagar_validate_cxp_documento(var_cxp_documento, var_script_case_init, do_ajax_form_del_cuentas_por_pagar_validate_cxp_documento_cb);
  } // do_ajax_form_del_cuentas_por_pagar_validate_cxp_documento

  function do_ajax_form_del_cuentas_por_pagar_validate_cxp_documento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cuentas_por_pagar_validate_cxp_documento_cb

  // ---------- Validate cxp_valor
  function do_ajax_form_del_cuentas_por_pagar_validate_cxp_valor()
  {
    var nomeCampo_cxp_valor = "cxp_valor";
    var var_cxp_valor = scAjaxGetFieldText(nomeCampo_cxp_valor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cuentas_por_pagar_validate_cxp_valor(var_cxp_valor, var_script_case_init, do_ajax_form_del_cuentas_por_pagar_validate_cxp_valor_cb);
  } // do_ajax_form_del_cuentas_por_pagar_validate_cxp_valor

  function do_ajax_form_del_cuentas_por_pagar_validate_cxp_valor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cuentas_por_pagar_validate_cxp_valor_cb

  // ---------- Validate cxp_contrato
  function do_ajax_form_del_cuentas_por_pagar_validate_cxp_contrato()
  {
    var nomeCampo_cxp_contrato = "cxp_contrato";
    var var_cxp_contrato = scAjaxGetFieldSelect(nomeCampo_cxp_contrato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cuentas_por_pagar_validate_cxp_contrato(var_cxp_contrato, var_script_case_init, do_ajax_form_del_cuentas_por_pagar_validate_cxp_contrato_cb);
  } // do_ajax_form_del_cuentas_por_pagar_validate_cxp_contrato

  function do_ajax_form_del_cuentas_por_pagar_validate_cxp_contrato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cuentas_por_pagar_validate_cxp_contrato_cb

  // ---------- Validate cxp_estado
  function do_ajax_form_del_cuentas_por_pagar_validate_cxp_estado()
  {
    var nomeCampo_cxp_estado = "cxp_estado";
    var var_cxp_estado = scAjaxGetFieldText(nomeCampo_cxp_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cuentas_por_pagar_validate_cxp_estado(var_cxp_estado, var_script_case_init, do_ajax_form_del_cuentas_por_pagar_validate_cxp_estado_cb);
  } // do_ajax_form_del_cuentas_por_pagar_validate_cxp_estado

  function do_ajax_form_del_cuentas_por_pagar_validate_cxp_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cuentas_por_pagar_validate_cxp_estado_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_cuentas_por_pagar_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_cuentas_por_pagar_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_del_cuentas_por_pagar_submit_form(var_cxp_fecha, var_cxp_tipo_documento, var_cxp_documento, var_cxp_valor, var_cxp_contrato, var_cxp_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_cuentas_por_pagar_submit_form_cb);
  } // do_ajax_form_del_cuentas_por_pagar_submit_form

  function do_ajax_form_del_cuentas_por_pagar_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_cuentas_por_pagar_submit_form_cb_after_alert);
  } // do_ajax_form_del_cuentas_por_pagar_submit_form_cb
  function do_ajax_form_del_cuentas_por_pagar_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_cuentas_por_pagar_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_cuentas_por_pagar_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_del_cuentas_por_pagar_navigate_form, function() {});
    } else {
      perform_ajax_form_del_cuentas_por_pagar_navigate_form();
    }
  }

  function perform_ajax_form_del_cuentas_por_pagar_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_del_cuentas_por_pagar_navigate_form(var_cxp_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_cuentas_por_pagar_navigate_form_cb);
  } // do_ajax_form_del_cuentas_por_pagar_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cuentas_por_pagar']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_cuentas_por_pagar_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_cuentas_por_pagar_navigate_form_cb_after_alert);
  } // do_ajax_form_del_cuentas_por_pagar_navigate_form_cb
  function do_ajax_form_del_cuentas_por_pagar_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_del_cuentas_por_pagar_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_cuentas_por_pagar_navigate_form_cb_after_alert

  function sc_hide_form_del_cuentas_por_pagar_form()
  {
