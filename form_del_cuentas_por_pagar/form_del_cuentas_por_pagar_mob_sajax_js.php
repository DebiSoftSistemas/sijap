  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_cuentas_por_pagar_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_cuentas_por_pagar_mob_form();
	}
...
?>
  ...
  // ---------- Validate cxp_fecha
  function do_ajax_form_del_cuentas_por_pagar_mob_validate_cxp_fecha()
  {
    var nomeCampo_cxp_fecha = "cxp_fecha";
    var var_cxp_fecha = scAjaxGetFieldText(nomeCampo_cxp_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cuentas_por_pagar_mob_validate_cxp_fecha(var_cxp_fecha, var_script_case_init, do_ajax_form_del_cuentas_por_pagar_mob_validate_cxp_fecha_cb);
  } // do_ajax_form_del_cuentas_por_pagar_mob_validate_cxp_fecha

  function do_ajax_form_del_cuentas_por_pagar_mob_validate_cxp_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cxp_fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cuentas_por_pagar_mob_validate_cxp_fecha_cb

  // ---------- Validate cxp_tipo_documento
  function do_ajax_form_del_cuentas_por_pagar_mob_validate_cxp_tipo_documento()
  {
    var nomeCampo_cxp_tipo_documento = "cxp_tipo_documento";
    var var_cxp_tipo_documento = scAjaxGetFieldSelect(nomeCampo_cxp_tipo_documento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cuentas_por_pagar_mob_validate_cxp_tipo_documento(var_cxp_tipo_documento, var_script_case_init, do_ajax_form_del_cuentas_por_pagar_mob_validate_cxp_tipo_documento_cb);
  } // do_ajax_form_del_cuentas_por_pagar_mob_validate_cxp_tipo_documento

  function do_ajax_form_del_cuentas_por_pagar_mob_validate_cxp_tipo_documento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cxp_tipo_documento";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cuentas_por_pagar_mob_validate_cxp_tipo_documento_cb

  // ---------- Validate cxp_documento
  function do_ajax_form_del_cuentas_por_pagar_mob_validate_cxp_documento()
  {
    var nomeCampo_cxp_documento = "cxp_documento";
    var var_cxp_documento = scAjaxGetFieldText(nomeCampo_cxp_documento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cuentas_por_pagar_mob_validate_cxp_documento(var_cxp_documento, var_script_case_init, do_ajax_form_del_cuentas_por_pagar_mob_validate_cxp_documento_cb);
  } // do_ajax_form_del_cuentas_por_pagar_mob_validate_cxp_documento

  function do_ajax_form_del_cuentas_por_pagar_mob_validate_cxp_documento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cxp_documento";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cuentas_por_pagar_mob_validate_cxp_documento_cb

  // ---------- Validate cxp_valor
  function do_ajax_form_del_cuentas_por_pagar_mob_validate_cxp_valor()
  {
    var nomeCampo_cxp_valor = "cxp_valor";
    var var_cxp_valor = scAjaxGetFieldText(nomeCampo_cxp_valor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cuentas_por_pagar_mob_validate_cxp_valor(var_cxp_valor, var_script_case_init, do_ajax_form_del_cuentas_por_pagar_mob_validate_cxp_valor_cb);
  } // do_ajax_form_del_cuentas_por_pagar_mob_validate_cxp_valor

  function do_ajax_form_del_cuentas_por_pagar_mob_validate_cxp_valor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cxp_valor";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cuentas_por_pagar_mob_validate_cxp_valor_cb

  // ---------- Validate cxp_contrato
  function do_ajax_form_del_cuentas_por_pagar_mob_validate_cxp_contrato()
  {
    var nomeCampo_cxp_contrato = "cxp_contrato";
    var var_cxp_contrato = scAjaxGetFieldSelect(nomeCampo_cxp_contrato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cuentas_por_pagar_mob_validate_cxp_contrato(var_cxp_contrato, var_script_case_init, do_ajax_form_del_cuentas_por_pagar_mob_validate_cxp_contrato_cb);
  } // do_ajax_form_del_cuentas_por_pagar_mob_validate_cxp_contrato

  function do_ajax_form_del_cuentas_por_pagar_mob_validate_cxp_contrato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cxp_contrato";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cuentas_por_pagar_mob_validate_cxp_contrato_cb

  // ---------- Validate cxp_estado
  function do_ajax_form_del_cuentas_por_pagar_mob_validate_cxp_estado()
  {
    var nomeCampo_cxp_estado = "cxp_estado";
    var var_cxp_estado = scAjaxGetFieldText(nomeCampo_cxp_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_cuentas_por_pagar_mob_validate_cxp_estado(var_cxp_estado, var_script_case_init, do_ajax_form_del_cuentas_por_pagar_mob_validate_cxp_estado_cb);
  } // do_ajax_form_del_cuentas_por_pagar_mob_validate_cxp_estado

  function do_ajax_form_del_cuentas_por_pagar_mob_validate_cxp_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cxp_estado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_cuentas_por_pagar_mob_validate_cxp_estado_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_cuentas_por_pagar_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_cuentas_por_pagar_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_cxp_fecha = scAjaxGetFieldText("cxp_fecha");
    var var_cxp_tipo_documento = scAjaxGetFieldSelect("cxp_tipo_documento");
    var var_cxp_documento = scAjaxGetFieldText("cxp_documento");
    var var_cxp_valor = scAjaxGetFieldText("cxp_valor");
    var var_cxp_contrato = scAjaxGetFieldSelect("cxp_contrato");
    var var_cxp_estado = scAjaxGetFieldText("cxp_estado");
    var var_cxp_id = scAjaxGetFieldText("cxp_id");
    ...
    scAjaxProcOn();
    x_ajax_form_del_cuentas_por_pagar_mob_submit_form(var_cxp_fecha, var_cxp_tipo_documento, var_cxp_documento, var_cxp_valor, var_cxp_contrato, var_cxp_estado, var_cxp_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_cuentas_por_pagar_mob_submit_form_cb);
  } // do_ajax_form_del_cuentas_por_pagar_mob_submit_form

  function do_ajax_form_del_cuentas_por_pagar_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_cuentas_por_pagar_mob_submit_form_cb_after_alert);
  } // do_ajax_form_del_cuentas_por_pagar_mob_submit_form_cb
  function do_ajax_form_del_cuentas_por_pagar_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_cuentas_por_pagar_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_cuentas_por_pagar_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_del_cuentas_por_pagar_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_del_cuentas_por_pagar_mob_navigate_form();
    }
  }

  function perform_ajax_form_del_cuentas_por_pagar_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    var var_cxp_id = document.F2.cxp_id.value;
    ...
    scAjaxProcOn();
    x_ajax_form_del_cuentas_por_pagar_mob_navigate_form(var_cxp_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_cuentas_por_pagar_mob_navigate_form_cb);
  } // do_ajax_form_del_cuentas_por_pagar_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_cuentas_por_pagar_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_cuentas_por_pagar_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.cxp_id.value = scAjaxGetKeyValue("cxp_id");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_cuentas_por_pagar_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_del_cuentas_por_pagar_mob_navigate_form_cb
  function do_ajax_form_del_cuentas_por_pagar_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_del_cuentas_por_pagar_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_cuentas_por_pagar_mob_navigate_form_cb_after_alert

  function sc_hide_form_del_cuentas_por_pagar_mob_form()
  {
  ...
  ajax_field_list[0] = "cxp_fecha";
  ajax_field_list[1] = "cxp_tipo_documento";
  ajax_field_list[2] = "cxp_documento";
  ajax_field_list[3] = "cxp_valor";
  ajax_field_list[4] = "cxp_contrato";
  ajax_field_list[5] = "cxp_estado";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "cxp_fecha": {"label": "<?php echo $this->Ini->Nm_lang['lang_fecha'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "cxp_tipo_documento": {"label": "<?php echo $this->Ini->Nm_lang['lang_tipo_comprobante'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "cxp_documento": {"label": "<?php echo $this->Ini->Nm_lang['lang_lot_documento'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "cxp_valor": {"label": "<?php echo $this->Ini->Nm_lang['lang_valor'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "cxp_contrato": {"label": "<?php echo $this->Ini->Nm_lang['lang_contrato'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "cxp_estado": {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    "cxp_fecha": new Array(),
    "cxp_tipo_documento": new Array(),
    "cxp_documento": new Array(),
    "cxp_valor": new Array(),
    "cxp_contrato": new Array(),
    "cxp_estado": new Array()
  };
  ajax_field_mult["cxp_fecha"][1] = "cxp_fecha";
  ajax_field_mult["cxp_tipo_documento"][1] = "cxp_tipo_documento";
  ajax_field_mult["cxp_documento"][1] = "cxp_documento";
  ajax_field_mult["cxp_valor"][1] = "cxp_valor";
  ajax_field_mult["cxp_contrato"][1] = "cxp_contrato";
  ajax_field_mult["cxp_estado"][1] = "cxp_estado";

  var ajax_field_id = {
    "cxp_fecha": new Array("hidden_field_label_cxp_fecha", "hidden_field_data_cxp_fecha"),
    "cxp_tipo_documento": new Array("hidden_field_label_cxp_tipo_documento", "hidden_field_data_cxp_tipo_documento"),
    "cxp_documento": new Array("hidden_field_label_cxp_documento", "hidden_field_data_cxp_documento"),
    "cxp_valor": new Array("hidden_field_label_cxp_valor", "hidden_field_data_cxp_valor"),
    "cxp_contrato": new Array("hidden_field_label_cxp_contrato", "hidden_field_data_cxp_contrato"),
    "cxp_estado": new Array("hidden_field_label_cxp_estado", "hidden_field_data_cxp_estado")
  };

  var ajax_read_only = {
    "cxp_fecha": "on",
    "cxp_tipo_documento": "on",
    "cxp_documento": "on",
    "cxp_valor": "on",
    "cxp_contrato": "off",
    "cxp_estado": "on"
