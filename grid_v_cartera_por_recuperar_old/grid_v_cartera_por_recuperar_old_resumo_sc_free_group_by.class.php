...
SCEOT;
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['arr_total']['cl_identificacion'] = $this->array_total_cl_identificacion;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['arr_total']['pro_descripcion'] = $this->array_total_pro_descripcion;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['arr_total']['op_estado'] = $this->array_total_op_estado;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['labels']['cl_identificacion'] = $Lab_cl_identificacion; 
       $prep_field['pro_descripcion'] = $Lab_pro_descripcion;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['labels']['pro_descripcion'] = $Lab_pro_descripcion; 
       $prep_field['op_estado'] = $Lab_op_estado;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['labels']['op_estado'] = $Lab_op_estado; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
...
{ 
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Gb_Free_cmp']))
      {
   ...
   function adiciona_registro($sum_do_subtotal, $sum_do_valor_iva, $sum_do_total, $quebra_periodo, $quebra_mes, $quebra_cl_identificacion, $quebra_pro_descripcion, $quebra_op_estado, $quebra_periodo_orig, $quebra_mes_orig, $quebra_cl_identificacion_orig, $quebra_pro_descripcion_orig, $quebra_op_estado_orig)
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
