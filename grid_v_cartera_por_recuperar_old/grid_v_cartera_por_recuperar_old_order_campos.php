...
<?php
   ...
   $Ord_Cmp = new grid_v_cartera_por_recuperar_old_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_v_cartera_por_recuperar_old_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["periodo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['labels']["periodo"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['labels']["periodo"] : "" . $this->Nm_lang['lang_periodo'] . "";
   $tab_ger_campos['mes'] = "on";
   $tab_def_campos['mes'] = "mes";
   $tab_labels["mes"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['labels']["mes"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['labels']["mes"] : "" . $this->Nm_lang['lang_srch_mnth'] . "";
   $tab_ger_campos['cl_identificacion'] = "on";
   $tab_def_campos['cl_identificacion'] = "cl_identificacion";
   $tab_labels["cl_identificacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['labels']["cl_identificacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['labels']["cl_identificacion"] : "" . $this->Nm_lang['lang_lot_identificacion'] . "";
   $tab_ger_campos['cl_nombre'] = "on";
   $tab_def_campos['cl_nombre'] = "cl_nombre";
   $tab_labels["cl_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['labels']["cl_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['labels']["cl_nombre"] : "" . $this->Nm_lang['lang_cliente'] . "";
   $tab_ger_campos['op_comentario'] = "on";
   $tab_def_campos['op_comentario'] = "op_comentario";
   $tab_labels["op_comentario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['labels']["op_comentario"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['labels']["op_comentario"] : "" . $this->Nm_lang['lang_comentario'] . "";
   $tab_ger_campos['pro_descripcion'] = "on";
   $tab_def_campos['pro_descripcion'] = "pro_descripcion";
   $tab_labels["pro_descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['labels']["pro_descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['labels']["pro_descripcion"] : "" . $this->Nm_lang['lang_producto'] . "";
   $tab_ger_campos['do_subtotal'] = "on";
   $tab_def_campos['do_subtotal'] = "do_subtotal";
   $tab_labels["do_subtotal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['labels']["do_subtotal"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['labels']["do_subtotal"] : "" . $this->Nm_lang['lang_subtotal'] . "";
   $tab_ger_campos['do_valor_iva'] = "on";
   $tab_def_campos['do_valor_iva'] = "do_valor_iva";
   $tab_labels["do_valor_iva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['labels']["do_valor_iva"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['labels']["do_valor_iva"] : "" . $this->Nm_lang['lang_iva'] . "";
   $tab_ger_campos['do_total'] = "on";
   $tab_def_campos['do_total'] = "do_total";
   $tab_labels["do_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['labels']["do_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['labels']["do_total"] : "" . $this->Nm_lang['lang_total'] . "";
   $tab_ger_campos['op_estado'] = "on";
   $tab_def_campos['op_estado'] = "op_estado";
   $tab_labels["op_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['labels']["op_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['labels']["op_estado"] : "" . $this->Nm_lang['lang_estado'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_v_cartera_por_recuperar_old_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar_old']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
