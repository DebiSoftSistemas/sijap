<?php
@session_start() ;
$_SESSION['scriptcase']['grid_v_cartera_por_recuperar_old']['sc_process_barr'] = true;
require_once('../grid_v_cartera_por_recuperar_old/index.php');
unset($_SESSION['scriptcase']['grid_v_cartera_por_recuperar_old']['sc_process_barr']);
$ExportCtrl = new grid_v_cartera_por_recuperar_old_export_control;
$ExportCtrl->Export_barr();

class grid_v_cartera_por_recuperar_old_export_control
{
