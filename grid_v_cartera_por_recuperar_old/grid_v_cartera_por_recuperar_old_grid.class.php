<?php
class grid_v_cartera_por_recuperar_old_grid
{
   var $Ini;
   var $Erro;
   var $Db;
   ...
   var $count_periodo;
   var $sum_periodo_do_subtotal;
   var $sum_periodo_do_valor_iva;
   var $sum_periodo_do_total;
   var $mes_Old;
   var $arg_sum_mes;
   var $Label_mes;
   var $sc_proc_quebra_mes;
   var $count_mes;
   var $sum_mes_do_subtotal;
   var $sum_mes_do_valor_iva;
   var $sum_mes_do_total;
...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_por_recuperar_old']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_por_recuperar_old']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_por_recuperar_old']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['usr_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['usr_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['usr_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['grid_pesq'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['grid_pesq'] = array();
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['charts_html'] = '';
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida'])
   { 
   ...
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida'])
       { 
           include_once($this->Ini->path_embutida . "grid_v_cartera_por_recuperar_old/" . $this->Ini->Apl_resumo); 
       } 
       else 
       { 
           include_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo); 
       } 
       $this->Res         = new grid_v_cartera_por_recuperar_old_resumo();
       $this->Res->Db     = $this->Db;
       $this->Res->Erro   = $this->Erro;
       $this->Res->Ini    = $this->Ini;
       $this->Res->Lookup = $this->Lookup;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['pdf_res'])
       {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['proc_pdf_vert'])
            {
            } 
            else
            {
       ...
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_v_cartera_por_recuperar_old'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'];
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_top();
       } 
       if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao_print'] != 'print')
       { 
           if ($this->Ini->grid_search_change_fil)
           { 
               $seq_search = 1;
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['grid_pesq'] as $cmp => $def)
               {
                  $Seq_grid      = $seq_search;
                  $Cmp_grid      = $cmp;
       ...
       unset ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['save_grid']);
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['pdf_res'] && (!isset($_GET['flash_graf']) || 'chart' != $_GET['flash_graf']))
       {
           $this->grid();
       }
       if ($nmgrp_apl_opcao != "pdf")
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['print_all'] && empty($this->nm_grid_sem_reg) && ($Gera_res || $Gera_graf))
       { 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] == "pdf")
       { 
           if (isset($_GET['flash_graf']) && 'chart' == $_GET['flash_graf'])
           {
               $this->Res->monta_resumo(true);
               require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
               $this->Graf  = new grid_v_cartera_por_recuperar_old_grafico();
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] == "pdf")
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] == "pdf")
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] = "igual";
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'];
 }
...
//
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['orig_pesq'] = "grid";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['Ind_lig_mult'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['Ind_lig_mult'] = 0;
   }
   $this->Img_embbed      = false;
   $this->nm_data         = new nm_data("es");
   $this->pdf_label_group = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opc_pdf']['label_group'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opc_pdf']['label_group'] : "N";
   $this->pdf_all_cab     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opc_pdf']['all_cab']))     ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opc_pdf']['all_cab'] : "S";
   $this->pdf_all_label   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opc_pdf']['all_label']))   ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opc_pdf']['all_label'] : "S";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opc_liga']['fix_top'])) {
       $this->Fix_bar_top = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opc_liga']['fix_top'] == "S") ? true : false;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opc_liga']['fix_bot'])) {
       $this->Fix_bar_bottom = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opc_liga']['fix_bot'] == "S") ? true : false;
   }
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "grid_v_cartera_por_recuperar_old/grid_v_cartera_por_recuperar_old_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   foreach ($NM_css as $cada_css)
   {
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['doc_word'])
       { 
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['pesq_tab_label']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['pesq_tab_label'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['pesq_tab_label'] .= "periodo?#?" . "" . $this->Ini->Nm_lang['lang_periodo'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['pesq_tab_label'] .= "mes?#?" . "" . $this->Ini->Nm_lang['lang_srch_mnth'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['pesq_tab_label'] .= "cl_nombre?#?" . "" . $this->Ini->Nm_lang['lang_cliente'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['pesq_tab_label'] .= "cl_identificacion?#?" . "" . $this->Ini->Nm_lang['lang_lot_identificacion'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['pesq_tab_label'] .= "pro_descripcion?#?" . "" . $this->Ini->Nm_lang['lang_producto'] . "" . "?@?";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['grid_search_add']))
   {
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['pesq_tab_label'];
       ...
       $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['grid_search_add']['seq'];
       $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['grid_search_add']['cmp'];
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['grid_search_add']);
       exit;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida'] || $this->Ini->Embutida_iframe)
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['force_toolbar']);
   } 
       $this->Tem_tab_vert = false;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Ind_Groupby'] == "sc_free_group_by")
   {
       if (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Gb_Free_cmp']) > 1)
       {
           $this->width_tabula_quebra  = (((count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Gb_Free_cmp']) - 1) * 13) + 3) . "px";
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Ind_Groupby'] == "Mensual")
   {
       $this->width_tabula_quebra  = "16px";
       $this->width_tabula_display = "''";
       $this->Tem_tab_vert = true;
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_por_recuperar_old']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_por_recuperar_old']['lig_edit'] != '')
   {
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_por_recuperar_old']['lig_edit'] == "on")  {$_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_por_recuperar_old']['lig_edit'] = "S";}
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_por_recuperar_old']['lig_edit'] == "off") {$_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_por_recuperar_old']['lig_edit'] = "N";}
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_por_recuperar_old']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['mostra_edit'] = "N";
       }
   }
   if ($this->Ini->SC_Link_View || ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opc_psq'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['psq_edit'] == 'N'))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['mostra_edit'] = "N";
   }
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ind_tree'] = 0;
   }
   elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['emb_tree_no']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['emb_tree_no'])
   { 
       $this->NM_emb_tree_no = true; 
   }
   $this->aba_iframe = false;
   $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['print_all'];
   if ($this->Print_All)
   {
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("grid_v_cartera_por_recuperar_old", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_por_recuperar_old']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_por_recuperar_old']['btn_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_por_recuperar_old']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
       {
           $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
       }
   }
   $this->Proc_link_res = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['where_resumo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['where_resumo'])) 
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['doc_word'] || $this->Ini->sc_export_ajax_img)
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['where_pesq_ant'];  
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['campos_busca']))
   { 
       $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['campos_busca'];
   ...
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['where_pesq_filtro'];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] = "muda_qt_linhas";
   } 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['dashboard_info']['maximized']) {
       $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['dashboard_info']['dashboard_app'];
       if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_v_cartera_por_recuperar_old'])) {
           $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_v_cartera_por_recuperar_old'];
   ...
   if ($this->Ini->Embutida_iframe) {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['sub_cons_iframe_btns'] as $BTN => $BTN_opc) {
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "grid_v_cartera_por_recuperar_old/grid_v_cartera_por_recuperar_old_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "grid_v_cartera_por_recuperar_old_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   $this->Tot         = new grid_v_cartera_por_recuperar_old_total($this->Ini->sc_page);
   $this->Tot->Db     = $this->Db;
   $this->Tot->Erro   = $this->Erro;
   $this->Tot->Ini    = $this->Ini;
   $this->Tot->Lookup = $this->Lookup;
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['qt_lin_grid'] = 10;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_por_recuperar_old']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_por_recuperar_old']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_por_recuperar_old']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_por_recuperar_old']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_por_recuperar_old']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_por_recuperar_old']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_por_recuperar_old']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_por_recuperar_old']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['qt_lin_grid']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Ind_Groupby'] == "sc_free_group_by") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_select']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_select'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_select_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_select']; 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Ind_Groupby'] == "Mensual") 
   {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Ind_Groupby'] == "sc_free_group_by") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_quebra'] = array(); 
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Gb_Free_sql'] as $cmp_var => $resto)
           {
               foreach ($resto as $SC_Sql_col => $SC_Sql_order)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_quebra'][$cmp_var][$SC_Sql_col] = $SC_Sql_order;
               }
           }
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Ind_Groupby'] == "Mensual") 
   {
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_quebra'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_quebra']['periodo']["periodo"] = "asc"; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_quebra']['mes']["mes"] = "asc"; 
       } 
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] = "inicio" ;  
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_grid'] = ""; 
                       $ordem = ($ordem == "asc") ? "desc" : "asc";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['prim_cons'] || !empty($nmgp_parms))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['prim_cons'] = false;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['where_orig'] = " where (op_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "' and op_estado not in ('P','N'))";  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['where_pesq_ant']    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['cond_pesq']         = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['where_pesq_filtro'] = "";
   }   
   if  (!empty($this->nm_where_dinamico)) 
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['where_pesq_filtro'];
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao']       = "igual" ; 
...
// 
   ...
   $this->sum_periodo_do_subtotal = 0;
   $this->sum_periodo_do_valor_iva = 0;
   $this->sum_periodo_do_total = 0;
   $this->arg_sum_mes = "";
   $this->count_mes = 0;
   $this->sum_mes_do_subtotal = 0;
   $this->sum_mes_do_valor_iva = 0;
   $this->sum_mes_do_total = 0;
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['tot_geral'][1] ;  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] == "final" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['qt_reg_grid'] == "all") 
   { 
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['tot_geral'][1] ;  
       $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['tot_geral'][1];
   } 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['contr_total_geral'] = "NAO";
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['sc_total']);
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['contr_array_resumo']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['contr_array_resumo'] = "NAO";
       } 
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['tot_geral'][1] ;  
   $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['tot_geral'][1];
   ...
   { 
       ...
       $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['where_pesq']; 
       if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['where_pesq'])) 
       { 
           $nmgp_select .= " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['where_resumo']; 
       } 
       else
       { 
           $nmgp_select .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['where_resumo'] . ")"; 
       } 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['sc_total'] = $rt_grid->fields[0];  
       
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
   {
       $this->Ini->Qtd_reg_ajax_grid = $this->count_ger;
   }
   else
   {
       $this->Ini->Qtd_reg_ajax_grid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['qt_reg_grid'];
   }
//----- 
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
   { 
       $nmgp_select = "SELECT periodo, mes, cl_identificacion, cl_nombre, op_comentario, pro_descripcion, do_subtotal, do_valor_iva, do_total, op_estado, op_operacion, op_empresa, dec_nombre, cl_telefono, cl_email, cl_direccion, pro_codigo from " . $this->Ini->nm_tabela; 
   } 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_desc']; 
   } 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       ...
       $this->op_comentario = $this->rs_grid->fields[4] ;  
       $this->pro_descripcion = $this->rs_grid->fields[5] ;  
       $this->do_subtotal = $this->rs_grid->fields[6] ;  
       $this->do_subtotal = (string)$this->do_subtotal;
       $this->do_valor_iva = $this->rs_grid->fields[7] ;  
       $this->do_valor_iva = (string)$this->do_valor_iva;
       $this->do_total = $this->rs_grid->fields[8] ;  
       $this->do_total = (string)$this->do_total;
       $this->op_estado = $this->rs_grid->fields[9] ;  
       $this->op_operacion = $this->rs_grid->fields[10] ;  
       $this->op_operacion = (string)$this->op_operacion;
       $this->op_empresa = $this->rs_grid->fields[11] ;  
       $this->dec_nombre = $this->rs_grid->fields[12] ;  
       $this->cl_telefono = $this->rs_grid->fields[13] ;  
       $this->cl_email = $this->rs_grid->fields[14] ;  
       $this->cl_direccion = $this->rs_grid->fields[15] ;  
       $this->pro_codigo = $this->rs_grid->fields[16] ;  
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Ind_Groupby'] == "sc_free_group_by") 
       {
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Gb_Free_cmp'] as $cmp => $sql)
           {
               $Cmp_orig   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Gb_Free_orig'][$cmp])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Gb_Free_orig'][$cmp] : $cmp;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Ind_Groupby'] == "Mensual") 
       {
           ...
           $this->quebra_periodo_Mensual($this->periodo) ; 
           $this->mes_Old = $this->mes ; 
           $this->quebra_mes_Mensual($this->periodo, $this->mes) ; 
       }
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['final']; 
   ...
   $this->NM_hidden_filters = ($this->Ini->Embutida_iframe && !empty($this->nm_grid_sem_reg) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['initialize']) ? true : false;
   $this->nmgp_reg_inicial  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['final'] + 1;
   $this->nmgp_reg_final    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['qt_reg_grid'];
   $this->nmgp_reg_final    = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['doc_word'] && !$this->Ini->sc_export_ajax)
       {
           require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
           $this->pb = new scProgressBar();
           $this->pb->setRoot($this->Ini->root);
           $this->pb->setDir($_SESSION['scriptcase']['grid_v_cartera_por_recuperar_old']['glo_nm_path_imag_temp'] . "/");
           $this->pb->setProgressbarMd5($_GET['pbmd5']);
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['word_return']);
       ...
       if ($this->Ini->Proc_print && $this->Ini->Export_html_zip  && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['print_return']);
           $this->pb->setTotalSteps($this->count_ger);
       }
       if (!$this->Ini->sc_export_ajax && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<HEAD>
 <TITLE>Cartera por Recuperar :: PDF</TITLE>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['pivot_charts']) : 0;
           ...
           if (-1 < $this->progress_grid)
           {
               ...
               grid_v_cartera_por_recuperar_old_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
               grid_v_cartera_por_recuperar_old_pdf_progress_call($this->Ini->path_js   . "\n", $this->Ini->Nm_lang);
               grid_v_cartera_por_recuperar_old_pdf_progress_call($this->Ini->path_prod . "/img/\n", $this->Ini->Nm_lang);
               grid_v_cartera_por_recuperar_old_pdf_progress_call($this->progress_tot   . "\n", $this->Ini->Nm_lang);
               ...
               grid_v_cartera_por_recuperar_old_pdf_progress_call($this->progress_tot . "_#NM#_" . "1_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
       ...
       $nm_saida->saida("  <HEAD>\r\n");
       $nm_saida->saida("   <TITLE>Cartera por Recuperar</TITLE>\r\n");
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida'] && $this->NM_opcao != "pdf") {
           $nm_saida->saida("   <link rel=\"shortcut icon\" href=\"../_lib/img/usr__NM__img__NM__favicon.png\">\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ajax_nav'] && !$this->Ini->sc_export_ajax)
       { 
           ...
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_v_cartera_por_recuperar_old_jquery_2643.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_v_cartera_por_recuperar_old_ajax.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_v_cartera_por_recuperar_old_message.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida']) {  
        ...
        <link rel='stylesheet' href='../_lib/lib/css/nm_mobile.css' type='text/css'/>
          <?php }
           ...
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['qt_reg_grid']) . ";\r\n");
           }
           ...
           $nm_saida->saida("    {\r\n");
           $nm_saida->saida("        let cells = $(\".sc-ui-grid-header-row-grid_v_cartera_por_recuperar_old-1\").find(\"td\");\r\n");
           ...
           $nm_saida->saida("        rows = $(\".sc-ui-grid-header-row-grid_v_cartera_por_recuperar_old-1\");\r\n");
           ...
           $nm_saida->saida("   var gridHeaders = $(\".sc-ui-grid-header-row-grid_v_cartera_por_recuperar_old-1\"), headerDisplayed = true;\r\n");
           ...
           $nm_saida->saida("   tableOriginal = document.getElementById(\"sc-ui-grid-body-4df79db5\");\r\n");
           ...
           if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao_print'] != 'print' && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['grid_pesq']))
           { 
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ancor_save']);
           }
           if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
           {
...
$nm_saida->saida("}\r\n");
       ...
       $nm_saida->saida("<style type=\"text/css\">\r\n");
       $nm_saida->saida("</style>\r\n");
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['num_css']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['num_css'] = rand(0, 1000);
       }
       $write_css = true;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida'] && !$this->Print_All && $this->NM_opcao != "print" && $this->NM_opcao != "pdf")
       {
           $write_css = false;
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida_pdf']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida_pdf'])
       {
           $write_css = true;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_cartera_por_recuperar_old_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida'])
       {
 ...
 { 
       ...
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_cartera_por_recuperar_old_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_grid_v_cartera_por_recuperar_old_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != "pdf") {
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_v_cartera_por_recuperar_old/grid_v_cartera_por_recuperar_old_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['proc_pdf_vert'])
  {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           ...
           if ($Pos1 !== false && $Pos2 !== false) {
               ...
               $cada_css = ".grid_v_cartera_por_recuperar_old_" . substr(trim($Tag[0]), 1);
               if (isset($Tag[1])) {
                   $cada_css .= ", .grid_v_cartera_por_recuperar_old_" . substr(trim($Tag[1]), 1);
               }
               $cada_css .= $Css;
           }
           else {
               $cada_css = ".grid_v_cartera_por_recuperar_old_" . substr($cada_css, 1);
           }
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   $this->css_body_embutida = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['css_body_embutida'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['css_body_embutida'] : "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida'])
   { 
       if (!$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['doc_word'] && ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao_print'] == "print")) 
       {
           if ($this->Print_All) 
           {
               $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
       ...
       {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
          $vertical_center = '';
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != "pdf" && !$this->Print_All)
       { 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['css_body_embutida'])) {
       $remove_border = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['css_body_embutida'];
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['proc_pdf_vert'])
   {
   }
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_v_cartera_por_recuperar_old']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_v_cartera_por_recuperar_old']) . "_";
           } 
       } 
       else 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_v_cartera_por_recuperar_old']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_v_cartera_por_recuperar_old']) . "_";
           } 
       }
   }
   $temp_css  = explode("/", $compl_css);
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida']) ? "grid_v_cartera_por_recuperar_old_" : "";
   $this->css_sep = " ";
...
//----- 
 function cabecalho_normal()
 {
   global
          $nm_saida;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['dashboard_info']['maximized'])
   {
       return; 
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opc_liga']['cab']))
   {
       return; 
   }
   if ($this->Ini->Embutida_iframe) {
   ...
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['where_pesq_filtro'];
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['cond_pesq']))
   {  
       $pos       = 0;
       $trab_pos  = false;
       $pos_tmp   = true; 
       $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['cond_pesq'];
       while ($pos_tmp)
       {
          $pos = strpos($tmp, "##*@@", $pos);
          if ($pos !== false)
       ...
       $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
       $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
       $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['cond_pesq'], 0, $trab_pos);
   ...
   $_SESSION['scriptcase']['grid_v_cartera_por_recuperar_old']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['grid_v_cartera_por_recuperar_old']['contr_erro'] = 'off';
   $this->nm_data->SetaData(date("Y/m/d H:i:s"), "YYYY/MM/DD HH:II:SS"); 
   $nm_saida->saida(" <TR id=\"sc_grid_head\">\r\n");
   $this->nm_data->SetaData(date("Y/m/d H:i:s"), "YYYY/MM/DD HH:II:SS");
   $sc_data_cab1 = $this->nm_data->FormataSaida("l, d @?#?@de F @?#?@de Y");
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['sv_dt_head']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['sv_dt_head'] = array();
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['sv_dt_head'] as $ind => $val)
   {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ajax_nav'] && $nm_refresch_cab_rod)
   { 
       $_SESSION['scriptcase']['saida_html'] = "";
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['sv_dt_head'][1] = $sc_data_cab1;
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['sv_dt_head']['fix'] = $nm_data_fixa;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != "pdf")
   { 
   ...
   { 
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['proc_pdf']) 
     { 
         $this->NM_calc_span();
           $nm_saida->saida("   <TD colspan=\"" . $this->NM_colspan . "\" class=\"" . $this->css_scGridTabelaTd . "\" style=\"vertical-align: top\">\r\n");
     } 
     else if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['proc_pdf_vert']) 
     {
   ...
   $nm_saida->saida("       <TR valign=\"middle\">\r\n");
   $nm_saida->saida("        <TD align=\"left\" class=\"" . $this->css_scGridHeaderFont . "\">\r\n");
   $nm_saida->saida("          Cartera por Recuperar\r\n");
   $nm_saida->saida("        </TD>\r\n");
   $nm_saida->saida("        <TD style=\"font-size: 5px\">\r\n");
   $nm_saida->saida("          &nbsp; &nbsp;\r\n");
   $nm_saida->saida("        </TD>\r\n");
...
// 
 function label_grid($linhas = 0)
 {
   ...
   $salva_htm_emb  = "";
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida_label'])
   { 
       $this->New_label['periodo'] = "" . $this->Ini->Nm_lang['lang_periodo'] . "";
       $this->New_label['mes'] = "" . $this->Ini->Nm_lang['lang_srch_mnth'] . "";
       $this->New_label['cl_identificacion'] = "" . $this->Ini->Nm_lang['lang_lot_identificacion'] . "";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['exibe_titulos']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
   ...
   $nm_saida->saida("    <TR id=\"tit_grid_v_cartera_por_recuperar_old__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-grid_v_cartera_por_recuperar_old-" . $tmp_header_row . "\">\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida_label']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_pro_codigo_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opc_psq']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_pro_codigo_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['field_order'] as $Cada_label)
   { 
   ...
   $nm_saida->saida("</TR>\r\n");
             ...
             foreach ($NM_css as $cada_css)
             {
                 ...
                 if ($Pos1 !== false && $Pos2 !== false) {
                     ...
                     $css_emb .= $cada_css . $Css;
                       ...
                       $css_emb .= ".grid_v_cartera_por_recuperar_old_" . substr($cada_css, 1);
                 }
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
     ...
     $NM_seq_lab = 1;
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['labels'] as $NM_cmp => $NM_lab)
     {
         if (empty($NM_lab) || $NM_lab == "&nbsp;")
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['labels'][$NM_cmp] = "No_Label" . $NM_seq_lab;
             $NM_seq_lab++;
         }
     } 
   } 
 ...
 function NM_label_periodo()
 {
   ...
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != 'pdf') {
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['op_operacion'])) ? $this->New_label['op_operacion'] : "" . $this->Ini->Nm_lang['lang_operacion'] . "";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['cl_telefono'])) ? $this->New_label['cl_telefono'] : "Cl Telefono";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['cl_email'])) ? $this->New_label['cl_email'] : "Cl Email";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['cl_direccion'])) ? $this->New_label['cl_direccion'] : "Cl Direccion";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
...
function SC_label_rightActionBar()
{
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_cmp'] == $fieldName) {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ordem_label'] == 'desc') {
                $sortRule = 'desc';
            } else {
                $sortRule = 'asc';
            }
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ini_cor_grid']);
       }
   }
...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['labels']['periodo'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['mes'])) ? $this->New_label['mes'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['labels']['mes'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cl_identificacion'])) ? $this->New_label['cl_identificacion'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['labels']['cl_identificacion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cl_nombre'])) ? $this->New_label['cl_nombre'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['labels']['cl_nombre'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['op_comentario'])) ? $this->New_label['op_comentario'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['labels']['op_comentario'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['pro_descripcion'])) ? $this->New_label['pro_descripcion'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['labels']['pro_descripcion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['do_subtotal'])) ? $this->New_label['do_subtotal'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['labels']['do_subtotal'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['do_valor_iva'])) ? $this->New_label['do_valor_iva'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['labels']['do_valor_iva'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['do_total'])) ? $this->New_label['do_total'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['labels']['do_total'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['op_estado'])) ? $this->New_label['op_estado'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['labels']['op_estado'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['op_operacion'])) ? $this->New_label['op_operacion'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['labels']['op_operacion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['op_empresa'])) ? $this->New_label['op_empresa'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['labels']['op_empresa'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['dec_nombre'])) ? $this->New_label['dec_nombre'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['labels']['dec_nombre'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cl_telefono'])) ? $this->New_label['cl_telefono'] : "Cl Telefono";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['labels']['cl_telefono'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cl_email'])) ? $this->New_label['cl_email'] : "Cl Email";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['labels']['cl_email'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cl_direccion'])) ? $this->New_label['cl_direccion'] : "Cl Direccion";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['labels']['cl_direccion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['pro_codigo'])) ? $this->New_label['pro_codigo'] : "Pro Codigo";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['labels']['pro_codigo'] = $SC_Label; 
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_por_recuperar_old']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_por_recuperar_old']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_por_recuperar_old']['lig_edit'];
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_grid_v_cartera_por_recuperar_old#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               ...
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['cab_embutida'] != "S")
               {
       ...
       else
       {
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['force_toolbar'] = true;
           } 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ajax_nav'])
           { 
               $_SESSION['scriptcase']['saida_html'] = "";
           } 
           $nm_saida->saida("  " . $this->nm_grid_sem_reg . "\r\n");
...
else
{
       ...
       $nm_id_aplicacao = " id=\"apl_grid_v_cartera_por_recuperar_old#?#1\"";
   } 
   $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] == "pdf") ? "padding: 0px !important;" : "";
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['proc_pdf_vert'])
{
}
else
...
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['proc_pdf']) { 
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['proc_pdf']) { 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-4df79db5\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['proc_pdf_vert']) { 
    $nm_saida->saida("</thead>\r\n");
 }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['proc_pdf'] && $this->pdf_all_label != "S" && $this->pdf_label_group != "S") 
   { 
      $this->label_grid($linhas);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida_grid'])
...
// 
   ...
   $this->Break_pag_pdf['Mensual']['periodo'] = "N";
   $this->Break_pag_prt['Mensual']['periodo'] = "N";
   $this->Break_pag_pdf['Mensual']['mes'] = "N";
   $this->Break_pag_prt['Mensual']['mes'] = "N";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['Config_Page_break_PDF'] = "S";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['Page_break_PDF']))
   {
       if (isset($this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Ind_Groupby']]))
       {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Gb_Free_cmp'] as $Cmp_gb => $resto)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['Page_break_PDF'][$Cmp_gb] = $this->Break_pag_pdf['sc_free_group_by'][$Cmp_gb];
               }
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['Page_break_PDF'] = $this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Ind_Groupby']];
           }
       }
       else
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['Page_break_PDF'] = array();
       }
   }
   $this->SC_top       = array();
   $this->SC_bot       = array();
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Ind_Groupby'] == "sc_free_group_by") 
   {
       ...
       $this->Nivel_gbBot = count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Gb_Free_cmp']);
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Ind_Groupby'] == "Mensual") 
   {
       ...
       {
           $this->quebra_periodo_Mensual_top(); 
       }
       if (isset($this->mes))
       {
           $this->quebra_mes_Mensual_top(); 
       }
       $this->nmgp_prim_pag_pdf = false;
   }
   ...
   $nm_houve_quebra = "N";
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          ...
          //---------- Gauge ----------
          if (!$this->Ini->sc_export_ajax && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
              if (0 == $this->progress_lim_now)
              {
               ...
               if (!NM_is_utf8($lang_protect))
               {
                  ...
                  grid_v_cartera_por_recuperar_old_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $lang_protect . " " . $this->progress_now . "...\n", $this->Ini->Nm_lang);
          ...
          $this->arg_sum_op_estado = " = " . $this->Db->qstr($this->op_estado);
          $this->SC_seq_page++; 
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['final'] + 1; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['rows_emb']++;
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Ind_Groupby'] == "sc_free_group_by") 
          {  
              $SC_arg_Gby = array();
              ...
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Gb_Free_cmp'] as $cmp => $sql)
              {
                  $Format_tst = $this->Ini->Get_Gb_date_format('sc_free_group_by', $cmp);
                  $SC_arg_Sql[$cmp] = $sql;
                  $Fun_GB  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Gb_Free_orig'][$cmp])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Gb_Free_orig'][$cmp] : $cmp;
                  if (!empty($Format_tst))
                  {
                      $temp = $this->$cmp;
                      if (!empty($temp))
              ...
              foreach ($SC_lst_Gby as $Ind => $cmp)
              {
                  ...
                  $sql_where = "";
                  $cmp_qb     = $this->$cmp;
                  foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Gb_Free_cmp'] as $Col_Gb => $Sql)
                  {
                      $tmp        = "arg_sum_" . $Col_Gb;
                      $sql_where .= (!empty($sql_where)) ? " and " : "";
              ...
              {
                  $cmp = $SC_lst_Gby[0];
                  if ($this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['doc_word'] && $this->Break_pag_prt[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Ind_Groupby']][$cmp] == "S")
                  {
                      $this->nm_quebra_pagina("pagina"); 
                  }
                  elseif (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['Page_break_PDF'][$cmp] == "S")
                  {
                      $this->nm_quebra_pagina("pagina"); 
                  }
              }
          ...
          if ($this->periodo !== $this->periodo_Old && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Ind_Groupby'] == "Mensual") 
          {  
              if (isset($this->mes_Old))
              {
                 $this->quebra_mes_Mensual_bot() ; 
              }
              if (isset($this->periodo_Old))
              {
                 $this->quebra_periodo_Mensual_bot() ; 
              }
              if ($this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['doc_word'] && $this->Break_pag_prt[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Ind_Groupby']]['periodo'] == "S")
              {
                  $this->nm_quebra_pagina("pagina"); 
              }
              elseif (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['Page_break_PDF']['periodo'] == "S")
              {
                  $this->nm_quebra_pagina("pagina"); 
              }
              $this->mes_Old = $this->mes ; 
          ...
          if ($this->mes !== $this->mes_Old && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Ind_Groupby'] == "Mensual") 
          {  
              if (isset($this->mes_Old))
              {
                 $this->quebra_mes_Mensual_bot() ; 
              }
              if ($this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['doc_word'] && $this->Break_pag_prt[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Ind_Groupby']]['mes'] == "S")
              {
                  $this->nm_quebra_pagina("pagina"); 
              }
              elseif (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['Page_break_PDF']['mes'] == "S")
              {
                  $this->nm_quebra_pagina("pagina"); 
              }
              $this->mes_Old = $this->mes ; 
          ...
          else
          {
              ...
              {
                  if ($this->nm_inicio_pag == 0 && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida_grid'])
                  {
                      $nm_houve_quebra = "N";
                  } 
              } 
              elseif (($nm_houve_quebra == "S" || ($this->nm_inicio_pag == 0)) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida_grid'])
              { 
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida_opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['dado_psq_ret'];
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida_grid']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->Css_Cmp['css_pro_codigo_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"   HEIGHT=\"0px\">&nbsp;</TD>\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opc_psq']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  style=\"" . $this->Css_Cmp['css_pro_codigo_grid_line'] . "\" NOWRAP align=\"left\" valign=\"top\" WIDTH=\"1px\"  HEIGHT=\"0px\">\r\n");
 $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcapture", "document.Fpesq.nm_ret_psq.value='" . str_replace(array("'", '"'), array("\'", '\"'), $teste) . "'; nm_escreve_window();", "document.Fpesq.nm_ret_psq.value='" . str_replace(array("'", '"'), array("\'", '\"'), $teste) . "'; nm_escreve_window();", "", "Rad_psq", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
          ...
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['field_order'] as $Cada_col)
          { 
   ...
   $this->SC_grid_rightActionBar();
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
   ...
   { 
       ...
       if (isset($this->mes_Old) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Ind_Groupby'] == "Mensual")
       {
           $this->quebra_mes_Mensual_bot() ; 
       }
       if (isset($this->periodo_Old) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Ind_Groupby'] == "Mensual")
       {
           $this->quebra_periodo_Mensual_bot() ; 
       }
  
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['exibe_total'] == "S")
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Ind_Groupby'] . "_bot";
           $this->$Gb_geral() ;
       } 
   }  
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida_grid'])
...
function SC_grid_rightActionBar()
{
 ...
 function NM_grid_mes()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['mes']) || $this->NM_cmp_hidden['mes'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
 ...
 function nm_quebra_pagina($nm_parms)
 {
    ...
    if (($this->Ini->nm_limite_lin > 0 && $this->Ini->nm_cont_lin > $this->Ini->nm_limite_lin) || $nm_parms == "pagina" || $nm_parms == "resumo" || $nm_parms == "total")
    {
        ...
        if ($this->Print_All)
        {
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['print_navigator']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['print_navigator'] == "Netscape")
            {
        ...
        if ($nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida'])
        {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['proc_pdf']) { 
           }
           else
           {
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['proc_pdf_vert']) { 
                $nm_saida->saida("     <thead>\r\n");
               }
               $this->cabecalho();
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['proc_pdf_vert']) { 
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['proc_pdf'] && ($this->pdf_all_cab == "S" || $this->pdf_all_label == "S")) { 
            $nm_saida->saida(" <thead> \r\n");
            if ($this->pdf_all_cab == "S")
            {
                $this->cabecalho();
            }
            if ($this->pdf_all_label == "S" && $nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida_grid'])
            {
                $this->label_grid();
            }
            $nm_saida->saida(" </thead> \r\n");
        }
        if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['proc_pdf'] && $nm_parms != "resumo" && $nm_parms != "pagina" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida_grid'])
        {
            $this->label_grid();
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['proc_pdf'] && $this->pdf_label_group != "S" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida_grid'])
        {
            $this->nm_inicio_pag = 0;
        }
    }
 ...
 function quebra_periodo_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   $this->sum_periodo_do_subtotal = $tot_periodo[2];
   $this->sum_periodo_do_valor_iva = $tot_periodo[3];
   $this->sum_periodo_do_total = $tot_periodo[4];
 ...
 function quebra_mes_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   $this->sum_mes_do_subtotal = $tot_mes[2];
   $this->sum_mes_do_valor_iva = $tot_mes[3];
   $this->sum_mes_do_total = $tot_mes[4];
   $Temp_cmp_quebra = array(); 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
       $conteudo = NM_encode_input(sc_strip_script($this->mes)); 
   }
 ...
 function quebra_cl_identificacion_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   $this->sum_cl_identificacion_do_subtotal = $tot_cl_identificacion[2];
   $this->sum_cl_identificacion_do_valor_iva = $tot_cl_identificacion[3];
   $this->sum_cl_identificacion_do_total = $tot_cl_identificacion[4];
   $Temp_cmp_quebra = array(); 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
       $conteudo = NM_encode_input(sc_strip_script($this->cl_identificacion)); 
   }
   ...
   $this->Lookup->lookup_sc_free_group_by_cl_identificacion($conteudo , $this->cl_identificacion) ; 
   $Temp_cmp_quebra[0]['cmp'] = $conteudo; 
 ...
 function quebra_op_estado_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   $this->sum_op_estado_do_subtotal = $tot_op_estado[2];
   $this->sum_op_estado_do_valor_iva = $tot_op_estado[3];
   $this->sum_op_estado_do_total = $tot_op_estado[4];
   $Temp_cmp_quebra = array(); 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
       $conteudo = NM_encode_input(sc_strip_script($this->op_estado)); 
   }
 ...
 function quebra_periodo_Mensual($periodo) 
 {
   global $tot_periodo;
   $this->sc_proc_quebra_mes = false;
   $this->sc_proc_quebra_periodo = true; 
   $this->Tot->quebra_periodo_Mensual($periodo, $this->arg_sum_periodo);
   $conteudo = $tot_periodo[0] ;  
   $this->count_periodo = $tot_periodo[1];
   $this->sum_periodo_do_subtotal = $tot_periodo[2];
   $this->sum_periodo_do_valor_iva = $tot_periodo[3];
   ...
   {
   $this->campos_quebra_periodo[0]['lab'] = "" . $this->Ini->Nm_lang['lang_periodo'] . ""; 
   }
   $this->sc_proc_quebra_periodo = false; 
 } 
 function quebra_mes_Mensual($periodo, $mes) 
 {
   global $tot_mes;
   $this->sc_proc_quebra_periodo = false;
   $this->sc_proc_quebra_mes = true; 
   $this->Tot->quebra_mes_Mensual($periodo, $mes, $this->arg_sum_periodo, $this->arg_sum_mes);
   $conteudo = $tot_mes[0] ;  
   $this->count_mes = $tot_mes[1];
   $this->sum_mes_do_subtotal = $tot_mes[2];
   $this->sum_mes_do_valor_iva = $tot_mes[3];
   $this->sum_mes_do_total = $tot_mes[4];
   $this->campos_quebra_mes = array(); 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
       $conteudo = NM_encode_input(sc_strip_script($this->mes)); 
   }
   else {
   ...
   $this->Lookup->lookup_Mensual_mes($conteudo , $this->mes) ; 
   $this->campos_quebra_mes[0]['cmp'] = $conteudo; 
   if (isset($this->nmgp_label_quebras['mes']))
   {
       $this->campos_quebra_mes[0]['lab'] = $this->nmgp_label_quebras['mes']; 
   }
   else
   {
   $this->campos_quebra_mes[0]['lab'] = "" . $this->Ini->Nm_lang['lang_srch_mnth'] . ""; 
   }
   $this->sc_proc_quebra_mes = false; 
 } 
 function quebra_periodo_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   $tot_periodo = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['periodo'] : 0;
   ...
   $link_div   = "";
   $link_div_2 = "";
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ind_tree'];
       ...
       $link_div .= "<img id=\"b_open_grid_v_cartera_por_recuperar_old_" . $this->NM_cont_body . "\" style=\"display:none\" onclick=\"document.getElementById('b_open_grid_v_cartera_por_recuperar_old_" . $this->NM_cont_body . "').style.display = 'none'; document.getElementById('b_close_grid_v_cartera_por_recuperar_old_" . $this->NM_cont_body . "').style.display = ''; NM_liga_tbody(" . $this->NM_cont_body . ", NM_tab_grid_v_cartera_por_recuperar_old, 'grid_v_cartera_por_recuperar_old'); return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_exp . "\">";
       $link_div .= "<img id=\"b_close_grid_v_cartera_por_recuperar_old_" . $this->NM_cont_body . "\" style=\"display:''\" onclick=\"document.getElementById('b_close_grid_v_cartera_por_recuperar_old_" . $this->NM_cont_body . "').style.display = 'none'; document.getElementById('b_open_grid_v_cartera_por_recuperar_old_" . $this->NM_cont_body . "').style.display = ''; NM_apaga_tbody(" . $this->NM_cont_body . ", NM_tab_grid_v_cartera_por_recuperar_old, 'grid_v_cartera_por_recuperar_old'); return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_col . "\">";
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_por_recuperar_old'][$this->NM_cont_body][$this->Tab_Nv_tree['periodo']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_por_recuperar_old_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   $this->NM_calc_span();
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['periodo'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_por_recuperar_old'][$this->NM_cont_body][$this->Tab_Nv_tree['periodo']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_por_recuperar_old_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
 ...
 function quebra_periodo_sc_free_group_by_bot($Cmp_Name) 
 {
   ...
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['periodo'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ind_tree'];
  ...
  foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
  {
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['field_order'] as $Cada_cmp)
   {
    ...
    if ($Cada_cmp == "do_subtotal" && (!isset($this->NM_cmp_hidden['do_subtotal']) || $this->NM_cmp_hidden['do_subtotal'] != "off"))
    {
      ...
      {
          $conteudo =  $tot_periodo[$NM_cmp_tot['do_subtotal'][$Tipo_Sum]]; 
    ...
    if ($Cada_cmp == "do_valor_iva" && (!isset($this->NM_cmp_hidden['do_valor_iva']) || $this->NM_cmp_hidden['do_valor_iva'] != "off"))
    {
      ...
      {
          $conteudo =  $tot_periodo[$NM_cmp_tot['do_valor_iva'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:2", "-") ; 
          }
    ...
    if ($Cada_cmp == "do_total" && (!isset($this->NM_cmp_hidden['do_total']) || $this->NM_cmp_hidden['do_total'] != "off"))
    {
      ...
      {
          $conteudo =  $tot_periodo[$NM_cmp_tot['do_total'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:2", "-") ; 
          }
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = false;
       $nm_saida->saida("    </TBODY>");
   }
 ...
 function quebra_mes_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_mes = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['mes'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_por_recuperar_old'][$this->NM_cont_body][$this->Tab_Nv_tree['mes']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_por_recuperar_old_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['mes'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_por_recuperar_old'][$this->NM_cont_body][$this->Tab_Nv_tree['mes']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_por_recuperar_old_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
           $this->NM_tbody_open = true;
       }
   }
 ...
 function quebra_mes_sc_free_group_by_bot($Cmp_Name) 
 {
   ...
   $NM_cmp_tot['do_total']['S'] = 4;
   $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . '');
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['mes'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ind_tree'];
  ...
  foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
  {
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['field_order'] as $Cada_cmp)
   {
    ...
    if ($Cada_cmp == "do_subtotal" && (!isset($this->NM_cmp_hidden['do_subtotal']) || $this->NM_cmp_hidden['do_subtotal'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['do_subtotal'][$Tipo_Sum]))
      {
          $conteudo =  $tot_mes[$NM_cmp_tot['do_subtotal'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:2", "-") ; 
          }
    ...
    if ($Cada_cmp == "do_valor_iva" && (!isset($this->NM_cmp_hidden['do_valor_iva']) || $this->NM_cmp_hidden['do_valor_iva'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['do_valor_iva'][$Tipo_Sum]))
      {
          $conteudo =  $tot_mes[$NM_cmp_tot['do_valor_iva'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:2", "-") ; 
          }
    ...
    if ($Cada_cmp == "do_total" && (!isset($this->NM_cmp_hidden['do_total']) || $this->NM_cmp_hidden['do_total'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['do_total'][$Tipo_Sum]))
      {
          $conteudo =  $tot_mes[$NM_cmp_tot['do_total'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:2", "-") ; 
          }
 ...
 function quebra_cl_identificacion_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_cl_identificacion = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['cl_identificacion'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_por_recuperar_old'][$this->NM_cont_body][$this->Tab_Nv_tree['cl_identificacion']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_por_recuperar_old_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['cl_identificacion'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_por_recuperar_old'][$this->NM_cont_body][$this->Tab_Nv_tree['cl_identificacion']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_por_recuperar_old_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
           $this->NM_tbody_open = true;
       }
   }
 ...
 function quebra_cl_identificacion_sc_free_group_by_bot($Cmp_Name) 
 {
   ...
   $NM_cmp_tot['do_total']['S'] = 4;
   $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . '');
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['cl_identificacion'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ind_tree'];
 ...
 function quebra_pro_descripcion_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_pro_descripcion = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['pro_descripcion'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_por_recuperar_old'][$this->NM_cont_body][$this->Tab_Nv_tree['pro_descripcion']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_por_recuperar_old_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['pro_descripcion'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_por_recuperar_old'][$this->NM_cont_body][$this->Tab_Nv_tree['pro_descripcion']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_por_recuperar_old_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
           $this->NM_tbody_open = true;
       }
   }
 ...
 function quebra_pro_descripcion_sc_free_group_by_bot($Cmp_Name) 
 {
   ...
   $NM_cmp_tot['do_total']['S'] = 4;
   $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . '');
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['pro_descripcion'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ind_tree'];
 ...
 function quebra_op_estado_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_op_estado = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['op_estado'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_por_recuperar_old'][$this->NM_cont_body][$this->Tab_Nv_tree['op_estado']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_por_recuperar_old_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['op_estado'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_por_recuperar_old'][$this->NM_cont_body][$this->Tab_Nv_tree['op_estado']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_por_recuperar_old_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
           $this->NM_tbody_open = true;
       }
   }
 ...
 function quebra_op_estado_sc_free_group_by_bot($Cmp_Name) 
 {
   ...
   $NM_cmp_tot['do_total']['S'] = 4;
   $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . '');
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['op_estado'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ind_tree'];
 ...
 function quebra_periodo_Mensual_top() 
 { global
          $periodo_ant_desc, 
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_por_recuperar_old'][$this->NM_cont_body]['1'] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_por_recuperar_old_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
 ...
 function quebra_periodo_Mensual_bot() 
 { global 
          $periodo_ant_desc, 
          $nm_saida, $tot_periodo;
   $NM_cmp_tot['do_subtotal']['S'] = 2;
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ind_tree'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_por_recuperar_old'][$this->NM_cont_body]['1'] = 'bot';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_por_recuperar_old_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['rows_emb']++;
   $periodo_ant_desc = $this->campos_quebra_periodo[0]['cmp'];
 ...
 function quebra_mes_Mensual_top() 
 { global
          $mes_ant_desc, 
          $nm_saida, $tot_mes;
   $this->SC_tab_quebra = 10;
   $mes_ant_desc = $this->campos_quebra_mes[0]['cmp'];
   static $cont_quebra_mes = 0; 
   $cont_quebra_mes++;
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_old = "";
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_por_recuperar_old'][$this->NM_cont_body]['2'] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_por_recuperar_old_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] == "pdf" && !$this->Print_All)
   {
       $nm_nivel_book_pdf = "<div style=\"height:1px;overflow:hidden\"><H3 style=\"font-size:0;padding:1px\">" .  $this->campos_quebra_mes[0]['cmp'] ;
       $nm_fecha_pdf_new = "</H3></div>";
   }
   $conteudo = $tot_mes[0] ;  
    $thisColspan = 2;
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ind_tree'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_por_recuperar_old'][$this->NM_cont_body]['2'] = 'bot';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_por_recuperar_old_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
       $this->NM_tbody_open = true;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida_grid'] && $this->nm_prim_linha)
 ...
 function quebra_mes_Mensual_bot() 
 { global 
          $mes_ant_desc, 
          $nm_saida, $tot_mes;
   $NM_cmp_tot['do_subtotal']['S'] = 2;
 ...
 function quebra_geral_sc_free_group_by_bot() 
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] == "pdf" && !$this->Print_All)
   {
      $nm_nivel_book_pdf = "<div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">" .  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['tot_geral'][0] . "</H1></div>";
   }
   $tit_lin_sumariza      =  $nm_nivel_book_pdf . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['tot_geral'][1] . ")";
   $tit_lin_sumariza_orig =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['tot_geral'][1] . ")";
  ...
  foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
  {
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['field_order'] as $Cada_cmp)
   {
    ...
    if ($Cada_cmp == "do_subtotal" && (!isset($this->NM_cmp_hidden['do_subtotal']) || $this->NM_cmp_hidden['do_subtotal'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['do_subtotal'][$Tipo_Sum]))
      {
          $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['tot_geral'][$NM_cmp_tot['do_subtotal'][$Tipo_Sum]] ; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:2", "-") ; 
          }
    ...
    if ($Cada_cmp == "do_valor_iva" && (!isset($this->NM_cmp_hidden['do_valor_iva']) || $this->NM_cmp_hidden['do_valor_iva'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['do_valor_iva'][$Tipo_Sum]))
      {
          $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['tot_geral'][$NM_cmp_tot['do_valor_iva'][$Tipo_Sum]] ; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:2", "-") ; 
          }
    ...
    if ($Cada_cmp == "do_total" && (!isset($this->NM_cmp_hidden['do_total']) || $this->NM_cmp_hidden['do_total'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['do_total'][$Tipo_Sum]))
      {
          $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['tot_geral'][$NM_cmp_tot['do_total'][$Tipo_Sum]] ; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:2", "-") ; 
          }
...
$nm_saida->saida("    </style>\r\n");
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on" && !$this->NM_hidden_filters)
      {
          ...
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['fast_search'][2] : "";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ajax_nav'])
          {
      ...
      if ($this->nmgp_botoes['group_1'] == "on" && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("           $Cod_Btn\r\n");
      if ($this->nmgp_botoes['pdf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
      $Tem_gb_pdf  = "s";
      $Tem_pdf_res = "n";
      $Tem_pdf_res = "s";
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Gb_Free_cmp']))
      {
          $Tem_pdf_res = "n";
      }
              $this->nm_btn_exist['pdf'][] = "pdf_top";
          $nm_saida->saida("            <div id=\"div_pdf_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "pdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + P)", "thickbox", "" . $this->Ini->path_link . "grid_v_cartera_por_recuperar_old/grid_v_cartera_por_recuperar_old_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=8&lpapel=279&apapel=216&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&sc_ver_93=s&nm_tem_gb=" . $Tem_gb_pdf . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_pdf_res=grid,resume&nm_all_modules=grid,resume&nm_label_group=N&nm_all_cab=S&nm_all_label=S&nm_orient_grid=2&password=n&summary_export_columns=S&pdf_zip=N&origem=cons&language=es&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_v_cartera_por_recuperar_old&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_word_res = "n";
          $Tem_word_res = "s";
          ...
          $nm_saida->saida("            <div id=\"div_word_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "grid_v_cartera_por_recuperar_old/grid_v_cartera_por_recuperar_old_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=" . $Tem_word_res . "&nm_ini_word_res=grid,resume&nm_all_modules=grid,resume&password=n&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_xls_res = "n";
          $Tem_xls_res = "s";
          ...
          $nm_saida->saida("            <div id=\"div_xls_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "xls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_v_cartera_por_recuperar_old/grid_v_cartera_por_recuperar_old_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_v_cartera_por_recuperar_old&nm_tp_xls=xlsx&nm_tot_xls=S&nm_res_cons=" . $Tem_xls_res . "&nm_ini_xls_res=grid,resume&nm_all_modules=grid,resume&password=n&summary_export_columns=S&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['print'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Tem_pdf_res = "n";
          $Tem_pdf_res = "s";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Gb_Free_cmp']))
          ...
          $nm_saida->saida("            <div id=\"div_print_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "print_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + P)", "thickbox", "" . $this->Ini->path_link . "grid_v_cartera_por_recuperar_old/grid_v_cartera_por_recuperar_old_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=RC&nm_cor=CO&password=n&language=es&nm_page=" . NM_encode_input($this->Ini->sc_page) . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_prt_res=grid,resume&nm_all_modules=grid,resume&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['sel_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      $pos_path = strrpos($this->Ini->path_prod, "/");
      $path_fields = $this->Ini->root . substr($this->Ini->path_prod, 0, $pos_path) . "/conf/fields/";
              $this->nm_btn_exist['sel_col'][] = "selcmp_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcolumns", "scBtnSelCamposShow('" . $this->Ini->path_link . "grid_v_cartera_por_recuperar_old/grid_v_cartera_por_recuperar_old_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnSelCamposShow('" . $this->Ini->path_link . "grid_v_cartera_por_recuperar_old/grid_v_cartera_por_recuperar_old_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "selcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Groupby_hide']))
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_v_cartera_por_recuperar_old/grid_v_cartera_por_recuperar_old_sel_groupby.php?opc_ret=igual&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_v_cartera_por_recuperar_old/grid_v_cartera_por_recuperar_old_sel_groupby.php?opc_ret=igual&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
          }
      }
          if ($this->nmgp_botoes['summary'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
          {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Gb_Free_cmp']))
            { }
            else {
          ...
          if (is_file("grid_v_cartera_por_recuperar_old_help.txt") && !$this->grid_emb_form)
          {
             $Arq_WebHelp = file("grid_v_cartera_por_recuperar_old_help.txt"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['dashboard_info']['under_dashboard']))
      {
         $this->nmgp_botoes['exit'] = "off"; 
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opc_psq'])
      ...
      {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['sc_modal'])
        {
...
$nm_saida->saida("    </style>\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao_print'] != "print") 
      {
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['qtline'] == "on" && $this->Ini->Apl_paginacao != "FULL")
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['qt_lin_grid'] == '10') ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['qt_lin_grid'] == '20') ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['qt_lin_grid'] == '50') ? " selected" : "";
              $nm_saida->saida("           <option value=\"50\" " . $obj_sel . ">50</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['qt_lin_grid'] == 'all') ? " selected" : "";
      ...
      if (is_file($this->Ini->root . $this->Ini->path_img_global . $this->Ini->Img_sep_grid))
      {
          ...
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opc_liga']['nav']))
          {
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['navpage'] == "on" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opc_liga']['nav']) && $this->Ini->Apl_paginacao != "FULL" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['qt_lin_grid'] != "all")
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['qt_lin_grid'];
              $Max_link   = 5;
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opc_liga']['nav']))
          {
...
$nm_saida->saida("    </style>\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['SC_Gb_Free_cmp']))
      {
          $Tem_pdf_res = "n";
              ...
              $this->nm_btn_exist['pdf'][] = "pdf_top";
          $nm_saida->saida("            <div id=\"div_pdf_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "pdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + P)", "thickbox", "" . $this->Ini->path_link . "grid_v_cartera_por_recuperar_old/grid_v_cartera_por_recuperar_old_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=8&lpapel=279&apapel=216&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&sc_ver_93=s&nm_tem_gb=" . $Tem_gb_pdf . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_pdf_res=grid,resume&nm_all_modules=grid,resume&nm_label_group=N&nm_all_cab=S&nm_all_label=S&nm_orient_grid=2&password=n&summary_export_columns=S&pdf_zip=N&origem=cons&language=es&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_v_cartera_por_recuperar_old&KeepThis=true&TB_iframe=true&modal=true", "group_4", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_word_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $this->nm_btn_exist['word'][] = "word_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "grid_v_cartera_por_recuperar_old/grid_v_cartera_por_recuperar_old_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=" . $Tem_word_res . "&nm_ini_word_res=grid,resume&nm_all_modules=grid,resume&password=n&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_4", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['sort_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_5_top = true;</script>\r\n");
          ...
          $nm_saida->saida("            <div id=\"div_ordcmp_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bsort", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_v_cartera_por_recuperar_old/grid_v_cartera_por_recuperar_old_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_v_cartera_por_recuperar_old/grid_v_cartera_por_recuperar_old_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "ordcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_5", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
...
$nm_saida->saida("    </style>\r\n");
   ...
   function html_grid_search()
   {
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['grid_pesq'])?'none':'';
       if(!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ajax_nav'])
       {
          $nm_saida->saida("   <tr id=\"NM_Grid_Search\" ajax='' style='display:" . $str_display . "'>\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['grid_pesq']))
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['grid_pesq'] as $cmp => $def)
           {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['save_grid']))
           {
               return;
           }
           else
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['save_grid']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['grid_pesq']))
           { 
   ...
   {
       $lin_obj  = "";
       $All_cmp_search = array('periodo','mes','cl_nombre','cl_identificacion','pro_descripcion');
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['pesq_tab_label'];
       if (!empty($nmgp_tab_label))
       {
          $nm_tab_campos = explode("?@?", $nmgp_tab_label);
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['grid_pesq']) && count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['grid_pesq']) < 5)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
   ...
   function grid_search_periodo($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['psq_check_ret']['periodo'] = array();
       $periodo_look = (is_string($periodo) ? substr($this->Db->qstr($periodo), 1, -1) : $periodo); 
       $nmgp_def_dados  = ""; 
       $nm_comando = "select distinct periodo from " . $this->Ini->nm_tabela . " where (op_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "' and op_estado not in ('P','N')) order by periodo"; 
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['psq_check_ret']['periodo'][] = trim($rs->fields[0]);
       ...
       $lin_obj .= "    <input id='grid_search_periodo_val_" . $ind . "' name='val_grid_search_periodo_" . $ind . "' type='hidden' value=''>";
       $lin_obj .= "    <SELECT class='" . $this->css_scAppDivToolbarInput . "' style='height : auto;' id=\"grid_search_periodo_val_" . $ind . "_orig\" name=\"val_grid_search_periodo_" . $ind . "_orig\" size=7 multiple onDblClick=\"nm_add_sel_Grid('grid_search_periodo_val_" . $ind . "_orig', 'grid_search_periodo_val_" . $ind . "_dest', 'N')\">";
       $delimitador = "##@@";
          ...
          if (!empty($nm_opcao))
          {
             ...
             if (is_array($val) && !empty($val))
             {
                ...
                foreach ($val as $Dados)
                {
                    ...
                    if ($Dados === $nm_opc_cod)
                    {
                        $periodo_sel = " disabled =\"disabled\" style=\"color: #A0A0A0\"";
                        break;
                    }
                }
             }
       ...
       $lin_obj .= nmButtonOutput($this->arr_buttons, "bpassfld_rightall", "nm_add_all_Grid('grid_search_periodo_val_" . $ind . "_orig', 'grid_search_periodo_val_" . $ind . "_dest', 'N');", "nm_add_all_Grid('grid_search_periodo_val_" . $ind . "_orig', 'grid_search_periodo_val_" . $ind . "_dest', 'N');", "G_Bbpassfld_rightall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");

       $lin_obj .= "   </div>";
       $lin_obj .= "   <div class='scBtnPassField'>";
       $lin_obj .= nmButtonOutput($this->arr_buttons, "bpassfld_right", "nm_add_sel_Grid('grid_search_periodo_val_" . $ind . "_orig', 'grid_search_periodo_val_" . $ind . "_dest', 'N');", "nm_add_sel_Grid('grid_search_periodo_val_" . $ind . "_orig', 'grid_search_periodo_val_" . $ind . "_dest', 'N');", "G_Bbpassfld_righ", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");

       $lin_obj .= "   </div>";
       $lin_obj .= "   <div class='scBtnPassField'>";
       $lin_obj .= nmButtonOutput($this->arr_buttons, "bpassfld_left", "nm_del_sel_Grid('grid_search_periodo_val_" . $ind . "_dest', 'grid_search_periodo_val_" . $ind . "_orig', 'N');", "nm_del_sel_Grid('grid_search_periodo_val_" . $ind . "_dest', 'grid_search_periodo_val_" . $ind . "_orig', 'N');", "G_Bbpassfld_left", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");

       $lin_obj .= "   </div>";
       $lin_obj .= "   <div class='scBtnPassField'>";
       $lin_obj .= nmButtonOutput($this->arr_buttons, "bpassfld_leftall", "nm_del_all_Grid('grid_search_periodo_val_" . $ind . "_dest', 'grid_search_periodo_val_" . $ind . "_orig', 'N');", "nm_del_all_Grid('grid_search_periodo_val_" . $ind . "_dest', 'grid_search_periodo_val_" . $ind . "_orig', 'N');", "G_Bbpassfld_leftall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");

       $lin_obj .= "   </div>";
       $lin_obj .= "   </td>";
       $lin_obj .= "   <td>";
       $lin_obj .= "    <SELECT class='" . $this->css_scAppDivToolbarInput . "' style='height : auto;' id=\"grid_search_periodo_val_" . $ind . "_dest\" name=\"val_grid_search_periodo_" . $ind . "_dest\" size=7 multiple onDblClick=\"nm_del_sel_Grid('grid_search_periodo_val_" . $ind . "_dest', 'grid_search_periodo_val_" . $ind . "_orig', 'N')\">";
       $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
       $nm_opcoes  = explode("?@?", $nm_opcoesx);
       foreach ($nm_opcoes as $nm_opcao)
       {
   ...
   function grid_search_mes($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['psq_check_ret']['mes'] = array();
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['psq_check_ret']['mes'][] = trim($rs->fields[0]);
   ...
   function grid_search_cl_nombre($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['psq_check_ret']['cl_nombre'] = array();
       ...
       $nm_comando = "SELECT cl_nombre, cl_nombre  FROM del_cliente  ORDER BY cl_nombre"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['psq_check_ret']['cl_nombre'][] = trim($rs->fields[0]);
             $nmgp_def_dados .= trim($rs->fields[1]) . "?#?"; 
             $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?"; 
             $rs->MoveNext(); 
          } 
   ...
   function grid_search_cl_identificacion($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['psq_check_ret']['cl_identificacion'] = array();
       $cl_identificacion_look = (is_string($cl_identificacion) ? substr($this->Db->qstr($cl_identificacion), 1, -1) : $cl_identificacion); 
       $nmgp_def_dados  = ""; 
       $nmgp_def_dados .= "" . $this->Ini->Nm_lang['lang_seleccione'] . "?#??#?N?@?"; 
       $nm_comando = "SELECT cl_identificacion, cl_identificacion  FROM del_cliente  ORDER BY cl_identificacion"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['psq_check_ret']['cl_identificacion'][] = trim($rs->fields[0]);
             $nmgp_def_dados .= trim($rs->fields[1]) . "?#?"; 
             $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?"; 
             $rs->MoveNext(); 
          } 
   ...
   function grid_search_pro_descripcion($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['psq_check_ret']['pro_descripcion'] = array();
       $pro_descripcion_look = (is_string($pro_descripcion) ? substr($this->Db->qstr($pro_descripcion), 1, -1) : $pro_descripcion); 
       $nmgp_def_dados  = ""; 
       $nm_comando = "SELECT pro_descripcion, pro_descripcion  FROM del_producto  ORDER BY pro_descripcion"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['psq_check_ret']['pro_descripcion'][] = trim($rs->fields[0]);
             $nmgp_def_dados .= trim($rs->fields[1]) . "?#?"; 
             $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?"; 
             $rs->MoveNext(); 
          } 
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "SIJAP/grid_v_cartera_por_recuperar_old";
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   ...
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
       $nm_saida->saida("   document.getElementById('first_bot').disabled = true;\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['ajax_nav'])
       {
   ...
   $nm_saida->saida("   if (typeof(scSetFixedHeaders) === typeof(function(){})) scSetFixedHeaders();\r\n");
   $nm_saida->saida("  });\r\n");
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
               $nm_saida->saida("   document.getElementById('forward_bot').disabled = true;\r\n");
               $nm_saida->saida("   document.getElementById('forward_bot').className = \"scButton_" . $this->arr_buttons['bcons_avanca']['style'] . " disabled\";\r\n");
   ...
   if ($this->grid_emb_form || $this->grid_emb_form_full)
   {
       ...
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_v_cartera_por_recuperar_old', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"grid_v_cartera_por_recuperar_old\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"grid_v_cartera_por_recuperar_old_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("                     action=\"grid_v_cartera_por_recuperar_old_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_v_cartera_por_recuperar_old/grid_v_cartera_por_recuperar_old_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
   ...
   $nm_saida->saida("           document.Fdoc_word.action = \"grid_v_cartera_por_recuperar_old_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("           document.F3.SC_module_export.value = z;\r\n");
   $nm_saida->saida("       }\r\n");
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['grid_v_cartera_por_recuperar_old_iframe_params'] = array(
   ...
   $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_v_cartera_por_recuperar_old@SC_par@" . md5($prep_parm_pdf);
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   $nm_saida->saida("               document.Fpdf.action=\"grid_v_cartera_por_recuperar_old_iframe.php\";\r\n");
   ...
   $nm_saida->saida("               document.Fprint.action = \"grid_v_cartera_por_recuperar_old_export_ctrl.php\";\r\n");
   $nm_saida->saida("           }\r\n");
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   ...
   $nm_saida->saida("           document.Fexport.action = \"grid_v_cartera_por_recuperar_old_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['campo_psq_ret']) )
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['grid_v_cartera_por_recuperar_old']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form  = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Form1 = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("           var Obj_Doc   = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form  = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Form1 = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("          var Obj_Doc   = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form  = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Form1 = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['campo_psq_ret']) . ";\r\n");
          $nm_saida->saida("          var Obj_Doc   = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"grid_v_cartera_por_recuperar_old_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar_old']['reg_start']))
   {
       $nm_saida->saida("      $(document).ready(function(){\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailStatus('grid_v_cartera_por_recuperar_old')\",50);\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_v_cartera_por_recuperar_old', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      })\r\n");
   }
