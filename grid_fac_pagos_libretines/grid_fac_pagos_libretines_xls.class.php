...
class grid_fac_pagos_libretines_xls
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_fac_pagos_libretines/grid_fac_pagos_libretines_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "grid_fac_pagos_libretines_res_xls.class.php");
              $this->Res_xls = new grid_fac_pagos_libretines_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_fac_pagos_libretines.zip";
          $this->Arquivo   .= "_grid_fac_pagos_libretines" . $this->Xls_tp;
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_pagos_libretines']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_pagos_libretines']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_pagos_libretines']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
...
$_SESSION['scriptcase']['grid_fac_pagos_libretines']['contr_erro'] = 'off'; 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_pagos_libretines']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_pagos_libretines']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_pagos_libretines']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_pagos_libretines']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_pagos_libretines']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_pagos_libretines']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_pagos_libretines']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_pagos_libretines']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   { 
      ...
      { 
          ...
          if ((!isset($this->NM_cmp_hidden['detalle']) || $this->NM_cmp_hidden['detalle'] != "off") && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalle_compra_libretines']['embutida_label'] = true;
              $GLOBALS["script_case_init"] = $this->Ini->sc_page;
              $GLOBALS["nmgp_parms"] = "nmgp_opcao?#?xls?@?";
              if (method_exists($this->grid_detalle_compra_libretines, "controle"))
              {
   ...
   function NM_export_pag_empresa()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->look_pag_empresa, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->look_pag_empresa, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- pag_fecha
   function NM_export_pag_fecha()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->pag_fecha = substr($this->pag_fecha, 0, 10);
         if (empty($this->pag_fecha) || $this->pag_fecha == "0000-00-00")
         {
             if ($this->Use_phpspreadsheet) {
                 $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->pag_fecha, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
             }
             else {
                 $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->pag_fecha, PHPExcel_Cell_DataType::TYPE_STRING);
             }
         }
         else
         {
             $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->pag_fecha);
   ...
   function NM_export_pag_metodo_pago()
   {
         ...
         if (is_numeric($this->look_pag_metodo_pago))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->look_pag_metodo_pago);
         $this->Xls_col++;
   }
   //----- pag_banco_origen
   function NM_export_pag_banco_origen()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->pag_banco_origen, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->pag_banco_origen, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- pag_cuenta_origen
   function NM_export_pag_cuenta_origen()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->pag_cuenta_origen, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->pag_cuenta_origen, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- pag_monto
   function NM_export_pag_monto()
   {
         ...
         if (is_numeric($this->pag_monto))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->pag_monto);
         $this->Xls_col++;
   }
   //----- pag_cuenta_destino
   function NM_export_pag_cuenta_destino()
   {
         ...
         if (is_numeric($this->look_pag_cuenta_destino))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->look_pag_cuenta_destino);
         $this->Xls_col++;
   }
   //----- pag_documento
   function NM_export_pag_documento()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->pag_documento, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->pag_documento, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- pag_verificar
   function NM_export_pag_verificar()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->pag_verificar, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->pag_verificar, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- pag_anular
   function NM_export_pag_anular()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->pag_anular, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->pag_anular, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- pag_id
   function NM_export_pag_id()
   {
         ...
         if (is_numeric($this->pag_id))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->pag_id);
         $this->Xls_col++;
   }
   //----- pag_empresa
   function NM_sub_cons_pag_empresa()
   {
         $this->look_pag_empresa = html_entity_decode($this->look_pag_empresa, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->look_pag_empresa = strip_tags($this->look_pag_empresa);
         $this->look_pag_empresa = NM_charset_to_utf8($this->look_pag_empresa);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_pag_empresa;
   ...
   //----- pag_fecha
   function NM_sub_cons_pag_fecha()
   {
         $this->pag_fecha = substr($this->pag_fecha, 0, 10);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->pag_fecha;
   ...
   //----- pag_metodo_pago
   function NM_sub_cons_pag_metodo_pago()
   {
         $this->look_pag_metodo_pago = NM_charset_to_utf8($this->look_pag_metodo_pago);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_pag_metodo_pago;
   ...
   //----- pag_banco_origen
   function NM_sub_cons_pag_banco_origen()
   {
         $this->pag_banco_origen = html_entity_decode($this->pag_banco_origen, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->pag_banco_origen = strip_tags($this->pag_banco_origen);
         $this->pag_banco_origen = NM_charset_to_utf8($this->pag_banco_origen);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->pag_banco_origen;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- pag_cuenta_origen
   function NM_sub_cons_pag_cuenta_origen()
   {
         $this->pag_cuenta_origen = html_entity_decode($this->pag_cuenta_origen, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->pag_cuenta_origen = strip_tags($this->pag_cuenta_origen);
         $this->pag_cuenta_origen = NM_charset_to_utf8($this->pag_cuenta_origen);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->pag_cuenta_origen;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- pag_monto
   function NM_sub_cons_pag_monto()
   {
         $this->pag_monto = NM_charset_to_utf8($this->pag_monto);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->pag_monto;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
   ...
   //----- pag_cuenta_destino
   function NM_sub_cons_pag_cuenta_destino()
   {
         $this->look_pag_cuenta_destino = NM_charset_to_utf8($this->look_pag_cuenta_destino);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_pag_cuenta_destino;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- pag_documento
   function NM_sub_cons_pag_documento()
   {
         $this->pag_documento = html_entity_decode($this->pag_documento, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->pag_documento = strip_tags($this->pag_documento);
         $this->pag_documento = NM_charset_to_utf8($this->pag_documento);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->pag_documento;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- pag_verificar
   function NM_sub_cons_pag_verificar()
   {
         $this->pag_verificar = html_entity_decode($this->pag_verificar, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->pag_verificar = strip_tags($this->pag_verificar);
         $this->pag_verificar = NM_charset_to_utf8($this->pag_verificar);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->pag_verificar;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- pag_anular
   function NM_sub_cons_pag_anular()
   {
         $this->pag_anular = html_entity_decode($this->pag_anular, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->pag_anular = strip_tags($this->pag_anular);
         $this->pag_anular = NM_charset_to_utf8($this->pag_anular);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->pag_anular;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   function NM_sub_cons_detalle()
   {
         ...
         $GLOBALS["script_case_init"] = $this->Ini->sc_page;
         $GLOBALS["nmgp_parms"] = "nmgp_opcao?#?xls?@?var_pago?#?" . str_replace("'", "@aspass@", $this->Orig_pag_id) . "?@?";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalle_compra_libretines']['embutida'] = true;
         if (method_exists($this->grid_detalle_compra_libretines, "controle"))
         {
             $this->grid_detalle_compra_libretines->controle();
   ...
   //----- pag_id
   function NM_sub_cons_pag_id()
   {
         $this->pag_id = NM_charset_to_utf8($this->pag_id);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->pag_id;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_pagos_libretines']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_pagos_libretines']['nolabel'])
       {
