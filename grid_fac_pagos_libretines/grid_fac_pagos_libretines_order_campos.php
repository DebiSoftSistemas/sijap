<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_fac_pagos_libretines']['glo_nm_path_imag_temp'] . "/sc_apl_default_debi_doc_electronicos.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_fac_pagos_libretines_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_fac_pagos_libretines_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['pag_empresa'] = "on";
   $tab_def_campos['pag_empresa'] = "pag_empresa";
   $tab_labels["pag_empresa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['labels']["pag_empresa"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['labels']["pag_empresa"] : "" . $this->Nm_lang['lang_cliente'] . "";
   $tab_ger_campos['pag_fecha'] = "on";
   $tab_def_campos['pag_fecha'] = "pag_fecha";
   $tab_labels["pag_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['labels']["pag_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['labels']["pag_fecha"] : "" . $this->Nm_lang['lang_fecha'] . "";
   $tab_ger_campos['pag_metodo_pago'] = "on";
   $tab_def_campos['pag_metodo_pago'] = "pag_metodo_pago";
   $tab_labels["pag_metodo_pago"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['labels']["pag_metodo_pago"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['labels']["pag_metodo_pago"] : "" . $this->Nm_lang['lang_metodo_pago'] . "";
   $tab_ger_campos['pag_banco_origen'] = "on";
   $tab_def_campos['pag_banco_origen'] = "pag_banco_origen";
   $tab_labels["pag_banco_origen"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['labels']["pag_banco_origen"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['labels']["pag_banco_origen"] : "" . $this->Nm_lang['lang_banco_origen'] . "";
   $tab_ger_campos['pag_cuenta_origen'] = "on";
   $tab_def_campos['pag_cuenta_origen'] = "pag_cuenta_origen";
   $tab_labels["pag_cuenta_origen"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['labels']["pag_cuenta_origen"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['labels']["pag_cuenta_origen"] : "" . $this->Nm_lang['lang_cuenta_origen'] . "";
   $tab_ger_campos['pag_monto'] = "on";
   $tab_def_campos['pag_monto'] = "pag_monto";
   $tab_labels["pag_monto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['labels']["pag_monto"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['labels']["pag_monto"] : "" . $this->Nm_lang['lang_valor_pago'] . "";
   $tab_ger_campos['pag_cuenta_destino'] = "on";
   $tab_def_campos['pag_cuenta_destino'] = "pag_cuenta_destino";
   $tab_labels["pag_cuenta_destino"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['labels']["pag_cuenta_destino"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['labels']["pag_cuenta_destino"] : "" . $this->Nm_lang['lang_cuenta_destino'] . "";
   $tab_ger_campos['pag_documento'] = "on";
   $tab_def_campos['pag_documento'] = "pag_documento";
   $tab_labels["pag_documento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['labels']["pag_documento"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['labels']["pag_documento"] : "" . $this->Nm_lang['lang_lot_documento'] . "";
   $tab_ger_campos['pag_verificar'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['pag_verificar'] = "pag_verificar";
   }
   else
   {
       $tab_def_campos['pag_verificar'] = "";
   }
   $tab_labels["pag_verificar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['labels']["pag_verificar"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['labels']["pag_verificar"] : "";
   $tab_ger_campos['pag_anular'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['pag_anular'] = "pag_anular";
   }
   else
   {
       $tab_def_campos['pag_anular'] = "";
   }
   $tab_labels["pag_anular"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['labels']["pag_anular"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['labels']["pag_anular"] : "";
   $tab_ger_campos['pag_verificar'] = "none";
   $tab_ger_campos['pag_anular'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> fac_pagos_libretines</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_fac_pagos_libretines_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_fac_pagos_libretines']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
