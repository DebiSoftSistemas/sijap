<?php
//
class form_recaudacion_creditos_contrato_mob_apl
{
   ...
   var $tesoreria;
   var $tesoreria_1;
   var $usar_compensacion;
   var $usar_compensacion_1;
   var $total_pago;
   var $contrato;
   var $nm_data;
   var $nmgp_opcao;
...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['saldo_por_pagar']))
          {
              $this->saldo_por_pagar = $this->NM_ajax_info['param']['saldo_por_pagar'];
          }
          if (isset($this->NM_ajax_info['param']['script_case_init']))
          {
              $this->script_case_init = $this->NM_ajax_info['param']['script_case_init'];
          }
          if (isset($this->NM_ajax_info['param']['tesoreria']))
          {
              $this->tesoreria = $this->NM_ajax_info['param']['tesoreria'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['usar_compensacion']))
          {
              $this->usar_compensacion = $this->NM_ajax_info['param']['usar_compensacion'];
          }
      ...
      if (isset($this->var_contrato) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['var_contrato'] = $this->var_contrato;
      }
      ...
      if (isset($_POST["var_contrato"]) && isset($this->var_contrato)) 
      {
          $_SESSION['var_contrato'] = $this->var_contrato;
      }
      ...
      if (isset($_GET["var_contrato"]) && isset($this->var_contrato)) 
      {
          $_SESSION['var_contrato'] = $this->var_contrato;
      }
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_recaudacion_creditos_contrato_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_recaudacion_creditos_contrato_mob']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_recaudacion_creditos_contrato_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_recaudacion_creditos_contrato_mob']['embutida_parms'];
      ...
      { 
          ...
          if (isset($this->var_contrato)) 
          {
              $_SESSION['var_contrato'] = $this->var_contrato;
          }
          if (isset($this->NM_where_filter_form))
          {
              $_SESSION['sc_session'][$script_case_init]['form_recaudacion_creditos_contrato_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_recaudacion_creditos_contrato_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_recaudacion_creditos_contrato_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_recaudacion_creditos_contrato_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (!isset($this->Igtech_RucEmpresa) && isset($this->igtech_rucempresa)) 
          {
              $this->Igtech_RucEmpresa = $this->igtech_rucempresa;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_recaudacion_creditos_contrato_mob']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_recaudacion_creditos_contrato_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_recaudacion_creditos_contrato_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_recaudacion_creditos_contrato_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_recaudacion_creditos_contrato_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_recaudacion_creditos_contrato_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_recaudacion_creditos_contrato_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_recaudacion_creditos_contrato_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_recaudacion_creditos_contrato_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_recaudacion_creditos_contrato_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_creditos_contrato']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_creditos_contrato'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_creditos_contrato_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['form_recaudacion_creditos_contrato_mob']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_recaudacion_creditos_contrato_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_recaudacion_creditos_contrato_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_recaudacion_creditos_contrato_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_recaudacion_creditos_contrato_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_recaudacion_creditos_contrato_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_recaudacion_creditos_contrato_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " del_cliente";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_recaudacion_creditos_contrato_mob")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $this->Db = $this->Ini->Db; 
      $this->nm_new_label['cambio'] = '' . $this->Ini->Nm_lang['lang_cambio'] . '';
      ...
      $this->nm_new_label['total_pago'] = '' . $this->Ini->Nm_lang['lang_total_pagar'] . '';
      ...
      $this->arr_buttons['btn_salir']['value']            = "" . $this->Ini->Nm_lang['lang_salir'] . "";
      ...
      $_SESSION['scriptcase']['error_icon']['form_recaudacion_creditos_contrato_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_recaudacion_creditos_contrato_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_creditos_contrato_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_creditos_contrato_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_creditos_contrato_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_creditos_contrato_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_creditos_contrato_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_creditos_contrato_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_creditos_contrato_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_creditos_contrato_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_creditos_contrato_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_creditos_contrato_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_recaudacion_creditos_contrato_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_recaudacion_creditos_contrato_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_creditos_contrato_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_creditos_contrato_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_creditos_contrato_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_creditos_contrato_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_creditos_contrato_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_creditos_contrato_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_creditos_contrato_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_creditos_contrato_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_creditos_contrato_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_creditos_contrato_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_creditos_contrato_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_creditos_contrato_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_creditos_contrato_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_creditos_contrato_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_creditos_contrato_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_creditos_contrato_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_creditos_contrato_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_creditos_contrato_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_creditos_contrato_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form'];
          ...
          if ($this->nmgp_opcao == "incluir" && $this->nmgp_dados_form['tesoreria'] != "null"){$this->tesoreria = $this->nmgp_dados_form['tesoreria'];} 
          if ($this->nmgp_opcao == "incluir" && $this->nmgp_dados_form['total_pago'] != "null"){$this->total_pago = $this->nmgp_dados_form['total_pago'];} 
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_recaudacion_creditos_contrato_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      { 
          include_once($this->Ini->path_embutida . 'form_recaudacion_creditos_contrato/Igtech.DebiConta.Clases.php');
      }
      else
      { 
      ...
      if ($this->Embutida_proc)
      { 
          include_once($this->Ini->path_embutida . 'form_recaudacion_creditos_contrato/Igtech.Log.php');
      }
      else
      { 
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_recaudacion_creditos_contrato_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_recaudacion_creditos_contrato_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_recaudacion_creditos_contrato/form_recaudacion_creditos_contrato_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_recaudacion_creditos_contrato_mob_erro.class.php"); 
      }
      $this->Erro      = new form_recaudacion_creditos_contrato_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['opcao']))
         { 
             if ($this->cl_id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_creditos_contrato_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_creditos_contrato_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_creditos_contrato_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['opc_ant'] : "";
      } 
      ...
      {
          $this->nmgp_botoes['actualizar_cliente'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['botoes']['actualizar_cliente'];
          $this->nmgp_botoes['facturar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['botoes']['facturar'];
          $this->nmgp_botoes['btn_salir'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['botoes']['btn_salir'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_recaudacion_creditos_contrato_mob']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_recaudacion_creditos_contrato_mob']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_select'];
     }
   }
   ...
   function loadFieldConfig()
   {
      ...
      //-- saldo_por_pagar
      $this->field_config['saldo_por_pagar']               = array();
      $this->field_config['saldo_por_pagar']['symbol_grp'] = '';
      $this->field_config['saldo_por_pagar']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['saldo_por_pagar']['symbol_dec'] = '.';
      $this->field_config['saldo_por_pagar']['symbol_neg'] = '-';
      $this->field_config['saldo_por_pagar']['format_neg'] = '2';
      //-- valor_pago
      ...
      $this->field_config['total']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['total']['symbol_dec'] = '.';
      $this->field_config['total']['symbol_neg'] = '-';
      ...
      $this->field_config['cambio']['symbol_grp'] = '';
      $this->field_config['cambio']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['cambio']['symbol_dec'] = '.';
      $this->field_config['cambio']['symbol_neg'] = '-';
      $this->field_config['cambio']['format_neg'] = '2';
      //-- cl_id
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['Gera_log_access'] = false;
      }
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          if ('validate_tesoreria' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'tesoreria');
          }
          if ('validate_saldo_por_pagar' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'saldo_por_pagar');
          }
          if ('validate_usar_compensacion' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'usar_compensacion');
          }
      ...
      {
          $this->nm_tira_formatacao();
          if ('event_usar_compensacion_onclick' == $this->NM_ajax_opcao)
          {
              $this->usar_compensacion_onClick();
          }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          if (is_array($this->usar_compensacion))
          {
              $x = 0; 
              $this->usar_compensacion_1 = $this->usar_compensacion;
              $this->usar_compensacion = ""; 
              if ($this->usar_compensacion_1 != "") 
              { 
                  foreach ($this->usar_compensacion_1 as $dados_usar_compensacion_1 ) 
                  { 
                      if ($x != 0)
                      { 
                          $this->usar_compensacion .= ";";
                      } 
                      $this->usar_compensacion .= $dados_usar_compensacion_1;
                      $x++ ; 
                  } 
              } 
          } 
          $this->nm_tira_formatacao();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_select']['cl_identificacion']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->cl_identificacion = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_select']['cl_identificacion'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_select']['cl_nombre']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->cl_nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_select']['cl_nombre'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_select']['cl_direccion']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->cl_direccion = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_select']['cl_direccion'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_select']['cl_telefono']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->cl_telefono = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_select']['cl_telefono'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_select']['cl_email']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->cl_email = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_select']['cl_email'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_select']['tesoreria']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tesoreria = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_select']['tesoreria'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_select']['total']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->total = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_select']['total'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_select']['total_pago']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->total_pago = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_select']['total_pago'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_select']['cambio']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->cambio = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_select']['cambio'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['recarga'] = $this->nmgp_opcao;
      }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_recaudacion_creditos_contrato_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_recaudacion_creditos_contrato_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_recaudacion_creditos_contrato_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="form_recaudacion_creditos_contrato_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_recaudacion_creditos_contrato_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sis_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'form_recaudacion_creditos_contrato_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_recaudacion_creditos_contrato_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
//
//--------------------------------------------------------------------------------------
   function lookup_contrato(&$conteudo)
   {
      global  $contrato;
      $guarda_formatado = $this->formatado;
      $this->nm_tira_formatacao();
      ...
      $nm_comando = "SELECT con_numero_contrato 
FROM jap_contrato 
WHERE con_id = '$this->contrato' 
ORDER BY con_numero_contrato"; 
...
<?php
include_once("form_recaudacion_creditos_contrato_mob_sajax_js.php");
?>
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['opc_ant'] == "incluir")
      {
      ...
      {
          if (!isset($this->total) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form']['total']))
          {
              $varloc_btn_php['total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form']['total'];
          }
          if (!isset($this->forma_pago) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form']['forma_pago']))
          {
              $varloc_btn_php['forma_pago'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form']['forma_pago'];
          }
          if (!isset($this->libretin) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form']['libretin']))
          {
              $varloc_btn_php['libretin'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form']['libretin'];
          }
          if (!isset($this->valor_pago) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form']['valor_pago']))
          {
              $varloc_btn_php['valor_pago'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form']['valor_pago'];
          }
          if (!isset($this->saldo_por_pagar) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form']['saldo_por_pagar']))
          {
              $varloc_btn_php['saldo_por_pagar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form']['saldo_por_pagar'];
          }
          if (!isset($this->valor_pago) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form']['valor_pago']))
          {
              $varloc_btn_php['valor_pago'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form']['valor_pago'];
          ...
          if (!isset($this->cl_email) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form']['cl_email']))
          {
              $varloc_btn_php['cl_email'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form']['cl_email'];
          }
          if (!isset($this->cl_telefono) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form']['cl_telefono']))
          {
              $varloc_btn_php['cl_telefono'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form']['cl_telefono'];
          }
          if (!isset($this->cl_direccion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form']['cl_direccion']))
          {
              $varloc_btn_php['cl_direccion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form']['cl_direccion'];
          }
          if (!isset($this->cl_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form']['cl_id']))
          {
              $varloc_btn_php['cl_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form']['cl_id'];
          }
          if (!isset($this->libretin) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form']['libretin']))
          {
              $varloc_btn_php['libretin'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form']['libretin'];
          }
          if (!isset($this->tesoreria) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form']['tesoreria']))
          {
              $varloc_btn_php['tesoreria'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form']['tesoreria'];
          }
          if (!isset($this->forma_pago) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form']['forma_pago']))
          {
              $varloc_btn_php['forma_pago'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form']['forma_pago'];
          }
          if (!isset($this->documento) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form']['documento']))
          {
              $varloc_btn_php['documento'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form']['documento'];
          }
          if (!isset($this->contrato) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form']['contrato']))
          {
              $varloc_btn_php['contrato'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form']['contrato'];
          }
          if (!isset($this->cl_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form']['cl_id']))
          {
              $varloc_btn_php['cl_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form']['cl_id'];
          }
          if (!isset($this->rs_factura) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form']['rs_factura']))
          {
              $varloc_btn_php['rs_factura'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form']['rs_factura'];
          }
          if (!isset($this->rs_factura) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form']['rs_factura']))
          {
              $varloc_btn_php['rs_factura'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form']['rs_factura'];
      ...
      $nm_f_saida = "form_recaudacion_creditos_contrato_mob.php";
      if (!empty($this->field_config['saldo_por_pagar']['symbol_dec']))
      {
          nm_limpa_valor($this->saldo_por_pagar, $this->field_config['saldo_por_pagar']['symbol_dec'], $this->field_config['saldo_por_pagar']['symbol_grp']) ; 
      }
      ...
      $_SESSION['scriptcase']['form_recaudacion_creditos_contrato_mob']['contr_erro'] = 'on';
...
if (!isset($this->sc_temp_Igtech_SesionLogin)) {$this->sc_temp_Igtech_SesionLogin = (isset($_SESSION['Igtech_SesionLogin'])) ? $_SESSION['Igtech_SesionLogin'] : "";}
 ...
 if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "No ha seleccionado deudas para recaudar";
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_recaudacion_creditos_contrato_mob';
  } elseif ('submit_form' == $this->NM_ajax_opcao) {
   $sErrorIndex = 'geral_form_recaudacion_creditos_contrato_mob';
  } else {
   $sErrorIndex = substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
  }
  $this->NM_ajax_info['errList'][$sErrorIndex][] = "No ha seleccionado deudas para recaudar";
 }
;
...
if($this->valor_pago ==''){
 ...
 if (!isset($this->Campos_Mens_erro)){$this->Campos_Mens_erro = "";}
 if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "No ha establecido el valor a pagar";
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_recaudacion_creditos_contrato_mob';
  ...
  $this->NM_ajax_info['errList'][$sErrorIndex][] = "No ha establecido el valor a pagar";
 }
;
	if (isset($this->Campos_Mens_erro) && !empty($this->Campos_Mens_erro))
{
...
$w_valor_pago=$this->saldo_por_pagar +$this->valor_pago ;

if($w_valor_pago>=$this->total ){
	$w_valor_pago1=$this->saldo_por_pagar ;
	$w_valor_pago2=$this->total -$this->saldo_por_pagar ;
}else{
	$w_valor_pago1=$this->saldo_por_pagar ;
	$w_valor_pago2=$this->valor_pago ;
}

if ($this->cl_email <>'' and $this->cl_telefono <>'' and $this->cl_direccion <>'' ){

	$check_sql = "SELECT * from sp_factura_credito(
													".$this->cl_id .", 
													".$this->libretin ." , 
													".$this->tesoreria .",
													".$w_valor_pago1.",
													...
													'".$this->documento ."',
													".$this->contrato .") as (respuesta int,mensaje varchar);";
	...
	if ($this->rs[0][0]=="SI"){
		$select_sql="SELECT pfc_id_factura_pago
					FROM v_del_ventas_credito 
					INNER JOIN del_pago_facturas_credito ON fp_id=pfc_id_fp_factura
					INNER JOIN del_factura on del_pago_facturas_credito.pfc_id_factura_pago=del_factura.fac_numero
					WHERE fp_seleccion='S'
					AND fp_usuario_selecciona='".$this->sc_temp_Igtech_SesionLogin."'   
					AND v_del_ventas_credito.fac_cliente=".$this->cl_id ."
					and fac_asiento is null;";
		 
      $nm_select = $select_sql; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($this->rs_factura = $this->Db->Execute($nm_select)) 
      { }
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
		...
		if (false == $this->rs_factura ) {
			$var_mensaje='Error al acceder a la base de datos.';
		}else{
			$facturas=array();
			while(!$this->rs_factura->EOF){
				$this->facturas[]=$this->rs_factura->fields[0];
				$this->rs_factura->MoveNext();  
			}
			$this->rs_factura->Close();
			foreach($this->facturas as $factura){
				$this->enviaFactura($factura,$this->sc_temp_Igtech_RucEmpresa);
			}
		}	
	}
	$redir_app    = 'pdf_baucher_credito';  
	$redir_param  = array(     
						'var_cliente' => $this->cl_id ,
						'var_tipo_comprobante'=>'99',
					);
	$redir_target = '_blank';  
	 if (isset($this->sc_temp_Igtech_SesionLogin)) { $_SESSION['Igtech_SesionLogin'] = $this->sc_temp_Igtech_SesionLogin;}
 if (isset($this->sc_temp_Igtech_RucEmpresa)) { $_SESSION['Igtech_RucEmpresa'] = $this->sc_temp_Igtech_RucEmpresa;}
   ...
   function Recupera_Nome_Campo($campo) 
   {
       switch($campo)
       {
           ...
           case 'contrato':
               ...
               break;
           case 'tesoreria':
               return "" . $this->Ini->Nm_lang['lang_tesoreria'] . "";
               break;
           case 'saldo_por_pagar':
               return "" . $this->Ini->Nm_lang['lang_saldo_por_pagar'] . "";
               break;
           case 'usar_compensacion':
               return "Usar Comprensación";
               break;
           case 'forma_pago':
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_recaudacion_creditos_contrato_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_recaudacion_creditos_contrato_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_recaudacion_creditos_contrato_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_recaudacion_creditos_contrato_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'tesoreria' == $filtro)) || (is_array($filtro) && in_array('tesoreria', $filtro)))
        $this->ValidateField_tesoreria($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!is_array($filtro) && ('' == $filtro || 'saldo_por_pagar' == $filtro)) || (is_array($filtro) && in_array('saldo_por_pagar', $filtro)))
        $this->ValidateField_saldo_por_pagar($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!is_array($filtro) && ('' == $filtro || 'usar_compensacion' == $filtro)) || (is_array($filtro) && in_array('usar_compensacion', $filtro)))
        $this->ValidateField_usar_compensacion($Campos_Crit, $Campos_Falta, $Campos_Erros);
    ...
    function ValidateField_tesoreria(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
   if (isset($this->Field_no_validate['tesoreria'])) {
       return;
   }
               if (!empty($this->tesoreria) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['Lookup_tesoreria']) && !in_array($this->tesoreria, $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['Lookup_tesoreria']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($Campos_Erros['tesoreria']))
                   {
                       $Campos_Erros['tesoreria'] = array();
                   }
                   $Campos_Erros['tesoreria'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($this->NM_ajax_info['errList']['tesoreria']) || !is_array($this->NM_ajax_info['errList']['tesoreria']))
                   {
                       $this->NM_ajax_info['errList']['tesoreria'] = array();
                   }
                   $this->NM_ajax_info['errList']['tesoreria'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
               }
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'tesoreria';
    ...
    } // ValidateField_tesoreria

    function ValidateField_saldo_por_pagar(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['saldo_por_pagar'])) {
          if (!empty($this->field_config['saldo_por_pagar']['symbol_dec'])) {
              nm_limpa_valor($this->saldo_por_pagar, $this->field_config['saldo_por_pagar']['symbol_dec'], $this->field_config['saldo_por_pagar']['symbol_grp']) ; 
          }
          return;
      }
      if ($this->saldo_por_pagar === "" || is_null($this->saldo_por_pagar))  
      { 
          $this->saldo_por_pagar = 0;
          $this->sc_force_zero[] = 'saldo_por_pagar';
      } 
      if (!empty($this->field_config['saldo_por_pagar']['symbol_dec']))
      {
          nm_limpa_valor($this->saldo_por_pagar, $this->field_config['saldo_por_pagar']['symbol_dec'], $this->field_config['saldo_por_pagar']['symbol_grp']) ; 
          if ('.' == substr($this->saldo_por_pagar, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->saldo_por_pagar, 1)))
              {
                  $this->saldo_por_pagar = '';
              }
              else
              {
                  $this->saldo_por_pagar = '0' . $this->saldo_por_pagar;
              }
          }
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->saldo_por_pagar != '')  
          { 
              $iTestSize = 21;
              if (strlen($this->saldo_por_pagar) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_saldo_por_pagar'] . ": " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['saldo_por_pagar']))
                  {
                      $Campos_Erros['saldo_por_pagar'] = array();
                  }
                  $Campos_Erros['saldo_por_pagar'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['saldo_por_pagar']) || !is_array($this->NM_ajax_info['errList']['saldo_por_pagar']))
                  {
                      $this->NM_ajax_info['errList']['saldo_por_pagar'] = array();
                  }
                  $this->NM_ajax_info['errList']['saldo_por_pagar'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->saldo_por_pagar, 18, 2, -0, 1.0E+20, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_saldo_por_pagar'] . "; " ; 
                  if (!isset($Campos_Erros['saldo_por_pagar']))
                  {
                      $Campos_Erros['saldo_por_pagar'] = array();
                  }
                  $Campos_Erros['saldo_por_pagar'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['saldo_por_pagar']) || !is_array($this->NM_ajax_info['errList']['saldo_por_pagar']))
                  {
                      $this->NM_ajax_info['errList']['saldo_por_pagar'] = array();
                  }
                  $this->NM_ajax_info['errList']['saldo_por_pagar'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'saldo_por_pagar';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_saldo_por_pagar

    function ValidateField_usar_compensacion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
   if (isset($this->Field_no_validate['usar_compensacion'])) {
       return;
   }
      if ($this->usar_compensacion == "" && $this->nmgp_opcao != "excluir")
      { 
      ...
      { 
          if (is_array($this->usar_compensacion))
          {
              ...
              foreach ($this->usar_compensacion as $ind => $dados_usar_compensacion_1 ) 
              {
                  if ($dados_usar_compensacion_1 != "") 
                  {
                      $this->usar_compensacion_1[] = $dados_usar_compensacion_1;
                  } 
              } 
              $this->usar_compensacion = ""; 
              foreach ($this->usar_compensacion_1 as $dados_usar_compensacion_1 ) 
        ...
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'usar_compensacion';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_usar_compensacion
   ...
   if (isset($this->Field_no_validate['forma_pago'])) {
       return;
               ...
               if (!empty($this->forma_pago) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['Lookup_forma_pago']) && !in_array($this->forma_pago, $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['Lookup_forma_pago']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['libretin'])) {
       return;
               ...
               if (!empty($this->libretin) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['Lookup_libretin']) && !in_array($this->libretin, $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['Lookup_libretin']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_cambio(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['cambio'])) {
          if (!empty($this->field_config['cambio']['symbol_dec'])) {
              nm_limpa_valor($this->cambio, $this->field_config['cambio']['symbol_dec'], $this->field_config['cambio']['symbol_grp']) ; 
          }
          return;
   ...
   function nm_guardar_campos()
   {
    ...
    $this->nmgp_dados_form['tesoreria'] = $this->tesoreria;
    $this->nmgp_dados_form['saldo_por_pagar'] = $this->saldo_por_pagar;
    $this->nmgp_dados_form['usar_compensacion'] = $this->usar_compensacion;
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_form'] = $this->nmgp_dados_form;
   }
   function nm_tira_formatacao()
   {
      ...
      $this->Before_unformat['saldo_por_pagar'] = $this->saldo_por_pagar;
      if (!empty($this->field_config['saldo_por_pagar']['symbol_dec']))
      {
         nm_limpa_valor($this->saldo_por_pagar, $this->field_config['saldo_por_pagar']['symbol_dec'], $this->field_config['saldo_por_pagar']['symbol_grp']);
      }
   ...
   function nm_formatar_campos($format_fields = array())
   {
     ...
     $this->formatado = true;
      if ('' !== $this->saldo_por_pagar || (!empty($format_fields) && isset($format_fields['saldo_por_pagar'])))
      {
          nmgp_Form_Num_Val($this->saldo_por_pagar, $this->field_config['saldo_por_pagar']['symbol_grp'], $this->field_config['saldo_por_pagar']['symbol_dec'], "2", "S", $this->field_config['saldo_por_pagar']['format_neg'], "", "", "-", $this->field_config['saldo_por_pagar']['symbol_fmt']) ; 
      }
...
//
   ...
   function ajax_return_values()
   {
          ...
          $this->ajax_return_values_tesoreria();
          $this->ajax_return_values_saldo_por_pagar();
          $this->ajax_return_values_usar_compensacion();
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['cl_id']['keyVal'] = form_recaudacion_creditos_contrato_mob_pack_protect_string($this->nmgp_dados_form['cl_id']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['grid_v_del_ventas_credito_contrato_script_case_init'] ]['grid_v_del_ventas_credito_contrato']['embutida_form_full'] = false;
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['grid_v_del_ventas_credito_contrato_script_case_init'] ]['grid_v_del_ventas_credito_contrato']['embutida_form']       = true;
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['grid_v_del_ventas_credito_contrato_script_case_init'] ]['grid_v_del_ventas_credito_contrato']['embutida_pai']        = "form_recaudacion_creditos_contrato_mob";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['grid_v_del_ventas_credito_contrato_script_case_init'] ]['grid_v_del_ventas_credito_contrato']['embutida_form_parms'] = "var_propietario*scin" . $this->nmgp_dados_form['cl_id'] . "*scoutvar_contrato*scin" . $this->nmgp_dados_form['contrato'] . "*scoutNMSC_inicial*scininicio*scoutNMSC_paginacao*scinFULL*scoutNMSC_cab*scinN*scoutNMSC_nav*scinN*scout";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['grid_v_del_ventas_credito_contrato_script_case_init'] ]['grid_v_del_ventas_credito_contrato']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['grid_v_del_ventas_credito_contrato_script_case_init'] ]['grid_v_del_ventas_credito_contrato']['total']);
              foreach ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['grid_v_del_ventas_credito_contrato_script_case_init'] ]['grid_v_del_ventas_credito_contrato'] as $i => $v)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['grid_v_del_ventas_credito_contrato_script_case_init'] ]['grid_v_del_ventas_credito_contrato'][$i] = $v;
              }
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['grid_v_del_ventas_credito_contrato_script_case_init'] ]['grid_v_del_ventas_credito_contrato']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['grid_v_del_ventas_credito_contrato_script_case_init'] ]['grid_v_del_ventas_credito_contrato']['total']);
              }
          }
   ...
   function ajax_return_values_contrato($bForce = false)
   {
          ...
          $this->NM_ajax_info['fldList']['contrato'] = array(
              ...
              $orig_contrato = $this->contrato;
              $contrato      = $this->contrato;
              $this->contrato = $contrato;
              $this->lookup_contrato($conteudo);
              $this->contrato = $orig_contrato;
              $this->NM_ajax_info['fldList']['contrato']['lookupCons'] = form_recaudacion_creditos_contrato_mob_pack_protect_string(NM_charset_to_utf8($conteudo));
          }
   }

          //----- tesoreria
   function ajax_return_values_tesoreria($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("tesoreria", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->tesoreria);
              $aLookup = array();
              $this->_tmp_lookup_tesoreria = $this->tesoreria;

 
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['Lookup_tesoreria']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['Lookup_tesoreria'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['Lookup_tesoreria']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['Lookup_tesoreria'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_recaudacion_creditos_contrato_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_recaudacion_creditos_contrato_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['Lookup_tesoreria'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"tesoreria\"";
          if (isset($this->NM_ajax_info['select_html']['tesoreria']) && !empty($this->NM_ajax_info['select_html']['tesoreria']))
          {
              $sSelComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['tesoreria']);
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->tesoreria == $sValue)
                  {
                      $this->_tmp_lookup_tesoreria = $sLabel;
                  }
          ...
          $aLookup  = $sLookup;
          $this->NM_ajax_info['fldList']['tesoreria'] = array(
                       'row'    => '',
               'type'    => 'select',
               'valList' => array($sTmpValue),
               'optList' => $aLookup,
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['tesoreria']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['tesoreria']['valList'][$i] = form_recaudacion_creditos_contrato_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['tesoreria']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['tesoreria']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['tesoreria']['labList'] = $aLabel;
          }
   }

          //----- saldo_por_pagar
   function ajax_return_values_saldo_por_pagar($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("saldo_por_pagar", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->saldo_por_pagar);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['saldo_por_pagar'] = array(
                       'row'    => '',
               'type'    => 'label',
               'valList' => array($sTmpValue),
              );
          ...
          //----- usar_compensacion
   function ajax_return_values_usar_compensacion($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("usar_compensacion", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->usar_compensacion);
              $aLookup = array();
              $this->_tmp_lookup_usar_compensacion = $this->usar_compensacion;

$aLookup[] = array(form_recaudacion_creditos_contrato_mob_pack_protect_string('S') => str_replace('<', '&lt;',form_recaudacion_creditos_contrato_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['Lookup_usar_compensacion'][] = 'S';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          if (isset($this->NM_ajax_info['select_html']['usar_compensacion']) && !empty($this->NM_ajax_info['select_html']['usar_compensacion']))
          {
              $sOptComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['usar_compensacion']);
          }
          $this->NM_ajax_info['fldList']['usar_compensacion'] = array(
                       'row'    => '',
               'type'    => 'checkbox',
               'switch'  => true,
               ...
               'colNum'  => 1,
               'optComp'  => $sOptComp,
               'optClass' => 'sc-ui-checkbox-usar_compensacion',
              );
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['usar_compensacion']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['usar_compensacion']['valList'][$i] = form_recaudacion_creditos_contrato_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['usar_compensacion']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['usar_compensacion']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['usar_compensacion']['labList'] = $aLabel;
          }
   }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['Lookup_forma_pago']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['Lookup_forma_pago'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['Lookup_forma_pago']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['Lookup_forma_pago'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   $nm_comando = "SELECT fp_id, fp_descripcion  FROM del_forma_pago  WHERE fp_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "' and fp_tipo<>'CRÉDITO' AND fp_compra_venta in ('VENTAS','TODOS') ORDER BY fp_descripcion";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['Lookup_forma_pago'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['forma_pago']['valList'][$i] = form_recaudacion_creditos_contrato_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['Lookup_libretin']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['Lookup_libretin'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['Lookup_libretin']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['Lookup_libretin'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['Lookup_libretin'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['libretin']['valList'][$i] = form_recaudacion_creditos_contrato_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_cl_id($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
   ...
   function ajax_add_parameters()
   {
       ...
       $this->NM_ajax_info['btnVars']['var_btn_btn_salir_var_propietario'] = $this->form_encode_input($this->nmgp_dados_form['cl_id']);
   } // ajax_add_parameters
  function nm_proc_onload($bFormat = true)
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['Field_no_validate'] = array();
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    $original_saldo_por_pagar = $this->saldo_por_pagar;
    $original_tesoreria = $this->tesoreria;
...
if (!isset($this->sc_temp_Igtech_SesionLogin)) {$this->sc_temp_Igtech_SesionLogin = (isset($_SESSION['Igtech_SesionLogin'])) ? $_SESSION['Igtech_SesionLogin'] : "";}
if (!isset($this->sc_temp_Igtech_RucEmpresa)) {$this->sc_temp_Igtech_RucEmpresa = (isset($_SESSION['Igtech_RucEmpresa'])) ? $_SESSION['Igtech_RucEmpresa'] : "";}
if (!isset($this->sc_temp_var_contrato)) {$this->sc_temp_var_contrato = (isset($_SESSION['var_contrato'])) ? $_SESSION['var_contrato'] : "";}
  $this->titulo = $this->Ini->Nm_lang['lang_pago_fc'] ;
$this->contrato =$this->sc_temp_var_contrato;

$select_sql="SELECT fp_id 
			 FROM del_forma_pago 
			 WHERE fp_empresa='".$this->sc_temp_Igtech_RucEmpresa."' 
			 and fp_compra_venta='NC'";
 
      $nm_select = $select_sql; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->rs_tesoreria = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
          $nm_count = $SCrx->FieldCount();
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                      $this->rs_tesoreria[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
          } 
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->rs_tesoreria = false;
          $this->rs_tesoreria_erro = $this->Db->ErrorMsg();
      } 

if(isset($this->rs_tesoreria[0][0])){
	$this->tesoreria =$this->rs_tesoreria[0][0];
	$this->saldo_por_pagar =0;
...
if (isset($this->sc_temp_var_contrato)) { $_SESSION['var_contrato'] = $this->sc_temp_var_contrato;}
if (isset($this->sc_temp_Igtech_RucEmpresa)) { $_SESSION['Igtech_RucEmpresa'] = $this->sc_temp_Igtech_RucEmpresa;}
if (isset($this->sc_temp_Igtech_SesionLogin)) { $_SESSION['Igtech_SesionLogin'] = $this->sc_temp_Igtech_SesionLogin;}
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    if (($original_saldo_por_pagar != $this->saldo_por_pagar || (isset($bFlagRead_saldo_por_pagar) && $bFlagRead_saldo_por_pagar)))
    {
        $this->ajax_return_values_saldo_por_pagar(true);
    }
    if (($original_tesoreria != $this->tesoreria || (isset($bFlagRead_tesoreria) && $bFlagRead_tesoreria)))
    {
        $this->ajax_return_values_tesoreria(true);
    }
...
//
   ...
   { 
      $this->saldo_por_pagar = str_replace($sc_parm1, $sc_parm2, $this->saldo_por_pagar); 
      $this->valor_pago = str_replace($sc_parm1, $sc_parm2, $this->valor_pago); 
      $this->total = str_replace($sc_parm1, $sc_parm2, $this->total); 
      $this->total_pago = str_replace($sc_parm1, $sc_parm2, $this->total_pago); 
      $this->cambio = str_replace($sc_parm1, $sc_parm2, $this->cambio); 
   } 
   function nm_poe_aspas_decimal() 
   { 
      $this->saldo_por_pagar = "'" . $this->saldo_por_pagar . "'";
      $this->valor_pago = "'" . $this->valor_pago . "'";
      $this->total = "'" . $this->total . "'";
      $this->total_pago = "'" . $this->total_pago . "'";
      $this->cambio = "'" . $this->cambio . "'";
   } 
   function nm_tira_aspas_decimal() 
   { 
      $this->saldo_por_pagar = str_replace("'", "", $this->saldo_por_pagar); 
      $this->valor_pago = str_replace("'", "", $this->valor_pago); 
      $this->total = str_replace("'", "", $this->total); 
      $this->total_pago = str_replace("'", "", $this->total_pago); 
      $this->cambio = str_replace("'", "", $this->cambio); 
   } 
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->cl_id)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['opcao'] = '';
   ...
   { 
      ...
      $NM_val_form['tesoreria'] = $this->tesoreria;
      $NM_val_form['saldo_por_pagar'] = $this->saldo_por_pagar;
      $NM_val_form['usar_compensacion'] = $this->usar_compensacion;
      ...
      $NM_val_form['total_pago'] = $this->total_pago;
      $NM_val_form['cambio'] = $this->cambio;
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
              ...
              $this->nmgp_refresh_fields = array_diff(array('titulo', 'mensaje', 'cl_identificacion', 'cl_nombre', 'cl_direccion', 'cl_telefono', 'cl_email', 'contrato', 'tesoreria', 'saldo_por_pagar', 'usar_compensacion', 'forma_pago', 'valor_pago', 'documento', 'libretin', 'total', 'total_pago', 'cambio', 'facturas'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['total']);
              }
              ...
              $this->NM_gera_log_new();
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['parms'] = "cl_id?#?$this->cl_id?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['select'] = ""; 
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['where_filter']))
              {
                  ...
                  $this->NM_ajax_info['buttonDisplay']['btn_salir'] = $this->nmgp_botoes['btn_salir'] = "off";
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_select'] = $this->nmgp_dados_select;
...
//-- 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['embutida_parms'] = "var_propietario*scin" . $this->nmgp_dados_form['cl_id'] . "*scoutvar_contrato*scin" . $this->nmgp_dados_form['contrato'] . "*scoutNMSC_inicial*scininicio*scoutNMSC_paginacao*scinFULL*scoutNMSC_cab*scinN*scoutNMSC_nav*scinN*scout";
  }
// 
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dados_select'];
   ...
   function NM_gera_log_output() 
   {
       ...
       $this->NM_gera_log_insert("Scriptcase", $this->SC_log_evt, $Log_output);
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }

//
function usar_compensacion_onClick()
{
$_SESSION['scriptcase']['form_recaudacion_creditos_contrato_mob']['contr_erro'] = 'on';
  
$original_usar_compensacion = $this->usar_compensacion;
$original_contrato = $this->contrato;
$original_saldo_por_pagar = $this->saldo_por_pagar;
$original_valor_pago = $this->valor_pago;
...
if($this->usar_compensacion =='S'){
	$select_sql="SELECT cxp_valor 
				 FROM v_del_cuentas_por_pagar_cliente_contrato 
				 WHERE cxp_cliente=".$this->cl_id .
				"and cxp_contrato=".$this->contrato ;
      ...
      { 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                      $this->rs_cxp[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
          } 
      ...
      { 
          $this->rs_cxp = false;
          $this->rs_cxp_erro = $this->Db->ErrorMsg();
      } 

	if(isset($this->rs_cxp[0][0])){
		$this->saldo_por_pagar =$this->rs_cxp[0][0];
	}else{
		$this->saldo_por_pagar =0;
	}	
}else{
...
$w_valor_pago=$this->saldo_por_pagar  + $this->valor_pago ;
$this->total_pago =$w_valor_pago;
if($w_valor_pago>=$this->total ){
	$sc_tmp_field_name = 'cambio';
$this->NM_ajax_info['fieldLabel'][$sc_tmp_field_name] = $this->nm_new_label[$sc_tmp_field_name] = $this->Ini->Nm_lang['lang_cambio'] ;
	$this->cambio =round($w_valor_pago-$this->total ,2);
}else{
	$sc_tmp_field_name = 'cambio';
$this->NM_ajax_info['fieldLabel'][$sc_tmp_field_name] = $this->nm_new_label[$sc_tmp_field_name] ='Saldo';
	$this->cambio =round($this->total -$w_valor_pago,2);
}

$modificado_usar_compensacion = $this->usar_compensacion;
$modificado_contrato = $this->contrato;
$modificado_saldo_por_pagar = $this->saldo_por_pagar;
...
$this->nm_formatar_campos('usar_compensacion', 'contrato', 'saldo_por_pagar', 'valor_pago', 'total_pago', 'total', 'cambio');
if ($original_usar_compensacion !== $modificado_usar_compensacion || isset($this->nmgp_cmp_readonly['usar_compensacion']) || (isset($bFlagRead_usar_compensacion) && $bFlagRead_usar_compensacion))
{
    $this->ajax_return_values_usar_compensacion(true);
}
...
if ($original_saldo_por_pagar !== $modificado_saldo_por_pagar || isset($this->nmgp_cmp_readonly['saldo_por_pagar']) || (isset($bFlagRead_saldo_por_pagar) && $bFlagRead_saldo_por_pagar))
{
    $this->ajax_return_values_saldo_por_pagar(true);
}
...
$this->NM_ajax_info['event_field'] = 'usar';
form_recaudacion_creditos_contrato_mob_pack_ajax_response();
exit;
$_SESSION['scriptcase']['form_recaudacion_creditos_contrato_mob']['contr_erro'] = 'off';
}
...
$modificado_total = $this->total;
$modificado_cambio = $this->cambio;
$this->nm_formatar_campos('valor_pago', 'saldo_por_pagar', 'total_pago', 'total', 'cambio');
if ($original_valor_pago !== $modificado_valor_pago || isset($this->nmgp_cmp_readonly['valor_pago']) || (isset($bFlagRead_valor_pago) && $bFlagRead_valor_pago))
{
    $this->ajax_return_values_valor_pago(true);
}
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_recaudacion_creditos_contrato_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['csrf_token'];
    }
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function Form_lookup_tesoreria()
   {
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['Lookup_tesoreria']))
{
...
else
{
   ...
   function Form_lookup_usar_compensacion()
   {
       $nmgp_def_dados  = "";
       $nmgp_def_dados .= "?#?S?#?N?@?";
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_recaudacion_creditos_contrato_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['total'] = $qt_geral_reg_form_recaudacion_creditos_contrato_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_recaudacion_creditos_contrato_mob_pack_ajax_response();
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_recaudacion_creditos_contrato_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_recaudacion_creditos_contrato_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['retorno_edit'] = "";
   }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function getButtonIds($buttonName) {
        switch ($buttonName) {
            ...
            case "facturar":
                ...
                break;
            case "exit":
                return array("sc_b_sai_t.sc-unique-btn-1", "sc_b_sai_t.sc-unique-btn-2", "sc_b_sai_t.sc-unique-btn-4", "sc_b_sai_t.sc-unique-btn-3");
                break;
            case "help":
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_creditos_contrato_mob']['ordem_ord'] == " desc") {
