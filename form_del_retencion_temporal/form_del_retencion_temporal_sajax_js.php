  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_retencion_temporal" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_retencion_temporal_form();
	}
...
?>
  ...
  function do_ajax_form_del_retencion_temporal_validate_dr_cod_doc_sustento()
  {
    ...
    x_ajax_form_del_retencion_temporal_validate_dr_cod_doc_sustento(var_dr_cod_doc_sustento, var_script_case_init, do_ajax_form_del_retencion_temporal_validate_dr_cod_doc_sustento_cb);
  } // do_ajax_form_del_retencion_temporal_validate_dr_cod_doc_sustento

  function do_ajax_form_del_retencion_temporal_validate_dr_cod_doc_sustento_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_retencion_temporal_validate_dr_cod_doc_sustento_cb

  // ---------- Validate dr_serie_doc_sustento
  function do_ajax_form_del_retencion_temporal_validate_dr_serie_doc_sustento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_retencion_temporal_validate_dr_serie_doc_sustento(var_dr_serie_doc_sustento, var_script_case_init, do_ajax_form_del_retencion_temporal_validate_dr_serie_doc_sustento_cb);
  } // do_ajax_form_del_retencion_temporal_validate_dr_serie_doc_sustento

  function do_ajax_form_del_retencion_temporal_validate_dr_serie_doc_sustento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_retencion_temporal_validate_dr_serie_doc_sustento_cb

  // ---------- Validate dr_secuencia_doc_sustento
  function do_ajax_form_del_retencion_temporal_validate_dr_secuencia_doc_sustento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_retencion_temporal_validate_dr_secuencia_doc_sustento(var_dr_secuencia_doc_sustento, var_script_case_init, do_ajax_form_del_retencion_temporal_validate_dr_secuencia_doc_sustento_cb);
  } // do_ajax_form_del_retencion_temporal_validate_dr_secuencia_doc_sustento

  function do_ajax_form_del_retencion_temporal_validate_dr_secuencia_doc_sustento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_retencion_temporal_validate_dr_secuencia_doc_sustento_cb

  // ---------- Validate dr_fecha_emision_doc_sustento
  function do_ajax_form_del_retencion_temporal_validate_dr_fecha_emision_doc_sustento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_retencion_temporal_validate_dr_fecha_emision_doc_sustento(var_dr_fecha_emision_doc_sustento, var_script_case_init, do_ajax_form_del_retencion_temporal_validate_dr_fecha_emision_doc_sustento_cb);
  } // do_ajax_form_del_retencion_temporal_validate_dr_fecha_emision_doc_sustento

  function do_ajax_form_del_retencion_temporal_validate_dr_fecha_emision_doc_sustento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_retencion_temporal_validate_dr_fecha_emision_doc_sustento_cb

  // ---------- Validate dr_fecha_caducidad
  function do_ajax_form_del_retencion_temporal_validate_dr_fecha_caducidad()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_retencion_temporal_validate_dr_fecha_caducidad(var_dr_fecha_caducidad, var_script_case_init, do_ajax_form_del_retencion_temporal_validate_dr_fecha_caducidad_cb);
  } // do_ajax_form_del_retencion_temporal_validate_dr_fecha_caducidad

  function do_ajax_form_del_retencion_temporal_validate_dr_fecha_caducidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_retencion_temporal_validate_dr_fecha_caducidad_cb

  // ---------- Validate dr_id
  function do_ajax_form_del_retencion_temporal_validate_dr_id()
  {
    var nomeCampo_dr_id = "dr_id";
    var var_dr_id = scAjaxGetFieldHidden(nomeCampo_dr_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_retencion_temporal_validate_dr_id(var_dr_id, var_script_case_init, do_ajax_form_del_retencion_temporal_validate_dr_id_cb);
  } // do_ajax_form_del_retencion_temporal_validate_dr_id

  function do_ajax_form_del_retencion_temporal_validate_dr_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dr_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_retencion_temporal_validate_dr_id_cb

  // ---------- Validate dr_empresa
  function do_ajax_form_del_retencion_temporal_validate_dr_empresa()
  {
    var nomeCampo_dr_empresa = "dr_empresa";
    var var_dr_empresa = scAjaxGetFieldText(nomeCampo_dr_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_retencion_temporal_validate_dr_empresa(var_dr_empresa, var_script_case_init, do_ajax_form_del_retencion_temporal_validate_dr_empresa_cb);
  } // do_ajax_form_del_retencion_temporal_validate_dr_empresa

  function do_ajax_form_del_retencion_temporal_validate_dr_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_retencion_temporal_validate_dr_empresa_cb

  // ---------- Validate dr_retencion
  function do_ajax_form_del_retencion_temporal_validate_dr_retencion()
  {
    var nomeCampo_dr_retencion = "dr_retencion";
    var var_dr_retencion = scAjaxGetFieldText(nomeCampo_dr_retencion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_retencion_temporal_validate_dr_retencion(var_dr_retencion, var_script_case_init, do_ajax_form_del_retencion_temporal_validate_dr_retencion_cb);
  } // do_ajax_form_del_retencion_temporal_validate_dr_retencion

  function do_ajax_form_del_retencion_temporal_validate_dr_retencion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_retencion_temporal_validate_dr_retencion_cb

  // ---------- Validate retenciones
  function do_ajax_form_del_retencion_temporal_validate_retenciones()
  {
    var nomeCampo_retenciones = "retenciones";
    var var_retenciones = scAjaxGetFieldText(nomeCampo_retenciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_retencion_temporal_validate_retenciones(var_retenciones, var_script_case_init, do_ajax_form_del_retencion_temporal_validate_retenciones_cb);
  } // do_ajax_form_del_retencion_temporal_validate_retenciones

  function do_ajax_form_del_retencion_temporal_validate_retenciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_retencion_temporal_validate_retenciones_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_retencion_temporal_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_retencion_temporal_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_del_retencion_temporal_submit_form(var_dr_cod_doc_sustento, var_dr_serie_doc_sustento, var_dr_secuencia_doc_sustento, var_dr_fecha_emision_doc_sustento, var_dr_fecha_caducidad, var_dr_id, var_dr_empresa, var_dr_retencion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_retencion_temporal_submit_form_cb);
  } // do_ajax_form_del_retencion_temporal_submit_form

  function do_ajax_form_del_retencion_temporal_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_retencion_temporal_submit_form_cb_after_alert);
  } // do_ajax_form_del_retencion_temporal_submit_form_cb
  function do_ajax_form_del_retencion_temporal_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_retencion_temporal_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_del_impuestos_retenidos"] = "off";

  function do_ajax_form_del_retencion_temporal_navigate_form()
  {
    perform_ajax_form_del_retencion_temporal_navigate_form();
  }

  function perform_ajax_form_del_retencion_temporal_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_del_impuestos_retenidos"] = "on";
    x_ajax_form_del_retencion_temporal_navigate_form(var_dr_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_retencion_temporal_navigate_form_cb);
  } // do_ajax_form_del_retencion_temporal_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_retencion_temporal']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_retencion_temporal_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_del_impuestos_retenidos"] && "nmsc_iframe_liga_form_del_impuestos_retenidos" != scMasterDetailIframe["nmsc_iframe_liga_form_del_impuestos_retenidos"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_del_impuestos_retenidos"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_del_impuestos_retenidos').contentWindow.nm_move('apl_detalhe', true, '500');
        document.getElementById('nmsc_iframe_liga_form_del_impuestos_retenidos').style.height = "500";
        document.getElementById('nmsc_iframe_liga_form_del_impuestos_retenidos').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_retencion_temporal_navigate_form_cb_after_alert);
  } // do_ajax_form_del_retencion_temporal_navigate_form_cb
  function do_ajax_form_del_retencion_temporal_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_del_retencion_temporal_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_retencion_temporal_navigate_form_cb_after_alert

  function sc_hide_form_del_retencion_temporal_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_del_impuestos_retenidos"])
    {
      return true;
    }
    return false;
