...
function scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="")
{
    ...
    if (isset($_SESSION['scriptcase']['grid_v_sis_reporte_ventas_comisionistas']['contr_erro']) && $_SESSION['scriptcase']['grid_v_sis_reporte_ventas_comisionistas']['contr_erro'] == 'on')
    {
