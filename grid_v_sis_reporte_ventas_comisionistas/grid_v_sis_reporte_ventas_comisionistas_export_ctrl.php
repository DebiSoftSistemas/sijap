<?php
@session_start() ;
$_SESSION['scriptcase']['grid_v_sis_reporte_ventas_comisionistas']['sc_process_barr'] = true;
require_once('../grid_v_sis_reporte_ventas_comisionistas/index.php');
unset($_SESSION['scriptcase']['grid_v_sis_reporte_ventas_comisionistas']['sc_process_barr']);
$ExportCtrl = new grid_v_sis_reporte_ventas_comisionistas_export_control;
$ExportCtrl->Export_barr();

class grid_v_sis_reporte_ventas_comisionistas_export_control
{
