...
<?php
   ...
   $Ord_Cmp = new grid_v_sis_reporte_ventas_comisionistas_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_v_sis_reporte_ventas_comisionistas_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["fac_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['labels']["fac_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['labels']["fac_fecha"] : "" . $this->Nm_lang['lang_fecha'] . "";
   $tab_ger_campos['mes'] = "on";
   $tab_def_campos['mes'] = "mes";
   $tab_labels["mes"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['labels']["mes"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['labels']["mes"] : "" . $this->Nm_lang['lang_srch_mnth'] . "";
   $tab_ger_campos['periodo'] = "on";
   $tab_def_campos['periodo'] = "periodo";
   $tab_labels["periodo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['labels']["periodo"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['labels']["periodo"] : "" . $this->Nm_lang['lang_periodo'] . "";
   $tab_ger_campos['emp_ruc'] = "on";
   $tab_def_campos['emp_ruc'] = "emp_ruc";
   $tab_labels["emp_ruc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['labels']["emp_ruc"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['labels']["emp_ruc"] : "" . $this->Nm_lang['lang_cliente'] . "";
   $tab_ger_campos['emp_razon_social'] = "on";
   $tab_def_campos['emp_razon_social'] = "emp_razon_social";
   $tab_labels["emp_razon_social"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['labels']["emp_razon_social"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['labels']["emp_razon_social"] : "" . $this->Nm_lang['lang_razon_social'] . "";
   $tab_ger_campos['fac_serie'] = "on";
   $tab_def_campos['fac_serie'] = "fac_serie";
   $tab_labels["fac_serie"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['labels']["fac_serie"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['labels']["fac_serie"] : "" . $this->Nm_lang['lang_serie_sri'] . "";
   $tab_ger_campos['fac_numero_doc'] = "on";
   $tab_def_campos['fac_numero_doc'] = "fac_numero_doc";
   $tab_labels["fac_numero_doc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['labels']["fac_numero_doc"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['labels']["fac_numero_doc"] : "" . $this->Nm_lang['lang_secuencial'] . "";
   $tab_ger_campos['fac_base_iva'] = "on";
   $tab_def_campos['fac_base_iva'] = "fac_base_iva";
   $tab_labels["fac_base_iva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['labels']["fac_base_iva"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['labels']["fac_base_iva"] : "" . $this->Nm_lang['lang_base_iva'] . "";
   $tab_ger_campos['fac_total_iva'] = "on";
   $tab_def_campos['fac_total_iva'] = "fac_total_iva";
   $tab_labels["fac_total_iva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['labels']["fac_total_iva"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['labels']["fac_total_iva"] : "" . $this->Nm_lang['lang_iva'] . "";
   $tab_ger_campos['fac_total'] = "on";
   $tab_def_campos['fac_total'] = "fac_total";
   $tab_labels["fac_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['labels']["fac_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['labels']["fac_total"] : "" . $this->Nm_lang['lang_total'] . "";
   $tab_ger_campos['com_ruc'] = "on";
   $tab_def_campos['com_ruc'] = "com_ruc";
   $tab_labels["com_ruc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['labels']["com_ruc"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['labels']["com_ruc"] : "" . $this->Nm_lang['lang_comisionistas'] . "";
   $tab_ger_campos['com_razon_social'] = "on";
   $tab_def_campos['com_razon_social'] = "com_razon_social";
   $tab_labels["com_razon_social"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['labels']["com_razon_social"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['labels']["com_razon_social"] : "" . $this->Nm_lang['lang_nombre'] . "";
   $tab_ger_campos['com_porcentaje_comision'] = "on";
   $tab_def_campos['com_porcentaje_comision'] = "com_porcentaje_comision";
   $tab_labels["com_porcentaje_comision"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['labels']["com_porcentaje_comision"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['labels']["com_porcentaje_comision"] : "" . $this->Nm_lang['lang_porcentaje_comision'] . "";
   $tab_ger_campos['valor_comision'] = "on";
   $tab_def_campos['valor_comision'] = "valor_comision";
   $tab_labels["valor_comision"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['labels']["valor_comision"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['labels']["valor_comision"] : "Valor Comisión";
   $tab_ger_campos['fac_primera_compra'] = "on";
   $tab_def_campos['fac_primera_compra'] = "fac_primera_compra";
   $tab_labels["fac_primera_compra"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['labels']["fac_primera_compra"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['labels']["fac_primera_compra"] : "Primera Compra";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_v_sis_reporte_ventas_comisionistas_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_v_sis_reporte_ventas_comisionistas']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
