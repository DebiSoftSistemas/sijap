<?php
class grid_v_cartera_recuperada_ind_grid
{
   var $Ini;
   var $Erro;
   var $Db;
...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_recuperada_ind']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_recuperada_ind']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_recuperada_ind']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['usr_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['usr_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['usr_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['grid_pesq'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['grid_pesq'] = array();
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['charts_html'] = '';
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida'])
   { 
   ...
   { 
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['proc_pdf_vert'])
            {
            } 
            else
            {
       ...
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_v_cartera_recuperada_ind'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'];
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_top();
       } 
       if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao_print'] != 'print')
       { 
           if ($this->Ini->grid_search_change_fil)
           { 
               $seq_search = 1;
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['grid_pesq'] as $cmp => $def)
               {
                  $Seq_grid      = $seq_search;
                  $Cmp_grid      = $cmp;
       ...
       unset ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['save_grid']);
       $this->grid();
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_bot();
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['print_all'] && empty($this->nm_grid_sem_reg) && ($Gera_res || $Gera_graf))
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] == "pdf")
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] == "pdf")
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] = "igual";
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'];
 }
...
//
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['orig_pesq'] = "grid";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['Ind_lig_mult'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['Ind_lig_mult'] = 0;
   }
   $this->Img_embbed      = false;
   $this->nm_data         = new nm_data("es");
   $this->pdf_label_group = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opc_pdf']['label_group'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opc_pdf']['label_group'] : "N";
   $this->pdf_all_cab     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opc_pdf']['all_cab']))     ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opc_pdf']['all_cab'] : "S";
   $this->pdf_all_label   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opc_pdf']['all_label']))   ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opc_pdf']['all_label'] : "S";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opc_liga']['fix_top'])) {
       $this->Fix_bar_top = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opc_liga']['fix_top'] == "S") ? true : false;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opc_liga']['fix_bot'])) {
       $this->Fix_bar_bottom = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opc_liga']['fix_bot'] == "S") ? true : false;
   }
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "grid_v_cartera_recuperada_ind/grid_v_cartera_recuperada_ind_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   foreach ($NM_css as $cada_css)
   {
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['doc_word'])
       { 
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['pesq_tab_label']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['pesq_tab_label'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['pesq_tab_label'] .= "con_numero_contrato?#?" . "" . $this->Ini->Nm_lang['lang_numero_contrato'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['pesq_tab_label'] .= "con_numero_medidor?#?" . "" . $this->Ini->Nm_lang['lang_numero_medidor'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['pesq_tab_label'] .= "op_fecha_ini?#?" . "" . $this->Ini->Nm_lang['lang_fecha_inicio'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['pesq_tab_label'] .= "fac_fecha?#?" . "" . $this->Ini->Nm_lang['lang_fecha'] . "" . "?@?";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['grid_search_add']))
   {
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['pesq_tab_label'];
       ...
       $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['grid_search_add']['seq'];
       $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['grid_search_add']['cmp'];
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['grid_search_add']);
       exit;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['dyn_search_aut_comp']))
   {
       $Cmp_select2 = array("con_numero_contrato","con_numero_medidor");
       $NM_func_aut_comp = "lookup_ajax_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['dyn_search_aut_comp']['cmp'];
       ...
       foreach ($nmgp_def_dados as $Ind => $Lista)
       {
          if (is_array($Lista))
          {
              foreach ($Lista as $Cod => $Valor)
              {
                  ...
                  if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['dyn_search_aut_comp']['cmp'], $Cmp_select2))
                  {
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['dyn_search_aut_comp']);
       exit;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida'] || $this->Ini->Embutida_iframe)
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['force_toolbar']);
   } 
       $this->Tem_tab_vert = false;
   $this->width_tabula_quebra  = "3px";
   $this->width_tabula_display = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_recuperada_ind']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_recuperada_ind']['lig_edit'] != '')
   {
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_recuperada_ind']['lig_edit'] == "on")  {$_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_recuperada_ind']['lig_edit'] = "S";}
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_recuperada_ind']['lig_edit'] == "off") {$_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_recuperada_ind']['lig_edit'] = "N";}
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_recuperada_ind']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['mostra_edit'] = "N";
       }
   }
   if ($this->Ini->SC_Link_View || ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opc_psq'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['psq_edit'] == 'N'))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['mostra_edit'] = "N";
   }
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ind_tree'] = 0;
   }
   elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['emb_tree_no']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['emb_tree_no'])
   { 
       $this->NM_emb_tree_no = true; 
   }
   $this->aba_iframe = false;
   $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['print_all'];
   if ($this->Print_All)
   {
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("grid_v_cartera_recuperada_ind", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_recuperada_ind']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_recuperada_ind']['btn_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_recuperada_ind']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
       {
           $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
       }
   }
   $this->Proc_link_res = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['where_resumo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['where_resumo'])) 
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['doc_word'] || $this->Ini->sc_export_ajax_img)
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['where_pesq_ant'];  
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['campos_busca']))
   { 
       $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['campos_busca'];
   ...
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['where_pesq_filtro'];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] = "muda_qt_linhas";
   } 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['dashboard_info']['maximized']) {
       $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['dashboard_info']['dashboard_app'];
       if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_v_cartera_recuperada_ind'])) {
           $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_v_cartera_recuperada_ind'];
   ...
   if ($this->Ini->Embutida_iframe) {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['sub_cons_iframe_btns'] as $BTN => $BTN_opc) {
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "grid_v_cartera_recuperada_ind/grid_v_cartera_recuperada_ind_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "grid_v_cartera_recuperada_ind_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   $this->Tot         = new grid_v_cartera_recuperada_ind_total($this->Ini->sc_page);
   $this->Tot->Db     = $this->Db;
   $this->Tot->Erro   = $this->Erro;
   $this->Tot->Ini    = $this->Ini;
   $this->Tot->Lookup = $this->Lookup;
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['qt_lin_grid'] = 10;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_recuperada_ind']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_recuperada_ind']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_recuperada_ind']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_recuperada_ind']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_recuperada_ind']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_recuperada_ind']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_recuperada_ind']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_recuperada_ind']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['qt_lin_grid']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['SC_Ind_Groupby'] == "op_contrato") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ordem_select']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ordem_select'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ordem_select_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ordem_select']; 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['SC_Ind_Groupby'] == "op_contrato") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ordem_quebra'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ordem_quebra']['op_contrato']["op_contrato"] = "asc"; 
       } 
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] = "inicio" ;  
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ordem_grid'] = ""; 
                       $ordem = ($ordem == "asc") ? "desc" : "asc";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['prim_cons'] || !empty($nmgp_parms))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['prim_cons'] = false;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['where_orig'] = " where (op_propietario=" . $_SESSION['var_propietario'] . " and op_estado in ('P'))";  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['where_pesq_ant']    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['cond_pesq']         = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['where_pesq_filtro'] = "";
   }   
   if  (!empty($this->nm_where_dinamico)) 
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['where_pesq_filtro'];
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao']       = "igual" ; 
...
// 
   ...
   $this->sum_op_contrato_fac_total = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] == "final" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['qt_reg_grid'] == "all") 
   { 
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['tot_geral'][1] ;  
       $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['tot_geral'][1];
   } 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['contr_total_geral'] = "NAO";
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['sc_total']);
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['tot_geral'][1] ;  
   ...
   { 
       ...
       $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['where_pesq']; 
       if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['where_pesq'])) 
       { 
           $nmgp_select .= " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['where_resumo']; 
       } 
       else
       { 
           $nmgp_select .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['where_resumo'] . ")"; 
       } 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['sc_total'] = $rt_grid->fields[0];  
       
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
   {
       $this->Ini->Qtd_reg_ajax_grid = $this->count_ger;
   }
   else
   {
       $this->Ini->Qtd_reg_ajax_grid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['qt_reg_grid'];
   }
//----- 
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
   { 
       $nmgp_select = "SELECT str_replace (convert(char(10),op_fecha_ini,102), '.', '-') + ' ' + convert(char(8),op_fecha_ini,20), cl_nombre, con_numero_contrato, con_numero_medidor, op_comentario, op_total, str_replace (convert(char(10),fac_fecha,102), '.', '-') + ' ' + convert(char(8),fac_fecha,20), serie, secuencial, fac_total, op_estado, op_operacion, op_empresa, str_replace (convert(char(10),op_fecha_emision,102), '.', '-') + ' ' + convert(char(8),op_fecha_emision,20), str_replace (convert(char(10),op_fecha_fin,102), '.', '-') + ' ' + convert(char(8),op_fecha_fin,20), op_propietario, op_subtotal_iva, op_subtotal_cero, op_subtotal, op_contrato, fac_estado from " . $this->Ini->nm_tabela; 
   } 
   elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
   { 
       $nmgp_select = "SELECT op_fecha_ini, cl_nombre, con_numero_contrato, con_numero_medidor, op_comentario, op_total, fac_fecha, serie, secuencial, fac_total, op_estado, op_operacion, op_empresa, op_fecha_emision, op_fecha_fin, op_propietario, op_subtotal_iva, op_subtotal_cero, op_subtotal, op_contrato, fac_estado from " . $this->Ini->nm_tabela; 
   } 
   elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
   { 
       $nmgp_select = "SELECT convert(char(23),op_fecha_ini,121), cl_nombre, con_numero_contrato, con_numero_medidor, op_comentario, op_total, convert(char(23),fac_fecha,121), serie, secuencial, fac_total, op_estado, op_operacion, op_empresa, convert(char(23),op_fecha_emision,121), convert(char(23),op_fecha_fin,121), op_propietario, op_subtotal_iva, op_subtotal_cero, op_subtotal, op_contrato, fac_estado from " . $this->Ini->nm_tabela; 
   } 
   ...
   { 
       $nmgp_select = "SELECT EXTEND(op_fecha_ini, YEAR TO DAY), cl_nombre, con_numero_contrato, con_numero_medidor, op_comentario, op_total, EXTEND(fac_fecha, YEAR TO DAY), serie, secuencial, fac_total, op_estado, op_operacion, op_empresa, EXTEND(op_fecha_emision, YEAR TO DAY), EXTEND(op_fecha_fin, YEAR TO DAY), op_propietario, op_subtotal_iva, op_subtotal_cero, op_subtotal, op_contrato, fac_estado from " . $this->Ini->nm_tabela; 
   } 
   else 
   { 
       $nmgp_select = "SELECT op_fecha_ini, cl_nombre, con_numero_contrato, con_numero_medidor, op_comentario, op_total, fac_fecha, serie, secuencial, fac_total, op_estado, op_operacion, op_empresa, op_fecha_emision, op_fecha_fin, op_propietario, op_subtotal_iva, op_subtotal_cero, op_subtotal, op_contrato, fac_estado from " . $this->Ini->nm_tabela; 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ordem_desc']; 
   } 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       ...
       $this->fac_fecha = $this->rs_grid->fields[6] ;  
       $this->serie = $this->rs_grid->fields[7] ;  
       $this->secuencial = $this->rs_grid->fields[8] ;  
       $this->fac_total = $this->rs_grid->fields[9] ;  
       $this->fac_total = (string)$this->fac_total;
       $this->op_estado = $this->rs_grid->fields[10] ;  
       $this->op_operacion = $this->rs_grid->fields[11] ;  
       $this->op_operacion = (string)$this->op_operacion;
       $this->op_empresa = $this->rs_grid->fields[12] ;  
       $this->op_fecha_emision = $this->rs_grid->fields[13] ;  
       $this->op_fecha_fin = $this->rs_grid->fields[14] ;  
       $this->op_propietario = $this->rs_grid->fields[15] ;  
       $this->op_propietario = (string)$this->op_propietario;
       $this->op_subtotal_iva = $this->rs_grid->fields[16] ;  
       $this->op_subtotal_iva =  str_replace(",", ".", $this->op_subtotal_iva);
       $this->op_subtotal_iva = (string)$this->op_subtotal_iva;
       $this->op_subtotal_cero = $this->rs_grid->fields[17] ;  
       $this->op_subtotal_cero =  str_replace(",", ".", $this->op_subtotal_cero);
       $this->op_subtotal_cero = (string)$this->op_subtotal_cero;
       $this->op_subtotal = $this->rs_grid->fields[18] ;  
       $this->op_subtotal =  str_replace(",", ".", $this->op_subtotal);
       $this->op_subtotal = (string)$this->op_subtotal;
       $this->op_contrato = $this->rs_grid->fields[19] ;  
       $this->op_contrato = (string)$this->op_contrato;
       $this->fac_estado = $this->rs_grid->fields[20] ;  
       if (!isset($this->op_contrato)) { $this->op_contrato = ""; }
       $GLOBALS["op_estado"] = $this->rs_grid->fields[10] ;  
       $GLOBALS["fac_estado"] = $this->rs_grid->fields[20] ;  
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['SC_Ind_Groupby'] == "op_contrato") 
       {
           ...
           $this->quebra_op_contrato_op_contrato($this->op_contrato) ; 
       }
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['final']; 
   ...
   $this->NM_hidden_filters = ($this->Ini->Embutida_iframe && !empty($this->nm_grid_sem_reg) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['initialize']) ? true : false;
   $this->nmgp_reg_inicial  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['final'] + 1;
   $this->nmgp_reg_final    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['qt_reg_grid'];
   $this->nmgp_reg_final    = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['doc_word'] && !$this->Ini->sc_export_ajax)
       {
           require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
           $this->pb = new scProgressBar();
           $this->pb->setRoot($this->Ini->root);
           $this->pb->setDir($_SESSION['scriptcase']['grid_v_cartera_recuperada_ind']['glo_nm_path_imag_temp'] . "/");
           $this->pb->setProgressbarMd5($_GET['pbmd5']);
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['word_return']);
       ...
       if ($this->Ini->Proc_print && $this->Ini->Export_html_zip  && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['print_return']);
           $this->pb->setTotalSteps($this->count_ger);
       }
       if (!$this->Ini->sc_export_ajax && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['pivot_charts']) : 0;
           ...
           if (-1 < $this->progress_grid)
           {
               ...
               grid_v_cartera_recuperada_ind_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
               grid_v_cartera_recuperada_ind_pdf_progress_call($this->Ini->path_js   . "\n", $this->Ini->Nm_lang);
               grid_v_cartera_recuperada_ind_pdf_progress_call($this->Ini->path_prod . "/img/\n", $this->Ini->Nm_lang);
               grid_v_cartera_recuperada_ind_pdf_progress_call($this->progress_tot   . "\n", $this->Ini->Nm_lang);
               ...
               grid_v_cartera_recuperada_ind_pdf_progress_call($this->progress_tot . "_#NM#_" . "1_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida'] && $this->NM_opcao != "pdf") {
           $nm_saida->saida("   <link rel=\"shortcut icon\" href=\"../_lib/img/usr__NM__img__NM__favicon.png\">\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ajax_nav'] && !$this->Ini->sc_export_ajax)
       { 
           ...
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_v_cartera_recuperada_ind_jquery_3381.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_v_cartera_recuperada_ind_ajax.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_v_cartera_recuperada_ind_message.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['qt_reg_grid']) . ";\r\n");
           }
           ...
           $nm_saida->saida("    {\r\n");
           $nm_saida->saida("        let cells = $(\".sc-ui-grid-header-row-grid_v_cartera_recuperada_ind-1\").find(\"td\");\r\n");
           ...
           $nm_saida->saida("        rows = $(\".sc-ui-grid-header-row-grid_v_cartera_recuperada_ind-1\");\r\n");
           ...
           $nm_saida->saida("   var gridHeaders = $(\".sc-ui-grid-header-row-grid_v_cartera_recuperada_ind-1\"), headerDisplayed = true;\r\n");
           ...
           $nm_saida->saida("   tableOriginal = document.getElementById(\"sc-ui-grid-body-8dfa9a5c\");\r\n");
           ...
           if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao_print'] != 'print' && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['grid_pesq']))
           { 
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ancor_save']);
           }
           $nm_saida->saida("   });\r\n");
...
$nm_saida->saida("}\r\n");
       ...
       $nm_saida->saida("<style type=\"text/css\">\r\n");
       $nm_saida->saida("</style>\r\n");
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['num_css']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['num_css'] = rand(0, 1000);
       }
       $write_css = true;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida'] && !$this->Print_All && $this->NM_opcao != "print" && $this->NM_opcao != "pdf")
       {
           $write_css = false;
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida_pdf']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida_pdf'])
       {
           $write_css = true;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_cartera_recuperada_ind_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida'])
       {
 ...
 { 
       ...
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_cartera_recuperada_ind_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_grid_v_cartera_recuperada_ind_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] != "pdf") {
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_v_cartera_recuperada_ind/grid_v_cartera_recuperada_ind_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['proc_pdf_vert'])
  {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           ...
           if ($Pos1 !== false && $Pos2 !== false) {
               ...
               $cada_css = ".grid_v_cartera_recuperada_ind_" . substr(trim($Tag[0]), 1);
               if (isset($Tag[1])) {
                   $cada_css .= ", .grid_v_cartera_recuperada_ind_" . substr(trim($Tag[1]), 1);
               }
               $cada_css .= $Css;
           }
           else {
               $cada_css = ".grid_v_cartera_recuperada_ind_" . substr($cada_css, 1);
           }
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   $this->css_body_embutida = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['css_body_embutida'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['css_body_embutida'] : "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida'])
   { 
       if (!$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['doc_word'] && ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao_print'] == "print")) 
       {
           if ($this->Print_All) 
           {
               $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
       ...
       {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
          $vertical_center = '';
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] != "pdf" && !$this->Print_All)
       { 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['css_body_embutida'])) {
       $remove_border = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['css_body_embutida'];
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['proc_pdf_vert'])
   {
   }
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_v_cartera_recuperada_ind']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_v_cartera_recuperada_ind']) . "_";
           } 
       } 
       else 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_v_cartera_recuperada_ind']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_v_cartera_recuperada_ind']) . "_";
           } 
       }
   }
   $temp_css  = explode("/", $compl_css);
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida']) ? "grid_v_cartera_recuperada_ind_" : "";
   $this->css_sep = " ";
...
// 
 function label_grid($linhas = 0)
 {
   ...
   $salva_htm_emb  = "";
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida_label'])
   { 
       $this->New_label['op_fecha_ini'] = "" . $this->Ini->Nm_lang['lang_fecha_inicio'] . "";
       $this->New_label['cl_nombre'] = "" . $this->Ini->Nm_lang['lang_nombre'] . "";
       $this->New_label['con_numero_contrato'] = "" . $this->Ini->Nm_lang['lang_numero_contrato'] . "";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['exibe_titulos']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
   ...
   $nm_saida->saida("    <TR id=\"tit_grid_v_cartera_recuperada_ind__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-grid_v_cartera_recuperada_ind-" . $tmp_header_row . "\">\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida_label']) { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opc_psq']) { 
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['field_order'] as $Cada_label)
   { 
   ...
   $nm_saida->saida("</TR>\r\n");
             ...
             foreach ($NM_css as $cada_css)
             {
                 ...
                 if ($Pos1 !== false && $Pos2 !== false) {
                     ...
                     $css_emb .= $cada_css . $Css;
                       ...
                       $css_emb .= ".grid_v_cartera_recuperada_ind_" . substr($cada_css, 1);
                 }
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
     ...
     $NM_seq_lab = 1;
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['labels'] as $NM_cmp => $NM_lab)
     {
         if (empty($NM_lab) || $NM_lab == "&nbsp;")
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['labels'][$NM_cmp] = "No_Label" . $NM_seq_lab;
             $NM_seq_lab++;
         }
     } 
   } 
 ...
 function NM_label_op_fecha_ini()
 {
   ...
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] != 'pdf') {
...
function SC_label_rightActionBar()
{
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ordem_cmp'] == $fieldName) {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ordem_label'] == 'desc') {
                $sortRule = 'desc';
            } else {
                $sortRule = 'asc';
            }
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ini_cor_grid']);
       }
   }
...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['labels']['op_fecha_ini'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cl_nombre'])) ? $this->New_label['cl_nombre'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['labels']['cl_nombre'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['con_numero_contrato'])) ? $this->New_label['con_numero_contrato'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['labels']['con_numero_contrato'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['con_numero_medidor'])) ? $this->New_label['con_numero_medidor'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['labels']['con_numero_medidor'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['op_comentario'])) ? $this->New_label['op_comentario'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['labels']['op_comentario'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['op_total'])) ? $this->New_label['op_total'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['labels']['op_total'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['fac_fecha'])) ? $this->New_label['fac_fecha'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['labels']['fac_fecha'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['serie'])) ? $this->New_label['serie'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['labels']['serie'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['secuencial'])) ? $this->New_label['secuencial'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['labels']['secuencial'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['fac_total'])) ? $this->New_label['fac_total'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['labels']['fac_total'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['op_estado'])) ? $this->New_label['op_estado'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['labels']['op_estado'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['op_operacion'])) ? $this->New_label['op_operacion'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['labels']['op_operacion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['op_empresa'])) ? $this->New_label['op_empresa'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['labels']['op_empresa'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['op_fecha_emision'])) ? $this->New_label['op_fecha_emision'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['labels']['op_fecha_emision'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['op_fecha_fin'])) ? $this->New_label['op_fecha_fin'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['labels']['op_fecha_fin'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['op_propietario'])) ? $this->New_label['op_propietario'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['labels']['op_propietario'] = $SC_Label; 
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_recuperada_ind']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_recuperada_ind']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_recuperada_ind']['lig_edit'];
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_grid_v_cartera_recuperada_ind#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               ...
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['cab_embutida'] != "S")
               {
       ...
       else
       {
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['force_toolbar'] = true;
           } 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ajax_nav'])
           { 
               $_SESSION['scriptcase']['saida_html'] = "";
           } 
           $nm_saida->saida("  " . $this->nm_grid_sem_reg . "\r\n");
           ...
           $nm_saida->saida("  </td></tr>\r\n");
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
           { 
               $this->sumario_mobile() ; 
           } 
       }
   ...
   { 
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['proc_pdf'])
{
}
else
{
       ...
       $nm_id_aplicacao = " id=\"apl_grid_v_cartera_recuperada_ind#?#1\"";
   } 
   $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] == "pdf") ? "padding: 0px !important;" : "";
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['proc_pdf_vert'])
{
}
else
...
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['proc_pdf']) { 
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['proc_pdf']) { 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-8dfa9a5c\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['proc_pdf_vert']) { 
    $nm_saida->saida("</thead>\r\n");
 }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['proc_pdf'] && $this->pdf_all_label != "S" && $this->pdf_label_group != "S") 
   { 
      $this->label_grid($linhas);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida_grid'])
...
// 
   ...
   $this->Break_pag_pdf['op_contrato']['op_contrato'] = "N";
   $this->Break_pag_prt['op_contrato']['op_contrato'] = "N";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['Config_Page_break_PDF'] = "S";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['Page_break_PDF']))
   {
       if (isset($this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['SC_Ind_Groupby']]))
       {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['SC_Gb_Free_cmp'] as $Cmp_gb => $resto)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['Page_break_PDF'][$Cmp_gb] = $this->Break_pag_pdf['sc_free_group_by'][$Cmp_gb];
               }
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['Page_break_PDF'] = $this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['SC_Ind_Groupby']];
           }
       }
       else
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['Page_break_PDF'] = array();
       }
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['SC_Ind_Groupby'] == "op_contrato") 
   {
       ...
       {
           $this->quebra_op_contrato_op_contrato_top(); 
       }
   ...
   $nm_houve_quebra = "N";
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          ...
          //---------- Gauge ----------
          if (!$this->Ini->sc_export_ajax && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
              if (0 == $this->progress_lim_now)
              {
               ...
               if (!NM_is_utf8($lang_protect))
               {
                  ...
                  grid_v_cartera_recuperada_ind_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $lang_protect . " " . $this->progress_now . "...\n", $this->Ini->Nm_lang);
          ...
          $this->arg_sum_op_contrato = ($this->op_contrato == "") ? " is null " : " = " . $this->op_contrato;
          $this->SC_seq_page++; 
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['final'] + 1; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['rows_emb']++;
          if ($this->op_contrato !== $this->op_contrato_Old && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['SC_Ind_Groupby'] == "op_contrato") 
          {  
              if (isset($this->op_contrato_Old))
              {
                 $this->quebra_op_contrato_op_contrato_bot() ; 
              }
              if ($this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['doc_word'] && $this->Break_pag_prt[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['SC_Ind_Groupby']]['op_contrato'] == "S")
              {
                  $this->nm_quebra_pagina("pagina"); 
              }
              elseif (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['Page_break_PDF']['op_contrato'] == "S")
              {
                  $this->nm_quebra_pagina("pagina"); 
              }
              $this->op_contrato_Old = $this->op_contrato ; 
          ...
          else
          {
              ...
              {
                  if ($this->nm_inicio_pag == 0 && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida_grid'])
                  {
                      $nm_houve_quebra = "N";
                  } 
              } 
              elseif (($nm_houve_quebra == "S" || ($this->nm_inicio_pag == 0)) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida_grid'])
              { 
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida_opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['dado_psq_ret'];
 ...
 $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcapture", "document.Fpesq.nm_ret_psq.value='" . str_replace(array("'", '"'), array("\'", '\"'), $teste) . "'; nm_escreve_window();", "document.Fpesq.nm_ret_psq.value='" . str_replace(array("'", '"'), array("\'", '\"'), $teste) . "'; nm_escreve_window();", "", "Rad_psq", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
          ...
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['field_order'] as $Cada_col)
          { 
   ...
   $this->SC_grid_rightActionBar();
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
   ...
   if ($this->rs_grid->EOF) 
   { 
       if (isset($this->op_contrato_Old) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['SC_Ind_Groupby'] == "op_contrato")
       {
           $this->quebra_op_contrato_op_contrato_bot() ; 
       }
  
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['exibe_total'] == "S")
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['SC_Ind_Groupby'] . "_bot";
           $this->$Gb_geral() ;
       } 
   }  
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida_grid'])
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
       $this->sumario_mobile() ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida_grid'])
...
function SC_grid_rightActionBar()
{
 ...
 function NM_grid_op_fecha_ini()
 {
      ...
      if (!isset($this->NM_cmp_hidden['op_fecha_ini']) || $this->NM_cmp_hidden['op_fecha_ini'] != "off") { 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida'] && !empty($conteudo)) 
          { 
 ...
 function NM_grid_cl_nombre()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['cl_nombre']) || $this->NM_cmp_hidden['cl_nombre'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
 ...
 function nm_quebra_pagina($nm_parms)
 {
    ...
    if (($this->Ini->nm_limite_lin > 0 && $this->Ini->nm_cont_lin > $this->Ini->nm_limite_lin) || $nm_parms == "pagina" || $nm_parms == "resumo" || $nm_parms == "total")
    {
        ...
        if ($this->Print_All)
        {
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['print_navigator']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['print_navigator'] == "Netscape")
            {
        ...
        if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['proc_pdf'] && $nm_parms != "resumo" && $nm_parms != "pagina" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida_grid'])
        {
            $this->label_grid();
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['proc_pdf'] && $this->pdf_label_group != "S" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida_grid'])
        {
            $this->nm_inicio_pag = 0;
        }
    }
 }
 function quebra_op_contrato_op_contrato($op_contrato) 
 {
   global $tot_op_contrato;
   $this->sc_proc_quebra_op_contrato = true; 
   $this->Tot->quebra_op_contrato_op_contrato($op_contrato, $this->arg_sum_op_contrato);
   ...
   $this->Lookup->lookup_op_contrato_op_contrato($conteudo , $this->op_contrato) ; 
 ...
 function quebra_op_contrato_op_contrato_top() 
 { global
   ...
   $link_div   = "";
   $link_div_2 = "";
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ind_tree'];
       ...
       $link_div .= "<img id=\"b_open_grid_v_cartera_recuperada_ind_" . $this->NM_cont_body . "\" style=\"display:''\" onclick=\"document.getElementById('b_open_grid_v_cartera_recuperada_ind_" . $this->NM_cont_body . "').style.display = 'none'; document.getElementById('b_close_grid_v_cartera_recuperada_ind_" . $this->NM_cont_body . "').style.display = ''; NM_liga_tbody(" . $this->NM_cont_body . ", NM_tab_grid_v_cartera_recuperada_ind, 'grid_v_cartera_recuperada_ind'); return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_exp . "\">";
       $link_div .= "<img id=\"b_close_grid_v_cartera_recuperada_ind_" . $this->NM_cont_body . "\" style=\"display:none\" onclick=\"document.getElementById('b_close_grid_v_cartera_recuperada_ind_" . $this->NM_cont_body . "').style.display = 'none'; document.getElementById('b_open_grid_v_cartera_recuperada_ind_" . $this->NM_cont_body . "').style.display = ''; NM_apaga_tbody(" . $this->NM_cont_body . ", NM_tab_grid_v_cartera_recuperada_ind, 'grid_v_cartera_recuperada_ind'); return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_col . "\">";
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_recuperada_ind'][$this->NM_cont_body]['1'] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_recuperada_ind_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   $this->NM_calc_span();
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ind_tree'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_recuperada_ind'][$this->NM_cont_body]['1'] = 'bot';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_recuperada_ind_" . $this->NM_cont_body . "_bot\" style=\"display:none\">");
 ...
 function quebra_op_contrato_op_contrato_bot() 
 { global 
          $op_contrato_ant_desc, 
          $nm_saida, $tot_op_contrato;
  ...
  foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
  {
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['field_order'] as $Cada_cmp)
   {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = false;
       $nm_saida->saida("    </TBODY>");
   }
 ...
 function quebra_geral_op_contrato_top() 
 {
   global $nm_saida; 
   if (isset($this->NM_tbody_open) && $this->NM_tbody_open)
   {
 ...
 function quebra_geral_op_contrato_bot() 
 {
   global 
          $nm_saida, $nm_data; 
   $this->Tot->quebra_geral_op_contrato(); 
   $NM_cmp_tot['op_total']['S'] = 2;
   $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . '');
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['rows_emb']++;
   $nm_nivel_book_pdf = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] == "pdf" && !$this->Print_All)
   {
      $nm_nivel_book_pdf = "<div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">" .  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['tot_geral'][0] . "</H1></div>";
   }
   $tit_lin_sumariza      =  $nm_nivel_book_pdf . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['tot_geral'][1] . ")";
   $tit_lin_sumariza_orig =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['tot_geral'][1] . ")";
  ...
  foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
  {
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['field_order'] as $Cada_cmp)
   {
    ...
    if ($Cada_cmp == "op_total" && (!isset($this->NM_cmp_hidden['op_total']) || $this->NM_cmp_hidden['op_total'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['op_total'][$Tipo_Sum]))
      {
          $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['tot_geral'][$NM_cmp_tot['op_total'][$Tipo_Sum]] ; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
 ...
 { global $nm_saida, $nm_lang; 
   ...
   $nm_sumario = str_replace("?final?", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['final'], $nm_sumario);
...
$nm_saida->saida("    </style>\r\n");
      ...
      if ($this->nmgp_botoes['group_1'] == "on" && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("           $Cod_Btn\r\n");
      if ($this->nmgp_botoes['pdf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      ...
      $Tem_pdf_res = "n";
          ...
          $nm_saida->saida("            <div id=\"div_pdf_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "pdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_v_cartera_recuperada_ind/grid_v_cartera_recuperada_ind_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=8&lpapel=279&apapel=216&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&sc_ver_93=s&nm_tem_gb=" . $Tem_gb_pdf . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_pdf_res=grid&nm_all_modules=grid&nm_label_group=N&nm_all_cab=S&nm_all_label=S&nm_orient_grid=2&password=n&summary_export_columns=S&pdf_zip=N&origem=cons&language=es&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_v_cartera_recuperada_ind&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_word_res = "n";
          $Tem_word_res = "s";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['SC_Gb_Free_cmp']))
          {
              $Tem_word_res = "n";
          }
          $nm_saida->saida("            <div id=\"div_word_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $this->nm_btn_exist['word'][] = "word_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_v_cartera_recuperada_ind/grid_v_cartera_recuperada_ind_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=" . $Tem_word_res . "&nm_ini_word_res=grid&nm_all_modules=grid&password=n&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_xls_res = "n";
          $Tem_xls_res = "s";
          ...
          $nm_saida->saida("            <div id=\"div_xls_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "xls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_v_cartera_recuperada_ind/grid_v_cartera_recuperada_ind_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_v_cartera_recuperada_ind&nm_tp_xls=xlsx&nm_tot_xls=S&nm_res_cons=" . $Tem_xls_res . "&nm_ini_xls_res=grid&nm_all_modules=grid&password=n&summary_export_columns=S&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['print'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Tem_pdf_res = "n";
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div id=\"div_print_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $this->nm_btn_exist['print'][] = "print_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "print_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_v_cartera_recuperada_ind/grid_v_cartera_recuperada_ind_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=RC&nm_cor=CO&password=n&language=es&nm_page=" . NM_encode_input($this->Ini->sc_page) . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_prt_res=grid&nm_all_modules=grid&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if (is_file($this->Ini->root . $this->Ini->path_img_global . $this->Ini->Img_sep_grid))
      {
          ...
          if (is_file("grid_v_cartera_recuperada_ind_help.txt") && !$this->grid_emb_form)
          {
             $Arq_WebHelp = file("grid_v_cartera_recuperada_ind_help.txt"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['dashboard_info']['under_dashboard']))
      {
         $this->nmgp_botoes['exit'] = "off"; 
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opc_psq'])
      ...
      {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['sc_modal'])
        {
...
$nm_saida->saida("    </style>\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao_print'] != "print") 
      {
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['qtline'] == "on" && $this->Ini->Apl_paginacao != "FULL")
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['qt_lin_grid'] == '10') ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['qt_lin_grid'] == '20') ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['qt_lin_grid'] == '50') ? " selected" : "";
              $nm_saida->saida("           <option value=\"50\" " . $obj_sel . ">50</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['qt_lin_grid'] == 'all') ? " selected" : "";
      ...
      if (is_file($this->Ini->root . $this->Ini->path_img_global . $this->Ini->Img_sep_grid))
      {
          ...
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opc_liga']['nav']))
          {
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['navpage'] == "on" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opc_liga']['nav']) && $this->Ini->Apl_paginacao != "FULL" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['qt_lin_grid'] != "all")
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['qt_lin_grid'];
              $Max_link   = 5;
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opc_liga']['nav']))
          {
...
$nm_saida->saida("    </style>\r\n");
      ...
      if ($this->nmgp_botoes['sel_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_5_top = true;</script>\r\n");
      ...
      $path_fields = $this->Ini->root . substr($this->Ini->path_prod, 0, $pos_path) . "/conf/fields/";
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcolumns", "scBtnSelCamposShow('" . $this->Ini->path_link . "grid_v_cartera_recuperada_ind/grid_v_cartera_recuperada_ind_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnSelCamposShow('" . $this->Ini->path_link . "grid_v_cartera_recuperada_ind/grid_v_cartera_recuperada_ind_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "selcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_5", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['sort_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_5_top = true;</script>\r\n");
          ...
          $nm_saida->saida("            <div id=\"div_ordcmp_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bsort", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_v_cartera_recuperada_ind/grid_v_cartera_recuperada_ind_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_v_cartera_recuperada_ind/grid_v_cartera_recuperada_ind_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "ordcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_5", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
   ...
   function html_grid_search()
   {
       ...
       $tmp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['cond_pesq'];
       $pos = strrpos($tmp, "##*@@");
       if ($pos !== false)
       {
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['grid_pesq'])?'none':'';
       if(!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ajax_nav'])
       {
          $nm_saida->saida("   <tr id=\"NM_Grid_Search\" ajax='' style='display:" . $str_display . "'>\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['grid_pesq']))
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['grid_pesq'] as $cmp => $def)
           {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['save_grid']))
           {
               return;
           }
           else
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['save_grid']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['grid_pesq']))
           { 
   ...
   {
       $lin_obj  = "";
       $All_cmp_search = array('con_numero_contrato','con_numero_medidor','op_fecha_ini','fac_fecha');
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['pesq_tab_label'];
       if (!empty($nmgp_tab_label))
       {
          $nm_tab_campos = explode("?@?", $nmgp_tab_label);
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['grid_pesq']) && count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['grid_pesq']) < 4)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
   ...
   function grid_search_con_numero_contrato($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $nm_comando = "select distinct con_numero_contrato from " . $this->Ini->nm_tabela . " where (op_propietario=" . $_SESSION['var_propietario'] . " and op_estado in ('P')) and con_numero_contrato = '$con_numero_contrato_look' order by con_numero_contrato"; 
   ...
   function grid_search_con_numero_medidor($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct con_numero_medidor from " . $this->Ini->nm_tabela . " where (op_propietario=" . $_SESSION['var_propietario'] . " and op_estado in ('P')) and con_numero_medidor = '$con_numero_medidor_look' order by con_numero_medidor"; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
   ...
   function lookup_ajax_con_numero_contrato($con_numero_contrato)
   {
       ...
       $con_numero_contrato_look = (is_string($con_numero_contrato) ? substr($this->Db->qstr($con_numero_contrato), 1, -1) : $con_numero_contrato); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct con_numero_contrato from " . $this->Ini->nm_tabela . " where (op_propietario=" . $_SESSION['var_propietario'] . " and op_estado in ('P')) and  con_numero_contrato like '%" . $con_numero_contrato . "%' order by con_numero_contrato"; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
          ...
          { 
            ...
            $cmp1 = grid_v_cartera_recuperada_ind_pack_protect_string($cmp1);
            $nmgp_def_dados[] = array($cmp1 => $cmp1); 
             $rs->MoveNext(); 
          } 
          $rs->Close(); 
   ...
   function lookup_ajax_con_numero_medidor($con_numero_medidor)
   {
       ...
       $con_numero_medidor_look = (is_string($con_numero_medidor) ? substr($this->Db->qstr($con_numero_medidor), 1, -1) : $con_numero_medidor); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct con_numero_medidor from " . $this->Ini->nm_tabela . " where (op_propietario=" . $_SESSION['var_propietario'] . " and op_estado in ('P')) and  con_numero_medidor like '%" . $con_numero_medidor . "%' order by con_numero_medidor"; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "SIJAP/grid_v_cartera_recuperada_ind";
   ...
   function JS_grid_search()
   {
       ...
       $nm_saida->saida(" function sc_grid_v_cartera_recuperada_ind_valida_mes(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida(" function sc_grid_v_cartera_recuperada_ind_valida_dia(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['op_fecha_ini_mes'] =  'sc_grid_v_cartera_recuperada_ind_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['op_fecha_ini_dia'] =  'sc_grid_v_cartera_recuperada_ind_valida_dia(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['op_fecha_ini_v2__mes'] =  'sc_grid_v_cartera_recuperada_ind_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['op_fecha_ini_v2__dia'] =  'sc_grid_v_cartera_recuperada_ind_valida_dia(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fac_fecha_mes'] =  'sc_grid_v_cartera_recuperada_ind_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fac_fecha_dia'] =  'sc_grid_v_cartera_recuperada_ind_valida_dia(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fac_fecha_v2__mes'] =  'sc_grid_v_cartera_recuperada_ind_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fac_fecha_v2__dia'] =  'sc_grid_v_cartera_recuperada_ind_valida_dia(this)';\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['ajax_nav'])
       { 
           ...
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['op_fecha_ini_mes']", 'value' => 'sc_grid_v_cartera_recuperada_ind_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['op_fecha_ini_dia']", 'value' => 'sc_grid_v_cartera_recuperada_ind_valida_dia(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['op_fecha_ini_v2__mes']", 'value' => 'sc_grid_v_cartera_recuperada_ind_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['op_fecha_ini_v2__dia']", 'value' => 'sc_grid_v_cartera_recuperada_ind_valida_dia(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fac_fecha_mes']", 'value' => 'sc_grid_v_cartera_recuperada_ind_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fac_fecha_dia']", 'value' => 'sc_grid_v_cartera_recuperada_ind_valida_dia(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fac_fecha_v2__mes']", 'value' => 'sc_grid_v_cartera_recuperada_ind_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fac_fecha_v2__dia']", 'value' => 'sc_grid_v_cartera_recuperada_ind_valida_dia(this)');
       } 
    ...
    function getFieldHighlight($filter_type, $field, $str_value, $str_value_original='')
    {
        ...
        {
            if (
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['campos_busca'][ $field ]) &&
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['campos_busca'][ $field . "_cond" ]) &&
                !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['campos_busca'][ $field ]) &&
                (
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['campos_busca'][ $field . "_cond"] == 'qp' ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['campos_busca'][ $field . "_cond"] == 'eq' ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['campos_busca'][ $field . "_cond"] == 'ii'
                )
            )
            {
                if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['campos_busca'][ $field . "_cond"] == 'qp')
                {
                    if(is_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['campos_busca'][ $field ]))
                    {
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['campos_busca'][ $field ] as $ind => $vals)
                        {
                    ...
                    {
                        if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['campos_busca'][ $field ], $str_value) == 0)
                        {
                            $str_value = $str_html_ini. $str_value .$str_html_fim;
                        }
                        elseif(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['campos_busca'][ $field ], $str_value_original) == 0)
                        {
                            $str_value = $str_html_ini. $str_value .$str_html_fim;
                        }
                        else
                        {
                            $keywords = preg_quote($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['campos_busca'][ $field ], '/');
                            $str_value = preg_replace('/'. $keywords .'/i', $str_html_ini . '$0' . $str_html_fim, $str_value);
                        }
                    }
                }
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['campos_busca'][ $field . "_cond"] == 'eq')
                {
                    if(is_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['campos_busca'][ $field ]))
                    {
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['campos_busca'][ $field ] as $ind => $vals)
                ...
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['campos_busca'][ $field . "_cond"] == 'ii')
                {
                    if(is_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['campos_busca'][ $field ]))
                    {
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['campos_busca'][ $field ] as $ind => $vals)
                    ...
                    {
                        if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['campos_busca'][ $field ], substr($str_value, 0, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['campos_busca'][ $field ]))) == 0)
                        {
                            $str_value = $str_html_ini. substr($str_value, 0, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['campos_busca'][ $field ])) .$str_html_fim . substr($str_value, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['campos_busca'][ $field ]));
                        }
                    }
                }
            }
        ...
        {
            if(
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['fast_search'][0]) &&
                (
                    (
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['fast_search'][0] == 'SC_all_Cmp' &&
                    in_array($field, array(''))
                    ) ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['fast_search'][0] == $field ||
                    strpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['fast_search'][0], $field . '_VLS_') !== false ||
                    strpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['fast_search'][0], '_VLS_' . $field) !== false
                )
            )
            {
                if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['fast_search'][1] == 'qp')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['fast_search'][2], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    elseif(!empty($str_value_original) && $str_value_original != '&nbsp;' && strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['fast_search'][2], $str_value_original) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    else
                    {
                        $keywords = preg_quote($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['fast_search'][2], '/');
                        $str_value = preg_replace('/'. $keywords .'/i', $str_html_ini . '$0' . $str_html_fim, $str_value);
                    }
                }
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['fast_search'][1] == 'eq')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['fast_search'][2], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   ...
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
   } 
   ...
   $nm_saida->saida("   if (typeof(scSetFixedHeaders) === typeof(function(){})) scSetFixedHeaders();\r\n");
   $nm_saida->saida("  });\r\n");
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
       } 
   ...
   if ($this->grid_emb_form || $this->grid_emb_form_full)
   {
       ...
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_v_cartera_recuperada_ind', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"grid_v_cartera_recuperada_ind\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"grid_v_cartera_recuperada_ind_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("                     action=\"grid_v_cartera_recuperada_ind_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_v_cartera_recuperada_ind/grid_v_cartera_recuperada_ind_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
   ...
   $nm_saida->saida("           document.Fdoc_word.action = \"grid_v_cartera_recuperada_ind_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("           document.F3.SC_module_export.value = z;\r\n");
   $nm_saida->saida("       }\r\n");
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['grid_v_cartera_recuperada_ind_iframe_params'] = array(
   ...
   $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_v_cartera_recuperada_ind@SC_par@" . md5($prep_parm_pdf);
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   $nm_saida->saida("               document.Fpdf.action=\"grid_v_cartera_recuperada_ind_iframe.php\";\r\n");
   ...
   $nm_saida->saida("               document.Fprint.action = \"grid_v_cartera_recuperada_ind_export_ctrl.php\";\r\n");
   $nm_saida->saida("           }\r\n");
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   ...
   $nm_saida->saida("           document.Fexport.action = \"grid_v_cartera_recuperada_ind_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['campo_psq_ret']) )
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['grid_v_cartera_recuperada_ind']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form  = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Form1 = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("           var Obj_Doc   = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form  = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Form1 = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("          var Obj_Doc   = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form  = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Form1 = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['campo_psq_ret']) . ";\r\n");
          $nm_saida->saida("          var Obj_Doc   = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"grid_v_cartera_recuperada_ind_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['reg_start']))
   {
       $nm_saida->saida("      $(document).ready(function(){\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailStatus('grid_v_cartera_recuperada_ind')\",50);\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_v_cartera_recuperada_ind', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      })\r\n");
   }
