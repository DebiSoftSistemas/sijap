...
class grid_v_cartera_recuperada_ind_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_v_cartera_recuperada_ind']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_v_cartera_recuperada_ind']['campos_busca']))
      { 
   ...
   //---- 
   function quebra_geral_op_contrato($res_limit=false, $res_export=false)
   {
      global $nada, $nm_lang , $op_estado, $fac_estado;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(op_total) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['where_pesq']; 
      } 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $rt->fields[1] = (string)$rt->fields[1]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['tot_geral'][2] = $rt->fields[1]; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada_ind']['contr_total_geral'] = "OK";
   } 

   //-----  op_contrato
   function quebra_op_contrato_op_contrato($op_contrato, $arg_sum_op_contrato) 
   {
      global $tot_op_contrato, $op_estado, $fac_estado;
