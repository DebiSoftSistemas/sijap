...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_del_sustento_retencion/form_del_sustento_retencion_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_del_sustento_retencion_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_del_sustento_retencion_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['link_info']['remove_border']) {
...
<?php
 include_once("form_del_sustento_retencion_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_del_sustento_retencion'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_del_sustento_retencion'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_disabled']['']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_disabled']['']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_label']['']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_label']['']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_label'][''];
        }
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-6';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php } 
?> 
<?php $sStyleHidden_sr_fechaemision_dumb = ('' == $sStyleHidden_sr_fechaemision) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_sr_fechaemision_dumb" style="<?php echo $sStyleHidden_sr_fechaemision_dumb; ?>"></TD>
<?php $sStyleHidden_sr_fecha_registro_contable_dumb = ('' == $sStyleHidden_sr_fecha_registro_contable) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_sr_fecha_registro_contable_dumb" style="<?php echo $sStyleHidden_sr_fecha_registro_contable_dumb; ?>"></TD>
<?php $sStyleHidden_sr_cod_docsustento_dumb = ('' == $sStyleHidden_sr_cod_docsustento) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_sr_cod_docsustento_dumb" style="<?php echo $sStyleHidden_sr_cod_docsustento_dumb; ?>"></TD>
<?php $sStyleHidden_sr_cod_sustento_dumb = ('' == $sStyleHidden_sr_cod_sustento) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_sr_cod_sustento_dumb" style="<?php echo $sStyleHidden_sr_cod_sustento_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } ?>
<?php $sStyleHidden_sr_id_dumb = ('' == $sStyleHidden_sr_id) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_sr_id_dumb" style="<?php echo $sStyleHidden_sr_id_dumb; ?>"></TD>
...
<?php $sStyleHidden_sr_serie_dumb = ('' == $sStyleHidden_sr_serie) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_sr_serie_dumb" style="<?php echo $sStyleHidden_sr_serie_dumb; ?>"></TD>
<?php $sStyleHidden_sr_secuencial_dumb = ('' == $sStyleHidden_sr_secuencial) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_sr_secuencial_dumb" style="<?php echo $sStyleHidden_sr_secuencial_dumb; ?>"></TD>
<?php $sStyleHidden_sr_autorizacion_dumb = ('' == $sStyleHidden_sr_autorizacion) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_sr_autorizacion_dumb" style="<?php echo $sStyleHidden_sr_autorizacion_dumb; ?>"></TD>
<?php $sStyleHidden_sr_total_sin_impuestos_dumb = ('' == $sStyleHidden_sr_total_sin_impuestos) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_sr_total_sin_impuestos_dumb" style="<?php echo $sStyleHidden_sr_total_sin_impuestos_dumb; ?>"></TD>
<?php $sStyleHidden_sr_importe_total_dumb = ('' == $sStyleHidden_sr_importe_total) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_sr_importe_total_dumb" style="<?php echo $sStyleHidden_sr_importe_total_dumb; ?>"></TD>
...
<?php $sStyleHidden_sr_tipo_regimen_dumb = ('' == $sStyleHidden_sr_tipo_regimen) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_sr_tipo_regimen_dumb" style="<?php echo $sStyleHidden_sr_tipo_regimen_dumb; ?>"></TD>
<?php $sStyleHidden_sr_pais_dumb = ('' == $sStyleHidden_sr_pais) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_sr_pais_dumb" style="<?php echo $sStyleHidden_sr_pais_dumb; ?>"></TD>
<?php $sStyleHidden_sr_paraiso_fiscal_dumb = ('' == $sStyleHidden_sr_paraiso_fiscal) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_sr_paraiso_fiscal_dumb" style="<?php echo $sStyleHidden_sr_paraiso_fiscal_dumb; ?>"></TD>
<?php $sStyleHidden_sr_pais_pago_dumb = ('' == $sStyleHidden_sr_pais_pago) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_sr_pais_pago_dumb" style="<?php echo $sStyleHidden_sr_pais_pago_dumb; ?>"></TD>
<?php $sStyleHidden_sr_aplica_doble_trib_dumb = ('' == $sStyleHidden_sr_aplica_doble_trib) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_sr_aplica_doble_trib_dumb" style="<?php echo $sStyleHidden_sr_aplica_doble_trib_dumb; ?>"></TD>
<?php $sStyleHidden_sr_pago_sujeto_retencion_nc_dumb = ('' == $sStyleHidden_sr_pago_sujeto_retencion_nc) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_sr_pago_sujeto_retencion_nc_dumb" style="<?php echo $sStyleHidden_sr_pago_sujeto_retencion_nc_dumb; ?>"></TD>
...
<?php $sStyleHidden_sr_total_reembolsos_dumb = ('' == $sStyleHidden_sr_total_reembolsos) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_sr_total_reembolsos_dumb" style="<?php echo $sStyleHidden_sr_total_reembolsos_dumb; ?>"></TD>
<?php $sStyleHidden_sr_total_baseimponible_reembolsos_dumb = ('' == $sStyleHidden_sr_total_baseimponible_reembolsos) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_sr_total_baseimponible_reembolsos_dumb" style="<?php echo $sStyleHidden_sr_total_baseimponible_reembolsos_dumb; ?>"></TD>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_impuestos'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_impuestos'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_impuesto_sustento_retencion_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_impuestos'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_impuesto_sustento_retencion_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_impuesto_sustento_retencion_script_case_init'] ]['form_del_impuesto_sustento_retencion']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_impuesto_sustento_retencion_script_case_init'] ]['form_del_impuesto_sustento_retencion']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_impuesto_sustento_retencion_script_case_init'] ]['form_del_impuesto_sustento_retencion']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_impuesto_sustento_retencion_script_case_init'] ]['form_del_impuesto_sustento_retencion']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_impuesto_sustento_retencion_script_case_init'] ]['form_del_impuesto_sustento_retencion']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_impuesto_sustento_retencion_script_case_init'] ]['form_del_impuesto_sustento_retencion']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_impuesto_sustento_retencion_script_case_init'] ]['form_del_impuesto_sustento_retencion']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_impuesto_sustento_retencion_script_case_init'] ]['form_del_impuesto_sustento_retencion']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_impuesto_sustento_retencion_script_case_init'] ]['form_del_impuesto_sustento_retencion']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_impuesto_sustento_retencion_script_case_init'] ]['form_del_impuesto_sustento_retencion']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_impuesto_sustento_retencion_script_case_init'] ]['form_del_impuesto_sustento_retencion']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_impuesto_sustento_retencion_script_case_init'] ]['form_del_impuesto_sustento_retencion']['embutida_liga_tp_pag'] = 'parcial';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_impuesto_sustento_retencion_script_case_init'] ]['form_del_impuesto_sustento_retencion']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scoutlink_remove_margin*scinok*scoutlink_remove_border*scinok*scout";
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_impuesto_sustento_retencion_script_case_init'] ]['form_del_sustento_retencion']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_del_sustento_retencion_empty.htm' : $this->Ini->link_form_del_impuesto_sustento_retencion_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y';
if (isset($this->Ini->sc_lig_target['C_@scinf_impuestos']) && 'nmsc_iframe_liga_form_del_impuesto_sustento_retencion' != $this->Ini->sc_lig_target['C_@scinf_impuestos'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_impuestos'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_impuesto_sustento_retencion_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_del_impuesto_sustento_retencion"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_form_del_impuesto_sustento_retencion"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_pagos'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_pagos'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_forma_pago_sustento_retencion_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_pagos'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_forma_pago_sustento_retencion_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_forma_pago_sustento_retencion_script_case_init'] ]['form_del_forma_pago_sustento_retencion']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_forma_pago_sustento_retencion_script_case_init'] ]['form_del_forma_pago_sustento_retencion']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_forma_pago_sustento_retencion_script_case_init'] ]['form_del_forma_pago_sustento_retencion']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_forma_pago_sustento_retencion_script_case_init'] ]['form_del_forma_pago_sustento_retencion']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_forma_pago_sustento_retencion_script_case_init'] ]['form_del_forma_pago_sustento_retencion']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_forma_pago_sustento_retencion_script_case_init'] ]['form_del_forma_pago_sustento_retencion']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_forma_pago_sustento_retencion_script_case_init'] ]['form_del_forma_pago_sustento_retencion']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_forma_pago_sustento_retencion_script_case_init'] ]['form_del_forma_pago_sustento_retencion']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_forma_pago_sustento_retencion_script_case_init'] ]['form_del_forma_pago_sustento_retencion']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_forma_pago_sustento_retencion_script_case_init'] ]['form_del_forma_pago_sustento_retencion']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_forma_pago_sustento_retencion_script_case_init'] ]['form_del_forma_pago_sustento_retencion']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_forma_pago_sustento_retencion_script_case_init'] ]['form_del_forma_pago_sustento_retencion']['embutida_liga_tp_pag'] = 'parcial';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_forma_pago_sustento_retencion_script_case_init'] ]['form_del_forma_pago_sustento_retencion']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scoutlink_remove_margin*scinok*scoutlink_remove_border*scinok*scout";
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_forma_pago_sustento_retencion_script_case_init'] ]['form_del_sustento_retencion']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_del_sustento_retencion_empty.htm' : $this->Ini->link_form_del_forma_pago_sustento_retencion_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y';
if (isset($this->Ini->sc_lig_target['C_@scinf_pagos']) && 'nmsc_iframe_liga_form_del_forma_pago_sustento_retencion' != $this->Ini->sc_lig_target['C_@scinf_pagos'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_pagos'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_forma_pago_sustento_retencion_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_del_forma_pago_sustento_retencion"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_form_del_forma_pago_sustento_retencion"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_retenciones'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_retenciones'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_impuestos_retenidos_sustento_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_retenciones'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_impuestos_retenidos_sustento_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_impuestos_retenidos_sustento_script_case_init'] ]['form_del_impuestos_retenidos_sustento']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_impuestos_retenidos_sustento_script_case_init'] ]['form_del_impuestos_retenidos_sustento']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_impuestos_retenidos_sustento_script_case_init'] ]['form_del_impuestos_retenidos_sustento']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_impuestos_retenidos_sustento_script_case_init'] ]['form_del_impuestos_retenidos_sustento']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_impuestos_retenidos_sustento_script_case_init'] ]['form_del_impuestos_retenidos_sustento']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_impuestos_retenidos_sustento_script_case_init'] ]['form_del_impuestos_retenidos_sustento']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_impuestos_retenidos_sustento_script_case_init'] ]['form_del_impuestos_retenidos_sustento']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_impuestos_retenidos_sustento_script_case_init'] ]['form_del_impuestos_retenidos_sustento']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_impuestos_retenidos_sustento_script_case_init'] ]['form_del_impuestos_retenidos_sustento']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_impuestos_retenidos_sustento_script_case_init'] ]['form_del_impuestos_retenidos_sustento']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_impuestos_retenidos_sustento_script_case_init'] ]['form_del_impuestos_retenidos_sustento']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_impuestos_retenidos_sustento_script_case_init'] ]['form_del_impuestos_retenidos_sustento']['embutida_liga_tp_pag'] = 'parcial';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_impuestos_retenidos_sustento_script_case_init'] ]['form_del_impuestos_retenidos_sustento']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scoutlink_remove_margin*scinok*scoutlink_remove_border*scinok*scout";
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_impuestos_retenidos_sustento_script_case_init'] ]['form_del_sustento_retencion']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_del_sustento_retencion_empty.htm' : $this->Ini->link_form_del_impuestos_retenidos_sustento_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y';
if (isset($this->Ini->sc_lig_target['C_@scinf_retenciones']) && 'nmsc_iframe_liga_form_del_impuestos_retenidos_sustento' != $this->Ini->sc_lig_target['C_@scinf_retenciones'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_retenciones'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['form_del_impuestos_retenidos_sustento_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_del_impuestos_retenidos_sustento"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_form_del_impuestos_retenidos_sustento"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_del_sustento_retencion");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_del_sustento_retencion");
 parent.scAjaxDetailHeight("form_del_sustento_retencion", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_sustento_retencion']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
