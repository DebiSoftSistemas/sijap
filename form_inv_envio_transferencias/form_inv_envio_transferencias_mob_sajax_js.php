  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_inv_envio_transferencias_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_inv_envio_transferencias_mob_form();
	}
...
?>
  ...
  // ---------- Validate tr_fecha
  function do_ajax_form_inv_envio_transferencias_mob_validate_tr_fecha()
  {
    var nomeCampo_tr_fecha = "tr_fecha";
    var var_tr_fecha = scAjaxGetFieldText(nomeCampo_tr_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_envio_transferencias_mob_validate_tr_fecha(var_tr_fecha, var_script_case_init, do_ajax_form_inv_envio_transferencias_mob_validate_tr_fecha_cb);
  } // do_ajax_form_inv_envio_transferencias_mob_validate_tr_fecha

  function do_ajax_form_inv_envio_transferencias_mob_validate_tr_fecha_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_envio_transferencias_mob_validate_tr_fecha_cb

  // ---------- Validate tr_bodega_origen
  function do_ajax_form_inv_envio_transferencias_mob_validate_tr_bodega_origen()
  {
    var nomeCampo_tr_bodega_origen = "tr_bodega_origen";
    var var_tr_bodega_origen = scAjaxGetFieldSelect(nomeCampo_tr_bodega_origen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_envio_transferencias_mob_validate_tr_bodega_origen(var_tr_bodega_origen, var_script_case_init, do_ajax_form_inv_envio_transferencias_mob_validate_tr_bodega_origen_cb);
  } // do_ajax_form_inv_envio_transferencias_mob_validate_tr_bodega_origen

  function do_ajax_form_inv_envio_transferencias_mob_validate_tr_bodega_origen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_envio_transferencias_mob_validate_tr_bodega_origen_cb

  // ---------- Validate tr_establecimiento
  function do_ajax_form_inv_envio_transferencias_mob_validate_tr_establecimiento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_envio_transferencias_mob_validate_tr_establecimiento(var_tr_establecimiento, var_script_case_init, do_ajax_form_inv_envio_transferencias_mob_validate_tr_establecimiento_cb);
  } // do_ajax_form_inv_envio_transferencias_mob_validate_tr_establecimiento

  function do_ajax_form_inv_envio_transferencias_mob_validate_tr_establecimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_envio_transferencias_mob_validate_tr_establecimiento_cb

  // ---------- Validate tr_bodega_destino
  function do_ajax_form_inv_envio_transferencias_mob_validate_tr_bodega_destino()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_envio_transferencias_mob_validate_tr_bodega_destino(var_tr_bodega_destino, var_script_case_init, do_ajax_form_inv_envio_transferencias_mob_validate_tr_bodega_destino_cb);
  } // do_ajax_form_inv_envio_transferencias_mob_validate_tr_bodega_destino

  function do_ajax_form_inv_envio_transferencias_mob_validate_tr_bodega_destino_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_envio_transferencias_mob_validate_tr_bodega_destino_cb

  // ---------- Validate tr_estado
  function do_ajax_form_inv_envio_transferencias_mob_validate_tr_estado()
  {
    var nomeCampo_tr_estado = "tr_estado";
    var var_tr_estado = scAjaxGetFieldHidden(nomeCampo_tr_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_envio_transferencias_mob_validate_tr_estado(var_tr_estado, var_script_case_init, do_ajax_form_inv_envio_transferencias_mob_validate_tr_estado_cb);
  } // do_ajax_form_inv_envio_transferencias_mob_validate_tr_estado

  function do_ajax_form_inv_envio_transferencias_mob_validate_tr_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_envio_transferencias_mob_validate_tr_estado_cb

  // ---------- Refresh tr_bodega_origen
  function do_ajax_form_inv_envio_transferencias_mob_refresh_tr_bodega_origen()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_inv_envio_transferencias_mob_refresh_tr_bodega_origen(var_tr_bodega_origen, var_tr_establecimiento, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_inv_envio_transferencias_mob_refresh_tr_bodega_origen_cb);
  } // do_ajax_form_inv_envio_transferencias_mob_refresh_tr_bodega_origen

  function do_ajax_form_inv_envio_transferencias_mob_refresh_tr_bodega_origen_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    do_ajax_form_inv_envio_transferencias_mob_refresh_tr_establecimiento();
    scAjaxShowDebug();
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_envio_transferencias_mob_refresh_tr_bodega_origen_cb

  // ---------- Refresh tr_establecimiento
  function do_ajax_form_inv_envio_transferencias_mob_refresh_tr_establecimiento()
  {
    var var_tr_establecimiento = scAjaxGetFieldSelect("tr_establecimiento");
    var var_tr_bodega_origen = scAjaxGetFieldSelect("tr_bodega_origen");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_inv_envio_transferencias_mob_refresh_tr_establecimiento(var_tr_establecimiento, var_tr_bodega_origen, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_inv_envio_transferencias_mob_refresh_tr_establecimiento_cb);
  } // do_ajax_form_inv_envio_transferencias_mob_refresh_tr_establecimiento

  function do_ajax_form_inv_envio_transferencias_mob_refresh_tr_establecimiento_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_envio_transferencias_mob_refresh_tr_establecimiento_cb

  // ---------- Event onchange tr_bodega_origen
  function do_ajax_form_inv_envio_transferencias_mob_event_tr_bodega_origen_onchange()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_inv_envio_transferencias_mob_event_tr_bodega_origen_onchange(var_script_case_init, do_ajax_form_inv_envio_transferencias_mob_event_tr_bodega_origen_onchange_cb);
  } // do_ajax_form_inv_envio_transferencias_mob_event_tr_bodega_origen_onchange

  function do_ajax_form_inv_envio_transferencias_mob_event_tr_bodega_origen_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "tr_bodega_origen";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_inv_envio_transferencias_mob_event_tr_bodega_origen_onchange_cb_after_alert);
  } // do_ajax_form_inv_envio_transferencias_mob_event_tr_bodega_origen_onchange_cb
  function do_ajax_form_inv_envio_transferencias_mob_event_tr_bodega_origen_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_inv_envio_transferencias_mob_refresh_tr_bodega_origen();
    scAjaxRedir();
  } // do_ajax_form_inv_envio_transferencias_mob_event_tr_bodega_origen_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_inv_envio_transferencias_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_inv_envio_transferencias_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_tr_estado = scAjaxGetFieldHidden("tr_estado");
    ...
    scAjaxProcOn();
    x_ajax_form_inv_envio_transferencias_mob_submit_form(var_tr_fecha, var_tr_bodega_origen, var_tr_establecimiento, var_tr_bodega_destino, var_tr_estado, var_tr_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_inv_envio_transferencias_mob_submit_form_cb);
  } // do_ajax_form_inv_envio_transferencias_mob_submit_form

  function do_ajax_form_inv_envio_transferencias_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_inv_envio_transferencias_mob_submit_form_cb_after_alert);
  } // do_ajax_form_inv_envio_transferencias_mob_submit_form_cb
  function do_ajax_form_inv_envio_transferencias_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_inv_envio_transferencias_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_inv_envio_transferencias_mob_navigate_form()
  {
    perform_ajax_form_inv_envio_transferencias_mob_navigate_form();
  }

  function perform_ajax_form_inv_envio_transferencias_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_inv_envio_transferencias_mob_navigate_form(var_tr_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_inv_envio_transferencias_mob_navigate_form_cb);
  } // do_ajax_form_inv_envio_transferencias_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_envio_transferencias_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_inv_envio_transferencias_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_inv_envio_transferencias_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_inv_envio_transferencias_mob_navigate_form_cb
  function do_ajax_form_inv_envio_transferencias_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_inv_envio_transferencias_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_inv_envio_transferencias_mob_navigate_form_cb_after_alert

  function sc_hide_form_inv_envio_transferencias_mob_form()
  {
  ...
  ajax_field_list[2] = "tr_establecimiento";
  ajax_field_list[3] = "tr_bodega_destino";
  ajax_field_list[4] = "tr_estado";
