<?php
//
class form_v_sis_permisos_rol_apl
{
   ...
   var $form_vert_form_v_sis_permisos_rol = array();
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_v_sis_permisos_rol']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_v_sis_permisos_rol']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_v_sis_permisos_rol']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_v_sis_permisos_rol']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_v_sis_permisos_rol']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_v_sis_permisos_rol']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_v_sis_permisos_rol']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_v_sis_permisos_rol']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_v_sis_permisos_rol']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_v_sis_permisos_rol']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_v_sis_permisos_rol']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_v_sis_permisos_rol']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_v_sis_permisos_rol']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_v_sis_permisos_rol']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_v_sis_permisos_rol']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_v_sis_permisos_rol']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_v_sis_permisos_rol']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_v_sis_permisos_rol_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_v_sis_permisos_rol']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_v_sis_permisos_rol']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_v_sis_permisos_rol'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_v_sis_permisos_rol']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_v_sis_permisos_rol']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_v_sis_permisos_rol') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_v_sis_permisos_rol']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " v_sis_permisos_rol";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_v_sis_permisos_rol")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_v_sis_permisos_rol']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_v_sis_permisos_rol'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_v_sis_permisos_rol']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_v_sis_permisos_rol']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_v_sis_permisos_rol']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_v_sis_permisos_rol']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_v_sis_permisos_rol']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_v_sis_permisos_rol']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_v_sis_permisos_rol']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_v_sis_permisos_rol']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_v_sis_permisos_rol']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_v_sis_permisos_rol']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_v_sis_permisos_rol'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_v_sis_permisos_rol'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_v_sis_permisos_rol']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_v_sis_permisos_rol']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_v_sis_permisos_rol']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_v_sis_permisos_rol']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_v_sis_permisos_rol']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_v_sis_permisos_rol']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_v_sis_permisos_rol']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_v_sis_permisos_rol']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_v_sis_permisos_rol']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_v_sis_permisos_rol']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_v_sis_permisos_rol']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_v_sis_permisos_rol']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_v_sis_permisos_rol']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field . "_"] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_v_sis_permisos_rol']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_v_sis_permisos_rol']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_v_sis_permisos_rol']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field . "_"] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_v_sis_permisos_rol']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_v_sis_permisos_rol']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_v_sis_permisos_rol']['exit'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_v_sis_permisos_rol", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_v_sis_permisos_rol_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_v_sis_permisos_rol_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_v_sis_permisos_rol/form_v_sis_permisos_rol_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_v_sis_permisos_rol_erro.class.php"); 
      }
      $this->Erro      = new form_v_sis_permisos_rol_erro();
      $this->Erro->Ini = $this->Ini;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['sc_max_reg']) && strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['sc_max_reg']) == "all")
      {
      ...
      if ($this->nmgp_opcao == "dyn_search" || $this->nmgp_opcao == "dyn_search_clear")  
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_filter']);
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['total']);
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['cond_pesq']);
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dyn_search']);
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_detal'])) 
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_detal'];
              }
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['empty_filter'])
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['empty_filter']);
                  $this->NM_ajax_info['empty_filter'] = 'ok';
                  form_v_sis_permisos_rol_pack_ajax_response();
                  exit;
              }
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dyn_search_clear'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dyn_refresh'] = array();
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
      } 
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['opcao']))
         { 
             if ($this->per_rol_ != "" || $this->mm_id_ != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_v_sis_permisos_rol']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_v_sis_permisos_rol']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_v_sis_permisos_rol']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['opc_ant'] : "";
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_v_sis_permisos_rol']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_v_sis_permisos_rol']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      { 
          if ($GLOBALS['F'] == "mm_modulo_")
          { 
              $nm_parms   = substr($GLOBALS['P0'], 1, strlen($GLOBALS['P0']) - 2);
              $array_vars = explode(",", $nm_parms);
              $this->mm_modulo_ = $array_vars[0];
              $mm_modulo_       = $this->mm_modulo_;
              nm_limpa_numero($mm_modulo_, $this->field_config['mm_modulo_']['symbol_grp']); 
              $this->mm_modulo_       = $mm_modulo_;
              $this->lookup_mm_modulo_($conteudo);
          ...
          if ($GLOBALS['F'] == "mm_menu_")
          { 
              $nm_parms   = substr($GLOBALS['P0'], 1, strlen($GLOBALS['P0']) - 2);
              $array_vars = explode(",", $nm_parms);
              $this->mm_menu_ = $array_vars[0];
              $mm_menu_       = $this->mm_menu_;
              $this->mm_menu_       = $mm_menu_;
              $this->lookup_mm_menu_($conteudo);
              $conteudo = str_replace("&", "&amp;", $conteudo); 
              $conteudo = str_replace("\/" , "\/", $conteudo); 
              echo "<html><head></head>";
              echo " <body onload=\"p=document.layers?parentLayer:window.parent;p.jsrsLoaded('" . $GLOBALS['C'] . "');\">";
   ...
   function loadFieldConfig()
   {
      ...
      //-- mm_modulo_
      $this->field_config['mm_modulo_']               = array();
      $this->field_config['mm_modulo_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['mm_modulo_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['mm_modulo_']['symbol_dec'] = '';
      $this->field_config['mm_modulo_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['mm_modulo_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
   }
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['Gera_log_access'] = false;
      }
      if ($this->nmgp_opcao == "change_qtd_line")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['sc_max_reg'] = $this->nmgp_max_line;
      }
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['opc_edit'] = true;  
      ...
      if ($this->NM_ajax_flag && 'submit_form' == $this->NM_ajax_opcao)
      {
         ...
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dados_form'][$sc_seq_vert]))
         {
             $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dados_form'][$sc_seq_vert];
         }
         ...
         if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "")
         {
             $this->NM_rollback_db();
              if ($this->NM_ajax_flag)
              {
                  if (!isset($this->NM_ajax_info['errList']['geral_form_v_sis_permisos_rol']) || !is_array($this->NM_ajax_info['errList']['geral_form_v_sis_permisos_rol']))
                  {
                      $this->NM_ajax_info['errList']['geral_form_v_sis_permisos_rol'] = array();
                  }
                  if ($Campos_Crit != "")
                  {
                      $this->NM_ajax_info['errList']['geral_form_v_sis_permisos_rol'][] = $Campos_Crit;
                  }
                  if (!empty($Campos_Falta))
                  {
                      $this->NM_ajax_info['errList']['geral_form_v_sis_permisos_rol'][] = $this->Formata_Campos_Falta($Campos_Falta);
                  }
                  if ($this->Campos_Mens_erro != "")
                  {
                      $this->NM_ajax_info['errList']['geral_form_v_sis_permisos_rol'][] = $this->Campos_Mens_erro;
                  }
              }
         }
         else
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['sc_redir_atualiz'] == "ok")
          {
      ...
      { 
         ...
         if (isset($this->mm_descripcion_)) { $this->nm_limpa_alfa($this->mm_descripcion_); }
         if (isset($this->per_permiso_)) { $this->nm_limpa_alfa($this->per_permiso_); }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dados_form'])) 
         {
            $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dados_form'][$sc_seq_vert];
         }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dados_select'])) 
         {
            $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dados_select'][$sc_seq_vert];
         }
         if ($this->nmgp_opcao != "recarga" && (!in_array($sc_seq_vert, $sc_check_excl) && !in_array($sc_seq_vert, $sc_check_incl) ))
         { }
         else
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['sc_disabled'] = array();
             $this->controle_form_vert(); 
             ...
             $this->form_vert_form_v_sis_permisos_rol[$sc_seq_vert]['per_rol_'] =  $this->per_rol_; 
             $this->form_vert_form_v_sis_permisos_rol[$sc_seq_vert]['mm_id_'] =  $this->mm_id_; 
             $this->form_vert_form_v_sis_permisos_rol[$sc_seq_vert]['mm_modulo_'] =  $this->mm_modulo_; 
             $this->form_vert_form_v_sis_permisos_rol[$sc_seq_vert]['mm_menu_'] =  $this->mm_menu_; 
             $this->form_vert_form_v_sis_permisos_rol[$sc_seq_vert]['mm_descripcion_'] =  $this->mm_descripcion_; 
             $this->form_vert_form_v_sis_permisos_rol[$sc_seq_vert]['per_permiso_'] =  $this->per_permiso_; 
         }
         $sc_seq_vert++; 
      } 
      ...
      if ($this->NM_ajax_flag && 'table_refresh' == $this->NM_ajax_opcao)
      {
          ...
          $this->NM_ajax_info['rsSize'] = sizeof($this->form_vert_form_v_sis_permisos_rol);
      ...
      {
          $this->nm_tira_formatacao();
          if ('event_per_permiso__onchange' == $this->NM_ajax_opcao)
          {
              $this->per_permiso__onChange();
          }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
...
//
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_v_sis_permisos_rol.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol'][$path_doc_md5][1] = $Zip_name;
?>
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " v_sis_permisos_rol") ?></TITLE>
...
<form name="Fdown" method="get" action="form_v_sis_permisos_rol_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_v_sis_permisos_rol"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_v_sis_permisos_rol', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sis_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'form_v_sis_permisos_rol', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_v_sis_permisos_rol', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
//
//--------------------------------------------------------------------------------------
   function lookup_mm_modulo_(&$conteudo)
   {
      global  $mm_modulo_;
      $guarda_formatado = $this->formatado;
      $this->nm_tira_formatacao();
      ...
      $nm_comando = "SELECT opm_nombre 
FROM sis_modulo 
WHERE opm_id = '$this->mm_modulo_' 
ORDER BY opm_nombre"; 
      if ($this->mm_modulo_ == "")
      { 
          $conteudo = ""; 
...
//
//--------------------------------------------------------------------------------------
   function lookup_mm_menu_(&$conteudo)
   {
      global  $mm_menu_;
      $guarda_formatado = $this->formatado;
      $this->nm_tira_formatacao();
      ...
      $nm_comando = "SELECT mm_descripcion 
FROM sis_menu_modulo 
WHERE mm_id = '$this->mm_menu_' 
ORDER BY mm_descripcion"; 
      if ($this->mm_menu_ == "")
      { 
          $conteudo = ""; 
          $this->nm_formatar_campos();
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              ...
              $this->NM_ajax_info['errList']['geral_form_v_sis_permisos_rol'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
    ...
    function ValidateField_per_rol_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->per_rol_, 4, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Per Rol; " ; 
                  if (!isset($Campos_Erros['per_rol_']))
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['php_cmp_required']['per_rol_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['php_cmp_required']['per_rol_'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_mm_id_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->mm_id_, 4, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Mm Id; " ; 
                  if (!isset($Campos_Erros['mm_id_']))
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['php_cmp_required']['mm_id_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['php_cmp_required']['mm_id_'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Mm Id" ; 
              if (!isset($Campos_Erros['mm_id_']))
    ...
    function ValidateField_mm_modulo_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if (isset($this->Field_no_validate['mm_modulo_'])) {
          nm_limpa_numero($this->mm_modulo_, $this->field_config['mm_modulo_']['symbol_grp']) ; 
          return;
      }
      ...
      { 
          ...
          { 
              $iTestSize = 4;
              if (strlen($this->mm_modulo_) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_modulo'] . ": " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['mm_modulo_']))
                  {
                      $Campos_Erros['mm_modulo_'] = array();
                  }
                  $Campos_Erros['mm_modulo_'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  ...
                  $this->NM_ajax_info['errList']['mm_modulo_'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->mm_modulo_, 4, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_modulo'] . "; " ; 
                  if (!isset($Campos_Erros['mm_modulo_']))
                  {
                      $Campos_Erros['mm_modulo_'] = array();
                  }
    ...
    function ValidateField_mm_menu_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->mm_menu_) > 2) 
          { 
              $hasError = true;
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_menu'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 2 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['mm_menu_']))
              {
                  $Campos_Erros['mm_menu_'] = array();
              }
              $Campos_Erros['mm_menu_'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 2 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              ...
              $this->NM_ajax_info['errList']['mm_menu_'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 2 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dados_form'][$sc_seq_vert] = $this->nmgp_dados_form;
   }
   function nm_tira_formatacao()
   {
      ...
      nm_limpa_numero($this->mm_id_, $this->field_config['mm_id_']['symbol_grp']) ; 
      $this->Before_unformat['mm_modulo_'] = $this->mm_modulo_;
      nm_limpa_numero($this->mm_modulo_, $this->field_config['mm_modulo_']['symbol_grp']) ; 
   }
   ...
   function nm_formatar_campos($format_fields = array())
   {
      ...
      if ('' !== $this->mm_modulo_ || (!empty($format_fields) && isset($format_fields['mm_modulo_'])))
      {
          nmgp_Form_Num_Val($this->mm_modulo_, $this->field_config['mm_modulo_']['symbol_grp'], $this->field_config['mm_modulo_']['symbol_dec'], "0", "S", $this->field_config['mm_modulo_']['format_neg'], "", "", "-", $this->field_config['mm_modulo_']['symbol_fmt']) ; 
      }
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['navStatus']['ret'] = $this->Nav_permite_ret ? 'S' : 'N';
              $this->NM_ajax_info['navStatus']['ava'] = $this->Nav_permite_ava ? 'S' : 'N';
              $this->NM_ajax_info['fldList']['per_rol_']['keyVal'] = form_v_sis_permisos_rol_pack_protect_string($this->nmgp_dados_form['per_rol_']);
              $this->NM_ajax_info['fldList']['mm_id_']['keyVal'] = form_v_sis_permisos_rol_pack_protect_string($this->nmgp_dados_form['mm_id_']);
          }
   } // ajax_return_values
   function ajax_return_values_all_vert()
   {
          ...
          {
              $this->form_vert_form_v_sis_permisos_rol[$this->nmgp_refresh_row] = $this->NM_ajax_info['param'];
              if ((isset($this->Embutida_ronly) && $this->Embutida_ronly) || $this->NM_ajax_force_values)
              {
                  ...
                  {
                      $this->form_vert_form_v_sis_permisos_rol[$this->nmgp_refresh_row]['per_rol_'] = $this->per_rol_;
                  }
                  if (isset($this->NM_ajax_changed['mm_id_']) && $this->NM_ajax_changed['mm_id_'])
                  {
                      $this->form_vert_form_v_sis_permisos_rol[$this->nmgp_refresh_row]['mm_id_'] = $this->mm_id_;
                  }
                  if (isset($this->NM_ajax_changed['mm_modulo_']) && $this->NM_ajax_changed['mm_modulo_'])
                  {
                      $this->form_vert_form_v_sis_permisos_rol[$this->nmgp_refresh_row]['mm_modulo_'] = $this->mm_modulo_;
                  }
                  if (isset($this->NM_ajax_changed['mm_menu_']) && $this->NM_ajax_changed['mm_menu_'])
                  {
                      $this->form_vert_form_v_sis_permisos_rol[$this->nmgp_refresh_row]['mm_menu_'] = $this->mm_menu_;
                  }
                  if (isset($this->NM_ajax_changed['mm_descripcion_']) && $this->NM_ajax_changed['mm_descripcion_'])
                  {
                      $this->form_vert_form_v_sis_permisos_rol[$this->nmgp_refresh_row]['mm_descripcion_'] = $this->mm_descripcion_;
                  }
                  if (isset($this->NM_ajax_changed['per_permiso_']) && $this->NM_ajax_changed['per_permiso_'])
                  {
                      $this->form_vert_form_v_sis_permisos_rol[$this->nmgp_refresh_row]['per_permiso_'] = $this->per_permiso_;
                  }
              }
          }
          ...
          foreach($this->form_vert_form_v_sis_permisos_rol as $sc_seq_vert => $aRecData)
          {
          ...
          $aLookupOrig = $aLookup;
              ...
              $this->mm_modulo_ = $aRecData['mm_modulo_'];
              $orig_mm_modulo_ = $this->mm_modulo_;
              $mm_modulo_      = $this->mm_modulo_;
              nm_limpa_numero($mm_modulo_, $this->field_config['mm_modulo_']['symbol_grp']); 
              $this->mm_modulo_ = $mm_modulo_;
              $this->lookup_mm_modulo_($conteudo);
              $this->mm_modulo_ = $orig_mm_modulo_;
              $this->NM_ajax_info['fldList']['mm_modulo_' . $sc_seq_vert]['lookupCons'] = form_v_sis_permisos_rol_pack_protect_string($conteudo);
              }
          ...
          $aLookupOrig = $aLookup;
              ...
              $this->mm_menu_ = $aRecData['mm_menu_'];
              $orig_mm_menu_ = $this->mm_menu_;
              $mm_menu_      = $this->mm_menu_;
              $this->mm_menu_ = $mm_menu_;
              $this->lookup_mm_menu_($conteudo);
              $this->mm_menu_ = $orig_mm_menu_;
              $this->NM_ajax_info['fldList']['mm_menu_' . $sc_seq_vert]['lookupCons'] = form_v_sis_permisos_rol_pack_protect_string($conteudo);
              }
          ...
          $aLookupOrig = $aLookup;
              ...
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("per_permiso_", $this->nmgp_refresh_fields)))
              {
                  ...
                  $aLookup = array();
$aLookup[] = array(form_v_sis_permisos_rol_pack_protect_string('S') => str_replace('<', '&lt;',form_v_sis_permisos_rol_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['Lookup_per_permiso_'][] = 'S';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['per_permiso_' . $sc_seq_vert]['valList'][$i] = form_v_sis_permisos_rol_pack_protect_string($v);
          }
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['Field_no_validate'] = array();
      $this->nm_guardar_campos();
...
//----------- 
   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar")
      {
          ...
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dados_select'][$sc_seq_vert]['per_rol_'] = $this->per_rol_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dados_select'][$sc_seq_vert]['mm_id_'] = $this->mm_id_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dados_select'][$sc_seq_vert]['mm_modulo_'] = $this->mm_modulo_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dados_select'][$sc_seq_vert]['mm_menu_'] = $this->mm_menu_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dados_select'][$sc_seq_vert]['mm_descripcion_'] = $this->mm_descripcion_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dados_select'][$sc_seq_vert]['per_permiso_'] = $this->per_permiso_;
          }
      }
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "mm_modulo = $this->mm_modulo_, mm_menu = $this->mm_menu_, mm_descripcion = '$this->mm_descripcion_', per_permiso = '$this->per_permiso_'"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          { 
              ...
              nm_limpa_numero($mm_modulo_, $this->field_config['mm_modulo_']['symbol_grp']); 
                  ...
                  $this->lookup_mm_modulo_($conteudo);
                  $this->mm_modulo_ = $orig_mm_modulo_;
                  $this->NM_ajax_info['fldList']['mm_modulo_' . $this->nmgp_refresh_row]['lookupCons'] = form_v_sis_permisos_rol_pack_protect_string($conteudo);
                  $tmpLabel_mm_modulo_ = $this->mm_modulo_;
                  $this->NM_ajax_info['fldList']['mm_modulo_' . $this->nmgp_refresh_row]['type']    = 'label';
                  ...
                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      ...
                      {
                          $this->NM_ajax_info['readOnly']['mm_modulo_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
                  ...
                  $this->lookup_mm_menu_($conteudo);
                  $this->mm_menu_ = $orig_mm_menu_;
                  $this->NM_ajax_info['fldList']['mm_menu_' . $this->nmgp_refresh_row]['lookupCons'] = form_v_sis_permisos_rol_pack_protect_string($conteudo);
                  $tmpLabel_mm_menu_ = $this->mm_menu_;
                  $this->NM_ajax_info['fldList']['mm_menu_' . $this->nmgp_refresh_row]['type']    = 'label';
                  ...
                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      ...
                      {
                          $this->NM_ajax_info['readOnly']['mm_menu_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
                  ...
                  $tmpLabel_mm_descripcion_ = $this->mm_descripcion_;
                  $this->NM_ajax_info['fldList']['mm_descripcion_' . $this->nmgp_refresh_row]['type']    = 'label';
                  ...
                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      ...
                      {
                          $this->NM_ajax_info['readOnly']['mm_descripcion_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
...
$_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['Lookup_per_permiso_'][] = 'S';
          ...
          {
              $aTemp_per_permiso_[$i] = form_v_sis_permisos_rol_pack_protect_string(NM_charset_to_utf8($v));
          }
          ...
          $tmpLabel_per_permiso_ = $sLabelTemp;
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['parms'] = "per_rol_?#?$this->per_rol_?@?mm_id_?#?$this->mm_id_?@?"; 
      }
...
//---------- 
   ...
   { 
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_v_sis_permisos_rol']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_v_sis_permisos_rol']['rows']))
      {
          $this->sc_max_reg = $_SESSION['scriptcase']['sc_apl_conf']['form_v_sis_permisos_rol']['rows'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_v_sis_permisos_rol']['rows_ins']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_v_sis_permisos_rol']['rows_ins']))
      {
          $this->sc_max_reg_incl = $_SESSION['scriptcase']['sc_apl_conf']['form_v_sis_permisos_rol']['rows_ins'];
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_liga_qtd_reg']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_liga_qtd_reg'])
      {
          $this->sc_max_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_liga_qtd_reg'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['sc_max_reg']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['sc_max_reg'] > 0 || strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['sc_max_reg']) == "all"))
      {
          $this->sc_max_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['sc_max_reg'];
      } 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
      $this->form_vert_form_v_sis_permisos_rol = array();
      if ($this->nmgp_opcao != "novo") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['parms'] = ""; 
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
      { 
          $GLOBALS["NM_ERRO_IBASE"] = 1;  
      ...
      {
          $this->nmgp_opcao = "avanca";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['reg_start'] -= $this->sc_max_reg;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['reg_start'] = 0;
      }
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['total']);
          }
      }
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_filter'] . ")";
          }
      }
      $sc_where = "";
      if ('' != $sc_where_filter)
      ...
      if ('total' != $this->form_paginacao)
      {
          if ($this->app_is_initializing || $this->sc_teve_excl || $this->sc_teve_incl || (isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['total']))
          {
              ...
              $qt_geral_reg_form_v_sis_permisos_rol = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['total'] = $qt_geral_reg_form_v_sis_permisos_rol;
              $rt->Close();
          }
      if ((isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['total']) || $this->sc_teve_excl || $this->sc_teve_incl)
      { 
          ...
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->per_rol_) && !empty($this->mm_id_))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['reg_start'] = $Count_start;
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_v_sis_permisos_rol = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['total'];
      } 
      if ($this->nmgp_opcao == "inicio" || $this->nmgp_opcao == "ordem") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['reg_start'] = 0; 
      } 
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_v_sis_permisos_rol) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if ($this->nmgp_opcao == "avanca")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['reg_start'] += $this->sc_max_reg; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['reg_start'] > $qt_geral_reg_form_v_sis_permisos_rol)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['reg_start'] = $qt_geral_reg_form_v_sis_permisos_rol - $this->sc_max_reg; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['reg_start'] = ($qt_geral_reg_form_v_sis_permisos_rol + 1) - $this->sc_max_reg; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['reg_start'] < 0)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['reg_start'] = 0; 
          }
      ...
      $Cmps_ord_def = array();
      $Cmps_ord_def[] = "per_rol";
      $Cmps_ord_def[] = "mm_id";
      $Cmps_ord_def[] = "mm_modulo";
      $Cmps_ord_def[] = "mm_menu";
      $Cmps_ord_def[] = "mm_descripcion";
      $Cmps_ord_def[] = "per_permiso";
      $sc_order_by  = "";
      $sc_order_by = "mm_modulo,mm_menu";
      $sc_order_by = str_replace("order by ", "", $sc_order_by);
      $sc_order_by = str_replace("ORDER BY ", "", trim($sc_order_by));
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['ordem_cmp'] != $this->nmgp_ordem)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['ordem_cmp'] = $this->nmgp_ordem; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['ordem_ord'] = ' asc'; 
              switch ($this->nmgp_ordem) {
                  case "per_rol":
                      $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['ordem_ord'] = ' desc';
                      break;
                  case "mm_id":
                      $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['ordem_ord'] = ' desc';
                      break;
          ...
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['ordem_ord'] == ' asc')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['ordem_ord'] = ' desc'; 
          }
          else
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['ordem_cmp'])) 
      { 
          $sc_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['ordem_cmp'] . $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['ordem_ord']; 
      } 
      ...
      else
      {
          ...
          { 
              ...
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['reg_start'] . ")" ; 
                  $rs = $this->Db->SelectLimit($nmgp_select, $this->sc_max_reg, $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['reg_start']) ; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['reg_start'] . ")" ; 
              ...
              { 
                  ...
                  if (!$rs === false && !$rs->EOF) 
                  { 
                      $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['reg_start']) ;  
                  } 
              } 
          } 
      }
          ...
          {
              $sc_seq_vert = 0; 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_filter']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['empty_filter'] = true;
              }
          }
          else
          {
          ...
          { 
              ...
              if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['parms'])) 
              { 
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['parms'] = "per_rol_?#?$this->per_rol_?@?mm_id_?#?$this->mm_id_?@?";
              } 
...
//
//-- 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dados_select'][$sc_seq_vert] = $this->nmgp_dados_select;
              $this->nm_guardar_campos();
              $this->nm_formatar_campos();
             $this->form_vert_form_v_sis_permisos_rol[$sc_seq_vert]['per_rol_'] =  $this->per_rol_; 
             $this->form_vert_form_v_sis_permisos_rol[$sc_seq_vert]['mm_id_'] =  $this->mm_id_; 
          ...
          ksort ($this->form_vert_form_v_sis_permisos_rol); 
          $rs->Close(); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['reg_qtd'] = $sc_seq_vert + $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['reg_start'] - 1;
          if ('total' == $this->form_paginacao)
          {
          ...
          {
              $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['reg_start'] + 1; 
              $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['reg_qtd']; 
              $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['total'] + 1; 
          }
          ...
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['reg_start'] < (($qt_geral_reg_form_v_sis_permisos_rol + 1) - $this->sc_max_reg);
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['opcao'] = '';
          }
      } 
      if ($this->nmgp_opcao == "novo") 
      { 
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_multi']) 
          { 
          } 
...
// 
   ...
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dados_select'][$sc_seq_vert] ))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dados_select'][$sc_seq_vert] ;
...
// 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['reg_start'] + $this->sc_max_reg;
       ...
       foreach ($Arr_result as $Ind_result => $Lin_result)
       {
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['record_state'][$sc_seq_vert]['buttons'] = array(
                        'delete' => $this->nmgp_botoes['delete'],
                        'update' => $this->nmgp_botoes['update']
                );
        }
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }

//
function per_permiso__onChange()
{
$_SESSION['scriptcase']['form_v_sis_permisos_rol']['contr_erro'] = 'on';
...
$update_sql ="UPDATE sis_permiso_rol
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
   ...
   {
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['table_refresh'] = true;
   ...
   else
   {
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['csrf_token'];
    }
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      if (empty($data_search)) 
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_detal'];
          }
      ...
      foreach ($fields as $field) {
          ...
          if ($field == "SC_all_Cmp") 
          {
              $this->SC_monta_condicao($comando, "mm_modulo", $arg_search, str_replace(",", ".", $data_search), "INT4", false);
          }
          if ($field == "SC_all_Cmp") 
          {
              $this->SC_monta_condicao($comando, "mm_menu", $arg_search, str_replace(",", ".", $data_search), "INT4", false);
          }
          if ($field == "SC_all_Cmp") 
          {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_v_sis_permisos_rol = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['total'] = $qt_geral_reg_form_v_sis_permisos_rol;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_v_sis_permisos_rol_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
   ...
   function html_dynamic_search()
   {
       ...
       $this->NM_case_insensitive = true;
      $this->Dyn_search_str = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['cond_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['cond_pesq']))
       {
           $tmp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['cond_pesq'];
           $pos = strrpos($tmp, "##*@@");
           if ($pos !== false)
           {
       ...
       if ($this->NM_ajax_flag)
       {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dyn_search_clear']))
           {
               return;
           }
       }
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dyn_search_label'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dyn_search_label']['mm_modulo_'] = (isset($this->New_label['mm_modulo_'])) ? $this->New_label['mm_modulo_'] : "" . $this->Ini->Nm_lang['lang_modulo'] . "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dyn_search_label']['mm_menu_'] = (isset($this->New_label['mm_menu_'])) ? $this->New_label['mm_menu_'] : "" . $this->Ini->Nm_lang['lang_menu'] . "";
       if ($this->NM_ajax_flag)
       { 
          ob_start();
       } 
...
<?php
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dyn_search']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dyn_search']))
       {
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dyn_search'] as $IX => $def)
           {
               $cmp = $def['cmp'];
               if ($cmp == "mm_modulo_")
               {
      ...
      <table id='id_dynamic_search_fields' class='SC_SubMenuApp' style='display:none; position: absolute; border-collapse: collapse; z-index: 1000;'> 
        <tr>
            <td class='scBtnGrpBackground'>
                <div class='scBtnGrpText' style='cursor: pointer;' onclick="ajax_add_dyn_search('mm_modulo_', 'form')"><?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dyn_search_label']['mm_modulo_'] ?>
                </div>
            </td>
        </tr>
        <tr>
            <td class='scBtnGrpBackground'>
                <div class='scBtnGrpText' style='cursor: pointer;' onclick="ajax_add_dyn_search('mm_menu_', 'form')"><?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dyn_search_label']['mm_menu_'] ?>
                </div>
            </td>
        </tr>
      </table> 
...
<?php
       ...
       { 
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dyn_search_clear']))
           { 
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dyn_search_clear']);
           } 
           return;
       } 
?>
...
<?php
   ...
   function dynamic_search_mm_modulo_($ind, $ajax, $opc="", $val=array())
   {
       ...
       $lin_obj .= "      <td style='border-style: none' nowrap>" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dyn_search_label']['mm_modulo_'] . "</td>";
       ...
       $nm_comando = "SELECT opm_id, opm_nombre  FROM sis_modulo WHERE opm_sistema='1'  ORDER BY opm_nombre"; 
       if ($this->NM_case_insensitive)
       {
           if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
   ...
   function dynamic_search_mm_menu_($ind, $ajax, $opc="", $val=array())
   {
       ...
       $lin_obj .= "      <td style='border-style: none' nowrap>" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dyn_search_label']['mm_menu_'] . "</td>";
       $lin_obj .= "      <td style='border-style: none' >";
       if (empty($opc))
       {
           $opc = "eq";
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dyn_refresh']['mm_modulo_']))
       {
           $mm_modulo_ = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dyn_refresh']['mm_modulo_'];
       }
...
?>
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['ajax_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['ajax_nav'])
   { 
...
function ajax_refresh_dyn_search(fields, parms)
{
    ...
    $.ajax({
      type: "POST",
      url: "form_v_sis_permisos_rol.php",
...
<?php
   ...
   function SC_proc_dyn_search($Parms)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dyn_search'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dyn_refresh'] = array();
       foreach ($tmp as $cada_f)
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dyn_search'][] = array('cmp' => $dats[0], 'opc' => $dats[1], 'val' => $val_sv);
           $ix++;
       }
       $this->NM_case_insensitive = true;
       $this->Dyn_Serarch_and_or = "and";
       $this->Cmd_Dyn_Search    = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['cond_dyn_search'] = "";
       foreach ($fields as $ind => $dados)
       {
           ...
           {
               $Label_cmp     = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dyn_search_label']['mm_modulo_'];
           ...
           {
               $Label_cmp     = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dyn_search_label']['mm_menu_'];
               $dados['vls'][0] = $dados['vls'][0][0];
               $tmp_pos = (is_string($dados['vls'][0])) ? strpos($dados['vls'][0], "##@@") : false;
               if ($tmp_pos === false)
               {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_pesq_filtro'] = "( " . $this->Cmd_Dyn_Search . " )";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_detal']) && !empty($this->Cmd_Dyn_Search)) 
       {
           $this->Cmd_Dyn_Search = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_detal'] . " and (" .  $this->Cmd_Dyn_Search . ")";
       }
       $sc_where = "";
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_pesq'] = $sc_where;
       $nmgp_select = "SELECT count(*) AS countTest from " . $this->Ini->nm_tabela . $sc_where; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
       $rt = $this->Db->Execute($nmgp_select) ; 
       if ($rt === false && !$rt->EOF && $GLOBALS["NM_ERRO_IBASE"] != 1) 
       ...
       $qt_geral_reg_form_v_sis_permisos_rol = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['total'] = $qt_geral_reg_form_v_sis_permisos_rol;
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['where_filter'] = $this->Cmd_Dyn_Search;
       $rt->Close(); 
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['cond_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['cond_dyn_search'] . $this->Dyn_Serarch_and_or;
       if (NM_is_utf8($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['cond_pesq']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['cond_pesq'] = sc_convert_encoding($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['cond_pesq'], $_SESSION['scriptcase']['charset'], "UTF-8");
       }
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['empty_filter']);
   ...
   function SC_proc_dyn_search_lookup($cond, $vls, $sql, $tp, $tsql, $lab)
   {
       ...
       if (!empty($nm_cmd))
       {
           ...
           if ($cond == "DF" || $cond == "NP")
           {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['cond_dyn_search'] .= $lab . " " . $this->Ini->Nm_lang['lang_srch_not_like'] . " " . $nm_cond . "##*@@";
           }
           else
           {
               $this->Cmd_Dyn_Search .= "(" . $ini_lower . $sql . $end_lower . " in (" . $nm_cmd . "))";
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['cond_dyn_search'] .= $lab . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
           }
       }
   }
   function SC_proc_dyn_search_all($cond, $vls, $sql, $tp, $tsql, $lab, $tp_unaccent=false)
   {
       $nm_aspas  = "'";
       $nm_aspas1 = "'";
       if ($tp == "N" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['decimal_db'] == ".")
       {
           $nm_aspas  = "";
           $nm_aspas1 = "";
       }
       if ($tp == "DT" || $tp == "DH" || $tp == "HH")
       {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['SC_sep_date1'];
          }
       }
       $nm_ini_lower = "";
       $nm_fim_lower = "";
       ...
       $dados   = $vls[0];
           ...
           if (!empty($nm_cmd))
           {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['cond_dyn_search'] .= $nm_cond;
           }
   }
   ...
   function SC_dyn_search_refresh_field($NM_fields_refresh, $NM_parms_refresh)
   {
        ...
        foreach ($NMparms_refr as $Cada_cmp)
        {
            ...
            if (in_array($Cmp_name, $mult_val))
            {
               ...
               $$Cmp_name = $list;
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dyn_refresh'][$Cmp_name] = $list;
            }
            else
            {
                $$Cmp_name = $Sc_temp[0];
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dyn_refresh'][$Cmp_name] = $Sc_temp[0];
            }
        }
 ...
 $nmgp_def_dados[] = array("" => "" . $this->Ini->Nm_lang['lang_seleccione'] . ""); 
       $nm_comando = "SELECT mm_id, mm_descripcion  FROM sis_menu_modulo  where mm_modulo='$mm_modulo_' ORDER BY mm_descripcion"; 
       if ($this->NM_case_insensitive)
       {
           if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
       ...
       { 
          ...
          { 
            ...
            $cmp1 = $this->form_v_sis_permisos_rol_pack_protect_string(str_replace(array("\r", "\n"), array('', '<br />'), $cmp1));
            $cmp2 = $this->form_v_sis_permisos_rol_pack_protect_string(str_replace(array("\r", "\n"), array('', '<br />'), $cmp2));
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_v_sis_permisos_rol_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_v_sis_permisos_rol_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
<?php
  exit;
    ...
    function displayAppHeader()
    {
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['mostra_cab']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['mostra_cab'] == "N") {
            return;
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['ordem_ord'] == " desc") {
