...
$old_error_handler = set_error_handler("form_v_sis_permisos_rol_scriptcase_error_handler");

function form_v_sis_permisos_rol_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['form_v_sis_permisos_rol']['contr_erro']) && $_SESSION['scriptcase']['form_v_sis_permisos_rol']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_v_sis_permisos_rol->contr_form_v_sis_permisos_rol->Apl_com_erro = true;
            if ($inicial_form_v_sis_permisos_rol->contr_form_v_sis_permisos_rol->NM_ajax_flag)
            {
                $inicial_form_v_sis_permisos_rol->contr_form_v_sis_permisos_rol->NM_ajax_info['errList']['geral_form_v_sis_permisos_rol'][] = $msg;
                return;
            }
            form_v_sis_permisos_rol_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_v_sis_permisos_rol_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_v_sis_permisos_rol'])  && '' != $_SESSION['scriptcase']['error_icon']['form_v_sis_permisos_rol'])  ? $_SESSION['scriptcase']['error_icon']['form_v_sis_permisos_rol']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_v_sis_permisos_rol']) && '' != $_SESSION['scriptcase']['error_span_title']['form_v_sis_permisos_rol']) ? $_SESSION['scriptcase']['error_span_title']['form_v_sis_permisos_rol'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_v_sis_permisos_rol']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_v_sis_permisos_rol']) ? $_SESSION['scriptcase']['error_icon_title']['form_v_sis_permisos_rol'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_v_sis_permisos_rol']['error_buffer'] .= ob_get_flush();
}
