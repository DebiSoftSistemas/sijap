  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_v_sis_permisos_rol" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_v_sis_permisos_rol_form();
	}
...
?>
  ...
  // ---------- Validate per_rol_
  function do_ajax_form_v_sis_permisos_rol_validate_per_rol_(iNumLinha)
  {
    var nomeCampo_per_rol_ = "per_rol_" + iNumLinha;
    var var_per_rol_ = scAjaxGetFieldText(nomeCampo_per_rol_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_v_sis_permisos_rol_validate_per_rol_(var_per_rol_, iNumLinha, var_script_case_init, do_ajax_form_v_sis_permisos_rol_validate_per_rol__cb);
  } // do_ajax_form_v_sis_permisos_rol_validate_per_rol_

  function do_ajax_form_v_sis_permisos_rol_validate_per_rol__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "per_rol_" + iLineNumber;
    }
    else
    {
      sFieldValid = "per_rol_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "per_rol_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "per_rol_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_v_sis_permisos_rol_validate_per_rol__cb

  // ---------- Validate mm_id_
  function do_ajax_form_v_sis_permisos_rol_validate_mm_id_(iNumLinha)
  {
    var nomeCampo_mm_id_ = "mm_id_" + iNumLinha;
    var var_mm_id_ = scAjaxGetFieldText(nomeCampo_mm_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_v_sis_permisos_rol_validate_mm_id_(var_mm_id_, iNumLinha, var_script_case_init, do_ajax_form_v_sis_permisos_rol_validate_mm_id__cb);
  } // do_ajax_form_v_sis_permisos_rol_validate_mm_id_

  function do_ajax_form_v_sis_permisos_rol_validate_mm_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "mm_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "mm_id_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "mm_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "mm_id_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_v_sis_permisos_rol_validate_mm_id__cb

  // ---------- Validate mm_modulo_
  function do_ajax_form_v_sis_permisos_rol_validate_mm_modulo_(iNumLinha)
  {
    var nomeCampo_mm_modulo_ = "mm_modulo_" + iNumLinha;
    var var_mm_modulo_ = scAjaxGetFieldHidden(nomeCampo_mm_modulo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_v_sis_permisos_rol_validate_mm_modulo_(var_mm_modulo_, iNumLinha, var_script_case_init, do_ajax_form_v_sis_permisos_rol_validate_mm_modulo__cb);
  } // do_ajax_form_v_sis_permisos_rol_validate_mm_modulo_

  function do_ajax_form_v_sis_permisos_rol_validate_mm_modulo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "mm_modulo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "mm_modulo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "mm_modulo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "mm_modulo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_v_sis_permisos_rol_validate_mm_modulo__cb

  // ---------- Validate mm_menu_
  function do_ajax_form_v_sis_permisos_rol_validate_mm_menu_(iNumLinha)
  {
    var nomeCampo_mm_menu_ = "mm_menu_" + iNumLinha;
    var var_mm_menu_ = scAjaxGetFieldHidden(nomeCampo_mm_menu_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_v_sis_permisos_rol_validate_mm_menu_(var_mm_menu_, iNumLinha, var_script_case_init, do_ajax_form_v_sis_permisos_rol_validate_mm_menu__cb);
  } // do_ajax_form_v_sis_permisos_rol_validate_mm_menu_

  function do_ajax_form_v_sis_permisos_rol_validate_mm_menu__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "mm_menu_" + iLineNumber;
    }
    else
    {
      sFieldValid = "mm_menu_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "mm_menu_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "mm_menu_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_v_sis_permisos_rol_validate_mm_menu__cb

  // ---------- Validate mm_descripcion_
  function do_ajax_form_v_sis_permisos_rol_validate_mm_descripcion_(iNumLinha)
  {
    var nomeCampo_mm_descripcion_ = "mm_descripcion_" + iNumLinha;
    var var_mm_descripcion_ = scAjaxGetFieldHidden(nomeCampo_mm_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_v_sis_permisos_rol_validate_mm_descripcion_(var_mm_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_v_sis_permisos_rol_validate_mm_descripcion__cb);
  } // do_ajax_form_v_sis_permisos_rol_validate_mm_descripcion_

  function do_ajax_form_v_sis_permisos_rol_validate_mm_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "mm_descripcion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "mm_descripcion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "mm_descripcion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "mm_descripcion_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_v_sis_permisos_rol_validate_mm_descripcion__cb

  // ---------- Validate per_permiso_
  function do_ajax_form_v_sis_permisos_rol_validate_per_permiso_(iNumLinha)
  {
    var nomeCampo_per_permiso_ = "per_permiso_" + iNumLinha;
    var var_per_permiso_ = scAjaxGetFieldCheckbox(nomeCampo_per_permiso_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_v_sis_permisos_rol_validate_per_permiso_(var_per_permiso_, iNumLinha, var_script_case_init, do_ajax_form_v_sis_permisos_rol_validate_per_permiso__cb);
  } // do_ajax_form_v_sis_permisos_rol_validate_per_permiso_

  function do_ajax_form_v_sis_permisos_rol_validate_per_permiso__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "per_permiso_" + iLineNumber;
    }
    else
    {
      sFieldValid = "per_permiso_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "per_permiso_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "per_permiso_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_v_sis_permisos_rol_validate_per_permiso__cb

  // ---------- Event onchange per_permiso_
  function do_ajax_form_v_sis_permisos_rol_event_per_permiso__onchange(iSeqForm)
  {
    var var_per_permiso_ = scAjaxGetFieldCheckbox("per_permiso_" + iSeqForm, ";");
    var var_per_rol_ = scAjaxGetFieldText("per_rol_" + iSeqForm);
    var var_mm_id_ = scAjaxGetFieldText("mm_id_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_v_sis_permisos_rol_event_per_permiso__onchange(var_per_permiso_, var_per_rol_, var_mm_id_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_v_sis_permisos_rol_event_per_permiso__onchange_cb);
  } // do_ajax_form_v_sis_permisos_rol_event_per_permiso__onchange

  function do_ajax_form_v_sis_permisos_rol_event_per_permiso__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_v_sis_permisos_rol_event_per_permiso__onchange_cb_after_alert);
  } // do_ajax_form_v_sis_permisos_rol_event_per_permiso__onchange_cb
  function do_ajax_form_v_sis_permisos_rol_event_per_permiso__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_v_sis_permisos_rol_event_per_permiso__onchange_cb_after_alert

  // ---------- Event onclick per_permiso_
  function do_ajax_form_v_sis_permisos_rol_event_per_permiso__onclick(iSeqForm)
  {
    var var_per_permiso_ = scAjaxGetFieldCheckbox("per_permiso_" + iSeqForm, ";");
    var var_per_rol_ = scAjaxGetFieldText("per_rol_" + iSeqForm);
    var var_mm_id_ = scAjaxGetFieldText("mm_id_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_v_sis_permisos_rol_event_per_permiso__onclick(var_per_permiso_, var_per_rol_, var_mm_id_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_v_sis_permisos_rol_event_per_permiso__onclick_cb);
  } // do_ajax_form_v_sis_permisos_rol_event_per_permiso__onclick

  function do_ajax_form_v_sis_permisos_rol_event_per_permiso__onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_v_sis_permisos_rol_event_per_permiso__onclick_cb_after_alert);
  } // do_ajax_form_v_sis_permisos_rol_event_per_permiso__onclick_cb
  function do_ajax_form_v_sis_permisos_rol_event_per_permiso__onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_v_sis_permisos_rol_event_per_permiso__onclick_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_v_sis_permisos_rol_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_v_sis_permisos_rol_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_v_sis_permisos_rol_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_v_sis_permisos_rol_add_new_line_cb);
  } // do_ajax_form_v_sis_permisos_rol_add_new_line

  function do_ajax_form_v_sis_permisos_rol_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_v_sis_permisos_rol_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_v_sis_permisos_rol_backup_line(iNumLinha)
  {
    var var_per_rol_ = scAjaxGetFieldText("per_rol_" + iNumLinha);
    var var_mm_id_ = scAjaxGetFieldText("mm_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_v_sis_permisos_rol_backup_line(var_per_rol_, var_mm_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_v_sis_permisos_rol_backup_line_cb);
  } // do_ajax_form_v_sis_permisos_rol_backup_line

  function do_ajax_form_v_sis_permisos_rol_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_v_sis_permisos_rol_backup_line_cb

  function do_ajax_form_v_sis_permisos_rol_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_v_sis_permisos_rol_cancel_insert

  function do_ajax_form_v_sis_permisos_rol_cancel_update(iSeqVert)
  {
    do_ajax_form_v_sis_permisos_rol_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_v_sis_permisos_rol_cancel_update

  function do_ajax_form_v_sis_permisos_rol_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_v_sis_permisos_rol_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_v_sis_permisos_rol_table_refresh()
  {
    var var_per_rol_ = document.F2.per_rol_.value;
    var var_mm_id_ = document.F2.mm_id_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_v_sis_permisos_rol_table_refresh(var_per_rol_, var_mm_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_v_sis_permisos_rol_table_refresh_cb);
  } //  do_ajax_form_v_sis_permisos_rol_table_refresh

  function do_ajax_form_v_sis_permisos_rol_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.per_rol_.value = scAjaxGetKeyValue("per_rol_");
    document.F2.mm_id_.value = scAjaxGetKeyValue("mm_id_");
    ...
    scAjaxAlert(do_ajax_form_v_sis_permisos_rol_table_refresh_cb_after_alert);
  } // do_ajax_form_v_sis_permisos_rol_table_refresh_cb
  function do_ajax_form_v_sis_permisos_rol_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_v_sis_permisos_rol_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_v_sis_permisos_rol_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_v_sis_permisos_rol_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_per_rol_ = scAjaxGetFieldText("per_rol_" + iNumLinha);
    var var_mm_id_ = scAjaxGetFieldText("mm_id_" + iNumLinha);
    var var_mm_modulo_ = scAjaxGetFieldHidden("mm_modulo_" + iNumLinha);
    var var_mm_menu_ = scAjaxGetFieldHidden("mm_menu_" + iNumLinha);
    var var_mm_descripcion_ = scAjaxGetFieldHidden("mm_descripcion_" + iNumLinha);
    var var_per_permiso_ = scAjaxGetFieldCheckbox("per_permiso_" + iNumLinha, ";");
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_v_sis_permisos_rol_submit_form(var_per_rol_, var_mm_id_, var_mm_modulo_, var_mm_menu_, var_mm_descripcion_, var_per_permiso_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_v_sis_permisos_rol_submit_form_cb);
  } // do_ajax_form_v_sis_permisos_rol_submit_form

  function do_ajax_form_v_sis_permisos_rol_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("per_rol_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("mm_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("mm_modulo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("mm_menu_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("mm_descripcion_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("per_permiso_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_v_sis_permisos_rol_submit_form_cb_after_alert);
  } // do_ajax_form_v_sis_permisos_rol_submit_form_cb
  function do_ajax_form_v_sis_permisos_rol_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_v_sis_permisos_rol_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_v_sis_permisos_rol_navigate_form()
  {
    perform_ajax_form_v_sis_permisos_rol_navigate_form();
  }

  function perform_ajax_form_v_sis_permisos_rol_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    {
      scAjaxHideErrorDisplay("per_rol_" + iNavForm);
      scAjaxHideErrorDisplay("mm_id_" + iNavForm);
      scAjaxHideErrorDisplay("mm_modulo_" + iNavForm);
      scAjaxHideErrorDisplay("mm_menu_" + iNavForm);
      scAjaxHideErrorDisplay("mm_descripcion_" + iNavForm);
      scAjaxHideErrorDisplay("per_permiso_" + iNavForm);
    }
    var var_per_rol_ = document.F2.per_rol_.value;
    var var_mm_id_ = document.F2.mm_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    ...
    scAjaxProcOn();
    x_ajax_form_v_sis_permisos_rol_navigate_form(var_per_rol_, var_mm_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_v_sis_permisos_rol_navigate_form_cb);
  } // do_ajax_form_v_sis_permisos_rol_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_sis_permisos_rol']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_v_sis_permisos_rol_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.per_rol_.value = scAjaxGetKeyValue("per_rol_" + var_last_index);
    document.F2.mm_id_.value = scAjaxGetKeyValue("mm_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_v_sis_permisos_rol_navigate_form_cb_after_alert);
  } // do_ajax_form_v_sis_permisos_rol_navigate_form_cb
  function do_ajax_form_v_sis_permisos_rol_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_v_sis_permisos_rol_navigate_form_cb_after_alert

    function sc_form_v_sis_permisos_rol_get_last_line_number()
    {
    ...
    } //sc_form_v_sis_permisos_rol_get_last_line_number

  function sc_hide_form_v_sis_permisos_rol_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "per_rol_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "mm_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "mm_modulo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "mm_menu_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "mm_descripcion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "per_permiso_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["per_rol_" + iNumLinha] = {"label": "Per Rol<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["mm_id_" + iNumLinha] = {"label": "Mm Id<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["mm_modulo_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_modulo'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["mm_menu_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_menu'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["mm_descripcion_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_opcion_menu'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["per_permiso_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_permiso_rol'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["per_rol_"][iNumLinha] = "per_rol_" + iNumLinha;
    ajax_field_mult["mm_id_"][iNumLinha] = "mm_id_" + iNumLinha;
    ajax_field_mult["mm_modulo_"][iNumLinha] = "mm_modulo_" + iNumLinha;
    ajax_field_mult["mm_menu_"][iNumLinha] = "mm_menu_" + iNumLinha;
    ajax_field_mult["mm_descripcion_"][iNumLinha] = "mm_descripcion_" + iNumLinha;
    ajax_field_mult["per_permiso_"][iNumLinha] = "per_permiso_" + iNumLinha;
    ajax_field_id["mm_modulo_" + iNumLinha] = new Array("hidden_field_label_mm_modulo_", "hidden_field_data_mm_modulo_" + iNumLinha);
    ajax_field_id["mm_menu_" + iNumLinha] = new Array("hidden_field_label_mm_menu_", "hidden_field_data_mm_menu_" + iNumLinha);
    ajax_field_id["mm_descripcion_" + iNumLinha] = new Array("hidden_field_label_mm_descripcion_", "hidden_field_data_mm_descripcion_" + iNumLinha);
    ajax_field_id["per_permiso_" + iNumLinha] = new Array("hidden_field_label_per_permiso_", "hidden_field_data_per_permiso_" + iNumLinha);
    ajax_error_count["per_rol_" + iNumLinha] = "off";
    ajax_error_count["mm_id_" + iNumLinha] = "off";
    ajax_error_count["mm_modulo_" + iNumLinha] = "off";
    ajax_error_count["mm_menu_" + iNumLinha] = "off";
    ajax_error_count["mm_descripcion_" + iNumLinha] = "off";
    ajax_error_count["per_permiso_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["per_rol_" + iNumLinha] = "on";
    ajax_read_only["mm_id_" + iNumLinha] = "on";
    ajax_read_only["mm_modulo_" + iNumLinha] = "off";
    ajax_read_only["mm_menu_" + iNumLinha] = "off";
    ajax_read_only["mm_descripcion_" + iNumLinha] = "off";
    ajax_read_only["per_permiso_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["per_rol_" + iNumLinha] = "on";
    ajax_read_only["mm_id_" + iNumLinha] = "on";
    ajax_read_only["mm_modulo_" + iNumLinha] = "on";
    ajax_read_only["mm_menu_" + iNumLinha] = "on";
    ajax_read_only["mm_descripcion_" + iNumLinha] = "on";
    ajax_read_only["per_permiso_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["per_rol_" + iNumLinha] = null;
    ajax_error_list["mm_id_" + iNumLinha] = null;
    ajax_error_list["mm_modulo_" + iNumLinha] = null;
    ajax_error_list["mm_menu_" + iNumLinha] = null;
    ajax_error_list["mm_descripcion_" + iNumLinha] = null;
    ajax_error_list["per_permiso_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "per_rol_": new Array(),
    "mm_id_": new Array(),
    "mm_modulo_": new Array(),
    "mm_menu_": new Array(),
    "mm_descripcion_": new Array(),
    "per_permiso_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["per_rol_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["per_rol_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["per_rol_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["per_rol_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["per_rol_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["mm_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["mm_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["mm_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["mm_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["mm_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["mm_modulo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["mm_modulo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["mm_modulo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["mm_modulo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["mm_modulo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["mm_menu_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["mm_menu_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["mm_menu_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["mm_menu_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["mm_menu_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["mm_descripcion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["mm_descripcion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["mm_descripcion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["mm_descripcion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["mm_descripcion_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["per_permiso_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["per_permiso_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["per_permiso_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["per_permiso_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["per_permiso_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['per_rol_'])) ? $this->nmgp_cmp_readonly['per_rol_'] : 'on';
?>
    scAjaxFieldRead("per_rol_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['mm_id_'])) ? $this->nmgp_cmp_readonly['mm_id_'] : 'on';
?>
    scAjaxFieldRead("mm_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['mm_modulo_'])) ? $this->nmgp_cmp_readonly['mm_modulo_'] : 'off';
?>
    scAjaxFieldRead("mm_modulo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['mm_menu_'])) ? $this->nmgp_cmp_readonly['mm_menu_'] : 'off';
?>
    scAjaxFieldRead("mm_menu_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['mm_descripcion_'])) ? $this->nmgp_cmp_readonly['mm_descripcion_'] : 'off';
?>
    scAjaxFieldRead("mm_descripcion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['per_permiso_'])) ? $this->nmgp_cmp_readonly['per_permiso_'] : 'off';
?>
    scAjaxFieldRead("per_permiso_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("per_rol_" + iSeq, "on");
    scAjaxFieldRead("mm_id_" + iSeq, "on");
    scAjaxFieldRead("mm_modulo_" + iSeq, "on");
    scAjaxFieldRead("mm_menu_" + iSeq, "on");
    scAjaxFieldRead("mm_descripcion_" + iSeq, "on");
    scAjaxFieldRead("per_permiso_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["per_rol_" + iRow] || "on" == ajax_error_count["mm_id_" + iRow] || "on" == ajax_error_count["mm_modulo_" + iRow] || "on" == ajax_error_count["mm_menu_" + iRow] || "on" == ajax_error_count["mm_descripcion_" + iRow] || "on" == ajax_error_count["per_permiso_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_per_rol_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_mm_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_mm_modulo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_mm_menu_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_mm_descripcion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_per_permiso_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["per_rol_" + iRow] && "off" == ajax_error_count["mm_id_" + iRow] && "off" == ajax_error_count["mm_modulo_" + iRow] && "off" == ajax_error_count["mm_menu_" + iRow] && "off" == ajax_error_count["mm_descripcion_" + iRow] && "off" == ajax_error_count["per_permiso_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["per_rol_" + iRow] = "off";
        ajax_error_count["mm_id_" + iRow] = "off";
        ajax_error_count["mm_modulo_" + iRow] = "off";
        ajax_error_count["mm_menu_" + iRow] = "off";
        ajax_error_count["mm_descripcion_" + iRow] = "off";
        ajax_error_count["per_permiso_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_per_rol_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_mm_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_mm_modulo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_mm_menu_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_mm_descripcion_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_per_permiso_" + iRow).removeClass("scFormErrorLine");
    }
  }
