  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_pais" == sTestField)
        {
...
?>
  ...
  // ---------- Validate pai_id_
  function do_ajax_form_sis_pais_validate_pai_id_(iNumLinha)
  {
    var nomeCampo_pai_id_ = "pai_id_" + iNumLinha;
    var var_pai_id_ = scAjaxGetFieldHidden(nomeCampo_pai_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_pais_validate_pai_id_(var_pai_id_, iNumLinha, var_script_case_init, do_ajax_form_sis_pais_validate_pai_id__cb);
  } // do_ajax_form_sis_pais_validate_pai_id_

  function do_ajax_form_sis_pais_validate_pai_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "pai_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pai_id_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "pai_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pai_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_pais_validate_pai_id__cb

  // ---------- Validate pai_nombre_
  function do_ajax_form_sis_pais_validate_pai_nombre_(iNumLinha)
  {
    var nomeCampo_pai_nombre_ = "pai_nombre_" + iNumLinha;
    var var_pai_nombre_ = scAjaxGetFieldText(nomeCampo_pai_nombre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_pais_validate_pai_nombre_(var_pai_nombre_, iNumLinha, var_script_case_init, do_ajax_form_sis_pais_validate_pai_nombre__cb);
  } // do_ajax_form_sis_pais_validate_pai_nombre_

  function do_ajax_form_sis_pais_validate_pai_nombre__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "pai_nombre_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pai_nombre_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "pai_nombre_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pai_nombre_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_pais_validate_pai_nombre__cb

  // ---------- Validate pai_codigo_sri_
  function do_ajax_form_sis_pais_validate_pai_codigo_sri_(iNumLinha)
  {
    var nomeCampo_pai_codigo_sri_ = "pai_codigo_sri_" + iNumLinha;
    var var_pai_codigo_sri_ = scAjaxGetFieldText(nomeCampo_pai_codigo_sri_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_pais_validate_pai_codigo_sri_(var_pai_codigo_sri_, iNumLinha, var_script_case_init, do_ajax_form_sis_pais_validate_pai_codigo_sri__cb);
  } // do_ajax_form_sis_pais_validate_pai_codigo_sri_

  function do_ajax_form_sis_pais_validate_pai_codigo_sri__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "pai_codigo_sri_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pai_codigo_sri_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "pai_codigo_sri_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pai_codigo_sri_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_pais_validate_pai_codigo_sri__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_sis_pais_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_sis_pais_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sis_pais_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_sis_pais_add_new_line_cb);
  } // do_ajax_form_sis_pais_add_new_line

  function do_ajax_form_sis_pais_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_sis_pais_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_sis_pais_backup_line(iNumLinha)
  {
    var var_pai_id_ = scAjaxGetFieldHidden("pai_id_" + iNumLinha);
    var var_pai_nombre_ = scAjaxGetFieldText("pai_nombre_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_pais_backup_line(var_pai_id_, var_pai_nombre_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_sis_pais_backup_line_cb);
  } // do_ajax_form_sis_pais_backup_line

  function do_ajax_form_sis_pais_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_sis_pais_backup_line_cb

  function do_ajax_form_sis_pais_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_sis_pais_cancel_insert

  function do_ajax_form_sis_pais_cancel_update(iSeqVert)
  {
    do_ajax_form_sis_pais_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_sis_pais_cancel_update

  function do_ajax_form_sis_pais_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_sis_pais_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_sis_pais_table_refresh()
  {
    var var_pai_id_ = document.F2.pai_id_.value;
    var var_pai_nombre_ = document.F2.pai_nombre_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_sis_pais_table_refresh(var_pai_id_, var_pai_nombre_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_pais_table_refresh_cb);
  } //  do_ajax_form_sis_pais_table_refresh

  function do_ajax_form_sis_pais_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.pai_id_.value = scAjaxGetKeyValue("pai_id_");
    document.F2.pai_nombre_.value = scAjaxGetKeyValue("pai_nombre_");
    ...
    scAjaxAlert(do_ajax_form_sis_pais_table_refresh_cb_after_alert);
  } // do_ajax_form_sis_pais_table_refresh_cb
  function do_ajax_form_sis_pais_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_sis_pais_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_sis_pais_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_sis_pais_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_pai_id_ = scAjaxGetFieldHidden("pai_id_" + iNumLinha);
    var var_pai_nombre_ = scAjaxGetFieldText("pai_nombre_" + iNumLinha);
    var var_pai_codigo_sri_ = scAjaxGetFieldText("pai_codigo_sri_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_sis_pais_submit_form(var_pai_id_, var_pai_nombre_, var_pai_codigo_sri_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_pais_submit_form_cb);
  } // do_ajax_form_sis_pais_submit_form

  function do_ajax_form_sis_pais_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("pai_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("pai_nombre_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("pai_codigo_sri_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sis_pais_submit_form_cb_after_alert);
  } // do_ajax_form_sis_pais_submit_form_cb
  function do_ajax_form_sis_pais_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_pais_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sis_pais_navigate_form()
  {
    perform_ajax_form_sis_pais_navigate_form();
  }

  function perform_ajax_form_sis_pais_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_sis_pais_cancel_insert(sc_form_sis_pais_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("pai_id_" + iNavForm);
      scAjaxHideErrorDisplay("pai_nombre_" + iNavForm);
      scAjaxHideErrorDisplay("pai_codigo_sri_" + iNavForm);
    }
    var var_pai_id_ = document.F2.pai_id_.value;
    var var_pai_nombre_ = document.F2.pai_nombre_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sis_pais_navigate_form(var_pai_id_, var_pai_nombre_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_pais_navigate_form_cb);
  } // do_ajax_form_sis_pais_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_pais']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_pais_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.pai_id_.value = scAjaxGetKeyValue("pai_id_" + var_last_index);
    document.F2.pai_nombre_.value = scAjaxGetKeyValue("pai_nombre_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_pais_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_pais_navigate_form_cb
  function do_ajax_form_sis_pais_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
    ...
    SC_btn_grp_text();
  } // do_ajax_form_sis_pais_navigate_form_cb_after_alert

    function sc_form_sis_pais_get_last_line_number()
    {
    ...
    } //sc_form_sis_pais_get_last_line_number

  function sc_hide_form_sis_pais_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "pai_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pai_nombre_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pai_codigo_sri_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["pai_id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pai_nombre_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_pais'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pai_codigo_sri_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_codigo_sri'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["pai_id_"][iNumLinha] = "pai_id_" + iNumLinha;
    ajax_field_mult["pai_nombre_"][iNumLinha] = "pai_nombre_" + iNumLinha;
    ajax_field_mult["pai_codigo_sri_"][iNumLinha] = "pai_codigo_sri_" + iNumLinha;
    ajax_field_id["pai_id_" + iNumLinha] = new Array("hidden_field_label_pai_id_", "hidden_field_data_pai_id_" + iNumLinha);
    ajax_field_id["pai_nombre_" + iNumLinha] = new Array("hidden_field_label_pai_nombre_", "hidden_field_data_pai_nombre_" + iNumLinha);
    ajax_field_id["pai_codigo_sri_" + iNumLinha] = new Array("hidden_field_label_pai_codigo_sri_", "hidden_field_data_pai_codigo_sri_" + iNumLinha);
    ajax_error_count["pai_id_" + iNumLinha] = "off";
    ajax_error_count["pai_nombre_" + iNumLinha] = "off";
    ajax_error_count["pai_codigo_sri_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["pai_id_" + iNumLinha] = "on";
    ajax_read_only["pai_nombre_" + iNumLinha] = "on";
    ajax_read_only["pai_codigo_sri_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["pai_id_" + iNumLinha] = "on";
    ajax_read_only["pai_nombre_" + iNumLinha] = "on";
    ajax_read_only["pai_codigo_sri_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["pai_id_" + iNumLinha] = null;
    ajax_error_list["pai_nombre_" + iNumLinha] = null;
    ajax_error_list["pai_codigo_sri_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "pai_id_": new Array(),
    "pai_nombre_": new Array(),
    "pai_codigo_sri_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["pai_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pai_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pai_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pai_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pai_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["pai_nombre_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pai_nombre_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pai_nombre_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pai_nombre_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pai_nombre_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["pai_codigo_sri_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pai_codigo_sri_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pai_codigo_sri_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pai_codigo_sri_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pai_codigo_sri_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pai_id_'])) ? $this->nmgp_cmp_readonly['pai_id_'] : 'on';
?>
    scAjaxFieldRead("pai_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pai_nombre_'])) ? $this->nmgp_cmp_readonly['pai_nombre_'] : 'on';
?>
    scAjaxFieldRead("pai_nombre_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pai_codigo_sri_'])) ? $this->nmgp_cmp_readonly['pai_codigo_sri_'] : 'off';
?>
    scAjaxFieldRead("pai_codigo_sri_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("pai_id_" + iSeq, "on");
    scAjaxFieldRead("pai_nombre_" + iSeq, "on");
    scAjaxFieldRead("pai_codigo_sri_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["pai_id_" + iRow] || "on" == ajax_error_count["pai_nombre_" + iRow] || "on" == ajax_error_count["pai_codigo_sri_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pai_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pai_nombre_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pai_codigo_sri_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["pai_id_" + iRow] && "off" == ajax_error_count["pai_nombre_" + iRow] && "off" == ajax_error_count["pai_codigo_sri_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["pai_id_" + iRow] = "off";
        ajax_error_count["pai_nombre_" + iRow] = "off";
        ajax_error_count["pai_codigo_sri_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_pai_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_pai_nombre_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_pai_codigo_sri_" + iRow).removeClass("scFormErrorLine");
    }
  }
