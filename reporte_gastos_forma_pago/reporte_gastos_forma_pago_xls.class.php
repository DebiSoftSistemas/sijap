...
class reporte_gastos_forma_pago_xls
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "reporte_gastos_forma_pago/reporte_gastos_forma_pago_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              ...
              $this->Res_xls = new reporte_gastos_forma_pago_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_reporte_gastos_forma_pago.zip";
          $this->Arquivo   .= "_reporte_gastos_forma_pago" . $this->Xls_tp;
          $this->Tit_doc    = "reporte_gastos_forma_pago" . $this->Xls_tp;
          $this->Tit_zip    = "reporte_gastos_forma_pago.zip";
      ...
      {
          $this->sum_fp_valor = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['tot_geral'][2];
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['SC_Ind_Groupby'] == "fc_serie")
      {
          $this->sum_fp_valor = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['tot_geral'][2];
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['where_pesq'];
      ...
      { 
          ...
          { 
              ...
              $nmgp_select_count .= " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['where_resumo']; 
          } 
          else
          { 
              $nmgp_select .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['where_resumo'] . ")"; 
              $nmgp_select_count .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['where_resumo'] . ")"; 
          } 
      } 
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['order_grid'];
      ...
      if (!$rs->EOF)
      {
         ...
         $this->fp_descripcion = $rs->fields[6] ;  
         $this->fp_valor = $rs->fields[7] ;  
         $this->fp_valor = (string)$this->fp_valor;
         $this->fc_comentario = $rs->fields[8] ;  
         $this->pr_direccion = $rs->fields[9] ;  
         $this->pr_email = $rs->fields[10] ;  
         $this->pr_telefono = $rs->fields[11] ;  
         $this->fc_usuario = $rs->fields[12] ;  
...
$_SESSION['scriptcase']['reporte_gastos_forma_pago']['contr_erro'] = 'off';
      ...
      while (!$rs->EOF)
      {
         ...
         $this->arg_sum_fc_usuario = " = " . $this->Db->qstr($this->fc_usuario);
          ...
          {  
              if (isset($this->fc_serie_Old) && !$prim_gb)
              {
              ...
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['embutida'] && !$prim_gb && $this->groupby_show == "S") {
                  $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                  $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
                  $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
                  $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   { 
      ...
      { 
          ...
          if ($Cada_col == "fc_comentario" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
   ...
   //----- fc_comentario
   function NM_export_fc_comentario()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
             $this->NM_ctrl_style[$current_cell_ref]['ini'] = $this->Xls_row;
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->fc_comentario = html_entity_decode($this->fc_comentario, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->fc_comentario = strip_tags($this->fc_comentario);
         $this->fc_comentario = NM_charset_to_utf8($this->fc_comentario);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fc_comentario, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fc_comentario, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- pr_direccion
   ...
   //----- fc_comentario
   function NM_sub_cons_fc_comentario()
   {
         $this->fc_comentario = html_entity_decode($this->fc_comentario, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->fc_comentario = strip_tags($this->fc_comentario);
         $this->fc_comentario = NM_charset_to_utf8($this->fc_comentario);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->fc_comentario;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['nolabel'])
       {
 ...
 function quebra_fc_serie_fc_serie($fc_serie) 
 {
     ...
     foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
     {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['field_order'] as $Cada_cmp)
       {
           if (isset($NM_cmp_tot['fp_valor'][$Tipo_Sum]) && $Cada_cmp == "fp_valor" && (!isset($this->NM_cmp_hidden['fp_valor']) || $this->NM_cmp_hidden['fp_valor'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['fp_valor'][$Tipo_Sum] . "fc_fecha_fp_valor";
           ...
           elseif (!isset($this->NM_cmp_hidden[$Cada_cmp]) || $this->NM_cmp_hidden[$Cada_cmp] != "off")
           {
               ...
               elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['embutida']) {
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
     ...
     foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
     {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['field_order'] as $Cada_cmp)
       {
           if (isset($NM_cmp_tot['fp_valor'][$Tipo_Sum]) && $Cada_cmp == "fp_valor" && (!isset($this->NM_cmp_hidden['fp_valor']) || $this->NM_cmp_hidden['fp_valor'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['fp_valor'][$Tipo_Sum] . "fc_serie_fp_valor";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['embutida']) {
     ...
     foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
     {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['field_order'] as $Cada_cmp)
       {
           if (isset($NM_cmp_tot['fp_valor'][$Tipo_Sum]) && $Cada_cmp == "fp_valor" && (!isset($this->NM_cmp_hidden['fp_valor']) || $this->NM_cmp_hidden['fp_valor'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['fp_valor'][$Tipo_Sum] . "pr_nombre_fp_valor";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['embutida']) {
     ...
     foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
     {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['field_order'] as $Cada_cmp)
       {
           if (isset($NM_cmp_tot['fp_valor'][$Tipo_Sum]) && $Cada_cmp == "fp_valor" && (!isset($this->NM_cmp_hidden['fp_valor']) || $this->NM_cmp_hidden['fp_valor'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['fp_valor'][$Tipo_Sum] . "pr_identificacion_fp_valor";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['embutida']) {
     ...
     foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
     {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['field_order'] as $Cada_cmp)
       {
           if (isset($NM_cmp_tot['fp_valor'][$Tipo_Sum]) && $Cada_cmp == "fp_valor" && (!isset($this->NM_cmp_hidden['fp_valor']) || $this->NM_cmp_hidden['fp_valor'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['fp_valor'][$Tipo_Sum] . "fc_usuario_fp_valor";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['embutida']) {
   ...
   function quebra_geral_sc_free_group_by_bot()
   {
       ...
       $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . '');
       $mens_tot_base = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['tot_geral'][1] . ")";
       $prim_lin_tot  = true;
     foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
     {
       $mens_tot      = $mens_tot_base . " - " . $Tit_sum;
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['field_order'] as $Cada_cmp)
       {
           if (isset($NM_cmp_tot['fp_valor'][$Tipo_Sum]) && $Cada_cmp == "fp_valor" && (!isset($this->NM_cmp_hidden['fp_valor']) || $this->NM_cmp_hidden['fp_valor'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['tot_geral'][$NM_cmp_tot['fp_valor'][$Tipo_Sum]];
               $prim_cmp = false;
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago'][$path_doc_md5][1] = $this->Tit_doc;
...
<HEAD>
 <TITLE>Resumen de Compras con Forma de Pago :: Excel</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_gastos_forma_pago']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
