<?php
@session_start() ;
$_SESSION['scriptcase']['reporte_gastos_forma_pago']['sc_process_barr'] = true;
require_once('../reporte_gastos_forma_pago/index.php');
unset($_SESSION['scriptcase']['reporte_gastos_forma_pago']['sc_process_barr']);
$ExportCtrl = new reporte_gastos_forma_pago_export_control;
$ExportCtrl->Export_barr();

class reporte_gastos_forma_pago_export_control
{
