...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_del_pedios_espera_pago"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_del_pedios_espera_pago"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_del_pedido_espera_pago'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_del_pedios_espera_pago']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_del_pedios_espera_pago']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_del_pedios_espera_pago']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_del_pedios_espera_pago']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_del_pedios_espera_pago']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_del_pedios_espera_pago</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_del_pedios_espera_pago']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_del_pedios_espera_pago']['embutida_filho'] as $ind => $sc_init)
          {
