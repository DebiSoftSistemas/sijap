<?php
class form_del_direccion_entrega_wp_form extends form_del_direccion_entrega_wp_apl
{
function Form_Init()
{
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_direccion_entrega_wp']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_direccion_entrega_wp']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_direccion_entrega_wp']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_direccion_entrega_wp']['sc_redir_atualiz'] == 'ok')
{
?>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_direccion_entrega_wp']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_del_direccion_entrega_wp/form_del_direccion_entrega_wp_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_del_direccion_entrega_wp_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_direccion_entrega_wp']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_direccion_entrega_wp']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_direccion_entrega_wp']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_direccion_entrega_wp']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_direccion_entrega_wp']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_direccion_entrega_wp']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_direccion_entrega_wp']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_direccion_entrega_wp']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_del_direccion_entrega_wp_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_direccion_entrega_wp']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_direccion_entrega_wp']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_direccion_entrega_wp']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_direccion_entrega_wp']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_direccion_entrega_wp']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_direccion_entrega_wp']['recarga'];
}
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    $opcao_botoes = 'inicio';
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_direccion_entrega_wp']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_direccion_entrega_wp']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_direccion_entrega_wp']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_direccion_entrega_wp']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_direccion_entrega_wp']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_direccion_entrega_wp']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_direccion_entrega_wp']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_direccion_entrega_wp']['link_info']['remove_border']) {
...
<?php
 include_once("form_del_direccion_entrega_wp_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_del_direccion_entrega_wp'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_del_direccion_entrega_wp'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_del_direccion_entrega_wp);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_del_direccion_entrega_wp = $this->form_vert_form_del_direccion_entrega_wp;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_del_direccion_entrega_wp))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_form_del_direccion_entrega_wp as $sc_seq_vert => $sc_lixo)
   {
       ...
       elseif ($Line_Add)
       {
        ...
        $this->dep_id_ = $this->form_vert_form_del_direccion_entrega_wp[$sc_seq_vert]['dep_id_']; 
       ...
       $this->dep_id_pedido_ = $this->form_vert_form_del_direccion_entrega_wp[$sc_seq_vert]['dep_id_pedido_']; 
       ...
       $this->dep_identificacion_quien_recibe_ = $this->form_vert_form_del_direccion_entrega_wp[$sc_seq_vert]['dep_identificacion_quien_recibe_']; 
       ...
       $this->dep_nombre_quien_recibie_ = $this->form_vert_form_del_direccion_entrega_wp[$sc_seq_vert]['dep_nombre_quien_recibie_']; 
       ...
       $this->dep_ciudad_ = $this->form_vert_form_del_direccion_entrega_wp[$sc_seq_vert]['dep_ciudad_']; 
       ...
       $this->dep_direccion_ = $this->form_vert_form_del_direccion_entrega_wp[$sc_seq_vert]['dep_direccion_']; 
       ...
       $this->dep_telefono_ = $this->form_vert_form_del_direccion_entrega_wp[$sc_seq_vert]['dep_telefono_']; 
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_del_direccion_entrega_wp_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_del_direccion_entrega_wp_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_del_direccion_entrega_wp_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_del_direccion_entrega_wp_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_del_direccion_entrega_wp_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_del_direccion_entrega_wp_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
<?php   
   ...
   { 
       ...
       $this->form_vert_form_del_direccion_entrega_wp = $guarda_form_vert_form_del_direccion_entrega_wp;
   } 
   if ($Table_refresh) 
   { 
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_direccion_entrega_wp']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_direccion_entrega_wp']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_direccion_entrega_wp']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_direccion_entrega_wp']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_direccion_entrega_wp']['btn_label']['exit'];
        }
?>
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_direccion_entrega_wp']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_direccion_entrega_wp']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_direccion_entrega_wp']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_direccion_entrega_wp']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_del_direccion_entrega_wp");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_del_direccion_entrega_wp");
 parent.scAjaxDetailHeight("form_del_direccion_entrega_wp", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_direccion_entrega_wp']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
