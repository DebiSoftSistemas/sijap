<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="cd_id" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['cd_id']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_conexion_debi']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_conexion_debi']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_del_conexion_debi"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
var Crtl_btn_sincronizar = false;
function sc_btn_sincronizar()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_sincronizar(); }, 500);
      return;
    }
    if (Crtl_btn_sincronizar) {return;}
    sc_btn_sincronizar_ok();
}
function sc_btn_sincronizar_cancel()
{
}
function sc_btn_sincronizar_ok()
{
    Crtl_btn_sincronizar = true;
    document.F1.nmgp_parms.value = "nmgp_opcao?#?formphp?@?nm_call_php?#?sincronizar?@?";
    document.F1.action = "./";
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_conexion_debi']['where_detal']))
  {
?>  
