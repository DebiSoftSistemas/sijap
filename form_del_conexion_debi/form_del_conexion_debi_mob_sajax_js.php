  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_conexion_debi_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_conexion_debi_mob_form();
	}
...
?>
  ...
  // ---------- Validate cd_id
  function do_ajax_form_del_conexion_debi_mob_validate_cd_id()
  {
    var nomeCampo_cd_id = "cd_id";
    var var_cd_id = scAjaxGetFieldHidden(nomeCampo_cd_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_conexion_debi_mob_validate_cd_id(var_cd_id, var_script_case_init, do_ajax_form_del_conexion_debi_mob_validate_cd_id_cb);
  } // do_ajax_form_del_conexion_debi_mob_validate_cd_id

  function do_ajax_form_del_conexion_debi_mob_validate_cd_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_conexion_debi_mob_validate_cd_id_cb

  // ---------- Validate cd_empresa
  function do_ajax_form_del_conexion_debi_mob_validate_cd_empresa()
  {
    var nomeCampo_cd_empresa = "cd_empresa";
    var var_cd_empresa = scAjaxGetFieldText(nomeCampo_cd_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_conexion_debi_mob_validate_cd_empresa(var_cd_empresa, var_script_case_init, do_ajax_form_del_conexion_debi_mob_validate_cd_empresa_cb);
  } // do_ajax_form_del_conexion_debi_mob_validate_cd_empresa

  function do_ajax_form_del_conexion_debi_mob_validate_cd_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cd_empresa";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_conexion_debi_mob_validate_cd_empresa_cb

  // ---------- Validate cd_host
  function do_ajax_form_del_conexion_debi_mob_validate_cd_host()
  {
    var nomeCampo_cd_host = "cd_host";
    var var_cd_host = scAjaxGetFieldText(nomeCampo_cd_host);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_conexion_debi_mob_validate_cd_host(var_cd_host, var_script_case_init, do_ajax_form_del_conexion_debi_mob_validate_cd_host_cb);
  } // do_ajax_form_del_conexion_debi_mob_validate_cd_host

  function do_ajax_form_del_conexion_debi_mob_validate_cd_host_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cd_host";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_conexion_debi_mob_validate_cd_host_cb

  // ---------- Validate cd_puerto
  function do_ajax_form_del_conexion_debi_mob_validate_cd_puerto()
  {
    var nomeCampo_cd_puerto = "cd_puerto";
    var var_cd_puerto = scAjaxGetFieldText(nomeCampo_cd_puerto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_conexion_debi_mob_validate_cd_puerto(var_cd_puerto, var_script_case_init, do_ajax_form_del_conexion_debi_mob_validate_cd_puerto_cb);
  } // do_ajax_form_del_conexion_debi_mob_validate_cd_puerto

  function do_ajax_form_del_conexion_debi_mob_validate_cd_puerto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cd_puerto";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_conexion_debi_mob_validate_cd_puerto_cb

  // ---------- Validate cd_usuario
  function do_ajax_form_del_conexion_debi_mob_validate_cd_usuario()
  {
    var nomeCampo_cd_usuario = "cd_usuario";
    var var_cd_usuario = scAjaxGetFieldText(nomeCampo_cd_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_conexion_debi_mob_validate_cd_usuario(var_cd_usuario, var_script_case_init, do_ajax_form_del_conexion_debi_mob_validate_cd_usuario_cb);
  } // do_ajax_form_del_conexion_debi_mob_validate_cd_usuario

  function do_ajax_form_del_conexion_debi_mob_validate_cd_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cd_usuario";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_conexion_debi_mob_validate_cd_usuario_cb

  // ---------- Validate cd_password
  function do_ajax_form_del_conexion_debi_mob_validate_cd_password()
  {
    var nomeCampo_cd_password = "cd_password";
    var var_cd_password = scAjaxGetFieldText(nomeCampo_cd_password);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_conexion_debi_mob_validate_cd_password(var_cd_password, var_script_case_init, do_ajax_form_del_conexion_debi_mob_validate_cd_password_cb);
  } // do_ajax_form_del_conexion_debi_mob_validate_cd_password

  function do_ajax_form_del_conexion_debi_mob_validate_cd_password_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cd_password";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_conexion_debi_mob_validate_cd_password_cb

  // ---------- Validate cd_base
  function do_ajax_form_del_conexion_debi_mob_validate_cd_base()
  {
    var nomeCampo_cd_base = "cd_base";
    var var_cd_base = scAjaxGetFieldText(nomeCampo_cd_base);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_conexion_debi_mob_validate_cd_base(var_cd_base, var_script_case_init, do_ajax_form_del_conexion_debi_mob_validate_cd_base_cb);
  } // do_ajax_form_del_conexion_debi_mob_validate_cd_base

  function do_ajax_form_del_conexion_debi_mob_validate_cd_base_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cd_base";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_conexion_debi_mob_validate_cd_base_cb

  // ---------- Validate cd_persistencia
  function do_ajax_form_del_conexion_debi_mob_validate_cd_persistencia()
  {
    var nomeCampo_cd_persistencia = "cd_persistencia";
    var var_cd_persistencia = scAjaxGetFieldCheckbox(nomeCampo_cd_persistencia, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_conexion_debi_mob_validate_cd_persistencia(var_cd_persistencia, var_script_case_init, do_ajax_form_del_conexion_debi_mob_validate_cd_persistencia_cb);
  } // do_ajax_form_del_conexion_debi_mob_validate_cd_persistencia

  function do_ajax_form_del_conexion_debi_mob_validate_cd_persistencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cd_persistencia";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_conexion_debi_mob_validate_cd_persistencia_cb

  // ---------- Validate cd_codificacion
  function do_ajax_form_del_conexion_debi_mob_validate_cd_codificacion()
  {
    var nomeCampo_cd_codificacion = "cd_codificacion";
    var var_cd_codificacion = scAjaxGetFieldSelect(nomeCampo_cd_codificacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_conexion_debi_mob_validate_cd_codificacion(var_cd_codificacion, var_script_case_init, do_ajax_form_del_conexion_debi_mob_validate_cd_codificacion_cb);
  } // do_ajax_form_del_conexion_debi_mob_validate_cd_codificacion

  function do_ajax_form_del_conexion_debi_mob_validate_cd_codificacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cd_codificacion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_conexion_debi_mob_validate_cd_codificacion_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_conexion_debi_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_conexion_debi_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_cd_id = scAjaxGetFieldHidden("cd_id");
    var var_cd_empresa = scAjaxGetFieldText("cd_empresa");
    var var_cd_host = scAjaxGetFieldText("cd_host");
    var var_cd_puerto = scAjaxGetFieldText("cd_puerto");
    var var_cd_usuario = scAjaxGetFieldText("cd_usuario");
    var var_cd_password = scAjaxGetFieldText("cd_password");
    var var_cd_base = scAjaxGetFieldText("cd_base");
    var var_cd_persistencia = scAjaxGetFieldCheckbox("cd_persistencia", ";");
    var var_cd_codificacion = scAjaxGetFieldSelect("cd_codificacion");
    ...
    scAjaxProcOn();
    x_ajax_form_del_conexion_debi_mob_submit_form(var_cd_id, var_cd_empresa, var_cd_host, var_cd_puerto, var_cd_usuario, var_cd_password, var_cd_base, var_cd_persistencia, var_cd_codificacion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_conexion_debi_mob_submit_form_cb);
  } // do_ajax_form_del_conexion_debi_mob_submit_form

  function do_ajax_form_del_conexion_debi_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("cd_id");
      scAjaxHideErrorDisplay("cd_empresa");
      scAjaxHideErrorDisplay("cd_host");
      scAjaxHideErrorDisplay("cd_puerto");
      scAjaxHideErrorDisplay("cd_usuario");
      scAjaxHideErrorDisplay("cd_password");
      scAjaxHideErrorDisplay("cd_base");
      scAjaxHideErrorDisplay("cd_persistencia");
      scAjaxHideErrorDisplay("cd_codificacion");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_conexion_debi_mob_submit_form_cb_after_alert);
  } // do_ajax_form_del_conexion_debi_mob_submit_form_cb
  function do_ajax_form_del_conexion_debi_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_conexion_debi_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_conexion_debi_mob_navigate_form()
  {
    perform_ajax_form_del_conexion_debi_mob_navigate_form();
  }

  function perform_ajax_form_del_conexion_debi_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("cd_persistencia");
    scAjaxHideErrorDisplay("cd_codificacion");
    var var_cd_id = document.F2.cd_id.value;
    ...
    scAjaxProcOn();
    x_ajax_form_del_conexion_debi_mob_navigate_form(var_cd_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_conexion_debi_mob_navigate_form_cb);
  } // do_ajax_form_del_conexion_debi_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_conexion_debi_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_conexion_debi_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.cd_id.value = scAjaxGetKeyValue("cd_id");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_conexion_debi_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_del_conexion_debi_mob_navigate_form_cb
  function do_ajax_form_del_conexion_debi_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_del_conexion_debi_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_conexion_debi_mob_navigate_form_cb_after_alert

  function sc_hide_form_del_conexion_debi_mob_form()
  {
  ...
  ajax_field_list[0] = "cd_id";
  ajax_field_list[1] = "cd_empresa";
  ajax_field_list[2] = "cd_host";
  ajax_field_list[3] = "cd_puerto";
  ajax_field_list[4] = "cd_usuario";
  ajax_field_list[5] = "cd_password";
  ajax_field_list[6] = "cd_base";
  ajax_field_list[7] = "cd_persistencia";
  ajax_field_list[8] = "cd_codificacion";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "cd_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cd_empresa": {"label": "<?php echo $this->Ini->Nm_lang['lang_empresa'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cd_host": {"label": "<?php echo $this->Ini->Nm_lang['lang_servidor'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cd_puerto": {"label": "<?php echo $this->Ini->Nm_lang['lang_puerto'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cd_usuario": {"label": "<?php echo $this->Ini->Nm_lang['lang_usuario'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cd_password": {"label": "<?php echo $this->Ini->Nm_lang['lang_contrasenia'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cd_base": {"label": "<?php echo $this->Ini->Nm_lang['lang_base_datos'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cd_persistencia": {"label": "<?php echo $this->Ini->Nm_lang['lang_persistencia'] ?>?", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cd_codificacion": {"label": "<?php echo $this->Ini->Nm_lang['lang_codificacion'] ?>?", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "cd_id": new Array(),
    "cd_empresa": new Array(),
    "cd_host": new Array(),
    "cd_puerto": new Array(),
    "cd_usuario": new Array(),
    "cd_password": new Array(),
    "cd_base": new Array(),
    "cd_persistencia": new Array(),
    "cd_codificacion": new Array()
  };
  ajax_field_mult["cd_id"][1] = "cd_id";
  ajax_field_mult["cd_empresa"][1] = "cd_empresa";
  ajax_field_mult["cd_host"][1] = "cd_host";
  ajax_field_mult["cd_puerto"][1] = "cd_puerto";
  ajax_field_mult["cd_usuario"][1] = "cd_usuario";
  ajax_field_mult["cd_password"][1] = "cd_password";
  ajax_field_mult["cd_base"][1] = "cd_base";
  ajax_field_mult["cd_persistencia"][1] = "cd_persistencia";
  ajax_field_mult["cd_codificacion"][1] = "cd_codificacion";

  var ajax_field_id = {
    "cd_host": new Array("hidden_field_label_cd_host", "hidden_field_data_cd_host"),
    "cd_puerto": new Array("hidden_field_label_cd_puerto", "hidden_field_data_cd_puerto"),
    "cd_usuario": new Array("hidden_field_label_cd_usuario", "hidden_field_data_cd_usuario"),
    "cd_password": new Array("hidden_field_label_cd_password", "hidden_field_data_cd_password"),
    "cd_base": new Array("hidden_field_label_cd_base", "hidden_field_data_cd_base"),
    "cd_persistencia": new Array("hidden_field_label_cd_persistencia", "hidden_field_data_cd_persistencia"),
    "cd_codificacion": new Array("hidden_field_label_cd_codificacion", "hidden_field_data_cd_codificacion")
  };
