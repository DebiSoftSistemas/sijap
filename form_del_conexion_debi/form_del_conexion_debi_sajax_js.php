  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_conexion_debi" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_conexion_debi_form();
	}
...
?>
  ...
  // ---------- Validate cd_id
  function do_ajax_form_del_conexion_debi_validate_cd_id()
  {
    var nomeCampo_cd_id = "cd_id";
    var var_cd_id = scAjaxGetFieldHidden(nomeCampo_cd_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_conexion_debi_validate_cd_id(var_cd_id, var_script_case_init, do_ajax_form_del_conexion_debi_validate_cd_id_cb);
  } // do_ajax_form_del_conexion_debi_validate_cd_id

  function do_ajax_form_del_conexion_debi_validate_cd_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_conexion_debi_validate_cd_id_cb

  // ---------- Validate cd_empresa
  function do_ajax_form_del_conexion_debi_validate_cd_empresa()
  {
    var nomeCampo_cd_empresa = "cd_empresa";
    var var_cd_empresa = scAjaxGetFieldText(nomeCampo_cd_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_conexion_debi_validate_cd_empresa(var_cd_empresa, var_script_case_init, do_ajax_form_del_conexion_debi_validate_cd_empresa_cb);
  } // do_ajax_form_del_conexion_debi_validate_cd_empresa

  function do_ajax_form_del_conexion_debi_validate_cd_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_conexion_debi_validate_cd_empresa_cb

  // ---------- Validate cd_host
  function do_ajax_form_del_conexion_debi_validate_cd_host()
  {
    var nomeCampo_cd_host = "cd_host";
    var var_cd_host = scAjaxGetFieldText(nomeCampo_cd_host);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_conexion_debi_validate_cd_host(var_cd_host, var_script_case_init, do_ajax_form_del_conexion_debi_validate_cd_host_cb);
  } // do_ajax_form_del_conexion_debi_validate_cd_host

  function do_ajax_form_del_conexion_debi_validate_cd_host_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cd_host";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_conexion_debi_validate_cd_host_cb

  // ---------- Validate cd_puerto
  function do_ajax_form_del_conexion_debi_validate_cd_puerto()
  {
    var nomeCampo_cd_puerto = "cd_puerto";
    var var_cd_puerto = scAjaxGetFieldText(nomeCampo_cd_puerto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_conexion_debi_validate_cd_puerto(var_cd_puerto, var_script_case_init, do_ajax_form_del_conexion_debi_validate_cd_puerto_cb);
  } // do_ajax_form_del_conexion_debi_validate_cd_puerto

  function do_ajax_form_del_conexion_debi_validate_cd_puerto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_conexion_debi_validate_cd_puerto_cb

  // ---------- Validate cd_usuario
  function do_ajax_form_del_conexion_debi_validate_cd_usuario()
  {
    var nomeCampo_cd_usuario = "cd_usuario";
    var var_cd_usuario = scAjaxGetFieldText(nomeCampo_cd_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_conexion_debi_validate_cd_usuario(var_cd_usuario, var_script_case_init, do_ajax_form_del_conexion_debi_validate_cd_usuario_cb);
  } // do_ajax_form_del_conexion_debi_validate_cd_usuario

  function do_ajax_form_del_conexion_debi_validate_cd_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_conexion_debi_validate_cd_usuario_cb

  // ---------- Validate cd_password
  function do_ajax_form_del_conexion_debi_validate_cd_password()
  {
    var nomeCampo_cd_password = "cd_password";
    var var_cd_password = scAjaxGetFieldText(nomeCampo_cd_password);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_conexion_debi_validate_cd_password(var_cd_password, var_script_case_init, do_ajax_form_del_conexion_debi_validate_cd_password_cb);
  } // do_ajax_form_del_conexion_debi_validate_cd_password

  function do_ajax_form_del_conexion_debi_validate_cd_password_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_conexion_debi_validate_cd_password_cb

  // ---------- Validate cd_base
  function do_ajax_form_del_conexion_debi_validate_cd_base()
  {
    var nomeCampo_cd_base = "cd_base";
    var var_cd_base = scAjaxGetFieldText(nomeCampo_cd_base);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_conexion_debi_validate_cd_base(var_cd_base, var_script_case_init, do_ajax_form_del_conexion_debi_validate_cd_base_cb);
  } // do_ajax_form_del_conexion_debi_validate_cd_base

  function do_ajax_form_del_conexion_debi_validate_cd_base_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cd_base";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_conexion_debi_validate_cd_base_cb

  // ---------- Validate cd_persistencia
  function do_ajax_form_del_conexion_debi_validate_cd_persistencia()
  {
    var nomeCampo_cd_persistencia = "cd_persistencia";
    var var_cd_persistencia = scAjaxGetFieldCheckbox(nomeCampo_cd_persistencia, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_conexion_debi_validate_cd_persistencia(var_cd_persistencia, var_script_case_init, do_ajax_form_del_conexion_debi_validate_cd_persistencia_cb);
  } // do_ajax_form_del_conexion_debi_validate_cd_persistencia

  function do_ajax_form_del_conexion_debi_validate_cd_persistencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_conexion_debi_validate_cd_persistencia_cb

  // ---------- Validate cd_codificacion
  function do_ajax_form_del_conexion_debi_validate_cd_codificacion()
  {
    var nomeCampo_cd_codificacion = "cd_codificacion";
    var var_cd_codificacion = scAjaxGetFieldSelect(nomeCampo_cd_codificacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_conexion_debi_validate_cd_codificacion(var_cd_codificacion, var_script_case_init, do_ajax_form_del_conexion_debi_validate_cd_codificacion_cb);
  } // do_ajax_form_del_conexion_debi_validate_cd_codificacion

  function do_ajax_form_del_conexion_debi_validate_cd_codificacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_conexion_debi_validate_cd_codificacion_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_conexion_debi_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_conexion_debi_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_del_conexion_debi_submit_form(var_cd_id, var_cd_empresa, var_cd_host, var_cd_puerto, var_cd_usuario, var_cd_password, var_cd_base, var_cd_persistencia, var_cd_codificacion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_conexion_debi_submit_form_cb);
  } // do_ajax_form_del_conexion_debi_submit_form

  function do_ajax_form_del_conexion_debi_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_conexion_debi_submit_form_cb_after_alert);
  } // do_ajax_form_del_conexion_debi_submit_form_cb
  function do_ajax_form_del_conexion_debi_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_conexion_debi_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_conexion_debi_navigate_form()
  {
    perform_ajax_form_del_conexion_debi_navigate_form();
  }

  function perform_ajax_form_del_conexion_debi_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_del_conexion_debi_navigate_form(var_cd_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_conexion_debi_navigate_form_cb);
  } // do_ajax_form_del_conexion_debi_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_conexion_debi']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_conexion_debi_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_conexion_debi_navigate_form_cb_after_alert);
  } // do_ajax_form_del_conexion_debi_navigate_form_cb
  function do_ajax_form_del_conexion_debi_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_del_conexion_debi_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_conexion_debi_navigate_form_cb_after_alert

  function sc_hide_form_del_conexion_debi_form()
  {
