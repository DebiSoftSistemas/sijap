  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_contrasenias_malas" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sis_contrasenias_malas_form();
	}
...
?>
  ...
  // ---------- Validate com_contrasenia_
  function do_ajax_form_sis_contrasenias_malas_validate_com_contrasenia_(iNumLinha)
  {
    var nomeCampo_com_contrasenia_ = "com_contrasenia_" + iNumLinha;
    var var_com_contrasenia_ = scAjaxGetFieldText(nomeCampo_com_contrasenia_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_contrasenias_malas_validate_com_contrasenia_(var_com_contrasenia_, iNumLinha, var_script_case_init, do_ajax_form_sis_contrasenias_malas_validate_com_contrasenia__cb);
  } // do_ajax_form_sis_contrasenias_malas_validate_com_contrasenia_

  function do_ajax_form_sis_contrasenias_malas_validate_com_contrasenia__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "com_contrasenia_" + iLineNumber;
    }
    else
    {
      sFieldValid = "com_contrasenia_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "com_contrasenia_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "com_contrasenia_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_contrasenias_malas_validate_com_contrasenia__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_sis_contrasenias_malas_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_sis_contrasenias_malas_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sis_contrasenias_malas_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_sis_contrasenias_malas_add_new_line_cb);
  } // do_ajax_form_sis_contrasenias_malas_add_new_line

  function do_ajax_form_sis_contrasenias_malas_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_sis_contrasenias_malas_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_sis_contrasenias_malas_backup_line(iNumLinha)
  {
    var var_com_contrasenia_ = scAjaxGetFieldText("com_contrasenia_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_contrasenias_malas_backup_line(var_com_contrasenia_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_sis_contrasenias_malas_backup_line_cb);
  } // do_ajax_form_sis_contrasenias_malas_backup_line

  function do_ajax_form_sis_contrasenias_malas_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_sis_contrasenias_malas_backup_line_cb

  function do_ajax_form_sis_contrasenias_malas_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_sis_contrasenias_malas_cancel_insert

  function do_ajax_form_sis_contrasenias_malas_cancel_update(iSeqVert)
  {
    do_ajax_form_sis_contrasenias_malas_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_sis_contrasenias_malas_cancel_update

  function do_ajax_form_sis_contrasenias_malas_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_sis_contrasenias_malas_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_sis_contrasenias_malas_table_refresh()
  {
    var var_com_contrasenia_ = document.F2.com_contrasenia_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_sis_contrasenias_malas_table_refresh(var_com_contrasenia_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_contrasenias_malas_table_refresh_cb);
  } //  do_ajax_form_sis_contrasenias_malas_table_refresh

  function do_ajax_form_sis_contrasenias_malas_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.com_contrasenia_.value = scAjaxGetKeyValue("com_contrasenia_");
    ...
    scAjaxAlert(do_ajax_form_sis_contrasenias_malas_table_refresh_cb_after_alert);
  } // do_ajax_form_sis_contrasenias_malas_table_refresh_cb
  function do_ajax_form_sis_contrasenias_malas_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_sis_contrasenias_malas_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_sis_contrasenias_malas_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_sis_contrasenias_malas_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_sis_contrasenias_malas_submit_form(var_com_contrasenia_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_contrasenias_malas_submit_form_cb);
  } // do_ajax_form_sis_contrasenias_malas_submit_form

  function do_ajax_form_sis_contrasenias_malas_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("com_contrasenia_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sis_contrasenias_malas_submit_form_cb_after_alert);
  } // do_ajax_form_sis_contrasenias_malas_submit_form_cb
  function do_ajax_form_sis_contrasenias_malas_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_contrasenias_malas_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sis_contrasenias_malas_navigate_form()
  {
    perform_ajax_form_sis_contrasenias_malas_navigate_form();
  }

  function perform_ajax_form_sis_contrasenias_malas_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_sis_contrasenias_malas_cancel_insert(sc_form_sis_contrasenias_malas_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("com_contrasenia_" + iNavForm);
    }
    var var_com_contrasenia_ = document.F2.com_contrasenia_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sis_contrasenias_malas_navigate_form(var_com_contrasenia_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_contrasenias_malas_navigate_form_cb);
  } // do_ajax_form_sis_contrasenias_malas_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_contrasenias_malas']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_contrasenias_malas_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.com_contrasenia_.value = scAjaxGetKeyValue("com_contrasenia_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_contrasenias_malas_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_contrasenias_malas_navigate_form_cb
  function do_ajax_form_sis_contrasenias_malas_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_sis_contrasenias_malas_navigate_form_cb_after_alert

    function sc_form_sis_contrasenias_malas_get_last_line_number()
    {
    ...
    } //sc_form_sis_contrasenias_malas_get_last_line_number

  function sc_hide_form_sis_contrasenias_malas_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "com_contrasenia_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["com_contrasenia_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_contrasenia'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["com_contrasenia_"][iNumLinha] = "com_contrasenia_" + iNumLinha;
    ajax_field_id["com_contrasenia_" + iNumLinha] = new Array("hidden_field_label_com_contrasenia_", "hidden_field_data_com_contrasenia_" + iNumLinha);
    ajax_error_count["com_contrasenia_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["com_contrasenia_" + iNumLinha] = "on";
<?php
}
else
{
...
?>
  ...
  {
    ajax_error_list["com_contrasenia_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["com_contrasenia_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["com_contrasenia_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["com_contrasenia_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["com_contrasenia_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["com_contrasenia_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
    ...
    mdOpenObjects(iSeq);
    Obj_Focus = eval("document.getElementById('id_sc_field_com_contrasenia_" + iSeq + "')");
    if (Obj_Focus)
    {
        Obj_Focus.focus();
    }
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['com_contrasenia_'])) ? $this->nmgp_cmp_readonly['com_contrasenia_'] : 'on';
?>
    scAjaxFieldRead("com_contrasenia_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("com_contrasenia_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["com_contrasenia_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_com_contrasenia_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["com_contrasenia_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["com_contrasenia_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_com_contrasenia_" + iRow).removeClass("scFormErrorLine");
    }
  }
