  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_telefono_sucursal" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sis_telefono_sucursal_form();
	}
...
?>
  ...
  // ---------- Validate tes_id_
  function do_ajax_form_sis_telefono_sucursal_validate_tes_id_(iNumLinha)
  {
    var nomeCampo_tes_id_ = "tes_id_" + iNumLinha;
    var var_tes_id_ = scAjaxGetFieldText(nomeCampo_tes_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_telefono_sucursal_validate_tes_id_(var_tes_id_, iNumLinha, var_script_case_init, do_ajax_form_sis_telefono_sucursal_validate_tes_id__cb);
  } // do_ajax_form_sis_telefono_sucursal_validate_tes_id_

  function do_ajax_form_sis_telefono_sucursal_validate_tes_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "tes_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tes_id_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "tes_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tes_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_telefono_sucursal_validate_tes_id__cb

  // ---------- Validate tes_sucursal_
  function do_ajax_form_sis_telefono_sucursal_validate_tes_sucursal_(iNumLinha)
  {
    var nomeCampo_tes_sucursal_ = "tes_sucursal_" + iNumLinha;
    var var_tes_sucursal_ = scAjaxGetFieldText(nomeCampo_tes_sucursal_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_telefono_sucursal_validate_tes_sucursal_(var_tes_sucursal_, iNumLinha, var_script_case_init, do_ajax_form_sis_telefono_sucursal_validate_tes_sucursal__cb);
  } // do_ajax_form_sis_telefono_sucursal_validate_tes_sucursal_

  function do_ajax_form_sis_telefono_sucursal_validate_tes_sucursal__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tes_sucursal_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tes_sucursal_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tes_sucursal_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tes_sucursal_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_telefono_sucursal_validate_tes_sucursal__cb

  // ---------- Validate tes_numero_
  function do_ajax_form_sis_telefono_sucursal_validate_tes_numero_(iNumLinha)
  {
    var nomeCampo_tes_numero_ = "tes_numero_" + iNumLinha;
    var var_tes_numero_ = scAjaxGetFieldText(nomeCampo_tes_numero_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_telefono_sucursal_validate_tes_numero_(var_tes_numero_, iNumLinha, var_script_case_init, do_ajax_form_sis_telefono_sucursal_validate_tes_numero__cb);
  } // do_ajax_form_sis_telefono_sucursal_validate_tes_numero_

  function do_ajax_form_sis_telefono_sucursal_validate_tes_numero__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tes_numero_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tes_numero_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tes_numero_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tes_numero_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_telefono_sucursal_validate_tes_numero__cb

  // ---------- Validate tes_tipo_
  function do_ajax_form_sis_telefono_sucursal_validate_tes_tipo_(iNumLinha)
  {
    var nomeCampo_tes_tipo_ = "tes_tipo_" + iNumLinha;
    var var_tes_tipo_ = scAjaxGetFieldText(nomeCampo_tes_tipo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_telefono_sucursal_validate_tes_tipo_(var_tes_tipo_, iNumLinha, var_script_case_init, do_ajax_form_sis_telefono_sucursal_validate_tes_tipo__cb);
  } // do_ajax_form_sis_telefono_sucursal_validate_tes_tipo_

  function do_ajax_form_sis_telefono_sucursal_validate_tes_tipo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tes_tipo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tes_tipo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tes_tipo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tes_tipo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_telefono_sucursal_validate_tes_tipo__cb

  // ---------- Validate tes_extension_
  function do_ajax_form_sis_telefono_sucursal_validate_tes_extension_(iNumLinha)
  {
    var nomeCampo_tes_extension_ = "tes_extension_" + iNumLinha;
    var var_tes_extension_ = scAjaxGetFieldText(nomeCampo_tes_extension_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_telefono_sucursal_validate_tes_extension_(var_tes_extension_, iNumLinha, var_script_case_init, do_ajax_form_sis_telefono_sucursal_validate_tes_extension__cb);
  } // do_ajax_form_sis_telefono_sucursal_validate_tes_extension_

  function do_ajax_form_sis_telefono_sucursal_validate_tes_extension__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tes_extension_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tes_extension_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tes_extension_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tes_extension_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_telefono_sucursal_validate_tes_extension__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_sis_telefono_sucursal_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_sis_telefono_sucursal_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sis_telefono_sucursal_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_sis_telefono_sucursal_add_new_line_cb);
  } // do_ajax_form_sis_telefono_sucursal_add_new_line

  function do_ajax_form_sis_telefono_sucursal_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_sis_telefono_sucursal_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_sis_telefono_sucursal_backup_line(iNumLinha)
  {
    var var_tes_id_ = scAjaxGetFieldText("tes_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_telefono_sucursal_backup_line(var_tes_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_sis_telefono_sucursal_backup_line_cb);
  } // do_ajax_form_sis_telefono_sucursal_backup_line

  function do_ajax_form_sis_telefono_sucursal_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_sis_telefono_sucursal_backup_line_cb

  function do_ajax_form_sis_telefono_sucursal_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_sis_telefono_sucursal_cancel_insert

  function do_ajax_form_sis_telefono_sucursal_cancel_update(iSeqVert)
  {
    do_ajax_form_sis_telefono_sucursal_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_sis_telefono_sucursal_cancel_update

  function do_ajax_form_sis_telefono_sucursal_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_sis_telefono_sucursal_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_sis_telefono_sucursal_table_refresh()
  {
    var var_tes_id_ = document.F2.tes_id_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_sis_telefono_sucursal_table_refresh(var_tes_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_telefono_sucursal_table_refresh_cb);
  } //  do_ajax_form_sis_telefono_sucursal_table_refresh

  function do_ajax_form_sis_telefono_sucursal_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.tes_id_.value = scAjaxGetKeyValue("tes_id_");
    ...
    scAjaxAlert(do_ajax_form_sis_telefono_sucursal_table_refresh_cb_after_alert);
  } // do_ajax_form_sis_telefono_sucursal_table_refresh_cb
  function do_ajax_form_sis_telefono_sucursal_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_sis_telefono_sucursal_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_sis_telefono_sucursal_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_sis_telefono_sucursal_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_tes_id_ = scAjaxGetFieldText("tes_id_" + iNumLinha);
    var var_tes_sucursal_ = scAjaxGetFieldText("tes_sucursal_" + iNumLinha);
    var var_tes_numero_ = scAjaxGetFieldText("tes_numero_" + iNumLinha);
    var var_tes_tipo_ = scAjaxGetFieldText("tes_tipo_" + iNumLinha);
    var var_tes_extension_ = scAjaxGetFieldText("tes_extension_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_sis_telefono_sucursal_submit_form(var_tes_id_, var_tes_sucursal_, var_tes_numero_, var_tes_tipo_, var_tes_extension_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_telefono_sucursal_submit_form_cb);
  } // do_ajax_form_sis_telefono_sucursal_submit_form

  function do_ajax_form_sis_telefono_sucursal_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("tes_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tes_sucursal_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tes_numero_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tes_tipo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tes_extension_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sis_telefono_sucursal_submit_form_cb_after_alert);
  } // do_ajax_form_sis_telefono_sucursal_submit_form_cb
  function do_ajax_form_sis_telefono_sucursal_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_telefono_sucursal_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sis_telefono_sucursal_navigate_form()
  {
    perform_ajax_form_sis_telefono_sucursal_navigate_form();
  }

  function perform_ajax_form_sis_telefono_sucursal_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_sis_telefono_sucursal_cancel_insert(sc_form_sis_telefono_sucursal_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("tes_id_" + iNavForm);
      scAjaxHideErrorDisplay("tes_sucursal_" + iNavForm);
      scAjaxHideErrorDisplay("tes_numero_" + iNavForm);
      scAjaxHideErrorDisplay("tes_tipo_" + iNavForm);
      scAjaxHideErrorDisplay("tes_extension_" + iNavForm);
    }
    var var_tes_id_ = document.F2.tes_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sis_telefono_sucursal_navigate_form(var_tes_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_telefono_sucursal_navigate_form_cb);
  } // do_ajax_form_sis_telefono_sucursal_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_telefono_sucursal']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_telefono_sucursal_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.tes_id_.value = scAjaxGetKeyValue("tes_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_telefono_sucursal_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_telefono_sucursal_navigate_form_cb
  function do_ajax_form_sis_telefono_sucursal_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_sis_telefono_sucursal_navigate_form_cb_after_alert

    function sc_form_sis_telefono_sucursal_get_last_line_number()
    {
    ...
    } //sc_form_sis_telefono_sucursal_get_last_line_number

  function sc_hide_form_sis_telefono_sucursal_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "tes_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tes_sucursal_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tes_numero_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tes_tipo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tes_extension_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["tes_id_" + iNumLinha] = {"label": "Tes Id<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tes_sucursal_" + iNumLinha] = {"label": "Tes Sucursal<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tes_numero_" + iNumLinha] = {"label": "Tes Numero<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tes_tipo_" + iNumLinha] = {"label": "Tes Tipo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tes_extension_" + iNumLinha] = {"label": "Tes Extension<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["tes_id_"][iNumLinha] = "tes_id_" + iNumLinha;
    ajax_field_mult["tes_sucursal_"][iNumLinha] = "tes_sucursal_" + iNumLinha;
    ajax_field_mult["tes_numero_"][iNumLinha] = "tes_numero_" + iNumLinha;
    ajax_field_mult["tes_tipo_"][iNumLinha] = "tes_tipo_" + iNumLinha;
    ajax_field_mult["tes_extension_"][iNumLinha] = "tes_extension_" + iNumLinha;
    ajax_field_id["tes_id_" + iNumLinha] = new Array("hidden_field_label_tes_id_", "hidden_field_data_tes_id_" + iNumLinha);
    ajax_field_id["tes_sucursal_" + iNumLinha] = new Array("hidden_field_label_tes_sucursal_", "hidden_field_data_tes_sucursal_" + iNumLinha);
    ajax_field_id["tes_numero_" + iNumLinha] = new Array("hidden_field_label_tes_numero_", "hidden_field_data_tes_numero_" + iNumLinha);
    ajax_field_id["tes_tipo_" + iNumLinha] = new Array("hidden_field_label_tes_tipo_", "hidden_field_data_tes_tipo_" + iNumLinha);
    ajax_field_id["tes_extension_" + iNumLinha] = new Array("hidden_field_label_tes_extension_", "hidden_field_data_tes_extension_" + iNumLinha);
    ajax_error_count["tes_id_" + iNumLinha] = "off";
    ajax_error_count["tes_sucursal_" + iNumLinha] = "off";
    ajax_error_count["tes_numero_" + iNumLinha] = "off";
    ajax_error_count["tes_tipo_" + iNumLinha] = "off";
    ajax_error_count["tes_extension_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["tes_id_" + iNumLinha] = "on";
    ajax_read_only["tes_sucursal_" + iNumLinha] = "off";
    ajax_read_only["tes_numero_" + iNumLinha] = "off";
    ajax_read_only["tes_tipo_" + iNumLinha] = "off";
    ajax_read_only["tes_extension_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["tes_id_" + iNumLinha] = "on";
    ajax_read_only["tes_sucursal_" + iNumLinha] = "on";
    ajax_read_only["tes_numero_" + iNumLinha] = "on";
    ajax_read_only["tes_tipo_" + iNumLinha] = "on";
    ajax_read_only["tes_extension_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["tes_id_" + iNumLinha] = null;
    ajax_error_list["tes_sucursal_" + iNumLinha] = null;
    ajax_error_list["tes_numero_" + iNumLinha] = null;
    ajax_error_list["tes_tipo_" + iNumLinha] = null;
    ajax_error_list["tes_extension_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "tes_id_": new Array(),
    "tes_sucursal_": new Array(),
    "tes_numero_": new Array(),
    "tes_tipo_": new Array(),
    "tes_extension_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["tes_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tes_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tes_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tes_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tes_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tes_sucursal_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tes_sucursal_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tes_sucursal_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tes_sucursal_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tes_sucursal_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tes_numero_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tes_numero_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tes_numero_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tes_numero_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tes_numero_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tes_tipo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tes_tipo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tes_tipo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tes_tipo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tes_tipo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tes_extension_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tes_extension_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tes_extension_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tes_extension_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tes_extension_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tes_id_'])) ? $this->nmgp_cmp_readonly['tes_id_'] : 'on';
?>
    scAjaxFieldRead("tes_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tes_sucursal_'])) ? $this->nmgp_cmp_readonly['tes_sucursal_'] : 'off';
?>
    scAjaxFieldRead("tes_sucursal_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tes_numero_'])) ? $this->nmgp_cmp_readonly['tes_numero_'] : 'off';
?>
    scAjaxFieldRead("tes_numero_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tes_tipo_'])) ? $this->nmgp_cmp_readonly['tes_tipo_'] : 'off';
?>
    scAjaxFieldRead("tes_tipo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tes_extension_'])) ? $this->nmgp_cmp_readonly['tes_extension_'] : 'off';
?>
    scAjaxFieldRead("tes_extension_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("tes_id_" + iSeq, "on");
    scAjaxFieldRead("tes_sucursal_" + iSeq, "on");
    scAjaxFieldRead("tes_numero_" + iSeq, "on");
    scAjaxFieldRead("tes_tipo_" + iSeq, "on");
    scAjaxFieldRead("tes_extension_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["tes_id_" + iRow] || "on" == ajax_error_count["tes_sucursal_" + iRow] || "on" == ajax_error_count["tes_numero_" + iRow] || "on" == ajax_error_count["tes_tipo_" + iRow] || "on" == ajax_error_count["tes_extension_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tes_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tes_sucursal_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tes_numero_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tes_tipo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tes_extension_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["tes_id_" + iRow] && "off" == ajax_error_count["tes_sucursal_" + iRow] && "off" == ajax_error_count["tes_numero_" + iRow] && "off" == ajax_error_count["tes_tipo_" + iRow] && "off" == ajax_error_count["tes_extension_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["tes_id_" + iRow] = "off";
        ajax_error_count["tes_sucursal_" + iRow] = "off";
        ajax_error_count["tes_numero_" + iRow] = "off";
        ajax_error_count["tes_tipo_" + iRow] = "off";
        ajax_error_count["tes_extension_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_tes_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tes_sucursal_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tes_numero_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tes_tipo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tes_extension_" + iRow).removeClass("scFormErrorLine");
    }
  }
