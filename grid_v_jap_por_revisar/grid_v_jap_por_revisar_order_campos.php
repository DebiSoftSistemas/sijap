<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_v_jap_por_revisar']['glo_nm_path_imag_temp'] . "/sc_apl_default_SIJAP.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_v_jap_por_revisar_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_v_jap_por_revisar_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['des_orden'] = "on";
   $tab_def_campos['des_orden'] = "des_orden";
   $tab_labels["des_orden"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['labels']["des_orden"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['labels']["des_orden"] : "" . $this->Nm_lang['lang_orden_ingreso'] . "";
   $tab_ger_campos['con_numero_contrato'] = "on";
   $tab_def_campos['con_numero_contrato'] = "con_numero_contrato";
   $tab_labels["con_numero_contrato"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['labels']["con_numero_contrato"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['labels']["con_numero_contrato"] : "Nro. " . $this->Nm_lang['lang_contrato'] . "";
   $tab_ger_campos['con_propietario'] = "on";
   $tab_def_campos['con_propietario'] = "con_propietario";
   $tab_labels["con_propietario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['labels']["con_propietario"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['labels']["con_propietario"] : "" . $this->Nm_lang['lang_propietario'] . "";
   $tab_ger_campos['esc_mes_periodo'] = "on";
   $tab_def_campos['esc_mes_periodo'] = "esc_mes_periodo";
   $tab_labels["esc_mes_periodo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['labels']["esc_mes_periodo"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['labels']["esc_mes_periodo"] : "" . $this->Nm_lang['lang_srch_mnth'] . "";
   $tab_ger_campos['esc_anio_periodo'] = "on";
   $tab_def_campos['esc_anio_periodo'] = "esc_anio_periodo";
   $tab_labels["esc_anio_periodo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['labels']["esc_anio_periodo"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['labels']["esc_anio_periodo"] : "" . $this->Nm_lang['lang_srch_year'] . "";
   $tab_ger_campos['con_numero_medidor'] = "on";
   $tab_def_campos['con_numero_medidor'] = "con_numero_medidor";
   $tab_labels["con_numero_medidor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['labels']["con_numero_medidor"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['labels']["con_numero_medidor"] : "" . $this->Nm_lang['lang_numero_medidor'] . "";
   $tab_ger_campos['des_lectura_anterior'] = "on";
   $tab_def_campos['des_lectura_anterior'] = "des_lectura_anterior";
   $tab_labels["des_lectura_anterior"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['labels']["des_lectura_anterior"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['labels']["des_lectura_anterior"] : "" . $this->Nm_lang['lang_lectura_anterior'] . "";
   $tab_ger_campos['des_lectura_actual'] = "on";
   $tab_def_campos['des_lectura_actual'] = "des_lectura_actual";
   $tab_labels["des_lectura_actual"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['labels']["des_lectura_actual"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['labels']["des_lectura_actual"] : "" . $this->Nm_lang['lang_lectura_actual'] . "";
   $tab_ger_campos['des_consumo'] = "on";
   $tab_def_campos['des_consumo'] = "des_consumo";
   $tab_labels["des_consumo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['labels']["des_consumo"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['labels']["des_consumo"] : "" . $this->Nm_lang['lang_consumo'] . "";
   $tab_ger_campos['des_consumo_base'] = "on";
   $tab_def_campos['des_consumo_base'] = "des_consumo_base";
   $tab_labels["des_consumo_base"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['labels']["des_consumo_base"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['labels']["des_consumo_base"] : "" . $this->Nm_lang['lang_consumo_base'] . "";
   $tab_ger_campos['des_consumo_excedente'] = "on";
   $tab_def_campos['des_consumo_excedente'] = "des_consumo_excedente";
   $tab_labels["des_consumo_excedente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['labels']["des_consumo_excedente"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['labels']["des_consumo_excedente"] : "" . $this->Nm_lang['lang_consumo_excedente'] . "";
   $tab_ger_campos['corregir'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['corregir'] = "corregir";
   }
   else
   {
       $tab_def_campos['corregir'] = "";
   }
   $tab_labels["corregir"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['labels']["corregir"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['labels']["corregir"] : "corregir";
   $tab_ger_campos['corregir'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_revisiones'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_v_jap_por_revisar_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_v_jap_por_revisar']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
