  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_detalle_nota_credito" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_detalle_nota_credito_form();
	}
...
?>
  ...
  // ---------- Validate dnc_id_
  function do_ajax_form_del_detalle_nota_credito_validate_dnc_id_(iNumLinha)
  {
    var nomeCampo_dnc_id_ = "dnc_id_" + iNumLinha;
    var var_dnc_id_ = scAjaxGetFieldHidden(nomeCampo_dnc_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_nota_credito_validate_dnc_id_(var_dnc_id_, iNumLinha, var_script_case_init, do_ajax_form_del_detalle_nota_credito_validate_dnc_id__cb);
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_id_

  function do_ajax_form_del_detalle_nota_credito_validate_dnc_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_id__cb

  // ---------- Validate dnc_factura_
  function do_ajax_form_del_detalle_nota_credito_validate_dnc_factura_(iNumLinha)
  {
    var nomeCampo_dnc_factura_ = "dnc_factura_" + iNumLinha;
    var var_dnc_factura_ = scAjaxGetFieldText(nomeCampo_dnc_factura_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_nota_credito_validate_dnc_factura_(var_dnc_factura_, iNumLinha, var_script_case_init, do_ajax_form_del_detalle_nota_credito_validate_dnc_factura__cb);
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_factura_

  function do_ajax_form_del_detalle_nota_credito_validate_dnc_factura__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_factura__cb

  // ---------- Validate dnc_empresa_
  function do_ajax_form_del_detalle_nota_credito_validate_dnc_empresa_(iNumLinha)
  {
    var nomeCampo_dnc_empresa_ = "dnc_empresa_" + iNumLinha;
    var var_dnc_empresa_ = scAjaxGetFieldText(nomeCampo_dnc_empresa_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_nota_credito_validate_dnc_empresa_(var_dnc_empresa_, iNumLinha, var_script_case_init, do_ajax_form_del_detalle_nota_credito_validate_dnc_empresa__cb);
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_empresa_

  function do_ajax_form_del_detalle_nota_credito_validate_dnc_empresa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_empresa__cb

  // ---------- Validate dnc_producto_
  function do_ajax_form_del_detalle_nota_credito_validate_dnc_producto_(iNumLinha)
  {
    var nomeCampo_dnc_producto_ = "dnc_producto_" + iNumLinha;
    var var_dnc_producto_ = scAjaxGetFieldSelect(nomeCampo_dnc_producto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_nota_credito_validate_dnc_producto_(var_dnc_producto_, iNumLinha, var_script_case_init, do_ajax_form_del_detalle_nota_credito_validate_dnc_producto__cb);
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_producto_

  function do_ajax_form_del_detalle_nota_credito_validate_dnc_producto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_producto__cb

  // ---------- Validate dnc_descripcion_
  function do_ajax_form_del_detalle_nota_credito_validate_dnc_descripcion_(iNumLinha)
  {
    var nomeCampo_dnc_descripcion_ = "dnc_descripcion_" + iNumLinha;
    var var_dnc_descripcion_ = scAjaxGetFieldText(nomeCampo_dnc_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_nota_credito_validate_dnc_descripcion_(var_dnc_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_del_detalle_nota_credito_validate_dnc_descripcion__cb);
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_descripcion_

  function do_ajax_form_del_detalle_nota_credito_validate_dnc_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_descripcion__cb

  // ---------- Validate dnc_cantidad_facturada_
  function do_ajax_form_del_detalle_nota_credito_validate_dnc_cantidad_facturada_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_nota_credito_validate_dnc_cantidad_facturada_(var_dnc_cantidad_facturada_, iNumLinha, var_script_case_init, do_ajax_form_del_detalle_nota_credito_validate_dnc_cantidad_facturada__cb);
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_cantidad_facturada_

  function do_ajax_form_del_detalle_nota_credito_validate_dnc_cantidad_facturada__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_cantidad_facturada__cb

  // ---------- Validate dnc_cantidad_
  function do_ajax_form_del_detalle_nota_credito_validate_dnc_cantidad_(iNumLinha)
  {
    var nomeCampo_dnc_cantidad_ = "dnc_cantidad_" + iNumLinha;
    var var_dnc_cantidad_ = scAjaxGetFieldText(nomeCampo_dnc_cantidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_nota_credito_validate_dnc_cantidad_(var_dnc_cantidad_, iNumLinha, var_script_case_init, do_ajax_form_del_detalle_nota_credito_validate_dnc_cantidad__cb);
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_cantidad_

  function do_ajax_form_del_detalle_nota_credito_validate_dnc_cantidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_cantidad__cb

  // ---------- Validate dnc_precio_unitario_
  function do_ajax_form_del_detalle_nota_credito_validate_dnc_precio_unitario_(iNumLinha)
  {
    var nomeCampo_dnc_precio_unitario_ = "dnc_precio_unitario_" + iNumLinha;
    var var_dnc_precio_unitario_ = scAjaxGetFieldText(nomeCampo_dnc_precio_unitario_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_nota_credito_validate_dnc_precio_unitario_(var_dnc_precio_unitario_, iNumLinha, var_script_case_init, do_ajax_form_del_detalle_nota_credito_validate_dnc_precio_unitario__cb);
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_precio_unitario_

  function do_ajax_form_del_detalle_nota_credito_validate_dnc_precio_unitario__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_precio_unitario__cb

  // ---------- Validate dnc_descuento_
  function do_ajax_form_del_detalle_nota_credito_validate_dnc_descuento_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_nota_credito_validate_dnc_descuento_(var_dnc_descuento_, iNumLinha, var_script_case_init, do_ajax_form_del_detalle_nota_credito_validate_dnc_descuento__cb);
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_descuento_

  function do_ajax_form_del_detalle_nota_credito_validate_dnc_descuento__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_descuento__cb

  // ---------- Validate dnc_subtotal_
  function do_ajax_form_del_detalle_nota_credito_validate_dnc_subtotal_(iNumLinha)
  {
    var nomeCampo_dnc_subtotal_ = "dnc_subtotal_" + iNumLinha;
    var var_dnc_subtotal_ = scAjaxGetFieldHidden(nomeCampo_dnc_subtotal_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_nota_credito_validate_dnc_subtotal_(var_dnc_subtotal_, iNumLinha, var_script_case_init, do_ajax_form_del_detalle_nota_credito_validate_dnc_subtotal__cb);
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_subtotal_

  function do_ajax_form_del_detalle_nota_credito_validate_dnc_subtotal__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_subtotal__cb

  // ---------- Validate dnc_base_iva_
  function do_ajax_form_del_detalle_nota_credito_validate_dnc_base_iva_(iNumLinha)
  {
    var nomeCampo_dnc_base_iva_ = "dnc_base_iva_" + iNumLinha;
    var var_dnc_base_iva_ = scAjaxGetFieldHidden(nomeCampo_dnc_base_iva_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_nota_credito_validate_dnc_base_iva_(var_dnc_base_iva_, iNumLinha, var_script_case_init, do_ajax_form_del_detalle_nota_credito_validate_dnc_base_iva__cb);
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_base_iva_

  function do_ajax_form_del_detalle_nota_credito_validate_dnc_base_iva__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_base_iva__cb

  // ---------- Validate dnc_porcentaje_iva_
  function do_ajax_form_del_detalle_nota_credito_validate_dnc_porcentaje_iva_(iNumLinha)
  {
    var nomeCampo_dnc_porcentaje_iva_ = "dnc_porcentaje_iva_" + iNumLinha;
    var var_dnc_porcentaje_iva_ = scAjaxGetFieldSelect(nomeCampo_dnc_porcentaje_iva_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_nota_credito_validate_dnc_porcentaje_iva_(var_dnc_porcentaje_iva_, iNumLinha, var_script_case_init, do_ajax_form_del_detalle_nota_credito_validate_dnc_porcentaje_iva__cb);
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_porcentaje_iva_

  function do_ajax_form_del_detalle_nota_credito_validate_dnc_porcentaje_iva__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_porcentaje_iva__cb

  // ---------- Validate dnc_valor_iva_
  function do_ajax_form_del_detalle_nota_credito_validate_dnc_valor_iva_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_nota_credito_validate_dnc_valor_iva_(var_dnc_valor_iva_, iNumLinha, var_script_case_init, do_ajax_form_del_detalle_nota_credito_validate_dnc_valor_iva__cb);
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_valor_iva_

  function do_ajax_form_del_detalle_nota_credito_validate_dnc_valor_iva__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_valor_iva__cb

  // ---------- Validate dnc_base_ice_
  function do_ajax_form_del_detalle_nota_credito_validate_dnc_base_ice_(iNumLinha)
  {
    var nomeCampo_dnc_base_ice_ = "dnc_base_ice_" + iNumLinha;
    var var_dnc_base_ice_ = scAjaxGetFieldText(nomeCampo_dnc_base_ice_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_nota_credito_validate_dnc_base_ice_(var_dnc_base_ice_, iNumLinha, var_script_case_init, do_ajax_form_del_detalle_nota_credito_validate_dnc_base_ice__cb);
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_base_ice_

  function do_ajax_form_del_detalle_nota_credito_validate_dnc_base_ice__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_base_ice__cb

  // ---------- Validate dnc_porcentaje_ice_
  function do_ajax_form_del_detalle_nota_credito_validate_dnc_porcentaje_ice_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_nota_credito_validate_dnc_porcentaje_ice_(var_dnc_porcentaje_ice_, iNumLinha, var_script_case_init, do_ajax_form_del_detalle_nota_credito_validate_dnc_porcentaje_ice__cb);
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_porcentaje_ice_

  function do_ajax_form_del_detalle_nota_credito_validate_dnc_porcentaje_ice__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_porcentaje_ice__cb

  // ---------- Validate dnc_valor_ice_
  function do_ajax_form_del_detalle_nota_credito_validate_dnc_valor_ice_(iNumLinha)
  {
    var nomeCampo_dnc_valor_ice_ = "dnc_valor_ice_" + iNumLinha;
    var var_dnc_valor_ice_ = scAjaxGetFieldText(nomeCampo_dnc_valor_ice_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_nota_credito_validate_dnc_valor_ice_(var_dnc_valor_ice_, iNumLinha, var_script_case_init, do_ajax_form_del_detalle_nota_credito_validate_dnc_valor_ice__cb);
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_valor_ice_

  function do_ajax_form_del_detalle_nota_credito_validate_dnc_valor_ice__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_valor_ice__cb

  // ---------- Validate dnc_base_irbpnr_
  function do_ajax_form_del_detalle_nota_credito_validate_dnc_base_irbpnr_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_nota_credito_validate_dnc_base_irbpnr_(var_dnc_base_irbpnr_, iNumLinha, var_script_case_init, do_ajax_form_del_detalle_nota_credito_validate_dnc_base_irbpnr__cb);
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_base_irbpnr_

  function do_ajax_form_del_detalle_nota_credito_validate_dnc_base_irbpnr__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_base_irbpnr__cb

  // ---------- Validate dnc_porcentaje_irbpnr_
  function do_ajax_form_del_detalle_nota_credito_validate_dnc_porcentaje_irbpnr_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_nota_credito_validate_dnc_porcentaje_irbpnr_(var_dnc_porcentaje_irbpnr_, iNumLinha, var_script_case_init, do_ajax_form_del_detalle_nota_credito_validate_dnc_porcentaje_irbpnr__cb);
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_porcentaje_irbpnr_

  function do_ajax_form_del_detalle_nota_credito_validate_dnc_porcentaje_irbpnr__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_porcentaje_irbpnr__cb

  // ---------- Validate dnc_valor_irbpnr_
  function do_ajax_form_del_detalle_nota_credito_validate_dnc_valor_irbpnr_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_nota_credito_validate_dnc_valor_irbpnr_(var_dnc_valor_irbpnr_, iNumLinha, var_script_case_init, do_ajax_form_del_detalle_nota_credito_validate_dnc_valor_irbpnr__cb);
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_valor_irbpnr_

  function do_ajax_form_del_detalle_nota_credito_validate_dnc_valor_irbpnr__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_valor_irbpnr__cb

  // ---------- Validate dnc_total_
  function do_ajax_form_del_detalle_nota_credito_validate_dnc_total_(iNumLinha)
  {
    var nomeCampo_dnc_total_ = "dnc_total_" + iNumLinha;
    var var_dnc_total_ = scAjaxGetFieldHidden(nomeCampo_dnc_total_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_nota_credito_validate_dnc_total_(var_dnc_total_, iNumLinha, var_script_case_init, do_ajax_form_del_detalle_nota_credito_validate_dnc_total__cb);
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_total_

  function do_ajax_form_del_detalle_nota_credito_validate_dnc_total__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_total__cb

  // ---------- Validate dnc_estado_
  function do_ajax_form_del_detalle_nota_credito_validate_dnc_estado_(iNumLinha)
  {
    var nomeCampo_dnc_estado_ = "dnc_estado_" + iNumLinha;
    var var_dnc_estado_ = scAjaxGetFieldText(nomeCampo_dnc_estado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_nota_credito_validate_dnc_estado_(var_dnc_estado_, iNumLinha, var_script_case_init, do_ajax_form_del_detalle_nota_credito_validate_dnc_estado__cb);
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_estado_

  function do_ajax_form_del_detalle_nota_credito_validate_dnc_estado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_estado__cb

  // ---------- Validate dnc_nota_credito_
  function do_ajax_form_del_detalle_nota_credito_validate_dnc_nota_credito_(iNumLinha)
  {
    var nomeCampo_dnc_nota_credito_ = "dnc_nota_credito_" + iNumLinha;
    var var_dnc_nota_credito_ = scAjaxGetFieldHidden(nomeCampo_dnc_nota_credito_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_nota_credito_validate_dnc_nota_credito_(var_dnc_nota_credito_, iNumLinha, var_script_case_init, do_ajax_form_del_detalle_nota_credito_validate_dnc_nota_credito__cb);
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_nota_credito_

  function do_ajax_form_del_detalle_nota_credito_validate_dnc_nota_credito__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_nota_credito_validate_dnc_nota_credito__cb

  // ---------- Event onchange dnc_precio_unitario_
  function do_ajax_form_del_detalle_nota_credito_event_dnc_precio_unitario__onchange(iSeqForm)
  {
    ...
    var var_dnc_producto_ = scAjaxGetFieldSelect("dnc_producto_" + iSeqForm);
    var var_dnc_porcentaje_iva_ = scAjaxGetFieldSelect("dnc_porcentaje_iva_" + iSeqForm);
    ...
    var var_dnc_precio_unitario_ = scAjaxGetFieldText("dnc_precio_unitario_" + iSeqForm);
    ...
    scAjaxProcOn(true);
    x_ajax_form_del_detalle_nota_credito_event_dnc_precio_unitario__onchange(var_dnc_cantidad_, var_dnc_cantidad_facturada_, var_dnc_producto_, var_dnc_porcentaje_iva_, var_dnc_porcentaje_ice_, var_dnc_porcentaje_irbpnr_, var_dnc_subtotal_, var_dnc_precio_unitario_, var_dnc_descuento_, var_dnc_base_ice_, var_dnc_valor_ice_, var_dnc_base_iva_, var_dnc_valor_iva_, var_dnc_base_irbpnr_, var_dnc_valor_irbpnr_, var_dnc_total_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_del_detalle_nota_credito_event_dnc_precio_unitario__onchange_cb);
  } // do_ajax_form_del_detalle_nota_credito_event_dnc_precio_unitario__onchange

  function do_ajax_form_del_detalle_nota_credito_event_dnc_precio_unitario__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_detalle_nota_credito_event_dnc_precio_unitario__onchange_cb_after_alert);
  } // do_ajax_form_del_detalle_nota_credito_event_dnc_precio_unitario__onchange_cb
  function do_ajax_form_del_detalle_nota_credito_event_dnc_precio_unitario__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_detalle_nota_credito_event_dnc_precio_unitario__onchange_cb_after_alert

  // ---------- Event onchange dnc_cantidad_
  function do_ajax_form_del_detalle_nota_credito_event_dnc_cantidad__onchange(iSeqForm)
  {
    var var_dnc_cantidad_ = scAjaxGetFieldText("dnc_cantidad_" + iSeqForm);
    var var_dnc_cantidad_facturada_ = scAjaxGetFieldHidden("dnc_cantidad_facturada_" + iSeqForm);
    var var_dnc_producto_ = scAjaxGetFieldSelect("dnc_producto_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_del_detalle_nota_credito_event_dnc_cantidad__onchange(var_dnc_cantidad_, var_dnc_cantidad_facturada_, var_dnc_producto_, var_dnc_porcentaje_iva_, var_dnc_porcentaje_ice_, var_dnc_porcentaje_irbpnr_, var_dnc_subtotal_, var_dnc_precio_unitario_, var_dnc_descuento_, var_dnc_base_ice_, var_dnc_valor_ice_, var_dnc_base_iva_, var_dnc_valor_iva_, var_dnc_base_irbpnr_, var_dnc_valor_irbpnr_, var_dnc_total_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_del_detalle_nota_credito_event_dnc_cantidad__onchange_cb);
  } // do_ajax_form_del_detalle_nota_credito_event_dnc_cantidad__onchange

  function do_ajax_form_del_detalle_nota_credito_event_dnc_cantidad__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_detalle_nota_credito_event_dnc_cantidad__onchange_cb_after_alert);
  } // do_ajax_form_del_detalle_nota_credito_event_dnc_cantidad__onchange_cb
  function do_ajax_form_del_detalle_nota_credito_event_dnc_cantidad__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_detalle_nota_credito_event_dnc_cantidad__onchange_cb_after_alert

  // ---------- Event onchange dnc_producto_
  function do_ajax_form_del_detalle_nota_credito_event_dnc_producto__onchange(iSeqForm)
  {
    var var_dnc_producto_ = scAjaxGetFieldSelect("dnc_producto_" + iSeqForm);
    var var_dnc_cantidad_ = scAjaxGetFieldText("dnc_cantidad_" + iSeqForm);
    var var_dnc_precio_unitario_ = scAjaxGetFieldText("dnc_precio_unitario_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_del_detalle_nota_credito_event_dnc_producto__onchange(var_dnc_producto_, var_dnc_cantidad_, var_dnc_precio_unitario_, var_dnc_descuento_, var_dnc_porcentaje_iva_, var_dnc_porcentaje_ice_, var_dnc_porcentaje_irbpnr_, var_dnc_base_ice_, var_dnc_base_irbpnr_, var_dnc_subtotal_, var_dnc_valor_ice_, var_dnc_base_iva_, var_dnc_valor_iva_, var_dnc_valor_irbpnr_, var_dnc_total_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_del_detalle_nota_credito_event_dnc_producto__onchange_cb);
  } // do_ajax_form_del_detalle_nota_credito_event_dnc_producto__onchange

  function do_ajax_form_del_detalle_nota_credito_event_dnc_producto__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_detalle_nota_credito_event_dnc_producto__onchange_cb_after_alert);
  } // do_ajax_form_del_detalle_nota_credito_event_dnc_producto__onchange_cb
  function do_ajax_form_del_detalle_nota_credito_event_dnc_producto__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_detalle_nota_credito_event_dnc_producto__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_del_detalle_nota_credito_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_del_detalle_nota_credito_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_detalle_nota_credito_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_del_detalle_nota_credito_add_new_line_cb);
  } // do_ajax_form_del_detalle_nota_credito_add_new_line

  function do_ajax_form_del_detalle_nota_credito_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_del_detalle_nota_credito_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_del_detalle_nota_credito_backup_line(iNumLinha)
  {
    var var_dnc_id_ = scAjaxGetFieldHidden("dnc_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_nota_credito_backup_line(var_dnc_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_del_detalle_nota_credito_backup_line_cb);
  } // do_ajax_form_del_detalle_nota_credito_backup_line

  function do_ajax_form_del_detalle_nota_credito_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_del_detalle_nota_credito_backup_line_cb

  function do_ajax_form_del_detalle_nota_credito_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_del_detalle_nota_credito_cancel_insert

  function do_ajax_form_del_detalle_nota_credito_cancel_update(iSeqVert)
  {
    do_ajax_form_del_detalle_nota_credito_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_del_detalle_nota_credito_cancel_update

  function do_ajax_form_del_detalle_nota_credito_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_del_detalle_nota_credito_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_del_detalle_nota_credito_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_detalle_nota_credito_table_refresh(var_dnc_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_detalle_nota_credito_table_refresh_cb);
  } //  do_ajax_form_del_detalle_nota_credito_table_refresh

  function do_ajax_form_del_detalle_nota_credito_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_del_detalle_nota_credito_table_refresh_cb_after_alert);
  } // do_ajax_form_del_detalle_nota_credito_table_refresh_cb
  function do_ajax_form_del_detalle_nota_credito_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_del_detalle_nota_credito_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_del_detalle_nota_credito_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_del_detalle_nota_credito_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_dnc_producto_ = scAjaxGetFieldSelect("dnc_producto_" + iNumLinha);
    var var_dnc_descripcion_ = scAjaxGetFieldText("dnc_descripcion_" + iNumLinha);
    ...
    var var_dnc_precio_unitario_ = scAjaxGetFieldText("dnc_precio_unitario_" + iNumLinha);
    ...
    var var_dnc_porcentaje_iva_ = scAjaxGetFieldSelect("dnc_porcentaje_iva_" + iNumLinha);
    ...
    var var_dnc_nota_credito_ = scAjaxGetFieldHidden("dnc_nota_credito_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_del_detalle_nota_credito_submit_form(var_dnc_id_, var_dnc_factura_, var_dnc_empresa_, var_dnc_producto_, var_dnc_descripcion_, var_dnc_cantidad_facturada_, var_dnc_cantidad_, var_dnc_precio_unitario_, var_dnc_descuento_, var_dnc_subtotal_, var_dnc_base_iva_, var_dnc_porcentaje_iva_, var_dnc_valor_iva_, var_dnc_base_ice_, var_dnc_porcentaje_ice_, var_dnc_valor_ice_, var_dnc_base_irbpnr_, var_dnc_porcentaje_irbpnr_, var_dnc_valor_irbpnr_, var_dnc_total_, var_dnc_estado_, var_dnc_nota_credito_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_detalle_nota_credito_submit_form_cb);
  } // do_ajax_form_del_detalle_nota_credito_submit_form

  function do_ajax_form_del_detalle_nota_credito_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_detalle_nota_credito_submit_form_cb_after_alert);
  } // do_ajax_form_del_detalle_nota_credito_submit_form_cb
  function do_ajax_form_del_detalle_nota_credito_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_detalle_nota_credito_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_detalle_nota_credito_navigate_form()
  {
    perform_ajax_form_del_detalle_nota_credito_navigate_form();
  }

  function perform_ajax_form_del_detalle_nota_credito_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_del_detalle_nota_credito_cancel_insert(sc_form_del_detalle_nota_credito_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_detalle_nota_credito_navigate_form(var_dnc_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_detalle_nota_credito_navigate_form_cb);
  } // do_ajax_form_del_detalle_nota_credito_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_detalle_nota_credito_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_detalle_nota_credito_navigate_form_cb_after_alert);
  } // do_ajax_form_del_detalle_nota_credito_navigate_form_cb
  function do_ajax_form_del_detalle_nota_credito_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_del_detalle_nota_credito_navigate_form_cb_after_alert

    function sc_form_del_detalle_nota_credito_get_last_line_number()
    {
    ...
    } //sc_form_del_detalle_nota_credito_get_last_line_number

  function sc_hide_form_del_detalle_nota_credito_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    ajax_field_id["dnc_porcentaje_iva_" + iNumLinha] = new Array("hidden_field_label_dnc_porcentaje_iva_", "hidden_field_data_dnc_porcentaje_iva_" + iNumLinha);
