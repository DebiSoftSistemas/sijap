<?php
//
class form_del_detalle_nota_credito_apl
{
   ...
   var $form_vert_form_del_detalle_nota_credito = array();
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_del_detalle_nota_credito']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_del_detalle_nota_credito']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_del_detalle_nota_credito']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_del_detalle_nota_credito']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_del_detalle_nota_credito']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_del_detalle_nota_credito']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_del_detalle_nota_credito']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_del_detalle_nota_credito']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->var_nota_credito)) 
          {
              $_SESSION['var_nota_credito'] = $this->var_nota_credito;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_del_detalle_nota_credito']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_del_detalle_nota_credito']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_del_detalle_nota_credito']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_del_detalle_nota_credito']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_del_detalle_nota_credito']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_del_detalle_nota_credito']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_del_detalle_nota_credito']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_del_detalle_nota_credito']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_del_detalle_nota_credito']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_del_detalle_nota_credito_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_del_detalle_nota_credito']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_del_detalle_nota_credito']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_del_detalle_nota_credito'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_del_detalle_nota_credito']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_del_detalle_nota_credito']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_del_detalle_nota_credito') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_del_detalle_nota_credito']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " del_detalle_nota_credito";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_del_detalle_nota_credito")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $this->arr_buttons['borrar_todo']['hint']             = "";
      $this->arr_buttons['borrar_todo']['type']             = "button";
      $this->arr_buttons['borrar_todo']['value']            = "" . $this->Ini->Nm_lang['lang_btns_dele'] . "";
      $this->arr_buttons['borrar_todo']['display']          = "text_fontawesomeicon";
      $this->arr_buttons['borrar_todo']['display_position'] = "text_right";
      $this->arr_buttons['borrar_todo']['style']            = "default";
      $this->arr_buttons['borrar_todo']['image']            = "";
      $this->arr_buttons['borrar_todo']['has_fa']            = "true";
      $this->arr_buttons['borrar_todo']['fontawesomeicon']            = "fas fa-trash-alt";


      $_SESSION['scriptcase']['error_icon']['form_del_detalle_nota_credito']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_del_detalle_nota_credito'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_nota_credito']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_nota_credito']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_nota_credito']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_nota_credito']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_nota_credito']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_nota_credito']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['goto']      = 'on';
          }
      }
      ...
      $this->nmgp_botoes['borrar_todo'] = "on";
      if (isset($this->NM_btn_cancel) && 'N' == $this->NM_btn_cancel)
      {
          $this->nmgp_botoes['cancel'] = "off";
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['where_orig'] = " where (dnc_cantidad>0
and dnc_nota_credito=" . $_SESSION['var_nota_credito'] . ")";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['where_pesq'] = " where (dnc_cantidad>0
and dnc_nota_credito=" . $_SESSION['var_nota_credito'] . ")";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_nota_credito']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_nota_credito']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_nota_credito']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_nota_credito']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_del_detalle_nota_credito'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_del_detalle_nota_credito'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_nota_credito']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_nota_credito']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_nota_credito']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_nota_credito']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_nota_credito']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_nota_credito']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_nota_credito']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_nota_credito']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_nota_credito']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_nota_credito']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_nota_credito']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_nota_credito']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_nota_credito']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field . "_"] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_nota_credito']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_nota_credito']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_nota_credito']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field . "_"] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_nota_credito']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_nota_credito']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_nota_credito']['exit'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_del_detalle_nota_credito_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_del_detalle_nota_credito_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_del_detalle_nota_credito/form_del_detalle_nota_credito_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_del_detalle_nota_credito_erro.class.php"); 
      }
      $this->Erro      = new form_del_detalle_nota_credito_erro();
      $this->Erro->Ini = $this->Ini;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['sc_max_reg']) && strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['sc_max_reg']) == "all")
      {
      ...
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['opcao']))
         { 
             if ($this->dnc_id_ != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_nota_credito']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_nota_credito']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_nota_credito']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['opc_ant'] : "";
      } 
      if ($this->nmgp_opcao == "novo")  
      {
          $this->nmgp_botoes['borrar_todo'] = "off";
      }
      elseif ($this->nmgp_opcao == "incluir")  
      {
          $this->nmgp_botoes['borrar_todo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['botoes']['borrar_todo'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_del_detalle_nota_credito']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_del_detalle_nota_credito']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      { 
          if ($nm_call_php == "borrar_todo")
          { 
              $this->sc_btn_borrar_todo();
          } 
          $this->NM_close_db(); 
          exit;
      } 
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['Gera_log_access'] = false;
      }
      if ($this->nmgp_opcao == "change_qtd_line")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['sc_max_reg'] = $this->nmgp_max_line;
      }
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['opc_edit'] = true;  
      ...
      if ($this->NM_ajax_flag && 'submit_form' == $this->NM_ajax_opcao)
      {
         ...
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dados_form'][$sc_seq_vert]))
         {
             $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dados_form'][$sc_seq_vert];
         }
         ...
         if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "")
         {
             $this->NM_rollback_db();
              if ($this->NM_ajax_flag)
              {
                  if (!isset($this->NM_ajax_info['errList']['geral_form_del_detalle_nota_credito']) || !is_array($this->NM_ajax_info['errList']['geral_form_del_detalle_nota_credito']))
                  {
                      $this->NM_ajax_info['errList']['geral_form_del_detalle_nota_credito'] = array();
                  }
                  if ($Campos_Crit != "")
                  {
                      $this->NM_ajax_info['errList']['geral_form_del_detalle_nota_credito'][] = $Campos_Crit;
                  }
                  if (!empty($Campos_Falta))
                  {
                      $this->NM_ajax_info['errList']['geral_form_del_detalle_nota_credito'][] = $this->Formata_Campos_Falta($Campos_Falta);
                  }
                  if ($this->Campos_Mens_erro != "")
                  {
                      $this->NM_ajax_info['errList']['geral_form_del_detalle_nota_credito'][] = $this->Campos_Mens_erro;
                  }
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['sc_redir_atualiz'] == "ok")
          {
      ...
      { 
         ...
         $Campos_Falta = array();
         $Campos_Erros = array();
         if ($this->nmgp_opcao == "recarga" && !isset($GLOBALS["dnc_porcentaje_iva_" . $sc_seq_vert]))
         { 
             $GLOBALS["dnc_porcentaje_iva_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dados_select'][$sc_seq_vert]['dnc_porcentaje_iva_'];
         } 
         ...
         if (isset($this->dnc_estado_)) { $this->nm_limpa_alfa($this->dnc_estado_); }
         if (isset($this->dnc_nota_credito_)) { $this->nm_limpa_alfa($this->dnc_nota_credito_); }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dados_form'])) 
         {
            $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dados_form'][$sc_seq_vert];
         }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dados_select'])) 
         {
            $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dados_select'][$sc_seq_vert];
         }
         ...
         {
             if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dados_select'][$sc_seq_vert]['dnc_porcentaje_iva_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['sc_disabled'][$sc_seq_vert]['dnc_porcentaje_iva_']))
             { 
                 $this->dnc_porcentaje_iva_ = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dados_select'][$sc_seq_vert]['dnc_porcentaje_iva_'];
             } 
             $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['sc_disabled'] = array();
             $this->controle_form_vert(); 
             ...
             $this->form_vert_form_del_detalle_nota_credito[$sc_seq_vert]['dnc_id_'] =  $this->dnc_id_; 
             $this->form_vert_form_del_detalle_nota_credito[$sc_seq_vert]['dnc_factura_'] =  $this->dnc_factura_; 
             $this->form_vert_form_del_detalle_nota_credito[$sc_seq_vert]['dnc_empresa_'] =  $this->dnc_empresa_; 
             $this->form_vert_form_del_detalle_nota_credito[$sc_seq_vert]['dnc_producto_'] =  $this->dnc_producto_; 
             $this->form_vert_form_del_detalle_nota_credito[$sc_seq_vert]['dnc_descripcion_'] =  $this->dnc_descripcion_; 
             $this->form_vert_form_del_detalle_nota_credito[$sc_seq_vert]['dnc_cantidad_facturada_'] =  $this->dnc_cantidad_facturada_; 
             $this->form_vert_form_del_detalle_nota_credito[$sc_seq_vert]['dnc_cantidad_'] =  $this->dnc_cantidad_; 
             $this->form_vert_form_del_detalle_nota_credito[$sc_seq_vert]['dnc_precio_unitario_'] =  $this->dnc_precio_unitario_; 
             $this->form_vert_form_del_detalle_nota_credito[$sc_seq_vert]['dnc_descuento_'] =  $this->dnc_descuento_; 
             $this->form_vert_form_del_detalle_nota_credito[$sc_seq_vert]['dnc_subtotal_'] =  $this->dnc_subtotal_; 
             $this->form_vert_form_del_detalle_nota_credito[$sc_seq_vert]['dnc_base_iva_'] =  $this->dnc_base_iva_; 
             $this->form_vert_form_del_detalle_nota_credito[$sc_seq_vert]['dnc_porcentaje_iva_'] =  $this->dnc_porcentaje_iva_; 
             $this->form_vert_form_del_detalle_nota_credito[$sc_seq_vert]['dnc_valor_iva_'] =  $this->dnc_valor_iva_; 
             $this->form_vert_form_del_detalle_nota_credito[$sc_seq_vert]['dnc_base_ice_'] =  $this->dnc_base_ice_; 
             $this->form_vert_form_del_detalle_nota_credito[$sc_seq_vert]['dnc_porcentaje_ice_'] =  $this->dnc_porcentaje_ice_; 
             $this->form_vert_form_del_detalle_nota_credito[$sc_seq_vert]['dnc_valor_ice_'] =  $this->dnc_valor_ice_; 
             $this->form_vert_form_del_detalle_nota_credito[$sc_seq_vert]['dnc_base_irbpnr_'] =  $this->dnc_base_irbpnr_; 
             $this->form_vert_form_del_detalle_nota_credito[$sc_seq_vert]['dnc_porcentaje_irbpnr_'] =  $this->dnc_porcentaje_irbpnr_; 
             $this->form_vert_form_del_detalle_nota_credito[$sc_seq_vert]['dnc_valor_irbpnr_'] =  $this->dnc_valor_irbpnr_; 
             $this->form_vert_form_del_detalle_nota_credito[$sc_seq_vert]['dnc_total_'] =  $this->dnc_total_; 
             $this->form_vert_form_del_detalle_nota_credito[$sc_seq_vert]['dnc_estado_'] =  $this->dnc_estado_; 
             $this->form_vert_form_del_detalle_nota_credito[$sc_seq_vert]['dnc_nota_credito_'] =  $this->dnc_nota_credito_; 
         }
         $sc_seq_vert++; 
      } 
      ...
      if ($this->NM_ajax_flag && 'table_refresh' == $this->NM_ajax_opcao)
      {
          ...
          $this->NM_ajax_info['rsSize'] = sizeof($this->form_vert_form_del_detalle_nota_credito);
      ...
      {
          $this->nm_tira_formatacao();
          if ('event_dnc_precio_unitario__onchange' == $this->NM_ajax_opcao)
          {
              $this->dnc_precio_unitario__onChange();
          }
          if ('event_dnc_cantidad__onchange' == $this->NM_ajax_opcao)
          {
              $this->dnc_cantidad__onChange();
          }
          if ('event_dnc_producto__onchange' == $this->NM_ajax_opcao)
          {
              $this->dnc_producto__onChange();
          }
          $this->NM_close_db();
          form_del_detalle_nota_credito_pack_ajax_response();
          exit;
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          if (isset($this->dnc_porcentaje_iva_))
          { 
              $SV_dnc_porcentaje_iva_ = $this->dnc_porcentaje_iva_;
          } 
          $this->nm_tira_formatacao();
          if (isset($SV_dnc_porcentaje_iva_) && $this->nmgp_opcao != "recarga")
          { 
              $this->dnc_porcentaje_iva_ = $SV_dnc_porcentaje_iva_;
          } 
...
//
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_del_detalle_nota_credito.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_del_detalle_nota_credito_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_del_detalle_nota_credito"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_del_detalle_nota_credito', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sis_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'form_del_detalle_nota_credito', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_del_detalle_nota_credito', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
<?php
      ...
      $_SESSION['scriptcase']['form_del_detalle_nota_credito']['contr_erro'] = 'on';
if (!isset($this->sc_temp_var_nota_credito)) {$this->sc_temp_var_nota_credito = (isset($_SESSION['var_nota_credito'])) ? $_SESSION['var_nota_credito'] : "";}
  $delete_sql="DELETE FROM del_detalle_nota_credito WHERE dnc_nota_credito=".$this->sc_temp_var_nota_credito;
...
?>
      ...
      <input type=hidden name="script_case_init" value="<?php  echo $this->form_encode_input($this->Ini->sc_page); ?>"/>
      <input type=hidden name="dnc_id_" value="<?php echo $this->form_encode_input($this->dnc_id_) ?>"/>
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              ...
              $this->NM_ajax_info['errList']['geral_form_del_detalle_nota_credito'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
   ...
   if (isset($this->Field_no_validate['dnc_producto_'])) {
       return;
               ...
               if (!empty($this->dnc_producto_) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['Lookup_dnc_producto_']) && !in_array($this->dnc_producto_, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['Lookup_dnc_producto_']))
               {
                   $hasError = true;
                   ...
                   $Campos_Erros['dnc_producto_'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   ...
                   $this->NM_ajax_info['errList']['dnc_producto_'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
               }
        if ($hasError) {
            global $sc_seq_vert;
   ...
   if (isset($this->Field_no_validate['dnc_porcentaje_iva_'])) {
       return;
               ...
               if (!empty($this->dnc_porcentaje_iva_) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['Lookup_dnc_porcentaje_iva_']) && !in_array($this->dnc_porcentaje_iva_, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['Lookup_dnc_porcentaje_iva_']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dados_form'][$sc_seq_vert] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['navStatus']['ret'] = $this->Nav_permite_ret ? 'S' : 'N';
              $this->NM_ajax_info['navStatus']['ava'] = $this->Nav_permite_ava ? 'S' : 'N';
              $this->NM_ajax_info['fldList']['dnc_id_']['keyVal'] = form_del_detalle_nota_credito_pack_protect_string($this->nmgp_dados_form['dnc_id_']);
          }
   } // ajax_return_values
   function ajax_return_values_all_vert()
   {
          ...
          {
              $this->form_vert_form_del_detalle_nota_credito[$this->nmgp_refresh_row] = $this->NM_ajax_info['param'];
              if ((isset($this->Embutida_ronly) && $this->Embutida_ronly) || $this->NM_ajax_force_values)
              {
                  ...
                  {
                      $this->form_vert_form_del_detalle_nota_credito[$this->nmgp_refresh_row]['dnc_id_'] = $this->dnc_id_;
                  }
                  if (isset($this->NM_ajax_changed['dnc_factura_']) && $this->NM_ajax_changed['dnc_factura_'])
                  {
                      $this->form_vert_form_del_detalle_nota_credito[$this->nmgp_refresh_row]['dnc_factura_'] = $this->dnc_factura_;
                  }
                  if (isset($this->NM_ajax_changed['dnc_empresa_']) && $this->NM_ajax_changed['dnc_empresa_'])
                  {
                      $this->form_vert_form_del_detalle_nota_credito[$this->nmgp_refresh_row]['dnc_empresa_'] = $this->dnc_empresa_;
                  }
                  if (isset($this->NM_ajax_changed['dnc_producto_']) && $this->NM_ajax_changed['dnc_producto_'])
                  {
                      $this->form_vert_form_del_detalle_nota_credito[$this->nmgp_refresh_row]['dnc_producto_'] = $this->dnc_producto_;
                  }
                  if (isset($this->NM_ajax_changed['dnc_descripcion_']) && $this->NM_ajax_changed['dnc_descripcion_'])
                  {
                      $this->form_vert_form_del_detalle_nota_credito[$this->nmgp_refresh_row]['dnc_descripcion_'] = $this->dnc_descripcion_;
                  }
                  if (isset($this->NM_ajax_changed['dnc_cantidad_facturada_']) && $this->NM_ajax_changed['dnc_cantidad_facturada_'])
                  {
                      $this->form_vert_form_del_detalle_nota_credito[$this->nmgp_refresh_row]['dnc_cantidad_facturada_'] = $this->dnc_cantidad_facturada_;
                  }
                  if (isset($this->NM_ajax_changed['dnc_cantidad_']) && $this->NM_ajax_changed['dnc_cantidad_'])
                  {
                      $this->form_vert_form_del_detalle_nota_credito[$this->nmgp_refresh_row]['dnc_cantidad_'] = $this->dnc_cantidad_;
                  }
                  if (isset($this->NM_ajax_changed['dnc_precio_unitario_']) && $this->NM_ajax_changed['dnc_precio_unitario_'])
                  {
                      $this->form_vert_form_del_detalle_nota_credito[$this->nmgp_refresh_row]['dnc_precio_unitario_'] = $this->dnc_precio_unitario_;
                  }
                  if (isset($this->NM_ajax_changed['dnc_descuento_']) && $this->NM_ajax_changed['dnc_descuento_'])
                  {
                      $this->form_vert_form_del_detalle_nota_credito[$this->nmgp_refresh_row]['dnc_descuento_'] = $this->dnc_descuento_;
                  }
                  if (isset($this->NM_ajax_changed['dnc_subtotal_']) && $this->NM_ajax_changed['dnc_subtotal_'])
                  {
                      $this->form_vert_form_del_detalle_nota_credito[$this->nmgp_refresh_row]['dnc_subtotal_'] = $this->dnc_subtotal_;
                  }
                  if (isset($this->NM_ajax_changed['dnc_base_iva_']) && $this->NM_ajax_changed['dnc_base_iva_'])
                  {
                      $this->form_vert_form_del_detalle_nota_credito[$this->nmgp_refresh_row]['dnc_base_iva_'] = $this->dnc_base_iva_;
                  }
                  if (isset($this->NM_ajax_changed['dnc_porcentaje_iva_']) && $this->NM_ajax_changed['dnc_porcentaje_iva_'])
                  {
                      $this->form_vert_form_del_detalle_nota_credito[$this->nmgp_refresh_row]['dnc_porcentaje_iva_'] = $this->dnc_porcentaje_iva_;
                  }
                  if (isset($this->NM_ajax_changed['dnc_valor_iva_']) && $this->NM_ajax_changed['dnc_valor_iva_'])
                  {
                      $this->form_vert_form_del_detalle_nota_credito[$this->nmgp_refresh_row]['dnc_valor_iva_'] = $this->dnc_valor_iva_;
                  }
                  if (isset($this->NM_ajax_changed['dnc_base_ice_']) && $this->NM_ajax_changed['dnc_base_ice_'])
                  {
                      $this->form_vert_form_del_detalle_nota_credito[$this->nmgp_refresh_row]['dnc_base_ice_'] = $this->dnc_base_ice_;
                  }
                  if (isset($this->NM_ajax_changed['dnc_porcentaje_ice_']) && $this->NM_ajax_changed['dnc_porcentaje_ice_'])
                  {
                      $this->form_vert_form_del_detalle_nota_credito[$this->nmgp_refresh_row]['dnc_porcentaje_ice_'] = $this->dnc_porcentaje_ice_;
                  }
                  if (isset($this->NM_ajax_changed['dnc_valor_ice_']) && $this->NM_ajax_changed['dnc_valor_ice_'])
                  {
                      $this->form_vert_form_del_detalle_nota_credito[$this->nmgp_refresh_row]['dnc_valor_ice_'] = $this->dnc_valor_ice_;
                  }
                  if (isset($this->NM_ajax_changed['dnc_base_irbpnr_']) && $this->NM_ajax_changed['dnc_base_irbpnr_'])
                  {
                      $this->form_vert_form_del_detalle_nota_credito[$this->nmgp_refresh_row]['dnc_base_irbpnr_'] = $this->dnc_base_irbpnr_;
                  }
                  if (isset($this->NM_ajax_changed['dnc_porcentaje_irbpnr_']) && $this->NM_ajax_changed['dnc_porcentaje_irbpnr_'])
                  {
                      $this->form_vert_form_del_detalle_nota_credito[$this->nmgp_refresh_row]['dnc_porcentaje_irbpnr_'] = $this->dnc_porcentaje_irbpnr_;
                  }
                  if (isset($this->NM_ajax_changed['dnc_valor_irbpnr_']) && $this->NM_ajax_changed['dnc_valor_irbpnr_'])
                  {
                      $this->form_vert_form_del_detalle_nota_credito[$this->nmgp_refresh_row]['dnc_valor_irbpnr_'] = $this->dnc_valor_irbpnr_;
                  }
                  if (isset($this->NM_ajax_changed['dnc_total_']) && $this->NM_ajax_changed['dnc_total_'])
                  {
                      $this->form_vert_form_del_detalle_nota_credito[$this->nmgp_refresh_row]['dnc_total_'] = $this->dnc_total_;
                  }
                  if (isset($this->NM_ajax_changed['dnc_estado_']) && $this->NM_ajax_changed['dnc_estado_'])
                  {
                      $this->form_vert_form_del_detalle_nota_credito[$this->nmgp_refresh_row]['dnc_estado_'] = $this->dnc_estado_;
                  }
                  if (isset($this->NM_ajax_changed['dnc_nota_credito_']) && $this->NM_ajax_changed['dnc_nota_credito_'])
                  {
                      $this->form_vert_form_del_detalle_nota_credito[$this->nmgp_refresh_row]['dnc_nota_credito_'] = $this->dnc_nota_credito_;
                  }
              }
          }
          ...
          foreach($this->form_vert_form_del_detalle_nota_credito as $sc_seq_vert => $aRecData)
          {
...
else
{
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_del_detalle_nota_credito_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_del_detalle_nota_credito_pack_protect_string(NM_charset_to_utf8($rs->fields[0] . " - " . $rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"dnc_producto_\"";
          if (isset($this->NM_ajax_info['select_html']['dnc_producto_']) && !empty($this->NM_ajax_info['select_html']['dnc_producto_']))
          {
              eval("\$sSelComp = \"" . str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['dnc_producto_']) . "\";");
          }
          $sLookup = '';
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['dnc_producto_' . $sc_seq_vert]['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['dnc_producto_' . $sc_seq_vert]['valList'][$i] = form_del_detalle_nota_credito_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['dnc_producto_' . $sc_seq_vert]['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['dnc_producto_' . $sc_seq_vert]['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['dnc_producto_' . $sc_seq_vert]['labList'] = $aLabel;
              }
...
else
{
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_del_detalle_nota_credito_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_del_detalle_nota_credito_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"dnc_porcentaje_iva_\"";
          if (isset($this->NM_ajax_info['select_html']['dnc_porcentaje_iva_']) && !empty($this->NM_ajax_info['select_html']['dnc_porcentaje_iva_']))
          {
              eval("\$sSelComp = \"" . str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['dnc_porcentaje_iva_']) . "\";");
          }
          $sLookup = '';
          foreach ($aLookup as $aOption)
          {
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['dnc_porcentaje_iva_' . $sc_seq_vert]['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['dnc_porcentaje_iva_' . $sc_seq_vert]['valList'][$i] = form_del_detalle_nota_credito_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['dnc_porcentaje_iva_' . $sc_seq_vert]['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['dnc_porcentaje_iva_' . $sc_seq_vert]['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['dnc_porcentaje_iva_' . $sc_seq_vert]['labList'] = $aLabel;
              }
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['Field_no_validate'] = array();
...
if (isset($this->rs[0][0]))     
{
    if($this->rs[0][0]<>'R'){
	 ...
	 $this->NM_ajax_info['buttonDisplay']['borrar_todo'] = $this->nmgp_botoes["borrar_todo"] = 'off';;	
	}
}
if (isset($this->sc_temp_var_nota_credito)) { $_SESSION['var_nota_credito'] = $this->sc_temp_var_nota_credito;}
$_SESSION['scriptcase']['form_del_detalle_nota_credito']['contr_erro'] = 'off'; 
...
//----------- 
   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar")
      {
          ...
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dados_select'][$sc_seq_vert]['dnc_id_'] = $this->dnc_id_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dados_select'][$sc_seq_vert]['dnc_factura_'] = $this->dnc_factura_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dados_select'][$sc_seq_vert]['dnc_empresa_'] = $this->dnc_empresa_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dados_select'][$sc_seq_vert]['dnc_producto_'] = $this->dnc_producto_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dados_select'][$sc_seq_vert]['dnc_descripcion_'] = $this->dnc_descripcion_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dados_select'][$sc_seq_vert]['dnc_cantidad_facturada_'] = $this->dnc_cantidad_facturada_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dados_select'][$sc_seq_vert]['dnc_cantidad_'] = $this->dnc_cantidad_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dados_select'][$sc_seq_vert]['dnc_precio_unitario_'] = $this->dnc_precio_unitario_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dados_select'][$sc_seq_vert]['dnc_descuento_'] = $this->dnc_descuento_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dados_select'][$sc_seq_vert]['dnc_subtotal_'] = $this->dnc_subtotal_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dados_select'][$sc_seq_vert]['dnc_base_iva_'] = $this->dnc_base_iva_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dados_select'][$sc_seq_vert]['dnc_porcentaje_iva_'] = $this->dnc_porcentaje_iva_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dados_select'][$sc_seq_vert]['dnc_valor_iva_'] = $this->dnc_valor_iva_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dados_select'][$sc_seq_vert]['dnc_base_ice_'] = $this->dnc_base_ice_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dados_select'][$sc_seq_vert]['dnc_porcentaje_ice_'] = $this->dnc_porcentaje_ice_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dados_select'][$sc_seq_vert]['dnc_valor_ice_'] = $this->dnc_valor_ice_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dados_select'][$sc_seq_vert]['dnc_base_irbpnr_'] = $this->dnc_base_irbpnr_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dados_select'][$sc_seq_vert]['dnc_porcentaje_irbpnr_'] = $this->dnc_porcentaje_irbpnr_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dados_select'][$sc_seq_vert]['dnc_valor_irbpnr_'] = $this->dnc_valor_irbpnr_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dados_select'][$sc_seq_vert]['dnc_total_'] = $this->dnc_total_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dados_select'][$sc_seq_vert]['dnc_estado_'] = $this->dnc_estado_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dados_select'][$sc_seq_vert]['dnc_nota_credito_'] = $this->dnc_nota_credito_;
          }
      }
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          { 
              $NM_seq_auto = "NEXT VALUE FOR del_detalle_nota_credito_dnc_id_seq, ";
              $NM_cmp_auto = "dnc_id, ";
          } 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          { 
              $NM_seq_auto = "del_detalle_nota_credito_dnc_id_seq.NEXTVAL, ";
              $NM_cmp_auto = "dnc_id, ";
          } 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
          { 
              $NM_seq_auto = "nextval('del_detalle_nota_credito_dnc_id_seq'), ";
              $NM_cmp_auto = "dnc_id, ";
          } 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $NM_seq_auto = "gen_id(del_detalle_nota_credito_dnc_id_seq, 1), ";
              $NM_cmp_auto = "dnc_id, ";
          } 
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (dnc_factura, dnc_empresa, dnc_producto, dnc_descripcion, dnc_cantidad_facturada, dnc_cantidad, dnc_precio_unitario, dnc_subtotal, dnc_descuento, dnc_base_iva, dnc_porcentaje_iva, dnc_valor_iva, dnc_base_ice, dnc_porcentaje_ice, dnc_valor_ice, dnc_base_irbpnr, dnc_porcentaje_irbpnr, dnc_valor_irbpnr, dnc_total, dnc_estado, dnc_nota_credito) VALUES ($this->dnc_factura_, '$this->dnc_empresa_', '$this->dnc_producto_', '$this->dnc_descripcion_', $this->dnc_cantidad_facturada_, $this->dnc_cantidad_, $this->dnc_precio_unitario_, $this->dnc_subtotal_, $this->dnc_descuento_, $this->dnc_base_iva_, $this->dnc_porcentaje_iva_, $this->dnc_valor_iva_, $this->dnc_base_ice_, '$this->dnc_porcentaje_ice_', $this->dnc_valor_ice_, $this->dnc_base_irbpnr_, '$this->dnc_porcentaje_irbpnr_', $this->dnc_valor_irbpnr_, $this->dnc_total_, '$this->dnc_estado_', $this->dnc_nota_credito_)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "dnc_factura, dnc_empresa, dnc_producto, dnc_descripcion, dnc_cantidad_facturada, dnc_cantidad, dnc_precio_unitario, dnc_subtotal, dnc_descuento, dnc_base_iva, dnc_porcentaje_iva, dnc_valor_iva, dnc_base_ice, dnc_porcentaje_ice, dnc_valor_ice, dnc_base_irbpnr, dnc_porcentaje_irbpnr, dnc_valor_irbpnr, dnc_total, dnc_estado, dnc_nota_credito) VALUES (" . $NM_seq_auto . "$this->dnc_factura_, '$this->dnc_empresa_', '$this->dnc_producto_', '$this->dnc_descripcion_', $this->dnc_cantidad_facturada_, $this->dnc_cantidad_, $this->dnc_precio_unitario_, $this->dnc_subtotal_, $this->dnc_descuento_, $this->dnc_base_iva_, $this->dnc_porcentaje_iva_, $this->dnc_valor_iva_, $this->dnc_base_ice_, '$this->dnc_porcentaje_ice_', $this->dnc_valor_ice_, $this->dnc_base_irbpnr_, '$this->dnc_porcentaje_irbpnr_', $this->dnc_valor_irbpnr_, $this->dnc_total_, '$this->dnc_estado_', $this->dnc_nota_credito_)"; 
              }
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select del_detalle_nota_credito_dnc_id_seq.currval from dual"; 
                  $rsy = $this->Db->Execute($_SESSION['scriptcase']['sc_sql_ult_comando']); 
                  if ($rsy === false && !$rsy->EOF)  
                  { 
                      $this->Erro->mensagem (__FILE__, __LINE__, "banco", $this->Ini->Nm_lang['lang_errm_dbas'], $this->Db->ErrorMsg()); 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_db2))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "values PREVVAL FOR del_detalle_nota_credito_dnc_id_seq"; 
                  $rsy = $this->Db->Execute($_SESSION['scriptcase']['sc_sql_ult_comando']); 
                  if ($rsy === false && !$rsy->EOF)  
                  { 
                      $this->Erro->mensagem (__FILE__, __LINE__, "banco", $this->Ini->Nm_lang['lang_errm_dbas'], $this->Db->ErrorMsg()); 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select CURRVAL('del_detalle_nota_credito_dnc_id_seq')"; 
                  $rsy = $this->Db->Execute($_SESSION['scriptcase']['sc_sql_ult_comando']); 
                  if ($rsy === false && !$rsy->EOF)  
                  { 
                      $this->Erro->mensagem (__FILE__, __LINE__, "banco", $this->Ini->Nm_lang['lang_errm_dbas'], $this->Db->ErrorMsg()); 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select gen_id(del_detalle_nota_credito_dnc_id_seq, 0) from " . $this->Ini->nm_tabela; 
                  $rsy = $this->Db->Execute($_SESSION['scriptcase']['sc_sql_ult_comando']); 
                  if ($rsy === false && !$rsy->EOF)  
                  { 
                      $this->Erro->mensagem (__FILE__, __LINE__, "banco", $this->Ini->Nm_lang['lang_errm_dbas'], $this->Db->ErrorMsg()); 
              ...
              $this->NM_gera_log_new();
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['total']++; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['reg_qtd']++; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['reg_I_E']++; 
              $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['reg_start'] + 1; 
              $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['reg_qtd']; 
              $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['total'] + 1; 
              $this->NM_gera_nav_page(); 
              $this->NM_ajax_info['navPage'] = $this->SC_nav_page; 
              ...
              if (isset($this->Embutida_form) && $this->Embutida_form)
              {
                  ...
                  $this->NM_ajax_info['fldList']['dnc_id_' . $this->nmgp_refresh_row]['type']    = 'label';
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              if (key($aValData) == form_del_detalle_nota_credito_pack_protect_string(NM_charset_to_utf8($this->dnc_producto_)))
              {
                  $sLabelTemp = current($aValData);
              }
          }
          $tmpLabel_dnc_producto_ = $sLabelTemp;
                  $this->NM_ajax_info['fldList']['dnc_producto_' . $this->nmgp_refresh_row]['type']    = 'select';
                  ...
                  $this->NM_ajax_info['fldList']['dnc_producto_' . $this->nmgp_refresh_row]['labList'] = array($tmpLabel_dnc_producto_);
                  ...
                  $this->NM_ajax_info['fldList']['dnc_descripcion_' . $this->nmgp_refresh_row]['type']    = 'text';
                  ...
                  $this->NM_ajax_info['fldList']['dnc_precio_unitario_' . $this->nmgp_refresh_row]['type']    = 'text';
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          foreach ($aLookup as $aValData)
          {
              if (key($aValData) == form_del_detalle_nota_credito_pack_protect_string(NM_charset_to_utf8($this->dnc_porcentaje_iva_)))
              {
                  $sLabelTemp = current($aValData);
              }
          }
          $tmpLabel_dnc_porcentaje_iva_ = $sLabelTemp;
                  $this->NM_ajax_info['fldList']['dnc_porcentaje_iva_' . $this->nmgp_refresh_row]['type']    = 'select';
                  ...
                  $this->NM_ajax_info['fldList']['dnc_porcentaje_iva_' . $this->nmgp_refresh_row]['labList'] = array($tmpLabel_dnc_porcentaje_iva_);
                  ...
                  $tmpLabel_dnc_nota_credito_ = $this->dnc_nota_credito_;
                  $this->NM_ajax_info['fldList']['dnc_nota_credito_' . $this->nmgp_refresh_row]['type']    = 'label';
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['reg_start'] = 0; 
              }
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
  ...
  $exec_sql = "SELECT sp_del_actualiza_nc(".$this->dnc_nota_credito_ .")";
...
$_SESSION['scriptcase']['form_del_detalle_nota_credito']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['parms'] = "dnc_id_?#?$this->dnc_id_?@?"; 
      }
...
//---------- 
   ...
   { 
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_nota_credito']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_nota_credito']['rows']))
      {
          $this->sc_max_reg = $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_nota_credito']['rows'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_nota_credito']['rows_ins']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_nota_credito']['rows_ins']))
      {
          $this->sc_max_reg_incl = $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_nota_credito']['rows_ins'];
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_liga_qtd_reg']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_liga_qtd_reg'])
      {
          $this->sc_max_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_liga_qtd_reg'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['sc_max_reg']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['sc_max_reg'] > 0 || strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['sc_max_reg']) == "all"))
      {
          $this->sc_max_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['sc_max_reg'];
      } 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
      $this->form_vert_form_del_detalle_nota_credito = array();
      if ($this->nmgp_opcao != "novo") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['parms'] = ""; 
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
      { 
          $GLOBALS["NM_ERRO_IBASE"] = 1;  
      ...
      {
          $this->nmgp_opcao = "avanca";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['reg_start'] -= $this->sc_max_reg;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['reg_start'] = 0;
      }
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['total']);
          }
      }
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['where_filter'] . ")";
          }
      }
...
and dnc_nota_credito=" . $_SESSION['var_nota_credito'] . ")");
      ...
      if ('total' != $this->form_paginacao)
      {
          if ($this->app_is_initializing || $this->sc_teve_excl || $this->sc_teve_incl || (isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['total']))
          {
              ...
              $qt_geral_reg_form_del_detalle_nota_credito = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['total'] = $qt_geral_reg_form_del_detalle_nota_credito;
              $rt->Close();
          }
      if ((isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['total']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['reg_I_E'] = 0; 
          ...
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->dnc_id_))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_del_detalle_nota_credito = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['total'];
      } 
      if ($this->nmgp_opcao == "inicio" || $this->nmgp_opcao == "ordem") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['reg_start'] = 0; 
      } 
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_del_detalle_nota_credito) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if ($this->nmgp_opcao == "avanca")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['reg_start'] += ($this->sc_max_reg + $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['reg_I_E']); 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['reg_start'] > $qt_geral_reg_form_del_detalle_nota_credito)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['reg_start'] = $qt_geral_reg_form_del_detalle_nota_credito - $this->sc_max_reg; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['reg_start'] = ($qt_geral_reg_form_del_detalle_nota_credito + 1) - $this->sc_max_reg; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['reg_start'] < 0)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['reg_start'] = 0; 
          }
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['ordem_cmp'] != $this->nmgp_ordem)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['ordem_cmp'] = $this->nmgp_ordem; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['ordem_ord'] = ' asc'; 
              switch ($this->nmgp_ordem) {
                  case "dnc_id":
                      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['ordem_ord'] = ' desc';
                      break;
                  case "dnc_factura":
                      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['ordem_ord'] = ' desc';
                      break;
          ...
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['ordem_ord'] == ' asc')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['ordem_ord'] = ' desc'; 
          }
          else
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['ordem_cmp'])) 
      { 
          $sc_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['ordem_cmp'] . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['ordem_ord']; 
      } 
      ...
      else
      {
          ...
          { 
              ...
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['reg_start'] . ")" ; 
                  $rs = $this->Db->SelectLimit($nmgp_select, $this->sc_max_reg, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['reg_start']) ; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['reg_start'] . ")" ; 
              ...
              { 
                  ...
                  if (!$rs === false && !$rs->EOF) 
                  { 
                      $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['reg_start']) ;  
                  } 
              } 
          } 
      }
          ...
          { 
              ...
              if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['parms'])) 
              { 
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['parms'] = "dnc_id_?#?$this->dnc_id_?@?";
              } 
              $this->nm_proc_onload_record($sc_seq_vert);
...
//
//-- 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dados_select'][$sc_seq_vert] = $this->nmgp_dados_select;
              $this->nm_guardar_campos();
              $this->nm_formatar_campos();
             $this->form_vert_form_del_detalle_nota_credito[$sc_seq_vert]['dnc_id_'] =  $this->dnc_id_; 
             $this->form_vert_form_del_detalle_nota_credito[$sc_seq_vert]['dnc_factura_'] =  $this->dnc_factura_; 
          ...
          ksort ($this->form_vert_form_del_detalle_nota_credito); 
          $rs->Close(); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['reg_qtd'] = $sc_seq_vert + $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['reg_start'] - 1;
          if ('total' == $this->form_paginacao)
          {
          ...
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['reg_start'] < (($qt_geral_reg_form_del_detalle_nota_credito + 1) - $this->sc_max_reg);
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['opcao'] = '';
          }
      } 
      if ($this->nmgp_opcao == "novo") 
      { 
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['embutida_multi']) 
          { 
          } 
          else 
          { 
          ...
          { 
              ...
              $this->dnc_producto_ = "";  
              $this->dnc_descripcion_ = "";  
              $this->dnc_cantidad_facturada_ = htmlentities("1");  
              $this->dnc_cantidad_ = "";  
              $this->dnc_precio_unitario_ = "";  
              $this->dnc_subtotal_ = "";  
              $this->dnc_descuento_ = "";  
              ...
              $this->dnc_valor_irbpnr_ = "";  
              $this->dnc_total_ = "";  
              $this->dnc_estado_ = htmlentities("R");  
...
// 
   ...
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dados_select'][$sc_seq_vert] ))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dados_select'][$sc_seq_vert] ;
...
// 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['reg_start'] + $this->sc_max_reg;
       ...
       foreach ($Arr_result as $Ind_result => $Lin_result)
       {
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['record_state'][$sc_seq_vert]['buttons'] = array(
                        'delete' => $this->nmgp_botoes['delete'],
                        'update' => $this->nmgp_botoes['update']
                );
        }
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }

//
function dnc_precio_unitario__onChange()
{
$_SESSION['scriptcase']['form_del_detalle_nota_credito']['contr_erro'] = 'on';
...
$original_dnc_porcentaje_iva_ = $this->dnc_porcentaje_iva_;
...
$modificado_dnc_porcentaje_iva_ = $this->dnc_porcentaje_iva_;
...
$this->nm_formatar_campos('dnc_cantidad_', 'dnc_cantidad_facturada_', 'dnc_producto_', 'dnc_porcentaje_iva_', 'dnc_porcentaje_ice_', 'dnc_porcentaje_irbpnr_', 'dnc_subtotal_', 'dnc_precio_unitario_', 'dnc_descuento_', 'dnc_base_ice_', 'dnc_valor_ice_', 'dnc_base_iva_', 'dnc_valor_iva_', 'dnc_base_irbpnr_', 'dnc_valor_irbpnr_', 'dnc_total_');
...
if ($original_dnc_porcentaje_iva_ !== $modificado_dnc_porcentaje_iva_ || isset($this->nmgp_cmp_readonly['dnc_porcentaje_iva_']) || (isset($bFlagRead_dnc_porcentaje_iva_) && $bFlagRead_dnc_porcentaje_iva_))
{
    $this->nmgp_refresh_fields[] = 'dnc_porcentaje_iva_';
    $this->NM_ajax_changed['dnc_porcentaje_iva_'] = true;
    $this->NM_ajax_force_values = true;
}
...
function dnc_producto__onChange()
{
$_SESSION['scriptcase']['form_del_detalle_nota_credito']['contr_erro'] = 'on';
...
if($this->dnc_producto_ <>''){
	...
	if (isset($this->rs[0][0])){
		$this->dnc_cantidad_ =1;
		$this->dnc_precio_unitario_ =$this->rs[0][0];
		$this->dnc_descuento_ =$this->rs[0][1];
		$this->dnc_porcentaje_iva_ =$this->rs[0][2];
		$this->dnc_porcentaje_ice_ =$this->rs[0][3];
		$this->dnc_porcentaje_irbpnr_ =$this->rs[0][4];
		$this->dnc_base_ice_ =$this->rs[0][5];
		$this->dnc_base_irbpnr_ =$this->rs[0][6];
	}
...
$modificado_dnc_valor_irbpnr_ = $this->dnc_valor_irbpnr_;
$modificado_dnc_total_ = $this->dnc_total_;
$this->nm_formatar_campos('dnc_producto_', 'dnc_cantidad_', 'dnc_precio_unitario_', 'dnc_descuento_', 'dnc_porcentaje_iva_', 'dnc_porcentaje_ice_', 'dnc_porcentaje_irbpnr_', 'dnc_base_ice_', 'dnc_base_irbpnr_', 'dnc_subtotal_', 'dnc_valor_ice_', 'dnc_base_iva_', 'dnc_valor_iva_', 'dnc_valor_irbpnr_', 'dnc_total_');
$this->nmgp_refresh_fields = array();
if ($original_dnc_producto_ !== $modificado_dnc_producto_ || isset($this->nmgp_cmp_readonly['dnc_producto_']) || (isset($bFlagRead_dnc_producto_) && $bFlagRead_dnc_producto_))
{
    $this->nmgp_refresh_fields[] = 'dnc_producto_';
...
if($this->dnc_producto_ <>''){
	...
	$check_sql = "SELECT iva_porcentaje FROM sri_tarifa_iva WHERE iva_codigo=".$this->dnc_porcentaje_iva_ ;
	...
	$check_sql = "SELECT ice_tarifa_especifica FROM sri_tarifa_ice WHERE ice_id=".$this->dnc_porcentaje_ice_ ;
	...
	if (isset($this->rs[0][0])){
		$var_porcentaje_ice=$this->rs[0][0];
	}
	
	$check_sql = "SELECT irbpnr_tarifa_especifica FROM sri_tarifa_irbpnr WHERE irbpnr_codigo='".$this->dnc_porcentaje_irbpnr_ ."'";
	...
	if (isset($this->rs[0][0])){
		$var_porcentaje_irbpnr=$this->rs[0][0];
	}
	
	
	
	$this->dnc_subtotal_ =round($this->dnc_cantidad_ *($this->dnc_precio_unitario_ -$this->dnc_descuento_ ),2);

	if($this->dnc_base_ice_ <>''and $this->dnc_base_ice_ <>0 and $var_porcentaje_ice<>0 ){
		$this->dnc_valor_ice_ =round($this->dnc_cantidad_ *$this->dnc_base_ice_ *$var_porcentaje_ice,2);
		...
		$this->dnc_base_iva_ =round($this->dnc_subtotal_ ,2);
		$this->dnc_valor_iva_ =round($this->dnc_base_iva_ *$var_porcentaje_iva/100,2);
		$this->dnc_base_ice_ =0;  
		$this->dnc_valor_ice_ =0;
	}
	if($var_porcentaje_irbpnr<>0 and $this->dnc_base_irbpnr_ <>0){
		$this->dnc_valor_irbpnr_ =round($this->dnc_cantidad_ *$this->dnc_base_irbpnr_ *$var_porcentaje_irbpnr,2);
	}else{
		$this->dnc_valor_irbpnr_ =0;
	}
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
   ...
   {
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['table_refresh'] = true;
   ...
   else
   {
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['csrf_token'];
    }
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function Form_lookup_dnc_producto_()
   {
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['Lookup_dnc_producto_']))
{
...
else
{
   ...
   function Form_lookup_dnc_porcentaje_iva_()
   {
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['Lookup_dnc_porcentaje_iva_']))
{
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['where_filter_form'] . " and ((dnc_cantidad>0
...
and dnc_nota_credito=" . $_SESSION['var_nota_credito'] . ") and (" . $comando . ")";
      ...
      $qt_geral_reg_form_del_detalle_nota_credito = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['total'] = $qt_geral_reg_form_del_detalle_nota_credito;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_del_detalle_nota_credito_pack_ajax_response();
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_del_detalle_nota_credito_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_del_detalle_nota_credito_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['masterValue']))
{
...
<?php
  exit;
    ...
    function sc_master_value($sIndex, $sValue)
    {
        ...
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['masterValue'] = $this->NM_ajax_info['masterValue'];
    } // sc_master_value
    ...
    function getButtonIds($buttonName) {
        switch ($buttonName) {
            ...
            case "exit":
                ...
                break;
            case "borrar_todo":
                return array("sc_borrar_todo_top.", "sc_borrar_todo_top.");
                break;
            case "birpara":
                return array("brec_b");
                break;
    ...
    function displayAppHeader()
    {
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['mostra_cab']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['mostra_cab'] == "N") {
            return;
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_credito']['ordem_ord'] == " desc") {
