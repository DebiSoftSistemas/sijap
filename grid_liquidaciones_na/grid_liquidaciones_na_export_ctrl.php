<?php
@session_start() ;
$_SESSION['scriptcase']['grid_liquidaciones_na']['sc_process_barr'] = true;
require_once('../grid_liquidaciones_na/index.php');
unset($_SESSION['scriptcase']['grid_liquidaciones_na']['sc_process_barr']);
$ExportCtrl = new grid_liquidaciones_na_export_control;
$ExportCtrl->Export_barr();

class grid_liquidaciones_na_export_control
{
