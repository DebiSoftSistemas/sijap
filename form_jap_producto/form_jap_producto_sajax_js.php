  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_jap_producto" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_jap_producto_form();
	}
...
?>
  ...
  // ---------- Validate pro_codigo
  function do_ajax_form_jap_producto_validate_pro_codigo()
  {
    var nomeCampo_pro_codigo = "pro_codigo";
    var var_pro_codigo = scAjaxGetFieldText(nomeCampo_pro_codigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_producto_validate_pro_codigo(var_pro_codigo, var_script_case_init, do_ajax_form_jap_producto_validate_pro_codigo_cb);
  } // do_ajax_form_jap_producto_validate_pro_codigo

  function do_ajax_form_jap_producto_validate_pro_codigo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_producto_validate_pro_codigo_cb

  // ---------- Validate pro_descripcion
  function do_ajax_form_jap_producto_validate_pro_descripcion()
  {
    var nomeCampo_pro_descripcion = "pro_descripcion";
    var var_pro_descripcion = scAjaxGetFieldHidden(nomeCampo_pro_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_producto_validate_pro_descripcion(var_pro_descripcion, var_script_case_init, do_ajax_form_jap_producto_validate_pro_descripcion_cb);
  } // do_ajax_form_jap_producto_validate_pro_descripcion

  function do_ajax_form_jap_producto_validate_pro_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_producto_validate_pro_descripcion_cb

  // ---------- Validate pro_estado
  function do_ajax_form_jap_producto_validate_pro_estado()
  {
    var nomeCampo_pro_estado = "pro_estado";
    var var_pro_estado = scAjaxGetFieldHidden(nomeCampo_pro_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_producto_validate_pro_estado(var_pro_estado, var_script_case_init, do_ajax_form_jap_producto_validate_pro_estado_cb);
  } // do_ajax_form_jap_producto_validate_pro_estado

  function do_ajax_form_jap_producto_validate_pro_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_producto_validate_pro_estado_cb

  // ---------- Validate funciones
  function do_ajax_form_jap_producto_validate_funciones()
  {
    var nomeCampo_funciones = "funciones";
    var var_funciones = scAjaxGetFieldText(nomeCampo_funciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_producto_validate_funciones(var_funciones, var_script_case_init, do_ajax_form_jap_producto_validate_funciones_cb);
  } // do_ajax_form_jap_producto_validate_funciones

  function do_ajax_form_jap_producto_validate_funciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_producto_validate_funciones_cb

  // ---------- Validate formulas
  function do_ajax_form_jap_producto_validate_formulas()
  {
    var nomeCampo_formulas = "formulas";
    var var_formulas = scAjaxGetFieldText(nomeCampo_formulas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_producto_validate_formulas(var_formulas, var_script_case_init, do_ajax_form_jap_producto_validate_formulas_cb);
  } // do_ajax_form_jap_producto_validate_formulas

  function do_ajax_form_jap_producto_validate_formulas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_producto_validate_formulas_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_jap_producto_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_jap_producto_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_jap_producto_submit_form(var_pro_codigo, var_pro_descripcion, var_pro_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_jap_producto_submit_form_cb);
  } // do_ajax_form_jap_producto_submit_form

  function do_ajax_form_jap_producto_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_jap_producto_submit_form_cb_after_alert);
  } // do_ajax_form_jap_producto_submit_form_cb
  function do_ajax_form_jap_producto_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_jap_producto_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["grid_v_jap_funciones_disponibles"] = "off";
  scStatusDetail["form_jap_formulas"] = "off";

  function do_ajax_form_jap_producto_navigate_form()
  {
    perform_ajax_form_jap_producto_navigate_form();
  }

  function perform_ajax_form_jap_producto_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scStatusDetail["form_jap_formulas"] = "on";
    x_ajax_form_jap_producto_navigate_form(var_pro_codigo, var_pro_empresa, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jap_producto_navigate_form_cb);
  } // do_ajax_form_jap_producto_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_producto']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_jap_producto_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_jap_formulas"] && "nmsc_iframe_liga_form_jap_formulas" != scMasterDetailIframe["nmsc_iframe_liga_form_jap_formulas"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_jap_formulas"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_jap_formulas').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_jap_formulas').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_jap_formulas').style.display = "none";
    }
    scAjaxSetBtnVars();
    sc_change_tabs(true, 'hidden_bloco_1', 'id_tabs_1_1');
    sc_change_tabs(false, 'hidden_bloco_2', 'id_tabs_1_2');
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_jap_producto_navigate_form_cb_after_alert);
  } // do_ajax_form_jap_producto_navigate_form_cb
  function do_ajax_form_jap_producto_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_jap_producto_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_jap_producto_navigate_form_cb_after_alert

  function sc_hide_form_jap_producto_form()
  {
  ...
  {
    if ("off" == scStatusDetail["grid_v_jap_funciones_disponibles"] && "off" == scStatusDetail["form_jap_formulas"])
    {
      return true;
    }
    return false;
