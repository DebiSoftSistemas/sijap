  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_jap_producto_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_jap_producto_mob_form();
	}
...
?>
  ...
  // ---------- Validate pro_codigo
  function do_ajax_form_jap_producto_mob_validate_pro_codigo()
  {
    var nomeCampo_pro_codigo = "pro_codigo";
    var var_pro_codigo = scAjaxGetFieldText(nomeCampo_pro_codigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_producto_mob_validate_pro_codigo(var_pro_codigo, var_script_case_init, do_ajax_form_jap_producto_mob_validate_pro_codigo_cb);
  } // do_ajax_form_jap_producto_mob_validate_pro_codigo

  function do_ajax_form_jap_producto_mob_validate_pro_codigo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_producto_mob_validate_pro_codigo_cb

  // ---------- Validate pro_descripcion
  function do_ajax_form_jap_producto_mob_validate_pro_descripcion()
  {
    var nomeCampo_pro_descripcion = "pro_descripcion";
    var var_pro_descripcion = scAjaxGetFieldHidden(nomeCampo_pro_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_producto_mob_validate_pro_descripcion(var_pro_descripcion, var_script_case_init, do_ajax_form_jap_producto_mob_validate_pro_descripcion_cb);
  } // do_ajax_form_jap_producto_mob_validate_pro_descripcion

  function do_ajax_form_jap_producto_mob_validate_pro_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_producto_mob_validate_pro_descripcion_cb

  // ---------- Validate pro_estado
  function do_ajax_form_jap_producto_mob_validate_pro_estado()
  {
    var nomeCampo_pro_estado = "pro_estado";
    var var_pro_estado = scAjaxGetFieldHidden(nomeCampo_pro_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_producto_mob_validate_pro_estado(var_pro_estado, var_script_case_init, do_ajax_form_jap_producto_mob_validate_pro_estado_cb);
  } // do_ajax_form_jap_producto_mob_validate_pro_estado

  function do_ajax_form_jap_producto_mob_validate_pro_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_producto_mob_validate_pro_estado_cb

  // ---------- Validate funciones
  function do_ajax_form_jap_producto_mob_validate_funciones()
  {
    var nomeCampo_funciones = "funciones";
    var var_funciones = scAjaxGetFieldText(nomeCampo_funciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_producto_mob_validate_funciones(var_funciones, var_script_case_init, do_ajax_form_jap_producto_mob_validate_funciones_cb);
  } // do_ajax_form_jap_producto_mob_validate_funciones

  function do_ajax_form_jap_producto_mob_validate_funciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_producto_mob_validate_funciones_cb

  // ---------- Validate formulas
  function do_ajax_form_jap_producto_mob_validate_formulas()
  {
    var nomeCampo_formulas = "formulas";
    var var_formulas = scAjaxGetFieldText(nomeCampo_formulas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_producto_mob_validate_formulas(var_formulas, var_script_case_init, do_ajax_form_jap_producto_mob_validate_formulas_cb);
  } // do_ajax_form_jap_producto_mob_validate_formulas

  function do_ajax_form_jap_producto_mob_validate_formulas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "formulas";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_producto_mob_validate_formulas_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_jap_producto_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_jap_producto_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_pro_codigo = scAjaxGetFieldText("pro_codigo");
    var var_pro_descripcion = scAjaxGetFieldHidden("pro_descripcion");
    var var_pro_estado = scAjaxGetFieldHidden("pro_estado");
    ...
    scAjaxProcOn();
    x_ajax_form_jap_producto_mob_submit_form(var_pro_codigo, var_pro_descripcion, var_pro_estado, var_pro_empresa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_jap_producto_mob_submit_form_cb);
  } // do_ajax_form_jap_producto_mob_submit_form

  function do_ajax_form_jap_producto_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("formulas");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_jap_producto_mob_submit_form_cb_after_alert);
  } // do_ajax_form_jap_producto_mob_submit_form_cb
  function do_ajax_form_jap_producto_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_jap_producto_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["grid_v_jap_funciones_disponibles"] = "off";
  scStatusDetail["form_jap_formulas_mob"] = "off";

  function do_ajax_form_jap_producto_mob_navigate_form()
  {
    perform_ajax_form_jap_producto_mob_navigate_form();
  }

  function perform_ajax_form_jap_producto_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["grid_v_jap_funciones_disponibles"] = "on";
    scStatusDetail["form_jap_formulas_mob"] = "on";
    x_ajax_form_jap_producto_mob_navigate_form(var_pro_codigo, var_pro_empresa, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jap_producto_mob_navigate_form_cb);
  } // do_ajax_form_jap_producto_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_producto_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_jap_producto_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_grid_v_jap_funciones_disponibles"] && "nmsc_iframe_liga_grid_v_jap_funciones_disponibles" != scMasterDetailIframe["nmsc_iframe_liga_grid_v_jap_funciones_disponibles"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_grid_v_jap_funciones_disponibles"]);
    }
    else {
        if (oResp["navSummary"].reg_tot != 0) {
            document.getElementById('nmsc_iframe_liga_grid_v_jap_funciones_disponibles').contentWindow.nm_move('apl_detalhe', true);
        }
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_jap_formulas_mob"] && "nmsc_iframe_liga_form_jap_formulas_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_jap_formulas_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_jap_formulas_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_jap_formulas_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_jap_formulas_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_jap_formulas_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_jap_producto_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_jap_producto_mob_navigate_form_cb
  function do_ajax_form_jap_producto_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_jap_producto_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_jap_producto_mob_navigate_form_cb_after_alert

  function sc_hide_form_jap_producto_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["grid_v_jap_funciones_disponibles"] && "off" == scStatusDetail["form_jap_formulas_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "pro_codigo";
  ajax_field_list[1] = "pro_descripcion";
  ajax_field_list[2] = "pro_estado";
  ajax_field_list[3] = "funciones";
  ajax_field_list[4] = "formulas";
  ...
  var ajax_error_list = {
    ...
    "pro_descripcion": {"label": "<?php echo $this->Ini->Nm_lang['lang_producto'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "funciones": {"label": "<?php echo $this->Ini->Nm_lang['lang_funciones_disponibles'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "formulas": {"label": "<?php echo $this->Ini->Nm_lang['lang_formulas'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["formulas"][1] = "formulas";
  ...
  var ajax_field_id = {
    ...
    "formulas": new Array("hidden_field_label_formulas", "hidden_field_data_formulas")
  };
