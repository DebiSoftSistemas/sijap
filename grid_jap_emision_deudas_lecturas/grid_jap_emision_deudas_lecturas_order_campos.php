<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_jap_emision_deudas_lecturas']['glo_nm_path_imag_temp'] . "/sc_apl_default_SIJAP.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_jap_emision_deudas_lecturas_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_jap_emision_deudas_lecturas_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_jap_emision_deudas_lecturas']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_jap_emision_deudas_lecturas']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['jap_escenario_esc_id'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['jap_escenario_esc_id'] = "jap_escenario_esc_id";
   }
   else
   {
       $tab_def_campos['jap_escenario_esc_id'] = "jap_escenario.esc_id";
   }
   $tab_labels["jap_escenario_esc_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_emision_deudas_lecturas']['labels']["jap_escenario_esc_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_emision_deudas_lecturas']['labels']["jap_escenario_esc_id"] : "" . $this->Nm_lang['lang_id'] . "";
   $tab_ger_campos['jap_escenario_esc_tipo_deuda'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['jap_escenario_esc_tipo_deuda'] = "jap_escenario_esc_tipo_deuda";
   }
   else
   {
       $tab_def_campos['jap_escenario_esc_tipo_deuda'] = "jap_escenario.esc_tipo_deuda";
   }
   $tab_labels["jap_escenario_esc_tipo_deuda"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_emision_deudas_lecturas']['labels']["jap_escenario_esc_tipo_deuda"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_emision_deudas_lecturas']['labels']["jap_escenario_esc_tipo_deuda"] : "" . $this->Nm_lang['lang_tipo_deuda'] . "";
   $tab_ger_campos['jap_escenario_esc_mes_periodo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['jap_escenario_esc_mes_periodo'] = "jap_escenario_esc_mes_periodo";
   }
   else
   {
       $tab_def_campos['jap_escenario_esc_mes_periodo'] = "jap_escenario.esc_mes_periodo";
   }
   $tab_labels["jap_escenario_esc_mes_periodo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_emision_deudas_lecturas']['labels']["jap_escenario_esc_mes_periodo"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_emision_deudas_lecturas']['labels']["jap_escenario_esc_mes_periodo"] : "" . $this->Nm_lang['lang_srch_mnth'] . "";
   $tab_ger_campos['jap_escenario_esc_anio_periodo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['jap_escenario_esc_anio_periodo'] = "jap_escenario_esc_anio_periodo";
   }
   else
   {
       $tab_def_campos['jap_escenario_esc_anio_periodo'] = "jap_escenario.esc_anio_periodo";
   }
   $tab_labels["jap_escenario_esc_anio_periodo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_emision_deudas_lecturas']['labels']["jap_escenario_esc_anio_periodo"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_emision_deudas_lecturas']['labels']["jap_escenario_esc_anio_periodo"] : "" . $this->Nm_lang['lang_srch_year'] . "";
   $tab_ger_campos['jap_rutas_medicion_rut_nombre'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['jap_rutas_medicion_rut_nombre'] = "jap_rutas_medicion_rut_nombre";
   }
   else
   {
       $tab_def_campos['jap_rutas_medicion_rut_nombre'] = "jap_rutas_medicion.rut_nombre";
   }
   $tab_labels["jap_rutas_medicion_rut_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_emision_deudas_lecturas']['labels']["jap_rutas_medicion_rut_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_emision_deudas_lecturas']['labels']["jap_rutas_medicion_rut_nombre"] : "" . $this->Nm_lang['lang_ruta'] . "";
   $tab_ger_campos['jap_escenario_esc_total'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['jap_escenario_esc_total'] = "jap_escenario_esc_total";
   }
   else
   {
       $tab_def_campos['jap_escenario_esc_total'] = "jap_escenario.esc_total";
   }
   $tab_labels["jap_escenario_esc_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_emision_deudas_lecturas']['labels']["jap_escenario_esc_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_emision_deudas_lecturas']['labels']["jap_escenario_esc_total"] : "" . $this->Nm_lang['lang_total'] . "";
   $tab_ger_campos['jap_escenario_esc_estado'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['jap_escenario_esc_estado'] = "jap_escenario_esc_estado";
   }
   else
   {
       $tab_def_campos['jap_escenario_esc_estado'] = "jap_escenario.esc_estado";
   }
   $tab_labels["jap_escenario_esc_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_emision_deudas_lecturas']['labels']["jap_escenario_esc_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_emision_deudas_lecturas']['labels']["jap_escenario_esc_estado"] : "" . $this->Nm_lang['lang_estado'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_jap_emision_deudas_lecturas']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_jap_emision_deudas_lecturas']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_jap_emision_deudas_lecturas']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_jap_emision_deudas_lecturas']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_jap_emision_deudas_lecturas']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_jap_emision_deudas_lecturas']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_jap_emision_deudas_lecturas']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_jap_emision_deudas_lecturas']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_jap_emision_deudas_lecturas']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_jap_emision_deudas_lecturas']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_jap_emision_deudas_lecturas']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_jap_emision_deudas_lecturas']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_emision_deudas'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_jap_emision_deudas_lecturas_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_jap_emision_deudas_lecturas']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_jap_emision_deudas_lecturas']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_jap_emision_deudas_lecturas']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_jap_emision_deudas_lecturas']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_jap_emision_deudas_lecturas']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
