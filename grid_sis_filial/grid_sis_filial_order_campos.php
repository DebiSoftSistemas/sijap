<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_sis_filial']['glo_nm_path_imag_temp'] . "/sc_apl_default_debi_doc_electronicos.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_sis_filial_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_sis_filial_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_sis_filial']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_sis_filial']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['fil_empresa'] = "on";
   $tab_def_campos['fil_empresa'] = "fil_empresa";
   $tab_labels["fil_empresa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sis_filial']['labels']["fil_empresa"])) ? $_SESSION['sc_session'][$sc_init]['grid_sis_filial']['labels']["fil_empresa"] : "" . $this->Nm_lang['lang_empresa'] . "";
   $tab_ger_campos['fil_nombre'] = "on";
   $tab_def_campos['fil_nombre'] = "fil_nombre";
   $tab_labels["fil_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sis_filial']['labels']["fil_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_sis_filial']['labels']["fil_nombre"] : "" . $this->Nm_lang['lang_filial'] . "";
   $tab_ger_campos['fil_ruc'] = "on";
   $tab_def_campos['fil_ruc'] = "fil_ruc";
   $tab_labels["fil_ruc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sis_filial']['labels']["fil_ruc"])) ? $_SESSION['sc_session'][$sc_init]['grid_sis_filial']['labels']["fil_ruc"] : "" . $this->Nm_lang['lang_ruc'] . "";
   $tab_ger_campos['fil_email'] = "on";
   $tab_def_campos['fil_email'] = "fil_email";
   $tab_labels["fil_email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sis_filial']['labels']["fil_email"])) ? $_SESSION['sc_session'][$sc_init]['grid_sis_filial']['labels']["fil_email"] : "" . $this->Nm_lang['lang_email'] . "";
   $tab_ger_campos['fil_representante'] = "on";
   $tab_def_campos['fil_representante'] = "fil_representante";
   $tab_labels["fil_representante"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sis_filial']['labels']["fil_representante"])) ? $_SESSION['sc_session'][$sc_init]['grid_sis_filial']['labels']["fil_representante"] : "" . $this->Nm_lang['lang_representante'] . "";
   $tab_ger_campos['fil_contador'] = "on";
   $tab_def_campos['fil_contador'] = "fil_contador";
   $tab_labels["fil_contador"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sis_filial']['labels']["fil_contador"])) ? $_SESSION['sc_session'][$sc_init]['grid_sis_filial']['labels']["fil_contador"] : "" . $this->Nm_lang['lang_contador'] . "";
   $tab_ger_campos['fil_actividad_economica'] = "on";
   $tab_def_campos['fil_actividad_economica'] = "fil_actividad_economica";
   $tab_labels["fil_actividad_economica"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sis_filial']['labels']["fil_actividad_economica"])) ? $_SESSION['sc_session'][$sc_init]['grid_sis_filial']['labels']["fil_actividad_economica"] : "" . $this->Nm_lang['lang_actividad_economica'] . "";
   $tab_ger_campos['fil_estado'] = "on";
   $tab_def_campos['fil_estado'] = "fil_estado";
   $tab_labels["fil_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sis_filial']['labels']["fil_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_sis_filial']['labels']["fil_estado"] : "" . $this->Nm_lang['lang_estado'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_sis_filial']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_sis_filial']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_sis_filial']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_sis_filial']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_sis_filial']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_sis_filial']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_sis_filial']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_sis_filial']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_sis_filial']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_sis_filial']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_sis_filial']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_sis_filial']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_configuracion'] ?>-<?php echo $this->Nm_lang['lang_filial'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_sis_filial_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_sis_filial']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_sis_filial']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_sis_filial']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_sis_filial']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_sis_filial']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
