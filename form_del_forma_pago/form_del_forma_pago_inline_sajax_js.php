...
?>
  ...
  function do_ajax_form_del_forma_pago_inline_validate_fp_tesoreria_debi_()
  {
    var nomeCampo_fp_tesoreria_debi_ = "fp_tesoreria_debi_";
    var var_fp_tesoreria_debi_ = scAjaxGetFieldSelect(nomeCampo_fp_tesoreria_debi_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_inline_validate_fp_tesoreria_debi_(var_fp_tesoreria_debi_, var_script_case_init, do_ajax_form_del_forma_pago_inline_validate_fp_tesoreria_debi__cb);
  } // do_ajax_form_del_forma_pago_inline_validate_fp_tesoreria_debi_

  function do_ajax_form_del_forma_pago_inline_validate_fp_tesoreria_debi__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_inline_validate_fp_tesoreria_debi__cb

  // ---------- Validate fp_producto_pago_
  function do_ajax_form_del_forma_pago_inline_validate_fp_producto_pago_()
  {
    var nomeCampo_fp_producto_pago_ = "fp_producto_pago_";
    var var_fp_producto_pago_ = scAjaxGetFieldSelect(nomeCampo_fp_producto_pago_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_inline_validate_fp_producto_pago_(var_fp_producto_pago_, var_script_case_init, do_ajax_form_del_forma_pago_inline_validate_fp_producto_pago__cb);
  } // do_ajax_form_del_forma_pago_inline_validate_fp_producto_pago_

  function do_ajax_form_del_forma_pago_inline_validate_fp_producto_pago__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_inline_validate_fp_producto_pago__cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_del_forma_pago_inline_submit_form()
  {
    ...
    var var_fp_tesoreria_debi_ = scAjaxGetFieldSelect("fp_tesoreria_debi_");
    var var_fp_producto_pago_ = scAjaxGetFieldSelect("fp_producto_pago_");
    ...
    scAjaxProcOn();
    x_ajax_form_del_forma_pago_inline_submit_form(var_fp_id_, var_fp_empresa_, var_fp_descripcion_, var_fp_sri_, var_fp_tipo_, var_fp_compra_venta_, var_fp_tesoreria_debi_, var_fp_producto_pago_, var_fp_estado_, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_forma_pago_inline_submit_form_cb);
  ...
  function do_ajax_form_del_forma_pago_inline_submit_form_cb(sResp)
  {
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("fp_tesoreria_debi_");
      scAjaxHideErrorDisplay("fp_producto_pago_");
...
?>
  ...
  ajax_field_list[6] = "fp_tesoreria_debi_";
  ajax_field_list[7] = "fp_producto_pago_";
  ajax_field_list[8] = "fp_estado_";
  ...
  var ajax_error_list = {
    ...
    "fp_tesoreria_debi_": {"label": "<?php echo $this->Ini->Nm_lang['lang_tesoreria'] ?> DEBI", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fp_producto_pago_": {"label": "<?php echo $this->Ini->Nm_lang['lang_producto'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["fp_tesoreria_debi_"][1] = "fp_tesoreria_debi_";
  ajax_field_mult["fp_producto_pago_"][1] = "fp_producto_pago_";
  ...
  var ajax_field_id = {
    ...
    "fp_tesoreria_debi_": new Array("hidden_field_label_fp_tesoreria_debi_", "hidden_field_data_fp_tesoreria_debi_"),
    "fp_producto_pago_": new Array("hidden_field_label_fp_producto_pago_", "hidden_field_data_fp_producto_pago_"),
  ...
  var ajax_read_only = {
    ...
    "fp_tesoreria_debi_": "off",
    "fp_producto_pago_": "off",
    "fp_estado_": "off"
  };
