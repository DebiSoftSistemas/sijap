...
?>
  ...
  // ---------- Validate fp_tesoreria_debi_
  function do_ajax_form_del_forma_pago_validate_fp_tesoreria_debi_(iNumLinha)
  {
    var nomeCampo_fp_tesoreria_debi_ = "fp_tesoreria_debi_" + iNumLinha;
    var var_fp_tesoreria_debi_ = scAjaxGetFieldSelect(nomeCampo_fp_tesoreria_debi_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_validate_fp_tesoreria_debi_(var_fp_tesoreria_debi_, iNumLinha, var_script_case_init, do_ajax_form_del_forma_pago_validate_fp_tesoreria_debi__cb);
  } // do_ajax_form_del_forma_pago_validate_fp_tesoreria_debi_

  function do_ajax_form_del_forma_pago_validate_fp_tesoreria_debi__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fp_tesoreria_debi_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fp_tesoreria_debi_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fp_tesoreria_debi_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fp_tesoreria_debi_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_validate_fp_tesoreria_debi__cb

  // ---------- Validate fp_producto_pago_
  function do_ajax_form_del_forma_pago_validate_fp_producto_pago_(iNumLinha)
  {
    var nomeCampo_fp_producto_pago_ = "fp_producto_pago_" + iNumLinha;
    var var_fp_producto_pago_ = scAjaxGetFieldSelect(nomeCampo_fp_producto_pago_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_validate_fp_producto_pago_(var_fp_producto_pago_, iNumLinha, var_script_case_init, do_ajax_form_del_forma_pago_validate_fp_producto_pago__cb);
  } // do_ajax_form_del_forma_pago_validate_fp_producto_pago_

  function do_ajax_form_del_forma_pago_validate_fp_producto_pago__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fp_producto_pago_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fp_producto_pago_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fp_producto_pago_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fp_producto_pago_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_validate_fp_producto_pago__cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_del_forma_pago_submit_form(iNumLinha, indexTR)
  {
    ...
    var var_fp_tesoreria_debi_ = scAjaxGetFieldSelect("fp_tesoreria_debi_" + iNumLinha);
    var var_fp_producto_pago_ = scAjaxGetFieldSelect("fp_producto_pago_" + iNumLinha);
...
?>
    x_ajax_form_del_forma_pago_submit_form(var_fp_id_, var_fp_empresa_, var_fp_descripcion_, var_fp_sri_, var_fp_tipo_, var_fp_compra_venta_, var_fp_tesoreria_debi_, var_fp_producto_pago_, var_fp_estado_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_forma_pago_submit_form_cb);
...
?>
      ...
      scAjaxHideErrorDisplay("fp_tesoreria_debi_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("fp_producto_pago_" + sc_num_ult_line);
...
?>
  ...
  function perform_ajax_form_del_forma_pago_navigate_form()
  {
    ...
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("fp_tesoreria_debi_" + iNavForm);
      scAjaxHideErrorDisplay("fp_producto_pago_" + iNavForm);
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fp_tesoreria_debi_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fp_producto_pago_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["fp_tesoreria_debi_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tesoreria'] ?> DEBI<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["fp_producto_pago_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_producto'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["fp_tesoreria_debi_"][iNumLinha] = "fp_tesoreria_debi_" + iNumLinha;
    ajax_field_mult["fp_producto_pago_"][iNumLinha] = "fp_producto_pago_" + iNumLinha;
    ...
    ajax_field_id["fp_tesoreria_debi_" + iNumLinha] = new Array("hidden_field_label_fp_tesoreria_debi_", "hidden_field_data_fp_tesoreria_debi_" + iNumLinha);
    ajax_field_id["fp_producto_pago_" + iNumLinha] = new Array("hidden_field_label_fp_producto_pago_", "hidden_field_data_fp_producto_pago_" + iNumLinha);
    ...
    ajax_error_count["fp_tesoreria_debi_" + iNumLinha] = "off";
    ajax_error_count["fp_producto_pago_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["fp_tesoreria_debi_" + iNumLinha] = "off";
    ajax_read_only["fp_producto_pago_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["fp_tesoreria_debi_" + iNumLinha] = "on";
    ajax_read_only["fp_producto_pago_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["fp_tesoreria_debi_" + iNumLinha] = null;
    ajax_error_list["fp_producto_pago_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    ...
    "fp_tesoreria_debi_": new Array(),
    "fp_producto_pago_": new Array(),
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["fp_tesoreria_debi_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fp_tesoreria_debi_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fp_tesoreria_debi_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fp_tesoreria_debi_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fp_tesoreria_debi_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["fp_producto_pago_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fp_producto_pago_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fp_producto_pago_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fp_producto_pago_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fp_producto_pago_" + iNumLinha]["onfocus"] = new Array();
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fp_tesoreria_debi_'])) ? $this->nmgp_cmp_readonly['fp_tesoreria_debi_'] : 'off';
?>
    scAjaxFieldRead("fp_tesoreria_debi_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fp_producto_pago_'])) ? $this->nmgp_cmp_readonly['fp_producto_pago_'] : 'off';
?>
    scAjaxFieldRead("fp_producto_pago_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("fp_tesoreria_debi_" + iSeq, "on");
    scAjaxFieldRead("fp_producto_pago_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["fp_id_" + iRow] || "on" == ajax_error_count["fp_empresa_" + iRow] || "on" == ajax_error_count["fp_descripcion_" + iRow] || "on" == ajax_error_count["fp_sri_" + iRow] || "on" == ajax_error_count["fp_tipo_" + iRow] || "on" == ajax_error_count["fp_compra_venta_" + iRow] || "on" == ajax_error_count["fp_tesoreria_debi_" + iRow] || "on" == ajax_error_count["fp_producto_pago_" + iRow] || "on" == ajax_error_count["fp_estado_" + iRow]))
    {
      ...
      $("#hidden_field_data_fp_tesoreria_debi_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_fp_producto_pago_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["fp_id_" + iRow] && "off" == ajax_error_count["fp_empresa_" + iRow] && "off" == ajax_error_count["fp_descripcion_" + iRow] && "off" == ajax_error_count["fp_sri_" + iRow] && "off" == ajax_error_count["fp_tipo_" + iRow] && "off" == ajax_error_count["fp_compra_venta_" + iRow] && "off" == ajax_error_count["fp_tesoreria_debi_" + iRow] && "off" == ajax_error_count["fp_producto_pago_" + iRow] && "off" == ajax_error_count["fp_estado_" + iRow]))
    {
      if (bErrorRow)
      {
        ...
        ajax_error_count["fp_tesoreria_debi_" + iRow] = "off";
        ajax_error_count["fp_producto_pago_" + iRow] = "off";
      ...
      $("#hidden_field_data_fp_tesoreria_debi_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_fp_producto_pago_" + iRow).removeClass("scFormErrorLine");
