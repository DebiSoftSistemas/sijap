<?php
@session_start() ;
$_SESSION['scriptcase']['grid_v_jap_contrato_danio']['sc_process_barr'] = true;
require_once('../grid_v_jap_contrato_danio/index.php');
unset($_SESSION['scriptcase']['grid_v_jap_contrato_danio']['sc_process_barr']);
$ExportCtrl = new grid_v_jap_contrato_danio_export_control;
$ExportCtrl->Export_barr();

class grid_v_jap_contrato_danio_export_control
{
