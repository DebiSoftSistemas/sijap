...
class grid_v_jap_contrato_danio_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_con_nombre = array();
...
SCEOT;
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_v_jap_contrato_danio']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_v_jap_contrato_danio']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['orig_pesq'] = "resumo";
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['where_resumo'] = "";
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              ...
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['arr_total']['con_nombre'] = $this->array_total_con_nombre;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['arr_total']['con_ruta'] = $this->array_total_con_ruta;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['json_use_label'])
       {
          $Lab_con_nombre = "con_nombre";
          $Lab_con_ruta = "con_ruta";
       }
       else
       {
       $Lab_con_nombre = "" . $this->Ini->Nm_lang['lang_nombre'] . "";
       $Lab_con_ruta = "" . $this->Ini->Nm_lang['lang_ruta'] . "";
       }
       $prep_field = array();
       $prep_field['con_nombre'] = $Lab_con_nombre;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_nombre'] = $Lab_con_nombre; 
       $prep_field['con_ruta'] = $Lab_con_ruta;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_ruta'] = $Lab_con_ruta; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_numero_contrato']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_numero_contrato'] = "" . $this->Ini->Nm_lang['lang_numero_contrato'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_nombre']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_nombre'] = "" . $this->Ini->Nm_lang['lang_nombre'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_cedula']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_cedula'] = "" . $this->Ini->Nm_lang['lang_lot_identificacion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_ruta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_ruta'] = "" . $this->Ini->Nm_lang['lang_ruta'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_numero_medidor']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_numero_medidor'] = "" . $this->Ini->Nm_lang['lang_numero_medidor'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_direccion_predio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_direccion_predio'] = "" . $this->Ini->Nm_lang['lang_direccion_predio'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_id'] = "Con Id"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_empresa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_empresa'] = "Con Empresa"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_propietario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_propietario'] = "Con Propietario"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_telefono']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_telefono'] = "Con Telefono"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_celular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_celular'] = "Con Celular"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_direccion_propietario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_direccion_propietario'] = "Con Direccion Propietario"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_correo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_correo'] = "Con Correo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_pais']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_pais'] = "Con Pais"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_provincia']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_provincia'] = "Con Provincia"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_canton']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_canton'] = "Con Canton"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_parroquia']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_parroquia'] = "Con Parroquia"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_toma_administrativa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_toma_administrativa'] = "Con Toma Administrativa"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_toma_operativa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_toma_operativa'] = "Con Toma Operativa"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_tipo_servicio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_tipo_servicio'] = "Con Tipo Servicio"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_condicion_contrato']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_condicion_contrato'] = "Con Condicion Contrato"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_usuario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_usuario'] = "Con Usuario"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_fecha']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_fecha'] = "Con Fecha"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_terminal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_terminal'] = "Con Terminal"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_estado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_estado'] = "Con Estado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_motivo_anulacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_motivo_anulacion'] = "Con Motivo Anulacion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_tipo_contrato']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_tipo_contrato'] = "Con Tipo Contrato"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_total_a_pagar']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_total_a_pagar'] = "Con Total A Pagar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_abono']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_abono'] = "Con Abono"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_plazo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_plazo'] = "Con Plazo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_fecha_instalacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_fecha_instalacion'] = "Con Fecha Instalacion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_observaciones']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_observaciones'] = "Con Observaciones"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_usuario_instala']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_usuario_instala'] = "Con Usuario Instala"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_maxima_lectura']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_maxima_lectura'] = "Con Maxima Lectura"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_lectura_actual']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_lectura_actual'] = "Con Lectura Actual"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_fecha_lectura']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_fecha_lectura'] = "Con Fecha Lectura"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_sino']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['con_sino'] = "Con Sino"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['rc_registra_danio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['labels']['rc_registra_danio'] = "Rc Registra Danio"; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['con_nombre']['alin'] = "''";
       $Arr_parms['con_nombre']['link'] = "S";
       $Arr_parms['con_ruta']['alin'] = "''";
       $Arr_parms['con_ruta']['link'] = "S";
       $Arr_parms['con_nombre']['fill'] = "true";
       $Arr_parms['con_nombre']['order'] = "label";
       $Arr_parms['con_nombre']['order_start'] = 'asc';
       $Arr_parms['con_nombre']['order_invert'] = 'false';
       $Arr_parms['con_nombre']['order_enabled'] = 'true';
       $Arr_parms['con_nombre']['order_datatype'] = 'varchar';
       $Arr_parms['con_nombre']['rating_function'] = '';
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['con_nombre'] = array(0 => 'con_nombre', 1 => '@aspass@');
       $prep_links_fl['con_ruta'] = array(0 => 'con_ruta', 1 => '');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_v_jap_contrato_danio@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_v_jap_contrato_danio_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_jap_contrato_danio_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_v_jap_contrato_danio_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_jap_contrato_danio_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_v_jap_contrato_danio/grid_v_jap_contrato_danio_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_v_jap_contrato_danio/grid_v_jap_contrato_danio_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_v_jap_contrato_danio&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid&nm_all_modules=grid&password=n&summary_export_columns=S&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + P)", "thickbox", "" . $this->Ini->path_link . "grid_v_jap_contrato_danio/grid_v_jap_contrato_danio_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid&nm_all_modules=grid&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
             $this->nm_btn_exist['groupby'][] = "sel_groupby_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_v_jap_contrato_danio/grid_v_jap_contrato_danio_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_v_jap_contrato_danio/grid_v_jap_contrato_danio_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + G)", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_v_jap_contrato_danio_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_v_jap_contrato_danio']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_v_jap_contrato_danio']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_v_jap_contrato_danio_config_pivot.php?nome_apl=grid_v_jap_contrato_danio&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"grid_v_jap_contrato_danio_iframe.php\";\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_jap_contrato_danio_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_v_jap_contrato_danio/grid_v_jap_contrato_danio_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
   ...
   //---- 
   function adiciona_registro($quebra_con_nombre, $quebra_con_ruta, $quebra_con_nombre_orig, $quebra_con_ruta_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_contrato_danio']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->con_numero_contrato = $rs_res->fields[0] ;  
            $this->con_nombre = $rs_res->fields[1] ;  
            $this->con_cedula = $rs_res->fields[2] ;  
            $this->con_ruta = $rs_res->fields[3] ;  
            $this->con_numero_medidor = $rs_res->fields[4] ;  
            $this->con_direccion_predio = $rs_res->fields[5] ;  
            $this->con_id = $rs_res->fields[6] ;  
            $this->con_empresa = $rs_res->fields[7] ;  
            $this->con_propietario = $rs_res->fields[8] ;  
            $this->con_telefono = $rs_res->fields[9] ;  
            $this->con_nombre_orig = $this->con_nombre;
            $this->con_ruta_orig = $this->con_ruta;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->con_nombre, $this->con_ruta, $this->con_nombre_orig,  $this->con_ruta_orig);
            }
   }
//
