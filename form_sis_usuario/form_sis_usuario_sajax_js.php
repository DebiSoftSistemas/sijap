  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_usuario" == sTestField)
        {
...
?>
  ...
  // ---------- Validate usu_filial
  function do_ajax_form_sis_usuario_validate_usu_filial()
  {
    var nomeCampo_usu_filial = "usu_filial";
    var var_usu_filial = scAjaxGetFieldSelect(nomeCampo_usu_filial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_usuario_validate_usu_filial(var_usu_filial, var_script_case_init, do_ajax_form_sis_usuario_validate_usu_filial_cb);
  } // do_ajax_form_sis_usuario_validate_usu_filial

  function do_ajax_form_sis_usuario_validate_usu_filial_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_usuario_validate_usu_filial_cb

  // ---------- Validate usu_usuario
  function do_ajax_form_sis_usuario_validate_usu_usuario()
  {
    var nomeCampo_usu_usuario = "usu_usuario";
    var var_usu_usuario = scAjaxGetFieldText(nomeCampo_usu_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_usuario_validate_usu_usuario(var_usu_usuario, var_script_case_init, do_ajax_form_sis_usuario_validate_usu_usuario_cb);
  } // do_ajax_form_sis_usuario_validate_usu_usuario

  function do_ajax_form_sis_usuario_validate_usu_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_usuario_validate_usu_usuario_cb

  // ---------- Validate usu_nombre
  function do_ajax_form_sis_usuario_validate_usu_nombre()
  {
    var nomeCampo_usu_nombre = "usu_nombre";
    var var_usu_nombre = scAjaxGetFieldText(nomeCampo_usu_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_usuario_validate_usu_nombre(var_usu_nombre, var_script_case_init, do_ajax_form_sis_usuario_validate_usu_nombre_cb);
  } // do_ajax_form_sis_usuario_validate_usu_nombre

  function do_ajax_form_sis_usuario_validate_usu_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_usuario_validate_usu_nombre_cb

  // ---------- Validate usu_cedula
  function do_ajax_form_sis_usuario_validate_usu_cedula()
  {
    var nomeCampo_usu_cedula = "usu_cedula";
    var var_usu_cedula = scAjaxGetFieldText(nomeCampo_usu_cedula);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_usuario_validate_usu_cedula(var_usu_cedula, var_script_case_init, do_ajax_form_sis_usuario_validate_usu_cedula_cb);
  } // do_ajax_form_sis_usuario_validate_usu_cedula

  function do_ajax_form_sis_usuario_validate_usu_cedula_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_usuario_validate_usu_cedula_cb

  // ---------- Validate usu_email
  function do_ajax_form_sis_usuario_validate_usu_email()
  {
    var nomeCampo_usu_email = "usu_email";
    var var_usu_email = scAjaxGetFieldText(nomeCampo_usu_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_usuario_validate_usu_email(var_usu_email, var_script_case_init, do_ajax_form_sis_usuario_validate_usu_email_cb);
  } // do_ajax_form_sis_usuario_validate_usu_email

  function do_ajax_form_sis_usuario_validate_usu_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_usuario_validate_usu_email_cb

  // ---------- Validate usu_super_administrador
  function do_ajax_form_sis_usuario_validate_usu_super_administrador()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_usuario_validate_usu_super_administrador(var_usu_super_administrador, var_script_case_init, do_ajax_form_sis_usuario_validate_usu_super_administrador_cb);
  } // do_ajax_form_sis_usuario_validate_usu_super_administrador

  function do_ajax_form_sis_usuario_validate_usu_super_administrador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_usuario_validate_usu_super_administrador_cb

  // ---------- Validate usu_estado
  function do_ajax_form_sis_usuario_validate_usu_estado()
  {
    var nomeCampo_usu_estado = "usu_estado";
    var var_usu_estado = scAjaxGetFieldSelect(nomeCampo_usu_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_usuario_validate_usu_estado(var_usu_estado, var_script_case_init, do_ajax_form_sis_usuario_validate_usu_estado_cb);
  } // do_ajax_form_sis_usuario_validate_usu_estado

  function do_ajax_form_sis_usuario_validate_usu_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_usuario_validate_usu_estado_cb

  // ---------- Validate usu_env_contrasenia
  function do_ajax_form_sis_usuario_validate_usu_env_contrasenia()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_usuario_validate_usu_env_contrasenia(var_usu_env_contrasenia, var_script_case_init, do_ajax_form_sis_usuario_validate_usu_env_contrasenia_cb);
  } // do_ajax_form_sis_usuario_validate_usu_env_contrasenia

  function do_ajax_form_sis_usuario_validate_usu_env_contrasenia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_usuario_validate_usu_env_contrasenia_cb

  // ---------- Validate roles
  function do_ajax_form_sis_usuario_validate_roles()
  {
    var nomeCampo_roles = "roles";
    var var_roles = scAjaxGetFieldText(nomeCampo_roles);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_usuario_validate_roles(var_roles, var_script_case_init, do_ajax_form_sis_usuario_validate_roles_cb);
  } // do_ajax_form_sis_usuario_validate_roles

  function do_ajax_form_sis_usuario_validate_roles_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "roles";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_usuario_validate_roles_cb

  // ---------- Validate permiso_sesion
  function do_ajax_form_sis_usuario_validate_permiso_sesion()
  {
    var nomeCampo_permiso_sesion = "permiso_sesion";
    var var_permiso_sesion = scAjaxGetFieldText(nomeCampo_permiso_sesion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_usuario_validate_permiso_sesion(var_permiso_sesion, var_script_case_init, do_ajax_form_sis_usuario_validate_permiso_sesion_cb);
  } // do_ajax_form_sis_usuario_validate_permiso_sesion

  function do_ajax_form_sis_usuario_validate_permiso_sesion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_usuario_validate_permiso_sesion_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_sis_usuario_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_sis_usuario_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_sis_usuario_submit_form(var_usu_filial, var_usu_usuario, var_usu_nombre, var_usu_cedula, var_usu_email, var_usu_super_administrador, var_usu_estado, var_usu_env_contrasenia, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_usuario_submit_form_cb);
  } // do_ajax_form_sis_usuario_submit_form

  function do_ajax_form_sis_usuario_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_sis_usuario_submit_form_cb_after_alert);
  } // do_ajax_form_sis_usuario_submit_form_cb
  function do_ajax_form_sis_usuario_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_usuario_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_sis_rol_usuario"] = "off";
  scStatusDetail["form_sis_permiso_sesion"] = "off";

  function do_ajax_form_sis_usuario_navigate_form()
  {
    perform_ajax_form_sis_usuario_navigate_form();
  }

  function perform_ajax_form_sis_usuario_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_sis_rol_usuario"] = "on";
    scStatusDetail["form_sis_permiso_sesion"] = "on";
    x_ajax_form_sis_usuario_navigate_form(var_usu_usuario, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_usuario_navigate_form_cb);
  } // do_ajax_form_sis_usuario_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_usuario']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_usuario_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_sis_rol_usuario"] && "nmsc_iframe_liga_form_sis_rol_usuario" != scMasterDetailIframe["nmsc_iframe_liga_form_sis_rol_usuario"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_sis_rol_usuario"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_sis_rol_usuario').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_sis_rol_usuario').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_sis_rol_usuario').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_sis_permiso_sesion"] && "nmsc_iframe_liga_form_sis_permiso_sesion" != scMasterDetailIframe["nmsc_iframe_liga_form_sis_permiso_sesion"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_sis_permiso_sesion"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_sis_permiso_sesion').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_sis_permiso_sesion').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_sis_permiso_sesion').style.display = "none";
    }
    scAjaxSetBtnVars();
    sc_change_tabs(true, 'hidden_bloco_1', 'id_tabs_1_1');
    sc_change_tabs(false, 'hidden_bloco_2', 'id_tabs_1_2');
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_usuario_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_usuario_navigate_form_cb
  function do_ajax_form_sis_usuario_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_sis_usuario_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_sis_usuario_navigate_form_cb_after_alert

  function sc_hide_form_sis_usuario_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_sis_rol_usuario"] && "off" == scStatusDetail["form_sis_permiso_sesion"])
    {
      return true;
    }
    return false;
