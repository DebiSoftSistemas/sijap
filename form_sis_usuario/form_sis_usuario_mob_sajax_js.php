  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_usuario_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sis_usuario_mob_form();
	}
...
?>
  ...
  // ---------- Validate usu_filial
  function do_ajax_form_sis_usuario_mob_validate_usu_filial()
  {
    var nomeCampo_usu_filial = "usu_filial";
    var var_usu_filial = scAjaxGetFieldSelect(nomeCampo_usu_filial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_usuario_mob_validate_usu_filial(var_usu_filial, var_script_case_init, do_ajax_form_sis_usuario_mob_validate_usu_filial_cb);
  } // do_ajax_form_sis_usuario_mob_validate_usu_filial

  function do_ajax_form_sis_usuario_mob_validate_usu_filial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usu_filial";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_usuario_mob_validate_usu_filial_cb

  // ---------- Validate usu_usuario
  function do_ajax_form_sis_usuario_mob_validate_usu_usuario()
  {
    var nomeCampo_usu_usuario = "usu_usuario";
    var var_usu_usuario = scAjaxGetFieldText(nomeCampo_usu_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_usuario_mob_validate_usu_usuario(var_usu_usuario, var_script_case_init, do_ajax_form_sis_usuario_mob_validate_usu_usuario_cb);
  } // do_ajax_form_sis_usuario_mob_validate_usu_usuario

  function do_ajax_form_sis_usuario_mob_validate_usu_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_usuario_mob_validate_usu_usuario_cb

  // ---------- Validate usu_nombre
  function do_ajax_form_sis_usuario_mob_validate_usu_nombre()
  {
    var nomeCampo_usu_nombre = "usu_nombre";
    var var_usu_nombre = scAjaxGetFieldText(nomeCampo_usu_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_usuario_mob_validate_usu_nombre(var_usu_nombre, var_script_case_init, do_ajax_form_sis_usuario_mob_validate_usu_nombre_cb);
  } // do_ajax_form_sis_usuario_mob_validate_usu_nombre

  function do_ajax_form_sis_usuario_mob_validate_usu_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_usuario_mob_validate_usu_nombre_cb

  // ---------- Validate usu_cedula
  function do_ajax_form_sis_usuario_mob_validate_usu_cedula()
  {
    var nomeCampo_usu_cedula = "usu_cedula";
    var var_usu_cedula = scAjaxGetFieldText(nomeCampo_usu_cedula);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_usuario_mob_validate_usu_cedula(var_usu_cedula, var_script_case_init, do_ajax_form_sis_usuario_mob_validate_usu_cedula_cb);
  } // do_ajax_form_sis_usuario_mob_validate_usu_cedula

  function do_ajax_form_sis_usuario_mob_validate_usu_cedula_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_usuario_mob_validate_usu_cedula_cb

  // ---------- Validate usu_email
  function do_ajax_form_sis_usuario_mob_validate_usu_email()
  {
    var nomeCampo_usu_email = "usu_email";
    var var_usu_email = scAjaxGetFieldText(nomeCampo_usu_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_usuario_mob_validate_usu_email(var_usu_email, var_script_case_init, do_ajax_form_sis_usuario_mob_validate_usu_email_cb);
  } // do_ajax_form_sis_usuario_mob_validate_usu_email

  function do_ajax_form_sis_usuario_mob_validate_usu_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_usuario_mob_validate_usu_email_cb

  // ---------- Validate usu_super_administrador
  function do_ajax_form_sis_usuario_mob_validate_usu_super_administrador()
  {
    var nomeCampo_usu_super_administrador = "usu_super_administrador";
    var var_usu_super_administrador = scAjaxGetFieldSelect(nomeCampo_usu_super_administrador);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_usuario_mob_validate_usu_super_administrador(var_usu_super_administrador, var_script_case_init, do_ajax_form_sis_usuario_mob_validate_usu_super_administrador_cb);
  } // do_ajax_form_sis_usuario_mob_validate_usu_super_administrador

  function do_ajax_form_sis_usuario_mob_validate_usu_super_administrador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_usuario_mob_validate_usu_super_administrador_cb

  // ---------- Validate usu_estado
  function do_ajax_form_sis_usuario_mob_validate_usu_estado()
  {
    var nomeCampo_usu_estado = "usu_estado";
    var var_usu_estado = scAjaxGetFieldSelect(nomeCampo_usu_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_usuario_mob_validate_usu_estado(var_usu_estado, var_script_case_init, do_ajax_form_sis_usuario_mob_validate_usu_estado_cb);
  } // do_ajax_form_sis_usuario_mob_validate_usu_estado

  function do_ajax_form_sis_usuario_mob_validate_usu_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_usuario_mob_validate_usu_estado_cb

  // ---------- Validate usu_env_contrasenia
  function do_ajax_form_sis_usuario_mob_validate_usu_env_contrasenia()
  {
    var nomeCampo_usu_env_contrasenia = "usu_env_contrasenia";
    var var_usu_env_contrasenia = scAjaxGetFieldRadio(nomeCampo_usu_env_contrasenia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_usuario_mob_validate_usu_env_contrasenia(var_usu_env_contrasenia, var_script_case_init, do_ajax_form_sis_usuario_mob_validate_usu_env_contrasenia_cb);
  } // do_ajax_form_sis_usuario_mob_validate_usu_env_contrasenia

  function do_ajax_form_sis_usuario_mob_validate_usu_env_contrasenia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usu_env_contrasenia";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_usuario_mob_validate_usu_env_contrasenia_cb

  // ---------- Validate roles
  function do_ajax_form_sis_usuario_mob_validate_roles()
  {
    var nomeCampo_roles = "roles";
    var var_roles = scAjaxGetFieldText(nomeCampo_roles);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_usuario_mob_validate_roles(var_roles, var_script_case_init, do_ajax_form_sis_usuario_mob_validate_roles_cb);
  } // do_ajax_form_sis_usuario_mob_validate_roles

  function do_ajax_form_sis_usuario_mob_validate_roles_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "roles";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_usuario_mob_validate_roles_cb

  // ---------- Validate permiso_sesion
  function do_ajax_form_sis_usuario_mob_validate_permiso_sesion()
  {
    var nomeCampo_permiso_sesion = "permiso_sesion";
    var var_permiso_sesion = scAjaxGetFieldText(nomeCampo_permiso_sesion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_usuario_mob_validate_permiso_sesion(var_permiso_sesion, var_script_case_init, do_ajax_form_sis_usuario_mob_validate_permiso_sesion_cb);
  } // do_ajax_form_sis_usuario_mob_validate_permiso_sesion

  function do_ajax_form_sis_usuario_mob_validate_permiso_sesion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "permiso_sesion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_usuario_mob_validate_permiso_sesion_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_sis_usuario_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_sis_usuario_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_usu_filial = scAjaxGetFieldSelect("usu_filial");
    ...
    var var_usu_super_administrador = scAjaxGetFieldSelect("usu_super_administrador");
    var var_usu_estado = scAjaxGetFieldSelect("usu_estado");
    var var_usu_env_contrasenia = scAjaxGetFieldRadio("usu_env_contrasenia");
    ...
    scAjaxProcOn();
    x_ajax_form_sis_usuario_mob_submit_form(var_usu_filial, var_usu_usuario, var_usu_nombre, var_usu_cedula, var_usu_email, var_usu_super_administrador, var_usu_estado, var_usu_env_contrasenia, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_usuario_mob_submit_form_cb);
  } // do_ajax_form_sis_usuario_mob_submit_form

  function do_ajax_form_sis_usuario_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("usu_filial");
      ...
      scAjaxHideErrorDisplay("usu_env_contrasenia");
      scAjaxHideErrorDisplay("roles");
      scAjaxHideErrorDisplay("permiso_sesion");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_sis_usuario_mob_submit_form_cb_after_alert);
  } // do_ajax_form_sis_usuario_mob_submit_form_cb
  function do_ajax_form_sis_usuario_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_usuario_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_sis_rol_usuario_mob"] = "off";
  scStatusDetail["form_sis_permiso_sesion_mob"] = "off";

  function do_ajax_form_sis_usuario_mob_navigate_form()
  {
    perform_ajax_form_sis_usuario_mob_navigate_form();
  }

  function perform_ajax_form_sis_usuario_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_sis_rol_usuario_mob"] = "on";
    scStatusDetail["form_sis_permiso_sesion_mob"] = "on";
    x_ajax_form_sis_usuario_mob_navigate_form(var_usu_usuario, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_usuario_mob_navigate_form_cb);
  } // do_ajax_form_sis_usuario_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_usuario_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_usuario_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_sis_rol_usuario_mob"] && "nmsc_iframe_liga_form_sis_rol_usuario_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_sis_rol_usuario_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_sis_rol_usuario_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_sis_rol_usuario_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_sis_rol_usuario_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_sis_rol_usuario_mob').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_sis_permiso_sesion_mob"] && "nmsc_iframe_liga_form_sis_permiso_sesion_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_sis_permiso_sesion_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_sis_permiso_sesion_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_sis_permiso_sesion_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_sis_permiso_sesion_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_sis_permiso_sesion_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_usuario_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_usuario_mob_navigate_form_cb
  function do_ajax_form_sis_usuario_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_sis_usuario_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_sis_usuario_mob_navigate_form_cb_after_alert

  function sc_hide_form_sis_usuario_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_sis_rol_usuario_mob"] && "off" == scStatusDetail["form_sis_permiso_sesion_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "usu_filial";
  ajax_field_list[1] = "usu_usuario";
  ajax_field_list[2] = "usu_nombre";
  ajax_field_list[3] = "usu_cedula";
  ajax_field_list[4] = "usu_email";
  ajax_field_list[5] = "usu_super_administrador";
  ajax_field_list[6] = "usu_estado";
  ajax_field_list[7] = "usu_env_contrasenia";
  ajax_field_list[8] = "roles";
  ajax_field_list[9] = "permiso_sesion";
  ...
  var ajax_error_list = {
    "usu_filial": {"label": "<?php echo $this->Ini->Nm_lang['lang_filial'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "usu_usuario": {"label": "<?php echo $this->Ini->Nm_lang['lang_usuario'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "usu_cedula": {"label": "<?php echo $this->Ini->Nm_lang['lang_cedula'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "usu_super_administrador": {"label": "<?php echo $this->Ini->Nm_lang['lang_administrador'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "usu_env_contrasenia": {"label": "<?php echo $this->Ini->Nm_lang['lang_enviar_contrasenia'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "roles": {"label": "<?php echo $this->Ini->Nm_lang['lang_roles'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "permiso_sesion": {"label": "<?php echo $this->Ini->Nm_lang['lang_permiso_sesion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "usu_env_contrasenia": new Array(),
    "roles": new Array(),
    "permiso_sesion": new Array()
  };
  ajax_field_mult["usu_filial"][1] = "usu_filial";
  ...
  ajax_field_mult["usu_env_contrasenia"][1] = "usu_env_contrasenia";
  ajax_field_mult["roles"][1] = "roles";
  ajax_field_mult["permiso_sesion"][1] = "permiso_sesion";

  var ajax_field_id = {
    "usu_filial": new Array("hidden_field_label_usu_filial", "hidden_field_data_usu_filial"),
    ...
    "usu_super_administrador": new Array("hidden_field_label_usu_super_administrador", "hidden_field_data_usu_super_administrador"),
    "usu_estado": new Array("hidden_field_label_usu_estado", "hidden_field_data_usu_estado"),
    "usu_env_contrasenia": new Array("hidden_field_label_usu_env_contrasenia", "hidden_field_data_usu_env_contrasenia"),
    "roles": new Array("hidden_field_label_roles", "hidden_field_data_roles"),
    "permiso_sesion": new Array("hidden_field_label_permiso_sesion", "hidden_field_data_permiso_sesion")
  };
