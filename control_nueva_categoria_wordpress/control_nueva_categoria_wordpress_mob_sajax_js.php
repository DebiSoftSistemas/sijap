  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_nueva_categoria_wordpress_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_nueva_categoria_wordpress_mob_form();
	}
...
?>
  ...
  // ---------- Validate cw_categoria
  function do_ajax_control_nueva_categoria_wordpress_mob_validate_cw_categoria()
  {
    var nomeCampo_cw_categoria = "cw_categoria";
    var var_cw_categoria = scAjaxGetFieldText(nomeCampo_cw_categoria);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_nueva_categoria_wordpress_mob_validate_cw_categoria(var_cw_categoria, var_script_case_init, do_ajax_control_nueva_categoria_wordpress_mob_validate_cw_categoria_cb);
  } // do_ajax_control_nueva_categoria_wordpress_mob_validate_cw_categoria

  function do_ajax_control_nueva_categoria_wordpress_mob_validate_cw_categoria_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cw_categoria";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_nueva_categoria_wordpress_mob_validate_cw_categoria_cb

  // ---------- Validate cw_descripcion
  function do_ajax_control_nueva_categoria_wordpress_mob_validate_cw_descripcion()
  {
    var nomeCampo_cw_descripcion = "cw_descripcion";
    var var_cw_descripcion = scAjaxGetFieldText(nomeCampo_cw_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_nueva_categoria_wordpress_mob_validate_cw_descripcion(var_cw_descripcion, var_script_case_init, do_ajax_control_nueva_categoria_wordpress_mob_validate_cw_descripcion_cb);
  } // do_ajax_control_nueva_categoria_wordpress_mob_validate_cw_descripcion

  function do_ajax_control_nueva_categoria_wordpress_mob_validate_cw_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cw_descripcion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_nueva_categoria_wordpress_mob_validate_cw_descripcion_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_nueva_categoria_wordpress_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_nueva_categoria_wordpress_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_cw_categoria = scAjaxGetFieldText("cw_categoria");
    var var_cw_descripcion = scAjaxGetFieldText("cw_descripcion");
    ...
    scAjaxProcOn();
    x_ajax_control_nueva_categoria_wordpress_mob_submit_form(var_cw_categoria, var_cw_descripcion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_nueva_categoria_wordpress_mob_submit_form_cb);
  } // do_ajax_control_nueva_categoria_wordpress_mob_submit_form

  function do_ajax_control_nueva_categoria_wordpress_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_nueva_categoria_wordpress_mob_submit_form_cb_after_alert);
  } // do_ajax_control_nueva_categoria_wordpress_mob_submit_form_cb
  function do_ajax_control_nueva_categoria_wordpress_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_nueva_categoria_wordpress_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_nueva_categoria_wordpress_mob_navigate_form()
  {
    perform_ajax_control_nueva_categoria_wordpress_mob_navigate_form();
  }

  function perform_ajax_control_nueva_categoria_wordpress_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_nueva_categoria_wordpress_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_categoria_wordpress_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_nueva_categoria_wordpress_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_nueva_categoria_wordpress_mob_navigate_form_cb_after_alert);
  } // do_ajax_control_nueva_categoria_wordpress_mob_navigate_form_cb
  function do_ajax_control_nueva_categoria_wordpress_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_nueva_categoria_wordpress_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_nueva_categoria_wordpress_mob_navigate_form_cb_after_alert

  function sc_hide_control_nueva_categoria_wordpress_mob_form()
  {
  ...
  ajax_field_list[0] = "cw_categoria";
  ajax_field_list[1] = "cw_descripcion";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "cw_categoria": {"label": "cw_categoria", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cw_descripcion": {"label": "cw_descripcion", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "cw_categoria": new Array(),
    "cw_descripcion": new Array()
  };
  ajax_field_mult["cw_categoria"][1] = "cw_categoria";
  ajax_field_mult["cw_descripcion"][1] = "cw_descripcion";

  var ajax_field_id = {
    "cw_categoria": new Array("hidden_field_label_cw_categoria", "hidden_field_data_cw_categoria"),
    "cw_descripcion": new Array("hidden_field_label_cw_descripcion", "hidden_field_data_cw_descripcion")
  };
