  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_nueva_categoria_wordpress" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_nueva_categoria_wordpress_form();
	}
...
?>
  ...
  function do_ajax_control_nueva_categoria_wordpress_validate_cw_categoria()
  {
    var nomeCampo_cw_categoria = "cw_categoria";
    var var_cw_categoria = scAjaxGetFieldText(nomeCampo_cw_categoria);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_nueva_categoria_wordpress_validate_cw_categoria(var_cw_categoria, var_script_case_init, do_ajax_control_nueva_categoria_wordpress_validate_cw_categoria_cb);
  } // do_ajax_control_nueva_categoria_wordpress_validate_cw_categoria

  function do_ajax_control_nueva_categoria_wordpress_validate_cw_categoria_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_nueva_categoria_wordpress_validate_cw_categoria_cb

  // ---------- Validate cw_descripcion
  function do_ajax_control_nueva_categoria_wordpress_validate_cw_descripcion()
  {
    var nomeCampo_cw_descripcion = "cw_descripcion";
    var var_cw_descripcion = scAjaxGetFieldText(nomeCampo_cw_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_nueva_categoria_wordpress_validate_cw_descripcion(var_cw_descripcion, var_script_case_init, do_ajax_control_nueva_categoria_wordpress_validate_cw_descripcion_cb);
  } // do_ajax_control_nueva_categoria_wordpress_validate_cw_descripcion

  function do_ajax_control_nueva_categoria_wordpress_validate_cw_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_nueva_categoria_wordpress_validate_cw_descripcion_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_nueva_categoria_wordpress_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_nueva_categoria_wordpress_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_control_nueva_categoria_wordpress_submit_form(var_cw_categoria, var_cw_descripcion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_nueva_categoria_wordpress_submit_form_cb);
  } // do_ajax_control_nueva_categoria_wordpress_submit_form

  function do_ajax_control_nueva_categoria_wordpress_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_nueva_categoria_wordpress_submit_form_cb_after_alert);
  } // do_ajax_control_nueva_categoria_wordpress_submit_form_cb
  function do_ajax_control_nueva_categoria_wordpress_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_nueva_categoria_wordpress_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_nueva_categoria_wordpress_navigate_form()
  {
    perform_ajax_control_nueva_categoria_wordpress_navigate_form();
  }

  function perform_ajax_control_nueva_categoria_wordpress_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_nueva_categoria_wordpress_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_categoria_wordpress']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_nueva_categoria_wordpress_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_nueva_categoria_wordpress_navigate_form_cb_after_alert);
  } // do_ajax_control_nueva_categoria_wordpress_navigate_form_cb
  function do_ajax_control_nueva_categoria_wordpress_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_nueva_categoria_wordpress_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_nueva_categoria_wordpress_navigate_form_cb_after_alert

  function sc_hide_control_nueva_categoria_wordpress_form()
  {
