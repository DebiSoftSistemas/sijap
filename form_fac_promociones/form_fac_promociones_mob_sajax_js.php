  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_fac_promociones_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_fac_promociones_mob_form();
	}
...
?>
  ...
  // ---------- Validate pr_id
  function do_ajax_form_fac_promociones_mob_validate_pr_id()
  {
    var nomeCampo_pr_id = "pr_id";
    var var_pr_id = scAjaxGetFieldHidden(nomeCampo_pr_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_promociones_mob_validate_pr_id(var_pr_id, var_script_case_init, do_ajax_form_fac_promociones_mob_validate_pr_id_cb);
  } // do_ajax_form_fac_promociones_mob_validate_pr_id

  function do_ajax_form_fac_promociones_mob_validate_pr_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_promociones_mob_validate_pr_id_cb

  // ---------- Validate pr_imagen
  function do_ajax_form_fac_promociones_mob_validate_pr_imagen()
  {
    var nomeCampo_pr_imagen = "pr_imagen";
    var var_pr_imagen = scAjaxGetFieldText(nomeCampo_pr_imagen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_promociones_mob_validate_pr_imagen(var_pr_imagen, var_script_case_init, do_ajax_form_fac_promociones_mob_validate_pr_imagen_cb);
  } // do_ajax_form_fac_promociones_mob_validate_pr_imagen

  function do_ajax_form_fac_promociones_mob_validate_pr_imagen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pr_imagen";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_promociones_mob_validate_pr_imagen_cb

  // ---------- Validate pr_nombre
  function do_ajax_form_fac_promociones_mob_validate_pr_nombre()
  {
    var nomeCampo_pr_nombre = "pr_nombre";
    var var_pr_nombre = scAjaxGetFieldText(nomeCampo_pr_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_promociones_mob_validate_pr_nombre(var_pr_nombre, var_script_case_init, do_ajax_form_fac_promociones_mob_validate_pr_nombre_cb);
  } // do_ajax_form_fac_promociones_mob_validate_pr_nombre

  function do_ajax_form_fac_promociones_mob_validate_pr_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_promociones_mob_validate_pr_nombre_cb

  // ---------- Validate pr_descripcion
  function do_ajax_form_fac_promociones_mob_validate_pr_descripcion()
  {
    var nomeCampo_pr_descripcion = "pr_descripcion";
    var var_pr_descripcion = scAjaxGetFieldText(nomeCampo_pr_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_promociones_mob_validate_pr_descripcion(var_pr_descripcion, var_script_case_init, do_ajax_form_fac_promociones_mob_validate_pr_descripcion_cb);
  } // do_ajax_form_fac_promociones_mob_validate_pr_descripcion

  function do_ajax_form_fac_promociones_mob_validate_pr_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pr_descripcion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_promociones_mob_validate_pr_descripcion_cb

  // ---------- Validate pr_grupo
  function do_ajax_form_fac_promociones_mob_validate_pr_grupo()
  {
    var nomeCampo_pr_grupo = "pr_grupo";
    var var_pr_grupo = scAjaxGetFieldSelect(nomeCampo_pr_grupo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_promociones_mob_validate_pr_grupo(var_pr_grupo, var_script_case_init, do_ajax_form_fac_promociones_mob_validate_pr_grupo_cb);
  } // do_ajax_form_fac_promociones_mob_validate_pr_grupo

  function do_ajax_form_fac_promociones_mob_validate_pr_grupo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pr_grupo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_promociones_mob_validate_pr_grupo_cb

  // ---------- Validate pr_estado
  function do_ajax_form_fac_promociones_mob_validate_pr_estado()
  {
    var nomeCampo_pr_estado = "pr_estado";
    var var_pr_estado = scAjaxGetFieldSelect(nomeCampo_pr_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_promociones_mob_validate_pr_estado(var_pr_estado, var_script_case_init, do_ajax_form_fac_promociones_mob_validate_pr_estado_cb);
  } // do_ajax_form_fac_promociones_mob_validate_pr_estado

  function do_ajax_form_fac_promociones_mob_validate_pr_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pr_estado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_promociones_mob_validate_pr_estado_cb

  // ---------- Validate pr_valor
  function do_ajax_form_fac_promociones_mob_validate_pr_valor()
  {
    var nomeCampo_pr_valor = "pr_valor";
    var var_pr_valor = scAjaxGetFieldHidden(nomeCampo_pr_valor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_promociones_mob_validate_pr_valor(var_pr_valor, var_script_case_init, do_ajax_form_fac_promociones_mob_validate_pr_valor_cb);
  } // do_ajax_form_fac_promociones_mob_validate_pr_valor

  function do_ajax_form_fac_promociones_mob_validate_pr_valor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pr_valor";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_promociones_mob_validate_pr_valor_cb

  // ---------- Validate pr_ice
  function do_ajax_form_fac_promociones_mob_validate_pr_ice()
  {
    var nomeCampo_pr_ice = "pr_ice";
    var var_pr_ice = scAjaxGetFieldHidden(nomeCampo_pr_ice);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_promociones_mob_validate_pr_ice(var_pr_ice, var_script_case_init, do_ajax_form_fac_promociones_mob_validate_pr_ice_cb);
  } // do_ajax_form_fac_promociones_mob_validate_pr_ice

  function do_ajax_form_fac_promociones_mob_validate_pr_ice_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pr_ice";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_promociones_mob_validate_pr_ice_cb

  // ---------- Validate pr_iva
  function do_ajax_form_fac_promociones_mob_validate_pr_iva()
  {
    var nomeCampo_pr_iva = "pr_iva";
    var var_pr_iva = scAjaxGetFieldHidden(nomeCampo_pr_iva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_promociones_mob_validate_pr_iva(var_pr_iva, var_script_case_init, do_ajax_form_fac_promociones_mob_validate_pr_iva_cb);
  } // do_ajax_form_fac_promociones_mob_validate_pr_iva

  function do_ajax_form_fac_promociones_mob_validate_pr_iva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pr_iva";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_promociones_mob_validate_pr_iva_cb

  // ---------- Validate pr_total
  function do_ajax_form_fac_promociones_mob_validate_pr_total()
  {
    var nomeCampo_pr_total = "pr_total";
    var var_pr_total = scAjaxGetFieldHidden(nomeCampo_pr_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_promociones_mob_validate_pr_total(var_pr_total, var_script_case_init, do_ajax_form_fac_promociones_mob_validate_pr_total_cb);
  } // do_ajax_form_fac_promociones_mob_validate_pr_total

  function do_ajax_form_fac_promociones_mob_validate_pr_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pr_total";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_promociones_mob_validate_pr_total_cb

  // ---------- Validate detalles
  function do_ajax_form_fac_promociones_mob_validate_detalles()
  {
    var nomeCampo_detalles = "detalles";
    var var_detalles = scAjaxGetFieldText(nomeCampo_detalles);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_promociones_mob_validate_detalles(var_detalles, var_script_case_init, do_ajax_form_fac_promociones_mob_validate_detalles_cb);
  } // do_ajax_form_fac_promociones_mob_validate_detalles

  function do_ajax_form_fac_promociones_mob_validate_detalles_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_promociones_mob_validate_detalles_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_fac_promociones_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_fac_promociones_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_pr_id = scAjaxGetFieldHidden("pr_id");
    var var_pr_imagen = scAjaxGetFieldText("pr_imagen");
    var var_pr_nombre = scAjaxGetFieldText("pr_nombre");
    var var_pr_descripcion = scAjaxGetFieldText("pr_descripcion");
    var var_pr_grupo = scAjaxGetFieldSelect("pr_grupo");
    var var_pr_estado = scAjaxGetFieldSelect("pr_estado");
    var var_pr_valor = scAjaxGetFieldHidden("pr_valor");
    var var_pr_ice = scAjaxGetFieldHidden("pr_ice");
    var var_pr_iva = scAjaxGetFieldHidden("pr_iva");
    var var_pr_total = scAjaxGetFieldHidden("pr_total");
    var var_pr_imagen_ul_name = scAjaxSpecCharProtect(document.F1.pr_imagen_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_pr_imagen_ul_type = document.F1.pr_imagen_ul_type.value;
    var var_pr_imagen_salva = scAjaxSpecCharProtect(document.F1.pr_imagen_salva.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_pr_imagen_limpa = document.F1.pr_imagen_limpa.checked ? "S" : "N";
    ...
    scAjaxProcOn();
    x_ajax_form_fac_promociones_mob_submit_form(var_pr_id, var_pr_imagen, var_pr_nombre, var_pr_descripcion, var_pr_grupo, var_pr_estado, var_pr_valor, var_pr_ice, var_pr_iva, var_pr_total, var_pr_imagen_ul_name, var_pr_imagen_ul_type, var_pr_imagen_salva, var_pr_imagen_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_fac_promociones_mob_submit_form_cb);
  } // do_ajax_form_fac_promociones_mob_submit_form

  function do_ajax_form_fac_promociones_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("pr_imagen");
      scAjaxHideErrorDisplay("pr_nombre");
      scAjaxHideErrorDisplay("pr_descripcion");
      scAjaxHideErrorDisplay("pr_grupo");
      scAjaxHideErrorDisplay("pr_estado");
      scAjaxHideErrorDisplay("pr_valor");
      scAjaxHideErrorDisplay("pr_ice");
      scAjaxHideErrorDisplay("pr_iva");
      scAjaxHideErrorDisplay("pr_total");
...
?>
    ...
    if (!scAjaxHasError())
    {
      ...
      if (document.F1.pr_imagen_limpa && document.F1.pr_imagen_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldImage("pr_imagen", oImgTemp, "", "", "", "N");
      }
    document.F1.pr_imagen_ul_name.value = '';
    document.F1.pr_imagen_ul_type.value = '';
    }
    scAjaxShowDebug();
    scAjaxSetDisplay();
    scBtnDisabled();
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_fac_promociones_mob_submit_form_cb_after_alert);
  } // do_ajax_form_fac_promociones_mob_submit_form_cb
  function do_ajax_form_fac_promociones_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_fac_promociones_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_fac_productos_promocion_mob"] = "off";

  function do_ajax_form_fac_promociones_mob_navigate_form()
  {
    perform_ajax_form_fac_promociones_mob_navigate_form();
  }

  function perform_ajax_form_fac_promociones_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_fac_productos_promocion_mob"] = "on";
    x_ajax_form_fac_promociones_mob_navigate_form(var_pr_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_promociones_mob_navigate_form_cb);
  } // do_ajax_form_fac_promociones_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_promociones_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_fac_promociones_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_fac_productos_promocion_mob"] && "nmsc_iframe_liga_form_fac_productos_promocion_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_fac_productos_promocion_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_fac_productos_promocion_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_fac_productos_promocion_mob').contentWindow.nm_move('apl_detalhe', true, '300');
        document.getElementById('nmsc_iframe_liga_form_fac_productos_promocion_mob').style.height = "300";
        document.getElementById('nmsc_iframe_liga_form_fac_productos_promocion_mob').style.display = "none";
    }
    document.F1.pr_imagen_ul_name.value = '';
    document.F1.pr_imagen_ul_type.value = '';
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_fac_promociones_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_fac_promociones_mob_navigate_form_cb
  function do_ajax_form_fac_promociones_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_fac_promociones_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_fac_promociones_mob_navigate_form_cb_after_alert

  function sc_hide_form_fac_promociones_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_fac_productos_promocion_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[1] = "pr_imagen";
  ajax_field_list[2] = "pr_nombre";
  ajax_field_list[3] = "pr_descripcion";
  ajax_field_list[4] = "pr_grupo";
  ajax_field_list[5] = "pr_estado";
  ajax_field_list[6] = "pr_valor";
  ajax_field_list[7] = "pr_ice";
  ajax_field_list[8] = "pr_iva";
  ajax_field_list[9] = "pr_total";
  ajax_field_list[10] = "detalles";
  ...
  var ajax_error_list = {
    ...
    "pr_imagen": {"label": "<?php echo $this->Ini->Nm_lang['lang_btns_img'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "pr_descripcion": {"label": "<?php echo $this->Ini->Nm_lang['lang_descripcion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pr_grupo": {"label": "<?php echo $this->Ini->Nm_lang['lang_list_groups'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pr_estado": {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pr_valor": {"label": "<?php echo $this->Ini->Nm_lang['lang_precio'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pr_ice": {"label": "<?php echo $this->Ini->Nm_lang['lang_ice'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pr_iva": {"label": "<?php echo $this->Ini->Nm_lang['lang_iva'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pr_total": {"label": "<?php echo $this->Ini->Nm_lang['lang_total_pagar'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["pr_imagen"][1] = "pr_imagen";
  ajax_field_mult["pr_nombre"][1] = "pr_nombre";
  ajax_field_mult["pr_descripcion"][1] = "pr_descripcion";
  ajax_field_mult["pr_grupo"][1] = "pr_grupo";
  ajax_field_mult["pr_estado"][1] = "pr_estado";
  ajax_field_mult["pr_valor"][1] = "pr_valor";
  ajax_field_mult["pr_ice"][1] = "pr_ice";
  ajax_field_mult["pr_iva"][1] = "pr_iva";
  ajax_field_mult["pr_total"][1] = "pr_total";
  ajax_field_mult["detalles"][1] = "detalles";

  var ajax_field_id = {
    "pr_imagen": new Array("hidden_field_label_pr_imagen", "hidden_field_data_pr_imagen"),
    "pr_nombre": new Array("hidden_field_label_pr_nombre", "hidden_field_data_pr_nombre"),
    "pr_descripcion": new Array("hidden_field_label_pr_descripcion", "hidden_field_data_pr_descripcion"),
    "pr_grupo": new Array("hidden_field_label_pr_grupo", "hidden_field_data_pr_grupo"),
    "pr_estado": new Array("hidden_field_label_pr_estado", "hidden_field_data_pr_estado"),
    "pr_valor": new Array("hidden_field_label_pr_valor", "hidden_field_data_pr_valor"),
    "pr_ice": new Array("hidden_field_label_pr_ice", "hidden_field_data_pr_ice"),
    "pr_iva": new Array("hidden_field_label_pr_iva", "hidden_field_data_pr_iva"),
    "pr_total": new Array("hidden_field_label_pr_total", "hidden_field_data_pr_total"),
