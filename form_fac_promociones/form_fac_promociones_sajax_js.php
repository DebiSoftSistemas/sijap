  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_fac_promociones" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_fac_promociones_form();
	}
...
?>
  ...
  // ---------- Validate pr_id
  function do_ajax_form_fac_promociones_validate_pr_id()
  {
    var nomeCampo_pr_id = "pr_id";
    var var_pr_id = scAjaxGetFieldHidden(nomeCampo_pr_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_promociones_validate_pr_id(var_pr_id, var_script_case_init, do_ajax_form_fac_promociones_validate_pr_id_cb);
  } // do_ajax_form_fac_promociones_validate_pr_id

  function do_ajax_form_fac_promociones_validate_pr_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_promociones_validate_pr_id_cb

  // ---------- Validate pr_imagen
  function do_ajax_form_fac_promociones_validate_pr_imagen()
  {
    var nomeCampo_pr_imagen = "pr_imagen";
    var var_pr_imagen = scAjaxGetFieldText(nomeCampo_pr_imagen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_promociones_validate_pr_imagen(var_pr_imagen, var_script_case_init, do_ajax_form_fac_promociones_validate_pr_imagen_cb);
  } // do_ajax_form_fac_promociones_validate_pr_imagen

  function do_ajax_form_fac_promociones_validate_pr_imagen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_promociones_validate_pr_imagen_cb

  // ---------- Validate pr_nombre
  function do_ajax_form_fac_promociones_validate_pr_nombre()
  {
    var nomeCampo_pr_nombre = "pr_nombre";
    var var_pr_nombre = scAjaxGetFieldText(nomeCampo_pr_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_promociones_validate_pr_nombre(var_pr_nombre, var_script_case_init, do_ajax_form_fac_promociones_validate_pr_nombre_cb);
  } // do_ajax_form_fac_promociones_validate_pr_nombre

  function do_ajax_form_fac_promociones_validate_pr_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_promociones_validate_pr_nombre_cb

  // ---------- Validate pr_descripcion
  function do_ajax_form_fac_promociones_validate_pr_descripcion()
  {
    var nomeCampo_pr_descripcion = "pr_descripcion";
    var var_pr_descripcion = scAjaxGetFieldText(nomeCampo_pr_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_promociones_validate_pr_descripcion(var_pr_descripcion, var_script_case_init, do_ajax_form_fac_promociones_validate_pr_descripcion_cb);
  } // do_ajax_form_fac_promociones_validate_pr_descripcion

  function do_ajax_form_fac_promociones_validate_pr_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_promociones_validate_pr_descripcion_cb

  // ---------- Validate pr_grupo
  function do_ajax_form_fac_promociones_validate_pr_grupo()
  {
    var nomeCampo_pr_grupo = "pr_grupo";
    var var_pr_grupo = scAjaxGetFieldSelect(nomeCampo_pr_grupo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_promociones_validate_pr_grupo(var_pr_grupo, var_script_case_init, do_ajax_form_fac_promociones_validate_pr_grupo_cb);
  } // do_ajax_form_fac_promociones_validate_pr_grupo

  function do_ajax_form_fac_promociones_validate_pr_grupo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_promociones_validate_pr_grupo_cb

  // ---------- Validate pr_estado
  function do_ajax_form_fac_promociones_validate_pr_estado()
  {
    var nomeCampo_pr_estado = "pr_estado";
    var var_pr_estado = scAjaxGetFieldSelect(nomeCampo_pr_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_promociones_validate_pr_estado(var_pr_estado, var_script_case_init, do_ajax_form_fac_promociones_validate_pr_estado_cb);
  } // do_ajax_form_fac_promociones_validate_pr_estado

  function do_ajax_form_fac_promociones_validate_pr_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_promociones_validate_pr_estado_cb

  // ---------- Validate pr_valor
  function do_ajax_form_fac_promociones_validate_pr_valor()
  {
    var nomeCampo_pr_valor = "pr_valor";
    var var_pr_valor = scAjaxGetFieldHidden(nomeCampo_pr_valor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_promociones_validate_pr_valor(var_pr_valor, var_script_case_init, do_ajax_form_fac_promociones_validate_pr_valor_cb);
  } // do_ajax_form_fac_promociones_validate_pr_valor

  function do_ajax_form_fac_promociones_validate_pr_valor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_promociones_validate_pr_valor_cb

  // ---------- Validate pr_ice
  function do_ajax_form_fac_promociones_validate_pr_ice()
  {
    var nomeCampo_pr_ice = "pr_ice";
    var var_pr_ice = scAjaxGetFieldHidden(nomeCampo_pr_ice);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_promociones_validate_pr_ice(var_pr_ice, var_script_case_init, do_ajax_form_fac_promociones_validate_pr_ice_cb);
  } // do_ajax_form_fac_promociones_validate_pr_ice

  function do_ajax_form_fac_promociones_validate_pr_ice_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pr_ice";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_promociones_validate_pr_ice_cb

  // ---------- Validate pr_iva
  function do_ajax_form_fac_promociones_validate_pr_iva()
  {
    var nomeCampo_pr_iva = "pr_iva";
    var var_pr_iva = scAjaxGetFieldHidden(nomeCampo_pr_iva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_promociones_validate_pr_iva(var_pr_iva, var_script_case_init, do_ajax_form_fac_promociones_validate_pr_iva_cb);
  } // do_ajax_form_fac_promociones_validate_pr_iva

  function do_ajax_form_fac_promociones_validate_pr_iva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pr_iva";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_promociones_validate_pr_iva_cb

  // ---------- Validate pr_total
  function do_ajax_form_fac_promociones_validate_pr_total()
  {
    var nomeCampo_pr_total = "pr_total";
    var var_pr_total = scAjaxGetFieldHidden(nomeCampo_pr_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_promociones_validate_pr_total(var_pr_total, var_script_case_init, do_ajax_form_fac_promociones_validate_pr_total_cb);
  } // do_ajax_form_fac_promociones_validate_pr_total

  function do_ajax_form_fac_promociones_validate_pr_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_promociones_validate_pr_total_cb

  // ---------- Validate detalles
  function do_ajax_form_fac_promociones_validate_detalles()
  {
    var nomeCampo_detalles = "detalles";
    var var_detalles = scAjaxGetFieldText(nomeCampo_detalles);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_promociones_validate_detalles(var_detalles, var_script_case_init, do_ajax_form_fac_promociones_validate_detalles_cb);
  } // do_ajax_form_fac_promociones_validate_detalles

  function do_ajax_form_fac_promociones_validate_detalles_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_promociones_validate_detalles_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_fac_promociones_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_fac_promociones_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_fac_promociones_submit_form(var_pr_id, var_pr_imagen, var_pr_nombre, var_pr_descripcion, var_pr_grupo, var_pr_estado, var_pr_valor, var_pr_ice, var_pr_iva, var_pr_total, var_pr_imagen_ul_name, var_pr_imagen_ul_type, var_pr_imagen_salva, var_pr_imagen_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_fac_promociones_submit_form_cb);
  } // do_ajax_form_fac_promociones_submit_form

  function do_ajax_form_fac_promociones_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_fac_promociones_submit_form_cb_after_alert);
  } // do_ajax_form_fac_promociones_submit_form_cb
  function do_ajax_form_fac_promociones_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_fac_promociones_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_fac_productos_promocion"] = "off";

  function do_ajax_form_fac_promociones_navigate_form()
  {
    perform_ajax_form_fac_promociones_navigate_form();
  }

  function perform_ajax_form_fac_promociones_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_fac_productos_promocion"] = "on";
    x_ajax_form_fac_promociones_navigate_form(var_pr_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_promociones_navigate_form_cb);
  } // do_ajax_form_fac_promociones_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_promociones']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_fac_promociones_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_fac_productos_promocion"] && "nmsc_iframe_liga_form_fac_productos_promocion" != scMasterDetailIframe["nmsc_iframe_liga_form_fac_productos_promocion"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_fac_productos_promocion"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_fac_productos_promocion').contentWindow.nm_move('apl_detalhe', true, '300');
        document.getElementById('nmsc_iframe_liga_form_fac_productos_promocion').style.height = "300";
        document.getElementById('nmsc_iframe_liga_form_fac_productos_promocion').style.display = "none";
    }
    document.F1.pr_imagen_ul_name.value = '';
    document.F1.pr_imagen_ul_type.value = '';
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_fac_promociones_navigate_form_cb_after_alert);
  } // do_ajax_form_fac_promociones_navigate_form_cb
  function do_ajax_form_fac_promociones_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_fac_promociones_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_fac_promociones_navigate_form_cb_after_alert

  function sc_hide_form_fac_promociones_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_fac_productos_promocion"])
    {
      return true;
    }
    return false;
