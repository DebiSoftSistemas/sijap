  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_horario_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sis_horario_mob_form();
	}
...
?>
  ...
  // ---------- Validate hor_nombre
  function do_ajax_form_sis_horario_mob_validate_hor_nombre()
  {
    var nomeCampo_hor_nombre = "hor_nombre";
    var var_hor_nombre = scAjaxGetFieldText(nomeCampo_hor_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_horario_mob_validate_hor_nombre(var_hor_nombre, var_script_case_init, do_ajax_form_sis_horario_mob_validate_hor_nombre_cb);
  } // do_ajax_form_sis_horario_mob_validate_hor_nombre

  function do_ajax_form_sis_horario_mob_validate_hor_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "hor_nombre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_horario_mob_validate_hor_nombre_cb

  // ---------- Validate hor_estado
  function do_ajax_form_sis_horario_mob_validate_hor_estado()
  {
    var nomeCampo_hor_estado = "hor_estado";
    var var_hor_estado = scAjaxGetFieldSelect(nomeCampo_hor_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_horario_mob_validate_hor_estado(var_hor_estado, var_script_case_init, do_ajax_form_sis_horario_mob_validate_hor_estado_cb);
  } // do_ajax_form_sis_horario_mob_validate_hor_estado

  function do_ajax_form_sis_horario_mob_validate_hor_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "hor_estado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_horario_mob_validate_hor_estado_cb

  // ---------- Validate dias
  function do_ajax_form_sis_horario_mob_validate_dias()
  {
    var nomeCampo_dias = "dias";
    var var_dias = scAjaxGetFieldText(nomeCampo_dias);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_horario_mob_validate_dias(var_dias, var_script_case_init, do_ajax_form_sis_horario_mob_validate_dias_cb);
  } // do_ajax_form_sis_horario_mob_validate_dias

  function do_ajax_form_sis_horario_mob_validate_dias_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dias";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_horario_mob_validate_dias_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_sis_horario_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_sis_horario_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_hor_nombre = scAjaxGetFieldText("hor_nombre");
    var var_hor_estado = scAjaxGetFieldSelect("hor_estado");
    var var_hor_id = scAjaxGetFieldText("hor_id");
    ...
    scAjaxProcOn();
    x_ajax_form_sis_horario_mob_submit_form(var_hor_nombre, var_hor_estado, var_hor_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_horario_mob_submit_form_cb);
  } // do_ajax_form_sis_horario_mob_submit_form

  function do_ajax_form_sis_horario_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("hor_nombre");
      scAjaxHideErrorDisplay("hor_estado");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_sis_horario_mob_submit_form_cb_after_alert);
  } // do_ajax_form_sis_horario_mob_submit_form_cb
  function do_ajax_form_sis_horario_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_horario_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_sis_detalle_horario_mob"] = "off";

  function do_ajax_form_sis_horario_mob_navigate_form()
  {
    perform_ajax_form_sis_horario_mob_navigate_form();
  }

  function perform_ajax_form_sis_horario_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("hor_estado");
    scAjaxHideErrorDisplay("dias");
    var var_hor_id = document.F2.hor_id.value;
    ...
    scAjaxProcOn();
    scStatusDetail["form_sis_detalle_horario_mob"] = "on";
    x_ajax_form_sis_horario_mob_navigate_form(var_hor_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_horario_mob_navigate_form_cb);
  } // do_ajax_form_sis_horario_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_horario_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_horario_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.hor_id.value = scAjaxGetKeyValue("hor_id");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_sis_detalle_horario_mob"] && "nmsc_iframe_liga_form_sis_detalle_horario_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_sis_detalle_horario_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_sis_detalle_horario_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_sis_detalle_horario_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_sis_detalle_horario_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_sis_detalle_horario_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_horario_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_horario_mob_navigate_form_cb
  function do_ajax_form_sis_horario_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_sis_horario_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_sis_horario_mob_navigate_form_cb_after_alert

  function sc_hide_form_sis_horario_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_sis_detalle_horario_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "hor_nombre";
  ajax_field_list[1] = "hor_estado";
  ajax_field_list[2] = "dias";
  ...
  var ajax_error_list = {
    "hor_nombre": {"label": "<?php echo $this->Ini->Nm_lang['lang_horario'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "hor_estado": {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "dias": {"label": "<?php echo $this->Ini->Nm_lang['lang_horario'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "hor_nombre": new Array(),
    "hor_estado": new Array(),
    "dias": new Array()
  };
  ajax_field_mult["hor_nombre"][1] = "hor_nombre";
  ajax_field_mult["hor_estado"][1] = "hor_estado";
  ajax_field_mult["dias"][1] = "dias";

  var ajax_field_id = {
    "hor_nombre": new Array("hidden_field_label_hor_nombre", "hidden_field_data_hor_nombre"),
    "hor_estado": new Array("hidden_field_label_hor_estado", "hidden_field_data_hor_estado"),
