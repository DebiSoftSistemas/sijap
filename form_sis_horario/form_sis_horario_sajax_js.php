  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_horario" == sTestField)
        {
...
?>
  ...
  // ---------- Validate hor_nombre
  function do_ajax_form_sis_horario_validate_hor_nombre()
  {
    var nomeCampo_hor_nombre = "hor_nombre";
    var var_hor_nombre = scAjaxGetFieldText(nomeCampo_hor_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_horario_validate_hor_nombre(var_hor_nombre, var_script_case_init, do_ajax_form_sis_horario_validate_hor_nombre_cb);
  } // do_ajax_form_sis_horario_validate_hor_nombre

  function do_ajax_form_sis_horario_validate_hor_nombre_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_horario_validate_hor_nombre_cb

  // ---------- Validate hor_estado
  function do_ajax_form_sis_horario_validate_hor_estado()
  {
    var nomeCampo_hor_estado = "hor_estado";
    var var_hor_estado = scAjaxGetFieldSelect(nomeCampo_hor_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_horario_validate_hor_estado(var_hor_estado, var_script_case_init, do_ajax_form_sis_horario_validate_hor_estado_cb);
  } // do_ajax_form_sis_horario_validate_hor_estado

  function do_ajax_form_sis_horario_validate_hor_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_horario_validate_hor_estado_cb

  // ---------- Validate dias
  function do_ajax_form_sis_horario_validate_dias()
  {
    var nomeCampo_dias = "dias";
    var var_dias = scAjaxGetFieldText(nomeCampo_dias);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_horario_validate_dias(var_dias, var_script_case_init, do_ajax_form_sis_horario_validate_dias_cb);
  } // do_ajax_form_sis_horario_validate_dias

  function do_ajax_form_sis_horario_validate_dias_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dias";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_horario_validate_dias_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_sis_horario_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_sis_horario_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_sis_horario_submit_form(var_hor_nombre, var_hor_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_horario_submit_form_cb);
  } // do_ajax_form_sis_horario_submit_form

  function do_ajax_form_sis_horario_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_sis_horario_submit_form_cb_after_alert);
  } // do_ajax_form_sis_horario_submit_form_cb
  function do_ajax_form_sis_horario_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_horario_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_sis_detalle_horario"] = "off";

  function do_ajax_form_sis_horario_navigate_form()
  {
    perform_ajax_form_sis_horario_navigate_form();
  }

  function perform_ajax_form_sis_horario_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_sis_detalle_horario"] = "on";
    x_ajax_form_sis_horario_navigate_form(var_hor_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_horario_navigate_form_cb);
  } // do_ajax_form_sis_horario_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_horario']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_horario_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_sis_detalle_horario"] && "nmsc_iframe_liga_form_sis_detalle_horario" != scMasterDetailIframe["nmsc_iframe_liga_form_sis_detalle_horario"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_sis_detalle_horario"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_sis_detalle_horario').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_sis_detalle_horario').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_sis_detalle_horario').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_horario_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_horario_navigate_form_cb
  function do_ajax_form_sis_horario_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_sis_horario_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_sis_horario_navigate_form_cb_after_alert

  function sc_hide_form_sis_horario_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_sis_detalle_horario"])
    {
      return true;
    }
    return false;
