...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['contratos_sin_ruta']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['contratos_sin_ruta']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['contratos_sin_ruta']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['usr_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['usr_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['usr_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['grid_pesq'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['grid_pesq'] = array();
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['charts_html'] = '';
   ...
   { 
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['proc_pdf_vert'])
            {
            } 
            else
            {
       ...
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['contratos_sin_ruta'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'];
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_top();
       } 
       if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao_print'] != 'print')
       { 
           if ($this->Ini->grid_search_change_fil)
           { 
               $seq_search = 1;
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['grid_pesq'] as $cmp => $def)
               {
                  $Seq_grid      = $seq_search;
                  $Cmp_grid      = $cmp;
       ...
       unset ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['save_grid']);
       $this->grid();
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_bot();
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['print_all'] && empty($this->nm_grid_sem_reg) && ($Gera_res || $Gera_graf) && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['SC_Ind_Groupby'] != "sc_free_total")
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] == "pdf")
       { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'];
 }
...
//
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['Ind_lig_mult'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['Ind_lig_mult'] = 0;
   }
   $this->Img_embbed      = false;
   $this->nm_data         = new nm_data("es");
   $this->pdf_label_group = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opc_pdf']['label_group'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opc_pdf']['label_group'] : "N";
   $this->pdf_all_cab     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opc_pdf']['all_cab']))     ? $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opc_pdf']['all_cab'] : "S";
   $this->pdf_all_label   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opc_pdf']['all_label']))   ? $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opc_pdf']['all_label'] : "S";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opc_liga']['fix_top'])) {
       $this->Fix_bar_top = ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opc_liga']['fix_top'] == "S") ? true : false;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opc_liga']['fix_bot'])) {
       $this->Fix_bar_bottom = ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opc_liga']['fix_bot'] == "S") ? true : false;
   }
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "contratos_sin_ruta/contratos_sin_ruta_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['pesq_tab_label']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['pesq_tab_label'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['pesq_tab_label'] .= "con_id?#?" . "" . $this->Ini->Nm_lang['lang_id'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['pesq_tab_label'] .= "con_propietario?#?" . "" . $this->Ini->Nm_lang['lang_propietario'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['pesq_tab_label'] .= "con_nombre?#?" . "" . $this->Ini->Nm_lang['lang_lot_nombre_completo'] . "" . "?@?";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['grid_search_add']))
   {
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['pesq_tab_label'];
       ...
       $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['grid_search_add']['seq'];
       $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['grid_search_add']['cmp'];
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['grid_search_add']);
       exit;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['dyn_search_aut_comp']))
   {
       $Cmp_select2 = array("con_nombre");
       $NM_func_aut_comp = "lookup_ajax_" . $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['dyn_search_aut_comp']['cmp'];
       ...
       foreach ($nmgp_def_dados as $Ind => $Lista)
       {
          if (is_array($Lista))
          {
              foreach ($Lista as $Cod => $Valor)
              {
                  ...
                  if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['dyn_search_aut_comp']['cmp'], $Cmp_select2))
                  {
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['dyn_search_aut_comp']);
       exit;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida'] || $this->Ini->Embutida_iframe)
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['force_toolbar']);
   } 
       $this->Tem_tab_vert = false;
   $this->width_tabula_quebra  = "0px";
   $this->width_tabula_display = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['contratos_sin_ruta']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['contratos_sin_ruta']['lig_edit'] != '')
   {
       if ($_SESSION['scriptcase']['sc_apl_conf']['contratos_sin_ruta']['lig_edit'] == "on")  {$_SESSION['scriptcase']['sc_apl_conf']['contratos_sin_ruta']['lig_edit'] = "S";}
       if ($_SESSION['scriptcase']['sc_apl_conf']['contratos_sin_ruta']['lig_edit'] == "off") {$_SESSION['scriptcase']['sc_apl_conf']['contratos_sin_ruta']['lig_edit'] = "N";}
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['contratos_sin_ruta']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['mostra_edit'] = "N";
       }
   }
   if ($this->Ini->SC_Link_View || ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opc_psq'] && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['psq_edit'] == 'N'))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['mostra_edit'] = "N";
   }
   $this->NM_cont_body   = 0; 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ind_tree'] = 0;
   }
   elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['emb_tree_no']) && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['emb_tree_no'])
   { 
       $this->NM_emb_tree_no = true; 
   }
   $this->aba_iframe = false;
   $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['print_all'];
   if ($this->Print_All)
   {
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("contratos_sin_ruta", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['contratos_sin_ruta']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['contratos_sin_ruta']['btn_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['contratos_sin_ruta']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
       {
           $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
       }
   }
   $this->Proc_link_res = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['where_resumo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['where_resumo'])) 
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['doc_word'] || $this->Ini->sc_export_ajax_img)
   { 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['campos_busca']))
   { 
       $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['campos_busca'];
   ...
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['where_pesq_filtro'];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] = "muda_qt_linhas";
   } 
   ...
   $this->New_label['con_numero_contrato'] = "" . $this->Ini->Nm_lang['lang_contrato'] . "";
   $this->New_label['con_estado'] = "" . $this->Ini->Nm_lang['lang_estado'] . "";
   $this->New_label['con_propietario'] = "" . $this->Ini->Nm_lang['lang_propietario'] . "";

   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['dashboard_info']['maximized']) {
       $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['dashboard_info']['dashboard_app'];
       if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['contratos_sin_ruta'])) {
           $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['contratos_sin_ruta'];
   ...
   if ($this->Ini->Embutida_iframe) {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['sub_cons_iframe_btns'] as $BTN => $BTN_opc) {
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "contratos_sin_ruta/contratos_sin_ruta_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "contratos_sin_ruta_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   $this->Tot         = new contratos_sin_ruta_total($this->Ini->sc_page);
   $this->Tot->Db     = $this->Db;
   $this->Tot->Erro   = $this->Erro;
   $this->Tot->Ini    = $this->Ini;
   $this->Tot->Lookup = $this->Lookup;
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['qt_lin_grid'] = 10;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['contratos_sin_ruta']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['contratos_sin_ruta']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['contratos_sin_ruta']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['contratos_sin_ruta']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['contratos_sin_ruta']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['contratos_sin_ruta']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['contratos_sin_ruta']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['contratos_sin_ruta']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['qt_lin_grid']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ordem_select']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ordem_select'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ordem_select_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ordem_select']; 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ordem_quebra'] = array(); 
       } 
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['where_pesq_filtro'];
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao']       = "igual" ; 
...
// 
   $this->count_ger = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] == "final" || $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['qt_reg_grid'] == "all") 
   { 
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['tot_geral'][1] ;  
       $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['tot_geral'][1];
   } 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['tot_geral'][1] ;  
   $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['tot_geral'][1];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
   {
       $this->Ini->Qtd_reg_ajax_grid = $this->count_ger;
   }
   else
   {
       $this->Ini->Qtd_reg_ajax_grid = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['qt_reg_grid'];
   }
//----- 
    if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
   { 
       $nmgp_select = "SELECT con_id, con_nombre, con_cedula, con_telefono, con_direccion_predio, con_toma_operativa, con_numero_medidor, con_numero_contrato, con_estado, con_propietario from (SELECT     con_id,     con_propietario,     con_nombre,     con_cedula,     con_telefono,     con_celular,     con_correo,     con_direccion_predio,     con_toma_operativa,     con_numero_medidor,     con_estado,     con_numero_contrato FROM     v_jap_contrato WHERE      con_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "'     and con_estado='V'     and con_id not in (SELECT rc_contrato  FROM jap_ruta_contrato inner join jap_rutas_medicion on rc_ruta=rut_id where rut_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "')) nm_sel_esp"; 
   } 
   ...
   $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['where_pesq']; 
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ordem_desc']; 
   } 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       ...
       $this->con_direccion_predio = $this->rs_grid->fields[4] ;  
       $this->con_toma_operativa = $this->rs_grid->fields[5] ;  
       $this->con_toma_operativa = (string)$this->con_toma_operativa;
       $this->con_numero_medidor = $this->rs_grid->fields[6] ;  
       $this->con_numero_contrato = $this->rs_grid->fields[7] ;  
       ...
       $this->SC_seq_page = 0;
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['final']; 
   ...
   $this->NM_hidden_filters = ($this->Ini->Embutida_iframe && !empty($this->nm_grid_sem_reg) && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['initialize']) ? true : false;
   $this->nmgp_reg_inicial  = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['final'] + 1;
   $this->nmgp_reg_final    = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['qt_reg_grid'];
   $this->nmgp_reg_final    = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['doc_word'] && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['word_return']);
       ...
       if ($this->Ini->Proc_print && $this->Ini->Export_html_zip  && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['print_return']);
           $this->pb->setTotalSteps($this->count_ger);
       }
       if (!$this->Ini->sc_export_ajax && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_contratos_sin_ruta'] ?> :: PDF</TITLE>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['pivot_charts']) : 0;
           ...
           if (-1 < $this->progress_grid)
           {
               ...
               contratos_sin_ruta_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
               contratos_sin_ruta_pdf_progress_call($this->Ini->path_js   . "\n", $this->Ini->Nm_lang);
               contratos_sin_ruta_pdf_progress_call($this->Ini->path_prod . "/img/\n", $this->Ini->Nm_lang);
               contratos_sin_ruta_pdf_progress_call($this->progress_tot   . "\n", $this->Ini->Nm_lang);
               ...
               contratos_sin_ruta_pdf_progress_call($this->progress_tot . "_#NM#_" . "1_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
       ...
       $nm_saida->saida("  <HEAD>\r\n");
       $nm_saida->saida("   <TITLE>" . $this->Ini->Nm_lang['lang_contratos_sin_ruta'] . "</TITLE>\r\n");
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida'] && $this->NM_opcao != "pdf") {
           $nm_saida->saida("   <link rel=\"shortcut icon\" href=\"../_lib/img/usr__NM__img__NM__favicon.png\">\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ajax_nav'] && !$this->Ini->sc_export_ajax)
       { 
           ...
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"contratos_sin_ruta_jquery_2682.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"contratos_sin_ruta_ajax.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"contratos_sin_ruta_message.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida']) {  
        ...
        <link rel='stylesheet' href='../_lib/lib/css/nm_mobile.css' type='text/css'/>
          <?php }
           ...
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['qt_reg_grid']) . ";\r\n");
           }
           ...
           $nm_saida->saida("    {\r\n");
           $nm_saida->saida("        let cells = $(\".sc-ui-grid-header-row-contratos_sin_ruta-1\").find(\"td\");\r\n");
           ...
           $nm_saida->saida("        rows = $(\".sc-ui-grid-header-row-contratos_sin_ruta-1\");\r\n");
           ...
           $nm_saida->saida("   var gridHeaders = $(\".sc-ui-grid-header-row-contratos_sin_ruta-1\"), headerDisplayed = true;\r\n");
           ...
           $nm_saida->saida("   tableOriginal = document.getElementById(\"sc-ui-grid-body-bccdde2f\");\r\n");
           ...
           if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao_print'] != 'print' && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['grid_pesq']))
           { 
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ancor_save']);
           }
           if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
           {
...
$nm_saida->saida("}\r\n");
       ...
       $nm_saida->saida("<style type=\"text/css\">\r\n");
       $nm_saida->saida("</style>\r\n");
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['num_css']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['num_css'] = rand(0, 1000);
       }
       $write_css = true;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida'] && !$this->Print_All && $this->NM_opcao != "print" && $this->NM_opcao != "pdf")
       {
           $write_css = false;
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida_pdf']) && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida_pdf'])
       {
           $write_css = true;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_contratos_sin_ruta_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida'])
       {
 ...
 { 
       ...
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_contratos_sin_ruta_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_contratos_sin_ruta_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "contratos_sin_ruta/contratos_sin_ruta_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['proc_pdf_vert'])
  {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           ...
           if ($Pos1 !== false && $Pos2 !== false) {
               ...
               $cada_css = ".contratos_sin_ruta_" . substr(trim($Tag[0]), 1);
               if (isset($Tag[1])) {
                   $cada_css .= ", .contratos_sin_ruta_" . substr(trim($Tag[1]), 1);
               }
               $cada_css .= $Css;
           }
           else {
               $cada_css = ".contratos_sin_ruta_" . substr($cada_css, 1);
           }
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   $this->css_body_embutida = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['css_body_embutida'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['css_body_embutida'] : "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida'])
   { 
       if (!$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['doc_word'] && ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao_print'] == "print")) 
       {
           if ($this->Print_All) 
           {
               $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
       ...
       {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
          $vertical_center = '';
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] != "pdf" && !$this->Print_All)
       { 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['css_body_embutida'])) {
       $remove_border = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['css_body_embutida'];
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['proc_pdf_vert'])
   {
   }
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['contratos_sin_ruta']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['contratos_sin_ruta']) . "_";
           } 
       } 
       else 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['contratos_sin_ruta']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['contratos_sin_ruta']) . "_";
           } 
       }
   }
   $temp_css  = explode("/", $compl_css);
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida']) ? "contratos_sin_ruta_" : "";
   $this->css_sep = " ";
...
//----- 
 function cabecalho_normal()
 {
   global
          $nm_saida;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['dashboard_info']['maximized'])
   {
       return; 
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opc_liga']['cab']))
   {
       return; 
   }
   if ($this->Ini->Embutida_iframe) {
   ...
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['where_pesq_filtro'];
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['cond_pesq']))
   {  
       $pos       = 0;
       $trab_pos  = false;
       $pos_tmp   = true; 
       $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['cond_pesq'];
       while ($pos_tmp)
       {
          $pos = strpos($tmp, "##*@@", $pos);
          if ($pos !== false)
       ...
       $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
       $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
       $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['cond_pesq'], 0, $trab_pos);
   ...
   { 
     ...
     else if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['proc_pdf_vert']) 
     {
   ...
   $nm_saida->saida("          " . $this->Ini->Nm_lang['lang_contratos_sin_ruta'] . "\r\n");
   $nm_saida->saida("        </TD>\r\n");
...
// 
 function label_grid($linhas = 0)
 {
   ...
   $salva_htm_emb  = "";
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida_label'])
   { 
       $this->New_label['con_id'] = "" . $this->Ini->Nm_lang['lang_id'] . "";
       $this->New_label['con_nombre'] = "" . $this->Ini->Nm_lang['lang_lot_nombre_completo'] . "";
       $this->New_label['con_cedula'] = "" . $this->Ini->Nm_lang['lang_cedula'] . "";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['exibe_titulos']) && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
   ...
   $nm_saida->saida("    <TR id=\"tit_contratos_sin_ruta__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-contratos_sin_ruta-" . $tmp_header_row . "\">\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida_label']) { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opc_psq']) { 
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['field_order'] as $Cada_label)
   { 
   ...
   $nm_saida->saida("</TR>\r\n");
             ...
             foreach ($NM_css as $cada_css)
             {
                 ...
                 if ($Pos1 !== false && $Pos2 !== false) {
                     ...
                     $css_emb .= $cada_css . $Css;
                       ...
                       $css_emb .= ".contratos_sin_ruta_" . substr($cada_css, 1);
                 }
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
     ...
     $NM_seq_lab = 1;
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['labels'] as $NM_cmp => $NM_lab)
     {
         if (empty($NM_lab) || $NM_lab == "&nbsp;")
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['labels'][$NM_cmp] = "No_Label" . $NM_seq_lab;
             $NM_seq_lab++;
         }
     } 
   } 
 ...
 function NM_label_con_id()
 {
   ...
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] != 'pdf') {
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['con_numero_contrato'])) ? $this->New_label['con_numero_contrato'] : "" . $this->Ini->Nm_lang['lang_contrato'] . "";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
...
function SC_label_rightActionBar()
{
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ordem_cmp'] == $fieldName) {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ordem_label'] == 'desc') {
                $sortRule = 'desc';
            } else {
                $sortRule = 'asc';
            }
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ini_cor_grid']);
       }
   }
...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['labels']['con_id'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['con_nombre'])) ? $this->New_label['con_nombre'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['labels']['con_nombre'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['con_cedula'])) ? $this->New_label['con_cedula'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['labels']['con_cedula'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['con_telefono'])) ? $this->New_label['con_telefono'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['labels']['con_telefono'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['con_direccion_predio'])) ? $this->New_label['con_direccion_predio'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['labels']['con_direccion_predio'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['con_toma_operativa'])) ? $this->New_label['con_toma_operativa'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['labels']['con_toma_operativa'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['con_numero_medidor'])) ? $this->New_label['con_numero_medidor'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['labels']['con_numero_medidor'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['con_numero_contrato'])) ? $this->New_label['con_numero_contrato'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['labels']['con_numero_contrato'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['con_estado'])) ? $this->New_label['con_estado'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['labels']['con_estado'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['con_propietario'])) ? $this->New_label['con_propietario'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['labels']['con_propietario'] = $SC_Label; 
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['contratos_sin_ruta']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['contratos_sin_ruta']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['contratos_sin_ruta']['lig_edit'];
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_contratos_sin_ruta#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               ...
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['cab_embutida'] != "S")
               {
       ...
       else
       {
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['force_toolbar'] = true;
           } 
...
else
{
       ...
       $nm_id_aplicacao = " id=\"apl_contratos_sin_ruta#?#1\"";
   } 
   $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] == "pdf") ? "padding: 0px !important;" : "";
if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['proc_pdf_vert'])
{
}
else
...
if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['proc_pdf']) { 
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['proc_pdf']) { 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-bccdde2f\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['proc_pdf_vert']) { 
    $nm_saida->saida("</thead>\r\n");
 }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['proc_pdf'] && $this->pdf_all_label != "S" && $this->pdf_label_group != "S") 
   { 
      $this->label_grid($linhas);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida_grid'])
...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['Config_Page_break_PDF'] = "S";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['Page_break_PDF']))
   {
       if (isset($this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['SC_Ind_Groupby']]))
       {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['SC_Gb_Free_cmp'] as $Cmp_gb => $resto)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['Page_break_PDF'][$Cmp_gb] = $this->Break_pag_pdf['sc_free_group_by'][$Cmp_gb];
               }
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['Page_break_PDF'] = $this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['SC_Ind_Groupby']];
           }
       }
       else
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['Page_break_PDF'] = array();
       }
   }
   ...
   $nm_houve_quebra = "N";
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          ...
          //---------- Gauge ----------
          if (!$this->Ini->sc_export_ajax && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
              if (0 == $this->progress_lim_now)
              {
               ...
               if (!NM_is_utf8($lang_protect))
               {
                  ...
                  contratos_sin_ruta_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $lang_protect . " " . $this->progress_now . "...\n", $this->Ini->Nm_lang);
          ...
          $this->con_propietario = (string)$this->con_propietario;
          $this->SC_seq_page++; 
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['final'] + 1; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['rows_emb']++;
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida_opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['dado_psq_ret'];
 ...
 $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcapture", "document.Fpesq.nm_ret_psq.value='" . str_replace(array("'", '"'), array("\'", '\"'), $teste) . "'; nm_escreve_window();", "document.Fpesq.nm_ret_psq.value='" . str_replace(array("'", '"'), array("\'", '\"'), $teste) . "'; nm_escreve_window();", "", "Rad_psq", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
          ...
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['field_order'] as $Cada_col)
          { 
   ...
   $this->SC_grid_rightActionBar();
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['exibe_total'] == "S")
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
       } 
   }  
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida_grid'])
...
function SC_grid_rightActionBar()
{
 ...
 function NM_grid_con_nombre()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['con_nombre']) || $this->NM_cmp_hidden['con_nombre'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
 ...
 function NM_grid_con_numero_medidor()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_con_numero_medidor_grid_line . "\"  style=\"" . $this->Css_Cmp['css_con_numero_medidor_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_con_numero_medidor_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_con_numero_contrato()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_con_numero_contrato_grid_line . "\"  style=\"" . $this->Css_Cmp['css_con_numero_contrato_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_con_numero_contrato_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 ...
 function nm_quebra_pagina($nm_parms)
 {
    ...
    if (($this->Ini->nm_limite_lin > 0 && $this->Ini->nm_cont_lin > $this->Ini->nm_limite_lin) || $nm_parms == "pagina" || $nm_parms == "resumo" || $nm_parms == "total")
    {
        ...
        if ($this->Print_All)
        {
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['print_navigator']) && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['print_navigator'] == "Netscape")
            {
        ...
        if ($nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida'])
        {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['proc_pdf']) { 
           }
           else
           {
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['proc_pdf_vert']) { 
                $nm_saida->saida("     <thead>\r\n");
               }
               $this->cabecalho();
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['proc_pdf_vert']) { 
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['proc_pdf'] && ($this->pdf_all_cab == "S" || $this->pdf_all_label == "S")) { 
            $nm_saida->saida(" <thead> \r\n");
            if ($this->pdf_all_cab == "S")
            {
                $this->cabecalho();
            }
            if ($this->pdf_all_label == "S" && $nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida_grid'])
            {
                $this->label_grid();
            }
            $nm_saida->saida(" </thead> \r\n");
        }
        if (!$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['proc_pdf'] && $nm_parms != "resumo" && $nm_parms != "pagina" && !$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida_grid'])
        {
            $this->label_grid();
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['proc_pdf'] && $this->pdf_label_group != "S" && !$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida_grid'])
        {
            $this->nm_inicio_pag = 0;
        }
    }
...
$nm_saida->saida("    </style>\r\n");
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on" && !$this->NM_hidden_filters)
      {
          ...
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['fast_search'][2] : "";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ajax_nav'])
          {
      ...
      if ($this->nmgp_botoes['sel_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      $pos_path = strrpos($this->Ini->path_prod, "/");
      $path_fields = $this->Ini->root . substr($this->Ini->path_prod, 0, $pos_path) . "/conf/fields/";
              $this->nm_btn_exist['sel_col'][] = "selcmp_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcolumns", "scBtnSelCamposShow('" . $this->Ini->path_link . "contratos_sin_ruta/contratos_sin_ruta_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnSelCamposShow('" . $this->Ini->path_link . "contratos_sin_ruta/contratos_sin_ruta_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "selcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['sort_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          else
          {
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bsort", "scBtnOrderCamposShow('" . $this->Ini->path_link . "contratos_sin_ruta/contratos_sin_ruta_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnOrderCamposShow('" . $this->Ini->path_link . "contratos_sin_ruta/contratos_sin_ruta_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "ordcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      ...
      if ($this->nmgp_botoes['group_1'] == "on" && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("           $Cod_Btn\r\n");
      if ($this->nmgp_botoes['pdf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      ...
      $Tem_pdf_res = "n";
          ...
          $nm_saida->saida("            <div id=\"div_pdf_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "pdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "contratos_sin_ruta/contratos_sin_ruta_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=8&lpapel=279&apapel=216&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&sc_ver_93=s&nm_tem_gb=" . $Tem_gb_pdf . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_pdf_res=grid&nm_all_modules=grid&nm_label_group=N&nm_all_cab=S&nm_all_label=S&nm_orient_grid=2&password=n&summary_export_columns=S&pdf_zip=N&origem=cons&language=es&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=contratos_sin_ruta&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_word_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['SC_Ind_Groupby'] != "sc_free_total")
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['SC_Gb_Free_cmp']))
          {
              $Tem_word_res = "n";
          }
          $nm_saida->saida("            <div id=\"div_word_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $this->nm_btn_exist['word'][] = "word_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "contratos_sin_ruta/contratos_sin_ruta_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=" . $Tem_word_res . "&nm_ini_word_res=grid&nm_all_modules=grid&password=n&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_xls_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['SC_Ind_Groupby'] != "sc_free_total")
          ...
          $nm_saida->saida("            <div id=\"div_xls_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "xls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "contratos_sin_ruta/contratos_sin_ruta_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=contratos_sin_ruta&nm_tp_xls=xlsx&nm_tot_xls=S&nm_res_cons=" . $Tem_xls_res . "&nm_ini_xls_res=grid&nm_all_modules=grid&password=n&summary_export_columns=S&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['xml'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_xml_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['SC_Ind_Groupby'] != "sc_free_total")
          ...
          $nm_saida->saida("            <div id=\"div_xml_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "xml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "contratos_sin_ruta/contratos_sin_ruta_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_xml_res . "&nm_ini_xml_res=grid&nm_all_modules=grid&nm_xml_tag=tag&nm_xml_label=S&language=es&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['csv'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_csv_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['SC_Ind_Groupby'] != "sc_free_total")
          ...
          $nm_saida->saida("            <div id=\"div_csv_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "csv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "contratos_sin_ruta/contratos_sin_ruta_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_csv_res . "&nm_ini_csv_res=grid&nm_all_modules=grid&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=es&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['rtf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
      ...
      if ($this->nmgp_botoes['print'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Tem_pdf_res = "n";
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div id=\"div_print_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $this->nm_btn_exist['print'][] = "print_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "print_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "contratos_sin_ruta/contratos_sin_ruta_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=RC&nm_cor=CO&password=n&language=es&nm_page=" . NM_encode_input($this->Ini->sc_page) . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_prt_res=grid&nm_all_modules=grid&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if (is_file($this->Ini->root . $this->Ini->path_img_global . $this->Ini->Img_sep_grid))
      {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['SC_Ind_Groupby'] != "sc_free_total")
        {
          ...
          if (is_file("contratos_sin_ruta_help.txt") && !$this->grid_emb_form)
          {
             $Arq_WebHelp = file("contratos_sin_ruta_help.txt"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['dashboard_info']['under_dashboard']))
      {
         $this->nmgp_botoes['exit'] = "off"; 
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opc_psq'])
      ...
      {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['sc_modal'])
        {
...
$nm_saida->saida("    </style>\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao_print'] != "print") 
      {
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['qtline'] == "on" && $this->Ini->Apl_paginacao != "FULL")
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['qt_lin_grid'] == '10') ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['qt_lin_grid'] == '20') ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['qt_lin_grid'] == '50') ? " selected" : "";
              $nm_saida->saida("           <option value=\"50\" " . $obj_sel . ">50</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['qt_lin_grid'] == 'all') ? " selected" : "";
      ...
      if (is_file($this->Ini->root . $this->Ini->path_img_global . $this->Ini->Img_sep_grid))
      {
          ...
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opc_liga']['nav']))
          {
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['navpage'] == "on" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opc_liga']['nav']) && $this->Ini->Apl_paginacao != "FULL" && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['qt_lin_grid'] != "all")
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['qt_lin_grid'];
              $Max_link   = 5;
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opc_liga']['nav']))
          {
...
$nm_saida->saida("    </style>\r\n");
      ...
      $Tem_pdf_res = "n";
              $this->nm_btn_exist['pdf'][] = "pdf_top";
          $nm_saida->saida("            <div id=\"div_pdf_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "pdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "contratos_sin_ruta/contratos_sin_ruta_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=8&lpapel=279&apapel=216&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&sc_ver_93=s&nm_tem_gb=" . $Tem_gb_pdf . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_pdf_res=grid&nm_all_modules=grid&nm_label_group=N&nm_all_cab=S&nm_all_label=S&nm_orient_grid=2&password=n&summary_export_columns=S&pdf_zip=N&origem=cons&language=es&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=contratos_sin_ruta&KeepThis=true&TB_iframe=true&modal=true", "group_4", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_word_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $this->nm_btn_exist['word'][] = "word_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "contratos_sin_ruta/contratos_sin_ruta_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=" . $Tem_word_res . "&nm_ini_word_res=grid&nm_all_modules=grid&password=n&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_4", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
...
$nm_saida->saida("    </style>\r\n");
   ...
   function html_grid_search()
   {
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['grid_pesq'])?'none':'';
       if(!$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ajax_nav'])
       {
          $nm_saida->saida("   <tr id=\"NM_Grid_Search\" ajax='' style='display:" . $str_display . "'>\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['grid_pesq']))
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['grid_pesq'] as $cmp => $def)
           {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['save_grid']))
           {
               return;
           }
           else
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
                        ...
                        if ($cmp == "con_propietario")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "con_propietario";
                           $lin_obj = $this->grid_search_con_propietario($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
                        if ($cmp == "con_nombre")
                        {
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['save_grid']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['grid_pesq']))
           { 
   ...
   {
       $lin_obj  = "";
       $All_cmp_search = array('con_id','con_propietario','con_nombre');
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['pesq_tab_label'];
       if (!empty($nmgp_tab_label))
       {
          $nm_tab_campos = explode("?@?", $nmgp_tab_label);
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['grid_pesq']) && count($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['grid_pesq']) < 3)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
   ...
   function grid_search_con_id($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $lin_obj .= "       <select id='grid_search_con_id_cond_" . $ind . "' name='cond_grid_search_con_id_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle;' onChange='grid_search_hide_input(\"con_id\", $ind)'>";
       ...
       $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_con_id_val_" . $ind . "' name='val_grid_search_con_id_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=4 alt=\"{datatype: 'decimal', maxLength: 4, precision: 0, decimalSep: '" . $_SESSION['scriptcase']['reg_conf']['dec_num'] . "', thousandsSep: '" . $_SESSION['scriptcase']['reg_conf']['grup_num'] . "', allowNegative: false, onlyNegative: false, enterTab: false}\">";
       $lin_obj .= "       </span>";
       $lin_obj .= "          </div>";
   ...
   function grid_search_con_propietario($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_con_propietario_" . $ind . "' style='display:none; z-index: 10'>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterLabel'>". NM_encode_input($label) ." <span class='scGridFilterTagListFilterLabelClose' onclick='closeAllTags(this);'></span></div>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterInputs'>";
       if (empty($opc))
       {
       ...
       $lin_obj .= "       <select id='grid_search_con_propietario_cond_" . $ind . "' name='cond_grid_search_con_propietario_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle;' onChange='grid_search_hide_input(\"con_propietario\", $ind)'>";
       $selected = ($opc == "gt") ? " selected" : "";
       $lin_obj .= "        <option value='gt'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_grtr'] . "</option>";
       $selected = ($opc == "lt") ? " selected" : "";
       $lin_obj .= "        <option value='lt'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_less'] . "</option>";
       ...
       $lin_obj .= "       <span id=\"grid_con_propietario_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       nmgp_Form_Num_Val($val_cmp, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
       $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_con_propietario_val_" . $ind . "' name='val_grid_search_con_propietario_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=4 alt=\"{datatype: 'decimal', maxLength: 4, precision: 0, decimalSep: '" . $_SESSION['scriptcase']['reg_conf']['dec_num'] . "', thousandsSep: '" . $_SESSION['scriptcase']['reg_conf']['grup_num'] . "', allowNegative: false, onlyNegative: false, enterTab: false}\">";
       $lin_obj .= "       </span>";
       $lin_obj .= "          </div>";
       $lin_obj .= "          <div class='scGridFilterTagListFilterBar'>";
       $lin_obj .= nmButtonOutput($this->arr_buttons, "bapply_appdiv", "closeAllTags();setTimeout(function() {nm_proc_grid_search($ind, 'proc_grid_search', 'grid_search')}, 200);", "closeAllTags();setTimeout(function() {nm_proc_grid_search($ind, 'proc_grid_search', 'grid_search')}, 200);", "grid_search_apply_" . $ind . "", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
   ...
   function grid_search_con_nombre($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $lin_obj .= "       <select id='grid_search_con_nombre_cond_" . $ind . "' name='cond_grid_search_con_nombre_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle;' onChange='grid_search_hide_input(\"con_nombre\", $ind)'>";
       ...
       $nm_comando = "select distinct con_nombre from (SELECT     con_id,     con_propietario,     con_nombre,     con_cedula,     con_telefono,     con_celular,     con_correo,     con_direccion_predio,     con_toma_operativa,     con_numero_medidor,     con_estado,     con_numero_contrato FROM     v_jap_contrato WHERE      con_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "'     and con_estado='V'     and con_id not in (SELECT rc_contrato  FROM jap_ruta_contrato inner join jap_rutas_medicion on rc_ruta=rut_id where rut_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "')) nm_sel_esp where #lowerI#con_nombre#lowerF# = #lowerI#'$con_nombre_look'#lowerF#"; 
   ...
   function lookup_ajax_con_nombre($con_nombre)
   {
       ...
       $con_nombre_look = (is_string($con_nombre) ? substr($this->Db->qstr($con_nombre), 1, -1) : $con_nombre); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct con_nombre from (SELECT     con_id,     con_propietario,     con_nombre,     con_cedula,     con_telefono,     con_celular,     con_correo,     con_direccion_predio,     con_toma_operativa,     con_numero_medidor,     con_estado,     con_numero_contrato FROM     v_jap_contrato WHERE      con_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "'     and con_estado='V'     and con_id not in (SELECT rc_contrato  FROM jap_ruta_contrato inner join jap_rutas_medicion on rc_ruta=rut_id where rut_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "')) nm_sel_esp where  #lowerI#con_nombre#lowerF# like #lowerI#'%" . $con_nombre . "%'#lowerF#"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
      ...
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
          ...
          { 
            ...
            $cmp1 = contratos_sin_ruta_pack_protect_string($cmp1);
            $nmgp_def_dados[] = array($cmp1 => $cmp1); 
             $rs->MoveNext(); 
          } 
          $rs->Close(); 
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "SIJAP/contratos_sin_ruta";
   ...
   function JS_grid_search()
   {
       ...
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'con_propietario')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                     result  = grid_search_get_text(obj_dyn + i, '');\r\n");
       $nm_saida->saida("                 }\r\n");
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   ...
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
       $nm_saida->saida("   document.getElementById('first_bot').disabled = true;\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['ajax_nav'])
       {
   ...
   $nm_saida->saida("   if (typeof(scSetFixedHeaders) === typeof(function(){})) scSetFixedHeaders();\r\n");
   $nm_saida->saida("  });\r\n");
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
               $nm_saida->saida("   document.getElementById('forward_bot').disabled = true;\r\n");
               $nm_saida->saida("   document.getElementById('forward_bot').className = \"scButton_" . $this->arr_buttons['bcons_avanca']['style'] . " disabled\";\r\n");
   ...
   if ($this->grid_emb_form || $this->grid_emb_form_full)
   {
       ...
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('contratos_sin_ruta', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"contratos_sin_ruta\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"contratos_sin_ruta_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("                     action=\"contratos_sin_ruta_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "contratos_sin_ruta/contratos_sin_ruta_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
   ...
   $nm_saida->saida("           document.Fdoc_word.action = \"contratos_sin_ruta_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("           document.F3.SC_module_export.value = z;\r\n");
   $nm_saida->saida("       }\r\n");
   $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['contratos_sin_ruta_iframe_params'] = array(
   ...
   $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@contratos_sin_ruta@SC_par@" . md5($prep_parm_pdf);
   $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   $nm_saida->saida("               document.Fpdf.action=\"contratos_sin_ruta_iframe.php\";\r\n");
   ...
   $nm_saida->saida("               document.Fprint.action = \"contratos_sin_ruta_export_ctrl.php\";\r\n");
   $nm_saida->saida("           }\r\n");
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   ...
   $nm_saida->saida("           document.Fexport.action = \"contratos_sin_ruta_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['campo_psq_ret']) )
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['contratos_sin_ruta']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form  = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Form1 = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("           var Obj_Doc   = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form  = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Form1 = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("          var Obj_Doc   = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form  = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Form1 = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['campo_psq_ret']) . ";\r\n");
          $nm_saida->saida("          var Obj_Doc   = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"contratos_sin_ruta_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['reg_start']))
   {
       $nm_saida->saida("      $(document).ready(function(){\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailStatus('contratos_sin_ruta')\",50);\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('contratos_sin_ruta', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      })\r\n");
   }
