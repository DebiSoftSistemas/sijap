...
class contratos_sin_ruta_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['contratos_sin_ruta']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['contratos_sin_ruta']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang ;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*) from (SELECT     con_id,     con_propietario,     con_nombre,     con_cedula,     con_telefono,     con_celular,     con_correo,     con_direccion_predio,     con_toma_operativa,     con_numero_medidor,     con_estado,     con_numero_contrato FROM     v_jap_contrato WHERE      con_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "'     and con_estado='V'     and con_id not in (SELECT rc_contrato  FROM jap_ruta_contrato inner join jap_rutas_medicion on rc_ruta=rut_id where rut_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "')) nm_sel_esp " . $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['where_pesq']; 
      } 
      else 
      { 
          $nm_comando = "select count(*) from (SELECT     con_id,     con_propietario,     con_nombre,     con_cedula,     con_telefono,     con_celular,     con_correo,     con_direccion_predio,     con_toma_operativa,     con_numero_medidor,     con_estado,     con_numero_contrato FROM     v_jap_contrato WHERE      con_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "'     and con_estado='V'     and con_id not in (SELECT rc_contrato  FROM jap_ruta_contrato inner join jap_rutas_medicion on rc_ruta=rut_id where rut_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "')) nm_sel_esp " . $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['where_pesq']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['contratos_sin_ruta']['contr_total_geral'] = "OK";
   } 
