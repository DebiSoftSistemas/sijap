...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "con_id";$Nm_numeric[] = "con_propietario";$Nm_numeric[] = "con_toma_operativa";$Nm_numeric[] = "con_id";$Nm_numeric[] = "con_propietario";$Nm_numeric[] = "con_toma_operativa";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_con_id_cond" name="con_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_con_id'), this, 'con_id')">
      ...
      <br><span id="id_hide_con_id"  <?php echo $str_hide_con_id?>><INPUT  type="text" id="SC_con_id" name="con_id" value="<?php echo NM_encode_input($con_id) ?>" size=4 alt="{datatype: 'integer', maxLength: 4, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_con_propietario_cond" name="con_propietario_cond" onChange="nm_campos_between(document.getElementById('id_vis_con_propietario'), this, 'con_propietario')">
      ...
      <br><span id="id_hide_con_propietario"  <?php echo $str_hide_con_propietario?>><INPUT  type="text" id="SC_con_propietario" name="con_propietario" value="<?php echo NM_encode_input($con_propietario) ?>" size=4 alt="{datatype: 'integer', maxLength: 4, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_con_nombre_cond" name="con_nombre_cond" onChange="nm_campos_between(document.getElementById('id_vis_con_nombre'), this, 'con_nombre')">
      ...
      <br><span id="id_hide_con_nombre"  <?php echo $str_hide_con_nombre?>><?php
      if ($con_nombre != "")
      {
      $con_nombre_look = (is_string($con_nombre) ? substr($this->Db->qstr($con_nombre), 1, -1) : $con_nombre); 
      $nmgp_def_dados = array(); 
