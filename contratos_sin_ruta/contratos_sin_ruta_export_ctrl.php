<?php
@session_start() ;
$_SESSION['scriptcase']['contratos_sin_ruta']['sc_process_barr'] = true;
require_once('../contratos_sin_ruta/index.php');
unset($_SESSION['scriptcase']['contratos_sin_ruta']['sc_process_barr']);
$ExportCtrl = new contratos_sin_ruta_export_control;
$ExportCtrl->Export_barr();

class contratos_sin_ruta_export_control
{
