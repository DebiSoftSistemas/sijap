...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIJAP_____contratos_sin_ruta"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIJAP_____contratos_sin_ruta"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['contratos_sin_ruta']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['contratos_sin_ruta']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['contratos_sin_ruta']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['contratos_sin_ruta']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['contratos_sin_ruta']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>contratos_sin_ruta</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['contratos_sin_ruta']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['contratos_sin_ruta']['embutida_filho'] as $ind => $sc_init)
          {
