  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_config_smtp" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sis_config_smtp_form();
	}
...
?>
  ...
  function do_ajax_form_sis_config_smtp_validate_csmtp_servidor()
  {
    var nomeCampo_csmtp_servidor = "csmtp_servidor";
    var var_csmtp_servidor = scAjaxGetFieldText(nomeCampo_csmtp_servidor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_config_smtp_validate_csmtp_servidor(var_csmtp_servidor, var_script_case_init, do_ajax_form_sis_config_smtp_validate_csmtp_servidor_cb);
  } // do_ajax_form_sis_config_smtp_validate_csmtp_servidor

  function do_ajax_form_sis_config_smtp_validate_csmtp_servidor_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_config_smtp_validate_csmtp_servidor_cb

  // ---------- Validate csmtp_usuario
  function do_ajax_form_sis_config_smtp_validate_csmtp_usuario()
  {
    var nomeCampo_csmtp_usuario = "csmtp_usuario";
    var var_csmtp_usuario = scAjaxGetFieldText(nomeCampo_csmtp_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_config_smtp_validate_csmtp_usuario(var_csmtp_usuario, var_script_case_init, do_ajax_form_sis_config_smtp_validate_csmtp_usuario_cb);
  } // do_ajax_form_sis_config_smtp_validate_csmtp_usuario

  function do_ajax_form_sis_config_smtp_validate_csmtp_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_config_smtp_validate_csmtp_usuario_cb

  // ---------- Validate csmtp_email_seguridad
  function do_ajax_form_sis_config_smtp_validate_csmtp_email_seguridad()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_config_smtp_validate_csmtp_email_seguridad(var_csmtp_email_seguridad, var_script_case_init, do_ajax_form_sis_config_smtp_validate_csmtp_email_seguridad_cb);
  } // do_ajax_form_sis_config_smtp_validate_csmtp_email_seguridad

  function do_ajax_form_sis_config_smtp_validate_csmtp_email_seguridad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_config_smtp_validate_csmtp_email_seguridad_cb

  // ---------- Validate csmtp_contrasenia
  function do_ajax_form_sis_config_smtp_validate_csmtp_contrasenia()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_config_smtp_validate_csmtp_contrasenia(var_csmtp_contrasenia, var_script_case_init, do_ajax_form_sis_config_smtp_validate_csmtp_contrasenia_cb);
  } // do_ajax_form_sis_config_smtp_validate_csmtp_contrasenia

  function do_ajax_form_sis_config_smtp_validate_csmtp_contrasenia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_config_smtp_validate_csmtp_contrasenia_cb

  // ---------- Validate csmtp_puerto_php
  function do_ajax_form_sis_config_smtp_validate_csmtp_puerto_php()
  {
    var nomeCampo_csmtp_puerto_php = "csmtp_puerto_php";
    var var_csmtp_puerto_php = scAjaxGetFieldText(nomeCampo_csmtp_puerto_php);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_config_smtp_validate_csmtp_puerto_php(var_csmtp_puerto_php, var_script_case_init, do_ajax_form_sis_config_smtp_validate_csmtp_puerto_php_cb);
  } // do_ajax_form_sis_config_smtp_validate_csmtp_puerto_php

  function do_ajax_form_sis_config_smtp_validate_csmtp_puerto_php_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_config_smtp_validate_csmtp_puerto_php_cb

  // ---------- Validate csmtp_tipo_conexion
  function do_ajax_form_sis_config_smtp_validate_csmtp_tipo_conexion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_config_smtp_validate_csmtp_tipo_conexion(var_csmtp_tipo_conexion, var_script_case_init, do_ajax_form_sis_config_smtp_validate_csmtp_tipo_conexion_cb);
  } // do_ajax_form_sis_config_smtp_validate_csmtp_tipo_conexion

  function do_ajax_form_sis_config_smtp_validate_csmtp_tipo_conexion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_config_smtp_validate_csmtp_tipo_conexion_cb

  // ---------- Validate csmtp_nombre_empresa
  function do_ajax_form_sis_config_smtp_validate_csmtp_nombre_empresa()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_config_smtp_validate_csmtp_nombre_empresa(var_csmtp_nombre_empresa, var_script_case_init, do_ajax_form_sis_config_smtp_validate_csmtp_nombre_empresa_cb);
  } // do_ajax_form_sis_config_smtp_validate_csmtp_nombre_empresa

  function do_ajax_form_sis_config_smtp_validate_csmtp_nombre_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_config_smtp_validate_csmtp_nombre_empresa_cb

  // ---------- Validate csmtp_ruta_imagenes
  function do_ajax_form_sis_config_smtp_validate_csmtp_ruta_imagenes()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_config_smtp_validate_csmtp_ruta_imagenes(var_csmtp_ruta_imagenes, var_script_case_init, do_ajax_form_sis_config_smtp_validate_csmtp_ruta_imagenes_cb);
  } // do_ajax_form_sis_config_smtp_validate_csmtp_ruta_imagenes

  function do_ajax_form_sis_config_smtp_validate_csmtp_ruta_imagenes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_config_smtp_validate_csmtp_ruta_imagenes_cb

  // ---------- Validate csmtp_ruta_plantillas
  function do_ajax_form_sis_config_smtp_validate_csmtp_ruta_plantillas()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_config_smtp_validate_csmtp_ruta_plantillas(var_csmtp_ruta_plantillas, var_script_case_init, do_ajax_form_sis_config_smtp_validate_csmtp_ruta_plantillas_cb);
  } // do_ajax_form_sis_config_smtp_validate_csmtp_ruta_plantillas

  function do_ajax_form_sis_config_smtp_validate_csmtp_ruta_plantillas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_config_smtp_validate_csmtp_ruta_plantillas_cb

  // ---------- Validate csmtp_dominio
  function do_ajax_form_sis_config_smtp_validate_csmtp_dominio()
  {
    var nomeCampo_csmtp_dominio = "csmtp_dominio";
    var var_csmtp_dominio = scAjaxGetFieldText(nomeCampo_csmtp_dominio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_config_smtp_validate_csmtp_dominio(var_csmtp_dominio, var_script_case_init, do_ajax_form_sis_config_smtp_validate_csmtp_dominio_cb);
  } // do_ajax_form_sis_config_smtp_validate_csmtp_dominio

  function do_ajax_form_sis_config_smtp_validate_csmtp_dominio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_config_smtp_validate_csmtp_dominio_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_sis_config_smtp_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_sis_config_smtp_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_sis_config_smtp_submit_form(var_csmtp_servidor, var_csmtp_usuario, var_csmtp_email_seguridad, var_csmtp_contrasenia, var_csmtp_puerto_php, var_csmtp_tipo_conexion, var_csmtp_nombre_empresa, var_csmtp_ruta_imagenes, var_csmtp_ruta_plantillas, var_csmtp_dominio, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_config_smtp_submit_form_cb);
  } // do_ajax_form_sis_config_smtp_submit_form

  function do_ajax_form_sis_config_smtp_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_sis_config_smtp_submit_form_cb_after_alert);
  } // do_ajax_form_sis_config_smtp_submit_form_cb
  function do_ajax_form_sis_config_smtp_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_config_smtp_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sis_config_smtp_navigate_form()
  {
    perform_ajax_form_sis_config_smtp_navigate_form();
  }

  function perform_ajax_form_sis_config_smtp_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_sis_config_smtp_navigate_form(var_csmtp_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_config_smtp_navigate_form_cb);
  } // do_ajax_form_sis_config_smtp_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_config_smtp']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_config_smtp_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_config_smtp_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_config_smtp_navigate_form_cb
  function do_ajax_form_sis_config_smtp_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_sis_config_smtp_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_sis_config_smtp_navigate_form_cb_after_alert

  function sc_hide_form_sis_config_smtp_form()
  {
