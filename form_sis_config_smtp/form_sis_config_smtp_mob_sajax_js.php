  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_config_smtp_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sis_config_smtp_mob_form();
	}
...
?>
  ...
  // ---------- Validate csmtp_servidor
  function do_ajax_form_sis_config_smtp_mob_validate_csmtp_servidor()
  {
    var nomeCampo_csmtp_servidor = "csmtp_servidor";
    var var_csmtp_servidor = scAjaxGetFieldText(nomeCampo_csmtp_servidor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_config_smtp_mob_validate_csmtp_servidor(var_csmtp_servidor, var_script_case_init, do_ajax_form_sis_config_smtp_mob_validate_csmtp_servidor_cb);
  } // do_ajax_form_sis_config_smtp_mob_validate_csmtp_servidor

  function do_ajax_form_sis_config_smtp_mob_validate_csmtp_servidor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "csmtp_servidor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_config_smtp_mob_validate_csmtp_servidor_cb

  // ---------- Validate csmtp_usuario
  function do_ajax_form_sis_config_smtp_mob_validate_csmtp_usuario()
  {
    var nomeCampo_csmtp_usuario = "csmtp_usuario";
    var var_csmtp_usuario = scAjaxGetFieldText(nomeCampo_csmtp_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_config_smtp_mob_validate_csmtp_usuario(var_csmtp_usuario, var_script_case_init, do_ajax_form_sis_config_smtp_mob_validate_csmtp_usuario_cb);
  } // do_ajax_form_sis_config_smtp_mob_validate_csmtp_usuario

  function do_ajax_form_sis_config_smtp_mob_validate_csmtp_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "csmtp_usuario";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_config_smtp_mob_validate_csmtp_usuario_cb

  // ---------- Validate csmtp_email_seguridad
  function do_ajax_form_sis_config_smtp_mob_validate_csmtp_email_seguridad()
  {
    var nomeCampo_csmtp_email_seguridad = "csmtp_email_seguridad";
    var var_csmtp_email_seguridad = scAjaxGetFieldText(nomeCampo_csmtp_email_seguridad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_config_smtp_mob_validate_csmtp_email_seguridad(var_csmtp_email_seguridad, var_script_case_init, do_ajax_form_sis_config_smtp_mob_validate_csmtp_email_seguridad_cb);
  } // do_ajax_form_sis_config_smtp_mob_validate_csmtp_email_seguridad

  function do_ajax_form_sis_config_smtp_mob_validate_csmtp_email_seguridad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "csmtp_email_seguridad";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_config_smtp_mob_validate_csmtp_email_seguridad_cb

  // ---------- Validate csmtp_contrasenia
  function do_ajax_form_sis_config_smtp_mob_validate_csmtp_contrasenia()
  {
    var nomeCampo_csmtp_contrasenia = "csmtp_contrasenia";
    var var_csmtp_contrasenia = scAjaxGetFieldText(nomeCampo_csmtp_contrasenia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_config_smtp_mob_validate_csmtp_contrasenia(var_csmtp_contrasenia, var_script_case_init, do_ajax_form_sis_config_smtp_mob_validate_csmtp_contrasenia_cb);
  } // do_ajax_form_sis_config_smtp_mob_validate_csmtp_contrasenia

  function do_ajax_form_sis_config_smtp_mob_validate_csmtp_contrasenia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "csmtp_contrasenia";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_config_smtp_mob_validate_csmtp_contrasenia_cb

  // ---------- Validate csmtp_puerto_php
  function do_ajax_form_sis_config_smtp_mob_validate_csmtp_puerto_php()
  {
    var nomeCampo_csmtp_puerto_php = "csmtp_puerto_php";
    var var_csmtp_puerto_php = scAjaxGetFieldText(nomeCampo_csmtp_puerto_php);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_config_smtp_mob_validate_csmtp_puerto_php(var_csmtp_puerto_php, var_script_case_init, do_ajax_form_sis_config_smtp_mob_validate_csmtp_puerto_php_cb);
  } // do_ajax_form_sis_config_smtp_mob_validate_csmtp_puerto_php

  function do_ajax_form_sis_config_smtp_mob_validate_csmtp_puerto_php_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "csmtp_puerto_php";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_config_smtp_mob_validate_csmtp_puerto_php_cb

  // ---------- Validate csmtp_tipo_conexion
  function do_ajax_form_sis_config_smtp_mob_validate_csmtp_tipo_conexion()
  {
    var nomeCampo_csmtp_tipo_conexion = "csmtp_tipo_conexion";
    var var_csmtp_tipo_conexion = scAjaxGetFieldSelect(nomeCampo_csmtp_tipo_conexion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_config_smtp_mob_validate_csmtp_tipo_conexion(var_csmtp_tipo_conexion, var_script_case_init, do_ajax_form_sis_config_smtp_mob_validate_csmtp_tipo_conexion_cb);
  } // do_ajax_form_sis_config_smtp_mob_validate_csmtp_tipo_conexion

  function do_ajax_form_sis_config_smtp_mob_validate_csmtp_tipo_conexion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "csmtp_tipo_conexion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_config_smtp_mob_validate_csmtp_tipo_conexion_cb

  // ---------- Validate csmtp_nombre_empresa
  function do_ajax_form_sis_config_smtp_mob_validate_csmtp_nombre_empresa()
  {
    var nomeCampo_csmtp_nombre_empresa = "csmtp_nombre_empresa";
    var var_csmtp_nombre_empresa = scAjaxGetFieldText(nomeCampo_csmtp_nombre_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_config_smtp_mob_validate_csmtp_nombre_empresa(var_csmtp_nombre_empresa, var_script_case_init, do_ajax_form_sis_config_smtp_mob_validate_csmtp_nombre_empresa_cb);
  } // do_ajax_form_sis_config_smtp_mob_validate_csmtp_nombre_empresa

  function do_ajax_form_sis_config_smtp_mob_validate_csmtp_nombre_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "csmtp_nombre_empresa";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_config_smtp_mob_validate_csmtp_nombre_empresa_cb

  // ---------- Validate csmtp_ruta_imagenes
  function do_ajax_form_sis_config_smtp_mob_validate_csmtp_ruta_imagenes()
  {
    var nomeCampo_csmtp_ruta_imagenes = "csmtp_ruta_imagenes";
    var var_csmtp_ruta_imagenes = scAjaxGetFieldText(nomeCampo_csmtp_ruta_imagenes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_config_smtp_mob_validate_csmtp_ruta_imagenes(var_csmtp_ruta_imagenes, var_script_case_init, do_ajax_form_sis_config_smtp_mob_validate_csmtp_ruta_imagenes_cb);
  } // do_ajax_form_sis_config_smtp_mob_validate_csmtp_ruta_imagenes

  function do_ajax_form_sis_config_smtp_mob_validate_csmtp_ruta_imagenes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "csmtp_ruta_imagenes";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_config_smtp_mob_validate_csmtp_ruta_imagenes_cb

  // ---------- Validate csmtp_ruta_plantillas
  function do_ajax_form_sis_config_smtp_mob_validate_csmtp_ruta_plantillas()
  {
    var nomeCampo_csmtp_ruta_plantillas = "csmtp_ruta_plantillas";
    var var_csmtp_ruta_plantillas = scAjaxGetFieldText(nomeCampo_csmtp_ruta_plantillas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_config_smtp_mob_validate_csmtp_ruta_plantillas(var_csmtp_ruta_plantillas, var_script_case_init, do_ajax_form_sis_config_smtp_mob_validate_csmtp_ruta_plantillas_cb);
  } // do_ajax_form_sis_config_smtp_mob_validate_csmtp_ruta_plantillas

  function do_ajax_form_sis_config_smtp_mob_validate_csmtp_ruta_plantillas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "csmtp_ruta_plantillas";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_config_smtp_mob_validate_csmtp_ruta_plantillas_cb

  // ---------- Validate csmtp_dominio
  function do_ajax_form_sis_config_smtp_mob_validate_csmtp_dominio()
  {
    var nomeCampo_csmtp_dominio = "csmtp_dominio";
    var var_csmtp_dominio = scAjaxGetFieldText(nomeCampo_csmtp_dominio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_config_smtp_mob_validate_csmtp_dominio(var_csmtp_dominio, var_script_case_init, do_ajax_form_sis_config_smtp_mob_validate_csmtp_dominio_cb);
  } // do_ajax_form_sis_config_smtp_mob_validate_csmtp_dominio

  function do_ajax_form_sis_config_smtp_mob_validate_csmtp_dominio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "csmtp_dominio";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_config_smtp_mob_validate_csmtp_dominio_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_sis_config_smtp_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_sis_config_smtp_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_csmtp_servidor = scAjaxGetFieldText("csmtp_servidor");
    var var_csmtp_usuario = scAjaxGetFieldText("csmtp_usuario");
    var var_csmtp_email_seguridad = scAjaxGetFieldText("csmtp_email_seguridad");
    var var_csmtp_contrasenia = scAjaxGetFieldText("csmtp_contrasenia");
    var var_csmtp_puerto_php = scAjaxGetFieldText("csmtp_puerto_php");
    var var_csmtp_tipo_conexion = scAjaxGetFieldSelect("csmtp_tipo_conexion");
    var var_csmtp_nombre_empresa = scAjaxGetFieldText("csmtp_nombre_empresa");
    var var_csmtp_ruta_imagenes = scAjaxGetFieldText("csmtp_ruta_imagenes");
    var var_csmtp_ruta_plantillas = scAjaxGetFieldText("csmtp_ruta_plantillas");
    var var_csmtp_dominio = scAjaxGetFieldText("csmtp_dominio");
    var var_csmtp_id = scAjaxGetFieldText("csmtp_id");
    ...
    scAjaxProcOn();
    x_ajax_form_sis_config_smtp_mob_submit_form(var_csmtp_servidor, var_csmtp_usuario, var_csmtp_email_seguridad, var_csmtp_contrasenia, var_csmtp_puerto_php, var_csmtp_tipo_conexion, var_csmtp_nombre_empresa, var_csmtp_ruta_imagenes, var_csmtp_ruta_plantillas, var_csmtp_dominio, var_csmtp_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_config_smtp_mob_submit_form_cb);
  } // do_ajax_form_sis_config_smtp_mob_submit_form

  function do_ajax_form_sis_config_smtp_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("csmtp_servidor");
      scAjaxHideErrorDisplay("csmtp_usuario");
      scAjaxHideErrorDisplay("csmtp_email_seguridad");
      scAjaxHideErrorDisplay("csmtp_contrasenia");
      scAjaxHideErrorDisplay("csmtp_puerto_php");
      scAjaxHideErrorDisplay("csmtp_tipo_conexion");
      scAjaxHideErrorDisplay("csmtp_nombre_empresa");
      scAjaxHideErrorDisplay("csmtp_ruta_imagenes");
      scAjaxHideErrorDisplay("csmtp_ruta_plantillas");
      scAjaxHideErrorDisplay("csmtp_dominio");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_sis_config_smtp_mob_submit_form_cb_after_alert);
  } // do_ajax_form_sis_config_smtp_mob_submit_form_cb
  function do_ajax_form_sis_config_smtp_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_config_smtp_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sis_config_smtp_mob_navigate_form()
  {
    perform_ajax_form_sis_config_smtp_mob_navigate_form();
  }

  function perform_ajax_form_sis_config_smtp_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("csmtp_ruta_plantillas");
    scAjaxHideErrorDisplay("csmtp_dominio");
    var var_csmtp_id = document.F2.csmtp_id.value;
    ...
    scAjaxProcOn();
    x_ajax_form_sis_config_smtp_mob_navigate_form(var_csmtp_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_config_smtp_mob_navigate_form_cb);
  } // do_ajax_form_sis_config_smtp_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_config_smtp_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_config_smtp_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.csmtp_id.value = scAjaxGetKeyValue("csmtp_id");
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_config_smtp_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_config_smtp_mob_navigate_form_cb
  function do_ajax_form_sis_config_smtp_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_sis_config_smtp_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_sis_config_smtp_mob_navigate_form_cb_after_alert

  function sc_hide_form_sis_config_smtp_mob_form()
  {
  ...
  ajax_field_list[0] = "csmtp_servidor";
  ajax_field_list[1] = "csmtp_usuario";
  ajax_field_list[2] = "csmtp_email_seguridad";
  ajax_field_list[3] = "csmtp_contrasenia";
  ajax_field_list[4] = "csmtp_puerto_php";
  ajax_field_list[5] = "csmtp_tipo_conexion";
  ajax_field_list[6] = "csmtp_nombre_empresa";
  ajax_field_list[7] = "csmtp_ruta_imagenes";
  ajax_field_list[8] = "csmtp_ruta_plantillas";
  ajax_field_list[9] = "csmtp_dominio";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "csmtp_servidor": {"label": "<?php echo $this->Ini->Nm_lang['lang_servidor_correo'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "csmtp_usuario": {"label": "<?php echo $this->Ini->Nm_lang['lang_usuario'] ?> SMTP", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "csmtp_email_seguridad": {"label": "Email Seguridad", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "csmtp_contrasenia": {"label": "<?php echo $this->Ini->Nm_lang['lang_contrasenia'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "csmtp_puerto_php": {"label": "<?php echo $this->Ini->Nm_lang['lang_puerto'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "csmtp_tipo_conexion": {"label": "<?php echo $this->Ini->Nm_lang['lang_tipo__conexion_smtp'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "csmtp_nombre_empresa": {"label": "<?php echo $this->Ini->Nm_lang['lang_nombre_empresa'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "csmtp_ruta_imagenes": {"label": "<?php echo $this->Ini->Nm_lang['lang_ruta_imagenes'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "csmtp_ruta_plantillas": {"label": "<?php echo $this->Ini->Nm_lang['lang_ruta_plantillas'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "csmtp_dominio": {"label": "<?php echo $this->Ini->Nm_lang['lang_dominio'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "csmtp_servidor": new Array(),
    "csmtp_usuario": new Array(),
    "csmtp_email_seguridad": new Array(),
    "csmtp_contrasenia": new Array(),
    "csmtp_puerto_php": new Array(),
    "csmtp_tipo_conexion": new Array(),
    "csmtp_nombre_empresa": new Array(),
    "csmtp_ruta_imagenes": new Array(),
    "csmtp_ruta_plantillas": new Array(),
    "csmtp_dominio": new Array()
  };
  ajax_field_mult["csmtp_servidor"][1] = "csmtp_servidor";
  ajax_field_mult["csmtp_usuario"][1] = "csmtp_usuario";
  ajax_field_mult["csmtp_email_seguridad"][1] = "csmtp_email_seguridad";
  ajax_field_mult["csmtp_contrasenia"][1] = "csmtp_contrasenia";
  ajax_field_mult["csmtp_puerto_php"][1] = "csmtp_puerto_php";
  ajax_field_mult["csmtp_tipo_conexion"][1] = "csmtp_tipo_conexion";
  ajax_field_mult["csmtp_nombre_empresa"][1] = "csmtp_nombre_empresa";
  ajax_field_mult["csmtp_ruta_imagenes"][1] = "csmtp_ruta_imagenes";
  ajax_field_mult["csmtp_ruta_plantillas"][1] = "csmtp_ruta_plantillas";
  ajax_field_mult["csmtp_dominio"][1] = "csmtp_dominio";

  var ajax_field_id = {
    "csmtp_servidor": new Array("hidden_field_label_csmtp_servidor", "hidden_field_data_csmtp_servidor"),
    "csmtp_usuario": new Array("hidden_field_label_csmtp_usuario", "hidden_field_data_csmtp_usuario"),
    "csmtp_email_seguridad": new Array("hidden_field_label_csmtp_email_seguridad", "hidden_field_data_csmtp_email_seguridad"),
    "csmtp_contrasenia": new Array("hidden_field_label_csmtp_contrasenia", "hidden_field_data_csmtp_contrasenia"),
    "csmtp_puerto_php": new Array("hidden_field_label_csmtp_puerto_php", "hidden_field_data_csmtp_puerto_php"),
    "csmtp_tipo_conexion": new Array("hidden_field_label_csmtp_tipo_conexion", "hidden_field_data_csmtp_tipo_conexion"),
    "csmtp_nombre_empresa": new Array("hidden_field_label_csmtp_nombre_empresa", "hidden_field_data_csmtp_nombre_empresa"),
    "csmtp_ruta_imagenes": new Array("hidden_field_label_csmtp_ruta_imagenes", "hidden_field_data_csmtp_ruta_imagenes"),
    "csmtp_ruta_plantillas": new Array("hidden_field_label_csmtp_ruta_plantillas", "hidden_field_data_csmtp_ruta_plantillas"),
    "csmtp_dominio": new Array("hidden_field_label_csmtp_dominio", "hidden_field_data_csmtp_dominio")
  };

  var ajax_read_only = {
    "csmtp_servidor": "off",
    "csmtp_usuario": "off",
    "csmtp_email_seguridad": "off",
    "csmtp_contrasenia": "off",
    "csmtp_puerto_php": "off",
    "csmtp_tipo_conexion": "off",
    "csmtp_nombre_empresa": "off",
    "csmtp_ruta_imagenes": "off",
    "csmtp_ruta_plantillas": "off",
    "csmtp_dominio": "off"
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("csmtp_email_seguridad" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("csmtp_nombre_empresa" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("csmtp_ruta_plantillas" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
