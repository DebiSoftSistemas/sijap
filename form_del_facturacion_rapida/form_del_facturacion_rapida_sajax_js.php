  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_facturacion_rapida" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_facturacion_rapida_form();
	}
...
?>
  ...
  // ---------- Validate fac_imagen
  function do_ajax_form_del_facturacion_rapida_validate_fac_imagen()
  {
    var nomeCampo_fac_imagen = "fac_imagen";
    var var_fac_imagen = scAjaxGetFieldText(nomeCampo_fac_imagen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_facturacion_rapida_validate_fac_imagen(var_fac_imagen, var_script_case_init, do_ajax_form_del_facturacion_rapida_validate_fac_imagen_cb);
  } // do_ajax_form_del_facturacion_rapida_validate_fac_imagen

  function do_ajax_form_del_facturacion_rapida_validate_fac_imagen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fac_imagen";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_facturacion_rapida_validate_fac_imagen_cb

  // ---------- Validate fac_id
  function do_ajax_form_del_facturacion_rapida_validate_fac_id()
  {
    var nomeCampo_fac_id = "fac_id";
    var var_fac_id = scAjaxGetFieldHidden(nomeCampo_fac_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_facturacion_rapida_validate_fac_id(var_fac_id, var_script_case_init, do_ajax_form_del_facturacion_rapida_validate_fac_id_cb);
  } // do_ajax_form_del_facturacion_rapida_validate_fac_id

  function do_ajax_form_del_facturacion_rapida_validate_fac_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fac_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_facturacion_rapida_validate_fac_id_cb

  // ---------- Validate fac_empresa
  function do_ajax_form_del_facturacion_rapida_validate_fac_empresa()
  {
    var nomeCampo_fac_empresa = "fac_empresa";
    var var_fac_empresa = scAjaxGetFieldText(nomeCampo_fac_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_facturacion_rapida_validate_fac_empresa(var_fac_empresa, var_script_case_init, do_ajax_form_del_facturacion_rapida_validate_fac_empresa_cb);
  } // do_ajax_form_del_facturacion_rapida_validate_fac_empresa

  function do_ajax_form_del_facturacion_rapida_validate_fac_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_facturacion_rapida_validate_fac_empresa_cb

  // ---------- Validate fac_descripcion
  function do_ajax_form_del_facturacion_rapida_validate_fac_descripcion()
  {
    var nomeCampo_fac_descripcion = "fac_descripcion";
    var var_fac_descripcion = scAjaxGetFieldText(nomeCampo_fac_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_facturacion_rapida_validate_fac_descripcion(var_fac_descripcion, var_script_case_init, do_ajax_form_del_facturacion_rapida_validate_fac_descripcion_cb);
  } // do_ajax_form_del_facturacion_rapida_validate_fac_descripcion

  function do_ajax_form_del_facturacion_rapida_validate_fac_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fac_descripcion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_facturacion_rapida_validate_fac_descripcion_cb

  // ---------- Validate fac_valor_fijo
  function do_ajax_form_del_facturacion_rapida_validate_fac_valor_fijo()
  {
    var nomeCampo_fac_valor_fijo = "fac_valor_fijo";
    var var_fac_valor_fijo = scAjaxGetFieldCheckbox(nomeCampo_fac_valor_fijo, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_facturacion_rapida_validate_fac_valor_fijo(var_fac_valor_fijo, var_script_case_init, do_ajax_form_del_facturacion_rapida_validate_fac_valor_fijo_cb);
  } // do_ajax_form_del_facturacion_rapida_validate_fac_valor_fijo

  function do_ajax_form_del_facturacion_rapida_validate_fac_valor_fijo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fac_valor_fijo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_facturacion_rapida_validate_fac_valor_fijo_cb

  // ---------- Validate fac_estado
  function do_ajax_form_del_facturacion_rapida_validate_fac_estado()
  {
    var nomeCampo_fac_estado = "fac_estado";
    var var_fac_estado = scAjaxGetFieldSelect(nomeCampo_fac_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_facturacion_rapida_validate_fac_estado(var_fac_estado, var_script_case_init, do_ajax_form_del_facturacion_rapida_validate_fac_estado_cb);
  } // do_ajax_form_del_facturacion_rapida_validate_fac_estado

  function do_ajax_form_del_facturacion_rapida_validate_fac_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_facturacion_rapida_validate_fac_estado_cb

  // ---------- Validate fac_usuario
  function do_ajax_form_del_facturacion_rapida_validate_fac_usuario()
  {
    var nomeCampo_fac_usuario = "fac_usuario";
    var var_fac_usuario = scAjaxGetFieldText(nomeCampo_fac_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_facturacion_rapida_validate_fac_usuario(var_fac_usuario, var_script_case_init, do_ajax_form_del_facturacion_rapida_validate_fac_usuario_cb);
  } // do_ajax_form_del_facturacion_rapida_validate_fac_usuario

  function do_ajax_form_del_facturacion_rapida_validate_fac_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_facturacion_rapida_validate_fac_usuario_cb

  // ---------- Validate fac_subtotal_iva
  function do_ajax_form_del_facturacion_rapida_validate_fac_subtotal_iva()
  {
    var nomeCampo_fac_subtotal_iva = "fac_subtotal_iva";
    var var_fac_subtotal_iva = scAjaxGetFieldText(nomeCampo_fac_subtotal_iva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_facturacion_rapida_validate_fac_subtotal_iva(var_fac_subtotal_iva, var_script_case_init, do_ajax_form_del_facturacion_rapida_validate_fac_subtotal_iva_cb);
  } // do_ajax_form_del_facturacion_rapida_validate_fac_subtotal_iva

  function do_ajax_form_del_facturacion_rapida_validate_fac_subtotal_iva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_facturacion_rapida_validate_fac_subtotal_iva_cb

  // ---------- Validate fac_subtotal_cero
  function do_ajax_form_del_facturacion_rapida_validate_fac_subtotal_cero()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_facturacion_rapida_validate_fac_subtotal_cero(var_fac_subtotal_cero, var_script_case_init, do_ajax_form_del_facturacion_rapida_validate_fac_subtotal_cero_cb);
  } // do_ajax_form_del_facturacion_rapida_validate_fac_subtotal_cero

  function do_ajax_form_del_facturacion_rapida_validate_fac_subtotal_cero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_facturacion_rapida_validate_fac_subtotal_cero_cb

  // ---------- Validate fac_subtotal_no_objeto
  function do_ajax_form_del_facturacion_rapida_validate_fac_subtotal_no_objeto()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_facturacion_rapida_validate_fac_subtotal_no_objeto(var_fac_subtotal_no_objeto, var_script_case_init, do_ajax_form_del_facturacion_rapida_validate_fac_subtotal_no_objeto_cb);
  } // do_ajax_form_del_facturacion_rapida_validate_fac_subtotal_no_objeto

  function do_ajax_form_del_facturacion_rapida_validate_fac_subtotal_no_objeto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_facturacion_rapida_validate_fac_subtotal_no_objeto_cb

  // ---------- Validate fac_subtotal_excento
  function do_ajax_form_del_facturacion_rapida_validate_fac_subtotal_excento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_facturacion_rapida_validate_fac_subtotal_excento(var_fac_subtotal_excento, var_script_case_init, do_ajax_form_del_facturacion_rapida_validate_fac_subtotal_excento_cb);
  } // do_ajax_form_del_facturacion_rapida_validate_fac_subtotal_excento

  function do_ajax_form_del_facturacion_rapida_validate_fac_subtotal_excento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_facturacion_rapida_validate_fac_subtotal_excento_cb

  // ---------- Validate fac_subtotal
  function do_ajax_form_del_facturacion_rapida_validate_fac_subtotal()
  {
    var nomeCampo_fac_subtotal = "fac_subtotal";
    var var_fac_subtotal = scAjaxGetFieldText(nomeCampo_fac_subtotal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_facturacion_rapida_validate_fac_subtotal(var_fac_subtotal, var_script_case_init, do_ajax_form_del_facturacion_rapida_validate_fac_subtotal_cb);
  } // do_ajax_form_del_facturacion_rapida_validate_fac_subtotal

  function do_ajax_form_del_facturacion_rapida_validate_fac_subtotal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_facturacion_rapida_validate_fac_subtotal_cb

  // ---------- Validate fac_total_descuento
  function do_ajax_form_del_facturacion_rapida_validate_fac_total_descuento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_facturacion_rapida_validate_fac_total_descuento(var_fac_total_descuento, var_script_case_init, do_ajax_form_del_facturacion_rapida_validate_fac_total_descuento_cb);
  } // do_ajax_form_del_facturacion_rapida_validate_fac_total_descuento

  function do_ajax_form_del_facturacion_rapida_validate_fac_total_descuento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_facturacion_rapida_validate_fac_total_descuento_cb

  // ---------- Validate fac_valor_ice
  function do_ajax_form_del_facturacion_rapida_validate_fac_valor_ice()
  {
    var nomeCampo_fac_valor_ice = "fac_valor_ice";
    var var_fac_valor_ice = scAjaxGetFieldText(nomeCampo_fac_valor_ice);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_facturacion_rapida_validate_fac_valor_ice(var_fac_valor_ice, var_script_case_init, do_ajax_form_del_facturacion_rapida_validate_fac_valor_ice_cb);
  } // do_ajax_form_del_facturacion_rapida_validate_fac_valor_ice

  function do_ajax_form_del_facturacion_rapida_validate_fac_valor_ice_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_facturacion_rapida_validate_fac_valor_ice_cb

  // ---------- Validate fac_valor_iva
  function do_ajax_form_del_facturacion_rapida_validate_fac_valor_iva()
  {
    var nomeCampo_fac_valor_iva = "fac_valor_iva";
    var var_fac_valor_iva = scAjaxGetFieldText(nomeCampo_fac_valor_iva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_facturacion_rapida_validate_fac_valor_iva(var_fac_valor_iva, var_script_case_init, do_ajax_form_del_facturacion_rapida_validate_fac_valor_iva_cb);
  } // do_ajax_form_del_facturacion_rapida_validate_fac_valor_iva

  function do_ajax_form_del_facturacion_rapida_validate_fac_valor_iva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_facturacion_rapida_validate_fac_valor_iva_cb

  // ---------- Validate fac_valor_irbpnr
  function do_ajax_form_del_facturacion_rapida_validate_fac_valor_irbpnr()
  {
    var nomeCampo_fac_valor_irbpnr = "fac_valor_irbpnr";
    var var_fac_valor_irbpnr = scAjaxGetFieldText(nomeCampo_fac_valor_irbpnr);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_facturacion_rapida_validate_fac_valor_irbpnr(var_fac_valor_irbpnr, var_script_case_init, do_ajax_form_del_facturacion_rapida_validate_fac_valor_irbpnr_cb);
  } // do_ajax_form_del_facturacion_rapida_validate_fac_valor_irbpnr

  function do_ajax_form_del_facturacion_rapida_validate_fac_valor_irbpnr_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_facturacion_rapida_validate_fac_valor_irbpnr_cb

  // ---------- Validate fac_total
  function do_ajax_form_del_facturacion_rapida_validate_fac_total()
  {
    var nomeCampo_fac_total = "fac_total";
    var var_fac_total = scAjaxGetFieldText(nomeCampo_fac_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_facturacion_rapida_validate_fac_total(var_fac_total, var_script_case_init, do_ajax_form_del_facturacion_rapida_validate_fac_total_cb);
  } // do_ajax_form_del_facturacion_rapida_validate_fac_total

  function do_ajax_form_del_facturacion_rapida_validate_fac_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_facturacion_rapida_validate_fac_total_cb

  // ---------- Validate detalle
  function do_ajax_form_del_facturacion_rapida_validate_detalle()
  {
    var nomeCampo_detalle = "detalle";
    var var_detalle = scAjaxGetFieldText(nomeCampo_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_facturacion_rapida_validate_detalle(var_detalle, var_script_case_init, do_ajax_form_del_facturacion_rapida_validate_detalle_cb);
  } // do_ajax_form_del_facturacion_rapida_validate_detalle

  function do_ajax_form_del_facturacion_rapida_validate_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detalle";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_facturacion_rapida_validate_detalle_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_facturacion_rapida_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_facturacion_rapida_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_fac_imagen = scAjaxGetFieldText("fac_imagen");
    var var_fac_id = scAjaxGetFieldHidden("fac_id");
    var var_fac_empresa = scAjaxGetFieldText("fac_empresa");
    var var_fac_descripcion = scAjaxGetFieldText("fac_descripcion");
    var var_fac_valor_fijo = scAjaxGetFieldCheckbox("fac_valor_fijo", ";");
    var var_fac_estado = scAjaxGetFieldSelect("fac_estado");
    ...
    var var_fac_imagen_ul_name = scAjaxSpecCharProtect(document.F1.fac_imagen_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_fac_imagen_ul_type = document.F1.fac_imagen_ul_type.value;
    var var_fac_imagen_salva = scAjaxSpecCharProtect(document.F1.fac_imagen_salva.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_fac_imagen_limpa = document.F1.fac_imagen_limpa.checked ? "S" : "N";
    ...
    scAjaxProcOn();
    x_ajax_form_del_facturacion_rapida_submit_form(var_fac_imagen, var_fac_id, var_fac_empresa, var_fac_descripcion, var_fac_valor_fijo, var_fac_estado, var_fac_usuario, var_fac_subtotal_iva, var_fac_subtotal_cero, var_fac_subtotal_no_objeto, var_fac_subtotal_excento, var_fac_subtotal, var_fac_total_descuento, var_fac_valor_ice, var_fac_valor_iva, var_fac_valor_irbpnr, var_fac_total, var_fac_imagen_ul_name, var_fac_imagen_ul_type, var_fac_imagen_salva, var_fac_imagen_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_facturacion_rapida_submit_form_cb);
  } // do_ajax_form_del_facturacion_rapida_submit_form

  function do_ajax_form_del_facturacion_rapida_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("fac_imagen");
      scAjaxHideErrorDisplay("fac_id");
      scAjaxHideErrorDisplay("fac_empresa");
      scAjaxHideErrorDisplay("fac_descripcion");
      scAjaxHideErrorDisplay("fac_valor_fijo");
...
?>
    ...
    if (!scAjaxHasError())
    {
      ...
      if (document.F1.fac_imagen_limpa && document.F1.fac_imagen_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldImage("fac_imagen", oImgTemp, "", "", "", "N");
      }
    document.F1.fac_imagen_ul_name.value = '';
    document.F1.fac_imagen_ul_type.value = '';
    }
    scAjaxShowDebug();
    scAjaxSetDisplay();
    scBtnDisabled();
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_facturacion_rapida_submit_form_cb_after_alert);
  } // do_ajax_form_del_facturacion_rapida_submit_form_cb
  function do_ajax_form_del_facturacion_rapida_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_facturacion_rapida_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_del_detalle_facturacion_rapida"] = "off";

  function do_ajax_form_del_facturacion_rapida_navigate_form()
  {
    perform_ajax_form_del_facturacion_rapida_navigate_form();
  }

  function perform_ajax_form_del_facturacion_rapida_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("fac_total");
    scAjaxHideErrorDisplay("detalle");
    var var_fac_id = document.F2.fac_id.value;
    ...
    scAjaxProcOn();
    scStatusDetail["form_del_detalle_facturacion_rapida"] = "on";
    x_ajax_form_del_facturacion_rapida_navigate_form(var_fac_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_facturacion_rapida_navigate_form_cb);
  } // do_ajax_form_del_facturacion_rapida_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_facturacion_rapida']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_facturacion_rapida_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.fac_id.value = scAjaxGetKeyValue("fac_id");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_del_detalle_facturacion_rapida"] && "nmsc_iframe_liga_form_del_detalle_facturacion_rapida" != scMasterDetailIframe["nmsc_iframe_liga_form_del_detalle_facturacion_rapida"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_del_detalle_facturacion_rapida"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_del_detalle_facturacion_rapida').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_del_detalle_facturacion_rapida').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_del_detalle_facturacion_rapida').style.display = "none";
    }
    document.F1.fac_imagen_ul_name.value = '';
    document.F1.fac_imagen_ul_type.value = '';
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_facturacion_rapida_navigate_form_cb_after_alert);
  } // do_ajax_form_del_facturacion_rapida_navigate_form_cb
  function do_ajax_form_del_facturacion_rapida_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_del_facturacion_rapida_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_facturacion_rapida_navigate_form_cb_after_alert

  function sc_hide_form_del_facturacion_rapida_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_del_detalle_facturacion_rapida"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "fac_imagen";
  ajax_field_list[1] = "fac_id";
  ajax_field_list[2] = "fac_empresa";
  ajax_field_list[3] = "fac_descripcion";
  ajax_field_list[4] = "fac_valor_fijo";
  ajax_field_list[5] = "fac_estado";
  ajax_field_list[6] = "fac_usuario";
  ajax_field_list[7] = "fac_subtotal_iva";
  ajax_field_list[8] = "fac_subtotal_cero";
  ajax_field_list[9] = "fac_subtotal_no_objeto";
  ajax_field_list[10] = "fac_subtotal_excento";
  ajax_field_list[11] = "fac_subtotal";
  ajax_field_list[12] = "fac_total_descuento";
  ajax_field_list[13] = "fac_valor_ice";
  ajax_field_list[14] = "fac_valor_iva";
  ajax_field_list[15] = "fac_valor_irbpnr";
  ajax_field_list[16] = "fac_total";
  ajax_field_list[17] = "detalle";
  ...
  var ajax_error_list = {
    "fac_imagen": {"label": "<?php echo $this->Ini->Nm_lang['lang_btns_img'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fac_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "fac_descripcion": {"label": "<?php echo $this->Ini->Nm_lang['lang_descripcion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fac_valor_fijo": {"label": "<?php echo $this->Ini->Nm_lang['lang_valor_fijo'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "fac_subtotal": {"label": "<?php echo $this->Ini->Nm_lang['lang_subtotal'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "fac_total": {"label": "<?php echo $this->Ini->Nm_lang['lang_total'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "fac_imagen": new Array(),
    "fac_id": new Array(),
    "fac_empresa": new Array(),
    "fac_descripcion": new Array(),
    "fac_valor_fijo": new Array(),
  ...
  ajax_field_mult["fac_imagen"][1] = "fac_imagen";
  ajax_field_mult["fac_id"][1] = "fac_id";
  ajax_field_mult["fac_empresa"][1] = "fac_empresa";
  ajax_field_mult["fac_descripcion"][1] = "fac_descripcion";
  ajax_field_mult["fac_valor_fijo"][1] = "fac_valor_fijo";
  ...
  var ajax_field_id = {
    "fac_imagen": new Array("hidden_field_label_fac_imagen", "hidden_field_data_fac_imagen"),
    "fac_descripcion": new Array("hidden_field_label_fac_descripcion", "hidden_field_data_fac_descripcion"),
    "fac_valor_fijo": new Array("hidden_field_label_fac_valor_fijo", "hidden_field_data_fac_valor_fijo"),
    "fac_estado": new Array("hidden_field_label_fac_estado", "hidden_field_data_fac_estado"),
