...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_fac_id' + iSeqRow).bind('blur', function() { sc_form_del_facturacion_rapida_fac_id_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_del_facturacion_rapida_fac_id_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fac_empresa' + iSeqRow).bind('blur', function() { sc_form_del_facturacion_rapida_fac_empresa_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_del_facturacion_rapida_fac_empresa_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fac_imagen' + iSeqRow).bind('blur', function() { sc_form_del_facturacion_rapida_fac_imagen_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_del_facturacion_rapida_fac_imagen_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fac_descripcion' + iSeqRow).bind('blur', function() { sc_form_del_facturacion_rapida_fac_descripcion_onblur(this, iSeqRow) })
                                             .bind('change', function() { sc_form_del_facturacion_rapida_fac_descripcion_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fac_valor_fijo' + iSeqRow).bind('blur', function() { sc_form_del_facturacion_rapida_fac_valor_fijo_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_del_facturacion_rapida_fac_valor_fijo_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fac_subtotal_iva' + iSeqRow).bind('blur', function() { sc_form_del_facturacion_rapida_fac_subtotal_iva_onblur(this, iSeqRow) })
                                              .bind('change', function() { sc_form_del_facturacion_rapida_fac_subtotal_iva_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fac_subtotal_cero' + iSeqRow).bind('blur', function() { sc_form_del_facturacion_rapida_fac_subtotal_cero_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_form_del_facturacion_rapida_fac_subtotal_cero_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fac_subtotal_no_objeto' + iSeqRow).bind('blur', function() { sc_form_del_facturacion_rapida_fac_subtotal_no_objeto_onblur(this, iSeqRow) })
                                                    .bind('change', function() { sc_form_del_facturacion_rapida_fac_subtotal_no_objeto_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fac_subtotal_excento' + iSeqRow).bind('blur', function() { sc_form_del_facturacion_rapida_fac_subtotal_excento_onblur(this, iSeqRow) })
                                                  .bind('change', function() { sc_form_del_facturacion_rapida_fac_subtotal_excento_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fac_subtotal' + iSeqRow).bind('blur', function() { sc_form_del_facturacion_rapida_fac_subtotal_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_del_facturacion_rapida_fac_subtotal_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fac_total_descuento' + iSeqRow).bind('blur', function() { sc_form_del_facturacion_rapida_fac_total_descuento_onblur(this, iSeqRow) })
                                                 .bind('change', function() { sc_form_del_facturacion_rapida_fac_total_descuento_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fac_valor_ice' + iSeqRow).bind('blur', function() { sc_form_del_facturacion_rapida_fac_valor_ice_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_del_facturacion_rapida_fac_valor_ice_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fac_valor_iva' + iSeqRow).bind('blur', function() { sc_form_del_facturacion_rapida_fac_valor_iva_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_del_facturacion_rapida_fac_valor_iva_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fac_valor_irbpnr' + iSeqRow).bind('blur', function() { sc_form_del_facturacion_rapida_fac_valor_irbpnr_onblur(this, iSeqRow) })
                                              .bind('change', function() { sc_form_del_facturacion_rapida_fac_valor_irbpnr_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fac_total' + iSeqRow).bind('blur', function() { sc_form_del_facturacion_rapida_fac_total_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_del_facturacion_rapida_fac_total_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fac_estado' + iSeqRow).bind('blur', function() { sc_form_del_facturacion_rapida_fac_estado_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_del_facturacion_rapida_fac_estado_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fac_usuario' + iSeqRow).bind('blur', function() { sc_form_del_facturacion_rapida_fac_usuario_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_del_facturacion_rapida_fac_usuario_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_detalle' + iSeqRow).bind('blur', function() { sc_form_del_facturacion_rapida_detalle_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_del_facturacion_rapida_detalle_onchange(this, iSeqRow) })
...
function sc_form_del_facturacion_rapida_fac_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_facturacion_rapida_fac_empresa_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_facturacion_rapida_fac_imagen_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_facturacion_rapida_fac_descripcion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_facturacion_rapida_fac_valor_fijo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_facturacion_rapida_fac_subtotal_iva_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_facturacion_rapida_fac_subtotal_cero_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_facturacion_rapida_fac_subtotal_no_objeto_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_facturacion_rapida_fac_subtotal_excento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_facturacion_rapida_fac_subtotal_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_facturacion_rapida_fac_total_descuento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_facturacion_rapida_fac_valor_ice_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_facturacion_rapida_fac_valor_iva_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_facturacion_rapida_fac_valor_irbpnr_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_facturacion_rapida_fac_total_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_facturacion_rapida_fac_estado_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_facturacion_rapida_fac_usuario_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_facturacion_rapida_detalle_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function displayChange_field_detalle(row, status) {
    var fieldId;
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_del_detalle_facturacion_rapida")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_del_detalle_facturacion_rapida")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_del_facturacion_rapida_form" + pageNo).hide();
}
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_fac_imagen" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_del_facturacion_rapida_ul_save.php",
    dropZone: "",
    formData: function() {
      return [
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_del_facturacion_rapida')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
