  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_jap_rutas" == sTestField)
        {
...
?>
  ...
  // ---------- Validate rut_id_
  function do_ajax_form_jap_rutas_validate_rut_id_(iNumLinha)
  {
    var nomeCampo_rut_id_ = "rut_id_" + iNumLinha;
    var var_rut_id_ = scAjaxGetFieldHidden(nomeCampo_rut_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_rutas_validate_rut_id_(var_rut_id_, iNumLinha, var_script_case_init, do_ajax_form_jap_rutas_validate_rut_id__cb);
  } // do_ajax_form_jap_rutas_validate_rut_id_

  function do_ajax_form_jap_rutas_validate_rut_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "rut_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rut_id_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "rut_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rut_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_rutas_validate_rut_id__cb

  // ---------- Validate rut_empresa_
  function do_ajax_form_jap_rutas_validate_rut_empresa_(iNumLinha)
  {
    var nomeCampo_rut_empresa_ = "rut_empresa_" + iNumLinha;
    var var_rut_empresa_ = scAjaxGetFieldText(nomeCampo_rut_empresa_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_rutas_validate_rut_empresa_(var_rut_empresa_, iNumLinha, var_script_case_init, do_ajax_form_jap_rutas_validate_rut_empresa__cb);
  } // do_ajax_form_jap_rutas_validate_rut_empresa_

  function do_ajax_form_jap_rutas_validate_rut_empresa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rut_empresa_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rut_empresa_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rut_empresa_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rut_empresa_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_rutas_validate_rut_empresa__cb

  // ---------- Validate rut_nombre_
  function do_ajax_form_jap_rutas_validate_rut_nombre_(iNumLinha)
  {
    var nomeCampo_rut_nombre_ = "rut_nombre_" + iNumLinha;
    var var_rut_nombre_ = scAjaxGetFieldText(nomeCampo_rut_nombre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_rutas_validate_rut_nombre_(var_rut_nombre_, iNumLinha, var_script_case_init, do_ajax_form_jap_rutas_validate_rut_nombre__cb);
  } // do_ajax_form_jap_rutas_validate_rut_nombre_

  function do_ajax_form_jap_rutas_validate_rut_nombre__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rut_nombre_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rut_nombre_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rut_nombre_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rut_nombre_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_rutas_validate_rut_nombre__cb

  // ---------- Validate rut_estado_
  function do_ajax_form_jap_rutas_validate_rut_estado_(iNumLinha)
  {
    var nomeCampo_rut_estado_ = "rut_estado_" + iNumLinha;
    var var_rut_estado_ = scAjaxGetFieldSelect(nomeCampo_rut_estado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_rutas_validate_rut_estado_(var_rut_estado_, iNumLinha, var_script_case_init, do_ajax_form_jap_rutas_validate_rut_estado__cb);
  } // do_ajax_form_jap_rutas_validate_rut_estado_

  function do_ajax_form_jap_rutas_validate_rut_estado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rut_estado_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rut_estado_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rut_estado_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rut_estado_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_rutas_validate_rut_estado__cb

  // ---------- Validate rut_codigo_
  function do_ajax_form_jap_rutas_validate_rut_codigo_(iNumLinha)
  {
    var nomeCampo_rut_codigo_ = "rut_codigo_" + iNumLinha;
    var var_rut_codigo_ = scAjaxGetFieldText(nomeCampo_rut_codigo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_rutas_validate_rut_codigo_(var_rut_codigo_, iNumLinha, var_script_case_init, do_ajax_form_jap_rutas_validate_rut_codigo__cb);
  } // do_ajax_form_jap_rutas_validate_rut_codigo_

  function do_ajax_form_jap_rutas_validate_rut_codigo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rut_codigo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rut_codigo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rut_codigo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rut_codigo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_rutas_validate_rut_codigo__cb

  // ---------- Validate rut_secuencial_
  function do_ajax_form_jap_rutas_validate_rut_secuencial_(iNumLinha)
  {
    var nomeCampo_rut_secuencial_ = "rut_secuencial_" + iNumLinha;
    var var_rut_secuencial_ = scAjaxGetFieldText(nomeCampo_rut_secuencial_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_rutas_validate_rut_secuencial_(var_rut_secuencial_, iNumLinha, var_script_case_init, do_ajax_form_jap_rutas_validate_rut_secuencial__cb);
  } // do_ajax_form_jap_rutas_validate_rut_secuencial_

  function do_ajax_form_jap_rutas_validate_rut_secuencial__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rut_secuencial_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rut_secuencial_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rut_secuencial_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rut_secuencial_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_rutas_validate_rut_secuencial__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_jap_rutas_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_jap_rutas_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_jap_rutas_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_jap_rutas_add_new_line_cb);
  } // do_ajax_form_jap_rutas_add_new_line

  function do_ajax_form_jap_rutas_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_jap_rutas_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_jap_rutas_backup_line(iNumLinha)
  {
    var var_rut_id_ = scAjaxGetFieldHidden("rut_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_rutas_backup_line(var_rut_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_jap_rutas_backup_line_cb);
  } // do_ajax_form_jap_rutas_backup_line

  function do_ajax_form_jap_rutas_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_jap_rutas_backup_line_cb

  function do_ajax_form_jap_rutas_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_jap_rutas_cancel_insert

  function do_ajax_form_jap_rutas_cancel_update(iSeqVert)
  {
    do_ajax_form_jap_rutas_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_jap_rutas_cancel_update

  function do_ajax_form_jap_rutas_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_jap_rutas_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_jap_rutas_table_refresh()
  {
    var var_rut_id_ = document.F2.rut_id_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_jap_rutas_table_refresh(var_rut_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jap_rutas_table_refresh_cb);
  } //  do_ajax_form_jap_rutas_table_refresh

  function do_ajax_form_jap_rutas_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.rut_id_.value = scAjaxGetKeyValue("rut_id_");
    ...
    scAjaxAlert(do_ajax_form_jap_rutas_table_refresh_cb_after_alert);
  } // do_ajax_form_jap_rutas_table_refresh_cb
  function do_ajax_form_jap_rutas_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_jap_rutas_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_jap_rutas_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_jap_rutas_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_rut_id_ = scAjaxGetFieldHidden("rut_id_" + iNumLinha);
    var var_rut_empresa_ = scAjaxGetFieldText("rut_empresa_" + iNumLinha);
    var var_rut_nombre_ = scAjaxGetFieldText("rut_nombre_" + iNumLinha);
    var var_rut_estado_ = scAjaxGetFieldSelect("rut_estado_" + iNumLinha);
    var var_rut_codigo_ = scAjaxGetFieldText("rut_codigo_" + iNumLinha);
    var var_rut_secuencial_ = scAjaxGetFieldText("rut_secuencial_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_jap_rutas_submit_form(var_rut_id_, var_rut_empresa_, var_rut_nombre_, var_rut_estado_, var_rut_codigo_, var_rut_secuencial_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_jap_rutas_submit_form_cb);
  } // do_ajax_form_jap_rutas_submit_form

  function do_ajax_form_jap_rutas_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("rut_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("rut_empresa_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("rut_nombre_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("rut_estado_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("rut_codigo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("rut_secuencial_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_jap_rutas_submit_form_cb_after_alert);
  } // do_ajax_form_jap_rutas_submit_form_cb
  function do_ajax_form_jap_rutas_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_jap_rutas_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_jap_rutas_navigate_form()
  {
    perform_ajax_form_jap_rutas_navigate_form();
  }

  function perform_ajax_form_jap_rutas_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_jap_rutas_cancel_insert(sc_form_jap_rutas_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("rut_id_" + iNavForm);
      scAjaxHideErrorDisplay("rut_empresa_" + iNavForm);
      scAjaxHideErrorDisplay("rut_nombre_" + iNavForm);
      scAjaxHideErrorDisplay("rut_estado_" + iNavForm);
      scAjaxHideErrorDisplay("rut_codigo_" + iNavForm);
      scAjaxHideErrorDisplay("rut_secuencial_" + iNavForm);
    }
    var var_rut_id_ = document.F2.rut_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_jap_rutas_navigate_form(var_rut_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jap_rutas_navigate_form_cb);
  } // do_ajax_form_jap_rutas_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_rutas']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_jap_rutas_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.rut_id_.value = scAjaxGetKeyValue("rut_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_jap_rutas_navigate_form_cb_after_alert);
  } // do_ajax_form_jap_rutas_navigate_form_cb
  function do_ajax_form_jap_rutas_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_jap_rutas_navigate_form_cb_after_alert

    function sc_form_jap_rutas_get_last_line_number()
    {
    ...
    } //sc_form_jap_rutas_get_last_line_number

  function sc_hide_form_jap_rutas_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "rut_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rut_empresa_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rut_nombre_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rut_estado_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rut_codigo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rut_secuencial_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["rut_id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["rut_empresa_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_empresa'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["rut_nombre_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_descripcion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["rut_estado_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["rut_codigo_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_codigo'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["rut_secuencial_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_secuencial'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["rut_id_"][iNumLinha] = "rut_id_" + iNumLinha;
    ajax_field_mult["rut_empresa_"][iNumLinha] = "rut_empresa_" + iNumLinha;
    ajax_field_mult["rut_nombre_"][iNumLinha] = "rut_nombre_" + iNumLinha;
    ajax_field_mult["rut_estado_"][iNumLinha] = "rut_estado_" + iNumLinha;
    ajax_field_mult["rut_codigo_"][iNumLinha] = "rut_codigo_" + iNumLinha;
    ajax_field_mult["rut_secuencial_"][iNumLinha] = "rut_secuencial_" + iNumLinha;
    ajax_field_id["rut_nombre_" + iNumLinha] = new Array("hidden_field_label_rut_nombre_", "hidden_field_data_rut_nombre_" + iNumLinha);
    ajax_field_id["rut_estado_" + iNumLinha] = new Array("hidden_field_label_rut_estado_", "hidden_field_data_rut_estado_" + iNumLinha);
    ajax_field_id["rut_codigo_" + iNumLinha] = new Array("hidden_field_label_rut_codigo_", "hidden_field_data_rut_codigo_" + iNumLinha);
    ajax_field_id["rut_secuencial_" + iNumLinha] = new Array("hidden_field_label_rut_secuencial_", "hidden_field_data_rut_secuencial_" + iNumLinha);
    ajax_error_count["rut_id_" + iNumLinha] = "off";
    ajax_error_count["rut_empresa_" + iNumLinha] = "off";
    ajax_error_count["rut_nombre_" + iNumLinha] = "off";
    ajax_error_count["rut_estado_" + iNumLinha] = "off";
    ajax_error_count["rut_codigo_" + iNumLinha] = "off";
    ajax_error_count["rut_secuencial_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["rut_id_" + iNumLinha] = "on";
    ajax_read_only["rut_empresa_" + iNumLinha] = "off";
    ajax_read_only["rut_nombre_" + iNumLinha] = "off";
    ajax_read_only["rut_estado_" + iNumLinha] = "off";
    ajax_read_only["rut_codigo_" + iNumLinha] = "off";
    ajax_read_only["rut_secuencial_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["rut_id_" + iNumLinha] = "on";
    ajax_read_only["rut_empresa_" + iNumLinha] = "on";
    ajax_read_only["rut_nombre_" + iNumLinha] = "on";
    ajax_read_only["rut_estado_" + iNumLinha] = "on";
    ajax_read_only["rut_codigo_" + iNumLinha] = "on";
    ajax_read_only["rut_secuencial_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["rut_id_" + iNumLinha] = null;
    ajax_error_list["rut_empresa_" + iNumLinha] = null;
    ajax_error_list["rut_nombre_" + iNumLinha] = null;
    ajax_error_list["rut_estado_" + iNumLinha] = null;
    ajax_error_list["rut_codigo_" + iNumLinha] = null;
    ajax_error_list["rut_secuencial_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "rut_id_": new Array(),
    "rut_empresa_": new Array(),
    "rut_nombre_": new Array(),
    "rut_estado_": new Array(),
    "rut_codigo_": new Array(),
    "rut_secuencial_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["rut_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rut_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rut_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rut_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rut_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["rut_empresa_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rut_empresa_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rut_empresa_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rut_empresa_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rut_empresa_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["rut_nombre_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rut_nombre_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rut_nombre_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rut_nombre_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rut_nombre_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["rut_estado_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rut_estado_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rut_estado_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rut_estado_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rut_estado_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["rut_codigo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rut_codigo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rut_codigo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rut_codigo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rut_codigo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["rut_secuencial_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rut_secuencial_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rut_secuencial_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rut_secuencial_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rut_secuencial_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rut_id_'])) ? $this->nmgp_cmp_readonly['rut_id_'] : 'on';
?>
    scAjaxFieldRead("rut_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rut_empresa_'])) ? $this->nmgp_cmp_readonly['rut_empresa_'] : 'off';
?>
    scAjaxFieldRead("rut_empresa_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rut_nombre_'])) ? $this->nmgp_cmp_readonly['rut_nombre_'] : 'off';
?>
    scAjaxFieldRead("rut_nombre_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rut_estado_'])) ? $this->nmgp_cmp_readonly['rut_estado_'] : 'off';
?>
    scAjaxFieldRead("rut_estado_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rut_codigo_'])) ? $this->nmgp_cmp_readonly['rut_codigo_'] : 'off';
?>
    scAjaxFieldRead("rut_codigo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rut_secuencial_'])) ? $this->nmgp_cmp_readonly['rut_secuencial_'] : 'off';
?>
    scAjaxFieldRead("rut_secuencial_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("rut_id_" + iSeq, "on");
    scAjaxFieldRead("rut_empresa_" + iSeq, "on");
    scAjaxFieldRead("rut_nombre_" + iSeq, "on");
    scAjaxFieldRead("rut_estado_" + iSeq, "on");
    scAjaxFieldRead("rut_codigo_" + iSeq, "on");
    scAjaxFieldRead("rut_secuencial_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["rut_id_" + iRow] || "on" == ajax_error_count["rut_empresa_" + iRow] || "on" == ajax_error_count["rut_nombre_" + iRow] || "on" == ajax_error_count["rut_estado_" + iRow] || "on" == ajax_error_count["rut_codigo_" + iRow] || "on" == ajax_error_count["rut_secuencial_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rut_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rut_empresa_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rut_nombre_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rut_estado_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rut_codigo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rut_secuencial_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["rut_id_" + iRow] && "off" == ajax_error_count["rut_empresa_" + iRow] && "off" == ajax_error_count["rut_nombre_" + iRow] && "off" == ajax_error_count["rut_estado_" + iRow] && "off" == ajax_error_count["rut_codigo_" + iRow] && "off" == ajax_error_count["rut_secuencial_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["rut_id_" + iRow] = "off";
        ajax_error_count["rut_empresa_" + iRow] = "off";
        ajax_error_count["rut_nombre_" + iRow] = "off";
        ajax_error_count["rut_estado_" + iRow] = "off";
        ajax_error_count["rut_codigo_" + iRow] = "off";
        ajax_error_count["rut_secuencial_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_rut_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_rut_empresa_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_rut_nombre_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_rut_estado_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_rut_codigo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_rut_secuencial_" + iRow).removeClass("scFormErrorLine");
    }
  }
