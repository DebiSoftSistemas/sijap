...
$old_error_handler = set_error_handler("control_enviar_coreo_scriptcase_error_handler");

function control_enviar_coreo_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['control_enviar_coreo']['contr_erro']) && $_SESSION['scriptcase']['control_enviar_coreo']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_control_enviar_coreo->contr_control_enviar_coreo->Apl_com_erro = true;
            if ($inicial_control_enviar_coreo->contr_control_enviar_coreo->NM_ajax_flag)
            {
                $inicial_control_enviar_coreo->contr_control_enviar_coreo->NM_ajax_info['errList']['geral_control_enviar_coreo'][] = $msg;
                return;
            }
            control_enviar_coreo_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function control_enviar_coreo_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['control_enviar_coreo'])  && '' != $_SESSION['scriptcase']['error_icon']['control_enviar_coreo'])  ? $_SESSION['scriptcase']['error_icon']['control_enviar_coreo']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['control_enviar_coreo']) && '' != $_SESSION['scriptcase']['error_close']['control_enviar_coreo']) ? $_SESSION['scriptcase']['error_close']['control_enviar_coreo'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['control_enviar_coreo']) && '' != $_SESSION['scriptcase']['error_span_title']['control_enviar_coreo']) ? $_SESSION['scriptcase']['error_span_title']['control_enviar_coreo'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['control_enviar_coreo']) && '' != $_SESSION['scriptcase']['error_icon_title']['control_enviar_coreo']) ? $_SESSION['scriptcase']['error_icon_title']['control_enviar_coreo'] : '';
?>
