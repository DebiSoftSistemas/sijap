  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_parametros_inline" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_parametros_inline_form();
	}
...
?>
  ...
  // ---------- Validate par_id_
  function do_ajax_form_del_parametros_inline_validate_par_id_()
  {
    var nomeCampo_par_id_ = "par_id_";
    var var_par_id_ = scAjaxGetFieldHidden(nomeCampo_par_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_parametros_inline_validate_par_id_(var_par_id_, var_script_case_init, do_ajax_form_del_parametros_inline_validate_par_id__cb);
  } // do_ajax_form_del_parametros_inline_validate_par_id_

  function do_ajax_form_del_parametros_inline_validate_par_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_parametros_inline_validate_par_id__cb

  // ---------- Validate par_empresa_
  function do_ajax_form_del_parametros_inline_validate_par_empresa_()
  {
    var nomeCampo_par_empresa_ = "par_empresa_";
    var var_par_empresa_ = scAjaxGetFieldText(nomeCampo_par_empresa_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_parametros_inline_validate_par_empresa_(var_par_empresa_, var_script_case_init, do_ajax_form_del_parametros_inline_validate_par_empresa__cb);
  } // do_ajax_form_del_parametros_inline_validate_par_empresa_

  function do_ajax_form_del_parametros_inline_validate_par_empresa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_parametros_inline_validate_par_empresa__cb

  // ---------- Validate par_pametro_
  function do_ajax_form_del_parametros_inline_validate_par_pametro_()
  {
    var nomeCampo_par_pametro_ = "par_pametro_";
    var var_par_pametro_ = scAjaxGetFieldSelect(nomeCampo_par_pametro_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_parametros_inline_validate_par_pametro_(var_par_pametro_, var_script_case_init, do_ajax_form_del_parametros_inline_validate_par_pametro__cb);
  } // do_ajax_form_del_parametros_inline_validate_par_pametro_

  function do_ajax_form_del_parametros_inline_validate_par_pametro__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_parametros_inline_validate_par_pametro__cb

  // ---------- Validate par_valor_
  function do_ajax_form_del_parametros_inline_validate_par_valor_()
  {
    var nomeCampo_par_valor_ = "par_valor_";
    var var_par_valor_ = scAjaxGetFieldText(nomeCampo_par_valor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_parametros_inline_validate_par_valor_(var_par_valor_, var_script_case_init, do_ajax_form_del_parametros_inline_validate_par_valor__cb);
  } // do_ajax_form_del_parametros_inline_validate_par_valor_

  function do_ajax_form_del_parametros_inline_validate_par_valor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_parametros_inline_validate_par_valor__cb

  // ---------- Validate par_tipo_
  function do_ajax_form_del_parametros_inline_validate_par_tipo_()
  {
    var nomeCampo_par_tipo_ = "par_tipo_";
    var var_par_tipo_ = scAjaxGetFieldSelect(nomeCampo_par_tipo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_parametros_inline_validate_par_tipo_(var_par_tipo_, var_script_case_init, do_ajax_form_del_parametros_inline_validate_par_tipo__cb);
  } // do_ajax_form_del_parametros_inline_validate_par_tipo_

  function do_ajax_form_del_parametros_inline_validate_par_tipo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_parametros_inline_validate_par_tipo__cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_parametros_inline_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_parametros_inline_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_par_id_ = scAjaxGetFieldHidden("par_id_");
    var var_par_empresa_ = scAjaxGetFieldText("par_empresa_");
    var var_par_pametro_ = scAjaxGetFieldSelect("par_pametro_");
    var var_par_valor_ = scAjaxGetFieldText("par_valor_");
    var var_par_tipo_ = scAjaxGetFieldSelect("par_tipo_");
    ...
    scAjaxProcOn();
    x_ajax_form_del_parametros_inline_submit_form(var_par_id_, var_par_empresa_, var_par_pametro_, var_par_valor_, var_par_tipo_, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_parametros_inline_submit_form_cb);
  } // do_ajax_form_del_parametros_inline_submit_form

  function do_ajax_form_del_parametros_inline_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("par_id_");
      scAjaxHideErrorDisplay("par_empresa_");
      scAjaxHideErrorDisplay("par_pametro_");
      scAjaxHideErrorDisplay("par_valor_");
      scAjaxHideErrorDisplay("par_tipo_");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_parametros_inline_submit_form_cb_after_alert);
  } // do_ajax_form_del_parametros_inline_submit_form_cb
  function do_ajax_form_del_parametros_inline_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_parametros_inline_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_parametros_inline_navigate_form()
  {
    perform_ajax_form_del_parametros_inline_navigate_form();
  }

  function perform_ajax_form_del_parametros_inline_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_del_parametros_inline_navigate_form(var_par_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_parametros_inline_navigate_form_cb);
  } // do_ajax_form_del_parametros_inline_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_parametros_inline']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_parametros_inline_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_parametros_inline_navigate_form_cb_after_alert);
  } // do_ajax_form_del_parametros_inline_navigate_form_cb
  function do_ajax_form_del_parametros_inline_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_del_parametros_inline_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_parametros_inline_navigate_form_cb_after_alert

  function sc_hide_form_del_parametros_inline_form()
  {
  ...
  ajax_field_list[0] = "par_id_";
  ajax_field_list[1] = "par_empresa_";
  ajax_field_list[2] = "par_pametro_";
  ajax_field_list[3] = "par_valor_";
  ajax_field_list[4] = "par_tipo_";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "par_id_": {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "par_empresa_": {"label": "<?php echo $this->Ini->Nm_lang['lang_empresa'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "par_pametro_": {"label": "<?php echo $this->Ini->Nm_lang['lang_parametro'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "par_valor_": {"label": "<?php echo $this->Ini->Nm_lang['lang_valor'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "par_tipo_": {"label": "<?php echo $this->Ini->Nm_lang['lang_tipo'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["par_id_"][1] = "par_id_";
  ajax_field_mult["par_empresa_"][1] = "par_empresa_";
  ajax_field_mult["par_pametro_"][1] = "par_pametro_";
  ajax_field_mult["par_valor_"][1] = "par_valor_";
  ajax_field_mult["par_tipo_"][1] = "par_tipo_";

  var ajax_field_id = {
    "par_pametro_": new Array("hidden_field_label_par_pametro_", "hidden_field_data_par_pametro_"),
    "par_valor_": new Array("hidden_field_label_par_valor_", "hidden_field_data_par_valor_"),
    "par_tipo_": new Array("hidden_field_label_par_tipo_", "hidden_field_data_par_tipo_")
  };
