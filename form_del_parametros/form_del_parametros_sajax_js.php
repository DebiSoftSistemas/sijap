  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_parametros" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_parametros_form();
	}
...
?>
  ...
  // ---------- Validate par_id_
  function do_ajax_form_del_parametros_validate_par_id_(iNumLinha)
  {
    var nomeCampo_par_id_ = "par_id_" + iNumLinha;
    var var_par_id_ = scAjaxGetFieldHidden(nomeCampo_par_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_parametros_validate_par_id_(var_par_id_, iNumLinha, var_script_case_init, do_ajax_form_del_parametros_validate_par_id__cb);
  } // do_ajax_form_del_parametros_validate_par_id_

  function do_ajax_form_del_parametros_validate_par_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "par_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "par_id_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "par_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "par_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_parametros_validate_par_id__cb

  // ---------- Validate par_empresa_
  function do_ajax_form_del_parametros_validate_par_empresa_(iNumLinha)
  {
    var nomeCampo_par_empresa_ = "par_empresa_" + iNumLinha;
    var var_par_empresa_ = scAjaxGetFieldText(nomeCampo_par_empresa_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_parametros_validate_par_empresa_(var_par_empresa_, iNumLinha, var_script_case_init, do_ajax_form_del_parametros_validate_par_empresa__cb);
  } // do_ajax_form_del_parametros_validate_par_empresa_

  function do_ajax_form_del_parametros_validate_par_empresa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "par_empresa_" + iLineNumber;
    }
    else
    {
      sFieldValid = "par_empresa_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "par_empresa_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "par_empresa_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_parametros_validate_par_empresa__cb

  // ---------- Validate par_pametro_
  function do_ajax_form_del_parametros_validate_par_pametro_(iNumLinha)
  {
    var nomeCampo_par_pametro_ = "par_pametro_" + iNumLinha;
    var var_par_pametro_ = scAjaxGetFieldSelect(nomeCampo_par_pametro_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_parametros_validate_par_pametro_(var_par_pametro_, iNumLinha, var_script_case_init, do_ajax_form_del_parametros_validate_par_pametro__cb);
  } // do_ajax_form_del_parametros_validate_par_pametro_

  function do_ajax_form_del_parametros_validate_par_pametro__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "par_pametro_" + iLineNumber;
    }
    else
    {
      sFieldValid = "par_pametro_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "par_pametro_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "par_pametro_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_parametros_validate_par_pametro__cb

  // ---------- Validate par_valor_
  function do_ajax_form_del_parametros_validate_par_valor_(iNumLinha)
  {
    var nomeCampo_par_valor_ = "par_valor_" + iNumLinha;
    var var_par_valor_ = scAjaxGetFieldText(nomeCampo_par_valor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_parametros_validate_par_valor_(var_par_valor_, iNumLinha, var_script_case_init, do_ajax_form_del_parametros_validate_par_valor__cb);
  } // do_ajax_form_del_parametros_validate_par_valor_

  function do_ajax_form_del_parametros_validate_par_valor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "par_valor_" + iLineNumber;
    }
    else
    {
      sFieldValid = "par_valor_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "par_valor_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "par_valor_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_parametros_validate_par_valor__cb

  // ---------- Validate par_tipo_
  function do_ajax_form_del_parametros_validate_par_tipo_(iNumLinha)
  {
    var nomeCampo_par_tipo_ = "par_tipo_" + iNumLinha;
    var var_par_tipo_ = scAjaxGetFieldSelect(nomeCampo_par_tipo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_parametros_validate_par_tipo_(var_par_tipo_, iNumLinha, var_script_case_init, do_ajax_form_del_parametros_validate_par_tipo__cb);
  } // do_ajax_form_del_parametros_validate_par_tipo_

  function do_ajax_form_del_parametros_validate_par_tipo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "par_tipo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "par_tipo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "par_tipo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "par_tipo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_parametros_validate_par_tipo__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_del_parametros_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_del_parametros_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_parametros_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_del_parametros_add_new_line_cb);
  } // do_ajax_form_del_parametros_add_new_line

  function do_ajax_form_del_parametros_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_del_parametros_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_del_parametros_backup_line(iNumLinha)
  {
    var var_par_id_ = scAjaxGetFieldHidden("par_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_parametros_backup_line(var_par_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_del_parametros_backup_line_cb);
  } // do_ajax_form_del_parametros_backup_line

  function do_ajax_form_del_parametros_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_del_parametros_backup_line_cb

  function do_ajax_form_del_parametros_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_del_parametros_cancel_insert

  function do_ajax_form_del_parametros_cancel_update(iSeqVert)
  {
    do_ajax_form_del_parametros_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_del_parametros_cancel_update

  function do_ajax_form_del_parametros_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_del_parametros_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_del_parametros_table_refresh()
  {
    var var_par_id_ = document.F2.par_id_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_del_parametros_table_refresh(var_par_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_parametros_table_refresh_cb);
  } //  do_ajax_form_del_parametros_table_refresh

  function do_ajax_form_del_parametros_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.par_id_.value = scAjaxGetKeyValue("par_id_");
    ...
    scAjaxAlert(do_ajax_form_del_parametros_table_refresh_cb_after_alert);
  } // do_ajax_form_del_parametros_table_refresh_cb
  function do_ajax_form_del_parametros_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_del_parametros_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_del_parametros_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_del_parametros_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_par_id_ = scAjaxGetFieldHidden("par_id_" + iNumLinha);
    var var_par_empresa_ = scAjaxGetFieldText("par_empresa_" + iNumLinha);
    var var_par_pametro_ = scAjaxGetFieldSelect("par_pametro_" + iNumLinha);
    var var_par_valor_ = scAjaxGetFieldText("par_valor_" + iNumLinha);
    var var_par_tipo_ = scAjaxGetFieldSelect("par_tipo_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_del_parametros_submit_form(var_par_id_, var_par_empresa_, var_par_pametro_, var_par_valor_, var_par_tipo_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_parametros_submit_form_cb);
  } // do_ajax_form_del_parametros_submit_form

  function do_ajax_form_del_parametros_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("par_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("par_empresa_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("par_pametro_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("par_valor_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("par_tipo_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_parametros_submit_form_cb_after_alert);
  } // do_ajax_form_del_parametros_submit_form_cb
  function do_ajax_form_del_parametros_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_parametros_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_parametros_navigate_form()
  {
    perform_ajax_form_del_parametros_navigate_form();
  }

  function perform_ajax_form_del_parametros_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_del_parametros_cancel_insert(sc_form_del_parametros_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("par_id_" + iNavForm);
      scAjaxHideErrorDisplay("par_empresa_" + iNavForm);
      scAjaxHideErrorDisplay("par_pametro_" + iNavForm);
      scAjaxHideErrorDisplay("par_valor_" + iNavForm);
      scAjaxHideErrorDisplay("par_tipo_" + iNavForm);
    }
    var var_par_id_ = document.F2.par_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_parametros_navigate_form(var_par_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_parametros_navigate_form_cb);
  } // do_ajax_form_del_parametros_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_parametros']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_parametros_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.par_id_.value = scAjaxGetKeyValue("par_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_parametros_navigate_form_cb_after_alert);
  } // do_ajax_form_del_parametros_navigate_form_cb
  function do_ajax_form_del_parametros_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_del_parametros_navigate_form_cb_after_alert

    function sc_form_del_parametros_get_last_line_number()
    {
    ...
    } //sc_form_del_parametros_get_last_line_number

  function sc_hide_form_del_parametros_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "par_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "par_empresa_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "par_pametro_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "par_valor_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "par_tipo_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["par_id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["par_empresa_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_empresa'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["par_pametro_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_parametro'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["par_valor_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_valor'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["par_tipo_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tipo'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["par_id_"][iNumLinha] = "par_id_" + iNumLinha;
    ajax_field_mult["par_empresa_"][iNumLinha] = "par_empresa_" + iNumLinha;
    ajax_field_mult["par_pametro_"][iNumLinha] = "par_pametro_" + iNumLinha;
    ajax_field_mult["par_valor_"][iNumLinha] = "par_valor_" + iNumLinha;
    ajax_field_mult["par_tipo_"][iNumLinha] = "par_tipo_" + iNumLinha;
    ajax_field_id["par_pametro_" + iNumLinha] = new Array("hidden_field_label_par_pametro_", "hidden_field_data_par_pametro_" + iNumLinha);
    ajax_field_id["par_valor_" + iNumLinha] = new Array("hidden_field_label_par_valor_", "hidden_field_data_par_valor_" + iNumLinha);
    ajax_field_id["par_tipo_" + iNumLinha] = new Array("hidden_field_label_par_tipo_", "hidden_field_data_par_tipo_" + iNumLinha);
    ajax_error_count["par_id_" + iNumLinha] = "off";
    ajax_error_count["par_empresa_" + iNumLinha] = "off";
    ajax_error_count["par_pametro_" + iNumLinha] = "off";
    ajax_error_count["par_valor_" + iNumLinha] = "off";
    ajax_error_count["par_tipo_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["par_id_" + iNumLinha] = "on";
    ajax_read_only["par_empresa_" + iNumLinha] = "off";
    ajax_read_only["par_pametro_" + iNumLinha] = "off";
    ajax_read_only["par_valor_" + iNumLinha] = "off";
    ajax_read_only["par_tipo_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["par_id_" + iNumLinha] = "on";
    ajax_read_only["par_empresa_" + iNumLinha] = "on";
    ajax_read_only["par_pametro_" + iNumLinha] = "on";
    ajax_read_only["par_valor_" + iNumLinha] = "on";
    ajax_read_only["par_tipo_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["par_id_" + iNumLinha] = null;
    ajax_error_list["par_empresa_" + iNumLinha] = null;
    ajax_error_list["par_pametro_" + iNumLinha] = null;
    ajax_error_list["par_valor_" + iNumLinha] = null;
    ajax_error_list["par_tipo_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "par_id_": new Array(),
    "par_empresa_": new Array(),
    "par_pametro_": new Array(),
    "par_valor_": new Array(),
    "par_tipo_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["par_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["par_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["par_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["par_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["par_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["par_empresa_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["par_empresa_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["par_empresa_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["par_empresa_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["par_empresa_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["par_pametro_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["par_pametro_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["par_pametro_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["par_pametro_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["par_pametro_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["par_valor_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["par_valor_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["par_valor_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["par_valor_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["par_valor_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["par_tipo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["par_tipo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["par_tipo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["par_tipo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["par_tipo_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['par_id_'])) ? $this->nmgp_cmp_readonly['par_id_'] : 'on';
?>
    scAjaxFieldRead("par_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['par_empresa_'])) ? $this->nmgp_cmp_readonly['par_empresa_'] : 'off';
?>
    scAjaxFieldRead("par_empresa_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['par_pametro_'])) ? $this->nmgp_cmp_readonly['par_pametro_'] : 'off';
?>
    scAjaxFieldRead("par_pametro_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['par_valor_'])) ? $this->nmgp_cmp_readonly['par_valor_'] : 'off';
?>
    scAjaxFieldRead("par_valor_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['par_tipo_'])) ? $this->nmgp_cmp_readonly['par_tipo_'] : 'off';
?>
    scAjaxFieldRead("par_tipo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("par_id_" + iSeq, "on");
    scAjaxFieldRead("par_empresa_" + iSeq, "on");
    scAjaxFieldRead("par_pametro_" + iSeq, "on");
    scAjaxFieldRead("par_valor_" + iSeq, "on");
    scAjaxFieldRead("par_tipo_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["par_id_" + iRow] || "on" == ajax_error_count["par_empresa_" + iRow] || "on" == ajax_error_count["par_pametro_" + iRow] || "on" == ajax_error_count["par_valor_" + iRow] || "on" == ajax_error_count["par_tipo_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_par_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_par_empresa_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_par_pametro_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_par_valor_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_par_tipo_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["par_id_" + iRow] && "off" == ajax_error_count["par_empresa_" + iRow] && "off" == ajax_error_count["par_pametro_" + iRow] && "off" == ajax_error_count["par_valor_" + iRow] && "off" == ajax_error_count["par_tipo_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["par_id_" + iRow] = "off";
        ajax_error_count["par_empresa_" + iRow] = "off";
        ajax_error_count["par_pametro_" + iRow] = "off";
        ajax_error_count["par_valor_" + iRow] = "off";
        ajax_error_count["par_tipo_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_par_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_par_empresa_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_par_pametro_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_par_valor_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_par_tipo_" + iRow).removeClass("scFormErrorLine");
    }
  }
