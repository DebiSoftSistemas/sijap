...
class grid_v_del_ventas_credito_contrato_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
...
SCEOT;
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_v_del_ventas_credito_contrato']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_v_del_ventas_credito_contrato']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['where_resumo'] = "";
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['contr_total_geral'] == "OK")
      {
          $this->array_total_con_numero_contrato = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['arr_total']['con_numero_contrato'];
      }
      else
      {
          $this->array_total_con_numero_contrato = array();
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['arr_total']['con_numero_contrato'] = $this->array_total_con_numero_contrato;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['json_use_label'])
       {
          $Lab_con_numero_contrato = "con_numero_contrato";
       }
       else
       {
       $Lab_con_numero_contrato = "" . $this->Ini->Nm_lang['lang_contrato'] . "";
       }
       $this->comp_field = array(
           $Lab_con_numero_contrato,
       );

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['labels']['fac_fecha']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['labels']['fac_fecha'] = "" . $this->Ini->Nm_lang['lang_fecha'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['labels']['con_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['labels']['con_id'] = "" . $this->Ini->Nm_lang['lang_numero_contrato'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['labels']['factura']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['labels']['factura'] = "" . $this->Ini->Nm_lang['lang_factura'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['labels']['fac_comentario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['labels']['fac_comentario'] = "" . $this->Ini->Nm_lang['lang_inf_adicional'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['labels']['fp_valor']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['labels']['fp_valor'] = "" . $this->Ini->Nm_lang['lang_saldo_inicial'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['labels']['fp_valor_pago']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['labels']['fp_valor_pago'] = "" . $this->Ini->Nm_lang['lang_valor_pagado'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['labels']['fp_saldo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['labels']['fp_saldo'] = "" . $this->Ini->Nm_lang['lang_saldo_pagar'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['labels']['seleccionar']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['labels']['seleccionar'] = ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['labels']['fp_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['labels']['fp_id'] = "" . $this->Ini->Nm_lang['lang_id'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['labels']['fac_empresa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['labels']['fac_empresa'] = "Fac Empresa"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['labels']['fp_seleccion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['labels']['fp_seleccion'] = "Fp Seleccion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['labels']['fp_usuario_selecciona']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['labels']['fp_usuario_selecciona'] = "Fp Usuario Selecciona"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['labels']['fac_numero']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['labels']['fac_numero'] = "Fac Numero"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['labels']['fac_cliente']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['labels']['fac_cliente'] = "Fac Cliente"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['labels']['con_numero_contrato']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['labels']['con_numero_contrato'] = "Con Numero Contrato"; 
       }
       //-----
       $this->comp_field_nm = array(
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['summarizing_fields_order']['con_numero_contrato']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['summarizing_fields_order']['con_numero_contrato'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['summarizing_fields_order']['con_numero_contrato'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['summarizing_fields_display']['con_numero_contrato'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['summarizing_fields_display']['con_numero_contrato'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['summarizing_fields_display']['con_numero_contrato'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['summarizing_fields_display']['con_numero_contrato'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['summarizing_fields_display']['con_numero_contrato'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['summarizing_fields_display']['con_numero_contrato'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['summarizing_fields_display']['con_numero_contrato'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_con_numero_contrato as $i_con_numero_contrato => $d_con_numero_contrato) {
           if (!isset($i_con_numero_contrato, $this->comp_label[0]) || !in_array($i_con_numero_contrato, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_con_numero_contrato[3] ] = $d_con_numero_contrato[2];
               $this->comp_label[0][ $d_con_numero_contrato[3] ] = $d_con_numero_contrato[2];
           }
       }
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_v_del_ventas_credito_contrato@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['proc_pdf_vert']){ 
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_v_del_ventas_credito_contrato_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['dashboard_refresh_after_chart'] = 'resumo';
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>" . $this->Ini->Nm_lang['lang_othr_smry_title'] . " v_del_ventas_credito</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_del_ventas_credito_contrato_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_v_del_ventas_credito_contrato_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_del_ventas_credito_contrato_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_v_del_ventas_credito_contrato/grid_v_del_ventas_credito_contrato_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_v_del_ventas_credito_contrato/grid_v_del_ventas_credito_contrato_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid&nm_all_modules=grid&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_v_del_ventas_credito_contrato/grid_v_del_ventas_credito_contrato_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_v_del_ventas_credito_contrato&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid&nm_all_modules=grid&password=n&summary_export_columns=S&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_v_del_ventas_credito_contrato/grid_v_del_ventas_credito_contrato_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid&nm_all_modules=grid&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_v_del_ventas_credito_contrato_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_v_del_ventas_credito_contrato']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_v_del_ventas_credito_contrato']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_v_del_ventas_credito_contrato_config_pivot.php?nome_apl=grid_v_del_ventas_credito_contrato&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"grid_v_del_ventas_credito_contrato_iframe.php\";\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_del_ventas_credito_contrato_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_v_del_ventas_credito_contrato/grid_v_del_ventas_credito_contrato_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_ventas_credito_contrato']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $fp_id = (isset($Busca_temp['fp_id'])) ? $Busca_temp['fp_id'] : ""; 
          $tmp_pos = (is_string($fp_id)) ? strpos($fp_id, "##@@") : false;
          if ($tmp_pos !== false && !is_array($fp_id))
          {
              $fp_id = substr($fp_id, 0, $tmp_pos);
          }
          $fac_empresa = (isset($Busca_temp['fac_empresa'])) ? $Busca_temp['fac_empresa'] : ""; 
          $tmp_pos = (is_string($fac_empresa)) ? strpos($fac_empresa, "##@@") : false;
          if ($tmp_pos !== false && !is_array($fac_empresa))
          {
          ...
          $fac_fecha_2 = (isset($Busca_temp['fac_fecha_input_2'])) ? $Busca_temp['fac_fecha_input_2'] : ""; 
          $factura = (isset($Busca_temp['factura'])) ? $Busca_temp['factura'] : ""; 
          $tmp_pos = (is_string($factura)) ? strpos($factura, "##@@") : false;
          if ($tmp_pos !== false && !is_array($factura))
          {
   ...
   //---- 
   function adiciona_registro($sum_fp_saldo, $quebra_con_numero_contrato, $quebra_con_numero_contrato_orig)
   {
      //----- Con Numero Contrato
      if (!isset($this->array_total_con_numero_contrato[$quebra_con_numero_contrato_orig]))
      {
         ...
         $this->array_total_con_numero_contrato[$quebra_con_numero_contrato_orig][1] = $sum_fp_saldo;
         $this->array_total_con_numero_contrato[$quebra_con_numero_contrato_orig][2] = $quebra_con_numero_contrato;
         $this->array_total_con_numero_contrato[$quebra_con_numero_contrato_orig][3] = $quebra_con_numero_contrato_orig;
      }
      else
      {
         $this->array_total_con_numero_contrato[$quebra_con_numero_contrato_orig][0]++;
         $this->array_total_con_numero_contrato[$quebra_con_numero_contrato_orig][1] = bcadd($this->array_total_con_numero_contrato[$quebra_con_numero_contrato_orig][1], $sum_fp_saldo, 10);
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
       ...
       $this->fac_empresa = $Busca_temp['fac_empresa']; 
       $this->fac_empresa = (isset($Busca_temp['fac_empresa'])) ? $Busca_temp['fac_empresa'] : ""; 
       $tmp_pos = (is_string($this->fac_empresa)) ? strpos($this->fac_empresa, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->fac_empresa))
       {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('con_numero_contrato', 'con_numero_contrato');
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->fp_seleccion = $rs_res->fields[9] ;  
            $this->con_numero_contrato = $rs_res->fields[10] ;  
            $this->fac_cliente = $rs_res->fields[11] ;  
...
$_SESSION['scriptcase']['grid_v_del_ventas_credito_contrato']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->fp_saldo, $this->con_numero_contrato, $this->con_numero_contrato_orig);
            }
   }
//
