...
<?php
   ...
   $Ord_Cmp = new grid_v_del_ventas_credito_contrato_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_v_del_ventas_credito_contrato_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_del_ventas_credito_contrato']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_del_ventas_credito_contrato']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["fac_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_ventas_credito_contrato']['labels']["fac_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_ventas_credito_contrato']['labels']["fac_fecha"] : "" . $this->Nm_lang['lang_fecha'] . "";
   $tab_ger_campos['con_id'] = "on";
   $tab_def_campos['con_id'] = "con_id";
   $tab_labels["con_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_ventas_credito_contrato']['labels']["con_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_ventas_credito_contrato']['labels']["con_id"] : "" . $this->Nm_lang['lang_numero_contrato'] . "";
   $tab_ger_campos['factura'] = "on";
   $tab_def_campos['factura'] = "factura";
   $tab_labels["factura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_ventas_credito_contrato']['labels']["factura"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_ventas_credito_contrato']['labels']["factura"] : "" . $this->Nm_lang['lang_factura'] . "";
   $tab_ger_campos['fac_comentario'] = "on";
   $tab_def_campos['fac_comentario'] = "fac_comentario";
   $tab_labels["fac_comentario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_ventas_credito_contrato']['labels']["fac_comentario"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_ventas_credito_contrato']['labels']["fac_comentario"] : "" . $this->Nm_lang['lang_inf_adicional'] . "";
   $tab_ger_campos['fp_valor'] = "on";
   $tab_def_campos['fp_valor'] = "fp_valor";
   $tab_labels["fp_valor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_ventas_credito_contrato']['labels']["fp_valor"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_ventas_credito_contrato']['labels']["fp_valor"] : "" . $this->Nm_lang['lang_saldo_inicial'] . "";
   $tab_ger_campos['fp_valor_pago'] = "on";
   $tab_def_campos['fp_valor_pago'] = "fp_valor_pago";
   $tab_labels["fp_valor_pago"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_ventas_credito_contrato']['labels']["fp_valor_pago"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_ventas_credito_contrato']['labels']["fp_valor_pago"] : "" . $this->Nm_lang['lang_valor_pagado'] . "";
   $tab_ger_campos['fp_saldo'] = "on";
   $tab_def_campos['fp_saldo'] = "fp_saldo";
   $tab_labels["fp_saldo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_ventas_credito_contrato']['labels']["fp_saldo"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_ventas_credito_contrato']['labels']["fp_saldo"] : "" . $this->Nm_lang['lang_saldo_pagar'] . "";
   ...
   $tab_labels["seleccionar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_ventas_credito_contrato']['labels']["seleccionar"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_ventas_credito_contrato']['labels']["seleccionar"] : "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_ventas_credito_contrato']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_v_del_ventas_credito_contrato']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_v_del_ventas_credito_contrato']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_del_ventas_credito_contrato']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_del_ventas_credito_contrato']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_v_del_ventas_credito_contrato']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_v_del_ventas_credito_contrato']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_v_del_ventas_credito_contrato']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_ventas_credito_contrato']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_v_del_ventas_credito_contrato']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_v_del_ventas_credito_contrato']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_v_del_ventas_credito_contrato']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_v_del_ventas_credito_contrato_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_ventas_credito_contrato']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_v_del_ventas_credito_contrato']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_ventas_credito_contrato']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_v_del_ventas_credito_contrato']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_v_del_ventas_credito_contrato']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
