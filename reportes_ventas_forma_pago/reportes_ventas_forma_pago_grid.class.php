...
//
   ...
   $this->Cmps_ord_def['fp_transaccion'] = " asc";
   $this->Cmps_ord_def['fp_lote'] = " asc";
...
//----- 
   ...
   { 
       ...
       $this->fp_transaccion = $this->rs_grid->fields[15] ;  
       $this->fp_lote = $this->rs_grid->fields[16] ;  
       $this->fac_estado_sri = $this->rs_grid->fields[17] ;  
       $this->fac_usuario = $this->rs_grid->fields[18] ;  
       $this->fac_numero = $this->rs_grid->fields[19] ;  
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       { 
           ...
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"reportes_ventas_forma_pago_jquery_2431.js\"></script>\r\n");
...
$nm_saida->saida("}\r\n");
 ...
 {  
   ...
   $this->css_fp_transaccion_label = $compl_css_emb . "css_fp_transaccion_label";
   $this->css_fp_transaccion_grid_line = $compl_css_emb . "css_fp_transaccion_grid_line";
   $this->css_fp_lote_label = $compl_css_emb . "css_fp_lote_label";
   $this->css_fp_lote_grid_line = $compl_css_emb . "css_fp_lote_grid_line";
 }  
 function cabecalho()
 {
...
// 
 function label_grid($linhas = 0)
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_fp_lote_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_psq']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_fp_lote_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . " sc-col-actionbar-left  " . $classColFld . $classColTitle . $classColActions . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_fp_lote_label'] . "\" >\r\n");
   $nm_saida->saida("<style>\r\n");
 ...
 function NM_label_fp_transaccion()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['fp_transaccion']) || $this->NM_cmp_hidden['fp_transaccion'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_fp_transaccion_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_fp_transaccion_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
        $fieldSortRule = $this->scGetColumnOrderRule('fp_transaccion');
        $fieldSortIcon = $this->scGetColumnOrderIcon('fp_transaccion', $fieldSortRule);
        if (empty($this->Ini->Label_sort_pos) || $this->Ini->Label_sort_pos == 'right') {
            $this->Ini->Label_sort_pos = 'right_field';
        }
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_fp_transaccion_label . "\" style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_field') {
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\">" . $fieldSortIcon . "<div style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div></div>";
        } elseif ($this->Ini->Label_sort_pos == 'right_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_fp_transaccion_label . "\" style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\">" . $fieldSortIcon . "<div style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div></div>";
        } else {
            $label_labelContent = "<div style=\"flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>";
        }
        $label_labelContent = "<a href=\"javascript:nm_gp_submit2('fp_transaccion')\" class=\"" . $this->css_scGridLabelLink . "\">". $label_labelContent . "</a>";
        $label_divLabel = "<div style=\"flex-grow: 1\">". $label_labelContent . "</div>";
        // controls
        $label_chart = '';
        $label_fixedColumn = "<span class=\"sc-op-fix-col sc-op-fix-col-" . $this->grid_fixed_column_no . " sc-op-fix-col-notfixed\" data-fixcolid=\"" . $this->grid_fixed_column_no . "\" id=\"sc-fld-fix-col-" . $this->grid_fixed_column_no . "\"><i class=\"fas fa-thumbtack\"></i></span>";
 ...
 function NM_label_fp_lote()
 {
   ...
   if (!isset($this->NM_cmp_hidden['fp_lote']) || $this->NM_cmp_hidden['fp_lote'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_fp_lote_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_fp_lote_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
        $fieldSortRule = $this->scGetColumnOrderRule('fp_lote');
        $fieldSortIcon = $this->scGetColumnOrderIcon('fp_lote', $fieldSortRule);
        if (empty($this->Ini->Label_sort_pos) || $this->Ini->Label_sort_pos == 'right') {
            $this->Ini->Label_sort_pos = 'right_field';
        }
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_fp_lote_label . "\" style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_field') {
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\">" . $fieldSortIcon . "<div style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div></div>";
        } elseif ($this->Ini->Label_sort_pos == 'right_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_fp_lote_label . "\" style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\">" . $fieldSortIcon . "<div style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div></div>";
        } else {
            $label_labelContent = "<div style=\"flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>";
        }
        $label_labelContent = "<a href=\"javascript:nm_gp_submit2('fp_lote')\" class=\"" . $this->css_scGridLabelLink . "\">". $label_labelContent . "</a>";
        $label_divLabel = "<div style=\"flex-grow: 1\">". $label_labelContent . "</div>";
        // controls
        $label_chart = '';
        $label_fixedColumn = "<span class=\"sc-op-fix-col sc-op-fix-col-" . $this->grid_fixed_column_no . " sc-op-fix-col-notfixed\" data-fixcolid=\"" . $this->grid_fixed_column_no . "\" id=\"sc-fld-fix-col-" . $this->grid_fixed_column_no . "\"><i class=\"fas fa-thumbtack\"></i></span>";
...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fp_transaccion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['fp_lote'])) ? $this->New_label['fp_lote'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fp_lote'] = $SC_Label; 
...
$_SESSION['scriptcase']['reportes_ventas_forma_pago']['contr_erro'] = 'off';
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['embutida_grid']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->Css_Cmp['css_fp_lote_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"   HEIGHT=\"0px\">&nbsp;</TD>\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opc_psq']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  style=\"" . $this->Css_Cmp['css_fp_lote_grid_line'] . "\" NOWRAP align=\"left\" valign=\"top\" WIDTH=\"1px\"  HEIGHT=\"0px\">\r\n");
...
function SC_grid_rightActionBar()
{
 ...
 function NM_grid_fp_transaccion()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['fp_transaccion']) || $this->NM_cmp_hidden['fp_transaccion'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
              $conteudo = NM_encode_input(sc_strip_script($this->fp_transaccion));
              $conteudo_original = NM_encode_input(sc_strip_script($this->fp_transaccion));
          }
          else {
              $conteudo = sc_strip_script($this->fp_transaccion); 
              $conteudo_original = sc_strip_script($this->fp_transaccion); 
          }
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_inherit_bg . ' ' . $this->css_line_fonf . $this->css_sep . $this->css_fp_transaccion_grid_line . " " . $classColFld . "\"  style=\"" . $this->Css_Cmp['css_fp_transaccion_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_fp_transaccion_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_fp_lote()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['fp_lote']) || $this->NM_cmp_hidden['fp_lote'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
              $conteudo = NM_encode_input(sc_strip_script($this->fp_lote));
              $conteudo_original = NM_encode_input(sc_strip_script($this->fp_lote));
          }
          else {
              $conteudo = sc_strip_script($this->fp_lote); 
              $conteudo_original = sc_strip_script($this->fp_lote); 
          }
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_inherit_bg . ' ' . $this->css_line_fonf . $this->css_sep . $this->css_fp_lote_grid_line . " " . $classColFld . "\"  style=\"" . $this->Css_Cmp['css_fp_lote_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_fp_lote_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 ...
 function quebra_fac_fecha_sc_free_group_by_bot($Cmp_Name) 
 {
  ...
  foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
  {
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['field_order'] as $Cada_cmp)
   {
    ...
    if ($Cada_cmp == "fp_transaccion" && (!isset($this->NM_cmp_hidden['fp_transaccion']) || $this->NM_cmp_hidden['fp_transaccion'] != "off"))
    {
        $colspan++;
    }
    if ($Cada_cmp == "fp_lote" && (!isset($this->NM_cmp_hidden['fp_lote']) || $this->NM_cmp_hidden['fp_lote'] != "off"))
    {
        $colspan++;
    }
   }
