...
SCEOT;
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fp_transaccion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fp_transaccion'] = "" . $this->Ini->Nm_lang['lang_numero_transaccion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fp_lote']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['labels']['fp_lote'] = "" . $this->Ini->Nm_lang['lang_lot_lote'] . ""; 
       }
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->fp_transaccion = $rs_res->fields[15] ;  
            $this->fp_lote = $rs_res->fields[16] ;  
            $this->fac_estado_sri = $rs_res->fields[17] ;  
            $this->fac_usuario = $rs_res->fields[18] ;  
            $this->fac_numero = $rs_res->fields[19] ;  
