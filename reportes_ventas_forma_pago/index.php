...
//----- 
   function controle($linhas = 0)
   {
      ...
      { 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['field_order'][] = "fp_transaccion";
          $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['field_order'][] = "fp_lote";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['usr_cmp_sel']['fp_transaccion'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['reportes_ventas_forma_pago']['usr_cmp_sel']['fp_lote'] = "off";
