<?php
@session_start() ;
$_SESSION['scriptcase']['reportes_ventas_forma_pago']['sc_process_barr'] = true;
require_once('../reportes_ventas_forma_pago/index.php');
unset($_SESSION['scriptcase']['reportes_ventas_forma_pago']['sc_process_barr']);
$ExportCtrl = new reportes_ventas_forma_pago_export_control;
$ExportCtrl->Export_barr();

class reportes_ventas_forma_pago_export_control
{
