...
?>
  ...
  function do_ajax_form_inv_toma_fisica_validate_tf_comentario()
  {
    var nomeCampo_tf_comentario = "tf_comentario";
    var var_tf_comentario = scAjaxGetFieldText(nomeCampo_tf_comentario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_toma_fisica_validate_tf_comentario(var_tf_comentario, var_script_case_init, do_ajax_form_inv_toma_fisica_validate_tf_comentario_cb);
  } // do_ajax_form_inv_toma_fisica_validate_tf_comentario

  function do_ajax_form_inv_toma_fisica_validate_tf_comentario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_toma_fisica_validate_tf_comentario_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_inv_toma_fisica_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_inv_toma_fisica_submit_form(var_tf_fecha, var_establecimiento, var_tf_bodega, var_tf_comentario, var_tf_id, var_tf_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_inv_toma_fisica_submit_form_cb);
