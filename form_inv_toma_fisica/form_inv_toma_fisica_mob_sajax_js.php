...
?>
  ...
  // ---------- Validate tf_comentario
  function do_ajax_form_inv_toma_fisica_mob_validate_tf_comentario()
  {
    var nomeCampo_tf_comentario = "tf_comentario";
    var var_tf_comentario = scAjaxGetFieldText(nomeCampo_tf_comentario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_toma_fisica_mob_validate_tf_comentario(var_tf_comentario, var_script_case_init, do_ajax_form_inv_toma_fisica_mob_validate_tf_comentario_cb);
  } // do_ajax_form_inv_toma_fisica_mob_validate_tf_comentario

  function do_ajax_form_inv_toma_fisica_mob_validate_tf_comentario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tf_comentario";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_toma_fisica_mob_validate_tf_comentario_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_inv_toma_fisica_mob_submit_form()
  {
    ...
    var var_tf_comentario = scAjaxGetFieldText("tf_comentario");
    ...
    scAjaxProcOn();
    x_ajax_form_inv_toma_fisica_mob_submit_form(var_tf_fecha, var_establecimiento, var_tf_bodega, var_tf_comentario, var_tf_id, var_tf_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_inv_toma_fisica_mob_submit_form_cb);
  ...
  function do_ajax_form_inv_toma_fisica_mob_submit_form_cb(sResp)
  {
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("tf_comentario");
...
?>
  ...
  ajax_field_list[3] = "tf_comentario";
  ajax_field_list[4] = "tf_id";
  ajax_field_list[5] = "tf_estado";
  ajax_field_list[6] = "productos";
  ...
  var ajax_error_list = {
    ...
    "tf_comentario": {"label": "<?php echo $this->Ini->Nm_lang['lang_comentario'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["tf_comentario"][1] = "tf_comentario";
  ...
  var ajax_field_id = {
    ...
    "tf_comentario": new Array("hidden_field_label_tf_comentario", "hidden_field_data_tf_comentario"),
