  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sri_tipo_comprobante" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sri_tipo_comprobante_form();
	}
...
?>
  ...
  // ---------- Validate tc_codigo_
  function do_ajax_form_sri_tipo_comprobante_validate_tc_codigo_(iNumLinha)
  {
    var nomeCampo_tc_codigo_ = "tc_codigo_" + iNumLinha;
    var var_tc_codigo_ = scAjaxGetFieldText(nomeCampo_tc_codigo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tipo_comprobante_validate_tc_codigo_(var_tc_codigo_, iNumLinha, var_script_case_init, do_ajax_form_sri_tipo_comprobante_validate_tc_codigo__cb);
  } // do_ajax_form_sri_tipo_comprobante_validate_tc_codigo_

  function do_ajax_form_sri_tipo_comprobante_validate_tc_codigo__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "tc_codigo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tc_codigo_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "tc_codigo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tc_codigo_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_tipo_comprobante_validate_tc_codigo__cb

  // ---------- Validate tc_nombre_
  function do_ajax_form_sri_tipo_comprobante_validate_tc_nombre_(iNumLinha)
  {
    var nomeCampo_tc_nombre_ = "tc_nombre_" + iNumLinha;
    var var_tc_nombre_ = scAjaxGetFieldText(nomeCampo_tc_nombre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tipo_comprobante_validate_tc_nombre_(var_tc_nombre_, iNumLinha, var_script_case_init, do_ajax_form_sri_tipo_comprobante_validate_tc_nombre__cb);
  } // do_ajax_form_sri_tipo_comprobante_validate_tc_nombre_

  function do_ajax_form_sri_tipo_comprobante_validate_tc_nombre__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tc_nombre_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tc_nombre_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tc_nombre_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tc_nombre_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_tipo_comprobante_validate_tc_nombre__cb

  // ---------- Validate tc_estado_
  function do_ajax_form_sri_tipo_comprobante_validate_tc_estado_(iNumLinha)
  {
    var nomeCampo_tc_estado_ = "tc_estado_" + iNumLinha;
    var var_tc_estado_ = scAjaxGetFieldSelect(nomeCampo_tc_estado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tipo_comprobante_validate_tc_estado_(var_tc_estado_, iNumLinha, var_script_case_init, do_ajax_form_sri_tipo_comprobante_validate_tc_estado__cb);
  } // do_ajax_form_sri_tipo_comprobante_validate_tc_estado_

  function do_ajax_form_sri_tipo_comprobante_validate_tc_estado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tc_estado_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tc_estado_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tc_estado_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tc_estado_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_tipo_comprobante_validate_tc_estado__cb

  // ---------- Validate tc_aplica_retencion_
  function do_ajax_form_sri_tipo_comprobante_validate_tc_aplica_retencion_(iNumLinha)
  {
    var nomeCampo_tc_aplica_retencion_ = "tc_aplica_retencion_" + iNumLinha;
    var var_tc_aplica_retencion_ = scAjaxGetFieldSelect(nomeCampo_tc_aplica_retencion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tipo_comprobante_validate_tc_aplica_retencion_(var_tc_aplica_retencion_, iNumLinha, var_script_case_init, do_ajax_form_sri_tipo_comprobante_validate_tc_aplica_retencion__cb);
  } // do_ajax_form_sri_tipo_comprobante_validate_tc_aplica_retencion_

  function do_ajax_form_sri_tipo_comprobante_validate_tc_aplica_retencion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tc_aplica_retencion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tc_aplica_retencion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tc_aplica_retencion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tc_aplica_retencion_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_tipo_comprobante_validate_tc_aplica_retencion__cb

  // ---------- Validate tc_aplica_nota_credito_
  function do_ajax_form_sri_tipo_comprobante_validate_tc_aplica_nota_credito_(iNumLinha)
  {
    var nomeCampo_tc_aplica_nota_credito_ = "tc_aplica_nota_credito_" + iNumLinha;
    var var_tc_aplica_nota_credito_ = scAjaxGetFieldSelect(nomeCampo_tc_aplica_nota_credito_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tipo_comprobante_validate_tc_aplica_nota_credito_(var_tc_aplica_nota_credito_, iNumLinha, var_script_case_init, do_ajax_form_sri_tipo_comprobante_validate_tc_aplica_nota_credito__cb);
  } // do_ajax_form_sri_tipo_comprobante_validate_tc_aplica_nota_credito_

  function do_ajax_form_sri_tipo_comprobante_validate_tc_aplica_nota_credito__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tc_aplica_nota_credito_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tc_aplica_nota_credito_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tc_aplica_nota_credito_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tc_aplica_nota_credito_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_tipo_comprobante_validate_tc_aplica_nota_credito__cb

  // ---------- Validate tc_aplica_nota_debito_
  function do_ajax_form_sri_tipo_comprobante_validate_tc_aplica_nota_debito_(iNumLinha)
  {
    var nomeCampo_tc_aplica_nota_debito_ = "tc_aplica_nota_debito_" + iNumLinha;
    var var_tc_aplica_nota_debito_ = scAjaxGetFieldSelect(nomeCampo_tc_aplica_nota_debito_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tipo_comprobante_validate_tc_aplica_nota_debito_(var_tc_aplica_nota_debito_, iNumLinha, var_script_case_init, do_ajax_form_sri_tipo_comprobante_validate_tc_aplica_nota_debito__cb);
  } // do_ajax_form_sri_tipo_comprobante_validate_tc_aplica_nota_debito_

  function do_ajax_form_sri_tipo_comprobante_validate_tc_aplica_nota_debito__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tc_aplica_nota_debito_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tc_aplica_nota_debito_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tc_aplica_nota_debito_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tc_aplica_nota_debito_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_tipo_comprobante_validate_tc_aplica_nota_debito__cb

  // ---------- Validate tc_aplica_guia_remision_
  function do_ajax_form_sri_tipo_comprobante_validate_tc_aplica_guia_remision_(iNumLinha)
  {
    var nomeCampo_tc_aplica_guia_remision_ = "tc_aplica_guia_remision_" + iNumLinha;
    var var_tc_aplica_guia_remision_ = scAjaxGetFieldSelect(nomeCampo_tc_aplica_guia_remision_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tipo_comprobante_validate_tc_aplica_guia_remision_(var_tc_aplica_guia_remision_, iNumLinha, var_script_case_init, do_ajax_form_sri_tipo_comprobante_validate_tc_aplica_guia_remision__cb);
  } // do_ajax_form_sri_tipo_comprobante_validate_tc_aplica_guia_remision_

  function do_ajax_form_sri_tipo_comprobante_validate_tc_aplica_guia_remision__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tc_aplica_guia_remision_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tc_aplica_guia_remision_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tc_aplica_guia_remision_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tc_aplica_guia_remision_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_tipo_comprobante_validate_tc_aplica_guia_remision__cb

  // ---------- Validate tc_aplica_compras_
  function do_ajax_form_sri_tipo_comprobante_validate_tc_aplica_compras_(iNumLinha)
  {
    var nomeCampo_tc_aplica_compras_ = "tc_aplica_compras_" + iNumLinha;
    var var_tc_aplica_compras_ = scAjaxGetFieldSelect(nomeCampo_tc_aplica_compras_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tipo_comprobante_validate_tc_aplica_compras_(var_tc_aplica_compras_, iNumLinha, var_script_case_init, do_ajax_form_sri_tipo_comprobante_validate_tc_aplica_compras__cb);
  } // do_ajax_form_sri_tipo_comprobante_validate_tc_aplica_compras_

  function do_ajax_form_sri_tipo_comprobante_validate_tc_aplica_compras__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tc_aplica_compras_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tc_aplica_compras_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tc_aplica_compras_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tc_aplica_compras_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_tipo_comprobante_validate_tc_aplica_compras__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_sri_tipo_comprobante_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_sri_tipo_comprobante_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sri_tipo_comprobante_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_sri_tipo_comprobante_add_new_line_cb);
  } // do_ajax_form_sri_tipo_comprobante_add_new_line

  function do_ajax_form_sri_tipo_comprobante_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_sri_tipo_comprobante_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_sri_tipo_comprobante_backup_line(iNumLinha)
  {
    var var_tc_codigo_ = scAjaxGetFieldText("tc_codigo_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tipo_comprobante_backup_line(var_tc_codigo_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_sri_tipo_comprobante_backup_line_cb);
  } // do_ajax_form_sri_tipo_comprobante_backup_line

  function do_ajax_form_sri_tipo_comprobante_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_sri_tipo_comprobante_backup_line_cb

  function do_ajax_form_sri_tipo_comprobante_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_sri_tipo_comprobante_cancel_insert

  function do_ajax_form_sri_tipo_comprobante_cancel_update(iSeqVert)
  {
    do_ajax_form_sri_tipo_comprobante_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_sri_tipo_comprobante_cancel_update

  function do_ajax_form_sri_tipo_comprobante_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_sri_tipo_comprobante_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_sri_tipo_comprobante_table_refresh()
  {
    var var_tc_codigo_ = document.F2.tc_codigo_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_sri_tipo_comprobante_table_refresh(var_tc_codigo_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sri_tipo_comprobante_table_refresh_cb);
  } //  do_ajax_form_sri_tipo_comprobante_table_refresh

  function do_ajax_form_sri_tipo_comprobante_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.tc_codigo_.value = scAjaxGetKeyValue("tc_codigo_");
    ...
    scAjaxAlert(do_ajax_form_sri_tipo_comprobante_table_refresh_cb_after_alert);
  } // do_ajax_form_sri_tipo_comprobante_table_refresh_cb
  function do_ajax_form_sri_tipo_comprobante_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_sri_tipo_comprobante_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_sri_tipo_comprobante_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_sri_tipo_comprobante_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_tc_codigo_ = scAjaxGetFieldText("tc_codigo_" + iNumLinha);
    var var_tc_nombre_ = scAjaxGetFieldText("tc_nombre_" + iNumLinha);
    var var_tc_estado_ = scAjaxGetFieldSelect("tc_estado_" + iNumLinha);
    var var_tc_aplica_retencion_ = scAjaxGetFieldSelect("tc_aplica_retencion_" + iNumLinha);
    var var_tc_aplica_nota_credito_ = scAjaxGetFieldSelect("tc_aplica_nota_credito_" + iNumLinha);
    var var_tc_aplica_nota_debito_ = scAjaxGetFieldSelect("tc_aplica_nota_debito_" + iNumLinha);
    var var_tc_aplica_guia_remision_ = scAjaxGetFieldSelect("tc_aplica_guia_remision_" + iNumLinha);
    var var_tc_aplica_compras_ = scAjaxGetFieldSelect("tc_aplica_compras_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_sri_tipo_comprobante_submit_form(var_tc_codigo_, var_tc_nombre_, var_tc_estado_, var_tc_aplica_retencion_, var_tc_aplica_nota_credito_, var_tc_aplica_nota_debito_, var_tc_aplica_guia_remision_, var_tc_aplica_compras_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sri_tipo_comprobante_submit_form_cb);
  } // do_ajax_form_sri_tipo_comprobante_submit_form

  function do_ajax_form_sri_tipo_comprobante_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("tc_codigo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tc_nombre_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tc_estado_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tc_aplica_retencion_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tc_aplica_nota_credito_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tc_aplica_nota_debito_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tc_aplica_guia_remision_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tc_aplica_compras_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sri_tipo_comprobante_submit_form_cb_after_alert);
  } // do_ajax_form_sri_tipo_comprobante_submit_form_cb
  function do_ajax_form_sri_tipo_comprobante_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sri_tipo_comprobante_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sri_tipo_comprobante_navigate_form()
  {
    perform_ajax_form_sri_tipo_comprobante_navigate_form();
  }

  function perform_ajax_form_sri_tipo_comprobante_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_sri_tipo_comprobante_cancel_insert(sc_form_sri_tipo_comprobante_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("tc_codigo_" + iNavForm);
      scAjaxHideErrorDisplay("tc_nombre_" + iNavForm);
      scAjaxHideErrorDisplay("tc_estado_" + iNavForm);
      scAjaxHideErrorDisplay("tc_aplica_retencion_" + iNavForm);
      scAjaxHideErrorDisplay("tc_aplica_nota_credito_" + iNavForm);
      scAjaxHideErrorDisplay("tc_aplica_nota_debito_" + iNavForm);
      scAjaxHideErrorDisplay("tc_aplica_guia_remision_" + iNavForm);
      scAjaxHideErrorDisplay("tc_aplica_compras_" + iNavForm);
    }
    var var_tc_codigo_ = document.F2.tc_codigo_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sri_tipo_comprobante_navigate_form(var_tc_codigo_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sri_tipo_comprobante_navigate_form_cb);
  } // do_ajax_form_sri_tipo_comprobante_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sri_tipo_comprobante']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sri_tipo_comprobante_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.tc_codigo_.value = scAjaxGetKeyValue("tc_codigo_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sri_tipo_comprobante_navigate_form_cb_after_alert);
  } // do_ajax_form_sri_tipo_comprobante_navigate_form_cb
  function do_ajax_form_sri_tipo_comprobante_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_sri_tipo_comprobante_navigate_form_cb_after_alert

    function sc_form_sri_tipo_comprobante_get_last_line_number()
    {
    ...
    } //sc_form_sri_tipo_comprobante_get_last_line_number

  function sc_hide_form_sri_tipo_comprobante_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "tc_codigo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tc_nombre_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tc_estado_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tc_aplica_retencion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tc_aplica_nota_credito_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tc_aplica_nota_debito_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tc_aplica_guia_remision_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tc_aplica_compras_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["tc_codigo_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_codigo'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tc_nombre_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_descripcion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tc_estado_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tc_aplica_retencion_" + iNumLinha] = {"label": "Aplica Retención<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tc_aplica_nota_credito_" + iNumLinha] = {"label": "Aplica Nota Credito<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tc_aplica_nota_debito_" + iNumLinha] = {"label": "Aplica Nota Debito<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tc_aplica_guia_remision_" + iNumLinha] = {"label": "Aplica Guia Remisión<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tc_aplica_compras_" + iNumLinha] = {"label": "Aplica Compras<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["tc_codigo_"][iNumLinha] = "tc_codigo_" + iNumLinha;
    ajax_field_mult["tc_nombre_"][iNumLinha] = "tc_nombre_" + iNumLinha;
    ajax_field_mult["tc_estado_"][iNumLinha] = "tc_estado_" + iNumLinha;
    ajax_field_mult["tc_aplica_retencion_"][iNumLinha] = "tc_aplica_retencion_" + iNumLinha;
    ajax_field_mult["tc_aplica_nota_credito_"][iNumLinha] = "tc_aplica_nota_credito_" + iNumLinha;
    ajax_field_mult["tc_aplica_nota_debito_"][iNumLinha] = "tc_aplica_nota_debito_" + iNumLinha;
    ajax_field_mult["tc_aplica_guia_remision_"][iNumLinha] = "tc_aplica_guia_remision_" + iNumLinha;
    ajax_field_mult["tc_aplica_compras_"][iNumLinha] = "tc_aplica_compras_" + iNumLinha;
    ajax_field_id["tc_codigo_" + iNumLinha] = new Array("hidden_field_label_tc_codigo_", "hidden_field_data_tc_codigo_" + iNumLinha);
    ajax_field_id["tc_nombre_" + iNumLinha] = new Array("hidden_field_label_tc_nombre_", "hidden_field_data_tc_nombre_" + iNumLinha);
    ajax_field_id["tc_estado_" + iNumLinha] = new Array("hidden_field_label_tc_estado_", "hidden_field_data_tc_estado_" + iNumLinha);
    ajax_field_id["tc_aplica_retencion_" + iNumLinha] = new Array("hidden_field_label_tc_aplica_retencion_", "hidden_field_data_tc_aplica_retencion_" + iNumLinha);
    ajax_field_id["tc_aplica_nota_credito_" + iNumLinha] = new Array("hidden_field_label_tc_aplica_nota_credito_", "hidden_field_data_tc_aplica_nota_credito_" + iNumLinha);
    ajax_field_id["tc_aplica_nota_debito_" + iNumLinha] = new Array("hidden_field_label_tc_aplica_nota_debito_", "hidden_field_data_tc_aplica_nota_debito_" + iNumLinha);
    ajax_field_id["tc_aplica_guia_remision_" + iNumLinha] = new Array("hidden_field_label_tc_aplica_guia_remision_", "hidden_field_data_tc_aplica_guia_remision_" + iNumLinha);
    ajax_field_id["tc_aplica_compras_" + iNumLinha] = new Array("hidden_field_label_tc_aplica_compras_", "hidden_field_data_tc_aplica_compras_" + iNumLinha);
    ajax_error_count["tc_codigo_" + iNumLinha] = "off";
    ajax_error_count["tc_nombre_" + iNumLinha] = "off";
    ajax_error_count["tc_estado_" + iNumLinha] = "off";
    ajax_error_count["tc_aplica_retencion_" + iNumLinha] = "off";
    ajax_error_count["tc_aplica_nota_credito_" + iNumLinha] = "off";
    ajax_error_count["tc_aplica_nota_debito_" + iNumLinha] = "off";
    ajax_error_count["tc_aplica_guia_remision_" + iNumLinha] = "off";
    ajax_error_count["tc_aplica_compras_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["tc_codigo_" + iNumLinha] = "on";
    ajax_read_only["tc_nombre_" + iNumLinha] = "off";
    ajax_read_only["tc_estado_" + iNumLinha] = "off";
    ajax_read_only["tc_aplica_retencion_" + iNumLinha] = "off";
    ajax_read_only["tc_aplica_nota_credito_" + iNumLinha] = "off";
    ajax_read_only["tc_aplica_nota_debito_" + iNumLinha] = "off";
    ajax_read_only["tc_aplica_guia_remision_" + iNumLinha] = "off";
    ajax_read_only["tc_aplica_compras_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["tc_codigo_" + iNumLinha] = "on";
    ajax_read_only["tc_nombre_" + iNumLinha] = "on";
    ajax_read_only["tc_estado_" + iNumLinha] = "on";
    ajax_read_only["tc_aplica_retencion_" + iNumLinha] = "on";
    ajax_read_only["tc_aplica_nota_credito_" + iNumLinha] = "on";
    ajax_read_only["tc_aplica_nota_debito_" + iNumLinha] = "on";
    ajax_read_only["tc_aplica_guia_remision_" + iNumLinha] = "on";
    ajax_read_only["tc_aplica_compras_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["tc_codigo_" + iNumLinha] = null;
    ajax_error_list["tc_nombre_" + iNumLinha] = null;
    ajax_error_list["tc_estado_" + iNumLinha] = null;
    ajax_error_list["tc_aplica_retencion_" + iNumLinha] = null;
    ajax_error_list["tc_aplica_nota_credito_" + iNumLinha] = null;
    ajax_error_list["tc_aplica_nota_debito_" + iNumLinha] = null;
    ajax_error_list["tc_aplica_guia_remision_" + iNumLinha] = null;
    ajax_error_list["tc_aplica_compras_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "tc_codigo_": new Array(),
    "tc_nombre_": new Array(),
    "tc_estado_": new Array(),
    "tc_aplica_retencion_": new Array(),
    "tc_aplica_nota_credito_": new Array(),
    "tc_aplica_nota_debito_": new Array(),
    "tc_aplica_guia_remision_": new Array(),
    "tc_aplica_compras_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["tc_codigo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tc_codigo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tc_codigo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tc_codigo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tc_codigo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tc_nombre_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tc_nombre_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tc_nombre_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tc_nombre_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tc_nombre_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tc_estado_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tc_estado_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tc_estado_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tc_estado_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tc_estado_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tc_aplica_retencion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tc_aplica_retencion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tc_aplica_retencion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tc_aplica_retencion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tc_aplica_retencion_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tc_aplica_nota_credito_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tc_aplica_nota_credito_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tc_aplica_nota_credito_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tc_aplica_nota_credito_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tc_aplica_nota_credito_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tc_aplica_nota_debito_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tc_aplica_nota_debito_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tc_aplica_nota_debito_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tc_aplica_nota_debito_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tc_aplica_nota_debito_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tc_aplica_guia_remision_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tc_aplica_guia_remision_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tc_aplica_guia_remision_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tc_aplica_guia_remision_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tc_aplica_guia_remision_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tc_aplica_compras_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tc_aplica_compras_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tc_aplica_compras_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tc_aplica_compras_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tc_aplica_compras_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tc_codigo_'])) ? $this->nmgp_cmp_readonly['tc_codigo_'] : 'on';
?>
    scAjaxFieldRead("tc_codigo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tc_nombre_'])) ? $this->nmgp_cmp_readonly['tc_nombre_'] : 'off';
?>
    scAjaxFieldRead("tc_nombre_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tc_estado_'])) ? $this->nmgp_cmp_readonly['tc_estado_'] : 'off';
?>
    scAjaxFieldRead("tc_estado_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tc_aplica_retencion_'])) ? $this->nmgp_cmp_readonly['tc_aplica_retencion_'] : 'off';
?>
    scAjaxFieldRead("tc_aplica_retencion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tc_aplica_nota_credito_'])) ? $this->nmgp_cmp_readonly['tc_aplica_nota_credito_'] : 'off';
?>
    scAjaxFieldRead("tc_aplica_nota_credito_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tc_aplica_nota_debito_'])) ? $this->nmgp_cmp_readonly['tc_aplica_nota_debito_'] : 'off';
?>
    scAjaxFieldRead("tc_aplica_nota_debito_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tc_aplica_guia_remision_'])) ? $this->nmgp_cmp_readonly['tc_aplica_guia_remision_'] : 'off';
?>
    scAjaxFieldRead("tc_aplica_guia_remision_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tc_aplica_compras_'])) ? $this->nmgp_cmp_readonly['tc_aplica_compras_'] : 'off';
?>
    scAjaxFieldRead("tc_aplica_compras_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("tc_codigo_" + iSeq, "on");
    scAjaxFieldRead("tc_nombre_" + iSeq, "on");
    scAjaxFieldRead("tc_estado_" + iSeq, "on");
    scAjaxFieldRead("tc_aplica_retencion_" + iSeq, "on");
    scAjaxFieldRead("tc_aplica_nota_credito_" + iSeq, "on");
    scAjaxFieldRead("tc_aplica_nota_debito_" + iSeq, "on");
    scAjaxFieldRead("tc_aplica_guia_remision_" + iSeq, "on");
    scAjaxFieldRead("tc_aplica_compras_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["tc_codigo_" + iRow] || "on" == ajax_error_count["tc_nombre_" + iRow] || "on" == ajax_error_count["tc_estado_" + iRow] || "on" == ajax_error_count["tc_aplica_retencion_" + iRow] || "on" == ajax_error_count["tc_aplica_nota_credito_" + iRow] || "on" == ajax_error_count["tc_aplica_nota_debito_" + iRow] || "on" == ajax_error_count["tc_aplica_guia_remision_" + iRow] || "on" == ajax_error_count["tc_aplica_compras_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tc_codigo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tc_nombre_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tc_estado_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tc_aplica_retencion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tc_aplica_nota_credito_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tc_aplica_nota_debito_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tc_aplica_guia_remision_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tc_aplica_compras_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["tc_codigo_" + iRow] && "off" == ajax_error_count["tc_nombre_" + iRow] && "off" == ajax_error_count["tc_estado_" + iRow] && "off" == ajax_error_count["tc_aplica_retencion_" + iRow] && "off" == ajax_error_count["tc_aplica_nota_credito_" + iRow] && "off" == ajax_error_count["tc_aplica_nota_debito_" + iRow] && "off" == ajax_error_count["tc_aplica_guia_remision_" + iRow] && "off" == ajax_error_count["tc_aplica_compras_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["tc_codigo_" + iRow] = "off";
        ajax_error_count["tc_nombre_" + iRow] = "off";
        ajax_error_count["tc_estado_" + iRow] = "off";
        ajax_error_count["tc_aplica_retencion_" + iRow] = "off";
        ajax_error_count["tc_aplica_nota_credito_" + iRow] = "off";
        ajax_error_count["tc_aplica_nota_debito_" + iRow] = "off";
        ajax_error_count["tc_aplica_guia_remision_" + iRow] = "off";
        ajax_error_count["tc_aplica_compras_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_tc_codigo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tc_nombre_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tc_estado_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tc_aplica_retencion_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tc_aplica_nota_credito_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tc_aplica_nota_debito_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tc_aplica_guia_remision_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tc_aplica_compras_" + iRow).removeClass("scFormErrorLine");
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("tc_aplica_retencion_" == sIndex)
    {
      scAjaxSetFieldSelect(sIndex, aValue, null);
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("tc_aplica_nota_credito_" == sIndex)
    {
      scAjaxSetFieldSelect(sIndex, aValue, null);
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("tc_aplica_nota_debito_" == sIndex)
    {
      scAjaxSetFieldSelect(sIndex, aValue, null);
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("tc_aplica_guia_remision_" == sIndex)
    {
      scAjaxSetFieldSelect(sIndex, aValue, null);
      updateHeaderFooter(sIndex, aValue);
