...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_modificar_contrato_ap"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_modificar_contrato_ap"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_modificar_contrato_ap']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_modificar_contrato_ap']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_modificar_contrato_ap']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_modificar_contrato_ap']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_modificar_contrato_ap']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_modificar_contrato_ap</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_modificar_contrato_ap']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_modificar_contrato_ap']['embutida_filho'] as $ind => $sc_init)
          {
