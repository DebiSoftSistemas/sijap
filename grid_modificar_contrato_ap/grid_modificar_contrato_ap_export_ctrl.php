<?php
@session_start() ;
$_SESSION['scriptcase']['grid_modificar_contrato_ap']['sc_process_barr'] = true;
require_once('../grid_modificar_contrato_ap/index.php');
unset($_SESSION['scriptcase']['grid_modificar_contrato_ap']['sc_process_barr']);
$ExportCtrl = new grid_modificar_contrato_ap_export_control;
$ExportCtrl->Export_barr();

class grid_modificar_contrato_ap_export_control
{
