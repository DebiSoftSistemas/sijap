...
<?php
   ...
   if (!isset($this->nmgp_cmp_hidden['emp_usuario']))
   {
       $this->nmgp_cmp_hidden['emp_usuario'] = 'off';
   }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_emp_clave_label" id="hidden_field_label_emp_clave" style="<?php echo $sStyleHidden_emp_clave; ?>"><span id="id_label_emp_clave"><?php echo $this->nm_new_label['emp_clave']; ?></span></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_emp_clave_reingreso_label" id="hidden_field_label_emp_clave_reingreso" style="<?php echo $sStyleHidden_emp_clave_reingreso; ?>"><span id="id_label_emp_clave_reingreso"><?php echo $this->nm_new_label['emp_clave_reingreso']; ?></span></TD>
