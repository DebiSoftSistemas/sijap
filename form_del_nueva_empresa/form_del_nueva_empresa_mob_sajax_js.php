...
?>
  ...
  function do_ajax_form_del_nueva_empresa_mob_event_emp_usuario_onblur()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_nueva_empresa_mob_event_emp_usuario_onblur(var_script_case_init, do_ajax_form_del_nueva_empresa_mob_event_emp_usuario_onblur_cb);
  ...
  function do_ajax_form_del_nueva_empresa_mob_event_emp_clave_onblur()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_nueva_empresa_mob_event_emp_clave_onblur(var_emp_clave, var_script_case_init, do_ajax_form_del_nueva_empresa_mob_event_emp_clave_onblur_cb);
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_del_nueva_empresa_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_del_nueva_empresa_mob_submit_form(var_emp_comisionista, var_emp_ruc, var_emp_razon_social, var_emp_nombre_comercial, var_emp_email, var_emp_obligado, var_emp_contribuyente_especial, var_emp_ambiente_sri, var_emp_clave, var_emp_clave_reingreso, var_mensaje, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_nueva_empresa_mob_submit_form_cb);
...
?>
  ...
  ajax_field_list[8] = "emp_clave";
  ajax_field_list[9] = "emp_clave_reingreso";
  ajax_field_list[10] = "mensaje";
