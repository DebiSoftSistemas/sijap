...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_admin_establecimientos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_admin_establecimientos"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_del_establecimiento_admin'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_admin_establecimientos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_admin_establecimientos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_admin_establecimientos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_admin_establecimientos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_admin_establecimientos']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_admin_establecimientos</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_admin_establecimientos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_admin_establecimientos']['embutida_filho'] as $ind => $sc_init)
          {
