...
<?php
   ...
   $Ord_Cmp = new grid_admin_establecimientos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_admin_establecimientos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_admin_establecimientos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_admin_establecimientos']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['est_logo'] = "est_logo";
   $tab_labels["est_logo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_admin_establecimientos']['labels']["est_logo"])) ? $_SESSION['sc_session'][$sc_init]['grid_admin_establecimientos']['labels']["est_logo"] : "" . $this->Nm_lang['lang_logotipo'] . "";
   $tab_ger_campos['est_nombre'] = "on";
   $tab_def_campos['est_nombre'] = "est_nombre";
   $tab_labels["est_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_admin_establecimientos']['labels']["est_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_admin_establecimientos']['labels']["est_nombre"] : "" . $this->Nm_lang['lang_nombre'] . "";
   $tab_ger_campos['est_codigo'] = "on";
   $tab_def_campos['est_codigo'] = "est_codigo";
   $tab_labels["est_codigo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_admin_establecimientos']['labels']["est_codigo"])) ? $_SESSION['sc_session'][$sc_init]['grid_admin_establecimientos']['labels']["est_codigo"] : "" . $this->Nm_lang['lang_codigo_sri'] . "";
   $tab_ger_campos['est_direccion'] = "on";
   $tab_def_campos['est_direccion'] = "est_direccion";
   $tab_labels["est_direccion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_admin_establecimientos']['labels']["est_direccion"])) ? $_SESSION['sc_session'][$sc_init]['grid_admin_establecimientos']['labels']["est_direccion"] : "" . $this->Nm_lang['lang_direccion'] . "";
   $tab_ger_campos['est_telefono'] = "on";
   $tab_def_campos['est_telefono'] = "est_telefono";
   $tab_labels["est_telefono"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_admin_establecimientos']['labels']["est_telefono"])) ? $_SESSION['sc_session'][$sc_init]['grid_admin_establecimientos']['labels']["est_telefono"] : "" . $this->Nm_lang['lang_lot_telefono'] . "";
   $tab_ger_campos['est_estado'] = "on";
   $tab_def_campos['est_estado'] = "est_estado";
   $tab_labels["est_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_admin_establecimientos']['labels']["est_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_admin_establecimientos']['labels']["est_estado"] : "" . $this->Nm_lang['lang_estado'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_admin_establecimientos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_admin_establecimientos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_admin_establecimientos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_admin_establecimientos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_admin_establecimientos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_admin_establecimientos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_admin_establecimientos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_admin_establecimientos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_admin_establecimientos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_admin_establecimientos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_admin_establecimientos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_admin_establecimientos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_admin_establecimientos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_admin_establecimientos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_admin_establecimientos']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_admin_establecimientos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_admin_establecimientos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_admin_establecimientos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
