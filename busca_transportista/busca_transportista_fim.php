...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____busca_transportista"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____busca_transportista"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['busca_transportista']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['busca_transportista']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['busca_transportista']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['busca_transportista']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['busca_transportista']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>busca_transportista</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['busca_transportista']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['busca_transportista']['embutida_filho'] as $ind => $sc_init)
          {
