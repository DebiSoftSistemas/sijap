<?php
@session_start() ;
$_SESSION['scriptcase']['busca_transportista']['sc_process_barr'] = true;
require_once('../busca_transportista/index.php');
unset($_SESSION['scriptcase']['busca_transportista']['sc_process_barr']);
$ExportCtrl = new busca_transportista_export_control;
$ExportCtrl->Export_barr();

class busca_transportista_export_control
{
