...
<html>
    <head>
        ...
        <title>{lang_ig_tech} {lang_administrador}</title>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["mnu_Igtech"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile.min.css" />
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["mnu_Igtech"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["mnu_Igtech"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile.min.js"></script>
    <style>
    <?php
    if(isset($mnu_Igtech_menuData["data"]) && is_array($mnu_Igtech_menuData["data"]) && !empty($mnu_Igtech_menuData["data"]))
    {
        foreach($mnu_Igtech_menuData["data"] as $arr_item)
        {
    ...
    <body>
    <?php
        escreveMenuMobile($mnu_Igtech_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
