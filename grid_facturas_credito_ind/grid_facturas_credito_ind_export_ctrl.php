<?php
@session_start() ;
$_SESSION['scriptcase']['grid_facturas_credito_ind']['sc_process_barr'] = true;
require_once('../grid_facturas_credito_ind/index.php');
unset($_SESSION['scriptcase']['grid_facturas_credito_ind']['sc_process_barr']);
$ExportCtrl = new grid_facturas_credito_ind_export_control;
$ExportCtrl->Export_barr();

class grid_facturas_credito_ind_export_control
{
