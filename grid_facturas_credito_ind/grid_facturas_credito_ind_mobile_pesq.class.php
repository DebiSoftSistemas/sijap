...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "fac_fecha";$Nm_numeric[] = "fp_id";$Nm_numeric[] = "fp_valor";$Nm_numeric[] = "fp_valor_pago";$Nm_numeric[] = "fp_saldo";$Nm_numeric[] = "fac_numero";$Nm_numeric[] = "fac_cliente";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_fp_saldo_cond" name="fp_saldo_cond" onChange="nm_campos_between(document.getElementById('id_vis_fp_saldo'), this, 'fp_saldo')">
      ...
      <br><span id="id_hide_fp_saldo"  <?php echo $str_hide_fp_saldo?>><INPUT  type="text" id="SC_fp_saldo" name="fp_saldo" value="<?php echo NM_encode_input($fp_saldo) ?>" size=15 alt="{datatype: 'decimal', maxLength: 15, precision: 2, decimalSep: '.', thousandsSep: '', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
