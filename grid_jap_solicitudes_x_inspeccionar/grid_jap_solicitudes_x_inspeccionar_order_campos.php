...
<?php
   ...
   $Ord_Cmp = new grid_jap_solicitudes_x_inspeccionar_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_jap_solicitudes_x_inspeccionar_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_jap_solicitudes_x_inspeccionar']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_jap_solicitudes_x_inspeccionar']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["si_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_solicitudes_x_inspeccionar']['labels']["si_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_solicitudes_x_inspeccionar']['labels']["si_fecha"] : "" . $this->Nm_lang['lang_fecha'] . "";
   $tab_ger_campos['si_secuecial'] = "on";
   $tab_def_campos['si_secuecial'] = "si_secuecial";
   $tab_labels["si_secuecial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_solicitudes_x_inspeccionar']['labels']["si_secuecial"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_solicitudes_x_inspeccionar']['labels']["si_secuecial"] : "" . $this->Nm_lang['lang_secuencial'] . "";
   $tab_ger_campos['si_contrato'] = "on";
   $tab_def_campos['si_contrato'] = "si_contrato";
   $tab_labels["si_contrato"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_solicitudes_x_inspeccionar']['labels']["si_contrato"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_solicitudes_x_inspeccionar']['labels']["si_contrato"] : "" . $this->Nm_lang['lang_contrato'] . "";
   $tab_ger_campos['si_tipo_inspeccion'] = "on";
   $tab_def_campos['si_tipo_inspeccion'] = "si_tipo_inspeccion";
   $tab_labels["si_tipo_inspeccion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_solicitudes_x_inspeccionar']['labels']["si_tipo_inspeccion"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_solicitudes_x_inspeccionar']['labels']["si_tipo_inspeccion"] : "" . $this->Nm_lang['lang_tipo_inspeccion'] . "";
   $tab_ger_campos['si_comentario'] = "on";
   $tab_def_campos['si_comentario'] = "si_comentario";
   $tab_labels["si_comentario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_solicitudes_x_inspeccionar']['labels']["si_comentario"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_solicitudes_x_inspeccionar']['labels']["si_comentario"] : "" . $this->Nm_lang['lang_comentario'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_jap_solicitudes_x_inspeccionar']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_jap_solicitudes_x_inspeccionar']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_jap_solicitudes_x_inspeccionar']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_jap_solicitudes_x_inspeccionar']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_jap_solicitudes_x_inspeccionar']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_jap_solicitudes_x_inspeccionar']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_jap_solicitudes_x_inspeccionar']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_jap_solicitudes_x_inspeccionar']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_jap_solicitudes_x_inspeccionar']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_jap_solicitudes_x_inspeccionar']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_jap_solicitudes_x_inspeccionar']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_jap_solicitudes_x_inspeccionar']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_jap_solicitudes_x_inspeccionar_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_jap_solicitudes_x_inspeccionar']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_jap_solicitudes_x_inspeccionar']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_jap_solicitudes_x_inspeccionar']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_jap_solicitudes_x_inspeccionar']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_jap_solicitudes_x_inspeccionar']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
