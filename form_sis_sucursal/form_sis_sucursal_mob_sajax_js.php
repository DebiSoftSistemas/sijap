  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_sucursal_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sis_sucursal_mob_form();
	}
...
?>
  ...
  // ---------- Validate suc_filial
  function do_ajax_form_sis_sucursal_mob_validate_suc_filial()
  {
    var nomeCampo_suc_filial = "suc_filial";
    var var_suc_filial = scAjaxGetFieldSelect(nomeCampo_suc_filial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_sucursal_mob_validate_suc_filial(var_suc_filial, var_script_case_init, do_ajax_form_sis_sucursal_mob_validate_suc_filial_cb);
  } // do_ajax_form_sis_sucursal_mob_validate_suc_filial

  function do_ajax_form_sis_sucursal_mob_validate_suc_filial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "suc_filial";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_sucursal_mob_validate_suc_filial_cb

  // ---------- Validate suc_nombre
  function do_ajax_form_sis_sucursal_mob_validate_suc_nombre()
  {
    var nomeCampo_suc_nombre = "suc_nombre";
    var var_suc_nombre = scAjaxGetFieldText(nomeCampo_suc_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_sucursal_mob_validate_suc_nombre(var_suc_nombre, var_script_case_init, do_ajax_form_sis_sucursal_mob_validate_suc_nombre_cb);
  } // do_ajax_form_sis_sucursal_mob_validate_suc_nombre

  function do_ajax_form_sis_sucursal_mob_validate_suc_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "suc_nombre";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_sucursal_mob_validate_suc_nombre_cb

  // ---------- Validate suc_representante
  function do_ajax_form_sis_sucursal_mob_validate_suc_representante()
  {
    var nomeCampo_suc_representante = "suc_representante";
    var var_suc_representante = scAjaxGetFieldText(nomeCampo_suc_representante);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_sucursal_mob_validate_suc_representante(var_suc_representante, var_script_case_init, do_ajax_form_sis_sucursal_mob_validate_suc_representante_cb);
  } // do_ajax_form_sis_sucursal_mob_validate_suc_representante

  function do_ajax_form_sis_sucursal_mob_validate_suc_representante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "suc_representante";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_sucursal_mob_validate_suc_representante_cb

  // ---------- Validate suc_pais
  function do_ajax_form_sis_sucursal_mob_validate_suc_pais()
  {
    var nomeCampo_suc_pais = "suc_pais";
    var var_suc_pais = scAjaxGetFieldSelect(nomeCampo_suc_pais);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_sucursal_mob_validate_suc_pais(var_suc_pais, var_script_case_init, do_ajax_form_sis_sucursal_mob_validate_suc_pais_cb);
  } // do_ajax_form_sis_sucursal_mob_validate_suc_pais

  function do_ajax_form_sis_sucursal_mob_validate_suc_pais_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "suc_pais";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_sucursal_mob_validate_suc_pais_cb

  // ---------- Validate suc_provincia
  function do_ajax_form_sis_sucursal_mob_validate_suc_provincia()
  {
    var nomeCampo_suc_provincia = "suc_provincia";
    var var_suc_provincia = scAjaxGetFieldSelect(nomeCampo_suc_provincia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_sucursal_mob_validate_suc_provincia(var_suc_provincia, var_script_case_init, do_ajax_form_sis_sucursal_mob_validate_suc_provincia_cb);
  } // do_ajax_form_sis_sucursal_mob_validate_suc_provincia

  function do_ajax_form_sis_sucursal_mob_validate_suc_provincia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "suc_provincia";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_sucursal_mob_validate_suc_provincia_cb

  // ---------- Validate suc_ciudad
  function do_ajax_form_sis_sucursal_mob_validate_suc_ciudad()
  {
    var nomeCampo_suc_ciudad = "suc_ciudad";
    var var_suc_ciudad = scAjaxGetFieldSelect(nomeCampo_suc_ciudad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_sucursal_mob_validate_suc_ciudad(var_suc_ciudad, var_script_case_init, do_ajax_form_sis_sucursal_mob_validate_suc_ciudad_cb);
  } // do_ajax_form_sis_sucursal_mob_validate_suc_ciudad

  function do_ajax_form_sis_sucursal_mob_validate_suc_ciudad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "suc_ciudad";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_sucursal_mob_validate_suc_ciudad_cb

  // ---------- Validate suc_sector
  function do_ajax_form_sis_sucursal_mob_validate_suc_sector()
  {
    var nomeCampo_suc_sector = "suc_sector";
    var var_suc_sector = scAjaxGetFieldText(nomeCampo_suc_sector);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_sucursal_mob_validate_suc_sector(var_suc_sector, var_script_case_init, do_ajax_form_sis_sucursal_mob_validate_suc_sector_cb);
  } // do_ajax_form_sis_sucursal_mob_validate_suc_sector

  function do_ajax_form_sis_sucursal_mob_validate_suc_sector_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "suc_sector";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_sucursal_mob_validate_suc_sector_cb

  // ---------- Validate suc_calle_principal
  function do_ajax_form_sis_sucursal_mob_validate_suc_calle_principal()
  {
    var nomeCampo_suc_calle_principal = "suc_calle_principal";
    var var_suc_calle_principal = scAjaxGetFieldText(nomeCampo_suc_calle_principal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_sucursal_mob_validate_suc_calle_principal(var_suc_calle_principal, var_script_case_init, do_ajax_form_sis_sucursal_mob_validate_suc_calle_principal_cb);
  } // do_ajax_form_sis_sucursal_mob_validate_suc_calle_principal

  function do_ajax_form_sis_sucursal_mob_validate_suc_calle_principal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "suc_calle_principal";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_sucursal_mob_validate_suc_calle_principal_cb

  // ---------- Validate suc_numero
  function do_ajax_form_sis_sucursal_mob_validate_suc_numero()
  {
    var nomeCampo_suc_numero = "suc_numero";
    var var_suc_numero = scAjaxGetFieldText(nomeCampo_suc_numero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_sucursal_mob_validate_suc_numero(var_suc_numero, var_script_case_init, do_ajax_form_sis_sucursal_mob_validate_suc_numero_cb);
  } // do_ajax_form_sis_sucursal_mob_validate_suc_numero

  function do_ajax_form_sis_sucursal_mob_validate_suc_numero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "suc_numero";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_sucursal_mob_validate_suc_numero_cb

  // ---------- Validate suc_calle_secundaria
  function do_ajax_form_sis_sucursal_mob_validate_suc_calle_secundaria()
  {
    var nomeCampo_suc_calle_secundaria = "suc_calle_secundaria";
    var var_suc_calle_secundaria = scAjaxGetFieldText(nomeCampo_suc_calle_secundaria);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_sucursal_mob_validate_suc_calle_secundaria(var_suc_calle_secundaria, var_script_case_init, do_ajax_form_sis_sucursal_mob_validate_suc_calle_secundaria_cb);
  } // do_ajax_form_sis_sucursal_mob_validate_suc_calle_secundaria

  function do_ajax_form_sis_sucursal_mob_validate_suc_calle_secundaria_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "suc_calle_secundaria";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_sucursal_mob_validate_suc_calle_secundaria_cb

  // ---------- Validate suc_referencia
  function do_ajax_form_sis_sucursal_mob_validate_suc_referencia()
  {
    var nomeCampo_suc_referencia = "suc_referencia";
    var var_suc_referencia = scAjaxGetFieldText(nomeCampo_suc_referencia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_sucursal_mob_validate_suc_referencia(var_suc_referencia, var_script_case_init, do_ajax_form_sis_sucursal_mob_validate_suc_referencia_cb);
  } // do_ajax_form_sis_sucursal_mob_validate_suc_referencia

  function do_ajax_form_sis_sucursal_mob_validate_suc_referencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "suc_referencia";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_sucursal_mob_validate_suc_referencia_cb

  // ---------- Refresh suc_pais
  function do_ajax_form_sis_sucursal_mob_refresh_suc_pais()
  {
    var var_suc_pais = scAjaxGetFieldSelect("suc_pais");
    var var_nmgp_refresh_fields = "suc_provincia";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sis_sucursal_mob_refresh_suc_pais(var_suc_pais, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_sis_sucursal_mob_refresh_suc_pais_cb);
  } // do_ajax_form_sis_sucursal_mob_refresh_suc_pais

  function do_ajax_form_sis_sucursal_mob_refresh_suc_pais_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_sucursal_mob_refresh_suc_pais_cb

  // ---------- Refresh suc_provincia
  function do_ajax_form_sis_sucursal_mob_refresh_suc_provincia()
  {
    var var_suc_provincia = scAjaxGetFieldSelect("suc_provincia");
    var var_nmgp_refresh_fields = "suc_ciudad";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sis_sucursal_mob_refresh_suc_provincia(var_suc_provincia, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_sis_sucursal_mob_refresh_suc_provincia_cb);
  } // do_ajax_form_sis_sucursal_mob_refresh_suc_provincia

  function do_ajax_form_sis_sucursal_mob_refresh_suc_provincia_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_sucursal_mob_refresh_suc_provincia_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_sis_sucursal_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_sis_sucursal_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_suc_filial = scAjaxGetFieldSelect("suc_filial");
    var var_suc_nombre = scAjaxGetFieldText("suc_nombre");
    var var_suc_representante = scAjaxGetFieldText("suc_representante");
    var var_suc_pais = scAjaxGetFieldSelect("suc_pais");
    var var_suc_provincia = scAjaxGetFieldSelect("suc_provincia");
    var var_suc_ciudad = scAjaxGetFieldSelect("suc_ciudad");
    var var_suc_sector = scAjaxGetFieldText("suc_sector");
    var var_suc_calle_principal = scAjaxGetFieldText("suc_calle_principal");
    var var_suc_numero = scAjaxGetFieldText("suc_numero");
    var var_suc_calle_secundaria = scAjaxGetFieldText("suc_calle_secundaria");
    var var_suc_referencia = scAjaxGetFieldText("suc_referencia");
    var var_suc_id = scAjaxGetFieldText("suc_id");
    ...
    scAjaxProcOn();
    x_ajax_form_sis_sucursal_mob_submit_form(var_suc_filial, var_suc_nombre, var_suc_representante, var_suc_pais, var_suc_provincia, var_suc_ciudad, var_suc_sector, var_suc_calle_principal, var_suc_numero, var_suc_calle_secundaria, var_suc_referencia, var_suc_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_sucursal_mob_submit_form_cb);
  } // do_ajax_form_sis_sucursal_mob_submit_form

  function do_ajax_form_sis_sucursal_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("suc_filial");
      scAjaxHideErrorDisplay("suc_nombre");
      scAjaxHideErrorDisplay("suc_representante");
      scAjaxHideErrorDisplay("suc_pais");
      scAjaxHideErrorDisplay("suc_provincia");
      scAjaxHideErrorDisplay("suc_ciudad");
      scAjaxHideErrorDisplay("suc_sector");
      scAjaxHideErrorDisplay("suc_calle_principal");
      scAjaxHideErrorDisplay("suc_numero");
      scAjaxHideErrorDisplay("suc_calle_secundaria");
      scAjaxHideErrorDisplay("suc_referencia");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_sis_sucursal_mob_submit_form_cb_after_alert);
  } // do_ajax_form_sis_sucursal_mob_submit_form_cb
  function do_ajax_form_sis_sucursal_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_sucursal_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sis_sucursal_mob_navigate_form()
  {
    perform_ajax_form_sis_sucursal_mob_navigate_form();
  }

  function perform_ajax_form_sis_sucursal_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("suc_calle_secundaria");
    scAjaxHideErrorDisplay("suc_referencia");
    var var_suc_id = document.F2.suc_id.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sis_sucursal_mob_navigate_form(var_suc_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_sucursal_mob_navigate_form_cb);
  } // do_ajax_form_sis_sucursal_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_sucursal_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_sucursal_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.suc_id.value = scAjaxGetKeyValue("suc_id");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_sucursal_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_sucursal_mob_navigate_form_cb
  function do_ajax_form_sis_sucursal_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_sis_sucursal_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_sis_sucursal_mob_navigate_form_cb_after_alert

  function sc_hide_form_sis_sucursal_mob_form()
  {
  ...
  ajax_field_list[0] = "suc_filial";
  ajax_field_list[1] = "suc_nombre";
  ajax_field_list[2] = "suc_representante";
  ajax_field_list[3] = "suc_pais";
  ajax_field_list[4] = "suc_provincia";
  ajax_field_list[5] = "suc_ciudad";
  ajax_field_list[6] = "suc_sector";
  ajax_field_list[7] = "suc_calle_principal";
  ajax_field_list[8] = "suc_numero";
  ajax_field_list[9] = "suc_calle_secundaria";
  ajax_field_list[10] = "suc_referencia";
  ...
  var ajax_error_list = {
    "suc_filial": {"label": "<?php echo $this->Ini->Nm_lang['lang_filial'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "suc_nombre": {"label": "<?php echo $this->Ini->Nm_lang['lang_sucursal'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "suc_representante": {"label": "<?php echo $this->Ini->Nm_lang['lang_representante'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "suc_pais": {"label": "<?php echo $this->Ini->Nm_lang['lang_pais'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "suc_provincia": {"label": "<?php echo $this->Ini->Nm_lang['lang_provincia'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "suc_ciudad": {"label": "<?php echo $this->Ini->Nm_lang['lang_ciudad'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "suc_sector": {"label": "<?php echo $this->Ini->Nm_lang['lang_sector'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "suc_calle_principal": {"label": "<?php echo $this->Ini->Nm_lang['lang_calle_principal'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "suc_numero": {"label": "<?php echo $this->Ini->Nm_lang['lang_numero'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "suc_calle_secundaria": {"label": "<?php echo $this->Ini->Nm_lang['lang_calle_secundaria'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "suc_referencia": {"label": "<?php echo $this->Ini->Nm_lang['lang_referencia'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "suc_filial": new Array(),
    "suc_nombre": new Array(),
    "suc_representante": new Array(),
    "suc_pais": new Array(),
    "suc_provincia": new Array(),
    "suc_ciudad": new Array(),
    "suc_sector": new Array(),
    "suc_calle_principal": new Array(),
    "suc_numero": new Array(),
    "suc_calle_secundaria": new Array(),
    "suc_referencia": new Array()
  };
  ajax_field_mult["suc_filial"][1] = "suc_filial";
  ajax_field_mult["suc_nombre"][1] = "suc_nombre";
  ajax_field_mult["suc_representante"][1] = "suc_representante";
  ajax_field_mult["suc_pais"][1] = "suc_pais";
  ajax_field_mult["suc_provincia"][1] = "suc_provincia";
  ajax_field_mult["suc_ciudad"][1] = "suc_ciudad";
  ajax_field_mult["suc_sector"][1] = "suc_sector";
  ajax_field_mult["suc_calle_principal"][1] = "suc_calle_principal";
  ajax_field_mult["suc_numero"][1] = "suc_numero";
  ajax_field_mult["suc_calle_secundaria"][1] = "suc_calle_secundaria";
  ajax_field_mult["suc_referencia"][1] = "suc_referencia";

  var ajax_field_id = {
    "suc_filial": new Array("hidden_field_label_suc_filial", "hidden_field_data_suc_filial"),
    "suc_nombre": new Array("hidden_field_label_suc_nombre", "hidden_field_data_suc_nombre"),
    "suc_representante": new Array("hidden_field_label_suc_representante", "hidden_field_data_suc_representante"),
    "suc_pais": new Array("hidden_field_label_suc_pais", "hidden_field_data_suc_pais"),
    "suc_provincia": new Array("hidden_field_label_suc_provincia", "hidden_field_data_suc_provincia"),
    "suc_ciudad": new Array("hidden_field_label_suc_ciudad", "hidden_field_data_suc_ciudad"),
    "suc_sector": new Array("hidden_field_label_suc_sector", "hidden_field_data_suc_sector"),
    "suc_calle_principal": new Array("hidden_field_label_suc_calle_principal", "hidden_field_data_suc_calle_principal"),
    "suc_numero": new Array("hidden_field_label_suc_numero", "hidden_field_data_suc_numero"),
    "suc_calle_secundaria": new Array("hidden_field_label_suc_calle_secundaria", "hidden_field_data_suc_calle_secundaria"),
    "suc_referencia": new Array("hidden_field_label_suc_referencia", "hidden_field_data_suc_referencia")
  };

  var ajax_read_only = {
    "suc_filial": "off",
    "suc_nombre": "off",
    "suc_representante": "off",
    "suc_pais": "off",
    "suc_provincia": "off",
    "suc_ciudad": "off",
    "suc_sector": "off",
    "suc_calle_principal": "off",
    "suc_numero": "off",
    "suc_calle_secundaria": "off",
    "suc_referencia": "off"
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("suc_calle_secundaria" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
