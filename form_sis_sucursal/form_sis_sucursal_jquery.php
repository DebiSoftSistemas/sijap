...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_suc_id' + iSeqRow).bind('change', function() { sc_form_sis_sucursal_suc_id_onchange(this, iSeqRow) });
  $('#id_sc_field_suc_filial' + iSeqRow).bind('blur', function() { sc_form_sis_sucursal_suc_filial_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_sis_sucursal_suc_filial_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_suc_nombre' + iSeqRow).bind('blur', function() { sc_form_sis_sucursal_suc_nombre_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_sis_sucursal_suc_nombre_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_suc_representante' + iSeqRow).bind('blur', function() { sc_form_sis_sucursal_suc_representante_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_form_sis_sucursal_suc_representante_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_suc_ciudad' + iSeqRow).bind('blur', function() { sc_form_sis_sucursal_suc_ciudad_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_sis_sucursal_suc_ciudad_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_suc_sector' + iSeqRow).bind('blur', function() { sc_form_sis_sucursal_suc_sector_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_sis_sucursal_suc_sector_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_suc_calle_principal' + iSeqRow).bind('blur', function() { sc_form_sis_sucursal_suc_calle_principal_onblur(this, iSeqRow) })
                                                 .bind('change', function() { sc_form_sis_sucursal_suc_calle_principal_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_suc_numero' + iSeqRow).bind('blur', function() { sc_form_sis_sucursal_suc_numero_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_sis_sucursal_suc_numero_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_suc_calle_secundaria' + iSeqRow).bind('blur', function() { sc_form_sis_sucursal_suc_calle_secundaria_onblur(this, iSeqRow) })
                                                  .bind('change', function() { sc_form_sis_sucursal_suc_calle_secundaria_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_suc_referencia' + iSeqRow).bind('blur', function() { sc_form_sis_sucursal_suc_referencia_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_sis_sucursal_suc_referencia_onchange(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_sis_sucursal_suc_referencia_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_sis_sucursal_suc_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_sis_sucursal_suc_filial_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_sis_sucursal_suc_nombre_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_sis_sucursal_suc_representante_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_sis_sucursal_suc_ciudad_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_sis_sucursal_suc_sector_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_sis_sucursal_suc_calle_principal_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_sis_sucursal_suc_numero_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_sis_sucursal_suc_calle_secundaria_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_sis_sucursal_suc_referencia_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_form_sis_sucursal_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_sis_sucursal')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
