  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_sucursal" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sis_sucursal_form();
	}
...
?>
  ...
  // ---------- Validate suc_filial
  function do_ajax_form_sis_sucursal_validate_suc_filial()
  {
    var nomeCampo_suc_filial = "suc_filial";
    var var_suc_filial = scAjaxGetFieldSelect(nomeCampo_suc_filial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_sucursal_validate_suc_filial(var_suc_filial, var_script_case_init, do_ajax_form_sis_sucursal_validate_suc_filial_cb);
  } // do_ajax_form_sis_sucursal_validate_suc_filial

  function do_ajax_form_sis_sucursal_validate_suc_filial_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_sucursal_validate_suc_filial_cb

  // ---------- Validate suc_nombre
  function do_ajax_form_sis_sucursal_validate_suc_nombre()
  {
    var nomeCampo_suc_nombre = "suc_nombre";
    var var_suc_nombre = scAjaxGetFieldText(nomeCampo_suc_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_sucursal_validate_suc_nombre(var_suc_nombre, var_script_case_init, do_ajax_form_sis_sucursal_validate_suc_nombre_cb);
  } // do_ajax_form_sis_sucursal_validate_suc_nombre

  function do_ajax_form_sis_sucursal_validate_suc_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_sucursal_validate_suc_nombre_cb

  // ---------- Validate suc_representante
  function do_ajax_form_sis_sucursal_validate_suc_representante()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_sucursal_validate_suc_representante(var_suc_representante, var_script_case_init, do_ajax_form_sis_sucursal_validate_suc_representante_cb);
  } // do_ajax_form_sis_sucursal_validate_suc_representante

  function do_ajax_form_sis_sucursal_validate_suc_representante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_sucursal_validate_suc_representante_cb

  // ---------- Validate suc_pais
  function do_ajax_form_sis_sucursal_validate_suc_pais()
  {
    var nomeCampo_suc_pais = "suc_pais";
    var var_suc_pais = scAjaxGetFieldSelect(nomeCampo_suc_pais);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_sucursal_validate_suc_pais(var_suc_pais, var_script_case_init, do_ajax_form_sis_sucursal_validate_suc_pais_cb);
  } // do_ajax_form_sis_sucursal_validate_suc_pais

  function do_ajax_form_sis_sucursal_validate_suc_pais_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_sucursal_validate_suc_pais_cb

  // ---------- Validate suc_provincia
  function do_ajax_form_sis_sucursal_validate_suc_provincia()
  {
    var nomeCampo_suc_provincia = "suc_provincia";
    var var_suc_provincia = scAjaxGetFieldSelect(nomeCampo_suc_provincia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_sucursal_validate_suc_provincia(var_suc_provincia, var_script_case_init, do_ajax_form_sis_sucursal_validate_suc_provincia_cb);
  } // do_ajax_form_sis_sucursal_validate_suc_provincia

  function do_ajax_form_sis_sucursal_validate_suc_provincia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_sucursal_validate_suc_provincia_cb

  // ---------- Validate suc_ciudad
  function do_ajax_form_sis_sucursal_validate_suc_ciudad()
  {
    var nomeCampo_suc_ciudad = "suc_ciudad";
    var var_suc_ciudad = scAjaxGetFieldSelect(nomeCampo_suc_ciudad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_sucursal_validate_suc_ciudad(var_suc_ciudad, var_script_case_init, do_ajax_form_sis_sucursal_validate_suc_ciudad_cb);
  } // do_ajax_form_sis_sucursal_validate_suc_ciudad

  function do_ajax_form_sis_sucursal_validate_suc_ciudad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_sucursal_validate_suc_ciudad_cb

  // ---------- Validate suc_sector
  function do_ajax_form_sis_sucursal_validate_suc_sector()
  {
    var nomeCampo_suc_sector = "suc_sector";
    var var_suc_sector = scAjaxGetFieldText(nomeCampo_suc_sector);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_sucursal_validate_suc_sector(var_suc_sector, var_script_case_init, do_ajax_form_sis_sucursal_validate_suc_sector_cb);
  } // do_ajax_form_sis_sucursal_validate_suc_sector

  function do_ajax_form_sis_sucursal_validate_suc_sector_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_sucursal_validate_suc_sector_cb

  // ---------- Validate suc_calle_principal
  function do_ajax_form_sis_sucursal_validate_suc_calle_principal()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_sucursal_validate_suc_calle_principal(var_suc_calle_principal, var_script_case_init, do_ajax_form_sis_sucursal_validate_suc_calle_principal_cb);
  } // do_ajax_form_sis_sucursal_validate_suc_calle_principal

  function do_ajax_form_sis_sucursal_validate_suc_calle_principal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_sucursal_validate_suc_calle_principal_cb

  // ---------- Validate suc_numero
  function do_ajax_form_sis_sucursal_validate_suc_numero()
  {
    var nomeCampo_suc_numero = "suc_numero";
    var var_suc_numero = scAjaxGetFieldText(nomeCampo_suc_numero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_sucursal_validate_suc_numero(var_suc_numero, var_script_case_init, do_ajax_form_sis_sucursal_validate_suc_numero_cb);
  } // do_ajax_form_sis_sucursal_validate_suc_numero

  function do_ajax_form_sis_sucursal_validate_suc_numero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_sucursal_validate_suc_numero_cb

  // ---------- Validate suc_calle_secundaria
  function do_ajax_form_sis_sucursal_validate_suc_calle_secundaria()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_sucursal_validate_suc_calle_secundaria(var_suc_calle_secundaria, var_script_case_init, do_ajax_form_sis_sucursal_validate_suc_calle_secundaria_cb);
  } // do_ajax_form_sis_sucursal_validate_suc_calle_secundaria

  function do_ajax_form_sis_sucursal_validate_suc_calle_secundaria_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_sucursal_validate_suc_calle_secundaria_cb

  // ---------- Validate suc_referencia
  function do_ajax_form_sis_sucursal_validate_suc_referencia()
  {
    var nomeCampo_suc_referencia = "suc_referencia";
    var var_suc_referencia = scAjaxGetFieldText(nomeCampo_suc_referencia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_sucursal_validate_suc_referencia(var_suc_referencia, var_script_case_init, do_ajax_form_sis_sucursal_validate_suc_referencia_cb);
  } // do_ajax_form_sis_sucursal_validate_suc_referencia

  function do_ajax_form_sis_sucursal_validate_suc_referencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_sucursal_validate_suc_referencia_cb

  // ---------- Refresh suc_pais
  function do_ajax_form_sis_sucursal_refresh_suc_pais()
  {
    var var_suc_pais = scAjaxGetFieldSelect("suc_pais");
    var var_nmgp_refresh_fields = "suc_provincia";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sis_sucursal_refresh_suc_pais(var_suc_pais, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_sis_sucursal_refresh_suc_pais_cb);
  } // do_ajax_form_sis_sucursal_refresh_suc_pais

  function do_ajax_form_sis_sucursal_refresh_suc_pais_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    do_ajax_form_sis_sucursal_refresh_suc_provincia();
    scAjaxShowDebug();
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_sucursal_refresh_suc_pais_cb

  // ---------- Refresh suc_provincia
  function do_ajax_form_sis_sucursal_refresh_suc_provincia()
  {
    var var_suc_provincia = scAjaxGetFieldSelect("suc_provincia");
    var var_nmgp_refresh_fields = "suc_ciudad";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sis_sucursal_refresh_suc_provincia(var_suc_provincia, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_sis_sucursal_refresh_suc_provincia_cb);
  } // do_ajax_form_sis_sucursal_refresh_suc_provincia

  function do_ajax_form_sis_sucursal_refresh_suc_provincia_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_sucursal_refresh_suc_provincia_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_sis_sucursal_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_sis_sucursal_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_sis_sucursal_submit_form(var_suc_filial, var_suc_nombre, var_suc_representante, var_suc_pais, var_suc_provincia, var_suc_ciudad, var_suc_sector, var_suc_calle_principal, var_suc_numero, var_suc_calle_secundaria, var_suc_referencia, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_sucursal_submit_form_cb);
  } // do_ajax_form_sis_sucursal_submit_form

  function do_ajax_form_sis_sucursal_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_sis_sucursal_submit_form_cb_after_alert);
  } // do_ajax_form_sis_sucursal_submit_form_cb
  function do_ajax_form_sis_sucursal_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_sucursal_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sis_sucursal_navigate_form()
  {
    perform_ajax_form_sis_sucursal_navigate_form();
  }

  function perform_ajax_form_sis_sucursal_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sis_sucursal_navigate_form(var_suc_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_sucursal_navigate_form_cb);
  } // do_ajax_form_sis_sucursal_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_sucursal']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_sucursal_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_sucursal_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_sucursal_navigate_form_cb
  function do_ajax_form_sis_sucursal_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_sis_sucursal_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_sis_sucursal_navigate_form_cb_after_alert

  function sc_hide_form_sis_sucursal_form()
  {
