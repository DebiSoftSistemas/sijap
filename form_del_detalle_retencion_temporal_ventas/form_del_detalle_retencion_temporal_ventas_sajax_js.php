  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_detalle_retencion_temporal_ventas" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_detalle_retencion_temporal_ventas_form();
	}
...
?>
  ...
  // ---------- Validate ir_id_
  function do_ajax_form_del_detalle_retencion_temporal_ventas_validate_ir_id_(iNumLinha)
  {
    var nomeCampo_ir_id_ = "ir_id_" + iNumLinha;
    var var_ir_id_ = scAjaxGetFieldHidden(nomeCampo_ir_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_retencion_temporal_ventas_validate_ir_id_(var_ir_id_, iNumLinha, var_script_case_init, do_ajax_form_del_detalle_retencion_temporal_ventas_validate_ir_id__cb);
  } // do_ajax_form_del_detalle_retencion_temporal_ventas_validate_ir_id_

  function do_ajax_form_del_detalle_retencion_temporal_ventas_validate_ir_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "ir_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ir_id_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "ir_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ir_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_retencion_temporal_ventas_validate_ir_id__cb

  // ---------- Validate ir_retencion_temporal_
  function do_ajax_form_del_detalle_retencion_temporal_ventas_validate_ir_retencion_temporal_(iNumLinha)
  {
    var nomeCampo_ir_retencion_temporal_ = "ir_retencion_temporal_" + iNumLinha;
    var var_ir_retencion_temporal_ = scAjaxGetFieldText(nomeCampo_ir_retencion_temporal_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_retencion_temporal_ventas_validate_ir_retencion_temporal_(var_ir_retencion_temporal_, iNumLinha, var_script_case_init, do_ajax_form_del_detalle_retencion_temporal_ventas_validate_ir_retencion_temporal__cb);
  } // do_ajax_form_del_detalle_retencion_temporal_ventas_validate_ir_retencion_temporal_

  function do_ajax_form_del_detalle_retencion_temporal_ventas_validate_ir_retencion_temporal__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "ir_retencion_temporal_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ir_retencion_temporal_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "ir_retencion_temporal_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ir_retencion_temporal_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_retencion_temporal_ventas_validate_ir_retencion_temporal__cb

  // ---------- Validate dr_impuesto_
  function do_ajax_form_del_detalle_retencion_temporal_ventas_validate_dr_impuesto_(iNumLinha)
  {
    var nomeCampo_dr_impuesto_ = "dr_impuesto_" + iNumLinha;
    var var_dr_impuesto_ = scAjaxGetFieldSelect(nomeCampo_dr_impuesto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_retencion_temporal_ventas_validate_dr_impuesto_(var_dr_impuesto_, iNumLinha, var_script_case_init, do_ajax_form_del_detalle_retencion_temporal_ventas_validate_dr_impuesto__cb);
  } // do_ajax_form_del_detalle_retencion_temporal_ventas_validate_dr_impuesto_

  function do_ajax_form_del_detalle_retencion_temporal_ventas_validate_dr_impuesto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "dr_impuesto_" + iLineNumber;
    }
    else
    {
      sFieldValid = "dr_impuesto_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "dr_impuesto_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "dr_impuesto_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_retencion_temporal_ventas_validate_dr_impuesto__cb

  // ---------- Validate dr_codigo_retencion_
  function do_ajax_form_del_detalle_retencion_temporal_ventas_validate_dr_codigo_retencion_(iNumLinha)
  {
    var nomeCampo_dr_codigo_retencion_ = "dr_codigo_retencion_" + iNumLinha;
    var var_dr_codigo_retencion_ = scAjaxGetFieldSelect(nomeCampo_dr_codigo_retencion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_retencion_temporal_ventas_validate_dr_codigo_retencion_(var_dr_codigo_retencion_, iNumLinha, var_script_case_init, do_ajax_form_del_detalle_retencion_temporal_ventas_validate_dr_codigo_retencion__cb);
  } // do_ajax_form_del_detalle_retencion_temporal_ventas_validate_dr_codigo_retencion_

  function do_ajax_form_del_detalle_retencion_temporal_ventas_validate_dr_codigo_retencion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "dr_codigo_retencion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "dr_codigo_retencion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "dr_codigo_retencion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "dr_codigo_retencion_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_retencion_temporal_ventas_validate_dr_codigo_retencion__cb

  // ---------- Validate dr_base_imponible_
  function do_ajax_form_del_detalle_retencion_temporal_ventas_validate_dr_base_imponible_(iNumLinha)
  {
    var nomeCampo_dr_base_imponible_ = "dr_base_imponible_" + iNumLinha;
    var var_dr_base_imponible_ = scAjaxGetFieldText(nomeCampo_dr_base_imponible_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_retencion_temporal_ventas_validate_dr_base_imponible_(var_dr_base_imponible_, iNumLinha, var_script_case_init, do_ajax_form_del_detalle_retencion_temporal_ventas_validate_dr_base_imponible__cb);
  } // do_ajax_form_del_detalle_retencion_temporal_ventas_validate_dr_base_imponible_

  function do_ajax_form_del_detalle_retencion_temporal_ventas_validate_dr_base_imponible__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "dr_base_imponible_" + iLineNumber;
    }
    else
    {
      sFieldValid = "dr_base_imponible_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "dr_base_imponible_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "dr_base_imponible_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_retencion_temporal_ventas_validate_dr_base_imponible__cb

  // ---------- Validate dr_porcentaje_retencion_
  function do_ajax_form_del_detalle_retencion_temporal_ventas_validate_dr_porcentaje_retencion_(iNumLinha)
  {
    var nomeCampo_dr_porcentaje_retencion_ = "dr_porcentaje_retencion_" + iNumLinha;
    var var_dr_porcentaje_retencion_ = scAjaxGetFieldText(nomeCampo_dr_porcentaje_retencion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_retencion_temporal_ventas_validate_dr_porcentaje_retencion_(var_dr_porcentaje_retencion_, iNumLinha, var_script_case_init, do_ajax_form_del_detalle_retencion_temporal_ventas_validate_dr_porcentaje_retencion__cb);
  } // do_ajax_form_del_detalle_retencion_temporal_ventas_validate_dr_porcentaje_retencion_

  function do_ajax_form_del_detalle_retencion_temporal_ventas_validate_dr_porcentaje_retencion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "dr_porcentaje_retencion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "dr_porcentaje_retencion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "dr_porcentaje_retencion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "dr_porcentaje_retencion_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_retencion_temporal_ventas_validate_dr_porcentaje_retencion__cb

  // ---------- Validate dr_valor_retenido_
  function do_ajax_form_del_detalle_retencion_temporal_ventas_validate_dr_valor_retenido_(iNumLinha)
  {
    var nomeCampo_dr_valor_retenido_ = "dr_valor_retenido_" + iNumLinha;
    var var_dr_valor_retenido_ = scAjaxGetFieldText(nomeCampo_dr_valor_retenido_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_retencion_temporal_ventas_validate_dr_valor_retenido_(var_dr_valor_retenido_, iNumLinha, var_script_case_init, do_ajax_form_del_detalle_retencion_temporal_ventas_validate_dr_valor_retenido__cb);
  } // do_ajax_form_del_detalle_retencion_temporal_ventas_validate_dr_valor_retenido_

  function do_ajax_form_del_detalle_retencion_temporal_ventas_validate_dr_valor_retenido__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "dr_valor_retenido_" + iLineNumber;
    }
    else
    {
      sFieldValid = "dr_valor_retenido_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "dr_valor_retenido_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "dr_valor_retenido_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_retencion_temporal_ventas_validate_dr_valor_retenido__cb

  // ---------- Refresh dr_impuesto_
  function do_ajax_form_del_detalle_retencion_temporal_ventas_refresh_dr_impuesto_(iSeqForm)
  {
    var var_dr_impuesto_ = scAjaxGetFieldSelect("dr_impuesto_" + iSeqForm);
    var var_nmgp_refresh_row = iSeqForm;
    var var_nmgp_refresh_fields = "dr_codigo_retencion_";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_detalle_retencion_temporal_ventas_refresh_dr_impuesto_(var_dr_impuesto_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_del_detalle_retencion_temporal_ventas_refresh_dr_impuesto__cb);
  } // do_ajax_form_del_detalle_retencion_temporal_ventas_refresh_dr_impuesto_

  function do_ajax_form_del_detalle_retencion_temporal_ventas_refresh_dr_impuesto__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_retencion_temporal_ventas_refresh_dr_impuesto__cb

  // ---------- Event onchange dr_base_imponible_
  function do_ajax_form_del_detalle_retencion_temporal_ventas_event_dr_base_imponible__onchange(iSeqForm)
  {
    var var_dr_base_imponible_ = scAjaxGetFieldText("dr_base_imponible_" + iSeqForm);
    var var_dr_porcentaje_retencion_ = scAjaxGetFieldText("dr_porcentaje_retencion_" + iSeqForm);
    var var_dr_valor_retenido_ = scAjaxGetFieldText("dr_valor_retenido_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_del_detalle_retencion_temporal_ventas_event_dr_base_imponible__onchange(var_dr_base_imponible_, var_dr_porcentaje_retencion_, var_dr_valor_retenido_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_del_detalle_retencion_temporal_ventas_event_dr_base_imponible__onchange_cb);
  } // do_ajax_form_del_detalle_retencion_temporal_ventas_event_dr_base_imponible__onchange

  function do_ajax_form_del_detalle_retencion_temporal_ventas_event_dr_base_imponible__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_detalle_retencion_temporal_ventas_event_dr_base_imponible__onchange_cb_after_alert);
  } // do_ajax_form_del_detalle_retencion_temporal_ventas_event_dr_base_imponible__onchange_cb
  function do_ajax_form_del_detalle_retencion_temporal_ventas_event_dr_base_imponible__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_detalle_retencion_temporal_ventas_event_dr_base_imponible__onchange_cb_after_alert

  // ---------- Event onchange dr_codigo_retencion_
  function do_ajax_form_del_detalle_retencion_temporal_ventas_event_dr_codigo_retencion__onchange(iSeqForm)
  {
    var var_dr_codigo_retencion_ = scAjaxGetFieldSelect("dr_codigo_retencion_" + iSeqForm);
    var var_dr_porcentaje_retencion_ = scAjaxGetFieldText("dr_porcentaje_retencion_" + iSeqForm);
    var var_dr_base_imponible_ = scAjaxGetFieldText("dr_base_imponible_" + iSeqForm);
    var var_dr_valor_retenido_ = scAjaxGetFieldText("dr_valor_retenido_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_del_detalle_retencion_temporal_ventas_event_dr_codigo_retencion__onchange(var_dr_codigo_retencion_, var_dr_porcentaje_retencion_, var_dr_base_imponible_, var_dr_valor_retenido_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_del_detalle_retencion_temporal_ventas_event_dr_codigo_retencion__onchange_cb);
  } // do_ajax_form_del_detalle_retencion_temporal_ventas_event_dr_codigo_retencion__onchange

  function do_ajax_form_del_detalle_retencion_temporal_ventas_event_dr_codigo_retencion__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_detalle_retencion_temporal_ventas_event_dr_codigo_retencion__onchange_cb_after_alert);
  } // do_ajax_form_del_detalle_retencion_temporal_ventas_event_dr_codigo_retencion__onchange_cb
  function do_ajax_form_del_detalle_retencion_temporal_ventas_event_dr_codigo_retencion__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_detalle_retencion_temporal_ventas_event_dr_codigo_retencion__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_del_detalle_retencion_temporal_ventas_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_del_detalle_retencion_temporal_ventas_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_detalle_retencion_temporal_ventas_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_del_detalle_retencion_temporal_ventas_add_new_line_cb);
  } // do_ajax_form_del_detalle_retencion_temporal_ventas_add_new_line

  function do_ajax_form_del_detalle_retencion_temporal_ventas_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_del_detalle_retencion_temporal_ventas_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_del_detalle_retencion_temporal_ventas_backup_line(iNumLinha)
  {
    var var_ir_id_ = scAjaxGetFieldHidden("ir_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_retencion_temporal_ventas_backup_line(var_ir_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_del_detalle_retencion_temporal_ventas_backup_line_cb);
  } // do_ajax_form_del_detalle_retencion_temporal_ventas_backup_line

  function do_ajax_form_del_detalle_retencion_temporal_ventas_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_del_detalle_retencion_temporal_ventas_backup_line_cb

  function do_ajax_form_del_detalle_retencion_temporal_ventas_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_del_detalle_retencion_temporal_ventas_cancel_insert

  function do_ajax_form_del_detalle_retencion_temporal_ventas_cancel_update(iSeqVert)
  {
    do_ajax_form_del_detalle_retencion_temporal_ventas_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_del_detalle_retencion_temporal_ventas_cancel_update

  function do_ajax_form_del_detalle_retencion_temporal_ventas_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_del_detalle_retencion_temporal_ventas_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_del_detalle_retencion_temporal_ventas_table_refresh()
  {
    var var_ir_id_ = document.F2.ir_id_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_detalle_retencion_temporal_ventas_table_refresh(var_ir_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_detalle_retencion_temporal_ventas_table_refresh_cb);
  } //  do_ajax_form_del_detalle_retencion_temporal_ventas_table_refresh

  function do_ajax_form_del_detalle_retencion_temporal_ventas_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.ir_id_.value = scAjaxGetKeyValue("ir_id_");
    ...
    scAjaxAlert(do_ajax_form_del_detalle_retencion_temporal_ventas_table_refresh_cb_after_alert);
  } // do_ajax_form_del_detalle_retencion_temporal_ventas_table_refresh_cb
  function do_ajax_form_del_detalle_retencion_temporal_ventas_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_del_detalle_retencion_temporal_ventas_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_del_detalle_retencion_temporal_ventas_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_del_detalle_retencion_temporal_ventas_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_ir_id_ = scAjaxGetFieldHidden("ir_id_" + iNumLinha);
    var var_ir_retencion_temporal_ = scAjaxGetFieldText("ir_retencion_temporal_" + iNumLinha);
    var var_dr_impuesto_ = scAjaxGetFieldSelect("dr_impuesto_" + iNumLinha);
    var var_dr_codigo_retencion_ = scAjaxGetFieldSelect("dr_codigo_retencion_" + iNumLinha);
    var var_dr_base_imponible_ = scAjaxGetFieldText("dr_base_imponible_" + iNumLinha);
    var var_dr_porcentaje_retencion_ = scAjaxGetFieldText("dr_porcentaje_retencion_" + iNumLinha);
    var var_dr_valor_retenido_ = scAjaxGetFieldText("dr_valor_retenido_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_del_detalle_retencion_temporal_ventas_submit_form(var_ir_id_, var_ir_retencion_temporal_, var_dr_impuesto_, var_dr_codigo_retencion_, var_dr_base_imponible_, var_dr_porcentaje_retencion_, var_dr_valor_retenido_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_detalle_retencion_temporal_ventas_submit_form_cb);
  } // do_ajax_form_del_detalle_retencion_temporal_ventas_submit_form

  function do_ajax_form_del_detalle_retencion_temporal_ventas_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("ir_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("ir_retencion_temporal_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("dr_impuesto_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("dr_codigo_retencion_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("dr_base_imponible_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("dr_porcentaje_retencion_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("dr_valor_retenido_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_detalle_retencion_temporal_ventas_submit_form_cb_after_alert);
  } // do_ajax_form_del_detalle_retencion_temporal_ventas_submit_form_cb
  function do_ajax_form_del_detalle_retencion_temporal_ventas_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_detalle_retencion_temporal_ventas_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_detalle_retencion_temporal_ventas_navigate_form()
  {
    perform_ajax_form_del_detalle_retencion_temporal_ventas_navigate_form();
  }

  function perform_ajax_form_del_detalle_retencion_temporal_ventas_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_del_detalle_retencion_temporal_ventas_cancel_insert(sc_form_del_detalle_retencion_temporal_ventas_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("ir_id_" + iNavForm);
      scAjaxHideErrorDisplay("ir_retencion_temporal_" + iNavForm);
      scAjaxHideErrorDisplay("dr_impuesto_" + iNavForm);
      scAjaxHideErrorDisplay("dr_codigo_retencion_" + iNavForm);
      scAjaxHideErrorDisplay("dr_base_imponible_" + iNavForm);
      scAjaxHideErrorDisplay("dr_porcentaje_retencion_" + iNavForm);
      scAjaxHideErrorDisplay("dr_valor_retenido_" + iNavForm);
    }
    var var_ir_id_ = document.F2.ir_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_detalle_retencion_temporal_ventas_navigate_form(var_ir_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_detalle_retencion_temporal_ventas_navigate_form_cb);
  } // do_ajax_form_del_detalle_retencion_temporal_ventas_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_retencion_temporal_ventas']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_detalle_retencion_temporal_ventas_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.ir_id_.value = scAjaxGetKeyValue("ir_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_detalle_retencion_temporal_ventas_navigate_form_cb_after_alert);
  } // do_ajax_form_del_detalle_retencion_temporal_ventas_navigate_form_cb
  function do_ajax_form_del_detalle_retencion_temporal_ventas_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_del_detalle_retencion_temporal_ventas_navigate_form_cb_after_alert

    function sc_form_del_detalle_retencion_temporal_ventas_get_last_line_number()
    {
    ...
    } //sc_form_del_detalle_retencion_temporal_ventas_get_last_line_number

  function sc_hide_form_del_detalle_retencion_temporal_ventas_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "ir_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "ir_retencion_temporal_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "dr_impuesto_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "dr_codigo_retencion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "dr_base_imponible_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "dr_porcentaje_retencion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "dr_valor_retenido_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["ir_id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["ir_retencion_temporal_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_retencion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["dr_impuesto_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_impuesto'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["dr_codigo_retencion_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_sustento'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["dr_base_imponible_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_base_imponible'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["dr_porcentaje_retencion_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_porcentaje_retencion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["dr_valor_retenido_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_valor_retenido'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["ir_id_"][iNumLinha] = "ir_id_" + iNumLinha;
    ajax_field_mult["ir_retencion_temporal_"][iNumLinha] = "ir_retencion_temporal_" + iNumLinha;
    ajax_field_mult["dr_impuesto_"][iNumLinha] = "dr_impuesto_" + iNumLinha;
    ajax_field_mult["dr_codigo_retencion_"][iNumLinha] = "dr_codigo_retencion_" + iNumLinha;
    ajax_field_mult["dr_base_imponible_"][iNumLinha] = "dr_base_imponible_" + iNumLinha;
    ajax_field_mult["dr_porcentaje_retencion_"][iNumLinha] = "dr_porcentaje_retencion_" + iNumLinha;
    ajax_field_mult["dr_valor_retenido_"][iNumLinha] = "dr_valor_retenido_" + iNumLinha;
    ajax_field_id["ir_id_" + iNumLinha] = new Array("hidden_field_label_ir_id_", "hidden_field_data_ir_id_" + iNumLinha);
    ajax_field_id["dr_impuesto_" + iNumLinha] = new Array("hidden_field_label_dr_impuesto_", "hidden_field_data_dr_impuesto_" + iNumLinha);
    ajax_field_id["dr_codigo_retencion_" + iNumLinha] = new Array("hidden_field_label_dr_codigo_retencion_", "hidden_field_data_dr_codigo_retencion_" + iNumLinha);
    ajax_field_id["dr_base_imponible_" + iNumLinha] = new Array("hidden_field_label_dr_base_imponible_", "hidden_field_data_dr_base_imponible_" + iNumLinha);
    ajax_field_id["dr_porcentaje_retencion_" + iNumLinha] = new Array("hidden_field_label_dr_porcentaje_retencion_", "hidden_field_data_dr_porcentaje_retencion_" + iNumLinha);
    ajax_field_id["dr_valor_retenido_" + iNumLinha] = new Array("hidden_field_label_dr_valor_retenido_", "hidden_field_data_dr_valor_retenido_" + iNumLinha);
    ajax_error_count["ir_id_" + iNumLinha] = "off";
    ajax_error_count["ir_retencion_temporal_" + iNumLinha] = "off";
    ajax_error_count["dr_impuesto_" + iNumLinha] = "off";
    ajax_error_count["dr_codigo_retencion_" + iNumLinha] = "off";
    ajax_error_count["dr_base_imponible_" + iNumLinha] = "off";
    ajax_error_count["dr_porcentaje_retencion_" + iNumLinha] = "off";
    ajax_error_count["dr_valor_retenido_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["ir_id_" + iNumLinha] = "on";
    ajax_read_only["ir_retencion_temporal_" + iNumLinha] = "off";
    ajax_read_only["dr_impuesto_" + iNumLinha] = "off";
    ajax_read_only["dr_codigo_retencion_" + iNumLinha] = "off";
    ajax_read_only["dr_base_imponible_" + iNumLinha] = "off";
    ajax_read_only["dr_porcentaje_retencion_" + iNumLinha] = "off";
    ajax_read_only["dr_valor_retenido_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["ir_id_" + iNumLinha] = "on";
    ajax_read_only["ir_retencion_temporal_" + iNumLinha] = "on";
    ajax_read_only["dr_impuesto_" + iNumLinha] = "on";
    ajax_read_only["dr_codigo_retencion_" + iNumLinha] = "on";
    ajax_read_only["dr_base_imponible_" + iNumLinha] = "on";
    ajax_read_only["dr_porcentaje_retencion_" + iNumLinha] = "on";
    ajax_read_only["dr_valor_retenido_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["ir_id_" + iNumLinha] = null;
    ajax_error_list["ir_retencion_temporal_" + iNumLinha] = null;
    ajax_error_list["dr_impuesto_" + iNumLinha] = null;
    ajax_error_list["dr_codigo_retencion_" + iNumLinha] = null;
    ajax_error_list["dr_base_imponible_" + iNumLinha] = null;
    ajax_error_list["dr_porcentaje_retencion_" + iNumLinha] = null;
    ajax_error_list["dr_valor_retenido_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "ir_id_": new Array(),
    "ir_retencion_temporal_": new Array(),
    "dr_impuesto_": new Array(),
    "dr_codigo_retencion_": new Array(),
    "dr_base_imponible_": new Array(),
    "dr_porcentaje_retencion_": new Array(),
    "dr_valor_retenido_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["ir_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ir_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ir_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ir_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ir_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["ir_retencion_temporal_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ir_retencion_temporal_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ir_retencion_temporal_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ir_retencion_temporal_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ir_retencion_temporal_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["dr_impuesto_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["dr_impuesto_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["dr_impuesto_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["dr_impuesto_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["dr_impuesto_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["dr_codigo_retencion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["dr_codigo_retencion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["dr_codigo_retencion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["dr_codigo_retencion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["dr_codigo_retencion_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["dr_base_imponible_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["dr_base_imponible_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["dr_base_imponible_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["dr_base_imponible_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["dr_base_imponible_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["dr_porcentaje_retencion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["dr_porcentaje_retencion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["dr_porcentaje_retencion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["dr_porcentaje_retencion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["dr_porcentaje_retencion_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["dr_valor_retenido_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["dr_valor_retenido_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["dr_valor_retenido_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["dr_valor_retenido_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["dr_valor_retenido_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ir_id_'])) ? $this->nmgp_cmp_readonly['ir_id_'] : 'on';
?>
    scAjaxFieldRead("ir_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ir_retencion_temporal_'])) ? $this->nmgp_cmp_readonly['ir_retencion_temporal_'] : 'off';
?>
    scAjaxFieldRead("ir_retencion_temporal_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['dr_impuesto_'])) ? $this->nmgp_cmp_readonly['dr_impuesto_'] : 'off';
?>
    scAjaxFieldRead("dr_impuesto_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['dr_codigo_retencion_'])) ? $this->nmgp_cmp_readonly['dr_codigo_retencion_'] : 'off';
?>
    scAjaxFieldRead("dr_codigo_retencion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['dr_base_imponible_'])) ? $this->nmgp_cmp_readonly['dr_base_imponible_'] : 'off';
?>
    scAjaxFieldRead("dr_base_imponible_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['dr_porcentaje_retencion_'])) ? $this->nmgp_cmp_readonly['dr_porcentaje_retencion_'] : 'off';
?>
    scAjaxFieldRead("dr_porcentaje_retencion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['dr_valor_retenido_'])) ? $this->nmgp_cmp_readonly['dr_valor_retenido_'] : 'off';
?>
    scAjaxFieldRead("dr_valor_retenido_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("ir_id_" + iSeq, "on");
    scAjaxFieldRead("ir_retencion_temporal_" + iSeq, "on");
    scAjaxFieldRead("dr_impuesto_" + iSeq, "on");
    scAjaxFieldRead("dr_codigo_retencion_" + iSeq, "on");
    scAjaxFieldRead("dr_base_imponible_" + iSeq, "on");
    scAjaxFieldRead("dr_porcentaje_retencion_" + iSeq, "on");
    scAjaxFieldRead("dr_valor_retenido_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["ir_id_" + iRow] || "on" == ajax_error_count["ir_retencion_temporal_" + iRow] || "on" == ajax_error_count["dr_impuesto_" + iRow] || "on" == ajax_error_count["dr_codigo_retencion_" + iRow] || "on" == ajax_error_count["dr_base_imponible_" + iRow] || "on" == ajax_error_count["dr_porcentaje_retencion_" + iRow] || "on" == ajax_error_count["dr_valor_retenido_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ir_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ir_retencion_temporal_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_dr_impuesto_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_dr_codigo_retencion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_dr_base_imponible_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_dr_porcentaje_retencion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_dr_valor_retenido_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["ir_id_" + iRow] && "off" == ajax_error_count["ir_retencion_temporal_" + iRow] && "off" == ajax_error_count["dr_impuesto_" + iRow] && "off" == ajax_error_count["dr_codigo_retencion_" + iRow] && "off" == ajax_error_count["dr_base_imponible_" + iRow] && "off" == ajax_error_count["dr_porcentaje_retencion_" + iRow] && "off" == ajax_error_count["dr_valor_retenido_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["ir_id_" + iRow] = "off";
        ajax_error_count["ir_retencion_temporal_" + iRow] = "off";
        ajax_error_count["dr_impuesto_" + iRow] = "off";
        ajax_error_count["dr_codigo_retencion_" + iRow] = "off";
        ajax_error_count["dr_base_imponible_" + iRow] = "off";
        ajax_error_count["dr_porcentaje_retencion_" + iRow] = "off";
        ajax_error_count["dr_valor_retenido_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_ir_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_ir_retencion_temporal_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_dr_impuesto_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_dr_codigo_retencion_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_dr_base_imponible_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_dr_porcentaje_retencion_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_dr_valor_retenido_" + iRow).removeClass("scFormErrorLine");
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("ir_retencion_temporal_" == sIndex)
    {
    ...
    if ("dr_codigo_retencion_" == sIndex)
    {
      scAjaxSetFieldSelect(sIndex, aValue, null);
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("dr_porcentaje_retencion_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
