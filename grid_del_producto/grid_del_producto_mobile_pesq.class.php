...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "pro_por_iva";$Nm_numeric[] = "pro_por_ice";$Nm_numeric[] = "pro_precio";$Nm_numeric[] = "pro_descuento";$Nm_numeric[] = "pro_familia_producto";$Nm_numeric[] = "pro_grupo_compras";$Nm_numeric[] = "pro_grupo_ventas";$Nm_numeric[] = "pro_por_iva";$Nm_numeric[] = "pro_por_ice";$Nm_numeric[] = "pro_precio";$Nm_numeric[] = "pro_descuento";$Nm_numeric[] = "pro_familia_producto";$Nm_numeric[] = "pro_grupo_compras";$Nm_numeric[] = "pro_grupo_ventas";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_pro_categoria_producto"  <?php echo $str_hide_pro_categoria_producto?>>
<?php
...
?>
   <span id="idAjaxSelect_pro_categoria_producto">
      <SELECT class="scFilterObjectOdd" id="SC_pro_categoria_producto" name="pro_categoria_producto[]"  size="7" multiple>
<?php
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_pro_familia_producto"  <?php echo $str_hide_pro_familia_producto?>>
<?php
...
?>
   <span id="idAjaxSelect_pro_familia_producto">
      <SELECT class="scFilterObjectEven" id="SC_pro_familia_producto" name="pro_familia_producto[]"  size="7" multiple>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
         ...
         if (!empty($nm_opcao))
         {
            ...
            if (is_array($pro_familia_producto) && !empty($pro_familia_producto))
            {
               ...
               foreach ($pro_familia_producto as $Dados)
               {
                   if ($Dados === $nm_opc_cod)
                   {
                       $pro_familia_producto_sel = "selected";
                       break;
                   }
               }
            }
...
?>
 ...
 function limpa_form()
 {
   ...
   {
      if (document.F1.elements[i].name == 'pro_categoria_producto[]')
      {
   ...
   for (i = 0; i < document.F1.elements.length; i++)
   {
      if (document.F1.elements[i].name == 'pro_familia_producto[]')
      {
          while (document.F1.elements[i].selectedIndex != -1)
          {
              aa = document.F1.elements[i].selectedIndex;
...
<?php
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "pro_categoria_producto" : return ('class="scFilterObjectOdd"'); break;
         case "pro_familia_producto" : return ('class="scFilterObjectEven"'); break;
         default       : return ("");
      }
   }
