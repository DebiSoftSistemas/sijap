<?php
@session_start() ;
$_SESSION['scriptcase']['grid_del_producto']['sc_process_barr'] = true;
require_once('../grid_del_producto/index.php');
unset($_SESSION['scriptcase']['grid_del_producto']['sc_process_barr']);
$ExportCtrl = new grid_del_producto_export_control;
$ExportCtrl->Export_barr();

class grid_del_producto_export_control
{
