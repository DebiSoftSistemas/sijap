...
class grid_del_producto_total
{
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_del_producto']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_del_producto']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang , $pro_categoria_producto, $pro_por_iva, $pro_estado, $pro_por_ice, $pro_por_irbpnr, $pro_familia_producto, $pro_grupo_compras, $pro_grupo_ventas;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_producto']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_producto']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_producto']['where_pesq']; 
      } 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_producto']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_producto']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_producto']['contr_total_geral'] = "OK";
   } 
