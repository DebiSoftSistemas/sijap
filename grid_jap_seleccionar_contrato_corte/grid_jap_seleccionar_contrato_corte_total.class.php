...
class grid_jap_seleccionar_contrato_corte_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_jap_seleccionar_contrato_corte']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_jap_seleccionar_contrato_corte']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang , $con_ruta, $op_propietario;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['where_pesq']; 
      } 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['contr_total_geral'] = "OK";
   } 
   ...
   function quebra_con_ruta_sc_free_group_by($con_ruta, $Where_qb, $Cmp_Name) 
   {
      ...
      global $$Var_name_gb, $con_ruta, $op_propietario;
      $tot_con_ruta = array() ;  
