...
<?php
   ...
   $Ord_Cmp = new grid_jap_seleccionar_contrato_corte_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_jap_seleccionar_contrato_corte_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["con_ruta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['labels']["con_ruta"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['labels']["con_ruta"] : "" . $this->Nm_lang['lang_ruta'] . "";
   $tab_ger_campos['op_fecha_ini'] = "on";
   $tab_def_campos['op_fecha_ini'] = "op_fecha_ini";
   $tab_labels["op_fecha_ini"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['labels']["op_fecha_ini"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['labels']["op_fecha_ini"] : "Fecha";
   $tab_ger_campos['rc_orden'] = "on";
   $tab_def_campos['rc_orden'] = "rc_orden";
   $tab_labels["rc_orden"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['labels']["rc_orden"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['labels']["rc_orden"] : "Orden";
   $tab_ger_campos['cl_nombre'] = "on";
   $tab_def_campos['cl_nombre'] = "cl_nombre";
   $tab_labels["cl_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['labels']["cl_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['labels']["cl_nombre"] : "" . $this->Nm_lang['lang_propietario'] . "";
   $tab_ger_campos['con_numero_contrato'] = "on";
   $tab_def_campos['con_numero_contrato'] = "con_numero_contrato";
   $tab_labels["con_numero_contrato"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['labels']["con_numero_contrato"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['labels']["con_numero_contrato"] : "" . $this->Nm_lang['lang_numero_contrato'] . "";
   $tab_ger_campos['con_numero_medidor'] = "on";
   $tab_def_campos['con_numero_medidor'] = "con_numero_medidor";
   $tab_labels["con_numero_medidor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['labels']["con_numero_medidor"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['labels']["con_numero_medidor"] : "" . $this->Nm_lang['lang_numero_medidor'] . "";
   $tab_ger_campos['meses_deuda'] = "on";
   $tab_def_campos['meses_deuda'] = "meses_deuda";
   $tab_labels["meses_deuda"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['labels']["meses_deuda"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['labels']["meses_deuda"] : "Meses Deuda";
   $tab_ger_campos['total_deuda'] = "on";
   $tab_def_campos['total_deuda'] = "total_deuda";
   $tab_labels["total_deuda"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['labels']["total_deuda"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['labels']["total_deuda"] : "Total Deuda";
   ...
   $tab_labels["seleccionar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['labels']["seleccionar"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['labels']["seleccionar"] : "seleccionar";
   $tab_ger_campos['con_id'] = "on";
   $tab_def_campos['con_id'] = "con_id";
   $tab_labels["con_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['labels']["con_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['labels']["con_id"] : "Con Id";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_jap_seleccionar_contrato_corte_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_jap_seleccionar_contrato_corte']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
