...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "op_fecha_ini";$Nm_numeric[] = "op_propietario";$Nm_numeric[] = "op_contrato";$Nm_numeric[] = "meses_deuda";$Nm_numeric[] = "con_ruta";$Nm_numeric[] = "total_deuda";$Nm_numeric[] = "rc_orden";$Nm_numeric[] = "con_id";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_meses_deuda"  <?php echo $str_hide_meses_deuda?>><INPUT  type="text" id="SC_meses_deuda" name="meses_deuda" value="<?php echo NM_encode_input($meses_deuda) ?>" size=17 alt="{datatype: 'integer', maxLength: 17, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
