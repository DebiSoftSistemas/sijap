<?php
class grid_jap_seleccionar_contrato_corte_grid
{
   var $Ini;
   var $Erro;
   var $Db;
...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['grid_pesq'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['grid_pesq'] = array();
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['charts_html'] = '';
   ...
   { 
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['proc_pdf_vert'])
            {
            } 
            else
            {
       ...
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_jap_seleccionar_contrato_corte'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'];
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_top();
       } 
       if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao_print'] != 'print')
       { 
           if ($this->Ini->grid_search_change_fil)
           { 
               $seq_search = 1;
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['grid_pesq'] as $cmp => $def)
               {
                  $Seq_grid      = $seq_search;
                  $Cmp_grid      = $cmp;
       ...
       unset ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['save_grid']);
       $this->grid();
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_bot();
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['print_all'] && empty($this->nm_grid_sem_reg) && ($Gera_res || $Gera_graf))
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] == "pdf")
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] == "pdf")
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] = "igual";
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'];
 }
...
//
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['orig_pesq'] = "grid";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['Ind_lig_mult'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['Ind_lig_mult'] = 0;
   }
   $this->Img_embbed      = false;
   $this->nm_data         = new nm_data("es");
   $this->pdf_label_group = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opc_pdf']['label_group'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opc_pdf']['label_group'] : "N";
   $this->pdf_all_cab     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opc_pdf']['all_cab']))     ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opc_pdf']['all_cab'] : "S";
   $this->pdf_all_label   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opc_pdf']['all_label']))   ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opc_pdf']['all_label'] : "S";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opc_liga']['fix_top'])) {
       $this->Fix_bar_top = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opc_liga']['fix_top'] == "S") ? true : false;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opc_liga']['fix_bot'])) {
       $this->Fix_bar_bottom = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opc_liga']['fix_bot'] == "S") ? true : false;
   }
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "grid_jap_seleccionar_contrato_corte/grid_jap_seleccionar_contrato_corte_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   foreach ($NM_css as $cada_css)
   {
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['doc_word'])
       { 
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['pesq_tab_label']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['pesq_tab_label'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['pesq_tab_label'] .= "con_ruta?#?" . "" . $this->Ini->Nm_lang['lang_ruta'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['pesq_tab_label'] .= "con_numero_contrato?#?" . "" . $this->Ini->Nm_lang['lang_numero_contrato'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['pesq_tab_label'] .= "meses_deuda?#?" . "Meses Deuda" . "?@?";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['grid_search_add']))
   {
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['pesq_tab_label'];
       ...
       $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['grid_search_add']['seq'];
       $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['grid_search_add']['cmp'];
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['grid_search_add']);
       exit;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida'] || $this->Ini->Embutida_iframe)
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['force_toolbar']);
   } 
       $this->Tem_tab_vert = false;
   if (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['SC_Gb_Free_cmp']) > 1)
   {
       $this->width_tabula_quebra  = (((count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['SC_Gb_Free_cmp']) - 1) * 13) + 3) . "px";
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_jap_seleccionar_contrato_corte']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_jap_seleccionar_contrato_corte']['lig_edit'] != '')
   {
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_jap_seleccionar_contrato_corte']['lig_edit'] == "on")  {$_SESSION['scriptcase']['sc_apl_conf']['grid_jap_seleccionar_contrato_corte']['lig_edit'] = "S";}
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_jap_seleccionar_contrato_corte']['lig_edit'] == "off") {$_SESSION['scriptcase']['sc_apl_conf']['grid_jap_seleccionar_contrato_corte']['lig_edit'] = "N";}
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_jap_seleccionar_contrato_corte']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['mostra_edit'] = "N";
       }
   }
   if ($this->Ini->SC_Link_View || ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opc_psq'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['psq_edit'] == 'N'))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['mostra_edit'] = "N";
   }
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ind_tree'] = 0;
   }
   elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['emb_tree_no']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['emb_tree_no'])
   { 
       $this->NM_emb_tree_no = true; 
   }
   $this->aba_iframe = false;
   $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['print_all'];
   if ($this->Print_All)
   {
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("grid_jap_seleccionar_contrato_corte", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_jap_seleccionar_contrato_corte']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_jap_seleccionar_contrato_corte']['btn_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_jap_seleccionar_contrato_corte']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
       {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['doc_word'] || $this->Ini->sc_export_ajax_img)
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['where_pesq_ant'];  
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] = "muda_qt_linhas";
   } 
   $this->New_label['con_ruta'] = "" . $this->Ini->Nm_lang['lang_ruta'] . "";
   $this->New_label['cl_nombre'] = "" . $this->Ini->Nm_lang['lang_propietario'] . "";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['dashboard_info']['maximized']) {
       $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['dashboard_info']['dashboard_app'];
       if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_jap_seleccionar_contrato_corte'])) {
           $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_jap_seleccionar_contrato_corte'];
   ...
   if ($this->Ini->Embutida_iframe) {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['sub_cons_iframe_btns'] as $BTN => $BTN_opc) {
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "grid_jap_seleccionar_contrato_corte/grid_jap_seleccionar_contrato_corte_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "grid_jap_seleccionar_contrato_corte_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   ...
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['qt_lin_grid'] = 10;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_jap_seleccionar_contrato_corte']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_jap_seleccionar_contrato_corte']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_jap_seleccionar_contrato_corte']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_jap_seleccionar_contrato_corte']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_jap_seleccionar_contrato_corte']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_jap_seleccionar_contrato_corte']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_jap_seleccionar_contrato_corte']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_jap_seleccionar_contrato_corte']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['qt_lin_grid']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['SC_Ind_Groupby'] == "sc_free_group_by") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_select']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_select'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_select']['rc_orden'] = 'asc'; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_select_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_select']; 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['SC_Ind_Groupby'] == "sc_free_group_by") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_quebra'] = array(); 
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['SC_Gb_Free_sql'] as $cmp_var => $resto)
           {
               foreach ($resto as $SC_Sql_col => $SC_Sql_order)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_quebra'][$cmp_var][$SC_Sql_col] = $SC_Sql_order;
               }
           }
       } 
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] = "inicio" ;  
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_grid'] = ""; 
                       $ordem = ($ordem == "asc") ? "desc" : "asc";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['prim_cons'] || !empty($nmgp_parms))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['prim_cons'] = false;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['where_orig'] = " where (op_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "' and con_estado='V')";  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['where_pesq_ant']    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['cond_pesq']         = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['where_pesq_filtro'] = "";
   }   
   if  (!empty($this->nm_where_dinamico)) 
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['where_pesq_filtro'];
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao']       = "igual" ; 
...
// 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] == "final" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['qt_reg_grid'] == "all") 
   { 
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['tot_geral'][1] ;  
       $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['tot_geral'][1];
   } 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['contr_total_geral'] = "NAO";
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['sc_total']);
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['tot_geral'][1] ;  
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['sc_total'] = $rt_grid->fields[0];  
       
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
   {
       $this->Ini->Qtd_reg_ajax_grid = $this->count_ger;
   }
   else
   {
       $this->Ini->Qtd_reg_ajax_grid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['qt_reg_grid'];
   }
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_desc']; 
   } 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       ...
       $this->meses_deuda = $this->rs_grid->fields[6] ;  
       ...
       $this->total_deuda = $this->rs_grid->fields[7] ;  
       $this->total_deuda = (string)$this->total_deuda;
       $this->op_empresa = $this->rs_grid->fields[8] ;  
       $this->op_propietario = $this->rs_grid->fields[9] ;  
       ...
       $this->con_id = $this->rs_grid->fields[13] ;  
       $this->con_id = (string)$this->con_id;
       $this->con_sino = $this->rs_grid->fields[14] ;  
       if (!isset($this->con_ruta)) { $this->con_ruta = ""; }
       $GLOBALS["op_propietario"] = $this->rs_grid->fields[9] ;  
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['SC_Ind_Groupby'] == "sc_free_group_by") 
       {
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['SC_Gb_Free_cmp'] as $cmp => $sql)
           {
               $Cmp_orig   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['SC_Gb_Free_orig'][$cmp])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['SC_Gb_Free_orig'][$cmp] : $cmp;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['final']; 
   ...
   $this->NM_hidden_filters = ($this->Ini->Embutida_iframe && !empty($this->nm_grid_sem_reg) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['initialize']) ? true : false;
   $this->nmgp_reg_inicial  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['final'] + 1;
   $this->nmgp_reg_final    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['qt_reg_grid'];
   $this->nmgp_reg_final    = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['doc_word'] && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['word_return']);
       ...
       if ($this->Ini->Proc_print && $this->Ini->Export_html_zip  && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['print_return']);
           $this->pb->setTotalSteps($this->count_ger);
       }
       if (!$this->Ini->sc_export_ajax && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['pivot_charts']) : 0;
           ...
           if (-1 < $this->progress_grid)
           {
               ...
               grid_jap_seleccionar_contrato_corte_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
               grid_jap_seleccionar_contrato_corte_pdf_progress_call($this->Ini->path_js   . "\n", $this->Ini->Nm_lang);
               grid_jap_seleccionar_contrato_corte_pdf_progress_call($this->Ini->path_prod . "/img/\n", $this->Ini->Nm_lang);
               grid_jap_seleccionar_contrato_corte_pdf_progress_call($this->progress_tot   . "\n", $this->Ini->Nm_lang);
               ...
               grid_jap_seleccionar_contrato_corte_pdf_progress_call($this->progress_tot . "_#NM#_" . "1_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida'] && $this->NM_opcao != "pdf") {
           $nm_saida->saida("   <link rel=\"shortcut icon\" href=\"../_lib/img/usr__NM__img__NM__favicon.png\">\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ajax_nav'] && !$this->Ini->sc_export_ajax)
       { 
           ...
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_jap_seleccionar_contrato_corte_jquery_1652.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_jap_seleccionar_contrato_corte_ajax.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_jap_seleccionar_contrato_corte_message.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
        ...
        if ($this->Fix_bar_top) {
           ...
           $nm_saida->saida("{\r\n");
           $nm_saida->saida("    selectedFields = $(\".sc-ui-grid-header-row-grid_jap_seleccionar_contrato_corte-1 .sc-op-fix-col.sc-op-fix-col-fixed\");\r\n");
           ...
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['qt_reg_grid']) . ";\r\n");
           }
           ...
           $nm_saida->saida("    {\r\n");
           $nm_saida->saida("        let cells = $(\".sc-ui-grid-header-row-grid_jap_seleccionar_contrato_corte-1\").find(\"td\");\r\n");
           ...
           $nm_saida->saida("        rows = $(\".sc-ui-grid-header-row-grid_jap_seleccionar_contrato_corte-1\");\r\n");
           ...
           $nm_saida->saida("   var gridHeaders = $(\".sc-ui-grid-header-row-grid_jap_seleccionar_contrato_corte-1\"), headerDisplayed = true;\r\n");
           ...
           $nm_saida->saida("   tableOriginal = document.getElementById(\"sc-ui-grid-body-5dc11b8e\");\r\n");
           ...
           if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao_print'] != 'print' && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['grid_pesq']))
           { 
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ancor_save']);
           }
           $nm_saida->saida("   });\r\n");
...
$nm_saida->saida("}\r\n");
       ...
       $nm_saida->saida("<style type=\"text/css\">\r\n");
       $nm_saida->saida("</style>\r\n");
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['num_css']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['num_css'] = rand(0, 1000);
       }
       $write_css = true;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida'] && !$this->Print_All && $this->NM_opcao != "print" && $this->NM_opcao != "pdf")
       {
           $write_css = false;
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida_pdf']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida_pdf'])
       {
           $write_css = true;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_jap_seleccionar_contrato_corte_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida'])
       {
 ...
 { 
       ...
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_jap_seleccionar_contrato_corte_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_grid_jap_seleccionar_contrato_corte_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] != "pdf") {
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_jap_seleccionar_contrato_corte/grid_jap_seleccionar_contrato_corte_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['proc_pdf_vert'])
  {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           ...
           if ($Pos1 !== false && $Pos2 !== false) {
               ...
               $cada_css = ".grid_jap_seleccionar_contrato_corte_" . substr(trim($Tag[0]), 1);
               if (isset($Tag[1])) {
                   $cada_css .= ", .grid_jap_seleccionar_contrato_corte_" . substr(trim($Tag[1]), 1);
               }
               $cada_css .= $Css;
           }
           else {
               $cada_css = ".grid_jap_seleccionar_contrato_corte_" . substr($cada_css, 1);
           }
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   $this->css_body_embutida = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['css_body_embutida'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['css_body_embutida'] : "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida'])
   { 
       if (!$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['doc_word'] && ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao_print'] == "print")) 
       {
           if ($this->Print_All) 
           {
               $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
       ...
       {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
          $vertical_center = '';
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] != "pdf" && !$this->Print_All)
       { 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['css_body_embutida'])) {
       $remove_border = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['css_body_embutida'];
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['proc_pdf_vert'])
   {
   }
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_jap_seleccionar_contrato_corte']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_jap_seleccionar_contrato_corte']) . "_";
           } 
       } 
       else 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_jap_seleccionar_contrato_corte']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_jap_seleccionar_contrato_corte']) . "_";
           } 
       }
   }
   $temp_css  = explode("/", $compl_css);
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida']) ? "grid_jap_seleccionar_contrato_corte_" : "";
   $this->css_sep = " ";
...
//----- 
 function cabecalho_normal()
 {
   global
          $nm_saida;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['dashboard_info']['maximized'])
   {
       return; 
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opc_liga']['cab']))
   {
       return; 
   }
   if ($this->Ini->Embutida_iframe) {
   ...
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['where_pesq_filtro'];
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['cond_pesq']))
   {  
       $pos       = 0;
       $trab_pos  = false;
       $pos_tmp   = true; 
       $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['cond_pesq'];
       while ($pos_tmp)
       {
          $pos = strpos($tmp, "##*@@", $pos);
          if ($pos !== false)
       ...
       $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
       $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
       $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['cond_pesq'], 0, $trab_pos);
...
$_SESSION['scriptcase']['grid_jap_seleccionar_contrato_corte']['contr_erro'] = 'off';
   ...
   { 
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['proc_pdf']) 
     { 
         $this->NM_calc_span();
           $nm_saida->saida("   <TD colspan=\"" . $this->NM_colspan . "\" class=\"" . $this->css_scGridTabelaTd . "\" style=\"vertical-align: top\">\r\n");
     } 
     else if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['proc_pdf_vert']) 
     {
...
// 
 function label_grid($linhas = 0)
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida_label'])
   { 
       $this->New_label['con_ruta'] = "" . $this->Ini->Nm_lang['lang_ruta'] . "";
       $this->New_label['cl_nombre'] = "" . $this->Ini->Nm_lang['lang_propietario'] . "";
       $this->New_label['con_numero_contrato'] = "" . $this->Ini->Nm_lang['lang_numero_contrato'] . "";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['exibe_titulos']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
   ...
   $nm_saida->saida("    <TR id=\"tit_grid_jap_seleccionar_contrato_corte__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-grid_jap_seleccionar_contrato_corte-" . $tmp_header_row . "\">\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida_label']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_con_id_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opc_psq']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_con_id_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['field_order'] as $Cada_label)
   { 
   ...
   $nm_saida->saida("</TR>\r\n");
             ...
             foreach ($NM_css as $cada_css)
             {
                 ...
                 if ($Pos1 !== false && $Pos2 !== false) {
                     ...
                     $css_emb .= $cada_css . $Css;
                       ...
                       $css_emb .= ".grid_jap_seleccionar_contrato_corte_" . substr($cada_css, 1);
                 }
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
     ...
     $NM_seq_lab = 1;
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['labels'] as $NM_cmp => $NM_lab)
     {
         if (empty($NM_lab) || $NM_lab == "&nbsp;")
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['labels'][$NM_cmp] = "No_Label" . $NM_seq_lab;
             $NM_seq_lab++;
         }
     } 
   } 
 ...
 function NM_label_con_ruta()
 {
   ...
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] != 'pdf') {
 ...
 function NM_label_cl_nombre()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_cl_nombre_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_cl_nombre_label'] . "\" NOWRAP WIDTH=\"200%\">\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
 ...
 function NM_label_seleccionar()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_seleccionar_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_seleccionar_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = 'left';
 ...
 function NM_label_op_propietario()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_op_propietario_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_op_propietario_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
 ...
 function NM_label_con_id()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_con_id_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_con_id_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '; justify-content: right';
...
function SC_label_rightActionBar()
{
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_cmp'] == $fieldName) {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ordem_label'] == 'desc') {
                $sortRule = 'desc';
            } else {
                $sortRule = 'asc';
            }
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $this->NM_cmp_hidden['con_id'] = "off"; 
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ini_cor_grid']);
       }
   }
...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['labels']['con_ruta'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['op_fecha_ini'])) ? $this->New_label['op_fecha_ini'] : "Fecha";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['labels']['op_fecha_ini'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['rc_orden'])) ? $this->New_label['rc_orden'] : "Orden";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['labels']['rc_orden'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cl_nombre'])) ? $this->New_label['cl_nombre'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['labels']['cl_nombre'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['con_numero_contrato'])) ? $this->New_label['con_numero_contrato'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['labels']['con_numero_contrato'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['con_numero_medidor'])) ? $this->New_label['con_numero_medidor'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['labels']['con_numero_medidor'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['meses_deuda'])) ? $this->New_label['meses_deuda'] : "Meses Deuda";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['labels']['meses_deuda'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['total_deuda'])) ? $this->New_label['total_deuda'] : "Total Deuda";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['labels']['total_deuda'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['seleccionar'])) ? $this->New_label['seleccionar'] : "seleccionar";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['labels']['seleccionar'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['op_empresa'])) ? $this->New_label['op_empresa'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['labels']['op_empresa'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['op_propietario'])) ? $this->New_label['op_propietario'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['labels']['op_propietario'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cl_telefono'])) ? $this->New_label['cl_telefono'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['labels']['cl_telefono'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cl_celular'])) ? $this->New_label['cl_celular'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['labels']['cl_celular'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cl_email'])) ? $this->New_label['cl_email'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['labels']['cl_email'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['con_id'])) ? $this->New_label['con_id'] : "Con Id";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['labels']['con_id'] = $SC_Label; 
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['grid_jap_seleccionar_contrato_corte']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_jap_seleccionar_contrato_corte']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_jap_seleccionar_contrato_corte']['lig_edit'];
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_grid_jap_seleccionar_contrato_corte#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               ...
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['cab_embutida'] != "S")
               {
       ...
       else
       {
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['force_toolbar'] = true;
           } 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ajax_nav'])
           { 
               $_SESSION['scriptcase']['saida_html'] = "";
           } 
           $nm_saida->saida("  " . $this->nm_grid_sem_reg . "\r\n");
           ...
           $nm_saida->saida("  </td></tr>\r\n");
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
           { 
               $this->sumario_mobile() ; 
           } 
       }
...
else
{
       ...
       $nm_id_aplicacao = " id=\"apl_grid_jap_seleccionar_contrato_corte#?#1\"";
   } 
   $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] == "pdf") ? "padding: 0px !important;" : "";
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['proc_pdf_vert'])
{
}
else
...
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['proc_pdf']) { 
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['proc_pdf']) { 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-5dc11b8e\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['proc_pdf_vert']) { 
    $nm_saida->saida("</thead>\r\n");
 }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['proc_pdf'] && $this->pdf_all_label != "S" && $this->pdf_label_group != "S") 
   { 
      $this->label_grid($linhas);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida_grid'])
...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['Config_Page_break_PDF'] = "S";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['Page_break_PDF']))
   {
       if (isset($this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['SC_Ind_Groupby']]))
       {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['SC_Gb_Free_cmp'] as $Cmp_gb => $resto)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['Page_break_PDF'][$Cmp_gb] = $this->Break_pag_pdf['sc_free_group_by'][$Cmp_gb];
               }
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['Page_break_PDF'] = $this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['SC_Ind_Groupby']];
           }
       }
       else
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['Page_break_PDF'] = array();
       }
   }
   $this->SC_top       = array();
   $this->SC_bot       = array();
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['SC_Ind_Groupby'] == "sc_free_group_by") 
   {
       ...
       $this->Nivel_gbBot = count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['SC_Gb_Free_cmp']);
   ...
   $nm_houve_quebra = "N";
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          ...
          //---------- Gauge ----------
          if (!$this->Ini->sc_export_ajax && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
              if (0 == $this->progress_lim_now)
              {
               ...
               if (!NM_is_utf8($lang_protect))
               {
                  ...
                  grid_jap_seleccionar_contrato_corte_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $lang_protect . " " . $this->progress_now . "...\n", $this->Ini->Nm_lang);
          ...
          $this->arg_sum_con_ruta = ($this->con_ruta == "") ? " is null " : " = " . $this->con_ruta;
          $this->SC_seq_page++; 
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['final'] + 1; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['rows_emb']++;
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['SC_Ind_Groupby'] == "sc_free_group_by") 
          {  
              $SC_arg_Gby = array();
              ...
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['SC_Gb_Free_cmp'] as $cmp => $sql)
              {
                  $Format_tst = $this->Ini->Get_Gb_date_format('sc_free_group_by', $cmp);
                  $SC_arg_Sql[$cmp] = $sql;
                  $Fun_GB  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['SC_Gb_Free_orig'][$cmp])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['SC_Gb_Free_orig'][$cmp] : $cmp;
                  if (!empty($Format_tst))
                  {
                      $temp = $this->$cmp;
                      if (!empty($temp))
              ...
              foreach ($SC_lst_Gby as $Ind => $cmp)
              {
                  ...
                  $sql_where = "";
                  $cmp_qb     = $this->$cmp;
                  foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['SC_Gb_Free_cmp'] as $Col_Gb => $Sql)
                  {
                      $tmp        = "arg_sum_" . $Col_Gb;
                      $sql_where .= (!empty($sql_where)) ? " and " : "";
              ...
              {
                  $cmp = $SC_lst_Gby[0];
                  if ($this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['doc_word'] && $this->Break_pag_prt[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['SC_Ind_Groupby']][$cmp] == "S" && $Qb_page)
                  {
                      $this->nm_quebra_pagina("pagina"); 
                  }
                  elseif (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['Page_break_PDF'][$cmp] == "S" && $Qb_page)
                  {
                      $this->nm_quebra_pagina("pagina"); 
                  }
                  $Qb_page = false;
...
$_SESSION['scriptcase']['grid_jap_seleccionar_contrato_corte']['contr_erro'] = 'off';
          ...
          else
          {
              ...
              {
                  if ($this->nm_inicio_pag == 0 && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida_grid'])
                  {
                      $nm_houve_quebra = "N";
                  } 
              } 
              elseif (($nm_houve_quebra == "S" || ($this->nm_inicio_pag == 0)) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida_grid'])
              { 
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida_opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['dado_psq_ret'];
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida_grid']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"display:" . $FieldDisp . ";" . $this->Css_Cmp['css_con_id_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"   HEIGHT=\"0px\">&nbsp;</TD>\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opc_psq']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  style=\"display:" . $FieldDisp . ";" . $this->Css_Cmp['css_con_id_grid_line'] . "\" NOWRAP align=\"left\" valign=\"top\" WIDTH=\"1px\"  HEIGHT=\"0px\">\r\n");
 $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcapture", "document.Fpesq.nm_ret_psq.value='" . str_replace(array("'", '"'), array("\'", '\"'), $teste) . "'; nm_escreve_window();", "document.Fpesq.nm_ret_psq.value='" . str_replace(array("'", '"'), array("\'", '\"'), $teste) . "'; nm_escreve_window();", "", "Rad_psq", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
   ...
   $this->SC_grid_rightActionBar();
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['exibe_total'] == "S")
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
       } 
   }  
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida_grid'])
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
       $this->sumario_mobile() ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida_grid'])
...
function SC_grid_rightActionBar()
{
 ...
 function NM_grid_con_ruta()
 {
      ...
      if (!isset($this->NM_cmp_hidden['con_ruta']) || $this->NM_cmp_hidden['con_ruta'] != "off") { 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida'] && !empty($conteudo)) 
          { 
 ...
 function NM_grid_cl_nombre()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['cl_nombre']) || $this->NM_cmp_hidden['cl_nombre'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_inherit_bg . ' ' . $this->css_line_fonf . $this->css_sep . $this->css_cl_nombre_grid_line . " " . $classColFld . "\"  style=\"" . $this->Css_Cmp['css_cl_nombre_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_cl_nombre_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 ...
 function NM_grid_seleccionar()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_inherit_bg . ' ' . $this->css_line_fonf . $this->css_sep . $this->css_seleccionar_grid_line . " " . $classColFld . "\"  style=\"display:" . $FieldDisp . ";" . $this->Css_Cmp['css_seleccionar_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  ><span id=\"id_sc_field_seleccionar_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
 }
 ...
 function NM_grid_con_id()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_inherit_bg . ' ' . $this->css_line_fonf . $this->css_sep . $this->css_con_id_grid_line . " " . $classColFld . "\"  style=\"display:" . $FieldDisp . ";" . $this->Css_Cmp['css_con_id_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_con_id_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
 }
 ...
 function nm_quebra_pagina($nm_parms)
 {
    ...
    if (($this->Ini->nm_limite_lin > 0 && $this->Ini->nm_cont_lin > $this->Ini->nm_limite_lin) || $nm_parms == "pagina" || $nm_parms == "resumo" || $nm_parms == "total")
    {
        ...
        if ($this->Print_All)
        {
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['print_navigator']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['print_navigator'] == "Netscape")
            {
        ...
        if ($nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida'])
        {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['proc_pdf']) { 
           }
           else
           {
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['proc_pdf_vert']) { 
                $nm_saida->saida("     <thead>\r\n");
               }
               $this->cabecalho();
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['proc_pdf_vert']) { 
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['proc_pdf'] && ($this->pdf_all_cab == "S" || $this->pdf_all_label == "S")) { 
            $nm_saida->saida(" <thead> \r\n");
            if ($this->pdf_all_cab == "S")
            {
                $this->cabecalho();
            }
            if ($this->pdf_all_label == "S" && $nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida_grid'])
            {
                $this->label_grid();
            }
            $nm_saida->saida(" </thead> \r\n");
        }
        if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['proc_pdf'] && $nm_parms != "resumo" && $nm_parms != "pagina" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida_grid'])
        {
            $this->label_grid();
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['proc_pdf'] && $this->pdf_label_group != "S" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida_grid'])
        {
            $this->nm_inicio_pag = 0;
        }
    }
 ...
 function quebra_con_ruta_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   $tot_con_ruta = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['con_ruta'] : 0;
   ...
   $link_div   = "";
   $link_div_2 = "";
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ind_tree'];
       ...
       $link_div .= "<img id=\"b_open_grid_jap_seleccionar_contrato_corte_" . $this->NM_cont_body . "\" style=\"display:none\" onclick=\"document.getElementById('b_open_grid_jap_seleccionar_contrato_corte_" . $this->NM_cont_body . "').style.display = 'none'; document.getElementById('b_close_grid_jap_seleccionar_contrato_corte_" . $this->NM_cont_body . "').style.display = ''; NM_liga_tbody(" . $this->NM_cont_body . ", NM_tab_grid_jap_seleccionar_contrato_corte, 'grid_jap_seleccionar_contrato_corte'); return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_exp . "\">";
       $link_div .= "<img id=\"b_close_grid_jap_seleccionar_contrato_corte_" . $this->NM_cont_body . "\" style=\"display:''\" onclick=\"document.getElementById('b_close_grid_jap_seleccionar_contrato_corte_" . $this->NM_cont_body . "').style.display = 'none'; document.getElementById('b_open_grid_jap_seleccionar_contrato_corte_" . $this->NM_cont_body . "').style.display = ''; NM_apaga_tbody(" . $this->NM_cont_body . ", NM_tab_grid_jap_seleccionar_contrato_corte, 'grid_jap_seleccionar_contrato_corte'); return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_col . "\">";
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_jap_seleccionar_contrato_corte'][$this->NM_cont_body][$this->Tab_Nv_tree['con_ruta']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_jap_seleccionar_contrato_corte_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   $this->NM_calc_span();
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['con_ruta'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_jap_seleccionar_contrato_corte'][$this->NM_cont_body][$this->Tab_Nv_tree['con_ruta']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_grid_jap_seleccionar_contrato_corte_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
 ...
 { global $nm_saida, $nm_lang; 
   ...
   $nm_sumario = str_replace("?final?", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['final'], $nm_sumario);
...
$nm_saida->saida("    </style>\r\n");
      ...
      if ($this->nmgp_botoes['group_1'] == "on" && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("           $Cod_Btn\r\n");
      if ($this->nmgp_botoes['pdf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      ...
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_word_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "grid_jap_seleccionar_contrato_corte/grid_jap_seleccionar_contrato_corte_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=" . $Tem_word_res . "&nm_ini_word_res=grid&nm_all_modules=grid&password=n&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_xls_res = "n";
          $Tem_xls_res = "s";
          ...
          $nm_saida->saida("            <div id=\"div_xls_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "xls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_jap_seleccionar_contrato_corte/grid_jap_seleccionar_contrato_corte_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_jap_seleccionar_contrato_corte&nm_tp_xls=xlsx&nm_tot_xls=S&nm_res_cons=" . $Tem_xls_res . "&nm_ini_xls_res=grid&nm_all_modules=grid&password=n&summary_export_columns=S&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['print'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Tem_pdf_res = "n";
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div id=\"div_print_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $this->nm_btn_exist['print'][] = "print_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "print_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + P)", "thickbox", "" . $this->Ini->path_link . "grid_jap_seleccionar_contrato_corte/grid_jap_seleccionar_contrato_corte_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=RC&nm_cor=CO&password=n&language=es&nm_page=" . NM_encode_input($this->Ini->sc_page) . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_prt_res=grid&nm_all_modules=grid&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['sel_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      $pos_path = strrpos($this->Ini->path_prod, "/");
      $path_fields = $this->Ini->root . substr($this->Ini->path_prod, 0, $pos_path) . "/conf/fields/";
              $this->nm_btn_exist['sel_col'][] = "selcmp_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcolumns", "scBtnSelCamposShow('" . $this->Ini->path_link . "grid_jap_seleccionar_contrato_corte/grid_jap_seleccionar_contrato_corte_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnSelCamposShow('" . $this->Ini->path_link . "grid_jap_seleccionar_contrato_corte/grid_jap_seleccionar_contrato_corte_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "selcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['filter'] == "on"  && !$this->grid_emb_form && !$this->NM_hidden_filters)
      {
           ...
           $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpesquisa", "", "", "pesq_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + F)", "thickbox", "" . $this->Ini->path_link . "grid_jap_seleccionar_contrato_corte/grid_jap_seleccionar_contrato_corte.php?script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&nmgp_opcao=busca&nmgp_orig_pesq=grid&KeepThis=true&TB_iframe=true&height=300&width=600&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
           $nm_saida->saida("           $Cod_Btn \r\n");
           $NM_btn = true;
      }
      if (is_file($this->Ini->root . $this->Ini->path_img_global . $this->Ini->Img_sep_grid))
      {
          ...
          if (is_file("grid_jap_seleccionar_contrato_corte_help.txt") && !$this->grid_emb_form)
          {
             $Arq_WebHelp = file("grid_jap_seleccionar_contrato_corte_help.txt"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['dashboard_info']['under_dashboard']))
      {
         $this->nmgp_botoes['exit'] = "off"; 
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opc_psq'])
      ...
      {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['sc_modal'])
        {
...
$nm_saida->saida("    </style>\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao_print'] != "print") 
      {
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['qtline'] == "on" && $this->Ini->Apl_paginacao != "FULL")
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['qt_lin_grid'] == '10') ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['qt_lin_grid'] == '20') ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['qt_lin_grid'] == '50') ? " selected" : "";
              $nm_saida->saida("           <option value=\"50\" " . $obj_sel . ">50</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['qt_lin_grid'] == 'all') ? " selected" : "";
      ...
      if (is_file($this->Ini->root . $this->Ini->path_img_global . $this->Ini->Img_sep_grid))
      {
          ...
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opc_liga']['nav']))
          {
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['navpage'] == "on" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opc_liga']['nav']) && $this->Ini->Apl_paginacao != "FULL" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['qt_lin_grid'] != "all")
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['qt_lin_grid'];
              $Max_link   = 5;
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opc_liga']['nav']))
          {
...
$nm_saida->saida("    </style>\r\n");
      ...
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_word_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $this->nm_btn_exist['word'][] = "word_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "grid_jap_seleccionar_contrato_corte/grid_jap_seleccionar_contrato_corte_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=" . $Tem_word_res . "&nm_ini_word_res=grid&nm_all_modules=grid&password=n&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_4", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['filter'] == "on"  && !$this->grid_emb_form && !$this->NM_hidden_filters)
      {
          ...
          $nm_saida->saida("            <div id=\"div_pesq_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
           $this->nm_btn_exist['filter'][] = "pesq_top";
           $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpesquisa", "", "", "pesq_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + F)", "thickbox", "" . $this->Ini->path_link . "grid_jap_seleccionar_contrato_corte/grid_jap_seleccionar_contrato_corte.php?script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&nmgp_opcao=busca&nmgp_orig_pesq=grid&KeepThis=true&TB_iframe=true&height=300&width=600&modal=true", "group_5", "only_text", "text_right", "", "", "", "", "", "", "");
           $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
           $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['sort_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_5_top = true;</script>\r\n");
          ...
          $nm_saida->saida("            <div id=\"div_ordcmp_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bsort", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_jap_seleccionar_contrato_corte/grid_jap_seleccionar_contrato_corte_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_jap_seleccionar_contrato_corte/grid_jap_seleccionar_contrato_corte_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "ordcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_5", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_5_top = true;</script>\r\n");
          $nm_saida->saida("            <div id=\"div_sel_groupby_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['SC_Groupby_hide']))
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_jap_seleccionar_contrato_corte/grid_jap_seleccionar_contrato_corte_sel_groupby.php?opc_ret=igual&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_jap_seleccionar_contrato_corte/grid_jap_seleccionar_contrato_corte_sel_groupby.php?opc_ret=igual&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_5", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
          }
   ...
   function html_grid_search()
   {
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['grid_pesq'])?'none':'';
       if(!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['ajax_nav'])
       {
       ...
       else
       {
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['save_grid']))
           {
               $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['grid_pesq']) ? 'none' : '';
               $this->Ini->Arr_result['setDisplay'][] = array('field' => 'NM_Grid_Search', 'value' => $str_display);
           }
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['grid_pesq']))
           { 
   ...
   {
       global $nm_saida;
       $this->Cmps_select2_grid = array('con_ruta');
       $lin_obj  = "";
   ...
   {
       $lin_obj  = "";
       $All_cmp_search = array('con_ruta','con_numero_contrato','meses_deuda');
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['pesq_tab_label'];
       if (!empty($nmgp_tab_label))
       {
          $nm_tab_campos = explode("?@?", $nmgp_tab_label);
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['grid_pesq']) && count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['grid_pesq']) < 3)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
   ...
   function grid_search_con_ruta($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['psq_check_ret']['con_ruta'] = array();
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['psq_check_ret']['con_ruta'][] = trim($rs->fields[0]);
   ...
   function grid_search_con_numero_contrato($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_con_numero_contrato_val_" . $ind . "' name='val_grid_search_con_numero_contrato_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=25 alt=\"{datatype: 'text', maxLength: 25, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\">";
       $lin_obj .= "       </span>";
       $lin_obj .= "          </div>";
       $lin_obj .= "          <div class='scGridFilterTagListFilterBar'>";
       $lin_obj .= nmButtonOutput($this->arr_buttons, "bapply_appdiv", "closeAllTags();setTimeout(function() {nm_proc_grid_search($ind, 'proc_grid_search', 'grid_search')}, 200);", "closeAllTags();setTimeout(function() {nm_proc_grid_search($ind, 'proc_grid_search', 'grid_search')}, 200);", "grid_search_apply_" . $ind . "", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
   ...
   function grid_search_meses_deuda($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $lin_obj .= "       <select id='grid_search_meses_deuda_cond_" . $ind . "' name='cond_grid_search_meses_deuda_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle; display: none'>";
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "SIJAP/grid_jap_seleccionar_contrato_corte";
   ...
   function JS_grid_search()
   {
    ...
    function getFieldHighlight($filter_type, $field, $str_value, $str_value_original='')
    {
        ...
        {
            if (
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['campos_busca'][ $field ]) &&
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['campos_busca'][ $field . "_cond" ]) &&
                !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['campos_busca'][ $field ]) &&
                (
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['campos_busca'][ $field . "_cond"] == 'qp' ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['campos_busca'][ $field . "_cond"] == 'eq' ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['campos_busca'][ $field . "_cond"] == 'ii'
                )
            )
            {
                if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['campos_busca'][ $field . "_cond"] == 'qp')
                {
                    if(is_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['campos_busca'][ $field ]))
                    {
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['campos_busca'][ $field ] as $ind => $vals)
                        {
                    ...
                    {
                        if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['campos_busca'][ $field ], $str_value) == 0)
                        {
                            $str_value = $str_html_ini. $str_value .$str_html_fim;
                        }
                        elseif(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['campos_busca'][ $field ], $str_value_original) == 0)
                        {
                            $str_value = $str_html_ini. $str_value .$str_html_fim;
                        }
                        else
                        {
                            $keywords = preg_quote($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['campos_busca'][ $field ], '/');
                            $str_value = preg_replace('/'. $keywords .'/i', $str_html_ini . '$0' . $str_html_fim, $str_value);
                        }
                    }
                }
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['campos_busca'][ $field . "_cond"] == 'eq')
                {
                    if(is_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['campos_busca'][ $field ]))
                    {
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['campos_busca'][ $field ] as $ind => $vals)
                ...
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['campos_busca'][ $field . "_cond"] == 'ii')
                {
                    if(is_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['campos_busca'][ $field ]))
                    {
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['campos_busca'][ $field ] as $ind => $vals)
                    ...
                    {
                        if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['campos_busca'][ $field ], substr($str_value, 0, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['campos_busca'][ $field ]))) == 0)
                        {
                            $str_value = $str_html_ini. substr($str_value, 0, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['campos_busca'][ $field ])) .$str_html_fim . substr($str_value, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['campos_busca'][ $field ]));
                        }
                    }
                }
            }
        ...
        {
            if(
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['fast_search'][0]) &&
                (
                    (
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['fast_search'][0] == 'SC_all_Cmp' &&
                    in_array($field, array(''))
                    ) ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['fast_search'][0] == $field ||
                    strpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['fast_search'][0], $field . '_VLS_') !== false ||
                    strpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['fast_search'][0], '_VLS_' . $field) !== false
                )
            )
            {
                if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['fast_search'][1] == 'qp')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['fast_search'][2], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    elseif(!empty($str_value_original) && $str_value_original != '&nbsp;' && strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['fast_search'][2], $str_value_original) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    else
                    {
                        $keywords = preg_quote($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['fast_search'][2], '/');
                        $str_value = preg_replace('/'. $keywords .'/i', $str_html_ini . '$0' . $str_html_fim, $str_value);
                    }
                }
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['fast_search'][1] == 'eq')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['fast_search'][2], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   ...
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
   } 
   ...
   $nm_saida->saida("   if (typeof(scSetFixedHeaders) === typeof(function(){})) scSetFixedHeaders();\r\n");
   $nm_saida->saida("  });\r\n");
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
       } 
   ...
   if ($this->grid_emb_form || $this->grid_emb_form_full)
   {
       ...
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_jap_seleccionar_contrato_corte', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"grid_jap_seleccionar_contrato_corte\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"grid_jap_seleccionar_contrato_corte_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("                     action=\"grid_jap_seleccionar_contrato_corte_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_jap_seleccionar_contrato_corte/grid_jap_seleccionar_contrato_corte_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
   ...
   $nm_saida->saida("           document.Fdoc_word.action = \"grid_jap_seleccionar_contrato_corte_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("           document.F3.SC_module_export.value = z;\r\n");
   $nm_saida->saida("       }\r\n");
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['grid_jap_seleccionar_contrato_corte_iframe_params'] = array(
   ...
   $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_jap_seleccionar_contrato_corte@SC_par@" . md5($prep_parm_pdf);
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   $nm_saida->saida("               document.Fpdf.action=\"grid_jap_seleccionar_contrato_corte_iframe.php\";\r\n");
   ...
   $nm_saida->saida("               document.Fprint.action = \"grid_jap_seleccionar_contrato_corte_export_ctrl.php\";\r\n");
   $nm_saida->saida("           }\r\n");
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   ...
   $nm_saida->saida("           document.Fexport.action = \"grid_jap_seleccionar_contrato_corte_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['campo_psq_ret']) )
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['grid_jap_seleccionar_contrato_corte']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form  = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Form1 = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("           var Obj_Doc   = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form  = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Form1 = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("          var Obj_Doc   = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form  = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Form1 = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['campo_psq_ret']) . ";\r\n");
          $nm_saida->saida("          var Obj_Doc   = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"grid_jap_seleccionar_contrato_corte_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_seleccionar_contrato_corte']['reg_start']))
   {
       $nm_saida->saida("      $(document).ready(function(){\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailStatus('grid_jap_seleccionar_contrato_corte')\",50);\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_jap_seleccionar_contrato_corte', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      })\r\n");
   }
