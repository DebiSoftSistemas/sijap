...
var var_btn_imprimir_var_salida = "<?php echo $this->form_encode_input($this->nmgp_dados_form['aj_id']); ?>";
...
{
  nm_gp_submit('<?php echo $this->Ini->link_form_jap_ajuste_inventario_pdf; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "var_salida*scin' + var_btn_imprimir_var_salida + '*scout"; ?>', '', '_blank', '0', '0', 'form_jap_ajuste_inventario_pdf');
}
 NM_tp_critica(1);
