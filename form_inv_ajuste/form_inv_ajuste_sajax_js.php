  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_inv_ajuste" == sTestField)
        {
...
?>
  ...
  // ---------- Validate aj_id
  function do_ajax_form_inv_ajuste_validate_aj_id()
  {
    var nomeCampo_aj_id = "aj_id";
    var var_aj_id = scAjaxGetFieldHidden(nomeCampo_aj_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_ajuste_validate_aj_id(var_aj_id, var_script_case_init, do_ajax_form_inv_ajuste_validate_aj_id_cb);
  } // do_ajax_form_inv_ajuste_validate_aj_id

  function do_ajax_form_inv_ajuste_validate_aj_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_ajuste_validate_aj_id_cb

  // ---------- Validate aj_fecha
  function do_ajax_form_inv_ajuste_validate_aj_fecha()
  {
    var nomeCampo_aj_fecha = "aj_fecha";
    var var_aj_fecha = scAjaxGetFieldText(nomeCampo_aj_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_ajuste_validate_aj_fecha(var_aj_fecha, var_script_case_init, do_ajax_form_inv_ajuste_validate_aj_fecha_cb);
  } // do_ajax_form_inv_ajuste_validate_aj_fecha

  function do_ajax_form_inv_ajuste_validate_aj_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_ajuste_validate_aj_fecha_cb

  // ---------- Validate aj_tipo_ajuste
  function do_ajax_form_inv_ajuste_validate_aj_tipo_ajuste()
  {
    var nomeCampo_aj_tipo_ajuste = "aj_tipo_ajuste";
    var var_aj_tipo_ajuste = scAjaxGetFieldSelect(nomeCampo_aj_tipo_ajuste);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_ajuste_validate_aj_tipo_ajuste(var_aj_tipo_ajuste, var_script_case_init, do_ajax_form_inv_ajuste_validate_aj_tipo_ajuste_cb);
  } // do_ajax_form_inv_ajuste_validate_aj_tipo_ajuste

  function do_ajax_form_inv_ajuste_validate_aj_tipo_ajuste_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_ajuste_validate_aj_tipo_ajuste_cb

  // ---------- Validate aj_bodega
  function do_ajax_form_inv_ajuste_validate_aj_bodega()
  {
    var nomeCampo_aj_bodega = "aj_bodega";
    var var_aj_bodega = scAjaxGetFieldSelect(nomeCampo_aj_bodega);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_ajuste_validate_aj_bodega(var_aj_bodega, var_script_case_init, do_ajax_form_inv_ajuste_validate_aj_bodega_cb);
  } // do_ajax_form_inv_ajuste_validate_aj_bodega

  function do_ajax_form_inv_ajuste_validate_aj_bodega_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_ajuste_validate_aj_bodega_cb

  // ---------- Validate aj_info_adicional
  function do_ajax_form_inv_ajuste_validate_aj_info_adicional()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_ajuste_validate_aj_info_adicional(var_aj_info_adicional, var_script_case_init, do_ajax_form_inv_ajuste_validate_aj_info_adicional_cb);
  } // do_ajax_form_inv_ajuste_validate_aj_info_adicional

  function do_ajax_form_inv_ajuste_validate_aj_info_adicional_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_ajuste_validate_aj_info_adicional_cb

  // ---------- Validate aj_estado
  function do_ajax_form_inv_ajuste_validate_aj_estado()
  {
    var nomeCampo_aj_estado = "aj_estado";
    var var_aj_estado = scAjaxGetFieldSelect(nomeCampo_aj_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_ajuste_validate_aj_estado(var_aj_estado, var_script_case_init, do_ajax_form_inv_ajuste_validate_aj_estado_cb);
  } // do_ajax_form_inv_ajuste_validate_aj_estado

  function do_ajax_form_inv_ajuste_validate_aj_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_ajuste_validate_aj_estado_cb

  // ---------- Validate aj_usuario
  function do_ajax_form_inv_ajuste_validate_aj_usuario()
  {
    var nomeCampo_aj_usuario = "aj_usuario";
    var var_aj_usuario = scAjaxGetFieldText(nomeCampo_aj_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_ajuste_validate_aj_usuario(var_aj_usuario, var_script_case_init, do_ajax_form_inv_ajuste_validate_aj_usuario_cb);
  } // do_ajax_form_inv_ajuste_validate_aj_usuario

  function do_ajax_form_inv_ajuste_validate_aj_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_ajuste_validate_aj_usuario_cb

  // ---------- Validate aj_empresa
  function do_ajax_form_inv_ajuste_validate_aj_empresa()
  {
    var nomeCampo_aj_empresa = "aj_empresa";
    var var_aj_empresa = scAjaxGetFieldText(nomeCampo_aj_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_ajuste_validate_aj_empresa(var_aj_empresa, var_script_case_init, do_ajax_form_inv_ajuste_validate_aj_empresa_cb);
  } // do_ajax_form_inv_ajuste_validate_aj_empresa

  function do_ajax_form_inv_ajuste_validate_aj_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_ajuste_validate_aj_empresa_cb

  // ---------- Validate detalle
  function do_ajax_form_inv_ajuste_validate_detalle()
  {
    var nomeCampo_detalle = "detalle";
    var var_detalle = scAjaxGetFieldText(nomeCampo_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_ajuste_validate_detalle(var_detalle, var_script_case_init, do_ajax_form_inv_ajuste_validate_detalle_cb);
  } // do_ajax_form_inv_ajuste_validate_detalle

  function do_ajax_form_inv_ajuste_validate_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detalle";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_ajuste_validate_detalle_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_inv_ajuste_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_inv_ajuste_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_inv_ajuste_submit_form(var_aj_id, var_aj_fecha, var_aj_tipo_ajuste, var_aj_bodega, var_aj_info_adicional, var_aj_estado, var_aj_usuario, var_aj_empresa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_inv_ajuste_submit_form_cb);
  } // do_ajax_form_inv_ajuste_submit_form

  function do_ajax_form_inv_ajuste_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_inv_ajuste_submit_form_cb_after_alert);
  } // do_ajax_form_inv_ajuste_submit_form_cb
  function do_ajax_form_inv_ajuste_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_inv_ajuste_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_inv_productos_ajuste"] = "off";

  function do_ajax_form_inv_ajuste_navigate_form()
  {
    perform_ajax_form_inv_ajuste_navigate_form();
  }

  function perform_ajax_form_inv_ajuste_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_inv_productos_ajuste"] = "on";
    x_ajax_form_inv_ajuste_navigate_form(var_aj_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_inv_ajuste_navigate_form_cb);
  } // do_ajax_form_inv_ajuste_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_ajuste']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_inv_ajuste_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_inv_productos_ajuste"] && "nmsc_iframe_liga_form_inv_productos_ajuste" != scMasterDetailIframe["nmsc_iframe_liga_form_inv_productos_ajuste"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_inv_productos_ajuste"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_inv_productos_ajuste').contentWindow.nm_move('apl_detalhe', true, '300');
        document.getElementById('nmsc_iframe_liga_form_inv_productos_ajuste').style.height = "300";
        document.getElementById('nmsc_iframe_liga_form_inv_productos_ajuste').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_inv_ajuste_navigate_form_cb_after_alert);
  } // do_ajax_form_inv_ajuste_navigate_form_cb
  function do_ajax_form_inv_ajuste_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_inv_ajuste_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_inv_ajuste_navigate_form_cb_after_alert

  function sc_hide_form_inv_ajuste_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_inv_productos_ajuste"])
    {
      return true;
    }
    return false;
