  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_inv_ajuste_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_inv_ajuste_mob_form();
	}
...
?>
  ...
  // ---------- Validate aj_id
  function do_ajax_form_inv_ajuste_mob_validate_aj_id()
  {
    var nomeCampo_aj_id = "aj_id";
    var var_aj_id = scAjaxGetFieldHidden(nomeCampo_aj_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_ajuste_mob_validate_aj_id(var_aj_id, var_script_case_init, do_ajax_form_inv_ajuste_mob_validate_aj_id_cb);
  } // do_ajax_form_inv_ajuste_mob_validate_aj_id

  function do_ajax_form_inv_ajuste_mob_validate_aj_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_ajuste_mob_validate_aj_id_cb

  // ---------- Validate aj_fecha
  function do_ajax_form_inv_ajuste_mob_validate_aj_fecha()
  {
    var nomeCampo_aj_fecha = "aj_fecha";
    var var_aj_fecha = scAjaxGetFieldText(nomeCampo_aj_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_ajuste_mob_validate_aj_fecha(var_aj_fecha, var_script_case_init, do_ajax_form_inv_ajuste_mob_validate_aj_fecha_cb);
  } // do_ajax_form_inv_ajuste_mob_validate_aj_fecha

  function do_ajax_form_inv_ajuste_mob_validate_aj_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "aj_fecha";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_ajuste_mob_validate_aj_fecha_cb

  // ---------- Validate aj_tipo_ajuste
  function do_ajax_form_inv_ajuste_mob_validate_aj_tipo_ajuste()
  {
    var nomeCampo_aj_tipo_ajuste = "aj_tipo_ajuste";
    var var_aj_tipo_ajuste = scAjaxGetFieldSelect(nomeCampo_aj_tipo_ajuste);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_ajuste_mob_validate_aj_tipo_ajuste(var_aj_tipo_ajuste, var_script_case_init, do_ajax_form_inv_ajuste_mob_validate_aj_tipo_ajuste_cb);
  } // do_ajax_form_inv_ajuste_mob_validate_aj_tipo_ajuste

  function do_ajax_form_inv_ajuste_mob_validate_aj_tipo_ajuste_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "aj_tipo_ajuste";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_ajuste_mob_validate_aj_tipo_ajuste_cb

  // ---------- Validate aj_bodega
  function do_ajax_form_inv_ajuste_mob_validate_aj_bodega()
  {
    var nomeCampo_aj_bodega = "aj_bodega";
    var var_aj_bodega = scAjaxGetFieldSelect(nomeCampo_aj_bodega);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_ajuste_mob_validate_aj_bodega(var_aj_bodega, var_script_case_init, do_ajax_form_inv_ajuste_mob_validate_aj_bodega_cb);
  } // do_ajax_form_inv_ajuste_mob_validate_aj_bodega

  function do_ajax_form_inv_ajuste_mob_validate_aj_bodega_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "aj_bodega";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_ajuste_mob_validate_aj_bodega_cb

  // ---------- Validate aj_info_adicional
  function do_ajax_form_inv_ajuste_mob_validate_aj_info_adicional()
  {
    var nomeCampo_aj_info_adicional = "aj_info_adicional";
    var var_aj_info_adicional = scAjaxGetFieldText(nomeCampo_aj_info_adicional);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_ajuste_mob_validate_aj_info_adicional(var_aj_info_adicional, var_script_case_init, do_ajax_form_inv_ajuste_mob_validate_aj_info_adicional_cb);
  } // do_ajax_form_inv_ajuste_mob_validate_aj_info_adicional

  function do_ajax_form_inv_ajuste_mob_validate_aj_info_adicional_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "aj_info_adicional";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_ajuste_mob_validate_aj_info_adicional_cb

  // ---------- Validate aj_estado
  function do_ajax_form_inv_ajuste_mob_validate_aj_estado()
  {
    var nomeCampo_aj_estado = "aj_estado";
    var var_aj_estado = scAjaxGetFieldSelect(nomeCampo_aj_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_ajuste_mob_validate_aj_estado(var_aj_estado, var_script_case_init, do_ajax_form_inv_ajuste_mob_validate_aj_estado_cb);
  } // do_ajax_form_inv_ajuste_mob_validate_aj_estado

  function do_ajax_form_inv_ajuste_mob_validate_aj_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "aj_estado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_ajuste_mob_validate_aj_estado_cb

  // ---------- Validate aj_usuario
  function do_ajax_form_inv_ajuste_mob_validate_aj_usuario()
  {
    var nomeCampo_aj_usuario = "aj_usuario";
    var var_aj_usuario = scAjaxGetFieldText(nomeCampo_aj_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_ajuste_mob_validate_aj_usuario(var_aj_usuario, var_script_case_init, do_ajax_form_inv_ajuste_mob_validate_aj_usuario_cb);
  } // do_ajax_form_inv_ajuste_mob_validate_aj_usuario

  function do_ajax_form_inv_ajuste_mob_validate_aj_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "aj_usuario";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_ajuste_mob_validate_aj_usuario_cb

  // ---------- Validate aj_empresa
  function do_ajax_form_inv_ajuste_mob_validate_aj_empresa()
  {
    var nomeCampo_aj_empresa = "aj_empresa";
    var var_aj_empresa = scAjaxGetFieldText(nomeCampo_aj_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_ajuste_mob_validate_aj_empresa(var_aj_empresa, var_script_case_init, do_ajax_form_inv_ajuste_mob_validate_aj_empresa_cb);
  } // do_ajax_form_inv_ajuste_mob_validate_aj_empresa

  function do_ajax_form_inv_ajuste_mob_validate_aj_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "aj_empresa";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_ajuste_mob_validate_aj_empresa_cb

  // ---------- Validate detalle
  function do_ajax_form_inv_ajuste_mob_validate_detalle()
  {
    var nomeCampo_detalle = "detalle";
    var var_detalle = scAjaxGetFieldText(nomeCampo_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_ajuste_mob_validate_detalle(var_detalle, var_script_case_init, do_ajax_form_inv_ajuste_mob_validate_detalle_cb);
  } // do_ajax_form_inv_ajuste_mob_validate_detalle

  function do_ajax_form_inv_ajuste_mob_validate_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detalle";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_ajuste_mob_validate_detalle_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_inv_ajuste_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_inv_ajuste_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_aj_id = scAjaxGetFieldHidden("aj_id");
    var var_aj_fecha = scAjaxGetFieldText("aj_fecha");
    var var_aj_tipo_ajuste = scAjaxGetFieldSelect("aj_tipo_ajuste");
    var var_aj_bodega = scAjaxGetFieldSelect("aj_bodega");
    var var_aj_info_adicional = scAjaxGetFieldText("aj_info_adicional");
    var var_aj_estado = scAjaxGetFieldSelect("aj_estado");
    var var_aj_usuario = scAjaxGetFieldText("aj_usuario");
    var var_aj_empresa = scAjaxGetFieldText("aj_empresa");
    ...
    scAjaxProcOn();
    x_ajax_form_inv_ajuste_mob_submit_form(var_aj_id, var_aj_fecha, var_aj_tipo_ajuste, var_aj_bodega, var_aj_info_adicional, var_aj_estado, var_aj_usuario, var_aj_empresa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_inv_ajuste_mob_submit_form_cb);
  } // do_ajax_form_inv_ajuste_mob_submit_form

  function do_ajax_form_inv_ajuste_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("aj_id");
      scAjaxHideErrorDisplay("aj_fecha");
      scAjaxHideErrorDisplay("aj_tipo_ajuste");
      scAjaxHideErrorDisplay("aj_bodega");
      scAjaxHideErrorDisplay("aj_info_adicional");
      scAjaxHideErrorDisplay("aj_estado");
      scAjaxHideErrorDisplay("aj_usuario");
      scAjaxHideErrorDisplay("aj_empresa");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_inv_ajuste_mob_submit_form_cb_after_alert);
  } // do_ajax_form_inv_ajuste_mob_submit_form_cb
  function do_ajax_form_inv_ajuste_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_inv_ajuste_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_inv_productos_ajuste_mob"] = "off";

  function do_ajax_form_inv_ajuste_mob_navigate_form()
  {
    perform_ajax_form_inv_ajuste_mob_navigate_form();
  }

  function perform_ajax_form_inv_ajuste_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("aj_empresa");
    scAjaxHideErrorDisplay("detalle");
    var var_aj_id = document.F2.aj_id.value;
    ...
    scAjaxProcOn();
    scStatusDetail["form_inv_productos_ajuste_mob"] = "on";
    x_ajax_form_inv_ajuste_mob_navigate_form(var_aj_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_inv_ajuste_mob_navigate_form_cb);
  } // do_ajax_form_inv_ajuste_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_ajuste_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_inv_ajuste_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.aj_id.value = scAjaxGetKeyValue("aj_id");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_inv_productos_ajuste_mob"] && "nmsc_iframe_liga_form_inv_productos_ajuste_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_inv_productos_ajuste_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_inv_productos_ajuste_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_inv_productos_ajuste_mob').contentWindow.nm_move('apl_detalhe', true, '300');
        document.getElementById('nmsc_iframe_liga_form_inv_productos_ajuste_mob').style.height = "300";
        document.getElementById('nmsc_iframe_liga_form_inv_productos_ajuste_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_inv_ajuste_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_inv_ajuste_mob_navigate_form_cb
  function do_ajax_form_inv_ajuste_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_inv_ajuste_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_inv_ajuste_mob_navigate_form_cb_after_alert

  function sc_hide_form_inv_ajuste_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_inv_productos_ajuste_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "aj_id";
  ajax_field_list[1] = "aj_fecha";
  ajax_field_list[2] = "aj_tipo_ajuste";
  ajax_field_list[3] = "aj_bodega";
  ajax_field_list[4] = "aj_info_adicional";
  ajax_field_list[5] = "aj_estado";
  ajax_field_list[6] = "aj_usuario";
  ajax_field_list[7] = "aj_empresa";
  ajax_field_list[8] = "detalle";
  ...
  var ajax_error_list = {
    "aj_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "aj_fecha": {"label": "<?php echo $this->Ini->Nm_lang['lang_fecha'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "aj_tipo_ajuste": {"label": "<?php echo $this->Ini->Nm_lang['lang_tipo_ajuste'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "aj_bodega": {"label": "<?php echo $this->Ini->Nm_lang['lang_bodega'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "aj_info_adicional": {"label": "<?php echo $this->Ini->Nm_lang['lang_inf_adicional'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "aj_estado": {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "aj_usuario": {"label": "<?php echo $this->Ini->Nm_lang['lang_usuario'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "aj_empresa": {"label": "<?php echo $this->Ini->Nm_lang['lang_empresa'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "aj_id": new Array(),
    "aj_fecha": new Array(),
    "aj_tipo_ajuste": new Array(),
    "aj_bodega": new Array(),
    "aj_info_adicional": new Array(),
    "aj_estado": new Array(),
    "aj_usuario": new Array(),
    "aj_empresa": new Array(),
    "detalle": new Array()
  };
  ajax_field_mult["aj_id"][1] = "aj_id";
  ajax_field_mult["aj_fecha"][1] = "aj_fecha";
  ajax_field_mult["aj_tipo_ajuste"][1] = "aj_tipo_ajuste";
  ajax_field_mult["aj_bodega"][1] = "aj_bodega";
  ajax_field_mult["aj_info_adicional"][1] = "aj_info_adicional";
  ajax_field_mult["aj_estado"][1] = "aj_estado";
  ajax_field_mult["aj_usuario"][1] = "aj_usuario";
  ajax_field_mult["aj_empresa"][1] = "aj_empresa";
  ajax_field_mult["detalle"][1] = "detalle";

  var ajax_field_id = {
    "aj_id": new Array("hidden_field_label_aj_id", "hidden_field_data_aj_id"),
    "aj_fecha": new Array("hidden_field_label_aj_fecha", "hidden_field_data_aj_fecha"),
    "aj_tipo_ajuste": new Array("hidden_field_label_aj_tipo_ajuste", "hidden_field_data_aj_tipo_ajuste"),
    "aj_bodega": new Array("hidden_field_label_aj_bodega", "hidden_field_data_aj_bodega"),
    "aj_info_adicional": new Array("hidden_field_label_aj_info_adicional", "hidden_field_data_aj_info_adicional"),
    "aj_estado": new Array("hidden_field_label_aj_estado", "hidden_field_data_aj_estado"),
