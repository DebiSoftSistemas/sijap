...
class grid_v_fac_cantidad_productos_deudas_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_v_fac_cantidad_productos_deudas']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_v_fac_cantidad_productos_deudas']['campos_busca']))
      { 
