<?php
@session_start() ;
$_SESSION['scriptcase']['grid_v_fac_cantidad_productos_deudas']['sc_process_barr'] = true;
require_once('../grid_v_fac_cantidad_productos_deudas/index.php');
unset($_SESSION['scriptcase']['grid_v_fac_cantidad_productos_deudas']['sc_process_barr']);
$ExportCtrl = new grid_v_fac_cantidad_productos_deudas_export_control;
$ExportCtrl->Export_barr();

class grid_v_fac_cantidad_productos_deudas_export_control
{
