<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_selecciona_contrato']['glo_nm_path_imag_temp'] . "/sc_apl_default_SIJAP.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_selecciona_contrato_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_selecciona_contrato_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["con_cedula"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['labels']["con_cedula"])) ? $_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['labels']["con_cedula"] : "" . $this->Nm_lang['lang_lot_identificacion'] . "";
   $tab_ger_campos['con_nombre'] = "on";
   $tab_def_campos['con_nombre'] = "con_nombre";
   $tab_labels["con_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['labels']["con_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['labels']["con_nombre"] : "" . $this->Nm_lang['lang_propietario'] . "";
   $tab_ger_campos['con_direccion_predio'] = "on";
   $tab_def_campos['con_direccion_predio'] = "con_direccion_predio";
   $tab_labels["con_direccion_predio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['labels']["con_direccion_predio"])) ? $_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['labels']["con_direccion_predio"] : "" . $this->Nm_lang['lang_direccion'] . "";
   $tab_ger_campos['con_numero_contrato'] = "on";
   $tab_def_campos['con_numero_contrato'] = "con_numero_contrato";
   $tab_labels["con_numero_contrato"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['labels']["con_numero_contrato"])) ? $_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['labels']["con_numero_contrato"] : "" . $this->Nm_lang['lang_numero_contrato'] . "";
   $tab_ger_campos['con_numero_medidor'] = "on";
   $tab_def_campos['con_numero_medidor'] = "con_numero_medidor";
   $tab_labels["con_numero_medidor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['labels']["con_numero_medidor"])) ? $_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['labels']["con_numero_medidor"] : "" . $this->Nm_lang['lang_numero_medidor'] . "";
   $tab_ger_campos['con_numero_censo'] = "on";
   $tab_def_campos['con_numero_censo'] = "con_numero_censo";
   $tab_labels["con_numero_censo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['labels']["con_numero_censo"])) ? $_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['labels']["con_numero_censo"] : "" . $this->Nm_lang['lang_numero_censo'] . "";
   $tab_ger_campos['con_comunidad'] = "on";
   $tab_def_campos['con_comunidad'] = "con_comunidad";
   $tab_labels["con_comunidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['labels']["con_comunidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['labels']["con_comunidad"] : "" . $this->Nm_lang['lang_comunidad'] . "";
   $tab_ger_campos['con_sector'] = "on";
   $tab_def_campos['con_sector'] = "con_sector";
   $tab_labels["con_sector"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['labels']["con_sector"])) ? $_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['labels']["con_sector"] : "" . $this->Nm_lang['lang_sector'] . "";
   $tab_ger_campos['con_ruta'] = "on";
   $tab_def_campos['con_ruta'] = "con_ruta";
   $tab_labels["con_ruta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['labels']["con_ruta"])) ? $_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['labels']["con_ruta"] : "" . $this->Nm_lang['lang_ruta'] . "";
   $tab_ger_campos['con_tipo_servicio'] = "on";
   $tab_def_campos['con_tipo_servicio'] = "con_tipo_servicio";
   $tab_labels["con_tipo_servicio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['labels']["con_tipo_servicio"])) ? $_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['labels']["con_tipo_servicio"] : "" . $this->Nm_lang['lang_tipo_servicio'] . "";
   $tab_ger_campos['con_condicion_contrato'] = "on";
   $tab_def_campos['con_condicion_contrato'] = "con_condicion_contrato";
   $tab_labels["con_condicion_contrato"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['labels']["con_condicion_contrato"])) ? $_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['labels']["con_condicion_contrato"] : "" . $this->Nm_lang['lang_condicion_contrato'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_pago_multiple'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_selecciona_contrato_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_selecciona_contrato']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
