...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_selecciona_contrato"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_selecciona_contrato"]);
   }
   ...
   $fecha_janela = false;
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_selecciona_contrato']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_selecciona_contrato']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_selecciona_contrato']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_selecciona_contrato']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_selecciona_contrato']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_selecciona_contrato</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_selecciona_contrato']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_selecciona_contrato']['embutida_filho'] as $ind => $sc_init)
          {
