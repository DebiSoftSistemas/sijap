<?php
@session_start() ;
$_SESSION['scriptcase']['grid_selecciona_contrato']['sc_process_barr'] = true;
require_once('../grid_selecciona_contrato/index.php');
unset($_SESSION['scriptcase']['grid_selecciona_contrato']['sc_process_barr']);
$ExportCtrl = new grid_selecciona_contrato_export_control;
$ExportCtrl->Export_barr();

class grid_selecciona_contrato_export_control
{
