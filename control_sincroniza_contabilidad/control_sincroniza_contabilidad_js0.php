...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_sincroniza_contabilidad']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['control_sincroniza_contabilidad']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="control_sincroniza_contabilidad"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
var Crtl_btn_AsientosEmision = false;
function sc_btn_AsientosEmision()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_AsientosEmision(); }, 500);
      return;
    }
    if (Crtl_btn_AsientosEmision) {return;}
    sc_btn_AsientosEmision_ok();
}
function sc_btn_AsientosEmision_cancel()
{
}
function sc_btn_AsientosEmision_ok()
{
    Crtl_btn_AsientosEmision = true;
    document.F1.nmgp_parms.value = "nmgp_opcao?#?formphp?@?nm_call_php?#?AsientosEmision?@?";
    document.F1.action = "./";
    document.F1.target = "_self";
    document.F1.submit();
}
var Crtl_btn_AsientosAnulacionDeudas = false;
function sc_btn_AsientosAnulacionDeudas()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_AsientosAnulacionDeudas(); }, 500);
      return;
    }
    if (Crtl_btn_AsientosAnulacionDeudas) {return;}
    sc_btn_AsientosAnulacionDeudas_ok();
}
function sc_btn_AsientosAnulacionDeudas_cancel()
{
}
function sc_btn_AsientosAnulacionDeudas_ok()
{
    Crtl_btn_AsientosAnulacionDeudas = true;
    document.F1.nmgp_parms.value = "nmgp_opcao?#?formphp?@?nm_call_php?#?AsientosAnulacionDeudas?@?";
    document.F1.action = "./";
    document.F1.target = "_self";
    document.F1.submit();
}
var Crtl_btn_AsientosFacturas = false;
function sc_btn_AsientosFacturas()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_AsientosFacturas(); }, 500);
      return;
    }
    if (Crtl_btn_AsientosFacturas) {return;}
    sc_btn_AsientosFacturas_ok();
}
function sc_btn_AsientosFacturas_cancel()
{
}
function sc_btn_AsientosFacturas_ok()
{
    Crtl_btn_AsientosFacturas = true;
    document.F1.nmgp_parms.value = "nmgp_opcao?#?formphp?@?nm_call_php?#?AsientosFacturas?@?";
    document.F1.action = "./";
    document.F1.target = "_self";
    document.F1.submit();
}
var Crtl_btn_AsientosControl = false;
function sc_btn_AsientosControl()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_AsientosControl(); }, 500);
      return;
    }
    if (Crtl_btn_AsientosControl) {return;}
    sc_btn_AsientosControl_ok();
}
function sc_btn_AsientosControl_cancel()
{
}
function sc_btn_AsientosControl_ok()
{
    Crtl_btn_AsientosControl = true;
    document.F1.nmgp_parms.value = "nmgp_opcao?#?formphp?@?nm_call_php?#?AsientosControl?@?";
    document.F1.action = "./";
    document.F1.target = "_self";
    document.F1.submit();
}
var Crtl_btn_FacturasAnuladas = false;
function sc_btn_FacturasAnuladas()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_FacturasAnuladas(); }, 500);
      return;
    }
    if (Crtl_btn_FacturasAnuladas) {return;}
    sc_btn_FacturasAnuladas_ok();
}
function sc_btn_FacturasAnuladas_cancel()
{
}
function sc_btn_FacturasAnuladas_ok()
{
    Crtl_btn_FacturasAnuladas = true;
    document.F1.nmgp_parms.value = "nmgp_opcao?#?formphp?@?nm_call_php?#?FacturasAnuladas?@?";
    document.F1.action = "./";
    document.F1.target = "_self";
    document.F1.submit();
}
var Crtl_btn_AsientosCuotasDivision = false;
function sc_btn_AsientosCuotasDivision()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_AsientosCuotasDivision(); }, 500);
      return;
    }
    if (Crtl_btn_AsientosCuotasDivision) {return;}
    sc_btn_AsientosCuotasDivision_ok();
}
function sc_btn_AsientosCuotasDivision_cancel()
{
}
function sc_btn_AsientosCuotasDivision_ok()
{
    Crtl_btn_AsientosCuotasDivision = true;
    document.F1.nmgp_parms.value = "nmgp_opcao?#?formphp?@?nm_call_php?#?AsientosCuotasDivision?@?";
    document.F1.action = "./";
    document.F1.target = "_self";
    document.F1.submit();
}
var Crtl_btn_AsientosEmisionRecargosMora = false;
function sc_btn_AsientosEmisionRecargosMora()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_AsientosEmisionRecargosMora(); }, 500);
      return;
    }
    if (Crtl_btn_AsientosEmisionRecargosMora) {return;}
    sc_btn_AsientosEmisionRecargosMora_ok();
}
function sc_btn_AsientosEmisionRecargosMora_cancel()
{
}
function sc_btn_AsientosEmisionRecargosMora_ok()
{
    Crtl_btn_AsientosEmisionRecargosMora = true;
    document.F1.nmgp_parms.value = "nmgp_opcao?#?formphp?@?nm_call_php?#?AsientosEmisionRecargosMora?@?";
    document.F1.action = "./";
    document.F1.target = "_self";
    document.F1.submit();
}
var Crtl_btn_AsientosConvenioPago = false;
function sc_btn_AsientosConvenioPago()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_AsientosConvenioPago(); }, 500);
      return;
    }
    if (Crtl_btn_AsientosConvenioPago) {return;}
    sc_btn_AsientosConvenioPago_ok();
}
function sc_btn_AsientosConvenioPago_cancel()
{
}
function sc_btn_AsientosConvenioPago_ok()
{
    Crtl_btn_AsientosConvenioPago = true;
    document.F1.nmgp_parms.value = "nmgp_opcao?#?formphp?@?nm_call_php?#?AsientosConvenioPago?@?";
    document.F1.action = "./";
    document.F1.target = "_self";
    document.F1.submit();
}
var Crtl_btn_asientos_nc = false;
function sc_btn_asientos_nc()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_asientos_nc(); }, 500);
      return;
    }
    if (Crtl_btn_asientos_nc) {return;}
    sc_btn_asientos_nc_ok();
}
function sc_btn_asientos_nc_cancel()
{
}
function sc_btn_asientos_nc_ok()
{
    Crtl_btn_asientos_nc = true;
    document.F1.nmgp_parms.value = "nmgp_opcao?#?formphp?@?nm_call_php?#?asientos_nc?@?";
    document.F1.action = "./";
    document.F1.target = "_self";
    document.F1.submit();
}
var Crtl_btn_anulacion_nc = false;
function sc_btn_anulacion_nc()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_anulacion_nc(); }, 500);
      return;
    }
    if (Crtl_btn_anulacion_nc) {return;}
    sc_btn_anulacion_nc_ok();
}
function sc_btn_anulacion_nc_cancel()
{
}
function sc_btn_anulacion_nc_ok()
{
    Crtl_btn_anulacion_nc = true;
    document.F1.nmgp_parms.value = "nmgp_opcao?#?formphp?@?nm_call_php?#?anulacion_nc?@?";
    document.F1.action = "./";
    document.F1.target = "_self";
    document.F1.submit();
}
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_sincroniza_contabilidad']['where_detal']))
  {
?>  
...
function sc_inline_form(seqRow, keyParams, width, height)
{
  ...
  nm_gp_submit('<?php echo $this->Ini->link_control_sincroniza_contabilidad_inline ?>', '<?php echo $this->nm_location ?>', 'NM_btn_insert*scinN*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinN*scoutNMSC_modal*scinok*scoutsc_redir_atualiz*scinok*scoutsc_inline_call*scinY*scoutsc_seq_row*scin' + seqRow + '*scout' + callParams, '', 'modal', height, width);
}

function sc_inline_form_add(width, height)
{
  nm_gp_submit('<?php echo $this->Ini->link_control_sincroniza_contabilidad_inline ?>', '<?php echo $this->nm_location ?>', 'NM_btn_insert*scinY*scoutNM_btn_update*scinN*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinN*scoutNMSC_modal*scinok*scoutsc_redir_atualiz*scinok*scoutsc_inline_call*scinY*scoutnmgp_opcao*scinnovo*scout', '', 'modal', height, width);
}
...
?>
    ...
    {
        do_ajax_control_sincroniza_contabilidad_navigate_form();
    }
} 
...
function scForm_submit_single(x) {
	if (x != "excluir")
	{
		...
		if ("incluir" == x || "muda_form" == x || "recarga" == x || "recarga_mobile" == x) {
			...
			Nm_Proc_Atualiz = true;
			do_ajax_control_sincroniza_contabilidad_submit_form();
		}
	}
	if (Nm_submit_ok) {
		Nm_Proc_Atualiz = true;
...
{
  if (scFormHasChanged) {
    scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', function() { document.F4.target = "_self"; document.F4.action = "control_sincroniza_contabilidad_fim.php"; document.F4.submit(); }, function() {});
  } else {
    document.F4.target = "_self";
    document.F4.action = "control_sincroniza_contabilidad_fim.php";
    document.F4.submit();
  }
}
