...
<?php
   ...
   $Ord_Cmp = new grid_sri_sustento_tributario_gasto_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_sri_sustento_tributario_gasto_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_sri_sustento_tributario_gasto']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_sri_sustento_tributario_gasto']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['stg_codigo'] = "stg_codigo";
   $tab_labels["stg_codigo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sri_sustento_tributario_gasto']['labels']["stg_codigo"])) ? $_SESSION['sc_session'][$sc_init]['grid_sri_sustento_tributario_gasto']['labels']["stg_codigo"] : "" . $this->Nm_lang['lang_codigo'] . "";
   $tab_ger_campos['stg_descripcion'] = "on";
   $tab_def_campos['stg_descripcion'] = "stg_descripcion";
   $tab_labels["stg_descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sri_sustento_tributario_gasto']['labels']["stg_descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_sri_sustento_tributario_gasto']['labels']["stg_descripcion"] : "" . $this->Nm_lang['lang_descripcion'] . "";
   $tab_ger_campos['stg_estado'] = "on";
   $tab_def_campos['stg_estado'] = "stg_estado";
   $tab_labels["stg_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sri_sustento_tributario_gasto']['labels']["stg_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_sri_sustento_tributario_gasto']['labels']["stg_estado"] : "" . $this->Nm_lang['lang_estado'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_sri_sustento_tributario_gasto']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_sri_sustento_tributario_gasto']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_sri_sustento_tributario_gasto']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_sri_sustento_tributario_gasto']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_sri_sustento_tributario_gasto']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_sri_sustento_tributario_gasto']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_sri_sustento_tributario_gasto']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_sri_sustento_tributario_gasto']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_sri_sustento_tributario_gasto']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_sri_sustento_tributario_gasto']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_sri_sustento_tributario_gasto']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_sri_sustento_tributario_gasto']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_sri_sustento_tributario_gasto_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_sri_sustento_tributario_gasto']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_sri_sustento_tributario_gasto']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_sri_sustento_tributario_gasto']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_sri_sustento_tributario_gasto']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_sri_sustento_tributario_gasto']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
