<?php
@session_start() ;
$_SESSION['scriptcase']['grid_sri_sustento_tributario_gasto']['sc_process_barr'] = true;
require_once('../grid_sri_sustento_tributario_gasto/index.php');
unset($_SESSION['scriptcase']['grid_sri_sustento_tributario_gasto']['sc_process_barr']);
$ExportCtrl = new grid_sri_sustento_tributario_gasto_export_control;
$ExportCtrl->Export_barr();

class grid_sri_sustento_tributario_gasto_export_control
{
