...
$old_error_handler = set_error_handler("frmInactividadDebi_mob_scriptcase_error_handler");

function frmInactividadDebi_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['frmInactividadDebi_mob']['contr_erro']) && $_SESSION['scriptcase']['frmInactividadDebi_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_frmInactividadDebi_mob->contr_frmInactividadDebi_mob->Apl_com_erro = true;
            if ($inicial_frmInactividadDebi_mob->contr_frmInactividadDebi_mob->NM_ajax_flag)
            {
                $inicial_frmInactividadDebi_mob->contr_frmInactividadDebi_mob->NM_ajax_info['errList']['geral_frmInactividadDebi_mob'][] = $msg;
                return;
            }
            frmInactividadDebi_mob_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function frmInactividadDebi_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['frmInactividadDebi_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['frmInactividadDebi_mob'])  ? $_SESSION['scriptcase']['error_icon']['frmInactividadDebi_mob']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['frmInactividadDebi_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['frmInactividadDebi_mob']) ? $_SESSION['scriptcase']['error_span_title']['frmInactividadDebi_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['frmInactividadDebi_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['frmInactividadDebi_mob']) ? $_SESSION['scriptcase']['error_icon_title']['frmInactividadDebi_mob'] : '';
?>
