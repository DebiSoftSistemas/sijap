<?php
//
class form_jap_contrato_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      {
          if (isset($this->NM_ajax_info['param']['con_abono']))
          {
              $this->con_abono = $this->NM_ajax_info['param']['con_abono'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['con_empresa']))
          {
              $this->con_empresa = $this->NM_ajax_info['param']['con_empresa'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['con_plazo']))
          {
              $this->con_plazo = $this->NM_ajax_info['param']['con_plazo'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['con_saldo_pagar']))
          {
              $this->con_saldo_pagar = $this->NM_ajax_info['param']['con_saldo_pagar'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['con_total_a_pagar']))
          {
              $this->con_total_a_pagar = $this->NM_ajax_info['param']['con_total_a_pagar'];
          }
          if (isset($this->NM_ajax_info['param']['con_usuario_instala']))
          {
              $this->con_usuario_instala = $this->NM_ajax_info['param']['con_usuario_instala'];
          }
          if (isset($this->NM_ajax_info['param']['con_valor_cuota']))
          {
              $this->con_valor_cuota = $this->NM_ajax_info['param']['con_valor_cuota'];
          }
          if (isset($this->NM_ajax_info['param']['csrf_token']))
          {
              $this->csrf_token = $this->NM_ajax_info['param']['csrf_token'];
          }
          if (isset($this->NM_ajax_info['param']['cuotas']))
          {
              $this->cuotas = $this->NM_ajax_info['param']['cuotas'];
          }
          if (isset($this->NM_ajax_info['param']['materiales']))
          {
              $this->materiales = $this->NM_ajax_info['param']['materiales'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['rubros']))
          {
              $this->rubros = $this->NM_ajax_info['param']['rubros'];
          }
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_jap_contrato_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_jap_contrato_mob']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_jap_contrato_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_jap_contrato_mob']['embutida_parms'];
          unset($_SESSION['sc_session'][$script_case_init]['form_jap_contrato_mob']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_form_jap_contrato_mob($cadapar[1]);
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_jap_contrato_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_jap_contrato_mob']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_jap_contrato_mob']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_jap_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_jap_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['total']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_jap_contrato_mob']['form_jap_rubro_contrato_mob_script_case_init'] ]['form_jap_rubro_contrato_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_jap_contrato_mob']['form_jap_rubro_contrato_mob_script_case_init'] ]['form_jap_rubro_contrato_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_jap_contrato_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_jap_contrato_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (!isset($this->Igtech_RucEmpresa) && isset($this->igtech_rucempresa)) 
          {
              $this->Igtech_RucEmpresa = $this->igtech_rucempresa;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_jap_contrato_mob']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['form_jap_contrato_mob']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_jap_contrato_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_jap_contrato_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_jap_contrato_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_jap_contrato_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_jap_contrato_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_jap_contrato_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_jap_contrato_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_jap_contrato_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_jap_contrato_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_contrato']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_jap_contrato'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_jap_contrato_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['form_jap_contrato_mob']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_jap_contrato_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_jap_contrato_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_jap_contrato_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_jap_contrato_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_jap_contrato_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_jap_contrato_mob']['label'] = "" . $this->Ini->Nm_lang['lang_jap_contrato'] . "";
      ...
      $this->nm_new_label['con_empresa'] = '' . $this->Ini->Nm_lang['lang_empresa'] . '';
      ...
      $this->nm_new_label['con_motivo_anulacion'] = '' . $this->Ini->Nm_lang['lang_motivo_rechazo'] . '';
      $this->nm_new_label['con_tipo_contrato'] = '' . $this->Ini->Nm_lang['lang_tipo_contrato'] . '';
      $this->nm_new_label['con_total_a_pagar'] = '' . $this->Ini->Nm_lang['lang_total_pagar'] . '';
      $this->nm_new_label['con_abono'] = '' . $this->Ini->Nm_lang['lang_abono'] . '';
      ...
      $this->nm_new_label['con_numero_contrato'] = '' . $this->Ini->Nm_lang['lang_numero_contrato'] . '';
      ...
      $this->nm_new_label['con_saldo_pagar'] = '' . $this->Ini->Nm_lang['lang_saldo_pagar'] . '';
      $this->nm_new_label['rubros'] = '' . $this->Ini->Nm_lang['lang_rubros'] . '';
      $this->nm_new_label['cuotas'] = '' . $this->Ini->Nm_lang['lang_cuotas'] . '';
      $this->nm_new_label['materiales'] = '' . $this->Ini->Nm_lang['lang_materiales'] . '';
      $this->nm_new_label['con_direccion_propietario'] = '' . $this->Ini->Nm_lang['lang_lot_direccion_propietario'] . '';
      $this->nm_new_label['con_valor_cuota'] = '' . $this->Ini->Nm_lang['lang_cuotas_de'] . '';
      $this->nm_new_label['con_nombre'] = '' . $this->Ini->Nm_lang['lang_lot_nombre_completo'] . '';
      $this->nm_new_label['con_cedula'] = '' . $this->Ini->Nm_lang['lang_lot_identificacion'] . '';
      ...
      $this->arr_buttons['enviar_legalizar']['hint']             = "";
      $this->arr_buttons['enviar_legalizar']['type']             = "button";
      $this->arr_buttons['enviar_legalizar']['value']            = "" . $this->Ini->Nm_lang['lang_enviar_legalizar'] . "";
      $this->arr_buttons['enviar_legalizar']['display']          = "text_fontawesomeicon";
      $this->arr_buttons['enviar_legalizar']['display_position'] = "text_right";
      $this->arr_buttons['enviar_legalizar']['style']            = "default";
      $this->arr_buttons['enviar_legalizar']['image']            = "";
      $this->arr_buttons['enviar_legalizar']['has_fa']            = "true";
      $this->arr_buttons['enviar_legalizar']['fontawesomeicon']            = "fas fa-arrow-alt-circle-right";
      ...
      $this->arr_buttons['actualizar']['hint']             = "";
      $this->arr_buttons['actualizar']['type']             = "button";
      $this->arr_buttons['actualizar']['value']            = "" . $this->Ini->Nm_lang['lang_actualizar'] . "";
      $this->arr_buttons['actualizar']['display']          = "text_fontawesomeicon";
      $this->arr_buttons['actualizar']['display_position'] = "text_right";
      $this->arr_buttons['actualizar']['style']            = "default";
      $this->arr_buttons['actualizar']['image']            = "";
      $this->arr_buttons['actualizar']['has_fa']            = "true";
      $this->arr_buttons['actualizar']['fontawesomeicon']            = "fas fa-save";

      $this->arr_buttons['btnimprimir']['hint']             = "";
      $this->arr_buttons['btnimprimir']['type']             = "button";
      $this->arr_buttons['btnimprimir']['value']            = "" . $this->Ini->Nm_lang['lang_imprimir_contrato'] . "";
      $this->arr_buttons['btnimprimir']['display']          = "text_fontawesomeicon";
      $this->arr_buttons['btnimprimir']['display_position'] = "text_right";
      $this->arr_buttons['btnimprimir']['style']            = "check";
      $this->arr_buttons['btnimprimir']['image']            = "";
      $this->arr_buttons['btnimprimir']['has_fa']            = "true";
      $this->arr_buttons['btnimprimir']['fontawesomeicon']            = "fas fa-print";

      $this->arr_buttons['imprimirsolicitud']['hint']             = "";
      $this->arr_buttons['imprimirsolicitud']['type']             = "button";
      $this->arr_buttons['imprimirsolicitud']['value']            = "" . $this->Ini->Nm_lang['lang_imprimir'] . "";
      $this->arr_buttons['imprimirsolicitud']['display']          = "text_fontawesomeicon";
      $this->arr_buttons['imprimirsolicitud']['display_position'] = "text_right";
      $this->arr_buttons['imprimirsolicitud']['style']            = "default";
      $this->arr_buttons['imprimirsolicitud']['image']            = "";
      $this->arr_buttons['imprimirsolicitud']['has_fa']            = "true";
      $this->arr_buttons['imprimirsolicitud']['fontawesomeicon']            = "fas fa-print";

      $this->arr_buttons['legalizar']['hint']             = "";
      $this->arr_buttons['legalizar']['type']             = "button";
      $this->arr_buttons['legalizar']['value']            = "" . $this->Ini->Nm_lang['lang_legalizar'] . "";
      $this->arr_buttons['legalizar']['display']          = "text_fontawesomeicon";
      $this->arr_buttons['legalizar']['display_position'] = "text_right";
      $this->arr_buttons['legalizar']['style']            = "default";
      $this->arr_buttons['legalizar']['image']            = "";
      $this->arr_buttons['legalizar']['has_fa']            = "true";
      $this->arr_buttons['legalizar']['fontawesomeicon']            = "fas fa-bookmark";

      $this->arr_buttons['ver_contratos']['hint']             = "";
      $this->arr_buttons['ver_contratos']['type']             = "button";
      $this->arr_buttons['ver_contratos']['value']            = "" . $this->Ini->Nm_lang['lang_contratos_ruta'] . "";
      $this->arr_buttons['ver_contratos']['display']          = "text_fontawesomeicon";
      $this->arr_buttons['ver_contratos']['display_position'] = "text_right";
      $this->arr_buttons['ver_contratos']['style']            = "default";
      $this->arr_buttons['ver_contratos']['image']            = "";
      $this->arr_buttons['ver_contratos']['has_fa']            = "true";
      $this->arr_buttons['ver_contratos']['fontawesomeicon']            = "fas fa-eye";


      $_SESSION['scriptcase']['error_icon']['form_jap_contrato_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_jap_contrato_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_contrato_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_jap_contrato_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_contrato_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_jap_contrato_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_contrato_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_jap_contrato_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['goto']      = 'on';
          }
      }
      ...
      $this->nmgp_botoes['enviar_legalizar'] = "on";
      $this->nmgp_botoes['anular'] = "on";
      $this->nmgp_botoes['actualizar'] = "on";
      $this->nmgp_botoes['btnImprimir'] = "on";
      $this->nmgp_botoes['ImprimirSolicitud'] = "on";
      $this->nmgp_botoes['legalizar'] = "on";
      $this->nmgp_botoes['ver_contratos'] = "on";
      if (isset($this->NM_btn_cancel) && 'N' == $this->NM_btn_cancel)
      {
          $this->nmgp_botoes['cancel'] = "off";
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_contrato_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_jap_contrato_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_jap_contrato_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_contrato_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_jap_contrato_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_jap_contrato_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_contrato_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_jap_contrato_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_jap_contrato_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_jap_contrato_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_contrato_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_jap_contrato_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_jap_contrato_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_contrato_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_jap_contrato_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_jap_contrato_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_contrato_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_jap_contrato_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_jap_contrato_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_contrato_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_jap_contrato_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_jap_contrato_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_contrato_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_jap_contrato_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_jap_contrato_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_jap_contrato_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      { 
          include_once($this->Ini->path_embutida . 'form_jap_contrato/Igtech.AmortizaAlemana.php');
      }
      else
      { 
      ...
      if ($this->Embutida_proc)
      { 
          include_once($this->Ini->path_embutida . 'form_jap_contrato/Igtech.DebiConta.Clases.php');
      }
      else
      { 
      ...
      if ($this->Embutida_proc)
      { 
          include_once($this->Ini->path_embutida . 'form_jap_contrato/Igtech.Log.php');
      }
      else
      { 
      ...
      if (isset($_GET['nm_cal_display']))
      {
          if ($this->Embutida_proc)
          { 
              include_once($this->Ini->path_embutida . 'form_jap_contrato/form_jap_contrato_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_jap_contrato_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_jap_contrato_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_jap_contrato_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_jap_contrato/form_jap_contrato_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_jap_contrato_mob_erro.class.php"); 
      }
      $this->Erro      = new form_jap_contrato_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['opcao']))
         { 
             if ($this->con_id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_contrato_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_jap_contrato_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_contrato_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['opc_ant'] : "";
      } 
      if ($this->nmgp_opcao == "novo")  
      {
          $this->nmgp_botoes['enviar_inspeccion'] = "off";
          $this->nmgp_botoes['enviar_legalizar'] = "off";
          $this->nmgp_botoes['anular'] = "off";
          $this->nmgp_botoes['actualizar'] = "off";
          $this->nmgp_botoes['btnImprimir'] = "off";
          $this->nmgp_botoes['ImprimirSolicitud'] = "off";
          $this->nmgp_botoes['legalizar'] = "off";
          $this->nmgp_botoes['ver_contratos'] = "off";
      }
      elseif ($this->nmgp_opcao == "incluir")  
      {
          $this->nmgp_botoes['enviar_inspeccion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['botoes']['enviar_inspeccion'];
          $this->nmgp_botoes['enviar_legalizar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['botoes']['enviar_legalizar'];
          $this->nmgp_botoes['anular'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['botoes']['anular'];
          $this->nmgp_botoes['actualizar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['botoes']['actualizar'];
          $this->nmgp_botoes['btnImprimir'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['botoes']['btnImprimir'];
          $this->nmgp_botoes['ImprimirSolicitud'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['botoes']['ImprimirSolicitud'];
          $this->nmgp_botoes['legalizar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['botoes']['legalizar'];
          $this->nmgp_botoes['ver_contratos'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['botoes']['ver_contratos'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['reg_start'] = "";
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['total']);
          $detailAppName = 'form_jap_materiales_contrato_mob';
          $detailAppObject = "form_jap_materiales_contrato_mob";
          ...
          $this->form_jap_materiales_contrato_mob = new $detailAppObject;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['form_jap_rubro_contrato_mob_script_case_init'] ]['form_jap_rubro_contrato_mob']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['form_jap_rubro_contrato_mob_script_case_init'] ]['form_jap_rubro_contrato_mob']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['form_jap_rubro_contrato_mob_script_case_init'] ]['form_jap_rubro_contrato_mob']['reg_start'] = "";
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['form_jap_rubro_contrato_mob_script_case_init'] ]['form_jap_rubro_contrato']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['form_jap_rubro_contrato_mob_script_case_init'] ]['form_jap_rubro_contrato']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['form_jap_rubro_contrato_mob_script_case_init'] ]['form_jap_rubro_contrato']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['form_jap_rubro_contrato_mob_script_case_init'] ]['form_jap_rubro_contrato_mob']['total']);
          $detailAppName = 'form_jap_rubro_contrato_mob';
          $detailAppObject = "form_jap_rubro_contrato_mob";
          $detailAppFolder = $this->Ini->root . $this->Ini->path_link  . SC_dir_app_name($detailAppName);
          if (!@is_dir($detailAppFolder)) {
              $detailAppName = substr($detailAppName, 0, -4);
              $detailAppObject = substr($detailAppObject, 0, -4);
          ...
          require_once($detailAppFolder . "/index.php");
          require_once($detailAppFolder . "/{$detailAppName}_apl.php");
          $this->form_jap_rubro_contrato_mob = new $detailAppObject;
      }
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_jap_contrato_mob']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_jap_contrato_mob']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      if (isset($this->con_empresa)) { $this->nm_limpa_alfa($this->con_empresa); }
      ...
      if (isset($this->con_total_a_pagar)) { $this->nm_limpa_alfa($this->con_total_a_pagar); }
      if (isset($this->con_abono)) { $this->nm_limpa_alfa($this->con_abono); }
      if (isset($this->con_plazo)) { $this->nm_limpa_alfa($this->con_plazo); }
      ...
      if (isset($this->rubros)) { $this->nm_limpa_alfa($this->rubros); }
      if (isset($this->cuotas)) { $this->nm_limpa_alfa($this->cuotas); }
      if (isset($this->materiales)) { $this->nm_limpa_alfa($this->materiales); }
      ...
      { 
          ...
          if ($nm_call_php == "enviar_legalizar")
          { 
              $this->sc_btn_enviar_legalizar();
          } 
          if ($nm_call_php == "anular")
          { 
              $this->sc_btn_anular();
          } 
          if ($nm_call_php == "actualizar")
          { 
              $this->sc_btn_actualizar();
          } 
          if ($nm_call_php == "btnImprimir")
          { 
              $this->sc_btn_btnImprimir();
          } 
          if ($nm_call_php == "legalizar")
          { 
              $this->sc_btn_legalizar();
          } 
          $this->NM_close_db(); 
          exit;
      } 
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_select'];
     }
   }
   ...
   function loadFieldConfig()
   {
      ...
      $this->field_config['con_orden_lecturas']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      ...
      $this->field_config['con_orden_lecturas']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['con_orden_lecturas']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      ...
      $this->field_config['con_numero_corte']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      ...
      $this->field_config['con_numero_corte']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['con_numero_corte']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- con_total_a_pagar
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Gera_log_access'] = false;
      }
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          if ('validate_materiales' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'materiales');
          }
          if ('validate_rubros' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'rubros');
          }
          if ('validate_con_total_a_pagar' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'con_total_a_pagar');
          }
          if ('validate_con_abono' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'con_abono');
          }
          if ('validate_con_saldo_pagar' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'con_saldo_pagar');
          }
          if ('validate_con_plazo' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'con_plazo');
          }
          if ('validate_con_valor_cuota' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'con_valor_cuota');
          }
          if ('validate_cuotas' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'cuotas');
          }
          if ('validate_con_empresa' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'con_empresa');
          }
          form_jap_contrato_mob_pack_ajax_response();
          exit;
      }
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6))
      {
          ...
          if ('event_con_abono_onchange' == $this->NM_ajax_opcao)
          {
              $this->con_abono_onChange();
          }
          if ('event_con_plazo_onchange' == $this->NM_ajax_opcao)
          {
              $this->con_plazo_onChange();
          }
          if ('event_con_propietario_onchange' == $this->NM_ajax_opcao)
          {
              $this->con_propietario_onChange();
          }
          if ('event_con_ruta_onchange' == $this->NM_ajax_opcao)
          {
              $this->con_ruta_onChange();
          }
          if ('event_con_total_a_pagar_onchange' == $this->NM_ajax_opcao)
          {
              $this->con_total_a_pagar_onChange();
          }
          form_jap_contrato_mob_pack_ajax_response();
          exit;
      }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      ...
      if ($this->nmgp_opcao == "incluir" || $this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "excluir") 
      {
          ...
          $_SESSION['scriptcase']['form_jap_contrato_mob']['contr_erro'] = 'off';
          if ($Campos_Crit != "") 
          {
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['recarga'] = $this->nmgp_opcao;
      }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_jap_contrato_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_jap_contrato_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_jap_contrato_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="form_jap_contrato_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_jap_contrato_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sis_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'form_jap_contrato_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_jap_contrato_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
<?php
include_once("form_jap_contrato_mob_sajax_js.php");
?>
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['opc_ant'] == "incluir")
      {
      ...
      {
          if (!isset($this->con_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_id']))
          {
              $varloc_btn_php['con_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_id'];
          }
          if (!isset($this->rs) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['rs']))
          {
              $varloc_btn_php['rs'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['rs'];
          }
      }
      $nm_f_saida = "form_jap_contrato_mob.php";
      ...
      $_SESSION['scriptcase']['form_jap_contrato_mob']['contr_erro'] = 'on';
...
if (false == $this->rs) {
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_jap_contrato_mob';
...
;
   ...
   while(!$this->rs->EOF) {
		...
		$mail_message        = $this->formulario_solicitud_inspeccion($this->Hoy()); 
		$mail_format         = 'H';
		$mail_copies		 = '';	
		$mail_tp_copies		 = '';
...
;
 ...
 {
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('grid_solicitud_servicio_ap') . "/", $this->nm_location, "_self?#?" . NM_encode_input("") . "?@?","_self", '', 440, 630);
 };
if (isset($this->sc_temp_Igtech_RucEmpresa)) { $_SESSION['Igtech_RucEmpresa'] = $this->sc_temp_Igtech_RucEmpresa;}
$_SESSION['scriptcase']['form_jap_contrato_mob']['contr_erro'] = 'off'; 
    echo ob_get_clean();
...
<?php
   ...
   function sc_btn_enviar_legalizar() 
   {
        global $nm_url_saida, $teste_validade, 
               $glo_senha_protect, $nm_apl_dependente, $nm_form_submit, $sc_check_excl, $nm_opc_form_php, $nm_call_php, $nm_opc_lookup;
...
<?php
      ...
      {
          if (!isset($this->con_toma_administrativa) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_toma_administrativa']))
          {
              $varloc_btn_php['con_toma_administrativa'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_toma_administrativa'];
          }
          if (!isset($this->con_toma_operativa) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_toma_operativa']))
          {
              $varloc_btn_php['con_toma_operativa'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_toma_operativa'];
          }
          if (!isset($this->con_tipo_servicio) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_tipo_servicio']))
          {
              $varloc_btn_php['con_tipo_servicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_tipo_servicio'];
          }
          if (!isset($this->con_condicion_contrato) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_condicion_contrato']))
          {
              $varloc_btn_php['con_condicion_contrato'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_condicion_contrato'];
          }
          if (!isset($this->con_ruta) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_ruta']))
          {
              $varloc_btn_php['con_ruta'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_ruta'];
          }
          if (!isset($this->con_orden_lecturas) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_orden_lecturas']))
          {
              $varloc_btn_php['con_orden_lecturas'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_orden_lecturas'];
          }
          if (!isset($this->con_fecha_instalacion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_fecha_instalacion']))
          {
              $varloc_btn_php['con_fecha_instalacion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_fecha_instalacion'];
          }
          if (!isset($this->con_numero_medidor) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_numero_medidor']))
          {
              $varloc_btn_php['con_numero_medidor'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_numero_medidor'];
          }
          if (!isset($this->con_maxima_lectura) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_maxima_lectura']))
          {
              $varloc_btn_php['con_maxima_lectura'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_maxima_lectura'];
          }
          if (!isset($this->con_lectura_actual) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_lectura_actual']))
          {
              $varloc_btn_php['con_lectura_actual'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_lectura_actual'];
          }
          if (!isset($this->con_fecha_lectura) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_fecha_lectura']))
          {
              $varloc_btn_php['con_fecha_lectura'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_fecha_lectura'];
          }
          if (!isset($this->con_tipo_contrato) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_tipo_contrato']))
          {
              $varloc_btn_php['con_tipo_contrato'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_tipo_contrato'];
          }
          if (!isset($this->con_propietario) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_propietario']))
          {
              $varloc_btn_php['con_propietario'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_propietario'];
          }
          if (!isset($this->con_pais) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_pais']))
          {
              $varloc_btn_php['con_pais'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_pais'];
          }
          if (!isset($this->con_provincia) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_provincia']))
          {
              $varloc_btn_php['con_provincia'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_provincia'];
          }
          if (!isset($this->con_canton) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_canton']))
          {
              $varloc_btn_php['con_canton'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_canton'];
          }
          if (!isset($this->con_parroquia) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_parroquia']))
          {
              $varloc_btn_php['con_parroquia'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_parroquia'];
          }
          if (!isset($this->con_comunidad) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_comunidad']))
          {
              $varloc_btn_php['con_comunidad'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_comunidad'];
          }
          if (!isset($this->con_sector) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_sector']))
          {
              $varloc_btn_php['con_sector'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_sector'];
          }
          if (!isset($this->con_numero_censo) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_numero_censo']))
          {
              $varloc_btn_php['con_numero_censo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_numero_censo'];
          }
          if (!isset($this->con_direccion_predio) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_direccion_predio']))
          {
              $varloc_btn_php['con_direccion_predio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_direccion_predio'];
          }
          if (!isset($this->con_toma_administrativa) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_toma_administrativa']))
          {
              $varloc_btn_php['con_toma_administrativa'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_toma_administrativa'];
          ...
          if (!isset($this->con_observaciones) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_observaciones']))
          {
              $varloc_btn_php['con_observaciones'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_observaciones'];
          }
          if (!isset($this->con_usuario_instala) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_usuario_instala']))
          {
              $varloc_btn_php['con_usuario_instala'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_usuario_instala'];
          }
          if (!isset($this->con_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_id']))
          {
              $varloc_btn_php['con_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_id'];
      ...
      $_SESSION['scriptcase']['form_jap_contrato_mob']['contr_erro'] = 'on';
  if ($this->con_toma_administrativa <>0 and $this->con_toma_operativa <>0 and $this->con_tipo_servicio <>0 and $this->con_condicion_contrato <>0 and $this->con_ruta <>0 and $this->con_orden_lecturas <>'' and $this->con_fecha_instalacion <>'' and $this->con_numero_medidor <>'' and $this->con_maxima_lectura <>0 and $this->con_lectura_actual <>'' and $this->con_fecha_lectura <>''){
	$update_sql = "UPDATE jap_contrato SET
	 ...
	 if (!isset($this->Campos_Mens_erro) || empty($this->Campos_Mens_erro))
 {
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('grid_predios_inspeccion_ap') . "/", $this->nm_location, "_self?#?" . NM_encode_input("") . "?@?","_self", '', 440, 630);
 };
}else{
	echo 'Faltan datos de la Inspección';
	
 if (!isset($this->Campos_Mens_erro)){$this->Campos_Mens_erro = "";}
 if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= 'Faltan datos de la Inspección';
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_jap_contrato_mob';
  ...
  $this->NM_ajax_info['errList'][$sErrorIndex][] = 'Faltan datos de la Inspección';
 }
;
}
$_SESSION['scriptcase']['form_jap_contrato_mob']['contr_erro'] = 'off'; 
...
<?php
      ...
      {
          if (!isset($this->con_motivo_anulacion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_motivo_anulacion']))
          {
              $varloc_btn_php['con_motivo_anulacion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_motivo_anulacion'];
          }
          if (!isset($this->con_motivo_anulacion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_motivo_anulacion']))
          {
              $varloc_btn_php['con_motivo_anulacion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_motivo_anulacion'];
          ...
          if (!isset($this->con_nombre) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_nombre']))
          {
              $varloc_btn_php['con_nombre'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_nombre'];
          }
          if (!isset($this->con_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_id']))
          {
              $varloc_btn_php['con_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_id'];
...
<?php
      ...
      {
          if (!isset($this->con_empresa) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_empresa']))
          {
              $varloc_btn_php['con_empresa'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_empresa'];
          }
          if (!isset($this->con_propietario) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_propietario']))
          {
              $varloc_btn_php['con_propietario'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_propietario'];
          ...
          if (!isset($this->con_usuario) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_usuario']))
          {
              $varloc_btn_php['con_usuario'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_usuario'];
          }
          if (!isset($this->con_fecha) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_fecha']))
          {
              $varloc_btn_php['con_fecha'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_fecha'];
          }
          if (!isset($this->con_terminal) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_terminal']))
          {
              $varloc_btn_php['con_terminal'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_terminal'];
          }
          if (!isset($this->con_estado) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_estado']))
          {
              $varloc_btn_php['con_estado'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_estado'];
          }
          if (!isset($this->con_motivo_anulacion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_motivo_anulacion']))
          {
              $varloc_btn_php['con_motivo_anulacion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_motivo_anulacion'];
          ...
          if (!isset($this->con_total_a_pagar) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_total_a_pagar']))
          {
              $varloc_btn_php['con_total_a_pagar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_total_a_pagar'];
          }
          if (!isset($this->con_abono) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_abono']))
          {
              $varloc_btn_php['con_abono'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_abono'];
          }
          if (!isset($this->con_plazo) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_plazo']))
          {
              $varloc_btn_php['con_plazo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_plazo'];
          }
          if (!isset($this->con_fecha_instalacion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_fecha_instalacion']))
          {
              $varloc_btn_php['con_fecha_instalacion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_fecha_instalacion'];
          ...
          if (!isset($this->con_numero_corte) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_numero_corte']))
          {
              $varloc_btn_php['con_numero_corte'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_numero_corte'];
          }
          if (!isset($this->con_usuario_instala) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_usuario_instala']))
          {
              $varloc_btn_php['con_usuario_instala'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_usuario_instala'];
          }
          if (!isset($this->con_numero_contrato) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_numero_contrato']))
          {
              $varloc_btn_php['con_numero_contrato'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_numero_contrato'];
          }
          if (!isset($this->con_maxima_lectura) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_maxima_lectura']))
          {
              $varloc_btn_php['con_maxima_lectura'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['con_maxima_lectura'];
  ...
  $update_sql = "UPDATE jap_contrato 
				SET	 
					...
					con_condicion_contrato      = ".$this->con_condicion_contrato .",
					con_numero_medidor          ='".$this->con_numero_medidor ."',
					con_usuario                 ='".$this->con_usuario ."',
					con_fecha                   ='".$this->con_fecha ."',
					con_terminal                ='".$this->con_terminal ."',
					con_estado                  ='".$this->con_estado ."',
					con_motivo_anulacion        ='".$this->con_motivo_anulacion ."',
					con_tipo_contrato           = ".$this->con_tipo_contrato .",
					con_total_a_pagar           = ".$this->con_total_a_pagar .",
					con_abono                   = ".$this->con_abono .",
					con_plazo                   = ".$this->con_plazo .",
					con_fecha_instalacion       ='".$this->con_fecha_instalacion ."',
					con_observaciones           ='".$this->con_observaciones ."',
...
<?php
      ...
      $_SESSION['scriptcase']['form_jap_contrato_mob']['contr_erro'] = 'on';
  $redir_app    = 'form_jap_contrato_pdf';
$redir_target = '_blank';
$redir_param  = array(  
					'var_contrato' => $this->con_id ,
				);
 if (!isset($this->Campos_Mens_erro) || empty($this->Campos_Mens_erro))
 {
...
<?php
      ...
      else
      {
          ...
          if (!isset($this->rs_operacion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['rs_operacion']))
          {
              $varloc_btn_php['rs_operacion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['rs_operacion'];
          }
          if (!isset($this->rs_operacion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['rs_operacion']))
          {
              $varloc_btn_php['rs_operacion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form']['rs_operacion'];
...
if (!isset($this->sc_temp_Igtech_SesionLogin)) {$this->sc_temp_Igtech_SesionLogin = (isset($_SESSION['Igtech_SesionLogin'])) ? $_SESSION['Igtech_SesionLogin'] : "";}
if (!isset($this->sc_temp_Igtech_RucEmpresa)) {$this->sc_temp_Igtech_RucEmpresa = (isset($_SESSION['Igtech_RucEmpresa'])) ? $_SESSION['Igtech_RucEmpresa'] : "";}
  if ($this->con_numero_contrato =='' or $this->con_numero_contrato ==0 ){
	$check_parametro="select sp_busca_parametro_ap('".$this->sc_temp_Igtech_RucEmpresa."','NUMCONXRUT','NO');";
	...
	if($this->rs_parametro[0][0]=="NO"){
		$check_sql = "select sp_jap_secuencial ('".$this->sc_temp_Igtech_RucEmpresa."','SECCONAP');" ;
      ...
      { 
		...
		if(isset($this->rs[0][0])){
			$this->con_numero_contrato =substr("000000".$this->rs[0][0],-6);
		}
		$check_sql = "select sp_busca_parametro_ap('".$this->sc_temp_Igtech_RucEmpresa."','PREFCONTRATO','');";
      ...
      { 
		...
		if(isset($this->rs[0][0])){
			$this->con_numero_contrato =$this->rs[0][0].$this->con_numero_contrato ;
		}
	}else{
		
		$check_sql = "select sp_jap_secuencial_contrato ('".$this->sc_temp_Igtech_RucEmpresa."',".$this->con_ruta .");" ;
      ...
      { 
		...
		if(isset($this->rs[0][0])){
			$this->con_numero_contrato =$this->rs[0][0];
		}	
	}
	$check_parametro="select sp_busca_parametro_ap('".$this->sc_temp_Igtech_RucEmpresa."','NUNORDCON','NO');";
	...
	if($this->rs_parametro[0][0]=="SI"){
		$this->con_orden_lecturas = substr("00000".$this->con_numero_contrato ,-5);
	}
...
if($this->con_estado =='L'){
	...
	$select_sql="SELECT rc_ruta, rc_orden 
				 FROM jap_ruta_contrato 
				 WHERE rc_contrato=".$this->con_id ;
	 
      $nm_select = $select_sql; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->rs_anterior = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
          $nm_count = $SCrx->FieldCount();
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                      $this->rs_anterior[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
          } 
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->rs_anterior = false;
          $this->rs_anterior_erro = $this->Db->ErrorMsg();
      } 

	
	if(isset($this->rs_anterior[0][0])){
		$w_ruta_anterior=$this->rs_anterior[0][0];
		$w_orden_anterior=$this->rs_anterior[0][1];
		$update_sql="UPDATE  jap_ruta_contrato
					SET rc_orden=rc_orden-1 
					WHERE
					rc_ruta=".$w_ruta_anterior."
					and rc_orden>=".$w_orden_anterior.";";
	...
	$check_sql="SELECT count(*) 
				FROM jap_ruta_contrato 
			    WHERE rc_ruta=".$this->con_ruta ."
			    AND rc_orden=".$this->con_orden_lecturas ;
	 
      $nm_select = $check_sql; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->rs_contador = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
          $nm_count = $SCrx->FieldCount();
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                      $this->rs_contador[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
          } 
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->rs_contador = false;
          $this->rs_contador_erro = $this->Db->ErrorMsg();
      } 


	if($this->rs_contador[0][0]>0){
		$update_sql = "UPDATE  jap_ruta_contrato
					SET rc_orden=rc_orden+1 
					WHERE
					rc_ruta=".$this->con_ruta ."
					and rc_orden>=".$this->con_orden_lecturas .";";
	...
	$insert_sql="INSERT INTO jap_ruta_contrato(rc_id, rc_ruta, rc_contrato, rc_orden) 
				VALUES(
				 (SELECT coalesce(max(rc_id),0)+1 FROM  jap_ruta_contrato),
				 ".$this->con_ruta .",
				 ".$this->con_id .",
	...
	$update_sql="UPDATE jap_contrato 
						SET  con_orden_lecturas=rc_orden
						from jap_ruta_contrato
						WHERE con_id=rc_contrato 
						and con_ruta=rc_ruta 
						and rc_ruta=".$this->con_ruta ;
	...
	$check_sql = "Select * from  sp_jap_emite_deudas_contrato ('". $this->sc_temp_Igtech_RucEmpresa."',"
																 . $this->con_id .",'"
																 . $this->sc_temp_Igtech_SesionLogin."','"
	...
	$exec_sql="SELECT sp_envio_materiales_contrato_al_kardex(".$this->con_id .")";
	...
	if ($this->rs[0][0]=="SI"){
		$select_sql="SELECT distinct cc_contrato,cc_operacion 
					 FROM jap_cuotas_contrato 
					 WHERE cc_contrato=".$this->con_id ."
   ...
   function Recupera_Nome_Campo($campo) 
   {
       switch($campo)
       {
           ...
           case 'con_direccion_propietario':
               return "" . $this->Ini->Nm_lang['lang_lot_direccion_propietario'] . "";
               break;
           case 'con_correo':
           ...
           case 'con_numero_corte':
               return "Con Numero Corte";
               break;
           case 'materiales':
               return "" . $this->Ini->Nm_lang['lang_materiales'] . "";
               break;
           case 'rubros':
               return "" . $this->Ini->Nm_lang['lang_rubros'] . "";
               break;
           ...
           case 'con_saldo_pagar':
               ...
               break;
           case 'con_plazo':
               return "Nro. " . $this->Ini->Nm_lang['lang_cuotas'] . "";
               break;
           case 'con_valor_cuota':
               return "" . $this->Ini->Nm_lang['lang_cuotas_de'] . "";
               break;
           case 'cuotas':
               return "" . $this->Ini->Nm_lang['lang_cuotas'] . "";
               break;
           case 'con_empresa':
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_jap_contrato_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_jap_contrato_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_jap_contrato_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_jap_contrato_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'materiales' == $filtro)) || (is_array($filtro) && in_array('materiales', $filtro)))
        $this->ValidateField_materiales($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "materiales";

      if ((!is_array($filtro) && ('' == $filtro || 'rubros' == $filtro)) || (is_array($filtro) && in_array('rubros', $filtro)))
        $this->ValidateField_rubros($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "rubros";

      if ((!is_array($filtro) && ('' == $filtro || 'con_total_a_pagar' == $filtro)) || (is_array($filtro) && in_array('con_total_a_pagar', $filtro)))
        $this->ValidateField_con_total_a_pagar($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "con_total_a_pagar";

      if ((!is_array($filtro) && ('' == $filtro || 'con_abono' == $filtro)) || (is_array($filtro) && in_array('con_abono', $filtro)))
        $this->ValidateField_con_abono($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "con_abono";

      if ((!is_array($filtro) && ('' == $filtro || 'con_saldo_pagar' == $filtro)) || (is_array($filtro) && in_array('con_saldo_pagar', $filtro)))
        $this->ValidateField_con_saldo_pagar($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "con_saldo_pagar";

      if ((!is_array($filtro) && ('' == $filtro || 'con_plazo' == $filtro)) || (is_array($filtro) && in_array('con_plazo', $filtro)))
        $this->ValidateField_con_plazo($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "con_plazo";

      if ((!is_array($filtro) && ('' == $filtro || 'con_valor_cuota' == $filtro)) || (is_array($filtro) && in_array('con_valor_cuota', $filtro)))
        $this->ValidateField_con_valor_cuota($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "con_valor_cuota";

      if ((!is_array($filtro) && ('' == $filtro || 'cuotas' == $filtro)) || (is_array($filtro) && in_array('cuotas', $filtro)))
        $this->ValidateField_cuotas($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "cuotas";

      if ((!is_array($filtro) && ('' == $filtro || 'con_empresa' == $filtro)) || (is_array($filtro) && in_array('con_empresa', $filtro)))
        $this->ValidateField_con_empresa($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "con_empresa";
...
//---
    ...
    function ValidateField_con_numero_contrato(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      $this->con_numero_contrato = sc_strtoupper($this->con_numero_contrato); 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->con_numero_contrato) > 255) 
          { 
              $hasError = true;
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_numero_contrato'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 255 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
   ...
   if (isset($this->Field_no_validate['con_tipo_contrato'])) {
      ...
      if ($this->con_tipo_contrato == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['php_cmp_required']['con_tipo_contrato']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['php_cmp_required']['con_tipo_contrato'] == "on"))
      {
          $hasError = true;
          $Campos_Falta[] = "" . $this->Ini->Nm_lang['lang_tipo_contrato'] . "" ; 
          if (!isset($Campos_Erros['con_tipo_contrato']))
          {
              $Campos_Erros['con_tipo_contrato'] = array();
          }
          $Campos_Erros['con_tipo_contrato'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
          ...
          $this->NM_ajax_info['errList']['con_tipo_contrato'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
      }
          if (!empty($this->con_tipo_contrato) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_tipo_contrato']) && !in_array($this->con_tipo_contrato, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_tipo_contrato']))
          {
              $hasError = true;
   ...
   if (isset($this->Field_no_validate['con_propietario'])) {
      ...
      if ($this->con_propietario == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['php_cmp_required']['con_propietario']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['php_cmp_required']['con_propietario'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->con_propietario) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_propietario']) && !in_array($this->con_propietario, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_propietario']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['con_propietario']))
   ...
   if (isset($this->Field_no_validate['con_pais'])) {
      ...
      if ($this->con_pais == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['php_cmp_required']['con_pais']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['php_cmp_required']['con_pais'] == "on"))
      {
          $hasError = true;
          ...
          $Campos_Erros['con_pais'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
          ...
          $this->NM_ajax_info['errList']['con_pais'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
      }
          if (!empty($this->con_pais) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_pais']) && !in_array($this->con_pais, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_pais']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['con_pais']))
   ...
   if (isset($this->Field_no_validate['con_provincia'])) {
      ...
      if ($this->con_provincia == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['php_cmp_required']['con_provincia']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['php_cmp_required']['con_provincia'] == "on"))
      {
          $hasError = true;
          ...
          $Campos_Erros['con_provincia'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
          ...
          $this->NM_ajax_info['errList']['con_provincia'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
      }
          if (!empty($this->con_provincia) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_provincia']) && !in_array($this->con_provincia, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_provincia']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['con_provincia']))
   ...
   if (isset($this->Field_no_validate['con_canton'])) {
      ...
      if ($this->con_canton == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['php_cmp_required']['con_canton']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['php_cmp_required']['con_canton'] == "on"))
      {
          $hasError = true;
          ...
          $Campos_Erros['con_canton'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
          ...
          $this->NM_ajax_info['errList']['con_canton'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
      }
          if (!empty($this->con_canton) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_canton']) && !in_array($this->con_canton, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_canton']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['con_canton']))
   ...
   if (isset($this->Field_no_validate['con_parroquia'])) {
      ...
      if ($this->con_parroquia == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['php_cmp_required']['con_parroquia']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['php_cmp_required']['con_parroquia'] == "on"))
      {
          $hasError = true;
          ...
          $Campos_Erros['con_parroquia'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
          ...
          $this->NM_ajax_info['errList']['con_parroquia'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
      }
          if (!empty($this->con_parroquia) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_parroquia']) && !in_array($this->con_parroquia, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_parroquia']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['con_parroquia']))
   ...
   if (isset($this->Field_no_validate['con_comunidad'])) {
       return;
               ...
               if (!empty($this->con_comunidad) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_comunidad']) && !in_array($this->con_comunidad, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_comunidad']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['con_sector'])) {
       return;
               ...
               if (!empty($this->con_sector) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_sector']) && !in_array($this->con_sector, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_sector']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_con_direccion_predio(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['php_cmp_required']['con_direccion_predio']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['php_cmp_required']['con_direccion_predio'] == "on")) 
      { 
          if ($this->con_direccion_predio == "")  
          { 
              $hasError = true;
              ...
              $Campos_Erros['con_direccion_predio'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
                  ...
                  $this->NM_ajax_info['errList']['con_direccion_predio'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
          } 
      } 
      if ($this->nmgp_opcao != "excluir") 
      { 
   ...
   if (isset($this->Field_no_validate['con_toma_administrativa'])) {
       return;
               ...
               if (!empty($this->con_toma_administrativa) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_toma_administrativa']) && !in_array($this->con_toma_administrativa, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_toma_administrativa']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['con_toma_operativa'])) {
       return;
               ...
               if (!empty($this->con_toma_operativa) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_toma_operativa']) && !in_array($this->con_toma_operativa, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_toma_operativa']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['con_tipo_servicio'])) {
       return;
               ...
               if (!empty($this->con_tipo_servicio) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_tipo_servicio']) && !in_array($this->con_tipo_servicio, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_tipo_servicio']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['con_condicion_contrato'])) {
       return;
               ...
               if (!empty($this->con_condicion_contrato) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_condicion_contrato']) && !in_array($this->con_condicion_contrato, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_condicion_contrato']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['con_ruta'])) {
       return;
               ...
               if (!empty($this->con_ruta) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_ruta']) && !in_array($this->con_ruta, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_ruta']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
...
;
    ...
    function ValidateField_con_numero_corte(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $hasError = true;
                  $Campos_Crit .= "Con Numero Corte: " . $this->Ini->Nm_lang['lang_errm_size']; 
    ...
    function ValidateField_materiales(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['materiales'])) {
          return;
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (trim($this->materiales) != "")  
          { 
          } 
      } 
        if ($hasError) {
    ...
    } // ValidateField_materiales

    function ValidateField_rubros(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['rubros'])) {
          return;
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
    ...
    } // ValidateField_rubros

    function ValidateField_con_total_a_pagar(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['con_total_a_pagar'])) {
          if (!empty($this->field_config['con_total_a_pagar']['symbol_dec'])) {
              nm_limpa_valor($this->con_total_a_pagar, $this->field_config['con_total_a_pagar']['symbol_dec'], $this->field_config['con_total_a_pagar']['symbol_grp']) ; 
          }
          return;
      ...
      {
          nm_limpa_valor($this->con_total_a_pagar, $this->field_config['con_total_a_pagar']['symbol_dec'], $this->field_config['con_total_a_pagar']['symbol_grp']) ; 
          if ('.' == substr($this->con_total_a_pagar, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->con_total_a_pagar, 1)))
              {
                  $this->con_total_a_pagar = '';
              }
              else
              {
                  $this->con_total_a_pagar = '0' . $this->con_total_a_pagar;
              }
          }
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          { 
              $iTestSize = 18;
              if (strlen($this->con_total_a_pagar) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_total_pagar'] . ": " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['con_total_a_pagar']))
                  {
                      $Campos_Erros['con_total_a_pagar'] = array();
                  }
                  $Campos_Erros['con_total_a_pagar'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['con_total_a_pagar']) || !is_array($this->NM_ajax_info['errList']['con_total_a_pagar']))
                  {
                      $this->NM_ajax_info['errList']['con_total_a_pagar'] = array();
                  }
                  $this->NM_ajax_info['errList']['con_total_a_pagar'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->con_total_a_pagar, 15, 2, -0, 1.0E+17, "N") == false)  
              { 
                  $hasError = true;
                  ...
                  $Campos_Erros['con_total_a_pagar'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['con_total_a_pagar']) || !is_array($this->NM_ajax_info['errList']['con_total_a_pagar']))
                  {
                      $this->NM_ajax_info['errList']['con_total_a_pagar'] = array();
                  }
                  $this->NM_ajax_info['errList']['con_total_a_pagar'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'con_total_a_pagar';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_con_total_a_pagar

    function ValidateField_con_abono(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['con_abono'])) {
          if (!empty($this->field_config['con_abono']['symbol_dec'])) {
              nm_limpa_valor($this->con_abono, $this->field_config['con_abono']['symbol_dec'], $this->field_config['con_abono']['symbol_grp']) ; 
          }
          return;
      ...
      {
          nm_limpa_valor($this->con_abono, $this->field_config['con_abono']['symbol_dec'], $this->field_config['con_abono']['symbol_grp']) ; 
          if ('.' == substr($this->con_abono, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->con_abono, 1)))
              {
                  $this->con_abono = '';
              }
              else
              {
                  $this->con_abono = '0' . $this->con_abono;
              }
          }
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          { 
              $iTestSize = 18;
              if (strlen($this->con_abono) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_abono'] . ": " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['con_abono']))
                  {
                      $Campos_Erros['con_abono'] = array();
                  }
                  $Campos_Erros['con_abono'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['con_abono']) || !is_array($this->NM_ajax_info['errList']['con_abono']))
                  {
                      $this->NM_ajax_info['errList']['con_abono'] = array();
                  }
                  $this->NM_ajax_info['errList']['con_abono'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->con_abono, 15, 2, -0, 1.0E+17, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_abono'] . "; " ; 
                  if (!isset($Campos_Erros['con_abono']))
                  {
                      $Campos_Erros['con_abono'] = array();
                  }
                  $Campos_Erros['con_abono'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['con_abono']) || !is_array($this->NM_ajax_info['errList']['con_abono']))
                  {
                      $this->NM_ajax_info['errList']['con_abono'] = array();
                  }
                  $this->NM_ajax_info['errList']['con_abono'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
    ...
    } // ValidateField_con_abono

    function ValidateField_con_saldo_pagar(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['con_saldo_pagar'])) {
          if (!empty($this->field_config['con_saldo_pagar']['symbol_dec'])) {
              nm_limpa_valor($this->con_saldo_pagar, $this->field_config['con_saldo_pagar']['symbol_dec'], $this->field_config['con_saldo_pagar']['symbol_grp']) ; 
          }
          return;
      }
      if ($this->con_saldo_pagar === "" || is_null($this->con_saldo_pagar))  
      { 
          $this->con_saldo_pagar = 0;
          $this->sc_force_zero[] = 'con_saldo_pagar';
      } 
      if (!empty($this->field_config['con_saldo_pagar']['symbol_dec']))
      {
          nm_limpa_valor($this->con_saldo_pagar, $this->field_config['con_saldo_pagar']['symbol_dec'], $this->field_config['con_saldo_pagar']['symbol_grp']) ; 
          if ('.' == substr($this->con_saldo_pagar, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->con_saldo_pagar, 1)))
              {
                  $this->con_saldo_pagar = '';
              }
              else
              {
                  $this->con_saldo_pagar = '0' . $this->con_saldo_pagar;
              }
          }
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->con_saldo_pagar != '')  
          { 
              $iTestSize = 21;
              if (strlen($this->con_saldo_pagar) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_saldo_pagar'] . ": " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['con_saldo_pagar']))
                  {
                      $Campos_Erros['con_saldo_pagar'] = array();
                  }
                  $Campos_Erros['con_saldo_pagar'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['con_saldo_pagar']) || !is_array($this->NM_ajax_info['errList']['con_saldo_pagar']))
                  {
                      $this->NM_ajax_info['errList']['con_saldo_pagar'] = array();
                  }
                  $this->NM_ajax_info['errList']['con_saldo_pagar'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->con_saldo_pagar, 18, 2, -0, 1.0E+20, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_saldo_pagar'] . "; " ; 
                  if (!isset($Campos_Erros['con_saldo_pagar']))
                  {
                      $Campos_Erros['con_saldo_pagar'] = array();
                  }
                  $Campos_Erros['con_saldo_pagar'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['con_saldo_pagar']) || !is_array($this->NM_ajax_info['errList']['con_saldo_pagar']))
                  {
                      $this->NM_ajax_info['errList']['con_saldo_pagar'] = array();
                  }
                  $this->NM_ajax_info['errList']['con_saldo_pagar'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'con_saldo_pagar';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_con_saldo_pagar

    function ValidateField_con_plazo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['con_plazo'])) {
          nm_limpa_numero($this->con_plazo, $this->field_config['con_plazo']['symbol_grp']) ; 
          return;
      }
      ...
      { 
          ...
          { 
              $iTestSize = 4;
              if (strlen($this->con_plazo) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Nro. " . $this->Ini->Nm_lang['lang_cuotas'] . ": " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['con_plazo']))
                  {
                      $Campos_Erros['con_plazo'] = array();
                  }
                  $Campos_Erros['con_plazo'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['con_plazo']) || !is_array($this->NM_ajax_info['errList']['con_plazo']))
                  {
                      $this->NM_ajax_info['errList']['con_plazo'] = array();
                  }
                  $this->NM_ajax_info['errList']['con_plazo'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->con_plazo, 4, 0, 1, 12, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Nro. " . $this->Ini->Nm_lang['lang_cuotas'] . "; " ; 
                  if (!isset($Campos_Erros['con_plazo']))
                  {
                      $Campos_Erros['con_plazo'] = array();
                  }
                  $Campos_Erros['con_plazo'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['con_plazo']) || !is_array($this->NM_ajax_info['errList']['con_plazo']))
                  {
                      $this->NM_ajax_info['errList']['con_plazo'] = array();
                  }
                  $this->NM_ajax_info['errList']['con_plazo'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
    ...
    } // ValidateField_con_plazo

    function ValidateField_con_valor_cuota(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['con_valor_cuota'])) {
          if (!empty($this->field_config['con_valor_cuota']['symbol_dec'])) {
              nm_limpa_valor($this->con_valor_cuota, $this->field_config['con_valor_cuota']['symbol_dec'], $this->field_config['con_valor_cuota']['symbol_grp']) ; 
          }
          return;
      }
      if ($this->con_valor_cuota === "" || is_null($this->con_valor_cuota))  
      { 
          $this->con_valor_cuota = 0;
          $this->sc_force_zero[] = 'con_valor_cuota';
      } 
      if (!empty($this->field_config['con_valor_cuota']['symbol_dec']))
      {
          nm_limpa_valor($this->con_valor_cuota, $this->field_config['con_valor_cuota']['symbol_dec'], $this->field_config['con_valor_cuota']['symbol_grp']) ; 
          if ('.' == substr($this->con_valor_cuota, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->con_valor_cuota, 1)))
              {
                  $this->con_valor_cuota = '';
              }
              else
              {
                  $this->con_valor_cuota = '0' . $this->con_valor_cuota;
              }
          }
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->con_valor_cuota != '')  
          { 
              $iTestSize = 21;
              if (strlen($this->con_valor_cuota) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_cuotas_de'] . ": " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['con_valor_cuota']))
                  {
                      $Campos_Erros['con_valor_cuota'] = array();
                  }
                  $Campos_Erros['con_valor_cuota'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['con_valor_cuota']) || !is_array($this->NM_ajax_info['errList']['con_valor_cuota']))
                  {
                      $this->NM_ajax_info['errList']['con_valor_cuota'] = array();
                  }
                  $this->NM_ajax_info['errList']['con_valor_cuota'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->con_valor_cuota, 18, 2, -0, 1.0E+20, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_cuotas_de'] . "; " ; 
                  if (!isset($Campos_Erros['con_valor_cuota']))
                  {
                      $Campos_Erros['con_valor_cuota'] = array();
                  }
                  $Campos_Erros['con_valor_cuota'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['con_valor_cuota']) || !is_array($this->NM_ajax_info['errList']['con_valor_cuota']))
                  {
                      $this->NM_ajax_info['errList']['con_valor_cuota'] = array();
                  }
                  $this->NM_ajax_info['errList']['con_valor_cuota'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'con_valor_cuota';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_con_valor_cuota

    function ValidateField_cuotas(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['cuotas'])) {
          return;
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
    ...
    } // ValidateField_cuotas

    function ValidateField_con_empresa(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['con_empresa'])) {
          return;
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->con_empresa) > 13) 
          { 
              $hasError = true;
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_empresa'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 13 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['con_empresa']))
              {
                  $Campos_Erros['con_empresa'] = array();
              }
              $Campos_Erros['con_empresa'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 13 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['con_empresa']) || !is_array($this->NM_ajax_info['errList']['con_empresa']))
              {
                  $this->NM_ajax_info['errList']['con_empresa'] = array();
              }
              $this->NM_ajax_info['errList']['con_empresa'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 13 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'con_empresa';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_con_empresa
   ...
   function nm_guardar_campos()
   {
    ...
    $this->nmgp_dados_form['materiales'] = $this->materiales;
    $this->nmgp_dados_form['rubros'] = $this->rubros;
    ...
    $this->nmgp_dados_form['cuotas'] = $this->cuotas;
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_form'] = $this->nmgp_dados_form;
   }
   ...
   function nm_formatar_campos($format_fields = array())
   {
     ...
     $this->formatado = true;
      ...
      if ('' !== $this->con_total_a_pagar || (!empty($format_fields) && isset($format_fields['con_total_a_pagar'])))
      {
          nmgp_Form_Num_Val($this->con_total_a_pagar, $this->field_config['con_total_a_pagar']['symbol_grp'], $this->field_config['con_total_a_pagar']['symbol_dec'], "2", "S", $this->field_config['con_total_a_pagar']['format_neg'], "", "", "-", $this->field_config['con_total_a_pagar']['symbol_fmt']) ; 
      }
      if ('' !== $this->con_abono || (!empty($format_fields) && isset($format_fields['con_abono'])))
      {
          nmgp_Form_Num_Val($this->con_abono, $this->field_config['con_abono']['symbol_grp'], $this->field_config['con_abono']['symbol_dec'], "2", "S", $this->field_config['con_abono']['format_neg'], "", "", "-", $this->field_config['con_abono']['symbol_fmt']) ; 
      }
      if ('' !== $this->con_saldo_pagar || (!empty($format_fields) && isset($format_fields['con_saldo_pagar'])))
      {
          nmgp_Form_Num_Val($this->con_saldo_pagar, $this->field_config['con_saldo_pagar']['symbol_grp'], $this->field_config['con_saldo_pagar']['symbol_dec'], "2", "S", $this->field_config['con_saldo_pagar']['format_neg'], "", "", "-", $this->field_config['con_saldo_pagar']['symbol_fmt']) ; 
      }
      if ('' !== $this->con_plazo || (!empty($format_fields) && isset($format_fields['con_plazo'])))
      {
          nmgp_Form_Num_Val($this->con_plazo, $this->field_config['con_plazo']['symbol_grp'], $this->field_config['con_plazo']['symbol_dec'], "0", "S", $this->field_config['con_plazo']['format_neg'], "", "", "-", $this->field_config['con_plazo']['symbol_fmt']) ; 
      }
      if ('' !== $this->con_valor_cuota || (!empty($format_fields) && isset($format_fields['con_valor_cuota'])))
      {
          nmgp_Form_Num_Val($this->con_valor_cuota, $this->field_config['con_valor_cuota']['symbol_grp'], $this->field_config['con_valor_cuota']['symbol_dec'], "2", "S", $this->field_config['con_valor_cuota']['format_neg'], "", "", "-", $this->field_config['con_valor_cuota']['symbol_fmt']) ; 
      }
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          $this->ajax_return_values_materiales();
          $this->ajax_return_values_rubros();
          $this->ajax_return_values_con_total_a_pagar();
          $this->ajax_return_values_con_abono();
          $this->ajax_return_values_con_saldo_pagar();
          $this->ajax_return_values_con_plazo();
          $this->ajax_return_values_con_valor_cuota();
          $this->ajax_return_values_cuotas();
          $this->ajax_return_values_con_empresa();
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              $this->NM_ajax_info['clearUpload']      = 'S';
              $this->NM_ajax_info['navStatus']['ret'] = $this->Nav_permite_ret ? 'S' : 'N';
              $this->NM_ajax_info['navStatus']['ava'] = $this->Nav_permite_ava ? 'S' : 'N';
              $this->NM_ajax_info['fldList']['con_id']['keyVal'] = form_jap_contrato_mob_pack_protect_string($this->nmgp_dados_form['con_id']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['form_jap_rubro_contrato_mob_script_case_init'] ]['form_jap_rubro_contrato_mob']['foreign_key']['rc_contrato'] = $this->nmgp_dados_form['con_id'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['form_jap_rubro_contrato_mob_script_case_init'] ]['form_jap_rubro_contrato_mob']['where_filter'] = "rc_contrato = " . $this->nmgp_dados_form['con_id'] . "";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['form_jap_rubro_contrato_mob_script_case_init'] ]['form_jap_rubro_contrato_mob']['where_detal']  = "rc_contrato = " . $this->nmgp_dados_form['con_id'] . "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['form_jap_rubro_contrato_mob_script_case_init'] ]['form_jap_rubro_contrato_mob']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['form_jap_rubro_contrato_mob_script_case_init'] ]['form_jap_rubro_contrato_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['form_jap_rubro_contrato_mob_script_case_init'] ]['form_jap_rubro_contrato_mob']['total']);
              foreach ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['form_jap_rubro_contrato_mob_script_case_init'] ]['form_jap_rubro_contrato_mob'] as $i => $v)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['form_jap_rubro_contrato_mob_script_case_init'] ]['form_jap_rubro_contrato'][$i] = $v;
              }
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['form_jap_rubro_contrato_mob_script_case_init'] ]['form_jap_rubro_contrato_mob']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['form_jap_rubro_contrato_mob_script_case_init'] ]['form_jap_rubro_contrato_mob']['total']);
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['grid_jap_cuotas_contrato_script_case_init'] ]['grid_jap_cuotas_contrato']['embutida_form_full'] = false;
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['grid_jap_cuotas_contrato_script_case_init'] ]['grid_jap_cuotas_contrato']['embutida_form']       = true;
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['grid_jap_cuotas_contrato_script_case_init'] ]['grid_jap_cuotas_contrato']['embutida_pai']        = "form_jap_contrato_mob";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['grid_jap_cuotas_contrato_script_case_init'] ]['grid_jap_cuotas_contrato']['embutida_form_parms'] = "var_contrato*scin" . $this->nmgp_dados_form['con_id'] . "*scoutNMSC_inicial*scininicio*scoutNMSC_paginacao*scinFULL*scoutNMSC_cab*scinN*scoutNMSC_nav*scinN*scout";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['grid_jap_cuotas_contrato_script_case_init'] ]['grid_jap_cuotas_contrato']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['grid_jap_cuotas_contrato_script_case_init'] ]['grid_jap_cuotas_contrato']['total']);
              foreach ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['grid_jap_cuotas_contrato_script_case_init'] ]['grid_jap_cuotas_contrato'] as $i => $v)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['grid_jap_cuotas_contrato_script_case_init'] ]['grid_jap_cuotas_contrato'][$i] = $v;
              }
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['grid_jap_cuotas_contrato_script_case_init'] ]['grid_jap_cuotas_contrato']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['grid_jap_cuotas_contrato_script_case_init'] ]['grid_jap_cuotas_contrato']['total']);
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['foreign_key']['mc_contrato'] = $this->nmgp_dados_form['con_id'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['where_filter'] = "mc_contrato = " . $this->nmgp_dados_form['con_id'] . "";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['where_detal']  = "mc_contrato = " . $this->nmgp_dados_form['con_id'] . "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['total']);
              foreach ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob'] as $i => $v)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato'][$i] = $v;
              }
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['total']);
              }
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_tipo_contrato']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_tipo_contrato'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_tipo_contrato']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_tipo_contrato'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   $old_value_con_total_a_pagar = $this->con_total_a_pagar;
   $old_value_con_abono = $this->con_abono;
   $old_value_con_saldo_pagar = $this->con_saldo_pagar;
   $old_value_con_plazo = $this->con_plazo;
   $old_value_con_valor_cuota = $this->con_valor_cuota;
   $this->nm_tira_formatacao();
   if ($this->nmgp_opcao != "nada") {
   ...
   $unformatted_value_con_total_a_pagar = $this->con_total_a_pagar;
   $unformatted_value_con_abono = $this->con_abono;
   $unformatted_value_con_saldo_pagar = $this->con_saldo_pagar;
   $unformatted_value_con_plazo = $this->con_plazo;
   $unformatted_value_con_valor_cuota = $this->con_valor_cuota;
   ...
   $this->con_total_a_pagar = $old_value_con_total_a_pagar;
   $this->con_abono = $old_value_con_abono;
   $this->con_saldo_pagar = $old_value_con_saldo_pagar;
   $this->con_plazo = $old_value_con_plazo;
   $this->con_valor_cuota = $old_value_con_valor_cuota;
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_jap_contrato_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_jap_contrato_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_tipo_contrato'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['con_tipo_contrato']['valList'][$i] = form_jap_contrato_mob_pack_protect_string($v);
          }
   ...
   function ajax_return_values_con_propietario($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("con_propietario", $this->nmgp_refresh_fields)) || $bForce)
          {
              ...
              $aLookup = array();
              $this->_tmp_lookup_con_propietario = $this->con_propietario;

 
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_propietario']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_propietario'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_propietario']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_propietario'] = array(); 
}
$aLookup[] = array(form_jap_contrato_mob_pack_protect_string('') => str_replace('<', '&lt;',form_jap_contrato_mob_pack_protect_string('' . $this->Ini->Nm_lang['lang_seleccione'] . '')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_propietario'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   $nm_comando = "SELECT cl_id, cl_identificacion|| '-' || cl_nombre FROM del_cliente  WHERE cl_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "' ORDER BY cl_nombre";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_propietario'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"con_propietario\"";
          if (isset($this->NM_ajax_info['select_html']['con_propietario']) && !empty($this->NM_ajax_info['select_html']['con_propietario']))
          {
              $sSelComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['con_propietario']);
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->con_propietario == $sValue)
                  {
                      $this->_tmp_lookup_con_propietario = $sLabel;
                  }
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['con_propietario']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['con_propietario']['valList'][$i] = form_jap_contrato_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['con_propietario']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['con_propietario']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['con_propietario']['labList'] = $aLabel;
          }
   }
   ...
   function ajax_return_values_con_estado($bForce = false)
   {
          ...
          $this->NM_ajax_info['fldList']['con_estado'] = array(
              ...
              $this->NM_ajax_info['fldList']['con_estado']['lookupCons'] = form_jap_contrato_mob_pack_protect_string(NM_charset_to_utf8($conteudo));
          }
   }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_pais']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_pais'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_pais']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_pais'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_pais'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['con_pais']['valList'][$i] = form_jap_contrato_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_provincia']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_provincia'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_provincia']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_provincia'] = array(); 
}
if ($this->con_pais != "")
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_provincia'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['con_provincia']['valList'][$i] = form_jap_contrato_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_canton']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_canton'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_canton']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_canton'] = array(); 
}
...
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_canton'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['con_canton']['valList'][$i] = form_jap_contrato_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_parroquia']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_parroquia'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_parroquia']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_parroquia'] = array(); 
}
$aLookup[] = array(form_jap_contrato_mob_pack_protect_string('') => str_replace('<', '&lt;',form_jap_contrato_mob_pack_protect_string('' . $this->Ini->Nm_lang['lang_seleccione'] . '')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_parroquia'][] = '';
if ($this->con_canton != "")
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_parroquia'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['con_parroquia']['valList'][$i] = form_jap_contrato_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_comunidad']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_comunidad'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_comunidad']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_comunidad'] = array(); 
}
$aLookup[] = array(form_jap_contrato_mob_pack_protect_string('0') => str_replace('<', '&lt;',form_jap_contrato_mob_pack_protect_string('' . $this->Ini->Nm_lang['lang_seleccione'] . '')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_comunidad'][] = '0';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_comunidad'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['con_comunidad']['valList'][$i] = form_jap_contrato_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_sector']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_sector'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_sector']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_sector'] = array(); 
}
$aLookup[] = array(form_jap_contrato_mob_pack_protect_string('0') => str_replace('<', '&lt;',form_jap_contrato_mob_pack_protect_string('' . $this->Ini->Nm_lang['lang_seleccione'] . '')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_sector'][] = '0';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_sector'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['con_sector']['valList'][$i] = form_jap_contrato_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_toma_administrativa']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_toma_administrativa'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_toma_administrativa']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_toma_administrativa'] = array(); 
}
$aLookup[] = array(form_jap_contrato_mob_pack_protect_string('0') => str_replace('<', '&lt;',form_jap_contrato_mob_pack_protect_string('' . $this->Ini->Nm_lang['lang_seleccione'] . '')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_toma_administrativa'][] = '0';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_toma_administrativa'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['con_toma_administrativa']['valList'][$i] = form_jap_contrato_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_toma_operativa']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_toma_operativa'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_toma_operativa']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_toma_operativa'] = array(); 
}
$aLookup[] = array(form_jap_contrato_mob_pack_protect_string('0') => str_replace('<', '&lt;',form_jap_contrato_mob_pack_protect_string('' . $this->Ini->Nm_lang['lang_seleccione'] . '')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_toma_operativa'][] = '0';
if ($this->con_toma_administrativa != "")
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_toma_operativa'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['con_toma_operativa']['valList'][$i] = form_jap_contrato_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_tipo_servicio']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_tipo_servicio'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_tipo_servicio']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_tipo_servicio'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_tipo_servicio'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['con_tipo_servicio']['valList'][$i] = form_jap_contrato_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_condicion_contrato']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_condicion_contrato'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_condicion_contrato']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_condicion_contrato'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_condicion_contrato'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['con_condicion_contrato']['valList'][$i] = form_jap_contrato_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_ruta']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_ruta'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_ruta']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_ruta'] = array(); 
}
$aLookup[] = array(form_jap_contrato_mob_pack_protect_string('') => str_replace('<', '&lt;',form_jap_contrato_mob_pack_protect_string('' . $this->Ini->Nm_lang['lang_seleccione'] . '')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_ruta'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_ruta'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['con_ruta']['valList'][$i] = form_jap_contrato_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_con_usuario_instala($bForce = false)
   {
          ...
          $this->NM_ajax_info['fldList']['con_usuario_instala'] = array(
              ...
              $this->NM_ajax_info['fldList']['con_usuario_instala']['lookupCons'] = form_jap_contrato_mob_pack_protect_string(NM_charset_to_utf8($conteudo));
          }
   }
   ...
   function ajax_return_values_con_numero_corte($bForce = false)
   {
          ...
          //----- materiales
   function ajax_return_values_materiales($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("materiales", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->materiales);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['materiales'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
          ...
          //----- rubros
   function ajax_return_values_rubros($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("rubros", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->rubros);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['rubros'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
          ...
          //----- con_total_a_pagar
   function ajax_return_values_con_total_a_pagar($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("con_total_a_pagar", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->con_total_a_pagar);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['con_total_a_pagar'] = array(
                       'row'    => '',
               'type'    => 'label',
               'valList' => array($sTmpValue),
              );
          ...
          //----- con_abono
   function ajax_return_values_con_abono($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("con_abono", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->con_abono);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['con_abono'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
          ...
          //----- con_saldo_pagar
   function ajax_return_values_con_saldo_pagar($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("con_saldo_pagar", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->con_saldo_pagar);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['con_saldo_pagar'] = array(
                       'row'    => '',
               'type'    => 'label',
               'valList' => array($sTmpValue),
              );
          ...
          //----- con_plazo
   function ajax_return_values_con_plazo($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("con_plazo", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->con_plazo);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['con_plazo'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
          ...
          //----- con_valor_cuota
   function ajax_return_values_con_valor_cuota($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("con_valor_cuota", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->con_valor_cuota);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['con_valor_cuota'] = array(
                       'row'    => '',
               'type'    => 'label',
               'valList' => array($sTmpValue),
              );
          ...
          //----- cuotas
   function ajax_return_values_cuotas($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("cuotas", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->cuotas);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['cuotas'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
          ...
          //----- con_empresa
   function ajax_return_values_con_empresa($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("con_empresa", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->con_empresa);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['con_empresa'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
   ...
   {
       $this->NM_ajax_info['btnVars']['var_btn_ImprimirSolicitud_var_contrato'] = $this->form_encode_input($this->nmgp_dados_form['con_id']);
       $this->NM_ajax_info['btnVars']['var_btn_ver_contratos_var_ruta'] = $this->form_encode_input($this->nmgp_dados_form['con_ruta']);
   } // ajax_add_parameters
  function nm_proc_onload($bFormat = true)
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Field_no_validate'] = array();
      if (!$this->NM_ajax_flag || !isset($this->nmgp_refresh_fields)) {
      $_SESSION['scriptcase']['form_jap_contrato_mob']['contr_erro'] = 'on';
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    $original_con_abono = $this->con_abono;
    ...
    $original_con_total_a_pagar = $this->con_total_a_pagar;
    $original_con_valor_cuota = $this->con_valor_cuota;
}
if (!isset($this->sc_temp_Igtech_RucEmpresa)) {$this->sc_temp_Igtech_RucEmpresa = (isset($_SESSION['Igtech_RucEmpresa'])) ? $_SESSION['Igtech_RucEmpresa'] : "";}
...
$this->NM_ajax_info['buttonDisplay']['enviar_legalizar'] = $this->nmgp_botoes["enviar_legalizar"] = 'off';;
$this->NM_ajax_info['buttonDisplay']['ver_contratos'] = $this->nmgp_botoes["ver_contratos"] = 'off';;

$this->NM_ajax_info['buttonDisplay']['btnImprimir'] = $this->nmgp_botoes["btnImprimir"] = 'off';;
$this->NM_ajax_info['buttonDisplay']['anular'] = $this->nmgp_botoes["anular"] = 'off';;
$this->NM_ajax_info['buttonDisplay']['legalizar'] = $this->nmgp_botoes["legalizar"] = 'off';;
...
if($this->rs_parametro[0][0]=="SI"){
	$this->sc_field_readonly("con_orden_lecturas", 'on');
}
...
if ($this->con_id ==''){
	$this->nmgp_cmp_hidden["con_id"] = 'off'; $this->NM_ajax_info['fieldDisplay']['con_id'] = 'off';
	$this->nmgp_cmp_hidden["con_numero_contrato"] = 'off'; $this->NM_ajax_info['fieldDisplay']['con_numero_contrato'] = 'off';
	...
	if (isset($this->rs[0][0])){
		$this->con_provincia  = $this->rs[0][0];
	}
	...
	if (isset($this->rs[0][0])){
		$this->con_canton  = $this->rs[0][0];
	}
	$check_sql = "SELECT sp_busca_parametro_ap ('".$this->sc_temp_Igtech_RucEmpresa."','PARRDEF', '612');";
	...
	if (isset($this->rs[0][0])){
		$this->con_parroquia  = $this->rs[0][0];
	}
}
if ($this->con_estado  == 'I'){
	$this->Ini->nm_hidden_blocos[4] = 'off'; $this->NM_ajax_info['blockDisplay']['4'] = 'off';
	$this->Ini->nm_hidden_blocos[3] = 'off'; $this->NM_ajax_info['blockDisplay']['3'] = 'off';
	$this->NM_ajax_info['buttonDisplay']['actualizar'] = $this->nmgp_botoes["actualizar"] = 'on';;
	$this->NM_ajax_info['buttonDisplay']['ImprimirSolicitud'] = $this->nmgp_botoes["ImprimirSolicitud"] = 'on';;
...
if($this->con_estado  == 'X'){
	...
	$this->NM_ajax_info['buttonDisplay']['actualizar'] = $this->nmgp_botoes["actualizar"] = 'off';;
	$this->NM_ajax_info['buttonDisplay']['enviar_inspeccion'] = $this->nmgp_botoes["enviar_inspeccion"] = 'off';;
	$this->NM_ajax_info['buttonDisplay']['enviar_legalizar'] = $this->nmgp_botoes["enviar_legalizar"] = 'on';;
	$this->NM_ajax_info['buttonDisplay']['btnImprimir'] = $this->nmgp_botoes["btnImprimir"] = 'off';;
	$this->NM_ajax_info['buttonDisplay']['anular'] = $this->nmgp_botoes["anular"] = 'on';;
	$this->NM_ajax_info['buttonDisplay']['ImprimirSolicitud'] = $this->nmgp_botoes["ImprimirSolicitud"] = 'off';;
	$this->NM_ajax_info['buttonDisplay']['ver_contratos'] = $this->nmgp_botoes["ver_contratos"] = 'on';;
	
	$this->nmgp_cmp_hidden["con_numero_contrato"] = 'off'; $this->NM_ajax_info['fieldDisplay']['con_numero_contrato'] = 'off';
	
	$this->sc_field_readonly("con_tipo_contrato", 'off');
	$this->sc_field_readonly("con_pais", 'off');
	$this->sc_field_readonly("con_provincia", 'off');
	$this->sc_field_readonly("con_canton", 'off');
	$this->sc_field_readonly("con_parroquia", 'off');
	$this->sc_field_readonly("con_direccion_predio", 'off');
	$this->sc_field_readonly("con_toma_administrativa", 'off');
	$this->sc_field_readonly("con_toma_operativa", 'off');
	$this->sc_field_readonly("con_tipo_servicio", 'off');
	$this->sc_field_readonly("con_condicion_contrato", 'off');
	$this->sc_field_readonly("con_ruta", 'off');
}
if($this->con_estado  == 'L'){
	$this->Ini->nm_hidden_blocos[4] = 'on'; $this->NM_ajax_info['blockDisplay']['4'] = 'on';
	$this->Ini->nm_hidden_blocos[5] = 'off'; $this->NM_ajax_info['blockDisplay']['5'] = 'off';
	...
	$this->NM_ajax_info['buttonDisplay']['btnImprimir'] = $this->nmgp_botoes["btnImprimir"] = 'off';;
	$this->NM_ajax_info['buttonDisplay']['anular'] = $this->nmgp_botoes["anular"] = 'off';;
	$this->NM_ajax_info['buttonDisplay']['legalizar'] = $this->nmgp_botoes["legalizar"] = 'on';;
	$this->NM_ajax_info['buttonDisplay']['ver_contratos'] = $this->nmgp_botoes["ver_contratos"] = 'on';;
	
	$this->sc_field_readonly("con_propietario", 'on');
...
if($this->con_estado  == 'V'){
	...
	$this->NM_ajax_info['buttonDisplay']['enviar_legalizar'] = $this->nmgp_botoes["enviar_legalizar"] = 'off';;
	$this->NM_ajax_info['buttonDisplay']['anular'] = $this->nmgp_botoes["anular"] = 'off';;
	$this->NM_ajax_info['buttonDisplay']['btnImprimir'] = $this->nmgp_botoes["btnImprimir"] = 'on';;
	$this->NM_ajax_info['buttonDisplay']['ImprimirSolicitud'] = $this->nmgp_botoes["ImprimirSolicitud"] = 'off';;
	$this->NM_ajax_info['buttonDisplay']['legalizar'] = $this->nmgp_botoes["legalizar"] = 'off';;
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    if (($original_con_abono != $this->con_abono || (isset($bFlagRead_con_abono) && $bFlagRead_con_abono)))
    {
        $this->ajax_return_values_con_abono(true);
    }
    ...
    if (($original_con_id != $this->con_id || (isset($bFlagRead_con_id) && $bFlagRead_con_id)))
    {
        $this->ajax_return_values_con_id(true);
    }
    ...
    if (($original_con_numero_contrato != $this->con_numero_contrato || (isset($bFlagRead_con_numero_contrato) && $bFlagRead_con_numero_contrato)))
    {
        $this->ajax_return_values_con_numero_contrato(true);
    }
    ...
    if (($original_con_orden_lecturas != $this->con_orden_lecturas || (isset($bFlagRead_con_orden_lecturas) && $bFlagRead_con_orden_lecturas)))
    {
        $this->ajax_return_values_con_orden_lecturas(true);
    }
    ...
    if (($original_con_plazo != $this->con_plazo || (isset($bFlagRead_con_plazo) && $bFlagRead_con_plazo)))
    {
        $this->ajax_return_values_con_plazo(true);
    }
    ...
    if (($original_con_saldo_pagar != $this->con_saldo_pagar || (isset($bFlagRead_con_saldo_pagar) && $bFlagRead_con_saldo_pagar)))
    {
        $this->ajax_return_values_con_saldo_pagar(true);
    }
    ...
    if (($original_con_total_a_pagar != $this->con_total_a_pagar || (isset($bFlagRead_con_total_a_pagar) && $bFlagRead_con_total_a_pagar)))
    {
        $this->ajax_return_values_con_total_a_pagar(true);
    }
    if (($original_con_valor_cuota != $this->con_valor_cuota || (isset($bFlagRead_con_valor_cuota) && $bFlagRead_con_valor_cuota)))
    {
        $this->ajax_return_values_con_valor_cuota(true);
    }
}
$_SESSION['scriptcase']['form_jap_contrato_mob']['contr_erro'] = 'off'; 
      }
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->con_id)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['opcao'] = '';
   ...
   function return_after_insert()
   {
      ...
      if ('' != $this->con_id)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['reg_start'] = $rsc->fields[0];
          $rsc->Close();
      }
   }
   ...
   { 
      ...
      if ('incluir' == $this->nmgp_opcao && empty($this->con_empresa)) {$this->con_empresa = "" . $_SESSION['Igtech_RucEmpresa'] . ""; $NM_val_null[] = "con_empresa";}  
      ...
      $NM_val_form['materiales'] = $this->materiales;
      $NM_val_form['rubros'] = $this->rubros;
      ...
      $NM_val_form['cuotas'] = $this->cuotas;
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "incluir") 
      {
          ...
          $this->rubros_before_qstr = $this->rubros;
          $this->rubros = substr($this->Db->qstr($this->rubros), 1, -1); 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->rubros = str_replace(array("\\r\\n", "\\n", "\r\n"), array("\r\n", "\n", "\n"), $this->rubros);
          }
          if ($this->rubros == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->rubros = "null"; 
              $NM_val_null[] = "rubros";
          } 
          $this->cuotas_before_qstr = $this->cuotas;
          $this->cuotas = substr($this->Db->qstr($this->cuotas), 1, -1); 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->cuotas = str_replace(array("\\r\\n", "\\n", "\r\n"), array("\r\n", "\n", "\n"), $this->cuotas);
          }
          if ($this->cuotas == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->cuotas = "null"; 
              $NM_val_null[] = "cuotas";
          } 
          $this->materiales_before_qstr = $this->materiales;
          $this->materiales = substr($this->Db->qstr($this->materiales), 1, -1); 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->materiales = str_replace(array("\\r\\n", "\\n", "\r\n"), array("\r\n", "\n", "\n"), $this->materiales);
          }
          if ($this->materiales == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->materiales = "null"; 
              $NM_val_null[] = "materiales";
          } 
      }
      if ($this->nmgp_opcao == "alterar") 
      {
          $SC_fields_update = array(); 
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $this->rubros = $this->rubros_before_qstr;
              $this->cuotas = $this->cuotas_before_qstr;
              $this->materiales = $this->materiales_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['con_empresa'])) { $this->con_empresa = $NM_val_form['con_empresa']; }
              elseif (isset($this->con_empresa)) { $this->nm_limpa_alfa($this->con_empresa); }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['con_total_a_pagar'])) { $this->con_total_a_pagar = $NM_val_form['con_total_a_pagar']; }
              elseif (isset($this->con_total_a_pagar)) { $this->nm_limpa_alfa($this->con_total_a_pagar); }
              if     (isset($NM_val_form) && isset($NM_val_form['con_abono'])) { $this->con_abono = $NM_val_form['con_abono']; }
              elseif (isset($this->con_abono)) { $this->nm_limpa_alfa($this->con_abono); }
              if     (isset($NM_val_form) && isset($NM_val_form['con_plazo'])) { $this->con_plazo = $NM_val_form['con_plazo']; }
              elseif (isset($this->con_plazo)) { $this->nm_limpa_alfa($this->con_plazo); }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['rubros'])) { $this->rubros = $NM_val_form['rubros']; }
              elseif (isset($this->rubros)) { $this->nm_limpa_alfa($this->rubros); }
              if     (isset($NM_val_form) && isset($NM_val_form['cuotas'])) { $this->cuotas = $NM_val_form['cuotas']; }
              elseif (isset($this->cuotas)) { $this->nm_limpa_alfa($this->cuotas); }
              if     (isset($NM_val_form) && isset($NM_val_form['materiales'])) { $this->materiales = $NM_val_form['materiales']; }
              elseif (isset($this->materiales)) { $this->nm_limpa_alfa($this->materiales); }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['total']);
              }
              ...
              $this->NM_gera_log_new();
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          if ($bDelecaoOk)
          {
              $sDetailWhere = "rc_contrato = " . $this->con_id . "";
              $this->form_jap_rubro_contrato_mob->ini_controle();
              if ($this->form_jap_rubro_contrato_mob->temRegistros($sDetailWhere))
              {
                  $bDelecaoOk = false;
          ...
          if ($bDelecaoOk)
          {
              $sDetailWhere = "mc_contrato = " . $this->con_id . "";
              $this->form_jap_materiales_contrato_mob->ini_controle();
              if ($this->form_jap_materiales_contrato_mob->temRegistros($sDetailWhere))
              {
                  $bDelecaoOk = false;
                  $sMsgErro   = $this->Ini->Nm_lang['lang_errm_fkvi'];
              }
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
  ...
  $insert_sql="INSERT INTO jap_rubro_contrato( 
				...
				SELECT ".$this->con_id ."
				 ...
				 ,pro_precio
				 ,pro_por_iva
				 ,round(pro_precio*iva_porcentaje/100,2)
				 ,round(pro_precio*(100+iva_porcentaje)/100,2)
				 ,'R'
				FROM jap_productos_aportacion 
				inner join v_del_producto on pap_producto=pro_codigo and pap_empresa=pro_empresa
				where pap_aportacion=".$this->con_tipo_contrato ;
...
if (isset($this->rs[0][0])){
	...
	$this->con_total_a_pagar = $this->rs[0][0];
	$this->con_abono = 0;
	$this->con_saldo_pagar = $this->rs[0][0];
	$this->con_plazo = 1;
	$this->con_valor_cuota = $this->rs[0][0];
	
}
$delete_sql="DELETE FROM jap_cuotas_contrato WHERE cc_contrato=".$this->con_id ;
...
$_SESSION['scriptcase']['form_jap_contrato_mob']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['parms'] = "con_id?#?$this->con_id?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "insert" || $this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['select'] = ""; 
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['where_filter']))
              {
                  ...
                  $this->NM_ajax_info['buttonDisplay']['legalizar'] = $this->nmgp_botoes['legalizar'] = "off";
                  $this->NM_ajax_info['buttonDisplay']['ver_contratos'] = $this->nmgp_botoes['ver_contratos'] = "off";
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_select'] = $this->nmgp_dados_select;
      ...
      { 
          ...
          else
          {
              ...
              $this->nmgp_dados_form["con_lectura_actual"] = $this->con_lectura_actual;
              $this->con_fecha_lectura =  date('Y') . "-" . date('m')  . "-" . date('d');
...
//-- 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_materiales_contrato_mob']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinS*scoutlink_remove_margin*scinok*scoutlink_remove_border*scinok*scout";
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_rubro_contrato_mob']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinS*scoutlink_remove_margin*scinok*scoutlink_remove_border*scinok*scout";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['embutida_parms'] = "var_contrato*scin" . $this->nmgp_dados_form['con_id'] . "*scoutNMSC_inicial*scininicio*scoutNMSC_paginacao*scinFULL*scoutNMSC_cab*scinN*scoutNMSC_nav*scinN*scout";
  }
// 
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dados_select'];
           ...
           $this->SC_log_arr['fields']['rubros']['0'] =  $nmgp_dados_select['rubros'];
           $this->SC_log_arr['fields']['cuotas']['0'] =  $nmgp_dados_select['cuotas'];
           $this->SC_log_arr['fields']['materiales']['0'] =  $nmgp_dados_select['materiales'];
       }
   }
// 
   function NM_gera_log_new() 
   {
       ...
       $this->SC_log_arr['fields']['rubros']['1'] =  $this->rubros;
       $this->SC_log_arr['fields']['cuotas']['1'] =  $this->cuotas;
       $this->SC_log_arr['fields']['materiales']['1'] =  $this->materiales;
   }
// 
...
// 
   function NM_gera_log_output() 
   {
       ...
       $Log_labels['con_motivo_anulacion'] =  "{lang_motivo_rechazo}";
       ...
       $Log_labels['con_plazo'] =  "Nro. {lang_cuotas}";
       ...
       $Log_labels['con_numero_contrato'] =  "{lang_numero_contrato}";
       ...
       $Log_labels['con_numero_corte'] =  "Con Numero Corte";
       $Log_labels['con_comunidad'] =  "{lang_comunidad}";
       $Log_labels['con_sector'] =  "{lang_sector}";
       $Log_labels['con_numero_censo'] =  "{lang_numero_censo}";
       $Log_labels['rubros'] =  "{lang_rubros}";
       $Log_labels['cuotas'] =  "{lang_cuotas}";
       $Log_labels['materiales'] =  "{lang_materiales}";
       ...
       $this->NM_gera_log_insert("Scriptcase", $this->SC_log_evt, $Log_output);
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }

//
function con_abono_onChange()
{
$_SESSION['scriptcase']['form_jap_contrato_mob']['contr_erro'] = 'on';
...
$original_con_valor_cuota = $this->con_valor_cuota;
$original_con_id = $this->con_id;
$original_con_fecha = $this->con_fecha;
$original_con_lectura_actual = $this->con_lectura_actual;
$original_con_maxima_lectura = $this->con_maxima_lectura;
$original_con_numero_contrato = $this->con_numero_contrato;
$original_con_id = $this->con_id;
...
FROM
	jap_rubro_contrato 
inner join sri_tarifa_iva on rc_por_iva=iva_codigo	 
WHERE
	rc_contrato=".$this->con_id ;
...
$porcentaje_abono=round($this->con_abono /$this->con_total_a_pagar ,6);
...
;
   ...
   while(!$this->deudas->EOF) {
		...
		$cuota=1;
	   	...
	   	if($porcentaje_abono>0){
			$w_parcial_abono_producto=round($this->deudas->fields[2]*$porcentaje_abono,2);
			$w_porcentaje_iva=$this->deudas->fields[3];
			$w_iva_abono=round($w_parcial_abono_producto*$w_porcentaje_iva/100,2);
			$w_total_abono=$w_parcial_abono_producto+$w_iva_abono;
			
			$w_saldo_producto=$this->deudas->fields[2]-$w_parcial_abono_producto;
			
			$insert_sql="INSERT INTO jap_cuotas_contrato(
							cc_contrato,
							cc_cuota,
							cc_fecha,
							cc_producto,
						...
						SELECT
								...
								'".$this->deudas->fields[1]."',
								".$w_parcial_abono_producto.",
								".$this->deudas->fields[7].",
								".$w_iva_abono.",
								".$w_total_abono."
							;";
     ...
     $nm_select = $insert_sql; 
      ...
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         ...
         $rf->Close();
			...
			$w_saldo_producto=$this->deudas->fields[2];
		}
	    if ($w_saldo_producto>0){
			
			$genera_amortizacion = new Igtech_AmortizaAlemana($w_saldo_producto,0,$this->con_plazo ,0,$this->con_fecha ,30,0);

			foreach ($genera_amortizacion->TablaResultados() as $campo) {
				$w_parcial_abono_producto=$campo[0];
				$w_porcentaje_iva=$this->deudas->fields[3];
				$w_iva_abono=round($w_parcial_abono_producto*$w_porcentaje_iva/100,2);
				$w_total_abono=$w_parcial_abono_producto+$w_iva_abono;
				$insert_sql = "INSERT INTO jap_cuotas_contrato(
...
$modificado_con_abono = $this->con_abono;
$modificado_con_saldo_pagar = $this->con_saldo_pagar;
$modificado_con_total_a_pagar = $this->con_total_a_pagar;
$modificado_con_plazo = $this->con_plazo;
$modificado_con_valor_cuota = $this->con_valor_cuota;
$modificado_con_id = $this->con_id;
$modificado_con_fecha = $this->con_fecha;
$modificado_con_lectura_actual = $this->con_lectura_actual;
$modificado_con_maxima_lectura = $this->con_maxima_lectura;
$modificado_con_numero_contrato = $this->con_numero_contrato;
$modificado_con_id = $this->con_id;
$this->nm_formatar_campos('con_abono', 'con_saldo_pagar', 'con_total_a_pagar', 'con_plazo', 'con_valor_cuota', 'con_id', 'con_fecha');
if ($original_con_abono !== $modificado_con_abono || isset($this->nmgp_cmp_readonly['con_abono']) || (isset($bFlagRead_con_abono) && $bFlagRead_con_abono))
{
    $this->ajax_return_values_con_abono(true);
}
if ($original_con_saldo_pagar !== $modificado_con_saldo_pagar || isset($this->nmgp_cmp_readonly['con_saldo_pagar']) || (isset($bFlagRead_con_saldo_pagar) && $bFlagRead_con_saldo_pagar))
{
    $this->ajax_return_values_con_saldo_pagar(true);
}
if ($original_con_total_a_pagar !== $modificado_con_total_a_pagar || isset($this->nmgp_cmp_readonly['con_total_a_pagar']) || (isset($bFlagRead_con_total_a_pagar) && $bFlagRead_con_total_a_pagar))
{
    $this->ajax_return_values_con_total_a_pagar(true);
}
if ($original_con_plazo !== $modificado_con_plazo || isset($this->nmgp_cmp_readonly['con_plazo']) || (isset($bFlagRead_con_plazo) && $bFlagRead_con_plazo))
{
    $this->ajax_return_values_con_plazo(true);
}
if ($original_con_valor_cuota !== $modificado_con_valor_cuota || isset($this->nmgp_cmp_readonly['con_valor_cuota']) || (isset($bFlagRead_con_valor_cuota) && $bFlagRead_con_valor_cuota))
{
    $this->ajax_return_values_con_valor_cuota(true);
}
if ($original_con_id !== $modificado_con_id || isset($this->nmgp_cmp_readonly['con_id']) || (isset($bFlagRead_con_id) && $bFlagRead_con_id))
{
    $this->ajax_return_values_con_id(true);
}
if ($original_con_fecha !== $modificado_con_fecha || isset($this->nmgp_cmp_readonly['con_fecha']) || (isset($bFlagRead_con_fecha) && $bFlagRead_con_fecha))
{
    $this->ajax_return_values_con_fecha(true);
}
if ($original_con_lectura_actual !== $modificado_con_lectura_actual || isset($this->nmgp_cmp_readonly['con_lectura_actual']) || (isset($bFlagRead_con_lectura_actual) && $bFlagRead_con_lectura_actual))
{
    $this->ajax_return_values_con_lectura_actual(true);
}
if ($original_con_maxima_lectura !== $modificado_con_maxima_lectura || isset($this->nmgp_cmp_readonly['con_maxima_lectura']) || (isset($bFlagRead_con_maxima_lectura) && $bFlagRead_con_maxima_lectura))
{
    $this->ajax_return_values_con_maxima_lectura(true);
}
if ($original_con_numero_contrato !== $modificado_con_numero_contrato || isset($this->nmgp_cmp_readonly['con_numero_contrato']) || (isset($bFlagRead_con_numero_contrato) && $bFlagRead_con_numero_contrato))
{
    $this->ajax_return_values_con_numero_contrato(true);
}
if ($original_con_id !== $modificado_con_id || isset($this->nmgp_cmp_readonly['con_id']) || (isset($bFlagRead_con_id) && $bFlagRead_con_id))
...
if (isset($this->rs[0][0])){
	$this->con_nombre =$this->rs[0][0];
	$this->con_cedula =$this->rs[0][1];
	$this->con_telefono =$this->rs[0][2];
	$this->con_celular =$this->rs[0][3];
	$this->con_direccion_propietario =$this->rs[0][4];
	$this->con_correo =$this->rs[0][5];
}else{

	
 if (!isset($this->Campos_Mens_erro)){$this->Campos_Mens_erro = "";}
 if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= 'No hay datos';
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_jap_contrato_mob';
  ...
  $this->NM_ajax_info['errList'][$sErrorIndex][] = 'No hay datos';
 }
;
}
...
function con_ruta_onChange()
{
$_SESSION['scriptcase']['form_jap_contrato_mob']['contr_erro'] = 'on';
  
$original_con_empresa = $this->con_empresa;
$original_con_propietario = $this->con_propietario;
$original_con_pais = $this->con_pais;
$original_con_provincia = $this->con_provincia;
$original_con_canton = $this->con_canton;
...
$original_con_fecha = $this->con_fecha;
$original_con_estado = $this->con_estado;
$original_con_motivo_anulacion = $this->con_motivo_anulacion;
$original_con_tipo_contrato = $this->con_tipo_contrato;
$original_con_total_a_pagar = $this->con_total_a_pagar;
$original_con_abono = $this->con_abono;
$original_con_plazo = $this->con_plazo;
$original_con_fecha_instalacion = $this->con_fecha_instalacion;
$original_con_observaciones = $this->con_observaciones;
$original_con_usuario_instala = $this->con_usuario_instala;
$original_con_numero_contrato = $this->con_numero_contrato;
$original_con_maxima_lectura = $this->con_maxima_lectura;
$original_con_lectura_actual = $this->con_lectura_actual;
$original_con_fecha_lectura = $this->con_fecha_lectura;
...
$modificado_con_empresa = $this->con_empresa;
$modificado_con_propietario = $this->con_propietario;
$modificado_con_pais = $this->con_pais;
$modificado_con_provincia = $this->con_provincia;
$modificado_con_canton = $this->con_canton;
$modificado_con_parroquia = $this->con_parroquia;
$modificado_con_direccion_predio = $this->con_direccion_predio;
$modificado_con_toma_administrativa = $this->con_toma_administrativa;
$modificado_con_toma_operativa = $this->con_toma_operativa;
$modificado_con_tipo_servicio = $this->con_tipo_servicio;
$modificado_con_condicion_contrato = $this->con_condicion_contrato;
$modificado_con_numero_medidor = $this->con_numero_medidor;
$modificado_con_fecha = $this->con_fecha;
$modificado_con_estado = $this->con_estado;
$modificado_con_motivo_anulacion = $this->con_motivo_anulacion;
$modificado_con_tipo_contrato = $this->con_tipo_contrato;
$modificado_con_total_a_pagar = $this->con_total_a_pagar;
$modificado_con_abono = $this->con_abono;
$modificado_con_plazo = $this->con_plazo;
$modificado_con_fecha_instalacion = $this->con_fecha_instalacion;
$modificado_con_observaciones = $this->con_observaciones;
$modificado_con_usuario_instala = $this->con_usuario_instala;
$modificado_con_numero_contrato = $this->con_numero_contrato;
$modificado_con_maxima_lectura = $this->con_maxima_lectura;
$modificado_con_lectura_actual = $this->con_lectura_actual;
$modificado_con_fecha_lectura = $this->con_fecha_lectura;
$modificado_con_ruta = $this->con_ruta;
$modificado_con_id = $this->con_id;
$this->nm_formatar_campos('con_empresa', 'con_propietario', 'con_pais', 'con_provincia', 'con_canton', 'con_parroquia', 'con_direccion_predio', 'con_toma_administrativa', 'con_toma_operativa', 'con_tipo_servicio', 'con_condicion_contrato', 'con_numero_medidor', 'con_fecha', 'con_estado', 'con_motivo_anulacion', 'con_tipo_contrato', 'con_total_a_pagar', 'con_abono', 'con_plazo', 'con_fecha_instalacion', 'con_observaciones', 'con_usuario_instala', 'con_numero_contrato', 'con_maxima_lectura', 'con_lectura_actual', 'con_fecha_lectura', 'con_ruta', 'con_id');
if ($original_con_empresa !== $modificado_con_empresa || isset($this->nmgp_cmp_readonly['con_empresa']) || (isset($bFlagRead_con_empresa) && $bFlagRead_con_empresa))
{
    $this->ajax_return_values_con_empresa(true);
}
if ($original_con_propietario !== $modificado_con_propietario || isset($this->nmgp_cmp_readonly['con_propietario']) || (isset($bFlagRead_con_propietario) && $bFlagRead_con_propietario))
{
    $this->ajax_return_values_con_propietario(true);
}
if ($original_con_pais !== $modificado_con_pais || isset($this->nmgp_cmp_readonly['con_pais']) || (isset($bFlagRead_con_pais) && $bFlagRead_con_pais))
{
    $this->ajax_return_values_con_pais(true);
}
if ($original_con_provincia !== $modificado_con_provincia || isset($this->nmgp_cmp_readonly['con_provincia']) || (isset($bFlagRead_con_provincia) && $bFlagRead_con_provincia))
{
    $this->ajax_return_values_con_provincia(true);
}
if ($original_con_canton !== $modificado_con_canton || isset($this->nmgp_cmp_readonly['con_canton']) || (isset($bFlagRead_con_canton) && $bFlagRead_con_canton))
{
    $this->ajax_return_values_con_canton(true);
}
if ($original_con_parroquia !== $modificado_con_parroquia || isset($this->nmgp_cmp_readonly['con_parroquia']) || (isset($bFlagRead_con_parroquia) && $bFlagRead_con_parroquia))
{
    $this->ajax_return_values_con_parroquia(true);
}
if ($original_con_direccion_predio !== $modificado_con_direccion_predio || isset($this->nmgp_cmp_readonly['con_direccion_predio']) || (isset($bFlagRead_con_direccion_predio) && $bFlagRead_con_direccion_predio))
{
    $this->ajax_return_values_con_direccion_predio(true);
}
if ($original_con_toma_administrativa !== $modificado_con_toma_administrativa || isset($this->nmgp_cmp_readonly['con_toma_administrativa']) || (isset($bFlagRead_con_toma_administrativa) && $bFlagRead_con_toma_administrativa))
{
    $this->ajax_return_values_con_toma_administrativa(true);
}
if ($original_con_toma_operativa !== $modificado_con_toma_operativa || isset($this->nmgp_cmp_readonly['con_toma_operativa']) || (isset($bFlagRead_con_toma_operativa) && $bFlagRead_con_toma_operativa))
{
    $this->ajax_return_values_con_toma_operativa(true);
}
if ($original_con_tipo_servicio !== $modificado_con_tipo_servicio || isset($this->nmgp_cmp_readonly['con_tipo_servicio']) || (isset($bFlagRead_con_tipo_servicio) && $bFlagRead_con_tipo_servicio))
{
    $this->ajax_return_values_con_tipo_servicio(true);
}
if ($original_con_condicion_contrato !== $modificado_con_condicion_contrato || isset($this->nmgp_cmp_readonly['con_condicion_contrato']) || (isset($bFlagRead_con_condicion_contrato) && $bFlagRead_con_condicion_contrato))
{
    $this->ajax_return_values_con_condicion_contrato(true);
}
if ($original_con_numero_medidor !== $modificado_con_numero_medidor || isset($this->nmgp_cmp_readonly['con_numero_medidor']) || (isset($bFlagRead_con_numero_medidor) && $bFlagRead_con_numero_medidor))
{
    $this->ajax_return_values_con_numero_medidor(true);
}
if ($original_con_fecha !== $modificado_con_fecha || isset($this->nmgp_cmp_readonly['con_fecha']) || (isset($bFlagRead_con_fecha) && $bFlagRead_con_fecha))
...
if ($original_con_estado !== $modificado_con_estado || isset($this->nmgp_cmp_readonly['con_estado']) || (isset($bFlagRead_con_estado) && $bFlagRead_con_estado))
{
    $this->ajax_return_values_con_estado(true);
}
if ($original_con_motivo_anulacion !== $modificado_con_motivo_anulacion || isset($this->nmgp_cmp_readonly['con_motivo_anulacion']) || (isset($bFlagRead_con_motivo_anulacion) && $bFlagRead_con_motivo_anulacion))
{
    $this->ajax_return_values_con_motivo_anulacion(true);
}
if ($original_con_tipo_contrato !== $modificado_con_tipo_contrato || isset($this->nmgp_cmp_readonly['con_tipo_contrato']) || (isset($bFlagRead_con_tipo_contrato) && $bFlagRead_con_tipo_contrato))
{
    $this->ajax_return_values_con_tipo_contrato(true);
}
if ($original_con_total_a_pagar !== $modificado_con_total_a_pagar || isset($this->nmgp_cmp_readonly['con_total_a_pagar']) || (isset($bFlagRead_con_total_a_pagar) && $bFlagRead_con_total_a_pagar))
...
if ($original_con_fecha_instalacion !== $modificado_con_fecha_instalacion || isset($this->nmgp_cmp_readonly['con_fecha_instalacion']) || (isset($bFlagRead_con_fecha_instalacion) && $bFlagRead_con_fecha_instalacion))
{
    $this->ajax_return_values_con_fecha_instalacion(true);
}
if ($original_con_observaciones !== $modificado_con_observaciones || isset($this->nmgp_cmp_readonly['con_observaciones']) || (isset($bFlagRead_con_observaciones) && $bFlagRead_con_observaciones))
{
    $this->ajax_return_values_con_observaciones(true);
}
if ($original_con_usuario_instala !== $modificado_con_usuario_instala || isset($this->nmgp_cmp_readonly['con_usuario_instala']) || (isset($bFlagRead_con_usuario_instala) && $bFlagRead_con_usuario_instala))
{
    $this->ajax_return_values_con_usuario_instala(true);
}
if ($original_con_numero_contrato !== $modificado_con_numero_contrato || isset($this->nmgp_cmp_readonly['con_numero_contrato']) || (isset($bFlagRead_con_numero_contrato) && $bFlagRead_con_numero_contrato))
{
    $this->ajax_return_values_con_numero_contrato(true);
...
if ($original_con_fecha_lectura !== $modificado_con_fecha_lectura || isset($this->nmgp_cmp_readonly['con_fecha_lectura']) || (isset($bFlagRead_con_fecha_lectura) && $bFlagRead_con_fecha_lectura))
{
    $this->ajax_return_values_con_fecha_lectura(true);
}
if ($original_con_ruta !== $modificado_con_ruta || isset($this->nmgp_cmp_readonly['con_ruta']) || (isset($bFlagRead_con_ruta) && $bFlagRead_con_ruta))
{
    $this->ajax_return_values_con_ruta(true);
}
if ($original_con_id !== $modificado_con_id || isset($this->nmgp_cmp_readonly['con_id']) || (isset($bFlagRead_con_id) && $bFlagRead_con_id))
...
function con_total_a_pagar_onChange()
{
$_SESSION['scriptcase']['form_jap_contrato_mob']['contr_erro'] = 'on';
...
$porcentaje_abono=round($this->con_abono /$this->con_total_a_pagar ,6);
echo 'porcentaje iva:'.$porcentaje_abono;
if (false == $this->deudas ) {
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_jap_contrato_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['csrf_token'];
    }
...
else
{
   ...
   function Form_lookup_con_propietario()
   {
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['Lookup_con_propietario']))
{
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['empty_filter']);
      ...
      foreach ($fields as $field) {
          ...
          if ($field == "SC_all_Cmp") 
          {
              $data_lookup = $this->SC_lookup_con_propietario($arg_search, $data_search);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_jap_contrato_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['total'] = $qt_geral_reg_form_jap_contrato_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_jap_contrato_mob_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['SC_sep_date1'];
              }
          }
   ...
   function SC_lookup_con_propietario($condicao, $campo)
   {
       $result = array();
       $campo_orig = $campo;
       $campo  = substr($this->Db->qstr($campo), 1, -1);
       ...
       {
           $nm_comando = "SELECT cl_identificacion|| '-' || cl_nombre, cl_id FROM del_cliente WHERE (CAST (cl_id AS TEXT) LIKE '%$campo%') AND (cl_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "')" ; 
       }
       else
       {
           $nm_comando = "SELECT cl_identificacion|| '-' || cl_nombre, cl_id FROM del_cliente WHERE (#cmp_icl_identificacion|| '-' || cl_nombre#cmp_f#cmp_apos LIKE '%#arg_i" . $campo . "#arg_f%'#arg_apos) AND (cl_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "')" ; 
       }
       if ($condicao == "ii")
       {
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_jap_contrato_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_jap_contrato_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['masterValue']))
{
...
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_materiales_contrato_mob']['reg_start'] = "";
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_materiales_contrato_mob']['total']);
   $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_rubro_contrato_mob']['reg_start'] = "";
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_rubro_contrato_mob']['total']);
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['retorno_edit'] = "";
   }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function getButtonIds($buttonName) {
        switch ($buttonName) {
            case "new":
                return array("sc_b_new_t.sc-unique-btn-1", "sc_b_new_b.sc-unique-btn-9", "sc_b_new_t.sc-unique-btn-17", "sc_b_new_b.sc-unique-btn-25");
                break;
            case "insert":
                return array("sc_b_ins_t.sc-unique-btn-2", "sc_b_ins_b.sc-unique-btn-10", "sc_b_ins_t.sc-unique-btn-18", "sc_b_ins_b.sc-unique-btn-26");
                break;
            case "update":
                return array("sc_b_upd_t.sc-unique-btn-3", "sc_b_upd_b.sc-unique-btn-11", "sc_b_upd_t.sc-unique-btn-19", "sc_b_upd_b.sc-unique-btn-27");
                break;
            case "actualizar":
                return array("sc_actualizar_top.", "sc_actualizar_bot.", "sc_actualizar_top.", "sc_actualizar_bot.");
                break;
            case "0":
                return array("sys_separator.sc-unique-btn-4", "sys_separator.sc-unique-btn-5", "sys_separator.sc-unique-btn-12", "sys_separator.sc-unique-btn-13", "sys_separator.sc-unique-btn-20", "sys_separator.sc-unique-btn-21", "sys_separator.sc-unique-btn-28", "sys_separator.sc-unique-btn-29");
                break;
            case "imprimirsolicitud":
                return array("sc_ImprimirSolicitud_top.", "sc_ImprimirSolicitud_bot.", "sc_ImprimirSolicitud_top.", "sc_ImprimirSolicitud_bot.");
                break;
            case "enviar_inspeccion":
                return array("sc_enviar_inspeccion_top.", "sc_enviar_inspeccion_bot.", "sc_enviar_inspeccion_top.", "sc_enviar_inspeccion_bot.");
                break;
            case "enviar_legalizar":
                return array("sc_enviar_legalizar_top.", "sc_enviar_legalizar_bot.", "sc_enviar_legalizar_top.", "sc_enviar_legalizar_bot.");
                break;
            case "legalizar":
                return array("sc_legalizar_top.", "sc_legalizar_bot.", "sc_legalizar_top.", "sc_legalizar_bot.");
                break;
            case "btnimprimir":
                return array("sc_btnImprimir_top.", "sc_btnImprimir_bot.", "sc_btnImprimir_top.", "sc_btnImprimir_bot.");
                break;
            case "anular":
            ...
            case "help":
                ...
                break;
            case "exit":
                return array("sc_b_sai_t.sc-unique-btn-6", "sc_b_sai_t.sc-unique-btn-8", "sc_b_sai_b.sc-unique-btn-14", "sc_b_sai_b.sc-unique-btn-16", "sc_b_sai_t.sc-unique-btn-22", "sc_b_sai_t.sc-unique-btn-24", "sc_b_sai_b.sc-unique-btn-30", "sc_b_sai_b.sc-unique-btn-32", "sc_b_sai_t.sc-unique-btn-7", "sc_b_sai_b.sc-unique-btn-15", "sc_b_sai_t.sc-unique-btn-23", "sc_b_sai_b.sc-unique-btn-31");
                break;
            case "ver_contratos":
                return array("sc_ver_contratos_top.", "sc_ver_contratos_bot.", "sc_ver_contratos_top.", "sc_ver_contratos_bot.");
                break;
        }
    ...
    function displayAppHeader()
    {
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['mostra_cab']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['mostra_cab'] == "N") {
            return;
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato_mob']['ordem_ord'] == " desc") {
