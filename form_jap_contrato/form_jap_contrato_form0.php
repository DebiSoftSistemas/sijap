...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_jap_contrato/form_jap_contrato_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_jap_contrato_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['recarga'];
}
if ('' != $this->con_estado)
{
...
if ('' != $this->con_usuario_instala)
{
    ...
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['link_info']['remove_border']) {
...
<?php
 include_once("form_jap_contrato_js0.php");
?>
<script type="text/javascript" src="<?php  echo $this->Ini->path_js . "/jsrsClient.js" ?>"> 
</script> 
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_jap_contrato'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_jap_contrato'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_disabled']['actualizar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_disabled']['actualizar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['actualizar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['actualizar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['actualizar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_disabled']['']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_disabled']['']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label'][''];
        }
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_disabled']['imprimirsolicitud']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_disabled']['imprimirsolicitud']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['imprimirsolicitud']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['imprimirsolicitud']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['imprimirsolicitud'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_disabled']['enviar_inspeccion']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_disabled']['enviar_inspeccion']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['enviar_inspeccion']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['enviar_inspeccion']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['enviar_inspeccion'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_disabled']['enviar_legalizar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_disabled']['enviar_legalizar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['enviar_legalizar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['enviar_legalizar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['enviar_legalizar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_disabled']['legalizar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_disabled']['legalizar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['legalizar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['legalizar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['legalizar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_disabled']['btnimprimir']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_disabled']['btnimprimir']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['btnimprimir']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['btnimprimir']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['btnimprimir'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_disabled']['anular']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_disabled']['anular']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['anular']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['anular']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['anular'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-6';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_disabled']['ver_contratos']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_disabled']['ver_contratos']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['ver_contratos']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['ver_contratos']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['btn_label']['ver_contratos'];
        }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_motivo_anulacion_line" id="hidden_field_data_con_motivo_anulacion" style="<?php echo $sStyleHidden_con_motivo_anulacion; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_motivo_anulacion_line" style="vertical-align: top;padding: 0px">
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_fecha_line" id="hidden_field_data_con_fecha" style="<?php echo $sStyleHidden_con_fecha; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_fecha_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="con_fecha" value="<?php echo $this->form_encode_input($con_fecha); ?>"><span id="id_ajax_label_con_fecha"><?php echo nl2br($con_fecha); ?></span>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_sino_line" id="hidden_field_data_con_sino" style="<?php echo $sStyleHidden_con_sino; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_sino_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="con_sino" value="<?php echo $this->form_encode_input($con_sino); ?>"><span id="id_ajax_label_con_sino"><?php echo nl2br($con_sino); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_id_line" id="hidden_field_data_con_id" style="<?php echo $sStyleHidden_con_id; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_id_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_numero_contrato_line" id="hidden_field_data_con_numero_contrato" style="<?php echo $sStyleHidden_con_numero_contrato; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_numero_contrato_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="con_numero_contrato" value="<?php echo $this->form_encode_input($con_numero_contrato); ?>"><span id="id_ajax_label_con_numero_contrato"><?php echo nl2br($con_numero_contrato); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_con_tipo_contrato_label" id="hidden_field_label_con_tipo_contrato" style="<?php echo $sStyleHidden_con_tipo_contrato; ?>"><span id="id_label_con_tipo_contrato"><?php echo $this->nm_new_label['con_tipo_contrato']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['php_cmp_required']['con_tipo_contrato']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['php_cmp_required']['con_tipo_contrato'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_con_tipo_contrato_line" id="hidden_field_data_con_tipo_contrato" style="<?php echo $sStyleHidden_con_tipo_contrato; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_tipo_contrato_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_con_propietario_label" id="hidden_field_label_con_propietario" style="<?php echo $sStyleHidden_con_propietario; ?>"><span id="id_label_con_propietario"><?php echo $this->nm_new_label['con_propietario']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['php_cmp_required']['con_propietario']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['php_cmp_required']['con_propietario'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_con_propietario_line" id="hidden_field_data_con_propietario" style="<?php echo $sStyleHidden_con_propietario; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_propietario_line" style="vertical-align: top;padding: 0px">
...
<?php
   ...
   if (isset($this->Ini->sc_lig_md5["form_del_cliente"]) && $this->Ini->sc_lig_md5["form_del_cliente"] == "S") {
       $Parms_Lig  = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scoutnm_evt_ret_edit*scindo_ajax_form_jap_contrato_lkpedt_refresh_con_propietario*scoutnmgp_url_saida*scinmodal*scoutnmgp_outra_jan*scintrue*scoutsc_redir_atualiz*scinok*scout";
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_jap_contrato@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scoutnm_evt_ret_edit*scindo_ajax_form_jap_contrato_lkpedt_refresh_con_propietario*scoutnmgp_url_saida*scinmodal*scoutnmgp_outra_jan*scintrue*scoutsc_redir_atualiz*scinok*scout";
   }
 ?><?php echo nmButtonOutput($this->arr_buttons, "bform_lookuplink", "", "", "fldedt_con_propietario", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->link_form_del_cliente_edit . "?script_case_init=" . $this->Ini->sc_page . "&nmgp_parms=" . $Md5_Lig . "&SC_lig_apl_orig=form_jap_contrato&KeepThis=true&TB_iframe=true&height=500&width=800&modal=true", "");?>
<?php    echo "</span>";
?> 
<?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_nombre_line" id="hidden_field_data_con_nombre" style="<?php echo $sStyleHidden_con_nombre; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_nombre_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="con_nombre" value="<?php echo $this->form_encode_input($con_nombre); ?>"><span id="id_ajax_label_con_nombre"><?php echo nl2br($con_nombre); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_cedula_line" id="hidden_field_data_con_cedula" style="<?php echo $sStyleHidden_con_cedula; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_cedula_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="con_cedula" value="<?php echo $this->form_encode_input($con_cedula); ?>"><span id="id_ajax_label_con_cedula"><?php echo nl2br($con_cedula); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_telefono_line" id="hidden_field_data_con_telefono" style="<?php echo $sStyleHidden_con_telefono; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_telefono_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="con_telefono" value="<?php echo $this->form_encode_input($con_telefono); ?>"><span id="id_ajax_label_con_telefono"><?php echo nl2br($con_telefono); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_celular_line" id="hidden_field_data_con_celular" style="<?php echo $sStyleHidden_con_celular; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_celular_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="con_celular" value="<?php echo $this->form_encode_input($con_celular); ?>"><span id="id_ajax_label_con_celular"><?php echo nl2br($con_celular); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_direccion_propietario_line" id="hidden_field_data_con_direccion_propietario" style="<?php echo $sStyleHidden_con_direccion_propietario; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_direccion_propietario_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="con_direccion_propietario" value="<?php echo $this->form_encode_input($con_direccion_propietario); ?>"><span id="id_ajax_label_con_direccion_propietario"><?php echo nl2br($con_direccion_propietario); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_correo_line" id="hidden_field_data_con_correo" style="<?php echo $sStyleHidden_con_correo; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_correo_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="con_correo" value="<?php echo $this->form_encode_input($con_correo); ?>"><span id="id_ajax_label_con_correo"><?php echo nl2br($con_correo); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_con_pais_label" id="hidden_field_label_con_pais" style="<?php echo $sStyleHidden_con_pais; ?>"><span id="id_label_con_pais"><?php echo $this->nm_new_label['con_pais']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['php_cmp_required']['con_pais']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['php_cmp_required']['con_pais'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_con_pais_line" id="hidden_field_data_con_pais" style="<?php echo $sStyleHidden_con_pais; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_pais_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_con_provincia_label" id="hidden_field_label_con_provincia" style="<?php echo $sStyleHidden_con_provincia; ?>"><span id="id_label_con_provincia"><?php echo $this->nm_new_label['con_provincia']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['php_cmp_required']['con_provincia']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['php_cmp_required']['con_provincia'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_con_provincia_line" id="hidden_field_data_con_provincia" style="<?php echo $sStyleHidden_con_provincia; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_provincia_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_con_canton_label" id="hidden_field_label_con_canton" style="<?php echo $sStyleHidden_con_canton; ?>"><span id="id_label_con_canton"><?php echo $this->nm_new_label['con_canton']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['php_cmp_required']['con_canton']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['php_cmp_required']['con_canton'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_con_canton_line" id="hidden_field_data_con_canton" style="<?php echo $sStyleHidden_con_canton; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_canton_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_con_parroquia_label" id="hidden_field_label_con_parroquia" style="<?php echo $sStyleHidden_con_parroquia; ?>"><span id="id_label_con_parroquia"><?php echo $this->nm_new_label['con_parroquia']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['php_cmp_required']['con_parroquia']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['php_cmp_required']['con_parroquia'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_con_parroquia_line" id="hidden_field_data_con_parroquia" style="<?php echo $sStyleHidden_con_parroquia; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_parroquia_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_comunidad_line" id="hidden_field_data_con_comunidad" style="<?php echo $sStyleHidden_con_comunidad; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_comunidad_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_sector_line" id="hidden_field_data_con_sector" style="<?php echo $sStyleHidden_con_sector; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_sector_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_numero_censo_line" id="hidden_field_data_con_numero_censo" style="<?php echo $sStyleHidden_con_numero_censo; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_numero_censo_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_con_direccion_predio_label" id="hidden_field_label_con_direccion_predio" style="<?php echo $sStyleHidden_con_direccion_predio; ?>"><span id="id_label_con_direccion_predio"><?php echo $this->nm_new_label['con_direccion_predio']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['php_cmp_required']['con_direccion_predio']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['php_cmp_required']['con_direccion_predio'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_toma_administrativa_line" id="hidden_field_data_con_toma_administrativa" style="<?php echo $sStyleHidden_con_toma_administrativa; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_toma_administrativa_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_con_toma_operativa_label" id="hidden_field_label_con_toma_operativa" style="<?php echo $sStyleHidden_con_toma_operativa; ?>"><span id="id_label_con_toma_operativa"><?php echo $this->nm_new_label['con_toma_operativa']; ?></span></TD>
    <TD class="scFormDataOdd css_con_toma_operativa_line" id="hidden_field_data_con_toma_operativa" style="<?php echo $sStyleHidden_con_toma_operativa; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_toma_operativa_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_condicion_contrato_line" id="hidden_field_data_con_condicion_contrato" style="<?php echo $sStyleHidden_con_condicion_contrato; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_condicion_contrato_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_ruta_line" id="hidden_field_data_con_ruta" style="<?php echo $sStyleHidden_con_ruta; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_ruta_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_orden_lecturas_line" id="hidden_field_data_con_orden_lecturas" style="<?php echo $sStyleHidden_con_orden_lecturas; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_orden_lecturas_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_fecha_instalacion_line" id="hidden_field_data_con_fecha_instalacion" style="<?php echo $sStyleHidden_con_fecha_instalacion; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_fecha_instalacion_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_numero_medidor_line" id="hidden_field_data_con_numero_medidor" style="<?php echo $sStyleHidden_con_numero_medidor; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_numero_medidor_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_maxima_lectura_line" id="hidden_field_data_con_maxima_lectura" style="<?php echo $sStyleHidden_con_maxima_lectura; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_maxima_lectura_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_lectura_actual_line" id="hidden_field_data_con_lectura_actual" style="<?php echo $sStyleHidden_con_lectura_actual; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_lectura_actual_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_fecha_lectura_line" id="hidden_field_data_con_fecha_lectura" style="<?php echo $sStyleHidden_con_fecha_lectura; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_fecha_lectura_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_numero_corte_line" id="hidden_field_data_con_numero_corte" style="<?php echo $sStyleHidden_con_numero_corte; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_numero_corte_line" style="vertical-align: top;padding: 0px">
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_materiales'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_materiales'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['form_jap_materiales_contrato_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_materiales'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['form_jap_materiales_contrato_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['form_jap_materiales_contrato_script_case_init'] ]['form_jap_materiales_contrato']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['form_jap_materiales_contrato_script_case_init'] ]['form_jap_materiales_contrato']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['form_jap_materiales_contrato_script_case_init'] ]['form_jap_materiales_contrato']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['form_jap_materiales_contrato_script_case_init'] ]['form_jap_materiales_contrato']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['form_jap_materiales_contrato_script_case_init'] ]['form_jap_materiales_contrato']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['form_jap_materiales_contrato_script_case_init'] ]['form_jap_materiales_contrato']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['form_jap_materiales_contrato_script_case_init'] ]['form_jap_materiales_contrato']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['form_jap_materiales_contrato_script_case_init'] ]['form_jap_materiales_contrato']['embutida_liga_form_btn_nav'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['form_jap_materiales_contrato_script_case_init'] ]['form_jap_materiales_contrato']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['form_jap_materiales_contrato_script_case_init'] ]['form_jap_materiales_contrato']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['form_jap_materiales_contrato_script_case_init'] ]['form_jap_materiales_contrato']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['form_jap_materiales_contrato_script_case_init'] ]['form_jap_materiales_contrato']['embutida_liga_tp_pag'] = 'total';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['form_jap_materiales_contrato_script_case_init'] ]['form_jap_materiales_contrato']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinS*scoutlink_remove_margin*scinok*scoutlink_remove_border*scinok*scout";
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['form_jap_materiales_contrato_script_case_init'] ]['form_jap_contrato']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_jap_contrato_empty.htm' : $this->Ini->link_form_jap_materiales_contrato_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y&sc_ifr_height=300';
if (isset($this->Ini->sc_lig_target['C_@scinf_materiales']) && 'nmsc_iframe_liga_form_jap_materiales_contrato' != $this->Ini->sc_lig_target['C_@scinf_materiales'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_materiales'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['form_jap_materiales_contrato_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_jap_materiales_contrato"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="300" width="100%" name="nmsc_iframe_liga_form_jap_materiales_contrato"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_rubros'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_rubros'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['form_jap_rubro_contrato_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_rubros'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['form_jap_rubro_contrato_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['form_jap_rubro_contrato_script_case_init'] ]['form_jap_rubro_contrato']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['form_jap_rubro_contrato_script_case_init'] ]['form_jap_rubro_contrato']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['form_jap_rubro_contrato_script_case_init'] ]['form_jap_rubro_contrato']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['form_jap_rubro_contrato_script_case_init'] ]['form_jap_rubro_contrato']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['form_jap_rubro_contrato_script_case_init'] ]['form_jap_rubro_contrato']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['form_jap_rubro_contrato_script_case_init'] ]['form_jap_rubro_contrato']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['form_jap_rubro_contrato_script_case_init'] ]['form_jap_rubro_contrato']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['form_jap_rubro_contrato_script_case_init'] ]['form_jap_rubro_contrato']['embutida_liga_form_btn_nav'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['form_jap_rubro_contrato_script_case_init'] ]['form_jap_rubro_contrato']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['form_jap_rubro_contrato_script_case_init'] ]['form_jap_rubro_contrato']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['form_jap_rubro_contrato_script_case_init'] ]['form_jap_rubro_contrato']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['form_jap_rubro_contrato_script_case_init'] ]['form_jap_rubro_contrato']['embutida_liga_tp_pag'] = 'total';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['form_jap_rubro_contrato_script_case_init'] ]['form_jap_rubro_contrato']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinS*scoutlink_remove_margin*scinok*scoutlink_remove_border*scinok*scout";
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['form_jap_rubro_contrato_script_case_init'] ]['form_jap_contrato']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_jap_contrato_empty.htm' : $this->Ini->link_form_jap_rubro_contrato_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y&sc_ifr_height=300';
if (isset($this->Ini->sc_lig_target['C_@scinf_rubros']) && 'nmsc_iframe_liga_form_jap_rubro_contrato' != $this->Ini->sc_lig_target['C_@scinf_rubros'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_rubros'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['form_jap_rubro_contrato_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_jap_rubro_contrato"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="300" width="100%" name="nmsc_iframe_liga_form_jap_rubro_contrato"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php $sStyleHidden_con_total_a_pagar_dumb = ('' == $sStyleHidden_con_total_a_pagar) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_con_total_a_pagar_dumb" style="<?php echo $sStyleHidden_con_total_a_pagar_dumb; ?>"></TD>
<?php $sStyleHidden_con_abono_dumb = ('' == $sStyleHidden_con_abono) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_con_abono_dumb" style="<?php echo $sStyleHidden_con_abono_dumb; ?>"></TD>
<?php $sStyleHidden_con_saldo_pagar_dumb = ('' == $sStyleHidden_con_saldo_pagar) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_con_saldo_pagar_dumb" style="<?php echo $sStyleHidden_con_saldo_pagar_dumb; ?>"></TD>
<?php $sStyleHidden_con_plazo_dumb = ('' == $sStyleHidden_con_plazo) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_con_plazo_dumb" style="<?php echo $sStyleHidden_con_plazo_dumb; ?>"></TD>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_cuotas'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_cuotas'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['grid_jap_cuotas_contrato_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_cuotas'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['grid_jap_cuotas_contrato_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_jap_contrato_empty.htm' : $this->Ini->link_grid_jap_cuotas_contrato_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y&sc_ifr_height=300' . $parms_lig_cons;
if (isset($this->Ini->sc_lig_target['C_@scinf_cuotas']) && 'nmsc_iframe_liga_grid_jap_cuotas_contrato' != $this->Ini->sc_lig_target['C_@scinf_cuotas'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_cuotas'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['grid_jap_cuotas_contrato_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_jap_contrato");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_jap_contrato");
 parent.scAjaxDetailHeight("form_jap_contrato", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_contrato']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
