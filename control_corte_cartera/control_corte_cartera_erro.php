...
$old_error_handler = set_error_handler("control_corte_cartera_scriptcase_error_handler");

function control_corte_cartera_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['control_corte_cartera']['contr_erro']) && $_SESSION['scriptcase']['control_corte_cartera']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_control_corte_cartera->contr_control_corte_cartera->Apl_com_erro = true;
            if ($inicial_control_corte_cartera->contr_control_corte_cartera->NM_ajax_flag)
            {
                $inicial_control_corte_cartera->contr_control_corte_cartera->NM_ajax_info['errList']['geral_control_corte_cartera'][] = $msg;
                return;
            }
            control_corte_cartera_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function control_corte_cartera_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['control_corte_cartera'])  && '' != $_SESSION['scriptcase']['error_icon']['control_corte_cartera'])  ? $_SESSION['scriptcase']['error_icon']['control_corte_cartera']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['control_corte_cartera']) && '' != $_SESSION['scriptcase']['error_span_title']['control_corte_cartera']) ? $_SESSION['scriptcase']['error_span_title']['control_corte_cartera'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['control_corte_cartera']) && '' != $_SESSION['scriptcase']['error_icon_title']['control_corte_cartera']) ? $_SESSION['scriptcase']['error_icon_title']['control_corte_cartera'] : '';
?>
