...
$old_error_handler = set_error_handler("control_genera_asiento_operacion_scriptcase_error_handler");

function control_genera_asiento_operacion_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['control_genera_asiento_operacion']['contr_erro']) && $_SESSION['scriptcase']['control_genera_asiento_operacion']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_control_genera_asiento_operacion->contr_control_genera_asiento_operacion->Apl_com_erro = true;
            if ($inicial_control_genera_asiento_operacion->contr_control_genera_asiento_operacion->NM_ajax_flag)
            {
                $inicial_control_genera_asiento_operacion->contr_control_genera_asiento_operacion->NM_ajax_info['errList']['geral_control_genera_asiento_operacion'][] = $msg;
                return;
            }
            control_genera_asiento_operacion_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function control_genera_asiento_operacion_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['control_genera_asiento_operacion'])  && '' != $_SESSION['scriptcase']['error_icon']['control_genera_asiento_operacion'])  ? $_SESSION['scriptcase']['error_icon']['control_genera_asiento_operacion']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['control_genera_asiento_operacion']) && '' != $_SESSION['scriptcase']['error_close']['control_genera_asiento_operacion']) ? $_SESSION['scriptcase']['error_close']['control_genera_asiento_operacion'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['control_genera_asiento_operacion']) && '' != $_SESSION['scriptcase']['error_span_title']['control_genera_asiento_operacion']) ? $_SESSION['scriptcase']['error_span_title']['control_genera_asiento_operacion'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['control_genera_asiento_operacion']) && '' != $_SESSION['scriptcase']['error_icon_title']['control_genera_asiento_operacion']) ? $_SESSION['scriptcase']['error_icon_title']['control_genera_asiento_operacion'] : '';
?>
