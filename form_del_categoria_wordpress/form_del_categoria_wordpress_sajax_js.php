  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_categoria_wordpress" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_categoria_wordpress_form();
	}
...
?>
  ...
  // ---------- Validate cw_id
  function do_ajax_form_del_categoria_wordpress_validate_cw_id()
  {
    var nomeCampo_cw_id = "cw_id";
    var var_cw_id = scAjaxGetFieldText(nomeCampo_cw_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_categoria_wordpress_validate_cw_id(var_cw_id, var_script_case_init, do_ajax_form_del_categoria_wordpress_validate_cw_id_cb);
  } // do_ajax_form_del_categoria_wordpress_validate_cw_id

  function do_ajax_form_del_categoria_wordpress_validate_cw_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_categoria_wordpress_validate_cw_id_cb

  // ---------- Validate cw_nombre
  function do_ajax_form_del_categoria_wordpress_validate_cw_nombre()
  {
    var nomeCampo_cw_nombre = "cw_nombre";
    var var_cw_nombre = scAjaxGetFieldText(nomeCampo_cw_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_categoria_wordpress_validate_cw_nombre(var_cw_nombre, var_script_case_init, do_ajax_form_del_categoria_wordpress_validate_cw_nombre_cb);
  } // do_ajax_form_del_categoria_wordpress_validate_cw_nombre

  function do_ajax_form_del_categoria_wordpress_validate_cw_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_categoria_wordpress_validate_cw_nombre_cb

  // ---------- Validate cw_descipccion
  function do_ajax_form_del_categoria_wordpress_validate_cw_descipccion()
  {
    var nomeCampo_cw_descipccion = "cw_descipccion";
    var var_cw_descipccion = scAjaxGetFieldText(nomeCampo_cw_descipccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_categoria_wordpress_validate_cw_descipccion(var_cw_descipccion, var_script_case_init, do_ajax_form_del_categoria_wordpress_validate_cw_descipccion_cb);
  } // do_ajax_form_del_categoria_wordpress_validate_cw_descipccion

  function do_ajax_form_del_categoria_wordpress_validate_cw_descipccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_categoria_wordpress_validate_cw_descipccion_cb

  // ---------- Validate cw_empresa
  function do_ajax_form_del_categoria_wordpress_validate_cw_empresa()
  {
    var nomeCampo_cw_empresa = "cw_empresa";
    var var_cw_empresa = scAjaxGetFieldText(nomeCampo_cw_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_categoria_wordpress_validate_cw_empresa(var_cw_empresa, var_script_case_init, do_ajax_form_del_categoria_wordpress_validate_cw_empresa_cb);
  } // do_ajax_form_del_categoria_wordpress_validate_cw_empresa

  function do_ajax_form_del_categoria_wordpress_validate_cw_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_categoria_wordpress_validate_cw_empresa_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_categoria_wordpress_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_categoria_wordpress_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_del_categoria_wordpress_submit_form(var_cw_id, var_cw_nombre, var_cw_descipccion, var_cw_empresa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_categoria_wordpress_submit_form_cb);
  } // do_ajax_form_del_categoria_wordpress_submit_form

  function do_ajax_form_del_categoria_wordpress_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_categoria_wordpress_submit_form_cb_after_alert);
  } // do_ajax_form_del_categoria_wordpress_submit_form_cb
  function do_ajax_form_del_categoria_wordpress_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_categoria_wordpress_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_categoria_wordpress_navigate_form()
  {
    perform_ajax_form_del_categoria_wordpress_navigate_form();
  }

  function perform_ajax_form_del_categoria_wordpress_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_del_categoria_wordpress_navigate_form(var_cw_id, var_cw_empresa, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_categoria_wordpress_navigate_form_cb);
  } // do_ajax_form_del_categoria_wordpress_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_categoria_wordpress']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_categoria_wordpress_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_categoria_wordpress_navigate_form_cb_after_alert);
  } // do_ajax_form_del_categoria_wordpress_navigate_form_cb
  function do_ajax_form_del_categoria_wordpress_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_del_categoria_wordpress_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_categoria_wordpress_navigate_form_cb_after_alert

  function sc_hide_form_del_categoria_wordpress_form()
  {
