  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_categoria_wordpress_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_categoria_wordpress_mob_form();
	}
...
?>
  ...
  // ---------- Validate cw_id
  function do_ajax_form_del_categoria_wordpress_mob_validate_cw_id()
  {
    var nomeCampo_cw_id = "cw_id";
    var var_cw_id = scAjaxGetFieldText(nomeCampo_cw_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_categoria_wordpress_mob_validate_cw_id(var_cw_id, var_script_case_init, do_ajax_form_del_categoria_wordpress_mob_validate_cw_id_cb);
  } // do_ajax_form_del_categoria_wordpress_mob_validate_cw_id

  function do_ajax_form_del_categoria_wordpress_mob_validate_cw_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_categoria_wordpress_mob_validate_cw_id_cb

  // ---------- Validate cw_nombre
  function do_ajax_form_del_categoria_wordpress_mob_validate_cw_nombre()
  {
    var nomeCampo_cw_nombre = "cw_nombre";
    var var_cw_nombre = scAjaxGetFieldText(nomeCampo_cw_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_categoria_wordpress_mob_validate_cw_nombre(var_cw_nombre, var_script_case_init, do_ajax_form_del_categoria_wordpress_mob_validate_cw_nombre_cb);
  } // do_ajax_form_del_categoria_wordpress_mob_validate_cw_nombre

  function do_ajax_form_del_categoria_wordpress_mob_validate_cw_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cw_nombre";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_categoria_wordpress_mob_validate_cw_nombre_cb

  // ---------- Validate cw_descipccion
  function do_ajax_form_del_categoria_wordpress_mob_validate_cw_descipccion()
  {
    var nomeCampo_cw_descipccion = "cw_descipccion";
    var var_cw_descipccion = scAjaxGetFieldText(nomeCampo_cw_descipccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_categoria_wordpress_mob_validate_cw_descipccion(var_cw_descipccion, var_script_case_init, do_ajax_form_del_categoria_wordpress_mob_validate_cw_descipccion_cb);
  } // do_ajax_form_del_categoria_wordpress_mob_validate_cw_descipccion

  function do_ajax_form_del_categoria_wordpress_mob_validate_cw_descipccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cw_descipccion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_categoria_wordpress_mob_validate_cw_descipccion_cb

  // ---------- Validate cw_empresa
  function do_ajax_form_del_categoria_wordpress_mob_validate_cw_empresa()
  {
    var nomeCampo_cw_empresa = "cw_empresa";
    var var_cw_empresa = scAjaxGetFieldText(nomeCampo_cw_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_categoria_wordpress_mob_validate_cw_empresa(var_cw_empresa, var_script_case_init, do_ajax_form_del_categoria_wordpress_mob_validate_cw_empresa_cb);
  } // do_ajax_form_del_categoria_wordpress_mob_validate_cw_empresa

  function do_ajax_form_del_categoria_wordpress_mob_validate_cw_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cw_empresa";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_categoria_wordpress_mob_validate_cw_empresa_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_categoria_wordpress_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_categoria_wordpress_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_cw_id = scAjaxGetFieldText("cw_id");
    var var_cw_nombre = scAjaxGetFieldText("cw_nombre");
    var var_cw_descipccion = scAjaxGetFieldText("cw_descipccion");
    var var_cw_empresa = scAjaxGetFieldText("cw_empresa");
    ...
    scAjaxProcOn();
    x_ajax_form_del_categoria_wordpress_mob_submit_form(var_cw_id, var_cw_nombre, var_cw_descipccion, var_cw_empresa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_categoria_wordpress_mob_submit_form_cb);
  } // do_ajax_form_del_categoria_wordpress_mob_submit_form

  function do_ajax_form_del_categoria_wordpress_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("cw_id");
      scAjaxHideErrorDisplay("cw_nombre");
      scAjaxHideErrorDisplay("cw_descipccion");
      scAjaxHideErrorDisplay("cw_empresa");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_categoria_wordpress_mob_submit_form_cb_after_alert);
  } // do_ajax_form_del_categoria_wordpress_mob_submit_form_cb
  function do_ajax_form_del_categoria_wordpress_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_categoria_wordpress_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_categoria_wordpress_mob_navigate_form()
  {
    perform_ajax_form_del_categoria_wordpress_mob_navigate_form();
  }

  function perform_ajax_form_del_categoria_wordpress_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("cw_descipccion");
    scAjaxHideErrorDisplay("cw_empresa");
    var var_cw_id = document.F2.cw_id.value;
    var var_cw_empresa = document.F2.cw_empresa.value;
    ...
    scAjaxProcOn();
    x_ajax_form_del_categoria_wordpress_mob_navigate_form(var_cw_id, var_cw_empresa, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_categoria_wordpress_mob_navigate_form_cb);
  } // do_ajax_form_del_categoria_wordpress_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_categoria_wordpress_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_categoria_wordpress_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.cw_id.value = scAjaxGetKeyValue("cw_id");
    document.F2.cw_empresa.value = scAjaxGetKeyValue("cw_empresa");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_categoria_wordpress_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_del_categoria_wordpress_mob_navigate_form_cb
  function do_ajax_form_del_categoria_wordpress_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_del_categoria_wordpress_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_categoria_wordpress_mob_navigate_form_cb_after_alert

  function sc_hide_form_del_categoria_wordpress_mob_form()
  {
  ...
  ajax_field_list[0] = "cw_id";
  ajax_field_list[1] = "cw_nombre";
  ajax_field_list[2] = "cw_descipccion";
  ajax_field_list[3] = "cw_empresa";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "cw_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cw_nombre": {"label": "<?php echo $this->Ini->Nm_lang['lang_categoria'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cw_descipccion": {"label": "<?php echo $this->Ini->Nm_lang['lang_descripcion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cw_empresa": {"label": "<?php echo $this->Ini->Nm_lang['lang_empresa'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "cw_id": new Array(),
    "cw_nombre": new Array(),
    "cw_descipccion": new Array(),
    "cw_empresa": new Array()
  };
  ajax_field_mult["cw_id"][1] = "cw_id";
  ajax_field_mult["cw_nombre"][1] = "cw_nombre";
  ajax_field_mult["cw_descipccion"][1] = "cw_descipccion";
  ajax_field_mult["cw_empresa"][1] = "cw_empresa";

  var ajax_field_id = {
    "cw_id": new Array("hidden_field_label_cw_id", "hidden_field_data_cw_id"),
    "cw_nombre": new Array("hidden_field_label_cw_nombre", "hidden_field_data_cw_nombre"),
    "cw_descipccion": new Array("hidden_field_label_cw_descipccion", "hidden_field_data_cw_descipccion")
  };
