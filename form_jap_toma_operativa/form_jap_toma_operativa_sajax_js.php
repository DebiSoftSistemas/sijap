  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_jap_toma_operativa" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_jap_toma_operativa_form();
	}
...
?>
  ...
  // ---------- Validate to_id_
  function do_ajax_form_jap_toma_operativa_validate_to_id_(iNumLinha)
  {
    var nomeCampo_to_id_ = "to_id_" + iNumLinha;
    var var_to_id_ = scAjaxGetFieldHidden(nomeCampo_to_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_toma_operativa_validate_to_id_(var_to_id_, iNumLinha, var_script_case_init, do_ajax_form_jap_toma_operativa_validate_to_id__cb);
  } // do_ajax_form_jap_toma_operativa_validate_to_id_

  function do_ajax_form_jap_toma_operativa_validate_to_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "to_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "to_id_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "to_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "to_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_toma_operativa_validate_to_id__cb

  // ---------- Validate to_descripcion_
  function do_ajax_form_jap_toma_operativa_validate_to_descripcion_(iNumLinha)
  {
    var nomeCampo_to_descripcion_ = "to_descripcion_" + iNumLinha;
    var var_to_descripcion_ = scAjaxGetFieldText(nomeCampo_to_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_toma_operativa_validate_to_descripcion_(var_to_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_jap_toma_operativa_validate_to_descripcion__cb);
  } // do_ajax_form_jap_toma_operativa_validate_to_descripcion_

  function do_ajax_form_jap_toma_operativa_validate_to_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "to_descripcion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "to_descripcion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "to_descripcion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "to_descripcion_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_toma_operativa_validate_to_descripcion__cb

  // ---------- Validate to_toma_administrativa_
  function do_ajax_form_jap_toma_operativa_validate_to_toma_administrativa_(iNumLinha)
  {
    var nomeCampo_to_toma_administrativa_ = "to_toma_administrativa_" + iNumLinha;
    var var_to_toma_administrativa_ = scAjaxGetFieldSelect(nomeCampo_to_toma_administrativa_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_toma_operativa_validate_to_toma_administrativa_(var_to_toma_administrativa_, iNumLinha, var_script_case_init, do_ajax_form_jap_toma_operativa_validate_to_toma_administrativa__cb);
  } // do_ajax_form_jap_toma_operativa_validate_to_toma_administrativa_

  function do_ajax_form_jap_toma_operativa_validate_to_toma_administrativa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "to_toma_administrativa_" + iLineNumber;
    }
    else
    {
      sFieldValid = "to_toma_administrativa_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "to_toma_administrativa_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "to_toma_administrativa_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_toma_operativa_validate_to_toma_administrativa__cb

  // ---------- Validate to_estado_
  function do_ajax_form_jap_toma_operativa_validate_to_estado_(iNumLinha)
  {
    var nomeCampo_to_estado_ = "to_estado_" + iNumLinha;
    var var_to_estado_ = scAjaxGetFieldSelect(nomeCampo_to_estado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_toma_operativa_validate_to_estado_(var_to_estado_, iNumLinha, var_script_case_init, do_ajax_form_jap_toma_operativa_validate_to_estado__cb);
  } // do_ajax_form_jap_toma_operativa_validate_to_estado_

  function do_ajax_form_jap_toma_operativa_validate_to_estado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "to_estado_" + iLineNumber;
    }
    else
    {
      sFieldValid = "to_estado_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "to_estado_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "to_estado_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_toma_operativa_validate_to_estado__cb

  // ---------- Validate to_empresa_
  function do_ajax_form_jap_toma_operativa_validate_to_empresa_(iNumLinha)
  {
    var nomeCampo_to_empresa_ = "to_empresa_" + iNumLinha;
    var var_to_empresa_ = scAjaxGetFieldText(nomeCampo_to_empresa_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_toma_operativa_validate_to_empresa_(var_to_empresa_, iNumLinha, var_script_case_init, do_ajax_form_jap_toma_operativa_validate_to_empresa__cb);
  } // do_ajax_form_jap_toma_operativa_validate_to_empresa_

  function do_ajax_form_jap_toma_operativa_validate_to_empresa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "to_empresa_" + iLineNumber;
    }
    else
    {
      sFieldValid = "to_empresa_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "to_empresa_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "to_empresa_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_toma_operativa_validate_to_empresa__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_jap_toma_operativa_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_jap_toma_operativa_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_jap_toma_operativa_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_jap_toma_operativa_add_new_line_cb);
  } // do_ajax_form_jap_toma_operativa_add_new_line

  function do_ajax_form_jap_toma_operativa_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_jap_toma_operativa_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_jap_toma_operativa_backup_line(iNumLinha)
  {
    var var_to_id_ = scAjaxGetFieldHidden("to_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_toma_operativa_backup_line(var_to_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_jap_toma_operativa_backup_line_cb);
  } // do_ajax_form_jap_toma_operativa_backup_line

  function do_ajax_form_jap_toma_operativa_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_jap_toma_operativa_backup_line_cb

  function do_ajax_form_jap_toma_operativa_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_jap_toma_operativa_cancel_insert

  function do_ajax_form_jap_toma_operativa_cancel_update(iSeqVert)
  {
    do_ajax_form_jap_toma_operativa_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_jap_toma_operativa_cancel_update

  function do_ajax_form_jap_toma_operativa_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_jap_toma_operativa_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_jap_toma_operativa_table_refresh()
  {
    var var_to_id_ = document.F2.to_id_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_jap_toma_operativa_table_refresh(var_to_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jap_toma_operativa_table_refresh_cb);
  } //  do_ajax_form_jap_toma_operativa_table_refresh

  function do_ajax_form_jap_toma_operativa_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.to_id_.value = scAjaxGetKeyValue("to_id_");
    ...
    scAjaxAlert(do_ajax_form_jap_toma_operativa_table_refresh_cb_after_alert);
  } // do_ajax_form_jap_toma_operativa_table_refresh_cb
  function do_ajax_form_jap_toma_operativa_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_jap_toma_operativa_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_jap_toma_operativa_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_jap_toma_operativa_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_to_id_ = scAjaxGetFieldHidden("to_id_" + iNumLinha);
    var var_to_descripcion_ = scAjaxGetFieldText("to_descripcion_" + iNumLinha);
    var var_to_toma_administrativa_ = scAjaxGetFieldSelect("to_toma_administrativa_" + iNumLinha);
    var var_to_estado_ = scAjaxGetFieldSelect("to_estado_" + iNumLinha);
    var var_to_empresa_ = scAjaxGetFieldText("to_empresa_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_jap_toma_operativa_submit_form(var_to_id_, var_to_descripcion_, var_to_toma_administrativa_, var_to_estado_, var_to_empresa_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_jap_toma_operativa_submit_form_cb);
  } // do_ajax_form_jap_toma_operativa_submit_form

  function do_ajax_form_jap_toma_operativa_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("to_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("to_descripcion_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("to_toma_administrativa_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("to_estado_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("to_empresa_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_jap_toma_operativa_submit_form_cb_after_alert);
  } // do_ajax_form_jap_toma_operativa_submit_form_cb
  function do_ajax_form_jap_toma_operativa_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_jap_toma_operativa_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_jap_toma_operativa_navigate_form()
  {
    perform_ajax_form_jap_toma_operativa_navigate_form();
  }

  function perform_ajax_form_jap_toma_operativa_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_jap_toma_operativa_cancel_insert(sc_form_jap_toma_operativa_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("to_id_" + iNavForm);
      scAjaxHideErrorDisplay("to_descripcion_" + iNavForm);
      scAjaxHideErrorDisplay("to_toma_administrativa_" + iNavForm);
      scAjaxHideErrorDisplay("to_estado_" + iNavForm);
      scAjaxHideErrorDisplay("to_empresa_" + iNavForm);
    }
    var var_to_id_ = document.F2.to_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_jap_toma_operativa_navigate_form(var_to_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jap_toma_operativa_navigate_form_cb);
  } // do_ajax_form_jap_toma_operativa_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_toma_operativa']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_jap_toma_operativa_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.to_id_.value = scAjaxGetKeyValue("to_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_jap_toma_operativa_navigate_form_cb_after_alert);
  } // do_ajax_form_jap_toma_operativa_navigate_form_cb
  function do_ajax_form_jap_toma_operativa_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_jap_toma_operativa_navigate_form_cb_after_alert

    function sc_form_jap_toma_operativa_get_last_line_number()
    {
    ...
    } //sc_form_jap_toma_operativa_get_last_line_number

  function sc_hide_form_jap_toma_operativa_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "to_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "to_descripcion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "to_toma_administrativa_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "to_estado_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "to_empresa_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["to_id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["to_descripcion_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_descripcion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["to_toma_administrativa_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_toma_administrativa'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["to_estado_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["to_empresa_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_empresa'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["to_id_"][iNumLinha] = "to_id_" + iNumLinha;
    ajax_field_mult["to_descripcion_"][iNumLinha] = "to_descripcion_" + iNumLinha;
    ajax_field_mult["to_toma_administrativa_"][iNumLinha] = "to_toma_administrativa_" + iNumLinha;
    ajax_field_mult["to_estado_"][iNumLinha] = "to_estado_" + iNumLinha;
    ajax_field_mult["to_empresa_"][iNumLinha] = "to_empresa_" + iNumLinha;
    ajax_field_id["to_descripcion_" + iNumLinha] = new Array("hidden_field_label_to_descripcion_", "hidden_field_data_to_descripcion_" + iNumLinha);
    ajax_field_id["to_toma_administrativa_" + iNumLinha] = new Array("hidden_field_label_to_toma_administrativa_", "hidden_field_data_to_toma_administrativa_" + iNumLinha);
    ajax_field_id["to_estado_" + iNumLinha] = new Array("hidden_field_label_to_estado_", "hidden_field_data_to_estado_" + iNumLinha);
    ajax_error_count["to_id_" + iNumLinha] = "off";
    ajax_error_count["to_descripcion_" + iNumLinha] = "off";
    ajax_error_count["to_toma_administrativa_" + iNumLinha] = "off";
    ajax_error_count["to_estado_" + iNumLinha] = "off";
    ajax_error_count["to_empresa_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["to_id_" + iNumLinha] = "on";
    ajax_read_only["to_descripcion_" + iNumLinha] = "off";
    ajax_read_only["to_toma_administrativa_" + iNumLinha] = "off";
    ajax_read_only["to_estado_" + iNumLinha] = "off";
    ajax_read_only["to_empresa_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["to_id_" + iNumLinha] = "on";
    ajax_read_only["to_descripcion_" + iNumLinha] = "on";
    ajax_read_only["to_toma_administrativa_" + iNumLinha] = "on";
    ajax_read_only["to_estado_" + iNumLinha] = "on";
    ajax_read_only["to_empresa_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["to_id_" + iNumLinha] = null;
    ajax_error_list["to_descripcion_" + iNumLinha] = null;
    ajax_error_list["to_toma_administrativa_" + iNumLinha] = null;
    ajax_error_list["to_estado_" + iNumLinha] = null;
    ajax_error_list["to_empresa_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "to_id_": new Array(),
    "to_descripcion_": new Array(),
    "to_toma_administrativa_": new Array(),
    "to_estado_": new Array(),
    "to_empresa_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["to_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["to_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["to_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["to_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["to_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["to_descripcion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["to_descripcion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["to_descripcion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["to_descripcion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["to_descripcion_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["to_toma_administrativa_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["to_toma_administrativa_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["to_toma_administrativa_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["to_toma_administrativa_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["to_toma_administrativa_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["to_estado_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["to_estado_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["to_estado_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["to_estado_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["to_estado_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["to_empresa_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["to_empresa_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["to_empresa_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["to_empresa_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["to_empresa_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['to_id_'])) ? $this->nmgp_cmp_readonly['to_id_'] : 'on';
?>
    scAjaxFieldRead("to_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['to_descripcion_'])) ? $this->nmgp_cmp_readonly['to_descripcion_'] : 'off';
?>
    scAjaxFieldRead("to_descripcion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['to_toma_administrativa_'])) ? $this->nmgp_cmp_readonly['to_toma_administrativa_'] : 'off';
?>
    scAjaxFieldRead("to_toma_administrativa_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['to_estado_'])) ? $this->nmgp_cmp_readonly['to_estado_'] : 'off';
?>
    scAjaxFieldRead("to_estado_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['to_empresa_'])) ? $this->nmgp_cmp_readonly['to_empresa_'] : 'off';
?>
    scAjaxFieldRead("to_empresa_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("to_id_" + iSeq, "on");
    scAjaxFieldRead("to_descripcion_" + iSeq, "on");
    scAjaxFieldRead("to_toma_administrativa_" + iSeq, "on");
    scAjaxFieldRead("to_estado_" + iSeq, "on");
    scAjaxFieldRead("to_empresa_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["to_id_" + iRow] || "on" == ajax_error_count["to_descripcion_" + iRow] || "on" == ajax_error_count["to_toma_administrativa_" + iRow] || "on" == ajax_error_count["to_estado_" + iRow] || "on" == ajax_error_count["to_empresa_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_to_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_to_descripcion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_to_toma_administrativa_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_to_estado_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_to_empresa_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["to_id_" + iRow] && "off" == ajax_error_count["to_descripcion_" + iRow] && "off" == ajax_error_count["to_toma_administrativa_" + iRow] && "off" == ajax_error_count["to_estado_" + iRow] && "off" == ajax_error_count["to_empresa_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["to_id_" + iRow] = "off";
        ajax_error_count["to_descripcion_" + iRow] = "off";
        ajax_error_count["to_toma_administrativa_" + iRow] = "off";
        ajax_error_count["to_estado_" + iRow] = "off";
        ajax_error_count["to_empresa_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_to_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_to_descripcion_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_to_toma_administrativa_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_to_estado_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_to_empresa_" + iRow).removeClass("scFormErrorLine");
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("to_toma_administrativa_" == sIndex)
    {
