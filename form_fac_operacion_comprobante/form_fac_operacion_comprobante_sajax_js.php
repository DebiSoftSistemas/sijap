  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_fac_operacion_comprobante" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_fac_operacion_comprobante_form();
	}
...
?>
  ...
  // ---------- Validate op_operacion_
  function do_ajax_form_fac_operacion_comprobante_validate_op_operacion_(iNumLinha)
  {
    var nomeCampo_op_operacion_ = "op_operacion_" + iNumLinha;
    var var_op_operacion_ = scAjaxGetFieldText(nomeCampo_op_operacion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operacion_comprobante_validate_op_operacion_(var_op_operacion_, iNumLinha, var_script_case_init, do_ajax_form_fac_operacion_comprobante_validate_op_operacion__cb);
  } // do_ajax_form_fac_operacion_comprobante_validate_op_operacion_

  function do_ajax_form_fac_operacion_comprobante_validate_op_operacion__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "op_operacion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "op_operacion_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "op_operacion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "op_operacion_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operacion_comprobante_validate_op_operacion__cb

  // ---------- Validate op_fecha_ini_
  function do_ajax_form_fac_operacion_comprobante_validate_op_fecha_ini_(iNumLinha)
  {
    var nomeCampo_op_fecha_ini_ = "op_fecha_ini_" + iNumLinha;
    var var_op_fecha_ini_ = scAjaxGetFieldHidden(nomeCampo_op_fecha_ini_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operacion_comprobante_validate_op_fecha_ini_(var_op_fecha_ini_, iNumLinha, var_script_case_init, do_ajax_form_fac_operacion_comprobante_validate_op_fecha_ini__cb);
  } // do_ajax_form_fac_operacion_comprobante_validate_op_fecha_ini_

  function do_ajax_form_fac_operacion_comprobante_validate_op_fecha_ini__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "op_fecha_ini_" + iLineNumber;
    }
    else
    {
      sFieldValid = "op_fecha_ini_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "op_fecha_ini_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "op_fecha_ini_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operacion_comprobante_validate_op_fecha_ini__cb

  // ---------- Validate op_comentario_
  function do_ajax_form_fac_operacion_comprobante_validate_op_comentario_(iNumLinha)
  {
    var nomeCampo_op_comentario_ = "op_comentario_" + iNumLinha;
    var var_op_comentario_ = scAjaxGetFieldHidden(nomeCampo_op_comentario_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operacion_comprobante_validate_op_comentario_(var_op_comentario_, iNumLinha, var_script_case_init, do_ajax_form_fac_operacion_comprobante_validate_op_comentario__cb);
  } // do_ajax_form_fac_operacion_comprobante_validate_op_comentario_

  function do_ajax_form_fac_operacion_comprobante_validate_op_comentario__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "op_comentario_" + iLineNumber;
    }
    else
    {
      sFieldValid = "op_comentario_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "op_comentario_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "op_comentario_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operacion_comprobante_validate_op_comentario__cb

  // ---------- Validate op_subtotal_
  function do_ajax_form_fac_operacion_comprobante_validate_op_subtotal_(iNumLinha)
  {
    var nomeCampo_op_subtotal_ = "op_subtotal_" + iNumLinha;
    var var_op_subtotal_ = scAjaxGetFieldHidden(nomeCampo_op_subtotal_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operacion_comprobante_validate_op_subtotal_(var_op_subtotal_, iNumLinha, var_script_case_init, do_ajax_form_fac_operacion_comprobante_validate_op_subtotal__cb);
  } // do_ajax_form_fac_operacion_comprobante_validate_op_subtotal_

  function do_ajax_form_fac_operacion_comprobante_validate_op_subtotal__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "op_subtotal_" + iLineNumber;
    }
    else
    {
      sFieldValid = "op_subtotal_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "op_subtotal_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "op_subtotal_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operacion_comprobante_validate_op_subtotal__cb

  // ---------- Validate op_subtotal_iva_
  function do_ajax_form_fac_operacion_comprobante_validate_op_subtotal_iva_(iNumLinha)
  {
    var nomeCampo_op_subtotal_iva_ = "op_subtotal_iva_" + iNumLinha;
    var var_op_subtotal_iva_ = scAjaxGetFieldHidden(nomeCampo_op_subtotal_iva_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operacion_comprobante_validate_op_subtotal_iva_(var_op_subtotal_iva_, iNumLinha, var_script_case_init, do_ajax_form_fac_operacion_comprobante_validate_op_subtotal_iva__cb);
  } // do_ajax_form_fac_operacion_comprobante_validate_op_subtotal_iva_

  function do_ajax_form_fac_operacion_comprobante_validate_op_subtotal_iva__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "op_subtotal_iva_" + iLineNumber;
    }
    else
    {
      sFieldValid = "op_subtotal_iva_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "op_subtotal_iva_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "op_subtotal_iva_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operacion_comprobante_validate_op_subtotal_iva__cb

  // ---------- Validate op_total_
  function do_ajax_form_fac_operacion_comprobante_validate_op_total_(iNumLinha)
  {
    var nomeCampo_op_total_ = "op_total_" + iNumLinha;
    var var_op_total_ = scAjaxGetFieldHidden(nomeCampo_op_total_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operacion_comprobante_validate_op_total_(var_op_total_, iNumLinha, var_script_case_init, do_ajax_form_fac_operacion_comprobante_validate_op_total__cb);
  } // do_ajax_form_fac_operacion_comprobante_validate_op_total_

  function do_ajax_form_fac_operacion_comprobante_validate_op_total__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "op_total_" + iLineNumber;
    }
    else
    {
      sFieldValid = "op_total_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "op_total_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "op_total_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operacion_comprobante_validate_op_total__cb

  // ---------- Validate op_seleccion_
  function do_ajax_form_fac_operacion_comprobante_validate_op_seleccion_(iNumLinha)
  {
    var nomeCampo_op_seleccion_ = "op_seleccion_" + iNumLinha;
    var var_op_seleccion_ = scAjaxGetFieldCheckbox(nomeCampo_op_seleccion_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operacion_comprobante_validate_op_seleccion_(var_op_seleccion_, iNumLinha, var_script_case_init, do_ajax_form_fac_operacion_comprobante_validate_op_seleccion__cb);
  } // do_ajax_form_fac_operacion_comprobante_validate_op_seleccion_

  function do_ajax_form_fac_operacion_comprobante_validate_op_seleccion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "op_seleccion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "op_seleccion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "op_seleccion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "op_seleccion_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operacion_comprobante_validate_op_seleccion__cb

  // ---------- Validate op_propietario_
  function do_ajax_form_fac_operacion_comprobante_validate_op_propietario_(iNumLinha)
  {
    var nomeCampo_op_propietario_ = "op_propietario_" + iNumLinha;
    var var_op_propietario_ = scAjaxGetFieldHidden(nomeCampo_op_propietario_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operacion_comprobante_validate_op_propietario_(var_op_propietario_, iNumLinha, var_script_case_init, do_ajax_form_fac_operacion_comprobante_validate_op_propietario__cb);
  } // do_ajax_form_fac_operacion_comprobante_validate_op_propietario_

  function do_ajax_form_fac_operacion_comprobante_validate_op_propietario__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "op_propietario_" + iLineNumber;
    }
    else
    {
      sFieldValid = "op_propietario_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "op_propietario_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "op_propietario_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operacion_comprobante_validate_op_propietario__cb

  // ---------- Event onchange op_seleccion_
  function do_ajax_form_fac_operacion_comprobante_event_op_seleccion__onchange(iSeqForm)
  {
    var var_op_seleccion_ = scAjaxGetFieldCheckbox("op_seleccion_" + iSeqForm, ";");
    var var_op_operacion_ = scAjaxGetFieldText("op_operacion_" + iSeqForm);
    var var_op_propietario_ = scAjaxGetFieldHidden("op_propietario_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_fac_operacion_comprobante_event_op_seleccion__onchange(var_op_seleccion_, var_op_operacion_, var_op_propietario_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_fac_operacion_comprobante_event_op_seleccion__onchange_cb);
  } // do_ajax_form_fac_operacion_comprobante_event_op_seleccion__onchange

  function do_ajax_form_fac_operacion_comprobante_event_op_seleccion__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_fac_operacion_comprobante_event_op_seleccion__onchange_cb_after_alert);
  } // do_ajax_form_fac_operacion_comprobante_event_op_seleccion__onchange_cb
  function do_ajax_form_fac_operacion_comprobante_event_op_seleccion__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_fac_operacion_comprobante_event_op_seleccion__onchange_cb_after_alert

  // ---------- Event onclick op_seleccion_
  function do_ajax_form_fac_operacion_comprobante_event_op_seleccion__onclick(iSeqForm)
  {
    var var_op_seleccion_ = scAjaxGetFieldCheckbox("op_seleccion_" + iSeqForm, ";");
    var var_op_operacion_ = scAjaxGetFieldText("op_operacion_" + iSeqForm);
    var var_op_propietario_ = scAjaxGetFieldHidden("op_propietario_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_fac_operacion_comprobante_event_op_seleccion__onclick(var_op_seleccion_, var_op_operacion_, var_op_propietario_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_fac_operacion_comprobante_event_op_seleccion__onclick_cb);
  } // do_ajax_form_fac_operacion_comprobante_event_op_seleccion__onclick

  function do_ajax_form_fac_operacion_comprobante_event_op_seleccion__onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_fac_operacion_comprobante_event_op_seleccion__onclick_cb_after_alert);
  } // do_ajax_form_fac_operacion_comprobante_event_op_seleccion__onclick_cb
  function do_ajax_form_fac_operacion_comprobante_event_op_seleccion__onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_fac_operacion_comprobante_event_op_seleccion__onclick_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_fac_operacion_comprobante_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_fac_operacion_comprobante_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_fac_operacion_comprobante_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_fac_operacion_comprobante_add_new_line_cb);
  } // do_ajax_form_fac_operacion_comprobante_add_new_line

  function do_ajax_form_fac_operacion_comprobante_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_fac_operacion_comprobante_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_fac_operacion_comprobante_backup_line(iNumLinha)
  {
    var var_op_operacion_ = scAjaxGetFieldText("op_operacion_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operacion_comprobante_backup_line(var_op_operacion_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_fac_operacion_comprobante_backup_line_cb);
  } // do_ajax_form_fac_operacion_comprobante_backup_line

  function do_ajax_form_fac_operacion_comprobante_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_fac_operacion_comprobante_backup_line_cb

  function do_ajax_form_fac_operacion_comprobante_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_fac_operacion_comprobante_cancel_insert

  function do_ajax_form_fac_operacion_comprobante_cancel_update(iSeqVert)
  {
    do_ajax_form_fac_operacion_comprobante_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_fac_operacion_comprobante_cancel_update

  function do_ajax_form_fac_operacion_comprobante_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_fac_operacion_comprobante_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_fac_operacion_comprobante_table_refresh()
  {
    var var_op_operacion_ = document.F2.op_operacion_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_fac_operacion_comprobante_table_refresh(var_op_operacion_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_operacion_comprobante_table_refresh_cb);
  } //  do_ajax_form_fac_operacion_comprobante_table_refresh

  function do_ajax_form_fac_operacion_comprobante_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.op_operacion_.value = scAjaxGetKeyValue("op_operacion_");
    ...
    scAjaxAlert(do_ajax_form_fac_operacion_comprobante_table_refresh_cb_after_alert);
  } // do_ajax_form_fac_operacion_comprobante_table_refresh_cb
  function do_ajax_form_fac_operacion_comprobante_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("b");
    sc_insert_open = false;
  } // do_ajax_form_fac_operacion_comprobante_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_fac_operacion_comprobante_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_fac_operacion_comprobante_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_op_operacion_ = scAjaxGetFieldText("op_operacion_" + iNumLinha);
    var var_op_fecha_ini_ = scAjaxGetFieldHidden("op_fecha_ini_" + iNumLinha);
    var var_op_comentario_ = scAjaxGetFieldHidden("op_comentario_" + iNumLinha);
    var var_op_subtotal_ = scAjaxGetFieldHidden("op_subtotal_" + iNumLinha);
    var var_op_subtotal_iva_ = scAjaxGetFieldHidden("op_subtotal_iva_" + iNumLinha);
    var var_op_total_ = scAjaxGetFieldHidden("op_total_" + iNumLinha);
    var var_op_seleccion_ = scAjaxGetFieldCheckbox("op_seleccion_" + iNumLinha, ";");
    var var_op_propietario_ = scAjaxGetFieldHidden("op_propietario_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_fac_operacion_comprobante_submit_form(var_op_operacion_, var_op_fecha_ini_, var_op_comentario_, var_op_subtotal_, var_op_subtotal_iva_, var_op_total_, var_op_seleccion_, var_op_propietario_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_fac_operacion_comprobante_submit_form_cb);
  } // do_ajax_form_fac_operacion_comprobante_submit_form

  function do_ajax_form_fac_operacion_comprobante_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("op_operacion_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("op_fecha_ini_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("op_comentario_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("op_subtotal_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("op_subtotal_iva_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("op_total_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("op_seleccion_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("op_propietario_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_fac_operacion_comprobante_submit_form_cb_after_alert);
  } // do_ajax_form_fac_operacion_comprobante_submit_form_cb
  function do_ajax_form_fac_operacion_comprobante_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_fac_operacion_comprobante_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_fac_operacion_comprobante_navigate_form()
  {
    perform_ajax_form_fac_operacion_comprobante_navigate_form();
  }

  function perform_ajax_form_fac_operacion_comprobante_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_fac_operacion_comprobante_cancel_insert(sc_form_fac_operacion_comprobante_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("op_operacion_" + iNavForm);
      scAjaxHideErrorDisplay("op_fecha_ini_" + iNavForm);
      scAjaxHideErrorDisplay("op_comentario_" + iNavForm);
      scAjaxHideErrorDisplay("op_subtotal_" + iNavForm);
      scAjaxHideErrorDisplay("op_subtotal_iva_" + iNavForm);
      scAjaxHideErrorDisplay("op_total_" + iNavForm);
      scAjaxHideErrorDisplay("op_seleccion_" + iNavForm);
      scAjaxHideErrorDisplay("op_propietario_" + iNavForm);
    }
    var var_op_operacion_ = document.F2.op_operacion_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_fac_operacion_comprobante_navigate_form(var_op_operacion_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_operacion_comprobante_navigate_form_cb);
  } // do_ajax_form_fac_operacion_comprobante_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_operacion_comprobante']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_fac_operacion_comprobante_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.op_operacion_.value = scAjaxGetKeyValue("op_operacion_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_fac_operacion_comprobante_navigate_form_cb_after_alert);
  } // do_ajax_form_fac_operacion_comprobante_navigate_form_cb
  function do_ajax_form_fac_operacion_comprobante_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_fac_operacion_comprobante_navigate_form_cb_after_alert

    function sc_form_fac_operacion_comprobante_get_last_line_number()
    {
    ...
    } //sc_form_fac_operacion_comprobante_get_last_line_number

  function sc_hide_form_fac_operacion_comprobante_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "op_operacion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "op_fecha_ini_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "op_comentario_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "op_subtotal_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "op_subtotal_iva_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "op_total_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "op_seleccion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "op_propietario_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["op_operacion_" + iNumLinha] = {"label": "Op Operacion<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["op_fecha_ini_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_fecha'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["op_comentario_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_comentario'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["op_subtotal_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_subtotal'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["op_subtotal_iva_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_iva'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["op_total_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_total'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["op_seleccion_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_seleccion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["op_propietario_" + iNumLinha] = {"label": "Op Propietario<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["op_operacion_"][iNumLinha] = "op_operacion_" + iNumLinha;
    ajax_field_mult["op_fecha_ini_"][iNumLinha] = "op_fecha_ini_" + iNumLinha;
    ajax_field_mult["op_comentario_"][iNumLinha] = "op_comentario_" + iNumLinha;
    ajax_field_mult["op_subtotal_"][iNumLinha] = "op_subtotal_" + iNumLinha;
    ajax_field_mult["op_subtotal_iva_"][iNumLinha] = "op_subtotal_iva_" + iNumLinha;
    ajax_field_mult["op_total_"][iNumLinha] = "op_total_" + iNumLinha;
    ajax_field_mult["op_seleccion_"][iNumLinha] = "op_seleccion_" + iNumLinha;
    ajax_field_mult["op_propietario_"][iNumLinha] = "op_propietario_" + iNumLinha;
    ajax_field_id["op_fecha_ini_" + iNumLinha] = new Array("hidden_field_label_op_fecha_ini_", "hidden_field_data_op_fecha_ini_" + iNumLinha);
    ajax_field_id["op_comentario_" + iNumLinha] = new Array("hidden_field_label_op_comentario_", "hidden_field_data_op_comentario_" + iNumLinha);
    ajax_field_id["op_subtotal_" + iNumLinha] = new Array("hidden_field_label_op_subtotal_", "hidden_field_data_op_subtotal_" + iNumLinha);
    ajax_field_id["op_subtotal_iva_" + iNumLinha] = new Array("hidden_field_label_op_subtotal_iva_", "hidden_field_data_op_subtotal_iva_" + iNumLinha);
    ajax_field_id["op_total_" + iNumLinha] = new Array("hidden_field_label_op_total_", "hidden_field_data_op_total_" + iNumLinha);
    ajax_field_id["op_seleccion_" + iNumLinha] = new Array("hidden_field_label_op_seleccion_", "hidden_field_data_op_seleccion_" + iNumLinha);
    ajax_error_count["op_operacion_" + iNumLinha] = "off";
    ajax_error_count["op_fecha_ini_" + iNumLinha] = "off";
    ajax_error_count["op_comentario_" + iNumLinha] = "off";
    ajax_error_count["op_subtotal_" + iNumLinha] = "off";
    ajax_error_count["op_subtotal_iva_" + iNumLinha] = "off";
    ajax_error_count["op_total_" + iNumLinha] = "off";
    ajax_error_count["op_seleccion_" + iNumLinha] = "off";
    ajax_error_count["op_propietario_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["op_operacion_" + iNumLinha] = "on";
    ajax_read_only["op_fecha_ini_" + iNumLinha] = "off";
    ajax_read_only["op_comentario_" + iNumLinha] = "off";
    ajax_read_only["op_subtotal_" + iNumLinha] = "off";
    ajax_read_only["op_subtotal_iva_" + iNumLinha] = "off";
    ajax_read_only["op_total_" + iNumLinha] = "off";
    ajax_read_only["op_seleccion_" + iNumLinha] = "off";
    ajax_read_only["op_propietario_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["op_operacion_" + iNumLinha] = "on";
    ajax_read_only["op_fecha_ini_" + iNumLinha] = "on";
    ajax_read_only["op_comentario_" + iNumLinha] = "on";
    ajax_read_only["op_subtotal_" + iNumLinha] = "on";
    ajax_read_only["op_subtotal_iva_" + iNumLinha] = "on";
    ajax_read_only["op_total_" + iNumLinha] = "on";
    ajax_read_only["op_seleccion_" + iNumLinha] = "on";
    ajax_read_only["op_propietario_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["op_operacion_" + iNumLinha] = null;
    ajax_error_list["op_fecha_ini_" + iNumLinha] = null;
    ajax_error_list["op_comentario_" + iNumLinha] = null;
    ajax_error_list["op_subtotal_" + iNumLinha] = null;
    ajax_error_list["op_subtotal_iva_" + iNumLinha] = null;
    ajax_error_list["op_total_" + iNumLinha] = null;
    ajax_error_list["op_seleccion_" + iNumLinha] = null;
    ajax_error_list["op_propietario_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "op_operacion_": new Array(),
    "op_fecha_ini_": new Array(),
    "op_comentario_": new Array(),
    "op_subtotal_": new Array(),
    "op_subtotal_iva_": new Array(),
    "op_total_": new Array(),
    "op_seleccion_": new Array(),
    "op_propietario_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["op_operacion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["op_operacion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["op_operacion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["op_operacion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["op_operacion_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["op_fecha_ini_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["op_fecha_ini_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["op_fecha_ini_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["op_fecha_ini_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["op_fecha_ini_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["op_comentario_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["op_comentario_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["op_comentario_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["op_comentario_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["op_comentario_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["op_subtotal_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["op_subtotal_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["op_subtotal_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["op_subtotal_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["op_subtotal_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["op_subtotal_iva_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["op_subtotal_iva_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["op_subtotal_iva_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["op_subtotal_iva_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["op_subtotal_iva_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["op_total_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["op_total_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["op_total_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["op_total_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["op_total_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["op_seleccion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["op_seleccion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["op_seleccion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["op_seleccion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["op_seleccion_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["op_propietario_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["op_propietario_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["op_propietario_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["op_propietario_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["op_propietario_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['op_operacion_'])) ? $this->nmgp_cmp_readonly['op_operacion_'] : 'on';
?>
    scAjaxFieldRead("op_operacion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['op_fecha_ini_'])) ? $this->nmgp_cmp_readonly['op_fecha_ini_'] : 'off';
?>
    scAjaxFieldRead("op_fecha_ini_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['op_comentario_'])) ? $this->nmgp_cmp_readonly['op_comentario_'] : 'off';
?>
    scAjaxFieldRead("op_comentario_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['op_subtotal_'])) ? $this->nmgp_cmp_readonly['op_subtotal_'] : 'off';
?>
    scAjaxFieldRead("op_subtotal_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['op_subtotal_iva_'])) ? $this->nmgp_cmp_readonly['op_subtotal_iva_'] : 'off';
?>
    scAjaxFieldRead("op_subtotal_iva_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['op_total_'])) ? $this->nmgp_cmp_readonly['op_total_'] : 'off';
?>
    scAjaxFieldRead("op_total_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['op_seleccion_'])) ? $this->nmgp_cmp_readonly['op_seleccion_'] : 'off';
?>
    scAjaxFieldRead("op_seleccion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['op_propietario_'])) ? $this->nmgp_cmp_readonly['op_propietario_'] : 'off';
?>
    scAjaxFieldRead("op_propietario_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("op_operacion_" + iSeq, "on");
    scAjaxFieldRead("op_fecha_ini_" + iSeq, "on");
    scAjaxFieldRead("op_comentario_" + iSeq, "on");
    scAjaxFieldRead("op_subtotal_" + iSeq, "on");
    scAjaxFieldRead("op_subtotal_iva_" + iSeq, "on");
    scAjaxFieldRead("op_total_" + iSeq, "on");
    scAjaxFieldRead("op_seleccion_" + iSeq, "on");
    scAjaxFieldRead("op_propietario_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["op_operacion_" + iRow] || "on" == ajax_error_count["op_fecha_ini_" + iRow] || "on" == ajax_error_count["op_comentario_" + iRow] || "on" == ajax_error_count["op_subtotal_" + iRow] || "on" == ajax_error_count["op_subtotal_iva_" + iRow] || "on" == ajax_error_count["op_total_" + iRow] || "on" == ajax_error_count["op_seleccion_" + iRow] || "on" == ajax_error_count["op_propietario_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_op_operacion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_op_fecha_ini_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_op_comentario_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_op_subtotal_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_op_subtotal_iva_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_op_total_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_op_seleccion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_op_propietario_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["op_operacion_" + iRow] && "off" == ajax_error_count["op_fecha_ini_" + iRow] && "off" == ajax_error_count["op_comentario_" + iRow] && "off" == ajax_error_count["op_subtotal_" + iRow] && "off" == ajax_error_count["op_subtotal_iva_" + iRow] && "off" == ajax_error_count["op_total_" + iRow] && "off" == ajax_error_count["op_seleccion_" + iRow] && "off" == ajax_error_count["op_propietario_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["op_operacion_" + iRow] = "off";
        ajax_error_count["op_fecha_ini_" + iRow] = "off";
        ajax_error_count["op_comentario_" + iRow] = "off";
        ajax_error_count["op_subtotal_" + iRow] = "off";
        ajax_error_count["op_subtotal_iva_" + iRow] = "off";
        ajax_error_count["op_total_" + iRow] = "off";
        ajax_error_count["op_seleccion_" + iRow] = "off";
        ajax_error_count["op_propietario_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_op_operacion_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_op_fecha_ini_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_op_comentario_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_op_subtotal_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_op_subtotal_iva_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_op_total_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_op_seleccion_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_op_propietario_" + iRow).removeClass("scFormErrorLine");
    }
  }
