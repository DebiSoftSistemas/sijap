<?php
@session_start() ;
$_SESSION['scriptcase']['grid_fac_operacion_contrato_comp']['sc_process_barr'] = true;
require_once('../grid_fac_operacion_contrato_comp/index.php');
unset($_SESSION['scriptcase']['grid_fac_operacion_contrato_comp']['sc_process_barr']);
$ExportCtrl = new grid_fac_operacion_contrato_comp_export_control;
$ExportCtrl->Export_barr();

class grid_fac_operacion_contrato_comp_export_control
{
