<?php
class grid_fac_operacion_contrato_comp_grid
{
   var $Ini;
   var $Erro;
   var $Db;
   ...
   var $sum_con_numero_contrato_op_subtotal;
   var $sum_con_numero_contrato_op_iva;
   var $sum_con_numero_contrato_op_total;
   var $seleccionar;
   var $detalles;
...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_fac_operacion_contrato_comp']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_fac_operacion_contrato_comp']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_fac_operacion_contrato_comp']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['usr_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['usr_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['usr_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['grid_pesq'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['grid_pesq'] = array();
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['charts_html'] = '';
   ...
   { 
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['proc_pdf_vert'])
            {
            } 
            else
            {
       ...
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_fac_operacion_contrato_comp'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'];
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_top();
       } 
       unset ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['save_grid']);
       $this->grid();
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['print_all'] && empty($this->nm_grid_sem_reg) && ($Gera_res || $Gera_graf))
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] == "pdf")
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] == "pdf")
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] = "igual";
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'];
 }
...
//
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['Ind_lig_mult'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['Ind_lig_mult'] = 0;
   }
   $this->Img_embbed      = false;
   $this->nm_data         = new nm_data("es");
   $this->pdf_label_group = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opc_pdf']['label_group'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opc_pdf']['label_group'] : "N";
   $this->pdf_all_cab     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opc_pdf']['all_cab']))     ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opc_pdf']['all_cab'] : "S";
   $this->pdf_all_label   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opc_pdf']['all_label']))   ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opc_pdf']['all_label'] : "S";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opc_liga']['fix_top'])) {
       $this->Fix_bar_top = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opc_liga']['fix_top'] == "S") ? true : false;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opc_liga']['fix_bot'])) {
       $this->Fix_bar_bottom = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opc_liga']['fix_bot'] == "S") ? true : false;
   }
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "grid_fac_operacion_contrato_comp/grid_fac_operacion_contrato_comp_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida'] || $this->Ini->Embutida_iframe)
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['force_toolbar']);
   } 
       $this->Tem_tab_vert = false;
   $this->width_tabula_quebra  = "3px";
   $this->width_tabula_display = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_fac_operacion_contrato_comp']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_fac_operacion_contrato_comp']['lig_edit'] != '')
   {
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_fac_operacion_contrato_comp']['lig_edit'] == "on")  {$_SESSION['scriptcase']['sc_apl_conf']['grid_fac_operacion_contrato_comp']['lig_edit'] = "S";}
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_fac_operacion_contrato_comp']['lig_edit'] == "off") {$_SESSION['scriptcase']['sc_apl_conf']['grid_fac_operacion_contrato_comp']['lig_edit'] = "N";}
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_fac_operacion_contrato_comp']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['mostra_edit'] = "N";
       }
   }
   if ($this->Ini->SC_Link_View || ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opc_psq'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['psq_edit'] == 'N'))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['mostra_edit'] = "N";
   }
   $this->NM_cont_body   = 0; 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ind_tree'] = 0;
   }
   elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['emb_tree_no']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['emb_tree_no'])
   { 
       $this->NM_emb_tree_no = true; 
   }
   $this->aba_iframe = false;
   $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['print_all'];
   if ($this->Print_All)
   {
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("grid_fac_operacion_contrato_comp", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_fac_operacion_contrato_comp']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_fac_operacion_contrato_comp']['btn_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_fac_operacion_contrato_comp']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
       {
           $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
       }
   }
   $this->Proc_link_res = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['where_resumo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['where_resumo'])) 
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['doc_word'] || $this->Ini->sc_export_ajax_img)
   { 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['campos_busca']))
   { 
       $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['campos_busca'];
   ...
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['where_pesq_filtro'];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] = "muda_qt_linhas";
   } 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['dashboard_info']['maximized']) {
       $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['dashboard_info']['dashboard_app'];
       if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_fac_operacion_contrato_comp'])) {
           $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_fac_operacion_contrato_comp'];
   ...
   if ($this->Ini->Embutida_iframe) {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['sub_cons_iframe_btns'] as $BTN => $BTN_opc) {
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "grid_fac_operacion_contrato_comp/grid_fac_operacion_contrato_comp_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "grid_fac_operacion_contrato_comp_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   $this->Tot         = new grid_fac_operacion_contrato_comp_total($this->Ini->sc_page);
   $this->Tot->Db     = $this->Db;
   $this->Tot->Erro   = $this->Erro;
   $this->Tot->Ini    = $this->Ini;
   $this->Tot->Lookup = $this->Lookup;
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['qt_lin_grid'] = 10;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_fac_operacion_contrato_comp']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_fac_operacion_contrato_comp']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_fac_operacion_contrato_comp']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_fac_operacion_contrato_comp']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_fac_operacion_contrato_comp']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_fac_operacion_contrato_comp']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_fac_operacion_contrato_comp']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_fac_operacion_contrato_comp']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['qt_lin_grid']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['SC_Ind_Groupby'] == "contrato") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ordem_select']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ordem_select'] = array(); 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['SC_Ind_Groupby'] == "contrato") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ordem_quebra'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ordem_quebra']['con_numero_contrato']["con_numero_contrato"] = "asc"; 
       } 
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['where_pesq_filtro'];
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao']       = "igual" ; 
...
// 
   ...
   $this->sum_con_numero_contrato_op_subtotal = 0;
   $this->sum_con_numero_contrato_op_iva = 0;
   $this->sum_con_numero_contrato_op_total = 0;
   $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['SC_Ind_Groupby'];
   $this->Tot->$Gb_geral();
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['tot_geral'][1] ;  
   $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['tot_geral'][1];
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
   ...
   { 
       ...
       $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['where_pesq']; 
       if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['where_pesq'])) 
       { 
           $nmgp_select .= " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['where_resumo']; 
       } 
       else
       { 
           $nmgp_select .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['where_resumo'] . ")"; 
       } 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['sc_total'] = $rt_grid->fields[0];  
       
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
   {
       $this->Ini->Qtd_reg_ajax_grid = $this->count_ger;
   }
   else
   {
       $this->Ini->Qtd_reg_ajax_grid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['qt_reg_grid'];
   }
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ordem_desc']; 
   } 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       ...
       $this->con_numero_contrato = $this->rs_grid->fields[32] ;  
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['SC_Ind_Groupby'] == "contrato") 
       {
           ...
           $this->quebra_con_numero_contrato_contrato($this->con_numero_contrato) ; 
       }
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['final']; 
   ...
   $this->NM_hidden_filters = ($this->Ini->Embutida_iframe && !empty($this->nm_grid_sem_reg) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['initialize']) ? true : false;
   $this->nmgp_reg_inicial  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['final'] + 1;
   $this->nmgp_reg_final    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['qt_reg_grid'];
   $this->nmgp_reg_final    = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['doc_word'] && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['word_return']);
       ...
       if ($this->Ini->Proc_print && $this->Ini->Export_html_zip  && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['print_return']);
           $this->pb->setTotalSteps($this->count_ger);
       }
       if (!$this->Ini->sc_export_ajax && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_charts']) : 0;
           ...
           if (-1 < $this->progress_grid)
           {
               ...
               grid_fac_operacion_contrato_comp_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
               grid_fac_operacion_contrato_comp_pdf_progress_call($this->Ini->path_js   . "\n", $this->Ini->Nm_lang);
               grid_fac_operacion_contrato_comp_pdf_progress_call($this->Ini->path_prod . "/img/\n", $this->Ini->Nm_lang);
               grid_fac_operacion_contrato_comp_pdf_progress_call($this->progress_tot   . "\n", $this->Ini->Nm_lang);
               ...
               grid_fac_operacion_contrato_comp_pdf_progress_call($this->progress_tot . "_#NM#_" . "1_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida'] && $this->NM_opcao != "pdf") {
           $nm_saida->saida("   <link rel=\"shortcut icon\" href=\"../_lib/img/usr__NM__img__NM__favicon.png\">\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ajax_nav'] && !$this->Ini->sc_export_ajax)
       { 
           ...
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_fac_operacion_contrato_comp_jquery_8647.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_fac_operacion_contrato_comp_ajax.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_fac_operacion_contrato_comp_message.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida']) {  
        ...
        <link rel='stylesheet' href='../_lib/lib/css/nm_mobile.css' type='text/css'/>
          <?php }
           ...
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['qt_reg_grid']) . ";\r\n");
           }
           $gridWidthCorrection = '';
           ...
           $nm_saida->saida("    {\r\n");
           $nm_saida->saida("        let cells = $(\".sc-ui-grid-header-row-grid_fac_operacion_contrato_comp-1\").find(\"td\");\r\n");
           ...
           $nm_saida->saida("        rows = $(\".sc-ui-grid-header-row-grid_fac_operacion_contrato_comp-1\");\r\n");
           ...
           $nm_saida->saida("   var gridHeaders = $(\".sc-ui-grid-header-row-grid_fac_operacion_contrato_comp-1\"), headerDisplayed = true;\r\n");
           ...
           $nm_saida->saida("   tableOriginal = document.getElementById(\"sc-ui-grid-body-1cf763dc\");\r\n");
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ancor_save']);
           }
           $nm_saida->saida("   });\r\n");
...
$nm_saida->saida("}\r\n");
       ...
       $nm_saida->saida("<style type=\"text/css\">\r\n");
       $nm_saida->saida("</style>\r\n");
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['num_css']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['num_css'] = rand(0, 1000);
       }
       $write_css = true;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida'] && !$this->Print_All && $this->NM_opcao != "print" && $this->NM_opcao != "pdf")
       {
           $write_css = false;
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida_pdf']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida_pdf'])
       {
           $write_css = true;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_fac_operacion_contrato_comp_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida'])
       {
 ...
 { 
       ...
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_fac_operacion_contrato_comp_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_grid_fac_operacion_contrato_comp_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_fac_operacion_contrato_comp/grid_fac_operacion_contrato_comp_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['proc_pdf_vert'])
  {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           ...
           if ($Pos1 !== false && $Pos2 !== false) {
               ...
               $cada_css = ".grid_fac_operacion_contrato_comp_" . substr(trim($Tag[0]), 1);
               if (isset($Tag[1])) {
                   $cada_css .= ", .grid_fac_operacion_contrato_comp_" . substr(trim($Tag[1]), 1);
               }
               $cada_css .= $Css;
           }
           else {
               $cada_css = ".grid_fac_operacion_contrato_comp_" . substr($cada_css, 1);
           }
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   $this->css_body_embutida = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['css_body_embutida'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['css_body_embutida'] : "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida'])
   { 
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
          $vertical_center = '';
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != "pdf" && !$this->Print_All)
       { 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['doc_word'])
       { 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['css_body_embutida'])) {
       $remove_border = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['css_body_embutida'];
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['proc_pdf_vert'])
   {
   }
   else
   {
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != "pdf" && 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao_print'] != "print") 
       { 
       if (!$_SESSION['scriptcase']['proc_mobile']) {
           $nm_saida->saida("    <TR>\r\n");
           $nm_saida->saida("    <TD  colspan=3 style=\"padding: 0px; border-width: 0px; vertical-align: top;\">\r\n");
           $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_A_grid_fac_operacion_contrato_comp\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_A_grid_fac_operacion_contrato_comp\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    </TR>\r\n");
       }
           $nm_saida->saida("    <TR>\r\n");
       ...
       if (!$_SESSION['scriptcase']['proc_mobile']) {
           $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_E_grid_fac_operacion_contrato_comp\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_E_grid_fac_operacion_contrato_comp\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    <td style=\"padding: 0px;  vertical-align: top;\"><table style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\" width=\"100%\"><tr>\r\n");
           $nm_saida->saida("    <TD colspan=3 style=\"padding: 0px; border-width: 0px; vertical-align: top;\" width=1>\r\n");
       if (!$_SESSION['scriptcase']['proc_mobile']) {
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_AL_grid_fac_operacion_contrato_comp\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_AL_grid_fac_operacion_contrato_comp\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    </TR>\r\n");
        } 
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_fac_operacion_contrato_comp']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_fac_operacion_contrato_comp']) . "_";
           } 
       } 
       else 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_fac_operacion_contrato_comp']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_fac_operacion_contrato_comp']) . "_";
           } 
       }
   }
   $temp_css  = explode("/", $compl_css);
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida']) ? "grid_fac_operacion_contrato_comp_" : "";
   $this->css_sep = " ";
...
// 
 function label_grid($linhas = 0)
 {
   ...
   $salva_htm_emb  = "";
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida_label'])
   { 
       $this->New_label['op_fecha_emision'] = "" . $this->Ini->Nm_lang['lang_fecha_emision'] . "";
       $this->New_label['op_fecha_ini'] = "" . $this->Ini->Nm_lang['lang_fecha'] . "";
       $this->New_label['op_comentario'] = "" . $this->Ini->Nm_lang['lang_comentario'] . "";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['exibe_titulos']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
   ...
   $nm_saida->saida("    <TR id=\"tit_grid_fac_operacion_contrato_comp__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-grid_fac_operacion_contrato_comp-" . $tmp_header_row . "\">\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida_label']) { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opc_psq']) { 
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['field_order'] as $Cada_label)
   { 
             ...
             foreach ($NM_css as $cada_css)
             {
                 ...
                 if ($Pos1 !== false && $Pos2 !== false) {
                     ...
                     $css_emb .= $cada_css . $Css;
                       ...
                       $css_emb .= ".grid_fac_operacion_contrato_comp_" . substr($cada_css, 1);
                 }
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
 ...
 function NM_label_op_fecha_emision()
 {
   ...
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != 'pdf') {
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['seleccionar'])) ? $this->New_label['seleccionar'] : "" . $this->Ini->Nm_lang['lang_seleccion'] . "";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
...
function SC_label_rightActionBar()
{
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ordem_cmp'] == $fieldName) {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ordem_label'] == 'desc') {
                $sortRule = 'desc';
            } else {
                $sortRule = 'asc';
            }
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ini_cor_grid']);
       }
   }
   ...
   $this->sc_where_atual   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['where_pesq'];
   $this->sc_where_filtro  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['where_pesq_filtro'];
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['grid_fac_operacion_contrato_comp']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_fac_operacion_contrato_comp']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_fac_operacion_contrato_comp']['lig_edit'];
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_grid_fac_operacion_contrato_comp#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               ...
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['cab_embutida'] != "S")
               {
       ...
       if (!$_SESSION['scriptcase']['proc_mobile']) {
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_EL_grid_fac_operacion_contrato_comp\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_EL_grid_fac_operacion_contrato_comp\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
               $nm_saida->saida("    </TD>\r\n");
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['force_toolbar'] = true;
           } 
           ...
           { 
               ...
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_A_grid_fac_operacion_contrato_comp', 'value' => 'NM_Blank_Page.htm');
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_D_grid_fac_operacion_contrato_comp', 'value' => 'NM_Blank_Page.htm');
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_E_grid_fac_operacion_contrato_comp', 'value' => 'NM_Blank_Page.htm');
               $_SESSION['scriptcase']['saida_html'] = "";
           } 
           $nm_saida->saida("  </td></tr>\r\n");
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
           { 
               $this->sumario_normal() ; 
           } 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
       ...
       if (!$_SESSION['scriptcase']['proc_mobile']) {
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_DL_grid_fac_operacion_contrato_comp\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_DL_grid_fac_operacion_contrato_comp\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
               $nm_saida->saida("</TD>\r\n");
               $nm_saida->saida("    <TD style=\"padding: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               if (!$_SESSION['scriptcase']['proc_mobile']) {
               $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_D_grid_fac_operacion_contrato_comp\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_D_grid_fac_operacion_contrato_comp\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
               }
               $nm_saida->saida("    </TD>\r\n");
               $nm_saida->saida("    </TR>\r\n");
           } 
...
else
{
      ...
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_EL_grid_fac_operacion_contrato_comp\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_EL_grid_fac_operacion_contrato_comp\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       ...
       $nm_id_aplicacao = " id=\"apl_grid_fac_operacion_contrato_comp#?#1\"";
   } 
   $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] == "pdf") ? "padding: 0px !important;" : "";
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['proc_pdf_vert'])
{
}
else
...
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['proc_pdf']) { 
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['proc_pdf']) { 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-1cf763dc\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['proc_pdf_vert']) { 
    $nm_saida->saida("</thead>\r\n");
 }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['proc_pdf'] && $this->pdf_all_label != "S" && $this->pdf_label_group != "S") 
   { 
      $this->label_grid($linhas);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida_grid'])
...
// 
   ...
   $this->Break_pag_pdf['contrato']['con_numero_contrato'] = "N";
   $this->Break_pag_prt['contrato']['con_numero_contrato'] = "N";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['Config_Page_break_PDF'] = "S";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['Page_break_PDF']))
   {
       if (isset($this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['SC_Ind_Groupby']]))
       {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['SC_Gb_Free_cmp'] as $Cmp_gb => $resto)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['Page_break_PDF'][$Cmp_gb] = $this->Break_pag_pdf['sc_free_group_by'][$Cmp_gb];
               }
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['Page_break_PDF'] = $this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['SC_Ind_Groupby']];
           }
       }
       else
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['Page_break_PDF'] = array();
       }
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['SC_Ind_Groupby'] == "contrato") 
   {
       ...
       {
           $this->quebra_con_numero_contrato_contrato_top(); 
       }
   ...
   $nm_houve_quebra = "N";
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          ...
          //---------- Gauge ----------
          if (!$this->Ini->sc_export_ajax && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
              if (0 == $this->progress_lim_now)
              {
               ...
               if (!NM_is_utf8($lang_protect))
               {
                  ...
                  grid_fac_operacion_contrato_comp_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $lang_protect . " " . $this->progress_now . "...\n", $this->Ini->Nm_lang);
          ...
          $this->arg_sum_con_numero_contrato = " = " . $this->Db->qstr($this->con_numero_contrato);
          $this->SC_seq_page++; 
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['final'] + 1; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['rows_emb']++;
          if ($this->con_numero_contrato !== $this->con_numero_contrato_Old && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['SC_Ind_Groupby'] == "contrato") 
          {  
              if (isset($this->con_numero_contrato_Old))
              {
                 $this->quebra_con_numero_contrato_contrato_bot() ; 
              }
              if ($this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['doc_word'] && $this->Break_pag_prt[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['SC_Ind_Groupby']]['con_numero_contrato'] == "S")
              {
                  $this->nm_quebra_pagina("pagina"); 
              }
              elseif (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['Page_break_PDF']['con_numero_contrato'] == "S")
              {
                  $this->nm_quebra_pagina("pagina"); 
              }
              $this->con_numero_contrato_Old = $this->con_numero_contrato ; 
          ...
          $_SESSION['scriptcase']['grid_fac_operacion_contrato_comp']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['grid_fac_operacion_contrato_comp']['contr_erro'] = 'off';
          ...
          else
          {
              ...
              {
                  if ($this->nm_inicio_pag == 0 && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida_grid'])
                  {
                      $nm_houve_quebra = "N";
                  } 
              } 
              elseif (($nm_houve_quebra == "S" || ($this->nm_inicio_pag == 0)) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida_grid'])
              { 
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida_opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['dado_psq_ret'];
 ...
 $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcapture", "document.Fpesq.nm_ret_psq.value='" . str_replace(array("'", '"'), array("\'", '\"'), $teste) . "'; nm_escreve_window();", "document.Fpesq.nm_ret_psq.value='" . str_replace(array("'", '"'), array("\'", '\"'), $teste) . "'; nm_escreve_window();", "", "Rad_psq", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
          ...
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['field_order'] as $Cada_col)
          { 
   ...
   $this->SC_grid_rightActionBar();
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
   ...
   if ($this->rs_grid->EOF) 
   { 
       if (isset($this->con_numero_contrato_Old) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['SC_Ind_Groupby'] == "contrato")
       {
           $this->quebra_con_numero_contrato_contrato_bot() ; 
       }
  
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['exibe_total'] == "S")
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['SC_Ind_Groupby'] . "_bot";
           $this->$Gb_geral() ;
       } 
   }  
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida_grid'])
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
       $this->sumario_normal() ; 
   } 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != "pdf" && empty($this->nm_grid_sem_reg) && 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao_print'] != "print") 
   { 
       $nm_saida->saida("</TABLE></TD>\r\n");
       $nm_saida->saida("<TD style=\"padding: 0px; border-width: 0px;\" valign=\"top\" width=1>\r\n");
...
function SC_grid_rightActionBar()
{
 ...
 function NM_grid_op_comentario()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['op_comentario']) || $this->NM_cmp_hidden['op_comentario'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
 ...
 if (!$this->Ini->Proc_print && !$this->Ini->SC_Link_View && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != "pdf" && $_SESSION['scriptcase']['contr_link_emb'] != "pdf" && $conteudo != "&nbsp;"){ $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['Ind_lig_mult']++;
       $linkTarget = isset($this->Ini->sc_lig_target['C_@scinf_seleccionar_@scinf_blank_selecciona_operacion_contrato_comp']) ? $this->Ini->sc_lig_target['C_@scinf_seleccionar_@scinf_blank_selecciona_operacion_contrato_comp'] : (isset($this->Ini->sc_lig_target['C_@scinf_seleccionar']) ? $this->Ini->sc_lig_target['C_@scinf_seleccionar'] : null);
       if (isset($this->Ini->sc_lig_md5["blank_selecciona_operacion_contrato_comp"]) && $this->Ini->sc_lig_md5["blank_selecciona_operacion_contrato_comp"] == "S") {
           $Parms_Lig = "nmgp_lig_edit_lapis?#?S?@?var_operacion?#?" . str_replace("'", "@aspass@", $this->op_operacion) . "?@?var_propietario?#?" . str_replace("'", "@aspass@", $this->op_propietario) . "?@?var_contrato?#?" . str_replace("'", "@aspass@", $this->op_contrato) . "?@?";
           if ($_SESSION['scriptcase']['proc_mobile']) {
               $Parms_Lig = str_replace("NM_run_iframe?#?1?@?", "", $Parms_Lig);
           }
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['dashboard_info']['under_dashboard'] && isset($linkTarget))
           {
               if ('' != $Parms_Lig)
               {
                   $Parms_Lig .= '*scout';
               }
               $Parms_Lig .= 'under_dashboard*scin1*scoutdashboard_app*scin' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['dashboard_info']['dashboard_app'] . '*scoutown_widget*scin' . $linkTarget . '*scoutparent_widget*scin' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['dashboard_info']['own_widget'] . '*scoutcompact_mode*scin' . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['dashboard_info']['compact_mode'] ? '1' : '0') . '*scoutremove_margin*scin' . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['dashboard_info']['remove_margin'] ? '1' : '0') . '*scoutremove_border*scin' . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['dashboard_info']['remove_border'] ? '1' : '0');
           }
           $Md5_Lig    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_fac_operacion_contrato_comp@SC_par@" . md5($Parms_Lig);
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
       } else {
           $Md5_Lig = "nmgp_lig_edit_lapis?#?S?@?var_operacion?#?" . str_replace("'", "@aspass@", $this->op_operacion) . "?@?var_propietario?#?" . str_replace("'", "@aspass@", $this->op_propietario) . "?@?var_contrato?#?" . str_replace("'", "@aspass@", $this->op_contrato) . "?@?";
       }
   $nm_saida->saida("<a  id=\"id_sc_field_seleccionar_" . $this->SC_seq_page . "\" href=\"javascript:nm_gp_submit5('" . $this->Ini->link_blank_selecciona_operacion_contrato_comp_blk . "', '$this->nm_location', '$Md5_Lig', '" . (isset($linkTarget) ? $linkTarget : '_parent') . "', '', '0', '0', '', 'blank_selecciona_operacion_contrato_comp', '" . $this->SC_ancora . "')\" onMouseover=\"nm_mostra_hint(this, event, '')\" onMouseOut=\"nm_apaga_hint()\" class=\"" . $this->Ini->cor_link_dados . $this->css_sep . $this->css_seleccionar_grid_line . "\" style=\"" . $this->Css_Cmp['css_seleccionar_grid_line'] . "\">" . $conteudo . "</a>\r\n");
} else {
 ...
 if (!$this->Ini->Proc_print && !$this->Ini->SC_Link_View && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != "pdf" && $_SESSION['scriptcase']['contr_link_emb'] != "pdf" && $conteudo != "&nbsp;"){ $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['Ind_lig_mult']++;
       $linkTarget = isset($this->Ini->sc_lig_target['C_@scinf_detalles_@scinf_grid_fac_detalle_operacion']) ? $this->Ini->sc_lig_target['C_@scinf_detalles_@scinf_grid_fac_detalle_operacion'] : (isset($this->Ini->sc_lig_target['C_@scinf_detalles']) ? $this->Ini->sc_lig_target['C_@scinf_detalles'] : null);
       if (isset($this->Ini->sc_lig_md5["grid_fac_detalle_operacion"]) && $this->Ini->sc_lig_md5["grid_fac_detalle_operacion"] == "S") {
           $Parms_Lig = "nmgp_lig_edit_lapis*scinS*scoutvar_operacion*scin" . str_replace("'", "@aspass@", $this->op_operacion) . "*scoutNMSC_inicial*scininicio*scoutNMSC_paginacao*scinFULL*scoutNMSC_cab*scinN*scoutNMSC_nav*scinN*scoutNMSC_modal*scinok*scout";
           if ($_SESSION['scriptcase']['proc_mobile']) {
               $Parms_Lig = str_replace("NM_run_iframe?#?1?@?", "", $Parms_Lig);
           }
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['dashboard_info']['under_dashboard'] && isset($linkTarget))
           ...
           $Md5_Lig = "nmgp_lig_edit_lapis*scinS*scoutvar_operacion*scin" . str_replace("'", "@aspass@", $this->op_operacion) . "*scoutNMSC_inicial*scininicio*scoutNMSC_paginacao*scinFULL*scoutNMSC_cab*scinN*scoutNMSC_nav*scinN*scoutNMSC_modal*scinok*scout";
       }
   $nm_saida->saida("<a id=\"id_sc_field_detalles_" . $this->SC_seq_page . "\" href=\"javascript:nm_gp_submit5('" . $this->Ini->link_grid_fac_detalle_operacion_cons . "', '$this->nm_location', '$Md5_Lig', '" . (isset($linkTarget) ? $linkTarget : 'modal') . "', 'inicio', '400', '800', '', 'grid_fac_detalle_operacion', '" . $this->SC_ancora . "')\" onMouseover=\"nm_mostra_hint(this, event, '')\" onMouseOut=\"nm_apaga_hint()\" class=\"" . $this->Ini->cor_link_dados . $this->css_sep . $this->css_detalles_grid_line . "\" style=\"" . $this->Css_Cmp['css_detalles_grid_line'] . "\">" . $conteudo . "</a>\r\n");
} else {
 ...
 function nm_quebra_pagina($nm_parms)
 {
    ...
    if (($this->Ini->nm_limite_lin > 0 && $this->Ini->nm_cont_lin > $this->Ini->nm_limite_lin) || $nm_parms == "pagina" || $nm_parms == "resumo" || $nm_parms == "total")
    {
        ...
        if ($this->Print_All)
        {
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['print_navigator']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['print_navigator'] == "Netscape")
            {
        ...
        if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['proc_pdf'] && $nm_parms != "resumo" && $nm_parms != "pagina" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida_grid'])
        {
            $this->label_grid();
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['proc_pdf'] && $this->pdf_label_group != "S" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida_grid'])
        {
            $this->nm_inicio_pag = 0;
        }
    }
 }
 function quebra_con_numero_contrato_contrato($con_numero_contrato) 
 {
   global $tot_con_numero_contrato;
   $this->sc_proc_quebra_con_numero_contrato = true; 
   $this->Tot->quebra_con_numero_contrato_contrato($con_numero_contrato, $this->arg_sum_con_numero_contrato);
   $conteudo = $tot_con_numero_contrato[0] ;  
   $this->count_con_numero_contrato = $tot_con_numero_contrato[1];
   $this->sum_con_numero_contrato_op_subtotal = $tot_con_numero_contrato[2];
   $this->sum_con_numero_contrato_op_iva = $tot_con_numero_contrato[3];
   $this->sum_con_numero_contrato_op_total = $tot_con_numero_contrato[4];
   ...
   $this->Lookup->lookup_contrato_con_numero_contrato($conteudo , $this->op_contrato) ; 
   ...
   {
   $this->campos_quebra_con_numero_contrato[0]['lab'] = "Con Numero Contrato"; 
   }
   $this->sc_proc_quebra_con_numero_contrato = false; 
 } 
 function quebra_con_numero_contrato_contrato_top() 
 { global
   ...
   $link_div   = "";
   $link_div_2 = "";
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ind_tree'];
       ...
       $link_div .= "<img id=\"b_open_grid_fac_operacion_contrato_comp_" . $this->NM_cont_body . "\" style=\"display:none\" onclick=\"document.getElementById('b_open_grid_fac_operacion_contrato_comp_" . $this->NM_cont_body . "').style.display = 'none'; document.getElementById('b_close_grid_fac_operacion_contrato_comp_" . $this->NM_cont_body . "').style.display = ''; NM_liga_tbody(" . $this->NM_cont_body . ", NM_tab_grid_fac_operacion_contrato_comp, 'grid_fac_operacion_contrato_comp'); return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_exp . "\">";
       $link_div .= "<img id=\"b_close_grid_fac_operacion_contrato_comp_" . $this->NM_cont_body . "\" style=\"display:''\" onclick=\"document.getElementById('b_close_grid_fac_operacion_contrato_comp_" . $this->NM_cont_body . "').style.display = 'none'; document.getElementById('b_open_grid_fac_operacion_contrato_comp_" . $this->NM_cont_body . "').style.display = ''; NM_apaga_tbody(" . $this->NM_cont_body . ", NM_tab_grid_fac_operacion_contrato_comp, 'grid_fac_operacion_contrato_comp'); return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_col . "\">";
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_fac_operacion_contrato_comp'][$this->NM_cont_body]['1'] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_fac_operacion_contrato_comp_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   $this->NM_calc_span();
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ind_tree'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_fac_operacion_contrato_comp'][$this->NM_cont_body]['1'] = 'bot';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_fac_operacion_contrato_comp_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
 ...
 function quebra_con_numero_contrato_contrato_bot() 
 { global 
          $con_numero_contrato_ant_desc, 
          $nm_saida, $tot_con_numero_contrato;
  ...
  foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
  {
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['field_order'] as $Cada_cmp)
   {
    ...
    if ($Cada_cmp == "op_subtotal" && (!isset($this->NM_cmp_hidden['op_subtotal']) || $this->NM_cmp_hidden['op_subtotal'] != "off"))
    {
      ...
      {
          $conteudo =  $tot_con_numero_contrato[$NM_cmp_tot['op_subtotal'][$Tipo_Sum]]; 
    ...
    if ($Cada_cmp == "op_iva" && (!isset($this->NM_cmp_hidden['op_iva']) || $this->NM_cmp_hidden['op_iva'] != "off"))
    {
      ...
      {
          $conteudo =  $tot_con_numero_contrato[$NM_cmp_tot['op_iva'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "op_total" && (!isset($this->NM_cmp_hidden['op_total']) || $this->NM_cmp_hidden['op_total'] != "off"))
    {
      ...
      {
          $conteudo =  $tot_con_numero_contrato[$NM_cmp_tot['op_total'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = false;
       $nm_saida->saida("    </TBODY>");
   }
 ...
 function quebra_geral_contrato_bot() 
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] == "pdf" && !$this->Print_All)
   {
      $nm_nivel_book_pdf = "<div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">" .  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['tot_geral'][0] . "</H1></div>";
   }
   $tit_lin_sumariza      = $nm_nivel_book_pdf . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['tot_geral'][0];
   $tit_lin_sumariza_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['tot_geral'][0];
  ...
  foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
  {
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['field_order'] as $Cada_cmp)
   {
    ...
    if ($Cada_cmp == "op_subtotal" && (!isset($this->NM_cmp_hidden['op_subtotal']) || $this->NM_cmp_hidden['op_subtotal'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['op_subtotal'][$Tipo_Sum]))
      {
          $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['tot_geral'][$NM_cmp_tot['op_subtotal'][$Tipo_Sum]] ; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "op_iva" && (!isset($this->NM_cmp_hidden['op_iva']) || $this->NM_cmp_hidden['op_iva'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['op_iva'][$Tipo_Sum]))
      {
          $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['tot_geral'][$NM_cmp_tot['op_iva'][$Tipo_Sum]] ; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "op_total" && (!isset($this->NM_cmp_hidden['op_total']) || $this->NM_cmp_hidden['op_total'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['op_total'][$Tipo_Sum]))
      {
          $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['tot_geral'][$NM_cmp_tot['op_total'][$Tipo_Sum]] ; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
 ...
 { global $nm_saida, $nm_lang; 
   ...
   $nm_sumario = str_replace("?final?", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['final'], $nm_sumario);
...
$nm_saida->saida("    </style>\r\n");
      ...
      $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"left\" width=\"33%\"> \r\n");
          if (is_file("grid_fac_operacion_contrato_comp_help.txt") && !$this->grid_emb_form)
          {
             $Arq_WebHelp = file("grid_fac_operacion_contrato_comp_help.txt"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['dashboard_info']['under_dashboard']))
      {
         $this->nmgp_botoes['exit'] = "off"; 
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opc_psq'])
      ...
      {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['sc_modal'])
        {
      ...
      $nm_saida->saida("        </tr> \r\n");
      $nm_saida->saida("       </table> \r\n");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ajax_nav'] && $this->force_toolbar)
      { 
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != "pdf" &&
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao_print'] != "print" && !$this->Print_All) 
   { 
      $nm_saida->saida("     <tr><td colspan=3  class=\"" . $this->css_scGridTabelaTd . "\" style=\"vertical-align: top\"> \r\n");
       if (!$_SESSION['scriptcase']['proc_mobile']) {
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_B_grid_fac_operacion_contrato_comp\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_B_grid_fac_operacion_contrato_comp\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
      $nm_saida->saida("     </td></tr> \r\n");
   } 
   $nm_saida->saida("   </TABLE>\r\n");
   ...
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   } 
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
   } 
   ...
   $nm_saida->saida("   if (typeof(scSetFixedHeaders) === typeof(function(){})) scSetFixedHeaders();\r\n");
   $nm_saida->saida("  });\r\n");
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
       } 
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
       } 
   ...
   if ($this->grid_emb_form || $this->grid_emb_form_full)
   {
       ...
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_fac_operacion_contrato_comp', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"grid_fac_operacion_contrato_comp\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"grid_fac_operacion_contrato_comp_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_fac_operacion_contrato_comp/grid_fac_operacion_contrato_comp_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
   ...
   $nm_saida->saida("           document.Fdoc_word.action = \"grid_fac_operacion_contrato_comp_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("      {\r\n");
   $nm_saida->saida("          NM_ancor_ult_lig = ancor;\r\n");
   $nm_saida->saida("          par_modal = '?&nmgp_outra_jan=true&nmgp_url_saida=modal&SC_lig_apl_orig=grid_fac_operacion_contrato_comp';\r\n");
   $nm_saida->saida("          if (opc != null && opc != '') \r\n");
   $nm_saida->saida("          {\r\n");
   ...
   $nm_saida->saida("          return;\r\n");
   $nm_saida->saida("      }\r\n");
   $nm_saida->saida("      if (pos == \"A\") {obj = document.getElementById('nmsc_iframe_liga_A_grid_fac_operacion_contrato_comp');} \r\n");
   $nm_saida->saida("      if (pos == \"B\") {obj = document.getElementById('nmsc_iframe_liga_B_grid_fac_operacion_contrato_comp');} \r\n");
   $nm_saida->saida("      if (pos == \"E\") {obj = document.getElementById('nmsc_iframe_liga_E_grid_fac_operacion_contrato_comp');} \r\n");
   $nm_saida->saida("      if (pos == \"D\") {obj = document.getElementById('nmsc_iframe_liga_D_grid_fac_operacion_contrato_comp');} \r\n");
   ...
   $nm_saida->saida("           document.F3.SC_module_export.value = z;\r\n");
   $nm_saida->saida("       }\r\n");
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['grid_fac_operacion_contrato_comp_iframe_params'] = array(
   ...
   $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_fac_operacion_contrato_comp@SC_par@" . md5($prep_parm_pdf);
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   $nm_saida->saida("               document.Fpdf.action=\"grid_fac_operacion_contrato_comp_iframe.php\";\r\n");
   ...
   $nm_saida->saida("           document.Fexport.action = \"grid_fac_operacion_contrato_comp_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['campo_psq_ret']) )
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['grid_fac_operacion_contrato_comp']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form  = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Form1 = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("           var Obj_Doc   = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form  = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Form1 = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("          var Obj_Doc   = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form  = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Form1 = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['campo_psq_ret']) . ";\r\n");
          $nm_saida->saida("          var Obj_Doc   = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"grid_fac_operacion_contrato_comp_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['reg_start']))
   {
       $nm_saida->saida("      $(document).ready(function(){\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailStatus('grid_fac_operacion_contrato_comp')\",50);\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_fac_operacion_contrato_comp', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      })\r\n");
   }
