...
class grid_fac_operacion_contrato_comp_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
...
SCEOT;
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_fac_operacion_contrato_comp']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_fac_operacion_contrato_comp']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['where_resumo'] = "";
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['contr_total_geral'] == "OK")
      {
          $this->array_total_con_numero_contrato = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['arr_total']['con_numero_contrato'];
      }
      else
      {
          $this->array_total_con_numero_contrato = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['tot_geral'][2];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['tot_geral'][3];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['tot_geral'][4];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['arr_total']['con_numero_contrato'] = $this->array_total_con_numero_contrato;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['json_use_label'])
       {
          $Lab_con_numero_contrato = "con_numero_contrato";
       }
       else
       {
       $Lab_con_numero_contrato = "Con Numero Contrato";
       }
       $this->comp_field = array(
           $Lab_con_numero_contrato,
       );

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_fecha_emision']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_fecha_emision'] = "" . $this->Ini->Nm_lang['lang_fecha_emision'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_fecha_ini']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_fecha_ini'] = "" . $this->Ini->Nm_lang['lang_fecha'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_comentario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_comentario'] = "" . $this->Ini->Nm_lang['lang_comentario'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_subtotal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_subtotal'] = "" . $this->Ini->Nm_lang['lang_subtotal'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_iva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_iva'] = "" . $this->Ini->Nm_lang['lang_iva'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_total'] = "" . $this->Ini->Nm_lang['lang_total'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['seleccionar']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['seleccionar'] = "" . $this->Ini->Nm_lang['lang_seleccion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['detalles']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['detalles'] = "detalles"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_operacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_operacion'] = "Op Operacion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_empresa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_empresa'] = "Op Empresa"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_fecha_fin']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_fecha_fin'] = "Op Fecha Fin"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_modulo_genera']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_modulo_genera'] = "Op Modulo Genera"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_tipo_cartera']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_tipo_cartera'] = "Op Tipo Cartera"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_propietario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_propietario'] = "Op Propietario"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_subtotal_cero']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_subtotal_cero'] = "Op Subtotal Cero"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_escenario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_escenario'] = "Op Escenario"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_usuario_emite']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_usuario_emite'] = "Op Usuario Emite"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_convenio_pago']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_convenio_pago'] = "Op Convenio Pago"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_dias_vencido']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_dias_vencido'] = "Op Dias Vencido"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_motivo_baja']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_motivo_baja'] = "Op Motivo Baja"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_fecha_baja']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_fecha_baja'] = "Op Fecha Baja"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_usuario_baja']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_usuario_baja'] = "Op Usuario Baja"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_terminal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_terminal'] = "Op Terminal"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_asiento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_asiento'] = "Op Asiento"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_tipo_comprobante']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_tipo_comprobante'] = "Op Tipo Comprobante"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_estado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_estado'] = "Op Estado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_contrato']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_contrato'] = "Op Contrato"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_seleccion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_seleccion'] = "Op Seleccion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_usuario_selecciona']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_usuario_selecciona'] = "Op Usuario Selecciona"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_factura']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_factura'] = "Op Factura"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_asiento_anula']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_asiento_anula'] = "Op Asiento Anula"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_subtotal_iva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_subtotal_iva'] = "Op Subtotal Iva"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_total_descuento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_total_descuento'] = "Op Total Descuento"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_fecha_factura']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['op_fecha_factura'] = "Op Fecha Factura"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['con_numero_contrato']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['labels']['con_numero_contrato'] = "Con Numero Contrato"; 
       }
       //-----
       $this->comp_field_nm = array(
           'con_numero_contrato' => 0,
       );
       ...
       //-----
       $this->comp_sum = array(
           2 => "Op Subtotal (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           3 => "Op Iva (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           4 => "Op Total (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['summarizing_fields_order']['contrato']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['summarizing_fields_order']['contrato'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['summarizing_fields_order']['contrato'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['summarizing_fields_display']['contrato'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['summarizing_fields_display']['contrato'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['summarizing_fields_display']['contrato'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['summarizing_fields_display']['contrato'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['summarizing_fields_display']['contrato'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['summarizing_fields_display']['contrato'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['summarizing_fields_display']['contrato'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "op_subtotal", 'show' => true),
           3 => array('field' => "op_iva", 'show' => true),
           4 => array('field' => "op_total", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "css_op_subtotal_sum",
           3 => "css_op_iva_sum",
           4 => "css_op_total_sum",
       );
       ...
       //-----
       foreach ($this->array_total_con_numero_contrato as $i_con_numero_contrato => $d_con_numero_contrato) {
           if (!isset($i_con_numero_contrato, $this->comp_label[0]) || !in_array($i_con_numero_contrato, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_con_numero_contrato[5] ] = $d_con_numero_contrato[4];
               $this->comp_label[0][ $d_con_numero_contrato[5] ] = $d_con_numero_contrato[4];
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'con_numero_contrato', 'prot' => '@aspass@'),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_tabular_label'];
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_con_numero_contrato => $l_con_numero_contrato) {
           if (isset($this->array_total_con_numero_contrato[$i_con_numero_contrato])) {
               $this->comp_group[$i_con_numero_contrato] = array();
           }
       }
     }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_con_numero_contrato;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_fac_operacion_contrato_comp@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['proc_pdf_vert']){ 
   ...
   public static function formatValue($total, $valor_campo)
   {
       ...
       if ($total == 3)
       {
           nmgp_Form_Num_Val($valor_campo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "5", "S", "", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']);
       }
       return $valor_campo;
   }
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_fac_operacion_contrato_comp_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['arr_total'][$cmp_gb];
      }
      if (is_array($this->array_total_con_numero_contrato)) {
          ksort($this->array_total_con_numero_contrato);
      }
   }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['dashboard_refresh_after_chart'] = 'resumo';
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>" . $this->Ini->Nm_lang['lang_othr_smry_title'] . " fac_operacion</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['doc_word'])
{
      ...
      { 
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['ajax_nav']) {  
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_fac_operacion_contrato_comp_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_fac_operacion_contrato_comp_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_fac_operacion_contrato_comp_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_fac_operacion_contrato_comp/grid_fac_operacion_contrato_comp_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_fac_operacion_contrato_comp/grid_fac_operacion_contrato_comp_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_fac_operacion_contrato_comp&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid&nm_all_modules=grid&password=n&summary_export_columns=S&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + P)", "thickbox", "" . $this->Ini->path_link . "grid_fac_operacion_contrato_comp/grid_fac_operacion_contrato_comp_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid&nm_all_modules=grid&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_fac_operacion_contrato_comp_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_fac_operacion_contrato_comp']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_fac_operacion_contrato_comp']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_fac_operacion_contrato_comp_config_pivot.php?nome_apl=grid_fac_operacion_contrato_comp&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("                  action=\"grid_fac_operacion_contrato_comp_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("               document.Fprint.action = \"grid_fac_operacion_contrato_comp_export_ctrl.php\";\r\n");
      $nm_saida->saida("           }\r\n");
      $nm_saida->saida("           else\r\n");
      $nm_saida->saida("           {\r\n");
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"grid_fac_operacion_contrato_comp_iframe.php\";\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_fac_operacion_contrato_comp_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_fac_operacion_contrato_comp/grid_fac_operacion_contrato_comp_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $op_fecha_factura = (isset($Busca_temp['op_fecha_factura'])) ? $Busca_temp['op_fecha_factura'] : ""; 
          $tmp_pos = (is_string($op_fecha_factura)) ? strpos($op_fecha_factura, "##@@") : false;
          if ($tmp_pos !== false && !is_array($op_fecha_factura))
          {
              $op_fecha_factura = substr($op_fecha_factura, 0, $tmp_pos);
          }
          $op_fecha_factura_2 = (isset($Busca_temp['op_fecha_factura_input_2'])) ? $Busca_temp['op_fecha_factura_input_2'] : ""; 
          $op_operacion = (isset($Busca_temp['op_operacion'])) ? $Busca_temp['op_operacion'] : ""; 
          $tmp_pos = (is_string($op_operacion)) ? strpos($op_operacion, "##@@") : false;
          if ($tmp_pos !== false && !is_array($op_operacion))
          {
              $op_operacion = substr($op_operacion, 0, $tmp_pos);
          }
          $op_empresa = (isset($Busca_temp['op_empresa'])) ? $Busca_temp['op_empresa'] : ""; 
          $tmp_pos = (is_string($op_empresa)) ? strpos($op_empresa, "##@@") : false;
          if ($tmp_pos !== false && !is_array($op_empresa))
          {
              $op_empresa = substr($op_empresa, 0, $tmp_pos);
          }
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_contrato_comp']['cond_pesq'], 0, $trab_pos);
   ...
   //---- 
   function adiciona_registro($sum_op_subtotal, $sum_op_iva, $sum_op_total, $quebra_con_numero_contrato, $quebra_con_numero_contrato_orig)
   {
      //----- Con Numero Contrato
      if (!isset($this->array_total_con_numero_contrato[$quebra_con_numero_contrato_orig]))
      {
         $this->array_total_con_numero_contrato[$quebra_con_numero_contrato_orig][0] = 1;
         $this->array_total_con_numero_contrato[$quebra_con_numero_contrato_orig][1] = $sum_op_subtotal;
         $this->array_total_con_numero_contrato[$quebra_con_numero_contrato_orig][2] = $sum_op_iva;
         $this->array_total_con_numero_contrato[$quebra_con_numero_contrato_orig][3] = $sum_op_total;
         $this->array_total_con_numero_contrato[$quebra_con_numero_contrato_orig][4] = $quebra_con_numero_contrato;
         $this->array_total_con_numero_contrato[$quebra_con_numero_contrato_orig][5] = $quebra_con_numero_contrato_orig;
      }
      else
      {
         $this->array_total_con_numero_contrato[$quebra_con_numero_contrato_orig][0]++;
         $this->array_total_con_numero_contrato[$quebra_con_numero_contrato_orig][1] = bcadd($this->array_total_con_numero_contrato[$quebra_con_numero_contrato_orig][1], $sum_op_subtotal, 10);
         $this->array_total_con_numero_contrato[$quebra_con_numero_contrato_orig][2] = bcadd($this->array_total_con_numero_contrato[$quebra_con_numero_contrato_orig][2], $sum_op_iva, 10);
         $this->array_total_con_numero_contrato[$quebra_con_numero_contrato_orig][3] = bcadd($this->array_total_con_numero_contrato[$quebra_con_numero_contrato_orig][3], $sum_op_total, 10);
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
       ...
       $this->op_fecha_factura = $Busca_temp['op_fecha_factura']; 
       $this->op_fecha_factura = (isset($Busca_temp['op_fecha_factura'])) ? $Busca_temp['op_fecha_factura'] : ""; 
       $tmp_pos = (is_string($this->op_fecha_factura)) ? strpos($this->op_fecha_factura, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->op_fecha_factura))
       {
       ...
       $op_fecha_factura_2 = (isset($Busca_temp['op_fecha_factura_input_2'])) ? $Busca_temp['op_fecha_factura_input_2'] : ""; 
       $this->op_fecha_factura_2 = $op_fecha_factura_2; 
       $this->op_operacion = $Busca_temp['op_operacion']; 
       $this->op_operacion = (isset($Busca_temp['op_operacion'])) ? $Busca_temp['op_operacion'] : ""; 
       $tmp_pos = (is_string($this->op_operacion)) ? strpos($this->op_operacion, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->op_operacion))
       {
       ...
       $this->op_empresa = $Busca_temp['op_empresa']; 
       $this->op_empresa = (isset($Busca_temp['op_empresa'])) ? $Busca_temp['op_empresa'] : ""; 
       $tmp_pos = (is_string($this->op_empresa)) ? strpos($this->op_empresa, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->op_empresa))
       {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('contrato', 'con_numero_contrato');
     $campos_order = $this->Ini->Get_date_order_groupby("con_numero_contrato", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->op_subtotal = $rs_res->fields[3] ;  
            $this->op_iva = $rs_res->fields[4] ;  
            $this->op_total = $rs_res->fields[5] ;  
            $this->op_operacion = $rs_res->fields[6] ;  
            $this->op_empresa = $rs_res->fields[7] ;  
            $this->op_fecha_fin = $rs_res->fields[8] ;  
            $this->op_modulo_genera = $rs_res->fields[9] ;  
            $this->op_tipo_cartera = $rs_res->fields[10] ;  
            $this->op_propietario = $rs_res->fields[11] ;  
            $this->op_subtotal_cero = $rs_res->fields[12] ;  
            $this->op_subtotal_cero =  str_replace(",", ".", $this->op_subtotal_cero);
            $this->op_escenario = $rs_res->fields[13] ;  
            $this->op_usuario_emite = $rs_res->fields[14] ;  
            $this->op_convenio_pago = $rs_res->fields[15] ;  
            $this->op_dias_vencido = $rs_res->fields[16] ;  
            $this->op_motivo_baja = $rs_res->fields[17] ;  
            $this->op_fecha_baja = $rs_res->fields[18] ;  
            $this->op_usuario_baja = $rs_res->fields[19] ;  
            $this->op_terminal = $rs_res->fields[20] ;  
            $this->op_asiento = $rs_res->fields[21] ;  
            $this->op_tipo_comprobante = $rs_res->fields[22] ;  
            $this->op_estado = $rs_res->fields[23] ;  
            $this->op_contrato = $rs_res->fields[24] ;  
            $this->op_seleccion = $rs_res->fields[25] ;  
            $this->op_usuario_selecciona = $rs_res->fields[26] ;  
            $this->op_factura = $rs_res->fields[27] ;  
            $this->op_asiento_anula = $rs_res->fields[28] ;  
            $this->op_subtotal_iva = $rs_res->fields[29] ;  
            $this->op_subtotal_iva =  str_replace(",", ".", $this->op_subtotal_iva);
            $this->op_total_descuento = $rs_res->fields[30] ;  
            $this->op_total_descuento =  str_replace(",", ".", $this->op_total_descuento);
            $this->op_fecha_factura = $rs_res->fields[31] ;  
            $this->con_numero_contrato = $rs_res->fields[32] ;  
...
$_SESSION['scriptcase']['grid_fac_operacion_contrato_comp']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->op_subtotal, $this->op_iva, $this->op_total, $this->con_numero_contrato, $this->con_numero_contrato_orig);
            }
   }
//
