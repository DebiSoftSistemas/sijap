...
function scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="")
{
    ...
    if (isset($_SESSION['scriptcase']['blank_selecciona_operacion_contrato_comp']['contr_erro']) && $_SESSION['scriptcase']['blank_selecciona_operacion_contrato_comp']['contr_erro'] == 'on')
    {
