  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_permiso_sesion" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sis_permiso_sesion_form();
	}
...
?>
  ...
  // ---------- Validate pes_usuario_
  function do_ajax_form_sis_permiso_sesion_validate_pes_usuario_(iNumLinha)
  {
    var nomeCampo_pes_usuario_ = "pes_usuario_" + iNumLinha;
    var var_pes_usuario_ = scAjaxGetFieldText(nomeCampo_pes_usuario_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_permiso_sesion_validate_pes_usuario_(var_pes_usuario_, iNumLinha, var_script_case_init, do_ajax_form_sis_permiso_sesion_validate_pes_usuario__cb);
  } // do_ajax_form_sis_permiso_sesion_validate_pes_usuario_

  function do_ajax_form_sis_permiso_sesion_validate_pes_usuario__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "pes_usuario_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pes_usuario_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "pes_usuario_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pes_usuario_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_permiso_sesion_validate_pes_usuario__cb

  // ---------- Validate pes_nodo_servidor_
  function do_ajax_form_sis_permiso_sesion_validate_pes_nodo_servidor_(iNumLinha)
  {
    var nomeCampo_pes_nodo_servidor_ = "pes_nodo_servidor_" + iNumLinha;
    var var_pes_nodo_servidor_ = scAjaxGetFieldSelect(nomeCampo_pes_nodo_servidor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_permiso_sesion_validate_pes_nodo_servidor_(var_pes_nodo_servidor_, iNumLinha, var_script_case_init, do_ajax_form_sis_permiso_sesion_validate_pes_nodo_servidor__cb);
  } // do_ajax_form_sis_permiso_sesion_validate_pes_nodo_servidor_

  function do_ajax_form_sis_permiso_sesion_validate_pes_nodo_servidor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "pes_nodo_servidor_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pes_nodo_servidor_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "pes_nodo_servidor_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pes_nodo_servidor_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_permiso_sesion_validate_pes_nodo_servidor__cb

  // ---------- Validate pes_filial_
  function do_ajax_form_sis_permiso_sesion_validate_pes_filial_(iNumLinha)
  {
    var nomeCampo_pes_filial_ = "pes_filial_" + iNumLinha;
    var var_pes_filial_ = scAjaxGetFieldSelect(nomeCampo_pes_filial_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_permiso_sesion_validate_pes_filial_(var_pes_filial_, iNumLinha, var_script_case_init, do_ajax_form_sis_permiso_sesion_validate_pes_filial__cb);
  } // do_ajax_form_sis_permiso_sesion_validate_pes_filial_

  function do_ajax_form_sis_permiso_sesion_validate_pes_filial__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "pes_filial_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pes_filial_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "pes_filial_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pes_filial_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_permiso_sesion_validate_pes_filial__cb

  // ---------- Validate pes_oficina_
  function do_ajax_form_sis_permiso_sesion_validate_pes_oficina_(iNumLinha)
  {
    var nomeCampo_pes_oficina_ = "pes_oficina_" + iNumLinha;
    var var_pes_oficina_ = scAjaxGetFieldSelect(nomeCampo_pes_oficina_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_permiso_sesion_validate_pes_oficina_(var_pes_oficina_, iNumLinha, var_script_case_init, do_ajax_form_sis_permiso_sesion_validate_pes_oficina__cb);
  } // do_ajax_form_sis_permiso_sesion_validate_pes_oficina_

  function do_ajax_form_sis_permiso_sesion_validate_pes_oficina__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "pes_oficina_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pes_oficina_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "pes_oficina_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pes_oficina_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_permiso_sesion_validate_pes_oficina__cb

  // ---------- Validate pes_horario_
  function do_ajax_form_sis_permiso_sesion_validate_pes_horario_(iNumLinha)
  {
    var nomeCampo_pes_horario_ = "pes_horario_" + iNumLinha;
    var var_pes_horario_ = scAjaxGetFieldSelect(nomeCampo_pes_horario_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_permiso_sesion_validate_pes_horario_(var_pes_horario_, iNumLinha, var_script_case_init, do_ajax_form_sis_permiso_sesion_validate_pes_horario__cb);
  } // do_ajax_form_sis_permiso_sesion_validate_pes_horario_

  function do_ajax_form_sis_permiso_sesion_validate_pes_horario__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "pes_horario_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pes_horario_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "pes_horario_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pes_horario_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_permiso_sesion_validate_pes_horario__cb

  // ---------- Validate pes_estacion_
  function do_ajax_form_sis_permiso_sesion_validate_pes_estacion_(iNumLinha)
  {
    var nomeCampo_pes_estacion_ = "pes_estacion_" + iNumLinha;
    var var_pes_estacion_ = scAjaxGetFieldText(nomeCampo_pes_estacion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_permiso_sesion_validate_pes_estacion_(var_pes_estacion_, iNumLinha, var_script_case_init, do_ajax_form_sis_permiso_sesion_validate_pes_estacion__cb);
  } // do_ajax_form_sis_permiso_sesion_validate_pes_estacion_

  function do_ajax_form_sis_permiso_sesion_validate_pes_estacion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "pes_estacion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pes_estacion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "pes_estacion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pes_estacion_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_permiso_sesion_validate_pes_estacion__cb

  // ---------- Validate pes_estado_
  function do_ajax_form_sis_permiso_sesion_validate_pes_estado_(iNumLinha)
  {
    var nomeCampo_pes_estado_ = "pes_estado_" + iNumLinha;
    var var_pes_estado_ = scAjaxGetFieldSelect(nomeCampo_pes_estado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_permiso_sesion_validate_pes_estado_(var_pes_estado_, iNumLinha, var_script_case_init, do_ajax_form_sis_permiso_sesion_validate_pes_estado__cb);
  } // do_ajax_form_sis_permiso_sesion_validate_pes_estado_

  function do_ajax_form_sis_permiso_sesion_validate_pes_estado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "pes_estado_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pes_estado_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "pes_estado_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pes_estado_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_permiso_sesion_validate_pes_estado__cb

  // ---------- Validate pes_empresa_
  function do_ajax_form_sis_permiso_sesion_validate_pes_empresa_(iNumLinha)
  {
    var nomeCampo_pes_empresa_ = "pes_empresa_" + iNumLinha;
    var var_pes_empresa_ = scAjaxGetFieldText(nomeCampo_pes_empresa_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_permiso_sesion_validate_pes_empresa_(var_pes_empresa_, iNumLinha, var_script_case_init, do_ajax_form_sis_permiso_sesion_validate_pes_empresa__cb);
  } // do_ajax_form_sis_permiso_sesion_validate_pes_empresa_

  function do_ajax_form_sis_permiso_sesion_validate_pes_empresa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "pes_empresa_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pes_empresa_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "pes_empresa_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pes_empresa_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_permiso_sesion_validate_pes_empresa__cb

  // ---------- Refresh pes_filial_
  function do_ajax_form_sis_permiso_sesion_refresh_pes_filial_(iSeqForm)
  {
    var var_pes_filial_ = scAjaxGetFieldSelect("pes_filial_" + iSeqForm);
    var var_nmgp_refresh_row = iSeqForm;
    var var_nmgp_refresh_fields = "pes_oficina_";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sis_permiso_sesion_refresh_pes_filial_(var_pes_filial_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_sis_permiso_sesion_refresh_pes_filial__cb);
  } // do_ajax_form_sis_permiso_sesion_refresh_pes_filial_

  function do_ajax_form_sis_permiso_sesion_refresh_pes_filial__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_permiso_sesion_refresh_pes_filial__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_sis_permiso_sesion_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_sis_permiso_sesion_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sis_permiso_sesion_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_sis_permiso_sesion_add_new_line_cb);
  } // do_ajax_form_sis_permiso_sesion_add_new_line

  function do_ajax_form_sis_permiso_sesion_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_sis_permiso_sesion_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_sis_permiso_sesion_backup_line(iNumLinha)
  {
    var var_pes_usuario_ = scAjaxGetFieldText("pes_usuario_" + iNumLinha);
    var var_pes_nodo_servidor_ = scAjaxGetFieldSelect("pes_nodo_servidor_" + iNumLinha);
    var var_pes_empresa_ = scAjaxGetFieldText("pes_empresa_" + iNumLinha);
    var var_pes_filial_ = scAjaxGetFieldSelect("pes_filial_" + iNumLinha);
    var var_pes_oficina_ = scAjaxGetFieldSelect("pes_oficina_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_permiso_sesion_backup_line(var_pes_usuario_, var_pes_nodo_servidor_, var_pes_empresa_, var_pes_filial_, var_pes_oficina_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_sis_permiso_sesion_backup_line_cb);
  } // do_ajax_form_sis_permiso_sesion_backup_line

  function do_ajax_form_sis_permiso_sesion_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_sis_permiso_sesion_backup_line_cb

  function do_ajax_form_sis_permiso_sesion_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_sis_permiso_sesion_cancel_insert

  function do_ajax_form_sis_permiso_sesion_cancel_update(iSeqVert)
  {
    do_ajax_form_sis_permiso_sesion_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_sis_permiso_sesion_cancel_update

  function do_ajax_form_sis_permiso_sesion_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_sis_permiso_sesion_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_sis_permiso_sesion_table_refresh()
  {
    var var_pes_usuario_ = document.F2.pes_usuario_.value;
    var var_pes_nodo_servidor_ = document.F2.pes_nodo_servidor_.value;
    var var_pes_empresa_ = document.F2.pes_empresa_.value;
    var var_pes_filial_ = document.F2.pes_filial_.value;
    var var_pes_oficina_ = document.F2.pes_oficina_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sis_permiso_sesion_table_refresh(var_pes_usuario_, var_pes_nodo_servidor_, var_pes_empresa_, var_pes_filial_, var_pes_oficina_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_permiso_sesion_table_refresh_cb);
  } //  do_ajax_form_sis_permiso_sesion_table_refresh

  function do_ajax_form_sis_permiso_sesion_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.pes_usuario_.value = scAjaxGetKeyValue("pes_usuario_");
    document.F2.pes_nodo_servidor_.value = scAjaxGetKeyValue("pes_nodo_servidor_");
    document.F2.pes_empresa_.value = scAjaxGetKeyValue("pes_empresa_");
    document.F2.pes_filial_.value = scAjaxGetKeyValue("pes_filial_");
    document.F2.pes_oficina_.value = scAjaxGetKeyValue("pes_oficina_");
    ...
    scAjaxAlert(do_ajax_form_sis_permiso_sesion_table_refresh_cb_after_alert);
  } // do_ajax_form_sis_permiso_sesion_table_refresh_cb
  function do_ajax_form_sis_permiso_sesion_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_sis_permiso_sesion_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_sis_permiso_sesion_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_sis_permiso_sesion_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_pes_filial_ = scAjaxGetFieldSelect("pes_filial_" + iNumLinha);
    var var_pes_oficina_ = scAjaxGetFieldSelect("pes_oficina_" + iNumLinha);
    var var_pes_horario_ = scAjaxGetFieldSelect("pes_horario_" + iNumLinha);
    var var_pes_estacion_ = scAjaxGetFieldText("pes_estacion_" + iNumLinha);
    var var_pes_estado_ = scAjaxGetFieldSelect("pes_estado_" + iNumLinha);
    var var_pes_empresa_ = scAjaxGetFieldText("pes_empresa_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_sis_permiso_sesion_submit_form(var_pes_usuario_, var_pes_nodo_servidor_, var_pes_filial_, var_pes_oficina_, var_pes_horario_, var_pes_estacion_, var_pes_estado_, var_pes_empresa_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_permiso_sesion_submit_form_cb);
  } // do_ajax_form_sis_permiso_sesion_submit_form

  function do_ajax_form_sis_permiso_sesion_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("pes_usuario_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("pes_nodo_servidor_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("pes_filial_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("pes_oficina_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("pes_horario_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("pes_estacion_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("pes_estado_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("pes_empresa_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sis_permiso_sesion_submit_form_cb_after_alert);
  } // do_ajax_form_sis_permiso_sesion_submit_form_cb
  function do_ajax_form_sis_permiso_sesion_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_permiso_sesion_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sis_permiso_sesion_navigate_form()
  {
    perform_ajax_form_sis_permiso_sesion_navigate_form();
  }

  function perform_ajax_form_sis_permiso_sesion_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_sis_permiso_sesion_cancel_insert(sc_form_sis_permiso_sesion_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("pes_usuario_" + iNavForm);
      scAjaxHideErrorDisplay("pes_nodo_servidor_" + iNavForm);
      scAjaxHideErrorDisplay("pes_filial_" + iNavForm);
      scAjaxHideErrorDisplay("pes_oficina_" + iNavForm);
      scAjaxHideErrorDisplay("pes_horario_" + iNavForm);
      scAjaxHideErrorDisplay("pes_estacion_" + iNavForm);
      scAjaxHideErrorDisplay("pes_estado_" + iNavForm);
      scAjaxHideErrorDisplay("pes_empresa_" + iNavForm);
    }
    var var_pes_usuario_ = document.F2.pes_usuario_.value;
    var var_pes_nodo_servidor_ = document.F2.pes_nodo_servidor_.value;
    var var_pes_empresa_ = document.F2.pes_empresa_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sis_permiso_sesion_navigate_form(var_pes_usuario_, var_pes_nodo_servidor_, var_pes_empresa_, var_pes_filial_, var_pes_oficina_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_permiso_sesion_navigate_form_cb);
  } // do_ajax_form_sis_permiso_sesion_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_permiso_sesion']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_permiso_sesion_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.pes_usuario_.value = scAjaxGetKeyValue("pes_usuario_" + var_last_index);
    document.F2.pes_nodo_servidor_.value = scAjaxGetKeyValue("pes_nodo_servidor_" + var_last_index);
    document.F2.pes_empresa_.value = scAjaxGetKeyValue("pes_empresa_" + var_last_index);
    document.F2.pes_filial_.value = scAjaxGetKeyValue("pes_filial_" + var_last_index);
    document.F2.pes_oficina_.value = scAjaxGetKeyValue("pes_oficina_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_permiso_sesion_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_permiso_sesion_navigate_form_cb
  function do_ajax_form_sis_permiso_sesion_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_sis_permiso_sesion_navigate_form_cb_after_alert

    function sc_form_sis_permiso_sesion_get_last_line_number()
    {
    ...
    } //sc_form_sis_permiso_sesion_get_last_line_number

  function sc_hide_form_sis_permiso_sesion_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "pes_usuario_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pes_nodo_servidor_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pes_filial_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pes_oficina_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pes_horario_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pes_estacion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pes_estado_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pes_empresa_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["pes_usuario_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_usuario'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pes_nodo_servidor_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_nodo_servidor'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pes_filial_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_filial'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pes_oficina_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_oficina'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pes_horario_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_horario'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pes_estacion_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_estacion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pes_estado_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pes_empresa_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_empresa'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["pes_usuario_"][iNumLinha] = "pes_usuario_" + iNumLinha;
    ajax_field_mult["pes_nodo_servidor_"][iNumLinha] = "pes_nodo_servidor_" + iNumLinha;
    ajax_field_mult["pes_filial_"][iNumLinha] = "pes_filial_" + iNumLinha;
    ajax_field_mult["pes_oficina_"][iNumLinha] = "pes_oficina_" + iNumLinha;
    ajax_field_mult["pes_horario_"][iNumLinha] = "pes_horario_" + iNumLinha;
    ajax_field_mult["pes_estacion_"][iNumLinha] = "pes_estacion_" + iNumLinha;
    ajax_field_mult["pes_estado_"][iNumLinha] = "pes_estado_" + iNumLinha;
    ajax_field_mult["pes_empresa_"][iNumLinha] = "pes_empresa_" + iNumLinha;
    ajax_field_id["pes_nodo_servidor_" + iNumLinha] = new Array("hidden_field_label_pes_nodo_servidor_", "hidden_field_data_pes_nodo_servidor_" + iNumLinha);
    ajax_field_id["pes_filial_" + iNumLinha] = new Array("hidden_field_label_pes_filial_", "hidden_field_data_pes_filial_" + iNumLinha);
    ajax_field_id["pes_oficina_" + iNumLinha] = new Array("hidden_field_label_pes_oficina_", "hidden_field_data_pes_oficina_" + iNumLinha);
    ajax_field_id["pes_horario_" + iNumLinha] = new Array("hidden_field_label_pes_horario_", "hidden_field_data_pes_horario_" + iNumLinha);
    ajax_field_id["pes_estacion_" + iNumLinha] = new Array("hidden_field_label_pes_estacion_", "hidden_field_data_pes_estacion_" + iNumLinha);
    ajax_field_id["pes_estado_" + iNumLinha] = new Array("hidden_field_label_pes_estado_", "hidden_field_data_pes_estado_" + iNumLinha);
    ajax_error_count["pes_usuario_" + iNumLinha] = "off";
    ajax_error_count["pes_nodo_servidor_" + iNumLinha] = "off";
    ajax_error_count["pes_filial_" + iNumLinha] = "off";
    ajax_error_count["pes_oficina_" + iNumLinha] = "off";
    ajax_error_count["pes_horario_" + iNumLinha] = "off";
    ajax_error_count["pes_estacion_" + iNumLinha] = "off";
    ajax_error_count["pes_estado_" + iNumLinha] = "off";
    ajax_error_count["pes_empresa_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["pes_usuario_" + iNumLinha] = "on";
    ajax_read_only["pes_nodo_servidor_" + iNumLinha] = "on";
    ajax_read_only["pes_filial_" + iNumLinha] = "on";
    ajax_read_only["pes_oficina_" + iNumLinha] = "on";
    ajax_read_only["pes_horario_" + iNumLinha] = "off";
    ajax_read_only["pes_estacion_" + iNumLinha] = "off";
    ajax_read_only["pes_estado_" + iNumLinha] = "off";
    ajax_read_only["pes_empresa_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["pes_filial_" + iNumLinha] = "on";
    ajax_read_only["pes_oficina_" + iNumLinha] = "on";
    ajax_read_only["pes_horario_" + iNumLinha] = "on";
    ajax_read_only["pes_estacion_" + iNumLinha] = "on";
    ajax_read_only["pes_estado_" + iNumLinha] = "on";
    ajax_read_only["pes_empresa_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["pes_usuario_" + iNumLinha] = null;
    ajax_error_list["pes_nodo_servidor_" + iNumLinha] = null;
    ajax_error_list["pes_filial_" + iNumLinha] = null;
    ajax_error_list["pes_oficina_" + iNumLinha] = null;
    ajax_error_list["pes_horario_" + iNumLinha] = null;
    ajax_error_list["pes_estacion_" + iNumLinha] = null;
    ajax_error_list["pes_estado_" + iNumLinha] = null;
    ajax_error_list["pes_empresa_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "pes_usuario_": new Array(),
    "pes_nodo_servidor_": new Array(),
    "pes_filial_": new Array(),
    "pes_oficina_": new Array(),
    "pes_horario_": new Array(),
    "pes_estacion_": new Array(),
    "pes_estado_": new Array(),
    "pes_empresa_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["pes_usuario_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pes_usuario_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pes_usuario_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pes_usuario_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pes_usuario_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["pes_nodo_servidor_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pes_nodo_servidor_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pes_nodo_servidor_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pes_nodo_servidor_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pes_nodo_servidor_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["pes_filial_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pes_filial_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pes_filial_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pes_filial_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pes_filial_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["pes_oficina_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pes_oficina_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pes_oficina_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pes_oficina_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pes_oficina_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["pes_horario_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pes_horario_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pes_horario_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pes_horario_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pes_horario_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["pes_estacion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pes_estacion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pes_estacion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pes_estacion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pes_estacion_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["pes_estado_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pes_estado_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pes_estado_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pes_estado_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pes_estado_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["pes_empresa_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pes_empresa_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pes_empresa_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pes_empresa_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pes_empresa_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pes_usuario_'])) ? $this->nmgp_cmp_readonly['pes_usuario_'] : 'on';
?>
    scAjaxFieldRead("pes_usuario_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pes_nodo_servidor_'])) ? $this->nmgp_cmp_readonly['pes_nodo_servidor_'] : 'on';
?>
    scAjaxFieldRead("pes_nodo_servidor_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pes_filial_'])) ? $this->nmgp_cmp_readonly['pes_filial_'] : 'on';
?>
    scAjaxFieldRead("pes_filial_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pes_oficina_'])) ? $this->nmgp_cmp_readonly['pes_oficina_'] : 'on';
?>
    scAjaxFieldRead("pes_oficina_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pes_horario_'])) ? $this->nmgp_cmp_readonly['pes_horario_'] : 'off';
?>
    scAjaxFieldRead("pes_horario_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pes_estacion_'])) ? $this->nmgp_cmp_readonly['pes_estacion_'] : 'off';
?>
    scAjaxFieldRead("pes_estacion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pes_estado_'])) ? $this->nmgp_cmp_readonly['pes_estado_'] : 'off';
?>
    scAjaxFieldRead("pes_estado_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pes_empresa_'])) ? $this->nmgp_cmp_readonly['pes_empresa_'] : 'off';
?>
    scAjaxFieldRead("pes_empresa_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("pes_usuario_" + iSeq, "on");
    scAjaxFieldRead("pes_nodo_servidor_" + iSeq, "on");
    scAjaxFieldRead("pes_filial_" + iSeq, "on");
    scAjaxFieldRead("pes_oficina_" + iSeq, "on");
    scAjaxFieldRead("pes_horario_" + iSeq, "on");
    scAjaxFieldRead("pes_estacion_" + iSeq, "on");
    scAjaxFieldRead("pes_estado_" + iSeq, "on");
    scAjaxFieldRead("pes_empresa_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["pes_usuario_" + iRow] || "on" == ajax_error_count["pes_nodo_servidor_" + iRow] || "on" == ajax_error_count["pes_filial_" + iRow] || "on" == ajax_error_count["pes_oficina_" + iRow] || "on" == ajax_error_count["pes_horario_" + iRow] || "on" == ajax_error_count["pes_estacion_" + iRow] || "on" == ajax_error_count["pes_estado_" + iRow] || "on" == ajax_error_count["pes_empresa_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pes_usuario_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pes_nodo_servidor_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pes_filial_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pes_oficina_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pes_horario_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pes_estacion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pes_estado_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pes_empresa_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["pes_usuario_" + iRow] && "off" == ajax_error_count["pes_nodo_servidor_" + iRow] && "off" == ajax_error_count["pes_filial_" + iRow] && "off" == ajax_error_count["pes_oficina_" + iRow] && "off" == ajax_error_count["pes_horario_" + iRow] && "off" == ajax_error_count["pes_estacion_" + iRow] && "off" == ajax_error_count["pes_estado_" + iRow] && "off" == ajax_error_count["pes_empresa_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["pes_usuario_" + iRow] = "off";
        ajax_error_count["pes_nodo_servidor_" + iRow] = "off";
        ajax_error_count["pes_filial_" + iRow] = "off";
        ajax_error_count["pes_oficina_" + iRow] = "off";
        ajax_error_count["pes_horario_" + iRow] = "off";
        ajax_error_count["pes_estacion_" + iRow] = "off";
        ajax_error_count["pes_estado_" + iRow] = "off";
        ajax_error_count["pes_empresa_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_pes_usuario_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_pes_nodo_servidor_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_pes_filial_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_pes_oficina_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_pes_horario_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_pes_estacion_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_pes_estado_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_pes_empresa_" + iRow).removeClass("scFormErrorLine");
    }
  }
