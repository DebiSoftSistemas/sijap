<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="pes_usuario_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['pes_usuario_']); ?>">
<input type="hidden" name="pes_nodo_servidor_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['pes_nodo_servidor_']); ?>">
<input type="hidden" name="pes_empresa_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['pes_empresa_']); ?>">
<input type="hidden" name="pes_filial_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['pes_filial_']); ?>">
<input type="hidden" name="pes_oficina_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['pes_oficina_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_sis_permiso_sesion"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function scForm_inline_submit(y, z) {
	Nm_Proc_Atualiz = true;
	do_ajax_form_sis_permiso_sesion_submit_form(y, z);
