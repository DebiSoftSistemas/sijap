...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_del_factura_multiple"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_del_factura_multiple"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_del_factura_multiple'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_del_factura_multiple']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_del_factura_multiple']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_del_factura_multiple']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_del_factura_multiple']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_del_factura_multiple']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_del_factura_multiple</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_del_factura_multiple']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_del_factura_multiple']['embutida_filho'] as $ind => $sc_init)
          {
