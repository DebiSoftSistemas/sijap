  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_detalle_guia_destinatario" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_detalle_guia_destinatario_form();
	}
...
?>
  ...
  // ---------- Validate dgd_id_
  function do_ajax_form_del_detalle_guia_destinatario_validate_dgd_id_(iNumLinha)
  {
    var nomeCampo_dgd_id_ = "dgd_id_" + iNumLinha;
    var var_dgd_id_ = scAjaxGetFieldHidden(nomeCampo_dgd_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_guia_destinatario_validate_dgd_id_(var_dgd_id_, iNumLinha, var_script_case_init, do_ajax_form_del_detalle_guia_destinatario_validate_dgd_id__cb);
  } // do_ajax_form_del_detalle_guia_destinatario_validate_dgd_id_

  function do_ajax_form_del_detalle_guia_destinatario_validate_dgd_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "dgd_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "dgd_id_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "dgd_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "dgd_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_guia_destinatario_validate_dgd_id__cb

  // ---------- Validate dgd_destinatario_
  function do_ajax_form_del_detalle_guia_destinatario_validate_dgd_destinatario_(iNumLinha)
  {
    var nomeCampo_dgd_destinatario_ = "dgd_destinatario_" + iNumLinha;
    var var_dgd_destinatario_ = scAjaxGetFieldText(nomeCampo_dgd_destinatario_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_guia_destinatario_validate_dgd_destinatario_(var_dgd_destinatario_, iNumLinha, var_script_case_init, do_ajax_form_del_detalle_guia_destinatario_validate_dgd_destinatario__cb);
  } // do_ajax_form_del_detalle_guia_destinatario_validate_dgd_destinatario_

  function do_ajax_form_del_detalle_guia_destinatario_validate_dgd_destinatario__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "dgd_destinatario_" + iLineNumber;
    }
    else
    {
      sFieldValid = "dgd_destinatario_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "dgd_destinatario_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "dgd_destinatario_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_guia_destinatario_validate_dgd_destinatario__cb

  // ---------- Validate dgd_producto_
  function do_ajax_form_del_detalle_guia_destinatario_validate_dgd_producto_(iNumLinha)
  {
    var nomeCampo_dgd_producto_ = "dgd_producto_" + iNumLinha;
    var var_dgd_producto_ = scAjaxGetFieldSelect(nomeCampo_dgd_producto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_guia_destinatario_validate_dgd_producto_(var_dgd_producto_, iNumLinha, var_script_case_init, do_ajax_form_del_detalle_guia_destinatario_validate_dgd_producto__cb);
  } // do_ajax_form_del_detalle_guia_destinatario_validate_dgd_producto_

  function do_ajax_form_del_detalle_guia_destinatario_validate_dgd_producto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "dgd_producto_" + iLineNumber;
    }
    else
    {
      sFieldValid = "dgd_producto_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "dgd_producto_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "dgd_producto_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_guia_destinatario_validate_dgd_producto__cb

  // ---------- Validate dgd_descripcion_adicional_
  function do_ajax_form_del_detalle_guia_destinatario_validate_dgd_descripcion_adicional_(iNumLinha)
  {
    var nomeCampo_dgd_descripcion_adicional_ = "dgd_descripcion_adicional_" + iNumLinha;
    var var_dgd_descripcion_adicional_ = scAjaxGetFieldText(nomeCampo_dgd_descripcion_adicional_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_guia_destinatario_validate_dgd_descripcion_adicional_(var_dgd_descripcion_adicional_, iNumLinha, var_script_case_init, do_ajax_form_del_detalle_guia_destinatario_validate_dgd_descripcion_adicional__cb);
  } // do_ajax_form_del_detalle_guia_destinatario_validate_dgd_descripcion_adicional_

  function do_ajax_form_del_detalle_guia_destinatario_validate_dgd_descripcion_adicional__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "dgd_descripcion_adicional_" + iLineNumber;
    }
    else
    {
      sFieldValid = "dgd_descripcion_adicional_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "dgd_descripcion_adicional_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "dgd_descripcion_adicional_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_guia_destinatario_validate_dgd_descripcion_adicional__cb

  // ---------- Validate dgd_cantidad_
  function do_ajax_form_del_detalle_guia_destinatario_validate_dgd_cantidad_(iNumLinha)
  {
    var nomeCampo_dgd_cantidad_ = "dgd_cantidad_" + iNumLinha;
    var var_dgd_cantidad_ = scAjaxGetFieldText(nomeCampo_dgd_cantidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_guia_destinatario_validate_dgd_cantidad_(var_dgd_cantidad_, iNumLinha, var_script_case_init, do_ajax_form_del_detalle_guia_destinatario_validate_dgd_cantidad__cb);
  } // do_ajax_form_del_detalle_guia_destinatario_validate_dgd_cantidad_

  function do_ajax_form_del_detalle_guia_destinatario_validate_dgd_cantidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "dgd_cantidad_" + iLineNumber;
    }
    else
    {
      sFieldValid = "dgd_cantidad_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "dgd_cantidad_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "dgd_cantidad_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_guia_destinatario_validate_dgd_cantidad__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_del_detalle_guia_destinatario_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_del_detalle_guia_destinatario_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_detalle_guia_destinatario_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_del_detalle_guia_destinatario_add_new_line_cb);
  } // do_ajax_form_del_detalle_guia_destinatario_add_new_line

  function do_ajax_form_del_detalle_guia_destinatario_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_del_detalle_guia_destinatario_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_del_detalle_guia_destinatario_backup_line(iNumLinha)
  {
    var var_dgd_id_ = scAjaxGetFieldHidden("dgd_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_guia_destinatario_backup_line(var_dgd_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_del_detalle_guia_destinatario_backup_line_cb);
  } // do_ajax_form_del_detalle_guia_destinatario_backup_line

  function do_ajax_form_del_detalle_guia_destinatario_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_del_detalle_guia_destinatario_backup_line_cb

  function do_ajax_form_del_detalle_guia_destinatario_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_del_detalle_guia_destinatario_cancel_insert

  function do_ajax_form_del_detalle_guia_destinatario_cancel_update(iSeqVert)
  {
    do_ajax_form_del_detalle_guia_destinatario_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_del_detalle_guia_destinatario_cancel_update

  function do_ajax_form_del_detalle_guia_destinatario_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_del_detalle_guia_destinatario_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_del_detalle_guia_destinatario_table_refresh()
  {
    var var_dgd_id_ = document.F2.dgd_id_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_del_detalle_guia_destinatario_table_refresh(var_dgd_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_detalle_guia_destinatario_table_refresh_cb);
  } //  do_ajax_form_del_detalle_guia_destinatario_table_refresh

  function do_ajax_form_del_detalle_guia_destinatario_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.dgd_id_.value = scAjaxGetKeyValue("dgd_id_");
    ...
    scAjaxAlert(do_ajax_form_del_detalle_guia_destinatario_table_refresh_cb_after_alert);
  } // do_ajax_form_del_detalle_guia_destinatario_table_refresh_cb
  function do_ajax_form_del_detalle_guia_destinatario_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_del_detalle_guia_destinatario_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_del_detalle_guia_destinatario_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_del_detalle_guia_destinatario_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_dgd_id_ = scAjaxGetFieldHidden("dgd_id_" + iNumLinha);
    var var_dgd_destinatario_ = scAjaxGetFieldText("dgd_destinatario_" + iNumLinha);
    var var_dgd_producto_ = scAjaxGetFieldSelect("dgd_producto_" + iNumLinha);
    var var_dgd_descripcion_adicional_ = scAjaxGetFieldText("dgd_descripcion_adicional_" + iNumLinha);
    var var_dgd_cantidad_ = scAjaxGetFieldText("dgd_cantidad_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_del_detalle_guia_destinatario_submit_form(var_dgd_id_, var_dgd_destinatario_, var_dgd_producto_, var_dgd_descripcion_adicional_, var_dgd_cantidad_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_detalle_guia_destinatario_submit_form_cb);
  } // do_ajax_form_del_detalle_guia_destinatario_submit_form

  function do_ajax_form_del_detalle_guia_destinatario_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("dgd_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("dgd_destinatario_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("dgd_producto_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("dgd_descripcion_adicional_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("dgd_cantidad_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_detalle_guia_destinatario_submit_form_cb_after_alert);
  } // do_ajax_form_del_detalle_guia_destinatario_submit_form_cb
  function do_ajax_form_del_detalle_guia_destinatario_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_detalle_guia_destinatario_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_detalle_guia_destinatario_navigate_form()
  {
    perform_ajax_form_del_detalle_guia_destinatario_navigate_form();
  }

  function perform_ajax_form_del_detalle_guia_destinatario_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_del_detalle_guia_destinatario_cancel_insert(sc_form_del_detalle_guia_destinatario_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("dgd_id_" + iNavForm);
      scAjaxHideErrorDisplay("dgd_destinatario_" + iNavForm);
      scAjaxHideErrorDisplay("dgd_producto_" + iNavForm);
      scAjaxHideErrorDisplay("dgd_descripcion_adicional_" + iNavForm);
      scAjaxHideErrorDisplay("dgd_cantidad_" + iNavForm);
    }
    var var_dgd_id_ = document.F2.dgd_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_detalle_guia_destinatario_navigate_form(var_dgd_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_detalle_guia_destinatario_navigate_form_cb);
  } // do_ajax_form_del_detalle_guia_destinatario_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_guia_destinatario']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_detalle_guia_destinatario_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.dgd_id_.value = scAjaxGetKeyValue("dgd_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_detalle_guia_destinatario_navigate_form_cb_after_alert);
  } // do_ajax_form_del_detalle_guia_destinatario_navigate_form_cb
  function do_ajax_form_del_detalle_guia_destinatario_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_del_detalle_guia_destinatario_navigate_form_cb_after_alert

    function sc_form_del_detalle_guia_destinatario_get_last_line_number()
    {
    ...
    } //sc_form_del_detalle_guia_destinatario_get_last_line_number

  function sc_hide_form_del_detalle_guia_destinatario_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "dgd_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "dgd_destinatario_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "dgd_producto_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "dgd_descripcion_adicional_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "dgd_cantidad_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["dgd_id_" + iNumLinha] = {"label": "Dgd Id<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["dgd_destinatario_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_destinatario'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["dgd_producto_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_producto'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["dgd_descripcion_adicional_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_descripcion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["dgd_cantidad_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_lot_cantidad'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["dgd_id_"][iNumLinha] = "dgd_id_" + iNumLinha;
    ajax_field_mult["dgd_destinatario_"][iNumLinha] = "dgd_destinatario_" + iNumLinha;
    ajax_field_mult["dgd_producto_"][iNumLinha] = "dgd_producto_" + iNumLinha;
    ajax_field_mult["dgd_descripcion_adicional_"][iNumLinha] = "dgd_descripcion_adicional_" + iNumLinha;
    ajax_field_mult["dgd_cantidad_"][iNumLinha] = "dgd_cantidad_" + iNumLinha;
    ajax_field_id["dgd_producto_" + iNumLinha] = new Array("hidden_field_label_dgd_producto_", "hidden_field_data_dgd_producto_" + iNumLinha);
    ajax_field_id["dgd_descripcion_adicional_" + iNumLinha] = new Array("hidden_field_label_dgd_descripcion_adicional_", "hidden_field_data_dgd_descripcion_adicional_" + iNumLinha);
    ajax_field_id["dgd_cantidad_" + iNumLinha] = new Array("hidden_field_label_dgd_cantidad_", "hidden_field_data_dgd_cantidad_" + iNumLinha);
    ajax_error_count["dgd_id_" + iNumLinha] = "off";
    ajax_error_count["dgd_destinatario_" + iNumLinha] = "off";
    ajax_error_count["dgd_producto_" + iNumLinha] = "off";
    ajax_error_count["dgd_descripcion_adicional_" + iNumLinha] = "off";
    ajax_error_count["dgd_cantidad_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["dgd_id_" + iNumLinha] = "on";
    ajax_read_only["dgd_destinatario_" + iNumLinha] = "off";
    ajax_read_only["dgd_producto_" + iNumLinha] = "off";
    ajax_read_only["dgd_descripcion_adicional_" + iNumLinha] = "off";
    ajax_read_only["dgd_cantidad_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["dgd_id_" + iNumLinha] = "on";
    ajax_read_only["dgd_destinatario_" + iNumLinha] = "on";
    ajax_read_only["dgd_producto_" + iNumLinha] = "on";
    ajax_read_only["dgd_descripcion_adicional_" + iNumLinha] = "on";
    ajax_read_only["dgd_cantidad_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["dgd_id_" + iNumLinha] = null;
    ajax_error_list["dgd_destinatario_" + iNumLinha] = null;
    ajax_error_list["dgd_producto_" + iNumLinha] = null;
    ajax_error_list["dgd_descripcion_adicional_" + iNumLinha] = null;
    ajax_error_list["dgd_cantidad_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "dgd_id_": new Array(),
    "dgd_destinatario_": new Array(),
    "dgd_producto_": new Array(),
    "dgd_descripcion_adicional_": new Array(),
    "dgd_cantidad_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["dgd_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["dgd_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["dgd_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["dgd_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["dgd_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["dgd_destinatario_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["dgd_destinatario_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["dgd_destinatario_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["dgd_destinatario_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["dgd_destinatario_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["dgd_producto_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["dgd_producto_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["dgd_producto_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["dgd_producto_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["dgd_producto_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["dgd_descripcion_adicional_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["dgd_descripcion_adicional_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["dgd_descripcion_adicional_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["dgd_descripcion_adicional_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["dgd_descripcion_adicional_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["dgd_cantidad_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["dgd_cantidad_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["dgd_cantidad_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["dgd_cantidad_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["dgd_cantidad_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['dgd_id_'])) ? $this->nmgp_cmp_readonly['dgd_id_'] : 'on';
?>
    scAjaxFieldRead("dgd_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['dgd_destinatario_'])) ? $this->nmgp_cmp_readonly['dgd_destinatario_'] : 'off';
?>
    scAjaxFieldRead("dgd_destinatario_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['dgd_producto_'])) ? $this->nmgp_cmp_readonly['dgd_producto_'] : 'off';
?>
    scAjaxFieldRead("dgd_producto_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['dgd_descripcion_adicional_'])) ? $this->nmgp_cmp_readonly['dgd_descripcion_adicional_'] : 'off';
?>
    scAjaxFieldRead("dgd_descripcion_adicional_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['dgd_cantidad_'])) ? $this->nmgp_cmp_readonly['dgd_cantidad_'] : 'off';
?>
    scAjaxFieldRead("dgd_cantidad_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("dgd_id_" + iSeq, "on");
    scAjaxFieldRead("dgd_destinatario_" + iSeq, "on");
    scAjaxFieldRead("dgd_producto_" + iSeq, "on");
    scAjaxFieldRead("dgd_descripcion_adicional_" + iSeq, "on");
    scAjaxFieldRead("dgd_cantidad_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["dgd_id_" + iRow] || "on" == ajax_error_count["dgd_destinatario_" + iRow] || "on" == ajax_error_count["dgd_producto_" + iRow] || "on" == ajax_error_count["dgd_descripcion_adicional_" + iRow] || "on" == ajax_error_count["dgd_cantidad_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_dgd_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_dgd_destinatario_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_dgd_producto_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_dgd_descripcion_adicional_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_dgd_cantidad_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["dgd_id_" + iRow] && "off" == ajax_error_count["dgd_destinatario_" + iRow] && "off" == ajax_error_count["dgd_producto_" + iRow] && "off" == ajax_error_count["dgd_descripcion_adicional_" + iRow] && "off" == ajax_error_count["dgd_cantidad_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["dgd_id_" + iRow] = "off";
        ajax_error_count["dgd_destinatario_" + iRow] = "off";
        ajax_error_count["dgd_producto_" + iRow] = "off";
        ajax_error_count["dgd_descripcion_adicional_" + iRow] = "off";
        ajax_error_count["dgd_cantidad_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_dgd_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_dgd_destinatario_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_dgd_producto_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_dgd_descripcion_adicional_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_dgd_cantidad_" + iRow).removeClass("scFormErrorLine");
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("dgd_descripcion_adicional_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
