...
SCEOT;
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_des_contrato = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones_ind']['arr_total']['des_contrato'];
      }
      else
      {
          $this->array_total_des_contrato = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones_ind']['arr_total']['des_contrato'] = $this->array_total_des_contrato;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones_ind']['labels']['des_contrato'] = $Lab_des_contrato; 
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones_ind']['summarizing_fields_order']['des_contrato']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones_ind']['summarizing_fields_order']['des_contrato'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones_ind']['summarizing_fields_order']['des_contrato'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones_ind']['summarizing_fields_display']['des_contrato'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones_ind']['summarizing_fields_display']['des_contrato'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones_ind']['summarizing_fields_display']['des_contrato'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones_ind']['summarizing_fields_display']['des_contrato'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones_ind']['summarizing_fields_display']['des_contrato'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones_ind']['summarizing_fields_display']['des_contrato'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones_ind']['summarizing_fields_display']['des_contrato'] as $i_sum => $d_sum)
           {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones_ind']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones_ind']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_des_contrato("res", $this->NM_export);
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('des_contrato', 'des_contrato');
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->look_esc_tipo_deuda = $this->esc_tipo_deuda; 
            $this->Lookup->lookup_esc_tipo_deuda($this->look_esc_tipo_deuda, $this->esc_tipo_deuda) ; 
...
if($this->op_estado =='P'){
	$this->factura ="<button type='button' class='scButton_default'><i class='fas fa-list-ol'></i></button>";
}else{
	$this->factura ="";
}
$_SESSION['scriptcase']['grid_v_jap_otras_emisiones_ind']['contr_erro'] = 'off'; 
            $this->des_contrato_orig = $this->des_contrato;
            $this->esc_tipo_deuda = $this->look_esc_tipo_deuda ;
