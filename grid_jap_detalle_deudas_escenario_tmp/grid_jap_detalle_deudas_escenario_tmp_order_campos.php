...
<?php
   ...
   $Ord_Cmp = new grid_jap_detalle_deudas_escenario_tmp_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_jap_detalle_deudas_escenario_tmp_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario_tmp']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario_tmp']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['ddt_producto'] = "ddt_producto";
   $tab_labels["ddt_producto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario_tmp']['labels']["ddt_producto"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario_tmp']['labels']["ddt_producto"] : "" . $this->Nm_lang['lang_producto'] . "";
   $tab_ger_campos['ddt_cantidad'] = "on";
   $tab_def_campos['ddt_cantidad'] = "ddt_cantidad";
   $tab_labels["ddt_cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario_tmp']['labels']["ddt_cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario_tmp']['labels']["ddt_cantidad"] : "" . $this->Nm_lang['lang_cantidad'] . "";
   $tab_ger_campos['ddt_valor'] = "on";
   $tab_def_campos['ddt_valor'] = "ddt_valor";
   $tab_labels["ddt_valor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario_tmp']['labels']["ddt_valor"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario_tmp']['labels']["ddt_valor"] : "" . $this->Nm_lang['lang_precio_unitario'] . "";
   $tab_ger_campos['ddt_subtotal'] = "on";
   $tab_def_campos['ddt_subtotal'] = "ddt_subtotal";
   $tab_labels["ddt_subtotal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario_tmp']['labels']["ddt_subtotal"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario_tmp']['labels']["ddt_subtotal"] : "" . $this->Nm_lang['lang_subtotal'] . "";
   $tab_ger_campos['ddt_iva'] = "on";
   $tab_def_campos['ddt_iva'] = "ddt_iva";
   $tab_labels["ddt_iva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario_tmp']['labels']["ddt_iva"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario_tmp']['labels']["ddt_iva"] : "" . $this->Nm_lang['lang_iva'] . "";
   $tab_ger_campos['ddt_total'] = "on";
   $tab_def_campos['ddt_total'] = "ddt_total";
   $tab_labels["ddt_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario_tmp']['labels']["ddt_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario_tmp']['labels']["ddt_total"] : "" . $this->Nm_lang['lang_total'] . "";
   $tab_ger_campos['ddt_unidad'] = "on";
   $tab_def_campos['ddt_unidad'] = "ddt_unidad";
   $tab_labels["ddt_unidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario_tmp']['labels']["ddt_unidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario_tmp']['labels']["ddt_unidad"] : "" . $this->Nm_lang['lang_unidad'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario_tmp']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario_tmp']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario_tmp']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario_tmp']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario_tmp']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario_tmp']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario_tmp']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario_tmp']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario_tmp']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario_tmp']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario_tmp']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario_tmp']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_jap_detalle_deudas_escenario_tmp_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario_tmp']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario_tmp']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario_tmp']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario_tmp']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario_tmp']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
