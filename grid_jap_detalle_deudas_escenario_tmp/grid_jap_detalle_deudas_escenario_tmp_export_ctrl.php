<?php
@session_start() ;
$_SESSION['scriptcase']['grid_jap_detalle_deudas_escenario_tmp']['sc_process_barr'] = true;
require_once('../grid_jap_detalle_deudas_escenario_tmp/index.php');
unset($_SESSION['scriptcase']['grid_jap_detalle_deudas_escenario_tmp']['sc_process_barr']);
$ExportCtrl = new grid_jap_detalle_deudas_escenario_tmp_export_control;
$ExportCtrl->Export_barr();

class grid_jap_detalle_deudas_escenario_tmp_export_control
{
