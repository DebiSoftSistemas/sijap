...
<html>
    <head>
        ...
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["mnu_pedidos"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile.min.css" />
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["mnu_pedidos"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["mnu_pedidos"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile.min.js"></script>
    <style>
    <?php
    if(isset($mnu_pedidos_menuData["data"]) && is_array($mnu_pedidos_menuData["data"]) && !empty($mnu_pedidos_menuData["data"]))
    {
        foreach($mnu_pedidos_menuData["data"] as $arr_item)
        {
    ...
    <body>
    <?php
        escreveMenuMobile($mnu_pedidos_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
