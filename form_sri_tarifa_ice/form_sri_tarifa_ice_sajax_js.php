  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sri_tarifa_ice" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sri_tarifa_ice_form();
	}
...
?>
  ...
  // ---------- Validate ice_id_
  function do_ajax_form_sri_tarifa_ice_validate_ice_id_(iNumLinha)
  {
    var nomeCampo_ice_id_ = "ice_id_" + iNumLinha;
    var var_ice_id_ = scAjaxGetFieldHidden(nomeCampo_ice_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tarifa_ice_validate_ice_id_(var_ice_id_, iNumLinha, var_script_case_init, do_ajax_form_sri_tarifa_ice_validate_ice_id__cb);
  } // do_ajax_form_sri_tarifa_ice_validate_ice_id_

  function do_ajax_form_sri_tarifa_ice_validate_ice_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "ice_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ice_id_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "ice_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ice_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_tarifa_ice_validate_ice_id__cb

  // ---------- Validate ice_codigo_
  function do_ajax_form_sri_tarifa_ice_validate_ice_codigo_(iNumLinha)
  {
    var nomeCampo_ice_codigo_ = "ice_codigo_" + iNumLinha;
    var var_ice_codigo_ = scAjaxGetFieldText(nomeCampo_ice_codigo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tarifa_ice_validate_ice_codigo_(var_ice_codigo_, iNumLinha, var_script_case_init, do_ajax_form_sri_tarifa_ice_validate_ice_codigo__cb);
  } // do_ajax_form_sri_tarifa_ice_validate_ice_codigo_

  function do_ajax_form_sri_tarifa_ice_validate_ice_codigo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "ice_codigo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ice_codigo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "ice_codigo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ice_codigo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_tarifa_ice_validate_ice_codigo__cb

  // ---------- Validate ice_descripcion_
  function do_ajax_form_sri_tarifa_ice_validate_ice_descripcion_(iNumLinha)
  {
    var nomeCampo_ice_descripcion_ = "ice_descripcion_" + iNumLinha;
    var var_ice_descripcion_ = scAjaxGetFieldText(nomeCampo_ice_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tarifa_ice_validate_ice_descripcion_(var_ice_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_sri_tarifa_ice_validate_ice_descripcion__cb);
  } // do_ajax_form_sri_tarifa_ice_validate_ice_descripcion_

  function do_ajax_form_sri_tarifa_ice_validate_ice_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "ice_descripcion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ice_descripcion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "ice_descripcion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ice_descripcion_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_tarifa_ice_validate_ice_descripcion__cb

  // ---------- Validate ice_tarifa_advaloren_
  function do_ajax_form_sri_tarifa_ice_validate_ice_tarifa_advaloren_(iNumLinha)
  {
    var nomeCampo_ice_tarifa_advaloren_ = "ice_tarifa_advaloren_" + iNumLinha;
    var var_ice_tarifa_advaloren_ = scAjaxGetFieldText(nomeCampo_ice_tarifa_advaloren_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tarifa_ice_validate_ice_tarifa_advaloren_(var_ice_tarifa_advaloren_, iNumLinha, var_script_case_init, do_ajax_form_sri_tarifa_ice_validate_ice_tarifa_advaloren__cb);
  } // do_ajax_form_sri_tarifa_ice_validate_ice_tarifa_advaloren_

  function do_ajax_form_sri_tarifa_ice_validate_ice_tarifa_advaloren__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "ice_tarifa_advaloren_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ice_tarifa_advaloren_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "ice_tarifa_advaloren_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ice_tarifa_advaloren_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_tarifa_ice_validate_ice_tarifa_advaloren__cb

  // ---------- Validate ice_tarifa_especifica_
  function do_ajax_form_sri_tarifa_ice_validate_ice_tarifa_especifica_(iNumLinha)
  {
    var nomeCampo_ice_tarifa_especifica_ = "ice_tarifa_especifica_" + iNumLinha;
    var var_ice_tarifa_especifica_ = scAjaxGetFieldText(nomeCampo_ice_tarifa_especifica_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tarifa_ice_validate_ice_tarifa_especifica_(var_ice_tarifa_especifica_, iNumLinha, var_script_case_init, do_ajax_form_sri_tarifa_ice_validate_ice_tarifa_especifica__cb);
  } // do_ajax_form_sri_tarifa_ice_validate_ice_tarifa_especifica_

  function do_ajax_form_sri_tarifa_ice_validate_ice_tarifa_especifica__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "ice_tarifa_especifica_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ice_tarifa_especifica_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "ice_tarifa_especifica_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ice_tarifa_especifica_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_tarifa_ice_validate_ice_tarifa_especifica__cb

  // ---------- Validate ice_estado_
  function do_ajax_form_sri_tarifa_ice_validate_ice_estado_(iNumLinha)
  {
    var nomeCampo_ice_estado_ = "ice_estado_" + iNumLinha;
    var var_ice_estado_ = scAjaxGetFieldSelect(nomeCampo_ice_estado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tarifa_ice_validate_ice_estado_(var_ice_estado_, iNumLinha, var_script_case_init, do_ajax_form_sri_tarifa_ice_validate_ice_estado__cb);
  } // do_ajax_form_sri_tarifa_ice_validate_ice_estado_

  function do_ajax_form_sri_tarifa_ice_validate_ice_estado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "ice_estado_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ice_estado_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "ice_estado_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ice_estado_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_tarifa_ice_validate_ice_estado__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_sri_tarifa_ice_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_sri_tarifa_ice_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sri_tarifa_ice_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_sri_tarifa_ice_add_new_line_cb);
  } // do_ajax_form_sri_tarifa_ice_add_new_line

  function do_ajax_form_sri_tarifa_ice_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_sri_tarifa_ice_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_sri_tarifa_ice_backup_line(iNumLinha)
  {
    var var_ice_id_ = scAjaxGetFieldHidden("ice_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tarifa_ice_backup_line(var_ice_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_sri_tarifa_ice_backup_line_cb);
  } // do_ajax_form_sri_tarifa_ice_backup_line

  function do_ajax_form_sri_tarifa_ice_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_sri_tarifa_ice_backup_line_cb

  function do_ajax_form_sri_tarifa_ice_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_sri_tarifa_ice_cancel_insert

  function do_ajax_form_sri_tarifa_ice_cancel_update(iSeqVert)
  {
    do_ajax_form_sri_tarifa_ice_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_sri_tarifa_ice_cancel_update

  function do_ajax_form_sri_tarifa_ice_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_sri_tarifa_ice_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_sri_tarifa_ice_table_refresh()
  {
    var var_ice_id_ = document.F2.ice_id_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_sri_tarifa_ice_table_refresh(var_ice_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sri_tarifa_ice_table_refresh_cb);
  } //  do_ajax_form_sri_tarifa_ice_table_refresh

  function do_ajax_form_sri_tarifa_ice_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.ice_id_.value = scAjaxGetKeyValue("ice_id_");
    ...
    scAjaxAlert(do_ajax_form_sri_tarifa_ice_table_refresh_cb_after_alert);
  } // do_ajax_form_sri_tarifa_ice_table_refresh_cb
  function do_ajax_form_sri_tarifa_ice_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_sri_tarifa_ice_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_sri_tarifa_ice_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_sri_tarifa_ice_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_ice_id_ = scAjaxGetFieldHidden("ice_id_" + iNumLinha);
    var var_ice_codigo_ = scAjaxGetFieldText("ice_codigo_" + iNumLinha);
    var var_ice_descripcion_ = scAjaxGetFieldText("ice_descripcion_" + iNumLinha);
    var var_ice_tarifa_advaloren_ = scAjaxGetFieldText("ice_tarifa_advaloren_" + iNumLinha);
    var var_ice_tarifa_especifica_ = scAjaxGetFieldText("ice_tarifa_especifica_" + iNumLinha);
    var var_ice_estado_ = scAjaxGetFieldSelect("ice_estado_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_sri_tarifa_ice_submit_form(var_ice_id_, var_ice_codigo_, var_ice_descripcion_, var_ice_tarifa_advaloren_, var_ice_tarifa_especifica_, var_ice_estado_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sri_tarifa_ice_submit_form_cb);
  } // do_ajax_form_sri_tarifa_ice_submit_form

  function do_ajax_form_sri_tarifa_ice_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("ice_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("ice_codigo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("ice_descripcion_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("ice_tarifa_advaloren_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("ice_tarifa_especifica_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("ice_estado_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sri_tarifa_ice_submit_form_cb_after_alert);
  } // do_ajax_form_sri_tarifa_ice_submit_form_cb
  function do_ajax_form_sri_tarifa_ice_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sri_tarifa_ice_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sri_tarifa_ice_navigate_form()
  {
    perform_ajax_form_sri_tarifa_ice_navigate_form();
  }

  function perform_ajax_form_sri_tarifa_ice_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_sri_tarifa_ice_cancel_insert(sc_form_sri_tarifa_ice_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("ice_id_" + iNavForm);
      scAjaxHideErrorDisplay("ice_codigo_" + iNavForm);
      scAjaxHideErrorDisplay("ice_descripcion_" + iNavForm);
      scAjaxHideErrorDisplay("ice_tarifa_advaloren_" + iNavForm);
      scAjaxHideErrorDisplay("ice_tarifa_especifica_" + iNavForm);
      scAjaxHideErrorDisplay("ice_estado_" + iNavForm);
    }
    var var_ice_id_ = document.F2.ice_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sri_tarifa_ice_navigate_form(var_ice_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sri_tarifa_ice_navigate_form_cb);
  } // do_ajax_form_sri_tarifa_ice_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sri_tarifa_ice']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sri_tarifa_ice_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.ice_id_.value = scAjaxGetKeyValue("ice_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sri_tarifa_ice_navigate_form_cb_after_alert);
  } // do_ajax_form_sri_tarifa_ice_navigate_form_cb
  function do_ajax_form_sri_tarifa_ice_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_sri_tarifa_ice_navigate_form_cb_after_alert

    function sc_form_sri_tarifa_ice_get_last_line_number()
    {
    ...
    } //sc_form_sri_tarifa_ice_get_last_line_number

  function sc_hide_form_sri_tarifa_ice_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "ice_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "ice_codigo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "ice_descripcion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "ice_tarifa_advaloren_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "ice_tarifa_especifica_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "ice_estado_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["ice_id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["ice_codigo_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_codigo'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["ice_descripcion_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_descripcion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["ice_tarifa_advaloren_" + iNumLinha] = {"label": "Tarifa Advaloren<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["ice_tarifa_especifica_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tarifa_especifica'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["ice_estado_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["ice_id_"][iNumLinha] = "ice_id_" + iNumLinha;
    ajax_field_mult["ice_codigo_"][iNumLinha] = "ice_codigo_" + iNumLinha;
    ajax_field_mult["ice_descripcion_"][iNumLinha] = "ice_descripcion_" + iNumLinha;
    ajax_field_mult["ice_tarifa_advaloren_"][iNumLinha] = "ice_tarifa_advaloren_" + iNumLinha;
    ajax_field_mult["ice_tarifa_especifica_"][iNumLinha] = "ice_tarifa_especifica_" + iNumLinha;
    ajax_field_mult["ice_estado_"][iNumLinha] = "ice_estado_" + iNumLinha;
    ajax_field_id["ice_codigo_" + iNumLinha] = new Array("hidden_field_label_ice_codigo_", "hidden_field_data_ice_codigo_" + iNumLinha);
    ajax_field_id["ice_descripcion_" + iNumLinha] = new Array("hidden_field_label_ice_descripcion_", "hidden_field_data_ice_descripcion_" + iNumLinha);
    ajax_field_id["ice_tarifa_advaloren_" + iNumLinha] = new Array("hidden_field_label_ice_tarifa_advaloren_", "hidden_field_data_ice_tarifa_advaloren_" + iNumLinha);
    ajax_field_id["ice_tarifa_especifica_" + iNumLinha] = new Array("hidden_field_label_ice_tarifa_especifica_", "hidden_field_data_ice_tarifa_especifica_" + iNumLinha);
    ajax_field_id["ice_estado_" + iNumLinha] = new Array("hidden_field_label_ice_estado_", "hidden_field_data_ice_estado_" + iNumLinha);
    ajax_error_count["ice_id_" + iNumLinha] = "off";
    ajax_error_count["ice_codigo_" + iNumLinha] = "off";
    ajax_error_count["ice_descripcion_" + iNumLinha] = "off";
    ajax_error_count["ice_tarifa_advaloren_" + iNumLinha] = "off";
    ajax_error_count["ice_tarifa_especifica_" + iNumLinha] = "off";
    ajax_error_count["ice_estado_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["ice_id_" + iNumLinha] = "on";
    ajax_read_only["ice_codigo_" + iNumLinha] = "off";
    ajax_read_only["ice_descripcion_" + iNumLinha] = "off";
    ajax_read_only["ice_tarifa_advaloren_" + iNumLinha] = "off";
    ajax_read_only["ice_tarifa_especifica_" + iNumLinha] = "off";
    ajax_read_only["ice_estado_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["ice_id_" + iNumLinha] = "on";
    ajax_read_only["ice_codigo_" + iNumLinha] = "on";
    ajax_read_only["ice_descripcion_" + iNumLinha] = "on";
    ajax_read_only["ice_tarifa_advaloren_" + iNumLinha] = "on";
    ajax_read_only["ice_tarifa_especifica_" + iNumLinha] = "on";
    ajax_read_only["ice_estado_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["ice_id_" + iNumLinha] = null;
    ajax_error_list["ice_codigo_" + iNumLinha] = null;
    ajax_error_list["ice_descripcion_" + iNumLinha] = null;
    ajax_error_list["ice_tarifa_advaloren_" + iNumLinha] = null;
    ajax_error_list["ice_tarifa_especifica_" + iNumLinha] = null;
    ajax_error_list["ice_estado_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "ice_id_": new Array(),
    "ice_codigo_": new Array(),
    "ice_descripcion_": new Array(),
    "ice_tarifa_advaloren_": new Array(),
    "ice_tarifa_especifica_": new Array(),
    "ice_estado_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["ice_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ice_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ice_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ice_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ice_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["ice_codigo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ice_codigo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ice_codigo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ice_codigo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ice_codigo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["ice_descripcion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ice_descripcion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ice_descripcion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ice_descripcion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ice_descripcion_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["ice_tarifa_advaloren_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ice_tarifa_advaloren_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ice_tarifa_advaloren_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ice_tarifa_advaloren_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ice_tarifa_advaloren_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["ice_tarifa_especifica_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ice_tarifa_especifica_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ice_tarifa_especifica_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ice_tarifa_especifica_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ice_tarifa_especifica_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["ice_estado_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ice_estado_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ice_estado_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ice_estado_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ice_estado_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ice_id_'])) ? $this->nmgp_cmp_readonly['ice_id_'] : 'on';
?>
    scAjaxFieldRead("ice_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ice_codigo_'])) ? $this->nmgp_cmp_readonly['ice_codigo_'] : 'off';
?>
    scAjaxFieldRead("ice_codigo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ice_descripcion_'])) ? $this->nmgp_cmp_readonly['ice_descripcion_'] : 'off';
?>
    scAjaxFieldRead("ice_descripcion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ice_tarifa_advaloren_'])) ? $this->nmgp_cmp_readonly['ice_tarifa_advaloren_'] : 'off';
?>
    scAjaxFieldRead("ice_tarifa_advaloren_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ice_tarifa_especifica_'])) ? $this->nmgp_cmp_readonly['ice_tarifa_especifica_'] : 'off';
?>
    scAjaxFieldRead("ice_tarifa_especifica_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ice_estado_'])) ? $this->nmgp_cmp_readonly['ice_estado_'] : 'off';
?>
    scAjaxFieldRead("ice_estado_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("ice_id_" + iSeq, "on");
    scAjaxFieldRead("ice_codigo_" + iSeq, "on");
    scAjaxFieldRead("ice_descripcion_" + iSeq, "on");
    scAjaxFieldRead("ice_tarifa_advaloren_" + iSeq, "on");
    scAjaxFieldRead("ice_tarifa_especifica_" + iSeq, "on");
    scAjaxFieldRead("ice_estado_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["ice_id_" + iRow] || "on" == ajax_error_count["ice_codigo_" + iRow] || "on" == ajax_error_count["ice_descripcion_" + iRow] || "on" == ajax_error_count["ice_tarifa_advaloren_" + iRow] || "on" == ajax_error_count["ice_tarifa_especifica_" + iRow] || "on" == ajax_error_count["ice_estado_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ice_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ice_codigo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ice_descripcion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ice_tarifa_advaloren_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ice_tarifa_especifica_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ice_estado_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["ice_id_" + iRow] && "off" == ajax_error_count["ice_codigo_" + iRow] && "off" == ajax_error_count["ice_descripcion_" + iRow] && "off" == ajax_error_count["ice_tarifa_advaloren_" + iRow] && "off" == ajax_error_count["ice_tarifa_especifica_" + iRow] && "off" == ajax_error_count["ice_estado_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["ice_id_" + iRow] = "off";
        ajax_error_count["ice_codigo_" + iRow] = "off";
        ajax_error_count["ice_descripcion_" + iRow] = "off";
        ajax_error_count["ice_tarifa_advaloren_" + iRow] = "off";
        ajax_error_count["ice_tarifa_especifica_" + iRow] = "off";
        ajax_error_count["ice_estado_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_ice_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_ice_codigo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_ice_descripcion_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_ice_tarifa_advaloren_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_ice_tarifa_especifica_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_ice_estado_" + iRow).removeClass("scFormErrorLine");
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("ice_tarifa_advaloren_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("ice_tarifa_especifica_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
