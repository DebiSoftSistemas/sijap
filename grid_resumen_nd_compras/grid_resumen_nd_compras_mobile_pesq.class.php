...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "nd_fecha";$Nm_datas[] = "nd_fecha_emison_docmod";$Nm_numeric[] = "nd_numero";$Nm_numeric[] = "pr_id";$Nm_numeric[] = "nd_iddocmod";$Nm_numeric[] = "nd_subtotal";$Nm_numeric[] = "nd_subtotal_iva";$Nm_numeric[] = "nd_valor_iva";$Nm_numeric[] = "nd_subtotal_cero";$Nm_numeric[] = "nd_subtotal_no_objeto";$Nm_numeric[] = "nd_subtotal_excento";$Nm_numeric[] = "nd_valor_ice";$Nm_numeric[] = "nd_total";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      <br><span id="id_hide_sc_field_0"  <?php echo $str_hide_sc_field_0?>><INPUT  type="text" id="SC_sc_field_0" name="sc_field_0" value="<?php echo NM_encode_input($sc_field_0) ?>" size="10" maxlength="10" class="scFilterObjectEven">
 </TD>
