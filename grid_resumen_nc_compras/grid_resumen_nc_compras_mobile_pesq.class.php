...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_nc_autorizacion"  <?php echo $str_hide_nc_autorizacion?>><?php
      if ($nc_autorizacion != "")
      {
      $nc_autorizacion_look = (is_string($nc_autorizacion) ? substr($this->Db->qstr($nc_autorizacion), 1, -1) : $nc_autorizacion); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_nc_secuencial_docmod"  <?php echo $str_hide_nc_secuencial_docmod?>><INPUT  type="text" id="SC_nc_secuencial_docmod" name="nc_secuencial_docmod" value="<?php echo NM_encode_input($nc_secuencial_docmod) ?>" size="50" maxlength="32767" class="scFilterObjectOdd">
 </TD>
