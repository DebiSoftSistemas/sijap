...
function scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="")
{
    ...
    if (isset($_SESSION['scriptcase']['blank_autorizar_liquidaciones_pendientes']['contr_erro']) && $_SESSION['scriptcase']['blank_autorizar_liquidaciones_pendientes']['contr_erro'] == 'on')
    {
