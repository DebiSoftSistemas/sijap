...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_lib_id' + iSeqRow).bind('blur', function() { sc_form_del_libretin_lib_id_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_del_libretin_lib_id_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_lib_punto_emision' + iSeqRow).bind('blur', function() { sc_form_del_libretin_lib_punto_emision_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_form_del_libretin_lib_punto_emision_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_lib_tipo_comprobante' + iSeqRow).bind('blur', function() { sc_form_del_libretin_lib_tipo_comprobante_onblur(this, iSeqRow) })
                                                  .bind('change', function() { sc_form_del_libretin_lib_tipo_comprobante_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_lib_secuencial' + iSeqRow).bind('blur', function() { sc_form_del_libretin_lib_secuencial_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_del_libretin_lib_secuencial_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_lib_disponibles' + iSeqRow).bind('blur', function() { sc_form_del_libretin_lib_disponibles_onblur(this, iSeqRow) })
                                             .bind('change', function() { sc_form_del_libretin_lib_disponibles_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_lib_utilizados' + iSeqRow).bind('blur', function() { sc_form_del_libretin_lib_utilizados_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_del_libretin_lib_utilizados_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_lib_desde' + iSeqRow).bind('blur', function() { sc_form_del_libretin_lib_desde_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_del_libretin_lib_desde_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_lib_hasta' + iSeqRow).bind('blur', function() { sc_form_del_libretin_lib_hasta_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_del_libretin_lib_hasta_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_lib_autorizacion' + iSeqRow).bind('blur', function() { sc_form_del_libretin_lib_autorizacion_onblur(this, iSeqRow) })
                                              .bind('change', function() { sc_form_del_libretin_lib_autorizacion_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_lib_fecha_caducidad' + iSeqRow).bind('blur', function() { sc_form_del_libretin_lib_fecha_caducidad_onblur(this, iSeqRow) })
                                                 .bind('change', function() { sc_form_del_libretin_lib_fecha_caducidad_onchange(this, iSeqRow) })
...
function sc_form_del_libretin_lib_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_libretin_lib_punto_emision_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_libretin_lib_tipo_comprobante_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_libretin_lib_secuencial_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_libretin_lib_disponibles_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_libretin_lib_utilizados_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_libretin_lib_desde_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_libretin_lib_hasta_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_libretin_lib_autorizacion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_libretin_lib_fecha_caducidad_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_form_del_libretin_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_lib_fecha_caducidad" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      setTimeout(function() { do_ajax_form_del_libretin_validate_lib_fecha_caducidad(iSeqRow); }, 200);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_del_libretin')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
