...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_del_libretin/form_del_libretin_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_del_libretin_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_del_libretin_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['recarga'];
}
if ('' != $this->lib_estado)
{
...
if ('' != $this->lib_tipo_libretin)
{
    ...
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['link_info']['remove_border']) {
...
<?php
 include_once("form_del_libretin_js0.php");
?>
<script type="text/javascript" src="<?php  echo $this->Ini->path_js . "/jsrsClient.js" ?>"> 
</script> 
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_del_libretin'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_del_libretin'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['btn_disabled']['']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['btn_disabled']['']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['btn_label']['']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['btn_label']['']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['btn_label'][''];
        }
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-5';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_lib_tipo_comprobante_label" id="hidden_field_label_lib_tipo_comprobante" style="<?php echo $sStyleHidden_lib_tipo_comprobante; ?>"><span id="id_label_lib_tipo_comprobante"><?php echo $this->nm_new_label['lib_tipo_comprobante']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['php_cmp_required']['lib_tipo_comprobante']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['php_cmp_required']['lib_tipo_comprobante'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_lib_punto_emision_label" id="hidden_field_label_lib_punto_emision" style="<?php echo $sStyleHidden_lib_punto_emision; ?>"><span id="id_label_lib_punto_emision"><?php echo $this->nm_new_label['lib_punto_emision']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['php_cmp_required']['lib_punto_emision']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['php_cmp_required']['lib_punto_emision'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_lib_punto_emision_line" id="hidden_field_data_lib_punto_emision" style="<?php echo $sStyleHidden_lib_punto_emision; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_lib_punto_emision_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_lib_tipo_libretin_label" id="hidden_field_label_lib_tipo_libretin" style="<?php echo $sStyleHidden_lib_tipo_libretin; ?>"><span id="id_label_lib_tipo_libretin"><?php echo $this->nm_new_label['lib_tipo_libretin']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['php_cmp_required']['lib_tipo_libretin']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['php_cmp_required']['lib_tipo_libretin'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_lib_tipo_libretin_line" id="hidden_field_data_lib_tipo_libretin" style="<?php echo $sStyleHidden_lib_tipo_libretin; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_lib_tipo_libretin_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="lib_tipo_libretin" value="<?php echo $this->form_encode_input($lib_tipo_libretin); ?>"><span id="id_ajax_label_lib_tipo_libretin"><?php echo nl2br($lib_tipo_libretin); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_lib_desde_label" id="hidden_field_label_lib_desde" style="<?php echo $sStyleHidden_lib_desde; ?>"><span id="id_label_lib_desde"><?php echo $this->nm_new_label['lib_desde']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['php_cmp_required']['lib_desde']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['php_cmp_required']['lib_desde'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_lib_hasta_label" id="hidden_field_label_lib_hasta" style="<?php echo $sStyleHidden_lib_hasta; ?>"><span id="id_label_lib_hasta"><?php echo $this->nm_new_label['lib_hasta']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['php_cmp_required']['lib_hasta']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['php_cmp_required']['lib_hasta'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_lib_secuencial_label" id="hidden_field_label_lib_secuencial" style="<?php echo $sStyleHidden_lib_secuencial; ?>"><span id="id_label_lib_secuencial"><?php echo $this->nm_new_label['lib_secuencial']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['php_cmp_required']['lib_secuencial']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['php_cmp_required']['lib_secuencial'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_lib_autorizacion_label" id="hidden_field_label_lib_autorizacion" style="<?php echo $sStyleHidden_lib_autorizacion; ?>"><span id="id_label_lib_autorizacion"><?php echo $this->nm_new_label['lib_autorizacion']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['php_cmp_required']['lib_autorizacion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['php_cmp_required']['lib_autorizacion'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_lib_fecha_caducidad_label" id="hidden_field_label_lib_fecha_caducidad" style="<?php echo $sStyleHidden_lib_fecha_caducidad; ?>"><span id="id_label_lib_fecha_caducidad"><?php echo $this->nm_new_label['lib_fecha_caducidad']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['php_cmp_required']['lib_fecha_caducidad']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['php_cmp_required']['lib_fecha_caducidad'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_lib_estado_label" id="hidden_field_label_lib_estado" style="<?php echo $sStyleHidden_lib_estado; ?>"><span id="id_label_lib_estado"><?php echo $this->nm_new_label['lib_estado']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['php_cmp_required']['lib_estado']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['php_cmp_required']['lib_estado'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_lib_estado_line" id="hidden_field_data_lib_estado" style="<?php echo $sStyleHidden_lib_estado; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_lib_estado_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="lib_estado" value="<?php echo $this->form_encode_input($lib_estado); ?>"><span id="id_ajax_label_lib_estado"><?php echo nl2br($lib_estado); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_lib_disponibles_label" id="hidden_field_label_lib_disponibles" style="<?php echo $sStyleHidden_lib_disponibles; ?>"><span id="id_label_lib_disponibles"><?php echo $this->nm_new_label['lib_disponibles']; ?></span></TD>
    <TD class="scFormDataOdd css_lib_disponibles_line" id="hidden_field_data_lib_disponibles" style="<?php echo $sStyleHidden_lib_disponibles; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_lib_disponibles_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="lib_disponibles" value="<?php echo $this->form_encode_input($lib_disponibles); ?>"><span id="id_ajax_label_lib_disponibles"><?php echo nl2br($lib_disponibles); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_lib_utilizados_label" id="hidden_field_label_lib_utilizados" style="<?php echo $sStyleHidden_lib_utilizados; ?>"><span id="id_label_lib_utilizados"><?php echo $this->nm_new_label['lib_utilizados']; ?></span></TD>
    <TD class="scFormDataOdd css_lib_utilizados_line" id="hidden_field_data_lib_utilizados" style="<?php echo $sStyleHidden_lib_utilizados; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_lib_utilizados_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="lib_utilizados" value="<?php echo $this->form_encode_input($lib_utilizados); ?>"><span id="id_ajax_label_lib_utilizados"><?php echo nl2br($lib_utilizados); ?></span>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_del_libretin");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_del_libretin");
 parent.scAjaxDetailHeight("form_del_libretin", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
