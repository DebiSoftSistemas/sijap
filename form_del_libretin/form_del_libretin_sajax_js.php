  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_libretin" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_libretin_form();
	}
...
?>
  ...
  // ---------- Validate lib_id
  function do_ajax_form_del_libretin_validate_lib_id()
  {
    var nomeCampo_lib_id = "lib_id";
    var var_lib_id = scAjaxGetFieldHidden(nomeCampo_lib_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_libretin_validate_lib_id(var_lib_id, var_script_case_init, do_ajax_form_del_libretin_validate_lib_id_cb);
  } // do_ajax_form_del_libretin_validate_lib_id

  function do_ajax_form_del_libretin_validate_lib_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_libretin_validate_lib_id_cb

  // ---------- Validate lib_tipo_comprobante
  function do_ajax_form_del_libretin_validate_lib_tipo_comprobante()
  {
    var nomeCampo_lib_tipo_comprobante = "lib_tipo_comprobante";
    var var_lib_tipo_comprobante = scAjaxGetFieldSelect(nomeCampo_lib_tipo_comprobante);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_libretin_validate_lib_tipo_comprobante(var_lib_tipo_comprobante, var_script_case_init, do_ajax_form_del_libretin_validate_lib_tipo_comprobante_cb);
  } // do_ajax_form_del_libretin_validate_lib_tipo_comprobante

  function do_ajax_form_del_libretin_validate_lib_tipo_comprobante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "lib_tipo_comprobante";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_libretin_validate_lib_tipo_comprobante_cb

  // ---------- Validate lib_punto_emision
  function do_ajax_form_del_libretin_validate_lib_punto_emision()
  {
    var nomeCampo_lib_punto_emision = "lib_punto_emision";
    var var_lib_punto_emision = scAjaxGetFieldSelect(nomeCampo_lib_punto_emision);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_libretin_validate_lib_punto_emision(var_lib_punto_emision, var_script_case_init, do_ajax_form_del_libretin_validate_lib_punto_emision_cb);
  } // do_ajax_form_del_libretin_validate_lib_punto_emision

  function do_ajax_form_del_libretin_validate_lib_punto_emision_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "lib_punto_emision";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_libretin_validate_lib_punto_emision_cb

  // ---------- Validate lib_tipo_libretin
  function do_ajax_form_del_libretin_validate_lib_tipo_libretin()
  {
    var nomeCampo_lib_tipo_libretin = "lib_tipo_libretin";
    var var_lib_tipo_libretin = scAjaxGetFieldHidden(nomeCampo_lib_tipo_libretin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_libretin_validate_lib_tipo_libretin(var_lib_tipo_libretin, var_script_case_init, do_ajax_form_del_libretin_validate_lib_tipo_libretin_cb);
  } // do_ajax_form_del_libretin_validate_lib_tipo_libretin

  function do_ajax_form_del_libretin_validate_lib_tipo_libretin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "lib_tipo_libretin";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_libretin_validate_lib_tipo_libretin_cb

  // ---------- Validate lib_desde
  function do_ajax_form_del_libretin_validate_lib_desde()
  {
    var nomeCampo_lib_desde = "lib_desde";
    var var_lib_desde = scAjaxGetFieldText(nomeCampo_lib_desde);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_libretin_validate_lib_desde(var_lib_desde, var_script_case_init, do_ajax_form_del_libretin_validate_lib_desde_cb);
  } // do_ajax_form_del_libretin_validate_lib_desde

  function do_ajax_form_del_libretin_validate_lib_desde_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "lib_desde";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_libretin_validate_lib_desde_cb

  // ---------- Validate lib_hasta
  function do_ajax_form_del_libretin_validate_lib_hasta()
  {
    var nomeCampo_lib_hasta = "lib_hasta";
    var var_lib_hasta = scAjaxGetFieldText(nomeCampo_lib_hasta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_libretin_validate_lib_hasta(var_lib_hasta, var_script_case_init, do_ajax_form_del_libretin_validate_lib_hasta_cb);
  } // do_ajax_form_del_libretin_validate_lib_hasta

  function do_ajax_form_del_libretin_validate_lib_hasta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "lib_hasta";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_libretin_validate_lib_hasta_cb

  // ---------- Validate lib_secuencial
  function do_ajax_form_del_libretin_validate_lib_secuencial()
  {
    var nomeCampo_lib_secuencial = "lib_secuencial";
    var var_lib_secuencial = scAjaxGetFieldText(nomeCampo_lib_secuencial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_libretin_validate_lib_secuencial(var_lib_secuencial, var_script_case_init, do_ajax_form_del_libretin_validate_lib_secuencial_cb);
  } // do_ajax_form_del_libretin_validate_lib_secuencial

  function do_ajax_form_del_libretin_validate_lib_secuencial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "lib_secuencial";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_libretin_validate_lib_secuencial_cb

  // ---------- Validate lib_autorizacion
  function do_ajax_form_del_libretin_validate_lib_autorizacion()
  {
    var nomeCampo_lib_autorizacion = "lib_autorizacion";
    var var_lib_autorizacion = scAjaxGetFieldText(nomeCampo_lib_autorizacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_libretin_validate_lib_autorizacion(var_lib_autorizacion, var_script_case_init, do_ajax_form_del_libretin_validate_lib_autorizacion_cb);
  } // do_ajax_form_del_libretin_validate_lib_autorizacion

  function do_ajax_form_del_libretin_validate_lib_autorizacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "lib_autorizacion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_libretin_validate_lib_autorizacion_cb

  // ---------- Validate lib_fecha_caducidad
  function do_ajax_form_del_libretin_validate_lib_fecha_caducidad()
  {
    var nomeCampo_lib_fecha_caducidad = "lib_fecha_caducidad";
    var var_lib_fecha_caducidad = scAjaxGetFieldText(nomeCampo_lib_fecha_caducidad);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() {
      var var_lib_fecha_caducidad = scAjaxGetFieldText(nomeCampo_lib_fecha_caducidad);
      x_ajax_form_del_libretin_validate_lib_fecha_caducidad(var_lib_fecha_caducidad, var_script_case_init, do_ajax_form_del_libretin_validate_lib_fecha_caducidad_cb);
    }, 200);
  } // do_ajax_form_del_libretin_validate_lib_fecha_caducidad

  function do_ajax_form_del_libretin_validate_lib_fecha_caducidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "lib_fecha_caducidad";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_libretin_validate_lib_fecha_caducidad_cb

  // ---------- Validate lib_estado
  function do_ajax_form_del_libretin_validate_lib_estado()
  {
    var nomeCampo_lib_estado = "lib_estado";
    var var_lib_estado = scAjaxGetFieldHidden(nomeCampo_lib_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_libretin_validate_lib_estado(var_lib_estado, var_script_case_init, do_ajax_form_del_libretin_validate_lib_estado_cb);
  } // do_ajax_form_del_libretin_validate_lib_estado

  function do_ajax_form_del_libretin_validate_lib_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "lib_estado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_libretin_validate_lib_estado_cb

  // ---------- Validate lib_disponibles
  function do_ajax_form_del_libretin_validate_lib_disponibles()
  {
    var nomeCampo_lib_disponibles = "lib_disponibles";
    var var_lib_disponibles = scAjaxGetFieldHidden(nomeCampo_lib_disponibles);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_libretin_validate_lib_disponibles(var_lib_disponibles, var_script_case_init, do_ajax_form_del_libretin_validate_lib_disponibles_cb);
  } // do_ajax_form_del_libretin_validate_lib_disponibles

  function do_ajax_form_del_libretin_validate_lib_disponibles_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "lib_disponibles";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_libretin_validate_lib_disponibles_cb

  // ---------- Validate lib_utilizados
  function do_ajax_form_del_libretin_validate_lib_utilizados()
  {
    var nomeCampo_lib_utilizados = "lib_utilizados";
    var var_lib_utilizados = scAjaxGetFieldHidden(nomeCampo_lib_utilizados);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_libretin_validate_lib_utilizados(var_lib_utilizados, var_script_case_init, do_ajax_form_del_libretin_validate_lib_utilizados_cb);
  } // do_ajax_form_del_libretin_validate_lib_utilizados

  function do_ajax_form_del_libretin_validate_lib_utilizados_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "lib_utilizados";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_libretin_validate_lib_utilizados_cb

  // ---------- Event onblur lib_tipo_libretin
  function do_ajax_form_del_libretin_event_lib_tipo_libretin_onblur()
  {
    var var_lib_tipo_libretin = scAjaxGetFieldHidden("lib_tipo_libretin");
    var var_lib_desde = scAjaxGetFieldText("lib_desde");
    var var_lib_hasta = scAjaxGetFieldText("lib_hasta");
    var var_lib_secuencial = scAjaxGetFieldText("lib_secuencial");
    var var_lib_autorizacion = scAjaxGetFieldText("lib_autorizacion");
    var var_lib_disponibles = scAjaxGetFieldHidden("lib_disponibles");
    var var_lib_utilizados = scAjaxGetFieldHidden("lib_utilizados");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_libretin_event_lib_tipo_libretin_onblur(var_lib_tipo_libretin, var_lib_desde, var_lib_hasta, var_lib_secuencial, var_lib_autorizacion, var_lib_disponibles, var_lib_utilizados, var_script_case_init, do_ajax_form_del_libretin_event_lib_tipo_libretin_onblur_cb);
  } // do_ajax_form_del_libretin_event_lib_tipo_libretin_onblur

  function do_ajax_form_del_libretin_event_lib_tipo_libretin_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "lib_tipo_libretin";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_libretin_event_lib_tipo_libretin_onblur_cb_after_alert);
  } // do_ajax_form_del_libretin_event_lib_tipo_libretin_onblur_cb
  function do_ajax_form_del_libretin_event_lib_tipo_libretin_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_libretin_event_lib_tipo_libretin_onblur_cb_after_alert

  // ---------- Event onchange lib_tipo_libretin
  function do_ajax_form_del_libretin_event_lib_tipo_libretin_onchange()
  {
    var var_lib_tipo_libretin = scAjaxGetFieldHidden("lib_tipo_libretin");
    var var_lib_desde = scAjaxGetFieldText("lib_desde");
    var var_lib_hasta = scAjaxGetFieldText("lib_hasta");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_libretin_event_lib_tipo_libretin_onchange(var_lib_tipo_libretin, var_lib_desde, var_lib_hasta, var_lib_secuencial, var_lib_autorizacion, var_lib_disponibles, var_lib_utilizados, var_script_case_init, do_ajax_form_del_libretin_event_lib_tipo_libretin_onchange_cb);
  } // do_ajax_form_del_libretin_event_lib_tipo_libretin_onchange

  function do_ajax_form_del_libretin_event_lib_tipo_libretin_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "lib_tipo_libretin";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_libretin_event_lib_tipo_libretin_onchange_cb_after_alert);
  } // do_ajax_form_del_libretin_event_lib_tipo_libretin_onchange_cb
  function do_ajax_form_del_libretin_event_lib_tipo_libretin_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_libretin_event_lib_tipo_libretin_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_libretin_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_libretin_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_lib_id = scAjaxGetFieldHidden("lib_id");
    var var_lib_tipo_comprobante = scAjaxGetFieldSelect("lib_tipo_comprobante");
    var var_lib_punto_emision = scAjaxGetFieldSelect("lib_punto_emision");
    var var_lib_tipo_libretin = scAjaxGetFieldHidden("lib_tipo_libretin");
    var var_lib_desde = scAjaxGetFieldText("lib_desde");
    var var_lib_hasta = scAjaxGetFieldText("lib_hasta");
    var var_lib_secuencial = scAjaxGetFieldText("lib_secuencial");
    var var_lib_autorizacion = scAjaxGetFieldText("lib_autorizacion");
    var var_lib_fecha_caducidad = scAjaxGetFieldText("lib_fecha_caducidad");
    var var_lib_estado = scAjaxGetFieldHidden("lib_estado");
    var var_lib_disponibles = scAjaxGetFieldHidden("lib_disponibles");
    var var_lib_utilizados = scAjaxGetFieldHidden("lib_utilizados");
    ...
    scAjaxProcOn();
    x_ajax_form_del_libretin_submit_form(var_lib_id, var_lib_tipo_comprobante, var_lib_punto_emision, var_lib_tipo_libretin, var_lib_desde, var_lib_hasta, var_lib_secuencial, var_lib_autorizacion, var_lib_fecha_caducidad, var_lib_estado, var_lib_disponibles, var_lib_utilizados, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_libretin_submit_form_cb);
  } // do_ajax_form_del_libretin_submit_form

  function do_ajax_form_del_libretin_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("lib_id");
      scAjaxHideErrorDisplay("lib_tipo_comprobante");
      scAjaxHideErrorDisplay("lib_punto_emision");
      scAjaxHideErrorDisplay("lib_tipo_libretin");
      scAjaxHideErrorDisplay("lib_desde");
      scAjaxHideErrorDisplay("lib_hasta");
      scAjaxHideErrorDisplay("lib_secuencial");
      scAjaxHideErrorDisplay("lib_autorizacion");
      scAjaxHideErrorDisplay("lib_fecha_caducidad");
      scAjaxHideErrorDisplay("lib_estado");
      scAjaxHideErrorDisplay("lib_disponibles");
      scAjaxHideErrorDisplay("lib_utilizados");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_libretin_submit_form_cb_after_alert);
  } // do_ajax_form_del_libretin_submit_form_cb
  function do_ajax_form_del_libretin_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_libretin_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_libretin_navigate_form()
  {
    perform_ajax_form_del_libretin_navigate_form();
  }

  function perform_ajax_form_del_libretin_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("lib_disponibles");
    scAjaxHideErrorDisplay("lib_utilizados");
    var var_lib_id = document.F2.lib_id.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_libretin_navigate_form(var_lib_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_libretin_navigate_form_cb);
  } // do_ajax_form_del_libretin_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_libretin_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.lib_id.value = scAjaxGetKeyValue("lib_id");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_libretin_navigate_form_cb_after_alert);
  } // do_ajax_form_del_libretin_navigate_form_cb
  function do_ajax_form_del_libretin_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_del_libretin_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_libretin_navigate_form_cb_after_alert

  function sc_hide_form_del_libretin_form()
  {
  ...
  ajax_field_list[0] = "lib_id";
  ajax_field_list[1] = "lib_tipo_comprobante";
  ajax_field_list[2] = "lib_punto_emision";
  ajax_field_list[3] = "lib_tipo_libretin";
  ajax_field_list[4] = "lib_desde";
  ajax_field_list[5] = "lib_hasta";
  ajax_field_list[6] = "lib_secuencial";
  ajax_field_list[7] = "lib_autorizacion";
  ajax_field_list[8] = "lib_fecha_caducidad";
  ajax_field_list[9] = "lib_estado";
  ajax_field_list[10] = "lib_disponibles";
  ajax_field_list[11] = "lib_utilizados";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "lib_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "lib_tipo_comprobante": {"label": "<?php echo $this->Ini->Nm_lang['lang_tipo_comprobante'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "lib_punto_emision": {"label": "<?php echo $this->Ini->Nm_lang['lang_punto_emision'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "lib_tipo_libretin": {"label": "<?php echo $this->Ini->Nm_lang['lang_tipo_libretin'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "lib_desde": {"label": "<?php echo $this->Ini->Nm_lang['lang_desde'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "lib_hasta": {"label": "<?php echo $this->Ini->Nm_lang['lang_hasta'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "lib_secuencial": {"label": "<?php echo $this->Ini->Nm_lang['lang_secuencial'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "lib_autorizacion": {"label": "<?php echo $this->Ini->Nm_lang['lang_autorizacion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "lib_fecha_caducidad": {"label": "<?php echo $this->Ini->Nm_lang['lang_fecha_caducidad'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "lib_estado": {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "lib_disponibles": {"label": "<?php echo $this->Ini->Nm_lang['lang_chart_available'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "lib_utilizados": {"label": "<?php echo $this->Ini->Nm_lang['lang_utilizados'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "lib_id": new Array(),
    "lib_tipo_comprobante": new Array(),
    "lib_punto_emision": new Array(),
    "lib_tipo_libretin": new Array(),
    "lib_desde": new Array(),
    "lib_hasta": new Array(),
    "lib_secuencial": new Array(),
    "lib_autorizacion": new Array(),
    "lib_fecha_caducidad": new Array(),
    "lib_estado": new Array(),
    "lib_disponibles": new Array(),
    "lib_utilizados": new Array()
  };
  ajax_field_mult["lib_id"][1] = "lib_id";
  ajax_field_mult["lib_tipo_comprobante"][1] = "lib_tipo_comprobante";
  ajax_field_mult["lib_punto_emision"][1] = "lib_punto_emision";
  ajax_field_mult["lib_tipo_libretin"][1] = "lib_tipo_libretin";
  ajax_field_mult["lib_desde"][1] = "lib_desde";
  ajax_field_mult["lib_hasta"][1] = "lib_hasta";
  ajax_field_mult["lib_secuencial"][1] = "lib_secuencial";
  ajax_field_mult["lib_autorizacion"][1] = "lib_autorizacion";
  ajax_field_mult["lib_fecha_caducidad"][1] = "lib_fecha_caducidad";
  ajax_field_mult["lib_estado"][1] = "lib_estado";
  ajax_field_mult["lib_disponibles"][1] = "lib_disponibles";
  ajax_field_mult["lib_utilizados"][1] = "lib_utilizados";

  var ajax_field_id = {
    "lib_tipo_comprobante": new Array("hidden_field_label_lib_tipo_comprobante", "hidden_field_data_lib_tipo_comprobante"),
    "lib_punto_emision": new Array("hidden_field_label_lib_punto_emision", "hidden_field_data_lib_punto_emision"),
    "lib_tipo_libretin": new Array("hidden_field_label_lib_tipo_libretin", "hidden_field_data_lib_tipo_libretin"),
    "lib_desde": new Array("hidden_field_label_lib_desde", "hidden_field_data_lib_desde"),
    "lib_hasta": new Array("hidden_field_label_lib_hasta", "hidden_field_data_lib_hasta"),
    "lib_secuencial": new Array("hidden_field_label_lib_secuencial", "hidden_field_data_lib_secuencial"),
    "lib_autorizacion": new Array("hidden_field_label_lib_autorizacion", "hidden_field_data_lib_autorizacion"),
    "lib_fecha_caducidad": new Array("hidden_field_label_lib_fecha_caducidad", "hidden_field_data_lib_fecha_caducidad"),
    "lib_estado": new Array("hidden_field_label_lib_estado", "hidden_field_data_lib_estado")
  };

  var ajax_read_only = {
    "lib_id": "on",
    "lib_tipo_comprobante": "off",
    "lib_punto_emision": "off",
    "lib_tipo_libretin": "off",
    "lib_desde": "off",
    "lib_hasta": "off",
    "lib_secuencial": "off",
    "lib_autorizacion": "off",
    "lib_fecha_caducidad": "off",
    "lib_estado": "off",
    "lib_disponibles": "off",
    "lib_utilizados": "off"
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("lib_tipo_comprobante" == sIndex)
    {
