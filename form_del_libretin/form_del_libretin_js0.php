<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="lib_id" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['lib_id']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_del_libretin"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin']['where_detal']))
  {
?>  
...
function lookup_lib_estado(campo)
{
   dados  = document.F1.lib_estado.value;
   jsrsExecute("<?php  echo $this->Ini->path_link . SC_dir_app_name('form_del_libretin')?>/form_del_libretin.php?script_case_init=<?php echo $this->form_encode_input($this->Ini->sc_page); ?>&nmgp_opcao=lookup", recebe_lib_estado, "lib_estado", dados, false);
}
function recebe_lib_estado(string)
{
   document.getElementById('id_lookup_lib_estado').innerHTML = string;
}
function lookup_lib_tipo_libretin(campo)
{
   dados  = document.F1.lib_tipo_libretin.value;
   jsrsExecute("<?php  echo $this->Ini->path_link . SC_dir_app_name('form_del_libretin')?>/form_del_libretin.php?script_case_init=<?php echo $this->form_encode_input($this->Ini->sc_page); ?>&nmgp_opcao=lookup", recebe_lib_tipo_libretin, "lib_tipo_libretin", dados, false);
}
function recebe_lib_tipo_libretin(string)
{
   document.getElementById('id_lookup_lib_tipo_libretin').innerHTML = string;
}
<?php 
