  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_jap_anular_contrato" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_jap_anular_contrato_form();
	}
...
?>
  ...
  function do_ajax_form_jap_anular_contrato_validate_con_motivo_anulacion()
  {
    ...
    x_ajax_form_jap_anular_contrato_validate_con_motivo_anulacion(var_con_motivo_anulacion, var_script_case_init, do_ajax_form_jap_anular_contrato_validate_con_motivo_anulacion_cb);
  } // do_ajax_form_jap_anular_contrato_validate_con_motivo_anulacion

  function do_ajax_form_jap_anular_contrato_validate_con_motivo_anulacion_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_validate_con_motivo_anulacion_cb

  // ---------- Validate con_fecha
  function do_ajax_form_jap_anular_contrato_validate_con_fecha()
  {
    var nomeCampo_con_fecha = "con_fecha";
    var var_con_fecha = scAjaxGetFieldHidden(nomeCampo_con_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_anular_contrato_validate_con_fecha(var_con_fecha, var_script_case_init, do_ajax_form_jap_anular_contrato_validate_con_fecha_cb);
  } // do_ajax_form_jap_anular_contrato_validate_con_fecha

  function do_ajax_form_jap_anular_contrato_validate_con_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_validate_con_fecha_cb

  // ---------- Validate con_sino
  function do_ajax_form_jap_anular_contrato_validate_con_sino()
  {
    var nomeCampo_con_sino = "con_sino";
    var var_con_sino = scAjaxGetFieldText(nomeCampo_con_sino);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_anular_contrato_validate_con_sino(var_con_sino, var_script_case_init, do_ajax_form_jap_anular_contrato_validate_con_sino_cb);
  } // do_ajax_form_jap_anular_contrato_validate_con_sino

  function do_ajax_form_jap_anular_contrato_validate_con_sino_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_validate_con_sino_cb

  // ---------- Validate con_id
  function do_ajax_form_jap_anular_contrato_validate_con_id()
  {
    var nomeCampo_con_id = "con_id";
    var var_con_id = scAjaxGetFieldHidden(nomeCampo_con_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_anular_contrato_validate_con_id(var_con_id, var_script_case_init, do_ajax_form_jap_anular_contrato_validate_con_id_cb);
  } // do_ajax_form_jap_anular_contrato_validate_con_id

  function do_ajax_form_jap_anular_contrato_validate_con_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "con_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_validate_con_id_cb

  // ---------- Validate con_numero_contrato
  function do_ajax_form_jap_anular_contrato_validate_con_numero_contrato()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_anular_contrato_validate_con_numero_contrato(var_con_numero_contrato, var_script_case_init, do_ajax_form_jap_anular_contrato_validate_con_numero_contrato_cb);
  } // do_ajax_form_jap_anular_contrato_validate_con_numero_contrato

  function do_ajax_form_jap_anular_contrato_validate_con_numero_contrato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_validate_con_numero_contrato_cb

  // ---------- Validate con_tipo_contrato
  function do_ajax_form_jap_anular_contrato_validate_con_tipo_contrato()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_anular_contrato_validate_con_tipo_contrato(var_con_tipo_contrato, var_script_case_init, do_ajax_form_jap_anular_contrato_validate_con_tipo_contrato_cb);
  } // do_ajax_form_jap_anular_contrato_validate_con_tipo_contrato

  function do_ajax_form_jap_anular_contrato_validate_con_tipo_contrato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_validate_con_tipo_contrato_cb

  // ---------- Validate con_propietario
  function do_ajax_form_jap_anular_contrato_validate_con_propietario()
  {
    var nomeCampo_con_propietario = "con_propietario";
    var var_con_propietario = scAjaxGetFieldHidden(nomeCampo_con_propietario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_anular_contrato_validate_con_propietario(var_con_propietario, var_script_case_init, do_ajax_form_jap_anular_contrato_validate_con_propietario_cb);
  } // do_ajax_form_jap_anular_contrato_validate_con_propietario

  function do_ajax_form_jap_anular_contrato_validate_con_propietario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_validate_con_propietario_cb

  // ---------- Validate con_nombre
  function do_ajax_form_jap_anular_contrato_validate_con_nombre()
  {
    var nomeCampo_con_nombre = "con_nombre";
    var var_con_nombre = scAjaxGetFieldHidden(nomeCampo_con_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_anular_contrato_validate_con_nombre(var_con_nombre, var_script_case_init, do_ajax_form_jap_anular_contrato_validate_con_nombre_cb);
  } // do_ajax_form_jap_anular_contrato_validate_con_nombre

  function do_ajax_form_jap_anular_contrato_validate_con_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_validate_con_nombre_cb

  // ---------- Validate con_cedula
  function do_ajax_form_jap_anular_contrato_validate_con_cedula()
  {
    var nomeCampo_con_cedula = "con_cedula";
    var var_con_cedula = scAjaxGetFieldHidden(nomeCampo_con_cedula);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_anular_contrato_validate_con_cedula(var_con_cedula, var_script_case_init, do_ajax_form_jap_anular_contrato_validate_con_cedula_cb);
  } // do_ajax_form_jap_anular_contrato_validate_con_cedula

  function do_ajax_form_jap_anular_contrato_validate_con_cedula_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_validate_con_cedula_cb

  // ---------- Validate con_telefono
  function do_ajax_form_jap_anular_contrato_validate_con_telefono()
  {
    var nomeCampo_con_telefono = "con_telefono";
    var var_con_telefono = scAjaxGetFieldHidden(nomeCampo_con_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_anular_contrato_validate_con_telefono(var_con_telefono, var_script_case_init, do_ajax_form_jap_anular_contrato_validate_con_telefono_cb);
  } // do_ajax_form_jap_anular_contrato_validate_con_telefono

  function do_ajax_form_jap_anular_contrato_validate_con_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_validate_con_telefono_cb

  // ---------- Validate con_celular
  function do_ajax_form_jap_anular_contrato_validate_con_celular()
  {
    var nomeCampo_con_celular = "con_celular";
    var var_con_celular = scAjaxGetFieldHidden(nomeCampo_con_celular);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_anular_contrato_validate_con_celular(var_con_celular, var_script_case_init, do_ajax_form_jap_anular_contrato_validate_con_celular_cb);
  } // do_ajax_form_jap_anular_contrato_validate_con_celular

  function do_ajax_form_jap_anular_contrato_validate_con_celular_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_validate_con_celular_cb

  // ---------- Validate con_direccion_propietario
  function do_ajax_form_jap_anular_contrato_validate_con_direccion_propietario()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_anular_contrato_validate_con_direccion_propietario(var_con_direccion_propietario, var_script_case_init, do_ajax_form_jap_anular_contrato_validate_con_direccion_propietario_cb);
  } // do_ajax_form_jap_anular_contrato_validate_con_direccion_propietario

  function do_ajax_form_jap_anular_contrato_validate_con_direccion_propietario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_validate_con_direccion_propietario_cb

  // ---------- Validate con_correo
  function do_ajax_form_jap_anular_contrato_validate_con_correo()
  {
    var nomeCampo_con_correo = "con_correo";
    var var_con_correo = scAjaxGetFieldHidden(nomeCampo_con_correo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_anular_contrato_validate_con_correo(var_con_correo, var_script_case_init, do_ajax_form_jap_anular_contrato_validate_con_correo_cb);
  } // do_ajax_form_jap_anular_contrato_validate_con_correo

  function do_ajax_form_jap_anular_contrato_validate_con_correo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_validate_con_correo_cb

  // ---------- Validate con_estado
  function do_ajax_form_jap_anular_contrato_validate_con_estado()
  {
    var nomeCampo_con_estado = "con_estado";
    var var_con_estado = scAjaxGetFieldHidden(nomeCampo_con_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_anular_contrato_validate_con_estado(var_con_estado, var_script_case_init, do_ajax_form_jap_anular_contrato_validate_con_estado_cb);
  } // do_ajax_form_jap_anular_contrato_validate_con_estado

  function do_ajax_form_jap_anular_contrato_validate_con_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_validate_con_estado_cb

  // ---------- Validate con_pais
  function do_ajax_form_jap_anular_contrato_validate_con_pais()
  {
    var nomeCampo_con_pais = "con_pais";
    var var_con_pais = scAjaxGetFieldSelect(nomeCampo_con_pais);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_anular_contrato_validate_con_pais(var_con_pais, var_script_case_init, do_ajax_form_jap_anular_contrato_validate_con_pais_cb);
  } // do_ajax_form_jap_anular_contrato_validate_con_pais

  function do_ajax_form_jap_anular_contrato_validate_con_pais_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_validate_con_pais_cb

  // ---------- Validate con_provincia
  function do_ajax_form_jap_anular_contrato_validate_con_provincia()
  {
    var nomeCampo_con_provincia = "con_provincia";
    var var_con_provincia = scAjaxGetFieldSelect(nomeCampo_con_provincia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_anular_contrato_validate_con_provincia(var_con_provincia, var_script_case_init, do_ajax_form_jap_anular_contrato_validate_con_provincia_cb);
  } // do_ajax_form_jap_anular_contrato_validate_con_provincia

  function do_ajax_form_jap_anular_contrato_validate_con_provincia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_validate_con_provincia_cb

  // ---------- Validate con_canton
  function do_ajax_form_jap_anular_contrato_validate_con_canton()
  {
    var nomeCampo_con_canton = "con_canton";
    var var_con_canton = scAjaxGetFieldSelect(nomeCampo_con_canton);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_anular_contrato_validate_con_canton(var_con_canton, var_script_case_init, do_ajax_form_jap_anular_contrato_validate_con_canton_cb);
  } // do_ajax_form_jap_anular_contrato_validate_con_canton

  function do_ajax_form_jap_anular_contrato_validate_con_canton_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_validate_con_canton_cb

  // ---------- Validate con_parroquia
  function do_ajax_form_jap_anular_contrato_validate_con_parroquia()
  {
    var nomeCampo_con_parroquia = "con_parroquia";
    var var_con_parroquia = scAjaxGetFieldSelect(nomeCampo_con_parroquia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_anular_contrato_validate_con_parroquia(var_con_parroquia, var_script_case_init, do_ajax_form_jap_anular_contrato_validate_con_parroquia_cb);
  } // do_ajax_form_jap_anular_contrato_validate_con_parroquia

  function do_ajax_form_jap_anular_contrato_validate_con_parroquia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_validate_con_parroquia_cb

  // ---------- Validate con_comunidad
  function do_ajax_form_jap_anular_contrato_validate_con_comunidad()
  {
    var nomeCampo_con_comunidad = "con_comunidad";
    var var_con_comunidad = scAjaxGetFieldSelect(nomeCampo_con_comunidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_anular_contrato_validate_con_comunidad(var_con_comunidad, var_script_case_init, do_ajax_form_jap_anular_contrato_validate_con_comunidad_cb);
  } // do_ajax_form_jap_anular_contrato_validate_con_comunidad

  function do_ajax_form_jap_anular_contrato_validate_con_comunidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_validate_con_comunidad_cb

  // ---------- Validate con_sector
  function do_ajax_form_jap_anular_contrato_validate_con_sector()
  {
    var nomeCampo_con_sector = "con_sector";
    var var_con_sector = scAjaxGetFieldSelect(nomeCampo_con_sector);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_anular_contrato_validate_con_sector(var_con_sector, var_script_case_init, do_ajax_form_jap_anular_contrato_validate_con_sector_cb);
  } // do_ajax_form_jap_anular_contrato_validate_con_sector

  function do_ajax_form_jap_anular_contrato_validate_con_sector_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_validate_con_sector_cb

  // ---------- Validate con_numero_censo
  function do_ajax_form_jap_anular_contrato_validate_con_numero_censo()
  {
    var nomeCampo_con_numero_censo = "con_numero_censo";
    var var_con_numero_censo = scAjaxGetFieldText(nomeCampo_con_numero_censo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_anular_contrato_validate_con_numero_censo(var_con_numero_censo, var_script_case_init, do_ajax_form_jap_anular_contrato_validate_con_numero_censo_cb);
  } // do_ajax_form_jap_anular_contrato_validate_con_numero_censo

  function do_ajax_form_jap_anular_contrato_validate_con_numero_censo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_validate_con_numero_censo_cb

  // ---------- Validate con_direccion_predio
  function do_ajax_form_jap_anular_contrato_validate_con_direccion_predio()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_anular_contrato_validate_con_direccion_predio(var_con_direccion_predio, var_script_case_init, do_ajax_form_jap_anular_contrato_validate_con_direccion_predio_cb);
  } // do_ajax_form_jap_anular_contrato_validate_con_direccion_predio

  function do_ajax_form_jap_anular_contrato_validate_con_direccion_predio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_validate_con_direccion_predio_cb

  // ---------- Validate con_toma_administrativa
  function do_ajax_form_jap_anular_contrato_validate_con_toma_administrativa()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_anular_contrato_validate_con_toma_administrativa(var_con_toma_administrativa, var_script_case_init, do_ajax_form_jap_anular_contrato_validate_con_toma_administrativa_cb);
  } // do_ajax_form_jap_anular_contrato_validate_con_toma_administrativa

  function do_ajax_form_jap_anular_contrato_validate_con_toma_administrativa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_validate_con_toma_administrativa_cb

  // ---------- Validate con_toma_operativa
  function do_ajax_form_jap_anular_contrato_validate_con_toma_operativa()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_anular_contrato_validate_con_toma_operativa(var_con_toma_operativa, var_script_case_init, do_ajax_form_jap_anular_contrato_validate_con_toma_operativa_cb);
  } // do_ajax_form_jap_anular_contrato_validate_con_toma_operativa

  function do_ajax_form_jap_anular_contrato_validate_con_toma_operativa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_validate_con_toma_operativa_cb

  // ---------- Validate con_condicion_contrato
  function do_ajax_form_jap_anular_contrato_validate_con_condicion_contrato()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_anular_contrato_validate_con_condicion_contrato(var_con_condicion_contrato, var_script_case_init, do_ajax_form_jap_anular_contrato_validate_con_condicion_contrato_cb);
  } // do_ajax_form_jap_anular_contrato_validate_con_condicion_contrato

  function do_ajax_form_jap_anular_contrato_validate_con_condicion_contrato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_validate_con_condicion_contrato_cb

  // ---------- Validate con_tipo_servicio
  function do_ajax_form_jap_anular_contrato_validate_con_tipo_servicio()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_anular_contrato_validate_con_tipo_servicio(var_con_tipo_servicio, var_script_case_init, do_ajax_form_jap_anular_contrato_validate_con_tipo_servicio_cb);
  } // do_ajax_form_jap_anular_contrato_validate_con_tipo_servicio

  function do_ajax_form_jap_anular_contrato_validate_con_tipo_servicio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_validate_con_tipo_servicio_cb

  // ---------- Validate con_ruta
  function do_ajax_form_jap_anular_contrato_validate_con_ruta()
  {
    var nomeCampo_con_ruta = "con_ruta";
    var var_con_ruta = scAjaxGetFieldSelect(nomeCampo_con_ruta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_anular_contrato_validate_con_ruta(var_con_ruta, var_script_case_init, do_ajax_form_jap_anular_contrato_validate_con_ruta_cb);
  } // do_ajax_form_jap_anular_contrato_validate_con_ruta

  function do_ajax_form_jap_anular_contrato_validate_con_ruta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_validate_con_ruta_cb

  // ---------- Validate con_orden_lecturas
  function do_ajax_form_jap_anular_contrato_validate_con_orden_lecturas()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_anular_contrato_validate_con_orden_lecturas(var_con_orden_lecturas, var_script_case_init, do_ajax_form_jap_anular_contrato_validate_con_orden_lecturas_cb);
  } // do_ajax_form_jap_anular_contrato_validate_con_orden_lecturas

  function do_ajax_form_jap_anular_contrato_validate_con_orden_lecturas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_validate_con_orden_lecturas_cb

  // ---------- Validate con_numero_corte
  function do_ajax_form_jap_anular_contrato_validate_con_numero_corte()
  {
    var nomeCampo_con_numero_corte = "con_numero_corte";
    var var_con_numero_corte = scAjaxGetFieldText(nomeCampo_con_numero_corte);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_anular_contrato_validate_con_numero_corte(var_con_numero_corte, var_script_case_init, do_ajax_form_jap_anular_contrato_validate_con_numero_corte_cb);
  } // do_ajax_form_jap_anular_contrato_validate_con_numero_corte

  function do_ajax_form_jap_anular_contrato_validate_con_numero_corte_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_validate_con_numero_corte_cb

  // ---------- Validate con_fecha_instalacion
  function do_ajax_form_jap_anular_contrato_validate_con_fecha_instalacion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_anular_contrato_validate_con_fecha_instalacion(var_con_fecha_instalacion, var_script_case_init, do_ajax_form_jap_anular_contrato_validate_con_fecha_instalacion_cb);
  } // do_ajax_form_jap_anular_contrato_validate_con_fecha_instalacion

  function do_ajax_form_jap_anular_contrato_validate_con_fecha_instalacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_validate_con_fecha_instalacion_cb

  // ---------- Validate con_numero_medidor
  function do_ajax_form_jap_anular_contrato_validate_con_numero_medidor()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_anular_contrato_validate_con_numero_medidor(var_con_numero_medidor, var_script_case_init, do_ajax_form_jap_anular_contrato_validate_con_numero_medidor_cb);
  } // do_ajax_form_jap_anular_contrato_validate_con_numero_medidor

  function do_ajax_form_jap_anular_contrato_validate_con_numero_medidor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_validate_con_numero_medidor_cb

  // ---------- Validate con_maxima_lectura
  function do_ajax_form_jap_anular_contrato_validate_con_maxima_lectura()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_anular_contrato_validate_con_maxima_lectura(var_con_maxima_lectura, var_script_case_init, do_ajax_form_jap_anular_contrato_validate_con_maxima_lectura_cb);
  } // do_ajax_form_jap_anular_contrato_validate_con_maxima_lectura

  function do_ajax_form_jap_anular_contrato_validate_con_maxima_lectura_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_validate_con_maxima_lectura_cb

  // ---------- Validate con_lectura_actual
  function do_ajax_form_jap_anular_contrato_validate_con_lectura_actual()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_anular_contrato_validate_con_lectura_actual(var_con_lectura_actual, var_script_case_init, do_ajax_form_jap_anular_contrato_validate_con_lectura_actual_cb);
  } // do_ajax_form_jap_anular_contrato_validate_con_lectura_actual

  function do_ajax_form_jap_anular_contrato_validate_con_lectura_actual_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_validate_con_lectura_actual_cb

  // ---------- Validate con_fecha_lectura
  function do_ajax_form_jap_anular_contrato_validate_con_fecha_lectura()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_anular_contrato_validate_con_fecha_lectura(var_con_fecha_lectura, var_script_case_init, do_ajax_form_jap_anular_contrato_validate_con_fecha_lectura_cb);
  } // do_ajax_form_jap_anular_contrato_validate_con_fecha_lectura

  function do_ajax_form_jap_anular_contrato_validate_con_fecha_lectura_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_validate_con_fecha_lectura_cb

  // ---------- Validate con_observaciones
  function do_ajax_form_jap_anular_contrato_validate_con_observaciones()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_anular_contrato_validate_con_observaciones(var_con_observaciones, var_script_case_init, do_ajax_form_jap_anular_contrato_validate_con_observaciones_cb);
  } // do_ajax_form_jap_anular_contrato_validate_con_observaciones

  function do_ajax_form_jap_anular_contrato_validate_con_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_validate_con_observaciones_cb

  // ---------- Validate con_usuario_instala
  function do_ajax_form_jap_anular_contrato_validate_con_usuario_instala()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_anular_contrato_validate_con_usuario_instala(var_con_usuario_instala, var_script_case_init, do_ajax_form_jap_anular_contrato_validate_con_usuario_instala_cb);
  } // do_ajax_form_jap_anular_contrato_validate_con_usuario_instala

  function do_ajax_form_jap_anular_contrato_validate_con_usuario_instala_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_validate_con_usuario_instala_cb

  // ---------- Refresh con_pais
  function do_ajax_form_jap_anular_contrato_refresh_con_pais()
  {
    var var_con_pais = scAjaxGetFieldSelect("con_pais");
    var var_nmgp_refresh_fields = "con_tipo_servicio";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_jap_anular_contrato_refresh_con_pais(var_con_pais, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_jap_anular_contrato_refresh_con_pais_cb);
  } // do_ajax_form_jap_anular_contrato_refresh_con_pais

  function do_ajax_form_jap_anular_contrato_refresh_con_pais_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_refresh_con_pais_cb

  // ---------- Refresh con_provincia
  function do_ajax_form_jap_anular_contrato_refresh_con_provincia()
  {
    var var_con_provincia = scAjaxGetFieldSelect("con_provincia");
    var var_nmgp_refresh_fields = "con_condicion_contrato";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_jap_anular_contrato_refresh_con_provincia(var_con_provincia, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_jap_anular_contrato_refresh_con_provincia_cb);
  } // do_ajax_form_jap_anular_contrato_refresh_con_provincia

  function do_ajax_form_jap_anular_contrato_refresh_con_provincia_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_refresh_con_provincia_cb

  // ---------- Refresh con_canton
  function do_ajax_form_jap_anular_contrato_refresh_con_canton()
  {
    var var_con_canton = scAjaxGetFieldSelect("con_canton");
    var var_nmgp_refresh_fields = "con_parroquia";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_jap_anular_contrato_refresh_con_canton(var_con_canton, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_jap_anular_contrato_refresh_con_canton_cb);
  } // do_ajax_form_jap_anular_contrato_refresh_con_canton

  function do_ajax_form_jap_anular_contrato_refresh_con_canton_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_anular_contrato_refresh_con_canton_cb

  // ---------- Event onchange con_propietario
  function do_ajax_form_jap_anular_contrato_event_con_propietario_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_jap_anular_contrato_event_con_propietario_onchange(var_con_propietario, var_con_nombre, var_con_cedula, var_con_telefono, var_con_celular, var_con_direccion_propietario, var_con_correo, var_script_case_init, do_ajax_form_jap_anular_contrato_event_con_propietario_onchange_cb);
  } // do_ajax_form_jap_anular_contrato_event_con_propietario_onchange

  function do_ajax_form_jap_anular_contrato_event_con_propietario_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "con_propietario";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_jap_anular_contrato_event_con_propietario_onchange_cb_after_alert);
  } // do_ajax_form_jap_anular_contrato_event_con_propietario_onchange_cb
  function do_ajax_form_jap_anular_contrato_event_con_propietario_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_jap_anular_contrato_event_con_propietario_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_jap_anular_contrato_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_jap_anular_contrato_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_jap_anular_contrato_submit_form_cb_after_alert);
  } // do_ajax_form_jap_anular_contrato_submit_form_cb
  function do_ajax_form_jap_anular_contrato_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_jap_anular_contrato_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_jap_anular_contrato_navigate_form()
  {
    perform_ajax_form_jap_anular_contrato_navigate_form();
  }

  function perform_ajax_form_jap_anular_contrato_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_jap_anular_contrato_navigate_form(var_con_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jap_anular_contrato_navigate_form_cb);
  } // do_ajax_form_jap_anular_contrato_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_jap_anular_contrato_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_jap_anular_contrato_navigate_form_cb_after_alert);
  } // do_ajax_form_jap_anular_contrato_navigate_form_cb
  function do_ajax_form_jap_anular_contrato_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_jap_anular_contrato_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_jap_anular_contrato_navigate_form_cb_after_alert

  function sc_hide_form_jap_anular_contrato_form()
  {
  ...
  function do_ajax_form_jap_anular_contrato_lkpedt_refresh_con_pais()
  {
    var var_con_pais = scAjaxGetFieldSelect("con_pais");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "con_pais";
    x_ajax_form_jap_anular_contrato_lkpedt_refresh_con_pais(var_con_pais, nmgp_refresh_fields, var_script_case_init, do_ajax_form_jap_anular_contrato_lkpedt_refresh_con_pais_cb);
  } // do_ajax_form_jap_anular_contrato_lkpedt_refresh_con_pais

  function do_ajax_form_jap_anular_contrato_lkpedt_refresh_con_pais_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_jap_anular_contrato_lkpedt_refresh_con_pais_cb

  function do_ajax_form_jap_anular_contrato_lkpedt_refresh_con_provincia()
  {
    var var_con_provincia = scAjaxGetFieldSelect("con_provincia");
    var var_con_pais = scAjaxGetFieldSelect("con_pais");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "con_provincia";
    x_ajax_form_jap_anular_contrato_lkpedt_refresh_con_provincia(var_con_provincia, var_con_pais, nmgp_refresh_fields, var_script_case_init, do_ajax_form_jap_anular_contrato_lkpedt_refresh_con_provincia_cb);
  } // do_ajax_form_jap_anular_contrato_lkpedt_refresh_con_provincia

  function do_ajax_form_jap_anular_contrato_lkpedt_refresh_con_provincia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_jap_anular_contrato_lkpedt_refresh_con_provincia_cb

  function do_ajax_form_jap_anular_contrato_lkpedt_refresh_con_canton()
  {
    var var_con_canton = scAjaxGetFieldSelect("con_canton");
    var var_con_provincia = scAjaxGetFieldSelect("con_provincia");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "con_canton";
    x_ajax_form_jap_anular_contrato_lkpedt_refresh_con_canton(var_con_canton, var_con_provincia, nmgp_refresh_fields, var_script_case_init, do_ajax_form_jap_anular_contrato_lkpedt_refresh_con_canton_cb);
  } // do_ajax_form_jap_anular_contrato_lkpedt_refresh_con_canton

  function do_ajax_form_jap_anular_contrato_lkpedt_refresh_con_canton_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_jap_anular_contrato_lkpedt_refresh_con_canton_cb

  function do_ajax_form_jap_anular_contrato_lkpedt_refresh_con_parroquia()
  {
    var var_con_parroquia = scAjaxGetFieldSelect("con_parroquia");
    var var_con_canton = scAjaxGetFieldSelect("con_canton");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "con_parroquia";
    x_ajax_form_jap_anular_contrato_lkpedt_refresh_con_parroquia(var_con_parroquia, var_con_canton, nmgp_refresh_fields, var_script_case_init, do_ajax_form_jap_anular_contrato_lkpedt_refresh_con_parroquia_cb);
  } // do_ajax_form_jap_anular_contrato_lkpedt_refresh_con_parroquia

  function do_ajax_form_jap_anular_contrato_lkpedt_refresh_con_parroquia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_jap_anular_contrato_lkpedt_refresh_con_parroquia_cb
