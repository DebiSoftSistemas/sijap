...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_jap_anular_contrato"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function sc_btn_anular()
{
    ...
    scJs_confirm("<?php echo html_entity_decode('Seguro Desea Anular el Contrato?', ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>", sc_btn_anular_ok, sc_btn_anular_cancel)
}
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['where_detal']))
  {
?>  
...
function lookup_con_estado(campo)
{
   ...
   jsrsExecute("<?php  echo $this->Ini->path_link . SC_dir_app_name('form_jap_anular_contrato')?>/form_jap_anular_contrato.php?script_case_init=<?php echo $this->form_encode_input($this->Ini->sc_page); ?>&nmgp_opcao=lookup", recebe_con_estado, "con_estado", dados, false);
}
...
function lookup_con_usuario_instala(campo)
{
   ...
   jsrsExecute("<?php  echo $this->Ini->path_link . SC_dir_app_name('form_jap_anular_contrato')?>/form_jap_anular_contrato.php?script_case_init=<?php echo $this->form_encode_input($this->Ini->sc_page); ?>&nmgp_opcao=lookup", recebe_con_usuario_instala, "con_usuario_instala", dados, false);
}
