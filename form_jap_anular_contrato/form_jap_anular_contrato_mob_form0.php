...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_jap_anular_contrato/form_jap_anular_contrato_mob_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_jap_anular_contrato_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['recarga'];
}
if ('' != $this->con_estado)
{
...
if ('' != $this->con_usuario_instala)
{
    ...
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['link_info']['remove_border']) {
...
if (isset($_SESSION['scriptcase']['form_jap_anular_contrato']['error_buffer']) && '' != $_SESSION['scriptcase']['form_jap_anular_contrato']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_jap_anular_contrato']['error_buffer'];
}
...
<?php
 include_once("form_jap_anular_contrato_mob_js0.php");
?>
<script type="text/javascript" src="<?php  echo $this->Ini->path_js . "/jsrsClient.js" ?>"> 
</script> 
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_jap_anular_contrato_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_jap_anular_contrato_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_jap_anular_contrato_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_disabled']['']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_disabled']['']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_label']['']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_label']['']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_label'][''];
        }
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_disabled']['anular']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_disabled']['anular']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_label']['anular']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_label']['anular']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_label']['anular'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-18';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_motivo_anulacion_line" id="hidden_field_data_con_motivo_anulacion" style="<?php echo $sStyleHidden_con_motivo_anulacion; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_motivo_anulacion_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_con_motivo_anulacion_label" style=""><span id="id_label_con_motivo_anulacion"><?php echo $this->nm_new_label['con_motivo_anulacion']; ?></span></span><br>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_fecha_line" id="hidden_field_data_con_fecha" style="<?php echo $sStyleHidden_con_fecha; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_fecha_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_con_fecha_label" style=""><span id="id_label_con_fecha"><?php echo $this->nm_new_label['con_fecha']; ?></span></span><br><input type="hidden" name="con_fecha" value="<?php echo $this->form_encode_input($con_fecha); ?>"><span id="id_ajax_label_con_fecha"><?php echo nl2br($con_fecha); ?></span>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_sino_line" id="hidden_field_data_con_sino" style="<?php echo $sStyleHidden_con_sino; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_sino_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_con_sino_label" style=""><span id="id_label_con_sino"><?php echo $this->nm_new_label['con_sino']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_numero_contrato_line" id="hidden_field_data_con_numero_contrato" style="<?php echo $sStyleHidden_con_numero_contrato; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_numero_contrato_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_con_numero_contrato_label" style=""><span id="id_label_con_numero_contrato"><?php echo $this->nm_new_label['con_numero_contrato']; ?></span></span><br><input type="hidden" name="con_numero_contrato" value="<?php echo $this->form_encode_input($con_numero_contrato); ?>"><span id="id_ajax_label_con_numero_contrato"><?php echo nl2br($con_numero_contrato); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_tipo_contrato_line" id="hidden_field_data_con_tipo_contrato" style="<?php echo $sStyleHidden_con_tipo_contrato; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_tipo_contrato_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_con_tipo_contrato_label" style=""><span id="id_label_con_tipo_contrato"><?php echo $this->nm_new_label['con_tipo_contrato']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_propietario_line" id="hidden_field_data_con_propietario" style="<?php echo $sStyleHidden_con_propietario; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_propietario_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_con_propietario_label" style=""><span id="id_label_con_propietario"><?php echo $this->nm_new_label['con_propietario']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['php_cmp_required']['con_propietario']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['php_cmp_required']['con_propietario'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br><input type="hidden" name="con_propietario" value="<?php echo $this->form_encode_input($con_propietario); ?>"><span id="id_ajax_label_con_propietario"><?php echo nl2br($con_propietario); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_cedula_line" id="hidden_field_data_con_cedula" style="<?php echo $sStyleHidden_con_cedula; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_cedula_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_con_cedula_label" style=""><span id="id_label_con_cedula"><?php echo $this->nm_new_label['con_cedula']; ?></span></span><br><input type="hidden" name="con_cedula" value="<?php echo $this->form_encode_input($con_cedula); ?>"><span id="id_ajax_label_con_cedula"><?php echo nl2br($con_cedula); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_telefono_line" id="hidden_field_data_con_telefono" style="<?php echo $sStyleHidden_con_telefono; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_telefono_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_con_telefono_label" style=""><span id="id_label_con_telefono"><?php echo $this->nm_new_label['con_telefono']; ?></span></span><br><input type="hidden" name="con_telefono" value="<?php echo $this->form_encode_input($con_telefono); ?>"><span id="id_ajax_label_con_telefono"><?php echo nl2br($con_telefono); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_pais_line" id="hidden_field_data_con_pais" style="<?php echo $sStyleHidden_con_pais; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_pais_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_con_pais_label" style=""><span id="id_label_con_pais"><?php echo $this->nm_new_label['con_pais']; ?></span></span><br>
...
<?php
   ...
   if (isset($this->Ini->sc_lig_md5["form_sis_pais"]) && $this->Ini->sc_lig_md5["form_sis_pais"] == "S") {
       $Parms_Lig  = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scoutnm_evt_ret_edit*scindo_ajax_form_jap_anular_contrato_mob_lkpedt_refresh_con_pais*scoutnmgp_url_saida*scinmodal*scoutnmgp_outra_jan*scintrue*scoutsc_redir_atualiz*scinok*scout";
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_jap_anular_contrato_mob@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scoutnm_evt_ret_edit*scindo_ajax_form_jap_anular_contrato_mob_lkpedt_refresh_con_pais*scoutnmgp_url_saida*scinmodal*scoutnmgp_outra_jan*scintrue*scoutsc_redir_atualiz*scinok*scout";
   }
 ?><?php echo nmButtonOutput($this->arr_buttons, "bform_lookuplink", "", "", "fldedt_con_pais", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->link_form_sis_pais_edit . "?script_case_init=" . $this->Ini->sc_page . "&nmgp_parms=" . $Md5_Lig . "&SC_lig_apl_orig=form_jap_anular_contrato_mob&KeepThis=true&TB_iframe=true&height=460&width=800&modal=true", "");?>
<?php    echo "</span>";
?> 
<?php  }?>
...
<?php
   ...
   if (isset($this->Ini->sc_lig_md5["form_sis_provincia"]) && $this->Ini->sc_lig_md5["form_sis_provincia"] == "S") {
       $Parms_Lig  = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scoutnm_evt_ret_edit*scindo_ajax_form_jap_anular_contrato_mob_lkpedt_refresh_con_provincia*scoutnmgp_url_saida*scinmodal*scoutnmgp_outra_jan*scintrue*scoutsc_redir_atualiz*scinok*scout";
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_jap_anular_contrato_mob@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scoutnm_evt_ret_edit*scindo_ajax_form_jap_anular_contrato_mob_lkpedt_refresh_con_provincia*scoutnmgp_url_saida*scinmodal*scoutnmgp_outra_jan*scintrue*scoutsc_redir_atualiz*scinok*scout";
   }
 ?><?php echo nmButtonOutput($this->arr_buttons, "bform_lookuplink", "", "", "fldedt_con_provincia", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->link_form_sis_provincia_edit . "?script_case_init=" . $this->Ini->sc_page . "&nmgp_parms=" . $Md5_Lig . "&SC_lig_apl_orig=form_jap_anular_contrato_mob&KeepThis=true&TB_iframe=true&height=460&width=800&modal=true", "");?>
<?php    echo "</span>";
?> 
<?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_canton_line" id="hidden_field_data_con_canton" style="<?php echo $sStyleHidden_con_canton; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_canton_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_con_canton_label" style=""><span id="id_label_con_canton"><?php echo $this->nm_new_label['con_canton']; ?></span></span><br>
...
<?php
   ...
   if (isset($this->Ini->sc_lig_md5["form_sis_canton"]) && $this->Ini->sc_lig_md5["form_sis_canton"] == "S") {
       $Parms_Lig  = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scoutnm_evt_ret_edit*scindo_ajax_form_jap_anular_contrato_mob_lkpedt_refresh_con_canton*scoutnmgp_url_saida*scinmodal*scoutnmgp_outra_jan*scintrue*scoutsc_redir_atualiz*scinok*scout";
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_jap_anular_contrato_mob@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scoutnm_evt_ret_edit*scindo_ajax_form_jap_anular_contrato_mob_lkpedt_refresh_con_canton*scoutnmgp_url_saida*scinmodal*scoutnmgp_outra_jan*scintrue*scoutsc_redir_atualiz*scinok*scout";
   }
 ?><?php echo nmButtonOutput($this->arr_buttons, "bform_lookuplink", "", "", "fldedt_con_canton", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->link_form_sis_canton_edit . "?script_case_init=" . $this->Ini->sc_page . "&nmgp_parms=" . $Md5_Lig . "&SC_lig_apl_orig=form_jap_anular_contrato_mob&KeepThis=true&TB_iframe=true&height=460&width=800&modal=true", "");?>
<?php    echo "</span>";
?> 
<?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_parroquia_line" id="hidden_field_data_con_parroquia" style="<?php echo $sStyleHidden_con_parroquia; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_parroquia_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_con_parroquia_label" style=""><span id="id_label_con_parroquia"><?php echo $this->nm_new_label['con_parroquia']; ?></span></span><br>
...
<?php
   ...
   if (isset($this->Ini->sc_lig_md5["form_sis_parroquia"]) && $this->Ini->sc_lig_md5["form_sis_parroquia"] == "S") {
       $Parms_Lig  = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scoutnm_evt_ret_edit*scindo_ajax_form_jap_anular_contrato_mob_lkpedt_refresh_con_parroquia*scoutnmgp_url_saida*scinmodal*scoutnmgp_outra_jan*scintrue*scoutsc_redir_atualiz*scinok*scout";
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_jap_anular_contrato_mob@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scoutnm_evt_ret_edit*scindo_ajax_form_jap_anular_contrato_mob_lkpedt_refresh_con_parroquia*scoutnmgp_url_saida*scinmodal*scoutnmgp_outra_jan*scintrue*scoutsc_redir_atualiz*scinok*scout";
   }
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_sector_line" id="hidden_field_data_con_sector" style="<?php echo $sStyleHidden_con_sector; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_sector_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_con_sector_label" style=""><span id="id_label_con_sector"><?php echo $this->nm_new_label['con_sector']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_numero_censo_line" id="hidden_field_data_con_numero_censo" style="<?php echo $sStyleHidden_con_numero_censo; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_numero_censo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_con_numero_censo_label" style=""><span id="id_label_con_numero_censo"><?php echo $this->nm_new_label['con_numero_censo']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_toma_administrativa_line" id="hidden_field_data_con_toma_administrativa" style="<?php echo $sStyleHidden_con_toma_administrativa; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_toma_administrativa_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_con_toma_administrativa_label" style=""><span id="id_label_con_toma_administrativa"><?php echo $this->nm_new_label['con_toma_administrativa']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_toma_operativa_line" id="hidden_field_data_con_toma_operativa" style="<?php echo $sStyleHidden_con_toma_operativa; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_toma_operativa_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_con_toma_operativa_label" style=""><span id="id_label_con_toma_operativa"><?php echo $this->nm_new_label['con_toma_operativa']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['php_cmp_required']['con_toma_operativa']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['php_cmp_required']['con_toma_operativa'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_condicion_contrato_line" id="hidden_field_data_con_condicion_contrato" style="<?php echo $sStyleHidden_con_condicion_contrato; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_condicion_contrato_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_con_condicion_contrato_label" style=""><span id="id_label_con_condicion_contrato"><?php echo $this->nm_new_label['con_condicion_contrato']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_ruta_line" id="hidden_field_data_con_ruta" style="<?php echo $sStyleHidden_con_ruta; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_ruta_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_con_ruta_label" style=""><span id="id_label_con_ruta"><?php echo $this->nm_new_label['con_ruta']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_orden_lecturas_line" id="hidden_field_data_con_orden_lecturas" style="<?php echo $sStyleHidden_con_orden_lecturas; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_orden_lecturas_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_con_orden_lecturas_label" style=""><span id="id_label_con_orden_lecturas"><?php echo $this->nm_new_label['con_orden_lecturas']; ?></span></span><br><input type="hidden" name="con_orden_lecturas" value="<?php echo $this->form_encode_input($con_orden_lecturas); ?>"><span id="id_ajax_label_con_orden_lecturas"><?php echo nl2br($con_orden_lecturas); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_numero_corte_line" id="hidden_field_data_con_numero_corte" style="<?php echo $sStyleHidden_con_numero_corte; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_numero_corte_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_con_numero_corte_label" style=""><span id="id_label_con_numero_corte"><?php echo $this->nm_new_label['con_numero_corte']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_fecha_instalacion_line" id="hidden_field_data_con_fecha_instalacion" style="<?php echo $sStyleHidden_con_fecha_instalacion; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_fecha_instalacion_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_con_fecha_instalacion_label" style=""><span id="id_label_con_fecha_instalacion"><?php echo $this->nm_new_label['con_fecha_instalacion']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_numero_medidor_line" id="hidden_field_data_con_numero_medidor" style="<?php echo $sStyleHidden_con_numero_medidor; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_numero_medidor_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_con_numero_medidor_label" style=""><span id="id_label_con_numero_medidor"><?php echo $this->nm_new_label['con_numero_medidor']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_maxima_lectura_line" id="hidden_field_data_con_maxima_lectura" style="<?php echo $sStyleHidden_con_maxima_lectura; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_maxima_lectura_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_con_maxima_lectura_label" style=""><span id="id_label_con_maxima_lectura"><?php echo $this->nm_new_label['con_maxima_lectura']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_lectura_actual_line" id="hidden_field_data_con_lectura_actual" style="<?php echo $sStyleHidden_con_lectura_actual; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_lectura_actual_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_con_lectura_actual_label" style=""><span id="id_label_con_lectura_actual"><?php echo $this->nm_new_label['con_lectura_actual']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_fecha_lectura_line" id="hidden_field_data_con_fecha_lectura" style="<?php echo $sStyleHidden_con_fecha_lectura; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_fecha_lectura_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_con_fecha_lectura_label" style=""><span id="id_label_con_fecha_lectura"><?php echo $this->nm_new_label['con_fecha_lectura']; ?></span></span><br>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_jap_anular_contrato_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_jap_anular_contrato_mob");
 parent.scAjaxDetailHeight("form_jap_anular_contrato_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
