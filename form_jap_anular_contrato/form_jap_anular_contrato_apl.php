<?php
//
class form_jap_anular_contrato_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_jap_anular_contrato']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_jap_anular_contrato']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_jap_anular_contrato']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_jap_anular_contrato']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_jap_anular_contrato']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_jap_anular_contrato']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_jap_anular_contrato']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_jap_anular_contrato']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (!isset($this->Igtech_RucEmpresa) && isset($this->igtech_rucempresa)) 
          {
              $this->Igtech_RucEmpresa = $this->igtech_rucempresa;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_jap_anular_contrato']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_jap_anular_contrato']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_jap_anular_contrato']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_jap_anular_contrato']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_jap_anular_contrato']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_jap_anular_contrato']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_jap_anular_contrato']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_jap_anular_contrato']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_jap_anular_contrato']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_jap_anular_contrato_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_jap_anular_contrato']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_jap_anular_contrato']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_jap_anular_contrato'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_jap_anular_contrato']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_jap_anular_contrato']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_jap_anular_contrato') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_jap_anular_contrato']['label'] = "" . $this->Ini->Nm_lang['lang_jap_contrato'] . "";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_jap_anular_contrato")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_jap_anular_contrato']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_jap_anular_contrato'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_anular_contrato']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_jap_anular_contrato']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_anular_contrato']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_jap_anular_contrato']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_anular_contrato']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_jap_anular_contrato']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_anular_contrato']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_jap_anular_contrato']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_jap_anular_contrato']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_anular_contrato']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_jap_anular_contrato'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_jap_anular_contrato'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_anular_contrato']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_jap_anular_contrato']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_jap_anular_contrato']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_anular_contrato']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_jap_anular_contrato']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_jap_anular_contrato']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_anular_contrato']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_jap_anular_contrato']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_jap_anular_contrato']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_jap_anular_contrato", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_jap_anular_contrato/form_jap_anular_contrato_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_jap_anular_contrato_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_jap_anular_contrato_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_jap_anular_contrato_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_jap_anular_contrato/form_jap_anular_contrato_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_jap_anular_contrato_erro.class.php"); 
      }
      $this->Erro      = new form_jap_anular_contrato_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['opcao']))
         { 
             if ($this->con_id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_anular_contrato']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_jap_anular_contrato']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_anular_contrato']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['opc_ant'] : "";
      } 
      ...
      {
          $this->nmgp_botoes['anular'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['botoes']['anular'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_jap_anular_contrato']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_jap_anular_contrato']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['dados_select'];
     }
   }
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['Gera_log_access'] = false;
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_jap_anular_contrato.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_jap_anular_contrato_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_jap_anular_contrato"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_jap_anular_contrato', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sis_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'form_jap_anular_contrato', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_jap_anular_contrato', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['opc_ant'] == "incluir")
      {
      ...
      {
          if (!isset($this->con_motivo_anulacion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['dados_form']['con_motivo_anulacion']))
          {
              $varloc_btn_php['con_motivo_anulacion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['dados_form']['con_motivo_anulacion'];
          }
          if (!isset($this->con_motivo_anulacion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['dados_form']['con_motivo_anulacion']))
          {
              $varloc_btn_php['con_motivo_anulacion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['dados_form']['con_motivo_anulacion'];
          }
          if (!isset($this->con_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['dados_form']['con_id']))
          {
              $varloc_btn_php['con_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['dados_form']['con_id'];
          }
          if (!isset($this->con_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['dados_form']['con_id']))
          {
              $varloc_btn_php['con_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['dados_form']['con_id'];
          }
          if (!isset($this->con_nombre) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['dados_form']['con_nombre']))
          {
              $varloc_btn_php['con_nombre'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['dados_form']['con_nombre'];
          }
          if (!isset($this->con_numero_contrato) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['dados_form']['con_numero_contrato']))
          {
              $varloc_btn_php['con_numero_contrato'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['dados_form']['con_numero_contrato'];
          }
          if (!isset($this->con_direccion_predio) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['dados_form']['con_direccion_predio']))
          {
              $varloc_btn_php['con_direccion_predio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['dados_form']['con_direccion_predio'];
          }
          if (!isset($this->con_numero_medidor) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['dados_form']['con_numero_medidor']))
          {
              $varloc_btn_php['con_numero_medidor'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['dados_form']['con_numero_medidor'];
          }
          if (!isset($this->con_lectura_actual) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['dados_form']['con_lectura_actual']))
          {
              $varloc_btn_php['con_lectura_actual'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['dados_form']['con_lectura_actual'];
          }
          if (!isset($this->con_motivo_anulacion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['dados_form']['con_motivo_anulacion']))
          {
              $varloc_btn_php['con_motivo_anulacion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['dados_form']['con_motivo_anulacion'];
      ...
      $_SESSION['scriptcase']['form_jap_anular_contrato']['contr_erro'] = 'on';
...
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('grid_anular_contrato_ap') . "/", $this->nm_location, "_self?#?" . NM_encode_input("") . "?@?","_self", '', 440, 630);
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_jap_anular_contrato';
	...
	if (isset($this->Campos_Mens_erro) && !empty($this->Campos_Mens_erro))
{
 if (isset($this->sc_temp_Igtech_SesionLogin)) { $_SESSION['Igtech_SesionLogin'] = $this->sc_temp_Igtech_SesionLogin;}
    if ($this->NM_ajax_flag)
    {
        $this->NM_ajax_info['redirExit']['action'] = "form_jap_anular_contrato_fim.php?script_case_init=" . $this->form_encode_input($this->Ini->sc_page);
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['sc_outra_jan'])
        {
            $_SESSION['scriptcase']['sc_outra_jan'] = "form_jap_anular_contrato";
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['sc_outra_jan'] = false;
        }
        $_SESSION['scriptcase']['form_jap_anular_contrato']['contr_erro'] = 'off';
        form_jap_anular_contrato_pack_ajax_response();
        exit;
...
<table align="center"><tr><td>
  <form name="Fexit" method=post
        action="form_jap_anular_contrato_fim.php"
        target="_self">
    <input type=hidden name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page) ?>">
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_jap_anular_contrato']) || !is_array($this->NM_ajax_info['errList']['geral_form_jap_anular_contrato']))
              {
                  $this->NM_ajax_info['errList']['geral_form_jap_anular_contrato'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_jap_anular_contrato'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
;
   ...
   if (isset($this->Field_no_validate['con_tipo_contrato'])) {
       return;
               ...
               if (!empty($this->con_tipo_contrato) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['Lookup_con_tipo_contrato']) && !in_array($this->con_tipo_contrato, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['Lookup_con_tipo_contrato']))
               {
                   $hasError = true;
    ...
    function ValidateField_con_propietario(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->con_propietario, 4, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['php_cmp_required']['con_propietario']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['php_cmp_required']['con_propietario'] == "on") 
           { 
              $hasError = true;
   ...
   if (isset($this->Field_no_validate['con_pais'])) {
       return;
               ...
               if (!empty($this->con_pais) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['Lookup_con_pais']) && !in_array($this->con_pais, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['Lookup_con_pais']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['con_provincia'])) {
       return;
               ...
               if (!empty($this->con_provincia) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['Lookup_con_provincia']) && !in_array($this->con_provincia, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['Lookup_con_provincia']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['con_canton'])) {
       return;
               ...
               if (!empty($this->con_canton) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['Lookup_con_canton']) && !in_array($this->con_canton, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['Lookup_con_canton']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['con_parroquia'])) {
       return;
               ...
               if (!empty($this->con_parroquia) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['Lookup_con_parroquia']) && !in_array($this->con_parroquia, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['Lookup_con_parroquia']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['con_comunidad'])) {
       return;
               ...
               if (!empty($this->con_comunidad) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['Lookup_con_comunidad']) && !in_array($this->con_comunidad, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['Lookup_con_comunidad']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['con_sector'])) {
       return;
               ...
               if (!empty($this->con_sector) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['Lookup_con_sector']) && !in_array($this->con_sector, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['Lookup_con_sector']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['con_toma_administrativa'])) {
       return;
               ...
               if (!empty($this->con_toma_administrativa) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['Lookup_con_toma_administrativa']) && !in_array($this->con_toma_administrativa, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['Lookup_con_toma_administrativa']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['con_toma_operativa'])) {
      ...
      if ($this->con_toma_operativa == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['php_cmp_required']['con_toma_operativa']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['php_cmp_required']['con_toma_operativa'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->con_toma_operativa) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['Lookup_con_toma_operativa']) && !in_array($this->con_toma_operativa, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['Lookup_con_toma_operativa']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['con_toma_operativa']))
   ...
   if (isset($this->Field_no_validate['con_condicion_contrato'])) {
       return;
               ...
               if (!empty($this->con_condicion_contrato) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['Lookup_con_condicion_contrato']) && !in_array($this->con_condicion_contrato, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['Lookup_con_condicion_contrato']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['con_tipo_servicio'])) {
       return;
               ...
               if (!empty($this->con_tipo_servicio) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['Lookup_con_tipo_servicio']) && !in_array($this->con_tipo_servicio, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['Lookup_con_tipo_servicio']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['con_ruta'])) {
       return;
               ...
               if (!empty($this->con_ruta) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['Lookup_con_ruta']) && !in_array($this->con_ruta, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['Lookup_con_ruta']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
...
;
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['con_id']['keyVal'] = form_jap_anular_contrato_pack_protect_string($this->nmgp_dados_form['con_id']);
          }
   } // ajax_return_values
...
else
{
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_jap_anular_contrato_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_jap_anular_contrato_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['con_tipo_contrato']['valList'][$i] = form_jap_anular_contrato_pack_protect_string($v);
          }
   ...
   function ajax_return_values_con_estado($bForce = false)
   {
          ...
          $this->NM_ajax_info['fldList']['con_estado'] = array(
              ...
              $this->NM_ajax_info['fldList']['con_estado']['lookupCons'] = form_jap_anular_contrato_pack_protect_string(NM_charset_to_utf8($conteudo));
          }
   }
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['con_pais']['valList'][$i] = form_jap_anular_contrato_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['con_provincia']['valList'][$i] = form_jap_anular_contrato_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['con_canton']['valList'][$i] = form_jap_anular_contrato_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_jap_anular_contrato_pack_protect_string('') => str_replace('<', '&lt;',form_jap_anular_contrato_pack_protect_string('' . $this->Ini->Nm_lang['lang_seleccione'] . '')));
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['con_parroquia']['valList'][$i] = form_jap_anular_contrato_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_jap_anular_contrato_pack_protect_string('0') => str_replace('<', '&lt;',form_jap_anular_contrato_pack_protect_string('' . $this->Ini->Nm_lang['lang_seleccione'] . '')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['Lookup_con_comunidad'][] = '0';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['con_comunidad']['valList'][$i] = form_jap_anular_contrato_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['Lookup_con_sector'][] = '0';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['con_sector']['valList'][$i] = form_jap_anular_contrato_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['con_toma_administrativa']['valList'][$i] = form_jap_anular_contrato_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['con_toma_operativa']['valList'][$i] = form_jap_anular_contrato_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['con_condicion_contrato']['valList'][$i] = form_jap_anular_contrato_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['con_tipo_servicio']['valList'][$i] = form_jap_anular_contrato_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['con_ruta']['valList'][$i] = form_jap_anular_contrato_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_con_usuario_instala($bForce = false)
   {
          ...
          $this->NM_ajax_info['fldList']['con_usuario_instala'] = array(
              ...
              $this->NM_ajax_info['fldList']['con_usuario_instala']['lookupCons'] = form_jap_anular_contrato_pack_protect_string(NM_charset_to_utf8($conteudo));
          }
   }
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['Field_no_validate'] = array();
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->con_id)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['opcao'] = '';
   ...
   function return_after_insert()
   {
      ...
      if ('' != $this->con_id)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['reg_start'] = $rsc->fields[0];
          $rsc->Close();
      }
   }
   ...
   { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['total']);
              }
              ...
              $this->NM_gera_log_new();
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['parms'] = "con_id?#?$this->con_id?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "insert" || $this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['select'] = ""; 
              } 
          } 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['dados_select'] = $this->nmgp_dados_select;
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['dados_select'];
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_jap_anular_contrato_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_jap_anular_contrato = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['total'] = $qt_geral_reg_form_jap_anular_contrato;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_jap_anular_contrato_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_jap_anular_contrato_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_jap_anular_contrato_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['masterValue']))
{
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['retorno_edit'] = "";
   }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function getButtonIds($buttonName) {
        switch ($buttonName) {
            ...
            case "update":
                ...
                break;
            case "0":
                return array("sys_separator.sc-unique-btn-4", "sys_separator.sc-unique-btn-5", "sys_separator.sc-unique-btn-12");
                break;
            case "anular":
    ...
    function displayAppHeader()
    {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_anular_contrato']['ordem_ord'] == " desc") {
