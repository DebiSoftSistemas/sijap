...
class grid_jap_contratos_cliente_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
...
SCEOT;
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_jap_contratos_cliente']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_jap_contratos_cliente']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['orig_pesq'] = "resumo";
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['where_resumo'] = "";
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              ...
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['arr_total']['con_cedula'] = $this->array_total_con_cedula;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['arr_total']['con_condicion_contrato'] = $this->array_total_con_condicion_contrato;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['arr_total']['con_tipo_servicio'] = $this->array_total_con_tipo_servicio;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['arr_total']['con_ruta'] = $this->array_total_con_ruta;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['arr_total']['con_estado'] = $this->array_total_con_estado;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['json_use_label'])
       {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['labels']['con_cedula'] = $Lab_con_cedula; 
       $prep_field['con_condicion_contrato'] = $Lab_con_condicion_contrato;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['labels']['con_condicion_contrato'] = $Lab_con_condicion_contrato; 
       $prep_field['con_tipo_servicio'] = $Lab_con_tipo_servicio;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['labels']['con_tipo_servicio'] = $Lab_con_tipo_servicio; 
       $prep_field['con_ruta'] = $Lab_con_ruta;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['labels']['con_ruta'] = $Lab_con_ruta; 
       $prep_field['con_estado'] = $Lab_con_estado;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['labels']['con_estado'] = $Lab_con_estado; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['labels']['con_numero_contrato']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['labels']['con_numero_contrato'] = "Nro. " . $this->Ini->Nm_lang['lang_contrato'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['labels']['con_condicion_contrato']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['labels']['con_condicion_contrato'] = "" . $this->Ini->Nm_lang['lang_condicion_contrato'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['labels']['con_tipo_servicio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['labels']['con_tipo_servicio'] = "" . $this->Ini->Nm_lang['lang_tipo_servicio'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['labels']['con_numero_medidor']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['labels']['con_numero_medidor'] = "" . $this->Ini->Nm_lang['lang_numero_medidor'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['labels']['con_ruta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['labels']['con_ruta'] = "" . $this->Ini->Nm_lang['lang_ruta'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['labels']['con_direccion_predio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['labels']['con_direccion_predio'] = "" . $this->Ini->Nm_lang['lang_direccion_predio'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['labels']['con_lectura_actual']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['labels']['con_lectura_actual'] = "" . $this->Ini->Nm_lang['lang_lectura_actual'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['labels']['con_estado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['labels']['con_estado'] = "" . $this->Ini->Nm_lang['lang_estado'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['labels']['con_toma_administrativa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['labels']['con_toma_administrativa'] = "" . $this->Ini->Nm_lang['lang_toma_administrativa'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['labels']['con_toma_operativa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['labels']['con_toma_operativa'] = "" . $this->Ini->Nm_lang['lang_toma_operativa'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['labels']['con_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['labels']['con_id'] = "" . $this->Ini->Nm_lang['lang_id'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['labels']['con_propietario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['labels']['con_propietario'] = "Con Propietario"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['labels']['con_nombre']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['labels']['con_nombre'] = "" . $this->Ini->Nm_lang['lang_lot_nombre_completo'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['labels']['con_cedula']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['labels']['con_cedula'] = "" . $this->Ini->Nm_lang['lang_cedula'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['labels']['con_telefono']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['labels']['con_telefono'] = "" . $this->Ini->Nm_lang['lang_lot_telefono'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['labels']['con_correo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['labels']['con_correo'] = "" . $this->Ini->Nm_lang['lang_email'] . ""; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_jap_contratos_cliente@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_jap_contratos_cliente_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['doc_word'])
{
      ...
      { 
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['ajax_nav']) {  
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_jap_contratos_cliente_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_jap_contratos_cliente_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_jap_contratos_cliente_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_jap_contratos_cliente/grid_jap_contratos_cliente_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_jap_contratos_cliente_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_jap_contratos_cliente']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_jap_contratos_cliente']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_jap_contratos_cliente_config_pivot.php?nome_apl=grid_jap_contratos_cliente&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"grid_jap_contratos_cliente_iframe.php\";\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_jap_contratos_cliente_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_jap_contratos_cliente/grid_jap_contratos_cliente_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
   ...
   //---- 
   function adiciona_registro($quebra_con_cedula, $quebra_con_condicion_contrato, $quebra_con_tipo_servicio, $quebra_con_ruta, $quebra_con_estado, $quebra_con_cedula_orig, $quebra_con_condicion_contrato_orig, $quebra_con_tipo_servicio_orig, $quebra_con_ruta_orig, $quebra_con_estado_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_contratos_cliente']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->con_condicion_contrato = $rs_res->fields[1] ;  
            $this->con_tipo_servicio = $rs_res->fields[2] ;  
            $this->con_numero_medidor = $rs_res->fields[3] ;  
            $this->con_ruta = $rs_res->fields[4] ;  
            $this->con_direccion_predio = $rs_res->fields[5] ;  
            $this->con_lectura_actual = $rs_res->fields[6] ;  
            $this->con_estado = $rs_res->fields[7] ;  
            $this->con_toma_administrativa = $rs_res->fields[8] ;  
            $this->con_toma_operativa = $rs_res->fields[9] ;  
            $this->con_cedula = $rs_res->fields[10] ;  
            $this->con_id = $rs_res->fields[11] ;  
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->con_cedula, $this->con_condicion_contrato, $this->con_tipo_servicio, $this->con_ruta, $this->con_estado, $this->con_cedula_orig,  $this->con_condicion_contrato_orig,  $this->con_tipo_servicio_orig,  $this->con_ruta_orig,  $this->con_estado_orig);
            }
   }
//
