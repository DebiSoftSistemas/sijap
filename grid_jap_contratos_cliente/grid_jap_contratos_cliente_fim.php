...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_jap_contratos_cliente"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_jap_contratos_cliente"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_jap_contratos_cliente']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_jap_contratos_cliente']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_jap_contratos_cliente']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_jap_contratos_cliente']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_jap_contratos_cliente']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_jap_contratos_cliente</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_jap_contratos_cliente']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_jap_contratos_cliente']['embutida_filho'] as $ind => $sc_init)
          {
