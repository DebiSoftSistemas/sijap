...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_del_pedido_entregar/form_del_pedido_entregar_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_del_pedido_entregar_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_del_pedido_entregar_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['link_info']['remove_border']) {
...
<?php
 include_once("form_del_pedido_entregar_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_del_pedido_entregar'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_del_pedido_entregar'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_disabled']['entregar_pedido']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_disabled']['entregar_pedido']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_label']['entregar_pedido']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_label']['entregar_pedido']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_label']['entregar_pedido'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_disabled']['']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_disabled']['']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_label']['']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_label']['']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_label'][''];
        }
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_disabled']['group_group_1']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_disabled']['group_group_1']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_label']['group_group_1']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_label']['group_group_1']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_label']['group_group_1'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_disabled']['nota_venta']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_disabled']['nota_venta']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_label']['nota_venta']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_label']['nota_venta']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_label']['nota_venta'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_disabled']['baucher_factura']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_disabled']['baucher_factura']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_label']['baucher_factura']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_label']['baucher_factura']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_label']['baucher_factura'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_disabled']['baucher_guia']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_disabled']['baucher_guia']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_label']['baucher_guia']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_label']['baucher_guia']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_label']['baucher_guia'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-4';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php } 
?> 
<?php $sStyleHidden_prof_fecha_dumb = ('' == $sStyleHidden_prof_fecha) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_prof_fecha_dumb" style="<?php echo $sStyleHidden_prof_fecha_dumb; ?>"></TD>
<?php $sStyleHidden_prof_establecimiento_dumb = ('' == $sStyleHidden_prof_establecimiento) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_prof_establecimiento_dumb" style="<?php echo $sStyleHidden_prof_establecimiento_dumb; ?>"></TD>
...
<?php $sStyleHidden_prof_tipo_entrega_dumb = ('' == $sStyleHidden_prof_tipo_entrega) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_prof_tipo_entrega_dumb" style="<?php echo $sStyleHidden_prof_tipo_entrega_dumb; ?>"></TD>
...
<?php } ?>
<?php $sStyleHidden_prof_numero_dumb = ('' == $sStyleHidden_prof_numero) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_prof_numero_dumb" style="<?php echo $sStyleHidden_prof_numero_dumb; ?>"></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_prof_transportista_label" id="hidden_field_label_prof_transportista" style="<?php echo $sStyleHidden_prof_transportista; ?>"><span id="id_label_prof_transportista"><?php echo $this->nm_new_label['prof_transportista']; ?></span></TD>
    <TD class="scFormDataOdd css_prof_transportista_line" id="hidden_field_data_prof_transportista" style="<?php echo $sStyleHidden_prof_transportista; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_prof_transportista_line" style="vertical-align: top;padding: 0px">
...
<?php
   ...
   if (isset($this->Ini->sc_lig_md5["form_del_transportista"]) && $this->Ini->sc_lig_md5["form_del_transportista"] == "S") {
       $Parms_Lig  = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scoutnm_evt_ret_edit*scindo_ajax_form_del_pedido_entregar_lkpedt_refresh_prof_transportista*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_del_pedido_entregar@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scoutnm_evt_ret_edit*scindo_ajax_form_del_pedido_entregar_lkpedt_refresh_prof_transportista*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
   }
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_prof_delivery_propio_label" id="hidden_field_label_prof_delivery_propio" style="<?php echo $sStyleHidden_prof_delivery_propio; ?>"><span id="id_label_prof_delivery_propio"><?php echo $this->nm_new_label['prof_delivery_propio']; ?></span></TD>
    <TD class="scFormDataOdd css_prof_delivery_propio_line" id="hidden_field_data_prof_delivery_propio" style="<?php echo $sStyleHidden_prof_delivery_propio; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_prof_delivery_propio_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_prof_guia_remision_label" id="hidden_field_label_prof_guia_remision" style="<?php echo $sStyleHidden_prof_guia_remision; ?>"><span id="id_label_prof_guia_remision"><?php echo $this->nm_new_label['prof_guia_remision']; ?></span></TD>
    <TD class="scFormDataOdd css_prof_guia_remision_line" id="hidden_field_data_prof_guia_remision" style="<?php echo $sStyleHidden_prof_guia_remision; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_prof_guia_remision_line" style="vertical-align: top;padding: 0px">
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_lugar_envio'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_lugar_envio'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_direccion_entrega_pedido_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_lugar_envio'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_direccion_entrega_pedido_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_direccion_entrega_pedido_script_case_init'] ]['form_del_direccion_entrega_pedido']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_direccion_entrega_pedido_script_case_init'] ]['form_del_direccion_entrega_pedido']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_direccion_entrega_pedido_script_case_init'] ]['form_del_direccion_entrega_pedido']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_direccion_entrega_pedido_script_case_init'] ]['form_del_direccion_entrega_pedido']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_direccion_entrega_pedido_script_case_init'] ]['form_del_direccion_entrega_pedido']['embutida_liga_form_insert'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_direccion_entrega_pedido_script_case_init'] ]['form_del_direccion_entrega_pedido']['embutida_liga_form_update'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_direccion_entrega_pedido_script_case_init'] ]['form_del_direccion_entrega_pedido']['embutida_liga_form_delete'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_direccion_entrega_pedido_script_case_init'] ]['form_del_direccion_entrega_pedido']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_direccion_entrega_pedido_script_case_init'] ]['form_del_direccion_entrega_pedido']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_direccion_entrega_pedido_script_case_init'] ]['form_del_direccion_entrega_pedido']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_direccion_entrega_pedido_script_case_init'] ]['form_del_direccion_entrega_pedido']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_direccion_entrega_pedido_script_case_init'] ]['form_del_direccion_entrega_pedido']['embutida_liga_tp_pag'] = 'parcial';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_direccion_entrega_pedido_script_case_init'] ]['form_del_direccion_entrega_pedido']['embutida_parms'] = "NM_btn_insert*scinN*scoutNM_btn_update*scinN*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinN*scout";
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_direccion_entrega_pedido_script_case_init'] ]['form_del_pedido_entregar']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_del_pedido_entregar_empty.htm' : $this->Ini->link_form_del_direccion_entrega_pedido_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y';
if (isset($this->Ini->sc_lig_target['C_@scinf_lugar_envio']) && 'nmsc_iframe_liga_form_del_direccion_entrega_pedido' != $this->Ini->sc_lig_target['C_@scinf_lugar_envio'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_lugar_envio'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_direccion_entrega_pedido_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_del_direccion_entrega_pedido"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_form_del_direccion_entrega_pedido"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalles'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalles'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_detalle_pedido_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalles'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_detalle_pedido_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_detalle_pedido_script_case_init'] ]['form_del_detalle_pedido']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_detalle_pedido_script_case_init'] ]['form_del_detalle_pedido']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_detalle_pedido_script_case_init'] ]['form_del_detalle_pedido']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_detalle_pedido_script_case_init'] ]['form_del_detalle_pedido']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_detalle_pedido_script_case_init'] ]['form_del_detalle_pedido']['embutida_liga_form_insert'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_detalle_pedido_script_case_init'] ]['form_del_detalle_pedido']['embutida_liga_form_update'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_detalle_pedido_script_case_init'] ]['form_del_detalle_pedido']['embutida_liga_form_delete'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_detalle_pedido_script_case_init'] ]['form_del_detalle_pedido']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_detalle_pedido_script_case_init'] ]['form_del_detalle_pedido']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_detalle_pedido_script_case_init'] ]['form_del_detalle_pedido']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_detalle_pedido_script_case_init'] ]['form_del_detalle_pedido']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_detalle_pedido_script_case_init'] ]['form_del_detalle_pedido']['embutida_liga_tp_pag'] = 'total';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_detalle_pedido_script_case_init'] ]['form_del_detalle_pedido']['embutida_parms'] = "var_proforma*scin" . $this->nmgp_dados_form['prof_numero'] . "*scoutNM_btn_insert*scinN*scoutNM_btn_update*scinN*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinN*scout";
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_detalle_pedido_script_case_init'] ]['form_del_pedido_entregar']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_del_pedido_entregar_empty.htm' : $this->Ini->link_form_del_detalle_pedido_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y&sc_ifr_height=440';
if (isset($this->Ini->sc_lig_target['C_@scinf_detalles']) && 'nmsc_iframe_liga_form_del_detalle_pedido' != $this->Ini->sc_lig_target['C_@scinf_detalles'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_detalles'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_detalle_pedido_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_del_detalle_pedido"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="440" width="100%" name="nmsc_iframe_liga_form_del_detalle_pedido"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_forma_pago'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_forma_pago'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_forma_pago_pedido_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_forma_pago'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_forma_pago_pedido_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_forma_pago_pedido_script_case_init'] ]['form_del_forma_pago_pedido']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_forma_pago_pedido_script_case_init'] ]['form_del_forma_pago_pedido']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_forma_pago_pedido_script_case_init'] ]['form_del_forma_pago_pedido']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_forma_pago_pedido_script_case_init'] ]['form_del_forma_pago_pedido']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_forma_pago_pedido_script_case_init'] ]['form_del_forma_pago_pedido']['embutida_liga_form_insert'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_forma_pago_pedido_script_case_init'] ]['form_del_forma_pago_pedido']['embutida_liga_form_update'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_forma_pago_pedido_script_case_init'] ]['form_del_forma_pago_pedido']['embutida_liga_form_delete'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_forma_pago_pedido_script_case_init'] ]['form_del_forma_pago_pedido']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_forma_pago_pedido_script_case_init'] ]['form_del_forma_pago_pedido']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_forma_pago_pedido_script_case_init'] ]['form_del_forma_pago_pedido']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_forma_pago_pedido_script_case_init'] ]['form_del_forma_pago_pedido']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_forma_pago_pedido_script_case_init'] ]['form_del_forma_pago_pedido']['embutida_liga_tp_pag'] = 'parcial';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_forma_pago_pedido_script_case_init'] ]['form_del_forma_pago_pedido']['embutida_parms'] = "var_proforma*scin" . $this->nmgp_dados_form['prof_numero'] . "*scoutNM_btn_insert*scinN*scoutNM_btn_update*scinN*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinN*scout";
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_forma_pago_pedido_script_case_init'] ]['form_del_pedido_entregar']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_del_pedido_entregar_empty.htm' : $this->Ini->link_form_del_forma_pago_pedido_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y';
if (isset($this->Ini->sc_lig_target['C_@scinf_forma_pago']) && 'nmsc_iframe_liga_form_del_forma_pago_pedido' != $this->Ini->sc_lig_target['C_@scinf_forma_pago'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_forma_pago'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['form_del_forma_pago_pedido_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_del_forma_pago_pedido"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_form_del_forma_pago_pedido"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_del_pedido_entregar");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_del_pedido_entregar");
 parent.scAjaxDetailHeight("form_del_pedido_entregar", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_entregar']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
