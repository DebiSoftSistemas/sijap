<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="us_usuario_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['us_usuario_']); ?>">
<input type="hidden" name="us_socio_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['us_socio_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_del_usuario_socio"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function scForm_inline_submit(y, z) {
	Nm_Proc_Atualiz = true;
	do_ajax_form_del_usuario_socio_submit_form(y, z);
