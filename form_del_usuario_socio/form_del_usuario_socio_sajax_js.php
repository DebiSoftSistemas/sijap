  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_usuario_socio" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_usuario_socio_form();
	}
...
?>
  ...
  // ---------- Validate us_usuario_
  function do_ajax_form_del_usuario_socio_validate_us_usuario_(iNumLinha)
  {
    var nomeCampo_us_usuario_ = "us_usuario_" + iNumLinha;
    var var_us_usuario_ = scAjaxGetFieldText(nomeCampo_us_usuario_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_usuario_socio_validate_us_usuario_(var_us_usuario_, iNumLinha, var_script_case_init, do_ajax_form_del_usuario_socio_validate_us_usuario__cb);
  } // do_ajax_form_del_usuario_socio_validate_us_usuario_

  function do_ajax_form_del_usuario_socio_validate_us_usuario__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "us_usuario_" + iLineNumber;
    }
    else
    {
      sFieldValid = "us_usuario_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "us_usuario_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "us_usuario_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_usuario_socio_validate_us_usuario__cb

  // ---------- Validate us_socio_
  function do_ajax_form_del_usuario_socio_validate_us_socio_(iNumLinha)
  {
    var nomeCampo_us_socio_ = "us_socio_" + iNumLinha;
    var var_us_socio_ = scAjaxGetFieldSelect(nomeCampo_us_socio_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_usuario_socio_validate_us_socio_(var_us_socio_, iNumLinha, var_script_case_init, do_ajax_form_del_usuario_socio_validate_us_socio__cb);
  } // do_ajax_form_del_usuario_socio_validate_us_socio_

  function do_ajax_form_del_usuario_socio_validate_us_socio__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "us_socio_" + iLineNumber;
    }
    else
    {
      sFieldValid = "us_socio_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "us_socio_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "us_socio_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_usuario_socio_validate_us_socio__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_del_usuario_socio_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_del_usuario_socio_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_usuario_socio_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_del_usuario_socio_add_new_line_cb);
  } // do_ajax_form_del_usuario_socio_add_new_line

  function do_ajax_form_del_usuario_socio_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_del_usuario_socio_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_del_usuario_socio_backup_line(iNumLinha)
  {
    var var_us_usuario_ = scAjaxGetFieldText("us_usuario_" + iNumLinha);
    var var_us_socio_ = scAjaxGetFieldSelect("us_socio_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_usuario_socio_backup_line(var_us_usuario_, var_us_socio_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_del_usuario_socio_backup_line_cb);
  } // do_ajax_form_del_usuario_socio_backup_line

  function do_ajax_form_del_usuario_socio_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_del_usuario_socio_backup_line_cb

  function do_ajax_form_del_usuario_socio_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_del_usuario_socio_cancel_insert

  function do_ajax_form_del_usuario_socio_cancel_update(iSeqVert)
  {
    do_ajax_form_del_usuario_socio_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_del_usuario_socio_cancel_update

  function do_ajax_form_del_usuario_socio_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_del_usuario_socio_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_del_usuario_socio_table_refresh()
  {
    var var_us_usuario_ = document.F2.us_usuario_.value;
    var var_us_socio_ = document.F2.us_socio_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_del_usuario_socio_table_refresh(var_us_usuario_, var_us_socio_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_usuario_socio_table_refresh_cb);
  } //  do_ajax_form_del_usuario_socio_table_refresh

  function do_ajax_form_del_usuario_socio_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.us_usuario_.value = scAjaxGetKeyValue("us_usuario_");
    document.F2.us_socio_.value = scAjaxGetKeyValue("us_socio_");
    ...
    scAjaxAlert(do_ajax_form_del_usuario_socio_table_refresh_cb_after_alert);
  } // do_ajax_form_del_usuario_socio_table_refresh_cb
  function do_ajax_form_del_usuario_socio_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_del_usuario_socio_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_del_usuario_socio_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_del_usuario_socio_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_del_usuario_socio_submit_form(var_us_usuario_, var_us_socio_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_usuario_socio_submit_form_cb);
  } // do_ajax_form_del_usuario_socio_submit_form

  function do_ajax_form_del_usuario_socio_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("us_usuario_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("us_socio_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_usuario_socio_submit_form_cb_after_alert);
  } // do_ajax_form_del_usuario_socio_submit_form_cb
  function do_ajax_form_del_usuario_socio_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_usuario_socio_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_usuario_socio_navigate_form()
  {
    perform_ajax_form_del_usuario_socio_navigate_form();
  }

  function perform_ajax_form_del_usuario_socio_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_del_usuario_socio_cancel_insert(sc_form_del_usuario_socio_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("us_usuario_" + iNavForm);
      scAjaxHideErrorDisplay("us_socio_" + iNavForm);
    }
    var var_us_usuario_ = document.F2.us_usuario_.value;
    var var_us_socio_ = document.F2.us_socio_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_usuario_socio_navigate_form(var_us_usuario_, var_us_socio_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_usuario_socio_navigate_form_cb);
  } // do_ajax_form_del_usuario_socio_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_usuario_socio']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_usuario_socio_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.us_usuario_.value = scAjaxGetKeyValue("us_usuario_" + var_last_index);
    document.F2.us_socio_.value = scAjaxGetKeyValue("us_socio_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_usuario_socio_navigate_form_cb_after_alert);
  } // do_ajax_form_del_usuario_socio_navigate_form_cb
  function do_ajax_form_del_usuario_socio_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_del_usuario_socio_navigate_form_cb_after_alert

    function sc_form_del_usuario_socio_get_last_line_number()
    {
    ...
    } //sc_form_del_usuario_socio_get_last_line_number

  function sc_hide_form_del_usuario_socio_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "us_usuario_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "us_socio_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["us_usuario_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_usuario'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["us_socio_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_socio'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["us_usuario_"][iNumLinha] = "us_usuario_" + iNumLinha;
    ajax_field_mult["us_socio_"][iNumLinha] = "us_socio_" + iNumLinha;
    ajax_field_id["us_socio_" + iNumLinha] = new Array("hidden_field_label_us_socio_", "hidden_field_data_us_socio_" + iNumLinha);
    ajax_error_count["us_usuario_" + iNumLinha] = "off";
    ajax_error_count["us_socio_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["us_usuario_" + iNumLinha] = "on";
    ajax_read_only["us_socio_" + iNumLinha] = "on";
<?php
}
else
{
...
?>
  ...
  {
    ajax_error_list["us_usuario_" + iNumLinha] = null;
    ajax_error_list["us_socio_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["us_usuario_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["us_usuario_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["us_usuario_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["us_usuario_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["us_usuario_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["us_socio_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["us_socio_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["us_socio_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["us_socio_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["us_socio_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['us_usuario_'])) ? $this->nmgp_cmp_readonly['us_usuario_'] : 'on';
?>
    scAjaxFieldRead("us_usuario_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['us_socio_'])) ? $this->nmgp_cmp_readonly['us_socio_'] : 'on';
?>
    scAjaxFieldRead("us_socio_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("us_usuario_" + iSeq, "on");
    scAjaxFieldRead("us_socio_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["us_usuario_" + iRow] || "on" == ajax_error_count["us_socio_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_us_usuario_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_us_socio_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["us_usuario_" + iRow] && "off" == ajax_error_count["us_socio_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["us_usuario_" + iRow] = "off";
        ajax_error_count["us_socio_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_us_usuario_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_us_socio_" + iRow).removeClass("scFormErrorLine");
    }
  }
