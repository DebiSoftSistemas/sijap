...
<?php
   ...
   $Ord_Cmp = new grid_fac_procesa_recargos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_fac_procesa_recargos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_fac_procesa_recargos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_fac_procesa_recargos']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['pr_id'] = "pr_id";
   $tab_labels["pr_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_procesa_recargos']['labels']["pr_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_procesa_recargos']['labels']["pr_id"] : "" . $this->Nm_lang['lang_id'] . "";
   $tab_ger_campos['pr_fecha'] = "on";
   $tab_def_campos['pr_fecha'] = "pr_fecha";
   $tab_labels["pr_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_procesa_recargos']['labels']["pr_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_procesa_recargos']['labels']["pr_fecha"] : "" . $this->Nm_lang['lang_fecha'] . "";
   $tab_ger_campos['pr_mes'] = "on";
   $tab_def_campos['pr_mes'] = "pr_mes";
   $tab_labels["pr_mes"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_procesa_recargos']['labels']["pr_mes"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_procesa_recargos']['labels']["pr_mes"] : "" . $this->Nm_lang['lang_srch_mnth'] . "";
   $tab_ger_campos['pr_periodo'] = "on";
   $tab_def_campos['pr_periodo'] = "pr_periodo";
   $tab_labels["pr_periodo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_procesa_recargos']['labels']["pr_periodo"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_procesa_recargos']['labels']["pr_periodo"] : "" . $this->Nm_lang['lang_periodo'] . "";
   $tab_ger_campos['pr_estado'] = "on";
   $tab_def_campos['pr_estado'] = "pr_estado";
   $tab_labels["pr_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_procesa_recargos']['labels']["pr_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_procesa_recargos']['labels']["pr_estado"] : "" . $this->Nm_lang['lang_estado'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_procesa_recargos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_fac_procesa_recargos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_fac_procesa_recargos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_fac_procesa_recargos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_fac_procesa_recargos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_fac_procesa_recargos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_fac_procesa_recargos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_fac_procesa_recargos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_procesa_recargos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_fac_procesa_recargos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_fac_procesa_recargos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_fac_procesa_recargos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_fac_procesa_recargos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_fac_procesa_recargos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_fac_procesa_recargos']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_procesa_recargos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_fac_procesa_recargos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_fac_procesa_recargos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
