...
class grid_del_libretin_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_del_libretin_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_del_libretin_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_del_libretin_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "del_libretin_lib_id";$Nm_numeric[] = "del_libretin_lib_punto_emision";$Nm_numeric[] = "del_libretin_lib_secuencial";$Nm_numeric[] = "del_libretin_lib_disponibles";$Nm_numeric[] = "del_libretin_lib_utilizados";$Nm_numeric[] = "del_libretin_lib_desde";$Nm_numeric[] = "del_libretin_lib_hasta";
      $campo_join = strtolower(str_replace(".", "_", $nome));
      if (in_array($campo_join, $Nm_numeric))
      {
          if ($condicao == "EP" || $condicao == "NE")
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$campo_join]);
              return;
          }
         $nm_ini_lower = "";
         $nm_fim_lower = "";
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      $Nm_datas[] = "del_libretin.lib_fecha_caducidad";$Nm_datas[] = "del_libretin_lib_fecha_caducidad";
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> del_libretin</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_del_libretin/grid_del_libretin_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_del_libretin_ajax_search.js"></script>
 <script type="text/javascript" src="grid_del_libretin_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_del_libretin_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_del_libretin']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_del_libretin']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_del_libretin_lib_tipo_comprobante_cond#NMF#' + search_get_sel_txt('SC_del_libretin_lib_tipo_comprobante_cond') + '@NMF@';
  str_out += 'SC_del_libretin_lib_tipo_comprobante#NMF#' + search_get_select('SC_del_libretin_lib_tipo_comprobante') + '@NMF@';
  str_out += 'SC_del_libretin_lib_punto_emision_cond#NMF#' + search_get_sel_txt('SC_del_libretin_lib_punto_emision_cond') + '@NMF@';
  str_out += 'SC_del_libretin_lib_punto_emision#NMF#' + search_get_Dselelect('SC_del_libretin_lib_punto_emision_dest') + '@NMF@';
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $del_libretin_lib_tipo_comprobante_cond, $del_libretin_lib_tipo_comprobante,
             $del_libretin_lib_punto_emision_cond, $del_libretin_lib_punto_emision,
             $nm_url_saida, $nm_apl_dependente, $nmgp_parms, $bprocessa, $nmgp_save_name, $NM_operador, $NM_filters, $nmgp_save_option, $NM_filters_del, $Script_BI;
      $Script_BI = "";
      if (isset($bprocessa) && ($bprocessa == "recarga" || $bprocessa == "save_form" || $bprocessa == "filter_delete"))
      {
          if (!empty($del_libretin_lib_punto_emision))
          {
              $del_libretin_lib_punto_emision = explode("@?@", $del_libretin_lib_punto_emision);
          }
          else
          {
              $del_libretin_lib_punto_emision = array();
          }
      }
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $del_libretin_lib_tipo_comprobante = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['campos_busca']['del_libretin_lib_tipo_comprobante']; 
          $del_libretin_lib_tipo_comprobante_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['campos_busca']['del_libretin_lib_tipo_comprobante_cond']; 
          $del_libretin_lib_punto_emision = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['campos_busca']['del_libretin_lib_punto_emision']; 
          $del_libretin_lib_punto_emision_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['campos_busca']['del_libretin_lib_punto_emision_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['campos_busca']['NM_operador']; 
      } 
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_del_libretin_lib_tipo_comprobante = (in_array($del_libretin_lib_tipo_comprobante_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_del_libretin_lib_punto_emision = (in_array($del_libretin_lib_punto_emision_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      // del_libretin_lib_punto_emision
      if (is_array($del_libretin_lib_punto_emision) && !empty($del_libretin_lib_punto_emision))
      {
         $tmp_array = array();
         $del_libretin_lib_punto_emision_val_str = "";
         foreach ($del_libretin_lib_punto_emision as $tmp_val_cmp)
         {
            if ("" != $del_libretin_lib_punto_emision_val_str)
            {
               $del_libretin_lib_punto_emision_val_str .= ",";
            }
            ...
            $del_libretin_lib_punto_emision_val_str .= "'$tmp_val_cmp'";
         }
         $del_libretin_lib_punto_emision = $tmp_array;
      }
      else
      {
         $del_libretin_lib_punto_emision_val_str = "";
      }
      if (!isset($del_libretin_lib_tipo_comprobante) || $del_libretin_lib_tipo_comprobante == "")
      {
          $del_libretin_lib_tipo_comprobante = "";
      }
      if (isset($del_libretin_lib_tipo_comprobante) && !empty($del_libretin_lib_tipo_comprobante))
      {
         $tmp_pos = (is_string($del_libretin_lib_tipo_comprobante)) ? strpos($del_libretin_lib_tipo_comprobante, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $del_libretin_lib_tipo_comprobante = substr($del_libretin_lib_tipo_comprobante, 0, $tmp_pos);
         }
      }
      if (!isset($del_libretin_lib_punto_emision) || $del_libretin_lib_punto_emision == "")
      {
          $del_libretin_lib_punto_emision = array();
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_del_libretin_lib_tipo_comprobante_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['del_libretin_lib_tipo_comprobante'])) ? $this->New_label['del_libretin_lib_tipo_comprobante'] : "" . $this->Ini->Nm_lang['lang_tipo_comprobante'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_del_libretin_lib_tipo_comprobante_cond" name="del_libretin_lib_tipo_comprobante_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_del_libretin_lib_tipo_comprobante" <?php echo $str_hide_del_libretin_lib_tipo_comprobante?> valign="top">
 ...
 $nmgp_tab_label .= "del_libretin_lib_tipo_comprobante?#?" . $SC_Label . "?@?";
...
?>
   <span id="idAjaxSelect_del_libretin_lib_tipo_comprobante">
      <SELECT class="scFilterObjectOdd" id="SC_del_libretin_lib_tipo_comprobante" name="del_libretin_lib_tipo_comprobante"  size="1">
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $del_libretin_lib_tipo_comprobante)
            {
                    $del_libretin_lib_tipo_comprobante_sel = ($nm_opc_cod === $del_libretin_lib_tipo_comprobante) ? "selected" : "";
            }
            else
            {
...
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $del_libretin_lib_tipo_comprobante_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
?>
      ...
      <TD id='SC_del_libretin_lib_punto_emision_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['del_libretin_lib_punto_emision'])) ? $this->New_label['del_libretin_lib_punto_emision'] : "" . $this->Ini->Nm_lang['lang_punto_emision'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_del_libretin_lib_punto_emision_cond" name="del_libretin_lib_punto_emision_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_del_libretin_lib_punto_emision" <?php echo $str_hide_del_libretin_lib_punto_emision?> valign="top">
 ...
 $nmgp_tab_label .= "del_libretin_lib_punto_emision?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
   <table style="padding: 0px; spacing: 0px; border-width: 0px;"><tr><td>
    <SELECT class="scFilterObjectEven" id="SC_del_libretin_lib_punto_emision_orig" name="del_libretin_lib_punto_emision_orig" size=7 multiple onDblClick="nm_add_sel('del_libretin_lib_punto_emision_orig', 'del_libretin_lib_punto_emision_dest', 'N' , '')">
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if (is_array($del_libretin_lib_punto_emision) && !empty($del_libretin_lib_punto_emision))
            {
               ...
               foreach ($del_libretin_lib_punto_emision as $Dados)
               {
                   if ($Dados === $nm_opc_cod)
                   {
            ...
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $del_libretin_lib_punto_emision_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
<?php
      ...
      echo nmButtonOutput($this->arr_buttons, "bpassfld_rightall", "nm_add_all('del_libretin_lib_punto_emision_orig', 'del_libretin_lib_punto_emision_dest', 'N', '');", "nm_add_all('del_libretin_lib_punto_emision_orig', 'del_libretin_lib_punto_emision_dest', 'N', '');", "Bbpassfld_rightall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_right", "nm_add_sel('del_libretin_lib_punto_emision_orig', 'del_libretin_lib_punto_emision_dest', 'N', '');", "nm_add_sel('del_libretin_lib_punto_emision_orig', 'del_libretin_lib_punto_emision_dest', 'N', '');", "Bbpassfld_righ", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_left", "nm_del_sel('del_libretin_lib_punto_emision_dest', 'del_libretin_lib_punto_emision_orig', 'N', '');", "nm_del_sel('del_libretin_lib_punto_emision_dest', 'del_libretin_lib_punto_emision_orig', 'N', '');", "Bbpassfld_left", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_leftall", "nm_del_all('del_libretin_lib_punto_emision_dest', 'del_libretin_lib_punto_emision_orig', 'N', '');", "nm_del_all('del_libretin_lib_punto_emision_dest', 'del_libretin_lib_punto_emision_orig', 'N', '');", "Bbpassfld_leftall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
?>
   </td>
   <td>
    <SELECT class="scFilterObjectEven" id="SC_del_libretin_lib_punto_emision_dest" name="del_libretin_lib_punto_emision_dest" size=7 multiple  onDblClick="nm_del_sel('del_libretin_lib_punto_emision_dest', 'del_libretin_lib_punto_emision_orig', 'N' , '')">"
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
    ...
    <input type="hidden" id="SC_del_libretin_lib_punto_emision" name="del_libretin_lib_punto_emision" value="">
   </td></tr></table>
   <script type="text/javascript">document.F1.del_libretin_lib_punto_emision_dest.selectedIndex = -1;</script>
<?php
?>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_del_libretin_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_del_libretin']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_del_libretin']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
   nm_pack('del_libretin_lib_punto_emision_dest', 'del_libretin_lib_punto_emision');
    document.F1.submit();
 }
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_del_libretin_lib_tipo_comprobante'), document.F1.del_libretin_lib_tipo_comprobante_cond, 'del_libretin_lib_tipo_comprobante');
   document.F1.del_libretin_lib_tipo_comprobante.value = "";
   nm_campos_between(document.getElementById('id_vis_del_libretin_lib_punto_emision'), document.F1.del_libretin_lib_punto_emision_cond, 'del_libretin_lib_punto_emision');
   nm_del_all('del_libretin_lib_punto_emision_dest', 'del_libretin_lib_punto_emision_orig', 'N', '');
   Sc_carga_select2('all');
 }
 function Sc_carga_select2(Field)
 {
    if (Field == 'all' || Field == 'del_libretin_lib_tipo_comprobante') {
       Sc_carga_select2_del_libretin_lib_tipo_comprobante();
    }
 }
 function Sc_carga_select2_del_libretin_lib_tipo_comprobante()
 {
  $("#SC_del_libretin_lib_tipo_comprobante").select2(
    {
      language: {
        noResults: function() {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_del_libretin_lib_tipo_comprobante_cond'] = 'cond';
      $tp_fields['SC_del_libretin_lib_tipo_comprobante'] = 'select';
      $tp_fields['SC_del_libretin_lib_punto_emision_cond'] = 'cond';
      $tp_fields['SC_del_libretin_lib_punto_emision'] = 'dselect';
   ...
   {
      global $del_libretin_lib_tipo_comprobante_cond, $del_libretin_lib_tipo_comprobante,
             $del_libretin_lib_punto_emision_cond, $del_libretin_lib_punto_emision, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['campos_busca'] as $Cmps => $Vals)
          {
              if ($Cmps == 'del_libretin_lib_punto_emision')
              {
                  $$Cmps = implode("@?@", $Vals);
              }
              else
      ...
      $del_libretin_lib_tipo_comprobante_cond_salva = $del_libretin_lib_tipo_comprobante_cond; 
      if (!isset($del_libretin_lib_tipo_comprobante_input_2) || $del_libretin_lib_tipo_comprobante_input_2 == "")
      {
          $del_libretin_lib_tipo_comprobante_input_2 = $del_libretin_lib_tipo_comprobante;
      }
      $del_libretin_lib_punto_emision_cond_salva = $del_libretin_lib_punto_emision_cond; 
      if (!isset($del_libretin_lib_punto_emision_input_2) || $del_libretin_lib_punto_emision_input_2 == "")
      {
          $del_libretin_lib_punto_emision_input_2 = $del_libretin_lib_punto_emision;
      }
      $tmp_pos = (is_string($del_libretin_lib_tipo_comprobante)) ? strpos($del_libretin_lib_tipo_comprobante, "##@@") : false;
      if ($tmp_pos === false) {
          $L_lookup = $del_libretin_lib_tipo_comprobante;
      }
      else {
          $L_lookup = substr($del_libretin_lib_tipo_comprobante, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['psq_check_ret']['del_libretin_lib_tipo_comprobante'])) {
      ...
      if (is_array($del_libretin_lib_punto_emision)) {
          foreach ($del_libretin_lib_punto_emision as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['psq_check_ret']['del_libretin_lib_punto_emision'])) {
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['campos_busca']['del_libretin_lib_tipo_comprobante'] = $del_libretin_lib_tipo_comprobante; 
      if (is_array($del_libretin_lib_tipo_comprobante) && !empty($del_libretin_lib_tipo_comprobante))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['Grid_search'][$I_Grid]['val'][0] = $del_libretin_lib_tipo_comprobante;
      }
      elseif ($del_libretin_lib_tipo_comprobante_cond_salva == "nu" || $del_libretin_lib_tipo_comprobante_cond_salva == "nn" || $del_libretin_lib_tipo_comprobante_cond_salva == "ep" || $del_libretin_lib_tipo_comprobante_cond_salva == "ne" || !empty($del_libretin_lib_tipo_comprobante))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['Grid_search'][$I_Grid]['val'][0][0] = $del_libretin_lib_tipo_comprobante;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['campos_busca']['del_libretin_lib_tipo_comprobante_cond'] = $del_libretin_lib_tipo_comprobante_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['Grid_search'][$I_Grid]['cmp'] = "del_libretin_lib_tipo_comprobante"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['Grid_search'][$I_Grid]['opc'] = $del_libretin_lib_tipo_comprobante_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq']['del_libretin_lib_tipo_comprobante'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['campos_busca']['del_libretin_lib_punto_emision'] = $del_libretin_lib_punto_emision; 
      if (is_array($del_libretin_lib_punto_emision) && !empty($del_libretin_lib_punto_emision))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['Grid_search'][$I_Grid]['val'][0] = $del_libretin_lib_punto_emision;
      }
      elseif ($del_libretin_lib_punto_emision_cond_salva == "nu" || $del_libretin_lib_punto_emision_cond_salva == "nn" || $del_libretin_lib_punto_emision_cond_salva == "ep" || $del_libretin_lib_punto_emision_cond_salva == "ne" || !empty($del_libretin_lib_punto_emision))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['Grid_search'][$I_Grid]['val'][0][0] = $del_libretin_lib_punto_emision;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['campos_busca']['del_libretin_lib_punto_emision_cond'] = $del_libretin_lib_punto_emision_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['Grid_search'][$I_Grid]['cmp'] = "del_libretin_lib_punto_emision"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['Grid_search'][$I_Grid]['opc'] = $del_libretin_lib_punto_emision_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq']['del_libretin_lib_punto_emision'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $Conteudo = $del_libretin_lib_tipo_comprobante;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      }
      $this->cmp_formatado['del_libretin_lib_tipo_comprobante'] = $Conteudo;
      $this->cmp_formatado['del_libretin_lib_punto_emision'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['campos_busca']['del_libretin_lib_punto_emision'];
      $this->cmp_formatado['del_libretin_lib_punto_emision_input_2'] = $del_libretin_lib_punto_emision_input_2;

      //----- $del_libretin_lib_tipo_comprobante
      $this->Date_part = false;
      if (isset($del_libretin_lib_tipo_comprobante))
      {
         $this->monta_condicao("del_libretin.lib_tipo_comprobante", $del_libretin_lib_tipo_comprobante_cond, $del_libretin_lib_tipo_comprobante, "", "del_libretin_lib_tipo_comprobante", "VARCHAR", false);
      }

      //----- $del_libretin_lib_punto_emision
      $this->Date_part = false;
      $nm_aspas = "";
      if ($del_libretin_lib_punto_emision_cond == "nu" || $del_libretin_lib_punto_emision_cond == "nn" || $del_libretin_lib_punto_emision_cond == "ep" || $del_libretin_lib_punto_emision_cond == "ne")
      {
          $del_libretin_lib_punto_emision = array();
      }
      if (is_array($del_libretin_lib_punto_emision) && count($del_libretin_lib_punto_emision) != 0)
      {
         foreach ($del_libretin_lib_punto_emision as $i => $dados)
         {
            $tmp_pos = (is_string($dados)) ? strpos($dados, "##@@") : false;
            if (($tmp_pos === false && $dados == "") || $tmp_pos == 0)
            {
                unset($del_libretin_lib_punto_emision[$i]);
            }
         }
      }
      if (is_array($del_libretin_lib_punto_emision) && count($del_libretin_lib_punto_emision) != 0)
      {
         ...
         $lim_descr   = 15;
         $lang_descr  = strlen($this->Ini->Nm_lang['lang_srch_orr_cond']);
         if ($del_libretin_lib_punto_emision_cond == "df" || $del_libretin_lib_punto_emision_cond == "np")
         {
             $this->comando        .= " del_libretin.lib_punto_emision not in (";
             $this->comando_sum    .= " del_libretin.lib_punto_emision not in (";
             $this->comando_filtro .= " del_libretin.lib_punto_emision not in (";
         }
         else
         {
             $this->comando        .= " del_libretin.lib_punto_emision in (";
             $this->comando_sum    .= " del_libretin.lib_punto_emision in (";
             $this->comando_filtro .= " del_libretin.lib_punto_emision in (";
         }
         $x                     = count($del_libretin_lib_punto_emision);
         $xx                    = 0;
         $nm_cond               = "";
         foreach ($del_libretin_lib_punto_emision as $i => $dados)
         {
            ...
            elseif (!$end_descr)
            {
                 $cond_descr .= " +" . (count($del_libretin_lib_punto_emision) - $count_descr);
                 $end_descr = true;
            };
            if ($xx != ($x - 1))
            {
         ...
         $Lang_descr_final = isset($Lang_descr[$del_libretin_lib_punto_emision_cond]) ? $Lang_descr[$del_libretin_lib_punto_emision_cond] : $this->Ini->Nm_lang['lang_srch_like'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['cond_pesq'] .= $nmgp_tab_label['del_libretin_lib_punto_emision'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq']['del_libretin_lib_punto_emision']['label'] = $nmgp_tab_label['del_libretin_lib_punto_emision'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq']['del_libretin_lib_punto_emision']['descr'] = $nmgp_tab_label['del_libretin_lib_punto_emision'] . ": " . $Lang_descr_final . " " . $cond_descr;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['grid_pesq']['del_libretin_lib_punto_emision']['hint'] = $nmgp_tab_label['del_libretin_lib_punto_emision'] . ": " . $Lang_descr_final . " " . $nm_cond;
      }
      elseif (isset($del_libretin_lib_punto_emision) && ($del_libretin_lib_punto_emision_cond == "nu" || $del_libretin_lib_punto_emision_cond == "nn" || $del_libretin_lib_punto_emision_cond == "ep" || $del_libretin_lib_punto_emision_cond == "ne"))
      {
         $this->monta_condicao("del_libretin.lib_punto_emision", $del_libretin_lib_punto_emision_cond, "", "", "del_libretin_lib_punto_emision", "INT4", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
    $this->Sel_case_sensitive($this->comando);
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['where_pesq'] = $this->comando;
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['cond_dyn_search'] = "";
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_libretin']['cond_pesq'] .= $this->NM_operador;
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "del_libretin_lib_tipo_comprobante" : return ('class="scFilterObjectOdd"'); break;
         default       : return ("");
      }
   }
