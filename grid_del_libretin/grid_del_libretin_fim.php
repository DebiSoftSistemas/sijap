...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_del_libretin"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_del_libretin"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_del_libretin']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_del_libretin']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_del_libretin']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_del_libretin']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_del_libretin']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_del_libretin']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_del_libretin']['embutida_filho'] as $ind => $sc_init)
          {
