...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "del_libretin.lib_fecha_caducidad";$Nm_datas[] = "del_libretin_lib_fecha_caducidad";$Nm_numeric[] = "del_libretin_lib_id";$Nm_numeric[] = "del_libretin_lib_punto_emision";$Nm_numeric[] = "del_libretin_lib_secuencial";$Nm_numeric[] = "del_libretin_lib_disponibles";$Nm_numeric[] = "del_libretin_lib_utilizados";$Nm_numeric[] = "del_libretin_lib_desde";$Nm_numeric[] = "del_libretin_lib_hasta";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_del_libretin_lib_tipo_comprobante"  <?php echo $str_hide_del_libretin_lib_tipo_comprobante?>>
<?php
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_del_libretin_lib_punto_emision"  <?php echo $str_hide_del_libretin_lib_punto_emision?>>
<?php
...
?>
   <span id="idAjaxSelect_del_libretin_lib_punto_emision">
      <SELECT class="scFilterObjectEven" id="SC_del_libretin_lib_punto_emision" name="del_libretin_lib_punto_emision[]"  size="7" multiple>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
         ...
         if (!empty($nm_opcao))
         {
            ...
            if (is_array($del_libretin_lib_punto_emision) && !empty($del_libretin_lib_punto_emision))
            {
               ...
               foreach ($del_libretin_lib_punto_emision as $Dados)
               {
                   if ($Dados === $nm_opc_cod)
                   {
                       $del_libretin_lib_punto_emision_sel = "selected";
                       break;
                   }
               }
            }
...
?>
 ...
 function limpa_form()
 {
   ...
   {
      if (document.F1.elements[i].name == 'del_libretin_lib_punto_emision[]')
      {
...
<?php
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         ...
         case "del_libretin_lib_punto_emision" : return ('class="scFilterObjectEven"'); break;
         default       : return ("");
      }
   }
