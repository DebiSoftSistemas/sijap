  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_fac_seleccion_operacion_convenio" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_fac_seleccion_operacion_convenio_form();
	}
...
?>
  ...
  // ---------- Validate op_contrato_
  function do_ajax_form_fac_seleccion_operacion_convenio_validate_op_contrato_(iNumLinha)
  {
    var nomeCampo_op_contrato_ = "op_contrato_" + iNumLinha;
    var var_op_contrato_ = scAjaxGetFieldSelect(nomeCampo_op_contrato_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_seleccion_operacion_convenio_validate_op_contrato_(var_op_contrato_, iNumLinha, var_script_case_init, do_ajax_form_fac_seleccion_operacion_convenio_validate_op_contrato__cb);
  } // do_ajax_form_fac_seleccion_operacion_convenio_validate_op_contrato_

  function do_ajax_form_fac_seleccion_operacion_convenio_validate_op_contrato__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "op_contrato_" + iLineNumber;
    }
    else
    {
      sFieldValid = "op_contrato_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "op_contrato_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "op_contrato_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_seleccion_operacion_convenio_validate_op_contrato__cb

  // ---------- Validate op_operacion_
  function do_ajax_form_fac_seleccion_operacion_convenio_validate_op_operacion_(iNumLinha)
  {
    var nomeCampo_op_operacion_ = "op_operacion_" + iNumLinha;
    var var_op_operacion_ = scAjaxGetFieldText(nomeCampo_op_operacion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_seleccion_operacion_convenio_validate_op_operacion_(var_op_operacion_, iNumLinha, var_script_case_init, do_ajax_form_fac_seleccion_operacion_convenio_validate_op_operacion__cb);
  } // do_ajax_form_fac_seleccion_operacion_convenio_validate_op_operacion_

  function do_ajax_form_fac_seleccion_operacion_convenio_validate_op_operacion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_seleccion_operacion_convenio_validate_op_operacion__cb

  // ---------- Validate op_fecha_ini_
  function do_ajax_form_fac_seleccion_operacion_convenio_validate_op_fecha_ini_(iNumLinha)
  {
    var nomeCampo_op_fecha_ini_ = "op_fecha_ini_" + iNumLinha;
    var var_op_fecha_ini_ = scAjaxGetFieldHidden(nomeCampo_op_fecha_ini_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_seleccion_operacion_convenio_validate_op_fecha_ini_(var_op_fecha_ini_, iNumLinha, var_script_case_init, do_ajax_form_fac_seleccion_operacion_convenio_validate_op_fecha_ini__cb);
  } // do_ajax_form_fac_seleccion_operacion_convenio_validate_op_fecha_ini_

  function do_ajax_form_fac_seleccion_operacion_convenio_validate_op_fecha_ini__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_seleccion_operacion_convenio_validate_op_fecha_ini__cb

  // ---------- Validate op_tipo_cartera_
  function do_ajax_form_fac_seleccion_operacion_convenio_validate_op_tipo_cartera_(iNumLinha)
  {
    var nomeCampo_op_tipo_cartera_ = "op_tipo_cartera_" + iNumLinha;
    var var_op_tipo_cartera_ = scAjaxGetFieldSelect(nomeCampo_op_tipo_cartera_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_seleccion_operacion_convenio_validate_op_tipo_cartera_(var_op_tipo_cartera_, iNumLinha, var_script_case_init, do_ajax_form_fac_seleccion_operacion_convenio_validate_op_tipo_cartera__cb);
  } // do_ajax_form_fac_seleccion_operacion_convenio_validate_op_tipo_cartera_

  function do_ajax_form_fac_seleccion_operacion_convenio_validate_op_tipo_cartera__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "op_tipo_cartera_" + iLineNumber;
    }
    else
    {
      sFieldValid = "op_tipo_cartera_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "op_tipo_cartera_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "op_tipo_cartera_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_seleccion_operacion_convenio_validate_op_tipo_cartera__cb

  // ---------- Validate op_propietario_
  function do_ajax_form_fac_seleccion_operacion_convenio_validate_op_propietario_(iNumLinha)
  {
    var nomeCampo_op_propietario_ = "op_propietario_" + iNumLinha;
    var var_op_propietario_ = scAjaxGetFieldSelect(nomeCampo_op_propietario_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_seleccion_operacion_convenio_validate_op_propietario_(var_op_propietario_, iNumLinha, var_script_case_init, do_ajax_form_fac_seleccion_operacion_convenio_validate_op_propietario__cb);
  } // do_ajax_form_fac_seleccion_operacion_convenio_validate_op_propietario_

  function do_ajax_form_fac_seleccion_operacion_convenio_validate_op_propietario__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_seleccion_operacion_convenio_validate_op_propietario__cb

  // ---------- Validate op_comentario_
  function do_ajax_form_fac_seleccion_operacion_convenio_validate_op_comentario_(iNumLinha)
  {
    var nomeCampo_op_comentario_ = "op_comentario_" + iNumLinha;
    var var_op_comentario_ = scAjaxGetFieldText(nomeCampo_op_comentario_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_seleccion_operacion_convenio_validate_op_comentario_(var_op_comentario_, iNumLinha, var_script_case_init, do_ajax_form_fac_seleccion_operacion_convenio_validate_op_comentario__cb);
  } // do_ajax_form_fac_seleccion_operacion_convenio_validate_op_comentario_

  function do_ajax_form_fac_seleccion_operacion_convenio_validate_op_comentario__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_seleccion_operacion_convenio_validate_op_comentario__cb

  // ---------- Validate op_total_
  function do_ajax_form_fac_seleccion_operacion_convenio_validate_op_total_(iNumLinha)
  {
    var nomeCampo_op_total_ = "op_total_" + iNumLinha;
    var var_op_total_ = scAjaxGetFieldText(nomeCampo_op_total_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_seleccion_operacion_convenio_validate_op_total_(var_op_total_, iNumLinha, var_script_case_init, do_ajax_form_fac_seleccion_operacion_convenio_validate_op_total__cb);
  } // do_ajax_form_fac_seleccion_operacion_convenio_validate_op_total_

  function do_ajax_form_fac_seleccion_operacion_convenio_validate_op_total__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_seleccion_operacion_convenio_validate_op_total__cb

  // ---------- Validate op_estado_
  function do_ajax_form_fac_seleccion_operacion_convenio_validate_op_estado_(iNumLinha)
  {
    var nomeCampo_op_estado_ = "op_estado_" + iNumLinha;
    var var_op_estado_ = scAjaxGetFieldSelect(nomeCampo_op_estado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_seleccion_operacion_convenio_validate_op_estado_(var_op_estado_, iNumLinha, var_script_case_init, do_ajax_form_fac_seleccion_operacion_convenio_validate_op_estado__cb);
  } // do_ajax_form_fac_seleccion_operacion_convenio_validate_op_estado_

  function do_ajax_form_fac_seleccion_operacion_convenio_validate_op_estado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "op_estado_" + iLineNumber;
    }
    else
    {
      sFieldValid = "op_estado_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "op_estado_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "op_estado_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_seleccion_operacion_convenio_validate_op_estado__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_fac_seleccion_operacion_convenio_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_fac_seleccion_operacion_convenio_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_fac_seleccion_operacion_convenio_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_fac_seleccion_operacion_convenio_add_new_line_cb);
  } // do_ajax_form_fac_seleccion_operacion_convenio_add_new_line

  function do_ajax_form_fac_seleccion_operacion_convenio_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_fac_seleccion_operacion_convenio_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_fac_seleccion_operacion_convenio_backup_line(iNumLinha)
  {
    var var_op_operacion_ = scAjaxGetFieldText("op_operacion_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_seleccion_operacion_convenio_backup_line(var_op_operacion_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_fac_seleccion_operacion_convenio_backup_line_cb);
  } // do_ajax_form_fac_seleccion_operacion_convenio_backup_line

  function do_ajax_form_fac_seleccion_operacion_convenio_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_fac_seleccion_operacion_convenio_backup_line_cb

  function do_ajax_form_fac_seleccion_operacion_convenio_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_fac_seleccion_operacion_convenio_cancel_insert

  function do_ajax_form_fac_seleccion_operacion_convenio_cancel_update(iSeqVert)
  {
    do_ajax_form_fac_seleccion_operacion_convenio_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_fac_seleccion_operacion_convenio_cancel_update

  function do_ajax_form_fac_seleccion_operacion_convenio_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_fac_seleccion_operacion_convenio_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_fac_seleccion_operacion_convenio_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_fac_seleccion_operacion_convenio_table_refresh(var_op_operacion_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_seleccion_operacion_convenio_table_refresh_cb);
  } //  do_ajax_form_fac_seleccion_operacion_convenio_table_refresh

  function do_ajax_form_fac_seleccion_operacion_convenio_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_fac_seleccion_operacion_convenio_table_refresh_cb_after_alert);
  } // do_ajax_form_fac_seleccion_operacion_convenio_table_refresh_cb
  function do_ajax_form_fac_seleccion_operacion_convenio_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_fac_seleccion_operacion_convenio_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_fac_seleccion_operacion_convenio_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_fac_seleccion_operacion_convenio_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_op_contrato_ = scAjaxGetFieldSelect("op_contrato_" + iNumLinha);
    var var_op_operacion_ = scAjaxGetFieldText("op_operacion_" + iNumLinha);
    var var_op_fecha_ini_ = scAjaxGetFieldHidden("op_fecha_ini_" + iNumLinha);
    var var_op_tipo_cartera_ = scAjaxGetFieldSelect("op_tipo_cartera_" + iNumLinha);
    var var_op_propietario_ = scAjaxGetFieldSelect("op_propietario_" + iNumLinha);
    var var_op_comentario_ = scAjaxGetFieldText("op_comentario_" + iNumLinha);
    var var_op_total_ = scAjaxGetFieldText("op_total_" + iNumLinha);
    var var_op_estado_ = scAjaxGetFieldSelect("op_estado_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_fac_seleccion_operacion_convenio_submit_form(var_op_contrato_, var_op_operacion_, var_op_fecha_ini_, var_op_tipo_cartera_, var_op_propietario_, var_op_comentario_, var_op_total_, var_op_estado_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_fac_seleccion_operacion_convenio_submit_form_cb);
  } // do_ajax_form_fac_seleccion_operacion_convenio_submit_form

  function do_ajax_form_fac_seleccion_operacion_convenio_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("op_contrato_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("op_operacion_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("op_fecha_ini_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("op_tipo_cartera_" + sc_num_ult_line);
      ...
      scAjaxHideErrorDisplay("op_estado_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_fac_seleccion_operacion_convenio_submit_form_cb_after_alert);
  } // do_ajax_form_fac_seleccion_operacion_convenio_submit_form_cb
  function do_ajax_form_fac_seleccion_operacion_convenio_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_fac_seleccion_operacion_convenio_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_fac_seleccion_operacion_convenio_navigate_form()
  {
    perform_ajax_form_fac_seleccion_operacion_convenio_navigate_form();
  }

  function perform_ajax_form_fac_seleccion_operacion_convenio_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    {
      scAjaxHideErrorDisplay("op_contrato_" + iNavForm);
      scAjaxHideErrorDisplay("op_operacion_" + iNavForm);
      scAjaxHideErrorDisplay("op_fecha_ini_" + iNavForm);
      scAjaxHideErrorDisplay("op_tipo_cartera_" + iNavForm);
      ...
      scAjaxHideErrorDisplay("op_estado_" + iNavForm);
    }
    var var_op_operacion_ = document.F2.op_operacion_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_fac_seleccion_operacion_convenio_navigate_form(var_op_operacion_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_seleccion_operacion_convenio_navigate_form_cb);
  } // do_ajax_form_fac_seleccion_operacion_convenio_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_seleccion_operacion_convenio']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_fac_seleccion_operacion_convenio_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_fac_seleccion_operacion_convenio_navigate_form_cb_after_alert);
  } // do_ajax_form_fac_seleccion_operacion_convenio_navigate_form_cb
  function do_ajax_form_fac_seleccion_operacion_convenio_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_fac_seleccion_operacion_convenio_navigate_form_cb_after_alert

    function sc_form_fac_seleccion_operacion_convenio_get_last_line_number()
    {
    ...
    } //sc_form_fac_seleccion_operacion_convenio_get_last_line_number

  function sc_hide_form_fac_seleccion_operacion_convenio_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "op_contrato_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "op_operacion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "op_fecha_ini_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "op_tipo_cartera_" + iNumLinha;
    iTotCampos++;
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "op_estado_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["op_contrato_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_contrato'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["op_operacion_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_operacion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["op_tipo_cartera_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tipo_cartera'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["op_propietario_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_propietario'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["op_estado_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["op_contrato_"][iNumLinha] = "op_contrato_" + iNumLinha;
    ...
    ajax_field_mult["op_tipo_cartera_"][iNumLinha] = "op_tipo_cartera_" + iNumLinha;
    ...
    ajax_field_mult["op_estado_"][iNumLinha] = "op_estado_" + iNumLinha;
    ajax_field_id["op_contrato_" + iNumLinha] = new Array("hidden_field_label_op_contrato_", "hidden_field_data_op_contrato_" + iNumLinha);
    ajax_field_id["op_operacion_" + iNumLinha] = new Array("hidden_field_label_op_operacion_", "hidden_field_data_op_operacion_" + iNumLinha);
    ...
    ajax_field_id["op_tipo_cartera_" + iNumLinha] = new Array("hidden_field_label_op_tipo_cartera_", "hidden_field_data_op_tipo_cartera_" + iNumLinha);
    ajax_field_id["op_propietario_" + iNumLinha] = new Array("hidden_field_label_op_propietario_", "hidden_field_data_op_propietario_" + iNumLinha);
    ...
    ajax_field_id["op_estado_" + iNumLinha] = new Array("hidden_field_label_op_estado_", "hidden_field_data_op_estado_" + iNumLinha);
    ajax_error_count["op_contrato_" + iNumLinha] = "off";
    ajax_error_count["op_operacion_" + iNumLinha] = "off";
    ajax_error_count["op_fecha_ini_" + iNumLinha] = "off";
    ajax_error_count["op_tipo_cartera_" + iNumLinha] = "off";
    ...
    ajax_error_count["op_estado_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["op_contrato_" + iNumLinha] = "on";
    ajax_read_only["op_operacion_" + iNumLinha] = "on";
    ajax_read_only["op_fecha_ini_" + iNumLinha] = "off";
    ajax_read_only["op_tipo_cartera_" + iNumLinha] = "on";
    ...
    ajax_read_only["op_estado_" + iNumLinha] = "on";
<?php
}
else
{
...
?>
  ...
  {
    ajax_error_list["op_contrato_" + iNumLinha] = null;
    ajax_error_list["op_operacion_" + iNumLinha] = null;
    ajax_error_list["op_fecha_ini_" + iNumLinha] = null;
    ajax_error_list["op_tipo_cartera_" + iNumLinha] = null;
    ...
    ajax_error_list["op_estado_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["op_contrato_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["op_contrato_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["op_contrato_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["op_contrato_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["op_contrato_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["op_tipo_cartera_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["op_tipo_cartera_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["op_tipo_cartera_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["op_tipo_cartera_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["op_tipo_cartera_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["op_estado_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["op_estado_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["op_estado_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["op_estado_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["op_estado_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['op_contrato_'])) ? $this->nmgp_cmp_readonly['op_contrato_'] : 'on';
?>
    scAjaxFieldRead("op_contrato_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['op_tipo_cartera_'])) ? $this->nmgp_cmp_readonly['op_tipo_cartera_'] : 'on';
?>
    scAjaxFieldRead("op_tipo_cartera_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['op_propietario_'])) ? $this->nmgp_cmp_readonly['op_propietario_'] : 'on';
?>
    scAjaxFieldRead("op_propietario_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['op_comentario_'])) ? $this->nmgp_cmp_readonly['op_comentario_'] : 'on';
?>
    scAjaxFieldRead("op_comentario_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['op_total_'])) ? $this->nmgp_cmp_readonly['op_total_'] : 'on';
?>
    scAjaxFieldRead("op_total_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['op_estado_'])) ? $this->nmgp_cmp_readonly['op_estado_'] : 'on';
?>
    scAjaxFieldRead("op_estado_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("op_contrato_" + iSeq, "on");
    scAjaxFieldRead("op_operacion_" + iSeq, "on");
    scAjaxFieldRead("op_fecha_ini_" + iSeq, "on");
    scAjaxFieldRead("op_tipo_cartera_" + iSeq, "on");
    scAjaxFieldRead("op_propietario_" + iSeq, "on");
    scAjaxFieldRead("op_comentario_" + iSeq, "on");
    scAjaxFieldRead("op_total_" + iSeq, "on");
    scAjaxFieldRead("op_estado_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["op_contrato_" + iRow] || "on" == ajax_error_count["op_operacion_" + iRow] || "on" == ajax_error_count["op_fecha_ini_" + iRow] || "on" == ajax_error_count["op_tipo_cartera_" + iRow] || "on" == ajax_error_count["op_propietario_" + iRow] || "on" == ajax_error_count["op_comentario_" + iRow] || "on" == ajax_error_count["op_total_" + iRow] || "on" == ajax_error_count["op_estado_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_op_contrato_" + iRow).addClass("scFormErrorLine");
      ...
      $("#hidden_field_data_op_tipo_cartera_" + iRow).addClass("scFormErrorLine");
      ...
      $("#hidden_field_data_op_estado_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["op_contrato_" + iRow] && "off" == ajax_error_count["op_operacion_" + iRow] && "off" == ajax_error_count["op_fecha_ini_" + iRow] && "off" == ajax_error_count["op_tipo_cartera_" + iRow] && "off" == ajax_error_count["op_propietario_" + iRow] && "off" == ajax_error_count["op_comentario_" + iRow] && "off" == ajax_error_count["op_total_" + iRow] && "off" == ajax_error_count["op_estado_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["op_contrato_" + iRow] = "off";
        ajax_error_count["op_operacion_" + iRow] = "off";
        ajax_error_count["op_fecha_ini_" + iRow] = "off";
        ajax_error_count["op_tipo_cartera_" + iRow] = "off";
        ajax_error_count["op_propietario_" + iRow] = "off";
        ajax_error_count["op_comentario_" + iRow] = "off";
        ajax_error_count["op_total_" + iRow] = "off";
        ajax_error_count["op_estado_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_op_contrato_" + iRow).removeClass("scFormErrorLine");
      ...
      $("#hidden_field_data_op_tipo_cartera_" + iRow).removeClass("scFormErrorLine");
      ...
      $("#hidden_field_data_op_estado_" + iRow).removeClass("scFormErrorLine");
    }
  }
