  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sri_tipo_identificacion" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sri_tipo_identificacion_form();
	}
...
?>
  ...
  // ---------- Validate ti_codigo_
  function do_ajax_form_sri_tipo_identificacion_validate_ti_codigo_(iNumLinha)
  {
    var nomeCampo_ti_codigo_ = "ti_codigo_" + iNumLinha;
    var var_ti_codigo_ = scAjaxGetFieldText(nomeCampo_ti_codigo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tipo_identificacion_validate_ti_codigo_(var_ti_codigo_, iNumLinha, var_script_case_init, do_ajax_form_sri_tipo_identificacion_validate_ti_codigo__cb);
  } // do_ajax_form_sri_tipo_identificacion_validate_ti_codigo_

  function do_ajax_form_sri_tipo_identificacion_validate_ti_codigo__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "ti_codigo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ti_codigo_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "ti_codigo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ti_codigo_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_tipo_identificacion_validate_ti_codigo__cb

  // ---------- Validate ti_nombre_
  function do_ajax_form_sri_tipo_identificacion_validate_ti_nombre_(iNumLinha)
  {
    var nomeCampo_ti_nombre_ = "ti_nombre_" + iNumLinha;
    var var_ti_nombre_ = scAjaxGetFieldText(nomeCampo_ti_nombre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tipo_identificacion_validate_ti_nombre_(var_ti_nombre_, iNumLinha, var_script_case_init, do_ajax_form_sri_tipo_identificacion_validate_ti_nombre__cb);
  } // do_ajax_form_sri_tipo_identificacion_validate_ti_nombre_

  function do_ajax_form_sri_tipo_identificacion_validate_ti_nombre__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "ti_nombre_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ti_nombre_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "ti_nombre_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ti_nombre_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_tipo_identificacion_validate_ti_nombre__cb

  // ---------- Validate ti_estado_
  function do_ajax_form_sri_tipo_identificacion_validate_ti_estado_(iNumLinha)
  {
    var nomeCampo_ti_estado_ = "ti_estado_" + iNumLinha;
    var var_ti_estado_ = scAjaxGetFieldSelect(nomeCampo_ti_estado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tipo_identificacion_validate_ti_estado_(var_ti_estado_, iNumLinha, var_script_case_init, do_ajax_form_sri_tipo_identificacion_validate_ti_estado__cb);
  } // do_ajax_form_sri_tipo_identificacion_validate_ti_estado_

  function do_ajax_form_sri_tipo_identificacion_validate_ti_estado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "ti_estado_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ti_estado_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "ti_estado_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ti_estado_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_tipo_identificacion_validate_ti_estado__cb

  // ---------- Validate ti_cliente_
  function do_ajax_form_sri_tipo_identificacion_validate_ti_cliente_(iNumLinha)
  {
    var nomeCampo_ti_cliente_ = "ti_cliente_" + iNumLinha;
    var var_ti_cliente_ = scAjaxGetFieldSelect(nomeCampo_ti_cliente_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tipo_identificacion_validate_ti_cliente_(var_ti_cliente_, iNumLinha, var_script_case_init, do_ajax_form_sri_tipo_identificacion_validate_ti_cliente__cb);
  } // do_ajax_form_sri_tipo_identificacion_validate_ti_cliente_

  function do_ajax_form_sri_tipo_identificacion_validate_ti_cliente__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "ti_cliente_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ti_cliente_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "ti_cliente_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ti_cliente_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_tipo_identificacion_validate_ti_cliente__cb

  // ---------- Validate ti_proveedor_
  function do_ajax_form_sri_tipo_identificacion_validate_ti_proveedor_(iNumLinha)
  {
    var nomeCampo_ti_proveedor_ = "ti_proveedor_" + iNumLinha;
    var var_ti_proveedor_ = scAjaxGetFieldSelect(nomeCampo_ti_proveedor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tipo_identificacion_validate_ti_proveedor_(var_ti_proveedor_, iNumLinha, var_script_case_init, do_ajax_form_sri_tipo_identificacion_validate_ti_proveedor__cb);
  } // do_ajax_form_sri_tipo_identificacion_validate_ti_proveedor_

  function do_ajax_form_sri_tipo_identificacion_validate_ti_proveedor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "ti_proveedor_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ti_proveedor_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "ti_proveedor_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ti_proveedor_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_tipo_identificacion_validate_ti_proveedor__cb

  // ---------- Validate ti_transportista_
  function do_ajax_form_sri_tipo_identificacion_validate_ti_transportista_(iNumLinha)
  {
    var nomeCampo_ti_transportista_ = "ti_transportista_" + iNumLinha;
    var var_ti_transportista_ = scAjaxGetFieldSelect(nomeCampo_ti_transportista_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tipo_identificacion_validate_ti_transportista_(var_ti_transportista_, iNumLinha, var_script_case_init, do_ajax_form_sri_tipo_identificacion_validate_ti_transportista__cb);
  } // do_ajax_form_sri_tipo_identificacion_validate_ti_transportista_

  function do_ajax_form_sri_tipo_identificacion_validate_ti_transportista__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "ti_transportista_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ti_transportista_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "ti_transportista_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ti_transportista_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_tipo_identificacion_validate_ti_transportista__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_sri_tipo_identificacion_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_sri_tipo_identificacion_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sri_tipo_identificacion_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_sri_tipo_identificacion_add_new_line_cb);
  } // do_ajax_form_sri_tipo_identificacion_add_new_line

  function do_ajax_form_sri_tipo_identificacion_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_sri_tipo_identificacion_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_sri_tipo_identificacion_backup_line(iNumLinha)
  {
    var var_ti_codigo_ = scAjaxGetFieldText("ti_codigo_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tipo_identificacion_backup_line(var_ti_codigo_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_sri_tipo_identificacion_backup_line_cb);
  } // do_ajax_form_sri_tipo_identificacion_backup_line

  function do_ajax_form_sri_tipo_identificacion_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_sri_tipo_identificacion_backup_line_cb

  function do_ajax_form_sri_tipo_identificacion_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_sri_tipo_identificacion_cancel_insert

  function do_ajax_form_sri_tipo_identificacion_cancel_update(iSeqVert)
  {
    do_ajax_form_sri_tipo_identificacion_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_sri_tipo_identificacion_cancel_update

  function do_ajax_form_sri_tipo_identificacion_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_sri_tipo_identificacion_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_sri_tipo_identificacion_table_refresh()
  {
    var var_ti_codigo_ = document.F2.ti_codigo_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_sri_tipo_identificacion_table_refresh(var_ti_codigo_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sri_tipo_identificacion_table_refresh_cb);
  } //  do_ajax_form_sri_tipo_identificacion_table_refresh

  function do_ajax_form_sri_tipo_identificacion_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.ti_codigo_.value = scAjaxGetKeyValue("ti_codigo_");
    ...
    scAjaxAlert(do_ajax_form_sri_tipo_identificacion_table_refresh_cb_after_alert);
  } // do_ajax_form_sri_tipo_identificacion_table_refresh_cb
  function do_ajax_form_sri_tipo_identificacion_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_sri_tipo_identificacion_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_sri_tipo_identificacion_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_sri_tipo_identificacion_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_ti_codigo_ = scAjaxGetFieldText("ti_codigo_" + iNumLinha);
    var var_ti_nombre_ = scAjaxGetFieldText("ti_nombre_" + iNumLinha);
    var var_ti_estado_ = scAjaxGetFieldSelect("ti_estado_" + iNumLinha);
    var var_ti_cliente_ = scAjaxGetFieldSelect("ti_cliente_" + iNumLinha);
    var var_ti_proveedor_ = scAjaxGetFieldSelect("ti_proveedor_" + iNumLinha);
    var var_ti_transportista_ = scAjaxGetFieldSelect("ti_transportista_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_sri_tipo_identificacion_submit_form(var_ti_codigo_, var_ti_nombre_, var_ti_estado_, var_ti_cliente_, var_ti_proveedor_, var_ti_transportista_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sri_tipo_identificacion_submit_form_cb);
  } // do_ajax_form_sri_tipo_identificacion_submit_form

  function do_ajax_form_sri_tipo_identificacion_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("ti_codigo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("ti_nombre_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("ti_estado_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("ti_cliente_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("ti_proveedor_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("ti_transportista_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sri_tipo_identificacion_submit_form_cb_after_alert);
  } // do_ajax_form_sri_tipo_identificacion_submit_form_cb
  function do_ajax_form_sri_tipo_identificacion_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sri_tipo_identificacion_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sri_tipo_identificacion_navigate_form()
  {
    perform_ajax_form_sri_tipo_identificacion_navigate_form();
  }

  function perform_ajax_form_sri_tipo_identificacion_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_sri_tipo_identificacion_cancel_insert(sc_form_sri_tipo_identificacion_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("ti_codigo_" + iNavForm);
      scAjaxHideErrorDisplay("ti_nombre_" + iNavForm);
      scAjaxHideErrorDisplay("ti_estado_" + iNavForm);
      scAjaxHideErrorDisplay("ti_cliente_" + iNavForm);
      scAjaxHideErrorDisplay("ti_proveedor_" + iNavForm);
      scAjaxHideErrorDisplay("ti_transportista_" + iNavForm);
    }
    var var_ti_codigo_ = document.F2.ti_codigo_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sri_tipo_identificacion_navigate_form(var_ti_codigo_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sri_tipo_identificacion_navigate_form_cb);
  } // do_ajax_form_sri_tipo_identificacion_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sri_tipo_identificacion']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sri_tipo_identificacion_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.ti_codigo_.value = scAjaxGetKeyValue("ti_codigo_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sri_tipo_identificacion_navigate_form_cb_after_alert);
  } // do_ajax_form_sri_tipo_identificacion_navigate_form_cb
  function do_ajax_form_sri_tipo_identificacion_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_sri_tipo_identificacion_navigate_form_cb_after_alert

    function sc_form_sri_tipo_identificacion_get_last_line_number()
    {
    ...
    } //sc_form_sri_tipo_identificacion_get_last_line_number

  function sc_hide_form_sri_tipo_identificacion_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "ti_codigo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "ti_nombre_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "ti_estado_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "ti_cliente_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "ti_proveedor_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "ti_transportista_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["ti_codigo_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_codigo'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["ti_nombre_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_descripcion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["ti_estado_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["ti_cliente_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_presente_cliente'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["ti_proveedor_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_presente_proveedor'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["ti_transportista_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_presente_transportista'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["ti_codigo_"][iNumLinha] = "ti_codigo_" + iNumLinha;
    ajax_field_mult["ti_nombre_"][iNumLinha] = "ti_nombre_" + iNumLinha;
    ajax_field_mult["ti_estado_"][iNumLinha] = "ti_estado_" + iNumLinha;
    ajax_field_mult["ti_cliente_"][iNumLinha] = "ti_cliente_" + iNumLinha;
    ajax_field_mult["ti_proveedor_"][iNumLinha] = "ti_proveedor_" + iNumLinha;
    ajax_field_mult["ti_transportista_"][iNumLinha] = "ti_transportista_" + iNumLinha;
    ajax_field_id["ti_codigo_" + iNumLinha] = new Array("hidden_field_label_ti_codigo_", "hidden_field_data_ti_codigo_" + iNumLinha);
    ajax_field_id["ti_nombre_" + iNumLinha] = new Array("hidden_field_label_ti_nombre_", "hidden_field_data_ti_nombre_" + iNumLinha);
    ajax_field_id["ti_estado_" + iNumLinha] = new Array("hidden_field_label_ti_estado_", "hidden_field_data_ti_estado_" + iNumLinha);
    ajax_field_id["ti_cliente_" + iNumLinha] = new Array("hidden_field_label_ti_cliente_", "hidden_field_data_ti_cliente_" + iNumLinha);
    ajax_field_id["ti_proveedor_" + iNumLinha] = new Array("hidden_field_label_ti_proveedor_", "hidden_field_data_ti_proveedor_" + iNumLinha);
    ajax_field_id["ti_transportista_" + iNumLinha] = new Array("hidden_field_label_ti_transportista_", "hidden_field_data_ti_transportista_" + iNumLinha);
    ajax_error_count["ti_codigo_" + iNumLinha] = "off";
    ajax_error_count["ti_nombre_" + iNumLinha] = "off";
    ajax_error_count["ti_estado_" + iNumLinha] = "off";
    ajax_error_count["ti_cliente_" + iNumLinha] = "off";
    ajax_error_count["ti_proveedor_" + iNumLinha] = "off";
    ajax_error_count["ti_transportista_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["ti_codigo_" + iNumLinha] = "on";
    ajax_read_only["ti_nombre_" + iNumLinha] = "off";
    ajax_read_only["ti_estado_" + iNumLinha] = "off";
    ajax_read_only["ti_cliente_" + iNumLinha] = "off";
    ajax_read_only["ti_proveedor_" + iNumLinha] = "off";
    ajax_read_only["ti_transportista_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["ti_codigo_" + iNumLinha] = "on";
    ajax_read_only["ti_nombre_" + iNumLinha] = "on";
    ajax_read_only["ti_estado_" + iNumLinha] = "on";
    ajax_read_only["ti_cliente_" + iNumLinha] = "on";
    ajax_read_only["ti_proveedor_" + iNumLinha] = "on";
    ajax_read_only["ti_transportista_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["ti_codigo_" + iNumLinha] = null;
    ajax_error_list["ti_nombre_" + iNumLinha] = null;
    ajax_error_list["ti_estado_" + iNumLinha] = null;
    ajax_error_list["ti_cliente_" + iNumLinha] = null;
    ajax_error_list["ti_proveedor_" + iNumLinha] = null;
    ajax_error_list["ti_transportista_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "ti_codigo_": new Array(),
    "ti_nombre_": new Array(),
    "ti_estado_": new Array(),
    "ti_cliente_": new Array(),
    "ti_proveedor_": new Array(),
    "ti_transportista_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["ti_codigo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ti_codigo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ti_codigo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ti_codigo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ti_codigo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["ti_nombre_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ti_nombre_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ti_nombre_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ti_nombre_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ti_nombre_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["ti_estado_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ti_estado_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ti_estado_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ti_estado_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ti_estado_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["ti_cliente_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ti_cliente_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ti_cliente_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ti_cliente_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ti_cliente_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["ti_proveedor_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ti_proveedor_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ti_proveedor_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ti_proveedor_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ti_proveedor_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["ti_transportista_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ti_transportista_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ti_transportista_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ti_transportista_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ti_transportista_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ti_codigo_'])) ? $this->nmgp_cmp_readonly['ti_codigo_'] : 'on';
?>
    scAjaxFieldRead("ti_codigo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ti_nombre_'])) ? $this->nmgp_cmp_readonly['ti_nombre_'] : 'off';
?>
    scAjaxFieldRead("ti_nombre_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ti_estado_'])) ? $this->nmgp_cmp_readonly['ti_estado_'] : 'off';
?>
    scAjaxFieldRead("ti_estado_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ti_cliente_'])) ? $this->nmgp_cmp_readonly['ti_cliente_'] : 'off';
?>
    scAjaxFieldRead("ti_cliente_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ti_proveedor_'])) ? $this->nmgp_cmp_readonly['ti_proveedor_'] : 'off';
?>
    scAjaxFieldRead("ti_proveedor_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ti_transportista_'])) ? $this->nmgp_cmp_readonly['ti_transportista_'] : 'off';
?>
    scAjaxFieldRead("ti_transportista_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("ti_codigo_" + iSeq, "on");
    scAjaxFieldRead("ti_nombre_" + iSeq, "on");
    scAjaxFieldRead("ti_estado_" + iSeq, "on");
    scAjaxFieldRead("ti_cliente_" + iSeq, "on");
    scAjaxFieldRead("ti_proveedor_" + iSeq, "on");
    scAjaxFieldRead("ti_transportista_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["ti_codigo_" + iRow] || "on" == ajax_error_count["ti_nombre_" + iRow] || "on" == ajax_error_count["ti_estado_" + iRow] || "on" == ajax_error_count["ti_cliente_" + iRow] || "on" == ajax_error_count["ti_proveedor_" + iRow] || "on" == ajax_error_count["ti_transportista_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ti_codigo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ti_nombre_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ti_estado_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ti_cliente_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ti_proveedor_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ti_transportista_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["ti_codigo_" + iRow] && "off" == ajax_error_count["ti_nombre_" + iRow] && "off" == ajax_error_count["ti_estado_" + iRow] && "off" == ajax_error_count["ti_cliente_" + iRow] && "off" == ajax_error_count["ti_proveedor_" + iRow] && "off" == ajax_error_count["ti_transportista_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["ti_codigo_" + iRow] = "off";
        ajax_error_count["ti_nombre_" + iRow] = "off";
        ajax_error_count["ti_estado_" + iRow] = "off";
        ajax_error_count["ti_cliente_" + iRow] = "off";
        ajax_error_count["ti_proveedor_" + iRow] = "off";
        ajax_error_count["ti_transportista_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_ti_codigo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_ti_nombre_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_ti_estado_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_ti_cliente_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_ti_proveedor_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_ti_transportista_" + iRow).removeClass("scFormErrorLine");
    }
  }
