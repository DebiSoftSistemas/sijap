...
$old_error_handler = set_error_handler("form_inv_productos_transferencia_recibir_scriptcase_error_handler");

function form_inv_productos_transferencia_recibir_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['form_inv_productos_transferencia_recibir']['contr_erro']) && $_SESSION['scriptcase']['form_inv_productos_transferencia_recibir']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_inv_productos_transferencia_recibir->contr_form_inv_productos_transferencia_recibir->Apl_com_erro = true;
            if ($inicial_form_inv_productos_transferencia_recibir->contr_form_inv_productos_transferencia_recibir->NM_ajax_flag)
            {
                $inicial_form_inv_productos_transferencia_recibir->contr_form_inv_productos_transferencia_recibir->NM_ajax_info['errList']['geral_form_inv_productos_transferencia_recibir'][] = $msg;
                return;
            }
            form_inv_productos_transferencia_recibir_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_inv_productos_transferencia_recibir_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_inv_productos_transferencia_recibir'])  && '' != $_SESSION['scriptcase']['error_icon']['form_inv_productos_transferencia_recibir'])  ? $_SESSION['scriptcase']['error_icon']['form_inv_productos_transferencia_recibir']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_inv_productos_transferencia_recibir']) && '' != $_SESSION['scriptcase']['error_span_title']['form_inv_productos_transferencia_recibir']) ? $_SESSION['scriptcase']['error_span_title']['form_inv_productos_transferencia_recibir'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_inv_productos_transferencia_recibir']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_inv_productos_transferencia_recibir']) ? $_SESSION['scriptcase']['error_icon_title']['form_inv_productos_transferencia_recibir'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_inv_productos_transferencia_recibir']['error_buffer'] .= ob_get_flush();
}
