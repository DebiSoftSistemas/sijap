<?php
@session_start() ;
$_SESSION['scriptcase']['grid_predios_inspeccion_ap']['sc_process_barr'] = true;
require_once('../grid_predios_inspeccion_ap/index.php');
unset($_SESSION['scriptcase']['grid_predios_inspeccion_ap']['sc_process_barr']);
$ExportCtrl = new grid_predios_inspeccion_ap_export_control;
$ExportCtrl->Export_barr();

class grid_predios_inspeccion_ap_export_control
{
