...
<html>
    <head>
        ...
        <title>{lang_empresa}s</title>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["mnu_empresas"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile.min.css" />
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["mnu_empresas"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["mnu_empresas"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile.min.js"></script>
    <style>
    <?php
    if(isset($mnu_empresas_menuData["data"]) && is_array($mnu_empresas_menuData["data"]) && !empty($mnu_empresas_menuData["data"]))
    {
        foreach($mnu_empresas_menuData["data"] as $arr_item)
        {
   ...
   <TABLE width="100%" class="scMenuHHeader">
    ...
    <?php
        escreveMenuMobile($mnu_empresas_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
