  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_forma_pago_sustento_retencion" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_forma_pago_sustento_retencion_form();
	}
...
?>
  ...
  // ---------- Validate psr_id_
  function do_ajax_form_del_forma_pago_sustento_retencion_validate_psr_id_(iNumLinha)
  {
    var nomeCampo_psr_id_ = "psr_id_" + iNumLinha;
    var var_psr_id_ = scAjaxGetFieldHidden(nomeCampo_psr_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_sustento_retencion_validate_psr_id_(var_psr_id_, iNumLinha, var_script_case_init, do_ajax_form_del_forma_pago_sustento_retencion_validate_psr_id__cb);
  } // do_ajax_form_del_forma_pago_sustento_retencion_validate_psr_id_

  function do_ajax_form_del_forma_pago_sustento_retencion_validate_psr_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "psr_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "psr_id_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "psr_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "psr_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_sustento_retencion_validate_psr_id__cb

  // ---------- Validate psr_sustento_retencion_
  function do_ajax_form_del_forma_pago_sustento_retencion_validate_psr_sustento_retencion_(iNumLinha)
  {
    var nomeCampo_psr_sustento_retencion_ = "psr_sustento_retencion_" + iNumLinha;
    var var_psr_sustento_retencion_ = scAjaxGetFieldText(nomeCampo_psr_sustento_retencion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_sustento_retencion_validate_psr_sustento_retencion_(var_psr_sustento_retencion_, iNumLinha, var_script_case_init, do_ajax_form_del_forma_pago_sustento_retencion_validate_psr_sustento_retencion__cb);
  } // do_ajax_form_del_forma_pago_sustento_retencion_validate_psr_sustento_retencion_

  function do_ajax_form_del_forma_pago_sustento_retencion_validate_psr_sustento_retencion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "psr_sustento_retencion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "psr_sustento_retencion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "psr_sustento_retencion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "psr_sustento_retencion_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_sustento_retencion_validate_psr_sustento_retencion__cb

  // ---------- Validate psr_forma_pago_
  function do_ajax_form_del_forma_pago_sustento_retencion_validate_psr_forma_pago_(iNumLinha)
  {
    var nomeCampo_psr_forma_pago_ = "psr_forma_pago_" + iNumLinha;
    var var_psr_forma_pago_ = scAjaxGetFieldSelect(nomeCampo_psr_forma_pago_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_sustento_retencion_validate_psr_forma_pago_(var_psr_forma_pago_, iNumLinha, var_script_case_init, do_ajax_form_del_forma_pago_sustento_retencion_validate_psr_forma_pago__cb);
  } // do_ajax_form_del_forma_pago_sustento_retencion_validate_psr_forma_pago_

  function do_ajax_form_del_forma_pago_sustento_retencion_validate_psr_forma_pago__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "psr_forma_pago_" + iLineNumber;
    }
    else
    {
      sFieldValid = "psr_forma_pago_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "psr_forma_pago_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "psr_forma_pago_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_sustento_retencion_validate_psr_forma_pago__cb

  // ---------- Validate psr_valor_pago_
  function do_ajax_form_del_forma_pago_sustento_retencion_validate_psr_valor_pago_(iNumLinha)
  {
    var nomeCampo_psr_valor_pago_ = "psr_valor_pago_" + iNumLinha;
    var var_psr_valor_pago_ = scAjaxGetFieldText(nomeCampo_psr_valor_pago_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_sustento_retencion_validate_psr_valor_pago_(var_psr_valor_pago_, iNumLinha, var_script_case_init, do_ajax_form_del_forma_pago_sustento_retencion_validate_psr_valor_pago__cb);
  } // do_ajax_form_del_forma_pago_sustento_retencion_validate_psr_valor_pago_

  function do_ajax_form_del_forma_pago_sustento_retencion_validate_psr_valor_pago__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "psr_valor_pago_" + iLineNumber;
    }
    else
    {
      sFieldValid = "psr_valor_pago_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "psr_valor_pago_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "psr_valor_pago_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_sustento_retencion_validate_psr_valor_pago__cb

  // ---------- Validate psr_estado_
  function do_ajax_form_del_forma_pago_sustento_retencion_validate_psr_estado_(iNumLinha)
  {
    var nomeCampo_psr_estado_ = "psr_estado_" + iNumLinha;
    var var_psr_estado_ = scAjaxGetFieldSelect(nomeCampo_psr_estado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_sustento_retencion_validate_psr_estado_(var_psr_estado_, iNumLinha, var_script_case_init, do_ajax_form_del_forma_pago_sustento_retencion_validate_psr_estado__cb);
  } // do_ajax_form_del_forma_pago_sustento_retencion_validate_psr_estado_

  function do_ajax_form_del_forma_pago_sustento_retencion_validate_psr_estado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "psr_estado_" + iLineNumber;
    }
    else
    {
      sFieldValid = "psr_estado_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "psr_estado_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "psr_estado_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_sustento_retencion_validate_psr_estado__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_del_forma_pago_sustento_retencion_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_del_forma_pago_sustento_retencion_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_forma_pago_sustento_retencion_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_del_forma_pago_sustento_retencion_add_new_line_cb);
  } // do_ajax_form_del_forma_pago_sustento_retencion_add_new_line

  function do_ajax_form_del_forma_pago_sustento_retencion_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_del_forma_pago_sustento_retencion_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_del_forma_pago_sustento_retencion_backup_line(iNumLinha)
  {
    var var_psr_id_ = scAjaxGetFieldHidden("psr_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_sustento_retencion_backup_line(var_psr_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_del_forma_pago_sustento_retencion_backup_line_cb);
  } // do_ajax_form_del_forma_pago_sustento_retencion_backup_line

  function do_ajax_form_del_forma_pago_sustento_retencion_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_del_forma_pago_sustento_retencion_backup_line_cb

  function do_ajax_form_del_forma_pago_sustento_retencion_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_del_forma_pago_sustento_retencion_cancel_insert

  function do_ajax_form_del_forma_pago_sustento_retencion_cancel_update(iSeqVert)
  {
    do_ajax_form_del_forma_pago_sustento_retencion_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_del_forma_pago_sustento_retencion_cancel_update

  function do_ajax_form_del_forma_pago_sustento_retencion_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_del_forma_pago_sustento_retencion_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_del_forma_pago_sustento_retencion_table_refresh()
  {
    var var_psr_id_ = document.F2.psr_id_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_del_forma_pago_sustento_retencion_table_refresh(var_psr_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_forma_pago_sustento_retencion_table_refresh_cb);
  } //  do_ajax_form_del_forma_pago_sustento_retencion_table_refresh

  function do_ajax_form_del_forma_pago_sustento_retencion_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.psr_id_.value = scAjaxGetKeyValue("psr_id_");
    ...
    scAjaxAlert(do_ajax_form_del_forma_pago_sustento_retencion_table_refresh_cb_after_alert);
  } // do_ajax_form_del_forma_pago_sustento_retencion_table_refresh_cb
  function do_ajax_form_del_forma_pago_sustento_retencion_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_del_forma_pago_sustento_retencion_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_del_forma_pago_sustento_retencion_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_del_forma_pago_sustento_retencion_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_psr_id_ = scAjaxGetFieldHidden("psr_id_" + iNumLinha);
    var var_psr_sustento_retencion_ = scAjaxGetFieldText("psr_sustento_retencion_" + iNumLinha);
    var var_psr_forma_pago_ = scAjaxGetFieldSelect("psr_forma_pago_" + iNumLinha);
    var var_psr_valor_pago_ = scAjaxGetFieldText("psr_valor_pago_" + iNumLinha);
    var var_psr_estado_ = scAjaxGetFieldSelect("psr_estado_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_del_forma_pago_sustento_retencion_submit_form(var_psr_id_, var_psr_sustento_retencion_, var_psr_forma_pago_, var_psr_valor_pago_, var_psr_estado_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_forma_pago_sustento_retencion_submit_form_cb);
  } // do_ajax_form_del_forma_pago_sustento_retencion_submit_form

  function do_ajax_form_del_forma_pago_sustento_retencion_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("psr_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("psr_sustento_retencion_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("psr_forma_pago_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("psr_valor_pago_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("psr_estado_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_forma_pago_sustento_retencion_submit_form_cb_after_alert);
  } // do_ajax_form_del_forma_pago_sustento_retencion_submit_form_cb
  function do_ajax_form_del_forma_pago_sustento_retencion_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_forma_pago_sustento_retencion_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_forma_pago_sustento_retencion_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_del_forma_pago_sustento_retencion_navigate_form, function() {});
    } else {
      perform_ajax_form_del_forma_pago_sustento_retencion_navigate_form();
    }
  }

  function perform_ajax_form_del_forma_pago_sustento_retencion_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_del_forma_pago_sustento_retencion_cancel_insert(sc_form_del_forma_pago_sustento_retencion_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("psr_id_" + iNavForm);
      scAjaxHideErrorDisplay("psr_sustento_retencion_" + iNavForm);
      scAjaxHideErrorDisplay("psr_forma_pago_" + iNavForm);
      scAjaxHideErrorDisplay("psr_valor_pago_" + iNavForm);
      scAjaxHideErrorDisplay("psr_estado_" + iNavForm);
    }
    var var_psr_id_ = document.F2.psr_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_forma_pago_sustento_retencion_navigate_form(var_psr_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_forma_pago_sustento_retencion_navigate_form_cb);
  } // do_ajax_form_del_forma_pago_sustento_retencion_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_forma_pago_sustento_retencion']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_forma_pago_sustento_retencion_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.psr_id_.value = scAjaxGetKeyValue("psr_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_forma_pago_sustento_retencion_navigate_form_cb_after_alert);
  } // do_ajax_form_del_forma_pago_sustento_retencion_navigate_form_cb
  function do_ajax_form_del_forma_pago_sustento_retencion_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_del_forma_pago_sustento_retencion_navigate_form_cb_after_alert

    function sc_form_del_forma_pago_sustento_retencion_get_last_line_number()
    {
    ...
    } //sc_form_del_forma_pago_sustento_retencion_get_last_line_number

  function sc_hide_form_del_forma_pago_sustento_retencion_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "psr_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "psr_sustento_retencion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "psr_forma_pago_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "psr_valor_pago_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "psr_estado_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["psr_id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["psr_sustento_retencion_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_sustento'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["psr_forma_pago_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_forma_pago'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["psr_valor_pago_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_valor'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["psr_estado_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["psr_id_"][iNumLinha] = "psr_id_" + iNumLinha;
    ajax_field_mult["psr_sustento_retencion_"][iNumLinha] = "psr_sustento_retencion_" + iNumLinha;
    ajax_field_mult["psr_forma_pago_"][iNumLinha] = "psr_forma_pago_" + iNumLinha;
    ajax_field_mult["psr_valor_pago_"][iNumLinha] = "psr_valor_pago_" + iNumLinha;
    ajax_field_mult["psr_estado_"][iNumLinha] = "psr_estado_" + iNumLinha;
    ajax_field_id["psr_forma_pago_" + iNumLinha] = new Array("hidden_field_label_psr_forma_pago_", "hidden_field_data_psr_forma_pago_" + iNumLinha);
    ajax_field_id["psr_valor_pago_" + iNumLinha] = new Array("hidden_field_label_psr_valor_pago_", "hidden_field_data_psr_valor_pago_" + iNumLinha);
    ajax_field_id["psr_estado_" + iNumLinha] = new Array("hidden_field_label_psr_estado_", "hidden_field_data_psr_estado_" + iNumLinha);
    ajax_error_count["psr_id_" + iNumLinha] = "off";
    ajax_error_count["psr_sustento_retencion_" + iNumLinha] = "off";
    ajax_error_count["psr_forma_pago_" + iNumLinha] = "off";
    ajax_error_count["psr_valor_pago_" + iNumLinha] = "off";
    ajax_error_count["psr_estado_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["psr_id_" + iNumLinha] = "on";
    ajax_read_only["psr_sustento_retencion_" + iNumLinha] = "off";
    ajax_read_only["psr_forma_pago_" + iNumLinha] = "off";
    ajax_read_only["psr_valor_pago_" + iNumLinha] = "off";
    ajax_read_only["psr_estado_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["psr_id_" + iNumLinha] = "on";
    ajax_read_only["psr_sustento_retencion_" + iNumLinha] = "on";
    ajax_read_only["psr_forma_pago_" + iNumLinha] = "on";
    ajax_read_only["psr_valor_pago_" + iNumLinha] = "on";
    ajax_read_only["psr_estado_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["psr_id_" + iNumLinha] = null;
    ajax_error_list["psr_sustento_retencion_" + iNumLinha] = null;
    ajax_error_list["psr_forma_pago_" + iNumLinha] = null;
    ajax_error_list["psr_valor_pago_" + iNumLinha] = null;
    ajax_error_list["psr_estado_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "psr_id_": new Array(),
    "psr_sustento_retencion_": new Array(),
    "psr_forma_pago_": new Array(),
    "psr_valor_pago_": new Array(),
    "psr_estado_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["psr_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["psr_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["psr_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["psr_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["psr_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["psr_sustento_retencion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["psr_sustento_retencion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["psr_sustento_retencion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["psr_sustento_retencion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["psr_sustento_retencion_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["psr_forma_pago_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["psr_forma_pago_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["psr_forma_pago_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["psr_forma_pago_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["psr_forma_pago_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["psr_valor_pago_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["psr_valor_pago_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["psr_valor_pago_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["psr_valor_pago_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["psr_valor_pago_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["psr_estado_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["psr_estado_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["psr_estado_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["psr_estado_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["psr_estado_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['psr_id_'])) ? $this->nmgp_cmp_readonly['psr_id_'] : 'on';
?>
    scAjaxFieldRead("psr_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['psr_sustento_retencion_'])) ? $this->nmgp_cmp_readonly['psr_sustento_retencion_'] : 'off';
?>
    scAjaxFieldRead("psr_sustento_retencion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['psr_forma_pago_'])) ? $this->nmgp_cmp_readonly['psr_forma_pago_'] : 'off';
?>
    scAjaxFieldRead("psr_forma_pago_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['psr_valor_pago_'])) ? $this->nmgp_cmp_readonly['psr_valor_pago_'] : 'off';
?>
    scAjaxFieldRead("psr_valor_pago_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['psr_estado_'])) ? $this->nmgp_cmp_readonly['psr_estado_'] : 'off';
?>
    scAjaxFieldRead("psr_estado_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("psr_id_" + iSeq, "on");
    scAjaxFieldRead("psr_sustento_retencion_" + iSeq, "on");
    scAjaxFieldRead("psr_forma_pago_" + iSeq, "on");
    scAjaxFieldRead("psr_valor_pago_" + iSeq, "on");
    scAjaxFieldRead("psr_estado_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["psr_id_" + iRow] || "on" == ajax_error_count["psr_sustento_retencion_" + iRow] || "on" == ajax_error_count["psr_forma_pago_" + iRow] || "on" == ajax_error_count["psr_valor_pago_" + iRow] || "on" == ajax_error_count["psr_estado_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_psr_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_psr_sustento_retencion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_psr_forma_pago_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_psr_valor_pago_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_psr_estado_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["psr_id_" + iRow] && "off" == ajax_error_count["psr_sustento_retencion_" + iRow] && "off" == ajax_error_count["psr_forma_pago_" + iRow] && "off" == ajax_error_count["psr_valor_pago_" + iRow] && "off" == ajax_error_count["psr_estado_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["psr_id_" + iRow] = "off";
        ajax_error_count["psr_sustento_retencion_" + iRow] = "off";
        ajax_error_count["psr_forma_pago_" + iRow] = "off";
        ajax_error_count["psr_valor_pago_" + iRow] = "off";
        ajax_error_count["psr_estado_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_psr_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_psr_sustento_retencion_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_psr_forma_pago_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_psr_valor_pago_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_psr_estado_" + iRow).removeClass("scFormErrorLine");
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("psr_sustento_retencion_" == sIndex)
    {
