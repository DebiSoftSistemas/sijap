<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_jap_contratos_legalizar']['glo_nm_path_imag_temp'] . "/sc_apl_default_SIJAP.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_jap_contratos_legalizar_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_jap_contratos_legalizar_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['con_id'] = "on";
   $tab_def_campos['con_id'] = "con_id";
   $tab_labels["con_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['labels']["con_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['labels']["con_id"] : "" . $this->Nm_lang['lang_solicitud'] . "";
   $tab_ger_campos['con_nombre'] = "on";
   $tab_def_campos['con_nombre'] = "con_nombre";
   $tab_labels["con_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['labels']["con_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['labels']["con_nombre"] : "" . $this->Nm_lang['lang_lot_nombre_completo'] . "";
   $tab_ger_campos['con_cedula'] = "on";
   $tab_def_campos['con_cedula'] = "con_cedula";
   $tab_labels["con_cedula"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['labels']["con_cedula"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['labels']["con_cedula"] : "" . $this->Nm_lang['lang_cedula'] . "";
   $tab_ger_campos['con_telefono'] = "on";
   $tab_def_campos['con_telefono'] = "con_telefono";
   $tab_labels["con_telefono"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['labels']["con_telefono"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['labels']["con_telefono"] : "" . $this->Nm_lang['lang_lot_telefono'] . "";
   $tab_ger_campos['con_correo'] = "on";
   $tab_def_campos['con_correo'] = "con_correo";
   $tab_labels["con_correo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['labels']["con_correo"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['labels']["con_correo"] : "" . $this->Nm_lang['lang_email'] . "";
   $tab_ger_campos['con_toma_administrativa'] = "on";
   $tab_def_campos['con_toma_administrativa'] = "con_toma_administrativa";
   $tab_labels["con_toma_administrativa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['labels']["con_toma_administrativa"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['labels']["con_toma_administrativa"] : "" . $this->Nm_lang['lang_toma_administrativa'] . "";
   $tab_ger_campos['con_toma_operativa'] = "on";
   $tab_def_campos['con_toma_operativa'] = "con_toma_operativa";
   $tab_labels["con_toma_operativa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['labels']["con_toma_operativa"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['labels']["con_toma_operativa"] : "" . $this->Nm_lang['lang_toma_operativa'] . "";
   $tab_ger_campos['con_tipo_servicio'] = "on";
   $tab_def_campos['con_tipo_servicio'] = "con_tipo_servicio";
   $tab_labels["con_tipo_servicio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['labels']["con_tipo_servicio"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['labels']["con_tipo_servicio"] : "" . $this->Nm_lang['lang_tipo_servicio'] . "";
   $tab_ger_campos['con_direccion_predio'] = "on";
   $tab_def_campos['con_direccion_predio'] = "con_direccion_predio";
   $tab_labels["con_direccion_predio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['labels']["con_direccion_predio"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['labels']["con_direccion_predio"] : "" . $this->Nm_lang['lang_direccion_predio'] . "";
   $tab_ger_campos['con_condicion_contrato'] = "on";
   $tab_def_campos['con_condicion_contrato'] = "con_condicion_contrato";
   $tab_labels["con_condicion_contrato"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['labels']["con_condicion_contrato"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['labels']["con_condicion_contrato"] : "" . $this->Nm_lang['lang_condicion_contrato'] . "";
   $tab_ger_campos['con_numero_censo'] = "on";
   $tab_def_campos['con_numero_censo'] = "con_numero_censo";
   $tab_labels["con_numero_censo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['labels']["con_numero_censo"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['labels']["con_numero_censo"] : "" . $this->Nm_lang['lang_numero_censo'] . "";
   $tab_ger_campos['con_estado'] = "on";
   $tab_def_campos['con_estado'] = "con_estado";
   $tab_labels["con_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['labels']["con_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['labels']["con_estado"] : "" . $this->Nm_lang['lang_estado'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_legalizacion_contrato'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_jap_contratos_legalizar_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_jap_contratos_legalizar']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
