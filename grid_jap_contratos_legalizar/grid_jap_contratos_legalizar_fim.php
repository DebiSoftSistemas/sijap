...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_jap_contratos_legalizar"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_jap_contratos_legalizar"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_jap_contrato'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_jap_contratos_legalizar']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_jap_contratos_legalizar']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_jap_contratos_legalizar']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_jap_contratos_legalizar']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_jap_contratos_legalizar']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_jap_contratos_legalizar</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_jap_contratos_legalizar']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_jap_contratos_legalizar']['embutida_filho'] as $ind => $sc_init)
          {
