<?php
@session_start() ;
$_SESSION['scriptcase']['grid_jap_contratos_legalizar']['sc_process_barr'] = true;
require_once('../grid_jap_contratos_legalizar/index.php');
unset($_SESSION['scriptcase']['grid_jap_contratos_legalizar']['sc_process_barr']);
$ExportCtrl = new grid_jap_contratos_legalizar_export_control;
$ExportCtrl->Export_barr();

class grid_jap_contratos_legalizar_export_control
{
