...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_emp_ruc"  <?php echo $str_hide_emp_ruc?>><?php
      if ($emp_ruc != "")
      {
      $emp_ruc_look = (is_string($emp_ruc) ? substr($this->Db->qstr($emp_ruc), 1, -1) : $emp_ruc); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_emp_razon_social"  <?php echo $str_hide_emp_razon_social?>><?php
      if ($emp_razon_social != "")
      {
      $emp_razon_social_look = (is_string($emp_razon_social) ? substr($this->Db->qstr($emp_razon_social), 1, -1) : $emp_razon_social); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_emp_nombre_comercial"  <?php echo $str_hide_emp_nombre_comercial?>><?php
