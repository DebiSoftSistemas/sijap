<?php
@session_start() ;
$_SESSION['scriptcase']['grid_sis_modulo']['sc_process_barr'] = true;
require_once('../grid_sis_modulo/index.php');
unset($_SESSION['scriptcase']['grid_sis_modulo']['sc_process_barr']);
$ExportCtrl = new grid_sis_modulo_export_control;
$ExportCtrl->Export_barr();

class grid_sis_modulo_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> sis_modulo</TITLE>
