  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_jap_control_filtro_formulas" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_jap_control_filtro_formulas_form();
	}
...
?>
  ...
  // ---------- Validate tipo_deuda
  function do_ajax_jap_control_filtro_formulas_validate_tipo_deuda()
  {
    var nomeCampo_tipo_deuda = "tipo_deuda";
    var var_tipo_deuda = scAjaxGetFieldSelect(nomeCampo_tipo_deuda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_jap_control_filtro_formulas_validate_tipo_deuda(var_tipo_deuda, var_script_case_init, do_ajax_jap_control_filtro_formulas_validate_tipo_deuda_cb);
  } // do_ajax_jap_control_filtro_formulas_validate_tipo_deuda

  function do_ajax_jap_control_filtro_formulas_validate_tipo_deuda_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_jap_control_filtro_formulas_validate_tipo_deuda_cb

  // ---------- Validate toma_administrativa
  function do_ajax_jap_control_filtro_formulas_validate_toma_administrativa()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_jap_control_filtro_formulas_validate_toma_administrativa(var_toma_administrativa, var_script_case_init, do_ajax_jap_control_filtro_formulas_validate_toma_administrativa_cb);
  } // do_ajax_jap_control_filtro_formulas_validate_toma_administrativa

  function do_ajax_jap_control_filtro_formulas_validate_toma_administrativa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_jap_control_filtro_formulas_validate_toma_administrativa_cb

  // ---------- Validate toma_operativa
  function do_ajax_jap_control_filtro_formulas_validate_toma_operativa()
  {
    var nomeCampo_toma_operativa = "toma_operativa";
    var var_toma_operativa = scAjaxGetFieldSelect(nomeCampo_toma_operativa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_jap_control_filtro_formulas_validate_toma_operativa(var_toma_operativa, var_script_case_init, do_ajax_jap_control_filtro_formulas_validate_toma_operativa_cb);
  } // do_ajax_jap_control_filtro_formulas_validate_toma_operativa

  function do_ajax_jap_control_filtro_formulas_validate_toma_operativa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_jap_control_filtro_formulas_validate_toma_operativa_cb

  // ---------- Validate tipo_servicio
  function do_ajax_jap_control_filtro_formulas_validate_tipo_servicio()
  {
    var nomeCampo_tipo_servicio = "tipo_servicio";
    var var_tipo_servicio = scAjaxGetFieldSelect(nomeCampo_tipo_servicio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_jap_control_filtro_formulas_validate_tipo_servicio(var_tipo_servicio, var_script_case_init, do_ajax_jap_control_filtro_formulas_validate_tipo_servicio_cb);
  } // do_ajax_jap_control_filtro_formulas_validate_tipo_servicio

  function do_ajax_jap_control_filtro_formulas_validate_tipo_servicio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_jap_control_filtro_formulas_validate_tipo_servicio_cb

  // ---------- Validate condicion_contrato
  function do_ajax_jap_control_filtro_formulas_validate_condicion_contrato()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_jap_control_filtro_formulas_validate_condicion_contrato(var_condicion_contrato, var_script_case_init, do_ajax_jap_control_filtro_formulas_validate_condicion_contrato_cb);
  } // do_ajax_jap_control_filtro_formulas_validate_condicion_contrato

  function do_ajax_jap_control_filtro_formulas_validate_condicion_contrato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_jap_control_filtro_formulas_validate_condicion_contrato_cb

  // ---------- Validate cantidad
  function do_ajax_jap_control_filtro_formulas_validate_cantidad()
  {
    var nomeCampo_cantidad = "cantidad";
    var var_cantidad = scAjaxGetFieldText(nomeCampo_cantidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_jap_control_filtro_formulas_validate_cantidad(var_cantidad, var_script_case_init, do_ajax_jap_control_filtro_formulas_validate_cantidad_cb);
  } // do_ajax_jap_control_filtro_formulas_validate_cantidad

  function do_ajax_jap_control_filtro_formulas_validate_cantidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_jap_control_filtro_formulas_validate_cantidad_cb

  // ---------- Refresh toma_administrativa
  function do_ajax_jap_control_filtro_formulas_refresh_toma_administrativa()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_jap_control_filtro_formulas_refresh_toma_administrativa(var_toma_administrativa, var_nmgp_refresh_fields, var_script_case_init, do_ajax_jap_control_filtro_formulas_refresh_toma_administrativa_cb);
  } // do_ajax_jap_control_filtro_formulas_refresh_toma_administrativa

  function do_ajax_jap_control_filtro_formulas_refresh_toma_administrativa_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_jap_control_filtro_formulas_refresh_toma_administrativa_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_jap_control_filtro_formulas_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_jap_control_filtro_formulas_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_jap_control_filtro_formulas_submit_form(var_tipo_deuda, var_toma_administrativa, var_toma_operativa, var_tipo_servicio, var_condicion_contrato, var_cantidad, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_jap_control_filtro_formulas_submit_form_cb);
  } // do_ajax_jap_control_filtro_formulas_submit_form

  function do_ajax_jap_control_filtro_formulas_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_jap_control_filtro_formulas_submit_form_cb_after_alert);
  } // do_ajax_jap_control_filtro_formulas_submit_form_cb
  function do_ajax_jap_control_filtro_formulas_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_jap_control_filtro_formulas_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_jap_control_filtro_formulas_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_jap_control_filtro_formulas_navigate_form, function() {});
    } else {
      perform_ajax_jap_control_filtro_formulas_navigate_form();
    }
  }

  function perform_ajax_jap_control_filtro_formulas_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_jap_control_filtro_formulas_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['jap_control_filtro_formulas']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_jap_control_filtro_formulas_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_jap_control_filtro_formulas_navigate_form_cb_after_alert);
  } // do_ajax_jap_control_filtro_formulas_navigate_form_cb
  function do_ajax_jap_control_filtro_formulas_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_jap_control_filtro_formulas_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_jap_control_filtro_formulas_navigate_form_cb_after_alert

  function sc_hide_jap_control_filtro_formulas_form()
  {
