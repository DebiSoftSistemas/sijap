...
$old_error_handler = set_error_handler("jap_control_filtro_formulas_mob_scriptcase_error_handler");

function jap_control_filtro_formulas_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['jap_control_filtro_formulas_mob']['contr_erro']) && $_SESSION['scriptcase']['jap_control_filtro_formulas_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_jap_control_filtro_formulas_mob->contr_jap_control_filtro_formulas_mob->Apl_com_erro = true;
            if ($inicial_jap_control_filtro_formulas_mob->contr_jap_control_filtro_formulas_mob->NM_ajax_flag)
            {
                $inicial_jap_control_filtro_formulas_mob->contr_jap_control_filtro_formulas_mob->NM_ajax_info['errList']['geral_jap_control_filtro_formulas_mob'][] = $msg;
                return;
            }
            jap_control_filtro_formulas_mob_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function jap_control_filtro_formulas_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['jap_control_filtro_formulas_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['jap_control_filtro_formulas_mob'])  ? $_SESSION['scriptcase']['error_icon']['jap_control_filtro_formulas_mob']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['jap_control_filtro_formulas_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['jap_control_filtro_formulas_mob']) ? $_SESSION['scriptcase']['error_span_title']['jap_control_filtro_formulas_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['jap_control_filtro_formulas_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['jap_control_filtro_formulas_mob']) ? $_SESSION['scriptcase']['error_icon_title']['jap_control_filtro_formulas_mob'] : '';
?>
