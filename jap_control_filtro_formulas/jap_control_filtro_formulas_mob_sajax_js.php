  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_jap_control_filtro_formulas_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_jap_control_filtro_formulas_mob_form();
	}
...
?>
  ...
  // ---------- Validate tipo_deuda
  function do_ajax_jap_control_filtro_formulas_mob_validate_tipo_deuda()
  {
    var nomeCampo_tipo_deuda = "tipo_deuda";
    var var_tipo_deuda = scAjaxGetFieldSelect(nomeCampo_tipo_deuda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_jap_control_filtro_formulas_mob_validate_tipo_deuda(var_tipo_deuda, var_script_case_init, do_ajax_jap_control_filtro_formulas_mob_validate_tipo_deuda_cb);
  } // do_ajax_jap_control_filtro_formulas_mob_validate_tipo_deuda

  function do_ajax_jap_control_filtro_formulas_mob_validate_tipo_deuda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo_deuda";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_jap_control_filtro_formulas_mob_validate_tipo_deuda_cb

  // ---------- Validate toma_administrativa
  function do_ajax_jap_control_filtro_formulas_mob_validate_toma_administrativa()
  {
    var nomeCampo_toma_administrativa = "toma_administrativa";
    var var_toma_administrativa = scAjaxGetFieldSelect(nomeCampo_toma_administrativa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_jap_control_filtro_formulas_mob_validate_toma_administrativa(var_toma_administrativa, var_script_case_init, do_ajax_jap_control_filtro_formulas_mob_validate_toma_administrativa_cb);
  } // do_ajax_jap_control_filtro_formulas_mob_validate_toma_administrativa

  function do_ajax_jap_control_filtro_formulas_mob_validate_toma_administrativa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "toma_administrativa";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_jap_control_filtro_formulas_mob_validate_toma_administrativa_cb

  // ---------- Validate toma_operativa
  function do_ajax_jap_control_filtro_formulas_mob_validate_toma_operativa()
  {
    var nomeCampo_toma_operativa = "toma_operativa";
    var var_toma_operativa = scAjaxGetFieldSelect(nomeCampo_toma_operativa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_jap_control_filtro_formulas_mob_validate_toma_operativa(var_toma_operativa, var_script_case_init, do_ajax_jap_control_filtro_formulas_mob_validate_toma_operativa_cb);
  } // do_ajax_jap_control_filtro_formulas_mob_validate_toma_operativa

  function do_ajax_jap_control_filtro_formulas_mob_validate_toma_operativa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "toma_operativa";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_jap_control_filtro_formulas_mob_validate_toma_operativa_cb

  // ---------- Validate tipo_servicio
  function do_ajax_jap_control_filtro_formulas_mob_validate_tipo_servicio()
  {
    var nomeCampo_tipo_servicio = "tipo_servicio";
    var var_tipo_servicio = scAjaxGetFieldSelect(nomeCampo_tipo_servicio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_jap_control_filtro_formulas_mob_validate_tipo_servicio(var_tipo_servicio, var_script_case_init, do_ajax_jap_control_filtro_formulas_mob_validate_tipo_servicio_cb);
  } // do_ajax_jap_control_filtro_formulas_mob_validate_tipo_servicio

  function do_ajax_jap_control_filtro_formulas_mob_validate_tipo_servicio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_jap_control_filtro_formulas_mob_validate_tipo_servicio_cb

  // ---------- Validate condicion_contrato
  function do_ajax_jap_control_filtro_formulas_mob_validate_condicion_contrato()
  {
    var nomeCampo_condicion_contrato = "condicion_contrato";
    var var_condicion_contrato = scAjaxGetFieldSelect(nomeCampo_condicion_contrato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_jap_control_filtro_formulas_mob_validate_condicion_contrato(var_condicion_contrato, var_script_case_init, do_ajax_jap_control_filtro_formulas_mob_validate_condicion_contrato_cb);
  } // do_ajax_jap_control_filtro_formulas_mob_validate_condicion_contrato

  function do_ajax_jap_control_filtro_formulas_mob_validate_condicion_contrato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "condicion_contrato";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_jap_control_filtro_formulas_mob_validate_condicion_contrato_cb

  // ---------- Validate cantidad
  function do_ajax_jap_control_filtro_formulas_mob_validate_cantidad()
  {
    var nomeCampo_cantidad = "cantidad";
    var var_cantidad = scAjaxGetFieldText(nomeCampo_cantidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_jap_control_filtro_formulas_mob_validate_cantidad(var_cantidad, var_script_case_init, do_ajax_jap_control_filtro_formulas_mob_validate_cantidad_cb);
  } // do_ajax_jap_control_filtro_formulas_mob_validate_cantidad

  function do_ajax_jap_control_filtro_formulas_mob_validate_cantidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_jap_control_filtro_formulas_mob_validate_cantidad_cb

  // ---------- Refresh toma_administrativa
  function do_ajax_jap_control_filtro_formulas_mob_refresh_toma_administrativa()
  {
    var var_toma_administrativa = scAjaxGetFieldSelect("toma_administrativa");
    var var_nmgp_refresh_fields = "toma_operativa";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_jap_control_filtro_formulas_mob_refresh_toma_administrativa(var_toma_administrativa, var_nmgp_refresh_fields, var_script_case_init, do_ajax_jap_control_filtro_formulas_mob_refresh_toma_administrativa_cb);
  } // do_ajax_jap_control_filtro_formulas_mob_refresh_toma_administrativa

  function do_ajax_jap_control_filtro_formulas_mob_refresh_toma_administrativa_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_jap_control_filtro_formulas_mob_refresh_toma_administrativa_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_jap_control_filtro_formulas_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_jap_control_filtro_formulas_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_tipo_deuda = scAjaxGetFieldSelect("tipo_deuda");
    var var_toma_administrativa = scAjaxGetFieldSelect("toma_administrativa");
    var var_toma_operativa = scAjaxGetFieldSelect("toma_operativa");
    var var_tipo_servicio = scAjaxGetFieldSelect("tipo_servicio");
    var var_condicion_contrato = scAjaxGetFieldSelect("condicion_contrato");
    ...
    scAjaxProcOn();
    x_ajax_jap_control_filtro_formulas_mob_submit_form(var_tipo_deuda, var_toma_administrativa, var_toma_operativa, var_tipo_servicio, var_condicion_contrato, var_cantidad, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_jap_control_filtro_formulas_mob_submit_form_cb);
  } // do_ajax_jap_control_filtro_formulas_mob_submit_form

  function do_ajax_jap_control_filtro_formulas_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_jap_control_filtro_formulas_mob_submit_form_cb_after_alert);
  } // do_ajax_jap_control_filtro_formulas_mob_submit_form_cb
  function do_ajax_jap_control_filtro_formulas_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_jap_control_filtro_formulas_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_jap_control_filtro_formulas_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_jap_control_filtro_formulas_mob_navigate_form, function() {});
    } else {
      perform_ajax_jap_control_filtro_formulas_mob_navigate_form();
    }
  }

  function perform_ajax_jap_control_filtro_formulas_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_jap_control_filtro_formulas_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['jap_control_filtro_formulas_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_jap_control_filtro_formulas_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_jap_control_filtro_formulas_mob_navigate_form_cb_after_alert);
  } // do_ajax_jap_control_filtro_formulas_mob_navigate_form_cb
  function do_ajax_jap_control_filtro_formulas_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_jap_control_filtro_formulas_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_jap_control_filtro_formulas_mob_navigate_form_cb_after_alert

  function sc_hide_jap_control_filtro_formulas_mob_form()
  {
  ...
  ajax_field_list[0] = "tipo_deuda";
  ajax_field_list[1] = "toma_administrativa";
  ajax_field_list[2] = "toma_operativa";
  ajax_field_list[3] = "tipo_servicio";
  ajax_field_list[4] = "condicion_contrato";
  ...
  var ajax_error_list = {
    "tipo_deuda": {"label": "<?php echo $this->Ini->Nm_lang['lang_tipo_deuda'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "toma_administrativa": {"label": "<?php echo $this->Ini->Nm_lang['lang_modulo'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "toma_operativa": {"label": "<?php echo $this->Ini->Nm_lang['lang_toma_operativa'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "tipo_servicio": {"label": "<?php echo $this->Ini->Nm_lang['lang_tipo_servicio'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "condicion_contrato": {"label": "<?php echo $this->Ini->Nm_lang['lang_condicion_contrato'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "cantidad": {"label": "<?php echo $this->Ini->Nm_lang['lang_consumo'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    "tipo_deuda": new Array(),
    "toma_administrativa": new Array(),
    "toma_operativa": new Array(),
    "tipo_servicio": new Array(),
    "condicion_contrato": new Array(),
    "cantidad": new Array()
  };
  ajax_field_mult["tipo_deuda"][1] = "tipo_deuda";
  ajax_field_mult["toma_administrativa"][1] = "toma_administrativa";
  ajax_field_mult["toma_operativa"][1] = "toma_operativa";
  ajax_field_mult["tipo_servicio"][1] = "tipo_servicio";
  ajax_field_mult["condicion_contrato"][1] = "condicion_contrato";
  ajax_field_mult["cantidad"][1] = "cantidad";

  var ajax_field_id = {
    "tipo_deuda": new Array("hidden_field_label_tipo_deuda", "hidden_field_data_tipo_deuda"),
    "toma_administrativa": new Array("hidden_field_label_toma_administrativa", "hidden_field_data_toma_administrativa"),
    "toma_operativa": new Array("hidden_field_label_toma_operativa", "hidden_field_data_toma_operativa"),
    "tipo_servicio": new Array("hidden_field_label_tipo_servicio", "hidden_field_data_tipo_servicio"),
    "condicion_contrato": new Array("hidden_field_label_condicion_contrato", "hidden_field_data_condicion_contrato"),
    "cantidad": new Array("hidden_field_label_cantidad", "hidden_field_data_cantidad")
  };

  var ajax_read_only = {
    "tipo_deuda": "off",
    "toma_administrativa": "off",
    "toma_operativa": "off",
    "tipo_servicio": "off",
    "condicion_contrato": "off",
    "cantidad": "off"
  };
