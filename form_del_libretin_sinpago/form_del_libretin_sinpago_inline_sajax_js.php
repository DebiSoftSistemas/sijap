  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_libretin_sinpago_inline" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_libretin_sinpago_inline_form();
	}
...
?>
  ...
  // ---------- Validate lib_id_
  function do_ajax_form_del_libretin_sinpago_inline_validate_lib_id_()
  {
    var nomeCampo_lib_id_ = "lib_id_";
    var var_lib_id_ = scAjaxGetFieldHidden(nomeCampo_lib_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_libretin_sinpago_inline_validate_lib_id_(var_lib_id_, var_script_case_init, do_ajax_form_del_libretin_sinpago_inline_validate_lib_id__cb);
  } // do_ajax_form_del_libretin_sinpago_inline_validate_lib_id_

  function do_ajax_form_del_libretin_sinpago_inline_validate_lib_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_libretin_sinpago_inline_validate_lib_id__cb

  // ---------- Validate lib_tipo_comprobante_
  function do_ajax_form_del_libretin_sinpago_inline_validate_lib_tipo_comprobante_()
  {
    var nomeCampo_lib_tipo_comprobante_ = "lib_tipo_comprobante_";
    var var_lib_tipo_comprobante_ = scAjaxGetFieldSelect(nomeCampo_lib_tipo_comprobante_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_libretin_sinpago_inline_validate_lib_tipo_comprobante_(var_lib_tipo_comprobante_, var_script_case_init, do_ajax_form_del_libretin_sinpago_inline_validate_lib_tipo_comprobante__cb);
  } // do_ajax_form_del_libretin_sinpago_inline_validate_lib_tipo_comprobante_

  function do_ajax_form_del_libretin_sinpago_inline_validate_lib_tipo_comprobante__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_libretin_sinpago_inline_validate_lib_tipo_comprobante__cb

  // ---------- Validate lib_punto_emision_
  function do_ajax_form_del_libretin_sinpago_inline_validate_lib_punto_emision_()
  {
    var nomeCampo_lib_punto_emision_ = "lib_punto_emision_";
    var var_lib_punto_emision_ = scAjaxGetFieldText(nomeCampo_lib_punto_emision_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_libretin_sinpago_inline_validate_lib_punto_emision_(var_lib_punto_emision_, var_script_case_init, do_ajax_form_del_libretin_sinpago_inline_validate_lib_punto_emision__cb);
  } // do_ajax_form_del_libretin_sinpago_inline_validate_lib_punto_emision_

  function do_ajax_form_del_libretin_sinpago_inline_validate_lib_punto_emision__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_libretin_sinpago_inline_validate_lib_punto_emision__cb

  // ---------- Validate lib_tipo_libretin_
  function do_ajax_form_del_libretin_sinpago_inline_validate_lib_tipo_libretin_()
  {
    var nomeCampo_lib_tipo_libretin_ = "lib_tipo_libretin_";
    var var_lib_tipo_libretin_ = scAjaxGetFieldSelect(nomeCampo_lib_tipo_libretin_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_libretin_sinpago_inline_validate_lib_tipo_libretin_(var_lib_tipo_libretin_, var_script_case_init, do_ajax_form_del_libretin_sinpago_inline_validate_lib_tipo_libretin__cb);
  } // do_ajax_form_del_libretin_sinpago_inline_validate_lib_tipo_libretin_

  function do_ajax_form_del_libretin_sinpago_inline_validate_lib_tipo_libretin__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_libretin_sinpago_inline_validate_lib_tipo_libretin__cb

  // ---------- Validate lib_desde_
  function do_ajax_form_del_libretin_sinpago_inline_validate_lib_desde_()
  {
    var nomeCampo_lib_desde_ = "lib_desde_";
    var var_lib_desde_ = scAjaxGetFieldText(nomeCampo_lib_desde_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_libretin_sinpago_inline_validate_lib_desde_(var_lib_desde_, var_script_case_init, do_ajax_form_del_libretin_sinpago_inline_validate_lib_desde__cb);
  } // do_ajax_form_del_libretin_sinpago_inline_validate_lib_desde_

  function do_ajax_form_del_libretin_sinpago_inline_validate_lib_desde__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_libretin_sinpago_inline_validate_lib_desde__cb

  // ---------- Validate lib_hasta_
  function do_ajax_form_del_libretin_sinpago_inline_validate_lib_hasta_()
  {
    var nomeCampo_lib_hasta_ = "lib_hasta_";
    var var_lib_hasta_ = scAjaxGetFieldText(nomeCampo_lib_hasta_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_libretin_sinpago_inline_validate_lib_hasta_(var_lib_hasta_, var_script_case_init, do_ajax_form_del_libretin_sinpago_inline_validate_lib_hasta__cb);
  } // do_ajax_form_del_libretin_sinpago_inline_validate_lib_hasta_

  function do_ajax_form_del_libretin_sinpago_inline_validate_lib_hasta__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_libretin_sinpago_inline_validate_lib_hasta__cb

  // ---------- Validate lib_secuencial_
  function do_ajax_form_del_libretin_sinpago_inline_validate_lib_secuencial_()
  {
    var nomeCampo_lib_secuencial_ = "lib_secuencial_";
    var var_lib_secuencial_ = scAjaxGetFieldText(nomeCampo_lib_secuencial_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_libretin_sinpago_inline_validate_lib_secuencial_(var_lib_secuencial_, var_script_case_init, do_ajax_form_del_libretin_sinpago_inline_validate_lib_secuencial__cb);
  } // do_ajax_form_del_libretin_sinpago_inline_validate_lib_secuencial_

  function do_ajax_form_del_libretin_sinpago_inline_validate_lib_secuencial__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_libretin_sinpago_inline_validate_lib_secuencial__cb

  // ---------- Validate lib_autorizacion_
  function do_ajax_form_del_libretin_sinpago_inline_validate_lib_autorizacion_()
  {
    var nomeCampo_lib_autorizacion_ = "lib_autorizacion_";
    var var_lib_autorizacion_ = scAjaxGetFieldText(nomeCampo_lib_autorizacion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_libretin_sinpago_inline_validate_lib_autorizacion_(var_lib_autorizacion_, var_script_case_init, do_ajax_form_del_libretin_sinpago_inline_validate_lib_autorizacion__cb);
  } // do_ajax_form_del_libretin_sinpago_inline_validate_lib_autorizacion_

  function do_ajax_form_del_libretin_sinpago_inline_validate_lib_autorizacion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_libretin_sinpago_inline_validate_lib_autorizacion__cb

  // ---------- Validate lib_fecha_caducidad_
  function do_ajax_form_del_libretin_sinpago_inline_validate_lib_fecha_caducidad_()
  {
    var nomeCampo_lib_fecha_caducidad_ = "lib_fecha_caducidad_";
    var var_lib_fecha_caducidad_ = scAjaxGetFieldText(nomeCampo_lib_fecha_caducidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_libretin_sinpago_inline_validate_lib_fecha_caducidad_(var_lib_fecha_caducidad_, var_script_case_init, do_ajax_form_del_libretin_sinpago_inline_validate_lib_fecha_caducidad__cb);
  } // do_ajax_form_del_libretin_sinpago_inline_validate_lib_fecha_caducidad_

  function do_ajax_form_del_libretin_sinpago_inline_validate_lib_fecha_caducidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_libretin_sinpago_inline_validate_lib_fecha_caducidad__cb

  // ---------- Validate lib_estado_
  function do_ajax_form_del_libretin_sinpago_inline_validate_lib_estado_()
  {
    var nomeCampo_lib_estado_ = "lib_estado_";
    var var_lib_estado_ = scAjaxGetFieldSelect(nomeCampo_lib_estado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_libretin_sinpago_inline_validate_lib_estado_(var_lib_estado_, var_script_case_init, do_ajax_form_del_libretin_sinpago_inline_validate_lib_estado__cb);
  } // do_ajax_form_del_libretin_sinpago_inline_validate_lib_estado_

  function do_ajax_form_del_libretin_sinpago_inline_validate_lib_estado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_libretin_sinpago_inline_validate_lib_estado__cb

  // ---------- Validate lib_disponibles_
  function do_ajax_form_del_libretin_sinpago_inline_validate_lib_disponibles_()
  {
    var nomeCampo_lib_disponibles_ = "lib_disponibles_";
    var var_lib_disponibles_ = scAjaxGetFieldHidden(nomeCampo_lib_disponibles_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_libretin_sinpago_inline_validate_lib_disponibles_(var_lib_disponibles_, var_script_case_init, do_ajax_form_del_libretin_sinpago_inline_validate_lib_disponibles__cb);
  } // do_ajax_form_del_libretin_sinpago_inline_validate_lib_disponibles_

  function do_ajax_form_del_libretin_sinpago_inline_validate_lib_disponibles__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_libretin_sinpago_inline_validate_lib_disponibles__cb

  // ---------- Validate lib_utilizados_
  function do_ajax_form_del_libretin_sinpago_inline_validate_lib_utilizados_()
  {
    var nomeCampo_lib_utilizados_ = "lib_utilizados_";
    var var_lib_utilizados_ = scAjaxGetFieldHidden(nomeCampo_lib_utilizados_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_libretin_sinpago_inline_validate_lib_utilizados_(var_lib_utilizados_, var_script_case_init, do_ajax_form_del_libretin_sinpago_inline_validate_lib_utilizados__cb);
  } // do_ajax_form_del_libretin_sinpago_inline_validate_lib_utilizados_

  function do_ajax_form_del_libretin_sinpago_inline_validate_lib_utilizados__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_libretin_sinpago_inline_validate_lib_utilizados__cb

  // ---------- Event onblur lib_tipo_libretin_
  function do_ajax_form_del_libretin_sinpago_inline_event_lib_tipo_libretin__onblur()
  {
    var var_lib_tipo_libretin_ = scAjaxGetFieldSelect("lib_tipo_libretin_");
    var var_lib_desde_ = scAjaxGetFieldText("lib_desde_");
    var var_lib_hasta_ = scAjaxGetFieldText("lib_hasta_");
    var var_lib_secuencial_ = scAjaxGetFieldText("lib_secuencial_");
    var var_lib_autorizacion_ = scAjaxGetFieldText("lib_autorizacion_");
    var var_lib_disponibles_ = scAjaxGetFieldHidden("lib_disponibles_");
    var var_lib_utilizados_ = scAjaxGetFieldHidden("lib_utilizados_");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_libretin_sinpago_inline_event_lib_tipo_libretin__onblur(var_lib_tipo_libretin_, var_lib_desde_, var_lib_hasta_, var_lib_secuencial_, var_lib_autorizacion_, var_lib_disponibles_, var_lib_utilizados_, var_script_case_init, do_ajax_form_del_libretin_sinpago_inline_event_lib_tipo_libretin__onblur_cb);
  } // do_ajax_form_del_libretin_sinpago_inline_event_lib_tipo_libretin__onblur

  function do_ajax_form_del_libretin_sinpago_inline_event_lib_tipo_libretin__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "lib_tipo_libretin_";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_libretin_sinpago_inline_event_lib_tipo_libretin__onblur_cb_after_alert);
  } // do_ajax_form_del_libretin_sinpago_inline_event_lib_tipo_libretin__onblur_cb
  function do_ajax_form_del_libretin_sinpago_inline_event_lib_tipo_libretin__onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_libretin_sinpago_inline_event_lib_tipo_libretin__onblur_cb_after_alert

  // ---------- Event onchange lib_tipo_libretin_
  function do_ajax_form_del_libretin_sinpago_inline_event_lib_tipo_libretin__onchange()
  {
    var var_lib_tipo_libretin_ = scAjaxGetFieldSelect("lib_tipo_libretin_");
    var var_lib_desde_ = scAjaxGetFieldText("lib_desde_");
    var var_lib_hasta_ = scAjaxGetFieldText("lib_hasta_");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_libretin_sinpago_inline_event_lib_tipo_libretin__onchange(var_lib_tipo_libretin_, var_lib_desde_, var_lib_hasta_, var_lib_secuencial_, var_lib_autorizacion_, var_lib_disponibles_, var_lib_utilizados_, var_script_case_init, do_ajax_form_del_libretin_sinpago_inline_event_lib_tipo_libretin__onchange_cb);
  } // do_ajax_form_del_libretin_sinpago_inline_event_lib_tipo_libretin__onchange

  function do_ajax_form_del_libretin_sinpago_inline_event_lib_tipo_libretin__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "lib_tipo_libretin_";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_libretin_sinpago_inline_event_lib_tipo_libretin__onchange_cb_after_alert);
  } // do_ajax_form_del_libretin_sinpago_inline_event_lib_tipo_libretin__onchange_cb
  function do_ajax_form_del_libretin_sinpago_inline_event_lib_tipo_libretin__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_libretin_sinpago_inline_event_lib_tipo_libretin__onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_libretin_sinpago_inline_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_libretin_sinpago_inline_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_lib_id_ = scAjaxGetFieldHidden("lib_id_");
    var var_lib_tipo_comprobante_ = scAjaxGetFieldSelect("lib_tipo_comprobante_");
    var var_lib_punto_emision_ = scAjaxGetFieldText("lib_punto_emision_");
    var var_lib_tipo_libretin_ = scAjaxGetFieldSelect("lib_tipo_libretin_");
    var var_lib_desde_ = scAjaxGetFieldText("lib_desde_");
    var var_lib_hasta_ = scAjaxGetFieldText("lib_hasta_");
    var var_lib_secuencial_ = scAjaxGetFieldText("lib_secuencial_");
    var var_lib_autorizacion_ = scAjaxGetFieldText("lib_autorizacion_");
    var var_lib_fecha_caducidad_ = scAjaxGetFieldText("lib_fecha_caducidad_");
    var var_lib_estado_ = scAjaxGetFieldSelect("lib_estado_");
    var var_lib_disponibles_ = scAjaxGetFieldHidden("lib_disponibles_");
    var var_lib_utilizados_ = scAjaxGetFieldHidden("lib_utilizados_");
    ...
    scAjaxProcOn();
    x_ajax_form_del_libretin_sinpago_inline_submit_form(var_lib_id_, var_lib_tipo_comprobante_, var_lib_punto_emision_, var_lib_tipo_libretin_, var_lib_desde_, var_lib_hasta_, var_lib_secuencial_, var_lib_autorizacion_, var_lib_fecha_caducidad_, var_lib_estado_, var_lib_disponibles_, var_lib_utilizados_, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_libretin_sinpago_inline_submit_form_cb);
  } // do_ajax_form_del_libretin_sinpago_inline_submit_form

  function do_ajax_form_del_libretin_sinpago_inline_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("lib_id_");
      scAjaxHideErrorDisplay("lib_tipo_comprobante_");
      scAjaxHideErrorDisplay("lib_punto_emision_");
      scAjaxHideErrorDisplay("lib_tipo_libretin_");
      scAjaxHideErrorDisplay("lib_desde_");
      scAjaxHideErrorDisplay("lib_hasta_");
      scAjaxHideErrorDisplay("lib_secuencial_");
      scAjaxHideErrorDisplay("lib_autorizacion_");
      scAjaxHideErrorDisplay("lib_fecha_caducidad_");
      scAjaxHideErrorDisplay("lib_estado_");
      scAjaxHideErrorDisplay("lib_disponibles_");
      scAjaxHideErrorDisplay("lib_utilizados_");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_libretin_sinpago_inline_submit_form_cb_after_alert);
  } // do_ajax_form_del_libretin_sinpago_inline_submit_form_cb
  function do_ajax_form_del_libretin_sinpago_inline_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_libretin_sinpago_inline_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_libretin_sinpago_inline_navigate_form()
  {
    perform_ajax_form_del_libretin_sinpago_inline_navigate_form();
  }

  function perform_ajax_form_del_libretin_sinpago_inline_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_libretin_sinpago_inline_navigate_form(var_lib_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_libretin_sinpago_inline_navigate_form_cb);
  } // do_ajax_form_del_libretin_sinpago_inline_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_libretin_sinpago_inline']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_libretin_sinpago_inline_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_libretin_sinpago_inline_navigate_form_cb_after_alert);
  } // do_ajax_form_del_libretin_sinpago_inline_navigate_form_cb
  function do_ajax_form_del_libretin_sinpago_inline_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_del_libretin_sinpago_inline_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_libretin_sinpago_inline_navigate_form_cb_after_alert

  function sc_hide_form_del_libretin_sinpago_inline_form()
  {
  ...
  ajax_field_list[0] = "lib_id_";
  ajax_field_list[1] = "lib_tipo_comprobante_";
  ajax_field_list[2] = "lib_punto_emision_";
  ajax_field_list[3] = "lib_tipo_libretin_";
  ajax_field_list[4] = "lib_desde_";
  ajax_field_list[5] = "lib_hasta_";
  ajax_field_list[6] = "lib_secuencial_";
  ajax_field_list[7] = "lib_autorizacion_";
  ajax_field_list[8] = "lib_fecha_caducidad_";
  ajax_field_list[9] = "lib_estado_";
  ajax_field_list[10] = "lib_disponibles_";
  ajax_field_list[11] = "lib_utilizados_";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "lib_id_": {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "lib_tipo_comprobante_": {"label": "<?php echo $this->Ini->Nm_lang['lang_tipo_comprobante'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "lib_punto_emision_": {"label": "<?php echo $this->Ini->Nm_lang['lang_punto_emision'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "lib_tipo_libretin_": {"label": "<?php echo $this->Ini->Nm_lang['lang_tipo_libretin'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "lib_desde_": {"label": "<?php echo $this->Ini->Nm_lang['lang_desde'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "lib_hasta_": {"label": "<?php echo $this->Ini->Nm_lang['lang_hasta'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "lib_secuencial_": {"label": "<?php echo $this->Ini->Nm_lang['lang_secuencial'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "lib_autorizacion_": {"label": "<?php echo $this->Ini->Nm_lang['lang_autorizacion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "lib_fecha_caducidad_": {"label": "<?php echo $this->Ini->Nm_lang['lang_fecha_caducidad'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "lib_estado_": {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "lib_disponibles_": {"label": "<?php echo $this->Ini->Nm_lang['lang_chart_available'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "lib_utilizados_": {"label": "<?php echo $this->Ini->Nm_lang['lang_utilizados'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["lib_id_"][1] = "lib_id_";
  ajax_field_mult["lib_tipo_comprobante_"][1] = "lib_tipo_comprobante_";
  ajax_field_mult["lib_punto_emision_"][1] = "lib_punto_emision_";
  ajax_field_mult["lib_tipo_libretin_"][1] = "lib_tipo_libretin_";
  ajax_field_mult["lib_desde_"][1] = "lib_desde_";
  ajax_field_mult["lib_hasta_"][1] = "lib_hasta_";
  ajax_field_mult["lib_secuencial_"][1] = "lib_secuencial_";
  ajax_field_mult["lib_autorizacion_"][1] = "lib_autorizacion_";
  ajax_field_mult["lib_fecha_caducidad_"][1] = "lib_fecha_caducidad_";
  ajax_field_mult["lib_estado_"][1] = "lib_estado_";
  ajax_field_mult["lib_disponibles_"][1] = "lib_disponibles_";
  ajax_field_mult["lib_utilizados_"][1] = "lib_utilizados_";

  var ajax_field_id = {
    "lib_tipo_comprobante_": new Array("hidden_field_label_lib_tipo_comprobante_", "hidden_field_data_lib_tipo_comprobante_"),
    "lib_tipo_libretin_": new Array("hidden_field_label_lib_tipo_libretin_", "hidden_field_data_lib_tipo_libretin_"),
    "lib_desde_": new Array("hidden_field_label_lib_desde_", "hidden_field_data_lib_desde_"),
    "lib_hasta_": new Array("hidden_field_label_lib_hasta_", "hidden_field_data_lib_hasta_"),
    "lib_secuencial_": new Array("hidden_field_label_lib_secuencial_", "hidden_field_data_lib_secuencial_"),
    "lib_autorizacion_": new Array("hidden_field_label_lib_autorizacion_", "hidden_field_data_lib_autorizacion_"),
    "lib_fecha_caducidad_": new Array("hidden_field_label_lib_fecha_caducidad_", "hidden_field_data_lib_fecha_caducidad_"),
    "lib_estado_": new Array("hidden_field_label_lib_estado_", "hidden_field_data_lib_estado_")
  };

  var ajax_read_only = {
    "lib_id_": "on",
    "lib_tipo_comprobante_": "off",
    "lib_punto_emision_": "off",
    "lib_tipo_libretin_": "off",
    "lib_desde_": "off",
    "lib_hasta_": "off",
    "lib_secuencial_": "off",
    "lib_autorizacion_": "off",
    "lib_fecha_caducidad_": "off",
    "lib_estado_": "off",
    "lib_disponibles_": "off",
    "lib_utilizados_": "off"
  };
