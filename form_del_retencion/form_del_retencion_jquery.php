...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_ret_numero' + iSeqRow).bind('change', function() { sc_form_del_retencion_ret_numero_onchange(this, iSeqRow) });
  $('#id_sc_field_ret_tipo_comprobante' + iSeqRow).bind('change', function() { sc_form_del_retencion_ret_tipo_comprobante_onchange(this, iSeqRow) });
  $('#id_sc_field_ret_empresa' + iSeqRow).bind('change', function() { sc_form_del_retencion_ret_empresa_onchange(this, iSeqRow) });
  $('#id_sc_field_ret_establecimiento' + iSeqRow).bind('blur', function() { sc_form_del_retencion_ret_establecimiento_onblur(this, iSeqRow) })
                                                 .bind('change', function() { sc_form_del_retencion_ret_establecimiento_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_ret_punto_emision' + iSeqRow).bind('blur', function() { sc_form_del_retencion_ret_punto_emision_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_form_del_retencion_ret_punto_emision_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_ret_secuencial' + iSeqRow).bind('blur', function() { sc_form_del_retencion_ret_secuencial_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_del_retencion_ret_secuencial_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_ret_ambiente' + iSeqRow).bind('blur', function() { sc_form_del_retencion_ret_ambiente_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_del_retencion_ret_ambiente_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_ret_tipo_libretin' + iSeqRow).bind('blur', function() { sc_form_del_retencion_ret_tipo_libretin_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_form_del_retencion_ret_tipo_libretin_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_ret_estado' + iSeqRow).bind('change', function() { sc_form_del_retencion_ret_estado_onchange(this, iSeqRow) });
  $('#id_sc_field_ret_estado_sri' + iSeqRow).bind('blur', function() { sc_form_del_retencion_ret_estado_sri_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_del_retencion_ret_estado_sri_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_ret_error_sri' + iSeqRow).bind('blur', function() { sc_form_del_retencion_ret_error_sri_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_del_retencion_ret_error_sri_onchange(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_del_retencion_ret_error_sri_onfocus(this, iSeqRow) });
  $('#id_sc_field_ret_fecha_autorizacion' + iSeqRow).bind('change', function() { sc_form_del_retencion_ret_fecha_autorizacion_onchange(this, iSeqRow) });
  $('#id_sc_field_ret_autorizacion' + iSeqRow).bind('change', function() { sc_form_del_retencion_ret_autorizacion_onchange(this, iSeqRow) });
  $('#id_sc_field_ret_clave' + iSeqRow).bind('change', function() { sc_form_del_retencion_ret_clave_onchange(this, iSeqRow) });
  $('#id_sc_field_ret_usuario' + iSeqRow).bind('change', function() { sc_form_del_retencion_ret_usuario_onchange(this, iSeqRow) });
  $('#id_sc_field_titulo' + iSeqRow).bind('blur', function() { sc_form_del_retencion_titulo_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_del_retencion_titulo_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_ret_ruc_cliente' + iSeqRow).bind('blur', function() { sc_form_del_retencion_ret_ruc_cliente_onblur(this, iSeqRow) })
                                             .bind('change', function() { sc_form_del_retencion_ret_ruc_cliente_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_ret_direccion_cliente' + iSeqRow).bind('blur', function() { sc_form_del_retencion_ret_direccion_cliente_onblur(this, iSeqRow) })
                                                   .bind('change', function() { sc_form_del_retencion_ret_direccion_cliente_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_ret_email_cliente' + iSeqRow).bind('blur', function() { sc_form_del_retencion_ret_email_cliente_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_form_del_retencion_ret_email_cliente_onchange(this, iSeqRow) })
                                               .bind('focus', function() { sc_form_del_retencion_ret_email_cliente_onfocus(this, iSeqRow) });
  $('#id_sc_field_establecimiento' + iSeqRow).bind('change', function() { sc_form_del_retencion_establecimiento_onchange(this, iSeqRow) });
  $('#id_sc_field_punto_emision' + iSeqRow).bind('change', function() { sc_form_del_retencion_punto_emision_onchange(this, iSeqRow) });
  $('#id_sc_field_secuencial' + iSeqRow).bind('blur', function() { sc_form_del_retencion_secuencial_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_del_retencion_secuencial_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_tipo_libretin' + iSeqRow).bind('blur', function() { sc_form_del_retencion_tipo_libretin_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_del_retencion_tipo_libretin_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_ambiente' + iSeqRow).bind('blur', function() { sc_form_del_retencion_ambiente_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_del_retencion_ambiente_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_detalle' + iSeqRow).bind('blur', function() { sc_form_del_retencion_detalle_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_del_retencion_detalle_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_ret_nombre_cliente' + iSeqRow).bind('blur', function() { sc_form_del_retencion_ret_nombre_cliente_onblur(this, iSeqRow) })
                                                .bind('change', function() { sc_form_del_retencion_ret_nombre_cliente_onchange(this, iSeqRow) })
                                                .bind('focus', function() { sc_form_del_retencion_ret_nombre_cliente_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_del_retencion_ret_numero_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_del_retencion_ret_tipo_comprobante_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_del_retencion_ret_empresa_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_retencion_ret_establecimiento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_retencion_ret_punto_emision_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_retencion_ret_secuencial_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_retencion_ret_ambiente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_retencion_ret_tipo_libretin_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_retencion_ret_estado_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_retencion_ret_estado_sri_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_retencion_ret_error_sri_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_retencion_ret_fecha_autorizacion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_del_retencion_ret_autorizacion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_del_retencion_ret_clave_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_del_retencion_ret_usuario_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_retencion_titulo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_retencion_ret_ruc_cliente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_retencion_ret_direccion_cliente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_retencion_ret_email_cliente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_retencion_establecimiento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_del_retencion_punto_emision_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_retencion_secuencial_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_retencion_tipo_libretin_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_retencion_ambiente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_retencion_detalle_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_retencion_ret_nombre_cliente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_form_del_retencion_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_ret_fecha" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      setTimeout(function() { do_ajax_form_del_retencion_validate_ret_fecha(iSeqRow); }, 200);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  $("#id_sc_field_ret_fecha_autorizacion" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_del_retencion_validate_ret_fecha_autorizacion(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_del_retencion')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
