...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIJAP_____buscar_v_jap_contrato_comp"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIJAP_____buscar_v_jap_contrato_comp"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['buscar_v_jap_contrato_comp']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['buscar_v_jap_contrato_comp']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['buscar_v_jap_contrato_comp']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['buscar_v_jap_contrato_comp']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['buscar_v_jap_contrato_comp']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>buscar_v_jap_contrato_comp</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['buscar_v_jap_contrato_comp']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['buscar_v_jap_contrato_comp']['embutida_filho'] as $ind => $sc_init)
          {
