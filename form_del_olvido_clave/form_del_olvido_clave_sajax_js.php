  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_olvido_clave" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_olvido_clave_form();
	}
...
?>
  ...
  function do_ajax_form_del_olvido_clave_validate_ruc_empresa()
  {
    var nomeCampo_ruc_empresa = "ruc_empresa";
    var var_ruc_empresa = scAjaxGetFieldText(nomeCampo_ruc_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_olvido_clave_validate_ruc_empresa(var_ruc_empresa, var_script_case_init, do_ajax_form_del_olvido_clave_validate_ruc_empresa_cb);
  } // do_ajax_form_del_olvido_clave_validate_ruc_empresa

  function do_ajax_form_del_olvido_clave_validate_ruc_empresa_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_olvido_clave_validate_ruc_empresa_cb

  // ---------- Validate login
  function do_ajax_form_del_olvido_clave_validate_login()
  {
    var nomeCampo_login = "login";
    var var_login = scAjaxGetFieldSelect(nomeCampo_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_olvido_clave_validate_login(var_login, var_script_case_init, do_ajax_form_del_olvido_clave_validate_login_cb);
  } // do_ajax_form_del_olvido_clave_validate_login

  function do_ajax_form_del_olvido_clave_validate_login_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "login";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_olvido_clave_validate_login_cb

  // ---------- Validate correo
  function do_ajax_form_del_olvido_clave_validate_correo()
  {
    var nomeCampo_correo = "correo";
    var var_correo = scAjaxGetFieldText(nomeCampo_correo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_olvido_clave_validate_correo(var_correo, var_script_case_init, do_ajax_form_del_olvido_clave_validate_correo_cb);
  } // do_ajax_form_del_olvido_clave_validate_correo

  function do_ajax_form_del_olvido_clave_validate_correo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "correo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_olvido_clave_validate_correo_cb

  // ---------- Validate mensaje
  function do_ajax_form_del_olvido_clave_validate_mensaje()
  {
  } // do_ajax_form_del_olvido_clave_validate_mensaje

  function do_ajax_form_del_olvido_clave_validate_mensaje_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mensaje";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_olvido_clave_validate_mensaje_cb

  // ---------- Refresh ruc_empresa
  function do_ajax_form_del_olvido_clave_refresh_ruc_empresa()
  {
    var var_ruc_empresa = scAjaxGetFieldText("ruc_empresa");
    var var_nmgp_refresh_fields = "login";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_olvido_clave_refresh_ruc_empresa(var_ruc_empresa, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_del_olvido_clave_refresh_ruc_empresa_cb);
  } // do_ajax_form_del_olvido_clave_refresh_ruc_empresa

  function do_ajax_form_del_olvido_clave_refresh_ruc_empresa_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_olvido_clave_refresh_ruc_empresa_cb

  // ---------- Event onchange login
  function do_ajax_form_del_olvido_clave_event_login_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_olvido_clave_event_login_onchange(var_login, var_ruc_empresa, var_mensaje, var_script_case_init, do_ajax_form_del_olvido_clave_event_login_onchange_cb);
  } // do_ajax_form_del_olvido_clave_event_login_onchange

  function do_ajax_form_del_olvido_clave_event_login_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "login";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_olvido_clave_event_login_onchange_cb_after_alert);
  } // do_ajax_form_del_olvido_clave_event_login_onchange_cb
  function do_ajax_form_del_olvido_clave_event_login_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_olvido_clave_event_login_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_olvido_clave_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_olvido_clave_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_ruc_empresa = scAjaxGetFieldText("ruc_empresa");
    ...
    scAjaxProcOn();
    x_ajax_form_del_olvido_clave_submit_form(var_ruc_empresa, var_login, var_correo, var_mensaje, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_olvido_clave_submit_form_cb);
  } // do_ajax_form_del_olvido_clave_submit_form

  function do_ajax_form_del_olvido_clave_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_olvido_clave_submit_form_cb_after_alert);
  } // do_ajax_form_del_olvido_clave_submit_form_cb
  function do_ajax_form_del_olvido_clave_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_olvido_clave_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_olvido_clave_navigate_form()
  {
    perform_ajax_form_del_olvido_clave_navigate_form();
  }

  function perform_ajax_form_del_olvido_clave_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_form_del_olvido_clave_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_olvido_clave']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_olvido_clave_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_olvido_clave_navigate_form_cb_after_alert);
  } // do_ajax_form_del_olvido_clave_navigate_form_cb
  function do_ajax_form_del_olvido_clave_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_del_olvido_clave_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_olvido_clave_navigate_form_cb_after_alert

  function sc_hide_form_del_olvido_clave_form()
  {
