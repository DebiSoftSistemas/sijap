...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_sbc_id' + iSeqRow).bind('blur', function() { sc_form_fac_solicitud_bajas_cartera_sbc_id_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_fac_solicitud_bajas_cartera_sbc_id_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_sbc_fecha' + iSeqRow).bind('blur', function() { sc_form_fac_solicitud_bajas_cartera_sbc_fecha_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_fac_solicitud_bajas_cartera_sbc_fecha_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_sbc_anio_baja' + iSeqRow).bind('blur', function() { sc_form_fac_solicitud_bajas_cartera_sbc_anio_baja_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_fac_solicitud_bajas_cartera_sbc_anio_baja_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_sbc_usuario' + iSeqRow).bind('blur', function() { sc_form_fac_solicitud_bajas_cartera_sbc_usuario_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_fac_solicitud_bajas_cartera_sbc_usuario_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_sbc_motivo_anulacion' + iSeqRow).bind('blur', function() { sc_form_fac_solicitud_bajas_cartera_sbc_motivo_anulacion_onblur(this, iSeqRow) })
                                                  .bind('change', function() { sc_form_fac_solicitud_bajas_cartera_sbc_motivo_anulacion_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_sbc_empresa' + iSeqRow).bind('blur', function() { sc_form_fac_solicitud_bajas_cartera_sbc_empresa_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_fac_solicitud_bajas_cartera_sbc_empresa_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_operaciones' + iSeqRow).bind('blur', function() { sc_form_fac_solicitud_bajas_cartera_operaciones_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_fac_solicitud_bajas_cartera_operaciones_onchange(this, iSeqRow) })
...
function sc_form_fac_solicitud_bajas_cartera_sbc_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_fac_solicitud_bajas_cartera_sbc_fecha_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_fac_solicitud_bajas_cartera_sbc_anio_baja_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_fac_solicitud_bajas_cartera_sbc_usuario_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_fac_solicitud_bajas_cartera_sbc_motivo_anulacion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_fac_solicitud_bajas_cartera_sbc_empresa_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_fac_solicitud_bajas_cartera_operaciones_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_form_fac_solicitud_bajas_cartera_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_fac_solicitud_bajas_cartera')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
