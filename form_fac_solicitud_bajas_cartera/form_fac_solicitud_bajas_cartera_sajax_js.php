  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_fac_solicitud_bajas_cartera" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_fac_solicitud_bajas_cartera_form();
	}
...
?>
  ...
  // ---------- Validate sbc_id
  function do_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_id()
  {
    var nomeCampo_sbc_id = "sbc_id";
    var var_sbc_id = scAjaxGetFieldHidden(nomeCampo_sbc_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_id(var_sbc_id, var_script_case_init, do_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_id_cb);
  } // do_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_id

  function do_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_id_cb

  // ---------- Validate sbc_fecha
  function do_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_fecha()
  {
    var nomeCampo_sbc_fecha = "sbc_fecha";
    var var_sbc_fecha = scAjaxGetFieldHidden(nomeCampo_sbc_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_fecha(var_sbc_fecha, var_script_case_init, do_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_fecha_cb);
  } // do_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_fecha

  function do_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sbc_fecha";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_fecha_cb

  // ---------- Validate sbc_anio_baja
  function do_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_anio_baja()
  {
    var nomeCampo_sbc_anio_baja = "sbc_anio_baja";
    var var_sbc_anio_baja = scAjaxGetFieldSelect(nomeCampo_sbc_anio_baja);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_anio_baja(var_sbc_anio_baja, var_script_case_init, do_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_anio_baja_cb);
  } // do_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_anio_baja

  function do_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_anio_baja_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sbc_anio_baja";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_anio_baja_cb

  // ---------- Validate sbc_motivo_anulacion
  function do_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_motivo_anulacion()
  {
    var nomeCampo_sbc_motivo_anulacion = "sbc_motivo_anulacion";
    var var_sbc_motivo_anulacion = scAjaxGetFieldText(nomeCampo_sbc_motivo_anulacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_motivo_anulacion(var_sbc_motivo_anulacion, var_script_case_init, do_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_motivo_anulacion_cb);
  } // do_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_motivo_anulacion

  function do_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_motivo_anulacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sbc_motivo_anulacion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_motivo_anulacion_cb

  // ---------- Validate sbc_usuario
  function do_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_usuario()
  {
    var nomeCampo_sbc_usuario = "sbc_usuario";
    var var_sbc_usuario = scAjaxGetFieldText(nomeCampo_sbc_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_usuario(var_sbc_usuario, var_script_case_init, do_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_usuario_cb);
  } // do_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_usuario

  function do_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sbc_usuario";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_usuario_cb

  // ---------- Validate sbc_estado
  function do_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_estado()
  {
    var nomeCampo_sbc_estado = "sbc_estado";
    var var_sbc_estado = scAjaxGetFieldHidden(nomeCampo_sbc_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_estado(var_sbc_estado, var_script_case_init, do_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_estado_cb);
  } // do_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_estado

  function do_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sbc_estado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_estado_cb

  // ---------- Validate sbc_empresa
  function do_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_empresa()
  {
    var nomeCampo_sbc_empresa = "sbc_empresa";
    var var_sbc_empresa = scAjaxGetFieldText(nomeCampo_sbc_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_empresa(var_sbc_empresa, var_script_case_init, do_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_empresa_cb);
  } // do_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_empresa

  function do_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sbc_empresa";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_bajas_cartera_validate_sbc_empresa_cb

  // ---------- Validate operaciones
  function do_ajax_form_fac_solicitud_bajas_cartera_validate_operaciones()
  {
    var nomeCampo_operaciones = "operaciones";
    var var_operaciones = scAjaxGetFieldText(nomeCampo_operaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_bajas_cartera_validate_operaciones(var_operaciones, var_script_case_init, do_ajax_form_fac_solicitud_bajas_cartera_validate_operaciones_cb);
  } // do_ajax_form_fac_solicitud_bajas_cartera_validate_operaciones

  function do_ajax_form_fac_solicitud_bajas_cartera_validate_operaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_bajas_cartera_validate_operaciones_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_fac_solicitud_bajas_cartera_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_fac_solicitud_bajas_cartera_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_sbc_id = scAjaxGetFieldHidden("sbc_id");
    var var_sbc_fecha = scAjaxGetFieldHidden("sbc_fecha");
    var var_sbc_anio_baja = scAjaxGetFieldSelect("sbc_anio_baja");
    var var_sbc_motivo_anulacion = scAjaxGetFieldText("sbc_motivo_anulacion");
    var var_sbc_usuario = scAjaxGetFieldText("sbc_usuario");
    var var_sbc_estado = scAjaxGetFieldHidden("sbc_estado");
    var var_sbc_empresa = scAjaxGetFieldText("sbc_empresa");
    ...
    scAjaxProcOn();
    x_ajax_form_fac_solicitud_bajas_cartera_submit_form(var_sbc_id, var_sbc_fecha, var_sbc_anio_baja, var_sbc_motivo_anulacion, var_sbc_usuario, var_sbc_estado, var_sbc_empresa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_fac_solicitud_bajas_cartera_submit_form_cb);
  } // do_ajax_form_fac_solicitud_bajas_cartera_submit_form

  function do_ajax_form_fac_solicitud_bajas_cartera_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_fac_solicitud_bajas_cartera_submit_form_cb_after_alert);
  } // do_ajax_form_fac_solicitud_bajas_cartera_submit_form_cb
  function do_ajax_form_fac_solicitud_bajas_cartera_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_fac_solicitud_bajas_cartera_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["grid_fac_operaciones_bajas_cartera"] = "off";

  function do_ajax_form_fac_solicitud_bajas_cartera_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_fac_solicitud_bajas_cartera_navigate_form, function() {});
    } else {
      perform_ajax_form_fac_solicitud_bajas_cartera_navigate_form();
    }
  }

  function perform_ajax_form_fac_solicitud_bajas_cartera_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    var var_sbc_id = document.F2.sbc_id.value;
    ...
    scAjaxProcOn();
    scStatusDetail["grid_fac_operaciones_bajas_cartera"] = "on";
    x_ajax_form_fac_solicitud_bajas_cartera_navigate_form(var_sbc_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_solicitud_bajas_cartera_navigate_form_cb);
  } // do_ajax_form_fac_solicitud_bajas_cartera_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_bajas_cartera']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_fac_solicitud_bajas_cartera_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.sbc_id.value = scAjaxGetKeyValue("sbc_id");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_grid_fac_operaciones_bajas_cartera"] && "nmsc_iframe_liga_grid_fac_operaciones_bajas_cartera" != scMasterDetailIframe["nmsc_iframe_liga_grid_fac_operaciones_bajas_cartera"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_grid_fac_operaciones_bajas_cartera"]);
    }
    else {
        if (oResp["navSummary"].reg_tot != 0) {
            document.getElementById('nmsc_iframe_liga_grid_fac_operaciones_bajas_cartera').contentWindow.nm_move('apl_detalhe', true, '400');
        }
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_fac_solicitud_bajas_cartera_navigate_form_cb_after_alert);
  } // do_ajax_form_fac_solicitud_bajas_cartera_navigate_form_cb
  function do_ajax_form_fac_solicitud_bajas_cartera_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_fac_solicitud_bajas_cartera_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_fac_solicitud_bajas_cartera_navigate_form_cb_after_alert

  function sc_hide_form_fac_solicitud_bajas_cartera_form()
  {
  ...
  {
    if ("off" == scStatusDetail["grid_fac_operaciones_bajas_cartera"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "sbc_id";
  ajax_field_list[1] = "sbc_fecha";
  ajax_field_list[2] = "sbc_anio_baja";
  ajax_field_list[3] = "sbc_motivo_anulacion";
  ajax_field_list[4] = "sbc_usuario";
  ajax_field_list[5] = "sbc_estado";
  ajax_field_list[6] = "sbc_empresa";
  ajax_field_list[7] = "operaciones";
  ...
  var ajax_error_list = {
    "sbc_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "sbc_fecha": {"label": "<?php echo $this->Ini->Nm_lang['lang_fecha'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "sbc_anio_baja": {"label": "<?php echo $this->Ini->Nm_lang['lang_srch_year'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "sbc_motivo_anulacion": {"label": "<?php echo $this->Ini->Nm_lang['lang_motivo_anulacion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "sbc_usuario": {"label": "<?php echo $this->Ini->Nm_lang['lang_usuario'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "sbc_estado": {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "sbc_empresa": {"label": "<?php echo $this->Ini->Nm_lang['lang_empresa'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "operaciones": {"label": "operaciones", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    "sbc_id": new Array(),
    "sbc_fecha": new Array(),
    "sbc_anio_baja": new Array(),
    "sbc_motivo_anulacion": new Array(),
    "sbc_usuario": new Array(),
    "sbc_estado": new Array(),
    "sbc_empresa": new Array(),
    "operaciones": new Array()
  };
  ajax_field_mult["sbc_id"][1] = "sbc_id";
  ajax_field_mult["sbc_fecha"][1] = "sbc_fecha";
  ajax_field_mult["sbc_anio_baja"][1] = "sbc_anio_baja";
  ajax_field_mult["sbc_motivo_anulacion"][1] = "sbc_motivo_anulacion";
  ajax_field_mult["sbc_usuario"][1] = "sbc_usuario";
  ajax_field_mult["sbc_estado"][1] = "sbc_estado";
  ajax_field_mult["sbc_empresa"][1] = "sbc_empresa";
  ajax_field_mult["operaciones"][1] = "operaciones";

  var ajax_field_id = {
    "sbc_fecha": new Array("hidden_field_label_sbc_fecha", "hidden_field_data_sbc_fecha"),
    "sbc_anio_baja": new Array("hidden_field_label_sbc_anio_baja", "hidden_field_data_sbc_anio_baja"),
    "sbc_motivo_anulacion": new Array("hidden_field_label_sbc_motivo_anulacion", "hidden_field_data_sbc_motivo_anulacion"),
    "sbc_estado": new Array("hidden_field_label_sbc_estado", "hidden_field_data_sbc_estado"),
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("sbc_motivo_anulacion" == sIndex)
    {
