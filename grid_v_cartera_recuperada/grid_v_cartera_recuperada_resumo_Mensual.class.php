...
SCEOT;
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_periodo_baja = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada']['arr_total']['periodo_baja'];
          $this->array_total_mes_baja = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada']['arr_total']['mes_baja'];
      }
      else
      {
          $this->array_total_periodo_baja = array();
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada']['summarizing_fields_order']['mensual']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada']['summarizing_fields_order']['mensual'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada']['summarizing_fields_order']['mensual'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada']['summarizing_fields_display']['mensual'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada']['summarizing_fields_display']['mensual'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada']['summarizing_fields_display']['mensual'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada']['summarizing_fields_display']['mensual'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada']['summarizing_fields_display']['mensual'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada']['summarizing_fields_display']['mensual'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_recuperada']['summarizing_fields_display']['mensual'] as $i_sum => $d_sum)
           {
...
{ 
   ...
   //---- 
   function adiciona_registro($sum_do_subtotal, $sum_do_valor_iva, $sum_do_total, $quebra_periodo_baja, $quebra_mes_baja, $quebra_periodo_baja_orig, $quebra_mes_baja_orig)
   {
      //----- periodo_baja
      if (!isset($this->array_total_periodo_baja[$quebra_periodo_baja_orig]))
      {
         ...
         $this->array_total_periodo_baja[$quebra_periodo_baja_orig][1] = $sum_do_subtotal;
         $this->array_total_periodo_baja[$quebra_periodo_baja_orig][2] = $sum_do_valor_iva;
         $this->array_total_periodo_baja[$quebra_periodo_baja_orig][3] = $sum_do_total;
      ...
      else
      {
         ...
         $this->array_total_periodo_baja[$quebra_periodo_baja_orig][1] = bcadd($this->array_total_periodo_baja[$quebra_periodo_baja_orig][1], $sum_do_subtotal, 10);
         $this->array_total_periodo_baja[$quebra_periodo_baja_orig][2] = bcadd($this->array_total_periodo_baja[$quebra_periodo_baja_orig][2], $sum_do_valor_iva, 10);
         $this->array_total_periodo_baja[$quebra_periodo_baja_orig][3] = bcadd($this->array_total_periodo_baja[$quebra_periodo_baja_orig][3], $sum_do_total, 10);
      }
      //----- Mes Recuperación
      if (!isset($this->array_total_mes_baja[$quebra_periodo_baja_orig][$quebra_mes_baja_orig]))
      {
         ...
         $this->array_total_mes_baja[$quebra_periodo_baja_orig][$quebra_mes_baja_orig][1] = $sum_do_subtotal;
         $this->array_total_mes_baja[$quebra_periodo_baja_orig][$quebra_mes_baja_orig][2] = $sum_do_valor_iva;
         $this->array_total_mes_baja[$quebra_periodo_baja_orig][$quebra_mes_baja_orig][3] = $sum_do_total;
      ...
      else
      {
         ...
         $this->array_total_mes_baja[$quebra_periodo_baja_orig][$quebra_mes_baja_orig][1] = bcadd($this->array_total_mes_baja[$quebra_periodo_baja_orig][$quebra_mes_baja_orig][1], $sum_do_subtotal, 10);
         $this->array_total_mes_baja[$quebra_periodo_baja_orig][$quebra_mes_baja_orig][2] = bcadd($this->array_total_mes_baja[$quebra_periodo_baja_orig][$quebra_mes_baja_orig][2], $sum_do_valor_iva, 10);
         $this->array_total_mes_baja[$quebra_periodo_baja_orig][$quebra_mes_baja_orig][3] = bcadd($this->array_total_mes_baja[$quebra_periodo_baja_orig][$quebra_mes_baja_orig][3], $sum_do_total, 10);
      }
   }
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->do_subtotal, $this->do_valor_iva, $this->do_total, $this->periodo_baja, $this->mes_baja, $this->periodo_baja_orig,  $this->mes_baja_orig);
            }
   }
//
