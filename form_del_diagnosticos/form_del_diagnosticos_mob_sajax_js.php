  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_diagnosticos_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_diagnosticos_mob_form();
	}
...
?>
  ...
  // ---------- Validate dia_id
  function do_ajax_form_del_diagnosticos_mob_validate_dia_id()
  {
    var nomeCampo_dia_id = "dia_id";
    var var_dia_id = scAjaxGetFieldHidden(nomeCampo_dia_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_diagnosticos_mob_validate_dia_id(var_dia_id, var_script_case_init, do_ajax_form_del_diagnosticos_mob_validate_dia_id_cb);
  } // do_ajax_form_del_diagnosticos_mob_validate_dia_id

  function do_ajax_form_del_diagnosticos_mob_validate_dia_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_diagnosticos_mob_validate_dia_id_cb

  // ---------- Validate dia_empresa
  function do_ajax_form_del_diagnosticos_mob_validate_dia_empresa()
  {
    var nomeCampo_dia_empresa = "dia_empresa";
    var var_dia_empresa = scAjaxGetFieldText(nomeCampo_dia_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_diagnosticos_mob_validate_dia_empresa(var_dia_empresa, var_script_case_init, do_ajax_form_del_diagnosticos_mob_validate_dia_empresa_cb);
  } // do_ajax_form_del_diagnosticos_mob_validate_dia_empresa

  function do_ajax_form_del_diagnosticos_mob_validate_dia_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dia_empresa";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_diagnosticos_mob_validate_dia_empresa_cb

  // ---------- Validate dia_descripcion
  function do_ajax_form_del_diagnosticos_mob_validate_dia_descripcion()
  {
    var nomeCampo_dia_descripcion = "dia_descripcion";
    var var_dia_descripcion = scAjaxGetFieldText(nomeCampo_dia_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_diagnosticos_mob_validate_dia_descripcion(var_dia_descripcion, var_script_case_init, do_ajax_form_del_diagnosticos_mob_validate_dia_descripcion_cb);
  } // do_ajax_form_del_diagnosticos_mob_validate_dia_descripcion

  function do_ajax_form_del_diagnosticos_mob_validate_dia_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dia_descripcion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_diagnosticos_mob_validate_dia_descripcion_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_diagnosticos_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_diagnosticos_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_dia_id = scAjaxGetFieldHidden("dia_id");
    var var_dia_empresa = scAjaxGetFieldText("dia_empresa");
    var var_dia_descripcion = scAjaxGetFieldText("dia_descripcion");
    ...
    scAjaxProcOn();
    x_ajax_form_del_diagnosticos_mob_submit_form(var_dia_id, var_dia_empresa, var_dia_descripcion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_diagnosticos_mob_submit_form_cb);
  } // do_ajax_form_del_diagnosticos_mob_submit_form

  function do_ajax_form_del_diagnosticos_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("dia_id");
      scAjaxHideErrorDisplay("dia_empresa");
      scAjaxHideErrorDisplay("dia_descripcion");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_diagnosticos_mob_submit_form_cb_after_alert);
  } // do_ajax_form_del_diagnosticos_mob_submit_form_cb
  function do_ajax_form_del_diagnosticos_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_diagnosticos_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_diagnosticos_mob_navigate_form()
  {
    perform_ajax_form_del_diagnosticos_mob_navigate_form();
  }

  function perform_ajax_form_del_diagnosticos_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("dia_empresa");
    scAjaxHideErrorDisplay("dia_descripcion");
    var var_dia_id = document.F2.dia_id.value;
    ...
    scAjaxProcOn();
    x_ajax_form_del_diagnosticos_mob_navigate_form(var_dia_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_diagnosticos_mob_navigate_form_cb);
  } // do_ajax_form_del_diagnosticos_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_diagnosticos_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_diagnosticos_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.dia_id.value = scAjaxGetKeyValue("dia_id");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_diagnosticos_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_del_diagnosticos_mob_navigate_form_cb
  function do_ajax_form_del_diagnosticos_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_del_diagnosticos_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_diagnosticos_mob_navigate_form_cb_after_alert

  function sc_hide_form_del_diagnosticos_mob_form()
  {
  ...
  ajax_field_list[0] = "dia_id";
  ajax_field_list[1] = "dia_empresa";
  ajax_field_list[2] = "dia_descripcion";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "dia_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "dia_empresa": {"label": "<?php echo $this->Ini->Nm_lang['lang_empresa'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "dia_descripcion": {"label": "<?php echo $this->Ini->Nm_lang['lang_diagnostico'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "dia_id": new Array(),
    "dia_empresa": new Array(),
    "dia_descripcion": new Array()
  };
  ajax_field_mult["dia_id"][1] = "dia_id";
  ajax_field_mult["dia_empresa"][1] = "dia_empresa";
  ajax_field_mult["dia_descripcion"][1] = "dia_descripcion";

  var ajax_field_id = {
    "dia_descripcion": new Array("hidden_field_label_dia_descripcion", "hidden_field_data_dia_descripcion")
  };
