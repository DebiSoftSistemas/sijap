  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_jap_escenario_materiales_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_jap_escenario_materiales_mob_form();
	}
...
?>
  ...
  // ---------- Validate esc_id
  function do_ajax_form_jap_escenario_materiales_mob_validate_esc_id()
  {
    var nomeCampo_esc_id = "esc_id";
    var var_esc_id = scAjaxGetFieldHidden(nomeCampo_esc_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_escenario_materiales_mob_validate_esc_id(var_esc_id, var_script_case_init, do_ajax_form_jap_escenario_materiales_mob_validate_esc_id_cb);
  } // do_ajax_form_jap_escenario_materiales_mob_validate_esc_id

  function do_ajax_form_jap_escenario_materiales_mob_validate_esc_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_escenario_materiales_mob_validate_esc_id_cb

  // ---------- Validate esc_tipo_deuda
  function do_ajax_form_jap_escenario_materiales_mob_validate_esc_tipo_deuda()
  {
    var nomeCampo_esc_tipo_deuda = "esc_tipo_deuda";
    var var_esc_tipo_deuda = scAjaxGetFieldSelect(nomeCampo_esc_tipo_deuda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_escenario_materiales_mob_validate_esc_tipo_deuda(var_esc_tipo_deuda, var_script_case_init, do_ajax_form_jap_escenario_materiales_mob_validate_esc_tipo_deuda_cb);
  } // do_ajax_form_jap_escenario_materiales_mob_validate_esc_tipo_deuda

  function do_ajax_form_jap_escenario_materiales_mob_validate_esc_tipo_deuda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "esc_tipo_deuda";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_escenario_materiales_mob_validate_esc_tipo_deuda_cb

  // ---------- Validate esc_mes_periodo
  function do_ajax_form_jap_escenario_materiales_mob_validate_esc_mes_periodo()
  {
    var nomeCampo_esc_mes_periodo = "esc_mes_periodo";
    var var_esc_mes_periodo = scAjaxGetFieldSelect(nomeCampo_esc_mes_periodo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_escenario_materiales_mob_validate_esc_mes_periodo(var_esc_mes_periodo, var_script_case_init, do_ajax_form_jap_escenario_materiales_mob_validate_esc_mes_periodo_cb);
  } // do_ajax_form_jap_escenario_materiales_mob_validate_esc_mes_periodo

  function do_ajax_form_jap_escenario_materiales_mob_validate_esc_mes_periodo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "esc_mes_periodo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_escenario_materiales_mob_validate_esc_mes_periodo_cb

  // ---------- Validate esc_anio_periodo
  function do_ajax_form_jap_escenario_materiales_mob_validate_esc_anio_periodo()
  {
    var nomeCampo_esc_anio_periodo = "esc_anio_periodo";
    var var_esc_anio_periodo = scAjaxGetFieldSelect(nomeCampo_esc_anio_periodo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_escenario_materiales_mob_validate_esc_anio_periodo(var_esc_anio_periodo, var_script_case_init, do_ajax_form_jap_escenario_materiales_mob_validate_esc_anio_periodo_cb);
  } // do_ajax_form_jap_escenario_materiales_mob_validate_esc_anio_periodo

  function do_ajax_form_jap_escenario_materiales_mob_validate_esc_anio_periodo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "esc_anio_periodo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_escenario_materiales_mob_validate_esc_anio_periodo_cb

  // ---------- Validate contrato
  function do_ajax_form_jap_escenario_materiales_mob_validate_contrato()
  {
    var nomeCampo_contrato = "contrato";
    var var_contrato = scAjaxGetFieldSelect(nomeCampo_contrato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_escenario_materiales_mob_validate_contrato(var_contrato, var_script_case_init, do_ajax_form_jap_escenario_materiales_mob_validate_contrato_cb);
  } // do_ajax_form_jap_escenario_materiales_mob_validate_contrato

  function do_ajax_form_jap_escenario_materiales_mob_validate_contrato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_escenario_materiales_mob_validate_contrato_cb

  // ---------- Validate esc_comentario
  function do_ajax_form_jap_escenario_materiales_mob_validate_esc_comentario()
  {
    var nomeCampo_esc_comentario = "esc_comentario";
    var var_esc_comentario = scAjaxGetFieldText(nomeCampo_esc_comentario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_escenario_materiales_mob_validate_esc_comentario(var_esc_comentario, var_script_case_init, do_ajax_form_jap_escenario_materiales_mob_validate_esc_comentario_cb);
  } // do_ajax_form_jap_escenario_materiales_mob_validate_esc_comentario

  function do_ajax_form_jap_escenario_materiales_mob_validate_esc_comentario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "esc_comentario";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_escenario_materiales_mob_validate_esc_comentario_cb

  // ---------- Validate esc_total
  function do_ajax_form_jap_escenario_materiales_mob_validate_esc_total()
  {
    var nomeCampo_esc_total = "esc_total";
    var var_esc_total = scAjaxGetFieldHidden(nomeCampo_esc_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_escenario_materiales_mob_validate_esc_total(var_esc_total, var_script_case_init, do_ajax_form_jap_escenario_materiales_mob_validate_esc_total_cb);
  } // do_ajax_form_jap_escenario_materiales_mob_validate_esc_total

  function do_ajax_form_jap_escenario_materiales_mob_validate_esc_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "esc_total";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_escenario_materiales_mob_validate_esc_total_cb

  // ---------- Validate esc_estado
  function do_ajax_form_jap_escenario_materiales_mob_validate_esc_estado()
  {
    var nomeCampo_esc_estado = "esc_estado";
    var var_esc_estado = scAjaxGetFieldHidden(nomeCampo_esc_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_escenario_materiales_mob_validate_esc_estado(var_esc_estado, var_script_case_init, do_ajax_form_jap_escenario_materiales_mob_validate_esc_estado_cb);
  } // do_ajax_form_jap_escenario_materiales_mob_validate_esc_estado

  function do_ajax_form_jap_escenario_materiales_mob_validate_esc_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "esc_estado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_escenario_materiales_mob_validate_esc_estado_cb

  // ---------- Validate detalles
  function do_ajax_form_jap_escenario_materiales_mob_validate_detalles()
  {
    var nomeCampo_detalles = "detalles";
    var var_detalles = scAjaxGetFieldText(nomeCampo_detalles);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_escenario_materiales_mob_validate_detalles(var_detalles, var_script_case_init, do_ajax_form_jap_escenario_materiales_mob_validate_detalles_cb);
  } // do_ajax_form_jap_escenario_materiales_mob_validate_detalles

  function do_ajax_form_jap_escenario_materiales_mob_validate_detalles_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_escenario_materiales_mob_validate_detalles_cb

  // ---------- Validate productos
  function do_ajax_form_jap_escenario_materiales_mob_validate_productos()
  {
    var nomeCampo_productos = "productos";
    var var_productos = scAjaxGetFieldText(nomeCampo_productos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_escenario_materiales_mob_validate_productos(var_productos, var_script_case_init, do_ajax_form_jap_escenario_materiales_mob_validate_productos_cb);
  } // do_ajax_form_jap_escenario_materiales_mob_validate_productos

  function do_ajax_form_jap_escenario_materiales_mob_validate_productos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_escenario_materiales_mob_validate_productos_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_jap_escenario_materiales_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_jap_escenario_materiales_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_esc_id = scAjaxGetFieldHidden("esc_id");
    var var_esc_tipo_deuda = scAjaxGetFieldSelect("esc_tipo_deuda");
    var var_esc_mes_periodo = scAjaxGetFieldSelect("esc_mes_periodo");
    var var_esc_anio_periodo = scAjaxGetFieldSelect("esc_anio_periodo");
    var var_contrato = scAjaxGetFieldSelect("contrato");
    var var_esc_comentario = scAjaxGetFieldText("esc_comentario");
    var var_esc_total = scAjaxGetFieldHidden("esc_total");
    var var_esc_estado = scAjaxGetFieldHidden("esc_estado");
    ...
    scAjaxProcOn();
    x_ajax_form_jap_escenario_materiales_mob_submit_form(var_esc_id, var_esc_tipo_deuda, var_esc_mes_periodo, var_esc_anio_periodo, var_contrato, var_esc_comentario, var_esc_total, var_esc_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_jap_escenario_materiales_mob_submit_form_cb);
  } // do_ajax_form_jap_escenario_materiales_mob_submit_form

  function do_ajax_form_jap_escenario_materiales_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("esc_id");
      scAjaxHideErrorDisplay("esc_tipo_deuda");
      scAjaxHideErrorDisplay("esc_mes_periodo");
      scAjaxHideErrorDisplay("esc_anio_periodo");
      scAjaxHideErrorDisplay("contrato");
      scAjaxHideErrorDisplay("esc_comentario");
      scAjaxHideErrorDisplay("esc_total");
      scAjaxHideErrorDisplay("esc_estado");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_jap_escenario_materiales_mob_submit_form_cb_after_alert);
  } // do_ajax_form_jap_escenario_materiales_mob_submit_form_cb
  function do_ajax_form_jap_escenario_materiales_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_jap_escenario_materiales_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["grid_jap_deudas_escenario_materiales"] = "off";
  scStatusDetail["form_jap_detalle_deudas_escenario_materiales_mob"] = "off";

  function do_ajax_form_jap_escenario_materiales_mob_navigate_form()
  {
    perform_ajax_form_jap_escenario_materiales_mob_navigate_form();
  }

  function perform_ajax_form_jap_escenario_materiales_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("detalles");
    scAjaxHideErrorDisplay("productos");
    var var_esc_id = document.F2.esc_id.value;
    ...
    scAjaxProcOn();
    scStatusDetail["grid_jap_deudas_escenario_materiales"] = "on";
    scStatusDetail["form_jap_detalle_deudas_escenario_materiales_mob"] = "on";
    x_ajax_form_jap_escenario_materiales_mob_navigate_form(var_esc_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jap_escenario_materiales_mob_navigate_form_cb);
  } // do_ajax_form_jap_escenario_materiales_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_escenario_materiales_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_jap_escenario_materiales_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.esc_id.value = scAjaxGetKeyValue("esc_id");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_grid_jap_deudas_escenario_materiales"] && "nmsc_iframe_liga_grid_jap_deudas_escenario_materiales" != scMasterDetailIframe["nmsc_iframe_liga_grid_jap_deudas_escenario_materiales"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_grid_jap_deudas_escenario_materiales"]);
    }
    else {
        if (oResp["navSummary"].reg_tot != 0) {
            document.getElementById('nmsc_iframe_liga_grid_jap_deudas_escenario_materiales').contentWindow.nm_move('apl_detalhe', true);
        }
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_jap_detalle_deudas_escenario_materiales_mob"] && "nmsc_iframe_liga_form_jap_detalle_deudas_escenario_materiales_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_jap_detalle_deudas_escenario_materiales_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_jap_detalle_deudas_escenario_materiales_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_jap_detalle_deudas_escenario_materiales_mob').contentWindow.nm_move('apl_detalhe', true, '300');
        document.getElementById('nmsc_iframe_liga_form_jap_detalle_deudas_escenario_materiales_mob').style.height = "300";
        document.getElementById('nmsc_iframe_liga_form_jap_detalle_deudas_escenario_materiales_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_jap_escenario_materiales_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_jap_escenario_materiales_mob_navigate_form_cb
  function do_ajax_form_jap_escenario_materiales_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_jap_escenario_materiales_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_jap_escenario_materiales_mob_navigate_form_cb_after_alert

  function sc_hide_form_jap_escenario_materiales_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["grid_jap_deudas_escenario_materiales"] && "off" == scStatusDetail["form_jap_detalle_deudas_escenario_materiales_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "esc_id";
  ajax_field_list[1] = "esc_tipo_deuda";
  ajax_field_list[2] = "esc_mes_periodo";
  ajax_field_list[3] = "esc_anio_periodo";
  ajax_field_list[4] = "contrato";
  ajax_field_list[5] = "esc_comentario";
  ajax_field_list[6] = "esc_total";
  ajax_field_list[7] = "esc_estado";
  ajax_field_list[8] = "detalles";
  ajax_field_list[9] = "productos";
  ...
  var ajax_error_list = {
    "esc_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "esc_tipo_deuda": {"label": "<?php echo $this->Ini->Nm_lang['lang_tipo_deuda'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "esc_mes_periodo": {"label": "<?php echo $this->Ini->Nm_lang['lang_srch_mnth'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "esc_anio_periodo": {"label": "<?php echo $this->Ini->Nm_lang['lang_srch_year'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "esc_comentario": {"label": "<?php echo $this->Ini->Nm_lang['lang_comentario'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "esc_total": {"label": "<?php echo $this->Ini->Nm_lang['lang_total'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "esc_estado": {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "esc_id": new Array(),
    "esc_tipo_deuda": new Array(),
    "esc_mes_periodo": new Array(),
    "esc_anio_periodo": new Array(),
    "contrato": new Array(),
    "esc_comentario": new Array(),
    "esc_total": new Array(),
    "esc_estado": new Array(),
    "detalles": new Array(),
    "productos": new Array()
  };
  ajax_field_mult["esc_id"][1] = "esc_id";
  ajax_field_mult["esc_tipo_deuda"][1] = "esc_tipo_deuda";
  ajax_field_mult["esc_mes_periodo"][1] = "esc_mes_periodo";
  ajax_field_mult["esc_anio_periodo"][1] = "esc_anio_periodo";
  ajax_field_mult["contrato"][1] = "contrato";
  ajax_field_mult["esc_comentario"][1] = "esc_comentario";
  ajax_field_mult["esc_total"][1] = "esc_total";
  ajax_field_mult["esc_estado"][1] = "esc_estado";
  ajax_field_mult["detalles"][1] = "detalles";
  ajax_field_mult["productos"][1] = "productos";

  var ajax_field_id = {
    "esc_id": new Array("hidden_field_label_esc_id", "hidden_field_data_esc_id"),
    "esc_tipo_deuda": new Array("hidden_field_label_esc_tipo_deuda", "hidden_field_data_esc_tipo_deuda"),
    "esc_mes_periodo": new Array("hidden_field_label_esc_mes_periodo", "hidden_field_data_esc_mes_periodo"),
    "esc_anio_periodo": new Array("hidden_field_label_esc_anio_periodo", "hidden_field_data_esc_anio_periodo"),
    "contrato": new Array("hidden_field_label_contrato", "hidden_field_data_contrato"),
    "esc_comentario": new Array("hidden_field_label_esc_comentario", "hidden_field_data_esc_comentario"),
    "esc_total": new Array("hidden_field_label_esc_total", "hidden_field_data_esc_total"),
    "esc_estado": new Array("hidden_field_label_esc_estado", "hidden_field_data_esc_estado"),
