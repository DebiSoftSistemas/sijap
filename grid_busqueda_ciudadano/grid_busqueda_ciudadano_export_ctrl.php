<?php
@session_start() ;
$_SESSION['scriptcase']['grid_busqueda_ciudadano']['sc_process_barr'] = true;
require_once('../grid_busqueda_ciudadano/index.php');
unset($_SESSION['scriptcase']['grid_busqueda_ciudadano']['sc_process_barr']);
$ExportCtrl = new grid_busqueda_ciudadano_export_control;
$ExportCtrl->Export_barr();

class grid_busqueda_ciudadano_export_control
{
