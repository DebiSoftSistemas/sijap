...
<?php
   ...
   $Ord_Cmp = new grid_busqueda_ciudadano_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_busqueda_ciudadano_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_busqueda_ciudadano']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_busqueda_ciudadano']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['ciu_identificacion'] = "ciu_identificacion";
   $tab_labels["ciu_identificacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_busqueda_ciudadano']['labels']["ciu_identificacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_busqueda_ciudadano']['labels']["ciu_identificacion"] : "" . $this->Nm_lang['lang_lot_identificacion'] . "";
   $tab_ger_campos['ciu_nombre'] = "on";
   $tab_def_campos['ciu_nombre'] = "ciu_nombre";
   $tab_labels["ciu_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_busqueda_ciudadano']['labels']["ciu_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_busqueda_ciudadano']['labels']["ciu_nombre"] : "" . $this->Nm_lang['lang_nombre'] . "";
   $tab_ger_campos['ciu_direccion'] = "on";
   $tab_def_campos['ciu_direccion'] = "ciu_direccion";
   $tab_labels["ciu_direccion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_busqueda_ciudadano']['labels']["ciu_direccion"])) ? $_SESSION['sc_session'][$sc_init]['grid_busqueda_ciudadano']['labels']["ciu_direccion"] : "" . $this->Nm_lang['lang_direccion'] . "";
   $tab_ger_campos['ciu_correo'] = "on";
   $tab_def_campos['ciu_correo'] = "ciu_correo";
   $tab_labels["ciu_correo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_busqueda_ciudadano']['labels']["ciu_correo"])) ? $_SESSION['sc_session'][$sc_init]['grid_busqueda_ciudadano']['labels']["ciu_correo"] : "" . $this->Nm_lang['lang_email'] . "";
   $tab_ger_campos['ciu_telefono'] = "on";
   $tab_def_campos['ciu_telefono'] = "ciu_telefono";
   $tab_labels["ciu_telefono"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_busqueda_ciudadano']['labels']["ciu_telefono"])) ? $_SESSION['sc_session'][$sc_init]['grid_busqueda_ciudadano']['labels']["ciu_telefono"] : "" . $this->Nm_lang['lang_lot_telefono'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_busqueda_ciudadano']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_busqueda_ciudadano']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_busqueda_ciudadano']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_busqueda_ciudadano']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_busqueda_ciudadano']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_busqueda_ciudadano']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_busqueda_ciudadano']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_busqueda_ciudadano']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_busqueda_ciudadano']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_busqueda_ciudadano']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_busqueda_ciudadano']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_busqueda_ciudadano']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_busqueda_ciudadano_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_busqueda_ciudadano']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_busqueda_ciudadano']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_busqueda_ciudadano']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_busqueda_ciudadano']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_busqueda_ciudadano']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
