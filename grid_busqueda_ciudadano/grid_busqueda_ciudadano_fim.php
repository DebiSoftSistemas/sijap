...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_busqueda_ciudadano"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_busqueda_ciudadano"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_busqueda_ciudadano']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_busqueda_ciudadano']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_busqueda_ciudadano']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_busqueda_ciudadano']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_busqueda_ciudadano']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_busqueda_ciudadano</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_busqueda_ciudadano']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_busqueda_ciudadano']['embutida_filho'] as $ind => $sc_init)
          {
