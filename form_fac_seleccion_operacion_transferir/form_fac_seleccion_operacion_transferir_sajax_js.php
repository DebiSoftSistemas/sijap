  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_fac_seleccion_operacion_transferir" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_fac_seleccion_operacion_transferir_form();
	}
...
?>
  ...
  function do_ajax_form_fac_seleccion_operacion_transferir_validate_op_operacion_(iNumLinha)
  {
    ...
    x_ajax_form_fac_seleccion_operacion_transferir_validate_op_operacion_(var_op_operacion_, iNumLinha, var_script_case_init, do_ajax_form_fac_seleccion_operacion_transferir_validate_op_operacion__cb);
  } // do_ajax_form_fac_seleccion_operacion_transferir_validate_op_operacion_

  function do_ajax_form_fac_seleccion_operacion_transferir_validate_op_operacion__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_seleccion_operacion_transferir_validate_op_operacion__cb

  // ---------- Validate op_tipo_cartera_
  function do_ajax_form_fac_seleccion_operacion_transferir_validate_op_tipo_cartera_(iNumLinha)
  {
    var nomeCampo_op_tipo_cartera_ = "op_tipo_cartera_" + iNumLinha;
    var var_op_tipo_cartera_ = scAjaxGetFieldText(nomeCampo_op_tipo_cartera_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_seleccion_operacion_transferir_validate_op_tipo_cartera_(var_op_tipo_cartera_, iNumLinha, var_script_case_init, do_ajax_form_fac_seleccion_operacion_transferir_validate_op_tipo_cartera__cb);
  } // do_ajax_form_fac_seleccion_operacion_transferir_validate_op_tipo_cartera_

  function do_ajax_form_fac_seleccion_operacion_transferir_validate_op_tipo_cartera__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_seleccion_operacion_transferir_validate_op_tipo_cartera__cb

  // ---------- Validate op_propietario_
  function do_ajax_form_fac_seleccion_operacion_transferir_validate_op_propietario_(iNumLinha)
  {
    var nomeCampo_op_propietario_ = "op_propietario_" + iNumLinha;
    var var_op_propietario_ = scAjaxGetFieldText(nomeCampo_op_propietario_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_seleccion_operacion_transferir_validate_op_propietario_(var_op_propietario_, iNumLinha, var_script_case_init, do_ajax_form_fac_seleccion_operacion_transferir_validate_op_propietario__cb);
  } // do_ajax_form_fac_seleccion_operacion_transferir_validate_op_propietario_

  function do_ajax_form_fac_seleccion_operacion_transferir_validate_op_propietario__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_seleccion_operacion_transferir_validate_op_propietario__cb

  // ---------- Validate op_comentario_
  function do_ajax_form_fac_seleccion_operacion_transferir_validate_op_comentario_(iNumLinha)
  {
    var nomeCampo_op_comentario_ = "op_comentario_" + iNumLinha;
    var var_op_comentario_ = scAjaxGetFieldText(nomeCampo_op_comentario_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_seleccion_operacion_transferir_validate_op_comentario_(var_op_comentario_, iNumLinha, var_script_case_init, do_ajax_form_fac_seleccion_operacion_transferir_validate_op_comentario__cb);
  } // do_ajax_form_fac_seleccion_operacion_transferir_validate_op_comentario_

  function do_ajax_form_fac_seleccion_operacion_transferir_validate_op_comentario__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_seleccion_operacion_transferir_validate_op_comentario__cb

  // ---------- Validate op_total_
  function do_ajax_form_fac_seleccion_operacion_transferir_validate_op_total_(iNumLinha)
  {
    var nomeCampo_op_total_ = "op_total_" + iNumLinha;
    var var_op_total_ = scAjaxGetFieldHidden(nomeCampo_op_total_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_seleccion_operacion_transferir_validate_op_total_(var_op_total_, iNumLinha, var_script_case_init, do_ajax_form_fac_seleccion_operacion_transferir_validate_op_total__cb);
  } // do_ajax_form_fac_seleccion_operacion_transferir_validate_op_total_

  function do_ajax_form_fac_seleccion_operacion_transferir_validate_op_total__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_seleccion_operacion_transferir_validate_op_total__cb

  // ---------- Validate op_estado_
  function do_ajax_form_fac_seleccion_operacion_transferir_validate_op_estado_(iNumLinha)
  {
    var nomeCampo_op_estado_ = "op_estado_" + iNumLinha;
    var var_op_estado_ = scAjaxGetFieldText(nomeCampo_op_estado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_seleccion_operacion_transferir_validate_op_estado_(var_op_estado_, iNumLinha, var_script_case_init, do_ajax_form_fac_seleccion_operacion_transferir_validate_op_estado__cb);
  } // do_ajax_form_fac_seleccion_operacion_transferir_validate_op_estado_

  function do_ajax_form_fac_seleccion_operacion_transferir_validate_op_estado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_seleccion_operacion_transferir_validate_op_estado__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_fac_seleccion_operacion_transferir_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_fac_seleccion_operacion_transferir_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_fac_seleccion_operacion_transferir_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_fac_seleccion_operacion_transferir_add_new_line_cb);
  } // do_ajax_form_fac_seleccion_operacion_transferir_add_new_line

  function do_ajax_form_fac_seleccion_operacion_transferir_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_fac_seleccion_operacion_transferir_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_fac_seleccion_operacion_transferir_backup_line(iNumLinha)
  {
    var var_op_operacion_ = scAjaxGetFieldText("op_operacion_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_seleccion_operacion_transferir_backup_line(var_op_operacion_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_fac_seleccion_operacion_transferir_backup_line_cb);
  } // do_ajax_form_fac_seleccion_operacion_transferir_backup_line

  function do_ajax_form_fac_seleccion_operacion_transferir_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_fac_seleccion_operacion_transferir_backup_line_cb

  function do_ajax_form_fac_seleccion_operacion_transferir_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_fac_seleccion_operacion_transferir_cancel_insert

  function do_ajax_form_fac_seleccion_operacion_transferir_cancel_update(iSeqVert)
  {
    do_ajax_form_fac_seleccion_operacion_transferir_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_fac_seleccion_operacion_transferir_cancel_update

  function do_ajax_form_fac_seleccion_operacion_transferir_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_fac_seleccion_operacion_transferir_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_fac_seleccion_operacion_transferir_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_fac_seleccion_operacion_transferir_table_refresh(var_op_operacion_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_seleccion_operacion_transferir_table_refresh_cb);
  } //  do_ajax_form_fac_seleccion_operacion_transferir_table_refresh

  function do_ajax_form_fac_seleccion_operacion_transferir_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_fac_seleccion_operacion_transferir_table_refresh_cb_after_alert);
  } // do_ajax_form_fac_seleccion_operacion_transferir_table_refresh_cb
  function do_ajax_form_fac_seleccion_operacion_transferir_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_fac_seleccion_operacion_transferir_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_fac_seleccion_operacion_transferir_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_fac_seleccion_operacion_transferir_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_op_operacion_ = scAjaxGetFieldText("op_operacion_" + iNumLinha);
    var var_op_tipo_cartera_ = scAjaxGetFieldText("op_tipo_cartera_" + iNumLinha);
    var var_op_propietario_ = scAjaxGetFieldText("op_propietario_" + iNumLinha);
    ...
    var var_op_estado_ = scAjaxGetFieldText("op_estado_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_fac_seleccion_operacion_transferir_submit_form(var_op_operacion_, var_op_tipo_cartera_, var_op_propietario_, var_op_comentario_, var_op_total_, var_op_estado_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_fac_seleccion_operacion_transferir_submit_form_cb);
  } // do_ajax_form_fac_seleccion_operacion_transferir_submit_form

  function do_ajax_form_fac_seleccion_operacion_transferir_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_fac_seleccion_operacion_transferir_submit_form_cb_after_alert);
  } // do_ajax_form_fac_seleccion_operacion_transferir_submit_form_cb
  function do_ajax_form_fac_seleccion_operacion_transferir_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_fac_seleccion_operacion_transferir_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_fac_seleccion_operacion_transferir_navigate_form()
  {
    perform_ajax_form_fac_seleccion_operacion_transferir_navigate_form();
  }

  function perform_ajax_form_fac_seleccion_operacion_transferir_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_fac_seleccion_operacion_transferir_navigate_form(var_op_operacion_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_seleccion_operacion_transferir_navigate_form_cb);
  } // do_ajax_form_fac_seleccion_operacion_transferir_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_seleccion_operacion_transferir']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_fac_seleccion_operacion_transferir_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_fac_seleccion_operacion_transferir_navigate_form_cb_after_alert);
  } // do_ajax_form_fac_seleccion_operacion_transferir_navigate_form_cb
  function do_ajax_form_fac_seleccion_operacion_transferir_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_fac_seleccion_operacion_transferir_navigate_form_cb_after_alert

    function sc_form_fac_seleccion_operacion_transferir_get_last_line_number()
    {
    ...
    } //sc_form_fac_seleccion_operacion_transferir_get_last_line_number

  function sc_hide_form_fac_seleccion_operacion_transferir_form()
  {
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["op_operacion_" + iRow] || "on" == ajax_error_count["op_tipo_cartera_" + iRow] || "on" == ajax_error_count["op_propietario_" + iRow] || "on" == ajax_error_count["op_comentario_" + iRow] || "on" == ajax_error_count["op_total_" + iRow] || "on" == ajax_error_count["op_estado_" + iRow]))
    {
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["op_operacion_" + iRow] && "off" == ajax_error_count["op_tipo_cartera_" + iRow] && "off" == ajax_error_count["op_propietario_" + iRow] && "off" == ajax_error_count["op_comentario_" + iRow] && "off" == ajax_error_count["op_total_" + iRow] && "off" == ajax_error_count["op_estado_" + iRow]))
    {
      if (bErrorRow)
      {
