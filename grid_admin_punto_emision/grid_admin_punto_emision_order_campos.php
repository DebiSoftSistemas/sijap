...
<?php
   ...
   $Ord_Cmp = new grid_admin_punto_emision_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_admin_punto_emision_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_admin_punto_emision']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_admin_punto_emision']['ordem_select_orig'] = array();
   }
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['del_punto_emision_pem_establecimiento'] = "cmp_maior_30_1";
   }
   else
   {
       $tab_def_campos['del_punto_emision_pem_establecimiento'] = "del_punto_emision.pem_establecimiento";
   }
   $tab_labels["del_punto_emision_pem_establecimiento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_admin_punto_emision']['labels']["del_punto_emision_pem_establecimiento"])) ? $_SESSION['sc_session'][$sc_init]['grid_admin_punto_emision']['labels']["del_punto_emision_pem_establecimiento"] : "" . $this->Nm_lang['lang_establecimiento'] . "";
   $tab_ger_campos['del_punto_emision_pen_serie'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['del_punto_emision_pen_serie'] = "del_punto_emision_pen_serie";
   }
   else
   {
       $tab_def_campos['del_punto_emision_pen_serie'] = "del_punto_emision.pen_serie";
   }
   $tab_labels["del_punto_emision_pen_serie"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_admin_punto_emision']['labels']["del_punto_emision_pen_serie"])) ? $_SESSION['sc_session'][$sc_init]['grid_admin_punto_emision']['labels']["del_punto_emision_pen_serie"] : "" . $this->Nm_lang['lang_punto_emision'] . "";
   ...
   {
       $tab_def_campos['serie'] = "est_codigo||' - '||pen_serie";
   }
   $tab_labels["serie"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_admin_punto_emision']['labels']["serie"])) ? $_SESSION['sc_session'][$sc_init]['grid_admin_punto_emision']['labels']["serie"] : "" . $this->Nm_lang['lang_serie_sri'] . "";
   $tab_ger_campos['del_punto_emision_pem_estado'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['del_punto_emision_pem_estado'] = "del_punto_emision_pem_estado";
   }
   else
   {
       $tab_def_campos['del_punto_emision_pem_estado'] = "del_punto_emision.pem_estado";
   }
   $tab_labels["del_punto_emision_pem_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_admin_punto_emision']['labels']["del_punto_emision_pem_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_admin_punto_emision']['labels']["del_punto_emision_pem_estado"] : "" . $this->Nm_lang['lang_estado'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_admin_punto_emision']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_admin_punto_emision']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_admin_punto_emision']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_admin_punto_emision']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_admin_punto_emision']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_admin_punto_emision']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_admin_punto_emision']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_admin_punto_emision']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_admin_punto_emision']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_admin_punto_emision']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_admin_punto_emision']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_admin_punto_emision']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_admin_punto_emision_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_admin_punto_emision']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_admin_punto_emision']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_admin_punto_emision']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_admin_punto_emision']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_admin_punto_emision']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
