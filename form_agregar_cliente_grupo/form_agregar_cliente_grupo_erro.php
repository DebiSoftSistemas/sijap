...
$old_error_handler = set_error_handler("form_agregar_cliente_grupo_scriptcase_error_handler");

function form_agregar_cliente_grupo_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['form_agregar_cliente_grupo']['contr_erro']) && $_SESSION['scriptcase']['form_agregar_cliente_grupo']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_agregar_cliente_grupo->contr_form_agregar_cliente_grupo->Apl_com_erro = true;
            if ($inicial_form_agregar_cliente_grupo->contr_form_agregar_cliente_grupo->NM_ajax_flag)
            {
                $inicial_form_agregar_cliente_grupo->contr_form_agregar_cliente_grupo->NM_ajax_info['errList']['geral_form_agregar_cliente_grupo'][] = $msg;
                return;
            }
            form_agregar_cliente_grupo_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_agregar_cliente_grupo_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_agregar_cliente_grupo'])  && '' != $_SESSION['scriptcase']['error_icon']['form_agregar_cliente_grupo'])  ? $_SESSION['scriptcase']['error_icon']['form_agregar_cliente_grupo']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_agregar_cliente_grupo']) && '' != $_SESSION['scriptcase']['error_span_title']['form_agregar_cliente_grupo']) ? $_SESSION['scriptcase']['error_span_title']['form_agregar_cliente_grupo'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_agregar_cliente_grupo']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_agregar_cliente_grupo']) ? $_SESSION['scriptcase']['error_icon_title']['form_agregar_cliente_grupo'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_agregar_cliente_grupo']['error_buffer'] .= ob_get_flush();
}
