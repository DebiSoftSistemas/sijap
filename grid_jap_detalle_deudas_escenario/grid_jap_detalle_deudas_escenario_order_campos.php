...
<?php
   ...
   $Ord_Cmp = new grid_jap_detalle_deudas_escenario_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_jap_detalle_deudas_escenario_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['dde_cantidad'] = "dde_cantidad";
   $tab_labels["dde_cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario']['labels']["dde_cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario']['labels']["dde_cantidad"] : "" . $this->Nm_lang['lang_lot_cantidad'] . "";
   $tab_ger_campos['dde_producto'] = "on";
   $tab_def_campos['dde_producto'] = "dde_producto";
   $tab_labels["dde_producto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario']['labels']["dde_producto"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario']['labels']["dde_producto"] : "" . $this->Nm_lang['lang_producto'] . "";
   $tab_ger_campos['dde_valor'] = "on";
   $tab_def_campos['dde_valor'] = "dde_valor";
   $tab_labels["dde_valor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario']['labels']["dde_valor"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario']['labels']["dde_valor"] : "" . $this->Nm_lang['lang_precio_unitario'] . "";
   $tab_ger_campos['dde_iva'] = "on";
   $tab_def_campos['dde_iva'] = "dde_iva";
   $tab_labels["dde_iva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario']['labels']["dde_iva"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario']['labels']["dde_iva"] : "" . $this->Nm_lang['lang_iva'] . "";
   $tab_ger_campos['dde_total'] = "on";
   $tab_def_campos['dde_total'] = "dde_total";
   $tab_labels["dde_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario']['labels']["dde_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario']['labels']["dde_total"] : "" . $this->Nm_lang['lang_total'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_jap_detalle_deudas_escenario_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_jap_detalle_deudas_escenario']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
