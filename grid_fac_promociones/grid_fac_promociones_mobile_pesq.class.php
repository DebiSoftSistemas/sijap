...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "pr_id";$Nm_numeric[] = "pr_filial";$Nm_numeric[] = "pr_valor";$Nm_numeric[] = "pr_iva";$Nm_numeric[] = "pr_ice";$Nm_numeric[] = "pr_total";$Nm_numeric[] = "pr_id";$Nm_numeric[] = "pr_filial";$Nm_numeric[] = "pr_valor";$Nm_numeric[] = "pr_iva";$Nm_numeric[] = "pr_ice";$Nm_numeric[] = "pr_total";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_pr_id_cond" name="pr_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_pr_id'), this, 'pr_id')">
      ...
      <br><span id="id_hide_pr_id"  <?php echo $str_hide_pr_id?>><INPUT  type="text" id="SC_pr_id" name="pr_id" value="<?php echo NM_encode_input($pr_id) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_pr_filial_cond" name="pr_filial_cond" onChange="nm_campos_between(document.getElementById('id_vis_pr_filial'), this, 'pr_filial')">
      ...
      <br><span id="id_hide_pr_filial"  <?php echo $str_hide_pr_filial?>><INPUT  type="text" id="SC_pr_filial" name="pr_filial" value="<?php echo NM_encode_input($pr_filial) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_pr_nombre_cond" name="pr_nombre_cond" onChange="nm_campos_between(document.getElementById('id_vis_pr_nombre'), this, 'pr_nombre')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_pr_descripcion_cond" name="pr_descripcion_cond" onChange="nm_campos_between(document.getElementById('id_vis_pr_descripcion'), this, 'pr_descripcion')">
      ...
      <br><span id="id_hide_pr_descripcion"  <?php echo $str_hide_pr_descripcion?>><INPUT  type="text" id="SC_pr_descripcion" name="pr_descripcion" value="<?php echo NM_encode_input($pr_descripcion) ?>" size="50" maxlength="32767" class="scFilterObjectEven">
 </TD>
