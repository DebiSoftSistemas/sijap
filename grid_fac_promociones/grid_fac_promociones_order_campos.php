...
<?php
   ...
   $Ord_Cmp = new grid_fac_promociones_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_fac_promociones_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_fac_promociones']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_fac_promociones']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['pr_imagen'] = "pr_imagen";
   $tab_labels["pr_imagen"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_promociones']['labels']["pr_imagen"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_promociones']['labels']["pr_imagen"] : "" . $this->Nm_lang['lang_btns_img'] . "";
   $tab_ger_campos['pr_nombre'] = "on";
   $tab_def_campos['pr_nombre'] = "pr_nombre";
   $tab_labels["pr_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_promociones']['labels']["pr_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_promociones']['labels']["pr_nombre"] : "" . $this->Nm_lang['lang_nombre'] . "";
   $tab_ger_campos['pr_descripcion'] = "on";
   $tab_def_campos['pr_descripcion'] = "pr_descripcion";
   $tab_labels["pr_descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_promociones']['labels']["pr_descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_promociones']['labels']["pr_descripcion"] : "" . $this->Nm_lang['lang_descripcion'] . "";
   $tab_ger_campos['pr_total'] = "on";
   $tab_def_campos['pr_total'] = "pr_total";
   $tab_labels["pr_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_promociones']['labels']["pr_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_promociones']['labels']["pr_total"] : "" . $this->Nm_lang['lang_total'] . "";
   $tab_ger_campos['pr_estado'] = "on";
   $tab_def_campos['pr_estado'] = "pr_estado";
   $tab_labels["pr_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_promociones']['labels']["pr_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_promociones']['labels']["pr_estado"] : "" . $this->Nm_lang['lang_estado'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_promociones']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_fac_promociones']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_fac_promociones']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_fac_promociones']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_fac_promociones']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_fac_promociones']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_fac_promociones']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_fac_promociones']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_promociones']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_fac_promociones']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_fac_promociones']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_fac_promociones']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_fac_promociones_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_fac_promociones']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_fac_promociones']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_promociones']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_fac_promociones']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_fac_promociones']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
