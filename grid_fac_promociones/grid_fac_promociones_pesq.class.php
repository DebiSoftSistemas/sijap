...
class grid_fac_promociones_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_fac_promociones_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_fac_promociones_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_fac_promociones_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$campo_join]);
              return;
          }
         $nm_ini_lower = "";
         $nm_fim_lower = "";
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_promociones'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_fac_promociones/grid_fac_promociones_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_fac_promociones_ajax_search.js"></script>
 <script type="text/javascript" src="grid_fac_promociones_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_fac_promociones_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_fac_promociones']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_fac_promociones']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_pr_id_cond#NMF#' + search_get_sel_txt('SC_pr_id_cond') + '@NMF@';
  str_out += 'SC_pr_id#NMF#' + search_get_text('SC_pr_id') + '@NMF@';
  str_out += 'SC_pr_filial_cond#NMF#' + search_get_sel_txt('SC_pr_filial_cond') + '@NMF@';
  str_out += 'SC_pr_filial#NMF#' + search_get_text('SC_pr_filial') + '@NMF@';
  ...
  str_out += 'SC_pr_descripcion_cond#NMF#' + search_get_sel_txt('SC_pr_descripcion_cond') + '@NMF@';
  str_out += 'SC_pr_descripcion#NMF#' + search_get_text('SC_pr_descripcion') + '@NMF@';
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      global 
             $pr_id_cond, $pr_id,
             $pr_filial_cond, $pr_filial,
             $pr_nombre_cond, $pr_nombre, $pr_nombre_autocomp,
             $pr_descripcion_cond, $pr_descripcion,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $pr_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['campos_busca']['pr_id']; 
          $pr_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['campos_busca']['pr_id_cond']; 
          $pr_filial = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['campos_busca']['pr_filial']; 
          $pr_filial_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['campos_busca']['pr_filial_cond']; 
          $pr_nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['campos_busca']['pr_nombre']; 
          $pr_nombre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['campos_busca']['pr_nombre_cond']; 
          $pr_descripcion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['campos_busca']['pr_descripcion']; 
          $pr_descripcion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['campos_busca']['pr_descripcion_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['campos_busca']['NM_operador']; 
          if (strtoupper($pr_id_cond) != "II" && strtoupper($pr_id_cond) != "QP" && strtoupper($pr_id_cond) != "NP" && strtoupper($pr_id_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($pr_id, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($pr_filial_cond) != "II" && strtoupper($pr_filial_cond) != "QP" && strtoupper($pr_filial_cond) != "NP" && strtoupper($pr_filial_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($pr_filial, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($pr_id_cond) || empty($pr_id_cond))
      {
         $pr_id_cond = "gt";
      }
      if (!isset($pr_filial_cond) || empty($pr_filial_cond))
      {
         $pr_filial_cond = "gt";
      }
      ...
      if (!isset($pr_descripcion_cond) || empty($pr_descripcion_cond))
      {
         $pr_descripcion_cond = "qp";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_pr_id = (in_array($pr_id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_pr_filial = (in_array($pr_filial_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_pr_nombre = (in_array($pr_nombre_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_pr_descripcion = (in_array($pr_descripcion_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      if (!isset($pr_filial) || $pr_filial == "")
      {
          $pr_filial = "";
      }
      if (isset($pr_filial) && !empty($pr_filial))
      {
         $tmp_pos = (is_string($pr_filial)) ? strpos($pr_filial, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $pr_filial = substr($pr_filial, 0, $tmp_pos);
         }
      }
      ...
      if (!isset($pr_descripcion) || $pr_descripcion == "")
      {
          $pr_descripcion = "";
      }
      if (isset($pr_descripcion) && !empty($pr_descripcion))
      {
         $tmp_pos = (is_string($pr_descripcion)) ? strpos($pr_descripcion, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $pr_descripcion = substr($pr_descripcion, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_pr_id_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['pr_id'])) ? $this->New_label['pr_id'] : "" . $this->Ini->Nm_lang['lang_id'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_pr_id_cond" name="pr_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_pr_id'), this, 'pr_id')">
       <OPTION value="gt" <?php if ("gt" == $pr_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $pr_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $pr_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_pr_id" <?php echo $str_hide_pr_id?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['pr_id'])) ? $this->New_label['pr_id'] : "" . $this->Ini->Nm_lang['lang_id'] . "";
 $nmgp_tab_label .= "pr_id?#?" . $SC_Label . "?@?";
...
?>
<INPUT  type="text" id="SC_pr_id" name="pr_id" value="<?php echo NM_encode_input($pr_id) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_pr_filial_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['pr_filial'])) ? $this->New_label['pr_filial'] : "" . $this->Ini->Nm_lang['lang_filial'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_pr_filial_cond" name="pr_filial_cond" onChange="nm_campos_between(document.getElementById('id_vis_pr_filial'), this, 'pr_filial')">
       <OPTION value="gt" <?php if ("gt" == $pr_filial_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $pr_filial_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $pr_filial_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_pr_filial" <?php echo $str_hide_pr_filial?> valign="top">
 ...
 $nmgp_tab_label .= "pr_filial?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_pr_filial" name="pr_filial" value="<?php echo NM_encode_input($pr_filial) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_pr_nombre_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['pr_nombre'])) ? $this->New_label['pr_nombre'] : "" . $this->Ini->Nm_lang['lang_nombre'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_pr_nombre_cond" name="pr_nombre_cond" onChange="nm_campos_between(document.getElementById('id_vis_pr_nombre'), this, 'pr_nombre')">
...
?>
<INPUT  type="text" id="SC_pr_nombre" name="pr_nombre" value="<?php echo NM_encode_input($pr_nombre) ?>"  size=50 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-pr_nombre" id="id_ac_pr_nombre" name="pr_nombre_autocomp"><?php if ('' !=  $pr_nombre) { ?><option value="<?php echo $pr_nombre ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_pr_descripcion_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['pr_descripcion'])) ? $this->New_label['pr_descripcion'] : "" . $this->Ini->Nm_lang['lang_descripcion'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_pr_descripcion_cond" name="pr_descripcion_cond" onChange="nm_campos_between(document.getElementById('id_vis_pr_descripcion'), this, 'pr_descripcion')">
       <OPTION value="qp" <?php if ("qp" == $pr_descripcion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $pr_descripcion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $pr_descripcion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $pr_descripcion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_pr_descripcion" <?php echo $str_hide_pr_descripcion?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['pr_descripcion'])) ? $this->New_label['pr_descripcion'] : "" . $this->Ini->Nm_lang['lang_descripcion'] . "";
 $nmgp_tab_label .= "pr_descripcion?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_pr_descripcion" name="pr_descripcion" value="<?php echo NM_encode_input($pr_descripcion) ?>" size="50" maxlength="32767" class="scFilterObjectEven">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_fac_promociones_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_fac_promociones']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_fac_promociones']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.pr_id_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_pr_id'), document.F1.pr_id_cond, 'pr_id');
   document.F1.pr_id.value = "";
   document.F1.pr_filial_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_pr_filial'), document.F1.pr_filial_cond, 'pr_filial');
   document.F1.pr_filial.value = "";
   ...
   document.F1.pr_descripcion_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_pr_descripcion'), document.F1.pr_descripcion_cond, 'pr_descripcion');
   document.F1.pr_descripcion.value = "";
   Sc_carga_select2('all');
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_pr_id_cond'] = 'cond';
      $tp_fields['SC_pr_id'] = 'text';
      $tp_fields['SC_pr_filial_cond'] = 'cond';
      $tp_fields['SC_pr_filial'] = 'text';
      $tp_fields['SC_pr_nombre_cond'] = 'cond';
      $tp_fields['SC_pr_nombre'] = 'text_aut';
      $tp_fields['id_ac_pr_nombre'] = 'select2_aut';
      $tp_fields['SC_pr_descripcion_cond'] = 'cond';
      $tp_fields['SC_pr_descripcion'] = 'text';
   ...
   {
      global $pr_id_cond, $pr_id,
             $pr_filial_cond, $pr_filial,
             $pr_nombre_cond, $pr_nombre, $pr_nombre_autocomp,
             $pr_descripcion_cond, $pr_descripcion, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $pr_id_cond_salva = $pr_id_cond; 
      if (!isset($pr_id_input_2) || $pr_id_input_2 == "")
      {
          $pr_id_input_2 = $pr_id;
      }
      $pr_filial_cond_salva = $pr_filial_cond; 
      if (!isset($pr_filial_input_2) || $pr_filial_input_2 == "")
      {
          $pr_filial_input_2 = $pr_filial;
      }
      ...
      $pr_descripcion_cond_salva = $pr_descripcion_cond; 
      if (!isset($pr_descripcion_input_2) || $pr_descripcion_input_2 == "")
      {
          $pr_descripcion_input_2 = $pr_descripcion;
      }
      if ($pr_id_cond != "in")
      {
          nm_limpa_numero($pr_id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($pr_filial_cond != "in")
      {
          nm_limpa_numero($pr_filial, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['campos_busca']['pr_id'] = $pr_id; 
      if (is_array($pr_id) && !empty($pr_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['Grid_search'][$I_Grid]['val'][0] = $pr_id;
      }
      elseif ($pr_id_cond_salva == "nu" || $pr_id_cond_salva == "nn" || $pr_id_cond_salva == "ep" || $pr_id_cond_salva == "ne" || !empty($pr_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['Grid_search'][$I_Grid]['val'][0][0] = $pr_id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['campos_busca']['pr_id_cond'] = $pr_id_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['Grid_search'][$I_Grid]['cmp'] = "pr_id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['Grid_search'][$I_Grid]['opc'] = $pr_id_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq']['pr_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['campos_busca']['pr_filial'] = $pr_filial; 
      if (is_array($pr_filial) && !empty($pr_filial))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['Grid_search'][$I_Grid]['val'][0] = $pr_filial;
      }
      elseif ($pr_filial_cond_salva == "nu" || $pr_filial_cond_salva == "nn" || $pr_filial_cond_salva == "ep" || $pr_filial_cond_salva == "ne" || !empty($pr_filial))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['Grid_search'][$I_Grid]['val'][0][0] = $pr_filial;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['campos_busca']['pr_filial_cond'] = $pr_filial_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['Grid_search'][$I_Grid]['cmp'] = "pr_filial"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['Grid_search'][$I_Grid]['opc'] = $pr_filial_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq']['pr_filial'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['campos_busca']['pr_nombre'] = $pr_nombre; 
      if (is_array($pr_nombre) && !empty($pr_nombre))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['Grid_search'][$I_Grid]['val'][0] = $pr_nombre;
      }
      elseif ($pr_nombre_cond_salva == "nu" || $pr_nombre_cond_salva == "nn" || $pr_nombre_cond_salva == "ep" || $pr_nombre_cond_salva == "ne" || !empty($pr_nombre))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['Grid_search'][$I_Grid]['val'][0][0] = $pr_nombre;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['campos_busca']['pr_nombre_cond'] = $pr_nombre_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['Grid_search'][$I_Grid]['cmp'] = "pr_nombre"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['Grid_search'][$I_Grid]['opc'] = $pr_nombre_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq']['pr_nombre'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['campos_busca']['pr_descripcion'] = $pr_descripcion; 
      if (is_array($pr_descripcion) && !empty($pr_descripcion))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['Grid_search'][$I_Grid]['val'][0] = $pr_descripcion;
      }
      elseif ($pr_descripcion_cond_salva == "nu" || $pr_descripcion_cond_salva == "nn" || $pr_descripcion_cond_salva == "ep" || $pr_descripcion_cond_salva == "ne" || !empty($pr_descripcion))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['Grid_search'][$I_Grid]['val'][0][0] = $pr_descripcion;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['campos_busca']['pr_descripcion_cond'] = $pr_descripcion_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['Grid_search'][$I_Grid]['cmp'] = "pr_descripcion"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['Grid_search'][$I_Grid]['opc'] = $pr_descripcion_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['grid_pesq']['pr_descripcion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $this->cmp_formatado['pr_id'] = $Conteudo;
      $Conteudo = $pr_filial;
      if (strtoupper($pr_filial_cond) != "II" && strtoupper($pr_filial_cond) != "QP" && strtoupper($pr_filial_cond) != "NP" && strtoupper($pr_filial_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['pr_filial'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($pr_nombre != '') {
      $pr_nombre_look = (is_string($pr_nombre) ? substr($this->Db->qstr($pr_nombre), 1, -1) : $pr_nombre); 
      $nmgp_def_dados = array(); 
      ...
      $Conteudo = $pr_descripcion;
      $this->cmp_formatado['pr_descripcion'] = $Conteudo;

      //----- $pr_id
      $this->Date_part = false;
      if (isset($pr_id) || $pr_id_cond == "nu" || $pr_id_cond == "nn" || $pr_id_cond == "ep" || $pr_id_cond == "ne")
      {
         $this->monta_condicao("pr_id", $pr_id_cond, $pr_id, "", "pr_id", "INT4", false);
      }

      //----- $pr_filial
      $this->Date_part = false;
      if (isset($pr_filial) || $pr_filial_cond == "nu" || $pr_filial_cond == "nn" || $pr_filial_cond == "ep" || $pr_filial_cond == "ne")
      {
         $this->monta_condicao("pr_filial", $pr_filial_cond, $pr_filial, "", "pr_filial", "INT4", false);
      }
      ...
      //----- $pr_descripcion
      $this->Date_part = false;
      if (isset($pr_descripcion) || $pr_descripcion_cond == "nu" || $pr_descripcion_cond == "nn" || $pr_descripcion_cond == "ep" || $pr_descripcion_cond == "ne")
      {
         $this->monta_condicao("pr_descripcion", $pr_descripcion_cond, $pr_descripcion, "", "pr_descripcion", "TEXT", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
    $this->Sel_case_sensitive($this->comando);
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_promociones']['cond_pesq'] .= $this->NM_operador;
