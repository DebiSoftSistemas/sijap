...
//----- 
   ...
   { 
       $nmgp_select = "SELECT nc_numero, str_replace (convert(char(10),nc_fecha,102), '.', '-') + ' ' + convert(char(8),nc_fecha,20), est_codigo, pen_serie, nc_secuencial, cl_nombre, cl_identificacion, nc_secuencial_docmod, nc_subtotal, nc_total_descuento, nc_valor_iva, nc_total, cl_direccion, cl_telefono, cl_email, nc_subtotal_iva, nc_subtotal_cero, nc_subtotal_no_objeto, nc_subtotal_excento, nc_valor_ice, nc_valor_irbpnr, nc_motivo, nc_estado_sri, nc_usuario from " . $this->Ini->nm_tabela; 
   } 
   elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
   { 
       $nmgp_select = "SELECT nc_numero, nc_fecha, est_codigo, pen_serie, nc_secuencial, cl_nombre, cl_identificacion, nc_secuencial_docmod, nc_subtotal, nc_total_descuento, nc_valor_iva, nc_total, cl_direccion, cl_telefono, cl_email, nc_subtotal_iva, nc_subtotal_cero, nc_subtotal_no_objeto, nc_subtotal_excento, nc_valor_ice, nc_valor_irbpnr, nc_motivo, nc_estado_sri, nc_usuario from " . $this->Ini->nm_tabela; 
   } 
   elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
   { 
       $nmgp_select = "SELECT nc_numero, convert(char(23),nc_fecha,121), est_codigo, pen_serie, nc_secuencial, cl_nombre, cl_identificacion, nc_secuencial_docmod, nc_subtotal, nc_total_descuento, nc_valor_iva, nc_total, cl_direccion, cl_telefono, cl_email, nc_subtotal_iva, nc_subtotal_cero, nc_subtotal_no_objeto, nc_subtotal_excento, nc_valor_ice, nc_valor_irbpnr, nc_motivo, nc_estado_sri, nc_usuario from " . $this->Ini->nm_tabela; 
   } 
   ...
   { 
       $nmgp_select = "SELECT nc_numero, EXTEND(nc_fecha, YEAR TO DAY), est_codigo, pen_serie, nc_secuencial, cl_nombre, cl_identificacion, nc_secuencial_docmod, nc_subtotal, nc_total_descuento, nc_valor_iva, nc_total, cl_direccion, cl_telefono, cl_email, nc_subtotal_iva, nc_subtotal_cero, nc_subtotal_no_objeto, nc_subtotal_excento, nc_valor_ice, nc_valor_irbpnr, nc_motivo, nc_estado_sri, nc_usuario from " . $this->Ini->nm_tabela; 
   } 
   else 
   { 
       $nmgp_select = "SELECT nc_numero, nc_fecha, est_codigo, pen_serie, nc_secuencial, cl_nombre, cl_identificacion, nc_secuencial_docmod, nc_subtotal, nc_total_descuento, nc_valor_iva, nc_total, cl_direccion, cl_telefono, cl_email, nc_subtotal_iva, nc_subtotal_cero, nc_subtotal_no_objeto, nc_subtotal_excento, nc_valor_ice, nc_valor_irbpnr, nc_motivo, nc_estado_sri, nc_usuario from " . $this->Ini->nm_tabela; 
   ...
   { 
       ...
       $this->cl_direccion = $this->rs_grid->fields[12] ;  
       $this->cl_telefono = $this->rs_grid->fields[13] ;  
       $this->cl_email = $this->rs_grid->fields[14] ;  
       $this->nc_subtotal_iva = $this->rs_grid->fields[15] ;  
       $this->nc_subtotal_iva = (string)$this->nc_subtotal_iva;
       $this->nc_subtotal_cero = $this->rs_grid->fields[16] ;  
       $this->nc_subtotal_cero = (string)$this->nc_subtotal_cero;
       $this->nc_subtotal_no_objeto = $this->rs_grid->fields[17] ;  
       $this->nc_subtotal_no_objeto = (string)$this->nc_subtotal_no_objeto;
       $this->nc_subtotal_excento = $this->rs_grid->fields[18] ;  
       $this->nc_subtotal_excento = (string)$this->nc_subtotal_excento;
       $this->nc_valor_ice = $this->rs_grid->fields[19] ;  
       $this->nc_valor_ice = (string)$this->nc_valor_ice;
       $this->nc_valor_irbpnr = $this->rs_grid->fields[20] ;  
       $this->nc_valor_irbpnr = (string)$this->nc_valor_irbpnr;
       $this->nc_motivo = $this->rs_grid->fields[21] ;  
       $this->nc_estado_sri = $this->rs_grid->fields[22] ;  
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       { 
           ...
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_resumen_nc_jquery_405.js\"></script>\r\n");
