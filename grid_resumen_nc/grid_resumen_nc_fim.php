...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_resumen_nc"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_resumen_nc"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_resumen_nc']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_resumen_nc']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_resumen_nc']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_resumen_nc']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_resumen_nc']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_resumen_nc']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_resumen_nc']['embutida_filho'] as $ind => $sc_init)
          {
