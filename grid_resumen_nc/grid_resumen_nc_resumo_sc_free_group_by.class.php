...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->cl_direccion = $rs_res->fields[12] ;  
            $this->cl_telefono = $rs_res->fields[13] ;  
            $this->cl_email = $rs_res->fields[14] ;  
            $this->nc_subtotal_iva = $rs_res->fields[15] ;  
            $this->nc_subtotal_cero = $rs_res->fields[16] ;  
            $this->nc_subtotal_no_objeto = $rs_res->fields[17] ;  
            $this->nc_subtotal_excento = $rs_res->fields[18] ;  
            $this->nc_valor_ice = $rs_res->fields[19] ;  
            $this->nc_valor_irbpnr = $rs_res->fields[20] ;  
            $this->nc_motivo = $rs_res->fields[21] ;  
            $this->nc_estado_sri = $rs_res->fields[22] ;  
