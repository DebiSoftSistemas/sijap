  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_rol_config_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sis_rol_config_mob_form();
	}
...
?>
  ...
  // ---------- Validate rol_id
  function do_ajax_form_sis_rol_config_mob_validate_rol_id()
  {
    var nomeCampo_rol_id = "rol_id";
    var var_rol_id = scAjaxGetFieldHidden(nomeCampo_rol_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_rol_config_mob_validate_rol_id(var_rol_id, var_script_case_init, do_ajax_form_sis_rol_config_mob_validate_rol_id_cb);
  } // do_ajax_form_sis_rol_config_mob_validate_rol_id

  function do_ajax_form_sis_rol_config_mob_validate_rol_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_rol_config_mob_validate_rol_id_cb

  // ---------- Validate rol_nombre
  function do_ajax_form_sis_rol_config_mob_validate_rol_nombre()
  {
    var nomeCampo_rol_nombre = "rol_nombre";
    var var_rol_nombre = scAjaxGetFieldText(nomeCampo_rol_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_rol_config_mob_validate_rol_nombre(var_rol_nombre, var_script_case_init, do_ajax_form_sis_rol_config_mob_validate_rol_nombre_cb);
  } // do_ajax_form_sis_rol_config_mob_validate_rol_nombre

  function do_ajax_form_sis_rol_config_mob_validate_rol_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "rol_nombre";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_rol_config_mob_validate_rol_nombre_cb

  // ---------- Validate rol_estado
  function do_ajax_form_sis_rol_config_mob_validate_rol_estado()
  {
    var nomeCampo_rol_estado = "rol_estado";
    var var_rol_estado = scAjaxGetFieldSelect(nomeCampo_rol_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_rol_config_mob_validate_rol_estado(var_rol_estado, var_script_case_init, do_ajax_form_sis_rol_config_mob_validate_rol_estado_cb);
  } // do_ajax_form_sis_rol_config_mob_validate_rol_estado

  function do_ajax_form_sis_rol_config_mob_validate_rol_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "rol_estado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_rol_config_mob_validate_rol_estado_cb

  // ---------- Validate permisos
  function do_ajax_form_sis_rol_config_mob_validate_permisos()
  {
    var nomeCampo_permisos = "permisos";
    var var_permisos = scAjaxGetFieldText(nomeCampo_permisos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_rol_config_mob_validate_permisos(var_permisos, var_script_case_init, do_ajax_form_sis_rol_config_mob_validate_permisos_cb);
  } // do_ajax_form_sis_rol_config_mob_validate_permisos

  function do_ajax_form_sis_rol_config_mob_validate_permisos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "permisos";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_rol_config_mob_validate_permisos_cb

  // ---------- Event onchange menus
  function do_ajax_form_sis_rol_config_mob_event_menus_onchange()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sis_rol_config_mob_event_menus_onchange(var_script_case_init, do_ajax_form_sis_rol_config_mob_event_menus_onchange_cb);
  } // do_ajax_form_sis_rol_config_mob_event_menus_onchange

  function do_ajax_form_sis_rol_config_mob_event_menus_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "menus";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sis_rol_config_mob_event_menus_onchange_cb_after_alert);
  } // do_ajax_form_sis_rol_config_mob_event_menus_onchange_cb
  function do_ajax_form_sis_rol_config_mob_event_menus_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_sis_rol_config_mob_event_menus_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_sis_rol_config_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_sis_rol_config_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_rol_id = scAjaxGetFieldHidden("rol_id");
    var var_rol_nombre = scAjaxGetFieldText("rol_nombre");
    var var_rol_estado = scAjaxGetFieldSelect("rol_estado");
    ...
    scAjaxProcOn();
    x_ajax_form_sis_rol_config_mob_submit_form(var_rol_id, var_rol_nombre, var_rol_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_rol_config_mob_submit_form_cb);
  } // do_ajax_form_sis_rol_config_mob_submit_form

  function do_ajax_form_sis_rol_config_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("rol_id");
      scAjaxHideErrorDisplay("rol_nombre");
      scAjaxHideErrorDisplay("rol_estado");
      scAjaxHideErrorDisplay("permisos");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_sis_rol_config_mob_submit_form_cb_after_alert);
  } // do_ajax_form_sis_rol_config_mob_submit_form_cb
  function do_ajax_form_sis_rol_config_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_rol_config_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_v_sis_permisos_rol_mob"] = "off";

  function do_ajax_form_sis_rol_config_mob_navigate_form()
  {
    perform_ajax_form_sis_rol_config_mob_navigate_form();
  }

  function perform_ajax_form_sis_rol_config_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("rol_estado");
    scAjaxHideErrorDisplay("permisos");
    var var_rol_id = document.F2.rol_id.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_v_sis_permisos_rol_mob"] = "on";
    x_ajax_form_sis_rol_config_mob_navigate_form(var_rol_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_rol_config_mob_navigate_form_cb);
  } // do_ajax_form_sis_rol_config_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_rol_config_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_rol_config_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.rol_id.value = scAjaxGetKeyValue("rol_id");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_v_sis_permisos_rol_mob"] && "nmsc_iframe_liga_form_v_sis_permisos_rol_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_v_sis_permisos_rol_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_v_sis_permisos_rol_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_v_sis_permisos_rol_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_v_sis_permisos_rol_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_v_sis_permisos_rol_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_rol_config_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_rol_config_mob_navigate_form_cb
  function do_ajax_form_sis_rol_config_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_sis_rol_config_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_sis_rol_config_mob_navigate_form_cb_after_alert

  function sc_hide_form_sis_rol_config_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_v_sis_permisos_rol_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "rol_id";
  ajax_field_list[1] = "rol_nombre";
  ajax_field_list[2] = "rol_estado";
  ajax_field_list[3] = "permisos";
  ...
  var ajax_error_list = {
    "rol_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "rol_nombre": {"label": "<?php echo $this->Ini->Nm_lang['lang_rol'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "rol_estado": {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "permisos": {"label": "<?php echo $this->Ini->Nm_lang['lang_permiso_rol'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "rol_id": new Array(),
    "rol_nombre": new Array(),
    "rol_estado": new Array(),
    "permisos": new Array()
  };
  ajax_field_mult["rol_id"][1] = "rol_id";
  ajax_field_mult["rol_nombre"][1] = "rol_nombre";
  ajax_field_mult["rol_estado"][1] = "rol_estado";
  ajax_field_mult["permisos"][1] = "permisos";

  var ajax_field_id = {
    "rol_id": new Array("hidden_field_label_rol_id", "hidden_field_data_rol_id"),
    "rol_nombre": new Array("hidden_field_label_rol_nombre", "hidden_field_data_rol_nombre"),
    "rol_estado": new Array("hidden_field_label_rol_estado", "hidden_field_data_rol_estado"),
    "permisos": new Array("hidden_field_label_permisos", "hidden_field_data_permisos")
  };
