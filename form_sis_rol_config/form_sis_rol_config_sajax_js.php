  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_rol_config" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sis_rol_config_form();
	}
...
?>
  ...
  // ---------- Validate rol_id
  function do_ajax_form_sis_rol_config_validate_rol_id()
  {
    var nomeCampo_rol_id = "rol_id";
    var var_rol_id = scAjaxGetFieldHidden(nomeCampo_rol_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_rol_config_validate_rol_id(var_rol_id, var_script_case_init, do_ajax_form_sis_rol_config_validate_rol_id_cb);
  } // do_ajax_form_sis_rol_config_validate_rol_id

  function do_ajax_form_sis_rol_config_validate_rol_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_rol_config_validate_rol_id_cb

  // ---------- Validate rol_nombre
  function do_ajax_form_sis_rol_config_validate_rol_nombre()
  {
    var nomeCampo_rol_nombre = "rol_nombre";
    var var_rol_nombre = scAjaxGetFieldText(nomeCampo_rol_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_rol_config_validate_rol_nombre(var_rol_nombre, var_script_case_init, do_ajax_form_sis_rol_config_validate_rol_nombre_cb);
  } // do_ajax_form_sis_rol_config_validate_rol_nombre

  function do_ajax_form_sis_rol_config_validate_rol_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_rol_config_validate_rol_nombre_cb

  // ---------- Validate rol_estado
  function do_ajax_form_sis_rol_config_validate_rol_estado()
  {
    var nomeCampo_rol_estado = "rol_estado";
    var var_rol_estado = scAjaxGetFieldSelect(nomeCampo_rol_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_rol_config_validate_rol_estado(var_rol_estado, var_script_case_init, do_ajax_form_sis_rol_config_validate_rol_estado_cb);
  } // do_ajax_form_sis_rol_config_validate_rol_estado

  function do_ajax_form_sis_rol_config_validate_rol_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_rol_config_validate_rol_estado_cb

  // ---------- Validate permisos
  function do_ajax_form_sis_rol_config_validate_permisos()
  {
    var nomeCampo_permisos = "permisos";
    var var_permisos = scAjaxGetFieldText(nomeCampo_permisos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_rol_config_validate_permisos(var_permisos, var_script_case_init, do_ajax_form_sis_rol_config_validate_permisos_cb);
  } // do_ajax_form_sis_rol_config_validate_permisos

  function do_ajax_form_sis_rol_config_validate_permisos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_rol_config_validate_permisos_cb

  // ---------- Event onchange menus
  function do_ajax_form_sis_rol_config_event_menus_onchange()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sis_rol_config_event_menus_onchange(var_script_case_init, do_ajax_form_sis_rol_config_event_menus_onchange_cb);
  } // do_ajax_form_sis_rol_config_event_menus_onchange

  function do_ajax_form_sis_rol_config_event_menus_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "menus";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sis_rol_config_event_menus_onchange_cb_after_alert);
  } // do_ajax_form_sis_rol_config_event_menus_onchange_cb
  function do_ajax_form_sis_rol_config_event_menus_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_sis_rol_config_event_menus_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_sis_rol_config_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_sis_rol_config_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_sis_rol_config_submit_form(var_rol_id, var_rol_nombre, var_rol_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_rol_config_submit_form_cb);
  } // do_ajax_form_sis_rol_config_submit_form

  function do_ajax_form_sis_rol_config_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_sis_rol_config_submit_form_cb_after_alert);
  } // do_ajax_form_sis_rol_config_submit_form_cb
  function do_ajax_form_sis_rol_config_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_rol_config_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_v_sis_permisos_rol"] = "off";

  function do_ajax_form_sis_rol_config_navigate_form()
  {
    perform_ajax_form_sis_rol_config_navigate_form();
  }

  function perform_ajax_form_sis_rol_config_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_v_sis_permisos_rol"] = "on";
    x_ajax_form_sis_rol_config_navigate_form(var_rol_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_rol_config_navigate_form_cb);
  } // do_ajax_form_sis_rol_config_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_rol_config']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_rol_config_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_v_sis_permisos_rol"] && "nmsc_iframe_liga_form_v_sis_permisos_rol" != scMasterDetailIframe["nmsc_iframe_liga_form_v_sis_permisos_rol"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_v_sis_permisos_rol"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_v_sis_permisos_rol').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_v_sis_permisos_rol').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_v_sis_permisos_rol').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_rol_config_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_rol_config_navigate_form_cb
  function do_ajax_form_sis_rol_config_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_sis_rol_config_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_sis_rol_config_navigate_form_cb_after_alert

  function sc_hide_form_sis_rol_config_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_v_sis_permisos_rol"])
    {
      return true;
    }
    return false;
