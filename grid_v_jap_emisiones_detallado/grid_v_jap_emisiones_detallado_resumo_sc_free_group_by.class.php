...
class grid_v_jap_emisiones_detallado_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_dde_producto        = array();
...
SCEOT;
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_v_jap_emisiones_detallado']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_v_jap_emisiones_detallado']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['orig_pesq'] = "resumo";
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['where_resumo'] = "";
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              ...
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['tot_geral'][2];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['tot_geral'][3];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['arr_total']['esc_anio_periodo'] = $this->array_total_esc_anio_periodo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['arr_total']['esc_mes_periodo'] = $this->array_total_esc_mes_periodo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['arr_total']['dde_producto'] = $this->array_total_dde_producto;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['arr_total']['des_ruta'] = $this->array_total_des_ruta;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['arr_total']['cl_nombre'] = $this->array_total_cl_nombre;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['arr_total']['cl_identificacion'] = $this->array_total_cl_identificacion;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['arr_total']['cl_telefono'] = $this->array_total_cl_telefono;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['arr_total']['cl_celular'] = $this->array_total_cl_celular;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['arr_total']['cl_email'] = $this->array_total_cl_email;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['arr_total']['con_numero_contrato'] = $this->array_total_con_numero_contrato;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['json_use_label'])
       {
          $Lab_esc_anio_periodo = "esc_anio_periodo";
          $Lab_esc_mes_periodo = "esc_mes_periodo";
          $Lab_dde_producto = "dde_producto";
       ...
       $Lab_dde_producto = "" . $this->Ini->Nm_lang['lang_producto'] . "";
       ...
       $Lab_con_numero_contrato = "" . $this->Ini->Nm_lang['lang_numero_contrato'] . "";
       }
       $prep_field = array();
       $prep_field['esc_anio_periodo'] = $Lab_esc_anio_periodo;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['esc_anio_periodo'] = $Lab_esc_anio_periodo; 
       $prep_field['esc_mes_periodo'] = $Lab_esc_mes_periodo;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['esc_mes_periodo'] = $Lab_esc_mes_periodo; 
       $prep_field['dde_producto'] = $Lab_dde_producto;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['dde_producto'] = $Lab_dde_producto; 
       $prep_field['des_ruta'] = $Lab_des_ruta;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['des_ruta'] = $Lab_des_ruta; 
       $prep_field['cl_nombre'] = $Lab_cl_nombre;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['cl_nombre'] = $Lab_cl_nombre; 
       $prep_field['cl_identificacion'] = $Lab_cl_identificacion;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['cl_identificacion'] = $Lab_cl_identificacion; 
       $prep_field['cl_telefono'] = $Lab_cl_telefono;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['cl_telefono'] = $Lab_cl_telefono; 
       $prep_field['cl_celular'] = $Lab_cl_celular;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['cl_celular'] = $Lab_cl_celular; 
       $prep_field['cl_email'] = $Lab_cl_email;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['cl_email'] = $Lab_cl_email; 
       $prep_field['con_numero_contrato'] = $Lab_con_numero_contrato;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['con_numero_contrato'] = $Lab_con_numero_contrato; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['esc_tipo_deuda']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['esc_tipo_deuda'] = "" . $this->Ini->Nm_lang['lang_tipo_deuda'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['cl_identificacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['cl_identificacion'] = "" . $this->Ini->Nm_lang['lang_lot_identificacion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['cl_nombre']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['cl_nombre'] = "" . $this->Ini->Nm_lang['lang_nombre'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['esc_anio_periodo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['esc_anio_periodo'] = "" . $this->Ini->Nm_lang['lang_srch_year'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['esc_mes_periodo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['esc_mes_periodo'] = "" . $this->Ini->Nm_lang['lang_srch_mnth'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['con_numero_contrato']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['con_numero_contrato'] = "" . $this->Ini->Nm_lang['lang_numero_contrato'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['des_consumo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['des_consumo'] = "" . $this->Ini->Nm_lang['lang_consumo'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['dde_producto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['dde_producto'] = "" . $this->Ini->Nm_lang['lang_producto'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['dde_total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['dde_total'] = "" . $this->Ini->Nm_lang['lang_valor'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['op_estado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['op_estado'] = "" . $this->Ini->Nm_lang['lang_estado'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['esc_fecha']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['esc_fecha'] = "" . $this->Ini->Nm_lang['lang_fecha'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['des_ruta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['des_ruta'] = "" . $this->Ini->Nm_lang['lang_ruta'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['cl_telefono']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['cl_telefono'] = "" . $this->Ini->Nm_lang['lang_lot_telefono'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['cl_celular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['cl_celular'] = "" . $this->Ini->Nm_lang['lang_celular'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['cl_email']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['cl_email'] = "" . $this->Ini->Nm_lang['lang_email'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['con_direccion_predio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['con_direccion_predio'] = "" . $this->Ini->Nm_lang['lang_direccion_predio'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['con_tipo_servicio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['con_tipo_servicio'] = "" . $this->Ini->Nm_lang['lang_tipo_servicio'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['con_condicion_contrato']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['con_condicion_contrato'] = "" . $this->Ini->Nm_lang['lang_condicion_contrato'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['des_numero_medidor']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['des_numero_medidor'] = "" . $this->Ini->Nm_lang['lang_numero_medidor'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['esc_empresa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['esc_empresa'] = "" . $this->Ini->Nm_lang['lang_empresa'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['con_propietario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['con_propietario'] = "" . $this->Ini->Nm_lang['lang_propietario'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['des_contrato']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['labels']['des_contrato'] = "" . $this->Ini->Nm_lang['lang_contrato'] . ""; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
       ...
       $this->comp_sum_lnk = array(
           ...
           3 => array('field' => "dde_total", 'show' => true),
       );
      ...
      eval ($Str_gb);
       ...
       $Arr_parms['dde_producto']['alin'] = "''";
       $Arr_parms['dde_producto']['link'] = "S";
       ...
       $Arr_parms['dde_producto']['fill'] = "true";
       $Arr_parms['dde_producto']['order'] = "label";
       $Arr_parms['dde_producto']['order_start'] = 'asc';
       $Arr_parms['dde_producto']['order_invert'] = 'false';
       $Arr_parms['dde_producto']['order_enabled'] = 'true';
       $Arr_parms['dde_producto']['order_datatype'] = 'varchar';
       $Arr_parms['dde_producto']['rating_function'] = '';
       ...
       $prep_links_fl['dde_producto'] = array(0 => 'dde_producto', 1 => '@aspass@');
       ...
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_v_jap_emisiones_detallado@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['proc_pdf_vert']){ 
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_v_jap_emisiones_detallado_total.class.php"); 
      }
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['opcao'] = "print";
      ...
      $this->Total   = new grid_v_jap_emisiones_detallado_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_jap_emisiones_detallado_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_v_jap_emisiones_detallado_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_jap_emisiones_detallado_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_v_jap_emisiones_detallado/grid_v_jap_emisiones_detallado_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "grid_v_jap_emisiones_detallado/grid_v_jap_emisiones_detallado_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume&nm_all_modules=grid,resume&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_v_jap_emisiones_detallado/grid_v_jap_emisiones_detallado_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_v_jap_emisiones_detallado&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid,resume&nm_all_modules=grid,resume&password=n&summary_export_columns=S&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + P)", "thickbox", "" . $this->Ini->path_link . "grid_v_jap_emisiones_detallado/grid_v_jap_emisiones_detallado_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid,resume&nm_all_modules=grid,resume&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
             $this->nm_btn_exist['groupby'][] = "sel_groupby_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_v_jap_emisiones_detallado/grid_v_jap_emisiones_detallado_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_v_jap_emisiones_detallado/grid_v_jap_emisiones_detallado_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + G)", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_v_jap_emisiones_detallado_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_v_jap_emisiones_detallado']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_v_jap_emisiones_detallado']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_v_jap_emisiones_detallado_config_pivot.php?nome_apl=grid_v_jap_emisiones_detallado&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"grid_v_jap_emisiones_detallado_iframe.php\";\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_jap_emisiones_detallado_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_v_jap_emisiones_detallado/grid_v_jap_emisiones_detallado_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
   ...
   //---- 
   function adiciona_registro($sum_des_consumo, $sum_dde_total, $quebra_esc_anio_periodo, $quebra_esc_mes_periodo, $quebra_dde_producto, $quebra_des_ruta, $quebra_cl_nombre, $quebra_cl_identificacion, $quebra_cl_telefono, $quebra_cl_celular, $quebra_cl_email, $quebra_con_numero_contrato, $quebra_esc_anio_periodo_orig, $quebra_esc_mes_periodo_orig, $quebra_dde_producto_orig, $quebra_des_ruta_orig, $quebra_cl_nombre_orig, $quebra_cl_identificacion_orig, $quebra_cl_telefono_orig, $quebra_cl_celular_orig, $quebra_cl_email_orig, $quebra_con_numero_contrato_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_detallado']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
          ...
          if (empty($sum_dde_total)) {$sum_dde_total = '0';}
          eval ('
          if (!isset($this->' . $arr_name . '))
          {
              $this->' . $arr_name . '[0] = 1;
              $this->' . $arr_name . '[1] = ' . $sum_des_consumo . ';
              $this->' . $arr_name . '[2] = ' . $sum_dde_total . ';
          ...
          else
          {
              ...
              $this->' . $arr_name . '[2] = bcadd($this->' . $arr_name . '[2], ' . $sum_dde_total . ', 10);
          }
          ');
      }
   }
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->esc_tipo_deuda = $rs_res->fields[0] ;  
            ...
            $this->des_consumo = $rs_res->fields[6] ;  
            $this->dde_producto = $rs_res->fields[7] ;  
            $this->dde_total = $rs_res->fields[8] ;  
            $this->op_estado = $rs_res->fields[9] ;  
            $this->esc_fecha = $rs_res->fields[10] ;  
            $this->des_ruta = $rs_res->fields[11] ;  
            $this->cl_telefono = $rs_res->fields[12] ;  
            $this->cl_celular = $rs_res->fields[13] ;  
            $this->cl_email = $rs_res->fields[14] ;  
            $this->con_direccion_predio = $rs_res->fields[15] ;  
            $this->con_tipo_servicio = $rs_res->fields[16] ;  
            $this->con_condicion_contrato = $rs_res->fields[17] ;  
            $this->des_numero_medidor = $rs_res->fields[18] ;  
            $this->esc_anio_periodo_orig = $this->esc_anio_periodo;
            $this->esc_mes_periodo_orig = $this->esc_mes_periodo;
            $this->dde_producto_orig = $this->dde_producto;
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->des_consumo, $this->dde_total, $this->esc_anio_periodo, $this->esc_mes_periodo, $this->dde_producto, $this->des_ruta, $this->cl_nombre, $this->cl_identificacion, $this->cl_telefono, $this->cl_celular, $this->cl_email, $this->con_numero_contrato, $this->esc_anio_periodo_orig,  $this->esc_mes_periodo_orig,  $this->dde_producto_orig,  $this->des_ruta_orig,  $this->cl_nombre_orig,  $this->cl_identificacion_orig,  $this->cl_telefono_orig,  $this->cl_celular_orig,  $this->cl_email_orig,  $this->con_numero_contrato_orig);
            }
   }
//
