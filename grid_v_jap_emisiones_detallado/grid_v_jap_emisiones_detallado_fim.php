...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_v_jap_emisiones_detallado"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_v_jap_emisiones_detallado"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_v_jap_emisiones_detallado']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_v_jap_emisiones_detallado']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_v_jap_emisiones_detallado']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_v_jap_emisiones_detallado']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_v_jap_emisiones_detallado']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_v_jap_emisiones_detallado</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_v_jap_emisiones_detallado']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_v_jap_emisiones_detallado']['embutida_filho'] as $ind => $sc_init)
          {
