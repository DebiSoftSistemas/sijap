...
<?php
   ...
   $Ord_Cmp = new grid_v_jap_emisiones_detallado_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_v_jap_emisiones_detallado_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["esc_tipo_deuda"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['labels']["esc_tipo_deuda"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['labels']["esc_tipo_deuda"] : "" . $this->Nm_lang['lang_tipo_deuda'] . "";
   $tab_ger_campos['cl_identificacion'] = "on";
   $tab_def_campos['cl_identificacion'] = "cl_identificacion";
   $tab_labels["cl_identificacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['labels']["cl_identificacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['labels']["cl_identificacion"] : "" . $this->Nm_lang['lang_lot_identificacion'] . "";
   $tab_ger_campos['cl_nombre'] = "on";
   $tab_def_campos['cl_nombre'] = "cl_nombre";
   $tab_labels["cl_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['labels']["cl_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['labels']["cl_nombre"] : "" . $this->Nm_lang['lang_nombre'] . "";
   $tab_ger_campos['esc_anio_periodo'] = "on";
   $tab_def_campos['esc_anio_periodo'] = "esc_anio_periodo";
   $tab_labels["esc_anio_periodo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['labels']["esc_anio_periodo"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['labels']["esc_anio_periodo"] : "" . $this->Nm_lang['lang_srch_year'] . "";
   $tab_ger_campos['esc_mes_periodo'] = "on";
   $tab_def_campos['esc_mes_periodo'] = "esc_mes_periodo";
   $tab_labels["esc_mes_periodo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['labels']["esc_mes_periodo"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['labels']["esc_mes_periodo"] : "" . $this->Nm_lang['lang_srch_mnth'] . "";
   $tab_ger_campos['con_numero_contrato'] = "on";
   $tab_def_campos['con_numero_contrato'] = "con_numero_contrato";
   $tab_labels["con_numero_contrato"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['labels']["con_numero_contrato"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['labels']["con_numero_contrato"] : "" . $this->Nm_lang['lang_numero_contrato'] . "";
   $tab_ger_campos['des_consumo'] = "on";
   $tab_def_campos['des_consumo'] = "des_consumo";
   $tab_labels["des_consumo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['labels']["des_consumo"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['labels']["des_consumo"] : "" . $this->Nm_lang['lang_consumo'] . "";
   $tab_ger_campos['dde_producto'] = "on";
   $tab_def_campos['dde_producto'] = "dde_producto";
   $tab_labels["dde_producto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['labels']["dde_producto"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['labels']["dde_producto"] : "" . $this->Nm_lang['lang_producto'] . "";
   $tab_ger_campos['dde_total'] = "on";
   $tab_def_campos['dde_total'] = "dde_total";
   $tab_labels["dde_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['labels']["dde_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['labels']["dde_total"] : "" . $this->Nm_lang['lang_valor'] . "";
   $tab_ger_campos['op_estado'] = "on";
   $tab_def_campos['op_estado'] = "op_estado";
   $tab_labels["op_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['labels']["op_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['labels']["op_estado"] : "" . $this->Nm_lang['lang_estado'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_v_jap_emisiones_detallado_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_detallado']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
