<?php
@session_start() ;
$_SESSION['scriptcase']['grid_v_jap_emisiones_detallado']['sc_process_barr'] = true;
require_once('../grid_v_jap_emisiones_detallado/index.php');
unset($_SESSION['scriptcase']['grid_v_jap_emisiones_detallado']['sc_process_barr']);
$ExportCtrl = new grid_v_jap_emisiones_detallado_export_control;
$ExportCtrl->Export_barr();

class grid_v_jap_emisiones_detallado_export_control
{
