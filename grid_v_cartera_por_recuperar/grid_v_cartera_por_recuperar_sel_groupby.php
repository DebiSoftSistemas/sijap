<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_v_cartera_por_recuperar']['glo_nm_path_imag_temp'] . "/sc_apl_default_SIJAP.txt"))
       {
?>
...
<?php
   ...
   $Sel_Groupby = new grid_v_cartera_por_recuperar_sel_Groupby(); 
   $Sel_Groupby->Sel_Groupby_init();
   
class grid_v_cartera_por_recuperar_sel_Groupby
{
function Sel_Groupby_init()
{
   ...
   if ($this->restore) {
       $groupby_atual = $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['dados_orig_gb']['all']['SC_Ind_Groupby'];
   }
   else {
       $groupby_atual = $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['SC_Ind_Groupby'];
   }
...
function Sel_processa_out($sel_groupby)
{
   ...
   {
       if (count($campos_sel) != count($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['SC_Gb_Free_cmp']))
       {
       ...
       {
          $Arr_temp = array();
           foreach ($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['SC_Gb_Free_cmp'] as $Cada_cmp => $Resto)
           {
               $Arr_temp[] = $Cada_cmp;
           }
   ...
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['SC_Ind_Groupby']     = $sel_groupby;
       $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['contr_array_resumo'] = "NAO";
       $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['contr_total_geral']  = "NAO";
       unset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['ordem_quebra']);
       unset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['ordem_select']);
       unset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['tot_geral']);
       unset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['Page_break_PDF']);
       unset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['arr_total']);
       unset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['pivot_group_by']);
       unset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['pivot_x_axys']);
       unset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['pivot_y_axys']);
       unset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['pivot_fill']);
       unset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['pivot_order']);
       unset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['pivot_order_col']);
       unset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['pivot_order_level']);
       unset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['pivot_order_sort']);
       unset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['pivot_order_start']);
       unset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['pivot_tabular']);
           $tab_arr_groubby_cmp = array();
           $tab_arr_groubby_sql = array();
           $tab_arr_groubby_cmp['op_fecha_emision'] = array('cmp' => "op_fecha_emision", 'ind' => 0, 'format' => "YYYYMMDD2");
           $tab_arr_groubby_cmp['periodo_emision'] = array('cmp' => "periodo_emision", 'ind' => 1, 'format' => "");
           $tab_arr_groubby_cmp['mes_emision'] = array('cmp' => "mes_emision", 'ind' => 2, 'format' => "");
           $tab_arr_groubby_cmp['cl_identificacion'] = array('cmp' => "cl_identificacion", 'ind' => 3, 'format' => "");
           $tab_arr_groubby_cmp['cl_nombre'] = array('cmp' => "cl_nombre", 'ind' => 4, 'format' => "");
           $tab_arr_groubby_cmp['pro_descripcion'] = array('cmp' => "pro_descripcion", 'ind' => 5, 'format' => "");
           $tab_arr_groubby_cmp['con_ruta'] = array('cmp' => "con_ruta", 'ind' => 6, 'format' => "");
           $tab_arr_groubby_cmp['op_estado'] = array('cmp' => "op_estado", 'ind' => 7, 'format' => "");
           $tab_arr_groubby_cmp['con_id'] = array('cmp' => "con_id", 'ind' => 8, 'format' => "");
           $tab_arr_groubby_cmp['op_asiento'] = array('cmp' => "op_asiento", 'ind' => 9, 'format' => "");
           $tab_arr_groubby_sql[0] = array('cmp' => "op_fecha_emision", 'ord' => 'asc');
           $tab_arr_groubby_sql[1] = array('cmp' => "periodo_emision", 'ord' => 'asc');
           $tab_arr_groubby_sql[2] = array('cmp' => "mes_emision", 'ord' => 'asc');
           $tab_arr_groubby_sql[3] = array('cmp' => "cl_identificacion", 'ord' => 'asc');
           $tab_arr_groubby_sql[4] = array('cmp' => "cl_nombre", 'ord' => 'asc');
           $tab_arr_groubby_sql[5] = array('cmp' => "pro_descripcion", 'ord' => 'asc');
           $tab_arr_groubby_sql[6] = array('cmp' => "con_ruta", 'ord' => 'asc');
           $tab_arr_groubby_sql[7] = array('cmp' => "op_estado", 'ord' => 'asc');
           $tab_arr_groubby_sql[8] = array('cmp' => "con_id", 'ord' => 'asc');
           $tab_arr_groubby_sql[9] = array('cmp' => "op_asiento", 'ord' => 'asc');
           $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['SC_Gb_Free_cmp']  = array();
           $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['SC_Gb_Free_sql']  = array();
           $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['SC_Gb_date_format']['sc_free_group_by'] = array();
           $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['SC_Gb_Free_orig'] = array();
           foreach ($campos_sel as $cada_cmp)
           {
               if (!empty($cada_cmp))
               {
                   $ind = $tab_arr_groubby_cmp[$cada_cmp]['ind'];
                   $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['SC_Gb_Free_cmp'][$cada_cmp] = $tab_arr_groubby_cmp[$cada_cmp]['cmp'];
                   $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['SC_Gb_Free_sql'][$cada_cmp][$tab_arr_groubby_sql[$ind]['cmp']] = $tab_arr_groubby_sql[$ind]['ord'];
                   $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['SC_Gb_date_format']['sc_free_group_by'][$cada_cmp] = $tab_arr_groubby_cmp[$cada_cmp]['format'];
               }
           }
   }
   if ($sel_groupby == "sc_free_group_by")
   {
       ...
       $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['pivot_x_axys'] = $xaxys_list;
       $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['pivot_y_axys'] = $yaxys_list;
   }
   if ($opc_ret == "resumo" && !empty($this->summ_fields))
   {
       $summ_fields = explode("@?@", $this->summ_fields);
       if(isset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['summarizing_fields_display'][ $sel_groupby ]))
       {
           foreach ($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['summarizing_fields_display'][ $sel_groupby ] as $i_sum => $d_sum)
           {
               $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['summarizing_fields_display'][ $sel_groupby ][$i_sum]['display'] = in_array($i_sum, $summ_fields);
           }
       }
       $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['summarizing_fields_order'][ $sel_groupby ] = $summ_fields;
       $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['summarizing_drill_down'] = $this->drill_down;
   }
?>
    <script language="javascript"> 
<?php
...
function Sel_processa_form()
{
   ...
   $arr_campos_free['op_fecha_emision'] = "" . sprintf("" . $this->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "", "" . $this->Nm_lang['lang_fecha_emision'] . "") . "";
   $arr_campos_free['periodo_emision'] = "" . $this->Nm_lang['lang_periodo_emision'] . "";
   $arr_campos_free['mes_emision'] = "" . $this->Nm_lang['lang_mes_emision'] . "";
   $arr_campos_free['cl_identificacion'] = "" . $this->Nm_lang['lang_lot_identificacion'] . "";
   $arr_campos_free['cl_nombre'] = "" . $this->Nm_lang['lang_cliente'] . "";
   $arr_campos_free['pro_descripcion'] = "" . $this->Nm_lang['lang_producto'] . "";
   $arr_campos_free['con_ruta'] = "" . $this->Nm_lang['lang_ruta'] . "";
   $arr_campos_free['op_estado'] = "" . $this->Nm_lang['lang_estado'] . "";
   $arr_campos_free['con_id'] = "" . $this->Nm_lang['lang_numero_contrato'] . "";
   $arr_campos_free['op_asiento'] = "Op Asiento";
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_cartera_recuperar'] ?></TITLE>
...
?>
 <script language="javascript" type="text/javascript">
  function scSubmitGroupBy(sPos) {
   $.ajax({
    type: "POST",
    url: "grid_v_cartera_por_recuperar_sel_groupby.php",
    data: {
...
<?php
if ($this->restore && $bSummaryPage && isset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['dados_orig_gb']['res']['summarizing_fields_control']))
{
    $aOptions = array();
    foreach ($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['dados_orig_gb']['res']['summarizing_fields_control'] as $quebra_nome => $_arr_fields)
    {
...
elseif (!$this->restore && $bSummaryPage && isset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['summarizing_fields_control']))
{
    $aOptions = array();
    foreach ($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['summarizing_fields_control'] as $quebra_nome => $_arr_fields)
    {
        if(is_array($_arr_fields))
        {
            foreach ($_arr_fields as $_key_total => $d_field)
...
{
  $max_height = 1;
  if ($this->restore && isset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['dados_orig_gb']['res']['summarizing_fields_display']))
  {
    foreach ($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['dados_orig_gb']['res']['summarizing_fields_display'] as $_quebra_nome => $_i_sum)
    {
  ...
  elseif (!$this->restore && isset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['summarizing_fields_display']))
  {
    foreach ($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['summarizing_fields_display'] as $_quebra_nome => $_i_sum)
    {
      if (count($_i_sum) > $max_height)
      {
          $max_height = count($_i_sum);
...
<?php
if ($bSummaryPage && $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['SC_Ind_Groupby'] == "sc_free_group_by") {
?>
   if (fieldList == "") {
...
<?php
    ...
    $iTabCount            = 1;
    foreach ($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['SC_All_Groupby'] as $QB => $Tp)
    {
        if (!in_array($QB, $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['SC_Groupby_hide']))
        {
...
<?php
     if (!in_array("Mensual", $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['SC_Groupby_hide']))
     {
         $this->static_gb_ok = "sc_id_sel_groupby_Mensual";
        if ($groupby_atual == "Mensual")
        {
            $check = " checked";
            $bStartFree = false;
            $this->static_gb_ok = "sc_id_sel_groupby_Mensual";
...
?>
      <div>
      <input type="radio" class="scAppDivToolbarInput sc_ui_gby_selected" onclick='scShowTotalFields();change_actual_static("sc_id_sel_groupby_Mensual");display_btn_restore_gb();' name="sel_groupby" value="Mensual" id="sc_id_sel_groupby_Mensual"<?php echo $check ?> style='display:none' />
      <label for="sc_id_sel_groupby_Mensual">
        Mensual
<?php
    $prep_labels = array();
    $prep_labels[] = "" . $this->Nm_lang['lang_periodo_consumo'] . "";
    $prep_labels[] = "" . $this->Nm_lang['lang_mes_consumo'] . "";
?>
        <span>
...
?>
  <td>
<?php
     if (!in_array("sc_free_group_by", $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['SC_Groupby_hide']))
     {
...
<?php
        ...
        $arr_tmp = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] : $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['SC_Gb_Free_cmp'];
...
<?php
        ...
        {
            if ($this->restore) {
                $xAxysGroupCount = count($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['dados_orig_gb']['res']['pivot_x_axys']);
            }
            else {
                $xAxysGroupCount = count($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['pivot_x_axys']);
            }
        }
...
<?php
        if ($bSummaryPage)
        {
            ...
            {
                $arr_pivot_x_axys = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['dados_orig_gb']['res']['pivot_x_axys'] : $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['pivot_x_axys'];
...
<?php
   ...
   if ($bSummaryPage)
   {
       ...
       if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['summarizing_fields_control'])) {
           $arr_filds = array();
       }
       else {
           $arr_filds = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['dados_orig_gb']['res']['summarizing_fields_control'] : $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['summarizing_fields_control'];
       }
    if (isset($arr_filds))
    {
?>
...
<?php
          if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['summarizing_fields_display'])) {
              $arr_disp = array();
          }
          else {
                 $arr_disp = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['dados_orig_gb']['res']['summarizing_fields_display'] : $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['summarizing_fields_display'];
          }
          if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['summarizing_fields_order'])) {
              $arr_ord = array();
          }
          else {
              $arr_ord  = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['dados_orig_gb']['res']['summarizing_fields_order']   : $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['summarizing_fields_order'];
          }
...
<script type="text/javascript">
   ...
   if ($this->restore) {
       $oJson = new Services_JSON();
        ob_end_clean();
        if ($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['dados_orig_gb']['all']['SC_Ind_Groupby'] == "sc_free_group_by") {
           $this->Arr_result['run_js'][] = "scShowFree()";
        } else {
           $this->Arr_result['set_var'][] = array('var' => 'actual_static_gb', 'value' => $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['dados_orig_gb']['all']['SC_Ind_Groupby']);
...
<?php
   $disp_rest = "none";
   foreach ($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['dados_orig_gb'] as $tp => $fields) {
       foreach ($fields as $name => $data) {
           if (isset($_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar'][$name])) {
               if ($tp == "all" && ($name != "SC_Gb_Free_cmp" || $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar']['SC_Ind_Groupby'] == "sc_free_group_by")) {
                   if ($data != $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar'][$name]) {
                       $disp_rest = "";
                       break;
                   }
               }
               elseif ($tp == "res" && $bSummaryPage && $data != $_SESSION['sc_session'][$sc_init]['grid_v_cartera_por_recuperar'][$name]) {
                   $disp_rest = "";
                   break;
               }
           }
