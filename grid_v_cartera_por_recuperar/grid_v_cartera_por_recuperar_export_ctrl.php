<?php
@session_start() ;
$_SESSION['scriptcase']['grid_v_cartera_por_recuperar']['sc_process_barr'] = true;
require_once('../grid_v_cartera_por_recuperar/index.php');
unset($_SESSION['scriptcase']['grid_v_cartera_por_recuperar']['sc_process_barr']);
$ExportCtrl = new grid_v_cartera_por_recuperar_export_control;
$ExportCtrl->Export_barr();

class grid_v_cartera_por_recuperar_export_control
{
