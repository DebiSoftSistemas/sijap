...
SCEOT;
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_periodo_consumo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['arr_total']['periodo_consumo'];
          $this->array_total_mes_consumo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['arr_total']['mes_consumo'];
      }
      else
      {
          $this->array_total_periodo_consumo = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['arr_total']['periodo_consumo'] = $this->array_total_periodo_consumo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['arr_total']['mes_consumo'] = $this->array_total_mes_consumo;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['labels']['periodo_consumo'] = $Lab_periodo_consumo; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['labels']['mes_consumo'] = $Lab_mes_consumo; 
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['summarizing_fields_order']['Mensual']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['summarizing_fields_order']['Mensual'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['summarizing_fields_order']['Mensual'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['summarizing_fields_display']['Mensual'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['summarizing_fields_display']['Mensual'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['summarizing_fields_display']['Mensual'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['summarizing_fields_display']['Mensual'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['summarizing_fields_display']['Mensual'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['summarizing_fields_display']['Mensual'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['summarizing_fields_display']['Mensual'] as $i_sum => $d_sum)
           {
