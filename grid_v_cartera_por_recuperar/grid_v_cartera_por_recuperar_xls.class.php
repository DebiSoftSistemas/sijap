...
class grid_v_cartera_por_recuperar_xls
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_v_cartera_por_recuperar/grid_v_cartera_por_recuperar_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              ...
              $this->Res_xls = new grid_v_cartera_por_recuperar_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_v_cartera_por_recuperar.zip";
          $this->Arquivo   .= "_grid_v_cartera_por_recuperar" . $this->Xls_tp;
          $this->Tit_doc    = "grid_v_cartera_por_recuperar" . $this->Xls_tp;
          $this->Tit_zip    = "grid_v_cartera_por_recuperar.zip";
      ...
      {
          $this->sum_do_total = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['tot_geral'][2];
          $this->sum_do_subtotal = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['tot_geral'][3];
          $this->sum_do_valor_iva = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['tot_geral'][4];
      }
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['where_pesq'];
      ...
      { 
          ...
          { 
              ...
              $nmgp_select_count .= " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['where_resumo']; 
          } 
          else
          { 
              $nmgp_select .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['where_resumo'] . ")"; 
              $nmgp_select_count .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['where_resumo'] . ")"; 
          } 
      } 
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['order_grid'];
      ...
      if (!$rs->EOF)
      {
         ...
         $this->periodo_consumo = $rs->fields[18] ;  
         $this->periodo_consumo = (string)$this->periodo_consumo;
         $this->mes_consumo = $rs->fields[19] ;  
...
$_SESSION['scriptcase']['grid_v_cartera_por_recuperar']['contr_erro'] = 'off';
      ...
      while (!$rs->EOF)
      {
         ...
         $this->arg_sum_mes_consumo = " = " . $this->Db->qstr($this->mes_consumo);
          ...
          {  
              ...
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['embutida'] && !$prim_gb && $this->groupby_show == "S") {
                  $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                  $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
                  $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
                  $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['nolabel'])
       {
 ...
 function quebra_mes_consumo_Mensual($periodo_consumo, $mes_consumo) 
 {
     ...
     foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
     {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['field_order'] as $Cada_cmp)
       {
           if (isset($NM_cmp_tot['do_total'][$Tipo_Sum]) && $Cada_cmp == "do_total" && (!isset($this->NM_cmp_hidden['do_total']) || $this->NM_cmp_hidden['do_total'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['do_total'][$Tipo_Sum] . "op_fecha_emision_do_total";
           ...
           elseif (isset($NM_cmp_tot['do_subtotal'][$Tipo_Sum]) && $Cada_cmp == "do_subtotal" && (!isset($this->NM_cmp_hidden['do_subtotal']) || $this->NM_cmp_hidden['do_subtotal'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['do_subtotal'][$Tipo_Sum] . "op_fecha_emision_do_subtotal";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['do_valor_iva'][$Tipo_Sum]) && $Cada_cmp == "do_valor_iva" && (!isset($this->NM_cmp_hidden['do_valor_iva']) || $this->NM_cmp_hidden['do_valor_iva'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['do_valor_iva'][$Tipo_Sum] . "op_fecha_emision_do_valor_iva";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['embutida']) {
           ...
           elseif (!isset($this->NM_cmp_hidden[$Cada_cmp]) || $this->NM_cmp_hidden[$Cada_cmp] != "off")
           {
               ...
               elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['embutida']) {
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
   ...
   function quebra_con_id_sc_free_group_by_top()
   {
       if ($this->groupby_show != "S") {
           return;
       }
       ...
       $temp_cmp = "";
       $cont_col = 0;
       foreach ($this->campos_quebra_con_id as $cada_campo) {
           if ($cont_col == $lim_col) {
               $temp_cmp = html_entity_decode($temp_cmp, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
               $temp_cmp = strip_tags($temp_cmp);
               $temp_cmp = NM_charset_to_utf8($temp_cmp);
   ...
   function quebra_con_id_sc_free_group_by_bot()
   {
       if ($this->groupby_show != "S") {
           return;
       }
     ...
     foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
     {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['field_order'] as $Cada_cmp)
       {
           if (isset($NM_cmp_tot['do_total'][$Tipo_Sum]) && $Cada_cmp == "do_total" && (!isset($this->NM_cmp_hidden['do_total']) || $this->NM_cmp_hidden['do_total'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['do_total'][$Tipo_Sum] . "con_id_do_total";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['do_subtotal'][$Tipo_Sum]) && $Cada_cmp == "do_subtotal" && (!isset($this->NM_cmp_hidden['do_subtotal']) || $this->NM_cmp_hidden['do_subtotal'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['do_subtotal'][$Tipo_Sum] . "con_id_do_subtotal";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['do_valor_iva'][$Tipo_Sum]) && $Cada_cmp == "do_valor_iva" && (!isset($this->NM_cmp_hidden['do_valor_iva']) || $this->NM_cmp_hidden['do_valor_iva'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['do_valor_iva'][$Tipo_Sum] . "con_id_do_valor_iva";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['embutida']) {
   ...
   function quebra_op_asiento_sc_free_group_by_top()
   {
       if ($this->groupby_show != "S") {
           return;
       }
       ...
       $temp_cmp = "";
       $cont_col = 0;
       foreach ($this->campos_quebra_op_asiento as $cada_campo) {
           if ($cont_col == $lim_col) {
               $temp_cmp = html_entity_decode($temp_cmp, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
               $temp_cmp = strip_tags($temp_cmp);
               $temp_cmp = NM_charset_to_utf8($temp_cmp);
   ...
   function quebra_op_asiento_sc_free_group_by_bot()
   {
       if ($this->groupby_show != "S") {
           return;
       }
     ...
     foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
     {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['field_order'] as $Cada_cmp)
       {
           if (isset($NM_cmp_tot['do_total'][$Tipo_Sum]) && $Cada_cmp == "do_total" && (!isset($this->NM_cmp_hidden['do_total']) || $this->NM_cmp_hidden['do_total'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['do_total'][$Tipo_Sum] . "op_asiento_do_total";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['do_subtotal'][$Tipo_Sum]) && $Cada_cmp == "do_subtotal" && (!isset($this->NM_cmp_hidden['do_subtotal']) || $this->NM_cmp_hidden['do_subtotal'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['do_subtotal'][$Tipo_Sum] . "op_asiento_do_subtotal";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['embutida']) {
           ...
           elseif (isset($NM_cmp_tot['do_valor_iva'][$Tipo_Sum]) && $Cada_cmp == "do_valor_iva" && (!isset($this->NM_cmp_hidden['do_valor_iva']) || $this->NM_cmp_hidden['do_valor_iva'] != "off"))
           {
               ...
               $Prep_Tot = $NM_cmp_tot['do_valor_iva'][$Tipo_Sum] . "op_asiento_do_valor_iva";
               $Cmp_Tot  = $this->$Prep_Tot;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['embutida']) {
   ...
   function quebra_geral_sc_free_group_by_bot()
   {
       ...
       $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . '');
       $mens_tot_base = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['tot_geral'][1] . ")";
       $prim_lin_tot  = true;
     foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
     {
       $mens_tot      = $mens_tot_base . " - " . $Tit_sum;
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['field_order'] as $Cada_cmp)
       {
           if (isset($NM_cmp_tot['do_total'][$Tipo_Sum]) && $Cada_cmp == "do_total" && (!isset($this->NM_cmp_hidden['do_total']) || $this->NM_cmp_hidden['do_total'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['tot_geral'][$NM_cmp_tot['do_total'][$Tipo_Sum]];
               $prim_cmp = false;
           ...
           elseif (isset($NM_cmp_tot['do_subtotal'][$Tipo_Sum]) && $Cada_cmp == "do_subtotal" && (!isset($this->NM_cmp_hidden['do_subtotal']) || $this->NM_cmp_hidden['do_subtotal'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['tot_geral'][$NM_cmp_tot['do_subtotal'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           elseif (isset($NM_cmp_tot['do_valor_iva'][$Tipo_Sum]) && $Cada_cmp == "do_valor_iva" && (!isset($this->NM_cmp_hidden['do_valor_iva']) || $this->NM_cmp_hidden['do_valor_iva'] != "off"))
           {
               ...
               $Vl_Tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['tot_geral'][$NM_cmp_tot['do_valor_iva'][$Tipo_Sum]];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar'][$path_doc_md5][1] = $this->Tit_doc;
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_por_recuperar']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
