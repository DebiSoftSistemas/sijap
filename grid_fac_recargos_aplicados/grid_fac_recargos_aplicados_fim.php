...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_fac_recargos_aplicados"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_fac_recargos_aplicados"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_fac_recargos_aplicados']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_fac_recargos_aplicados']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_fac_recargos_aplicados']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_fac_recargos_aplicados']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_fac_recargos_aplicados']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_fac_recargos_aplicados</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_fac_recargos_aplicados']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_fac_recargos_aplicados']['embutida_filho'] as $ind => $sc_init)
          {
