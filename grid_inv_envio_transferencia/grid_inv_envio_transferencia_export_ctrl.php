<?php
@session_start() ;
$_SESSION['scriptcase']['grid_inv_envio_transferencia']['sc_process_barr'] = true;
require_once('../grid_inv_envio_transferencia/index.php');
unset($_SESSION['scriptcase']['grid_inv_envio_transferencia']['sc_process_barr']);
$ExportCtrl = new grid_inv_envio_transferencia_export_control;
$ExportCtrl->Export_barr();

class grid_inv_envio_transferencia_export_control
{
