...
//
   function init($Tp_init = "")
   {
      ...
      $this->nm_dt_ult_alt   = "20250910"; 
      $this->nm_hr_ult_alt   = "130953"; 
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_facturas_na']['glo_nm_conexao'], $this->root . $this->path_prod, 'SIJAP', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
$this->sc_ajax_message($this->Ini->Nm_lang['lang_doc_anulado'], "Aviso", "modal = Y & button = Y & button_label = Ok & body_icon = Y & redir = grid_factura_na.php", "toast=Y&toasto_pos=center-start&type=success");
...
if (!isset($_SESSION['Igtech_RucEmpresa'])) {$_SESSION['Igtech_RucEmpresa'] = "";}
if (!isset($this->sc_temp_Igtech_RucEmpresa)) {$this->sc_temp_Igtech_RucEmpresa = (isset($_SESSION['Igtech_RucEmpresa'])) ? $_SESSION['Igtech_RucEmpresa'] : "";}
  $this->sc_ajax_message($this->autorizar_factura($this->fac_numero ,'S'), "Aviso", "modal = Y & button = Y & button_label = Ok & body_icon = Y & redir = grid_facturas_na.php", "toast=Y&toasto_pos=center-start&type=success");
$check_sql = "select sp_del_busca_parametro ('".$this->sc_temp_Igtech_RucEmpresa."','PARENDEBI','NO')";
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['grid_facturas_na']['glo_nm_path_imag_temp'] . "/sc_apl_default_SIJAP.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_facturas_na']['glo_nm_path_imag_temp'] . "/sc_apl_default_SIJAP.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_SIJAP'])) {
               $_SESSION['scriptcase']['grid_facturas_na']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_SIJAP'];
           }
       }
   }
