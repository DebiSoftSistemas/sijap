  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_jap_inspectores" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_jap_inspectores_form();
	}
...
?>
  ...
  // ---------- Validate ins_id_
  function do_ajax_form_jap_inspectores_validate_ins_id_(iNumLinha)
  {
    var nomeCampo_ins_id_ = "ins_id_" + iNumLinha;
    var var_ins_id_ = scAjaxGetFieldHidden(nomeCampo_ins_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_inspectores_validate_ins_id_(var_ins_id_, iNumLinha, var_script_case_init, do_ajax_form_jap_inspectores_validate_ins_id__cb);
  } // do_ajax_form_jap_inspectores_validate_ins_id_

  function do_ajax_form_jap_inspectores_validate_ins_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "ins_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ins_id_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "ins_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ins_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_inspectores_validate_ins_id__cb

  // ---------- Validate ins_usuario_
  function do_ajax_form_jap_inspectores_validate_ins_usuario_(iNumLinha)
  {
    var nomeCampo_ins_usuario_ = "ins_usuario_" + iNumLinha;
    var var_ins_usuario_ = scAjaxGetFieldSelect(nomeCampo_ins_usuario_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_inspectores_validate_ins_usuario_(var_ins_usuario_, iNumLinha, var_script_case_init, do_ajax_form_jap_inspectores_validate_ins_usuario__cb);
  } // do_ajax_form_jap_inspectores_validate_ins_usuario_

  function do_ajax_form_jap_inspectores_validate_ins_usuario__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "ins_usuario_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ins_usuario_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "ins_usuario_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ins_usuario_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_inspectores_validate_ins_usuario__cb

  // ---------- Validate ins_estado_
  function do_ajax_form_jap_inspectores_validate_ins_estado_(iNumLinha)
  {
    var nomeCampo_ins_estado_ = "ins_estado_" + iNumLinha;
    var var_ins_estado_ = scAjaxGetFieldSelect(nomeCampo_ins_estado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_inspectores_validate_ins_estado_(var_ins_estado_, iNumLinha, var_script_case_init, do_ajax_form_jap_inspectores_validate_ins_estado__cb);
  } // do_ajax_form_jap_inspectores_validate_ins_estado_

  function do_ajax_form_jap_inspectores_validate_ins_estado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "ins_estado_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ins_estado_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "ins_estado_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ins_estado_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_inspectores_validate_ins_estado__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_jap_inspectores_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_jap_inspectores_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_jap_inspectores_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_jap_inspectores_add_new_line_cb);
  } // do_ajax_form_jap_inspectores_add_new_line

  function do_ajax_form_jap_inspectores_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_jap_inspectores_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_jap_inspectores_backup_line(iNumLinha)
  {
    var var_ins_id_ = scAjaxGetFieldHidden("ins_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_inspectores_backup_line(var_ins_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_jap_inspectores_backup_line_cb);
  } // do_ajax_form_jap_inspectores_backup_line

  function do_ajax_form_jap_inspectores_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_jap_inspectores_backup_line_cb

  function do_ajax_form_jap_inspectores_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_jap_inspectores_cancel_insert

  function do_ajax_form_jap_inspectores_cancel_update(iSeqVert)
  {
    do_ajax_form_jap_inspectores_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_jap_inspectores_cancel_update

  function do_ajax_form_jap_inspectores_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_jap_inspectores_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_jap_inspectores_table_refresh()
  {
    var var_ins_id_ = document.F2.ins_id_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_jap_inspectores_table_refresh(var_ins_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jap_inspectores_table_refresh_cb);
  } //  do_ajax_form_jap_inspectores_table_refresh

  function do_ajax_form_jap_inspectores_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.ins_id_.value = scAjaxGetKeyValue("ins_id_");
    ...
    scAjaxAlert(do_ajax_form_jap_inspectores_table_refresh_cb_after_alert);
  } // do_ajax_form_jap_inspectores_table_refresh_cb
  function do_ajax_form_jap_inspectores_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_jap_inspectores_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_jap_inspectores_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_jap_inspectores_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_ins_id_ = scAjaxGetFieldHidden("ins_id_" + iNumLinha);
    var var_ins_usuario_ = scAjaxGetFieldSelect("ins_usuario_" + iNumLinha);
    var var_ins_estado_ = scAjaxGetFieldSelect("ins_estado_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_jap_inspectores_submit_form(var_ins_id_, var_ins_usuario_, var_ins_estado_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_jap_inspectores_submit_form_cb);
  } // do_ajax_form_jap_inspectores_submit_form

  function do_ajax_form_jap_inspectores_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("ins_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("ins_usuario_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("ins_estado_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_jap_inspectores_submit_form_cb_after_alert);
  } // do_ajax_form_jap_inspectores_submit_form_cb
  function do_ajax_form_jap_inspectores_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_jap_inspectores_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_jap_inspectores_navigate_form()
  {
    perform_ajax_form_jap_inspectores_navigate_form();
  }

  function perform_ajax_form_jap_inspectores_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_jap_inspectores_cancel_insert(sc_form_jap_inspectores_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("ins_id_" + iNavForm);
      scAjaxHideErrorDisplay("ins_usuario_" + iNavForm);
      scAjaxHideErrorDisplay("ins_estado_" + iNavForm);
    }
    var var_ins_id_ = document.F2.ins_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_jap_inspectores_navigate_form(var_ins_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jap_inspectores_navigate_form_cb);
  } // do_ajax_form_jap_inspectores_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_inspectores']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_jap_inspectores_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.ins_id_.value = scAjaxGetKeyValue("ins_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_jap_inspectores_navigate_form_cb_after_alert);
  } // do_ajax_form_jap_inspectores_navigate_form_cb
  function do_ajax_form_jap_inspectores_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_jap_inspectores_navigate_form_cb_after_alert

    function sc_form_jap_inspectores_get_last_line_number()
    {
    ...
    } //sc_form_jap_inspectores_get_last_line_number

  function sc_hide_form_jap_inspectores_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "ins_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "ins_usuario_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "ins_estado_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["ins_id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["ins_usuario_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_username'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["ins_estado_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["ins_id_"][iNumLinha] = "ins_id_" + iNumLinha;
    ajax_field_mult["ins_usuario_"][iNumLinha] = "ins_usuario_" + iNumLinha;
    ajax_field_mult["ins_estado_"][iNumLinha] = "ins_estado_" + iNumLinha;
    ajax_field_id["ins_id_" + iNumLinha] = new Array("hidden_field_label_ins_id_", "hidden_field_data_ins_id_" + iNumLinha);
    ajax_field_id["ins_usuario_" + iNumLinha] = new Array("hidden_field_label_ins_usuario_", "hidden_field_data_ins_usuario_" + iNumLinha);
    ajax_field_id["ins_estado_" + iNumLinha] = new Array("hidden_field_label_ins_estado_", "hidden_field_data_ins_estado_" + iNumLinha);
    ajax_error_count["ins_id_" + iNumLinha] = "off";
    ajax_error_count["ins_usuario_" + iNumLinha] = "off";
    ajax_error_count["ins_estado_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["ins_id_" + iNumLinha] = "on";
    ajax_read_only["ins_usuario_" + iNumLinha] = "off";
    ajax_read_only["ins_estado_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["ins_id_" + iNumLinha] = "on";
    ajax_read_only["ins_usuario_" + iNumLinha] = "on";
    ajax_read_only["ins_estado_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["ins_id_" + iNumLinha] = null;
    ajax_error_list["ins_usuario_" + iNumLinha] = null;
    ajax_error_list["ins_estado_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "ins_id_": new Array(),
    "ins_usuario_": new Array(),
    "ins_estado_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["ins_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ins_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ins_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ins_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ins_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["ins_usuario_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ins_usuario_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ins_usuario_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ins_usuario_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ins_usuario_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["ins_estado_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ins_estado_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ins_estado_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ins_estado_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ins_estado_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ins_id_'])) ? $this->nmgp_cmp_readonly['ins_id_'] : 'on';
?>
    scAjaxFieldRead("ins_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ins_usuario_'])) ? $this->nmgp_cmp_readonly['ins_usuario_'] : 'off';
?>
    scAjaxFieldRead("ins_usuario_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ins_estado_'])) ? $this->nmgp_cmp_readonly['ins_estado_'] : 'off';
?>
    scAjaxFieldRead("ins_estado_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("ins_id_" + iSeq, "on");
    scAjaxFieldRead("ins_usuario_" + iSeq, "on");
    scAjaxFieldRead("ins_estado_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["ins_id_" + iRow] || "on" == ajax_error_count["ins_usuario_" + iRow] || "on" == ajax_error_count["ins_estado_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ins_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ins_usuario_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ins_estado_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["ins_id_" + iRow] && "off" == ajax_error_count["ins_usuario_" + iRow] && "off" == ajax_error_count["ins_estado_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["ins_id_" + iRow] = "off";
        ajax_error_count["ins_usuario_" + iRow] = "off";
        ajax_error_count["ins_estado_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_ins_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_ins_usuario_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_ins_estado_" + iRow).removeClass("scFormErrorLine");
    }
  }
