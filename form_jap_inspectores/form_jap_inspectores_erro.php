...
$old_error_handler = set_error_handler("form_jap_inspectores_scriptcase_error_handler");

function form_jap_inspectores_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['form_jap_inspectores']['contr_erro']) && $_SESSION['scriptcase']['form_jap_inspectores']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_jap_inspectores->contr_form_jap_inspectores->Apl_com_erro = true;
            if ($inicial_form_jap_inspectores->contr_form_jap_inspectores->NM_ajax_flag)
            {
                $inicial_form_jap_inspectores->contr_form_jap_inspectores->NM_ajax_info['errList']['geral_form_jap_inspectores'][] = $msg;
                return;
            }
            form_jap_inspectores_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_jap_inspectores_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_jap_inspectores'])  && '' != $_SESSION['scriptcase']['error_icon']['form_jap_inspectores'])  ? $_SESSION['scriptcase']['error_icon']['form_jap_inspectores']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_jap_inspectores']) && '' != $_SESSION['scriptcase']['error_span_title']['form_jap_inspectores']) ? $_SESSION['scriptcase']['error_span_title']['form_jap_inspectores'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_jap_inspectores']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_jap_inspectores']) ? $_SESSION['scriptcase']['error_icon_title']['form_jap_inspectores'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_jap_inspectores']['error_buffer'] .= ob_get_flush();
}
