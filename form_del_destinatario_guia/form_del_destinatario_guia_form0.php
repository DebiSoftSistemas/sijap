...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_del_destinatario_guia/form_del_destinatario_guia_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_del_destinatario_guia_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_del_destinatario_guia_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['link_info']['remove_border']) {
...
<?php
 include_once("form_del_destinatario_guia_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_del_destinatario_guia'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_del_destinatario_guia'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-1';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['btn_disabled']['']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['btn_disabled']['']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['btn_label']['']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['btn_label']['']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['btn_label'][''];
        }
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['btn_label']['delete'];
        }
?>
...
<?php
   $Sc_iframe_master = ($this->Embutida_call) ? 'nmgp_iframe_ret*scinnmsc_iframe_liga_form_del_destinatario_guia*scout' : '';
   if (isset($this->Ini->sc_lig_md5["buscar_factura"]) && $this->Ini->sc_lig_md5["buscar_factura"] == "S") {
       ...
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_del_destinatario_guia@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
...
<?php } 
?> 
<?php $sStyleHidden_dg_iddoc_sustento_dumb = ('' == $sStyleHidden_dg_iddoc_sustento) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_dg_iddoc_sustento_dumb" style="<?php echo $sStyleHidden_dg_iddoc_sustento_dumb; ?>"></TD>
<?php $sStyleHidden_tipo_sustento_dumb = ('' == $sStyleHidden_tipo_sustento) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_tipo_sustento_dumb" style="<?php echo $sStyleHidden_tipo_sustento_dumb; ?>"></TD>
...
<?php $sStyleHidden_autorizacion_sustento_dumb = ('' == $sStyleHidden_autorizacion_sustento) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_autorizacion_sustento_dumb" style="<?php echo $sStyleHidden_autorizacion_sustento_dumb; ?>"></TD>
...
<?php } ?>
<?php $sStyleHidden_dg_coddoc_sustento_dumb = ('' == $sStyleHidden_dg_coddoc_sustento) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_dg_coddoc_sustento_dumb" style="<?php echo $sStyleHidden_dg_coddoc_sustento_dumb; ?>"></TD>
<?php $sStyleHidden_dg_serie_sustento_dumb = ('' == $sStyleHidden_dg_serie_sustento) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_dg_serie_sustento_dumb" style="<?php echo $sStyleHidden_dg_serie_sustento_dumb; ?>"></TD>
<?php $sStyleHidden_dg_secuencial_sustento_dumb = ('' == $sStyleHidden_dg_secuencial_sustento) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_dg_secuencial_sustento_dumb" style="<?php echo $sStyleHidden_dg_secuencial_sustento_dumb; ?>"></TD>
<?php $sStyleHidden_dg_autorizacion_sustento_dumb = ('' == $sStyleHidden_dg_autorizacion_sustento) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_dg_autorizacion_sustento_dumb" style="<?php echo $sStyleHidden_dg_autorizacion_sustento_dumb; ?>"></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_dg_establecimiento_destino_label" id="hidden_field_label_dg_establecimiento_destino" style="<?php echo $sStyleHidden_dg_establecimiento_destino; ?>"><span id="id_label_dg_establecimiento_destino"><?php echo $this->nm_new_label['dg_establecimiento_destino']; ?></span></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_dg_tipo_label" id="hidden_field_label_dg_tipo" style="<?php echo $sStyleHidden_dg_tipo; ?>"><span id="id_label_dg_tipo"><?php echo $this->nm_new_label['dg_tipo']; ?></span></TD>
    <TD class="scFormDataOdd css_dg_tipo_line" id="hidden_field_data_dg_tipo" style="<?php echo $sStyleHidden_dg_tipo; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dg_tipo_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_dg_nombre_destinatario_label" id="hidden_field_label_dg_nombre_destinatario" style="<?php echo $sStyleHidden_dg_nombre_destinatario; ?>"><span id="id_label_dg_nombre_destinatario"><?php echo $this->nm_new_label['dg_nombre_destinatario']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['php_cmp_required']['dg_nombre_destinatario']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['php_cmp_required']['dg_nombre_destinatario'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_dg_nombre_destinatario_line" id="hidden_field_data_dg_nombre_destinatario" style="<?php echo $sStyleHidden_dg_nombre_destinatario; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dg_nombre_destinatario_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_dg_identificacion_destinatario_label" id="hidden_field_label_dg_identificacion_destinatario" style="<?php echo $sStyleHidden_dg_identificacion_destinatario; ?>"><span id="id_label_dg_identificacion_destinatario"><?php echo $this->nm_new_label['dg_identificacion_destinatario']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['php_cmp_required']['dg_identificacion_destinatario']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['php_cmp_required']['dg_identificacion_destinatario'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_dg_identificacion_destinatario_line" id="hidden_field_data_dg_identificacion_destinatario" style="<?php echo $sStyleHidden_dg_identificacion_destinatario; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dg_identificacion_destinatario_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_dg_direccion_destino_label" id="hidden_field_label_dg_direccion_destino" style="<?php echo $sStyleHidden_dg_direccion_destino; ?>"><span id="id_label_dg_direccion_destino"><?php echo $this->nm_new_label['dg_direccion_destino']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['php_cmp_required']['dg_direccion_destino']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['php_cmp_required']['dg_direccion_destino'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_dg_direccion_destino_line" id="hidden_field_data_dg_direccion_destino" style="<?php echo $sStyleHidden_dg_direccion_destino; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dg_direccion_destino_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_dg_documento_aduanero_label" id="hidden_field_label_dg_documento_aduanero" style="<?php echo $sStyleHidden_dg_documento_aduanero; ?>"><span id="id_label_dg_documento_aduanero"><?php echo $this->nm_new_label['dg_documento_aduanero']; ?></span></TD>
    <TD class="scFormDataOdd css_dg_documento_aduanero_line" id="hidden_field_data_dg_documento_aduanero" style="<?php echo $sStyleHidden_dg_documento_aduanero; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dg_documento_aduanero_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_dg_motivo_traslado_label" id="hidden_field_label_dg_motivo_traslado" style="<?php echo $sStyleHidden_dg_motivo_traslado; ?>"><span id="id_label_dg_motivo_traslado"><?php echo $this->nm_new_label['dg_motivo_traslado']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['php_cmp_required']['dg_motivo_traslado']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['php_cmp_required']['dg_motivo_traslado'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_dg_motivo_traslado_line" id="hidden_field_data_dg_motivo_traslado" style="<?php echo $sStyleHidden_dg_motivo_traslado; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dg_motivo_traslado_line" style="vertical-align: top;padding: 0px">
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_dg_ruta_label" id="hidden_field_label_dg_ruta" style="<?php echo $sStyleHidden_dg_ruta; ?>"><span id="id_label_dg_ruta"><?php echo $this->nm_new_label['dg_ruta']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['php_cmp_required']['dg_ruta']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['php_cmp_required']['dg_ruta'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_dg_ruta_line" id="hidden_field_data_dg_ruta" style="<?php echo $sStyleHidden_dg_ruta; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dg_ruta_line" style="vertical-align: top;padding: 0px">
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_dg_id_label" id="hidden_field_label_dg_id" style="<?php echo $sStyleHidden_dg_id; ?>"><span id="id_label_dg_id"><?php echo $this->nm_new_label['dg_id']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['php_cmp_required']['dg_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['php_cmp_required']['dg_id'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_dg_id_line" id="hidden_field_data_dg_id" style="<?php echo $sStyleHidden_dg_id; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dg_id_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_dg_guia_label" id="hidden_field_label_dg_guia" style="<?php echo $sStyleHidden_dg_guia; ?>"><span id="id_label_dg_guia"><?php echo $this->nm_new_label['dg_guia']; ?></span></TD>
    <TD class="scFormDataOdd css_dg_guia_line" id="hidden_field_data_dg_guia" style="<?php echo $sStyleHidden_dg_guia; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dg_guia_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_dg_empresa_label" id="hidden_field_label_dg_empresa" style="<?php echo $sStyleHidden_dg_empresa; ?>"><span id="id_label_dg_empresa"><?php echo $this->nm_new_label['dg_empresa']; ?></span></TD>
    <TD class="scFormDataOdd css_dg_empresa_line" id="hidden_field_data_dg_empresa" style="<?php echo $sStyleHidden_dg_empresa; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dg_empresa_line" style="vertical-align: top;padding: 0px">
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_productos'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_productos'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['form_del_detalle_guia_destinatario_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_productos'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['form_del_detalle_guia_destinatario_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['form_del_detalle_guia_destinatario_script_case_init'] ]['form_del_detalle_guia_destinatario']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['form_del_detalle_guia_destinatario_script_case_init'] ]['form_del_detalle_guia_destinatario']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['form_del_detalle_guia_destinatario_script_case_init'] ]['form_del_detalle_guia_destinatario']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['form_del_detalle_guia_destinatario_script_case_init'] ]['form_del_detalle_guia_destinatario']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['form_del_detalle_guia_destinatario_script_case_init'] ]['form_del_detalle_guia_destinatario']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['form_del_detalle_guia_destinatario_script_case_init'] ]['form_del_detalle_guia_destinatario']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['form_del_detalle_guia_destinatario_script_case_init'] ]['form_del_detalle_guia_destinatario']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['form_del_detalle_guia_destinatario_script_case_init'] ]['form_del_detalle_guia_destinatario']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['form_del_detalle_guia_destinatario_script_case_init'] ]['form_del_detalle_guia_destinatario']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['form_del_detalle_guia_destinatario_script_case_init'] ]['form_del_detalle_guia_destinatario']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['form_del_detalle_guia_destinatario_script_case_init'] ]['form_del_detalle_guia_destinatario']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['form_del_detalle_guia_destinatario_script_case_init'] ]['form_del_detalle_guia_destinatario']['embutida_liga_tp_pag'] = 'total';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['form_del_detalle_guia_destinatario_script_case_init'] ]['form_del_detalle_guia_destinatario']['embutida_parms'] = "var_destinatario*scin" . $this->nmgp_dados_form['dg_id'] . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['form_del_detalle_guia_destinatario_script_case_init'] ]['form_del_destinatario_guia']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_del_destinatario_guia_empty.htm' : $this->Ini->link_form_del_detalle_guia_destinatario_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y&sc_ifr_height=300';
if (isset($this->Ini->sc_lig_target['C_@scinf_productos']) && 'nmsc_iframe_liga_form_del_detalle_guia_destinatario' != $this->Ini->sc_lig_target['C_@scinf_productos'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_productos'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['form_del_detalle_guia_destinatario_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_del_detalle_guia_destinatario"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="300" width="100%" name="nmsc_iframe_liga_form_del_detalle_guia_destinatario"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_del_destinatario_guia");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_del_destinatario_guia");
 parent.scAjaxDetailHeight("form_del_destinatario_guia", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
