<?php
//
class form_del_destinatario_guia_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_del_destinatario_guia']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_del_destinatario_guia']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_del_destinatario_guia']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_del_destinatario_guia']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_del_destinatario_guia']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_del_destinatario_guia']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_del_destinatario_guia']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_del_destinatario_guia']['form_del_detalle_guia_destinatario_script_case_init'] ]['form_del_detalle_guia_destinatario']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_del_destinatario_guia']['form_del_detalle_guia_destinatario_script_case_init'] ]['form_del_detalle_guia_destinatario']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_del_destinatario_guia']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_del_destinatario_guia']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->var_id_destinatario)) 
          {
              $_SESSION['var_id_destinatario'] = $this->var_id_destinatario;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_del_destinatario_guia']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_del_destinatario_guia']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_del_destinatario_guia']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_del_destinatario_guia']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_del_destinatario_guia']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_del_destinatario_guia']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_del_destinatario_guia']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_del_destinatario_guia']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_del_destinatario_guia']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_del_destinatario_guia_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_del_destinatario_guia']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_del_destinatario_guia']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_del_destinatario_guia'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_del_destinatario_guia']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_del_destinatario_guia']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_del_destinatario_guia') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_del_destinatario_guia']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " del_destinatario_guia";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_del_destinatario_guia")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_del_destinatario_guia']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_del_destinatario_guia'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_destinatario_guia']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_del_destinatario_guia']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_destinatario_guia']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_del_destinatario_guia']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_destinatario_guia']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_del_destinatario_guia']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['where_orig'] = " where (dg_id=" . $_SESSION['var_id_destinatario'] . ")";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['where_pesq'] = " where (dg_id=" . $_SESSION['var_id_destinatario'] . ")";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_destinatario_guia']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_del_destinatario_guia']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_del_destinatario_guia']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_destinatario_guia']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_del_destinatario_guia'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_del_destinatario_guia'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_destinatario_guia']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_del_destinatario_guia']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_del_destinatario_guia']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_destinatario_guia']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_del_destinatario_guia']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_del_destinatario_guia']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_destinatario_guia']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_destinatario_guia']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_del_destinatario_guia']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dados_form'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_del_destinatario_guia/form_del_destinatario_guia_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_del_destinatario_guia_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_del_destinatario_guia_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_del_destinatario_guia_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_del_destinatario_guia/form_del_destinatario_guia_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_del_destinatario_guia_erro.class.php"); 
      }
      $this->Erro      = new form_del_destinatario_guia_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['opcao']))
         { 
             if ($this->dg_id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_destinatario_guia']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_destinatario_guia']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_del_destinatario_guia']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['opc_ant'] : "";
      } 
      ...
      {
          $this->nmgp_botoes['desde_factura'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['botoes']['desde_factura'];
          $this->nmgp_botoes['entre_establecimientos'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['botoes']['entre_establecimientos'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['form_del_detalle_guia_destinatario_script_case_init'] ]['form_del_detalle_guia_destinatario']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['form_del_detalle_guia_destinatario_script_case_init'] ]['form_del_detalle_guia_destinatario']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['form_del_detalle_guia_destinatario_script_case_init'] ]['form_del_detalle_guia_destinatario']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['form_del_detalle_guia_destinatario_script_case_init'] ]['form_del_detalle_guia_destinatario']['total']);
          $detailAppObject = "form_del_detalle_guia_destinatario_apl";
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_del_detalle_guia_destinatario') . "/index.php");
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_del_detalle_guia_destinatario') . "/form_del_detalle_guia_destinatario_apl.php");
          $this->form_del_detalle_guia_destinatario = new $detailAppObject;
      }
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_del_destinatario_guia']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_del_destinatario_guia']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dados_select'];
     }
   }
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['Gera_log_access'] = false;
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dados_select']['tipo_sustento']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tipo_sustento = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dados_select']['tipo_sustento'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dados_select']['serie_sustento']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->serie_sustento = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dados_select']['serie_sustento'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dados_select']['secuencial_sustento']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->secuencial_sustento = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dados_select']['secuencial_sustento'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dados_select']['autorizacion_sustento']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->autorizacion_sustento = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dados_select']['autorizacion_sustento'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dados_select']['fecha_sustento']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fecha_sustento = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dados_select']['fecha_sustento'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['recarga'] = $this->nmgp_opcao;
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_del_destinatario_guia.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_del_destinatario_guia_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_del_destinatario_guia"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_del_destinatario_guia', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sis_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'form_del_destinatario_guia', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_del_destinatario_guia', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_del_destinatario_guia']) || !is_array($this->NM_ajax_info['errList']['geral_form_del_destinatario_guia']))
              {
                  $this->NM_ajax_info['errList']['geral_form_del_destinatario_guia'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_del_destinatario_guia'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
    ...
    function ValidateField_dg_iddoc_sustento(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->dg_iddoc_sustento, 9, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
   ...
   if (isset($this->Field_no_validate['dg_establecimiento_destino'])) {
       return;
               ...
               if (!empty($this->dg_establecimiento_destino) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['Lookup_dg_establecimiento_destino']) && !in_array($this->dg_establecimiento_destino, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['Lookup_dg_establecimiento_destino']))
               {
                   $hasError = true;
    ...
    function ValidateField_dg_nombre_destinatario(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['php_cmp_required']['dg_nombre_destinatario']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['php_cmp_required']['dg_nombre_destinatario'] == "on")) 
      { 
    ...
    function ValidateField_dg_identificacion_destinatario(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['php_cmp_required']['dg_identificacion_destinatario']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['php_cmp_required']['dg_identificacion_destinatario'] == "on")) 
      { 
    ...
    function ValidateField_dg_direccion_destino(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['php_cmp_required']['dg_direccion_destino']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['php_cmp_required']['dg_direccion_destino'] == "on")) 
      { 
    ...
    function ValidateField_dg_motivo_traslado(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['php_cmp_required']['dg_motivo_traslado']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['php_cmp_required']['dg_motivo_traslado'] == "on")) 
      { 
    ...
    function ValidateField_dg_ruta(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['php_cmp_required']['dg_ruta']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['php_cmp_required']['dg_ruta'] == "on")) 
      { 
          if ($this->dg_ruta == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_dg_id(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->dg_id, 9, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['php_cmp_required']['dg_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['php_cmp_required']['dg_id'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_dg_guia(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->dg_guia, 9, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['dg_id']['keyVal'] = form_del_destinatario_guia_pack_protect_string($this->nmgp_dados_form['dg_id']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['form_del_detalle_guia_destinatario_script_case_init'] ]['form_del_detalle_guia_destinatario']['foreign_key']['dgd_destinatario'] = $this->nmgp_dados_form['dg_id'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['form_del_detalle_guia_destinatario_script_case_init'] ]['form_del_detalle_guia_destinatario']['where_filter'] = "dgd_destinatario = " . $this->nmgp_dados_form['dg_id'] . "";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['form_del_detalle_guia_destinatario_script_case_init'] ]['form_del_detalle_guia_destinatario']['where_detal']  = "dgd_destinatario = " . $this->nmgp_dados_form['dg_id'] . "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['form_del_detalle_guia_destinatario_script_case_init'] ]['form_del_detalle_guia_destinatario']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['form_del_detalle_guia_destinatario_script_case_init'] ]['form_del_detalle_guia_destinatario']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['form_del_detalle_guia_destinatario_script_case_init'] ]['form_del_detalle_guia_destinatario']['total']);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['Lookup_dg_establecimiento_destino']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['Lookup_dg_establecimiento_destino'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['Lookup_dg_establecimiento_destino']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['Lookup_dg_establecimiento_destino'] = array(); 
}
$aLookup[] = array(form_del_destinatario_guia_pack_protect_string('0') => str_replace('<', '&lt;',form_del_destinatario_guia_pack_protect_string('' . $this->Ini->Nm_lang['lang_seleccione'] . '')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['Lookup_dg_establecimiento_destino'][] = '0';
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_del_destinatario_guia_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_del_destinatario_guia_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['Lookup_dg_establecimiento_destino'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['dg_establecimiento_destino']['valList'][$i] = form_del_destinatario_guia_pack_protect_string($v);
          }
   ...
   function ajax_return_values_productos($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['Field_no_validate'] = array();
      if (!$this->NM_ajax_flag || !isset($this->nmgp_refresh_fields)) {
      $_SESSION['scriptcase']['form_del_destinatario_guia']['contr_erro'] = 'on';
...
//----------- 
   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['total']);
              }
              ...
              $this->NM_gera_log_new();
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          if ($bDelecaoOk)
          {
              ...
              $this->form_del_detalle_guia_destinatario->ini_controle();
              if ($this->form_del_detalle_guia_destinatario->temRegistros($sDetailWhere))
              {
                  if (!$this->form_del_detalle_guia_destinatario->deletaRegistros($sDetailWhere))
                  {
                      $bDelecaoOk = false;
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['parms'] = "dg_id?#?$this->dg_id?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (!empty($sc_where))
              {
                  if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['reg_start'] < $qt_geral_reg_form_del_destinatario_guia;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['opcao']   = '';
          }
      } 
...
//-- 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_guia_destinatario']['embutida_parms'] = "var_destinatario*scin" . $this->nmgp_dados_form['dg_id'] . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
  }
// 
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dados_select'];
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_del_destinatario_guia_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['where_filter_form'] . " and ((dg_id=" . $_SESSION['var_id_destinatario'] . ")) and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_del_destinatario_guia = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['total'] = $qt_geral_reg_form_del_destinatario_guia;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_del_destinatario_guia_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_del_destinatario_guia_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_del_destinatario_guia_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
<?php
  exit;
    ...
    function getButtonIds($buttonName) {
        switch ($buttonName) {
            ...
            case "exit":
                ...
                break;
            case "0":
                return array("sys_separator.sc-unique-btn-4", "sys_separator.sc-unique-btn-7", "sys_separator.sc-unique-btn-11");
                break;
            case "update":
                return array("sc_b_upd_t.sc-unique-btn-5", "sc_b_upd_b.sc-unique-btn-12");
                break;
            case "delete":
                return array("sc_b_del_t.sc-unique-btn-6", "sc_b_del_b.sc-unique-btn-13");
                break;
        }
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_destinatario_guia']['ordem_ord'] == " desc") {
