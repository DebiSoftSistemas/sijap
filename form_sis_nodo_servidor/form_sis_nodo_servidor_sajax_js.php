  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_nodo_servidor" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sis_nodo_servidor_form();
	}
...
?>
  ...
  // ---------- Validate nos_nombre_
  function do_ajax_form_sis_nodo_servidor_validate_nos_nombre_(iNumLinha)
  {
    var nomeCampo_nos_nombre_ = "nos_nombre_" + iNumLinha;
    var var_nos_nombre_ = scAjaxGetFieldText(nomeCampo_nos_nombre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_nodo_servidor_validate_nos_nombre_(var_nos_nombre_, iNumLinha, var_script_case_init, do_ajax_form_sis_nodo_servidor_validate_nos_nombre__cb);
  } // do_ajax_form_sis_nodo_servidor_validate_nos_nombre_

  function do_ajax_form_sis_nodo_servidor_validate_nos_nombre__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "nos_nombre_" + iLineNumber;
    }
    else
    {
      sFieldValid = "nos_nombre_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "nos_nombre_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "nos_nombre_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_nodo_servidor_validate_nos_nombre__cb

  // ---------- Validate nos_descripcion_
  function do_ajax_form_sis_nodo_servidor_validate_nos_descripcion_(iNumLinha)
  {
    var nomeCampo_nos_descripcion_ = "nos_descripcion_" + iNumLinha;
    var var_nos_descripcion_ = scAjaxGetFieldText(nomeCampo_nos_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_nodo_servidor_validate_nos_descripcion_(var_nos_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_sis_nodo_servidor_validate_nos_descripcion__cb);
  } // do_ajax_form_sis_nodo_servidor_validate_nos_descripcion_

  function do_ajax_form_sis_nodo_servidor_validate_nos_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "nos_descripcion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "nos_descripcion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "nos_descripcion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "nos_descripcion_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_nodo_servidor_validate_nos_descripcion__cb

  // ---------- Validate nos_ip_
  function do_ajax_form_sis_nodo_servidor_validate_nos_ip_(iNumLinha)
  {
    var nomeCampo_nos_ip_ = "nos_ip_" + iNumLinha;
    var var_nos_ip_ = scAjaxGetFieldText(nomeCampo_nos_ip_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_nodo_servidor_validate_nos_ip_(var_nos_ip_, iNumLinha, var_script_case_init, do_ajax_form_sis_nodo_servidor_validate_nos_ip__cb);
  } // do_ajax_form_sis_nodo_servidor_validate_nos_ip_

  function do_ajax_form_sis_nodo_servidor_validate_nos_ip__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "nos_ip_" + iLineNumber;
    }
    else
    {
      sFieldValid = "nos_ip_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "nos_ip_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "nos_ip_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_nodo_servidor_validate_nos_ip__cb

  // ---------- Validate nos_ssoo_
  function do_ajax_form_sis_nodo_servidor_validate_nos_ssoo_(iNumLinha)
  {
    var nomeCampo_nos_ssoo_ = "nos_ssoo_" + iNumLinha;
    var var_nos_ssoo_ = scAjaxGetFieldSelect(nomeCampo_nos_ssoo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_nodo_servidor_validate_nos_ssoo_(var_nos_ssoo_, iNumLinha, var_script_case_init, do_ajax_form_sis_nodo_servidor_validate_nos_ssoo__cb);
  } // do_ajax_form_sis_nodo_servidor_validate_nos_ssoo_

  function do_ajax_form_sis_nodo_servidor_validate_nos_ssoo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "nos_ssoo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "nos_ssoo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "nos_ssoo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "nos_ssoo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_nodo_servidor_validate_nos_ssoo__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_sis_nodo_servidor_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_sis_nodo_servidor_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sis_nodo_servidor_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_sis_nodo_servidor_add_new_line_cb);
  } // do_ajax_form_sis_nodo_servidor_add_new_line

  function do_ajax_form_sis_nodo_servidor_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_sis_nodo_servidor_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_sis_nodo_servidor_backup_line(iNumLinha)
  {
    var var_nos_nombre_ = scAjaxGetFieldText("nos_nombre_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_nodo_servidor_backup_line(var_nos_nombre_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_sis_nodo_servidor_backup_line_cb);
  } // do_ajax_form_sis_nodo_servidor_backup_line

  function do_ajax_form_sis_nodo_servidor_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_sis_nodo_servidor_backup_line_cb

  function do_ajax_form_sis_nodo_servidor_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_sis_nodo_servidor_cancel_insert

  function do_ajax_form_sis_nodo_servidor_cancel_update(iSeqVert)
  {
    do_ajax_form_sis_nodo_servidor_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_sis_nodo_servidor_cancel_update

  function do_ajax_form_sis_nodo_servidor_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_sis_nodo_servidor_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_sis_nodo_servidor_table_refresh()
  {
    var var_nos_nombre_ = document.F2.nos_nombre_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_sis_nodo_servidor_table_refresh(var_nos_nombre_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_nodo_servidor_table_refresh_cb);
  } //  do_ajax_form_sis_nodo_servidor_table_refresh

  function do_ajax_form_sis_nodo_servidor_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.nos_nombre_.value = scAjaxGetKeyValue("nos_nombre_");
    ...
    scAjaxAlert(do_ajax_form_sis_nodo_servidor_table_refresh_cb_after_alert);
  } // do_ajax_form_sis_nodo_servidor_table_refresh_cb
  function do_ajax_form_sis_nodo_servidor_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_sis_nodo_servidor_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_sis_nodo_servidor_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_sis_nodo_servidor_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_nos_nombre_ = scAjaxGetFieldText("nos_nombre_" + iNumLinha);
    var var_nos_descripcion_ = scAjaxGetFieldText("nos_descripcion_" + iNumLinha);
    var var_nos_ip_ = scAjaxGetFieldText("nos_ip_" + iNumLinha);
    var var_nos_ssoo_ = scAjaxGetFieldSelect("nos_ssoo_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_sis_nodo_servidor_submit_form(var_nos_nombre_, var_nos_descripcion_, var_nos_ip_, var_nos_ssoo_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_nodo_servidor_submit_form_cb);
  } // do_ajax_form_sis_nodo_servidor_submit_form

  function do_ajax_form_sis_nodo_servidor_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("nos_nombre_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("nos_descripcion_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("nos_ip_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("nos_ssoo_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sis_nodo_servidor_submit_form_cb_after_alert);
  } // do_ajax_form_sis_nodo_servidor_submit_form_cb
  function do_ajax_form_sis_nodo_servidor_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_nodo_servidor_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sis_nodo_servidor_navigate_form()
  {
    perform_ajax_form_sis_nodo_servidor_navigate_form();
  }

  function perform_ajax_form_sis_nodo_servidor_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_sis_nodo_servidor_cancel_insert(sc_form_sis_nodo_servidor_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("nos_nombre_" + iNavForm);
      scAjaxHideErrorDisplay("nos_descripcion_" + iNavForm);
      scAjaxHideErrorDisplay("nos_ip_" + iNavForm);
      scAjaxHideErrorDisplay("nos_ssoo_" + iNavForm);
    }
    var var_nos_nombre_ = document.F2.nos_nombre_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sis_nodo_servidor_navigate_form(var_nos_nombre_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_nodo_servidor_navigate_form_cb);
  } // do_ajax_form_sis_nodo_servidor_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_nodo_servidor']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_nodo_servidor_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.nos_nombre_.value = scAjaxGetKeyValue("nos_nombre_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_nodo_servidor_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_nodo_servidor_navigate_form_cb
  function do_ajax_form_sis_nodo_servidor_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_sis_nodo_servidor_navigate_form_cb_after_alert

    function sc_form_sis_nodo_servidor_get_last_line_number()
    {
    ...
    } //sc_form_sis_nodo_servidor_get_last_line_number

  function sc_hide_form_sis_nodo_servidor_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "nos_nombre_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "nos_descripcion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "nos_ip_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "nos_ssoo_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["nos_nombre_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_nodo'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["nos_descripcion_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_descripcion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["nos_ip_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_ip'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["nos_ssoo_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_ssoo'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["nos_nombre_"][iNumLinha] = "nos_nombre_" + iNumLinha;
    ajax_field_mult["nos_descripcion_"][iNumLinha] = "nos_descripcion_" + iNumLinha;
    ajax_field_mult["nos_ip_"][iNumLinha] = "nos_ip_" + iNumLinha;
    ajax_field_mult["nos_ssoo_"][iNumLinha] = "nos_ssoo_" + iNumLinha;
    ajax_field_id["nos_nombre_" + iNumLinha] = new Array("hidden_field_label_nos_nombre_", "hidden_field_data_nos_nombre_" + iNumLinha);
    ajax_field_id["nos_descripcion_" + iNumLinha] = new Array("hidden_field_label_nos_descripcion_", "hidden_field_data_nos_descripcion_" + iNumLinha);
    ajax_field_id["nos_ip_" + iNumLinha] = new Array("hidden_field_label_nos_ip_", "hidden_field_data_nos_ip_" + iNumLinha);
    ajax_field_id["nos_ssoo_" + iNumLinha] = new Array("hidden_field_label_nos_ssoo_", "hidden_field_data_nos_ssoo_" + iNumLinha);
    ajax_error_count["nos_nombre_" + iNumLinha] = "off";
    ajax_error_count["nos_descripcion_" + iNumLinha] = "off";
    ajax_error_count["nos_ip_" + iNumLinha] = "off";
    ajax_error_count["nos_ssoo_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["nos_nombre_" + iNumLinha] = "on";
    ajax_read_only["nos_descripcion_" + iNumLinha] = "off";
    ajax_read_only["nos_ip_" + iNumLinha] = "off";
    ajax_read_only["nos_ssoo_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["nos_nombre_" + iNumLinha] = "on";
    ajax_read_only["nos_descripcion_" + iNumLinha] = "on";
    ajax_read_only["nos_ip_" + iNumLinha] = "on";
    ajax_read_only["nos_ssoo_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["nos_nombre_" + iNumLinha] = null;
    ajax_error_list["nos_descripcion_" + iNumLinha] = null;
    ajax_error_list["nos_ip_" + iNumLinha] = null;
    ajax_error_list["nos_ssoo_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "nos_nombre_": new Array(),
    "nos_descripcion_": new Array(),
    "nos_ip_": new Array(),
    "nos_ssoo_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["nos_nombre_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["nos_nombre_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["nos_nombre_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["nos_nombre_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["nos_nombre_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["nos_descripcion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["nos_descripcion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["nos_descripcion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["nos_descripcion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["nos_descripcion_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["nos_ip_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["nos_ip_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["nos_ip_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["nos_ip_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["nos_ip_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["nos_ssoo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["nos_ssoo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["nos_ssoo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["nos_ssoo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["nos_ssoo_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['nos_nombre_'])) ? $this->nmgp_cmp_readonly['nos_nombre_'] : 'on';
?>
    scAjaxFieldRead("nos_nombre_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['nos_descripcion_'])) ? $this->nmgp_cmp_readonly['nos_descripcion_'] : 'off';
?>
    scAjaxFieldRead("nos_descripcion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['nos_ip_'])) ? $this->nmgp_cmp_readonly['nos_ip_'] : 'off';
?>
    scAjaxFieldRead("nos_ip_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['nos_ssoo_'])) ? $this->nmgp_cmp_readonly['nos_ssoo_'] : 'off';
?>
    scAjaxFieldRead("nos_ssoo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("nos_nombre_" + iSeq, "on");
    scAjaxFieldRead("nos_descripcion_" + iSeq, "on");
    scAjaxFieldRead("nos_ip_" + iSeq, "on");
    scAjaxFieldRead("nos_ssoo_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["nos_nombre_" + iRow] || "on" == ajax_error_count["nos_descripcion_" + iRow] || "on" == ajax_error_count["nos_ip_" + iRow] || "on" == ajax_error_count["nos_ssoo_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_nos_nombre_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_nos_descripcion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_nos_ip_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_nos_ssoo_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["nos_nombre_" + iRow] && "off" == ajax_error_count["nos_descripcion_" + iRow] && "off" == ajax_error_count["nos_ip_" + iRow] && "off" == ajax_error_count["nos_ssoo_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["nos_nombre_" + iRow] = "off";
        ajax_error_count["nos_descripcion_" + iRow] = "off";
        ajax_error_count["nos_ip_" + iRow] = "off";
        ajax_error_count["nos_ssoo_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_nos_nombre_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_nos_descripcion_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_nos_ip_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_nos_ssoo_" + iRow).removeClass("scFormErrorLine");
    }
  }
