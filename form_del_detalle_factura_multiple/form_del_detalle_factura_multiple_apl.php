<?php
//
class form_del_detalle_factura_multiple_apl
{
   ...
   var $form_vert_form_del_detalle_factura_multiple = array();
...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['df_factura_multiple_']))
          {
              $this->df_factura_multiple_ = $this->NM_ajax_info['param']['df_factura_multiple_'];
          }
      ...
      $this->sc_conv_var['df_factura_multiple'] = "df_factura_multiple_";
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_del_detalle_factura_multiple']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_del_detalle_factura_multiple']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_del_detalle_factura_multiple']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_del_detalle_factura_multiple']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_del_detalle_factura_multiple']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_del_detalle_factura_multiple']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_del_detalle_factura_multiple']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_del_detalle_factura_multiple']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (!isset($this->Igtech_RucEmpresa) && isset($this->igtech_rucempresa)) 
          {
              $this->Igtech_RucEmpresa = $this->igtech_rucempresa;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_del_detalle_factura_multiple']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_del_detalle_factura_multiple']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_del_detalle_factura_multiple']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_del_detalle_factura_multiple']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_del_detalle_factura_multiple']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_del_detalle_factura_multiple']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_del_detalle_factura_multiple']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_del_detalle_factura_multiple']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_del_detalle_factura_multiple']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_del_detalle_factura_multiple_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_del_detalle_factura_multiple']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_del_detalle_factura_multiple']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_del_detalle_factura_multiple'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_del_detalle_factura_multiple']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_del_detalle_factura_multiple']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_del_detalle_factura_multiple') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_del_detalle_factura_multiple']['label'] = "Agregar Producto";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_del_detalle_factura_multiple")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_del_detalle_factura_multiple']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_del_detalle_factura_multiple'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura_multiple']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura_multiple']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura_multiple']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura_multiple']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura_multiple']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura_multiple']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura_multiple']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura_multiple']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura_multiple']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_detalle_factura_multiple']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_del_detalle_factura_multiple'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_del_detalle_factura_multiple'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura_multiple']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura_multiple']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura_multiple']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura_multiple']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura_multiple']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura_multiple']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura_multiple']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura_multiple']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura_multiple']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura_multiple']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura_multiple']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura_multiple']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura_multiple']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field . "_"] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura_multiple']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura_multiple']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura_multiple']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field . "_"] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura_multiple']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura_multiple']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura_multiple']['exit'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_del_detalle_factura_multiple_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_del_detalle_factura_multiple_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_del_detalle_factura_multiple/form_del_detalle_factura_multiple_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_del_detalle_factura_multiple_erro.class.php"); 
      }
      $this->Erro      = new form_del_detalle_factura_multiple_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['opcao']))
         { 
             if ($this->df_id_ != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura_multiple']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura_multiple']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura_multiple']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['opc_ant'] : "";
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_del_detalle_factura_multiple']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_del_detalle_factura_multiple']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
   ...
   function loadFieldConfig()
   {
      ...
      //-- df_factura_multiple_
      $this->field_config['df_factura_multiple_']               = array();
      $this->field_config['df_factura_multiple_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['df_factura_multiple_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['df_factura_multiple_']['symbol_dec'] = '';
      $this->field_config['df_factura_multiple_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['df_factura_multiple_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['Gera_log_access'] = false;
      }
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['opc_edit'] = true;  
      ...
      if ($this->NM_ajax_flag && 'submit_form' == $this->NM_ajax_opcao)
      {
         ...
         if (isset($this->df_factura_multiple_)) { $this->nm_limpa_alfa($this->df_factura_multiple_); }
         ...
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['dados_form'][$sc_seq_vert]))
         {
             $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['dados_form'][$sc_seq_vert];
         ...
         if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "")
         {
             $this->NM_rollback_db();
              if ($this->NM_ajax_flag)
              {
                  if (!isset($this->NM_ajax_info['errList']['geral_form_del_detalle_factura_multiple']) || !is_array($this->NM_ajax_info['errList']['geral_form_del_detalle_factura_multiple']))
                  {
                      $this->NM_ajax_info['errList']['geral_form_del_detalle_factura_multiple'] = array();
                  }
                  if ($Campos_Crit != "")
                  {
                      $this->NM_ajax_info['errList']['geral_form_del_detalle_factura_multiple'][] = $Campos_Crit;
                  }
                  if (!empty($Campos_Falta))
                  {
                      $this->NM_ajax_info['errList']['geral_form_del_detalle_factura_multiple'][] = $this->Formata_Campos_Falta($Campos_Falta);
                  }
                  if ($this->Campos_Mens_erro != "")
                  {
                      $this->NM_ajax_info['errList']['geral_form_del_detalle_factura_multiple'][] = $this->Campos_Mens_erro;
                  }
              }
         }
         else
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['sc_redir_atualiz'] == "ok")
          {
      ...
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
         ...
         $Campos_Erros = array();
          ...
          if ('validate_df_factura_multiple_' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'df_factura_multiple_');
          }
      ...
      { 
         ...
         $this->df_factura_multiple_ = $GLOBALS["df_factura_multiple_" . $sc_seq_vert]; 
         ...
         if (isset($this->df_total_)) { $this->nm_limpa_alfa($this->df_total_); }
         if (isset($this->df_precio_sin_subsidio_)) { $this->nm_limpa_alfa($this->df_precio_sin_subsidio_); }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['dados_form'])) 
         {
            $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['dados_form'][$sc_seq_vert];
         }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['dados_select'])) 
         {
            $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['dados_select'][$sc_seq_vert];
         }
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['sc_disabled'] = array();
             $this->controle_form_vert(); 
             ...
             $this->form_vert_form_del_detalle_factura_multiple[$sc_seq_vert]['df_id_'] =  $this->df_id_; 
             $this->form_vert_form_del_detalle_factura_multiple[$sc_seq_vert]['df_producto_'] =  $this->df_producto_; 
             $this->form_vert_form_del_detalle_factura_multiple[$sc_seq_vert]['df_descripcion_'] =  $this->df_descripcion_; 
             $this->form_vert_form_del_detalle_factura_multiple[$sc_seq_vert]['df_cantidad_'] =  $this->df_cantidad_; 
             $this->form_vert_form_del_detalle_factura_multiple[$sc_seq_vert]['df_precio_unitario_'] =  $this->df_precio_unitario_; 
             $this->form_vert_form_del_detalle_factura_multiple[$sc_seq_vert]['df_descuento_'] =  $this->df_descuento_; 
             $this->form_vert_form_del_detalle_factura_multiple[$sc_seq_vert]['df_subtotal_'] =  $this->df_subtotal_; 
             $this->form_vert_form_del_detalle_factura_multiple[$sc_seq_vert]['df_base_iva_'] =  $this->df_base_iva_; 
             $this->form_vert_form_del_detalle_factura_multiple[$sc_seq_vert]['df_porcentaje_iva_'] =  $this->df_porcentaje_iva_; 
             $this->form_vert_form_del_detalle_factura_multiple[$sc_seq_vert]['df_valor_iva_'] =  $this->df_valor_iva_; 
             $this->form_vert_form_del_detalle_factura_multiple[$sc_seq_vert]['df_total_'] =  $this->df_total_; 
             $this->form_vert_form_del_detalle_factura_multiple[$sc_seq_vert]['df_base_ice_'] =  $this->df_base_ice_; 
             $this->form_vert_form_del_detalle_factura_multiple[$sc_seq_vert]['df_porcentaje_ice_'] =  $this->df_porcentaje_ice_; 
             $this->form_vert_form_del_detalle_factura_multiple[$sc_seq_vert]['df_valor_ice_'] =  $this->df_valor_ice_; 
             $this->form_vert_form_del_detalle_factura_multiple[$sc_seq_vert]['df_base_irbpnr_'] =  $this->df_base_irbpnr_; 
             $this->form_vert_form_del_detalle_factura_multiple[$sc_seq_vert]['df_porcentaje_irbpnr_'] =  $this->df_porcentaje_irbpnr_; 
             $this->form_vert_form_del_detalle_factura_multiple[$sc_seq_vert]['df_valor_irbpnr_'] =  $this->df_valor_irbpnr_; 
             $this->form_vert_form_del_detalle_factura_multiple[$sc_seq_vert]['df_factura_multiple_'] =  $this->df_factura_multiple_; 
             $this->form_vert_form_del_detalle_factura_multiple[$sc_seq_vert]['df_precio_sin_subsidio_'] =  $this->df_precio_sin_subsidio_; 
             $this->form_vert_form_del_detalle_factura_multiple[$sc_seq_vert]['df_empresa_'] =  $this->df_empresa_; 
             $this->form_vert_form_del_detalle_factura_multiple[$sc_seq_vert]['df_estado_'] =  $this->df_estado_; 
         }
         $sc_seq_vert++; 
      } 
      ...
      if ($this->NM_ajax_flag && 'table_refresh' == $this->NM_ajax_opcao)
      {
          ...
          $this->NM_ajax_info['rsSize'] = sizeof($this->form_vert_form_del_detalle_factura_multiple);
      ...
      {
          $this->nm_tira_formatacao();
          if ('event_df_base_ice__onchange' == $this->NM_ajax_opcao)
          {
              $this->df_base_ice__onChange();
          }
          if ('event_df_base_irbpnr__onchange' == $this->NM_ajax_opcao)
          {
              $this->df_base_irbpnr__onChange();
          }
          ...
          if ('event_df_valor_ice__onchange' == $this->NM_ajax_opcao)
          {
              $this->df_valor_ice__onChange();
          }
          if ('event_df_valor_irbpnr__onchange' == $this->NM_ajax_opcao)
          {
              $this->df_valor_irbpnr__onChange();
          }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
...
//
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_del_detalle_factura_multiple.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_del_detalle_factura_multiple_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_del_detalle_factura_multiple"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_del_detalle_factura_multiple', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sis_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'form_del_detalle_factura_multiple', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_del_detalle_factura_multiple', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
   ...
   function Recupera_Nome_Campo($campo) 
   {
       switch($campo)
       {
           ...
           case 'df_valor_irbpnr_':
               ...
               break;
           case 'df_factura_multiple_':
               return "Df Factura Multiple";
               break;
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              ...
              $this->NM_ajax_info['errList']['geral_form_del_detalle_factura_multiple'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'df_factura_multiple_' == $filtro)) || (is_array($filtro) && in_array('df_factura_multiple_', $filtro)))
        $this->ValidateField_df_factura_multiple_($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!isset($this->scFormFocusErrorName) || '' == $this->scFormFocusErrorName) && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "df_factura_multiple_";
   ...
   if (isset($this->Field_no_validate['df_producto_'])) {
      ...
      if ($this->df_producto_ == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['php_cmp_required']['df_producto_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['php_cmp_required']['df_producto_'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->df_producto_) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['Lookup_df_producto_']) && !in_array($this->df_producto_, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['Lookup_df_producto_']))
          {
              $hasError = true;
    ...
    function ValidateField_df_cantidad_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['php_cmp_required']['df_cantidad_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['php_cmp_required']['df_cantidad_'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_df_precio_unitario_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['php_cmp_required']['df_precio_unitario_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['php_cmp_required']['df_precio_unitario_'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_df_factura_multiple_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['df_factura_multiple_'])) {
          nm_limpa_numero($this->df_factura_multiple_, $this->field_config['df_factura_multiple_']['symbol_grp']) ; 
          return;
      }
      if ($this->df_factura_multiple_ === "" || is_null($this->df_factura_multiple_))  
      { 
          $this->df_factura_multiple_ = 0;
          $this->sc_force_zero[] = 'df_factura_multiple_';
      } 
      nm_limpa_numero($this->df_factura_multiple_, $this->field_config['df_factura_multiple_']['symbol_grp']) ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->df_factura_multiple_ != '')  
          { 
              $iTestSize = 9;
              if (strlen($this->df_factura_multiple_) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Df Factura Multiple: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['df_factura_multiple_']))
                  {
                      $Campos_Erros['df_factura_multiple_'] = array();
                  }
                  $Campos_Erros['df_factura_multiple_'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['df_factura_multiple_']) || !is_array($this->NM_ajax_info['errList']['df_factura_multiple_']))
                  {
                      $this->NM_ajax_info['errList']['df_factura_multiple_'] = array();
                  }
                  $this->NM_ajax_info['errList']['df_factura_multiple_'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->df_factura_multiple_, 9, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Df Factura Multiple; " ; 
                  if (!isset($Campos_Erros['df_factura_multiple_']))
                  {
                      $Campos_Erros['df_factura_multiple_'] = array();
                  }
                  $Campos_Erros['df_factura_multiple_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['df_factura_multiple_']) || !is_array($this->NM_ajax_info['errList']['df_factura_multiple_']))
                  {
                      $this->NM_ajax_info['errList']['df_factura_multiple_'] = array();
                  }
                  $this->NM_ajax_info['errList']['df_factura_multiple_'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'df_factura_multiple_';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_df_factura_multiple_
   ...
   function nm_guardar_campos()
   {
    ...
    $this->nmgp_dados_form['df_factura_multiple_'] = $this->df_factura_multiple_;
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['dados_form'][$sc_seq_vert] = $this->nmgp_dados_form;
   }
   function nm_tira_formatacao()
   {
      ...
      $this->Before_unformat['df_factura_multiple_'] = $this->df_factura_multiple_;
      nm_limpa_numero($this->df_factura_multiple_, $this->field_config['df_factura_multiple_']['symbol_grp']) ; 
   ...
   function nm_clear_val($Nome_Campo)
   {
      ...
      if ($Nome_Campo == "df_factura_multiple_")
      {
          nm_limpa_numero($this->df_factura_multiple_, $this->field_config['df_factura_multiple_']['symbol_grp']) ; 
      }
   ...
   function nm_formatar_campos($format_fields = array())
   {
      ...
      if ('' !== $this->df_factura_multiple_ || (!empty($format_fields) && isset($format_fields['df_factura_multiple_'])))
      {
          nmgp_Form_Num_Val($this->df_factura_multiple_, $this->field_config['df_factura_multiple_']['symbol_grp'], $this->field_config['df_factura_multiple_']['symbol_dec'], "0", "S", $this->field_config['df_factura_multiple_']['format_neg'], "", "", "-", $this->field_config['df_factura_multiple_']['symbol_fmt']) ; 
      }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['navStatus']['ret'] = $this->Nav_permite_ret ? 'S' : 'N';
              $this->NM_ajax_info['navStatus']['ava'] = $this->Nav_permite_ava ? 'S' : 'N';
              $this->NM_ajax_info['fldList']['df_id_']['keyVal'] = form_del_detalle_factura_multiple_pack_protect_string($this->nmgp_dados_form['df_id_']);
          }
   } // ajax_return_values
   function ajax_return_values_all_vert()
   {
          ...
          {
              $this->form_vert_form_del_detalle_factura_multiple[$this->nmgp_refresh_row] = $this->NM_ajax_info['param'];
              if ((isset($this->Embutida_ronly) && $this->Embutida_ronly) || $this->NM_ajax_force_values)
              {
                  ...
                  {
                      $this->form_vert_form_del_detalle_factura_multiple[$this->nmgp_refresh_row]['df_id_'] = $this->df_id_;
                  }
                  if (isset($this->NM_ajax_changed['df_producto_']) && $this->NM_ajax_changed['df_producto_'])
                  {
                      $this->form_vert_form_del_detalle_factura_multiple[$this->nmgp_refresh_row]['df_producto_'] = $this->df_producto_;
                  }
                  if (isset($this->NM_ajax_changed['df_descripcion_']) && $this->NM_ajax_changed['df_descripcion_'])
                  {
                      $this->form_vert_form_del_detalle_factura_multiple[$this->nmgp_refresh_row]['df_descripcion_'] = $this->df_descripcion_;
                  }
                  if (isset($this->NM_ajax_changed['df_cantidad_']) && $this->NM_ajax_changed['df_cantidad_'])
                  {
                      $this->form_vert_form_del_detalle_factura_multiple[$this->nmgp_refresh_row]['df_cantidad_'] = $this->df_cantidad_;
                  }
                  if (isset($this->NM_ajax_changed['df_precio_unitario_']) && $this->NM_ajax_changed['df_precio_unitario_'])
                  {
                      $this->form_vert_form_del_detalle_factura_multiple[$this->nmgp_refresh_row]['df_precio_unitario_'] = $this->df_precio_unitario_;
                  }
                  if (isset($this->NM_ajax_changed['df_descuento_']) && $this->NM_ajax_changed['df_descuento_'])
                  {
                      $this->form_vert_form_del_detalle_factura_multiple[$this->nmgp_refresh_row]['df_descuento_'] = $this->df_descuento_;
                  }
                  if (isset($this->NM_ajax_changed['df_subtotal_']) && $this->NM_ajax_changed['df_subtotal_'])
                  {
                      $this->form_vert_form_del_detalle_factura_multiple[$this->nmgp_refresh_row]['df_subtotal_'] = $this->df_subtotal_;
                  }
                  if (isset($this->NM_ajax_changed['df_base_iva_']) && $this->NM_ajax_changed['df_base_iva_'])
                  {
                      $this->form_vert_form_del_detalle_factura_multiple[$this->nmgp_refresh_row]['df_base_iva_'] = $this->df_base_iva_;
                  }
                  if (isset($this->NM_ajax_changed['df_porcentaje_iva_']) && $this->NM_ajax_changed['df_porcentaje_iva_'])
                  {
                      $this->form_vert_form_del_detalle_factura_multiple[$this->nmgp_refresh_row]['df_porcentaje_iva_'] = $this->df_porcentaje_iva_;
                  }
                  if (isset($this->NM_ajax_changed['df_valor_iva_']) && $this->NM_ajax_changed['df_valor_iva_'])
                  {
                      $this->form_vert_form_del_detalle_factura_multiple[$this->nmgp_refresh_row]['df_valor_iva_'] = $this->df_valor_iva_;
                  }
                  if (isset($this->NM_ajax_changed['df_total_']) && $this->NM_ajax_changed['df_total_'])
                  {
                      $this->form_vert_form_del_detalle_factura_multiple[$this->nmgp_refresh_row]['df_total_'] = $this->df_total_;
                  }
                  if (isset($this->NM_ajax_changed['df_base_ice_']) && $this->NM_ajax_changed['df_base_ice_'])
                  {
                      $this->form_vert_form_del_detalle_factura_multiple[$this->nmgp_refresh_row]['df_base_ice_'] = $this->df_base_ice_;
                  }
                  if (isset($this->NM_ajax_changed['df_porcentaje_ice_']) && $this->NM_ajax_changed['df_porcentaje_ice_'])
                  {
                      $this->form_vert_form_del_detalle_factura_multiple[$this->nmgp_refresh_row]['df_porcentaje_ice_'] = $this->df_porcentaje_ice_;
                  }
                  if (isset($this->NM_ajax_changed['df_valor_ice_']) && $this->NM_ajax_changed['df_valor_ice_'])
                  {
                      $this->form_vert_form_del_detalle_factura_multiple[$this->nmgp_refresh_row]['df_valor_ice_'] = $this->df_valor_ice_;
                  }
                  if (isset($this->NM_ajax_changed['df_base_irbpnr_']) && $this->NM_ajax_changed['df_base_irbpnr_'])
                  {
                      $this->form_vert_form_del_detalle_factura_multiple[$this->nmgp_refresh_row]['df_base_irbpnr_'] = $this->df_base_irbpnr_;
                  }
                  if (isset($this->NM_ajax_changed['df_porcentaje_irbpnr_']) && $this->NM_ajax_changed['df_porcentaje_irbpnr_'])
                  {
                      $this->form_vert_form_del_detalle_factura_multiple[$this->nmgp_refresh_row]['df_porcentaje_irbpnr_'] = $this->df_porcentaje_irbpnr_;
                  }
                  if (isset($this->NM_ajax_changed['df_valor_irbpnr_']) && $this->NM_ajax_changed['df_valor_irbpnr_'])
                  {
                      $this->form_vert_form_del_detalle_factura_multiple[$this->nmgp_refresh_row]['df_valor_irbpnr_'] = $this->df_valor_irbpnr_;
                  }
                  if (isset($this->NM_ajax_changed['df_factura_multiple_']) && $this->NM_ajax_changed['df_factura_multiple_'])
                  {
                      $this->form_vert_form_del_detalle_factura_multiple[$this->nmgp_refresh_row]['df_factura_multiple_'] = $this->df_factura_multiple_;
                  }
                  if (isset($this->NM_ajax_changed['df_precio_sin_subsidio_']) && $this->NM_ajax_changed['df_precio_sin_subsidio_'])
                  {
                      $this->form_vert_form_del_detalle_factura_multiple[$this->nmgp_refresh_row]['df_precio_sin_subsidio_'] = $this->df_precio_sin_subsidio_;
                  }
              }
          }
          ...
          foreach($this->form_vert_form_del_detalle_factura_multiple as $sc_seq_vert => $aRecData)
          {
...
$aLookup[] = array(form_del_detalle_factura_multiple_pack_protect_string('') => str_replace('<', '&lt;',form_del_detalle_factura_multiple_pack_protect_string('' . $this->Ini->Nm_lang['lang_seleccione'] . '')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['Lookup_df_producto_'][] = '';
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_del_detalle_factura_multiple_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_del_detalle_factura_multiple_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['df_producto_' . $sc_seq_vert]['valList'][$i] = form_del_detalle_factura_multiple_pack_protect_string($v);
          }
          ...
          $aLookupOrig = $aLookup;
              ...
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("df_factura_multiple_", $this->nmgp_refresh_fields)))
              {
                  $sTmpValue = NM_charset_to_utf8($aRecData['df_factura_multiple_']);
                  $aLookup = array();
          $aLookupOrig = $aLookup;
                  $this->NM_ajax_info['fldList']['df_factura_multiple_' . $sc_seq_vert] = array(
                       'row'    => $sc_seq_vert,
                       'type'    => 'text',
                       'valList' => array($sTmpValue),
                       );
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['Field_no_validate'] = array();
      $this->nm_guardar_campos();
   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar")
      {
          ...
          if ($this->nmgp_dados_select['df_id_'] == $this->df_id_ &&
              ...
              $this->nmgp_dados_select['df_factura_multiple_'] == $this->df_factura_multiple_ &&
              $this->nmgp_dados_select['df_precio_sin_subsidio_'] == $this->df_precio_sin_subsidio_)
          { }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['dados_select'][$sc_seq_vert]['df_id_'] = $this->df_id_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['dados_select'][$sc_seq_vert]['df_producto_'] = $this->df_producto_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['dados_select'][$sc_seq_vert]['df_descripcion_'] = $this->df_descripcion_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['dados_select'][$sc_seq_vert]['df_cantidad_'] = $this->df_cantidad_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['dados_select'][$sc_seq_vert]['df_precio_unitario_'] = $this->df_precio_unitario_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['dados_select'][$sc_seq_vert]['df_descuento_'] = $this->df_descuento_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['dados_select'][$sc_seq_vert]['df_subtotal_'] = $this->df_subtotal_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['dados_select'][$sc_seq_vert]['df_base_iva_'] = $this->df_base_iva_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['dados_select'][$sc_seq_vert]['df_porcentaje_iva_'] = $this->df_porcentaje_iva_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['dados_select'][$sc_seq_vert]['df_valor_iva_'] = $this->df_valor_iva_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['dados_select'][$sc_seq_vert]['df_total_'] = $this->df_total_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['dados_select'][$sc_seq_vert]['df_base_ice_'] = $this->df_base_ice_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['dados_select'][$sc_seq_vert]['df_porcentaje_ice_'] = $this->df_porcentaje_ice_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['dados_select'][$sc_seq_vert]['df_valor_ice_'] = $this->df_valor_ice_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['dados_select'][$sc_seq_vert]['df_base_irbpnr_'] = $this->df_base_irbpnr_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['dados_select'][$sc_seq_vert]['df_porcentaje_irbpnr_'] = $this->df_porcentaje_irbpnr_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['dados_select'][$sc_seq_vert]['df_valor_irbpnr_'] = $this->df_valor_irbpnr_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['dados_select'][$sc_seq_vert]['df_factura_multiple_'] = $this->df_factura_multiple_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['dados_select'][$sc_seq_vert]['df_precio_sin_subsidio_'] = $this->df_precio_sin_subsidio_;
          }
      }
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      ...
      $NM_val_form['df_factura_multiple_'] = $this->df_factura_multiple_;
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['df_factura_multiple_'])) { $this->df_factura_multiple_ = $NM_val_form['df_factura_multiple_']; }
              elseif (isset($this->df_factura_multiple_)) { $this->nm_limpa_alfa($this->df_factura_multiple_); }
              ...
              $this->nmgp_refresh_fields = array_diff(array('df_id_', 'df_producto_', 'df_descripcion_', 'df_cantidad_', 'df_precio_unitario_', 'df_descuento_', 'df_subtotal_', 'df_base_iva_', 'df_porcentaje_iva_', 'df_valor_iva_', 'df_total_', 'df_base_ice_', 'df_porcentaje_ice_', 'df_valor_ice_', 'df_base_irbpnr_', 'df_porcentaje_irbpnr_', 'df_valor_irbpnr_', 'df_factura_multiple_', 'df_precio_sin_subsidio_'), $aDoNotUpdate);
              $this->ajax_return_values();
              ...
              if (isset($this->Embutida_ronly) && $this->Embutida_ronly)
              {
                  ...
                  $this->NM_ajax_info['readOnly']['df_factura_multiple_' . $this->nmgp_refresh_row] = 'on';
      ...
      { 
          ...
          { 
              $NM_seq_auto = "NEXT VALUE FOR del_detalle_factura_multiple_df_id_seq, ";
              $NM_cmp_auto = "df_id, ";
          } 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          { 
              $NM_seq_auto = "del_detalle_factura_multiple_df_id_seq.NEXTVAL, ";
              $NM_cmp_auto = "df_id, ";
          } 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
          { 
              $NM_seq_auto = "nextval('del_detalle_factura_multiple_df_id_seq'), ";
              $NM_cmp_auto = "df_id, ";
          } 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $NM_seq_auto = "gen_id(del_detalle_factura_multiple_df_id_seq, 1), ";
              $NM_cmp_auto = "df_id, ";
          } 
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (df_factura_multiple, df_empresa, df_producto, df_descripcion, df_cantidad, df_precio_unitario, df_subtotal, df_descuento, df_base_iva, df_porcentaje_iva, df_valor_iva, df_base_ice, df_porcentaje_ice, df_valor_ice, df_base_irbpnr, df_porcentaje_irbpnr, df_valor_irbpnr, df_total, df_estado, df_precio_sin_subsidio) VALUES ($this->df_factura_multiple_, '$this->df_empresa_', '$this->df_producto_', '$this->df_descripcion_', $this->df_cantidad_, $this->df_precio_unitario_, $this->df_subtotal_, $this->df_descuento_, $this->df_base_iva_, $this->df_porcentaje_iva_, $this->df_valor_iva_, $this->df_base_ice_, '$this->df_porcentaje_ice_', $this->df_valor_ice_, $this->df_base_irbpnr_, '$this->df_porcentaje_irbpnr_', $this->df_valor_irbpnr_, $this->df_total_, '$this->df_estado_', $this->df_precio_sin_subsidio_)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "df_factura_multiple, df_empresa, df_producto, df_descripcion, df_cantidad, df_precio_unitario, df_subtotal, df_descuento, df_base_iva, df_porcentaje_iva, df_valor_iva, df_base_ice, df_porcentaje_ice, df_valor_ice, df_base_irbpnr, df_porcentaje_irbpnr, df_valor_irbpnr, df_total, df_estado, df_precio_sin_subsidio) VALUES (" . $NM_seq_auto . "$this->df_factura_multiple_, '$this->df_empresa_', '$this->df_producto_', '$this->df_descripcion_', $this->df_cantidad_, $this->df_precio_unitario_, $this->df_subtotal_, $this->df_descuento_, $this->df_base_iva_, $this->df_porcentaje_iva_, $this->df_valor_iva_, $this->df_base_ice_, '$this->df_porcentaje_ice_', $this->df_valor_ice_, $this->df_base_irbpnr_, '$this->df_porcentaje_irbpnr_', $this->df_valor_irbpnr_, $this->df_total_, '$this->df_estado_', $this->df_precio_sin_subsidio_)"; 
              }
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select del_detalle_factura_multiple_df_id_seq.currval from dual"; 
                  $rsy = $this->Db->Execute($_SESSION['scriptcase']['sc_sql_ult_comando']); 
                  if ($rsy === false && !$rsy->EOF)  
                  { 
                      $this->Erro->mensagem (__FILE__, __LINE__, "banco", $this->Ini->Nm_lang['lang_errm_dbas'], $this->Db->ErrorMsg()); 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_db2))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "values PREVVAL FOR del_detalle_factura_multiple_df_id_seq"; 
                  $rsy = $this->Db->Execute($_SESSION['scriptcase']['sc_sql_ult_comando']); 
                  if ($rsy === false && !$rsy->EOF)  
                  { 
                      $this->Erro->mensagem (__FILE__, __LINE__, "banco", $this->Ini->Nm_lang['lang_errm_dbas'], $this->Db->ErrorMsg()); 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select CURRVAL('del_detalle_factura_multiple_df_id_seq')"; 
                  $rsy = $this->Db->Execute($_SESSION['scriptcase']['sc_sql_ult_comando']); 
                  if ($rsy === false && !$rsy->EOF)  
                  { 
                      $this->Erro->mensagem (__FILE__, __LINE__, "banco", $this->Ini->Nm_lang['lang_errm_dbas'], $this->Db->ErrorMsg()); 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select gen_id(del_detalle_factura_multiple_df_id_seq, 0) from " . $this->Ini->nm_tabela; 
                  $rsy = $this->Db->Execute($_SESSION['scriptcase']['sc_sql_ult_comando']); 
                  if ($rsy === false && !$rsy->EOF)  
                  { 
                      $this->Erro->mensagem (__FILE__, __LINE__, "banco", $this->Ini->Nm_lang['lang_errm_dbas'], $this->Db->ErrorMsg()); 
              ...
              $this->NM_gera_log_new();
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['total']++; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['reg_qtd']++; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['reg_I_E']++; 
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              if (key($aValData) == form_del_detalle_factura_multiple_pack_protect_string(NM_charset_to_utf8($this->df_producto_)))
              {
          ...
          $tmpLabel_df_producto_ = $sLabelTemp;
                  ...
                  $this->NM_ajax_info['fldList']['df_factura_multiple_' . $this->nmgp_refresh_row]['type']    = 'text';
                  $this->NM_ajax_info['fldList']['df_factura_multiple_' . $this->nmgp_refresh_row]['valList'] = array($this->form_encode_input(NM_charset_to_utf8($this->df_factura_multiple_)));
                  $this->NM_ajax_info['fldList']['df_factura_multiple_' . $this->nmgp_refresh_row]['labList'] = array($this->form_encode_input(NM_charset_to_utf8($tmpLabel_df_factura_multiple_)));

                  if ((isset($this->Embutida_form) && $this->Embutida_form) && (!isset($this->Embutida_ronly) || !$this->Embutida_ronly))
                  {
                      if (!isset($this->NM_ajax_info['readOnly']['df_factura_multiple_' . $this->nmgp_refresh_row]))
                      {
                          $this->NM_ajax_info['readOnly']['df_factura_multiple_' . $this->nmgp_refresh_row] = "off";
                      }
                  }
                  elseif (isset($this->Embutida_ronly) && $this->Embutida_ronly)
                  {
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
    ...
    if ("insert" == $this->sc_evento && $this->nmgp_opcao != "nada") {
        ...
        $_SESSION['scriptcase']['form_del_detalle_factura_multiple']['contr_erro'] = 'on';
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    $original_df_factura_multiple_ = $this->df_factura_multiple_;
}
  $update_sql = "SELECT sp_del_actualiza_factura_multiple(".$this->df_factura_multiple_ .");";
...
$check_sql = "SELECT fac_subtotal,
				...
				WHERE fac_numero=".$this->df_factura_multiple_ .";";
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    if (($original_df_factura_multiple_ != $this->df_factura_multiple_ || (isset($bFlagRead_df_factura_multiple_) && $bFlagRead_df_factura_multiple_))&& isset($this->nmgp_refresh_row))
    {
        $this->NM_ajax_info['fldList']['df_factura_multiple_' . $this->nmgp_refresh_row]['type']    = 'text';
        $this->NM_ajax_info['fldList']['df_factura_multiple_' . $this->nmgp_refresh_row]['valList'] = array($this->df_factura_multiple_);
        $this->NM_ajax_changed['df_factura_multiple_'] = true;
    }
}
$_SESSION['scriptcase']['form_del_detalle_factura_multiple']['contr_erro'] = 'off'; 
    }
...
$_SESSION['scriptcase']['form_del_detalle_factura_multiple']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['parms'] = "df_id_?#?$this->df_id_?@?"; 
      }
...
//---------- 
   ...
   { 
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura_multiple']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura_multiple']['rows']))
      {
          $this->sc_max_reg = $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura_multiple']['rows'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura_multiple']['rows_ins']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura_multiple']['rows_ins']))
      {
          $this->sc_max_reg_incl = $_SESSION['scriptcase']['sc_apl_conf']['form_del_detalle_factura_multiple']['rows_ins'];
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_liga_qtd_reg']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_liga_qtd_reg'])
      {
          $this->sc_max_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_liga_qtd_reg'];
      }
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
      $this->form_vert_form_del_detalle_factura_multiple = array();
      if ($this->nmgp_opcao != "novo") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['parms'] = ""; 
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
      { 
          $GLOBALS["NM_ERRO_IBASE"] = 1;  
      ...
      {
          $this->nmgp_opcao = "avanca";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['reg_start'] -= $this->sc_max_reg;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['reg_start'] = 0;
      }
      if (isset($this->NM_where_filter))
      {
          $this->NM_where_filter = str_replace("@percent@", "%", $this->NM_where_filter);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['total']);
          }
      }
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['where_filter'] . ")";
          }
      }
      $sc_where = "";
      if ('' != $sc_where_filter)
      ...
      if ('total' != $this->form_paginacao)
      {
          if ($this->app_is_initializing || $this->sc_teve_excl || $this->sc_teve_incl || (isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['total']))
          {
              ...
              $qt_geral_reg_form_del_detalle_factura_multiple = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['total'] = $qt_geral_reg_form_del_detalle_factura_multiple;
              $rt->Close();
          }
      if ((isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['total']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['reg_I_E'] = 0; 
          ...
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->df_id_))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_del_detalle_factura_multiple = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['total'];
      } 
      if ($this->nmgp_opcao == "inicio" || $this->nmgp_opcao == "ordem") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['reg_start'] = 0; 
      } 
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_del_detalle_factura_multiple) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if ($this->nmgp_opcao == "avanca")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['reg_start'] += ($this->sc_max_reg + $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['reg_I_E']); 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['reg_start'] > $qt_geral_reg_form_del_detalle_factura_multiple)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['reg_start'] = $qt_geral_reg_form_del_detalle_factura_multiple - $this->sc_max_reg; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['reg_start'] = 0; 
              }
          }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['reg_start'] = ($qt_geral_reg_form_del_detalle_factura_multiple + 1) - $this->sc_max_reg; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['reg_start'] < 0)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['reg_start'] = 0; 
          }
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['ordem_cmp'] != $this->nmgp_ordem)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['ordem_cmp'] = $this->nmgp_ordem; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['ordem_ord'] = ' asc'; 
              switch ($this->nmgp_ordem) {
                  case "df_id":
                      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['ordem_ord'] = ' desc';
                      break;
                  case "df_cantidad":
                      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['ordem_ord'] = ' desc';
                      break;
          ...
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['ordem_ord'] == ' asc')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['ordem_ord'] = ' desc'; 
          }
          else
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['ordem_cmp'])) 
      { 
          $sc_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['ordem_cmp'] . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['ordem_ord']; 
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      { 
          $nmgp_select = "SELECT df_id, df_factura_multiple, df_empresa, df_producto, df_descripcion, df_cantidad, df_precio_unitario, df_subtotal, df_descuento, df_base_iva, df_porcentaje_iva, df_valor_iva, df_base_ice, df_porcentaje_ice, df_valor_ice, df_base_irbpnr, df_porcentaje_irbpnr, df_valor_irbpnr, df_total, df_estado, df_precio_sin_subsidio from " . $this->Ini->nm_tabela . $sc_where . $sc_order_by; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nmgp_select = "SELECT df_id, df_factura_multiple, df_empresa, df_producto, df_descripcion, df_cantidad, df_precio_unitario, df_subtotal, df_descuento, df_base_iva, df_porcentaje_iva, df_valor_iva, df_base_ice, df_porcentaje_ice, df_valor_ice, df_base_irbpnr, df_porcentaje_irbpnr, df_valor_irbpnr, df_total, df_estado, df_precio_sin_subsidio from " . $this->Ini->nm_tabela . $sc_where . $sc_order_by; 
      ...
      else
      {
          ...
          { 
              ...
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['reg_start'] . ")" ; 
                  $rs = $this->Db->SelectLimit($nmgp_select, $this->sc_max_reg, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['reg_start']) ; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['reg_start'] . ")" ; 
              ...
              { 
                  ...
                  if (!$rs === false && !$rs->EOF) 
                  { 
                      $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['reg_start']) ;  
                  } 
              } 
          } 
      }
          ...
          { 
              ...
              $this->df_factura_multiple_ = $rs->fields[1] ; 
              $this->nmgp_dados_select['df_factura_multiple_'] = $this->df_factura_multiple_;
              ...
              $this->df_precio_sin_subsidio_ = $rs->fields[20] ; 
              $this->nmgp_dados_select['df_precio_sin_subsidio_'] = $this->df_precio_sin_subsidio_;
              $GLOBALS["NM_ERRO_IBASE"] = 0; 
              $this->nm_troca_decimal(",", ".");
              $this->df_id_ = (string)$this->df_id_; 
              $this->df_factura_multiple_ = (string)$this->df_factura_multiple_; 
              ...
              if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['parms'])) 
              { 
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['parms'] = "df_id_?#?$this->df_id_?@?";
              } 
              $this->nm_proc_onload_record($sc_seq_vert);
...
//
//-- 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['dados_select'][$sc_seq_vert] = $this->nmgp_dados_select;
              $this->nm_guardar_campos();
              $this->nm_formatar_campos();
             $this->form_vert_form_del_detalle_factura_multiple[$sc_seq_vert]['df_id_'] =  $this->df_id_; 
             $this->form_vert_form_del_detalle_factura_multiple[$sc_seq_vert]['df_producto_'] =  $this->df_producto_; 
          ...
          ksort ($this->form_vert_form_del_detalle_factura_multiple); 
          $rs->Close(); 
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['reg_start'] < (($qt_geral_reg_form_del_detalle_factura_multiple + 1) - $this->sc_max_reg);
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['opcao'] = '';
          }
      } 
      if ($this->nmgp_opcao == "novo") 
      { 
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['embutida_multi']) 
          { 
          } 
          else 
          { 
...
// 
   ...
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['dados_select'][$sc_seq_vert] ))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['dados_select'][$sc_seq_vert] ;
           $this->SC_log_arr['fields']['df_factura_multiple']['0'] =  $nmgp_dados_select['df_factura_multiple_'];
...
// 
   ...
   {
       $this->SC_log_arr['fields']['df_factura_multiple']['1'] =  $this->df_factura_multiple_;
...
// 
   function NM_gera_log_output() 
   {
       ...
       $prim_delim = "";
       $Log_labels = array();
       $Log_labels['df_factura_multiple'] =  "Df Factura Multiple";
       ...
       $this->NM_gera_log_insert("Scriptcase", $this->SC_log_evt, $Log_output);
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['record_state'][$sc_seq_vert]['buttons'] = array(
                        'delete' => $this->nmgp_botoes['delete'],
                        'update' => $this->nmgp_botoes['update']
                );
        }
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }

//
function df_base_ice__onChange()
{
$_SESSION['scriptcase']['form_del_detalle_factura_multiple']['contr_erro'] = 'on';
...
if($this->df_producto_ <>''){
	...
	if($this->df_base_ice_ <>''and $this->df_base_ice_ <>0 and $var_porcentaje_ice<>0 ){
		 $this->df_valor_ice_ =$this->df_base_ice_ *$var_porcentaje_ice;
		 $this->df_base_iva_ =$this->df_subtotal_ +$this->df_valor_ice_ ;
		 $this->df_valor_iva_ =$this->df_base_iva_ *$var_porcentaje_iva/100;
	}else{
		 $this->df_base_ice_ =0;
		 $this->df_valor_ice_ =0;
...
$this->nm_formatar_campos('df_producto_', 'df_base_irbpnr_', 'df_porcentaje_irbpnr_', 'df_valor_irbpnr_', 'df_base_ice_', 'df_valor_ice_', 'df_base_iva_', 'df_subtotal_', 'df_valor_iva_', 'df_total_');
...
function df_base_irbpnr__onChange()
{
$_SESSION['scriptcase']['form_del_detalle_factura_multiple']['contr_erro'] = 'on';
if (!isset($this->sc_temp_Igtech_RucEmpresa)) {$this->sc_temp_Igtech_RucEmpresa = (isset($_SESSION['Igtech_RucEmpresa'])) ? $_SESSION['Igtech_RucEmpresa'] : "";}
...
if($this->df_producto_ <>''){
	...
	if($this->df_base_irbpnr_ <>''and $this->df_base_irbpnr_ <>0 and $var_porcentaje_irbpnr<>0){
		$this->df_valor_irbpnr_ =$this->df_base_irbpnr_ *$var_porcentaje_irbpnr;
	}else{
		$this->df_base_irbpnr_ =0;
		$this->df_valor_irbpnr_ =0;
	}
...
$modificado_df_valor_ice_ = $this->df_valor_ice_;
$modificado_df_valor_iva_ = $this->df_valor_iva_;
$this->nm_formatar_campos('df_producto_', 'df_base_irbpnr_', 'df_porcentaje_irbpnr_', 'df_valor_irbpnr_', 'df_total_', 'df_subtotal_', 'df_valor_ice_', 'df_valor_iva_');
$this->nmgp_refresh_fields = array();
if ($original_df_producto_ !== $modificado_df_producto_ || isset($this->nmgp_cmp_readonly['df_producto_']) || (isset($bFlagRead_df_producto_) && $bFlagRead_df_producto_))
{
    $this->nmgp_refresh_fields[] = 'df_producto_';
...
$modificado_df_valor_iva_ = $this->df_valor_iva_;
$modificado_df_total_ = $this->df_total_;
$this->nm_formatar_campos('df_producto_', 'df_precio_unitario_', 'df_valor_ice_', 'df_porcentaje_ice_', 'df_base_ice_', 'df_base_irbpnr_', 'df_porcentaje_irbpnr_', 'df_valor_irbpnr_', 'df_subtotal_', 'df_cantidad_', 'df_descuento_', 'df_base_iva_', 'df_valor_iva_', 'df_total_');
$this->nmgp_refresh_fields = array();
if ($original_df_producto_ !== $modificado_df_producto_ || isset($this->nmgp_cmp_readonly['df_producto_']) || (isset($bFlagRead_df_producto_) && $bFlagRead_df_producto_))
{
    $this->nmgp_refresh_fields[] = 'df_producto_';
...
function df_valor_ice__onChange()
{
$_SESSION['scriptcase']['form_del_detalle_factura_multiple']['contr_erro'] = 'on';
if (!isset($this->sc_temp_Igtech_RucEmpresa)) {$this->sc_temp_Igtech_RucEmpresa = (isset($_SESSION['Igtech_RucEmpresa'])) ? $_SESSION['Igtech_RucEmpresa'] : "";}
...
if($this->df_producto_ <>''){
	...
	if($this->df_valor_ice_ <>''and $this->df_valor_ice_ <>0){
		 $this->df_base_iva_ =$this->df_subtotal_ +$this->df_valor_ice_ ;
		 $this->df_valor_iva_ =$this->df_base_iva_ *$var_porcentaje_iva/100;
	}else{
		 $this->df_base_iva_ =$this->df_subtotal_ ;
...
$modificado_df_total_ = $this->df_total_;
$modificado_df_valor_irbpnr_ = $this->df_valor_irbpnr_;
$this->nm_formatar_campos('df_producto_', 'df_valor_ice_', 'df_porcentaje_ice_', 'df_base_ice_', 'df_base_iva_', 'df_subtotal_', 'df_valor_iva_', 'df_total_', 'df_valor_irbpnr_');
$this->nmgp_refresh_fields = array();
if ($original_df_producto_ !== $modificado_df_producto_ || isset($this->nmgp_cmp_readonly['df_producto_']) || (isset($bFlagRead_df_producto_) && $bFlagRead_df_producto_))
{
    $this->nmgp_refresh_fields[] = 'df_producto_';
...
function df_valor_irbpnr__onChange()
{
$_SESSION['scriptcase']['form_del_detalle_factura_multiple']['contr_erro'] = 'on';
...
$modificado_df_valor_iva_ = $this->df_valor_iva_;
$modificado_df_valor_irbpnr_ = $this->df_valor_irbpnr_;
$this->nm_formatar_campos('df_total_', 'df_subtotal_', 'df_valor_ice_', 'df_valor_iva_', 'df_valor_irbpnr_');
$this->nmgp_refresh_fields = array();
if ($original_df_total_ !== $modificado_df_total_ || isset($this->nmgp_cmp_readonly['df_total_']) || (isset($bFlagRead_df_total_) && $bFlagRead_df_total_))
{
    $this->nmgp_refresh_fields[] = 'df_total_';
...
if($this->df_producto_ <>''){
	...
	if($var_porcentaje_irbpnr<>0){
		 $this->df_base_irbpnr_ = $this->df_cantidad_ ;
	     $this->df_valor_irbpnr_ =$this->df_base_irbpnr_ *$var_porcentaje_irbpnr;
	}else{
		 $this->df_valor_irbpnr_ =0;
	}
...
if($this->df_producto_ <>''){
	...
	if (isset($this->rs[0][0])){
		...
		$var_porcentaje_irbpnr=$this->rs[0][7];
		if($this->rs[0][8]=='S'){
			$this->df_precio_sin_subsidio_ =$this->rs[0][9];
		}else{
			$this->df_precio_sin_subsidio_ =0;
		}
	}
	...
	if( $var_porcentaje_irbpnr<>0){
		 $this->df_base_irbpnr_ =$this->df_cantidad_ ;
	     $this->df_valor_irbpnr_ =round($this->df_base_irbpnr_ *$var_porcentaje_irbpnr,2);
	}else{
		 $this->df_valor_irbpnr_ =0;
	}
	$this->df_total_ =$this->df_subtotal_ +$this->df_valor_ice_ +$this->df_valor_iva_ +$this->df_valor_irbpnr_ ;
...
$modificado_df_valor_iva_ = $this->df_valor_iva_;
$modificado_df_total_ = $this->df_total_;
$this->nm_formatar_campos('df_producto_', 'df_precio_unitario_', 'df_descuento_', 'df_porcentaje_iva_', 'df_porcentaje_ice_', 'df_porcentaje_irbpnr_', 'df_precio_sin_subsidio_', 'df_subtotal_', 'df_cantidad_', 'df_valor_ice_', 'df_base_ice_', 'df_base_irbpnr_', 'df_valor_irbpnr_', 'df_base_iva_', 'df_valor_iva_', 'df_total_');
$this->nmgp_refresh_fields = array();
if ($original_df_producto_ !== $modificado_df_producto_ || isset($this->nmgp_cmp_readonly['df_producto_']) || (isset($bFlagRead_df_producto_) && $bFlagRead_df_producto_))
{
    $this->nmgp_refresh_fields[] = 'df_producto_';
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
   ...
   {
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['table_refresh'] = true;
   ...
   else
   {
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_del_detalle_factura_multiple = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['total'] = $qt_geral_reg_form_del_detalle_factura_multiple;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_del_detalle_factura_multiple_pack_ajax_response();
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_del_detalle_factura_multiple_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_del_detalle_factura_multiple_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['masterValue']))
{
...
<?php
  exit;
    ...
    function sc_master_value($sIndex, $sValue)
    {
        ...
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['masterValue'] = $this->NM_ajax_info['masterValue'];
    } // sc_master_value
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple']['ordem_ord'] == " desc") {
