  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_cargar_contratos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_cargar_contratos_form();
	}
...
?>
  ...
  // ---------- Validate plantilla
  function do_ajax_control_cargar_contratos_validate_plantilla()
  {
  } // do_ajax_control_cargar_contratos_validate_plantilla

  function do_ajax_control_cargar_contratos_validate_plantilla_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_cargar_contratos_validate_plantilla_cb

  // ---------- Validate archivo
  function do_ajax_control_cargar_contratos_validate_archivo()
  {
    var nomeCampo_archivo = "archivo";
    var var_archivo = scAjaxGetFieldText(nomeCampo_archivo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_cargar_contratos_validate_archivo(var_archivo, var_script_case_init, do_ajax_control_cargar_contratos_validate_archivo_cb);
  } // do_ajax_control_cargar_contratos_validate_archivo

  function do_ajax_control_cargar_contratos_validate_archivo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "archivo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_cargar_contratos_validate_archivo_cb

  // ---------- Validate ubicacion
  function do_ajax_control_cargar_contratos_validate_ubicacion()
  {
    var nomeCampo_ubicacion = "ubicacion";
    var var_ubicacion = scAjaxGetFieldText(nomeCampo_ubicacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_cargar_contratos_validate_ubicacion(var_ubicacion, var_script_case_init, do_ajax_control_cargar_contratos_validate_ubicacion_cb);
  } // do_ajax_control_cargar_contratos_validate_ubicacion

  function do_ajax_control_cargar_contratos_validate_ubicacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_cargar_contratos_validate_ubicacion_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_control_cargar_contratos_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_cargar_contratos_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_control_cargar_contratos_submit_form(var_plantilla, var_archivo, var_ubicacion, var_archivo_ul_name, var_archivo_ul_type, var_archivo_salva, var_archivo_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_cargar_contratos_submit_form_cb);
  } // do_ajax_control_cargar_contratos_submit_form

  function do_ajax_control_cargar_contratos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_cargar_contratos_submit_form_cb_after_alert);
  } // do_ajax_control_cargar_contratos_submit_form_cb
  function do_ajax_control_cargar_contratos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_cargar_contratos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_cargar_contratos_navigate_form()
  {
    perform_ajax_control_cargar_contratos_navigate_form();
  }

  function perform_ajax_control_cargar_contratos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_cargar_contratos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_cargar_contratos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_cargar_contratos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_cargar_contratos_navigate_form_cb_after_alert);
  } // do_ajax_control_cargar_contratos_navigate_form_cb
  function do_ajax_control_cargar_contratos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_cargar_contratos_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_cargar_contratos_navigate_form_cb_after_alert

  function sc_hide_control_cargar_contratos_form()
  {
