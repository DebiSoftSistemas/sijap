  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_forma_pago_pedido_wp" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_forma_pago_pedido_wp_form();
	}
...
?>
  ...
  // ---------- Validate fp_id_
  function do_ajax_form_del_forma_pago_pedido_wp_validate_fp_id_(iNumLinha)
  {
    var nomeCampo_fp_id_ = "fp_id_" + iNumLinha;
    var var_fp_id_ = scAjaxGetFieldHidden(nomeCampo_fp_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_pedido_wp_validate_fp_id_(var_fp_id_, iNumLinha, var_script_case_init, do_ajax_form_del_forma_pago_pedido_wp_validate_fp_id__cb);
  } // do_ajax_form_del_forma_pago_pedido_wp_validate_fp_id_

  function do_ajax_form_del_forma_pago_pedido_wp_validate_fp_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_pedido_wp_validate_fp_id__cb

  // ---------- Validate fp_forma_pago_
  function do_ajax_form_del_forma_pago_pedido_wp_validate_fp_forma_pago_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_pedido_wp_validate_fp_forma_pago_(var_fp_forma_pago_, iNumLinha, var_script_case_init, do_ajax_form_del_forma_pago_pedido_wp_validate_fp_forma_pago__cb);
  } // do_ajax_form_del_forma_pago_pedido_wp_validate_fp_forma_pago_

  function do_ajax_form_del_forma_pago_pedido_wp_validate_fp_forma_pago__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_pedido_wp_validate_fp_forma_pago__cb

  // ---------- Validate fp_valor_
  function do_ajax_form_del_forma_pago_pedido_wp_validate_fp_valor_(iNumLinha)
  {
    var nomeCampo_fp_valor_ = "fp_valor_" + iNumLinha;
    var var_fp_valor_ = scAjaxGetFieldText(nomeCampo_fp_valor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_pedido_wp_validate_fp_valor_(var_fp_valor_, iNumLinha, var_script_case_init, do_ajax_form_del_forma_pago_pedido_wp_validate_fp_valor__cb);
  } // do_ajax_form_del_forma_pago_pedido_wp_validate_fp_valor_

  function do_ajax_form_del_forma_pago_pedido_wp_validate_fp_valor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_pedido_wp_validate_fp_valor__cb

  // ---------- Validate fp_plazo_
  function do_ajax_form_del_forma_pago_pedido_wp_validate_fp_plazo_(iNumLinha)
  {
    var nomeCampo_fp_plazo_ = "fp_plazo_" + iNumLinha;
    var var_fp_plazo_ = scAjaxGetFieldText(nomeCampo_fp_plazo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_pedido_wp_validate_fp_plazo_(var_fp_plazo_, iNumLinha, var_script_case_init, do_ajax_form_del_forma_pago_pedido_wp_validate_fp_plazo__cb);
  } // do_ajax_form_del_forma_pago_pedido_wp_validate_fp_plazo_

  function do_ajax_form_del_forma_pago_pedido_wp_validate_fp_plazo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_pedido_wp_validate_fp_plazo__cb

  // ---------- Validate fp_unidad_tiempo_
  function do_ajax_form_del_forma_pago_pedido_wp_validate_fp_unidad_tiempo_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_pedido_wp_validate_fp_unidad_tiempo_(var_fp_unidad_tiempo_, iNumLinha, var_script_case_init, do_ajax_form_del_forma_pago_pedido_wp_validate_fp_unidad_tiempo__cb);
  } // do_ajax_form_del_forma_pago_pedido_wp_validate_fp_unidad_tiempo_

  function do_ajax_form_del_forma_pago_pedido_wp_validate_fp_unidad_tiempo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_pedido_wp_validate_fp_unidad_tiempo__cb

  // ---------- Validate fp_lote_
  function do_ajax_form_del_forma_pago_pedido_wp_validate_fp_lote_(iNumLinha)
  {
    var nomeCampo_fp_lote_ = "fp_lote_" + iNumLinha;
    var var_fp_lote_ = scAjaxGetFieldText(nomeCampo_fp_lote_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_pedido_wp_validate_fp_lote_(var_fp_lote_, iNumLinha, var_script_case_init, do_ajax_form_del_forma_pago_pedido_wp_validate_fp_lote__cb);
  } // do_ajax_form_del_forma_pago_pedido_wp_validate_fp_lote_

  function do_ajax_form_del_forma_pago_pedido_wp_validate_fp_lote__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fp_lote_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fp_lote_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fp_lote_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fp_lote_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_pedido_wp_validate_fp_lote__cb

  // ---------- Validate fp_transaccion_
  function do_ajax_form_del_forma_pago_pedido_wp_validate_fp_transaccion_(iNumLinha)
  {
    var nomeCampo_fp_transaccion_ = "fp_transaccion_" + iNumLinha;
    var var_fp_transaccion_ = scAjaxGetFieldText(nomeCampo_fp_transaccion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_pedido_wp_validate_fp_transaccion_(var_fp_transaccion_, iNumLinha, var_script_case_init, do_ajax_form_del_forma_pago_pedido_wp_validate_fp_transaccion__cb);
  } // do_ajax_form_del_forma_pago_pedido_wp_validate_fp_transaccion_

  function do_ajax_form_del_forma_pago_pedido_wp_validate_fp_transaccion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fp_transaccion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fp_transaccion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fp_transaccion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fp_transaccion_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_pedido_wp_validate_fp_transaccion__cb

  // ---------- Event onfocus fp_forma_pago_
  function do_ajax_form_del_forma_pago_pedido_wp_event_fp_forma_pago__onfocus(iSeqForm)
  {
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn();
    x_ajax_form_del_forma_pago_pedido_wp_event_fp_forma_pago__onfocus(var_script_case_init, var_nmgp_refresh_row, do_ajax_form_del_forma_pago_pedido_wp_event_fp_forma_pago__onfocus_cb);
  } // do_ajax_form_del_forma_pago_pedido_wp_event_fp_forma_pago__onfocus

  function do_ajax_form_del_forma_pago_pedido_wp_event_fp_forma_pago__onfocus_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_forma_pago_pedido_wp_event_fp_forma_pago__onfocus_cb_after_alert);
  } // do_ajax_form_del_forma_pago_pedido_wp_event_fp_forma_pago__onfocus_cb
  function do_ajax_form_del_forma_pago_pedido_wp_event_fp_forma_pago__onfocus_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_forma_pago_pedido_wp_event_fp_forma_pago__onfocus_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_del_forma_pago_pedido_wp_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_del_forma_pago_pedido_wp_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_forma_pago_pedido_wp_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_del_forma_pago_pedido_wp_add_new_line_cb);
  } // do_ajax_form_del_forma_pago_pedido_wp_add_new_line

  function do_ajax_form_del_forma_pago_pedido_wp_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
...
?>
  } // do_ajax_form_del_forma_pago_pedido_wp_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_del_forma_pago_pedido_wp_backup_line(iNumLinha)
  {
    var var_fp_id_ = scAjaxGetFieldHidden("fp_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_pedido_wp_backup_line(var_fp_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_del_forma_pago_pedido_wp_backup_line_cb);
  } // do_ajax_form_del_forma_pago_pedido_wp_backup_line

  function do_ajax_form_del_forma_pago_pedido_wp_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_del_forma_pago_pedido_wp_backup_line_cb

  function do_ajax_form_del_forma_pago_pedido_wp_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_del_forma_pago_pedido_wp_cancel_insert

  function do_ajax_form_del_forma_pago_pedido_wp_cancel_update(iSeqVert)
  {
    do_ajax_form_del_forma_pago_pedido_wp_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_del_forma_pago_pedido_wp_cancel_update

  function do_ajax_form_del_forma_pago_pedido_wp_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_del_forma_pago_pedido_wp_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_del_forma_pago_pedido_wp_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_forma_pago_pedido_wp_table_refresh(var_fp_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_forma_pago_pedido_wp_table_refresh_cb);
  } //  do_ajax_form_del_forma_pago_pedido_wp_table_refresh

  function do_ajax_form_del_forma_pago_pedido_wp_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_del_forma_pago_pedido_wp_table_refresh_cb_after_alert);
  } // do_ajax_form_del_forma_pago_pedido_wp_table_refresh_cb
  function do_ajax_form_del_forma_pago_pedido_wp_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("b");
    sc_insert_open = false;
  } // do_ajax_form_del_forma_pago_pedido_wp_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_del_forma_pago_pedido_wp_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_del_forma_pago_pedido_wp_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_fp_lote_ = scAjaxGetFieldText("fp_lote_" + iNumLinha);
    var var_fp_transaccion_ = scAjaxGetFieldText("fp_transaccion_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_del_forma_pago_pedido_wp_submit_form(var_fp_id_, var_fp_forma_pago_, var_fp_valor_, var_fp_plazo_, var_fp_unidad_tiempo_, var_fp_lote_, var_fp_transaccion_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_forma_pago_pedido_wp_submit_form_cb);
  } // do_ajax_form_del_forma_pago_pedido_wp_submit_form

  function do_ajax_form_del_forma_pago_pedido_wp_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("fp_lote_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("fp_transaccion_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_forma_pago_pedido_wp_submit_form_cb_after_alert);
  } // do_ajax_form_del_forma_pago_pedido_wp_submit_form_cb
  function do_ajax_form_del_forma_pago_pedido_wp_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_forma_pago_pedido_wp_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_forma_pago_pedido_wp_navigate_form()
  {
    perform_ajax_form_del_forma_pago_pedido_wp_navigate_form();
  }

  function perform_ajax_form_del_forma_pago_pedido_wp_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_del_forma_pago_pedido_wp_cancel_insert(sc_form_del_forma_pago_pedido_wp_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("fp_lote_" + iNavForm);
      scAjaxHideErrorDisplay("fp_transaccion_" + iNavForm);
    }
    var var_fp_id_ = document.F2.fp_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_forma_pago_pedido_wp_navigate_form(var_fp_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_forma_pago_pedido_wp_navigate_form_cb);
  } // do_ajax_form_del_forma_pago_pedido_wp_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_forma_pago_pedido_wp']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_forma_pago_pedido_wp_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_forma_pago_pedido_wp_navigate_form_cb_after_alert);
  } // do_ajax_form_del_forma_pago_pedido_wp_navigate_form_cb
  function do_ajax_form_del_forma_pago_pedido_wp_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_del_forma_pago_pedido_wp_navigate_form_cb_after_alert

    function sc_form_del_forma_pago_pedido_wp_get_last_line_number()
    {
    ...
    } //sc_form_del_forma_pago_pedido_wp_get_last_line_number

  function sc_hide_form_del_forma_pago_pedido_wp_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fp_lote_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fp_transaccion_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["fp_lote_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_lot_lote'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["fp_transaccion_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_numero_transaccion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["fp_lote_"][iNumLinha] = "fp_lote_" + iNumLinha;
    ajax_field_mult["fp_transaccion_"][iNumLinha] = "fp_transaccion_" + iNumLinha;
    ...
    ajax_field_id["fp_lote_" + iNumLinha] = new Array("hidden_field_label_fp_lote_", "hidden_field_data_fp_lote_" + iNumLinha);
    ajax_field_id["fp_transaccion_" + iNumLinha] = new Array("hidden_field_label_fp_transaccion_", "hidden_field_data_fp_transaccion_" + iNumLinha);
    ...
    ajax_error_count["fp_lote_" + iNumLinha] = "off";
    ajax_error_count["fp_transaccion_" + iNumLinha] = "off";
<?php
...
?>
    ...
    ajax_read_only["fp_lote_" + iNumLinha] = "off";
    ajax_read_only["fp_transaccion_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["fp_lote_" + iNumLinha] = "on";
    ajax_read_only["fp_transaccion_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["fp_lote_" + iNumLinha] = null;
    ajax_error_list["fp_transaccion_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["fp_lote_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fp_lote_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fp_lote_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fp_lote_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fp_lote_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["fp_transaccion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fp_transaccion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fp_transaccion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fp_transaccion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fp_transaccion_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
    ...
    mdOpenObjects(iSeq);
    Obj_Focus = eval("document.getElementById('id_sc_field_fp_forma_pago_" + iSeq + "')");
    if (Obj_Focus)
    {
        Obj_Focus.focus();
    }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fp_lote_'])) ? $this->nmgp_cmp_readonly['fp_lote_'] : 'off';
?>
    scAjaxFieldRead("fp_lote_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fp_transaccion_'])) ? $this->nmgp_cmp_readonly['fp_transaccion_'] : 'off';
?>
    scAjaxFieldRead("fp_transaccion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("fp_lote_" + iSeq, "on");
    scAjaxFieldRead("fp_transaccion_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["fp_id_" + iRow] || "on" == ajax_error_count["fp_forma_pago_" + iRow] || "on" == ajax_error_count["fp_valor_" + iRow] || "on" == ajax_error_count["fp_plazo_" + iRow] || "on" == ajax_error_count["fp_unidad_tiempo_" + iRow] || "on" == ajax_error_count["fp_lote_" + iRow] || "on" == ajax_error_count["fp_transaccion_" + iRow]))
    {
      ...
      $("#hidden_field_data_fp_lote_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_fp_transaccion_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["fp_id_" + iRow] && "off" == ajax_error_count["fp_forma_pago_" + iRow] && "off" == ajax_error_count["fp_valor_" + iRow] && "off" == ajax_error_count["fp_plazo_" + iRow] && "off" == ajax_error_count["fp_unidad_tiempo_" + iRow] && "off" == ajax_error_count["fp_lote_" + iRow] && "off" == ajax_error_count["fp_transaccion_" + iRow]))
    {
      if (bErrorRow)
      {
        ...
        ajax_error_count["fp_lote_" + iRow] = "off";
        ajax_error_count["fp_transaccion_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_fp_lote_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_fp_transaccion_" + iRow).removeClass("scFormErrorLine");
    }
  }
