<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_sis_solicitud_firma']['glo_nm_path_imag_temp'] . "/sc_apl_default_debi_doc_electronicos.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_sis_solicitud_firma_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_sis_solicitud_firma_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_sis_solicitud_firma']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_sis_solicitud_firma']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['sf_comisionista'] = "on";
   $tab_def_campos['sf_comisionista'] = "sf_comisionista";
   $tab_labels["sf_comisionista"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sis_solicitud_firma']['labels']["sf_comisionista"])) ? $_SESSION['sc_session'][$sc_init]['grid_sis_solicitud_firma']['labels']["sf_comisionista"] : "" . $this->Nm_lang['lang_comisionistas'] . "";
   $tab_ger_campos['sf_tipo_firma'] = "on";
   $tab_def_campos['sf_tipo_firma'] = "sf_tipo_firma";
   $tab_labels["sf_tipo_firma"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sis_solicitud_firma']['labels']["sf_tipo_firma"])) ? $_SESSION['sc_session'][$sc_init]['grid_sis_solicitud_firma']['labels']["sf_tipo_firma"] : "" . $this->Nm_lang['lang_tipo_firma'] . "";
   $tab_ger_campos['sf_duracion'] = "on";
   $tab_def_campos['sf_duracion'] = "sf_duracion";
   $tab_labels["sf_duracion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sis_solicitud_firma']['labels']["sf_duracion"])) ? $_SESSION['sc_session'][$sc_init]['grid_sis_solicitud_firma']['labels']["sf_duracion"] : "" . $this->Nm_lang['lang_duracion_firma'] . "";
   $tab_ger_campos['sf_identificacion'] = "on";
   $tab_def_campos['sf_identificacion'] = "sf_identificacion";
   $tab_labels["sf_identificacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sis_solicitud_firma']['labels']["sf_identificacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_sis_solicitud_firma']['labels']["sf_identificacion"] : "" . $this->Nm_lang['lang_lot_identificacion'] . "";
   $tab_ger_campos['sf_nombre'] = "on";
   $tab_def_campos['sf_nombre'] = "sf_nombre";
   $tab_labels["sf_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sis_solicitud_firma']['labels']["sf_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_sis_solicitud_firma']['labels']["sf_nombre"] : "" . $this->Nm_lang['lang_nombre'] . "";
   $tab_ger_campos['sf_direcccion'] = "on";
   $tab_def_campos['sf_direcccion'] = "sf_direcccion";
   $tab_labels["sf_direcccion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sis_solicitud_firma']['labels']["sf_direcccion"])) ? $_SESSION['sc_session'][$sc_init]['grid_sis_solicitud_firma']['labels']["sf_direcccion"] : "" . $this->Nm_lang['lang_direccion'] . "";
   $tab_ger_campos['sf_telefono'] = "on";
   $tab_def_campos['sf_telefono'] = "sf_telefono";
   $tab_labels["sf_telefono"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sis_solicitud_firma']['labels']["sf_telefono"])) ? $_SESSION['sc_session'][$sc_init]['grid_sis_solicitud_firma']['labels']["sf_telefono"] : "" . $this->Nm_lang['lang_lot_telefono'] . "";
   $tab_ger_campos['sf_email'] = "on";
   $tab_def_campos['sf_email'] = "sf_email";
   $tab_labels["sf_email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sis_solicitud_firma']['labels']["sf_email"])) ? $_SESSION['sc_session'][$sc_init]['grid_sis_solicitud_firma']['labels']["sf_email"] : "" . $this->Nm_lang['lang_email'] . "";
   $tab_ger_campos['sf_estado'] = "on";
   $tab_def_campos['sf_estado'] = "sf_estado";
   $tab_labels["sf_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sis_solicitud_firma']['labels']["sf_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_sis_solicitud_firma']['labels']["sf_estado"] : "" . $this->Nm_lang['lang_estado'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_sis_solicitud_firma']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_sis_solicitud_firma']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_sis_solicitud_firma']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_sis_solicitud_firma']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_sis_solicitud_firma']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_sis_solicitud_firma']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_sis_solicitud_firma']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_sis_solicitud_firma']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_sis_solicitud_firma']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_sis_solicitud_firma']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_sis_solicitud_firma']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_sis_solicitud_firma']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> sis_solicitud_firma</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_sis_solicitud_firma_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_sis_solicitud_firma']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_sis_solicitud_firma']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_sis_solicitud_firma']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_sis_solicitud_firma']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_sis_solicitud_firma']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
