...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_sis_solicitud_firma"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_sis_solicitud_firma"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_sis_solicitud_firma'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_sis_solicitud_firma']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_sis_solicitud_firma']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_sis_solicitud_firma']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_sis_solicitud_firma']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_sis_solicitud_firma']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_sis_solicitud_firma</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_sis_solicitud_firma']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_sis_solicitud_firma']['embutida_filho'] as $ind => $sc_init)
          {
