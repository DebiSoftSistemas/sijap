...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "esc_fecha";$Nm_datas[] = "fac_fecha";$Nm_numeric[] = "esc_tipo_deuda";$Nm_numeric[] = "esc_anio_periodo";$Nm_numeric[] = "des_ruta";$Nm_numeric[] = "con_propietario";$Nm_numeric[] = "des_contrato";$Nm_numeric[] = "con_tipo_servicio";$Nm_numeric[] = "con_condicion_contrato";$Nm_numeric[] = "des_lectura_anterior";$Nm_numeric[] = "des_lectura_actual";$Nm_numeric[] = "des_consumo";$Nm_numeric[] = "des_consumo_base";$Nm_numeric[] = "des_consumo_excedente";$Nm_numeric[] = "des_total";$Nm_numeric[] = "des_operacion";$Nm_numeric[] = "esc_id";$Nm_numeric[] = "des_id";
...
?>
   <span id="idAjaxSelect_des_ruta">
      <SELECT class="scFilterObjectEven" id="SC_des_ruta" name="des_ruta[]"  size="7" multiple>
<?php
...
?>
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "des_ruta" : return ('class="scFilterObjectEven"'); break;
         default       : return ("");
      }
   }
