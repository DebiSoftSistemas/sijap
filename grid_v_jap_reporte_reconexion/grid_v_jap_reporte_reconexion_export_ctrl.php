<?php
@session_start() ;
$_SESSION['scriptcase']['grid_v_jap_reporte_reconexion']['sc_process_barr'] = true;
require_once('../grid_v_jap_reporte_reconexion/index.php');
unset($_SESSION['scriptcase']['grid_v_jap_reporte_reconexion']['sc_process_barr']);
$ExportCtrl = new grid_v_jap_reporte_reconexion_export_control;
$ExportCtrl->Export_barr();

class grid_v_jap_reporte_reconexion_export_control
{
