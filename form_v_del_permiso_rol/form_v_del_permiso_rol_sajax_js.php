  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_v_del_permiso_rol" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_v_del_permiso_rol_form();
	}
...
?>
  ...
  // ---------- Validate per_rol_
  function do_ajax_form_v_del_permiso_rol_validate_per_rol_(iNumLinha)
  {
    var nomeCampo_per_rol_ = "per_rol_" + iNumLinha;
    var var_per_rol_ = scAjaxGetFieldText(nomeCampo_per_rol_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_v_del_permiso_rol_validate_per_rol_(var_per_rol_, iNumLinha, var_script_case_init, do_ajax_form_v_del_permiso_rol_validate_per_rol__cb);
  } // do_ajax_form_v_del_permiso_rol_validate_per_rol_

  function do_ajax_form_v_del_permiso_rol_validate_per_rol__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_v_del_permiso_rol_validate_per_rol__cb

  // ---------- Validate mm_id_
  function do_ajax_form_v_del_permiso_rol_validate_mm_id_(iNumLinha)
  {
    var nomeCampo_mm_id_ = "mm_id_" + iNumLinha;
    var var_mm_id_ = scAjaxGetFieldText(nomeCampo_mm_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_v_del_permiso_rol_validate_mm_id_(var_mm_id_, iNumLinha, var_script_case_init, do_ajax_form_v_del_permiso_rol_validate_mm_id__cb);
  } // do_ajax_form_v_del_permiso_rol_validate_mm_id_

  function do_ajax_form_v_del_permiso_rol_validate_mm_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_v_del_permiso_rol_validate_mm_id__cb

  // ---------- Validate mm_modulo_
  function do_ajax_form_v_del_permiso_rol_validate_mm_modulo_(iNumLinha)
  {
    var nomeCampo_mm_modulo_ = "mm_modulo_" + iNumLinha;
    var var_mm_modulo_ = scAjaxGetFieldSelect(nomeCampo_mm_modulo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_v_del_permiso_rol_validate_mm_modulo_(var_mm_modulo_, iNumLinha, var_script_case_init, do_ajax_form_v_del_permiso_rol_validate_mm_modulo__cb);
  } // do_ajax_form_v_del_permiso_rol_validate_mm_modulo_

  function do_ajax_form_v_del_permiso_rol_validate_mm_modulo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_v_del_permiso_rol_validate_mm_modulo__cb

  // ---------- Validate mm_menu_
  function do_ajax_form_v_del_permiso_rol_validate_mm_menu_(iNumLinha)
  {
    var nomeCampo_mm_menu_ = "mm_menu_" + iNumLinha;
    var var_mm_menu_ = scAjaxGetFieldSelect(nomeCampo_mm_menu_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_v_del_permiso_rol_validate_mm_menu_(var_mm_menu_, iNumLinha, var_script_case_init, do_ajax_form_v_del_permiso_rol_validate_mm_menu__cb);
  } // do_ajax_form_v_del_permiso_rol_validate_mm_menu_

  function do_ajax_form_v_del_permiso_rol_validate_mm_menu__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_v_del_permiso_rol_validate_mm_menu__cb

  // ---------- Validate mm_descripcion_
  function do_ajax_form_v_del_permiso_rol_validate_mm_descripcion_(iNumLinha)
  {
    var nomeCampo_mm_descripcion_ = "mm_descripcion_" + iNumLinha;
    var var_mm_descripcion_ = scAjaxGetFieldText(nomeCampo_mm_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_v_del_permiso_rol_validate_mm_descripcion_(var_mm_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_v_del_permiso_rol_validate_mm_descripcion__cb);
  } // do_ajax_form_v_del_permiso_rol_validate_mm_descripcion_

  function do_ajax_form_v_del_permiso_rol_validate_mm_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_v_del_permiso_rol_validate_mm_descripcion__cb

  // ---------- Validate per_permiso_
  function do_ajax_form_v_del_permiso_rol_validate_per_permiso_(iNumLinha)
  {
    var nomeCampo_per_permiso_ = "per_permiso_" + iNumLinha;
    var var_per_permiso_ = scAjaxGetFieldCheckbox(nomeCampo_per_permiso_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_v_del_permiso_rol_validate_per_permiso_(var_per_permiso_, iNumLinha, var_script_case_init, do_ajax_form_v_del_permiso_rol_validate_per_permiso__cb);
  } // do_ajax_form_v_del_permiso_rol_validate_per_permiso_

  function do_ajax_form_v_del_permiso_rol_validate_per_permiso__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_v_del_permiso_rol_validate_per_permiso__cb

  // ---------- Event onclick per_permiso_
  function do_ajax_form_v_del_permiso_rol_event_per_permiso__onclick(iSeqForm)
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_v_del_permiso_rol_event_per_permiso__onclick(var_per_permiso_, var_per_rol_, var_mm_id_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_v_del_permiso_rol_event_per_permiso__onclick_cb);
  } // do_ajax_form_v_del_permiso_rol_event_per_permiso__onclick

  function do_ajax_form_v_del_permiso_rol_event_per_permiso__onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_v_del_permiso_rol_event_per_permiso__onclick_cb_after_alert);
  } // do_ajax_form_v_del_permiso_rol_event_per_permiso__onclick_cb
  function do_ajax_form_v_del_permiso_rol_event_per_permiso__onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_v_del_permiso_rol_event_per_permiso__onclick_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_v_del_permiso_rol_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_v_del_permiso_rol_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_v_del_permiso_rol_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_v_del_permiso_rol_add_new_line_cb);
  } // do_ajax_form_v_del_permiso_rol_add_new_line

  function do_ajax_form_v_del_permiso_rol_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_v_del_permiso_rol_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_v_del_permiso_rol_backup_line(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_v_del_permiso_rol_backup_line(var_per_rol_, var_mm_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_v_del_permiso_rol_backup_line_cb);
  } // do_ajax_form_v_del_permiso_rol_backup_line

  function do_ajax_form_v_del_permiso_rol_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_v_del_permiso_rol_backup_line_cb

  function do_ajax_form_v_del_permiso_rol_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_v_del_permiso_rol_cancel_insert

  function do_ajax_form_v_del_permiso_rol_cancel_update(iSeqVert)
  {
    do_ajax_form_v_del_permiso_rol_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_v_del_permiso_rol_cancel_update

  function do_ajax_form_v_del_permiso_rol_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_v_del_permiso_rol_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_v_del_permiso_rol_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_v_del_permiso_rol_table_refresh(var_per_rol_, var_mm_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_v_del_permiso_rol_table_refresh_cb);
  } //  do_ajax_form_v_del_permiso_rol_table_refresh

  function do_ajax_form_v_del_permiso_rol_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_v_del_permiso_rol_table_refresh_cb_after_alert);
  } // do_ajax_form_v_del_permiso_rol_table_refresh_cb
  function do_ajax_form_v_del_permiso_rol_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_v_del_permiso_rol_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_v_del_permiso_rol_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_v_del_permiso_rol_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_per_rol_ = scAjaxGetFieldText("per_rol_" + iNumLinha);
    var var_mm_id_ = scAjaxGetFieldText("mm_id_" + iNumLinha);
    var var_mm_modulo_ = scAjaxGetFieldSelect("mm_modulo_" + iNumLinha);
    var var_mm_menu_ = scAjaxGetFieldSelect("mm_menu_" + iNumLinha);
    var var_mm_descripcion_ = scAjaxGetFieldText("mm_descripcion_" + iNumLinha);
...
?>
    x_ajax_form_v_del_permiso_rol_submit_form(var_per_rol_, var_mm_id_, var_mm_modulo_, var_mm_menu_, var_mm_descripcion_, var_per_permiso_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_v_del_permiso_rol_submit_form_cb);
  } // do_ajax_form_v_del_permiso_rol_submit_form

  function do_ajax_form_v_del_permiso_rol_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_v_del_permiso_rol_submit_form_cb_after_alert);
  } // do_ajax_form_v_del_permiso_rol_submit_form_cb
  function do_ajax_form_v_del_permiso_rol_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_v_del_permiso_rol_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_v_del_permiso_rol_navigate_form()
  {
    perform_ajax_form_v_del_permiso_rol_navigate_form();
  }

  function perform_ajax_form_v_del_permiso_rol_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_v_del_permiso_rol_navigate_form(var_per_rol_, var_mm_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_v_del_permiso_rol_navigate_form_cb);
  } // do_ajax_form_v_del_permiso_rol_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_v_del_permiso_rol']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_v_del_permiso_rol_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_v_del_permiso_rol_navigate_form_cb_after_alert);
  } // do_ajax_form_v_del_permiso_rol_navigate_form_cb
  function do_ajax_form_v_del_permiso_rol_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_v_del_permiso_rol_navigate_form_cb_after_alert

    function sc_form_v_del_permiso_rol_get_last_line_number()
    {
    ...
    } //sc_form_v_del_permiso_rol_get_last_line_number

  function sc_hide_form_v_del_permiso_rol_form()
  {
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['mm_modulo_'])) ? $this->nmgp_cmp_readonly['mm_modulo_'] : 'on';
?>
    scAjaxFieldRead("mm_modulo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['mm_menu_'])) ? $this->nmgp_cmp_readonly['mm_menu_'] : 'on';
?>
    scAjaxFieldRead("mm_menu_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['mm_descripcion_'])) ? $this->nmgp_cmp_readonly['mm_descripcion_'] : 'on';
?>
