...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIJAP_____buscar_v_jap_contrato_anticipos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIJAP_____buscar_v_jap_contrato_anticipos"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['buscar_v_jap_contrato_anticipos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['buscar_v_jap_contrato_anticipos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['buscar_v_jap_contrato_anticipos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['buscar_v_jap_contrato_anticipos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['buscar_v_jap_contrato_anticipos']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>buscar_v_jap_contrato_anticipos</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['buscar_v_jap_contrato_anticipos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['buscar_v_jap_contrato_anticipos']['embutida_filho'] as $ind => $sc_init)
          {
