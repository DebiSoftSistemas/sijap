<?php
@session_start() ;
$_SESSION['scriptcase']['grid_v_jap_padron_general']['sc_process_barr'] = true;
require_once('../grid_v_jap_padron_general/index.php');
unset($_SESSION['scriptcase']['grid_v_jap_padron_general']['sc_process_barr']);
$ExportCtrl = new grid_v_jap_padron_general_export_control;
$ExportCtrl->Export_barr();

class grid_v_jap_padron_general_export_control
{
