  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_salario_basico" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sis_salario_basico_form();
	}
...
?>
  ...
  // ---------- Validate sb_id_
  function do_ajax_form_sis_salario_basico_validate_sb_id_(iNumLinha)
  {
    var nomeCampo_sb_id_ = "sb_id_" + iNumLinha;
    var var_sb_id_ = scAjaxGetFieldHidden(nomeCampo_sb_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_salario_basico_validate_sb_id_(var_sb_id_, iNumLinha, var_script_case_init, do_ajax_form_sis_salario_basico_validate_sb_id__cb);
  } // do_ajax_form_sis_salario_basico_validate_sb_id_

  function do_ajax_form_sis_salario_basico_validate_sb_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "sb_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "sb_id_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "sb_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "sb_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_salario_basico_validate_sb_id__cb

  // ---------- Validate sb_anio_
  function do_ajax_form_sis_salario_basico_validate_sb_anio_(iNumLinha)
  {
    var nomeCampo_sb_anio_ = "sb_anio_" + iNumLinha;
    var var_sb_anio_ = scAjaxGetFieldText(nomeCampo_sb_anio_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_salario_basico_validate_sb_anio_(var_sb_anio_, iNumLinha, var_script_case_init, do_ajax_form_sis_salario_basico_validate_sb_anio__cb);
  } // do_ajax_form_sis_salario_basico_validate_sb_anio_

  function do_ajax_form_sis_salario_basico_validate_sb_anio__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "sb_anio_" + iLineNumber;
    }
    else
    {
      sFieldValid = "sb_anio_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "sb_anio_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "sb_anio_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_salario_basico_validate_sb_anio__cb

  // ---------- Validate sb_valor_
  function do_ajax_form_sis_salario_basico_validate_sb_valor_(iNumLinha)
  {
    var nomeCampo_sb_valor_ = "sb_valor_" + iNumLinha;
    var var_sb_valor_ = scAjaxGetFieldText(nomeCampo_sb_valor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_salario_basico_validate_sb_valor_(var_sb_valor_, iNumLinha, var_script_case_init, do_ajax_form_sis_salario_basico_validate_sb_valor__cb);
  } // do_ajax_form_sis_salario_basico_validate_sb_valor_

  function do_ajax_form_sis_salario_basico_validate_sb_valor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "sb_valor_" + iLineNumber;
    }
    else
    {
      sFieldValid = "sb_valor_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "sb_valor_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "sb_valor_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_salario_basico_validate_sb_valor__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_sis_salario_basico_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_sis_salario_basico_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sis_salario_basico_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_sis_salario_basico_add_new_line_cb);
  } // do_ajax_form_sis_salario_basico_add_new_line

  function do_ajax_form_sis_salario_basico_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_sis_salario_basico_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_sis_salario_basico_backup_line(iNumLinha)
  {
    var var_sb_id_ = scAjaxGetFieldHidden("sb_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_salario_basico_backup_line(var_sb_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_sis_salario_basico_backup_line_cb);
  } // do_ajax_form_sis_salario_basico_backup_line

  function do_ajax_form_sis_salario_basico_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_sis_salario_basico_backup_line_cb

  function do_ajax_form_sis_salario_basico_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_sis_salario_basico_cancel_insert

  function do_ajax_form_sis_salario_basico_cancel_update(iSeqVert)
  {
    do_ajax_form_sis_salario_basico_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_sis_salario_basico_cancel_update

  function do_ajax_form_sis_salario_basico_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_sis_salario_basico_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_sis_salario_basico_table_refresh()
  {
    var var_sb_id_ = document.F2.sb_id_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_sis_salario_basico_table_refresh(var_sb_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_salario_basico_table_refresh_cb);
  } //  do_ajax_form_sis_salario_basico_table_refresh

  function do_ajax_form_sis_salario_basico_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.sb_id_.value = scAjaxGetKeyValue("sb_id_");
    ...
    scAjaxAlert(do_ajax_form_sis_salario_basico_table_refresh_cb_after_alert);
  } // do_ajax_form_sis_salario_basico_table_refresh_cb
  function do_ajax_form_sis_salario_basico_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_sis_salario_basico_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_sis_salario_basico_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_sis_salario_basico_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_sb_id_ = scAjaxGetFieldHidden("sb_id_" + iNumLinha);
    var var_sb_anio_ = scAjaxGetFieldText("sb_anio_" + iNumLinha);
    var var_sb_valor_ = scAjaxGetFieldText("sb_valor_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_sis_salario_basico_submit_form(var_sb_id_, var_sb_anio_, var_sb_valor_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_salario_basico_submit_form_cb);
  } // do_ajax_form_sis_salario_basico_submit_form

  function do_ajax_form_sis_salario_basico_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("sb_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("sb_anio_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("sb_valor_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sis_salario_basico_submit_form_cb_after_alert);
  } // do_ajax_form_sis_salario_basico_submit_form_cb
  function do_ajax_form_sis_salario_basico_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_salario_basico_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sis_salario_basico_navigate_form()
  {
    perform_ajax_form_sis_salario_basico_navigate_form();
  }

  function perform_ajax_form_sis_salario_basico_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_sis_salario_basico_cancel_insert(sc_form_sis_salario_basico_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("sb_id_" + iNavForm);
      scAjaxHideErrorDisplay("sb_anio_" + iNavForm);
      scAjaxHideErrorDisplay("sb_valor_" + iNavForm);
    }
    var var_sb_id_ = document.F2.sb_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sis_salario_basico_navigate_form(var_sb_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_salario_basico_navigate_form_cb);
  } // do_ajax_form_sis_salario_basico_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_salario_basico']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_salario_basico_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.sb_id_.value = scAjaxGetKeyValue("sb_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_salario_basico_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_salario_basico_navigate_form_cb
  function do_ajax_form_sis_salario_basico_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_sis_salario_basico_navigate_form_cb_after_alert

    function sc_form_sis_salario_basico_get_last_line_number()
    {
    ...
    } //sc_form_sis_salario_basico_get_last_line_number

  function sc_hide_form_sis_salario_basico_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "sb_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "sb_anio_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "sb_valor_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["sb_id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["sb_anio_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_srch_year'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["sb_valor_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_valor'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["sb_id_"][iNumLinha] = "sb_id_" + iNumLinha;
    ajax_field_mult["sb_anio_"][iNumLinha] = "sb_anio_" + iNumLinha;
    ajax_field_mult["sb_valor_"][iNumLinha] = "sb_valor_" + iNumLinha;
    ajax_field_id["sb_anio_" + iNumLinha] = new Array("hidden_field_label_sb_anio_", "hidden_field_data_sb_anio_" + iNumLinha);
    ajax_field_id["sb_valor_" + iNumLinha] = new Array("hidden_field_label_sb_valor_", "hidden_field_data_sb_valor_" + iNumLinha);
    ajax_error_count["sb_id_" + iNumLinha] = "off";
    ajax_error_count["sb_anio_" + iNumLinha] = "off";
    ajax_error_count["sb_valor_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["sb_id_" + iNumLinha] = "on";
    ajax_read_only["sb_anio_" + iNumLinha] = "off";
    ajax_read_only["sb_valor_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["sb_id_" + iNumLinha] = "on";
    ajax_read_only["sb_anio_" + iNumLinha] = "on";
    ajax_read_only["sb_valor_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["sb_id_" + iNumLinha] = null;
    ajax_error_list["sb_anio_" + iNumLinha] = null;
    ajax_error_list["sb_valor_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["sb_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["sb_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["sb_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["sb_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["sb_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["sb_anio_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["sb_anio_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["sb_anio_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["sb_anio_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["sb_anio_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["sb_valor_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["sb_valor_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["sb_valor_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["sb_valor_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["sb_valor_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['sb_id_'])) ? $this->nmgp_cmp_readonly['sb_id_'] : 'on';
?>
    scAjaxFieldRead("sb_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['sb_anio_'])) ? $this->nmgp_cmp_readonly['sb_anio_'] : 'off';
?>
    scAjaxFieldRead("sb_anio_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['sb_valor_'])) ? $this->nmgp_cmp_readonly['sb_valor_'] : 'off';
?>
    scAjaxFieldRead("sb_valor_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("sb_id_" + iSeq, "on");
    scAjaxFieldRead("sb_anio_" + iSeq, "on");
    scAjaxFieldRead("sb_valor_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["sb_id_" + iRow] || "on" == ajax_error_count["sb_anio_" + iRow] || "on" == ajax_error_count["sb_valor_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sb_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sb_anio_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sb_valor_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["sb_id_" + iRow] && "off" == ajax_error_count["sb_anio_" + iRow] && "off" == ajax_error_count["sb_valor_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["sb_id_" + iRow] = "off";
        ajax_error_count["sb_anio_" + iRow] = "off";
        ajax_error_count["sb_valor_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_sb_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_sb_anio_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_sb_valor_" + iRow).removeClass("scFormErrorLine");
    }
  }
