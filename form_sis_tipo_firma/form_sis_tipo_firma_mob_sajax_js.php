  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_tipo_firma_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sis_tipo_firma_mob_form();
	}
...
?>
  ...
  // ---------- Validate tf_id
  function do_ajax_form_sis_tipo_firma_mob_validate_tf_id()
  {
    var nomeCampo_tf_id = "tf_id";
    var var_tf_id = scAjaxGetFieldHidden(nomeCampo_tf_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_tipo_firma_mob_validate_tf_id(var_tf_id, var_script_case_init, do_ajax_form_sis_tipo_firma_mob_validate_tf_id_cb);
  } // do_ajax_form_sis_tipo_firma_mob_validate_tf_id

  function do_ajax_form_sis_tipo_firma_mob_validate_tf_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_tipo_firma_mob_validate_tf_id_cb

  // ---------- Validate tf_descripcion
  function do_ajax_form_sis_tipo_firma_mob_validate_tf_descripcion()
  {
    var nomeCampo_tf_descripcion = "tf_descripcion";
    var var_tf_descripcion = scAjaxGetFieldText(nomeCampo_tf_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_tipo_firma_mob_validate_tf_descripcion(var_tf_descripcion, var_script_case_init, do_ajax_form_sis_tipo_firma_mob_validate_tf_descripcion_cb);
  } // do_ajax_form_sis_tipo_firma_mob_validate_tf_descripcion

  function do_ajax_form_sis_tipo_firma_mob_validate_tf_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tf_descripcion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_tipo_firma_mob_validate_tf_descripcion_cb

  // ---------- Validate tf_producto
  function do_ajax_form_sis_tipo_firma_mob_validate_tf_producto()
  {
    var nomeCampo_tf_producto = "tf_producto";
    var var_tf_producto = scAjaxGetFieldSelect(nomeCampo_tf_producto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_tipo_firma_mob_validate_tf_producto(var_tf_producto, var_script_case_init, do_ajax_form_sis_tipo_firma_mob_validate_tf_producto_cb);
  } // do_ajax_form_sis_tipo_firma_mob_validate_tf_producto

  function do_ajax_form_sis_tipo_firma_mob_validate_tf_producto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tf_producto";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_tipo_firma_mob_validate_tf_producto_cb

  // ---------- Validate tf_estado
  function do_ajax_form_sis_tipo_firma_mob_validate_tf_estado()
  {
    var nomeCampo_tf_estado = "tf_estado";
    var var_tf_estado = scAjaxGetFieldSelect(nomeCampo_tf_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_tipo_firma_mob_validate_tf_estado(var_tf_estado, var_script_case_init, do_ajax_form_sis_tipo_firma_mob_validate_tf_estado_cb);
  } // do_ajax_form_sis_tipo_firma_mob_validate_tf_estado

  function do_ajax_form_sis_tipo_firma_mob_validate_tf_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_tipo_firma_mob_validate_tf_estado_cb

  // ---------- Validate documentos
  function do_ajax_form_sis_tipo_firma_mob_validate_documentos()
  {
    var nomeCampo_documentos = "documentos";
    var var_documentos = scAjaxGetFieldText(nomeCampo_documentos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_tipo_firma_mob_validate_documentos(var_documentos, var_script_case_init, do_ajax_form_sis_tipo_firma_mob_validate_documentos_cb);
  } // do_ajax_form_sis_tipo_firma_mob_validate_documentos

  function do_ajax_form_sis_tipo_firma_mob_validate_documentos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_tipo_firma_mob_validate_documentos_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_sis_tipo_firma_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_sis_tipo_firma_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_tf_id = scAjaxGetFieldHidden("tf_id");
    var var_tf_descripcion = scAjaxGetFieldText("tf_descripcion");
    var var_tf_producto = scAjaxGetFieldSelect("tf_producto");
    ...
    scAjaxProcOn();
    x_ajax_form_sis_tipo_firma_mob_submit_form(var_tf_id, var_tf_descripcion, var_tf_producto, var_tf_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_tipo_firma_mob_submit_form_cb);
  } // do_ajax_form_sis_tipo_firma_mob_submit_form

  function do_ajax_form_sis_tipo_firma_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("tf_descripcion");
      scAjaxHideErrorDisplay("tf_producto");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_sis_tipo_firma_mob_submit_form_cb_after_alert);
  } // do_ajax_form_sis_tipo_firma_mob_submit_form_cb
  function do_ajax_form_sis_tipo_firma_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_tipo_firma_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_sis_documentos_tipo_firma_mob"] = "off";

  function do_ajax_form_sis_tipo_firma_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_sis_tipo_firma_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_sis_tipo_firma_mob_navigate_form();
    }
  }

  function perform_ajax_form_sis_tipo_firma_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_sis_documentos_tipo_firma_mob"] = "on";
    x_ajax_form_sis_tipo_firma_mob_navigate_form(var_tf_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_tipo_firma_mob_navigate_form_cb);
  } // do_ajax_form_sis_tipo_firma_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_tipo_firma_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_tipo_firma_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_sis_documentos_tipo_firma_mob"] && "nmsc_iframe_liga_form_sis_documentos_tipo_firma_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_sis_documentos_tipo_firma_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_sis_documentos_tipo_firma_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_sis_documentos_tipo_firma_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_sis_documentos_tipo_firma_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_sis_documentos_tipo_firma_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_tipo_firma_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_tipo_firma_mob_navigate_form_cb
  function do_ajax_form_sis_tipo_firma_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_sis_tipo_firma_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_sis_tipo_firma_mob_navigate_form_cb_after_alert

  function sc_hide_form_sis_tipo_firma_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_sis_documentos_tipo_firma_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "tf_id";
  ajax_field_list[1] = "tf_descripcion";
  ajax_field_list[2] = "tf_producto";
  ajax_field_list[3] = "tf_estado";
  ajax_field_list[4] = "documentos";
  ...
  var ajax_error_list = {
    ...
    "tf_descripcion": {"label": "<?php echo $this->Ini->Nm_lang['lang_descripcion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tf_producto": {"label": "<?php echo $this->Ini->Nm_lang['lang_producto'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "documentos": {"label": "Documentos", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "tf_id": new Array(),
    "tf_descripcion": new Array(),
    "tf_producto": new Array(),
    "tf_estado": new Array(),
    "documentos": new Array()
  };
  ajax_field_mult["tf_id"][1] = "tf_id";
  ajax_field_mult["tf_descripcion"][1] = "tf_descripcion";
  ajax_field_mult["tf_producto"][1] = "tf_producto";
  ajax_field_mult["tf_estado"][1] = "tf_estado";
  ajax_field_mult["documentos"][1] = "documentos";

  var ajax_field_id = {
    "tf_id": new Array("hidden_field_label_tf_id", "hidden_field_data_tf_id"),
    "tf_descripcion": new Array("hidden_field_label_tf_descripcion", "hidden_field_data_tf_descripcion"),
    "tf_producto": new Array("hidden_field_label_tf_producto", "hidden_field_data_tf_producto"),
    "tf_estado": new Array("hidden_field_label_tf_estado", "hidden_field_data_tf_estado"),
