<?php
@session_start() ;
$_SESSION['scriptcase']['grid_solicitud_servicio_ap']['sc_process_barr'] = true;
require_once('../grid_solicitud_servicio_ap/index.php');
unset($_SESSION['scriptcase']['grid_solicitud_servicio_ap']['sc_process_barr']);
$ExportCtrl = new grid_solicitud_servicio_ap_export_control;
$ExportCtrl->Export_barr();

class grid_solicitud_servicio_ap_export_control
{
