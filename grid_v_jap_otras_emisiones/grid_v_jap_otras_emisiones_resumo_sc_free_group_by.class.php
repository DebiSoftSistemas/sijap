...
class grid_v_jap_otras_emisiones_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function initializeButtons()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_v_jap_otras_emisiones'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_v_jap_otras_emisiones'];
   ...
   if ($this->Ini->Embutida_iframe) {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['sub_cons_iframe_btns'] as $BTN => $BTN_opc) {
           $this->nmgp_botoes[$BTN] = $BTN_opc;
       }
   }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_v_jap_otras_emisiones']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_v_jap_otras_emisiones']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_v_jap_otras_emisiones']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
...
SCEOT;
	...
	function generateChartImages() {
		...
		$this->Graf         = new grid_v_jap_otras_emisiones_grafico();
		$this->Graf->Db     = $this->Db;
		$this->Graf->Erro   = $this->Erro;
		$this->Graf->Ini    = $this->Ini;
		$this->Graf->Lookup = $this->Lookup;

		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_v_jap_otras_emisiones']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_v_jap_otras_emisiones']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['orig_pesq'] = "resumo";
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['where_pesq_filtro'];
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['campos_busca']))
     { 
         $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['campos_busca'];
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pesq_tab_label']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pesq_tab_label'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pesq_tab_label'] .= "esc_tipo_deuda?#?" . "" . $this->Ini->Nm_lang['lang_tipo_deuda'] . "" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pesq_tab_label'] .= "esc_fecha?#?" . "" . $this->Ini->Nm_lang['lang_fecha_emision'] . "" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pesq_tab_label'] .= "esc_mes_periodo?#?" . "" . $this->Ini->Nm_lang['lang_srch_mnth'] . "" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pesq_tab_label'] .= "esc_anio_periodo?#?" . "" . $this->Ini->Nm_lang['lang_srch_year'] . "" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pesq_tab_label'] .= "des_ruta?#?" . "" . $this->Ini->Nm_lang['lang_ruta'] . "" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pesq_tab_label'] .= "cl_nombre?#?" . "" . $this->Ini->Nm_lang['lang_nombre'] . "" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pesq_tab_label'] .= "con_numero_contrato?#?" . "" . $this->Ini->Nm_lang['lang_numero'] . " Contrato" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pesq_tab_label'] .= "des_numero_medidor?#?" . "" . $this->Ini->Nm_lang['lang_numero_medidor'] . "" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pesq_tab_label'] .= "op_estado?#?" . "" . $this->Ini->Nm_lang['lang_estado_deudas'] . "" . "?@?";
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['grid_search_add']))
      {
          $this->monta_css();
          $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pesq_tab_label'];
          ...
          $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['grid_search_add']['seq'];
          $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['grid_search_add']['cmp'];
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['grid_search_add']);
          exit;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['dyn_search_aut_comp']))
      {
          $Cmp_select2 = array("cl_nombre","con_numero_contrato","des_numero_medidor");
          ob_start();
          $NM_func_aut_comp = "lookup_ajax_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['dyn_search_aut_comp']['cmp'];
          ...
          foreach ($nmgp_def_dados as $Ind => $Lista)
          {
             if (is_array($Lista))
             {
                 foreach ($Lista as $Cod => $Valor)
                 {
                     ...
                     if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['dyn_search_aut_comp']['cmp'], $Cmp_select2))
                     {
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['dyn_search_aut_comp']);
          exit;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['opcao'] != "pdf")
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['res_hrz'];
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']) && !$this->NM_export)
      {
          foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
          {
              if (in_array("grid_v_jap_otras_emisiones", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral(false, $this->NM_export);
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              $Arr_tot_name = "array_total_" . $cmp_gb;
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['tot_geral'][3];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['tot_geral'][4];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['tot_geral'][5];
      $this->array_total_geral[3] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['arr_total']['esc_tipo_deuda'] = $this->array_total_esc_tipo_deuda;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['arr_total']['esc_anio_periodo'] = $this->array_total_esc_anio_periodo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['arr_total']['esc_mes_periodo'] = $this->array_total_esc_mes_periodo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['arr_total']['cl_nombre'] = $this->array_total_cl_nombre;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['arr_total']['cl_telefono'] = $this->array_total_cl_telefono;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['arr_total']['cl_celular'] = $this->array_total_cl_celular;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['arr_total']['cl_email'] = $this->array_total_cl_email;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['arr_total']['des_ruta'] = $this->array_total_des_ruta;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['arr_total']['op_estado'] = $this->array_total_op_estado;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['json_use_label'])
       {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['esc_tipo_deuda'] = $Lab_esc_tipo_deuda; 
       $prep_field['esc_anio_periodo'] = $Lab_esc_anio_periodo;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['esc_anio_periodo'] = $Lab_esc_anio_periodo; 
       $prep_field['esc_mes_periodo'] = $Lab_esc_mes_periodo;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['esc_mes_periodo'] = $Lab_esc_mes_periodo; 
       $prep_field['cl_nombre'] = $Lab_cl_nombre;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['cl_nombre'] = $Lab_cl_nombre; 
       $prep_field['cl_telefono'] = $Lab_cl_telefono;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['cl_telefono'] = $Lab_cl_telefono; 
       $prep_field['cl_celular'] = $Lab_cl_celular;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['cl_celular'] = $Lab_cl_celular; 
       $prep_field['cl_email'] = $Lab_cl_email;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['cl_email'] = $Lab_cl_email; 
       $prep_field['des_ruta'] = $Lab_des_ruta;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['des_ruta'] = $Lab_des_ruta; 
       $prep_field['op_estado'] = $Lab_op_estado;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['op_estado'] = $Lab_op_estado; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['esc_fecha']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['esc_fecha'] = "" . $this->Ini->Nm_lang['lang_fecha_emision'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['esc_tipo_deuda']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['esc_tipo_deuda'] = "" . $this->Ini->Nm_lang['lang_tipo_deuda'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['cl_nombre']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['cl_nombre'] = "" . $this->Ini->Nm_lang['lang_nombre'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['esc_anio_periodo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['esc_anio_periodo'] = "" . $this->Ini->Nm_lang['lang_srch_year'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['esc_mes_periodo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['esc_mes_periodo'] = "" . $this->Ini->Nm_lang['lang_srch_mnth'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['con_numero_contrato']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['con_numero_contrato'] = "" . $this->Ini->Nm_lang['lang_numero'] . " Contrato"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['des_total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['des_total'] = "" . $this->Ini->Nm_lang['lang_total_pagar'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['op_estado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['op_estado'] = "" . $this->Ini->Nm_lang['lang_estado_deudas'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['op_motivo_baja']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['op_motivo_baja'] = "Motivo Baja"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['detalle_deuda']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['detalle_deuda'] = "" . $this->Ini->Nm_lang['lang_deuda'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['detalles']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['detalles'] = "" . $this->Ini->Nm_lang['lang_materiales'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['factura']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['factura'] = "" . $this->Ini->Nm_lang['lang_factura'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['des_ruta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['des_ruta'] = "" . $this->Ini->Nm_lang['lang_ruta'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['cl_telefono']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['cl_telefono'] = "" . $this->Ini->Nm_lang['lang_lot_telefono'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['cl_celular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['cl_celular'] = "" . $this->Ini->Nm_lang['lang_celular'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['cl_email']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['cl_email'] = "" . $this->Ini->Nm_lang['lang_email'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['con_direccion_predio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['con_direccion_predio'] = "" . $this->Ini->Nm_lang['lang_direccion_predio'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['des_contrato']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['des_contrato'] = "" . $this->Ini->Nm_lang['lang_contrato'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['con_tipo_servicio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['con_tipo_servicio'] = "" . $this->Ini->Nm_lang['lang_tipo_servicio'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['con_condicion_contrato']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['con_condicion_contrato'] = "" . $this->Ini->Nm_lang['lang_condicion_contrato'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['des_numero_medidor']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['des_numero_medidor'] = "" . $this->Ini->Nm_lang['lang_numero_medidor'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['des_lectura_anterior']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['des_lectura_anterior'] = "" . $this->Ini->Nm_lang['lang_lectura_anterior'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['des_lectura_actual']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['des_lectura_actual'] = "" . $this->Ini->Nm_lang['lang_lectura_actual'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['des_consumo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['des_consumo'] = "" . $this->Ini->Nm_lang['lang_consumo'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['des_consumo_base']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['des_consumo_base'] = "" . $this->Ini->Nm_lang['lang_consumo_base'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['des_consumo_excedente']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['des_consumo_excedente'] = "" . $this->Ini->Nm_lang['lang_consumo_excedente'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['op_asiento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['op_asiento'] = "" . $this->Ini->Nm_lang['lang_asiento_emision'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['op_asiento_reversa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['op_asiento_reversa'] = "" . $this->Ini->Nm_lang['lang_asiento_reverso'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['op_asiento_ingreso']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['op_asiento_ingreso'] = "" . $this->Ini->Nm_lang['lang_asiento_ingreso'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['esc_empresa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['esc_empresa'] = "" . $this->Ini->Nm_lang['lang_empresa'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['con_propietario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['con_propietario'] = "" . $this->Ini->Nm_lang['lang_propietario'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['cl_identificacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['cl_identificacion'] = "Cl Identificacion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['des_operacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['des_operacion'] = "" . $this->Ini->Nm_lang['lang_operacion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['des_estado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['des_estado'] = "" . $this->Ini->Nm_lang['lang_estado'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['des_revisar']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['des_revisar'] = "Des Revisar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['des_registra_danio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['des_registra_danio'] = "Des Registra Danio"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['esc_tipo_emision']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['esc_tipo_emision'] = "Esc Tipo Emision"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['esc_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['esc_id'] = "" . $this->Ini->Nm_lang['lang_secuencial'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['des_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['des_id'] = "Des Id"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['fac_numero']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['labels']['fac_numero'] = "Fac Numero"; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_v_jap_otras_emisiones@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function makeTabular(&$a_data)
   {
       ...
       {
           $a_labels = array();
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['proc_pdf_vert'])
   {
     $this->comp_tab_hover = true;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['arr_export']['data']  = $this->build_data;
           return;
       }

       $nm_saida->saida("<tr id=\"summary_body\" class='sc-mobile-inner-control'>\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['ajax_nav'])
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
       } 
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
   ...
   function drawMatrixLabels()
   {
       ...
       $nm_saida->saida("    <script type=\"text/javascript\">\r\n");
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['embutida'])
       { 
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
         ...
         { 
            ...
            { 
                $seq_search = 1;
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['grid_pesq'] as $cmp => $def)
                {
                   $Seq_grid      = $seq_search;
                   $Cmp_grid      = $cmp;
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_v_jap_otras_emisiones']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_v_jap_otras_emisiones']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_v_jap_otras_emisiones']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_v_jap_otras_emisiones']) . "_";
               } 
           }
       }
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_v_jap_otras_emisiones_total.class.php"); 
      }
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['print_all'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['doc_word'] || $this->Ini->sc_export_ajax_img)
      { 
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['opcao'] = "print";
      ...
      $this->Total   = new grid_v_jap_otras_emisiones_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['arr_total'][$cmp_gb];
      }
...
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['doc_word'])
{
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['doc_word'])
{
      ...
      { 
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['ajax_nav']) {  
        ...
        <link rel='stylesheet' href='../_lib/lib/css/nm_mobile.css' type='text/css'/>
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_v_jap_otras_emisiones_ajax.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_v_jap_otras_emisiones_jquery_8078.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_v_jap_otras_emisiones_message.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput2.js\"></script>\r\n");
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_jap_otras_emisiones_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_v_jap_otras_emisiones_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_jap_otras_emisiones_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_v_jap_otras_emisiones/grid_v_jap_otras_emisiones_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['dashboard_info']['remove_margin'] ? 'margin: 0;' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['dashboard_info']['remove_border'] ? 'border-width: 0;' : '';
          $vertical_center = '';
          $nm_saida->saida(" <BODY id=\"grid_summary\" class=\"" . $this->css_scGridPage . " sc-app-grid\" style=\"" . $remove_margin . $vertical_center . "\">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "grid_v_jap_otras_emisiones/grid_v_jap_otras_emisiones_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume&nm_all_modules=grid,resume&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_v_jap_otras_emisiones/grid_v_jap_otras_emisiones_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_v_jap_otras_emisiones&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid,resume&nm_all_modules=grid,resume&password=n&summary_export_columns=S&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
             $this->nm_btn_exist['groupby'][] = "sel_groupby_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_v_jap_otras_emisiones/grid_v_jap_otras_emisiones_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_v_jap_otras_emisiones/grid_v_jap_otras_emisiones_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + G)", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_v_jap_otras_emisiones_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("grid_v_jap_otras_emisiones_help.txt"); 
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_v_jap_otras_emisiones']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_v_jap_otras_emisiones']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_v_jap_otras_emisiones_config_pivot.php?nome_apl=grid_v_jap_otras_emisiones&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("                  action=\"grid_v_jap_otras_emisiones_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_v_jap_otras_emisiones/grid_v_jap_otras_emisiones_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
      $nm_saida->saida("       }\r\n");
      $nm_saida->saida("       else\r\n");
      $nm_saida->saida("       {\r\n");
      ...
      $nm_saida->saida("               document.Fdoc_word.action = \"grid_v_jap_otras_emisiones_export_ctrl.php\";\r\n");
      ...
      $nm_saida->saida("               document.Fprint.action = \"grid_v_jap_otras_emisiones_export_ctrl.php\";\r\n");
      $nm_saida->saida("           }\r\n");
      $nm_saida->saida("           else\r\n");
      $nm_saida->saida("           {\r\n");
      ...
      $nm_saida->saida("               document.Fexport.action = \"grid_v_jap_otras_emisiones_export_ctrl.php\";\r\n");
      ...
      $nm_saida->saida("       document.F3.SC_module_export.value = z;\r\n");
      $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['grid_v_jap_otras_emisiones_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_v_jap_otras_emisiones@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"grid_v_jap_otras_emisiones_iframe.php\";\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_jap_otras_emisiones_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_v_jap_otras_emisiones/grid_v_jap_otras_emisiones_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['print_all'];
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['pdf_res'])
       {
           $nm_saida->saida("<TR>\r\n");
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['cond_pesq'], 0, $trab_pos);
   ...
   $sc_data_cab1 = $this->nm_data->FormataSaida("l, d @?#?@de F @?#?@de Y");
      ...
      $nm_saida->saida("       <TR valign=\"middle\">\r\n");
      $nm_saida->saida("        <TD align=\"left\" class=\"" . $this->css_scGridHeaderFont . "\">\r\n");
      $nm_saida->saida("          " . $this->Ini->Nm_lang['lang_reporte_emisiones'] . " " . $this->Ini->Nm_lang['lang_otras_emisiones'] . "\r\n");
      $nm_saida->saida("        </TD>\r\n");
      $nm_saida->saida("        <TD style=\"font-size: 5px\">\r\n");
      $nm_saida->saida("          &nbsp; &nbsp;\r\n");
      $nm_saida->saida("        </TD>\r\n");
   ...
   function adiciona_registro($sum_des_total, $sum_des_consumo, $sum_des_consumo_base, $sum_des_consumo_excedente, $quebra_esc_tipo_deuda, $quebra_esc_anio_periodo, $quebra_esc_mes_periodo, $quebra_cl_nombre, $quebra_cl_telefono, $quebra_cl_celular, $quebra_cl_email, $quebra_des_ruta, $quebra_op_estado, $quebra_esc_tipo_deuda_orig, $quebra_esc_anio_periodo_orig, $quebra_esc_mes_periodo_orig, $quebra_cl_nombre_orig, $quebra_cl_telefono_orig, $quebra_cl_celular_orig, $quebra_cl_email_orig, $quebra_des_ruta_orig, $quebra_op_estado_orig)
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['where_pesq']; 
     $campos_order = "";
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['SC_Gb_Free_sql'] as $cmp_var => $resto)
     {
...
//
   ...
   function html_grid_search()
   {
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['grid_pesq'])?'none':'';
       if(!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['ajax_nav'])
       {
          $nm_saida->saida("   <tr id=\"NM_Grid_Search\" ajax='' style='display:" . $str_display . "'>\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['grid_pesq']))
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['grid_pesq'] as $cmp => $def)
           {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['save_grid']))
           {
               return;
           }
           else
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['save_grid']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['grid_pesq']))
           { 
   ...
   function grid_search_add_tag()
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['grid_pesq']) && count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['grid_pesq']) < 9)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
   ...
   function grid_search_esc_tipo_deuda($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['psq_check_ret']['esc_tipo_deuda'] = array();
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['psq_check_ret']['esc_tipo_deuda'][] = trim($rs->fields[0]);
   ...
   function grid_search_esc_mes_periodo($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['psq_check_ret']['esc_mes_periodo'] = array();
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['psq_check_ret']['esc_mes_periodo'][] = trim($rs->fields[0]);
             $nmgp_def_dados .= trim($rs->fields[1]) . "?#?"; 
             $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?"; 
             $rs->MoveNext(); 
          } 
   ...
   function grid_search_esc_anio_periodo($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['psq_check_ret']['esc_anio_periodo'] = array();
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['psq_check_ret']['esc_anio_periodo'][] = trim($rs->fields[0]);
   ...
   function grid_search_des_ruta($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['psq_check_ret']['des_ruta'] = array();
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['psq_check_ret']['des_ruta'][] = trim($rs->fields[0]);
             $nmgp_def_dados .= trim($rs->fields[1]) . "?#?"; 
             $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?"; 
             $rs->MoveNext(); 
          } 
   ...
   function grid_search_op_estado($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['psq_check_ret']['op_estado'] = array();
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['psq_check_ret']['op_estado'][] = trim($rs->fields[0]);
             $nmgp_def_dados .= trim($rs->fields[1]) . "?#?"; 
             $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?"; 
             $rs->MoveNext(); 
          } 
      ...
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
          ...
          { 
            ...
            $cmp1 = grid_v_jap_otras_emisiones_pack_protect_string($cmp1);
            $nmgp_def_dados[] = array($cmp1 => $cmp1); 
             $rs->MoveNext(); 
          } 
          $rs->Close(); 
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "SIJAP/grid_v_jap_otras_emisiones";
   ...
   function JS_grid_search()
   {
       ...
       $nm_saida->saida(" function sc_grid_v_jap_otras_emisiones_valida_mes(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida(" function sc_grid_v_jap_otras_emisiones_valida_dia(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['esc_fecha_mes'] =  'sc_grid_v_jap_otras_emisiones_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['esc_fecha_dia'] =  'sc_grid_v_jap_otras_emisiones_valida_dia(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['esc_fecha_v2__mes'] =  'sc_grid_v_jap_otras_emisiones_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['esc_fecha_v2__dia'] =  'sc_grid_v_jap_otras_emisiones_valida_dia(this)';\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_otras_emisiones']['ajax_nav'])
       { 
           ...
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['esc_fecha_mes']", 'value' => 'sc_grid_v_jap_otras_emisiones_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['esc_fecha_dia']", 'value' => 'sc_grid_v_jap_otras_emisiones_valida_dia(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['esc_fecha_v2__mes']", 'value' => 'sc_grid_v_jap_otras_emisiones_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['esc_fecha_v2__dia']", 'value' => 'sc_grid_v_jap_otras_emisiones_valida_dia(this)');
       } 
