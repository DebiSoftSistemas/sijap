...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_fac_factura"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_fac_factura"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_fac_factura']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_fac_factura']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_fac_factura']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_fac_factura']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_fac_factura']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_fac_factura']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_fac_factura']['embutida_filho'] as $ind => $sc_init)
          {
