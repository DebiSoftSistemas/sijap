...
class grid_fac_factura_total
{
   ...
   function quebra_geral_sc_free_total($res_limit=false, $res_export=false)
   {
      ...
      { 
          $nm_comando = "select count(*), sum(fac_subtotal), sum(fac_total_iva), sum(fac_total) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_factura']['where_pesq']; 
      } 
