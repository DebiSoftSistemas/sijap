...
// 
   ...
   $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_factura']['tot_geral'][1];
       ...
       $this->sum_fac_total_iva = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_factura']['tot_geral'][3];
       $this->sum_fac_total = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_factura']['tot_geral'][4];
       }
...
//----- 
   ...
   { 
       $nmgp_select = "SELECT fac_numero, fac_serie, fac_numero_doc, fac_cliente, str_replace (convert(char(10),fac_fecha,102), '.', '-') + ' ' + convert(char(8),fac_fecha,20), fac_subtotal, fac_total_iva, fac_total, fac_estado_sri, fac_estado from " . $this->Ini->nm_tabela; 
   } 
   elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
   { 
       $nmgp_select = "SELECT fac_numero, fac_serie, fac_numero_doc, fac_cliente, fac_fecha, fac_subtotal, fac_total_iva, fac_total, fac_estado_sri, fac_estado from " . $this->Ini->nm_tabela; 
   } 
   elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
   { 
       $nmgp_select = "SELECT fac_numero, fac_serie, fac_numero_doc, fac_cliente, convert(char(23),fac_fecha,121), fac_subtotal, fac_total_iva, fac_total, fac_estado_sri, fac_estado from " . $this->Ini->nm_tabela; 
   } 
   ...
   { 
       $nmgp_select = "SELECT fac_numero, fac_serie, fac_numero_doc, fac_cliente, EXTEND(fac_fecha, YEAR TO DAY), fac_subtotal, fac_total_iva, fac_total, fac_estado_sri, fac_estado from " . $this->Ini->nm_tabela; 
   } 
   else 
   { 
       $nmgp_select = "SELECT fac_numero, fac_serie, fac_numero_doc, fac_cliente, fac_fecha, fac_subtotal, fac_total_iva, fac_total, fac_estado_sri, fac_estado from " . $this->Ini->nm_tabela; 
   ...
   { 
       ...
       $this->fac_total_iva = $this->rs_grid->fields[6] ;  
       ...
       $this->fac_estado = $this->rs_grid->fields[9] ;  
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       { 
           ...
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_fac_factura_jquery_1134.js\"></script>\r\n");
...
$nm_saida->saida("    </style>\r\n");
   ...
   {
       $lin_obj  = "";
       $All_cmp_search = array('fac_fecha','fac_cliente','fac_serie','fac_numero_doc','fac_estado_sri');
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_factura']['pesq_tab_label'];
       if (!empty($nmgp_tab_label))
       {
          $nm_tab_campos = explode("?@?", $nmgp_tab_label);
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_factura']['grid_pesq']) && count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_factura']['grid_pesq']) < 5)
       {
