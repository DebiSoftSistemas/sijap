<?php
class form_seleccion_cliente_escenario_form extends form_seleccion_cliente_escenario_apl
{
function Form_Init()
{
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['sc_redir_atualiz'] == 'ok')
{
?>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_seleccion_cliente_escenario/form_seleccion_cliente_escenario_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_seleccion_cliente_escenario_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_seleccion_cliente_escenario_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['recarga'];
}
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    $opcao_botoes = 'inicio';
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['link_info']['remove_border']) {
...
<?php
 include_once("form_seleccion_cliente_escenario_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_seleccion_cliente_escenario'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_seleccion_cliente_escenario'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['run_iframe'] != "R")
{
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['fast_search'][2] : "";
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_disabled']['']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_disabled']['']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_label']['']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_label']['']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_label'][''];
        }
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_disabled']['balterarsel']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_disabled']['balterarsel']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_label']['balterarsel']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_label']['balterarsel']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_label']['balterarsel'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-4';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_seleccion_cliente_escenario);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_seleccion_cliente_escenario = $this->form_vert_form_seleccion_cliente_escenario;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_seleccion_cliente_escenario))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_form_seleccion_cliente_escenario as $sc_seq_vert => $sc_lixo)
   {
       $this->form_fixed_column_no = 0;
       $this->loadRecordState($sc_seq_vert);
       $this->cl_empresa_ = $this->form_vert_form_seleccion_cliente_escenario[$sc_seq_vert]['cl_empresa_'];
       $this->cl_tipo_identificacion_ = $this->form_vert_form_seleccion_cliente_escenario[$sc_seq_vert]['cl_tipo_identificacion_'];
       $this->cl_pais_ = $this->form_vert_form_seleccion_cliente_escenario[$sc_seq_vert]['cl_pais_'];
       $this->cl_provincia_ = $this->form_vert_form_seleccion_cliente_escenario[$sc_seq_vert]['cl_provincia_'];
       $this->cl_ciudad_ = $this->form_vert_form_seleccion_cliente_escenario[$sc_seq_vert]['cl_ciudad_'];
       ...
       elseif ($Line_Add)
       {
        ...
        $this->cl_id_ = $this->form_vert_form_seleccion_cliente_escenario[$sc_seq_vert]['cl_id_']; 
       $cl_id_ = $this->cl_id_; 
       if (!isset($this->nmgp_cmp_hidden['cl_id_']))
       {
           $this->nmgp_cmp_hidden['cl_id_'] = 'off';
       ...
       $this->seleccionar_ = $this->form_vert_form_seleccion_cliente_escenario[$sc_seq_vert]['seleccionar_']; 
       ...
       $this->cl_nombre_ = $this->form_vert_form_seleccion_cliente_escenario[$sc_seq_vert]['cl_nombre_']; 
       ...
       $this->cl_identificacion_ = $this->form_vert_form_seleccion_cliente_escenario[$sc_seq_vert]['cl_identificacion_']; 
       ...
       $this->cl_direccion_ = $this->form_vert_form_seleccion_cliente_escenario[$sc_seq_vert]['cl_direccion_']; 
       ...
       $this->cl_telefono_ = $this->form_vert_form_seleccion_cliente_escenario[$sc_seq_vert]['cl_telefono_']; 
       ...
       $this->cl_celular_ = $this->form_vert_form_seleccion_cliente_escenario[$sc_seq_vert]['cl_celular_']; 
       ...
       $this->cl_email_ = $this->form_vert_form_seleccion_cliente_escenario[$sc_seq_vert]['cl_email_']; 
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_seleccion_cliente_escenario_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_seleccion_cliente_escenario_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_seleccion_cliente_escenario_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_seleccion_cliente_escenario_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_seleccion_cliente_escenario_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_seleccion_cliente_escenario_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['Lookup_seleccionar_'][] = 'S'; ?>
...
<?php   
   ...
   { 
       ...
       $this->form_vert_form_seleccion_cliente_escenario = $guarda_form_vert_form_seleccion_cliente_escenario;
   } 
   if ($Table_refresh) 
   { 
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_disabled']['birpara']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_disabled']['birpara']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_label']['birpara']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_label']['birpara']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_label']['birpara'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['btn_label']['last'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_seleccion_cliente_escenario");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_seleccion_cliente_escenario");
 parent.scAjaxDetailHeight("form_seleccion_cliente_escenario", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
