  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_seleccion_cliente_escenario" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_seleccion_cliente_escenario_form();
	}
...
?>
  ...
  // ---------- Validate cl_id_
  function do_ajax_form_seleccion_cliente_escenario_validate_cl_id_(iNumLinha)
  {
    var nomeCampo_cl_id_ = "cl_id_" + iNumLinha;
    var var_cl_id_ = scAjaxGetFieldText(nomeCampo_cl_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_seleccion_cliente_escenario_validate_cl_id_(var_cl_id_, iNumLinha, var_script_case_init, do_ajax_form_seleccion_cliente_escenario_validate_cl_id__cb);
  } // do_ajax_form_seleccion_cliente_escenario_validate_cl_id_

  function do_ajax_form_seleccion_cliente_escenario_validate_cl_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_seleccion_cliente_escenario_validate_cl_id__cb

  // ---------- Validate seleccionar_
  function do_ajax_form_seleccion_cliente_escenario_validate_seleccionar_(iNumLinha)
  {
    var nomeCampo_seleccionar_ = "seleccionar_" + iNumLinha;
    var var_seleccionar_ = scAjaxGetFieldCheckbox(nomeCampo_seleccionar_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_seleccion_cliente_escenario_validate_seleccionar_(var_seleccionar_, iNumLinha, var_script_case_init, do_ajax_form_seleccion_cliente_escenario_validate_seleccionar__cb);
  } // do_ajax_form_seleccion_cliente_escenario_validate_seleccionar_

  function do_ajax_form_seleccion_cliente_escenario_validate_seleccionar__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "seleccionar_" + iLineNumber;
    }
    else
    {
      sFieldValid = "seleccionar_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "seleccionar_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "seleccionar_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_seleccion_cliente_escenario_validate_seleccionar__cb

  // ---------- Validate cl_nombre_
  function do_ajax_form_seleccion_cliente_escenario_validate_cl_nombre_(iNumLinha)
  {
    var nomeCampo_cl_nombre_ = "cl_nombre_" + iNumLinha;
    var var_cl_nombre_ = scAjaxGetFieldHidden(nomeCampo_cl_nombre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_seleccion_cliente_escenario_validate_cl_nombre_(var_cl_nombre_, iNumLinha, var_script_case_init, do_ajax_form_seleccion_cliente_escenario_validate_cl_nombre__cb);
  } // do_ajax_form_seleccion_cliente_escenario_validate_cl_nombre_

  function do_ajax_form_seleccion_cliente_escenario_validate_cl_nombre__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "cl_nombre_" + iLineNumber;
    }
    else
    {
      sFieldValid = "cl_nombre_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "cl_nombre_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "cl_nombre_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_seleccion_cliente_escenario_validate_cl_nombre__cb

  // ---------- Validate cl_identificacion_
  function do_ajax_form_seleccion_cliente_escenario_validate_cl_identificacion_(iNumLinha)
  {
    var nomeCampo_cl_identificacion_ = "cl_identificacion_" + iNumLinha;
    var var_cl_identificacion_ = scAjaxGetFieldHidden(nomeCampo_cl_identificacion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_seleccion_cliente_escenario_validate_cl_identificacion_(var_cl_identificacion_, iNumLinha, var_script_case_init, do_ajax_form_seleccion_cliente_escenario_validate_cl_identificacion__cb);
  } // do_ajax_form_seleccion_cliente_escenario_validate_cl_identificacion_

  function do_ajax_form_seleccion_cliente_escenario_validate_cl_identificacion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "cl_identificacion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "cl_identificacion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "cl_identificacion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "cl_identificacion_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_seleccion_cliente_escenario_validate_cl_identificacion__cb

  // ---------- Validate cl_direccion_
  function do_ajax_form_seleccion_cliente_escenario_validate_cl_direccion_(iNumLinha)
  {
    var nomeCampo_cl_direccion_ = "cl_direccion_" + iNumLinha;
    var var_cl_direccion_ = scAjaxGetFieldHidden(nomeCampo_cl_direccion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_seleccion_cliente_escenario_validate_cl_direccion_(var_cl_direccion_, iNumLinha, var_script_case_init, do_ajax_form_seleccion_cliente_escenario_validate_cl_direccion__cb);
  } // do_ajax_form_seleccion_cliente_escenario_validate_cl_direccion_

  function do_ajax_form_seleccion_cliente_escenario_validate_cl_direccion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "cl_direccion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "cl_direccion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "cl_direccion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "cl_direccion_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_seleccion_cliente_escenario_validate_cl_direccion__cb

  // ---------- Validate cl_telefono_
  function do_ajax_form_seleccion_cliente_escenario_validate_cl_telefono_(iNumLinha)
  {
    var nomeCampo_cl_telefono_ = "cl_telefono_" + iNumLinha;
    var var_cl_telefono_ = scAjaxGetFieldHidden(nomeCampo_cl_telefono_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_seleccion_cliente_escenario_validate_cl_telefono_(var_cl_telefono_, iNumLinha, var_script_case_init, do_ajax_form_seleccion_cliente_escenario_validate_cl_telefono__cb);
  } // do_ajax_form_seleccion_cliente_escenario_validate_cl_telefono_

  function do_ajax_form_seleccion_cliente_escenario_validate_cl_telefono__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "cl_telefono_" + iLineNumber;
    }
    else
    {
      sFieldValid = "cl_telefono_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "cl_telefono_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "cl_telefono_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_seleccion_cliente_escenario_validate_cl_telefono__cb

  // ---------- Validate cl_celular_
  function do_ajax_form_seleccion_cliente_escenario_validate_cl_celular_(iNumLinha)
  {
    var nomeCampo_cl_celular_ = "cl_celular_" + iNumLinha;
    var var_cl_celular_ = scAjaxGetFieldHidden(nomeCampo_cl_celular_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_seleccion_cliente_escenario_validate_cl_celular_(var_cl_celular_, iNumLinha, var_script_case_init, do_ajax_form_seleccion_cliente_escenario_validate_cl_celular__cb);
  } // do_ajax_form_seleccion_cliente_escenario_validate_cl_celular_

  function do_ajax_form_seleccion_cliente_escenario_validate_cl_celular__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "cl_celular_" + iLineNumber;
    }
    else
    {
      sFieldValid = "cl_celular_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "cl_celular_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "cl_celular_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_seleccion_cliente_escenario_validate_cl_celular__cb

  // ---------- Validate cl_email_
  function do_ajax_form_seleccion_cliente_escenario_validate_cl_email_(iNumLinha)
  {
    var nomeCampo_cl_email_ = "cl_email_" + iNumLinha;
    var var_cl_email_ = scAjaxGetFieldHidden(nomeCampo_cl_email_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_seleccion_cliente_escenario_validate_cl_email_(var_cl_email_, iNumLinha, var_script_case_init, do_ajax_form_seleccion_cliente_escenario_validate_cl_email__cb);
  } // do_ajax_form_seleccion_cliente_escenario_validate_cl_email_

  function do_ajax_form_seleccion_cliente_escenario_validate_cl_email__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "cl_email_" + iLineNumber;
    }
    else
    {
      sFieldValid = "cl_email_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "cl_email_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "cl_email_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_seleccion_cliente_escenario_validate_cl_email__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_seleccion_cliente_escenario_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_seleccion_cliente_escenario_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_seleccion_cliente_escenario_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_seleccion_cliente_escenario_add_new_line_cb);
  } // do_ajax_form_seleccion_cliente_escenario_add_new_line

  function do_ajax_form_seleccion_cliente_escenario_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_seleccion_cliente_escenario_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_seleccion_cliente_escenario_backup_line(iNumLinha)
  {
    var var_cl_id_ = scAjaxGetFieldText("cl_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_seleccion_cliente_escenario_backup_line(var_cl_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_seleccion_cliente_escenario_backup_line_cb);
  } // do_ajax_form_seleccion_cliente_escenario_backup_line

  function do_ajax_form_seleccion_cliente_escenario_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_seleccion_cliente_escenario_backup_line_cb

  function do_ajax_form_seleccion_cliente_escenario_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_seleccion_cliente_escenario_cancel_insert

  function do_ajax_form_seleccion_cliente_escenario_cancel_update(iSeqVert)
  {
    do_ajax_form_seleccion_cliente_escenario_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_seleccion_cliente_escenario_cancel_update

  function do_ajax_form_seleccion_cliente_escenario_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_seleccion_cliente_escenario_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_seleccion_cliente_escenario_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_seleccion_cliente_escenario_table_refresh(var_cl_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_seleccion_cliente_escenario_table_refresh_cb);
  } //  do_ajax_form_seleccion_cliente_escenario_table_refresh

  function do_ajax_form_seleccion_cliente_escenario_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_seleccion_cliente_escenario_table_refresh_cb_after_alert);
  } // do_ajax_form_seleccion_cliente_escenario_table_refresh_cb
  function do_ajax_form_seleccion_cliente_escenario_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_seleccion_cliente_escenario_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_seleccion_cliente_escenario_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_seleccion_cliente_escenario_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_cl_id_ = scAjaxGetFieldText("cl_id_" + iNumLinha);
    var var_seleccionar_ = scAjaxGetFieldCheckbox("seleccionar_" + iNumLinha, ";");
    var var_cl_nombre_ = scAjaxGetFieldHidden("cl_nombre_" + iNumLinha);
    var var_cl_identificacion_ = scAjaxGetFieldHidden("cl_identificacion_" + iNumLinha);
    var var_cl_direccion_ = scAjaxGetFieldHidden("cl_direccion_" + iNumLinha);
    var var_cl_telefono_ = scAjaxGetFieldHidden("cl_telefono_" + iNumLinha);
    var var_cl_celular_ = scAjaxGetFieldHidden("cl_celular_" + iNumLinha);
    var var_cl_email_ = scAjaxGetFieldHidden("cl_email_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_seleccion_cliente_escenario_submit_form(var_cl_id_, var_seleccionar_, var_cl_nombre_, var_cl_identificacion_, var_cl_direccion_, var_cl_telefono_, var_cl_celular_, var_cl_email_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_seleccion_cliente_escenario_submit_form_cb);
  } // do_ajax_form_seleccion_cliente_escenario_submit_form

  function do_ajax_form_seleccion_cliente_escenario_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("seleccionar_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("cl_nombre_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("cl_identificacion_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("cl_direccion_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("cl_telefono_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("cl_celular_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("cl_email_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_seleccion_cliente_escenario_submit_form_cb_after_alert);
  } // do_ajax_form_seleccion_cliente_escenario_submit_form_cb
  function do_ajax_form_seleccion_cliente_escenario_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_seleccion_cliente_escenario_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_seleccion_cliente_escenario_navigate_form()
  {
    perform_ajax_form_seleccion_cliente_escenario_navigate_form();
  }

  function perform_ajax_form_seleccion_cliente_escenario_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("seleccionar_" + iNavForm);
      scAjaxHideErrorDisplay("cl_nombre_" + iNavForm);
      scAjaxHideErrorDisplay("cl_identificacion_" + iNavForm);
      scAjaxHideErrorDisplay("cl_direccion_" + iNavForm);
      scAjaxHideErrorDisplay("cl_telefono_" + iNavForm);
      scAjaxHideErrorDisplay("cl_celular_" + iNavForm);
      scAjaxHideErrorDisplay("cl_email_" + iNavForm);
    }
    var var_cl_id_ = document.F2.cl_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_seleccion_cliente_escenario_navigate_form(var_cl_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_seleccion_cliente_escenario_navigate_form_cb);
  } // do_ajax_form_seleccion_cliente_escenario_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_seleccion_cliente_escenario']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_seleccion_cliente_escenario_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxClearErrors()
    scResetFormChanges()
    $("#sc-ui-checkbox-seleccionar_-control").prop("checked", false);
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_seleccion_cliente_escenario_navigate_form_cb_after_alert);
  } // do_ajax_form_seleccion_cliente_escenario_navigate_form_cb
  function do_ajax_form_seleccion_cliente_escenario_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_seleccion_cliente_escenario_navigate_form_cb_after_alert

    function sc_form_seleccion_cliente_escenario_get_last_line_number()
    {
    ...
    } //sc_form_seleccion_cliente_escenario_get_last_line_number

  function sc_hide_form_seleccion_cliente_escenario_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "seleccionar_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "cl_nombre_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "cl_identificacion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "cl_direccion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "cl_telefono_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "cl_celular_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "cl_email_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["cl_id_" + iNumLinha] = {"label": "Cl Id<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["seleccionar_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_seleccion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["cl_nombre_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_cliente'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["cl_identificacion_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_lot_identificacion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["cl_direccion_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_direccion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["cl_telefono_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_lot_telefono'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["cl_celular_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_celular'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["cl_email_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_email'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["cl_id_"][iNumLinha] = "cl_id_" + iNumLinha;
    ajax_field_mult["seleccionar_"][iNumLinha] = "seleccionar_" + iNumLinha;
    ajax_field_mult["cl_nombre_"][iNumLinha] = "cl_nombre_" + iNumLinha;
    ajax_field_mult["cl_identificacion_"][iNumLinha] = "cl_identificacion_" + iNumLinha;
    ajax_field_mult["cl_direccion_"][iNumLinha] = "cl_direccion_" + iNumLinha;
    ajax_field_mult["cl_telefono_"][iNumLinha] = "cl_telefono_" + iNumLinha;
    ajax_field_mult["cl_celular_"][iNumLinha] = "cl_celular_" + iNumLinha;
    ajax_field_mult["cl_email_"][iNumLinha] = "cl_email_" + iNumLinha;
    ajax_field_id["seleccionar_" + iNumLinha] = new Array("hidden_field_label_seleccionar_", "hidden_field_data_seleccionar_" + iNumLinha);
    ajax_field_id["cl_nombre_" + iNumLinha] = new Array("hidden_field_label_cl_nombre_", "hidden_field_data_cl_nombre_" + iNumLinha);
    ajax_field_id["cl_identificacion_" + iNumLinha] = new Array("hidden_field_label_cl_identificacion_", "hidden_field_data_cl_identificacion_" + iNumLinha);
    ajax_field_id["cl_direccion_" + iNumLinha] = new Array("hidden_field_label_cl_direccion_", "hidden_field_data_cl_direccion_" + iNumLinha);
    ajax_field_id["cl_telefono_" + iNumLinha] = new Array("hidden_field_label_cl_telefono_", "hidden_field_data_cl_telefono_" + iNumLinha);
    ajax_field_id["cl_celular_" + iNumLinha] = new Array("hidden_field_label_cl_celular_", "hidden_field_data_cl_celular_" + iNumLinha);
    ajax_field_id["cl_email_" + iNumLinha] = new Array("hidden_field_label_cl_email_", "hidden_field_data_cl_email_" + iNumLinha);
    ajax_error_count["cl_id_" + iNumLinha] = "off";
    ajax_error_count["seleccionar_" + iNumLinha] = "off";
    ajax_error_count["cl_nombre_" + iNumLinha] = "off";
    ajax_error_count["cl_identificacion_" + iNumLinha] = "off";
    ajax_error_count["cl_direccion_" + iNumLinha] = "off";
    ajax_error_count["cl_telefono_" + iNumLinha] = "off";
    ajax_error_count["cl_celular_" + iNumLinha] = "off";
    ajax_error_count["cl_email_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["cl_id_" + iNumLinha] = "on";
    ajax_read_only["seleccionar_" + iNumLinha] = "off";
    ajax_read_only["cl_nombre_" + iNumLinha] = "off";
    ajax_read_only["cl_identificacion_" + iNumLinha] = "off";
    ajax_read_only["cl_direccion_" + iNumLinha] = "off";
    ajax_read_only["cl_telefono_" + iNumLinha] = "off";
    ajax_read_only["cl_celular_" + iNumLinha] = "off";
    ajax_read_only["cl_email_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["cl_id_" + iNumLinha] = "on";
    ajax_read_only["seleccionar_" + iNumLinha] = "on";
    ajax_read_only["cl_nombre_" + iNumLinha] = "on";
    ajax_read_only["cl_identificacion_" + iNumLinha] = "on";
    ajax_read_only["cl_direccion_" + iNumLinha] = "on";
    ajax_read_only["cl_telefono_" + iNumLinha] = "on";
    ajax_read_only["cl_celular_" + iNumLinha] = "on";
    ajax_read_only["cl_email_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["seleccionar_" + iNumLinha] = null;
    ajax_error_list["cl_nombre_" + iNumLinha] = null;
    ajax_error_list["cl_identificacion_" + iNumLinha] = null;
    ajax_error_list["cl_direccion_" + iNumLinha] = null;
    ajax_error_list["cl_telefono_" + iNumLinha] = null;
    ajax_error_list["cl_celular_" + iNumLinha] = null;
    ajax_error_list["cl_email_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "cl_id_": new Array(),
    "seleccionar_": new Array(),
    "cl_nombre_": new Array(),
    "cl_identificacion_": new Array(),
    "cl_direccion_": new Array(),
    "cl_telefono_": new Array(),
    "cl_celular_": new Array(),
    "cl_email_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["seleccionar_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["seleccionar_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["seleccionar_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["seleccionar_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["seleccionar_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["cl_nombre_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["cl_nombre_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["cl_nombre_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["cl_nombre_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["cl_nombre_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["cl_identificacion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["cl_identificacion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["cl_identificacion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["cl_identificacion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["cl_identificacion_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["cl_direccion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["cl_direccion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["cl_direccion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["cl_direccion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["cl_direccion_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["cl_telefono_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["cl_telefono_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["cl_telefono_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["cl_telefono_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["cl_telefono_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["cl_celular_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["cl_celular_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["cl_celular_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["cl_celular_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["cl_celular_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["cl_email_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["cl_email_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["cl_email_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["cl_email_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["cl_email_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['seleccionar_'])) ? $this->nmgp_cmp_readonly['seleccionar_'] : 'off';
?>
    scAjaxFieldRead("seleccionar_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['cl_nombre_'])) ? $this->nmgp_cmp_readonly['cl_nombre_'] : 'off';
?>
    scAjaxFieldRead("cl_nombre_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['cl_identificacion_'])) ? $this->nmgp_cmp_readonly['cl_identificacion_'] : 'off';
?>
    scAjaxFieldRead("cl_identificacion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['cl_direccion_'])) ? $this->nmgp_cmp_readonly['cl_direccion_'] : 'off';
?>
    scAjaxFieldRead("cl_direccion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['cl_telefono_'])) ? $this->nmgp_cmp_readonly['cl_telefono_'] : 'off';
?>
    scAjaxFieldRead("cl_telefono_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['cl_celular_'])) ? $this->nmgp_cmp_readonly['cl_celular_'] : 'off';
?>
    scAjaxFieldRead("cl_celular_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['cl_email_'])) ? $this->nmgp_cmp_readonly['cl_email_'] : 'off';
?>
    scAjaxFieldRead("cl_email_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("cl_id_" + iSeq, "on");
    scAjaxFieldRead("seleccionar_" + iSeq, "on");
    scAjaxFieldRead("cl_nombre_" + iSeq, "on");
    scAjaxFieldRead("cl_identificacion_" + iSeq, "on");
    scAjaxFieldRead("cl_direccion_" + iSeq, "on");
    scAjaxFieldRead("cl_telefono_" + iSeq, "on");
    scAjaxFieldRead("cl_celular_" + iSeq, "on");
    scAjaxFieldRead("cl_email_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["cl_id_" + iRow] || "on" == ajax_error_count["seleccionar_" + iRow] || "on" == ajax_error_count["cl_nombre_" + iRow] || "on" == ajax_error_count["cl_identificacion_" + iRow] || "on" == ajax_error_count["cl_direccion_" + iRow] || "on" == ajax_error_count["cl_telefono_" + iRow] || "on" == ajax_error_count["cl_celular_" + iRow] || "on" == ajax_error_count["cl_email_" + iRow]))
    {
      ...
      $("#hidden_field_data_seleccionar_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_cl_nombre_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_cl_identificacion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_cl_direccion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_cl_telefono_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_cl_celular_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_cl_email_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["cl_id_" + iRow] && "off" == ajax_error_count["seleccionar_" + iRow] && "off" == ajax_error_count["cl_nombre_" + iRow] && "off" == ajax_error_count["cl_identificacion_" + iRow] && "off" == ajax_error_count["cl_direccion_" + iRow] && "off" == ajax_error_count["cl_telefono_" + iRow] && "off" == ajax_error_count["cl_celular_" + iRow] && "off" == ajax_error_count["cl_email_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["cl_id_" + iRow] = "off";
        ajax_error_count["seleccionar_" + iRow] = "off";
        ajax_error_count["cl_nombre_" + iRow] = "off";
        ajax_error_count["cl_identificacion_" + iRow] = "off";
        ajax_error_count["cl_direccion_" + iRow] = "off";
        ajax_error_count["cl_telefono_" + iRow] = "off";
        ajax_error_count["cl_celular_" + iRow] = "off";
        ajax_error_count["cl_email_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_seleccionar_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_cl_nombre_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_cl_identificacion_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_cl_direccion_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_cl_telefono_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_cl_celular_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_cl_email_" + iRow).removeClass("scFormErrorLine");
    }
  }
