  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_fac_cuenta_bancaria" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_fac_cuenta_bancaria_form();
	}
...
?>
  ...
  // ---------- Validate cb_id
  function do_ajax_form_fac_cuenta_bancaria_validate_cb_id()
  {
    var nomeCampo_cb_id = "cb_id";
    var var_cb_id = scAjaxGetFieldHidden(nomeCampo_cb_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_cuenta_bancaria_validate_cb_id(var_cb_id, var_script_case_init, do_ajax_form_fac_cuenta_bancaria_validate_cb_id_cb);
  } // do_ajax_form_fac_cuenta_bancaria_validate_cb_id

  function do_ajax_form_fac_cuenta_bancaria_validate_cb_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_cuenta_bancaria_validate_cb_id_cb

  // ---------- Validate cb_banco
  function do_ajax_form_fac_cuenta_bancaria_validate_cb_banco()
  {
    var nomeCampo_cb_banco = "cb_banco";
    var var_cb_banco = scAjaxGetFieldSelect(nomeCampo_cb_banco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_cuenta_bancaria_validate_cb_banco(var_cb_banco, var_script_case_init, do_ajax_form_fac_cuenta_bancaria_validate_cb_banco_cb);
  } // do_ajax_form_fac_cuenta_bancaria_validate_cb_banco

  function do_ajax_form_fac_cuenta_bancaria_validate_cb_banco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_cuenta_bancaria_validate_cb_banco_cb

  // ---------- Validate cb_tipo_cuenta
  function do_ajax_form_fac_cuenta_bancaria_validate_cb_tipo_cuenta()
  {
    var nomeCampo_cb_tipo_cuenta = "cb_tipo_cuenta";
    var var_cb_tipo_cuenta = scAjaxGetFieldSelect(nomeCampo_cb_tipo_cuenta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_cuenta_bancaria_validate_cb_tipo_cuenta(var_cb_tipo_cuenta, var_script_case_init, do_ajax_form_fac_cuenta_bancaria_validate_cb_tipo_cuenta_cb);
  } // do_ajax_form_fac_cuenta_bancaria_validate_cb_tipo_cuenta

  function do_ajax_form_fac_cuenta_bancaria_validate_cb_tipo_cuenta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_cuenta_bancaria_validate_cb_tipo_cuenta_cb

  // ---------- Validate cb_numero_cuenta
  function do_ajax_form_fac_cuenta_bancaria_validate_cb_numero_cuenta()
  {
    var nomeCampo_cb_numero_cuenta = "cb_numero_cuenta";
    var var_cb_numero_cuenta = scAjaxGetFieldText(nomeCampo_cb_numero_cuenta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_cuenta_bancaria_validate_cb_numero_cuenta(var_cb_numero_cuenta, var_script_case_init, do_ajax_form_fac_cuenta_bancaria_validate_cb_numero_cuenta_cb);
  } // do_ajax_form_fac_cuenta_bancaria_validate_cb_numero_cuenta

  function do_ajax_form_fac_cuenta_bancaria_validate_cb_numero_cuenta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_cuenta_bancaria_validate_cb_numero_cuenta_cb

  // ---------- Validate cb_cuenta_contable
  function do_ajax_form_fac_cuenta_bancaria_validate_cb_cuenta_contable()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_cuenta_bancaria_validate_cb_cuenta_contable(var_cb_cuenta_contable, var_script_case_init, do_ajax_form_fac_cuenta_bancaria_validate_cb_cuenta_contable_cb);
  } // do_ajax_form_fac_cuenta_bancaria_validate_cb_cuenta_contable

  function do_ajax_form_fac_cuenta_bancaria_validate_cb_cuenta_contable_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_cuenta_bancaria_validate_cb_cuenta_contable_cb

  // ---------- Validate cb_estado
  function do_ajax_form_fac_cuenta_bancaria_validate_cb_estado()
  {
    var nomeCampo_cb_estado = "cb_estado";
    var var_cb_estado = scAjaxGetFieldSelect(nomeCampo_cb_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_cuenta_bancaria_validate_cb_estado(var_cb_estado, var_script_case_init, do_ajax_form_fac_cuenta_bancaria_validate_cb_estado_cb);
  } // do_ajax_form_fac_cuenta_bancaria_validate_cb_estado

  function do_ajax_form_fac_cuenta_bancaria_validate_cb_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_cuenta_bancaria_validate_cb_estado_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_fac_cuenta_bancaria_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_fac_cuenta_bancaria_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_fac_cuenta_bancaria_submit_form(var_cb_id, var_cb_banco, var_cb_tipo_cuenta, var_cb_numero_cuenta, var_cb_cuenta_contable, var_cb_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_fac_cuenta_bancaria_submit_form_cb);
  } // do_ajax_form_fac_cuenta_bancaria_submit_form

  function do_ajax_form_fac_cuenta_bancaria_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_fac_cuenta_bancaria_submit_form_cb_after_alert);
  } // do_ajax_form_fac_cuenta_bancaria_submit_form_cb
  function do_ajax_form_fac_cuenta_bancaria_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_fac_cuenta_bancaria_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_fac_cuenta_bancaria_navigate_form()
  {
    perform_ajax_form_fac_cuenta_bancaria_navigate_form();
  }

  function perform_ajax_form_fac_cuenta_bancaria_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_fac_cuenta_bancaria_navigate_form(var_cb_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_cuenta_bancaria_navigate_form_cb);
  } // do_ajax_form_fac_cuenta_bancaria_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_cuenta_bancaria']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_fac_cuenta_bancaria_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_fac_cuenta_bancaria_navigate_form_cb_after_alert);
  } // do_ajax_form_fac_cuenta_bancaria_navigate_form_cb
  function do_ajax_form_fac_cuenta_bancaria_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_fac_cuenta_bancaria_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_fac_cuenta_bancaria_navigate_form_cb_after_alert

  function sc_hide_form_fac_cuenta_bancaria_form()
  {
