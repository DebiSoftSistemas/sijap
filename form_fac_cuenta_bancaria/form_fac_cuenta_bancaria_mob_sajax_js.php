  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_fac_cuenta_bancaria_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_fac_cuenta_bancaria_mob_form();
	}
...
?>
  ...
  // ---------- Validate cb_id
  function do_ajax_form_fac_cuenta_bancaria_mob_validate_cb_id()
  {
    var nomeCampo_cb_id = "cb_id";
    var var_cb_id = scAjaxGetFieldHidden(nomeCampo_cb_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_cuenta_bancaria_mob_validate_cb_id(var_cb_id, var_script_case_init, do_ajax_form_fac_cuenta_bancaria_mob_validate_cb_id_cb);
  } // do_ajax_form_fac_cuenta_bancaria_mob_validate_cb_id

  function do_ajax_form_fac_cuenta_bancaria_mob_validate_cb_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_cuenta_bancaria_mob_validate_cb_id_cb

  // ---------- Validate cb_banco
  function do_ajax_form_fac_cuenta_bancaria_mob_validate_cb_banco()
  {
    var nomeCampo_cb_banco = "cb_banco";
    var var_cb_banco = scAjaxGetFieldSelect(nomeCampo_cb_banco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_cuenta_bancaria_mob_validate_cb_banco(var_cb_banco, var_script_case_init, do_ajax_form_fac_cuenta_bancaria_mob_validate_cb_banco_cb);
  } // do_ajax_form_fac_cuenta_bancaria_mob_validate_cb_banco

  function do_ajax_form_fac_cuenta_bancaria_mob_validate_cb_banco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cb_banco";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_cuenta_bancaria_mob_validate_cb_banco_cb

  // ---------- Validate cb_tipo_cuenta
  function do_ajax_form_fac_cuenta_bancaria_mob_validate_cb_tipo_cuenta()
  {
    var nomeCampo_cb_tipo_cuenta = "cb_tipo_cuenta";
    var var_cb_tipo_cuenta = scAjaxGetFieldSelect(nomeCampo_cb_tipo_cuenta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_cuenta_bancaria_mob_validate_cb_tipo_cuenta(var_cb_tipo_cuenta, var_script_case_init, do_ajax_form_fac_cuenta_bancaria_mob_validate_cb_tipo_cuenta_cb);
  } // do_ajax_form_fac_cuenta_bancaria_mob_validate_cb_tipo_cuenta

  function do_ajax_form_fac_cuenta_bancaria_mob_validate_cb_tipo_cuenta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cb_tipo_cuenta";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_cuenta_bancaria_mob_validate_cb_tipo_cuenta_cb

  // ---------- Validate cb_numero_cuenta
  function do_ajax_form_fac_cuenta_bancaria_mob_validate_cb_numero_cuenta()
  {
    var nomeCampo_cb_numero_cuenta = "cb_numero_cuenta";
    var var_cb_numero_cuenta = scAjaxGetFieldText(nomeCampo_cb_numero_cuenta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_cuenta_bancaria_mob_validate_cb_numero_cuenta(var_cb_numero_cuenta, var_script_case_init, do_ajax_form_fac_cuenta_bancaria_mob_validate_cb_numero_cuenta_cb);
  } // do_ajax_form_fac_cuenta_bancaria_mob_validate_cb_numero_cuenta

  function do_ajax_form_fac_cuenta_bancaria_mob_validate_cb_numero_cuenta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cb_numero_cuenta";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_cuenta_bancaria_mob_validate_cb_numero_cuenta_cb

  // ---------- Validate cb_cuenta_contable
  function do_ajax_form_fac_cuenta_bancaria_mob_validate_cb_cuenta_contable()
  {
    var nomeCampo_cb_cuenta_contable = "cb_cuenta_contable";
    var var_cb_cuenta_contable = scAjaxGetFieldText(nomeCampo_cb_cuenta_contable);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_cuenta_bancaria_mob_validate_cb_cuenta_contable(var_cb_cuenta_contable, var_script_case_init, do_ajax_form_fac_cuenta_bancaria_mob_validate_cb_cuenta_contable_cb);
  } // do_ajax_form_fac_cuenta_bancaria_mob_validate_cb_cuenta_contable

  function do_ajax_form_fac_cuenta_bancaria_mob_validate_cb_cuenta_contable_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cb_cuenta_contable";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_cuenta_bancaria_mob_validate_cb_cuenta_contable_cb

  // ---------- Validate cb_estado
  function do_ajax_form_fac_cuenta_bancaria_mob_validate_cb_estado()
  {
    var nomeCampo_cb_estado = "cb_estado";
    var var_cb_estado = scAjaxGetFieldSelect(nomeCampo_cb_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_cuenta_bancaria_mob_validate_cb_estado(var_cb_estado, var_script_case_init, do_ajax_form_fac_cuenta_bancaria_mob_validate_cb_estado_cb);
  } // do_ajax_form_fac_cuenta_bancaria_mob_validate_cb_estado

  function do_ajax_form_fac_cuenta_bancaria_mob_validate_cb_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cb_estado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_cuenta_bancaria_mob_validate_cb_estado_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_fac_cuenta_bancaria_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_fac_cuenta_bancaria_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_cb_id = scAjaxGetFieldHidden("cb_id");
    var var_cb_banco = scAjaxGetFieldSelect("cb_banco");
    var var_cb_tipo_cuenta = scAjaxGetFieldSelect("cb_tipo_cuenta");
    var var_cb_numero_cuenta = scAjaxGetFieldText("cb_numero_cuenta");
    var var_cb_cuenta_contable = scAjaxGetFieldText("cb_cuenta_contable");
    var var_cb_estado = scAjaxGetFieldSelect("cb_estado");
    ...
    scAjaxProcOn();
    x_ajax_form_fac_cuenta_bancaria_mob_submit_form(var_cb_id, var_cb_banco, var_cb_tipo_cuenta, var_cb_numero_cuenta, var_cb_cuenta_contable, var_cb_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_fac_cuenta_bancaria_mob_submit_form_cb);
  } // do_ajax_form_fac_cuenta_bancaria_mob_submit_form

  function do_ajax_form_fac_cuenta_bancaria_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("cb_id");
      scAjaxHideErrorDisplay("cb_banco");
      scAjaxHideErrorDisplay("cb_tipo_cuenta");
      scAjaxHideErrorDisplay("cb_numero_cuenta");
      scAjaxHideErrorDisplay("cb_cuenta_contable");
      scAjaxHideErrorDisplay("cb_estado");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_fac_cuenta_bancaria_mob_submit_form_cb_after_alert);
  } // do_ajax_form_fac_cuenta_bancaria_mob_submit_form_cb
  function do_ajax_form_fac_cuenta_bancaria_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_fac_cuenta_bancaria_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_fac_cuenta_bancaria_mob_navigate_form()
  {
    perform_ajax_form_fac_cuenta_bancaria_mob_navigate_form();
  }

  function perform_ajax_form_fac_cuenta_bancaria_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("cb_cuenta_contable");
    scAjaxHideErrorDisplay("cb_estado");
    var var_cb_id = document.F2.cb_id.value;
    ...
    scAjaxProcOn();
    x_ajax_form_fac_cuenta_bancaria_mob_navigate_form(var_cb_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_cuenta_bancaria_mob_navigate_form_cb);
  } // do_ajax_form_fac_cuenta_bancaria_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_cuenta_bancaria_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_fac_cuenta_bancaria_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.cb_id.value = scAjaxGetKeyValue("cb_id");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_fac_cuenta_bancaria_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_fac_cuenta_bancaria_mob_navigate_form_cb
  function do_ajax_form_fac_cuenta_bancaria_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_fac_cuenta_bancaria_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_fac_cuenta_bancaria_mob_navigate_form_cb_after_alert

  function sc_hide_form_fac_cuenta_bancaria_mob_form()
  {
  ...
  ajax_field_list[0] = "cb_id";
  ajax_field_list[1] = "cb_banco";
  ajax_field_list[2] = "cb_tipo_cuenta";
  ajax_field_list[3] = "cb_numero_cuenta";
  ajax_field_list[4] = "cb_cuenta_contable";
  ajax_field_list[5] = "cb_estado";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "cb_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cb_banco": {"label": "<?php echo $this->Ini->Nm_lang['lang_banco'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cb_tipo_cuenta": {"label": "<?php echo $this->Ini->Nm_lang['lang_tipo_cuenta'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cb_numero_cuenta": {"label": "<?php echo $this->Ini->Nm_lang['lang_numero_cuenta'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cb_cuenta_contable": {"label": "<?php echo $this->Ini->Nm_lang['lang_cuenta_contable'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cb_estado": {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "cb_id": new Array(),
    "cb_banco": new Array(),
    "cb_tipo_cuenta": new Array(),
    "cb_numero_cuenta": new Array(),
    "cb_cuenta_contable": new Array(),
    "cb_estado": new Array()
  };
  ajax_field_mult["cb_id"][1] = "cb_id";
  ajax_field_mult["cb_banco"][1] = "cb_banco";
  ajax_field_mult["cb_tipo_cuenta"][1] = "cb_tipo_cuenta";
  ajax_field_mult["cb_numero_cuenta"][1] = "cb_numero_cuenta";
  ajax_field_mult["cb_cuenta_contable"][1] = "cb_cuenta_contable";
  ajax_field_mult["cb_estado"][1] = "cb_estado";

  var ajax_field_id = {
    "cb_id": new Array("hidden_field_label_cb_id", "hidden_field_data_cb_id"),
    "cb_banco": new Array("hidden_field_label_cb_banco", "hidden_field_data_cb_banco"),
    "cb_tipo_cuenta": new Array("hidden_field_label_cb_tipo_cuenta", "hidden_field_data_cb_tipo_cuenta"),
    "cb_numero_cuenta": new Array("hidden_field_label_cb_numero_cuenta", "hidden_field_data_cb_numero_cuenta"),
    "cb_cuenta_contable": new Array("hidden_field_label_cb_cuenta_contable", "hidden_field_data_cb_cuenta_contable"),
    "cb_estado": new Array("hidden_field_label_cb_estado", "hidden_field_data_cb_estado")
  };
  ...
  var ajax_read_only = {
    ...
    "cb_banco": "off",
    "cb_tipo_cuenta": "off",
    "cb_numero_cuenta": "off",
    "cb_cuenta_contable": "off",
    "cb_estado": "off"
  };
