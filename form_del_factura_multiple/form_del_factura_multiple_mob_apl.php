<?php
//
class form_del_factura_multiple_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_del_factura_multiple_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_del_factura_multiple_mob']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_del_factura_multiple_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_del_factura_multiple_mob']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_del_factura_multiple_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_del_factura_multiple_mob']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_del_factura_multiple_mob']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_del_factura_multiple_mob']['form_del_detalle_factura_multiple_mob_script_case_init'] ]['form_del_detalle_factura_multiple_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_del_factura_multiple_mob']['form_del_detalle_factura_multiple_mob_script_case_init'] ]['form_del_detalle_factura_multiple_mob']['total']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_del_factura_multiple_mob']['form_del_forma_pago_factura_multiple_mob_script_case_init'] ]['form_del_forma_pago_factura_multiple_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_del_factura_multiple_mob']['form_del_forma_pago_factura_multiple_mob_script_case_init'] ]['form_del_forma_pago_factura_multiple_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_del_factura_multiple_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_del_factura_multiple_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->var_id_factura)) 
          {
              $_SESSION['var_id_factura'] = $this->var_id_factura;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_del_factura_multiple_mob']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_del_factura_multiple_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_del_factura_multiple_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_del_factura_multiple_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_del_factura_multiple_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_del_factura_multiple_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_del_factura_multiple_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_del_factura_multiple_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_del_factura_multiple_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_del_factura_multiple_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_factura_multiple']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_del_factura_multiple'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_del_factura_multiple_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['form_del_factura_multiple_mob']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_del_factura_multiple_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_del_factura_multiple_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_del_factura_multiple_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_del_factura_multiple_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_del_factura_multiple_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_del_factura_multiple_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " del_factura";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_del_factura_multiple_mob")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_del_factura_multiple_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_del_factura_multiple_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_factura_multiple_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_del_factura_multiple_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_factura_multiple_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_del_factura_multiple_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_factura_multiple_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_del_factura_multiple_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['where_orig'] = " where (fac_numero=" . $_SESSION['var_id_factura'] . ")";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['where_pesq'] = " where (fac_numero=" . $_SESSION['var_id_factura'] . ")";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_factura_multiple_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_del_factura_multiple_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_del_factura_multiple_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_factura_multiple_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_del_factura_multiple_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_del_factura_multiple_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_factura_multiple_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_factura_multiple_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_del_factura_multiple_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_del_factura_multiple_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_factura_multiple_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_factura_multiple_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_del_factura_multiple_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_factura_multiple_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_factura_multiple_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_del_factura_multiple_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_factura_multiple_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_del_factura_multiple_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_del_factura_multiple_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_factura_multiple_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_del_factura_multiple_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_del_factura_multiple_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_factura_multiple_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_factura_multiple_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_del_factura_multiple_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dados_form'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_del_factura_multiple/form_del_factura_multiple_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_del_factura_multiple_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_del_factura_multiple_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_del_factura_multiple_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_del_factura_multiple/form_del_factura_multiple_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_del_factura_multiple_mob_erro.class.php"); 
      }
      $this->Erro      = new form_del_factura_multiple_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['opcao']))
         { 
             if ($this->fac_numero != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_factura_multiple_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_factura_multiple_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_del_factura_multiple_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['opc_ant'] : "";
      } 
      ...
      {
          $this->nmgp_botoes['Nuevo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['botoes']['Nuevo'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_detalle_factura_multiple_mob_script_case_init'] ]['form_del_detalle_factura_multiple_mob']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_detalle_factura_multiple_mob_script_case_init'] ]['form_del_detalle_factura_multiple_mob']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_detalle_factura_multiple_mob_script_case_init'] ]['form_del_detalle_factura_multiple_mob']['reg_start'] = "";
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_detalle_factura_multiple_mob_script_case_init'] ]['form_del_detalle_factura_multiple']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_detalle_factura_multiple_mob_script_case_init'] ]['form_del_detalle_factura_multiple']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_detalle_factura_multiple_mob_script_case_init'] ]['form_del_detalle_factura_multiple']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_detalle_factura_multiple_mob_script_case_init'] ]['form_del_detalle_factura_multiple_mob']['total']);
          $detailAppName = 'form_del_detalle_factura_multiple_mob';
          $detailAppObject = "form_del_detalle_factura_multiple_mob";
          ...
          $this->form_del_detalle_factura_multiple_mob = new $detailAppObject;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_forma_pago_factura_multiple_mob_script_case_init'] ]['form_del_forma_pago_factura_multiple_mob']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_forma_pago_factura_multiple_mob_script_case_init'] ]['form_del_forma_pago_factura_multiple_mob']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_forma_pago_factura_multiple_mob_script_case_init'] ]['form_del_forma_pago_factura_multiple_mob']['reg_start'] = "";
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_forma_pago_factura_multiple_mob_script_case_init'] ]['form_del_forma_pago_factura_multiple']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_forma_pago_factura_multiple_mob_script_case_init'] ]['form_del_forma_pago_factura_multiple']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_forma_pago_factura_multiple_mob_script_case_init'] ]['form_del_forma_pago_factura_multiple']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_forma_pago_factura_multiple_mob_script_case_init'] ]['form_del_forma_pago_factura_multiple_mob']['total']);
          $detailAppName = 'form_del_forma_pago_factura_multiple_mob';
          $detailAppObject = "form_del_forma_pago_factura_multiple_mob";
          $detailAppFolder = $this->Ini->root . $this->Ini->path_link  . SC_dir_app_name($detailAppName);
          if (!@is_dir($detailAppFolder)) {
              $detailAppName = substr($detailAppName, 0, -4);
              $detailAppObject = substr($detailAppObject, 0, -4);
          ...
          require_once($detailAppFolder . "/index.php");
          require_once($detailAppFolder . "/{$detailAppName}_apl.php");
          $this->form_del_forma_pago_factura_multiple_mob = new $detailAppObject;
      }
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_del_factura_multiple_mob']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_del_factura_multiple_mob']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dados_select'];
     }
   }
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['Gera_log_access'] = false;
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dados_select']['establecimiento']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->establecimiento = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dados_select']['establecimiento'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dados_select']['punto_emision']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->punto_emision = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dados_select']['punto_emision'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dados_select']['tipo_libretin']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tipo_libretin = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dados_select']['tipo_libretin'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dados_select']['ambiente']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->ambiente = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dados_select']['ambiente'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dados_select']['fac_subtotal']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fac_subtotal = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dados_select']['fac_subtotal'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dados_select']['fac_subtotal_iva']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fac_subtotal_iva = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dados_select']['fac_subtotal_iva'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dados_select']['fac_subtotal_cero']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fac_subtotal_cero = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dados_select']['fac_subtotal_cero'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dados_select']['fac_subtotal_no_objeto']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fac_subtotal_no_objeto = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dados_select']['fac_subtotal_no_objeto'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dados_select']['fac_subtotal_excento']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fac_subtotal_excento = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dados_select']['fac_subtotal_excento'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dados_select']['fac_total_descuento']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fac_total_descuento = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dados_select']['fac_total_descuento'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dados_select']['fac_valor_ice']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fac_valor_ice = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dados_select']['fac_valor_ice'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dados_select']['fac_valor_iva']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fac_valor_iva = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dados_select']['fac_valor_iva'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dados_select']['fac_valor_irbpnr']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fac_valor_irbpnr = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dados_select']['fac_valor_irbpnr'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dados_select']['fac_propina']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fac_propina = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dados_select']['fac_propina'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dados_select']['fac_total']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fac_total = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dados_select']['fac_total'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['recarga'] = $this->nmgp_opcao;
      }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_del_factura_multiple_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_del_factura_multiple_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_del_factura_multiple_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="form_del_factura_multiple_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_del_factura_multiple_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sis_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'form_del_factura_multiple_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_del_factura_multiple_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_del_factura_multiple_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_del_factura_multiple_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_del_factura_multiple_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_del_factura_multiple_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
   ...
   if (isset($this->Field_no_validate['fac_libretin'])) {
      ...
      if ($this->fac_libretin == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['php_cmp_required']['fac_libretin']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['php_cmp_required']['fac_libretin'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->fac_libretin) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['Lookup_fac_libretin']) && !in_array($this->fac_libretin, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['Lookup_fac_libretin']))
          {
              $hasError = true;
...
;
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['fac_numero']['keyVal'] = form_del_factura_multiple_mob_pack_protect_string($this->nmgp_dados_form['fac_numero']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_detalle_factura_multiple_mob_script_case_init'] ]['form_del_detalle_factura_multiple_mob']['foreign_key']['df_factura_multiple'] = $this->nmgp_dados_form['fac_numero'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_detalle_factura_multiple_mob_script_case_init'] ]['form_del_detalle_factura_multiple_mob']['foreign_key']['df_empresa'] = $this->nmgp_dados_form['fac_empresa'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_detalle_factura_multiple_mob_script_case_init'] ]['form_del_detalle_factura_multiple_mob']['where_filter'] = "df_factura_multiple = " . $this->nmgp_dados_form['fac_numero'] . " AND df_empresa = '" . $this->nmgp_dados_form['fac_empresa'] . "'";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_detalle_factura_multiple_mob_script_case_init'] ]['form_del_detalle_factura_multiple_mob']['where_detal']  = "df_factura_multiple = " . $this->nmgp_dados_form['fac_numero'] . " AND df_empresa = '" . $this->nmgp_dados_form['fac_empresa'] . "'";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_detalle_factura_multiple_mob_script_case_init'] ]['form_del_detalle_factura_multiple_mob']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_detalle_factura_multiple_mob_script_case_init'] ]['form_del_detalle_factura_multiple_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_detalle_factura_multiple_mob_script_case_init'] ]['form_del_detalle_factura_multiple_mob']['total']);
              foreach ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_detalle_factura_multiple_mob_script_case_init'] ]['form_del_detalle_factura_multiple_mob'] as $i => $v)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_detalle_factura_multiple_mob_script_case_init'] ]['form_del_detalle_factura_multiple'][$i] = $v;
              }
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_detalle_factura_multiple_mob_script_case_init'] ]['form_del_detalle_factura_multiple_mob']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_detalle_factura_multiple_mob_script_case_init'] ]['form_del_detalle_factura_multiple_mob']['total']);
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_forma_pago_factura_multiple_mob_script_case_init'] ]['form_del_forma_pago_factura_multiple_mob']['foreign_key']['fp_factura_multiple'] = $this->nmgp_dados_form['fac_numero'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_forma_pago_factura_multiple_mob_script_case_init'] ]['form_del_forma_pago_factura_multiple_mob']['where_filter'] = "fp_factura_multiple = " . $this->nmgp_dados_form['fac_numero'] . "";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_forma_pago_factura_multiple_mob_script_case_init'] ]['form_del_forma_pago_factura_multiple_mob']['where_detal']  = "fp_factura_multiple = " . $this->nmgp_dados_form['fac_numero'] . "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_forma_pago_factura_multiple_mob_script_case_init'] ]['form_del_forma_pago_factura_multiple_mob']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_forma_pago_factura_multiple_mob_script_case_init'] ]['form_del_forma_pago_factura_multiple_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_forma_pago_factura_multiple_mob_script_case_init'] ]['form_del_forma_pago_factura_multiple_mob']['total']);
              foreach ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_forma_pago_factura_multiple_mob_script_case_init'] ]['form_del_forma_pago_factura_multiple_mob'] as $i => $v)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_forma_pago_factura_multiple_mob_script_case_init'] ]['form_del_forma_pago_factura_multiple'][$i] = $v;
              }
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_forma_pago_factura_multiple_mob_script_case_init'] ]['form_del_forma_pago_factura_multiple_mob']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_forma_pago_factura_multiple_mob_script_case_init'] ]['form_del_forma_pago_factura_multiple_mob']['total']);
              }
              ...
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['grid_del_cliente_factura_multiple_script_case_init'] ]['grid_del_cliente_factura_multiple']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['grid_del_cliente_factura_multiple_script_case_init'] ]['grid_del_cliente_factura_multiple']['total']);
              ...
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['grid_del_cliente_factura_multiple_script_case_init'] ]['grid_del_cliente_factura_multiple']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['grid_del_cliente_factura_multiple_script_case_init'] ]['grid_del_cliente_factura_multiple']['total']);
              }
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['Lookup_fac_libretin']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['Lookup_fac_libretin'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['Lookup_fac_libretin']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['Lookup_fac_libretin'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_del_factura_multiple_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_del_factura_multiple_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['Lookup_fac_libretin'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['fac_libretin']['valList'][$i] = form_del_factura_multiple_mob_pack_protect_string($v);
          }
   ...
   function ajax_return_values_fac_numero($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['Field_no_validate'] = array();
      if (!$this->NM_ajax_flag || !isset($this->nmgp_refresh_fields)) {
      $_SESSION['scriptcase']['form_del_factura_multiple_mob']['contr_erro'] = 'on';
...
if($this->fac_libretin <>''){
	...
	if (isset($this->rs[0][0])){
		...
		$this->tipo_libretin =$this->rs[0][2];
		$this->ambiente =$this->rs[0][3];
	...
	if (isset($this->rs[0][0])){
		...
		$this->fac_ambiente =$this->rs[0][2];
		$this->fac_tipo_libretin =$this->rs[0][3];
		$this->establecimiento  = $this->rs[0][4];
		$this->punto_emision  = $this->rs[0][5];
		$secuencial = $this->rs[0][6];
		$this->ambiente =$this->rs[0][7];
		$this->tipo_libretin =$this->rs[0][8];
...
if ($this->verificar_guia($this->fac_serie_guia )==false){
...
if ($this->fac_total ==0){
	...
	$check_sql = "SELECT coalesce(sum(fp_valor),0) 
			  FROM del_forma_pago_factura_multiple
		 	  WHERE fp_factura_multiple=".$this->fac_numero ;
...
$check_sql = "SELECT count(*) 
              ...
              WHERE cfm_factura_multiple=".$this->fac_numero ;
...
if ($this->rs[0][0]==0){
	$this->sc_temp_var_procesar=false;
	$this->sc_temp_var_mensaje='No ha seleccionado Clientes para emitir facturas<br>';
}
...
$_SESSION['scriptcase']['form_del_factura_multiple_mob']['contr_erro'] = 'off'; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "fac_establecimiento = $this->fac_establecimiento, fac_punto_emision = $this->fac_punto_emision, fac_fecha = #$this->fac_fecha#, fac_ambiente = $this->fac_ambiente, fac_tipo_libretin = '$this->fac_tipo_libretin', fac_libretin = $this->fac_libretin, fac_serie_guia = '$this->fac_serie_guia', fac_subtotal_iva = $this->fac_subtotal_iva, fac_subtotal_cero = $this->fac_subtotal_cero, fac_subtotal_no_objeto = $this->fac_subtotal_no_objeto, fac_subtotal_excento = $this->fac_subtotal_excento, fac_subtotal = $this->fac_subtotal, fac_total_descuento = $this->fac_total_descuento, fac_valor_ice = $this->fac_valor_ice, fac_valor_iva = $this->fac_valor_iva, fac_valor_irbpnr = $this->fac_valor_irbpnr, fac_propina = $this->fac_propina, fac_total = $this->fac_total"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
                  $SC_fields_update[] = "fac_establecimiento = $this->fac_establecimiento, fac_punto_emision = $this->fac_punto_emision, fac_fecha = " . $this->Ini->date_delim . $this->fac_fecha . $this->Ini->date_delim1 . ", fac_ambiente = $this->fac_ambiente, fac_tipo_libretin = '$this->fac_tipo_libretin', fac_libretin = $this->fac_libretin, fac_serie_guia = '$this->fac_serie_guia', fac_subtotal_iva = $this->fac_subtotal_iva, fac_subtotal_cero = $this->fac_subtotal_cero, fac_subtotal_no_objeto = $this->fac_subtotal_no_objeto, fac_subtotal_excento = $this->fac_subtotal_excento, fac_subtotal = $this->fac_subtotal, fac_total_descuento = $this->fac_total_descuento, fac_valor_ice = $this->fac_valor_ice, fac_valor_iva = $this->fac_valor_iva, fac_valor_irbpnr = $this->fac_valor_irbpnr, fac_propina = $this->fac_propina, fac_total = $this->fac_total"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
                  $SC_fields_update[] = "fac_establecimiento = $this->fac_establecimiento, fac_punto_emision = $this->fac_punto_emision, fac_fecha = EXTEND('$this->fac_fecha', YEAR TO DAY), fac_ambiente = $this->fac_ambiente, fac_tipo_libretin = '$this->fac_tipo_libretin', fac_libretin = $this->fac_libretin, fac_serie_guia = '$this->fac_serie_guia', fac_subtotal_iva = $this->fac_subtotal_iva, fac_subtotal_cero = $this->fac_subtotal_cero, fac_subtotal_no_objeto = $this->fac_subtotal_no_objeto, fac_subtotal_excento = $this->fac_subtotal_excento, fac_subtotal = $this->fac_subtotal, fac_total_descuento = $this->fac_total_descuento, fac_valor_ice = $this->fac_valor_ice, fac_valor_iva = $this->fac_valor_iva, fac_valor_irbpnr = $this->fac_valor_irbpnr, fac_propina = $this->fac_propina, fac_total = $this->fac_total"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
              ...
              $this->nmgp_refresh_fields = array_diff(array('titulo', 'fac_libretin', 'establecimiento', 'punto_emision', 'tipo_libretin', 'ambiente', 'fac_fecha', 'fac_serie_guia', 'fac_establecimiento', 'fac_punto_emision', 'fac_tipo_libretin', 'fac_ambiente', 'detalle', 'fac_subtotal', 'fac_subtotal_iva', 'fac_subtotal_cero', 'fac_subtotal_no_objeto', 'fac_subtotal_excento', 'fac_total_descuento', 'fac_valor_ice', 'fac_valor_iva', 'fac_valor_irbpnr', 'fac_propina', 'fac_total', 'forma_pago', 'clientes'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (fac_numero, fac_tipo_comprobante, fac_empresa, fac_establecimiento, fac_punto_emision, fac_fecha, fac_ambiente, fac_tipo_libretin, fac_libretin, fac_serie_guia, fac_comentario, fac_aplica_propina, fac_subtotal_iva, fac_subtotal_cero, fac_subtotal_no_objeto, fac_subtotal_excento, fac_subtotal, fac_total_descuento, fac_valor_ice, fac_valor_iva, fac_valor_irbpnr, fac_propina, fac_total, fac_estado, fac_usuario) VALUES ($this->fac_numero, '$this->fac_tipo_comprobante', '$this->fac_empresa', $this->fac_establecimiento, $this->fac_punto_emision, #$this->fac_fecha#, $this->fac_ambiente, '$this->fac_tipo_libretin', $this->fac_libretin, '$this->fac_serie_guia', '$this->fac_comentario', '$this->fac_aplica_propina', $this->fac_subtotal_iva, $this->fac_subtotal_cero, $this->fac_subtotal_no_objeto, $this->fac_subtotal_excento, $this->fac_subtotal, $this->fac_total_descuento, $this->fac_valor_ice, $this->fac_valor_iva, $this->fac_valor_irbpnr, $this->fac_propina, $this->fac_total, '$this->fac_estado', '$this->fac_usuario')"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "fac_numero, fac_tipo_comprobante, fac_empresa, fac_establecimiento, fac_punto_emision, fac_fecha, fac_ambiente, fac_tipo_libretin, fac_libretin, fac_serie_guia, fac_comentario, fac_aplica_propina, fac_subtotal_iva, fac_subtotal_cero, fac_subtotal_no_objeto, fac_subtotal_excento, fac_subtotal, fac_total_descuento, fac_valor_ice, fac_valor_iva, fac_valor_irbpnr, fac_propina, fac_total, fac_estado, fac_usuario) VALUES (" . $NM_seq_auto . "$this->fac_numero, '$this->fac_tipo_comprobante', '$this->fac_empresa', $this->fac_establecimiento, $this->fac_punto_emision, " . $this->Ini->date_delim . $this->fac_fecha . $this->Ini->date_delim1 . ", $this->fac_ambiente, '$this->fac_tipo_libretin', $this->fac_libretin, '$this->fac_serie_guia', '$this->fac_comentario', '$this->fac_aplica_propina', $this->fac_subtotal_iva, $this->fac_subtotal_cero, $this->fac_subtotal_no_objeto, $this->fac_subtotal_excento, $this->fac_subtotal, $this->fac_total_descuento, $this->fac_valor_ice, $this->fac_valor_iva, $this->fac_valor_irbpnr, $this->fac_propina, $this->fac_total, '$this->fac_estado', '$this->fac_usuario')"; 
              }
              ...
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "fac_numero, fac_tipo_comprobante, fac_empresa, fac_establecimiento, fac_punto_emision, fac_fecha, fac_ambiente, fac_tipo_libretin, fac_libretin, fac_serie_guia, fac_comentario, fac_aplica_propina, fac_subtotal_iva, fac_subtotal_cero, fac_subtotal_no_objeto, fac_subtotal_excento, fac_subtotal, fac_total_descuento, fac_valor_ice, fac_valor_iva, fac_valor_irbpnr, fac_propina, fac_total, fac_estado, fac_usuario) VALUES (" . $NM_seq_auto . "$this->fac_numero, '$this->fac_tipo_comprobante', '$this->fac_empresa', $this->fac_establecimiento, $this->fac_punto_emision, EXTEND('$this->fac_fecha', YEAR TO DAY), $this->fac_ambiente, '$this->fac_tipo_libretin', $this->fac_libretin, '$this->fac_serie_guia', '$this->fac_comentario', '$this->fac_aplica_propina', $this->fac_subtotal_iva, $this->fac_subtotal_cero, $this->fac_subtotal_no_objeto, $this->fac_subtotal_excento, $this->fac_subtotal, $this->fac_total_descuento, $this->fac_valor_ice, $this->fac_valor_iva, $this->fac_valor_irbpnr, $this->fac_propina, $this->fac_total, '$this->fac_estado', '$this->fac_usuario')"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "fac_numero, fac_tipo_comprobante, fac_empresa, fac_establecimiento, fac_punto_emision, fac_fecha, fac_ambiente, fac_tipo_libretin, fac_libretin, fac_serie_guia, fac_comentario, fac_aplica_propina, fac_subtotal_iva, fac_subtotal_cero, fac_subtotal_no_objeto, fac_subtotal_excento, fac_subtotal, fac_total_descuento, fac_valor_ice, fac_valor_iva, fac_valor_irbpnr, fac_propina, fac_total, fac_estado, fac_usuario) VALUES (" . $NM_seq_auto . "$this->fac_numero, '$this->fac_tipo_comprobante', '$this->fac_empresa', $this->fac_establecimiento, $this->fac_punto_emision, " . $this->Ini->date_delim . $this->fac_fecha . $this->Ini->date_delim1 . ", $this->fac_ambiente, '$this->fac_tipo_libretin', $this->fac_libretin, '$this->fac_serie_guia', '$this->fac_comentario', '$this->fac_aplica_propina', $this->fac_subtotal_iva, $this->fac_subtotal_cero, $this->fac_subtotal_no_objeto, $this->fac_subtotal_excento, $this->fac_subtotal, $this->fac_total_descuento, $this->fac_valor_ice, $this->fac_valor_iva, $this->fac_valor_irbpnr, $this->fac_propina, $this->fac_total, '$this->fac_estado', '$this->fac_usuario')"; 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['total']);
              }
              ...
              $this->NM_gera_log_new();
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          if ($bDelecaoOk)
          {
              $sDetailWhere = "df_factura_multiple = " . $this->fac_numero . " AND df_empresa = '" . $this->fac_empresa . "'";
              $this->form_del_detalle_factura_multiple_mob->ini_controle();
              if ($this->form_del_detalle_factura_multiple_mob->temRegistros($sDetailWhere))
              {
                  $bDelecaoOk = false;
          ...
          if ($bDelecaoOk)
          {
              $sDetailWhere = "fp_factura_multiple = " . $this->fac_numero . "";
              $this->form_del_forma_pago_factura_multiple_mob->ini_controle();
              if ($this->form_del_forma_pago_factura_multiple_mob->temRegistros($sDetailWhere))
              {
                  $bDelecaoOk = false;
                  $sMsgErro   = $this->Ini->Nm_lang['lang_errm_fkvi'];
              }
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['reg_start'] = 0; 
              }
	...
	if($this->sc_temp_var_procesar==true){
      ...
      { 
		...
		if (false == $this->rs_cliente ) {
			...
			$var_aplicacion_retorno='form_del_factura_multiple';
		}else{
		   while(!$this->rs_cliente->EOF)	{
				$check_sql = "SELECT * from sp_factura_multiple("
							.$this->fac_numero .", "
							.$this->fac_libretin .","
      ...
      { 
          ...
          $this->rs_erro = $this->Db->ErrorMsg();
			...
			$check_sql = "SELECT count(*) 
				  ...
				  WHERE 
				  cfm_estado='R'
				  and cfm_factura_multiple=".$this->fac_numero ;
...
$_SESSION['scriptcase']['form_del_factura_multiple_mob']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['parms'] = "fac_numero?#?$this->fac_numero?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          { 
              $nmgp_select = "SELECT fac_numero, fac_tipo_comprobante, fac_empresa, fac_establecimiento, fac_punto_emision, str_replace (convert(char(10),fac_fecha,102), '.', '-') + ' ' + convert(char(8),fac_fecha,20), fac_ambiente, fac_tipo_libretin, fac_libretin, fac_serie_guia, fac_comentario, fac_aplica_propina, fac_subtotal_iva, fac_subtotal_cero, fac_subtotal_no_objeto, fac_subtotal_excento, fac_subtotal, fac_total_descuento, fac_valor_ice, fac_valor_iva, fac_valor_irbpnr, fac_propina, fac_total, fac_estado, fac_usuario from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $nmgp_select = "SELECT fac_numero, fac_tipo_comprobante, fac_empresa, fac_establecimiento, fac_punto_emision, convert(char(23),fac_fecha,121), fac_ambiente, fac_tipo_libretin, fac_libretin, fac_serie_guia, fac_comentario, fac_aplica_propina, fac_subtotal_iva, fac_subtotal_cero, fac_subtotal_no_objeto, fac_subtotal_excento, fac_subtotal, fac_total_descuento, fac_valor_ice, fac_valor_iva, fac_valor_irbpnr, fac_propina, fac_total, fac_estado, fac_usuario from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          { 
              $nmgp_select = "SELECT fac_numero, fac_tipo_comprobante, fac_empresa, fac_establecimiento, fac_punto_emision, fac_fecha, fac_ambiente, fac_tipo_libretin, fac_libretin, fac_serie_guia, fac_comentario, fac_aplica_propina, fac_subtotal_iva, fac_subtotal_cero, fac_subtotal_no_objeto, fac_subtotal_excento, fac_subtotal, fac_total_descuento, fac_valor_ice, fac_valor_iva, fac_valor_irbpnr, fac_propina, fac_total, fac_estado, fac_usuario from " . $this->Ini->nm_tabela ; 
          ...
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
          { 
              $nmgp_select = "SELECT fac_numero, fac_tipo_comprobante, fac_empresa, fac_establecimiento, fac_punto_emision, EXTEND(fac_fecha, YEAR TO DAY), fac_ambiente, fac_tipo_libretin, fac_libretin, fac_serie_guia, fac_comentario, fac_aplica_propina, fac_subtotal_iva, fac_subtotal_cero, fac_subtotal_no_objeto, fac_subtotal_excento, fac_subtotal, fac_total_descuento, fac_valor_ice, fac_valor_iva, fac_valor_irbpnr, fac_propina, fac_total, fac_estado, fac_usuario from " . $this->Ini->nm_tabela ; 
          } 
          else 
          { 
              $nmgp_select = "SELECT fac_numero, fac_tipo_comprobante, fac_empresa, fac_establecimiento, fac_punto_emision, fac_fecha, fac_ambiente, fac_tipo_libretin, fac_libretin, fac_serie_guia, fac_comentario, fac_aplica_propina, fac_subtotal_iva, fac_subtotal_cero, fac_subtotal_no_objeto, fac_subtotal_excento, fac_subtotal, fac_total_descuento, fac_valor_ice, fac_valor_iva, fac_valor_irbpnr, fac_propina, fac_total, fac_estado, fac_usuario from " . $this->Ini->nm_tabela ; 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (!empty($sc_where))
              {
                  if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['reg_start']) ;  
              } 
          } 
          ...
          { 
              ...
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['reg_start'] < $qt_geral_reg_form_del_factura_multiple_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['opcao']   = '';
          }
      } 
...
//-- 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple_mob']['embutida_parms'] = "var_factura*scin" . $this->nmgp_dados_form['fac_numero'] . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_forma_pago_factura_multiple_mob']['embutida_parms'] = "var_factura*scin" . $this->nmgp_dados_form['fac_numero'] . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_factura_multiple']['embutida_parms'] = "var_factura_multiple*scin" . $this->nmgp_dados_form['fac_numero'] . "*scoutNMSC_inicial*scininicio*scoutNMSC_paginacao*scinFULL*scoutNMSC_cab*scinN*scoutNMSC_nav*scinN*scout";
  }
// 
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dados_select'];
   ...
   function NM_gera_log_output() 
   {
       ...
       $this->NM_gera_log_insert("Scriptcase", $this->SC_log_evt, $Log_output);
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
$this->nm_formatar_campos('fac_libretin', 'fac_establecimiento', 'fac_punto_emision', 'fac_ambiente', 'fac_tipo_libretin', 'establecimiento', 'punto_emision', 'ambiente', 'tipo_libretin');
...
$modificado_fac_total = $this->fac_total;
$this->nm_formatar_campos('fac_subtotal', 'fac_subtotal_iva', 'fac_subtotal_cero', 'fac_subtotal_no_objeto', 'fac_subtotal_excento', 'fac_total_descuento', 'fac_valor_ice', 'fac_valor_iva', 'fac_valor_irbpnr', 'fac_propina', 'fac_total');
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
        include_once("form_del_factura_multiple_mob_form0.php");
        include_once("form_del_factura_multiple_mob_form1.php");
        $this->hideFormPages();
 }
...
<?php
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['where_filter_form'] . " and ((fac_numero=" . $_SESSION['var_id_factura'] . ")) and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_del_factura_multiple_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['total'] = $qt_geral_reg_form_del_factura_multiple_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_del_factura_multiple_mob_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_del_factura_multiple_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_del_factura_multiple_mob_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['masterValue']))
{
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple_mob']['reg_start'] = "";
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_factura_multiple_mob']['total']);
   $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_forma_pago_factura_multiple_mob']['reg_start'] = "";
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_forma_pago_factura_multiple_mob']['total']);
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['retorno_edit'] = "";
   }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function getButtonIds($buttonName) {
        switch ($buttonName) {
            case "help":
                ...
                break;
            case "exit":
                return array("sc_b_sai_t.sc-unique-btn-1", "sc_b_sai_t.sc-unique-btn-3", "sc_b_sai_b.sc-unique-btn-6", "sc_b_sai_b.sc-unique-btn-8", "sc_b_sai_t.sc-unique-btn-11", "sc_b_sai_t.sc-unique-btn-13", "sc_b_sai_b.sc-unique-btn-16", "sc_b_sai_b.sc-unique-btn-18", "sc_b_sai_t.sc-unique-btn-2", "sc_b_sai_b.sc-unique-btn-7", "sc_b_sai_t.sc-unique-btn-12", "sc_b_sai_b.sc-unique-btn-17");
                break;
            case "0":
                return array("sys_separator.sc-unique-btn-4", "sys_separator.sc-unique-btn-9", "sys_separator.sc-unique-btn-14", "sys_separator.sc-unique-btn-19");
                break;
            case "nuevo":
                return array("sc_Nuevo_top.", "sc_Nuevo_bot.", "sc_Nuevo_top.", "sc_Nuevo_bot.");
                break;
            case "update":
                return array("sc_b_upd_t.sc-unique-btn-5", "sc_b_upd_b.sc-unique-btn-10", "sc_b_upd_t.sc-unique-btn-15", "sc_b_upd_b.sc-unique-btn-20");
                break;
        }
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['ordem_ord'] == " desc") {
