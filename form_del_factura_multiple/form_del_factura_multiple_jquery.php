...
function scFocusField(sField) {
  ...
  if ($oField.length > 0) {
    switch ($oField[0].name) {
      ...
      case 'fac_total':
      case 'forma_pago':
        sc_exib_ocult_pag('form_del_factura_multiple_form0');
        break;
      case 'clientes':
        sc_exib_ocult_pag('form_del_factura_multiple_form1');
        break;
    }
  }
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_fac_numero' + iSeqRow).bind('change', function() { sc_form_del_factura_multiple_fac_numero_onchange(this, iSeqRow) });
  $('#id_sc_field_fac_tipo_comprobante' + iSeqRow).bind('change', function() { sc_form_del_factura_multiple_fac_tipo_comprobante_onchange(this, iSeqRow) });
  $('#id_sc_field_fac_empresa' + iSeqRow).bind('change', function() { sc_form_del_factura_multiple_fac_empresa_onchange(this, iSeqRow) });
  $('#id_sc_field_fac_establecimiento' + iSeqRow).bind('blur', function() { sc_form_del_factura_multiple_fac_establecimiento_onblur(this, iSeqRow) })
                                                 .bind('change', function() { sc_form_del_factura_multiple_fac_establecimiento_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fac_punto_emision' + iSeqRow).bind('blur', function() { sc_form_del_factura_multiple_fac_punto_emision_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_form_del_factura_multiple_fac_punto_emision_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fac_fecha' + iSeqRow).bind('blur', function() { sc_form_del_factura_multiple_fac_fecha_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_del_factura_multiple_fac_fecha_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fac_ambiente' + iSeqRow).bind('blur', function() { sc_form_del_factura_multiple_fac_ambiente_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_del_factura_multiple_fac_ambiente_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fac_tipo_libretin' + iSeqRow).bind('blur', function() { sc_form_del_factura_multiple_fac_tipo_libretin_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_form_del_factura_multiple_fac_tipo_libretin_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fac_serie_guia' + iSeqRow).bind('blur', function() { sc_form_del_factura_multiple_fac_serie_guia_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_del_factura_multiple_fac_serie_guia_onchange(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_del_factura_multiple_fac_serie_guia_onfocus(this, iSeqRow) });
  $('#id_sc_field_fac_comentario' + iSeqRow).bind('change', function() { sc_form_del_factura_multiple_fac_comentario_onchange(this, iSeqRow) });
  $('#id_sc_field_fac_aplica_propina' + iSeqRow).bind('change', function() { sc_form_del_factura_multiple_fac_aplica_propina_onchange(this, iSeqRow) });
  $('#id_sc_field_fac_subtotal_iva' + iSeqRow).bind('blur', function() { sc_form_del_factura_multiple_fac_subtotal_iva_onblur(this, iSeqRow) })
                                              .bind('change', function() { sc_form_del_factura_multiple_fac_subtotal_iva_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fac_subtotal_cero' + iSeqRow).bind('blur', function() { sc_form_del_factura_multiple_fac_subtotal_cero_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_form_del_factura_multiple_fac_subtotal_cero_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fac_subtotal_no_objeto' + iSeqRow).bind('blur', function() { sc_form_del_factura_multiple_fac_subtotal_no_objeto_onblur(this, iSeqRow) })
                                                    .bind('change', function() { sc_form_del_factura_multiple_fac_subtotal_no_objeto_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fac_subtotal_excento' + iSeqRow).bind('blur', function() { sc_form_del_factura_multiple_fac_subtotal_excento_onblur(this, iSeqRow) })
                                                  .bind('change', function() { sc_form_del_factura_multiple_fac_subtotal_excento_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fac_subtotal' + iSeqRow).bind('blur', function() { sc_form_del_factura_multiple_fac_subtotal_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_del_factura_multiple_fac_subtotal_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fac_total_descuento' + iSeqRow).bind('blur', function() { sc_form_del_factura_multiple_fac_total_descuento_onblur(this, iSeqRow) })
                                                 .bind('change', function() { sc_form_del_factura_multiple_fac_total_descuento_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fac_valor_ice' + iSeqRow).bind('blur', function() { sc_form_del_factura_multiple_fac_valor_ice_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_del_factura_multiple_fac_valor_ice_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fac_valor_iva' + iSeqRow).bind('blur', function() { sc_form_del_factura_multiple_fac_valor_iva_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_del_factura_multiple_fac_valor_iva_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fac_valor_irbpnr' + iSeqRow).bind('blur', function() { sc_form_del_factura_multiple_fac_valor_irbpnr_onblur(this, iSeqRow) })
                                              .bind('change', function() { sc_form_del_factura_multiple_fac_valor_irbpnr_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fac_propina' + iSeqRow).bind('blur', function() { sc_form_del_factura_multiple_fac_propina_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_del_factura_multiple_fac_propina_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fac_total' + iSeqRow).bind('blur', function() { sc_form_del_factura_multiple_fac_total_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_del_factura_multiple_fac_total_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_del_factura_multiple_fac_total_onfocus(this, iSeqRow) });
  $('#id_sc_field_fac_estado' + iSeqRow).bind('change', function() { sc_form_del_factura_multiple_fac_estado_onchange(this, iSeqRow) });
  $('#id_sc_field_fac_usuario' + iSeqRow).bind('change', function() { sc_form_del_factura_multiple_fac_usuario_onchange(this, iSeqRow) });
  $('#id_sc_field_tipo_libretin' + iSeqRow).bind('blur', function() { sc_form_del_factura_multiple_tipo_libretin_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_del_factura_multiple_tipo_libretin_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_ambiente' + iSeqRow).bind('blur', function() { sc_form_del_factura_multiple_ambiente_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_del_factura_multiple_ambiente_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_detalle' + iSeqRow).bind('blur', function() { sc_form_del_factura_multiple_detalle_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_del_factura_multiple_detalle_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_forma_pago' + iSeqRow).bind('blur', function() { sc_form_del_factura_multiple_forma_pago_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_del_factura_multiple_forma_pago_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_titulo' + iSeqRow).bind('blur', function() { sc_form_del_factura_multiple_titulo_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_del_factura_multiple_titulo_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_establecimiento' + iSeqRow).bind('blur', function() { sc_form_del_factura_multiple_establecimiento_onblur(this, iSeqRow) })
                                             .bind('change', function() { sc_form_del_factura_multiple_establecimiento_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_punto_emision' + iSeqRow).bind('blur', function() { sc_form_del_factura_multiple_punto_emision_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_del_factura_multiple_punto_emision_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_clientes' + iSeqRow).bind('blur', function() { sc_form_del_factura_multiple_clientes_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_del_factura_multiple_clientes_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_del_factura_multiple_clientes_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_del_factura_multiple_fac_numero_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_del_factura_multiple_fac_tipo_comprobante_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_del_factura_multiple_fac_empresa_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_factura_multiple_fac_establecimiento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_factura_multiple_fac_punto_emision_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_factura_multiple_fac_fecha_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_factura_multiple_fac_ambiente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_factura_multiple_fac_tipo_libretin_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_factura_multiple_fac_serie_guia_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_factura_multiple_fac_comentario_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_del_factura_multiple_fac_aplica_propina_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_factura_multiple_fac_subtotal_iva_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_factura_multiple_fac_subtotal_cero_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_factura_multiple_fac_subtotal_no_objeto_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_factura_multiple_fac_subtotal_excento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_factura_multiple_fac_subtotal_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_factura_multiple_fac_total_descuento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_factura_multiple_fac_valor_ice_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_factura_multiple_fac_valor_iva_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_factura_multiple_fac_valor_irbpnr_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_factura_multiple_fac_propina_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_factura_multiple_fac_total_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_factura_multiple_fac_estado_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_del_factura_multiple_fac_usuario_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_factura_multiple_tipo_libretin_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_factura_multiple_ambiente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_factura_multiple_detalle_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_factura_multiple_forma_pago_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_factura_multiple_titulo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_factura_multiple_establecimiento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_factura_multiple_punto_emision_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_factura_multiple_clientes_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function displayChange_field_detalle(row, status) {
    var fieldId;
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_del_detalle_factura_multiple")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_del_detalle_factura_multiple")[0].contentWindow.scRecreateSelect2();
	}
}
...
function displayChange_field_forma_pago(row, status) {
    var fieldId;
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_del_forma_pago_factura_multiple")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_del_forma_pago_factura_multiple")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_del_factura_multiple_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fac_fecha" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_del_factura_multiple_validate_fac_fecha(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_del_factura_multiple')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
