  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_factura_multiple_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_factura_multiple_mob_form();
	}
...
?>
  ...
  // ---------- Validate titulo
  function do_ajax_form_del_factura_multiple_mob_validate_titulo()
  {
    var nomeCampo_titulo = "titulo";
    var var_titulo = scAjaxGetFieldHidden(nomeCampo_titulo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_multiple_mob_validate_titulo(var_titulo, var_script_case_init, do_ajax_form_del_factura_multiple_mob_validate_titulo_cb);
  } // do_ajax_form_del_factura_multiple_mob_validate_titulo

  function do_ajax_form_del_factura_multiple_mob_validate_titulo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_multiple_mob_validate_titulo_cb

  // ---------- Validate fac_libretin
  function do_ajax_form_del_factura_multiple_mob_validate_fac_libretin()
  {
    var nomeCampo_fac_libretin = "fac_libretin";
    var var_fac_libretin = scAjaxGetFieldSelect(nomeCampo_fac_libretin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_multiple_mob_validate_fac_libretin(var_fac_libretin, var_script_case_init, do_ajax_form_del_factura_multiple_mob_validate_fac_libretin_cb);
  } // do_ajax_form_del_factura_multiple_mob_validate_fac_libretin

  function do_ajax_form_del_factura_multiple_mob_validate_fac_libretin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_multiple_mob_validate_fac_libretin_cb

  // ---------- Validate establecimiento
  function do_ajax_form_del_factura_multiple_mob_validate_establecimiento()
  {
    var nomeCampo_establecimiento = "establecimiento";
    var var_establecimiento = scAjaxGetFieldText(nomeCampo_establecimiento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_multiple_mob_validate_establecimiento(var_establecimiento, var_script_case_init, do_ajax_form_del_factura_multiple_mob_validate_establecimiento_cb);
  } // do_ajax_form_del_factura_multiple_mob_validate_establecimiento

  function do_ajax_form_del_factura_multiple_mob_validate_establecimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_multiple_mob_validate_establecimiento_cb

  // ---------- Validate punto_emision
  function do_ajax_form_del_factura_multiple_mob_validate_punto_emision()
  {
    var nomeCampo_punto_emision = "punto_emision";
    var var_punto_emision = scAjaxGetFieldText(nomeCampo_punto_emision);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_multiple_mob_validate_punto_emision(var_punto_emision, var_script_case_init, do_ajax_form_del_factura_multiple_mob_validate_punto_emision_cb);
  } // do_ajax_form_del_factura_multiple_mob_validate_punto_emision

  function do_ajax_form_del_factura_multiple_mob_validate_punto_emision_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_multiple_mob_validate_punto_emision_cb

  // ---------- Validate tipo_libretin
  function do_ajax_form_del_factura_multiple_mob_validate_tipo_libretin()
  {
    var nomeCampo_tipo_libretin = "tipo_libretin";
    var var_tipo_libretin = scAjaxGetFieldText(nomeCampo_tipo_libretin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_multiple_mob_validate_tipo_libretin(var_tipo_libretin, var_script_case_init, do_ajax_form_del_factura_multiple_mob_validate_tipo_libretin_cb);
  } // do_ajax_form_del_factura_multiple_mob_validate_tipo_libretin

  function do_ajax_form_del_factura_multiple_mob_validate_tipo_libretin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_multiple_mob_validate_tipo_libretin_cb

  // ---------- Validate ambiente
  function do_ajax_form_del_factura_multiple_mob_validate_ambiente()
  {
    var nomeCampo_ambiente = "ambiente";
    var var_ambiente = scAjaxGetFieldText(nomeCampo_ambiente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_multiple_mob_validate_ambiente(var_ambiente, var_script_case_init, do_ajax_form_del_factura_multiple_mob_validate_ambiente_cb);
  } // do_ajax_form_del_factura_multiple_mob_validate_ambiente

  function do_ajax_form_del_factura_multiple_mob_validate_ambiente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_multiple_mob_validate_ambiente_cb

  // ---------- Validate fac_fecha
  function do_ajax_form_del_factura_multiple_mob_validate_fac_fecha()
  {
    var nomeCampo_fac_fecha = "fac_fecha";
    var var_fac_fecha = scAjaxGetFieldText(nomeCampo_fac_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_multiple_mob_validate_fac_fecha(var_fac_fecha, var_script_case_init, do_ajax_form_del_factura_multiple_mob_validate_fac_fecha_cb);
  } // do_ajax_form_del_factura_multiple_mob_validate_fac_fecha

  function do_ajax_form_del_factura_multiple_mob_validate_fac_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_multiple_mob_validate_fac_fecha_cb

  // ---------- Validate fac_serie_guia
  function do_ajax_form_del_factura_multiple_mob_validate_fac_serie_guia()
  {
    var nomeCampo_fac_serie_guia = "fac_serie_guia";
    var var_fac_serie_guia = scAjaxGetFieldText(nomeCampo_fac_serie_guia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_multiple_mob_validate_fac_serie_guia(var_fac_serie_guia, var_script_case_init, do_ajax_form_del_factura_multiple_mob_validate_fac_serie_guia_cb);
  } // do_ajax_form_del_factura_multiple_mob_validate_fac_serie_guia

  function do_ajax_form_del_factura_multiple_mob_validate_fac_serie_guia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_multiple_mob_validate_fac_serie_guia_cb

  // ---------- Validate fac_establecimiento
  function do_ajax_form_del_factura_multiple_mob_validate_fac_establecimiento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_multiple_mob_validate_fac_establecimiento(var_fac_establecimiento, var_script_case_init, do_ajax_form_del_factura_multiple_mob_validate_fac_establecimiento_cb);
  } // do_ajax_form_del_factura_multiple_mob_validate_fac_establecimiento

  function do_ajax_form_del_factura_multiple_mob_validate_fac_establecimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_multiple_mob_validate_fac_establecimiento_cb

  // ---------- Validate fac_punto_emision
  function do_ajax_form_del_factura_multiple_mob_validate_fac_punto_emision()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_multiple_mob_validate_fac_punto_emision(var_fac_punto_emision, var_script_case_init, do_ajax_form_del_factura_multiple_mob_validate_fac_punto_emision_cb);
  } // do_ajax_form_del_factura_multiple_mob_validate_fac_punto_emision

  function do_ajax_form_del_factura_multiple_mob_validate_fac_punto_emision_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_multiple_mob_validate_fac_punto_emision_cb

  // ---------- Validate fac_tipo_libretin
  function do_ajax_form_del_factura_multiple_mob_validate_fac_tipo_libretin()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_multiple_mob_validate_fac_tipo_libretin(var_fac_tipo_libretin, var_script_case_init, do_ajax_form_del_factura_multiple_mob_validate_fac_tipo_libretin_cb);
  } // do_ajax_form_del_factura_multiple_mob_validate_fac_tipo_libretin

  function do_ajax_form_del_factura_multiple_mob_validate_fac_tipo_libretin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_multiple_mob_validate_fac_tipo_libretin_cb

  // ---------- Validate fac_ambiente
  function do_ajax_form_del_factura_multiple_mob_validate_fac_ambiente()
  {
    var nomeCampo_fac_ambiente = "fac_ambiente";
    var var_fac_ambiente = scAjaxGetFieldHidden(nomeCampo_fac_ambiente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_multiple_mob_validate_fac_ambiente(var_fac_ambiente, var_script_case_init, do_ajax_form_del_factura_multiple_mob_validate_fac_ambiente_cb);
  } // do_ajax_form_del_factura_multiple_mob_validate_fac_ambiente

  function do_ajax_form_del_factura_multiple_mob_validate_fac_ambiente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_multiple_mob_validate_fac_ambiente_cb

  // ---------- Validate detalle
  function do_ajax_form_del_factura_multiple_mob_validate_detalle()
  {
    var nomeCampo_detalle = "detalle";
    var var_detalle = scAjaxGetFieldText(nomeCampo_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_multiple_mob_validate_detalle(var_detalle, var_script_case_init, do_ajax_form_del_factura_multiple_mob_validate_detalle_cb);
  } // do_ajax_form_del_factura_multiple_mob_validate_detalle

  function do_ajax_form_del_factura_multiple_mob_validate_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detalle";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_multiple_mob_validate_detalle_cb

  // ---------- Validate fac_subtotal
  function do_ajax_form_del_factura_multiple_mob_validate_fac_subtotal()
  {
    var nomeCampo_fac_subtotal = "fac_subtotal";
    var var_fac_subtotal = scAjaxGetFieldText(nomeCampo_fac_subtotal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_multiple_mob_validate_fac_subtotal(var_fac_subtotal, var_script_case_init, do_ajax_form_del_factura_multiple_mob_validate_fac_subtotal_cb);
  } // do_ajax_form_del_factura_multiple_mob_validate_fac_subtotal

  function do_ajax_form_del_factura_multiple_mob_validate_fac_subtotal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_multiple_mob_validate_fac_subtotal_cb

  // ---------- Validate fac_subtotal_iva
  function do_ajax_form_del_factura_multiple_mob_validate_fac_subtotal_iva()
  {
    var nomeCampo_fac_subtotal_iva = "fac_subtotal_iva";
    var var_fac_subtotal_iva = scAjaxGetFieldText(nomeCampo_fac_subtotal_iva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_multiple_mob_validate_fac_subtotal_iva(var_fac_subtotal_iva, var_script_case_init, do_ajax_form_del_factura_multiple_mob_validate_fac_subtotal_iva_cb);
  } // do_ajax_form_del_factura_multiple_mob_validate_fac_subtotal_iva

  function do_ajax_form_del_factura_multiple_mob_validate_fac_subtotal_iva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_multiple_mob_validate_fac_subtotal_iva_cb

  // ---------- Validate fac_subtotal_cero
  function do_ajax_form_del_factura_multiple_mob_validate_fac_subtotal_cero()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_multiple_mob_validate_fac_subtotal_cero(var_fac_subtotal_cero, var_script_case_init, do_ajax_form_del_factura_multiple_mob_validate_fac_subtotal_cero_cb);
  } // do_ajax_form_del_factura_multiple_mob_validate_fac_subtotal_cero

  function do_ajax_form_del_factura_multiple_mob_validate_fac_subtotal_cero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_multiple_mob_validate_fac_subtotal_cero_cb

  // ---------- Validate fac_subtotal_no_objeto
  function do_ajax_form_del_factura_multiple_mob_validate_fac_subtotal_no_objeto()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_multiple_mob_validate_fac_subtotal_no_objeto(var_fac_subtotal_no_objeto, var_script_case_init, do_ajax_form_del_factura_multiple_mob_validate_fac_subtotal_no_objeto_cb);
  } // do_ajax_form_del_factura_multiple_mob_validate_fac_subtotal_no_objeto

  function do_ajax_form_del_factura_multiple_mob_validate_fac_subtotal_no_objeto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_multiple_mob_validate_fac_subtotal_no_objeto_cb

  // ---------- Validate fac_subtotal_excento
  function do_ajax_form_del_factura_multiple_mob_validate_fac_subtotal_excento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_multiple_mob_validate_fac_subtotal_excento(var_fac_subtotal_excento, var_script_case_init, do_ajax_form_del_factura_multiple_mob_validate_fac_subtotal_excento_cb);
  } // do_ajax_form_del_factura_multiple_mob_validate_fac_subtotal_excento

  function do_ajax_form_del_factura_multiple_mob_validate_fac_subtotal_excento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_multiple_mob_validate_fac_subtotal_excento_cb

  // ---------- Validate fac_total_descuento
  function do_ajax_form_del_factura_multiple_mob_validate_fac_total_descuento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_multiple_mob_validate_fac_total_descuento(var_fac_total_descuento, var_script_case_init, do_ajax_form_del_factura_multiple_mob_validate_fac_total_descuento_cb);
  } // do_ajax_form_del_factura_multiple_mob_validate_fac_total_descuento

  function do_ajax_form_del_factura_multiple_mob_validate_fac_total_descuento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_multiple_mob_validate_fac_total_descuento_cb

  // ---------- Validate fac_valor_ice
  function do_ajax_form_del_factura_multiple_mob_validate_fac_valor_ice()
  {
    var nomeCampo_fac_valor_ice = "fac_valor_ice";
    var var_fac_valor_ice = scAjaxGetFieldText(nomeCampo_fac_valor_ice);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_multiple_mob_validate_fac_valor_ice(var_fac_valor_ice, var_script_case_init, do_ajax_form_del_factura_multiple_mob_validate_fac_valor_ice_cb);
  } // do_ajax_form_del_factura_multiple_mob_validate_fac_valor_ice

  function do_ajax_form_del_factura_multiple_mob_validate_fac_valor_ice_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_multiple_mob_validate_fac_valor_ice_cb

  // ---------- Validate fac_valor_iva
  function do_ajax_form_del_factura_multiple_mob_validate_fac_valor_iva()
  {
    var nomeCampo_fac_valor_iva = "fac_valor_iva";
    var var_fac_valor_iva = scAjaxGetFieldText(nomeCampo_fac_valor_iva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_multiple_mob_validate_fac_valor_iva(var_fac_valor_iva, var_script_case_init, do_ajax_form_del_factura_multiple_mob_validate_fac_valor_iva_cb);
  } // do_ajax_form_del_factura_multiple_mob_validate_fac_valor_iva

  function do_ajax_form_del_factura_multiple_mob_validate_fac_valor_iva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_multiple_mob_validate_fac_valor_iva_cb

  // ---------- Validate fac_valor_irbpnr
  function do_ajax_form_del_factura_multiple_mob_validate_fac_valor_irbpnr()
  {
    var nomeCampo_fac_valor_irbpnr = "fac_valor_irbpnr";
    var var_fac_valor_irbpnr = scAjaxGetFieldText(nomeCampo_fac_valor_irbpnr);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_multiple_mob_validate_fac_valor_irbpnr(var_fac_valor_irbpnr, var_script_case_init, do_ajax_form_del_factura_multiple_mob_validate_fac_valor_irbpnr_cb);
  } // do_ajax_form_del_factura_multiple_mob_validate_fac_valor_irbpnr

  function do_ajax_form_del_factura_multiple_mob_validate_fac_valor_irbpnr_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_multiple_mob_validate_fac_valor_irbpnr_cb

  // ---------- Validate fac_propina
  function do_ajax_form_del_factura_multiple_mob_validate_fac_propina()
  {
    var nomeCampo_fac_propina = "fac_propina";
    var var_fac_propina = scAjaxGetFieldText(nomeCampo_fac_propina);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_multiple_mob_validate_fac_propina(var_fac_propina, var_script_case_init, do_ajax_form_del_factura_multiple_mob_validate_fac_propina_cb);
  } // do_ajax_form_del_factura_multiple_mob_validate_fac_propina

  function do_ajax_form_del_factura_multiple_mob_validate_fac_propina_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_multiple_mob_validate_fac_propina_cb

  // ---------- Validate fac_total
  function do_ajax_form_del_factura_multiple_mob_validate_fac_total()
  {
    var nomeCampo_fac_total = "fac_total";
    var var_fac_total = scAjaxGetFieldText(nomeCampo_fac_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_multiple_mob_validate_fac_total(var_fac_total, var_script_case_init, do_ajax_form_del_factura_multiple_mob_validate_fac_total_cb);
  } // do_ajax_form_del_factura_multiple_mob_validate_fac_total

  function do_ajax_form_del_factura_multiple_mob_validate_fac_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_multiple_mob_validate_fac_total_cb

  // ---------- Validate forma_pago
  function do_ajax_form_del_factura_multiple_mob_validate_forma_pago()
  {
    var nomeCampo_forma_pago = "forma_pago";
    var var_forma_pago = scAjaxGetFieldText(nomeCampo_forma_pago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_multiple_mob_validate_forma_pago(var_forma_pago, var_script_case_init, do_ajax_form_del_factura_multiple_mob_validate_forma_pago_cb);
  } // do_ajax_form_del_factura_multiple_mob_validate_forma_pago

  function do_ajax_form_del_factura_multiple_mob_validate_forma_pago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_multiple_mob_validate_forma_pago_cb

  // ---------- Validate clientes
  function do_ajax_form_del_factura_multiple_mob_validate_clientes()
  {
    var nomeCampo_clientes = "clientes";
    var var_clientes = scAjaxGetFieldText(nomeCampo_clientes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_factura_multiple_mob_validate_clientes(var_clientes, var_script_case_init, do_ajax_form_del_factura_multiple_mob_validate_clientes_cb);
  } // do_ajax_form_del_factura_multiple_mob_validate_clientes

  function do_ajax_form_del_factura_multiple_mob_validate_clientes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_factura_multiple_mob_validate_clientes_cb

  // ---------- Event onblur fac_valor_entrega
  function do_ajax_form_del_factura_multiple_mob_event_fac_valor_entrega_onblur()
  {
    var var_fac_total = scAjaxGetFieldText("fac_total");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_factura_multiple_mob_event_fac_valor_entrega_onblur(var_fac_total, var_script_case_init, do_ajax_form_del_factura_multiple_mob_event_fac_valor_entrega_onblur_cb);
  } // do_ajax_form_del_factura_multiple_mob_event_fac_valor_entrega_onblur

  function do_ajax_form_del_factura_multiple_mob_event_fac_valor_entrega_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_factura_multiple_mob_event_fac_valor_entrega_onblur_cb_after_alert);
  } // do_ajax_form_del_factura_multiple_mob_event_fac_valor_entrega_onblur_cb
  function do_ajax_form_del_factura_multiple_mob_event_fac_valor_entrega_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_factura_multiple_mob_event_fac_valor_entrega_onblur_cb_after_alert

  // ---------- Event onblur fac_libretin
  function do_ajax_form_del_factura_multiple_mob_event_fac_libretin_onblur()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_factura_multiple_mob_event_fac_libretin_onblur(var_fac_libretin, var_fac_establecimiento, var_fac_punto_emision, var_fac_ambiente, var_fac_tipo_libretin, var_establecimiento, var_punto_emision, var_ambiente, var_tipo_libretin, var_script_case_init, do_ajax_form_del_factura_multiple_mob_event_fac_libretin_onblur_cb);
  } // do_ajax_form_del_factura_multiple_mob_event_fac_libretin_onblur

  function do_ajax_form_del_factura_multiple_mob_event_fac_libretin_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "fac_libretin";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_factura_multiple_mob_event_fac_libretin_onblur_cb_after_alert);
  } // do_ajax_form_del_factura_multiple_mob_event_fac_libretin_onblur_cb
  function do_ajax_form_del_factura_multiple_mob_event_fac_libretin_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_factura_multiple_mob_event_fac_libretin_onblur_cb_after_alert

  // ---------- Event onchange fac_aplica_propina
  function do_ajax_form_del_factura_multiple_mob_event_fac_aplica_propina_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_factura_multiple_mob_event_fac_aplica_propina_onchange(var_fac_subtotal, var_fac_subtotal_iva, var_fac_subtotal_cero, var_fac_subtotal_no_objeto, var_fac_subtotal_excento, var_fac_total_descuento, var_fac_valor_ice, var_fac_valor_iva, var_fac_valor_irbpnr, var_fac_propina, var_fac_total, var_script_case_init, do_ajax_form_del_factura_multiple_mob_event_fac_aplica_propina_onchange_cb);
  } // do_ajax_form_del_factura_multiple_mob_event_fac_aplica_propina_onchange

  function do_ajax_form_del_factura_multiple_mob_event_fac_aplica_propina_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_factura_multiple_mob_event_fac_aplica_propina_onchange_cb_after_alert);
  } // do_ajax_form_del_factura_multiple_mob_event_fac_aplica_propina_onchange_cb
  function do_ajax_form_del_factura_multiple_mob_event_fac_aplica_propina_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_factura_multiple_mob_event_fac_aplica_propina_onchange_cb_after_alert

  // ---------- Event onchange fac_libretin
  function do_ajax_form_del_factura_multiple_mob_event_fac_libretin_onchange()
  {
    var var_fac_libretin = scAjaxGetFieldSelect("fac_libretin");
    var var_fac_establecimiento = scAjaxGetFieldHidden("fac_establecimiento");
    var var_fac_punto_emision = scAjaxGetFieldHidden("fac_punto_emision");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_factura_multiple_mob_event_fac_libretin_onchange(var_fac_libretin, var_fac_establecimiento, var_fac_punto_emision, var_fac_ambiente, var_fac_tipo_libretin, var_establecimiento, var_punto_emision, var_ambiente, var_tipo_libretin, var_script_case_init, do_ajax_form_del_factura_multiple_mob_event_fac_libretin_onchange_cb);
  } // do_ajax_form_del_factura_multiple_mob_event_fac_libretin_onchange

  function do_ajax_form_del_factura_multiple_mob_event_fac_libretin_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "fac_libretin";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_factura_multiple_mob_event_fac_libretin_onchange_cb_after_alert);
  } // do_ajax_form_del_factura_multiple_mob_event_fac_libretin_onchange_cb
  function do_ajax_form_del_factura_multiple_mob_event_fac_libretin_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_factura_multiple_mob_event_fac_libretin_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_factura_multiple_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_factura_multiple_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_del_factura_multiple_mob_submit_form(var_titulo, var_fac_libretin, var_establecimiento, var_punto_emision, var_tipo_libretin, var_ambiente, var_fac_fecha, var_fac_serie_guia, var_fac_establecimiento, var_fac_punto_emision, var_fac_tipo_libretin, var_fac_ambiente, var_fac_subtotal, var_fac_subtotal_iva, var_fac_subtotal_cero, var_fac_subtotal_no_objeto, var_fac_subtotal_excento, var_fac_total_descuento, var_fac_valor_ice, var_fac_valor_iva, var_fac_valor_irbpnr, var_fac_propina, var_fac_total, var_fac_numero, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_factura_multiple_mob_submit_form_cb);
  } // do_ajax_form_del_factura_multiple_mob_submit_form

  function do_ajax_form_del_factura_multiple_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_factura_multiple_mob_submit_form_cb_after_alert);
  } // do_ajax_form_del_factura_multiple_mob_submit_form_cb
  function do_ajax_form_del_factura_multiple_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_factura_multiple_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_del_detalle_factura_multiple_mob"] = "off";
  scStatusDetail["form_del_forma_pago_factura_multiple_mob"] = "off";
  scStatusDetail["grid_del_cliente_factura_multiple"] = "off";

  function do_ajax_form_del_factura_multiple_mob_navigate_form()
  {
    perform_ajax_form_del_factura_multiple_mob_navigate_form();
  }

  function perform_ajax_form_del_factura_multiple_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_del_detalle_factura_multiple_mob"] = "on";
    scStatusDetail["form_del_forma_pago_factura_multiple_mob"] = "on";
    scStatusDetail["grid_del_cliente_factura_multiple"] = "on";
    x_ajax_form_del_factura_multiple_mob_navigate_form(var_fac_numero, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_factura_multiple_mob_navigate_form_cb);
  } // do_ajax_form_del_factura_multiple_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_factura_multiple_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_del_detalle_factura_multiple_mob"] && "nmsc_iframe_liga_form_del_detalle_factura_multiple_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_del_detalle_factura_multiple_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_del_detalle_factura_multiple_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_del_detalle_factura_multiple_mob').contentWindow.nm_move('apl_detalhe', true, '450');
        document.getElementById('nmsc_iframe_liga_form_del_detalle_factura_multiple_mob').style.height = "450";
        document.getElementById('nmsc_iframe_liga_form_del_detalle_factura_multiple_mob').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_del_forma_pago_factura_multiple_mob"] && "nmsc_iframe_liga_form_del_forma_pago_factura_multiple_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_del_forma_pago_factura_multiple_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_del_forma_pago_factura_multiple_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_del_forma_pago_factura_multiple_mob').contentWindow.nm_move('apl_detalhe', true, '200');
        document.getElementById('nmsc_iframe_liga_form_del_forma_pago_factura_multiple_mob').style.height = "200";
        document.getElementById('nmsc_iframe_liga_form_del_forma_pago_factura_multiple_mob').style.display = "none";
    }
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_factura_multiple_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_del_factura_multiple_mob_navigate_form_cb
  function do_ajax_form_del_factura_multiple_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_del_factura_multiple_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_del_factura_multiple_mob_navigate_form_cb_after_alert

  function sc_hide_form_del_factura_multiple_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_del_detalle_factura_multiple_mob"] && "off" == scStatusDetail["form_del_forma_pago_factura_multiple_mob"] && "off" == scStatusDetail["grid_del_cliente_factura_multiple"])
    {
      return true;
    }
    return false;
