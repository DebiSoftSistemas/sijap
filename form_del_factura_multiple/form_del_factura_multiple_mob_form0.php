...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_del_factura_multiple/form_del_factura_multiple_mob_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_del_factura_multiple_mob_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_del_factura_multiple_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['link_info']['remove_border']) {
...
if (isset($_SESSION['scriptcase']['form_del_factura_multiple']['error_buffer']) && '' != $_SESSION['scriptcase']['form_del_factura_multiple']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_del_factura_multiple']['error_buffer'];
}
...
<?php
 include_once("form_del_factura_multiple_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_del_factura_multiple_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_del_factura_multiple_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_del_factura_multiple_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<script type="text/javascript">
var pag_ativa = "form_del_factura_multiple_mob_form0";
</script>
<ul class="scTabLine sc-ui-page-tab-line">
<?php
    $this->tabCssClass = array(
        'form_del_factura_multiple_mob_form0' => array(
            'title' => "{lang_factura}",
            'class' => empty($nmgp_num_form) || $nmgp_num_form == "form_del_factura_multiple_mob_form0" ? "scTabActive" : "scTabInactive",
        ),
        'form_del_factura_multiple_mob_form1' => array(
            'title' => "{lang_clientes}",
            'class' => $nmgp_num_form == "form_del_factura_multiple_mob_form1" ? "scTabActive" : "scTabInactive",
        ),
    );
    if (!empty($this->Ini->nm_hidden_pages)) {
        foreach ($this->Ini->nm_hidden_pages as $pageName => $pageStatus) {
            if ('{lang_factura}' == $pageName && 'off' == $pageStatus) {
                $this->tabCssClass['form_del_factura_multiple_mob_form0']['class'] = 'scTabInactive';
            }
            if ('{lang_clientes}' == $pageName && 'off' == $pageStatus) {
                $this->tabCssClass['form_del_factura_multiple_mob_form1']['class'] = 'scTabInactive';
            }
        }
...
?>
<?php
    $css_celula = $this->tabCssClass["form_del_factura_multiple_mob_form0"]['class'];
?>
   <li id="id_form_del_factura_multiple_mob_form0" class="sc-form-page sc-tab-click <?php echo $css_celula; ?>" data-tab-name="form_del_factura_multiple_mob_form0">
...
<?php
    $css_celula = $this->tabCssClass["form_del_factura_multiple_mob_form1"]['class'];
?>
   <li id="id_form_del_factura_multiple_mob_form1" class="sc-form-page sc-tab-click <?php echo $css_celula; ?>" data-tab-name="form_del_factura_multiple_mob_form1">
...
<div id="form_del_factura_multiple_mob_form0" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalle'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalle'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_detalle_factura_multiple_mob_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalle'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_detalle_factura_multiple_mob_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_detalle_factura_multiple_mob_script_case_init'] ]['form_del_detalle_factura_multiple_mob']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_detalle_factura_multiple_mob_script_case_init'] ]['form_del_detalle_factura_multiple_mob']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_detalle_factura_multiple_mob_script_case_init'] ]['form_del_detalle_factura_multiple_mob']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_detalle_factura_multiple_mob_script_case_init'] ]['form_del_detalle_factura_multiple_mob']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_detalle_factura_multiple_mob_script_case_init'] ]['form_del_detalle_factura_multiple_mob']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_detalle_factura_multiple_mob_script_case_init'] ]['form_del_detalle_factura_multiple_mob']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_detalle_factura_multiple_mob_script_case_init'] ]['form_del_detalle_factura_multiple_mob']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_detalle_factura_multiple_mob_script_case_init'] ]['form_del_detalle_factura_multiple_mob']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_detalle_factura_multiple_mob_script_case_init'] ]['form_del_detalle_factura_multiple_mob']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_detalle_factura_multiple_mob_script_case_init'] ]['form_del_detalle_factura_multiple_mob']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_detalle_factura_multiple_mob_script_case_init'] ]['form_del_detalle_factura_multiple_mob']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_detalle_factura_multiple_mob_script_case_init'] ]['form_del_detalle_factura_multiple_mob']['embutida_liga_tp_pag'] = 'total';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_detalle_factura_multiple_mob_script_case_init'] ]['form_del_detalle_factura_multiple_mob']['embutida_parms'] = "var_factura*scin" . $this->nmgp_dados_form['fac_numero'] . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_detalle_factura_multiple_mob_script_case_init'] ]['form_del_factura_multiple_mob']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_del_factura_multiple_mob_empty.htm' : $this->Ini->link_form_del_detalle_factura_multiple_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y&sc_ifr_height=450';
...
if (isset($this->Ini->sc_lig_target['C_@scinf_detalle']) && 'nmsc_iframe_liga_form_del_detalle_factura_multiple_mob' != $this->Ini->sc_lig_target['C_@scinf_detalle'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_detalle'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_detalle_factura_multiple_mob_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_del_detalle_factura_multiple_mob"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="450" width="100%" name="nmsc_iframe_liga_form_del_detalle_factura_multiple_mob"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_forma_pago'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_forma_pago'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_forma_pago_factura_multiple_mob_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_forma_pago'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_forma_pago_factura_multiple_mob_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_forma_pago_factura_multiple_mob_script_case_init'] ]['form_del_forma_pago_factura_multiple_mob']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_forma_pago_factura_multiple_mob_script_case_init'] ]['form_del_forma_pago_factura_multiple_mob']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_forma_pago_factura_multiple_mob_script_case_init'] ]['form_del_forma_pago_factura_multiple_mob']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_forma_pago_factura_multiple_mob_script_case_init'] ]['form_del_forma_pago_factura_multiple_mob']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_forma_pago_factura_multiple_mob_script_case_init'] ]['form_del_forma_pago_factura_multiple_mob']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_forma_pago_factura_multiple_mob_script_case_init'] ]['form_del_forma_pago_factura_multiple_mob']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_forma_pago_factura_multiple_mob_script_case_init'] ]['form_del_forma_pago_factura_multiple_mob']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_forma_pago_factura_multiple_mob_script_case_init'] ]['form_del_forma_pago_factura_multiple_mob']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_forma_pago_factura_multiple_mob_script_case_init'] ]['form_del_forma_pago_factura_multiple_mob']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_forma_pago_factura_multiple_mob_script_case_init'] ]['form_del_forma_pago_factura_multiple_mob']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_forma_pago_factura_multiple_mob_script_case_init'] ]['form_del_forma_pago_factura_multiple_mob']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_forma_pago_factura_multiple_mob_script_case_init'] ]['form_del_forma_pago_factura_multiple_mob']['embutida_liga_tp_pag'] = 'total';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_forma_pago_factura_multiple_mob_script_case_init'] ]['form_del_forma_pago_factura_multiple_mob']['embutida_parms'] = "var_factura*scin" . $this->nmgp_dados_form['fac_numero'] . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_forma_pago_factura_multiple_mob_script_case_init'] ]['form_del_factura_multiple_mob']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_del_factura_multiple_mob_empty.htm' : $this->Ini->link_form_del_forma_pago_factura_multiple_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y&sc_ifr_height=200';
...
if (isset($this->Ini->sc_lig_target['C_@scinf_forma_pago']) && 'nmsc_iframe_liga_form_del_forma_pago_factura_multiple_mob' != $this->Ini->sc_lig_target['C_@scinf_forma_pago'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_forma_pago'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_multiple_mob']['form_del_forma_pago_factura_multiple_mob_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_del_forma_pago_factura_multiple_mob"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="200" width="100%" name="nmsc_iframe_liga_form_del_forma_pago_factura_multiple_mob"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
