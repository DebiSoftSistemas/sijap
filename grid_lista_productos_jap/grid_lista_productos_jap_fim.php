...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_lista_productos_jap"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_lista_productos_jap"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_lista_productos_jap']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_lista_productos_jap']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_lista_productos_jap']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_lista_productos_jap']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_lista_productos_jap']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_lista_productos_jap</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_lista_productos_jap']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_lista_productos_jap']['embutida_filho'] as $ind => $sc_init)
          {
