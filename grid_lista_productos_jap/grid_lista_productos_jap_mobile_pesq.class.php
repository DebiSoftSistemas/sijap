...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_pro_codigo_cond" name="pro_codigo_cond" onChange="nm_campos_between(document.getElementById('id_vis_pro_codigo'), this, 'pro_codigo')">
      ...
      <br><span id="id_hide_pro_codigo"  <?php echo $str_hide_pro_codigo?>><?php
      if ($pro_codigo != "")
      {
      $pro_codigo_look = (is_string($pro_codigo) ? substr($this->Db->qstr($pro_codigo), 1, -1) : $pro_codigo); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_pro_estado_cond" name="pro_estado_cond" onChange="nm_campos_between(document.getElementById('id_vis_pro_estado'), this, 'pro_estado')">
      ...
      <br><span id="id_hide_pro_estado"  <?php echo $str_hide_pro_estado?>><?php
      if ($pro_estado != "")
      {
      $pro_estado_look = (is_string($pro_estado) ? substr($this->Db->qstr($pro_estado), 1, -1) : $pro_estado); 
      $nmgp_def_dados = array(); 
