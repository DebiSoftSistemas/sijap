<?php
@session_start() ;
$_SESSION['scriptcase']['grid_pedidos_por_entregar']['sc_process_barr'] = true;
require_once('../grid_pedidos_por_entregar/index.php');
unset($_SESSION['scriptcase']['grid_pedidos_por_entregar']['sc_process_barr']);
$ExportCtrl = new grid_pedidos_por_entregar_export_control;
$ExportCtrl->Export_barr();

class grid_pedidos_por_entregar_export_control
{
