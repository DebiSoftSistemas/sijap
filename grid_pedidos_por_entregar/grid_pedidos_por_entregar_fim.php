...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_pedidos_por_entregar"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_pedidos_por_entregar"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_del_pedido_entregar'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_pedidos_por_entregar']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_pedidos_por_entregar']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_pedidos_por_entregar']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_pedidos_por_entregar']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_pedidos_por_entregar']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_pedidos_por_entregar</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_pedidos_por_entregar']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_pedidos_por_entregar']['embutida_filho'] as $ind => $sc_init)
          {
