  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_fac_operacion" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_fac_operacion_form();
	}
...
?>
  ...
  function do_ajax_form_fac_operacion_validate_op_operacion_(iNumLinha)
  {
    ...
    x_ajax_form_fac_operacion_validate_op_operacion_(var_op_operacion_, iNumLinha, var_script_case_init, do_ajax_form_fac_operacion_validate_op_operacion__cb);
  } // do_ajax_form_fac_operacion_validate_op_operacion_

  function do_ajax_form_fac_operacion_validate_op_operacion__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operacion_validate_op_operacion__cb

  // ---------- Validate op_fecha_ini_
  function do_ajax_form_fac_operacion_validate_op_fecha_ini_(iNumLinha)
  {
    var nomeCampo_op_fecha_ini_ = "op_fecha_ini_" + iNumLinha;
    var var_op_fecha_ini_ = scAjaxGetFieldHidden(nomeCampo_op_fecha_ini_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operacion_validate_op_fecha_ini_(var_op_fecha_ini_, iNumLinha, var_script_case_init, do_ajax_form_fac_operacion_validate_op_fecha_ini__cb);
  } // do_ajax_form_fac_operacion_validate_op_fecha_ini_

  function do_ajax_form_fac_operacion_validate_op_fecha_ini__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operacion_validate_op_fecha_ini__cb

  // ---------- Validate op_comentario_
  function do_ajax_form_fac_operacion_validate_op_comentario_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operacion_validate_op_comentario_(var_op_comentario_, iNumLinha, var_script_case_init, do_ajax_form_fac_operacion_validate_op_comentario__cb);
  } // do_ajax_form_fac_operacion_validate_op_comentario_

  function do_ajax_form_fac_operacion_validate_op_comentario__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operacion_validate_op_comentario__cb

  // ---------- Validate op_subtotal_
  function do_ajax_form_fac_operacion_validate_op_subtotal_(iNumLinha)
  {
    var nomeCampo_op_subtotal_ = "op_subtotal_" + iNumLinha;
    var var_op_subtotal_ = scAjaxGetFieldHidden(nomeCampo_op_subtotal_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operacion_validate_op_subtotal_(var_op_subtotal_, iNumLinha, var_script_case_init, do_ajax_form_fac_operacion_validate_op_subtotal__cb);
  } // do_ajax_form_fac_operacion_validate_op_subtotal_

  function do_ajax_form_fac_operacion_validate_op_subtotal__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operacion_validate_op_subtotal__cb

  // ---------- Validate op_subtotal_iva_
  function do_ajax_form_fac_operacion_validate_op_subtotal_iva_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operacion_validate_op_subtotal_iva_(var_op_subtotal_iva_, iNumLinha, var_script_case_init, do_ajax_form_fac_operacion_validate_op_subtotal_iva__cb);
  } // do_ajax_form_fac_operacion_validate_op_subtotal_iva_

  function do_ajax_form_fac_operacion_validate_op_subtotal_iva__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operacion_validate_op_subtotal_iva__cb

  // ---------- Validate op_total_
  function do_ajax_form_fac_operacion_validate_op_total_(iNumLinha)
  {
    var nomeCampo_op_total_ = "op_total_" + iNumLinha;
    var var_op_total_ = scAjaxGetFieldHidden(nomeCampo_op_total_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operacion_validate_op_total_(var_op_total_, iNumLinha, var_script_case_init, do_ajax_form_fac_operacion_validate_op_total__cb);
  } // do_ajax_form_fac_operacion_validate_op_total_

  function do_ajax_form_fac_operacion_validate_op_total__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operacion_validate_op_total__cb

  // ---------- Validate op_seleccion_
  function do_ajax_form_fac_operacion_validate_op_seleccion_(iNumLinha)
  {
    var nomeCampo_op_seleccion_ = "op_seleccion_" + iNumLinha;
    var var_op_seleccion_ = scAjaxGetFieldCheckbox(nomeCampo_op_seleccion_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operacion_validate_op_seleccion_(var_op_seleccion_, iNumLinha, var_script_case_init, do_ajax_form_fac_operacion_validate_op_seleccion__cb);
  } // do_ajax_form_fac_operacion_validate_op_seleccion_

  function do_ajax_form_fac_operacion_validate_op_seleccion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operacion_validate_op_seleccion__cb

  // ---------- Validate op_propietario_
  function do_ajax_form_fac_operacion_validate_op_propietario_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operacion_validate_op_propietario_(var_op_propietario_, iNumLinha, var_script_case_init, do_ajax_form_fac_operacion_validate_op_propietario__cb);
  } // do_ajax_form_fac_operacion_validate_op_propietario_

  function do_ajax_form_fac_operacion_validate_op_propietario__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operacion_validate_op_propietario__cb

  // ---------- Event onchange op_seleccion_
  function do_ajax_form_fac_operacion_event_op_seleccion__onchange(iSeqForm)
  {
    ...
    var var_op_modulo_genera_ = scAjaxGetFieldText("op_modulo_genera_" + iSeqForm);
    var var_op_total_descuento_ = scAjaxGetFieldText("op_total_descuento_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_fac_operacion_event_op_seleccion__onchange(var_op_seleccion_, var_op_operacion_, var_op_propietario_, var_op_modulo_genera_, var_op_total_descuento_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_fac_operacion_event_op_seleccion__onchange_cb);
  } // do_ajax_form_fac_operacion_event_op_seleccion__onchange

  function do_ajax_form_fac_operacion_event_op_seleccion__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_fac_operacion_event_op_seleccion__onchange_cb_after_alert);
  } // do_ajax_form_fac_operacion_event_op_seleccion__onchange_cb
  function do_ajax_form_fac_operacion_event_op_seleccion__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_fac_operacion_event_op_seleccion__onchange_cb_after_alert

  // ---------- Event onclick op_seleccion_
  function do_ajax_form_fac_operacion_event_op_seleccion__onclick(iSeqForm)
  {
    var var_op_seleccion_ = scAjaxGetFieldCheckbox("op_seleccion_" + iSeqForm, ";");
    var var_op_operacion_ = scAjaxGetFieldText("op_operacion_" + iSeqForm);
    var var_op_propietario_ = scAjaxGetFieldHidden("op_propietario_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_fac_operacion_event_op_seleccion__onclick(var_op_seleccion_, var_op_operacion_, var_op_propietario_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_fac_operacion_event_op_seleccion__onclick_cb);
  } // do_ajax_form_fac_operacion_event_op_seleccion__onclick

  function do_ajax_form_fac_operacion_event_op_seleccion__onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_fac_operacion_event_op_seleccion__onclick_cb_after_alert);
  } // do_ajax_form_fac_operacion_event_op_seleccion__onclick_cb
  function do_ajax_form_fac_operacion_event_op_seleccion__onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_fac_operacion_event_op_seleccion__onclick_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_fac_operacion_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_fac_operacion_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_fac_operacion_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_fac_operacion_add_new_line_cb);
  } // do_ajax_form_fac_operacion_add_new_line

  function do_ajax_form_fac_operacion_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_fac_operacion_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_fac_operacion_backup_line(iNumLinha)
  {
    var var_op_operacion_ = scAjaxGetFieldText("op_operacion_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operacion_backup_line(var_op_operacion_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_fac_operacion_backup_line_cb);
  } // do_ajax_form_fac_operacion_backup_line

  function do_ajax_form_fac_operacion_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_fac_operacion_backup_line_cb

  function do_ajax_form_fac_operacion_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_fac_operacion_cancel_insert

  function do_ajax_form_fac_operacion_cancel_update(iSeqVert)
  {
    do_ajax_form_fac_operacion_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_fac_operacion_cancel_update

  function do_ajax_form_fac_operacion_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_fac_operacion_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_fac_operacion_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_fac_operacion_table_refresh(var_op_operacion_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_operacion_table_refresh_cb);
  } //  do_ajax_form_fac_operacion_table_refresh

  function do_ajax_form_fac_operacion_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_fac_operacion_table_refresh_cb_after_alert);
  } // do_ajax_form_fac_operacion_table_refresh_cb
  function do_ajax_form_fac_operacion_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("b");
    sc_insert_open = false;
  } // do_ajax_form_fac_operacion_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_fac_operacion_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_fac_operacion_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_fac_operacion_submit_form(var_op_operacion_, var_op_fecha_ini_, var_op_comentario_, var_op_subtotal_, var_op_subtotal_iva_, var_op_total_, var_op_seleccion_, var_op_propietario_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_fac_operacion_submit_form_cb);
  } // do_ajax_form_fac_operacion_submit_form

  function do_ajax_form_fac_operacion_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_fac_operacion_submit_form_cb_after_alert);
  } // do_ajax_form_fac_operacion_submit_form_cb
  function do_ajax_form_fac_operacion_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_fac_operacion_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_fac_operacion_navigate_form()
  {
    perform_ajax_form_fac_operacion_navigate_form();
  }

  function perform_ajax_form_fac_operacion_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_fac_operacion_cancel_insert(sc_form_fac_operacion_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_fac_operacion_navigate_form(var_op_operacion_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_operacion_navigate_form_cb);
  } // do_ajax_form_fac_operacion_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_operacion']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_fac_operacion_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_fac_operacion_navigate_form_cb_after_alert);
  } // do_ajax_form_fac_operacion_navigate_form_cb
  function do_ajax_form_fac_operacion_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_fac_operacion_navigate_form_cb_after_alert

    function sc_form_fac_operacion_get_last_line_number()
    {
    ...
    } //sc_form_fac_operacion_get_last_line_number

  function sc_hide_form_fac_operacion_form()
  {
