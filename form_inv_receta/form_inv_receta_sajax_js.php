  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_inv_receta" == sTestField)
        {
...
?>
  ...
  // ---------- Validate re_producto_
  function do_ajax_form_inv_receta_validate_re_producto_(iNumLinha)
  {
    var nomeCampo_re_producto_ = "re_producto_" + iNumLinha;
    var var_re_producto_ = scAjaxGetFieldText(nomeCampo_re_producto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_receta_validate_re_producto_(var_re_producto_, iNumLinha, var_script_case_init, do_ajax_form_inv_receta_validate_re_producto__cb);
  } // do_ajax_form_inv_receta_validate_re_producto_

  function do_ajax_form_inv_receta_validate_re_producto__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "re_producto_" + iLineNumber;
    }
    else
    {
      sFieldValid = "re_producto_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "re_producto_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "re_producto_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_receta_validate_re_producto__cb

  // ---------- Validate re_empresa_
  function do_ajax_form_inv_receta_validate_re_empresa_(iNumLinha)
  {
    var nomeCampo_re_empresa_ = "re_empresa_" + iNumLinha;
    var var_re_empresa_ = scAjaxGetFieldText(nomeCampo_re_empresa_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_receta_validate_re_empresa_(var_re_empresa_, iNumLinha, var_script_case_init, do_ajax_form_inv_receta_validate_re_empresa__cb);
  } // do_ajax_form_inv_receta_validate_re_empresa_

  function do_ajax_form_inv_receta_validate_re_empresa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "re_empresa_" + iLineNumber;
    }
    else
    {
      sFieldValid = "re_empresa_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "re_empresa_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "re_empresa_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_receta_validate_re_empresa__cb

  // ---------- Validate re_ingrediente_
  function do_ajax_form_inv_receta_validate_re_ingrediente_(iNumLinha)
  {
    var nomeCampo_re_ingrediente_ = "re_ingrediente_" + iNumLinha;
    var var_re_ingrediente_ = scAjaxGetFieldSelect(nomeCampo_re_ingrediente_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_receta_validate_re_ingrediente_(var_re_ingrediente_, iNumLinha, var_script_case_init, do_ajax_form_inv_receta_validate_re_ingrediente__cb);
  } // do_ajax_form_inv_receta_validate_re_ingrediente_

  function do_ajax_form_inv_receta_validate_re_ingrediente__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "re_ingrediente_" + iLineNumber;
    }
    else
    {
      sFieldValid = "re_ingrediente_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "re_ingrediente_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "re_ingrediente_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_receta_validate_re_ingrediente__cb

  // ---------- Validate re_cantidad_
  function do_ajax_form_inv_receta_validate_re_cantidad_(iNumLinha)
  {
    var nomeCampo_re_cantidad_ = "re_cantidad_" + iNumLinha;
    var var_re_cantidad_ = scAjaxGetFieldText(nomeCampo_re_cantidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_receta_validate_re_cantidad_(var_re_cantidad_, iNumLinha, var_script_case_init, do_ajax_form_inv_receta_validate_re_cantidad__cb);
  } // do_ajax_form_inv_receta_validate_re_cantidad_

  function do_ajax_form_inv_receta_validate_re_cantidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "re_cantidad_" + iLineNumber;
    }
    else
    {
      sFieldValid = "re_cantidad_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "re_cantidad_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "re_cantidad_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_receta_validate_re_cantidad__cb

  // ---------- Validate re_unidad_
  function do_ajax_form_inv_receta_validate_re_unidad_(iNumLinha)
  {
    var nomeCampo_re_unidad_ = "re_unidad_" + iNumLinha;
    var var_re_unidad_ = scAjaxGetFieldSelect(nomeCampo_re_unidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_receta_validate_re_unidad_(var_re_unidad_, iNumLinha, var_script_case_init, do_ajax_form_inv_receta_validate_re_unidad__cb);
  } // do_ajax_form_inv_receta_validate_re_unidad_

  function do_ajax_form_inv_receta_validate_re_unidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "re_unidad_" + iLineNumber;
    }
    else
    {
      sFieldValid = "re_unidad_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "re_unidad_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "re_unidad_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_receta_validate_re_unidad__cb

  // ---------- Refresh re_ingrediente_
  function do_ajax_form_inv_receta_refresh_re_ingrediente_(iSeqForm)
  {
    var var_re_ingrediente_ = scAjaxGetFieldSelect("re_ingrediente_" + iSeqForm);
    var var_nmgp_refresh_row = iSeqForm;
    var var_nmgp_refresh_fields = "re_unidad_";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_inv_receta_refresh_re_ingrediente_(var_re_ingrediente_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_inv_receta_refresh_re_ingrediente__cb);
  } // do_ajax_form_inv_receta_refresh_re_ingrediente_

  function do_ajax_form_inv_receta_refresh_re_ingrediente__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_receta_refresh_re_ingrediente__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_inv_receta_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_inv_receta_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_inv_receta_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_inv_receta_add_new_line_cb);
  } // do_ajax_form_inv_receta_add_new_line

  function do_ajax_form_inv_receta_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_inv_receta_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_inv_receta_backup_line(iNumLinha)
  {
    var var_re_producto_ = scAjaxGetFieldText("re_producto_" + iNumLinha);
    var var_re_empresa_ = scAjaxGetFieldText("re_empresa_" + iNumLinha);
    var var_re_ingrediente_ = scAjaxGetFieldSelect("re_ingrediente_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_receta_backup_line(var_re_producto_, var_re_empresa_, var_re_ingrediente_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_inv_receta_backup_line_cb);
  } // do_ajax_form_inv_receta_backup_line

  function do_ajax_form_inv_receta_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_inv_receta_backup_line_cb

  function do_ajax_form_inv_receta_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_inv_receta_cancel_insert

  function do_ajax_form_inv_receta_cancel_update(iSeqVert)
  {
    do_ajax_form_inv_receta_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_inv_receta_cancel_update

  function do_ajax_form_inv_receta_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_inv_receta_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_inv_receta_table_refresh()
  {
    var var_re_producto_ = document.F2.re_producto_.value;
    var var_re_empresa_ = document.F2.re_empresa_.value;
    var var_re_ingrediente_ = document.F2.re_ingrediente_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_inv_receta_table_refresh(var_re_producto_, var_re_empresa_, var_re_ingrediente_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_inv_receta_table_refresh_cb);
  } //  do_ajax_form_inv_receta_table_refresh

  function do_ajax_form_inv_receta_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.re_producto_.value = scAjaxGetKeyValue("re_producto_");
    document.F2.re_empresa_.value = scAjaxGetKeyValue("re_empresa_");
    document.F2.re_ingrediente_.value = scAjaxGetKeyValue("re_ingrediente_");
    ...
    scAjaxAlert(do_ajax_form_inv_receta_table_refresh_cb_after_alert);
  } // do_ajax_form_inv_receta_table_refresh_cb
  function do_ajax_form_inv_receta_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_inv_receta_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_inv_receta_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_inv_receta_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_re_empresa_ = scAjaxGetFieldText("re_empresa_" + iNumLinha);
    var var_re_ingrediente_ = scAjaxGetFieldSelect("re_ingrediente_" + iNumLinha);
    var var_re_cantidad_ = scAjaxGetFieldText("re_cantidad_" + iNumLinha);
    var var_re_unidad_ = scAjaxGetFieldSelect("re_unidad_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_inv_receta_submit_form(var_re_producto_, var_re_empresa_, var_re_ingrediente_, var_re_cantidad_, var_re_unidad_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_inv_receta_submit_form_cb);
  } // do_ajax_form_inv_receta_submit_form

  function do_ajax_form_inv_receta_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("re_producto_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("re_empresa_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("re_ingrediente_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("re_cantidad_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("re_unidad_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_inv_receta_submit_form_cb_after_alert);
  } // do_ajax_form_inv_receta_submit_form_cb
  function do_ajax_form_inv_receta_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_inv_receta_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_inv_receta_navigate_form()
  {
    perform_ajax_form_inv_receta_navigate_form();
  }

  function perform_ajax_form_inv_receta_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_inv_receta_cancel_insert(sc_form_inv_receta_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("re_producto_" + iNavForm);
      scAjaxHideErrorDisplay("re_empresa_" + iNavForm);
      scAjaxHideErrorDisplay("re_ingrediente_" + iNavForm);
      scAjaxHideErrorDisplay("re_cantidad_" + iNavForm);
      scAjaxHideErrorDisplay("re_unidad_" + iNavForm);
    }
    var var_re_producto_ = document.F2.re_producto_.value;
    var var_re_empresa_ = document.F2.re_empresa_.value;
    var var_re_ingrediente_ = document.F2.re_ingrediente_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_inv_receta_navigate_form(var_re_producto_, var_re_empresa_, var_re_ingrediente_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_inv_receta_navigate_form_cb);
  } // do_ajax_form_inv_receta_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_receta']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_inv_receta_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.re_producto_.value = scAjaxGetKeyValue("re_producto_" + var_last_index);
    document.F2.re_empresa_.value = scAjaxGetKeyValue("re_empresa_" + var_last_index);
    document.F2.re_ingrediente_.value = scAjaxGetKeyValue("re_ingrediente_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_inv_receta_navigate_form_cb_after_alert);
  } // do_ajax_form_inv_receta_navigate_form_cb
  function do_ajax_form_inv_receta_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_inv_receta_navigate_form_cb_after_alert

    function sc_form_inv_receta_get_last_line_number()
    {
    ...
    } //sc_form_inv_receta_get_last_line_number

  function sc_hide_form_inv_receta_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "re_producto_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "re_empresa_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "re_ingrediente_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "re_cantidad_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "re_unidad_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["re_producto_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_producto'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["re_empresa_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_empresa'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["re_ingrediente_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_ingrediente'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["re_cantidad_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_lot_cantidad'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["re_unidad_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_unidad'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["re_producto_"][iNumLinha] = "re_producto_" + iNumLinha;
    ajax_field_mult["re_empresa_"][iNumLinha] = "re_empresa_" + iNumLinha;
    ajax_field_mult["re_ingrediente_"][iNumLinha] = "re_ingrediente_" + iNumLinha;
    ajax_field_mult["re_cantidad_"][iNumLinha] = "re_cantidad_" + iNumLinha;
    ajax_field_mult["re_unidad_"][iNumLinha] = "re_unidad_" + iNumLinha;
    ajax_field_id["re_ingrediente_" + iNumLinha] = new Array("hidden_field_label_re_ingrediente_", "hidden_field_data_re_ingrediente_" + iNumLinha);
    ajax_field_id["re_cantidad_" + iNumLinha] = new Array("hidden_field_label_re_cantidad_", "hidden_field_data_re_cantidad_" + iNumLinha);
    ajax_field_id["re_unidad_" + iNumLinha] = new Array("hidden_field_label_re_unidad_", "hidden_field_data_re_unidad_" + iNumLinha);
    ajax_error_count["re_producto_" + iNumLinha] = "off";
    ajax_error_count["re_empresa_" + iNumLinha] = "off";
    ajax_error_count["re_ingrediente_" + iNumLinha] = "off";
    ajax_error_count["re_cantidad_" + iNumLinha] = "off";
    ajax_error_count["re_unidad_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["re_producto_" + iNumLinha] = "on";
    ajax_read_only["re_empresa_" + iNumLinha] = "on";
    ajax_read_only["re_ingrediente_" + iNumLinha] = "on";
    ajax_read_only["re_cantidad_" + iNumLinha] = "off";
    ajax_read_only["re_unidad_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["re_empresa_" + iNumLinha] = "on";
    ajax_read_only["re_ingrediente_" + iNumLinha] = "on";
    ajax_read_only["re_cantidad_" + iNumLinha] = "on";
    ajax_read_only["re_unidad_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["re_producto_" + iNumLinha] = null;
    ajax_error_list["re_empresa_" + iNumLinha] = null;
    ajax_error_list["re_ingrediente_" + iNumLinha] = null;
    ajax_error_list["re_cantidad_" + iNumLinha] = null;
    ajax_error_list["re_unidad_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "re_producto_": new Array(),
    "re_empresa_": new Array(),
    "re_ingrediente_": new Array(),
    "re_cantidad_": new Array(),
    "re_unidad_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["re_producto_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["re_producto_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["re_producto_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["re_producto_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["re_producto_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["re_empresa_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["re_empresa_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["re_empresa_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["re_empresa_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["re_empresa_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["re_ingrediente_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["re_ingrediente_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["re_ingrediente_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["re_ingrediente_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["re_ingrediente_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["re_cantidad_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["re_cantidad_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["re_cantidad_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["re_cantidad_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["re_cantidad_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["re_unidad_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["re_unidad_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["re_unidad_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["re_unidad_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["re_unidad_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['re_producto_'])) ? $this->nmgp_cmp_readonly['re_producto_'] : 'on';
?>
    scAjaxFieldRead("re_producto_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['re_empresa_'])) ? $this->nmgp_cmp_readonly['re_empresa_'] : 'on';
?>
    scAjaxFieldRead("re_empresa_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['re_ingrediente_'])) ? $this->nmgp_cmp_readonly['re_ingrediente_'] : 'on';
?>
    scAjaxFieldRead("re_ingrediente_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['re_cantidad_'])) ? $this->nmgp_cmp_readonly['re_cantidad_'] : 'off';
?>
    scAjaxFieldRead("re_cantidad_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['re_unidad_'])) ? $this->nmgp_cmp_readonly['re_unidad_'] : 'off';
?>
    scAjaxFieldRead("re_unidad_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("re_producto_" + iSeq, "on");
    scAjaxFieldRead("re_empresa_" + iSeq, "on");
    scAjaxFieldRead("re_ingrediente_" + iSeq, "on");
    scAjaxFieldRead("re_cantidad_" + iSeq, "on");
    scAjaxFieldRead("re_unidad_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["re_producto_" + iRow] || "on" == ajax_error_count["re_empresa_" + iRow] || "on" == ajax_error_count["re_ingrediente_" + iRow] || "on" == ajax_error_count["re_cantidad_" + iRow] || "on" == ajax_error_count["re_unidad_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_re_producto_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_re_empresa_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_re_ingrediente_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_re_cantidad_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_re_unidad_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["re_producto_" + iRow] && "off" == ajax_error_count["re_empresa_" + iRow] && "off" == ajax_error_count["re_ingrediente_" + iRow] && "off" == ajax_error_count["re_cantidad_" + iRow] && "off" == ajax_error_count["re_unidad_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["re_producto_" + iRow] = "off";
        ajax_error_count["re_empresa_" + iRow] = "off";
        ajax_error_count["re_ingrediente_" + iRow] = "off";
        ajax_error_count["re_cantidad_" + iRow] = "off";
        ajax_error_count["re_unidad_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_re_producto_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_re_empresa_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_re_ingrediente_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_re_cantidad_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_re_unidad_" + iRow).removeClass("scFormErrorLine");
    }
  }
