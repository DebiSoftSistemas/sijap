<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="re_producto_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['re_producto_']); ?>">
<input type="hidden" name="re_empresa_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['re_empresa_']); ?>">
<input type="hidden" name="re_ingrediente_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['re_ingrediente_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_inv_receta"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function scForm_inline_submit(y, z) {
	Nm_Proc_Atualiz = true;
	do_ajax_form_inv_receta_submit_form(y, z);
