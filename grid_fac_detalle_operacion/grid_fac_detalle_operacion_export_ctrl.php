<?php
@session_start() ;
$_SESSION['scriptcase']['grid_fac_detalle_operacion']['sc_process_barr'] = true;
require_once('../grid_fac_detalle_operacion/index.php');
unset($_SESSION['scriptcase']['grid_fac_detalle_operacion']['sc_process_barr']);
$ExportCtrl = new grid_fac_detalle_operacion_export_control;
$ExportCtrl->Export_barr();

class grid_fac_detalle_operacion_export_control
{
