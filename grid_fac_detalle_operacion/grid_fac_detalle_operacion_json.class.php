...
class grid_fac_detalle_operacion_json
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_fac_detalle_operacion/grid_fac_detalle_operacion_res_json.class.php"))
      {
          $this->Tem_json_res  = false;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_detalle_operacion']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_detalle_operacion']['json_label']))
      {
          $this->Json_use_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_detalle_operacion']['json_label'];
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_detalle_operacion']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_detalle_operacion']['json_format']))
      {
          $this->Json_format = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_detalle_operacion']['json_format'];
      }
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_detalle_operacion']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_detalle_operacion']['json_return']);
      ...
      $this->Arquivo     .= ".json";
      $this->Tit_doc      = "grid_fac_detalle_operacion.json";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_detalle_operacion']['json_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_detalle_operacion']['json_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_detalle_operacion']['json_name'] .= ".json";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_detalle_operacion']['json_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_detalle_operacion']['json_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_detalle_operacion']['json_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_detalle_operacion']['json_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_detalle_operacion']['json_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_detalle_operacion']['json_name']);
      }
      ...
      { 
          ...
          { 
              ...
              require_once($this->Ini->path_aplicacao . "grid_fac_detalle_operacion_res_json.class.php");
              $this->Res = new grid_fac_detalle_operacion_res_json();
              $this->prep_modulos("Res");
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_detalle_operacion']['json_res_grid'] = true;
              $this->Res->monta_json();
          } 
          if (!$this->Ini->sc_export_ajax) {
          ...
          { 
              ...
              { 
                  $str_zip   = "";
                  $Arq_res   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_detalle_operacion']['json_res_file']['json'];
                  ...
                  unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_detalle_operacion']['json_res_file']['json']);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_detalle_operacion']['json_res_grid']);
          } 
      }
   ...
   function NM_export_do_cantidad()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->do_cantidad;
   }
   //----- do_precio_unitario
   function NM_export_do_precio_unitario()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->do_precio_unitario;
   }
   //----- do_subtotal
   ...
   function NM_export_do_secuencia()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->do_secuencia;
   }
   //----- do_operacion
   function NM_export_do_operacion()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->do_operacion;
   }
   //----- do_descripcion
   function NM_export_do_descripcion()
   {
         $this->do_descripcion = NM_charset_to_utf8($this->do_descripcion);
         if ($this->Json_use_label)
         {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->do_descripcion;
   }
   //----- do_descuento
   ...
   function NM_export_do_base_iva()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->do_base_iva;
   }
   //----- do_porcentaje_iva
   function NM_export_do_porcentaje_iva()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->do_porcentaje_iva;
   }
   //----- do_estado
   function NM_export_do_estado()
   {
         $this->do_estado = NM_charset_to_utf8($this->do_estado);
         if ($this->Json_use_label)
         {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->do_estado;
   }
   //----- do_cuenta_x_cobrar
   function NM_export_do_cuenta_x_cobrar()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->do_cuenta_x_cobrar;
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_detalle_operacion']['json_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_detalle_operacion']['json_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> fac_detalle_operacion :: JSON</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_detalle_operacion']['json_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
