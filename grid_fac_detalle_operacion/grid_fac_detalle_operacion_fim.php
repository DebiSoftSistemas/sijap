...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_fac_detalle_operacion"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_fac_detalle_operacion"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_fac_detalle_operacion']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_fac_detalle_operacion']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_fac_detalle_operacion']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_fac_detalle_operacion']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_fac_detalle_operacion']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_fac_detalle_operacion</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_fac_detalle_operacion']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_fac_detalle_operacion']['embutida_filho'] as $ind => $sc_init)
          {
