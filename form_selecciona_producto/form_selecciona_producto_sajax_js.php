  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_selecciona_producto" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_selecciona_producto_form();
	}
...
?>
  ...
  function do_ajax_form_selecciona_producto_validate_pro_empresa_(iNumLinha)
  {
    ...
    x_ajax_form_selecciona_producto_validate_pro_empresa_(var_pro_empresa_, iNumLinha, var_script_case_init, do_ajax_form_selecciona_producto_validate_pro_empresa__cb);
  } // do_ajax_form_selecciona_producto_validate_pro_empresa_

  function do_ajax_form_selecciona_producto_validate_pro_empresa__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_selecciona_producto_validate_pro_empresa__cb

  // ---------- Validate pro_codigo_
  function do_ajax_form_selecciona_producto_validate_pro_codigo_(iNumLinha)
  {
    var nomeCampo_pro_codigo_ = "pro_codigo_" + iNumLinha;
    var var_pro_codigo_ = scAjaxGetFieldText(nomeCampo_pro_codigo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_selecciona_producto_validate_pro_codigo_(var_pro_codigo_, iNumLinha, var_script_case_init, do_ajax_form_selecciona_producto_validate_pro_codigo__cb);
  } // do_ajax_form_selecciona_producto_validate_pro_codigo_

  function do_ajax_form_selecciona_producto_validate_pro_codigo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_selecciona_producto_validate_pro_codigo__cb

  // ---------- Validate pro_codigo_aux_
  function do_ajax_form_selecciona_producto_validate_pro_codigo_aux_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_selecciona_producto_validate_pro_codigo_aux_(var_pro_codigo_aux_, iNumLinha, var_script_case_init, do_ajax_form_selecciona_producto_validate_pro_codigo_aux__cb);
  } // do_ajax_form_selecciona_producto_validate_pro_codigo_aux_

  function do_ajax_form_selecciona_producto_validate_pro_codigo_aux__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_selecciona_producto_validate_pro_codigo_aux__cb

  // ---------- Validate pro_descripcion_
  function do_ajax_form_selecciona_producto_validate_pro_descripcion_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_selecciona_producto_validate_pro_descripcion_(var_pro_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_selecciona_producto_validate_pro_descripcion__cb);
  } // do_ajax_form_selecciona_producto_validate_pro_descripcion_

  function do_ajax_form_selecciona_producto_validate_pro_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_selecciona_producto_validate_pro_descripcion__cb

  // ---------- Validate seleccionar_
  function do_ajax_form_selecciona_producto_validate_seleccionar_(iNumLinha)
  {
    var nomeCampo_seleccionar_ = "seleccionar_" + iNumLinha;
    var var_seleccionar_ = scAjaxGetFieldCheckbox(nomeCampo_seleccionar_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_selecciona_producto_validate_seleccionar_(var_seleccionar_, iNumLinha, var_script_case_init, do_ajax_form_selecciona_producto_validate_seleccionar__cb);
  } // do_ajax_form_selecciona_producto_validate_seleccionar_

  function do_ajax_form_selecciona_producto_validate_seleccionar__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_selecciona_producto_validate_seleccionar__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_selecciona_producto_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_selecciona_producto_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_selecciona_producto_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_selecciona_producto_add_new_line_cb);
  } // do_ajax_form_selecciona_producto_add_new_line

  function do_ajax_form_selecciona_producto_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_selecciona_producto_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_selecciona_producto_backup_line(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_selecciona_producto_backup_line(var_pro_codigo_, var_pro_empresa_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_selecciona_producto_backup_line_cb);
  } // do_ajax_form_selecciona_producto_backup_line

  function do_ajax_form_selecciona_producto_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_selecciona_producto_backup_line_cb

  function do_ajax_form_selecciona_producto_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_selecciona_producto_cancel_insert

  function do_ajax_form_selecciona_producto_cancel_update(iSeqVert)
  {
    do_ajax_form_selecciona_producto_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_selecciona_producto_cancel_update

  function do_ajax_form_selecciona_producto_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_selecciona_producto_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_selecciona_producto_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_selecciona_producto_table_refresh(var_pro_codigo_, var_pro_empresa_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_selecciona_producto_table_refresh_cb);
  } //  do_ajax_form_selecciona_producto_table_refresh

  function do_ajax_form_selecciona_producto_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_selecciona_producto_table_refresh_cb_after_alert);
  } // do_ajax_form_selecciona_producto_table_refresh_cb
  function do_ajax_form_selecciona_producto_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_selecciona_producto_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_selecciona_producto_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_selecciona_producto_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_selecciona_producto_submit_form(var_pro_empresa_, var_pro_codigo_, var_pro_codigo_aux_, var_pro_descripcion_, var_seleccionar_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_selecciona_producto_submit_form_cb);
  } // do_ajax_form_selecciona_producto_submit_form

  function do_ajax_form_selecciona_producto_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_selecciona_producto_submit_form_cb_after_alert);
  } // do_ajax_form_selecciona_producto_submit_form_cb
  function do_ajax_form_selecciona_producto_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_selecciona_producto_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_selecciona_producto_navigate_form()
  {
    perform_ajax_form_selecciona_producto_navigate_form();
  }

  function perform_ajax_form_selecciona_producto_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_selecciona_producto_navigate_form(var_pro_codigo_, var_pro_empresa_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_selecciona_producto_navigate_form_cb);
  } // do_ajax_form_selecciona_producto_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_selecciona_producto']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_selecciona_producto_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_selecciona_producto_navigate_form_cb_after_alert);
  } // do_ajax_form_selecciona_producto_navigate_form_cb
  function do_ajax_form_selecciona_producto_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_selecciona_producto_navigate_form_cb_after_alert

    function sc_form_selecciona_producto_get_last_line_number()
    {
    ...
    } //sc_form_selecciona_producto_get_last_line_number

  function sc_hide_form_selecciona_producto_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    ajax_error_list["pro_codigo_aux_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_codigo_secundario'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pro_descripcion_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_descripcion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["pro_empresa_" + iRow] || "on" == ajax_error_count["pro_codigo_" + iRow] || "on" == ajax_error_count["pro_codigo_aux_" + iRow] || "on" == ajax_error_count["pro_descripcion_" + iRow] || "on" == ajax_error_count["seleccionar_" + iRow]))
    {
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["pro_empresa_" + iRow] && "off" == ajax_error_count["pro_codigo_" + iRow] && "off" == ajax_error_count["pro_codigo_aux_" + iRow] && "off" == ajax_error_count["pro_descripcion_" + iRow] && "off" == ajax_error_count["seleccionar_" + iRow]))
    {
      if (bErrorRow)
      {
