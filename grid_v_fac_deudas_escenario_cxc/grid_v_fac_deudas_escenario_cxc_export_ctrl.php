<?php
@session_start() ;
$_SESSION['scriptcase']['grid_v_fac_deudas_escenario_cxc']['sc_process_barr'] = true;
require_once('../grid_v_fac_deudas_escenario_cxc/index.php');
unset($_SESSION['scriptcase']['grid_v_fac_deudas_escenario_cxc']['sc_process_barr']);
$ExportCtrl = new grid_v_fac_deudas_escenario_cxc_export_control;
$ExportCtrl->Export_barr();

class grid_v_fac_deudas_escenario_cxc_export_control
{
