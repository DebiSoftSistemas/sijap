...
<?php
   ...
   $Ord_Cmp = new grid_v_fac_deudas_escenario_cxc_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_v_fac_deudas_escenario_cxc_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_fac_deudas_escenario_cxc']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_fac_deudas_escenario_cxc']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["fac_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_fac_deudas_escenario_cxc']['labels']["fac_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_fac_deudas_escenario_cxc']['labels']["fac_fecha"] : "" . $this->Nm_lang['lang_fecha'] . "";
   $tab_ger_campos['fac_comentario'] = "on";
   $tab_def_campos['fac_comentario'] = "fac_comentario";
   $tab_labels["fac_comentario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_fac_deudas_escenario_cxc']['labels']["fac_comentario"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_fac_deudas_escenario_cxc']['labels']["fac_comentario"] : "" . $this->Nm_lang['lang_detalle'] . "";
   $tab_ger_campos['cl_nombre'] = "on";
   $tab_def_campos['cl_nombre'] = "cl_nombre";
   $tab_labels["cl_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_fac_deudas_escenario_cxc']['labels']["cl_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_fac_deudas_escenario_cxc']['labels']["cl_nombre"] : "" . $this->Nm_lang['lang_cliente'] . "";
   $tab_ger_campos['mes_periodo'] = "on";
   $tab_def_campos['mes_periodo'] = "mes_periodo";
   $tab_labels["mes_periodo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_fac_deudas_escenario_cxc']['labels']["mes_periodo"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_fac_deudas_escenario_cxc']['labels']["mes_periodo"] : "" . $this->Nm_lang['lang_srch_mnth'] . "";
   $tab_ger_campos['anio_periodo'] = "on";
   $tab_def_campos['anio_periodo'] = "anio_periodo";
   $tab_labels["anio_periodo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_fac_deudas_escenario_cxc']['labels']["anio_periodo"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_fac_deudas_escenario_cxc']['labels']["anio_periodo"] : "" . $this->Nm_lang['lang_srch_year'] . "";
   $tab_ger_campos['fac_total'] = "on";
   $tab_def_campos['fac_total'] = "fac_total";
   $tab_labels["fac_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_fac_deudas_escenario_cxc']['labels']["fac_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_fac_deudas_escenario_cxc']['labels']["fac_total"] : "" . $this->Nm_lang['lang_valor'] . "";
   $tab_ger_campos['op_estado'] = "on";
   $tab_def_campos['op_estado'] = "op_estado";
   $tab_labels["op_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_fac_deudas_escenario_cxc']['labels']["op_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_fac_deudas_escenario_cxc']['labels']["op_estado"] : "" . $this->Nm_lang['lang_estado'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_v_fac_deudas_escenario_cxc']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_v_fac_deudas_escenario_cxc']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_v_fac_deudas_escenario_cxc']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_fac_deudas_escenario_cxc']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_fac_deudas_escenario_cxc']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_v_fac_deudas_escenario_cxc']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_v_fac_deudas_escenario_cxc']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_v_fac_deudas_escenario_cxc']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_v_fac_deudas_escenario_cxc']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_v_fac_deudas_escenario_cxc']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_v_fac_deudas_escenario_cxc']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_v_fac_deudas_escenario_cxc']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_v_fac_deudas_escenario_cxc_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_v_fac_deudas_escenario_cxc']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_v_fac_deudas_escenario_cxc']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_v_fac_deudas_escenario_cxc']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_v_fac_deudas_escenario_cxc']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_v_fac_deudas_escenario_cxc']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
