...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____busca_aplicacion"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____busca_aplicacion"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['busca_aplicacion']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['busca_aplicacion']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['busca_aplicacion']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['busca_aplicacion']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['busca_aplicacion']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['busca_aplicacion']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['busca_aplicacion']['embutida_filho'] as $ind => $sc_init)
          {
