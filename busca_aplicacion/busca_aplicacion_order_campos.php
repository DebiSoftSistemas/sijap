...
<?php
   ...
   $Ord_Cmp = new busca_aplicacion_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class busca_aplicacion_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['busca_aplicacion']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['busca_aplicacion']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['apl_id'] = "apl_id";
   $tab_labels["apl_id"]   = (isset($_SESSION['sc_session'][$sc_init]['busca_aplicacion']['labels']["apl_id"])) ? $_SESSION['sc_session'][$sc_init]['busca_aplicacion']['labels']["apl_id"] : "" . $this->Nm_lang['lang_id'] . "";
   $tab_ger_campos['apl_nombre'] = "on";
   $tab_def_campos['apl_nombre'] = "apl_nombre";
   $tab_labels["apl_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['busca_aplicacion']['labels']["apl_nombre"])) ? $_SESSION['sc_session'][$sc_init]['busca_aplicacion']['labels']["apl_nombre"] : "" . $this->Nm_lang['lang_aplicacion'] . "";
   $tab_ger_campos['apl_descripcion'] = "on";
   $tab_def_campos['apl_descripcion'] = "apl_descripcion";
   $tab_labels["apl_descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['busca_aplicacion']['labels']["apl_descripcion"])) ? $_SESSION['sc_session'][$sc_init]['busca_aplicacion']['labels']["apl_descripcion"] : "" . $this->Nm_lang['lang_descripcion'] . "";
   $tab_ger_campos['apl_tipo'] = "on";
   $tab_def_campos['apl_tipo'] = "apl_tipo";
   $tab_labels["apl_tipo"]   = (isset($_SESSION['sc_session'][$sc_init]['busca_aplicacion']['labels']["apl_tipo"])) ? $_SESSION['sc_session'][$sc_init]['busca_aplicacion']['labels']["apl_tipo"] : "" . $this->Nm_lang['lang_sec_app_type'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['busca_aplicacion']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['busca_aplicacion']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['busca_aplicacion']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['busca_aplicacion']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['busca_aplicacion']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['busca_aplicacion']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['busca_aplicacion']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['busca_aplicacion']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['busca_aplicacion']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['busca_aplicacion']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['busca_aplicacion']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['busca_aplicacion']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "busca_aplicacion_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['busca_aplicacion']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['busca_aplicacion']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['busca_aplicacion']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['busca_aplicacion']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['busca_aplicacion']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
