...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "apl_id";$Nm_numeric[] = "apl_id";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_apl_id_cond" name="apl_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_apl_id'), this, 'apl_id')">
       <OPTION value="eq" <?php if ("eq" == $apl_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_apl_id"  <?php echo $str_hide_apl_id?>><?php
      if ($apl_id != "")
      {
      $apl_id_look = (is_string($apl_id) ? substr($this->Db->qstr($apl_id), 1, -1) : $apl_id); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_apl_nombre_cond" name="apl_nombre_cond" onChange="nm_campos_between(document.getElementById('id_vis_apl_nombre'), this, 'apl_nombre')">
      ...
      <br><span id="id_hide_apl_nombre"  <?php echo $str_hide_apl_nombre?>><?php
      if ($apl_nombre != "")
      {
      $apl_nombre_look = (is_string($apl_nombre) ? substr($this->Db->qstr($apl_nombre), 1, -1) : $apl_nombre); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_apl_descripcion_cond" name="apl_descripcion_cond" onChange="nm_campos_between(document.getElementById('id_vis_apl_descripcion'), this, 'apl_descripcion')">
      ...
      <br><span id="id_hide_apl_descripcion"  <?php echo $str_hide_apl_descripcion?>><?php
      if ($apl_descripcion != "")
      {
      $apl_descripcion_look = (is_string($apl_descripcion) ? substr($this->Db->qstr($apl_descripcion), 1, -1) : $apl_descripcion); 
      $nmgp_def_dados = array(); 
