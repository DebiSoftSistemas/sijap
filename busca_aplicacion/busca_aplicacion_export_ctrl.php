<?php
@session_start() ;
$_SESSION['scriptcase']['busca_aplicacion']['sc_process_barr'] = true;
require_once('../busca_aplicacion/index.php');
unset($_SESSION['scriptcase']['busca_aplicacion']['sc_process_barr']);
$ExportCtrl = new busca_aplicacion_export_control;
$ExportCtrl->Export_barr();

class busca_aplicacion_export_control
{
