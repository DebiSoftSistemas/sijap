...
class busca_aplicacion_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . busca_aplicacion_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . busca_aplicacion_pack_protect_string($Tipo_filter[0]) . "\">.." . busca_aplicacion_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_apl_id')
      {
          $apl_id = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_apl_id($apl_id);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_apl_nombre')
      {
          $apl_nombre = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_apl_nombre($apl_nombre);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_apl_descripcion')
      {
          $apl_descripcion = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_apl_descripcion($apl_descripcion);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   {
      $apl_id = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $apl_id);
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$campo_join]);
              return;
          }
         $nm_ini_lower = "";
         $nm_fim_lower = "";
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_buscar_aplicacion'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>busca_aplicacion/busca_aplicacion_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="busca_aplicacion_ajax_search.js"></script>
 <script type="text/javascript" src="busca_aplicacion_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="busca_aplicacion_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['busca_aplicacion']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['busca_aplicacion']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_apl_id_cond#NMF#' + search_get_sel_txt('SC_apl_id_cond') + '@NMF@';
  str_out += 'SC_apl_id#NMF#' + search_get_text('SC_apl_id') + '@NMF@';
  str_out += 'id_ac_apl_id#NMF#' + search_get_title('select2-id_ac_apl_id-container') + '@NMF@';
  str_out += 'SC_apl_nombre_cond#NMF#' + search_get_sel_txt('SC_apl_nombre_cond') + '@NMF@';
  str_out += 'SC_apl_nombre#NMF#' + search_get_text('SC_apl_nombre') + '@NMF@';
  str_out += 'id_ac_apl_nombre#NMF#' + search_get_title('select2-id_ac_apl_nombre-container') + '@NMF@';
  str_out += 'SC_apl_descripcion_cond#NMF#' + search_get_sel_txt('SC_apl_descripcion_cond') + '@NMF@';
  str_out += 'SC_apl_descripcion#NMF#' + search_get_text('SC_apl_descripcion') + '@NMF@';
  str_out += 'id_ac_apl_descripcion#NMF#' + search_get_title('select2-id_ac_apl_descripcion-container') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-apl_id").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_apl_id",
      max_itens: "10",
   ...
   $("#SC_apl_id").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-apl_nombre").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_apl_nombre",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_apl_nombre").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-apl_descripcion").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_apl_descripcion",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_apl_descripcion").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $apl_id_cond, $apl_id, $apl_id_autocomp,
             $apl_nombre_cond, $apl_nombre, $apl_nombre_autocomp,
             $apl_descripcion_cond, $apl_descripcion, $apl_descripcion_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $apl_id = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['campos_busca']['apl_id']; 
          $apl_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['campos_busca']['apl_id_cond']; 
          $apl_nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['campos_busca']['apl_nombre']; 
          $apl_nombre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['campos_busca']['apl_nombre_cond']; 
          $apl_descripcion = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['campos_busca']['apl_descripcion']; 
          $apl_descripcion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['campos_busca']['apl_descripcion_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['campos_busca']['NM_operador']; 
      } 
      if (!isset($apl_nombre_cond) || empty($apl_nombre_cond))
      {
         $apl_nombre_cond = "qp";
      }
      if (!isset($apl_descripcion_cond) || empty($apl_descripcion_cond))
      {
         $apl_descripcion_cond = "qp";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_apl_id = (in_array($apl_id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_apl_nombre = (in_array($apl_nombre_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_apl_descripcion = (in_array($apl_descripcion_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($apl_id) || $apl_id == "")
      {
          $apl_id = "";
      }
      if (isset($apl_id) && !empty($apl_id))
      {
         $tmp_pos = (is_string($apl_id)) ? strpos($apl_id, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $apl_id = substr($apl_id, 0, $tmp_pos);
         }
      }
      if (!isset($apl_nombre) || $apl_nombre == "")
      {
          $apl_nombre = "";
      }
      if (isset($apl_nombre) && !empty($apl_nombre))
      {
         $tmp_pos = (is_string($apl_nombre)) ? strpos($apl_nombre, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $apl_nombre = substr($apl_nombre, 0, $tmp_pos);
         }
      }
      if (!isset($apl_descripcion) || $apl_descripcion == "")
      {
          $apl_descripcion = "";
      }
      if (isset($apl_descripcion) && !empty($apl_descripcion))
      {
         $tmp_pos = (is_string($apl_descripcion)) ? strpos($apl_descripcion, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $apl_descripcion = substr($apl_descripcion, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_apl_id_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['apl_id'])) ? $this->New_label['apl_id'] : "" . $this->Ini->Nm_lang['lang_id'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_apl_id_cond" name="apl_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_apl_id'), this, 'apl_id')">
       <OPTION value="eq" <?php if ("eq" == $apl_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_apl_id" <?php echo $str_hide_apl_id?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['apl_id'])) ? $this->New_label['apl_id'] : "" . $this->Ini->Nm_lang['lang_id'] . "";
 $nmgp_tab_label .= "apl_id?#?" . $SC_Label . "?@?";
...
<?php
   ...
   { 
      ...
      {
            nmgp_Form_Num_Val($apl_id, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $apl_id;
      }
?>
<INPUT  type="text" id="SC_apl_id" name="apl_id" value="<?php echo NM_encode_input($apl_id) ?>" size=4 alt="{datatype: 'integer', maxLength: 4, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-apl_id" id="id_ac_apl_id" name="apl_id_autocomp"><?php if ('' !=  $apl_id) { ?><option value="<?php echo $apl_id ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_apl_nombre_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['apl_nombre'])) ? $this->New_label['apl_nombre'] : "" . $this->Ini->Nm_lang['lang_aplicacion'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_apl_nombre_cond" name="apl_nombre_cond" onChange="nm_campos_between(document.getElementById('id_vis_apl_nombre'), this, 'apl_nombre')">
       <OPTION value="qp" <?php if ("qp" == $apl_nombre_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $apl_nombre_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $apl_nombre_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $apl_nombre_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_apl_nombre" <?php echo $str_hide_apl_nombre?> valign="top">
 ...
 $nmgp_tab_label .= "apl_nombre?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $apl_nombre;
      }
?>
<INPUT  type="text" id="SC_apl_nombre" name="apl_nombre" value="<?php echo NM_encode_input($apl_nombre) ?>"  size=50 alt="{datatype: 'text', maxLength: 128, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-apl_nombre" id="id_ac_apl_nombre" name="apl_nombre_autocomp"><?php if ('' !=  $apl_nombre) { ?><option value="<?php echo $apl_nombre ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_apl_descripcion_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['apl_descripcion'])) ? $this->New_label['apl_descripcion'] : "" . $this->Ini->Nm_lang['lang_descripcion'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_apl_descripcion_cond" name="apl_descripcion_cond" onChange="nm_campos_between(document.getElementById('id_vis_apl_descripcion'), this, 'apl_descripcion')">
       <OPTION value="qp" <?php if ("qp" == $apl_descripcion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $apl_descripcion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $apl_descripcion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $apl_descripcion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_apl_descripcion" <?php echo $str_hide_apl_descripcion?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['apl_descripcion'])) ? $this->New_label['apl_descripcion'] : "" . $this->Ini->Nm_lang['lang_descripcion'] . "";
 $nmgp_tab_label .= "apl_descripcion?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $apl_descripcion;
      }
?>
<INPUT  type="text" id="SC_apl_descripcion" name="apl_descripcion" value="<?php echo NM_encode_input($apl_descripcion) ?>"  size=50 alt="{datatype: 'text', maxLength: 250, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-apl_descripcion" id="id_ac_apl_descripcion" name="apl_descripcion_autocomp"><?php if ('' !=  $apl_descripcion) { ?><option value="<?php echo $apl_descripcion ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("busca_aplicacion_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['busca_aplicacion']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['busca_aplicacion']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_apl_id'), document.F1.apl_id_cond, 'apl_id');
   document.F1.apl_id.value = "";
   document.F1.apl_id_autocomp.value = "";
   $('#select2-id_ac_apl_id-container').html('<?php echo $this->Val_init_apl_id['desc'] ?>');;
   document.F1.apl_nombre_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_apl_nombre'), document.F1.apl_nombre_cond, 'apl_nombre');
   document.F1.apl_nombre.value = "";
   document.F1.apl_nombre_autocomp.value = "";
   $('#select2-id_ac_apl_nombre-container').html('<?php echo $this->Val_init_apl_nombre['desc'] ?>');;
   document.F1.apl_descripcion_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_apl_descripcion'), document.F1.apl_descripcion_cond, 'apl_descripcion');
   document.F1.apl_descripcion.value = "";
   document.F1.apl_descripcion_autocomp.value = "";
   $('#select2-id_ac_apl_descripcion-container').html('<?php echo $this->Val_init_apl_descripcion['desc'] ?>');;
   Sc_carga_select2('all');
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_apl_id_cond'] = 'cond';
      $tp_fields['SC_apl_id'] = 'text_aut';
      $tp_fields['id_ac_apl_id'] = 'select2_aut';
      $tp_fields['SC_apl_nombre_cond'] = 'cond';
      $tp_fields['SC_apl_nombre'] = 'text_aut';
      $tp_fields['id_ac_apl_nombre'] = 'select2_aut';
      $tp_fields['SC_apl_descripcion_cond'] = 'cond';
      $tp_fields['SC_apl_descripcion'] = 'text_aut';
      $tp_fields['id_ac_apl_descripcion'] = 'select2_aut';
   ...
   {
      global $apl_id_cond, $apl_id, $apl_id_autocomp,
             $apl_nombre_cond, $apl_nombre, $apl_nombre_autocomp,
             $apl_descripcion_cond, $apl_descripcion, $apl_descripcion_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($apl_id_autocomp) && empty($apl_id))
      {
          $apl_id = $apl_id_autocomp;
      }
      if (!empty($apl_nombre_autocomp) && empty($apl_nombre))
      {
          $apl_nombre = $apl_nombre_autocomp;
      }
      if (!empty($apl_descripcion_autocomp) && empty($apl_descripcion))
      {
          $apl_descripcion = $apl_descripcion_autocomp;
      }
      $apl_id_cond_salva = $apl_id_cond; 
      if (!isset($apl_id_input_2) || $apl_id_input_2 == "")
      {
          $apl_id_input_2 = $apl_id;
      }
      $apl_nombre_cond_salva = $apl_nombre_cond; 
      if (!isset($apl_nombre_input_2) || $apl_nombre_input_2 == "")
      {
          $apl_nombre_input_2 = $apl_nombre;
      }
      $apl_descripcion_cond_salva = $apl_descripcion_cond; 
      if (!isset($apl_descripcion_input_2) || $apl_descripcion_input_2 == "")
      {
          $apl_descripcion_input_2 = $apl_descripcion;
      }
      if ($apl_id_cond != "in")
      {
          nm_limpa_numero($apl_id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['campos_busca']['apl_id'] = $apl_id; 
      if (is_array($apl_id) && !empty($apl_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['Grid_search'][$I_Grid]['val'][0] = $apl_id;
      }
      elseif ($apl_id_cond_salva == "nu" || $apl_id_cond_salva == "nn" || $apl_id_cond_salva == "ep" || $apl_id_cond_salva == "ne" || !empty($apl_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['Grid_search'][$I_Grid]['val'][0][0] = $apl_id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['campos_busca']['apl_id_cond'] = $apl_id_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['Grid_search'][$I_Grid]['cmp'] = "apl_id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['Grid_search'][$I_Grid]['opc'] = $apl_id_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq']['apl_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['campos_busca']['apl_nombre'] = $apl_nombre; 
      if (is_array($apl_nombre) && !empty($apl_nombre))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['Grid_search'][$I_Grid]['val'][0] = $apl_nombre;
      }
      elseif ($apl_nombre_cond_salva == "nu" || $apl_nombre_cond_salva == "nn" || $apl_nombre_cond_salva == "ep" || $apl_nombre_cond_salva == "ne" || !empty($apl_nombre))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['Grid_search'][$I_Grid]['val'][0][0] = $apl_nombre;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['campos_busca']['apl_nombre_cond'] = $apl_nombre_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['Grid_search'][$I_Grid]['cmp'] = "apl_nombre"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['Grid_search'][$I_Grid]['opc'] = $apl_nombre_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq']['apl_nombre'] = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['campos_busca']['apl_descripcion'] = $apl_descripcion; 
      if (is_array($apl_descripcion) && !empty($apl_descripcion))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['Grid_search'][$I_Grid]['val'][0] = $apl_descripcion;
      }
      elseif ($apl_descripcion_cond_salva == "nu" || $apl_descripcion_cond_salva == "nn" || $apl_descripcion_cond_salva == "ep" || $apl_descripcion_cond_salva == "ne" || !empty($apl_descripcion))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['Grid_search'][$I_Grid]['val'][0][0] = $apl_descripcion;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['campos_busca']['apl_descripcion_cond'] = $apl_descripcion_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['Grid_search'][$I_Grid]['cmp'] = "apl_descripcion"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['Grid_search'][$I_Grid]['opc'] = $apl_descripcion_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['grid_pesq']['apl_descripcion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['campos_busca'] = $Temp_Busca;
      }
      if ($apl_id_cond != "in" && $apl_id_cond != "bw" && !empty($apl_id) && !is_numeric($apl_id))
      {
      ...
      if ($apl_id_cond == "bw" && ((!empty($apl_id) && !is_numeric($apl_id)) || (!empty($apl_id_input_2) && !is_numeric($apl_id_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : " . $this->Ini->Nm_lang['lang_id'] . "";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['apl_id'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['apl_id'] = $cmp1;
      }
      else
      {
          $cmp1 = $apl_id;
    ...
    if ($apl_nombre != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['apl_nombre'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['apl_nombre'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['apl_nombre'] = $apl_nombre;
      }
      $nmgp_def_dados = array();
    if ($apl_descripcion != '') {
      $apl_descripcion_look = (is_string($apl_descripcion) ? substr($this->Db->qstr($apl_descripcion), 1, -1) : $apl_descripcion); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['apl_descripcion'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['apl_descripcion'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['apl_descripcion'] = $apl_descripcion;
      }

      //----- $apl_id
      $this->Date_part = false;
      if (isset($apl_id) || $apl_id_cond == "nu" || $apl_id_cond == "nn" || $apl_id_cond == "ep" || $apl_id_cond == "ne")
      {
         $this->monta_condicao("apl_id", $apl_id_cond, $apl_id, "", "apl_id", "INTEGER", false);
      }

      //----- $apl_nombre
      $this->Date_part = false;
      if (isset($apl_nombre) || $apl_nombre_cond == "nu" || $apl_nombre_cond == "nn" || $apl_nombre_cond == "ep" || $apl_nombre_cond == "ne")
      {
         $this->monta_condicao("apl_nombre", $apl_nombre_cond, $apl_nombre, "", "apl_nombre", "VARCHAR", false);
      }

      //----- $apl_descripcion
      $this->Date_part = false;
      if (isset($apl_descripcion) || $apl_descripcion_cond == "nu" || $apl_descripcion_cond == "nn" || $apl_descripcion_cond == "ep" || $apl_descripcion_cond == "ne")
      {
         $this->monta_condicao("apl_descripcion", $apl_descripcion_cond, $apl_descripcion, "", "apl_descripcion", "VARCHAR", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
    $this->Sel_case_sensitive($this->comando);
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['busca_aplicacion']['cond_pesq'] .= $this->NM_operador;
