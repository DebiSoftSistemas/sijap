...
<?php
   ...
   $Ord_Cmp = new grid_sis_catalogo_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_sis_catalogo_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_sis_catalogo']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_sis_catalogo']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['cat_id'] = "cat_id";
   $tab_labels["cat_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sis_catalogo']['labels']["cat_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_sis_catalogo']['labels']["cat_id"] : "" . $this->Nm_lang['lang_id'] . "";
   $tab_ger_campos['cat_nombre'] = "on";
   $tab_def_campos['cat_nombre'] = "cat_nombre";
   $tab_labels["cat_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sis_catalogo']['labels']["cat_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_sis_catalogo']['labels']["cat_nombre"] : "" . $this->Nm_lang['lang_catalogo'] . "";
   $tab_ger_campos['cat_vista_bdd'] = "on";
   $tab_def_campos['cat_vista_bdd'] = "cat_vista_bdd";
   $tab_labels["cat_vista_bdd"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sis_catalogo']['labels']["cat_vista_bdd"])) ? $_SESSION['sc_session'][$sc_init]['grid_sis_catalogo']['labels']["cat_vista_bdd"] : "" . $this->Nm_lang['lang_vista_bdd'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_sis_catalogo']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_sis_catalogo']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_sis_catalogo']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_sis_catalogo']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_sis_catalogo']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_sis_catalogo']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_sis_catalogo']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_sis_catalogo']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_sis_catalogo']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_sis_catalogo']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_sis_catalogo']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_sis_catalogo']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_sis_catalogo_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_sis_catalogo']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_sis_catalogo']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_sis_catalogo']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_sis_catalogo']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_sis_catalogo']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
