...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_inv_recibir_transferencia"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_inv_recibir_transferencia"]);
   }
