<?php
@session_start() ;
$_SESSION['scriptcase']['grid_fac_solicitud_anulacion_deuda']['sc_process_barr'] = true;
require_once('../grid_fac_solicitud_anulacion_deuda/index.php');
unset($_SESSION['scriptcase']['grid_fac_solicitud_anulacion_deuda']['sc_process_barr']);
$ExportCtrl = new grid_fac_solicitud_anulacion_deuda_export_control;
$ExportCtrl->Export_barr();

class grid_fac_solicitud_anulacion_deuda_export_control
{
