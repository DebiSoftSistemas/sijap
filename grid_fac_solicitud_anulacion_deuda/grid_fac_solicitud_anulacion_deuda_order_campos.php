...
<?php
   ...
   $Ord_Cmp = new grid_fac_solicitud_anulacion_deuda_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_fac_solicitud_anulacion_deuda_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_anulacion_deuda']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_anulacion_deuda']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['sad_fecha'] = "sad_fecha";
   $tab_labels["sad_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_anulacion_deuda']['labels']["sad_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_anulacion_deuda']['labels']["sad_fecha"] : "" . $this->Nm_lang['lang_fecha'] . "";
   $tab_ger_campos['sad_propietario'] = "on";
   $tab_def_campos['sad_propietario'] = "sad_propietario";
   $tab_labels["sad_propietario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_anulacion_deuda']['labels']["sad_propietario"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_anulacion_deuda']['labels']["sad_propietario"] : "" . $this->Nm_lang['lang_propietario'] . "";
   $tab_ger_campos['sad_usuario'] = "on";
   $tab_def_campos['sad_usuario'] = "sad_usuario";
   $tab_labels["sad_usuario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_anulacion_deuda']['labels']["sad_usuario"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_anulacion_deuda']['labels']["sad_usuario"] : "" . $this->Nm_lang['lang_usuario'] . "";
   $tab_ger_campos['sad_estado'] = "on";
   $tab_def_campos['sad_estado'] = "sad_estado";
   $tab_labels["sad_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_anulacion_deuda']['labels']["sad_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_anulacion_deuda']['labels']["sad_estado"] : "" . $this->Nm_lang['lang_estado'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_anulacion_deuda']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_anulacion_deuda']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_anulacion_deuda']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_anulacion_deuda']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_anulacion_deuda']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_anulacion_deuda']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_anulacion_deuda']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_anulacion_deuda']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_anulacion_deuda']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_anulacion_deuda']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_anulacion_deuda']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_anulacion_deuda']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_fac_solicitud_anulacion_deuda_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_anulacion_deuda']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_anulacion_deuda']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_anulacion_deuda']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_anulacion_deuda']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_anulacion_deuda']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
