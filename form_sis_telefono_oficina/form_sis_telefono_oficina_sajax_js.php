  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_telefono_oficina" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sis_telefono_oficina_form();
	}
...
?>
  ...
  // ---------- Validate teo_id_
  function do_ajax_form_sis_telefono_oficina_validate_teo_id_(iNumLinha)
  {
    var nomeCampo_teo_id_ = "teo_id_" + iNumLinha;
    var var_teo_id_ = scAjaxGetFieldText(nomeCampo_teo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_telefono_oficina_validate_teo_id_(var_teo_id_, iNumLinha, var_script_case_init, do_ajax_form_sis_telefono_oficina_validate_teo_id__cb);
  } // do_ajax_form_sis_telefono_oficina_validate_teo_id_

  function do_ajax_form_sis_telefono_oficina_validate_teo_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "teo_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "teo_id_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "teo_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "teo_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_telefono_oficina_validate_teo_id__cb

  // ---------- Validate teo_oficina_
  function do_ajax_form_sis_telefono_oficina_validate_teo_oficina_(iNumLinha)
  {
    var nomeCampo_teo_oficina_ = "teo_oficina_" + iNumLinha;
    var var_teo_oficina_ = scAjaxGetFieldText(nomeCampo_teo_oficina_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_telefono_oficina_validate_teo_oficina_(var_teo_oficina_, iNumLinha, var_script_case_init, do_ajax_form_sis_telefono_oficina_validate_teo_oficina__cb);
  } // do_ajax_form_sis_telefono_oficina_validate_teo_oficina_

  function do_ajax_form_sis_telefono_oficina_validate_teo_oficina__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "teo_oficina_" + iLineNumber;
    }
    else
    {
      sFieldValid = "teo_oficina_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "teo_oficina_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "teo_oficina_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_telefono_oficina_validate_teo_oficina__cb

  // ---------- Validate teo_numero_
  function do_ajax_form_sis_telefono_oficina_validate_teo_numero_(iNumLinha)
  {
    var nomeCampo_teo_numero_ = "teo_numero_" + iNumLinha;
    var var_teo_numero_ = scAjaxGetFieldText(nomeCampo_teo_numero_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_telefono_oficina_validate_teo_numero_(var_teo_numero_, iNumLinha, var_script_case_init, do_ajax_form_sis_telefono_oficina_validate_teo_numero__cb);
  } // do_ajax_form_sis_telefono_oficina_validate_teo_numero_

  function do_ajax_form_sis_telefono_oficina_validate_teo_numero__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "teo_numero_" + iLineNumber;
    }
    else
    {
      sFieldValid = "teo_numero_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "teo_numero_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "teo_numero_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_telefono_oficina_validate_teo_numero__cb

  // ---------- Validate teo_tipo_
  function do_ajax_form_sis_telefono_oficina_validate_teo_tipo_(iNumLinha)
  {
    var nomeCampo_teo_tipo_ = "teo_tipo_" + iNumLinha;
    var var_teo_tipo_ = scAjaxGetFieldText(nomeCampo_teo_tipo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_telefono_oficina_validate_teo_tipo_(var_teo_tipo_, iNumLinha, var_script_case_init, do_ajax_form_sis_telefono_oficina_validate_teo_tipo__cb);
  } // do_ajax_form_sis_telefono_oficina_validate_teo_tipo_

  function do_ajax_form_sis_telefono_oficina_validate_teo_tipo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "teo_tipo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "teo_tipo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "teo_tipo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "teo_tipo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_telefono_oficina_validate_teo_tipo__cb

  // ---------- Validate teo_extension_
  function do_ajax_form_sis_telefono_oficina_validate_teo_extension_(iNumLinha)
  {
    var nomeCampo_teo_extension_ = "teo_extension_" + iNumLinha;
    var var_teo_extension_ = scAjaxGetFieldText(nomeCampo_teo_extension_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_telefono_oficina_validate_teo_extension_(var_teo_extension_, iNumLinha, var_script_case_init, do_ajax_form_sis_telefono_oficina_validate_teo_extension__cb);
  } // do_ajax_form_sis_telefono_oficina_validate_teo_extension_

  function do_ajax_form_sis_telefono_oficina_validate_teo_extension__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "teo_extension_" + iLineNumber;
    }
    else
    {
      sFieldValid = "teo_extension_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "teo_extension_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "teo_extension_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_telefono_oficina_validate_teo_extension__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_sis_telefono_oficina_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_sis_telefono_oficina_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sis_telefono_oficina_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_sis_telefono_oficina_add_new_line_cb);
  } // do_ajax_form_sis_telefono_oficina_add_new_line

  function do_ajax_form_sis_telefono_oficina_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_sis_telefono_oficina_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_sis_telefono_oficina_backup_line(iNumLinha)
  {
    var var_teo_id_ = scAjaxGetFieldText("teo_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_telefono_oficina_backup_line(var_teo_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_sis_telefono_oficina_backup_line_cb);
  } // do_ajax_form_sis_telefono_oficina_backup_line

  function do_ajax_form_sis_telefono_oficina_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_sis_telefono_oficina_backup_line_cb

  function do_ajax_form_sis_telefono_oficina_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_sis_telefono_oficina_cancel_insert

  function do_ajax_form_sis_telefono_oficina_cancel_update(iSeqVert)
  {
    do_ajax_form_sis_telefono_oficina_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_sis_telefono_oficina_cancel_update

  function do_ajax_form_sis_telefono_oficina_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_sis_telefono_oficina_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_sis_telefono_oficina_table_refresh()
  {
    var var_teo_id_ = document.F2.teo_id_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_sis_telefono_oficina_table_refresh(var_teo_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_telefono_oficina_table_refresh_cb);
  } //  do_ajax_form_sis_telefono_oficina_table_refresh

  function do_ajax_form_sis_telefono_oficina_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.teo_id_.value = scAjaxGetKeyValue("teo_id_");
    ...
    scAjaxAlert(do_ajax_form_sis_telefono_oficina_table_refresh_cb_after_alert);
  } // do_ajax_form_sis_telefono_oficina_table_refresh_cb
  function do_ajax_form_sis_telefono_oficina_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_sis_telefono_oficina_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_sis_telefono_oficina_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_sis_telefono_oficina_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_teo_id_ = scAjaxGetFieldText("teo_id_" + iNumLinha);
    var var_teo_oficina_ = scAjaxGetFieldText("teo_oficina_" + iNumLinha);
    var var_teo_numero_ = scAjaxGetFieldText("teo_numero_" + iNumLinha);
    var var_teo_tipo_ = scAjaxGetFieldText("teo_tipo_" + iNumLinha);
    var var_teo_extension_ = scAjaxGetFieldText("teo_extension_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_sis_telefono_oficina_submit_form(var_teo_id_, var_teo_oficina_, var_teo_numero_, var_teo_tipo_, var_teo_extension_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_telefono_oficina_submit_form_cb);
  } // do_ajax_form_sis_telefono_oficina_submit_form

  function do_ajax_form_sis_telefono_oficina_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("teo_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("teo_oficina_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("teo_numero_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("teo_tipo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("teo_extension_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sis_telefono_oficina_submit_form_cb_after_alert);
  } // do_ajax_form_sis_telefono_oficina_submit_form_cb
  function do_ajax_form_sis_telefono_oficina_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_telefono_oficina_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sis_telefono_oficina_navigate_form()
  {
    perform_ajax_form_sis_telefono_oficina_navigate_form();
  }

  function perform_ajax_form_sis_telefono_oficina_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_sis_telefono_oficina_cancel_insert(sc_form_sis_telefono_oficina_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("teo_id_" + iNavForm);
      scAjaxHideErrorDisplay("teo_oficina_" + iNavForm);
      scAjaxHideErrorDisplay("teo_numero_" + iNavForm);
      scAjaxHideErrorDisplay("teo_tipo_" + iNavForm);
      scAjaxHideErrorDisplay("teo_extension_" + iNavForm);
    }
    var var_teo_id_ = document.F2.teo_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sis_telefono_oficina_navigate_form(var_teo_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_telefono_oficina_navigate_form_cb);
  } // do_ajax_form_sis_telefono_oficina_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_telefono_oficina']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_telefono_oficina_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.teo_id_.value = scAjaxGetKeyValue("teo_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_telefono_oficina_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_telefono_oficina_navigate_form_cb
  function do_ajax_form_sis_telefono_oficina_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_sis_telefono_oficina_navigate_form_cb_after_alert

    function sc_form_sis_telefono_oficina_get_last_line_number()
    {
    ...
    } //sc_form_sis_telefono_oficina_get_last_line_number

  function sc_hide_form_sis_telefono_oficina_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "teo_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "teo_oficina_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "teo_numero_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "teo_tipo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "teo_extension_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["teo_id_" + iNumLinha] = {"label": "Teo Id<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["teo_oficina_" + iNumLinha] = {"label": "Teo Oficina<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["teo_numero_" + iNumLinha] = {"label": "Teo Numero<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["teo_tipo_" + iNumLinha] = {"label": "Teo Tipo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["teo_extension_" + iNumLinha] = {"label": "Teo Extension<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["teo_id_"][iNumLinha] = "teo_id_" + iNumLinha;
    ajax_field_mult["teo_oficina_"][iNumLinha] = "teo_oficina_" + iNumLinha;
    ajax_field_mult["teo_numero_"][iNumLinha] = "teo_numero_" + iNumLinha;
    ajax_field_mult["teo_tipo_"][iNumLinha] = "teo_tipo_" + iNumLinha;
    ajax_field_mult["teo_extension_"][iNumLinha] = "teo_extension_" + iNumLinha;
    ajax_field_id["teo_id_" + iNumLinha] = new Array("hidden_field_label_teo_id_", "hidden_field_data_teo_id_" + iNumLinha);
    ajax_field_id["teo_oficina_" + iNumLinha] = new Array("hidden_field_label_teo_oficina_", "hidden_field_data_teo_oficina_" + iNumLinha);
    ajax_field_id["teo_numero_" + iNumLinha] = new Array("hidden_field_label_teo_numero_", "hidden_field_data_teo_numero_" + iNumLinha);
    ajax_field_id["teo_tipo_" + iNumLinha] = new Array("hidden_field_label_teo_tipo_", "hidden_field_data_teo_tipo_" + iNumLinha);
    ajax_field_id["teo_extension_" + iNumLinha] = new Array("hidden_field_label_teo_extension_", "hidden_field_data_teo_extension_" + iNumLinha);
    ajax_error_count["teo_id_" + iNumLinha] = "off";
    ajax_error_count["teo_oficina_" + iNumLinha] = "off";
    ajax_error_count["teo_numero_" + iNumLinha] = "off";
    ajax_error_count["teo_tipo_" + iNumLinha] = "off";
    ajax_error_count["teo_extension_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["teo_id_" + iNumLinha] = "on";
    ajax_read_only["teo_oficina_" + iNumLinha] = "off";
    ajax_read_only["teo_numero_" + iNumLinha] = "off";
    ajax_read_only["teo_tipo_" + iNumLinha] = "off";
    ajax_read_only["teo_extension_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["teo_id_" + iNumLinha] = "on";
    ajax_read_only["teo_oficina_" + iNumLinha] = "on";
    ajax_read_only["teo_numero_" + iNumLinha] = "on";
    ajax_read_only["teo_tipo_" + iNumLinha] = "on";
    ajax_read_only["teo_extension_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["teo_id_" + iNumLinha] = null;
    ajax_error_list["teo_oficina_" + iNumLinha] = null;
    ajax_error_list["teo_numero_" + iNumLinha] = null;
    ajax_error_list["teo_tipo_" + iNumLinha] = null;
    ajax_error_list["teo_extension_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "teo_id_": new Array(),
    "teo_oficina_": new Array(),
    "teo_numero_": new Array(),
    "teo_tipo_": new Array(),
    "teo_extension_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["teo_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["teo_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["teo_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["teo_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["teo_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["teo_oficina_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["teo_oficina_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["teo_oficina_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["teo_oficina_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["teo_oficina_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["teo_numero_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["teo_numero_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["teo_numero_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["teo_numero_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["teo_numero_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["teo_tipo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["teo_tipo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["teo_tipo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["teo_tipo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["teo_tipo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["teo_extension_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["teo_extension_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["teo_extension_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["teo_extension_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["teo_extension_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['teo_id_'])) ? $this->nmgp_cmp_readonly['teo_id_'] : 'on';
?>
    scAjaxFieldRead("teo_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['teo_oficina_'])) ? $this->nmgp_cmp_readonly['teo_oficina_'] : 'off';
?>
    scAjaxFieldRead("teo_oficina_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['teo_numero_'])) ? $this->nmgp_cmp_readonly['teo_numero_'] : 'off';
?>
    scAjaxFieldRead("teo_numero_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['teo_tipo_'])) ? $this->nmgp_cmp_readonly['teo_tipo_'] : 'off';
?>
    scAjaxFieldRead("teo_tipo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['teo_extension_'])) ? $this->nmgp_cmp_readonly['teo_extension_'] : 'off';
?>
    scAjaxFieldRead("teo_extension_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("teo_id_" + iSeq, "on");
    scAjaxFieldRead("teo_oficina_" + iSeq, "on");
    scAjaxFieldRead("teo_numero_" + iSeq, "on");
    scAjaxFieldRead("teo_tipo_" + iSeq, "on");
    scAjaxFieldRead("teo_extension_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["teo_id_" + iRow] || "on" == ajax_error_count["teo_oficina_" + iRow] || "on" == ajax_error_count["teo_numero_" + iRow] || "on" == ajax_error_count["teo_tipo_" + iRow] || "on" == ajax_error_count["teo_extension_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_teo_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_teo_oficina_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_teo_numero_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_teo_tipo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_teo_extension_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["teo_id_" + iRow] && "off" == ajax_error_count["teo_oficina_" + iRow] && "off" == ajax_error_count["teo_numero_" + iRow] && "off" == ajax_error_count["teo_tipo_" + iRow] && "off" == ajax_error_count["teo_extension_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["teo_id_" + iRow] = "off";
        ajax_error_count["teo_oficina_" + iRow] = "off";
        ajax_error_count["teo_numero_" + iRow] = "off";
        ajax_error_count["teo_tipo_" + iRow] = "off";
        ajax_error_count["teo_extension_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_teo_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_teo_oficina_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_teo_numero_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_teo_tipo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_teo_extension_" + iRow).removeClass("scFormErrorLine");
    }
  }
