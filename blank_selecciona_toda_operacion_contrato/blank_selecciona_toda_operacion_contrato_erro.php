...
function scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="")
{
    ...
    if (isset($_SESSION['scriptcase']['blank_selecciona_toda_operacion_contrato']['contr_erro']) && $_SESSION['scriptcase']['blank_selecciona_toda_operacion_contrato']['contr_erro'] == 'on')
    {
