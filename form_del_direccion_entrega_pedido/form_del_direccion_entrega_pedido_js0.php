<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="dep_id_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['dep_id_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_del_direccion_entrega_pedido"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function scForm_inline_submit(y, z) {
	Nm_Proc_Atualiz = true;
	do_ajax_form_del_direccion_entrega_pedido_submit_form(y, z);
...
{
   nm_field_disabled("dep_identificacion_quien_recibe_=disabled;dep_nombre_quien_recibie_=disabled;dep_direccion_=disabled;dep_telefono_=disabled", "");
   nm_field_disabled("dep_pais_=disabled;dep_provincial_=disabled;dep_ciudad_=disabled", "U");
