...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_dr_id' + iSeqRow).bind('blur', function() { sc_form_del_detalle_retencion_ventas_dr_id_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_del_detalle_retencion_ventas_dr_id_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_dr_retencion' + iSeqRow).bind('blur', function() { sc_form_del_detalle_retencion_ventas_dr_retencion_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_del_detalle_retencion_ventas_dr_retencion_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_dr_empresa' + iSeqRow).bind('blur', function() { sc_form_del_detalle_retencion_ventas_dr_empresa_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_del_detalle_retencion_ventas_dr_empresa_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_dr_id_factura_venta' + iSeqRow).bind('blur', function() { sc_form_del_detalle_retencion_ventas_dr_id_factura_venta_onblur(this, iSeqRow) })
                                                 .bind('change', function() { sc_form_del_detalle_retencion_ventas_dr_id_factura_venta_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_dr_cod_doc_sustento' + iSeqRow).bind('blur', function() { sc_form_del_detalle_retencion_ventas_dr_cod_doc_sustento_onblur(this, iSeqRow) })
                                                 .bind('change', function() { sc_form_del_detalle_retencion_ventas_dr_cod_doc_sustento_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_dr_serie_doc_sustento' + iSeqRow).bind('blur', function() { sc_form_del_detalle_retencion_ventas_dr_serie_doc_sustento_onblur(this, iSeqRow) })
                                                   .bind('change', function() { sc_form_del_detalle_retencion_ventas_dr_serie_doc_sustento_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_dr_secuencia_doc_sustento' + iSeqRow).bind('blur', function() { sc_form_del_detalle_retencion_ventas_dr_secuencia_doc_sustento_onblur(this, iSeqRow) })
                                                       .bind('change', function() { sc_form_del_detalle_retencion_ventas_dr_secuencia_doc_sustento_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_dr_fecha_emision_doc_sustento' + iSeqRow).bind('blur', function() { sc_form_del_detalle_retencion_ventas_dr_fecha_emision_doc_sustento_onblur(this, iSeqRow) })
                                                           .bind('change', function() { sc_form_del_detalle_retencion_ventas_dr_fecha_emision_doc_sustento_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_dr_porcentaje_retencion' + iSeqRow).bind('blur', function() { sc_form_del_detalle_retencion_ventas_dr_porcentaje_retencion_onblur(this, iSeqRow) })
                                                     .bind('change', function() { sc_form_del_detalle_retencion_ventas_dr_porcentaje_retencion_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_dr_valor_retenido' + iSeqRow).bind('blur', function() { sc_form_del_detalle_retencion_ventas_dr_valor_retenido_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_form_del_detalle_retencion_ventas_dr_valor_retenido_onchange(this, iSeqRow) })
...
function sc_form_del_detalle_retencion_ventas_dr_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_detalle_retencion_ventas_dr_retencion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_detalle_retencion_ventas_dr_empresa_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_detalle_retencion_ventas_dr_id_factura_venta_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_detalle_retencion_ventas_dr_cod_doc_sustento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_detalle_retencion_ventas_dr_serie_doc_sustento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_detalle_retencion_ventas_dr_secuencia_doc_sustento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_detalle_retencion_ventas_dr_fecha_emision_doc_sustento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_detalle_retencion_ventas_dr_porcentaje_retencion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_detalle_retencion_ventas_dr_valor_retenido_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_form_del_detalle_retencion_ventas_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_dr_fecha_emision_doc_sustento" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      setTimeout(function() { do_ajax_form_del_detalle_retencion_ventas_validate_dr_fecha_emision_doc_sustento(iSeqRow); }, 200);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_del_detalle_retencion_ventas')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
