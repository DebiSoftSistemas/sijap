...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "sdd_fecha";$Nm_numeric[] = "sdd_id";$Nm_numeric[] = "sdd_propietario";$Nm_numeric[] = "sdd_monto";$Nm_numeric[] = "sdd_plazo";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_sdd_id_cond" name="sdd_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_sdd_id'), this, 'sdd_id')">
      ...
      <br><span id="id_hide_sdd_id"  <?php echo $str_hide_sdd_id?>><INPUT  type="text" id="SC_sdd_id" name="sdd_id" value="<?php echo NM_encode_input($sdd_id) ?>" size=4 alt="{datatype: 'integer', maxLength: 4, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_sdd_fecha_cond" name="sdd_fecha_cond" onChange="nm_campos_between(document.getElementById('id_vis_sdd_fecha'), this, 'sdd_fecha')">
      ...
      <br><span id="id_hide_sdd_fecha"  <?php echo $str_hide_sdd_fecha?>><?php
      if ($sdd_fecha != "")
      {
      $sdd_fecha_look = (is_string($sdd_fecha) ? substr($this->Db->qstr($sdd_fecha), 1, -1) : $sdd_fecha); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_sdd_propietario_cond" name="sdd_propietario_cond" onChange="nm_campos_between(document.getElementById('id_vis_sdd_propietario'), this, 'sdd_propietario')">
      ...
      <br><span id="id_hide_sdd_propietario"  <?php echo $str_hide_sdd_propietario?>><INPUT  type="text" id="SC_sdd_propietario" name="sdd_propietario" value="<?php echo NM_encode_input($sdd_propietario) ?>" size=4 alt="{datatype: 'integer', maxLength: 4, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_sdd_monto_cond" name="sdd_monto_cond" onChange="nm_campos_between(document.getElementById('id_vis_sdd_monto'), this, 'sdd_monto')">
