...
class grid_fac_solicitud_division_deuda_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_fac_solicitud_division_deuda_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_fac_solicitud_division_deuda_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_fac_solicitud_division_deuda_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_sdd_fecha')
      {
          $sdd_fecha = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_sdd_fecha($sdd_fecha);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$campo_join]);
              return;
          }
         $nm_ini_lower = "";
         $nm_fim_lower = "";
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         $nome_sum = "fac_solicitud_division_deuda.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_subdivision_deuda'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_fac_solicitud_division_deuda/grid_fac_solicitud_division_deuda_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_fac_solicitud_division_deuda_ajax_search.js"></script>
 <script type="text/javascript" src="grid_fac_solicitud_division_deuda_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_fac_solicitud_division_deuda_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_fac_solicitud_division_deuda']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_fac_solicitud_division_deuda']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_sdd_id_cond#NMF#' + search_get_sel_txt('SC_sdd_id_cond') + '@NMF@';
  str_out += 'SC_sdd_id#NMF#' + search_get_text('SC_sdd_id') + '@NMF@';
  str_out += 'SC_sdd_fecha_cond#NMF#' + search_get_sel_txt('SC_sdd_fecha_cond') + '@NMF@';
  str_out += 'SC_sdd_fecha#NMF#' + search_get_text('SC_sdd_fecha') + '@NMF@';
  str_out += 'id_ac_sdd_fecha#NMF#' + search_get_title('select2-id_ac_sdd_fecha-container') + '@NMF@';
  str_out += 'SC_sdd_propietario_cond#NMF#' + search_get_sel_txt('SC_sdd_propietario_cond') + '@NMF@';
  str_out += 'SC_sdd_propietario#NMF#' + search_get_text('SC_sdd_propietario') + '@NMF@';
  str_out += 'SC_sdd_monto_cond#NMF#' + search_get_sel_txt('SC_sdd_monto_cond') + '@NMF@';
  str_out += 'SC_sdd_monto#NMF#' + search_get_text('SC_sdd_monto') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-sdd_fecha").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_sdd_fecha",
      max_itens: "10",
   ...
   $("#SC_sdd_fecha").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      global 
             $sdd_id_cond, $sdd_id,
             $sdd_fecha_cond, $sdd_fecha, $sdd_fecha_autocomp,
             $sdd_propietario_cond, $sdd_propietario,
             $sdd_monto_cond, $sdd_monto,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $sdd_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['campos_busca']['sdd_id']; 
          $sdd_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['campos_busca']['sdd_id_cond']; 
          $sdd_fecha = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['campos_busca']['sdd_fecha']; 
          $sdd_fecha_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['campos_busca']['sdd_fecha_cond']; 
          $sdd_propietario = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['campos_busca']['sdd_propietario']; 
          $sdd_propietario_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['campos_busca']['sdd_propietario_cond']; 
          $sdd_monto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['campos_busca']['sdd_monto']; 
          $sdd_monto_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['campos_busca']['sdd_monto_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['campos_busca']['NM_operador']; 
          if (strtoupper($sdd_id_cond) != "II" && strtoupper($sdd_id_cond) != "QP" && strtoupper($sdd_id_cond) != "NP" && strtoupper($sdd_id_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($sdd_id, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($sdd_propietario_cond) != "II" && strtoupper($sdd_propietario_cond) != "QP" && strtoupper($sdd_propietario_cond) != "NP" && strtoupper($sdd_propietario_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($sdd_propietario, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($sdd_monto_cond) != "II" && strtoupper($sdd_monto_cond) != "QP" && strtoupper($sdd_monto_cond) != "NP" && strtoupper($sdd_monto_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($sdd_monto, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($sdd_id_cond) || empty($sdd_id_cond))
      {
         $sdd_id_cond = "gt";
      }
      if (!isset($sdd_fecha_cond) || empty($sdd_fecha_cond))
      {
         $sdd_fecha_cond = "qp";
      }
      if (!isset($sdd_propietario_cond) || empty($sdd_propietario_cond))
      {
         $sdd_propietario_cond = "gt";
      }
      if (!isset($sdd_monto_cond) || empty($sdd_monto_cond))
      {
         $sdd_monto_cond = "gt";
      }
      ...
      $str_hide_sdd_id = (in_array($sdd_id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_sdd_fecha = (in_array($sdd_fecha_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_sdd_propietario = (in_array($sdd_propietario_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_sdd_monto = (in_array($sdd_monto_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($sdd_id) || $sdd_id == "")
      {
          $sdd_id = "";
      }
      if (isset($sdd_id) && !empty($sdd_id))
      {
         $tmp_pos = (is_string($sdd_id)) ? strpos($sdd_id, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $sdd_id = substr($sdd_id, 0, $tmp_pos);
         }
      }
      if (!isset($sdd_fecha) || $sdd_fecha == "")
      {
          $sdd_fecha = "";
      }
      if (isset($sdd_fecha) && !empty($sdd_fecha))
      {
         $tmp_pos = (is_string($sdd_fecha)) ? strpos($sdd_fecha, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $sdd_fecha = substr($sdd_fecha, 0, $tmp_pos);
         }
      }
      if (!isset($sdd_propietario) || $sdd_propietario == "")
      {
          $sdd_propietario = "";
      }
      if (isset($sdd_propietario) && !empty($sdd_propietario))
      {
         $tmp_pos = (is_string($sdd_propietario)) ? strpos($sdd_propietario, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $sdd_propietario = substr($sdd_propietario, 0, $tmp_pos);
         }
      }
      if (!isset($sdd_monto) || $sdd_monto == "")
      {
          $sdd_monto = "";
      }
      if (isset($sdd_monto) && !empty($sdd_monto))
      {
         $tmp_pos = (is_string($sdd_monto)) ? strpos($sdd_monto, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $sdd_monto = substr($sdd_monto, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_sdd_id_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['sdd_id'])) ? $this->New_label['sdd_id'] : "" . $this->Ini->Nm_lang['lang_id'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_sdd_id_cond" name="sdd_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_sdd_id'), this, 'sdd_id')">
       <OPTION value="gt" <?php if ("gt" == $sdd_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $sdd_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $sdd_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_sdd_id" <?php echo $str_hide_sdd_id?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['sdd_id'])) ? $this->New_label['sdd_id'] : "" . $this->Ini->Nm_lang['lang_id'] . "";
 $nmgp_tab_label .= "sdd_id?#?" . $SC_Label . "?@?";
...
?>
<INPUT  type="text" id="SC_sdd_id" name="sdd_id" value="<?php echo NM_encode_input($sdd_id) ?>" size=4 alt="{datatype: 'integer', maxLength: 4, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_sdd_fecha_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['sdd_fecha'])) ? $this->New_label['sdd_fecha'] : "" . $this->Ini->Nm_lang['lang_fecha'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_sdd_fecha_cond" name="sdd_fecha_cond" onChange="nm_campos_between(document.getElementById('id_vis_sdd_fecha'), this, 'sdd_fecha')">
       <OPTION value="qp" <?php if ("qp" == $sdd_fecha_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $sdd_fecha_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $sdd_fecha_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $sdd_fecha_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_sdd_fecha" <?php echo $str_hide_sdd_fecha?> valign="top">
 ...
 $nmgp_tab_label .= "sdd_fecha?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $sdd_fecha;
      }
?>
<INPUT  type="text" id="SC_sdd_fecha" name="sdd_fecha" value="<?php echo NM_encode_input($sdd_fecha) ?>"  size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-sdd_fecha" id="id_ac_sdd_fecha" name="sdd_fecha_autocomp"><?php if ('' !=  $sdd_fecha) { ?><option value="<?php echo $sdd_fecha ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_sdd_propietario_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['sdd_propietario'])) ? $this->New_label['sdd_propietario'] : "" . $this->Ini->Nm_lang['lang_propietario'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_sdd_propietario_cond" name="sdd_propietario_cond" onChange="nm_campos_between(document.getElementById('id_vis_sdd_propietario'), this, 'sdd_propietario')">
       <OPTION value="gt" <?php if ("gt" == $sdd_propietario_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $sdd_propietario_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $sdd_propietario_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_sdd_propietario" <?php echo $str_hide_sdd_propietario?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['sdd_propietario'])) ? $this->New_label['sdd_propietario'] : "" . $this->Ini->Nm_lang['lang_propietario'] . "";
 $nmgp_tab_label .= "sdd_propietario?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_sdd_propietario" name="sdd_propietario" value="<?php echo NM_encode_input($sdd_propietario) ?>" size=4 alt="{datatype: 'integer', maxLength: 4, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_sdd_monto_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['sdd_monto'])) ? $this->New_label['sdd_monto'] : "" . $this->Ini->Nm_lang['lang_monto_inicial'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_sdd_monto_cond" name="sdd_monto_cond" onChange="nm_campos_between(document.getElementById('id_vis_sdd_monto'), this, 'sdd_monto')">
       <OPTION value="gt" <?php if ("gt" == $sdd_monto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $sdd_monto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $sdd_monto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_sdd_monto" <?php echo $str_hide_sdd_monto?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['sdd_monto'])) ? $this->New_label['sdd_monto'] : "" . $this->Ini->Nm_lang['lang_monto_inicial'] . "";
 $nmgp_tab_label .= "sdd_monto?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_sdd_monto" name="sdd_monto" value="<?php echo NM_encode_input($sdd_monto) ?>" size=17 alt="{datatype: 'decimal', maxLength: 17, precision: 0, decimalSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['dec_num'] ?>', thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_fac_solicitud_division_deuda_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_fac_solicitud_division_deuda']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_fac_solicitud_division_deuda']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.sdd_id_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_sdd_id'), document.F1.sdd_id_cond, 'sdd_id');
   document.F1.sdd_id.value = "";
   document.F1.sdd_fecha_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_sdd_fecha'), document.F1.sdd_fecha_cond, 'sdd_fecha');
   document.F1.sdd_fecha.value = "";
   document.F1.sdd_fecha_autocomp.value = "";
   $('#select2-id_ac_sdd_fecha-container').html('<?php echo $this->Val_init_sdd_fecha['desc'] ?>');;
   document.F1.sdd_propietario_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_sdd_propietario'), document.F1.sdd_propietario_cond, 'sdd_propietario');
   document.F1.sdd_propietario.value = "";
   document.F1.sdd_monto_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_sdd_monto'), document.F1.sdd_monto_cond, 'sdd_monto');
   document.F1.sdd_monto.value = "";
   Sc_carga_select2('all');
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_fac_solicitud_division_deuda/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_sdd_id_cond'] = 'cond';
      $tp_fields['SC_sdd_id'] = 'text';
      $tp_fields['SC_sdd_fecha_cond'] = 'cond';
      $tp_fields['SC_sdd_fecha'] = 'text_aut';
      $tp_fields['id_ac_sdd_fecha'] = 'select2_aut';
      $tp_fields['SC_sdd_propietario_cond'] = 'cond';
      $tp_fields['SC_sdd_propietario'] = 'text';
      $tp_fields['SC_sdd_monto_cond'] = 'cond';
      $tp_fields['SC_sdd_monto'] = 'text';
   ...
   {
      global $sdd_id_cond, $sdd_id,
             $sdd_fecha_cond, $sdd_fecha, $sdd_fecha_autocomp,
             $sdd_propietario_cond, $sdd_propietario,
             $sdd_monto_cond, $sdd_monto, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($sdd_fecha_autocomp) && empty($sdd_fecha))
      {
          $sdd_fecha = $sdd_fecha_autocomp;
      }
      $sdd_id_cond_salva = $sdd_id_cond; 
      if (!isset($sdd_id_input_2) || $sdd_id_input_2 == "")
      {
          $sdd_id_input_2 = $sdd_id;
      }
      $sdd_fecha_cond_salva = $sdd_fecha_cond; 
      if (!isset($sdd_fecha_input_2) || $sdd_fecha_input_2 == "")
      {
          $sdd_fecha_input_2 = $sdd_fecha;
      }
      $sdd_propietario_cond_salva = $sdd_propietario_cond; 
      if (!isset($sdd_propietario_input_2) || $sdd_propietario_input_2 == "")
      {
          $sdd_propietario_input_2 = $sdd_propietario;
      }
      $sdd_monto_cond_salva = $sdd_monto_cond; 
      if (!isset($sdd_monto_input_2) || $sdd_monto_input_2 == "")
      {
          $sdd_monto_input_2 = $sdd_monto;
      }
      if ($sdd_id_cond != "in")
      {
          nm_limpa_numero($sdd_id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($sdd_propietario_cond != "in")
      {
          nm_limpa_numero($sdd_propietario, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($sdd_monto_cond != "in")
      {
          nm_limpa_numero($sdd_monto, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['campos_busca']['sdd_id'] = $sdd_id; 
      if (is_array($sdd_id) && !empty($sdd_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['Grid_search'][$I_Grid]['val'][0] = $sdd_id;
      }
      elseif ($sdd_id_cond_salva == "nu" || $sdd_id_cond_salva == "nn" || $sdd_id_cond_salva == "ep" || $sdd_id_cond_salva == "ne" || !empty($sdd_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['Grid_search'][$I_Grid]['val'][0][0] = $sdd_id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['campos_busca']['sdd_id_cond'] = $sdd_id_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['Grid_search'][$I_Grid]['cmp'] = "sdd_id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['Grid_search'][$I_Grid]['opc'] = $sdd_id_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq']['sdd_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['campos_busca']['sdd_fecha'] = $sdd_fecha; 
      if (is_array($sdd_fecha) && !empty($sdd_fecha))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['Grid_search'][$I_Grid]['val'][0] = $sdd_fecha;
      }
      elseif ($sdd_fecha_cond_salva == "nu" || $sdd_fecha_cond_salva == "nn" || $sdd_fecha_cond_salva == "ep" || $sdd_fecha_cond_salva == "ne" || !empty($sdd_fecha))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['Grid_search'][$I_Grid]['val'][0][0] = $sdd_fecha;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['campos_busca']['sdd_fecha_cond'] = $sdd_fecha_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['Grid_search'][$I_Grid]['cmp'] = "sdd_fecha"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['Grid_search'][$I_Grid]['opc'] = $sdd_fecha_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq']['sdd_fecha'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['campos_busca']['sdd_propietario'] = $sdd_propietario; 
      if (is_array($sdd_propietario) && !empty($sdd_propietario))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['Grid_search'][$I_Grid]['val'][0] = $sdd_propietario;
      }
      elseif ($sdd_propietario_cond_salva == "nu" || $sdd_propietario_cond_salva == "nn" || $sdd_propietario_cond_salva == "ep" || $sdd_propietario_cond_salva == "ne" || !empty($sdd_propietario))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['Grid_search'][$I_Grid]['val'][0][0] = $sdd_propietario;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['campos_busca']['sdd_propietario_cond'] = $sdd_propietario_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['Grid_search'][$I_Grid]['cmp'] = "sdd_propietario"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['Grid_search'][$I_Grid]['opc'] = $sdd_propietario_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq']['sdd_propietario'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['campos_busca']['sdd_monto'] = $sdd_monto; 
      if (is_array($sdd_monto) && !empty($sdd_monto))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['Grid_search'][$I_Grid]['val'][0] = $sdd_monto;
      }
      elseif ($sdd_monto_cond_salva == "nu" || $sdd_monto_cond_salva == "nn" || $sdd_monto_cond_salva == "ep" || $sdd_monto_cond_salva == "ne" || !empty($sdd_monto))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['Grid_search'][$I_Grid]['val'][0][0] = $sdd_monto;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['campos_busca']['sdd_monto_cond'] = $sdd_monto_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['Grid_search'][$I_Grid]['cmp'] = "sdd_monto"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['Grid_search'][$I_Grid]['opc'] = $sdd_monto_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['grid_pesq']['sdd_monto'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['campos_busca'] = $Temp_Busca;
      }
      if ($sdd_monto_cond != "in" && $sdd_monto_cond != "bw" && !empty($sdd_monto) && !is_numeric($sdd_monto))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : " . $this->Ini->Nm_lang['lang_monto_inicial'] . "";
      }
      if ($sdd_monto_cond == "bw" && ((!empty($sdd_monto) && !is_numeric($sdd_monto)) || (!empty($sdd_monto_input_2) && !is_numeric($sdd_monto_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : " . $this->Ini->Nm_lang['lang_monto_inicial'] . "";
      }
      if (!empty($this->Campos_Mens_erro)) 
      ...
      $this->cmp_formatado['sdd_id'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($sdd_fecha != '') {
      $sdd_fecha_look = (is_string($sdd_fecha) ? substr($this->Db->qstr($sdd_fecha), 1, -1) : $sdd_fecha); 
      $nmgp_def_dados = array(); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['sdd_fecha'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['sdd_fecha'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['sdd_fecha'] = $sdd_fecha;
      }
      $Conteudo = $sdd_propietario;
      if (strtoupper($sdd_propietario_cond) != "II" && strtoupper($sdd_propietario_cond) != "QP" && strtoupper($sdd_propietario_cond) != "NP" && strtoupper($sdd_propietario_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['sdd_propietario'] = $Conteudo;
      $Conteudo = $sdd_monto;
      if (strtoupper($sdd_monto_cond) != "II" && strtoupper($sdd_monto_cond) != "QP" && strtoupper($sdd_monto_cond) != "NP" && strtoupper($sdd_monto_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['sdd_monto'] = $Conteudo;

      //----- $sdd_id
      $this->Date_part = false;
      if (isset($sdd_id) || $sdd_id_cond == "nu" || $sdd_id_cond == "nn" || $sdd_id_cond == "ep" || $sdd_id_cond == "ne")
      {
         $this->monta_condicao("sdd_id", $sdd_id_cond, $sdd_id, "", "sdd_id", "INT4", false);
      }

      //----- $sdd_fecha
      $this->Date_part = false;
      if (isset($sdd_fecha) || $sdd_fecha_cond == "nu" || $sdd_fecha_cond == "nn" || $sdd_fecha_cond == "ep" || $sdd_fecha_cond == "ne")
      {
         $this->monta_condicao("sdd_fecha", $sdd_fecha_cond, $sdd_fecha, "", "sdd_fecha", "DATE", false);
      }

      //----- $sdd_propietario
      $this->Date_part = false;
      if (isset($sdd_propietario) || $sdd_propietario_cond == "nu" || $sdd_propietario_cond == "nn" || $sdd_propietario_cond == "ep" || $sdd_propietario_cond == "ne")
      {
         $this->monta_condicao("sdd_propietario", $sdd_propietario_cond, $sdd_propietario, "", "sdd_propietario", "INT4", false);
      }

      //----- $sdd_monto
      $this->Date_part = false;
      if (isset($sdd_monto) || $sdd_monto_cond == "nu" || $sdd_monto_cond == "nn" || $sdd_monto_cond == "ep" || $sdd_monto_cond == "ne")
      {
         $this->monta_condicao("sdd_monto", $sdd_monto_cond, $sdd_monto, "", "sdd_monto", "NUMERIC", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
    $this->Sel_case_sensitive($this->comando);
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_division_deuda']['cond_pesq'] .= $this->NM_operador;
