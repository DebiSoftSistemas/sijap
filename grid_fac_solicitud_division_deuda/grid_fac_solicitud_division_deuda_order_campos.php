...
<?php
   ...
   $Ord_Cmp = new grid_fac_solicitud_division_deuda_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_fac_solicitud_division_deuda_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_division_deuda']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_division_deuda']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['sdd_id'] = "sdd_id";
   $tab_labels["sdd_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_division_deuda']['labels']["sdd_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_division_deuda']['labels']["sdd_id"] : "" . $this->Nm_lang['lang_id'] . "";
   $tab_ger_campos['sdd_fecha'] = "on";
   $tab_def_campos['sdd_fecha'] = "sdd_fecha";
   $tab_labels["sdd_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_division_deuda']['labels']["sdd_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_division_deuda']['labels']["sdd_fecha"] : "" . $this->Nm_lang['lang_fecha'] . "";
   $tab_ger_campos['sdd_propietario'] = "on";
   $tab_def_campos['sdd_propietario'] = "sdd_propietario";
   $tab_labels["sdd_propietario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_division_deuda']['labels']["sdd_propietario"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_division_deuda']['labels']["sdd_propietario"] : "" . $this->Nm_lang['lang_propietario'] . "";
   $tab_ger_campos['sdd_monto'] = "on";
   $tab_def_campos['sdd_monto'] = "sdd_monto";
   $tab_labels["sdd_monto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_division_deuda']['labels']["sdd_monto"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_division_deuda']['labels']["sdd_monto"] : "" . $this->Nm_lang['lang_monto_inicial'] . "";
   $tab_ger_campos['sdd_plazo'] = "on";
   $tab_def_campos['sdd_plazo'] = "sdd_plazo";
   $tab_labels["sdd_plazo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_division_deuda']['labels']["sdd_plazo"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_division_deuda']['labels']["sdd_plazo"] : "" . $this->Nm_lang['lang_plazo'] . "";
   $tab_ger_campos['sdd_estado'] = "on";
   $tab_def_campos['sdd_estado'] = "sdd_estado";
   $tab_labels["sdd_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_division_deuda']['labels']["sdd_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_division_deuda']['labels']["sdd_estado"] : "" . $this->Nm_lang['lang_estado'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_division_deuda']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_division_deuda']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_division_deuda']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_division_deuda']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_division_deuda']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_division_deuda']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_division_deuda']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_division_deuda']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_division_deuda']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_division_deuda']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_division_deuda']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_division_deuda']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_fac_solicitud_division_deuda_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_division_deuda']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_division_deuda']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_division_deuda']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_division_deuda']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_division_deuda']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
