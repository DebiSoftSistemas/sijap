...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_del_cuentas_por_pagar"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_del_cuentas_por_pagar"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_del_cuentas_por_pagar']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_del_cuentas_por_pagar']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_del_cuentas_por_pagar']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_del_cuentas_por_pagar']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_del_cuentas_por_pagar']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_del_cuentas_por_pagar</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_del_cuentas_por_pagar']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_del_cuentas_por_pagar']['embutida_filho'] as $ind => $sc_init)
          {
