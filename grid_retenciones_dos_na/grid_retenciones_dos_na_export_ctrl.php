<?php
@session_start() ;
$_SESSION['scriptcase']['grid_retenciones_dos_na']['sc_process_barr'] = true;
require_once('../grid_retenciones_dos_na/index.php');
unset($_SESSION['scriptcase']['grid_retenciones_dos_na']['sc_process_barr']);
$ExportCtrl = new grid_retenciones_dos_na_export_control;
$ExportCtrl->Export_barr();

class grid_retenciones_dos_na_export_control
{
