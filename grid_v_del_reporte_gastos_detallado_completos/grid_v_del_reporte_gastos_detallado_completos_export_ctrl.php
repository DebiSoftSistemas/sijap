<?php
@session_start() ;
$_SESSION['scriptcase']['grid_v_del_reporte_gastos_detallado_completos']['sc_process_barr'] = true;
require_once('../grid_v_del_reporte_gastos_detallado_completos/index.php');
unset($_SESSION['scriptcase']['grid_v_del_reporte_gastos_detallado_completos']['sc_process_barr']);
$ExportCtrl = new grid_v_del_reporte_gastos_detallado_completos_export_control;
$ExportCtrl->Export_barr();

class grid_v_del_reporte_gastos_detallado_completos_export_control
{
