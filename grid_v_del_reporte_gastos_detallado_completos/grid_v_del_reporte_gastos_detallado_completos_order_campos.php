...
<?php
   ...
   $Ord_Cmp = new grid_v_del_reporte_gastos_detallado_completos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_v_del_reporte_gastos_detallado_completos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['fc_fecha'] = "fc_fecha";
   $tab_labels["fc_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['labels']["fc_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['labels']["fc_fecha"] : "" . $this->Nm_lang['lang_fecha'] . "";
   $tab_ger_campos['pr_nombre'] = "on";
   $tab_def_campos['pr_nombre'] = "pr_nombre";
   $tab_labels["pr_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['labels']["pr_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['labels']["pr_nombre"] : "" . $this->Nm_lang['lang_proveedor'] . "";
   $tab_ger_campos['pr_identificacion'] = "on";
   $tab_def_campos['pr_identificacion'] = "pr_identificacion";
   $tab_labels["pr_identificacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['labels']["pr_identificacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['labels']["pr_identificacion"] : "" . $this->Nm_lang['lang_lot_identificacion'] . "";
   $tab_ger_campos['fc_documento'] = "on";
   $tab_def_campos['fc_documento'] = "fc_documento";
   $tab_labels["fc_documento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['labels']["fc_documento"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['labels']["fc_documento"] : "" . $this->Nm_lang['lang_lot_documento'] . "";
   $tab_ger_campos['pro_descripcion'] = "on";
   $tab_def_campos['pro_descripcion'] = "pro_descripcion";
   $tab_labels["pro_descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['labels']["pro_descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['labels']["pro_descripcion"] : "" . $this->Nm_lang['lang_producto'] . "";
   $tab_ger_campos['dfc_cantidad'] = "on";
   $tab_def_campos['dfc_cantidad'] = "dfc_cantidad";
   $tab_labels["dfc_cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['labels']["dfc_cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['labels']["dfc_cantidad"] : "" . $this->Nm_lang['lang_cantidad'] . "";
   $tab_ger_campos['dfc_precio_unitario'] = "on";
   $tab_def_campos['dfc_precio_unitario'] = "dfc_precio_unitario";
   $tab_labels["dfc_precio_unitario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['labels']["dfc_precio_unitario"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['labels']["dfc_precio_unitario"] : "" . $this->Nm_lang['lang_precio_unitario'] . "";
   $tab_ger_campos['dfc_subtotal'] = "on";
   $tab_def_campos['dfc_subtotal'] = "dfc_subtotal";
   $tab_labels["dfc_subtotal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['labels']["dfc_subtotal"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['labels']["dfc_subtotal"] : "" . $this->Nm_lang['lang_subtotal'] . "";
   $tab_ger_campos['dfc_descuento'] = "on";
   $tab_def_campos['dfc_descuento'] = "dfc_descuento";
   $tab_labels["dfc_descuento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['labels']["dfc_descuento"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['labels']["dfc_descuento"] : "" . $this->Nm_lang['lang_descuento'] . "";
   $tab_ger_campos['dfc_valor_iva'] = "on";
   $tab_def_campos['dfc_valor_iva'] = "dfc_valor_iva";
   $tab_labels["dfc_valor_iva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['labels']["dfc_valor_iva"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['labels']["dfc_valor_iva"] : "" . $this->Nm_lang['lang_iva'] . "";
   $tab_ger_campos['dfc_total'] = "on";
   $tab_def_campos['dfc_total'] = "dfc_total";
   $tab_labels["dfc_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['labels']["dfc_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['labels']["dfc_total"] : "" . $this->Nm_lang['lang_total'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_v_del_reporte_gastos_detallado_completos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_v_del_reporte_gastos_detallado_completos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
