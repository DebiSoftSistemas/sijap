...
class grid_v_del_reporte_gastos_detallado_completos_resumo
{
   ...
   var $array_total_dfc_porcentaje_iva;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_dfc_porcentaje_iva  = array();
...
SCEOT;
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
      ...
      $this->array_total_geral[4] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['tot_geral'][5];
      $this->array_total_geral[5] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['tot_geral'][8];
      $this->array_total_geral[6] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['tot_geral'][6];
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['arr_total']['pr_identificacion'] = $this->array_total_pr_identificacion;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['arr_total']['pr_nombre'] = $this->array_total_pr_nombre;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['arr_total']['pro_descripcion'] = $this->array_total_pro_descripcion;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['arr_total']['dfc_porcentaje_iva'] = $this->array_total_dfc_porcentaje_iva;
   ...
   function completeMatrix()
   {
       ...
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['json_use_label'])
       {
          ...
          $Lab_dfc_porcentaje_iva = "dfc_porcentaje_iva";
       }
       else
       {
       ...
       $Lab_dfc_porcentaje_iva = "" . $this->Ini->Nm_lang['lang_porcentaje_iva'] . "";
       }
       $prep_field = array();
       $prep_field['fc_sustento_gasto'] = $Lab_fc_sustento_gasto;
       ...
       $prep_field['fc_tipo_comprobante'] = $Lab_fc_tipo_comprobante;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['pr_identificacion'] = $Lab_pr_identificacion; 
       $prep_field['pr_nombre'] = $Lab_pr_nombre;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['pr_nombre'] = $Lab_pr_nombre; 
       $prep_field['pro_descripcion'] = $Lab_pro_descripcion;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['pro_descripcion'] = $Lab_pro_descripcion; 
       $prep_field['dfc_porcentaje_iva'] = $Lab_dfc_porcentaje_iva;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['dfc_porcentaje_iva'] = $Lab_dfc_porcentaje_iva; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
       ...
       $this->comp_sum_lnk = array(
           ...
           6 => array('field' => "dfc_valor_iva", 'show' => true),
           7 => array('field' => "dfc_valor_irbpnr", 'show' => true),
           8 => array('field' => "dfc_total", 'show' => true),
       );
       ...
       $this->comp_sum_css = array(
           ...
           6 => "css_dfc_valor_iva_sum",
           7 => "css_dfc_valor_irbpnr_sum",
           8 => "css_dfc_total_sum",
       );
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['fc_sustento_gasto']['alin'] = "''";
       $Arr_parms['fc_sustento_gasto']['link'] = "S";
       $Arr_parms['fc_tipo_comprobante']['alin'] = "''";
       $Arr_parms['fc_tipo_comprobante']['link'] = "S";
       ...
       $Arr_parms['dfc_porcentaje_iva']['alin'] = "''";
       $Arr_parms['dfc_porcentaje_iva']['link'] = "S";
       $Arr_parms['fc_sustento_gasto']['fill'] = "true";
       $Arr_parms['fc_sustento_gasto']['order'] = "label";
       $Arr_parms['fc_sustento_gasto']['order_start'] = 'asc';
       $Arr_parms['fc_sustento_gasto']['order_invert'] = 'false';
       $Arr_parms['fc_sustento_gasto']['order_enabled'] = 'true';
       $Arr_parms['fc_sustento_gasto']['order_datatype'] = 'varchar';
       $Arr_parms['fc_sustento_gasto']['rating_function'] = '';
       $Arr_parms['fc_tipo_comprobante']['fill'] = "true";
       $Arr_parms['fc_tipo_comprobante']['order'] = "label";
       $Arr_parms['fc_tipo_comprobante']['order_start'] = 'asc';
       $Arr_parms['fc_tipo_comprobante']['order_invert'] = 'false';
       $Arr_parms['fc_tipo_comprobante']['order_enabled'] = 'true';
       $Arr_parms['fc_tipo_comprobante']['order_datatype'] = 'varchar';
       $Arr_parms['fc_tipo_comprobante']['rating_function'] = '';
       ...
       $Arr_parms['dfc_porcentaje_iva']['fill'] = "true";
       $Arr_parms['dfc_porcentaje_iva']['order'] = "label";
       $Arr_parms['dfc_porcentaje_iva']['order_start'] = 'asc';
       $Arr_parms['dfc_porcentaje_iva']['order_invert'] = 'false';
       $Arr_parms['dfc_porcentaje_iva']['order_enabled'] = 'true';
       $Arr_parms['dfc_porcentaje_iva']['order_datatype'] = 'int4';
       $Arr_parms['dfc_porcentaje_iva']['rating_function'] = '';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['fc_sustento_gasto'] = array(0 => 'fc_sustento_gasto', 1 => '@aspass@');
       $prep_links_fl['fc_tipo_comprobante'] = array(0 => 'fc_tipo_comprobante', 1 => '@aspass@');
       ...
       $prep_links_fl['dfc_porcentaje_iva'] = array(0 => 'dfc_porcentaje_iva', 1 => '');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['proc_pdf_vert']){ 
   ...
   public static function formatValue($total, $valor_campo)
   {
       ...
       if ($total == 1)
       {
           nmgp_Form_Num_Val($valor_campo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "65535", "S", "", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']);
       }
       if ($total == 2)
       {
       ...
       if ($total == 3)
       {
           nmgp_Form_Num_Val($valor_campo, "", ".", "6", "S", "1", "", "N:1", "-");
       }
       if ($total == 4)
       {
           nmgp_Form_Num_Val($valor_campo, "", ".", "2", "S", "1", "", "N:1", "-");
...
{ 
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['SC_Gb_Free_cmp']))
      {
   ...
   //---- 
   function adiciona_registro($sum_dfc_cantidad, $sum_dfc_subtotal, $sum_dfc_descuento, $sum_dfc_valor_iva, $sum_dfc_total, $sum_dfc_valor_ice, $sum_dfc_valor_irbpnr, $quebra_fc_sustento_gasto, $quebra_fc_tipo_comprobante, $quebra_pr_identificacion, $quebra_pr_nombre, $quebra_pro_descripcion, $quebra_dfc_porcentaje_iva, $quebra_fc_sustento_gasto_orig, $quebra_fc_tipo_comprobante_orig, $quebra_pr_identificacion_orig, $quebra_pr_nombre_orig, $quebra_pro_descripcion_orig, $quebra_dfc_porcentaje_iva_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
          ...
          $cmp_look   = "Cmp_formt";
          $cmp_orig   = "Cmp_arg";
          if (empty($sum_dfc_cantidad)) {$sum_dfc_cantidad = '0';}
          if (empty($sum_dfc_subtotal)) {$sum_dfc_subtotal = '0';}
          if (empty($sum_dfc_descuento)) {$sum_dfc_descuento = '0';}
          if (empty($sum_dfc_valor_iva)) {$sum_dfc_valor_iva = '0';}
          if (empty($sum_dfc_total)) {$sum_dfc_total = '0';}
          if (empty($sum_dfc_valor_ice)) {$sum_dfc_valor_ice = '0';}
          if (empty($sum_dfc_valor_irbpnr)) {$sum_dfc_valor_irbpnr = '0';}
          eval ('
          if (!isset($this->' . $arr_name . '))
          {
              $this->' . $arr_name . '[0] = 1;
              $this->' . $arr_name . '[1] = ' . $sum_dfc_cantidad . ';
              $this->' . $arr_name . '[2] = ' . $sum_dfc_subtotal . ';
              $this->' . $arr_name . '[3] = ' . $sum_dfc_descuento . ';
              $this->' . $arr_name . '[4] = ' . $sum_dfc_valor_iva . ';
              $this->' . $arr_name . '[5] = ' . $sum_dfc_total . ';
              $this->' . $arr_name . '[6] = ' . $sum_dfc_valor_ice . ';
              $this->' . $arr_name . '[7] = ' . $sum_dfc_valor_irbpnr . ';
          ...
          {
              $this->' . $arr_name . '[0]++;
              $this->' . $arr_name . '[1] = bcadd($this->' . $arr_name . '[1], ' . $sum_dfc_cantidad . ', 10);
              $this->' . $arr_name . '[2] = bcadd($this->' . $arr_name . '[2], ' . $sum_dfc_subtotal . ', 10);
              $this->' . $arr_name . '[3] = bcadd($this->' . $arr_name . '[3], ' . $sum_dfc_descuento . ', 10);
              $this->' . $arr_name . '[4] = bcadd($this->' . $arr_name . '[4], ' . $sum_dfc_valor_iva . ', 10);
              $this->' . $arr_name . '[5] = bcadd($this->' . $arr_name . '[5], ' . $sum_dfc_total . ', 10);
              $this->' . $arr_name . '[6] = bcadd($this->' . $arr_name . '[6], ' . $sum_dfc_valor_ice . ', 10);
              $this->' . $arr_name . '[7] = bcadd($this->' . $arr_name . '[7], ' . $sum_dfc_valor_irbpnr . ', 10);
          }
          ');
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['SC_Gb_Free_sql'] as $cmp_var => $resto)
     {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->dfc_porcentaje_iva_orig = $this->dfc_porcentaje_iva;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->dfc_cantidad, $this->dfc_subtotal, $this->dfc_descuento, $this->dfc_valor_iva, $this->dfc_total, $this->dfc_valor_ice, $this->dfc_valor_irbpnr, $this->fc_sustento_gasto, $this->fc_tipo_comprobante, $this->pr_identificacion, $this->pr_nombre, $this->pro_descripcion, $this->dfc_porcentaje_iva, $this->fc_sustento_gasto_orig,  $this->fc_tipo_comprobante_orig,  $this->pr_identificacion_orig,  $this->pr_nombre_orig,  $this->pro_descripcion_orig,  $this->dfc_porcentaje_iva_orig);
            }
   }
//
