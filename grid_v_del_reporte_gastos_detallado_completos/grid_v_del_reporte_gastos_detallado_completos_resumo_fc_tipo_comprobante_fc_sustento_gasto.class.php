...
class grid_v_del_reporte_gastos_detallado_completos_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $array_total_fc_sustento_gasto;
   var $array_total_fc_tipo_comprobante;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_fc_sustento_gasto   = array();
      $this->array_total_fc_tipo_comprobante = array();
   ...
   function initializeButtons()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_v_del_reporte_gastos_detallado_completos'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_v_del_reporte_gastos_detallado_completos'];
   ...
   if ($this->Ini->Embutida_iframe) {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['sub_cons_iframe_btns'] as $BTN => $BTN_opc) {
           $this->nmgp_botoes[$BTN] = $BTN_opc;
       }
   }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_v_del_reporte_gastos_detallado_completos']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_v_del_reporte_gastos_detallado_completos']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_v_del_reporte_gastos_detallado_completos']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
...
SCEOT;
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_v_del_reporte_gastos_detallado_completos']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_v_del_reporte_gastos_detallado_completos']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['orig_pesq'] = "resumo";
     ...
     { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pesq_tab_label']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pesq_tab_label'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pesq_tab_label'] .= "fc_fecha?#?" . "" . $this->Ini->Nm_lang['lang_fecha'] . "" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pesq_tab_label'] .= "fc_tipo_comprobante?#?" . "" . $this->Ini->Nm_lang['lang_tipo_comprobante'] . "" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pesq_tab_label'] .= "pr_identificacion?#?" . "" . $this->Ini->Nm_lang['lang_lot_identificacion'] . "" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pesq_tab_label'] .= "pro_codigo?#?" . "" . $this->Ini->Nm_lang['lang_codigo'] . "" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pesq_tab_label'] .= "pro_descripcion?#?" . "" . $this->Ini->Nm_lang['lang_producto'] . "" . "?@?";
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['grid_search_add']))
      {
          $this->monta_css();
          $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pesq_tab_label'];
          ...
          $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['grid_search_add']['seq'];
          $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['grid_search_add']['cmp'];
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['grid_search_add']);
          exit;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['dyn_search_aut_comp']))
      {
          $Cmp_select2 = array("pr_identificacion","pro_codigo","pro_descripcion");
          ob_start();
          $NM_func_aut_comp = "lookup_ajax_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['dyn_search_aut_comp']['cmp'];
          ...
          foreach ($nmgp_def_dados as $Ind => $Lista)
          {
             if (is_array($Lista))
             {
                 foreach ($Lista as $Cod => $Valor)
                 {
                     ...
                     if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['dyn_search_aut_comp']['cmp'], $Cmp_select2))
                     {
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['dyn_search_aut_comp']);
          exit;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['opcao'] != "pdf")
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['res_hrz'];
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']) && !$this->NM_export)
      {
          foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
          {
              if (in_array("grid_v_del_reporte_gastos_detallado_completos", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['where_resumo'] = "";
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['contr_total_geral'] == "OK")
      {
          $this->array_total_fc_sustento_gasto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['arr_total']['fc_sustento_gasto'];
          $this->array_total_fc_tipo_comprobante = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['arr_total']['fc_tipo_comprobante'];
      }
      else
      {
          $this->array_total_fc_sustento_gasto = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['tot_geral'][2];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['tot_geral'][3];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['tot_geral'][4];
      $this->array_total_geral[3] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['tot_geral'][7];
      $this->array_total_geral[4] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['tot_geral'][8];
      $this->array_total_geral[5] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['tot_geral'][5];
      $this->array_total_geral[6] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['tot_geral'][9];
      $this->array_total_geral[7] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['tot_geral'][6];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['arr_total']['fc_sustento_gasto'] = $this->array_total_fc_sustento_gasto;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['arr_total']['fc_tipo_comprobante'] = $this->array_total_fc_tipo_comprobante;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['json_use_label'])
       {
          $Lab_fc_sustento_gasto = "fc_sustento_gasto";
          $Lab_fc_tipo_comprobante = "fc_tipo_comprobante";
       }
       else
       {
       $Lab_fc_sustento_gasto = "" . $this->Ini->Nm_lang['lang_sustento_tributario'] . "";
       $Lab_fc_tipo_comprobante = "" . $this->Ini->Nm_lang['lang_tipo_comprobante'] . "";
       }
       $this->comp_field = array(
           $Lab_fc_sustento_gasto,
           $Lab_fc_tipo_comprobante,
       );
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['fc_sustento_gasto'] = $Lab_fc_sustento_gasto; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['fc_tipo_comprobante'] = $Lab_fc_tipo_comprobante; 

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['fc_fecha']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['fc_fecha'] = "" . $this->Ini->Nm_lang['lang_fecha'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['pr_nombre']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['pr_nombre'] = "" . $this->Ini->Nm_lang['lang_proveedor'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['pr_identificacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['pr_identificacion'] = "" . $this->Ini->Nm_lang['lang_lot_identificacion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['fc_documento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['fc_documento'] = "" . $this->Ini->Nm_lang['lang_lot_documento'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['pro_descripcion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['pro_descripcion'] = "" . $this->Ini->Nm_lang['lang_producto'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['dfc_cantidad']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['dfc_cantidad'] = "" . $this->Ini->Nm_lang['lang_cantidad'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['dfc_precio_unitario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['dfc_precio_unitario'] = "" . $this->Ini->Nm_lang['lang_precio_unitario'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['dfc_subtotal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['dfc_subtotal'] = "" . $this->Ini->Nm_lang['lang_subtotal'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['dfc_descuento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['dfc_descuento'] = "" . $this->Ini->Nm_lang['lang_descuento'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['dfc_valor_iva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['dfc_valor_iva'] = "" . $this->Ini->Nm_lang['lang_iva'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['dfc_total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['dfc_total'] = "" . $this->Ini->Nm_lang['lang_total'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['fc_tipo_comprobante']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['fc_tipo_comprobante'] = "" . $this->Ini->Nm_lang['lang_tipo_comprobante'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['fc_sustento_gasto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['fc_sustento_gasto'] = "" . $this->Ini->Nm_lang['lang_sustento_tributario'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['pr_direccion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['pr_direccion'] = "" . $this->Ini->Nm_lang['lang_direccion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['pr_telefono']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['pr_telefono'] = "" . $this->Ini->Nm_lang['lang_lot_telefono'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['pr_celular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['pr_celular'] = "" . $this->Ini->Nm_lang['lang_celular'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['pr_email']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['pr_email'] = "" . $this->Ini->Nm_lang['lang_email'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['documento_modificado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['documento_modificado'] = "Documento Modificado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['pro_codigo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['pro_codigo'] = "" . $this->Ini->Nm_lang['lang_codigo'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['dfc_porcentaje_ice']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['dfc_porcentaje_ice'] = "" . $this->Ini->Nm_lang['lang_porcentaje_ice'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['dfc_valor_ice']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['dfc_valor_ice'] = "" . $this->Ini->Nm_lang['lang_ice'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['dfc_base_iva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['dfc_base_iva'] = "" . $this->Ini->Nm_lang['lang_base_iva'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['dfc_porcentaje_iva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['dfc_porcentaje_iva'] = "" . $this->Ini->Nm_lang['lang_porcentaje_iva'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['dfc_porcentaje_irbpnr']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['dfc_porcentaje_irbpnr'] = "" . $this->Ini->Nm_lang['lang_porcentaje_irbpnr'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['dfc_valor_irbpnr']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['dfc_valor_irbpnr'] = "" . $this->Ini->Nm_lang['lang_irbpnr'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['fc_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['fc_id'] = "" . $this->Ini->Nm_lang['lang_id'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['fc_empresa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['fc_empresa'] = "" . $this->Ini->Nm_lang['lang_empresa'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['fc_usuario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['labels']['fc_usuario'] = "" . $this->Ini->Nm_lang['lang_usuario'] . ""; 
       }
       //-----
       $this->comp_field_nm = array(
           'fc_sustento_gasto' => 0,
           'fc_tipo_comprobante' => 1,
       );
       ...
       //-----
       $this->comp_sum = array(
           2 => "Dfc Cantidad (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           3 => "" .  $this->Ini->Nm_lang['lang_subtotal'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           4 => "" .  $this->Ini->Nm_lang['lang_descuento'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           5 => "" .  $this->Ini->Nm_lang['lang_ice'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           6 => "" .  $this->Ini->Nm_lang['lang_base_iva'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           7 => "" .  $this->Ini->Nm_lang['lang_iva'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           8 => "" .  $this->Ini->Nm_lang['lang_irbpnr'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           9 => "" .  $this->Ini->Nm_lang['lang_total'] . " (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['summarizing_fields_order']['fc_tipo_comprobante_fc_sustento_gasto']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['summarizing_fields_order']['fc_tipo_comprobante_fc_sustento_gasto'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['summarizing_fields_order']['fc_tipo_comprobante_fc_sustento_gasto'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['summarizing_fields_display']['fc_tipo_comprobante_fc_sustento_gasto'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['summarizing_fields_display']['fc_tipo_comprobante_fc_sustento_gasto'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['summarizing_fields_display']['fc_tipo_comprobante_fc_sustento_gasto'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['summarizing_fields_display']['fc_tipo_comprobante_fc_sustento_gasto'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['summarizing_fields_display']['fc_tipo_comprobante_fc_sustento_gasto'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['summarizing_fields_display']['fc_tipo_comprobante_fc_sustento_gasto'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['summarizing_fields_display']['fc_tipo_comprobante_fc_sustento_gasto'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "dfc_cantidad", 'show' => true),
           3 => array('field' => "dfc_subtotal", 'show' => true),
           4 => array('field' => "dfc_descuento", 'show' => true),
           5 => array('field' => "dfc_valor_ice", 'show' => true),
           6 => array('field' => "dfc_base_iva", 'show' => true),
           7 => array('field' => "dfc_valor_iva", 'show' => true),
           8 => array('field' => "dfc_valor_irbpnr", 'show' => true),
           9 => array('field' => "dfc_total", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "css_dfc_cantidad_sum",
           3 => "css_dfc_subtotal_sum",
           4 => "css_dfc_descuento_sum",
           5 => "css_dfc_valor_ice_sum",
           6 => "css_dfc_base_iva_sum",
           7 => "css_dfc_valor_iva_sum",
           8 => "css_dfc_valor_irbpnr_sum",
           9 => "css_dfc_total_sum",
       );
       ...
       $this->comp_sum_nm = array(
           ...
           6 => "dfc_base_iva_sum",
           7 => "dfc_valor_iva_sum",
           8 => "dfc_valor_irbpnr_sum",
           9 => "dfc_total_sum",
       );

       //-----
       foreach ($this->array_total_fc_sustento_gasto as $i_fc_sustento_gasto => $d_fc_sustento_gasto) {
           if (!isset($i_fc_sustento_gasto, $this->comp_label[0]) || !in_array($i_fc_sustento_gasto, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_fc_sustento_gasto[10] ] = $d_fc_sustento_gasto[9];
               $this->comp_label[0][ $d_fc_sustento_gasto[10] ] = $d_fc_sustento_gasto[9];
           }
           foreach ($this->array_total_fc_tipo_comprobante[$i_fc_sustento_gasto] as $i_fc_tipo_comprobante => $d_fc_tipo_comprobante) {
               if (!isset($i_fc_tipo_comprobante, $this->comp_label[1][ $d_fc_sustento_gasto[10] ]) || !in_array($i_fc_tipo_comprobante, $this->comp_label[1][ $d_fc_sustento_gasto[10] ], true)) {
                   $this->comp_index[1][ $d_fc_tipo_comprobante[10] ] = $d_fc_tipo_comprobante[9];
                   $this->comp_label[1][ $d_fc_sustento_gasto[10] ][ $d_fc_tipo_comprobante[10] ] = $d_fc_tipo_comprobante[9];
               }
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'fc_sustento_gasto', 'prot' => '@aspass@'),
           array('name' => 'fc_tipo_comprobante', 'prot' => '@aspass@'),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_tabular_label'];
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_fc_sustento_gasto => $l_fc_sustento_gasto) {
           if (isset($this->array_total_fc_sustento_gasto[$i_fc_sustento_gasto])) {
               $this->comp_group[$i_fc_sustento_gasto] = array();
           }
           foreach ($this->comp_label[1][$i_fc_sustento_gasto] as $i_fc_tipo_comprobante => $l_fc_tipo_comprobante) {
               if (isset($this->array_total_fc_tipo_comprobante[$i_fc_sustento_gasto][$i_fc_tipo_comprobante])) {
                   $this->comp_group[$i_fc_sustento_gasto][$i_fc_tipo_comprobante] = array();
               }
           }
       }
     }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_fc_sustento_gasto;
       }
       elseif (1 == $level) {
           $return = $this->array_total_fc_tipo_comprobante;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_v_del_reporte_gastos_detallado_completos@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function makeTabular(&$a_data)
   {
       ...
       {
           $a_labels = array();
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['proc_pdf_vert'])
   {
     $this->comp_tab_hover = true;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialOrderFA = '';
                       ...
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['proc_pdf_vert']){ 
   ...
   public static function formatValue($total, $valor_campo)
   {
       ...
       if ($total == 1)
       {
           nmgp_Form_Num_Val($valor_campo, "", ".", "6", "S", "12", "", "N:12", "-");
       }
       if ($total == 2)
       {
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
         ...
         { 
            ...
            { 
                $seq_search = 1;
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['grid_pesq'] as $cmp => $def)
                {
                   $Seq_grid      = $seq_search;
                   $Cmp_grid      = $cmp;
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_v_del_reporte_gastos_detallado_completos']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_v_del_reporte_gastos_detallado_completos']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_v_del_reporte_gastos_detallado_completos']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_v_del_reporte_gastos_detallado_completos']) . "_";
               } 
           }
       }
   ...
   function inicializa_vars()
   {
      ...
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['print_all'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['doc_word'] || $this->Ini->sc_export_ajax_img)
      { 
      ...
      $this->Total   = new grid_v_del_reporte_gastos_detallado_completos_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_fc_tipo_comprobante_fc_sustento_gasto("res", $this->NM_export);
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['arr_total'][$cmp_gb];
      }
      if (is_array($this->array_total_fc_sustento_gasto)) {
          ksort($this->array_total_fc_sustento_gasto);
      }
      if (is_array($this->array_total_fc_tipo_comprobante)) {
          ksort($this->array_total_fc_tipo_comprobante);
      }
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['SC_Ind_Groupby'];
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['dashboard_refresh_after_chart'] = 'resumo';
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>Reporte Detallado de Compras</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['doc_word'])
{
      ...
      { 
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['ajax_nav']) {  
        ...
        <link rel='stylesheet' href='../_lib/lib/css/nm_mobile.css' type='text/css'/>
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_v_del_reporte_gastos_detallado_completos_ajax.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_v_del_reporte_gastos_detallado_completos_jquery_4100.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_v_del_reporte_gastos_detallado_completos_message.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput2.js\"></script>\r\n");
...
$nm_saida->saida("    </style>\r\n");
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_del_reporte_gastos_detallado_completos_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_v_del_reporte_gastos_detallado_completos_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_del_reporte_gastos_detallado_completos_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_v_del_reporte_gastos_detallado_completos/grid_v_del_reporte_gastos_detallado_completos_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['dashboard_info']['remove_margin'] ? 'margin: 0;' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['dashboard_info']['remove_border'] ? 'border-width: 0;' : '';
          $vertical_center = '';
          $nm_saida->saida(" <BODY id=\"grid_summary\" class=\"" . $this->css_scGridPage . " sc-app-grid\" style=\"" . $remove_margin . $vertical_center . "\">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_v_del_reporte_gastos_detallado_completos/grid_v_del_reporte_gastos_detallado_completos_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_v_del_reporte_gastos_detallado_completos&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid,resume&nm_all_modules=grid,resume&password=n&summary_export_columns=S&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "grid_v_del_reporte_gastos_detallado_completos/grid_v_del_reporte_gastos_detallado_completos_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume&nm_all_modules=grid,resume&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + P)", "thickbox", "" . $this->Ini->path_link . "grid_v_del_reporte_gastos_detallado_completos/grid_v_del_reporte_gastos_detallado_completos_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid,resume&nm_all_modules=grid,resume&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
             $this->nm_btn_exist['groupby'][] = "sel_groupby_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_v_del_reporte_gastos_detallado_completos/grid_v_del_reporte_gastos_detallado_completos_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_v_del_reporte_gastos_detallado_completos/grid_v_del_reporte_gastos_detallado_completos_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + G)", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_v_del_reporte_gastos_detallado_completos_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("grid_v_del_reporte_gastos_detallado_completos_help.txt"); 
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_v_del_reporte_gastos_detallado_completos']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_v_del_reporte_gastos_detallado_completos']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_v_del_reporte_gastos_detallado_completos_config_pivot.php?nome_apl=grid_v_del_reporte_gastos_detallado_completos&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("                  action=\"grid_v_del_reporte_gastos_detallado_completos_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_v_del_reporte_gastos_detallado_completos/grid_v_del_reporte_gastos_detallado_completos_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
      $nm_saida->saida("       }\r\n");
      $nm_saida->saida("       else\r\n");
      $nm_saida->saida("       {\r\n");
      ...
      $nm_saida->saida("               document.Fdoc_word.action = \"grid_v_del_reporte_gastos_detallado_completos_export_ctrl.php\";\r\n");
      ...
      $nm_saida->saida("               document.Fprint.action = \"grid_v_del_reporte_gastos_detallado_completos_export_ctrl.php\";\r\n");
      $nm_saida->saida("           }\r\n");
      $nm_saida->saida("           else\r\n");
      $nm_saida->saida("           {\r\n");
      ...
      $nm_saida->saida("               document.Fexport.action = \"grid_v_del_reporte_gastos_detallado_completos_export_ctrl.php\";\r\n");
      ...
      $nm_saida->saida("       document.F3.SC_module_export.value = z;\r\n");
      $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['grid_v_del_reporte_gastos_detallado_completos_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_v_del_reporte_gastos_detallado_completos@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"grid_v_del_reporte_gastos_detallado_completos_iframe.php\";\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_del_reporte_gastos_detallado_completos_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_v_del_reporte_gastos_detallado_completos/grid_v_del_reporte_gastos_detallado_completos_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $fc_fecha_2 = (isset($Busca_temp['fc_fecha_input_2'])) ? $Busca_temp['fc_fecha_input_2'] : ""; 
          $fc_tipo_comprobante = (isset($Busca_temp['fc_tipo_comprobante'])) ? $Busca_temp['fc_tipo_comprobante'] : ""; 
          $tmp_pos = (is_string($fc_tipo_comprobante)) ? strpos($fc_tipo_comprobante, "##@@") : false;
          if ($tmp_pos !== false && !is_array($fc_tipo_comprobante))
          {
              $fc_tipo_comprobante = substr($fc_tipo_comprobante, 0, $tmp_pos);
          }
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['cond_pesq'], 0, $trab_pos);
   ...
   $sc_data_cab1 = $this->nm_data->FormataSaida("l, d @?#?@de F @?#?@de Y");
      ...
      $nm_saida->saida("       <TR valign=\"middle\">\r\n");
      $nm_saida->saida("        <TD align=\"left\" class=\"" . $this->css_scGridHeaderFont . "\">\r\n");
      $nm_saida->saida("          Reporte Detallado de Compras\r\n");
      $nm_saida->saida("        </TD>\r\n");
      $nm_saida->saida("        <TD style=\"font-size: 5px\">\r\n");
      $nm_saida->saida("          &nbsp; &nbsp;\r\n");
      $nm_saida->saida("        </TD>\r\n");
   ...
   //---- 
   function adiciona_registro($sum_dfc_cantidad, $sum_dfc_subtotal, $sum_dfc_descuento, $sum_dfc_valor_iva, $sum_dfc_total, $sum_dfc_valor_ice, $sum_dfc_base_iva, $sum_dfc_valor_irbpnr, $quebra_fc_sustento_gasto, $quebra_fc_tipo_comprobante, $quebra_fc_sustento_gasto_orig, $quebra_fc_tipo_comprobante_orig)
   {
      //----- fc_sustento_gasto
      if (!isset($this->array_total_fc_sustento_gasto[$quebra_fc_sustento_gasto_orig]))
      {
         $this->array_total_fc_sustento_gasto[$quebra_fc_sustento_gasto_orig][0] = 1;
         $this->array_total_fc_sustento_gasto[$quebra_fc_sustento_gasto_orig][1] = $sum_dfc_cantidad;
         $this->array_total_fc_sustento_gasto[$quebra_fc_sustento_gasto_orig][2] = $sum_dfc_subtotal;
         $this->array_total_fc_sustento_gasto[$quebra_fc_sustento_gasto_orig][3] = $sum_dfc_descuento;
         $this->array_total_fc_sustento_gasto[$quebra_fc_sustento_gasto_orig][4] = $sum_dfc_valor_iva;
         $this->array_total_fc_sustento_gasto[$quebra_fc_sustento_gasto_orig][5] = $sum_dfc_total;
         $this->array_total_fc_sustento_gasto[$quebra_fc_sustento_gasto_orig][6] = $sum_dfc_valor_ice;
         $this->array_total_fc_sustento_gasto[$quebra_fc_sustento_gasto_orig][7] = $sum_dfc_base_iva;
         $this->array_total_fc_sustento_gasto[$quebra_fc_sustento_gasto_orig][8] = $sum_dfc_valor_irbpnr;
         $this->array_total_fc_sustento_gasto[$quebra_fc_sustento_gasto_orig][9] = $quebra_fc_sustento_gasto;
         $this->array_total_fc_sustento_gasto[$quebra_fc_sustento_gasto_orig][10] = $quebra_fc_sustento_gasto_orig;
      }
      else
      {
         $this->array_total_fc_sustento_gasto[$quebra_fc_sustento_gasto_orig][0]++;
         $this->array_total_fc_sustento_gasto[$quebra_fc_sustento_gasto_orig][1] = bcadd($this->array_total_fc_sustento_gasto[$quebra_fc_sustento_gasto_orig][1], $sum_dfc_cantidad, 10);
         $this->array_total_fc_sustento_gasto[$quebra_fc_sustento_gasto_orig][2] = bcadd($this->array_total_fc_sustento_gasto[$quebra_fc_sustento_gasto_orig][2], $sum_dfc_subtotal, 10);
         $this->array_total_fc_sustento_gasto[$quebra_fc_sustento_gasto_orig][3] = bcadd($this->array_total_fc_sustento_gasto[$quebra_fc_sustento_gasto_orig][3], $sum_dfc_descuento, 10);
         $this->array_total_fc_sustento_gasto[$quebra_fc_sustento_gasto_orig][4] = bcadd($this->array_total_fc_sustento_gasto[$quebra_fc_sustento_gasto_orig][4], $sum_dfc_valor_iva, 10);
         $this->array_total_fc_sustento_gasto[$quebra_fc_sustento_gasto_orig][5] = bcadd($this->array_total_fc_sustento_gasto[$quebra_fc_sustento_gasto_orig][5], $sum_dfc_total, 10);
         $this->array_total_fc_sustento_gasto[$quebra_fc_sustento_gasto_orig][6] = bcadd($this->array_total_fc_sustento_gasto[$quebra_fc_sustento_gasto_orig][6], $sum_dfc_valor_ice, 10);
         $this->array_total_fc_sustento_gasto[$quebra_fc_sustento_gasto_orig][7] = bcadd($this->array_total_fc_sustento_gasto[$quebra_fc_sustento_gasto_orig][7], $sum_dfc_base_iva, 10);
         $this->array_total_fc_sustento_gasto[$quebra_fc_sustento_gasto_orig][8] = bcadd($this->array_total_fc_sustento_gasto[$quebra_fc_sustento_gasto_orig][8], $sum_dfc_valor_irbpnr, 10);
      }
      //----- fc_tipo_comprobante
      if (!isset($this->array_total_fc_tipo_comprobante[$quebra_fc_sustento_gasto_orig][$quebra_fc_tipo_comprobante_orig]))
      {
         $this->array_total_fc_tipo_comprobante[$quebra_fc_sustento_gasto_orig][$quebra_fc_tipo_comprobante_orig][0] = 1;
         $this->array_total_fc_tipo_comprobante[$quebra_fc_sustento_gasto_orig][$quebra_fc_tipo_comprobante_orig][1] = $sum_dfc_cantidad;
         $this->array_total_fc_tipo_comprobante[$quebra_fc_sustento_gasto_orig][$quebra_fc_tipo_comprobante_orig][2] = $sum_dfc_subtotal;
         $this->array_total_fc_tipo_comprobante[$quebra_fc_sustento_gasto_orig][$quebra_fc_tipo_comprobante_orig][3] = $sum_dfc_descuento;
         $this->array_total_fc_tipo_comprobante[$quebra_fc_sustento_gasto_orig][$quebra_fc_tipo_comprobante_orig][4] = $sum_dfc_valor_iva;
         $this->array_total_fc_tipo_comprobante[$quebra_fc_sustento_gasto_orig][$quebra_fc_tipo_comprobante_orig][5] = $sum_dfc_total;
         $this->array_total_fc_tipo_comprobante[$quebra_fc_sustento_gasto_orig][$quebra_fc_tipo_comprobante_orig][6] = $sum_dfc_valor_ice;
         $this->array_total_fc_tipo_comprobante[$quebra_fc_sustento_gasto_orig][$quebra_fc_tipo_comprobante_orig][7] = $sum_dfc_base_iva;
         $this->array_total_fc_tipo_comprobante[$quebra_fc_sustento_gasto_orig][$quebra_fc_tipo_comprobante_orig][8] = $sum_dfc_valor_irbpnr;
         $this->array_total_fc_tipo_comprobante[$quebra_fc_sustento_gasto_orig][$quebra_fc_tipo_comprobante_orig][9] = $quebra_fc_tipo_comprobante;
         $this->array_total_fc_tipo_comprobante[$quebra_fc_sustento_gasto_orig][$quebra_fc_tipo_comprobante_orig][10] = $quebra_fc_tipo_comprobante_orig;
      }
      else
      {
         $this->array_total_fc_tipo_comprobante[$quebra_fc_sustento_gasto_orig][$quebra_fc_tipo_comprobante_orig][0]++;
         $this->array_total_fc_tipo_comprobante[$quebra_fc_sustento_gasto_orig][$quebra_fc_tipo_comprobante_orig][1] = bcadd($this->array_total_fc_tipo_comprobante[$quebra_fc_sustento_gasto_orig][$quebra_fc_tipo_comprobante_orig][1], $sum_dfc_cantidad, 10);
         $this->array_total_fc_tipo_comprobante[$quebra_fc_sustento_gasto_orig][$quebra_fc_tipo_comprobante_orig][2] = bcadd($this->array_total_fc_tipo_comprobante[$quebra_fc_sustento_gasto_orig][$quebra_fc_tipo_comprobante_orig][2], $sum_dfc_subtotal, 10);
         $this->array_total_fc_tipo_comprobante[$quebra_fc_sustento_gasto_orig][$quebra_fc_tipo_comprobante_orig][3] = bcadd($this->array_total_fc_tipo_comprobante[$quebra_fc_sustento_gasto_orig][$quebra_fc_tipo_comprobante_orig][3], $sum_dfc_descuento, 10);
         $this->array_total_fc_tipo_comprobante[$quebra_fc_sustento_gasto_orig][$quebra_fc_tipo_comprobante_orig][4] = bcadd($this->array_total_fc_tipo_comprobante[$quebra_fc_sustento_gasto_orig][$quebra_fc_tipo_comprobante_orig][4], $sum_dfc_valor_iva, 10);
         $this->array_total_fc_tipo_comprobante[$quebra_fc_sustento_gasto_orig][$quebra_fc_tipo_comprobante_orig][5] = bcadd($this->array_total_fc_tipo_comprobante[$quebra_fc_sustento_gasto_orig][$quebra_fc_tipo_comprobante_orig][5], $sum_dfc_total, 10);
         $this->array_total_fc_tipo_comprobante[$quebra_fc_sustento_gasto_orig][$quebra_fc_tipo_comprobante_orig][6] = bcadd($this->array_total_fc_tipo_comprobante[$quebra_fc_sustento_gasto_orig][$quebra_fc_tipo_comprobante_orig][6], $sum_dfc_valor_ice, 10);
         $this->array_total_fc_tipo_comprobante[$quebra_fc_sustento_gasto_orig][$quebra_fc_tipo_comprobante_orig][7] = bcadd($this->array_total_fc_tipo_comprobante[$quebra_fc_sustento_gasto_orig][$quebra_fc_tipo_comprobante_orig][7], $sum_dfc_base_iva, 10);
         $this->array_total_fc_tipo_comprobante[$quebra_fc_sustento_gasto_orig][$quebra_fc_tipo_comprobante_orig][8] = bcadd($this->array_total_fc_tipo_comprobante[$quebra_fc_sustento_gasto_orig][$quebra_fc_tipo_comprobante_orig][8], $sum_dfc_valor_irbpnr, 10);
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
       ...
       $fc_fecha_2 = (isset($Busca_temp['fc_fecha_input_2'])) ? $Busca_temp['fc_fecha_input_2'] : ""; 
       $this->fc_fecha_2 = $fc_fecha_2; 
       $this->fc_tipo_comprobante = $Busca_temp['fc_tipo_comprobante']; 
       $this->fc_tipo_comprobante = (isset($Busca_temp['fc_tipo_comprobante'])) ? $Busca_temp['fc_tipo_comprobante'] : ""; 
       $tmp_pos = (is_string($this->fc_tipo_comprobante)) ? strpos($this->fc_tipo_comprobante, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->fc_tipo_comprobante))
       {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('fc_tipo_comprobante_fc_sustento_gasto', 'fc_sustento_gasto');
     $campos_order = $this->Ini->Get_date_order_groupby("fc_sustento_gasto", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('fc_tipo_comprobante_fc_sustento_gasto', 'fc_tipo_comprobante');
     $campos_order = $this->Ini->Get_date_order_groupby("fc_tipo_comprobante", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->pr_nombre = $rs_res->fields[1] ;  
            $this->pr_identificacion = $rs_res->fields[2] ;  
            $this->fc_documento = $rs_res->fields[3] ;  
            $this->pro_descripcion = $rs_res->fields[4] ;  
            $this->dfc_cantidad = $rs_res->fields[5] ;  
            $this->dfc_precio_unitario = $rs_res->fields[6] ;  
            $this->dfc_subtotal = $rs_res->fields[7] ;  
            $this->dfc_descuento = $rs_res->fields[8] ;  
            $this->dfc_valor_iva = $rs_res->fields[9] ;  
            $this->dfc_total = $rs_res->fields[10] ;  
            $this->fc_tipo_comprobante = $rs_res->fields[11] ;  
            $this->fc_sustento_gasto = $rs_res->fields[12] ;  
            $this->pr_direccion = $rs_res->fields[13] ;  
            $this->pr_telefono = $rs_res->fields[14] ;  
            $this->pr_celular = $rs_res->fields[15] ;  
            $this->pr_email = $rs_res->fields[16] ;  
            $this->documento_modificado = $rs_res->fields[17] ;  
            $this->pro_codigo = $rs_res->fields[18] ;  
            $this->dfc_porcentaje_ice = $rs_res->fields[19] ;  
            $this->dfc_valor_ice = $rs_res->fields[20] ;  
            $this->dfc_base_iva = $rs_res->fields[21] ;  
            $this->dfc_porcentaje_iva = $rs_res->fields[22] ;  
            $this->dfc_porcentaje_irbpnr = $rs_res->fields[23] ;  
            $this->dfc_valor_irbpnr = $rs_res->fields[24] ;  
            ...
            $this->fc_sustento_gasto_orig = $this->fc_sustento_gasto;
            $this->fc_tipo_comprobante_orig = $this->fc_tipo_comprobante;
            $this->fc_tipo_comprobante = $this->look_fc_tipo_comprobante ;
            $this->dfc_porcentaje_iva = $this->look_dfc_porcentaje_iva ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->dfc_cantidad, $this->dfc_subtotal, $this->dfc_descuento, $this->dfc_valor_iva, $this->dfc_total, $this->dfc_valor_ice, $this->dfc_base_iva, $this->dfc_valor_irbpnr, $this->fc_sustento_gasto, $this->fc_tipo_comprobante, $this->fc_sustento_gasto_orig,  $this->fc_tipo_comprobante_orig);
            }
   }
//
   ...
   function html_grid_search()
   {
       ...
       $this->grid_search_str = "";
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['campos_slider']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['campos_slider'] = array(); 
       }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['ajax_nav'])
        { 
           $_SESSION['scriptcase']['saida_html'] = "";
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['grid_pesq'])?'none':'';
       if(!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['ajax_nav'])
       {
          $nm_saida->saida("   <tr id=\"NM_Grid_Search\" ajax='' style='display:" . $str_display . "'>\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['grid_pesq']))
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['grid_pesq'] as $cmp => $def)
           {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['save_grid']))
           {
               return;
           }
           else
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['save_grid']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['grid_pesq']))
           { 
   ...
   {
       $lin_obj  = "";
       $All_cmp_search = array('fc_fecha','fc_tipo_comprobante','pr_identificacion','pro_codigo','pro_descripcion');
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['pesq_tab_label'];
       if (!empty($nmgp_tab_label))
       {
          $nm_tab_campos = explode("?@?", $nmgp_tab_label);
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['grid_pesq']) && count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['grid_pesq']) < 5)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
   ...
   function grid_search_fc_tipo_comprobante($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $lin_obj .= "       <select id='grid_search_fc_tipo_comprobante_cond_" . $ind . "' name='cond_grid_search_fc_tipo_comprobante_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle; display: none'>";
       $selected = ($opc == "eq") ? " selected" : "";
       $lin_obj .= "        <option value='eq'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_exac'] . "</option>";
       $lin_obj .= "       </select>";
       if ($opc == "nu" || $opc == "nn" || $opc == "ep" || $opc == "ne")
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['psq_check_ret']['fc_tipo_comprobante'] = array();
       $fc_tipo_comprobante_look = (is_string($fc_tipo_comprobante) ? substr($this->Db->qstr($fc_tipo_comprobante), 1, -1) : $fc_tipo_comprobante); 
       $nmgp_def_dados  = ""; 
       $nm_comando = "select distinct fc_tipo_comprobante,tc_nombre  from v_del_reporte_gastos_detallado_completos  join sri_tipo_comprobante on fc_tipo_comprobante=tc_codigo WHERE fc_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "'  order by fc_tipo_comprobante"; 
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['psq_check_ret']['fc_tipo_comprobante'][] = trim($rs->fields[0]);
   ...
   function grid_search_pr_identificacion($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $nm_comando = "select distinct pr_identificacion from " . $this->Ini->nm_tabela . " where (fc_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') and pr_identificacion = '$pr_identificacion_look' order by pr_identificacion"; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function grid_search_pro_codigo($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct pro_codigo from " . $this->Ini->nm_tabela . " where (fc_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') and pro_codigo = '$pro_codigo_look' order by pro_codigo"; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
   ...
   function grid_search_pro_descripcion($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct pro_descripcion from " . $this->Ini->nm_tabela . " where (fc_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') and pro_descripcion = '$pro_descripcion_look' order by pro_descripcion"; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
   ...
   function lookup_ajax_pr_identificacion($pr_identificacion)
   {
       ...
       $pr_identificacion_look = (is_string($pr_identificacion) ? substr($this->Db->qstr($pr_identificacion), 1, -1) : $pr_identificacion); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct pr_identificacion from " . $this->Ini->nm_tabela . " where (fc_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') and  pr_identificacion like '%" . $pr_identificacion . "%' order by pr_identificacion"; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
          ...
          { 
            ...
            $cmp1 = grid_v_del_reporte_gastos_detallado_completos_pack_protect_string($cmp1);
            $nmgp_def_dados[] = array($cmp1 => $cmp1); 
             $rs->MoveNext(); 
          } 
          $rs->Close(); 
   ...
   function lookup_ajax_pro_codigo($pro_codigo)
   {
       ...
       $pro_codigo_look = (is_string($pro_codigo) ? substr($this->Db->qstr($pro_codigo), 1, -1) : $pro_codigo); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct pro_codigo from " . $this->Ini->nm_tabela . " where (fc_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') and  pro_codigo like '%" . $pro_codigo . "%' order by pro_codigo"; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
   ...
   function lookup_ajax_pro_descripcion($pro_descripcion)
   {
       ...
       $pro_descripcion_look = (is_string($pro_descripcion) ? substr($this->Db->qstr($pro_descripcion), 1, -1) : $pro_descripcion); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct pro_descripcion from " . $this->Ini->nm_tabela . " where (fc_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') and  pro_descripcion like '%" . $pro_descripcion . "%' order by pro_descripcion"; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "debi_doc_electronicos/grid_v_del_reporte_gastos_detallado_completos";
   ...
   function JS_grid_search()
   {
       ...
       $nm_saida->saida(" function sc_grid_v_del_reporte_gastos_detallado_completos_valida_mes(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida(" function sc_grid_v_del_reporte_gastos_detallado_completos_valida_dia(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fc_fecha_mes'] =  'sc_grid_v_del_reporte_gastos_detallado_completos_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fc_fecha_dia'] =  'sc_grid_v_del_reporte_gastos_detallado_completos_valida_dia(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fc_fecha_v2__mes'] =  'sc_grid_v_del_reporte_gastos_detallado_completos_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fc_fecha_v2__dia'] =  'sc_grid_v_del_reporte_gastos_detallado_completos_valida_dia(this)';\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['ajax_nav'])
       { 
           ...
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fc_fecha_mes']", 'value' => 'sc_grid_v_del_reporte_gastos_detallado_completos_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fc_fecha_dia']", 'value' => 'sc_grid_v_del_reporte_gastos_detallado_completos_valida_dia(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fc_fecha_v2__mes']", 'value' => 'sc_grid_v_del_reporte_gastos_detallado_completos_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fc_fecha_v2__dia']", 'value' => 'sc_grid_v_del_reporte_gastos_detallado_completos_valida_dia(this)');
       } 
 foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['campos_slider'] as $SCmp => $STp)
 {
     foreach ($STp as $Cada_tp => $Val_tp)
     {
        $Val_slider = (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['campos_slider'][$SCmp][$Cada_tp])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_reporte_gastos_detallado_completos']['campos_slider'][$SCmp][$Cada_tp] : "''";
