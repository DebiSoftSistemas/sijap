  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_usuario_punto_emision" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_usuario_punto_emision_form();
	}
...
?>
  ...
  // ---------- Validate upe_punto_emision_
  function do_ajax_form_del_usuario_punto_emision_validate_upe_punto_emision_(iNumLinha)
  {
    var nomeCampo_upe_punto_emision_ = "upe_punto_emision_" + iNumLinha;
    var var_upe_punto_emision_ = scAjaxGetFieldText(nomeCampo_upe_punto_emision_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_usuario_punto_emision_validate_upe_punto_emision_(var_upe_punto_emision_, iNumLinha, var_script_case_init, do_ajax_form_del_usuario_punto_emision_validate_upe_punto_emision__cb);
  } // do_ajax_form_del_usuario_punto_emision_validate_upe_punto_emision_

  function do_ajax_form_del_usuario_punto_emision_validate_upe_punto_emision__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "upe_punto_emision_" + iLineNumber;
    }
    else
    {
      sFieldValid = "upe_punto_emision_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "upe_punto_emision_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "upe_punto_emision_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_usuario_punto_emision_validate_upe_punto_emision__cb

  // ---------- Validate upe_usuario_
  function do_ajax_form_del_usuario_punto_emision_validate_upe_usuario_(iNumLinha)
  {
    var nomeCampo_upe_usuario_ = "upe_usuario_" + iNumLinha;
    var var_upe_usuario_ = scAjaxGetFieldSelect(nomeCampo_upe_usuario_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_usuario_punto_emision_validate_upe_usuario_(var_upe_usuario_, iNumLinha, var_script_case_init, do_ajax_form_del_usuario_punto_emision_validate_upe_usuario__cb);
  } // do_ajax_form_del_usuario_punto_emision_validate_upe_usuario_

  function do_ajax_form_del_usuario_punto_emision_validate_upe_usuario__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "upe_usuario_" + iLineNumber;
    }
    else
    {
      sFieldValid = "upe_usuario_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "upe_usuario_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "upe_usuario_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_usuario_punto_emision_validate_upe_usuario__cb

  // ---------- Validate upe_estado_
  function do_ajax_form_del_usuario_punto_emision_validate_upe_estado_(iNumLinha)
  {
    var nomeCampo_upe_estado_ = "upe_estado_" + iNumLinha;
    var var_upe_estado_ = scAjaxGetFieldSelect(nomeCampo_upe_estado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_usuario_punto_emision_validate_upe_estado_(var_upe_estado_, iNumLinha, var_script_case_init, do_ajax_form_del_usuario_punto_emision_validate_upe_estado__cb);
  } // do_ajax_form_del_usuario_punto_emision_validate_upe_estado_

  function do_ajax_form_del_usuario_punto_emision_validate_upe_estado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "upe_estado_" + iLineNumber;
    }
    else
    {
      sFieldValid = "upe_estado_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "upe_estado_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "upe_estado_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_usuario_punto_emision_validate_upe_estado__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_del_usuario_punto_emision_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_del_usuario_punto_emision_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_usuario_punto_emision_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_del_usuario_punto_emision_add_new_line_cb);
  } // do_ajax_form_del_usuario_punto_emision_add_new_line

  function do_ajax_form_del_usuario_punto_emision_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_del_usuario_punto_emision_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_del_usuario_punto_emision_backup_line(iNumLinha)
  {
    var var_upe_usuario_ = scAjaxGetFieldSelect("upe_usuario_" + iNumLinha);
    var var_upe_punto_emision_ = scAjaxGetFieldText("upe_punto_emision_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_usuario_punto_emision_backup_line(var_upe_usuario_, var_upe_punto_emision_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_del_usuario_punto_emision_backup_line_cb);
  } // do_ajax_form_del_usuario_punto_emision_backup_line

  function do_ajax_form_del_usuario_punto_emision_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_del_usuario_punto_emision_backup_line_cb

  function do_ajax_form_del_usuario_punto_emision_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_del_usuario_punto_emision_cancel_insert

  function do_ajax_form_del_usuario_punto_emision_cancel_update(iSeqVert)
  {
    do_ajax_form_del_usuario_punto_emision_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_del_usuario_punto_emision_cancel_update

  function do_ajax_form_del_usuario_punto_emision_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_del_usuario_punto_emision_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_del_usuario_punto_emision_table_refresh()
  {
    var var_upe_usuario_ = document.F2.upe_usuario_.value;
    var var_upe_punto_emision_ = document.F2.upe_punto_emision_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_del_usuario_punto_emision_table_refresh(var_upe_usuario_, var_upe_punto_emision_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_usuario_punto_emision_table_refresh_cb);
  } //  do_ajax_form_del_usuario_punto_emision_table_refresh

  function do_ajax_form_del_usuario_punto_emision_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.upe_usuario_.value = scAjaxGetKeyValue("upe_usuario_");
    document.F2.upe_punto_emision_.value = scAjaxGetKeyValue("upe_punto_emision_");
    ...
    scAjaxAlert(do_ajax_form_del_usuario_punto_emision_table_refresh_cb_after_alert);
  } // do_ajax_form_del_usuario_punto_emision_table_refresh_cb
  function do_ajax_form_del_usuario_punto_emision_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_del_usuario_punto_emision_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_del_usuario_punto_emision_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_del_usuario_punto_emision_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_upe_punto_emision_ = scAjaxGetFieldText("upe_punto_emision_" + iNumLinha);
    var var_upe_usuario_ = scAjaxGetFieldSelect("upe_usuario_" + iNumLinha);
    var var_upe_estado_ = scAjaxGetFieldSelect("upe_estado_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_del_usuario_punto_emision_submit_form(var_upe_punto_emision_, var_upe_usuario_, var_upe_estado_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_usuario_punto_emision_submit_form_cb);
  } // do_ajax_form_del_usuario_punto_emision_submit_form

  function do_ajax_form_del_usuario_punto_emision_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("upe_punto_emision_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("upe_usuario_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("upe_estado_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_usuario_punto_emision_submit_form_cb_after_alert);
  } // do_ajax_form_del_usuario_punto_emision_submit_form_cb
  function do_ajax_form_del_usuario_punto_emision_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_usuario_punto_emision_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_usuario_punto_emision_navigate_form()
  {
    perform_ajax_form_del_usuario_punto_emision_navigate_form();
  }

  function perform_ajax_form_del_usuario_punto_emision_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_del_usuario_punto_emision_cancel_insert(sc_form_del_usuario_punto_emision_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("upe_punto_emision_" + iNavForm);
      scAjaxHideErrorDisplay("upe_usuario_" + iNavForm);
      scAjaxHideErrorDisplay("upe_estado_" + iNavForm);
    }
    var var_upe_usuario_ = document.F2.upe_usuario_.value;
    var var_upe_punto_emision_ = document.F2.upe_punto_emision_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_usuario_punto_emision_navigate_form(var_upe_usuario_, var_upe_punto_emision_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_usuario_punto_emision_navigate_form_cb);
  } // do_ajax_form_del_usuario_punto_emision_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_usuario_punto_emision']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_usuario_punto_emision_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.upe_usuario_.value = scAjaxGetKeyValue("upe_usuario_" + var_last_index);
    document.F2.upe_punto_emision_.value = scAjaxGetKeyValue("upe_punto_emision_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_usuario_punto_emision_navigate_form_cb_after_alert);
  } // do_ajax_form_del_usuario_punto_emision_navigate_form_cb
  function do_ajax_form_del_usuario_punto_emision_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_del_usuario_punto_emision_navigate_form_cb_after_alert

    function sc_form_del_usuario_punto_emision_get_last_line_number()
    {
    ...
    } //sc_form_del_usuario_punto_emision_get_last_line_number

  function sc_hide_form_del_usuario_punto_emision_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "upe_punto_emision_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "upe_usuario_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "upe_estado_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["upe_punto_emision_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_punto_emision'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["upe_usuario_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_username'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["upe_estado_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["upe_punto_emision_"][iNumLinha] = "upe_punto_emision_" + iNumLinha;
    ajax_field_mult["upe_usuario_"][iNumLinha] = "upe_usuario_" + iNumLinha;
    ajax_field_mult["upe_estado_"][iNumLinha] = "upe_estado_" + iNumLinha;
    ajax_field_id["upe_usuario_" + iNumLinha] = new Array("hidden_field_label_upe_usuario_", "hidden_field_data_upe_usuario_" + iNumLinha);
    ajax_field_id["upe_estado_" + iNumLinha] = new Array("hidden_field_label_upe_estado_", "hidden_field_data_upe_estado_" + iNumLinha);
    ajax_error_count["upe_punto_emision_" + iNumLinha] = "off";
    ajax_error_count["upe_usuario_" + iNumLinha] = "off";
    ajax_error_count["upe_estado_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["upe_punto_emision_" + iNumLinha] = "on";
    ajax_read_only["upe_usuario_" + iNumLinha] = "on";
    ajax_read_only["upe_estado_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["upe_punto_emision_" + iNumLinha] = "on";
    ajax_read_only["upe_usuario_" + iNumLinha] = "on";
    ajax_read_only["upe_estado_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["upe_punto_emision_" + iNumLinha] = null;
    ajax_error_list["upe_usuario_" + iNumLinha] = null;
    ajax_error_list["upe_estado_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "upe_punto_emision_": new Array(),
    "upe_usuario_": new Array(),
    "upe_estado_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["upe_punto_emision_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["upe_punto_emision_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["upe_punto_emision_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["upe_punto_emision_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["upe_punto_emision_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["upe_usuario_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["upe_usuario_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["upe_usuario_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["upe_usuario_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["upe_usuario_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["upe_estado_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["upe_estado_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["upe_estado_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["upe_estado_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["upe_estado_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['upe_punto_emision_'])) ? $this->nmgp_cmp_readonly['upe_punto_emision_'] : 'on';
?>
    scAjaxFieldRead("upe_punto_emision_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['upe_usuario_'])) ? $this->nmgp_cmp_readonly['upe_usuario_'] : 'on';
?>
    scAjaxFieldRead("upe_usuario_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['upe_estado_'])) ? $this->nmgp_cmp_readonly['upe_estado_'] : 'off';
?>
    scAjaxFieldRead("upe_estado_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("upe_punto_emision_" + iSeq, "on");
    scAjaxFieldRead("upe_usuario_" + iSeq, "on");
    scAjaxFieldRead("upe_estado_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["upe_punto_emision_" + iRow] || "on" == ajax_error_count["upe_usuario_" + iRow] || "on" == ajax_error_count["upe_estado_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_upe_punto_emision_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_upe_usuario_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_upe_estado_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["upe_punto_emision_" + iRow] && "off" == ajax_error_count["upe_usuario_" + iRow] && "off" == ajax_error_count["upe_estado_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["upe_punto_emision_" + iRow] = "off";
        ajax_error_count["upe_usuario_" + iRow] = "off";
        ajax_error_count["upe_estado_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_upe_punto_emision_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_upe_usuario_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_upe_estado_" + iRow).removeClass("scFormErrorLine");
    }
  }
