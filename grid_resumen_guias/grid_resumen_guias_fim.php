...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_resumen_guias"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_resumen_guias"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_resumen_guias']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_resumen_guias']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_resumen_guias']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_resumen_guias']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_resumen_guias']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_resumen_guias</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_resumen_guias']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_resumen_guias']['embutida_filho'] as $ind => $sc_init)
          {
