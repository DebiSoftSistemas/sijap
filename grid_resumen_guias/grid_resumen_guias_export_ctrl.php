<?php
@session_start() ;
$_SESSION['scriptcase']['grid_resumen_guias']['sc_process_barr'] = true;
require_once('../grid_resumen_guias/index.php');
unset($_SESSION['scriptcase']['grid_resumen_guias']['sc_process_barr']);
$ExportCtrl = new grid_resumen_guias_export_control;
$ExportCtrl->Export_barr();

class grid_resumen_guias_export_control
{
