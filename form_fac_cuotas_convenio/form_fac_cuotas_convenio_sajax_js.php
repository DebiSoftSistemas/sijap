  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_fac_cuotas_convenio" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_fac_cuotas_convenio_form();
	}
...
?>
  ...
  // ---------- Validate cc_id
  function do_ajax_form_fac_cuotas_convenio_validate_cc_id()
  {
    var nomeCampo_cc_id = "cc_id";
    var var_cc_id = scAjaxGetFieldHidden(nomeCampo_cc_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_cuotas_convenio_validate_cc_id(var_cc_id, var_script_case_init, do_ajax_form_fac_cuotas_convenio_validate_cc_id_cb);
  } // do_ajax_form_fac_cuotas_convenio_validate_cc_id

  function do_ajax_form_fac_cuotas_convenio_validate_cc_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_cuotas_convenio_validate_cc_id_cb

  // ---------- Validate cc_convenio
  function do_ajax_form_fac_cuotas_convenio_validate_cc_convenio()
  {
    var nomeCampo_cc_convenio = "cc_convenio";
    var var_cc_convenio = scAjaxGetFieldHidden(nomeCampo_cc_convenio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_cuotas_convenio_validate_cc_convenio(var_cc_convenio, var_script_case_init, do_ajax_form_fac_cuotas_convenio_validate_cc_convenio_cb);
  } // do_ajax_form_fac_cuotas_convenio_validate_cc_convenio

  function do_ajax_form_fac_cuotas_convenio_validate_cc_convenio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_cuotas_convenio_validate_cc_convenio_cb

  // ---------- Validate cc_cuota
  function do_ajax_form_fac_cuotas_convenio_validate_cc_cuota()
  {
    var nomeCampo_cc_cuota = "cc_cuota";
    var var_cc_cuota = scAjaxGetFieldHidden(nomeCampo_cc_cuota);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_cuotas_convenio_validate_cc_cuota(var_cc_cuota, var_script_case_init, do_ajax_form_fac_cuotas_convenio_validate_cc_cuota_cb);
  } // do_ajax_form_fac_cuotas_convenio_validate_cc_cuota

  function do_ajax_form_fac_cuotas_convenio_validate_cc_cuota_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_cuotas_convenio_validate_cc_cuota_cb

  // ---------- Validate cc_fecha
  function do_ajax_form_fac_cuotas_convenio_validate_cc_fecha()
  {
    var nomeCampo_cc_fecha = "cc_fecha";
    var var_cc_fecha = scAjaxGetFieldHidden(nomeCampo_cc_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_cuotas_convenio_validate_cc_fecha(var_cc_fecha, var_script_case_init, do_ajax_form_fac_cuotas_convenio_validate_cc_fecha_cb);
  } // do_ajax_form_fac_cuotas_convenio_validate_cc_fecha

  function do_ajax_form_fac_cuotas_convenio_validate_cc_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_cuotas_convenio_validate_cc_fecha_cb

  // ---------- Validate cc_capital
  function do_ajax_form_fac_cuotas_convenio_validate_cc_capital()
  {
    var nomeCampo_cc_capital = "cc_capital";
    var var_cc_capital = scAjaxGetFieldText(nomeCampo_cc_capital);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_cuotas_convenio_validate_cc_capital(var_cc_capital, var_script_case_init, do_ajax_form_fac_cuotas_convenio_validate_cc_capital_cb);
  } // do_ajax_form_fac_cuotas_convenio_validate_cc_capital

  function do_ajax_form_fac_cuotas_convenio_validate_cc_capital_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_cuotas_convenio_validate_cc_capital_cb

  // ---------- Validate cc_interes
  function do_ajax_form_fac_cuotas_convenio_validate_cc_interes()
  {
    var nomeCampo_cc_interes = "cc_interes";
    var var_cc_interes = scAjaxGetFieldHidden(nomeCampo_cc_interes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_cuotas_convenio_validate_cc_interes(var_cc_interes, var_script_case_init, do_ajax_form_fac_cuotas_convenio_validate_cc_interes_cb);
  } // do_ajax_form_fac_cuotas_convenio_validate_cc_interes

  function do_ajax_form_fac_cuotas_convenio_validate_cc_interes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_cuotas_convenio_validate_cc_interes_cb

  // ---------- Validate cc_cargos
  function do_ajax_form_fac_cuotas_convenio_validate_cc_cargos()
  {
    var nomeCampo_cc_cargos = "cc_cargos";
    var var_cc_cargos = scAjaxGetFieldHidden(nomeCampo_cc_cargos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_cuotas_convenio_validate_cc_cargos(var_cc_cargos, var_script_case_init, do_ajax_form_fac_cuotas_convenio_validate_cc_cargos_cb);
  } // do_ajax_form_fac_cuotas_convenio_validate_cc_cargos

  function do_ajax_form_fac_cuotas_convenio_validate_cc_cargos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_cuotas_convenio_validate_cc_cargos_cb

  // ---------- Validate cc_valor_cuota
  function do_ajax_form_fac_cuotas_convenio_validate_cc_valor_cuota()
  {
    var nomeCampo_cc_valor_cuota = "cc_valor_cuota";
    var var_cc_valor_cuota = scAjaxGetFieldHidden(nomeCampo_cc_valor_cuota);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_cuotas_convenio_validate_cc_valor_cuota(var_cc_valor_cuota, var_script_case_init, do_ajax_form_fac_cuotas_convenio_validate_cc_valor_cuota_cb);
  } // do_ajax_form_fac_cuotas_convenio_validate_cc_valor_cuota

  function do_ajax_form_fac_cuotas_convenio_validate_cc_valor_cuota_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_cuotas_convenio_validate_cc_valor_cuota_cb

  // ---------- Event onblur cc_capital
  function do_ajax_form_fac_cuotas_convenio_event_cc_capital_onblur()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_fac_cuotas_convenio_event_cc_capital_onblur(var_cc_valor_cuota, var_cc_capital, var_cc_interes, var_script_case_init, do_ajax_form_fac_cuotas_convenio_event_cc_capital_onblur_cb);
  } // do_ajax_form_fac_cuotas_convenio_event_cc_capital_onblur

  function do_ajax_form_fac_cuotas_convenio_event_cc_capital_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cc_capital";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_fac_cuotas_convenio_event_cc_capital_onblur_cb_after_alert);
  } // do_ajax_form_fac_cuotas_convenio_event_cc_capital_onblur_cb
  function do_ajax_form_fac_cuotas_convenio_event_cc_capital_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_fac_cuotas_convenio_event_cc_capital_onblur_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_fac_cuotas_convenio_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_fac_cuotas_convenio_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_fac_cuotas_convenio_submit_form(var_cc_id, var_cc_convenio, var_cc_cuota, var_cc_fecha, var_cc_capital, var_cc_interes, var_cc_cargos, var_cc_valor_cuota, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_fac_cuotas_convenio_submit_form_cb);
  } // do_ajax_form_fac_cuotas_convenio_submit_form

  function do_ajax_form_fac_cuotas_convenio_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_fac_cuotas_convenio_submit_form_cb_after_alert);
  } // do_ajax_form_fac_cuotas_convenio_submit_form_cb
  function do_ajax_form_fac_cuotas_convenio_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_fac_cuotas_convenio_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_fac_cuotas_convenio_navigate_form()
  {
    perform_ajax_form_fac_cuotas_convenio_navigate_form();
  }

  function perform_ajax_form_fac_cuotas_convenio_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_fac_cuotas_convenio_navigate_form(var_cc_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_cuotas_convenio_navigate_form_cb);
  } // do_ajax_form_fac_cuotas_convenio_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_cuotas_convenio']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_fac_cuotas_convenio_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_fac_cuotas_convenio_navigate_form_cb_after_alert);
  } // do_ajax_form_fac_cuotas_convenio_navigate_form_cb
  function do_ajax_form_fac_cuotas_convenio_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_fac_cuotas_convenio_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_fac_cuotas_convenio_navigate_form_cb_after_alert

  function sc_hide_form_fac_cuotas_convenio_form()
  {
