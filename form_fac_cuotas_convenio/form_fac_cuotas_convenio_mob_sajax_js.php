  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_fac_cuotas_convenio_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_fac_cuotas_convenio_mob_form();
	}
...
?>
  ...
  // ---------- Validate cc_id
  function do_ajax_form_fac_cuotas_convenio_mob_validate_cc_id()
  {
    var nomeCampo_cc_id = "cc_id";
    var var_cc_id = scAjaxGetFieldHidden(nomeCampo_cc_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_cuotas_convenio_mob_validate_cc_id(var_cc_id, var_script_case_init, do_ajax_form_fac_cuotas_convenio_mob_validate_cc_id_cb);
  } // do_ajax_form_fac_cuotas_convenio_mob_validate_cc_id

  function do_ajax_form_fac_cuotas_convenio_mob_validate_cc_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_cuotas_convenio_mob_validate_cc_id_cb

  // ---------- Validate cc_convenio
  function do_ajax_form_fac_cuotas_convenio_mob_validate_cc_convenio()
  {
    var nomeCampo_cc_convenio = "cc_convenio";
    var var_cc_convenio = scAjaxGetFieldHidden(nomeCampo_cc_convenio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_cuotas_convenio_mob_validate_cc_convenio(var_cc_convenio, var_script_case_init, do_ajax_form_fac_cuotas_convenio_mob_validate_cc_convenio_cb);
  } // do_ajax_form_fac_cuotas_convenio_mob_validate_cc_convenio

  function do_ajax_form_fac_cuotas_convenio_mob_validate_cc_convenio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cc_convenio";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_cuotas_convenio_mob_validate_cc_convenio_cb

  // ---------- Validate cc_cuota
  function do_ajax_form_fac_cuotas_convenio_mob_validate_cc_cuota()
  {
    var nomeCampo_cc_cuota = "cc_cuota";
    var var_cc_cuota = scAjaxGetFieldHidden(nomeCampo_cc_cuota);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_cuotas_convenio_mob_validate_cc_cuota(var_cc_cuota, var_script_case_init, do_ajax_form_fac_cuotas_convenio_mob_validate_cc_cuota_cb);
  } // do_ajax_form_fac_cuotas_convenio_mob_validate_cc_cuota

  function do_ajax_form_fac_cuotas_convenio_mob_validate_cc_cuota_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cc_cuota";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_cuotas_convenio_mob_validate_cc_cuota_cb

  // ---------- Validate cc_fecha
  function do_ajax_form_fac_cuotas_convenio_mob_validate_cc_fecha()
  {
    var nomeCampo_cc_fecha = "cc_fecha";
    var var_cc_fecha = scAjaxGetFieldHidden(nomeCampo_cc_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_cuotas_convenio_mob_validate_cc_fecha(var_cc_fecha, var_script_case_init, do_ajax_form_fac_cuotas_convenio_mob_validate_cc_fecha_cb);
  } // do_ajax_form_fac_cuotas_convenio_mob_validate_cc_fecha

  function do_ajax_form_fac_cuotas_convenio_mob_validate_cc_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cc_fecha";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_cuotas_convenio_mob_validate_cc_fecha_cb

  // ---------- Validate cc_capital
  function do_ajax_form_fac_cuotas_convenio_mob_validate_cc_capital()
  {
    var nomeCampo_cc_capital = "cc_capital";
    var var_cc_capital = scAjaxGetFieldText(nomeCampo_cc_capital);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_cuotas_convenio_mob_validate_cc_capital(var_cc_capital, var_script_case_init, do_ajax_form_fac_cuotas_convenio_mob_validate_cc_capital_cb);
  } // do_ajax_form_fac_cuotas_convenio_mob_validate_cc_capital

  function do_ajax_form_fac_cuotas_convenio_mob_validate_cc_capital_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cc_capital";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_cuotas_convenio_mob_validate_cc_capital_cb

  // ---------- Validate cc_interes
  function do_ajax_form_fac_cuotas_convenio_mob_validate_cc_interes()
  {
    var nomeCampo_cc_interes = "cc_interes";
    var var_cc_interes = scAjaxGetFieldHidden(nomeCampo_cc_interes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_cuotas_convenio_mob_validate_cc_interes(var_cc_interes, var_script_case_init, do_ajax_form_fac_cuotas_convenio_mob_validate_cc_interes_cb);
  } // do_ajax_form_fac_cuotas_convenio_mob_validate_cc_interes

  function do_ajax_form_fac_cuotas_convenio_mob_validate_cc_interes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cc_interes";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_cuotas_convenio_mob_validate_cc_interes_cb

  // ---------- Validate cc_cargos
  function do_ajax_form_fac_cuotas_convenio_mob_validate_cc_cargos()
  {
    var nomeCampo_cc_cargos = "cc_cargos";
    var var_cc_cargos = scAjaxGetFieldHidden(nomeCampo_cc_cargos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_cuotas_convenio_mob_validate_cc_cargos(var_cc_cargos, var_script_case_init, do_ajax_form_fac_cuotas_convenio_mob_validate_cc_cargos_cb);
  } // do_ajax_form_fac_cuotas_convenio_mob_validate_cc_cargos

  function do_ajax_form_fac_cuotas_convenio_mob_validate_cc_cargos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cc_cargos";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_cuotas_convenio_mob_validate_cc_cargos_cb

  // ---------- Validate cc_valor_cuota
  function do_ajax_form_fac_cuotas_convenio_mob_validate_cc_valor_cuota()
  {
    var nomeCampo_cc_valor_cuota = "cc_valor_cuota";
    var var_cc_valor_cuota = scAjaxGetFieldHidden(nomeCampo_cc_valor_cuota);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_cuotas_convenio_mob_validate_cc_valor_cuota(var_cc_valor_cuota, var_script_case_init, do_ajax_form_fac_cuotas_convenio_mob_validate_cc_valor_cuota_cb);
  } // do_ajax_form_fac_cuotas_convenio_mob_validate_cc_valor_cuota

  function do_ajax_form_fac_cuotas_convenio_mob_validate_cc_valor_cuota_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cc_valor_cuota";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_cuotas_convenio_mob_validate_cc_valor_cuota_cb

  // ---------- Event onblur cc_capital
  function do_ajax_form_fac_cuotas_convenio_mob_event_cc_capital_onblur()
  {
    var var_cc_valor_cuota = scAjaxGetFieldHidden("cc_valor_cuota");
    var var_cc_capital = scAjaxGetFieldText("cc_capital");
    var var_cc_interes = scAjaxGetFieldHidden("cc_interes");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_fac_cuotas_convenio_mob_event_cc_capital_onblur(var_cc_valor_cuota, var_cc_capital, var_cc_interes, var_script_case_init, do_ajax_form_fac_cuotas_convenio_mob_event_cc_capital_onblur_cb);
  } // do_ajax_form_fac_cuotas_convenio_mob_event_cc_capital_onblur

  function do_ajax_form_fac_cuotas_convenio_mob_event_cc_capital_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cc_capital";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_fac_cuotas_convenio_mob_event_cc_capital_onblur_cb_after_alert);
  } // do_ajax_form_fac_cuotas_convenio_mob_event_cc_capital_onblur_cb
  function do_ajax_form_fac_cuotas_convenio_mob_event_cc_capital_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_fac_cuotas_convenio_mob_event_cc_capital_onblur_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_fac_cuotas_convenio_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_fac_cuotas_convenio_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_cc_id = scAjaxGetFieldHidden("cc_id");
    var var_cc_convenio = scAjaxGetFieldHidden("cc_convenio");
    var var_cc_cuota = scAjaxGetFieldHidden("cc_cuota");
    var var_cc_fecha = scAjaxGetFieldHidden("cc_fecha");
    var var_cc_capital = scAjaxGetFieldText("cc_capital");
    var var_cc_interes = scAjaxGetFieldHidden("cc_interes");
    var var_cc_cargos = scAjaxGetFieldHidden("cc_cargos");
    var var_cc_valor_cuota = scAjaxGetFieldHidden("cc_valor_cuota");
    ...
    scAjaxProcOn();
    x_ajax_form_fac_cuotas_convenio_mob_submit_form(var_cc_id, var_cc_convenio, var_cc_cuota, var_cc_fecha, var_cc_capital, var_cc_interes, var_cc_cargos, var_cc_valor_cuota, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_fac_cuotas_convenio_mob_submit_form_cb);
  } // do_ajax_form_fac_cuotas_convenio_mob_submit_form

  function do_ajax_form_fac_cuotas_convenio_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("cc_id");
      scAjaxHideErrorDisplay("cc_convenio");
      scAjaxHideErrorDisplay("cc_cuota");
      scAjaxHideErrorDisplay("cc_fecha");
      scAjaxHideErrorDisplay("cc_capital");
      scAjaxHideErrorDisplay("cc_interes");
      scAjaxHideErrorDisplay("cc_cargos");
      scAjaxHideErrorDisplay("cc_valor_cuota");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_fac_cuotas_convenio_mob_submit_form_cb_after_alert);
  } // do_ajax_form_fac_cuotas_convenio_mob_submit_form_cb
  function do_ajax_form_fac_cuotas_convenio_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_fac_cuotas_convenio_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_fac_cuotas_convenio_mob_navigate_form()
  {
    perform_ajax_form_fac_cuotas_convenio_mob_navigate_form();
  }

  function perform_ajax_form_fac_cuotas_convenio_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("cc_cargos");
    scAjaxHideErrorDisplay("cc_valor_cuota");
    var var_cc_id = document.F2.cc_id.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_fac_cuotas_convenio_mob_navigate_form(var_cc_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_cuotas_convenio_mob_navigate_form_cb);
  } // do_ajax_form_fac_cuotas_convenio_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_cuotas_convenio_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_fac_cuotas_convenio_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.cc_id.value = scAjaxGetKeyValue("cc_id");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_fac_cuotas_convenio_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_fac_cuotas_convenio_mob_navigate_form_cb
  function do_ajax_form_fac_cuotas_convenio_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_fac_cuotas_convenio_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_fac_cuotas_convenio_mob_navigate_form_cb_after_alert

  function sc_hide_form_fac_cuotas_convenio_mob_form()
  {
  ...
  ajax_field_list[0] = "cc_id";
  ajax_field_list[1] = "cc_convenio";
  ajax_field_list[2] = "cc_cuota";
  ajax_field_list[3] = "cc_fecha";
  ajax_field_list[4] = "cc_capital";
  ajax_field_list[5] = "cc_interes";
  ajax_field_list[6] = "cc_cargos";
  ajax_field_list[7] = "cc_valor_cuota";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "cc_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cc_convenio": {"label": "<?php echo $this->Ini->Nm_lang['lang_convenio_pago'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cc_cuota": {"label": "<?php echo $this->Ini->Nm_lang['lang_cuota_nro'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cc_fecha": {"label": "<?php echo $this->Ini->Nm_lang['lang_fecha'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cc_capital": {"label": "<?php echo $this->Ini->Nm_lang['lang_capital'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cc_interes": {"label": "<?php echo $this->Ini->Nm_lang['lang_interes'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cc_cargos": {"label": "<?php echo $this->Ini->Nm_lang['lang_recargos'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cc_valor_cuota": {"label": "<?php echo $this->Ini->Nm_lang['lang_valor_pago'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "cc_id": new Array(),
    "cc_convenio": new Array(),
    "cc_cuota": new Array(),
    "cc_fecha": new Array(),
    "cc_capital": new Array(),
    "cc_interes": new Array(),
    "cc_cargos": new Array(),
    "cc_valor_cuota": new Array()
  };
  ajax_field_mult["cc_id"][1] = "cc_id";
  ajax_field_mult["cc_convenio"][1] = "cc_convenio";
  ajax_field_mult["cc_cuota"][1] = "cc_cuota";
  ajax_field_mult["cc_fecha"][1] = "cc_fecha";
  ajax_field_mult["cc_capital"][1] = "cc_capital";
  ajax_field_mult["cc_interes"][1] = "cc_interes";
  ajax_field_mult["cc_cargos"][1] = "cc_cargos";
  ajax_field_mult["cc_valor_cuota"][1] = "cc_valor_cuota";

  var ajax_field_id = {
    "cc_cuota": new Array("hidden_field_label_cc_cuota", "hidden_field_data_cc_cuota"),
    "cc_fecha": new Array("hidden_field_label_cc_fecha", "hidden_field_data_cc_fecha"),
    "cc_capital": new Array("hidden_field_label_cc_capital", "hidden_field_data_cc_capital"),
    "cc_interes": new Array("hidden_field_label_cc_interes", "hidden_field_data_cc_interes"),
    "cc_valor_cuota": new Array("hidden_field_label_cc_valor_cuota", "hidden_field_data_cc_valor_cuota")
  };
