  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_jap_aportaciones_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_jap_aportaciones_mob_form();
	}
...
?>
  ...
  // ---------- Validate ap_id
  function do_ajax_form_jap_aportaciones_mob_validate_ap_id()
  {
    var nomeCampo_ap_id = "ap_id";
    var var_ap_id = scAjaxGetFieldHidden(nomeCampo_ap_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_aportaciones_mob_validate_ap_id(var_ap_id, var_script_case_init, do_ajax_form_jap_aportaciones_mob_validate_ap_id_cb);
  } // do_ajax_form_jap_aportaciones_mob_validate_ap_id

  function do_ajax_form_jap_aportaciones_mob_validate_ap_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_aportaciones_mob_validate_ap_id_cb

  // ---------- Validate ap_descripcion
  function do_ajax_form_jap_aportaciones_mob_validate_ap_descripcion()
  {
    var nomeCampo_ap_descripcion = "ap_descripcion";
    var var_ap_descripcion = scAjaxGetFieldText(nomeCampo_ap_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_aportaciones_mob_validate_ap_descripcion(var_ap_descripcion, var_script_case_init, do_ajax_form_jap_aportaciones_mob_validate_ap_descripcion_cb);
  } // do_ajax_form_jap_aportaciones_mob_validate_ap_descripcion

  function do_ajax_form_jap_aportaciones_mob_validate_ap_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ap_descripcion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_aportaciones_mob_validate_ap_descripcion_cb

  // ---------- Validate ap_tipo_cartera
  function do_ajax_form_jap_aportaciones_mob_validate_ap_tipo_cartera()
  {
    var nomeCampo_ap_tipo_cartera = "ap_tipo_cartera";
    var var_ap_tipo_cartera = scAjaxGetFieldSelect(nomeCampo_ap_tipo_cartera);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_aportaciones_mob_validate_ap_tipo_cartera(var_ap_tipo_cartera, var_script_case_init, do_ajax_form_jap_aportaciones_mob_validate_ap_tipo_cartera_cb);
  } // do_ajax_form_jap_aportaciones_mob_validate_ap_tipo_cartera

  function do_ajax_form_jap_aportaciones_mob_validate_ap_tipo_cartera_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ap_tipo_cartera";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_aportaciones_mob_validate_ap_tipo_cartera_cb

  // ---------- Validate ap_tipo_comprobante
  function do_ajax_form_jap_aportaciones_mob_validate_ap_tipo_comprobante()
  {
    var nomeCampo_ap_tipo_comprobante = "ap_tipo_comprobante";
    var var_ap_tipo_comprobante = scAjaxGetFieldSelect(nomeCampo_ap_tipo_comprobante);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_aportaciones_mob_validate_ap_tipo_comprobante(var_ap_tipo_comprobante, var_script_case_init, do_ajax_form_jap_aportaciones_mob_validate_ap_tipo_comprobante_cb);
  } // do_ajax_form_jap_aportaciones_mob_validate_ap_tipo_comprobante

  function do_ajax_form_jap_aportaciones_mob_validate_ap_tipo_comprobante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ap_tipo_comprobante";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_aportaciones_mob_validate_ap_tipo_comprobante_cb

  // ---------- Validate ap_periodicidad
  function do_ajax_form_jap_aportaciones_mob_validate_ap_periodicidad()
  {
    var nomeCampo_ap_periodicidad = "ap_periodicidad";
    var var_ap_periodicidad = scAjaxGetFieldSelect(nomeCampo_ap_periodicidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_aportaciones_mob_validate_ap_periodicidad(var_ap_periodicidad, var_script_case_init, do_ajax_form_jap_aportaciones_mob_validate_ap_periodicidad_cb);
  } // do_ajax_form_jap_aportaciones_mob_validate_ap_periodicidad

  function do_ajax_form_jap_aportaciones_mob_validate_ap_periodicidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ap_periodicidad";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_aportaciones_mob_validate_ap_periodicidad_cb

  // ---------- Validate ap_dias_vigencia
  function do_ajax_form_jap_aportaciones_mob_validate_ap_dias_vigencia()
  {
    var nomeCampo_ap_dias_vigencia = "ap_dias_vigencia";
    var var_ap_dias_vigencia = scAjaxGetFieldText(nomeCampo_ap_dias_vigencia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_aportaciones_mob_validate_ap_dias_vigencia(var_ap_dias_vigencia, var_script_case_init, do_ajax_form_jap_aportaciones_mob_validate_ap_dias_vigencia_cb);
  } // do_ajax_form_jap_aportaciones_mob_validate_ap_dias_vigencia

  function do_ajax_form_jap_aportaciones_mob_validate_ap_dias_vigencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ap_dias_vigencia";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_aportaciones_mob_validate_ap_dias_vigencia_cb

  // ---------- Validate ap_emite_asiento
  function do_ajax_form_jap_aportaciones_mob_validate_ap_emite_asiento()
  {
    var nomeCampo_ap_emite_asiento = "ap_emite_asiento";
    var var_ap_emite_asiento = scAjaxGetFieldCheckbox(nomeCampo_ap_emite_asiento, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_aportaciones_mob_validate_ap_emite_asiento(var_ap_emite_asiento, var_script_case_init, do_ajax_form_jap_aportaciones_mob_validate_ap_emite_asiento_cb);
  } // do_ajax_form_jap_aportaciones_mob_validate_ap_emite_asiento

  function do_ajax_form_jap_aportaciones_mob_validate_ap_emite_asiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ap_emite_asiento";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_aportaciones_mob_validate_ap_emite_asiento_cb

  // ---------- Validate ap_estado
  function do_ajax_form_jap_aportaciones_mob_validate_ap_estado()
  {
    var nomeCampo_ap_estado = "ap_estado";
    var var_ap_estado = scAjaxGetFieldSelect(nomeCampo_ap_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_aportaciones_mob_validate_ap_estado(var_ap_estado, var_script_case_init, do_ajax_form_jap_aportaciones_mob_validate_ap_estado_cb);
  } // do_ajax_form_jap_aportaciones_mob_validate_ap_estado

  function do_ajax_form_jap_aportaciones_mob_validate_ap_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ap_estado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_aportaciones_mob_validate_ap_estado_cb

  // ---------- Validate ap_contrato
  function do_ajax_form_jap_aportaciones_mob_validate_ap_contrato()
  {
    var nomeCampo_ap_contrato = "ap_contrato";
    var var_ap_contrato = scAjaxGetFieldCheckbox(nomeCampo_ap_contrato, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_aportaciones_mob_validate_ap_contrato(var_ap_contrato, var_script_case_init, do_ajax_form_jap_aportaciones_mob_validate_ap_contrato_cb);
  } // do_ajax_form_jap_aportaciones_mob_validate_ap_contrato

  function do_ajax_form_jap_aportaciones_mob_validate_ap_contrato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ap_contrato";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_aportaciones_mob_validate_ap_contrato_cb

  // ---------- Validate ap_servicio
  function do_ajax_form_jap_aportaciones_mob_validate_ap_servicio()
  {
    var nomeCampo_ap_servicio = "ap_servicio";
    var var_ap_servicio = scAjaxGetFieldCheckbox(nomeCampo_ap_servicio, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_aportaciones_mob_validate_ap_servicio(var_ap_servicio, var_script_case_init, do_ajax_form_jap_aportaciones_mob_validate_ap_servicio_cb);
  } // do_ajax_form_jap_aportaciones_mob_validate_ap_servicio

  function do_ajax_form_jap_aportaciones_mob_validate_ap_servicio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ap_servicio";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_aportaciones_mob_validate_ap_servicio_cb

  // ---------- Validate ap_personalizada
  function do_ajax_form_jap_aportaciones_mob_validate_ap_personalizada()
  {
    var nomeCampo_ap_personalizada = "ap_personalizada";
    var var_ap_personalizada = scAjaxGetFieldCheckbox(nomeCampo_ap_personalizada, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_aportaciones_mob_validate_ap_personalizada(var_ap_personalizada, var_script_case_init, do_ajax_form_jap_aportaciones_mob_validate_ap_personalizada_cb);
  } // do_ajax_form_jap_aportaciones_mob_validate_ap_personalizada

  function do_ajax_form_jap_aportaciones_mob_validate_ap_personalizada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ap_personalizada";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_aportaciones_mob_validate_ap_personalizada_cb

  // ---------- Validate ap_libre
  function do_ajax_form_jap_aportaciones_mob_validate_ap_libre()
  {
    var nomeCampo_ap_libre = "ap_libre";
    var var_ap_libre = scAjaxGetFieldCheckbox(nomeCampo_ap_libre, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_aportaciones_mob_validate_ap_libre(var_ap_libre, var_script_case_init, do_ajax_form_jap_aportaciones_mob_validate_ap_libre_cb);
  } // do_ajax_form_jap_aportaciones_mob_validate_ap_libre

  function do_ajax_form_jap_aportaciones_mob_validate_ap_libre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ap_libre";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_aportaciones_mob_validate_ap_libre_cb

  // ---------- Validate ap_reconexion
  function do_ajax_form_jap_aportaciones_mob_validate_ap_reconexion()
  {
    var nomeCampo_ap_reconexion = "ap_reconexion";
    var var_ap_reconexion = scAjaxGetFieldCheckbox(nomeCampo_ap_reconexion, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_aportaciones_mob_validate_ap_reconexion(var_ap_reconexion, var_script_case_init, do_ajax_form_jap_aportaciones_mob_validate_ap_reconexion_cb);
  } // do_ajax_form_jap_aportaciones_mob_validate_ap_reconexion

  function do_ajax_form_jap_aportaciones_mob_validate_ap_reconexion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ap_reconexion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_aportaciones_mob_validate_ap_reconexion_cb

  // ---------- Validate ap_materiales
  function do_ajax_form_jap_aportaciones_mob_validate_ap_materiales()
  {
    var nomeCampo_ap_materiales = "ap_materiales";
    var var_ap_materiales = scAjaxGetFieldCheckbox(nomeCampo_ap_materiales, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_aportaciones_mob_validate_ap_materiales(var_ap_materiales, var_script_case_init, do_ajax_form_jap_aportaciones_mob_validate_ap_materiales_cb);
  } // do_ajax_form_jap_aportaciones_mob_validate_ap_materiales

  function do_ajax_form_jap_aportaciones_mob_validate_ap_materiales_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ap_materiales";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_aportaciones_mob_validate_ap_materiales_cb

  // ---------- Validate productos
  function do_ajax_form_jap_aportaciones_mob_validate_productos()
  {
    var nomeCampo_productos = "productos";
    var var_productos = scAjaxGetFieldText(nomeCampo_productos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_aportaciones_mob_validate_productos(var_productos, var_script_case_init, do_ajax_form_jap_aportaciones_mob_validate_productos_cb);
  } // do_ajax_form_jap_aportaciones_mob_validate_productos

  function do_ajax_form_jap_aportaciones_mob_validate_productos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_aportaciones_mob_validate_productos_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_jap_aportaciones_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_jap_aportaciones_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_ap_id = scAjaxGetFieldHidden("ap_id");
    var var_ap_descripcion = scAjaxGetFieldText("ap_descripcion");
    var var_ap_tipo_cartera = scAjaxGetFieldSelect("ap_tipo_cartera");
    var var_ap_tipo_comprobante = scAjaxGetFieldSelect("ap_tipo_comprobante");
    var var_ap_periodicidad = scAjaxGetFieldSelect("ap_periodicidad");
    var var_ap_dias_vigencia = scAjaxGetFieldText("ap_dias_vigencia");
    var var_ap_emite_asiento = scAjaxGetFieldCheckbox("ap_emite_asiento", ";");
    var var_ap_estado = scAjaxGetFieldSelect("ap_estado");
    var var_ap_contrato = scAjaxGetFieldCheckbox("ap_contrato", ";");
    var var_ap_servicio = scAjaxGetFieldCheckbox("ap_servicio", ";");
    var var_ap_personalizada = scAjaxGetFieldCheckbox("ap_personalizada", ";");
    var var_ap_libre = scAjaxGetFieldCheckbox("ap_libre", ";");
    var var_ap_reconexion = scAjaxGetFieldCheckbox("ap_reconexion", ";");
    var var_ap_materiales = scAjaxGetFieldCheckbox("ap_materiales", ";");
    ...
    scAjaxProcOn();
    x_ajax_form_jap_aportaciones_mob_submit_form(var_ap_id, var_ap_descripcion, var_ap_tipo_cartera, var_ap_tipo_comprobante, var_ap_periodicidad, var_ap_dias_vigencia, var_ap_emite_asiento, var_ap_estado, var_ap_contrato, var_ap_servicio, var_ap_personalizada, var_ap_libre, var_ap_reconexion, var_ap_materiales, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_jap_aportaciones_mob_submit_form_cb);
  } // do_ajax_form_jap_aportaciones_mob_submit_form

  function do_ajax_form_jap_aportaciones_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("ap_id");
      scAjaxHideErrorDisplay("ap_descripcion");
      scAjaxHideErrorDisplay("ap_tipo_cartera");
      scAjaxHideErrorDisplay("ap_tipo_comprobante");
      scAjaxHideErrorDisplay("ap_periodicidad");
      scAjaxHideErrorDisplay("ap_dias_vigencia");
      scAjaxHideErrorDisplay("ap_emite_asiento");
      scAjaxHideErrorDisplay("ap_estado");
      scAjaxHideErrorDisplay("ap_contrato");
      scAjaxHideErrorDisplay("ap_servicio");
      scAjaxHideErrorDisplay("ap_personalizada");
      scAjaxHideErrorDisplay("ap_libre");
      scAjaxHideErrorDisplay("ap_reconexion");
      scAjaxHideErrorDisplay("ap_materiales");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_jap_aportaciones_mob_submit_form_cb_after_alert);
  } // do_ajax_form_jap_aportaciones_mob_submit_form_cb
  function do_ajax_form_jap_aportaciones_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_jap_aportaciones_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_jap_productos_aportacion_mob"] = "off";

  function do_ajax_form_jap_aportaciones_mob_navigate_form()
  {
    perform_ajax_form_jap_aportaciones_mob_navigate_form();
  }

  function perform_ajax_form_jap_aportaciones_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("ap_materiales");
    scAjaxHideErrorDisplay("productos");
    var var_ap_id = document.F2.ap_id.value;
    ...
    scAjaxProcOn();
    scStatusDetail["form_jap_productos_aportacion_mob"] = "on";
    x_ajax_form_jap_aportaciones_mob_navigate_form(var_ap_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jap_aportaciones_mob_navigate_form_cb);
  } // do_ajax_form_jap_aportaciones_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_aportaciones_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_jap_aportaciones_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.ap_id.value = scAjaxGetKeyValue("ap_id");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_jap_productos_aportacion_mob"] && "nmsc_iframe_liga_form_jap_productos_aportacion_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_jap_productos_aportacion_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_jap_productos_aportacion_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_jap_productos_aportacion_mob').contentWindow.nm_move('apl_detalhe', true, '400');
        document.getElementById('nmsc_iframe_liga_form_jap_productos_aportacion_mob').style.height = "400";
        document.getElementById('nmsc_iframe_liga_form_jap_productos_aportacion_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_jap_aportaciones_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_jap_aportaciones_mob_navigate_form_cb
  function do_ajax_form_jap_aportaciones_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_jap_aportaciones_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_jap_aportaciones_mob_navigate_form_cb_after_alert

  function sc_hide_form_jap_aportaciones_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_jap_productos_aportacion_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "ap_id";
  ajax_field_list[1] = "ap_descripcion";
  ajax_field_list[2] = "ap_tipo_cartera";
  ajax_field_list[3] = "ap_tipo_comprobante";
  ajax_field_list[4] = "ap_periodicidad";
  ajax_field_list[5] = "ap_dias_vigencia";
  ajax_field_list[6] = "ap_emite_asiento";
  ajax_field_list[7] = "ap_estado";
  ajax_field_list[8] = "ap_contrato";
  ajax_field_list[9] = "ap_servicio";
  ajax_field_list[10] = "ap_personalizada";
  ajax_field_list[11] = "ap_libre";
  ajax_field_list[12] = "ap_reconexion";
  ajax_field_list[13] = "ap_materiales";
  ajax_field_list[14] = "productos";
  ...
  var ajax_error_list = {
    "ap_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ap_descripcion": {"label": "<?php echo $this->Ini->Nm_lang['lang_descripcion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ap_tipo_cartera": {"label": "<?php echo $this->Ini->Nm_lang['lang_tipo_cartera'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ap_tipo_comprobante": {"label": "<?php echo $this->Ini->Nm_lang['lang_tipo_comprobante'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ap_periodicidad": {"label": "<?php echo $this->Ini->Nm_lang['lang_periodicidad_aportes'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ap_dias_vigencia": {"label": "<?php echo $this->Ini->Nm_lang['lang_dias_vigencia'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ap_emite_asiento": {"label": "<?php echo $this->Ini->Nm_lang['lang_emite_asiento'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ap_estado": {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ap_contrato": {"label": "<?php echo $this->Ini->Nm_lang['lang_contrato'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ap_servicio": {"label": "<?php echo $this->Ini->Nm_lang['lang_servicio_mensual'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ap_personalizada": {"label": "<?php echo $this->Ini->Nm_lang['lang_otras_emisiones'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ap_libre": {"label": "<?php echo $this->Ini->Nm_lang['lang_personalizada'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ap_reconexion": {"label": "<?php echo $this->Ini->Nm_lang['lang_reconexion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ap_materiales": {"label": "<?php echo $this->Ini->Nm_lang['lang_materiales'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "productos": {"label": "<?php echo $this->Ini->Nm_lang['lang_productos'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "ap_id": new Array(),
    "ap_descripcion": new Array(),
    "ap_tipo_cartera": new Array(),
    "ap_tipo_comprobante": new Array(),
    "ap_periodicidad": new Array(),
    "ap_dias_vigencia": new Array(),
    "ap_emite_asiento": new Array(),
    "ap_estado": new Array(),
    "ap_contrato": new Array(),
    "ap_servicio": new Array(),
    "ap_personalizada": new Array(),
    "ap_libre": new Array(),
    "ap_reconexion": new Array(),
    "ap_materiales": new Array(),
    "productos": new Array()
  };
  ajax_field_mult["ap_id"][1] = "ap_id";
  ajax_field_mult["ap_descripcion"][1] = "ap_descripcion";
  ajax_field_mult["ap_tipo_cartera"][1] = "ap_tipo_cartera";
  ajax_field_mult["ap_tipo_comprobante"][1] = "ap_tipo_comprobante";
  ajax_field_mult["ap_periodicidad"][1] = "ap_periodicidad";
  ajax_field_mult["ap_dias_vigencia"][1] = "ap_dias_vigencia";
  ajax_field_mult["ap_emite_asiento"][1] = "ap_emite_asiento";
  ajax_field_mult["ap_estado"][1] = "ap_estado";
  ajax_field_mult["ap_contrato"][1] = "ap_contrato";
  ajax_field_mult["ap_servicio"][1] = "ap_servicio";
  ajax_field_mult["ap_personalizada"][1] = "ap_personalizada";
  ajax_field_mult["ap_libre"][1] = "ap_libre";
  ajax_field_mult["ap_reconexion"][1] = "ap_reconexion";
  ajax_field_mult["ap_materiales"][1] = "ap_materiales";
  ajax_field_mult["productos"][1] = "productos";

  var ajax_field_id = {
    "ap_id": new Array("hidden_field_label_ap_id", "hidden_field_data_ap_id"),
    "ap_descripcion": new Array("hidden_field_label_ap_descripcion", "hidden_field_data_ap_descripcion"),
    "ap_tipo_cartera": new Array("hidden_field_label_ap_tipo_cartera", "hidden_field_data_ap_tipo_cartera"),
    "ap_tipo_comprobante": new Array("hidden_field_label_ap_tipo_comprobante", "hidden_field_data_ap_tipo_comprobante"),
    "ap_periodicidad": new Array("hidden_field_label_ap_periodicidad", "hidden_field_data_ap_periodicidad"),
    "ap_dias_vigencia": new Array("hidden_field_label_ap_dias_vigencia", "hidden_field_data_ap_dias_vigencia"),
    "ap_emite_asiento": new Array("hidden_field_label_ap_emite_asiento", "hidden_field_data_ap_emite_asiento"),
    "ap_estado": new Array("hidden_field_label_ap_estado", "hidden_field_data_ap_estado"),
    "ap_contrato": new Array("hidden_field_label_ap_contrato", "hidden_field_data_ap_contrato"),
    "ap_servicio": new Array("hidden_field_label_ap_servicio", "hidden_field_data_ap_servicio"),
    "ap_personalizada": new Array("hidden_field_label_ap_personalizada", "hidden_field_data_ap_personalizada"),
    "ap_libre": new Array("hidden_field_label_ap_libre", "hidden_field_data_ap_libre"),
    "ap_reconexion": new Array("hidden_field_label_ap_reconexion", "hidden_field_data_ap_reconexion"),
    "ap_materiales": new Array("hidden_field_label_ap_materiales", "hidden_field_data_ap_materiales"),
  ...
  var ajax_read_only = {
    ...
    "ap_descripcion": "off",
    "ap_tipo_cartera": "off",
    "ap_tipo_comprobante": "off",
    "ap_periodicidad": "off",
    "ap_dias_vigencia": "off",
    "ap_emite_asiento": "off",
    "ap_estado": "off",
    "ap_contrato": "off",
    "ap_servicio": "off",
    "ap_personalizada": "off",
    "ap_libre": "off",
    "ap_reconexion": "off",
    "ap_materiales": "off",
    "productos": "off"
