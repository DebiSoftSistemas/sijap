  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_jap_aportaciones" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_jap_aportaciones_form();
	}
...
?>
  ...
  // ---------- Validate ap_id
  function do_ajax_form_jap_aportaciones_validate_ap_id()
  {
    var nomeCampo_ap_id = "ap_id";
    var var_ap_id = scAjaxGetFieldHidden(nomeCampo_ap_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_aportaciones_validate_ap_id(var_ap_id, var_script_case_init, do_ajax_form_jap_aportaciones_validate_ap_id_cb);
  } // do_ajax_form_jap_aportaciones_validate_ap_id

  function do_ajax_form_jap_aportaciones_validate_ap_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_aportaciones_validate_ap_id_cb

  // ---------- Validate ap_descripcion
  function do_ajax_form_jap_aportaciones_validate_ap_descripcion()
  {
    var nomeCampo_ap_descripcion = "ap_descripcion";
    var var_ap_descripcion = scAjaxGetFieldText(nomeCampo_ap_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_aportaciones_validate_ap_descripcion(var_ap_descripcion, var_script_case_init, do_ajax_form_jap_aportaciones_validate_ap_descripcion_cb);
  } // do_ajax_form_jap_aportaciones_validate_ap_descripcion

  function do_ajax_form_jap_aportaciones_validate_ap_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_aportaciones_validate_ap_descripcion_cb

  // ---------- Validate ap_tipo_cartera
  function do_ajax_form_jap_aportaciones_validate_ap_tipo_cartera()
  {
    var nomeCampo_ap_tipo_cartera = "ap_tipo_cartera";
    var var_ap_tipo_cartera = scAjaxGetFieldSelect(nomeCampo_ap_tipo_cartera);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_aportaciones_validate_ap_tipo_cartera(var_ap_tipo_cartera, var_script_case_init, do_ajax_form_jap_aportaciones_validate_ap_tipo_cartera_cb);
  } // do_ajax_form_jap_aportaciones_validate_ap_tipo_cartera

  function do_ajax_form_jap_aportaciones_validate_ap_tipo_cartera_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_aportaciones_validate_ap_tipo_cartera_cb

  // ---------- Validate ap_tipo_comprobante
  function do_ajax_form_jap_aportaciones_validate_ap_tipo_comprobante()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_aportaciones_validate_ap_tipo_comprobante(var_ap_tipo_comprobante, var_script_case_init, do_ajax_form_jap_aportaciones_validate_ap_tipo_comprobante_cb);
  } // do_ajax_form_jap_aportaciones_validate_ap_tipo_comprobante

  function do_ajax_form_jap_aportaciones_validate_ap_tipo_comprobante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_aportaciones_validate_ap_tipo_comprobante_cb

  // ---------- Validate ap_periodicidad
  function do_ajax_form_jap_aportaciones_validate_ap_periodicidad()
  {
    var nomeCampo_ap_periodicidad = "ap_periodicidad";
    var var_ap_periodicidad = scAjaxGetFieldSelect(nomeCampo_ap_periodicidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_aportaciones_validate_ap_periodicidad(var_ap_periodicidad, var_script_case_init, do_ajax_form_jap_aportaciones_validate_ap_periodicidad_cb);
  } // do_ajax_form_jap_aportaciones_validate_ap_periodicidad

  function do_ajax_form_jap_aportaciones_validate_ap_periodicidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_aportaciones_validate_ap_periodicidad_cb

  // ---------- Validate ap_dias_vigencia
  function do_ajax_form_jap_aportaciones_validate_ap_dias_vigencia()
  {
    var nomeCampo_ap_dias_vigencia = "ap_dias_vigencia";
    var var_ap_dias_vigencia = scAjaxGetFieldText(nomeCampo_ap_dias_vigencia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_aportaciones_validate_ap_dias_vigencia(var_ap_dias_vigencia, var_script_case_init, do_ajax_form_jap_aportaciones_validate_ap_dias_vigencia_cb);
  } // do_ajax_form_jap_aportaciones_validate_ap_dias_vigencia

  function do_ajax_form_jap_aportaciones_validate_ap_dias_vigencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_aportaciones_validate_ap_dias_vigencia_cb

  // ---------- Validate ap_emite_asiento
  function do_ajax_form_jap_aportaciones_validate_ap_emite_asiento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_aportaciones_validate_ap_emite_asiento(var_ap_emite_asiento, var_script_case_init, do_ajax_form_jap_aportaciones_validate_ap_emite_asiento_cb);
  } // do_ajax_form_jap_aportaciones_validate_ap_emite_asiento

  function do_ajax_form_jap_aportaciones_validate_ap_emite_asiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_aportaciones_validate_ap_emite_asiento_cb

  // ---------- Validate ap_estado
  function do_ajax_form_jap_aportaciones_validate_ap_estado()
  {
    var nomeCampo_ap_estado = "ap_estado";
    var var_ap_estado = scAjaxGetFieldSelect(nomeCampo_ap_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_aportaciones_validate_ap_estado(var_ap_estado, var_script_case_init, do_ajax_form_jap_aportaciones_validate_ap_estado_cb);
  } // do_ajax_form_jap_aportaciones_validate_ap_estado

  function do_ajax_form_jap_aportaciones_validate_ap_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_aportaciones_validate_ap_estado_cb

  // ---------- Validate ap_contrato
  function do_ajax_form_jap_aportaciones_validate_ap_contrato()
  {
    var nomeCampo_ap_contrato = "ap_contrato";
    var var_ap_contrato = scAjaxGetFieldCheckbox(nomeCampo_ap_contrato, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_aportaciones_validate_ap_contrato(var_ap_contrato, var_script_case_init, do_ajax_form_jap_aportaciones_validate_ap_contrato_cb);
  } // do_ajax_form_jap_aportaciones_validate_ap_contrato

  function do_ajax_form_jap_aportaciones_validate_ap_contrato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_aportaciones_validate_ap_contrato_cb

  // ---------- Validate ap_servicio
  function do_ajax_form_jap_aportaciones_validate_ap_servicio()
  {
    var nomeCampo_ap_servicio = "ap_servicio";
    var var_ap_servicio = scAjaxGetFieldCheckbox(nomeCampo_ap_servicio, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_aportaciones_validate_ap_servicio(var_ap_servicio, var_script_case_init, do_ajax_form_jap_aportaciones_validate_ap_servicio_cb);
  } // do_ajax_form_jap_aportaciones_validate_ap_servicio

  function do_ajax_form_jap_aportaciones_validate_ap_servicio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_aportaciones_validate_ap_servicio_cb

  // ---------- Validate ap_personalizada
  function do_ajax_form_jap_aportaciones_validate_ap_personalizada()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_aportaciones_validate_ap_personalizada(var_ap_personalizada, var_script_case_init, do_ajax_form_jap_aportaciones_validate_ap_personalizada_cb);
  } // do_ajax_form_jap_aportaciones_validate_ap_personalizada

  function do_ajax_form_jap_aportaciones_validate_ap_personalizada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_aportaciones_validate_ap_personalizada_cb

  // ---------- Validate ap_libre
  function do_ajax_form_jap_aportaciones_validate_ap_libre()
  {
    var nomeCampo_ap_libre = "ap_libre";
    var var_ap_libre = scAjaxGetFieldCheckbox(nomeCampo_ap_libre, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_aportaciones_validate_ap_libre(var_ap_libre, var_script_case_init, do_ajax_form_jap_aportaciones_validate_ap_libre_cb);
  } // do_ajax_form_jap_aportaciones_validate_ap_libre

  function do_ajax_form_jap_aportaciones_validate_ap_libre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_aportaciones_validate_ap_libre_cb

  // ---------- Validate ap_reconexion
  function do_ajax_form_jap_aportaciones_validate_ap_reconexion()
  {
    var nomeCampo_ap_reconexion = "ap_reconexion";
    var var_ap_reconexion = scAjaxGetFieldCheckbox(nomeCampo_ap_reconexion, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_aportaciones_validate_ap_reconexion(var_ap_reconexion, var_script_case_init, do_ajax_form_jap_aportaciones_validate_ap_reconexion_cb);
  } // do_ajax_form_jap_aportaciones_validate_ap_reconexion

  function do_ajax_form_jap_aportaciones_validate_ap_reconexion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_aportaciones_validate_ap_reconexion_cb

  // ---------- Validate ap_materiales
  function do_ajax_form_jap_aportaciones_validate_ap_materiales()
  {
    var nomeCampo_ap_materiales = "ap_materiales";
    var var_ap_materiales = scAjaxGetFieldCheckbox(nomeCampo_ap_materiales, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_aportaciones_validate_ap_materiales(var_ap_materiales, var_script_case_init, do_ajax_form_jap_aportaciones_validate_ap_materiales_cb);
  } // do_ajax_form_jap_aportaciones_validate_ap_materiales

  function do_ajax_form_jap_aportaciones_validate_ap_materiales_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_aportaciones_validate_ap_materiales_cb

  // ---------- Validate productos
  function do_ajax_form_jap_aportaciones_validate_productos()
  {
    var nomeCampo_productos = "productos";
    var var_productos = scAjaxGetFieldText(nomeCampo_productos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_aportaciones_validate_productos(var_productos, var_script_case_init, do_ajax_form_jap_aportaciones_validate_productos_cb);
  } // do_ajax_form_jap_aportaciones_validate_productos

  function do_ajax_form_jap_aportaciones_validate_productos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_aportaciones_validate_productos_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_jap_aportaciones_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_jap_aportaciones_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_jap_aportaciones_submit_form(var_ap_id, var_ap_descripcion, var_ap_tipo_cartera, var_ap_tipo_comprobante, var_ap_periodicidad, var_ap_dias_vigencia, var_ap_emite_asiento, var_ap_estado, var_ap_contrato, var_ap_servicio, var_ap_personalizada, var_ap_libre, var_ap_reconexion, var_ap_materiales, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_jap_aportaciones_submit_form_cb);
  } // do_ajax_form_jap_aportaciones_submit_form

  function do_ajax_form_jap_aportaciones_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_jap_aportaciones_submit_form_cb_after_alert);
  } // do_ajax_form_jap_aportaciones_submit_form_cb
  function do_ajax_form_jap_aportaciones_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_jap_aportaciones_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_jap_productos_aportacion"] = "off";

  function do_ajax_form_jap_aportaciones_navigate_form()
  {
    perform_ajax_form_jap_aportaciones_navigate_form();
  }

  function perform_ajax_form_jap_aportaciones_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_jap_productos_aportacion"] = "on";
    x_ajax_form_jap_aportaciones_navigate_form(var_ap_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jap_aportaciones_navigate_form_cb);
  } // do_ajax_form_jap_aportaciones_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_aportaciones']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_jap_aportaciones_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_jap_productos_aportacion"] && "nmsc_iframe_liga_form_jap_productos_aportacion" != scMasterDetailIframe["nmsc_iframe_liga_form_jap_productos_aportacion"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_jap_productos_aportacion"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_jap_productos_aportacion').contentWindow.nm_move('apl_detalhe', true, '400');
        document.getElementById('nmsc_iframe_liga_form_jap_productos_aportacion').style.height = "400";
        document.getElementById('nmsc_iframe_liga_form_jap_productos_aportacion').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_jap_aportaciones_navigate_form_cb_after_alert);
  } // do_ajax_form_jap_aportaciones_navigate_form_cb
  function do_ajax_form_jap_aportaciones_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_jap_aportaciones_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_jap_aportaciones_navigate_form_cb_after_alert

  function sc_hide_form_jap_aportaciones_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_jap_productos_aportacion"])
    {
      return true;
    }
    return false;
