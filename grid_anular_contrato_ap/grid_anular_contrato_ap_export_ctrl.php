<?php
@session_start() ;
$_SESSION['scriptcase']['grid_anular_contrato_ap']['sc_process_barr'] = true;
require_once('../grid_anular_contrato_ap/index.php');
unset($_SESSION['scriptcase']['grid_anular_contrato_ap']['sc_process_barr']);
$ExportCtrl = new grid_anular_contrato_ap_export_control;
$ExportCtrl->Export_barr();

class grid_anular_contrato_ap_export_control
{
