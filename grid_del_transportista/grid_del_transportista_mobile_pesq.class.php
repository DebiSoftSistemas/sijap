...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "tr_id";$Nm_numeric[] = "tr_pais";$Nm_numeric[] = "tr_provincia";$Nm_numeric[] = "tr_ciudad";$Nm_numeric[] = "tr_id";$Nm_numeric[] = "tr_pais";$Nm_numeric[] = "tr_provincia";$Nm_numeric[] = "tr_ciudad";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_tr_nombre"  <?php echo $str_hide_tr_nombre?>><INPUT  type="text" id="SC_tr_nombre" name="tr_nombre" value="<?php echo NM_encode_input($tr_nombre) ?>"  size=50 alt="{datatype: 'text', maxLength: 300, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_tr_identificacion"  <?php echo $str_hide_tr_identificacion?>><INPUT  type="text" id="SC_tr_identificacion" name="tr_identificacion" value="<?php echo NM_encode_input($tr_identificacion) ?>"  size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_tr_placa"  <?php echo $str_hide_tr_placa?>><INPUT  type="text" id="SC_tr_placa" name="tr_placa" value="<?php echo NM_encode_input($tr_placa) ?>"  size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
