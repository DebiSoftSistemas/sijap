...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_del_transportista"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_del_transportista"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_del_transportista'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_del_transportista']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_del_transportista']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_del_transportista']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_del_transportista']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_del_transportista']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_del_transportista</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_del_transportista']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_del_transportista']['embutida_filho'] as $ind => $sc_init)
          {
