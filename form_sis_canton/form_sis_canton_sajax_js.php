...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    ajax_error_list["can_nombre_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_canton'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
