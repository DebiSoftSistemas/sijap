...
?>
  ...
  var ajax_error_list = {
    ...
    "can_nombre_": {"label": "<?php echo $this->Ini->Nm_lang['lang_canton'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
