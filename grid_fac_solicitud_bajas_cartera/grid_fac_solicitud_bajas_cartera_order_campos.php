...
<?php
   ...
   $Ord_Cmp = new grid_fac_solicitud_bajas_cartera_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_fac_solicitud_bajas_cartera_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_bajas_cartera']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_bajas_cartera']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['sbc_id'] = "sbc_id";
   $tab_labels["sbc_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_bajas_cartera']['labels']["sbc_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_bajas_cartera']['labels']["sbc_id"] : "" . $this->Nm_lang['lang_id'] . "";
   $tab_ger_campos['sbc_fecha'] = "on";
   $tab_def_campos['sbc_fecha'] = "sbc_fecha";
   $tab_labels["sbc_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_bajas_cartera']['labels']["sbc_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_bajas_cartera']['labels']["sbc_fecha"] : "" . $this->Nm_lang['lang_fecha'] . "";
   $tab_ger_campos['sbc_anio_baja'] = "on";
   $tab_def_campos['sbc_anio_baja'] = "sbc_anio_baja";
   $tab_labels["sbc_anio_baja"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_bajas_cartera']['labels']["sbc_anio_baja"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_bajas_cartera']['labels']["sbc_anio_baja"] : "" . $this->Nm_lang['lang_srch_year'] . "";
   $tab_ger_campos['sbc_motivo_anulacion'] = "on";
   $tab_def_campos['sbc_motivo_anulacion'] = "sbc_motivo_anulacion";
   $tab_labels["sbc_motivo_anulacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_bajas_cartera']['labels']["sbc_motivo_anulacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_bajas_cartera']['labels']["sbc_motivo_anulacion"] : "" . $this->Nm_lang['lang_motivo_anulacion'] . "";
   $tab_ger_campos['sbc_estado'] = "on";
   $tab_def_campos['sbc_estado'] = "sbc_estado";
   $tab_labels["sbc_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_bajas_cartera']['labels']["sbc_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_bajas_cartera']['labels']["sbc_estado"] : "" . $this->Nm_lang['lang_estado'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_bajas_cartera']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_bajas_cartera']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_bajas_cartera']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_bajas_cartera']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_bajas_cartera']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_bajas_cartera']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_bajas_cartera']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_bajas_cartera']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_bajas_cartera']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_bajas_cartera']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_bajas_cartera']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_bajas_cartera']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_fac_solicitud_bajas_cartera_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_bajas_cartera']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_bajas_cartera']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_bajas_cartera']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_bajas_cartera']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_bajas_cartera']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
