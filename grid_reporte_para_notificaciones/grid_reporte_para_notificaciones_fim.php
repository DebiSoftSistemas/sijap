...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_reporte_para_notificaciones"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_reporte_para_notificaciones"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_reporte_para_notificaciones']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_reporte_para_notificaciones']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_reporte_para_notificaciones']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_reporte_para_notificaciones']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_reporte_para_notificaciones']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_reporte_para_notificaciones</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_reporte_para_notificaciones']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_reporte_para_notificaciones']['embutida_filho'] as $ind => $sc_init)
          {
