...
class grid_reporte_para_notificaciones_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_reporte_para_notificaciones_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_reporte_para_notificaciones_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_reporte_para_notificaciones_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "op_propietario";$Nm_numeric[] = "op_contrato";$Nm_numeric[] = "meses_deuda";$Nm_numeric[] = "con_ruta";$Nm_numeric[] = "total_deuda";$Nm_numeric[] = "rc_orden";$Nm_numeric[] = "con_comunidad";$Nm_numeric[] = "con_sector";$Nm_numeric[] = "con_tipo_servicio";
      $campo_join = strtolower(str_replace(".", "_", $nome));
      if (in_array($campo_join, $Nm_numeric))
      {
          if ($condicao == "EP" || $condicao == "NE")
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$campo_join]);
              return;
          }
         $nm_ini_lower = "";
         $nm_fim_lower = "";
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         $nome_sum = "v_fac_cantidad_productos_deudas.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_reporte_para_notificaciones'] ?></TITLE>
...
<?php
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['orig_pesq'] == "res")  
    { 
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_reporte_para_notificaciones/grid_reporte_para_notificaciones_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_reporte_para_notificaciones_ajax_search.js"></script>
 <script type="text/javascript" src="grid_reporte_para_notificaciones_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_reporte_para_notificaciones_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_reporte_para_notificaciones']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_reporte_para_notificaciones']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_con_ruta#NMF#' + search_get_select('SC_con_ruta') + '@NMF@';
  str_out += 'SC_meses_deuda_cond#NMF#' + search_get_sel_txt('SC_meses_deuda_cond') + '@NMF@';
  str_out += 'SC_meses_deuda#NMF#' + search_get_text('SC_meses_deuda') + '@NMF@';
  str_out += 'SC_con_numero_contrato_cond#NMF#' + search_get_sel_txt('SC_con_numero_contrato_cond') + '@NMF@';
  str_out += 'SC_con_numero_contrato#NMF#' + search_get_select('SC_con_numero_contrato') + '@NMF@';
...
<TABLE id="main_table" align="center" valign="top" width="50%">
<tr>
<td>
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
          $meses_deuda = "3";
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $con_ruta = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['campos_busca']['con_ruta']; 
          $con_ruta_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['campos_busca']['con_ruta_cond']; 
          $meses_deuda = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['campos_busca']['meses_deuda']; 
          $meses_deuda_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['campos_busca']['meses_deuda_cond']; 
          $con_numero_contrato = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['campos_busca']['con_numero_contrato']; 
          $con_numero_contrato_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['campos_busca']['con_numero_contrato_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['campos_busca']['NM_operador']; 
          if (strtoupper($meses_deuda_cond) != "II" && strtoupper($meses_deuda_cond) != "QP" && strtoupper($meses_deuda_cond) != "NP" && strtoupper($meses_deuda_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($meses_deuda, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      ...
      if (!isset($meses_deuda_cond) || empty($meses_deuda_cond))
      {
         $meses_deuda_cond = "ge";
      }
      ...
      $str_hide_meses_deuda = (in_array($meses_deuda_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      if (isset($con_ruta) && !empty($con_ruta))
      {
      ...
      if (!isset($meses_deuda) || $meses_deuda == "")
      {
          $meses_deuda = "";
      }
      if (isset($meses_deuda) && !empty($meses_deuda))
      {
...
?>
   <span id="idAjaxSelect_con_ruta">
      <SELECT class="scFilterObjectOdd" id="SC_con_ruta" name="con_ruta"  size="1">
...
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $con_ruta)
            {
                    $con_ruta_sel = ($nm_opc_cod === $con_ruta) ? "selected" : "";
            }
            else
            {
...
?>
      ...
      <TD id='SC_meses_deuda_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['meses_deuda'])) ? $this->New_label['meses_deuda'] : "Meses Deuda"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_meses_deuda_cond" name="meses_deuda_cond" onChange="nm_campos_between(document.getElementById('id_vis_meses_deuda'), this, 'meses_deuda')">
       <OPTION value="ge" <?php if ("ge" == $meses_deuda_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr_equl'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $meses_deuda_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="le" <?php if ("le" == $meses_deuda_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less_equl'] ?></OPTION>
       <OPTION value="gt" <?php if ("gt" == $meses_deuda_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $meses_deuda_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_meses_deuda" <?php echo $str_hide_meses_deuda?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['meses_deuda'])) ? $this->New_label['meses_deuda'] : "Meses Deuda";
 $nmgp_tab_label .= "meses_deuda?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_meses_deuda" name="meses_deuda" value="<?php echo NM_encode_input($meses_deuda) ?>" size=17 alt="{datatype: 'integer', maxLength: 17, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
?>
   <span id="idAjaxSelect_con_numero_contrato">
      <SELECT class="scFilterObjectOdd" id="SC_con_numero_contrato" name="con_numero_contrato"  size="1">
       <OPTION value=""><?php echo $this->Ini->Nm_lang['lang_seleccione'] ?></OPTION>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            {
                    $con_numero_contrato_sel = ($nm_opc_cod === $con_numero_contrato) ? "selected" : "";
            }
            else
            {
            ...
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $con_numero_contrato_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_reporte_para_notificaciones_help.txt"))
   {
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bsair", "self.parent.tb_remove();", "self.parent.tb_remove();", "sc_b_cancel_bot", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + Q)", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
?>
    </td>
   </tr></table>
<?php
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.con_ruta.value = "";
   document.F1.meses_deuda_cond.value = 'ge';
   nm_campos_between(document.getElementById('id_vis_meses_deuda'), document.F1.meses_deuda_cond, 'meses_deuda');
   document.F1.meses_deuda.value = "3";
 ...
 {
    if (Field == 'all' || Field == 'con_numero_contrato') {
       Sc_carga_select2_con_numero_contrato();
    }
    if (Field == 'all' || Field == 'con_ruta') {
       Sc_carga_select2_con_ruta();
    }
 }
 function Sc_carga_select2_con_numero_contrato()
 {
  $("#SC_con_numero_contrato").select2(
    {
      language: {
        noResults: function() {
 ...
 function Sc_carga_select2_con_ruta()
 {
  $("#SC_con_ruta").select2(
    {
      language: {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_reporte_para_notificaciones/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_con_ruta'] = 'select';
      $tp_fields['SC_meses_deuda_cond'] = 'cond';
      $tp_fields['SC_meses_deuda'] = 'text';
      $tp_fields['SC_con_numero_contrato_cond'] = 'cond';
      $tp_fields['SC_con_numero_contrato'] = 'select';
   ...
   function trata_campos()
   {
      global $con_ruta_cond, $con_ruta,
             $meses_deuda_cond, $meses_deuda,
             $con_numero_contrato_cond, $con_numero_contrato, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $meses_deuda_cond_salva = $meses_deuda_cond; 
      if (!isset($meses_deuda_input_2) || $meses_deuda_input_2 == "")
      {
          $meses_deuda_input_2 = $meses_deuda;
      }
      ...
      if ($tmp_pos === false) {
          ...
          $L_lookup = substr($con_ruta, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['psq_check_ret']['con_ruta'])) {
      ...
      if ($meses_deuda_cond != "in")
      {
          nm_limpa_numero($meses_deuda, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $tmp_pos = (is_string($con_numero_contrato)) ? strpos($con_numero_contrato, "##@@") : false;
      if ($tmp_pos === false) {
          $L_lookup = $con_numero_contrato;
      }
      else {
          $L_lookup = substr($con_numero_contrato, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['psq_check_ret']['con_numero_contrato'])) {
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['campos_busca']['con_ruta'] = $con_ruta; 
      if (is_array($con_ruta) && !empty($con_ruta))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['Grid_search'][$I_Grid]['val'][0] = $con_ruta;
      }
      elseif ($con_ruta_cond_salva == "nu" || $con_ruta_cond_salva == "nn" || $con_ruta_cond_salva == "ep" || $con_ruta_cond_salva == "ne" || !empty($con_ruta))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['Grid_search'][$I_Grid]['val'][0][0] = $con_ruta;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['campos_busca']['con_ruta_cond'] = $con_ruta_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['Grid_search'][$I_Grid]['cmp'] = "con_ruta"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['Grid_search'][$I_Grid]['opc'] = $con_ruta_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq']['con_ruta'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['campos_busca']['meses_deuda'] = $meses_deuda; 
      if (is_array($meses_deuda) && !empty($meses_deuda))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['Grid_search'][$I_Grid]['val'][0] = $meses_deuda;
      }
      elseif ($meses_deuda_cond_salva == "nu" || $meses_deuda_cond_salva == "nn" || $meses_deuda_cond_salva == "ep" || $meses_deuda_cond_salva == "ne" || !empty($meses_deuda))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['Grid_search'][$I_Grid]['val'][0][0] = $meses_deuda;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['campos_busca']['meses_deuda_cond'] = $meses_deuda_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['Grid_search'][$I_Grid]['cmp'] = "meses_deuda"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['Grid_search'][$I_Grid]['opc'] = $meses_deuda_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq']['meses_deuda'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['campos_busca']['con_numero_contrato'] = $con_numero_contrato; 
      if (is_array($con_numero_contrato) && !empty($con_numero_contrato))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['Grid_search'][$I_Grid]['val'][0] = $con_numero_contrato;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['Grid_search'][$I_Grid]['val'][0][0] = $con_numero_contrato;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['campos_busca']['con_numero_contrato_cond'] = $con_numero_contrato_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['Grid_search'][$I_Grid]['cmp'] = "con_numero_contrato"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['Grid_search'][$I_Grid]['opc'] = $con_numero_contrato_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['grid_pesq']['con_numero_contrato'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $this->cmp_formatado['con_ruta'] = $Conteudo;
      $Conteudo = $meses_deuda;
      if (strtoupper($meses_deuda_cond) != "II" && strtoupper($meses_deuda_cond) != "QP" && strtoupper($meses_deuda_cond) != "NP" && strtoupper($meses_deuda_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['meses_deuda'] = $Conteudo;
      ...
      if (isset($con_ruta))
      {
         $this->monta_condicao("con_ruta", $con_ruta_cond, $con_ruta, "", "con_ruta", "INT4", true);
      }

      //----- $meses_deuda
      $this->Date_part = false;
      if (isset($meses_deuda) || $meses_deuda_cond == "nu" || $meses_deuda_cond == "nn" || $meses_deuda_cond == "ep" || $meses_deuda_cond == "ne")
      {
         $this->monta_condicao("meses_deuda", $meses_deuda_cond, $meses_deuda, "", "meses_deuda", "INT8", true);
      }

      //----- $con_numero_contrato
      $this->Date_part = false;
      if (isset($con_numero_contrato))
      {
         $this->monta_condicao("con_numero_contrato", $con_numero_contrato_cond, $con_numero_contrato, "", "con_numero_contrato", "VARCHAR", true);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
    $this->Sel_case_sensitive($this->comando);
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['where_pesq'] = $this->comando;
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['cond_dyn_search'] = "";
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['where_pesq_grid']    = $this->comando_filtro;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['cond_pesq'] .= $this->NM_operador;
...
?>
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         ...
         case "con_numero_contrato" : return ('class="scFilterObjectOdd"'); break;
         default       : return ("");
      }
   }
