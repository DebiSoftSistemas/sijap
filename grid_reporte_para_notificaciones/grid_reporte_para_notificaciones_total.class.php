...
class grid_reporte_para_notificaciones_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_reporte_para_notificaciones']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_reporte_para_notificaciones']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang , $con_ruta, $op_propietario, $con_comunidad, $con_sector, $con_tipo_servicio;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(total_deuda) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['where_pesq']; 
      } 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $rt->fields[1] = (string)$rt->fields[1]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['tot_geral'][2] = $rt->fields[1]; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['contr_total_geral'] = "OK";
   } 
   ...
   function quebra_con_ruta_sc_free_group_by($con_ruta, $Where_qb, $Cmp_Name) 
   {
      ...
      global $$Var_name_gb, $con_ruta, $op_propietario, $con_comunidad, $con_sector, $con_tipo_servicio;
      $tot_con_ruta = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(total_deuda) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_para_notificaciones']['where_pesq']; 
