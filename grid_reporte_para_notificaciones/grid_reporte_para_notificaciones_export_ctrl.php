<?php
@session_start() ;
$_SESSION['scriptcase']['grid_reporte_para_notificaciones']['sc_process_barr'] = true;
require_once('../grid_reporte_para_notificaciones/index.php');
unset($_SESSION['scriptcase']['grid_reporte_para_notificaciones']['sc_process_barr']);
$ExportCtrl = new grid_reporte_para_notificaciones_export_control;
$ExportCtrl->Export_barr();

class grid_reporte_para_notificaciones_export_control
{
