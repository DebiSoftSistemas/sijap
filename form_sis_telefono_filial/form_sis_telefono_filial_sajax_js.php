  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_telefono_filial" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sis_telefono_filial_form();
	}
...
?>
  ...
  // ---------- Validate tef_id_
  function do_ajax_form_sis_telefono_filial_validate_tef_id_(iNumLinha)
  {
    var nomeCampo_tef_id_ = "tef_id_" + iNumLinha;
    var var_tef_id_ = scAjaxGetFieldText(nomeCampo_tef_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_telefono_filial_validate_tef_id_(var_tef_id_, iNumLinha, var_script_case_init, do_ajax_form_sis_telefono_filial_validate_tef_id__cb);
  } // do_ajax_form_sis_telefono_filial_validate_tef_id_

  function do_ajax_form_sis_telefono_filial_validate_tef_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "tef_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tef_id_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "tef_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tef_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_telefono_filial_validate_tef_id__cb

  // ---------- Validate tef_filial_
  function do_ajax_form_sis_telefono_filial_validate_tef_filial_(iNumLinha)
  {
    var nomeCampo_tef_filial_ = "tef_filial_" + iNumLinha;
    var var_tef_filial_ = scAjaxGetFieldText(nomeCampo_tef_filial_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_telefono_filial_validate_tef_filial_(var_tef_filial_, iNumLinha, var_script_case_init, do_ajax_form_sis_telefono_filial_validate_tef_filial__cb);
  } // do_ajax_form_sis_telefono_filial_validate_tef_filial_

  function do_ajax_form_sis_telefono_filial_validate_tef_filial__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tef_filial_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tef_filial_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tef_filial_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tef_filial_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_telefono_filial_validate_tef_filial__cb

  // ---------- Validate tef_numero_
  function do_ajax_form_sis_telefono_filial_validate_tef_numero_(iNumLinha)
  {
    var nomeCampo_tef_numero_ = "tef_numero_" + iNumLinha;
    var var_tef_numero_ = scAjaxGetFieldText(nomeCampo_tef_numero_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_telefono_filial_validate_tef_numero_(var_tef_numero_, iNumLinha, var_script_case_init, do_ajax_form_sis_telefono_filial_validate_tef_numero__cb);
  } // do_ajax_form_sis_telefono_filial_validate_tef_numero_

  function do_ajax_form_sis_telefono_filial_validate_tef_numero__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tef_numero_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tef_numero_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tef_numero_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tef_numero_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_telefono_filial_validate_tef_numero__cb

  // ---------- Validate tef_tipo_
  function do_ajax_form_sis_telefono_filial_validate_tef_tipo_(iNumLinha)
  {
    var nomeCampo_tef_tipo_ = "tef_tipo_" + iNumLinha;
    var var_tef_tipo_ = scAjaxGetFieldText(nomeCampo_tef_tipo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_telefono_filial_validate_tef_tipo_(var_tef_tipo_, iNumLinha, var_script_case_init, do_ajax_form_sis_telefono_filial_validate_tef_tipo__cb);
  } // do_ajax_form_sis_telefono_filial_validate_tef_tipo_

  function do_ajax_form_sis_telefono_filial_validate_tef_tipo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tef_tipo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tef_tipo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tef_tipo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tef_tipo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_telefono_filial_validate_tef_tipo__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_sis_telefono_filial_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_sis_telefono_filial_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sis_telefono_filial_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_sis_telefono_filial_add_new_line_cb);
  } // do_ajax_form_sis_telefono_filial_add_new_line

  function do_ajax_form_sis_telefono_filial_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_sis_telefono_filial_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_sis_telefono_filial_backup_line(iNumLinha)
  {
    var var_tef_id_ = scAjaxGetFieldText("tef_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_telefono_filial_backup_line(var_tef_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_sis_telefono_filial_backup_line_cb);
  } // do_ajax_form_sis_telefono_filial_backup_line

  function do_ajax_form_sis_telefono_filial_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_sis_telefono_filial_backup_line_cb

  function do_ajax_form_sis_telefono_filial_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_sis_telefono_filial_cancel_insert

  function do_ajax_form_sis_telefono_filial_cancel_update(iSeqVert)
  {
    do_ajax_form_sis_telefono_filial_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_sis_telefono_filial_cancel_update

  function do_ajax_form_sis_telefono_filial_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_sis_telefono_filial_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_sis_telefono_filial_table_refresh()
  {
    var var_tef_id_ = document.F2.tef_id_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_sis_telefono_filial_table_refresh(var_tef_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_telefono_filial_table_refresh_cb);
  } //  do_ajax_form_sis_telefono_filial_table_refresh

  function do_ajax_form_sis_telefono_filial_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.tef_id_.value = scAjaxGetKeyValue("tef_id_");
    ...
    scAjaxAlert(do_ajax_form_sis_telefono_filial_table_refresh_cb_after_alert);
  } // do_ajax_form_sis_telefono_filial_table_refresh_cb
  function do_ajax_form_sis_telefono_filial_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_sis_telefono_filial_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_sis_telefono_filial_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_sis_telefono_filial_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_tef_id_ = scAjaxGetFieldText("tef_id_" + iNumLinha);
    var var_tef_filial_ = scAjaxGetFieldText("tef_filial_" + iNumLinha);
    var var_tef_numero_ = scAjaxGetFieldText("tef_numero_" + iNumLinha);
    var var_tef_tipo_ = scAjaxGetFieldText("tef_tipo_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_sis_telefono_filial_submit_form(var_tef_id_, var_tef_filial_, var_tef_numero_, var_tef_tipo_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_telefono_filial_submit_form_cb);
  } // do_ajax_form_sis_telefono_filial_submit_form

  function do_ajax_form_sis_telefono_filial_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("tef_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tef_filial_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tef_numero_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tef_tipo_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sis_telefono_filial_submit_form_cb_after_alert);
  } // do_ajax_form_sis_telefono_filial_submit_form_cb
  function do_ajax_form_sis_telefono_filial_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_telefono_filial_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sis_telefono_filial_navigate_form()
  {
    perform_ajax_form_sis_telefono_filial_navigate_form();
  }

  function perform_ajax_form_sis_telefono_filial_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_sis_telefono_filial_cancel_insert(sc_form_sis_telefono_filial_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("tef_id_" + iNavForm);
      scAjaxHideErrorDisplay("tef_filial_" + iNavForm);
      scAjaxHideErrorDisplay("tef_numero_" + iNavForm);
      scAjaxHideErrorDisplay("tef_tipo_" + iNavForm);
    }
    var var_tef_id_ = document.F2.tef_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sis_telefono_filial_navigate_form(var_tef_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_telefono_filial_navigate_form_cb);
  } // do_ajax_form_sis_telefono_filial_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_telefono_filial']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_telefono_filial_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.tef_id_.value = scAjaxGetKeyValue("tef_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_telefono_filial_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_telefono_filial_navigate_form_cb
  function do_ajax_form_sis_telefono_filial_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_sis_telefono_filial_navigate_form_cb_after_alert

    function sc_form_sis_telefono_filial_get_last_line_number()
    {
    ...
    } //sc_form_sis_telefono_filial_get_last_line_number

  function sc_hide_form_sis_telefono_filial_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "tef_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tef_filial_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tef_numero_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tef_tipo_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["tef_id_" + iNumLinha] = {"label": "Tef Id<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tef_filial_" + iNumLinha] = {"label": "Tef Filial<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tef_numero_" + iNumLinha] = {"label": "Tef Numero<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tef_tipo_" + iNumLinha] = {"label": "Tef Tipo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["tef_id_"][iNumLinha] = "tef_id_" + iNumLinha;
    ajax_field_mult["tef_filial_"][iNumLinha] = "tef_filial_" + iNumLinha;
    ajax_field_mult["tef_numero_"][iNumLinha] = "tef_numero_" + iNumLinha;
    ajax_field_mult["tef_tipo_"][iNumLinha] = "tef_tipo_" + iNumLinha;
    ajax_field_id["tef_id_" + iNumLinha] = new Array("hidden_field_label_tef_id_", "hidden_field_data_tef_id_" + iNumLinha);
    ajax_field_id["tef_filial_" + iNumLinha] = new Array("hidden_field_label_tef_filial_", "hidden_field_data_tef_filial_" + iNumLinha);
    ajax_field_id["tef_numero_" + iNumLinha] = new Array("hidden_field_label_tef_numero_", "hidden_field_data_tef_numero_" + iNumLinha);
    ajax_field_id["tef_tipo_" + iNumLinha] = new Array("hidden_field_label_tef_tipo_", "hidden_field_data_tef_tipo_" + iNumLinha);
    ajax_error_count["tef_id_" + iNumLinha] = "off";
    ajax_error_count["tef_filial_" + iNumLinha] = "off";
    ajax_error_count["tef_numero_" + iNumLinha] = "off";
    ajax_error_count["tef_tipo_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["tef_id_" + iNumLinha] = "on";
    ajax_read_only["tef_filial_" + iNumLinha] = "off";
    ajax_read_only["tef_numero_" + iNumLinha] = "off";
    ajax_read_only["tef_tipo_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["tef_id_" + iNumLinha] = "on";
    ajax_read_only["tef_filial_" + iNumLinha] = "on";
    ajax_read_only["tef_numero_" + iNumLinha] = "on";
    ajax_read_only["tef_tipo_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["tef_id_" + iNumLinha] = null;
    ajax_error_list["tef_filial_" + iNumLinha] = null;
    ajax_error_list["tef_numero_" + iNumLinha] = null;
    ajax_error_list["tef_tipo_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "tef_id_": new Array(),
    "tef_filial_": new Array(),
    "tef_numero_": new Array(),
    "tef_tipo_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["tef_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tef_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tef_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tef_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tef_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tef_filial_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tef_filial_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tef_filial_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tef_filial_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tef_filial_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tef_numero_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tef_numero_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tef_numero_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tef_numero_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tef_numero_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tef_tipo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tef_tipo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tef_tipo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tef_tipo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tef_tipo_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tef_id_'])) ? $this->nmgp_cmp_readonly['tef_id_'] : 'on';
?>
    scAjaxFieldRead("tef_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tef_filial_'])) ? $this->nmgp_cmp_readonly['tef_filial_'] : 'off';
?>
    scAjaxFieldRead("tef_filial_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tef_numero_'])) ? $this->nmgp_cmp_readonly['tef_numero_'] : 'off';
?>
    scAjaxFieldRead("tef_numero_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tef_tipo_'])) ? $this->nmgp_cmp_readonly['tef_tipo_'] : 'off';
?>
    scAjaxFieldRead("tef_tipo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("tef_id_" + iSeq, "on");
    scAjaxFieldRead("tef_filial_" + iSeq, "on");
    scAjaxFieldRead("tef_numero_" + iSeq, "on");
    scAjaxFieldRead("tef_tipo_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["tef_id_" + iRow] || "on" == ajax_error_count["tef_filial_" + iRow] || "on" == ajax_error_count["tef_numero_" + iRow] || "on" == ajax_error_count["tef_tipo_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tef_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tef_filial_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tef_numero_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tef_tipo_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["tef_id_" + iRow] && "off" == ajax_error_count["tef_filial_" + iRow] && "off" == ajax_error_count["tef_numero_" + iRow] && "off" == ajax_error_count["tef_tipo_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["tef_id_" + iRow] = "off";
        ajax_error_count["tef_filial_" + iRow] = "off";
        ajax_error_count["tef_numero_" + iRow] = "off";
        ajax_error_count["tef_tipo_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_tef_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tef_filial_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tef_numero_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tef_tipo_" + iRow).removeClass("scFormErrorLine");
    }
  }
