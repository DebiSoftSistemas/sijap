  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_categoria_producto" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_categoria_producto_form();
	}
...
?>
  ...
  // ---------- Validate cat_id_
  function do_ajax_form_del_categoria_producto_validate_cat_id_(iNumLinha)
  {
    var nomeCampo_cat_id_ = "cat_id_" + iNumLinha;
    var var_cat_id_ = scAjaxGetFieldText(nomeCampo_cat_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_categoria_producto_validate_cat_id_(var_cat_id_, iNumLinha, var_script_case_init, do_ajax_form_del_categoria_producto_validate_cat_id__cb);
  } // do_ajax_form_del_categoria_producto_validate_cat_id_

  function do_ajax_form_del_categoria_producto_validate_cat_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "cat_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "cat_id_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "cat_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "cat_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_categoria_producto_validate_cat_id__cb

  // ---------- Validate cat_empresa_
  function do_ajax_form_del_categoria_producto_validate_cat_empresa_(iNumLinha)
  {
    var nomeCampo_cat_empresa_ = "cat_empresa_" + iNumLinha;
    var var_cat_empresa_ = scAjaxGetFieldText(nomeCampo_cat_empresa_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_categoria_producto_validate_cat_empresa_(var_cat_empresa_, iNumLinha, var_script_case_init, do_ajax_form_del_categoria_producto_validate_cat_empresa__cb);
  } // do_ajax_form_del_categoria_producto_validate_cat_empresa_

  function do_ajax_form_del_categoria_producto_validate_cat_empresa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "cat_empresa_" + iLineNumber;
    }
    else
    {
      sFieldValid = "cat_empresa_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "cat_empresa_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "cat_empresa_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_categoria_producto_validate_cat_empresa__cb

  // ---------- Validate cat_descripcion_
  function do_ajax_form_del_categoria_producto_validate_cat_descripcion_(iNumLinha)
  {
    var nomeCampo_cat_descripcion_ = "cat_descripcion_" + iNumLinha;
    var var_cat_descripcion_ = scAjaxGetFieldText(nomeCampo_cat_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_categoria_producto_validate_cat_descripcion_(var_cat_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_del_categoria_producto_validate_cat_descripcion__cb);
  } // do_ajax_form_del_categoria_producto_validate_cat_descripcion_

  function do_ajax_form_del_categoria_producto_validate_cat_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "cat_descripcion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "cat_descripcion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "cat_descripcion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "cat_descripcion_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_categoria_producto_validate_cat_descripcion__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_del_categoria_producto_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_del_categoria_producto_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_categoria_producto_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_del_categoria_producto_add_new_line_cb);
  } // do_ajax_form_del_categoria_producto_add_new_line

  function do_ajax_form_del_categoria_producto_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_del_categoria_producto_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_del_categoria_producto_backup_line(iNumLinha)
  {
    var var_cat_id_ = scAjaxGetFieldText("cat_id_" + iNumLinha);
    var var_cat_empresa_ = scAjaxGetFieldText("cat_empresa_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_categoria_producto_backup_line(var_cat_id_, var_cat_empresa_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_del_categoria_producto_backup_line_cb);
  } // do_ajax_form_del_categoria_producto_backup_line

  function do_ajax_form_del_categoria_producto_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_del_categoria_producto_backup_line_cb

  function do_ajax_form_del_categoria_producto_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_del_categoria_producto_cancel_insert

  function do_ajax_form_del_categoria_producto_cancel_update(iSeqVert)
  {
    do_ajax_form_del_categoria_producto_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_del_categoria_producto_cancel_update

  function do_ajax_form_del_categoria_producto_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_del_categoria_producto_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_del_categoria_producto_table_refresh()
  {
    var var_cat_id_ = document.F2.cat_id_.value;
    var var_cat_empresa_ = document.F2.cat_empresa_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_del_categoria_producto_table_refresh(var_cat_id_, var_cat_empresa_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_categoria_producto_table_refresh_cb);
  } //  do_ajax_form_del_categoria_producto_table_refresh

  function do_ajax_form_del_categoria_producto_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.cat_id_.value = scAjaxGetKeyValue("cat_id_");
    document.F2.cat_empresa_.value = scAjaxGetKeyValue("cat_empresa_");
    ...
    scAjaxAlert(do_ajax_form_del_categoria_producto_table_refresh_cb_after_alert);
  } // do_ajax_form_del_categoria_producto_table_refresh_cb
  function do_ajax_form_del_categoria_producto_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_del_categoria_producto_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_del_categoria_producto_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_del_categoria_producto_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_cat_id_ = scAjaxGetFieldText("cat_id_" + iNumLinha);
    var var_cat_empresa_ = scAjaxGetFieldText("cat_empresa_" + iNumLinha);
    var var_cat_descripcion_ = scAjaxGetFieldText("cat_descripcion_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_del_categoria_producto_submit_form(var_cat_id_, var_cat_empresa_, var_cat_descripcion_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_categoria_producto_submit_form_cb);
  } // do_ajax_form_del_categoria_producto_submit_form

  function do_ajax_form_del_categoria_producto_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("cat_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("cat_empresa_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("cat_descripcion_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_categoria_producto_submit_form_cb_after_alert);
  } // do_ajax_form_del_categoria_producto_submit_form_cb
  function do_ajax_form_del_categoria_producto_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_categoria_producto_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_categoria_producto_navigate_form()
  {
    perform_ajax_form_del_categoria_producto_navigate_form();
  }

  function perform_ajax_form_del_categoria_producto_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_del_categoria_producto_cancel_insert(sc_form_del_categoria_producto_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("cat_id_" + iNavForm);
      scAjaxHideErrorDisplay("cat_empresa_" + iNavForm);
      scAjaxHideErrorDisplay("cat_descripcion_" + iNavForm);
    }
    var var_cat_id_ = document.F2.cat_id_.value;
    var var_cat_empresa_ = document.F2.cat_empresa_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_categoria_producto_navigate_form(var_cat_id_, var_cat_empresa_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_categoria_producto_navigate_form_cb);
  } // do_ajax_form_del_categoria_producto_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_categoria_producto']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_categoria_producto_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.cat_id_.value = scAjaxGetKeyValue("cat_id_" + var_last_index);
    document.F2.cat_empresa_.value = scAjaxGetKeyValue("cat_empresa_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_categoria_producto_navigate_form_cb_after_alert);
  } // do_ajax_form_del_categoria_producto_navigate_form_cb
  function do_ajax_form_del_categoria_producto_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_del_categoria_producto_navigate_form_cb_after_alert

    function sc_form_del_categoria_producto_get_last_line_number()
    {
    ...
    } //sc_form_del_categoria_producto_get_last_line_number

  function sc_hide_form_del_categoria_producto_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "cat_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "cat_empresa_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "cat_descripcion_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["cat_id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_codigo'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["cat_empresa_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_empresa'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["cat_descripcion_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_descripcion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["cat_id_"][iNumLinha] = "cat_id_" + iNumLinha;
    ajax_field_mult["cat_empresa_"][iNumLinha] = "cat_empresa_" + iNumLinha;
    ajax_field_mult["cat_descripcion_"][iNumLinha] = "cat_descripcion_" + iNumLinha;
    ajax_field_id["cat_id_" + iNumLinha] = new Array("hidden_field_label_cat_id_", "hidden_field_data_cat_id_" + iNumLinha);
    ajax_field_id["cat_descripcion_" + iNumLinha] = new Array("hidden_field_label_cat_descripcion_", "hidden_field_data_cat_descripcion_" + iNumLinha);
    ajax_error_count["cat_id_" + iNumLinha] = "off";
    ajax_error_count["cat_empresa_" + iNumLinha] = "off";
    ajax_error_count["cat_descripcion_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["cat_id_" + iNumLinha] = "on";
    ajax_read_only["cat_empresa_" + iNumLinha] = "on";
    ajax_read_only["cat_descripcion_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["cat_id_" + iNumLinha] = "on";
    ajax_read_only["cat_empresa_" + iNumLinha] = "on";
    ajax_read_only["cat_descripcion_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["cat_id_" + iNumLinha] = null;
    ajax_error_list["cat_empresa_" + iNumLinha] = null;
    ajax_error_list["cat_descripcion_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "cat_id_": new Array(),
    "cat_empresa_": new Array(),
    "cat_descripcion_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["cat_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["cat_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["cat_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["cat_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["cat_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["cat_empresa_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["cat_empresa_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["cat_empresa_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["cat_empresa_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["cat_empresa_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["cat_descripcion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["cat_descripcion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["cat_descripcion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["cat_descripcion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["cat_descripcion_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['cat_id_'])) ? $this->nmgp_cmp_readonly['cat_id_'] : 'on';
?>
    scAjaxFieldRead("cat_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['cat_empresa_'])) ? $this->nmgp_cmp_readonly['cat_empresa_'] : 'on';
?>
    scAjaxFieldRead("cat_empresa_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['cat_descripcion_'])) ? $this->nmgp_cmp_readonly['cat_descripcion_'] : 'off';
?>
    scAjaxFieldRead("cat_descripcion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("cat_id_" + iSeq, "on");
    scAjaxFieldRead("cat_empresa_" + iSeq, "on");
    scAjaxFieldRead("cat_descripcion_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["cat_id_" + iRow] || "on" == ajax_error_count["cat_empresa_" + iRow] || "on" == ajax_error_count["cat_descripcion_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_cat_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_cat_empresa_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_cat_descripcion_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["cat_id_" + iRow] && "off" == ajax_error_count["cat_empresa_" + iRow] && "off" == ajax_error_count["cat_descripcion_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["cat_id_" + iRow] = "off";
        ajax_error_count["cat_empresa_" + iRow] = "off";
        ajax_error_count["cat_descripcion_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_cat_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_cat_empresa_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_cat_descripcion_" + iRow).removeClass("scFormErrorLine");
    }
  }
