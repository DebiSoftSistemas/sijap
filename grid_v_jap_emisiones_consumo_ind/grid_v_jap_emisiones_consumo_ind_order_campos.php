...
<?php
   ...
   $Ord_Cmp = new grid_v_jap_emisiones_consumo_ind_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_v_jap_emisiones_consumo_ind_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_consumo_ind']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_consumo_ind']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["esc_anio_periodo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_consumo_ind']['labels']["esc_anio_periodo"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_consumo_ind']['labels']["esc_anio_periodo"] : "" . $this->Nm_lang['lang_srch_year'] . "";
   $tab_ger_campos['esc_mes_periodo'] = "on";
   $tab_def_campos['esc_mes_periodo'] = "esc_mes_periodo";
   $tab_labels["esc_mes_periodo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_consumo_ind']['labels']["esc_mes_periodo"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_consumo_ind']['labels']["esc_mes_periodo"] : "" . $this->Nm_lang['lang_srch_mnth'] . "";
   $tab_ger_campos['con_numero_contrato'] = "on";
   $tab_def_campos['con_numero_contrato'] = "con_numero_contrato";
   $tab_labels["con_numero_contrato"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_consumo_ind']['labels']["con_numero_contrato"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_consumo_ind']['labels']["con_numero_contrato"] : "" . $this->Nm_lang['lang_numero'] . " Contrato";
   $tab_ger_campos['des_lectura_anterior'] = "on";
   $tab_def_campos['des_lectura_anterior'] = "des_lectura_anterior";
   $tab_labels["des_lectura_anterior"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_consumo_ind']['labels']["des_lectura_anterior"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_consumo_ind']['labels']["des_lectura_anterior"] : "" . $this->Nm_lang['lang_lectura_anterior'] . "";
   $tab_ger_campos['des_lectura_actual'] = "on";
   $tab_def_campos['des_lectura_actual'] = "des_lectura_actual";
   $tab_labels["des_lectura_actual"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_consumo_ind']['labels']["des_lectura_actual"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_consumo_ind']['labels']["des_lectura_actual"] : "" . $this->Nm_lang['lang_lectura_actual'] . "";
   $tab_ger_campos['des_consumo'] = "on";
   $tab_def_campos['des_consumo'] = "des_consumo";
   $tab_labels["des_consumo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_consumo_ind']['labels']["des_consumo"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_consumo_ind']['labels']["des_consumo"] : "" . $this->Nm_lang['lang_consumo'] . "";
   $tab_ger_campos['des_total'] = "on";
   $tab_def_campos['des_total'] = "des_total";
   $tab_labels["des_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_consumo_ind']['labels']["des_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_consumo_ind']['labels']["des_total"] : "" . $this->Nm_lang['lang_total_pagar'] . "";
   $tab_ger_campos['op_estado'] = "on";
   $tab_def_campos['op_estado'] = "op_estado";
   $tab_labels["op_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_consumo_ind']['labels']["op_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_consumo_ind']['labels']["op_estado"] : "" . $this->Nm_lang['lang_estado_deudas'] . "";
   ...
   $tab_labels["detalle"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_consumo_ind']['labels']["detalle"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_consumo_ind']['labels']["detalle"] : "detalle";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_consumo_ind']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_consumo_ind']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_consumo_ind']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_consumo_ind']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_consumo_ind']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_consumo_ind']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_consumo_ind']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_consumo_ind']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_consumo_ind']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_consumo_ind']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_consumo_ind']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_consumo_ind']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_v_jap_emisiones_consumo_ind_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_consumo_ind']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_consumo_ind']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_consumo_ind']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_consumo_ind']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_v_jap_emisiones_consumo_ind']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
