...
class grid_v_jap_emisiones_consumo_ind_resumo
{
   ...
   var $conv_col;
   var $count_ger;
   var $sc_proc_quebra_des_contrato;
   var $count_des_contrato;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_des_contrato = array();
...
SCEOT;
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_des_contrato = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_consumo_ind']['arr_total']['des_contrato'];
      }
      else
      {
          $this->array_total_des_contrato = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_consumo_ind']['arr_total']['des_contrato'] = $this->array_total_des_contrato;
   ...
   function completeMatrix()
   {
       ...
       {
          $Lab_des_contrato = "des_contrato";
       }
       else
       {
       $Lab_des_contrato = "" . $this->Ini->Nm_lang['lang_contrato'] . "";
       }
       $this->comp_field = array(
           $Lab_des_contrato,
       );
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_consumo_ind']['labels']['des_contrato'] = $Lab_des_contrato; 
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_consumo_ind']['summarizing_fields_order']['contrato']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_consumo_ind']['summarizing_fields_order']['contrato'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_consumo_ind']['summarizing_fields_order']['contrato'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_consumo_ind']['summarizing_fields_display']['contrato'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_consumo_ind']['summarizing_fields_display']['contrato'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_consumo_ind']['summarizing_fields_display']['contrato'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_consumo_ind']['summarizing_fields_display']['contrato'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_consumo_ind']['summarizing_fields_display']['contrato'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_consumo_ind']['summarizing_fields_display']['contrato'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_consumo_ind']['summarizing_fields_display']['contrato'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_des_contrato as $i_des_contrato => $d_des_contrato) {
           if (!isset($i_des_contrato, $this->comp_label[0]) || !in_array($i_des_contrato, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_des_contrato[2] ] = $d_des_contrato[1];
               $this->comp_label[0][ $d_des_contrato[2] ] = $d_des_contrato[1];
           }
       }
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_des_contrato => $l_des_contrato) {
           if (isset($this->array_total_des_contrato[$i_des_contrato])) {
               $this->comp_group[$i_des_contrato] = array();
           }
       }
     }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_des_contrato;
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_consumo_ind']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_consumo_ind']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_contrato("res", $this->NM_export);
      ...
      if (is_array($this->array_total_des_contrato)) {
          ksort($this->array_total_des_contrato);
      }
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_emisiones_consumo_ind']['SC_Ind_Groupby'];
...
{ 
   ...
   //---- 
   function adiciona_registro($quebra_des_contrato, $quebra_des_contrato_orig)
   {
      //----- des_contrato
      if (!isset($this->array_total_des_contrato[$quebra_des_contrato_orig]))
      {
         $this->array_total_des_contrato[$quebra_des_contrato_orig][0] = 1;
         $this->array_total_des_contrato[$quebra_des_contrato_orig][1] = $quebra_des_contrato;
         $this->array_total_des_contrato[$quebra_des_contrato_orig][2] = $quebra_des_contrato_orig;
      }
      else
      {
         $this->array_total_des_contrato[$quebra_des_contrato_orig][0]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('contrato', 'des_contrato');
     $campos_order = $this->Ini->Get_date_order_groupby("des_contrato", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->look_esc_mes_periodo = $this->esc_mes_periodo; 
            $this->Lookup->lookup_esc_mes_periodo($this->look_esc_mes_periodo, $this->esc_mes_periodo) ; 
            $this->look_op_estado = $this->op_estado; 
            $this->Lookup->lookup_op_estado($this->look_op_estado, $this->op_estado) ; 
            $this->look_des_ruta = $this->des_ruta; 
            $this->Lookup->lookup_des_ruta($this->look_des_ruta, $this->des_ruta) ; 
            $_SESSION['scriptcase']['grid_v_jap_emisiones_consumo_ind']['contr_erro'] = 'on';
 $this->detalle ="<button type='button' class='scButton_default'><i class='fas fa-list-ol'></i></button>";
$_SESSION['scriptcase']['grid_v_jap_emisiones_consumo_ind']['contr_erro'] = 'off'; 
            $this->des_contrato_orig = $this->des_contrato;
            $this->esc_mes_periodo = $this->look_esc_mes_periodo ;
            $this->op_estado = $this->look_op_estado ;
            $this->des_ruta = $this->look_des_ruta ;
            nmgp_Form_Num_Val($this->des_contrato, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->des_contrato, $this->des_contrato_orig);
            }
   }
//
