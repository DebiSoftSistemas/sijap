<?php
@session_start() ;
$_SESSION['scriptcase']['grid_v_jap_emisiones_consumo_ind']['sc_process_barr'] = true;
require_once('../grid_v_jap_emisiones_consumo_ind/index.php');
unset($_SESSION['scriptcase']['grid_v_jap_emisiones_consumo_ind']['sc_process_barr']);
$ExportCtrl = new grid_v_jap_emisiones_consumo_ind_export_control;
$ExportCtrl->Export_barr();

class grid_v_jap_emisiones_consumo_ind_export_control
{
