  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_detalle_horario" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sis_detalle_horario_form();
	}
...
?>
  ...
  // ---------- Validate deh_horario_
  function do_ajax_form_sis_detalle_horario_validate_deh_horario_(iNumLinha)
  {
    var nomeCampo_deh_horario_ = "deh_horario_" + iNumLinha;
    var var_deh_horario_ = scAjaxGetFieldText(nomeCampo_deh_horario_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_detalle_horario_validate_deh_horario_(var_deh_horario_, iNumLinha, var_script_case_init, do_ajax_form_sis_detalle_horario_validate_deh_horario__cb);
  } // do_ajax_form_sis_detalle_horario_validate_deh_horario_

  function do_ajax_form_sis_detalle_horario_validate_deh_horario__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "deh_horario_" + iLineNumber;
    }
    else
    {
      sFieldValid = "deh_horario_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "deh_horario_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "deh_horario_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_detalle_horario_validate_deh_horario__cb

  // ---------- Validate deh_dia_
  function do_ajax_form_sis_detalle_horario_validate_deh_dia_(iNumLinha)
  {
    var nomeCampo_deh_dia_ = "deh_dia_" + iNumLinha;
    var var_deh_dia_ = scAjaxGetFieldSelect(nomeCampo_deh_dia_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_detalle_horario_validate_deh_dia_(var_deh_dia_, iNumLinha, var_script_case_init, do_ajax_form_sis_detalle_horario_validate_deh_dia__cb);
  } // do_ajax_form_sis_detalle_horario_validate_deh_dia_

  function do_ajax_form_sis_detalle_horario_validate_deh_dia__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "deh_dia_" + iLineNumber;
    }
    else
    {
      sFieldValid = "deh_dia_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "deh_dia_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "deh_dia_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_detalle_horario_validate_deh_dia__cb

  // ---------- Validate deh_entrada_
  function do_ajax_form_sis_detalle_horario_validate_deh_entrada_(iNumLinha)
  {
    var nomeCampo_deh_entrada_ = "deh_entrada_" + iNumLinha;
    var var_deh_entrada_ = scAjaxGetFieldText(nomeCampo_deh_entrada_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_detalle_horario_validate_deh_entrada_(var_deh_entrada_, iNumLinha, var_script_case_init, do_ajax_form_sis_detalle_horario_validate_deh_entrada__cb);
  } // do_ajax_form_sis_detalle_horario_validate_deh_entrada_

  function do_ajax_form_sis_detalle_horario_validate_deh_entrada__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "deh_entrada_" + iLineNumber;
    }
    else
    {
      sFieldValid = "deh_entrada_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "deh_entrada_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "deh_entrada_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_detalle_horario_validate_deh_entrada__cb

  // ---------- Validate deh_salida_
  function do_ajax_form_sis_detalle_horario_validate_deh_salida_(iNumLinha)
  {
    var nomeCampo_deh_salida_ = "deh_salida_" + iNumLinha;
    var var_deh_salida_ = scAjaxGetFieldText(nomeCampo_deh_salida_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_detalle_horario_validate_deh_salida_(var_deh_salida_, iNumLinha, var_script_case_init, do_ajax_form_sis_detalle_horario_validate_deh_salida__cb);
  } // do_ajax_form_sis_detalle_horario_validate_deh_salida_

  function do_ajax_form_sis_detalle_horario_validate_deh_salida__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "deh_salida_" + iLineNumber;
    }
    else
    {
      sFieldValid = "deh_salida_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "deh_salida_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "deh_salida_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_detalle_horario_validate_deh_salida__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_sis_detalle_horario_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_sis_detalle_horario_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sis_detalle_horario_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_sis_detalle_horario_add_new_line_cb);
  } // do_ajax_form_sis_detalle_horario_add_new_line

  function do_ajax_form_sis_detalle_horario_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_sis_detalle_horario_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_sis_detalle_horario_backup_line(iNumLinha)
  {
    var var_deh_horario_ = scAjaxGetFieldText("deh_horario_" + iNumLinha);
    var var_deh_dia_ = scAjaxGetFieldSelect("deh_dia_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_detalle_horario_backup_line(var_deh_horario_, var_deh_dia_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_sis_detalle_horario_backup_line_cb);
  } // do_ajax_form_sis_detalle_horario_backup_line

  function do_ajax_form_sis_detalle_horario_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_sis_detalle_horario_backup_line_cb

  function do_ajax_form_sis_detalle_horario_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_sis_detalle_horario_cancel_insert

  function do_ajax_form_sis_detalle_horario_cancel_update(iSeqVert)
  {
    do_ajax_form_sis_detalle_horario_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_sis_detalle_horario_cancel_update

  function do_ajax_form_sis_detalle_horario_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_sis_detalle_horario_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_sis_detalle_horario_table_refresh()
  {
    var var_deh_horario_ = document.F2.deh_horario_.value;
    var var_deh_dia_ = document.F2.deh_dia_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_sis_detalle_horario_table_refresh(var_deh_horario_, var_deh_dia_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_detalle_horario_table_refresh_cb);
  } //  do_ajax_form_sis_detalle_horario_table_refresh

  function do_ajax_form_sis_detalle_horario_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.deh_horario_.value = scAjaxGetKeyValue("deh_horario_");
    document.F2.deh_dia_.value = scAjaxGetKeyValue("deh_dia_");
    ...
    scAjaxAlert(do_ajax_form_sis_detalle_horario_table_refresh_cb_after_alert);
  } // do_ajax_form_sis_detalle_horario_table_refresh_cb
  function do_ajax_form_sis_detalle_horario_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_sis_detalle_horario_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_sis_detalle_horario_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_sis_detalle_horario_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_deh_horario_ = scAjaxGetFieldText("deh_horario_" + iNumLinha);
    var var_deh_dia_ = scAjaxGetFieldSelect("deh_dia_" + iNumLinha);
    var var_deh_entrada_ = scAjaxGetFieldText("deh_entrada_" + iNumLinha);
    var var_deh_salida_ = scAjaxGetFieldText("deh_salida_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_sis_detalle_horario_submit_form(var_deh_horario_, var_deh_dia_, var_deh_entrada_, var_deh_salida_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_detalle_horario_submit_form_cb);
  } // do_ajax_form_sis_detalle_horario_submit_form

  function do_ajax_form_sis_detalle_horario_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("deh_horario_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("deh_dia_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("deh_entrada_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("deh_salida_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sis_detalle_horario_submit_form_cb_after_alert);
  } // do_ajax_form_sis_detalle_horario_submit_form_cb
  function do_ajax_form_sis_detalle_horario_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_detalle_horario_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sis_detalle_horario_navigate_form()
  {
    perform_ajax_form_sis_detalle_horario_navigate_form();
  }

  function perform_ajax_form_sis_detalle_horario_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_sis_detalle_horario_cancel_insert(sc_form_sis_detalle_horario_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("deh_horario_" + iNavForm);
      scAjaxHideErrorDisplay("deh_dia_" + iNavForm);
      scAjaxHideErrorDisplay("deh_entrada_" + iNavForm);
      scAjaxHideErrorDisplay("deh_salida_" + iNavForm);
    }
    var var_deh_horario_ = document.F2.deh_horario_.value;
    var var_deh_dia_ = document.F2.deh_dia_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sis_detalle_horario_navigate_form(var_deh_horario_, var_deh_dia_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_detalle_horario_navigate_form_cb);
  } // do_ajax_form_sis_detalle_horario_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_detalle_horario']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_detalle_horario_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.deh_horario_.value = scAjaxGetKeyValue("deh_horario_" + var_last_index);
    document.F2.deh_dia_.value = scAjaxGetKeyValue("deh_dia_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_detalle_horario_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_detalle_horario_navigate_form_cb
  function do_ajax_form_sis_detalle_horario_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_sis_detalle_horario_navigate_form_cb_after_alert

    function sc_form_sis_detalle_horario_get_last_line_number()
    {
    ...
    } //sc_form_sis_detalle_horario_get_last_line_number

  function sc_hide_form_sis_detalle_horario_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "deh_horario_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "deh_dia_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "deh_entrada_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "deh_salida_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["deh_horario_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_horario'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["deh_dia_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_dia'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["deh_entrada_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_entrada'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["deh_salida_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_salida'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["deh_horario_"][iNumLinha] = "deh_horario_" + iNumLinha;
    ajax_field_mult["deh_dia_"][iNumLinha] = "deh_dia_" + iNumLinha;
    ajax_field_mult["deh_entrada_"][iNumLinha] = "deh_entrada_" + iNumLinha;
    ajax_field_mult["deh_salida_"][iNumLinha] = "deh_salida_" + iNumLinha;
    ajax_field_id["deh_dia_" + iNumLinha] = new Array("hidden_field_label_deh_dia_", "hidden_field_data_deh_dia_" + iNumLinha);
    ajax_field_id["deh_entrada_" + iNumLinha] = new Array("hidden_field_label_deh_entrada_", "hidden_field_data_deh_entrada_" + iNumLinha);
    ajax_field_id["deh_salida_" + iNumLinha] = new Array("hidden_field_label_deh_salida_", "hidden_field_data_deh_salida_" + iNumLinha);
    ajax_error_count["deh_horario_" + iNumLinha] = "off";
    ajax_error_count["deh_dia_" + iNumLinha] = "off";
    ajax_error_count["deh_entrada_" + iNumLinha] = "off";
    ajax_error_count["deh_salida_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["deh_horario_" + iNumLinha] = "on";
    ajax_read_only["deh_dia_" + iNumLinha] = "on";
    ajax_read_only["deh_entrada_" + iNumLinha] = "off";
    ajax_read_only["deh_salida_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["deh_horario_" + iNumLinha] = "on";
    ajax_read_only["deh_dia_" + iNumLinha] = "on";
    ajax_read_only["deh_entrada_" + iNumLinha] = "on";
    ajax_read_only["deh_salida_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["deh_horario_" + iNumLinha] = null;
    ajax_error_list["deh_dia_" + iNumLinha] = null;
    ajax_error_list["deh_entrada_" + iNumLinha] = null;
    ajax_error_list["deh_salida_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "deh_horario_": new Array(),
    "deh_dia_": new Array(),
    "deh_entrada_": new Array(),
    "deh_salida_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["deh_horario_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["deh_horario_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["deh_horario_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["deh_horario_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["deh_horario_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["deh_dia_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["deh_dia_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["deh_dia_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["deh_dia_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["deh_dia_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["deh_entrada_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["deh_entrada_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["deh_entrada_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["deh_entrada_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["deh_entrada_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["deh_salida_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["deh_salida_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["deh_salida_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["deh_salida_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["deh_salida_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['deh_horario_'])) ? $this->nmgp_cmp_readonly['deh_horario_'] : 'on';
?>
    scAjaxFieldRead("deh_horario_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['deh_dia_'])) ? $this->nmgp_cmp_readonly['deh_dia_'] : 'on';
?>
    scAjaxFieldRead("deh_dia_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['deh_entrada_'])) ? $this->nmgp_cmp_readonly['deh_entrada_'] : 'off';
?>
    scAjaxFieldRead("deh_entrada_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['deh_salida_'])) ? $this->nmgp_cmp_readonly['deh_salida_'] : 'off';
?>
    scAjaxFieldRead("deh_salida_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("deh_horario_" + iSeq, "on");
    scAjaxFieldRead("deh_dia_" + iSeq, "on");
    scAjaxFieldRead("deh_entrada_" + iSeq, "on");
    scAjaxFieldRead("deh_salida_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["deh_horario_" + iRow] || "on" == ajax_error_count["deh_dia_" + iRow] || "on" == ajax_error_count["deh_entrada_" + iRow] || "on" == ajax_error_count["deh_salida_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_deh_horario_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_deh_dia_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_deh_entrada_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_deh_salida_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["deh_horario_" + iRow] && "off" == ajax_error_count["deh_dia_" + iRow] && "off" == ajax_error_count["deh_entrada_" + iRow] && "off" == ajax_error_count["deh_salida_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["deh_horario_" + iRow] = "off";
        ajax_error_count["deh_dia_" + iRow] = "off";
        ajax_error_count["deh_entrada_" + iRow] = "off";
        ajax_error_count["deh_salida_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_deh_horario_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_deh_dia_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_deh_entrada_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_deh_salida_" + iRow).removeClass("scFormErrorLine");
    }
  }
