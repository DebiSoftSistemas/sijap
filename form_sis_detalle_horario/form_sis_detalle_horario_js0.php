<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="deh_horario_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['deh_horario_']); ?>">
<input type="hidden" name="deh_dia_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['deh_dia_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_sis_detalle_horario"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function scForm_inline_submit(y, z) {
	Nm_Proc_Atualiz = true;
	do_ajax_form_sis_detalle_horario_submit_form(y, z);
