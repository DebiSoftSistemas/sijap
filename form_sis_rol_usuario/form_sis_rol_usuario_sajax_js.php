  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_rol_usuario" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sis_rol_usuario_form();
	}
...
?>
  ...
  // ---------- Validate rou_usuario_
  function do_ajax_form_sis_rol_usuario_validate_rou_usuario_(iNumLinha)
  {
    var nomeCampo_rou_usuario_ = "rou_usuario_" + iNumLinha;
    var var_rou_usuario_ = scAjaxGetFieldText(nomeCampo_rou_usuario_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_rol_usuario_validate_rou_usuario_(var_rou_usuario_, iNumLinha, var_script_case_init, do_ajax_form_sis_rol_usuario_validate_rou_usuario__cb);
  } // do_ajax_form_sis_rol_usuario_validate_rou_usuario_

  function do_ajax_form_sis_rol_usuario_validate_rou_usuario__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "rou_usuario_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rou_usuario_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "rou_usuario_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rou_usuario_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_rol_usuario_validate_rou_usuario__cb

  // ---------- Validate rou_rol_
  function do_ajax_form_sis_rol_usuario_validate_rou_rol_(iNumLinha)
  {
    var nomeCampo_rou_rol_ = "rou_rol_" + iNumLinha;
    var var_rou_rol_ = scAjaxGetFieldSelect(nomeCampo_rou_rol_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_rol_usuario_validate_rou_rol_(var_rou_rol_, iNumLinha, var_script_case_init, do_ajax_form_sis_rol_usuario_validate_rou_rol__cb);
  } // do_ajax_form_sis_rol_usuario_validate_rou_rol_

  function do_ajax_form_sis_rol_usuario_validate_rou_rol__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rou_rol_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rou_rol_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rou_rol_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rou_rol_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_rol_usuario_validate_rou_rol__cb

  // ---------- Validate rou_oficina_
  function do_ajax_form_sis_rol_usuario_validate_rou_oficina_(iNumLinha)
  {
    var nomeCampo_rou_oficina_ = "rou_oficina_" + iNumLinha;
    var var_rou_oficina_ = scAjaxGetFieldText(nomeCampo_rou_oficina_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_rol_usuario_validate_rou_oficina_(var_rou_oficina_, iNumLinha, var_script_case_init, do_ajax_form_sis_rol_usuario_validate_rou_oficina__cb);
  } // do_ajax_form_sis_rol_usuario_validate_rou_oficina_

  function do_ajax_form_sis_rol_usuario_validate_rou_oficina__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rou_oficina_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rou_oficina_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rou_oficina_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rou_oficina_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_rol_usuario_validate_rou_oficina__cb

  // ---------- Validate rou_estado_
  function do_ajax_form_sis_rol_usuario_validate_rou_estado_(iNumLinha)
  {
    var nomeCampo_rou_estado_ = "rou_estado_" + iNumLinha;
    var var_rou_estado_ = scAjaxGetFieldSelect(nomeCampo_rou_estado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_rol_usuario_validate_rou_estado_(var_rou_estado_, iNumLinha, var_script_case_init, do_ajax_form_sis_rol_usuario_validate_rou_estado__cb);
  } // do_ajax_form_sis_rol_usuario_validate_rou_estado_

  function do_ajax_form_sis_rol_usuario_validate_rou_estado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rou_estado_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rou_estado_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rou_estado_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rou_estado_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_rol_usuario_validate_rou_estado__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_sis_rol_usuario_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_sis_rol_usuario_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sis_rol_usuario_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_sis_rol_usuario_add_new_line_cb);
  } // do_ajax_form_sis_rol_usuario_add_new_line

  function do_ajax_form_sis_rol_usuario_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_sis_rol_usuario_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_sis_rol_usuario_backup_line(iNumLinha)
  {
    var var_rou_usuario_ = scAjaxGetFieldText("rou_usuario_" + iNumLinha);
    var var_rou_rol_ = scAjaxGetFieldSelect("rou_rol_" + iNumLinha);
    var var_rou_oficina_ = scAjaxGetFieldText("rou_oficina_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_rol_usuario_backup_line(var_rou_usuario_, var_rou_rol_, var_rou_oficina_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_sis_rol_usuario_backup_line_cb);
  } // do_ajax_form_sis_rol_usuario_backup_line

  function do_ajax_form_sis_rol_usuario_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_sis_rol_usuario_backup_line_cb

  function do_ajax_form_sis_rol_usuario_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_sis_rol_usuario_cancel_insert

  function do_ajax_form_sis_rol_usuario_cancel_update(iSeqVert)
  {
    do_ajax_form_sis_rol_usuario_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_sis_rol_usuario_cancel_update

  function do_ajax_form_sis_rol_usuario_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_sis_rol_usuario_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_sis_rol_usuario_table_refresh()
  {
    var var_rou_usuario_ = document.F2.rou_usuario_.value;
    var var_rou_rol_ = document.F2.rou_rol_.value;
    var var_rou_oficina_ = document.F2.rou_oficina_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_sis_rol_usuario_table_refresh(var_rou_usuario_, var_rou_rol_, var_rou_oficina_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_rol_usuario_table_refresh_cb);
  } //  do_ajax_form_sis_rol_usuario_table_refresh

  function do_ajax_form_sis_rol_usuario_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.rou_usuario_.value = scAjaxGetKeyValue("rou_usuario_");
    document.F2.rou_rol_.value = scAjaxGetKeyValue("rou_rol_");
    document.F2.rou_oficina_.value = scAjaxGetKeyValue("rou_oficina_");
    ...
    scAjaxAlert(do_ajax_form_sis_rol_usuario_table_refresh_cb_after_alert);
  } // do_ajax_form_sis_rol_usuario_table_refresh_cb
  function do_ajax_form_sis_rol_usuario_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_sis_rol_usuario_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_sis_rol_usuario_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_sis_rol_usuario_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_rou_rol_ = scAjaxGetFieldSelect("rou_rol_" + iNumLinha);
    var var_rou_oficina_ = scAjaxGetFieldText("rou_oficina_" + iNumLinha);
    var var_rou_estado_ = scAjaxGetFieldSelect("rou_estado_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_sis_rol_usuario_submit_form(var_rou_usuario_, var_rou_rol_, var_rou_oficina_, var_rou_estado_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_rol_usuario_submit_form_cb);
  } // do_ajax_form_sis_rol_usuario_submit_form

  function do_ajax_form_sis_rol_usuario_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("rou_usuario_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("rou_rol_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("rou_oficina_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("rou_estado_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sis_rol_usuario_submit_form_cb_after_alert);
  } // do_ajax_form_sis_rol_usuario_submit_form_cb
  function do_ajax_form_sis_rol_usuario_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_rol_usuario_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sis_rol_usuario_navigate_form()
  {
    perform_ajax_form_sis_rol_usuario_navigate_form();
  }

  function perform_ajax_form_sis_rol_usuario_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_sis_rol_usuario_cancel_insert(sc_form_sis_rol_usuario_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("rou_usuario_" + iNavForm);
      scAjaxHideErrorDisplay("rou_rol_" + iNavForm);
      scAjaxHideErrorDisplay("rou_oficina_" + iNavForm);
      scAjaxHideErrorDisplay("rou_estado_" + iNavForm);
    }
    var var_rou_usuario_ = document.F2.rou_usuario_.value;
    var var_rou_rol_ = document.F2.rou_rol_.value;
    var var_rou_oficina_ = document.F2.rou_oficina_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sis_rol_usuario_navigate_form(var_rou_usuario_, var_rou_rol_, var_rou_oficina_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_rol_usuario_navigate_form_cb);
  } // do_ajax_form_sis_rol_usuario_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_rol_usuario']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_rol_usuario_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.rou_usuario_.value = scAjaxGetKeyValue("rou_usuario_" + var_last_index);
    document.F2.rou_rol_.value = scAjaxGetKeyValue("rou_rol_" + var_last_index);
    document.F2.rou_oficina_.value = scAjaxGetKeyValue("rou_oficina_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_rol_usuario_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_rol_usuario_navigate_form_cb
  function do_ajax_form_sis_rol_usuario_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_sis_rol_usuario_navigate_form_cb_after_alert

    function sc_form_sis_rol_usuario_get_last_line_number()
    {
    ...
    } //sc_form_sis_rol_usuario_get_last_line_number

  function sc_hide_form_sis_rol_usuario_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "rou_usuario_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rou_rol_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rou_oficina_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rou_estado_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["rou_usuario_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_usuario'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["rou_rol_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_rol'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["rou_oficina_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_oficina'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["rou_estado_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["rou_usuario_"][iNumLinha] = "rou_usuario_" + iNumLinha;
    ajax_field_mult["rou_rol_"][iNumLinha] = "rou_rol_" + iNumLinha;
    ajax_field_mult["rou_oficina_"][iNumLinha] = "rou_oficina_" + iNumLinha;
    ajax_field_mult["rou_estado_"][iNumLinha] = "rou_estado_" + iNumLinha;
    ajax_field_id["rou_rol_" + iNumLinha] = new Array("hidden_field_label_rou_rol_", "hidden_field_data_rou_rol_" + iNumLinha);
    ajax_field_id["rou_estado_" + iNumLinha] = new Array("hidden_field_label_rou_estado_", "hidden_field_data_rou_estado_" + iNumLinha);
    ajax_error_count["rou_usuario_" + iNumLinha] = "off";
    ajax_error_count["rou_rol_" + iNumLinha] = "off";
    ajax_error_count["rou_oficina_" + iNumLinha] = "off";
    ajax_error_count["rou_estado_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["rou_usuario_" + iNumLinha] = "on";
    ajax_read_only["rou_rol_" + iNumLinha] = "on";
    ajax_read_only["rou_oficina_" + iNumLinha] = "on";
    ajax_read_only["rou_estado_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["rou_rol_" + iNumLinha] = "on";
    ajax_read_only["rou_oficina_" + iNumLinha] = "on";
    ajax_read_only["rou_estado_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["rou_usuario_" + iNumLinha] = null;
    ajax_error_list["rou_rol_" + iNumLinha] = null;
    ajax_error_list["rou_oficina_" + iNumLinha] = null;
    ajax_error_list["rou_estado_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "rou_usuario_": new Array(),
    "rou_rol_": new Array(),
    "rou_oficina_": new Array(),
    "rou_estado_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["rou_usuario_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rou_usuario_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rou_usuario_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rou_usuario_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rou_usuario_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["rou_rol_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rou_rol_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rou_rol_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rou_rol_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rou_rol_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["rou_oficina_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rou_oficina_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rou_oficina_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rou_oficina_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rou_oficina_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["rou_estado_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rou_estado_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rou_estado_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rou_estado_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rou_estado_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rou_usuario_'])) ? $this->nmgp_cmp_readonly['rou_usuario_'] : 'on';
?>
    scAjaxFieldRead("rou_usuario_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rou_rol_'])) ? $this->nmgp_cmp_readonly['rou_rol_'] : 'on';
?>
    scAjaxFieldRead("rou_rol_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rou_oficina_'])) ? $this->nmgp_cmp_readonly['rou_oficina_'] : 'on';
?>
    scAjaxFieldRead("rou_oficina_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rou_estado_'])) ? $this->nmgp_cmp_readonly['rou_estado_'] : 'off';
?>
    scAjaxFieldRead("rou_estado_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("rou_usuario_" + iSeq, "on");
    scAjaxFieldRead("rou_rol_" + iSeq, "on");
    scAjaxFieldRead("rou_oficina_" + iSeq, "on");
    scAjaxFieldRead("rou_estado_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["rou_usuario_" + iRow] || "on" == ajax_error_count["rou_rol_" + iRow] || "on" == ajax_error_count["rou_oficina_" + iRow] || "on" == ajax_error_count["rou_estado_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rou_usuario_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rou_rol_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rou_oficina_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rou_estado_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["rou_usuario_" + iRow] && "off" == ajax_error_count["rou_rol_" + iRow] && "off" == ajax_error_count["rou_oficina_" + iRow] && "off" == ajax_error_count["rou_estado_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["rou_usuario_" + iRow] = "off";
        ajax_error_count["rou_rol_" + iRow] = "off";
        ajax_error_count["rou_oficina_" + iRow] = "off";
        ajax_error_count["rou_estado_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_rou_usuario_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_rou_rol_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_rou_oficina_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_rou_estado_" + iRow).removeClass("scFormErrorLine");
    }
  }
