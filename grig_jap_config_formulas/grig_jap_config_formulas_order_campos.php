<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grig_jap_config_formulas']['glo_nm_path_imag_temp'] . "/sc_apl_default_SIJAP.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grig_jap_config_formulas_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grig_jap_config_formulas_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grig_jap_config_formulas']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grig_jap_config_formulas']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['jap_aportaciones_ap_descripcion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['jap_aportaciones_ap_descripcion'] = "cmp_maior_30_1";
   }
   else
   {
       $tab_def_campos['jap_aportaciones_ap_descripcion'] = "jap_aportaciones.ap_descripcion";
   }
   $tab_labels["jap_aportaciones_ap_descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grig_jap_config_formulas']['labels']["jap_aportaciones_ap_descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grig_jap_config_formulas']['labels']["jap_aportaciones_ap_descripcion"] : "" . $this->Nm_lang['lang_tipo_deuda'] . "";
   $tab_ger_campos['del_producto_pro_codigo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['del_producto_pro_codigo'] = "del_producto_pro_codigo";
   }
   else
   {
       $tab_def_campos['del_producto_pro_codigo'] = "del_producto.pro_codigo";
   }
   $tab_labels["del_producto_pro_codigo"]   = (isset($_SESSION['sc_session'][$sc_init]['grig_jap_config_formulas']['labels']["del_producto_pro_codigo"])) ? $_SESSION['sc_session'][$sc_init]['grig_jap_config_formulas']['labels']["del_producto_pro_codigo"] : "" . $this->Nm_lang['lang_codigo'] . "";
   $tab_ger_campos['del_producto_pro_descripcion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['del_producto_pro_descripcion'] = "del_producto_pro_descripcion";
   }
   else
   {
       $tab_def_campos['del_producto_pro_descripcion'] = "del_producto.pro_descripcion";
   }
   $tab_labels["del_producto_pro_descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grig_jap_config_formulas']['labels']["del_producto_pro_descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grig_jap_config_formulas']['labels']["del_producto_pro_descripcion"] : "" . $this->Nm_lang['lang_descripcion'] . "";
   $tab_ger_campos['jap_formulas_for_consumo_desde'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['jap_formulas_for_consumo_desde'] = "jap_formulas_for_consumo_desde";
   }
   else
   {
       $tab_def_campos['jap_formulas_for_consumo_desde'] = "jap_formulas.for_consumo_desde";
   }
   $tab_labels["jap_formulas_for_consumo_desde"]   = (isset($_SESSION['sc_session'][$sc_init]['grig_jap_config_formulas']['labels']["jap_formulas_for_consumo_desde"])) ? $_SESSION['sc_session'][$sc_init]['grig_jap_config_formulas']['labels']["jap_formulas_for_consumo_desde"] : "" . $this->Nm_lang['lang_consumo_desde'] . "";
   $tab_ger_campos['jap_formulas_for_consumo_hasta'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['jap_formulas_for_consumo_hasta'] = "jap_formulas_for_consumo_hasta";
   }
   else
   {
       $tab_def_campos['jap_formulas_for_consumo_hasta'] = "jap_formulas.for_consumo_hasta";
   }
   $tab_labels["jap_formulas_for_consumo_hasta"]   = (isset($_SESSION['sc_session'][$sc_init]['grig_jap_config_formulas']['labels']["jap_formulas_for_consumo_hasta"])) ? $_SESSION['sc_session'][$sc_init]['grig_jap_config_formulas']['labels']["jap_formulas_for_consumo_hasta"] : "" . $this->Nm_lang['lang_consumo_hasta'] . "";
   $tab_ger_campos['jap_formulas_for_formula'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['jap_formulas_for_formula'] = "jap_formulas_for_formula";
   }
   else
   {
       $tab_def_campos['jap_formulas_for_formula'] = "jap_formulas.for_formula";
   }
   $tab_labels["jap_formulas_for_formula"]   = (isset($_SESSION['sc_session'][$sc_init]['grig_jap_config_formulas']['labels']["jap_formulas_for_formula"])) ? $_SESSION['sc_session'][$sc_init]['grig_jap_config_formulas']['labels']["jap_formulas_for_formula"] : "" . $this->Nm_lang['lang_formula'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grig_jap_config_formulas']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grig_jap_config_formulas']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grig_jap_config_formulas']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grig_jap_config_formulas']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grig_jap_config_formulas']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grig_jap_config_formulas']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grig_jap_config_formulas']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grig_jap_config_formulas']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grig_jap_config_formulas']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grig_jap_config_formulas']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grig_jap_config_formulas']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grig_jap_config_formulas']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_formulas'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grig_jap_config_formulas_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grig_jap_config_formulas']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grig_jap_config_formulas']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grig_jap_config_formulas']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grig_jap_config_formulas']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grig_jap_config_formulas']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
