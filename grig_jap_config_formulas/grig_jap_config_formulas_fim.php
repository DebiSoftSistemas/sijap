...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIJAP_____grig_jap_config_formulas"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIJAP_____grig_jap_config_formulas"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grig_jap_config_formulas']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grig_jap_config_formulas']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grig_jap_config_formulas']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grig_jap_config_formulas']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grig_jap_config_formulas']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grig_jap_config_formulas</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grig_jap_config_formulas']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grig_jap_config_formulas']['embutida_filho'] as $ind => $sc_init)
          {
