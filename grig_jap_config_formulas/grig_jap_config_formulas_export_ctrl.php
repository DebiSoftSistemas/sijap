<?php
@session_start() ;
$_SESSION['scriptcase']['grig_jap_config_formulas']['sc_process_barr'] = true;
require_once('../grig_jap_config_formulas/index.php');
unset($_SESSION['scriptcase']['grig_jap_config_formulas']['sc_process_barr']);
$ExportCtrl = new grig_jap_config_formulas_export_control;
$ExportCtrl->Export_barr();

class grig_jap_config_formulas_export_control
{
