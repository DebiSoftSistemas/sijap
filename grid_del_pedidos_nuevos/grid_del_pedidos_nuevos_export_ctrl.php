<?php
@session_start() ;
$_SESSION['scriptcase']['grid_del_pedidos_nuevos']['sc_process_barr'] = true;
require_once('../grid_del_pedidos_nuevos/index.php');
unset($_SESSION['scriptcase']['grid_del_pedidos_nuevos']['sc_process_barr']);
$ExportCtrl = new grid_del_pedidos_nuevos_export_control;
$ExportCtrl->Export_barr();

class grid_del_pedidos_nuevos_export_control
{
