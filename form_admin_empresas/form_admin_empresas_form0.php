...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_admin_empresas/form_admin_empresas_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_admin_empresas_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_admin_empresas_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['link_info']['remove_border']) {
...
<?php
 include_once("form_admin_empresas_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_admin_empresas'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_admin_empresas'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['run_iframe'] != "R")
{
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['fast_search'][2] : "";
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<script type="text/javascript">
var pag_ativa = "form_admin_empresas_form0";
</script>
<ul class="scTabLine sc-ui-page-tab-line">
<?php
    $this->tabCssClass = array(
        'form_admin_empresas_form0' => array(
            'title' => "{lang_datos_generales}",
            'class' => empty($nmgp_num_form) || $nmgp_num_form == "form_admin_empresas_form0" ? "scTabActive" : "scTabInactive",
        ),
        'form_admin_empresas_form1' => array(
            'title' => "{lang_establecimiento}",
            'class' => $nmgp_num_form == "form_admin_empresas_form1" ? "scTabActive" : "scTabInactive",
        ),
        'form_admin_empresas_form2' => array(
            'title' => "{lang_punto_emision}",
            'class' => $nmgp_num_form == "form_admin_empresas_form2" ? "scTabActive" : "scTabInactive",
        ),
        'form_admin_empresas_form3' => array(
            'title' => "{lang_othr_msec_cusr}",
            'class' => $nmgp_num_form == "form_admin_empresas_form3" ? "scTabActive" : "scTabInactive",
        ),
        'form_admin_empresas_form4' => array(
            'title' => "{lang_productos}",
            'class' => $nmgp_num_form == "form_admin_empresas_form4" ? "scTabActive" : "scTabInactive",
        ),
        'form_admin_empresas_form5' => array(
            'title' => "{lang_pedidos_convenios}",
            'class' => $nmgp_num_form == "form_admin_empresas_form5" ? "scTabActive" : "scTabInactive",
        ),
    );
    if (!empty($this->Ini->nm_hidden_pages)) {
        foreach ($this->Ini->nm_hidden_pages as $pageName => $pageStatus) {
            if ('{lang_datos_generales}' == $pageName && 'off' == $pageStatus) {
                $this->tabCssClass['form_admin_empresas_form0']['class'] = 'scTabInactive';
            }
            if ('{lang_establecimiento}' == $pageName && 'off' == $pageStatus) {
                $this->tabCssClass['form_admin_empresas_form1']['class'] = 'scTabInactive';
            }
            if ('{lang_punto_emision}' == $pageName && 'off' == $pageStatus) {
                $this->tabCssClass['form_admin_empresas_form2']['class'] = 'scTabInactive';
            }
            if ('{lang_othr_msec_cusr}' == $pageName && 'off' == $pageStatus) {
                $this->tabCssClass['form_admin_empresas_form3']['class'] = 'scTabInactive';
            }
            if ('{lang_productos}' == $pageName && 'off' == $pageStatus) {
                $this->tabCssClass['form_admin_empresas_form4']['class'] = 'scTabInactive';
            }
            if ('{lang_pedidos_convenios}' == $pageName && 'off' == $pageStatus) {
                $this->tabCssClass['form_admin_empresas_form5']['class'] = 'scTabInactive';
            }
        }
...
?>
<?php
    $css_celula = $this->tabCssClass["form_admin_empresas_form0"]['class'];
?>
   <li id="id_form_admin_empresas_form0" class="sc-form-page sc-tab-click <?php echo $css_celula; ?>" data-tab-name="form_admin_empresas_form0">
     <?php echo $this->Ini->Nm_lang['lang_datos_generales']; ?>
   </li>
<?php
    $css_celula = $this->tabCssClass["form_admin_empresas_form1"]['class'];
?>
   <li id="id_form_admin_empresas_form1" class="sc-form-page sc-tab-click <?php echo $css_celula; ?>" data-tab-name="form_admin_empresas_form1">
     <?php echo $this->Ini->Nm_lang['lang_establecimiento']; ?>
   </li>
<?php
    $css_celula = $this->tabCssClass["form_admin_empresas_form2"]['class'];
?>
   <li id="id_form_admin_empresas_form2" class="sc-form-page sc-tab-click <?php echo $css_celula; ?>" data-tab-name="form_admin_empresas_form2">
     <?php echo $this->Ini->Nm_lang['lang_punto_emision']; ?>
   </li>
<?php
    $css_celula = $this->tabCssClass["form_admin_empresas_form3"]['class'];
?>
   <li id="id_form_admin_empresas_form3" class="sc-form-page sc-tab-click <?php echo $css_celula; ?>" data-tab-name="form_admin_empresas_form3">
     <?php echo $this->Ini->Nm_lang['lang_othr_msec_cusr']; ?>
   </li>
<?php
    $css_celula = $this->tabCssClass["form_admin_empresas_form4"]['class'];
?>
   <li id="id_form_admin_empresas_form4" class="sc-form-page sc-tab-click <?php echo $css_celula; ?>" data-tab-name="form_admin_empresas_form4">
     <?php echo $this->Ini->Nm_lang['lang_productos']; ?>
   </li>
<?php
    $css_celula = $this->tabCssClass["form_admin_empresas_form5"]['class'];
?>
   <li id="id_form_admin_empresas_form5" class="sc-form-page sc-tab-click <?php echo $css_celula; ?>" data-tab-name="form_admin_empresas_form5">
...
<div id="form_admin_empresas_form0" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_emp_logo_label" id="hidden_field_label_emp_logo" style="<?php echo $sStyleHidden_emp_logo; ?>"><span id="id_label_emp_logo"><?php echo $this->nm_new_label['emp_logo']; ?></span></TD>
    <TD class="scFormDataOdd css_emp_logo_line" id="hidden_field_data_emp_logo" style="<?php echo $sStyleHidden_emp_logo; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emp_logo_line" style="vertical-align: top;padding: 0px">
...
?> 
    ...
    <TD class="scFormDataOdd css_emp_obligado_line" id="hidden_field_data_emp_obligado" style="<?php echo $sStyleHidden_emp_obligado; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emp_obligado_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['Lookup_emp_obligado'][] = 'S'; ?>
<?php  if (in_array("S", $this->emp_obligado_1))  { echo " checked" ;} ?> onClick="do_ajax_form_admin_empresas_event_emp_obligado_onclick();" ><span></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_emp_estado_label" id="hidden_field_label_emp_estado" style="<?php echo $sStyleHidden_emp_estado; ?>"><span id="id_label_emp_estado"><?php echo $this->nm_new_label['emp_estado']; ?></span></TD>
    <TD class="scFormDataOdd css_emp_estado_line" id="hidden_field_data_emp_estado" style="<?php echo $sStyleHidden_emp_estado; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emp_estado_line" style="vertical-align: top;padding: 0px">
...
?> 
    ...
    <TD class="scFormDataOdd css_escontribuyenteespecial_line" id="hidden_field_data_escontribuyenteespecial" style="<?php echo $sStyleHidden_escontribuyenteespecial; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_escontribuyenteespecial_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['Lookup_escontribuyenteespecial'][] = 'S'; ?>
<?php  if (in_array("S", $this->escontribuyenteespecial_1))  { echo " checked" ;} ?> onClick="do_ajax_form_admin_empresas_event_escontribuyenteespecial_onclick();" ><span></span>
<label for="<?php echo $tempOptionId ?>"></label> </div>
</TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
...
?> 
    ...
    <TD class="scFormDataOdd css_esartesanocalificado_line" id="hidden_field_data_esartesanocalificado" style="<?php echo $sStyleHidden_esartesanocalificado; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_esartesanocalificado_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['Lookup_esartesanocalificado'][] = 'S'; ?>
<?php  if (in_array("S", $this->esartesanocalificado_1))  { echo " checked" ;} ?> onClick="do_ajax_form_admin_empresas_event_esartesanocalificado_onclick();" ><span></span>
<label for="<?php echo $tempOptionId ?>"></label> </div>
</TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_emp_calificacion_artesanal_line" id="hidden_field_data_emp_calificacion_artesanal" style="<?php echo $sStyleHidden_emp_calificacion_artesanal; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emp_calificacion_artesanal_line" style="vertical-align: top;padding: 0px">
...
?> 
    ...
    <TD class="scFormDataOdd css_emp_es_op_transporte_line" id="hidden_field_data_emp_es_op_transporte" style="<?php echo $sStyleHidden_emp_es_op_transporte; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emp_es_op_transporte_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['Lookup_emp_es_op_transporte'][] = 'S'; ?>
...
?> 
    ...
    <TD class="scFormDataOdd css_emp_socio_transportista_line" id="hidden_field_data_emp_socio_transportista" style="<?php echo $sStyleHidden_emp_socio_transportista; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emp_socio_transportista_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['Lookup_emp_socio_transportista'][] = 'S'; ?>
...
?> 
    ...
    <TD class="scFormDataOdd css_es_profesionalsalud_line" id="hidden_field_data_es_profesionalsalud" style="<?php echo $sStyleHidden_es_profesionalsalud; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_es_profesionalsalud_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['Lookup_es_profesionalsalud'][] = 'S'; ?>
...
?> 
    ...
    <TD class="scFormDataOdd css_emp_agente_retencion_line" id="hidden_field_data_emp_agente_retencion" style="<?php echo $sStyleHidden_emp_agente_retencion; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emp_agente_retencion_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['Lookup_emp_agente_retencion'][] = 'S'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_emp_ambiente_sri_line" id="hidden_field_data_emp_ambiente_sri" style="<?php echo $sStyleHidden_emp_ambiente_sri; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emp_ambiente_sri_line" style="vertical-align: top;padding: 0px">
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_emp_autorizacion_inmediata_label" id="hidden_field_label_emp_autorizacion_inmediata" style="<?php echo $sStyleHidden_emp_autorizacion_inmediata; ?>"><span id="id_label_emp_autorizacion_inmediata"><?php echo $this->nm_new_label['emp_autorizacion_inmediata']; ?></span></TD>
    <TD class="scFormDataOdd css_emp_autorizacion_inmediata_line" id="hidden_field_data_emp_autorizacion_inmediata" style="<?php echo $sStyleHidden_emp_autorizacion_inmediata; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emp_autorizacion_inmediata_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['Lookup_emp_autorizacion_inmediata'][] = 'S'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_emp_comisionista_line" id="hidden_field_data_emp_comisionista" style="<?php echo $sStyleHidden_emp_comisionista; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emp_comisionista_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_emp_tipo_suscripcion_label" id="hidden_field_label_emp_tipo_suscripcion" style="<?php echo $sStyleHidden_emp_tipo_suscripcion; ?>"><span id="id_label_emp_tipo_suscripcion"><?php echo $this->nm_new_label['emp_tipo_suscripcion']; ?></span></TD>
    <TD class="scFormDataOdd css_emp_tipo_suscripcion_line" id="hidden_field_data_emp_tipo_suscripcion" style="<?php echo $sStyleHidden_emp_tipo_suscripcion; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emp_tipo_suscripcion_line" style="vertical-align: top;padding: 0px">
