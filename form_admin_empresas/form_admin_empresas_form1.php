<div id="form_admin_empresas_form1" style='<?php echo ($this->tabCssClass["form_admin_empresas_form1"]['class'] == 'scTabInactive' ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_establecimiento'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_establecimiento'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['grid_admin_establecimientos_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_establecimiento'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['grid_admin_establecimientos_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_admin_empresas_empty.htm' : $this->Ini->link_grid_admin_establecimientos_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y' . $parms_lig_cons;
if (isset($this->Ini->sc_lig_target['C_@scinf_establecimiento']) && 'nmsc_iframe_liga_grid_admin_establecimientos' != $this->Ini->sc_lig_target['C_@scinf_establecimiento'])
{
    ...
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_establecimiento'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_admin_empresas']['grid_admin_establecimientos_script_case_init']);
    }
?>
