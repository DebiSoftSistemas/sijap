<?php
@session_start() ;
$_SESSION['scriptcase']['grid_jap_escenario_materiales']['sc_process_barr'] = true;
require_once('../grid_jap_escenario_materiales/index.php');
unset($_SESSION['scriptcase']['grid_jap_escenario_materiales']['sc_process_barr']);
$ExportCtrl = new grid_jap_escenario_materiales_export_control;
$ExportCtrl->Export_barr();

class grid_jap_escenario_materiales_export_control
{
