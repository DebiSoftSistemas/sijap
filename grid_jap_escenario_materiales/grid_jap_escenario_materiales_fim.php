...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_jap_escenario_materiales"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_jap_escenario_materiales"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_jap_escenario_materiales'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_jap_escenario_materiales']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_jap_escenario_materiales']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_jap_escenario_materiales']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_jap_escenario_materiales']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_jap_escenario_materiales']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_jap_escenario_materiales</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_jap_escenario_materiales']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_jap_escenario_materiales']['embutida_filho'] as $ind => $sc_init)
          {
