<?php
@session_start() ;
$_SESSION['scriptcase']['grid_del_punto_emision']['sc_process_barr'] = true;
require_once('../grid_del_punto_emision/index.php');
unset($_SESSION['scriptcase']['grid_del_punto_emision']['sc_process_barr']);
$ExportCtrl = new grid_del_punto_emision_export_control;
$ExportCtrl->Export_barr();

class grid_del_punto_emision_export_control
{
