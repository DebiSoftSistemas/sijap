...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "del_punto_emision_pem_id";$Nm_numeric[] = "del_punto_emision_pem_establecimiento";$Nm_numeric[] = "del_punto_emision_pem_id";$Nm_numeric[] = "del_punto_emision_pem_establecimiento";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_del_punto_emision_pem_establecimiento"  <?php echo $str_hide_del_punto_emision_pem_establecimiento?>>
<?php
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_del_punto_emision_pen_serie"  <?php echo $str_hide_del_punto_emision_pen_serie?>><?php
