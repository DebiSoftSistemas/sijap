...
class grid_del_punto_emision_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == 'autocomp_del_punto_emision_pen_serie')
      {
          $del_punto_emision_pen_serie = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_del_punto_emision_pen_serie($del_punto_emision_pen_serie);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "del_punto_emision_pem_id";$Nm_numeric[] = "del_punto_emision_pem_establecimiento";
      $campo_join = strtolower(str_replace(".", "_", $nome));
      if (in_array($campo_join, $Nm_numeric))
      {
          if ($condicao == "EP" || $condicao == "NE")
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$campo_join]);
              return;
          }
         $nm_ini_lower = "";
         $nm_fim_lower = "";
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_punto_emision'] ?></TITLE>
...
<?php
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['orig_pesq'] == "res")  
    { 
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_del_punto_emision/grid_del_punto_emision_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_del_punto_emision_ajax_search.js"></script>
 <script type="text/javascript" src="grid_del_punto_emision_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_del_punto_emision_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_del_punto_emision']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_del_punto_emision']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-del_punto_emision_pen_serie").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_del_punto_emision_pen_serie",
      max_itens: "10",
   ...
   $("#SC_del_punto_emision_pen_serie").val(e.params.data.id);
  });
 });
</script>
...
<TABLE id="main_table" align="left" valign="top" width="98%">
<tr>
<td>
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $del_punto_emision_pem_establecimiento_cond, $del_punto_emision_pem_establecimiento,
             $del_punto_emision_pen_serie_cond, $del_punto_emision_pen_serie, $del_punto_emision_pen_serie_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $del_punto_emision_pem_establecimiento = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['campos_busca']['del_punto_emision_pem_establecimiento']; 
          $del_punto_emision_pem_establecimiento_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['campos_busca']['del_punto_emision_pem_establecimiento_cond']; 
          $del_punto_emision_pen_serie = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['campos_busca']['del_punto_emision_pen_serie']; 
          $del_punto_emision_pen_serie_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['campos_busca']['del_punto_emision_pen_serie_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['campos_busca']['NM_operador']; 
      } 
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_del_punto_emision_pem_establecimiento = (in_array($del_punto_emision_pem_establecimiento_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_del_punto_emision_pen_serie = (in_array($del_punto_emision_pen_serie_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($del_punto_emision_pem_establecimiento) || $del_punto_emision_pem_establecimiento == "")
      {
          $del_punto_emision_pem_establecimiento = "";
      }
      if (isset($del_punto_emision_pem_establecimiento) && !empty($del_punto_emision_pem_establecimiento))
      {
         $tmp_pos = (is_string($del_punto_emision_pem_establecimiento)) ? strpos($del_punto_emision_pem_establecimiento, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $del_punto_emision_pem_establecimiento = substr($del_punto_emision_pem_establecimiento, 0, $tmp_pos);
         }
      }
      if (!isset($del_punto_emision_pen_serie) || $del_punto_emision_pen_serie == "")
      {
          $del_punto_emision_pen_serie = "";
      }
      if (isset($del_punto_emision_pen_serie) && !empty($del_punto_emision_pen_serie))
      {
         $tmp_pos = (is_string($del_punto_emision_pen_serie)) ? strpos($del_punto_emision_pen_serie, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $del_punto_emision_pen_serie = substr($del_punto_emision_pen_serie, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_del_punto_emision_pem_establecimiento_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['del_punto_emision_pem_establecimiento'])) ? $this->New_label['del_punto_emision_pem_establecimiento'] : "" . $this->Ini->Nm_lang['lang_establecimiento'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_del_punto_emision_pem_establecimiento_cond" name="del_punto_emision_pem_establecimiento_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_del_punto_emision_pem_establecimiento" <?php echo $str_hide_del_punto_emision_pem_establecimiento?> valign="top">
 ...
 $nmgp_tab_label .= "del_punto_emision_pem_establecimiento?#?" . $SC_Label . "?@?";
...
?>
   <span id="idAjaxSelect_del_punto_emision_pem_establecimiento">
      <SELECT class="scFilterObjectOdd css_del_punto_emision_pem_establecimiento_fil_obj" id="SC_del_punto_emision_pem_establecimiento" name="del_punto_emision_pem_establecimiento"  size="1">
...
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $del_punto_emision_pem_establecimiento)
            {
                    $del_punto_emision_pem_establecimiento_sel = ($nm_opc_cod === $del_punto_emision_pem_establecimiento) ? "selected" : "";
            }
            else
            {
...
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $del_punto_emision_pem_establecimiento_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
?>
      ...
      <TD id='SC_del_punto_emision_pen_serie_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['del_punto_emision_pen_serie'])) ? $this->New_label['del_punto_emision_pen_serie'] : "" . $this->Ini->Nm_lang['lang_punto_emision'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_del_punto_emision_pen_serie_cond" name="del_punto_emision_pen_serie_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_del_punto_emision_pen_serie" <?php echo $str_hide_del_punto_emision_pen_serie?> valign="top">
 ...
 $nmgp_tab_label .= "del_punto_emision_pen_serie?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $del_punto_emision_pen_serie;
      }
?>
<INPUT  type="text" id="SC_del_punto_emision_pen_serie" name="del_punto_emision_pen_serie" value="<?php echo NM_encode_input($del_punto_emision_pen_serie) ?>"  size=3 alt="{datatype: 'text', maxLength: 3, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven css_del_punto_emision_pen_serie_fil_obj sc-ui-autocomp-del_punto_emision_pen_serie" id="id_ac_del_punto_emision_pen_serie" name="del_punto_emision_pen_serie_autocomp"><?php if ('' !=  $del_punto_emision_pen_serie) { ?><option value="<?php echo $del_punto_emision_pen_serie ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_del_punto_emision_help.txt"))
   {
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['orig_pesq'] == "grid")
   {
...
<SCRIPT type="text/javascript">
 ...
 {
   document.F1.reset();
   nm_campos_between(document.getElementById('id_vis_del_punto_emision_pem_establecimiento'), document.F1.del_punto_emision_pem_establecimiento_cond, 'del_punto_emision_pem_establecimiento');
   document.F1.del_punto_emision_pem_establecimiento.value = "";
   nm_campos_between(document.getElementById('id_vis_del_punto_emision_pen_serie'), document.F1.del_punto_emision_pen_serie_cond, 'del_punto_emision_pen_serie');
   document.F1.del_punto_emision_pen_serie.value = "";
   document.F1.del_punto_emision_pen_serie_autocomp.value = "";
   $('#select2-id_ac_del_punto_emision_pen_serie-container').html('<?php echo $this->Val_init_del_punto_emision_pen_serie['desc'] ?>');;
   Sc_carga_select2('all');
 }
 function Sc_carga_select2(Field)
 {
    if (Field == 'all' || Field == 'del_punto_emision_pem_establecimiento') {
       Sc_carga_select2_del_punto_emision_pem_establecimiento();
    }
 }
 function Sc_carga_select2_del_punto_emision_pem_establecimiento()
 {
  $("#SC_del_punto_emision_pem_establecimiento").select2(
    {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   {
      global $del_punto_emision_pem_establecimiento_cond, $del_punto_emision_pem_establecimiento,
             $del_punto_emision_pen_serie_cond, $del_punto_emision_pen_serie, $del_punto_emision_pen_serie_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($del_punto_emision_pen_serie_autocomp) && empty($del_punto_emision_pen_serie))
      {
          $del_punto_emision_pen_serie = $del_punto_emision_pen_serie_autocomp;
      }
      $del_punto_emision_pem_establecimiento_cond_salva = $del_punto_emision_pem_establecimiento_cond; 
      if (!isset($del_punto_emision_pem_establecimiento_input_2) || $del_punto_emision_pem_establecimiento_input_2 == "")
      {
          $del_punto_emision_pem_establecimiento_input_2 = $del_punto_emision_pem_establecimiento;
      }
      $del_punto_emision_pen_serie_cond_salva = $del_punto_emision_pen_serie_cond; 
      if (!isset($del_punto_emision_pen_serie_input_2) || $del_punto_emision_pen_serie_input_2 == "")
      {
          $del_punto_emision_pen_serie_input_2 = $del_punto_emision_pen_serie;
      }
      $tmp_pos = (is_string($del_punto_emision_pem_establecimiento)) ? strpos($del_punto_emision_pem_establecimiento, "##@@") : false;
      if ($tmp_pos === false) {
          $L_lookup = $del_punto_emision_pem_establecimiento;
      }
      else {
          $L_lookup = substr($del_punto_emision_pem_establecimiento, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['psq_check_ret']['del_punto_emision_pem_establecimiento'])) {
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['campos_busca']['del_punto_emision_pem_establecimiento'] = $del_punto_emision_pem_establecimiento; 
      if (is_array($del_punto_emision_pem_establecimiento) && !empty($del_punto_emision_pem_establecimiento))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['Grid_search'][$I_Grid]['val'][0] = $del_punto_emision_pem_establecimiento;
      }
      elseif ($del_punto_emision_pem_establecimiento_cond_salva == "nu" || $del_punto_emision_pem_establecimiento_cond_salva == "nn" || $del_punto_emision_pem_establecimiento_cond_salva == "ep" || $del_punto_emision_pem_establecimiento_cond_salva == "ne" || !empty($del_punto_emision_pem_establecimiento))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['Grid_search'][$I_Grid]['val'][0][0] = $del_punto_emision_pem_establecimiento;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['campos_busca']['del_punto_emision_pem_establecimiento_cond'] = $del_punto_emision_pem_establecimiento_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['Grid_search'][$I_Grid]['cmp'] = "del_punto_emision_pem_establecimiento"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['Grid_search'][$I_Grid]['opc'] = $del_punto_emision_pem_establecimiento_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq']['del_punto_emision_pem_establecimiento'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['campos_busca']['del_punto_emision_pen_serie'] = $del_punto_emision_pen_serie; 
      if (is_array($del_punto_emision_pen_serie) && !empty($del_punto_emision_pen_serie))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['Grid_search'][$I_Grid]['val'][0] = $del_punto_emision_pen_serie;
      }
      elseif ($del_punto_emision_pen_serie_cond_salva == "nu" || $del_punto_emision_pen_serie_cond_salva == "nn" || $del_punto_emision_pen_serie_cond_salva == "ep" || $del_punto_emision_pen_serie_cond_salva == "ne" || !empty($del_punto_emision_pen_serie))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['Grid_search'][$I_Grid]['val'][0][0] = $del_punto_emision_pen_serie;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['campos_busca']['del_punto_emision_pen_serie_cond'] = $del_punto_emision_pen_serie_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['Grid_search'][$I_Grid]['cmp'] = "del_punto_emision_pen_serie"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['Grid_search'][$I_Grid]['opc'] = $del_punto_emision_pen_serie_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['grid_pesq']['del_punto_emision_pen_serie'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $Conteudo = $del_punto_emision_pem_establecimiento;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      }
      $this->cmp_formatado['del_punto_emision_pem_establecimiento'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($del_punto_emision_pen_serie != '') {
      $del_punto_emision_pen_serie_look = (is_string($del_punto_emision_pen_serie) ? substr($this->Db->qstr($del_punto_emision_pen_serie), 1, -1) : $del_punto_emision_pen_serie); 
      $nmgp_def_dados = array(); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['del_punto_emision_pen_serie'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['del_punto_emision_pen_serie'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['del_punto_emision_pen_serie'] = $del_punto_emision_pen_serie;
      }

      //----- $del_punto_emision_pem_establecimiento
      $this->Date_part = false;
      if (isset($del_punto_emision_pem_establecimiento))
      {
         $this->monta_condicao("del_punto_emision.pem_establecimiento", $del_punto_emision_pem_establecimiento_cond, $del_punto_emision_pem_establecimiento, "", "del_punto_emision_pem_establecimiento", "INT4", false);
      }

      //----- $del_punto_emision_pen_serie
      $this->Date_part = false;
      if (isset($del_punto_emision_pen_serie) || $del_punto_emision_pen_serie_cond == "nu" || $del_punto_emision_pen_serie_cond == "nn" || $del_punto_emision_pen_serie_cond == "ep" || $del_punto_emision_pen_serie_cond == "ne")
      {
         $this->monta_condicao("del_punto_emision.pen_serie", $del_punto_emision_pen_serie_cond, $del_punto_emision_pen_serie, "", "del_punto_emision_pen_serie", "VARCHAR", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
    $this->Sel_case_sensitive($this->comando);
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['where_pesq'] = $this->comando;
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['cond_dyn_search'] = "";
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['where_pesq_grid']    = $this->comando_filtro;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_punto_emision']['cond_pesq'] .= $this->NM_operador;
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "del_punto_emision_pem_establecimiento" : return ('class="scFilterObjectOdd css_del_punto_emision_pem_establecimiento_fil_obj"'); break;
         default       : return ("");
      }
   }
