  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_jap_sector" == sTestField)
        {
...
?>
  ...
  // ---------- Validate sec_id_
  function do_ajax_form_jap_sector_validate_sec_id_(iNumLinha)
  {
    var nomeCampo_sec_id_ = "sec_id_" + iNumLinha;
    var var_sec_id_ = scAjaxGetFieldHidden(nomeCampo_sec_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_sector_validate_sec_id_(var_sec_id_, iNumLinha, var_script_case_init, do_ajax_form_jap_sector_validate_sec_id__cb);
  } // do_ajax_form_jap_sector_validate_sec_id_

  function do_ajax_form_jap_sector_validate_sec_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_sector_validate_sec_id__cb

  // ---------- Validate sec_empresa_
  function do_ajax_form_jap_sector_validate_sec_empresa_(iNumLinha)
  {
    var nomeCampo_sec_empresa_ = "sec_empresa_" + iNumLinha;
    var var_sec_empresa_ = scAjaxGetFieldText(nomeCampo_sec_empresa_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_sector_validate_sec_empresa_(var_sec_empresa_, iNumLinha, var_script_case_init, do_ajax_form_jap_sector_validate_sec_empresa__cb);
  } // do_ajax_form_jap_sector_validate_sec_empresa_

  function do_ajax_form_jap_sector_validate_sec_empresa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_sector_validate_sec_empresa__cb

  // ---------- Validate sec_descripcion_
  function do_ajax_form_jap_sector_validate_sec_descripcion_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_sector_validate_sec_descripcion_(var_sec_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_jap_sector_validate_sec_descripcion__cb);
  } // do_ajax_form_jap_sector_validate_sec_descripcion_

  function do_ajax_form_jap_sector_validate_sec_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_sector_validate_sec_descripcion__cb

  // ---------- Validate sec_esado_
  function do_ajax_form_jap_sector_validate_sec_esado_(iNumLinha)
  {
    var nomeCampo_sec_esado_ = "sec_esado_" + iNumLinha;
    var var_sec_esado_ = scAjaxGetFieldSelect(nomeCampo_sec_esado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_sector_validate_sec_esado_(var_sec_esado_, iNumLinha, var_script_case_init, do_ajax_form_jap_sector_validate_sec_esado__cb);
  } // do_ajax_form_jap_sector_validate_sec_esado_

  function do_ajax_form_jap_sector_validate_sec_esado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "sec_esado_" + iLineNumber;
    }
    else
    {
      sFieldValid = "sec_esado_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "sec_esado_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "sec_esado_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_sector_validate_sec_esado__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_jap_sector_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_jap_sector_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_jap_sector_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_jap_sector_add_new_line_cb);
  } // do_ajax_form_jap_sector_add_new_line

  function do_ajax_form_jap_sector_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_jap_sector_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_jap_sector_backup_line(iNumLinha)
  {
    var var_sec_id_ = scAjaxGetFieldHidden("sec_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_sector_backup_line(var_sec_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_jap_sector_backup_line_cb);
  } // do_ajax_form_jap_sector_backup_line

  function do_ajax_form_jap_sector_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_jap_sector_backup_line_cb

  function do_ajax_form_jap_sector_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_jap_sector_cancel_insert

  function do_ajax_form_jap_sector_cancel_update(iSeqVert)
  {
    do_ajax_form_jap_sector_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_jap_sector_cancel_update

  function do_ajax_form_jap_sector_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_jap_sector_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_jap_sector_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_jap_sector_table_refresh(var_sec_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jap_sector_table_refresh_cb);
  } //  do_ajax_form_jap_sector_table_refresh

  function do_ajax_form_jap_sector_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_jap_sector_table_refresh_cb_after_alert);
  } // do_ajax_form_jap_sector_table_refresh_cb
  function do_ajax_form_jap_sector_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_jap_sector_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_jap_sector_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_jap_sector_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_sec_esado_ = scAjaxGetFieldSelect("sec_esado_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_jap_sector_submit_form(var_sec_id_, var_sec_empresa_, var_sec_descripcion_, var_sec_esado_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_jap_sector_submit_form_cb);
  } // do_ajax_form_jap_sector_submit_form

  function do_ajax_form_jap_sector_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("sec_esado_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_jap_sector_submit_form_cb_after_alert);
  } // do_ajax_form_jap_sector_submit_form_cb
  function do_ajax_form_jap_sector_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_jap_sector_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_jap_sector_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_jap_sector_navigate_form, function() {});
    } else {
      perform_ajax_form_jap_sector_navigate_form();
    }
  }

  function perform_ajax_form_jap_sector_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_jap_sector_cancel_insert(sc_form_jap_sector_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("sec_esado_" + iNavForm);
    }
    var var_sec_id_ = document.F2.sec_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_jap_sector_navigate_form(var_sec_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jap_sector_navigate_form_cb);
  } // do_ajax_form_jap_sector_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_sector']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_jap_sector_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_jap_sector_navigate_form_cb_after_alert);
  } // do_ajax_form_jap_sector_navigate_form_cb
  function do_ajax_form_jap_sector_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_jap_sector_navigate_form_cb_after_alert

    function sc_form_jap_sector_get_last_line_number()
    {
    ...
    } //sc_form_jap_sector_get_last_line_number

  function sc_hide_form_jap_sector_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "sec_esado_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["sec_esado_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["sec_esado_"][iNumLinha] = "sec_esado_" + iNumLinha;
    ...
    ajax_field_id["sec_esado_" + iNumLinha] = new Array("hidden_field_label_sec_esado_", "hidden_field_data_sec_esado_" + iNumLinha);
    ...
    ajax_error_count["sec_esado_" + iNumLinha] = "off";
<?php
...
?>
    ...
    ajax_read_only["sec_esado_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["sec_esado_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["sec_esado_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["sec_esado_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["sec_esado_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["sec_esado_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["sec_esado_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["sec_esado_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['sec_esado_'])) ? $this->nmgp_cmp_readonly['sec_esado_'] : 'off';
?>
    scAjaxFieldRead("sec_esado_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("sec_esado_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["sec_id_" + iRow] || "on" == ajax_error_count["sec_empresa_" + iRow] || "on" == ajax_error_count["sec_descripcion_" + iRow] || "on" == ajax_error_count["sec_esado_" + iRow]))
    {
      ...
      $("#hidden_field_data_sec_esado_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["sec_id_" + iRow] && "off" == ajax_error_count["sec_empresa_" + iRow] && "off" == ajax_error_count["sec_descripcion_" + iRow] && "off" == ajax_error_count["sec_esado_" + iRow]))
    {
      if (bErrorRow)
      {
        ...
        ajax_error_count["sec_esado_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_sec_esado_" + iRow).removeClass("scFormErrorLine");
    }
  }
