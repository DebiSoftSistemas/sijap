  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_fac_solicitud_cambio_deudor_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_fac_solicitud_cambio_deudor_mob_form();
	}
...
?>
  ...
  // ---------- Validate scd_id
  function do_ajax_form_fac_solicitud_cambio_deudor_mob_validate_scd_id()
  {
    var nomeCampo_scd_id = "scd_id";
    var var_scd_id = scAjaxGetFieldHidden(nomeCampo_scd_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_cambio_deudor_mob_validate_scd_id(var_scd_id, var_script_case_init, do_ajax_form_fac_solicitud_cambio_deudor_mob_validate_scd_id_cb);
  } // do_ajax_form_fac_solicitud_cambio_deudor_mob_validate_scd_id

  function do_ajax_form_fac_solicitud_cambio_deudor_mob_validate_scd_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_cambio_deudor_mob_validate_scd_id_cb

  // ---------- Validate scd_fecha
  function do_ajax_form_fac_solicitud_cambio_deudor_mob_validate_scd_fecha()
  {
    var nomeCampo_scd_fecha = "scd_fecha";
    var var_scd_fecha = scAjaxGetFieldHidden(nomeCampo_scd_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_cambio_deudor_mob_validate_scd_fecha(var_scd_fecha, var_script_case_init, do_ajax_form_fac_solicitud_cambio_deudor_mob_validate_scd_fecha_cb);
  } // do_ajax_form_fac_solicitud_cambio_deudor_mob_validate_scd_fecha

  function do_ajax_form_fac_solicitud_cambio_deudor_mob_validate_scd_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "scd_fecha";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_cambio_deudor_mob_validate_scd_fecha_cb

  // ---------- Validate scd_propietario_actual
  function do_ajax_form_fac_solicitud_cambio_deudor_mob_validate_scd_propietario_actual()
  {
    var nomeCampo_scd_propietario_actual = "scd_propietario_actual";
    var var_scd_propietario_actual = scAjaxGetFieldSelect(nomeCampo_scd_propietario_actual);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_cambio_deudor_mob_validate_scd_propietario_actual(var_scd_propietario_actual, var_script_case_init, do_ajax_form_fac_solicitud_cambio_deudor_mob_validate_scd_propietario_actual_cb);
  } // do_ajax_form_fac_solicitud_cambio_deudor_mob_validate_scd_propietario_actual

  function do_ajax_form_fac_solicitud_cambio_deudor_mob_validate_scd_propietario_actual_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "scd_propietario_actual";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_cambio_deudor_mob_validate_scd_propietario_actual_cb

  // ---------- Validate scd_nuevo_propietario
  function do_ajax_form_fac_solicitud_cambio_deudor_mob_validate_scd_nuevo_propietario()
  {
    var nomeCampo_scd_nuevo_propietario = "scd_nuevo_propietario";
    var var_scd_nuevo_propietario = scAjaxGetFieldSelect(nomeCampo_scd_nuevo_propietario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_cambio_deudor_mob_validate_scd_nuevo_propietario(var_scd_nuevo_propietario, var_script_case_init, do_ajax_form_fac_solicitud_cambio_deudor_mob_validate_scd_nuevo_propietario_cb);
  } // do_ajax_form_fac_solicitud_cambio_deudor_mob_validate_scd_nuevo_propietario

  function do_ajax_form_fac_solicitud_cambio_deudor_mob_validate_scd_nuevo_propietario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "scd_nuevo_propietario";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_cambio_deudor_mob_validate_scd_nuevo_propietario_cb

  // ---------- Validate scd_motivo_cambio
  function do_ajax_form_fac_solicitud_cambio_deudor_mob_validate_scd_motivo_cambio()
  {
    var nomeCampo_scd_motivo_cambio = "scd_motivo_cambio";
    var var_scd_motivo_cambio = scAjaxGetFieldText(nomeCampo_scd_motivo_cambio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_cambio_deudor_mob_validate_scd_motivo_cambio(var_scd_motivo_cambio, var_script_case_init, do_ajax_form_fac_solicitud_cambio_deudor_mob_validate_scd_motivo_cambio_cb);
  } // do_ajax_form_fac_solicitud_cambio_deudor_mob_validate_scd_motivo_cambio

  function do_ajax_form_fac_solicitud_cambio_deudor_mob_validate_scd_motivo_cambio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "scd_motivo_cambio";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_cambio_deudor_mob_validate_scd_motivo_cambio_cb

  // ---------- Validate scd_estado
  function do_ajax_form_fac_solicitud_cambio_deudor_mob_validate_scd_estado()
  {
    var nomeCampo_scd_estado = "scd_estado";
    var var_scd_estado = scAjaxGetFieldHidden(nomeCampo_scd_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_cambio_deudor_mob_validate_scd_estado(var_scd_estado, var_script_case_init, do_ajax_form_fac_solicitud_cambio_deudor_mob_validate_scd_estado_cb);
  } // do_ajax_form_fac_solicitud_cambio_deudor_mob_validate_scd_estado

  function do_ajax_form_fac_solicitud_cambio_deudor_mob_validate_scd_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "scd_estado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_cambio_deudor_mob_validate_scd_estado_cb

  // ---------- Validate detalles
  function do_ajax_form_fac_solicitud_cambio_deudor_mob_validate_detalles()
  {
    var nomeCampo_detalles = "detalles";
    var var_detalles = scAjaxGetFieldText(nomeCampo_detalles);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_cambio_deudor_mob_validate_detalles(var_detalles, var_script_case_init, do_ajax_form_fac_solicitud_cambio_deudor_mob_validate_detalles_cb);
  } // do_ajax_form_fac_solicitud_cambio_deudor_mob_validate_detalles

  function do_ajax_form_fac_solicitud_cambio_deudor_mob_validate_detalles_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_cambio_deudor_mob_validate_detalles_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_fac_solicitud_cambio_deudor_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_fac_solicitud_cambio_deudor_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_scd_id = scAjaxGetFieldHidden("scd_id");
    var var_scd_fecha = scAjaxGetFieldHidden("scd_fecha");
    var var_scd_propietario_actual = scAjaxGetFieldSelect("scd_propietario_actual");
    var var_scd_nuevo_propietario = scAjaxGetFieldSelect("scd_nuevo_propietario");
    var var_scd_motivo_cambio = scAjaxGetFieldText("scd_motivo_cambio");
    var var_scd_estado = scAjaxGetFieldHidden("scd_estado");
    ...
    scAjaxProcOn();
    x_ajax_form_fac_solicitud_cambio_deudor_mob_submit_form(var_scd_id, var_scd_fecha, var_scd_propietario_actual, var_scd_nuevo_propietario, var_scd_motivo_cambio, var_scd_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_fac_solicitud_cambio_deudor_mob_submit_form_cb);
  } // do_ajax_form_fac_solicitud_cambio_deudor_mob_submit_form

  function do_ajax_form_fac_solicitud_cambio_deudor_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("scd_id");
      scAjaxHideErrorDisplay("scd_fecha");
      scAjaxHideErrorDisplay("scd_propietario_actual");
      scAjaxHideErrorDisplay("scd_nuevo_propietario");
      scAjaxHideErrorDisplay("scd_motivo_cambio");
      scAjaxHideErrorDisplay("scd_estado");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_fac_solicitud_cambio_deudor_mob_submit_form_cb_after_alert);
  } // do_ajax_form_fac_solicitud_cambio_deudor_mob_submit_form_cb
  function do_ajax_form_fac_solicitud_cambio_deudor_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_fac_solicitud_cambio_deudor_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_fac_operaciones_transferir_mob"] = "off";

  function do_ajax_form_fac_solicitud_cambio_deudor_mob_navigate_form()
  {
    perform_ajax_form_fac_solicitud_cambio_deudor_mob_navigate_form();
  }

  function perform_ajax_form_fac_solicitud_cambio_deudor_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("scd_estado");
    scAjaxHideErrorDisplay("detalles");
    var var_scd_id = document.F2.scd_id.value;
    ...
    scAjaxProcOn();
    scStatusDetail["form_fac_operaciones_transferir_mob"] = "on";
    x_ajax_form_fac_solicitud_cambio_deudor_mob_navigate_form(var_scd_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_solicitud_cambio_deudor_mob_navigate_form_cb);
  } // do_ajax_form_fac_solicitud_cambio_deudor_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_cambio_deudor_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_fac_solicitud_cambio_deudor_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.scd_id.value = scAjaxGetKeyValue("scd_id");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_fac_operaciones_transferir_mob"] && "nmsc_iframe_liga_form_fac_operaciones_transferir_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_fac_operaciones_transferir_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_fac_operaciones_transferir_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_fac_operaciones_transferir_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_fac_operaciones_transferir_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_fac_operaciones_transferir_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_fac_solicitud_cambio_deudor_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_fac_solicitud_cambio_deudor_mob_navigate_form_cb
  function do_ajax_form_fac_solicitud_cambio_deudor_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_fac_solicitud_cambio_deudor_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_fac_solicitud_cambio_deudor_mob_navigate_form_cb_after_alert

  function sc_hide_form_fac_solicitud_cambio_deudor_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_fac_operaciones_transferir_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "scd_id";
  ajax_field_list[1] = "scd_fecha";
  ajax_field_list[2] = "scd_propietario_actual";
  ajax_field_list[3] = "scd_nuevo_propietario";
  ajax_field_list[4] = "scd_motivo_cambio";
  ajax_field_list[5] = "scd_estado";
  ajax_field_list[6] = "detalles";
  ...
  var ajax_error_list = {
    "scd_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "scd_fecha": {"label": "<?php echo $this->Ini->Nm_lang['lang_fecha'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "scd_propietario_actual": {"label": "<?php echo $this->Ini->Nm_lang['lang_propietario_actual'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "scd_nuevo_propietario": {"label": "<?php echo $this->Ini->Nm_lang['lang_nuevo_propietario'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "scd_motivo_cambio": {"label": "<?php echo $this->Ini->Nm_lang['lang_motivo_cambio'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "scd_estado": {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "detalles": {"label": "<?php echo $this->Ini->Nm_lang['lang_detalles'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "scd_id": new Array(),
    "scd_fecha": new Array(),
    "scd_propietario_actual": new Array(),
    "scd_nuevo_propietario": new Array(),
    "scd_motivo_cambio": new Array(),
    "scd_estado": new Array(),
    "detalles": new Array()
  };
  ajax_field_mult["scd_id"][1] = "scd_id";
  ajax_field_mult["scd_fecha"][1] = "scd_fecha";
  ajax_field_mult["scd_propietario_actual"][1] = "scd_propietario_actual";
  ajax_field_mult["scd_nuevo_propietario"][1] = "scd_nuevo_propietario";
  ajax_field_mult["scd_motivo_cambio"][1] = "scd_motivo_cambio";
  ajax_field_mult["scd_estado"][1] = "scd_estado";
  ajax_field_mult["detalles"][1] = "detalles";

  var ajax_field_id = {
    "scd_fecha": new Array("hidden_field_label_scd_fecha", "hidden_field_data_scd_fecha"),
    "scd_propietario_actual": new Array("hidden_field_label_scd_propietario_actual", "hidden_field_data_scd_propietario_actual"),
    "scd_nuevo_propietario": new Array("hidden_field_label_scd_nuevo_propietario", "hidden_field_data_scd_nuevo_propietario"),
    "scd_motivo_cambio": new Array("hidden_field_label_scd_motivo_cambio", "hidden_field_data_scd_motivo_cambio"),
    "scd_estado": new Array("hidden_field_label_scd_estado", "hidden_field_data_scd_estado"),
  ...
  var ajax_read_only = {
    "scd_id": "on",
    "scd_fecha": "off",
    "scd_propietario_actual": "off",
    "scd_nuevo_propietario": "off",
    "scd_motivo_cambio": "off",
    "scd_estado": "off",
    "detalles": "off"
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("scd_propietario_actual" == sIndex)
    {
    ...
    if ("scd_nuevo_propietario" == sIndex)
    {
      scAjaxSetFieldSelect(sIndex, aValue, null);
      updateHeaderFooter(sIndex, aValue);
