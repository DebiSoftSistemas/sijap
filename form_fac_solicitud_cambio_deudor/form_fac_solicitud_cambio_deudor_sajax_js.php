  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_fac_solicitud_cambio_deudor" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_fac_solicitud_cambio_deudor_form();
	}
...
?>
  ...
  // ---------- Validate scd_id
  function do_ajax_form_fac_solicitud_cambio_deudor_validate_scd_id()
  {
    var nomeCampo_scd_id = "scd_id";
    var var_scd_id = scAjaxGetFieldHidden(nomeCampo_scd_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_cambio_deudor_validate_scd_id(var_scd_id, var_script_case_init, do_ajax_form_fac_solicitud_cambio_deudor_validate_scd_id_cb);
  } // do_ajax_form_fac_solicitud_cambio_deudor_validate_scd_id

  function do_ajax_form_fac_solicitud_cambio_deudor_validate_scd_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_cambio_deudor_validate_scd_id_cb

  // ---------- Validate scd_fecha
  function do_ajax_form_fac_solicitud_cambio_deudor_validate_scd_fecha()
  {
    var nomeCampo_scd_fecha = "scd_fecha";
    var var_scd_fecha = scAjaxGetFieldHidden(nomeCampo_scd_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_cambio_deudor_validate_scd_fecha(var_scd_fecha, var_script_case_init, do_ajax_form_fac_solicitud_cambio_deudor_validate_scd_fecha_cb);
  } // do_ajax_form_fac_solicitud_cambio_deudor_validate_scd_fecha

  function do_ajax_form_fac_solicitud_cambio_deudor_validate_scd_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_cambio_deudor_validate_scd_fecha_cb

  // ---------- Validate scd_propietario_actual
  function do_ajax_form_fac_solicitud_cambio_deudor_validate_scd_propietario_actual()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_cambio_deudor_validate_scd_propietario_actual(var_scd_propietario_actual, var_script_case_init, do_ajax_form_fac_solicitud_cambio_deudor_validate_scd_propietario_actual_cb);
  } // do_ajax_form_fac_solicitud_cambio_deudor_validate_scd_propietario_actual

  function do_ajax_form_fac_solicitud_cambio_deudor_validate_scd_propietario_actual_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_cambio_deudor_validate_scd_propietario_actual_cb

  // ---------- Validate scd_nuevo_propietario
  function do_ajax_form_fac_solicitud_cambio_deudor_validate_scd_nuevo_propietario()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_cambio_deudor_validate_scd_nuevo_propietario(var_scd_nuevo_propietario, var_script_case_init, do_ajax_form_fac_solicitud_cambio_deudor_validate_scd_nuevo_propietario_cb);
  } // do_ajax_form_fac_solicitud_cambio_deudor_validate_scd_nuevo_propietario

  function do_ajax_form_fac_solicitud_cambio_deudor_validate_scd_nuevo_propietario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_cambio_deudor_validate_scd_nuevo_propietario_cb

  // ---------- Validate scd_motivo_cambio
  function do_ajax_form_fac_solicitud_cambio_deudor_validate_scd_motivo_cambio()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_cambio_deudor_validate_scd_motivo_cambio(var_scd_motivo_cambio, var_script_case_init, do_ajax_form_fac_solicitud_cambio_deudor_validate_scd_motivo_cambio_cb);
  } // do_ajax_form_fac_solicitud_cambio_deudor_validate_scd_motivo_cambio

  function do_ajax_form_fac_solicitud_cambio_deudor_validate_scd_motivo_cambio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_cambio_deudor_validate_scd_motivo_cambio_cb

  // ---------- Validate scd_estado
  function do_ajax_form_fac_solicitud_cambio_deudor_validate_scd_estado()
  {
    var nomeCampo_scd_estado = "scd_estado";
    var var_scd_estado = scAjaxGetFieldHidden(nomeCampo_scd_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_cambio_deudor_validate_scd_estado(var_scd_estado, var_script_case_init, do_ajax_form_fac_solicitud_cambio_deudor_validate_scd_estado_cb);
  } // do_ajax_form_fac_solicitud_cambio_deudor_validate_scd_estado

  function do_ajax_form_fac_solicitud_cambio_deudor_validate_scd_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_cambio_deudor_validate_scd_estado_cb

  // ---------- Validate detalles
  function do_ajax_form_fac_solicitud_cambio_deudor_validate_detalles()
  {
    var nomeCampo_detalles = "detalles";
    var var_detalles = scAjaxGetFieldText(nomeCampo_detalles);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_cambio_deudor_validate_detalles(var_detalles, var_script_case_init, do_ajax_form_fac_solicitud_cambio_deudor_validate_detalles_cb);
  } // do_ajax_form_fac_solicitud_cambio_deudor_validate_detalles

  function do_ajax_form_fac_solicitud_cambio_deudor_validate_detalles_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_cambio_deudor_validate_detalles_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_fac_solicitud_cambio_deudor_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_fac_solicitud_cambio_deudor_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_fac_solicitud_cambio_deudor_submit_form(var_scd_id, var_scd_fecha, var_scd_propietario_actual, var_scd_nuevo_propietario, var_scd_motivo_cambio, var_scd_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_fac_solicitud_cambio_deudor_submit_form_cb);
  } // do_ajax_form_fac_solicitud_cambio_deudor_submit_form

  function do_ajax_form_fac_solicitud_cambio_deudor_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_fac_solicitud_cambio_deudor_submit_form_cb_after_alert);
  } // do_ajax_form_fac_solicitud_cambio_deudor_submit_form_cb
  function do_ajax_form_fac_solicitud_cambio_deudor_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_fac_solicitud_cambio_deudor_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_fac_operaciones_transferir"] = "off";

  function do_ajax_form_fac_solicitud_cambio_deudor_navigate_form()
  {
    perform_ajax_form_fac_solicitud_cambio_deudor_navigate_form();
  }

  function perform_ajax_form_fac_solicitud_cambio_deudor_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_fac_operaciones_transferir"] = "on";
    x_ajax_form_fac_solicitud_cambio_deudor_navigate_form(var_scd_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_solicitud_cambio_deudor_navigate_form_cb);
  } // do_ajax_form_fac_solicitud_cambio_deudor_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_cambio_deudor']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_fac_solicitud_cambio_deudor_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_fac_operaciones_transferir"] && "nmsc_iframe_liga_form_fac_operaciones_transferir" != scMasterDetailIframe["nmsc_iframe_liga_form_fac_operaciones_transferir"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_fac_operaciones_transferir"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_fac_operaciones_transferir').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_fac_operaciones_transferir').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_fac_operaciones_transferir').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_fac_solicitud_cambio_deudor_navigate_form_cb_after_alert);
  } // do_ajax_form_fac_solicitud_cambio_deudor_navigate_form_cb
  function do_ajax_form_fac_solicitud_cambio_deudor_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_fac_solicitud_cambio_deudor_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_fac_solicitud_cambio_deudor_navigate_form_cb_after_alert

  function sc_hide_form_fac_solicitud_cambio_deudor_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_fac_operaciones_transferir"])
    {
      return true;
    }
    return false;
