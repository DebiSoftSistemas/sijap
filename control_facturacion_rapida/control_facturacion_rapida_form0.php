...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>control_facturacion_rapida/control_facturacion_rapida_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("control_facturacion_rapida_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('control_facturacion_rapida_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['link_info']['remove_border']) {
...
<?php
 include_once("control_facturacion_rapida_js0.php");
?>
<script type="text/javascript"> 
nmdg_enter_tab = true;
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_facturacion_rapida'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_facturacion_rapida'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['empty_filter'] = true;
       }
  }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fr_idservicio_label" id="hidden_field_label_fr_idservicio" style="<?php echo $sStyleHidden_fr_idservicio; ?>"><span id="id_label_fr_idservicio"><?php echo $this->nm_new_label['fr_idservicio']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_idservicio']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_idservicio'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fr_servicio_label" id="hidden_field_label_fr_servicio" style="<?php echo $sStyleHidden_fr_servicio; ?>"><span id="id_label_fr_servicio"><?php echo $this->nm_new_label['fr_servicio']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_servicio']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_servicio'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_fr_servicio_line" id="hidden_field_data_fr_servicio" style="<?php echo $sStyleHidden_fr_servicio; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fr_cantidad_label" id="hidden_field_label_fr_cantidad" style="<?php echo $sStyleHidden_fr_cantidad; ?>"><span id="id_label_fr_cantidad"><?php echo $this->nm_new_label['fr_cantidad']; ?></span></TD>
    <TD class="scFormDataOdd css_fr_cantidad_line" id="hidden_field_data_fr_cantidad" style="<?php echo $sStyleHidden_fr_cantidad; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fr_valor_label" id="hidden_field_label_fr_valor" style="<?php echo $sStyleHidden_fr_valor; ?>"><span id="id_label_fr_valor"><?php echo $this->nm_new_label['fr_valor']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_valor']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_valor'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fr_valor_fijo_label" id="hidden_field_label_fr_valor_fijo" style="<?php echo $sStyleHidden_fr_valor_fijo; ?>"><span id="id_label_fr_valor_fijo"><?php echo $this->nm_new_label['fr_valor_fijo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_valor_fijo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_valor_fijo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_fr_valor_fijo_line" id="hidden_field_data_fr_valor_fijo" style="<?php echo $sStyleHidden_fr_valor_fijo; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fr_forma_pago_label" id="hidden_field_label_fr_forma_pago" style="<?php echo $sStyleHidden_fr_forma_pago; ?>"><span id="id_label_fr_forma_pago"><?php echo $this->nm_new_label['fr_forma_pago']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_forma_pago']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_forma_pago'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fr_total_label" id="hidden_field_label_fr_total" style="<?php echo $sStyleHidden_fr_total; ?>"><span id="id_label_fr_total"><?php echo $this->nm_new_label['fr_total']; ?></span></TD>
    <TD class="scFormDataOdd css_fr_total_line" id="hidden_field_data_fr_total" style="<?php echo $sStyleHidden_fr_total; ?>"><input type="hidden" name="fr_total" value="<?php echo $this->form_encode_input($fr_total); ?>"><span id="id_ajax_label_fr_total"><?php echo nl2br($fr_total); ?></span>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fr_comentario_label" id="hidden_field_label_fr_comentario" style="<?php echo $sStyleHidden_fr_comentario; ?>"><span id="id_label_fr_comentario"><?php echo $this->nm_new_label['fr_comentario']; ?></span></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fr_cedula_label" id="hidden_field_label_fr_cedula" style="<?php echo $sStyleHidden_fr_cedula; ?>"><span id="id_label_fr_cedula"><?php echo $this->nm_new_label['fr_cedula']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_cedula']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_cedula'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_fr_cedula_line" id="hidden_field_data_fr_cedula" style="<?php echo $sStyleHidden_fr_cedula; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fr_nombre_label" id="hidden_field_label_fr_nombre" style="<?php echo $sStyleHidden_fr_nombre; ?>"><span id="id_label_fr_nombre"><?php echo $this->nm_new_label['fr_nombre']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_nombre']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_nombre'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_fr_nombre_line" id="hidden_field_data_fr_nombre" style="<?php echo $sStyleHidden_fr_nombre; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fr_provincia_label" id="hidden_field_label_fr_provincia" style="<?php echo $sStyleHidden_fr_provincia; ?>"><span id="id_label_fr_provincia"><?php echo $this->nm_new_label['fr_provincia']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_provincia']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_provincia'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_fr_provincia_line" id="hidden_field_data_fr_provincia" style="<?php echo $sStyleHidden_fr_provincia; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fr_canton_label" id="hidden_field_label_fr_canton" style="<?php echo $sStyleHidden_fr_canton; ?>"><span id="id_label_fr_canton"><?php echo $this->nm_new_label['fr_canton']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_canton']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_canton'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_fr_canton_line" id="hidden_field_data_fr_canton" style="<?php echo $sStyleHidden_fr_canton; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fr_direccion_label" id="hidden_field_label_fr_direccion" style="<?php echo $sStyleHidden_fr_direccion; ?>"><span id="id_label_fr_direccion"><?php echo $this->nm_new_label['fr_direccion']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_direccion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_direccion'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_fr_direccion_line" id="hidden_field_data_fr_direccion" style="<?php echo $sStyleHidden_fr_direccion; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fr_tipo_identificacion_label" id="hidden_field_label_fr_tipo_identificacion" style="<?php echo $sStyleHidden_fr_tipo_identificacion; ?>"><span id="id_label_fr_tipo_identificacion"><?php echo $this->nm_new_label['fr_tipo_identificacion']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_tipo_identificacion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_tipo_identificacion'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_fr_tipo_identificacion_line" id="hidden_field_data_fr_tipo_identificacion" style="<?php echo $sStyleHidden_fr_tipo_identificacion; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fr_correo_label" id="hidden_field_label_fr_correo" style="<?php echo $sStyleHidden_fr_correo; ?>"><span id="id_label_fr_correo"><?php echo $this->nm_new_label['fr_correo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_correo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['php_cmp_required']['fr_correo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_fr_correo_line" id="hidden_field_data_fr_correo" style="<?php echo $sStyleHidden_fr_correo; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fr_telefono_label" id="hidden_field_label_fr_telefono" style="<?php echo $sStyleHidden_fr_telefono; ?>"><span id="id_label_fr_telefono"><?php echo $this->nm_new_label['fr_telefono']; ?></span></TD>
    <TD class="scFormDataOdd css_fr_telefono_line" id="hidden_field_data_fr_telefono" style="<?php echo $sStyleHidden_fr_telefono; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fr_valor_minimo_label" id="hidden_field_label_fr_valor_minimo" style="<?php echo $sStyleHidden_fr_valor_minimo; ?>"><span id="id_label_fr_valor_minimo"><?php echo $this->nm_new_label['fr_valor_minimo']; ?></span></TD>
    <TD class="scFormDataOdd css_fr_valor_minimo_line" id="hidden_field_data_fr_valor_minimo" style="<?php echo $sStyleHidden_fr_valor_minimo; ?>">
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['btn_disabled']['ok']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['btn_disabled']['ok']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['btn_label']['ok']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['btn_label']['ok']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['btn_label']['ok'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['btn_label']['help'];
        }
?>
...
<?php
    if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['nm_run_menu'] != 1))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['btn_label']['exit'];
        }
?>
...
<?php
    if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("control_facturacion_rapida");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("control_facturacion_rapida");
 parent.scAjaxDetailHeight("control_facturacion_rapida", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
