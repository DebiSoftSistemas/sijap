  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_facturacion_rapida" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_facturacion_rapida_form();
	}
...
?>
  ...
  function do_ajax_control_facturacion_rapida_validate_fr_idservicio()
  {
    var nomeCampo_fr_idservicio = "fr_idservicio";
    var var_fr_idservicio = scAjaxGetFieldText(nomeCampo_fr_idservicio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_facturacion_rapida_validate_fr_idservicio(var_fr_idservicio, var_script_case_init, do_ajax_control_facturacion_rapida_validate_fr_idservicio_cb);
  } // do_ajax_control_facturacion_rapida_validate_fr_idservicio

  function do_ajax_control_facturacion_rapida_validate_fr_idservicio_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_facturacion_rapida_validate_fr_idservicio_cb

  // ---------- Validate fr_servicio
  function do_ajax_control_facturacion_rapida_validate_fr_servicio()
  {
    var nomeCampo_fr_servicio = "fr_servicio";
    var var_fr_servicio = scAjaxGetFieldText(nomeCampo_fr_servicio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_facturacion_rapida_validate_fr_servicio(var_fr_servicio, var_script_case_init, do_ajax_control_facturacion_rapida_validate_fr_servicio_cb);
  } // do_ajax_control_facturacion_rapida_validate_fr_servicio

  function do_ajax_control_facturacion_rapida_validate_fr_servicio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_facturacion_rapida_validate_fr_servicio_cb

  // ---------- Validate fr_cantidad
  function do_ajax_control_facturacion_rapida_validate_fr_cantidad()
  {
    var nomeCampo_fr_cantidad = "fr_cantidad";
    var var_fr_cantidad = scAjaxGetFieldText(nomeCampo_fr_cantidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_facturacion_rapida_validate_fr_cantidad(var_fr_cantidad, var_script_case_init, do_ajax_control_facturacion_rapida_validate_fr_cantidad_cb);
  } // do_ajax_control_facturacion_rapida_validate_fr_cantidad

  function do_ajax_control_facturacion_rapida_validate_fr_cantidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_facturacion_rapida_validate_fr_cantidad_cb

  // ---------- Validate fr_valor
  function do_ajax_control_facturacion_rapida_validate_fr_valor()
  {
    var nomeCampo_fr_valor = "fr_valor";
    var var_fr_valor = scAjaxGetFieldText(nomeCampo_fr_valor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_facturacion_rapida_validate_fr_valor(var_fr_valor, var_script_case_init, do_ajax_control_facturacion_rapida_validate_fr_valor_cb);
  } // do_ajax_control_facturacion_rapida_validate_fr_valor

  function do_ajax_control_facturacion_rapida_validate_fr_valor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_facturacion_rapida_validate_fr_valor_cb

  // ---------- Validate fr_valor_fijo
  function do_ajax_control_facturacion_rapida_validate_fr_valor_fijo()
  {
    var nomeCampo_fr_valor_fijo = "fr_valor_fijo";
    var var_fr_valor_fijo = scAjaxGetFieldText(nomeCampo_fr_valor_fijo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_facturacion_rapida_validate_fr_valor_fijo(var_fr_valor_fijo, var_script_case_init, do_ajax_control_facturacion_rapida_validate_fr_valor_fijo_cb);
  } // do_ajax_control_facturacion_rapida_validate_fr_valor_fijo

  function do_ajax_control_facturacion_rapida_validate_fr_valor_fijo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_facturacion_rapida_validate_fr_valor_fijo_cb

  // ---------- Validate fr_forma_pago
  function do_ajax_control_facturacion_rapida_validate_fr_forma_pago()
  {
    var nomeCampo_fr_forma_pago = "fr_forma_pago";
    var var_fr_forma_pago = scAjaxGetFieldSelect(nomeCampo_fr_forma_pago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_facturacion_rapida_validate_fr_forma_pago(var_fr_forma_pago, var_script_case_init, do_ajax_control_facturacion_rapida_validate_fr_forma_pago_cb);
  } // do_ajax_control_facturacion_rapida_validate_fr_forma_pago

  function do_ajax_control_facturacion_rapida_validate_fr_forma_pago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_facturacion_rapida_validate_fr_forma_pago_cb

  // ---------- Validate fr_total
  function do_ajax_control_facturacion_rapida_validate_fr_total()
  {
    var nomeCampo_fr_total = "fr_total";
    var var_fr_total = scAjaxGetFieldHidden(nomeCampo_fr_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_facturacion_rapida_validate_fr_total(var_fr_total, var_script_case_init, do_ajax_control_facturacion_rapida_validate_fr_total_cb);
  } // do_ajax_control_facturacion_rapida_validate_fr_total

  function do_ajax_control_facturacion_rapida_validate_fr_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_facturacion_rapida_validate_fr_total_cb

  // ---------- Validate fr_comentario
  function do_ajax_control_facturacion_rapida_validate_fr_comentario()
  {
    var nomeCampo_fr_comentario = "fr_comentario";
    var var_fr_comentario = scAjaxGetFieldText(nomeCampo_fr_comentario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_facturacion_rapida_validate_fr_comentario(var_fr_comentario, var_script_case_init, do_ajax_control_facturacion_rapida_validate_fr_comentario_cb);
  } // do_ajax_control_facturacion_rapida_validate_fr_comentario

  function do_ajax_control_facturacion_rapida_validate_fr_comentario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_facturacion_rapida_validate_fr_comentario_cb

  // ---------- Validate fr_cedula
  function do_ajax_control_facturacion_rapida_validate_fr_cedula()
  {
    var nomeCampo_fr_cedula = "fr_cedula";
    var var_fr_cedula = scAjaxGetFieldText(nomeCampo_fr_cedula);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_facturacion_rapida_validate_fr_cedula(var_fr_cedula, var_script_case_init, do_ajax_control_facturacion_rapida_validate_fr_cedula_cb);
  } // do_ajax_control_facturacion_rapida_validate_fr_cedula

  function do_ajax_control_facturacion_rapida_validate_fr_cedula_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_facturacion_rapida_validate_fr_cedula_cb

  // ---------- Validate fr_nombre
  function do_ajax_control_facturacion_rapida_validate_fr_nombre()
  {
    var nomeCampo_fr_nombre = "fr_nombre";
    var var_fr_nombre = scAjaxGetFieldText(nomeCampo_fr_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_facturacion_rapida_validate_fr_nombre(var_fr_nombre, var_script_case_init, do_ajax_control_facturacion_rapida_validate_fr_nombre_cb);
  } // do_ajax_control_facturacion_rapida_validate_fr_nombre

  function do_ajax_control_facturacion_rapida_validate_fr_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_facturacion_rapida_validate_fr_nombre_cb

  // ---------- Validate fr_provincia
  function do_ajax_control_facturacion_rapida_validate_fr_provincia()
  {
    var nomeCampo_fr_provincia = "fr_provincia";
    var var_fr_provincia = scAjaxGetFieldSelect(nomeCampo_fr_provincia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_facturacion_rapida_validate_fr_provincia(var_fr_provincia, var_script_case_init, do_ajax_control_facturacion_rapida_validate_fr_provincia_cb);
  } // do_ajax_control_facturacion_rapida_validate_fr_provincia

  function do_ajax_control_facturacion_rapida_validate_fr_provincia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_facturacion_rapida_validate_fr_provincia_cb

  // ---------- Validate fr_canton
  function do_ajax_control_facturacion_rapida_validate_fr_canton()
  {
    var nomeCampo_fr_canton = "fr_canton";
    var var_fr_canton = scAjaxGetFieldSelect(nomeCampo_fr_canton);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_facturacion_rapida_validate_fr_canton(var_fr_canton, var_script_case_init, do_ajax_control_facturacion_rapida_validate_fr_canton_cb);
  } // do_ajax_control_facturacion_rapida_validate_fr_canton

  function do_ajax_control_facturacion_rapida_validate_fr_canton_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_facturacion_rapida_validate_fr_canton_cb

  // ---------- Validate fr_direccion
  function do_ajax_control_facturacion_rapida_validate_fr_direccion()
  {
    var nomeCampo_fr_direccion = "fr_direccion";
    var var_fr_direccion = scAjaxGetFieldText(nomeCampo_fr_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_facturacion_rapida_validate_fr_direccion(var_fr_direccion, var_script_case_init, do_ajax_control_facturacion_rapida_validate_fr_direccion_cb);
  } // do_ajax_control_facturacion_rapida_validate_fr_direccion

  function do_ajax_control_facturacion_rapida_validate_fr_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_facturacion_rapida_validate_fr_direccion_cb

  // ---------- Validate fr_tipo_identificacion
  function do_ajax_control_facturacion_rapida_validate_fr_tipo_identificacion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_facturacion_rapida_validate_fr_tipo_identificacion(var_fr_tipo_identificacion, var_script_case_init, do_ajax_control_facturacion_rapida_validate_fr_tipo_identificacion_cb);
  } // do_ajax_control_facturacion_rapida_validate_fr_tipo_identificacion

  function do_ajax_control_facturacion_rapida_validate_fr_tipo_identificacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_facturacion_rapida_validate_fr_tipo_identificacion_cb

  // ---------- Validate fr_correo
  function do_ajax_control_facturacion_rapida_validate_fr_correo()
  {
    var nomeCampo_fr_correo = "fr_correo";
    var var_fr_correo = scAjaxGetFieldText(nomeCampo_fr_correo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_facturacion_rapida_validate_fr_correo(var_fr_correo, var_script_case_init, do_ajax_control_facturacion_rapida_validate_fr_correo_cb);
  } // do_ajax_control_facturacion_rapida_validate_fr_correo

  function do_ajax_control_facturacion_rapida_validate_fr_correo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_facturacion_rapida_validate_fr_correo_cb

  // ---------- Validate fr_telefono
  function do_ajax_control_facturacion_rapida_validate_fr_telefono()
  {
    var nomeCampo_fr_telefono = "fr_telefono";
    var var_fr_telefono = scAjaxGetFieldText(nomeCampo_fr_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_facturacion_rapida_validate_fr_telefono(var_fr_telefono, var_script_case_init, do_ajax_control_facturacion_rapida_validate_fr_telefono_cb);
  } // do_ajax_control_facturacion_rapida_validate_fr_telefono

  function do_ajax_control_facturacion_rapida_validate_fr_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_facturacion_rapida_validate_fr_telefono_cb

  // ---------- Validate fr_valor_minimo
  function do_ajax_control_facturacion_rapida_validate_fr_valor_minimo()
  {
    var nomeCampo_fr_valor_minimo = "fr_valor_minimo";
    var var_fr_valor_minimo = scAjaxGetFieldText(nomeCampo_fr_valor_minimo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_facturacion_rapida_validate_fr_valor_minimo(var_fr_valor_minimo, var_script_case_init, do_ajax_control_facturacion_rapida_validate_fr_valor_minimo_cb);
  } // do_ajax_control_facturacion_rapida_validate_fr_valor_minimo

  function do_ajax_control_facturacion_rapida_validate_fr_valor_minimo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_facturacion_rapida_validate_fr_valor_minimo_cb

  // ---------- Refresh fr_provincia
  function do_ajax_control_facturacion_rapida_refresh_fr_provincia()
  {
    var var_fr_provincia = scAjaxGetFieldSelect("fr_provincia");
    var var_nmgp_refresh_fields = "fr_canton";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_control_facturacion_rapida_refresh_fr_provincia(var_fr_provincia, var_nmgp_refresh_fields, var_script_case_init, do_ajax_control_facturacion_rapida_refresh_fr_provincia_cb);
  } // do_ajax_control_facturacion_rapida_refresh_fr_provincia

  function do_ajax_control_facturacion_rapida_refresh_fr_provincia_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_facturacion_rapida_refresh_fr_provincia_cb

  // ---------- Event onchange fr_cantidad
  function do_ajax_control_facturacion_rapida_event_fr_cantidad_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_control_facturacion_rapida_event_fr_cantidad_onchange(var_fr_cantidad, var_fr_total, var_fr_valor, var_script_case_init, do_ajax_control_facturacion_rapida_event_fr_cantidad_onchange_cb);
  } // do_ajax_control_facturacion_rapida_event_fr_cantidad_onchange

  function do_ajax_control_facturacion_rapida_event_fr_cantidad_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "fr_cantidad";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_control_facturacion_rapida_event_fr_cantidad_onchange_cb_after_alert);
  } // do_ajax_control_facturacion_rapida_event_fr_cantidad_onchange_cb
  function do_ajax_control_facturacion_rapida_event_fr_cantidad_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_control_facturacion_rapida_event_fr_cantidad_onchange_cb_after_alert

  // ---------- Event onblur fr_cedula
  function do_ajax_control_facturacion_rapida_event_fr_cedula_onblur()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_control_facturacion_rapida_event_fr_cedula_onblur(var_fr_cedula, var_fr_tipo_identificacion, var_fr_nombre, var_fr_provincia, var_fr_canton, var_fr_direccion, var_fr_correo, var_fr_telefono, var_script_case_init, do_ajax_control_facturacion_rapida_event_fr_cedula_onblur_cb);
  } // do_ajax_control_facturacion_rapida_event_fr_cedula_onblur

  function do_ajax_control_facturacion_rapida_event_fr_cedula_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "fr_cedula";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_control_facturacion_rapida_event_fr_cedula_onblur_cb_after_alert);
  } // do_ajax_control_facturacion_rapida_event_fr_cedula_onblur_cb
  function do_ajax_control_facturacion_rapida_event_fr_cedula_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_control_facturacion_rapida_event_fr_cedula_onblur_cb_after_alert

  // ---------- Event onchange fr_cedula
  function do_ajax_control_facturacion_rapida_event_fr_cedula_onchange()
  {
    var var_fr_cedula = scAjaxGetFieldText("fr_cedula");
    var var_fr_tipo_identificacion = scAjaxGetFieldText("fr_tipo_identificacion");
    var var_fr_nombre = scAjaxGetFieldText("fr_nombre");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_control_facturacion_rapida_event_fr_cedula_onchange(var_fr_cedula, var_fr_tipo_identificacion, var_fr_nombre, var_fr_provincia, var_fr_canton, var_fr_direccion, var_fr_correo, var_fr_telefono, var_script_case_init, do_ajax_control_facturacion_rapida_event_fr_cedula_onchange_cb);
  } // do_ajax_control_facturacion_rapida_event_fr_cedula_onchange

  function do_ajax_control_facturacion_rapida_event_fr_cedula_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "fr_cedula";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_control_facturacion_rapida_event_fr_cedula_onchange_cb_after_alert);
  } // do_ajax_control_facturacion_rapida_event_fr_cedula_onchange_cb
  function do_ajax_control_facturacion_rapida_event_fr_cedula_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_control_facturacion_rapida_event_fr_cedula_onchange_cb_after_alert

  // ---------- Event onchange fr_valor
  function do_ajax_control_facturacion_rapida_event_fr_valor_onchange()
  {
    var var_fr_total = scAjaxGetFieldHidden("fr_total");
    var var_fr_cantidad = scAjaxGetFieldText("fr_cantidad");
    var var_fr_valor = scAjaxGetFieldText("fr_valor");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_control_facturacion_rapida_event_fr_valor_onchange(var_fr_total, var_fr_cantidad, var_fr_valor, var_script_case_init, do_ajax_control_facturacion_rapida_event_fr_valor_onchange_cb);
  } // do_ajax_control_facturacion_rapida_event_fr_valor_onchange

  function do_ajax_control_facturacion_rapida_event_fr_valor_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "fr_valor";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_control_facturacion_rapida_event_fr_valor_onchange_cb_after_alert);
  } // do_ajax_control_facturacion_rapida_event_fr_valor_onchange_cb
  function do_ajax_control_facturacion_rapida_event_fr_valor_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_control_facturacion_rapida_event_fr_valor_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_facturacion_rapida_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_facturacion_rapida_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_control_facturacion_rapida_submit_form(var_fr_idservicio, var_fr_servicio, var_fr_cantidad, var_fr_valor, var_fr_valor_fijo, var_fr_forma_pago, var_fr_total, var_fr_comentario, var_fr_cedula, var_fr_nombre, var_fr_provincia, var_fr_canton, var_fr_direccion, var_fr_tipo_identificacion, var_fr_correo, var_fr_telefono, var_fr_valor_minimo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_facturacion_rapida_submit_form_cb);
  } // do_ajax_control_facturacion_rapida_submit_form

  function do_ajax_control_facturacion_rapida_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_facturacion_rapida_submit_form_cb_after_alert);
  } // do_ajax_control_facturacion_rapida_submit_form_cb
  function do_ajax_control_facturacion_rapida_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_facturacion_rapida_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_facturacion_rapida_navigate_form()
  {
    perform_ajax_control_facturacion_rapida_navigate_form();
  }

  function perform_ajax_control_facturacion_rapida_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_facturacion_rapida_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_facturacion_rapida']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_facturacion_rapida_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_facturacion_rapida_navigate_form_cb_after_alert);
  } // do_ajax_control_facturacion_rapida_navigate_form_cb
  function do_ajax_control_facturacion_rapida_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_control_facturacion_rapida_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_facturacion_rapida_navigate_form_cb_after_alert

  function sc_hide_control_facturacion_rapida_form()
  {
