 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_est_nombre_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['est_nombre'])) ? $this->New_label['est_nombre'] : "" . $this->Ini->Nm_lang['lang_nombre_establecimiento'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_est_nombre_cond" name="est_nombre_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_est_nombre" <?php echo $str_hide_est_nombre?> valign="top">
...
<select class="sc-js-input scFilterObjectOdd css_est_nombre_fil_obj sc-ui-autocomp-est_nombre" id="id_ac_est_nombre" name="est_nombre_autocomp"><?php if ('' !=  $est_nombre) { ?><option value="<?php echo $est_nombre ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_est_codigo_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['est_codigo'])) ? $this->New_label['est_codigo'] : "" . $this->Ini->Nm_lang['lang_codigo_sri'] . ""; ?></TD>
