  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_jap_tipo_inspeccion" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_jap_tipo_inspeccion_form();
	}
...
?>
  ...
  // ---------- Validate ti_id_
  function do_ajax_form_jap_tipo_inspeccion_validate_ti_id_(iNumLinha)
  {
    var nomeCampo_ti_id_ = "ti_id_" + iNumLinha;
    var var_ti_id_ = scAjaxGetFieldHidden(nomeCampo_ti_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_tipo_inspeccion_validate_ti_id_(var_ti_id_, iNumLinha, var_script_case_init, do_ajax_form_jap_tipo_inspeccion_validate_ti_id__cb);
  } // do_ajax_form_jap_tipo_inspeccion_validate_ti_id_

  function do_ajax_form_jap_tipo_inspeccion_validate_ti_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "ti_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ti_id_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "ti_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ti_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_tipo_inspeccion_validate_ti_id__cb

  // ---------- Validate ti_empresa_
  function do_ajax_form_jap_tipo_inspeccion_validate_ti_empresa_(iNumLinha)
  {
    var nomeCampo_ti_empresa_ = "ti_empresa_" + iNumLinha;
    var var_ti_empresa_ = scAjaxGetFieldText(nomeCampo_ti_empresa_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_tipo_inspeccion_validate_ti_empresa_(var_ti_empresa_, iNumLinha, var_script_case_init, do_ajax_form_jap_tipo_inspeccion_validate_ti_empresa__cb);
  } // do_ajax_form_jap_tipo_inspeccion_validate_ti_empresa_

  function do_ajax_form_jap_tipo_inspeccion_validate_ti_empresa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "ti_empresa_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ti_empresa_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "ti_empresa_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ti_empresa_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_tipo_inspeccion_validate_ti_empresa__cb

  // ---------- Validate ti_descripcion_
  function do_ajax_form_jap_tipo_inspeccion_validate_ti_descripcion_(iNumLinha)
  {
    var nomeCampo_ti_descripcion_ = "ti_descripcion_" + iNumLinha;
    var var_ti_descripcion_ = scAjaxGetFieldText(nomeCampo_ti_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_tipo_inspeccion_validate_ti_descripcion_(var_ti_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_jap_tipo_inspeccion_validate_ti_descripcion__cb);
  } // do_ajax_form_jap_tipo_inspeccion_validate_ti_descripcion_

  function do_ajax_form_jap_tipo_inspeccion_validate_ti_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "ti_descripcion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ti_descripcion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "ti_descripcion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ti_descripcion_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_tipo_inspeccion_validate_ti_descripcion__cb

  // ---------- Validate ti_estado_
  function do_ajax_form_jap_tipo_inspeccion_validate_ti_estado_(iNumLinha)
  {
    var nomeCampo_ti_estado_ = "ti_estado_" + iNumLinha;
    var var_ti_estado_ = scAjaxGetFieldSelect(nomeCampo_ti_estado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_tipo_inspeccion_validate_ti_estado_(var_ti_estado_, iNumLinha, var_script_case_init, do_ajax_form_jap_tipo_inspeccion_validate_ti_estado__cb);
  } // do_ajax_form_jap_tipo_inspeccion_validate_ti_estado_

  function do_ajax_form_jap_tipo_inspeccion_validate_ti_estado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_tipo_inspeccion_validate_ti_estado__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_jap_tipo_inspeccion_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_jap_tipo_inspeccion_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_jap_tipo_inspeccion_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_jap_tipo_inspeccion_add_new_line_cb);
  } // do_ajax_form_jap_tipo_inspeccion_add_new_line

  function do_ajax_form_jap_tipo_inspeccion_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_jap_tipo_inspeccion_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_jap_tipo_inspeccion_backup_line(iNumLinha)
  {
    var var_ti_id_ = scAjaxGetFieldHidden("ti_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_tipo_inspeccion_backup_line(var_ti_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_jap_tipo_inspeccion_backup_line_cb);
  } // do_ajax_form_jap_tipo_inspeccion_backup_line

  function do_ajax_form_jap_tipo_inspeccion_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_jap_tipo_inspeccion_backup_line_cb

  function do_ajax_form_jap_tipo_inspeccion_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_jap_tipo_inspeccion_cancel_insert

  function do_ajax_form_jap_tipo_inspeccion_cancel_update(iSeqVert)
  {
    do_ajax_form_jap_tipo_inspeccion_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_jap_tipo_inspeccion_cancel_update

  function do_ajax_form_jap_tipo_inspeccion_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_jap_tipo_inspeccion_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_jap_tipo_inspeccion_table_refresh()
  {
    var var_ti_id_ = document.F2.ti_id_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_jap_tipo_inspeccion_table_refresh(var_ti_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jap_tipo_inspeccion_table_refresh_cb);
  } //  do_ajax_form_jap_tipo_inspeccion_table_refresh

  function do_ajax_form_jap_tipo_inspeccion_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.ti_id_.value = scAjaxGetKeyValue("ti_id_");
    ...
    scAjaxAlert(do_ajax_form_jap_tipo_inspeccion_table_refresh_cb_after_alert);
  } // do_ajax_form_jap_tipo_inspeccion_table_refresh_cb
  function do_ajax_form_jap_tipo_inspeccion_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_jap_tipo_inspeccion_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_jap_tipo_inspeccion_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_jap_tipo_inspeccion_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_ti_id_ = scAjaxGetFieldHidden("ti_id_" + iNumLinha);
    var var_ti_empresa_ = scAjaxGetFieldText("ti_empresa_" + iNumLinha);
    var var_ti_descripcion_ = scAjaxGetFieldText("ti_descripcion_" + iNumLinha);
...
?>
    x_ajax_form_jap_tipo_inspeccion_submit_form(var_ti_id_, var_ti_empresa_, var_ti_descripcion_, var_ti_estado_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_jap_tipo_inspeccion_submit_form_cb);
  } // do_ajax_form_jap_tipo_inspeccion_submit_form

  function do_ajax_form_jap_tipo_inspeccion_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("ti_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("ti_empresa_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("ti_descripcion_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_jap_tipo_inspeccion_submit_form_cb_after_alert);
  } // do_ajax_form_jap_tipo_inspeccion_submit_form_cb
  function do_ajax_form_jap_tipo_inspeccion_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_jap_tipo_inspeccion_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_jap_tipo_inspeccion_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_jap_tipo_inspeccion_navigate_form, function() {});
    } else {
      perform_ajax_form_jap_tipo_inspeccion_navigate_form();
    }
  }

  function perform_ajax_form_jap_tipo_inspeccion_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_jap_tipo_inspeccion_cancel_insert(sc_form_jap_tipo_inspeccion_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("ti_id_" + iNavForm);
      scAjaxHideErrorDisplay("ti_empresa_" + iNavForm);
      scAjaxHideErrorDisplay("ti_descripcion_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_jap_tipo_inspeccion_navigate_form(var_ti_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jap_tipo_inspeccion_navigate_form_cb);
  } // do_ajax_form_jap_tipo_inspeccion_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_tipo_inspeccion']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_jap_tipo_inspeccion_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.ti_id_.value = scAjaxGetKeyValue("ti_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_jap_tipo_inspeccion_navigate_form_cb_after_alert);
  } // do_ajax_form_jap_tipo_inspeccion_navigate_form_cb
  function do_ajax_form_jap_tipo_inspeccion_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_jap_tipo_inspeccion_navigate_form_cb_after_alert

    function sc_form_jap_tipo_inspeccion_get_last_line_number()
    {
    ...
    } //sc_form_jap_tipo_inspeccion_get_last_line_number

  function sc_hide_form_jap_tipo_inspeccion_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "ti_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "ti_empresa_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "ti_descripcion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "ti_estado_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["ti_id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["ti_empresa_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_empresa'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["ti_descripcion_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_descripcion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["ti_id_"][iNumLinha] = "ti_id_" + iNumLinha;
    ajax_field_mult["ti_empresa_"][iNumLinha] = "ti_empresa_" + iNumLinha;
    ajax_field_mult["ti_descripcion_"][iNumLinha] = "ti_descripcion_" + iNumLinha;
    ajax_field_mult["ti_estado_"][iNumLinha] = "ti_estado_" + iNumLinha;
    ajax_field_id["ti_descripcion_" + iNumLinha] = new Array("hidden_field_label_ti_descripcion_", "hidden_field_data_ti_descripcion_" + iNumLinha);
    ajax_field_id["ti_estado_" + iNumLinha] = new Array("hidden_field_label_ti_estado_", "hidden_field_data_ti_estado_" + iNumLinha);
    ajax_error_count["ti_id_" + iNumLinha] = "off";
    ajax_error_count["ti_empresa_" + iNumLinha] = "off";
    ajax_error_count["ti_descripcion_" + iNumLinha] = "off";
    ajax_error_count["ti_estado_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["ti_id_" + iNumLinha] = "on";
    ajax_read_only["ti_empresa_" + iNumLinha] = "off";
    ajax_read_only["ti_descripcion_" + iNumLinha] = "off";
...
?>
    ajax_read_only["ti_id_" + iNumLinha] = "on";
    ajax_read_only["ti_empresa_" + iNumLinha] = "on";
    ajax_read_only["ti_descripcion_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["ti_id_" + iNumLinha] = null;
    ajax_error_list["ti_empresa_" + iNumLinha] = null;
    ajax_error_list["ti_descripcion_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    "ti_id_": new Array(),
    "ti_empresa_": new Array(),
    "ti_descripcion_": new Array(),
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["ti_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ti_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ti_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ti_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ti_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["ti_empresa_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ti_empresa_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ti_empresa_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ti_empresa_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ti_empresa_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["ti_descripcion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ti_descripcion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ti_descripcion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ti_descripcion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ti_descripcion_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ti_id_'])) ? $this->nmgp_cmp_readonly['ti_id_'] : 'on';
?>
    scAjaxFieldRead("ti_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ti_empresa_'])) ? $this->nmgp_cmp_readonly['ti_empresa_'] : 'off';
?>
    scAjaxFieldRead("ti_empresa_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ti_descripcion_'])) ? $this->nmgp_cmp_readonly['ti_descripcion_'] : 'off';
?>
    scAjaxFieldRead("ti_descripcion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("ti_id_" + iSeq, "on");
    scAjaxFieldRead("ti_empresa_" + iSeq, "on");
    scAjaxFieldRead("ti_descripcion_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["ti_id_" + iRow] || "on" == ajax_error_count["ti_empresa_" + iRow] || "on" == ajax_error_count["ti_descripcion_" + iRow] || "on" == ajax_error_count["ti_estado_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ti_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ti_empresa_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ti_descripcion_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["ti_id_" + iRow] && "off" == ajax_error_count["ti_empresa_" + iRow] && "off" == ajax_error_count["ti_descripcion_" + iRow] && "off" == ajax_error_count["ti_estado_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["ti_id_" + iRow] = "off";
        ajax_error_count["ti_empresa_" + iRow] = "off";
        ajax_error_count["ti_descripcion_" + iRow] = "off";
      ...
      $("#hidden_field_data_ti_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_ti_empresa_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_ti_descripcion_" + iRow).removeClass("scFormErrorLine");
