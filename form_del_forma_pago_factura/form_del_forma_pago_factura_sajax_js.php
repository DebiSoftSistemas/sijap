  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_forma_pago_factura" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_forma_pago_factura_form();
	}
...
?>
  ...
  // ---------- Validate fp_id_
  function do_ajax_form_del_forma_pago_factura_validate_fp_id_(iNumLinha)
  {
    var nomeCampo_fp_id_ = "fp_id_" + iNumLinha;
    var var_fp_id_ = scAjaxGetFieldHidden(nomeCampo_fp_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_factura_validate_fp_id_(var_fp_id_, iNumLinha, var_script_case_init, do_ajax_form_del_forma_pago_factura_validate_fp_id__cb);
  } // do_ajax_form_del_forma_pago_factura_validate_fp_id_

  function do_ajax_form_del_forma_pago_factura_validate_fp_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_factura_validate_fp_id__cb

  // ---------- Validate fp_factura_
  function do_ajax_form_del_forma_pago_factura_validate_fp_factura_(iNumLinha)
  {
    var nomeCampo_fp_factura_ = "fp_factura_" + iNumLinha;
    var var_fp_factura_ = scAjaxGetFieldText(nomeCampo_fp_factura_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_factura_validate_fp_factura_(var_fp_factura_, iNumLinha, var_script_case_init, do_ajax_form_del_forma_pago_factura_validate_fp_factura__cb);
  } // do_ajax_form_del_forma_pago_factura_validate_fp_factura_

  function do_ajax_form_del_forma_pago_factura_validate_fp_factura__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fp_factura_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fp_factura_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fp_factura_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fp_factura_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_factura_validate_fp_factura__cb

  // ---------- Validate fp_forma_pago_
  function do_ajax_form_del_forma_pago_factura_validate_fp_forma_pago_(iNumLinha)
  {
    var nomeCampo_fp_forma_pago_ = "fp_forma_pago_" + iNumLinha;
    var var_fp_forma_pago_ = scAjaxGetFieldSelect(nomeCampo_fp_forma_pago_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_factura_validate_fp_forma_pago_(var_fp_forma_pago_, iNumLinha, var_script_case_init, do_ajax_form_del_forma_pago_factura_validate_fp_forma_pago__cb);
  } // do_ajax_form_del_forma_pago_factura_validate_fp_forma_pago_

  function do_ajax_form_del_forma_pago_factura_validate_fp_forma_pago__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fp_forma_pago_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fp_forma_pago_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fp_forma_pago_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fp_forma_pago_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_factura_validate_fp_forma_pago__cb

  // ---------- Validate fp_valor_
  function do_ajax_form_del_forma_pago_factura_validate_fp_valor_(iNumLinha)
  {
    var nomeCampo_fp_valor_ = "fp_valor_" + iNumLinha;
    var var_fp_valor_ = scAjaxGetFieldText(nomeCampo_fp_valor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_factura_validate_fp_valor_(var_fp_valor_, iNumLinha, var_script_case_init, do_ajax_form_del_forma_pago_factura_validate_fp_valor__cb);
  } // do_ajax_form_del_forma_pago_factura_validate_fp_valor_

  function do_ajax_form_del_forma_pago_factura_validate_fp_valor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fp_valor_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fp_valor_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fp_valor_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fp_valor_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_factura_validate_fp_valor__cb

  // ---------- Validate fp_plazo_
  function do_ajax_form_del_forma_pago_factura_validate_fp_plazo_(iNumLinha)
  {
    var nomeCampo_fp_plazo_ = "fp_plazo_" + iNumLinha;
    var var_fp_plazo_ = scAjaxGetFieldText(nomeCampo_fp_plazo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_factura_validate_fp_plazo_(var_fp_plazo_, iNumLinha, var_script_case_init, do_ajax_form_del_forma_pago_factura_validate_fp_plazo__cb);
  } // do_ajax_form_del_forma_pago_factura_validate_fp_plazo_

  function do_ajax_form_del_forma_pago_factura_validate_fp_plazo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fp_plazo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fp_plazo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fp_plazo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fp_plazo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_factura_validate_fp_plazo__cb

  // ---------- Validate fp_unidad_tiempo_
  function do_ajax_form_del_forma_pago_factura_validate_fp_unidad_tiempo_(iNumLinha)
  {
    var nomeCampo_fp_unidad_tiempo_ = "fp_unidad_tiempo_" + iNumLinha;
    var var_fp_unidad_tiempo_ = scAjaxGetFieldSelect(nomeCampo_fp_unidad_tiempo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_factura_validate_fp_unidad_tiempo_(var_fp_unidad_tiempo_, iNumLinha, var_script_case_init, do_ajax_form_del_forma_pago_factura_validate_fp_unidad_tiempo__cb);
  } // do_ajax_form_del_forma_pago_factura_validate_fp_unidad_tiempo_

  function do_ajax_form_del_forma_pago_factura_validate_fp_unidad_tiempo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fp_unidad_tiempo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fp_unidad_tiempo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fp_unidad_tiempo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fp_unidad_tiempo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_factura_validate_fp_unidad_tiempo__cb

  // ---------- Validate fp_valor_pago_
  function do_ajax_form_del_forma_pago_factura_validate_fp_valor_pago_(iNumLinha)
  {
    var nomeCampo_fp_valor_pago_ = "fp_valor_pago_" + iNumLinha;
    var var_fp_valor_pago_ = scAjaxGetFieldText(nomeCampo_fp_valor_pago_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_factura_validate_fp_valor_pago_(var_fp_valor_pago_, iNumLinha, var_script_case_init, do_ajax_form_del_forma_pago_factura_validate_fp_valor_pago__cb);
  } // do_ajax_form_del_forma_pago_factura_validate_fp_valor_pago_

  function do_ajax_form_del_forma_pago_factura_validate_fp_valor_pago__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fp_valor_pago_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fp_valor_pago_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fp_valor_pago_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fp_valor_pago_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_factura_validate_fp_valor_pago__cb

  // ---------- Validate fp_saldo_
  function do_ajax_form_del_forma_pago_factura_validate_fp_saldo_(iNumLinha)
  {
    var nomeCampo_fp_saldo_ = "fp_saldo_" + iNumLinha;
    var var_fp_saldo_ = scAjaxGetFieldText(nomeCampo_fp_saldo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_factura_validate_fp_saldo_(var_fp_saldo_, iNumLinha, var_script_case_init, do_ajax_form_del_forma_pago_factura_validate_fp_saldo__cb);
  } // do_ajax_form_del_forma_pago_factura_validate_fp_saldo_

  function do_ajax_form_del_forma_pago_factura_validate_fp_saldo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fp_saldo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fp_saldo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fp_saldo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fp_saldo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_forma_pago_factura_validate_fp_saldo__cb

  // ---------- Event onfocus fp_forma_pago_
  function do_ajax_form_del_forma_pago_factura_event_fp_forma_pago__onfocus(iSeqForm)
  {
    var var_fp_valor_ = scAjaxGetFieldText("fp_valor_" + iSeqForm);
    var var_fp_saldo_ = scAjaxGetFieldText("fp_saldo_" + iSeqForm);
    var var_fp_valor_pago_ = scAjaxGetFieldText("fp_valor_pago_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn();
    x_ajax_form_del_forma_pago_factura_event_fp_forma_pago__onfocus(var_fp_valor_, var_fp_saldo_, var_fp_valor_pago_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_del_forma_pago_factura_event_fp_forma_pago__onfocus_cb);
  } // do_ajax_form_del_forma_pago_factura_event_fp_forma_pago__onfocus

  function do_ajax_form_del_forma_pago_factura_event_fp_forma_pago__onfocus_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_forma_pago_factura_event_fp_forma_pago__onfocus_cb_after_alert);
  } // do_ajax_form_del_forma_pago_factura_event_fp_forma_pago__onfocus_cb
  function do_ajax_form_del_forma_pago_factura_event_fp_forma_pago__onfocus_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_forma_pago_factura_event_fp_forma_pago__onfocus_cb_after_alert

  // ---------- Event onblur fp_valor_
  function do_ajax_form_del_forma_pago_factura_event_fp_valor__onblur(iSeqForm)
  {
    var var_fp_valor_pago_ = scAjaxGetFieldText("fp_valor_pago_" + iSeqForm);
    var var_fp_saldo_ = scAjaxGetFieldText("fp_saldo_" + iSeqForm);
    var var_fp_valor_ = scAjaxGetFieldText("fp_valor_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_del_forma_pago_factura_event_fp_valor__onblur(var_fp_valor_pago_, var_fp_saldo_, var_fp_valor_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_del_forma_pago_factura_event_fp_valor__onblur_cb);
  } // do_ajax_form_del_forma_pago_factura_event_fp_valor__onblur

  function do_ajax_form_del_forma_pago_factura_event_fp_valor__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_forma_pago_factura_event_fp_valor__onblur_cb_after_alert);
  } // do_ajax_form_del_forma_pago_factura_event_fp_valor__onblur_cb
  function do_ajax_form_del_forma_pago_factura_event_fp_valor__onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_forma_pago_factura_event_fp_valor__onblur_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_del_forma_pago_factura_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_del_forma_pago_factura_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_forma_pago_factura_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_del_forma_pago_factura_add_new_line_cb);
  } // do_ajax_form_del_forma_pago_factura_add_new_line

  function do_ajax_form_del_forma_pago_factura_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
...
?>
  } // do_ajax_form_del_forma_pago_factura_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_del_forma_pago_factura_backup_line(iNumLinha)
  {
    var var_fp_id_ = scAjaxGetFieldHidden("fp_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_forma_pago_factura_backup_line(var_fp_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_del_forma_pago_factura_backup_line_cb);
  } // do_ajax_form_del_forma_pago_factura_backup_line

  function do_ajax_form_del_forma_pago_factura_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_del_forma_pago_factura_backup_line_cb

  function do_ajax_form_del_forma_pago_factura_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_del_forma_pago_factura_cancel_insert

  function do_ajax_form_del_forma_pago_factura_cancel_update(iSeqVert)
  {
    do_ajax_form_del_forma_pago_factura_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_del_forma_pago_factura_cancel_update

  function do_ajax_form_del_forma_pago_factura_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_del_forma_pago_factura_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_del_forma_pago_factura_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_forma_pago_factura_table_refresh(var_fp_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_forma_pago_factura_table_refresh_cb);
  } //  do_ajax_form_del_forma_pago_factura_table_refresh

  function do_ajax_form_del_forma_pago_factura_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_del_forma_pago_factura_table_refresh_cb_after_alert);
  } // do_ajax_form_del_forma_pago_factura_table_refresh_cb
  function do_ajax_form_del_forma_pago_factura_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_del_forma_pago_factura_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_del_forma_pago_factura_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_del_forma_pago_factura_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_fp_id_ = scAjaxGetFieldHidden("fp_id_" + iNumLinha);
    var var_fp_factura_ = scAjaxGetFieldText("fp_factura_" + iNumLinha);
    var var_fp_forma_pago_ = scAjaxGetFieldSelect("fp_forma_pago_" + iNumLinha);
    var var_fp_valor_ = scAjaxGetFieldText("fp_valor_" + iNumLinha);
    var var_fp_plazo_ = scAjaxGetFieldText("fp_plazo_" + iNumLinha);
    var var_fp_unidad_tiempo_ = scAjaxGetFieldSelect("fp_unidad_tiempo_" + iNumLinha);
    var var_fp_valor_pago_ = scAjaxGetFieldText("fp_valor_pago_" + iNumLinha);
    var var_fp_saldo_ = scAjaxGetFieldText("fp_saldo_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_del_forma_pago_factura_submit_form(var_fp_id_, var_fp_factura_, var_fp_forma_pago_, var_fp_valor_, var_fp_plazo_, var_fp_unidad_tiempo_, var_fp_valor_pago_, var_fp_saldo_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_forma_pago_factura_submit_form_cb);
  } // do_ajax_form_del_forma_pago_factura_submit_form

  function do_ajax_form_del_forma_pago_factura_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("fp_factura_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("fp_forma_pago_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("fp_valor_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("fp_plazo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("fp_unidad_tiempo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("fp_valor_pago_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("fp_saldo_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_forma_pago_factura_submit_form_cb_after_alert);
  } // do_ajax_form_del_forma_pago_factura_submit_form_cb
  function do_ajax_form_del_forma_pago_factura_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_forma_pago_factura_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_forma_pago_factura_navigate_form()
  {
    perform_ajax_form_del_forma_pago_factura_navigate_form();
  }

  function perform_ajax_form_del_forma_pago_factura_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_del_forma_pago_factura_cancel_insert(sc_form_del_forma_pago_factura_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("fp_factura_" + iNavForm);
      scAjaxHideErrorDisplay("fp_forma_pago_" + iNavForm);
      scAjaxHideErrorDisplay("fp_valor_" + iNavForm);
      scAjaxHideErrorDisplay("fp_plazo_" + iNavForm);
      scAjaxHideErrorDisplay("fp_unidad_tiempo_" + iNavForm);
      scAjaxHideErrorDisplay("fp_valor_pago_" + iNavForm);
      scAjaxHideErrorDisplay("fp_saldo_" + iNavForm);
    }
    var var_fp_id_ = document.F2.fp_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_forma_pago_factura_navigate_form(var_fp_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_forma_pago_factura_navigate_form_cb);
  } // do_ajax_form_del_forma_pago_factura_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_forma_pago_factura']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_forma_pago_factura_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_forma_pago_factura_navigate_form_cb_after_alert);
  } // do_ajax_form_del_forma_pago_factura_navigate_form_cb
  function do_ajax_form_del_forma_pago_factura_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_del_forma_pago_factura_navigate_form_cb_after_alert

    function sc_form_del_forma_pago_factura_get_last_line_number()
    {
    ...
    } //sc_form_del_forma_pago_factura_get_last_line_number

  function sc_hide_form_del_forma_pago_factura_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fp_factura_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fp_forma_pago_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fp_valor_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fp_plazo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fp_unidad_tiempo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fp_valor_pago_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fp_saldo_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["fp_factura_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_factura'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["fp_forma_pago_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_forma_pago'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["fp_valor_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_valor'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["fp_plazo_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_plazo'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["fp_unidad_tiempo_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_unidad_tiempo'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["fp_valor_pago_" + iNumLinha] = {"label": "Fp Valor Pago<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["fp_saldo_" + iNumLinha] = {"label": "Fp Saldo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["fp_id_"][iNumLinha] = "fp_id_" + iNumLinha;
    ajax_field_mult["fp_factura_"][iNumLinha] = "fp_factura_" + iNumLinha;
    ajax_field_mult["fp_forma_pago_"][iNumLinha] = "fp_forma_pago_" + iNumLinha;
    ajax_field_mult["fp_valor_"][iNumLinha] = "fp_valor_" + iNumLinha;
    ajax_field_mult["fp_plazo_"][iNumLinha] = "fp_plazo_" + iNumLinha;
    ajax_field_mult["fp_unidad_tiempo_"][iNumLinha] = "fp_unidad_tiempo_" + iNumLinha;
    ajax_field_mult["fp_valor_pago_"][iNumLinha] = "fp_valor_pago_" + iNumLinha;
    ajax_field_mult["fp_saldo_"][iNumLinha] = "fp_saldo_" + iNumLinha;
    ajax_field_id["fp_forma_pago_" + iNumLinha] = new Array("hidden_field_label_fp_forma_pago_", "hidden_field_data_fp_forma_pago_" + iNumLinha);
    ajax_field_id["fp_valor_" + iNumLinha] = new Array("hidden_field_label_fp_valor_", "hidden_field_data_fp_valor_" + iNumLinha);
    ajax_field_id["fp_plazo_" + iNumLinha] = new Array("hidden_field_label_fp_plazo_", "hidden_field_data_fp_plazo_" + iNumLinha);
    ajax_field_id["fp_unidad_tiempo_" + iNumLinha] = new Array("hidden_field_label_fp_unidad_tiempo_", "hidden_field_data_fp_unidad_tiempo_" + iNumLinha);
    ajax_error_count["fp_id_" + iNumLinha] = "off";
    ajax_error_count["fp_factura_" + iNumLinha] = "off";
    ajax_error_count["fp_forma_pago_" + iNumLinha] = "off";
    ajax_error_count["fp_valor_" + iNumLinha] = "off";
    ajax_error_count["fp_plazo_" + iNumLinha] = "off";
    ajax_error_count["fp_unidad_tiempo_" + iNumLinha] = "off";
    ajax_error_count["fp_valor_pago_" + iNumLinha] = "off";
    ajax_error_count["fp_saldo_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["fp_id_" + iNumLinha] = "on";
    ajax_read_only["fp_factura_" + iNumLinha] = "off";
    ajax_read_only["fp_forma_pago_" + iNumLinha] = "off";
    ajax_read_only["fp_valor_" + iNumLinha] = "off";
    ajax_read_only["fp_plazo_" + iNumLinha] = "off";
    ajax_read_only["fp_unidad_tiempo_" + iNumLinha] = "off";
    ajax_read_only["fp_valor_pago_" + iNumLinha] = "off";
    ajax_read_only["fp_saldo_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["fp_id_" + iNumLinha] = "on";
    ajax_read_only["fp_factura_" + iNumLinha] = "on";
    ajax_read_only["fp_forma_pago_" + iNumLinha] = "on";
    ajax_read_only["fp_valor_" + iNumLinha] = "on";
    ajax_read_only["fp_plazo_" + iNumLinha] = "on";
    ajax_read_only["fp_unidad_tiempo_" + iNumLinha] = "on";
    ajax_read_only["fp_valor_pago_" + iNumLinha] = "on";
    ajax_read_only["fp_saldo_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["fp_factura_" + iNumLinha] = null;
    ajax_error_list["fp_forma_pago_" + iNumLinha] = null;
    ajax_error_list["fp_valor_" + iNumLinha] = null;
    ajax_error_list["fp_plazo_" + iNumLinha] = null;
    ajax_error_list["fp_unidad_tiempo_" + iNumLinha] = null;
    ajax_error_list["fp_valor_pago_" + iNumLinha] = null;
    ajax_error_list["fp_saldo_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "fp_id_": new Array(),
    "fp_factura_": new Array(),
    "fp_forma_pago_": new Array(),
    "fp_valor_": new Array(),
    "fp_plazo_": new Array(),
    "fp_unidad_tiempo_": new Array(),
    "fp_valor_pago_": new Array(),
    "fp_saldo_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["fp_factura_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fp_factura_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fp_factura_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fp_factura_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fp_factura_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["fp_forma_pago_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fp_forma_pago_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fp_forma_pago_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fp_forma_pago_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fp_forma_pago_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["fp_valor_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fp_valor_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fp_valor_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fp_valor_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fp_valor_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["fp_plazo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fp_plazo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fp_plazo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fp_plazo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fp_plazo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["fp_unidad_tiempo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fp_unidad_tiempo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fp_unidad_tiempo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fp_unidad_tiempo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fp_unidad_tiempo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["fp_valor_pago_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fp_valor_pago_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fp_valor_pago_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fp_valor_pago_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fp_valor_pago_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["fp_saldo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fp_saldo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fp_saldo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fp_saldo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fp_saldo_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fp_factura_'])) ? $this->nmgp_cmp_readonly['fp_factura_'] : 'off';
?>
    scAjaxFieldRead("fp_factura_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fp_forma_pago_'])) ? $this->nmgp_cmp_readonly['fp_forma_pago_'] : 'off';
?>
    scAjaxFieldRead("fp_forma_pago_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fp_valor_'])) ? $this->nmgp_cmp_readonly['fp_valor_'] : 'off';
?>
    scAjaxFieldRead("fp_valor_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fp_plazo_'])) ? $this->nmgp_cmp_readonly['fp_plazo_'] : 'off';
?>
    scAjaxFieldRead("fp_plazo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fp_unidad_tiempo_'])) ? $this->nmgp_cmp_readonly['fp_unidad_tiempo_'] : 'off';
?>
    scAjaxFieldRead("fp_unidad_tiempo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fp_valor_pago_'])) ? $this->nmgp_cmp_readonly['fp_valor_pago_'] : 'off';
?>
    scAjaxFieldRead("fp_valor_pago_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fp_saldo_'])) ? $this->nmgp_cmp_readonly['fp_saldo_'] : 'off';
?>
    scAjaxFieldRead("fp_saldo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("fp_id_" + iSeq, "on");
    scAjaxFieldRead("fp_factura_" + iSeq, "on");
    scAjaxFieldRead("fp_forma_pago_" + iSeq, "on");
    scAjaxFieldRead("fp_valor_" + iSeq, "on");
    scAjaxFieldRead("fp_plazo_" + iSeq, "on");
    scAjaxFieldRead("fp_unidad_tiempo_" + iSeq, "on");
    scAjaxFieldRead("fp_valor_pago_" + iSeq, "on");
    scAjaxFieldRead("fp_saldo_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["fp_id_" + iRow] || "on" == ajax_error_count["fp_factura_" + iRow] || "on" == ajax_error_count["fp_forma_pago_" + iRow] || "on" == ajax_error_count["fp_valor_" + iRow] || "on" == ajax_error_count["fp_plazo_" + iRow] || "on" == ajax_error_count["fp_unidad_tiempo_" + iRow] || "on" == ajax_error_count["fp_valor_pago_" + iRow] || "on" == ajax_error_count["fp_saldo_" + iRow]))
    {
      ...
      $("#hidden_field_data_fp_factura_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_fp_forma_pago_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_fp_valor_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_fp_plazo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_fp_unidad_tiempo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_fp_valor_pago_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_fp_saldo_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["fp_id_" + iRow] && "off" == ajax_error_count["fp_factura_" + iRow] && "off" == ajax_error_count["fp_forma_pago_" + iRow] && "off" == ajax_error_count["fp_valor_" + iRow] && "off" == ajax_error_count["fp_plazo_" + iRow] && "off" == ajax_error_count["fp_unidad_tiempo_" + iRow] && "off" == ajax_error_count["fp_valor_pago_" + iRow] && "off" == ajax_error_count["fp_saldo_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["fp_id_" + iRow] = "off";
        ajax_error_count["fp_factura_" + iRow] = "off";
        ajax_error_count["fp_forma_pago_" + iRow] = "off";
        ajax_error_count["fp_valor_" + iRow] = "off";
        ajax_error_count["fp_plazo_" + iRow] = "off";
        ajax_error_count["fp_unidad_tiempo_" + iRow] = "off";
        ajax_error_count["fp_valor_pago_" + iRow] = "off";
        ajax_error_count["fp_saldo_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_fp_factura_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_fp_forma_pago_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_fp_valor_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_fp_plazo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_fp_unidad_tiempo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_fp_valor_pago_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_fp_saldo_" + iRow).removeClass("scFormErrorLine");
    }
  }
