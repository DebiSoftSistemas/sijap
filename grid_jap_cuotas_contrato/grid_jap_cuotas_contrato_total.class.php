...
class grid_jap_cuotas_contrato_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_jap_cuotas_contrato']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_jap_cuotas_contrato']['campos_busca']))
      { 
   ...
   //---- 
   function quebra_geral_cc_cuota($res_limit=false, $res_export=false)
   {
      global $nada, $nm_lang , $cc_producto;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(cc_valor), sum(cc_iva), sum(cc_total), sum(cc_por_iva) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['where_pesq']; 
      } 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $rt->fields[1] = (string)$rt->fields[1]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['tot_geral'][2] = $rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $rt->fields[2] = (string)$rt->fields[2]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['tot_geral'][3] = $rt->fields[2]; 
      $rt->fields[3] = str_replace(",", ".", $rt->fields[3]);
      $rt->fields[3] = (string)$rt->fields[3]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['tot_geral'][4] = $rt->fields[3]; 
      $rt->fields[4] = str_replace(",", ".", $rt->fields[4]);
      $rt->fields[4] = (string)$rt->fields[4]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['tot_geral'][5] = $rt->fields[4]; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['contr_total_geral'] = "OK";
   } 

   //-----  cc_cuota
   function quebra_cc_cuota_cc_cuota($cc_cuota, $arg_sum_cc_cuota) 
   {
      ...
      { 
         $nm_comando .= " where cc_cuota" . $arg_sum_cc_cuota ; 
      } 
      else 
      { 
         $nm_comando .= " and cc_cuota" . $arg_sum_cc_cuota ; 
      } 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = '';
      if (!$rt = $this->Db->Execute($nm_comando)) 
