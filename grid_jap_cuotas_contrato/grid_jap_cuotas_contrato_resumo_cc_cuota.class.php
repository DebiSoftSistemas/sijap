...
class grid_jap_cuotas_contrato_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
...
SCEOT;
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_jap_cuotas_contrato']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_jap_cuotas_contrato']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['where_resumo'] = "";
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['contr_total_geral'] == "OK")
      {
          $this->array_total_cc_cuota = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['arr_total']['cc_cuota'];
      }
      else
      {
          $this->array_total_cc_cuota = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['tot_geral'][2];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['tot_geral'][5];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['tot_geral'][4];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['arr_total']['cc_cuota'] = $this->array_total_cc_cuota;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['json_use_label'])
       {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['labels']['cc_fecha']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['labels']['cc_fecha'] = "" . $this->Ini->Nm_lang['lang_fecha'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['labels']['cc_producto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['labels']['cc_producto'] = "" . $this->Ini->Nm_lang['lang_producto'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['labels']['cc_valor']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['labels']['cc_valor'] = "" . $this->Ini->Nm_lang['lang_valor'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['labels']['cc_iva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['labels']['cc_iva'] = "" . $this->Ini->Nm_lang['lang_iva'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['labels']['cc_total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['labels']['cc_total'] = "" . $this->Ini->Nm_lang['lang_othr_chrt_totl'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['labels']['cc_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['labels']['cc_id'] = "" . $this->Ini->Nm_lang['lang_id'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['labels']['cc_contrato']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['labels']['cc_contrato'] = "" . $this->Ini->Nm_lang['lang_contrato'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['labels']['cc_cuota']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['labels']['cc_cuota'] = "" . $this->Ini->Nm_lang['lang_cuota_nro'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['labels']['cc_por_iva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['labels']['cc_por_iva'] = "" . $this->Ini->Nm_lang['lang_porcentaje_iva'] . ""; 
       }
       //-----
       $this->comp_field_nm = array(
           'cc_cuota' => 0,
       ...
       //-----
       $this->comp_sum = array(
           2 => "Cc Valor (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           3 => "Cc Por Iva (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           4 => "Cc Total (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['summarizing_fields_order']['cc_cuota']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['summarizing_fields_order']['cc_cuota'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['summarizing_fields_order']['cc_cuota'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['summarizing_fields_display']['cc_cuota'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['summarizing_fields_display']['cc_cuota'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['summarizing_fields_display']['cc_cuota'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['summarizing_fields_display']['cc_cuota'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['summarizing_fields_display']['cc_cuota'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['summarizing_fields_display']['cc_cuota'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['summarizing_fields_display']['cc_cuota'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "cc_valor", 'show' => true),
           3 => array('field' => "cc_por_iva", 'show' => true),
           4 => array('field' => "cc_total", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "css_cc_valor_sum",
           3 => "css_cc_por_iva_sum",
           4 => "css_cc_total_sum",
       );
       ...
       //-----
       foreach ($this->array_total_cc_cuota as $i_cc_cuota => $d_cc_cuota) {
           if (!isset($i_cc_cuota, $this->comp_label[0]) || !in_array($i_cc_cuota, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_cc_cuota[6] ] = $d_cc_cuota[5];
               $this->comp_label[0][ $d_cc_cuota[6] ] = $d_cc_cuota[5];
           }
       }
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_tabular_label'];
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_cc_cuota => $l_cc_cuota) {
           if (isset($this->array_total_cc_cuota[$i_cc_cuota])) {
               $this->comp_group[$i_cc_cuota] = array();
           }
       }
     }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_jap_cuotas_contrato@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['proc_pdf_vert']){ 
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_jap_cuotas_contrato_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_cc_cuota("res", $this->NM_export);
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['doc_word'])
{
      ...
      { 
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['ajax_nav']) {  
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_jap_cuotas_contrato_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_jap_cuotas_contrato_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_jap_cuotas_contrato_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_jap_cuotas_contrato/grid_jap_cuotas_contrato_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "grid_jap_cuotas_contrato/grid_jap_cuotas_contrato_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid&nm_all_modules=grid&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_jap_cuotas_contrato/grid_jap_cuotas_contrato_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_jap_cuotas_contrato&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid&nm_all_modules=grid&password=n&summary_export_columns=S&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "grid_jap_cuotas_contrato/grid_jap_cuotas_contrato_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid&nm_all_modules=grid&nm_xml_tag=tag&nm_xml_label=S&language=es&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_jap_cuotas_contrato_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_jap_cuotas_contrato']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_jap_cuotas_contrato']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_jap_cuotas_contrato_config_pivot.php?nome_apl=grid_jap_cuotas_contrato&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"grid_jap_cuotas_contrato_iframe.php\";\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_jap_cuotas_contrato_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_jap_cuotas_contrato/grid_jap_cuotas_contrato_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $cc_contrato = (isset($Busca_temp['cc_contrato'])) ? $Busca_temp['cc_contrato'] : ""; 
          $tmp_pos = (is_string($cc_contrato)) ? strpos($cc_contrato, "##@@") : false;
          if ($tmp_pos !== false && !is_array($cc_contrato))
          {
              $cc_contrato = substr($cc_contrato, 0, $tmp_pos);
          }
   ...
   //---- 
   function adiciona_registro($sum_cc_valor, $sum_cc_iva, $sum_cc_total, $sum_cc_por_iva, $quebra_cc_cuota, $quebra_cc_cuota_orig)
   {
      //----- cc_cuota
      if (!isset($this->array_total_cc_cuota[$quebra_cc_cuota_orig]))
      {
         $this->array_total_cc_cuota[$quebra_cc_cuota_orig][0] = 1;
         $this->array_total_cc_cuota[$quebra_cc_cuota_orig][1] = $sum_cc_valor;
         $this->array_total_cc_cuota[$quebra_cc_cuota_orig][2] = $sum_cc_iva;
         $this->array_total_cc_cuota[$quebra_cc_cuota_orig][3] = $sum_cc_total;
         $this->array_total_cc_cuota[$quebra_cc_cuota_orig][4] = $sum_cc_por_iva;
         $this->array_total_cc_cuota[$quebra_cc_cuota_orig][5] = $quebra_cc_cuota;
         $this->array_total_cc_cuota[$quebra_cc_cuota_orig][6] = $quebra_cc_cuota_orig;
      }
      else
      {
         $this->array_total_cc_cuota[$quebra_cc_cuota_orig][0]++;
         $this->array_total_cc_cuota[$quebra_cc_cuota_orig][1] = bcadd($this->array_total_cc_cuota[$quebra_cc_cuota_orig][1], $sum_cc_valor, 10);
         $this->array_total_cc_cuota[$quebra_cc_cuota_orig][2] = bcadd($this->array_total_cc_cuota[$quebra_cc_cuota_orig][2], $sum_cc_iva, 10);
         $this->array_total_cc_cuota[$quebra_cc_cuota_orig][3] = bcadd($this->array_total_cc_cuota[$quebra_cc_cuota_orig][3], $sum_cc_total, 10);
         $this->array_total_cc_cuota[$quebra_cc_cuota_orig][4] = bcadd($this->array_total_cc_cuota[$quebra_cc_cuota_orig][4], $sum_cc_por_iva, 10);
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
       ...
       $this->cc_contrato = $Busca_temp['cc_contrato']; 
       $this->cc_contrato = (isset($Busca_temp['cc_contrato'])) ? $Busca_temp['cc_contrato'] : ""; 
       $tmp_pos = (is_string($this->cc_contrato)) ? strpos($this->cc_contrato, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->cc_contrato))
       {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('cc_cuota', 'cc_cuota');
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->cc_fecha = $rs_res->fields[0] ;  
            $this->cc_producto = $rs_res->fields[1] ;  
            $this->cc_valor = $rs_res->fields[2] ;  
            $this->cc_iva = $rs_res->fields[3] ;  
            $this->cc_total = $rs_res->fields[4] ;  
            $this->cc_id = $rs_res->fields[5] ;  
            $this->cc_contrato = $rs_res->fields[6] ;  
            $this->cc_cuota = $rs_res->fields[7] ;  
            $this->cc_por_iva = $rs_res->fields[8] ;  
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->cc_valor, $this->cc_iva, $this->cc_total, $this->cc_por_iva, $this->cc_cuota, $this->cc_cuota_orig);
            }
   }
//
