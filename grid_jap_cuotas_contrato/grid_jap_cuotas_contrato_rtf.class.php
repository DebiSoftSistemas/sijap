...
class grid_jap_cuotas_contrato_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_jap_cuotas_contrato.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['rtf_name']);
      }
   ...
   function NM_export_cc_valor()
   {
         ...
         $this->cc_valor = str_replace('<', '&lt;', $this->cc_valor);
         $this->cc_valor = str_replace('>', '&gt;', $this->cc_valor);
         $this->Texto_tag .= "<td>" . $this->cc_valor . "</td>\r\n";
   }
   //----- cc_iva
   function NM_export_cc_iva()
   {
         ...
         $this->cc_iva = str_replace('<', '&lt;', $this->cc_iva);
         $this->cc_iva = str_replace('>', '&gt;', $this->cc_iva);
         $this->Texto_tag .= "<td>" . $this->cc_iva . "</td>\r\n";
   }
   //----- cc_total
   function NM_export_cc_total()
   {
         ...
         $this->cc_total = str_replace('<', '&lt;', $this->cc_total);
         $this->cc_total = str_replace('>', '&gt;', $this->cc_total);
         $this->Texto_tag .= "<td>" . $this->cc_total . "</td>\r\n";
   }
   //----- cc_id
   ...
   function NM_export_cc_contrato()
   {
         ...
         $this->cc_contrato = str_replace('<', '&lt;', $this->cc_contrato);
         $this->cc_contrato = str_replace('>', '&gt;', $this->cc_contrato);
         $this->Texto_tag .= "<td>" . $this->cc_contrato . "</td>\r\n";
   }
   //----- cc_cuota
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_cuotas_contrato']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_cuotas'] ?> :: RTF</TITLE>
