<form name="F2" method=post 
               ...
               target="_self"> 
<input type="hidden" name="si_id" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['si_id']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_jap_solicitud_inspeccion_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function sc_btn_enviar_inspeccion_ok()
{
    ...
    document.F1.action = "form_jap_solicitud_inspeccion_mob.php";
    document.F1.target = "_self";
    document.F1.submit();
}
var var_btn_imprimir_var_solicitud = "<?php echo $this->form_encode_input($this->nmgp_dados_form['si_id']); ?>";
...
{
  nm_gp_submit('<?php echo $this->Ini->link_form_jap_solicitud_inspeccion_pdf; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "var_solicitud*scin' + var_btn_imprimir_var_solicitud + '*scout"; ?>', '', 'new_tab', '0', '0', 'form_jap_solicitud_inspeccion_pdf');
}
...
function sc_btn_finalizar()
{
    ...
    scJs_confirm("<?php echo html_entity_decode('Se guardaran los datos', ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>", sc_btn_finalizar_ok, sc_btn_finalizar_cancel)
}
function sc_btn_finalizar_cancel()
{
}
function sc_btn_finalizar_ok()
{
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['where_detal']))
  {
?>  
...
{
   nm_field_disabled("propietario=disabled;contrato=disabled;direccion=disabled", "");
