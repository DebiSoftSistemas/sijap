<?php
//
class form_jap_solicitud_inspeccion_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_jap_solicitud_inspeccion_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_jap_solicitud_inspeccion_mob']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_jap_solicitud_inspeccion_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_jap_solicitud_inspeccion_mob']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_jap_solicitud_inspeccion_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_jap_solicitud_inspeccion_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_jap_solicitud_inspeccion_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_jap_solicitud_inspeccion_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (!isset($this->Igtech_RucEmpresa) && isset($this->igtech_rucempresa)) 
          {
              $this->Igtech_RucEmpresa = $this->igtech_rucempresa;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_jap_solicitud_inspeccion_mob']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_jap_solicitud_inspeccion_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_jap_solicitud_inspeccion_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_jap_solicitud_inspeccion_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_jap_solicitud_inspeccion_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_jap_solicitud_inspeccion_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_jap_solicitud_inspeccion_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_jap_solicitud_inspeccion_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_jap_solicitud_inspeccion_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_jap_solicitud_inspeccion_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_solicitud_inspeccion']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_jap_solicitud_inspeccion'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_jap_solicitud_inspeccion_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['form_jap_solicitud_inspeccion_mob']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_jap_solicitud_inspeccion_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_jap_solicitud_inspeccion_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_jap_solicitud_inspeccion_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_jap_solicitud_inspeccion_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_jap_solicitud_inspeccion_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_jap_solicitud_inspeccion_mob']['label'] = "" . $this->Ini->Nm_lang['lang_solicitud_inspeccion'] . "";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_jap_solicitud_inspeccion_mob")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_jap_solicitud_inspeccion_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_jap_solicitud_inspeccion_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_solicitud_inspeccion_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_jap_solicitud_inspeccion_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_solicitud_inspeccion_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_jap_solicitud_inspeccion_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_solicitud_inspeccion_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_jap_solicitud_inspeccion_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_solicitud_inspeccion_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_jap_solicitud_inspeccion_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_jap_solicitud_inspeccion_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_solicitud_inspeccion_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_jap_solicitud_inspeccion_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_jap_solicitud_inspeccion_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_solicitud_inspeccion_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_jap_solicitud_inspeccion_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_jap_solicitud_inspeccion_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_jap_solicitud_inspeccion_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_solicitud_inspeccion_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_jap_solicitud_inspeccion_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_jap_solicitud_inspeccion_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_solicitud_inspeccion_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_jap_solicitud_inspeccion_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_jap_solicitud_inspeccion_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_solicitud_inspeccion_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_jap_solicitud_inspeccion_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_jap_solicitud_inspeccion_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_solicitud_inspeccion_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_jap_solicitud_inspeccion_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_jap_solicitud_inspeccion_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_solicitud_inspeccion_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_jap_solicitud_inspeccion_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_jap_solicitud_inspeccion_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_jap_solicitud_inspeccion_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_jap_solicitud_inspeccion/form_jap_solicitud_inspeccion_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_jap_solicitud_inspeccion_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_jap_solicitud_inspeccion_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_jap_solicitud_inspeccion_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_jap_solicitud_inspeccion/form_jap_solicitud_inspeccion_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_jap_solicitud_inspeccion_mob_erro.class.php"); 
      }
      $this->Erro      = new form_jap_solicitud_inspeccion_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['opcao']))
         { 
             if ($this->si_id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_solicitud_inspeccion_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_jap_solicitud_inspeccion_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_solicitud_inspeccion_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['opc_ant'] : "";
      } 
      ...
      {
          $this->nmgp_botoes['enviar_inspeccion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['botoes']['enviar_inspeccion'];
          $this->nmgp_botoes['imprimir'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['botoes']['imprimir'];
          $this->nmgp_botoes['anular'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['botoes']['anular'];
          $this->nmgp_botoes['finalizar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['botoes']['finalizar'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_insert_on = false;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_jap_solicitud_inspeccion_mob']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_jap_solicitud_inspeccion_mob']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['dados_select'];
     }
   }
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['Gera_log_access'] = false;
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['dados_select']['propietario']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->propietario = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['dados_select']['propietario'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['dados_select']['contrato']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->contrato = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['dados_select']['contrato'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['dados_select']['direccion']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->direccion = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['dados_select']['direccion'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['recarga'] = $this->nmgp_opcao;
      }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_jap_solicitud_inspeccion_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_jap_solicitud_inspeccion_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_jap_solicitud_inspeccion_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="form_jap_solicitud_inspeccion_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_jap_solicitud_inspeccion_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sis_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'form_jap_solicitud_inspeccion_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_jap_solicitud_inspeccion_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['opc_ant'] == "incluir")
      {
      ...
      {
          if (!isset($this->si_tipo_inspeccion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['dados_form']['si_tipo_inspeccion']))
          {
              $varloc_btn_php['si_tipo_inspeccion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['dados_form']['si_tipo_inspeccion'];
          }
          if (!isset($this->si_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['dados_form']['si_id']))
          {
              $varloc_btn_php['si_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['dados_form']['si_id'];
          }
          if (!isset($this->rs) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['dados_form']['rs']))
          {
              $varloc_btn_php['rs'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['dados_form']['rs'];
          }
      }
      $nm_f_saida = "form_jap_solicitud_inspeccion_mob.php";
      ...
      $_SESSION['scriptcase']['form_jap_solicitud_inspeccion_mob']['contr_erro'] = 'on';
...
if (false == $this->rs) {
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_jap_solicitud_inspeccion_mob';
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_jap_solicitud_inspeccion_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_jap_solicitud_inspeccion_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_jap_solicitud_inspeccion_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_jap_solicitud_inspeccion_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
    ...
    function ValidateField_si_empresa(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['php_cmp_required']['si_empresa']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['php_cmp_required']['si_empresa'] == "on")) 
      { 
          if ($this->si_empresa == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_si_fecha(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['php_cmp_required']['si_fecha']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['php_cmp_required']['si_fecha'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_si_secuecial(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->si_secuecial, 9, 0, -0, 999999999, "N") == false)  
              { 
                  $hasError = true;
   ...
   if (isset($this->Field_no_validate['si_contrato'])) {
      ...
      if ($this->si_contrato == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['php_cmp_required']['si_contrato']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['php_cmp_required']['si_contrato'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->si_contrato) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['Lookup_si_contrato']) && !in_array($this->si_contrato, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['Lookup_si_contrato']))
          {
              $hasError = true;
   ...
   if (isset($this->Field_no_validate['si_tipo_inspeccion'])) {
      ...
      if ($this->si_tipo_inspeccion == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['php_cmp_required']['si_tipo_inspeccion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['php_cmp_required']['si_tipo_inspeccion'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->si_tipo_inspeccion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['Lookup_si_tipo_inspeccion']) && !in_array($this->si_tipo_inspeccion, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['Lookup_si_tipo_inspeccion']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['si_tipo_inspeccion']))
   ...
   if (isset($this->Field_no_validate['si_usuario_inspecciona'])) {
       return;
               ...
               if (!empty($this->si_usuario_inspecciona) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['Lookup_si_usuario_inspecciona']) && !in_array($this->si_usuario_inspecciona, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['Lookup_si_usuario_inspecciona']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['si_id']['keyVal'] = form_jap_solicitud_inspeccion_mob_pack_protect_string($this->nmgp_dados_form['si_id']);
          }
   } // ajax_return_values
...
$aLookup[] = array(form_jap_solicitud_inspeccion_mob_pack_protect_string('') => str_replace('<', '&lt;',form_jap_solicitud_inspeccion_mob_pack_protect_string('' . $this->Ini->Nm_lang['lang_seleccione'] . '')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['Lookup_si_contrato'][] = '';
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_jap_solicitud_inspeccion_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_jap_solicitud_inspeccion_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['si_contrato']['valList'][$i] = form_jap_solicitud_inspeccion_mob_pack_protect_string($v);
          }
...
$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['Lookup_si_tipo_inspeccion'][] = '';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['si_tipo_inspeccion']['valList'][$i] = form_jap_solicitud_inspeccion_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['si_usuario_inspecciona']['valList'][$i] = form_jap_solicitud_inspeccion_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['Field_no_validate'] = array();
...
//----------- 
   ...
   function return_after_insert()
   {
      ...
      if ('' != $this->si_id)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['reg_start'] = $rsc->fields[0];
          $rsc->Close();
      }
   }
...
$_SESSION['scriptcase']['form_jap_solicitud_inspeccion_mob']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['total']);
              }
              ...
              $this->NM_gera_log_new();
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['parms'] = "si_id?#?$this->si_id?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['run_iframe'] == "R")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_form_jap_solicitud_inspeccion_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['total'] = $qt_geral_reg_form_jap_solicitud_inspeccion_mob;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->si_id))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_jap_solicitud_inspeccion_mob = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['reg_start'] > $qt_geral_reg_form_jap_solicitud_inspeccion_mob)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['reg_start'] = $qt_geral_reg_form_jap_solicitud_inspeccion_mob; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_jap_solicitud_inspeccion_mob) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['reg_start']) ;  
              } 
          } 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['reg_start'] < $qt_geral_reg_form_jap_solicitud_inspeccion_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['opcao']   = '';
          }
      } 
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['dados_select'];
...
// 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['reg_start'] + 1;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_jap_solicitud_inspeccion_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['csrf_token'];
    }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_jap_solicitud_inspeccion_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_jap_solicitud_inspeccion_mob_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['masterValue']))
{
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['retorno_edit'] = "";
   }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function getButtonIds($buttonName) {
        switch ($buttonName) {
            case "help":
                ...
                break;
            case "exit":
                return array("sc_b_sai_t.sc-unique-btn-1", "sc_b_sai_t.sc-unique-btn-2", "sc_b_sai_t.sc-unique-btn-4", "sc_b_sai_t.sc-unique-btn-3", "sc_b_sai_t.sc-unique-btn-5", "sc_b_sai_b.sc-unique-btn-23");
                break;
            case "new":
            ...
            case "update":
                ...
                break;
            case "0":
                return array("sys_separator.sc-unique-btn-10", "sys_separator.sc-unique-btn-11", "sys_separator.sc-unique-btn-16", "sys_separator.sc-unique-btn-17", "sys_separator.sc-unique-btn-22");
                break;
            case "imprimir":
            ...
            case "birpara":
                ...
                break;
            case "first":
                return array("sc_b_ini_b.sc-unique-btn-12", "sc_b_ini_b.sc-unique-btn-18");
                break;
            case "back":
                return array("sc_b_ret_b.sc-unique-btn-13", "sc_b_ret_b.sc-unique-btn-19");
                break;
            case "forward":
                return array("sc_b_avc_b.sc-unique-btn-14", "sc_b_avc_b.sc-unique-btn-20");
                break;
            case "last":
                return array("sc_b_fim_b.sc-unique-btn-15", "sc_b_fim_b.sc-unique-btn-21");
                break;
        }
    ...
    function displayAppHeader()
    {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion_mob']['ordem_ord'] == " desc") {
