  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_jap_solicitud_inspeccion" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_jap_solicitud_inspeccion_form();
	}
...
?>
  ...
  function do_ajax_form_jap_solicitud_inspeccion_validate_si_motivo_anulacion()
  {
    ...
    x_ajax_form_jap_solicitud_inspeccion_validate_si_motivo_anulacion(var_si_motivo_anulacion, var_script_case_init, do_ajax_form_jap_solicitud_inspeccion_validate_si_motivo_anulacion_cb);
  } // do_ajax_form_jap_solicitud_inspeccion_validate_si_motivo_anulacion

  function do_ajax_form_jap_solicitud_inspeccion_validate_si_motivo_anulacion_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_solicitud_inspeccion_validate_si_motivo_anulacion_cb

  // ---------- Validate si_id
  function do_ajax_form_jap_solicitud_inspeccion_validate_si_id()
  {
    var nomeCampo_si_id = "si_id";
    var var_si_id = scAjaxGetFieldHidden(nomeCampo_si_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_solicitud_inspeccion_validate_si_id(var_si_id, var_script_case_init, do_ajax_form_jap_solicitud_inspeccion_validate_si_id_cb);
  } // do_ajax_form_jap_solicitud_inspeccion_validate_si_id

  function do_ajax_form_jap_solicitud_inspeccion_validate_si_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "si_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_solicitud_inspeccion_validate_si_id_cb

  // ---------- Validate si_empresa
  function do_ajax_form_jap_solicitud_inspeccion_validate_si_empresa()
  {
    var nomeCampo_si_empresa = "si_empresa";
    var var_si_empresa = scAjaxGetFieldText(nomeCampo_si_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_solicitud_inspeccion_validate_si_empresa(var_si_empresa, var_script_case_init, do_ajax_form_jap_solicitud_inspeccion_validate_si_empresa_cb);
  } // do_ajax_form_jap_solicitud_inspeccion_validate_si_empresa

  function do_ajax_form_jap_solicitud_inspeccion_validate_si_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_solicitud_inspeccion_validate_si_empresa_cb

  // ---------- Validate si_fecha
  function do_ajax_form_jap_solicitud_inspeccion_validate_si_fecha()
  {
    ...
    setTimeout(function() {
      var var_si_fecha = scAjaxGetFieldText(nomeCampo_si_fecha);
      x_ajax_form_jap_solicitud_inspeccion_validate_si_fecha(var_si_fecha, var_script_case_init, do_ajax_form_jap_solicitud_inspeccion_validate_si_fecha_cb);
    }, 200);
  } // do_ajax_form_jap_solicitud_inspeccion_validate_si_fecha

  function do_ajax_form_jap_solicitud_inspeccion_validate_si_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_solicitud_inspeccion_validate_si_fecha_cb

  // ---------- Validate si_secuecial
  function do_ajax_form_jap_solicitud_inspeccion_validate_si_secuecial()
  {
    var nomeCampo_si_secuecial = "si_secuecial";
    var var_si_secuecial = scAjaxGetFieldHidden(nomeCampo_si_secuecial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_solicitud_inspeccion_validate_si_secuecial(var_si_secuecial, var_script_case_init, do_ajax_form_jap_solicitud_inspeccion_validate_si_secuecial_cb);
  } // do_ajax_form_jap_solicitud_inspeccion_validate_si_secuecial

  function do_ajax_form_jap_solicitud_inspeccion_validate_si_secuecial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_solicitud_inspeccion_validate_si_secuecial_cb

  // ---------- Validate si_contrato
  function do_ajax_form_jap_solicitud_inspeccion_validate_si_contrato()
  {
    var nomeCampo_si_contrato = "si_contrato";
    var var_si_contrato = scAjaxGetFieldSelect(nomeCampo_si_contrato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_solicitud_inspeccion_validate_si_contrato(var_si_contrato, var_script_case_init, do_ajax_form_jap_solicitud_inspeccion_validate_si_contrato_cb);
  } // do_ajax_form_jap_solicitud_inspeccion_validate_si_contrato

  function do_ajax_form_jap_solicitud_inspeccion_validate_si_contrato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_solicitud_inspeccion_validate_si_contrato_cb

  // ---------- Validate si_estado
  function do_ajax_form_jap_solicitud_inspeccion_validate_si_estado()
  {
    var nomeCampo_si_estado = "si_estado";
    var var_si_estado = scAjaxGetFieldText(nomeCampo_si_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_solicitud_inspeccion_validate_si_estado(var_si_estado, var_script_case_init, do_ajax_form_jap_solicitud_inspeccion_validate_si_estado_cb);
  } // do_ajax_form_jap_solicitud_inspeccion_validate_si_estado

  function do_ajax_form_jap_solicitud_inspeccion_validate_si_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_solicitud_inspeccion_validate_si_estado_cb

  // ---------- Validate si_tipo_inspeccion
  function do_ajax_form_jap_solicitud_inspeccion_validate_si_tipo_inspeccion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_solicitud_inspeccion_validate_si_tipo_inspeccion(var_si_tipo_inspeccion, var_script_case_init, do_ajax_form_jap_solicitud_inspeccion_validate_si_tipo_inspeccion_cb);
  } // do_ajax_form_jap_solicitud_inspeccion_validate_si_tipo_inspeccion

  function do_ajax_form_jap_solicitud_inspeccion_validate_si_tipo_inspeccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_solicitud_inspeccion_validate_si_tipo_inspeccion_cb

  // ---------- Validate si_comentario
  function do_ajax_form_jap_solicitud_inspeccion_validate_si_comentario()
  {
    var nomeCampo_si_comentario = "si_comentario";
    var var_si_comentario = scAjaxGetFieldText(nomeCampo_si_comentario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_solicitud_inspeccion_validate_si_comentario(var_si_comentario, var_script_case_init, do_ajax_form_jap_solicitud_inspeccion_validate_si_comentario_cb);
  } // do_ajax_form_jap_solicitud_inspeccion_validate_si_comentario

  function do_ajax_form_jap_solicitud_inspeccion_validate_si_comentario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_solicitud_inspeccion_validate_si_comentario_cb

  // ---------- Validate propietario
  function do_ajax_form_jap_solicitud_inspeccion_validate_propietario()
  {
    var nomeCampo_propietario = "propietario";
    var var_propietario = scAjaxGetFieldText(nomeCampo_propietario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_solicitud_inspeccion_validate_propietario(var_propietario, var_script_case_init, do_ajax_form_jap_solicitud_inspeccion_validate_propietario_cb);
  } // do_ajax_form_jap_solicitud_inspeccion_validate_propietario

  function do_ajax_form_jap_solicitud_inspeccion_validate_propietario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_solicitud_inspeccion_validate_propietario_cb

  // ---------- Validate contrato
  function do_ajax_form_jap_solicitud_inspeccion_validate_contrato()
  {
    var nomeCampo_contrato = "contrato";
    var var_contrato = scAjaxGetFieldText(nomeCampo_contrato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_solicitud_inspeccion_validate_contrato(var_contrato, var_script_case_init, do_ajax_form_jap_solicitud_inspeccion_validate_contrato_cb);
  } // do_ajax_form_jap_solicitud_inspeccion_validate_contrato

  function do_ajax_form_jap_solicitud_inspeccion_validate_contrato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_solicitud_inspeccion_validate_contrato_cb

  // ---------- Validate direccion
  function do_ajax_form_jap_solicitud_inspeccion_validate_direccion()
  {
    var nomeCampo_direccion = "direccion";
    var var_direccion = scAjaxGetFieldText(nomeCampo_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_solicitud_inspeccion_validate_direccion(var_direccion, var_script_case_init, do_ajax_form_jap_solicitud_inspeccion_validate_direccion_cb);
  } // do_ajax_form_jap_solicitud_inspeccion_validate_direccion

  function do_ajax_form_jap_solicitud_inspeccion_validate_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_solicitud_inspeccion_validate_direccion_cb

  // ---------- Validate si_fecha_inspeccion
  function do_ajax_form_jap_solicitud_inspeccion_validate_si_fecha_inspeccion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_solicitud_inspeccion_validate_si_fecha_inspeccion(var_si_fecha_inspeccion, var_script_case_init, do_ajax_form_jap_solicitud_inspeccion_validate_si_fecha_inspeccion_cb);
  } // do_ajax_form_jap_solicitud_inspeccion_validate_si_fecha_inspeccion

  function do_ajax_form_jap_solicitud_inspeccion_validate_si_fecha_inspeccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_solicitud_inspeccion_validate_si_fecha_inspeccion_cb

  // ---------- Validate si_observacion
  function do_ajax_form_jap_solicitud_inspeccion_validate_si_observacion()
  {
    var nomeCampo_si_observacion = "si_observacion";
    var var_si_observacion = scAjaxGetFieldText(nomeCampo_si_observacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_solicitud_inspeccion_validate_si_observacion(var_si_observacion, var_script_case_init, do_ajax_form_jap_solicitud_inspeccion_validate_si_observacion_cb);
  } // do_ajax_form_jap_solicitud_inspeccion_validate_si_observacion

  function do_ajax_form_jap_solicitud_inspeccion_validate_si_observacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_solicitud_inspeccion_validate_si_observacion_cb

  // ---------- Validate si_usuario_inspecciona
  function do_ajax_form_jap_solicitud_inspeccion_validate_si_usuario_inspecciona()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_solicitud_inspeccion_validate_si_usuario_inspecciona(var_si_usuario_inspecciona, var_script_case_init, do_ajax_form_jap_solicitud_inspeccion_validate_si_usuario_inspecciona_cb);
  } // do_ajax_form_jap_solicitud_inspeccion_validate_si_usuario_inspecciona

  function do_ajax_form_jap_solicitud_inspeccion_validate_si_usuario_inspecciona_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_solicitud_inspeccion_validate_si_usuario_inspecciona_cb

  // ---------- Event onblur si_contrato
  function do_ajax_form_jap_solicitud_inspeccion_event_si_contrato_onblur()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_jap_solicitud_inspeccion_event_si_contrato_onblur(var_si_contrato, var_propietario, var_contrato, var_direccion, var_script_case_init, do_ajax_form_jap_solicitud_inspeccion_event_si_contrato_onblur_cb);
  } // do_ajax_form_jap_solicitud_inspeccion_event_si_contrato_onblur

  function do_ajax_form_jap_solicitud_inspeccion_event_si_contrato_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "si_contrato";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_jap_solicitud_inspeccion_event_si_contrato_onblur_cb_after_alert);
  } // do_ajax_form_jap_solicitud_inspeccion_event_si_contrato_onblur_cb
  function do_ajax_form_jap_solicitud_inspeccion_event_si_contrato_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_jap_solicitud_inspeccion_event_si_contrato_onblur_cb_after_alert

  // ---------- Event onchange si_contrato
  function do_ajax_form_jap_solicitud_inspeccion_event_si_contrato_onchange()
  {
    var var_si_contrato = scAjaxGetFieldSelect("si_contrato");
    var var_propietario = scAjaxGetFieldText("propietario");
    var var_contrato = scAjaxGetFieldText("contrato");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_jap_solicitud_inspeccion_event_si_contrato_onchange(var_si_contrato, var_propietario, var_contrato, var_direccion, var_script_case_init, do_ajax_form_jap_solicitud_inspeccion_event_si_contrato_onchange_cb);
  } // do_ajax_form_jap_solicitud_inspeccion_event_si_contrato_onchange

  function do_ajax_form_jap_solicitud_inspeccion_event_si_contrato_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "si_contrato";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_jap_solicitud_inspeccion_event_si_contrato_onchange_cb_after_alert);
  } // do_ajax_form_jap_solicitud_inspeccion_event_si_contrato_onchange_cb
  function do_ajax_form_jap_solicitud_inspeccion_event_si_contrato_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_jap_solicitud_inspeccion_event_si_contrato_onchange_cb_after_alert

  // ---------- Event onclick scajaxbutton_anular
  function do_ajax_form_jap_solicitud_inspeccion_event_scajaxbutton_anular_onclick()
  {
    var var_si_motivo_anulacion = scAjaxGetFieldText("si_motivo_anulacion");
    var var_si_id = scAjaxGetFieldHidden("si_id");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_jap_solicitud_inspeccion_event_scajaxbutton_anular_onclick(var_si_motivo_anulacion, var_si_id, var_script_case_init, do_ajax_form_jap_solicitud_inspeccion_event_scajaxbutton_anular_onclick_cb);
  } // do_ajax_form_jap_solicitud_inspeccion_event_scajaxbutton_anular_onclick

  function do_ajax_form_jap_solicitud_inspeccion_event_scajaxbutton_anular_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_jap_solicitud_inspeccion_event_scajaxbutton_anular_onclick_cb_after_alert);
  } // do_ajax_form_jap_solicitud_inspeccion_event_scajaxbutton_anular_onclick_cb
  function do_ajax_form_jap_solicitud_inspeccion_event_scajaxbutton_anular_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_jap_solicitud_inspeccion_event_scajaxbutton_anular_onclick_cb_after_alert

  // ---------- Event onclick scajaxbutton_finalizar
  function do_ajax_form_jap_solicitud_inspeccion_event_scajaxbutton_finalizar_onclick()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_jap_solicitud_inspeccion_event_scajaxbutton_finalizar_onclick(var_si_observacion, var_si_fecha_inspeccion, var_si_id, var_script_case_init, do_ajax_form_jap_solicitud_inspeccion_event_scajaxbutton_finalizar_onclick_cb);
  } // do_ajax_form_jap_solicitud_inspeccion_event_scajaxbutton_finalizar_onclick

  function do_ajax_form_jap_solicitud_inspeccion_event_scajaxbutton_finalizar_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_jap_solicitud_inspeccion_event_scajaxbutton_finalizar_onclick_cb_after_alert);
  } // do_ajax_form_jap_solicitud_inspeccion_event_scajaxbutton_finalizar_onclick_cb
  function do_ajax_form_jap_solicitud_inspeccion_event_scajaxbutton_finalizar_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_jap_solicitud_inspeccion_event_scajaxbutton_finalizar_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_jap_solicitud_inspeccion_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_jap_solicitud_inspeccion_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_si_motivo_anulacion = scAjaxGetFieldText("si_motivo_anulacion");
    ...
    scAjaxProcOn();
    x_ajax_form_jap_solicitud_inspeccion_submit_form(var_si_motivo_anulacion, var_si_id, var_si_empresa, var_si_fecha, var_si_secuecial, var_si_contrato, var_si_estado, var_si_tipo_inspeccion, var_si_comentario, var_propietario, var_contrato, var_direccion, var_si_fecha_inspeccion, var_si_observacion, var_si_usuario_inspecciona, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_jap_solicitud_inspeccion_submit_form_cb);
  } // do_ajax_form_jap_solicitud_inspeccion_submit_form

  function do_ajax_form_jap_solicitud_inspeccion_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_jap_solicitud_inspeccion_submit_form_cb_after_alert);
  } // do_ajax_form_jap_solicitud_inspeccion_submit_form_cb
  function do_ajax_form_jap_solicitud_inspeccion_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_jap_solicitud_inspeccion_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_jap_solicitud_inspeccion_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_jap_solicitud_inspeccion_navigate_form, function() {});
    } else {
      perform_ajax_form_jap_solicitud_inspeccion_navigate_form();
    }
  }

  function perform_ajax_form_jap_solicitud_inspeccion_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_jap_solicitud_inspeccion_navigate_form(var_si_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jap_solicitud_inspeccion_navigate_form_cb);
  } // do_ajax_form_jap_solicitud_inspeccion_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_solicitud_inspeccion']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_jap_solicitud_inspeccion_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_jap_solicitud_inspeccion_navigate_form_cb_after_alert);
  } // do_ajax_form_jap_solicitud_inspeccion_navigate_form_cb
  function do_ajax_form_jap_solicitud_inspeccion_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_jap_solicitud_inspeccion_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_jap_solicitud_inspeccion_navigate_form_cb_after_alert

  function sc_hide_form_jap_solicitud_inspeccion_form()
  {
