...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_del_escenario_cxc"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_del_escenario_cxc"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_escenario_cxc'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_del_escenario_cxc']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_del_escenario_cxc']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_del_escenario_cxc']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_del_escenario_cxc']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_del_escenario_cxc']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_del_escenario_cxc</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_del_escenario_cxc']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_del_escenario_cxc']['embutida_filho'] as $ind => $sc_init)
          {
