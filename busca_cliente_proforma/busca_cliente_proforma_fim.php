...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____busca_cliente_proforma"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____busca_cliente_proforma"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['busca_cliente_proforma']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['busca_cliente_proforma']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['busca_cliente_proforma']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['busca_cliente_proforma']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['busca_cliente_proforma']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>busca_cliente_proforma</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['busca_cliente_proforma']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['busca_cliente_proforma']['embutida_filho'] as $ind => $sc_init)
          {
