...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_cl_id_cond" name="cl_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_cl_id'), this, 'cl_id')">
      ...
      <br><span id="id_hide_cl_id"  <?php echo $str_hide_cl_id?>><INPUT  type="text" id="SC_cl_id" name="cl_id" value="<?php echo NM_encode_input($cl_id) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_cl_empresa_cond" name="cl_empresa_cond" onChange="nm_campos_between(document.getElementById('id_vis_cl_empresa'), this, 'cl_empresa')">
      ...
      <br><span id="id_hide_cl_empresa"  <?php echo $str_hide_cl_empresa?>><?php
      if ($cl_empresa != "")
      {
      $cl_empresa_look = (is_string($cl_empresa) ? substr($this->Db->qstr($cl_empresa), 1, -1) : $cl_empresa); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_cl_nombre_cond" name="cl_nombre_cond" onChange="nm_campos_between(document.getElementById('id_vis_cl_nombre'), this, 'cl_nombre')">
      ...
      <br><span id="id_hide_cl_nombre"  <?php echo $str_hide_cl_nombre?>><?php
      if ($cl_nombre != "")
      {
      $cl_nombre_look = (is_string($cl_nombre) ? substr($this->Db->qstr($cl_nombre), 1, -1) : $cl_nombre); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_cl_tipo_identificacion_cond" name="cl_tipo_identificacion_cond" onChange="nm_campos_between(document.getElementById('id_vis_cl_tipo_identificacion'), this, 'cl_tipo_identificacion')">
      ...
      <br><span id="id_hide_cl_tipo_identificacion"  <?php echo $str_hide_cl_tipo_identificacion?>><?php
