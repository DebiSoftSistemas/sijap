<?php
@session_start() ;
$_SESSION['scriptcase']['busca_cliente_proforma']['sc_process_barr'] = true;
require_once('../busca_cliente_proforma/index.php');
unset($_SESSION['scriptcase']['busca_cliente_proforma']['sc_process_barr']);
$ExportCtrl = new busca_cliente_proforma_export_control;
$ExportCtrl->Export_barr();

class busca_cliente_proforma_export_control
{
