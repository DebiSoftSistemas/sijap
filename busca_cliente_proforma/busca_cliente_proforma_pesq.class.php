...
class busca_cliente_proforma_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . busca_cliente_proforma_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . busca_cliente_proforma_pack_protect_string($Tipo_filter[0]) . "\">.." . busca_cliente_proforma_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_cl_empresa')
      {
          $cl_empresa = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_cl_empresa($cl_empresa);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_cl_tipo_identificacion')
      {
          $cl_tipo_identificacion = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_cl_tipo_identificacion($cl_tipo_identificacion);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$campo_join]);
              return;
          }
         $nm_ini_lower = "";
         $nm_fim_lower = "";
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>busca_cliente_proforma/busca_cliente_proforma_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="busca_cliente_proforma_ajax_search.js"></script>
 <script type="text/javascript" src="busca_cliente_proforma_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="busca_cliente_proforma_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['busca_cliente_proforma']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['busca_cliente_proforma']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_cl_id_cond#NMF#' + search_get_sel_txt('SC_cl_id_cond') + '@NMF@';
  str_out += 'SC_cl_id#NMF#' + search_get_text('SC_cl_id') + '@NMF@';
  str_out += 'SC_cl_empresa_cond#NMF#' + search_get_sel_txt('SC_cl_empresa_cond') + '@NMF@';
  str_out += 'SC_cl_empresa#NMF#' + search_get_text('SC_cl_empresa') + '@NMF@';
  str_out += 'id_ac_cl_empresa#NMF#' + search_get_title('select2-id_ac_cl_empresa-container') + '@NMF@';
  ...
  str_out += 'SC_cl_tipo_identificacion_cond#NMF#' + search_get_sel_txt('SC_cl_tipo_identificacion_cond') + '@NMF@';
  str_out += 'SC_cl_tipo_identificacion#NMF#' + search_get_text('SC_cl_tipo_identificacion') + '@NMF@';
  str_out += 'id_ac_cl_tipo_identificacion#NMF#' + search_get_title('select2-id_ac_cl_tipo_identificacion-container') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-cl_tipo_identificacion").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_cl_tipo_identificacion",
      max_itens: "10",
   ...
   $("#SC_cl_tipo_identificacion").val(e.params.data.id);
  });
  ...
  $(".sc-ui-autocomp-cl_empresa").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_cl_empresa",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_cl_empresa").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      global 
             $cl_id_cond, $cl_id,
             $cl_empresa_cond, $cl_empresa, $cl_empresa_autocomp,
             $cl_nombre_cond, $cl_nombre, $cl_nombre_autocomp,
             $cl_tipo_identificacion_cond, $cl_tipo_identificacion, $cl_tipo_identificacion_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $cl_id = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campos_busca']['cl_id']; 
          $cl_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campos_busca']['cl_id_cond']; 
          $cl_empresa = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campos_busca']['cl_empresa']; 
          $cl_empresa_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campos_busca']['cl_empresa_cond']; 
          $cl_nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campos_busca']['cl_nombre']; 
          $cl_nombre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campos_busca']['cl_nombre_cond']; 
          $cl_tipo_identificacion = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campos_busca']['cl_tipo_identificacion']; 
          $cl_tipo_identificacion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campos_busca']['cl_tipo_identificacion_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campos_busca']['NM_operador']; 
          if (strtoupper($cl_id_cond) != "II" && strtoupper($cl_id_cond) != "QP" && strtoupper($cl_id_cond) != "NP" && strtoupper($cl_id_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($cl_id, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($cl_id_cond) || empty($cl_id_cond))
      {
         $cl_id_cond = "gt";
      }
      if (!isset($cl_empresa_cond) || empty($cl_empresa_cond))
      {
         $cl_empresa_cond = "qp";
      }
      ...
      if (!isset($cl_tipo_identificacion_cond) || empty($cl_tipo_identificacion_cond))
      {
         $cl_tipo_identificacion_cond = "qp";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_cl_id = (in_array($cl_id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_cl_empresa = (in_array($cl_empresa_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_cl_nombre = (in_array($cl_nombre_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_cl_tipo_identificacion = (in_array($cl_tipo_identificacion_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($cl_id) || $cl_id == "")
      {
          $cl_id = "";
      }
      if (isset($cl_id) && !empty($cl_id))
      {
         $tmp_pos = (is_string($cl_id)) ? strpos($cl_id, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $cl_id = substr($cl_id, 0, $tmp_pos);
         }
      }
      if (!isset($cl_empresa) || $cl_empresa == "")
      {
          $cl_empresa = "";
      }
      if (isset($cl_empresa) && !empty($cl_empresa))
      {
         $tmp_pos = (is_string($cl_empresa)) ? strpos($cl_empresa, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $cl_empresa = substr($cl_empresa, 0, $tmp_pos);
         }
      }
      ...
      if (!isset($cl_tipo_identificacion) || $cl_tipo_identificacion == "")
      {
          $cl_tipo_identificacion = "";
      }
      if (isset($cl_tipo_identificacion) && !empty($cl_tipo_identificacion))
      {
         $tmp_pos = (is_string($cl_tipo_identificacion)) ? strpos($cl_tipo_identificacion, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $cl_tipo_identificacion = substr($cl_tipo_identificacion, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_cl_id_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['cl_id'])) ? $this->New_label['cl_id'] : "Cl Id"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_cl_id_cond" name="cl_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_cl_id'), this, 'cl_id')">
       <OPTION value="gt" <?php if ("gt" == $cl_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $cl_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $cl_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cl_id" <?php echo $str_hide_cl_id?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['cl_id'])) ? $this->New_label['cl_id'] : "Cl Id";
 $nmgp_tab_label .= "cl_id?#?" . $SC_Label . "?@?";
...
?>
<INPUT  type="text" id="SC_cl_id" name="cl_id" value="<?php echo NM_encode_input($cl_id) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_cl_empresa_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['cl_empresa'])) ? $this->New_label['cl_empresa'] : "Cl Empresa"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_cl_empresa_cond" name="cl_empresa_cond" onChange="nm_campos_between(document.getElementById('id_vis_cl_empresa'), this, 'cl_empresa')">
       <OPTION value="qp" <?php if ("qp" == $cl_empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $cl_empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $cl_empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $cl_empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cl_empresa" <?php echo $str_hide_cl_empresa?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['cl_empresa'])) ? $this->New_label['cl_empresa'] : "Cl Empresa";
 $nmgp_tab_label .= "cl_empresa?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $cl_empresa;
      }
?>
<INPUT  type="text" id="SC_cl_empresa" name="cl_empresa" value="<?php echo NM_encode_input($cl_empresa) ?>"  size=13 alt="{datatype: 'text', maxLength: 13, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-cl_empresa" id="id_ac_cl_empresa" name="cl_empresa_autocomp"><?php if ('' !=  $cl_empresa) { ?><option value="<?php echo $cl_empresa ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
     ...
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_cl_nombre_cond" name="cl_nombre_cond" onChange="nm_campos_between(document.getElementById('id_vis_cl_nombre'), this, 'cl_nombre')">
       <OPTION value="qp" <?php if ("qp" == $cl_nombre_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $cl_nombre_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $cl_nombre_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $cl_nombre_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-cl_nombre" id="id_ac_cl_nombre" name="cl_nombre_autocomp"><?php if ('' !=  $cl_nombre) { ?><option value="<?php echo $cl_nombre ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_cl_tipo_identificacion_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['cl_tipo_identificacion'])) ? $this->New_label['cl_tipo_identificacion'] : "" . $this->Ini->Nm_lang['lang_lot_tipoid'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_cl_tipo_identificacion_cond" name="cl_tipo_identificacion_cond" onChange="nm_campos_between(document.getElementById('id_vis_cl_tipo_identificacion'), this, 'cl_tipo_identificacion')">
       <OPTION value="qp" <?php if ("qp" == $cl_tipo_identificacion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $cl_tipo_identificacion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $cl_tipo_identificacion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $cl_tipo_identificacion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cl_tipo_identificacion" <?php echo $str_hide_cl_tipo_identificacion?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 ...
 $nmgp_tab_label .= "cl_tipo_identificacion?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $cl_tipo_identificacion;
      }
?>
<INPUT  type="text" id="SC_cl_tipo_identificacion" name="cl_tipo_identificacion" value="<?php echo NM_encode_input($cl_tipo_identificacion) ?>"  size=2 alt="{datatype: 'text', maxLength: 2, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-cl_tipo_identificacion" id="id_ac_cl_tipo_identificacion" name="cl_tipo_identificacion_autocomp"><?php if ('' !=  $cl_tipo_identificacion) { ?><option value="<?php echo $cl_tipo_identificacion ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("busca_cliente_proforma_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['busca_cliente_proforma']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['busca_cliente_proforma']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.cl_id_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_cl_id'), document.F1.cl_id_cond, 'cl_id');
   document.F1.cl_id.value = "";
   document.F1.cl_empresa_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_cl_empresa'), document.F1.cl_empresa_cond, 'cl_empresa');
   document.F1.cl_empresa.value = "";
   document.F1.cl_empresa_autocomp.value = "";
   $('#select2-id_ac_cl_empresa-container').html('<?php echo $this->Val_init_cl_empresa['desc'] ?>');;
   document.F1.cl_nombre_cond.value = 'qp';
   ...
   document.F1.cl_tipo_identificacion_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_cl_tipo_identificacion'), document.F1.cl_tipo_identificacion_cond, 'cl_tipo_identificacion');
   document.F1.cl_tipo_identificacion.value = "";
   document.F1.cl_tipo_identificacion_autocomp.value = "";
   $('#select2-id_ac_cl_tipo_identificacion-container').html('<?php echo $this->Val_init_cl_tipo_identificacion['desc'] ?>');;
   Sc_carga_select2('all');
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "busca_cliente_proforma/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_cl_id_cond'] = 'cond';
      $tp_fields['SC_cl_id'] = 'text';
      $tp_fields['SC_cl_empresa_cond'] = 'cond';
      $tp_fields['SC_cl_empresa'] = 'text_aut';
      $tp_fields['id_ac_cl_empresa'] = 'select2_aut';
      $tp_fields['SC_cl_nombre_cond'] = 'cond';
      $tp_fields['SC_cl_nombre'] = 'text_aut';
      $tp_fields['id_ac_cl_nombre'] = 'select2_aut';
      $tp_fields['SC_cl_tipo_identificacion_cond'] = 'cond';
      $tp_fields['SC_cl_tipo_identificacion'] = 'text_aut';
      $tp_fields['id_ac_cl_tipo_identificacion'] = 'select2_aut';
   ...
   {
      global $cl_id_cond, $cl_id,
             $cl_empresa_cond, $cl_empresa, $cl_empresa_autocomp,
             $cl_nombre_cond, $cl_nombre, $cl_nombre_autocomp,
             $cl_tipo_identificacion_cond, $cl_tipo_identificacion, $cl_tipo_identificacion_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($cl_empresa_autocomp) && empty($cl_empresa))
      {
          $cl_empresa = $cl_empresa_autocomp;
      }
      if (!empty($cl_nombre_autocomp) && empty($cl_nombre))
      {
          $cl_nombre = $cl_nombre_autocomp;
      }
      if (!empty($cl_tipo_identificacion_autocomp) && empty($cl_tipo_identificacion))
      {
          $cl_tipo_identificacion = $cl_tipo_identificacion_autocomp;
      }
      $cl_id_cond_salva = $cl_id_cond; 
      if (!isset($cl_id_input_2) || $cl_id_input_2 == "")
      {
          $cl_id_input_2 = $cl_id;
      }
      $cl_empresa_cond_salva = $cl_empresa_cond; 
      if (!isset($cl_empresa_input_2) || $cl_empresa_input_2 == "")
      {
          $cl_empresa_input_2 = $cl_empresa;
      }
      ...
      $cl_tipo_identificacion_cond_salva = $cl_tipo_identificacion_cond; 
      if (!isset($cl_tipo_identificacion_input_2) || $cl_tipo_identificacion_input_2 == "")
      {
          $cl_tipo_identificacion_input_2 = $cl_tipo_identificacion;
      }
      if ($cl_id_cond != "in")
      {
          nm_limpa_numero($cl_id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campos_busca']['cl_id'] = $cl_id; 
      if (is_array($cl_id) && !empty($cl_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['Grid_search'][$I_Grid]['val'][0] = $cl_id;
      }
      elseif ($cl_id_cond_salva == "nu" || $cl_id_cond_salva == "nn" || $cl_id_cond_salva == "ep" || $cl_id_cond_salva == "ne" || !empty($cl_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['Grid_search'][$I_Grid]['val'][0][0] = $cl_id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campos_busca']['cl_id_cond'] = $cl_id_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['Grid_search'][$I_Grid]['cmp'] = "cl_id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['Grid_search'][$I_Grid]['opc'] = $cl_id_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq']['cl_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campos_busca']['cl_empresa'] = $cl_empresa; 
      if (is_array($cl_empresa) && !empty($cl_empresa))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['Grid_search'][$I_Grid]['val'][0] = $cl_empresa;
      }
      elseif ($cl_empresa_cond_salva == "nu" || $cl_empresa_cond_salva == "nn" || $cl_empresa_cond_salva == "ep" || $cl_empresa_cond_salva == "ne" || !empty($cl_empresa))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['Grid_search'][$I_Grid]['val'][0][0] = $cl_empresa;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campos_busca']['cl_empresa_cond'] = $cl_empresa_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['Grid_search'][$I_Grid]['cmp'] = "cl_empresa"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['Grid_search'][$I_Grid]['opc'] = $cl_empresa_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq']['cl_empresa'] = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campos_busca']['cl_nombre'] = $cl_nombre; 
      if (is_array($cl_nombre) && !empty($cl_nombre))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['Grid_search'][$I_Grid]['val'][0] = $cl_nombre;
      }
      elseif ($cl_nombre_cond_salva == "nu" || $cl_nombre_cond_salva == "nn" || $cl_nombre_cond_salva == "ep" || $cl_nombre_cond_salva == "ne" || !empty($cl_nombre))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['Grid_search'][$I_Grid]['val'][0][0] = $cl_nombre;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campos_busca']['cl_nombre_cond'] = $cl_nombre_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['Grid_search'][$I_Grid]['cmp'] = "cl_nombre"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['Grid_search'][$I_Grid]['opc'] = $cl_nombre_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq']['cl_nombre'] = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campos_busca']['cl_tipo_identificacion'] = $cl_tipo_identificacion; 
      if (is_array($cl_tipo_identificacion) && !empty($cl_tipo_identificacion))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['Grid_search'][$I_Grid]['val'][0] = $cl_tipo_identificacion;
      }
      elseif ($cl_tipo_identificacion_cond_salva == "nu" || $cl_tipo_identificacion_cond_salva == "nn" || $cl_tipo_identificacion_cond_salva == "ep" || $cl_tipo_identificacion_cond_salva == "ne" || !empty($cl_tipo_identificacion))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['Grid_search'][$I_Grid]['val'][0][0] = $cl_tipo_identificacion;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campos_busca']['cl_tipo_identificacion_cond'] = $cl_tipo_identificacion_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['Grid_search'][$I_Grid]['cmp'] = "cl_tipo_identificacion"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['Grid_search'][$I_Grid]['opc'] = $cl_tipo_identificacion_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['grid_pesq']['cl_tipo_identificacion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $this->cmp_formatado['cl_id'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($cl_empresa != '') {
      $cl_empresa_look = (is_string($cl_empresa) ? substr($this->Db->qstr($cl_empresa), 1, -1) : $cl_empresa); 
      $nmgp_def_dados = array(); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['cl_empresa'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['cl_empresa'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['cl_empresa'] = $cl_empresa;
      }
      $nmgp_def_dados = array();
    if ($cl_nombre != '') {
      $cl_nombre_look = (is_string($cl_nombre) ? substr($this->Db->qstr($cl_nombre), 1, -1) : $cl_nombre); 
    ...
    if ($cl_tipo_identificacion != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['cl_tipo_identificacion'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['cl_tipo_identificacion'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['cl_tipo_identificacion'] = $cl_tipo_identificacion;
      }

      //----- $cl_id
      $this->Date_part = false;
      if (isset($cl_id) || $cl_id_cond == "nu" || $cl_id_cond == "nn" || $cl_id_cond == "ep" || $cl_id_cond == "ne")
      {
         $this->monta_condicao("cl_id", $cl_id_cond, $cl_id, "", "cl_id", "INT4", false);
      }

      //----- $cl_empresa
      $this->Date_part = false;
      if (isset($cl_empresa) || $cl_empresa_cond == "nu" || $cl_empresa_cond == "nn" || $cl_empresa_cond == "ep" || $cl_empresa_cond == "ne")
      {
         $this->monta_condicao("cl_empresa", $cl_empresa_cond, $cl_empresa, "", "cl_empresa", "VARCHAR", false);
      }
      ...
      //----- $cl_tipo_identificacion
      $this->Date_part = false;
      if (isset($cl_tipo_identificacion) || $cl_tipo_identificacion_cond == "nu" || $cl_tipo_identificacion_cond == "nn" || $cl_tipo_identificacion_cond == "ep" || $cl_tipo_identificacion_cond == "ne")
      {
         $this->monta_condicao("cl_tipo_identificacion", $cl_tipo_identificacion_cond, $cl_tipo_identificacion, "", "cl_tipo_identificacion", "VARCHAR", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
    $this->Sel_case_sensitive($this->comando);
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['busca_cliente_proforma']['cond_pesq'] .= $this->NM_operador;
