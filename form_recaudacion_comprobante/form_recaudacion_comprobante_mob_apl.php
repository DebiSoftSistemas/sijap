<?php
//
class form_recaudacion_comprobante_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_recaudacion_comprobante_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_recaudacion_comprobante_mob']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_recaudacion_comprobante_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_recaudacion_comprobante_mob']['embutida_parms'];
          unset($_SESSION['sc_session'][$script_case_init]['form_recaudacion_comprobante_mob']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_form_recaudacion_comprobante_mob($cadapar[1]);
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_recaudacion_comprobante_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_recaudacion_comprobante_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_recaudacion_comprobante_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_recaudacion_comprobante_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (!isset($this->Igtech_RucEmpresa) && isset($this->igtech_rucempresa)) 
          {
              $this->Igtech_RucEmpresa = $this->igtech_rucempresa;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_recaudacion_comprobante_mob']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['form_recaudacion_comprobante_mob']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_recaudacion_comprobante_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_recaudacion_comprobante_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_recaudacion_comprobante_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_recaudacion_comprobante_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_recaudacion_comprobante_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_recaudacion_comprobante_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_recaudacion_comprobante_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_recaudacion_comprobante_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_recaudacion_comprobante_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_comprobante']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_comprobante'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_comprobante_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['form_recaudacion_comprobante_mob']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_recaudacion_comprobante_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_recaudacion_comprobante_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_recaudacion_comprobante_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_recaudacion_comprobante_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_recaudacion_comprobante_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_recaudacion_comprobante_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " del_cliente";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_recaudacion_comprobante_mob")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $this->arr_buttons['seleccionar_todo']['style']            = "small";
      ...
      $_SESSION['scriptcase']['error_icon']['form_recaudacion_comprobante_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_recaudacion_comprobante_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_comprobante_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_comprobante_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_comprobante_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_comprobante_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_comprobante_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_comprobante_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_comprobante_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_comprobante_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_comprobante_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recaudacion_comprobante_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_recaudacion_comprobante_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_recaudacion_comprobante_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_comprobante_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_comprobante_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_comprobante_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_comprobante_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_comprobante_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_comprobante_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_comprobante_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_comprobante_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_comprobante_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_comprobante_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_comprobante_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_comprobante_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_comprobante_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_comprobante_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_comprobante_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_comprobante_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_comprobante_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_comprobante_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_comprobante_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_recaudacion_comprobante_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      { 
          include_once($this->Ini->path_embutida . 'form_recaudacion_comprobante/Igtech.DebiConta.Clases.php');
      }
      else
      { 
      ...
      if ($this->Embutida_proc)
      { 
          include_once($this->Ini->path_embutida . 'form_recaudacion_comprobante/Igtech.Log.php');
      }
      else
      { 
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_recaudacion_comprobante_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_recaudacion_comprobante_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_recaudacion_comprobante/form_recaudacion_comprobante_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_recaudacion_comprobante_mob_erro.class.php"); 
      }
      $this->Erro      = new form_recaudacion_comprobante_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['opcao']))
         { 
             if ($this->cl_id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_comprobante_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_comprobante_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_recaudacion_comprobante_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['opc_ant'] : "";
      } 
      ...
      {
          $this->nmgp_botoes['actualizar_cliente'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['botoes']['actualizar_cliente'];
          $this->nmgp_botoes['facturar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['botoes']['facturar'];
          $this->nmgp_botoes['seleccionar_todo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['botoes']['seleccionar_todo'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_recaudacion_comprobante_mob']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_recaudacion_comprobante_mob']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_select'];
     }
   }
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['Gera_log_access'] = false;
      }
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          form_recaudacion_comprobante_mob_pack_ajax_response();
          exit;
      }
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6))
      {
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          ...
          $this->nm_tira_formatacao();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_select']['cl_identificacion']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->cl_identificacion = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_select']['cl_identificacion'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_select']['cl_nombre']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->cl_nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_select']['cl_nombre'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_select']['cl_direccion']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->cl_direccion = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_select']['cl_direccion'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_select']['cl_telefono']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->cl_telefono = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_select']['cl_telefono'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_select']['cl_email']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->cl_email = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_select']['cl_email'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_select']['tesoreria']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tesoreria = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_select']['tesoreria'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_select']['total']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->total = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_select']['total'];
          } 
      ...
      if ($this->nmgp_opcao == "incluir" || $this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "excluir") 
      {
          ...
          $_SESSION['scriptcase']['form_recaudacion_comprobante_mob']['contr_erro'] = 'off';
          if ($Campos_Crit != "") 
          {
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['recarga'] = $this->nmgp_opcao;
      }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_recaudacion_comprobante_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_recaudacion_comprobante_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_recaudacion_comprobante_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="form_recaudacion_comprobante_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_recaudacion_comprobante_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sis_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'form_recaudacion_comprobante_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_recaudacion_comprobante_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
<?php
include_once("form_recaudacion_comprobante_mob_sajax_js.php");
?>
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['opc_ant'] == "incluir")
      {
      ...
      {
          if (!isset($this->total) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_form']['total']))
          {
              $varloc_btn_php['total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_form']['total'];
          }
          if (!isset($this->forma_pago) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_form']['forma_pago']))
          {
              $varloc_btn_php['forma_pago'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_form']['forma_pago'];
          }
          if (!isset($this->libretin) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_form']['libretin']))
          {
              $varloc_btn_php['libretin'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_form']['libretin'];
          }
          if (!isset($this->cl_email) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_form']['cl_email']))
          {
              $varloc_btn_php['cl_email'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_form']['cl_email'];
          }
          if (!isset($this->cl_telefono) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_form']['cl_telefono']))
          {
              $varloc_btn_php['cl_telefono'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_form']['cl_telefono'];
          }
          if (!isset($this->cl_direccion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_form']['cl_direccion']))
          {
              $varloc_btn_php['cl_direccion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_form']['cl_direccion'];
          }
          if (!isset($this->cl_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_form']['cl_id']))
          {
              $varloc_btn_php['cl_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_form']['cl_id'];
          }
          if (!isset($this->libretin) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_form']['libretin']))
          {
              $varloc_btn_php['libretin'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_form']['libretin'];
          }
          if (!isset($this->tesoreria) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_form']['tesoreria']))
          {
              $varloc_btn_php['tesoreria'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_form']['tesoreria'];
          }
          if (!isset($this->saldo_por_pagar) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_form']['saldo_por_pagar']))
          {
              $varloc_btn_php['saldo_por_pagar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_form']['saldo_por_pagar'];
          }
          if (!isset($this->forma_pago) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_form']['forma_pago']))
          {
              $varloc_btn_php['forma_pago'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_form']['forma_pago'];
          }
          if (!isset($this->valor_pago) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_form']['valor_pago']))
          {
              $varloc_btn_php['valor_pago'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_form']['valor_pago'];
          }
          if (!isset($this->documento) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_form']['documento']))
          {
              $varloc_btn_php['documento'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_form']['documento'];
          }
          if (!isset($this->cl_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_form']['cl_id']))
          {
              $varloc_btn_php['cl_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_form']['cl_id'];
          }
          if (!isset($this->rs_operacion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_form']['rs_operacion']))
          {
              $varloc_btn_php['rs_operacion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_form']['rs_operacion'];
          }
          if (!isset($this->rs_operacion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_form']['rs_operacion']))
          {
              $varloc_btn_php['rs_operacion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_form']['rs_operacion'];
      ...
      $nm_f_saida = "form_recaudacion_comprobante_mob.php";
      ...
      $_SESSION['scriptcase']['form_recaudacion_comprobante_mob']['contr_erro'] = 'on';
...
if (!isset($this->sc_temp_Igtech_SesionLogin)) {$this->sc_temp_Igtech_SesionLogin = (isset($_SESSION['Igtech_SesionLogin'])) ? $_SESSION['Igtech_SesionLogin'] : "";}
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_recaudacion_comprobante_mob';
...
if ($this->cl_email <>'' and $this->cl_telefono <>'' and $this->cl_direccion <>'' ){
	...
	$check_sql = "SELECT * from sp_factura_operacion(
													...
													'".$this->documento ."') as (respuesta int,mensaje varchar);";
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_recaudacion_comprobante_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_recaudacion_comprobante_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_recaudacion_comprobante_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_recaudacion_comprobante_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
   ...
   if (isset($this->Field_no_validate['tesoreria'])) {
       return;
               ...
               if (!empty($this->tesoreria) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['Lookup_tesoreria']) && !in_array($this->tesoreria, $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['Lookup_tesoreria']))
               {
                   $hasError = true;
   ...
   if (isset($this->Field_no_validate['forma_pago'])) {
       return;
               ...
               if (!empty($this->forma_pago) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['Lookup_forma_pago']) && !in_array($this->forma_pago, $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['Lookup_forma_pago']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['libretin'])) {
       return;
               ...
               if (!empty($this->libretin) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['Lookup_libretin']) && !in_array($this->libretin, $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['Lookup_libretin']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['cl_id']['keyVal'] = form_recaudacion_comprobante_mob_pack_protect_string($this->nmgp_dados_form['cl_id']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['grid_fac_operacion_comp_script_case_init'] ]['grid_fac_operacion_comp']['embutida_form_full'] = false;
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['grid_fac_operacion_comp_script_case_init'] ]['grid_fac_operacion_comp']['embutida_form']       = true;
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['grid_fac_operacion_comp_script_case_init'] ]['grid_fac_operacion_comp']['embutida_pai']        = "form_recaudacion_comprobante_mob";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['grid_fac_operacion_comp_script_case_init'] ]['grid_fac_operacion_comp']['embutida_form_parms'] = "var_propietario*scin" . $this->nmgp_dados_form['cl_id'] . "*scoutNMSC_inicial*scininicio*scoutNMSC_paginacao*scinFULL*scout";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['grid_fac_operacion_comp_script_case_init'] ]['grid_fac_operacion_comp']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['grid_fac_operacion_comp_script_case_init'] ]['grid_fac_operacion_comp']['total']);
              foreach ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['grid_fac_operacion_comp_script_case_init'] ]['grid_fac_operacion_comp'] as $i => $v)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['grid_fac_operacion_comp_script_case_init'] ]['grid_fac_operacion_comp'][$i] = $v;
              }
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['grid_fac_operacion_comp_script_case_init'] ]['grid_fac_operacion_comp']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['grid_fac_operacion_comp_script_case_init'] ]['grid_fac_operacion_comp']['total']);
              }
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['Lookup_tesoreria']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['Lookup_tesoreria'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['Lookup_tesoreria']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['Lookup_tesoreria'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_recaudacion_comprobante_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_recaudacion_comprobante_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['Lookup_tesoreria'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tesoreria']['valList'][$i] = form_recaudacion_comprobante_mob_pack_protect_string($v);
          }
...
$aLookup[] = array(form_recaudacion_comprobante_mob_pack_protect_string('S') => str_replace('<', '&lt;',form_recaudacion_comprobante_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['Lookup_usar_compensacion'][] = 'S';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['usar_compensacion']['valList'][$i] = form_recaudacion_comprobante_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['Lookup_forma_pago']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['Lookup_forma_pago'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['Lookup_forma_pago']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['Lookup_forma_pago'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['Lookup_forma_pago'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['forma_pago']['valList'][$i] = form_recaudacion_comprobante_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['Lookup_libretin']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['Lookup_libretin'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['Lookup_libretin']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['Lookup_libretin'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['Lookup_libretin'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['libretin']['valList'][$i] = form_recaudacion_comprobante_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_cl_id($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['Field_no_validate'] = array();
...
if (!isset($this->sc_temp_Igtech_SesionLogin)) {$this->sc_temp_Igtech_SesionLogin = (isset($_SESSION['Igtech_SesionLogin'])) ? $_SESSION['Igtech_SesionLogin'] : "";}
if (!isset($this->sc_temp_Igtech_RucEmpresa)) {$this->sc_temp_Igtech_RucEmpresa = (isset($_SESSION['Igtech_RucEmpresa'])) ? $_SESSION['Igtech_RucEmpresa'] : "";}
  $this->titulo = $this->Ini->Nm_lang['lang_emitir_notaventa'] ;
$var_mensaje="";
...
if($this->rs[0][0]>0){
	$var_mensaje.="El usuario tiene facturas a crédito por cobrar.<br>";
}
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->cl_id)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['opcao'] = '';
   ...
   { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
              ...
              $this->nmgp_refresh_fields = array_diff(array('titulo', 'mensaje', 'cl_identificacion', 'cl_nombre', 'cl_direccion', 'cl_telefono', 'cl_email', 'tesoreria', 'saldo_por_pagar', 'usar_compensacion', 'forma_pago', 'valor_pago', 'documento', 'libretin', 'total', 'operaciones'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['total']);
              }
              ...
              $this->NM_gera_log_new();
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['parms'] = "cl_id?#?$this->cl_id?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['select'] = ""; 
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_select'] = $this->nmgp_dados_select;
...
//-- 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operacion_comp']['embutida_parms'] = "var_propietario*scin" . $this->nmgp_dados_form['cl_id'] . "*scoutNMSC_inicial*scininicio*scoutNMSC_paginacao*scinFULL*scout";
  }
// 
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dados_select'];
   ...
   function NM_gera_log_output() 
   {
       ...
       $this->NM_gera_log_insert("Scriptcase", $this->SC_log_evt, $Log_output);
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
if($this->usar_compensacion =='S'){
	$select_sql="SELECT cxp_valor FROM v_del_cuentas_por_pagar_cliente WHERE cxp_cliente=".$this->cl_id ;
...
$this->nm_formatar_campos('usar_compensacion', 'saldo_por_pagar', 'total', 'valor_pago');
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_recaudacion_comprobante_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_recaudacion_comprobante_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['total'] = $qt_geral_reg_form_recaudacion_comprobante_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_recaudacion_comprobante_mob_pack_ajax_response();
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_recaudacion_comprobante_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_recaudacion_comprobante_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['retorno_edit'] = "";
   }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function getButtonIds($buttonName) {
        switch ($buttonName) {
            ...
            case "seleccionar_todo":
                return array("sc_seleccionar_todo_top.", "sc_seleccionar_todo_top.");
                break;
        }
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['ordem_ord'] == " desc") {
