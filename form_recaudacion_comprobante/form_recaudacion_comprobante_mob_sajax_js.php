  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_recaudacion_comprobante_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_recaudacion_comprobante_mob_form();
	}
...
?>
  ...
  // ---------- Validate titulo
  function do_ajax_form_recaudacion_comprobante_mob_validate_titulo()
  {
    var nomeCampo_titulo = "titulo";
    var var_titulo = scAjaxGetFieldHidden(nomeCampo_titulo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recaudacion_comprobante_mob_validate_titulo(var_titulo, var_script_case_init, do_ajax_form_recaudacion_comprobante_mob_validate_titulo_cb);
  } // do_ajax_form_recaudacion_comprobante_mob_validate_titulo

  function do_ajax_form_recaudacion_comprobante_mob_validate_titulo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recaudacion_comprobante_mob_validate_titulo_cb

  // ---------- Validate mensaje
  function do_ajax_form_recaudacion_comprobante_mob_validate_mensaje()
  {
    var nomeCampo_mensaje = "mensaje";
    var var_mensaje = scAjaxGetFieldHidden(nomeCampo_mensaje);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recaudacion_comprobante_mob_validate_mensaje(var_mensaje, var_script_case_init, do_ajax_form_recaudacion_comprobante_mob_validate_mensaje_cb);
  } // do_ajax_form_recaudacion_comprobante_mob_validate_mensaje

  function do_ajax_form_recaudacion_comprobante_mob_validate_mensaje_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mensaje";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recaudacion_comprobante_mob_validate_mensaje_cb

  // ---------- Validate cl_identificacion
  function do_ajax_form_recaudacion_comprobante_mob_validate_cl_identificacion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recaudacion_comprobante_mob_validate_cl_identificacion(var_cl_identificacion, var_script_case_init, do_ajax_form_recaudacion_comprobante_mob_validate_cl_identificacion_cb);
  } // do_ajax_form_recaudacion_comprobante_mob_validate_cl_identificacion

  function do_ajax_form_recaudacion_comprobante_mob_validate_cl_identificacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recaudacion_comprobante_mob_validate_cl_identificacion_cb

  // ---------- Validate cl_nombre
  function do_ajax_form_recaudacion_comprobante_mob_validate_cl_nombre()
  {
    var nomeCampo_cl_nombre = "cl_nombre";
    var var_cl_nombre = scAjaxGetFieldText(nomeCampo_cl_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recaudacion_comprobante_mob_validate_cl_nombre(var_cl_nombre, var_script_case_init, do_ajax_form_recaudacion_comprobante_mob_validate_cl_nombre_cb);
  } // do_ajax_form_recaudacion_comprobante_mob_validate_cl_nombre

  function do_ajax_form_recaudacion_comprobante_mob_validate_cl_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recaudacion_comprobante_mob_validate_cl_nombre_cb

  // ---------- Validate cl_direccion
  function do_ajax_form_recaudacion_comprobante_mob_validate_cl_direccion()
  {
    var nomeCampo_cl_direccion = "cl_direccion";
    var var_cl_direccion = scAjaxGetFieldText(nomeCampo_cl_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recaudacion_comprobante_mob_validate_cl_direccion(var_cl_direccion, var_script_case_init, do_ajax_form_recaudacion_comprobante_mob_validate_cl_direccion_cb);
  } // do_ajax_form_recaudacion_comprobante_mob_validate_cl_direccion

  function do_ajax_form_recaudacion_comprobante_mob_validate_cl_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recaudacion_comprobante_mob_validate_cl_direccion_cb

  // ---------- Validate cl_telefono
  function do_ajax_form_recaudacion_comprobante_mob_validate_cl_telefono()
  {
    var nomeCampo_cl_telefono = "cl_telefono";
    var var_cl_telefono = scAjaxGetFieldText(nomeCampo_cl_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recaudacion_comprobante_mob_validate_cl_telefono(var_cl_telefono, var_script_case_init, do_ajax_form_recaudacion_comprobante_mob_validate_cl_telefono_cb);
  } // do_ajax_form_recaudacion_comprobante_mob_validate_cl_telefono

  function do_ajax_form_recaudacion_comprobante_mob_validate_cl_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recaudacion_comprobante_mob_validate_cl_telefono_cb

  // ---------- Validate cl_email
  function do_ajax_form_recaudacion_comprobante_mob_validate_cl_email()
  {
    var nomeCampo_cl_email = "cl_email";
    var var_cl_email = scAjaxGetFieldText(nomeCampo_cl_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recaudacion_comprobante_mob_validate_cl_email(var_cl_email, var_script_case_init, do_ajax_form_recaudacion_comprobante_mob_validate_cl_email_cb);
  } // do_ajax_form_recaudacion_comprobante_mob_validate_cl_email

  function do_ajax_form_recaudacion_comprobante_mob_validate_cl_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recaudacion_comprobante_mob_validate_cl_email_cb

  // ---------- Validate tesoreria
  function do_ajax_form_recaudacion_comprobante_mob_validate_tesoreria()
  {
    var nomeCampo_tesoreria = "tesoreria";
    var var_tesoreria = scAjaxGetFieldSelect(nomeCampo_tesoreria);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recaudacion_comprobante_mob_validate_tesoreria(var_tesoreria, var_script_case_init, do_ajax_form_recaudacion_comprobante_mob_validate_tesoreria_cb);
  } // do_ajax_form_recaudacion_comprobante_mob_validate_tesoreria

  function do_ajax_form_recaudacion_comprobante_mob_validate_tesoreria_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recaudacion_comprobante_mob_validate_tesoreria_cb

  // ---------- Validate saldo_por_pagar
  function do_ajax_form_recaudacion_comprobante_mob_validate_saldo_por_pagar()
  {
    var nomeCampo_saldo_por_pagar = "saldo_por_pagar";
    var var_saldo_por_pagar = scAjaxGetFieldHidden(nomeCampo_saldo_por_pagar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recaudacion_comprobante_mob_validate_saldo_por_pagar(var_saldo_por_pagar, var_script_case_init, do_ajax_form_recaudacion_comprobante_mob_validate_saldo_por_pagar_cb);
  } // do_ajax_form_recaudacion_comprobante_mob_validate_saldo_por_pagar

  function do_ajax_form_recaudacion_comprobante_mob_validate_saldo_por_pagar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recaudacion_comprobante_mob_validate_saldo_por_pagar_cb

  // ---------- Validate usar_compensacion
  function do_ajax_form_recaudacion_comprobante_mob_validate_usar_compensacion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recaudacion_comprobante_mob_validate_usar_compensacion(var_usar_compensacion, var_script_case_init, do_ajax_form_recaudacion_comprobante_mob_validate_usar_compensacion_cb);
  } // do_ajax_form_recaudacion_comprobante_mob_validate_usar_compensacion

  function do_ajax_form_recaudacion_comprobante_mob_validate_usar_compensacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recaudacion_comprobante_mob_validate_usar_compensacion_cb

  // ---------- Validate forma_pago
  function do_ajax_form_recaudacion_comprobante_mob_validate_forma_pago()
  {
    var nomeCampo_forma_pago = "forma_pago";
    var var_forma_pago = scAjaxGetFieldSelect(nomeCampo_forma_pago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recaudacion_comprobante_mob_validate_forma_pago(var_forma_pago, var_script_case_init, do_ajax_form_recaudacion_comprobante_mob_validate_forma_pago_cb);
  } // do_ajax_form_recaudacion_comprobante_mob_validate_forma_pago

  function do_ajax_form_recaudacion_comprobante_mob_validate_forma_pago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recaudacion_comprobante_mob_validate_forma_pago_cb

  // ---------- Validate valor_pago
  function do_ajax_form_recaudacion_comprobante_mob_validate_valor_pago()
  {
    var nomeCampo_valor_pago = "valor_pago";
    var var_valor_pago = scAjaxGetFieldHidden(nomeCampo_valor_pago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recaudacion_comprobante_mob_validate_valor_pago(var_valor_pago, var_script_case_init, do_ajax_form_recaudacion_comprobante_mob_validate_valor_pago_cb);
  } // do_ajax_form_recaudacion_comprobante_mob_validate_valor_pago

  function do_ajax_form_recaudacion_comprobante_mob_validate_valor_pago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recaudacion_comprobante_mob_validate_valor_pago_cb

  // ---------- Validate documento
  function do_ajax_form_recaudacion_comprobante_mob_validate_documento()
  {
    var nomeCampo_documento = "documento";
    var var_documento = scAjaxGetFieldText(nomeCampo_documento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recaudacion_comprobante_mob_validate_documento(var_documento, var_script_case_init, do_ajax_form_recaudacion_comprobante_mob_validate_documento_cb);
  } // do_ajax_form_recaudacion_comprobante_mob_validate_documento

  function do_ajax_form_recaudacion_comprobante_mob_validate_documento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recaudacion_comprobante_mob_validate_documento_cb

  // ---------- Validate libretin
  function do_ajax_form_recaudacion_comprobante_mob_validate_libretin()
  {
    var nomeCampo_libretin = "libretin";
    var var_libretin = scAjaxGetFieldSelect(nomeCampo_libretin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recaudacion_comprobante_mob_validate_libretin(var_libretin, var_script_case_init, do_ajax_form_recaudacion_comprobante_mob_validate_libretin_cb);
  } // do_ajax_form_recaudacion_comprobante_mob_validate_libretin

  function do_ajax_form_recaudacion_comprobante_mob_validate_libretin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recaudacion_comprobante_mob_validate_libretin_cb

  // ---------- Validate total
  function do_ajax_form_recaudacion_comprobante_mob_validate_total()
  {
    var nomeCampo_total = "total";
    var var_total = scAjaxGetFieldText(nomeCampo_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recaudacion_comprobante_mob_validate_total(var_total, var_script_case_init, do_ajax_form_recaudacion_comprobante_mob_validate_total_cb);
  } // do_ajax_form_recaudacion_comprobante_mob_validate_total

  function do_ajax_form_recaudacion_comprobante_mob_validate_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "total";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recaudacion_comprobante_mob_validate_total_cb

  // ---------- Validate operaciones
  function do_ajax_form_recaudacion_comprobante_mob_validate_operaciones()
  {
    var nomeCampo_operaciones = "operaciones";
    var var_operaciones = scAjaxGetFieldText(nomeCampo_operaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recaudacion_comprobante_mob_validate_operaciones(var_operaciones, var_script_case_init, do_ajax_form_recaudacion_comprobante_mob_validate_operaciones_cb);
  } // do_ajax_form_recaudacion_comprobante_mob_validate_operaciones

  function do_ajax_form_recaudacion_comprobante_mob_validate_operaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recaudacion_comprobante_mob_validate_operaciones_cb

  // ---------- Event onclick usar_compensacion
  function do_ajax_form_recaudacion_comprobante_mob_event_usar_compensacion_onclick()
  {
    ...
    var var_valor_pago = scAjaxGetFieldHidden("valor_pago");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_recaudacion_comprobante_mob_event_usar_compensacion_onclick(var_usar_compensacion, var_saldo_por_pagar, var_total, var_valor_pago, var_script_case_init, do_ajax_form_recaudacion_comprobante_mob_event_usar_compensacion_onclick_cb);
  } // do_ajax_form_recaudacion_comprobante_mob_event_usar_compensacion_onclick

  function do_ajax_form_recaudacion_comprobante_mob_event_usar_compensacion_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "usar_compensacion";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_recaudacion_comprobante_mob_event_usar_compensacion_onclick_cb_after_alert);
  } // do_ajax_form_recaudacion_comprobante_mob_event_usar_compensacion_onclick_cb
  function do_ajax_form_recaudacion_comprobante_mob_event_usar_compensacion_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_recaudacion_comprobante_mob_event_usar_compensacion_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_recaudacion_comprobante_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_recaudacion_comprobante_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_recaudacion_comprobante_mob_submit_form(var_titulo, var_mensaje, var_cl_identificacion, var_cl_nombre, var_cl_direccion, var_cl_telefono, var_cl_email, var_tesoreria, var_saldo_por_pagar, var_usar_compensacion, var_forma_pago, var_valor_pago, var_documento, var_libretin, var_total, var_cl_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_recaudacion_comprobante_mob_submit_form_cb);
  } // do_ajax_form_recaudacion_comprobante_mob_submit_form

  function do_ajax_form_recaudacion_comprobante_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_recaudacion_comprobante_mob_submit_form_cb_after_alert);
  } // do_ajax_form_recaudacion_comprobante_mob_submit_form_cb
  function do_ajax_form_recaudacion_comprobante_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_recaudacion_comprobante_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["grid_fac_operacion_comp"] = "off";

  function do_ajax_form_recaudacion_comprobante_mob_navigate_form()
  {
    perform_ajax_form_recaudacion_comprobante_mob_navigate_form();
  }

  function perform_ajax_form_recaudacion_comprobante_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["grid_fac_operacion_comp"] = "on";
    x_ajax_form_recaudacion_comprobante_mob_navigate_form(var_cl_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_recaudacion_comprobante_mob_navigate_form_cb);
  } // do_ajax_form_recaudacion_comprobante_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_recaudacion_comprobante_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_recaudacion_comprobante_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_grid_fac_operacion_comp"] && "nmsc_iframe_liga_grid_fac_operacion_comp" != scMasterDetailIframe["nmsc_iframe_liga_grid_fac_operacion_comp"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_grid_fac_operacion_comp"]);
    }
    else {
        if (oResp["navSummary"].reg_tot != 0) {
            document.getElementById('nmsc_iframe_liga_grid_fac_operacion_comp').contentWindow.nm_move('apl_detalhe', true);
        }
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_recaudacion_comprobante_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_recaudacion_comprobante_mob_navigate_form_cb
  function do_ajax_form_recaudacion_comprobante_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_recaudacion_comprobante_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_recaudacion_comprobante_mob_navigate_form_cb_after_alert

  function sc_hide_form_recaudacion_comprobante_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["grid_fac_operacion_comp"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[15] = "operaciones";
  ...
  var ajax_error_list = {
    ...
    "operaciones": {"label": "operaciones", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
