...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_coc_empresa' + iSeqRow).bind('blur', function() { sc_form_sis_config_contrasenia_coc_empresa_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_sis_config_contrasenia_coc_empresa_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_coc_tiempo_validez' + iSeqRow).bind('blur', function() { sc_form_sis_config_contrasenia_coc_tiempo_validez_onblur(this, iSeqRow) })
                                                .bind('change', function() { sc_form_sis_config_contrasenia_coc_tiempo_validez_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_coc_minimo_carater' + iSeqRow).bind('blur', function() { sc_form_sis_config_contrasenia_coc_minimo_carater_onblur(this, iSeqRow) })
                                                .bind('change', function() { sc_form_sis_config_contrasenia_coc_minimo_carater_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_coc_mayusculas' + iSeqRow).bind('blur', function() { sc_form_sis_config_contrasenia_coc_mayusculas_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_sis_config_contrasenia_coc_mayusculas_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_coc_especiales' + iSeqRow).bind('blur', function() { sc_form_sis_config_contrasenia_coc_especiales_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_sis_config_contrasenia_coc_especiales_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_coc_digitos' + iSeqRow).bind('blur', function() { sc_form_sis_config_contrasenia_coc_digitos_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_sis_config_contrasenia_coc_digitos_onchange(this, iSeqRow) })
...
function sc_form_sis_config_contrasenia_coc_empresa_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_sis_config_contrasenia_coc_tiempo_validez_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_sis_config_contrasenia_coc_minimo_carater_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_sis_config_contrasenia_coc_mayusculas_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_sis_config_contrasenia_coc_especiales_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_sis_config_contrasenia_coc_digitos_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_form_sis_config_contrasenia_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_sis_config_contrasenia')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
