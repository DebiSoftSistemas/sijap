  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_config_contrasenia" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sis_config_contrasenia_form();
	}
...
?>
  ...
  // ---------- Validate coc_empresa
  function do_ajax_form_sis_config_contrasenia_validate_coc_empresa()
  {
    var nomeCampo_coc_empresa = "coc_empresa";
    var var_coc_empresa = scAjaxGetFieldSelect(nomeCampo_coc_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_config_contrasenia_validate_coc_empresa(var_coc_empresa, var_script_case_init, do_ajax_form_sis_config_contrasenia_validate_coc_empresa_cb);
  } // do_ajax_form_sis_config_contrasenia_validate_coc_empresa

  function do_ajax_form_sis_config_contrasenia_validate_coc_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "coc_empresa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_config_contrasenia_validate_coc_empresa_cb

  // ---------- Validate coc_tiempo_validez
  function do_ajax_form_sis_config_contrasenia_validate_coc_tiempo_validez()
  {
    var nomeCampo_coc_tiempo_validez = "coc_tiempo_validez";
    var var_coc_tiempo_validez = scAjaxGetFieldText(nomeCampo_coc_tiempo_validez);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_config_contrasenia_validate_coc_tiempo_validez(var_coc_tiempo_validez, var_script_case_init, do_ajax_form_sis_config_contrasenia_validate_coc_tiempo_validez_cb);
  } // do_ajax_form_sis_config_contrasenia_validate_coc_tiempo_validez

  function do_ajax_form_sis_config_contrasenia_validate_coc_tiempo_validez_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "coc_tiempo_validez";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_config_contrasenia_validate_coc_tiempo_validez_cb

  // ---------- Validate coc_minimo_carater
  function do_ajax_form_sis_config_contrasenia_validate_coc_minimo_carater()
  {
    var nomeCampo_coc_minimo_carater = "coc_minimo_carater";
    var var_coc_minimo_carater = scAjaxGetFieldText(nomeCampo_coc_minimo_carater);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_config_contrasenia_validate_coc_minimo_carater(var_coc_minimo_carater, var_script_case_init, do_ajax_form_sis_config_contrasenia_validate_coc_minimo_carater_cb);
  } // do_ajax_form_sis_config_contrasenia_validate_coc_minimo_carater

  function do_ajax_form_sis_config_contrasenia_validate_coc_minimo_carater_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "coc_minimo_carater";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_config_contrasenia_validate_coc_minimo_carater_cb

  // ---------- Validate coc_mayusculas
  function do_ajax_form_sis_config_contrasenia_validate_coc_mayusculas()
  {
    var nomeCampo_coc_mayusculas = "coc_mayusculas";
    var var_coc_mayusculas = scAjaxGetFieldSelect(nomeCampo_coc_mayusculas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_config_contrasenia_validate_coc_mayusculas(var_coc_mayusculas, var_script_case_init, do_ajax_form_sis_config_contrasenia_validate_coc_mayusculas_cb);
  } // do_ajax_form_sis_config_contrasenia_validate_coc_mayusculas

  function do_ajax_form_sis_config_contrasenia_validate_coc_mayusculas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "coc_mayusculas";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_config_contrasenia_validate_coc_mayusculas_cb

  // ---------- Validate coc_especiales
  function do_ajax_form_sis_config_contrasenia_validate_coc_especiales()
  {
    var nomeCampo_coc_especiales = "coc_especiales";
    var var_coc_especiales = scAjaxGetFieldSelect(nomeCampo_coc_especiales);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_config_contrasenia_validate_coc_especiales(var_coc_especiales, var_script_case_init, do_ajax_form_sis_config_contrasenia_validate_coc_especiales_cb);
  } // do_ajax_form_sis_config_contrasenia_validate_coc_especiales

  function do_ajax_form_sis_config_contrasenia_validate_coc_especiales_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "coc_especiales";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_config_contrasenia_validate_coc_especiales_cb

  // ---------- Validate coc_digitos
  function do_ajax_form_sis_config_contrasenia_validate_coc_digitos()
  {
    var nomeCampo_coc_digitos = "coc_digitos";
    var var_coc_digitos = scAjaxGetFieldSelect(nomeCampo_coc_digitos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_config_contrasenia_validate_coc_digitos(var_coc_digitos, var_script_case_init, do_ajax_form_sis_config_contrasenia_validate_coc_digitos_cb);
  } // do_ajax_form_sis_config_contrasenia_validate_coc_digitos

  function do_ajax_form_sis_config_contrasenia_validate_coc_digitos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "coc_digitos";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_config_contrasenia_validate_coc_digitos_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_sis_config_contrasenia_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_sis_config_contrasenia_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_coc_empresa = scAjaxGetFieldSelect("coc_empresa");
    var var_coc_tiempo_validez = scAjaxGetFieldText("coc_tiempo_validez");
    var var_coc_minimo_carater = scAjaxGetFieldText("coc_minimo_carater");
    var var_coc_mayusculas = scAjaxGetFieldSelect("coc_mayusculas");
    var var_coc_especiales = scAjaxGetFieldSelect("coc_especiales");
    var var_coc_digitos = scAjaxGetFieldSelect("coc_digitos");
    ...
    scAjaxProcOn();
    x_ajax_form_sis_config_contrasenia_submit_form(var_coc_empresa, var_coc_tiempo_validez, var_coc_minimo_carater, var_coc_mayusculas, var_coc_especiales, var_coc_digitos, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_config_contrasenia_submit_form_cb);
  } // do_ajax_form_sis_config_contrasenia_submit_form

  function do_ajax_form_sis_config_contrasenia_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("coc_empresa");
      scAjaxHideErrorDisplay("coc_tiempo_validez");
      scAjaxHideErrorDisplay("coc_minimo_carater");
      scAjaxHideErrorDisplay("coc_mayusculas");
      scAjaxHideErrorDisplay("coc_especiales");
      scAjaxHideErrorDisplay("coc_digitos");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_sis_config_contrasenia_submit_form_cb_after_alert);
  } // do_ajax_form_sis_config_contrasenia_submit_form_cb
  function do_ajax_form_sis_config_contrasenia_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_config_contrasenia_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sis_config_contrasenia_navigate_form()
  {
    perform_ajax_form_sis_config_contrasenia_navigate_form();
  }

  function perform_ajax_form_sis_config_contrasenia_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("coc_especiales");
    scAjaxHideErrorDisplay("coc_digitos");
    var var_coc_empresa = document.F2.coc_empresa.value;
    ...
    scAjaxProcOn();
    x_ajax_form_sis_config_contrasenia_navigate_form(var_coc_empresa, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_config_contrasenia_navigate_form_cb);
  } // do_ajax_form_sis_config_contrasenia_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_config_contrasenia']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_config_contrasenia_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.coc_empresa.value = scAjaxGetKeyValue("coc_empresa");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_config_contrasenia_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_config_contrasenia_navigate_form_cb
  function do_ajax_form_sis_config_contrasenia_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_sis_config_contrasenia_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_sis_config_contrasenia_navigate_form_cb_after_alert

  function sc_hide_form_sis_config_contrasenia_form()
  {
  ...
  ajax_field_list[0] = "coc_empresa";
  ajax_field_list[1] = "coc_tiempo_validez";
  ajax_field_list[2] = "coc_minimo_carater";
  ajax_field_list[3] = "coc_mayusculas";
  ajax_field_list[4] = "coc_especiales";
  ajax_field_list[5] = "coc_digitos";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "coc_empresa": {"label": "<?php echo $this->Ini->Nm_lang['lang_empresa'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "coc_tiempo_validez": {"label": "<?php echo $this->Ini->Nm_lang['lang_tiempo_validez'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "coc_minimo_carater": {"label": "<?php echo $this->Ini->Nm_lang['lang_minimo_carater'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "coc_mayusculas": {"label": "<?php echo $this->Ini->Nm_lang['lang_mayusculas'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "coc_especiales": {"label": "<?php echo $this->Ini->Nm_lang['lang_especiales'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "coc_digitos": {"label": "<?php echo $this->Ini->Nm_lang['lang_digitos'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "coc_empresa": new Array(),
    "coc_tiempo_validez": new Array(),
    "coc_minimo_carater": new Array(),
    "coc_mayusculas": new Array(),
    "coc_especiales": new Array(),
    "coc_digitos": new Array()
  };
  ajax_field_mult["coc_empresa"][1] = "coc_empresa";
  ajax_field_mult["coc_tiempo_validez"][1] = "coc_tiempo_validez";
  ajax_field_mult["coc_minimo_carater"][1] = "coc_minimo_carater";
  ajax_field_mult["coc_mayusculas"][1] = "coc_mayusculas";
  ajax_field_mult["coc_especiales"][1] = "coc_especiales";
  ajax_field_mult["coc_digitos"][1] = "coc_digitos";

  var ajax_field_id = {
    "coc_empresa": new Array("hidden_field_label_coc_empresa", "hidden_field_data_coc_empresa"),
    "coc_tiempo_validez": new Array("hidden_field_label_coc_tiempo_validez", "hidden_field_data_coc_tiempo_validez"),
    "coc_minimo_carater": new Array("hidden_field_label_coc_minimo_carater", "hidden_field_data_coc_minimo_carater"),
    "coc_mayusculas": new Array("hidden_field_label_coc_mayusculas", "hidden_field_data_coc_mayusculas"),
    "coc_especiales": new Array("hidden_field_label_coc_especiales", "hidden_field_data_coc_especiales"),
    "coc_digitos": new Array("hidden_field_label_coc_digitos", "hidden_field_data_coc_digitos")
  };

  var ajax_read_only = {
    "coc_empresa": "on",
    "coc_tiempo_validez": "off",
    "coc_minimo_carater": "off",
    "coc_mayusculas": "off",
    "coc_especiales": "off",
    "coc_digitos": "off"
  };
