  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_fac_solicitud_convenio_pago" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_fac_solicitud_convenio_pago_form();
	}
...
?>
  ...
  // ---------- Validate scp_fecha
  function do_ajax_form_fac_solicitud_convenio_pago_validate_scp_fecha()
  {
    var nomeCampo_scp_fecha = "scp_fecha";
    var var_scp_fecha = scAjaxGetFieldHidden(nomeCampo_scp_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_convenio_pago_validate_scp_fecha(var_scp_fecha, var_script_case_init, do_ajax_form_fac_solicitud_convenio_pago_validate_scp_fecha_cb);
  } // do_ajax_form_fac_solicitud_convenio_pago_validate_scp_fecha

  function do_ajax_form_fac_solicitud_convenio_pago_validate_scp_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "scp_fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_convenio_pago_validate_scp_fecha_cb

  // ---------- Validate scp_secuencial_documento
  function do_ajax_form_fac_solicitud_convenio_pago_validate_scp_secuencial_documento()
  {
    var nomeCampo_scp_secuencial_documento = "scp_secuencial_documento";
    var var_scp_secuencial_documento = scAjaxGetFieldHidden(nomeCampo_scp_secuencial_documento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_convenio_pago_validate_scp_secuencial_documento(var_scp_secuencial_documento, var_script_case_init, do_ajax_form_fac_solicitud_convenio_pago_validate_scp_secuencial_documento_cb);
  } // do_ajax_form_fac_solicitud_convenio_pago_validate_scp_secuencial_documento

  function do_ajax_form_fac_solicitud_convenio_pago_validate_scp_secuencial_documento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "scp_secuencial_documento";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_convenio_pago_validate_scp_secuencial_documento_cb

  // ---------- Validate scp_propietario
  function do_ajax_form_fac_solicitud_convenio_pago_validate_scp_propietario()
  {
    var nomeCampo_scp_propietario = "scp_propietario";
    var var_scp_propietario = scAjaxGetFieldSelect(nomeCampo_scp_propietario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_convenio_pago_validate_scp_propietario(var_scp_propietario, var_script_case_init, do_ajax_form_fac_solicitud_convenio_pago_validate_scp_propietario_cb);
  } // do_ajax_form_fac_solicitud_convenio_pago_validate_scp_propietario

  function do_ajax_form_fac_solicitud_convenio_pago_validate_scp_propietario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "scp_propietario";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_convenio_pago_validate_scp_propietario_cb

  // ---------- Validate scp_id
  function do_ajax_form_fac_solicitud_convenio_pago_validate_scp_id()
  {
    var nomeCampo_scp_id = "scp_id";
    var var_scp_id = scAjaxGetFieldHidden(nomeCampo_scp_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_convenio_pago_validate_scp_id(var_scp_id, var_script_case_init, do_ajax_form_fac_solicitud_convenio_pago_validate_scp_id_cb);
  } // do_ajax_form_fac_solicitud_convenio_pago_validate_scp_id

  function do_ajax_form_fac_solicitud_convenio_pago_validate_scp_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "scp_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_convenio_pago_validate_scp_id_cb

  // ---------- Validate scp_plazo
  function do_ajax_form_fac_solicitud_convenio_pago_validate_scp_plazo()
  {
    var nomeCampo_scp_plazo = "scp_plazo";
    var var_scp_plazo = scAjaxGetFieldText(nomeCampo_scp_plazo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_convenio_pago_validate_scp_plazo(var_scp_plazo, var_script_case_init, do_ajax_form_fac_solicitud_convenio_pago_validate_scp_plazo_cb);
  } // do_ajax_form_fac_solicitud_convenio_pago_validate_scp_plazo

  function do_ajax_form_fac_solicitud_convenio_pago_validate_scp_plazo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "scp_plazo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_convenio_pago_validate_scp_plazo_cb

  // ---------- Validate scp_monto
  function do_ajax_form_fac_solicitud_convenio_pago_validate_scp_monto()
  {
    var nomeCampo_scp_monto = "scp_monto";
    var var_scp_monto = scAjaxGetFieldHidden(nomeCampo_scp_monto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_convenio_pago_validate_scp_monto(var_scp_monto, var_script_case_init, do_ajax_form_fac_solicitud_convenio_pago_validate_scp_monto_cb);
  } // do_ajax_form_fac_solicitud_convenio_pago_validate_scp_monto

  function do_ajax_form_fac_solicitud_convenio_pago_validate_scp_monto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "scp_monto";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_convenio_pago_validate_scp_monto_cb

  // ---------- Validate scp_taza
  function do_ajax_form_fac_solicitud_convenio_pago_validate_scp_taza()
  {
    var nomeCampo_scp_taza = "scp_taza";
    var var_scp_taza = scAjaxGetFieldHidden(nomeCampo_scp_taza);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_convenio_pago_validate_scp_taza(var_scp_taza, var_script_case_init, do_ajax_form_fac_solicitud_convenio_pago_validate_scp_taza_cb);
  } // do_ajax_form_fac_solicitud_convenio_pago_validate_scp_taza

  function do_ajax_form_fac_solicitud_convenio_pago_validate_scp_taza_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "scp_taza";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_convenio_pago_validate_scp_taza_cb

  // ---------- Validate scp_tipo_amortizacion
  function do_ajax_form_fac_solicitud_convenio_pago_validate_scp_tipo_amortizacion()
  {
    var nomeCampo_scp_tipo_amortizacion = "scp_tipo_amortizacion";
    var var_scp_tipo_amortizacion = scAjaxGetFieldSelect(nomeCampo_scp_tipo_amortizacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_convenio_pago_validate_scp_tipo_amortizacion(var_scp_tipo_amortizacion, var_script_case_init, do_ajax_form_fac_solicitud_convenio_pago_validate_scp_tipo_amortizacion_cb);
  } // do_ajax_form_fac_solicitud_convenio_pago_validate_scp_tipo_amortizacion

  function do_ajax_form_fac_solicitud_convenio_pago_validate_scp_tipo_amortizacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "scp_tipo_amortizacion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_convenio_pago_validate_scp_tipo_amortizacion_cb

  // ---------- Validate scp_estado
  function do_ajax_form_fac_solicitud_convenio_pago_validate_scp_estado()
  {
    var nomeCampo_scp_estado = "scp_estado";
    var var_scp_estado = scAjaxGetFieldHidden(nomeCampo_scp_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_convenio_pago_validate_scp_estado(var_scp_estado, var_script_case_init, do_ajax_form_fac_solicitud_convenio_pago_validate_scp_estado_cb);
  } // do_ajax_form_fac_solicitud_convenio_pago_validate_scp_estado

  function do_ajax_form_fac_solicitud_convenio_pago_validate_scp_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "scp_estado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_convenio_pago_validate_scp_estado_cb

  // ---------- Validate detalles
  function do_ajax_form_fac_solicitud_convenio_pago_validate_detalles()
  {
    var nomeCampo_detalles = "detalles";
    var var_detalles = scAjaxGetFieldText(nomeCampo_detalles);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_convenio_pago_validate_detalles(var_detalles, var_script_case_init, do_ajax_form_fac_solicitud_convenio_pago_validate_detalles_cb);
  } // do_ajax_form_fac_solicitud_convenio_pago_validate_detalles

  function do_ajax_form_fac_solicitud_convenio_pago_validate_detalles_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_convenio_pago_validate_detalles_cb

  // ---------- Validate amortizacion
  function do_ajax_form_fac_solicitud_convenio_pago_validate_amortizacion()
  {
    var nomeCampo_amortizacion = "amortizacion";
    var var_amortizacion = scAjaxGetFieldText(nomeCampo_amortizacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_convenio_pago_validate_amortizacion(var_amortizacion, var_script_case_init, do_ajax_form_fac_solicitud_convenio_pago_validate_amortizacion_cb);
  } // do_ajax_form_fac_solicitud_convenio_pago_validate_amortizacion

  function do_ajax_form_fac_solicitud_convenio_pago_validate_amortizacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "amortizacion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_convenio_pago_validate_amortizacion_cb

  // ---------- Event onchange scp_contrato
  function do_ajax_form_fac_solicitud_convenio_pago_event_scp_contrato_onchange()
  {
    var var_scp_id = scAjaxGetFieldHidden("scp_id");
    var var_scp_monto = scAjaxGetFieldHidden("scp_monto");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_fac_solicitud_convenio_pago_event_scp_contrato_onchange(var_scp_id, var_scp_monto, var_script_case_init, do_ajax_form_fac_solicitud_convenio_pago_event_scp_contrato_onchange_cb);
  } // do_ajax_form_fac_solicitud_convenio_pago_event_scp_contrato_onchange

  function do_ajax_form_fac_solicitud_convenio_pago_event_scp_contrato_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "scp_contrato";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_fac_solicitud_convenio_pago_event_scp_contrato_onchange_cb_after_alert);
  } // do_ajax_form_fac_solicitud_convenio_pago_event_scp_contrato_onchange_cb
  function do_ajax_form_fac_solicitud_convenio_pago_event_scp_contrato_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_fac_solicitud_convenio_pago_event_scp_contrato_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_fac_solicitud_convenio_pago_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_fac_solicitud_convenio_pago_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_scp_fecha = scAjaxGetFieldHidden("scp_fecha");
    var var_scp_secuencial_documento = scAjaxGetFieldHidden("scp_secuencial_documento");
    var var_scp_propietario = scAjaxGetFieldSelect("scp_propietario");
    var var_scp_id = scAjaxGetFieldHidden("scp_id");
    var var_scp_plazo = scAjaxGetFieldText("scp_plazo");
    var var_scp_monto = scAjaxGetFieldHidden("scp_monto");
    var var_scp_taza = scAjaxGetFieldHidden("scp_taza");
    var var_scp_tipo_amortizacion = scAjaxGetFieldSelect("scp_tipo_amortizacion");
    var var_scp_estado = scAjaxGetFieldHidden("scp_estado");
    ...
    scAjaxProcOn();
    x_ajax_form_fac_solicitud_convenio_pago_submit_form(var_scp_fecha, var_scp_secuencial_documento, var_scp_propietario, var_scp_id, var_scp_plazo, var_scp_monto, var_scp_taza, var_scp_tipo_amortizacion, var_scp_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_fac_solicitud_convenio_pago_submit_form_cb);
  } // do_ajax_form_fac_solicitud_convenio_pago_submit_form

  function do_ajax_form_fac_solicitud_convenio_pago_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("scp_fecha");
      scAjaxHideErrorDisplay("scp_secuencial_documento");
      scAjaxHideErrorDisplay("scp_propietario");
      scAjaxHideErrorDisplay("scp_id");
      scAjaxHideErrorDisplay("scp_plazo");
      scAjaxHideErrorDisplay("scp_monto");
      scAjaxHideErrorDisplay("scp_taza");
      scAjaxHideErrorDisplay("scp_tipo_amortizacion");
      scAjaxHideErrorDisplay("scp_estado");
      scAjaxHideErrorDisplay("detalles");
      scAjaxHideErrorDisplay("amortizacion");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_fac_solicitud_convenio_pago_submit_form_cb_after_alert);
  } // do_ajax_form_fac_solicitud_convenio_pago_submit_form_cb
  function do_ajax_form_fac_solicitud_convenio_pago_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_fac_solicitud_convenio_pago_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_fac_operaciones_convenio"] = "off";
  scStatusDetail["grid_fac_cuotas_convenio"] = "off";

  function do_ajax_form_fac_solicitud_convenio_pago_navigate_form()
  {
    perform_ajax_form_fac_solicitud_convenio_pago_navigate_form();
  }

  function perform_ajax_form_fac_solicitud_convenio_pago_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("detalles");
    scAjaxHideErrorDisplay("amortizacion");
    var var_scp_id = document.F2.scp_id.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_fac_operaciones_convenio"] = "on";
    scStatusDetail["grid_fac_cuotas_convenio"] = "on";
    x_ajax_form_fac_solicitud_convenio_pago_navigate_form(var_scp_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_solicitud_convenio_pago_navigate_form_cb);
  } // do_ajax_form_fac_solicitud_convenio_pago_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_fac_solicitud_convenio_pago_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.scp_id.value = scAjaxGetKeyValue("scp_id");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_fac_operaciones_convenio"] && "nmsc_iframe_liga_form_fac_operaciones_convenio" != scMasterDetailIframe["nmsc_iframe_liga_form_fac_operaciones_convenio"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_fac_operaciones_convenio"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_fac_operaciones_convenio').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_fac_operaciones_convenio').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_fac_operaciones_convenio').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_grid_fac_cuotas_convenio"] && "nmsc_iframe_liga_grid_fac_cuotas_convenio" != scMasterDetailIframe["nmsc_iframe_liga_grid_fac_cuotas_convenio"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_grid_fac_cuotas_convenio"]);
    }
    else {
        if (oResp["navSummary"].reg_tot != 0) {
            document.getElementById('nmsc_iframe_liga_grid_fac_cuotas_convenio').contentWindow.nm_move('apl_detalhe', true);
        }
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_fac_solicitud_convenio_pago_navigate_form_cb_after_alert);
  } // do_ajax_form_fac_solicitud_convenio_pago_navigate_form_cb
  function do_ajax_form_fac_solicitud_convenio_pago_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_fac_solicitud_convenio_pago_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_fac_solicitud_convenio_pago_navigate_form_cb_after_alert

  function sc_hide_form_fac_solicitud_convenio_pago_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_fac_operaciones_convenio"] && "off" == scStatusDetail["grid_fac_cuotas_convenio"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "scp_fecha";
  ajax_field_list[1] = "scp_secuencial_documento";
  ajax_field_list[2] = "scp_propietario";
  ajax_field_list[3] = "scp_id";
  ajax_field_list[4] = "scp_plazo";
  ajax_field_list[5] = "scp_monto";
  ajax_field_list[6] = "scp_taza";
  ajax_field_list[7] = "scp_tipo_amortizacion";
  ajax_field_list[8] = "scp_estado";
  ajax_field_list[9] = "detalles";
  ajax_field_list[10] = "amortizacion";
  ...
  var ajax_error_list = {
    "scp_fecha": {"label": "<?php echo $this->Ini->Nm_lang['lang_fecha'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "scp_secuencial_documento": {"label": "<?php echo $this->Ini->Nm_lang['lang_solicitud'] ?> Nro.", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "scp_propietario": {"label": "<?php echo $this->Ini->Nm_lang['lang_propietario'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "scp_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "scp_plazo": {"label": "<?php echo $this->Ini->Nm_lang['lang_plazo'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "scp_monto": {"label": "<?php echo $this->Ini->Nm_lang['lang_saldo'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "scp_taza": {"label": "<?php echo $this->Ini->Nm_lang['lang_tasas_interes'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "scp_tipo_amortizacion": {"label": "<?php echo $this->Ini->Nm_lang['lang_tipo_amortizacion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "scp_estado": {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "detalles": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "amortizacion": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "scp_fecha": new Array(),
    "scp_secuencial_documento": new Array(),
    "scp_propietario": new Array(),
    "scp_id": new Array(),
    "scp_plazo": new Array(),
    "scp_monto": new Array(),
    "scp_taza": new Array(),
    "scp_tipo_amortizacion": new Array(),
    "scp_estado": new Array(),
    "detalles": new Array(),
    "amortizacion": new Array()
  };
  ajax_field_mult["scp_fecha"][1] = "scp_fecha";
  ajax_field_mult["scp_secuencial_documento"][1] = "scp_secuencial_documento";
  ajax_field_mult["scp_propietario"][1] = "scp_propietario";
  ajax_field_mult["scp_id"][1] = "scp_id";
  ajax_field_mult["scp_plazo"][1] = "scp_plazo";
  ajax_field_mult["scp_monto"][1] = "scp_monto";
  ajax_field_mult["scp_taza"][1] = "scp_taza";
  ajax_field_mult["scp_tipo_amortizacion"][1] = "scp_tipo_amortizacion";
  ajax_field_mult["scp_estado"][1] = "scp_estado";
  ajax_field_mult["detalles"][1] = "detalles";
  ajax_field_mult["amortizacion"][1] = "amortizacion";

  var ajax_field_id = {
    "scp_fecha": new Array("hidden_field_label_scp_fecha", "hidden_field_data_scp_fecha"),
    "scp_secuencial_documento": new Array("hidden_field_label_scp_secuencial_documento", "hidden_field_data_scp_secuencial_documento"),
    "scp_propietario": new Array("hidden_field_label_scp_propietario", "hidden_field_data_scp_propietario"),
    "scp_plazo": new Array("hidden_field_label_scp_plazo", "hidden_field_data_scp_plazo"),
    "scp_monto": new Array("hidden_field_label_scp_monto", "hidden_field_data_scp_monto"),
    "scp_taza": new Array("hidden_field_label_scp_taza", "hidden_field_data_scp_taza"),
    "scp_tipo_amortizacion": new Array("hidden_field_label_scp_tipo_amortizacion", "hidden_field_data_scp_tipo_amortizacion"),
    "scp_estado": new Array("hidden_field_label_scp_estado", "hidden_field_data_scp_estado"),
    "detalles": new Array("hidden_field_label_detalles", "hidden_field_data_detalles"),
    "amortizacion": new Array("hidden_field_label_amortizacion", "hidden_field_data_amortizacion")
  };

  var ajax_read_only = {
    "scp_fecha": "off",
    "scp_secuencial_documento": "off",
    "scp_propietario": "off",
    "scp_id": "on",
    "scp_plazo": "off",
    "scp_monto": "off",
    "scp_taza": "off",
    "scp_tipo_amortizacion": "off",
    "scp_estado": "off",
    "detalles": "off",
    "amortizacion": "off"
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("scp_secuencial_documento" == sIndex)
    {
      scAjaxSetFieldLabel(sIndex, aValue);
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("scp_tipo_amortizacion" == sIndex)
    {
      scAjaxSetFieldSelect(sIndex, aValue, null);
      updateHeaderFooter(sIndex, aValue);
