<?php
//
class form_fac_solicitud_convenio_pago_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_fac_solicitud_convenio_pago']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_fac_solicitud_convenio_pago']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_fac_solicitud_convenio_pago']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_fac_solicitud_convenio_pago']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_fac_solicitud_convenio_pago']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_fac_solicitud_convenio_pago']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_fac_solicitud_convenio_pago']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_fac_solicitud_convenio_pago']['form_fac_operaciones_convenio_script_case_init'] ]['form_fac_operaciones_convenio']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_fac_solicitud_convenio_pago']['form_fac_operaciones_convenio_script_case_init'] ]['form_fac_operaciones_convenio']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_fac_solicitud_convenio_pago']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_fac_solicitud_convenio_pago']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (!isset($this->Igtech_RucEmpresa) && isset($this->igtech_rucempresa)) 
          {
              $this->Igtech_RucEmpresa = $this->igtech_rucempresa;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_fac_solicitud_convenio_pago']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_fac_solicitud_convenio_pago']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_fac_solicitud_convenio_pago']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_fac_solicitud_convenio_pago']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_fac_solicitud_convenio_pago']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_fac_solicitud_convenio_pago']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_fac_solicitud_convenio_pago']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_fac_solicitud_convenio_pago']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_fac_solicitud_convenio_pago']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_fac_solicitud_convenio_pago_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_fac_solicitud_convenio_pago']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_fac_solicitud_convenio_pago']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_fac_solicitud_convenio_pago'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_fac_solicitud_convenio_pago']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_fac_solicitud_convenio_pago']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_fac_solicitud_convenio_pago') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_fac_solicitud_convenio_pago']['label'] = "" . $this->Ini->Nm_lang['lang_solicitud_convenio'] . "";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_fac_solicitud_convenio_pago")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_fac_solicitud_convenio_pago']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_fac_solicitud_convenio_pago'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_fac_solicitud_convenio_pago']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_fac_solicitud_convenio_pago']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_fac_solicitud_convenio_pago']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_fac_solicitud_convenio_pago']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_fac_solicitud_convenio_pago']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_fac_solicitud_convenio_pago']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['where_orig'] = " where (scp_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "')";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['where_pesq'] = " where (scp_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "')";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_fac_solicitud_convenio_pago']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_fac_solicitud_convenio_pago']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_fac_solicitud_convenio_pago']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_fac_solicitud_convenio_pago']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_fac_solicitud_convenio_pago'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_fac_solicitud_convenio_pago'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_fac_solicitud_convenio_pago']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_fac_solicitud_convenio_pago']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_fac_solicitud_convenio_pago']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_fac_solicitud_convenio_pago']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_fac_solicitud_convenio_pago']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_fac_solicitud_convenio_pago']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_fac_solicitud_convenio_pago']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_fac_solicitud_convenio_pago']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_fac_solicitud_convenio_pago']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['dados_form'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_fac_solicitud_convenio_pago_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_fac_solicitud_convenio_pago_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_fac_solicitud_convenio_pago/form_fac_solicitud_convenio_pago_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_fac_solicitud_convenio_pago_erro.class.php"); 
      }
      $this->Erro      = new form_fac_solicitud_convenio_pago_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['opcao']))
         { 
             if ($this->scp_id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_fac_solicitud_convenio_pago']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_fac_solicitud_convenio_pago']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_fac_solicitud_convenio_pago']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['opc_ant'] : "";
      } 
      ...
      {
          $this->nmgp_botoes['agregar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['botoes']['agregar'];
          $this->nmgp_botoes['procesar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['botoes']['procesar'];
          $this->nmgp_botoes['simular'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['botoes']['simular'];
          $this->nmgp_botoes['Imprimir'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['botoes']['Imprimir'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['form_fac_operaciones_convenio_script_case_init'] ]['form_fac_operaciones_convenio']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['form_fac_operaciones_convenio_script_case_init'] ]['form_fac_operaciones_convenio']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['form_fac_operaciones_convenio_script_case_init'] ]['form_fac_operaciones_convenio']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['form_fac_operaciones_convenio_script_case_init'] ]['form_fac_operaciones_convenio']['total']);
          $detailAppObject = "form_fac_operaciones_convenio_apl";
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_fac_operaciones_convenio') . "/index.php");
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_fac_operaciones_convenio') . "/form_fac_operaciones_convenio_apl.php");
          $this->form_fac_operaciones_convenio = new $detailAppObject;
      }
      ...
      $this->sc_insert_on = false;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_fac_solicitud_convenio_pago']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_fac_solicitud_convenio_pago']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['dados_select'];
     }
   }
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['Gera_log_access'] = false;
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_fac_solicitud_convenio_pago.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_fac_solicitud_convenio_pago_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_fac_solicitud_convenio_pago"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_fac_solicitud_convenio_pago', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sis_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'form_fac_solicitud_convenio_pago', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_fac_solicitud_convenio_pago', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['opc_ant'] == "incluir")
      {
      ...
      {
          if (!isset($this->scp_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['dados_form']['scp_id']))
          {
              $varloc_btn_php['scp_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['dados_form']['scp_id'];
          }
          if (!isset($this->scp_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['dados_form']['scp_id']))
          {
              $varloc_btn_php['scp_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['dados_form']['scp_id'];
          }
          if (!isset($this->rs_operacion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['dados_form']['rs_operacion']))
          {
              $varloc_btn_php['rs_operacion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['dados_form']['rs_operacion'];
          }
          if (!isset($this->rs_operacion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['dados_form']['rs_operacion']))
          {
              $varloc_btn_php['rs_operacion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['dados_form']['rs_operacion'];
      ...
      $_SESSION['scriptcase']['form_fac_solicitud_convenio_pago']['contr_erro'] = 'on';
...
<?php
      ...
      else
      {
          ...
          if (!isset($this->deudas) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['dados_form']['deudas']))
          {
              $varloc_btn_php['deudas'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['dados_form']['deudas'];
          }
          if (!isset($this->scp_tipo_amortizacion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['dados_form']['scp_tipo_amortizacion']))
          {
              $varloc_btn_php['scp_tipo_amortizacion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['dados_form']['scp_tipo_amortizacion'];
          }
          if (!isset($this->scp_taza) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['dados_form']['scp_taza']))
          {
              $varloc_btn_php['scp_taza'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['dados_form']['scp_taza'];
          }
          if (!isset($this->scp_plazo) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['dados_form']['scp_plazo']))
          {
              $varloc_btn_php['scp_plazo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['dados_form']['scp_plazo'];
          }
          if (!isset($this->scp_fecha) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['dados_form']['scp_fecha']))
          {
              $varloc_btn_php['scp_fecha'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['dados_form']['scp_fecha'];
          }
          if (!isset($this->scp_tipo_amortizacion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['dados_form']['scp_tipo_amortizacion']))
          {
              $varloc_btn_php['scp_tipo_amortizacion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['dados_form']['scp_tipo_amortizacion'];
...
if (false == $this->deudas ) {
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_fac_solicitud_convenio_pago';
...
<?php
      ...
      else
      {
          ...
          if (!isset($this->scp_monto) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['dados_form']['scp_monto']))
          {
              $varloc_btn_php['scp_monto'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['dados_form']['scp_monto'];
          }
      }
      $nm_f_saida = "./";
      nm_limpa_data($this->scp_fecha, $this->field_config['scp_fecha']['date_sep']) ; 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_fac_solicitud_convenio_pago']) || !is_array($this->NM_ajax_info['errList']['geral_form_fac_solicitud_convenio_pago']))
              {
                  $this->NM_ajax_info['errList']['geral_form_fac_solicitud_convenio_pago'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_fac_solicitud_convenio_pago'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
    ...
    function ValidateField_scp_secuencial_documento(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->scp_secuencial_documento, 4, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
   ...
   if (isset($this->Field_no_validate['scp_propietario'])) {
      ...
      if ($this->scp_propietario == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['php_cmp_required']['scp_propietario']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['php_cmp_required']['scp_propietario'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->scp_propietario) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['Lookup_scp_propietario']) && !in_array($this->scp_propietario, $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['Lookup_scp_propietario']))
          {
              $hasError = true;
    ...
    function ValidateField_scp_plazo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->scp_plazo, 4, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['php_cmp_required']['scp_plazo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['php_cmp_required']['scp_plazo'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_scp_monto(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->scp_monto, 15, 2, 0, 0, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_scp_taza(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->scp_taza, 5, 2, 0, 0, "N") == false)  
              { 
                  $hasError = true;
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['php_cmp_required']['scp_taza']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['php_cmp_required']['scp_taza'] == "on") 
           { 
              $hasError = true;
   ...
   if (isset($this->Field_no_validate['scp_tipo_amortizacion'])) {
      ...
      if ($this->scp_tipo_amortizacion == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['php_cmp_required']['scp_tipo_amortizacion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['php_cmp_required']['scp_tipo_amortizacion'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->scp_tipo_amortizacion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['Lookup_scp_tipo_amortizacion']) && !in_array($this->scp_tipo_amortizacion, $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['Lookup_scp_tipo_amortizacion']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['scp_tipo_amortizacion']))
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['scp_id']['keyVal'] = form_fac_solicitud_convenio_pago_pack_protect_string($this->nmgp_dados_form['scp_id']);
              ...
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['grid_fac_cuotas_convenio_script_case_init'] ]['grid_fac_cuotas_convenio']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['grid_fac_cuotas_convenio_script_case_init'] ]['grid_fac_cuotas_convenio']['total']);
              ...
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['total'] < 0)
              {
...
$aLookup[] = array(form_fac_solicitud_convenio_pago_pack_protect_string('') => str_replace('<', '&lt;',form_fac_solicitud_convenio_pago_pack_protect_string('' . $this->Ini->Nm_lang['lang_seleccione'] . '')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['Lookup_scp_propietario'][] = '';
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_fac_solicitud_convenio_pago_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_fac_solicitud_convenio_pago_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['scp_propietario']['valList'][$i] = form_fac_solicitud_convenio_pago_pack_protect_string($v);
          }
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['scp_tipo_amortizacion']['valList'][$i] = form_fac_solicitud_convenio_pago_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_scp_estado($bForce = false)
   {
          ...
          $this->NM_ajax_info['fldList']['scp_estado'] = array(
              ...
              $this->NM_ajax_info['fldList']['scp_estado']['lookupCons'] = form_fac_solicitud_convenio_pago_pack_protect_string(NM_charset_to_utf8($conteudo));
          }
   }
   ...
   function ajax_return_values_amortizacion($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['Field_no_validate'] = array();
...
$_SESSION['scriptcase']['form_fac_solicitud_convenio_pago']['contr_erro'] = 'off'; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['total']);
              }
              ...
              $this->NM_gera_log_new();
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          if ($bDelecaoOk)
          {
              ...
              $this->form_fac_operaciones_convenio->ini_controle();
              if ($this->form_fac_operaciones_convenio->temRegistros($sDetailWhere))
              {
                  $bDelecaoOk = false;
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['reg_start'] = 0; 
              }
...
$_SESSION['scriptcase']['form_fac_solicitud_convenio_pago']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['parms'] = "scp_id?#?$this->scp_id?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['run_iframe'] == "R")
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['iframe_evento']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      ...
      { 
          ...
          $qt_geral_reg_form_fac_solicitud_convenio_pago = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['total'] = $qt_geral_reg_form_fac_solicitud_convenio_pago;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->scp_id))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_fac_solicitud_convenio_pago = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['reg_start'] > $qt_geral_reg_form_fac_solicitud_convenio_pago)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['reg_start'] = $qt_geral_reg_form_fac_solicitud_convenio_pago; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_fac_solicitud_convenio_pago) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (!empty($sc_where))
              {
                  if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['reg_start']) ;  
              } 
          } 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['reg_start'] < $qt_geral_reg_form_fac_solicitud_convenio_pago;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['opcao']   = '';
          }
      } 
...
//-- 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_operaciones_convenio']['embutida_parms'] = "NM_btn_insert*scinN*scoutNM_btn_update*scinN*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['dados_select'];
...
// 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['reg_start'] + 1;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_fac_solicitud_convenio_pago_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['where_filter_form'] . " and ((scp_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "')) and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_fac_solicitud_convenio_pago = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['total'] = $qt_geral_reg_form_fac_solicitud_convenio_pago;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_fac_solicitud_convenio_pago_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_fac_solicitud_convenio_pago_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_fac_solicitud_convenio_pago_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['masterValue']))
{
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['retorno_edit'] = "";
   }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function displayAppHeader()
    {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago']['ordem_ord'] == " desc") {
