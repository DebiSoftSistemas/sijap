...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_fac_solicitud_convenio_pago/form_fac_solicitud_convenio_pago_mob_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_fac_solicitud_convenio_pago_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['recarga'];
}
if ('' != $this->scp_estado)
{
    $this->lookup_scp_estado($look_rpc_scp_estado);
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['link_info']['remove_border']) {
...
if (isset($_SESSION['scriptcase']['form_fac_solicitud_convenio_pago']['error_buffer']) && '' != $_SESSION['scriptcase']['form_fac_solicitud_convenio_pago']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_fac_solicitud_convenio_pago']['error_buffer'];
}
...
<?php
 include_once("form_fac_solicitud_convenio_pago_mob_js0.php");
?>
<script type="text/javascript" src="<?php  echo $this->Ini->path_js . "/jsrsClient.js" ?>"> 
</script> 
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_fac_solicitud_convenio_pago_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_fac_solicitud_convenio_pago_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_fac_solicitud_convenio_pago_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['run_iframe'] != "R")
{
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['fast_search'][2] : "";
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label'][''];
        }
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['agregar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['agregar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['agregar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['agregar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['agregar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['simular']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['simular']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['simular']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['simular']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['simular'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['procesar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['procesar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['procesar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['procesar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['procesar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['imprimir']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['imprimir']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['imprimir']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['imprimir']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['imprimir'];
        }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_scp_fecha_line" id="hidden_field_data_scp_fecha" style="<?php echo $sStyleHidden_scp_fecha; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_scp_fecha_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_scp_fecha_label" style=""><span id="id_label_scp_fecha"><?php echo $this->nm_new_label['scp_fecha']; ?></span></span><br><input type="hidden" name="scp_fecha" value="<?php echo $this->form_encode_input($scp_fecha); ?>"><span id="id_ajax_label_scp_fecha"><?php echo nl2br($scp_fecha); ?></span>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_scp_secuencial_documento_line" id="hidden_field_data_scp_secuencial_documento" style="<?php echo $sStyleHidden_scp_secuencial_documento; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_scp_secuencial_documento_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_scp_secuencial_documento_label" style=""><span id="id_label_scp_secuencial_documento"><?php echo $this->nm_new_label['scp_secuencial_documento']; ?></span></span><br><input type="hidden" name="scp_secuencial_documento" value="<?php echo $this->form_encode_input($scp_secuencial_documento); ?>"><span id="id_ajax_label_scp_secuencial_documento"><?php echo nl2br($scp_secuencial_documento); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_scp_propietario_line" id="hidden_field_data_scp_propietario" style="<?php echo $sStyleHidden_scp_propietario; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_scp_propietario_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_scp_propietario_label" style=""><span id="id_label_scp_propietario"><?php echo $this->nm_new_label['scp_propietario']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['php_cmp_required']['scp_propietario']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['php_cmp_required']['scp_propietario'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormDataOdd css_scp_id_line" id="hidden_field_data_scp_id" style="<?php echo $sStyleHidden_scp_id; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_scp_id_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_scp_id_label" style=""><span id="id_label_scp_id"><?php echo $this->nm_new_label['scp_id']; ?></span></span><br><span id="id_read_on_scp_id" class="css_scp_id_line" style="<?php echo $sStyleReadLab_scp_id; ?>"><?php echo $this->form_format_readonly("scp_id", $this->form_encode_input($this->scp_id)); ?></span><span id="id_read_off_scp_id" class="css_read_off_scp_id" style="<?php echo $sStyleReadInp_scp_id; ?>"><input type="hidden" name="scp_id" value="<?php echo $this->form_encode_input($scp_id) . "\">"?><span id="id_ajax_label_scp_id"><?php echo nl2br($scp_id); ?></span>
</span></span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_scp_id_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_scp_id_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }
      else
      {
         $sc_hidden_no--;
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_scp_plazo_line" id="hidden_field_data_scp_plazo" style="<?php echo $sStyleHidden_scp_plazo; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_scp_plazo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_scp_plazo_label" style=""><span id="id_label_scp_plazo"><?php echo $this->nm_new_label['scp_plazo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['php_cmp_required']['scp_plazo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['php_cmp_required']['scp_plazo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_scp_monto_line" id="hidden_field_data_scp_monto" style="<?php echo $sStyleHidden_scp_monto; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_scp_monto_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_scp_monto_label" style=""><span id="id_label_scp_monto"><?php echo $this->nm_new_label['scp_monto']; ?></span></span><br><input type="hidden" name="scp_monto" value="<?php echo $this->form_encode_input($scp_monto); ?>"><span id="id_ajax_label_scp_monto"><?php echo nl2br($scp_monto); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_scp_taza_line" id="hidden_field_data_scp_taza" style="<?php echo $sStyleHidden_scp_taza; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_scp_taza_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_scp_taza_label" style=""><span id="id_label_scp_taza"><?php echo $this->nm_new_label['scp_taza']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['php_cmp_required']['scp_taza']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['php_cmp_required']['scp_taza'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br><input type="hidden" name="scp_taza" value="<?php echo $this->form_encode_input($scp_taza); ?>"><span id="id_ajax_label_scp_taza"><?php echo nl2br($scp_taza); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_scp_tipo_amortizacion_line" id="hidden_field_data_scp_tipo_amortizacion" style="<?php echo $sStyleHidden_scp_tipo_amortizacion; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_scp_tipo_amortizacion_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_scp_tipo_amortizacion_label" style=""><span id="id_label_scp_tipo_amortizacion"><?php echo $this->nm_new_label['scp_tipo_amortizacion']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['php_cmp_required']['scp_tipo_amortizacion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['php_cmp_required']['scp_tipo_amortizacion'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_scp_estado_line" id="hidden_field_data_scp_estado" style="<?php echo $sStyleHidden_scp_estado; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_scp_estado_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_scp_estado_label" style=""><span id="id_label_scp_estado"><?php echo $this->nm_new_label['scp_estado']; ?></span></span><br><input type="hidden" name="scp_estado" value="<?php echo $this->form_encode_input($scp_estado); ?>"><span id="id_ajax_label_scp_estado"><?php echo nl2br($scp_estado); ?></span>
...
<?php $sStyleHidden_scp_estado_dumb = ('' == $sStyleHidden_scp_estado) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_scp_estado_dumb" style="<?php echo $sStyleHidden_scp_estado_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalles'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalles'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['form_fac_operaciones_convenio_mob_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalles'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['form_fac_operaciones_convenio_mob_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['form_fac_operaciones_convenio_mob_script_case_init'] ]['form_fac_operaciones_convenio_mob']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['form_fac_operaciones_convenio_mob_script_case_init'] ]['form_fac_operaciones_convenio_mob']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['form_fac_operaciones_convenio_mob_script_case_init'] ]['form_fac_operaciones_convenio_mob']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['form_fac_operaciones_convenio_mob_script_case_init'] ]['form_fac_operaciones_convenio_mob']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['form_fac_operaciones_convenio_mob_script_case_init'] ]['form_fac_operaciones_convenio_mob']['embutida_liga_form_insert'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['form_fac_operaciones_convenio_mob_script_case_init'] ]['form_fac_operaciones_convenio_mob']['embutida_liga_form_update'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['form_fac_operaciones_convenio_mob_script_case_init'] ]['form_fac_operaciones_convenio_mob']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['form_fac_operaciones_convenio_mob_script_case_init'] ]['form_fac_operaciones_convenio_mob']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['form_fac_operaciones_convenio_mob_script_case_init'] ]['form_fac_operaciones_convenio_mob']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['form_fac_operaciones_convenio_mob_script_case_init'] ]['form_fac_operaciones_convenio_mob']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['form_fac_operaciones_convenio_mob_script_case_init'] ]['form_fac_operaciones_convenio_mob']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['form_fac_operaciones_convenio_mob_script_case_init'] ]['form_fac_operaciones_convenio_mob']['embutida_liga_tp_pag'] = 'parcial';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['form_fac_operaciones_convenio_mob_script_case_init'] ]['form_fac_operaciones_convenio_mob']['embutida_parms'] = "NM_btn_insert*scinN*scoutNM_btn_update*scinN*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['form_fac_operaciones_convenio_mob_script_case_init'] ]['form_fac_solicitud_convenio_pago_mob']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_fac_solicitud_convenio_pago_mob_empty.htm' : $this->Ini->link_form_fac_operaciones_convenio_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y';
...
if (isset($this->Ini->sc_lig_target['C_@scinf_detalles']) && 'nmsc_iframe_liga_form_fac_operaciones_convenio_mob' != $this->Ini->sc_lig_target['C_@scinf_detalles'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_detalles'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['form_fac_operaciones_convenio_mob_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_fac_operaciones_convenio_mob"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_form_fac_operaciones_convenio_mob"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Amortizacion'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Amortizacion'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['grid_fac_cuotas_convenio_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Amortizacion'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['grid_fac_cuotas_convenio_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 if (isset($this->Ini->sc_lig_md5["grid_fac_cuotas_convenio"]) && $this->Ini->sc_lig_md5["grid_fac_cuotas_convenio"] == "S") {
     ...
     $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_fac_solicitud_convenio_pago_mob@SC_par@" . md5($Parms_Lig);
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
 } else {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_fac_solicitud_convenio_pago_mob_empty.htm' : $this->Ini->link_grid_fac_cuotas_convenio_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y' . $parms_lig_cons;
...
if (isset($this->Ini->sc_lig_target['C_@scinf_Amortizacion']) && 'nmsc_iframe_liga_grid_fac_cuotas_convenio' != $this->Ini->sc_lig_target['C_@scinf_Amortizacion'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_Amortizacion'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['grid_fac_cuotas_convenio_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['btn_label']['last'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['total'] + 1)?>);</script><?php }} ?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_fac_solicitud_convenio_pago_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_fac_solicitud_convenio_pago_mob");
 parent.scAjaxDetailHeight("form_fac_solicitud_convenio_pago_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
