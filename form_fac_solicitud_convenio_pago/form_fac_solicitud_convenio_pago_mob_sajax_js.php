  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_fac_solicitud_convenio_pago_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_fac_solicitud_convenio_pago_mob_form();
	}
...
?>
  ...
  // ---------- Validate scp_fecha
  function do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_fecha()
  {
    var nomeCampo_scp_fecha = "scp_fecha";
    var var_scp_fecha = scAjaxGetFieldHidden(nomeCampo_scp_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_fecha(var_scp_fecha, var_script_case_init, do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_fecha_cb);
  } // do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_fecha

  function do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_fecha_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_fecha_cb

  // ---------- Validate scp_secuencial_documento
  function do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_secuencial_documento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_secuencial_documento(var_scp_secuencial_documento, var_script_case_init, do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_secuencial_documento_cb);
  } // do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_secuencial_documento

  function do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_secuencial_documento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_secuencial_documento_cb

  // ---------- Validate scp_propietario
  function do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_propietario()
  {
    var nomeCampo_scp_propietario = "scp_propietario";
    var var_scp_propietario = scAjaxGetFieldSelect(nomeCampo_scp_propietario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_propietario(var_scp_propietario, var_script_case_init, do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_propietario_cb);
  } // do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_propietario

  function do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_propietario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_propietario_cb

  // ---------- Validate scp_id
  function do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_id()
  {
    var nomeCampo_scp_id = "scp_id";
    var var_scp_id = scAjaxGetFieldHidden(nomeCampo_scp_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_id(var_scp_id, var_script_case_init, do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_id_cb);
  } // do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_id

  function do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "scp_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_id_cb

  // ---------- Validate scp_plazo
  function do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_plazo()
  {
    var nomeCampo_scp_plazo = "scp_plazo";
    var var_scp_plazo = scAjaxGetFieldText(nomeCampo_scp_plazo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_plazo(var_scp_plazo, var_script_case_init, do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_plazo_cb);
  } // do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_plazo

  function do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_plazo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_plazo_cb

  // ---------- Validate scp_monto
  function do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_monto()
  {
    var nomeCampo_scp_monto = "scp_monto";
    var var_scp_monto = scAjaxGetFieldHidden(nomeCampo_scp_monto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_monto(var_scp_monto, var_script_case_init, do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_monto_cb);
  } // do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_monto

  function do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_monto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_monto_cb

  // ---------- Validate scp_taza
  function do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_taza()
  {
    var nomeCampo_scp_taza = "scp_taza";
    var var_scp_taza = scAjaxGetFieldHidden(nomeCampo_scp_taza);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_taza(var_scp_taza, var_script_case_init, do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_taza_cb);
  } // do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_taza

  function do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_taza_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_taza_cb

  // ---------- Validate scp_tipo_amortizacion
  function do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_tipo_amortizacion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_tipo_amortizacion(var_scp_tipo_amortizacion, var_script_case_init, do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_tipo_amortizacion_cb);
  } // do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_tipo_amortizacion

  function do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_tipo_amortizacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_tipo_amortizacion_cb

  // ---------- Validate scp_estado
  function do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_estado()
  {
    var nomeCampo_scp_estado = "scp_estado";
    var var_scp_estado = scAjaxGetFieldHidden(nomeCampo_scp_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_estado(var_scp_estado, var_script_case_init, do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_estado_cb);
  } // do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_estado

  function do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_convenio_pago_mob_validate_scp_estado_cb

  // ---------- Validate detalles
  function do_ajax_form_fac_solicitud_convenio_pago_mob_validate_detalles()
  {
    var nomeCampo_detalles = "detalles";
    var var_detalles = scAjaxGetFieldText(nomeCampo_detalles);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_convenio_pago_mob_validate_detalles(var_detalles, var_script_case_init, do_ajax_form_fac_solicitud_convenio_pago_mob_validate_detalles_cb);
  } // do_ajax_form_fac_solicitud_convenio_pago_mob_validate_detalles

  function do_ajax_form_fac_solicitud_convenio_pago_mob_validate_detalles_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_convenio_pago_mob_validate_detalles_cb

  // ---------- Validate amortizacion
  function do_ajax_form_fac_solicitud_convenio_pago_mob_validate_amortizacion()
  {
    var nomeCampo_amortizacion = "amortizacion";
    var var_amortizacion = scAjaxGetFieldText(nomeCampo_amortizacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_convenio_pago_mob_validate_amortizacion(var_amortizacion, var_script_case_init, do_ajax_form_fac_solicitud_convenio_pago_mob_validate_amortizacion_cb);
  } // do_ajax_form_fac_solicitud_convenio_pago_mob_validate_amortizacion

  function do_ajax_form_fac_solicitud_convenio_pago_mob_validate_amortizacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_convenio_pago_mob_validate_amortizacion_cb

  // ---------- Event onchange scp_contrato
  function do_ajax_form_fac_solicitud_convenio_pago_mob_event_scp_contrato_onchange()
  {
    var var_scp_id = scAjaxGetFieldHidden("scp_id");
    var var_scp_monto = scAjaxGetFieldHidden("scp_monto");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_fac_solicitud_convenio_pago_mob_event_scp_contrato_onchange(var_scp_id, var_scp_monto, var_script_case_init, do_ajax_form_fac_solicitud_convenio_pago_mob_event_scp_contrato_onchange_cb);
  } // do_ajax_form_fac_solicitud_convenio_pago_mob_event_scp_contrato_onchange

  function do_ajax_form_fac_solicitud_convenio_pago_mob_event_scp_contrato_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_fac_solicitud_convenio_pago_mob_event_scp_contrato_onchange_cb_after_alert);
  } // do_ajax_form_fac_solicitud_convenio_pago_mob_event_scp_contrato_onchange_cb
  function do_ajax_form_fac_solicitud_convenio_pago_mob_event_scp_contrato_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_fac_solicitud_convenio_pago_mob_event_scp_contrato_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_fac_solicitud_convenio_pago_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_fac_solicitud_convenio_pago_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_fac_solicitud_convenio_pago_mob_submit_form(var_scp_fecha, var_scp_secuencial_documento, var_scp_propietario, var_scp_id, var_scp_plazo, var_scp_monto, var_scp_taza, var_scp_tipo_amortizacion, var_scp_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_fac_solicitud_convenio_pago_mob_submit_form_cb);
  } // do_ajax_form_fac_solicitud_convenio_pago_mob_submit_form

  function do_ajax_form_fac_solicitud_convenio_pago_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_fac_solicitud_convenio_pago_mob_submit_form_cb_after_alert);
  } // do_ajax_form_fac_solicitud_convenio_pago_mob_submit_form_cb
  function do_ajax_form_fac_solicitud_convenio_pago_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_fac_solicitud_convenio_pago_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_fac_operaciones_convenio_mob"] = "off";
  scStatusDetail["grid_fac_cuotas_convenio"] = "off";

  function do_ajax_form_fac_solicitud_convenio_pago_mob_navigate_form()
  {
    perform_ajax_form_fac_solicitud_convenio_pago_mob_navigate_form();
  }

  function perform_ajax_form_fac_solicitud_convenio_pago_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_fac_operaciones_convenio_mob"] = "on";
    scStatusDetail["grid_fac_cuotas_convenio"] = "on";
    x_ajax_form_fac_solicitud_convenio_pago_mob_navigate_form(var_scp_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_solicitud_convenio_pago_mob_navigate_form_cb);
  } // do_ajax_form_fac_solicitud_convenio_pago_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_convenio_pago_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_fac_solicitud_convenio_pago_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_fac_operaciones_convenio_mob"] && "nmsc_iframe_liga_form_fac_operaciones_convenio_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_fac_operaciones_convenio_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_fac_operaciones_convenio_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_fac_operaciones_convenio_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_fac_operaciones_convenio_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_fac_operaciones_convenio_mob').style.display = "none";
    }
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_fac_solicitud_convenio_pago_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_fac_solicitud_convenio_pago_mob_navigate_form_cb
  function do_ajax_form_fac_solicitud_convenio_pago_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_fac_solicitud_convenio_pago_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_fac_solicitud_convenio_pago_mob_navigate_form_cb_after_alert

  function sc_hide_form_fac_solicitud_convenio_pago_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_fac_operaciones_convenio_mob"] && "off" == scStatusDetail["grid_fac_cuotas_convenio"])
    {
      return true;
    }
    return false;
