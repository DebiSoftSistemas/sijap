...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_scp_id' + iSeqRow).bind('blur', function() { sc_form_fac_solicitud_convenio_pago_scp_id_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_fac_solicitud_convenio_pago_scp_id_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_scp_fecha' + iSeqRow).bind('blur', function() { sc_form_fac_solicitud_convenio_pago_scp_fecha_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_fac_solicitud_convenio_pago_scp_fecha_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_fac_solicitud_convenio_pago_scp_fecha_onfocus(this, iSeqRow) });
  $('#id_sc_field_scp_empresa' + iSeqRow).bind('change', function() { sc_form_fac_solicitud_convenio_pago_scp_empresa_onchange(this, iSeqRow) });
  $('#id_sc_field_scp_propietario' + iSeqRow).bind('blur', function() { sc_form_fac_solicitud_convenio_pago_scp_propietario_onblur(this, iSeqRow) })
                                             .bind('change', function() { sc_form_fac_solicitud_convenio_pago_scp_propietario_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_scp_monto' + iSeqRow).bind('blur', function() { sc_form_fac_solicitud_convenio_pago_scp_monto_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_fac_solicitud_convenio_pago_scp_monto_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_scp_plazo' + iSeqRow).bind('blur', function() { sc_form_fac_solicitud_convenio_pago_scp_plazo_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_fac_solicitud_convenio_pago_scp_plazo_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_scp_taza' + iSeqRow).bind('blur', function() { sc_form_fac_solicitud_convenio_pago_scp_taza_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_fac_solicitud_convenio_pago_scp_taza_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_scp_tipo_amortizacion' + iSeqRow).bind('blur', function() { sc_form_fac_solicitud_convenio_pago_scp_tipo_amortizacion_onblur(this, iSeqRow) })
                                                   .bind('change', function() { sc_form_fac_solicitud_convenio_pago_scp_tipo_amortizacion_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_scp_secuencial_documento' + iSeqRow).bind('blur', function() { sc_form_fac_solicitud_convenio_pago_scp_secuencial_documento_onblur(this, iSeqRow) })
                                                      .bind('change', function() { sc_form_fac_solicitud_convenio_pago_scp_secuencial_documento_onchange(this, iSeqRow) })
                                                      .bind('focus', function() { sc_form_fac_solicitud_convenio_pago_scp_secuencial_documento_onfocus(this, iSeqRow) });
  $('#id_sc_field_scp_usuario' + iSeqRow).bind('change', function() { sc_form_fac_solicitud_convenio_pago_scp_usuario_onchange(this, iSeqRow) });
  $('#id_sc_field_scp_ip' + iSeqRow).bind('change', function() { sc_form_fac_solicitud_convenio_pago_scp_ip_onchange(this, iSeqRow) });
  ...
  $('#id_sc_field_amortizacion' + iSeqRow).bind('blur', function() { sc_form_fac_solicitud_convenio_pago_amortizacion_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_fac_solicitud_convenio_pago_amortizacion_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_detalles' + iSeqRow).bind('blur', function() { sc_form_fac_solicitud_convenio_pago_detalles_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_fac_solicitud_convenio_pago_detalles_onchange(this, iSeqRow) })
...
function sc_form_fac_solicitud_convenio_pago_scp_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_fac_solicitud_convenio_pago_scp_fecha_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_fac_solicitud_convenio_pago_scp_empresa_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_fac_solicitud_convenio_pago_scp_propietario_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_fac_solicitud_convenio_pago_scp_monto_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_fac_solicitud_convenio_pago_scp_plazo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_fac_solicitud_convenio_pago_scp_taza_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_fac_solicitud_convenio_pago_scp_tipo_amortizacion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_fac_solicitud_convenio_pago_scp_secuencial_documento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_fac_solicitud_convenio_pago_scp_usuario_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_fac_solicitud_convenio_pago_scp_ip_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_fac_solicitud_convenio_pago_amortizacion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_fac_solicitud_convenio_pago_detalles_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function displayChange_field_detalles(row, status) {
    var fieldId;
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_fac_operaciones_convenio")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_fac_operaciones_convenio")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_fac_solicitud_convenio_pago_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_fac_solicitud_convenio_pago')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
