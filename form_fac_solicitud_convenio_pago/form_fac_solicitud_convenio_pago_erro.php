...
$old_error_handler = set_error_handler("form_fac_solicitud_convenio_pago_scriptcase_error_handler");

function form_fac_solicitud_convenio_pago_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['form_fac_solicitud_convenio_pago']['contr_erro']) && $_SESSION['scriptcase']['form_fac_solicitud_convenio_pago']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_fac_solicitud_convenio_pago->contr_form_fac_solicitud_convenio_pago->Apl_com_erro = true;
            if ($inicial_form_fac_solicitud_convenio_pago->contr_form_fac_solicitud_convenio_pago->NM_ajax_flag)
            {
                $inicial_form_fac_solicitud_convenio_pago->contr_form_fac_solicitud_convenio_pago->NM_ajax_info['errList']['geral_form_fac_solicitud_convenio_pago'][] = $msg;
                return;
            }
            form_fac_solicitud_convenio_pago_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_fac_solicitud_convenio_pago_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_fac_solicitud_convenio_pago'])  && '' != $_SESSION['scriptcase']['error_icon']['form_fac_solicitud_convenio_pago'])  ? $_SESSION['scriptcase']['error_icon']['form_fac_solicitud_convenio_pago']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['form_fac_solicitud_convenio_pago']) && '' != $_SESSION['scriptcase']['error_close']['form_fac_solicitud_convenio_pago']) ? $_SESSION['scriptcase']['error_close']['form_fac_solicitud_convenio_pago'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_fac_solicitud_convenio_pago']) && '' != $_SESSION['scriptcase']['error_span_title']['form_fac_solicitud_convenio_pago']) ? $_SESSION['scriptcase']['error_span_title']['form_fac_solicitud_convenio_pago'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_fac_solicitud_convenio_pago']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_fac_solicitud_convenio_pago']) ? $_SESSION['scriptcase']['error_icon_title']['form_fac_solicitud_convenio_pago'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_fac_solicitud_convenio_pago']['error_buffer'] .= ob_get_flush();
}
