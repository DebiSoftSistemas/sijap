<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_fac_solicitud_convenio_pago']['glo_nm_path_imag_temp'] . "/sc_apl_default_SIJAP.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_fac_solicitud_convenio_pago_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_fac_solicitud_convenio_pago_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_convenio_pago']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_convenio_pago']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['scp_secuencial_documento'] = "on";
   $tab_def_campos['scp_secuencial_documento'] = "scp_secuencial_documento";
   $tab_labels["scp_secuencial_documento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_convenio_pago']['labels']["scp_secuencial_documento"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_convenio_pago']['labels']["scp_secuencial_documento"] : "" . $this->Nm_lang['lang_solicitud'] . " Nro.";
   $tab_ger_campos['scp_fecha'] = "on";
   $tab_def_campos['scp_fecha'] = "scp_fecha";
   $tab_labels["scp_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_convenio_pago']['labels']["scp_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_convenio_pago']['labels']["scp_fecha"] : "" . $this->Nm_lang['lang_fecha'] . "";
   $tab_ger_campos['scp_propietario'] = "on";
   $tab_def_campos['scp_propietario'] = "scp_propietario";
   $tab_labels["scp_propietario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_convenio_pago']['labels']["scp_propietario"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_convenio_pago']['labels']["scp_propietario"] : "" . $this->Nm_lang['lang_propietario'] . "";
   $tab_ger_campos['scp_monto'] = "on";
   $tab_def_campos['scp_monto'] = "scp_monto";
   $tab_labels["scp_monto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_convenio_pago']['labels']["scp_monto"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_convenio_pago']['labels']["scp_monto"] : "" . $this->Nm_lang['lang_saldo'] . "";
   $tab_ger_campos['scp_plazo'] = "on";
   $tab_def_campos['scp_plazo'] = "scp_plazo";
   $tab_labels["scp_plazo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_convenio_pago']['labels']["scp_plazo"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_convenio_pago']['labels']["scp_plazo"] : "" . $this->Nm_lang['lang_plazo'] . "";
   $tab_ger_campos['scp_taza'] = "on";
   $tab_def_campos['scp_taza'] = "scp_taza";
   $tab_labels["scp_taza"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_convenio_pago']['labels']["scp_taza"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_convenio_pago']['labels']["scp_taza"] : "" . $this->Nm_lang['lang_tasas_interes'] . "";
   $tab_ger_campos['scp_tipo_amortizacion'] = "on";
   $tab_def_campos['scp_tipo_amortizacion'] = "scp_tipo_amortizacion";
   $tab_labels["scp_tipo_amortizacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_convenio_pago']['labels']["scp_tipo_amortizacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_convenio_pago']['labels']["scp_tipo_amortizacion"] : "" . $this->Nm_lang['lang_tipo_amortizacion'] . "";
   $tab_ger_campos['scp_estado'] = "on";
   $tab_def_campos['scp_estado'] = "scp_estado";
   $tab_labels["scp_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_convenio_pago']['labels']["scp_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_convenio_pago']['labels']["scp_estado"] : "" . $this->Nm_lang['lang_estado'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_convenio_pago']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_convenio_pago']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_convenio_pago']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_convenio_pago']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_convenio_pago']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_convenio_pago']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_convenio_pago']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_convenio_pago']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_convenio_pago']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_convenio_pago']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_convenio_pago']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_convenio_pago']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_solicitud_convenio'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_fac_solicitud_convenio_pago_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_convenio_pago']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_convenio_pago']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_convenio_pago']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_convenio_pago']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_convenio_pago']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
