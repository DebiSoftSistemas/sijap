...
class grid_fac_solicitud_convenio_pago_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_fac_solicitud_convenio_pago_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_fac_solicitud_convenio_pago_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_fac_solicitud_convenio_pago_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_scp_fecha')
      {
          $scp_fecha = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_scp_fecha($scp_fecha);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$campo_join]);
              return;
          }
         $nm_ini_lower = "";
         $nm_fim_lower = "";
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         $nome_sum = "fac_solicitud_convenio_pago.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_solicitud_convenio'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_fac_solicitud_convenio_pago/grid_fac_solicitud_convenio_pago_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_fac_solicitud_convenio_pago_ajax_search.js"></script>
 <script type="text/javascript" src="grid_fac_solicitud_convenio_pago_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_fac_solicitud_convenio_pago_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_fac_solicitud_convenio_pago']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_fac_solicitud_convenio_pago']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_scp_id_cond#NMF#' + search_get_sel_txt('SC_scp_id_cond') + '@NMF@';
  str_out += 'SC_scp_id#NMF#' + search_get_text('SC_scp_id') + '@NMF@';
  str_out += 'SC_scp_fecha_cond#NMF#' + search_get_sel_txt('SC_scp_fecha_cond') + '@NMF@';
  str_out += 'SC_scp_fecha#NMF#' + search_get_text('SC_scp_fecha') + '@NMF@';
  str_out += 'id_ac_scp_fecha#NMF#' + search_get_title('select2-id_ac_scp_fecha-container') + '@NMF@';
  str_out += 'SC_scp_propietario_cond#NMF#' + search_get_sel_txt('SC_scp_propietario_cond') + '@NMF@';
  str_out += 'SC_scp_propietario#NMF#' + search_get_text('SC_scp_propietario') + '@NMF@';
  str_out += 'SC_scp_monto_cond#NMF#' + search_get_sel_txt('SC_scp_monto_cond') + '@NMF@';
  str_out += 'SC_scp_monto#NMF#' + search_get_text('SC_scp_monto') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-scp_fecha").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_scp_fecha",
      max_itens: "10",
   ...
   $("#SC_scp_fecha").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      global 
             $scp_id_cond, $scp_id,
             $scp_fecha_cond, $scp_fecha, $scp_fecha_autocomp,
             $scp_propietario_cond, $scp_propietario,
             $scp_monto_cond, $scp_monto,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $scp_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['campos_busca']['scp_id']; 
          $scp_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['campos_busca']['scp_id_cond']; 
          $scp_fecha = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['campos_busca']['scp_fecha']; 
          $scp_fecha_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['campos_busca']['scp_fecha_cond']; 
          $scp_propietario = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['campos_busca']['scp_propietario']; 
          $scp_propietario_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['campos_busca']['scp_propietario_cond']; 
          $scp_monto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['campos_busca']['scp_monto']; 
          $scp_monto_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['campos_busca']['scp_monto_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['campos_busca']['NM_operador']; 
          if (strtoupper($scp_id_cond) != "II" && strtoupper($scp_id_cond) != "QP" && strtoupper($scp_id_cond) != "NP" && strtoupper($scp_id_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($scp_id, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($scp_propietario_cond) != "II" && strtoupper($scp_propietario_cond) != "QP" && strtoupper($scp_propietario_cond) != "NP" && strtoupper($scp_propietario_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($scp_propietario, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($scp_monto_cond) != "II" && strtoupper($scp_monto_cond) != "QP" && strtoupper($scp_monto_cond) != "NP" && strtoupper($scp_monto_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($scp_monto, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($scp_id_cond) || empty($scp_id_cond))
      {
         $scp_id_cond = "gt";
      }
      if (!isset($scp_fecha_cond) || empty($scp_fecha_cond))
      {
         $scp_fecha_cond = "qp";
      }
      if (!isset($scp_propietario_cond) || empty($scp_propietario_cond))
      {
         $scp_propietario_cond = "gt";
      }
      if (!isset($scp_monto_cond) || empty($scp_monto_cond))
      {
         $scp_monto_cond = "gt";
      }
      ...
      $str_hide_scp_id = (in_array($scp_id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_scp_fecha = (in_array($scp_fecha_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_scp_propietario = (in_array($scp_propietario_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_scp_monto = (in_array($scp_monto_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($scp_id) || $scp_id == "")
      {
          $scp_id = "";
      }
      if (isset($scp_id) && !empty($scp_id))
      {
         $tmp_pos = (is_string($scp_id)) ? strpos($scp_id, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $scp_id = substr($scp_id, 0, $tmp_pos);
         }
      }
      if (!isset($scp_fecha) || $scp_fecha == "")
      {
          $scp_fecha = "";
      }
      if (isset($scp_fecha) && !empty($scp_fecha))
      {
         $tmp_pos = (is_string($scp_fecha)) ? strpos($scp_fecha, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $scp_fecha = substr($scp_fecha, 0, $tmp_pos);
         }
      }
      if (!isset($scp_propietario) || $scp_propietario == "")
      {
          $scp_propietario = "";
      }
      if (isset($scp_propietario) && !empty($scp_propietario))
      {
         $tmp_pos = (is_string($scp_propietario)) ? strpos($scp_propietario, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $scp_propietario = substr($scp_propietario, 0, $tmp_pos);
         }
      }
      if (!isset($scp_monto) || $scp_monto == "")
      {
          $scp_monto = "";
      }
      if (isset($scp_monto) && !empty($scp_monto))
      {
         $tmp_pos = (is_string($scp_monto)) ? strpos($scp_monto, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $scp_monto = substr($scp_monto, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_scp_id_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['scp_id'])) ? $this->New_label['scp_id'] : "" . $this->Ini->Nm_lang['lang_id'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_scp_id_cond" name="scp_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_scp_id'), this, 'scp_id')">
       <OPTION value="gt" <?php if ("gt" == $scp_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $scp_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $scp_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_scp_id" <?php echo $str_hide_scp_id?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['scp_id'])) ? $this->New_label['scp_id'] : "" . $this->Ini->Nm_lang['lang_id'] . "";
 $nmgp_tab_label .= "scp_id?#?" . $SC_Label . "?@?";
...
?>
<INPUT  type="text" id="SC_scp_id" name="scp_id" value="<?php echo NM_encode_input($scp_id) ?>" size=4 alt="{datatype: 'integer', maxLength: 4, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_scp_fecha_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['scp_fecha'])) ? $this->New_label['scp_fecha'] : "" . $this->Ini->Nm_lang['lang_fecha'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_scp_fecha_cond" name="scp_fecha_cond" onChange="nm_campos_between(document.getElementById('id_vis_scp_fecha'), this, 'scp_fecha')">
       <OPTION value="qp" <?php if ("qp" == $scp_fecha_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $scp_fecha_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $scp_fecha_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $scp_fecha_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_scp_fecha" <?php echo $str_hide_scp_fecha?> valign="top">
 ...
 $nmgp_tab_label .= "scp_fecha?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $scp_fecha;
      }
?>
<INPUT  type="text" id="SC_scp_fecha" name="scp_fecha" value="<?php echo NM_encode_input($scp_fecha) ?>"  size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-scp_fecha" id="id_ac_scp_fecha" name="scp_fecha_autocomp"><?php if ('' !=  $scp_fecha) { ?><option value="<?php echo $scp_fecha ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_scp_propietario_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['scp_propietario'])) ? $this->New_label['scp_propietario'] : "" . $this->Ini->Nm_lang['lang_propietario'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_scp_propietario_cond" name="scp_propietario_cond" onChange="nm_campos_between(document.getElementById('id_vis_scp_propietario'), this, 'scp_propietario')">
       <OPTION value="gt" <?php if ("gt" == $scp_propietario_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $scp_propietario_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $scp_propietario_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_scp_propietario" <?php echo $str_hide_scp_propietario?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['scp_propietario'])) ? $this->New_label['scp_propietario'] : "" . $this->Ini->Nm_lang['lang_propietario'] . "";
 $nmgp_tab_label .= "scp_propietario?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_scp_propietario" name="scp_propietario" value="<?php echo NM_encode_input($scp_propietario) ?>" size=4 alt="{datatype: 'integer', maxLength: 4, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_scp_monto_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['scp_monto'])) ? $this->New_label['scp_monto'] : "" . $this->Ini->Nm_lang['lang_saldo'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_scp_monto_cond" name="scp_monto_cond" onChange="nm_campos_between(document.getElementById('id_vis_scp_monto'), this, 'scp_monto')">
       <OPTION value="gt" <?php if ("gt" == $scp_monto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $scp_monto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $scp_monto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_scp_monto" <?php echo $str_hide_scp_monto?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['scp_monto'])) ? $this->New_label['scp_monto'] : "" . $this->Ini->Nm_lang['lang_saldo'] . "";
 $nmgp_tab_label .= "scp_monto?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_scp_monto" name="scp_monto" value="<?php echo NM_encode_input($scp_monto) ?>" size=17 alt="{datatype: 'decimal', maxLength: 17, precision: 0, decimalSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['dec_num'] ?>', thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_fac_solicitud_convenio_pago_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_fac_solicitud_convenio_pago']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_fac_solicitud_convenio_pago']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.scp_id_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_scp_id'), document.F1.scp_id_cond, 'scp_id');
   document.F1.scp_id.value = "";
   document.F1.scp_fecha_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_scp_fecha'), document.F1.scp_fecha_cond, 'scp_fecha');
   document.F1.scp_fecha.value = "";
   document.F1.scp_fecha_autocomp.value = "";
   $('#select2-id_ac_scp_fecha-container').html('<?php echo $this->Val_init_scp_fecha['desc'] ?>');;
   document.F1.scp_propietario_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_scp_propietario'), document.F1.scp_propietario_cond, 'scp_propietario');
   document.F1.scp_propietario.value = "";
   document.F1.scp_monto_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_scp_monto'), document.F1.scp_monto_cond, 'scp_monto');
   document.F1.scp_monto.value = "";
   Sc_carga_select2('all');
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_fac_solicitud_convenio_pago/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_scp_id_cond'] = 'cond';
      $tp_fields['SC_scp_id'] = 'text';
      $tp_fields['SC_scp_fecha_cond'] = 'cond';
      $tp_fields['SC_scp_fecha'] = 'text_aut';
      $tp_fields['id_ac_scp_fecha'] = 'select2_aut';
      $tp_fields['SC_scp_propietario_cond'] = 'cond';
      $tp_fields['SC_scp_propietario'] = 'text';
      $tp_fields['SC_scp_monto_cond'] = 'cond';
      $tp_fields['SC_scp_monto'] = 'text';
   ...
   {
      global $scp_id_cond, $scp_id,
             $scp_fecha_cond, $scp_fecha, $scp_fecha_autocomp,
             $scp_propietario_cond, $scp_propietario,
             $scp_monto_cond, $scp_monto, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($scp_fecha_autocomp) && empty($scp_fecha))
      {
          $scp_fecha = $scp_fecha_autocomp;
      }
      $scp_id_cond_salva = $scp_id_cond; 
      if (!isset($scp_id_input_2) || $scp_id_input_2 == "")
      {
          $scp_id_input_2 = $scp_id;
      }
      $scp_fecha_cond_salva = $scp_fecha_cond; 
      if (!isset($scp_fecha_input_2) || $scp_fecha_input_2 == "")
      {
          $scp_fecha_input_2 = $scp_fecha;
      }
      $scp_propietario_cond_salva = $scp_propietario_cond; 
      if (!isset($scp_propietario_input_2) || $scp_propietario_input_2 == "")
      {
          $scp_propietario_input_2 = $scp_propietario;
      }
      $scp_monto_cond_salva = $scp_monto_cond; 
      if (!isset($scp_monto_input_2) || $scp_monto_input_2 == "")
      {
          $scp_monto_input_2 = $scp_monto;
      }
      if ($scp_id_cond != "in")
      {
          nm_limpa_numero($scp_id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($scp_propietario_cond != "in")
      {
          nm_limpa_numero($scp_propietario, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($scp_monto_cond != "in")
      {
          nm_limpa_numero($scp_monto, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['campos_busca']['scp_id'] = $scp_id; 
      if (is_array($scp_id) && !empty($scp_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['Grid_search'][$I_Grid]['val'][0] = $scp_id;
      }
      elseif ($scp_id_cond_salva == "nu" || $scp_id_cond_salva == "nn" || $scp_id_cond_salva == "ep" || $scp_id_cond_salva == "ne" || !empty($scp_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['Grid_search'][$I_Grid]['val'][0][0] = $scp_id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['campos_busca']['scp_id_cond'] = $scp_id_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['Grid_search'][$I_Grid]['cmp'] = "scp_id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['Grid_search'][$I_Grid]['opc'] = $scp_id_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq']['scp_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['campos_busca']['scp_fecha'] = $scp_fecha; 
      if (is_array($scp_fecha) && !empty($scp_fecha))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['Grid_search'][$I_Grid]['val'][0] = $scp_fecha;
      }
      elseif ($scp_fecha_cond_salva == "nu" || $scp_fecha_cond_salva == "nn" || $scp_fecha_cond_salva == "ep" || $scp_fecha_cond_salva == "ne" || !empty($scp_fecha))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['Grid_search'][$I_Grid]['val'][0][0] = $scp_fecha;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['campos_busca']['scp_fecha_cond'] = $scp_fecha_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['Grid_search'][$I_Grid]['cmp'] = "scp_fecha"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['Grid_search'][$I_Grid]['opc'] = $scp_fecha_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq']['scp_fecha'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['campos_busca']['scp_propietario'] = $scp_propietario; 
      if (is_array($scp_propietario) && !empty($scp_propietario))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['Grid_search'][$I_Grid]['val'][0] = $scp_propietario;
      }
      elseif ($scp_propietario_cond_salva == "nu" || $scp_propietario_cond_salva == "nn" || $scp_propietario_cond_salva == "ep" || $scp_propietario_cond_salva == "ne" || !empty($scp_propietario))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['Grid_search'][$I_Grid]['val'][0][0] = $scp_propietario;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['campos_busca']['scp_propietario_cond'] = $scp_propietario_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['Grid_search'][$I_Grid]['cmp'] = "scp_propietario"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['Grid_search'][$I_Grid]['opc'] = $scp_propietario_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq']['scp_propietario'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['campos_busca']['scp_monto'] = $scp_monto; 
      if (is_array($scp_monto) && !empty($scp_monto))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['Grid_search'][$I_Grid]['val'][0] = $scp_monto;
      }
      elseif ($scp_monto_cond_salva == "nu" || $scp_monto_cond_salva == "nn" || $scp_monto_cond_salva == "ep" || $scp_monto_cond_salva == "ne" || !empty($scp_monto))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['Grid_search'][$I_Grid]['val'][0][0] = $scp_monto;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['campos_busca']['scp_monto_cond'] = $scp_monto_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['Grid_search'][$I_Grid]['cmp'] = "scp_monto"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['Grid_search'][$I_Grid]['opc'] = $scp_monto_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['grid_pesq']['scp_monto'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['campos_busca'] = $Temp_Busca;
      }
      if ($scp_monto_cond != "in" && $scp_monto_cond != "bw" && !empty($scp_monto) && !is_numeric($scp_monto))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : " . $this->Ini->Nm_lang['lang_saldo'] . "";
      }
      if ($scp_monto_cond == "bw" && ((!empty($scp_monto) && !is_numeric($scp_monto)) || (!empty($scp_monto_input_2) && !is_numeric($scp_monto_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : " . $this->Ini->Nm_lang['lang_saldo'] . "";
      }
      if (!empty($this->Campos_Mens_erro)) 
      ...
      $this->cmp_formatado['scp_id'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($scp_fecha != '') {
      $scp_fecha_look = (is_string($scp_fecha) ? substr($this->Db->qstr($scp_fecha), 1, -1) : $scp_fecha); 
      $nmgp_def_dados = array(); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['scp_fecha'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['scp_fecha'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['scp_fecha'] = $scp_fecha;
      }
      $Conteudo = $scp_propietario;
      if (strtoupper($scp_propietario_cond) != "II" && strtoupper($scp_propietario_cond) != "QP" && strtoupper($scp_propietario_cond) != "NP" && strtoupper($scp_propietario_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['scp_propietario'] = $Conteudo;
      $Conteudo = $scp_monto;
      if (strtoupper($scp_monto_cond) != "II" && strtoupper($scp_monto_cond) != "QP" && strtoupper($scp_monto_cond) != "NP" && strtoupper($scp_monto_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['scp_monto'] = $Conteudo;

      //----- $scp_id
      $this->Date_part = false;
      if (isset($scp_id) || $scp_id_cond == "nu" || $scp_id_cond == "nn" || $scp_id_cond == "ep" || $scp_id_cond == "ne")
      {
         $this->monta_condicao("scp_id", $scp_id_cond, $scp_id, "", "scp_id", "INT4", false);
      }

      //----- $scp_fecha
      $this->Date_part = false;
      if (isset($scp_fecha) || $scp_fecha_cond == "nu" || $scp_fecha_cond == "nn" || $scp_fecha_cond == "ep" || $scp_fecha_cond == "ne")
      {
         $this->monta_condicao("scp_fecha", $scp_fecha_cond, $scp_fecha, "", "scp_fecha", "DATE", false);
      }

      //----- $scp_propietario
      $this->Date_part = false;
      if (isset($scp_propietario) || $scp_propietario_cond == "nu" || $scp_propietario_cond == "nn" || $scp_propietario_cond == "ep" || $scp_propietario_cond == "ne")
      {
         $this->monta_condicao("scp_propietario", $scp_propietario_cond, $scp_propietario, "", "scp_propietario", "INT4", false);
      }

      //----- $scp_monto
      $this->Date_part = false;
      if (isset($scp_monto) || $scp_monto_cond == "nu" || $scp_monto_cond == "nn" || $scp_monto_cond == "ep" || $scp_monto_cond == "ne")
      {
         $this->monta_condicao("scp_monto", $scp_monto_cond, $scp_monto, "", "scp_monto", "NUMERIC", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
    $this->Sel_case_sensitive($this->comando);
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_solicitud_convenio_pago']['cond_pesq'] .= $this->NM_operador;
