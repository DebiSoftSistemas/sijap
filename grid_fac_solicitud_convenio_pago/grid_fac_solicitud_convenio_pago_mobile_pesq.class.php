...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "scp_fecha";$Nm_numeric[] = "scp_id";$Nm_numeric[] = "scp_propietario";$Nm_numeric[] = "scp_monto";$Nm_numeric[] = "scp_plazo";$Nm_numeric[] = "scp_taza";$Nm_numeric[] = "scp_secuencial_documento";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_scp_id_cond" name="scp_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_scp_id'), this, 'scp_id')">
      ...
      <br><span id="id_hide_scp_id"  <?php echo $str_hide_scp_id?>><INPUT  type="text" id="SC_scp_id" name="scp_id" value="<?php echo NM_encode_input($scp_id) ?>" size=4 alt="{datatype: 'integer', maxLength: 4, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_scp_fecha_cond" name="scp_fecha_cond" onChange="nm_campos_between(document.getElementById('id_vis_scp_fecha'), this, 'scp_fecha')">
      ...
      <br><span id="id_hide_scp_fecha"  <?php echo $str_hide_scp_fecha?>><?php
      if ($scp_fecha != "")
      {
      $scp_fecha_look = (is_string($scp_fecha) ? substr($this->Db->qstr($scp_fecha), 1, -1) : $scp_fecha); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_scp_propietario_cond" name="scp_propietario_cond" onChange="nm_campos_between(document.getElementById('id_vis_scp_propietario'), this, 'scp_propietario')">
      ...
      <br><span id="id_hide_scp_propietario"  <?php echo $str_hide_scp_propietario?>><INPUT  type="text" id="SC_scp_propietario" name="scp_propietario" value="<?php echo NM_encode_input($scp_propietario) ?>" size=4 alt="{datatype: 'integer', maxLength: 4, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_scp_monto_cond" name="scp_monto_cond" onChange="nm_campos_between(document.getElementById('id_vis_scp_monto'), this, 'scp_monto')">
