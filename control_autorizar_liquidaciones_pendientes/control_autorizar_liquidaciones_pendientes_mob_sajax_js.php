  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_autorizar_liquidaciones_pendientes_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_autorizar_liquidaciones_pendientes_mob_form();
	}
...
?>
  ...
  // ---------- Validate mensaje_control
  function do_ajax_control_autorizar_liquidaciones_pendientes_mob_validate_mensaje_control()
  {
  } // do_ajax_control_autorizar_liquidaciones_pendientes_mob_validate_mensaje_control

  function do_ajax_control_autorizar_liquidaciones_pendientes_mob_validate_mensaje_control_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mensaje_control";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_autorizar_liquidaciones_pendientes_mob_validate_mensaje_control_cb

  // ---------- Event onclick scajaxbutton_autorizar
  function do_ajax_control_autorizar_liquidaciones_pendientes_mob_event_scajaxbutton_autorizar_onclick()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_control_autorizar_liquidaciones_pendientes_mob_event_scajaxbutton_autorizar_onclick(var_script_case_init, do_ajax_control_autorizar_liquidaciones_pendientes_mob_event_scajaxbutton_autorizar_onclick_cb);
  } // do_ajax_control_autorizar_liquidaciones_pendientes_mob_event_scajaxbutton_autorizar_onclick

  function do_ajax_control_autorizar_liquidaciones_pendientes_mob_event_scajaxbutton_autorizar_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_control_autorizar_liquidaciones_pendientes_mob_event_scajaxbutton_autorizar_onclick_cb_after_alert);
  } // do_ajax_control_autorizar_liquidaciones_pendientes_mob_event_scajaxbutton_autorizar_onclick_cb
  function do_ajax_control_autorizar_liquidaciones_pendientes_mob_event_scajaxbutton_autorizar_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_control_autorizar_liquidaciones_pendientes_mob_event_scajaxbutton_autorizar_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_autorizar_liquidaciones_pendientes_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_autorizar_liquidaciones_pendientes_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_mensaje_control = scAjaxGetFieldHidden("mensaje_control");
    ...
    scAjaxProcOn();
    x_ajax_control_autorizar_liquidaciones_pendientes_mob_submit_form(var_mensaje_control, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_autorizar_liquidaciones_pendientes_mob_submit_form_cb);
  } // do_ajax_control_autorizar_liquidaciones_pendientes_mob_submit_form

  function do_ajax_control_autorizar_liquidaciones_pendientes_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_autorizar_liquidaciones_pendientes_mob_submit_form_cb_after_alert);
  } // do_ajax_control_autorizar_liquidaciones_pendientes_mob_submit_form_cb
  function do_ajax_control_autorizar_liquidaciones_pendientes_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_autorizar_liquidaciones_pendientes_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_autorizar_liquidaciones_pendientes_mob_navigate_form()
  {
    perform_ajax_control_autorizar_liquidaciones_pendientes_mob_navigate_form();
  }

  function perform_ajax_control_autorizar_liquidaciones_pendientes_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_autorizar_liquidaciones_pendientes_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_autorizar_liquidaciones_pendientes_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_autorizar_liquidaciones_pendientes_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_autorizar_liquidaciones_pendientes_mob_navigate_form_cb_after_alert);
  } // do_ajax_control_autorizar_liquidaciones_pendientes_mob_navigate_form_cb
  function do_ajax_control_autorizar_liquidaciones_pendientes_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_autorizar_liquidaciones_pendientes_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_autorizar_liquidaciones_pendientes_mob_navigate_form_cb_after_alert

  function sc_hide_control_autorizar_liquidaciones_pendientes_mob_form()
  {
  ...
  ajax_field_list[0] = "mensaje_control";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "mensaje_control": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "mensaje_control": new Array()
  };
  ajax_field_mult["mensaje_control"][1] = "mensaje_control";

  var ajax_field_id = {
    "mensaje_control": new Array("hidden_field_label_mensaje_control", "hidden_field_data_mensaje_control")
  };
