...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_del_detalle_factura"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_del_detalle_factura"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_detalle_factura_nueva'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_del_detalle_factura']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_del_detalle_factura']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_del_detalle_factura']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_del_detalle_factura']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_del_detalle_factura']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_del_detalle_factura</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_del_detalle_factura']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_del_detalle_factura']['embutida_filho'] as $ind => $sc_init)
          {
