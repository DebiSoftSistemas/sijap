...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_pro_descripcion_cond" name="pro_descripcion_cond" onChange="nm_campos_between(document.getElementById('id_vis_pro_descripcion'), this, 'pro_descripcion')">
      ...
      <br><span id="id_hide_pro_descripcion"  <?php echo $str_hide_pro_descripcion?>><?php
      if ($pro_descripcion != "")
      {
      $pro_descripcion_look = (is_string($pro_descripcion) ? substr($this->Db->qstr($pro_descripcion), 1, -1) : $pro_descripcion); 
      $nmgp_def_dados = array(); 
