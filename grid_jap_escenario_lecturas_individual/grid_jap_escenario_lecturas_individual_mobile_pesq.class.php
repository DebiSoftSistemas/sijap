...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "esc_fecha";$Nm_numeric[] = "esc_id";$Nm_numeric[] = "esc_tipo_deuda";$Nm_numeric[] = "esc_anio_periodo";$Nm_numeric[] = "esc_ruta";$Nm_numeric[] = "esc_total";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_esc_id_cond" name="esc_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_esc_id'), this, 'esc_id')">
      ...
      <br><span id="id_hide_esc_id"  <?php echo $str_hide_esc_id?>><INPUT  type="text" id="SC_esc_id" name="esc_id" value="<?php echo NM_encode_input($esc_id) ?>" size=4 alt="{datatype: 'integer', maxLength: 4, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_esc_tipo_deuda_cond" name="esc_tipo_deuda_cond" onChange="nm_campos_between(document.getElementById('id_vis_esc_tipo_deuda'), this, 'esc_tipo_deuda')">
      ...
      <br><span id="id_hide_esc_tipo_deuda"  <?php echo $str_hide_esc_tipo_deuda?>><INPUT  type="text" id="SC_esc_tipo_deuda" name="esc_tipo_deuda" value="<?php echo NM_encode_input($esc_tipo_deuda) ?>" size=4 alt="{datatype: 'integer', maxLength: 4, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_esc_mes_periodo_cond" name="esc_mes_periodo_cond" onChange="nm_campos_between(document.getElementById('id_vis_esc_mes_periodo'), this, 'esc_mes_periodo')">
      ...
      <br><span id="id_hide_esc_mes_periodo"  <?php echo $str_hide_esc_mes_periodo?>><?php
      if ($esc_mes_periodo != "")
      {
      $esc_mes_periodo_look = (is_string($esc_mes_periodo) ? substr($this->Db->qstr($esc_mes_periodo), 1, -1) : $esc_mes_periodo); 
      $nmgp_def_dados = array(); 
