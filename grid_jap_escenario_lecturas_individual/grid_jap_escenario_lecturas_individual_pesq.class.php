...
class grid_jap_escenario_lecturas_individual_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_jap_escenario_lecturas_individual_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_jap_escenario_lecturas_individual_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_jap_escenario_lecturas_individual_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_esc_mes_periodo')
      {
          $esc_mes_periodo = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_esc_mes_periodo($esc_mes_periodo);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$campo_join]);
              return;
          }
         $nm_ini_lower = "";
         $nm_fim_lower = "";
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_plantillas_lectura'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_jap_escenario_lecturas_individual/grid_jap_escenario_lecturas_individual_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_jap_escenario_lecturas_individual_ajax_search.js"></script>
 <script type="text/javascript" src="grid_jap_escenario_lecturas_individual_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_jap_escenario_lecturas_individual_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_jap_escenario_lecturas_individual']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_jap_escenario_lecturas_individual']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_esc_id_cond#NMF#' + search_get_sel_txt('SC_esc_id_cond') + '@NMF@';
  str_out += 'SC_esc_id#NMF#' + search_get_text('SC_esc_id') + '@NMF@';
  str_out += 'SC_esc_tipo_deuda_cond#NMF#' + search_get_sel_txt('SC_esc_tipo_deuda_cond') + '@NMF@';
  str_out += 'SC_esc_tipo_deuda#NMF#' + search_get_text('SC_esc_tipo_deuda') + '@NMF@';
  str_out += 'SC_esc_mes_periodo_cond#NMF#' + search_get_sel_txt('SC_esc_mes_periodo_cond') + '@NMF@';
  str_out += 'SC_esc_mes_periodo#NMF#' + search_get_text('SC_esc_mes_periodo') + '@NMF@';
  str_out += 'id_ac_esc_mes_periodo#NMF#' + search_get_title('select2-id_ac_esc_mes_periodo-container') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-esc_mes_periodo").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_esc_mes_periodo",
      max_itens: "10",
   ...
   $("#SC_esc_mes_periodo").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $esc_mes_periodo_cond, $esc_mes_periodo, $esc_mes_periodo_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $esc_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['campos_busca']['esc_id']; 
          $esc_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['campos_busca']['esc_id_cond']; 
          $esc_tipo_deuda = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['campos_busca']['esc_tipo_deuda']; 
          $esc_tipo_deuda_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['campos_busca']['esc_tipo_deuda_cond']; 
          $esc_mes_periodo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['campos_busca']['esc_mes_periodo']; 
          $esc_mes_periodo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['campos_busca']['esc_mes_periodo_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['campos_busca']['NM_operador']; 
          if (strtoupper($esc_id_cond) != "II" && strtoupper($esc_id_cond) != "QP" && strtoupper($esc_id_cond) != "NP" && strtoupper($esc_id_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($esc_id, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($esc_tipo_deuda_cond) != "II" && strtoupper($esc_tipo_deuda_cond) != "QP" && strtoupper($esc_tipo_deuda_cond) != "NP" && strtoupper($esc_tipo_deuda_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($esc_tipo_deuda, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($esc_id_cond) || empty($esc_id_cond))
      {
         $esc_id_cond = "gt";
      }
      if (!isset($esc_tipo_deuda_cond) || empty($esc_tipo_deuda_cond))
      {
         $esc_tipo_deuda_cond = "gt";
      }
      if (!isset($esc_mes_periodo_cond) || empty($esc_mes_periodo_cond))
      {
         $esc_mes_periodo_cond = "qp";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_esc_id = (in_array($esc_id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      if (!isset($esc_id) || $esc_id == "")
      {
          $esc_id = "";
      }
      if (isset($esc_id) && !empty($esc_id))
      {
         $tmp_pos = (is_string($esc_id)) ? strpos($esc_id, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $esc_id = substr($esc_id, 0, $tmp_pos);
         }
      }
      ...
      if (isset($esc_tipo_deuda) && !empty($esc_tipo_deuda))
      {
      ...
      if (isset($esc_mes_periodo) && !empty($esc_mes_periodo))
      {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_esc_id_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['esc_id'])) ? $this->New_label['esc_id'] : "" . $this->Ini->Nm_lang['lang_id'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_esc_id_cond" name="esc_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_esc_id'), this, 'esc_id')">
       <OPTION value="gt" <?php if ("gt" == $esc_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $esc_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $esc_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_esc_id" <?php echo $str_hide_esc_id?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['esc_id'])) ? $this->New_label['esc_id'] : "" . $this->Ini->Nm_lang['lang_id'] . "";
 $nmgp_tab_label .= "esc_id?#?" . $SC_Label . "?@?";
...
?>
<INPUT  type="text" id="SC_esc_id" name="esc_id" value="<?php echo NM_encode_input($esc_id) ?>" size=4 alt="{datatype: 'integer', maxLength: 4, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_esc_tipo_deuda_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['esc_tipo_deuda'])) ? $this->New_label['esc_tipo_deuda'] : "" . $this->Ini->Nm_lang['lang_tipo_deuda'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_esc_tipo_deuda_cond" name="esc_tipo_deuda_cond" onChange="nm_campos_between(document.getElementById('id_vis_esc_tipo_deuda'), this, 'esc_tipo_deuda')">
       <OPTION value="gt" <?php if ("gt" == $esc_tipo_deuda_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $esc_tipo_deuda_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $esc_tipo_deuda_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
?>
<INPUT  type="text" id="SC_esc_tipo_deuda" name="esc_tipo_deuda" value="<?php echo NM_encode_input($esc_tipo_deuda) ?>" size=4 alt="{datatype: 'integer', maxLength: 4, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
     ...
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_esc_mes_periodo_cond" name="esc_mes_periodo_cond" onChange="nm_campos_between(document.getElementById('id_vis_esc_mes_periodo'), this, 'esc_mes_periodo')">
       <OPTION value="qp" <?php if ("qp" == $esc_mes_periodo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $esc_mes_periodo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $esc_mes_periodo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $esc_mes_periodo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
<?php
      ...
      {
          $sAutocompValue = $esc_mes_periodo;
      }
?>
<INPUT  type="text" id="SC_esc_mes_periodo" name="esc_mes_periodo" value="<?php echo NM_encode_input($esc_mes_periodo) ?>"  size=2 alt="{datatype: 'text', maxLength: 2, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-esc_mes_periodo" id="id_ac_esc_mes_periodo" name="esc_mes_periodo_autocomp"><?php if ('' !=  $esc_mes_periodo) { ?><option value="<?php echo $esc_mes_periodo ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_jap_escenario_lecturas_individual_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_jap_escenario_lecturas_individual']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_jap_escenario_lecturas_individual']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.esc_id_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_esc_id'), document.F1.esc_id_cond, 'esc_id');
   document.F1.esc_id.value = "";
   document.F1.esc_tipo_deuda_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_esc_tipo_deuda'), document.F1.esc_tipo_deuda_cond, 'esc_tipo_deuda');
   document.F1.esc_tipo_deuda.value = "";
   document.F1.esc_mes_periodo_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_esc_mes_periodo'), document.F1.esc_mes_periodo_cond, 'esc_mes_periodo');
   document.F1.esc_mes_periodo.value = "";
   document.F1.esc_mes_periodo_autocomp.value = "";
   $('#select2-id_ac_esc_mes_periodo-container').html('<?php echo $this->Val_init_esc_mes_periodo['desc'] ?>');;
   Sc_carga_select2('all');
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_jap_escenario_lecturas_individual/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_esc_id_cond'] = 'cond';
      $tp_fields['SC_esc_id'] = 'text';
      $tp_fields['SC_esc_tipo_deuda_cond'] = 'cond';
      $tp_fields['SC_esc_tipo_deuda'] = 'text';
      $tp_fields['SC_esc_mes_periodo_cond'] = 'cond';
      $tp_fields['SC_esc_mes_periodo'] = 'text_aut';
      $tp_fields['id_ac_esc_mes_periodo'] = 'select2_aut';
   ...
   {
      global $esc_id_cond, $esc_id,
             $esc_tipo_deuda_cond, $esc_tipo_deuda,
             $esc_mes_periodo_cond, $esc_mes_periodo, $esc_mes_periodo_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($esc_mes_periodo_autocomp) && empty($esc_mes_periodo))
      {
          $esc_mes_periodo = $esc_mes_periodo_autocomp;
      }
      $esc_id_cond_salva = $esc_id_cond; 
      if (!isset($esc_id_input_2) || $esc_id_input_2 == "")
      {
          $esc_id_input_2 = $esc_id;
      }
      ...
      if ($esc_id_cond != "in")
      {
          nm_limpa_numero($esc_id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($esc_tipo_deuda_cond != "in")
      {
          nm_limpa_numero($esc_tipo_deuda, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['campos_busca']['esc_id'] = $esc_id; 
      if (is_array($esc_id) && !empty($esc_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['Grid_search'][$I_Grid]['val'][0] = $esc_id;
      }
      elseif ($esc_id_cond_salva == "nu" || $esc_id_cond_salva == "nn" || $esc_id_cond_salva == "ep" || $esc_id_cond_salva == "ne" || !empty($esc_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['Grid_search'][$I_Grid]['val'][0][0] = $esc_id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['campos_busca']['esc_id_cond'] = $esc_id_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['Grid_search'][$I_Grid]['cmp'] = "esc_id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['Grid_search'][$I_Grid]['opc'] = $esc_id_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq']['esc_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['campos_busca']['esc_tipo_deuda'] = $esc_tipo_deuda; 
      if (is_array($esc_tipo_deuda) && !empty($esc_tipo_deuda))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['Grid_search'][$I_Grid]['val'][0] = $esc_tipo_deuda;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['Grid_search'][$I_Grid]['val'][0][0] = $esc_tipo_deuda;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['campos_busca']['esc_tipo_deuda_cond'] = $esc_tipo_deuda_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['Grid_search'][$I_Grid]['cmp'] = "esc_tipo_deuda"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['Grid_search'][$I_Grid]['opc'] = $esc_tipo_deuda_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq']['esc_tipo_deuda'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['campos_busca']['esc_mes_periodo'] = $esc_mes_periodo; 
      if (is_array($esc_mes_periodo) && !empty($esc_mes_periodo))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['Grid_search'][$I_Grid]['val'][0] = $esc_mes_periodo;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['Grid_search'][$I_Grid]['val'][0][0] = $esc_mes_periodo;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['campos_busca']['esc_mes_periodo_cond'] = $esc_mes_periodo_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['Grid_search'][$I_Grid]['cmp'] = "esc_mes_periodo"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['Grid_search'][$I_Grid]['opc'] = $esc_mes_periodo_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['grid_pesq']['esc_mes_periodo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $this->cmp_formatado['esc_id'] = $Conteudo;
      $Conteudo = $esc_tipo_deuda;
      if (strtoupper($esc_tipo_deuda_cond) != "II" && strtoupper($esc_tipo_deuda_cond) != "QP" && strtoupper($esc_tipo_deuda_cond) != "NP" && strtoupper($esc_tipo_deuda_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['esc_tipo_deuda'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($esc_mes_periodo != '') {
      $esc_mes_periodo_look = (is_string($esc_mes_periodo) ? substr($this->Db->qstr($esc_mes_periodo), 1, -1) : $esc_mes_periodo); 
      $nmgp_def_dados = array(); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['esc_mes_periodo'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['esc_mes_periodo'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['esc_mes_periodo'] = $esc_mes_periodo;
      }

      //----- $esc_id
      $this->Date_part = false;
      if (isset($esc_id) || $esc_id_cond == "nu" || $esc_id_cond == "nn" || $esc_id_cond == "ep" || $esc_id_cond == "ne")
      {
         $this->monta_condicao("esc_id", $esc_id_cond, $esc_id, "", "esc_id", "INT4", false);
      }

      //----- $esc_tipo_deuda
      $this->Date_part = false;
      if (isset($esc_tipo_deuda) || $esc_tipo_deuda_cond == "nu" || $esc_tipo_deuda_cond == "nn" || $esc_tipo_deuda_cond == "ep" || $esc_tipo_deuda_cond == "ne")
      {
         $this->monta_condicao("esc_tipo_deuda", $esc_tipo_deuda_cond, $esc_tipo_deuda, "", "esc_tipo_deuda", "INT4", false);
      }

      //----- $esc_mes_periodo
      $this->Date_part = false;
      if (isset($esc_mes_periodo) || $esc_mes_periodo_cond == "nu" || $esc_mes_periodo_cond == "nn" || $esc_mes_periodo_cond == "ep" || $esc_mes_periodo_cond == "ne")
      {
         $this->monta_condicao("esc_mes_periodo", $esc_mes_periodo_cond, $esc_mes_periodo, "", "esc_mes_periodo", "VARCHAR", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
    $this->Sel_case_sensitive($this->comando);
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_escenario_lecturas_individual']['cond_pesq'] .= $this->NM_operador;
