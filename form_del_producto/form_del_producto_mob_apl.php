...
//---------------------------------------------------------
   ...
   if (isset($this->Field_no_validate['pro_producto_debi'])) {
       return;
               ...
               if (!empty($this->pro_producto_debi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_producto_debi']) && !in_array($this->pro_producto_debi, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_producto_debi']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['pro_cta_cobrar'])) {
       return;
               ...
               if (!empty($this->pro_cta_cobrar) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_cta_cobrar']) && !in_array($this->pro_cta_cobrar, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_cta_cobrar']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['pro_cta_puente'])) {
       return;
               ...
               if (!empty($this->pro_cta_puente) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_cta_puente']) && !in_array($this->pro_cta_puente, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_cta_puente']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['pro_cta_ingreso'])) {
       return;
               ...
               if (!empty($this->pro_cta_ingreso) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_cta_ingreso']) && !in_array($this->pro_cta_ingreso, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_cta_ingreso']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_pro_cta_cartera_vencida(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->pro_cta_cartera_vencida, 9, 0, -0, 999999999, "N") == false)  
              { 
                  $hasError = true;
...
$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_producto_debi'][] = '';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['pro_producto_debi']['valList'][$i] = form_del_producto_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_cta_cobrar'][] = '';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['pro_cta_cobrar']['valList'][$i] = form_del_producto_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_cta_puente'][] = '';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['pro_cta_puente']['valList'][$i] = form_del_producto_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_cta_ingreso'][] = '';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['pro_cta_ingreso']['valList'][$i] = form_del_producto_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          { 
              ...
              $this->nmgp_refresh_fields = array_diff(array('pro_imagen', 'pro_empresa', 'pro_codigo', 'pro_codigo_aux', 'pro_descripcion', 'pro_categoria_producto', 'pro_familia_producto', 'pro_grupo_compras', 'pro_grupo_ventas', 'pro_estado', 'pro_aplica_subsidio', 'pro_precio_sin_subsidio', 'pro_valor_subsidio', 'pro_precio', 'pro_por_ice', 'tarifa_ice', 'pro_base_ice', 'total_ice', 'pro_por_iva', 'tarifa_iva', 'base_iva', 'total_iva', 'pro_por_irbpnr', 'tarifa_irbpnr', 'pro_base_irbpnr', 'total_irbpnr', 'pro_iva', 'precio_con_impuesto', 'pro_ice', 'pro_irbpnr', 'pro_compra', 'pro_venta', 'pro_stock', 'pro_unidad', 'pro_producto_debi', 'pro_cta_cobrar', 'pro_cta_puente', 'pro_cta_ingreso', 'pro_cta_cartera_vencida', 'pro_cantidad_inventario', 'pro_costo_promedio', 'pro_total_inventario'), $aDoNotUpdate);
              $this->ajax_return_values();
