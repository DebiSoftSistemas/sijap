...
<?php $sStyleHidden_pro_unidad_dumb = ('' == $sStyleHidden_pro_unidad) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_pro_unidad_dumb" style="<?php echo $sStyleHidden_pro_unidad_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_pro_producto_debi_line" id="hidden_field_data_pro_producto_debi" style="<?php echo $sStyleHidden_pro_producto_debi; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pro_producto_debi_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_pro_producto_debi_label" style=""><span id="id_label_pro_producto_debi"><?php echo $this->nm_new_label['pro_producto_debi']; ?></span></span><br>
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_producto_debi']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_producto_debi'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_producto_debi']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_producto_debi'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_producto_debi'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
<?php
   ...
   echo "\r" ; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_producto_debi'][] = ''; 
   echo "  <option value=\"\">" . str_replace("<", "&lt;","" . $this->Ini->Nm_lang['lang_seleccione'] . "") . "</option>" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_pro_cta_cobrar_line" id="hidden_field_data_pro_cta_cobrar" style="<?php echo $sStyleHidden_pro_cta_cobrar; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pro_cta_cobrar_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_pro_cta_cobrar_label" style=""><span id="id_label_pro_cta_cobrar"><?php echo $this->nm_new_label['pro_cta_cobrar']; ?></span></span><br>
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_cta_cobrar']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_cta_cobrar'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_cta_cobrar']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_cta_cobrar'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_cta_cobrar'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
<?php
   ...
   echo "\r" ; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_cta_cobrar'][] = ''; 
   echo "  <option value=\"\">" . str_replace("<", "&lt;","" . $this->Ini->Nm_lang['lang_seleccione'] . "") . "</option>" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_pro_cta_puente_line" id="hidden_field_data_pro_cta_puente" style="<?php echo $sStyleHidden_pro_cta_puente; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pro_cta_puente_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_pro_cta_puente_label" style=""><span id="id_label_pro_cta_puente"><?php echo $this->nm_new_label['pro_cta_puente']; ?></span></span><br>
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_cta_puente']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_cta_puente'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_cta_puente']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_cta_puente'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_cta_puente'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
<?php
   ...
   echo "\r" ; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_cta_puente'][] = ''; 
   echo "  <option value=\"\">" . str_replace("<", "&lt;","" . $this->Ini->Nm_lang['lang_seleccione'] . "") . "</option>" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_pro_cta_ingreso_line" id="hidden_field_data_pro_cta_ingreso" style="<?php echo $sStyleHidden_pro_cta_ingreso; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pro_cta_ingreso_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_pro_cta_ingreso_label" style=""><span id="id_label_pro_cta_ingreso"><?php echo $this->nm_new_label['pro_cta_ingreso']; ?></span></span><br>
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_cta_ingreso']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_cta_ingreso'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_cta_ingreso']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_cta_ingreso'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_cta_ingreso'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
<?php
   ...
   echo "\r" ; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_producto_mob']['Lookup_pro_cta_ingreso'][] = ''; 
   echo "  <option value=\"\">" . str_replace("<", "&lt;","" . $this->Ini->Nm_lang['lang_seleccione'] . "") . "</option>" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_pro_cta_cartera_vencida_line" id="hidden_field_data_pro_cta_cartera_vencida" style="<?php echo $sStyleHidden_pro_cta_cartera_vencida; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pro_cta_cartera_vencida_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_pro_cta_cartera_vencida_label" style=""><span id="id_label_pro_cta_cartera_vencida"><?php echo $this->nm_new_label['pro_cta_cartera_vencida']; ?></span></span><br>
