<?php
@session_start() ;
$_SESSION['scriptcase']['grid_resumen_nd']['sc_process_barr'] = true;
require_once('../grid_resumen_nd/index.php');
unset($_SESSION['scriptcase']['grid_resumen_nd']['sc_process_barr']);
$ExportCtrl = new grid_resumen_nd_export_control;
$ExportCtrl->Export_barr();

class grid_resumen_nd_export_control
{
