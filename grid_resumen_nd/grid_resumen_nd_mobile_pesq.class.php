...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "nd_fecha";$Nm_numeric[] = "nd_numero";$Nm_numeric[] = "nd_subtotal";$Nm_numeric[] = "nd_subtotal_iva";$Nm_numeric[] = "nd_valor_iva";$Nm_numeric[] = "nd_subtotal_cero";$Nm_numeric[] = "nd_subtotal_no_objeto";$Nm_numeric[] = "nd_subtotal_excento";$Nm_numeric[] = "nd_valor_ice";$Nm_numeric[] = "nd_total";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_nd_usuario"  <?php echo $str_hide_nd_usuario?>>
<?php
...
?>
   <span id="idAjaxSelect_nd_usuario">
      <SELECT class="scFilterObjectEven" id="SC_nd_usuario" name="nd_usuario[]"  size="7" multiple>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
 ...
 function limpa_form()
 {
   ...
   for (i = 0; i < document.F1.elements.length; i++)
   {
      if (document.F1.elements[i].name == 'nd_usuario[]')
      {
          while (document.F1.elements[i].selectedIndex != -1)
          {
              aa = document.F1.elements[i].selectedIndex;
...
<?php
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         ...
         case "nd_usuario" : return ('class="scFilterObjectEven"'); break;
         default       : return ("");
      }
   }
