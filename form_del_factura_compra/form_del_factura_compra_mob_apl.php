...
//
      ...
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra_mob']['dados_select']['liq_desde']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->liq_desde = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra_mob']['dados_select']['liq_desde'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra_mob']['dados_select']['liq_hasta']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->liq_hasta = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra_mob']['dados_select']['liq_hasta'];
          } 
...
//---
   ...
   if (isset($this->Field_no_validate['liq_serie'])) {
       return;
               ...
               if (!empty($this->liq_serie) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra_mob']['Lookup_liq_serie']) && !in_array($this->liq_serie, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_factura_compra_mob']['Lookup_liq_serie']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_liq_libretin(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->liq_libretin, 9, 0, -0, 999999999, "N") == false)  
              { 
                  $hasError = true;
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['liq_serie']['valList'][$i] = form_del_factura_compra_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
