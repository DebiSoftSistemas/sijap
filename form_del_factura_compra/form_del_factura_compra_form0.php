...
<?php } 
?> 
<?php $sStyleHidden_liq_serie_dumb = ('' == $sStyleHidden_liq_serie) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_liq_serie_dumb" style="<?php echo $sStyleHidden_liq_serie_dumb; ?>"></TD>
...
<?php $sStyleHidden_liq_desde_dumb = ('' == $sStyleHidden_liq_desde) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_liq_desde_dumb" style="<?php echo $sStyleHidden_liq_desde_dumb; ?>"></TD>
<?php $sStyleHidden_liq_hasta_dumb = ('' == $sStyleHidden_liq_hasta) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_liq_hasta_dumb" style="<?php echo $sStyleHidden_liq_hasta_dumb; ?>"></TD>
