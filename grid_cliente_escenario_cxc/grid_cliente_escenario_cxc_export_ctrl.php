<?php
@session_start() ;
$_SESSION['scriptcase']['grid_cliente_escenario_cxc']['sc_process_barr'] = true;
require_once('../grid_cliente_escenario_cxc/index.php');
unset($_SESSION['scriptcase']['grid_cliente_escenario_cxc']['sc_process_barr']);
$ExportCtrl = new grid_cliente_escenario_cxc_export_control;
$ExportCtrl->Export_barr();

class grid_cliente_escenario_cxc_export_control
{
