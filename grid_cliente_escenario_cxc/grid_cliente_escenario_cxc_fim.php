...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_cliente_escenario_cxc"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_cliente_escenario_cxc"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cliente_escenario_cxc']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_cliente_escenario_cxc']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cliente_escenario_cxc']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_cliente_escenario_cxc']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_cliente_escenario_cxc']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_cliente_escenario_cxc</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_cliente_escenario_cxc']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_cliente_escenario_cxc']['embutida_filho'] as $ind => $sc_init)
          {
