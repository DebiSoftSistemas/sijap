...
class grid_cliente_escenario_cxc_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_cliente_escenario_cxc']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_cliente_escenario_cxc']['campos_busca']))
      { 
