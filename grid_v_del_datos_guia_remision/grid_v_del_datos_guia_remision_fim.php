...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_v_del_datos_guia_remision"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_v_del_datos_guia_remision"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_del_guia_remision'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_v_del_datos_guia_remision']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_v_del_datos_guia_remision']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_v_del_datos_guia_remision']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_v_del_datos_guia_remision']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_v_del_datos_guia_remision']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_v_del_datos_guia_remision</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_v_del_datos_guia_remision']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_v_del_datos_guia_remision']['embutida_filho'] as $ind => $sc_init)
          {
