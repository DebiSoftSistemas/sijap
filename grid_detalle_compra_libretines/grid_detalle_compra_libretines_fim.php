...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_detalle_compra_libretines"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_detalle_compra_libretines"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detalle_compra_libretines']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_detalle_compra_libretines']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detalle_compra_libretines']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_detalle_compra_libretines']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_detalle_compra_libretines']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_detalle_compra_libretines</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_detalle_compra_libretines']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_detalle_compra_libretines']['embutida_filho'] as $ind => $sc_init)
          {
