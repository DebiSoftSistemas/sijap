...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_activa_libretin_mob']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['control_activa_libretin_mob']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="control_activa_libretin_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function nm_saida_glo()
{
  ...
  document.F4.action = "control_activa_libretin_mob_fim.php";
  document.F4.submit();
}
...
function lookup_id(campo)
{
   ...
   jsrsExecute("<?php  echo $this->Ini->path_link . SC_dir_app_name('control_activa_libretin_mob')?>/control_activa_libretin_mob.php?script_case_init=<?php echo $this->form_encode_input($this->Ini->sc_page); ?>&nmgp_opcao=lookup", recebe_id, "id", dados, false);
}
