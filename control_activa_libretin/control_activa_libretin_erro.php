...
$old_error_handler = set_error_handler("control_activa_libretin_scriptcase_error_handler");

function control_activa_libretin_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['control_activa_libretin']['contr_erro']) && $_SESSION['scriptcase']['control_activa_libretin']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_control_activa_libretin->contr_control_activa_libretin->Apl_com_erro = true;
            if ($inicial_control_activa_libretin->contr_control_activa_libretin->NM_ajax_flag)
            {
                $inicial_control_activa_libretin->contr_control_activa_libretin->NM_ajax_info['errList']['geral_control_activa_libretin'][] = $msg;
                return;
            }
            control_activa_libretin_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function control_activa_libretin_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['control_activa_libretin'])  && '' != $_SESSION['scriptcase']['error_icon']['control_activa_libretin'])  ? $_SESSION['scriptcase']['error_icon']['control_activa_libretin']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['control_activa_libretin']) && '' != $_SESSION['scriptcase']['error_close']['control_activa_libretin']) ? $_SESSION['scriptcase']['error_close']['control_activa_libretin'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['control_activa_libretin']) && '' != $_SESSION['scriptcase']['error_span_title']['control_activa_libretin']) ? $_SESSION['scriptcase']['error_span_title']['control_activa_libretin'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['control_activa_libretin']) && '' != $_SESSION['scriptcase']['error_icon_title']['control_activa_libretin']) ? $_SESSION['scriptcase']['error_icon_title']['control_activa_libretin'] : '';
?>
