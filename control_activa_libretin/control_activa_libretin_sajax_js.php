  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_activa_libretin" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_activa_libretin_form();
	}
...
?>
  ...
  // ---------- Validate mensaje
  function do_ajax_control_activa_libretin_validate_mensaje()
  {
  } // do_ajax_control_activa_libretin_validate_mensaje

  function do_ajax_control_activa_libretin_validate_mensaje_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_activa_libretin_validate_mensaje_cb

  // ---------- Validate id
  function do_ajax_control_activa_libretin_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_activa_libretin_validate_id(var_id, var_script_case_init, do_ajax_control_activa_libretin_validate_id_cb);
  } // do_ajax_control_activa_libretin_validate_id

  function do_ajax_control_activa_libretin_validate_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_activa_libretin_validate_id_cb

  // ---------- Validate cantidad
  function do_ajax_control_activa_libretin_validate_cantidad()
  {
    var nomeCampo_cantidad = "cantidad";
    var var_cantidad = scAjaxGetFieldHidden(nomeCampo_cantidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_activa_libretin_validate_cantidad(var_cantidad, var_script_case_init, do_ajax_control_activa_libretin_validate_cantidad_cb);
  } // do_ajax_control_activa_libretin_validate_cantidad

  function do_ajax_control_activa_libretin_validate_cantidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_activa_libretin_validate_cantidad_cb

  // ---------- Validate secuencial
  function do_ajax_control_activa_libretin_validate_secuencial()
  {
    var nomeCampo_secuencial = "secuencial";
    var var_secuencial = scAjaxGetFieldText(nomeCampo_secuencial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_activa_libretin_validate_secuencial(var_secuencial, var_script_case_init, do_ajax_control_activa_libretin_validate_secuencial_cb);
  } // do_ajax_control_activa_libretin_validate_secuencial

  function do_ajax_control_activa_libretin_validate_secuencial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_activa_libretin_validate_secuencial_cb

  // ---------- Validate desde
  function do_ajax_control_activa_libretin_validate_desde()
  {
    var nomeCampo_desde = "desde";
    var var_desde = scAjaxGetFieldText(nomeCampo_desde);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_activa_libretin_validate_desde(var_desde, var_script_case_init, do_ajax_control_activa_libretin_validate_desde_cb);
  } // do_ajax_control_activa_libretin_validate_desde

  function do_ajax_control_activa_libretin_validate_desde_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "desde";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_activa_libretin_validate_desde_cb

  // ---------- Validate hasta
  function do_ajax_control_activa_libretin_validate_hasta()
  {
    var nomeCampo_hasta = "hasta";
    var var_hasta = scAjaxGetFieldText(nomeCampo_hasta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_activa_libretin_validate_hasta(var_hasta, var_script_case_init, do_ajax_control_activa_libretin_validate_hasta_cb);
  } // do_ajax_control_activa_libretin_validate_hasta

  function do_ajax_control_activa_libretin_validate_hasta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "hasta";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_activa_libretin_validate_hasta_cb

  // ---------- Event onchange secuencial
  function do_ajax_control_activa_libretin_event_secuencial_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_control_activa_libretin_event_secuencial_onchange(var_desde, var_secuencial, var_hasta, var_cantidad, var_script_case_init, do_ajax_control_activa_libretin_event_secuencial_onchange_cb);
  } // do_ajax_control_activa_libretin_event_secuencial_onchange

  function do_ajax_control_activa_libretin_event_secuencial_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "secuencial";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_control_activa_libretin_event_secuencial_onchange_cb_after_alert);
  } // do_ajax_control_activa_libretin_event_secuencial_onchange_cb
  function do_ajax_control_activa_libretin_event_secuencial_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_control_activa_libretin_event_secuencial_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_activa_libretin_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_activa_libretin_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_control_activa_libretin_submit_form(var_mensaje, var_id, var_cantidad, var_secuencial, var_desde, var_hasta, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_activa_libretin_submit_form_cb);
  } // do_ajax_control_activa_libretin_submit_form

  function do_ajax_control_activa_libretin_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_activa_libretin_submit_form_cb_after_alert);
  } // do_ajax_control_activa_libretin_submit_form_cb
  function do_ajax_control_activa_libretin_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_activa_libretin_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_activa_libretin_navigate_form()
  {
    perform_ajax_control_activa_libretin_navigate_form();
  }

  function perform_ajax_control_activa_libretin_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_activa_libretin_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_activa_libretin']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_activa_libretin_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_activa_libretin_navigate_form_cb_after_alert);
  } // do_ajax_control_activa_libretin_navigate_form_cb
  function do_ajax_control_activa_libretin_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_activa_libretin_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_activa_libretin_navigate_form_cb_after_alert

  function sc_hide_control_activa_libretin_form()
  {
