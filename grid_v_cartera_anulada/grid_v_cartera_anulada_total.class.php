...
class grid_v_cartera_anulada_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_v_cartera_anulada']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_v_cartera_anulada']['campos_busca']))
      { 
   ...
   function Calc_resumo_sc_free_group_by($destino_resumo, $res_export=false)
   {
      global $nm_lang;
      $this->nm_data = new nm_data("es");
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada']['sql_tot_res']);
      ...
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('op_fecha_baja' => "op_fecha_baja",'periodo_baja' => "periodo_baja",'mes_baja' => "mes_baja",'cl_identificacion' => "cl_identificacion",'cl_nombre' => "cl_nombre",'pro_descripcion' => "pro_descripcion",'con_ruta' => "con_ruta",'op_estado' => "op_estado",'op_asiento_anula' => "op_asiento_anula");
      $cmps_quebra_atual = array();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada']['SC_Gb_Free_cmp'] as $cmp => $resto)
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada']['arr_total'] = array();
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada']['arr_total'][$cmp_gb] = $this->$Arr_tot_name;
      }
   }
   ...
   function Res_Totaliza_sc_free_group_by($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def, $res_export)
   {
      ...
      $cmp_sql_tp_num = array('op_operacion' => 'N','periodo_emision' => 'N','periodo_consumo' => 'N','do_subtotal' => 'N','do_descuento' => 'N','do_valor_iva' => 'N','do_total' => 'N','op_propietario' => 'N','con_id' => 'N','con_ruta' => 'N','periodo_baja' => 'N');
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada']['sql_tot_res']))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada']['sql_tot_res'] = str_replace("#@#cmps_quebras#@#", "", $comando);
      }
      $comando  = str_replace("#@#cmps_quebras#@#", "," . $cmps_quebras, $comando);
      $comando .= " group by " . $cmps_quebras . " order by " .  $cmps_quebras;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada']['Res_search_metric_use']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada']['Res_search_metric_use']))
      {
          $comando = $cmd_simp;
          $cmps_S  = "";
      ...
      $format_dimensions['op_fecha_baja']['reg'] = "S";
      $format_dimensions['op_fecha_baja']['msk'] = "";
      $format_dimensions['periodo_baja']['reg'] = "S";
      $format_dimensions['periodo_baja']['msk'] = "";
      $format_dimensions['mes_baja']['reg'] = "S";
      $format_dimensions['mes_baja']['msk'] = "";
      ...
      $format_dimensions['op_asiento_anula']['reg'] = "S";
      $format_dimensions['op_asiento_anula']['msk'] = "";
      while (!$rt->EOF)
      {
          $sql_where = "";
          ...
          nmgp_Form_Num_Val($$Cada_dim, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
              ...
              if ($Cada_dim == "mes_baja") {
                  $this->Lookup->lookup_sc_free_group_by_mes_baja($$Cada_dim,  $mes_baja);
              }
   ...
   function Calc_resumo_Mensual($destino_resumo, $res_export=false)
   {
      ...
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada']['where_pesq'];
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('periodo_baja' => "periodo_baja",'mes_baja' => "mes_baja");
      $cmps_quebra_atual = array("periodo_baja","mes_baja");
      $ult_cmp_quebra_atual = $cmps_quebra_atual[(count($cmps_quebra_atual) - 1)];
      $arr_tots = "";
      $join     = "";
      $group    = "";
   ...
   function Res_Totaliza_Mensual($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def, $res_export)
   {
      ...
      while (!$rt->EOF)
      {
          ...
          nmgp_Form_Num_Val($$Cada_dim, "", ",", "0", "S", "2", "", "N:", "-") ; 
              ...
              if ($Cada_dim == "mes_baja") {
                  $this->Lookup->lookup_Mensual_mes_baja($$Cada_dim,  $mes_baja);
              }
              if (null === $$Cada_dim)
              {
                  $$Cada_dim = '';
   ...
   {
      global $nada, $nm_lang , $con_id, $con_ruta, $op_estado, $mes_baja, $mes_consumo;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(do_total), sum(do_subtotal), sum(do_valor_iva) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada']['where_pesq']; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*), sum(do_total), sum(do_subtotal), sum(do_valor_iva) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada']['where_pesq']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $rt->fields[1] = (string)$rt->fields[1]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada']['tot_geral'][2] = $rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $rt->fields[2] = (string)$rt->fields[2]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada']['tot_geral'][3] = $rt->fields[2]; 
      $rt->fields[3] = str_replace(",", ".", $rt->fields[3]);
      $rt->fields[3] = (string)$rt->fields[3]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada']['tot_geral'][4] = $rt->fields[3]; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada']['contr_total_geral'] = "OK";
   } 
   ...
   //-----  op_fecha_baja
   function quebra_op_fecha_baja_sc_free_group_by($op_fecha_baja, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb, $con_id, $con_ruta, $op_estado, $mes_baja, $mes_consumo;
      $tot_op_fecha_baja = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(do_total), sum(do_subtotal), sum(do_valor_iva) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada']['where_pesq']; 
      } 
      ...
      $tot_op_fecha_baja[0] = NM_encode_input(sc_strip_script($op_fecha_baja)) ; 
      $tot_op_fecha_baja[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_op_fecha_baja[2] = (string)$rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $tot_op_fecha_baja[3] = (string)$rt->fields[2]; 
      $rt->fields[3] = str_replace(",", ".", $rt->fields[3]);
      $tot_op_fecha_baja[4] = (string)$rt->fields[3]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_op_fecha_baja;
   } 

   //-----  periodo_baja
   function quebra_periodo_baja_sc_free_group_by($periodo_baja, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb, $con_id, $con_ruta, $op_estado, $mes_baja, $mes_consumo;
      $tot_periodo_baja = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(do_total), sum(do_subtotal), sum(do_valor_iva) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada']['where_pesq']; 
      } 
      ...
      $tot_periodo_baja[0] = NM_encode_input(sc_strip_script($periodo_baja)) ; 
      $tot_periodo_baja[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_periodo_baja[2] = (string)$rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $tot_periodo_baja[3] = (string)$rt->fields[2]; 
      $rt->fields[3] = str_replace(",", ".", $rt->fields[3]);
      $tot_periodo_baja[4] = (string)$rt->fields[3]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_periodo_baja;
   } 

   //-----  mes_baja
   function quebra_mes_baja_sc_free_group_by($mes_baja, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb, $con_id, $con_ruta, $op_estado, $mes_baja, $mes_consumo;
      $tot_mes_baja = array() ;  
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
          $tot_mes_baja[0] = NM_encode_input(sc_strip_script($mes_baja));
      }
      else {
          $tot_mes_baja[0] = sc_strip_script($mes_baja) ; 
      }
      $tot_mes_baja[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_mes_baja[2] = (string)$rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $tot_mes_baja[3] = (string)$rt->fields[2]; 
      $rt->fields[3] = str_replace(",", ".", $rt->fields[3]);
      $tot_mes_baja[4] = (string)$rt->fields[3]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_mes_baja;
   } 
   ...
   //-----  op_asiento_anula
   function quebra_op_asiento_anula_sc_free_group_by($op_asiento_anula, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb, $con_id, $con_ruta, $op_estado, $mes_baja, $mes_consumo;
      $tot_op_asiento_anula = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(do_total), sum(do_subtotal), sum(do_valor_iva) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada']['where_pesq']; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
          $tot_op_asiento_anula[0] = NM_encode_input(sc_strip_script($op_asiento_anula));
      }
      else {
          $tot_op_asiento_anula[0] = sc_strip_script($op_asiento_anula) ; 
      }
      $tot_op_asiento_anula[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_op_asiento_anula[2] = (string)$rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $tot_op_asiento_anula[3] = (string)$rt->fields[2]; 
      $rt->fields[3] = str_replace(",", ".", $rt->fields[3]);
      $tot_op_asiento_anula[4] = (string)$rt->fields[3]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_op_asiento_anula;
   } 

   //-----  periodo_baja
   function quebra_periodo_baja_Mensual($periodo_baja, $arg_sum_periodo_baja) 
   {
      global $tot_periodo_baja, $con_id, $con_ruta, $op_estado, $mes_baja, $mes_consumo;
      $tot_periodo_baja = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(do_total), sum(do_subtotal), sum(do_valor_iva) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada']['where_pesq']; 
      ...
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada']['where_pesq'])) 
      { 
         $nm_comando .= " where periodo_baja" . $arg_sum_periodo_baja ; 
      } 
      else 
      { 
         $nm_comando .= " and periodo_baja" . $arg_sum_periodo_baja ; 
      } 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = '';
      if (!$rt = $this->Db->Execute($nm_comando)) 
   ...
   //-----  mes_baja
   function quebra_mes_baja_Mensual($periodo_baja, $mes_baja, $arg_sum_periodo_baja, $arg_sum_mes_baja) 
   {
      global $tot_mes_baja, $con_id, $con_ruta, $op_estado, $mes_baja, $mes_consumo;
      $tot_mes_baja = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(do_total), sum(do_subtotal), sum(do_valor_iva) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada']['where_pesq']; 
      ...
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_anulada']['where_pesq'])) 
      { 
         $nm_comando .= " where periodo_baja" . $arg_sum_periodo_baja . " and mes_baja" . $arg_sum_mes_baja ; 
      } 
      else 
      { 
         $nm_comando .= " and periodo_baja" . $arg_sum_periodo_baja . " and mes_baja" . $arg_sum_mes_baja ; 
      } 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = '';
      if (!$rt = $this->Db->Execute($nm_comando)) 
