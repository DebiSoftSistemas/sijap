...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proforma_facturar']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proforma_facturar']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_del_proforma_facturar"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proforma_facturar']['where_detal']))
  {
?>  
...
{
   nm_field_disabled("proforma=disabled;fac_secuencial=disabled;fac_ruc_cliente=disabled;fac_nombre_cliente=disabled;fac_direccion_cliente=disabled;fac_email_cliente=disabled;prof_subtotal_facturar=disabled;prof_subtotal_iva_facturar=disabled;prof_subtotal_cero_facturar=disabled;prof_subtotal_no_objeto_facturar=disabled;prof_subtotal_excento_facturar=disabled;prof_total_descuento_facturar=disabled;prof_valor_ice_facturar=disabled;prof_valor_iva_facturar=disabled;prof_valor_irbpnr_facturar=disabled;prof_propina_facturar=disabled;prof_total_facturar=disabled;fac_cambio=disabled", "");
