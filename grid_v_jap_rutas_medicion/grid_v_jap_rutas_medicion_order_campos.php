...
<?php
   ...
   $Ord_Cmp = new grid_v_jap_rutas_medicion_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_v_jap_rutas_medicion_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_rutas_medicion']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_jap_rutas_medicion']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["rc_orden"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_rutas_medicion']['labels']["rc_orden"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_rutas_medicion']['labels']["rc_orden"] : "" . $this->Nm_lang['lang_orden_ingreso'] . "";
   $tab_ger_campos['con_nombre'] = "on";
   $tab_def_campos['con_nombre'] = "con_nombre";
   $tab_labels["con_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_rutas_medicion']['labels']["con_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_rutas_medicion']['labels']["con_nombre"] : "" . $this->Nm_lang['lang_nombre'] . "";
   $tab_ger_campos['con_cedula'] = "on";
   $tab_def_campos['con_cedula'] = "con_cedula";
   $tab_labels["con_cedula"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_rutas_medicion']['labels']["con_cedula"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_rutas_medicion']['labels']["con_cedula"] : "" . $this->Nm_lang['lang_lot_identificacion'] . "";
   $tab_ger_campos['con_numero_contrato'] = "on";
   $tab_def_campos['con_numero_contrato'] = "con_numero_contrato";
   $tab_labels["con_numero_contrato"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_rutas_medicion']['labels']["con_numero_contrato"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_rutas_medicion']['labels']["con_numero_contrato"] : "" . $this->Nm_lang['lang_numero_contrato'] . "";
   $tab_ger_campos['con_numero_medidor'] = "on";
   $tab_def_campos['con_numero_medidor'] = "con_numero_medidor";
   $tab_labels["con_numero_medidor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_rutas_medicion']['labels']["con_numero_medidor"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_rutas_medicion']['labels']["con_numero_medidor"] : "" . $this->Nm_lang['lang_numero_medidor'] . "";
   $tab_ger_campos['rc_registra_danio'] = "on";
   $tab_def_campos['rc_registra_danio'] = "rc_registra_danio";
   $tab_labels["rc_registra_danio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_rutas_medicion']['labels']["rc_registra_danio"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_rutas_medicion']['labels']["rc_registra_danio"] : "" . $this->Nm_lang['lang_registra_danio'] . "";
   $tab_ger_campos['con_numero_censo'] = "on";
   $tab_def_campos['con_numero_censo'] = "con_numero_censo";
   $tab_labels["con_numero_censo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_rutas_medicion']['labels']["con_numero_censo"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_rutas_medicion']['labels']["con_numero_censo"] : "" . $this->Nm_lang['lang_numero_censo'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_rutas_medicion']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_v_jap_rutas_medicion']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_v_jap_rutas_medicion']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_rutas_medicion']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_jap_rutas_medicion']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_v_jap_rutas_medicion']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_v_jap_rutas_medicion']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_v_jap_rutas_medicion']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_rutas_medicion']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_v_jap_rutas_medicion']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_v_jap_rutas_medicion']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_v_jap_rutas_medicion']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_v_jap_rutas_medicion_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_v_jap_rutas_medicion']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_v_jap_rutas_medicion']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_v_jap_rutas_medicion']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_v_jap_rutas_medicion']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_v_jap_rutas_medicion']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
