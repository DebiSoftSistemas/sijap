...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_resumen_compras"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_resumen_compras"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_resumen_compras']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_resumen_compras']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_resumen_compras']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_resumen_compras']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_resumen_compras']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_resumen_compras</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_resumen_compras']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_resumen_compras']['embutida_filho'] as $ind => $sc_init)
          {
