<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_v_del_datos_retencion_sri']['glo_nm_path_imag_temp'] . "/sc_apl_default_debi_doc_electronicos.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_v_del_datos_retencion_sri_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_v_del_datos_retencion_sri_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['ret_empresa'] = "on";
   $tab_def_campos['ret_empresa'] = "ret_empresa";
   $tab_labels["ret_empresa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['labels']["ret_empresa"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['labels']["ret_empresa"] : "" . $this->Nm_lang['lang_empresa'] . "";
   $tab_ger_campos['ret_fecha'] = "on";
   $tab_def_campos['ret_fecha'] = "ret_fecha";
   $tab_labels["ret_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['labels']["ret_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['labels']["ret_fecha"] : "" . $this->Nm_lang['lang_fecha'] . "";
   $tab_ger_campos['est_codigo'] = "on";
   $tab_def_campos['est_codigo'] = "est_codigo";
   $tab_labels["est_codigo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['labels']["est_codigo"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['labels']["est_codigo"] : "" . $this->Nm_lang['lang_establecimiento'] . "";
   $tab_ger_campos['pen_serie'] = "on";
   $tab_def_campos['pen_serie'] = "pen_serie";
   $tab_labels["pen_serie"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['labels']["pen_serie"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['labels']["pen_serie"] : "" . $this->Nm_lang['lang_punto_emision'] . "";
   $tab_ger_campos['ret_secuencial'] = "on";
   $tab_def_campos['ret_secuencial'] = "ret_secuencial";
   $tab_labels["ret_secuencial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['labels']["ret_secuencial"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['labels']["ret_secuencial"] : "" . $this->Nm_lang['lang_secuencial'] . "";
   $tab_ger_campos['pr_identificacion'] = "on";
   $tab_def_campos['pr_identificacion'] = "pr_identificacion";
   $tab_labels["pr_identificacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['labels']["pr_identificacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['labels']["pr_identificacion"] : "" . $this->Nm_lang['lang_lot_identificacion'] . "";
   $tab_ger_campos['pr_nombre'] = "on";
   $tab_def_campos['pr_nombre'] = "pr_nombre";
   $tab_labels["pr_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['labels']["pr_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['labels']["pr_nombre"] : "" . $this->Nm_lang['lang_proveedor'] . "";
   $tab_ger_campos['ret_estado_sri'] = "on";
   $tab_def_campos['ret_estado_sri'] = "ret_estado_sri";
   $tab_labels["ret_estado_sri"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['labels']["ret_estado_sri"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['labels']["ret_estado_sri"] : "" . $this->Nm_lang['lang_estado_sri'] . "";
   ...
   $tab_labels["pdf"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['labels']["pdf"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['labels']["pdf"] : "";
   $tab_ger_campos['xml'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['xml'] = "xml";
   }
   else
   {
       $tab_def_campos['xml'] = "";
   }
   $tab_labels["xml"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['labels']["xml"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['labels']["xml"] : "";
   $tab_ger_campos['autorizar'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['autorizar'] = "autorizar";
   }
   else
   {
       $tab_def_campos['autorizar'] = "";
   }
   $tab_labels["autorizar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['labels']["autorizar"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['labels']["autorizar"] : "";
   $tab_ger_campos['pdf'] = "none";
   $tab_ger_campos['xml'] = "none";
   $tab_ger_campos['autorizar'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> v_del_datos_retencion_sri</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_v_del_datos_retencion_sri_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_v_del_datos_retencion_sri']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
