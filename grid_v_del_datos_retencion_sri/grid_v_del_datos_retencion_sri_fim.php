...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_v_del_datos_retencion_sri"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_v_del_datos_retencion_sri"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_v_del_datos_retencion_sri']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_v_del_datos_retencion_sri']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_v_del_datos_retencion_sri']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_v_del_datos_retencion_sri']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_v_del_datos_retencion_sri']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_v_del_datos_retencion_sri</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_v_del_datos_retencion_sri']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_v_del_datos_retencion_sri']['embutida_filho'] as $ind => $sc_init)
          {
