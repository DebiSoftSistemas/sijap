...
class grid_v_del_datos_retencion_sri_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_v_del_datos_retencion_sri_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_v_del_datos_retencion_sri_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_v_del_datos_retencion_sri_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_ret_tipo_comprobante')
      {
          $ret_tipo_comprobante = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_ret_tipo_comprobante($ret_tipo_comprobante);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$campo_join]);
              return;
          }
         $nm_ini_lower = "";
         $nm_fim_lower = "";
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         $nome_sum = "v_del_datos_retencion_sri.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> v_del_datos_retencion_sri</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_v_del_datos_retencion_sri/grid_v_del_datos_retencion_sri_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_v_del_datos_retencion_sri_ajax_search.js"></script>
 <script type="text/javascript" src="grid_v_del_datos_retencion_sri_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_v_del_datos_retencion_sri_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_v_del_datos_retencion_sri']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_v_del_datos_retencion_sri']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_ret_numero_cond#NMF#' + search_get_sel_txt('SC_ret_numero_cond') + '@NMF@';
  str_out += 'SC_ret_numero#NMF#' + search_get_text('SC_ret_numero') + '@NMF@';
  str_out += 'SC_ret_ambiente_cond#NMF#' + search_get_sel_txt('SC_ret_ambiente_cond') + '@NMF@';
  str_out += 'SC_ret_ambiente#NMF#' + search_get_text('SC_ret_ambiente') + '@NMF@';
  str_out += 'SC_ret_tipo_comprobante_cond#NMF#' + search_get_sel_txt('SC_ret_tipo_comprobante_cond') + '@NMF@';
  str_out += 'SC_ret_tipo_comprobante#NMF#' + search_get_text('SC_ret_tipo_comprobante') + '@NMF@';
  str_out += 'id_ac_ret_tipo_comprobante#NMF#' + search_get_title('select2-id_ac_ret_tipo_comprobante-container') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-ret_tipo_comprobante").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_ret_tipo_comprobante",
      max_itens: "10",
   ...
   $("#SC_ret_tipo_comprobante").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $ret_numero_cond, $ret_numero,
             $ret_ambiente_cond, $ret_ambiente,
             $ret_tipo_comprobante_cond, $ret_tipo_comprobante, $ret_tipo_comprobante_autocomp,
             $fecha_cond, $fecha,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $ret_numero = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['campos_busca']['ret_numero']; 
          $ret_numero_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['campos_busca']['ret_numero_cond']; 
          $ret_ambiente = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['campos_busca']['ret_ambiente']; 
          $ret_ambiente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['campos_busca']['ret_ambiente_cond']; 
          $ret_tipo_comprobante = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['campos_busca']['ret_tipo_comprobante']; 
          $ret_tipo_comprobante_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['campos_busca']['ret_tipo_comprobante_cond']; 
          $fecha = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['campos_busca']['fecha']; 
          $fecha_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['campos_busca']['fecha_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['campos_busca']['NM_operador']; 
          if (strtoupper($ret_numero_cond) != "II" && strtoupper($ret_numero_cond) != "QP" && strtoupper($ret_numero_cond) != "NP" && strtoupper($ret_numero_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($ret_numero, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($ret_ambiente_cond) != "II" && strtoupper($ret_ambiente_cond) != "QP" && strtoupper($ret_ambiente_cond) != "NP" && strtoupper($ret_ambiente_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($ret_ambiente, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($ret_numero_cond) || empty($ret_numero_cond))
      {
         $ret_numero_cond = "gt";
      }
      if (!isset($ret_ambiente_cond) || empty($ret_ambiente_cond))
      {
         $ret_ambiente_cond = "gt";
      }
      if (!isset($ret_tipo_comprobante_cond) || empty($ret_tipo_comprobante_cond))
      {
         $ret_tipo_comprobante_cond = "qp";
      }
      ...
      $str_hide_ret_numero = (in_array($ret_numero_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_ret_ambiente = (in_array($ret_ambiente_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_ret_tipo_comprobante = (in_array($ret_tipo_comprobante_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_fecha = (in_array($fecha_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($ret_numero) || $ret_numero == "")
      {
          $ret_numero = "";
      }
      if (isset($ret_numero) && !empty($ret_numero))
      {
         $tmp_pos = (is_string($ret_numero)) ? strpos($ret_numero, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $ret_numero = substr($ret_numero, 0, $tmp_pos);
         }
      }
      if (!isset($ret_ambiente) || $ret_ambiente == "")
      {
          $ret_ambiente = "";
      }
      if (isset($ret_ambiente) && !empty($ret_ambiente))
      {
         $tmp_pos = (is_string($ret_ambiente)) ? strpos($ret_ambiente, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $ret_ambiente = substr($ret_ambiente, 0, $tmp_pos);
         }
      }
      if (!isset($ret_tipo_comprobante) || $ret_tipo_comprobante == "")
      {
          $ret_tipo_comprobante = "";
      }
      if (isset($ret_tipo_comprobante) && !empty($ret_tipo_comprobante))
      {
         $tmp_pos = (is_string($ret_tipo_comprobante)) ? strpos($ret_tipo_comprobante, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $ret_tipo_comprobante = substr($ret_tipo_comprobante, 0, $tmp_pos);
         }
      }
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_ret_numero_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['ret_numero'])) ? $this->New_label['ret_numero'] : "Ret Numero"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_ret_numero_cond" name="ret_numero_cond" onChange="nm_campos_between(document.getElementById('id_vis_ret_numero'), this, 'ret_numero')">
       <OPTION value="gt" <?php if ("gt" == $ret_numero_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $ret_numero_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $ret_numero_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_ret_numero" <?php echo $str_hide_ret_numero?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['ret_numero'])) ? $this->New_label['ret_numero'] : "Ret Numero";
 $nmgp_tab_label .= "ret_numero?#?" . $SC_Label . "?@?";
...
?>
<INPUT  type="text" id="SC_ret_numero" name="ret_numero" value="<?php echo NM_encode_input($ret_numero) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_ret_ambiente_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['ret_ambiente'])) ? $this->New_label['ret_ambiente'] : "Ret Ambiente"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_ret_ambiente_cond" name="ret_ambiente_cond" onChange="nm_campos_between(document.getElementById('id_vis_ret_ambiente'), this, 'ret_ambiente')">
       <OPTION value="gt" <?php if ("gt" == $ret_ambiente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $ret_ambiente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $ret_ambiente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_ret_ambiente" <?php echo $str_hide_ret_ambiente?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['ret_ambiente'])) ? $this->New_label['ret_ambiente'] : "Ret Ambiente";
 $nmgp_tab_label .= "ret_ambiente?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_ret_ambiente" name="ret_ambiente" value="<?php echo NM_encode_input($ret_ambiente) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_ret_tipo_comprobante_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['ret_tipo_comprobante'])) ? $this->New_label['ret_tipo_comprobante'] : "Ret Tipo Comprobante"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_ret_tipo_comprobante_cond" name="ret_tipo_comprobante_cond" onChange="nm_campos_between(document.getElementById('id_vis_ret_tipo_comprobante'), this, 'ret_tipo_comprobante')">
       <OPTION value="qp" <?php if ("qp" == $ret_tipo_comprobante_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $ret_tipo_comprobante_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $ret_tipo_comprobante_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $ret_tipo_comprobante_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_ret_tipo_comprobante" <?php echo $str_hide_ret_tipo_comprobante?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['ret_tipo_comprobante'])) ? $this->New_label['ret_tipo_comprobante'] : "Ret Tipo Comprobante";
 $nmgp_tab_label .= "ret_tipo_comprobante?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $ret_tipo_comprobante;
      }
?>
<INPUT  type="text" id="SC_ret_tipo_comprobante" name="ret_tipo_comprobante" value="<?php echo NM_encode_input($ret_tipo_comprobante) ?>"  size=2 alt="{datatype: 'text', maxLength: 2, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-ret_tipo_comprobante" id="id_ac_ret_tipo_comprobante" name="ret_tipo_comprobante_autocomp"><?php if ('' !=  $ret_tipo_comprobante) { ?><option value="<?php echo $ret_tipo_comprobante ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
...
?>
<INPUT  type="text" id="SC_fecha" name="fecha" value="<?php echo NM_encode_input($fecha) ?>" size="50" maxlength="32767" class="scFilterObjectEven">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_v_del_datos_retencion_sri_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_v_del_datos_retencion_sri']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_v_del_datos_retencion_sri']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.ret_numero_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_ret_numero'), document.F1.ret_numero_cond, 'ret_numero');
   document.F1.ret_numero.value = "";
   document.F1.ret_ambiente_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_ret_ambiente'), document.F1.ret_ambiente_cond, 'ret_ambiente');
   document.F1.ret_ambiente.value = "";
   document.F1.ret_tipo_comprobante_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_ret_tipo_comprobante'), document.F1.ret_tipo_comprobante_cond, 'ret_tipo_comprobante');
   document.F1.ret_tipo_comprobante.value = "";
   document.F1.ret_tipo_comprobante_autocomp.value = "";
   $('#select2-id_ac_ret_tipo_comprobante-container').html('<?php echo $this->Val_init_ret_tipo_comprobante['desc'] ?>');;
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_v_del_datos_retencion_sri/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_ret_numero_cond'] = 'cond';
      $tp_fields['SC_ret_numero'] = 'text';
      $tp_fields['SC_ret_ambiente_cond'] = 'cond';
      $tp_fields['SC_ret_ambiente'] = 'text';
      $tp_fields['SC_ret_tipo_comprobante_cond'] = 'cond';
      $tp_fields['SC_ret_tipo_comprobante'] = 'text_aut';
      $tp_fields['id_ac_ret_tipo_comprobante'] = 'select2_aut';
      $tp_fields['SC_fecha_cond'] = 'cond';
      $tp_fields['SC_fecha'] = 'text';
   ...
   {
      global $ret_numero_cond, $ret_numero,
             $ret_ambiente_cond, $ret_ambiente,
             $ret_tipo_comprobante_cond, $ret_tipo_comprobante, $ret_tipo_comprobante_autocomp,
             $fecha_cond, $fecha, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($ret_tipo_comprobante_autocomp) && empty($ret_tipo_comprobante))
      {
          $ret_tipo_comprobante = $ret_tipo_comprobante_autocomp;
      }
      $ret_numero_cond_salva = $ret_numero_cond; 
      if (!isset($ret_numero_input_2) || $ret_numero_input_2 == "")
      {
          $ret_numero_input_2 = $ret_numero;
      }
      $ret_ambiente_cond_salva = $ret_ambiente_cond; 
      if (!isset($ret_ambiente_input_2) || $ret_ambiente_input_2 == "")
      {
          $ret_ambiente_input_2 = $ret_ambiente;
      }
      $ret_tipo_comprobante_cond_salva = $ret_tipo_comprobante_cond; 
      if (!isset($ret_tipo_comprobante_input_2) || $ret_tipo_comprobante_input_2 == "")
      {
          $ret_tipo_comprobante_input_2 = $ret_tipo_comprobante;
      }
      ...
      if ($ret_numero_cond != "in")
      {
          nm_limpa_numero($ret_numero, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($ret_ambiente_cond != "in")
      {
          nm_limpa_numero($ret_ambiente, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['campos_busca']['ret_numero'] = $ret_numero; 
      if (is_array($ret_numero) && !empty($ret_numero))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['Grid_search'][$I_Grid]['val'][0] = $ret_numero;
      }
      elseif ($ret_numero_cond_salva == "nu" || $ret_numero_cond_salva == "nn" || $ret_numero_cond_salva == "ep" || $ret_numero_cond_salva == "ne" || !empty($ret_numero))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['Grid_search'][$I_Grid]['val'][0][0] = $ret_numero;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['campos_busca']['ret_numero_cond'] = $ret_numero_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['Grid_search'][$I_Grid]['cmp'] = "ret_numero"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['Grid_search'][$I_Grid]['opc'] = $ret_numero_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq']['ret_numero'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['campos_busca']['ret_ambiente'] = $ret_ambiente; 
      if (is_array($ret_ambiente) && !empty($ret_ambiente))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['Grid_search'][$I_Grid]['val'][0] = $ret_ambiente;
      }
      elseif ($ret_ambiente_cond_salva == "nu" || $ret_ambiente_cond_salva == "nn" || $ret_ambiente_cond_salva == "ep" || $ret_ambiente_cond_salva == "ne" || !empty($ret_ambiente))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['Grid_search'][$I_Grid]['val'][0][0] = $ret_ambiente;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['campos_busca']['ret_ambiente_cond'] = $ret_ambiente_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['Grid_search'][$I_Grid]['cmp'] = "ret_ambiente"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['Grid_search'][$I_Grid]['opc'] = $ret_ambiente_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq']['ret_ambiente'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['campos_busca']['ret_tipo_comprobante'] = $ret_tipo_comprobante; 
      if (is_array($ret_tipo_comprobante) && !empty($ret_tipo_comprobante))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['Grid_search'][$I_Grid]['val'][0] = $ret_tipo_comprobante;
      }
      elseif ($ret_tipo_comprobante_cond_salva == "nu" || $ret_tipo_comprobante_cond_salva == "nn" || $ret_tipo_comprobante_cond_salva == "ep" || $ret_tipo_comprobante_cond_salva == "ne" || !empty($ret_tipo_comprobante))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['Grid_search'][$I_Grid]['val'][0][0] = $ret_tipo_comprobante;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['campos_busca']['ret_tipo_comprobante_cond'] = $ret_tipo_comprobante_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['Grid_search'][$I_Grid]['cmp'] = "ret_tipo_comprobante"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['Grid_search'][$I_Grid]['opc'] = $ret_tipo_comprobante_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq']['ret_tipo_comprobante'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['campos_busca']['fecha'] = $fecha; 
      if (is_array($fecha) && !empty($fecha))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['Grid_search'][$I_Grid]['val'][0] = $fecha;
      }
      elseif ($fecha_cond_salva == "nu" || $fecha_cond_salva == "nn" || $fecha_cond_salva == "ep" || $fecha_cond_salva == "ne" || !empty($fecha))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['Grid_search'][$I_Grid]['val'][0][0] = $fecha;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['campos_busca']['fecha_cond'] = $fecha_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['Grid_search'][$I_Grid]['cmp'] = "fecha"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['Grid_search'][$I_Grid]['opc'] = $fecha_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['grid_pesq']['fecha'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $this->cmp_formatado['ret_numero'] = $Conteudo;
      $Conteudo = $ret_ambiente;
      if (strtoupper($ret_ambiente_cond) != "II" && strtoupper($ret_ambiente_cond) != "QP" && strtoupper($ret_ambiente_cond) != "NP" && strtoupper($ret_ambiente_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['ret_ambiente'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($ret_tipo_comprobante != '') {
      $ret_tipo_comprobante_look = (is_string($ret_tipo_comprobante) ? substr($this->Db->qstr($ret_tipo_comprobante), 1, -1) : $ret_tipo_comprobante); 
      $nmgp_def_dados = array(); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['ret_tipo_comprobante'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['ret_tipo_comprobante'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['ret_tipo_comprobante'] = $ret_tipo_comprobante;
      }
      $Conteudo = $fecha;
      ...
      if (isset($ret_numero) || $ret_numero_cond == "nu" || $ret_numero_cond == "nn" || $ret_numero_cond == "ep" || $ret_numero_cond == "ne")
      {
         $this->monta_condicao("ret_numero", $ret_numero_cond, $ret_numero, "", "ret_numero", "INT4", false);
      }

      //----- $ret_ambiente
      $this->Date_part = false;
      if (isset($ret_ambiente) || $ret_ambiente_cond == "nu" || $ret_ambiente_cond == "nn" || $ret_ambiente_cond == "ep" || $ret_ambiente_cond == "ne")
      {
         $this->monta_condicao("ret_ambiente", $ret_ambiente_cond, $ret_ambiente, "", "ret_ambiente", "INT4", false);
      }

      //----- $ret_tipo_comprobante
      $this->Date_part = false;
      if (isset($ret_tipo_comprobante) || $ret_tipo_comprobante_cond == "nu" || $ret_tipo_comprobante_cond == "nn" || $ret_tipo_comprobante_cond == "ep" || $ret_tipo_comprobante_cond == "ne")
      {
         $this->monta_condicao("ret_tipo_comprobante", $ret_tipo_comprobante_cond, $ret_tipo_comprobante, "", "ret_tipo_comprobante", "VARCHAR", false);
      }
      ...
      {
         $this->monta_condicao("fecha", $fecha_cond, $fecha, "", "fecha", "TEXT", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
    $this->Sel_case_sensitive($this->comando);
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_datos_retencion_sri']['cond_pesq'] .= $this->NM_operador;
