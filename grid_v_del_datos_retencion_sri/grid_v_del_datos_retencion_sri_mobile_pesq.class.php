...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "ret_fecha";$Nm_numeric[] = "ret_numero";$Nm_numeric[] = "ret_ambiente";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_ret_numero_cond" name="ret_numero_cond" onChange="nm_campos_between(document.getElementById('id_vis_ret_numero'), this, 'ret_numero')">
      ...
      <br><span id="id_hide_ret_numero"  <?php echo $str_hide_ret_numero?>><INPUT  type="text" id="SC_ret_numero" name="ret_numero" value="<?php echo NM_encode_input($ret_numero) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_ret_ambiente_cond" name="ret_ambiente_cond" onChange="nm_campos_between(document.getElementById('id_vis_ret_ambiente'), this, 'ret_ambiente')">
      ...
      <br><span id="id_hide_ret_ambiente"  <?php echo $str_hide_ret_ambiente?>><INPUT  type="text" id="SC_ret_ambiente" name="ret_ambiente" value="<?php echo NM_encode_input($ret_ambiente) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_ret_tipo_comprobante_cond" name="ret_tipo_comprobante_cond" onChange="nm_campos_between(document.getElementById('id_vis_ret_tipo_comprobante'), this, 'ret_tipo_comprobante')">
      ...
      <br><span id="id_hide_ret_tipo_comprobante"  <?php echo $str_hide_ret_tipo_comprobante?>><?php
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      <br><span id="id_hide_fecha"  <?php echo $str_hide_fecha?>><INPUT  type="text" id="SC_fecha" name="fecha" value="<?php echo NM_encode_input($fecha) ?>" size="50" maxlength="32767" class="scFilterObjectEven">
 </TD>
