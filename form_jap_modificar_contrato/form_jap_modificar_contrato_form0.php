...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_jap_modificar_contrato/form_jap_modificar_contrato_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_jap_modificar_contrato_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['link_info']['remove_border']) {
...
<?php
 include_once("form_jap_modificar_contrato_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_jap_modificar_contrato'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_jap_modificar_contrato'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-1';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_disabled']['actualizar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_disabled']['actualizar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_label']['actualizar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_label']['actualizar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_label']['actualizar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_disabled']['']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_disabled']['']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_label']['']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_label']['']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_label'][''];
        }
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_disabled']['btnimprimir']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_disabled']['btnimprimir']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_label']['btnimprimir']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_label']['btnimprimir']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_label']['btnimprimir'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_disabled']['modificar_cliente']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_disabled']['modificar_cliente']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_label']['modificar_cliente']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_label']['modificar_cliente']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_label']['modificar_cliente'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_disabled']['historial']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_disabled']['historial']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_label']['historial']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_label']['historial']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_label']['historial'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_disabled']['ver_contratos']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_disabled']['ver_contratos']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_label']['ver_contratos']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_label']['ver_contratos']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['btn_label']['ver_contratos'];
        }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_sino_line" id="hidden_field_data_con_sino" style="<?php echo $sStyleHidden_con_sino; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_sino_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_numero_contrato_line" id="hidden_field_data_con_numero_contrato" style="<?php echo $sStyleHidden_con_numero_contrato; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_numero_contrato_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_con_propietario_label" id="hidden_field_label_con_propietario" style="<?php echo $sStyleHidden_con_propietario; ?>"><span id="id_label_con_propietario"><?php echo $this->nm_new_label['con_propietario']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['php_cmp_required']['con_propietario']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['php_cmp_required']['con_propietario'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_estado_line" id="hidden_field_data_con_estado" style="<?php echo $sStyleHidden_con_estado; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_estado_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_con_pais_label" id="hidden_field_label_con_pais" style="<?php echo $sStyleHidden_con_pais; ?>"><span id="id_label_con_pais"><?php echo $this->nm_new_label['con_pais']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['php_cmp_required']['con_pais']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['php_cmp_required']['con_pais'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_con_provincia_label" id="hidden_field_label_con_provincia" style="<?php echo $sStyleHidden_con_provincia; ?>"><span id="id_label_con_provincia"><?php echo $this->nm_new_label['con_provincia']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['php_cmp_required']['con_provincia']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['php_cmp_required']['con_provincia'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_con_canton_label" id="hidden_field_label_con_canton" style="<?php echo $sStyleHidden_con_canton; ?>"><span id="id_label_con_canton"><?php echo $this->nm_new_label['con_canton']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['php_cmp_required']['con_canton']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['php_cmp_required']['con_canton'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_con_parroquia_label" id="hidden_field_label_con_parroquia" style="<?php echo $sStyleHidden_con_parroquia; ?>"><span id="id_label_con_parroquia"><?php echo $this->nm_new_label['con_parroquia']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['php_cmp_required']['con_parroquia']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['php_cmp_required']['con_parroquia'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_con_toma_administrativa_label" id="hidden_field_label_con_toma_administrativa" style="<?php echo $sStyleHidden_con_toma_administrativa; ?>"><span id="id_label_con_toma_administrativa"><?php echo $this->nm_new_label['con_toma_administrativa']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['php_cmp_required']['con_toma_administrativa']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['php_cmp_required']['con_toma_administrativa'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_con_toma_operativa_label" id="hidden_field_label_con_toma_operativa" style="<?php echo $sStyleHidden_con_toma_operativa; ?>"><span id="id_label_con_toma_operativa"><?php echo $this->nm_new_label['con_toma_operativa']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['php_cmp_required']['con_toma_operativa']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['php_cmp_required']['con_toma_operativa'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_con_tipo_servicio_label" id="hidden_field_label_con_tipo_servicio" style="<?php echo $sStyleHidden_con_tipo_servicio; ?>"><span id="id_label_con_tipo_servicio"><?php echo $this->nm_new_label['con_tipo_servicio']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['php_cmp_required']['con_tipo_servicio']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['php_cmp_required']['con_tipo_servicio'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_con_condicion_contrato_label" id="hidden_field_label_con_condicion_contrato" style="<?php echo $sStyleHidden_con_condicion_contrato; ?>"><span id="id_label_con_condicion_contrato"><?php echo $this->nm_new_label['con_condicion_contrato']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['php_cmp_required']['con_condicion_contrato']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['php_cmp_required']['con_condicion_contrato'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_materiales'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_materiales'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['form_jap_materiales_contrato_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_materiales'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['form_jap_materiales_contrato_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['form_jap_materiales_contrato_script_case_init'] ]['form_jap_materiales_contrato']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['form_jap_materiales_contrato_script_case_init'] ]['form_jap_materiales_contrato']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['form_jap_materiales_contrato_script_case_init'] ]['form_jap_materiales_contrato']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['form_jap_materiales_contrato_script_case_init'] ]['form_jap_materiales_contrato']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['form_jap_materiales_contrato_script_case_init'] ]['form_jap_materiales_contrato']['embutida_liga_form_insert'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['form_jap_materiales_contrato_script_case_init'] ]['form_jap_materiales_contrato']['embutida_liga_form_update'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['form_jap_materiales_contrato_script_case_init'] ]['form_jap_materiales_contrato']['embutida_liga_form_delete'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['form_jap_materiales_contrato_script_case_init'] ]['form_jap_materiales_contrato']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['form_jap_materiales_contrato_script_case_init'] ]['form_jap_materiales_contrato']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['form_jap_materiales_contrato_script_case_init'] ]['form_jap_materiales_contrato']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['form_jap_materiales_contrato_script_case_init'] ]['form_jap_materiales_contrato']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['form_jap_materiales_contrato_script_case_init'] ]['form_jap_materiales_contrato']['embutida_liga_tp_pag'] = 'total';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['form_jap_materiales_contrato_script_case_init'] ]['form_jap_materiales_contrato']['embutida_parms'] = "NM_btn_insert*scinN*scoutNM_btn_update*scinN*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinN*scout";
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['form_jap_materiales_contrato_script_case_init'] ]['form_jap_modificar_contrato']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_jap_modificar_contrato_empty.htm' : $this->Ini->link_form_jap_materiales_contrato_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y&sc_ifr_height=300';
if (isset($this->Ini->sc_lig_target['C_@scinf_materiales']) && 'nmsc_iframe_liga_form_jap_materiales_contrato' != $this->Ini->sc_lig_target['C_@scinf_materiales'])
{
    ...
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_materiales'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['form_jap_materiales_contrato_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_rubros'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_rubros'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['grid_jap_rubro_contrato_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_rubros'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['grid_jap_rubro_contrato_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 if (isset($this->Ini->sc_lig_md5["grid_jap_rubro_contrato"]) && $this->Ini->sc_lig_md5["grid_jap_rubro_contrato"] == "S") {
     ...
     $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_jap_modificar_contrato@SC_par@" . md5($Parms_Lig);
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
 } else {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_jap_modificar_contrato_empty.htm' : $this->Ini->link_grid_jap_rubro_contrato_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y&sc_ifr_height=300' . $parms_lig_cons;
if (isset($this->Ini->sc_lig_target['C_@scinf_rubros']) && 'nmsc_iframe_liga_grid_jap_rubro_contrato' != $this->Ini->sc_lig_target['C_@scinf_rubros'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_rubros'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['grid_jap_rubro_contrato_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_abono_line" id="hidden_field_data_con_abono" style="<?php echo $sStyleHidden_con_abono; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%;float:right"><tr><td  class="scFormDataFontOdd css_con_abono_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_con_abono_label" style=""><span id="id_label_con_abono"><?php echo $this->nm_new_label['con_abono']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_plazo_line" id="hidden_field_data_con_plazo" style="<?php echo $sStyleHidden_con_plazo; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%;float:right"><tr><td  class="scFormDataFontOdd css_con_plazo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_con_plazo_label" style=""><span id="id_label_con_plazo"><?php echo $this->nm_new_label['con_plazo']; ?></span></span><br>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_cuotas'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_cuotas'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['grid_jap_cuotas_contrato_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_cuotas'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['grid_jap_cuotas_contrato_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 $parms_lig_cons = "&nmgp_parms=" . $Md5_Lig;
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_jap_modificar_contrato_empty.htm' : $this->Ini->link_grid_jap_cuotas_contrato_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y&sc_ifr_height=300' . $parms_lig_cons;
if (isset($this->Ini->sc_lig_target['C_@scinf_cuotas']) && 'nmsc_iframe_liga_grid_jap_cuotas_contrato' != $this->Ini->sc_lig_target['C_@scinf_cuotas'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_cuotas'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['grid_jap_cuotas_contrato_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_jap_modificar_contrato");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_jap_modificar_contrato");
 parent.scAjaxDetailHeight("form_jap_modificar_contrato", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
