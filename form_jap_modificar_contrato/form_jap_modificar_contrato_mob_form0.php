...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_jap_modificar_contrato/form_jap_modificar_contrato_mob_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_jap_modificar_contrato_mob_jquery.php');
 ...
 function toggleBlock(e) {
  ...
  if (show_block[block_id]) {
    ...
    if ("hidden_bloco_6" == block_id) {
      scAjaxDetailHeight("grid_jap_rubro_contrato", "300");
    }
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['link_info']['remove_border']) {
...
if (isset($_SESSION['scriptcase']['form_jap_modificar_contrato']['error_buffer']) && '' != $_SESSION['scriptcase']['form_jap_modificar_contrato']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_jap_modificar_contrato']['error_buffer'];
}
...
<?php
 include_once("form_jap_modificar_contrato_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_jap_modificar_contrato_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_jap_modificar_contrato_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_jap_modificar_contrato_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-13';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_disabled']['actualizar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_disabled']['actualizar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_label']['actualizar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_label']['actualizar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_label']['actualizar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_disabled']['']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_disabled']['']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_label']['']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_label']['']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_label'][''];
        }
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_disabled']['btnimprimir']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_disabled']['btnimprimir']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_label']['btnimprimir']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_label']['btnimprimir']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_label']['btnimprimir'];
        }
?>
...
<?php
    if ($opcao_botoes != "novo") {
        $sCondStyle = ($this->nmgp_botoes['modificar_cliente'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = '';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_disabled']['modificar_cliente']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_disabled']['modificar_cliente']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_label']['modificar_cliente']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_label']['modificar_cliente']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_label']['modificar_cliente'];
        }
?>
<?php echo nmButtonOutput($this->arr_buttons, "modificar_cliente", "scBtnFn_modificar_cliente()", "scBtnFn_modificar_cliente()", "sc_modificar_cliente_top", "", "" . $buttonMacroLabel . "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "" . $buttonMacroDisabled . "", "", "");?>
 
<?php
        $NM_btn = true;
    }
    if ($opcao_botoes != "novo") {
        $sCondStyle = ($this->nmgp_botoes['historial'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = '';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_disabled']['historial']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_disabled']['historial']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_label']['historial']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_label']['historial']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_label']['historial'];
        }
?>
<?php echo nmButtonOutput($this->arr_buttons, "historial", "scBtnFn_historial()", "scBtnFn_historial()", "sc_historial_top", "", "" . $buttonMacroLabel . "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "" . $buttonMacroDisabled . "", "", "");?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_disabled']['ver_contratos']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_disabled']['ver_contratos']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_label']['ver_contratos']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_label']['ver_contratos']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['btn_label']['ver_contratos'];
        }
?>
   ...
   <tr>
    ...
    <TD colspan="1" height="20" class="scFormBlock">
     <TABLE style="padding: 0px; spacing: 0px; border-width: 0px;" width="100%" height="100%">
      <TR>
       <TD align="" valign="" class="scFormBlockFont"><?php if ('' != $this->Ini->Block_img_exp && '' != $this->Ini->Block_img_col && !$this->Ini->Export_img_zip) { echo "<table style=\"border-collapse: collapse; height: 100%; width: 100%\"><tr><td style=\"vertical-align: middle; border-width: 0px; padding: 0px 2px 0px 0px\"><img id=\"SC_blk_pdf0\" src=\"" . $this->Ini->path_icones . "/" . $this->Ini->Block_img_col . "\" style=\"border: 0px; float: left\" class=\"sc-ui-block-control\"></td><td style=\"border-width: 0px; padding: 0px; width: 100%;\" class=\"scFormBlockAlign\">"; } ?><?php echo $this->Ini->Nm_lang['lang_motivo_cambio'] ?><?php if ('' != $this->Ini->Block_img_exp && '' != $this->Ini->Block_img_col && !$this->Ini->Export_img_zip) { echo "</td></tr></table>"; } ?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_numero_contrato_line" id="hidden_field_data_con_numero_contrato" style="<?php echo $sStyleHidden_con_numero_contrato; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_numero_contrato_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_con_numero_contrato_label" style=""><span id="id_label_con_numero_contrato"><?php echo $this->nm_new_label['con_numero_contrato']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["con_numero_contrato"]) &&  $this->nmgp_cmp_readonly["con_numero_contrato"] == "on") { 

 ?>
<input type="hidden" name="con_numero_contrato" value="<?php echo $this->form_encode_input($con_numero_contrato) . "\">" . $con_numero_contrato . ""; ?>
<?php } else { ?>
<span id="id_read_on_con_numero_contrato" class="sc-ui-readonly-con_numero_contrato css_con_numero_contrato_line" style="<?php echo $sStyleReadLab_con_numero_contrato; ?>"><?php echo $this->form_format_readonly("con_numero_contrato", $this->form_encode_input($this->con_numero_contrato)); ?></span><span id="id_read_off_con_numero_contrato" class="css_read_off_con_numero_contrato<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_con_numero_contrato; ?>">
 <input class="sc-js-input scFormObjectOdd css_con_numero_contrato_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_con_numero_contrato" type=text name="con_numero_contrato" value="<?php echo $this->form_encode_input($con_numero_contrato) ?>"
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=25"; } ?> maxlength=255 alt="{datatype: 'text', maxLength: 255, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: 'upper', enterTab: false, enterSubmit: false, autoTab: true, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
else
{
   ...
   while (!empty($todo[$x])) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
          if ($cadaselect[1] == "@ ") {$cadaselect[1]= trim($cadaselect[1]); } ; 
          if (isset($this->Embutida_ronly) && $this->Embutida_ronly && isset($this->con_estado_1))
          {
              foreach ($this->con_estado_1 as $tmp_con_estado)
              {
                  if (trim($tmp_con_estado) === trim($cadaselect[1])) {$con_estado_look .= $cadaselect[0] . '__SC_BREAK_LINE__';}
              }
          }
          elseif (isset($cadaselect[1]) && is_string($this->con_estado) && trim($this->con_estado) === trim($cadaselect[1])) {$con_estado_look .= $cadaselect[0];} 
          $x++; 
   }

?>
<input type="hidden" name="con_estado" value="<?php echo $this->form_encode_input($con_estado) . "\">" . $con_estado_look . ""; ?>
<?php } else { ?>
<?php
   $todo = $this->Form_lookup_con_estado();
   $x = 0 ; 
   $con_estado_look = ""; 
   while (!empty($todo[$x])) 
   {
          ...
          if (empty($con_estado_look))
          {
              $con_estado_look = $this->con_estado;
          }
   $x = 0; 
   echo "<span id=\"id_read_on_con_estado\" class=\"css_con_estado_line\" style=\"" .  $sStyleReadLab_con_estado . "\">" . $this->form_format_readonly("con_estado", $this->form_encode_input($con_estado_look)) . "</span><span id=\"id_read_off_con_estado\" class=\"css_read_off_con_estado" . $this->classes_100perc_fields['span_input'] . "\" style=\"white-space: nowrap; " . $sStyleReadInp_con_estado . "\">";
   echo " <span id=\"idAjaxSelect_con_estado\" class=\"" . $this->classes_100perc_fields['span_select'] . "\"><select class=\"sc-js-input scFormObjectOdd css_con_estado_obj" . $this->classes_100perc_fields['input'] . "\" style=\"\" id=\"id_sc_field_con_estado\" name=\"con_estado\" size=\"1\" alt=\"{type: 'select', enterTab: false}\">" ; 
   echo "\r" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
          if ($cadaselect[1] == "@ ") {$cadaselect[1]= trim($cadaselect[1]); } ; 
          echo "  <option value=\"$cadaselect[1]\"" ; 
          if (trim($this->con_estado) === trim($cadaselect[1])) 
          {
              echo " selected" ; 
          }
          if (strtoupper($cadaselect[2]) == "S") 
          {
              if (empty($this->con_estado)) 
              {
                  echo " selected" ;
              } 
           } 
...
?> 
<?php  }?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_con_estado_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_con_estado_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_con_usuario_instala_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_con_usuario_instala_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php $sStyleHidden_con_observaciones_dumb = ('' == $sStyleHidden_con_observaciones) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_con_observaciones_dumb" style="<?php echo $sStyleHidden_con_observaciones_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php if ($sc_hidden_no > 0) { echo "<tr style=\"display: none;\">"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['materiales'] = "materiales";
    }
?>
<?php
   $nm_cor_fun_cel  = (isset($nm_cor_fun_cel) && $nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_materiales'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_materiales'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_materiales'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['embutida_liga_form_insert'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['embutida_liga_form_update'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['embutida_liga_form_delete'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['embutida_liga_tp_pag'] = 'total';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['embutida_parms'] = "NM_btn_insert*scinN*scoutNM_btn_update*scinN*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinN*scout";
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_modificar_contrato_mob']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_jap_modificar_contrato_mob_empty.htm' : $this->Ini->link_form_jap_materiales_contrato_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y&sc_ifr_height=300';
...
if (isset($this->Ini->sc_lig_target['C_@scinf_materiales']) && 'nmsc_iframe_liga_form_jap_materiales_contrato_mob' != $this->Ini->sc_lig_target['C_@scinf_materiales'])
{
    ...
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_materiales'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_rubros'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_rubros'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['grid_jap_rubro_contrato_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_rubros'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['grid_jap_rubro_contrato_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 if (isset($this->Ini->sc_lig_md5["grid_jap_rubro_contrato"]) && $this->Ini->sc_lig_md5["grid_jap_rubro_contrato"] == "S") {
     $Parms_Lig  = "var_contrato*scin" . $this->nmgp_dados_form['con_id'] . "*scoutNMSC_inicial*scininicio*scoutNMSC_paginacao*scinFULL*scout";
     $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_jap_modificar_contrato_mob@SC_par@" . md5($Parms_Lig);
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
 } else {
     $Md5_Lig  = "var_contrato*scin" . $this->nmgp_dados_form['con_id'] . "*scoutNMSC_inicial*scininicio*scoutNMSC_paginacao*scinFULL*scout";
 }
 $parms_lig_cons = "&nmgp_parms=" . $Md5_Lig;
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_jap_modificar_contrato_mob_empty.htm' : $this->Ini->link_grid_jap_rubro_contrato_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y&sc_ifr_height=300' . $parms_lig_cons;
...
if (isset($this->Ini->sc_lig_target['C_@scinf_rubros']) && 'nmsc_iframe_liga_grid_jap_rubro_contrato' != $this->Ini->sc_lig_target['C_@scinf_rubros'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_rubros'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['grid_jap_rubro_contrato_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_grid_jap_rubro_contrato"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="300" width="100%" name="nmsc_iframe_liga_grid_jap_rubro_contrato"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_cuotas'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_cuotas'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['grid_jap_cuotas_contrato_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_cuotas'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['grid_jap_cuotas_contrato_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 $parms_lig_cons = "&nmgp_parms=" . $Md5_Lig;
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_jap_modificar_contrato_mob_empty.htm' : $this->Ini->link_grid_jap_cuotas_contrato_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y&sc_ifr_height=300' . $parms_lig_cons;
...
if (isset($this->Ini->sc_lig_target['C_@scinf_cuotas']) && 'nmsc_iframe_liga_grid_jap_cuotas_contrato' != $this->Ini->sc_lig_target['C_@scinf_cuotas'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_cuotas'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['grid_jap_cuotas_contrato_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_jap_modificar_contrato_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_jap_modificar_contrato_mob");
 parent.scAjaxDetailHeight("form_jap_modificar_contrato_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<script type="text/javascript">
	...
	function scBtnFn_sys_format_inc() {
		...
		if ($("#sc_b_new_b.sc-unique-btn-21").length && $("#sc_b_new_b.sc-unique-btn-21").is(":visible")) {
		    if ($("#sc_b_new_b.sc-unique-btn-21").hasClass("disabled")) {
		        return;
		    }
			nm_move ('novo');
			toggleToolbar(event, true); return;
		}
		if ($("#sc_b_ins_b.sc-unique-btn-22").length && $("#sc_b_ins_b.sc-unique-btn-22").is(":visible")) {
		    if ($("#sc_b_ins_b.sc-unique-btn-22").hasClass("disabled")) {
		        return;
		    }
			nm_atualiza ('incluir');
			toggleToolbar(event, true); return;
	...
	function scBtnFn_modificar_cliente() {
		if ($("#sc_modificar_cliente_top").length && $("#sc_modificar_cliente_top").is(":visible")) {
		    if ($("#sc_modificar_cliente_top").hasClass("disabled")) {
		        return;
		    }
			sc_btn_modificar_cliente()
			toggleToolbar(event, true); return;
		}
		if ($("#sc_modificar_cliente_top").length && $("#sc_modificar_cliente_top").is(":visible")) {
		    if ($("#sc_modificar_cliente_top").hasClass("disabled")) {
	...
	function scBtnFn_historial() {
		if ($("#sc_historial_top").length && $("#sc_historial_top").is(":visible")) {
		    if ($("#sc_historial_top").hasClass("disabled")) {
		        return;
		    }
			sc_btn_historial()
			toggleToolbar(event, true); return;
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
