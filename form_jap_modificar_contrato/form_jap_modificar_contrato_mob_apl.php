<?php
//
class form_jap_modificar_contrato_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_jap_modificar_contrato_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_jap_modificar_contrato_mob']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_jap_modificar_contrato_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_jap_modificar_contrato_mob']['embutida_parms'];
          unset($_SESSION['sc_session'][$script_case_init]['form_jap_modificar_contrato_mob']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_form_jap_modificar_contrato_mob($cadapar[1]);
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_jap_modificar_contrato_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_jap_modificar_contrato_mob']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_jap_modificar_contrato_mob']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_jap_modificar_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_jap_modificar_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_jap_modificar_contrato_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_jap_modificar_contrato_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (!isset($this->Igtech_RucEmpresa) && isset($this->igtech_rucempresa)) 
          {
              $this->Igtech_RucEmpresa = $this->igtech_rucempresa;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_jap_modificar_contrato_mob']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['form_jap_modificar_contrato_mob']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_jap_modificar_contrato_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_jap_modificar_contrato_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_jap_modificar_contrato_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_jap_modificar_contrato_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_jap_modificar_contrato_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_jap_modificar_contrato_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_jap_modificar_contrato_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_jap_modificar_contrato_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_jap_modificar_contrato_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_modificar_contrato']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_jap_modificar_contrato'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_jap_modificar_contrato_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['form_jap_modificar_contrato_mob']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_jap_modificar_contrato_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_jap_modificar_contrato_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_jap_modificar_contrato_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_jap_modificar_contrato_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_jap_modificar_contrato_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_jap_modificar_contrato_mob']['label'] = "" . $this->Ini->Nm_lang['lang_jap_contrato'] . "";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_jap_modificar_contrato_mob")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $this->nm_new_label['con_motivo_anulacion'] = '' . $this->Ini->Nm_lang['lang_motivo_cambio'] . '';
      ...
      $this->arr_buttons['actualizar']['fontawesomeicon']            = "fas fa-edit";
      ...
      $this->arr_buttons['btnimprimir']['style']            = "default";
      ...
      $this->arr_buttons['modificar_cliente']['hint']             = "";
      $this->arr_buttons['modificar_cliente']['type']             = "button";
      $this->arr_buttons['modificar_cliente']['value']            = "" . $this->Ini->Nm_lang['lang_cliente'] . "";
      $this->arr_buttons['modificar_cliente']['display']          = "text_fontawesomeicon";
      $this->arr_buttons['modificar_cliente']['display_position'] = "text_right";
      $this->arr_buttons['modificar_cliente']['style']            = "default";
      $this->arr_buttons['modificar_cliente']['image']            = "";
      $this->arr_buttons['modificar_cliente']['has_fa']            = "true";
      $this->arr_buttons['modificar_cliente']['fontawesomeicon']            = "fas fa-user-check";

      $this->arr_buttons['historial']['hint']             = "";
      $this->arr_buttons['historial']['type']             = "button";
      $this->arr_buttons['historial']['value']            = "" . $this->Ini->Nm_lang['lang_historial'] . "";
      $this->arr_buttons['historial']['display']          = "text_fontawesomeicon";
      $this->arr_buttons['historial']['display_position'] = "text_right";
      $this->arr_buttons['historial']['style']            = "default";
      $this->arr_buttons['historial']['image']            = "";
      $this->arr_buttons['historial']['has_fa']            = "true";
      $this->arr_buttons['historial']['fontawesomeicon']            = "fas fa-history";
      ...
      $_SESSION['scriptcase']['error_icon']['form_jap_modificar_contrato_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_jap_modificar_contrato_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_modificar_contrato_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_jap_modificar_contrato_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_modificar_contrato_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_jap_modificar_contrato_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_modificar_contrato_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_jap_modificar_contrato_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['goto']      = 'on';
          }
      }
      ...
      $this->nmgp_botoes['modificar_cliente'] = "on";
      $this->nmgp_botoes['historial'] = "on";
      $this->nmgp_botoes['ver_contratos'] = "on";
      if (isset($this->NM_btn_cancel) && 'N' == $this->NM_btn_cancel)
      {
          $this->nmgp_botoes['cancel'] = "off";
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_modificar_contrato_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_jap_modificar_contrato_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_jap_modificar_contrato_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_jap_modificar_contrato_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_jap_modificar_contrato_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_jap_modificar_contrato_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_modificar_contrato_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_jap_modificar_contrato_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_jap_modificar_contrato_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_jap_modificar_contrato_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_modificar_contrato_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_jap_modificar_contrato_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_jap_modificar_contrato_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_modificar_contrato_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_jap_modificar_contrato_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_jap_modificar_contrato_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_modificar_contrato_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_jap_modificar_contrato_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_jap_modificar_contrato_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_modificar_contrato_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_jap_modificar_contrato_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_jap_modificar_contrato_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_modificar_contrato_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_jap_modificar_contrato_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_jap_modificar_contrato_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_jap_modificar_contrato_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_jap_modificar_contrato/form_jap_modificar_contrato_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_jap_modificar_contrato_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_jap_modificar_contrato_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_jap_modificar_contrato_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_jap_modificar_contrato/form_jap_modificar_contrato_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_jap_modificar_contrato_mob_erro.class.php"); 
      }
      $this->Erro      = new form_jap_modificar_contrato_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['opcao']))
         { 
             if ($this->con_id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_modificar_contrato_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_jap_modificar_contrato_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_jap_modificar_contrato_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['opc_ant'] : "";
      } 
      if ($this->nmgp_opcao == "novo")  
      {
          $this->nmgp_botoes['actualizar'] = "off";
          $this->nmgp_botoes['btnImprimir'] = "off";
          $this->nmgp_botoes['modificar_cliente'] = "off";
          $this->nmgp_botoes['historial'] = "off";
          $this->nmgp_botoes['ver_contratos'] = "off";
      }
      elseif ($this->nmgp_opcao == "incluir")  
      {
          $this->nmgp_botoes['actualizar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['botoes']['actualizar'];
          $this->nmgp_botoes['btnImprimir'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['botoes']['btnImprimir'];
          $this->nmgp_botoes['modificar_cliente'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['botoes']['modificar_cliente'];
          $this->nmgp_botoes['historial'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['botoes']['historial'];
          $this->nmgp_botoes['ver_contratos'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['botoes']['ver_contratos'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['reg_start'] = "";
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['total']);
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_jap_modificar_contrato_mob']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_jap_modificar_contrato_mob']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_select'];
     }
   }
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Gera_log_access'] = false;
      }
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          form_jap_modificar_contrato_mob_pack_ajax_response();
          exit;
      }
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6))
      {
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      ...
      if ($this->nmgp_opcao == "incluir" || $this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "excluir") 
      {
          ...
          $_SESSION['scriptcase']['form_jap_modificar_contrato_mob']['contr_erro'] = 'off';
          if ($Campos_Crit != "") 
          {
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['recarga'] = $this->nmgp_opcao;
      }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_jap_modificar_contrato_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_jap_modificar_contrato_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_jap_modificar_contrato_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="form_jap_modificar_contrato_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_jap_modificar_contrato_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sis_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'form_jap_modificar_contrato_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_jap_modificar_contrato_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
<?php
include_once("form_jap_modificar_contrato_mob_sajax_js.php");
?>
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['opc_ant'] == "incluir")
      {
      ...
      {
          if (!isset($this->con_orden_lecturas) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_orden_lecturas']))
          {
              $varloc_btn_php['con_orden_lecturas'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_orden_lecturas'];
          }
          if (!isset($this->con_numero_contrato) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_numero_contrato']))
          {
              $varloc_btn_php['con_numero_contrato'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_numero_contrato'];
          }
          if (!isset($this->con_empresa) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_empresa']))
          {
              $varloc_btn_php['con_empresa'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_empresa'];
          }
          if (!isset($this->con_propietario) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_propietario']))
          {
              $varloc_btn_php['con_propietario'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_propietario'];
          }
          if (!isset($this->con_pais) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_pais']))
          {
              $varloc_btn_php['con_pais'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_pais'];
          }
          if (!isset($this->con_provincia) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_provincia']))
          {
              $varloc_btn_php['con_provincia'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_provincia'];
          }
          if (!isset($this->con_canton) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_canton']))
          {
              $varloc_btn_php['con_canton'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_canton'];
          }
          if (!isset($this->con_parroquia) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_parroquia']))
          {
              $varloc_btn_php['con_parroquia'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_parroquia'];
          }
          if (!isset($this->con_comunidad) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_comunidad']))
          {
              $varloc_btn_php['con_comunidad'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_comunidad'];
          }
          if (!isset($this->con_sector) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_sector']))
          {
              $varloc_btn_php['con_sector'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_sector'];
          }
          if (!isset($this->con_numero_censo) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_numero_censo']))
          {
              $varloc_btn_php['con_numero_censo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_numero_censo'];
          }
          if (!isset($this->con_direccion_predio) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_direccion_predio']))
          {
              $varloc_btn_php['con_direccion_predio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_direccion_predio'];
          }
          if (!isset($this->con_toma_administrativa) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_toma_administrativa']))
          {
              $varloc_btn_php['con_toma_administrativa'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_toma_administrativa'];
          }
          if (!isset($this->con_toma_operativa) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_toma_operativa']))
          {
              $varloc_btn_php['con_toma_operativa'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_toma_operativa'];
          }
          if (!isset($this->con_tipo_servicio) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_tipo_servicio']))
          {
              $varloc_btn_php['con_tipo_servicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_tipo_servicio'];
          }
          if (!isset($this->con_condicion_contrato) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_condicion_contrato']))
          {
              $varloc_btn_php['con_condicion_contrato'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_condicion_contrato'];
          }
          if (!isset($this->con_numero_medidor) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_numero_medidor']))
          {
              $varloc_btn_php['con_numero_medidor'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_numero_medidor'];
          }
          if (!isset($this->con_usuario) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_usuario']))
          {
              $varloc_btn_php['con_usuario'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_usuario'];
          }
          if (!isset($this->con_fecha) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_fecha']))
          {
              $varloc_btn_php['con_fecha'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_fecha'];
          }
          if (!isset($this->con_terminal) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_terminal']))
          {
              $varloc_btn_php['con_terminal'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_terminal'];
          }
          if (!isset($this->con_estado) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_estado']))
          {
              $varloc_btn_php['con_estado'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_estado'];
          }
          if (!isset($this->con_motivo_anulacion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_motivo_anulacion']))
          {
              $varloc_btn_php['con_motivo_anulacion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_motivo_anulacion'];
          }
          if (!isset($this->con_tipo_contrato) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_tipo_contrato']))
          {
              $varloc_btn_php['con_tipo_contrato'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_tipo_contrato'];
          }
          if (!isset($this->con_total_a_pagar) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_total_a_pagar']))
          {
              $varloc_btn_php['con_total_a_pagar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_total_a_pagar'];
          }
          if (!isset($this->con_abono) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_abono']))
          {
              $varloc_btn_php['con_abono'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_abono'];
          }
          if (!isset($this->con_plazo) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_plazo']))
          {
              $varloc_btn_php['con_plazo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_plazo'];
          }
          if (!isset($this->con_fecha_instalacion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_fecha_instalacion']))
          {
              $varloc_btn_php['con_fecha_instalacion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_fecha_instalacion'];
          }
          if (!isset($this->con_observaciones) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_observaciones']))
          {
              $varloc_btn_php['con_observaciones'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_observaciones'];
          }
          if (!isset($this->con_usuario_instala) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_usuario_instala']))
          {
              $varloc_btn_php['con_usuario_instala'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_usuario_instala'];
          }
          if (!isset($this->con_numero_contrato) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_numero_contrato']))
          {
              $varloc_btn_php['con_numero_contrato'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_numero_contrato'];
          }
          if (!isset($this->con_maxima_lectura) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_maxima_lectura']))
          {
              $varloc_btn_php['con_maxima_lectura'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_maxima_lectura'];
          }
          if (!isset($this->con_lectura_actual) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_lectura_actual']))
          {
              $varloc_btn_php['con_lectura_actual'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_lectura_actual'];
          }
          if (!isset($this->con_fecha_lectura) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_fecha_lectura']))
          {
              $varloc_btn_php['con_fecha_lectura'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_fecha_lectura'];
          }
          if (!isset($this->con_ruta) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_ruta']))
          {
              $varloc_btn_php['con_ruta'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_ruta'];
          }
          if (!isset($this->con_orden_lecturas) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_orden_lecturas']))
          {
              $varloc_btn_php['con_orden_lecturas'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_orden_lecturas'];
          }
          if (!isset($this->con_numero_corte) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_numero_corte']))
          {
              $varloc_btn_php['con_numero_corte'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_numero_corte'];
          }
          if (!isset($this->con_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_id']))
          {
              $varloc_btn_php['con_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_id'];
          }
          if (!isset($this->con_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_id']))
          {
              $varloc_btn_php['con_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_id'];
          ...
          if (!isset($this->con_nombre) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_nombre']))
          {
              $varloc_btn_php['con_nombre'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_nombre'];
          }
          if (!isset($this->con_numero_contrato) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_numero_contrato']))
          {
              $varloc_btn_php['con_numero_contrato'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form']['con_numero_contrato'];
      ...
      $nm_f_saida = "form_jap_modificar_contrato_mob.php";
      ...
      $_SESSION['scriptcase']['form_jap_modificar_contrato_mob']['contr_erro'] = 'on';
...
if($this->rs_parametro[0][0]=="NO"){
	...
	if ($this->con_estado =='V' or  $this->con_estado =='S'){
	...
	$update_sql="UPDATE  jap_ruta_contrato
					SET rc_orden=".$this->con_orden_lecturas .",
						rc_ruta=".$this->con_ruta ."
					WHERE
...
$update_sql="UPDATE jap_deudas_escenario 
			SET  
				des_propietario= con_propietario,
				des_lectura_anterior=con_lectura_actual,
				des_revisar='SI'
			from jap_contrato      
			WHERE des_contrato=con_id
			and des_estado in ('R','S')
			and  con_id=".$this->con_id .";";
...
$update_sql="UPDATE fac_operacion 
			SET  op_propietario = con_propietario 
			from jap_contrato 
			WHERE  op_contrato=con_id 
			and op_estado <>'P' 
			and con_propietario<>op_propietario
			and con_id=".$this->con_id .";";
   ...
   function Recupera_Nome_Campo($campo) 
   {
       switch($campo)
       {
           case 'con_motivo_anulacion':
               return "" . $this->Ini->Nm_lang['lang_motivo_cambio'] . "";
               break;
           case 'con_fecha':
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_jap_modificar_contrato_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_jap_modificar_contrato_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_jap_modificar_contrato_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_jap_modificar_contrato_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
    ...
    function ValidateField_con_motivo_anulacion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              $hasError = true;
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_motivo_cambio'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 32767 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
   ...
   if (isset($this->Field_no_validate['con_tipo_contrato'])) {
       return;
               ...
               if (!empty($this->con_tipo_contrato) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_tipo_contrato']) && !in_array($this->con_tipo_contrato, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_tipo_contrato']))
               {
                   $hasError = true;
   ...
   if (isset($this->Field_no_validate['con_propietario'])) {
      ...
      if ($this->con_propietario == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['php_cmp_required']['con_propietario']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['php_cmp_required']['con_propietario'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->con_propietario) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_propietario']) && !in_array($this->con_propietario, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_propietario']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['con_propietario']))
   ...
   if (isset($this->Field_no_validate['con_estado'])) {
       return;
               ...
               if (!empty($this->con_estado) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_estado']) && !in_array($this->con_estado, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_estado']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   ...
                   $Campos_Erros['con_estado'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   ...
                   $this->NM_ajax_info['errList']['con_estado'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
               }
        if ($hasError) {
            global $sc_seq_vert;
   ...
   if (isset($this->Field_no_validate['con_pais'])) {
      ...
      if ($this->con_pais == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['php_cmp_required']['con_pais']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['php_cmp_required']['con_pais'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->con_pais) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_pais']) && !in_array($this->con_pais, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_pais']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['con_pais']))
   ...
   if (isset($this->Field_no_validate['con_provincia'])) {
      ...
      if ($this->con_provincia == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['php_cmp_required']['con_provincia']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['php_cmp_required']['con_provincia'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->con_provincia) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_provincia']) && !in_array($this->con_provincia, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_provincia']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['con_provincia']))
   ...
   if (isset($this->Field_no_validate['con_canton'])) {
      ...
      if ($this->con_canton == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['php_cmp_required']['con_canton']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['php_cmp_required']['con_canton'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->con_canton) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_canton']) && !in_array($this->con_canton, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_canton']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['con_canton']))
   ...
   if (isset($this->Field_no_validate['con_parroquia'])) {
      ...
      if ($this->con_parroquia == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['php_cmp_required']['con_parroquia']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['php_cmp_required']['con_parroquia'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->con_parroquia) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_parroquia']) && !in_array($this->con_parroquia, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_parroquia']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['con_parroquia']))
   ...
   if (isset($this->Field_no_validate['con_comunidad'])) {
       return;
               ...
               if (!empty($this->con_comunidad) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_comunidad']) && !in_array($this->con_comunidad, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_comunidad']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['con_sector'])) {
       return;
               ...
               if (!empty($this->con_sector) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_sector']) && !in_array($this->con_sector, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_sector']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['con_toma_administrativa'])) {
      ...
      if ($this->con_toma_administrativa == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['php_cmp_required']['con_toma_administrativa']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['php_cmp_required']['con_toma_administrativa'] == "on"))
      {
          $hasError = true;
          $Campos_Falta[] = "" . $this->Ini->Nm_lang['lang_toma_administrativa'] . "" ; 
          if (!isset($Campos_Erros['con_toma_administrativa']))
          {
              $Campos_Erros['con_toma_administrativa'] = array();
          }
          $Campos_Erros['con_toma_administrativa'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
          ...
          $this->NM_ajax_info['errList']['con_toma_administrativa'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
      }
          if (!empty($this->con_toma_administrativa) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_toma_administrativa']) && !in_array($this->con_toma_administrativa, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_toma_administrativa']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['con_toma_administrativa']))
   ...
   if (isset($this->Field_no_validate['con_toma_operativa'])) {
      ...
      if ($this->con_toma_operativa == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['php_cmp_required']['con_toma_operativa']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['php_cmp_required']['con_toma_operativa'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->con_toma_operativa) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_toma_operativa']) && !in_array($this->con_toma_operativa, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_toma_operativa']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['con_toma_operativa']))
   ...
   if (isset($this->Field_no_validate['con_tipo_servicio'])) {
      ...
      if ($this->con_tipo_servicio == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['php_cmp_required']['con_tipo_servicio']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['php_cmp_required']['con_tipo_servicio'] == "on"))
      {
          $hasError = true;
          $Campos_Falta[] = "" . $this->Ini->Nm_lang['lang_tipo_servicio'] . "" ; 
          if (!isset($Campos_Erros['con_tipo_servicio']))
          {
              $Campos_Erros['con_tipo_servicio'] = array();
          }
          $Campos_Erros['con_tipo_servicio'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
          ...
          $this->NM_ajax_info['errList']['con_tipo_servicio'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
      }
          if (!empty($this->con_tipo_servicio) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_tipo_servicio']) && !in_array($this->con_tipo_servicio, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_tipo_servicio']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['con_tipo_servicio']))
   ...
   if (isset($this->Field_no_validate['con_condicion_contrato'])) {
      ...
      if ($this->con_condicion_contrato == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['php_cmp_required']['con_condicion_contrato']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['php_cmp_required']['con_condicion_contrato'] == "on"))
      {
          $hasError = true;
          $Campos_Falta[] = "" . $this->Ini->Nm_lang['lang_condicion_contrato'] . "" ; 
          if (!isset($Campos_Erros['con_condicion_contrato']))
          {
              $Campos_Erros['con_condicion_contrato'] = array();
          }
          $Campos_Erros['con_condicion_contrato'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
          ...
          $this->NM_ajax_info['errList']['con_condicion_contrato'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
      }
          if (!empty($this->con_condicion_contrato) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_condicion_contrato']) && !in_array($this->con_condicion_contrato, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_condicion_contrato']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['con_condicion_contrato']))
   ...
   if (isset($this->Field_no_validate['con_ruta'])) {
       return;
               ...
               if (!empty($this->con_ruta) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_ruta']) && !in_array($this->con_ruta, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_ruta']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
...
;
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['con_id']['keyVal'] = form_jap_modificar_contrato_mob_pack_protect_string($this->nmgp_dados_form['con_id']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['foreign_key']['mc_contrato'] = $this->nmgp_dados_form['con_id'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['where_filter'] = "mc_contrato = " . $this->nmgp_dados_form['con_id'] . "";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['where_detal']  = "mc_contrato = " . $this->nmgp_dados_form['con_id'] . "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['total']);
              foreach ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob'] as $i => $v)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato'][$i] = $v;
              }
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['form_jap_materiales_contrato_mob_script_case_init'] ]['form_jap_materiales_contrato_mob']['total']);
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['grid_jap_cuotas_contrato_script_case_init'] ]['grid_jap_cuotas_contrato']['embutida_form_full'] = false;
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['grid_jap_cuotas_contrato_script_case_init'] ]['grid_jap_cuotas_contrato']['embutida_form']       = true;
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['grid_jap_cuotas_contrato_script_case_init'] ]['grid_jap_cuotas_contrato']['embutida_pai']        = "form_jap_modificar_contrato_mob";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['grid_jap_cuotas_contrato_script_case_init'] ]['grid_jap_cuotas_contrato']['embutida_form_parms'] = "var_contrato*scin" . $this->nmgp_dados_form['con_id'] . "*scoutNMSC_inicial*scininicio*scoutNMSC_paginacao*scinFULL*scoutNMSC_cab*scinN*scoutNMSC_nav*scinN*scout";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['grid_jap_cuotas_contrato_script_case_init'] ]['grid_jap_cuotas_contrato']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['grid_jap_cuotas_contrato_script_case_init'] ]['grid_jap_cuotas_contrato']['total']);
              foreach ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['grid_jap_cuotas_contrato_script_case_init'] ]['grid_jap_cuotas_contrato'] as $i => $v)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['grid_jap_cuotas_contrato_script_case_init'] ]['grid_jap_cuotas_contrato'][$i] = $v;
              }
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['grid_jap_cuotas_contrato_script_case_init'] ]['grid_jap_cuotas_contrato']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['grid_jap_cuotas_contrato_script_case_init'] ]['grid_jap_cuotas_contrato']['total']);
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['grid_jap_rubro_contrato_script_case_init'] ]['grid_jap_rubro_contrato']['embutida_form_full'] = false;
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['grid_jap_rubro_contrato_script_case_init'] ]['grid_jap_rubro_contrato']['embutida_form']       = true;
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['grid_jap_rubro_contrato_script_case_init'] ]['grid_jap_rubro_contrato']['embutida_pai']        = "form_jap_modificar_contrato_mob";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['grid_jap_rubro_contrato_script_case_init'] ]['grid_jap_rubro_contrato']['embutida_form_parms'] = "var_contrato*scin" . $this->nmgp_dados_form['con_id'] . "*scoutNMSC_inicial*scininicio*scoutNMSC_paginacao*scinFULL*scout";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['grid_jap_rubro_contrato_script_case_init'] ]['grid_jap_rubro_contrato']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['grid_jap_rubro_contrato_script_case_init'] ]['grid_jap_rubro_contrato']['total']);
              foreach ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['grid_jap_rubro_contrato_script_case_init'] ]['grid_jap_rubro_contrato'] as $i => $v)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['grid_jap_rubro_contrato_script_case_init'] ]['grid_jap_rubro_contrato'][$i] = $v;
              }
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['grid_jap_rubro_contrato_script_case_init'] ]['grid_jap_rubro_contrato']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['grid_jap_rubro_contrato_script_case_init'] ]['grid_jap_rubro_contrato']['total']);
              }
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_tipo_contrato']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_tipo_contrato'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_tipo_contrato']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_tipo_contrato'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_jap_modificar_contrato_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_jap_modificar_contrato_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_tipo_contrato'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['con_tipo_contrato']['valList'][$i] = form_jap_modificar_contrato_mob_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_propietario']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_propietario'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_propietario']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_propietario'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_propietario'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['con_propietario']['valList'][$i] = form_jap_modificar_contrato_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_con_estado($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("con_estado", $this->nmgp_refresh_fields)) || $bForce)
          {
              ...
              $aLookup = array();
              $this->_tmp_lookup_con_estado = $this->con_estado;

 
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_estado']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_estado'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_estado']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_estado'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   $nm_comando = "SELECT dec_id, dec_nombre  FROM v_jar_estado_contrato  WHERE dec_id IN ('N','S','V')";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_estado'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"con_estado\"";
          if (isset($this->NM_ajax_info['select_html']['con_estado']) && !empty($this->NM_ajax_info['select_html']['con_estado']))
          {
              $sSelComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['con_estado']);
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->con_estado == $sValue)
                  {
                      $this->_tmp_lookup_con_estado = $sLabel;
                  }
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['con_estado']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['con_estado']['valList'][$i] = form_jap_modificar_contrato_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['con_estado']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['con_estado']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['con_estado']['labList'] = $aLabel;
          }
   }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_pais']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_pais'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_pais']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_pais'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_pais'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['con_pais']['valList'][$i] = form_jap_modificar_contrato_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_provincia']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_provincia'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_provincia']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_provincia'] = array(); 
}
if ($this->con_pais != "")
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_provincia'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['con_provincia']['valList'][$i] = form_jap_modificar_contrato_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_canton']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_canton'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_canton']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_canton'] = array(); 
}
...
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_canton'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['con_canton']['valList'][$i] = form_jap_modificar_contrato_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_parroquia']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_parroquia'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_parroquia']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_parroquia'] = array(); 
}
$aLookup[] = array(form_jap_modificar_contrato_mob_pack_protect_string('') => str_replace('<', '&lt;',form_jap_modificar_contrato_mob_pack_protect_string('' . $this->Ini->Nm_lang['lang_seleccione'] . '')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_parroquia'][] = '';
if ($this->con_canton != "")
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_parroquia'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['con_parroquia']['valList'][$i] = form_jap_modificar_contrato_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_comunidad']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_comunidad'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_comunidad']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_comunidad'] = array(); 
}
$aLookup[] = array(form_jap_modificar_contrato_mob_pack_protect_string('0') => str_replace('<', '&lt;',form_jap_modificar_contrato_mob_pack_protect_string('' . $this->Ini->Nm_lang['lang_seleccione'] . '')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_comunidad'][] = '0';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_comunidad'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['con_comunidad']['valList'][$i] = form_jap_modificar_contrato_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_sector']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_sector'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_sector']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_sector'] = array(); 
}
$aLookup[] = array(form_jap_modificar_contrato_mob_pack_protect_string('0') => str_replace('<', '&lt;',form_jap_modificar_contrato_mob_pack_protect_string('' . $this->Ini->Nm_lang['lang_seleccione'] . '')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_sector'][] = '0';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_sector'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['con_sector']['valList'][$i] = form_jap_modificar_contrato_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_toma_administrativa']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_toma_administrativa'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_toma_administrativa']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_toma_administrativa'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_toma_administrativa'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['con_toma_administrativa']['valList'][$i] = form_jap_modificar_contrato_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_toma_operativa']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_toma_operativa'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_toma_operativa']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_toma_operativa'] = array(); 
}
$aLookup[] = array(form_jap_modificar_contrato_mob_pack_protect_string('') => str_replace('<', '&lt;',form_jap_modificar_contrato_mob_pack_protect_string('' . $this->Ini->Nm_lang['lang_seleccione'] . '')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_toma_operativa'][] = '';
...
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_toma_operativa'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['con_toma_operativa']['valList'][$i] = form_jap_modificar_contrato_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_tipo_servicio']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_tipo_servicio'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_tipo_servicio']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_tipo_servicio'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_tipo_servicio'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['con_tipo_servicio']['valList'][$i] = form_jap_modificar_contrato_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_condicion_contrato']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_condicion_contrato'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_condicion_contrato']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_condicion_contrato'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_condicion_contrato'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['con_condicion_contrato']['valList'][$i] = form_jap_modificar_contrato_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_ruta']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_ruta'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_ruta']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_ruta'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_ruta'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['con_ruta']['valList'][$i] = form_jap_modificar_contrato_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_con_empresa($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
   ...
   {
       $this->NM_ajax_info['btnVars']['var_btn_modificar_cliente_cl_id'] = $this->form_encode_input($this->nmgp_dados_form['con_propietario']);
       $this->NM_ajax_info['btnVars']['var_btn_historial_var_contrato'] = $this->form_encode_input($this->nmgp_dados_form['con_id']);
       $this->NM_ajax_info['btnVars']['var_btn_ver_contratos_var_ruta'] = $this->form_encode_input($this->nmgp_dados_form['con_ruta']);
   } // ajax_add_parameters
  function nm_proc_onload($bFormat = true)
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Field_no_validate'] = array();
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->con_id)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['opcao'] = '';
   ...
   function return_after_insert()
   {
      ...
      if ('' != $this->con_id)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['reg_start'] = $rsc->fields[0];
          $rsc->Close();
      }
   }
   ...
   { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['total']);
              }
              ...
              $this->NM_gera_log_new();
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['parms'] = "con_id?#?$this->con_id?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "insert" || $this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['select'] = ""; 
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['where_filter']))
              {
                  ...
                  $this->NM_ajax_info['buttonDisplay']['modificar_cliente'] = $this->nmgp_botoes['modificar_cliente'] = "off";
                  $this->NM_ajax_info['buttonDisplay']['historial'] = $this->nmgp_botoes['historial'] = "off";
                  $this->NM_ajax_info['buttonDisplay']['ver_contratos'] = $this->nmgp_botoes['ver_contratos'] = "off";
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_select'] = $this->nmgp_dados_select;
...
//-- 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_materiales_contrato_mob']['embutida_parms'] = "NM_btn_insert*scinN*scoutNM_btn_update*scinN*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinN*scout";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rubro_contrato']['embutida_parms'] = "var_contrato*scin" . $this->nmgp_dados_form['con_id'] . "*scoutNMSC_inicial*scininicio*scoutNMSC_paginacao*scinFULL*scout";
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dados_select'];
...
// 
   function NM_gera_log_output() 
   {
       ...
       $Log_labels['con_motivo_anulacion'] =  "{lang_motivo_cambio}";
       ...
       $Log_labels['materiales'] =  "materiales";
       ...
       $this->NM_gera_log_insert("Scriptcase", $this->SC_log_evt, $Log_output);
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
if (false == $this->deudas ) {
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_jap_modificar_contrato_mob';
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_jap_modificar_contrato_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['csrf_token'];
    }
...
else
{
   ...
   function Form_lookup_con_estado()
   {
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['Lookup_con_estado']))
{
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['empty_filter']);
      ...
      foreach ($fields as $field) {
          ...
          if ($field == "SC_all_Cmp") 
          {
              $data_lookup = $this->SC_lookup_con_estado($arg_search, $data_search);
              if (is_array($data_lookup) && !empty($data_lookup)) 
              {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_jap_modificar_contrato_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['total'] = $qt_geral_reg_form_jap_modificar_contrato_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_jap_modificar_contrato_mob_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['SC_sep_date1'];
              }
          }
   ...
   function SC_lookup_con_estado($condicao, $campo)
   {
       $result = array();
       $campo_orig = $campo;
       $campo  = substr($this->Db->qstr($campo), 1, -1);
       $nm_comando = "SELECT dec_nombre, dec_id FROM v_jar_estado_contrato WHERE (#lowerI##cmp_idec_nombre#cmp_f)#cmp_apos LIKE #lowerI#'%#arg_i" . $campo . "#arg_f%')#arg_apos) AND (dec_id IN ('N','S','V'))" ; 
       if ($condicao == "ii")
       {
           $nm_comando = str_replace("LIKE #lowerI#'%#arg_i" . $campo . "#arg_f%')", "LIKE #lowerI#'#arg_i" . $campo . "#arg_f%')", $nm_comando);
       }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_jap_modificar_contrato_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_jap_modificar_contrato_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['retorno_edit'] = "";
   }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function getButtonIds($buttonName) {
        switch ($buttonName) {
            case "help":
                ...
                break;
            case "exit":
                return array("sc_b_sai_t.sc-unique-btn-1", "sc_b_sai_t.sc-unique-btn-3", "sc_b_sai_t.sc-unique-btn-13", "sc_b_sai_t.sc-unique-btn-15", "sc_b_sai_t.sc-unique-btn-2", "sc_b_sai_t.sc-unique-btn-14");
                break;
            case "new":
                return array("sc_b_new_t.sc-unique-btn-4", "sc_b_new_b.sc-unique-btn-9", "sc_b_new_t.sc-unique-btn-16", "sc_b_new_b.sc-unique-btn-21");
                break;
            case "insert":
                return array("sc_b_ins_t.sc-unique-btn-5", "sc_b_ins_b.sc-unique-btn-10", "sc_b_ins_t.sc-unique-btn-17", "sc_b_ins_b.sc-unique-btn-22");
                break;
            case "update":
                return array("sc_b_upd_t.sc-unique-btn-6", "sc_b_upd_b.sc-unique-btn-11", "sc_b_upd_t.sc-unique-btn-18", "sc_b_upd_b.sc-unique-btn-23");
                break;
            case "actualizar":
                return array("sc_actualizar_top.", "sc_actualizar_bot.", "sc_actualizar_top.", "sc_actualizar_bot.");
                break;
            case "0":
                return array("sys_separator.sc-unique-btn-7", "sys_separator.sc-unique-btn-8", "sys_separator.sc-unique-btn-12", "sys_separator.sc-unique-btn-19", "sys_separator.sc-unique-btn-20", "sys_separator.sc-unique-btn-24");
                break;
            case "btnimprimir":
                return array("sc_btnImprimir_top.", "sc_btnImprimir_bot.", "sc_btnImprimir_top.", "sc_btnImprimir_bot.");
                break;
            case "modificar_cliente":
                return array("sc_modificar_cliente_top.", "sc_modificar_cliente_top.");
                break;
            case "historial":
                return array("sc_historial_top.", "sc_historial_top.");
                break;
            case "ver_contratos":
                return array("sc_ver_contratos_top.", "sc_ver_contratos_top.");
                break;
        }
    ...
    function displayAppHeader()
    {
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['mostra_cab']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato']['mostra_cab'] == "N") {
            return;
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['ordem_ord'] == " desc") {
