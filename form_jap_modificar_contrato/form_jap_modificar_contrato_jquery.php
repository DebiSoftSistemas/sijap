...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_con_id' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_id_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_jap_modificar_contrato_con_id_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_jap_modificar_contrato_con_id_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_empresa' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_empresa_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_jap_modificar_contrato_con_empresa_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_jap_modificar_contrato_con_empresa_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_propietario' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_propietario_onblur(this, iSeqRow) })
                                             .bind('change', function() { sc_form_jap_modificar_contrato_con_propietario_onchange(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_jap_modificar_contrato_con_propietario_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_pais' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_pais_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_jap_modificar_contrato_con_pais_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_jap_modificar_contrato_con_pais_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_provincia' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_provincia_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_jap_modificar_contrato_con_provincia_onchange(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_jap_modificar_contrato_con_provincia_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_canton' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_canton_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_jap_modificar_contrato_con_canton_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_jap_modificar_contrato_con_canton_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_parroquia' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_parroquia_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_jap_modificar_contrato_con_parroquia_onchange(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_jap_modificar_contrato_con_parroquia_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_direccion_predio' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_direccion_predio_onblur(this, iSeqRow) })
                                                  .bind('change', function() { sc_form_jap_modificar_contrato_con_direccion_predio_onchange(this, iSeqRow) })
                                                  .bind('focus', function() { sc_form_jap_modificar_contrato_con_direccion_predio_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_toma_administrativa' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_toma_administrativa_onblur(this, iSeqRow) })
                                                     .bind('change', function() { sc_form_jap_modificar_contrato_con_toma_administrativa_onchange(this, iSeqRow) })
                                                     .bind('focus', function() { sc_form_jap_modificar_contrato_con_toma_administrativa_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_toma_operativa' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_toma_operativa_onblur(this, iSeqRow) })
                                                .bind('change', function() { sc_form_jap_modificar_contrato_con_toma_operativa_onchange(this, iSeqRow) })
                                                .bind('focus', function() { sc_form_jap_modificar_contrato_con_toma_operativa_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_tipo_servicio' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_tipo_servicio_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_form_jap_modificar_contrato_con_tipo_servicio_onchange(this, iSeqRow) })
                                               .bind('focus', function() { sc_form_jap_modificar_contrato_con_tipo_servicio_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_condicion_contrato' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_condicion_contrato_onblur(this, iSeqRow) })
                                                    .bind('change', function() { sc_form_jap_modificar_contrato_con_condicion_contrato_onchange(this, iSeqRow) })
                                                    .bind('focus', function() { sc_form_jap_modificar_contrato_con_condicion_contrato_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_numero_medidor' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_numero_medidor_onblur(this, iSeqRow) })
                                                .bind('change', function() { sc_form_jap_modificar_contrato_con_numero_medidor_onchange(this, iSeqRow) })
                                                .bind('focus', function() { sc_form_jap_modificar_contrato_con_numero_medidor_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_usuario' + iSeqRow).bind('change', function() { sc_form_jap_modificar_contrato_con_usuario_onchange(this, iSeqRow) });
  $('#id_sc_field_con_fecha' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_fecha_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_jap_modificar_contrato_con_fecha_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_jap_modificar_contrato_con_fecha_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_terminal' + iSeqRow).bind('change', function() { sc_form_jap_modificar_contrato_con_terminal_onchange(this, iSeqRow) });
  $('#id_sc_field_con_estado' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_estado_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_jap_modificar_contrato_con_estado_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_jap_modificar_contrato_con_estado_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_motivo_anulacion' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_motivo_anulacion_onblur(this, iSeqRow) })
                                                  .bind('change', function() { sc_form_jap_modificar_contrato_con_motivo_anulacion_onchange(this, iSeqRow) })
                                                  .bind('focus', function() { sc_form_jap_modificar_contrato_con_motivo_anulacion_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_tipo_contrato' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_tipo_contrato_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_form_jap_modificar_contrato_con_tipo_contrato_onchange(this, iSeqRow) })
                                               .bind('focus', function() { sc_form_jap_modificar_contrato_con_tipo_contrato_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_total_a_pagar' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_total_a_pagar_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_form_jap_modificar_contrato_con_total_a_pagar_onchange(this, iSeqRow) })
                                               .bind('focus', function() { sc_form_jap_modificar_contrato_con_total_a_pagar_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_abono' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_abono_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_jap_modificar_contrato_con_abono_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_jap_modificar_contrato_con_abono_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_plazo' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_plazo_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_jap_modificar_contrato_con_plazo_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_jap_modificar_contrato_con_plazo_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_fecha_instalacion' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_fecha_instalacion_onblur(this, iSeqRow) })
                                                   .bind('change', function() { sc_form_jap_modificar_contrato_con_fecha_instalacion_onchange(this, iSeqRow) })
                                                   .bind('focus', function() { sc_form_jap_modificar_contrato_con_fecha_instalacion_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_observaciones' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_observaciones_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_form_jap_modificar_contrato_con_observaciones_onchange(this, iSeqRow) })
                                               .bind('focus', function() { sc_form_jap_modificar_contrato_con_observaciones_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_usuario_instala' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_usuario_instala_onblur(this, iSeqRow) })
                                                 .bind('change', function() { sc_form_jap_modificar_contrato_con_usuario_instala_onchange(this, iSeqRow) })
                                                 .bind('focus', function() { sc_form_jap_modificar_contrato_con_usuario_instala_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_numero_contrato' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_numero_contrato_onblur(this, iSeqRow) })
                                                 .bind('change', function() { sc_form_jap_modificar_contrato_con_numero_contrato_onchange(this, iSeqRow) })
                                                 .bind('focus', function() { sc_form_jap_modificar_contrato_con_numero_contrato_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_maxima_lectura' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_maxima_lectura_onblur(this, iSeqRow) })
                                                .bind('change', function() { sc_form_jap_modificar_contrato_con_maxima_lectura_onchange(this, iSeqRow) })
                                                .bind('focus', function() { sc_form_jap_modificar_contrato_con_maxima_lectura_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_lectura_actual' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_lectura_actual_onblur(this, iSeqRow) })
                                                .bind('change', function() { sc_form_jap_modificar_contrato_con_lectura_actual_onchange(this, iSeqRow) })
                                                .bind('focus', function() { sc_form_jap_modificar_contrato_con_lectura_actual_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_fecha_lectura' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_fecha_lectura_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_form_jap_modificar_contrato_con_fecha_lectura_onchange(this, iSeqRow) })
                                               .bind('focus', function() { sc_form_jap_modificar_contrato_con_fecha_lectura_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_ruta' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_ruta_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_jap_modificar_contrato_con_ruta_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_jap_modificar_contrato_con_ruta_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_sino' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_sino_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_jap_modificar_contrato_con_sino_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_jap_modificar_contrato_con_sino_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_orden_lecturas' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_orden_lecturas_onblur(this, iSeqRow) })
                                                .bind('change', function() { sc_form_jap_modificar_contrato_con_orden_lecturas_onchange(this, iSeqRow) })
                                                .bind('focus', function() { sc_form_jap_modificar_contrato_con_orden_lecturas_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_numero_corte' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_numero_corte_onblur(this, iSeqRow) })
                                              .bind('change', function() { sc_form_jap_modificar_contrato_con_numero_corte_onchange(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_jap_modificar_contrato_con_numero_corte_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_comunidad' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_comunidad_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_jap_modificar_contrato_con_comunidad_onchange(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_jap_modificar_contrato_con_comunidad_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_sector' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_sector_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_jap_modificar_contrato_con_sector_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_jap_modificar_contrato_con_sector_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_numero_censo' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_numero_censo_onblur(this, iSeqRow) })
                                              .bind('change', function() { sc_form_jap_modificar_contrato_con_numero_censo_onchange(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_jap_modificar_contrato_con_numero_censo_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_cedula' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_cedula_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_jap_modificar_contrato_con_cedula_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_jap_modificar_contrato_con_cedula_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_telefono' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_telefono_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_jap_modificar_contrato_con_telefono_onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_jap_modificar_contrato_con_telefono_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_celular' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_celular_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_jap_modificar_contrato_con_celular_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_jap_modificar_contrato_con_celular_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_correo' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_correo_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_jap_modificar_contrato_con_correo_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_jap_modificar_contrato_con_correo_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_direccion_propietario' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_direccion_propietario_onblur(this, iSeqRow) })
                                                       .bind('change', function() { sc_form_jap_modificar_contrato_con_direccion_propietario_onchange(this, iSeqRow) })
                                                       .bind('focus', function() { sc_form_jap_modificar_contrato_con_direccion_propietario_onfocus(this, iSeqRow) });
  $('#id_sc_field_materiales' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_materiales_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_jap_modificar_contrato_materiales_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_jap_modificar_contrato_materiales_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_valor_cuota' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_valor_cuota_onblur(this, iSeqRow) })
                                             .bind('change', function() { sc_form_jap_modificar_contrato_con_valor_cuota_onchange(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_jap_modificar_contrato_con_valor_cuota_onfocus(this, iSeqRow) });
  $('#id_sc_field_cuotas' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_cuotas_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_jap_modificar_contrato_cuotas_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_jap_modificar_contrato_cuotas_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_saldo_pagar' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_saldo_pagar_onblur(this, iSeqRow) })
                                             .bind('change', function() { sc_form_jap_modificar_contrato_con_saldo_pagar_onchange(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_jap_modificar_contrato_con_saldo_pagar_onfocus(this, iSeqRow) });
  $('#id_sc_field_rubros' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_rubros_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_jap_modificar_contrato_rubros_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_jap_modificar_contrato_rubros_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_nombre' + iSeqRow).bind('blur', function() { sc_form_jap_modificar_contrato_con_nombre_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_jap_modificar_contrato_con_nombre_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_jap_modificar_contrato_con_nombre_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_jap_modificar_contrato_con_id_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_id();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_con_id_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_empresa_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_empresa();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_empresa_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_con_empresa_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_propietario_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_propietario();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_propietario_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_form_jap_modificar_contrato_event_con_propietario_onchange();
}

function sc_form_jap_modificar_contrato_con_propietario_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_pais_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_pais();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_pais_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_form_jap_modificar_contrato_refresh_con_pais();
}

function sc_form_jap_modificar_contrato_con_pais_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_provincia_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_provincia();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_provincia_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_form_jap_modificar_contrato_refresh_con_provincia();
}

function sc_form_jap_modificar_contrato_con_provincia_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_canton_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_canton();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_canton_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_form_jap_modificar_contrato_refresh_con_canton();
}

function sc_form_jap_modificar_contrato_con_canton_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_parroquia_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_parroquia();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_parroquia_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_con_parroquia_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_direccion_predio_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_direccion_predio();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_direccion_predio_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_con_direccion_predio_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_toma_administrativa_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_toma_administrativa();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_toma_administrativa_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_con_toma_administrativa_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_toma_operativa_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_toma_operativa();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_toma_operativa_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_con_toma_operativa_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_tipo_servicio_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_tipo_servicio();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_tipo_servicio_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_con_tipo_servicio_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_condicion_contrato_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_condicion_contrato();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_condicion_contrato_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_con_condicion_contrato_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_numero_medidor_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_numero_medidor();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_numero_medidor_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_con_numero_medidor_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_usuario_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_con_fecha_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_fecha();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_fecha_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_con_fecha_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_terminal_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_con_estado_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_estado();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_estado_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_con_estado_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_motivo_anulacion_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_motivo_anulacion();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_motivo_anulacion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_con_motivo_anulacion_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_tipo_contrato_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_tipo_contrato();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_tipo_contrato_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_con_tipo_contrato_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_total_a_pagar_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_total_a_pagar();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_total_a_pagar_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_form_jap_modificar_contrato_event_con_total_a_pagar_onchange();
}

function sc_form_jap_modificar_contrato_con_total_a_pagar_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_abono_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_abono();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_abono_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_form_jap_modificar_contrato_event_con_abono_onchange();
}

function sc_form_jap_modificar_contrato_con_abono_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_plazo_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_plazo();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_plazo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_form_jap_modificar_contrato_event_con_plazo_onchange();
}

function sc_form_jap_modificar_contrato_con_plazo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_fecha_instalacion_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_fecha_instalacion();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_fecha_instalacion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_con_fecha_instalacion_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_observaciones_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_observaciones();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_observaciones_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_con_observaciones_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_usuario_instala_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_usuario_instala();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_usuario_instala_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_con_usuario_instala_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_numero_contrato_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_numero_contrato();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_numero_contrato_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_con_numero_contrato_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_maxima_lectura_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_maxima_lectura();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_maxima_lectura_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_con_maxima_lectura_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_lectura_actual_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_lectura_actual();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_lectura_actual_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_con_lectura_actual_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_fecha_lectura_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_fecha_lectura();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_fecha_lectura_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_con_fecha_lectura_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_ruta_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_ruta();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_ruta_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_con_ruta_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_sino_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_sino();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_sino_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_con_sino_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_orden_lecturas_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_orden_lecturas();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_orden_lecturas_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_con_orden_lecturas_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_numero_corte_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_numero_corte();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_numero_corte_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_con_numero_corte_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_comunidad_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_comunidad();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_comunidad_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_con_comunidad_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_sector_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_sector();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_sector_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_con_sector_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_numero_censo_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_numero_censo();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_numero_censo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_con_numero_censo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_cedula_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_cedula();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_cedula_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_con_cedula_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_telefono_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_telefono();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_telefono_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_con_telefono_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_celular_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_celular();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_celular_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_con_celular_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_correo_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_correo();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_correo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_con_correo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_direccion_propietario_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_direccion_propietario();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_direccion_propietario_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_con_direccion_propietario_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_materiales_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_materiales();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_materiales_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_materiales_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_valor_cuota_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_valor_cuota();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_valor_cuota_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_con_valor_cuota_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_cuotas_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_cuotas();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_cuotas_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_cuotas_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_saldo_pagar_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_saldo_pagar();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_saldo_pagar_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_con_saldo_pagar_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_rubros_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_rubros();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_rubros_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_rubros_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_jap_modificar_contrato_con_nombre_onblur(oThis, iSeqRow) {
  do_ajax_form_jap_modificar_contrato_validate_con_nombre();
  scCssBlur(oThis);
}

function sc_form_jap_modificar_contrato_con_nombre_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_jap_modificar_contrato_con_nombre_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function displayChange_field_con_estado(row, status) {
	...
	if ("on" == status) {
		if ("all" == row) {
			var fieldList = $(".css_con_estado__obj");
			for (var i = 0; i < fieldList.length; i++) {
				$($(fieldList[i]).attr("id")).select2("destroy");
			}
		}
		else {
			$("#id_sc_field_con_estado" + row).select2("destroy");
		}
		scJQSelect2Add(row, "con_estado");
	}
}
...
function displayChange_field_rubros(row, status) {
    var fieldId;
	if ("on" == status && typeof $("#nmsc_iframe_liga_grid_jap_rubro_contrato")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_grid_jap_rubro_contrato")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scRecreateSelect2() {
	...
	displayChange_field_con_estado("all", "on");
...
function scHidePage(pageNo) {
	$("#id_form_jap_modificar_contrato_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_con_fecha_instalacion" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_jap_modificar_contrato_validate_con_fecha_instalacion(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  $("#id_sc_field_con_fecha_lectura" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_jap_modificar_contrato_validate_con_fecha_lectura(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_jap_modificar_contrato')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
...
function scJQSelect2Add(seqRow, specificField) {
  ...
  if (null == specificField || "con_estado" == specificField) {
    scJQSelect2Add_con_estado(seqRow);
  }
...
function scJQSelect2Add_con_estado(seqRow) {
  var elemSelector = "all" == seqRow ? ".css_con_estado_obj" : "#id_sc_field_con_estado" + seqRow;
  $(elemSelector).select2(
    {
      minimumResultsForSearch: Infinity,
      containerCssClass: 'css_con_estado_obj',
      dropdownCssClass: 'css_con_estado_obj',
      language: {
        noResults: function() {
          return "<?php echo $this->Ini->Nm_lang['lang_autocomp_notfound'] ?>";
        },
...
function scJQElementsAdd(iLine) {
  ...
  setTimeout(function () { if ('function' == typeof displayChange_field_con_estado) { displayChange_field_con_estado(iLine, "on"); } }, 150);
