...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_jap_modificar_contrato_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function sc_btn_actualizar_ok()
{
    ...
    document.F1.action = "form_jap_modificar_contrato_mob.php";
...
var var_btn_modificar_cliente_cl_id = "<?php echo $this->form_encode_input($this->nmgp_dados_form['con_propietario']); ?>";
function sc_btn_modificar_cliente()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_modificar_cliente(); }, 500);
      return;
    }
    sc_btn_modificar_cliente_ok();
}
function sc_btn_modificar_cliente_cancel()
{
}
function sc_btn_modificar_cliente_ok()
{
  tb_show('', '<?php echo $this->Ini->link_form_del_cliente_edit; ?>?script_case_init=<?php echo $this->Ini->sc_page; ?>&nmgp_url_saida=modal&nmgp_parms=<?php echo "cl_id*scin' + var_btn_modificar_cliente_cl_id + '*scoutNM_btn_insert*scinN*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinN*scoutsc_redir_atualiz*scinok*scoutsc_redir_insert*scinok*scout"; ?>&nmgp_outra_jan=true&TB_iframe=true&height=400&width=1024&modal=true', '');
}
var var_btn_historial_var_contrato = "<?php echo $this->form_encode_input($this->nmgp_dados_form['con_id']); ?>";
function sc_btn_historial()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_historial(); }, 500);
      return;
    }
    sc_btn_historial_ok();
}
function sc_btn_historial_cancel()
{
}
function sc_btn_historial_ok()
{
  tb_show('', '<?php echo $this->Ini->link_grid_jap_log_contrato_cons; ?>?script_case_init=<?php echo $this->Ini->sc_page; ?>&nmgp_url_saida=modal&nmgp_parms=<?php echo "var_contrato*scin' + var_btn_historial_var_contrato + '*scoutNMSC_inicial*scininicio*scoutNMSC_paginacao*scinFULL*scoutNMSC_cab*scinN*scoutNMSC_nav*scinN*scout"; ?>&nmgp_outra_jan=true&TB_iframe=true&height=400&width=800&modal=true', '');
}
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_modificar_contrato_mob']['where_detal']))
  {
?>  
