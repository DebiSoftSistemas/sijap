...
{
    db_conect_devel($_SESSION['scriptcase']['mnu_principal']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['mnu_principal']['glo_nm_path_prod'], 'SIJAP', 2); 
}
...
{ 
   $this->Db = db_conect_devel($_SESSION['scriptcase']['mnu_principal']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['mnu_principal']['glo_nm_path_prod'], 'SIJAP'); 
} 
else 
{ 
...
?>
  ...
  <div class='mainmenu menu--horizontal'>
      ...
      <div class='menu__container '>
        ...
        <td class='sc-layer-2' style='width:89.92%;text-align:left;'>
                        <span class='sc-layer-2-0' style='font-weight:bold;font-size: 18px;background-color: ;font-family: ;color: #ffffff;'><?php echo "" . $this->Nm_lang['lang_empresa'] . ": " . $_SESSION['Igtech_NombreEmpresa'] . "" ?></span><br/>
            <span class='sc-layer-2-1' style='font-size: 15px;background-color: ;font-family: ;color: #ffffff;'>
<?php
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['mnu_principal']['glo_nm_path_imag_temp'] . "/sc_apl_default_SIJAP.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['mnu_principal']['glo_nm_path_imag_temp'] . "/sc_apl_default_SIJAP.txt"));
    }
    if (isset($apl_def)) {
        ...
        if (isset($_COOKIE['sc_actual_lang_SIJAP'])) {
            $_SESSION['scriptcase']['mnu_principal']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_SIJAP'];
        }
    }
}
