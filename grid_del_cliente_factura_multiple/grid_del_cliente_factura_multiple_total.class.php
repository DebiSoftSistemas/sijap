...
class grid_del_cliente_factura_multiple_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_del_cliente_factura_multiple']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_del_cliente_factura_multiple']['campos_busca']))
      { 
