<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_v_del_resumen_facturacion_diaria']['glo_nm_path_imag_temp'] . "/sc_apl_default_SIJAP.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_v_del_resumen_facturacion_diaria_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_v_del_resumen_facturacion_diaria_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["fac_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['labels']["fac_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['labels']["fac_fecha"] : "" . $this->Nm_lang['lang_fecha'] . "";
   $tab_ger_campos['fac_tipo_comprobante'] = "on";
   $tab_def_campos['fac_tipo_comprobante'] = "fac_tipo_comprobante";
   $tab_labels["fac_tipo_comprobante"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['labels']["fac_tipo_comprobante"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['labels']["fac_tipo_comprobante"] : "" . $this->Nm_lang['lang_tipo_comprobante'] . "";
   $tab_ger_campos['fac_serie'] = "on";
   $tab_def_campos['fac_serie'] = "fac_serie";
   $tab_labels["fac_serie"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['labels']["fac_serie"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['labels']["fac_serie"] : "" . $this->Nm_lang['lang_serie_sri'] . "";
   $tab_ger_campos['concepto_factura'] = "on";
   $tab_def_campos['concepto_factura'] = "concepto_factura";
   $tab_labels["concepto_factura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['labels']["concepto_factura"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['labels']["concepto_factura"] : "" . $this->Nm_lang['lang_datos_factura'] . "";
   $tab_ger_campos['cl_nombre'] = "on";
   $tab_def_campos['cl_nombre'] = "cl_nombre";
   $tab_labels["cl_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['labels']["cl_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['labels']["cl_nombre"] : "" . $this->Nm_lang['lang_nombre'] . "";
   $tab_ger_campos['pro_descripcion'] = "on";
   $tab_def_campos['pro_descripcion'] = "pro_descripcion";
   $tab_labels["pro_descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['labels']["pro_descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['labels']["pro_descripcion"] : "" . $this->Nm_lang['lang_producto'] . "";
   $tab_ger_campos['df_subtotal'] = "on";
   $tab_def_campos['df_subtotal'] = "df_subtotal";
   $tab_labels["df_subtotal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['labels']["df_subtotal"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['labels']["df_subtotal"] : "" . $this->Nm_lang['lang_subtotal'] . "";
   $tab_ger_campos['df_descuento'] = "on";
   $tab_def_campos['df_descuento'] = "df_descuento";
   $tab_labels["df_descuento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['labels']["df_descuento"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['labels']["df_descuento"] : "" . $this->Nm_lang['lang_descuento'] . "";
   $tab_ger_campos['df_valor_iva'] = "on";
   $tab_def_campos['df_valor_iva'] = "df_valor_iva";
   $tab_labels["df_valor_iva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['labels']["df_valor_iva"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['labels']["df_valor_iva"] : "" . $this->Nm_lang['lang_iva'] . "";
   $tab_ger_campos['df_total'] = "on";
   $tab_def_campos['df_total'] = "df_total";
   $tab_labels["df_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['labels']["df_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['labels']["df_total"] : "" . $this->Nm_lang['lang_total'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> v_del_facturas_detalladas</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_v_del_resumen_facturacion_diaria_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_v_del_resumen_facturacion_diaria']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
