...
class grid_v_del_resumen_facturacion_diaria_resumo
{
   ...
   var $array_total_concepto_factura;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_concepto_factura     = array();
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['dashboard_info']['under_dashboard'] ? "off" : "on";
...
SCEOT;
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_pro_descripcion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['arr_total']['pro_descripcion'];
          $this->array_total_fac_tipo_comprobante = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['arr_total']['fac_tipo_comprobante'];
          $this->array_total_fac_serie = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['arr_total']['fac_serie'];
          $this->array_total_concepto_factura = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['arr_total']['concepto_factura'];
      }
      else
      {
          $this->array_total_pro_descripcion = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['tot_geral'][5];
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['arr_total']['concepto_factura'] = $this->array_total_concepto_factura;
   ...
   function completeMatrix()
   {
       ...
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['json_use_label'])
       {
          ...
          $Lab_concepto_factura = "concepto_factura";
       }
       else
       {
       ...
       $Lab_concepto_factura = "" . $this->Ini->Nm_lang['lang_datos_factura'] . "";
       }
       $this->comp_field = array(
           $Lab_pro_descripcion,
           $Lab_fac_tipo_comprobante,
           $Lab_fac_serie,
           $Lab_concepto_factura,
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['concepto_factura']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['concepto_factura'] = "" . $this->Ini->Nm_lang['lang_datos_factura'] . ""; 
       }
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['fac_numero'] = "Fac Numero"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['fac_empresa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['fac_empresa'] = "Fac Empresa"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['fac_secuencial']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['fac_secuencial'] = "Fac Secuencial"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['fac_cliente']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['fac_cliente'] = "Fac Cliente"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['cl_identificacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['cl_identificacion'] = "Cl Identificacion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['cl_direccion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['cl_direccion'] = "Cl Direccion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['cl_telefono']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['cl_telefono'] = "Cl Telefono"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['cl_celular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['cl_celular'] = "Cl Celular"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['cl_email']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['cl_email'] = "Cl Email"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['fac_comentario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['fac_comentario'] = "Fac Comentario"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['pro_codigo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['pro_codigo'] = "Pro Codigo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['df_descripcion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['df_descripcion'] = "Df Descripcion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['df_cantidad']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['df_cantidad'] = "Df Cantidad"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['df_precio_unitario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['df_precio_unitario'] = "Df Precio Unitario"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['df_base_iva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['df_base_iva'] = "Df Base Iva"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['df_valor_ice']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['df_valor_ice'] = "Df Valor Ice"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['df_valor_irbpnr']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['df_valor_irbpnr'] = "Df Valor Irbpnr"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['mes']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['mes'] = "Mes"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['anio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['anio'] = "Anio"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['fac_usuario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['fac_usuario'] = "Fac Usuario"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['fac_asiento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['labels']['fac_asiento'] = "Fac Asiento"; 
       }
       //-----
       $this->comp_field_nm = array(
           'pro_descripcion' => 0,
           'fac_tipo_comprobante' => 1,
           'fac_serie' => 2,
           'concepto_factura' => 3,
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['summarizing_fields_order']['Inicial']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['summarizing_fields_order']['Inicial'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['summarizing_fields_order']['Inicial'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['summarizing_fields_display']['Inicial'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['summarizing_fields_display']['Inicial'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['summarizing_fields_display']['Inicial'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['summarizing_fields_display']['Inicial'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['summarizing_fields_display']['Inicial'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['summarizing_fields_display']['Inicial'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['summarizing_fields_display']['Inicial'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "df_total", 'show' => true),
       );
       ...
       //-----
       foreach ($this->array_total_pro_descripcion as $i_pro_descripcion => $d_pro_descripcion) {
           if (!isset($i_pro_descripcion, $this->comp_label[0]) || !in_array($i_pro_descripcion, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_pro_descripcion[6] ] = $d_pro_descripcion[5];
               $this->comp_label[0][ $d_pro_descripcion[6] ] = $d_pro_descripcion[5];
           }
           foreach ($this->array_total_fac_tipo_comprobante[$i_pro_descripcion] as $i_fac_tipo_comprobante => $d_fac_tipo_comprobante) {
               if (!isset($i_fac_tipo_comprobante, $this->comp_label[1][ $d_pro_descripcion[6] ]) || !in_array($i_fac_tipo_comprobante, $this->comp_label[1][ $d_pro_descripcion[6] ], true)) {
                   $this->comp_index[1][ $d_fac_tipo_comprobante[6] ] = $d_fac_tipo_comprobante[5];
                   $this->comp_label[1][ $d_pro_descripcion[6] ][ $d_fac_tipo_comprobante[6] ] = $d_fac_tipo_comprobante[5];
               }
               foreach ($this->array_total_fac_serie[$i_pro_descripcion][$i_fac_tipo_comprobante] as $i_fac_serie => $d_fac_serie) {
                   if (!isset($i_fac_serie, $this->comp_label[2][ $d_pro_descripcion[6] ][ $d_fac_tipo_comprobante[6] ]) || !in_array($i_fac_serie, $this->comp_label[2][ $d_pro_descripcion[6] ][ $d_fac_tipo_comprobante[6] ], true)) {
                       $this->comp_index[2][ $d_fac_serie[6] ] = $d_fac_serie[5];
                       $this->comp_label[2][ $d_pro_descripcion[6] ][ $d_fac_tipo_comprobante[6] ][ $d_fac_serie[6] ] = $d_fac_serie[5];
                   }
                   foreach ($this->array_total_concepto_factura[$i_pro_descripcion][$i_fac_tipo_comprobante][$i_fac_serie] as $i_concepto_factura => $d_concepto_factura) {
                       if (!isset($i_concepto_factura, $this->comp_label[3][ $d_pro_descripcion[6] ][ $d_fac_tipo_comprobante[6] ][ $d_fac_serie[6] ]) || !in_array($i_concepto_factura, $this->comp_label[3][ $d_pro_descripcion[6] ][ $d_fac_tipo_comprobante[6] ][ $d_fac_serie[6] ], true)) {
                           $this->comp_index[3][ $d_concepto_factura[6] ] = $d_concepto_factura[5];
                           $this->comp_label[3][ $d_pro_descripcion[6] ][ $d_fac_tipo_comprobante[6] ][ $d_fac_serie[6] ][ $d_concepto_factura[6] ] = $d_concepto_factura[5];
                       }
                   }
               }
           }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'pro_descripcion', 'prot' => '@aspass@'),
           array('name' => 'fac_tipo_comprobante', 'prot' => '@aspass@'),
           array('name' => 'fac_serie', 'prot' => '@aspass@'),
           array('name' => 'concepto_factura', 'prot' => '@aspass@'),
       );
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_pro_descripcion => $l_pro_descripcion) {
           if (isset($this->array_total_pro_descripcion[$i_pro_descripcion])) {
               $this->comp_group[$i_pro_descripcion] = array();
           }
           foreach ($this->comp_label[1][$i_pro_descripcion] as $i_fac_tipo_comprobante => $l_fac_tipo_comprobante) {
               if (isset($this->array_total_fac_tipo_comprobante[$i_pro_descripcion][$i_fac_tipo_comprobante])) {
                   $this->comp_group[$i_pro_descripcion][$i_fac_tipo_comprobante] = array();
               }
               foreach ($this->comp_label[2][$i_pro_descripcion][$i_fac_tipo_comprobante] as $i_fac_serie => $l_fac_serie) {
                   if (isset($this->array_total_fac_serie[$i_pro_descripcion][$i_fac_tipo_comprobante][$i_fac_serie])) {
                       $this->comp_group[$i_pro_descripcion][$i_fac_tipo_comprobante][$i_fac_serie] = array();
                   }
                   foreach ($this->comp_label[3][$i_pro_descripcion][$i_fac_tipo_comprobante][$i_fac_serie] as $i_concepto_factura => $l_concepto_factura) {
                       if (isset($this->array_total_concepto_factura[$i_pro_descripcion][$i_fac_tipo_comprobante][$i_fac_serie][$i_concepto_factura])) {
                           $this->comp_group[$i_pro_descripcion][$i_fac_tipo_comprobante][$i_fac_serie][$i_concepto_factura] = array();
                       }
                   }
               }
           }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_pro_descripcion;
       }
       elseif (1 == $level) {
           $return = $this->array_total_fac_tipo_comprobante;
       }
       elseif (2 == $level) {
           $return = $this->array_total_fac_serie;
       }
       elseif (3 == $level) {
           $return = $this->array_total_concepto_factura;
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_Inicial("res", $this->NM_export);
      ...
      if (is_array($this->array_total_pro_descripcion)) {
          ksort($this->array_total_pro_descripcion);
      }
      if (is_array($this->array_total_fac_tipo_comprobante)) {
          ksort($this->array_total_fac_tipo_comprobante);
      }
      if (is_array($this->array_total_fac_serie)) {
          ksort($this->array_total_fac_serie);
      }
      if (is_array($this->array_total_concepto_factura)) {
          ksort($this->array_total_concepto_factura);
      }
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_resumen_facturacion_diaria']['SC_Ind_Groupby'];
...
{ 
   ...
   //---- 
   function adiciona_registro($sum_df_subtotal, $sum_df_descuento, $sum_df_valor_iva, $sum_df_total, $quebra_pro_descripcion, $quebra_fac_tipo_comprobante, $quebra_fac_serie, $quebra_concepto_factura, $quebra_pro_descripcion_orig, $quebra_fac_tipo_comprobante_orig, $quebra_fac_serie_orig, $quebra_concepto_factura_orig)
   {
      //----- pro_descripcion
      if (!isset($this->array_total_pro_descripcion[$quebra_pro_descripcion_orig]))
      {
         $this->array_total_pro_descripcion[$quebra_pro_descripcion_orig][0] = 1;
         $this->array_total_pro_descripcion[$quebra_pro_descripcion_orig][1] = $sum_df_subtotal;
         $this->array_total_pro_descripcion[$quebra_pro_descripcion_orig][2] = $sum_df_descuento;
         $this->array_total_pro_descripcion[$quebra_pro_descripcion_orig][3] = $sum_df_valor_iva;
         $this->array_total_pro_descripcion[$quebra_pro_descripcion_orig][4] = $sum_df_total;
         $this->array_total_pro_descripcion[$quebra_pro_descripcion_orig][5] = $quebra_pro_descripcion;
         $this->array_total_pro_descripcion[$quebra_pro_descripcion_orig][6] = $quebra_pro_descripcion_orig;
      }
      else
      {
         $this->array_total_pro_descripcion[$quebra_pro_descripcion_orig][0]++;
         $this->array_total_pro_descripcion[$quebra_pro_descripcion_orig][1] = bcadd($this->array_total_pro_descripcion[$quebra_pro_descripcion_orig][1], $sum_df_subtotal, 10);
         $this->array_total_pro_descripcion[$quebra_pro_descripcion_orig][2] = bcadd($this->array_total_pro_descripcion[$quebra_pro_descripcion_orig][2], $sum_df_descuento, 10);
         $this->array_total_pro_descripcion[$quebra_pro_descripcion_orig][3] = bcadd($this->array_total_pro_descripcion[$quebra_pro_descripcion_orig][3], $sum_df_valor_iva, 10);
         $this->array_total_pro_descripcion[$quebra_pro_descripcion_orig][4] = bcadd($this->array_total_pro_descripcion[$quebra_pro_descripcion_orig][4], $sum_df_total, 10);
      }
      //----- fac_tipo_comprobante
      if (!isset($this->array_total_fac_tipo_comprobante[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig]))
      {
         $this->array_total_fac_tipo_comprobante[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][0] = 1;
         $this->array_total_fac_tipo_comprobante[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][1] = $sum_df_subtotal;
         $this->array_total_fac_tipo_comprobante[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][2] = $sum_df_descuento;
         $this->array_total_fac_tipo_comprobante[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][3] = $sum_df_valor_iva;
         $this->array_total_fac_tipo_comprobante[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][4] = $sum_df_total;
         $this->array_total_fac_tipo_comprobante[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][5] = $quebra_fac_tipo_comprobante;
         $this->array_total_fac_tipo_comprobante[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][6] = $quebra_fac_tipo_comprobante_orig;
      }
      else
      {
         $this->array_total_fac_tipo_comprobante[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][0]++;
         $this->array_total_fac_tipo_comprobante[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][1] = bcadd($this->array_total_fac_tipo_comprobante[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][1], $sum_df_subtotal, 10);
         $this->array_total_fac_tipo_comprobante[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][2] = bcadd($this->array_total_fac_tipo_comprobante[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][2], $sum_df_descuento, 10);
         $this->array_total_fac_tipo_comprobante[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][3] = bcadd($this->array_total_fac_tipo_comprobante[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][3], $sum_df_valor_iva, 10);
         $this->array_total_fac_tipo_comprobante[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][4] = bcadd($this->array_total_fac_tipo_comprobante[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][4], $sum_df_total, 10);
      }
      //----- fac_serie
      if (!isset($this->array_total_fac_serie[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][$quebra_fac_serie_orig]))
      {
         $this->array_total_fac_serie[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][$quebra_fac_serie_orig][0] = 1;
         $this->array_total_fac_serie[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][$quebra_fac_serie_orig][1] = $sum_df_subtotal;
         $this->array_total_fac_serie[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][$quebra_fac_serie_orig][2] = $sum_df_descuento;
         $this->array_total_fac_serie[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][$quebra_fac_serie_orig][3] = $sum_df_valor_iva;
         $this->array_total_fac_serie[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][$quebra_fac_serie_orig][4] = $sum_df_total;
         $this->array_total_fac_serie[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][$quebra_fac_serie_orig][5] = $quebra_fac_serie;
         $this->array_total_fac_serie[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][$quebra_fac_serie_orig][6] = $quebra_fac_serie_orig;
      }
      else
      {
         $this->array_total_fac_serie[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][$quebra_fac_serie_orig][0]++;
         $this->array_total_fac_serie[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][$quebra_fac_serie_orig][1] = bcadd($this->array_total_fac_serie[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][$quebra_fac_serie_orig][1], $sum_df_subtotal, 10);
         $this->array_total_fac_serie[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][$quebra_fac_serie_orig][2] = bcadd($this->array_total_fac_serie[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][$quebra_fac_serie_orig][2], $sum_df_descuento, 10);
         $this->array_total_fac_serie[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][$quebra_fac_serie_orig][3] = bcadd($this->array_total_fac_serie[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][$quebra_fac_serie_orig][3], $sum_df_valor_iva, 10);
         $this->array_total_fac_serie[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][$quebra_fac_serie_orig][4] = bcadd($this->array_total_fac_serie[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][$quebra_fac_serie_orig][4], $sum_df_total, 10);
      }
      //----- concepto_factura
      if (!isset($this->array_total_concepto_factura[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][$quebra_fac_serie_orig][$quebra_concepto_factura_orig]))
      {
         $this->array_total_concepto_factura[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][$quebra_fac_serie_orig][$quebra_concepto_factura_orig][0] = 1;
         $this->array_total_concepto_factura[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][$quebra_fac_serie_orig][$quebra_concepto_factura_orig][1] = $sum_df_subtotal;
         $this->array_total_concepto_factura[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][$quebra_fac_serie_orig][$quebra_concepto_factura_orig][2] = $sum_df_descuento;
         $this->array_total_concepto_factura[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][$quebra_fac_serie_orig][$quebra_concepto_factura_orig][3] = $sum_df_valor_iva;
         $this->array_total_concepto_factura[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][$quebra_fac_serie_orig][$quebra_concepto_factura_orig][4] = $sum_df_total;
         $this->array_total_concepto_factura[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][$quebra_fac_serie_orig][$quebra_concepto_factura_orig][5] = $quebra_concepto_factura;
         $this->array_total_concepto_factura[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][$quebra_fac_serie_orig][$quebra_concepto_factura_orig][6] = $quebra_concepto_factura_orig;
      }
      else
      {
         $this->array_total_concepto_factura[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][$quebra_fac_serie_orig][$quebra_concepto_factura_orig][0]++;
         $this->array_total_concepto_factura[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][$quebra_fac_serie_orig][$quebra_concepto_factura_orig][1] = bcadd($this->array_total_concepto_factura[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][$quebra_fac_serie_orig][$quebra_concepto_factura_orig][1], $sum_df_subtotal, 10);
         $this->array_total_concepto_factura[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][$quebra_fac_serie_orig][$quebra_concepto_factura_orig][2] = bcadd($this->array_total_concepto_factura[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][$quebra_fac_serie_orig][$quebra_concepto_factura_orig][2], $sum_df_descuento, 10);
         $this->array_total_concepto_factura[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][$quebra_fac_serie_orig][$quebra_concepto_factura_orig][3] = bcadd($this->array_total_concepto_factura[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][$quebra_fac_serie_orig][$quebra_concepto_factura_orig][3], $sum_df_valor_iva, 10);
         $this->array_total_concepto_factura[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][$quebra_fac_serie_orig][$quebra_concepto_factura_orig][4] = bcadd($this->array_total_concepto_factura[$quebra_pro_descripcion_orig][$quebra_fac_tipo_comprobante_orig][$quebra_fac_serie_orig][$quebra_concepto_factura_orig][4], $sum_df_total, 10);
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('Inicial', 'pro_descripcion');
     $campos_order = $this->Ini->Get_date_order_groupby("pro_descripcion", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('Inicial', 'fac_tipo_comprobante');
     $campos_order = $this->Ini->Get_date_order_groupby("fac_tipo_comprobante", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('Inicial', 'fac_serie');
     $campos_order = $this->Ini->Get_date_order_groupby("fac_serie", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('Inicial', 'concepto_factura');
     $campos_order = $this->Ini->Get_date_order_groupby("concepto_factura", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->concepto_factura = $rs_res->fields[3] ;  
            $this->cl_nombre = $rs_res->fields[4] ;  
            $this->pro_descripcion = $rs_res->fields[5] ;  
            $this->df_subtotal = $rs_res->fields[6] ;  
            $this->df_descuento = $rs_res->fields[7] ;  
            $this->df_valor_iva = $rs_res->fields[8] ;  
            $this->df_total = $rs_res->fields[9] ;  
            $this->fac_numero = $rs_res->fields[10] ;  
            $this->fac_empresa = $rs_res->fields[11] ;  
            $this->fac_secuencial = $rs_res->fields[12] ;  
            ...
            $this->concepto_factura_orig = $this->concepto_factura;
            $this->fac_tipo_comprobante = $this->look_fac_tipo_comprobante ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->df_subtotal, $this->df_descuento, $this->df_valor_iva, $this->df_total, $this->pro_descripcion, $this->fac_tipo_comprobante, $this->fac_serie, $this->concepto_factura, $this->pro_descripcion_orig,  $this->fac_tipo_comprobante_orig,  $this->fac_serie_orig,  $this->concepto_factura_orig);
            }
   }
//
