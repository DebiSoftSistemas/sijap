...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_v_jap_padron_x_ruta"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_v_jap_padron_x_ruta"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_v_jap_padron_x_ruta']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_v_jap_padron_x_ruta']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_v_jap_padron_x_ruta']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_v_jap_padron_x_ruta']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_v_jap_padron_x_ruta']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_v_jap_padron_x_ruta</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_v_jap_padron_x_ruta']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_v_jap_padron_x_ruta']['embutida_filho'] as $ind => $sc_init)
          {
