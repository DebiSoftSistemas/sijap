...
class grid_v_jap_padron_x_ruta_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_v_jap_padron_x_ruta']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_v_jap_padron_x_ruta']['campos_busca']))
      { 
   ...
   //---- 
   function quebra_geral_con_ruta($res_limit=false, $res_export=false)
   {
      global $nada, $nm_lang , $con_ruta, $cl_tipo_identificacion;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_ruta']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_ruta']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_ruta']['where_pesq']; 
      } 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_ruta']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_ruta']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_ruta']['contr_total_geral'] = "OK";
   } 

   //-----  con_ruta
   function quebra_con_ruta_con_ruta($con_ruta, $arg_sum_con_ruta) 
   {
      global $tot_con_ruta, $con_ruta, $cl_tipo_identificacion;
      $tot_con_ruta = array() ;  
