...
class buscar_v_jap_contrato_anticipos_ap_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . buscar_v_jap_contrato_anticipos_ap_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . buscar_v_jap_contrato_anticipos_ap_pack_protect_string($Tipo_filter[0]) . "\">.." . buscar_v_jap_contrato_anticipos_ap_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      }
   ...
   function lookup_ajax_cl_nombre($cl_nombre)
   {
      ...
      $nm_comando = "select distinct cl_nombre from " . $this->Ini->nm_tabela . " where (cl_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') and  #lowerI#cl_nombre#lowerF# like #lowerI#'" . $cl_nombre . "%'#lowerF#"; 
      $this->Sel_case_sensitive($nm_comando);
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 100, 0)) 
      { 
         while (!$rs->EOF) 
         { 
   ...
   function lookup_ajax_cl_identificacion($cl_identificacion)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct cl_identificacion from " . $this->Ini->nm_tabela . " where (cl_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') and  #lowerI#cl_identificacion#lowerF# like #lowerI#'" . $cl_identificacion . "%'#lowerF#"; 
      $this->Sel_case_sensitive($nm_comando);
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function lookup_ajax_con_numero_contrato($con_numero_contrato)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct con_numero_contrato from " . $this->Ini->nm_tabela . " where (cl_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') and  #lowerI#con_numero_contrato#lowerF# like #lowerI#'" . $con_numero_contrato . "%'#lowerF#"; 
      $this->Sel_case_sensitive($nm_comando);
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function lookup_ajax_con_numero_medidor($con_numero_medidor)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct con_numero_medidor from " . $this->Ini->nm_tabela . " where (cl_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') and  #lowerI#con_numero_medidor#lowerF# like #lowerI#'" . $con_numero_medidor . "%'#lowerF#"; 
      $this->Sel_case_sensitive($nm_comando);
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function lookup_ajax_con_numero_censo($con_numero_censo)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct con_numero_censo from " . $this->Ini->nm_tabela . " where (cl_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') and  #lowerI#con_numero_censo#lowerF# like #lowerI#'" . $con_numero_censo . "%'#lowerF#"; 
      $this->Sel_case_sensitive($nm_comando);
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "cl_id";$Nm_numeric[] = "con_id";$Nm_numeric[] = "cl_id";$Nm_numeric[] = "con_id";
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         $nm_ini_lower = "";
         $nm_fim_lower = "";
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>buscar_v_jap_contrato_anticipos_ap/buscar_v_jap_contrato_anticipos_ap_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="buscar_v_jap_contrato_anticipos_ap_ajax_search.js"></script>
 <script type="text/javascript" src="buscar_v_jap_contrato_anticipos_ap_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="buscar_v_jap_contrato_anticipos_ap_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['buscar_v_jap_contrato_anticipos_ap']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['buscar_v_jap_contrato_anticipos_ap']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
if ((isset($this->nm_mens_alert) && count($this->nm_mens_alert)) || (isset($this->Ini->nm_mens_alert) && count($this->Ini->nm_mens_alert))) {
   ...
   if (isset($this->nm_mens_alert) && !empty($this->nm_mens_alert))
   {
       foreach ($this->nm_mens_alert as $i_alert => $mensagem)
       {
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['ajax_nav'])
           { 
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'id_ac_con_numero_censo#NMF#' + search_get_text('id_ac_con_numero_censo') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   ...
   scClass = $("#id_ac_con_numero_censo").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_con_numero_censo").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
     ...
     select: function (event, ui) {
       $("#SC_con_numero_censo").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_con_numero_censo").val( $(this).val() );
       }
     }
   });
 });
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['buscar_v_jap_contrato_anticipos_ap']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['buscar_v_jap_contrato_anticipos_ap']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['buscar_v_jap_contrato_anticipos_ap']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("buscar_v_jap_contrato_anticipos_ap", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $cl_nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['campos_busca']['cl_nombre']; 
          $cl_nombre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['campos_busca']['cl_nombre_cond']; 
          $cl_identificacion = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['campos_busca']['cl_identificacion']; 
          $cl_identificacion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['campos_busca']['cl_identificacion_cond']; 
          $con_numero_contrato = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['campos_busca']['con_numero_contrato']; 
          $con_numero_contrato_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['campos_busca']['con_numero_contrato_cond']; 
          $con_numero_medidor = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['campos_busca']['con_numero_medidor']; 
          $con_numero_medidor_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['campos_busca']['con_numero_medidor_cond']; 
          $con_numero_censo = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['campos_busca']['con_numero_censo']; 
          $con_numero_censo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['campos_busca']['con_numero_censo_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['campos_busca']['NM_operador']; 
      } 
...
<?php
      ...
      $cl_nombre_look = (is_string($cl_nombre) ? substr($this->Db->qstr($cl_nombre), 1, -1) : $cl_nombre); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct cl_nombre from " . $this->Ini->nm_tabela . " where (cl_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') and #lowerI#cl_nombre#lowerF# = #lowerI#'$cl_nombre_look'#lowerF#"; 
      $this->Sel_case_sensitive($nm_comando);
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
...
?>
<INPUT  type="text" id="SC_cl_nombre" name="cl_nombre" value="<?php echo NM_encode_input($cl_nombre) ?>"  size=50 alt="{datatype: 'text', maxLength: 300, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: false}" onChange="nm_submit_form()" style="display: none">
<input class="sc-js-input scFilterObjectOdd css_cl_nombre_fil_obj" type="text" id="id_ac_cl_nombre" name="cl_nombre_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: false}" onChange="nm_submit_form()">
...
<?php
      ...
      $cl_identificacion_look = (is_string($cl_identificacion) ? substr($this->Db->qstr($cl_identificacion), 1, -1) : $cl_identificacion); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct cl_identificacion from " . $this->Ini->nm_tabela . " where (cl_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') and #lowerI#cl_identificacion#lowerF# = #lowerI#'$cl_identificacion_look'#lowerF#"; 
      $this->Sel_case_sensitive($nm_comando);
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
...
<?php
      ...
      $con_numero_contrato_look = (is_string($con_numero_contrato) ? substr($this->Db->qstr($con_numero_contrato), 1, -1) : $con_numero_contrato); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct con_numero_contrato from " . $this->Ini->nm_tabela . " where (cl_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') and #lowerI#con_numero_contrato#lowerF# = #lowerI#'$con_numero_contrato_look'#lowerF#"; 
      $this->Sel_case_sensitive($nm_comando);
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
...
?>
<INPUT  type="text" id="SC_con_numero_contrato" name="con_numero_contrato" value="<?php echo NM_encode_input($con_numero_contrato) ?>"  size=25 alt="{datatype: 'text', maxLength: 25, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd css_con_numero_contrato_fil_obj" type="text" id="id_ac_con_numero_contrato" name="con_numero_contrato_autocomp" size="25"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 25, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: false}">
...
<?php
      ...
      $con_numero_medidor_look = (is_string($con_numero_medidor) ? substr($this->Db->qstr($con_numero_medidor), 1, -1) : $con_numero_medidor); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct con_numero_medidor from " . $this->Ini->nm_tabela . " where (cl_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') and #lowerI#con_numero_medidor#lowerF# = #lowerI#'$con_numero_medidor_look'#lowerF#"; 
      $this->Sel_case_sensitive($nm_comando);
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
...
<input class="sc-js-input scFilterObjectEven css_con_numero_medidor_fil_obj" type="text" id="id_ac_con_numero_medidor" name="con_numero_medidor_autocomp" size="15"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
      ...
      $con_numero_censo_look = (is_string($con_numero_censo) ? substr($this->Db->qstr($con_numero_censo), 1, -1) : $con_numero_censo); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct con_numero_censo from " . $this->Ini->nm_tabela . " where (cl_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') and #lowerI#con_numero_censo#lowerF# = #lowerI#'$con_numero_censo_look'#lowerF#"; 
      $this->Sel_case_sensitive($nm_comando);
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
...
<input class="sc-js-input scFilterObjectOdd css_con_numero_censo_fil_obj" type="text" id="id_ac_con_numero_censo" name="con_numero_censo_autocomp" size="25"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 25, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (is_file("buscar_v_jap_contrato_anticipos_ap_help.txt"))
   {
      $Arq_WebHelp = file("buscar_v_jap_contrato_anticipos_ap_help.txt"); 
...
<?php
   ...
   elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['dashboard_info']['under_dashboard'])
   { }
   else
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['orig_pesq'] == "grid")
   {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "SIJAP/buscar_v_jap_contrato_anticipos_ap";
   ...
   function inicializa_vars()
   {
      ...
      $this->redir_modal = "";
      $this->nm_data = new nm_data("es");
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['cond_pesq'] = "";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "buscar_v_jap_contrato_anticipos_ap/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['id_ac_con_numero_censo'] = 'text_aut';
   ...
   function trata_campos()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['campos_busca']['cl_nombre'] = $cl_nombre; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['campos_busca']['cl_nombre_cond'] = $cl_nombre_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['campos_busca']['cl_identificacion'] = $cl_identificacion; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['campos_busca']['cl_identificacion_cond'] = $cl_identificacion_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['campos_busca']['con_numero_contrato'] = $con_numero_contrato; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['campos_busca']['con_numero_contrato_cond'] = $con_numero_contrato_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['campos_busca']['con_numero_medidor'] = $con_numero_medidor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['campos_busca']['con_numero_medidor_cond'] = $con_numero_medidor_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['campos_busca']['con_numero_censo'] = $con_numero_censo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['campos_busca']['con_numero_censo_cond'] = $con_numero_censo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['campos_busca'] = $Temp_Busca;
      }
      $_SESSION['scriptcase']['buscar_v_jap_contrato_anticipos_ap']['contr_erro'] = 'on';
...
if (!isset($this->sc_temp_Igtech_RucEmpresa)) {$this->sc_temp_Igtech_RucEmpresa = (isset($_SESSION['Igtech_RucEmpresa'])) ? $_SESSION['Igtech_RucEmpresa'] : "";}
 if($cl_nombre <>'' or $cl_identificacion <>'' or $con_numero_medidor <>'' or $con_numero_contrato <>'' or $con_numero_censo <>''){

	if($cl_nombre <>''){
		$select_sql="SELECT distinct cl_id
					FROM del_cliente 
					left join jap_contrato on cl_id=con_propietario
					where
					trim(cl_nombre ||' - ' || cl_identificacion) = '".$cl_nombre ."'
	...
	if($cl_identificacion <>''){
		$select_sql="SELECT distinct cl_id
					...
					left join jap_contrato on cl_id=con_propietario
					where
					trim(cl_identificacion)='".$cl_identificacion ."'
					and cl_empresa='".$this->sc_temp_Igtech_RucEmpresa."'
					and cl_estado='V';";  
	}
	
	if($con_numero_medidor <>''){
		$select_sql="SELECT distinct cl_id,con_id
					FROM del_cliente 
					left join jap_contrato on cl_id=con_propietario
					where
					trim(con_numero_medidor)='".$con_numero_medidor ."'
					and cl_empresa='".$this->sc_temp_Igtech_RucEmpresa."'
					and cl_estado='V';";  
	}
	...
	if($con_numero_contrato <>''){
		$select_sql="SELECT distinct cl_id,con_id
					...
					left join jap_contrato on cl_id=con_propietario
					where
					trim(con_numero_contrato)='".$con_numero_contrato ."'
					and cl_empresa='".$this->sc_temp_Igtech_RucEmpresa."'
					and cl_estado='V';";  
	}
	if($con_numero_censo <>''){
		$select_sql="SELECT distinct cl_id,con_id
					...
					left join jap_contrato on cl_id=con_propietario
					where
					trim(con_numero_censo)='".$con_numero_censo ."'
					and cl_empresa='".$this->sc_temp_Igtech_RucEmpresa."'
					and cl_estado='V';";  
	}
	...
	if(isset($rs[0][0]) ){
			...
			$redir_app    = 'form_recaudacion_anticipos_contrato';
			$redir_target = '_self';
			$redir_param  = array(  
							'cl_id' => $rs[0][0],
							);
...
$_SESSION['scriptcase']['buscar_v_jap_contrato_anticipos_ap']['contr_erro'] = 'off'; 
    ...
    if ($con_numero_censo != '') {
      ...
      if (isset($con_numero_contrato) && !empty($con_numero_contrato))
      { 
           $con_numero_contrato = strtoupper($con_numero_contrato);
      } 
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['cond_dyn_search'] = "";
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['where_filtro'] = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['where_filter'] = $this->comando_filtro;
      $this->retorna_pesq();
   }
   function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $alt_modal=0, $larg_modal=0, $opc="")
   {
      if (is_array($nm_apl_parms))
      {
          ...
          foreach ($nm_apl_parms as $par => $val)
          {
              ...
              elseif (substr($val, 0, 1) == "[")
              {
                  $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap'][substr($val, 1, -1)];
              }
              else
              {
                  $tmp_parms .= $val;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['iframe_print']) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_v_jap_contrato_anticipos_ap']['iframe_print'] )
      {
          $target = "_parent";
      }
   ?>
