...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_buscar_cliente"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_buscar_cliente"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_recaudacion_factura'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_buscar_cliente']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_buscar_cliente']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_buscar_cliente']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_buscar_cliente']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_buscar_cliente']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_buscar_cliente</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_buscar_cliente']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_buscar_cliente']['embutida_filho'] as $ind => $sc_init)
          {
