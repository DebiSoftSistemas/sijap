...
<?php
   ...
   $Ord_Cmp = new grid_buscar_cliente_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_buscar_cliente_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_buscar_cliente']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_buscar_cliente']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["cl_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_buscar_cliente']['labels']["cl_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_buscar_cliente']['labels']["cl_nombre"] : "" . $this->Nm_lang['lang_cliente'] . "";
   $tab_ger_campos['cl_identificacion'] = "on";
   $tab_def_campos['cl_identificacion'] = "cl_identificacion";
   $tab_labels["cl_identificacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_buscar_cliente']['labels']["cl_identificacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_buscar_cliente']['labels']["cl_identificacion"] : "" . $this->Nm_lang['lang_lot_identificacion'] . "";
   $tab_ger_campos['cl_direccion'] = "on";
   $tab_def_campos['cl_direccion'] = "cl_direccion";
   $tab_labels["cl_direccion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_buscar_cliente']['labels']["cl_direccion"])) ? $_SESSION['sc_session'][$sc_init]['grid_buscar_cliente']['labels']["cl_direccion"] : "" . $this->Nm_lang['lang_direccion'] . "";
   $tab_ger_campos['cl_telefono'] = "on";
   $tab_def_campos['cl_telefono'] = "cl_telefono";
   $tab_labels["cl_telefono"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_buscar_cliente']['labels']["cl_telefono"])) ? $_SESSION['sc_session'][$sc_init]['grid_buscar_cliente']['labels']["cl_telefono"] : "" . $this->Nm_lang['lang_lot_telefono'] . "";
   $tab_ger_campos['cl_email'] = "on";
   $tab_def_campos['cl_email'] = "cl_email";
   $tab_labels["cl_email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_buscar_cliente']['labels']["cl_email"])) ? $_SESSION['sc_session'][$sc_init]['grid_buscar_cliente']['labels']["cl_email"] : "" . $this->Nm_lang['lang_email'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_buscar_cliente']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_buscar_cliente']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_buscar_cliente']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_buscar_cliente']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_buscar_cliente']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_buscar_cliente']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_buscar_cliente']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_buscar_cliente']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_buscar_cliente']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_buscar_cliente']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_buscar_cliente']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_buscar_cliente']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_buscar_cliente_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_buscar_cliente']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_buscar_cliente']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_buscar_cliente']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_buscar_cliente']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_buscar_cliente']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
