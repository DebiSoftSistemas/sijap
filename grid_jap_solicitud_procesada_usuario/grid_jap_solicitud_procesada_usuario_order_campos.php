<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_jap_solicitud_procesada_usuario']['glo_nm_path_imag_temp'] . "/sc_apl_default_SIJAP.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_jap_solicitud_procesada_usuario_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_jap_solicitud_procesada_usuario_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_jap_solicitud_procesada_usuario']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_jap_solicitud_procesada_usuario']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['jap_solicitud_inspeccion_si_fecha'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['jap_solicitud_inspeccion_si_fecha'] = "cmp_maior_30_1";
   }
   else
   {
       $tab_def_campos['jap_solicitud_inspeccion_si_fecha'] = "jap_solicitud_inspeccion.si_fecha";
   }
   $tab_labels["jap_solicitud_inspeccion_si_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_solicitud_procesada_usuario']['labels']["jap_solicitud_inspeccion_si_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_solicitud_procesada_usuario']['labels']["jap_solicitud_inspeccion_si_fecha"] : "" . $this->Nm_lang['lang_fecha'] . "";
   $tab_ger_campos['jap_solicitud_inspeccion_si_secuecial'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['jap_solicitud_inspeccion_si_secuecial'] = "cmp_maior_30_2";
   }
   else
   {
       $tab_def_campos['jap_solicitud_inspeccion_si_secuecial'] = "jap_solicitud_inspeccion.si_secuecial";
   }
   $tab_labels["jap_solicitud_inspeccion_si_secuecial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_solicitud_procesada_usuario']['labels']["jap_solicitud_inspeccion_si_secuecial"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_solicitud_procesada_usuario']['labels']["jap_solicitud_inspeccion_si_secuecial"] : "" . $this->Nm_lang['lang_secuencial'] . "";
   $tab_ger_campos['jap_solicitud_inspeccion_si_contrato'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['jap_solicitud_inspeccion_si_contrato'] = "cmp_maior_30_3";
   }
   else
   {
       $tab_def_campos['jap_solicitud_inspeccion_si_contrato'] = "jap_solicitud_inspeccion.si_contrato";
   }
   $tab_labels["jap_solicitud_inspeccion_si_contrato"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_solicitud_procesada_usuario']['labels']["jap_solicitud_inspeccion_si_contrato"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_solicitud_procesada_usuario']['labels']["jap_solicitud_inspeccion_si_contrato"] : "" . $this->Nm_lang['lang_contrato'] . "";
   $tab_ger_campos['jap_solicitud_inspeccion_si_tipo_inspeccion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['jap_solicitud_inspeccion_si_tipo_inspeccion'] = "cmp_maior_30_4";
   }
   else
   {
       $tab_def_campos['jap_solicitud_inspeccion_si_tipo_inspeccion'] = "jap_solicitud_inspeccion.si_tipo_inspeccion";
   }
   $tab_labels["jap_solicitud_inspeccion_si_tipo_inspeccion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_solicitud_procesada_usuario']['labels']["jap_solicitud_inspeccion_si_tipo_inspeccion"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_solicitud_procesada_usuario']['labels']["jap_solicitud_inspeccion_si_tipo_inspeccion"] : "" . $this->Nm_lang['lang_tipo_inspeccion'] . "";
   $tab_ger_campos['jap_solicitud_inspeccion_si_comentario'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['jap_solicitud_inspeccion_si_comentario'] = "cmp_maior_30_5";
   }
   else
   {
       $tab_def_campos['jap_solicitud_inspeccion_si_comentario'] = "jap_solicitud_inspeccion.si_comentario";
   }
   $tab_labels["jap_solicitud_inspeccion_si_comentario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_solicitud_procesada_usuario']['labels']["jap_solicitud_inspeccion_si_comentario"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_solicitud_procesada_usuario']['labels']["jap_solicitud_inspeccion_si_comentario"] : "" . $this->Nm_lang['lang_comentario'] . "";
   $tab_ger_campos['jap_solicitud_inspeccion_si_fecha_inspeccion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['jap_solicitud_inspeccion_si_fecha_inspeccion'] = "cmp_maior_30_6";
   }
   else
   {
       $tab_def_campos['jap_solicitud_inspeccion_si_fecha_inspeccion'] = "jap_solicitud_inspeccion.si_fecha_inspeccion";
   }
   $tab_labels["jap_solicitud_inspeccion_si_fecha_inspeccion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_solicitud_procesada_usuario']['labels']["jap_solicitud_inspeccion_si_fecha_inspeccion"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_solicitud_procesada_usuario']['labels']["jap_solicitud_inspeccion_si_fecha_inspeccion"] : "" . $this->Nm_lang['lang_fecha_inspeccion'] . "";
   $tab_ger_campos['jap_solicitud_inspeccion_si_observacion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['jap_solicitud_inspeccion_si_observacion'] = "cmp_maior_30_7";
   }
   else
   {
       $tab_def_campos['jap_solicitud_inspeccion_si_observacion'] = "jap_solicitud_inspeccion.si_observacion";
   }
   $tab_labels["jap_solicitud_inspeccion_si_observacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_solicitud_procesada_usuario']['labels']["jap_solicitud_inspeccion_si_observacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_solicitud_procesada_usuario']['labels']["jap_solicitud_inspeccion_si_observacion"] : "" . $this->Nm_lang['lang_observacion'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_jap_solicitud_procesada_usuario']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_jap_solicitud_procesada_usuario']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_jap_solicitud_procesada_usuario']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_jap_solicitud_procesada_usuario']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_jap_solicitud_procesada_usuario']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_jap_solicitud_procesada_usuario']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_jap_solicitud_procesada_usuario']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_jap_solicitud_procesada_usuario']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_jap_solicitud_procesada_usuario']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_jap_solicitud_procesada_usuario']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_jap_solicitud_procesada_usuario']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_jap_solicitud_procesada_usuario']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_solicitud_procesada'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_jap_solicitud_procesada_usuario_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_jap_solicitud_procesada_usuario']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_jap_solicitud_procesada_usuario']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_jap_solicitud_procesada_usuario']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_jap_solicitud_procesada_usuario']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_jap_solicitud_procesada_usuario']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
