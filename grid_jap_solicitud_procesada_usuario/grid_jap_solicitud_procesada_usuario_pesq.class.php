...
class grid_jap_solicitud_procesada_usuario_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_jap_solicitud_procesada_usuario_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_jap_solicitud_procesada_usuario_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_jap_solicitud_procesada_usuario_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "jap_solicitud_inspeccion_si_id";$Nm_numeric[] = "jap_solicitud_inspeccion_si_secuecial";$Nm_numeric[] = "jap_solicitud_inspeccion_si_contrato";$Nm_numeric[] = "jap_solicitud_inspeccion_si_tipo_inspeccion";
      $campo_join = strtolower(str_replace(".", "_", $nome));
      if (in_array($campo_join, $Nm_numeric))
      {
          if ($condicao == "EP" || $condicao == "NE")
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$campo_join]);
              return;
          }
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      $Nm_datas[] = "jap_solicitud_inspeccion.si_fecha";$Nm_datas[] = "jap_solicitud_inspeccion_si_fecha";$Nm_datas[] = "jap_solicitud_inspeccion.si_fecha_inspeccion";$Nm_datas[] = "jap_solicitud_inspeccion_si_fecha_inspeccion";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_jap_solicitud_procesada_usuario/grid_jap_solicitud_procesada_usuario_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_jap_solicitud_procesada_usuario_ajax_search.js"></script>
 <script type="text/javascript" src="grid_jap_solicitud_procesada_usuario_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_jap_solicitud_procesada_usuario_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_jap_solicitud_procesada_usuario']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_jap_solicitud_procesada_usuario']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_jap_solicitud_inspeccion_si_contrato_cond#NMF#' + search_get_sel_txt('SC_jap_solicitud_inspeccion_si_contrato_cond') + '@NMF@';
  str_out += 'SC_jap_solicitud_inspeccion_si_contrato#NMF#' + search_get_select('SC_jap_solicitud_inspeccion_si_contrato') + '@NMF@';
  str_out += 'SC_jap_solicitud_inspeccion_si_tipo_inspeccion_cond#NMF#' + search_get_sel_txt('SC_jap_solicitud_inspeccion_si_tipo_inspeccion_cond') + '@NMF@';
  str_out += 'SC_jap_solicitud_inspeccion_si_tipo_inspeccion#NMF#' + search_get_select('SC_jap_solicitud_inspeccion_si_tipo_inspeccion') + '@NMF@';
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $jap_solicitud_inspeccion_si_contrato_cond, $jap_solicitud_inspeccion_si_contrato,
             $jap_solicitud_inspeccion_si_tipo_inspeccion_cond, $jap_solicitud_inspeccion_si_tipo_inspeccion,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $jap_solicitud_inspeccion_si_contrato = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['campos_busca']['jap_solicitud_inspeccion_si_contrato']; 
          $jap_solicitud_inspeccion_si_contrato_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['campos_busca']['jap_solicitud_inspeccion_si_contrato_cond']; 
          $jap_solicitud_inspeccion_si_tipo_inspeccion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['campos_busca']['jap_solicitud_inspeccion_si_tipo_inspeccion']; 
          $jap_solicitud_inspeccion_si_tipo_inspeccion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['campos_busca']['jap_solicitud_inspeccion_si_tipo_inspeccion_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['campos_busca']['NM_operador']; 
      } 
      if (!isset($jap_solicitud_inspeccion_si_contrato_cond) || empty($jap_solicitud_inspeccion_si_contrato_cond))
      {
         $jap_solicitud_inspeccion_si_contrato_cond = "eq";
      }
      if (!isset($jap_solicitud_inspeccion_si_tipo_inspeccion_cond) || empty($jap_solicitud_inspeccion_si_tipo_inspeccion_cond))
      {
         $jap_solicitud_inspeccion_si_tipo_inspeccion_cond = "eq";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_jap_solicitud_inspeccion_si_contrato = (in_array($jap_solicitud_inspeccion_si_contrato_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_jap_solicitud_inspeccion_si_tipo_inspeccion = (in_array($jap_solicitud_inspeccion_si_tipo_inspeccion_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($jap_solicitud_inspeccion_si_contrato) || $jap_solicitud_inspeccion_si_contrato == "")
      {
          $jap_solicitud_inspeccion_si_contrato = "";
      }
      if (isset($jap_solicitud_inspeccion_si_contrato) && !empty($jap_solicitud_inspeccion_si_contrato))
      {
      ...
      if (!isset($jap_solicitud_inspeccion_si_tipo_inspeccion) || $jap_solicitud_inspeccion_si_tipo_inspeccion == "")
      {
          $jap_solicitud_inspeccion_si_tipo_inspeccion = "";
      }
      if (isset($jap_solicitud_inspeccion_si_tipo_inspeccion) && !empty($jap_solicitud_inspeccion_si_tipo_inspeccion))
      {
...
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_jap_solicitud_inspeccion_si_contrato_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['jap_solicitud_inspeccion_si_contrato'])) ? $this->New_label['jap_solicitud_inspeccion_si_contrato'] : "" . $this->Ini->Nm_lang['lang_contrato'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_jap_solicitud_inspeccion_si_contrato_cond" name="jap_solicitud_inspeccion_si_contrato_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_jap_solicitud_inspeccion_si_contrato" <?php echo $str_hide_jap_solicitud_inspeccion_si_contrato?> valign="top">
 ...
 $nmgp_tab_label .= "jap_solicitud_inspeccion_si_contrato?#?" . $SC_Label . "?@?";
...
?>
   <span id="idAjaxSelect_jap_solicitud_inspeccion_si_contrato">
      <SELECT class="scFilterObjectOdd" id="SC_jap_solicitud_inspeccion_si_contrato" name="jap_solicitud_inspeccion_si_contrato"  size="1">
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $jap_solicitud_inspeccion_si_contrato)
            {
                    $jap_solicitud_inspeccion_si_contrato_sel = ($nm_opc_cod === $jap_solicitud_inspeccion_si_contrato) ? "selected" : "";
            }
            else
            {
...
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $jap_solicitud_inspeccion_si_contrato_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
?>
      ...
      <TD id='SC_jap_solicitud_inspeccion_si_tipo_inspeccion_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['jap_solicitud_inspeccion_si_tipo_inspeccion'])) ? $this->New_label['jap_solicitud_inspeccion_si_tipo_inspeccion'] : "" . $this->Ini->Nm_lang['lang_tipo_inspeccion'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_jap_solicitud_inspeccion_si_tipo_inspeccion_cond" name="jap_solicitud_inspeccion_si_tipo_inspeccion_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_jap_solicitud_inspeccion_si_tipo_inspeccion" <?php echo $str_hide_jap_solicitud_inspeccion_si_tipo_inspeccion?> valign="top">
 ...
 $nmgp_tab_label .= "jap_solicitud_inspeccion_si_tipo_inspeccion?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
   <span id="idAjaxSelect_jap_solicitud_inspeccion_si_tipo_inspeccion">
      <SELECT class="scFilterObjectEven" id="SC_jap_solicitud_inspeccion_si_tipo_inspeccion" name="jap_solicitud_inspeccion_si_tipo_inspeccion"  size="1">
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            list($nm_opc_val, $nm_opc_cod, $nm_opc_sel) = $temp_bug_list;
            if ($nm_opc_cod == "@ ") {$nm_opc_cod = trim($nm_opc_cod); }
            if ("" != $jap_solicitud_inspeccion_si_tipo_inspeccion)
            {
                    $jap_solicitud_inspeccion_si_tipo_inspeccion_sel = ($nm_opc_cod === $jap_solicitud_inspeccion_si_tipo_inspeccion) ? "selected" : "";
            }
            else
            {
            ...
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $jap_solicitud_inspeccion_si_tipo_inspeccion_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_jap_solicitud_procesada_usuario_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_jap_solicitud_procesada_usuario']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_jap_solicitud_procesada_usuario']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.jap_solicitud_inspeccion_si_contrato_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_jap_solicitud_inspeccion_si_contrato'), document.F1.jap_solicitud_inspeccion_si_contrato_cond, 'jap_solicitud_inspeccion_si_contrato');
   document.F1.jap_solicitud_inspeccion_si_contrato.value = "";
   document.F1.jap_solicitud_inspeccion_si_tipo_inspeccion_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_jap_solicitud_inspeccion_si_tipo_inspeccion'), document.F1.jap_solicitud_inspeccion_si_tipo_inspeccion_cond, 'jap_solicitud_inspeccion_si_tipo_inspeccion');
   document.F1.jap_solicitud_inspeccion_si_tipo_inspeccion.value = "";
   Sc_carga_select2('all');
 }
 function Sc_carga_select2(Field)
 {
    if (Field == 'all' || Field == 'jap_solicitud_inspeccion_si_contrato') {
       Sc_carga_select2_jap_solicitud_inspeccion_si_contrato();
    }
    if (Field == 'all' || Field == 'jap_solicitud_inspeccion_si_tipo_inspeccion') {
       Sc_carga_select2_jap_solicitud_inspeccion_si_tipo_inspeccion();
    }
 }
 function Sc_carga_select2_jap_solicitud_inspeccion_si_contrato()
 {
  $("#SC_jap_solicitud_inspeccion_si_contrato").select2(
    {
 ...
 function Sc_carga_select2_jap_solicitud_inspeccion_si_tipo_inspeccion()
 {
  $("#SC_jap_solicitud_inspeccion_si_tipo_inspeccion").select2(
    {
      minimumResultsForSearch: Infinity,
      language: {
        noResults: function() {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_jap_solicitud_procesada_usuario/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_jap_solicitud_inspeccion_si_contrato_cond'] = 'cond';
      $tp_fields['SC_jap_solicitud_inspeccion_si_contrato'] = 'select';
      $tp_fields['SC_jap_solicitud_inspeccion_si_tipo_inspeccion_cond'] = 'cond';
      $tp_fields['SC_jap_solicitud_inspeccion_si_tipo_inspeccion'] = 'select';
   ...
   {
      global $jap_solicitud_inspeccion_si_contrato_cond, $jap_solicitud_inspeccion_si_contrato,
             $jap_solicitud_inspeccion_si_tipo_inspeccion_cond, $jap_solicitud_inspeccion_si_tipo_inspeccion, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $jap_solicitud_inspeccion_si_contrato_cond_salva = $jap_solicitud_inspeccion_si_contrato_cond; 
      if (!isset($jap_solicitud_inspeccion_si_contrato_input_2) || $jap_solicitud_inspeccion_si_contrato_input_2 == "")
      {
          $jap_solicitud_inspeccion_si_contrato_input_2 = $jap_solicitud_inspeccion_si_contrato;
      }
      $jap_solicitud_inspeccion_si_tipo_inspeccion_cond_salva = $jap_solicitud_inspeccion_si_tipo_inspeccion_cond; 
      if (!isset($jap_solicitud_inspeccion_si_tipo_inspeccion_input_2) || $jap_solicitud_inspeccion_si_tipo_inspeccion_input_2 == "")
      {
          $jap_solicitud_inspeccion_si_tipo_inspeccion_input_2 = $jap_solicitud_inspeccion_si_tipo_inspeccion;
      }
      $tmp_pos = (is_string($jap_solicitud_inspeccion_si_contrato)) ? strpos($jap_solicitud_inspeccion_si_contrato, "##@@") : false;
      if ($tmp_pos === false) {
          $L_lookup = $jap_solicitud_inspeccion_si_contrato;
      }
      else {
          $L_lookup = substr($jap_solicitud_inspeccion_si_contrato, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['psq_check_ret']['jap_solicitud_inspeccion_si_contrato'])) {
      ...
      $tmp_pos = (is_string($jap_solicitud_inspeccion_si_tipo_inspeccion)) ? strpos($jap_solicitud_inspeccion_si_tipo_inspeccion, "##@@") : false;
      if ($tmp_pos === false) {
          $L_lookup = $jap_solicitud_inspeccion_si_tipo_inspeccion;
      }
      else {
          $L_lookup = substr($jap_solicitud_inspeccion_si_tipo_inspeccion, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['psq_check_ret']['jap_solicitud_inspeccion_si_tipo_inspeccion'])) {
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['campos_busca']['jap_solicitud_inspeccion_si_contrato'] = $jap_solicitud_inspeccion_si_contrato; 
      if (is_array($jap_solicitud_inspeccion_si_contrato) && !empty($jap_solicitud_inspeccion_si_contrato))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['Grid_search'][$I_Grid]['val'][0] = $jap_solicitud_inspeccion_si_contrato;
      }
      elseif ($jap_solicitud_inspeccion_si_contrato_cond_salva == "nu" || $jap_solicitud_inspeccion_si_contrato_cond_salva == "nn" || $jap_solicitud_inspeccion_si_contrato_cond_salva == "ep" || $jap_solicitud_inspeccion_si_contrato_cond_salva == "ne" || !empty($jap_solicitud_inspeccion_si_contrato))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['Grid_search'][$I_Grid]['val'][0][0] = $jap_solicitud_inspeccion_si_contrato;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['campos_busca']['jap_solicitud_inspeccion_si_contrato_cond'] = $jap_solicitud_inspeccion_si_contrato_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['Grid_search'][$I_Grid]['cmp'] = "jap_solicitud_inspeccion_si_contrato"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['Grid_search'][$I_Grid]['opc'] = $jap_solicitud_inspeccion_si_contrato_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq']['jap_solicitud_inspeccion_si_contrato'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['campos_busca']['jap_solicitud_inspeccion_si_tipo_inspeccion'] = $jap_solicitud_inspeccion_si_tipo_inspeccion; 
      if (is_array($jap_solicitud_inspeccion_si_tipo_inspeccion) && !empty($jap_solicitud_inspeccion_si_tipo_inspeccion))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['Grid_search'][$I_Grid]['val'][0] = $jap_solicitud_inspeccion_si_tipo_inspeccion;
      }
      elseif ($jap_solicitud_inspeccion_si_tipo_inspeccion_cond_salva == "nu" || $jap_solicitud_inspeccion_si_tipo_inspeccion_cond_salva == "nn" || $jap_solicitud_inspeccion_si_tipo_inspeccion_cond_salva == "ep" || $jap_solicitud_inspeccion_si_tipo_inspeccion_cond_salva == "ne" || !empty($jap_solicitud_inspeccion_si_tipo_inspeccion))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['Grid_search'][$I_Grid]['val'][0][0] = $jap_solicitud_inspeccion_si_tipo_inspeccion;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['campos_busca']['jap_solicitud_inspeccion_si_tipo_inspeccion_cond'] = $jap_solicitud_inspeccion_si_tipo_inspeccion_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['Grid_search'][$I_Grid]['cmp'] = "jap_solicitud_inspeccion_si_tipo_inspeccion"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['Grid_search'][$I_Grid]['opc'] = $jap_solicitud_inspeccion_si_tipo_inspeccion_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['grid_pesq']['jap_solicitud_inspeccion_si_tipo_inspeccion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $Conteudo = $jap_solicitud_inspeccion_si_contrato;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      }
      $this->cmp_formatado['jap_solicitud_inspeccion_si_contrato'] = $Conteudo;
      $Conteudo = $jap_solicitud_inspeccion_si_tipo_inspeccion;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      }
      $this->cmp_formatado['jap_solicitud_inspeccion_si_tipo_inspeccion'] = $Conteudo;

      //----- $jap_solicitud_inspeccion_si_contrato
      $this->Date_part = false;
      if (isset($jap_solicitud_inspeccion_si_contrato))
      {
         $this->monta_condicao("jap_solicitud_inspeccion.si_contrato", $jap_solicitud_inspeccion_si_contrato_cond, $jap_solicitud_inspeccion_si_contrato, "", "jap_solicitud_inspeccion_si_contrato", "INT4", false);
      }

      //----- $jap_solicitud_inspeccion_si_tipo_inspeccion
      $this->Date_part = false;
      if (isset($jap_solicitud_inspeccion_si_tipo_inspeccion))
      {
         $this->monta_condicao("jap_solicitud_inspeccion.si_tipo_inspeccion", $jap_solicitud_inspeccion_si_tipo_inspeccion_cond, $jap_solicitud_inspeccion_si_tipo_inspeccion, "", "jap_solicitud_inspeccion_si_tipo_inspeccion", "INT4", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['where_pesq'] = $this->comando;
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['cond_dyn_search'] = "";
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_solicitud_procesada_usuario']['cond_pesq'] .= $this->NM_operador;
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "jap_solicitud_inspeccion_si_contrato" : return ('class="scFilterObjectOdd"'); break;
         case "jap_solicitud_inspeccion_si_tipo_inspeccion" : return ('class="scFilterObjectEven"'); break;
         default       : return ("");
      }
   }
