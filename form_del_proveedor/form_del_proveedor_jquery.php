...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_pr_id' + iSeqRow).bind('blur', function() { sc_form_del_proveedor_pr_id_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_del_proveedor_pr_id_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pr_empresa' + iSeqRow).bind('blur', function() { sc_form_del_proveedor_pr_empresa_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_del_proveedor_pr_empresa_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pr_nombre' + iSeqRow).bind('blur', function() { sc_form_del_proveedor_pr_nombre_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_del_proveedor_pr_nombre_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pr_identificacion' + iSeqRow).bind('blur', function() { sc_form_del_proveedor_pr_identificacion_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_form_del_proveedor_pr_identificacion_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pr_ciudad' + iSeqRow).bind('blur', function() { sc_form_del_proveedor_pr_ciudad_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_del_proveedor_pr_ciudad_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pr_direccion' + iSeqRow).bind('blur', function() { sc_form_del_proveedor_pr_direccion_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_del_proveedor_pr_direccion_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pr_telefono' + iSeqRow).bind('blur', function() { sc_form_del_proveedor_pr_telefono_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_del_proveedor_pr_telefono_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pr_celular' + iSeqRow).bind('blur', function() { sc_form_del_proveedor_pr_celular_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_del_proveedor_pr_celular_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pr_email' + iSeqRow).bind('blur', function() { sc_form_del_proveedor_pr_email_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_del_proveedor_pr_email_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pr_retencion_iva' + iSeqRow).bind('blur', function() { sc_form_del_proveedor_pr_retencion_iva_onblur(this, iSeqRow) })
                                              .bind('change', function() { sc_form_del_proveedor_pr_retencion_iva_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pr_parte_relacionada' + iSeqRow).bind('blur', function() { sc_form_del_proveedor_pr_parte_relacionada_onblur(this, iSeqRow) })
                                                  .bind('change', function() { sc_form_del_proveedor_pr_parte_relacionada_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pr_tipo_persona' + iSeqRow).bind('blur', function() { sc_form_del_proveedor_pr_tipo_persona_onblur(this, iSeqRow) })
                                             .bind('change', function() { sc_form_del_proveedor_pr_tipo_persona_onchange(this, iSeqRow) })
...
function sc_form_del_proveedor_pr_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_proveedor_pr_empresa_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_proveedor_pr_nombre_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_proveedor_pr_identificacion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_proveedor_pr_ciudad_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_proveedor_pr_direccion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_proveedor_pr_telefono_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_proveedor_pr_celular_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_proveedor_pr_email_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_proveedor_pr_retencion_iva_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_proveedor_pr_parte_relacionada_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_del_proveedor_pr_tipo_persona_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_form_del_proveedor_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_del_proveedor')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
