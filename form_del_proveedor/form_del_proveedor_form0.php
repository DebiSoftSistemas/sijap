...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_del_proveedor/form_del_proveedor_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_del_proveedor_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_del_proveedor_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['link_info']['remove_border']) {
...
<?php
 include_once("form_del_proveedor_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_del_proveedor'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_del_proveedor'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['run_iframe'] != "R")
{
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['fast_search'][2] : "";
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_disabled']['']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_disabled']['']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_label']['']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_label']['']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_label'][''];
        }
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_pr_id_line" id="hidden_field_data_pr_id" style="<?php echo $sStyleHidden_pr_id; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pr_id_line" style="vertical-align: top;padding: 0px">
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { 
 ?>
<span id="id_read_on_pr_id" css_pr_id_line" style="<?php echo $sStyleReadLab_pr_id; ?>"><?php echo $this->form_format_readonly("pr_id", $this->form_encode_input($this->pr_id)); ?></span><span id="id_read_off_pr_id" class="css_read_off_pr_id" style="<?php echo $sStyleReadInp_pr_id; ?>"><input type="hidden" name="pr_id" value="<?php echo $this->form_encode_input($pr_id) . "\">"?><span id="id_ajax_label_pr_id"><?php echo nl2br($pr_id); ?></span>
</span><?php } else { ?>
&nbsp;
<?php } ?>
</span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_pr_id_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_pr_id_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pr_empresa_label" id="hidden_field_label_pr_empresa" style="<?php echo $sStyleHidden_pr_empresa; ?>"><span id="id_label_pr_empresa"><?php echo $this->nm_new_label['pr_empresa']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['php_cmp_required']['pr_empresa']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['php_cmp_required']['pr_empresa'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_pr_empresa_line" id="hidden_field_data_pr_empresa" style="<?php echo $sStyleHidden_pr_empresa; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pr_empresa_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pr_tipo_identificacion_label" id="hidden_field_label_pr_tipo_identificacion" style="<?php echo $sStyleHidden_pr_tipo_identificacion; ?>"><span id="id_label_pr_tipo_identificacion"><?php echo $this->nm_new_label['pr_tipo_identificacion']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['php_cmp_required']['pr_tipo_identificacion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['php_cmp_required']['pr_tipo_identificacion'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pr_tipo_persona_label" id="hidden_field_label_pr_tipo_persona" style="<?php echo $sStyleHidden_pr_tipo_persona; ?>"><span id="id_label_pr_tipo_persona"><?php echo $this->nm_new_label['pr_tipo_persona']; ?></span></TD>
    <TD class="scFormDataOdd css_pr_tipo_persona_line" id="hidden_field_data_pr_tipo_persona" style="<?php echo $sStyleHidden_pr_tipo_persona; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pr_tipo_persona_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pr_identificacion_label" id="hidden_field_label_pr_identificacion" style="<?php echo $sStyleHidden_pr_identificacion; ?>"><span id="id_label_pr_identificacion"><?php echo $this->nm_new_label['pr_identificacion']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['php_cmp_required']['pr_identificacion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['php_cmp_required']['pr_identificacion'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_pr_identificacion_line" id="hidden_field_data_pr_identificacion" style="<?php echo $sStyleHidden_pr_identificacion; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pr_identificacion_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pr_nombre_label" id="hidden_field_label_pr_nombre" style="<?php echo $sStyleHidden_pr_nombre; ?>"><span id="id_label_pr_nombre"><?php echo $this->nm_new_label['pr_nombre']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['php_cmp_required']['pr_nombre']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['php_cmp_required']['pr_nombre'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_pr_nombre_line" id="hidden_field_data_pr_nombre" style="<?php echo $sStyleHidden_pr_nombre; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pr_nombre_line" style="vertical-align: top;padding: 0px">
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pr_parte_relacionada_label" id="hidden_field_label_pr_parte_relacionada" style="<?php echo $sStyleHidden_pr_parte_relacionada; ?>"><span id="id_label_pr_parte_relacionada"><?php echo $this->nm_new_label['pr_parte_relacionada']; ?></span></TD>
    <TD class="scFormDataOdd css_pr_parte_relacionada_line" id="hidden_field_data_pr_parte_relacionada" style="<?php echo $sStyleHidden_pr_parte_relacionada; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pr_parte_relacionada_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['Lookup_pr_parte_relacionada'][] = 'S'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pr_email_label" id="hidden_field_label_pr_email" style="<?php echo $sStyleHidden_pr_email; ?>"><span id="id_label_pr_email"><?php echo $this->nm_new_label['pr_email']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['php_cmp_required']['pr_email']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['php_cmp_required']['pr_email'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_pr_email_line" id="hidden_field_data_pr_email" style="<?php echo $sStyleHidden_pr_email; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pr_email_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pr_telefono_label" id="hidden_field_label_pr_telefono" style="<?php echo $sStyleHidden_pr_telefono; ?>"><span id="id_label_pr_telefono"><?php echo $this->nm_new_label['pr_telefono']; ?></span></TD>
    <TD class="scFormDataOdd css_pr_telefono_line" id="hidden_field_data_pr_telefono" style="<?php echo $sStyleHidden_pr_telefono; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pr_telefono_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pr_celular_label" id="hidden_field_label_pr_celular" style="<?php echo $sStyleHidden_pr_celular; ?>"><span id="id_label_pr_celular"><?php echo $this->nm_new_label['pr_celular']; ?></span></TD>
    <TD class="scFormDataOdd css_pr_celular_line" id="hidden_field_data_pr_celular" style="<?php echo $sStyleHidden_pr_celular; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pr_celular_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pr_pais_label" id="hidden_field_label_pr_pais" style="<?php echo $sStyleHidden_pr_pais; ?>"><span id="id_label_pr_pais"><?php echo $this->nm_new_label['pr_pais']; ?></span></TD>
    <TD class="scFormDataOdd css_pr_pais_line" id="hidden_field_data_pr_pais" style="<?php echo $sStyleHidden_pr_pais; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pr_pais_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pr_provincia_label" id="hidden_field_label_pr_provincia" style="<?php echo $sStyleHidden_pr_provincia; ?>"><span id="id_label_pr_provincia"><?php echo $this->nm_new_label['pr_provincia']; ?></span></TD>
    <TD class="scFormDataOdd css_pr_provincia_line" id="hidden_field_data_pr_provincia" style="<?php echo $sStyleHidden_pr_provincia; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pr_provincia_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pr_ciudad_label" id="hidden_field_label_pr_ciudad" style="<?php echo $sStyleHidden_pr_ciudad; ?>"><span id="id_label_pr_ciudad"><?php echo $this->nm_new_label['pr_ciudad']; ?></span></TD>
    <TD class="scFormDataOdd css_pr_ciudad_line" id="hidden_field_data_pr_ciudad" style="<?php echo $sStyleHidden_pr_ciudad; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pr_ciudad_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pr_direccion_label" id="hidden_field_label_pr_direccion" style="<?php echo $sStyleHidden_pr_direccion; ?>"><span id="id_label_pr_direccion"><?php echo $this->nm_new_label['pr_direccion']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['php_cmp_required']['pr_direccion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['php_cmp_required']['pr_direccion'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_pr_direccion_line" id="hidden_field_data_pr_direccion" style="<?php echo $sStyleHidden_pr_direccion; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pr_direccion_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pr_retencion_iva_label" id="hidden_field_label_pr_retencion_iva" style="<?php echo $sStyleHidden_pr_retencion_iva; ?>"><span id="id_label_pr_retencion_iva"><?php echo $this->nm_new_label['pr_retencion_iva']; ?></span></TD>
    <TD class="scFormDataOdd css_pr_retencion_iva_line" id="hidden_field_data_pr_retencion_iva" style="<?php echo $sStyleHidden_pr_retencion_iva; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pr_retencion_iva_line" style="vertical-align: top;padding: 0px">
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_disabled']['birpara']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_disabled']['birpara']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_label']['birpara']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_label']['birpara']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_label']['birpara'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['btn_label']['last'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_del_proveedor");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_del_proveedor");
 parent.scAjaxDetailHeight("form_del_proveedor", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proveedor']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
