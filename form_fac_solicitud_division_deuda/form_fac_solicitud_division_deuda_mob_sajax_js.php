  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_fac_solicitud_division_deuda_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_fac_solicitud_division_deuda_mob_form();
	}
...
?>
  ...
  // ---------- Validate sdd_id
  function do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_id()
  {
    var nomeCampo_sdd_id = "sdd_id";
    var var_sdd_id = scAjaxGetFieldHidden(nomeCampo_sdd_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_id(var_sdd_id, var_script_case_init, do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_id_cb);
  } // do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_id

  function do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_id_cb

  // ---------- Validate sdd_fecha
  function do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_fecha()
  {
    var nomeCampo_sdd_fecha = "sdd_fecha";
    var var_sdd_fecha = scAjaxGetFieldHidden(nomeCampo_sdd_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_fecha(var_sdd_fecha, var_script_case_init, do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_fecha_cb);
  } // do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_fecha

  function do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sdd_fecha";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_fecha_cb

  // ---------- Validate sdd_propietario
  function do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_propietario()
  {
    var nomeCampo_sdd_propietario = "sdd_propietario";
    var var_sdd_propietario = scAjaxGetFieldSelect(nomeCampo_sdd_propietario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_propietario(var_sdd_propietario, var_script_case_init, do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_propietario_cb);
  } // do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_propietario

  function do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_propietario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sdd_propietario";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_propietario_cb

  // ---------- Validate sdd_monto
  function do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_monto()
  {
    var nomeCampo_sdd_monto = "sdd_monto";
    var var_sdd_monto = scAjaxGetFieldHidden(nomeCampo_sdd_monto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_monto(var_sdd_monto, var_script_case_init, do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_monto_cb);
  } // do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_monto

  function do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_monto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sdd_monto";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_monto_cb

  // ---------- Validate sdd_plazo
  function do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_plazo()
  {
    var nomeCampo_sdd_plazo = "sdd_plazo";
    var var_sdd_plazo = scAjaxGetFieldText(nomeCampo_sdd_plazo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_plazo(var_sdd_plazo, var_script_case_init, do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_plazo_cb);
  } // do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_plazo

  function do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_plazo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sdd_plazo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_plazo_cb

  // ---------- Validate sdd_estado
  function do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_estado()
  {
    var nomeCampo_sdd_estado = "sdd_estado";
    var var_sdd_estado = scAjaxGetFieldHidden(nomeCampo_sdd_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_estado(var_sdd_estado, var_script_case_init, do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_estado_cb);
  } // do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_estado

  function do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sdd_estado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_estado_cb

  // ---------- Validate sdd_secuencial_documento
  function do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_secuencial_documento()
  {
    var nomeCampo_sdd_secuencial_documento = "sdd_secuencial_documento";
    var var_sdd_secuencial_documento = scAjaxGetFieldHidden(nomeCampo_sdd_secuencial_documento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_secuencial_documento(var_sdd_secuencial_documento, var_script_case_init, do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_secuencial_documento_cb);
  } // do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_secuencial_documento

  function do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_secuencial_documento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sdd_secuencial_documento";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_secuencial_documento_cb

  // ---------- Validate sdd_usuario
  function do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_usuario()
  {
    var nomeCampo_sdd_usuario = "sdd_usuario";
    var var_sdd_usuario = scAjaxGetFieldText(nomeCampo_sdd_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_usuario(var_sdd_usuario, var_script_case_init, do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_usuario_cb);
  } // do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_usuario

  function do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sdd_usuario";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_usuario_cb

  // ---------- Validate sdd_ip
  function do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_ip()
  {
    var nomeCampo_sdd_ip = "sdd_ip";
    var var_sdd_ip = scAjaxGetFieldText(nomeCampo_sdd_ip);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_ip(var_sdd_ip, var_script_case_init, do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_ip_cb);
  } // do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_ip

  function do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_ip_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sdd_ip";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_ip_cb

  // ---------- Validate sdd_empresa
  function do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_empresa()
  {
    var nomeCampo_sdd_empresa = "sdd_empresa";
    var var_sdd_empresa = scAjaxGetFieldText(nomeCampo_sdd_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_empresa(var_sdd_empresa, var_script_case_init, do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_empresa_cb);
  } // do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_empresa

  function do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sdd_empresa";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_division_deuda_mob_validate_sdd_empresa_cb

  // ---------- Validate operaciones
  function do_ajax_form_fac_solicitud_division_deuda_mob_validate_operaciones()
  {
    var nomeCampo_operaciones = "operaciones";
    var var_operaciones = scAjaxGetFieldText(nomeCampo_operaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_division_deuda_mob_validate_operaciones(var_operaciones, var_script_case_init, do_ajax_form_fac_solicitud_division_deuda_mob_validate_operaciones_cb);
  } // do_ajax_form_fac_solicitud_division_deuda_mob_validate_operaciones

  function do_ajax_form_fac_solicitud_division_deuda_mob_validate_operaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "operaciones";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_division_deuda_mob_validate_operaciones_cb

  // ---------- Validate cuotas
  function do_ajax_form_fac_solicitud_division_deuda_mob_validate_cuotas()
  {
    var nomeCampo_cuotas = "cuotas";
    var var_cuotas = scAjaxGetFieldText(nomeCampo_cuotas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_division_deuda_mob_validate_cuotas(var_cuotas, var_script_case_init, do_ajax_form_fac_solicitud_division_deuda_mob_validate_cuotas_cb);
  } // do_ajax_form_fac_solicitud_division_deuda_mob_validate_cuotas

  function do_ajax_form_fac_solicitud_division_deuda_mob_validate_cuotas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cuotas";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_division_deuda_mob_validate_cuotas_cb

  // ---------- Event onchange sdd_propietario
  function do_ajax_form_fac_solicitud_division_deuda_mob_event_sdd_propietario_onchange()
  {
    var var_sdd_id = scAjaxGetFieldHidden("sdd_id");
    var var_sdd_monto = scAjaxGetFieldHidden("sdd_monto");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_fac_solicitud_division_deuda_mob_event_sdd_propietario_onchange(var_sdd_id, var_sdd_monto, var_script_case_init, do_ajax_form_fac_solicitud_division_deuda_mob_event_sdd_propietario_onchange_cb);
  } // do_ajax_form_fac_solicitud_division_deuda_mob_event_sdd_propietario_onchange

  function do_ajax_form_fac_solicitud_division_deuda_mob_event_sdd_propietario_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "sdd_propietario";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_fac_solicitud_division_deuda_mob_event_sdd_propietario_onchange_cb_after_alert);
  } // do_ajax_form_fac_solicitud_division_deuda_mob_event_sdd_propietario_onchange_cb
  function do_ajax_form_fac_solicitud_division_deuda_mob_event_sdd_propietario_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_fac_solicitud_division_deuda_mob_event_sdd_propietario_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_fac_solicitud_division_deuda_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_fac_solicitud_division_deuda_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_sdd_id = scAjaxGetFieldHidden("sdd_id");
    var var_sdd_fecha = scAjaxGetFieldHidden("sdd_fecha");
    var var_sdd_propietario = scAjaxGetFieldSelect("sdd_propietario");
    var var_sdd_monto = scAjaxGetFieldHidden("sdd_monto");
    var var_sdd_plazo = scAjaxGetFieldText("sdd_plazo");
    var var_sdd_estado = scAjaxGetFieldHidden("sdd_estado");
    var var_sdd_secuencial_documento = scAjaxGetFieldHidden("sdd_secuencial_documento");
    var var_sdd_usuario = scAjaxGetFieldText("sdd_usuario");
    var var_sdd_ip = scAjaxGetFieldText("sdd_ip");
    var var_sdd_empresa = scAjaxGetFieldText("sdd_empresa");
    ...
    scAjaxProcOn();
    x_ajax_form_fac_solicitud_division_deuda_mob_submit_form(var_sdd_id, var_sdd_fecha, var_sdd_propietario, var_sdd_monto, var_sdd_plazo, var_sdd_estado, var_sdd_secuencial_documento, var_sdd_usuario, var_sdd_ip, var_sdd_empresa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_fac_solicitud_division_deuda_mob_submit_form_cb);
  } // do_ajax_form_fac_solicitud_division_deuda_mob_submit_form

  function do_ajax_form_fac_solicitud_division_deuda_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("sdd_id");
      scAjaxHideErrorDisplay("sdd_fecha");
      scAjaxHideErrorDisplay("sdd_propietario");
      scAjaxHideErrorDisplay("sdd_monto");
      scAjaxHideErrorDisplay("sdd_plazo");
      scAjaxHideErrorDisplay("sdd_estado");
      scAjaxHideErrorDisplay("sdd_secuencial_documento");
      scAjaxHideErrorDisplay("sdd_usuario");
      scAjaxHideErrorDisplay("sdd_ip");
      scAjaxHideErrorDisplay("sdd_empresa");
      scAjaxHideErrorDisplay("operaciones");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_fac_solicitud_division_deuda_mob_submit_form_cb_after_alert);
  } // do_ajax_form_fac_solicitud_division_deuda_mob_submit_form_cb
  function do_ajax_form_fac_solicitud_division_deuda_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_fac_solicitud_division_deuda_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_fac_operaciones_dividir_mob"] = "off";
  scStatusDetail["grid_fac_cuotas_division"] = "off";

  function do_ajax_form_fac_solicitud_division_deuda_mob_navigate_form()
  {
    perform_ajax_form_fac_solicitud_division_deuda_mob_navigate_form();
  }

  function perform_ajax_form_fac_solicitud_division_deuda_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("operaciones");
    scAjaxHideErrorDisplay("cuotas");
    var var_sdd_id = document.F2.sdd_id.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_fac_operaciones_dividir_mob"] = "on";
    scStatusDetail["grid_fac_cuotas_division"] = "on";
    x_ajax_form_fac_solicitud_division_deuda_mob_navigate_form(var_sdd_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_solicitud_division_deuda_mob_navigate_form_cb);
  } // do_ajax_form_fac_solicitud_division_deuda_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_division_deuda_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_fac_solicitud_division_deuda_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.sdd_id.value = scAjaxGetKeyValue("sdd_id");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_fac_operaciones_dividir_mob"] && "nmsc_iframe_liga_form_fac_operaciones_dividir_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_fac_operaciones_dividir_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_fac_operaciones_dividir_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_fac_operaciones_dividir_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_fac_operaciones_dividir_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_fac_operaciones_dividir_mob').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_grid_fac_cuotas_division"] && "nmsc_iframe_liga_grid_fac_cuotas_division" != scMasterDetailIframe["nmsc_iframe_liga_grid_fac_cuotas_division"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_grid_fac_cuotas_division"]);
    }
    else {
        if (oResp["navSummary"].reg_tot != 0) {
            document.getElementById('nmsc_iframe_liga_grid_fac_cuotas_division').contentWindow.nm_move('apl_detalhe', true);
        }
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_fac_solicitud_division_deuda_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_fac_solicitud_division_deuda_mob_navigate_form_cb
  function do_ajax_form_fac_solicitud_division_deuda_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_fac_solicitud_division_deuda_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_fac_solicitud_division_deuda_mob_navigate_form_cb_after_alert

  function sc_hide_form_fac_solicitud_division_deuda_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_fac_operaciones_dividir_mob"] && "off" == scStatusDetail["grid_fac_cuotas_division"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "sdd_id";
  ajax_field_list[1] = "sdd_fecha";
  ajax_field_list[2] = "sdd_propietario";
  ajax_field_list[3] = "sdd_monto";
  ajax_field_list[4] = "sdd_plazo";
  ajax_field_list[5] = "sdd_estado";
  ajax_field_list[6] = "sdd_secuencial_documento";
  ajax_field_list[7] = "sdd_usuario";
  ajax_field_list[8] = "sdd_ip";
  ajax_field_list[9] = "sdd_empresa";
  ajax_field_list[10] = "operaciones";
  ajax_field_list[11] = "cuotas";
  ...
  var ajax_error_list = {
    "sdd_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sdd_fecha": {"label": "<?php echo $this->Ini->Nm_lang['lang_fecha'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sdd_propietario": {"label": "<?php echo $this->Ini->Nm_lang['lang_propietario'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sdd_monto": {"label": "<?php echo $this->Ini->Nm_lang['lang_monto_inicial'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sdd_plazo": {"label": "<?php echo $this->Ini->Nm_lang['lang_plazo'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sdd_estado": {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sdd_secuencial_documento": {"label": "<?php echo $this->Ini->Nm_lang['lang_secuencial'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sdd_usuario": {"label": "<?php echo $this->Ini->Nm_lang['lang_usuario'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sdd_ip": {"label": "<?php echo $this->Ini->Nm_lang['lang_ip'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sdd_empresa": {"label": "Sdd Empresa", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "operaciones": {"label": "<?php echo $this->Ini->Nm_lang['lang_operaciones'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "sdd_id": new Array(),
    "sdd_fecha": new Array(),
    "sdd_propietario": new Array(),
    "sdd_monto": new Array(),
    "sdd_plazo": new Array(),
    "sdd_estado": new Array(),
    "sdd_secuencial_documento": new Array(),
    "sdd_usuario": new Array(),
    "sdd_ip": new Array(),
    "sdd_empresa": new Array(),
    "operaciones": new Array(),
    "cuotas": new Array()
  };
  ajax_field_mult["sdd_id"][1] = "sdd_id";
  ajax_field_mult["sdd_fecha"][1] = "sdd_fecha";
  ajax_field_mult["sdd_propietario"][1] = "sdd_propietario";
  ajax_field_mult["sdd_monto"][1] = "sdd_monto";
  ajax_field_mult["sdd_plazo"][1] = "sdd_plazo";
  ajax_field_mult["sdd_estado"][1] = "sdd_estado";
  ajax_field_mult["sdd_secuencial_documento"][1] = "sdd_secuencial_documento";
  ajax_field_mult["sdd_usuario"][1] = "sdd_usuario";
  ajax_field_mult["sdd_ip"][1] = "sdd_ip";
  ajax_field_mult["sdd_empresa"][1] = "sdd_empresa";
  ajax_field_mult["operaciones"][1] = "operaciones";
  ajax_field_mult["cuotas"][1] = "cuotas";

  var ajax_field_id = {
    "sdd_fecha": new Array("hidden_field_label_sdd_fecha", "hidden_field_data_sdd_fecha"),
    "sdd_propietario": new Array("hidden_field_label_sdd_propietario", "hidden_field_data_sdd_propietario"),
    "sdd_monto": new Array("hidden_field_label_sdd_monto", "hidden_field_data_sdd_monto"),
    "sdd_plazo": new Array("hidden_field_label_sdd_plazo", "hidden_field_data_sdd_plazo"),
    "sdd_estado": new Array("hidden_field_label_sdd_estado", "hidden_field_data_sdd_estado"),
    "operaciones": new Array("hidden_field_label_operaciones", "hidden_field_data_operaciones"),
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("sdd_secuencial_documento" == sIndex)
    {
      scAjaxSetFieldLabel(sIndex, aValue);
      updateHeaderFooter(sIndex, aValue);
