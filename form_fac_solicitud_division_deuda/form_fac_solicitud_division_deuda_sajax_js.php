  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_fac_solicitud_division_deuda" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_fac_solicitud_division_deuda_form();
	}
...
?>
  ...
  // ---------- Validate sdd_id
  function do_ajax_form_fac_solicitud_division_deuda_validate_sdd_id()
  {
    var nomeCampo_sdd_id = "sdd_id";
    var var_sdd_id = scAjaxGetFieldHidden(nomeCampo_sdd_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_division_deuda_validate_sdd_id(var_sdd_id, var_script_case_init, do_ajax_form_fac_solicitud_division_deuda_validate_sdd_id_cb);
  } // do_ajax_form_fac_solicitud_division_deuda_validate_sdd_id

  function do_ajax_form_fac_solicitud_division_deuda_validate_sdd_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_division_deuda_validate_sdd_id_cb

  // ---------- Validate sdd_fecha
  function do_ajax_form_fac_solicitud_division_deuda_validate_sdd_fecha()
  {
    var nomeCampo_sdd_fecha = "sdd_fecha";
    var var_sdd_fecha = scAjaxGetFieldHidden(nomeCampo_sdd_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_division_deuda_validate_sdd_fecha(var_sdd_fecha, var_script_case_init, do_ajax_form_fac_solicitud_division_deuda_validate_sdd_fecha_cb);
  } // do_ajax_form_fac_solicitud_division_deuda_validate_sdd_fecha

  function do_ajax_form_fac_solicitud_division_deuda_validate_sdd_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_division_deuda_validate_sdd_fecha_cb

  // ---------- Validate sdd_propietario
  function do_ajax_form_fac_solicitud_division_deuda_validate_sdd_propietario()
  {
    var nomeCampo_sdd_propietario = "sdd_propietario";
    var var_sdd_propietario = scAjaxGetFieldSelect(nomeCampo_sdd_propietario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_division_deuda_validate_sdd_propietario(var_sdd_propietario, var_script_case_init, do_ajax_form_fac_solicitud_division_deuda_validate_sdd_propietario_cb);
  } // do_ajax_form_fac_solicitud_division_deuda_validate_sdd_propietario

  function do_ajax_form_fac_solicitud_division_deuda_validate_sdd_propietario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_division_deuda_validate_sdd_propietario_cb

  // ---------- Validate sdd_monto
  function do_ajax_form_fac_solicitud_division_deuda_validate_sdd_monto()
  {
    var nomeCampo_sdd_monto = "sdd_monto";
    var var_sdd_monto = scAjaxGetFieldHidden(nomeCampo_sdd_monto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_division_deuda_validate_sdd_monto(var_sdd_monto, var_script_case_init, do_ajax_form_fac_solicitud_division_deuda_validate_sdd_monto_cb);
  } // do_ajax_form_fac_solicitud_division_deuda_validate_sdd_monto

  function do_ajax_form_fac_solicitud_division_deuda_validate_sdd_monto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_division_deuda_validate_sdd_monto_cb

  // ---------- Validate sdd_plazo
  function do_ajax_form_fac_solicitud_division_deuda_validate_sdd_plazo()
  {
    var nomeCampo_sdd_plazo = "sdd_plazo";
    var var_sdd_plazo = scAjaxGetFieldText(nomeCampo_sdd_plazo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_division_deuda_validate_sdd_plazo(var_sdd_plazo, var_script_case_init, do_ajax_form_fac_solicitud_division_deuda_validate_sdd_plazo_cb);
  } // do_ajax_form_fac_solicitud_division_deuda_validate_sdd_plazo

  function do_ajax_form_fac_solicitud_division_deuda_validate_sdd_plazo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_division_deuda_validate_sdd_plazo_cb

  // ---------- Validate sdd_estado
  function do_ajax_form_fac_solicitud_division_deuda_validate_sdd_estado()
  {
    var nomeCampo_sdd_estado = "sdd_estado";
    var var_sdd_estado = scAjaxGetFieldHidden(nomeCampo_sdd_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_division_deuda_validate_sdd_estado(var_sdd_estado, var_script_case_init, do_ajax_form_fac_solicitud_division_deuda_validate_sdd_estado_cb);
  } // do_ajax_form_fac_solicitud_division_deuda_validate_sdd_estado

  function do_ajax_form_fac_solicitud_division_deuda_validate_sdd_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_division_deuda_validate_sdd_estado_cb

  // ---------- Validate sdd_secuencial_documento
  function do_ajax_form_fac_solicitud_division_deuda_validate_sdd_secuencial_documento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_division_deuda_validate_sdd_secuencial_documento(var_sdd_secuencial_documento, var_script_case_init, do_ajax_form_fac_solicitud_division_deuda_validate_sdd_secuencial_documento_cb);
  } // do_ajax_form_fac_solicitud_division_deuda_validate_sdd_secuencial_documento

  function do_ajax_form_fac_solicitud_division_deuda_validate_sdd_secuencial_documento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_division_deuda_validate_sdd_secuencial_documento_cb

  // ---------- Validate sdd_usuario
  function do_ajax_form_fac_solicitud_division_deuda_validate_sdd_usuario()
  {
    var nomeCampo_sdd_usuario = "sdd_usuario";
    var var_sdd_usuario = scAjaxGetFieldText(nomeCampo_sdd_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_division_deuda_validate_sdd_usuario(var_sdd_usuario, var_script_case_init, do_ajax_form_fac_solicitud_division_deuda_validate_sdd_usuario_cb);
  } // do_ajax_form_fac_solicitud_division_deuda_validate_sdd_usuario

  function do_ajax_form_fac_solicitud_division_deuda_validate_sdd_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_division_deuda_validate_sdd_usuario_cb

  // ---------- Validate sdd_ip
  function do_ajax_form_fac_solicitud_division_deuda_validate_sdd_ip()
  {
    var nomeCampo_sdd_ip = "sdd_ip";
    var var_sdd_ip = scAjaxGetFieldText(nomeCampo_sdd_ip);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_division_deuda_validate_sdd_ip(var_sdd_ip, var_script_case_init, do_ajax_form_fac_solicitud_division_deuda_validate_sdd_ip_cb);
  } // do_ajax_form_fac_solicitud_division_deuda_validate_sdd_ip

  function do_ajax_form_fac_solicitud_division_deuda_validate_sdd_ip_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sdd_ip";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_division_deuda_validate_sdd_ip_cb

  // ---------- Validate sdd_empresa
  function do_ajax_form_fac_solicitud_division_deuda_validate_sdd_empresa()
  {
    var nomeCampo_sdd_empresa = "sdd_empresa";
    var var_sdd_empresa = scAjaxGetFieldText(nomeCampo_sdd_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_division_deuda_validate_sdd_empresa(var_sdd_empresa, var_script_case_init, do_ajax_form_fac_solicitud_division_deuda_validate_sdd_empresa_cb);
  } // do_ajax_form_fac_solicitud_division_deuda_validate_sdd_empresa

  function do_ajax_form_fac_solicitud_division_deuda_validate_sdd_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_division_deuda_validate_sdd_empresa_cb

  // ---------- Validate operaciones
  function do_ajax_form_fac_solicitud_division_deuda_validate_operaciones()
  {
    var nomeCampo_operaciones = "operaciones";
    var var_operaciones = scAjaxGetFieldText(nomeCampo_operaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_division_deuda_validate_operaciones(var_operaciones, var_script_case_init, do_ajax_form_fac_solicitud_division_deuda_validate_operaciones_cb);
  } // do_ajax_form_fac_solicitud_division_deuda_validate_operaciones

  function do_ajax_form_fac_solicitud_division_deuda_validate_operaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_division_deuda_validate_operaciones_cb

  // ---------- Validate cuotas
  function do_ajax_form_fac_solicitud_division_deuda_validate_cuotas()
  {
    var nomeCampo_cuotas = "cuotas";
    var var_cuotas = scAjaxGetFieldText(nomeCampo_cuotas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_division_deuda_validate_cuotas(var_cuotas, var_script_case_init, do_ajax_form_fac_solicitud_division_deuda_validate_cuotas_cb);
  } // do_ajax_form_fac_solicitud_division_deuda_validate_cuotas

  function do_ajax_form_fac_solicitud_division_deuda_validate_cuotas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cuotas";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_division_deuda_validate_cuotas_cb

  // ---------- Event onchange sdd_propietario
  function do_ajax_form_fac_solicitud_division_deuda_event_sdd_propietario_onchange()
  {
    var var_sdd_id = scAjaxGetFieldHidden("sdd_id");
    var var_sdd_monto = scAjaxGetFieldHidden("sdd_monto");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_fac_solicitud_division_deuda_event_sdd_propietario_onchange(var_sdd_id, var_sdd_monto, var_script_case_init, do_ajax_form_fac_solicitud_division_deuda_event_sdd_propietario_onchange_cb);
  } // do_ajax_form_fac_solicitud_division_deuda_event_sdd_propietario_onchange

  function do_ajax_form_fac_solicitud_division_deuda_event_sdd_propietario_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "sdd_propietario";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_fac_solicitud_division_deuda_event_sdd_propietario_onchange_cb_after_alert);
  } // do_ajax_form_fac_solicitud_division_deuda_event_sdd_propietario_onchange_cb
  function do_ajax_form_fac_solicitud_division_deuda_event_sdd_propietario_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_fac_solicitud_division_deuda_event_sdd_propietario_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_fac_solicitud_division_deuda_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_fac_solicitud_division_deuda_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_sdd_id = scAjaxGetFieldHidden("sdd_id");
    ...
    scAjaxProcOn();
    x_ajax_form_fac_solicitud_division_deuda_submit_form(var_sdd_id, var_sdd_fecha, var_sdd_propietario, var_sdd_monto, var_sdd_plazo, var_sdd_estado, var_sdd_secuencial_documento, var_sdd_usuario, var_sdd_ip, var_sdd_empresa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_fac_solicitud_division_deuda_submit_form_cb);
  } // do_ajax_form_fac_solicitud_division_deuda_submit_form

  function do_ajax_form_fac_solicitud_division_deuda_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_fac_solicitud_division_deuda_submit_form_cb_after_alert);
  } // do_ajax_form_fac_solicitud_division_deuda_submit_form_cb
  function do_ajax_form_fac_solicitud_division_deuda_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_fac_solicitud_division_deuda_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_fac_operaciones_dividir"] = "off";
  scStatusDetail["grid_fac_cuotas_division"] = "off";

  function do_ajax_form_fac_solicitud_division_deuda_navigate_form()
  {
    perform_ajax_form_fac_solicitud_division_deuda_navigate_form();
  }

  function perform_ajax_form_fac_solicitud_division_deuda_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_fac_operaciones_dividir"] = "on";
    scStatusDetail["grid_fac_cuotas_division"] = "on";
    x_ajax_form_fac_solicitud_division_deuda_navigate_form(var_sdd_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_solicitud_division_deuda_navigate_form_cb);
  } // do_ajax_form_fac_solicitud_division_deuda_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_division_deuda']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_fac_solicitud_division_deuda_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_fac_operaciones_dividir"] && "nmsc_iframe_liga_form_fac_operaciones_dividir" != scMasterDetailIframe["nmsc_iframe_liga_form_fac_operaciones_dividir"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_fac_operaciones_dividir"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_fac_operaciones_dividir').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_fac_operaciones_dividir').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_fac_operaciones_dividir').style.display = "none";
    }
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_fac_solicitud_division_deuda_navigate_form_cb_after_alert);
  } // do_ajax_form_fac_solicitud_division_deuda_navigate_form_cb
  function do_ajax_form_fac_solicitud_division_deuda_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_fac_solicitud_division_deuda_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_fac_solicitud_division_deuda_navigate_form_cb_after_alert

  function sc_hide_form_fac_solicitud_division_deuda_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_fac_operaciones_dividir"] && "off" == scStatusDetail["grid_fac_cuotas_division"])
    {
      return true;
    }
    return false;
