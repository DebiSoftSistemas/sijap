<?php
class form_del_detalle_proforma_form extends form_del_detalle_proforma_apl
{
function Form_Init()
{
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['sc_redir_atualiz'] == 'ok')
{
?>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_del_detalle_proforma/form_del_detalle_proforma_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_del_detalle_proforma_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_del_detalle_proforma_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['recarga'];
}
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    $opcao_botoes = 'inicio';
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['link_info']['remove_border']) {
...
<?php
 include_once("form_del_detalle_proforma_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_del_detalle_proforma'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_del_detalle_proforma'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['run_iframe'] != "R")
{
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['fast_search'][2] : "";
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_disabled']['']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_disabled']['']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_label']['']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_label']['']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_label'][''];
        }
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
   ...
   if (!isset($this->nmgp_cmp_hidden['dp_base_ice_']))
   {
       $this->nmgp_cmp_hidden['dp_base_ice_'] = 'off';
   }
   if (!isset($this->nmgp_cmp_hidden['dp_porcentaje_ice_']))
   {
       $this->nmgp_cmp_hidden['dp_porcentaje_ice_'] = 'off';
   }
   if (!isset($this->nmgp_cmp_hidden['dp_valor_ice_']))
   {
       $this->nmgp_cmp_hidden['dp_valor_ice_'] = 'off';
   }
   if (!isset($this->nmgp_cmp_hidden['dp_base_irbpnr_']))
   {
       $this->nmgp_cmp_hidden['dp_base_irbpnr_'] = 'off';
   }
   if (!isset($this->nmgp_cmp_hidden['dp_porcentaje_irbpnr_']))
   {
       $this->nmgp_cmp_hidden['dp_porcentaje_irbpnr_'] = 'off';
   }
   if (!isset($this->nmgp_cmp_hidden['dp_valor_irbpnr_']))
   {
       $this->nmgp_cmp_hidden['dp_valor_irbpnr_'] = 'off';
   }
?>
...
?>
   ...
   <?php
    $sStyleHidden_dp_base_ice_ = '';
    if (isset($this->nmgp_cmp_hidden['dp_base_ice_']) && $this->nmgp_cmp_hidden['dp_base_ice_'] == 'off') {
        $sStyleHidden_dp_base_ice_ = 'display: none';
    }
    if (1 || !isset($this->nmgp_cmp_hidden['dp_base_ice_']) || $this->nmgp_cmp_hidden['dp_base_ice_'] == 'on') {
        if (!isset($this->nm_new_label['dp_base_ice_'])) {
            $this->nm_new_label['dp_base_ice_'] = "" . $this->Ini->Nm_lang['lang_base_ice'] . "";
        }
        $SC_Label = "" . $this->nm_new_label['dp_base_ice_']  . "";
        $label_fieldName = nl2br($SC_Label);
        ...
        $classColFld = " sc-col-fld sc-col-fld-" . $this->form_fixed_column_no;
?>
    <TD class="<?php echo $this->css_inherit_bg . ' ' ?>scFormLabelOddMult css_dp_base_ice__label sc-col-title" id="hidden_field_label_dp_base_ice_" style="<?php echo $sStyleHidden_dp_base_ice_; ?>" > <?php echo $label_final ?> </TD>
   <?php
        $this->form_fixed_column_no++;
    }
?>
...
?>
   ...
   <?php
    $sStyleHidden_dp_valor_ice_ = '';
    if (isset($this->nmgp_cmp_hidden['dp_valor_ice_']) && $this->nmgp_cmp_hidden['dp_valor_ice_'] == 'off') {
        $sStyleHidden_dp_valor_ice_ = 'display: none';
    }
    if (1 || !isset($this->nmgp_cmp_hidden['dp_valor_ice_']) || $this->nmgp_cmp_hidden['dp_valor_ice_'] == 'on') {
        if (!isset($this->nm_new_label['dp_valor_ice_'])) {
            $this->nm_new_label['dp_valor_ice_'] = "" . $this->Ini->Nm_lang['lang_ice'] . "";
        }
        $SC_Label = "" . $this->nm_new_label['dp_valor_ice_']  . "";
        $label_fieldName = nl2br($SC_Label);
        ...
        $classColFld = " sc-col-fld sc-col-fld-" . $this->form_fixed_column_no;
?>
    <TD class="<?php echo $this->css_inherit_bg . ' ' ?>scFormLabelOddMult css_dp_valor_ice__label sc-col-title" id="hidden_field_label_dp_valor_ice_" style="<?php echo $sStyleHidden_dp_valor_ice_; ?>" > <?php echo $label_final ?> </TD>
   <?php
        $this->form_fixed_column_no++;
    }
?>
   ...
   <?php
    $sStyleHidden_dp_base_irbpnr_ = '';
    if (isset($this->nmgp_cmp_hidden['dp_base_irbpnr_']) && $this->nmgp_cmp_hidden['dp_base_irbpnr_'] == 'off') {
        $sStyleHidden_dp_base_irbpnr_ = 'display: none';
    }
    if (1 || !isset($this->nmgp_cmp_hidden['dp_base_irbpnr_']) || $this->nmgp_cmp_hidden['dp_base_irbpnr_'] == 'on') {
        if (!isset($this->nm_new_label['dp_base_irbpnr_'])) {
            $this->nm_new_label['dp_base_irbpnr_'] = "" . $this->Ini->Nm_lang['lang_base_irbpnr'] . "";
        }
        $SC_Label = "" . $this->nm_new_label['dp_base_irbpnr_']  . "";
        $label_fieldName = nl2br($SC_Label);
        ...
        $classColFld = " sc-col-fld sc-col-fld-" . $this->form_fixed_column_no;
?>
    <TD class="<?php echo $this->css_inherit_bg . ' ' ?>scFormLabelOddMult css_dp_base_irbpnr__label sc-col-title" id="hidden_field_label_dp_base_irbpnr_" style="<?php echo $sStyleHidden_dp_base_irbpnr_; ?>" > <?php echo $label_final ?> </TD>
   <?php
        $this->form_fixed_column_no++;
    }
?>
...
?>
   ...
   <?php
    $sStyleHidden_dp_valor_irbpnr_ = '';
    if (isset($this->nmgp_cmp_hidden['dp_valor_irbpnr_']) && $this->nmgp_cmp_hidden['dp_valor_irbpnr_'] == 'off') {
        $sStyleHidden_dp_valor_irbpnr_ = 'display: none';
    }
    if (1 || !isset($this->nmgp_cmp_hidden['dp_valor_irbpnr_']) || $this->nmgp_cmp_hidden['dp_valor_irbpnr_'] == 'on') {
        if (!isset($this->nm_new_label['dp_valor_irbpnr_'])) {
            $this->nm_new_label['dp_valor_irbpnr_'] = "" . $this->Ini->Nm_lang['lang_irbpnr'] . "";
        }
        $SC_Label = "" . $this->nm_new_label['dp_valor_irbpnr_']  . "";
        $label_fieldName = nl2br($SC_Label);
        ...
        $classColFld = " sc-col-fld sc-col-fld-" . $this->form_fixed_column_no;
?>
    <TD class="<?php echo $this->css_inherit_bg . ' ' ?>scFormLabelOddMult css_dp_valor_irbpnr__label sc-col-title" id="hidden_field_label_dp_valor_irbpnr_" style="<?php echo $sStyleHidden_dp_valor_irbpnr_; ?>" > <?php echo $label_final ?> </TD>
   <?php
        $this->form_fixed_column_no++;
    }
?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_del_detalle_proforma);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_del_detalle_proforma = $this->form_vert_form_del_detalle_proforma;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_del_detalle_proforma))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_form_del_detalle_proforma as $sc_seq_vert => $sc_lixo)
   {
       $this->form_fixed_column_no = 0;
       $this->loadRecordState($sc_seq_vert);
       $this->dp_empresa_ = $this->form_vert_form_del_detalle_proforma[$sc_seq_vert]['dp_empresa_'];
       $this->dp_estado_ = $this->form_vert_form_del_detalle_proforma[$sc_seq_vert]['dp_estado_'];
       if (isset($this->Embutida_ronly) && $this->Embutida_ronly && !$Line_Add)
       {
           ...
           $this->nmgp_cmp_readonly['dp_base_ice_'] = true;
           $this->nmgp_cmp_readonly['dp_porcentaje_ice_'] = true;
           $this->nmgp_cmp_readonly['dp_valor_ice_'] = true;
           $this->nmgp_cmp_readonly['dp_base_irbpnr_'] = true;
           $this->nmgp_cmp_readonly['dp_porcentaje_irbpnr_'] = true;
           $this->nmgp_cmp_readonly['dp_valor_irbpnr_'] = true;
       }
       elseif ($Line_Add)
       {
           ...
           if (!isset($this->nmgp_cmp_readonly['dp_base_ice_']) || $this->nmgp_cmp_readonly['dp_base_ice_'] != "on") {$this->nmgp_cmp_readonly['dp_base_ice_'] = false;}
           ...
           if (!isset($this->nmgp_cmp_readonly['dp_valor_ice_']) || $this->nmgp_cmp_readonly['dp_valor_ice_'] != "on") {$this->nmgp_cmp_readonly['dp_valor_ice_'] = false;}
           if (!isset($this->nmgp_cmp_readonly['dp_base_irbpnr_']) || $this->nmgp_cmp_readonly['dp_base_irbpnr_'] != "on") {$this->nmgp_cmp_readonly['dp_base_irbpnr_'] = false;}
           ...
           if (!isset($this->nmgp_cmp_readonly['dp_valor_irbpnr_']) || $this->nmgp_cmp_readonly['dp_valor_irbpnr_'] != "on") {$this->nmgp_cmp_readonly['dp_valor_irbpnr_'] = false;}
       }
        ...
        $this->dp_id_ = $this->form_vert_form_del_detalle_proforma[$sc_seq_vert]['dp_id_']; 
       $dp_id_ = $this->dp_id_; 
       if (!isset($this->nmgp_cmp_hidden['dp_id_']))
       {
           $this->nmgp_cmp_hidden['dp_id_'] = 'off';
       ...
       $this->dp_proforma_ = $this->form_vert_form_del_detalle_proforma[$sc_seq_vert]['dp_proforma_']; 
       ...
       if (isset($this->nmgp_cmp_readonly['dp_proforma_']) && $this->nmgp_cmp_readonly['dp_proforma_'] == 'on')
       {
       ...
       $this->dp_producto_ = $this->form_vert_form_del_detalle_proforma[$sc_seq_vert]['dp_producto_']; 
       ...
       $this->dp_descripcion_ = $this->form_vert_form_del_detalle_proforma[$sc_seq_vert]['dp_descripcion_']; 
       ...
       $this->dp_cantidad_ = $this->form_vert_form_del_detalle_proforma[$sc_seq_vert]['dp_cantidad_']; 
       ...
       $this->dp_precio_unitario_ = $this->form_vert_form_del_detalle_proforma[$sc_seq_vert]['dp_precio_unitario_']; 
       ...
       $this->dp_descuento_ = $this->form_vert_form_del_detalle_proforma[$sc_seq_vert]['dp_descuento_']; 
       ...
       $this->dp_subtotal_ = $this->form_vert_form_del_detalle_proforma[$sc_seq_vert]['dp_subtotal_']; 
       ...
       $this->dp_base_iva_ = $this->form_vert_form_del_detalle_proforma[$sc_seq_vert]['dp_base_iva_']; 
       ...
       $this->dp_porcentaje_iva_ = $this->form_vert_form_del_detalle_proforma[$sc_seq_vert]['dp_porcentaje_iva_']; 
       ...
       $this->dp_valor_iva_ = $this->form_vert_form_del_detalle_proforma[$sc_seq_vert]['dp_valor_iva_']; 
       ...
       $this->dp_total_ = $this->form_vert_form_del_detalle_proforma[$sc_seq_vert]['dp_total_']; 
       ...
       $this->dp_base_ice_ = $this->form_vert_form_del_detalle_proforma[$sc_seq_vert]['dp_base_ice_']; 
       $dp_base_ice_ = $this->dp_base_ice_; 
       if (!isset($this->nmgp_cmp_hidden['dp_base_ice_']))
       {
           $this->nmgp_cmp_hidden['dp_base_ice_'] = 'off';
       }
       $sStyleHidden_dp_base_ice_ = '';
       if (isset($sCheckRead_dp_base_ice_))
       {
           unset($sCheckRead_dp_base_ice_);
       }
       if (isset($this->nmgp_cmp_readonly['dp_base_ice_']))
       {
           $sCheckRead_dp_base_ice_ = $this->nmgp_cmp_readonly['dp_base_ice_'];
       }
       if (isset($this->nmgp_cmp_hidden['dp_base_ice_']) && $this->nmgp_cmp_hidden['dp_base_ice_'] == 'off')
       {
           unset($this->nmgp_cmp_hidden['dp_base_ice_']);
           $sStyleHidden_dp_base_ice_ = 'display: none;';
       }
       $bTestReadOnly_dp_base_ice_ = true;
       $sStyleReadLab_dp_base_ice_ = 'display: none;';
       $sStyleReadInp_dp_base_ice_ = '';
       if (isset($this->nmgp_cmp_readonly['dp_base_ice_']) && $this->nmgp_cmp_readonly['dp_base_ice_'] == 'on')
       {
           $bTestReadOnly_dp_base_ice_ = false;
           unset($this->nmgp_cmp_readonly['dp_base_ice_']);
           $sStyleReadLab_dp_base_ice_ = '';
           $sStyleReadInp_dp_base_ice_ = 'display: none;';
       }
       $this->dp_porcentaje_ice_ = $this->form_vert_form_del_detalle_proforma[$sc_seq_vert]['dp_porcentaje_ice_']; 
       ...
       $this->dp_valor_ice_ = $this->form_vert_form_del_detalle_proforma[$sc_seq_vert]['dp_valor_ice_']; 
       $dp_valor_ice_ = $this->dp_valor_ice_; 
       if (!isset($this->nmgp_cmp_hidden['dp_valor_ice_']))
       {
           $this->nmgp_cmp_hidden['dp_valor_ice_'] = 'off';
       }
       $sStyleHidden_dp_valor_ice_ = '';
       if (isset($sCheckRead_dp_valor_ice_))
       {
           unset($sCheckRead_dp_valor_ice_);
       }
       if (isset($this->nmgp_cmp_readonly['dp_valor_ice_']))
       {
           $sCheckRead_dp_valor_ice_ = $this->nmgp_cmp_readonly['dp_valor_ice_'];
       }
       if (isset($this->nmgp_cmp_hidden['dp_valor_ice_']) && $this->nmgp_cmp_hidden['dp_valor_ice_'] == 'off')
       {
           unset($this->nmgp_cmp_hidden['dp_valor_ice_']);
           $sStyleHidden_dp_valor_ice_ = 'display: none;';
       }
       $bTestReadOnly_dp_valor_ice_ = true;
       $sStyleReadLab_dp_valor_ice_ = 'display: none;';
       $sStyleReadInp_dp_valor_ice_ = '';
       if (isset($this->nmgp_cmp_readonly['dp_valor_ice_']) && $this->nmgp_cmp_readonly['dp_valor_ice_'] == 'on')
       {
           $bTestReadOnly_dp_valor_ice_ = false;
           unset($this->nmgp_cmp_readonly['dp_valor_ice_']);
           $sStyleReadLab_dp_valor_ice_ = '';
           $sStyleReadInp_dp_valor_ice_ = 'display: none;';
       }
       $this->dp_base_irbpnr_ = $this->form_vert_form_del_detalle_proforma[$sc_seq_vert]['dp_base_irbpnr_']; 
       $dp_base_irbpnr_ = $this->dp_base_irbpnr_; 
       if (!isset($this->nmgp_cmp_hidden['dp_base_irbpnr_']))
       {
           $this->nmgp_cmp_hidden['dp_base_irbpnr_'] = 'off';
       }
       $sStyleHidden_dp_base_irbpnr_ = '';
       if (isset($sCheckRead_dp_base_irbpnr_))
       {
           unset($sCheckRead_dp_base_irbpnr_);
       }
       if (isset($this->nmgp_cmp_readonly['dp_base_irbpnr_']))
       {
           $sCheckRead_dp_base_irbpnr_ = $this->nmgp_cmp_readonly['dp_base_irbpnr_'];
       }
       if (isset($this->nmgp_cmp_hidden['dp_base_irbpnr_']) && $this->nmgp_cmp_hidden['dp_base_irbpnr_'] == 'off')
       {
           unset($this->nmgp_cmp_hidden['dp_base_irbpnr_']);
           $sStyleHidden_dp_base_irbpnr_ = 'display: none;';
       }
       $bTestReadOnly_dp_base_irbpnr_ = true;
       $sStyleReadLab_dp_base_irbpnr_ = 'display: none;';
       $sStyleReadInp_dp_base_irbpnr_ = '';
       if (isset($this->nmgp_cmp_readonly['dp_base_irbpnr_']) && $this->nmgp_cmp_readonly['dp_base_irbpnr_'] == 'on')
       {
           $bTestReadOnly_dp_base_irbpnr_ = false;
           unset($this->nmgp_cmp_readonly['dp_base_irbpnr_']);
           $sStyleReadLab_dp_base_irbpnr_ = '';
           $sStyleReadInp_dp_base_irbpnr_ = 'display: none;';
       }
       $this->dp_porcentaje_irbpnr_ = $this->form_vert_form_del_detalle_proforma[$sc_seq_vert]['dp_porcentaje_irbpnr_']; 
       ...
       $this->dp_valor_irbpnr_ = $this->form_vert_form_del_detalle_proforma[$sc_seq_vert]['dp_valor_irbpnr_']; 
       $dp_valor_irbpnr_ = $this->dp_valor_irbpnr_; 
       if (!isset($this->nmgp_cmp_hidden['dp_valor_irbpnr_']))
       {
           $this->nmgp_cmp_hidden['dp_valor_irbpnr_'] = 'off';
       }
       $sStyleHidden_dp_valor_irbpnr_ = '';
       if (isset($sCheckRead_dp_valor_irbpnr_))
       {
           unset($sCheckRead_dp_valor_irbpnr_);
       }
       if (isset($this->nmgp_cmp_readonly['dp_valor_irbpnr_']))
       {
           $sCheckRead_dp_valor_irbpnr_ = $this->nmgp_cmp_readonly['dp_valor_irbpnr_'];
       }
       if (isset($this->nmgp_cmp_hidden['dp_valor_irbpnr_']) && $this->nmgp_cmp_hidden['dp_valor_irbpnr_'] == 'off')
       {
           unset($this->nmgp_cmp_hidden['dp_valor_irbpnr_']);
           $sStyleHidden_dp_valor_irbpnr_ = 'display: none;';
       }
       $bTestReadOnly_dp_valor_irbpnr_ = true;
       $sStyleReadLab_dp_valor_irbpnr_ = 'display: none;';
       $sStyleReadInp_dp_valor_irbpnr_ = '';
       if (isset($this->nmgp_cmp_readonly['dp_valor_irbpnr_']) && $this->nmgp_cmp_readonly['dp_valor_irbpnr_'] == 'on')
       {
           $bTestReadOnly_dp_valor_irbpnr_ = false;
           unset($this->nmgp_cmp_readonly['dp_valor_irbpnr_']);
           $sStyleReadLab_dp_valor_irbpnr_ = '';
           $sStyleReadInp_dp_valor_irbpnr_ = 'display: none;';
       }
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_del_detalle_proforma_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_del_detalle_proforma_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_del_detalle_proforma_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_del_detalle_proforma_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_del_detalle_proforma_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_del_detalle_proforma_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOddMult css_dp_proforma__line" id="hidden_field_data_dp_proforma_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_dp_proforma_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_dp_proforma__line" style="vertical-align: top;padding: 0px"><input type="hidden" name="dp_proforma_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($dp_proforma_); ?>"><span id="id_ajax_label_dp_proforma_<?php echo $sc_seq_vert; ?>"><?php echo nl2br($dp_proforma_); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['dp_base_ice_']) && $this->nmgp_cmp_hidden['dp_base_ice_'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="dp_base_ice_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($dp_base_ice_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOddMult css_dp_base_ice__line" id="hidden_field_data_dp_base_ice_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_dp_base_ice_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_dp_base_ice__line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly_dp_base_ice_ && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["dp_base_ice_"]) &&  $this->nmgp_cmp_readonly["dp_base_ice_"] == "on") { 

 ?>
<input type="hidden" name="dp_base_ice_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($dp_base_ice_) . "\">" . $dp_base_ice_ . ""; ?>
<?php } else { ?>
<span id="id_read_on_dp_base_ice_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-dp_base_ice_<?php echo $sc_seq_vert ?> css_dp_base_ice__line" style="<?php echo $sStyleReadLab_dp_base_ice_; ?>"><?php echo $this->form_format_readonly("dp_base_ice_", $this->form_encode_input($this->dp_base_ice_)); ?></span><span id="id_read_off_dp_base_ice_<?php echo $sc_seq_vert ?>" class="css_read_off_dp_base_ice_<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_dp_base_ice_; ?>">
 <input class="sc-js-input scFormObjectOddMult css_dp_base_ice__obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_dp_base_ice_<?php echo $sc_seq_vert ?>" type=text name="dp_base_ice_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($dp_base_ice_) ?>"
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=15"; } ?> alt="{datatype: 'decimal', maxLength: 15, precision: 2, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['dp_base_ice_']['symbol_dec']); ?>', thousandsSep: '', thousandsFormat: <?php echo $this->field_config['dp_base_ice_']['symbol_fmt']; ?>, manualDecimals: true, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['dp_base_ice_']['format_neg'] ? "'suffix'" : "'prefix'") ?>, enterTab: false, enterSubmit: false, autoTab: true, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_dp_base_ice_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_dp_base_ice_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['dp_valor_ice_']) && $this->nmgp_cmp_hidden['dp_valor_ice_'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="dp_valor_ice_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($dp_valor_ice_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOddMult css_dp_valor_ice__line" id="hidden_field_data_dp_valor_ice_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_dp_valor_ice_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_dp_valor_ice__line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly_dp_valor_ice_ && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["dp_valor_ice_"]) &&  $this->nmgp_cmp_readonly["dp_valor_ice_"] == "on") { 

 ?>
<input type="hidden" name="dp_valor_ice_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($dp_valor_ice_) . "\">" . $dp_valor_ice_ . ""; ?>
<?php } else { ?>
<span id="id_read_on_dp_valor_ice_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-dp_valor_ice_<?php echo $sc_seq_vert ?> css_dp_valor_ice__line" style="<?php echo $sStyleReadLab_dp_valor_ice_; ?>"><?php echo $this->form_format_readonly("dp_valor_ice_", $this->form_encode_input($this->dp_valor_ice_)); ?></span><span id="id_read_off_dp_valor_ice_<?php echo $sc_seq_vert ?>" class="css_read_off_dp_valor_ice_<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_dp_valor_ice_; ?>">
 <input class="sc-js-input scFormObjectOddMult css_dp_valor_ice__obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_dp_valor_ice_<?php echo $sc_seq_vert ?>" type=text name="dp_valor_ice_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($dp_valor_ice_) ?>"
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=15"; } ?> alt="{datatype: 'decimal', maxLength: 15, precision: 2, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['dp_valor_ice_']['symbol_dec']); ?>', thousandsSep: '', thousandsFormat: <?php echo $this->field_config['dp_valor_ice_']['symbol_fmt']; ?>, manualDecimals: true, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['dp_valor_ice_']['format_neg'] ? "'suffix'" : "'prefix'") ?>, enterTab: false, enterSubmit: false, autoTab: true, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_dp_valor_ice_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_dp_valor_ice_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>

   <?php if (isset($this->nmgp_cmp_hidden['dp_base_irbpnr_']) && $this->nmgp_cmp_hidden['dp_base_irbpnr_'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="dp_base_irbpnr_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($dp_base_irbpnr_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOddMult css_dp_base_irbpnr__line" id="hidden_field_data_dp_base_irbpnr_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_dp_base_irbpnr_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_dp_base_irbpnr__line" style="vertical-align: top;padding: 0px"><input type="hidden" name="dp_base_irbpnr_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($dp_base_irbpnr_); ?>"><span id="id_ajax_label_dp_base_irbpnr_<?php echo $sc_seq_vert; ?>"><?php echo nl2br($dp_base_irbpnr_); ?></span>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_dp_base_irbpnr_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_dp_base_irbpnr_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['dp_valor_irbpnr_']) && $this->nmgp_cmp_hidden['dp_valor_irbpnr_'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="dp_valor_irbpnr_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($dp_valor_irbpnr_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOddMult css_dp_valor_irbpnr__line" id="hidden_field_data_dp_valor_irbpnr_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_dp_valor_irbpnr_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_dp_valor_irbpnr__line" style="vertical-align: top;padding: 0px"><input type="hidden" name="dp_valor_irbpnr_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($dp_valor_irbpnr_); ?>"><span id="id_ajax_label_dp_valor_irbpnr_<?php echo $sc_seq_vert; ?>"><?php echo nl2br($dp_valor_irbpnr_); ?></span>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_dp_valor_irbpnr_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_dp_valor_irbpnr_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php   
       ...
       if (isset($sCheckRead_dp_base_ice_))
       {
           $this->nmgp_cmp_readonly['dp_base_ice_'] = $sCheckRead_dp_base_ice_;
       }
       if ('display: none;' == $sStyleHidden_dp_base_ice_)
       {
           $this->nmgp_cmp_hidden['dp_base_ice_'] = 'off';
       }
       if (isset($sCheckRead_dp_porcentaje_ice_))
       ...
       if (isset($sCheckRead_dp_valor_ice_))
       {
           $this->nmgp_cmp_readonly['dp_valor_ice_'] = $sCheckRead_dp_valor_ice_;
       }
       if ('display: none;' == $sStyleHidden_dp_valor_ice_)
       {
           $this->nmgp_cmp_hidden['dp_valor_ice_'] = 'off';
       }
       if (isset($sCheckRead_dp_base_irbpnr_))
       {
           $this->nmgp_cmp_readonly['dp_base_irbpnr_'] = $sCheckRead_dp_base_irbpnr_;
       }
       if ('display: none;' == $sStyleHidden_dp_base_irbpnr_)
       {
           $this->nmgp_cmp_hidden['dp_base_irbpnr_'] = 'off';
       }
       if (isset($sCheckRead_dp_porcentaje_irbpnr_))
       ...
       if (isset($sCheckRead_dp_valor_irbpnr_))
       {
           $this->nmgp_cmp_readonly['dp_valor_irbpnr_'] = $sCheckRead_dp_valor_irbpnr_;
       }
       if ('display: none;' == $sStyleHidden_dp_valor_irbpnr_)
       {
           $this->nmgp_cmp_hidden['dp_valor_irbpnr_'] = 'off';
       }
   ...
   { 
       ...
       $this->form_vert_form_del_detalle_proforma = $guarda_form_vert_form_del_detalle_proforma;
   } 
   if ($Table_refresh) 
   { 
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_disabled']['birpara']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_disabled']['birpara']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_label']['birpara']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_label']['birpara']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_label']['birpara'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['btn_label']['last'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_del_detalle_proforma");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_del_detalle_proforma");
 parent.scAjaxDetailHeight("form_del_detalle_proforma", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<script type="text/javascript">
	...
	function scBtnFn_sys_format_inc() {
		if ($("#sc_b_new_t.sc-unique-btn-2").length && $("#sc_b_new_t.sc-unique-btn-2").is(":visible")) {
			...
			do_ajax_form_del_detalle_proforma_add_new_line(); return false;
			 return;
		}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_proforma']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
