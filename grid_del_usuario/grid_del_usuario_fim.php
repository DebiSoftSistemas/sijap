...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_del_usuario"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_del_usuario"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_del_usuario'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_del_usuario']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_del_usuario']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_del_usuario']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_del_usuario']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_del_usuario']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_del_usuario']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_del_usuario']['embutida_filho'] as $ind => $sc_init)
          {
