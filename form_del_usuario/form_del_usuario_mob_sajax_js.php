  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_usuario_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_usuario_mob_form();
	}
...
?>
  ...
  // ---------- Validate usu_empresa
  function do_ajax_form_del_usuario_mob_validate_usu_empresa()
  {
    var nomeCampo_usu_empresa = "usu_empresa";
    var var_usu_empresa = scAjaxGetFieldText(nomeCampo_usu_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_usuario_mob_validate_usu_empresa(var_usu_empresa, var_script_case_init, do_ajax_form_del_usuario_mob_validate_usu_empresa_cb);
  } // do_ajax_form_del_usuario_mob_validate_usu_empresa

  function do_ajax_form_del_usuario_mob_validate_usu_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usu_empresa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_usuario_mob_validate_usu_empresa_cb

  // ---------- Validate usu_usuario
  function do_ajax_form_del_usuario_mob_validate_usu_usuario()
  {
    var nomeCampo_usu_usuario = "usu_usuario";
    var var_usu_usuario = scAjaxGetFieldText(nomeCampo_usu_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_usuario_mob_validate_usu_usuario(var_usu_usuario, var_script_case_init, do_ajax_form_del_usuario_mob_validate_usu_usuario_cb);
  } // do_ajax_form_del_usuario_mob_validate_usu_usuario

  function do_ajax_form_del_usuario_mob_validate_usu_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_usuario_mob_validate_usu_usuario_cb

  // ---------- Validate usu_nombre
  function do_ajax_form_del_usuario_mob_validate_usu_nombre()
  {
    var nomeCampo_usu_nombre = "usu_nombre";
    var var_usu_nombre = scAjaxGetFieldText(nomeCampo_usu_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_usuario_mob_validate_usu_nombre(var_usu_nombre, var_script_case_init, do_ajax_form_del_usuario_mob_validate_usu_nombre_cb);
  } // do_ajax_form_del_usuario_mob_validate_usu_nombre

  function do_ajax_form_del_usuario_mob_validate_usu_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_usuario_mob_validate_usu_nombre_cb

  // ---------- Validate usu_cedula
  function do_ajax_form_del_usuario_mob_validate_usu_cedula()
  {
    var nomeCampo_usu_cedula = "usu_cedula";
    var var_usu_cedula = scAjaxGetFieldText(nomeCampo_usu_cedula);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_usuario_mob_validate_usu_cedula(var_usu_cedula, var_script_case_init, do_ajax_form_del_usuario_mob_validate_usu_cedula_cb);
  } // do_ajax_form_del_usuario_mob_validate_usu_cedula

  function do_ajax_form_del_usuario_mob_validate_usu_cedula_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usu_cedula";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_usuario_mob_validate_usu_cedula_cb

  // ---------- Validate usu_direccion
  function do_ajax_form_del_usuario_mob_validate_usu_direccion()
  {
    var nomeCampo_usu_direccion = "usu_direccion";
    var var_usu_direccion = scAjaxGetFieldText(nomeCampo_usu_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_usuario_mob_validate_usu_direccion(var_usu_direccion, var_script_case_init, do_ajax_form_del_usuario_mob_validate_usu_direccion_cb);
  } // do_ajax_form_del_usuario_mob_validate_usu_direccion

  function do_ajax_form_del_usuario_mob_validate_usu_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usu_direccion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_usuario_mob_validate_usu_direccion_cb

  // ---------- Validate usu_telefono
  function do_ajax_form_del_usuario_mob_validate_usu_telefono()
  {
    var nomeCampo_usu_telefono = "usu_telefono";
    var var_usu_telefono = scAjaxGetFieldText(nomeCampo_usu_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_usuario_mob_validate_usu_telefono(var_usu_telefono, var_script_case_init, do_ajax_form_del_usuario_mob_validate_usu_telefono_cb);
  } // do_ajax_form_del_usuario_mob_validate_usu_telefono

  function do_ajax_form_del_usuario_mob_validate_usu_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usu_telefono";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_usuario_mob_validate_usu_telefono_cb

  // ---------- Validate usu_email
  function do_ajax_form_del_usuario_mob_validate_usu_email()
  {
    var nomeCampo_usu_email = "usu_email";
    var var_usu_email = scAjaxGetFieldText(nomeCampo_usu_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_usuario_mob_validate_usu_email(var_usu_email, var_script_case_init, do_ajax_form_del_usuario_mob_validate_usu_email_cb);
  } // do_ajax_form_del_usuario_mob_validate_usu_email

  function do_ajax_form_del_usuario_mob_validate_usu_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usu_email";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_usuario_mob_validate_usu_email_cb

  // ---------- Validate usu_estado
  function do_ajax_form_del_usuario_mob_validate_usu_estado()
  {
    var nomeCampo_usu_estado = "usu_estado";
    var var_usu_estado = scAjaxGetFieldSelect(nomeCampo_usu_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_usuario_mob_validate_usu_estado(var_usu_estado, var_script_case_init, do_ajax_form_del_usuario_mob_validate_usu_estado_cb);
  } // do_ajax_form_del_usuario_mob_validate_usu_estado

  function do_ajax_form_del_usuario_mob_validate_usu_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usu_estado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_usuario_mob_validate_usu_estado_cb

  // ---------- Validate usu_super_administrador
  function do_ajax_form_del_usuario_mob_validate_usu_super_administrador()
  {
    var nomeCampo_usu_super_administrador = "usu_super_administrador";
    var var_usu_super_administrador = scAjaxGetFieldText(nomeCampo_usu_super_administrador);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_usuario_mob_validate_usu_super_administrador(var_usu_super_administrador, var_script_case_init, do_ajax_form_del_usuario_mob_validate_usu_super_administrador_cb);
  } // do_ajax_form_del_usuario_mob_validate_usu_super_administrador

  function do_ajax_form_del_usuario_mob_validate_usu_super_administrador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usu_super_administrador";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_usuario_mob_validate_usu_super_administrador_cb

  // ---------- Validate roles
  function do_ajax_form_del_usuario_mob_validate_roles()
  {
    var nomeCampo_roles = "roles";
    var var_roles = scAjaxGetFieldText(nomeCampo_roles);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_usuario_mob_validate_roles(var_roles, var_script_case_init, do_ajax_form_del_usuario_mob_validate_roles_cb);
  } // do_ajax_form_del_usuario_mob_validate_roles

  function do_ajax_form_del_usuario_mob_validate_roles_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "roles";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_usuario_mob_validate_roles_cb

  // ---------- Validate socio
  function do_ajax_form_del_usuario_mob_validate_socio()
  {
    var nomeCampo_socio = "socio";
    var var_socio = scAjaxGetFieldText(nomeCampo_socio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_usuario_mob_validate_socio(var_socio, var_script_case_init, do_ajax_form_del_usuario_mob_validate_socio_cb);
  } // do_ajax_form_del_usuario_mob_validate_socio

  function do_ajax_form_del_usuario_mob_validate_socio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "socio";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_usuario_mob_validate_socio_cb

  // ---------- Validate transporte
  function do_ajax_form_del_usuario_mob_validate_transporte()
  {
    var nomeCampo_transporte = "transporte";
    var var_transporte = scAjaxGetFieldText(nomeCampo_transporte);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_usuario_mob_validate_transporte(var_transporte, var_script_case_init, do_ajax_form_del_usuario_mob_validate_transporte_cb);
  } // do_ajax_form_del_usuario_mob_validate_transporte

  function do_ajax_form_del_usuario_mob_validate_transporte_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_usuario_mob_validate_transporte_cb

  // ---------- Validate usu_ruc_empresa
  function do_ajax_form_del_usuario_mob_validate_usu_ruc_empresa()
  {
    var nomeCampo_usu_ruc_empresa = "usu_ruc_empresa";
    var var_usu_ruc_empresa = scAjaxGetFieldSelect(nomeCampo_usu_ruc_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_usuario_mob_validate_usu_ruc_empresa(var_usu_ruc_empresa, var_script_case_init, do_ajax_form_del_usuario_mob_validate_usu_ruc_empresa_cb);
  } // do_ajax_form_del_usuario_mob_validate_usu_ruc_empresa

  function do_ajax_form_del_usuario_mob_validate_usu_ruc_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usu_ruc_empresa";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_usuario_mob_validate_usu_ruc_empresa_cb

  // ---------- Validate usu_establecimiento_empresa
  function do_ajax_form_del_usuario_mob_validate_usu_establecimiento_empresa()
  {
    var nomeCampo_usu_establecimiento_empresa = "usu_establecimiento_empresa";
    var var_usu_establecimiento_empresa = scAjaxGetFieldSelect(nomeCampo_usu_establecimiento_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_usuario_mob_validate_usu_establecimiento_empresa(var_usu_establecimiento_empresa, var_script_case_init, do_ajax_form_del_usuario_mob_validate_usu_establecimiento_empresa_cb);
  } // do_ajax_form_del_usuario_mob_validate_usu_establecimiento_empresa

  function do_ajax_form_del_usuario_mob_validate_usu_establecimiento_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usu_establecimiento_empresa";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_usuario_mob_validate_usu_establecimiento_empresa_cb

  // ---------- Validate usu_punto_emision
  function do_ajax_form_del_usuario_mob_validate_usu_punto_emision()
  {
    var nomeCampo_usu_punto_emision = "usu_punto_emision";
    var var_usu_punto_emision = scAjaxGetFieldSelect(nomeCampo_usu_punto_emision);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_usuario_mob_validate_usu_punto_emision(var_usu_punto_emision, var_script_case_init, do_ajax_form_del_usuario_mob_validate_usu_punto_emision_cb);
  } // do_ajax_form_del_usuario_mob_validate_usu_punto_emision

  function do_ajax_form_del_usuario_mob_validate_usu_punto_emision_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usu_punto_emision";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_usuario_mob_validate_usu_punto_emision_cb

  // ---------- Refresh usu_ruc_empresa
  function do_ajax_form_del_usuario_mob_refresh_usu_ruc_empresa()
  {
    var var_usu_ruc_empresa = scAjaxGetFieldSelect("usu_ruc_empresa");
    var var_nmgp_refresh_fields = "usu_establecimiento_empresa";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_usuario_mob_refresh_usu_ruc_empresa(var_usu_ruc_empresa, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_del_usuario_mob_refresh_usu_ruc_empresa_cb);
  } // do_ajax_form_del_usuario_mob_refresh_usu_ruc_empresa

  function do_ajax_form_del_usuario_mob_refresh_usu_ruc_empresa_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    do_ajax_form_del_usuario_mob_refresh_usu_establecimiento_empresa();
    scAjaxShowDebug();
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_usuario_mob_refresh_usu_ruc_empresa_cb

  // ---------- Refresh usu_establecimiento_empresa
  function do_ajax_form_del_usuario_mob_refresh_usu_establecimiento_empresa()
  {
    var var_usu_establecimiento_empresa = scAjaxGetFieldSelect("usu_establecimiento_empresa");
    var var_nmgp_refresh_fields = "usu_punto_emision";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_usuario_mob_refresh_usu_establecimiento_empresa(var_usu_establecimiento_empresa, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_del_usuario_mob_refresh_usu_establecimiento_empresa_cb);
  } // do_ajax_form_del_usuario_mob_refresh_usu_establecimiento_empresa

  function do_ajax_form_del_usuario_mob_refresh_usu_establecimiento_empresa_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_usuario_mob_refresh_usu_establecimiento_empresa_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_usuario_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_usuario_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_usu_empresa = scAjaxGetFieldText("usu_empresa");
    var var_usu_usuario = scAjaxGetFieldText("usu_usuario");
    var var_usu_nombre = scAjaxGetFieldText("usu_nombre");
    var var_usu_cedula = scAjaxGetFieldText("usu_cedula");
    var var_usu_direccion = scAjaxGetFieldText("usu_direccion");
    var var_usu_telefono = scAjaxGetFieldText("usu_telefono");
    var var_usu_email = scAjaxGetFieldText("usu_email");
    var var_usu_estado = scAjaxGetFieldSelect("usu_estado");
    var var_usu_super_administrador = scAjaxGetFieldText("usu_super_administrador");
    var var_usu_ruc_empresa = scAjaxGetFieldSelect("usu_ruc_empresa");
    var var_usu_establecimiento_empresa = scAjaxGetFieldSelect("usu_establecimiento_empresa");
    var var_usu_punto_emision = scAjaxGetFieldSelect("usu_punto_emision");
    ...
    scAjaxProcOn();
    x_ajax_form_del_usuario_mob_submit_form(var_usu_empresa, var_usu_usuario, var_usu_nombre, var_usu_cedula, var_usu_direccion, var_usu_telefono, var_usu_email, var_usu_estado, var_usu_super_administrador, var_usu_ruc_empresa, var_usu_establecimiento_empresa, var_usu_punto_emision, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_usuario_mob_submit_form_cb);
  } // do_ajax_form_del_usuario_mob_submit_form

  function do_ajax_form_del_usuario_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("usu_empresa");
      scAjaxHideErrorDisplay("usu_usuario");
      scAjaxHideErrorDisplay("usu_nombre");
      scAjaxHideErrorDisplay("usu_cedula");
      scAjaxHideErrorDisplay("usu_direccion");
      scAjaxHideErrorDisplay("usu_telefono");
      scAjaxHideErrorDisplay("usu_email");
      scAjaxHideErrorDisplay("usu_estado");
      scAjaxHideErrorDisplay("usu_super_administrador");
      scAjaxHideErrorDisplay("roles");
      scAjaxHideErrorDisplay("socio");
      scAjaxHideErrorDisplay("transporte");
      scAjaxHideErrorDisplay("usu_ruc_empresa");
      scAjaxHideErrorDisplay("usu_establecimiento_empresa");
      scAjaxHideErrorDisplay("usu_punto_emision");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_usuario_mob_submit_form_cb_after_alert);
  } // do_ajax_form_del_usuario_mob_submit_form_cb
  function do_ajax_form_del_usuario_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_usuario_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_del_rol_usuario_mob"] = "off";
  scStatusDetail["form_del_usuario_socio_mob"] = "off";
  scStatusDetail["form_del_transporte_usuario_mob"] = "off";

  function do_ajax_form_del_usuario_mob_navigate_form()
  {
    perform_ajax_form_del_usuario_mob_navigate_form();
  }

  function perform_ajax_form_del_usuario_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("usu_establecimiento_empresa");
    scAjaxHideErrorDisplay("usu_punto_emision");
    var var_usu_usuario = document.F2.usu_usuario.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_del_rol_usuario_mob"] = "on";
    scStatusDetail["form_del_usuario_socio_mob"] = "on";
    scStatusDetail["form_del_transporte_usuario_mob"] = "on";
    x_ajax_form_del_usuario_mob_navigate_form(var_usu_usuario, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_usuario_mob_navigate_form_cb);
  } // do_ajax_form_del_usuario_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_usuario_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_usuario_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.usu_usuario.value = scAjaxGetKeyValue("usu_usuario");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_del_rol_usuario_mob"] && "nmsc_iframe_liga_form_del_rol_usuario_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_del_rol_usuario_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_del_rol_usuario_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_del_rol_usuario_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_del_rol_usuario_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_del_rol_usuario_mob').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_del_usuario_socio_mob"] && "nmsc_iframe_liga_form_del_usuario_socio_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_del_usuario_socio_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_del_usuario_socio_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_del_usuario_socio_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_del_usuario_socio_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_del_usuario_socio_mob').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_del_transporte_usuario_mob"] && "nmsc_iframe_liga_form_del_transporte_usuario_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_del_transporte_usuario_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_del_transporte_usuario_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_del_transporte_usuario_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_del_transporte_usuario_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_del_transporte_usuario_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_usuario_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_del_usuario_mob_navigate_form_cb
  function do_ajax_form_del_usuario_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_del_usuario_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_usuario_mob_navigate_form_cb_after_alert

  function sc_hide_form_del_usuario_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_del_rol_usuario_mob"] && "off" == scStatusDetail["form_del_usuario_socio_mob"] && "off" == scStatusDetail["form_del_transporte_usuario_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "usu_empresa";
  ajax_field_list[1] = "usu_usuario";
  ajax_field_list[2] = "usu_nombre";
  ajax_field_list[3] = "usu_cedula";
  ajax_field_list[4] = "usu_direccion";
  ajax_field_list[5] = "usu_telefono";
  ajax_field_list[6] = "usu_email";
  ajax_field_list[7] = "usu_estado";
  ajax_field_list[8] = "usu_super_administrador";
  ajax_field_list[9] = "roles";
  ajax_field_list[10] = "socio";
  ajax_field_list[11] = "transporte";
  ajax_field_list[12] = "usu_ruc_empresa";
  ajax_field_list[13] = "usu_establecimiento_empresa";
  ajax_field_list[14] = "usu_punto_emision";
  ...
  var ajax_error_list = {
    "usu_empresa": {"label": "<?php echo $this->Ini->Nm_lang['lang_empresa'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "usu_usuario": {"label": "<?php echo $this->Ini->Nm_lang['lang_username'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "usu_nombre": {"label": "<?php echo $this->Ini->Nm_lang['lang_nombre'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "usu_cedula": {"label": "<?php echo $this->Ini->Nm_lang['lang_cedula'] ?>/<?php echo $this->Ini->Nm_lang['lang_ruc'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "usu_direccion": {"label": "<?php echo $this->Ini->Nm_lang['lang_direccion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "usu_telefono": {"label": "<?php echo $this->Ini->Nm_lang['lang_lot_telefono'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "usu_email": {"label": "<?php echo $this->Ini->Nm_lang['lang_email'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "usu_estado": {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "usu_super_administrador": {"label": "Usu Super Administrador", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "roles": {"label": "roles", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "socio": {"label": "<?php echo $this->Ini->Nm_lang['lang_socio'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "usu_ruc_empresa": {"label": "<?php echo $this->Ini->Nm_lang['lang_ruc'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "usu_establecimiento_empresa": {"label": "<?php echo $this->Ini->Nm_lang['lang_establecimiento'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "usu_punto_emision": {"label": "<?php echo $this->Ini->Nm_lang['lang_punto_emision'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "usu_empresa": new Array(),
    "usu_usuario": new Array(),
    "usu_nombre": new Array(),
    "usu_cedula": new Array(),
    "usu_direccion": new Array(),
    "usu_telefono": new Array(),
    "usu_email": new Array(),
    "usu_estado": new Array(),
    "usu_super_administrador": new Array(),
    "roles": new Array(),
    "socio": new Array(),
    "transporte": new Array(),
    "usu_ruc_empresa": new Array(),
    "usu_establecimiento_empresa": new Array(),
    "usu_punto_emision": new Array()
  };
  ajax_field_mult["usu_empresa"][1] = "usu_empresa";
  ajax_field_mult["usu_usuario"][1] = "usu_usuario";
  ajax_field_mult["usu_nombre"][1] = "usu_nombre";
  ajax_field_mult["usu_cedula"][1] = "usu_cedula";
  ajax_field_mult["usu_direccion"][1] = "usu_direccion";
  ajax_field_mult["usu_telefono"][1] = "usu_telefono";
  ajax_field_mult["usu_email"][1] = "usu_email";
  ajax_field_mult["usu_estado"][1] = "usu_estado";
  ajax_field_mult["usu_super_administrador"][1] = "usu_super_administrador";
  ajax_field_mult["roles"][1] = "roles";
  ajax_field_mult["socio"][1] = "socio";
  ajax_field_mult["transporte"][1] = "transporte";
  ajax_field_mult["usu_ruc_empresa"][1] = "usu_ruc_empresa";
  ajax_field_mult["usu_establecimiento_empresa"][1] = "usu_establecimiento_empresa";
  ajax_field_mult["usu_punto_emision"][1] = "usu_punto_emision";
  ...
  var ajax_field_id = {
    ...
    "usu_cedula": new Array("hidden_field_label_usu_cedula", "hidden_field_data_usu_cedula"),
    "usu_direccion": new Array("hidden_field_label_usu_direccion", "hidden_field_data_usu_direccion"),
    "usu_telefono": new Array("hidden_field_label_usu_telefono", "hidden_field_data_usu_telefono"),
    "usu_email": new Array("hidden_field_label_usu_email", "hidden_field_data_usu_email"),
    "usu_estado": new Array("hidden_field_label_usu_estado", "hidden_field_data_usu_estado"),
    "roles": new Array("hidden_field_label_roles", "hidden_field_data_roles"),
    "socio": new Array("hidden_field_label_socio", "hidden_field_data_socio"),
    "transporte": new Array("hidden_field_label_transporte", "hidden_field_data_transporte"),
    "usu_ruc_empresa": new Array("hidden_field_label_usu_ruc_empresa", "hidden_field_data_usu_ruc_empresa"),
    "usu_establecimiento_empresa": new Array("hidden_field_label_usu_establecimiento_empresa", "hidden_field_data_usu_establecimiento_empresa"),
    "usu_punto_emision": new Array("hidden_field_label_usu_punto_emision", "hidden_field_data_usu_punto_emision")
  };
  ...
  var ajax_read_only = {
    ...
    "usu_email": "off",
    "usu_estado": "off",
    "usu_super_administrador": "off",
    "roles": "off",
    "socio": "off",
    "transporte": "off",
    "usu_ruc_empresa": "off",
    "usu_establecimiento_empresa": "off",
    "usu_punto_emision": "off"
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("usu_super_administrador" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("usu_establecimiento_empresa" == sIndex)
    {
      scAjaxSetFieldSelect(sIndex, aValue, null);
      updateHeaderFooter(sIndex, aValue);
