  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_jap_tarifa_reconexion" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_jap_tarifa_reconexion_form();
	}
...
?>
  ...
  // ---------- Validate tr_id_
  function do_ajax_form_jap_tarifa_reconexion_validate_tr_id_(iNumLinha)
  {
    var nomeCampo_tr_id_ = "tr_id_" + iNumLinha;
    var var_tr_id_ = scAjaxGetFieldHidden(nomeCampo_tr_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_tarifa_reconexion_validate_tr_id_(var_tr_id_, iNumLinha, var_script_case_init, do_ajax_form_jap_tarifa_reconexion_validate_tr_id__cb);
  } // do_ajax_form_jap_tarifa_reconexion_validate_tr_id_

  function do_ajax_form_jap_tarifa_reconexion_validate_tr_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "tr_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tr_id_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "tr_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tr_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_tarifa_reconexion_validate_tr_id__cb

  // ---------- Validate tr_empresa_
  function do_ajax_form_jap_tarifa_reconexion_validate_tr_empresa_(iNumLinha)
  {
    var nomeCampo_tr_empresa_ = "tr_empresa_" + iNumLinha;
    var var_tr_empresa_ = scAjaxGetFieldText(nomeCampo_tr_empresa_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_tarifa_reconexion_validate_tr_empresa_(var_tr_empresa_, iNumLinha, var_script_case_init, do_ajax_form_jap_tarifa_reconexion_validate_tr_empresa__cb);
  } // do_ajax_form_jap_tarifa_reconexion_validate_tr_empresa_

  function do_ajax_form_jap_tarifa_reconexion_validate_tr_empresa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tr_empresa_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tr_empresa_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tr_empresa_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tr_empresa_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_tarifa_reconexion_validate_tr_empresa__cb

  // ---------- Validate tr_producto_
  function do_ajax_form_jap_tarifa_reconexion_validate_tr_producto_(iNumLinha)
  {
    var nomeCampo_tr_producto_ = "tr_producto_" + iNumLinha;
    var var_tr_producto_ = scAjaxGetFieldSelect(nomeCampo_tr_producto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_tarifa_reconexion_validate_tr_producto_(var_tr_producto_, iNumLinha, var_script_case_init, do_ajax_form_jap_tarifa_reconexion_validate_tr_producto__cb);
  } // do_ajax_form_jap_tarifa_reconexion_validate_tr_producto_

  function do_ajax_form_jap_tarifa_reconexion_validate_tr_producto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tr_producto_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tr_producto_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tr_producto_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tr_producto_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_tarifa_reconexion_validate_tr_producto__cb

  // ---------- Validate tr_corte_desde_
  function do_ajax_form_jap_tarifa_reconexion_validate_tr_corte_desde_(iNumLinha)
  {
    var nomeCampo_tr_corte_desde_ = "tr_corte_desde_" + iNumLinha;
    var var_tr_corte_desde_ = scAjaxGetFieldText(nomeCampo_tr_corte_desde_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_tarifa_reconexion_validate_tr_corte_desde_(var_tr_corte_desde_, iNumLinha, var_script_case_init, do_ajax_form_jap_tarifa_reconexion_validate_tr_corte_desde__cb);
  } // do_ajax_form_jap_tarifa_reconexion_validate_tr_corte_desde_

  function do_ajax_form_jap_tarifa_reconexion_validate_tr_corte_desde__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tr_corte_desde_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tr_corte_desde_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tr_corte_desde_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tr_corte_desde_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_tarifa_reconexion_validate_tr_corte_desde__cb

  // ---------- Validate tr_corte_hasta_
  function do_ajax_form_jap_tarifa_reconexion_validate_tr_corte_hasta_(iNumLinha)
  {
    var nomeCampo_tr_corte_hasta_ = "tr_corte_hasta_" + iNumLinha;
    var var_tr_corte_hasta_ = scAjaxGetFieldText(nomeCampo_tr_corte_hasta_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_tarifa_reconexion_validate_tr_corte_hasta_(var_tr_corte_hasta_, iNumLinha, var_script_case_init, do_ajax_form_jap_tarifa_reconexion_validate_tr_corte_hasta__cb);
  } // do_ajax_form_jap_tarifa_reconexion_validate_tr_corte_hasta_

  function do_ajax_form_jap_tarifa_reconexion_validate_tr_corte_hasta__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tr_corte_hasta_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tr_corte_hasta_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tr_corte_hasta_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tr_corte_hasta_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_tarifa_reconexion_validate_tr_corte_hasta__cb

  // ---------- Validate tr_formula_
  function do_ajax_form_jap_tarifa_reconexion_validate_tr_formula_(iNumLinha)
  {
    var nomeCampo_tr_formula_ = "tr_formula_" + iNumLinha;
    var var_tr_formula_ = scAjaxGetFieldText(nomeCampo_tr_formula_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_tarifa_reconexion_validate_tr_formula_(var_tr_formula_, iNumLinha, var_script_case_init, do_ajax_form_jap_tarifa_reconexion_validate_tr_formula__cb);
  } // do_ajax_form_jap_tarifa_reconexion_validate_tr_formula_

  function do_ajax_form_jap_tarifa_reconexion_validate_tr_formula__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tr_formula_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tr_formula_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tr_formula_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tr_formula_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_tarifa_reconexion_validate_tr_formula__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_jap_tarifa_reconexion_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_jap_tarifa_reconexion_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_jap_tarifa_reconexion_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_jap_tarifa_reconexion_add_new_line_cb);
  } // do_ajax_form_jap_tarifa_reconexion_add_new_line

  function do_ajax_form_jap_tarifa_reconexion_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_jap_tarifa_reconexion_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_jap_tarifa_reconexion_backup_line(iNumLinha)
  {
    var var_tr_id_ = scAjaxGetFieldHidden("tr_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_tarifa_reconexion_backup_line(var_tr_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_jap_tarifa_reconexion_backup_line_cb);
  } // do_ajax_form_jap_tarifa_reconexion_backup_line

  function do_ajax_form_jap_tarifa_reconexion_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_jap_tarifa_reconexion_backup_line_cb

  function do_ajax_form_jap_tarifa_reconexion_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_jap_tarifa_reconexion_cancel_insert

  function do_ajax_form_jap_tarifa_reconexion_cancel_update(iSeqVert)
  {
    do_ajax_form_jap_tarifa_reconexion_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_jap_tarifa_reconexion_cancel_update

  function do_ajax_form_jap_tarifa_reconexion_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_jap_tarifa_reconexion_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_jap_tarifa_reconexion_table_refresh()
  {
    var var_tr_id_ = document.F2.tr_id_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_jap_tarifa_reconexion_table_refresh(var_tr_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jap_tarifa_reconexion_table_refresh_cb);
  } //  do_ajax_form_jap_tarifa_reconexion_table_refresh

  function do_ajax_form_jap_tarifa_reconexion_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.tr_id_.value = scAjaxGetKeyValue("tr_id_");
    ...
    scAjaxAlert(do_ajax_form_jap_tarifa_reconexion_table_refresh_cb_after_alert);
  } // do_ajax_form_jap_tarifa_reconexion_table_refresh_cb
  function do_ajax_form_jap_tarifa_reconexion_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_jap_tarifa_reconexion_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_jap_tarifa_reconexion_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_jap_tarifa_reconexion_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_tr_id_ = scAjaxGetFieldHidden("tr_id_" + iNumLinha);
    var var_tr_empresa_ = scAjaxGetFieldText("tr_empresa_" + iNumLinha);
    var var_tr_producto_ = scAjaxGetFieldSelect("tr_producto_" + iNumLinha);
    var var_tr_corte_desde_ = scAjaxGetFieldText("tr_corte_desde_" + iNumLinha);
    var var_tr_corte_hasta_ = scAjaxGetFieldText("tr_corte_hasta_" + iNumLinha);
    var var_tr_formula_ = scAjaxGetFieldText("tr_formula_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_jap_tarifa_reconexion_submit_form(var_tr_id_, var_tr_empresa_, var_tr_producto_, var_tr_corte_desde_, var_tr_corte_hasta_, var_tr_formula_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_jap_tarifa_reconexion_submit_form_cb);
  } // do_ajax_form_jap_tarifa_reconexion_submit_form

  function do_ajax_form_jap_tarifa_reconexion_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("tr_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tr_empresa_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tr_producto_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tr_corte_desde_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tr_corte_hasta_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tr_formula_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_jap_tarifa_reconexion_submit_form_cb_after_alert);
  } // do_ajax_form_jap_tarifa_reconexion_submit_form_cb
  function do_ajax_form_jap_tarifa_reconexion_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_jap_tarifa_reconexion_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_jap_tarifa_reconexion_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_jap_tarifa_reconexion_navigate_form, function() {});
    } else {
      perform_ajax_form_jap_tarifa_reconexion_navigate_form();
    }
  }

  function perform_ajax_form_jap_tarifa_reconexion_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_jap_tarifa_reconexion_cancel_insert(sc_form_jap_tarifa_reconexion_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("tr_id_" + iNavForm);
      scAjaxHideErrorDisplay("tr_empresa_" + iNavForm);
      scAjaxHideErrorDisplay("tr_producto_" + iNavForm);
      scAjaxHideErrorDisplay("tr_corte_desde_" + iNavForm);
      scAjaxHideErrorDisplay("tr_corte_hasta_" + iNavForm);
      scAjaxHideErrorDisplay("tr_formula_" + iNavForm);
    }
    var var_tr_id_ = document.F2.tr_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_jap_tarifa_reconexion_navigate_form(var_tr_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jap_tarifa_reconexion_navigate_form_cb);
  } // do_ajax_form_jap_tarifa_reconexion_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_tarifa_reconexion']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_jap_tarifa_reconexion_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.tr_id_.value = scAjaxGetKeyValue("tr_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_jap_tarifa_reconexion_navigate_form_cb_after_alert);
  } // do_ajax_form_jap_tarifa_reconexion_navigate_form_cb
  function do_ajax_form_jap_tarifa_reconexion_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_jap_tarifa_reconexion_navigate_form_cb_after_alert

    function sc_form_jap_tarifa_reconexion_get_last_line_number()
    {
    ...
    } //sc_form_jap_tarifa_reconexion_get_last_line_number

  function sc_hide_form_jap_tarifa_reconexion_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "tr_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tr_empresa_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tr_producto_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tr_corte_desde_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tr_corte_hasta_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tr_formula_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["tr_id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tr_empresa_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_empresa'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tr_producto_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_producto'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tr_corte_desde_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_nro_corte'] ?> <?php echo $this->Ini->Nm_lang['lang_desde'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tr_corte_hasta_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_nro_corte'] ?> <?php echo $this->Ini->Nm_lang['lang_hasta'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tr_formula_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_formula'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["tr_id_"][iNumLinha] = "tr_id_" + iNumLinha;
    ajax_field_mult["tr_empresa_"][iNumLinha] = "tr_empresa_" + iNumLinha;
    ajax_field_mult["tr_producto_"][iNumLinha] = "tr_producto_" + iNumLinha;
    ajax_field_mult["tr_corte_desde_"][iNumLinha] = "tr_corte_desde_" + iNumLinha;
    ajax_field_mult["tr_corte_hasta_"][iNumLinha] = "tr_corte_hasta_" + iNumLinha;
    ajax_field_mult["tr_formula_"][iNumLinha] = "tr_formula_" + iNumLinha;
    ajax_field_id["tr_producto_" + iNumLinha] = new Array("hidden_field_label_tr_producto_", "hidden_field_data_tr_producto_" + iNumLinha);
    ajax_field_id["tr_corte_desde_" + iNumLinha] = new Array("hidden_field_label_tr_corte_desde_", "hidden_field_data_tr_corte_desde_" + iNumLinha);
    ajax_field_id["tr_corte_hasta_" + iNumLinha] = new Array("hidden_field_label_tr_corte_hasta_", "hidden_field_data_tr_corte_hasta_" + iNumLinha);
    ajax_field_id["tr_formula_" + iNumLinha] = new Array("hidden_field_label_tr_formula_", "hidden_field_data_tr_formula_" + iNumLinha);
    ajax_error_count["tr_id_" + iNumLinha] = "off";
    ajax_error_count["tr_empresa_" + iNumLinha] = "off";
    ajax_error_count["tr_producto_" + iNumLinha] = "off";
    ajax_error_count["tr_corte_desde_" + iNumLinha] = "off";
    ajax_error_count["tr_corte_hasta_" + iNumLinha] = "off";
    ajax_error_count["tr_formula_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["tr_id_" + iNumLinha] = "on";
    ajax_read_only["tr_empresa_" + iNumLinha] = "off";
    ajax_read_only["tr_producto_" + iNumLinha] = "off";
    ajax_read_only["tr_corte_desde_" + iNumLinha] = "off";
    ajax_read_only["tr_corte_hasta_" + iNumLinha] = "off";
    ajax_read_only["tr_formula_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["tr_id_" + iNumLinha] = "on";
    ajax_read_only["tr_empresa_" + iNumLinha] = "on";
    ajax_read_only["tr_producto_" + iNumLinha] = "on";
    ajax_read_only["tr_corte_desde_" + iNumLinha] = "on";
    ajax_read_only["tr_corte_hasta_" + iNumLinha] = "on";
    ajax_read_only["tr_formula_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["tr_id_" + iNumLinha] = null;
    ajax_error_list["tr_empresa_" + iNumLinha] = null;
    ajax_error_list["tr_producto_" + iNumLinha] = null;
    ajax_error_list["tr_corte_desde_" + iNumLinha] = null;
    ajax_error_list["tr_corte_hasta_" + iNumLinha] = null;
    ajax_error_list["tr_formula_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "tr_id_": new Array(),
    "tr_empresa_": new Array(),
    "tr_producto_": new Array(),
    "tr_corte_desde_": new Array(),
    "tr_corte_hasta_": new Array(),
    "tr_formula_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["tr_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tr_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tr_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tr_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tr_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tr_empresa_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tr_empresa_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tr_empresa_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tr_empresa_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tr_empresa_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tr_producto_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tr_producto_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tr_producto_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tr_producto_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tr_producto_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tr_corte_desde_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tr_corte_desde_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tr_corte_desde_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tr_corte_desde_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tr_corte_desde_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tr_corte_hasta_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tr_corte_hasta_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tr_corte_hasta_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tr_corte_hasta_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tr_corte_hasta_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tr_formula_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tr_formula_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tr_formula_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tr_formula_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tr_formula_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tr_id_'])) ? $this->nmgp_cmp_readonly['tr_id_'] : 'on';
?>
    scAjaxFieldRead("tr_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tr_empresa_'])) ? $this->nmgp_cmp_readonly['tr_empresa_'] : 'off';
?>
    scAjaxFieldRead("tr_empresa_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tr_producto_'])) ? $this->nmgp_cmp_readonly['tr_producto_'] : 'off';
?>
    scAjaxFieldRead("tr_producto_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tr_corte_desde_'])) ? $this->nmgp_cmp_readonly['tr_corte_desde_'] : 'off';
?>
    scAjaxFieldRead("tr_corte_desde_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tr_corte_hasta_'])) ? $this->nmgp_cmp_readonly['tr_corte_hasta_'] : 'off';
?>
    scAjaxFieldRead("tr_corte_hasta_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tr_formula_'])) ? $this->nmgp_cmp_readonly['tr_formula_'] : 'off';
?>
    scAjaxFieldRead("tr_formula_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("tr_id_" + iSeq, "on");
    scAjaxFieldRead("tr_empresa_" + iSeq, "on");
    scAjaxFieldRead("tr_producto_" + iSeq, "on");
    scAjaxFieldRead("tr_corte_desde_" + iSeq, "on");
    scAjaxFieldRead("tr_corte_hasta_" + iSeq, "on");
    scAjaxFieldRead("tr_formula_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["tr_id_" + iRow] || "on" == ajax_error_count["tr_empresa_" + iRow] || "on" == ajax_error_count["tr_producto_" + iRow] || "on" == ajax_error_count["tr_corte_desde_" + iRow] || "on" == ajax_error_count["tr_corte_hasta_" + iRow] || "on" == ajax_error_count["tr_formula_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tr_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tr_empresa_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tr_producto_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tr_corte_desde_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tr_corte_hasta_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tr_formula_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["tr_id_" + iRow] && "off" == ajax_error_count["tr_empresa_" + iRow] && "off" == ajax_error_count["tr_producto_" + iRow] && "off" == ajax_error_count["tr_corte_desde_" + iRow] && "off" == ajax_error_count["tr_corte_hasta_" + iRow] && "off" == ajax_error_count["tr_formula_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["tr_id_" + iRow] = "off";
        ajax_error_count["tr_empresa_" + iRow] = "off";
        ajax_error_count["tr_producto_" + iRow] = "off";
        ajax_error_count["tr_corte_desde_" + iRow] = "off";
        ajax_error_count["tr_corte_hasta_" + iRow] = "off";
        ajax_error_count["tr_formula_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_tr_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tr_empresa_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tr_producto_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tr_corte_desde_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tr_corte_hasta_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tr_formula_" + iRow).removeClass("scFormErrorLine");
    }
  }
