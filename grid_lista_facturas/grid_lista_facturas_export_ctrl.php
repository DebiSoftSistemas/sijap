<?php
@session_start() ;
$_SESSION['scriptcase']['grid_lista_facturas']['sc_process_barr'] = true;
require_once('../grid_lista_facturas/index.php');
unset($_SESSION['scriptcase']['grid_lista_facturas']['sc_process_barr']);
$ExportCtrl = new grid_lista_facturas_export_control;
$ExportCtrl->Export_barr();

class grid_lista_facturas_export_control
{
