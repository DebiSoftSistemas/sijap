...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_lista_facturas"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_lista_facturas"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_del_punto_venta'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_lista_facturas']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_lista_facturas']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_lista_facturas']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_lista_facturas']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_lista_facturas']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_lista_facturas</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_lista_facturas']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_lista_facturas']['embutida_filho'] as $ind => $sc_init)
          {
