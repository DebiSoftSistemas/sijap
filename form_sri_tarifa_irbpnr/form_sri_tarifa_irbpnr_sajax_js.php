  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sri_tarifa_irbpnr" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sri_tarifa_irbpnr_form();
	}
...
?>
  ...
  // ---------- Validate irbpnr_codigo_
  function do_ajax_form_sri_tarifa_irbpnr_validate_irbpnr_codigo_(iNumLinha)
  {
    var nomeCampo_irbpnr_codigo_ = "irbpnr_codigo_" + iNumLinha;
    var var_irbpnr_codigo_ = scAjaxGetFieldText(nomeCampo_irbpnr_codigo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tarifa_irbpnr_validate_irbpnr_codigo_(var_irbpnr_codigo_, iNumLinha, var_script_case_init, do_ajax_form_sri_tarifa_irbpnr_validate_irbpnr_codigo__cb);
  } // do_ajax_form_sri_tarifa_irbpnr_validate_irbpnr_codigo_

  function do_ajax_form_sri_tarifa_irbpnr_validate_irbpnr_codigo__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "irbpnr_codigo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "irbpnr_codigo_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "irbpnr_codigo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "irbpnr_codigo_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_tarifa_irbpnr_validate_irbpnr_codigo__cb

  // ---------- Validate irbpnr_descripcion_
  function do_ajax_form_sri_tarifa_irbpnr_validate_irbpnr_descripcion_(iNumLinha)
  {
    var nomeCampo_irbpnr_descripcion_ = "irbpnr_descripcion_" + iNumLinha;
    var var_irbpnr_descripcion_ = scAjaxGetFieldText(nomeCampo_irbpnr_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tarifa_irbpnr_validate_irbpnr_descripcion_(var_irbpnr_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_sri_tarifa_irbpnr_validate_irbpnr_descripcion__cb);
  } // do_ajax_form_sri_tarifa_irbpnr_validate_irbpnr_descripcion_

  function do_ajax_form_sri_tarifa_irbpnr_validate_irbpnr_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "irbpnr_descripcion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "irbpnr_descripcion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "irbpnr_descripcion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "irbpnr_descripcion_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_tarifa_irbpnr_validate_irbpnr_descripcion__cb

  // ---------- Validate irbpnr_tarifa_especifica_
  function do_ajax_form_sri_tarifa_irbpnr_validate_irbpnr_tarifa_especifica_(iNumLinha)
  {
    var nomeCampo_irbpnr_tarifa_especifica_ = "irbpnr_tarifa_especifica_" + iNumLinha;
    var var_irbpnr_tarifa_especifica_ = scAjaxGetFieldText(nomeCampo_irbpnr_tarifa_especifica_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tarifa_irbpnr_validate_irbpnr_tarifa_especifica_(var_irbpnr_tarifa_especifica_, iNumLinha, var_script_case_init, do_ajax_form_sri_tarifa_irbpnr_validate_irbpnr_tarifa_especifica__cb);
  } // do_ajax_form_sri_tarifa_irbpnr_validate_irbpnr_tarifa_especifica_

  function do_ajax_form_sri_tarifa_irbpnr_validate_irbpnr_tarifa_especifica__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "irbpnr_tarifa_especifica_" + iLineNumber;
    }
    else
    {
      sFieldValid = "irbpnr_tarifa_especifica_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "irbpnr_tarifa_especifica_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "irbpnr_tarifa_especifica_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_tarifa_irbpnr_validate_irbpnr_tarifa_especifica__cb

  // ---------- Validate irbpnr_tarifa_advaloren_
  function do_ajax_form_sri_tarifa_irbpnr_validate_irbpnr_tarifa_advaloren_(iNumLinha)
  {
    var nomeCampo_irbpnr_tarifa_advaloren_ = "irbpnr_tarifa_advaloren_" + iNumLinha;
    var var_irbpnr_tarifa_advaloren_ = scAjaxGetFieldText(nomeCampo_irbpnr_tarifa_advaloren_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tarifa_irbpnr_validate_irbpnr_tarifa_advaloren_(var_irbpnr_tarifa_advaloren_, iNumLinha, var_script_case_init, do_ajax_form_sri_tarifa_irbpnr_validate_irbpnr_tarifa_advaloren__cb);
  } // do_ajax_form_sri_tarifa_irbpnr_validate_irbpnr_tarifa_advaloren_

  function do_ajax_form_sri_tarifa_irbpnr_validate_irbpnr_tarifa_advaloren__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "irbpnr_tarifa_advaloren_" + iLineNumber;
    }
    else
    {
      sFieldValid = "irbpnr_tarifa_advaloren_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "irbpnr_tarifa_advaloren_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "irbpnr_tarifa_advaloren_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_tarifa_irbpnr_validate_irbpnr_tarifa_advaloren__cb

  // ---------- Validate irbpnr_estado_
  function do_ajax_form_sri_tarifa_irbpnr_validate_irbpnr_estado_(iNumLinha)
  {
    var nomeCampo_irbpnr_estado_ = "irbpnr_estado_" + iNumLinha;
    var var_irbpnr_estado_ = scAjaxGetFieldSelect(nomeCampo_irbpnr_estado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tarifa_irbpnr_validate_irbpnr_estado_(var_irbpnr_estado_, iNumLinha, var_script_case_init, do_ajax_form_sri_tarifa_irbpnr_validate_irbpnr_estado__cb);
  } // do_ajax_form_sri_tarifa_irbpnr_validate_irbpnr_estado_

  function do_ajax_form_sri_tarifa_irbpnr_validate_irbpnr_estado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "irbpnr_estado_" + iLineNumber;
    }
    else
    {
      sFieldValid = "irbpnr_estado_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "irbpnr_estado_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "irbpnr_estado_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_tarifa_irbpnr_validate_irbpnr_estado__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_sri_tarifa_irbpnr_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_sri_tarifa_irbpnr_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sri_tarifa_irbpnr_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_sri_tarifa_irbpnr_add_new_line_cb);
  } // do_ajax_form_sri_tarifa_irbpnr_add_new_line

  function do_ajax_form_sri_tarifa_irbpnr_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_sri_tarifa_irbpnr_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_sri_tarifa_irbpnr_backup_line(iNumLinha)
  {
    var var_irbpnr_codigo_ = scAjaxGetFieldText("irbpnr_codigo_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tarifa_irbpnr_backup_line(var_irbpnr_codigo_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_sri_tarifa_irbpnr_backup_line_cb);
  } // do_ajax_form_sri_tarifa_irbpnr_backup_line

  function do_ajax_form_sri_tarifa_irbpnr_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_sri_tarifa_irbpnr_backup_line_cb

  function do_ajax_form_sri_tarifa_irbpnr_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_sri_tarifa_irbpnr_cancel_insert

  function do_ajax_form_sri_tarifa_irbpnr_cancel_update(iSeqVert)
  {
    do_ajax_form_sri_tarifa_irbpnr_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_sri_tarifa_irbpnr_cancel_update

  function do_ajax_form_sri_tarifa_irbpnr_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_sri_tarifa_irbpnr_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_sri_tarifa_irbpnr_table_refresh()
  {
    var var_irbpnr_codigo_ = document.F2.irbpnr_codigo_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_sri_tarifa_irbpnr_table_refresh(var_irbpnr_codigo_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sri_tarifa_irbpnr_table_refresh_cb);
  } //  do_ajax_form_sri_tarifa_irbpnr_table_refresh

  function do_ajax_form_sri_tarifa_irbpnr_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.irbpnr_codigo_.value = scAjaxGetKeyValue("irbpnr_codigo_");
    ...
    scAjaxAlert(do_ajax_form_sri_tarifa_irbpnr_table_refresh_cb_after_alert);
  } // do_ajax_form_sri_tarifa_irbpnr_table_refresh_cb
  function do_ajax_form_sri_tarifa_irbpnr_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_sri_tarifa_irbpnr_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_sri_tarifa_irbpnr_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_sri_tarifa_irbpnr_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_irbpnr_codigo_ = scAjaxGetFieldText("irbpnr_codigo_" + iNumLinha);
    var var_irbpnr_descripcion_ = scAjaxGetFieldText("irbpnr_descripcion_" + iNumLinha);
    var var_irbpnr_tarifa_especifica_ = scAjaxGetFieldText("irbpnr_tarifa_especifica_" + iNumLinha);
    var var_irbpnr_tarifa_advaloren_ = scAjaxGetFieldText("irbpnr_tarifa_advaloren_" + iNumLinha);
    var var_irbpnr_estado_ = scAjaxGetFieldSelect("irbpnr_estado_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_sri_tarifa_irbpnr_submit_form(var_irbpnr_codigo_, var_irbpnr_descripcion_, var_irbpnr_tarifa_especifica_, var_irbpnr_tarifa_advaloren_, var_irbpnr_estado_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sri_tarifa_irbpnr_submit_form_cb);
  } // do_ajax_form_sri_tarifa_irbpnr_submit_form

  function do_ajax_form_sri_tarifa_irbpnr_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("irbpnr_codigo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("irbpnr_descripcion_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("irbpnr_tarifa_especifica_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("irbpnr_tarifa_advaloren_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("irbpnr_estado_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sri_tarifa_irbpnr_submit_form_cb_after_alert);
  } // do_ajax_form_sri_tarifa_irbpnr_submit_form_cb
  function do_ajax_form_sri_tarifa_irbpnr_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sri_tarifa_irbpnr_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sri_tarifa_irbpnr_navigate_form()
  {
    perform_ajax_form_sri_tarifa_irbpnr_navigate_form();
  }

  function perform_ajax_form_sri_tarifa_irbpnr_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_sri_tarifa_irbpnr_cancel_insert(sc_form_sri_tarifa_irbpnr_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("irbpnr_codigo_" + iNavForm);
      scAjaxHideErrorDisplay("irbpnr_descripcion_" + iNavForm);
      scAjaxHideErrorDisplay("irbpnr_tarifa_especifica_" + iNavForm);
      scAjaxHideErrorDisplay("irbpnr_tarifa_advaloren_" + iNavForm);
      scAjaxHideErrorDisplay("irbpnr_estado_" + iNavForm);
    }
    var var_irbpnr_codigo_ = document.F2.irbpnr_codigo_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sri_tarifa_irbpnr_navigate_form(var_irbpnr_codigo_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sri_tarifa_irbpnr_navigate_form_cb);
  } // do_ajax_form_sri_tarifa_irbpnr_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sri_tarifa_irbpnr']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sri_tarifa_irbpnr_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.irbpnr_codigo_.value = scAjaxGetKeyValue("irbpnr_codigo_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sri_tarifa_irbpnr_navigate_form_cb_after_alert);
  } // do_ajax_form_sri_tarifa_irbpnr_navigate_form_cb
  function do_ajax_form_sri_tarifa_irbpnr_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_sri_tarifa_irbpnr_navigate_form_cb_after_alert

    function sc_form_sri_tarifa_irbpnr_get_last_line_number()
    {
    ...
    } //sc_form_sri_tarifa_irbpnr_get_last_line_number

  function sc_hide_form_sri_tarifa_irbpnr_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "irbpnr_codigo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "irbpnr_descripcion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "irbpnr_tarifa_especifica_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "irbpnr_tarifa_advaloren_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "irbpnr_estado_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["irbpnr_codigo_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_codigo'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["irbpnr_descripcion_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_descripcion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["irbpnr_tarifa_especifica_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tarifa_especifica'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["irbpnr_tarifa_advaloren_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tarifa_advaloren'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["irbpnr_estado_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["irbpnr_codigo_"][iNumLinha] = "irbpnr_codigo_" + iNumLinha;
    ajax_field_mult["irbpnr_descripcion_"][iNumLinha] = "irbpnr_descripcion_" + iNumLinha;
    ajax_field_mult["irbpnr_tarifa_especifica_"][iNumLinha] = "irbpnr_tarifa_especifica_" + iNumLinha;
    ajax_field_mult["irbpnr_tarifa_advaloren_"][iNumLinha] = "irbpnr_tarifa_advaloren_" + iNumLinha;
    ajax_field_mult["irbpnr_estado_"][iNumLinha] = "irbpnr_estado_" + iNumLinha;
    ajax_field_id["irbpnr_codigo_" + iNumLinha] = new Array("hidden_field_label_irbpnr_codigo_", "hidden_field_data_irbpnr_codigo_" + iNumLinha);
    ajax_field_id["irbpnr_descripcion_" + iNumLinha] = new Array("hidden_field_label_irbpnr_descripcion_", "hidden_field_data_irbpnr_descripcion_" + iNumLinha);
    ajax_field_id["irbpnr_tarifa_especifica_" + iNumLinha] = new Array("hidden_field_label_irbpnr_tarifa_especifica_", "hidden_field_data_irbpnr_tarifa_especifica_" + iNumLinha);
    ajax_field_id["irbpnr_estado_" + iNumLinha] = new Array("hidden_field_label_irbpnr_estado_", "hidden_field_data_irbpnr_estado_" + iNumLinha);
    ajax_error_count["irbpnr_codigo_" + iNumLinha] = "off";
    ajax_error_count["irbpnr_descripcion_" + iNumLinha] = "off";
    ajax_error_count["irbpnr_tarifa_especifica_" + iNumLinha] = "off";
    ajax_error_count["irbpnr_tarifa_advaloren_" + iNumLinha] = "off";
    ajax_error_count["irbpnr_estado_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["irbpnr_codigo_" + iNumLinha] = "on";
    ajax_read_only["irbpnr_descripcion_" + iNumLinha] = "off";
    ajax_read_only["irbpnr_tarifa_especifica_" + iNumLinha] = "off";
    ajax_read_only["irbpnr_tarifa_advaloren_" + iNumLinha] = "off";
    ajax_read_only["irbpnr_estado_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["irbpnr_codigo_" + iNumLinha] = "on";
    ajax_read_only["irbpnr_descripcion_" + iNumLinha] = "on";
    ajax_read_only["irbpnr_tarifa_especifica_" + iNumLinha] = "on";
    ajax_read_only["irbpnr_tarifa_advaloren_" + iNumLinha] = "on";
    ajax_read_only["irbpnr_estado_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["irbpnr_codigo_" + iNumLinha] = null;
    ajax_error_list["irbpnr_descripcion_" + iNumLinha] = null;
    ajax_error_list["irbpnr_tarifa_especifica_" + iNumLinha] = null;
    ajax_error_list["irbpnr_tarifa_advaloren_" + iNumLinha] = null;
    ajax_error_list["irbpnr_estado_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "irbpnr_codigo_": new Array(),
    "irbpnr_descripcion_": new Array(),
    "irbpnr_tarifa_especifica_": new Array(),
    "irbpnr_tarifa_advaloren_": new Array(),
    "irbpnr_estado_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["irbpnr_codigo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["irbpnr_codigo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["irbpnr_codigo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["irbpnr_codigo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["irbpnr_codigo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["irbpnr_descripcion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["irbpnr_descripcion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["irbpnr_descripcion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["irbpnr_descripcion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["irbpnr_descripcion_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["irbpnr_tarifa_especifica_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["irbpnr_tarifa_especifica_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["irbpnr_tarifa_especifica_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["irbpnr_tarifa_especifica_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["irbpnr_tarifa_especifica_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["irbpnr_tarifa_advaloren_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["irbpnr_tarifa_advaloren_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["irbpnr_tarifa_advaloren_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["irbpnr_tarifa_advaloren_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["irbpnr_tarifa_advaloren_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["irbpnr_estado_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["irbpnr_estado_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["irbpnr_estado_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["irbpnr_estado_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["irbpnr_estado_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['irbpnr_codigo_'])) ? $this->nmgp_cmp_readonly['irbpnr_codigo_'] : 'on';
?>
    scAjaxFieldRead("irbpnr_codigo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['irbpnr_descripcion_'])) ? $this->nmgp_cmp_readonly['irbpnr_descripcion_'] : 'off';
?>
    scAjaxFieldRead("irbpnr_descripcion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['irbpnr_tarifa_especifica_'])) ? $this->nmgp_cmp_readonly['irbpnr_tarifa_especifica_'] : 'off';
?>
    scAjaxFieldRead("irbpnr_tarifa_especifica_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['irbpnr_tarifa_advaloren_'])) ? $this->nmgp_cmp_readonly['irbpnr_tarifa_advaloren_'] : 'off';
?>
    scAjaxFieldRead("irbpnr_tarifa_advaloren_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['irbpnr_estado_'])) ? $this->nmgp_cmp_readonly['irbpnr_estado_'] : 'off';
?>
    scAjaxFieldRead("irbpnr_estado_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("irbpnr_codigo_" + iSeq, "on");
    scAjaxFieldRead("irbpnr_descripcion_" + iSeq, "on");
    scAjaxFieldRead("irbpnr_tarifa_especifica_" + iSeq, "on");
    scAjaxFieldRead("irbpnr_tarifa_advaloren_" + iSeq, "on");
    scAjaxFieldRead("irbpnr_estado_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["irbpnr_codigo_" + iRow] || "on" == ajax_error_count["irbpnr_descripcion_" + iRow] || "on" == ajax_error_count["irbpnr_tarifa_especifica_" + iRow] || "on" == ajax_error_count["irbpnr_tarifa_advaloren_" + iRow] || "on" == ajax_error_count["irbpnr_estado_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_irbpnr_codigo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_irbpnr_descripcion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_irbpnr_tarifa_especifica_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_irbpnr_tarifa_advaloren_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_irbpnr_estado_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["irbpnr_codigo_" + iRow] && "off" == ajax_error_count["irbpnr_descripcion_" + iRow] && "off" == ajax_error_count["irbpnr_tarifa_especifica_" + iRow] && "off" == ajax_error_count["irbpnr_tarifa_advaloren_" + iRow] && "off" == ajax_error_count["irbpnr_estado_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["irbpnr_codigo_" + iRow] = "off";
        ajax_error_count["irbpnr_descripcion_" + iRow] = "off";
        ajax_error_count["irbpnr_tarifa_especifica_" + iRow] = "off";
        ajax_error_count["irbpnr_tarifa_advaloren_" + iRow] = "off";
        ajax_error_count["irbpnr_estado_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_irbpnr_codigo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_irbpnr_descripcion_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_irbpnr_tarifa_especifica_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_irbpnr_tarifa_advaloren_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_irbpnr_estado_" + iRow).removeClass("scFormErrorLine");
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("irbpnr_tarifa_especifica_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("irbpnr_tarifa_advaloren_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
