<?php
@session_start() ;
$_SESSION['scriptcase']['grid_notas_credito_na']['sc_process_barr'] = true;
require_once('../grid_notas_credito_na/index.php');
unset($_SESSION['scriptcase']['grid_notas_credito_na']['sc_process_barr']);
$ExportCtrl = new grid_notas_credito_na_export_control;
$ExportCtrl->Export_barr();

class grid_notas_credito_na_export_control
{
