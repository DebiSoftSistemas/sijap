<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_v_del_inventario']['glo_nm_path_imag_temp'] . "/sc_apl_default_SIJAP.txt"))
       {
?>
...
function Sel_processa_out($sel_groupby)
{
   ...
   elseif ($sel_groupby != $groupby_atual || $Change_free_groupby)
   {
       ...
       unset($_SESSION['sc_session'][$sc_init]['grid_v_del_inventario']['pivot_tabular']);
           ...
           $tab_arr_groubby_cmp['bo_establecimiento'] = array('cmp' => "bo_establecimiento", 'ind' => 0, 'format' => "");
           $tab_arr_groubby_cmp['bodega'] = array('cmp' => "bodega", 'ind' => 1, 'format' => "");
           $tab_arr_groubby_cmp['pro_descripcion'] = array('cmp' => "pro_descripcion", 'ind' => 2, 'format' => "");
           $tab_arr_groubby_sql[0] = array('cmp' => "bo_establecimiento", 'ord' => 'asc');
           $tab_arr_groubby_sql[1] = array('cmp' => "bodega", 'ord' => 'asc');
           $tab_arr_groubby_sql[2] = array('cmp' => "pro_descripcion", 'ord' => 'asc');
...
function Sel_processa_form()
{
   ...
   $arr_campos_free['bo_establecimiento'] = "" . $this->Nm_lang['lang_establecimiento'] . "";
   $arr_campos_free['bodega'] = "" . $this->Nm_lang['lang_bodega'] . "";
...
<?php
    $prep_labels = array();
    $prep_labels[] = "" . $this->Nm_lang['lang_establecimiento'] . "";
