...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "pro_cantidad_inventario";$Nm_numeric[] = "cantidad";$Nm_numeric[] = "costo_promedio";$Nm_numeric[] = "total";$Nm_numeric[] = "kar_bodega";$Nm_numeric[] = "bo_establecimiento";$Nm_numeric[] = "kar_unidad";
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_pro_codigo#NMF#' + search_get_select('SC_pro_codigo') + '@NMF@';
...
<?php
   ...
   function monta_form()
   {
      ...
      { 
          ...
          $kar_bodega = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['campos_busca']['kar_bodega']; 
          $kar_bodega_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['campos_busca']['kar_bodega_cond']; 
          ...
          $pro_codigo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['campos_busca']['pro_codigo']; 
          $pro_codigo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['campos_busca']['pro_codigo_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['campos_busca']['NM_operador']; 
      } 
      if (!isset($kar_bodega_cond) || empty($kar_bodega_cond))
      {
         $kar_bodega_cond = "eq";
      }
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_kar_bodega_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['kar_bodega'])) ? $this->New_label['kar_bodega'] : "" . $this->Ini->Nm_lang['lang_bodega'] . ""; ?></TD>
...
?>
   <span id="idAjaxSelect_kar_bodega">
      <SELECT class="scFilterObjectOdd" id="SC_kar_bodega" name="kar_bodega"  size="1">
...
?>
      ...
      <TD id='SC_cat_descripcion_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['cat_descripcion'])) ? $this->New_label['cat_descripcion'] : "" . $this->Ini->Nm_lang['lang_categoria'] . ""; ?></TD>
...
?>
   <span id="idAjaxSelect_cat_descripcion">
      <SELECT class="scFilterObjectEven" id="SC_cat_descripcion" name="cat_descripcion"  size="1">
       <OPTION value=""><?php echo $this->Ini->Nm_lang['lang_seleccione'] ?></OPTION>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
...
?>
   <span id="idAjaxSelect_pro_codigo">
      <SELECT class="scFilterObjectOdd" id="SC_pro_codigo" name="pro_codigo"  size="1">
       <OPTION value=""><?php echo $this->Ini->Nm_lang['lang_seleccione'] ?></OPTION>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $pro_codigo)
            {
                    $pro_codigo_sel = ($nm_opc_cod === $pro_codigo) ? "selected" : "";
            }
            else
            {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.kar_bodega_cond.value = 'eq';
 ...
 function Sc_carga_select2(Field)
 {
    ...
    if (Field == 'all' || Field == 'pro_codigo') {
       Sc_carga_select2_pro_codigo();
    }
 }
 ...
 function Sc_carga_select2_pro_codigo()
 {
  $("#SC_pro_codigo").select2(
    {
      language: {
        noResults: function() {
          return "<?php echo $this->Ini->Nm_lang['lang_autocomp_notfound'] ?>";
...
<?php
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_pro_codigo'] = 'select';
   ...
   {
      global $kar_bodega_cond, $kar_bodega,
             $cat_descripcion_cond, $cat_descripcion,
             $pro_codigo_cond, $pro_codigo, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['psq_check_ret']['kar_bodega'])) {
      ...
      if ($tmp_pos === false) {
          ...
          $L_lookup = substr($pro_codigo, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['psq_check_ret']['pro_codigo'])) {
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['campos_busca']['kar_bodega'] = $kar_bodega; 
      if (is_array($kar_bodega) && !empty($kar_bodega))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['Grid_search'][$I_Grid]['val'][0] = $kar_bodega;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['Grid_search'][$I_Grid]['val'][0][0] = $kar_bodega;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['campos_busca']['kar_bodega_cond'] = $kar_bodega_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['Grid_search'][$I_Grid]['cmp'] = "kar_bodega"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['Grid_search'][$I_Grid]['opc'] = $kar_bodega_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['grid_pesq']['kar_bodega'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['campos_busca']['pro_codigo'] = $pro_codigo; 
      if (is_array($pro_codigo) && !empty($pro_codigo))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['Grid_search'][$I_Grid]['val'][0] = $pro_codigo;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['Grid_search'][$I_Grid]['val'][0][0] = $pro_codigo;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['campos_busca']['pro_codigo_cond'] = $pro_codigo_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['Grid_search'][$I_Grid]['cmp'] = "pro_codigo"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['Grid_search'][$I_Grid]['opc'] = $pro_codigo_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['grid_pesq']['pro_codigo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      ...
      $this->cmp_formatado['pro_codigo'] = $Conteudo;
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "kar_bodega" : return ('class="scFilterObjectOdd"'); break;
         case "cat_descripcion" : return ('class="scFilterObjectEven"'); break;
         case "pro_codigo" : return ('class="scFilterObjectOdd"'); break;
         default       : return ("");
      }
   }
