...
SCEOT;
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['tot_geral'][3];
   ...
   function completeMatrix()
   {
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['bo_establecimiento']['alin'] = "''";
       $Arr_parms['bo_establecimiento']['link'] = "S";
       $Arr_parms['bodega']['alin'] = "''";
       $Arr_parms['bodega']['link'] = "S";
       $Arr_parms['pro_descripcion']['alin'] = "''";
       $Arr_parms['pro_descripcion']['link'] = "S";
       $Arr_parms['bo_establecimiento']['fill'] = "true";
       $Arr_parms['bo_establecimiento']['order'] = "label";
       $Arr_parms['bo_establecimiento']['order_start'] = 'asc';
       $Arr_parms['bo_establecimiento']['order_invert'] = 'false';
       $Arr_parms['bo_establecimiento']['order_enabled'] = 'true';
       $Arr_parms['bo_establecimiento']['order_datatype'] = 'int4';
       $Arr_parms['bo_establecimiento']['rating_function'] = '';
       $Arr_parms['bodega']['fill'] = "true";
       $Arr_parms['bodega']['order'] = "label";
       $Arr_parms['bodega']['order_start'] = 'asc';
       $Arr_parms['bodega']['order_invert'] = 'false';
       $Arr_parms['bodega']['order_enabled'] = 'true';
       $Arr_parms['bodega']['order_datatype'] = 'varchar';
       $Arr_parms['bodega']['rating_function'] = '';
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['bo_establecimiento'] = array(0 => 'bo_establecimiento', 1 => '');
       $prep_links_fl['bodega'] = array(0 => 'bodega', 1 => '@aspass@');
...
{ 
   ...
   //---- 
   function adiciona_registro($sum_pro_cantidad_inventario, $sum_total, $quebra_bo_establecimiento, $quebra_bodega, $quebra_pro_descripcion, $quebra_bo_establecimiento_orig, $quebra_bodega_orig, $quebra_pro_descripcion_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_inventario']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          ...
          {
              $this->' . $arr_name . '[0] = 1;
              $this->' . $arr_name . '[1] = ' . $sum_pro_cantidad_inventario . ';
          ...
          {
              $this->' . $arr_name . '[0]++;
              $this->' . $arr_name . '[1] = bcadd($this->' . $arr_name . '[1], ' . $sum_pro_cantidad_inventario . ', 10);
              $this->' . $arr_name . '[2] = bcadd($this->' . $arr_name . '[2], ' . $sum_total . ', 10);
          }
          ');
      }
   }
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->pro_cantidad_inventario = $rs_res->fields[5] ;  
            $this->costo_promedio = $rs_res->fields[6] ;  
            $this->total = $rs_res->fields[7] ;  
            $this->kar_empresa = $rs_res->fields[8] ;  
            $this->bo_establecimiento = $rs_res->fields[9] ;  
            $this->bodega = $rs_res->fields[10] ;  
            $this->pro_codigo_aux = $rs_res->fields[11] ;  
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->pro_cantidad_inventario, $this->total, $this->bo_establecimiento, $this->bodega, $this->pro_descripcion, $this->bo_establecimiento_orig,  $this->bodega_orig,  $this->pro_descripcion_orig);
            }
   }
//
