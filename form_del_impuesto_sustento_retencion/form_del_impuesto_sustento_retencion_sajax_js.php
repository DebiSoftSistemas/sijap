  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_impuesto_sustento_retencion" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_impuesto_sustento_retencion_form();
	}
...
?>
  ...
  // ---------- Validate isr_id_
  function do_ajax_form_del_impuesto_sustento_retencion_validate_isr_id_(iNumLinha)
  {
    var nomeCampo_isr_id_ = "isr_id_" + iNumLinha;
    var var_isr_id_ = scAjaxGetFieldHidden(nomeCampo_isr_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_impuesto_sustento_retencion_validate_isr_id_(var_isr_id_, iNumLinha, var_script_case_init, do_ajax_form_del_impuesto_sustento_retencion_validate_isr_id__cb);
  } // do_ajax_form_del_impuesto_sustento_retencion_validate_isr_id_

  function do_ajax_form_del_impuesto_sustento_retencion_validate_isr_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "isr_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "isr_id_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "isr_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "isr_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_impuesto_sustento_retencion_validate_isr_id__cb

  // ---------- Validate isr_doc_sustento_
  function do_ajax_form_del_impuesto_sustento_retencion_validate_isr_doc_sustento_(iNumLinha)
  {
    var nomeCampo_isr_doc_sustento_ = "isr_doc_sustento_" + iNumLinha;
    var var_isr_doc_sustento_ = scAjaxGetFieldText(nomeCampo_isr_doc_sustento_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_impuesto_sustento_retencion_validate_isr_doc_sustento_(var_isr_doc_sustento_, iNumLinha, var_script_case_init, do_ajax_form_del_impuesto_sustento_retencion_validate_isr_doc_sustento__cb);
  } // do_ajax_form_del_impuesto_sustento_retencion_validate_isr_doc_sustento_

  function do_ajax_form_del_impuesto_sustento_retencion_validate_isr_doc_sustento__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "isr_doc_sustento_" + iLineNumber;
    }
    else
    {
      sFieldValid = "isr_doc_sustento_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "isr_doc_sustento_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "isr_doc_sustento_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_impuesto_sustento_retencion_validate_isr_doc_sustento__cb

  // ---------- Validate isr_cod_impuesto_
  function do_ajax_form_del_impuesto_sustento_retencion_validate_isr_cod_impuesto_(iNumLinha)
  {
    var nomeCampo_isr_cod_impuesto_ = "isr_cod_impuesto_" + iNumLinha;
    var var_isr_cod_impuesto_ = scAjaxGetFieldSelect(nomeCampo_isr_cod_impuesto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_impuesto_sustento_retencion_validate_isr_cod_impuesto_(var_isr_cod_impuesto_, iNumLinha, var_script_case_init, do_ajax_form_del_impuesto_sustento_retencion_validate_isr_cod_impuesto__cb);
  } // do_ajax_form_del_impuesto_sustento_retencion_validate_isr_cod_impuesto_

  function do_ajax_form_del_impuesto_sustento_retencion_validate_isr_cod_impuesto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "isr_cod_impuesto_" + iLineNumber;
    }
    else
    {
      sFieldValid = "isr_cod_impuesto_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "isr_cod_impuesto_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "isr_cod_impuesto_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_impuesto_sustento_retencion_validate_isr_cod_impuesto__cb

  // ---------- Validate isr_cod_porcentaje_
  function do_ajax_form_del_impuesto_sustento_retencion_validate_isr_cod_porcentaje_(iNumLinha)
  {
    var nomeCampo_isr_cod_porcentaje_ = "isr_cod_porcentaje_" + iNumLinha;
    var var_isr_cod_porcentaje_ = scAjaxGetFieldSelect(nomeCampo_isr_cod_porcentaje_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_impuesto_sustento_retencion_validate_isr_cod_porcentaje_(var_isr_cod_porcentaje_, iNumLinha, var_script_case_init, do_ajax_form_del_impuesto_sustento_retencion_validate_isr_cod_porcentaje__cb);
  } // do_ajax_form_del_impuesto_sustento_retencion_validate_isr_cod_porcentaje_

  function do_ajax_form_del_impuesto_sustento_retencion_validate_isr_cod_porcentaje__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "isr_cod_porcentaje_" + iLineNumber;
    }
    else
    {
      sFieldValid = "isr_cod_porcentaje_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "isr_cod_porcentaje_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "isr_cod_porcentaje_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_impuesto_sustento_retencion_validate_isr_cod_porcentaje__cb

  // ---------- Validate isr_base_imponible_
  function do_ajax_form_del_impuesto_sustento_retencion_validate_isr_base_imponible_(iNumLinha)
  {
    var nomeCampo_isr_base_imponible_ = "isr_base_imponible_" + iNumLinha;
    var var_isr_base_imponible_ = scAjaxGetFieldText(nomeCampo_isr_base_imponible_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_impuesto_sustento_retencion_validate_isr_base_imponible_(var_isr_base_imponible_, iNumLinha, var_script_case_init, do_ajax_form_del_impuesto_sustento_retencion_validate_isr_base_imponible__cb);
  } // do_ajax_form_del_impuesto_sustento_retencion_validate_isr_base_imponible_

  function do_ajax_form_del_impuesto_sustento_retencion_validate_isr_base_imponible__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "isr_base_imponible_" + iLineNumber;
    }
    else
    {
      sFieldValid = "isr_base_imponible_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "isr_base_imponible_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "isr_base_imponible_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_impuesto_sustento_retencion_validate_isr_base_imponible__cb

  // ---------- Validate isr_tarifa_
  function do_ajax_form_del_impuesto_sustento_retencion_validate_isr_tarifa_(iNumLinha)
  {
    var nomeCampo_isr_tarifa_ = "isr_tarifa_" + iNumLinha;
    var var_isr_tarifa_ = scAjaxGetFieldText(nomeCampo_isr_tarifa_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_impuesto_sustento_retencion_validate_isr_tarifa_(var_isr_tarifa_, iNumLinha, var_script_case_init, do_ajax_form_del_impuesto_sustento_retencion_validate_isr_tarifa__cb);
  } // do_ajax_form_del_impuesto_sustento_retencion_validate_isr_tarifa_

  function do_ajax_form_del_impuesto_sustento_retencion_validate_isr_tarifa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "isr_tarifa_" + iLineNumber;
    }
    else
    {
      sFieldValid = "isr_tarifa_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "isr_tarifa_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "isr_tarifa_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_impuesto_sustento_retencion_validate_isr_tarifa__cb

  // ---------- Validate isr_valor_impuesto_
  function do_ajax_form_del_impuesto_sustento_retencion_validate_isr_valor_impuesto_(iNumLinha)
  {
    var nomeCampo_isr_valor_impuesto_ = "isr_valor_impuesto_" + iNumLinha;
    var var_isr_valor_impuesto_ = scAjaxGetFieldText(nomeCampo_isr_valor_impuesto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_impuesto_sustento_retencion_validate_isr_valor_impuesto_(var_isr_valor_impuesto_, iNumLinha, var_script_case_init, do_ajax_form_del_impuesto_sustento_retencion_validate_isr_valor_impuesto__cb);
  } // do_ajax_form_del_impuesto_sustento_retencion_validate_isr_valor_impuesto_

  function do_ajax_form_del_impuesto_sustento_retencion_validate_isr_valor_impuesto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "isr_valor_impuesto_" + iLineNumber;
    }
    else
    {
      sFieldValid = "isr_valor_impuesto_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "isr_valor_impuesto_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "isr_valor_impuesto_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_impuesto_sustento_retencion_validate_isr_valor_impuesto__cb

  // ---------- Refresh isr_cod_impuesto_
  function do_ajax_form_del_impuesto_sustento_retencion_refresh_isr_cod_impuesto_(iSeqForm)
  {
    var var_isr_cod_impuesto_ = scAjaxGetFieldSelect("isr_cod_impuesto_" + iSeqForm);
    var var_nmgp_refresh_row = iSeqForm;
    var var_nmgp_refresh_fields = "isr_cod_porcentaje_";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_impuesto_sustento_retencion_refresh_isr_cod_impuesto_(var_isr_cod_impuesto_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_del_impuesto_sustento_retencion_refresh_isr_cod_impuesto__cb);
  } // do_ajax_form_del_impuesto_sustento_retencion_refresh_isr_cod_impuesto_

  function do_ajax_form_del_impuesto_sustento_retencion_refresh_isr_cod_impuesto__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_impuesto_sustento_retencion_refresh_isr_cod_impuesto__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_del_impuesto_sustento_retencion_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_del_impuesto_sustento_retencion_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_impuesto_sustento_retencion_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_del_impuesto_sustento_retencion_add_new_line_cb);
  } // do_ajax_form_del_impuesto_sustento_retencion_add_new_line

  function do_ajax_form_del_impuesto_sustento_retencion_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_del_impuesto_sustento_retencion_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_del_impuesto_sustento_retencion_backup_line(iNumLinha)
  {
    var var_isr_id_ = scAjaxGetFieldHidden("isr_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_impuesto_sustento_retencion_backup_line(var_isr_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_del_impuesto_sustento_retencion_backup_line_cb);
  } // do_ajax_form_del_impuesto_sustento_retencion_backup_line

  function do_ajax_form_del_impuesto_sustento_retencion_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_del_impuesto_sustento_retencion_backup_line_cb

  function do_ajax_form_del_impuesto_sustento_retencion_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_del_impuesto_sustento_retencion_cancel_insert

  function do_ajax_form_del_impuesto_sustento_retencion_cancel_update(iSeqVert)
  {
    do_ajax_form_del_impuesto_sustento_retencion_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_del_impuesto_sustento_retencion_cancel_update

  function do_ajax_form_del_impuesto_sustento_retencion_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_del_impuesto_sustento_retencion_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_del_impuesto_sustento_retencion_table_refresh()
  {
    var var_isr_id_ = document.F2.isr_id_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_impuesto_sustento_retencion_table_refresh(var_isr_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_impuesto_sustento_retencion_table_refresh_cb);
  } //  do_ajax_form_del_impuesto_sustento_retencion_table_refresh

  function do_ajax_form_del_impuesto_sustento_retencion_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.isr_id_.value = scAjaxGetKeyValue("isr_id_");
    ...
    scAjaxAlert(do_ajax_form_del_impuesto_sustento_retencion_table_refresh_cb_after_alert);
  } // do_ajax_form_del_impuesto_sustento_retencion_table_refresh_cb
  function do_ajax_form_del_impuesto_sustento_retencion_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_del_impuesto_sustento_retencion_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_del_impuesto_sustento_retencion_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_del_impuesto_sustento_retencion_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_isr_id_ = scAjaxGetFieldHidden("isr_id_" + iNumLinha);
    var var_isr_doc_sustento_ = scAjaxGetFieldText("isr_doc_sustento_" + iNumLinha);
    var var_isr_cod_impuesto_ = scAjaxGetFieldSelect("isr_cod_impuesto_" + iNumLinha);
    var var_isr_cod_porcentaje_ = scAjaxGetFieldSelect("isr_cod_porcentaje_" + iNumLinha);
    var var_isr_base_imponible_ = scAjaxGetFieldText("isr_base_imponible_" + iNumLinha);
    var var_isr_tarifa_ = scAjaxGetFieldText("isr_tarifa_" + iNumLinha);
    var var_isr_valor_impuesto_ = scAjaxGetFieldText("isr_valor_impuesto_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_del_impuesto_sustento_retencion_submit_form(var_isr_id_, var_isr_doc_sustento_, var_isr_cod_impuesto_, var_isr_cod_porcentaje_, var_isr_base_imponible_, var_isr_tarifa_, var_isr_valor_impuesto_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_impuesto_sustento_retencion_submit_form_cb);
  } // do_ajax_form_del_impuesto_sustento_retencion_submit_form

  function do_ajax_form_del_impuesto_sustento_retencion_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("isr_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("isr_doc_sustento_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("isr_cod_impuesto_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("isr_cod_porcentaje_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("isr_base_imponible_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("isr_tarifa_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("isr_valor_impuesto_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_impuesto_sustento_retencion_submit_form_cb_after_alert);
  } // do_ajax_form_del_impuesto_sustento_retencion_submit_form_cb
  function do_ajax_form_del_impuesto_sustento_retencion_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_impuesto_sustento_retencion_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_impuesto_sustento_retencion_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_del_impuesto_sustento_retencion_navigate_form, function() {});
    } else {
      perform_ajax_form_del_impuesto_sustento_retencion_navigate_form();
    }
  }

  function perform_ajax_form_del_impuesto_sustento_retencion_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_del_impuesto_sustento_retencion_cancel_insert(sc_form_del_impuesto_sustento_retencion_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("isr_id_" + iNavForm);
      scAjaxHideErrorDisplay("isr_doc_sustento_" + iNavForm);
      scAjaxHideErrorDisplay("isr_cod_impuesto_" + iNavForm);
      scAjaxHideErrorDisplay("isr_cod_porcentaje_" + iNavForm);
      scAjaxHideErrorDisplay("isr_base_imponible_" + iNavForm);
      scAjaxHideErrorDisplay("isr_tarifa_" + iNavForm);
      scAjaxHideErrorDisplay("isr_valor_impuesto_" + iNavForm);
    }
    var var_isr_id_ = document.F2.isr_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_impuesto_sustento_retencion_navigate_form(var_isr_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_impuesto_sustento_retencion_navigate_form_cb);
  } // do_ajax_form_del_impuesto_sustento_retencion_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_impuesto_sustento_retencion']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_impuesto_sustento_retencion_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.isr_id_.value = scAjaxGetKeyValue("isr_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_impuesto_sustento_retencion_navigate_form_cb_after_alert);
  } // do_ajax_form_del_impuesto_sustento_retencion_navigate_form_cb
  function do_ajax_form_del_impuesto_sustento_retencion_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_del_impuesto_sustento_retencion_navigate_form_cb_after_alert

    function sc_form_del_impuesto_sustento_retencion_get_last_line_number()
    {
    ...
    } //sc_form_del_impuesto_sustento_retencion_get_last_line_number

  function sc_hide_form_del_impuesto_sustento_retencion_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "isr_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "isr_doc_sustento_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "isr_cod_impuesto_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "isr_cod_porcentaje_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "isr_base_imponible_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "isr_tarifa_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "isr_valor_impuesto_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["isr_id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["isr_doc_sustento_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_sustento_tributario'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["isr_cod_impuesto_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_impuesto'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["isr_cod_porcentaje_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_codigo_porcentaje'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["isr_base_imponible_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_base_imponible'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["isr_tarifa_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tarifa'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["isr_valor_impuesto_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_valor_impuesto'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["isr_id_"][iNumLinha] = "isr_id_" + iNumLinha;
    ajax_field_mult["isr_doc_sustento_"][iNumLinha] = "isr_doc_sustento_" + iNumLinha;
    ajax_field_mult["isr_cod_impuesto_"][iNumLinha] = "isr_cod_impuesto_" + iNumLinha;
    ajax_field_mult["isr_cod_porcentaje_"][iNumLinha] = "isr_cod_porcentaje_" + iNumLinha;
    ajax_field_mult["isr_base_imponible_"][iNumLinha] = "isr_base_imponible_" + iNumLinha;
    ajax_field_mult["isr_tarifa_"][iNumLinha] = "isr_tarifa_" + iNumLinha;
    ajax_field_mult["isr_valor_impuesto_"][iNumLinha] = "isr_valor_impuesto_" + iNumLinha;
    ajax_field_id["isr_cod_impuesto_" + iNumLinha] = new Array("hidden_field_label_isr_cod_impuesto_", "hidden_field_data_isr_cod_impuesto_" + iNumLinha);
    ajax_field_id["isr_cod_porcentaje_" + iNumLinha] = new Array("hidden_field_label_isr_cod_porcentaje_", "hidden_field_data_isr_cod_porcentaje_" + iNumLinha);
    ajax_field_id["isr_base_imponible_" + iNumLinha] = new Array("hidden_field_label_isr_base_imponible_", "hidden_field_data_isr_base_imponible_" + iNumLinha);
    ajax_field_id["isr_valor_impuesto_" + iNumLinha] = new Array("hidden_field_label_isr_valor_impuesto_", "hidden_field_data_isr_valor_impuesto_" + iNumLinha);
    ajax_error_count["isr_id_" + iNumLinha] = "off";
    ajax_error_count["isr_doc_sustento_" + iNumLinha] = "off";
    ajax_error_count["isr_cod_impuesto_" + iNumLinha] = "off";
    ajax_error_count["isr_cod_porcentaje_" + iNumLinha] = "off";
    ajax_error_count["isr_base_imponible_" + iNumLinha] = "off";
    ajax_error_count["isr_tarifa_" + iNumLinha] = "off";
    ajax_error_count["isr_valor_impuesto_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["isr_id_" + iNumLinha] = "on";
    ajax_read_only["isr_doc_sustento_" + iNumLinha] = "off";
    ajax_read_only["isr_cod_impuesto_" + iNumLinha] = "off";
    ajax_read_only["isr_cod_porcentaje_" + iNumLinha] = "off";
    ajax_read_only["isr_base_imponible_" + iNumLinha] = "off";
    ajax_read_only["isr_tarifa_" + iNumLinha] = "off";
    ajax_read_only["isr_valor_impuesto_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["isr_id_" + iNumLinha] = "on";
    ajax_read_only["isr_doc_sustento_" + iNumLinha] = "on";
    ajax_read_only["isr_cod_impuesto_" + iNumLinha] = "on";
    ajax_read_only["isr_cod_porcentaje_" + iNumLinha] = "on";
    ajax_read_only["isr_base_imponible_" + iNumLinha] = "on";
    ajax_read_only["isr_tarifa_" + iNumLinha] = "on";
    ajax_read_only["isr_valor_impuesto_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["isr_id_" + iNumLinha] = null;
    ajax_error_list["isr_doc_sustento_" + iNumLinha] = null;
    ajax_error_list["isr_cod_impuesto_" + iNumLinha] = null;
    ajax_error_list["isr_cod_porcentaje_" + iNumLinha] = null;
    ajax_error_list["isr_base_imponible_" + iNumLinha] = null;
    ajax_error_list["isr_tarifa_" + iNumLinha] = null;
    ajax_error_list["isr_valor_impuesto_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "isr_id_": new Array(),
    "isr_doc_sustento_": new Array(),
    "isr_cod_impuesto_": new Array(),
    "isr_cod_porcentaje_": new Array(),
    "isr_base_imponible_": new Array(),
    "isr_tarifa_": new Array(),
    "isr_valor_impuesto_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["isr_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["isr_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["isr_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["isr_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["isr_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["isr_doc_sustento_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["isr_doc_sustento_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["isr_doc_sustento_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["isr_doc_sustento_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["isr_doc_sustento_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["isr_cod_impuesto_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["isr_cod_impuesto_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["isr_cod_impuesto_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["isr_cod_impuesto_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["isr_cod_impuesto_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["isr_cod_porcentaje_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["isr_cod_porcentaje_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["isr_cod_porcentaje_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["isr_cod_porcentaje_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["isr_cod_porcentaje_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["isr_base_imponible_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["isr_base_imponible_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["isr_base_imponible_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["isr_base_imponible_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["isr_base_imponible_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["isr_tarifa_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["isr_tarifa_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["isr_tarifa_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["isr_tarifa_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["isr_tarifa_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["isr_valor_impuesto_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["isr_valor_impuesto_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["isr_valor_impuesto_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["isr_valor_impuesto_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["isr_valor_impuesto_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['isr_id_'])) ? $this->nmgp_cmp_readonly['isr_id_'] : 'on';
?>
    scAjaxFieldRead("isr_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['isr_doc_sustento_'])) ? $this->nmgp_cmp_readonly['isr_doc_sustento_'] : 'off';
?>
    scAjaxFieldRead("isr_doc_sustento_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['isr_cod_impuesto_'])) ? $this->nmgp_cmp_readonly['isr_cod_impuesto_'] : 'off';
?>
    scAjaxFieldRead("isr_cod_impuesto_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['isr_cod_porcentaje_'])) ? $this->nmgp_cmp_readonly['isr_cod_porcentaje_'] : 'off';
?>
    scAjaxFieldRead("isr_cod_porcentaje_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['isr_base_imponible_'])) ? $this->nmgp_cmp_readonly['isr_base_imponible_'] : 'off';
?>
    scAjaxFieldRead("isr_base_imponible_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['isr_tarifa_'])) ? $this->nmgp_cmp_readonly['isr_tarifa_'] : 'off';
?>
    scAjaxFieldRead("isr_tarifa_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['isr_valor_impuesto_'])) ? $this->nmgp_cmp_readonly['isr_valor_impuesto_'] : 'off';
?>
    scAjaxFieldRead("isr_valor_impuesto_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("isr_id_" + iSeq, "on");
    scAjaxFieldRead("isr_doc_sustento_" + iSeq, "on");
    scAjaxFieldRead("isr_cod_impuesto_" + iSeq, "on");
    scAjaxFieldRead("isr_cod_porcentaje_" + iSeq, "on");
    scAjaxFieldRead("isr_base_imponible_" + iSeq, "on");
    scAjaxFieldRead("isr_tarifa_" + iSeq, "on");
    scAjaxFieldRead("isr_valor_impuesto_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["isr_id_" + iRow] || "on" == ajax_error_count["isr_doc_sustento_" + iRow] || "on" == ajax_error_count["isr_cod_impuesto_" + iRow] || "on" == ajax_error_count["isr_cod_porcentaje_" + iRow] || "on" == ajax_error_count["isr_base_imponible_" + iRow] || "on" == ajax_error_count["isr_tarifa_" + iRow] || "on" == ajax_error_count["isr_valor_impuesto_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_isr_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_isr_doc_sustento_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_isr_cod_impuesto_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_isr_cod_porcentaje_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_isr_base_imponible_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_isr_tarifa_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_isr_valor_impuesto_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["isr_id_" + iRow] && "off" == ajax_error_count["isr_doc_sustento_" + iRow] && "off" == ajax_error_count["isr_cod_impuesto_" + iRow] && "off" == ajax_error_count["isr_cod_porcentaje_" + iRow] && "off" == ajax_error_count["isr_base_imponible_" + iRow] && "off" == ajax_error_count["isr_tarifa_" + iRow] && "off" == ajax_error_count["isr_valor_impuesto_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["isr_id_" + iRow] = "off";
        ajax_error_count["isr_doc_sustento_" + iRow] = "off";
        ajax_error_count["isr_cod_impuesto_" + iRow] = "off";
        ajax_error_count["isr_cod_porcentaje_" + iRow] = "off";
        ajax_error_count["isr_base_imponible_" + iRow] = "off";
        ajax_error_count["isr_tarifa_" + iRow] = "off";
        ajax_error_count["isr_valor_impuesto_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_isr_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_isr_doc_sustento_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_isr_cod_impuesto_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_isr_cod_porcentaje_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_isr_base_imponible_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_isr_tarifa_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_isr_valor_impuesto_" + iRow).removeClass("scFormErrorLine");
    }
  }
