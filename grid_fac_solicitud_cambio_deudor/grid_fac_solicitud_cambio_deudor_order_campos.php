...
<?php
   ...
   $Ord_Cmp = new grid_fac_solicitud_cambio_deudor_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_fac_solicitud_cambio_deudor_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_cambio_deudor']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_cambio_deudor']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['scd_fecha'] = "scd_fecha";
   $tab_labels["scd_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_cambio_deudor']['labels']["scd_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_cambio_deudor']['labels']["scd_fecha"] : "" . $this->Nm_lang['lang_fecha'] . "";
   $tab_ger_campos['scd_propietario_actual'] = "on";
   $tab_def_campos['scd_propietario_actual'] = "scd_propietario_actual";
   $tab_labels["scd_propietario_actual"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_cambio_deudor']['labels']["scd_propietario_actual"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_cambio_deudor']['labels']["scd_propietario_actual"] : "" . $this->Nm_lang['lang_propietario_actual'] . "";
   $tab_ger_campos['scd_nuevo_propietario'] = "on";
   $tab_def_campos['scd_nuevo_propietario'] = "scd_nuevo_propietario";
   $tab_labels["scd_nuevo_propietario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_cambio_deudor']['labels']["scd_nuevo_propietario"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_cambio_deudor']['labels']["scd_nuevo_propietario"] : "" . $this->Nm_lang['lang_lot_nuevo_propietario'] . "";
   $tab_ger_campos['scd_motivo_cambio'] = "on";
   $tab_def_campos['scd_motivo_cambio'] = "scd_motivo_cambio";
   $tab_labels["scd_motivo_cambio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_cambio_deudor']['labels']["scd_motivo_cambio"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_cambio_deudor']['labels']["scd_motivo_cambio"] : "" . $this->Nm_lang['lang_motivo_cambio'] . "";
   $tab_ger_campos['scd_usuario'] = "on";
   $tab_def_campos['scd_usuario'] = "scd_usuario";
   $tab_labels["scd_usuario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_cambio_deudor']['labels']["scd_usuario"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_cambio_deudor']['labels']["scd_usuario"] : "" . $this->Nm_lang['lang_usuario'] . "";
   $tab_ger_campos['scd_estado'] = "on";
   $tab_def_campos['scd_estado'] = "scd_estado";
   $tab_labels["scd_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_cambio_deudor']['labels']["scd_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_cambio_deudor']['labels']["scd_estado"] : "" . $this->Nm_lang['lang_estado'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_cambio_deudor']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_cambio_deudor']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_cambio_deudor']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_cambio_deudor']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_cambio_deudor']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_cambio_deudor']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_cambio_deudor']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_cambio_deudor']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_cambio_deudor']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_cambio_deudor']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_cambio_deudor']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_cambio_deudor']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_fac_solicitud_cambio_deudor_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_cambio_deudor']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_cambio_deudor']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_cambio_deudor']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_cambio_deudor']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_fac_solicitud_cambio_deudor']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
