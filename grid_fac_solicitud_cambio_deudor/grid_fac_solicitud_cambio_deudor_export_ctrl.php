<?php
@session_start() ;
$_SESSION['scriptcase']['grid_fac_solicitud_cambio_deudor']['sc_process_barr'] = true;
require_once('../grid_fac_solicitud_cambio_deudor/index.php');
unset($_SESSION['scriptcase']['grid_fac_solicitud_cambio_deudor']['sc_process_barr']);
$ExportCtrl = new grid_fac_solicitud_cambio_deudor_export_control;
$ExportCtrl->Export_barr();

class grid_fac_solicitud_cambio_deudor_export_control
{
