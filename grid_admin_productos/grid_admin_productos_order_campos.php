...
<?php
   ...
   $Ord_Cmp = new grid_admin_productos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_admin_productos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_admin_productos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_admin_productos']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["pro_codigo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_admin_productos']['labels']["pro_codigo"])) ? $_SESSION['sc_session'][$sc_init]['grid_admin_productos']['labels']["pro_codigo"] : "Pro Codigo";
   $tab_ger_campos['pro_codigo_aux'] = "on";
   $tab_def_campos['pro_codigo_aux'] = "pro_codigo_aux";
   $tab_labels["pro_codigo_aux"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_admin_productos']['labels']["pro_codigo_aux"])) ? $_SESSION['sc_session'][$sc_init]['grid_admin_productos']['labels']["pro_codigo_aux"] : "Pro Codigo Aux";
   $tab_ger_campos['pro_empresa'] = "on";
   $tab_def_campos['pro_empresa'] = "pro_empresa";
   $tab_labels["pro_empresa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_admin_productos']['labels']["pro_empresa"])) ? $_SESSION['sc_session'][$sc_init]['grid_admin_productos']['labels']["pro_empresa"] : "Pro Empresa";
   $tab_ger_campos['pro_descripcion'] = "on";
   $tab_def_campos['pro_descripcion'] = "pro_descripcion";
   $tab_labels["pro_descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_admin_productos']['labels']["pro_descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_admin_productos']['labels']["pro_descripcion"] : "Pro Descripcion";
   $tab_ger_campos['pro_iva'] = "on";
   $tab_def_campos['pro_iva'] = "pro_iva";
   $tab_labels["pro_iva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_admin_productos']['labels']["pro_iva"])) ? $_SESSION['sc_session'][$sc_init]['grid_admin_productos']['labels']["pro_iva"] : "Pro Iva";
   $tab_ger_campos['pro_por_iva'] = "on";
   $tab_def_campos['pro_por_iva'] = "pro_por_iva";
   $tab_labels["pro_por_iva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_admin_productos']['labels']["pro_por_iva"])) ? $_SESSION['sc_session'][$sc_init]['grid_admin_productos']['labels']["pro_por_iva"] : "Pro Por Iva";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_admin_productos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_admin_productos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_admin_productos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_admin_productos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_admin_productos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_admin_productos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_admin_productos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_admin_productos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_admin_productos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_admin_productos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_admin_productos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_admin_productos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_admin_productos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_admin_productos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_admin_productos']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_admin_productos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_admin_productos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_admin_productos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
