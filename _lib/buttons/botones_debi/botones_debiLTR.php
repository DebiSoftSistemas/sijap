<?php
  ...
  $this->arr_buttons['bgridsave']['style'] = 'ok';
  ...
  $this->arr_buttons['gantt_chart']['fontawesomeicon']  = 'fas fa-align-left';
  ...
  $this->arr_buttons['bcons_apply']['style'] = 'ok';
  ...
  $this->arr_buttons['bmultiselect']['fontawesomeicon']  = 'fas fa-list-ol';
  $this->arr_buttons['bmultiselect']['style'] = 'ok';
  ...
  $this->arr_buttons['balterar']['style'] = 'ok';
  ...
  $this->arr_buttons['balterarsel']['style'] = 'ok';
  ...
  $this->arr_buttons['bcsort']['fontawesomeicon']  = 'fas fa-sort';
  $this->arr_buttons['bcsort']['style'] = 'default';
  $this->arr_buttons['bcsort']['image'] = 'sys__NM__nm_botones_debi_bcsort.gif';
  ...
  $this->arr_buttons['bchart_bar']['image'] = 'sys__NM__nm_botones_debi_bchart_bar.gif';
  ...
  $this->arr_buttons['bchart_line']['image'] = 'sys__NM__nm_botones_debi_bchart_line.gif';
  ...
  $this->arr_buttons['bchart_area']['image'] = 'sys__NM__nm_botones_debi_bchart_area.gif';
  ...
  $this->arr_buttons['bchart_pizza']['image'] = 'sys__NM__nm_botones_debi_bchart_pizza.gif';
  ...
  $this->arr_buttons['bchart_combo']['fontawesomeicon']  = 'far fa-chart-bar';
  $this->arr_buttons['bchart_combo']['style'] = 'default';
  $this->arr_buttons['bchart_combo']['image'] = 'sys__NM__nm_botones_debi_bchart_combo.gif';
  ...
  $this->arr_buttons['bchart_stack']['fontawesomeicon']  = 'fas fa-align-center';
  $this->arr_buttons['bchart_stack']['style'] = 'default';
  $this->arr_buttons['bchart_stack']['image'] = 'sys__NM__nm_botones_debi_bchart_stack.gif';
  ...
  $this->arr_buttons['bsalvar']['style'] = 'ok';
  ...
  $this->arr_buttons['blink']['fontawesomeicon']  = 'fas fa-ellipsis-h';
  ...
  $this->arr_buttons['blanguage']['fontawesomeicon']  = 'fas fa-language';
  ...
  $this->arr_buttons['bfieldhelp']['display']          = 'only_fontawesomeicon';
  $this->arr_buttons['bfieldhelp']['display_position'] = 'text_right';
  $this->arr_buttons['bfieldhelp']['fontawesomeicon']  = 'far fa-question-circle';
  ...
  $this->arr_buttons['bgooglemaps']['style'] = 'google';
  ...
  $this->arr_buttons['bgridsavesession']['style'] = 'ok';
