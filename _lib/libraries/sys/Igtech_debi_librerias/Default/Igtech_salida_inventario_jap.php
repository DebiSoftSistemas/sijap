...
class MYPDF extends TCPDF {
	...
	function cuerpoContrato(){	
		...
		$this->SetFont('times', '', 8);
		$this->SetXY($x,$y);
		$this->MultiCell(90, $this->ancho, 'CLIENTE: '.$this->w_solicitante, 0, 'L', 0, 0, '', '', true);
		$this->SetXY($x+140,$y);
		$this->MultiCell(50, $this->ancho, 'CEDULA: '.$this->w_cedula_solicitante, 0, 'L', 0, 0, '', '', true);
		$y+=$this->ancho;
		$this->SetXY($x,$y);
       	$this->MultiCell(145, $this->ancho, 'DIRECCION: '.$this->w_direccion, 0, 'L', 0, 0, '', '', true);
		$y+=$this->ancho;
		$this->SetXY($x,$y);
		$this->MultiCell(50, $this->ancho, 'NRO. CONTRATO: '.$this->w_contrato, 0, 'L', 0, 0, '', '', true);
		$this->SetXY($x+70,$y);
		$this->MultiCell(50, $this->ancho, 'NRO. MEDIDOR: '.$this->w_nro_medidor, 0, 'L', 0, 0, '', '', true);
		$this->SetXY($x+140,$y);
		$this->MultiCell(50, $this->ancho, 'RUTA: '.$this->w_ruta, 0, 'L', 0, 0, '', '', true);	
		$y+=$this->ancho;
		$this->SetXY($x,$y);
	    $this->MultiCell(140, $this->ancho, "FECHA DE EGRESO: ".$this->w_fecha_egreso, 0, 'L', 0, 0, '', '', true);
		$y+=$this->ancho;
	...
	function Detalle_Egreso($x,$y){
			...
			$this->SetXY($x,$y);
	    	$this->MultiCell(15, $this->ancho, "COD.", 0, 'L', 0, 2, '' ,'', true);
			$this->SetXY($x+15,$y);
	    	$this->MultiCell(50, $this->ancho, "PRODUCTO", 0, 'L', 0, 2, '' ,'', true);
			$this->SetXY($x+65,$y);
	    	$this->MultiCell(20, $this->ancho, "UNIDAD", 0, 'L', 0, 2, '' ,'', true);
			$this->SetXY($x+85,$y);
	    	$this->MultiCell(20, $this->ancho, "CANT.", 0, 'R', 0, 2, '' ,'', true);
			$this->SetXY($x+105,$y);
	    	$this->MultiCell(25, $this->ancho, "PRECIO", 0, 'R', 0, 2, '' ,'', true);
			$this->SetXY($x+130,$y);
			$this->MultiCell(25, $this->ancho, "SUBTOTAL", 0, 'R', 0, 2, '' ,'', true);
			$this->SetXY($x+155,$y);
			$this->MultiCell(15, $this->ancho, "IVA", 0, 'R', 0, 2, '' ,'', true);
			$this->SetXY($x+170,$y);
	    	$this->MultiCell(20, $this->ancho, "TOTAL", 0, 'R', 0, 2, '' ,'', true);
			$y+=$this->ancho;
		foreach ($this->w_productos as $item) {
			...
			$this->SetXY($x+15,$y);
			$this->MultiCell(50, $this->ancho*$num_lineas, $item['producto'], 0, 'L', 0, 2, '' ,'', true);
			...
			$this->SetXY($x+130,$y);
			$this->MultiCell(25, $this->ancho*$num_lineas, number_format($item['subtotal'],2), 0, 'R', 0, 2, '' ,'', true);
			$this->SetXY($x+155,$y);
			$this->MultiCell(15, $this->ancho*$num_lineas, number_format($item['iva'],2), 0, 'R', 0, 2, '' ,'', true);
			$this->SetXY($x+170,$y);
	    	$this->MultiCell(20, $this->ancho*$num_lineas, number_format($item['total'],2), 0, 'R', 0, 2, '' ,'', true);
			$y+=$this->ancho*$num_lineas;
		...
		$this->SetFont('times', 'B', 8);
		$this->SetXY($x+105,$y);
		$this->MultiCell(25, $this->ancho, 'TOTALES', 0, 'R', 0, 2, '' ,'', true);
		$this->SetXY($x+130,$y);
		$this->MultiCell(25, $this->ancho, number_format($w_subtotal,2), 0, 'R', 0, 2, '' ,'', true);
		$this->SetXY($x+155,$y);
		$this->MultiCell(15, $this->ancho, number_format($w_iva,2), 0, 'R', 0, 2, '' ,'', true);
		$this->SetXY($x+170,$y);
		$this->MultiCell(20, $this->ancho, number_format($w_total,2), 0, 'R', 0, 2, '' ,'', true);
		$y+=15;
