...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_del_pedidos_entregados"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_del_pedidos_entregados"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_del_pedidos_entregados']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_del_pedidos_entregados']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_del_pedidos_entregados']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_del_pedidos_entregados']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_del_pedidos_entregados']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_del_pedidos_entregados</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_del_pedidos_entregados']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_del_pedidos_entregados']['embutida_filho'] as $ind => $sc_init)
          {
