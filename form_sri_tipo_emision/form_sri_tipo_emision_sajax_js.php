  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sri_tipo_emision" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sri_tipo_emision_form();
	}
...
?>
  ...
  // ---------- Validate te_id_
  function do_ajax_form_sri_tipo_emision_validate_te_id_(iNumLinha)
  {
    var nomeCampo_te_id_ = "te_id_" + iNumLinha;
    var var_te_id_ = scAjaxGetFieldHidden(nomeCampo_te_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tipo_emision_validate_te_id_(var_te_id_, iNumLinha, var_script_case_init, do_ajax_form_sri_tipo_emision_validate_te_id__cb);
  } // do_ajax_form_sri_tipo_emision_validate_te_id_

  function do_ajax_form_sri_tipo_emision_validate_te_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "te_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "te_id_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "te_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "te_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_tipo_emision_validate_te_id__cb

  // ---------- Validate te_codigo_
  function do_ajax_form_sri_tipo_emision_validate_te_codigo_(iNumLinha)
  {
    var nomeCampo_te_codigo_ = "te_codigo_" + iNumLinha;
    var var_te_codigo_ = scAjaxGetFieldText(nomeCampo_te_codigo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tipo_emision_validate_te_codigo_(var_te_codigo_, iNumLinha, var_script_case_init, do_ajax_form_sri_tipo_emision_validate_te_codigo__cb);
  } // do_ajax_form_sri_tipo_emision_validate_te_codigo_

  function do_ajax_form_sri_tipo_emision_validate_te_codigo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "te_codigo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "te_codigo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "te_codigo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "te_codigo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_tipo_emision_validate_te_codigo__cb

  // ---------- Validate te_tipo_emision_
  function do_ajax_form_sri_tipo_emision_validate_te_tipo_emision_(iNumLinha)
  {
    var nomeCampo_te_tipo_emision_ = "te_tipo_emision_" + iNumLinha;
    var var_te_tipo_emision_ = scAjaxGetFieldText(nomeCampo_te_tipo_emision_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tipo_emision_validate_te_tipo_emision_(var_te_tipo_emision_, iNumLinha, var_script_case_init, do_ajax_form_sri_tipo_emision_validate_te_tipo_emision__cb);
  } // do_ajax_form_sri_tipo_emision_validate_te_tipo_emision_

  function do_ajax_form_sri_tipo_emision_validate_te_tipo_emision__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "te_tipo_emision_" + iLineNumber;
    }
    else
    {
      sFieldValid = "te_tipo_emision_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "te_tipo_emision_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "te_tipo_emision_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_tipo_emision_validate_te_tipo_emision__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_sri_tipo_emision_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_sri_tipo_emision_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sri_tipo_emision_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_sri_tipo_emision_add_new_line_cb);
  } // do_ajax_form_sri_tipo_emision_add_new_line

  function do_ajax_form_sri_tipo_emision_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_sri_tipo_emision_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_sri_tipo_emision_backup_line(iNumLinha)
  {
    var var_te_id_ = scAjaxGetFieldHidden("te_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_tipo_emision_backup_line(var_te_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_sri_tipo_emision_backup_line_cb);
  } // do_ajax_form_sri_tipo_emision_backup_line

  function do_ajax_form_sri_tipo_emision_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_sri_tipo_emision_backup_line_cb

  function do_ajax_form_sri_tipo_emision_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_sri_tipo_emision_cancel_insert

  function do_ajax_form_sri_tipo_emision_cancel_update(iSeqVert)
  {
    do_ajax_form_sri_tipo_emision_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_sri_tipo_emision_cancel_update

  function do_ajax_form_sri_tipo_emision_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_sri_tipo_emision_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_sri_tipo_emision_table_refresh()
  {
    var var_te_id_ = document.F2.te_id_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_sri_tipo_emision_table_refresh(var_te_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sri_tipo_emision_table_refresh_cb);
  } //  do_ajax_form_sri_tipo_emision_table_refresh

  function do_ajax_form_sri_tipo_emision_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.te_id_.value = scAjaxGetKeyValue("te_id_");
    ...
    scAjaxAlert(do_ajax_form_sri_tipo_emision_table_refresh_cb_after_alert);
  } // do_ajax_form_sri_tipo_emision_table_refresh_cb
  function do_ajax_form_sri_tipo_emision_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_sri_tipo_emision_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_sri_tipo_emision_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_sri_tipo_emision_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_te_id_ = scAjaxGetFieldHidden("te_id_" + iNumLinha);
    var var_te_codigo_ = scAjaxGetFieldText("te_codigo_" + iNumLinha);
    var var_te_tipo_emision_ = scAjaxGetFieldText("te_tipo_emision_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_sri_tipo_emision_submit_form(var_te_id_, var_te_codigo_, var_te_tipo_emision_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sri_tipo_emision_submit_form_cb);
  } // do_ajax_form_sri_tipo_emision_submit_form

  function do_ajax_form_sri_tipo_emision_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("te_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("te_codigo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("te_tipo_emision_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sri_tipo_emision_submit_form_cb_after_alert);
  } // do_ajax_form_sri_tipo_emision_submit_form_cb
  function do_ajax_form_sri_tipo_emision_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sri_tipo_emision_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sri_tipo_emision_navigate_form()
  {
    perform_ajax_form_sri_tipo_emision_navigate_form();
  }

  function perform_ajax_form_sri_tipo_emision_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_sri_tipo_emision_cancel_insert(sc_form_sri_tipo_emision_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("te_id_" + iNavForm);
      scAjaxHideErrorDisplay("te_codigo_" + iNavForm);
      scAjaxHideErrorDisplay("te_tipo_emision_" + iNavForm);
    }
    var var_te_id_ = document.F2.te_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sri_tipo_emision_navigate_form(var_te_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sri_tipo_emision_navigate_form_cb);
  } // do_ajax_form_sri_tipo_emision_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sri_tipo_emision']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sri_tipo_emision_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.te_id_.value = scAjaxGetKeyValue("te_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sri_tipo_emision_navigate_form_cb_after_alert);
  } // do_ajax_form_sri_tipo_emision_navigate_form_cb
  function do_ajax_form_sri_tipo_emision_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_sri_tipo_emision_navigate_form_cb_after_alert

    function sc_form_sri_tipo_emision_get_last_line_number()
    {
    ...
    } //sc_form_sri_tipo_emision_get_last_line_number

  function sc_hide_form_sri_tipo_emision_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "te_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "te_codigo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "te_tipo_emision_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["te_id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["te_codigo_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_codigo'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["te_tipo_emision_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_descripcion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["te_id_"][iNumLinha] = "te_id_" + iNumLinha;
    ajax_field_mult["te_codigo_"][iNumLinha] = "te_codigo_" + iNumLinha;
    ajax_field_mult["te_tipo_emision_"][iNumLinha] = "te_tipo_emision_" + iNumLinha;
    ajax_field_id["te_codigo_" + iNumLinha] = new Array("hidden_field_label_te_codigo_", "hidden_field_data_te_codigo_" + iNumLinha);
    ajax_field_id["te_tipo_emision_" + iNumLinha] = new Array("hidden_field_label_te_tipo_emision_", "hidden_field_data_te_tipo_emision_" + iNumLinha);
    ajax_error_count["te_id_" + iNumLinha] = "off";
    ajax_error_count["te_codigo_" + iNumLinha] = "off";
    ajax_error_count["te_tipo_emision_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["te_id_" + iNumLinha] = "on";
    ajax_read_only["te_codigo_" + iNumLinha] = "off";
    ajax_read_only["te_tipo_emision_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["te_id_" + iNumLinha] = "on";
    ajax_read_only["te_codigo_" + iNumLinha] = "on";
    ajax_read_only["te_tipo_emision_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["te_id_" + iNumLinha] = null;
    ajax_error_list["te_codigo_" + iNumLinha] = null;
    ajax_error_list["te_tipo_emision_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "te_id_": new Array(),
    "te_codigo_": new Array(),
    "te_tipo_emision_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["te_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["te_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["te_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["te_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["te_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["te_codigo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["te_codigo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["te_codigo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["te_codigo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["te_codigo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["te_tipo_emision_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["te_tipo_emision_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["te_tipo_emision_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["te_tipo_emision_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["te_tipo_emision_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['te_id_'])) ? $this->nmgp_cmp_readonly['te_id_'] : 'on';
?>
    scAjaxFieldRead("te_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['te_codigo_'])) ? $this->nmgp_cmp_readonly['te_codigo_'] : 'off';
?>
    scAjaxFieldRead("te_codigo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['te_tipo_emision_'])) ? $this->nmgp_cmp_readonly['te_tipo_emision_'] : 'off';
?>
    scAjaxFieldRead("te_tipo_emision_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("te_id_" + iSeq, "on");
    scAjaxFieldRead("te_codigo_" + iSeq, "on");
    scAjaxFieldRead("te_tipo_emision_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["te_id_" + iRow] || "on" == ajax_error_count["te_codigo_" + iRow] || "on" == ajax_error_count["te_tipo_emision_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_te_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_te_codigo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_te_tipo_emision_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["te_id_" + iRow] && "off" == ajax_error_count["te_codigo_" + iRow] && "off" == ajax_error_count["te_tipo_emision_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["te_id_" + iRow] = "off";
        ajax_error_count["te_codigo_" + iRow] = "off";
        ajax_error_count["te_tipo_emision_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_te_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_te_codigo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_te_tipo_emision_" + iRow).removeClass("scFormErrorLine");
    }
  }
