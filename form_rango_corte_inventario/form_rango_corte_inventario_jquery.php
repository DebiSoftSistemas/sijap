...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_fecha_desde' + iSeqRow).bind('blur', function() { sc_form_rango_corte_inventario_fecha_desde_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_rango_corte_inventario_fecha_desde_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_rango_corte_inventario_fecha_desde_onfocus(this, iSeqRow) });
  $('#id_sc_field_fecha_hasta' + iSeqRow).bind('blur', function() { sc_form_rango_corte_inventario_fecha_hasta_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_rango_corte_inventario_fecha_hasta_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_rango_corte_inventario_fecha_hasta_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_rango_corte_inventario_fecha_desde_onblur(oThis, iSeqRow) {
  do_ajax_form_rango_corte_inventario_validate_fecha_desde();
  scCssBlur(oThis);
}

function sc_form_rango_corte_inventario_fecha_desde_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_rango_corte_inventario_fecha_desde_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_rango_corte_inventario_fecha_hasta_onblur(oThis, iSeqRow) {
  do_ajax_form_rango_corte_inventario_validate_fecha_hasta();
  scCssBlur(oThis);
}

function sc_form_rango_corte_inventario_fecha_hasta_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_rango_corte_inventario_fecha_hasta_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_rango_corte_inventario_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fecha_desde" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      setTimeout(function() { do_ajax_form_rango_corte_inventario_validate_fecha_desde(iSeqRow); }, 200);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  $("#id_sc_field_fecha_hasta" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      setTimeout(function() { do_ajax_form_rango_corte_inventario_validate_fecha_hasta(iSeqRow); }, 200);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_rango_corte_inventario')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
