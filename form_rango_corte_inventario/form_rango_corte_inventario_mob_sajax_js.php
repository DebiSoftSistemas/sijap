  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_rango_corte_inventario_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_rango_corte_inventario_mob_form();
	}
...
?>
  ...
  function do_ajax_form_rango_corte_inventario_mob_validate_fecha_desde()
  {
    ...
    setTimeout(function() {
      var var_fecha_desde = scAjaxGetFieldText(nomeCampo_fecha_desde);
      x_ajax_form_rango_corte_inventario_mob_validate_fecha_desde(var_fecha_desde, var_script_case_init, do_ajax_form_rango_corte_inventario_mob_validate_fecha_desde_cb);
    }, 200);
  } // do_ajax_form_rango_corte_inventario_mob_validate_fecha_desde

  function do_ajax_form_rango_corte_inventario_mob_validate_fecha_desde_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_rango_corte_inventario_mob_validate_fecha_desde_cb

  // ---------- Validate fecha_hasta
  function do_ajax_form_rango_corte_inventario_mob_validate_fecha_hasta()
  {
    ...
    setTimeout(function() {
      var var_fecha_hasta = scAjaxGetFieldText(nomeCampo_fecha_hasta);
      x_ajax_form_rango_corte_inventario_mob_validate_fecha_hasta(var_fecha_hasta, var_script_case_init, do_ajax_form_rango_corte_inventario_mob_validate_fecha_hasta_cb);
    }, 200);
  } // do_ajax_form_rango_corte_inventario_mob_validate_fecha_hasta

  function do_ajax_form_rango_corte_inventario_mob_validate_fecha_hasta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_rango_corte_inventario_mob_validate_fecha_hasta_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_rango_corte_inventario_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_rango_corte_inventario_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_rango_corte_inventario_mob_submit_form(var_fecha_desde, var_fecha_hasta, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_rango_corte_inventario_mob_submit_form_cb);
  } // do_ajax_form_rango_corte_inventario_mob_submit_form

  function do_ajax_form_rango_corte_inventario_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_rango_corte_inventario_mob_submit_form_cb_after_alert);
  } // do_ajax_form_rango_corte_inventario_mob_submit_form_cb
  function do_ajax_form_rango_corte_inventario_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_rango_corte_inventario_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_rango_corte_inventario_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_rango_corte_inventario_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_rango_corte_inventario_mob_navigate_form();
    }
  }

  function perform_ajax_form_rango_corte_inventario_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_form_rango_corte_inventario_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_rango_corte_inventario_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_rango_corte_inventario_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_rango_corte_inventario_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_rango_corte_inventario_mob_navigate_form_cb
  function do_ajax_form_rango_corte_inventario_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_rango_corte_inventario_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_rango_corte_inventario_mob_navigate_form_cb_after_alert

  function sc_hide_form_rango_corte_inventario_mob_form()
  {
  ...
  ajax_field_list[0] = "fecha_desde";
  ajax_field_list[1] = "fecha_hasta";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "fecha_desde": {"label": "<?php echo $this->Ini->Nm_lang['lang_fecha_desde'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "fecha_hasta": {"label": "<?php echo $this->Ini->Nm_lang['lang_fecha_hasta'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
