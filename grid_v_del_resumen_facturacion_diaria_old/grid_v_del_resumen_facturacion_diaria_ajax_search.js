...
Table_sv_fil[1] = "fac_tipo_comprobante";
...
function ajax_select_filter(parm)
{
    ...
    $.ajax({
     ...
     .done(function(json_sel_fil) {
        ...
        if ($("#SC_fac_fecha_cond") && search_get_sel_txt("SC_fac_fecha_cond").substring(0, 3) == "bi_") {
            formata_bi_fac_fecha(search_get_sel_txt("SC_fac_fecha_cond"), SC_fac_fecha_bi_opc, SC_fac_fecha_bi_dt);
        }
