  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_jap_rutas_medicion_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_jap_rutas_medicion_mob_form();
	}
...
?>
  ...
  // ---------- Validate rut_id
  function do_ajax_form_jap_rutas_medicion_mob_validate_rut_id()
  {
    var nomeCampo_rut_id = "rut_id";
    var var_rut_id = scAjaxGetFieldHidden(nomeCampo_rut_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_rutas_medicion_mob_validate_rut_id(var_rut_id, var_script_case_init, do_ajax_form_jap_rutas_medicion_mob_validate_rut_id_cb);
  } // do_ajax_form_jap_rutas_medicion_mob_validate_rut_id

  function do_ajax_form_jap_rutas_medicion_mob_validate_rut_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_rutas_medicion_mob_validate_rut_id_cb

  // ---------- Validate rut_nombre
  function do_ajax_form_jap_rutas_medicion_mob_validate_rut_nombre()
  {
    var nomeCampo_rut_nombre = "rut_nombre";
    var var_rut_nombre = scAjaxGetFieldHidden(nomeCampo_rut_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_rutas_medicion_mob_validate_rut_nombre(var_rut_nombre, var_script_case_init, do_ajax_form_jap_rutas_medicion_mob_validate_rut_nombre_cb);
  } // do_ajax_form_jap_rutas_medicion_mob_validate_rut_nombre

  function do_ajax_form_jap_rutas_medicion_mob_validate_rut_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "rut_nombre";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_rutas_medicion_mob_validate_rut_nombre_cb

  // ---------- Validate rut_estado
  function do_ajax_form_jap_rutas_medicion_mob_validate_rut_estado()
  {
    var nomeCampo_rut_estado = "rut_estado";
    var var_rut_estado = scAjaxGetFieldSelect(nomeCampo_rut_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_rutas_medicion_mob_validate_rut_estado(var_rut_estado, var_script_case_init, do_ajax_form_jap_rutas_medicion_mob_validate_rut_estado_cb);
  } // do_ajax_form_jap_rutas_medicion_mob_validate_rut_estado

  function do_ajax_form_jap_rutas_medicion_mob_validate_rut_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "rut_estado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_rutas_medicion_mob_validate_rut_estado_cb

  // ---------- Validate lista_contratos
  function do_ajax_form_jap_rutas_medicion_mob_validate_lista_contratos()
  {
    var nomeCampo_lista_contratos = "lista_contratos";
    var var_lista_contratos = scAjaxGetFieldText(nomeCampo_lista_contratos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_rutas_medicion_mob_validate_lista_contratos(var_lista_contratos, var_script_case_init, do_ajax_form_jap_rutas_medicion_mob_validate_lista_contratos_cb);
  } // do_ajax_form_jap_rutas_medicion_mob_validate_lista_contratos

  function do_ajax_form_jap_rutas_medicion_mob_validate_lista_contratos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "lista_contratos";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_rutas_medicion_mob_validate_lista_contratos_cb

  // ---------- Validate rut_empresa
  function do_ajax_form_jap_rutas_medicion_mob_validate_rut_empresa()
  {
    var nomeCampo_rut_empresa = "rut_empresa";
    var var_rut_empresa = scAjaxGetFieldText(nomeCampo_rut_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_rutas_medicion_mob_validate_rut_empresa(var_rut_empresa, var_script_case_init, do_ajax_form_jap_rutas_medicion_mob_validate_rut_empresa_cb);
  } // do_ajax_form_jap_rutas_medicion_mob_validate_rut_empresa

  function do_ajax_form_jap_rutas_medicion_mob_validate_rut_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "rut_empresa";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_rutas_medicion_mob_validate_rut_empresa_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_jap_rutas_medicion_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_jap_rutas_medicion_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_rut_id = scAjaxGetFieldHidden("rut_id");
    var var_rut_nombre = scAjaxGetFieldHidden("rut_nombre");
    var var_rut_estado = scAjaxGetFieldSelect("rut_estado");
    var var_rut_empresa = scAjaxGetFieldText("rut_empresa");
    ...
    scAjaxProcOn();
    x_ajax_form_jap_rutas_medicion_mob_submit_form(var_rut_id, var_rut_nombre, var_rut_estado, var_rut_empresa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_jap_rutas_medicion_mob_submit_form_cb);
  } // do_ajax_form_jap_rutas_medicion_mob_submit_form

  function do_ajax_form_jap_rutas_medicion_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("rut_id");
      scAjaxHideErrorDisplay("rut_nombre");
      scAjaxHideErrorDisplay("rut_estado");
      scAjaxHideErrorDisplay("lista_contratos");
      scAjaxHideErrorDisplay("rut_empresa");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_jap_rutas_medicion_mob_submit_form_cb_after_alert);
  } // do_ajax_form_jap_rutas_medicion_mob_submit_form_cb
  function do_ajax_form_jap_rutas_medicion_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_jap_rutas_medicion_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["grid_v_jap_rutas_medicion"] = "off";

  function do_ajax_form_jap_rutas_medicion_mob_navigate_form()
  {
    perform_ajax_form_jap_rutas_medicion_mob_navigate_form();
  }

  function perform_ajax_form_jap_rutas_medicion_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("lista_contratos");
    scAjaxHideErrorDisplay("rut_empresa");
    var var_rut_id = document.F2.rut_id.value;
    ...
    scAjaxProcOn();
    scStatusDetail["grid_v_jap_rutas_medicion"] = "on";
    x_ajax_form_jap_rutas_medicion_mob_navigate_form(var_rut_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jap_rutas_medicion_mob_navigate_form_cb);
  } // do_ajax_form_jap_rutas_medicion_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_rutas_medicion_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_jap_rutas_medicion_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.rut_id.value = scAjaxGetKeyValue("rut_id");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_grid_v_jap_rutas_medicion"] && "nmsc_iframe_liga_grid_v_jap_rutas_medicion" != scMasterDetailIframe["nmsc_iframe_liga_grid_v_jap_rutas_medicion"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_grid_v_jap_rutas_medicion"]);
    }
    else {
        if (oResp["navSummary"].reg_tot != 0) {
            document.getElementById('nmsc_iframe_liga_grid_v_jap_rutas_medicion').contentWindow.nm_move('apl_detalhe', true);
        }
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_jap_rutas_medicion_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_jap_rutas_medicion_mob_navigate_form_cb
  function do_ajax_form_jap_rutas_medicion_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_jap_rutas_medicion_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_jap_rutas_medicion_mob_navigate_form_cb_after_alert

  function sc_hide_form_jap_rutas_medicion_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["grid_v_jap_rutas_medicion"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "rut_id";
  ajax_field_list[1] = "rut_nombre";
  ajax_field_list[2] = "rut_estado";
  ajax_field_list[3] = "lista_contratos";
  ajax_field_list[4] = "rut_empresa";
  ...
  var ajax_error_list = {
    "rut_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "rut_nombre": {"label": "<?php echo $this->Ini->Nm_lang['lang_ruta'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "rut_estado": {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "lista_contratos": {"label": "<?php echo $this->Ini->Nm_lang['lang_lista_contratos'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "rut_empresa": {"label": "<?php echo $this->Ini->Nm_lang['lang_empresa'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "rut_id": new Array(),
    "rut_nombre": new Array(),
    "rut_estado": new Array(),
    "lista_contratos": new Array(),
    "rut_empresa": new Array()
  };
  ajax_field_mult["rut_id"][1] = "rut_id";
  ajax_field_mult["rut_nombre"][1] = "rut_nombre";
  ajax_field_mult["rut_estado"][1] = "rut_estado";
  ajax_field_mult["lista_contratos"][1] = "lista_contratos";
  ajax_field_mult["rut_empresa"][1] = "rut_empresa";

  var ajax_field_id = {
    "rut_nombre": new Array("hidden_field_label_rut_nombre", "hidden_field_data_rut_nombre"),
    "rut_estado": new Array("hidden_field_label_rut_estado", "hidden_field_data_rut_estado"),
    "lista_contratos": new Array("hidden_field_label_lista_contratos", "hidden_field_data_lista_contratos")
  };
