  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_jap_rutas_medicion" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_jap_rutas_medicion_form();
	}
...
?>
  ...
  // ---------- Validate rut_id
  function do_ajax_form_jap_rutas_medicion_validate_rut_id()
  {
    var nomeCampo_rut_id = "rut_id";
    var var_rut_id = scAjaxGetFieldHidden(nomeCampo_rut_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_rutas_medicion_validate_rut_id(var_rut_id, var_script_case_init, do_ajax_form_jap_rutas_medicion_validate_rut_id_cb);
  } // do_ajax_form_jap_rutas_medicion_validate_rut_id

  function do_ajax_form_jap_rutas_medicion_validate_rut_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_rutas_medicion_validate_rut_id_cb

  // ---------- Validate rut_nombre
  function do_ajax_form_jap_rutas_medicion_validate_rut_nombre()
  {
    var nomeCampo_rut_nombre = "rut_nombre";
    var var_rut_nombre = scAjaxGetFieldHidden(nomeCampo_rut_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_rutas_medicion_validate_rut_nombre(var_rut_nombre, var_script_case_init, do_ajax_form_jap_rutas_medicion_validate_rut_nombre_cb);
  } // do_ajax_form_jap_rutas_medicion_validate_rut_nombre

  function do_ajax_form_jap_rutas_medicion_validate_rut_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_rutas_medicion_validate_rut_nombre_cb

  // ---------- Validate rut_estado
  function do_ajax_form_jap_rutas_medicion_validate_rut_estado()
  {
    var nomeCampo_rut_estado = "rut_estado";
    var var_rut_estado = scAjaxGetFieldSelect(nomeCampo_rut_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_rutas_medicion_validate_rut_estado(var_rut_estado, var_script_case_init, do_ajax_form_jap_rutas_medicion_validate_rut_estado_cb);
  } // do_ajax_form_jap_rutas_medicion_validate_rut_estado

  function do_ajax_form_jap_rutas_medicion_validate_rut_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_rutas_medicion_validate_rut_estado_cb

  // ---------- Validate lista_contratos
  function do_ajax_form_jap_rutas_medicion_validate_lista_contratos()
  {
    var nomeCampo_lista_contratos = "lista_contratos";
    var var_lista_contratos = scAjaxGetFieldText(nomeCampo_lista_contratos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_rutas_medicion_validate_lista_contratos(var_lista_contratos, var_script_case_init, do_ajax_form_jap_rutas_medicion_validate_lista_contratos_cb);
  } // do_ajax_form_jap_rutas_medicion_validate_lista_contratos

  function do_ajax_form_jap_rutas_medicion_validate_lista_contratos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_rutas_medicion_validate_lista_contratos_cb

  // ---------- Validate rut_empresa
  function do_ajax_form_jap_rutas_medicion_validate_rut_empresa()
  {
    var nomeCampo_rut_empresa = "rut_empresa";
    var var_rut_empresa = scAjaxGetFieldText(nomeCampo_rut_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_rutas_medicion_validate_rut_empresa(var_rut_empresa, var_script_case_init, do_ajax_form_jap_rutas_medicion_validate_rut_empresa_cb);
  } // do_ajax_form_jap_rutas_medicion_validate_rut_empresa

  function do_ajax_form_jap_rutas_medicion_validate_rut_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_rutas_medicion_validate_rut_empresa_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_jap_rutas_medicion_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_jap_rutas_medicion_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_jap_rutas_medicion_submit_form(var_rut_id, var_rut_nombre, var_rut_estado, var_rut_empresa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_jap_rutas_medicion_submit_form_cb);
  } // do_ajax_form_jap_rutas_medicion_submit_form

  function do_ajax_form_jap_rutas_medicion_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_jap_rutas_medicion_submit_form_cb_after_alert);
  } // do_ajax_form_jap_rutas_medicion_submit_form_cb
  function do_ajax_form_jap_rutas_medicion_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_jap_rutas_medicion_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["grid_v_jap_rutas_medicion"] = "off";

  function do_ajax_form_jap_rutas_medicion_navigate_form()
  {
    perform_ajax_form_jap_rutas_medicion_navigate_form();
  }

  function perform_ajax_form_jap_rutas_medicion_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_jap_rutas_medicion_navigate_form(var_rut_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jap_rutas_medicion_navigate_form_cb);
  } // do_ajax_form_jap_rutas_medicion_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_rutas_medicion']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_jap_rutas_medicion_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_jap_rutas_medicion_navigate_form_cb_after_alert);
  } // do_ajax_form_jap_rutas_medicion_navigate_form_cb
  function do_ajax_form_jap_rutas_medicion_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_jap_rutas_medicion_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_jap_rutas_medicion_navigate_form_cb_after_alert

  function sc_hide_form_jap_rutas_medicion_form()
  {
