...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_dr_id' + iSeqRow).bind('blur', function() { sc_form_del_detalle_retencion_dr_id_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_del_detalle_retencion_dr_id_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_del_detalle_retencion_dr_id_onfocus(this, iSeqRow) });
  $('#id_sc_field_dr_retencion' + iSeqRow).bind('blur', function() { sc_form_del_detalle_retencion_dr_retencion_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_del_detalle_retencion_dr_retencion_onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_del_detalle_retencion_dr_retencion_onfocus(this, iSeqRow) });
  $('#id_sc_field_dr_impuesto' + iSeqRow).bind('blur', function() { sc_form_del_detalle_retencion_dr_impuesto_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_del_detalle_retencion_dr_impuesto_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_del_detalle_retencion_dr_impuesto_onfocus(this, iSeqRow) });
  $('#id_sc_field_dr_codigo_retencion' + iSeqRow).bind('blur', function() { sc_form_del_detalle_retencion_dr_codigo_retencion_onblur(this, iSeqRow) })
                                                 .bind('change', function() { sc_form_del_detalle_retencion_dr_codigo_retencion_onchange(this, iSeqRow) })
                                                 .bind('focus', function() { sc_form_del_detalle_retencion_dr_codigo_retencion_onfocus(this, iSeqRow) });
  $('#id_sc_field_dr_base_imponible' + iSeqRow).bind('blur', function() { sc_form_del_detalle_retencion_dr_base_imponible_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_form_del_detalle_retencion_dr_base_imponible_onchange(this, iSeqRow) })
                                               .bind('focus', function() { sc_form_del_detalle_retencion_dr_base_imponible_onfocus(this, iSeqRow) });
  $('#id_sc_field_dr_porcentaje_retencion' + iSeqRow).bind('blur', function() { sc_form_del_detalle_retencion_dr_porcentaje_retencion_onblur(this, iSeqRow) })
                                                     .bind('change', function() { sc_form_del_detalle_retencion_dr_porcentaje_retencion_onchange(this, iSeqRow) })
                                                     .bind('focus', function() { sc_form_del_detalle_retencion_dr_porcentaje_retencion_onfocus(this, iSeqRow) });
  $('#id_sc_field_dr_valor_retenido' + iSeqRow).bind('blur', function() { sc_form_del_detalle_retencion_dr_valor_retenido_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_form_del_detalle_retencion_dr_valor_retenido_onchange(this, iSeqRow) })
                                               .bind('focus', function() { sc_form_del_detalle_retencion_dr_valor_retenido_onfocus(this, iSeqRow) });
  $('#id_sc_field_dr_cod_doc_sustento' + iSeqRow).bind('blur', function() { sc_form_del_detalle_retencion_dr_cod_doc_sustento_onblur(this, iSeqRow) })
                                                 .bind('change', function() { sc_form_del_detalle_retencion_dr_cod_doc_sustento_onchange(this, iSeqRow) })
                                                 .bind('focus', function() { sc_form_del_detalle_retencion_dr_cod_doc_sustento_onfocus(this, iSeqRow) });
  $('#id_sc_field_dr_serie_doc_sustento' + iSeqRow).bind('blur', function() { sc_form_del_detalle_retencion_dr_serie_doc_sustento_onblur(this, iSeqRow) })
                                                   .bind('change', function() { sc_form_del_detalle_retencion_dr_serie_doc_sustento_onchange(this, iSeqRow) })
                                                   .bind('focus', function() { sc_form_del_detalle_retencion_dr_serie_doc_sustento_onfocus(this, iSeqRow) });
  $('#id_sc_field_dr_secuencia_doc_sustento' + iSeqRow).bind('blur', function() { sc_form_del_detalle_retencion_dr_secuencia_doc_sustento_onblur(this, iSeqRow) })
                                                       .bind('change', function() { sc_form_del_detalle_retencion_dr_secuencia_doc_sustento_onchange(this, iSeqRow) })
                                                       .bind('focus', function() { sc_form_del_detalle_retencion_dr_secuencia_doc_sustento_onfocus(this, iSeqRow) });
  $('#id_sc_field_dr_fecha_emision_doc_sustento' + iSeqRow).bind('blur', function() { sc_form_del_detalle_retencion_dr_fecha_emision_doc_sustento_onblur(this, iSeqRow) })
                                                           .bind('change', function() { sc_form_del_detalle_retencion_dr_fecha_emision_doc_sustento_onchange(this, iSeqRow) })
                                                           .bind('focus', function() { sc_form_del_detalle_retencion_dr_fecha_emision_doc_sustento_onfocus(this, iSeqRow) });
  $('#id_sc_field_dr_empresa' + iSeqRow).bind('blur', function() { sc_form_del_detalle_retencion_dr_empresa_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_del_detalle_retencion_dr_empresa_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_del_detalle_retencion_dr_empresa_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_del_detalle_retencion_dr_id_onblur(oThis, iSeqRow) {
  do_ajax_form_del_detalle_retencion_validate_dr_id();
  scCssBlur(oThis);
}

function sc_form_del_detalle_retencion_dr_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_del_detalle_retencion_dr_id_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_detalle_retencion_dr_retencion_onblur(oThis, iSeqRow) {
  do_ajax_form_del_detalle_retencion_validate_dr_retencion();
  scCssBlur(oThis);
}

function sc_form_del_detalle_retencion_dr_retencion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_del_detalle_retencion_dr_retencion_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_detalle_retencion_dr_impuesto_onblur(oThis, iSeqRow) {
  do_ajax_form_del_detalle_retencion_validate_dr_impuesto();
  scCssBlur(oThis);
}

function sc_form_del_detalle_retencion_dr_impuesto_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_form_del_detalle_retencion_refresh_dr_impuesto();
}

function sc_form_del_detalle_retencion_dr_impuesto_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_detalle_retencion_dr_codigo_retencion_onblur(oThis, iSeqRow) {
  do_ajax_form_del_detalle_retencion_validate_dr_codigo_retencion();
  scCssBlur(oThis);
}

function sc_form_del_detalle_retencion_dr_codigo_retencion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_form_del_detalle_retencion_event_dr_codigo_retencion_onchange();
}

function sc_form_del_detalle_retencion_dr_codigo_retencion_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_detalle_retencion_dr_base_imponible_onblur(oThis, iSeqRow) {
  do_ajax_form_del_detalle_retencion_validate_dr_base_imponible();
  scCssBlur(oThis);
}

function sc_form_del_detalle_retencion_dr_base_imponible_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_form_del_detalle_retencion_event_dr_base_imponible_onchange();
}

function sc_form_del_detalle_retencion_dr_base_imponible_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_detalle_retencion_dr_porcentaje_retencion_onblur(oThis, iSeqRow) {
  do_ajax_form_del_detalle_retencion_validate_dr_porcentaje_retencion();
  scCssBlur(oThis);
}

function sc_form_del_detalle_retencion_dr_porcentaje_retencion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_del_detalle_retencion_dr_porcentaje_retencion_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_detalle_retencion_dr_valor_retenido_onblur(oThis, iSeqRow) {
  do_ajax_form_del_detalle_retencion_validate_dr_valor_retenido();
  scCssBlur(oThis);
}

function sc_form_del_detalle_retencion_dr_valor_retenido_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_del_detalle_retencion_dr_valor_retenido_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_detalle_retencion_dr_cod_doc_sustento_onblur(oThis, iSeqRow) {
  do_ajax_form_del_detalle_retencion_validate_dr_cod_doc_sustento();
  scCssBlur(oThis);
}

function sc_form_del_detalle_retencion_dr_cod_doc_sustento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_del_detalle_retencion_dr_cod_doc_sustento_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_detalle_retencion_dr_serie_doc_sustento_onblur(oThis, iSeqRow) {
  do_ajax_form_del_detalle_retencion_validate_dr_serie_doc_sustento();
  scCssBlur(oThis);
}

function sc_form_del_detalle_retencion_dr_serie_doc_sustento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_del_detalle_retencion_dr_serie_doc_sustento_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_detalle_retencion_dr_secuencia_doc_sustento_onblur(oThis, iSeqRow) {
  do_ajax_form_del_detalle_retencion_validate_dr_secuencia_doc_sustento();
  scCssBlur(oThis);
}

function sc_form_del_detalle_retencion_dr_secuencia_doc_sustento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_del_detalle_retencion_dr_secuencia_doc_sustento_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_detalle_retencion_dr_fecha_emision_doc_sustento_onblur(oThis, iSeqRow) {
  do_ajax_form_del_detalle_retencion_validate_dr_fecha_emision_doc_sustento();
  scCssBlur(oThis);
}

function sc_form_del_detalle_retencion_dr_fecha_emision_doc_sustento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_del_detalle_retencion_dr_fecha_emision_doc_sustento_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_del_detalle_retencion_dr_empresa_onblur(oThis, iSeqRow) {
  do_ajax_form_del_detalle_retencion_validate_dr_empresa();
  scCssBlur(oThis);
}

function sc_form_del_detalle_retencion_dr_empresa_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_del_detalle_retencion_dr_empresa_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_del_detalle_retencion_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_dr_fecha_emision_doc_sustento" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      setTimeout(function() { do_ajax_form_del_detalle_retencion_validate_dr_fecha_emision_doc_sustento(iSeqRow); }, 200);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_del_detalle_retencion')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
