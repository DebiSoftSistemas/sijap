  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_detalle_retencion" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_detalle_retencion_form();
	}
...
?>
  ...
  function do_ajax_form_del_detalle_retencion_validate_dr_cod_doc_sustento()
  {
    ...
    x_ajax_form_del_detalle_retencion_validate_dr_cod_doc_sustento(var_dr_cod_doc_sustento, var_script_case_init, do_ajax_form_del_detalle_retencion_validate_dr_cod_doc_sustento_cb);
  } // do_ajax_form_del_detalle_retencion_validate_dr_cod_doc_sustento

  function do_ajax_form_del_detalle_retencion_validate_dr_cod_doc_sustento_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_retencion_validate_dr_cod_doc_sustento_cb

  // ---------- Validate dr_serie_doc_sustento
  function do_ajax_form_del_detalle_retencion_validate_dr_serie_doc_sustento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_retencion_validate_dr_serie_doc_sustento(var_dr_serie_doc_sustento, var_script_case_init, do_ajax_form_del_detalle_retencion_validate_dr_serie_doc_sustento_cb);
  } // do_ajax_form_del_detalle_retencion_validate_dr_serie_doc_sustento

  function do_ajax_form_del_detalle_retencion_validate_dr_serie_doc_sustento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_retencion_validate_dr_serie_doc_sustento_cb

  // ---------- Validate dr_secuencia_doc_sustento
  function do_ajax_form_del_detalle_retencion_validate_dr_secuencia_doc_sustento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_retencion_validate_dr_secuencia_doc_sustento(var_dr_secuencia_doc_sustento, var_script_case_init, do_ajax_form_del_detalle_retencion_validate_dr_secuencia_doc_sustento_cb);
  } // do_ajax_form_del_detalle_retencion_validate_dr_secuencia_doc_sustento

  function do_ajax_form_del_detalle_retencion_validate_dr_secuencia_doc_sustento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_retencion_validate_dr_secuencia_doc_sustento_cb

  // ---------- Validate dr_fecha_emision_doc_sustento
  function do_ajax_form_del_detalle_retencion_validate_dr_fecha_emision_doc_sustento()
  {
    ...
    setTimeout(function() {
      var var_dr_fecha_emision_doc_sustento = scAjaxGetFieldText(nomeCampo_dr_fecha_emision_doc_sustento);
      x_ajax_form_del_detalle_retencion_validate_dr_fecha_emision_doc_sustento(var_dr_fecha_emision_doc_sustento, var_script_case_init, do_ajax_form_del_detalle_retencion_validate_dr_fecha_emision_doc_sustento_cb);
    }, 200);
  } // do_ajax_form_del_detalle_retencion_validate_dr_fecha_emision_doc_sustento

  function do_ajax_form_del_detalle_retencion_validate_dr_fecha_emision_doc_sustento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_retencion_validate_dr_fecha_emision_doc_sustento_cb

  // ---------- Validate dr_empresa
  function do_ajax_form_del_detalle_retencion_validate_dr_empresa()
  {
    var nomeCampo_dr_empresa = "dr_empresa";
    var var_dr_empresa = scAjaxGetFieldText(nomeCampo_dr_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_retencion_validate_dr_empresa(var_dr_empresa, var_script_case_init, do_ajax_form_del_detalle_retencion_validate_dr_empresa_cb);
  } // do_ajax_form_del_detalle_retencion_validate_dr_empresa

  function do_ajax_form_del_detalle_retencion_validate_dr_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_retencion_validate_dr_empresa_cb

  // ---------- Validate dr_impuesto
  function do_ajax_form_del_detalle_retencion_validate_dr_impuesto()
  {
    var nomeCampo_dr_impuesto = "dr_impuesto";
    var var_dr_impuesto = scAjaxGetFieldSelect(nomeCampo_dr_impuesto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_retencion_validate_dr_impuesto(var_dr_impuesto, var_script_case_init, do_ajax_form_del_detalle_retencion_validate_dr_impuesto_cb);
  } // do_ajax_form_del_detalle_retencion_validate_dr_impuesto

  function do_ajax_form_del_detalle_retencion_validate_dr_impuesto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_retencion_validate_dr_impuesto_cb

  // ---------- Validate dr_codigo_retencion
  function do_ajax_form_del_detalle_retencion_validate_dr_codigo_retencion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_retencion_validate_dr_codigo_retencion(var_dr_codigo_retencion, var_script_case_init, do_ajax_form_del_detalle_retencion_validate_dr_codigo_retencion_cb);
  } // do_ajax_form_del_detalle_retencion_validate_dr_codigo_retencion

  function do_ajax_form_del_detalle_retencion_validate_dr_codigo_retencion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_retencion_validate_dr_codigo_retencion_cb

  // ---------- Validate dr_base_imponible
  function do_ajax_form_del_detalle_retencion_validate_dr_base_imponible()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_retencion_validate_dr_base_imponible(var_dr_base_imponible, var_script_case_init, do_ajax_form_del_detalle_retencion_validate_dr_base_imponible_cb);
  } // do_ajax_form_del_detalle_retencion_validate_dr_base_imponible

  function do_ajax_form_del_detalle_retencion_validate_dr_base_imponible_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_retencion_validate_dr_base_imponible_cb

  // ---------- Validate dr_porcentaje_retencion
  function do_ajax_form_del_detalle_retencion_validate_dr_porcentaje_retencion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_retencion_validate_dr_porcentaje_retencion(var_dr_porcentaje_retencion, var_script_case_init, do_ajax_form_del_detalle_retencion_validate_dr_porcentaje_retencion_cb);
  } // do_ajax_form_del_detalle_retencion_validate_dr_porcentaje_retencion

  function do_ajax_form_del_detalle_retencion_validate_dr_porcentaje_retencion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_retencion_validate_dr_porcentaje_retencion_cb

  // ---------- Validate dr_valor_retenido
  function do_ajax_form_del_detalle_retencion_validate_dr_valor_retenido()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_retencion_validate_dr_valor_retenido(var_dr_valor_retenido, var_script_case_init, do_ajax_form_del_detalle_retencion_validate_dr_valor_retenido_cb);
  } // do_ajax_form_del_detalle_retencion_validate_dr_valor_retenido

  function do_ajax_form_del_detalle_retencion_validate_dr_valor_retenido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_retencion_validate_dr_valor_retenido_cb

  // ---------- Validate dr_id
  function do_ajax_form_del_detalle_retencion_validate_dr_id()
  {
    var nomeCampo_dr_id = "dr_id";
    var var_dr_id = scAjaxGetFieldHidden(nomeCampo_dr_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_retencion_validate_dr_id(var_dr_id, var_script_case_init, do_ajax_form_del_detalle_retencion_validate_dr_id_cb);
  } // do_ajax_form_del_detalle_retencion_validate_dr_id

  function do_ajax_form_del_detalle_retencion_validate_dr_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dr_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_retencion_validate_dr_id_cb

  // ---------- Validate dr_retencion
  function do_ajax_form_del_detalle_retencion_validate_dr_retencion()
  {
    var nomeCampo_dr_retencion = "dr_retencion";
    var var_dr_retencion = scAjaxGetFieldText(nomeCampo_dr_retencion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_detalle_retencion_validate_dr_retencion(var_dr_retencion, var_script_case_init, do_ajax_form_del_detalle_retencion_validate_dr_retencion_cb);
  } // do_ajax_form_del_detalle_retencion_validate_dr_retencion

  function do_ajax_form_del_detalle_retencion_validate_dr_retencion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_retencion_validate_dr_retencion_cb

  // ---------- Refresh dr_impuesto
  function do_ajax_form_del_detalle_retencion_refresh_dr_impuesto()
  {
    var var_dr_impuesto = scAjaxGetFieldSelect("dr_impuesto");
    var var_nmgp_refresh_fields = "dr_codigo_retencion";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_detalle_retencion_refresh_dr_impuesto(var_dr_impuesto, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_del_detalle_retencion_refresh_dr_impuesto_cb);
  } // do_ajax_form_del_detalle_retencion_refresh_dr_impuesto

  function do_ajax_form_del_detalle_retencion_refresh_dr_impuesto_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_detalle_retencion_refresh_dr_impuesto_cb

  // ---------- Event onchange dr_base_imponible
  function do_ajax_form_del_detalle_retencion_event_dr_base_imponible_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_detalle_retencion_event_dr_base_imponible_onchange(var_dr_base_imponible, var_dr_porcentaje_retencion, var_dr_valor_retenido, var_script_case_init, do_ajax_form_del_detalle_retencion_event_dr_base_imponible_onchange_cb);
  } // do_ajax_form_del_detalle_retencion_event_dr_base_imponible_onchange

  function do_ajax_form_del_detalle_retencion_event_dr_base_imponible_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "dr_base_imponible";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_detalle_retencion_event_dr_base_imponible_onchange_cb_after_alert);
  } // do_ajax_form_del_detalle_retencion_event_dr_base_imponible_onchange_cb
  function do_ajax_form_del_detalle_retencion_event_dr_base_imponible_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_detalle_retencion_event_dr_base_imponible_onchange_cb_after_alert

  // ---------- Event onchange dr_codigo_retencion
  function do_ajax_form_del_detalle_retencion_event_dr_codigo_retencion_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_detalle_retencion_event_dr_codigo_retencion_onchange(var_dr_codigo_retencion, var_dr_porcentaje_retencion, var_dr_base_imponible, var_dr_valor_retenido, var_script_case_init, do_ajax_form_del_detalle_retencion_event_dr_codigo_retencion_onchange_cb);
  } // do_ajax_form_del_detalle_retencion_event_dr_codigo_retencion_onchange

  function do_ajax_form_del_detalle_retencion_event_dr_codigo_retencion_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "dr_codigo_retencion";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_detalle_retencion_event_dr_codigo_retencion_onchange_cb_after_alert);
  } // do_ajax_form_del_detalle_retencion_event_dr_codigo_retencion_onchange_cb
  function do_ajax_form_del_detalle_retencion_event_dr_codigo_retencion_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_detalle_retencion_event_dr_codigo_retencion_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_detalle_retencion_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_detalle_retencion_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_del_detalle_retencion_submit_form(var_dr_cod_doc_sustento, var_dr_serie_doc_sustento, var_dr_secuencia_doc_sustento, var_dr_fecha_emision_doc_sustento, var_dr_empresa, var_dr_impuesto, var_dr_codigo_retencion, var_dr_base_imponible, var_dr_porcentaje_retencion, var_dr_valor_retenido, var_dr_id, var_dr_retencion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_detalle_retencion_submit_form_cb);
  } // do_ajax_form_del_detalle_retencion_submit_form

  function do_ajax_form_del_detalle_retencion_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_detalle_retencion_submit_form_cb_after_alert);
  } // do_ajax_form_del_detalle_retencion_submit_form_cb
  function do_ajax_form_del_detalle_retencion_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_detalle_retencion_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_detalle_retencion_navigate_form()
  {
    perform_ajax_form_del_detalle_retencion_navigate_form();
  }

  function perform_ajax_form_del_detalle_retencion_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_detalle_retencion_navigate_form(var_dr_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_detalle_retencion_navigate_form_cb);
  } // do_ajax_form_del_detalle_retencion_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_retencion']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_detalle_retencion_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_detalle_retencion_navigate_form_cb_after_alert);
  } // do_ajax_form_del_detalle_retencion_navigate_form_cb
  function do_ajax_form_del_detalle_retencion_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_del_detalle_retencion_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_detalle_retencion_navigate_form_cb_after_alert

  function sc_hide_form_del_detalle_retencion_form()
  {
