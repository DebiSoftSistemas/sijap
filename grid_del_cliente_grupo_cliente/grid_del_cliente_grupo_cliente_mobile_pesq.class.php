...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "cgc_id";$Nm_numeric[] = "cgc_grupo";$Nm_numeric[] = "cgc_cliente";$Nm_numeric[] = "cl_id";$Nm_numeric[] = "cl_pais";$Nm_numeric[] = "cl_provincia";$Nm_numeric[] = "cl_ciudad";$Nm_numeric[] = "cgc_id";$Nm_numeric[] = "cgc_grupo";$Nm_numeric[] = "cgc_cliente";$Nm_numeric[] = "cl_id";$Nm_numeric[] = "cl_pais";$Nm_numeric[] = "cl_provincia";$Nm_numeric[] = "cl_ciudad";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_cgc_id_cond" name="cgc_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_cgc_id'), this, 'cgc_id')">
      ...
      <br><span id="id_hide_cgc_id"  <?php echo $str_hide_cgc_id?>><INPUT  type="text" id="SC_cgc_id" name="cgc_id" value="<?php echo NM_encode_input($cgc_id) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_cgc_grupo_cond" name="cgc_grupo_cond" onChange="nm_campos_between(document.getElementById('id_vis_cgc_grupo'), this, 'cgc_grupo')">
      ...
      <br><span id="id_hide_cgc_grupo"  <?php echo $str_hide_cgc_grupo?>><INPUT  type="text" id="SC_cgc_grupo" name="cgc_grupo" value="<?php echo NM_encode_input($cgc_grupo) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_cgc_cliente_cond" name="cgc_cliente_cond" onChange="nm_campos_between(document.getElementById('id_vis_cgc_cliente'), this, 'cgc_cliente')">
