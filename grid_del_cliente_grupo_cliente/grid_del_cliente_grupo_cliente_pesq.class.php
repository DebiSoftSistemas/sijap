...
class grid_del_cliente_grupo_cliente_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_del_cliente_grupo_cliente_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_del_cliente_grupo_cliente_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_del_cliente_grupo_cliente_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$campo_join]);
              return;
          }
         $nm_ini_lower = "";
         $nm_fim_lower = "";
      ...
      else
      {
         ...
         $nome_sum = "del_cliente_grupo_cliente.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> del_cliente_grupo_cliente</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_del_cliente_grupo_cliente/grid_del_cliente_grupo_cliente_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_del_cliente_grupo_cliente_ajax_search.js"></script>
 <script type="text/javascript" src="grid_del_cliente_grupo_cliente_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_del_cliente_grupo_cliente_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_del_cliente_grupo_cliente']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_del_cliente_grupo_cliente']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_cgc_id_cond#NMF#' + search_get_sel_txt('SC_cgc_id_cond') + '@NMF@';
  str_out += 'SC_cgc_id#NMF#' + search_get_text('SC_cgc_id') + '@NMF@';
  str_out += 'SC_cgc_grupo_cond#NMF#' + search_get_sel_txt('SC_cgc_grupo_cond') + '@NMF@';
  str_out += 'SC_cgc_grupo#NMF#' + search_get_text('SC_cgc_grupo') + '@NMF@';
  str_out += 'SC_cgc_cliente_cond#NMF#' + search_get_sel_txt('SC_cgc_cliente_cond') + '@NMF@';
  str_out += 'SC_cgc_cliente#NMF#' + search_get_text('SC_cgc_cliente') + '@NMF@';
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      global 
             $cgc_id_cond, $cgc_id,
             $cgc_grupo_cond, $cgc_grupo,
             $cgc_cliente_cond, $cgc_cliente,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $cgc_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['campos_busca']['cgc_id']; 
          $cgc_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['campos_busca']['cgc_id_cond']; 
          $cgc_grupo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['campos_busca']['cgc_grupo']; 
          $cgc_grupo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['campos_busca']['cgc_grupo_cond']; 
          $cgc_cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['campos_busca']['cgc_cliente']; 
          $cgc_cliente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['campos_busca']['cgc_cliente_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['campos_busca']['NM_operador']; 
          if (strtoupper($cgc_id_cond) != "II" && strtoupper($cgc_id_cond) != "QP" && strtoupper($cgc_id_cond) != "NP" && strtoupper($cgc_id_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($cgc_id, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($cgc_grupo_cond) != "II" && strtoupper($cgc_grupo_cond) != "QP" && strtoupper($cgc_grupo_cond) != "NP" && strtoupper($cgc_grupo_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($cgc_grupo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($cgc_cliente_cond) != "II" && strtoupper($cgc_cliente_cond) != "QP" && strtoupper($cgc_cliente_cond) != "NP" && strtoupper($cgc_cliente_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($cgc_cliente, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($cgc_id_cond) || empty($cgc_id_cond))
      {
         $cgc_id_cond = "gt";
      }
      if (!isset($cgc_grupo_cond) || empty($cgc_grupo_cond))
      {
         $cgc_grupo_cond = "gt";
      }
      if (!isset($cgc_cliente_cond) || empty($cgc_cliente_cond))
      {
         $cgc_cliente_cond = "gt";
      }
      ...
      $str_hide_cgc_id = (in_array($cgc_id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_cgc_grupo = (in_array($cgc_grupo_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_cgc_cliente = (in_array($cgc_cliente_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($cgc_id) || $cgc_id == "")
      {
          $cgc_id = "";
      }
      if (isset($cgc_id) && !empty($cgc_id))
      {
         $tmp_pos = (is_string($cgc_id)) ? strpos($cgc_id, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $cgc_id = substr($cgc_id, 0, $tmp_pos);
         }
      }
      if (!isset($cgc_grupo) || $cgc_grupo == "")
      {
          $cgc_grupo = "";
      }
      if (isset($cgc_grupo) && !empty($cgc_grupo))
      {
         $tmp_pos = (is_string($cgc_grupo)) ? strpos($cgc_grupo, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $cgc_grupo = substr($cgc_grupo, 0, $tmp_pos);
         }
      }
      if (!isset($cgc_cliente) || $cgc_cliente == "")
      {
          $cgc_cliente = "";
      }
      if (isset($cgc_cliente) && !empty($cgc_cliente))
      {
         $tmp_pos = (is_string($cgc_cliente)) ? strpos($cgc_cliente, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $cgc_cliente = substr($cgc_cliente, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_cgc_id_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['cgc_id'])) ? $this->New_label['cgc_id'] : "Cgc Id"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_cgc_id_cond" name="cgc_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_cgc_id'), this, 'cgc_id')">
       <OPTION value="gt" <?php if ("gt" == $cgc_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $cgc_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $cgc_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cgc_id" <?php echo $str_hide_cgc_id?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['cgc_id'])) ? $this->New_label['cgc_id'] : "Cgc Id";
 $nmgp_tab_label .= "cgc_id?#?" . $SC_Label . "?@?";
...
?>
<INPUT  type="text" id="SC_cgc_id" name="cgc_id" value="<?php echo NM_encode_input($cgc_id) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_cgc_grupo_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['cgc_grupo'])) ? $this->New_label['cgc_grupo'] : "Cgc Grupo"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_cgc_grupo_cond" name="cgc_grupo_cond" onChange="nm_campos_between(document.getElementById('id_vis_cgc_grupo'), this, 'cgc_grupo')">
       <OPTION value="gt" <?php if ("gt" == $cgc_grupo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $cgc_grupo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $cgc_grupo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cgc_grupo" <?php echo $str_hide_cgc_grupo?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['cgc_grupo'])) ? $this->New_label['cgc_grupo'] : "Cgc Grupo";
 $nmgp_tab_label .= "cgc_grupo?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_cgc_grupo" name="cgc_grupo" value="<?php echo NM_encode_input($cgc_grupo) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_cgc_cliente_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['cgc_cliente'])) ? $this->New_label['cgc_cliente'] : "Cgc Cliente"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_cgc_cliente_cond" name="cgc_cliente_cond" onChange="nm_campos_between(document.getElementById('id_vis_cgc_cliente'), this, 'cgc_cliente')">
       <OPTION value="gt" <?php if ("gt" == $cgc_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $cgc_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $cgc_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cgc_cliente" <?php echo $str_hide_cgc_cliente?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['cgc_cliente'])) ? $this->New_label['cgc_cliente'] : "Cgc Cliente";
 $nmgp_tab_label .= "cgc_cliente?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_cgc_cliente" name="cgc_cliente" value="<?php echo NM_encode_input($cgc_cliente) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_del_cliente_grupo_cliente_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_del_cliente_grupo_cliente']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_del_cliente_grupo_cliente']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.cgc_id_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_cgc_id'), document.F1.cgc_id_cond, 'cgc_id');
   document.F1.cgc_id.value = "";
   document.F1.cgc_grupo_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_cgc_grupo'), document.F1.cgc_grupo_cond, 'cgc_grupo');
   document.F1.cgc_grupo.value = "";
   document.F1.cgc_cliente_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_cgc_cliente'), document.F1.cgc_cliente_cond, 'cgc_cliente');
   document.F1.cgc_cliente.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_del_cliente_grupo_cliente/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_cgc_id_cond'] = 'cond';
      $tp_fields['SC_cgc_id'] = 'text';
      $tp_fields['SC_cgc_grupo_cond'] = 'cond';
      $tp_fields['SC_cgc_grupo'] = 'text';
      $tp_fields['SC_cgc_cliente_cond'] = 'cond';
      $tp_fields['SC_cgc_cliente'] = 'text';
   ...
   {
      global $cgc_id_cond, $cgc_id,
             $cgc_grupo_cond, $cgc_grupo,
             $cgc_cliente_cond, $cgc_cliente, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $cgc_id_cond_salva = $cgc_id_cond; 
      if (!isset($cgc_id_input_2) || $cgc_id_input_2 == "")
      {
          $cgc_id_input_2 = $cgc_id;
      }
      $cgc_grupo_cond_salva = $cgc_grupo_cond; 
      if (!isset($cgc_grupo_input_2) || $cgc_grupo_input_2 == "")
      {
          $cgc_grupo_input_2 = $cgc_grupo;
      }
      $cgc_cliente_cond_salva = $cgc_cliente_cond; 
      if (!isset($cgc_cliente_input_2) || $cgc_cliente_input_2 == "")
      {
          $cgc_cliente_input_2 = $cgc_cliente;
      }
      if ($cgc_id_cond != "in")
      {
          nm_limpa_numero($cgc_id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($cgc_grupo_cond != "in")
      {
          nm_limpa_numero($cgc_grupo, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($cgc_cliente_cond != "in")
      {
          nm_limpa_numero($cgc_cliente, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['campos_busca']['cgc_id'] = $cgc_id; 
      if (is_array($cgc_id) && !empty($cgc_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['Grid_search'][$I_Grid]['val'][0] = $cgc_id;
      }
      elseif ($cgc_id_cond_salva == "nu" || $cgc_id_cond_salva == "nn" || $cgc_id_cond_salva == "ep" || $cgc_id_cond_salva == "ne" || !empty($cgc_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['Grid_search'][$I_Grid]['val'][0][0] = $cgc_id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['campos_busca']['cgc_id_cond'] = $cgc_id_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['Grid_search'][$I_Grid]['cmp'] = "cgc_id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['Grid_search'][$I_Grid]['opc'] = $cgc_id_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq']['cgc_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['campos_busca']['cgc_grupo'] = $cgc_grupo; 
      if (is_array($cgc_grupo) && !empty($cgc_grupo))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['Grid_search'][$I_Grid]['val'][0] = $cgc_grupo;
      }
      elseif ($cgc_grupo_cond_salva == "nu" || $cgc_grupo_cond_salva == "nn" || $cgc_grupo_cond_salva == "ep" || $cgc_grupo_cond_salva == "ne" || !empty($cgc_grupo))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['Grid_search'][$I_Grid]['val'][0][0] = $cgc_grupo;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['campos_busca']['cgc_grupo_cond'] = $cgc_grupo_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['Grid_search'][$I_Grid]['cmp'] = "cgc_grupo"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['Grid_search'][$I_Grid]['opc'] = $cgc_grupo_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq']['cgc_grupo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['campos_busca']['cgc_cliente'] = $cgc_cliente; 
      if (is_array($cgc_cliente) && !empty($cgc_cliente))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['Grid_search'][$I_Grid]['val'][0] = $cgc_cliente;
      }
      elseif ($cgc_cliente_cond_salva == "nu" || $cgc_cliente_cond_salva == "nn" || $cgc_cliente_cond_salva == "ep" || $cgc_cliente_cond_salva == "ne" || !empty($cgc_cliente))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['Grid_search'][$I_Grid]['val'][0][0] = $cgc_cliente;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['campos_busca']['cgc_cliente_cond'] = $cgc_cliente_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['Grid_search'][$I_Grid]['cmp'] = "cgc_cliente"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['Grid_search'][$I_Grid]['opc'] = $cgc_cliente_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['grid_pesq']['cgc_cliente'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $this->cmp_formatado['cgc_id'] = $Conteudo;
      $Conteudo = $cgc_grupo;
      if (strtoupper($cgc_grupo_cond) != "II" && strtoupper($cgc_grupo_cond) != "QP" && strtoupper($cgc_grupo_cond) != "NP" && strtoupper($cgc_grupo_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['cgc_grupo'] = $Conteudo;
      $Conteudo = $cgc_cliente;
      if (strtoupper($cgc_cliente_cond) != "II" && strtoupper($cgc_cliente_cond) != "QP" && strtoupper($cgc_cliente_cond) != "NP" && strtoupper($cgc_cliente_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['cgc_cliente'] = $Conteudo;

      //----- $cgc_id
      $this->Date_part = false;
      if (isset($cgc_id) || $cgc_id_cond == "nu" || $cgc_id_cond == "nn" || $cgc_id_cond == "ep" || $cgc_id_cond == "ne")
      {
         $this->monta_condicao("cgc_id", $cgc_id_cond, $cgc_id, "", "cgc_id", "INT4", false);
      }

      //----- $cgc_grupo
      $this->Date_part = false;
      if (isset($cgc_grupo) || $cgc_grupo_cond == "nu" || $cgc_grupo_cond == "nn" || $cgc_grupo_cond == "ep" || $cgc_grupo_cond == "ne")
      {
         $this->monta_condicao("cgc_grupo", $cgc_grupo_cond, $cgc_grupo, "", "cgc_grupo", "INT4", false);
      }

      //----- $cgc_cliente
      $this->Date_part = false;
      if (isset($cgc_cliente) || $cgc_cliente_cond == "nu" || $cgc_cliente_cond == "nn" || $cgc_cliente_cond == "ep" || $cgc_cliente_cond == "ne")
      {
         $this->monta_condicao("cgc_cliente", $cgc_cliente_cond, $cgc_cliente, "", "cgc_cliente", "INT4", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
    $this->Sel_case_sensitive($this->comando);
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_cliente_grupo_cliente']['cond_pesq'] .= $this->NM_operador;
