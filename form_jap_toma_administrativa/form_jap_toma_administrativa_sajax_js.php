  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_jap_toma_administrativa" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_jap_toma_administrativa_form();
	}
...
?>
  ...
  // ---------- Validate ta_id_
  function do_ajax_form_jap_toma_administrativa_validate_ta_id_(iNumLinha)
  {
    var nomeCampo_ta_id_ = "ta_id_" + iNumLinha;
    var var_ta_id_ = scAjaxGetFieldHidden(nomeCampo_ta_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_toma_administrativa_validate_ta_id_(var_ta_id_, iNumLinha, var_script_case_init, do_ajax_form_jap_toma_administrativa_validate_ta_id__cb);
  } // do_ajax_form_jap_toma_administrativa_validate_ta_id_

  function do_ajax_form_jap_toma_administrativa_validate_ta_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_toma_administrativa_validate_ta_id__cb

  // ---------- Validate ta_empresa_
  function do_ajax_form_jap_toma_administrativa_validate_ta_empresa_(iNumLinha)
  {
    var nomeCampo_ta_empresa_ = "ta_empresa_" + iNumLinha;
    var var_ta_empresa_ = scAjaxGetFieldText(nomeCampo_ta_empresa_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_toma_administrativa_validate_ta_empresa_(var_ta_empresa_, iNumLinha, var_script_case_init, do_ajax_form_jap_toma_administrativa_validate_ta_empresa__cb);
  } // do_ajax_form_jap_toma_administrativa_validate_ta_empresa_

  function do_ajax_form_jap_toma_administrativa_validate_ta_empresa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_toma_administrativa_validate_ta_empresa__cb

  // ---------- Validate ta_descripcion_
  function do_ajax_form_jap_toma_administrativa_validate_ta_descripcion_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_toma_administrativa_validate_ta_descripcion_(var_ta_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_jap_toma_administrativa_validate_ta_descripcion__cb);
  } // do_ajax_form_jap_toma_administrativa_validate_ta_descripcion_

  function do_ajax_form_jap_toma_administrativa_validate_ta_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_toma_administrativa_validate_ta_descripcion__cb

  // ---------- Validate ta_estado_
  function do_ajax_form_jap_toma_administrativa_validate_ta_estado_(iNumLinha)
  {
    var nomeCampo_ta_estado_ = "ta_estado_" + iNumLinha;
    var var_ta_estado_ = scAjaxGetFieldSelect(nomeCampo_ta_estado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_toma_administrativa_validate_ta_estado_(var_ta_estado_, iNumLinha, var_script_case_init, do_ajax_form_jap_toma_administrativa_validate_ta_estado__cb);
  } // do_ajax_form_jap_toma_administrativa_validate_ta_estado_

  function do_ajax_form_jap_toma_administrativa_validate_ta_estado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_toma_administrativa_validate_ta_estado__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_jap_toma_administrativa_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_jap_toma_administrativa_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_jap_toma_administrativa_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_jap_toma_administrativa_add_new_line_cb);
  } // do_ajax_form_jap_toma_administrativa_add_new_line

  function do_ajax_form_jap_toma_administrativa_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_jap_toma_administrativa_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_jap_toma_administrativa_backup_line(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_toma_administrativa_backup_line(var_ta_id_, var_ta_empresa_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_jap_toma_administrativa_backup_line_cb);
  } // do_ajax_form_jap_toma_administrativa_backup_line

  function do_ajax_form_jap_toma_administrativa_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_jap_toma_administrativa_backup_line_cb

  function do_ajax_form_jap_toma_administrativa_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_jap_toma_administrativa_cancel_insert

  function do_ajax_form_jap_toma_administrativa_cancel_update(iSeqVert)
  {
    do_ajax_form_jap_toma_administrativa_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_jap_toma_administrativa_cancel_update

  function do_ajax_form_jap_toma_administrativa_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_jap_toma_administrativa_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_jap_toma_administrativa_table_refresh()
  {
    var var_ta_id_ = document.F2.ta_id_.value;
    var var_ta_empresa_ = document.F2.ta_empresa_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_jap_toma_administrativa_table_refresh(var_ta_id_, var_ta_empresa_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jap_toma_administrativa_table_refresh_cb);
  } //  do_ajax_form_jap_toma_administrativa_table_refresh

  function do_ajax_form_jap_toma_administrativa_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.ta_empresa_.value = scAjaxGetKeyValue("ta_empresa_");
    ...
    scAjaxAlert(do_ajax_form_jap_toma_administrativa_table_refresh_cb_after_alert);
  } // do_ajax_form_jap_toma_administrativa_table_refresh_cb
  function do_ajax_form_jap_toma_administrativa_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_jap_toma_administrativa_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_jap_toma_administrativa_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_jap_toma_administrativa_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_jap_toma_administrativa_submit_form(var_ta_id_, var_ta_empresa_, var_ta_descripcion_, var_ta_estado_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_jap_toma_administrativa_submit_form_cb);
  } // do_ajax_form_jap_toma_administrativa_submit_form

  function do_ajax_form_jap_toma_administrativa_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_jap_toma_administrativa_submit_form_cb_after_alert);
  } // do_ajax_form_jap_toma_administrativa_submit_form_cb
  function do_ajax_form_jap_toma_administrativa_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_jap_toma_administrativa_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_jap_toma_administrativa_navigate_form()
  {
    perform_ajax_form_jap_toma_administrativa_navigate_form();
  }

  function perform_ajax_form_jap_toma_administrativa_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_jap_toma_administrativa_cancel_insert(sc_form_jap_toma_administrativa_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_jap_toma_administrativa_navigate_form(var_ta_id_, var_ta_empresa_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jap_toma_administrativa_navigate_form_cb);
  } // do_ajax_form_jap_toma_administrativa_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_toma_administrativa']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_jap_toma_administrativa_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.ta_empresa_.value = scAjaxGetKeyValue("ta_empresa_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_jap_toma_administrativa_navigate_form_cb_after_alert);
  } // do_ajax_form_jap_toma_administrativa_navigate_form_cb
  function do_ajax_form_jap_toma_administrativa_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_jap_toma_administrativa_navigate_form_cb_after_alert

    function sc_form_jap_toma_administrativa_get_last_line_number()
    {
    ...
    } //sc_form_jap_toma_administrativa_get_last_line_number

  function sc_hide_form_jap_toma_administrativa_form()
  {
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ta_empresa_'])) ? $this->nmgp_cmp_readonly['ta_empresa_'] : 'on';
?>
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["ta_id_" + iRow] || "on" == ajax_error_count["ta_empresa_" + iRow] || "on" == ajax_error_count["ta_descripcion_" + iRow] || "on" == ajax_error_count["ta_estado_" + iRow]))
    {
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["ta_id_" + iRow] && "off" == ajax_error_count["ta_empresa_" + iRow] && "off" == ajax_error_count["ta_descripcion_" + iRow] && "off" == ajax_error_count["ta_estado_" + iRow]))
    {
      if (bErrorRow)
      {
