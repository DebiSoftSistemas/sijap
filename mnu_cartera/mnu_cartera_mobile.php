...
<html>
    <head>
        ...
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["mnu_cartera"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile.min.css" />
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["mnu_cartera"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["mnu_cartera"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile.min.js"></script>
    <style>
    <?php
    if(isset($mnu_cartera_menuData["data"]) && is_array($mnu_cartera_menuData["data"]) && !empty($mnu_cartera_menuData["data"]))
    {
        foreach($mnu_cartera_menuData["data"] as $arr_item)
        {
   ...
   <TABLE width="100%" class="scMenuHHeader">
    ...
    <?php
        escreveMenuMobile($mnu_cartera_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
