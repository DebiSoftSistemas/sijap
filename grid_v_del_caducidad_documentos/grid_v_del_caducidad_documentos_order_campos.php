...
<?php
   ...
   $Ord_Cmp = new grid_v_del_caducidad_documentos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_v_del_caducidad_documentos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_del_caducidad_documentos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_del_caducidad_documentos']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["ruc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_caducidad_documentos']['labels']["ruc"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_caducidad_documentos']['labels']["ruc"] : "" . $this->Nm_lang['lang_ruc'] . "";
   $tab_ger_campos['razon_social'] = "on";
   $tab_def_campos['razon_social'] = "razon_social";
   $tab_labels["razon_social"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_caducidad_documentos']['labels']["razon_social"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_caducidad_documentos']['labels']["razon_social"] : "" . $this->Nm_lang['lang_razon_social'] . "";
   $tab_ger_campos['serie'] = "on";
   $tab_def_campos['serie'] = "serie";
   $tab_labels["serie"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_caducidad_documentos']['labels']["serie"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_caducidad_documentos']['labels']["serie"] : "" . $this->Nm_lang['lang_serie_sri'] . "";
   $tab_ger_campos['telefono'] = "on";
   $tab_def_campos['telefono'] = "telefono";
   $tab_labels["telefono"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_caducidad_documentos']['labels']["telefono"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_caducidad_documentos']['labels']["telefono"] : "" . $this->Nm_lang['lang_lot_telefono'] . "";
   $tab_ger_campos['tipo_comprobante'] = "on";
   $tab_def_campos['tipo_comprobante'] = "tipo_comprobante";
   $tab_labels["tipo_comprobante"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_caducidad_documentos']['labels']["tipo_comprobante"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_caducidad_documentos']['labels']["tipo_comprobante"] : "" . $this->Nm_lang['lang_tipo_comprobante'] . "";
   $tab_ger_campos['fecha_caducidad'] = "on";
   $tab_def_campos['fecha_caducidad'] = "fecha_caducidad";
   $tab_labels["fecha_caducidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_caducidad_documentos']['labels']["fecha_caducidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_caducidad_documentos']['labels']["fecha_caducidad"] : "" . $this->Nm_lang['lang_fecha_caducidad'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_caducidad_documentos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_v_del_caducidad_documentos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_v_del_caducidad_documentos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_del_caducidad_documentos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_del_caducidad_documentos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_v_del_caducidad_documentos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_v_del_caducidad_documentos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_v_del_caducidad_documentos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_caducidad_documentos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_v_del_caducidad_documentos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_v_del_caducidad_documentos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_v_del_caducidad_documentos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_v_del_caducidad_documentos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_caducidad_documentos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_v_del_caducidad_documentos']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_caducidad_documentos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_v_del_caducidad_documentos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_v_del_caducidad_documentos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
