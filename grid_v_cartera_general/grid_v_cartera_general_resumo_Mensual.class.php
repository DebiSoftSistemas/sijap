...
SCEOT;
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_periodo_emision = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['arr_total']['periodo_emision'];
          $this->array_total_mes_emision = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['arr_total']['mes_emision'];
      }
      else
      {
          $this->array_total_periodo_emision = array();
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['summarizing_fields_order']['Mensual']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['summarizing_fields_order']['Mensual'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['summarizing_fields_order']['Mensual'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['summarizing_fields_display']['Mensual'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['summarizing_fields_display']['Mensual'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['summarizing_fields_display']['Mensual'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['summarizing_fields_display']['Mensual'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['summarizing_fields_display']['Mensual'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['summarizing_fields_display']['Mensual'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['summarizing_fields_display']['Mensual'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_periodo_emision as $i_periodo_emision => $d_periodo_emision) {
           if (!isset($i_periodo_emision, $this->comp_label[0]) || !in_array($i_periodo_emision, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_periodo_emision[5] ] = $d_periodo_emision[4];
               $this->comp_label[0][ $d_periodo_emision[5] ] = $d_periodo_emision[4];
           }
           foreach ($this->array_total_mes_emision[$i_periodo_emision] as $i_mes_emision => $d_mes_emision) {
               if (!isset($i_mes_emision, $this->comp_label[1][ $d_periodo_emision[5] ]) || !in_array($i_mes_emision, $this->comp_label[1][ $d_periodo_emision[5] ], true)) {
                   $this->comp_index[1][ $d_mes_emision[5] ] = $d_mes_emision[4];
                   $this->comp_label[1][ $d_periodo_emision[5] ][ $d_mes_emision[5] ] = $d_mes_emision[4];
               }
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'periodo_emision', 'prot' => ''),
           array('name' => 'mes_emision', 'prot' => '@aspass@'),
       );
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_periodo_emision => $l_periodo_emision) {
           if (isset($this->array_total_periodo_emision[$i_periodo_emision])) {
               $this->comp_group[$i_periodo_emision] = array();
           }
           foreach ($this->comp_label[1][$i_periodo_emision] as $i_mes_emision => $l_mes_emision) {
               if (isset($this->array_total_mes_emision[$i_periodo_emision][$i_mes_emision])) {
                   $this->comp_group[$i_periodo_emision][$i_mes_emision] = array();
               }
           }
       }
     }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_periodo_emision;
       }
       elseif (1 == $level) {
           $return = $this->array_total_mes_emision;
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      ...
      if (is_array($this->array_total_periodo_emision)) {
          ksort($this->array_total_periodo_emision);
      }
      if (is_array($this->array_total_mes_emision)) {
          ksort($this->array_total_mes_emision);
      }
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Ind_Groupby'];
...
{ 
   ...
   //---- 
   function adiciona_registro($sum_do_total, $sum_do_subtotal, $sum_do_valor_iva, $quebra_periodo_emision, $quebra_mes_emision, $quebra_periodo_emision_orig, $quebra_mes_emision_orig)
   {
      //----- periodo_emision
      if (!isset($this->array_total_periodo_emision[$quebra_periodo_emision_orig]))
      {
         $this->array_total_periodo_emision[$quebra_periodo_emision_orig][0] = 1;
         $this->array_total_periodo_emision[$quebra_periodo_emision_orig][1] = $sum_do_total;
         $this->array_total_periodo_emision[$quebra_periodo_emision_orig][2] = $sum_do_subtotal;
         $this->array_total_periodo_emision[$quebra_periodo_emision_orig][3] = $sum_do_valor_iva;
         $this->array_total_periodo_emision[$quebra_periodo_emision_orig][4] = $quebra_periodo_emision;
         $this->array_total_periodo_emision[$quebra_periodo_emision_orig][5] = $quebra_periodo_emision_orig;
      }
      else
      {
         $this->array_total_periodo_emision[$quebra_periodo_emision_orig][0]++;
         $this->array_total_periodo_emision[$quebra_periodo_emision_orig][1] = bcadd($this->array_total_periodo_emision[$quebra_periodo_emision_orig][1], $sum_do_total, 10);
         $this->array_total_periodo_emision[$quebra_periodo_emision_orig][2] = bcadd($this->array_total_periodo_emision[$quebra_periodo_emision_orig][2], $sum_do_subtotal, 10);
         $this->array_total_periodo_emision[$quebra_periodo_emision_orig][3] = bcadd($this->array_total_periodo_emision[$quebra_periodo_emision_orig][3], $sum_do_valor_iva, 10);
      }
      //----- mes_emision
      if (!isset($this->array_total_mes_emision[$quebra_periodo_emision_orig][$quebra_mes_emision_orig]))
      {
         $this->array_total_mes_emision[$quebra_periodo_emision_orig][$quebra_mes_emision_orig][0] = 1;
         $this->array_total_mes_emision[$quebra_periodo_emision_orig][$quebra_mes_emision_orig][1] = $sum_do_total;
         $this->array_total_mes_emision[$quebra_periodo_emision_orig][$quebra_mes_emision_orig][2] = $sum_do_subtotal;
         $this->array_total_mes_emision[$quebra_periodo_emision_orig][$quebra_mes_emision_orig][3] = $sum_do_valor_iva;
         $this->array_total_mes_emision[$quebra_periodo_emision_orig][$quebra_mes_emision_orig][4] = $quebra_mes_emision;
         $this->array_total_mes_emision[$quebra_periodo_emision_orig][$quebra_mes_emision_orig][5] = $quebra_mes_emision_orig;
      }
      else
      {
         $this->array_total_mes_emision[$quebra_periodo_emision_orig][$quebra_mes_emision_orig][0]++;
         $this->array_total_mes_emision[$quebra_periodo_emision_orig][$quebra_mes_emision_orig][1] = bcadd($this->array_total_mes_emision[$quebra_periodo_emision_orig][$quebra_mes_emision_orig][1], $sum_do_total, 10);
         $this->array_total_mes_emision[$quebra_periodo_emision_orig][$quebra_mes_emision_orig][2] = bcadd($this->array_total_mes_emision[$quebra_periodo_emision_orig][$quebra_mes_emision_orig][2], $sum_do_subtotal, 10);
         $this->array_total_mes_emision[$quebra_periodo_emision_orig][$quebra_mes_emision_orig][3] = bcadd($this->array_total_mes_emision[$quebra_periodo_emision_orig][$quebra_mes_emision_orig][3], $sum_do_valor_iva, 10);
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('Mensual', 'periodo_emision');
     $campos_order = $this->Ini->Get_date_order_groupby("periodo_emision", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('Mensual', 'mes_emision');
     $campos_order = $this->Ini->Get_date_order_groupby("mes_emision", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->look_con_id = $this->con_id; 
            $this->Lookup->lookup_con_id($this->look_con_id, $this->con_id) ; 
            $this->look_op_estado = $this->op_estado; 
            $this->Lookup->lookup_op_estado($this->look_op_estado, $this->op_estado) ; 
            $this->look_mes_emision = $this->mes_emision; 
            $this->Lookup->lookup_mes_emision($this->look_mes_emision, $this->mes_emision) ; 
            $this->periodo_emision_orig = $this->periodo_emision;
            $this->mes_emision_orig = $this->mes_emision;
            $this->con_ruta = $this->look_con_ruta ;
            $this->con_id = $this->look_con_id ;
            $this->op_estado = $this->look_op_estado ;
            $this->mes_emision = $this->look_mes_emision ;
            nmgp_Form_Num_Val($this->periodo_emision, "", ",", "0", "S", "2", "", "N:", "-") ; 
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->do_total, $this->do_subtotal, $this->do_valor_iva, $this->periodo_emision, $this->mes_emision, $this->periodo_emision_orig,  $this->mes_emision_orig);
            }
   }
//
