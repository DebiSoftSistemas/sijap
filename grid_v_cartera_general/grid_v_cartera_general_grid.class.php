<?php
class grid_v_cartera_general_grid
{
   var $Ini;
   var $Erro;
   var $Db;
...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_general']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_general']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_general']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['usr_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['usr_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['usr_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['grid_pesq'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['grid_pesq'] = array();
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['charts_html'] = '';
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida'])
   { 
   ...
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida'])
       { 
           include_once($this->Ini->path_embutida . "grid_v_cartera_general/" . $this->Ini->Apl_resumo); 
       } 
       else 
       { 
           include_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo); 
       } 
       $this->Res         = new grid_v_cartera_general_resumo();
       $this->Res->Db     = $this->Db;
       $this->Res->Erro   = $this->Erro;
       $this->Res->Ini    = $this->Ini;
       $this->Res->Lookup = $this->Lookup;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['pdf_res'])
       {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['proc_pdf_vert'])
            {
            } 
            else
            {
       ...
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_v_cartera_general'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'];
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_top();
       } 
       if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao_print'] != 'print')
       { 
           if ($this->Ini->grid_search_change_fil)
           { 
               $seq_search = 1;
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['grid_pesq'] as $cmp => $def)
               {
                  $Seq_grid      = $seq_search;
                  $Cmp_grid      = $cmp;
       ...
       unset ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['save_grid']);
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['pdf_res'] && (!isset($_GET['flash_graf']) || 'chart' != $_GET['flash_graf']))
       {
           $this->grid();
       }
       if ($nmgrp_apl_opcao != "pdf")
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['print_all'] && empty($this->nm_grid_sem_reg) && ($Gera_res || $Gera_graf))
       { 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] == "pdf")
       { 
           if (isset($_GET['flash_graf']) && 'chart' == $_GET['flash_graf'])
           {
               $this->Res->monta_resumo(true);
               require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
               $this->Graf  = new grid_v_cartera_general_grafico();
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] == "pdf")
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] == "pdf")
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] = "igual";
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'];
 }
...
//
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['orig_pesq'] = "grid";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['Ind_lig_mult'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['Ind_lig_mult'] = 0;
   }
   $this->Img_embbed      = false;
   $this->nm_data         = new nm_data("es");
   $this->pdf_label_group = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opc_pdf']['label_group'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opc_pdf']['label_group'] : "N";
   $this->pdf_all_cab     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opc_pdf']['all_cab']))     ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opc_pdf']['all_cab'] : "S";
   $this->pdf_all_label   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opc_pdf']['all_label']))   ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opc_pdf']['all_label'] : "S";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opc_liga']['fix_top'])) {
       $this->Fix_bar_top = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opc_liga']['fix_top'] == "S") ? true : false;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opc_liga']['fix_bot'])) {
       $this->Fix_bar_bottom = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opc_liga']['fix_bot'] == "S") ? true : false;
   }
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "grid_v_cartera_general/grid_v_cartera_general_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   foreach ($NM_css as $cada_css)
   {
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['doc_word'])
       { 
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['pesq_tab_label']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['pesq_tab_label'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['pesq_tab_label'] .= "op_fecha_emision?#?" . "" . $this->Ini->Nm_lang['lang_fecha_emision'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['pesq_tab_label'] .= "periodo_emision?#?" . "" . $this->Ini->Nm_lang['lang_periodo_emision'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['pesq_tab_label'] .= "mes_emision?#?" . "" . $this->Ini->Nm_lang['lang_mes_emision'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['pesq_tab_label'] .= "con_ruta?#?" . "" . $this->Ini->Nm_lang['lang_ruta'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['pesq_tab_label'] .= "con_id?#?" . "" . $this->Ini->Nm_lang['lang_numero_contrato'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['pesq_tab_label'] .= "cl_identificacion?#?" . "" . $this->Ini->Nm_lang['lang_lot_identificacion'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['pesq_tab_label'] .= "cl_nombre?#?" . "" . $this->Ini->Nm_lang['lang_cliente'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['pesq_tab_label'] .= "pro_codigo?#?" . "" . $this->Ini->Nm_lang['lang_codigo'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['pesq_tab_label'] .= "op_asiento?#?" . "" . $this->Ini->Nm_lang['lang_asiento_emision'] . "" . "?@?";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['grid_search_add']))
   {
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['pesq_tab_label'];
       ...
       $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['grid_search_add']['seq'];
       $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['grid_search_add']['cmp'];
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['grid_search_add']);
       exit;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['dyn_search_aut_comp']))
   {
       $Cmp_select2 = array("cl_identificacion","cl_nombre","op_asiento");
       $NM_func_aut_comp = "lookup_ajax_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['dyn_search_aut_comp']['cmp'];
       ...
       foreach ($nmgp_def_dados as $Ind => $Lista)
       {
          if (is_array($Lista))
          {
              foreach ($Lista as $Cod => $Valor)
              {
                  ...
                  if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['dyn_search_aut_comp']['cmp'], $Cmp_select2))
                  {
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['dyn_search_aut_comp']);
       exit;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida'] || $this->Ini->Embutida_iframe)
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['force_toolbar']);
   } 
       $this->Tem_tab_vert = false;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Ind_Groupby'] == "sc_free_group_by")
   {
       if (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Gb_Free_cmp']) > 1)
       {
           $this->width_tabula_quebra  = (((count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Gb_Free_cmp']) - 1) * 13) + 3) . "px";
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Ind_Groupby'] == "Mensual")
   {
       $this->width_tabula_quebra  = "16px";
       $this->width_tabula_display = "''";
       $this->Tem_tab_vert = true;
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_general']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_general']['lig_edit'] != '')
   {
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_general']['lig_edit'] == "on")  {$_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_general']['lig_edit'] = "S";}
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_general']['lig_edit'] == "off") {$_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_general']['lig_edit'] = "N";}
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_general']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['mostra_edit'] = "N";
       }
   }
   if ($this->Ini->SC_Link_View || ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opc_psq'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['psq_edit'] == 'N'))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['mostra_edit'] = "N";
   }
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree'] = 0;
   }
   elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['emb_tree_no']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['emb_tree_no'])
   { 
       $this->NM_emb_tree_no = true; 
   }
   $this->aba_iframe = false;
   $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['print_all'];
   if ($this->Print_All)
   {
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("grid_v_cartera_general", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_general']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_general']['btn_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_general']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
       {
           $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
       }
   }
   $this->Proc_link_res = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['where_resumo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['where_resumo'])) 
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['doc_word'] || $this->Ini->sc_export_ajax_img)
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['where_pesq_ant'];  
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['campos_busca']))
   { 
       $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['campos_busca'];
   ...
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['where_pesq_filtro'];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] = "muda_qt_linhas";
   } 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['dashboard_info']['maximized']) {
       $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['dashboard_info']['dashboard_app'];
       if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_v_cartera_general'])) {
           $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_v_cartera_general'];
   ...
   if ($this->Ini->Embutida_iframe) {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['sub_cons_iframe_btns'] as $BTN => $BTN_opc) {
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "grid_v_cartera_general/grid_v_cartera_general_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "grid_v_cartera_general_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   $this->Tot         = new grid_v_cartera_general_total($this->Ini->sc_page);
   $this->Tot->Db     = $this->Db;
   $this->Tot->Erro   = $this->Erro;
   $this->Tot->Ini    = $this->Ini;
   $this->Tot->Lookup = $this->Lookup;
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['qt_lin_grid'] = 10;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_general']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_general']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_general']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_general']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_general']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_general']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_general']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_general']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['qt_lin_grid']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Ind_Groupby'] == "sc_free_group_by") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_select']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_select'] = array(); 
           $Free_sql_atual = array();
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Gb_Free_sql'] as $cmp => $resto)
           {
           ...
           if (!isset($Free_sql_atual['periodo_emision']))
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_select']['periodo_emision'] = 'asc'; 
           } 
           $Free_sql_atual = array();
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Gb_Free_sql'] as $cmp => $resto)
           {
           ...
           if (!isset($Free_sql_atual['mes_emision']))
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_select']['mes_emision'] = 'asc'; 
           } 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_select_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_select']; 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Ind_Groupby'] == "Mensual") 
   {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Ind_Groupby'] == "sc_free_group_by") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_quebra'] = array(); 
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Gb_Free_sql'] as $cmp_var => $resto)
           {
               foreach ($resto as $SC_Sql_col => $SC_Sql_order)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_quebra'][$cmp_var][$SC_Sql_col] = $SC_Sql_order;
               }
           }
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Ind_Groupby'] == "Mensual") 
   {
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_quebra'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_quebra']['periodo_emision']["periodo_emision"] = "asc"; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_quebra']['mes_emision']["mes_emision"] = "asc"; 
       } 
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] = "inicio" ;  
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_grid'] = ""; 
                       $ordem = ($ordem == "asc") ? "desc" : "asc";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['prim_cons'] || !empty($nmgp_parms))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['prim_cons'] = false;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['where_orig'] = " where (op_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "')";  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['where_pesq_ant']    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['cond_pesq']         = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['where_pesq_filtro'] = "";
   }   
   if  (!empty($this->nm_where_dinamico)) 
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['where_pesq_filtro'];
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao']       = "igual" ; 
...
// 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['tot_geral'][1] ;  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] == "final" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['qt_reg_grid'] == "all") 
   { 
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['tot_geral'][1] ;  
       $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['tot_geral'][1];
   } 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['contr_total_geral'] = "NAO";
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['sc_total']);
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['contr_array_resumo']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['contr_array_resumo'] = "NAO";
       } 
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['tot_geral'][1] ;  
   $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['tot_geral'][1];
   ...
   { 
       ...
       $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['where_pesq']; 
       if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['where_pesq'])) 
       { 
           $nmgp_select .= " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['where_resumo']; 
       } 
       else
       { 
           $nmgp_select .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['where_resumo'] . ")"; 
       } 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['sc_total'] = $rt_grid->fields[0];  
       
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
   {
       $this->Ini->Qtd_reg_ajax_grid = $this->count_ger;
   }
   else
   {
       $this->Ini->Qtd_reg_ajax_grid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['qt_reg_grid'];
   }
//----- 
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
   { 
       $nmgp_select = "SELECT str_replace (convert(char(10),op_fecha_emision,102), '.', '-') + ' ' + convert(char(8),op_fecha_emision,20), cl_nombre, con_ruta, con_id, op_comentario, pro_descripcion, do_total, op_estado, periodo_emision, mes_emision, cl_identificacion, cl_telefono, cl_email, cl_direccion, pro_codigo, do_subtotal, do_valor_iva, op_asiento, mes_consumo from " . $this->Ini->nm_tabela; 
   } 
   elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
   { 
       $nmgp_select = "SELECT op_fecha_emision, cl_nombre, con_ruta, con_id, op_comentario, pro_descripcion, do_total, op_estado, periodo_emision, mes_emision, cl_identificacion, cl_telefono, cl_email, cl_direccion, pro_codigo, do_subtotal, do_valor_iva, op_asiento, mes_consumo from " . $this->Ini->nm_tabela; 
   } 
   elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
   { 
       $nmgp_select = "SELECT convert(char(23),op_fecha_emision,121), cl_nombre, con_ruta, con_id, op_comentario, pro_descripcion, do_total, op_estado, periodo_emision, mes_emision, cl_identificacion, cl_telefono, cl_email, cl_direccion, pro_codigo, do_subtotal, do_valor_iva, op_asiento, mes_consumo from " . $this->Ini->nm_tabela; 
   } 
   ...
   { 
       $nmgp_select = "SELECT EXTEND(op_fecha_emision, YEAR TO DAY), cl_nombre, con_ruta, con_id, op_comentario, pro_descripcion, do_total, op_estado, periodo_emision, mes_emision, cl_identificacion, cl_telefono, cl_email, cl_direccion, pro_codigo, do_subtotal, do_valor_iva, op_asiento, mes_consumo from " . $this->Ini->nm_tabela; 
   } 
   else 
   { 
       $nmgp_select = "SELECT op_fecha_emision, cl_nombre, con_ruta, con_id, op_comentario, pro_descripcion, do_total, op_estado, periodo_emision, mes_emision, cl_identificacion, cl_telefono, cl_email, cl_direccion, pro_codigo, do_subtotal, do_valor_iva, op_asiento, mes_consumo from " . $this->Ini->nm_tabela; 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_desc']; 
   } 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       ...
       $this->con_ruta = $this->rs_grid->fields[2] ;  
       $this->con_ruta = (string)$this->con_ruta;
       $this->con_id = $this->rs_grid->fields[3] ;  
       ...
       $this->mes_consumo = $this->rs_grid->fields[18] ;  
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Gb_Free_orig']))
       {
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Gb_Free_orig'] as $Cmp_clone => $Cmp_orig)
           {
       ...
       $GLOBALS["con_ruta"] = $this->rs_grid->fields[2] ;  
       $GLOBALS["con_ruta"] = (string)$GLOBALS["con_ruta"] ;
       $GLOBALS["con_id"] = $this->rs_grid->fields[3] ;  
       $GLOBALS["con_id"] = (string)$GLOBALS["con_id"] ;
       $GLOBALS["op_estado"] = $this->rs_grid->fields[7] ;  
       $GLOBALS["mes_emision"] = $this->rs_grid->fields[9] ;  
       $GLOBALS["mes_consumo"] = $this->rs_grid->fields[18] ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Ind_Groupby'] == "sc_free_group_by")
       {
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
           {
               $Cmp_orig = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Ind_Groupby'] == "sc_free_group_by") 
       {
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Gb_Free_cmp'] as $cmp => $sql)
           {
               $Cmp_orig   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Gb_Free_orig'][$cmp])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Gb_Free_orig'][$cmp] : $cmp;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Ind_Groupby'] == "Mensual") 
       {
           $this->periodo_emision_Old = $this->periodo_emision ; 
           $this->quebra_periodo_emision_Mensual($this->periodo_emision) ; 
           $this->mes_emision_Old = $this->mes_emision ; 
           $this->quebra_mes_emision_Mensual($this->periodo_emision, $this->mes_emision) ; 
       }
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['final']; 
   ...
   $this->NM_hidden_filters = ($this->Ini->Embutida_iframe && !empty($this->nm_grid_sem_reg) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['initialize']) ? true : false;
   $this->nmgp_reg_inicial  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['final'] + 1;
   $this->nmgp_reg_final    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['qt_reg_grid'];
   $this->nmgp_reg_final    = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['doc_word'] && !$this->Ini->sc_export_ajax)
       {
           require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
           $this->pb = new scProgressBar();
           $this->pb->setRoot($this->Ini->root);
           $this->pb->setDir($_SESSION['scriptcase']['grid_v_cartera_general']['glo_nm_path_imag_temp'] . "/");
           $this->pb->setProgressbarMd5($_GET['pbmd5']);
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['word_return']);
       ...
       if ($this->Ini->Proc_print && $this->Ini->Export_html_zip  && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['print_return']);
           $this->pb->setTotalSteps($this->count_ger);
       }
       if (!$this->Ini->sc_export_ajax && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_cartera_general'] ?> :: PDF</TITLE>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['pivot_charts']) : 0;
           ...
           if (-1 < $this->progress_grid)
           {
               ...
               grid_v_cartera_general_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
               grid_v_cartera_general_pdf_progress_call($this->Ini->path_js   . "\n", $this->Ini->Nm_lang);
               grid_v_cartera_general_pdf_progress_call($this->Ini->path_prod . "/img/\n", $this->Ini->Nm_lang);
               grid_v_cartera_general_pdf_progress_call($this->progress_tot   . "\n", $this->Ini->Nm_lang);
               ...
               grid_v_cartera_general_pdf_progress_call($this->progress_tot . "_#NM#_" . "1_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
       ...
       $nm_saida->saida("  <HEAD>\r\n");
       $nm_saida->saida("   <TITLE>" . $this->Ini->Nm_lang['lang_cartera_general'] . "</TITLE>\r\n");
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida'] && $this->NM_opcao != "pdf") {
           $nm_saida->saida("   <link rel=\"shortcut icon\" href=\"../_lib/img/usr__NM__img__NM__favicon.png\">\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ajax_nav'] && !$this->Ini->sc_export_ajax)
       { 
           ...
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_v_cartera_general_jquery_9289.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_v_cartera_general_ajax.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_v_cartera_general_message.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida']) {  
        ...
        <link rel='stylesheet' href='../_lib/lib/css/nm_mobile.css' type='text/css'/>
          <?php }
           ...
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['qt_reg_grid']) . ";\r\n");
           }
           ...
           $nm_saida->saida("    {\r\n");
           $nm_saida->saida("        let cells = $(\".sc-ui-grid-header-row-grid_v_cartera_general-1\").find(\"td\");\r\n");
           ...
           $nm_saida->saida("        rows = $(\".sc-ui-grid-header-row-grid_v_cartera_general-1\");\r\n");
           ...
           $nm_saida->saida("   var gridHeaders = $(\".sc-ui-grid-header-row-grid_v_cartera_general-1\"), headerDisplayed = true;\r\n");
           ...
           $nm_saida->saida("   tableOriginal = document.getElementById(\"sc-ui-grid-body-83f3d1fb\");\r\n");
           ...
           if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao_print'] != 'print' && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['grid_pesq']))
           { 
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ancor_save']);
           }
           $nm_saida->saida("   });\r\n");
...
$nm_saida->saida("}\r\n");
       ...
       $nm_saida->saida("<style type=\"text/css\">\r\n");
       $nm_saida->saida("</style>\r\n");
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['num_css']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['num_css'] = rand(0, 1000);
       }
       $write_css = true;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida'] && !$this->Print_All && $this->NM_opcao != "print" && $this->NM_opcao != "pdf")
       {
           $write_css = false;
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida_pdf']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida_pdf'])
       {
           $write_css = true;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_cartera_general_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida'])
       {
 ...
 { 
       ...
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_v_cartera_general_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_grid_v_cartera_general_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf") {
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_v_cartera_general/grid_v_cartera_general_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['proc_pdf_vert'])
  {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           ...
           if ($Pos1 !== false && $Pos2 !== false) {
               ...
               $cada_css = ".grid_v_cartera_general_" . substr(trim($Tag[0]), 1);
               if (isset($Tag[1])) {
                   $cada_css .= ", .grid_v_cartera_general_" . substr(trim($Tag[1]), 1);
               }
               $cada_css .= $Css;
           }
           else {
               $cada_css = ".grid_v_cartera_general_" . substr($cada_css, 1);
           }
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   $this->css_body_embutida = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['css_body_embutida'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['css_body_embutida'] : "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida'])
   { 
       if (!$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['doc_word'] && ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao_print'] == "print")) 
       {
           if ($this->Print_All) 
           {
               $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
       ...
       {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
          $vertical_center = '';
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$this->Print_All)
       { 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['css_body_embutida'])) {
       $remove_border = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['css_body_embutida'];
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['proc_pdf_vert'])
   {
   }
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_v_cartera_general']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_v_cartera_general']) . "_";
           } 
       } 
       else 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_v_cartera_general']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_v_cartera_general']) . "_";
           } 
       }
   }
   $temp_css  = explode("/", $compl_css);
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida']) ? "grid_v_cartera_general_" : "";
   $this->css_sep = " ";
...
//----- 
 function cabecalho_normal()
 {
   global
          $nm_saida;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['dashboard_info']['maximized'])
   {
       return; 
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opc_liga']['cab']))
   {
       return; 
   }
   if ($this->Ini->Embutida_iframe) {
   ...
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['where_pesq_filtro'];
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['cond_pesq']))
   {  
       $pos       = 0;
       $trab_pos  = false;
       $pos_tmp   = true; 
       $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['cond_pesq'];
       while ($pos_tmp)
       {
          $pos = strpos($tmp, "##*@@", $pos);
          if ($pos !== false)
       ...
       $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
       $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
       $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['cond_pesq'], 0, $trab_pos);
   ...
   $_SESSION['scriptcase']['grid_v_cartera_general']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['grid_v_cartera_general']['contr_erro'] = 'off';
   $this->nm_data->SetaData(date("Y/m/d H:i:s"), "YYYY/MM/DD HH:II:SS"); 
   $nm_saida->saida(" <TR id=\"sc_grid_head\">\r\n");
   $this->nm_data->SetaData(date("Y/m/d H:i:s"), "YYYY/MM/DD HH:II:SS");
   $sc_data_cab1 = $this->nm_data->FormataSaida("l, d @?#?@de F @?#?@de Y");
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['sv_dt_head']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['sv_dt_head'] = array();
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['sv_dt_head'] as $ind => $val)
   {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ajax_nav'] && $nm_refresch_cab_rod)
   { 
       $_SESSION['scriptcase']['saida_html'] = "";
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['sv_dt_head'][1] = $sc_data_cab1;
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['sv_dt_head']['fix'] = $nm_data_fixa;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf")
   { 
   ...
   { 
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['proc_pdf']) 
     { 
         $this->NM_calc_span();
           $nm_saida->saida("   <TD colspan=\"" . $this->NM_colspan . "\" class=\"" . $this->css_scGridTabelaTd . "\" style=\"vertical-align: top\">\r\n");
     } 
     else if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['proc_pdf_vert']) 
     {
   ...
   $nm_saida->saida("       <TR valign=\"middle\">\r\n");
   $nm_saida->saida("        <TD align=\"left\" class=\"" . $this->css_scGridHeaderFont . "\">\r\n");
   $nm_saida->saida("          " . $this->Ini->Nm_lang['lang_cartera_general'] . "\r\n");
   $nm_saida->saida("        </TD>\r\n");
   $nm_saida->saida("        <TD style=\"font-size: 5px\">\r\n");
   $nm_saida->saida("          &nbsp; &nbsp;\r\n");
   $nm_saida->saida("        </TD>\r\n");
...
// 
 function label_grid($linhas = 0)
 {
   ...
   $salva_htm_emb  = "";
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida_label'])
   { 
       $this->New_label['op_fecha_emision'] = "" . $this->Ini->Nm_lang['lang_fecha_emision'] . "";
       $this->New_label['cl_nombre'] = "" . $this->Ini->Nm_lang['lang_cliente'] . "";
       $this->New_label['con_ruta'] = "" . $this->Ini->Nm_lang['lang_ruta'] . "";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['exibe_titulos']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
   ...
   $nm_saida->saida("    <TR id=\"tit_grid_v_cartera_general__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-grid_v_cartera_general-" . $tmp_header_row . "\">\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida_label']) { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opc_psq']) { 
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['field_order'] as $Cada_label)
   { 
   ...
   $nm_saida->saida("</TR>\r\n");
             ...
             foreach ($NM_css as $cada_css)
             {
                 ...
                 if ($Pos1 !== false && $Pos2 !== false) {
                     ...
                     $css_emb .= $cada_css . $Css;
                       ...
                       $css_emb .= ".grid_v_cartera_general_" . substr($cada_css, 1);
                 }
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
     ...
     $NM_seq_lab = 1;
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['labels'] as $NM_cmp => $NM_lab)
     {
         if (empty($NM_lab) || $NM_lab == "&nbsp;")
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['labels'][$NM_cmp] = "No_Label" . $NM_seq_lab;
             $NM_seq_lab++;
         }
     } 
   } 
 ...
 function NM_label_op_fecha_emision()
 {
   ...
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != 'pdf') {
...
function SC_label_rightActionBar()
{
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_cmp'] == $fieldName) {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ordem_label'] == 'desc') {
                $sortRule = 'desc';
            } else {
                $sortRule = 'asc';
            }
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ini_cor_grid']);
       }
   }
...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['labels']['op_fecha_emision'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cl_nombre'])) ? $this->New_label['cl_nombre'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['labels']['cl_nombre'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['con_ruta'])) ? $this->New_label['con_ruta'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['labels']['con_ruta'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['con_id'])) ? $this->New_label['con_id'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['labels']['con_id'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['op_comentario'])) ? $this->New_label['op_comentario'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['labels']['op_comentario'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['pro_descripcion'])) ? $this->New_label['pro_descripcion'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['labels']['pro_descripcion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['do_total'])) ? $this->New_label['do_total'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['labels']['do_total'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['op_estado'])) ? $this->New_label['op_estado'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['labels']['op_estado'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['periodo_emision'])) ? $this->New_label['periodo_emision'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['labels']['periodo_emision'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['mes_emision'])) ? $this->New_label['mes_emision'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['labels']['mes_emision'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cl_identificacion'])) ? $this->New_label['cl_identificacion'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['labels']['cl_identificacion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cl_telefono'])) ? $this->New_label['cl_telefono'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['labels']['cl_telefono'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cl_email'])) ? $this->New_label['cl_email'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['labels']['cl_email'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cl_direccion'])) ? $this->New_label['cl_direccion'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['labels']['cl_direccion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['pro_codigo'])) ? $this->New_label['pro_codigo'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['labels']['pro_codigo'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['do_subtotal'])) ? $this->New_label['do_subtotal'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['labels']['do_subtotal'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['do_valor_iva'])) ? $this->New_label['do_valor_iva'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['labels']['do_valor_iva'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['op_asiento'])) ? $this->New_label['op_asiento'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['labels']['op_asiento'] = $SC_Label; 
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_general']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_general']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_v_cartera_general']['lig_edit'];
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_grid_v_cartera_general#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               ...
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['cab_embutida'] != "S")
               {
       ...
       else
       {
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['force_toolbar'] = true;
           } 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ajax_nav'])
           { 
               $_SESSION['scriptcase']['saida_html'] = "";
           } 
           $nm_saida->saida("  " . $this->nm_grid_sem_reg . "\r\n");
...
else
{
       ...
       $nm_id_aplicacao = " id=\"apl_grid_v_cartera_general#?#1\"";
   } 
   $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] == "pdf") ? "padding: 0px !important;" : "";
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['proc_pdf_vert'])
{
}
else
...
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['proc_pdf']) { 
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['proc_pdf']) { 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-83f3d1fb\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['proc_pdf_vert']) { 
    $nm_saida->saida("</thead>\r\n");
 }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['proc_pdf'] && $this->pdf_all_label != "S" && $this->pdf_label_group != "S") 
   { 
      $this->label_grid($linhas);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida_grid'])
...
// 
   ...
   $this->Break_pag_pdf['Mensual']['periodo_emision'] = "N";
   $this->Break_pag_prt['Mensual']['periodo_emision'] = "N";
   $this->Break_pag_pdf['Mensual']['mes_emision'] = "N";
   $this->Break_pag_prt['Mensual']['mes_emision'] = "N";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['Config_Page_break_PDF'] = "S";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['Page_break_PDF']))
   {
       if (isset($this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Ind_Groupby']]))
       {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Gb_Free_cmp'] as $Cmp_gb => $resto)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['Page_break_PDF'][$Cmp_gb] = $this->Break_pag_pdf['sc_free_group_by'][$Cmp_gb];
               }
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['Page_break_PDF'] = $this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Ind_Groupby']];
           }
       }
       else
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['Page_break_PDF'] = array();
       }
   }
   $this->SC_top       = array();
   $this->SC_bot       = array();
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Ind_Groupby'] == "sc_free_group_by") 
   {
       ...
       $this->Nivel_gbBot = count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Gb_Free_cmp']);
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Ind_Groupby'] == "Mensual") 
   {
       if (isset($this->periodo_emision))
       {
           $this->quebra_periodo_emision_Mensual_top(); 
       }
       if (isset($this->mes_emision))
       {
           $this->quebra_mes_emision_Mensual_top(); 
       }
       $this->nmgp_prim_pag_pdf = false;
   }
   ...
   $nm_houve_quebra = "N";
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          ...
          //---------- Gauge ----------
          if (!$this->Ini->sc_export_ajax && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
              if (0 == $this->progress_lim_now)
              {
               ...
               if (!NM_is_utf8($lang_protect))
               {
                  ...
                  grid_v_cartera_general_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $lang_protect . " " . $this->progress_now . "...\n", $this->Ini->Nm_lang);
          ...
          $this->arg_sum_op_asiento = " = " . $this->Db->qstr($this->op_asiento);
          $this->SC_seq_page++; 
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['final'] + 1; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['rows_emb']++;
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Ind_Groupby'] == "sc_free_group_by") 
          {  
              $SC_arg_Gby = array();
              ...
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Gb_Free_cmp'] as $cmp => $sql)
              {
                  $Format_tst = $this->Ini->Get_Gb_date_format('sc_free_group_by', $cmp);
                  $SC_arg_Sql[$cmp] = $sql;
                  $Fun_GB  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Gb_Free_orig'][$cmp])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Gb_Free_orig'][$cmp] : $cmp;
                  if (!empty($Format_tst))
                  {
                      $temp = $this->$cmp;
                      if (!empty($temp))
              ...
              foreach ($SC_lst_Gby as $Ind => $cmp)
              {
                  ...
                  $sql_where = "";
                  $cmp_qb     = $this->$cmp;
                  foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Gb_Free_cmp'] as $Col_Gb => $Sql)
                  {
                      $tmp        = "arg_sum_" . $Col_Gb;
                      $sql_where .= (!empty($sql_where)) ? " and " : "";
              ...
              {
                  $cmp = $SC_lst_Gby[0];
                  if ($this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['doc_word'] && $this->Break_pag_prt[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Ind_Groupby']][$cmp] == "S")
                  {
                      $this->nm_quebra_pagina("pagina"); 
                  }
                  elseif (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['Page_break_PDF'][$cmp] == "S")
                  {
                      $this->nm_quebra_pagina("pagina"); 
                  }
              }
          ...
          if ($this->periodo_emision !== $this->periodo_emision_Old && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Ind_Groupby'] == "Mensual") 
          {  
              if (isset($this->mes_emision_Old))
              {
                 $this->quebra_mes_emision_Mensual_bot() ; 
              }
              if (isset($this->periodo_emision_Old))
              {
                 $this->quebra_periodo_emision_Mensual_bot() ; 
              }
              if ($this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['doc_word'] && $this->Break_pag_prt[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Ind_Groupby']]['periodo_emision'] == "S")
              {
                  $this->nm_quebra_pagina("pagina"); 
              }
              elseif (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['Page_break_PDF']['periodo_emision'] == "S")
              {
                  $this->nm_quebra_pagina("pagina"); 
              }
              $this->mes_emision_Old = $this->mes_emision ; 
          ...
          if ($this->mes_emision !== $this->mes_emision_Old && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Ind_Groupby'] == "Mensual") 
          {  
              if (isset($this->mes_emision_Old))
              {
                 $this->quebra_mes_emision_Mensual_bot() ; 
              }
              if ($this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['doc_word'] && $this->Break_pag_prt[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Ind_Groupby']]['mes_emision'] == "S")
              {
                  $this->nm_quebra_pagina("pagina"); 
              }
              elseif (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['Page_break_PDF']['mes_emision'] == "S")
              {
                  $this->nm_quebra_pagina("pagina"); 
              }
              $this->mes_emision_Old = $this->mes_emision ; 
          ...
          else
          {
              ...
              {
                  if ($this->nm_inicio_pag == 0 && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida_grid'])
                  {
                      $nm_houve_quebra = "N";
                  } 
              } 
              elseif (($nm_houve_quebra == "S" || ($this->nm_inicio_pag == 0)) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida_grid'])
              { 
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida_opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['dado_psq_ret'];
 ...
 $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcapture", "document.Fpesq.nm_ret_psq.value='" . str_replace(array("'", '"'), array("\'", '\"'), $teste) . "'; nm_escreve_window();", "document.Fpesq.nm_ret_psq.value='" . str_replace(array("'", '"'), array("\'", '\"'), $teste) . "'; nm_escreve_window();", "", "Rad_psq", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
          ...
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['field_order'] as $Cada_col)
          { 
   ...
   $this->SC_grid_rightActionBar();
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
   ...
   { 
       ...
       if (isset($this->mes_emision_Old) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Ind_Groupby'] == "Mensual")
       {
           $this->quebra_mes_emision_Mensual_bot() ; 
       }
       if (isset($this->periodo_emision_Old) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Ind_Groupby'] == "Mensual")
       {
           $this->quebra_periodo_emision_Mensual_bot() ; 
       }
  
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['exibe_total'] == "S")
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Ind_Groupby'] . "_bot";
           $this->$Gb_geral() ;
       } 
   }  
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida_grid'])
...
function SC_grid_rightActionBar()
{
 ...
 function NM_grid_op_fecha_emision()
 {
      ...
      if (!isset($this->NM_cmp_hidden['op_fecha_emision']) || $this->NM_cmp_hidden['op_fecha_emision'] != "off") { 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida'] && !empty($conteudo)) 
          { 
 ...
 function NM_grid_cl_nombre()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['cl_nombre']) || $this->NM_cmp_hidden['cl_nombre'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
 ...
 function NM_grid_mes_emision()
 {
      ...
      if (!isset($this->NM_cmp_hidden['mes_emision']) || $this->NM_cmp_hidden['mes_emision'] != "off") { 
          ...
          $this->Lookup->lookup_mes_emision($conteudo , $this->mes_emision) ; 
          $str_tem_display = $conteudo;
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida'] && !empty($conteudo)) 
          { 
 ...
 function nm_quebra_pagina($nm_parms)
 {
    ...
    if (($this->Ini->nm_limite_lin > 0 && $this->Ini->nm_cont_lin > $this->Ini->nm_limite_lin) || $nm_parms == "pagina" || $nm_parms == "resumo" || $nm_parms == "total")
    {
        ...
        if ($this->Print_All)
        {
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['print_navigator']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['print_navigator'] == "Netscape")
            {
        ...
        if ($nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida'])
        {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['proc_pdf']) { 
           }
           else
           {
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['proc_pdf_vert']) { 
                $nm_saida->saida("     <thead>\r\n");
               }
               $this->cabecalho();
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['proc_pdf_vert']) { 
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['proc_pdf'] && ($this->pdf_all_cab == "S" || $this->pdf_all_label == "S")) { 
            $nm_saida->saida(" <thead> \r\n");
            if ($this->pdf_all_cab == "S")
            {
                $this->cabecalho();
            }
            if ($this->pdf_all_label == "S" && $nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida_grid'])
            {
                $this->label_grid();
            }
            $nm_saida->saida(" </thead> \r\n");
        }
        if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['proc_pdf'] && $nm_parms != "resumo" && $nm_parms != "pagina" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida_grid'])
        {
            $this->label_grid();
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['proc_pdf'] && $this->pdf_label_group != "S" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida_grid'])
        {
            $this->nm_inicio_pag = 0;
        }
    }
 ...
 function quebra_op_asiento_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   {
       $Temp_cmp_quebra[0]['lab'] = "" . $this->Ini->Nm_lang['lang_asiento_emision'] . ""; 
   }
   $this->$Cmps_Gb_Free = $Temp_cmp_quebra;
   $this->sc_proc_quebra_op_asiento = false; 
 } 
 function quebra_periodo_emision_Mensual($periodo_emision) 
 {
   global $tot_periodo_emision;
   $this->sc_proc_quebra_mes_emision = false;
   $this->sc_proc_quebra_periodo_emision = true; 
   $this->Tot->quebra_periodo_emision_Mensual($periodo_emision, $this->arg_sum_periodo_emision);
   $conteudo = $tot_periodo_emision[0] ;  
   $this->count_periodo_emision = $tot_periodo_emision[1];
   $this->sum_periodo_emision_do_total = $tot_periodo_emision[2];
   $this->sum_periodo_emision_do_subtotal = $tot_periodo_emision[3];
   $this->sum_periodo_emision_do_valor_iva = $tot_periodo_emision[4];
   $this->campos_quebra_periodo_emision = array(); 
   $conteudo = NM_encode_input(sc_strip_script($this->periodo_emision)); 
   nmgp_Form_Num_Val($conteudo, "", ",", "0", "S", "2", "", "N:", "-") ; 
   $this->campos_quebra_periodo_emision[0]['cmp'] = $conteudo; 
   if (isset($this->nmgp_label_quebras['periodo_emision']))
   {
       $this->campos_quebra_periodo_emision[0]['lab'] = $this->nmgp_label_quebras['periodo_emision']; 
   }
   else
   {
   $this->campos_quebra_periodo_emision[0]['lab'] = "" . $this->Ini->Nm_lang['lang_periodo_emision'] . ""; 
   }
   $this->sc_proc_quebra_periodo_emision = false; 
 } 
 function quebra_mes_emision_Mensual($periodo_emision, $mes_emision) 
 {
   global $tot_mes_emision;
   $this->sc_proc_quebra_periodo_emision = false;
   $this->sc_proc_quebra_mes_emision = true; 
   $this->Tot->quebra_mes_emision_Mensual($periodo_emision, $mes_emision, $this->arg_sum_periodo_emision, $this->arg_sum_mes_emision);
   $conteudo = $tot_mes_emision[0] ;  
   $this->count_mes_emision = $tot_mes_emision[1];
   $this->sum_mes_emision_do_total = $tot_mes_emision[2];
   $this->sum_mes_emision_do_subtotal = $tot_mes_emision[3];
   $this->sum_mes_emision_do_valor_iva = $tot_mes_emision[4];
   $this->campos_quebra_mes_emision = array(); 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
       $conteudo = NM_encode_input(sc_strip_script($this->mes_emision)); 
   }
   else {
   ...
   $this->Lookup->lookup_Mensual_mes_emision($conteudo , $this->mes_emision) ; 
   $this->campos_quebra_mes_emision[0]['cmp'] = $conteudo; 
   if (isset($this->nmgp_label_quebras['mes_emision']))
   {
       $this->campos_quebra_mes_emision[0]['lab'] = $this->nmgp_label_quebras['mes_emision']; 
   }
   else
   {
   $this->campos_quebra_mes_emision[0]['lab'] = "" . $this->Ini->Nm_lang['lang_mes_emision'] . ""; 
   }
   $this->sc_proc_quebra_mes_emision = false; 
 } 
 function quebra_op_fecha_emision_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   $tot_op_fecha_emision = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['op_fecha_emision'] : 0;
   ...
   $link_div   = "";
   $link_div_2 = "";
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree'];
       ...
       $link_div .= "<img id=\"b_open_grid_v_cartera_general_" . $this->NM_cont_body . "\" style=\"display:none\" onclick=\"document.getElementById('b_open_grid_v_cartera_general_" . $this->NM_cont_body . "').style.display = 'none'; document.getElementById('b_close_grid_v_cartera_general_" . $this->NM_cont_body . "').style.display = ''; NM_liga_tbody(" . $this->NM_cont_body . ", NM_tab_grid_v_cartera_general, 'grid_v_cartera_general'); return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_exp . "\">";
       $link_div .= "<img id=\"b_close_grid_v_cartera_general_" . $this->NM_cont_body . "\" style=\"display:''\" onclick=\"document.getElementById('b_close_grid_v_cartera_general_" . $this->NM_cont_body . "').style.display = 'none'; document.getElementById('b_open_grid_v_cartera_general_" . $this->NM_cont_body . "').style.display = ''; NM_apaga_tbody(" . $this->NM_cont_body . ", NM_tab_grid_v_cartera_general, 'grid_v_cartera_general'); return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_col . "\">";
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_general'][$this->NM_cont_body][$this->Tab_Nv_tree['op_fecha_emision']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_general_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   $this->NM_calc_span();
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['op_fecha_emision'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_general'][$this->NM_cont_body][$this->Tab_Nv_tree['op_fecha_emision']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_general_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
 ...
 function quebra_op_fecha_emision_sc_free_group_by_bot($Cmp_Name) 
 {
   ...
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['op_fecha_emision'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree'];
  ...
  foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
  {
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['field_order'] as $Cada_cmp)
   {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = false;
       $nm_saida->saida("    </TBODY>");
   }
 ...
 function quebra_periodo_emision_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_periodo_emision = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['periodo_emision'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_general'][$this->NM_cont_body][$this->Tab_Nv_tree['periodo_emision']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_general_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['periodo_emision'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_general'][$this->NM_cont_body][$this->Tab_Nv_tree['periodo_emision']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_general_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
           $this->NM_tbody_open = true;
       }
   }
 ...
 function quebra_periodo_emision_sc_free_group_by_bot($Cmp_Name) 
 {
   ...
   $NM_cmp_tot['do_valor_iva']['S'] = 4;
   $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . '');
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['periodo_emision'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree'];
 ...
 function quebra_mes_emision_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_mes_emision = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['mes_emision'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_general'][$this->NM_cont_body][$this->Tab_Nv_tree['mes_emision']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_general_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['mes_emision'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_general'][$this->NM_cont_body][$this->Tab_Nv_tree['mes_emision']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_general_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
           $this->NM_tbody_open = true;
       }
   }
 ...
 function quebra_mes_emision_sc_free_group_by_bot($Cmp_Name) 
 {
   ...
   $NM_cmp_tot['do_valor_iva']['S'] = 4;
   $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . '');
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['mes_emision'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree'];
 ...
 function quebra_cl_identificacion_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_cl_identificacion = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['cl_identificacion'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_general'][$this->NM_cont_body][$this->Tab_Nv_tree['cl_identificacion']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_general_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['cl_identificacion'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_general'][$this->NM_cont_body][$this->Tab_Nv_tree['cl_identificacion']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_general_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
           $this->NM_tbody_open = true;
       }
   }
 ...
 function quebra_cl_identificacion_sc_free_group_by_bot($Cmp_Name) 
 {
   ...
   $NM_cmp_tot['do_valor_iva']['S'] = 4;
   $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . '');
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['cl_identificacion'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree'];
 ...
 function quebra_cl_nombre_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_cl_nombre = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['cl_nombre'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_general'][$this->NM_cont_body][$this->Tab_Nv_tree['cl_nombre']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_general_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['cl_nombre'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_general'][$this->NM_cont_body][$this->Tab_Nv_tree['cl_nombre']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_general_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
           $this->NM_tbody_open = true;
       }
   }
 ...
 function quebra_cl_nombre_sc_free_group_by_bot($Cmp_Name) 
 {
   ...
   $NM_cmp_tot['do_valor_iva']['S'] = 4;
   $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . '');
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['cl_nombre'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree'];
 ...
 function quebra_pro_descripcion_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_pro_descripcion = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['pro_descripcion'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_general'][$this->NM_cont_body][$this->Tab_Nv_tree['pro_descripcion']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_general_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['pro_descripcion'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_general'][$this->NM_cont_body][$this->Tab_Nv_tree['pro_descripcion']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_general_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
           $this->NM_tbody_open = true;
       }
   }
 ...
 function quebra_pro_descripcion_sc_free_group_by_bot($Cmp_Name) 
 {
   ...
   $NM_cmp_tot['do_valor_iva']['S'] = 4;
   $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . '');
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['pro_descripcion'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree'];
 ...
 function quebra_con_ruta_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_con_ruta = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['con_ruta'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_general'][$this->NM_cont_body][$this->Tab_Nv_tree['con_ruta']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_general_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['con_ruta'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_general'][$this->NM_cont_body][$this->Tab_Nv_tree['con_ruta']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_general_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
           $this->NM_tbody_open = true;
       }
   }
 ...
 function quebra_con_ruta_sc_free_group_by_bot($Cmp_Name) 
 {
   ...
   $NM_cmp_tot['do_valor_iva']['S'] = 4;
   $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . '');
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['con_ruta'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree'];
 ...
 function quebra_op_estado_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_op_estado = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['op_estado'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_general'][$this->NM_cont_body][$this->Tab_Nv_tree['op_estado']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_general_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['op_estado'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_general'][$this->NM_cont_body][$this->Tab_Nv_tree['op_estado']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_general_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
           $this->NM_tbody_open = true;
       }
   }
 ...
 function quebra_op_estado_sc_free_group_by_bot($Cmp_Name) 
 {
   ...
   $NM_cmp_tot['do_valor_iva']['S'] = 4;
   $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . '');
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['op_estado'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree'];
 ...
 function quebra_con_id_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_con_id = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['con_id'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_general'][$this->NM_cont_body][$this->Tab_Nv_tree['con_id']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_general_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['con_id'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_general'][$this->NM_cont_body][$this->Tab_Nv_tree['con_id']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_general_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
           $this->NM_tbody_open = true;
       }
   }
 ...
 function quebra_con_id_sc_free_group_by_bot($Cmp_Name) 
 {
   ...
   $NM_cmp_tot['do_valor_iva']['S'] = 4;
   $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . '');
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['con_id'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree'];
 ...
 function quebra_op_asiento_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_op_asiento = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['op_asiento'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_general'][$this->NM_cont_body][$this->Tab_Nv_tree['op_asiento']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_general_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['op_asiento'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_general'][$this->NM_cont_body][$this->Tab_Nv_tree['op_asiento']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_general_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
           $this->NM_tbody_open = true;
       }
   }
 ...
 function quebra_op_asiento_sc_free_group_by_bot($Cmp_Name) 
 {
   ...
   $NM_cmp_tot['do_valor_iva']['S'] = 4;
   $NM_tipos_tot = array('S' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . '');
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['op_asiento'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree'];
 ...
 function quebra_periodo_emision_Mensual_top() 
 { global
          $periodo_emision_ant_desc, 
          $nm_saida, $tot_periodo_emision;
   $this->SC_tab_quebra = 0;
   $periodo_emision_ant_desc = $this->campos_quebra_periodo_emision[0]['cmp'];
   static $cont_quebra_periodo_emision = 0; 
   $cont_quebra_periodo_emision++;
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_old = "";
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_general'][$this->NM_cont_body]['1'] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_general_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] == "pdf" && !$this->Print_All)
   {
       $nm_nivel_book_pdf = "<div style=\"height:1px;overflow:hidden\"><H2 style=\"font-size:0;padding:1px\">" .  $this->campos_quebra_periodo_emision[0]['cmp'] ;
       $nm_fecha_pdf_new = "</H2></div>";
   }
   $conteudo = $tot_periodo_emision[0] ;  
    $thisColspan = 2;
   $colspan = $this->NM_colspan;
   $this->Label_periodo_emision = "<table>"; 
   foreach ($this->campos_quebra_periodo_emision as $cada_campo) 
   { 
       $this->Label_periodo_emision .= "<tr>"; 
       $this->Label_periodo_emision .= "<td>" . $cada_campo['lab'] . "</td><td> => </td>";
       $this->Label_periodo_emision .= "<td>" . $cada_campo['cmp'] . "</td>";
 ...
 function quebra_periodo_emision_Mensual_bot() 
 { global 
          $periodo_emision_ant_desc, 
          $nm_saida, $tot_periodo_emision;
   $NM_cmp_tot['do_total']['S'] = 2;
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_general'][$this->NM_cont_body]['1'] = 'bot';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_general_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['rows_emb']++;
   $periodo_emision_ant_desc = $this->campos_quebra_periodo_emision[0]['cmp'];
 ...
 function quebra_mes_emision_Mensual_top() 
 { global
          $mes_emision_ant_desc, 
          $nm_saida, $tot_mes_emision;
   $this->SC_tab_quebra = 10;
   $mes_emision_ant_desc = $this->campos_quebra_mes_emision[0]['cmp'];
   static $cont_quebra_mes_emision = 0; 
   $cont_quebra_mes_emision++;
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_old = "";
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_general'][$this->NM_cont_body]['2'] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_general_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] == "pdf" && !$this->Print_All)
   {
       $nm_nivel_book_pdf = "<div style=\"height:1px;overflow:hidden\"><H3 style=\"font-size:0;padding:1px\">" .  $this->campos_quebra_mes_emision[0]['cmp'] ;
       $nm_fecha_pdf_new = "</H3></div>";
   }
   $conteudo = $tot_mes_emision[0] ;  
    $thisColspan = 2;
   $colspan = $this->NM_colspan;
   $this->Label_mes_emision = "<table>"; 
   foreach ($this->campos_quebra_mes_emision as $cada_campo) 
   { 
       $this->Label_mes_emision .= "<tr>"; 
       $this->Label_mes_emision .= "<td>" . $cada_campo['lab'] . "</td><td> => </td>";
       $this->Label_mes_emision .= "<td>" . $cada_campo['cmp'] . "</td>";
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ind_tree'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_v_cartera_general'][$this->NM_cont_body]['2'] = 'bot';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_v_cartera_general_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
       $this->NM_tbody_open = true;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida_grid'] && $this->nm_prim_linha)
 ...
 function quebra_mes_emision_Mensual_bot() 
 { global 
          $mes_emision_ant_desc, 
          $nm_saida, $tot_mes_emision;
   $NM_cmp_tot['do_total']['S'] = 2;
 ...
 function quebra_geral_sc_free_group_by_bot() 
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] == "pdf" && !$this->Print_All)
   {
      $nm_nivel_book_pdf = "<div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">" .  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['tot_geral'][0] . "</H1></div>";
   }
   $tit_lin_sumariza      =  $nm_nivel_book_pdf . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['tot_geral'][1] . ")";
   $tit_lin_sumariza_orig =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['tot_geral'][1] . ")";
  ...
  foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
  {
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['field_order'] as $Cada_cmp)
   {
    ...
    if ($Cada_cmp == "do_total" && (!isset($this->NM_cmp_hidden['do_total']) || $this->NM_cmp_hidden['do_total'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['do_total'][$Tipo_Sum]))
      {
          $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['tot_geral'][$NM_cmp_tot['do_total'][$Tipo_Sum]] ; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "do_subtotal" && (!isset($this->NM_cmp_hidden['do_subtotal']) || $this->NM_cmp_hidden['do_subtotal'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['do_subtotal'][$Tipo_Sum]))
      {
          $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['tot_geral'][$NM_cmp_tot['do_subtotal'][$Tipo_Sum]] ; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
    ...
    if ($Cada_cmp == "do_valor_iva" && (!isset($this->NM_cmp_hidden['do_valor_iva']) || $this->NM_cmp_hidden['do_valor_iva'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['do_valor_iva'][$Tipo_Sum]))
      {
          $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['tot_geral'][$NM_cmp_tot['do_valor_iva'][$Tipo_Sum]] ; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, "", ".", "0", "S", "2", "", "N:1", "-") ; 
          }
...
$nm_saida->saida("    </style>\r\n");
      ...
      if ($this->nmgp_botoes['group_1'] == "on" && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("           $Cod_Btn\r\n");
      if ($this->nmgp_botoes['pdf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
      $Tem_gb_pdf  = "s";
      $Tem_pdf_res = "n";
      $Tem_pdf_res = "s";
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Gb_Free_cmp']))
      {
          $Tem_pdf_res = "n";
      }
              $this->nm_btn_exist['pdf'][] = "pdf_top";
          $nm_saida->saida("            <div id=\"div_pdf_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "pdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + P)", "thickbox", "" . $this->Ini->path_link . "grid_v_cartera_general/grid_v_cartera_general_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=8&lpapel=279&apapel=216&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&sc_ver_93=s&nm_tem_gb=" . $Tem_gb_pdf . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_pdf_res=grid,resume&nm_all_modules=grid,resume&nm_label_group=N&nm_all_cab=S&nm_all_label=S&nm_orient_grid=2&password=n&summary_export_columns=S&pdf_zip=N&origem=cons&language=es&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_v_cartera_general&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_word_res = "n";
          $Tem_word_res = "s";
          ...
          $nm_saida->saida("            <div id=\"div_word_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "grid_v_cartera_general/grid_v_cartera_general_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=" . $Tem_word_res . "&nm_ini_word_res=grid,resume&nm_all_modules=grid,resume&password=n&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_xls_res = "n";
          $Tem_xls_res = "s";
          ...
          $nm_saida->saida("            <div id=\"div_xls_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "xls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_v_cartera_general/grid_v_cartera_general_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_v_cartera_general&nm_tp_xls=xlsx&nm_tot_xls=S&nm_res_cons=" . $Tem_xls_res . "&nm_ini_xls_res=grid,resume&nm_all_modules=grid,resume&password=n&summary_export_columns=S&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['print'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Tem_pdf_res = "n";
          $Tem_pdf_res = "s";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Gb_Free_cmp']))
          ...
          $nm_saida->saida("            <div id=\"div_print_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "print_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + P)", "thickbox", "" . $this->Ini->path_link . "grid_v_cartera_general/grid_v_cartera_general_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=RC&nm_cor=CO&password=n&language=es&nm_page=" . NM_encode_input($this->Ini->sc_page) . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_prt_res=grid,resume&nm_all_modules=grid,resume&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['sel_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      $pos_path = strrpos($this->Ini->path_prod, "/");
      $path_fields = $this->Ini->root . substr($this->Ini->path_prod, 0, $pos_path) . "/conf/fields/";
              $this->nm_btn_exist['sel_col'][] = "selcmp_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcolumns", "scBtnSelCamposShow('" . $this->Ini->path_link . "grid_v_cartera_general/grid_v_cartera_general_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnSelCamposShow('" . $this->Ini->path_link . "grid_v_cartera_general/grid_v_cartera_general_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "selcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Groupby_hide']))
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_v_cartera_general/grid_v_cartera_general_sel_groupby.php?opc_ret=igual&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_v_cartera_general/grid_v_cartera_general_sel_groupby.php?opc_ret=igual&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
          }
      }
          if ($this->nmgp_botoes['summary'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
          {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['SC_Gb_Free_cmp']))
            { }
            else {
          ...
          if (is_file("grid_v_cartera_general_help.txt") && !$this->grid_emb_form)
          {
             $Arq_WebHelp = file("grid_v_cartera_general_help.txt"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['dashboard_info']['under_dashboard']))
      {
         $this->nmgp_botoes['exit'] = "off"; 
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opc_psq'])
      ...
      {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['sc_modal'])
        {
...
$nm_saida->saida("    </style>\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao_print'] != "print") 
      {
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['qtline'] == "on" && $this->Ini->Apl_paginacao != "FULL")
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['qt_lin_grid'] == '10') ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['qt_lin_grid'] == '20') ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['qt_lin_grid'] == '50') ? " selected" : "";
              $nm_saida->saida("           <option value=\"50\" " . $obj_sel . ">50</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['qt_lin_grid'] == 'all') ? " selected" : "";
      ...
      if (is_file($this->Ini->root . $this->Ini->path_img_global . $this->Ini->Img_sep_grid))
      {
          ...
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opc_liga']['nav']))
          {
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['navpage'] == "on" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opc_liga']['nav']) && $this->Ini->Apl_paginacao != "FULL" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['qt_lin_grid'] != "all")
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['qt_lin_grid'];
              $Max_link   = 5;
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opc_liga']['nav']))
          {
...
$nm_saida->saida("    </style>\r\n");
   ...
   function html_grid_search()
   {
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['grid_pesq'])?'none':'';
       if(!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ajax_nav'])
       {
          $nm_saida->saida("   <tr id=\"NM_Grid_Search\" ajax='' style='display:" . $str_display . "'>\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['grid_pesq']))
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['grid_pesq'] as $cmp => $def)
           {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['save_grid']))
           {
               return;
           }
           else
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['save_grid']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['grid_pesq']))
           { 
   ...
   function grid_search_add_tag()
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['grid_pesq']) && count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['grid_pesq']) < 9)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
   ...
   function grid_search_periodo_emision($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['psq_check_ret']['periodo_emision'] = array();
       $periodo_emision_look = (is_string($periodo_emision) ? substr($this->Db->qstr($periodo_emision), 1, -1) : $periodo_emision); 
       $nmgp_def_dados  = ""; 
       $nm_comando = "select distinct periodo_emision from " . $this->Ini->nm_tabela . " where (op_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') order by periodo_emision"; 
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['psq_check_ret']['periodo_emision'][] = trim($rs->fields[0]);
   ...
   function grid_search_mes_emision($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['psq_check_ret']['mes_emision'] = array();
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['psq_check_ret']['mes_emision'][] = trim($rs->fields[0]);
   ...
   function grid_search_con_ruta($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['psq_check_ret']['con_ruta'] = array();
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['psq_check_ret']['con_ruta'][] = trim($rs->fields[0]);
             $nmgp_def_dados .= trim($rs->fields[1]) . "?#?"; 
             $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?"; 
             $rs->MoveNext(); 
          } 
   ...
   function grid_search_con_id($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['psq_check_ret']['con_id'] = array();
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['psq_check_ret']['con_id'][] = trim($rs->fields[0]);
             $nmgp_def_dados .= trim($rs->fields[1]) . "?#?"; 
             $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?"; 
             $rs->MoveNext(); 
          } 
   ...
   function grid_search_cl_identificacion($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $nm_comando = "select distinct cl_identificacion from " . $this->Ini->nm_tabela . " where (op_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') and cl_identificacion = '$cl_identificacion_look' order by cl_identificacion"; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function grid_search_cl_nombre($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct cl_nombre from " . $this->Ini->nm_tabela . " where (op_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') and cl_nombre = '$cl_nombre_look' order by cl_nombre"; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
   ...
   function grid_search_pro_codigo($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['psq_check_ret']['pro_codigo'] = array();
       $pro_codigo_look = (is_string($pro_codigo) ? substr($this->Db->qstr($pro_codigo), 1, -1) : $pro_codigo); 
       $nmgp_def_dados  = ""; 
       $nm_comando = "SELECT pro_codigo, pro_descripcion FROM del_producto  where pro_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "' ORDER BY pro_codigo"; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['psq_check_ret']['pro_codigo'][] = trim($rs->fields[0]);
       ...
       $lin_obj .= "   <table style=\"padding: 0px; spacing: 0px; border-width: 0px;\"><tr><td>";
       $lin_obj .= "    <input id='grid_search_pro_codigo_val_" . $ind . "' name='val_grid_search_pro_codigo_" . $ind . "' type='hidden' value=''>";
       $lin_obj .= "    <SELECT class='" . $this->css_scAppDivToolbarInput . "' style='height : auto;' id=\"grid_search_pro_codigo_val_" . $ind . "_orig\" name=\"val_grid_search_pro_codigo_" . $ind . "_orig\" size=7 multiple onDblClick=\"nm_add_sel_Grid('grid_search_pro_codigo_val_" . $ind . "_orig', 'grid_search_pro_codigo_val_" . $ind . "_dest', 'N')\">";
       $delimitador = "##@@";
       $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
       $nm_opcoes  = explode("?@?", $nm_opcoesx);
       $val = isset($val[0]) ? $val[0] : array();
          ...
          if (!empty($nm_opcao))
          {
             ...
             if (is_array($val) && !empty($val))
             {
                ...
                foreach ($val as $Dados)
                {
                    ...
                    if ($Dados === $nm_opc_cod)
                    {
                        $pro_codigo_sel = " disabled =\"disabled\" style=\"color: #A0A0A0\"";
                        break;
                    }
                }
             }
       ...
       $lin_obj .= "   <td align=\"center\">";
       $lin_obj .= "   <div class='scBtnPassField'>";
       $lin_obj .= nmButtonOutput($this->arr_buttons, "bpassfld_rightall", "nm_add_all_Grid('grid_search_pro_codigo_val_" . $ind . "_orig', 'grid_search_pro_codigo_val_" . $ind . "_dest', 'N');", "nm_add_all_Grid('grid_search_pro_codigo_val_" . $ind . "_orig', 'grid_search_pro_codigo_val_" . $ind . "_dest', 'N');", "G_Bbpassfld_rightall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");

       $lin_obj .= "   </div>";
       $lin_obj .= "   <div class='scBtnPassField'>";
       $lin_obj .= nmButtonOutput($this->arr_buttons, "bpassfld_right", "nm_add_sel_Grid('grid_search_pro_codigo_val_" . $ind . "_orig', 'grid_search_pro_codigo_val_" . $ind . "_dest', 'N');", "nm_add_sel_Grid('grid_search_pro_codigo_val_" . $ind . "_orig', 'grid_search_pro_codigo_val_" . $ind . "_dest', 'N');", "G_Bbpassfld_righ", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");

       $lin_obj .= "   </div>";
       $lin_obj .= "   <div class='scBtnPassField'>";
       $lin_obj .= nmButtonOutput($this->arr_buttons, "bpassfld_left", "nm_del_sel_Grid('grid_search_pro_codigo_val_" . $ind . "_dest', 'grid_search_pro_codigo_val_" . $ind . "_orig', 'N');", "nm_del_sel_Grid('grid_search_pro_codigo_val_" . $ind . "_dest', 'grid_search_pro_codigo_val_" . $ind . "_orig', 'N');", "G_Bbpassfld_left", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");

       $lin_obj .= "   </div>";
       $lin_obj .= "   <div class='scBtnPassField'>";
       $lin_obj .= nmButtonOutput($this->arr_buttons, "bpassfld_leftall", "nm_del_all_Grid('grid_search_pro_codigo_val_" . $ind . "_dest', 'grid_search_pro_codigo_val_" . $ind . "_orig', 'N');", "nm_del_all_Grid('grid_search_pro_codigo_val_" . $ind . "_dest', 'grid_search_pro_codigo_val_" . $ind . "_orig', 'N');", "G_Bbpassfld_leftall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");

       $lin_obj .= "   </div>";
       $lin_obj .= "   </td>";
       $lin_obj .= "   <td>";
       $lin_obj .= "    <SELECT class='" . $this->css_scAppDivToolbarInput . "' style='height : auto;' id=\"grid_search_pro_codigo_val_" . $ind . "_dest\" name=\"val_grid_search_pro_codigo_" . $ind . "_dest\" size=7 multiple onDblClick=\"nm_del_sel_Grid('grid_search_pro_codigo_val_" . $ind . "_dest', 'grid_search_pro_codigo_val_" . $ind . "_orig', 'N')\">";
       $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
       $nm_opcoes  = explode("?@?", $nm_opcoesx);
       foreach ($nm_opcoes as $nm_opcao)
       {
   ...
   function grid_search_op_asiento($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct op_asiento from " . $this->Ini->nm_tabela . " where (op_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') and op_asiento = '$op_asiento_look' order by op_asiento"; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
   ...
   function lookup_ajax_cl_identificacion($cl_identificacion)
   {
       ...
       $cl_identificacion_look = (is_string($cl_identificacion) ? substr($this->Db->qstr($cl_identificacion), 1, -1) : $cl_identificacion); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct cl_identificacion from " . $this->Ini->nm_tabela . " where (op_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') and  cl_identificacion like '" . $cl_identificacion . "%' order by cl_identificacion"; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
          ...
          { 
            ...
            $cmp1 = grid_v_cartera_general_pack_protect_string($cmp1);
            $nmgp_def_dados[] = array($cmp1 => $cmp1); 
             $rs->MoveNext(); 
          } 
          $rs->Close(); 
   ...
   function lookup_ajax_cl_nombre($cl_nombre)
   {
       ...
       $cl_nombre_look = (is_string($cl_nombre) ? substr($this->Db->qstr($cl_nombre), 1, -1) : $cl_nombre); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct cl_nombre from " . $this->Ini->nm_tabela . " where (op_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') and  cl_nombre like '" . $cl_nombre . "%' order by cl_nombre"; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
   ...
   function lookup_ajax_op_asiento($op_asiento)
   {
       ...
       $op_asiento_look = (is_string($op_asiento) ? substr($this->Db->qstr($op_asiento), 1, -1) : $op_asiento); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct op_asiento from " . $this->Ini->nm_tabela . " where (op_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "') and  op_asiento like '%" . $op_asiento . "%' order by op_asiento"; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "SIJAP/grid_v_cartera_general";
   ...
   function JS_grid_search()
   {
       ...
       $nm_saida->saida(" function sc_grid_v_cartera_general_valida_mes(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida(" function sc_grid_v_cartera_general_valida_dia(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['op_fecha_emision_mes'] =  'sc_grid_v_cartera_general_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['op_fecha_emision_dia'] =  'sc_grid_v_cartera_general_valida_dia(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['op_fecha_emision_v2__mes'] =  'sc_grid_v_cartera_general_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['op_fecha_emision_v2__dia'] =  'sc_grid_v_cartera_general_valida_dia(this)';\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ajax_nav'])
       { 
           ...
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['op_fecha_emision_mes']", 'value' => 'sc_grid_v_cartera_general_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['op_fecha_emision_dia']", 'value' => 'sc_grid_v_cartera_general_valida_dia(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['op_fecha_emision_v2__mes']", 'value' => 'sc_grid_v_cartera_general_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['op_fecha_emision_v2__dia']", 'value' => 'sc_grid_v_cartera_general_valida_dia(this)');
       } 
    ...
    function getFieldHighlight($filter_type, $field, $str_value, $str_value_original='')
    {
        ...
        {
            if (
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['campos_busca'][ $field ]) &&
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['campos_busca'][ $field . "_cond" ]) &&
                !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['campos_busca'][ $field ]) &&
                (
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['campos_busca'][ $field . "_cond"] == 'qp' ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['campos_busca'][ $field . "_cond"] == 'eq' ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['campos_busca'][ $field . "_cond"] == 'ii'
                )
            )
            {
                if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['campos_busca'][ $field . "_cond"] == 'qp')
                {
                    if(is_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['campos_busca'][ $field ]))
                    {
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['campos_busca'][ $field ] as $ind => $vals)
                        {
                    ...
                    {
                        if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['campos_busca'][ $field ], $str_value) == 0)
                        {
                            $str_value = $str_html_ini. $str_value .$str_html_fim;
                        }
                        elseif(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['campos_busca'][ $field ], $str_value_original) == 0)
                        {
                            $str_value = $str_html_ini. $str_value .$str_html_fim;
                        }
                        else
                        {
                            $keywords = preg_quote($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['campos_busca'][ $field ], '/');
                            $str_value = preg_replace('/'. $keywords .'/i', $str_html_ini . '$0' . $str_html_fim, $str_value);
                        }
                    }
                }
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['campos_busca'][ $field . "_cond"] == 'eq')
                {
                    if(is_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['campos_busca'][ $field ]))
                    {
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['campos_busca'][ $field ] as $ind => $vals)
                ...
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['campos_busca'][ $field . "_cond"] == 'ii')
                {
                    if(is_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['campos_busca'][ $field ]))
                    {
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['campos_busca'][ $field ] as $ind => $vals)
                    ...
                    {
                        if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['campos_busca'][ $field ], substr($str_value, 0, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['campos_busca'][ $field ]))) == 0)
                        {
                            $str_value = $str_html_ini. substr($str_value, 0, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['campos_busca'][ $field ])) .$str_html_fim . substr($str_value, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['campos_busca'][ $field ]));
                        }
                    }
                }
            }
        ...
        {
            if(
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['fast_search'][0]) &&
                (
                    (
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['fast_search'][0] == 'SC_all_Cmp' &&
                    in_array($field, array(''))
                    ) ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['fast_search'][0] == $field ||
                    strpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['fast_search'][0], $field . '_VLS_') !== false ||
                    strpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['fast_search'][0], '_VLS_' . $field) !== false
                )
            )
            {
                if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['fast_search'][1] == 'qp')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['fast_search'][2], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    elseif(!empty($str_value_original) && $str_value_original != '&nbsp;' && strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['fast_search'][2], $str_value_original) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    else
                    {
                        $keywords = preg_quote($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['fast_search'][2], '/');
                        $str_value = preg_replace('/'. $keywords .'/i', $str_html_ini . '$0' . $str_html_fim, $str_value);
                    }
                }
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['fast_search'][1] == 'eq')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['fast_search'][2], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   ...
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
       $nm_saida->saida("   document.getElementById('first_bot').disabled = true;\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['ajax_nav'])
       {
   ...
   $nm_saida->saida("   if (typeof(scSetFixedHeaders) === typeof(function(){})) scSetFixedHeaders();\r\n");
   $nm_saida->saida("  });\r\n");
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
               $nm_saida->saida("   document.getElementById('forward_bot').disabled = true;\r\n");
               $nm_saida->saida("   document.getElementById('forward_bot').className = \"scButton_" . $this->arr_buttons['bcons_avanca']['style'] . " disabled\";\r\n");
   ...
   if ($this->grid_emb_form || $this->grid_emb_form_full)
   {
       ...
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_v_cartera_general', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"grid_v_cartera_general\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"grid_v_cartera_general_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("                     action=\"grid_v_cartera_general_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_v_cartera_general/grid_v_cartera_general_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
   ...
   $nm_saida->saida("           document.Fdoc_word.action = \"grid_v_cartera_general_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("           document.F3.SC_module_export.value = z;\r\n");
   $nm_saida->saida("       }\r\n");
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['grid_v_cartera_general_iframe_params'] = array(
   ...
   $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_v_cartera_general@SC_par@" . md5($prep_parm_pdf);
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   $nm_saida->saida("               document.Fpdf.action=\"grid_v_cartera_general_iframe.php\";\r\n");
   ...
   $nm_saida->saida("               document.Fprint.action = \"grid_v_cartera_general_export_ctrl.php\";\r\n");
   $nm_saida->saida("           }\r\n");
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   ...
   $nm_saida->saida("           document.Fexport.action = \"grid_v_cartera_general_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['campo_psq_ret']) )
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['grid_v_cartera_general']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form  = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Form1 = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("           var Obj_Doc   = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form  = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Form1 = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("          var Obj_Doc   = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form  = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Form1 = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['campo_psq_ret']) . ";\r\n");
          $nm_saida->saida("          var Obj_Doc   = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"grid_v_cartera_general_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general']['reg_start']))
   {
       $nm_saida->saida("      $(document).ready(function(){\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailStatus('grid_v_cartera_general')\",50);\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_v_cartera_general', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      })\r\n");
   }
