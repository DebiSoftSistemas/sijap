...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_v_cartera_general"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_v_cartera_general"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_v_cartera_general']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_v_cartera_general']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_v_cartera_general']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_v_cartera_general']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_v_cartera_general']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_v_cartera_general</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_v_cartera_general']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_v_cartera_general']['embutida_filho'] as $ind => $sc_init)
          {
