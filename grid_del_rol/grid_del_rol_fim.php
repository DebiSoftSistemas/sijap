...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_del_rol"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_del_rol"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_del_rol'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_del_rol']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_del_rol']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_del_rol']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_del_rol']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_del_rol']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_del_rol']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_del_rol']['embutida_filho'] as $ind => $sc_init)
          {
