  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sri_fechas_iva_diferenciado" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sri_fechas_iva_diferenciado_form();
	}
...
?>
  ...
  // ---------- Validate fid_fecha_
  function do_ajax_form_sri_fechas_iva_diferenciado_validate_fid_fecha_(iNumLinha)
  {
    var nomeCampo_fid_fecha_ = "fid_fecha_" + iNumLinha;
    var var_fid_fecha_ = scAjaxGetFieldText(nomeCampo_fid_fecha_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_fechas_iva_diferenciado_validate_fid_fecha_(var_fid_fecha_, iNumLinha, var_script_case_init, do_ajax_form_sri_fechas_iva_diferenciado_validate_fid_fecha__cb);
  } // do_ajax_form_sri_fechas_iva_diferenciado_validate_fid_fecha_

  function do_ajax_form_sri_fechas_iva_diferenciado_validate_fid_fecha__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "fid_fecha_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fid_fecha_";
    }
    ...
    if ("" == sFieldErrors || ($("#ui-datepicker-div").length && $("#ui-datepicker-div").filter(":visible").length))
    {
      ...
      scErrorLineOff(iLineNumber, "fid_fecha_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fid_fecha_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_fechas_iva_diferenciado_validate_fid_fecha__cb

  // ---------- Validate fid_codigo_iva_
  function do_ajax_form_sri_fechas_iva_diferenciado_validate_fid_codigo_iva_(iNumLinha)
  {
    var nomeCampo_fid_codigo_iva_ = "fid_codigo_iva_" + iNumLinha;
    var var_fid_codigo_iva_ = scAjaxGetFieldSelect(nomeCampo_fid_codigo_iva_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_fechas_iva_diferenciado_validate_fid_codigo_iva_(var_fid_codigo_iva_, iNumLinha, var_script_case_init, do_ajax_form_sri_fechas_iva_diferenciado_validate_fid_codigo_iva__cb);
  } // do_ajax_form_sri_fechas_iva_diferenciado_validate_fid_codigo_iva_

  function do_ajax_form_sri_fechas_iva_diferenciado_validate_fid_codigo_iva__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fid_codigo_iva_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fid_codigo_iva_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fid_codigo_iva_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fid_codigo_iva_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_fechas_iva_diferenciado_validate_fid_codigo_iva__cb

  // ---------- Validate fid_porcentaje_
  function do_ajax_form_sri_fechas_iva_diferenciado_validate_fid_porcentaje_(iNumLinha)
  {
    var nomeCampo_fid_porcentaje_ = "fid_porcentaje_" + iNumLinha;
    var var_fid_porcentaje_ = scAjaxGetFieldText(nomeCampo_fid_porcentaje_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_fechas_iva_diferenciado_validate_fid_porcentaje_(var_fid_porcentaje_, iNumLinha, var_script_case_init, do_ajax_form_sri_fechas_iva_diferenciado_validate_fid_porcentaje__cb);
  } // do_ajax_form_sri_fechas_iva_diferenciado_validate_fid_porcentaje_

  function do_ajax_form_sri_fechas_iva_diferenciado_validate_fid_porcentaje__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fid_porcentaje_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fid_porcentaje_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fid_porcentaje_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fid_porcentaje_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_fechas_iva_diferenciado_validate_fid_porcentaje__cb

  // ---------- Validate fid_estado_
  function do_ajax_form_sri_fechas_iva_diferenciado_validate_fid_estado_(iNumLinha)
  {
    var nomeCampo_fid_estado_ = "fid_estado_" + iNumLinha;
    var var_fid_estado_ = scAjaxGetFieldSelect(nomeCampo_fid_estado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_fechas_iva_diferenciado_validate_fid_estado_(var_fid_estado_, iNumLinha, var_script_case_init, do_ajax_form_sri_fechas_iva_diferenciado_validate_fid_estado__cb);
  } // do_ajax_form_sri_fechas_iva_diferenciado_validate_fid_estado_

  function do_ajax_form_sri_fechas_iva_diferenciado_validate_fid_estado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fid_estado_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fid_estado_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fid_estado_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fid_estado_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sri_fechas_iva_diferenciado_validate_fid_estado__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_sri_fechas_iva_diferenciado_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_sri_fechas_iva_diferenciado_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sri_fechas_iva_diferenciado_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_sri_fechas_iva_diferenciado_add_new_line_cb);
  } // do_ajax_form_sri_fechas_iva_diferenciado_add_new_line

  function do_ajax_form_sri_fechas_iva_diferenciado_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_sri_fechas_iva_diferenciado_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_sri_fechas_iva_diferenciado_backup_line(iNumLinha)
  {
    var var_fid_fecha_ = scAjaxGetFieldText("fid_fecha_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sri_fechas_iva_diferenciado_backup_line(var_fid_fecha_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_sri_fechas_iva_diferenciado_backup_line_cb);
  } // do_ajax_form_sri_fechas_iva_diferenciado_backup_line

  function do_ajax_form_sri_fechas_iva_diferenciado_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_sri_fechas_iva_diferenciado_backup_line_cb

  function do_ajax_form_sri_fechas_iva_diferenciado_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_sri_fechas_iva_diferenciado_cancel_insert

  function do_ajax_form_sri_fechas_iva_diferenciado_cancel_update(iSeqVert)
  {
    do_ajax_form_sri_fechas_iva_diferenciado_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_sri_fechas_iva_diferenciado_cancel_update

  function do_ajax_form_sri_fechas_iva_diferenciado_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_sri_fechas_iva_diferenciado_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_sri_fechas_iva_diferenciado_table_refresh()
  {
    var var_fid_fecha_ = document.F2.fid_fecha_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_sri_fechas_iva_diferenciado_table_refresh(var_fid_fecha_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sri_fechas_iva_diferenciado_table_refresh_cb);
  } //  do_ajax_form_sri_fechas_iva_diferenciado_table_refresh

  function do_ajax_form_sri_fechas_iva_diferenciado_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.fid_fecha_.value = scAjaxGetKeyValue("fid_fecha_");
    ...
    scAjaxAlert(do_ajax_form_sri_fechas_iva_diferenciado_table_refresh_cb_after_alert);
  } // do_ajax_form_sri_fechas_iva_diferenciado_table_refresh_cb
  function do_ajax_form_sri_fechas_iva_diferenciado_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_sri_fechas_iva_diferenciado_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_sri_fechas_iva_diferenciado_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_sri_fechas_iva_diferenciado_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_fid_fecha_ = scAjaxGetFieldText("fid_fecha_" + iNumLinha);
    var var_fid_codigo_iva_ = scAjaxGetFieldSelect("fid_codigo_iva_" + iNumLinha);
    var var_fid_porcentaje_ = scAjaxGetFieldText("fid_porcentaje_" + iNumLinha);
    var var_fid_estado_ = scAjaxGetFieldSelect("fid_estado_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_sri_fechas_iva_diferenciado_submit_form(var_fid_fecha_, var_fid_codigo_iva_, var_fid_porcentaje_, var_fid_estado_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sri_fechas_iva_diferenciado_submit_form_cb);
  } // do_ajax_form_sri_fechas_iva_diferenciado_submit_form

  function do_ajax_form_sri_fechas_iva_diferenciado_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("fid_fecha_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("fid_codigo_iva_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("fid_porcentaje_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("fid_estado_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sri_fechas_iva_diferenciado_submit_form_cb_after_alert);
  } // do_ajax_form_sri_fechas_iva_diferenciado_submit_form_cb
  function do_ajax_form_sri_fechas_iva_diferenciado_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sri_fechas_iva_diferenciado_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sri_fechas_iva_diferenciado_navigate_form()
  {
    perform_ajax_form_sri_fechas_iva_diferenciado_navigate_form();
  }

  function perform_ajax_form_sri_fechas_iva_diferenciado_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_sri_fechas_iva_diferenciado_cancel_insert(sc_form_sri_fechas_iva_diferenciado_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("fid_fecha_" + iNavForm);
      scAjaxHideErrorDisplay("fid_codigo_iva_" + iNavForm);
      scAjaxHideErrorDisplay("fid_porcentaje_" + iNavForm);
      scAjaxHideErrorDisplay("fid_estado_" + iNavForm);
    }
    var var_fid_fecha_ = document.F2.fid_fecha_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sri_fechas_iva_diferenciado_navigate_form(var_fid_fecha_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sri_fechas_iva_diferenciado_navigate_form_cb);
  } // do_ajax_form_sri_fechas_iva_diferenciado_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sri_fechas_iva_diferenciado']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sri_fechas_iva_diferenciado_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.fid_fecha_.value = scAjaxGetKeyValue("fid_fecha_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sri_fechas_iva_diferenciado_navigate_form_cb_after_alert);
  } // do_ajax_form_sri_fechas_iva_diferenciado_navigate_form_cb
  function do_ajax_form_sri_fechas_iva_diferenciado_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_sri_fechas_iva_diferenciado_navigate_form_cb_after_alert

    function sc_form_sri_fechas_iva_diferenciado_get_last_line_number()
    {
    ...
    } //sc_form_sri_fechas_iva_diferenciado_get_last_line_number

  function sc_hide_form_sri_fechas_iva_diferenciado_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "fid_fecha_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fid_codigo_iva_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fid_porcentaje_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fid_estado_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["fid_fecha_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_fecha'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["fid_codigo_iva_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_codigo_sri'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["fid_porcentaje_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_porcentaje_iva'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["fid_estado_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["fid_fecha_"][iNumLinha] = "fid_fecha_" + iNumLinha;
    ajax_field_mult["fid_codigo_iva_"][iNumLinha] = "fid_codigo_iva_" + iNumLinha;
    ajax_field_mult["fid_porcentaje_"][iNumLinha] = "fid_porcentaje_" + iNumLinha;
    ajax_field_mult["fid_estado_"][iNumLinha] = "fid_estado_" + iNumLinha;
    ajax_field_id["fid_fecha_" + iNumLinha] = new Array("hidden_field_label_fid_fecha_", "hidden_field_data_fid_fecha_" + iNumLinha);
    ajax_field_id["fid_codigo_iva_" + iNumLinha] = new Array("hidden_field_label_fid_codigo_iva_", "hidden_field_data_fid_codigo_iva_" + iNumLinha);
    ajax_field_id["fid_porcentaje_" + iNumLinha] = new Array("hidden_field_label_fid_porcentaje_", "hidden_field_data_fid_porcentaje_" + iNumLinha);
    ajax_field_id["fid_estado_" + iNumLinha] = new Array("hidden_field_label_fid_estado_", "hidden_field_data_fid_estado_" + iNumLinha);
    ajax_error_count["fid_fecha_" + iNumLinha] = "off";
    ajax_error_count["fid_codigo_iva_" + iNumLinha] = "off";
    ajax_error_count["fid_porcentaje_" + iNumLinha] = "off";
    ajax_error_count["fid_estado_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["fid_fecha_" + iNumLinha] = "on";
    ajax_read_only["fid_codigo_iva_" + iNumLinha] = "off";
    ajax_read_only["fid_porcentaje_" + iNumLinha] = "off";
    ajax_read_only["fid_estado_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["fid_fecha_" + iNumLinha] = "on";
    ajax_read_only["fid_codigo_iva_" + iNumLinha] = "on";
    ajax_read_only["fid_porcentaje_" + iNumLinha] = "on";
    ajax_read_only["fid_estado_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["fid_fecha_" + iNumLinha] = null;
    ajax_error_list["fid_codigo_iva_" + iNumLinha] = null;
    ajax_error_list["fid_porcentaje_" + iNumLinha] = null;
    ajax_error_list["fid_estado_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "fid_fecha_": new Array(),
    "fid_codigo_iva_": new Array(),
    "fid_porcentaje_": new Array(),
    "fid_estado_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["fid_fecha_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fid_fecha_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fid_fecha_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fid_fecha_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fid_fecha_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["fid_codigo_iva_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fid_codigo_iva_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fid_codigo_iva_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fid_codigo_iva_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fid_codigo_iva_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["fid_porcentaje_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fid_porcentaje_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fid_porcentaje_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fid_porcentaje_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fid_porcentaje_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["fid_estado_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fid_estado_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fid_estado_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fid_estado_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fid_estado_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fid_fecha_'])) ? $this->nmgp_cmp_readonly['fid_fecha_'] : 'on';
?>
    scAjaxFieldRead("fid_fecha_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fid_codigo_iva_'])) ? $this->nmgp_cmp_readonly['fid_codigo_iva_'] : 'off';
?>
    scAjaxFieldRead("fid_codigo_iva_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fid_porcentaje_'])) ? $this->nmgp_cmp_readonly['fid_porcentaje_'] : 'off';
?>
    scAjaxFieldRead("fid_porcentaje_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fid_estado_'])) ? $this->nmgp_cmp_readonly['fid_estado_'] : 'off';
?>
    scAjaxFieldRead("fid_estado_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("fid_fecha_" + iSeq, "on");
    scAjaxFieldRead("fid_codigo_iva_" + iSeq, "on");
    scAjaxFieldRead("fid_porcentaje_" + iSeq, "on");
    scAjaxFieldRead("fid_estado_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["fid_fecha_" + iRow] || "on" == ajax_error_count["fid_codigo_iva_" + iRow] || "on" == ajax_error_count["fid_porcentaje_" + iRow] || "on" == ajax_error_count["fid_estado_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_fid_fecha_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_fid_codigo_iva_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_fid_porcentaje_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_fid_estado_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["fid_fecha_" + iRow] && "off" == ajax_error_count["fid_codigo_iva_" + iRow] && "off" == ajax_error_count["fid_porcentaje_" + iRow] && "off" == ajax_error_count["fid_estado_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["fid_fecha_" + iRow] = "off";
        ajax_error_count["fid_codigo_iva_" + iRow] = "off";
        ajax_error_count["fid_porcentaje_" + iRow] = "off";
        ajax_error_count["fid_estado_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_fid_fecha_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_fid_codigo_iva_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_fid_porcentaje_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_fid_estado_" + iRow).removeClass("scFormErrorLine");
    }
  }
