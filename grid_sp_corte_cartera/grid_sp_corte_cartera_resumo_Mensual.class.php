...
SCEOT;
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_periodo_consumo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['arr_total']['periodo_consumo'];
          $this->array_total_mes_consumo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['arr_total']['mes_consumo'];
      }
      else
      {
          $this->array_total_periodo_consumo = array();
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['summarizing_fields_order']['Mensual']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['summarizing_fields_order']['Mensual'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['summarizing_fields_order']['Mensual'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['summarizing_fields_display']['Mensual'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['summarizing_fields_display']['Mensual'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['summarizing_fields_display']['Mensual'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['summarizing_fields_display']['Mensual'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['summarizing_fields_display']['Mensual'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['summarizing_fields_display']['Mensual'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['summarizing_fields_display']['Mensual'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_periodo_consumo as $i_periodo_consumo => $d_periodo_consumo) {
           if (!isset($i_periodo_consumo, $this->comp_label[0]) || !in_array($i_periodo_consumo, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_periodo_consumo[5] ] = $d_periodo_consumo[4];
               $this->comp_label[0][ $d_periodo_consumo[5] ] = $d_periodo_consumo[4];
           }
           foreach ($this->array_total_mes_consumo[$i_periodo_consumo] as $i_mes_consumo => $d_mes_consumo) {
               if (!isset($i_mes_consumo, $this->comp_label[1][ $d_periodo_consumo[5] ]) || !in_array($i_mes_consumo, $this->comp_label[1][ $d_periodo_consumo[5] ], true)) {
                   $this->comp_index[1][ $d_mes_consumo[5] ] = $d_mes_consumo[4];
                   $this->comp_label[1][ $d_periodo_consumo[5] ][ $d_mes_consumo[5] ] = $d_mes_consumo[4];
               }
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'periodo_consumo', 'prot' => ''),
           array('name' => 'mes_consumo', 'prot' => '@aspass@'),
       );
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_periodo_consumo => $l_periodo_consumo) {
           if (isset($this->array_total_periodo_consumo[$i_periodo_consumo])) {
               $this->comp_group[$i_periodo_consumo] = array();
           }
           foreach ($this->comp_label[1][$i_periodo_consumo] as $i_mes_consumo => $l_mes_consumo) {
               if (isset($this->array_total_mes_consumo[$i_periodo_consumo][$i_mes_consumo])) {
                   $this->comp_group[$i_periodo_consumo][$i_mes_consumo] = array();
               }
           }
       }
     }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_periodo_consumo;
       }
       elseif (1 == $level) {
           $return = $this->array_total_mes_consumo;
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      ...
      if (is_array($this->array_total_periodo_consumo)) {
          ksort($this->array_total_periodo_consumo);
      }
      if (is_array($this->array_total_mes_consumo)) {
          ksort($this->array_total_mes_consumo);
      }
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['SC_Ind_Groupby'];
...
{ 
   ...
   //---- 
   function adiciona_registro($sum_do_total, $sum_do_subtotal, $sum_do_valor_iva, $quebra_periodo_consumo, $quebra_mes_consumo, $quebra_periodo_consumo_orig, $quebra_mes_consumo_orig)
   {
      //----- periodo_consumo
      if (!isset($this->array_total_periodo_consumo[$quebra_periodo_consumo_orig]))
      {
         $this->array_total_periodo_consumo[$quebra_periodo_consumo_orig][0] = 1;
         $this->array_total_periodo_consumo[$quebra_periodo_consumo_orig][1] = $sum_do_total;
         $this->array_total_periodo_consumo[$quebra_periodo_consumo_orig][2] = $sum_do_subtotal;
         $this->array_total_periodo_consumo[$quebra_periodo_consumo_orig][3] = $sum_do_valor_iva;
         $this->array_total_periodo_consumo[$quebra_periodo_consumo_orig][4] = $quebra_periodo_consumo;
         $this->array_total_periodo_consumo[$quebra_periodo_consumo_orig][5] = $quebra_periodo_consumo_orig;
      }
      else
      {
         $this->array_total_periodo_consumo[$quebra_periodo_consumo_orig][0]++;
         $this->array_total_periodo_consumo[$quebra_periodo_consumo_orig][1] = bcadd($this->array_total_periodo_consumo[$quebra_periodo_consumo_orig][1], $sum_do_total, 10);
         $this->array_total_periodo_consumo[$quebra_periodo_consumo_orig][2] = bcadd($this->array_total_periodo_consumo[$quebra_periodo_consumo_orig][2], $sum_do_subtotal, 10);
         $this->array_total_periodo_consumo[$quebra_periodo_consumo_orig][3] = bcadd($this->array_total_periodo_consumo[$quebra_periodo_consumo_orig][3], $sum_do_valor_iva, 10);
      }
      //----- mes_consumo
      if (!isset($this->array_total_mes_consumo[$quebra_periodo_consumo_orig][$quebra_mes_consumo_orig]))
      {
         $this->array_total_mes_consumo[$quebra_periodo_consumo_orig][$quebra_mes_consumo_orig][0] = 1;
         $this->array_total_mes_consumo[$quebra_periodo_consumo_orig][$quebra_mes_consumo_orig][1] = $sum_do_total;
         $this->array_total_mes_consumo[$quebra_periodo_consumo_orig][$quebra_mes_consumo_orig][2] = $sum_do_subtotal;
         $this->array_total_mes_consumo[$quebra_periodo_consumo_orig][$quebra_mes_consumo_orig][3] = $sum_do_valor_iva;
         $this->array_total_mes_consumo[$quebra_periodo_consumo_orig][$quebra_mes_consumo_orig][4] = $quebra_mes_consumo;
         $this->array_total_mes_consumo[$quebra_periodo_consumo_orig][$quebra_mes_consumo_orig][5] = $quebra_mes_consumo_orig;
      }
      else
      {
         $this->array_total_mes_consumo[$quebra_periodo_consumo_orig][$quebra_mes_consumo_orig][0]++;
         $this->array_total_mes_consumo[$quebra_periodo_consumo_orig][$quebra_mes_consumo_orig][1] = bcadd($this->array_total_mes_consumo[$quebra_periodo_consumo_orig][$quebra_mes_consumo_orig][1], $sum_do_total, 10);
         $this->array_total_mes_consumo[$quebra_periodo_consumo_orig][$quebra_mes_consumo_orig][2] = bcadd($this->array_total_mes_consumo[$quebra_periodo_consumo_orig][$quebra_mes_consumo_orig][2], $sum_do_subtotal, 10);
         $this->array_total_mes_consumo[$quebra_periodo_consumo_orig][$quebra_mes_consumo_orig][3] = bcadd($this->array_total_mes_consumo[$quebra_periodo_consumo_orig][$quebra_mes_consumo_orig][3], $sum_do_valor_iva, 10);
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('Mensual', 'periodo_consumo');
     $campos_order = $this->Ini->Get_date_order_groupby("periodo_consumo", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('Mensual', 'mes_consumo');
     $campos_order = $this->Ini->Get_date_order_groupby("mes_consumo", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->look_mes_consumo = $this->mes_consumo; 
            $this->Lookup->lookup_mes_consumo($this->look_mes_consumo, $this->mes_consumo) ; 
            $this->periodo_consumo_orig = $this->periodo_consumo;
            $this->mes_consumo_orig = $this->mes_consumo;
            $this->mes_consumo = $this->look_mes_consumo ;
            nmgp_Form_Num_Val($this->periodo_consumo, "", ",", "0", "S", "2", "", "N:", "-") ; 
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->do_total, $this->do_subtotal, $this->do_valor_iva, $this->periodo_consumo, $this->mes_consumo, $this->periodo_consumo_orig,  $this->mes_consumo_orig);
            }
   }
//
