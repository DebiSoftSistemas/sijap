...
class grid_sp_corte_cartera_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_sp_corte_cartera']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_sp_corte_cartera']['campos_busca']))
      { 
   ...
   {
      global $nm_lang, $op_estado_corte;
      $this->nm_data = new nm_data("es");
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['sql_tot_res']);
      ...
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('periodo_emision' => "periodo_emision",'mes_emision' => "mes_emision",'periodo_consumo' => "periodo_consumo",'mes_consumo' => "mes_consumo",'cl_identificacion' => "cl_identificacion",'cl_nombre' => "cl_nombre",'pro_descripcion' => "pro_descripcion");
      $cmps_quebra_atual = array();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['SC_Gb_Free_cmp'] as $cmp => $resto)
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['arr_total'] = array();
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['arr_total'][$cmp_gb] = $this->$Arr_tot_name;
      }
   }
   ...
   function Res_Totaliza_sc_free_group_by($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def, $res_export)
   {
      ...
      $cmp_sql_tp_num = array('op_operacion' => 'N','periodo_emision' => 'N','periodo_consumo' => 'N','do_subtotal' => 'N','do_descuento' => 'N','do_valor_iva' => 'N','do_total' => 'N');
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['sql_tot_res']))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['sql_tot_res'] = str_replace("#@#cmps_quebras#@#", "", $comando);
      }
      $comando  = str_replace("#@#cmps_quebras#@#", "," . $cmps_quebras, $comando);
      $comando .= " group by " . $cmps_quebras . " order by " .  $cmps_quebras;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['Res_search_metric_use']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['Res_search_metric_use']))
      {
          $comando = $cmd_simp;
          $cmps_S  = "";
      ...
      while (!$rt->EOF)
      {
          ...
          nmgp_Form_Num_Val($$Cada_dim, "", ",", "0", "S", "2", "", "N:", "-") ; 
              ...
              if ($Cada_dim == "mes_consumo") {
                  $this->Lookup->lookup_sc_free_group_by_mes_consumo($$Cada_dim,  $mes_consumo);
              }
   ...
   {
      global $nada, $nm_lang , $op_estado, $mes_consumo;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(do_total), sum(do_subtotal), sum(do_valor_iva) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['where_pesq']; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*), sum(do_total), sum(do_subtotal), sum(do_valor_iva) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['where_pesq']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $rt->fields[1] = (string)$rt->fields[1]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['tot_geral'][2] = $rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $rt->fields[2] = (string)$rt->fields[2]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['tot_geral'][3] = $rt->fields[2]; 
      $rt->fields[3] = str_replace(",", ".", $rt->fields[3]);
      $rt->fields[3] = (string)$rt->fields[3]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['tot_geral'][4] = $rt->fields[3]; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['contr_total_geral'] = "OK";
   } 
   ...
   function quebra_periodo_emision_sc_free_group_by($periodo_emision, $Where_qb, $Cmp_Name) 
   {
      ...
      global $$Var_name_gb, $op_estado, $mes_consumo;
   ...
   //-----  periodo_consumo
   function quebra_periodo_consumo_sc_free_group_by($periodo_consumo, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb, $op_estado, $mes_consumo;
      ...
      $rt->Close(); 
      $$Var_name_gb = $tot_periodo_consumo;
   } 

   //-----  mes_consumo
   function quebra_mes_consumo_sc_free_group_by($mes_consumo, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb, $op_estado, $mes_consumo;
   ...
   {
      global $tot_periodo_consumo, $op_estado, $mes_consumo;
      $tot_periodo_consumo = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(do_total), sum(do_subtotal), sum(do_valor_iva) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['where_pesq']; 
   ...
   {
      global $tot_mes_consumo, $op_estado, $mes_consumo;
      $tot_mes_consumo = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(do_total), sum(do_subtotal), sum(do_valor_iva) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['where_pesq']; 
