<?php
@session_start() ;
$_SESSION['scriptcase']['grid_sp_corte_cartera']['sc_process_barr'] = true;
require_once('../grid_sp_corte_cartera/index.php');
unset($_SESSION['scriptcase']['grid_sp_corte_cartera']['sc_process_barr']);
$ExportCtrl = new grid_sp_corte_cartera_export_control;
$ExportCtrl->Export_barr();

class grid_sp_corte_cartera_export_control
{
