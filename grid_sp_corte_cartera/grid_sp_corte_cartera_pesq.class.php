...
class grid_sp_corte_cartera_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_sp_corte_cartera_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_sp_corte_cartera_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_sp_corte_cartera_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "op_operacion";$Nm_numeric[] = "periodo_emision";$Nm_numeric[] = "periodo_consumo";$Nm_numeric[] = "do_subtotal";$Nm_numeric[] = "do_descuento";$Nm_numeric[] = "do_valor_iva";$Nm_numeric[] = "do_total";
      $campo_join = strtolower(str_replace(".", "_", $nome));
      if (in_array($campo_join, $Nm_numeric))
      {
          if ($condicao == "EP" || $condicao == "NE")
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$campo_join]);
              return;
          }
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_sp_corte_cartera/grid_sp_corte_cartera_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_sp_corte_cartera_ajax_search.js"></script>
 <script type="text/javascript" src="grid_sp_corte_cartera_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_sp_corte_cartera_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_sp_corte_cartera']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_sp_corte_cartera']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_periodo_consumo_cond#NMF#' + search_get_sel_txt('SC_periodo_consumo_cond') + '@NMF@';
  str_out += 'SC_periodo_consumo#NMF#' + search_get_Dselelect('SC_periodo_consumo_dest') + '@NMF@';
  str_out += 'SC_mes_consumo_cond#NMF#' + search_get_sel_txt('SC_mes_consumo_cond') + '@NMF@';
  str_out += 'SC_mes_consumo#NMF#' + search_get_Dselelect('SC_mes_consumo_dest') + '@NMF@';
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $periodo_consumo_cond, $periodo_consumo,
             $mes_consumo_cond, $mes_consumo,
      ...
      if (isset($bprocessa) && ($bprocessa == "recarga" || $bprocessa == "save_form" || $bprocessa == "filter_delete"))
      {
          if (!empty($periodo_consumo))
          {
              $periodo_consumo = explode("@?@", $periodo_consumo);
          }
          else
          {
              $periodo_consumo = array();
          }
      }
      if (isset($bprocessa) && ($bprocessa == "recarga" || $bprocessa == "save_form" || $bprocessa == "filter_delete"))
      {
          if (!empty($mes_consumo))
          {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $periodo_emision = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca']['periodo_emision']; 
          $periodo_emision_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca']['periodo_emision_cond']; 
          $mes_emision = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca']['mes_emision']; 
          $mes_emision_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca']['mes_emision_cond']; 
          $periodo_consumo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca']['periodo_consumo']; 
          $periodo_consumo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca']['periodo_consumo_cond']; 
          $mes_consumo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca']['mes_consumo']; 
          $mes_consumo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca']['mes_consumo_cond']; 
          $cl_identificacion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca']['cl_identificacion']; 
          $cl_identificacion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca']['cl_identificacion_cond']; 
          $cl_nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca']['cl_nombre']; 
          $cl_nombre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca']['cl_nombre_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca']['NM_operador']; 
      } 
      ...
      $str_hide_periodo_consumo = (in_array($periodo_consumo_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_mes_consumo = (in_array($mes_consumo_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      // periodo_consumo
      if (is_array($periodo_consumo) && !empty($periodo_consumo))
      {
         $tmp_array = array();
         $periodo_consumo_val_str = "";
         foreach ($periodo_consumo as $tmp_val_cmp)
         {
            if ("" != $periodo_consumo_val_str)
            {
               $periodo_consumo_val_str .= ",";
            }
            $tmp_pos = (is_string($tmp_val_cmp)) ? strpos($tmp_val_cmp, "##@@") : false;
            ...
            $periodo_consumo_val_str .= "'$tmp_val_cmp'";
         }
         $periodo_consumo = $tmp_array;
      }
      else
      {
         $periodo_consumo_val_str = "";
      ...
      // mes_consumo
      if (is_array($mes_consumo) && !empty($mes_consumo))
      {
         $tmp_array = array();
         $mes_consumo_val_str = "";
         foreach ($mes_consumo as $tmp_val_cmp)
         {
            if ("" != $mes_consumo_val_str)
            {
               $mes_consumo_val_str .= ",";
            }
            $tmp_pos = (is_string($tmp_val_cmp)) ? strpos($tmp_val_cmp, "##@@") : false;
            ...
            $mes_consumo_val_str .= "'$tmp_val_cmp'";
         }
         $mes_consumo = $tmp_array;
      }
      else
      {
         $mes_consumo_val_str = "''";
      ...
      if (!isset($periodo_consumo) || $periodo_consumo == "")
      {
          $periodo_consumo = array();
      }
      if (!isset($mes_consumo) || $mes_consumo == "")
      {
          $mes_consumo = array();
      }
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_periodo_emision_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['periodo_emision'])) ? $this->New_label['periodo_emision'] : "" . $this->Ini->Nm_lang['lang_periodo_emision'] . ""; ?></TD>
...
?>
   <table style="padding: 0px; spacing: 0px; border-width: 0px;"><tr><td>
    <SELECT class="scFilterObjectOdd" id="SC_periodo_emision_orig" name="periodo_emision_orig" size=7 multiple onDblClick="nm_add_sel('periodo_emision_orig', 'periodo_emision_dest', 'N' , '')">
<?php
...
?>
   ...
   <td>
    <SELECT class="scFilterObjectOdd" id="SC_periodo_emision_dest" name="periodo_emision_dest" size=7 multiple  onDblClick="nm_del_sel('periodo_emision_dest', 'periodo_emision_orig', 'N' , '')">"
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
      ...
      <TD id='SC_mes_emision_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['mes_emision'])) ? $this->New_label['mes_emision'] : "" . $this->Ini->Nm_lang['lang_mes_emision'] . ""; ?></TD>
...
?>
   <table style="padding: 0px; spacing: 0px; border-width: 0px;"><tr><td>
    <SELECT class="scFilterObjectEven" id="SC_mes_emision_orig" name="mes_emision_orig" size=7 multiple onDblClick="nm_add_sel('mes_emision_orig', 'mes_emision_dest', 'N' , '')">
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
   ...
   <td>
    <SELECT class="scFilterObjectEven" id="SC_mes_emision_dest" name="mes_emision_dest" size=7 multiple  onDblClick="nm_del_sel('mes_emision_dest', 'mes_emision_orig', 'N' , '')">"
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
      ...
      <TD id='SC_periodo_consumo_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['periodo_consumo'])) ? $this->New_label['periodo_consumo'] : "" . $this->Ini->Nm_lang['lang_periodo_consumo'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_periodo_consumo_cond" name="periodo_consumo_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_periodo_consumo" <?php echo $str_hide_periodo_consumo?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['periodo_consumo'])) ? $this->New_label['periodo_consumo'] : "" . $this->Ini->Nm_lang['lang_periodo_consumo'] . "";
 $nmgp_tab_label .= "periodo_consumo?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
   <table style="padding: 0px; spacing: 0px; border-width: 0px;"><tr><td>
    <SELECT class="scFilterObjectOdd" id="SC_periodo_consumo_orig" name="periodo_consumo_orig" size=7 multiple onDblClick="nm_add_sel('periodo_consumo_orig', 'periodo_consumo_dest', 'N' , '')">
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            {
               $periodo_consumo_sel = "";
               foreach ($periodo_consumo as $Dados)
               {
                   if ($Dados === $nm_opc_cod)
                   {
            ...
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $periodo_consumo_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
<?php
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_rightall", "nm_add_all('periodo_consumo_orig', 'periodo_consumo_dest', 'N', '');", "nm_add_all('periodo_consumo_orig', 'periodo_consumo_dest', 'N', '');", "Bbpassfld_rightall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_right", "nm_add_sel('periodo_consumo_orig', 'periodo_consumo_dest', 'N', '');", "nm_add_sel('periodo_consumo_orig', 'periodo_consumo_dest', 'N', '');", "Bbpassfld_righ", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_left", "nm_del_sel('periodo_consumo_dest', 'periodo_consumo_orig', 'N', '');", "nm_del_sel('periodo_consumo_dest', 'periodo_consumo_orig', 'N', '');", "Bbpassfld_left", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_leftall", "nm_del_all('periodo_consumo_dest', 'periodo_consumo_orig', 'N', '');", "nm_del_all('periodo_consumo_dest', 'periodo_consumo_orig', 'N', '');", "Bbpassfld_leftall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
?>
   </td>
   <td>
    <SELECT class="scFilterObjectOdd" id="SC_periodo_consumo_dest" name="periodo_consumo_dest" size=7 multiple  onDblClick="nm_del_sel('periodo_consumo_dest', 'periodo_consumo_orig', 'N' , '')">"
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
    ...
    <input type="hidden" id="SC_periodo_consumo" name="periodo_consumo" value="">
   </td></tr></table>
   <script type="text/javascript">document.F1.periodo_consumo_dest.selectedIndex = -1;</script>
<?php
?>
      ...
      <TD id='SC_mes_consumo_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['mes_consumo'])) ? $this->New_label['mes_consumo'] : "" . $this->Ini->Nm_lang['lang_mes_consumo'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_mes_consumo_cond" name="mes_consumo_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_mes_consumo" <?php echo $str_hide_mes_consumo?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['mes_consumo'])) ? $this->New_label['mes_consumo'] : "" . $this->Ini->Nm_lang['lang_mes_consumo'] . "";
 $nmgp_tab_label .= "mes_consumo?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
   <table style="padding: 0px; spacing: 0px; border-width: 0px;"><tr><td>
    <SELECT class="scFilterObjectEven" id="SC_mes_consumo_orig" name="mes_consumo_orig" size=7 multiple onDblClick="nm_add_sel('mes_consumo_orig', 'mes_consumo_dest', 'N' , '')">
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $mes_consumo_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
<?php
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_rightall", "nm_add_all('mes_consumo_orig', 'mes_consumo_dest', 'N', '');", "nm_add_all('mes_consumo_orig', 'mes_consumo_dest', 'N', '');", "Bbpassfld_rightall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_right", "nm_add_sel('mes_consumo_orig', 'mes_consumo_dest', 'N', '');", "nm_add_sel('mes_consumo_orig', 'mes_consumo_dest', 'N', '');", "Bbpassfld_righ", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_left", "nm_del_sel('mes_consumo_dest', 'mes_consumo_orig', 'N', '');", "nm_del_sel('mes_consumo_dest', 'mes_consumo_orig', 'N', '');", "Bbpassfld_left", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_leftall", "nm_del_all('mes_consumo_dest', 'mes_consumo_orig', 'N', '');", "nm_del_all('mes_consumo_dest', 'mes_consumo_orig', 'N', '');", "Bbpassfld_leftall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
?>
   </td>
   <td>
    <SELECT class="scFilterObjectEven" id="SC_mes_consumo_dest" name="mes_consumo_dest" size=7 multiple  onDblClick="nm_del_sel('mes_consumo_dest', 'mes_consumo_orig', 'N' , '')">"
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
    ...
    <input type="hidden" id="SC_mes_consumo" name="mes_consumo" value="">
   </td></tr></table>
   <script type="text/javascript">document.F1.mes_consumo_dest.selectedIndex = -1;</script>
<?php
?>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_sp_corte_cartera_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_sp_corte_cartera']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_sp_corte_cartera']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function nm_submit_form()
 {
   ...
   nm_pack('periodo_consumo_dest', 'periodo_consumo');
   nm_pack('mes_consumo_dest', 'mes_consumo');
    document.F1.submit();
 }
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_periodo_consumo'), document.F1.periodo_consumo_cond, 'periodo_consumo');
   nm_del_all('periodo_consumo_dest', 'periodo_consumo_orig', 'N', '');
   nm_campos_between(document.getElementById('id_vis_mes_consumo'), document.F1.mes_consumo_cond, 'mes_consumo');
   nm_del_all('mes_consumo_dest', 'mes_consumo_orig', 'N', '');
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_sp_corte_cartera/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_periodo_consumo_cond'] = 'cond';
      $tp_fields['SC_periodo_consumo'] = 'dselect';
      $tp_fields['SC_mes_consumo_cond'] = 'cond';
      $tp_fields['SC_mes_consumo'] = 'dselect';
   ...
   {
      global $periodo_emision_cond, $periodo_emision,
             $mes_emision_cond, $mes_emision,
             $periodo_consumo_cond, $periodo_consumo,
             $mes_consumo_cond, $mes_consumo,
             $cl_identificacion_cond, $cl_identificacion, $cl_identificacion_autocomp,
             $cl_nombre_cond, $cl_nombre, $cl_nombre_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca'] as $Cmps => $Vals)
          {
              if ($Cmps == 'periodo_emision' || $Cmps == 'mes_emision' || $Cmps == 'periodo_consumo' || $Cmps == 'mes_consumo')
              {
                  $$Cmps = implode("@?@", $Vals);
              }
              else
      ...
      $periodo_consumo_cond_salva = $periodo_consumo_cond; 
      if (!isset($periodo_consumo_input_2) || $periodo_consumo_input_2 == "")
      {
          $periodo_consumo_input_2 = $periodo_consumo;
      }
      $mes_consumo_cond_salva = $mes_consumo_cond; 
      if (!isset($mes_consumo_input_2) || $mes_consumo_input_2 == "")
      {
          $mes_consumo_input_2 = $mes_consumo;
      }
      ...
      if (is_array($periodo_emision)) {
          foreach ($periodo_emision as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['psq_check_ret']['periodo_emision'])) {
      ...
      if (is_array($mes_emision)) {
          foreach ($mes_emision as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['psq_check_ret']['mes_emision'])) {
      ...
      if (is_array($periodo_consumo)) {
          foreach ($periodo_consumo as $I => $Val) {
              $tmp_pos = (is_string($Val)) ? strpos($Val, "##@@") : false;
              if ($tmp_pos === false) {
                  $L_lookup = $Val;
              }
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['psq_check_ret']['periodo_consumo'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_periodo_consumo'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      if (is_array($mes_consumo)) {
          foreach ($mes_consumo as $I => $Val) {
              $tmp_pos = (is_string($Val)) ? strpos($Val, "##@@") : false;
              if ($tmp_pos === false) {
                  $L_lookup = $Val;
              }
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['psq_check_ret']['mes_consumo'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_mes_consumo'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca']['periodo_emision'] = $periodo_emision; 
      if (is_array($periodo_emision) && !empty($periodo_emision))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['Grid_search'][$I_Grid]['val'][0] = $periodo_emision;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['Grid_search'][$I_Grid]['val'][0][0] = $periodo_emision;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca']['periodo_emision_cond'] = $periodo_emision_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['Grid_search'][$I_Grid]['cmp'] = "periodo_emision"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['Grid_search'][$I_Grid]['opc'] = $periodo_emision_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq']['periodo_emision'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca']['mes_emision'] = $mes_emision; 
      if (is_array($mes_emision) && !empty($mes_emision))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['Grid_search'][$I_Grid]['val'][0] = $mes_emision;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['Grid_search'][$I_Grid]['val'][0][0] = $mes_emision;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca']['mes_emision_cond'] = $mes_emision_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['Grid_search'][$I_Grid]['cmp'] = "mes_emision"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['Grid_search'][$I_Grid]['opc'] = $mes_emision_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq']['mes_emision'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca']['periodo_consumo'] = $periodo_consumo; 
      if (is_array($periodo_consumo) && !empty($periodo_consumo))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['Grid_search'][$I_Grid]['val'][0] = $periodo_consumo;
      }
      elseif ($periodo_consumo_cond_salva == "nu" || $periodo_consumo_cond_salva == "nn" || $periodo_consumo_cond_salva == "ep" || $periodo_consumo_cond_salva == "ne" || !empty($periodo_consumo))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['Grid_search'][$I_Grid]['val'][0][0] = $periodo_consumo;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca']['periodo_consumo_cond'] = $periodo_consumo_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['Grid_search'][$I_Grid]['cmp'] = "periodo_consumo"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['Grid_search'][$I_Grid]['opc'] = $periodo_consumo_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq']['periodo_consumo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca']['mes_consumo'] = $mes_consumo; 
      if (is_array($mes_consumo) && !empty($mes_consumo))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['Grid_search'][$I_Grid]['val'][0] = $mes_consumo;
      }
      elseif ($mes_consumo_cond_salva == "nu" || $mes_consumo_cond_salva == "nn" || $mes_consumo_cond_salva == "ep" || $mes_consumo_cond_salva == "ne" || !empty($mes_consumo))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['Grid_search'][$I_Grid]['val'][0][0] = $mes_consumo;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca']['mes_consumo_cond'] = $mes_consumo_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['Grid_search'][$I_Grid]['cmp'] = "mes_consumo"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['Grid_search'][$I_Grid]['opc'] = $mes_consumo_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq']['mes_consumo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca']['cl_identificacion'] = $cl_identificacion; 
      if (is_array($cl_identificacion) && !empty($cl_identificacion))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['Grid_search'][$I_Grid]['val'][0] = $cl_identificacion;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['Grid_search'][$I_Grid]['val'][0][0] = $cl_identificacion;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca']['cl_identificacion_cond'] = $cl_identificacion_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['Grid_search'][$I_Grid]['cmp'] = "cl_identificacion"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['Grid_search'][$I_Grid]['opc'] = $cl_identificacion_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq']['cl_identificacion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca']['cl_nombre'] = $cl_nombre; 
      if (is_array($cl_nombre) && !empty($cl_nombre))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['Grid_search'][$I_Grid]['val'][0] = $cl_nombre;
      }
      elseif ($cl_nombre_cond_salva == "nu" || $cl_nombre_cond_salva == "nn" || $cl_nombre_cond_salva == "ep" || $cl_nombre_cond_salva == "ne" || !empty($cl_nombre))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['Grid_search'][$I_Grid]['val'][0][0] = $cl_nombre;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca']['cl_nombre_cond'] = $cl_nombre_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['Grid_search'][$I_Grid]['cmp'] = "cl_nombre"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['Grid_search'][$I_Grid]['opc'] = $cl_nombre_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq']['cl_nombre'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $this->cmp_formatado['periodo_emision'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca']['periodo_emision'];
      $this->cmp_formatado['periodo_emision_input_2'] = $periodo_emision_input_2;
      $this->cmp_formatado['mes_emision'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca']['mes_emision'];
      $this->cmp_formatado['mes_emision_input_2'] = $mes_emision_input_2;
      $this->cmp_formatado['periodo_consumo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca']['periodo_consumo'];
      $this->cmp_formatado['periodo_consumo_input_2'] = $periodo_consumo_input_2;
      $this->cmp_formatado['mes_consumo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca']['mes_consumo'];
      $this->cmp_formatado['mes_consumo_input_2'] = $mes_consumo_input_2;
      $nmgp_def_dados = array();
    if ($cl_identificacion != '') {
      $cl_identificacion_look = (is_string($cl_identificacion) ? substr($this->Db->qstr($cl_identificacion), 1, -1) : $cl_identificacion); 
      $nmgp_def_dados = array(); 
    ...
    if ($cl_nombre != '') {
      ...
      if (is_array($periodo_emision) && count($periodo_emision) != 0)
      {
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['cond_pesq'] .= $nmgp_tab_label['periodo_emision'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq']['periodo_emision']['label'] = $nmgp_tab_label['periodo_emision'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq']['periodo_emision']['descr'] = $nmgp_tab_label['periodo_emision'] . ": " . $Lang_descr_final . " " . $cond_descr;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq']['periodo_emision']['hint'] = $nmgp_tab_label['periodo_emision'] . ": " . $Lang_descr_final . " " . $nm_cond;
      }
      ...
      if (is_array($mes_emision) && count($mes_emision) != 0)
      {
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['cond_pesq'] .= $nmgp_tab_label['mes_emision'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq']['mes_emision']['label'] = $nmgp_tab_label['mes_emision'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq']['mes_emision']['descr'] = $nmgp_tab_label['mes_emision'] . ": " . $Lang_descr_final . " " . $cond_descr;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq']['mes_emision']['hint'] = $nmgp_tab_label['mes_emision'] . ": " . $Lang_descr_final . " " . $nm_cond;
      }
      ...
      $this->Date_part = false;
      $nm_aspas = "";
      if ($periodo_consumo_cond == "nu" || $periodo_consumo_cond == "nn" || $periodo_consumo_cond == "ep" || $periodo_consumo_cond == "ne")
      {
          $periodo_consumo = array();
      }
      if (is_array($periodo_consumo) && count($periodo_consumo) != 0)
      {
         foreach ($periodo_consumo as $i => $dados)
         {
            $tmp_pos = (is_string($dados)) ? strpos($dados, "##@@") : false;
            if (($tmp_pos === false && $dados == "") || $tmp_pos == 0)
            {
                unset($periodo_consumo[$i]);
            }
         }
      }
      if (is_array($periodo_consumo) && count($periodo_consumo) != 0)
      {
         ...
         $lim_descr   = 15;
         $lang_descr  = strlen($this->Ini->Nm_lang['lang_srch_orr_cond']);
         if ($periodo_consumo_cond == "df" || $periodo_consumo_cond == "np")
         {
             $this->comando        .= " periodo_consumo not in (";
             $this->comando_sum    .= " v_cartera_general.periodo_consumo not in (";
             $this->comando_filtro .= " periodo_consumo not in (";
         }
         else
         {
             $this->comando        .= " periodo_consumo in (";
             $this->comando_sum    .= " v_cartera_general.periodo_consumo in (";
             $this->comando_filtro .= " periodo_consumo in (";
         }
         $x                     = count($periodo_consumo);
         $xx                    = 0;
         $nm_cond               = "";
         foreach ($periodo_consumo as $i => $dados)
         {
            ...
            elseif (!$end_descr)
            {
                 $cond_descr .= " +" . (count($periodo_consumo) - $count_descr);
                 $end_descr = true;
            };
            if ($xx != ($x - 1))
            {
         ...
         $Lang_descr['df'] = $this->Ini->Nm_lang['lang_srch_diff'];
         $Lang_descr['np'] = $this->Ini->Nm_lang['lang_srch_not_like'];
         $Lang_descr_final = isset($Lang_descr[$periodo_consumo_cond]) ? $Lang_descr[$periodo_consumo_cond] : $this->Ini->Nm_lang['lang_srch_like'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['cond_pesq'] .= $nmgp_tab_label['periodo_consumo'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq']['periodo_consumo']['label'] = $nmgp_tab_label['periodo_consumo'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq']['periodo_consumo']['descr'] = $nmgp_tab_label['periodo_consumo'] . ": " . $Lang_descr_final . " " . $cond_descr;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq']['periodo_consumo']['hint'] = $nmgp_tab_label['periodo_consumo'] . ": " . $Lang_descr_final . " " . $nm_cond;
      }
      elseif (isset($periodo_consumo) && ($periodo_consumo_cond == "nu" || $periodo_consumo_cond == "nn" || $periodo_consumo_cond == "ep" || $periodo_consumo_cond == "ne"))
      {
         $this->monta_condicao("periodo_consumo", $periodo_consumo_cond, "", "", "periodo_consumo", "INT4", false);
      }

      //----- $mes_consumo
      $this->Date_part = false;
      $nm_aspas = "'";
      if ($mes_consumo_cond == "nu" || $mes_consumo_cond == "nn" || $mes_consumo_cond == "ep" || $mes_consumo_cond == "ne")
      {
          $mes_consumo = array();
      }
      if (is_array($mes_consumo) && count($mes_consumo) != 0)
      {
         foreach ($mes_consumo as $i => $dados)
         {
            $tmp_pos = (is_string($dados)) ? strpos($dados, "##@@") : false;
            if (($tmp_pos === false && $dados == "") || $tmp_pos == 0)
            {
      ...
      if (is_array($mes_consumo) && count($mes_consumo) != 0)
      {
         ...
         $lim_descr   = 15;
         $lang_descr  = strlen($this->Ini->Nm_lang['lang_srch_orr_cond']);
         if ($mes_consumo_cond == "df" || $mes_consumo_cond == "np")
         {
             $this->comando        .= " mes_consumo not in (";
             $this->comando_sum    .= " v_cartera_general.mes_consumo not in (";
             $this->comando_filtro .= " mes_consumo not in (";
         }
         else
         {
             $this->comando        .= " mes_consumo in (";
             $this->comando_sum    .= " v_cartera_general.mes_consumo in (";
             $this->comando_filtro .= " mes_consumo in (";
         }
         $x                     = count($mes_consumo);
         $xx                    = 0;
         $nm_cond               = "";
         foreach ($mes_consumo as $i => $dados)
         {
            ...
            elseif (!$end_descr)
            {
                 $cond_descr .= " +" . (count($mes_consumo) - $count_descr);
                 $end_descr = true;
            };
            if ($xx != ($x - 1))
            {
         ...
         $Lang_descr['df'] = $this->Ini->Nm_lang['lang_srch_diff'];
         $Lang_descr['np'] = $this->Ini->Nm_lang['lang_srch_not_like'];
         $Lang_descr_final = isset($Lang_descr[$mes_consumo_cond]) ? $Lang_descr[$mes_consumo_cond] : $this->Ini->Nm_lang['lang_srch_like'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['cond_pesq'] .= $nmgp_tab_label['mes_consumo'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq']['mes_consumo']['label'] = $nmgp_tab_label['mes_consumo'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq']['mes_consumo']['descr'] = $nmgp_tab_label['mes_consumo'] . ": " . $Lang_descr_final . " " . $cond_descr;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['grid_pesq']['mes_consumo']['hint'] = $nmgp_tab_label['mes_consumo'] . ": " . $Lang_descr_final . " " . $nm_cond;
      }
      elseif (isset($mes_consumo) && ($mes_consumo_cond == "nu" || $mes_consumo_cond == "nn" || $mes_consumo_cond == "ep" || $mes_consumo_cond == "ne"))
      {
         $this->monta_condicao("mes_consumo", $mes_consumo_cond, "", "", "mes_consumo", "TEXT", false);
      }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['where_pesq'] = $this->comando;
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['cond_dyn_search'] = "";
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sp_corte_cartera']['cond_pesq'] .= $this->NM_operador;
