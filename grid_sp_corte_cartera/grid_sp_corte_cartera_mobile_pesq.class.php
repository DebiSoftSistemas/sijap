...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "op_fecha_emision";$Nm_numeric[] = "op_operacion";$Nm_numeric[] = "periodo_emision";$Nm_numeric[] = "periodo_consumo";$Nm_numeric[] = "do_subtotal";$Nm_numeric[] = "do_descuento";$Nm_numeric[] = "do_valor_iva";$Nm_numeric[] = "do_total";
...
?>
   <span id="idAjaxSelect_periodo_emision">
      <SELECT class="scFilterObjectOdd" id="SC_periodo_emision" name="periodo_emision[]"  size="7" multiple>
<?php
...
?>
   <span id="idAjaxSelect_mes_emision">
      <SELECT class="scFilterObjectEven" id="SC_mes_emision" name="mes_emision[]"  size="7" multiple>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_periodo_consumo"  <?php echo $str_hide_periodo_consumo?>>
<?php
...
?>
   <span id="idAjaxSelect_periodo_consumo">
      <SELECT class="scFilterObjectOdd" id="SC_periodo_consumo" name="periodo_consumo[]"  size="7" multiple>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_mes_consumo"  <?php echo $str_hide_mes_consumo?>>
<?php
...
?>
   <span id="idAjaxSelect_mes_consumo">
      <SELECT class="scFilterObjectEven" id="SC_mes_consumo" name="mes_consumo[]"  size="7" multiple>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
 ...
 function limpa_form()
 {
   ...
   for (i = 0; i < document.F1.elements.length; i++)
   {
      if (document.F1.elements[i].name == 'periodo_consumo[]')
      {
          while (document.F1.elements[i].selectedIndex != -1)
          {
              aa = document.F1.elements[i].selectedIndex;
   ...
   for (i = 0; i < document.F1.elements.length; i++)
   {
      if (document.F1.elements[i].name == 'mes_consumo[]')
      {
          while (document.F1.elements[i].selectedIndex != -1)
          {
              aa = document.F1.elements[i].selectedIndex;
...
<?php
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "periodo_emision" : return ('class="scFilterObjectOdd"'); break;
         case "mes_emision" : return ('class="scFilterObjectEven"'); break;
         case "periodo_consumo" : return ('class="scFilterObjectOdd"'); break;
         case "mes_consumo" : return ('class="scFilterObjectEven"'); break;
         default       : return ("");
      }
   }
