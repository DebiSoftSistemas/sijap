...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_sp_corte_cartera"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_sp_corte_cartera"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_sp_corte_cartera']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_sp_corte_cartera']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_sp_corte_cartera']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_sp_corte_cartera']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_sp_corte_cartera']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_sp_corte_cartera</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_sp_corte_cartera']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_sp_corte_cartera']['embutida_filho'] as $ind => $sc_init)
          {
