...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_sis_oficina"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_sis_oficina"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_sis_oficina'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_sis_oficina']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_sis_oficina']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_sis_oficina']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_sis_oficina']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_sis_oficina']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_sis_oficina']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_sis_oficina']['embutida_filho'] as $ind => $sc_init)
          {
