...
<?php
   ...
   $Ord_Cmp = new grid_sis_oficina_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_sis_oficina_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_sis_oficina']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_sis_oficina']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['ofi_filial'] = "ofi_filial";
   $tab_labels["ofi_filial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sis_oficina']['labels']["ofi_filial"])) ? $_SESSION['sc_session'][$sc_init]['grid_sis_oficina']['labels']["ofi_filial"] : "" . $this->Nm_lang['lang_filial'] . "";
   $tab_ger_campos['ofi_sucursal'] = "on";
   $tab_def_campos['ofi_sucursal'] = "ofi_sucursal";
   $tab_labels["ofi_sucursal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sis_oficina']['labels']["ofi_sucursal"])) ? $_SESSION['sc_session'][$sc_init]['grid_sis_oficina']['labels']["ofi_sucursal"] : "" . $this->Nm_lang['lang_sucursal'] . "";
   $tab_ger_campos['ofi_nombre'] = "on";
   $tab_def_campos['ofi_nombre'] = "ofi_nombre";
   $tab_labels["ofi_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sis_oficina']['labels']["ofi_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_sis_oficina']['labels']["ofi_nombre"] : "" . $this->Nm_lang['lang_oficina'] . "";
   $tab_ger_campos['ofi_representante'] = "on";
   $tab_def_campos['ofi_representante'] = "ofi_representante";
   $tab_labels["ofi_representante"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sis_oficina']['labels']["ofi_representante"])) ? $_SESSION['sc_session'][$sc_init]['grid_sis_oficina']['labels']["ofi_representante"] : "" . $this->Nm_lang['lang_representante'] . "";
   $tab_ger_campos['ofi_serie_sri'] = "on";
   $tab_def_campos['ofi_serie_sri'] = "ofi_serie_sri";
   $tab_labels["ofi_serie_sri"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sis_oficina']['labels']["ofi_serie_sri"])) ? $_SESSION['sc_session'][$sc_init]['grid_sis_oficina']['labels']["ofi_serie_sri"] : "" . $this->Nm_lang['lang_serie_sri'] . "";
   $tab_ger_campos['ofi_estado'] = "on";
   $tab_def_campos['ofi_estado'] = "ofi_estado";
   $tab_labels["ofi_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sis_oficina']['labels']["ofi_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_sis_oficina']['labels']["ofi_estado"] : "" . $this->Nm_lang['lang_estado'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_sis_oficina']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_sis_oficina']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_sis_oficina']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_sis_oficina']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_sis_oficina']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_sis_oficina']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_sis_oficina']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_sis_oficina']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_sis_oficina']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_sis_oficina']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_sis_oficina']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_sis_oficina']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_sis_oficina_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_sis_oficina']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_sis_oficina']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_sis_oficina']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_sis_oficina']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_sis_oficina']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
