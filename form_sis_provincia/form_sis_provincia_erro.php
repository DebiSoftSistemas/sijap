...
$old_error_handler = set_error_handler("form_sis_provincia_scriptcase_error_handler");

function form_sis_provincia_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['form_sis_provincia']['contr_erro']) && $_SESSION['scriptcase']['form_sis_provincia']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_sis_provincia->contr_form_sis_provincia->Apl_com_erro = true;
            if ($inicial_form_sis_provincia->contr_form_sis_provincia->NM_ajax_flag)
            {
                $inicial_form_sis_provincia->contr_form_sis_provincia->NM_ajax_info['errList']['geral_form_sis_provincia'][] = $msg;
                return;
            }
            form_sis_provincia_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_sis_provincia_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_sis_provincia'])  && '' != $_SESSION['scriptcase']['error_icon']['form_sis_provincia'])  ? $_SESSION['scriptcase']['error_icon']['form_sis_provincia']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_sis_provincia']) && '' != $_SESSION['scriptcase']['error_span_title']['form_sis_provincia']) ? $_SESSION['scriptcase']['error_span_title']['form_sis_provincia'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_sis_provincia']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_sis_provincia']) ? $_SESSION['scriptcase']['error_icon_title']['form_sis_provincia'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_sis_provincia']['error_buffer'] .= ob_get_flush();
}
