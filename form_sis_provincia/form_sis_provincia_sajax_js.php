  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_provincia" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sis_provincia_form();
	}
...
?>
  ...
  // ---------- Validate pro_id_
  function do_ajax_form_sis_provincia_validate_pro_id_(iNumLinha)
  {
    var nomeCampo_pro_id_ = "pro_id_" + iNumLinha;
    var var_pro_id_ = scAjaxGetFieldHidden(nomeCampo_pro_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_provincia_validate_pro_id_(var_pro_id_, iNumLinha, var_script_case_init, do_ajax_form_sis_provincia_validate_pro_id__cb);
  } // do_ajax_form_sis_provincia_validate_pro_id_

  function do_ajax_form_sis_provincia_validate_pro_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "pro_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pro_id_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "pro_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pro_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_provincia_validate_pro_id__cb

  // ---------- Validate pro_pais_
  function do_ajax_form_sis_provincia_validate_pro_pais_(iNumLinha)
  {
    var nomeCampo_pro_pais_ = "pro_pais_" + iNumLinha;
    var var_pro_pais_ = scAjaxGetFieldSelect(nomeCampo_pro_pais_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_provincia_validate_pro_pais_(var_pro_pais_, iNumLinha, var_script_case_init, do_ajax_form_sis_provincia_validate_pro_pais__cb);
  } // do_ajax_form_sis_provincia_validate_pro_pais_

  function do_ajax_form_sis_provincia_validate_pro_pais__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "pro_pais_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pro_pais_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "pro_pais_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pro_pais_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_provincia_validate_pro_pais__cb

  // ---------- Validate pro_nombre_
  function do_ajax_form_sis_provincia_validate_pro_nombre_(iNumLinha)
  {
    var nomeCampo_pro_nombre_ = "pro_nombre_" + iNumLinha;
    var var_pro_nombre_ = scAjaxGetFieldText(nomeCampo_pro_nombre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_provincia_validate_pro_nombre_(var_pro_nombre_, iNumLinha, var_script_case_init, do_ajax_form_sis_provincia_validate_pro_nombre__cb);
  } // do_ajax_form_sis_provincia_validate_pro_nombre_

  function do_ajax_form_sis_provincia_validate_pro_nombre__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "pro_nombre_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pro_nombre_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "pro_nombre_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pro_nombre_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_provincia_validate_pro_nombre__cb

  // ---------- Validate pro_codigo_
  function do_ajax_form_sis_provincia_validate_pro_codigo_(iNumLinha)
  {
    var nomeCampo_pro_codigo_ = "pro_codigo_" + iNumLinha;
    var var_pro_codigo_ = scAjaxGetFieldText(nomeCampo_pro_codigo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_provincia_validate_pro_codigo_(var_pro_codigo_, iNumLinha, var_script_case_init, do_ajax_form_sis_provincia_validate_pro_codigo__cb);
  } // do_ajax_form_sis_provincia_validate_pro_codigo_

  function do_ajax_form_sis_provincia_validate_pro_codigo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_provincia_validate_pro_codigo__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_sis_provincia_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_sis_provincia_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sis_provincia_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_sis_provincia_add_new_line_cb);
  } // do_ajax_form_sis_provincia_add_new_line

  function do_ajax_form_sis_provincia_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_sis_provincia_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_sis_provincia_backup_line(iNumLinha)
  {
    var var_pro_id_ = scAjaxGetFieldHidden("pro_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_provincia_backup_line(var_pro_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_sis_provincia_backup_line_cb);
  } // do_ajax_form_sis_provincia_backup_line

  function do_ajax_form_sis_provincia_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_sis_provincia_backup_line_cb

  function do_ajax_form_sis_provincia_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_sis_provincia_cancel_insert

  function do_ajax_form_sis_provincia_cancel_update(iSeqVert)
  {
    do_ajax_form_sis_provincia_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_sis_provincia_cancel_update

  function do_ajax_form_sis_provincia_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_sis_provincia_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_sis_provincia_table_refresh()
  {
    var var_pro_id_ = document.F2.pro_id_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_sis_provincia_table_refresh(var_pro_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_provincia_table_refresh_cb);
  } //  do_ajax_form_sis_provincia_table_refresh

  function do_ajax_form_sis_provincia_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.pro_id_.value = scAjaxGetKeyValue("pro_id_");
    ...
    scAjaxAlert(do_ajax_form_sis_provincia_table_refresh_cb_after_alert);
  } // do_ajax_form_sis_provincia_table_refresh_cb
  function do_ajax_form_sis_provincia_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_sis_provincia_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_sis_provincia_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_sis_provincia_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_pro_id_ = scAjaxGetFieldHidden("pro_id_" + iNumLinha);
    var var_pro_pais_ = scAjaxGetFieldSelect("pro_pais_" + iNumLinha);
    var var_pro_nombre_ = scAjaxGetFieldText("pro_nombre_" + iNumLinha);
...
?>
    x_ajax_form_sis_provincia_submit_form(var_pro_id_, var_pro_pais_, var_pro_nombre_, var_pro_codigo_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_provincia_submit_form_cb);
  } // do_ajax_form_sis_provincia_submit_form

  function do_ajax_form_sis_provincia_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("pro_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("pro_pais_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("pro_nombre_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sis_provincia_submit_form_cb_after_alert);
  } // do_ajax_form_sis_provincia_submit_form_cb
  function do_ajax_form_sis_provincia_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_provincia_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sis_provincia_navigate_form()
  {
    perform_ajax_form_sis_provincia_navigate_form();
  }

  function perform_ajax_form_sis_provincia_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_sis_provincia_cancel_insert(sc_form_sis_provincia_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("pro_id_" + iNavForm);
      scAjaxHideErrorDisplay("pro_pais_" + iNavForm);
      scAjaxHideErrorDisplay("pro_nombre_" + iNavForm);
    ...
    scAjaxProcOn();
    x_ajax_form_sis_provincia_navigate_form(var_pro_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_provincia_navigate_form_cb);
  } // do_ajax_form_sis_provincia_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_provincia']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_provincia_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.pro_id_.value = scAjaxGetKeyValue("pro_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_provincia_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_provincia_navigate_form_cb
  function do_ajax_form_sis_provincia_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_sis_provincia_navigate_form_cb_after_alert

    function sc_form_sis_provincia_get_last_line_number()
    {
    ...
    } //sc_form_sis_provincia_get_last_line_number

  function sc_hide_form_sis_provincia_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "pro_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pro_pais_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pro_nombre_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pro_codigo_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["pro_id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pro_pais_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_pais'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pro_nombre_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_provincia'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["pro_id_"][iNumLinha] = "pro_id_" + iNumLinha;
    ajax_field_mult["pro_pais_"][iNumLinha] = "pro_pais_" + iNumLinha;
    ajax_field_mult["pro_nombre_"][iNumLinha] = "pro_nombre_" + iNumLinha;
    ajax_field_mult["pro_codigo_"][iNumLinha] = "pro_codigo_" + iNumLinha;
    ajax_field_id["pro_id_" + iNumLinha] = new Array("hidden_field_label_pro_id_", "hidden_field_data_pro_id_" + iNumLinha);
    ajax_field_id["pro_pais_" + iNumLinha] = new Array("hidden_field_label_pro_pais_", "hidden_field_data_pro_pais_" + iNumLinha);
    ajax_field_id["pro_nombre_" + iNumLinha] = new Array("hidden_field_label_pro_nombre_", "hidden_field_data_pro_nombre_" + iNumLinha);
    ajax_field_id["pro_codigo_" + iNumLinha] = new Array("hidden_field_label_pro_codigo_", "hidden_field_data_pro_codigo_" + iNumLinha);
    ajax_error_count["pro_id_" + iNumLinha] = "off";
    ajax_error_count["pro_pais_" + iNumLinha] = "off";
    ajax_error_count["pro_nombre_" + iNumLinha] = "off";
    ajax_error_count["pro_codigo_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["pro_id_" + iNumLinha] = "on";
    ajax_read_only["pro_pais_" + iNumLinha] = "off";
    ajax_read_only["pro_nombre_" + iNumLinha] = "off";
    ajax_read_only["pro_codigo_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["pro_id_" + iNumLinha] = "on";
    ajax_read_only["pro_pais_" + iNumLinha] = "on";
    ajax_read_only["pro_nombre_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["pro_id_" + iNumLinha] = null;
    ajax_error_list["pro_pais_" + iNumLinha] = null;
    ajax_error_list["pro_nombre_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["pro_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pro_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pro_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pro_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pro_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["pro_pais_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pro_pais_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pro_pais_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pro_pais_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pro_pais_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["pro_nombre_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pro_nombre_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pro_nombre_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pro_nombre_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pro_nombre_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pro_id_'])) ? $this->nmgp_cmp_readonly['pro_id_'] : 'on';
?>
    scAjaxFieldRead("pro_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pro_pais_'])) ? $this->nmgp_cmp_readonly['pro_pais_'] : 'off';
?>
    scAjaxFieldRead("pro_pais_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pro_nombre_'])) ? $this->nmgp_cmp_readonly['pro_nombre_'] : 'off';
?>
    scAjaxFieldRead("pro_nombre_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pro_codigo_'])) ? $this->nmgp_cmp_readonly['pro_codigo_'] : 'off';
?>
  ...
  {
    scAjaxFieldRead("pro_id_" + iSeq, "on");
    scAjaxFieldRead("pro_pais_" + iSeq, "on");
    scAjaxFieldRead("pro_nombre_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["pro_id_" + iRow] || "on" == ajax_error_count["pro_pais_" + iRow] || "on" == ajax_error_count["pro_nombre_" + iRow] || "on" == ajax_error_count["pro_codigo_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pro_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pro_pais_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pro_nombre_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["pro_id_" + iRow] && "off" == ajax_error_count["pro_pais_" + iRow] && "off" == ajax_error_count["pro_nombre_" + iRow] && "off" == ajax_error_count["pro_codigo_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["pro_id_" + iRow] = "off";
        ajax_error_count["pro_pais_" + iRow] = "off";
        ajax_error_count["pro_nombre_" + iRow] = "off";
      ...
      $("#hidden_field_data_pro_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_pro_pais_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_pro_nombre_" + iRow).removeClass("scFormErrorLine");
