<?php
class form_del_detalle_pedido_form extends form_del_detalle_pedido_apl
{
function Form_Init()
{
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['sc_redir_atualiz'] == 'ok')
{
?>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_del_detalle_pedido/form_del_detalle_pedido_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_del_detalle_pedido_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_del_detalle_pedido_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['recarga'];
}
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    $opcao_botoes = 'inicio';
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['link_info']['remove_border']) {
...
<?php
 include_once("form_del_detalle_pedido_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_del_detalle_pedido'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_del_detalle_pedido'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-1';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_del_detalle_pedido);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_del_detalle_pedido = $this->form_vert_form_del_detalle_pedido;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_del_detalle_pedido))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_form_del_detalle_pedido as $sc_seq_vert => $sc_lixo)
   {
       $this->form_fixed_column_no = 0;
       $this->loadRecordState($sc_seq_vert);
       $this->dp_pedido_convenio_ = $this->form_vert_form_del_detalle_pedido[$sc_seq_vert]['dp_pedido_convenio_'];
       $this->dp_empresa_ = $this->form_vert_form_del_detalle_pedido[$sc_seq_vert]['dp_empresa_'];
       $this->dp_base_ice_ = $this->form_vert_form_del_detalle_pedido[$sc_seq_vert]['dp_base_ice_'];
       $this->dp_porcentaje_ice_ = $this->form_vert_form_del_detalle_pedido[$sc_seq_vert]['dp_porcentaje_ice_'];
       $this->dp_valor_ice_ = $this->form_vert_form_del_detalle_pedido[$sc_seq_vert]['dp_valor_ice_'];
       $this->dp_base_irbpnr_ = $this->form_vert_form_del_detalle_pedido[$sc_seq_vert]['dp_base_irbpnr_'];
       $this->dp_porcentaje_irbpnr_ = $this->form_vert_form_del_detalle_pedido[$sc_seq_vert]['dp_porcentaje_irbpnr_'];
       $this->dp_valor_irbpnr_ = $this->form_vert_form_del_detalle_pedido[$sc_seq_vert]['dp_valor_irbpnr_'];
       $this->dp_estado_ = $this->form_vert_form_del_detalle_pedido[$sc_seq_vert]['dp_estado_'];
       ...
       elseif ($Line_Add)
       {
        ...
        $this->dp_id_ = $this->form_vert_form_del_detalle_pedido[$sc_seq_vert]['dp_id_']; 
       $dp_id_ = $this->dp_id_; 
       if (!isset($this->nmgp_cmp_hidden['dp_id_']))
       {
           $this->nmgp_cmp_hidden['dp_id_'] = 'off';
       ...
       $this->dp_producto_ = $this->form_vert_form_del_detalle_pedido[$sc_seq_vert]['dp_producto_']; 
       ...
       $this->dp_descripcion_ = $this->form_vert_form_del_detalle_pedido[$sc_seq_vert]['dp_descripcion_']; 
       ...
       $this->dp_cantidad_ = $this->form_vert_form_del_detalle_pedido[$sc_seq_vert]['dp_cantidad_']; 
       ...
       $this->dp_precio_unitario_ = $this->form_vert_form_del_detalle_pedido[$sc_seq_vert]['dp_precio_unitario_']; 
       ...
       $this->dp_descuento_ = $this->form_vert_form_del_detalle_pedido[$sc_seq_vert]['dp_descuento_']; 
       ...
       $this->dp_subtotal_ = $this->form_vert_form_del_detalle_pedido[$sc_seq_vert]['dp_subtotal_']; 
       ...
       $this->dp_base_iva_ = $this->form_vert_form_del_detalle_pedido[$sc_seq_vert]['dp_base_iva_']; 
       ...
       $this->dp_porcentaje_iva_ = $this->form_vert_form_del_detalle_pedido[$sc_seq_vert]['dp_porcentaje_iva_']; 
       ...
       $this->dp_valor_iva_ = $this->form_vert_form_del_detalle_pedido[$sc_seq_vert]['dp_valor_iva_']; 
       ...
       $this->dp_total_ = $this->form_vert_form_del_detalle_pedido[$sc_seq_vert]['dp_total_']; 
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_del_detalle_pedido_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_del_detalle_pedido_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_del_detalle_pedido_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_del_detalle_pedido_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_del_detalle_pedido_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_del_detalle_pedido_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
<?php   
   ...
   { 
       ...
       $this->form_vert_form_del_detalle_pedido = $guarda_form_vert_form_del_detalle_pedido;
   } 
   if ($Table_refresh) 
   { 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_del_detalle_pedido");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_del_detalle_pedido");
 parent.scAjaxDetailHeight("form_del_detalle_pedido", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_pedido']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
