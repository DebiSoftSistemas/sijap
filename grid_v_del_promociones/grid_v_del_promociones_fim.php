...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_v_del_promociones"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_v_del_promociones"]);
   }
   ...
   $fecha_janela = false;
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_v_del_promociones']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_v_del_promociones']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_v_del_promociones']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_v_del_promociones']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_v_del_promociones']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_v_del_promociones</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_v_del_promociones']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_v_del_promociones']['embutida_filho'] as $ind => $sc_init)
          {
