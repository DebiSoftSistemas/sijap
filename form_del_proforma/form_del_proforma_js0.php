...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proforma']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proforma']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_del_proforma"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
{
  nm_gp_submit('<?php echo $this->Ini->link_blank_nueva_factura; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "var_tipo_documento*scin98*scout"; ?>', '', '_self', '0', '0', 'blank_nueva_factura');
}
var var_btn_Facturar_prof_numero = "<?php echo $this->form_encode_input($this->nmgp_dados_form['prof_numero']); ?>";
var var_btn_Facturar_var_proforma = "<?php echo $this->form_encode_input($this->nmgp_dados_form['prof_numero']); ?>";
...
{
  nm_gp_submit('<?php echo $this->Ini->link_form_del_proforma_facturar_edit; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "prof_numero*scin' + var_btn_Facturar_prof_numero + '*scoutvar_proforma*scin' + var_btn_Facturar_var_proforma + '*scoutNM_btn_insert*scinN*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinN*scout"; ?>', '', '_self', '0', '0', 'form_del_proforma_facturar');
}
var var_btn_Imprimir_var_proforma = "<?php echo $this->form_encode_input($this->nmgp_dados_form['prof_numero']); ?>";
...
{
  nm_gp_submit('<?php echo $this->Ini->link_pdf_proforma; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "var_proforma*scin' + var_btn_Imprimir_var_proforma + '*scout"; ?>', '', '_blank', '0', '0', 'pdf_proforma');
}
...
var var_btn_baucher_var_proforma = "<?php echo $this->form_encode_input($this->nmgp_dados_form['prof_numero']); ?>";
...
{
  nm_gp_submit('<?php echo $this->Ini->link_pdf_proforma_baucher; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "var_proforma*scin' + var_btn_baucher_var_proforma + '*scout"; ?>', '', '_blank', '0', '0', 'pdf_proforma_baucher');
}
 NM_tp_critica(1);
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_proforma']['where_detal']))
  {
?>  
...
function sc_inline_form(seqRow, keyParams, width, height)
{
  ...
  nm_gp_submit('<?php echo $this->Ini->link_form_del_proforma_inline ?>', '<?php echo $this->nm_location ?>', 'NM_btn_insert*scinN*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinN*scoutNMSC_modal*scinok*scoutsc_redir_atualiz*scinok*scoutsc_inline_call*scinY*scoutsc_seq_row*scin' + seqRow + '*scout' + callParams, '', 'modal', height, width);
}

function sc_inline_form_add(width, height)
{
  nm_gp_submit('<?php echo $this->Ini->link_form_del_proforma_inline ?>', '<?php echo $this->nm_location ?>', 'NM_btn_insert*scinY*scoutNM_btn_update*scinN*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinN*scoutNMSC_modal*scinok*scoutsc_redir_atualiz*scinok*scoutsc_inline_call*scinY*scoutnmgp_opcao*scinnovo*scout', '', 'modal', height, width);
}
