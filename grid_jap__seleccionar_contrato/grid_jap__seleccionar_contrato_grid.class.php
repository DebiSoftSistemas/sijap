<?php
class grid_jap__seleccionar_contrato_grid
{
   var $Ini;
   var $Erro;
   var $Db;
...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_jap__seleccionar_contrato']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_jap__seleccionar_contrato']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_jap__seleccionar_contrato']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['usr_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['usr_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['usr_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['grid_pesq'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['grid_pesq'] = array();
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['charts_html'] = '';
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'])
   { 
   ...
   { 
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['proc_pdf_vert'])
            {
            } 
            else
            {
       ...
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_jap__seleccionar_contrato'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'];
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_top();
       } 
       if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao_print'] != 'print')
       { 
           if ($this->Ini->grid_search_change_fil)
           { 
               $seq_search = 1;
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['grid_pesq'] as $cmp => $def)
               {
                  $Seq_grid      = $seq_search;
                  $Cmp_grid      = $cmp;
       ...
       unset ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['save_grid']);
       $this->grid();
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_bot();
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['print_all'] && empty($this->nm_grid_sem_reg) && ($Gera_res || $Gera_graf) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['SC_Ind_Groupby'] != "sc_free_total")
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] == "pdf")
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] == "pdf")
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] = "igual";
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'];
 }
...
//
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['orig_pesq'] = "grid";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['Ind_lig_mult'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['Ind_lig_mult'] = 0;
   }
   $this->Img_embbed      = false;
   $this->nm_data         = new nm_data("es");
   $this->pdf_label_group = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opc_pdf']['label_group'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opc_pdf']['label_group'] : "N";
   $this->pdf_all_cab     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opc_pdf']['all_cab']))     ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opc_pdf']['all_cab'] : "S";
   $this->pdf_all_label   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opc_pdf']['all_label']))   ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opc_pdf']['all_label'] : "S";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opc_liga']['fix_top'])) {
       $this->Fix_bar_top = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opc_liga']['fix_top'] == "S") ? true : false;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opc_liga']['fix_bot'])) {
       $this->Fix_bar_bottom = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opc_liga']['fix_bot'] == "S") ? true : false;
   }
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "grid_jap__seleccionar_contrato/grid_jap__seleccionar_contrato_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   foreach ($NM_css as $cada_css)
   {
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['doc_word'])
       { 
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['pesq_tab_label']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['pesq_tab_label'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['pesq_tab_label'] .= "con_ruta?#?" . "" . $this->Ini->Nm_lang['lang_ruta'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['pesq_tab_label'] .= "con_cedula?#?" . "" . $this->Ini->Nm_lang['lang_lot_identificacion'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['pesq_tab_label'] .= "con_nombre?#?" . "" . $this->Ini->Nm_lang['lang_nombre'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['pesq_tab_label'] .= "con_numero_contrato?#?" . "" . $this->Ini->Nm_lang['lang_numero_contrato'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['pesq_tab_label'] .= "con_numero_medidor?#?" . "" . $this->Ini->Nm_lang['lang_numero_medidor'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['pesq_tab_label'] .= "con_tipo_servicio?#?" . "" . $this->Ini->Nm_lang['lang_tipo_servicio'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['pesq_tab_label'] .= "con_condicion_contrato?#?" . "" . $this->Ini->Nm_lang['lang_condicion_contrato'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['pesq_tab_label'] .= "con_comunidad?#?" . "" . $this->Ini->Nm_lang['lang_comunidad'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['pesq_tab_label'] .= "con_sector?#?" . "" . $this->Ini->Nm_lang['lang_sector'] . "" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['pesq_tab_label'] .= "con_estado?#?" . "" . $this->Ini->Nm_lang['lang_estado'] . "" . "?@?";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['grid_search_add']))
   {
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['pesq_tab_label'];
       ...
       $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['grid_search_add']['seq'];
       $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['grid_search_add']['cmp'];
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['grid_search_add']);
       exit;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['dyn_search_aut_comp']))
   {
       $Cmp_select2 = array("con_cedula","con_nombre","con_numero_contrato","con_numero_medidor");
       $NM_func_aut_comp = "lookup_ajax_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['dyn_search_aut_comp']['cmp'];
       ...
       foreach ($nmgp_def_dados as $Ind => $Lista)
       {
          if (is_array($Lista))
          {
              foreach ($Lista as $Cod => $Valor)
              {
                  ...
                  if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['dyn_search_aut_comp']['cmp'], $Cmp_select2))
                  {
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['dyn_search_aut_comp']);
       exit;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'] || $this->Ini->Embutida_iframe)
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['force_toolbar']);
   } 
       $this->Tem_tab_vert = false;
   $this->width_tabula_quebra  = "0px";
   $this->width_tabula_display = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_jap__seleccionar_contrato']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_jap__seleccionar_contrato']['lig_edit'] != '')
   {
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_jap__seleccionar_contrato']['lig_edit'] == "on")  {$_SESSION['scriptcase']['sc_apl_conf']['grid_jap__seleccionar_contrato']['lig_edit'] = "S";}
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_jap__seleccionar_contrato']['lig_edit'] == "off") {$_SESSION['scriptcase']['sc_apl_conf']['grid_jap__seleccionar_contrato']['lig_edit'] = "N";}
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_jap__seleccionar_contrato']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['mostra_edit'] = "N";
       }
   }
   if ($this->Ini->SC_Link_View || ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opc_psq'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['psq_edit'] == 'N'))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['mostra_edit'] = "N";
   }
   $this->NM_cont_body   = 0; 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ind_tree'] = 0;
   }
   elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['emb_tree_no']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['emb_tree_no'])
   { 
       $this->NM_emb_tree_no = true; 
   }
   $this->aba_iframe = false;
   $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['print_all'];
   if ($this->Print_All)
   {
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("grid_jap__seleccionar_contrato", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   $this->Cmps_ord_def['con_celular'] = " asc";
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_jap__seleccionar_contrato']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_jap__seleccionar_contrato']['btn_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_jap__seleccionar_contrato']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
       {
           $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
       }
   }
   $this->Proc_link_res = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['where_resumo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['where_resumo'])) 
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['doc_word'] || $this->Ini->sc_export_ajax_img)
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['where_pesq_ant'];  
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['campos_busca']))
   { 
       $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['campos_busca'];
       ...
       $this->con_sector = (isset($Busca_temp['con_sector'])) ? $Busca_temp['con_sector'] : ""; 
       $tmp_pos = (is_string($this->con_sector)) ? strpos($this->con_sector, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->con_sector))
       {
           $this->con_sector = substr($this->con_sector, 0, $tmp_pos);
       }
   ...
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['where_pesq_filtro'];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] = "muda_qt_linhas";
   } 
   $this->New_label['con_ruta'] = "" . $this->Ini->Nm_lang['lang_ruta'] . "";
   $this->New_label['con_cedula'] = "" . $this->Ini->Nm_lang['lang_lot_identificacion'] . "";
   $this->New_label['con_nombre'] = "" . $this->Ini->Nm_lang['lang_nombre'] . "";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['dashboard_info']['maximized']) {
       $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['dashboard_info']['dashboard_app'];
       if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_jap__seleccionar_contrato'])) {
           $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_jap__seleccionar_contrato'];
   ...
   if ($this->Ini->Embutida_iframe) {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['sub_cons_iframe_btns'] as $BTN => $BTN_opc) {
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "grid_jap__seleccionar_contrato/grid_jap__seleccionar_contrato_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "grid_jap__seleccionar_contrato_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   $this->Tot         = new grid_jap__seleccionar_contrato_total($this->Ini->sc_page);
   $this->Tot->Db     = $this->Db;
   $this->Tot->Erro   = $this->Erro;
   $this->Tot->Ini    = $this->Ini;
   $this->Tot->Lookup = $this->Lookup;
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['qt_lin_grid'] = 10;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_jap__seleccionar_contrato']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_jap__seleccionar_contrato']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_jap__seleccionar_contrato']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_jap__seleccionar_contrato']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_jap__seleccionar_contrato']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_jap__seleccionar_contrato']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_jap__seleccionar_contrato']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_jap__seleccionar_contrato']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['qt_lin_grid']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ordem_select']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ordem_select'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ordem_select_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ordem_select']; 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ordem_quebra'] = array(); 
       } 
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] = "inicio" ;  
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ordem_grid'] = ""; 
                       $ordem = ($ordem == "asc") ? "desc" : "asc";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['prim_cons'] || !empty($nmgp_parms))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['prim_cons'] = false;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['where_orig'] = "";  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['where_pesq_ant']    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['cond_pesq']         = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['where_pesq_filtro'] = "";
   }   
   if  (!empty($this->nm_where_dinamico)) 
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['where_pesq_filtro'];
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao']       = "igual" ; 
...
// 
   $this->count_ger = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] == "final" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['qt_reg_grid'] == "all") 
   { 
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['tot_geral'][1] ;  
       $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['tot_geral'][1];
   } 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['contr_total_geral'] = "NAO";
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['sc_total']);
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['tot_geral'][1] ;  
   $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['tot_geral'][1];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
   {
       $this->Ini->Qtd_reg_ajax_grid = $this->count_ger;
   }
   else
   {
       $this->Ini->Qtd_reg_ajax_grid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['qt_reg_grid'];
   }
//----- 
    if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
   { 
       $nmgp_select = "SELECT con_ruta, con_cedula, con_nombre, con_tipo_servicio, con_numero_contrato, con_estado, con_id, con_telefono, con_celular, con_direccion_predio, con_condicion_contrato, con_comunidad, con_sector, con_sino from (SELECT     con_id,     con_empresa,     con_propietario,     con_nombre,     con_cedula,     con_telefono,     con_celular,     con_direccion_propietario,     con_correo,     con_pais,     con_provincia,     con_canton,     con_parroquia,     con_direccion_predio,     con_toma_administrativa,     con_toma_operativa,     con_tipo_servicio,     con_condicion_contrato,     con_numero_medidor,     con_estado,     con_numero_contrato,     con_ruta,     con_sino,     con_comunidad,     con_sector FROM     v_jap_contrato where con_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "' and con_estado in ('V','S') and con_id not in (SELECT des_contrato FROM jap_deudas_escenario where des_escenario=" . $_SESSION['var_escenario'] . ")) nm_sel_esp"; 
   } 
   ...
   $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['where_pesq']; 
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ordem_desc']; 
   } 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       ...
       $this->con_cedula = $this->rs_grid->fields[1] ;  
       $this->con_nombre = $this->rs_grid->fields[2] ;  
       $this->con_tipo_servicio = $this->rs_grid->fields[3] ;  
       $this->con_tipo_servicio = (string)$this->con_tipo_servicio;
       $this->con_numero_contrato = $this->rs_grid->fields[4] ;  
       $this->con_estado = $this->rs_grid->fields[5] ;  
       $this->con_id = $this->rs_grid->fields[6] ;  
       $this->con_id = (string)$this->con_id;
       $this->con_telefono = $this->rs_grid->fields[7] ;  
       $this->con_celular = $this->rs_grid->fields[8] ;  
       $this->con_direccion_predio = $this->rs_grid->fields[9] ;  
       $this->con_condicion_contrato = $this->rs_grid->fields[10] ;  
       $this->con_condicion_contrato = (string)$this->con_condicion_contrato;
       $this->con_comunidad = $this->rs_grid->fields[11] ;  
       $this->con_comunidad = (string)$this->con_comunidad;
       $this->con_sector = $this->rs_grid->fields[12] ;  
       $this->con_sector = (string)$this->con_sector;
       $this->con_sino = $this->rs_grid->fields[13] ;  
       $GLOBALS["con_tipo_servicio"] = $this->rs_grid->fields[3] ;  
       $GLOBALS["con_tipo_servicio"] = (string)$GLOBALS["con_tipo_servicio"] ;
       $GLOBALS["con_estado"] = $this->rs_grid->fields[5] ;  
       $GLOBALS["con_condicion_contrato"] = $this->rs_grid->fields[10] ;  
       $GLOBALS["con_condicion_contrato"] = (string)$GLOBALS["con_condicion_contrato"] ;
       $GLOBALS["con_comunidad"] = $this->rs_grid->fields[11] ;  
       $GLOBALS["con_comunidad"] = (string)$GLOBALS["con_comunidad"] ;
       $GLOBALS["con_sector"] = $this->rs_grid->fields[12] ;  
       $GLOBALS["con_sector"] = (string)$GLOBALS["con_sector"] ;
       $this->SC_seq_register = $this->nmgp_reg_start ; 
       $this->SC_seq_page = 0;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['final']; 
   ...
   $this->NM_hidden_filters = ($this->Ini->Embutida_iframe && !empty($this->nm_grid_sem_reg) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['initialize']) ? true : false;
   $this->nmgp_reg_inicial  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['final'] + 1;
   $this->nmgp_reg_final    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['qt_reg_grid'];
   $this->nmgp_reg_final    = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['doc_word'] && !$this->Ini->sc_export_ajax)
       {
           require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
           $this->pb = new scProgressBar();
           $this->pb->setRoot($this->Ini->root);
           $this->pb->setDir($_SESSION['scriptcase']['grid_jap__seleccionar_contrato']['glo_nm_path_imag_temp'] . "/");
           $this->pb->setProgressbarMd5($_GET['pbmd5']);
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['word_return']);
       ...
       if ($this->Ini->Proc_print && $this->Ini->Export_html_zip  && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['print_return']);
           $this->pb->setTotalSteps($this->count_ger);
       }
       if (!$this->Ini->sc_export_ajax && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> v_jap_contrato :: PDF</TITLE>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['pivot_charts']) : 0;
           ...
           if (-1 < $this->progress_grid)
           {
               ...
               grid_jap__seleccionar_contrato_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
               grid_jap__seleccionar_contrato_pdf_progress_call($this->Ini->path_js   . "\n", $this->Ini->Nm_lang);
               grid_jap__seleccionar_contrato_pdf_progress_call($this->Ini->path_prod . "/img/\n", $this->Ini->Nm_lang);
               grid_jap__seleccionar_contrato_pdf_progress_call($this->progress_tot   . "\n", $this->Ini->Nm_lang);
               ...
               grid_jap__seleccionar_contrato_pdf_progress_call($this->progress_tot . "_#NM#_" . "1_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
       ...
       $nm_saida->saida("  <HEAD>\r\n");
       $nm_saida->saida("   <TITLE>" . $this->Ini->Nm_lang['lang_othr_grid_title'] . " v_jap_contrato</TITLE>\r\n");
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'] && $this->NM_opcao != "pdf") {
           $nm_saida->saida("   <link rel=\"shortcut icon\" href=\"../_lib/img/usr__NM__img__NM__favicon.png\">\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ajax_nav'] && !$this->Ini->sc_export_ajax)
       { 
           ...
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_jap__seleccionar_contrato_jquery_8033.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_jap__seleccionar_contrato_ajax.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_jap__seleccionar_contrato_message.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida']) {  
        ...
        <link rel='stylesheet' href='../_lib/lib/css/nm_mobile.css' type='text/css'/>
          <?php }
           ...
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['qt_reg_grid']) . ";\r\n");
           }
           ...
           $nm_saida->saida("    {\r\n");
           $nm_saida->saida("        let cells = $(\".sc-ui-grid-header-row-grid_jap__seleccionar_contrato-1\").find(\"td\");\r\n");
           ...
           $nm_saida->saida("        rows = $(\".sc-ui-grid-header-row-grid_jap__seleccionar_contrato-1\");\r\n");
           ...
           $nm_saida->saida("   var gridHeaders = $(\".sc-ui-grid-header-row-grid_jap__seleccionar_contrato-1\"), headerDisplayed = true;\r\n");
           ...
           $nm_saida->saida("   tableOriginal = document.getElementById(\"sc-ui-grid-body-5837d77a\");\r\n");
           ...
           if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao_print'] != 'print' && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['grid_pesq']))
           { 
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ancor_save']);
           }
           $nm_saida->saida("   });\r\n");
...
$nm_saida->saida("}\r\n");
       ...
       $nm_saida->saida("<style type=\"text/css\">\r\n");
       $nm_saida->saida("</style>\r\n");
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['num_css']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['num_css'] = rand(0, 1000);
       }
       $write_css = true;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'] && !$this->Print_All && $this->NM_opcao != "print" && $this->NM_opcao != "pdf")
       {
           $write_css = false;
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida_pdf']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida_pdf'])
       {
           $write_css = true;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_jap__seleccionar_contrato_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'])
       {
 ...
 { 
       ...
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_jap__seleccionar_contrato_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_grid_jap__seleccionar_contrato_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] != "pdf") {
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_jap__seleccionar_contrato/grid_jap__seleccionar_contrato_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['proc_pdf_vert'])
  {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           ...
           if ($Pos1 !== false && $Pos2 !== false) {
               ...
               $cada_css = ".grid_jap__seleccionar_contrato_" . substr(trim($Tag[0]), 1);
               if (isset($Tag[1])) {
                   $cada_css .= ", .grid_jap__seleccionar_contrato_" . substr(trim($Tag[1]), 1);
               }
               $cada_css .= $Css;
           }
           else {
               $cada_css = ".grid_jap__seleccionar_contrato_" . substr($cada_css, 1);
           }
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   $this->css_body_embutida = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['css_body_embutida'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['css_body_embutida'] : "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'])
   { 
       if (!$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['doc_word'] && ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao_print'] == "print")) 
       {
           if ($this->Print_All) 
           {
               $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
       ...
       {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
          $vertical_center = '';
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] != "pdf" && !$this->Print_All)
       { 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['css_body_embutida'])) {
       $remove_border = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['css_body_embutida'];
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['proc_pdf_vert'])
   {
   }
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_jap__seleccionar_contrato']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_jap__seleccionar_contrato']) . "_";
           } 
       } 
       else 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_jap__seleccionar_contrato']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_jap__seleccionar_contrato']) . "_";
           } 
       }
   }
   $temp_css  = explode("/", $compl_css);
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida']) ? "grid_jap__seleccionar_contrato_" : "";
   $this->css_sep = " ";
   ...
   $this->css_con_celular_label = $compl_css_emb . "css_con_celular_label";
   $this->css_con_celular_grid_line = $compl_css_emb . "css_con_celular_grid_line";
...
//----- 
 function cabecalho_normal()
 {
   global
          $nm_saida;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['dashboard_info']['maximized'])
   {
       return; 
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opc_liga']['cab']))
   {
       return; 
   }
   if ($this->Ini->Embutida_iframe) {
   ...
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['where_pesq_filtro'];
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['cond_pesq']))
   {  
       $pos       = 0;
       $trab_pos  = false;
       $pos_tmp   = true; 
       $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['cond_pesq'];
       while ($pos_tmp)
       {
          $pos = strpos($tmp, "##*@@", $pos);
          if ($pos !== false)
       ...
       $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
       $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
       $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['cond_pesq'], 0, $trab_pos);
   ...
   $_SESSION['scriptcase']['grid_jap__seleccionar_contrato']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['grid_jap__seleccionar_contrato']['contr_erro'] = 'off';
   ...
   { 
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['proc_pdf']) 
     { 
         $this->NM_calc_span();
           $nm_saida->saida("   <TD colspan=\"" . $this->NM_colspan . "\" class=\"" . $this->css_scGridTabelaTd . "\" style=\"vertical-align: top\">\r\n");
     } 
     else if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['proc_pdf_vert']) 
     {
...
// 
 function label_grid($linhas = 0)
 {
   ...
   $salva_htm_emb  = "";
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida_label'])
   { 
       $this->New_label['con_ruta'] = "" . $this->Ini->Nm_lang['lang_ruta'] . "";
       $this->New_label['con_cedula'] = "" . $this->Ini->Nm_lang['lang_lot_identificacion'] . "";
       $this->New_label['con_nombre'] = "" . $this->Ini->Nm_lang['lang_nombre'] . "";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['exibe_titulos']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
   ...
   $nm_saida->saida("    <TR id=\"tit_grid_jap__seleccionar_contrato__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-grid_jap__seleccionar_contrato-" . $tmp_header_row . "\">\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida_label']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_con_sector_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opc_psq']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_con_sector_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['field_order'] as $Cada_label)
   { 
   ...
   $nm_saida->saida("</TR>\r\n");
             ...
             foreach ($NM_css as $cada_css)
             {
                 ...
                 if ($Pos1 !== false && $Pos2 !== false) {
                     ...
                     $css_emb .= $cada_css . $Css;
                       ...
                       $css_emb .= ".grid_jap__seleccionar_contrato_" . substr($cada_css, 1);
                 }
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
     ...
     $NM_seq_lab = 1;
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['labels'] as $NM_cmp => $NM_lab)
     {
         if (empty($NM_lab) || $NM_lab == "&nbsp;")
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['labels'][$NM_cmp] = "No_Label" . $NM_seq_lab;
             $NM_seq_lab++;
         }
     } 
   } 
 ...
 function NM_label_con_ruta()
 {
   ...
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] != 'pdf') {
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['con_nombre'])) ? $this->New_label['con_nombre'] : "" . $this->Ini->Nm_lang['lang_nombre'] . "";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
 ...
 function NM_label_seleccionar()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_seleccionar_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_seleccionar_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = 'left';
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['con_telefono'])) ? $this->New_label['con_telefono'] : "Con Telefono";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
 ...
 function NM_label_con_celular()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['con_celular'])) ? $this->New_label['con_celular'] : "Con Celular";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
   ...
   if (!isset($this->NM_cmp_hidden['con_celular']) || $this->NM_cmp_hidden['con_celular'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_con_celular_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_con_celular_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
        $fieldSortRule = $this->scGetColumnOrderRule('con_celular');
        $fieldSortIcon = $this->scGetColumnOrderIcon('con_celular', $fieldSortRule);
        if (empty($this->Ini->Label_sort_pos) || $this->Ini->Label_sort_pos == 'right') {
            $this->Ini->Label_sort_pos = 'right_field';
        }
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_con_celular_label . "\" style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_field') {
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\">" . $fieldSortIcon . "<div style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div></div>";
        } elseif ($this->Ini->Label_sort_pos == 'right_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_con_celular_label . "\" style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\">" . $fieldSortIcon . "<div style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div></div>";
        } else {
            $label_labelContent = "<div style=\"flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>";
        }
        $label_labelContent = "<a href=\"javascript:nm_gp_submit2('con_celular')\" class=\"" . $this->css_scGridLabelLink . "\">". $label_labelContent . "</a>";
        $label_divLabel = "<div style=\"flex-grow: 1\">". $label_labelContent . "</div>";
        // controls
        $label_chart = '';
        $label_fixedColumn = '';
 ...
 function NM_label_con_comunidad()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_con_comunidad_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_con_comunidad_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
 ...
 function NM_label_con_sector()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_con_sector_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_con_sector_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
...
function SC_label_rightActionBar()
{
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ordem_cmp'] == $fieldName) {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ordem_label'] == 'desc') {
                $sortRule = 'desc';
            } else {
                $sortRule = 'asc';
            }
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ini_cor_grid']);
       }
   }
...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['labels']['con_ruta'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['con_cedula'])) ? $this->New_label['con_cedula'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['labels']['con_cedula'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['con_nombre'])) ? $this->New_label['con_nombre'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['labels']['con_nombre'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['con_tipo_servicio'])) ? $this->New_label['con_tipo_servicio'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['labels']['con_tipo_servicio'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['con_numero_contrato'])) ? $this->New_label['con_numero_contrato'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['labels']['con_numero_contrato'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['con_estado'])) ? $this->New_label['con_estado'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['labels']['con_estado'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['seleccionar'])) ? $this->New_label['seleccionar'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['labels']['seleccionar'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['con_id'])) ? $this->New_label['con_id'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['labels']['con_id'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['con_telefono'])) ? $this->New_label['con_telefono'] : "Con Telefono";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['labels']['con_telefono'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['con_celular'])) ? $this->New_label['con_celular'] : "Con Celular";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['labels']['con_celular'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['con_direccion_predio'])) ? $this->New_label['con_direccion_predio'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['labels']['con_direccion_predio'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['con_condicion_contrato'])) ? $this->New_label['con_condicion_contrato'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['labels']['con_condicion_contrato'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['con_comunidad'])) ? $this->New_label['con_comunidad'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['labels']['con_comunidad'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['con_sector'])) ? $this->New_label['con_sector'] : "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['labels']['con_sector'] = $SC_Label; 
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['grid_jap__seleccionar_contrato']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_jap__seleccionar_contrato']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_jap__seleccionar_contrato']['lig_edit'];
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_grid_jap__seleccionar_contrato#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               ...
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['cab_embutida'] != "S")
               {
       ...
       else
       {
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['force_toolbar'] = true;
           } 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ajax_nav'])
           { 
               $_SESSION['scriptcase']['saida_html'] = "";
           } 
           $nm_saida->saida("  " . $this->nm_grid_sem_reg . "\r\n");
           ...
           $nm_saida->saida("  </td></tr>\r\n");
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
           { 
               $this->sumario_mobile() ; 
           } 
       }
...
else
{
       ...
       $nm_id_aplicacao = " id=\"apl_grid_jap__seleccionar_contrato#?#1\"";
   } 
   $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] == "pdf") ? "padding: 0px !important;" : "";
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['proc_pdf_vert'])
{
}
else
...
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['proc_pdf']) { 
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['proc_pdf']) { 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-5837d77a\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['proc_pdf_vert']) { 
    $nm_saida->saida("</thead>\r\n");
 }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['proc_pdf'] && $this->pdf_all_label != "S" && $this->pdf_label_group != "S") 
   { 
      $this->label_grid($linhas);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida_grid'])
...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['Config_Page_break_PDF'] = "S";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['Page_break_PDF']))
   {
       if (isset($this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['SC_Ind_Groupby']]))
       {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['SC_Gb_Free_cmp'] as $Cmp_gb => $resto)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['Page_break_PDF'][$Cmp_gb] = $this->Break_pag_pdf['sc_free_group_by'][$Cmp_gb];
               }
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['Page_break_PDF'] = $this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['SC_Ind_Groupby']];
           }
       }
       else
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['Page_break_PDF'] = array();
       }
   }
   ...
   $nm_houve_quebra = "N";
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          ...
          //---------- Gauge ----------
          if (!$this->Ini->sc_export_ajax && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
              if (0 == $this->progress_lim_now)
              {
               ...
               if (!NM_is_utf8($lang_protect))
               {
                  ...
                  grid_jap__seleccionar_contrato_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $lang_protect . " " . $this->progress_now . "...\n", $this->Ini->Nm_lang);
          ...
          $GLOBALS["con_sector"] = (string)$GLOBALS["con_sector"];
          $this->SC_seq_page++; 
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['final'] + 1; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['rows_emb']++;
...
$_SESSION['scriptcase']['grid_jap__seleccionar_contrato']['contr_erro'] = 'off';
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida_opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['dado_psq_ret'];
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida_grid']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->Css_Cmp['css_con_sector_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"   HEIGHT=\"0px\">&nbsp;</TD>\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opc_psq']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  style=\"" . $this->Css_Cmp['css_con_sector_grid_line'] . "\" NOWRAP align=\"left\" valign=\"top\" WIDTH=\"1px\"  HEIGHT=\"0px\">\r\n");
 $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcapture", "document.Fpesq.nm_ret_psq.value='" . str_replace(array("'", '"'), array("\'", '\"'), $teste) . "'; nm_escreve_window();", "document.Fpesq.nm_ret_psq.value='" . str_replace(array("'", '"'), array("\'", '\"'), $teste) . "'; nm_escreve_window();", "", "Rad_psq", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
          ...
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['field_order'] as $Cada_col)
          { 
   ...
   $this->SC_grid_rightActionBar();
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['exibe_total'] == "S")
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
       } 
   }  
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida_grid'])
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
       $this->sumario_mobile() ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida_grid'])
...
function SC_grid_rightActionBar()
{
 ...
 function NM_grid_con_ruta()
 {
      ...
      if (!isset($this->NM_cmp_hidden['con_ruta']) || $this->NM_cmp_hidden['con_ruta'] != "off") { 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'] && !empty($conteudo)) 
          { 
 ...
 function NM_grid_con_cedula()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['con_cedula']) || $this->NM_cmp_hidden['con_cedula'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'con_cedula', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] != 'pdf') {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_con_cedula_grid_line . "\"  style=\"" . $this->Css_Cmp['css_con_cedula_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_con_cedula_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_con_nombre()
 {
      ...
      if (!isset($this->NM_cmp_hidden['con_nombre']) || $this->NM_cmp_hidden['con_nombre'] != "off") { 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'con_nombre', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] != 'pdf') {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_con_nombre_grid_line . "\"  style=\"" . $this->Css_Cmp['css_con_nombre_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_con_nombre_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 ...
 function NM_grid_con_estado()
 {
      ...
      if (!isset($this->NM_cmp_hidden['con_estado']) || $this->NM_cmp_hidden['con_estado'] != "off") { 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'con_estado', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] != 'pdf') {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_con_estado_grid_line . "\"  style=\"" . $this->Css_Cmp['css_con_estado_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_con_estado_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_seleccionar()
 {
      ...
      if (!isset($this->NM_cmp_hidden['seleccionar']) || $this->NM_cmp_hidden['seleccionar'] != "off") { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
              $conteudo = NM_encode_input(sc_strip_script($this->seleccionar));
              $conteudo_original = NM_encode_input(sc_strip_script($this->seleccionar));
          }
          else {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_seleccionar_grid_line . "\"  style=\"display:" . $FieldDisp . ";" . $this->Css_Cmp['css_seleccionar_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  ><span id=\"id_sc_field_seleccionar_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
 }
 function NM_grid_con_id()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_con_id_grid_line . "\"  style=\"display:" . $FieldDisp . ";" . $this->Css_Cmp['css_con_id_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_Hidden_con_id_" . $this->SC_seq_page . "\" style= \"display: none;\">" . $this->con_id . "</span><span id=\"id_sc_field_con_id_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
 }
 function NM_grid_con_telefono()
 {
      ...
      if (!isset($this->NM_cmp_hidden['con_telefono']) || $this->NM_cmp_hidden['con_telefono'] != "off") { 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'con_telefono', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] != 'pdf') {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_con_telefono_grid_line . "\"  style=\"" . $this->Css_Cmp['css_con_telefono_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_con_telefono_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_con_celular()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['con_celular']) || $this->NM_cmp_hidden['con_celular'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
              $conteudo = NM_encode_input(sc_strip_script($this->con_celular));
              $conteudo_original = NM_encode_input(sc_strip_script($this->con_celular));
          }
          else {
              $conteudo = sc_strip_script($this->con_celular); 
              $conteudo_original = sc_strip_script($this->con_celular); 
          }
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'con_celular', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] != 'pdf') {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_con_celular_grid_line . "\"  style=\"" . $this->Css_Cmp['css_con_celular_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_con_celular_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 ...
 function NM_grid_con_comunidad()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_con_comunidad_grid_line . "\"  style=\"" . $this->Css_Cmp['css_con_comunidad_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_con_comunidad_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_con_sector()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_con_sector_grid_line . "\"  style=\"" . $this->Css_Cmp['css_con_sector_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_con_sector_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 ...
 function nm_quebra_pagina($nm_parms)
 {
    ...
    if (($this->Ini->nm_limite_lin > 0 && $this->Ini->nm_cont_lin > $this->Ini->nm_limite_lin) || $nm_parms == "pagina" || $nm_parms == "resumo" || $nm_parms == "total")
    {
        ...
        if ($this->Print_All)
        {
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['print_navigator']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['print_navigator'] == "Netscape")
            {
        ...
        if ($nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'])
        {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['proc_pdf']) { 
           }
           else
           {
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['proc_pdf_vert']) { 
                $nm_saida->saida("     <thead>\r\n");
               }
               $this->cabecalho();
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['proc_pdf_vert']) { 
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['proc_pdf'] && ($this->pdf_all_cab == "S" || $this->pdf_all_label == "S")) { 
            $nm_saida->saida(" <thead> \r\n");
            if ($this->pdf_all_cab == "S")
            {
                $this->cabecalho();
            }
            if ($this->pdf_all_label == "S" && $nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida_grid'])
            {
                $this->label_grid();
            }
            $nm_saida->saida(" </thead> \r\n");
        }
        if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['proc_pdf'] && $nm_parms != "resumo" && $nm_parms != "pagina" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida_grid'])
        {
            $this->label_grid();
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['proc_pdf'] && $this->pdf_label_group != "S" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida_grid'])
        {
            $this->nm_inicio_pag = 0;
        }
    }
 ...
 { global $nm_saida, $nm_lang; 
   ...
   $nm_sumario = str_replace("?final?", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['final'], $nm_sumario);
...
$nm_saida->saida("    </style>\r\n");
      ...
      if ($this->nmgp_botoes['group_1'] == "on" && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("           $Cod_Btn\r\n");
      if ($this->nmgp_botoes['pdf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      ...
      $Tem_pdf_res = "n";
          ...
          $nm_saida->saida("            <div id=\"div_pdf_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "pdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + P)", "thickbox", "" . $this->Ini->path_link . "grid_jap__seleccionar_contrato/grid_jap__seleccionar_contrato_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=8&lpapel=279&apapel=216&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&sc_ver_93=s&nm_tem_gb=" . $Tem_gb_pdf . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_pdf_res=grid&nm_all_modules=grid&nm_label_group=N&nm_all_cab=S&nm_all_label=S&nm_orient_grid=2&password=n&summary_export_columns=S&pdf_zip=N&origem=cons&language=es&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_jap__seleccionar_contrato&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_word_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['SC_Ind_Groupby'] != "sc_free_total")
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['SC_Gb_Free_cmp']))
          {
              $Tem_word_res = "n";
          }
          $nm_saida->saida("            <div id=\"div_word_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $this->nm_btn_exist['word'][] = "word_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "grid_jap__seleccionar_contrato/grid_jap__seleccionar_contrato_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=" . $Tem_word_res . "&nm_ini_word_res=grid&nm_all_modules=grid&password=n&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_xls_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['SC_Ind_Groupby'] != "sc_free_total")
          ...
          $nm_saida->saida("            <div id=\"div_xls_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "xls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_jap__seleccionar_contrato/grid_jap__seleccionar_contrato_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_jap__seleccionar_contrato&nm_tp_xls=xlsx&nm_tot_xls=S&nm_res_cons=" . $Tem_xls_res . "&nm_ini_xls_res=grid&nm_all_modules=grid&password=n&summary_export_columns=S&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['print'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Tem_pdf_res = "n";
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div id=\"div_print_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $this->nm_btn_exist['print'][] = "print_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "print_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + P)", "thickbox", "" . $this->Ini->path_link . "grid_jap__seleccionar_contrato/grid_jap__seleccionar_contrato_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=RC&nm_cor=CO&password=n&language=es&nm_page=" . NM_encode_input($this->Ini->sc_page) . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_prt_res=grid&nm_all_modules=grid&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['sel_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      $pos_path = strrpos($this->Ini->path_prod, "/");
      $path_fields = $this->Ini->root . substr($this->Ini->path_prod, 0, $pos_path) . "/conf/fields/";
              $this->nm_btn_exist['sel_col'][] = "selcmp_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcolumns", "scBtnSelCamposShow('" . $this->Ini->path_link . "grid_jap__seleccionar_contrato/grid_jap__seleccionar_contrato_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnSelCamposShow('" . $this->Ini->path_link . "grid_jap__seleccionar_contrato/grid_jap__seleccionar_contrato_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "selcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if (is_file($this->Ini->root . $this->Ini->path_img_global . $this->Ini->Img_sep_grid))
      {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['SC_Ind_Groupby'] != "sc_free_total")
        {
          ...
          if (is_file("grid_jap__seleccionar_contrato_help.txt") && !$this->grid_emb_form)
          {
             $Arq_WebHelp = file("grid_jap__seleccionar_contrato_help.txt"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['dashboard_info']['under_dashboard']))
      {
         $this->nmgp_botoes['exit'] = "off"; 
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opc_psq'])
      ...
      {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['sc_modal'])
        {
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['guardar'] == "on" && !$this->grid_emb_form) 
      { 
          $this->nm_btn_exist['guardar'][] = "sc_guardar_top";
          $Cod_Btn = nmButtonOutput($this->arr_buttons, "guardar", "sc_btn_guardar();", "sc_btn_guardar();", "sc_guardar_top", "", "" . $this->Ini->Nm_lang['lang_agregar_contratos'] . "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
          $nm_saida->saida("          $Cod_Btn \r\n");
          $NM_btn = true;
      } 
          $nm_saida->saida("         </td> \r\n");
...
$nm_saida->saida("    </style>\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao_print'] != "print") 
      {
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['qtline'] == "on" && $this->Ini->Apl_paginacao != "FULL")
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['qt_lin_grid'] == '10') ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['qt_lin_grid'] == '20') ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['qt_lin_grid'] == '50') ? " selected" : "";
              $nm_saida->saida("           <option value=\"50\" " . $obj_sel . ">50</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['qt_lin_grid'] == 'all') ? " selected" : "";
      ...
      if (is_file($this->Ini->root . $this->Ini->path_img_global . $this->Ini->Img_sep_grid))
      {
          ...
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opc_liga']['nav']))
          {
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['navpage'] == "on" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opc_liga']['nav']) && $this->Ini->Apl_paginacao != "FULL" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['qt_lin_grid'] != "all")
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['qt_lin_grid'];
              $Max_link   = 5;
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opc_liga']['nav']))
          {
...
$nm_saida->saida("    </style>\r\n");
      ...
      $Tem_pdf_res = "n";
              $this->nm_btn_exist['pdf'][] = "pdf_top";
          $nm_saida->saida("            <div id=\"div_pdf_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "pdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + P)", "thickbox", "" . $this->Ini->path_link . "grid_jap__seleccionar_contrato/grid_jap__seleccionar_contrato_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=8&lpapel=279&apapel=216&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&sc_ver_93=s&nm_tem_gb=" . $Tem_gb_pdf . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_pdf_res=grid&nm_all_modules=grid&nm_label_group=N&nm_all_cab=S&nm_all_label=S&nm_orient_grid=2&password=n&summary_export_columns=S&pdf_zip=N&origem=cons&language=es&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_jap__seleccionar_contrato&KeepThis=true&TB_iframe=true&modal=true", "group_4", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['sort_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_5_top = true;</script>\r\n");
          ...
          $nm_saida->saida("            <div id=\"div_ordcmp_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bsort", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_jap__seleccionar_contrato/grid_jap__seleccionar_contrato_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_jap__seleccionar_contrato/grid_jap__seleccionar_contrato_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "ordcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_5", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
   ...
   function html_grid_search()
   {
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['grid_pesq'])?'none':'';
       if(!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ajax_nav'])
       {
          $nm_saida->saida("   <tr id=\"NM_Grid_Search\" ajax='' style='display:" . $str_display . "'>\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['grid_pesq']))
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['grid_pesq'] as $cmp => $def)
           {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['save_grid']))
           {
               return;
           }
           else
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
                        ...
                        if ($cmp == "con_sector")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "con_sector";
                           $lin_obj = $this->grid_search_con_sector($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
                        if ($cmp == "con_estado")
                        {
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['save_grid']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['grid_pesq']))
           { 
   ...
   {
       global $nm_saida;
       $this->Cmps_select2_grid = array('con_estado','con_comunidad','con_sector');
       $lin_obj  = "";
   ...
   {
       $lin_obj  = "";
       $All_cmp_search = array('con_ruta','con_cedula','con_nombre','con_numero_contrato','con_numero_medidor','con_tipo_servicio','con_condicion_contrato','con_comunidad','con_sector','con_estado');
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['pesq_tab_label'];
       if (!empty($nmgp_tab_label))
       {
          $nm_tab_campos = explode("?@?", $nmgp_tab_label);
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['grid_pesq']) && count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['grid_pesq']) < 10)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
   ...
   function grid_search_con_ruta($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['psq_check_ret']['con_ruta'] = array();
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['psq_check_ret']['con_ruta'][] = trim($rs->fields[0]);
   ...
   function grid_search_con_cedula($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $nm_comando = "select distinct con_cedula from (SELECT     con_id,     con_empresa,     con_propietario,     con_nombre,     con_cedula,     con_telefono,     con_celular,     con_direccion_propietario,     con_correo,     con_pais,     con_provincia,     con_canton,     con_parroquia,     con_direccion_predio,     con_toma_administrativa,     con_toma_operativa,     con_tipo_servicio,     con_condicion_contrato,     con_numero_medidor,     con_estado,     con_numero_contrato,     con_ruta,     con_sino,     con_comunidad,     con_sector FROM     v_jap_contrato where con_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "' and con_estado in ('V','S') and con_id not in (SELECT des_contrato FROM jap_deudas_escenario where des_escenario=" . $_SESSION['var_escenario'] . ")) nm_sel_esp where #lowerI#con_cedula#lowerF# = #lowerI#'$con_cedula_look'#lowerF#"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
      ...
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       ...
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_con_cedula_val_" . $ind . "' name='val_grid_search_con_cedula_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=20 alt=\"{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\" style='display: none'>";
   ...
   function grid_search_con_nombre($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct con_nombre from (SELECT     con_id,     con_empresa,     con_propietario,     con_nombre,     con_cedula,     con_telefono,     con_celular,     con_direccion_propietario,     con_correo,     con_pais,     con_provincia,     con_canton,     con_parroquia,     con_direccion_predio,     con_toma_administrativa,     con_toma_operativa,     con_tipo_servicio,     con_condicion_contrato,     con_numero_medidor,     con_estado,     con_numero_contrato,     con_ruta,     con_sino,     con_comunidad,     con_sector FROM     v_jap_contrato where con_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "' and con_estado in ('V','S') and con_id not in (SELECT des_contrato FROM jap_deudas_escenario where des_escenario=" . $_SESSION['var_escenario'] . ")) nm_sel_esp where #lowerI#con_nombre#lowerF# = #lowerI#'$con_nombre_look'#lowerF#"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
      ...
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       ...
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_con_nombre_val_" . $ind . "' name='val_grid_search_con_nombre_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=50 alt=\"{datatype: 'text', maxLength: 300, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\" style='display: none'>";
       $tmp_pos = (is_string($val_cmp)) ? strpos($val_cmp, "##@@") : false;
       if ($tmp_pos !== false) {
           $val_cmp = substr($val_cmp, ($tmp_pos + 4));
           $sAutocompValue = substr($sAutocompValue, ($tmp_pos + 4));
   ...
   function grid_search_con_numero_contrato($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct con_numero_contrato from (SELECT     con_id,     con_empresa,     con_propietario,     con_nombre,     con_cedula,     con_telefono,     con_celular,     con_direccion_propietario,     con_correo,     con_pais,     con_provincia,     con_canton,     con_parroquia,     con_direccion_predio,     con_toma_administrativa,     con_toma_operativa,     con_tipo_servicio,     con_condicion_contrato,     con_numero_medidor,     con_estado,     con_numero_contrato,     con_ruta,     con_sino,     con_comunidad,     con_sector FROM     v_jap_contrato where con_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "' and con_estado in ('V','S') and con_id not in (SELECT des_contrato FROM jap_deudas_escenario where des_escenario=" . $_SESSION['var_escenario'] . ")) nm_sel_esp where #lowerI#con_numero_contrato#lowerF# = #lowerI#'$con_numero_contrato_look'#lowerF#"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
   ...
   function grid_search_con_numero_medidor($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct con_numero_medidor from (SELECT     con_id,     con_empresa,     con_propietario,     con_nombre,     con_cedula,     con_telefono,     con_celular,     con_direccion_propietario,     con_correo,     con_pais,     con_provincia,     con_canton,     con_parroquia,     con_direccion_predio,     con_toma_administrativa,     con_toma_operativa,     con_tipo_servicio,     con_condicion_contrato,     con_numero_medidor,     con_estado,     con_numero_contrato,     con_ruta,     con_sino,     con_comunidad,     con_sector FROM     v_jap_contrato where con_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "' and con_estado in ('V','S') and con_id not in (SELECT des_contrato FROM jap_deudas_escenario where des_escenario=" . $_SESSION['var_escenario'] . ")) nm_sel_esp where #lowerI#con_numero_medidor#lowerF# = #lowerI#'$con_numero_medidor_look'#lowerF#"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
   ...
   function grid_search_con_tipo_servicio($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['psq_check_ret']['con_tipo_servicio'] = array();
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['psq_check_ret']['con_tipo_servicio'][] = trim($rs->fields[0]);
             $nmgp_def_dados .= trim($rs->fields[1]) . "?#?"; 
             $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?"; 
             $rs->MoveNext(); 
          } 
   ...
   function grid_search_con_condicion_contrato($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['psq_check_ret']['con_condicion_contrato'] = array();
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['psq_check_ret']['con_condicion_contrato'][] = trim($rs->fields[0]);
             $nmgp_def_dados .= trim($rs->fields[1]) . "?#?"; 
             $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?"; 
             $rs->MoveNext(); 
          } 
   ...
   function grid_search_con_comunidad($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['psq_check_ret']['con_comunidad'] = array();
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['psq_check_ret']['con_comunidad'][] = trim($rs->fields[0]);
             $nmgp_def_dados .= trim($rs->fields[1]) . "?#?"; 
             $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?"; 
             $rs->MoveNext(); 
          } 
       ...
       $lin_obj .= "    <SELECT class='" . $this->css_scAppDivToolbarInput . "' id=\"grid_search_con_comunidad_val_" . $ind . "\" name=\"val_grid_search_con_comunidad_" . $ind . "\"  size=1>";
       $delimitador = "##@@";
       $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
       $nm_opcoes  = explode("?@?", $nm_opcoesx);
       $val = isset($val[0]) ? $val[0] : array();
   ...
   function grid_search_con_sector($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_con_sector_" . $ind . "' style='display:none; z-index: 10'>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterLabel'>". NM_encode_input($label) ." <span class='scGridFilterTagListFilterLabelClose' onclick='closeAllTags(this);'></span></div>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterInputs'>";
       if (empty($opc))
       {
       ...
       $lin_obj .= "       <select id='grid_search_con_sector_cond_" . $ind . "' name='cond_grid_search_con_sector_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle; display: none'>";
       $selected = ($opc == "eq") ? " selected" : "";
       $lin_obj .= "        <option value='eq'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_exac'] . "</option>";
       $lin_obj .= "       </select>";
       if ($opc == "nu" || $opc == "nn" || $opc == "ep" || $opc == "ne")
       ...
       $lin_obj .= "       <span id=\"grid_con_sector_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['psq_check_ret']['con_sector'] = array();
       $con_sector_look = (is_string($con_sector) ? substr($this->Db->qstr($con_sector), 1, -1) : $con_sector); 
       $nmgp_def_dados  = ""; 
       $nmgp_def_dados .= "" . $this->Ini->Nm_lang['lang_seleccione'] . "?#??#?N?@?"; 
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['psq_check_ret']['con_sector'][] = trim($rs->fields[0]);
             $nmgp_def_dados .= trim($rs->fields[1]) . "?#?"; 
             $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?"; 
             $rs->MoveNext(); 
          } 
       ...
       $lin_obj .= "    <SELECT class='" . $this->css_scAppDivToolbarInput . "' id=\"grid_search_con_sector_val_" . $ind . "\" name=\"val_grid_search_con_sector_" . $ind . "\"  size=1>";
       $delimitador = "##@@";
       $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
       $nm_opcoes  = explode("?@?", $nm_opcoesx);
       $val = isset($val[0]) ? $val[0] : array();
       foreach ($nm_opcoes as $nm_opcao)
       {
          if (!empty($nm_opcao))
          {
             ...
             {
                $con_sector_sel = ("S" == $nm_opc_sel) ? " selected" : "";
             }
             $lin_obj .= "       <OPTION value=\"" . NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val) . "\"" . $con_sector_sel . ">" . $nm_opc_val . "</OPTION>";
          }
       }
       $lin_obj .= "    </SELECT>";
       $lin_obj .= "       </span>";
   ...
   function grid_search_con_estado($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['psq_check_ret']['con_estado'] = array();
       $con_estado_look = (is_string($con_estado) ? substr($this->Db->qstr($con_estado), 1, -1) : $con_estado); 
       $nmgp_def_dados  = ""; 
       $nmgp_def_dados .= "" . $this->Ini->Nm_lang['lang_seleccione'] . "?#??#?N?@?"; 
       $nm_comando = "SELECT dec_id, dec_nombre  FROM v_jar_estado_contrato  where dec_id in ('V','S') ORDER BY dec_nombre"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['psq_check_ret']['con_estado'][] = trim($rs->fields[0]);
             $nmgp_def_dados .= trim($rs->fields[1]) . "?#?"; 
             $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?"; 
             $rs->MoveNext(); 
          } 
       ...
       $lin_obj .= "    <SELECT class='" . $this->css_scAppDivToolbarInput . "' id=\"grid_search_con_estado_val_" . $ind . "\" name=\"val_grid_search_con_estado_" . $ind . "\"  size=1>";
       $delimitador = "##@@";
       $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
       $nm_opcoes  = explode("?@?", $nm_opcoesx);
       $val = isset($val[0]) ? $val[0] : array();
      ...
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
          ...
          { 
            ...
            $cmp1 = grid_jap__seleccionar_contrato_pack_protect_string($cmp1);
            $nmgp_def_dados[] = array($cmp1 => $cmp1); 
             $rs->MoveNext(); 
          } 
          $rs->Close(); 
   ...
   function lookup_ajax_con_nombre($con_nombre)
   {
       ...
       $con_nombre_look = (is_string($con_nombre) ? substr($this->Db->qstr($con_nombre), 1, -1) : $con_nombre); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct con_nombre from (SELECT     con_id,     con_empresa,     con_propietario,     con_nombre,     con_cedula,     con_telefono,     con_celular,     con_direccion_propietario,     con_correo,     con_pais,     con_provincia,     con_canton,     con_parroquia,     con_direccion_predio,     con_toma_administrativa,     con_toma_operativa,     con_tipo_servicio,     con_condicion_contrato,     con_numero_medidor,     con_estado,     con_numero_contrato,     con_ruta,     con_sino,     con_comunidad,     con_sector FROM     v_jap_contrato where con_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "' and con_estado in ('V','S') and con_id not in (SELECT des_contrato FROM jap_deudas_escenario where des_escenario=" . $_SESSION['var_escenario'] . ")) nm_sel_esp where  #lowerI#con_nombre#lowerF# like #lowerI#'%" . $con_nombre . "%'#lowerF#"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
   ...
   function lookup_ajax_con_numero_contrato($con_numero_contrato)
   {
       ...
       $con_numero_contrato_look = (is_string($con_numero_contrato) ? substr($this->Db->qstr($con_numero_contrato), 1, -1) : $con_numero_contrato); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct con_numero_contrato from (SELECT     con_id,     con_empresa,     con_propietario,     con_nombre,     con_cedula,     con_telefono,     con_celular,     con_direccion_propietario,     con_correo,     con_pais,     con_provincia,     con_canton,     con_parroquia,     con_direccion_predio,     con_toma_administrativa,     con_toma_operativa,     con_tipo_servicio,     con_condicion_contrato,     con_numero_medidor,     con_estado,     con_numero_contrato,     con_ruta,     con_sino,     con_comunidad,     con_sector FROM     v_jap_contrato where con_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "' and con_estado in ('V','S') and con_id not in (SELECT des_contrato FROM jap_deudas_escenario where des_escenario=" . $_SESSION['var_escenario'] . ")) nm_sel_esp where  #lowerI#con_numero_contrato#lowerF# like #lowerI#'%" . $con_numero_contrato . "%'#lowerF#"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
   ...
   function lookup_ajax_con_numero_medidor($con_numero_medidor)
   {
       ...
       $con_numero_medidor_look = (is_string($con_numero_medidor) ? substr($this->Db->qstr($con_numero_medidor), 1, -1) : $con_numero_medidor); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct con_numero_medidor from (SELECT     con_id,     con_empresa,     con_propietario,     con_nombre,     con_cedula,     con_telefono,     con_celular,     con_direccion_propietario,     con_correo,     con_pais,     con_provincia,     con_canton,     con_parroquia,     con_direccion_predio,     con_toma_administrativa,     con_toma_operativa,     con_tipo_servicio,     con_condicion_contrato,     con_numero_medidor,     con_estado,     con_numero_contrato,     con_ruta,     con_sino,     con_comunidad,     con_sector FROM     v_jap_contrato where con_empresa='" . $_SESSION['Igtech_RucEmpresa'] . "' and con_estado in ('V','S') and con_id not in (SELECT des_contrato FROM jap_deudas_escenario where des_escenario=" . $_SESSION['var_escenario'] . ")) nm_sel_esp where  #lowerI#con_numero_medidor#lowerF# like #lowerI#'%" . $con_numero_medidor . "%'#lowerF#"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "SIJAP/grid_jap__seleccionar_contrato";
   ...
   function JS_grid_search()
   {
       ...
       $nm_saida->saida("     function Sc_carga_select2_grid_con_estado(SEQ)\r\n");
       $nm_saida->saida("     {\r\n");
       $nm_saida->saida("      $(\"#grid_search_con_estado_val_\" + SEQ).select2(\r\n");
       $nm_saida->saida("        {\r\n");
       ...
       $nm_saida->saida("      );\r\n");
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida("     function Sc_carga_select2_grid_con_comunidad(SEQ)\r\n");
       $nm_saida->saida("     {\r\n");
       $nm_saida->saida("      $(\"#grid_search_con_comunidad_val_\" + SEQ).select2(\r\n");
       $nm_saida->saida("        {\r\n");
       $nm_saida->saida("          minimumResultsForSearch: Infinity,\r\n");
       $nm_saida->saida("          language: {\r\n");
       $nm_saida->saida("            noResults: function() {\r\n");
       ...
       $nm_saida->saida("      );\r\n");
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida("     function Sc_carga_select2_grid_con_sector(SEQ)\r\n");
       $nm_saida->saida("     {\r\n");
       $nm_saida->saida("      $(\"#grid_search_con_sector_val_\" + SEQ).select2(\r\n");
       $nm_saida->saida("        {\r\n");
       $nm_saida->saida("          minimumResultsForSearch: Infinity,\r\n");
       $nm_saida->saida("          language: {\r\n");
       $nm_saida->saida("            noResults: function() {\r\n");
       ...
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'con_sector')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                     result  = grid_search_get_select(obj_dyn + i, '');\r\n");
       $nm_saida->saida("                 }\r\n");
    ...
    function getFieldHighlight($filter_type, $field, $str_value, $str_value_original='')
    {
        ...
        {
            if (
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['campos_busca'][ $field ]) &&
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['campos_busca'][ $field . "_cond" ]) &&
                !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['campos_busca'][ $field ]) &&
                (
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['campos_busca'][ $field . "_cond"] == 'qp' ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['campos_busca'][ $field . "_cond"] == 'eq' ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['campos_busca'][ $field . "_cond"] == 'ii'
                )
            )
            {
                if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['campos_busca'][ $field . "_cond"] == 'qp')
                {
                    if(is_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['campos_busca'][ $field ]))
                    {
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['campos_busca'][ $field ] as $ind => $vals)
                        {
                    ...
                    {
                        if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['campos_busca'][ $field ], $str_value) == 0)
                        {
                            $str_value = $str_html_ini. $str_value .$str_html_fim;
                        }
                        elseif(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['campos_busca'][ $field ], $str_value_original) == 0)
                        {
                            $str_value = $str_html_ini. $str_value .$str_html_fim;
                        }
                        else
                        {
                            $keywords = preg_quote($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['campos_busca'][ $field ], '/');
                            $str_value = preg_replace('/'. $keywords .'/i', $str_html_ini . '$0' . $str_html_fim, $str_value);
                        }
                    }
                }
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['campos_busca'][ $field . "_cond"] == 'eq')
                {
                    if(is_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['campos_busca'][ $field ]))
                    {
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['campos_busca'][ $field ] as $ind => $vals)
                ...
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['campos_busca'][ $field . "_cond"] == 'ii')
                {
                    if(is_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['campos_busca'][ $field ]))
                    {
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['campos_busca'][ $field ] as $ind => $vals)
                    ...
                    {
                        if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['campos_busca'][ $field ], substr($str_value, 0, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['campos_busca'][ $field ]))) == 0)
                        {
                            $str_value = $str_html_ini. substr($str_value, 0, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['campos_busca'][ $field ])) .$str_html_fim . substr($str_value, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['campos_busca'][ $field ]));
                        }
                    }
                }
            }
        ...
        {
            if(
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['fast_search'][0]) &&
                (
                    (
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['fast_search'][0] == 'SC_all_Cmp' &&
                    in_array($field, array(''))
                    ) ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['fast_search'][0] == $field ||
                    strpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['fast_search'][0], $field . '_VLS_') !== false ||
                    strpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['fast_search'][0], '_VLS_' . $field) !== false
                )
            )
            {
                if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['fast_search'][1] == 'qp')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['fast_search'][2], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    elseif(!empty($str_value_original) && $str_value_original != '&nbsp;' && strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['fast_search'][2], $str_value_original) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    else
                    {
                        $keywords = preg_quote($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['fast_search'][2], '/');
                        $str_value = preg_replace('/'. $keywords .'/i', $str_html_ini . '$0' . $str_html_fim, $str_value);
                    }
                }
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['fast_search'][1] == 'eq')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['fast_search'][2], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   ...
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
   } 
   ...
   $nm_saida->saida("   if (typeof(scSetFixedHeaders) === typeof(function(){})) scSetFixedHeaders();\r\n");
   $nm_saida->saida("  });\r\n");
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
       } 
   ...
   if ($this->grid_emb_form || $this->grid_emb_form_full)
   {
       ...
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_jap__seleccionar_contrato', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"grid_jap__seleccionar_contrato\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"grid_jap__seleccionar_contrato_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("                     action=\"grid_jap__seleccionar_contrato_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_jap__seleccionar_contrato/grid_jap__seleccionar_contrato_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
   ...
   $nm_saida->saida("           document.Fdoc_word.action = \"grid_jap__seleccionar_contrato_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   $nm_saida->saida("   var Crtl_btn_guardar = false;\r\n");
   $nm_saida->saida("   function sc_btn_guardar()\r\n");
   $nm_saida->saida("   {\r\n");
   $nm_saida->saida("       if (Crtl_btn_guardar) {return;}\r\n");
   $nm_saida->saida("       document.F4.target = \"_self\";\r\n");
   $nm_saida->saida("       Crtl_btn_guardar = true;\r\n");
   $nm_saida->saida("       document.F4.rec.value = \"\";\r\n");
   $nm_saida->saida("       document.F4.nm_call_php.value = \"guardar\";\r\n");
   ...
   $nm_saida->saida("           document.F3.SC_module_export.value = z;\r\n");
   $nm_saida->saida("       }\r\n");
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['grid_jap__seleccionar_contrato_iframe_params'] = array(
   ...
   $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_jap__seleccionar_contrato@SC_par@" . md5($prep_parm_pdf);
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   $nm_saida->saida("               document.Fpdf.action=\"grid_jap__seleccionar_contrato_iframe.php\";\r\n");
   ...
   $nm_saida->saida("               document.Fprint.action = \"grid_jap__seleccionar_contrato_export_ctrl.php\";\r\n");
   $nm_saida->saida("           }\r\n");
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   ...
   $nm_saida->saida("           document.Fexport.action = \"grid_jap__seleccionar_contrato_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['campo_psq_ret']) )
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['grid_jap__seleccionar_contrato']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form  = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Form1 = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("           var Obj_Doc   = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form  = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Form1 = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("          var Obj_Doc   = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form  = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Form1 = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['campo_psq_ret']) . ";\r\n");
          $nm_saida->saida("          var Obj_Doc   = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"grid_jap__seleccionar_contrato_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap__seleccionar_contrato']['reg_start']))
   {
       $nm_saida->saida("      $(document).ready(function(){\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailStatus('grid_jap__seleccionar_contrato')\",50);\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_jap__seleccionar_contrato', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      })\r\n");
   }
