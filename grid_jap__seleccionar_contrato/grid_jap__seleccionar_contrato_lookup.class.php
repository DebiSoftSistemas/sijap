<?php
class grid_jap__seleccionar_contrato_lookup
{
//  
...
//  
   function lookup_con_comunidad(&$conteudo , $con_comunidad) 
   {   
      static $save_conteudo = "" ; 
      static $save_conteudo1 = "" ; 
      $tst_cache = $con_comunidad; 
      if ($tst_cache === $save_conteudo && $conteudo != "&nbsp;") 
      { 
          $conteudo = $save_conteudo1 ; 
          return ; 
      ...
      $save_conteudo = $tst_cache ; 
      if (trim($con_comunidad) === "" || trim($con_comunidad) == "&nbsp;")
      { 
          $conteudo = "&nbsp;";
          $save_conteudo  = ""; 
          $save_conteudo1 = ""; 
      ...
      $nm_comando = "select com_descripcion from jap_comunidad where com_id = $con_comunidad order by com_descripcion" ; 
      $conteudo = "" ; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rx = $this->Db->Execute($nm_comando)) 
...
//  
   function lookup_con_sector(&$conteudo , $con_sector) 
   {   
      static $save_conteudo = "" ; 
      static $save_conteudo1 = "" ; 
      $tst_cache = $con_sector; 
      if ($tst_cache === $save_conteudo && $conteudo != "&nbsp;") 
      { 
          $conteudo = $save_conteudo1 ; 
          return ; 
      ...
      $save_conteudo = $tst_cache ; 
      if (trim($con_sector) === "" || trim($con_sector) == "&nbsp;")
      { 
          $conteudo = "&nbsp;";
          $save_conteudo  = ""; 
          $save_conteudo1 = ""; 
      ...
      $nm_comando = "select sec_descripcion from jap_sector where sec_id = $con_sector order by sec_descripcion" ; 
      $conteudo = "" ; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rx = $this->Db->Execute($nm_comando)) 
