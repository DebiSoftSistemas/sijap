  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_empresa_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sis_empresa_mob_form();
	}
...
?>
  ...
  // ---------- Validate emp_nombre
  function do_ajax_form_sis_empresa_mob_validate_emp_nombre()
  {
    var nomeCampo_emp_nombre = "emp_nombre";
    var var_emp_nombre = scAjaxGetFieldText(nomeCampo_emp_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_empresa_mob_validate_emp_nombre(var_emp_nombre, var_script_case_init, do_ajax_form_sis_empresa_mob_validate_emp_nombre_cb);
  } // do_ajax_form_sis_empresa_mob_validate_emp_nombre

  function do_ajax_form_sis_empresa_mob_validate_emp_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "emp_nombre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_empresa_mob_validate_emp_nombre_cb

  // ---------- Validate emp_direccion
  function do_ajax_form_sis_empresa_mob_validate_emp_direccion()
  {
    var nomeCampo_emp_direccion = "emp_direccion";
    var var_emp_direccion = scAjaxGetFieldText(nomeCampo_emp_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_empresa_mob_validate_emp_direccion(var_emp_direccion, var_script_case_init, do_ajax_form_sis_empresa_mob_validate_emp_direccion_cb);
  } // do_ajax_form_sis_empresa_mob_validate_emp_direccion

  function do_ajax_form_sis_empresa_mob_validate_emp_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "emp_direccion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_empresa_mob_validate_emp_direccion_cb

  // ---------- Validate emp_imagen_menu
  function do_ajax_form_sis_empresa_mob_validate_emp_imagen_menu()
  {
    var nomeCampo_emp_imagen_menu = "emp_imagen_menu";
    var var_emp_imagen_menu = scAjaxGetFieldText(nomeCampo_emp_imagen_menu);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_empresa_mob_validate_emp_imagen_menu(var_emp_imagen_menu, var_script_case_init, do_ajax_form_sis_empresa_mob_validate_emp_imagen_menu_cb);
  } // do_ajax_form_sis_empresa_mob_validate_emp_imagen_menu

  function do_ajax_form_sis_empresa_mob_validate_emp_imagen_menu_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "emp_imagen_menu";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_empresa_mob_validate_emp_imagen_menu_cb

  // ---------- Validate emp_firma
  function do_ajax_form_sis_empresa_mob_validate_emp_firma()
  {
    var nomeCampo_emp_firma = "emp_firma";
    var var_emp_firma = scAjaxGetFieldText(nomeCampo_emp_firma);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_empresa_mob_validate_emp_firma(var_emp_firma, var_script_case_init, do_ajax_form_sis_empresa_mob_validate_emp_firma_cb);
  } // do_ajax_form_sis_empresa_mob_validate_emp_firma

  function do_ajax_form_sis_empresa_mob_validate_emp_firma_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_empresa_mob_validate_emp_firma_cb

  // ---------- Validate emp_clave_firma
  function do_ajax_form_sis_empresa_mob_validate_emp_clave_firma()
  {
    var nomeCampo_emp_clave_firma = "emp_clave_firma";
    var var_emp_clave_firma = scAjaxGetFieldText(nomeCampo_emp_clave_firma);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_empresa_mob_validate_emp_clave_firma(var_emp_clave_firma, var_script_case_init, do_ajax_form_sis_empresa_mob_validate_emp_clave_firma_cb);
  } // do_ajax_form_sis_empresa_mob_validate_emp_clave_firma

  function do_ajax_form_sis_empresa_mob_validate_emp_clave_firma_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_empresa_mob_validate_emp_clave_firma_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_sis_empresa_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_sis_empresa_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_emp_nombre = scAjaxGetFieldText("emp_nombre");
    var var_emp_direccion = scAjaxGetFieldText("emp_direccion");
    var var_emp_imagen_menu = scAjaxGetFieldText("emp_imagen_menu");
    var var_emp_firma = scAjaxGetFieldText("emp_firma");
    var var_emp_clave_firma = scAjaxGetFieldText("emp_clave_firma");
    var var_emp_id = scAjaxGetFieldText("emp_id");
    var var_emp_imagen_menu_ul_name = scAjaxSpecCharProtect(document.F1.emp_imagen_menu_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_emp_imagen_menu_ul_type = document.F1.emp_imagen_menu_ul_type.value;
    ...
    var var_emp_imagen_menu_salva = scAjaxSpecCharProtect(document.F1.emp_imagen_menu_salva.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_emp_imagen_menu_limpa = document.F1.emp_imagen_menu_limpa.checked ? "S" : "N";
    ...
    scAjaxProcOn();
    x_ajax_form_sis_empresa_mob_submit_form(var_emp_nombre, var_emp_direccion, var_emp_imagen_menu, var_emp_firma, var_emp_clave_firma, var_emp_id, var_emp_imagen_menu_ul_name, var_emp_imagen_menu_ul_type, var_emp_firma_ul_name, var_emp_firma_ul_type, var_emp_imagen_menu_salva, var_emp_imagen_menu_limpa, var_emp_firma_salva, var_emp_firma_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_empresa_mob_submit_form_cb);
  } // do_ajax_form_sis_empresa_mob_submit_form

  function do_ajax_form_sis_empresa_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("emp_nombre");
      scAjaxHideErrorDisplay("emp_direccion");
      scAjaxHideErrorDisplay("emp_imagen_menu");
...
?>
    ...
    if (!scAjaxHasError())
    {
      ...
      if (document.F1.emp_imagen_menu_limpa && document.F1.emp_imagen_menu_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldImage("emp_imagen_menu", oImgTemp, "", "", "", "N");
      }
    ...
    document.F1.emp_imagen_menu_ul_name.value = '';
    document.F1.emp_imagen_menu_ul_type.value = '';
    }
    scAjaxShowDebug();
    scAjaxSetDisplay();
    scBtnDisabled();
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_sis_empresa_mob_submit_form_cb_after_alert);
  } // do_ajax_form_sis_empresa_mob_submit_form_cb
  function do_ajax_form_sis_empresa_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_empresa_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sis_empresa_mob_navigate_form()
  {
    perform_ajax_form_sis_empresa_mob_navigate_form();
  }

  function perform_ajax_form_sis_empresa_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("emp_firma");
    scAjaxHideErrorDisplay("emp_clave_firma");
    var var_emp_id = document.F2.emp_id.value;
    ...
    scAjaxProcOn();
    x_ajax_form_sis_empresa_mob_navigate_form(var_emp_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_empresa_mob_navigate_form_cb);
  } // do_ajax_form_sis_empresa_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_empresa_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_empresa_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.emp_id.value = scAjaxGetKeyValue("emp_id");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_empresa_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_empresa_mob_navigate_form_cb
  function do_ajax_form_sis_empresa_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_sis_empresa_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_sis_empresa_mob_navigate_form_cb_after_alert

  function sc_hide_form_sis_empresa_mob_form()
  {
  ...
  ajax_field_list[0] = "emp_nombre";
  ajax_field_list[1] = "emp_direccion";
  ajax_field_list[2] = "emp_imagen_menu";
  ajax_field_list[3] = "emp_firma";
  ajax_field_list[4] = "emp_clave_firma";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "emp_nombre": {"label": "<?php echo $this->Ini->Nm_lang['lang_nombre_empresa'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "emp_direccion": {"label": "<?php echo $this->Ini->Nm_lang['lang_direccion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "emp_imagen_menu": {"label": "<?php echo $this->Ini->Nm_lang['lang_imagen_menu'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "emp_nombre": new Array(),
    "emp_direccion": new Array(),
    "emp_imagen_menu": new Array(),
    "emp_firma": new Array(),
    "emp_clave_firma": new Array()
  };
  ajax_field_mult["emp_nombre"][1] = "emp_nombre";
  ajax_field_mult["emp_direccion"][1] = "emp_direccion";
  ajax_field_mult["emp_imagen_menu"][1] = "emp_imagen_menu";
  ajax_field_mult["emp_firma"][1] = "emp_firma";
  ajax_field_mult["emp_clave_firma"][1] = "emp_clave_firma";

  var ajax_field_id = {
    "emp_nombre": new Array("hidden_field_label_emp_nombre", "hidden_field_data_emp_nombre"),
    "emp_direccion": new Array("hidden_field_label_emp_direccion", "hidden_field_data_emp_direccion"),
    "emp_imagen_menu": new Array("hidden_field_label_emp_imagen_menu", "hidden_field_data_emp_imagen_menu"),
