  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_empresa" == sTestField)
        {
...
?>
  ...
  // ---------- Validate emp_nombre
  function do_ajax_form_sis_empresa_validate_emp_nombre()
  {
    var nomeCampo_emp_nombre = "emp_nombre";
    var var_emp_nombre = scAjaxGetFieldText(nomeCampo_emp_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_empresa_validate_emp_nombre(var_emp_nombre, var_script_case_init, do_ajax_form_sis_empresa_validate_emp_nombre_cb);
  } // do_ajax_form_sis_empresa_validate_emp_nombre

  function do_ajax_form_sis_empresa_validate_emp_nombre_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_empresa_validate_emp_nombre_cb

  // ---------- Validate emp_direccion
  function do_ajax_form_sis_empresa_validate_emp_direccion()
  {
    var nomeCampo_emp_direccion = "emp_direccion";
    var var_emp_direccion = scAjaxGetFieldText(nomeCampo_emp_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_empresa_validate_emp_direccion(var_emp_direccion, var_script_case_init, do_ajax_form_sis_empresa_validate_emp_direccion_cb);
  } // do_ajax_form_sis_empresa_validate_emp_direccion

  function do_ajax_form_sis_empresa_validate_emp_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_empresa_validate_emp_direccion_cb

  // ---------- Validate emp_imagen_menu
  function do_ajax_form_sis_empresa_validate_emp_imagen_menu()
  {
    var nomeCampo_emp_imagen_menu = "emp_imagen_menu";
    var var_emp_imagen_menu = scAjaxGetFieldText(nomeCampo_emp_imagen_menu);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_empresa_validate_emp_imagen_menu(var_emp_imagen_menu, var_script_case_init, do_ajax_form_sis_empresa_validate_emp_imagen_menu_cb);
  } // do_ajax_form_sis_empresa_validate_emp_imagen_menu

  function do_ajax_form_sis_empresa_validate_emp_imagen_menu_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_empresa_validate_emp_imagen_menu_cb

  // ---------- Validate emp_firma
  function do_ajax_form_sis_empresa_validate_emp_firma()
  {
    var nomeCampo_emp_firma = "emp_firma";
    var var_emp_firma = scAjaxGetFieldText(nomeCampo_emp_firma);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_empresa_validate_emp_firma(var_emp_firma, var_script_case_init, do_ajax_form_sis_empresa_validate_emp_firma_cb);
  } // do_ajax_form_sis_empresa_validate_emp_firma

  function do_ajax_form_sis_empresa_validate_emp_firma_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_empresa_validate_emp_firma_cb

  // ---------- Validate emp_clave_firma
  function do_ajax_form_sis_empresa_validate_emp_clave_firma()
  {
    var nomeCampo_emp_clave_firma = "emp_clave_firma";
    var var_emp_clave_firma = scAjaxGetFieldText(nomeCampo_emp_clave_firma);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_empresa_validate_emp_clave_firma(var_emp_clave_firma, var_script_case_init, do_ajax_form_sis_empresa_validate_emp_clave_firma_cb);
  } // do_ajax_form_sis_empresa_validate_emp_clave_firma

  function do_ajax_form_sis_empresa_validate_emp_clave_firma_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_empresa_validate_emp_clave_firma_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_sis_empresa_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_sis_empresa_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_sis_empresa_submit_form(var_emp_nombre, var_emp_direccion, var_emp_imagen_menu, var_emp_firma, var_emp_clave_firma, var_emp_imagen_menu_ul_name, var_emp_imagen_menu_ul_type, var_emp_firma_ul_name, var_emp_firma_ul_type, var_emp_imagen_menu_salva, var_emp_imagen_menu_limpa, var_emp_firma_salva, var_emp_firma_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_empresa_submit_form_cb);
  } // do_ajax_form_sis_empresa_submit_form

  function do_ajax_form_sis_empresa_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_sis_empresa_submit_form_cb_after_alert);
  } // do_ajax_form_sis_empresa_submit_form_cb
  function do_ajax_form_sis_empresa_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_empresa_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sis_empresa_navigate_form()
  {
    perform_ajax_form_sis_empresa_navigate_form();
  }

  function perform_ajax_form_sis_empresa_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_sis_empresa_navigate_form(var_emp_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_empresa_navigate_form_cb);
  } // do_ajax_form_sis_empresa_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_empresa']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_empresa_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_empresa_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_empresa_navigate_form_cb
  function do_ajax_form_sis_empresa_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_sis_empresa_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_sis_empresa_navigate_form_cb_after_alert

  function sc_hide_form_sis_empresa_form()
  {
