  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_fac_serie_comprobante_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_fac_serie_comprobante_mob_form();
	}
...
?>
  ...
  // ---------- Validate sc_id
  function do_ajax_form_fac_serie_comprobante_mob_validate_sc_id()
  {
    var nomeCampo_sc_id = "sc_id";
    var var_sc_id = scAjaxGetFieldHidden(nomeCampo_sc_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_serie_comprobante_mob_validate_sc_id(var_sc_id, var_script_case_init, do_ajax_form_fac_serie_comprobante_mob_validate_sc_id_cb);
  } // do_ajax_form_fac_serie_comprobante_mob_validate_sc_id

  function do_ajax_form_fac_serie_comprobante_mob_validate_sc_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_serie_comprobante_mob_validate_sc_id_cb

  // ---------- Validate sc_filial
  function do_ajax_form_fac_serie_comprobante_mob_validate_sc_filial()
  {
    var nomeCampo_sc_filial = "sc_filial";
    var var_sc_filial = scAjaxGetFieldText(nomeCampo_sc_filial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_serie_comprobante_mob_validate_sc_filial(var_sc_filial, var_script_case_init, do_ajax_form_fac_serie_comprobante_mob_validate_sc_filial_cb);
  } // do_ajax_form_fac_serie_comprobante_mob_validate_sc_filial

  function do_ajax_form_fac_serie_comprobante_mob_validate_sc_filial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sc_filial";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_serie_comprobante_mob_validate_sc_filial_cb

  // ---------- Validate sc_oficina
  function do_ajax_form_fac_serie_comprobante_mob_validate_sc_oficina()
  {
    var nomeCampo_sc_oficina = "sc_oficina";
    var var_sc_oficina = scAjaxGetFieldSelect(nomeCampo_sc_oficina);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_serie_comprobante_mob_validate_sc_oficina(var_sc_oficina, var_script_case_init, do_ajax_form_fac_serie_comprobante_mob_validate_sc_oficina_cb);
  } // do_ajax_form_fac_serie_comprobante_mob_validate_sc_oficina

  function do_ajax_form_fac_serie_comprobante_mob_validate_sc_oficina_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sc_oficina";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_serie_comprobante_mob_validate_sc_oficina_cb

  // ---------- Validate sc_tipo
  function do_ajax_form_fac_serie_comprobante_mob_validate_sc_tipo()
  {
    var nomeCampo_sc_tipo = "sc_tipo";
    var var_sc_tipo = scAjaxGetFieldSelect(nomeCampo_sc_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_serie_comprobante_mob_validate_sc_tipo(var_sc_tipo, var_script_case_init, do_ajax_form_fac_serie_comprobante_mob_validate_sc_tipo_cb);
  } // do_ajax_form_fac_serie_comprobante_mob_validate_sc_tipo

  function do_ajax_form_fac_serie_comprobante_mob_validate_sc_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sc_tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_serie_comprobante_mob_validate_sc_tipo_cb

  // ---------- Validate sc_serie
  function do_ajax_form_fac_serie_comprobante_mob_validate_sc_serie()
  {
    var nomeCampo_sc_serie = "sc_serie";
    var var_sc_serie = scAjaxGetFieldText(nomeCampo_sc_serie);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_serie_comprobante_mob_validate_sc_serie(var_sc_serie, var_script_case_init, do_ajax_form_fac_serie_comprobante_mob_validate_sc_serie_cb);
  } // do_ajax_form_fac_serie_comprobante_mob_validate_sc_serie

  function do_ajax_form_fac_serie_comprobante_mob_validate_sc_serie_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sc_serie";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_serie_comprobante_mob_validate_sc_serie_cb

  // ---------- Validate sc_inicio
  function do_ajax_form_fac_serie_comprobante_mob_validate_sc_inicio()
  {
    var nomeCampo_sc_inicio = "sc_inicio";
    var var_sc_inicio = scAjaxGetFieldText(nomeCampo_sc_inicio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_serie_comprobante_mob_validate_sc_inicio(var_sc_inicio, var_script_case_init, do_ajax_form_fac_serie_comprobante_mob_validate_sc_inicio_cb);
  } // do_ajax_form_fac_serie_comprobante_mob_validate_sc_inicio

  function do_ajax_form_fac_serie_comprobante_mob_validate_sc_inicio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sc_inicio";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_serie_comprobante_mob_validate_sc_inicio_cb

  // ---------- Validate sc_fin
  function do_ajax_form_fac_serie_comprobante_mob_validate_sc_fin()
  {
    var nomeCampo_sc_fin = "sc_fin";
    var var_sc_fin = scAjaxGetFieldText(nomeCampo_sc_fin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_serie_comprobante_mob_validate_sc_fin(var_sc_fin, var_script_case_init, do_ajax_form_fac_serie_comprobante_mob_validate_sc_fin_cb);
  } // do_ajax_form_fac_serie_comprobante_mob_validate_sc_fin

  function do_ajax_form_fac_serie_comprobante_mob_validate_sc_fin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sc_fin";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_serie_comprobante_mob_validate_sc_fin_cb

  // ---------- Validate sc_secuencial
  function do_ajax_form_fac_serie_comprobante_mob_validate_sc_secuencial()
  {
    var nomeCampo_sc_secuencial = "sc_secuencial";
    var var_sc_secuencial = scAjaxGetFieldText(nomeCampo_sc_secuencial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_serie_comprobante_mob_validate_sc_secuencial(var_sc_secuencial, var_script_case_init, do_ajax_form_fac_serie_comprobante_mob_validate_sc_secuencial_cb);
  } // do_ajax_form_fac_serie_comprobante_mob_validate_sc_secuencial

  function do_ajax_form_fac_serie_comprobante_mob_validate_sc_secuencial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sc_secuencial";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_serie_comprobante_mob_validate_sc_secuencial_cb

  // ---------- Validate sc_estado
  function do_ajax_form_fac_serie_comprobante_mob_validate_sc_estado()
  {
    var nomeCampo_sc_estado = "sc_estado";
    var var_sc_estado = scAjaxGetFieldSelect(nomeCampo_sc_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_serie_comprobante_mob_validate_sc_estado(var_sc_estado, var_script_case_init, do_ajax_form_fac_serie_comprobante_mob_validate_sc_estado_cb);
  } // do_ajax_form_fac_serie_comprobante_mob_validate_sc_estado

  function do_ajax_form_fac_serie_comprobante_mob_validate_sc_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sc_estado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_serie_comprobante_mob_validate_sc_estado_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_fac_serie_comprobante_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_fac_serie_comprobante_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_sc_id = scAjaxGetFieldHidden("sc_id");
    var var_sc_filial = scAjaxGetFieldText("sc_filial");
    var var_sc_oficina = scAjaxGetFieldSelect("sc_oficina");
    var var_sc_tipo = scAjaxGetFieldSelect("sc_tipo");
    var var_sc_serie = scAjaxGetFieldText("sc_serie");
    var var_sc_inicio = scAjaxGetFieldText("sc_inicio");
    var var_sc_fin = scAjaxGetFieldText("sc_fin");
    var var_sc_secuencial = scAjaxGetFieldText("sc_secuencial");
    var var_sc_estado = scAjaxGetFieldSelect("sc_estado");
    ...
    scAjaxProcOn();
    x_ajax_form_fac_serie_comprobante_mob_submit_form(var_sc_id, var_sc_filial, var_sc_oficina, var_sc_tipo, var_sc_serie, var_sc_inicio, var_sc_fin, var_sc_secuencial, var_sc_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_fac_serie_comprobante_mob_submit_form_cb);
  } // do_ajax_form_fac_serie_comprobante_mob_submit_form

  function do_ajax_form_fac_serie_comprobante_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("sc_id");
      scAjaxHideErrorDisplay("sc_filial");
      scAjaxHideErrorDisplay("sc_oficina");
      scAjaxHideErrorDisplay("sc_tipo");
      scAjaxHideErrorDisplay("sc_serie");
      scAjaxHideErrorDisplay("sc_inicio");
      scAjaxHideErrorDisplay("sc_fin");
      scAjaxHideErrorDisplay("sc_secuencial");
      scAjaxHideErrorDisplay("sc_estado");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_fac_serie_comprobante_mob_submit_form_cb_after_alert);
  } // do_ajax_form_fac_serie_comprobante_mob_submit_form_cb
  function do_ajax_form_fac_serie_comprobante_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_fac_serie_comprobante_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_fac_serie_comprobante_mob_navigate_form()
  {
    perform_ajax_form_fac_serie_comprobante_mob_navigate_form();
  }

  function perform_ajax_form_fac_serie_comprobante_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("sc_secuencial");
    scAjaxHideErrorDisplay("sc_estado");
    var var_sc_id = document.F2.sc_id.value;
    ...
    scAjaxProcOn();
    x_ajax_form_fac_serie_comprobante_mob_navigate_form(var_sc_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_serie_comprobante_mob_navigate_form_cb);
  } // do_ajax_form_fac_serie_comprobante_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_serie_comprobante_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_fac_serie_comprobante_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.sc_id.value = scAjaxGetKeyValue("sc_id");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_fac_serie_comprobante_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_fac_serie_comprobante_mob_navigate_form_cb
  function do_ajax_form_fac_serie_comprobante_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_fac_serie_comprobante_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_fac_serie_comprobante_mob_navigate_form_cb_after_alert

  function sc_hide_form_fac_serie_comprobante_mob_form()
  {
  ...
  ajax_field_list[0] = "sc_id";
  ajax_field_list[1] = "sc_filial";
  ajax_field_list[2] = "sc_oficina";
  ajax_field_list[3] = "sc_tipo";
  ajax_field_list[4] = "sc_serie";
  ajax_field_list[5] = "sc_inicio";
  ajax_field_list[6] = "sc_fin";
  ajax_field_list[7] = "sc_secuencial";
  ajax_field_list[8] = "sc_estado";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "sc_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sc_filial": {"label": "<?php echo $this->Ini->Nm_lang['lang_filial'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sc_oficina": {"label": "<?php echo $this->Ini->Nm_lang['lang_oficina'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sc_tipo": {"label": "<?php echo $this->Ini->Nm_lang['lang_tipo_comprobante'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sc_serie": {"label": "<?php echo $this->Ini->Nm_lang['lang_serie_sri'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sc_inicio": {"label": "<?php echo $this->Ini->Nm_lang['lang_inicio'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sc_fin": {"label": "<?php echo $this->Ini->Nm_lang['lang_fin'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sc_secuencial": {"label": "<?php echo $this->Ini->Nm_lang['lang_secuencial'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sc_estado": {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "sc_id": new Array(),
    "sc_filial": new Array(),
    "sc_oficina": new Array(),
    "sc_tipo": new Array(),
    "sc_serie": new Array(),
    "sc_inicio": new Array(),
    "sc_fin": new Array(),
    "sc_secuencial": new Array(),
    "sc_estado": new Array()
  };
  ajax_field_mult["sc_id"][1] = "sc_id";
  ajax_field_mult["sc_filial"][1] = "sc_filial";
  ajax_field_mult["sc_oficina"][1] = "sc_oficina";
  ajax_field_mult["sc_tipo"][1] = "sc_tipo";
  ajax_field_mult["sc_serie"][1] = "sc_serie";
  ajax_field_mult["sc_inicio"][1] = "sc_inicio";
  ajax_field_mult["sc_fin"][1] = "sc_fin";
  ajax_field_mult["sc_secuencial"][1] = "sc_secuencial";
  ajax_field_mult["sc_estado"][1] = "sc_estado";

  var ajax_field_id = {
    "sc_oficina": new Array("hidden_field_label_sc_oficina", "hidden_field_data_sc_oficina"),
    "sc_tipo": new Array("hidden_field_label_sc_tipo", "hidden_field_data_sc_tipo"),
    "sc_serie": new Array("hidden_field_label_sc_serie", "hidden_field_data_sc_serie"),
    "sc_inicio": new Array("hidden_field_label_sc_inicio", "hidden_field_data_sc_inicio"),
    "sc_fin": new Array("hidden_field_label_sc_fin", "hidden_field_data_sc_fin"),
    "sc_secuencial": new Array("hidden_field_label_sc_secuencial", "hidden_field_data_sc_secuencial"),
    "sc_estado": new Array("hidden_field_label_sc_estado", "hidden_field_data_sc_estado")
  };
