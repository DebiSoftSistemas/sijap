  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_fac_serie_comprobante" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_fac_serie_comprobante_form();
	}
...
?>
  ...
  // ---------- Validate sc_id
  function do_ajax_form_fac_serie_comprobante_validate_sc_id()
  {
    var nomeCampo_sc_id = "sc_id";
    var var_sc_id = scAjaxGetFieldHidden(nomeCampo_sc_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_serie_comprobante_validate_sc_id(var_sc_id, var_script_case_init, do_ajax_form_fac_serie_comprobante_validate_sc_id_cb);
  } // do_ajax_form_fac_serie_comprobante_validate_sc_id

  function do_ajax_form_fac_serie_comprobante_validate_sc_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_serie_comprobante_validate_sc_id_cb

  // ---------- Validate sc_filial
  function do_ajax_form_fac_serie_comprobante_validate_sc_filial()
  {
    var nomeCampo_sc_filial = "sc_filial";
    var var_sc_filial = scAjaxGetFieldText(nomeCampo_sc_filial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_serie_comprobante_validate_sc_filial(var_sc_filial, var_script_case_init, do_ajax_form_fac_serie_comprobante_validate_sc_filial_cb);
  } // do_ajax_form_fac_serie_comprobante_validate_sc_filial

  function do_ajax_form_fac_serie_comprobante_validate_sc_filial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_serie_comprobante_validate_sc_filial_cb

  // ---------- Validate sc_oficina
  function do_ajax_form_fac_serie_comprobante_validate_sc_oficina()
  {
    var nomeCampo_sc_oficina = "sc_oficina";
    var var_sc_oficina = scAjaxGetFieldSelect(nomeCampo_sc_oficina);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_serie_comprobante_validate_sc_oficina(var_sc_oficina, var_script_case_init, do_ajax_form_fac_serie_comprobante_validate_sc_oficina_cb);
  } // do_ajax_form_fac_serie_comprobante_validate_sc_oficina

  function do_ajax_form_fac_serie_comprobante_validate_sc_oficina_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_serie_comprobante_validate_sc_oficina_cb

  // ---------- Validate sc_tipo
  function do_ajax_form_fac_serie_comprobante_validate_sc_tipo()
  {
    var nomeCampo_sc_tipo = "sc_tipo";
    var var_sc_tipo = scAjaxGetFieldSelect(nomeCampo_sc_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_serie_comprobante_validate_sc_tipo(var_sc_tipo, var_script_case_init, do_ajax_form_fac_serie_comprobante_validate_sc_tipo_cb);
  } // do_ajax_form_fac_serie_comprobante_validate_sc_tipo

  function do_ajax_form_fac_serie_comprobante_validate_sc_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sc_tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_serie_comprobante_validate_sc_tipo_cb

  // ---------- Validate sc_serie
  function do_ajax_form_fac_serie_comprobante_validate_sc_serie()
  {
    var nomeCampo_sc_serie = "sc_serie";
    var var_sc_serie = scAjaxGetFieldText(nomeCampo_sc_serie);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_serie_comprobante_validate_sc_serie(var_sc_serie, var_script_case_init, do_ajax_form_fac_serie_comprobante_validate_sc_serie_cb);
  } // do_ajax_form_fac_serie_comprobante_validate_sc_serie

  function do_ajax_form_fac_serie_comprobante_validate_sc_serie_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_serie_comprobante_validate_sc_serie_cb

  // ---------- Validate sc_inicio
  function do_ajax_form_fac_serie_comprobante_validate_sc_inicio()
  {
    var nomeCampo_sc_inicio = "sc_inicio";
    var var_sc_inicio = scAjaxGetFieldText(nomeCampo_sc_inicio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_serie_comprobante_validate_sc_inicio(var_sc_inicio, var_script_case_init, do_ajax_form_fac_serie_comprobante_validate_sc_inicio_cb);
  } // do_ajax_form_fac_serie_comprobante_validate_sc_inicio

  function do_ajax_form_fac_serie_comprobante_validate_sc_inicio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_serie_comprobante_validate_sc_inicio_cb

  // ---------- Validate sc_fin
  function do_ajax_form_fac_serie_comprobante_validate_sc_fin()
  {
    var nomeCampo_sc_fin = "sc_fin";
    var var_sc_fin = scAjaxGetFieldText(nomeCampo_sc_fin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_serie_comprobante_validate_sc_fin(var_sc_fin, var_script_case_init, do_ajax_form_fac_serie_comprobante_validate_sc_fin_cb);
  } // do_ajax_form_fac_serie_comprobante_validate_sc_fin

  function do_ajax_form_fac_serie_comprobante_validate_sc_fin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sc_fin";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_serie_comprobante_validate_sc_fin_cb

  // ---------- Validate sc_secuencial
  function do_ajax_form_fac_serie_comprobante_validate_sc_secuencial()
  {
    var nomeCampo_sc_secuencial = "sc_secuencial";
    var var_sc_secuencial = scAjaxGetFieldText(nomeCampo_sc_secuencial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_serie_comprobante_validate_sc_secuencial(var_sc_secuencial, var_script_case_init, do_ajax_form_fac_serie_comprobante_validate_sc_secuencial_cb);
  } // do_ajax_form_fac_serie_comprobante_validate_sc_secuencial

  function do_ajax_form_fac_serie_comprobante_validate_sc_secuencial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_serie_comprobante_validate_sc_secuencial_cb

  // ---------- Validate sc_estado
  function do_ajax_form_fac_serie_comprobante_validate_sc_estado()
  {
    var nomeCampo_sc_estado = "sc_estado";
    var var_sc_estado = scAjaxGetFieldSelect(nomeCampo_sc_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_serie_comprobante_validate_sc_estado(var_sc_estado, var_script_case_init, do_ajax_form_fac_serie_comprobante_validate_sc_estado_cb);
  } // do_ajax_form_fac_serie_comprobante_validate_sc_estado

  function do_ajax_form_fac_serie_comprobante_validate_sc_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_serie_comprobante_validate_sc_estado_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_fac_serie_comprobante_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_fac_serie_comprobante_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_fac_serie_comprobante_submit_form(var_sc_id, var_sc_filial, var_sc_oficina, var_sc_tipo, var_sc_serie, var_sc_inicio, var_sc_fin, var_sc_secuencial, var_sc_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_fac_serie_comprobante_submit_form_cb);
  } // do_ajax_form_fac_serie_comprobante_submit_form

  function do_ajax_form_fac_serie_comprobante_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_fac_serie_comprobante_submit_form_cb_after_alert);
  } // do_ajax_form_fac_serie_comprobante_submit_form_cb
  function do_ajax_form_fac_serie_comprobante_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_fac_serie_comprobante_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_fac_serie_comprobante_navigate_form()
  {
    perform_ajax_form_fac_serie_comprobante_navigate_form();
  }

  function perform_ajax_form_fac_serie_comprobante_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_fac_serie_comprobante_navigate_form(var_sc_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_serie_comprobante_navigate_form_cb);
  } // do_ajax_form_fac_serie_comprobante_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_serie_comprobante']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_fac_serie_comprobante_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_fac_serie_comprobante_navigate_form_cb_after_alert);
  } // do_ajax_form_fac_serie_comprobante_navigate_form_cb
  function do_ajax_form_fac_serie_comprobante_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_fac_serie_comprobante_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_fac_serie_comprobante_navigate_form_cb_after_alert

  function sc_hide_form_fac_serie_comprobante_form()
  {
