...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_login_mob']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_login_mob']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_login_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
?> 
function sc_btn_registrarse()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_registrarse(); }, 500);
      return;
    }
    sc_btn_registrarse_ok();
}
function sc_btn_registrarse_cancel()
{
}
function sc_btn_registrarse_ok()
{
  nm_gp_submit('<?php echo $this->Ini->link_form_del_nueva_empresa_edit; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "NM_btn_insert*scinS*scoutNM_btn_update*scinN*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinN*scout"; ?>', '', '_self', '0', '0', 'form_del_nueva_empresa');
}
function sc_btn_factura_rapida()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_factura_rapida(); }, 500);
      return;
    }
    sc_btn_factura_rapida_ok();
}
function sc_btn_factura_rapida_cancel()
{
}
function sc_btn_factura_rapida_ok()
{
  nm_gp_submit('<?php echo $this->Ini->link_factura_rapida_edit; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "NM_btn_insert*scinN*scoutNM_btn_update*scinN*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinS*scout"; ?>', '', '_self', '0', '0', 'factura_rapida');
}
 NM_tp_critica(1);
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_login_mob']['where_detal']))
  {
?>  
...
function nm_saida_glo()
{
  ...
  document.F4.action = "form_login_mob_fim.php";
  document.F4.submit();
}
