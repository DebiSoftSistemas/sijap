...
<?php
   ...
   $Ord_Cmp = new grid_sis_usuario_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_sis_usuario_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_sis_usuario']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_sis_usuario']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["usu_usuario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sis_usuario']['labels']["usu_usuario"])) ? $_SESSION['sc_session'][$sc_init]['grid_sis_usuario']['labels']["usu_usuario"] : "" . $this->Nm_lang['lang_usuario'] . "";
   $tab_ger_campos['usu_nombre'] = "on";
   $tab_def_campos['usu_nombre'] = "usu_nombre";
   $tab_labels["usu_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sis_usuario']['labels']["usu_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_sis_usuario']['labels']["usu_nombre"] : "" . $this->Nm_lang['lang_nombre'] . "";
   $tab_ger_campos['usu_cedula'] = "on";
   $tab_def_campos['usu_cedula'] = "usu_cedula";
   $tab_labels["usu_cedula"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sis_usuario']['labels']["usu_cedula"])) ? $_SESSION['sc_session'][$sc_init]['grid_sis_usuario']['labels']["usu_cedula"] : "" . $this->Nm_lang['lang_cedula'] . "";
   $tab_ger_campos['usu_email'] = "on";
   $tab_def_campos['usu_email'] = "usu_email";
   $tab_labels["usu_email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sis_usuario']['labels']["usu_email"])) ? $_SESSION['sc_session'][$sc_init]['grid_sis_usuario']['labels']["usu_email"] : "" . $this->Nm_lang['lang_email'] . "";
   $tab_ger_campos['usu_estado'] = "on";
   $tab_def_campos['usu_estado'] = "usu_estado";
   $tab_labels["usu_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sis_usuario']['labels']["usu_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_sis_usuario']['labels']["usu_estado"] : "" . $this->Nm_lang['lang_estado'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_sis_usuario']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_sis_usuario']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_sis_usuario']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_sis_usuario']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_sis_usuario']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_sis_usuario']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_sis_usuario']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_sis_usuario']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_sis_usuario']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_sis_usuario']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_sis_usuario']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_sis_usuario']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_sis_usuario_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_sis_usuario']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_sis_usuario']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_sis_usuario']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_sis_usuario']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_sis_usuario']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
