...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "usu_fecha_crea";$Nm_datas[] = "usu_fecha_estado";$Nm_numeric[] = "usu_filial";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_usu_filial"  <?php echo $str_hide_usu_filial?>>
<?php
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_usu_usuario"  <?php echo $str_hide_usu_usuario?>><?php
      if ($usu_usuario != "")
      {
      $usu_usuario_look = (is_string($usu_usuario) ? substr($this->Db->qstr($usu_usuario), 1, -1) : $usu_usuario); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_usu_nombre"  <?php echo $str_hide_usu_nombre?>><?php
      if ($usu_nombre != "")
      {
      $usu_nombre_look = (is_string($usu_nombre) ? substr($this->Db->qstr($usu_nombre), 1, -1) : $usu_nombre); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_usu_cedula"  <?php echo $str_hide_usu_cedula?>><?php
      if ($usu_cedula != "")
      {
      $usu_cedula_look = (is_string($usu_cedula) ? substr($this->Db->qstr($usu_cedula), 1, -1) : $usu_cedula); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_usu_email"  <?php echo $str_hide_usu_email?>><?php
      if ($usu_email != "")
      {
      $usu_email_look = (is_string($usu_email) ? substr($this->Db->qstr($usu_email), 1, -1) : $usu_email); 
      $nmgp_def_dados = array(); 
