  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_transportista_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_transportista_mob_form();
	}
...
?>
  ...
  // ---------- Validate tr_id
  function do_ajax_form_del_transportista_mob_validate_tr_id()
  {
    var nomeCampo_tr_id = "tr_id";
    var var_tr_id = scAjaxGetFieldHidden(nomeCampo_tr_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_transportista_mob_validate_tr_id(var_tr_id, var_script_case_init, do_ajax_form_del_transportista_mob_validate_tr_id_cb);
  } // do_ajax_form_del_transportista_mob_validate_tr_id

  function do_ajax_form_del_transportista_mob_validate_tr_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_transportista_mob_validate_tr_id_cb

  // ---------- Validate tr_empresa
  function do_ajax_form_del_transportista_mob_validate_tr_empresa()
  {
    var nomeCampo_tr_empresa = "tr_empresa";
    var var_tr_empresa = scAjaxGetFieldText(nomeCampo_tr_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_transportista_mob_validate_tr_empresa(var_tr_empresa, var_script_case_init, do_ajax_form_del_transportista_mob_validate_tr_empresa_cb);
  } // do_ajax_form_del_transportista_mob_validate_tr_empresa

  function do_ajax_form_del_transportista_mob_validate_tr_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tr_empresa";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_transportista_mob_validate_tr_empresa_cb

  // ---------- Validate tr_tipo_identificacion
  function do_ajax_form_del_transportista_mob_validate_tr_tipo_identificacion()
  {
    var nomeCampo_tr_tipo_identificacion = "tr_tipo_identificacion";
    var var_tr_tipo_identificacion = scAjaxGetFieldSelect(nomeCampo_tr_tipo_identificacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_transportista_mob_validate_tr_tipo_identificacion(var_tr_tipo_identificacion, var_script_case_init, do_ajax_form_del_transportista_mob_validate_tr_tipo_identificacion_cb);
  } // do_ajax_form_del_transportista_mob_validate_tr_tipo_identificacion

  function do_ajax_form_del_transportista_mob_validate_tr_tipo_identificacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tr_tipo_identificacion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_transportista_mob_validate_tr_tipo_identificacion_cb

  // ---------- Validate tr_identificacion
  function do_ajax_form_del_transportista_mob_validate_tr_identificacion()
  {
    var nomeCampo_tr_identificacion = "tr_identificacion";
    var var_tr_identificacion = scAjaxGetFieldText(nomeCampo_tr_identificacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_transportista_mob_validate_tr_identificacion(var_tr_identificacion, var_script_case_init, do_ajax_form_del_transportista_mob_validate_tr_identificacion_cb);
  } // do_ajax_form_del_transportista_mob_validate_tr_identificacion

  function do_ajax_form_del_transportista_mob_validate_tr_identificacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tr_identificacion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_transportista_mob_validate_tr_identificacion_cb

  // ---------- Validate tr_nombre
  function do_ajax_form_del_transportista_mob_validate_tr_nombre()
  {
    var nomeCampo_tr_nombre = "tr_nombre";
    var var_tr_nombre = scAjaxGetFieldText(nomeCampo_tr_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_transportista_mob_validate_tr_nombre(var_tr_nombre, var_script_case_init, do_ajax_form_del_transportista_mob_validate_tr_nombre_cb);
  } // do_ajax_form_del_transportista_mob_validate_tr_nombre

  function do_ajax_form_del_transportista_mob_validate_tr_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tr_nombre";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_transportista_mob_validate_tr_nombre_cb

  // ---------- Validate tr_email
  function do_ajax_form_del_transportista_mob_validate_tr_email()
  {
    var nomeCampo_tr_email = "tr_email";
    var var_tr_email = scAjaxGetFieldText(nomeCampo_tr_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_transportista_mob_validate_tr_email(var_tr_email, var_script_case_init, do_ajax_form_del_transportista_mob_validate_tr_email_cb);
  } // do_ajax_form_del_transportista_mob_validate_tr_email

  function do_ajax_form_del_transportista_mob_validate_tr_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tr_email";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_transportista_mob_validate_tr_email_cb

  // ---------- Validate tr_telefono
  function do_ajax_form_del_transportista_mob_validate_tr_telefono()
  {
    var nomeCampo_tr_telefono = "tr_telefono";
    var var_tr_telefono = scAjaxGetFieldText(nomeCampo_tr_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_transportista_mob_validate_tr_telefono(var_tr_telefono, var_script_case_init, do_ajax_form_del_transportista_mob_validate_tr_telefono_cb);
  } // do_ajax_form_del_transportista_mob_validate_tr_telefono

  function do_ajax_form_del_transportista_mob_validate_tr_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tr_telefono";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_transportista_mob_validate_tr_telefono_cb

  // ---------- Validate tr_celular
  function do_ajax_form_del_transportista_mob_validate_tr_celular()
  {
    var nomeCampo_tr_celular = "tr_celular";
    var var_tr_celular = scAjaxGetFieldText(nomeCampo_tr_celular);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_transportista_mob_validate_tr_celular(var_tr_celular, var_script_case_init, do_ajax_form_del_transportista_mob_validate_tr_celular_cb);
  } // do_ajax_form_del_transportista_mob_validate_tr_celular

  function do_ajax_form_del_transportista_mob_validate_tr_celular_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tr_celular";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_transportista_mob_validate_tr_celular_cb

  // ---------- Validate tr_pais
  function do_ajax_form_del_transportista_mob_validate_tr_pais()
  {
    var nomeCampo_tr_pais = "tr_pais";
    var var_tr_pais = scAjaxGetFieldSelect(nomeCampo_tr_pais);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_transportista_mob_validate_tr_pais(var_tr_pais, var_script_case_init, do_ajax_form_del_transportista_mob_validate_tr_pais_cb);
  } // do_ajax_form_del_transportista_mob_validate_tr_pais

  function do_ajax_form_del_transportista_mob_validate_tr_pais_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tr_pais";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_transportista_mob_validate_tr_pais_cb

  // ---------- Validate tr_provincia
  function do_ajax_form_del_transportista_mob_validate_tr_provincia()
  {
    var nomeCampo_tr_provincia = "tr_provincia";
    var var_tr_provincia = scAjaxGetFieldSelect(nomeCampo_tr_provincia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_transportista_mob_validate_tr_provincia(var_tr_provincia, var_script_case_init, do_ajax_form_del_transportista_mob_validate_tr_provincia_cb);
  } // do_ajax_form_del_transportista_mob_validate_tr_provincia

  function do_ajax_form_del_transportista_mob_validate_tr_provincia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tr_provincia";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_transportista_mob_validate_tr_provincia_cb

  // ---------- Validate tr_ciudad
  function do_ajax_form_del_transportista_mob_validate_tr_ciudad()
  {
    var nomeCampo_tr_ciudad = "tr_ciudad";
    var var_tr_ciudad = scAjaxGetFieldSelect(nomeCampo_tr_ciudad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_transportista_mob_validate_tr_ciudad(var_tr_ciudad, var_script_case_init, do_ajax_form_del_transportista_mob_validate_tr_ciudad_cb);
  } // do_ajax_form_del_transportista_mob_validate_tr_ciudad

  function do_ajax_form_del_transportista_mob_validate_tr_ciudad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tr_ciudad";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_transportista_mob_validate_tr_ciudad_cb

  // ---------- Validate tr_direccion
  function do_ajax_form_del_transportista_mob_validate_tr_direccion()
  {
    var nomeCampo_tr_direccion = "tr_direccion";
    var var_tr_direccion = scAjaxGetFieldText(nomeCampo_tr_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_transportista_mob_validate_tr_direccion(var_tr_direccion, var_script_case_init, do_ajax_form_del_transportista_mob_validate_tr_direccion_cb);
  } // do_ajax_form_del_transportista_mob_validate_tr_direccion

  function do_ajax_form_del_transportista_mob_validate_tr_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tr_direccion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_transportista_mob_validate_tr_direccion_cb

  // ---------- Validate tr_placa
  function do_ajax_form_del_transportista_mob_validate_tr_placa()
  {
    var nomeCampo_tr_placa = "tr_placa";
    var var_tr_placa = scAjaxGetFieldText(nomeCampo_tr_placa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_transportista_mob_validate_tr_placa(var_tr_placa, var_script_case_init, do_ajax_form_del_transportista_mob_validate_tr_placa_cb);
  } // do_ajax_form_del_transportista_mob_validate_tr_placa

  function do_ajax_form_del_transportista_mob_validate_tr_placa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tr_placa";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_transportista_mob_validate_tr_placa_cb

  // ---------- Refresh tr_pais
  function do_ajax_form_del_transportista_mob_refresh_tr_pais()
  {
    var var_tr_pais = scAjaxGetFieldSelect("tr_pais");
    var var_tr_provincia = scAjaxGetFieldSelect("tr_provincia");
    var var_nmgp_refresh_fields = "tr_provincia_#fld#_tr_ciudad";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_transportista_mob_refresh_tr_pais(var_tr_pais, var_tr_provincia, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_del_transportista_mob_refresh_tr_pais_cb);
  } // do_ajax_form_del_transportista_mob_refresh_tr_pais

  function do_ajax_form_del_transportista_mob_refresh_tr_pais_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    do_ajax_form_del_transportista_mob_refresh_tr_provincia();
    scAjaxShowDebug();
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_transportista_mob_refresh_tr_pais_cb

  // ---------- Refresh tr_provincia
  function do_ajax_form_del_transportista_mob_refresh_tr_provincia()
  {
    var var_tr_provincia = scAjaxGetFieldSelect("tr_provincia");
    var var_nmgp_refresh_fields = "tr_ciudad";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_transportista_mob_refresh_tr_provincia(var_tr_provincia, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_del_transportista_mob_refresh_tr_provincia_cb);
  } // do_ajax_form_del_transportista_mob_refresh_tr_provincia

  function do_ajax_form_del_transportista_mob_refresh_tr_provincia_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_transportista_mob_refresh_tr_provincia_cb

  // ---------- Event onblur tr_identificacion
  function do_ajax_form_del_transportista_mob_event_tr_identificacion_onblur()
  {
    var var_tr_tipo_identificacion = scAjaxGetFieldSelect("tr_tipo_identificacion");
    var var_tr_identificacion = scAjaxGetFieldText("tr_identificacion");
    var var_tr_nombre = scAjaxGetFieldText("tr_nombre");
    var var_tr_direccion = scAjaxGetFieldText("tr_direccion");
    var var_tr_email = scAjaxGetFieldText("tr_email");
    var var_tr_telefono = scAjaxGetFieldText("tr_telefono");
    var var_tr_pais = scAjaxGetFieldSelect("tr_pais");
    var var_tr_provincia = scAjaxGetFieldSelect("tr_provincia");
    var var_tr_ciudad = scAjaxGetFieldSelect("tr_ciudad");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_transportista_mob_event_tr_identificacion_onblur(var_tr_tipo_identificacion, var_tr_identificacion, var_tr_nombre, var_tr_direccion, var_tr_email, var_tr_telefono, var_tr_pais, var_tr_provincia, var_tr_ciudad, var_script_case_init, do_ajax_form_del_transportista_mob_event_tr_identificacion_onblur_cb);
  } // do_ajax_form_del_transportista_mob_event_tr_identificacion_onblur

  function do_ajax_form_del_transportista_mob_event_tr_identificacion_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "tr_identificacion";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_transportista_mob_event_tr_identificacion_onblur_cb_after_alert);
  } // do_ajax_form_del_transportista_mob_event_tr_identificacion_onblur_cb
  function do_ajax_form_del_transportista_mob_event_tr_identificacion_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_transportista_mob_event_tr_identificacion_onblur_cb_after_alert

  // ---------- Event onchange tr_tipo_identificacion
  function do_ajax_form_del_transportista_mob_event_tr_tipo_identificacion_onchange()
  {
    var var_tr_identificacion = scAjaxGetFieldText("tr_identificacion");
    var var_tr_tipo_identificacion = scAjaxGetFieldSelect("tr_tipo_identificacion");
    var var_tr_nombre = scAjaxGetFieldText("tr_nombre");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_transportista_mob_event_tr_tipo_identificacion_onchange(var_tr_identificacion, var_tr_tipo_identificacion, var_tr_nombre, var_tr_direccion, var_tr_email, var_tr_telefono, var_tr_pais, var_tr_provincia, var_tr_ciudad, var_script_case_init, do_ajax_form_del_transportista_mob_event_tr_tipo_identificacion_onchange_cb);
  } // do_ajax_form_del_transportista_mob_event_tr_tipo_identificacion_onchange

  function do_ajax_form_del_transportista_mob_event_tr_tipo_identificacion_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "tr_tipo_identificacion";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_transportista_mob_event_tr_tipo_identificacion_onchange_cb_after_alert);
  } // do_ajax_form_del_transportista_mob_event_tr_tipo_identificacion_onchange_cb
  function do_ajax_form_del_transportista_mob_event_tr_tipo_identificacion_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_transportista_mob_event_tr_tipo_identificacion_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_transportista_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_transportista_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_tr_id = scAjaxGetFieldHidden("tr_id");
    var var_tr_empresa = scAjaxGetFieldText("tr_empresa");
    var var_tr_tipo_identificacion = scAjaxGetFieldSelect("tr_tipo_identificacion");
    var var_tr_identificacion = scAjaxGetFieldText("tr_identificacion");
    var var_tr_nombre = scAjaxGetFieldText("tr_nombre");
    var var_tr_email = scAjaxGetFieldText("tr_email");
    var var_tr_telefono = scAjaxGetFieldText("tr_telefono");
    var var_tr_celular = scAjaxGetFieldText("tr_celular");
    var var_tr_pais = scAjaxGetFieldSelect("tr_pais");
    var var_tr_provincia = scAjaxGetFieldSelect("tr_provincia");
    var var_tr_ciudad = scAjaxGetFieldSelect("tr_ciudad");
    var var_tr_direccion = scAjaxGetFieldText("tr_direccion");
    var var_tr_placa = scAjaxGetFieldText("tr_placa");
    ...
    scAjaxProcOn();
    x_ajax_form_del_transportista_mob_submit_form(var_tr_id, var_tr_empresa, var_tr_tipo_identificacion, var_tr_identificacion, var_tr_nombre, var_tr_email, var_tr_telefono, var_tr_celular, var_tr_pais, var_tr_provincia, var_tr_ciudad, var_tr_direccion, var_tr_placa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_transportista_mob_submit_form_cb);
  } // do_ajax_form_del_transportista_mob_submit_form

  function do_ajax_form_del_transportista_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("tr_id");
      scAjaxHideErrorDisplay("tr_empresa");
      scAjaxHideErrorDisplay("tr_tipo_identificacion");
      scAjaxHideErrorDisplay("tr_identificacion");
      scAjaxHideErrorDisplay("tr_nombre");
      scAjaxHideErrorDisplay("tr_email");
      scAjaxHideErrorDisplay("tr_telefono");
      scAjaxHideErrorDisplay("tr_celular");
      scAjaxHideErrorDisplay("tr_pais");
      scAjaxHideErrorDisplay("tr_provincia");
      scAjaxHideErrorDisplay("tr_ciudad");
      scAjaxHideErrorDisplay("tr_direccion");
      scAjaxHideErrorDisplay("tr_placa");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_transportista_mob_submit_form_cb_after_alert);
  } // do_ajax_form_del_transportista_mob_submit_form_cb
  function do_ajax_form_del_transportista_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_transportista_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_transportista_mob_navigate_form()
  {
    perform_ajax_form_del_transportista_mob_navigate_form();
  }

  function perform_ajax_form_del_transportista_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("tr_direccion");
    scAjaxHideErrorDisplay("tr_placa");
    var var_tr_id = document.F2.tr_id.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_transportista_mob_navigate_form(var_tr_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_transportista_mob_navigate_form_cb);
  } // do_ajax_form_del_transportista_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_transportista_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_transportista_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.tr_id.value = scAjaxGetKeyValue("tr_id");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_transportista_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_del_transportista_mob_navigate_form_cb
  function do_ajax_form_del_transportista_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_del_transportista_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_transportista_mob_navigate_form_cb_after_alert

  function sc_hide_form_del_transportista_mob_form()
  {
  ...
  ajax_field_list[0] = "tr_id";
  ajax_field_list[1] = "tr_empresa";
  ajax_field_list[2] = "tr_tipo_identificacion";
  ajax_field_list[3] = "tr_identificacion";
  ajax_field_list[4] = "tr_nombre";
  ajax_field_list[5] = "tr_email";
  ajax_field_list[6] = "tr_telefono";
  ajax_field_list[7] = "tr_celular";
  ajax_field_list[8] = "tr_pais";
  ajax_field_list[9] = "tr_provincia";
  ajax_field_list[10] = "tr_ciudad";
  ajax_field_list[11] = "tr_direccion";
  ajax_field_list[12] = "tr_placa";
  ...
  var ajax_error_list = {
    "tr_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tr_empresa": {"label": "<?php echo $this->Ini->Nm_lang['lang_empresa'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tr_tipo_identificacion": {"label": "<?php echo $this->Ini->Nm_lang['lang_tipo_identificacion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tr_identificacion": {"label": "<?php echo $this->Ini->Nm_lang['lang_lot_identificacion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tr_nombre": {"label": "<?php echo $this->Ini->Nm_lang['lang_nombre'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tr_email": {"label": "<?php echo $this->Ini->Nm_lang['lang_email'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tr_telefono": {"label": "<?php echo $this->Ini->Nm_lang['lang_lot_telefono'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tr_celular": {"label": "<?php echo $this->Ini->Nm_lang['lang_celular'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tr_pais": {"label": "<?php echo $this->Ini->Nm_lang['lang_pais'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tr_provincia": {"label": "<?php echo $this->Ini->Nm_lang['lang_provincia'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tr_ciudad": {"label": "<?php echo $this->Ini->Nm_lang['lang_ciudad'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tr_direccion": {"label": "<?php echo $this->Ini->Nm_lang['lang_direccion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tr_placa": {"label": "<?php echo $this->Ini->Nm_lang['lang_placa'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "tr_id": new Array(),
    "tr_empresa": new Array(),
    "tr_tipo_identificacion": new Array(),
    "tr_identificacion": new Array(),
    "tr_nombre": new Array(),
    "tr_email": new Array(),
    "tr_telefono": new Array(),
    "tr_celular": new Array(),
    "tr_pais": new Array(),
    "tr_provincia": new Array(),
    "tr_ciudad": new Array(),
    "tr_direccion": new Array(),
    "tr_placa": new Array()
  };
  ajax_field_mult["tr_id"][1] = "tr_id";
  ajax_field_mult["tr_empresa"][1] = "tr_empresa";
  ajax_field_mult["tr_tipo_identificacion"][1] = "tr_tipo_identificacion";
  ajax_field_mult["tr_identificacion"][1] = "tr_identificacion";
  ajax_field_mult["tr_nombre"][1] = "tr_nombre";
  ajax_field_mult["tr_email"][1] = "tr_email";
  ajax_field_mult["tr_telefono"][1] = "tr_telefono";
  ajax_field_mult["tr_celular"][1] = "tr_celular";
  ajax_field_mult["tr_pais"][1] = "tr_pais";
  ajax_field_mult["tr_provincia"][1] = "tr_provincia";
  ajax_field_mult["tr_ciudad"][1] = "tr_ciudad";
  ajax_field_mult["tr_direccion"][1] = "tr_direccion";
  ajax_field_mult["tr_placa"][1] = "tr_placa";

  var ajax_field_id = {
    "tr_tipo_identificacion": new Array("hidden_field_label_tr_tipo_identificacion", "hidden_field_data_tr_tipo_identificacion"),
    "tr_identificacion": new Array("hidden_field_label_tr_identificacion", "hidden_field_data_tr_identificacion"),
    "tr_nombre": new Array("hidden_field_label_tr_nombre", "hidden_field_data_tr_nombre"),
    "tr_email": new Array("hidden_field_label_tr_email", "hidden_field_data_tr_email"),
    "tr_telefono": new Array("hidden_field_label_tr_telefono", "hidden_field_data_tr_telefono"),
    "tr_celular": new Array("hidden_field_label_tr_celular", "hidden_field_data_tr_celular"),
    "tr_pais": new Array("hidden_field_label_tr_pais", "hidden_field_data_tr_pais"),
    "tr_provincia": new Array("hidden_field_label_tr_provincia", "hidden_field_data_tr_provincia"),
    "tr_ciudad": new Array("hidden_field_label_tr_ciudad", "hidden_field_data_tr_ciudad"),
    "tr_direccion": new Array("hidden_field_label_tr_direccion", "hidden_field_data_tr_direccion"),
    "tr_placa": new Array("hidden_field_label_tr_placa", "hidden_field_data_tr_placa")
  };

  var ajax_read_only = {
    "tr_id": "on",
    "tr_empresa": "off",
    "tr_tipo_identificacion": "off",
    "tr_identificacion": "off",
    "tr_nombre": "off",
    "tr_email": "off",
    "tr_telefono": "off",
    "tr_celular": "off",
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("tr_tipo_identificacion" == sIndex)
    {
