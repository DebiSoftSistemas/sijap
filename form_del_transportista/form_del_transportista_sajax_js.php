  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_transportista" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_transportista_form();
	}
...
?>
  ...
  // ---------- Validate tr_id
  function do_ajax_form_del_transportista_validate_tr_id()
  {
    var nomeCampo_tr_id = "tr_id";
    var var_tr_id = scAjaxGetFieldHidden(nomeCampo_tr_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_transportista_validate_tr_id(var_tr_id, var_script_case_init, do_ajax_form_del_transportista_validate_tr_id_cb);
  } // do_ajax_form_del_transportista_validate_tr_id

  function do_ajax_form_del_transportista_validate_tr_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_transportista_validate_tr_id_cb

  // ---------- Validate tr_empresa
  function do_ajax_form_del_transportista_validate_tr_empresa()
  {
    var nomeCampo_tr_empresa = "tr_empresa";
    var var_tr_empresa = scAjaxGetFieldText(nomeCampo_tr_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_transportista_validate_tr_empresa(var_tr_empresa, var_script_case_init, do_ajax_form_del_transportista_validate_tr_empresa_cb);
  } // do_ajax_form_del_transportista_validate_tr_empresa

  function do_ajax_form_del_transportista_validate_tr_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_transportista_validate_tr_empresa_cb

  // ---------- Validate tr_tipo_identificacion
  function do_ajax_form_del_transportista_validate_tr_tipo_identificacion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_transportista_validate_tr_tipo_identificacion(var_tr_tipo_identificacion, var_script_case_init, do_ajax_form_del_transportista_validate_tr_tipo_identificacion_cb);
  } // do_ajax_form_del_transportista_validate_tr_tipo_identificacion

  function do_ajax_form_del_transportista_validate_tr_tipo_identificacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_transportista_validate_tr_tipo_identificacion_cb

  // ---------- Validate tr_identificacion
  function do_ajax_form_del_transportista_validate_tr_identificacion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_transportista_validate_tr_identificacion(var_tr_identificacion, var_script_case_init, do_ajax_form_del_transportista_validate_tr_identificacion_cb);
  } // do_ajax_form_del_transportista_validate_tr_identificacion

  function do_ajax_form_del_transportista_validate_tr_identificacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_transportista_validate_tr_identificacion_cb

  // ---------- Validate tr_nombre
  function do_ajax_form_del_transportista_validate_tr_nombre()
  {
    var nomeCampo_tr_nombre = "tr_nombre";
    var var_tr_nombre = scAjaxGetFieldText(nomeCampo_tr_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_transportista_validate_tr_nombre(var_tr_nombre, var_script_case_init, do_ajax_form_del_transportista_validate_tr_nombre_cb);
  } // do_ajax_form_del_transportista_validate_tr_nombre

  function do_ajax_form_del_transportista_validate_tr_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_transportista_validate_tr_nombre_cb

  // ---------- Validate tr_email
  function do_ajax_form_del_transportista_validate_tr_email()
  {
    var nomeCampo_tr_email = "tr_email";
    var var_tr_email = scAjaxGetFieldText(nomeCampo_tr_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_transportista_validate_tr_email(var_tr_email, var_script_case_init, do_ajax_form_del_transportista_validate_tr_email_cb);
  } // do_ajax_form_del_transportista_validate_tr_email

  function do_ajax_form_del_transportista_validate_tr_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_transportista_validate_tr_email_cb

  // ---------- Validate tr_telefono
  function do_ajax_form_del_transportista_validate_tr_telefono()
  {
    var nomeCampo_tr_telefono = "tr_telefono";
    var var_tr_telefono = scAjaxGetFieldText(nomeCampo_tr_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_transportista_validate_tr_telefono(var_tr_telefono, var_script_case_init, do_ajax_form_del_transportista_validate_tr_telefono_cb);
  } // do_ajax_form_del_transportista_validate_tr_telefono

  function do_ajax_form_del_transportista_validate_tr_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_transportista_validate_tr_telefono_cb

  // ---------- Validate tr_celular
  function do_ajax_form_del_transportista_validate_tr_celular()
  {
    var nomeCampo_tr_celular = "tr_celular";
    var var_tr_celular = scAjaxGetFieldText(nomeCampo_tr_celular);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_transportista_validate_tr_celular(var_tr_celular, var_script_case_init, do_ajax_form_del_transportista_validate_tr_celular_cb);
  } // do_ajax_form_del_transportista_validate_tr_celular

  function do_ajax_form_del_transportista_validate_tr_celular_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_transportista_validate_tr_celular_cb

  // ---------- Validate tr_pais
  function do_ajax_form_del_transportista_validate_tr_pais()
  {
    var nomeCampo_tr_pais = "tr_pais";
    var var_tr_pais = scAjaxGetFieldSelect(nomeCampo_tr_pais);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_transportista_validate_tr_pais(var_tr_pais, var_script_case_init, do_ajax_form_del_transportista_validate_tr_pais_cb);
  } // do_ajax_form_del_transportista_validate_tr_pais

  function do_ajax_form_del_transportista_validate_tr_pais_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tr_pais";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_transportista_validate_tr_pais_cb

  // ---------- Validate tr_provincia
  function do_ajax_form_del_transportista_validate_tr_provincia()
  {
    var nomeCampo_tr_provincia = "tr_provincia";
    var var_tr_provincia = scAjaxGetFieldSelect(nomeCampo_tr_provincia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_transportista_validate_tr_provincia(var_tr_provincia, var_script_case_init, do_ajax_form_del_transportista_validate_tr_provincia_cb);
  } // do_ajax_form_del_transportista_validate_tr_provincia

  function do_ajax_form_del_transportista_validate_tr_provincia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_transportista_validate_tr_provincia_cb

  // ---------- Validate tr_ciudad
  function do_ajax_form_del_transportista_validate_tr_ciudad()
  {
    var nomeCampo_tr_ciudad = "tr_ciudad";
    var var_tr_ciudad = scAjaxGetFieldSelect(nomeCampo_tr_ciudad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_transportista_validate_tr_ciudad(var_tr_ciudad, var_script_case_init, do_ajax_form_del_transportista_validate_tr_ciudad_cb);
  } // do_ajax_form_del_transportista_validate_tr_ciudad

  function do_ajax_form_del_transportista_validate_tr_ciudad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_transportista_validate_tr_ciudad_cb

  // ---------- Validate tr_direccion
  function do_ajax_form_del_transportista_validate_tr_direccion()
  {
    var nomeCampo_tr_direccion = "tr_direccion";
    var var_tr_direccion = scAjaxGetFieldText(nomeCampo_tr_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_transportista_validate_tr_direccion(var_tr_direccion, var_script_case_init, do_ajax_form_del_transportista_validate_tr_direccion_cb);
  } // do_ajax_form_del_transportista_validate_tr_direccion

  function do_ajax_form_del_transportista_validate_tr_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_transportista_validate_tr_direccion_cb

  // ---------- Validate tr_placa
  function do_ajax_form_del_transportista_validate_tr_placa()
  {
    var nomeCampo_tr_placa = "tr_placa";
    var var_tr_placa = scAjaxGetFieldText(nomeCampo_tr_placa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_transportista_validate_tr_placa(var_tr_placa, var_script_case_init, do_ajax_form_del_transportista_validate_tr_placa_cb);
  } // do_ajax_form_del_transportista_validate_tr_placa

  function do_ajax_form_del_transportista_validate_tr_placa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_transportista_validate_tr_placa_cb

  // ---------- Refresh tr_pais
  function do_ajax_form_del_transportista_refresh_tr_pais()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_del_transportista_refresh_tr_pais(var_tr_pais, var_tr_provincia, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_del_transportista_refresh_tr_pais_cb);
  } // do_ajax_form_del_transportista_refresh_tr_pais

  function do_ajax_form_del_transportista_refresh_tr_pais_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    do_ajax_form_del_transportista_refresh_tr_provincia();
    scAjaxShowDebug();
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_transportista_refresh_tr_pais_cb

  // ---------- Refresh tr_provincia
  function do_ajax_form_del_transportista_refresh_tr_provincia()
  {
    var var_tr_provincia = scAjaxGetFieldSelect("tr_provincia");
    var var_nmgp_refresh_fields = "tr_ciudad";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_transportista_refresh_tr_provincia(var_tr_provincia, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_del_transportista_refresh_tr_provincia_cb);
  } // do_ajax_form_del_transportista_refresh_tr_provincia

  function do_ajax_form_del_transportista_refresh_tr_provincia_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_transportista_refresh_tr_provincia_cb

  // ---------- Event onblur tr_identificacion
  function do_ajax_form_del_transportista_event_tr_identificacion_onblur()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_transportista_event_tr_identificacion_onblur(var_tr_tipo_identificacion, var_tr_identificacion, var_tr_nombre, var_tr_direccion, var_tr_email, var_tr_telefono, var_tr_pais, var_tr_provincia, var_tr_ciudad, var_script_case_init, do_ajax_form_del_transportista_event_tr_identificacion_onblur_cb);
  } // do_ajax_form_del_transportista_event_tr_identificacion_onblur

  function do_ajax_form_del_transportista_event_tr_identificacion_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "tr_identificacion";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_transportista_event_tr_identificacion_onblur_cb_after_alert);
  } // do_ajax_form_del_transportista_event_tr_identificacion_onblur_cb
  function do_ajax_form_del_transportista_event_tr_identificacion_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_transportista_event_tr_identificacion_onblur_cb_after_alert

  // ---------- Event onchange tr_tipo_identificacion
  function do_ajax_form_del_transportista_event_tr_tipo_identificacion_onchange()
  {
    var var_tr_identificacion = scAjaxGetFieldText("tr_identificacion");
    var var_tr_tipo_identificacion = scAjaxGetFieldSelect("tr_tipo_identificacion");
    var var_tr_nombre = scAjaxGetFieldText("tr_nombre");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_transportista_event_tr_tipo_identificacion_onchange(var_tr_identificacion, var_tr_tipo_identificacion, var_tr_nombre, var_tr_direccion, var_tr_email, var_tr_telefono, var_tr_pais, var_tr_provincia, var_tr_ciudad, var_script_case_init, do_ajax_form_del_transportista_event_tr_tipo_identificacion_onchange_cb);
  } // do_ajax_form_del_transportista_event_tr_tipo_identificacion_onchange

  function do_ajax_form_del_transportista_event_tr_tipo_identificacion_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "tr_tipo_identificacion";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_transportista_event_tr_tipo_identificacion_onchange_cb_after_alert);
  } // do_ajax_form_del_transportista_event_tr_tipo_identificacion_onchange_cb
  function do_ajax_form_del_transportista_event_tr_tipo_identificacion_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_transportista_event_tr_tipo_identificacion_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_del_transportista_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_del_transportista_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_del_transportista_submit_form(var_tr_id, var_tr_empresa, var_tr_tipo_identificacion, var_tr_identificacion, var_tr_nombre, var_tr_email, var_tr_telefono, var_tr_celular, var_tr_pais, var_tr_provincia, var_tr_ciudad, var_tr_direccion, var_tr_placa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_transportista_submit_form_cb);
  } // do_ajax_form_del_transportista_submit_form

  function do_ajax_form_del_transportista_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_del_transportista_submit_form_cb_after_alert);
  } // do_ajax_form_del_transportista_submit_form_cb
  function do_ajax_form_del_transportista_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_transportista_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_transportista_navigate_form()
  {
    perform_ajax_form_del_transportista_navigate_form();
  }

  function perform_ajax_form_del_transportista_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_transportista_navigate_form(var_tr_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_transportista_navigate_form_cb);
  } // do_ajax_form_del_transportista_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_transportista']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_transportista_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_transportista_navigate_form_cb_after_alert);
  } // do_ajax_form_del_transportista_navigate_form_cb
  function do_ajax_form_del_transportista_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_del_transportista_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_del_transportista_navigate_form_cb_after_alert

  function sc_hide_form_del_transportista_form()
  {
