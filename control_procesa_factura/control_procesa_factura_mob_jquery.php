...
function scEventControl_onCalculator_fr_valor() {
  if (!_scCalculatorControl["id_sc_field_fr_valor"]) {
    ...
    do_ajax_control_procesa_factura_mob_event_fr_valor_onblur();
  }
...
function scEventControl_onCalculator_fr_valor2() {
  if (!_scCalculatorControl["id_sc_field_fr_valor2"]) {
    ...
    do_ajax_control_procesa_factura_mob_event_fr_valor2_onblur();
  }
...
function scEventControl_onCalculator_fr_valor3() {
  if (!_scCalculatorControl["id_sc_field_fr_valor3"]) {
    ...
    do_ajax_control_procesa_factura_mob_event_fr_valor3_onblur();
  }
...
function scHidePage(pageNo) {
	$("#id_control_procesa_factura_mob_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'control_procesa_factura_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
