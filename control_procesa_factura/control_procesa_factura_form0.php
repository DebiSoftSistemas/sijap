...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>control_procesa_factura/control_procesa_factura_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("control_procesa_factura_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('control_procesa_factura_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['link_info']['remove_border']) {
...
<?php
 include_once("control_procesa_factura_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_procesa_factura'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_procesa_factura'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['empty_filter'] = true;
       }
  }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fr_cedula_label" id="hidden_field_label_fr_cedula" style="<?php echo $sStyleHidden_fr_cedula; ?>"><span id="id_label_fr_cedula"><?php echo $this->nm_new_label['fr_cedula']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['php_cmp_required']['fr_cedula']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['php_cmp_required']['fr_cedula'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fr_nombre_label" id="hidden_field_label_fr_nombre" style="<?php echo $sStyleHidden_fr_nombre; ?>"><span id="id_label_fr_nombre"><?php echo $this->nm_new_label['fr_nombre']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['php_cmp_required']['fr_nombre']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['php_cmp_required']['fr_nombre'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fac_libretin_label" id="hidden_field_label_fac_libretin" style="<?php echo $sStyleHidden_fac_libretin; ?>"><span id="id_label_fac_libretin"><?php echo $this->nm_new_label['fac_libretin']; ?></span></TD>
    <TD class="scFormDataOdd css_fac_libretin_line" id="hidden_field_data_fac_libretin" style="<?php echo $sStyleHidden_fac_libretin; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fr_provincia_label" id="hidden_field_label_fr_provincia" style="<?php echo $sStyleHidden_fr_provincia; ?>"><span id="id_label_fr_provincia"><?php echo $this->nm_new_label['fr_provincia']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['php_cmp_required']['fr_provincia']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['php_cmp_required']['fr_provincia'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fr_canton_label" id="hidden_field_label_fr_canton" style="<?php echo $sStyleHidden_fr_canton; ?>"><span id="id_label_fr_canton"><?php echo $this->nm_new_label['fr_canton']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['php_cmp_required']['fr_canton']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['php_cmp_required']['fr_canton'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fr_direccion_label" id="hidden_field_label_fr_direccion" style="<?php echo $sStyleHidden_fr_direccion; ?>"><span id="id_label_fr_direccion"><?php echo $this->nm_new_label['fr_direccion']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['php_cmp_required']['fr_direccion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['php_cmp_required']['fr_direccion'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fr_tipo_identificacion_label" id="hidden_field_label_fr_tipo_identificacion" style="<?php echo $sStyleHidden_fr_tipo_identificacion; ?>"><span id="id_label_fr_tipo_identificacion"><?php echo $this->nm_new_label['fr_tipo_identificacion']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['php_cmp_required']['fr_tipo_identificacion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['php_cmp_required']['fr_tipo_identificacion'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fr_correo_label" id="hidden_field_label_fr_correo" style="<?php echo $sStyleHidden_fr_correo; ?>"><span id="id_label_fr_correo"><?php echo $this->nm_new_label['fr_correo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['php_cmp_required']['fr_correo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['php_cmp_required']['fr_correo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fac_estado_sri_label" id="hidden_field_label_fac_estado_sri" style="<?php echo $sStyleHidden_fac_estado_sri; ?>"><span id="id_label_fac_estado_sri"><?php echo $this->nm_new_label['fac_estado_sri']; ?></span></TD>
    <TD class="scFormDataOdd css_fac_estado_sri_line" id="hidden_field_data_fac_estado_sri" style="<?php echo $sStyleHidden_fac_estado_sri; ?>">
...
<?php $sStyleHidden_fr_forma_pago_dumb = ('' == $sStyleHidden_fr_forma_pago) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_fr_forma_pago_dumb" style="<?php echo $sStyleHidden_fr_forma_pago_dumb; ?>"></TD>
...
<?php $sStyleHidden_fr_forma_pago2_dumb = ('' == $sStyleHidden_fr_forma_pago2) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_fr_forma_pago2_dumb" style="<?php echo $sStyleHidden_fr_forma_pago2_dumb; ?>"></TD>
...
<?php $sStyleHidden_fr_forma_pago3_dumb = ('' == $sStyleHidden_fr_forma_pago3) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_fr_forma_pago3_dumb" style="<?php echo $sStyleHidden_fr_forma_pago3_dumb; ?>"></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_total_pago_label" id="hidden_field_label_total_pago" style="<?php echo $sStyleHidden_total_pago; ?>"><span id="id_label_total_pago"><?php echo $this->nm_new_label['total_pago']; ?></span></TD>
    <TD class="scFormDataOdd css_total_pago_line" id="hidden_field_data_total_pago" style="<?php echo $sStyleHidden_total_pago; ?>"><input type="hidden" name="total_pago" value="<?php echo $this->form_encode_input($total_pago); ?>"><span id="id_ajax_label_total_pago"><?php echo nl2br($total_pago); ?></span>
</TD>
   <?php }?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['btn_disabled']['ok']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['btn_disabled']['ok']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['btn_label']['ok']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['btn_label']['ok']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['btn_label']['ok'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['btn_label']['help'];
        }
?>
...
<?php
    if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['nm_run_menu'] != 1))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['btn_label']['exit'];
        }
?>
...
<?php
    if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("control_procesa_factura");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("control_procesa_factura");
 parent.scAjaxDetailHeight("control_procesa_factura", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['control_procesa_factura']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
