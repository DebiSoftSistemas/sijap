  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_inv_unidad_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_inv_unidad_mob_form();
	}
...
?>
  ...
  // ---------- Validate uni_id
  function do_ajax_form_inv_unidad_mob_validate_uni_id()
  {
    var nomeCampo_uni_id = "uni_id";
    var var_uni_id = scAjaxGetFieldHidden(nomeCampo_uni_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_unidad_mob_validate_uni_id(var_uni_id, var_script_case_init, do_ajax_form_inv_unidad_mob_validate_uni_id_cb);
  } // do_ajax_form_inv_unidad_mob_validate_uni_id

  function do_ajax_form_inv_unidad_mob_validate_uni_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_unidad_mob_validate_uni_id_cb

  // ---------- Validate uni_empresa
  function do_ajax_form_inv_unidad_mob_validate_uni_empresa()
  {
    var nomeCampo_uni_empresa = "uni_empresa";
    var var_uni_empresa = scAjaxGetFieldText(nomeCampo_uni_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_unidad_mob_validate_uni_empresa(var_uni_empresa, var_script_case_init, do_ajax_form_inv_unidad_mob_validate_uni_empresa_cb);
  } // do_ajax_form_inv_unidad_mob_validate_uni_empresa

  function do_ajax_form_inv_unidad_mob_validate_uni_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "uni_empresa";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_unidad_mob_validate_uni_empresa_cb

  // ---------- Validate uni_nombre
  function do_ajax_form_inv_unidad_mob_validate_uni_nombre()
  {
    var nomeCampo_uni_nombre = "uni_nombre";
    var var_uni_nombre = scAjaxGetFieldText(nomeCampo_uni_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_unidad_mob_validate_uni_nombre(var_uni_nombre, var_script_case_init, do_ajax_form_inv_unidad_mob_validate_uni_nombre_cb);
  } // do_ajax_form_inv_unidad_mob_validate_uni_nombre

  function do_ajax_form_inv_unidad_mob_validate_uni_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "uni_nombre";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_unidad_mob_validate_uni_nombre_cb

  // ---------- Validate uni_abreviacion
  function do_ajax_form_inv_unidad_mob_validate_uni_abreviacion()
  {
    var nomeCampo_uni_abreviacion = "uni_abreviacion";
    var var_uni_abreviacion = scAjaxGetFieldText(nomeCampo_uni_abreviacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_unidad_mob_validate_uni_abreviacion(var_uni_abreviacion, var_script_case_init, do_ajax_form_inv_unidad_mob_validate_uni_abreviacion_cb);
  } // do_ajax_form_inv_unidad_mob_validate_uni_abreviacion

  function do_ajax_form_inv_unidad_mob_validate_uni_abreviacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "uni_abreviacion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_unidad_mob_validate_uni_abreviacion_cb

  // ---------- Validate uni_tipo
  function do_ajax_form_inv_unidad_mob_validate_uni_tipo()
  {
    var nomeCampo_uni_tipo = "uni_tipo";
    var var_uni_tipo = scAjaxGetFieldSelect(nomeCampo_uni_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_unidad_mob_validate_uni_tipo(var_uni_tipo, var_script_case_init, do_ajax_form_inv_unidad_mob_validate_uni_tipo_cb);
  } // do_ajax_form_inv_unidad_mob_validate_uni_tipo

  function do_ajax_form_inv_unidad_mob_validate_uni_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "uni_tipo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_unidad_mob_validate_uni_tipo_cb

  // ---------- Validate equivalencias
  function do_ajax_form_inv_unidad_mob_validate_equivalencias()
  {
    var nomeCampo_equivalencias = "equivalencias";
    var var_equivalencias = scAjaxGetFieldText(nomeCampo_equivalencias);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_unidad_mob_validate_equivalencias(var_equivalencias, var_script_case_init, do_ajax_form_inv_unidad_mob_validate_equivalencias_cb);
  } // do_ajax_form_inv_unidad_mob_validate_equivalencias

  function do_ajax_form_inv_unidad_mob_validate_equivalencias_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "equivalencias";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_unidad_mob_validate_equivalencias_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_inv_unidad_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_inv_unidad_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_uni_id = scAjaxGetFieldHidden("uni_id");
    var var_uni_empresa = scAjaxGetFieldText("uni_empresa");
    var var_uni_nombre = scAjaxGetFieldText("uni_nombre");
    var var_uni_abreviacion = scAjaxGetFieldText("uni_abreviacion");
    var var_uni_tipo = scAjaxGetFieldSelect("uni_tipo");
    ...
    scAjaxProcOn();
    x_ajax_form_inv_unidad_mob_submit_form(var_uni_id, var_uni_empresa, var_uni_nombre, var_uni_abreviacion, var_uni_tipo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_inv_unidad_mob_submit_form_cb);
  } // do_ajax_form_inv_unidad_mob_submit_form

  function do_ajax_form_inv_unidad_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("uni_id");
      scAjaxHideErrorDisplay("uni_empresa");
      scAjaxHideErrorDisplay("uni_nombre");
      scAjaxHideErrorDisplay("uni_abreviacion");
      scAjaxHideErrorDisplay("uni_tipo");
      scAjaxHideErrorDisplay("equivalencias");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_inv_unidad_mob_submit_form_cb_after_alert);
  } // do_ajax_form_inv_unidad_mob_submit_form_cb
  function do_ajax_form_inv_unidad_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_inv_unidad_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_inv_equivalencia_mob"] = "off";

  function do_ajax_form_inv_unidad_mob_navigate_form()
  {
    perform_ajax_form_inv_unidad_mob_navigate_form();
  }

  function perform_ajax_form_inv_unidad_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("uni_tipo");
    scAjaxHideErrorDisplay("equivalencias");
    var var_uni_id = document.F2.uni_id.value;
    ...
    scAjaxProcOn();
    scStatusDetail["form_inv_equivalencia_mob"] = "on";
    x_ajax_form_inv_unidad_mob_navigate_form(var_uni_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_inv_unidad_mob_navigate_form_cb);
  } // do_ajax_form_inv_unidad_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_unidad_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_inv_unidad_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.uni_id.value = scAjaxGetKeyValue("uni_id");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_inv_equivalencia_mob"] && "nmsc_iframe_liga_form_inv_equivalencia_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_inv_equivalencia_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_inv_equivalencia_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_inv_equivalencia_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_inv_equivalencia_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_inv_equivalencia_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_inv_unidad_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_inv_unidad_mob_navigate_form_cb
  function do_ajax_form_inv_unidad_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_inv_unidad_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_inv_unidad_mob_navigate_form_cb_after_alert

  function sc_hide_form_inv_unidad_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_inv_equivalencia_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "uni_id";
  ajax_field_list[1] = "uni_empresa";
  ajax_field_list[2] = "uni_nombre";
  ajax_field_list[3] = "uni_abreviacion";
  ajax_field_list[4] = "uni_tipo";
  ajax_field_list[5] = "equivalencias";
  ...
  var ajax_error_list = {
    "uni_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "uni_empresa": {"label": "<?php echo $this->Ini->Nm_lang['lang_empresa'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "uni_nombre": {"label": "<?php echo $this->Ini->Nm_lang['lang_descripcion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "uni_abreviacion": {"label": "<?php echo $this->Ini->Nm_lang['lang_abreviatura'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "uni_tipo": {"label": "<?php echo $this->Ini->Nm_lang['lang_tipo'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "equivalencias": {"label": "equivalencias", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "uni_id": new Array(),
    "uni_empresa": new Array(),
    "uni_nombre": new Array(),
    "uni_abreviacion": new Array(),
    "uni_tipo": new Array(),
    "equivalencias": new Array()
  };
  ajax_field_mult["uni_id"][1] = "uni_id";
  ajax_field_mult["uni_empresa"][1] = "uni_empresa";
  ajax_field_mult["uni_nombre"][1] = "uni_nombre";
  ajax_field_mult["uni_abreviacion"][1] = "uni_abreviacion";
  ajax_field_mult["uni_tipo"][1] = "uni_tipo";
  ajax_field_mult["equivalencias"][1] = "equivalencias";

  var ajax_field_id = {
    "uni_nombre": new Array("hidden_field_label_uni_nombre", "hidden_field_data_uni_nombre"),
    "uni_abreviacion": new Array("hidden_field_label_uni_abreviacion", "hidden_field_data_uni_abreviacion"),
    "uni_tipo": new Array("hidden_field_label_uni_tipo", "hidden_field_data_uni_tipo"),
    "equivalencias": new Array("hidden_field_label_equivalencias", "hidden_field_data_equivalencias")
  };
