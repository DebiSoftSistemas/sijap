  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_inv_unidad" == sTestField)
        {
...
?>
  ...
  // ---------- Validate uni_id
  function do_ajax_form_inv_unidad_validate_uni_id()
  {
    var nomeCampo_uni_id = "uni_id";
    var var_uni_id = scAjaxGetFieldHidden(nomeCampo_uni_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_unidad_validate_uni_id(var_uni_id, var_script_case_init, do_ajax_form_inv_unidad_validate_uni_id_cb);
  } // do_ajax_form_inv_unidad_validate_uni_id

  function do_ajax_form_inv_unidad_validate_uni_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_unidad_validate_uni_id_cb

  // ---------- Validate uni_empresa
  function do_ajax_form_inv_unidad_validate_uni_empresa()
  {
    var nomeCampo_uni_empresa = "uni_empresa";
    var var_uni_empresa = scAjaxGetFieldText(nomeCampo_uni_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_unidad_validate_uni_empresa(var_uni_empresa, var_script_case_init, do_ajax_form_inv_unidad_validate_uni_empresa_cb);
  } // do_ajax_form_inv_unidad_validate_uni_empresa

  function do_ajax_form_inv_unidad_validate_uni_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_unidad_validate_uni_empresa_cb

  // ---------- Validate uni_nombre
  function do_ajax_form_inv_unidad_validate_uni_nombre()
  {
    var nomeCampo_uni_nombre = "uni_nombre";
    var var_uni_nombre = scAjaxGetFieldText(nomeCampo_uni_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_unidad_validate_uni_nombre(var_uni_nombre, var_script_case_init, do_ajax_form_inv_unidad_validate_uni_nombre_cb);
  } // do_ajax_form_inv_unidad_validate_uni_nombre

  function do_ajax_form_inv_unidad_validate_uni_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_unidad_validate_uni_nombre_cb

  // ---------- Validate uni_abreviacion
  function do_ajax_form_inv_unidad_validate_uni_abreviacion()
  {
    var nomeCampo_uni_abreviacion = "uni_abreviacion";
    var var_uni_abreviacion = scAjaxGetFieldText(nomeCampo_uni_abreviacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_unidad_validate_uni_abreviacion(var_uni_abreviacion, var_script_case_init, do_ajax_form_inv_unidad_validate_uni_abreviacion_cb);
  } // do_ajax_form_inv_unidad_validate_uni_abreviacion

  function do_ajax_form_inv_unidad_validate_uni_abreviacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_unidad_validate_uni_abreviacion_cb

  // ---------- Validate uni_tipo
  function do_ajax_form_inv_unidad_validate_uni_tipo()
  {
    var nomeCampo_uni_tipo = "uni_tipo";
    var var_uni_tipo = scAjaxGetFieldSelect(nomeCampo_uni_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_unidad_validate_uni_tipo(var_uni_tipo, var_script_case_init, do_ajax_form_inv_unidad_validate_uni_tipo_cb);
  } // do_ajax_form_inv_unidad_validate_uni_tipo

  function do_ajax_form_inv_unidad_validate_uni_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_unidad_validate_uni_tipo_cb

  // ---------- Validate equivalencias
  function do_ajax_form_inv_unidad_validate_equivalencias()
  {
    var nomeCampo_equivalencias = "equivalencias";
    var var_equivalencias = scAjaxGetFieldText(nomeCampo_equivalencias);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_unidad_validate_equivalencias(var_equivalencias, var_script_case_init, do_ajax_form_inv_unidad_validate_equivalencias_cb);
  } // do_ajax_form_inv_unidad_validate_equivalencias

  function do_ajax_form_inv_unidad_validate_equivalencias_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_unidad_validate_equivalencias_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_inv_unidad_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_inv_unidad_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_inv_unidad_submit_form(var_uni_id, var_uni_empresa, var_uni_nombre, var_uni_abreviacion, var_uni_tipo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_inv_unidad_submit_form_cb);
  } // do_ajax_form_inv_unidad_submit_form

  function do_ajax_form_inv_unidad_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_inv_unidad_submit_form_cb_after_alert);
  } // do_ajax_form_inv_unidad_submit_form_cb
  function do_ajax_form_inv_unidad_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_inv_unidad_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_inv_equivalencia"] = "off";

  function do_ajax_form_inv_unidad_navigate_form()
  {
    perform_ajax_form_inv_unidad_navigate_form();
  }

  function perform_ajax_form_inv_unidad_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_inv_equivalencia"] = "on";
    x_ajax_form_inv_unidad_navigate_form(var_uni_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_inv_unidad_navigate_form_cb);
  } // do_ajax_form_inv_unidad_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_unidad']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_inv_unidad_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_inv_equivalencia"] && "nmsc_iframe_liga_form_inv_equivalencia" != scMasterDetailIframe["nmsc_iframe_liga_form_inv_equivalencia"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_inv_equivalencia"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_inv_equivalencia').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_inv_equivalencia').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_inv_equivalencia').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_inv_unidad_navigate_form_cb_after_alert);
  } // do_ajax_form_inv_unidad_navigate_form_cb
  function do_ajax_form_inv_unidad_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_inv_unidad_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_inv_unidad_navigate_form_cb_after_alert

  function sc_hide_form_inv_unidad_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_inv_equivalencia"])
    {
      return true;
    }
    return false;
