...
<?php
   ...
   $Ord_Cmp = new grid_jap_escenario_reconexiones_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_jap_escenario_reconexiones_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_jap_escenario_reconexiones']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_jap_escenario_reconexiones']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["esc_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_escenario_reconexiones']['labels']["esc_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_escenario_reconexiones']['labels']["esc_id"] : "" . $this->Nm_lang['lang_id'] . "";
   $tab_ger_campos['esc_tipo_deuda'] = "on";
   $tab_def_campos['esc_tipo_deuda'] = "esc_tipo_deuda";
   $tab_labels["esc_tipo_deuda"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_escenario_reconexiones']['labels']["esc_tipo_deuda"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_escenario_reconexiones']['labels']["esc_tipo_deuda"] : "" . $this->Nm_lang['lang_tipo_deuda'] . "";
   $tab_ger_campos['esc_mes_periodo'] = "on";
   $tab_def_campos['esc_mes_periodo'] = "esc_mes_periodo";
   $tab_labels["esc_mes_periodo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_escenario_reconexiones']['labels']["esc_mes_periodo"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_escenario_reconexiones']['labels']["esc_mes_periodo"] : "" . $this->Nm_lang['lang_srch_mnth'] . "";
   $tab_ger_campos['esc_anio_periodo'] = "on";
   $tab_def_campos['esc_anio_periodo'] = "esc_anio_periodo";
   $tab_labels["esc_anio_periodo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_escenario_reconexiones']['labels']["esc_anio_periodo"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_escenario_reconexiones']['labels']["esc_anio_periodo"] : "" . $this->Nm_lang['lang_srch_year'] . "";
   $tab_ger_campos['esc_total'] = "on";
   $tab_def_campos['esc_total'] = "esc_total";
   $tab_labels["esc_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_escenario_reconexiones']['labels']["esc_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_escenario_reconexiones']['labels']["esc_total"] : "" . $this->Nm_lang['lang_total'] . "";
   $tab_ger_campos['esc_estado'] = "on";
   $tab_def_campos['esc_estado'] = "esc_estado";
   $tab_labels["esc_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_escenario_reconexiones']['labels']["esc_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_escenario_reconexiones']['labels']["esc_estado"] : "" . $this->Nm_lang['lang_estado'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_jap_escenario_reconexiones']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_jap_escenario_reconexiones']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_jap_escenario_reconexiones']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_jap_escenario_reconexiones']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_jap_escenario_reconexiones']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_jap_escenario_reconexiones']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_jap_escenario_reconexiones']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_jap_escenario_reconexiones']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_jap_escenario_reconexiones']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_jap_escenario_reconexiones']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_jap_escenario_reconexiones']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_jap_escenario_reconexiones']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_jap_escenario_reconexiones_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_jap_escenario_reconexiones']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_jap_escenario_reconexiones']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_jap_escenario_reconexiones']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_jap_escenario_reconexiones']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_jap_escenario_reconexiones']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
