...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_del_pedidos_wp"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_del_pedidos_wp"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_del_pedido_wp'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_del_pedidos_wp']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_del_pedidos_wp']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_del_pedidos_wp']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_del_pedidos_wp']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_del_pedidos_wp']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_del_pedidos_wp</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_del_pedidos_wp']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_del_pedidos_wp']['embutida_filho'] as $ind => $sc_init)
          {
