...
<?php
   ...
   $Ord_Cmp = new grid_del_sustento_retencion_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_del_sustento_retencion_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_del_sustento_retencion']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_del_sustento_retencion']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['sr_fechaemision'] = "sr_fechaemision";
   $tab_labels["sr_fechaemision"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_del_sustento_retencion']['labels']["sr_fechaemision"])) ? $_SESSION['sc_session'][$sc_init]['grid_del_sustento_retencion']['labels']["sr_fechaemision"] : "" . $this->Nm_lang['lang_fecha_emision'] . "";
   $tab_ger_campos['sr_cod_sustento'] = "on";
   $tab_def_campos['sr_cod_sustento'] = "sr_cod_sustento";
   $tab_labels["sr_cod_sustento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_del_sustento_retencion']['labels']["sr_cod_sustento"])) ? $_SESSION['sc_session'][$sc_init]['grid_del_sustento_retencion']['labels']["sr_cod_sustento"] : "" . $this->Nm_lang['lang_sustento_tributario'] . "";
   $tab_ger_campos['sr_cod_docsustento'] = "on";
   $tab_def_campos['sr_cod_docsustento'] = "sr_cod_docsustento";
   $tab_labels["sr_cod_docsustento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_del_sustento_retencion']['labels']["sr_cod_docsustento"])) ? $_SESSION['sc_session'][$sc_init]['grid_del_sustento_retencion']['labels']["sr_cod_docsustento"] : "" . $this->Nm_lang['lang_tipo_documento'] . "";
   $tab_ger_campos['sr_serie'] = "on";
   $tab_def_campos['sr_serie'] = "sr_serie";
   $tab_labels["sr_serie"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_del_sustento_retencion']['labels']["sr_serie"])) ? $_SESSION['sc_session'][$sc_init]['grid_del_sustento_retencion']['labels']["sr_serie"] : "" . $this->Nm_lang['lang_serie_sri'] . "";
   $tab_ger_campos['sr_secuencial'] = "on";
   $tab_def_campos['sr_secuencial'] = "sr_secuencial";
   $tab_labels["sr_secuencial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_del_sustento_retencion']['labels']["sr_secuencial"])) ? $_SESSION['sc_session'][$sc_init]['grid_del_sustento_retencion']['labels']["sr_secuencial"] : "" . $this->Nm_lang['lang_secuencial'] . "";
   $tab_ger_campos['sr_importe_total'] = "on";
   $tab_def_campos['sr_importe_total'] = "sr_importe_total";
   $tab_labels["sr_importe_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_del_sustento_retencion']['labels']["sr_importe_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_del_sustento_retencion']['labels']["sr_importe_total"] : "" . $this->Nm_lang['lang_total'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_del_sustento_retencion']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_del_sustento_retencion']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_del_sustento_retencion']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_del_sustento_retencion']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_del_sustento_retencion']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_del_sustento_retencion']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_del_sustento_retencion']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_del_sustento_retencion']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_del_sustento_retencion']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_del_sustento_retencion']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_del_sustento_retencion']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_del_sustento_retencion']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_del_sustento_retencion_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_del_sustento_retencion']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_del_sustento_retencion']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_del_sustento_retencion']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_del_sustento_retencion']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_del_sustento_retencion']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
