<?php
@session_start() ;
$_SESSION['scriptcase']['grid_v_inventario_bodega']['sc_process_barr'] = true;
require_once('../grid_v_inventario_bodega/index.php');
unset($_SESSION['scriptcase']['grid_v_inventario_bodega']['sc_process_barr']);
$ExportCtrl = new grid_v_inventario_bodega_export_control;
$ExportCtrl->Export_barr();

class grid_v_inventario_bodega_export_control
{
