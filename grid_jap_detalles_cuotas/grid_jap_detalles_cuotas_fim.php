...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_jap_detalles_cuotas"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_jap_detalles_cuotas"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_jap_detalles_cuotas']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_jap_detalles_cuotas']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_jap_detalles_cuotas']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_jap_detalles_cuotas']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_jap_detalles_cuotas']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_jap_detalles_cuotas</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_jap_detalles_cuotas']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_jap_detalles_cuotas']['embutida_filho'] as $ind => $sc_init)
          {
