...
<?php
   ...
   $Ord_Cmp = new grid_v_del_cuentas_por_pagar_cliente_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_v_del_cuentas_por_pagar_cliente_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_del_cuentas_por_pagar_cliente']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_del_cuentas_por_pagar_cliente']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["cl_identificacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_cuentas_por_pagar_cliente']['labels']["cl_identificacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_cuentas_por_pagar_cliente']['labels']["cl_identificacion"] : "" . $this->Nm_lang['lang_lot_identificacion'] . "";
   $tab_ger_campos['cl_nombre'] = "on";
   $tab_def_campos['cl_nombre'] = "cl_nombre";
   $tab_labels["cl_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_cuentas_por_pagar_cliente']['labels']["cl_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_cuentas_por_pagar_cliente']['labels']["cl_nombre"] : "" . $this->Nm_lang['lang_nombre'] . "";
   $tab_ger_campos['cl_direccion'] = "on";
   $tab_def_campos['cl_direccion'] = "cl_direccion";
   $tab_labels["cl_direccion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_cuentas_por_pagar_cliente']['labels']["cl_direccion"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_cuentas_por_pagar_cliente']['labels']["cl_direccion"] : "" . $this->Nm_lang['lang_direccion'] . "";
   $tab_ger_campos['cxp_valor'] = "on";
   $tab_def_campos['cxp_valor'] = "cxp_valor";
   $tab_labels["cxp_valor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_cuentas_por_pagar_cliente']['labels']["cxp_valor"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_cuentas_por_pagar_cliente']['labels']["cxp_valor"] : "" . $this->Nm_lang['lang_valor'] . "";
   ...
   $tab_labels["detalles"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_cuentas_por_pagar_cliente']['labels']["detalles"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_cuentas_por_pagar_cliente']['labels']["detalles"] : "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_cuentas_por_pagar_cliente']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_v_del_cuentas_por_pagar_cliente']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_v_del_cuentas_por_pagar_cliente']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_del_cuentas_por_pagar_cliente']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_del_cuentas_por_pagar_cliente']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_v_del_cuentas_por_pagar_cliente']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_v_del_cuentas_por_pagar_cliente']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_v_del_cuentas_por_pagar_cliente']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_cuentas_por_pagar_cliente']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_v_del_cuentas_por_pagar_cliente']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_v_del_cuentas_por_pagar_cliente']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_v_del_cuentas_por_pagar_cliente']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_v_del_cuentas_por_pagar_cliente_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_cuentas_por_pagar_cliente']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_v_del_cuentas_por_pagar_cliente']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_cuentas_por_pagar_cliente']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_v_del_cuentas_por_pagar_cliente']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_v_del_cuentas_por_pagar_cliente']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
