<?php
//
class form_del_nota_debito_compras_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_del_nota_debito_compras_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_del_nota_debito_compras_mob']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_del_nota_debito_compras_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_del_nota_debito_compras_mob']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_del_nota_debito_compras_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_del_nota_debito_compras_mob']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_del_nota_debito_compras_mob']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_del_nota_debito_compras_mob']['form_del_detalle_nota_debito_compras_mob_script_case_init'] ]['form_del_detalle_nota_debito_compras_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_del_nota_debito_compras_mob']['form_del_detalle_nota_debito_compras_mob_script_case_init'] ]['form_del_detalle_nota_debito_compras_mob']['total']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_del_nota_debito_compras_mob']['form_del_forma_pago_nd_compras_mob_script_case_init'] ]['form_del_forma_pago_nd_compras_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_del_nota_debito_compras_mob']['form_del_forma_pago_nd_compras_mob_script_case_init'] ]['form_del_forma_pago_nd_compras_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_del_nota_debito_compras_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_del_nota_debito_compras_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->var_id_nota_debito)) 
          {
              $_SESSION['var_id_nota_debito'] = $this->var_id_nota_debito;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_del_nota_debito_compras_mob']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_del_nota_debito_compras_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_del_nota_debito_compras_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_del_nota_debito_compras_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_del_nota_debito_compras_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_del_nota_debito_compras_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_del_nota_debito_compras_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_del_nota_debito_compras_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_del_nota_debito_compras_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_del_nota_debito_compras_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_debito_compras']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_debito_compras'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_debito_compras_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['form_del_nota_debito_compras_mob']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_del_nota_debito_compras_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_del_nota_debito_compras_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_del_nota_debito_compras_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_del_nota_debito_compras_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_del_nota_debito_compras_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_del_nota_debito_compras_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " del_nota_debito_compras";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_del_nota_debito_compras_mob")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_del_nota_debito_compras_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_del_nota_debito_compras_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_debito_compras_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_debito_compras_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_debito_compras_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_debito_compras_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_debito_compras_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_debito_compras_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['where_orig'] = " where (nd_numero=" . $_SESSION['var_id_nota_debito'] . ")";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['where_pesq'] = " where (nd_numero=" . $_SESSION['var_id_nota_debito'] . ")";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_debito_compras_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_debito_compras_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_debito_compras_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_del_nota_debito_compras_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_del_nota_debito_compras_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_del_nota_debito_compras_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_debito_compras_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_debito_compras_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_debito_compras_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_debito_compras_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_debito_compras_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_debito_compras_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_debito_compras_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_debito_compras_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_debito_compras_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_debito_compras_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_debito_compras_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_debito_compras_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_debito_compras_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_debito_compras_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_debito_compras_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_debito_compras_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_debito_compras_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_debito_compras_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_debito_compras_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_form'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_del_nota_debito_compras/form_del_nota_debito_compras_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_del_nota_debito_compras_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_del_nota_debito_compras_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_del_nota_debito_compras_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_del_nota_debito_compras/form_del_nota_debito_compras_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_del_nota_debito_compras_mob_erro.class.php"); 
      }
      $this->Erro      = new form_del_nota_debito_compras_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['opcao']))
         { 
             if ($this->nd_numero != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_debito_compras_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_debito_compras_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_del_nota_debito_compras_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['opc_ant'] : "";
      } 
      ...
      {
          $this->nmgp_botoes['nuevo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['botoes']['nuevo'];
          $this->nmgp_botoes['Anular'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['botoes']['Anular'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['form_del_detalle_nota_debito_compras_mob_script_case_init'] ]['form_del_detalle_nota_debito_compras_mob']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['form_del_detalle_nota_debito_compras_mob_script_case_init'] ]['form_del_detalle_nota_debito_compras_mob']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['form_del_detalle_nota_debito_compras_mob_script_case_init'] ]['form_del_detalle_nota_debito_compras_mob']['reg_start'] = "";
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['form_del_detalle_nota_debito_compras_mob_script_case_init'] ]['form_del_detalle_nota_debito_compras']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['form_del_detalle_nota_debito_compras_mob_script_case_init'] ]['form_del_detalle_nota_debito_compras']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['form_del_detalle_nota_debito_compras_mob_script_case_init'] ]['form_del_detalle_nota_debito_compras']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['form_del_detalle_nota_debito_compras_mob_script_case_init'] ]['form_del_detalle_nota_debito_compras_mob']['total']);
          $detailAppName = 'form_del_detalle_nota_debito_compras_mob';
          $detailAppObject = "form_del_detalle_nota_debito_compras_mob";
          ...
          $this->form_del_detalle_nota_debito_compras_mob = new $detailAppObject;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['form_del_forma_pago_nd_compras_mob_script_case_init'] ]['form_del_forma_pago_nd_compras_mob']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['form_del_forma_pago_nd_compras_mob_script_case_init'] ]['form_del_forma_pago_nd_compras_mob']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['form_del_forma_pago_nd_compras_mob_script_case_init'] ]['form_del_forma_pago_nd_compras_mob']['reg_start'] = "";
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['form_del_forma_pago_nd_compras_mob_script_case_init'] ]['form_del_forma_pago_nd_compras']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['form_del_forma_pago_nd_compras_mob_script_case_init'] ]['form_del_forma_pago_nd_compras']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['form_del_forma_pago_nd_compras_mob_script_case_init'] ]['form_del_forma_pago_nd_compras']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['form_del_forma_pago_nd_compras_mob_script_case_init'] ]['form_del_forma_pago_nd_compras_mob']['total']);
          $detailAppName = 'form_del_forma_pago_nd_compras_mob';
          $detailAppObject = "form_del_forma_pago_nd_compras_mob";
          $detailAppFolder = $this->Ini->root . $this->Ini->path_link  . SC_dir_app_name($detailAppName);
          if (!@is_dir($detailAppFolder)) {
              $detailAppName = substr($detailAppName, 0, -4);
              $detailAppObject = substr($detailAppObject, 0, -4);
          ...
          require_once($detailAppFolder . "/index.php");
          require_once($detailAppFolder . "/{$detailAppName}_apl.php");
          $this->form_del_forma_pago_nd_compras_mob = new $detailAppObject;
      }
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_del_nota_debito_compras_mob']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_del_nota_debito_compras_mob']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_select'];
     }
   }
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['Gera_log_access'] = false;
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_select']['tipo_doc_sustento']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tipo_doc_sustento = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_select']['tipo_doc_sustento'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_select']['serie_sustento']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->serie_sustento = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_select']['serie_sustento'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_select']['secuencial_sustento']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->secuencial_sustento = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_select']['secuencial_sustento'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_select']['fecha_sustento']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fecha_sustento = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_select']['fecha_sustento'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_select']['fac_ruc_cliente']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fac_ruc_cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_select']['fac_ruc_cliente'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_select']['fac_nombre_cliente']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fac_nombre_cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_select']['fac_nombre_cliente'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_select']['fac_direccion_cliente']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fac_direccion_cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_select']['fac_direccion_cliente'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_select']['fac_email_cliente']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fac_email_cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_select']['fac_email_cliente'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_select']['nd_subtotal']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->nd_subtotal = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_select']['nd_subtotal'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_select']['nd_subtotal_iva']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->nd_subtotal_iva = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_select']['nd_subtotal_iva'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_select']['nd_subtotal_cero']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->nd_subtotal_cero = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_select']['nd_subtotal_cero'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_select']['nd_subtotal_no_objeto']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->nd_subtotal_no_objeto = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_select']['nd_subtotal_no_objeto'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_select']['nd_subtotal_excento']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->nd_subtotal_excento = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_select']['nd_subtotal_excento'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_select']['nd_valor_ice']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->nd_valor_ice = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_select']['nd_valor_ice'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_select']['nd_valor_iva']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->nd_valor_iva = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_select']['nd_valor_iva'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_select']['nd_total']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->nd_total = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_select']['nd_total'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['recarga'] = $this->nmgp_opcao;
      }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_del_nota_debito_compras_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_del_nota_debito_compras_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_del_nota_debito_compras_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="form_del_nota_debito_compras_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_del_nota_debito_compras_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sis_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'form_del_nota_debito_compras_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sis_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_del_nota_debito_compras_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_del_nota_debito_compras_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_del_nota_debito_compras_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_del_nota_debito_compras_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_del_nota_debito_compras_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
;
    ...
    function ValidateField_nd_proveedor(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->nd_proveedor, 9, 0, -0, 999999999, "N") == false)  
              { 
                  $hasError = true;
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['nd_numero']['keyVal'] = form_del_nota_debito_compras_mob_pack_protect_string($this->nmgp_dados_form['nd_numero']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['form_del_detalle_nota_debito_compras_mob_script_case_init'] ]['form_del_detalle_nota_debito_compras_mob']['foreign_key']['dnd_nota_debito'] = $this->nmgp_dados_form['nd_numero'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['form_del_detalle_nota_debito_compras_mob_script_case_init'] ]['form_del_detalle_nota_debito_compras_mob']['where_filter'] = "dnd_nota_debito = " . $this->nmgp_dados_form['nd_numero'] . "";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['form_del_detalle_nota_debito_compras_mob_script_case_init'] ]['form_del_detalle_nota_debito_compras_mob']['where_detal']  = "dnd_nota_debito = " . $this->nmgp_dados_form['nd_numero'] . "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['form_del_detalle_nota_debito_compras_mob_script_case_init'] ]['form_del_detalle_nota_debito_compras_mob']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['form_del_detalle_nota_debito_compras_mob_script_case_init'] ]['form_del_detalle_nota_debito_compras_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['form_del_detalle_nota_debito_compras_mob_script_case_init'] ]['form_del_detalle_nota_debito_compras_mob']['total']);
              foreach ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['form_del_detalle_nota_debito_compras_mob_script_case_init'] ]['form_del_detalle_nota_debito_compras_mob'] as $i => $v)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['form_del_detalle_nota_debito_compras_mob_script_case_init'] ]['form_del_detalle_nota_debito_compras'][$i] = $v;
              }
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['form_del_detalle_nota_debito_compras_mob_script_case_init'] ]['form_del_detalle_nota_debito_compras_mob']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['form_del_detalle_nota_debito_compras_mob_script_case_init'] ]['form_del_detalle_nota_debito_compras_mob']['total']);
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['form_del_forma_pago_nd_compras_mob_script_case_init'] ]['form_del_forma_pago_nd_compras_mob']['foreign_key']['fp_nota_debito'] = $this->nmgp_dados_form['nd_numero'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['form_del_forma_pago_nd_compras_mob_script_case_init'] ]['form_del_forma_pago_nd_compras_mob']['where_filter'] = "fp_nota_debito = " . $this->nmgp_dados_form['nd_numero'] . "";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['form_del_forma_pago_nd_compras_mob_script_case_init'] ]['form_del_forma_pago_nd_compras_mob']['where_detal']  = "fp_nota_debito = " . $this->nmgp_dados_form['nd_numero'] . "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['form_del_forma_pago_nd_compras_mob_script_case_init'] ]['form_del_forma_pago_nd_compras_mob']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['form_del_forma_pago_nd_compras_mob_script_case_init'] ]['form_del_forma_pago_nd_compras_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['form_del_forma_pago_nd_compras_mob_script_case_init'] ]['form_del_forma_pago_nd_compras_mob']['total']);
              foreach ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['form_del_forma_pago_nd_compras_mob_script_case_init'] ]['form_del_forma_pago_nd_compras_mob'] as $i => $v)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['form_del_forma_pago_nd_compras_mob_script_case_init'] ]['form_del_forma_pago_nd_compras'][$i] = $v;
              }
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['form_del_forma_pago_nd_compras_mob_script_case_init'] ]['form_del_forma_pago_nd_compras_mob']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['form_del_forma_pago_nd_compras_mob_script_case_init'] ]['form_del_forma_pago_nd_compras_mob']['total']);
              }
          }
   ...
   function ajax_return_values_nd_numero($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['Field_no_validate'] = array();
      if (!$this->NM_ajax_flag || !isset($this->nmgp_refresh_fields)) {
      $_SESSION['scriptcase']['form_del_nota_debito_compras_mob']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['form_del_nota_debito_compras_mob']['contr_erro'] = 'off'; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['total']);
              }
              ...
              $this->NM_gera_log_new();
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          if ($bDelecaoOk)
          {
              ...
              $this->form_del_detalle_nota_debito_compras_mob->ini_controle();
              if ($this->form_del_detalle_nota_debito_compras_mob->temRegistros($sDetailWhere))
              {
                  $bDelecaoOk = false;
          ...
          if ($bDelecaoOk)
          {
              ...
              $this->form_del_forma_pago_nd_compras_mob->ini_controle();
              if ($this->form_del_forma_pago_nd_compras_mob->temRegistros($sDetailWhere))
              {
                  $bDelecaoOk = false;
                  $sMsgErro   = $this->Ini->Nm_lang['lang_errm_fkvi'];
              }
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['reg_start'] = 0; 
              }
...
if (!isset($this->sc_temp_var_procesar)) {$this->sc_temp_var_procesar = (isset($_SESSION['var_procesar'])) ? $_SESSION['var_procesar'] : "";}
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_del_nota_debito_compras_mob';
	...
	if (isset($this->Campos_Mens_erro) && !empty($this->Campos_Mens_erro))
{
 ...
 if (isset($this->sc_temp_var_mensaje)) { $_SESSION['var_mensaje'] = $this->sc_temp_var_mensaje;}
    if ($this->NM_ajax_flag)
    {
        $this->NM_ajax_info['redirExit']['action'] = "form_del_nota_debito_compras_mob_fim.php?script_case_init=" . $this->form_encode_input($this->Ini->sc_page);
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['sc_outra_jan'])
        {
            $_SESSION['scriptcase']['sc_outra_jan'] = "form_del_nota_debito_compras_mob";
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['sc_outra_jan'] = false;
        }
        $_SESSION['scriptcase']['form_del_nota_debito_compras_mob']['contr_erro'] = 'off';
        form_del_nota_debito_compras_mob_pack_ajax_response();
        exit;
...
<table align="center"><tr><td>
  <form name="Fexit" method=post
        action="form_del_nota_debito_compras_mob_fim.php"
        target="_self">
    <input type=hidden name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page) ?>">
...
$_SESSION['scriptcase']['form_del_nota_debito_compras_mob']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['parms'] = "nd_numero?#?$this->nd_numero?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (!empty($sc_where))
              {
                  if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['reg_start']) ;  
              } 
          } 
          ...
          { 
              ...
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['where_filter']))
              {
                  ...
                  $this->NM_ajax_info['buttonDisplay']['Anular'] = $this->nmgp_botoes['Anular'] = "off";
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['reg_start'] < $qt_geral_reg_form_del_nota_debito_compras_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['opcao']   = '';
          }
      } 
...
//-- 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_detalle_nota_debito_compras_mob']['embutida_parms'] = "var_nota_debito*scin" . $this->nmgp_dados_form['nd_numero'] . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_forma_pago_nd_compras_mob']['embutida_parms'] = "var_factura*scin" . $this->nmgp_dados_form['nd_numero'] . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
  }
// 
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dados_select'];
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_del_nota_debito_compras_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['csrf_token'];
    }
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['where_filter_form'] . " and ((nd_numero=" . $_SESSION['var_id_nota_debito'] . ")) and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_del_nota_debito_compras_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['total'] = $qt_geral_reg_form_del_nota_debito_compras_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_del_nota_debito_compras_mob_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_del_nota_debito_compras_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_del_nota_debito_compras_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
<?php
  exit;
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_nota_debito_compras_mob']['ordem_ord'] == " desc") {
