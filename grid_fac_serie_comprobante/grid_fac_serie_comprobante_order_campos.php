...
<?php
   ...
   $Ord_Cmp = new grid_fac_serie_comprobante_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_fac_serie_comprobante_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_fac_serie_comprobante']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_fac_serie_comprobante']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['sc_oficina'] = "sc_oficina";
   $tab_labels["sc_oficina"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_serie_comprobante']['labels']["sc_oficina"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_serie_comprobante']['labels']["sc_oficina"] : "" . $this->Nm_lang['lang_oficina'] . "";
   $tab_ger_campos['sc_tipo'] = "on";
   $tab_def_campos['sc_tipo'] = "sc_tipo";
   $tab_labels["sc_tipo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_serie_comprobante']['labels']["sc_tipo"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_serie_comprobante']['labels']["sc_tipo"] : "" . $this->Nm_lang['lang_tipo_comprobante'] . "";
   $tab_ger_campos['sc_serie'] = "on";
   $tab_def_campos['sc_serie'] = "sc_serie";
   $tab_labels["sc_serie"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_serie_comprobante']['labels']["sc_serie"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_serie_comprobante']['labels']["sc_serie"] : "" . $this->Nm_lang['lang_serie_sri'] . "";
   $tab_ger_campos['sc_inicio'] = "on";
   $tab_def_campos['sc_inicio'] = "sc_inicio";
   $tab_labels["sc_inicio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_serie_comprobante']['labels']["sc_inicio"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_serie_comprobante']['labels']["sc_inicio"] : "" . $this->Nm_lang['lang_inicio'] . "";
   $tab_ger_campos['sc_fin'] = "on";
   $tab_def_campos['sc_fin'] = "sc_fin";
   $tab_labels["sc_fin"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_serie_comprobante']['labels']["sc_fin"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_serie_comprobante']['labels']["sc_fin"] : "" . $this->Nm_lang['lang_fin'] . "";
   $tab_ger_campos['sc_secuencial'] = "on";
   $tab_def_campos['sc_secuencial'] = "sc_secuencial";
   $tab_labels["sc_secuencial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_serie_comprobante']['labels']["sc_secuencial"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_serie_comprobante']['labels']["sc_secuencial"] : "" . $this->Nm_lang['lang_secuencial'] . "";
   $tab_ger_campos['sc_estado'] = "on";
   $tab_def_campos['sc_estado'] = "sc_estado";
   $tab_labels["sc_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_serie_comprobante']['labels']["sc_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_serie_comprobante']['labels']["sc_estado"] : "" . $this->Nm_lang['lang_estado'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_serie_comprobante']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_fac_serie_comprobante']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_fac_serie_comprobante']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_fac_serie_comprobante']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_fac_serie_comprobante']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_fac_serie_comprobante']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_fac_serie_comprobante']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_fac_serie_comprobante']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_serie_comprobante']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_fac_serie_comprobante']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_fac_serie_comprobante']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_fac_serie_comprobante']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_fac_serie_comprobante_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_fac_serie_comprobante']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_fac_serie_comprobante']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_serie_comprobante']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_fac_serie_comprobante']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_fac_serie_comprobante']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
