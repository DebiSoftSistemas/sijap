<?php
@session_start() ;
$_SESSION['scriptcase']['grid_fac_serie_comprobante']['sc_process_barr'] = true;
require_once('../grid_fac_serie_comprobante/index.php');
unset($_SESSION['scriptcase']['grid_fac_serie_comprobante']['sc_process_barr']);
$ExportCtrl = new grid_fac_serie_comprobante_export_control;
$ExportCtrl->Export_barr();

class grid_fac_serie_comprobante_export_control
{
