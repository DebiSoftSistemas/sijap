...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_resumen_retenciones_ventas"]))
   {
      unset($_SESSION['session_sec_aplicacao']["debi_doc_electronicos_____grid_resumen_retenciones_ventas"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_resumen_retenciones_ventas']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_resumen_retenciones_ventas']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_resumen_retenciones_ventas']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_resumen_retenciones_ventas']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_resumen_retenciones_ventas']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_resumen_retenciones_ventas</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_resumen_retenciones_ventas']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_resumen_retenciones_ventas']['embutida_filho'] as $ind => $sc_init)
          {
