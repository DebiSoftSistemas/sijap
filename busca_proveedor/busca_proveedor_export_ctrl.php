<?php
@session_start() ;
$_SESSION['scriptcase']['busca_proveedor']['sc_process_barr'] = true;
require_once('../busca_proveedor/index.php');
unset($_SESSION['scriptcase']['busca_proveedor']['sc_process_barr']);
$ExportCtrl = new busca_proveedor_export_control;
$ExportCtrl->Export_barr();

class busca_proveedor_export_control
{
