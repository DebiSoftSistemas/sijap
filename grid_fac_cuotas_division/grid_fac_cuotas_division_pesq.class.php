...
class grid_fac_cuotas_division_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_fac_cuotas_division_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_fac_cuotas_division_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_fac_cuotas_division_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_cd_id')
      {
          $cd_id = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_cd_id($cd_id);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_cd_producto')
      {
          $cd_producto = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_cd_producto($cd_producto);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   {
      $cd_id = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $cd_id);
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$campo_join]);
              return;
          }
         $nm_ini_lower = "";
         $nm_fim_lower = "";
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         $nome_sum = "fac_cuotas_division.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> fac_cuotas_division</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_fac_cuotas_division/grid_fac_cuotas_division_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_fac_cuotas_division_ajax_search.js"></script>
 <script type="text/javascript" src="grid_fac_cuotas_division_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_fac_cuotas_division_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_fac_cuotas_division']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_fac_cuotas_division']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_cd_id_cond#NMF#' + search_get_sel_txt('SC_cd_id_cond') + '@NMF@';
  str_out += 'SC_cd_id#NMF#' + search_get_text('SC_cd_id') + '@NMF@';
  str_out += 'id_ac_cd_id#NMF#' + search_get_title('select2-id_ac_cd_id-container') + '@NMF@';
  str_out += 'SC_cd_operacion_cond#NMF#' + search_get_sel_txt('SC_cd_operacion_cond') + '@NMF@';
  str_out += 'SC_cd_operacion#NMF#' + search_get_text('SC_cd_operacion') + '@NMF@';
  str_out += 'SC_cd_producto_cond#NMF#' + search_get_sel_txt('SC_cd_producto_cond') + '@NMF@';
  str_out += 'SC_cd_producto#NMF#' + search_get_text('SC_cd_producto') + '@NMF@';
  str_out += 'id_ac_cd_producto#NMF#' + search_get_title('select2-id_ac_cd_producto-container') + '@NMF@';
  str_out += 'SC_cd_cuota_cond#NMF#' + search_get_sel_txt('SC_cd_cuota_cond') + '@NMF@';
  str_out += 'SC_cd_cuota#NMF#' + search_get_text('SC_cd_cuota') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-cd_producto").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_cd_producto",
      max_itens: "10",
   ...
   $("#SC_cd_producto").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-cd_id").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_cd_id",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $cd_id_cond, $cd_id, $cd_id_autocomp,
             $cd_operacion_cond, $cd_operacion,
             $cd_producto_cond, $cd_producto, $cd_producto_autocomp,
             $cd_cuota_cond, $cd_cuota,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $cd_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['campos_busca']['cd_id']; 
          $cd_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['campos_busca']['cd_id_cond']; 
          $cd_operacion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['campos_busca']['cd_operacion']; 
          $cd_operacion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['campos_busca']['cd_operacion_cond']; 
          $cd_producto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['campos_busca']['cd_producto']; 
          $cd_producto_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['campos_busca']['cd_producto_cond']; 
          $cd_cuota = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['campos_busca']['cd_cuota']; 
          $cd_cuota_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['campos_busca']['cd_cuota_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['campos_busca']['NM_operador']; 
          if (strtoupper($cd_operacion_cond) != "II" && strtoupper($cd_operacion_cond) != "QP" && strtoupper($cd_operacion_cond) != "NP" && strtoupper($cd_operacion_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($cd_operacion, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($cd_cuota_cond) != "II" && strtoupper($cd_cuota_cond) != "QP" && strtoupper($cd_cuota_cond) != "NP" && strtoupper($cd_cuota_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($cd_cuota, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($cd_id_cond) || empty($cd_id_cond))
      {
         $cd_id_cond = "qp";
      }
      if (!isset($cd_operacion_cond) || empty($cd_operacion_cond))
      {
         $cd_operacion_cond = "gt";
      }
      if (!isset($cd_producto_cond) || empty($cd_producto_cond))
      {
         $cd_producto_cond = "qp";
      }
      if (!isset($cd_cuota_cond) || empty($cd_cuota_cond))
      {
         $cd_cuota_cond = "gt";
      }
      ...
      $str_hide_cd_id = (in_array($cd_id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_cd_operacion = (in_array($cd_operacion_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_cd_producto = (in_array($cd_producto_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_cd_cuota = (in_array($cd_cuota_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($cd_id) || $cd_id == "")
      {
          $cd_id = "";
      }
      if (isset($cd_id) && !empty($cd_id))
      {
      ...
      if (!isset($cd_operacion) || $cd_operacion == "")
      {
          $cd_operacion = "";
      }
      if (isset($cd_operacion) && !empty($cd_operacion))
      {
      ...
      if (!isset($cd_producto) || $cd_producto == "")
      {
          $cd_producto = "";
      }
      if (isset($cd_producto) && !empty($cd_producto))
      {
      ...
      if (!isset($cd_cuota) || $cd_cuota == "")
      {
          $cd_cuota = "";
      }
      if (isset($cd_cuota) && !empty($cd_cuota))
      {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_cd_id_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['cd_id'])) ? $this->New_label['cd_id'] : "" . $this->Ini->Nm_lang['lang_id'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_cd_id_cond" name="cd_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_cd_id'), this, 'cd_id')">
       <OPTION value="qp" <?php if ("qp" == $cd_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $cd_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $cd_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cd_id" <?php echo $str_hide_cd_id?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['cd_id'])) ? $this->New_label['cd_id'] : "" . $this->Ini->Nm_lang['lang_id'] . "";
 $nmgp_tab_label .= "cd_id?#?" . $SC_Label . "?@?";
...
<?php
   ...
   { 
      ...
      {
            nmgp_Form_Num_Val($cd_id, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $cd_id;
      }
?>
<INPUT  type="text" id="SC_cd_id" name="cd_id" value="<?php echo NM_encode_input($cd_id) ?>" size=4 alt="{datatype: 'integer', maxLength: 4, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-cd_id" id="id_ac_cd_id" name="cd_id_autocomp"><?php if ('' !=  $cd_id) { ?><option value="<?php echo $cd_id ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_cd_operacion_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['cd_operacion'])) ? $this->New_label['cd_operacion'] : "" . $this->Ini->Nm_lang['lang_operacion'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_cd_operacion_cond" name="cd_operacion_cond" onChange="nm_campos_between(document.getElementById('id_vis_cd_operacion'), this, 'cd_operacion')">
       <OPTION value="gt" <?php if ("gt" == $cd_operacion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $cd_operacion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $cd_operacion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cd_operacion" <?php echo $str_hide_cd_operacion?> valign="top">
 ...
 $nmgp_tab_label .= "cd_operacion?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_cd_operacion" name="cd_operacion" value="<?php echo NM_encode_input($cd_operacion) ?>" size=4 alt="{datatype: 'integer', maxLength: 4, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_cd_producto_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['cd_producto'])) ? $this->New_label['cd_producto'] : "" . $this->Ini->Nm_lang['lang_producto'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_cd_producto_cond" name="cd_producto_cond" onChange="nm_campos_between(document.getElementById('id_vis_cd_producto'), this, 'cd_producto')">
       <OPTION value="qp" <?php if ("qp" == $cd_producto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $cd_producto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $cd_producto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $cd_producto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cd_producto" <?php echo $str_hide_cd_producto?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['cd_producto'])) ? $this->New_label['cd_producto'] : "" . $this->Ini->Nm_lang['lang_producto'] . "";
 $nmgp_tab_label .= "cd_producto?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $cd_producto;
      }
?>
<INPUT  type="text" id="SC_cd_producto" name="cd_producto" value="<?php echo NM_encode_input($cd_producto) ?>"  size=26 alt="{datatype: 'text', maxLength: 26, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-cd_producto" id="id_ac_cd_producto" name="cd_producto_autocomp"><?php if ('' !=  $cd_producto) { ?><option value="<?php echo $cd_producto ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_cd_cuota_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['cd_cuota'])) ? $this->New_label['cd_cuota'] : "" . $this->Ini->Nm_lang['lang_cuota_nro'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_cd_cuota_cond" name="cd_cuota_cond" onChange="nm_campos_between(document.getElementById('id_vis_cd_cuota'), this, 'cd_cuota')">
       <OPTION value="gt" <?php if ("gt" == $cd_cuota_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $cd_cuota_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $cd_cuota_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cd_cuota" <?php echo $str_hide_cd_cuota?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['cd_cuota'])) ? $this->New_label['cd_cuota'] : "" . $this->Ini->Nm_lang['lang_cuota_nro'] . "";
 $nmgp_tab_label .= "cd_cuota?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_cd_cuota" name="cd_cuota" value="<?php echo NM_encode_input($cd_cuota) ?>" size=4 alt="{datatype: 'integer', maxLength: 4, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_fac_cuotas_division_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_fac_cuotas_division']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_fac_cuotas_division']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.cd_id_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_cd_id'), document.F1.cd_id_cond, 'cd_id');
   document.F1.cd_id.value = "";
   document.F1.cd_id_autocomp.value = "";
   $('#select2-id_ac_cd_id-container').html('<?php echo $this->Val_init_cd_id['desc'] ?>');;
   document.F1.cd_operacion_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_cd_operacion'), document.F1.cd_operacion_cond, 'cd_operacion');
   document.F1.cd_operacion.value = "";
   document.F1.cd_producto_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_cd_producto'), document.F1.cd_producto_cond, 'cd_producto');
   document.F1.cd_producto.value = "";
   document.F1.cd_producto_autocomp.value = "";
   $('#select2-id_ac_cd_producto-container').html('<?php echo $this->Val_init_cd_producto['desc'] ?>');;
   document.F1.cd_cuota_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_cd_cuota'), document.F1.cd_cuota_cond, 'cd_cuota');
   document.F1.cd_cuota.value = "";
   Sc_carga_select2('all');
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_fac_cuotas_division/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_cd_id_cond'] = 'cond';
      $tp_fields['SC_cd_id'] = 'text_aut';
      $tp_fields['id_ac_cd_id'] = 'select2_aut';
      $tp_fields['SC_cd_operacion_cond'] = 'cond';
      $tp_fields['SC_cd_operacion'] = 'text';
      $tp_fields['SC_cd_producto_cond'] = 'cond';
      $tp_fields['SC_cd_producto'] = 'text_aut';
      $tp_fields['id_ac_cd_producto'] = 'select2_aut';
      $tp_fields['SC_cd_cuota_cond'] = 'cond';
      $tp_fields['SC_cd_cuota'] = 'text';
   ...
   {
      global $cd_id_cond, $cd_id, $cd_id_autocomp,
             $cd_operacion_cond, $cd_operacion,
             $cd_producto_cond, $cd_producto, $cd_producto_autocomp,
             $cd_cuota_cond, $cd_cuota, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($cd_id_autocomp) && empty($cd_id))
      {
          $cd_id = $cd_id_autocomp;
      }
      if (!empty($cd_producto_autocomp) && empty($cd_producto))
      {
          $cd_producto = $cd_producto_autocomp;
      }
      $cd_id_cond_salva = $cd_id_cond; 
      if (!isset($cd_id_input_2) || $cd_id_input_2 == "")
      {
          $cd_id_input_2 = $cd_id;
      }
      $cd_operacion_cond_salva = $cd_operacion_cond; 
      if (!isset($cd_operacion_input_2) || $cd_operacion_input_2 == "")
      {
          $cd_operacion_input_2 = $cd_operacion;
      }
      $cd_producto_cond_salva = $cd_producto_cond; 
      if (!isset($cd_producto_input_2) || $cd_producto_input_2 == "")
      {
          $cd_producto_input_2 = $cd_producto;
      }
      $cd_cuota_cond_salva = $cd_cuota_cond; 
      if (!isset($cd_cuota_input_2) || $cd_cuota_input_2 == "")
      {
          $cd_cuota_input_2 = $cd_cuota;
      }
      if ($cd_id_cond != "in")
      {
          nm_limpa_numero($cd_id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($cd_operacion_cond != "in")
      {
          nm_limpa_numero($cd_operacion, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($cd_cuota_cond != "in")
      {
          nm_limpa_numero($cd_cuota, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['campos_busca']['cd_id'] = $cd_id; 
      if (is_array($cd_id) && !empty($cd_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['Grid_search'][$I_Grid]['val'][0] = $cd_id;
      }
      elseif ($cd_id_cond_salva == "nu" || $cd_id_cond_salva == "nn" || $cd_id_cond_salva == "ep" || $cd_id_cond_salva == "ne" || !empty($cd_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['Grid_search'][$I_Grid]['val'][0][0] = $cd_id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['campos_busca']['cd_id_cond'] = $cd_id_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['Grid_search'][$I_Grid]['cmp'] = "cd_id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['Grid_search'][$I_Grid]['opc'] = $cd_id_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq']['cd_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['campos_busca']['cd_operacion'] = $cd_operacion; 
      if (is_array($cd_operacion) && !empty($cd_operacion))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['Grid_search'][$I_Grid]['val'][0] = $cd_operacion;
      }
      elseif ($cd_operacion_cond_salva == "nu" || $cd_operacion_cond_salva == "nn" || $cd_operacion_cond_salva == "ep" || $cd_operacion_cond_salva == "ne" || !empty($cd_operacion))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['Grid_search'][$I_Grid]['val'][0][0] = $cd_operacion;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['campos_busca']['cd_operacion_cond'] = $cd_operacion_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['Grid_search'][$I_Grid]['cmp'] = "cd_operacion"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['Grid_search'][$I_Grid]['opc'] = $cd_operacion_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq']['cd_operacion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['campos_busca']['cd_producto'] = $cd_producto; 
      if (is_array($cd_producto) && !empty($cd_producto))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['Grid_search'][$I_Grid]['val'][0] = $cd_producto;
      }
      elseif ($cd_producto_cond_salva == "nu" || $cd_producto_cond_salva == "nn" || $cd_producto_cond_salva == "ep" || $cd_producto_cond_salva == "ne" || !empty($cd_producto))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['Grid_search'][$I_Grid]['val'][0][0] = $cd_producto;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['campos_busca']['cd_producto_cond'] = $cd_producto_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['Grid_search'][$I_Grid]['cmp'] = "cd_producto"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['Grid_search'][$I_Grid]['opc'] = $cd_producto_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq']['cd_producto'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['campos_busca']['cd_cuota'] = $cd_cuota; 
      if (is_array($cd_cuota) && !empty($cd_cuota))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['Grid_search'][$I_Grid]['val'][0] = $cd_cuota;
      }
      elseif ($cd_cuota_cond_salva == "nu" || $cd_cuota_cond_salva == "nn" || $cd_cuota_cond_salva == "ep" || $cd_cuota_cond_salva == "ne" || !empty($cd_cuota))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['Grid_search'][$I_Grid]['val'][0][0] = $cd_cuota;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['campos_busca']['cd_cuota_cond'] = $cd_cuota_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['Grid_search'][$I_Grid]['cmp'] = "cd_cuota"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['Grid_search'][$I_Grid]['opc'] = $cd_cuota_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['grid_pesq']['cd_cuota'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['campos_busca'] = $Temp_Busca;
      }
      if ($cd_id_cond != "in" && $cd_id_cond != "bw" && !empty($cd_id) && !is_numeric($cd_id))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : " . $this->Ini->Nm_lang['lang_id'] . "";
      }
      if ($cd_id_cond == "bw" && ((!empty($cd_id) && !is_numeric($cd_id)) || (!empty($cd_id_input_2) && !is_numeric($cd_id_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : " . $this->Ini->Nm_lang['lang_id'] . "";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      $this->cmp_formatado['cd_operacion'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($cd_producto != '') {
      $cd_producto_look = (is_string($cd_producto) ? substr($this->Db->qstr($cd_producto), 1, -1) : $cd_producto); 
      $nmgp_def_dados = array(); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['cd_producto'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['cd_producto'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['cd_producto'] = $cd_producto;
      }
      $Conteudo = $cd_cuota;
      if (strtoupper($cd_cuota_cond) != "II" && strtoupper($cd_cuota_cond) != "QP" && strtoupper($cd_cuota_cond) != "NP" && strtoupper($cd_cuota_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['cd_cuota'] = $Conteudo;

      //----- $cd_id
      $this->Date_part = false;
      if (isset($cd_id) || $cd_id_cond == "nu" || $cd_id_cond == "nn" || $cd_id_cond == "ep" || $cd_id_cond == "ne")
      {
         $this->monta_condicao("cd_id", $cd_id_cond, $cd_id, "", "cd_id", "INT4", false);
      }

      //----- $cd_operacion
      $this->Date_part = false;
      if (isset($cd_operacion) || $cd_operacion_cond == "nu" || $cd_operacion_cond == "nn" || $cd_operacion_cond == "ep" || $cd_operacion_cond == "ne")
      {
         $this->monta_condicao("cd_operacion", $cd_operacion_cond, $cd_operacion, "", "cd_operacion", "INT4", false);
      }

      //----- $cd_producto
      $this->Date_part = false;
      if (isset($cd_producto) || $cd_producto_cond == "nu" || $cd_producto_cond == "nn" || $cd_producto_cond == "ep" || $cd_producto_cond == "ne")
      {
         $this->monta_condicao("cd_producto", $cd_producto_cond, $cd_producto, "", "cd_producto", "VARCHAR", false);
      }

      //----- $cd_cuota
      $this->Date_part = false;
      if (isset($cd_cuota) || $cd_cuota_cond == "nu" || $cd_cuota_cond == "nn" || $cd_cuota_cond == "ep" || $cd_cuota_cond == "ne")
      {
         $this->monta_condicao("cd_cuota", $cd_cuota_cond, $cd_cuota, "", "cd_cuota", "INT4", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
    $this->Sel_case_sensitive($this->comando);
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_cuotas_division']['cond_pesq'] .= $this->NM_operador;
