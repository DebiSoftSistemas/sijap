...
<?php
   ...
   $Ord_Cmp = new grid_fac_cuotas_division_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_fac_cuotas_division_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_division']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_division']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['cd_cuota'] = "cd_cuota";
   $tab_labels["cd_cuota"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_division']['labels']["cd_cuota"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_division']['labels']["cd_cuota"] : "" . $this->Nm_lang['lang_cuota_nro'] . "";
   $tab_ger_campos['cd_fecha'] = "on";
   $tab_def_campos['cd_fecha'] = "cd_fecha";
   $tab_labels["cd_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_division']['labels']["cd_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_division']['labels']["cd_fecha"] : "" . $this->Nm_lang['lang_fecha'] . "";
   $tab_ger_campos['cd_producto'] = "on";
   $tab_def_campos['cd_producto'] = "cd_producto";
   $tab_labels["cd_producto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_division']['labels']["cd_producto"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_division']['labels']["cd_producto"] : "" . $this->Nm_lang['lang_producto'] . "";
   $tab_ger_campos['cd_capital'] = "on";
   $tab_def_campos['cd_capital'] = "cd_capital";
   $tab_labels["cd_capital"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_division']['labels']["cd_capital"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_division']['labels']["cd_capital"] : "" . $this->Nm_lang['lang_valor'] . "";
   $tab_ger_campos['cd_valor_iva'] = "on";
   $tab_def_campos['cd_valor_iva'] = "cd_valor_iva";
   $tab_labels["cd_valor_iva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_division']['labels']["cd_valor_iva"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_division']['labels']["cd_valor_iva"] : "" . $this->Nm_lang['lang_iva'] . "";
   $tab_ger_campos['cd_total'] = "on";
   $tab_def_campos['cd_total'] = "cd_total";
   $tab_labels["cd_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_division']['labels']["cd_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_division']['labels']["cd_total"] : "" . $this->Nm_lang['lang_total'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_division']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_division']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_division']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_division']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_division']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_division']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_division']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_division']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_division']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_division']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_division']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_division']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_fac_cuotas_division_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_division']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_division']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_division']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_division']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_fac_cuotas_division']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
