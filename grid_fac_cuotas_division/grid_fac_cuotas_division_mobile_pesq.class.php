...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "cd_fecha";$Nm_numeric[] = "cd_id";$Nm_numeric[] = "cd_operacion";$Nm_numeric[] = "cd_cuota";$Nm_numeric[] = "cd_capital";$Nm_numeric[] = "cd_solicitud";$Nm_numeric[] = "cd_porcentaje_iva";$Nm_numeric[] = "cd_valor_iva";$Nm_numeric[] = "cd_total";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_cd_id_cond" name="cd_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_cd_id'), this, 'cd_id')">
      ...
      <br><span id="id_hide_cd_id"  <?php echo $str_hide_cd_id?>><?php
      if ($cd_id != "")
      {
      $cd_id_look = (is_string($cd_id) ? substr($this->Db->qstr($cd_id), 1, -1) : $cd_id); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_cd_operacion_cond" name="cd_operacion_cond" onChange="nm_campos_between(document.getElementById('id_vis_cd_operacion'), this, 'cd_operacion')">
      ...
      <br><span id="id_hide_cd_operacion"  <?php echo $str_hide_cd_operacion?>><INPUT  type="text" id="SC_cd_operacion" name="cd_operacion" value="<?php echo NM_encode_input($cd_operacion) ?>" size=4 alt="{datatype: 'integer', maxLength: 4, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_cd_producto_cond" name="cd_producto_cond" onChange="nm_campos_between(document.getElementById('id_vis_cd_producto'), this, 'cd_producto')">
      ...
      <br><span id="id_hide_cd_producto"  <?php echo $str_hide_cd_producto?>><?php
      if ($cd_producto != "")
      {
      $cd_producto_look = (is_string($cd_producto) ? substr($this->Db->qstr($cd_producto), 1, -1) : $cd_producto); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_cd_cuota_cond" name="cd_cuota_cond" onChange="nm_campos_between(document.getElementById('id_vis_cd_cuota'), this, 'cd_cuota')">
      ...
      <br><span id="id_hide_cd_cuota"  <?php echo $str_hide_cd_cuota?>><INPUT  type="text" id="SC_cd_cuota" name="cd_cuota" value="<?php echo NM_encode_input($cd_cuota) ?>" size=4 alt="{datatype: 'integer', maxLength: 4, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
