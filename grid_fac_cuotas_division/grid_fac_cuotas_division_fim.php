...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_fac_cuotas_division"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_fac_cuotas_division"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_fac_cuotas_division']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_fac_cuotas_division']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_fac_cuotas_division']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_fac_cuotas_division']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_fac_cuotas_division']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_fac_cuotas_division</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_fac_cuotas_division']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_fac_cuotas_division']['embutida_filho'] as $ind => $sc_init)
          {
