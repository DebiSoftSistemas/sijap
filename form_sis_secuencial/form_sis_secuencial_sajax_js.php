  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_secuencial" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sis_secuencial_form();
	}
...
?>
  ...
  // ---------- Validate sec_id_
  function do_ajax_form_sis_secuencial_validate_sec_id_(iNumLinha)
  {
    var nomeCampo_sec_id_ = "sec_id_" + iNumLinha;
    var var_sec_id_ = scAjaxGetFieldText(nomeCampo_sec_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_secuencial_validate_sec_id_(var_sec_id_, iNumLinha, var_script_case_init, do_ajax_form_sis_secuencial_validate_sec_id__cb);
  } // do_ajax_form_sis_secuencial_validate_sec_id_

  function do_ajax_form_sis_secuencial_validate_sec_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_secuencial_validate_sec_id__cb

  // ---------- Validate sec_descripcion_
  function do_ajax_form_sis_secuencial_validate_sec_descripcion_(iNumLinha)
  {
    var nomeCampo_sec_descripcion_ = "sec_descripcion_" + iNumLinha;
    var var_sec_descripcion_ = scAjaxGetFieldText(nomeCampo_sec_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_secuencial_validate_sec_descripcion_(var_sec_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_sis_secuencial_validate_sec_descripcion__cb);
  } // do_ajax_form_sis_secuencial_validate_sec_descripcion_

  function do_ajax_form_sis_secuencial_validate_sec_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "sec_descripcion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "sec_descripcion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "sec_descripcion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "sec_descripcion_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_secuencial_validate_sec_descripcion__cb

  // ---------- Validate sec_valor_
  function do_ajax_form_sis_secuencial_validate_sec_valor_(iNumLinha)
  {
    var nomeCampo_sec_valor_ = "sec_valor_" + iNumLinha;
    var var_sec_valor_ = scAjaxGetFieldText(nomeCampo_sec_valor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_secuencial_validate_sec_valor_(var_sec_valor_, iNumLinha, var_script_case_init, do_ajax_form_sis_secuencial_validate_sec_valor__cb);
  } // do_ajax_form_sis_secuencial_validate_sec_valor_

  function do_ajax_form_sis_secuencial_validate_sec_valor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_secuencial_validate_sec_valor__cb

  // ---------- Validate sec_incremento_
  function do_ajax_form_sis_secuencial_validate_sec_incremento_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_secuencial_validate_sec_incremento_(var_sec_incremento_, iNumLinha, var_script_case_init, do_ajax_form_sis_secuencial_validate_sec_incremento__cb);
  } // do_ajax_form_sis_secuencial_validate_sec_incremento_

  function do_ajax_form_sis_secuencial_validate_sec_incremento__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_secuencial_validate_sec_incremento__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_sis_secuencial_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_sis_secuencial_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sis_secuencial_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_sis_secuencial_add_new_line_cb);
  } // do_ajax_form_sis_secuencial_add_new_line

  function do_ajax_form_sis_secuencial_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_sis_secuencial_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_sis_secuencial_backup_line(iNumLinha)
  {
    var var_sec_id_ = scAjaxGetFieldText("sec_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_secuencial_backup_line(var_sec_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_sis_secuencial_backup_line_cb);
  } // do_ajax_form_sis_secuencial_backup_line

  function do_ajax_form_sis_secuencial_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_sis_secuencial_backup_line_cb

  function do_ajax_form_sis_secuencial_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_sis_secuencial_cancel_insert

  function do_ajax_form_sis_secuencial_cancel_update(iSeqVert)
  {
    do_ajax_form_sis_secuencial_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_sis_secuencial_cancel_update

  function do_ajax_form_sis_secuencial_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_sis_secuencial_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_sis_secuencial_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_sis_secuencial_table_refresh(var_sec_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_secuencial_table_refresh_cb);
  } //  do_ajax_form_sis_secuencial_table_refresh

  function do_ajax_form_sis_secuencial_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_sis_secuencial_table_refresh_cb_after_alert);
  } // do_ajax_form_sis_secuencial_table_refresh_cb
  function do_ajax_form_sis_secuencial_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_sis_secuencial_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_sis_secuencial_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_sis_secuencial_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_sec_id_ = scAjaxGetFieldText("sec_id_" + iNumLinha);
    var var_sec_descripcion_ = scAjaxGetFieldText("sec_descripcion_" + iNumLinha);
...
?>
    x_ajax_form_sis_secuencial_submit_form(var_sec_id_, var_sec_descripcion_, var_sec_valor_, var_sec_incremento_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_secuencial_submit_form_cb);
  } // do_ajax_form_sis_secuencial_submit_form

  function do_ajax_form_sis_secuencial_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("sec_descripcion_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sis_secuencial_submit_form_cb_after_alert);
  } // do_ajax_form_sis_secuencial_submit_form_cb
  function do_ajax_form_sis_secuencial_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_secuencial_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sis_secuencial_navigate_form()
  {
    perform_ajax_form_sis_secuencial_navigate_form();
  }

  function perform_ajax_form_sis_secuencial_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_sis_secuencial_cancel_insert(sc_form_sis_secuencial_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("sec_descripcion_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sis_secuencial_navigate_form(var_sec_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_secuencial_navigate_form_cb);
  } // do_ajax_form_sis_secuencial_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_secuencial']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_secuencial_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_secuencial_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_secuencial_navigate_form_cb
  function do_ajax_form_sis_secuencial_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_sis_secuencial_navigate_form_cb_after_alert

    function sc_form_sis_secuencial_get_last_line_number()
    {
    ...
    } //sc_form_sis_secuencial_get_last_line_number

  function sc_hide_form_sis_secuencial_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "sec_descripcion_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["sec_descripcion_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_descripcion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["sec_descripcion_"][iNumLinha] = "sec_descripcion_" + iNumLinha;
    ...
    ajax_field_id["sec_id_" + iNumLinha] = new Array("hidden_field_label_sec_id_", "hidden_field_data_sec_id_" + iNumLinha);
    ajax_field_id["sec_descripcion_" + iNumLinha] = new Array("hidden_field_label_sec_descripcion_", "hidden_field_data_sec_descripcion_" + iNumLinha);
    ...
    ajax_error_count["sec_descripcion_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["sec_descripcion_" + iNumLinha] = "off";
...
?>
    ajax_read_only["sec_id_" + iNumLinha] = "on";
    ajax_read_only["sec_descripcion_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["sec_descripcion_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["sec_descripcion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["sec_descripcion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["sec_descripcion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["sec_descripcion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["sec_descripcion_" + iNumLinha]["onfocus"] = new Array();
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['sec_descripcion_'])) ? $this->nmgp_cmp_readonly['sec_descripcion_'] : 'off';
?>
    scAjaxFieldRead("sec_descripcion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("sec_descripcion_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["sec_id_" + iRow] || "on" == ajax_error_count["sec_descripcion_" + iRow] || "on" == ajax_error_count["sec_valor_" + iRow] || "on" == ajax_error_count["sec_incremento_" + iRow]))
    {
      ...
      $("#hidden_field_data_sec_descripcion_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["sec_id_" + iRow] && "off" == ajax_error_count["sec_descripcion_" + iRow] && "off" == ajax_error_count["sec_valor_" + iRow] && "off" == ajax_error_count["sec_incremento_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["sec_id_" + iRow] = "off";
        ajax_error_count["sec_descripcion_" + iRow] = "off";
      ...
      $("#hidden_field_data_sec_descripcion_" + iRow).removeClass("scFormErrorLine");
