...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "ret_fecha";$Nm_numeric[] = "ret_numero";$Nm_numeric[] = "ret_cliente";$Nm_numeric[] = "ret_anio_periodo_fiscal";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_ret_cliente"  <?php echo $str_hide_ret_cliente?>>
<?php
