...
class grid_fac_operaciones_bajas_cartera_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_fac_operaciones_bajas_cartera']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_fac_operaciones_bajas_cartera']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang , $fac_operaciones_bajas_cartera_obc_tipo_cartera, $fac_operaciones_bajas_cartera_obc_propietario, $jap_contrato_con_comunidad, $fac_operaciones_bajas_cartera_obc_estado;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operaciones_bajas_cartera']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operaciones_bajas_cartera']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operaciones_bajas_cartera']['where_pesq']; 
      } 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operaciones_bajas_cartera']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operaciones_bajas_cartera']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_fac_operaciones_bajas_cartera']['contr_total_geral'] = "OK";
   } 
