<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_fac_operaciones_bajas_cartera']['glo_nm_path_imag_temp'] . "/sc_apl_default_SIJAP.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_fac_operaciones_bajas_cartera_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_fac_operaciones_bajas_cartera_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_fac_operaciones_bajas_cartera']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_fac_operaciones_bajas_cartera']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['fac_operaciones_bajas_cartera_obc_tipo_cartera'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['fac_operaciones_bajas_cartera_obc_tipo_cartera'] = "cmp_maior_30_1";
   }
   else
   {
       $tab_def_campos['fac_operaciones_bajas_cartera_obc_tipo_cartera'] = "fac_operaciones_bajas_cartera.obc_tipo_cartera";
   }
   $tab_labels["fac_operaciones_bajas_cartera_obc_tipo_cartera"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_operaciones_bajas_cartera']['labels']["fac_operaciones_bajas_cartera_obc_tipo_cartera"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_operaciones_bajas_cartera']['labels']["fac_operaciones_bajas_cartera_obc_tipo_cartera"] : "" . $this->Nm_lang['lang_tipo_cartera'] . "";
   $tab_ger_campos['fac_operacion_op_fecha_emision'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['fac_operacion_op_fecha_emision'] = "fac_operacion_op_fecha_emision";
   }
   else
   {
       $tab_def_campos['fac_operacion_op_fecha_emision'] = "fac_operacion.op_fecha_emision";
   }
   $tab_labels["fac_operacion_op_fecha_emision"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_operaciones_bajas_cartera']['labels']["fac_operacion_op_fecha_emision"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_operaciones_bajas_cartera']['labels']["fac_operacion_op_fecha_emision"] : "" . $this->Nm_lang['lang_fecha_emision'] . "";
   $tab_ger_campos['fac_operaciones_bajas_cartera_obc_propietario'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['fac_operaciones_bajas_cartera_obc_propietario'] = "cmp_maior_30_2";
   }
   else
   {
       $tab_def_campos['fac_operaciones_bajas_cartera_obc_propietario'] = "fac_operaciones_bajas_cartera.obc_propietario";
   }
   $tab_labels["fac_operaciones_bajas_cartera_obc_propietario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_operaciones_bajas_cartera']['labels']["fac_operaciones_bajas_cartera_obc_propietario"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_operaciones_bajas_cartera']['labels']["fac_operaciones_bajas_cartera_obc_propietario"] : "" . $this->Nm_lang['lang_propietario'] . "";
   $tab_ger_campos['jap_contrato_con_numero_contrato'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['jap_contrato_con_numero_contrato'] = "cmp_maior_30_3";
   }
   else
   {
       $tab_def_campos['jap_contrato_con_numero_contrato'] = "jap_contrato.con_numero_contrato";
   }
   $tab_labels["jap_contrato_con_numero_contrato"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_operaciones_bajas_cartera']['labels']["jap_contrato_con_numero_contrato"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_operaciones_bajas_cartera']['labels']["jap_contrato_con_numero_contrato"] : "" . $this->Nm_lang['lang_numero_contrato'] . "";
   $tab_ger_campos['jap_contrato_con_comunidad'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['jap_contrato_con_comunidad'] = "jap_contrato_con_comunidad";
   }
   else
   {
       $tab_def_campos['jap_contrato_con_comunidad'] = "jap_contrato.con_comunidad";
   }
   $tab_labels["jap_contrato_con_comunidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_operaciones_bajas_cartera']['labels']["jap_contrato_con_comunidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_operaciones_bajas_cartera']['labels']["jap_contrato_con_comunidad"] : "" . $this->Nm_lang['lang_comunidad'] . "";
   $tab_ger_campos['jap_contrato_con_sector'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['jap_contrato_con_sector'] = "jap_contrato_con_sector";
   }
   else
   {
       $tab_def_campos['jap_contrato_con_sector'] = "jap_contrato.con_sector";
   }
   $tab_labels["jap_contrato_con_sector"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_operaciones_bajas_cartera']['labels']["jap_contrato_con_sector"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_operaciones_bajas_cartera']['labels']["jap_contrato_con_sector"] : "" . $this->Nm_lang['lang_sector'] . "";
   $tab_ger_campos['fac_operaciones_bajas_cartera_obc_comentario'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['fac_operaciones_bajas_cartera_obc_comentario'] = "cmp_maior_30_4";
   }
   else
   {
       $tab_def_campos['fac_operaciones_bajas_cartera_obc_comentario'] = "fac_operaciones_bajas_cartera.obc_comentario";
   }
   $tab_labels["fac_operaciones_bajas_cartera_obc_comentario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_operaciones_bajas_cartera']['labels']["fac_operaciones_bajas_cartera_obc_comentario"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_operaciones_bajas_cartera']['labels']["fac_operaciones_bajas_cartera_obc_comentario"] : "" . $this->Nm_lang['lang_descripcion'] . "";
   $tab_ger_campos['fac_operaciones_bajas_cartera_obc_saldo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['fac_operaciones_bajas_cartera_obc_saldo'] = "cmp_maior_30_5";
   }
   else
   {
       $tab_def_campos['fac_operaciones_bajas_cartera_obc_saldo'] = "fac_operaciones_bajas_cartera.obc_saldo";
   }
   $tab_labels["fac_operaciones_bajas_cartera_obc_saldo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_operaciones_bajas_cartera']['labels']["fac_operaciones_bajas_cartera_obc_saldo"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_operaciones_bajas_cartera']['labels']["fac_operaciones_bajas_cartera_obc_saldo"] : "" . $this->Nm_lang['lang_valor'] . "";
   $tab_ger_campos['fac_operaciones_bajas_cartera_obc_estado'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['fac_operaciones_bajas_cartera_obc_estado'] = "cmp_maior_30_6";
   }
   else
   {
       $tab_def_campos['fac_operaciones_bajas_cartera_obc_estado'] = "fac_operaciones_bajas_cartera.obc_estado";
   }
   $tab_labels["fac_operaciones_bajas_cartera_obc_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_fac_operaciones_bajas_cartera']['labels']["fac_operaciones_bajas_cartera_obc_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_fac_operaciones_bajas_cartera']['labels']["fac_operaciones_bajas_cartera_obc_estado"] : "" . $this->Nm_lang['lang_estado'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_operaciones_bajas_cartera']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_fac_operaciones_bajas_cartera']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_fac_operaciones_bajas_cartera']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_fac_operaciones_bajas_cartera']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_fac_operaciones_bajas_cartera']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_fac_operaciones_bajas_cartera']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_fac_operaciones_bajas_cartera']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_fac_operaciones_bajas_cartera']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_operaciones_bajas_cartera']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_fac_operaciones_bajas_cartera']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_fac_operaciones_bajas_cartera']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_fac_operaciones_bajas_cartera']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> fac_operaciones_bajas_cartera</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_fac_operaciones_bajas_cartera_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_fac_operaciones_bajas_cartera']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_fac_operaciones_bajas_cartera']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_fac_operaciones_bajas_cartera']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_fac_operaciones_bajas_cartera']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_fac_operaciones_bajas_cartera']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
