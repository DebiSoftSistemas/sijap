  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_aplicacion_menu" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sis_aplicacion_menu_form();
	}
...
?>
  ...
  // ---------- Validate as_id_
  function do_ajax_form_sis_aplicacion_menu_validate_as_id_(iNumLinha)
  {
    var nomeCampo_as_id_ = "as_id_" + iNumLinha;
    var var_as_id_ = scAjaxGetFieldHidden(nomeCampo_as_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_aplicacion_menu_validate_as_id_(var_as_id_, iNumLinha, var_script_case_init, do_ajax_form_sis_aplicacion_menu_validate_as_id__cb);
  } // do_ajax_form_sis_aplicacion_menu_validate_as_id_

  function do_ajax_form_sis_aplicacion_menu_validate_as_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "as_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "as_id_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "as_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "as_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_aplicacion_menu_validate_as_id__cb

  // ---------- Validate as_submenu_
  function do_ajax_form_sis_aplicacion_menu_validate_as_submenu_(iNumLinha)
  {
    var nomeCampo_as_submenu_ = "as_submenu_" + iNumLinha;
    var var_as_submenu_ = scAjaxGetFieldText(nomeCampo_as_submenu_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_aplicacion_menu_validate_as_submenu_(var_as_submenu_, iNumLinha, var_script_case_init, do_ajax_form_sis_aplicacion_menu_validate_as_submenu__cb);
  } // do_ajax_form_sis_aplicacion_menu_validate_as_submenu_

  function do_ajax_form_sis_aplicacion_menu_validate_as_submenu__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "as_submenu_" + iLineNumber;
    }
    else
    {
      sFieldValid = "as_submenu_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "as_submenu_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "as_submenu_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_aplicacion_menu_validate_as_submenu__cb

  // ---------- Validate as_aplicacion_
  function do_ajax_form_sis_aplicacion_menu_validate_as_aplicacion_(iNumLinha)
  {
    var nomeCampo_as_aplicacion_ = "as_aplicacion_" + iNumLinha;
    var var_as_aplicacion_ = scAjaxGetFieldSelect(nomeCampo_as_aplicacion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_aplicacion_menu_validate_as_aplicacion_(var_as_aplicacion_, iNumLinha, var_script_case_init, do_ajax_form_sis_aplicacion_menu_validate_as_aplicacion__cb);
  } // do_ajax_form_sis_aplicacion_menu_validate_as_aplicacion_

  function do_ajax_form_sis_aplicacion_menu_validate_as_aplicacion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "as_aplicacion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "as_aplicacion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "as_aplicacion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "as_aplicacion_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_aplicacion_menu_validate_as_aplicacion__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_sis_aplicacion_menu_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_sis_aplicacion_menu_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sis_aplicacion_menu_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_sis_aplicacion_menu_add_new_line_cb);
  } // do_ajax_form_sis_aplicacion_menu_add_new_line

  function do_ajax_form_sis_aplicacion_menu_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_sis_aplicacion_menu_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_sis_aplicacion_menu_backup_line(iNumLinha)
  {
    var var_as_id_ = scAjaxGetFieldHidden("as_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_aplicacion_menu_backup_line(var_as_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_sis_aplicacion_menu_backup_line_cb);
  } // do_ajax_form_sis_aplicacion_menu_backup_line

  function do_ajax_form_sis_aplicacion_menu_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_sis_aplicacion_menu_backup_line_cb

  function do_ajax_form_sis_aplicacion_menu_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_sis_aplicacion_menu_cancel_insert

  function do_ajax_form_sis_aplicacion_menu_cancel_update(iSeqVert)
  {
    do_ajax_form_sis_aplicacion_menu_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_sis_aplicacion_menu_cancel_update

  function do_ajax_form_sis_aplicacion_menu_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_sis_aplicacion_menu_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_sis_aplicacion_menu_table_refresh()
  {
    var var_as_id_ = document.F2.as_id_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_sis_aplicacion_menu_table_refresh(var_as_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_aplicacion_menu_table_refresh_cb);
  } //  do_ajax_form_sis_aplicacion_menu_table_refresh

  function do_ajax_form_sis_aplicacion_menu_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.as_id_.value = scAjaxGetKeyValue("as_id_");
    ...
    scAjaxAlert(do_ajax_form_sis_aplicacion_menu_table_refresh_cb_after_alert);
  } // do_ajax_form_sis_aplicacion_menu_table_refresh_cb
  function do_ajax_form_sis_aplicacion_menu_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_sis_aplicacion_menu_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_sis_aplicacion_menu_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_sis_aplicacion_menu_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_as_id_ = scAjaxGetFieldHidden("as_id_" + iNumLinha);
    var var_as_submenu_ = scAjaxGetFieldText("as_submenu_" + iNumLinha);
    var var_as_aplicacion_ = scAjaxGetFieldSelect("as_aplicacion_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_sis_aplicacion_menu_submit_form(var_as_id_, var_as_submenu_, var_as_aplicacion_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_aplicacion_menu_submit_form_cb);
  } // do_ajax_form_sis_aplicacion_menu_submit_form

  function do_ajax_form_sis_aplicacion_menu_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("as_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("as_submenu_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("as_aplicacion_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sis_aplicacion_menu_submit_form_cb_after_alert);
  } // do_ajax_form_sis_aplicacion_menu_submit_form_cb
  function do_ajax_form_sis_aplicacion_menu_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_aplicacion_menu_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sis_aplicacion_menu_navigate_form()
  {
    perform_ajax_form_sis_aplicacion_menu_navigate_form();
  }

  function perform_ajax_form_sis_aplicacion_menu_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_sis_aplicacion_menu_cancel_insert(sc_form_sis_aplicacion_menu_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("as_id_" + iNavForm);
      scAjaxHideErrorDisplay("as_submenu_" + iNavForm);
      scAjaxHideErrorDisplay("as_aplicacion_" + iNavForm);
    }
    var var_as_id_ = document.F2.as_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sis_aplicacion_menu_navigate_form(var_as_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_aplicacion_menu_navigate_form_cb);
  } // do_ajax_form_sis_aplicacion_menu_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_aplicacion_menu']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_aplicacion_menu_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.as_id_.value = scAjaxGetKeyValue("as_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_aplicacion_menu_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_aplicacion_menu_navigate_form_cb
  function do_ajax_form_sis_aplicacion_menu_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_sis_aplicacion_menu_navigate_form_cb_after_alert

    function sc_form_sis_aplicacion_menu_get_last_line_number()
    {
    ...
    } //sc_form_sis_aplicacion_menu_get_last_line_number

  function sc_hide_form_sis_aplicacion_menu_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "as_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "as_submenu_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "as_aplicacion_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["as_id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["as_submenu_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_submenu'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["as_aplicacion_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_aplicacion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["as_id_"][iNumLinha] = "as_id_" + iNumLinha;
    ajax_field_mult["as_submenu_"][iNumLinha] = "as_submenu_" + iNumLinha;
    ajax_field_mult["as_aplicacion_"][iNumLinha] = "as_aplicacion_" + iNumLinha;
    ajax_field_id["as_aplicacion_" + iNumLinha] = new Array("hidden_field_label_as_aplicacion_", "hidden_field_data_as_aplicacion_" + iNumLinha);
    ajax_error_count["as_id_" + iNumLinha] = "off";
    ajax_error_count["as_submenu_" + iNumLinha] = "off";
    ajax_error_count["as_aplicacion_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["as_id_" + iNumLinha] = "on";
    ajax_read_only["as_submenu_" + iNumLinha] = "off";
    ajax_read_only["as_aplicacion_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["as_id_" + iNumLinha] = "on";
    ajax_read_only["as_submenu_" + iNumLinha] = "on";
    ajax_read_only["as_aplicacion_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["as_id_" + iNumLinha] = null;
    ajax_error_list["as_submenu_" + iNumLinha] = null;
    ajax_error_list["as_aplicacion_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "as_id_": new Array(),
    "as_submenu_": new Array(),
    "as_aplicacion_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["as_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["as_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["as_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["as_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["as_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["as_submenu_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["as_submenu_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["as_submenu_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["as_submenu_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["as_submenu_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["as_aplicacion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["as_aplicacion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["as_aplicacion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["as_aplicacion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["as_aplicacion_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['as_id_'])) ? $this->nmgp_cmp_readonly['as_id_'] : 'on';
?>
    scAjaxFieldRead("as_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['as_submenu_'])) ? $this->nmgp_cmp_readonly['as_submenu_'] : 'off';
?>
    scAjaxFieldRead("as_submenu_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['as_aplicacion_'])) ? $this->nmgp_cmp_readonly['as_aplicacion_'] : 'off';
?>
    scAjaxFieldRead("as_aplicacion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("as_id_" + iSeq, "on");
    scAjaxFieldRead("as_submenu_" + iSeq, "on");
    scAjaxFieldRead("as_aplicacion_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["as_id_" + iRow] || "on" == ajax_error_count["as_submenu_" + iRow] || "on" == ajax_error_count["as_aplicacion_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_as_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_as_submenu_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_as_aplicacion_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["as_id_" + iRow] && "off" == ajax_error_count["as_submenu_" + iRow] && "off" == ajax_error_count["as_aplicacion_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["as_id_" + iRow] = "off";
        ajax_error_count["as_submenu_" + iRow] = "off";
        ajax_error_count["as_aplicacion_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_as_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_as_submenu_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_as_aplicacion_" + iRow).removeClass("scFormErrorLine");
    }
  }
