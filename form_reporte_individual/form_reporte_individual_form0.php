...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_reporte_individual/form_reporte_individual_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_reporte_individual_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_reporte_individual_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['link_info']['remove_border']) {
...
<?php
 include_once("form_reporte_individual_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_reporte_individual'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_reporte_individual'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-1';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
  ...
  if (document.getElementById(sTabId)) {
    if (bTabDisp) {
      ...
      if ("hidden_bloco_2" == sTabId) {
        scAjaxDetailHeight("grid_jap_contratos_cliente_cartera", $($("#nmsc_iframe_liga_grid_jap_contratos_cliente_cartera")[0].contentWindow.document).innerHeight());
      }
      if ("hidden_bloco_3" == sTabId) {
        scAjaxDetailHeight("grid_v_jap_instalacion_contratos_ind", $($("#nmsc_iframe_liga_grid_v_jap_instalacion_contratos_ind")[0].contentWindow.document).innerHeight());
        scAjaxDetailHeight("grid_v_jap_emisiones_consumo_ind", $($("#nmsc_iframe_liga_grid_v_jap_emisiones_consumo_ind")[0].contentWindow.document).innerHeight());
        scAjaxDetailHeight("grid_v_jap_otras_emisiones_ind", $($("#nmsc_iframe_liga_grid_v_jap_otras_emisiones_ind")[0].contentWindow.document).innerHeight());
      }
      if ("hidden_bloco_4" == sTabId) {
        scAjaxDetailHeight("grid_jap_solicitud_procesada_usuario", $($("#nmsc_iframe_liga_grid_jap_solicitud_procesada_usuario")[0].contentWindow.document).innerHeight());
      }
      if ("hidden_bloco_5" == sTabId) {
        scAjaxDetailHeight("grid_v_cartera_por_recuperar_ind", $($("#nmsc_iframe_liga_grid_v_cartera_por_recuperar_ind")[0].contentWindow.document).innerHeight());
      }
      if ("hidden_bloco_6" == sTabId) {
        scAjaxDetailHeight("grid_v_cartera_recuperada_ind", $($("#nmsc_iframe_liga_grid_v_cartera_recuperada_ind")[0].contentWindow.document).innerHeight());
      }
      if ("hidden_bloco_7" == sTabId) {
        scAjaxDetailHeight("grid_v_cartera_anulada_ind", $($("#nmsc_iframe_liga_grid_v_cartera_anulada_ind")[0].contentWindow.document).innerHeight());
      }
      if ("hidden_bloco_8" == sTabId) {
        scAjaxDetailHeight("grid_del_factura_cliente", $($("#nmsc_iframe_liga_grid_del_factura_cliente")[0].contentWindow.document).innerHeight());
      }
      if ("hidden_bloco_9" == sTabId) {
        scAjaxDetailHeight("grid_facturas_credito_ind", $($("#nmsc_iframe_liga_grid_facturas_credito_ind")[0].contentWindow.document).innerHeight());
      }
      if ("hidden_bloco_10" == sTabId) {
        scAjaxDetailHeight("grid_del_nota_credito_ind", $($("#nmsc_iframe_liga_grid_del_nota_credito_ind")[0].contentWindow.document).innerHeight());
      }
      if ("hidden_bloco_11" == sTabId) {
        scAjaxDetailHeight("grid_v_del_cuentas_por_pagar_cliente_ind", $($("#nmsc_iframe_liga_grid_v_del_cuentas_por_pagar_cliente_ind")[0].contentWindow.document).innerHeight());
      }
    }
    else {
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cl_tipo_identificacion_label" id="hidden_field_label_cl_tipo_identificacion" style="<?php echo $sStyleHidden_cl_tipo_identificacion; ?>"><span id="id_label_cl_tipo_identificacion"><?php echo $this->nm_new_label['cl_tipo_identificacion']; ?></span></TD>
    <TD class="scFormDataOdd css_cl_tipo_identificacion_line" id="hidden_field_data_cl_tipo_identificacion" style="<?php echo $sStyleHidden_cl_tipo_identificacion; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cl_tipo_identificacion_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cl_celular_line" id="hidden_field_data_cl_celular" style="<?php echo $sStyleHidden_cl_celular; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cl_celular_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cl_pais_line" id="hidden_field_data_cl_pais" style="<?php echo $sStyleHidden_cl_pais; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cl_pais_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cl_provincia_line" id="hidden_field_data_cl_provincia" style="<?php echo $sStyleHidden_cl_provincia; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cl_provincia_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cl_ciudad_line" id="hidden_field_data_cl_ciudad" style="<?php echo $sStyleHidden_cl_ciudad; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cl_ciudad_line" style="vertical-align: top;padding: 0px">
...
<ul class="scTabLine">
<li id="id_tabs_2_2" class="scTabActive"><a href="javascript: sc_control_tabs_2(2)"><?php echo $this->Ini->Nm_lang['lang_contratos'] ?></a></li>
<li id="id_tabs_2_3" class="scTabInactive"><a href="javascript: sc_control_tabs_2(3)">Emisiones</a></li>
<li id="id_tabs_2_4" class="scTabInactive"><a href="javascript: sc_control_tabs_2(4)"><?php echo $this->Ini->Nm_lang['lang_solicitud_procesada'] ?></a></li>
<li id="id_tabs_2_5" class="scTabInactive"><a href="javascript: sc_control_tabs_2(5)">Deudas por Pagar</a></li>
<li id="id_tabs_2_6" class="scTabInactive"><a href="javascript: sc_control_tabs_2(6)">Deudas Pagadas</a></li>
<li id="id_tabs_2_7" class="scTabInactive"><a href="javascript: sc_control_tabs_2(7)">Deudas Anuladas</a></li>
<li id="id_tabs_2_8" class="scTabInactive"><a href="javascript: sc_control_tabs_2(8)"><?php echo $this->Ini->Nm_lang['lang_factura'] ?>s</a></li>
<li id="id_tabs_2_9" class="scTabInactive"><a href="javascript: sc_control_tabs_2(9)"><?php echo $this->Ini->Nm_lang['lang_facturas_credito'] ?></a></li>
<li id="id_tabs_2_10" class="scTabInactive"><a href="javascript: sc_control_tabs_2(10)">Notas de Crédito</a></li>
<li id="id_tabs_2_11" class="scTabInactive"><a href="javascript: sc_control_tabs_2(11)">Anticipos</a></li>
</ul>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_contratos'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_contratos'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['grid_jap_contratos_cliente_cartera_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_contratos'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['grid_jap_contratos_cliente_cartera_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 if (isset($this->Ini->sc_lig_md5["grid_jap_contratos_cliente_cartera"]) && $this->Ini->sc_lig_md5["grid_jap_contratos_cliente_cartera"] == "S") {
     ...
     $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_reporte_individual@SC_par@" . md5($Parms_Lig);
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
 } else {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_reporte_individual_empty.htm' : $this->Ini->link_grid_jap_contratos_cliente_cartera_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y' . $parms_lig_cons;
if (isset($this->Ini->sc_lig_target['C_@scinf_contratos']) && 'nmsc_iframe_liga_grid_jap_contratos_cliente_cartera' != $this->Ini->sc_lig_target['C_@scinf_contratos'])
{
    ...
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_contratos'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['grid_jap_contratos_cliente_cartera_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_deudas_instalacion'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_deudas_instalacion'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['grid_v_jap_instalacion_contratos_ind_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_deudas_instalacion'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['grid_v_jap_instalacion_contratos_ind_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 $parms_lig_cons = "&nmgp_parms=" . $Md5_Lig;
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_reporte_individual_empty.htm' : $this->Ini->link_grid_v_jap_instalacion_contratos_ind_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y' . $parms_lig_cons;
if (isset($this->Ini->sc_lig_target['C_@scinf_deudas_instalacion']) && 'nmsc_iframe_liga_grid_v_jap_instalacion_contratos_ind' != $this->Ini->sc_lig_target['C_@scinf_deudas_instalacion'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_deudas_instalacion'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['grid_v_jap_instalacion_contratos_ind_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_deudas_consumo'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_deudas_consumo'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['grid_v_jap_emisiones_consumo_ind_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_deudas_consumo'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['grid_v_jap_emisiones_consumo_ind_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 $parms_lig_cons = "&nmgp_parms=" . $Md5_Lig;
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_reporte_individual_empty.htm' : $this->Ini->link_grid_v_jap_emisiones_consumo_ind_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y' . $parms_lig_cons;
if (isset($this->Ini->sc_lig_target['C_@scinf_deudas_consumo']) && 'nmsc_iframe_liga_grid_v_jap_emisiones_consumo_ind' != $this->Ini->sc_lig_target['C_@scinf_deudas_consumo'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_deudas_consumo'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['grid_v_jap_emisiones_consumo_ind_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_otras_deudas'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_otras_deudas'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['grid_v_jap_otras_emisiones_ind_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_otras_deudas'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['grid_v_jap_otras_emisiones_ind_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 $parms_lig_cons = "&nmgp_parms=" . $Md5_Lig;
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_reporte_individual_empty.htm' : $this->Ini->link_grid_v_jap_otras_emisiones_ind_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y' . $parms_lig_cons;
if (isset($this->Ini->sc_lig_target['C_@scinf_otras_deudas']) && 'nmsc_iframe_liga_grid_v_jap_otras_emisiones_ind' != $this->Ini->sc_lig_target['C_@scinf_otras_deudas'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_otras_deudas'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['grid_v_jap_otras_emisiones_ind_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_inspecciones'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_inspecciones'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['grid_jap_solicitud_procesada_usuario_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_inspecciones'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['grid_jap_solicitud_procesada_usuario_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 $parms_lig_cons = "&nmgp_parms=" . $Md5_Lig;
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_reporte_individual_empty.htm' : $this->Ini->link_grid_jap_solicitud_procesada_usuario_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y' . $parms_lig_cons;
if (isset($this->Ini->sc_lig_target['C_@scinf_inspecciones']) && 'nmsc_iframe_liga_grid_jap_solicitud_procesada_usuario' != $this->Ini->sc_lig_target['C_@scinf_inspecciones'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_inspecciones'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['grid_jap_solicitud_procesada_usuario_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_cartera_recuperar'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_cartera_recuperar'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['grid_v_cartera_por_recuperar_ind_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_cartera_recuperar'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['grid_v_cartera_por_recuperar_ind_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 $parms_lig_cons = "&nmgp_parms=" . $Md5_Lig;
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_reporte_individual_empty.htm' : $this->Ini->link_grid_v_cartera_por_recuperar_ind_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y' . $parms_lig_cons;
if (isset($this->Ini->sc_lig_target['C_@scinf_cartera_recuperar']) && 'nmsc_iframe_liga_grid_v_cartera_por_recuperar_ind' != $this->Ini->sc_lig_target['C_@scinf_cartera_recuperar'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_cartera_recuperar'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['grid_v_cartera_por_recuperar_ind_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_cartera_recuperada'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_cartera_recuperada'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['grid_v_cartera_recuperada_ind_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_cartera_recuperada'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['grid_v_cartera_recuperada_ind_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 $parms_lig_cons = "&nmgp_parms=" . $Md5_Lig;
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_reporte_individual_empty.htm' : $this->Ini->link_grid_v_cartera_recuperada_ind_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y' . $parms_lig_cons;
if (isset($this->Ini->sc_lig_target['C_@scinf_cartera_recuperada']) && 'nmsc_iframe_liga_grid_v_cartera_recuperada_ind' != $this->Ini->sc_lig_target['C_@scinf_cartera_recuperada'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_cartera_recuperada'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['grid_v_cartera_recuperada_ind_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_cartera_anulada'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_cartera_anulada'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['grid_v_cartera_anulada_ind_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_cartera_anulada'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['grid_v_cartera_anulada_ind_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 $parms_lig_cons = "&nmgp_parms=" . $Md5_Lig;
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_reporte_individual_empty.htm' : $this->Ini->link_grid_v_cartera_anulada_ind_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y' . $parms_lig_cons;
if (isset($this->Ini->sc_lig_target['C_@scinf_cartera_anulada']) && 'nmsc_iframe_liga_grid_v_cartera_anulada_ind' != $this->Ini->sc_lig_target['C_@scinf_cartera_anulada'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_cartera_anulada'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['grid_v_cartera_anulada_ind_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_facturas'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_facturas'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['grid_del_factura_cliente_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_facturas'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['grid_del_factura_cliente_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 $parms_lig_cons = "&nmgp_parms=" . $Md5_Lig;
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_reporte_individual_empty.htm' : $this->Ini->link_grid_del_factura_cliente_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y' . $parms_lig_cons;
if (isset($this->Ini->sc_lig_target['C_@scinf_facturas']) && 'nmsc_iframe_liga_grid_del_factura_cliente' != $this->Ini->sc_lig_target['C_@scinf_facturas'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_facturas'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['grid_del_factura_cliente_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_factura_credito'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_factura_credito'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['grid_facturas_credito_ind_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_factura_credito'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['grid_facturas_credito_ind_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 $parms_lig_cons = "&nmgp_parms=" . $Md5_Lig;
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_reporte_individual_empty.htm' : $this->Ini->link_grid_facturas_credito_ind_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y' . $parms_lig_cons;
if (isset($this->Ini->sc_lig_target['C_@scinf_factura_credito']) && 'nmsc_iframe_liga_grid_facturas_credito_ind' != $this->Ini->sc_lig_target['C_@scinf_factura_credito'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_factura_credito'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['grid_facturas_credito_ind_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_notas_credito'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_notas_credito'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['grid_del_nota_credito_ind_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_notas_credito'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['grid_del_nota_credito_ind_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 $parms_lig_cons = "&nmgp_parms=" . $Md5_Lig;
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_reporte_individual_empty.htm' : $this->Ini->link_grid_del_nota_credito_ind_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y' . $parms_lig_cons;
if (isset($this->Ini->sc_lig_target['C_@scinf_notas_credito']) && 'nmsc_iframe_liga_grid_del_nota_credito_ind' != $this->Ini->sc_lig_target['C_@scinf_notas_credito'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_notas_credito'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['grid_del_nota_credito_ind_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_cxp_cliente'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_cxp_cliente'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['grid_v_del_cuentas_por_pagar_cliente_ind_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_cxp_cliente'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['grid_v_del_cuentas_por_pagar_cliente_ind_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 $parms_lig_cons = "&nmgp_parms=" . $Md5_Lig;
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_reporte_individual_empty.htm' : $this->Ini->link_grid_v_del_cuentas_por_pagar_cliente_ind_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y' . $parms_lig_cons;
if (isset($this->Ini->sc_lig_target['C_@scinf_cxp_cliente']) && 'nmsc_iframe_liga_grid_v_del_cuentas_por_pagar_cliente_ind' != $this->Ini->sc_lig_target['C_@scinf_cxp_cliente'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_cxp_cliente'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['grid_v_del_cuentas_por_pagar_cliente_ind_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_disabled']['']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_disabled']['']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_label']['']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_label']['']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_label'][''];
        }
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['btn_label']['last'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_reporte_individual");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_reporte_individual");
 parent.scAjaxDetailHeight("form_reporte_individual", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_reporte_individual']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
