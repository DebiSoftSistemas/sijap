...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_del_pedido_pagado/form_del_pedido_pagado_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_del_pedido_pagado_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_del_pedido_pagado_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['link_info']['remove_border']) {
...
<?php
 include_once("form_del_pedido_pagado_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_del_pedido_pagado'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_del_pedido_pagado'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        $buttonMacroLabel = "" . $this->Ini->Nm_lang['lang_solicitar_preparacion'] . "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-2';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
   if (!isset($this->nmgp_cmp_hidden['prof_aplica_propina']))
   {
       $this->nmgp_cmp_hidden['prof_aplica_propina'] = 'off';
   }
   ...
   if (!isset($this->nmgp_cmp_hidden['prof_factura']))
   {
       $this->nmgp_cmp_hidden['prof_factura'] = 'off';
   }
   ...
   if (!isset($this->nmgp_cmp_hidden['prof_transportista']))
   {
       $this->nmgp_cmp_hidden['prof_transportista'] = 'off';
   }
...
<span id="id_read_on_prof_usuario" class="sc-ui-readonly-prof_usuario css_prof_usuario_line" style="<?php echo $sStyleReadLab_prof_usuario; ?>"><?php echo $this->form_format_readonly("prof_usuario", $this->form_encode_input($this->prof_usuario)); ?></span><span id="id_read_off_prof_usuario" class="css_read_off_prof_usuario<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_prof_usuario; ?>">
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=35"; } ?> maxlength=35 alt="{datatype: 'text', maxLength: 35, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
   ...
   <?php
    ...
    {
        $this->nm_new_label['prof_aplica_propina'] = "Prof Aplica Propina";
    }
?>
<?php
   $nm_cor_fun_cel  = (isset($nm_cor_fun_cel) && $nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<input type="hidden" name="prof_aplica_propina" value="<?php echo $this->form_encode_input($prof_aplica_propina) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>
...
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["prof_aplica_propina"]) &&  $this->nmgp_cmp_readonly["prof_aplica_propina"] == "on") { 
 ...
 ?>
<input type="hidden" name="prof_aplica_propina" value="<?php echo $this->form_encode_input($prof_aplica_propina) . "\">" . $prof_aplica_propina . ""; ?>
<?php } else { ?>
<span id="id_read_on_prof_aplica_propina" class="sc-ui-readonly-prof_aplica_propina css_prof_aplica_propina_line" style="<?php echo $sStyleReadLab_prof_aplica_propina; ?>"><?php echo $this->form_format_readonly("prof_aplica_propina", $this->form_encode_input($this->prof_aplica_propina)); ?></span><span id="id_read_off_prof_aplica_propina" class="css_read_off_prof_aplica_propina<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_prof_aplica_propina; ?>">
 <input class="sc-js-input scFormObjectOdd css_prof_aplica_propina_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_prof_aplica_propina" type=text name="prof_aplica_propina" value="<?php echo $this->form_encode_input($prof_aplica_propina) ?>"
...
<?php $sStyleHidden_prof_estado_dumb = ('' == $sStyleHidden_prof_estado) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_prof_estado_dumb" style="<?php echo $sStyleHidden_prof_estado_dumb; ?>"></TD>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['prof_transportista'] = "Prof Transportista";
    }
?>
<?php
   $nm_cor_fun_cel  = (isset($nm_cor_fun_cel) && $nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<input type="hidden" name="prof_transportista" value="<?php echo $this->form_encode_input($prof_transportista) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>
...
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["prof_transportista"]) &&  $this->nmgp_cmp_readonly["prof_transportista"] == "on") { 
 ...
 ?>
<input type="hidden" name="prof_transportista" value="<?php echo $this->form_encode_input($prof_transportista) . "\">" . $prof_transportista . ""; ?>
<?php } else { ?>
<span id="id_read_on_prof_transportista" class="sc-ui-readonly-prof_transportista css_prof_transportista_line" style="<?php echo $sStyleReadLab_prof_transportista; ?>"><?php echo $this->form_format_readonly("prof_transportista", $this->form_encode_input($this->prof_transportista)); ?></span><span id="id_read_off_prof_transportista" class="css_read_off_prof_transportista<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_prof_transportista; ?>">
 <input class="sc-js-input scFormObjectOdd css_prof_transportista_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_prof_transportista" type=text name="prof_transportista" value="<?php echo $this->form_encode_input($prof_transportista) ?>"
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=9"; } ?> alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['prof_transportista']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['prof_transportista']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['prof_transportista']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
   ...
   <?php
    if (!isset($this->nm_new_label['prof_factura']))
    {
        $this->nm_new_label['prof_factura'] = "Prof Factura";
    }
?>
<?php
   $nm_cor_fun_cel  = (isset($nm_cor_fun_cel) && $nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = (isset($nm_img_fun_cel) && $nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $prof_factura = $this->prof_factura;
   if (!isset($this->nmgp_cmp_hidden['prof_factura']))
   {
       $this->nmgp_cmp_hidden['prof_factura'] = 'off';
   }
   $sStyleHidden_prof_factura = '';
   if (isset($this->nmgp_cmp_hidden['prof_factura']) && $this->nmgp_cmp_hidden['prof_factura'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['prof_factura']);
       $sStyleHidden_prof_factura = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_prof_factura = 'display: none;';
   $sStyleReadInp_prof_factura = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['prof_factura']) && $this->nmgp_cmp_readonly['prof_factura'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['prof_factura']);
       $sStyleReadLab_prof_factura = '';
       $sStyleReadInp_prof_factura = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['prof_factura']) && $this->nmgp_cmp_hidden['prof_factura'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="prof_factura" value="<?php echo $this->form_encode_input($prof_factura) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_prof_factura_line" id="hidden_field_data_prof_factura" style="<?php echo $sStyleHidden_prof_factura; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_prof_factura_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_prof_factura_label" style=""><span id="id_label_prof_factura"><?php echo $this->nm_new_label['prof_factura']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["prof_factura"]) &&  $this->nmgp_cmp_readonly["prof_factura"] == "on") { 

 ?>
<input type="hidden" name="prof_factura" value="<?php echo $this->form_encode_input($prof_factura) . "\">" . $prof_factura . ""; ?>
<?php } else { ?>
<span id="id_read_on_prof_factura" class="sc-ui-readonly-prof_factura css_prof_factura_line" style="<?php echo $sStyleReadLab_prof_factura; ?>"><?php echo $this->form_format_readonly("prof_factura", $this->form_encode_input($this->prof_factura)); ?></span><span id="id_read_off_prof_factura" class="css_read_off_prof_factura<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_prof_factura; ?>">
 <input class="sc-js-input scFormObjectOdd css_prof_factura_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_prof_factura" type=text name="prof_factura" value="<?php echo $this->form_encode_input($prof_factura) ?>"
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=9"; } ?> alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['prof_factura']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['prof_factura']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['prof_factura']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_prof_factura_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_prof_factura_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php } ?>
<?php $sStyleHidden_prof_transportista_dumb = ('' == $sStyleHidden_prof_transportista) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_prof_transportista_dumb" style="<?php echo $sStyleHidden_prof_transportista_dumb; ?>"></TD>
<?php $sStyleHidden_prof_factura_dumb = ('' == $sStyleHidden_prof_factura) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_prof_factura_dumb" style="<?php echo $sStyleHidden_prof_factura_dumb; ?>"></TD>
<?php $sStyleHidden_prof_delivery_propio_dumb = ('' == $sStyleHidden_prof_delivery_propio) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_prof_delivery_propio_dumb" style="<?php echo $sStyleHidden_prof_delivery_propio_dumb; ?>"></TD>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_lugar_envio'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_lugar_envio'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_direccion_entrega_pedido_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_lugar_envio'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_direccion_entrega_pedido_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_direccion_entrega_pedido_script_case_init'] ]['form_del_direccion_entrega_pedido']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_direccion_entrega_pedido_script_case_init'] ]['form_del_direccion_entrega_pedido']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_direccion_entrega_pedido_script_case_init'] ]['form_del_direccion_entrega_pedido']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_direccion_entrega_pedido_script_case_init'] ]['form_del_direccion_entrega_pedido']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_direccion_entrega_pedido_script_case_init'] ]['form_del_direccion_entrega_pedido']['embutida_liga_form_insert'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_direccion_entrega_pedido_script_case_init'] ]['form_del_direccion_entrega_pedido']['embutida_liga_form_update'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_direccion_entrega_pedido_script_case_init'] ]['form_del_direccion_entrega_pedido']['embutida_liga_form_delete'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_direccion_entrega_pedido_script_case_init'] ]['form_del_direccion_entrega_pedido']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_direccion_entrega_pedido_script_case_init'] ]['form_del_direccion_entrega_pedido']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_direccion_entrega_pedido_script_case_init'] ]['form_del_direccion_entrega_pedido']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_direccion_entrega_pedido_script_case_init'] ]['form_del_direccion_entrega_pedido']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_direccion_entrega_pedido_script_case_init'] ]['form_del_direccion_entrega_pedido']['embutida_liga_tp_pag'] = 'parcial';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_direccion_entrega_pedido_script_case_init'] ]['form_del_direccion_entrega_pedido']['embutida_parms'] = "NM_btn_insert*scinN*scoutNM_btn_update*scinN*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinN*scout";
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_direccion_entrega_pedido_script_case_init'] ]['form_del_pedido_pagado']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_del_pedido_pagado_empty.htm' : $this->Ini->link_form_del_direccion_entrega_pedido_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y';
if (isset($this->Ini->sc_lig_target['C_@scinf_lugar_envio']) && 'nmsc_iframe_liga_form_del_direccion_entrega_pedido' != $this->Ini->sc_lig_target['C_@scinf_lugar_envio'])
{
    ...
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_lugar_envio'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_direccion_entrega_pedido_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalles'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalles'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_detalle_pedido_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalles'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_detalle_pedido_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_detalle_pedido_script_case_init'] ]['form_del_detalle_pedido']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_detalle_pedido_script_case_init'] ]['form_del_detalle_pedido']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_detalle_pedido_script_case_init'] ]['form_del_detalle_pedido']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_detalle_pedido_script_case_init'] ]['form_del_detalle_pedido']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_detalle_pedido_script_case_init'] ]['form_del_detalle_pedido']['embutida_liga_form_insert'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_detalle_pedido_script_case_init'] ]['form_del_detalle_pedido']['embutida_liga_form_update'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_detalle_pedido_script_case_init'] ]['form_del_detalle_pedido']['embutida_liga_form_delete'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_detalle_pedido_script_case_init'] ]['form_del_detalle_pedido']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_detalle_pedido_script_case_init'] ]['form_del_detalle_pedido']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_detalle_pedido_script_case_init'] ]['form_del_detalle_pedido']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_detalle_pedido_script_case_init'] ]['form_del_detalle_pedido']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_detalle_pedido_script_case_init'] ]['form_del_detalle_pedido']['embutida_liga_tp_pag'] = 'total';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_detalle_pedido_script_case_init'] ]['form_del_detalle_pedido']['embutida_parms'] = "var_proforma*scin" . $this->nmgp_dados_form['prof_numero'] . "*scoutNM_btn_insert*scinN*scoutNM_btn_update*scinN*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinN*scout";
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_detalle_pedido_script_case_init'] ]['form_del_pedido_pagado']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_del_pedido_pagado_empty.htm' : $this->Ini->link_form_del_detalle_pedido_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y&sc_ifr_height=440';
if (isset($this->Ini->sc_lig_target['C_@scinf_detalles']) && 'nmsc_iframe_liga_form_del_detalle_pedido' != $this->Ini->sc_lig_target['C_@scinf_detalles'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_detalles'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_detalle_pedido_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_forma_pago'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_forma_pago'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_forma_pago_pedido_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_forma_pago'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_forma_pago_pedido_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_forma_pago_pedido_script_case_init'] ]['form_del_forma_pago_pedido']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_forma_pago_pedido_script_case_init'] ]['form_del_forma_pago_pedido']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_forma_pago_pedido_script_case_init'] ]['form_del_forma_pago_pedido']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_forma_pago_pedido_script_case_init'] ]['form_del_forma_pago_pedido']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_forma_pago_pedido_script_case_init'] ]['form_del_forma_pago_pedido']['embutida_liga_form_insert'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_forma_pago_pedido_script_case_init'] ]['form_del_forma_pago_pedido']['embutida_liga_form_update'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_forma_pago_pedido_script_case_init'] ]['form_del_forma_pago_pedido']['embutida_liga_form_delete'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_forma_pago_pedido_script_case_init'] ]['form_del_forma_pago_pedido']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_forma_pago_pedido_script_case_init'] ]['form_del_forma_pago_pedido']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_forma_pago_pedido_script_case_init'] ]['form_del_forma_pago_pedido']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_forma_pago_pedido_script_case_init'] ]['form_del_forma_pago_pedido']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_forma_pago_pedido_script_case_init'] ]['form_del_forma_pago_pedido']['embutida_liga_tp_pag'] = 'parcial';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_forma_pago_pedido_script_case_init'] ]['form_del_forma_pago_pedido']['embutida_parms'] = "var_proforma*scin" . $this->nmgp_dados_form['prof_numero'] . "*scoutNM_btn_insert*scinN*scoutNM_btn_update*scinN*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinN*scout";
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_forma_pago_pedido_script_case_init'] ]['form_del_pedido_pagado']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_del_pedido_pagado_empty.htm' : $this->Ini->link_form_del_forma_pago_pedido_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y';
if (isset($this->Ini->sc_lig_target['C_@scinf_forma_pago']) && 'nmsc_iframe_liga_form_del_forma_pago_pedido' != $this->Ini->sc_lig_target['C_@scinf_forma_pago'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_forma_pago'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['form_del_forma_pago_pedido_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_del_pedido_pagado");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_del_pedido_pagado");
 parent.scAjaxDetailHeight("form_del_pedido_pagado", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_del_pedido_pagado']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
