  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_fac_procesa_recargos_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_fac_procesa_recargos_mob_form();
	}
...
?>
  ...
  // ---------- Validate pr_id
  function do_ajax_form_fac_procesa_recargos_mob_validate_pr_id()
  {
    var nomeCampo_pr_id = "pr_id";
    var var_pr_id = scAjaxGetFieldHidden(nomeCampo_pr_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_procesa_recargos_mob_validate_pr_id(var_pr_id, var_script_case_init, do_ajax_form_fac_procesa_recargos_mob_validate_pr_id_cb);
  } // do_ajax_form_fac_procesa_recargos_mob_validate_pr_id

  function do_ajax_form_fac_procesa_recargos_mob_validate_pr_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_procesa_recargos_mob_validate_pr_id_cb

  // ---------- Validate pr_empresa
  function do_ajax_form_fac_procesa_recargos_mob_validate_pr_empresa()
  {
    var nomeCampo_pr_empresa = "pr_empresa";
    var var_pr_empresa = scAjaxGetFieldText(nomeCampo_pr_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_procesa_recargos_mob_validate_pr_empresa(var_pr_empresa, var_script_case_init, do_ajax_form_fac_procesa_recargos_mob_validate_pr_empresa_cb);
  } // do_ajax_form_fac_procesa_recargos_mob_validate_pr_empresa

  function do_ajax_form_fac_procesa_recargos_mob_validate_pr_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_procesa_recargos_mob_validate_pr_empresa_cb

  // ---------- Validate pr_fecha
  function do_ajax_form_fac_procesa_recargos_mob_validate_pr_fecha()
  {
    var nomeCampo_pr_fecha = "pr_fecha";
    var var_pr_fecha = scAjaxGetFieldHidden(nomeCampo_pr_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_procesa_recargos_mob_validate_pr_fecha(var_pr_fecha, var_script_case_init, do_ajax_form_fac_procesa_recargos_mob_validate_pr_fecha_cb);
  } // do_ajax_form_fac_procesa_recargos_mob_validate_pr_fecha

  function do_ajax_form_fac_procesa_recargos_mob_validate_pr_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pr_fecha";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_procesa_recargos_mob_validate_pr_fecha_cb

  // ---------- Validate pr_periodo
  function do_ajax_form_fac_procesa_recargos_mob_validate_pr_periodo()
  {
    var nomeCampo_pr_periodo = "pr_periodo";
    var var_pr_periodo = scAjaxGetFieldSelect(nomeCampo_pr_periodo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_procesa_recargos_mob_validate_pr_periodo(var_pr_periodo, var_script_case_init, do_ajax_form_fac_procesa_recargos_mob_validate_pr_periodo_cb);
  } // do_ajax_form_fac_procesa_recargos_mob_validate_pr_periodo

  function do_ajax_form_fac_procesa_recargos_mob_validate_pr_periodo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pr_periodo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_procesa_recargos_mob_validate_pr_periodo_cb

  // ---------- Validate pr_mes
  function do_ajax_form_fac_procesa_recargos_mob_validate_pr_mes()
  {
    var nomeCampo_pr_mes = "pr_mes";
    var var_pr_mes = scAjaxGetFieldSelect(nomeCampo_pr_mes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_procesa_recargos_mob_validate_pr_mes(var_pr_mes, var_script_case_init, do_ajax_form_fac_procesa_recargos_mob_validate_pr_mes_cb);
  } // do_ajax_form_fac_procesa_recargos_mob_validate_pr_mes

  function do_ajax_form_fac_procesa_recargos_mob_validate_pr_mes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pr_mes";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_procesa_recargos_mob_validate_pr_mes_cb

  // ---------- Validate pr_usuario
  function do_ajax_form_fac_procesa_recargos_mob_validate_pr_usuario()
  {
    var nomeCampo_pr_usuario = "pr_usuario";
    var var_pr_usuario = scAjaxGetFieldText(nomeCampo_pr_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_procesa_recargos_mob_validate_pr_usuario(var_pr_usuario, var_script_case_init, do_ajax_form_fac_procesa_recargos_mob_validate_pr_usuario_cb);
  } // do_ajax_form_fac_procesa_recargos_mob_validate_pr_usuario

  function do_ajax_form_fac_procesa_recargos_mob_validate_pr_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pr_usuario";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_procesa_recargos_mob_validate_pr_usuario_cb

  // ---------- Validate pr_estado
  function do_ajax_form_fac_procesa_recargos_mob_validate_pr_estado()
  {
    var nomeCampo_pr_estado = "pr_estado";
    var var_pr_estado = scAjaxGetFieldHidden(nomeCampo_pr_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_procesa_recargos_mob_validate_pr_estado(var_pr_estado, var_script_case_init, do_ajax_form_fac_procesa_recargos_mob_validate_pr_estado_cb);
  } // do_ajax_form_fac_procesa_recargos_mob_validate_pr_estado

  function do_ajax_form_fac_procesa_recargos_mob_validate_pr_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_procesa_recargos_mob_validate_pr_estado_cb

  // ---------- Validate operaciones
  function do_ajax_form_fac_procesa_recargos_mob_validate_operaciones()
  {
    var nomeCampo_operaciones = "operaciones";
    var var_operaciones = scAjaxGetFieldText(nomeCampo_operaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_procesa_recargos_mob_validate_operaciones(var_operaciones, var_script_case_init, do_ajax_form_fac_procesa_recargos_mob_validate_operaciones_cb);
  } // do_ajax_form_fac_procesa_recargos_mob_validate_operaciones

  function do_ajax_form_fac_procesa_recargos_mob_validate_operaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_procesa_recargos_mob_validate_operaciones_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_fac_procesa_recargos_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_fac_procesa_recargos_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_pr_id = scAjaxGetFieldHidden("pr_id");
    var var_pr_empresa = scAjaxGetFieldText("pr_empresa");
    var var_pr_fecha = scAjaxGetFieldHidden("pr_fecha");
    var var_pr_periodo = scAjaxGetFieldSelect("pr_periodo");
    var var_pr_mes = scAjaxGetFieldSelect("pr_mes");
    var var_pr_usuario = scAjaxGetFieldText("pr_usuario");
    var var_pr_estado = scAjaxGetFieldHidden("pr_estado");
    ...
    scAjaxProcOn();
    x_ajax_form_fac_procesa_recargos_mob_submit_form(var_pr_id, var_pr_empresa, var_pr_fecha, var_pr_periodo, var_pr_mes, var_pr_usuario, var_pr_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_fac_procesa_recargos_mob_submit_form_cb);
  } // do_ajax_form_fac_procesa_recargos_mob_submit_form

  function do_ajax_form_fac_procesa_recargos_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("pr_fecha");
      scAjaxHideErrorDisplay("pr_periodo");
      scAjaxHideErrorDisplay("pr_mes");
      scAjaxHideErrorDisplay("pr_usuario");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_fac_procesa_recargos_mob_submit_form_cb_after_alert);
  } // do_ajax_form_fac_procesa_recargos_mob_submit_form_cb
  function do_ajax_form_fac_procesa_recargos_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_fac_procesa_recargos_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["grid_fac_recargos_aplicados"] = "off";

  function do_ajax_form_fac_procesa_recargos_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_fac_procesa_recargos_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_fac_procesa_recargos_mob_navigate_form();
    }
  }

  function perform_ajax_form_fac_procesa_recargos_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["grid_fac_recargos_aplicados"] = "on";
    x_ajax_form_fac_procesa_recargos_mob_navigate_form(var_pr_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_procesa_recargos_mob_navigate_form_cb);
  } // do_ajax_form_fac_procesa_recargos_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_procesa_recargos_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_fac_procesa_recargos_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_grid_fac_recargos_aplicados"] && "nmsc_iframe_liga_grid_fac_recargos_aplicados" != scMasterDetailIframe["nmsc_iframe_liga_grid_fac_recargos_aplicados"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_grid_fac_recargos_aplicados"]);
    }
    else {
        if (oResp["navSummary"].reg_tot != 0) {
            document.getElementById('nmsc_iframe_liga_grid_fac_recargos_aplicados').contentWindow.nm_move('apl_detalhe', true);
        }
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_fac_procesa_recargos_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_fac_procesa_recargos_mob_navigate_form_cb
  function do_ajax_form_fac_procesa_recargos_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_fac_procesa_recargos_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_fac_procesa_recargos_mob_navigate_form_cb_after_alert

  function sc_hide_form_fac_procesa_recargos_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["grid_fac_recargos_aplicados"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[2] = "pr_fecha";
  ajax_field_list[3] = "pr_periodo";
  ajax_field_list[4] = "pr_mes";
  ajax_field_list[5] = "pr_usuario";
  ajax_field_list[6] = "pr_estado";
  ...
  var ajax_error_list = {
    ...
    "pr_fecha": {"label": "<?php echo $this->Ini->Nm_lang['lang_fecha'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pr_periodo": {"label": "<?php echo $this->Ini->Nm_lang['lang_periodo_emision'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pr_mes": {"label": "<?php echo $this->Ini->Nm_lang['lang_srch_mnth'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pr_usuario": {"label": "<?php echo $this->Ini->Nm_lang['lang_usuario'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    ...
    "pr_fecha": new Array(),
    "pr_periodo": new Array(),
    "pr_mes": new Array(),
    "pr_usuario": new Array(),
    "pr_estado": new Array(),
    "operaciones": new Array()
  };
  ajax_field_mult["pr_id"][1] = "pr_id";
  ajax_field_mult["pr_empresa"][1] = "pr_empresa";
  ajax_field_mult["pr_fecha"][1] = "pr_fecha";
  ajax_field_mult["pr_periodo"][1] = "pr_periodo";
  ajax_field_mult["pr_mes"][1] = "pr_mes";
  ajax_field_mult["pr_usuario"][1] = "pr_usuario";
  ajax_field_mult["pr_estado"][1] = "pr_estado";
  ajax_field_mult["operaciones"][1] = "operaciones";

  var ajax_field_id = {
    "pr_id": new Array("hidden_field_label_pr_id", "hidden_field_data_pr_id"),
    "pr_fecha": new Array("hidden_field_label_pr_fecha", "hidden_field_data_pr_fecha"),
    "pr_periodo": new Array("hidden_field_label_pr_periodo", "hidden_field_data_pr_periodo"),
    "pr_mes": new Array("hidden_field_label_pr_mes", "hidden_field_data_pr_mes"),
