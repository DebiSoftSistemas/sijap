  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_fac_procesa_recargos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_fac_procesa_recargos_form();
	}
...
?>
  ...
  // ---------- Validate pr_id
  function do_ajax_form_fac_procesa_recargos_validate_pr_id()
  {
    var nomeCampo_pr_id = "pr_id";
    var var_pr_id = scAjaxGetFieldHidden(nomeCampo_pr_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_procesa_recargos_validate_pr_id(var_pr_id, var_script_case_init, do_ajax_form_fac_procesa_recargos_validate_pr_id_cb);
  } // do_ajax_form_fac_procesa_recargos_validate_pr_id

  function do_ajax_form_fac_procesa_recargos_validate_pr_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_procesa_recargos_validate_pr_id_cb

  // ---------- Validate pr_empresa
  function do_ajax_form_fac_procesa_recargos_validate_pr_empresa()
  {
    var nomeCampo_pr_empresa = "pr_empresa";
    var var_pr_empresa = scAjaxGetFieldText(nomeCampo_pr_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_procesa_recargos_validate_pr_empresa(var_pr_empresa, var_script_case_init, do_ajax_form_fac_procesa_recargos_validate_pr_empresa_cb);
  } // do_ajax_form_fac_procesa_recargos_validate_pr_empresa

  function do_ajax_form_fac_procesa_recargos_validate_pr_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_procesa_recargos_validate_pr_empresa_cb

  // ---------- Validate pr_fecha
  function do_ajax_form_fac_procesa_recargos_validate_pr_fecha()
  {
    var nomeCampo_pr_fecha = "pr_fecha";
    var var_pr_fecha = scAjaxGetFieldHidden(nomeCampo_pr_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_procesa_recargos_validate_pr_fecha(var_pr_fecha, var_script_case_init, do_ajax_form_fac_procesa_recargos_validate_pr_fecha_cb);
  } // do_ajax_form_fac_procesa_recargos_validate_pr_fecha

  function do_ajax_form_fac_procesa_recargos_validate_pr_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_procesa_recargos_validate_pr_fecha_cb

  // ---------- Validate pr_periodo
  function do_ajax_form_fac_procesa_recargos_validate_pr_periodo()
  {
    var nomeCampo_pr_periodo = "pr_periodo";
    var var_pr_periodo = scAjaxGetFieldSelect(nomeCampo_pr_periodo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_procesa_recargos_validate_pr_periodo(var_pr_periodo, var_script_case_init, do_ajax_form_fac_procesa_recargos_validate_pr_periodo_cb);
  } // do_ajax_form_fac_procesa_recargos_validate_pr_periodo

  function do_ajax_form_fac_procesa_recargos_validate_pr_periodo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_procesa_recargos_validate_pr_periodo_cb

  // ---------- Validate pr_mes
  function do_ajax_form_fac_procesa_recargos_validate_pr_mes()
  {
    var nomeCampo_pr_mes = "pr_mes";
    var var_pr_mes = scAjaxGetFieldSelect(nomeCampo_pr_mes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_procesa_recargos_validate_pr_mes(var_pr_mes, var_script_case_init, do_ajax_form_fac_procesa_recargos_validate_pr_mes_cb);
  } // do_ajax_form_fac_procesa_recargos_validate_pr_mes

  function do_ajax_form_fac_procesa_recargos_validate_pr_mes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pr_mes";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_procesa_recargos_validate_pr_mes_cb

  // ---------- Validate pr_usuario
  function do_ajax_form_fac_procesa_recargos_validate_pr_usuario()
  {
    var nomeCampo_pr_usuario = "pr_usuario";
    var var_pr_usuario = scAjaxGetFieldText(nomeCampo_pr_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_procesa_recargos_validate_pr_usuario(var_pr_usuario, var_script_case_init, do_ajax_form_fac_procesa_recargos_validate_pr_usuario_cb);
  } // do_ajax_form_fac_procesa_recargos_validate_pr_usuario

  function do_ajax_form_fac_procesa_recargos_validate_pr_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_procesa_recargos_validate_pr_usuario_cb

  // ---------- Validate pr_estado
  function do_ajax_form_fac_procesa_recargos_validate_pr_estado()
  {
    var nomeCampo_pr_estado = "pr_estado";
    var var_pr_estado = scAjaxGetFieldHidden(nomeCampo_pr_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_procesa_recargos_validate_pr_estado(var_pr_estado, var_script_case_init, do_ajax_form_fac_procesa_recargos_validate_pr_estado_cb);
  } // do_ajax_form_fac_procesa_recargos_validate_pr_estado

  function do_ajax_form_fac_procesa_recargos_validate_pr_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_procesa_recargos_validate_pr_estado_cb

  // ---------- Validate operaciones
  function do_ajax_form_fac_procesa_recargos_validate_operaciones()
  {
    var nomeCampo_operaciones = "operaciones";
    var var_operaciones = scAjaxGetFieldText(nomeCampo_operaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_procesa_recargos_validate_operaciones(var_operaciones, var_script_case_init, do_ajax_form_fac_procesa_recargos_validate_operaciones_cb);
  } // do_ajax_form_fac_procesa_recargos_validate_operaciones

  function do_ajax_form_fac_procesa_recargos_validate_operaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_procesa_recargos_validate_operaciones_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_fac_procesa_recargos_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_fac_procesa_recargos_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_fac_procesa_recargos_submit_form(var_pr_id, var_pr_empresa, var_pr_fecha, var_pr_periodo, var_pr_mes, var_pr_usuario, var_pr_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_fac_procesa_recargos_submit_form_cb);
  } // do_ajax_form_fac_procesa_recargos_submit_form

  function do_ajax_form_fac_procesa_recargos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_fac_procesa_recargos_submit_form_cb_after_alert);
  } // do_ajax_form_fac_procesa_recargos_submit_form_cb
  function do_ajax_form_fac_procesa_recargos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_fac_procesa_recargos_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["grid_fac_recargos_aplicados"] = "off";

  function do_ajax_form_fac_procesa_recargos_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_fac_procesa_recargos_navigate_form, function() {});
    } else {
      perform_ajax_form_fac_procesa_recargos_navigate_form();
    }
  }

  function perform_ajax_form_fac_procesa_recargos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_fac_procesa_recargos_navigate_form(var_pr_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_procesa_recargos_navigate_form_cb);
  } // do_ajax_form_fac_procesa_recargos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_procesa_recargos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_fac_procesa_recargos_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_fac_procesa_recargos_navigate_form_cb_after_alert);
  } // do_ajax_form_fac_procesa_recargos_navigate_form_cb
  function do_ajax_form_fac_procesa_recargos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_fac_procesa_recargos_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_fac_procesa_recargos_navigate_form_cb_after_alert

  function sc_hide_form_fac_procesa_recargos_form()
  {
