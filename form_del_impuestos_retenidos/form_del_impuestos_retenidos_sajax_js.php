  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_del_impuestos_retenidos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_del_impuestos_retenidos_form();
	}
...
?>
  ...
  // ---------- Validate ir_id_
  function do_ajax_form_del_impuestos_retenidos_validate_ir_id_(iNumLinha)
  {
    var nomeCampo_ir_id_ = "ir_id_" + iNumLinha;
    var var_ir_id_ = scAjaxGetFieldHidden(nomeCampo_ir_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_impuestos_retenidos_validate_ir_id_(var_ir_id_, iNumLinha, var_script_case_init, do_ajax_form_del_impuestos_retenidos_validate_ir_id__cb);
  } // do_ajax_form_del_impuestos_retenidos_validate_ir_id_

  function do_ajax_form_del_impuestos_retenidos_validate_ir_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_impuestos_retenidos_validate_ir_id__cb

  // ---------- Validate ir_retencion_
  function do_ajax_form_del_impuestos_retenidos_validate_ir_retencion_(iNumLinha)
  {
    var nomeCampo_ir_retencion_ = "ir_retencion_" + iNumLinha;
    var var_ir_retencion_ = scAjaxGetFieldText(nomeCampo_ir_retencion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_impuestos_retenidos_validate_ir_retencion_(var_ir_retencion_, iNumLinha, var_script_case_init, do_ajax_form_del_impuestos_retenidos_validate_ir_retencion__cb);
  } // do_ajax_form_del_impuestos_retenidos_validate_ir_retencion_

  function do_ajax_form_del_impuestos_retenidos_validate_ir_retencion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "ir_retencion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ir_retencion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "ir_retencion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ir_retencion_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_impuestos_retenidos_validate_ir_retencion__cb

  // ---------- Validate dr_impuesto_
  function do_ajax_form_del_impuestos_retenidos_validate_dr_impuesto_(iNumLinha)
  {
    var nomeCampo_dr_impuesto_ = "dr_impuesto_" + iNumLinha;
    var var_dr_impuesto_ = scAjaxGetFieldSelect(nomeCampo_dr_impuesto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_impuestos_retenidos_validate_dr_impuesto_(var_dr_impuesto_, iNumLinha, var_script_case_init, do_ajax_form_del_impuestos_retenidos_validate_dr_impuesto__cb);
  } // do_ajax_form_del_impuestos_retenidos_validate_dr_impuesto_

  function do_ajax_form_del_impuestos_retenidos_validate_dr_impuesto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_impuestos_retenidos_validate_dr_impuesto__cb

  // ---------- Validate dr_codigo_retencion_
  function do_ajax_form_del_impuestos_retenidos_validate_dr_codigo_retencion_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_impuestos_retenidos_validate_dr_codigo_retencion_(var_dr_codigo_retencion_, iNumLinha, var_script_case_init, do_ajax_form_del_impuestos_retenidos_validate_dr_codigo_retencion__cb);
  } // do_ajax_form_del_impuestos_retenidos_validate_dr_codigo_retencion_

  function do_ajax_form_del_impuestos_retenidos_validate_dr_codigo_retencion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_impuestos_retenidos_validate_dr_codigo_retencion__cb

  // ---------- Validate dr_base_imponible_
  function do_ajax_form_del_impuestos_retenidos_validate_dr_base_imponible_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_impuestos_retenidos_validate_dr_base_imponible_(var_dr_base_imponible_, iNumLinha, var_script_case_init, do_ajax_form_del_impuestos_retenidos_validate_dr_base_imponible__cb);
  } // do_ajax_form_del_impuestos_retenidos_validate_dr_base_imponible_

  function do_ajax_form_del_impuestos_retenidos_validate_dr_base_imponible__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_impuestos_retenidos_validate_dr_base_imponible__cb

  // ---------- Validate dr_porcentaje_retencion_
  function do_ajax_form_del_impuestos_retenidos_validate_dr_porcentaje_retencion_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_impuestos_retenidos_validate_dr_porcentaje_retencion_(var_dr_porcentaje_retencion_, iNumLinha, var_script_case_init, do_ajax_form_del_impuestos_retenidos_validate_dr_porcentaje_retencion__cb);
  } // do_ajax_form_del_impuestos_retenidos_validate_dr_porcentaje_retencion_

  function do_ajax_form_del_impuestos_retenidos_validate_dr_porcentaje_retencion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_impuestos_retenidos_validate_dr_porcentaje_retencion__cb

  // ---------- Validate dr_valor_retenido_
  function do_ajax_form_del_impuestos_retenidos_validate_dr_valor_retenido_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_impuestos_retenidos_validate_dr_valor_retenido_(var_dr_valor_retenido_, iNumLinha, var_script_case_init, do_ajax_form_del_impuestos_retenidos_validate_dr_valor_retenido__cb);
  } // do_ajax_form_del_impuestos_retenidos_validate_dr_valor_retenido_

  function do_ajax_form_del_impuestos_retenidos_validate_dr_valor_retenido__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_impuestos_retenidos_validate_dr_valor_retenido__cb

  // ---------- Refresh dr_impuesto_
  function do_ajax_form_del_impuestos_retenidos_refresh_dr_impuesto_(iSeqForm)
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_del_impuestos_retenidos_refresh_dr_impuesto_(var_dr_impuesto_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_del_impuestos_retenidos_refresh_dr_impuesto__cb);
  } // do_ajax_form_del_impuestos_retenidos_refresh_dr_impuesto_

  function do_ajax_form_del_impuestos_retenidos_refresh_dr_impuesto__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_del_impuestos_retenidos_refresh_dr_impuesto__cb

  // ---------- Event onchange dr_base_imponible_
  function do_ajax_form_del_impuestos_retenidos_event_dr_base_imponible__onchange(iSeqForm)
  {
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_del_impuestos_retenidos_event_dr_base_imponible__onchange(var_dr_base_imponible_, var_dr_porcentaje_retencion_, var_dr_valor_retenido_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_del_impuestos_retenidos_event_dr_base_imponible__onchange_cb);
  } // do_ajax_form_del_impuestos_retenidos_event_dr_base_imponible__onchange

  function do_ajax_form_del_impuestos_retenidos_event_dr_base_imponible__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_impuestos_retenidos_event_dr_base_imponible__onchange_cb_after_alert);
  } // do_ajax_form_del_impuestos_retenidos_event_dr_base_imponible__onchange_cb
  function do_ajax_form_del_impuestos_retenidos_event_dr_base_imponible__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_impuestos_retenidos_event_dr_base_imponible__onchange_cb_after_alert

  // ---------- Event onchange dr_codigo_retencion_
  function do_ajax_form_del_impuestos_retenidos_event_dr_codigo_retencion__onchange(iSeqForm)
  {
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_del_impuestos_retenidos_event_dr_codigo_retencion__onchange(var_dr_codigo_retencion_, var_dr_porcentaje_retencion_, var_dr_base_imponible_, var_dr_valor_retenido_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_del_impuestos_retenidos_event_dr_codigo_retencion__onchange_cb);
  } // do_ajax_form_del_impuestos_retenidos_event_dr_codigo_retencion__onchange

  function do_ajax_form_del_impuestos_retenidos_event_dr_codigo_retencion__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_impuestos_retenidos_event_dr_codigo_retencion__onchange_cb_after_alert);
  } // do_ajax_form_del_impuestos_retenidos_event_dr_codigo_retencion__onchange_cb
  function do_ajax_form_del_impuestos_retenidos_event_dr_codigo_retencion__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_del_impuestos_retenidos_event_dr_codigo_retencion__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_del_impuestos_retenidos_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_del_impuestos_retenidos_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_del_impuestos_retenidos_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_del_impuestos_retenidos_add_new_line_cb);
  } // do_ajax_form_del_impuestos_retenidos_add_new_line

  function do_ajax_form_del_impuestos_retenidos_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_del_impuestos_retenidos_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_del_impuestos_retenidos_backup_line(iNumLinha)
  {
    var var_ir_id_ = scAjaxGetFieldHidden("ir_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_del_impuestos_retenidos_backup_line(var_ir_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_del_impuestos_retenidos_backup_line_cb);
  } // do_ajax_form_del_impuestos_retenidos_backup_line

  function do_ajax_form_del_impuestos_retenidos_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_del_impuestos_retenidos_backup_line_cb

  function do_ajax_form_del_impuestos_retenidos_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_del_impuestos_retenidos_cancel_insert

  function do_ajax_form_del_impuestos_retenidos_cancel_update(iSeqVert)
  {
    do_ajax_form_del_impuestos_retenidos_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_del_impuestos_retenidos_cancel_update

  function do_ajax_form_del_impuestos_retenidos_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_del_impuestos_retenidos_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_del_impuestos_retenidos_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_impuestos_retenidos_table_refresh(var_ir_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_impuestos_retenidos_table_refresh_cb);
  } //  do_ajax_form_del_impuestos_retenidos_table_refresh

  function do_ajax_form_del_impuestos_retenidos_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_del_impuestos_retenidos_table_refresh_cb_after_alert);
  } // do_ajax_form_del_impuestos_retenidos_table_refresh_cb
  function do_ajax_form_del_impuestos_retenidos_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_del_impuestos_retenidos_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_del_impuestos_retenidos_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_del_impuestos_retenidos_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_ir_id_ = scAjaxGetFieldHidden("ir_id_" + iNumLinha);
    var var_ir_retencion_ = scAjaxGetFieldText("ir_retencion_" + iNumLinha);
...
?>
    x_ajax_form_del_impuestos_retenidos_submit_form(var_ir_id_, var_ir_retencion_, var_dr_impuesto_, var_dr_codigo_retencion_, var_dr_base_imponible_, var_dr_porcentaje_retencion_, var_dr_valor_retenido_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_del_impuestos_retenidos_submit_form_cb);
  } // do_ajax_form_del_impuestos_retenidos_submit_form

  function do_ajax_form_del_impuestos_retenidos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("ir_retencion_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_del_impuestos_retenidos_submit_form_cb_after_alert);
  } // do_ajax_form_del_impuestos_retenidos_submit_form_cb
  function do_ajax_form_del_impuestos_retenidos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_del_impuestos_retenidos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_del_impuestos_retenidos_navigate_form()
  {
    perform_ajax_form_del_impuestos_retenidos_navigate_form();
  }

  function perform_ajax_form_del_impuestos_retenidos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_del_impuestos_retenidos_cancel_insert(sc_form_del_impuestos_retenidos_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("ir_retencion_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_del_impuestos_retenidos_navigate_form(var_ir_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_del_impuestos_retenidos_navigate_form_cb);
  } // do_ajax_form_del_impuestos_retenidos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_del_impuestos_retenidos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_del_impuestos_retenidos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_del_impuestos_retenidos_navigate_form_cb_after_alert);
  } // do_ajax_form_del_impuestos_retenidos_navigate_form_cb
  function do_ajax_form_del_impuestos_retenidos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_del_impuestos_retenidos_navigate_form_cb_after_alert

    function sc_form_del_impuestos_retenidos_get_last_line_number()
    {
    ...
    } //sc_form_del_impuestos_retenidos_get_last_line_number

  function sc_hide_form_del_impuestos_retenidos_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "ir_retencion_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["ir_retencion_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_retencion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["ir_retencion_"][iNumLinha] = "ir_retencion_" + iNumLinha;
    ...
    ajax_error_count["ir_retencion_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["ir_retencion_" + iNumLinha] = "off";
...
?>
    ajax_read_only["ir_id_" + iNumLinha] = "on";
    ajax_read_only["ir_retencion_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["ir_retencion_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["ir_retencion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ir_retencion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ir_retencion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ir_retencion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ir_retencion_" + iNumLinha]["onfocus"] = new Array();
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ir_retencion_'])) ? $this->nmgp_cmp_readonly['ir_retencion_'] : 'off';
?>
    scAjaxFieldRead("ir_retencion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("ir_retencion_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["ir_id_" + iRow] || "on" == ajax_error_count["ir_retencion_" + iRow] || "on" == ajax_error_count["dr_impuesto_" + iRow] || "on" == ajax_error_count["dr_codigo_retencion_" + iRow] || "on" == ajax_error_count["dr_base_imponible_" + iRow] || "on" == ajax_error_count["dr_porcentaje_retencion_" + iRow] || "on" == ajax_error_count["dr_valor_retenido_" + iRow]))
    {
      ...
      $("#hidden_field_data_ir_retencion_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["ir_id_" + iRow] && "off" == ajax_error_count["ir_retencion_" + iRow] && "off" == ajax_error_count["dr_impuesto_" + iRow] && "off" == ajax_error_count["dr_codigo_retencion_" + iRow] && "off" == ajax_error_count["dr_base_imponible_" + iRow] && "off" == ajax_error_count["dr_porcentaje_retencion_" + iRow] && "off" == ajax_error_count["dr_valor_retenido_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["ir_id_" + iRow] = "off";
        ajax_error_count["ir_retencion_" + iRow] = "off";
      ...
      $("#hidden_field_data_ir_retencion_" + iRow).removeClass("scFormErrorLine");
