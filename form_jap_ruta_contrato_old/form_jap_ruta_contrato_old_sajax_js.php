  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_jap_ruta_contrato_old" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_jap_ruta_contrato_old_form();
	}
...
?>
  ...
  // ---------- Validate rc_id_
  function do_ajax_form_jap_ruta_contrato_old_validate_rc_id_(iNumLinha)
  {
    var nomeCampo_rc_id_ = "rc_id_" + iNumLinha;
    var var_rc_id_ = scAjaxGetFieldHidden(nomeCampo_rc_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_ruta_contrato_old_validate_rc_id_(var_rc_id_, iNumLinha, var_script_case_init, do_ajax_form_jap_ruta_contrato_old_validate_rc_id__cb);
  } // do_ajax_form_jap_ruta_contrato_old_validate_rc_id_

  function do_ajax_form_jap_ruta_contrato_old_validate_rc_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "rc_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rc_id_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "rc_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rc_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_ruta_contrato_old_validate_rc_id__cb

  // ---------- Validate rc_ruta_
  function do_ajax_form_jap_ruta_contrato_old_validate_rc_ruta_(iNumLinha)
  {
    var nomeCampo_rc_ruta_ = "rc_ruta_" + iNumLinha;
    var var_rc_ruta_ = scAjaxGetFieldText(nomeCampo_rc_ruta_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_ruta_contrato_old_validate_rc_ruta_(var_rc_ruta_, iNumLinha, var_script_case_init, do_ajax_form_jap_ruta_contrato_old_validate_rc_ruta__cb);
  } // do_ajax_form_jap_ruta_contrato_old_validate_rc_ruta_

  function do_ajax_form_jap_ruta_contrato_old_validate_rc_ruta__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rc_ruta_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rc_ruta_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rc_ruta_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rc_ruta_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_ruta_contrato_old_validate_rc_ruta__cb

  // ---------- Validate rc_orden_
  function do_ajax_form_jap_ruta_contrato_old_validate_rc_orden_(iNumLinha)
  {
    var nomeCampo_rc_orden_ = "rc_orden_" + iNumLinha;
    var var_rc_orden_ = scAjaxGetFieldText(nomeCampo_rc_orden_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_ruta_contrato_old_validate_rc_orden_(var_rc_orden_, iNumLinha, var_script_case_init, do_ajax_form_jap_ruta_contrato_old_validate_rc_orden__cb);
  } // do_ajax_form_jap_ruta_contrato_old_validate_rc_orden_

  function do_ajax_form_jap_ruta_contrato_old_validate_rc_orden__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rc_orden_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rc_orden_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rc_orden_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rc_orden_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_ruta_contrato_old_validate_rc_orden__cb

  // ---------- Validate rc_contrato_
  function do_ajax_form_jap_ruta_contrato_old_validate_rc_contrato_(iNumLinha)
  {
    var nomeCampo_rc_contrato_ = "rc_contrato_" + iNumLinha;
    var var_rc_contrato_ = scAjaxGetFieldHidden(nomeCampo_rc_contrato_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_ruta_contrato_old_validate_rc_contrato_(var_rc_contrato_, iNumLinha, var_script_case_init, do_ajax_form_jap_ruta_contrato_old_validate_rc_contrato__cb);
  } // do_ajax_form_jap_ruta_contrato_old_validate_rc_contrato_

  function do_ajax_form_jap_ruta_contrato_old_validate_rc_contrato__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rc_contrato_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rc_contrato_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rc_contrato_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rc_contrato_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_ruta_contrato_old_validate_rc_contrato__cb

  // ---------- Validate rc_num_contrato_
  function do_ajax_form_jap_ruta_contrato_old_validate_rc_num_contrato_(iNumLinha)
  {
    var nomeCampo_rc_num_contrato_ = "rc_num_contrato_" + iNumLinha;
    var var_rc_num_contrato_ = scAjaxGetFieldHidden(nomeCampo_rc_num_contrato_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_ruta_contrato_old_validate_rc_num_contrato_(var_rc_num_contrato_, iNumLinha, var_script_case_init, do_ajax_form_jap_ruta_contrato_old_validate_rc_num_contrato__cb);
  } // do_ajax_form_jap_ruta_contrato_old_validate_rc_num_contrato_

  function do_ajax_form_jap_ruta_contrato_old_validate_rc_num_contrato__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rc_num_contrato_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rc_num_contrato_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rc_num_contrato_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rc_num_contrato_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_ruta_contrato_old_validate_rc_num_contrato__cb

  // ---------- Validate rc_cedula_
  function do_ajax_form_jap_ruta_contrato_old_validate_rc_cedula_(iNumLinha)
  {
    var nomeCampo_rc_cedula_ = "rc_cedula_" + iNumLinha;
    var var_rc_cedula_ = scAjaxGetFieldHidden(nomeCampo_rc_cedula_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_ruta_contrato_old_validate_rc_cedula_(var_rc_cedula_, iNumLinha, var_script_case_init, do_ajax_form_jap_ruta_contrato_old_validate_rc_cedula__cb);
  } // do_ajax_form_jap_ruta_contrato_old_validate_rc_cedula_

  function do_ajax_form_jap_ruta_contrato_old_validate_rc_cedula__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rc_cedula_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rc_cedula_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rc_cedula_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rc_cedula_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_ruta_contrato_old_validate_rc_cedula__cb

  // ---------- Validate rc_usuario_
  function do_ajax_form_jap_ruta_contrato_old_validate_rc_usuario_(iNumLinha)
  {
    var nomeCampo_rc_usuario_ = "rc_usuario_" + iNumLinha;
    var var_rc_usuario_ = scAjaxGetFieldHidden(nomeCampo_rc_usuario_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_ruta_contrato_old_validate_rc_usuario_(var_rc_usuario_, iNumLinha, var_script_case_init, do_ajax_form_jap_ruta_contrato_old_validate_rc_usuario__cb);
  } // do_ajax_form_jap_ruta_contrato_old_validate_rc_usuario_

  function do_ajax_form_jap_ruta_contrato_old_validate_rc_usuario__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rc_usuario_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rc_usuario_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rc_usuario_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rc_usuario_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_ruta_contrato_old_validate_rc_usuario__cb

  // ---------- Validate rc_num_medidor_
  function do_ajax_form_jap_ruta_contrato_old_validate_rc_num_medidor_(iNumLinha)
  {
    var nomeCampo_rc_num_medidor_ = "rc_num_medidor_" + iNumLinha;
    var var_rc_num_medidor_ = scAjaxGetFieldHidden(nomeCampo_rc_num_medidor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_ruta_contrato_old_validate_rc_num_medidor_(var_rc_num_medidor_, iNumLinha, var_script_case_init, do_ajax_form_jap_ruta_contrato_old_validate_rc_num_medidor__cb);
  } // do_ajax_form_jap_ruta_contrato_old_validate_rc_num_medidor_

  function do_ajax_form_jap_ruta_contrato_old_validate_rc_num_medidor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rc_num_medidor_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rc_num_medidor_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rc_num_medidor_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rc_num_medidor_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_ruta_contrato_old_validate_rc_num_medidor__cb

  // ---------- Event onchange rc_contrato_
  function do_ajax_form_jap_ruta_contrato_old_event_rc_contrato__onchange(iSeqForm)
  {
    var var_rc_contrato_ = scAjaxGetFieldHidden("rc_contrato_" + iSeqForm);
    var var_rc_cedula_ = scAjaxGetFieldHidden("rc_cedula_" + iSeqForm);
    var var_rc_usuario_ = scAjaxGetFieldHidden("rc_usuario_" + iSeqForm);
    var var_rc_num_medidor_ = scAjaxGetFieldHidden("rc_num_medidor_" + iSeqForm);
    var var_rc_num_contrato_ = scAjaxGetFieldHidden("rc_num_contrato_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_jap_ruta_contrato_old_event_rc_contrato__onchange(var_rc_contrato_, var_rc_cedula_, var_rc_usuario_, var_rc_num_medidor_, var_rc_num_contrato_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_jap_ruta_contrato_old_event_rc_contrato__onchange_cb);
  } // do_ajax_form_jap_ruta_contrato_old_event_rc_contrato__onchange

  function do_ajax_form_jap_ruta_contrato_old_event_rc_contrato__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_jap_ruta_contrato_old_event_rc_contrato__onchange_cb_after_alert);
  } // do_ajax_form_jap_ruta_contrato_old_event_rc_contrato__onchange_cb
  function do_ajax_form_jap_ruta_contrato_old_event_rc_contrato__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_jap_ruta_contrato_old_event_rc_contrato__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_jap_ruta_contrato_old_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_jap_ruta_contrato_old_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_jap_ruta_contrato_old_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_jap_ruta_contrato_old_add_new_line_cb);
  } // do_ajax_form_jap_ruta_contrato_old_add_new_line

  function do_ajax_form_jap_ruta_contrato_old_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_jap_ruta_contrato_old_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_jap_ruta_contrato_old_backup_line(iNumLinha)
  {
    var var_rc_id_ = scAjaxGetFieldHidden("rc_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_ruta_contrato_old_backup_line(var_rc_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_jap_ruta_contrato_old_backup_line_cb);
  } // do_ajax_form_jap_ruta_contrato_old_backup_line

  function do_ajax_form_jap_ruta_contrato_old_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_jap_ruta_contrato_old_backup_line_cb

  function do_ajax_form_jap_ruta_contrato_old_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_jap_ruta_contrato_old_cancel_insert

  function do_ajax_form_jap_ruta_contrato_old_cancel_update(iSeqVert)
  {
    do_ajax_form_jap_ruta_contrato_old_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_jap_ruta_contrato_old_cancel_update

  function do_ajax_form_jap_ruta_contrato_old_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_jap_ruta_contrato_old_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_jap_ruta_contrato_old_table_refresh()
  {
    var var_rc_id_ = document.F2.rc_id_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_jap_ruta_contrato_old_table_refresh(var_rc_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jap_ruta_contrato_old_table_refresh_cb);
  } //  do_ajax_form_jap_ruta_contrato_old_table_refresh

  function do_ajax_form_jap_ruta_contrato_old_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.rc_id_.value = scAjaxGetKeyValue("rc_id_");
    ...
    scAjaxAlert(do_ajax_form_jap_ruta_contrato_old_table_refresh_cb_after_alert);
  } // do_ajax_form_jap_ruta_contrato_old_table_refresh_cb
  function do_ajax_form_jap_ruta_contrato_old_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_jap_ruta_contrato_old_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_jap_ruta_contrato_old_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_jap_ruta_contrato_old_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_rc_id_ = scAjaxGetFieldHidden("rc_id_" + iNumLinha);
    var var_rc_ruta_ = scAjaxGetFieldText("rc_ruta_" + iNumLinha);
    var var_rc_orden_ = scAjaxGetFieldText("rc_orden_" + iNumLinha);
    var var_rc_contrato_ = scAjaxGetFieldHidden("rc_contrato_" + iNumLinha);
    var var_rc_num_contrato_ = scAjaxGetFieldHidden("rc_num_contrato_" + iNumLinha);
    var var_rc_cedula_ = scAjaxGetFieldHidden("rc_cedula_" + iNumLinha);
    var var_rc_usuario_ = scAjaxGetFieldHidden("rc_usuario_" + iNumLinha);
    var var_rc_num_medidor_ = scAjaxGetFieldHidden("rc_num_medidor_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_jap_ruta_contrato_old_submit_form(var_rc_id_, var_rc_ruta_, var_rc_orden_, var_rc_contrato_, var_rc_num_contrato_, var_rc_cedula_, var_rc_usuario_, var_rc_num_medidor_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_jap_ruta_contrato_old_submit_form_cb);
  } // do_ajax_form_jap_ruta_contrato_old_submit_form

  function do_ajax_form_jap_ruta_contrato_old_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("rc_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("rc_ruta_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("rc_orden_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("rc_contrato_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("rc_num_contrato_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("rc_cedula_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("rc_usuario_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("rc_num_medidor_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_jap_ruta_contrato_old_submit_form_cb_after_alert);
  } // do_ajax_form_jap_ruta_contrato_old_submit_form_cb
  function do_ajax_form_jap_ruta_contrato_old_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_jap_ruta_contrato_old_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_jap_ruta_contrato_old_navigate_form()
  {
    perform_ajax_form_jap_ruta_contrato_old_navigate_form();
  }

  function perform_ajax_form_jap_ruta_contrato_old_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_jap_ruta_contrato_old_cancel_insert(sc_form_jap_ruta_contrato_old_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("rc_id_" + iNavForm);
      scAjaxHideErrorDisplay("rc_ruta_" + iNavForm);
      scAjaxHideErrorDisplay("rc_orden_" + iNavForm);
      scAjaxHideErrorDisplay("rc_contrato_" + iNavForm);
      scAjaxHideErrorDisplay("rc_num_contrato_" + iNavForm);
      scAjaxHideErrorDisplay("rc_cedula_" + iNavForm);
      scAjaxHideErrorDisplay("rc_usuario_" + iNavForm);
      scAjaxHideErrorDisplay("rc_num_medidor_" + iNavForm);
    }
    var var_rc_id_ = document.F2.rc_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_jap_ruta_contrato_old_navigate_form(var_rc_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jap_ruta_contrato_old_navigate_form_cb);
  } // do_ajax_form_jap_ruta_contrato_old_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_ruta_contrato_old']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_jap_ruta_contrato_old_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.rc_id_.value = scAjaxGetKeyValue("rc_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_jap_ruta_contrato_old_navigate_form_cb_after_alert);
  } // do_ajax_form_jap_ruta_contrato_old_navigate_form_cb
  function do_ajax_form_jap_ruta_contrato_old_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_jap_ruta_contrato_old_navigate_form_cb_after_alert

    function sc_form_jap_ruta_contrato_old_get_last_line_number()
    {
    ...
    } //sc_form_jap_ruta_contrato_old_get_last_line_number

  function sc_hide_form_jap_ruta_contrato_old_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "rc_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rc_ruta_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rc_orden_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rc_contrato_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rc_num_contrato_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rc_cedula_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rc_usuario_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rc_num_medidor_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["rc_id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["rc_ruta_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_ruta'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["rc_orden_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_orden_ingreso'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["rc_contrato_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_contrato'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["rc_num_contrato_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_contrato'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["rc_cedula_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_lot_identificacion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["rc_usuario_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_cliente'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["rc_num_medidor_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_numero_medidor'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["rc_id_"][iNumLinha] = "rc_id_" + iNumLinha;
    ajax_field_mult["rc_ruta_"][iNumLinha] = "rc_ruta_" + iNumLinha;
    ajax_field_mult["rc_orden_"][iNumLinha] = "rc_orden_" + iNumLinha;
    ajax_field_mult["rc_contrato_"][iNumLinha] = "rc_contrato_" + iNumLinha;
    ajax_field_mult["rc_num_contrato_"][iNumLinha] = "rc_num_contrato_" + iNumLinha;
    ajax_field_mult["rc_cedula_"][iNumLinha] = "rc_cedula_" + iNumLinha;
    ajax_field_mult["rc_usuario_"][iNumLinha] = "rc_usuario_" + iNumLinha;
    ajax_field_mult["rc_num_medidor_"][iNumLinha] = "rc_num_medidor_" + iNumLinha;
    ajax_field_id["rc_orden_" + iNumLinha] = new Array("hidden_field_label_rc_orden_", "hidden_field_data_rc_orden_" + iNumLinha);
    ajax_field_id["rc_contrato_" + iNumLinha] = new Array("hidden_field_label_rc_contrato_", "hidden_field_data_rc_contrato_" + iNumLinha);
    ajax_field_id["rc_num_contrato_" + iNumLinha] = new Array("hidden_field_label_rc_num_contrato_", "hidden_field_data_rc_num_contrato_" + iNumLinha);
    ajax_field_id["rc_cedula_" + iNumLinha] = new Array("hidden_field_label_rc_cedula_", "hidden_field_data_rc_cedula_" + iNumLinha);
    ajax_field_id["rc_usuario_" + iNumLinha] = new Array("hidden_field_label_rc_usuario_", "hidden_field_data_rc_usuario_" + iNumLinha);
    ajax_field_id["rc_num_medidor_" + iNumLinha] = new Array("hidden_field_label_rc_num_medidor_", "hidden_field_data_rc_num_medidor_" + iNumLinha);
    ajax_error_count["rc_id_" + iNumLinha] = "off";
    ajax_error_count["rc_ruta_" + iNumLinha] = "off";
    ajax_error_count["rc_orden_" + iNumLinha] = "off";
    ajax_error_count["rc_contrato_" + iNumLinha] = "off";
    ajax_error_count["rc_num_contrato_" + iNumLinha] = "off";
    ajax_error_count["rc_cedula_" + iNumLinha] = "off";
    ajax_error_count["rc_usuario_" + iNumLinha] = "off";
    ajax_error_count["rc_num_medidor_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["rc_id_" + iNumLinha] = "on";
    ajax_read_only["rc_ruta_" + iNumLinha] = "off";
    ajax_read_only["rc_orden_" + iNumLinha] = "off";
    ajax_read_only["rc_contrato_" + iNumLinha] = "off";
    ajax_read_only["rc_num_contrato_" + iNumLinha] = "off";
    ajax_read_only["rc_cedula_" + iNumLinha] = "off";
    ajax_read_only["rc_usuario_" + iNumLinha] = "off";
    ajax_read_only["rc_num_medidor_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["rc_id_" + iNumLinha] = "on";
    ajax_read_only["rc_ruta_" + iNumLinha] = "on";
    ajax_read_only["rc_orden_" + iNumLinha] = "on";
    ajax_read_only["rc_contrato_" + iNumLinha] = "on";
    ajax_read_only["rc_num_contrato_" + iNumLinha] = "on";
    ajax_read_only["rc_cedula_" + iNumLinha] = "on";
    ajax_read_only["rc_usuario_" + iNumLinha] = "on";
    ajax_read_only["rc_num_medidor_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["rc_id_" + iNumLinha] = null;
    ajax_error_list["rc_ruta_" + iNumLinha] = null;
    ajax_error_list["rc_orden_" + iNumLinha] = null;
    ajax_error_list["rc_contrato_" + iNumLinha] = null;
    ajax_error_list["rc_num_contrato_" + iNumLinha] = null;
    ajax_error_list["rc_cedula_" + iNumLinha] = null;
    ajax_error_list["rc_usuario_" + iNumLinha] = null;
    ajax_error_list["rc_num_medidor_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    ...
    "rc_ruta_": new Array(),
    "rc_orden_": new Array(),
    "rc_contrato_": new Array(),
    "rc_num_contrato_": new Array(),
    "rc_cedula_": new Array(),
    "rc_usuario_": new Array(),
    "rc_num_medidor_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["rc_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rc_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rc_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rc_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rc_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["rc_ruta_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rc_ruta_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rc_ruta_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rc_ruta_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rc_ruta_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["rc_orden_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rc_orden_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rc_orden_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rc_orden_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rc_orden_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["rc_contrato_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rc_contrato_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rc_contrato_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rc_contrato_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rc_contrato_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["rc_num_contrato_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rc_num_contrato_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rc_num_contrato_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rc_num_contrato_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rc_num_contrato_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["rc_cedula_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rc_cedula_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rc_cedula_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rc_cedula_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rc_cedula_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["rc_usuario_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rc_usuario_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rc_usuario_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rc_usuario_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rc_usuario_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["rc_num_medidor_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rc_num_medidor_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rc_num_medidor_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rc_num_medidor_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rc_num_medidor_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rc_id_'])) ? $this->nmgp_cmp_readonly['rc_id_'] : 'on';
?>
    scAjaxFieldRead("rc_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rc_ruta_'])) ? $this->nmgp_cmp_readonly['rc_ruta_'] : 'off';
?>
    scAjaxFieldRead("rc_ruta_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rc_orden_'])) ? $this->nmgp_cmp_readonly['rc_orden_'] : 'off';
?>
    scAjaxFieldRead("rc_orden_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rc_contrato_'])) ? $this->nmgp_cmp_readonly['rc_contrato_'] : 'off';
?>
    scAjaxFieldRead("rc_contrato_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rc_num_contrato_'])) ? $this->nmgp_cmp_readonly['rc_num_contrato_'] : 'off';
?>
    scAjaxFieldRead("rc_num_contrato_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rc_cedula_'])) ? $this->nmgp_cmp_readonly['rc_cedula_'] : 'off';
?>
    scAjaxFieldRead("rc_cedula_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rc_usuario_'])) ? $this->nmgp_cmp_readonly['rc_usuario_'] : 'off';
?>
    scAjaxFieldRead("rc_usuario_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rc_num_medidor_'])) ? $this->nmgp_cmp_readonly['rc_num_medidor_'] : 'off';
?>
    scAjaxFieldRead("rc_num_medidor_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("rc_id_" + iSeq, "on");
    scAjaxFieldRead("rc_ruta_" + iSeq, "on");
    scAjaxFieldRead("rc_orden_" + iSeq, "on");
    scAjaxFieldRead("rc_contrato_" + iSeq, "on");
    scAjaxFieldRead("rc_num_contrato_" + iSeq, "on");
    scAjaxFieldRead("rc_cedula_" + iSeq, "on");
    scAjaxFieldRead("rc_usuario_" + iSeq, "on");
    scAjaxFieldRead("rc_num_medidor_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["rc_id_" + iRow] || "on" == ajax_error_count["rc_ruta_" + iRow] || "on" == ajax_error_count["rc_orden_" + iRow] || "on" == ajax_error_count["rc_contrato_" + iRow] || "on" == ajax_error_count["rc_num_contrato_" + iRow] || "on" == ajax_error_count["rc_cedula_" + iRow] || "on" == ajax_error_count["rc_usuario_" + iRow] || "on" == ajax_error_count["rc_num_medidor_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rc_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rc_ruta_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rc_orden_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rc_contrato_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rc_num_contrato_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rc_cedula_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rc_usuario_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rc_num_medidor_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["rc_id_" + iRow] && "off" == ajax_error_count["rc_ruta_" + iRow] && "off" == ajax_error_count["rc_orden_" + iRow] && "off" == ajax_error_count["rc_contrato_" + iRow] && "off" == ajax_error_count["rc_num_contrato_" + iRow] && "off" == ajax_error_count["rc_cedula_" + iRow] && "off" == ajax_error_count["rc_usuario_" + iRow] && "off" == ajax_error_count["rc_num_medidor_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["rc_id_" + iRow] = "off";
        ajax_error_count["rc_ruta_" + iRow] = "off";
        ajax_error_count["rc_orden_" + iRow] = "off";
        ajax_error_count["rc_contrato_" + iRow] = "off";
        ajax_error_count["rc_num_contrato_" + iRow] = "off";
        ajax_error_count["rc_cedula_" + iRow] = "off";
        ajax_error_count["rc_usuario_" + iRow] = "off";
        ajax_error_count["rc_num_medidor_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_rc_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_rc_ruta_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_rc_orden_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_rc_contrato_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_rc_num_contrato_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_rc_cedula_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_rc_usuario_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_rc_num_medidor_" + iRow).removeClass("scFormErrorLine");
    }
  }
