...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_fac_numero' + iSeqRow).bind('blur', function() { sc_control_autoriza_documento_fac_numero_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_control_autoriza_documento_fac_numero_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_control_autoriza_documento_fac_numero_onfocus(this, iSeqRow) });
  $('#id_sc_field_tipo' + iSeqRow).bind('blur', function() { sc_control_autoriza_documento_tipo_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_control_autoriza_documento_tipo_onchange(this, iSeqRow) })
                                  .bind('focus', function() { sc_control_autoriza_documento_tipo_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_control_autoriza_documento_fac_numero_onblur(oThis, iSeqRow) {
  do_ajax_control_autoriza_documento_validate_fac_numero();
  scCssBlur(oThis);
}

function sc_control_autoriza_documento_fac_numero_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_control_autoriza_documento_fac_numero_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_control_autoriza_documento_tipo_onblur(oThis, iSeqRow) {
  do_ajax_control_autoriza_documento_validate_tipo();
  scCssBlur(oThis);
}

function sc_control_autoriza_documento_tipo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_control_autoriza_documento_tipo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_control_autoriza_documento_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'control_autoriza_documento')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
