  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_cargo_inline" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sis_cargo_inline_form();
	}
...
?>
  ...
  function do_ajax_form_sis_cargo_inline_validate_car_descripcion_()
  {
    var nomeCampo_car_descripcion_ = "car_descripcion_";
    var var_car_descripcion_ = scAjaxGetFieldText(nomeCampo_car_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_cargo_inline_validate_car_descripcion_(var_car_descripcion_, var_script_case_init, do_ajax_form_sis_cargo_inline_validate_car_descripcion__cb);
  } // do_ajax_form_sis_cargo_inline_validate_car_descripcion_

  function do_ajax_form_sis_cargo_inline_validate_car_descripcion__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_cargo_inline_validate_car_descripcion__cb

  // ---------- Validate car_estado_
  function do_ajax_form_sis_cargo_inline_validate_car_estado_()
  {
    var nomeCampo_car_estado_ = "car_estado_";
    var var_car_estado_ = scAjaxGetFieldSelect(nomeCampo_car_estado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_cargo_inline_validate_car_estado_(var_car_estado_, var_script_case_init, do_ajax_form_sis_cargo_inline_validate_car_estado__cb);
  } // do_ajax_form_sis_cargo_inline_validate_car_estado_

  function do_ajax_form_sis_cargo_inline_validate_car_estado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_cargo_inline_validate_car_estado__cb

  // ---------- Validate car_id_
  function do_ajax_form_sis_cargo_inline_validate_car_id_()
  {
    var nomeCampo_car_id_ = "car_id_";
    var var_car_id_ = scAjaxGetFieldText(nomeCampo_car_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_cargo_inline_validate_car_id_(var_car_id_, var_script_case_init, do_ajax_form_sis_cargo_inline_validate_car_id__cb);
  } // do_ajax_form_sis_cargo_inline_validate_car_id_

  function do_ajax_form_sis_cargo_inline_validate_car_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "car_id_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_cargo_inline_validate_car_id__cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_sis_cargo_inline_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_sis_cargo_inline_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_car_descripcion_ = scAjaxGetFieldText("car_descripcion_");
    var var_car_estado_ = scAjaxGetFieldSelect("car_estado_");
    var var_car_id_ = scAjaxGetFieldText("car_id_");
    ...
    scAjaxProcOn();
    x_ajax_form_sis_cargo_inline_submit_form(var_car_descripcion_, var_car_estado_, var_car_id_, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_cargo_inline_submit_form_cb);
  } // do_ajax_form_sis_cargo_inline_submit_form

  function do_ajax_form_sis_cargo_inline_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("car_descripcion_");
      scAjaxHideErrorDisplay("car_estado_");
      scAjaxHideErrorDisplay("car_id_");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_sis_cargo_inline_submit_form_cb_after_alert);
  } // do_ajax_form_sis_cargo_inline_submit_form_cb
  function do_ajax_form_sis_cargo_inline_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_cargo_inline_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sis_cargo_inline_navigate_form()
  {
    perform_ajax_form_sis_cargo_inline_navigate_form();
  }

  function perform_ajax_form_sis_cargo_inline_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_sis_cargo_inline_navigate_form(var_car_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_cargo_inline_navigate_form_cb);
  } // do_ajax_form_sis_cargo_inline_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_cargo_inline']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_cargo_inline_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_cargo_inline_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_cargo_inline_navigate_form_cb
  function do_ajax_form_sis_cargo_inline_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_sis_cargo_inline_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_sis_cargo_inline_navigate_form_cb_after_alert

  function sc_hide_form_sis_cargo_inline_form()
  {
  ...
  ajax_field_list[0] = "car_descripcion_";
  ajax_field_list[1] = "car_estado_";
  ajax_field_list[2] = "car_id_";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "car_descripcion_": {"label": "<?php echo $this->Ini->Nm_lang['lang_cargo'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "car_estado_": {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "car_id_": {"label": "Car Id", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["car_descripcion_"][1] = "car_descripcion_";
  ajax_field_mult["car_estado_"][1] = "car_estado_";
  ajax_field_mult["car_id_"][1] = "car_id_";

  var ajax_field_id = {
    "car_descripcion_": new Array("hidden_field_label_car_descripcion_", "hidden_field_data_car_descripcion_"),
    "car_estado_": new Array("hidden_field_label_car_estado_", "hidden_field_data_car_estado_")
  };

  var ajax_read_only = {
    "car_descripcion_": "off",
    "car_estado_": "off",
    "car_id_": "on"
  };
