...
function scEventControl_onCalculator_df_cantidad() {
  if (!_scCalculatorControl["id_sc_field_df_cantidad"]) {
    ...
    do_ajax_form_detalle_factura_nueva_mob_event_df_cantidad_onblur();
  }
...
function scEventControl_onCalculator_df_precio_unitario() {
  if (!_scCalculatorControl["id_sc_field_df_precio_unitario"]) {
    ...
    do_ajax_form_detalle_factura_nueva_mob_event_df_precio_unitario_onblur();
  }
...
function scEventControl_onCalculator_df_descuento() {
  if (!_scCalculatorControl["id_sc_field_df_descuento"]) {
    ...
    do_ajax_form_detalle_factura_nueva_mob_event_df_descuento_onblur();
  }
...
function scHidePage(pageNo) {
	$("#id_form_detalle_factura_nueva_mob_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_detalle_factura_nueva_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
