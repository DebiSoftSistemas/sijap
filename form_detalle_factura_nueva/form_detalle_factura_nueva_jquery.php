...
function scEventControl_onCalculator_df_cantidad() {
  if (!_scCalculatorControl["id_sc_field_df_cantidad"]) {
    ...
    do_ajax_form_detalle_factura_nueva_event_df_cantidad_onblur();
  }
...
function scEventControl_onCalculator_df_precio_unitario() {
  if (!_scCalculatorControl["id_sc_field_df_precio_unitario"]) {
    ...
    do_ajax_form_detalle_factura_nueva_event_df_precio_unitario_onblur();
  }
...
function scEventControl_onCalculator_df_descuento() {
  if (!_scCalculatorControl["id_sc_field_df_descuento"]) {
    ...
    do_ajax_form_detalle_factura_nueva_event_df_descuento_onblur();
  }
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_df_id' + iSeqRow).bind('blur', function() { sc_form_detalle_factura_nueva_df_id_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_detalle_factura_nueva_df_id_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_detalle_factura_nueva_df_id_onfocus(this, iSeqRow) });
  $('#id_sc_field_df_factura' + iSeqRow).bind('blur', function() { sc_form_detalle_factura_nueva_df_factura_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_detalle_factura_nueva_df_factura_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_detalle_factura_nueva_df_factura_onfocus(this, iSeqRow) });
  $('#id_sc_field_df_empresa' + iSeqRow).bind('change', function() { sc_form_detalle_factura_nueva_df_empresa_onchange(this, iSeqRow) });
  $('#id_sc_field_df_producto' + iSeqRow).bind('blur', function() { sc_form_detalle_factura_nueva_df_producto_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_detalle_factura_nueva_df_producto_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_detalle_factura_nueva_df_producto_onfocus(this, iSeqRow) });
  $('#id_sc_field_df_descripcion' + iSeqRow).bind('blur', function() { sc_form_detalle_factura_nueva_df_descripcion_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_detalle_factura_nueva_df_descripcion_onchange(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_detalle_factura_nueva_df_descripcion_onfocus(this, iSeqRow) });
  $('#id_sc_field_df_cantidad' + iSeqRow).bind('blur', function() { sc_form_detalle_factura_nueva_df_cantidad_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_detalle_factura_nueva_df_cantidad_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_detalle_factura_nueva_df_cantidad_onfocus(this, iSeqRow) });
  $('#id_sc_field_df_precio_unitario' + iSeqRow).bind('blur', function() { sc_form_detalle_factura_nueva_df_precio_unitario_onblur(this, iSeqRow) })
                                                .bind('change', function() { sc_form_detalle_factura_nueva_df_precio_unitario_onchange(this, iSeqRow) })
                                                .bind('focus', function() { sc_form_detalle_factura_nueva_df_precio_unitario_onfocus(this, iSeqRow) });
  $('#id_sc_field_df_subtotal' + iSeqRow).bind('blur', function() { sc_form_detalle_factura_nueva_df_subtotal_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_detalle_factura_nueva_df_subtotal_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_detalle_factura_nueva_df_subtotal_onfocus(this, iSeqRow) });
  $('#id_sc_field_df_descuento' + iSeqRow).bind('blur', function() { sc_form_detalle_factura_nueva_df_descuento_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_detalle_factura_nueva_df_descuento_onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_detalle_factura_nueva_df_descuento_onfocus(this, iSeqRow) });
  $('#id_sc_field_df_base_iva' + iSeqRow).bind('blur', function() { sc_form_detalle_factura_nueva_df_base_iva_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_detalle_factura_nueva_df_base_iva_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_detalle_factura_nueva_df_base_iva_onfocus(this, iSeqRow) });
  $('#id_sc_field_df_porcentaje_iva' + iSeqRow).bind('blur', function() { sc_form_detalle_factura_nueva_df_porcentaje_iva_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_form_detalle_factura_nueva_df_porcentaje_iva_onchange(this, iSeqRow) })
                                               .bind('focus', function() { sc_form_detalle_factura_nueva_df_porcentaje_iva_onfocus(this, iSeqRow) });
  $('#id_sc_field_df_valor_iva' + iSeqRow).bind('blur', function() { sc_form_detalle_factura_nueva_df_valor_iva_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_detalle_factura_nueva_df_valor_iva_onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_detalle_factura_nueva_df_valor_iva_onfocus(this, iSeqRow) });
  $('#id_sc_field_df_base_ice' + iSeqRow).bind('blur', function() { sc_form_detalle_factura_nueva_df_base_ice_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_detalle_factura_nueva_df_base_ice_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_detalle_factura_nueva_df_base_ice_onfocus(this, iSeqRow) });
  $('#id_sc_field_df_porcentaje_ice' + iSeqRow).bind('blur', function() { sc_form_detalle_factura_nueva_df_porcentaje_ice_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_form_detalle_factura_nueva_df_porcentaje_ice_onchange(this, iSeqRow) })
                                               .bind('focus', function() { sc_form_detalle_factura_nueva_df_porcentaje_ice_onfocus(this, iSeqRow) });
  $('#id_sc_field_df_valor_ice' + iSeqRow).bind('blur', function() { sc_form_detalle_factura_nueva_df_valor_ice_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_detalle_factura_nueva_df_valor_ice_onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_detalle_factura_nueva_df_valor_ice_onfocus(this, iSeqRow) });
  $('#id_sc_field_df_base_irbpnr' + iSeqRow).bind('blur', function() { sc_form_detalle_factura_nueva_df_base_irbpnr_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_detalle_factura_nueva_df_base_irbpnr_onchange(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_detalle_factura_nueva_df_base_irbpnr_onfocus(this, iSeqRow) });
  $('#id_sc_field_df_porcentaje_irbpnr' + iSeqRow).bind('blur', function() { sc_form_detalle_factura_nueva_df_porcentaje_irbpnr_onblur(this, iSeqRow) })
                                                  .bind('change', function() { sc_form_detalle_factura_nueva_df_porcentaje_irbpnr_onchange(this, iSeqRow) })
                                                  .bind('focus', function() { sc_form_detalle_factura_nueva_df_porcentaje_irbpnr_onfocus(this, iSeqRow) });
  $('#id_sc_field_df_valor_irbpnr' + iSeqRow).bind('blur', function() { sc_form_detalle_factura_nueva_df_valor_irbpnr_onblur(this, iSeqRow) })
                                             .bind('change', function() { sc_form_detalle_factura_nueva_df_valor_irbpnr_onchange(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_detalle_factura_nueva_df_valor_irbpnr_onfocus(this, iSeqRow) });
  $('#id_sc_field_df_total' + iSeqRow).bind('blur', function() { sc_form_detalle_factura_nueva_df_total_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_detalle_factura_nueva_df_total_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_detalle_factura_nueva_df_total_onfocus(this, iSeqRow) });
  $('#id_sc_field_df_estado' + iSeqRow).bind('change', function() { sc_form_detalle_factura_nueva_df_estado_onchange(this, iSeqRow) });
  $('#id_sc_field_df_cantidad_nc' + iSeqRow).bind('blur', function() { sc_form_detalle_factura_nueva_df_cantidad_nc_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_detalle_factura_nueva_df_cantidad_nc_onchange(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_detalle_factura_nueva_df_cantidad_nc_onfocus(this, iSeqRow) });
  $('#id_sc_field_df_precio_sin_subsidio' + iSeqRow).bind('blur', function() { sc_form_detalle_factura_nueva_df_precio_sin_subsidio_onblur(this, iSeqRow) })
                                                    .bind('change', function() { sc_form_detalle_factura_nueva_df_precio_sin_subsidio_onchange(this, iSeqRow) })
                                                    .bind('focus', function() { sc_form_detalle_factura_nueva_df_precio_sin_subsidio_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_detalle_factura_nueva_df_id_onblur(oThis, iSeqRow) {
  do_ajax_form_detalle_factura_nueva_validate_df_id();
  scCssBlur(oThis);
}

function sc_form_detalle_factura_nueva_df_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_detalle_factura_nueva_df_id_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detalle_factura_nueva_df_factura_onblur(oThis, iSeqRow) {
  do_ajax_form_detalle_factura_nueva_validate_df_factura();
  scCssBlur(oThis);
}

function sc_form_detalle_factura_nueva_df_factura_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_detalle_factura_nueva_df_factura_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detalle_factura_nueva_df_empresa_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_detalle_factura_nueva_df_producto_onblur(oThis, iSeqRow) {
  do_ajax_form_detalle_factura_nueva_validate_df_producto();
  scCssBlur(oThis);
}

function sc_form_detalle_factura_nueva_df_producto_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_form_detalle_factura_nueva_event_df_producto_onchange();
}

function sc_form_detalle_factura_nueva_df_producto_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detalle_factura_nueva_df_descripcion_onblur(oThis, iSeqRow) {
  do_ajax_form_detalle_factura_nueva_validate_df_descripcion();
  scCssBlur(oThis);
}

function sc_form_detalle_factura_nueva_df_descripcion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_detalle_factura_nueva_df_descripcion_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detalle_factura_nueva_df_cantidad_onblur(oThis, iSeqRow) {
  do_ajax_form_detalle_factura_nueva_validate_df_cantidad();
  scCssBlur(oThis);
}

function sc_form_detalle_factura_nueva_df_cantidad_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_form_detalle_factura_nueva_event_df_cantidad_onchange();
}

function sc_form_detalle_factura_nueva_df_cantidad_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detalle_factura_nueva_df_precio_unitario_onblur(oThis, iSeqRow) {
  do_ajax_form_detalle_factura_nueva_validate_df_precio_unitario();
  scCssBlur(oThis);
}

function sc_form_detalle_factura_nueva_df_precio_unitario_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_form_detalle_factura_nueva_event_df_precio_unitario_onchange();
}

function sc_form_detalle_factura_nueva_df_precio_unitario_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detalle_factura_nueva_df_subtotal_onblur(oThis, iSeqRow) {
  do_ajax_form_detalle_factura_nueva_validate_df_subtotal();
  scCssBlur(oThis);
}

function sc_form_detalle_factura_nueva_df_subtotal_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_detalle_factura_nueva_df_subtotal_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detalle_factura_nueva_df_descuento_onblur(oThis, iSeqRow) {
  do_ajax_form_detalle_factura_nueva_validate_df_descuento();
  scCssBlur(oThis);
}

function sc_form_detalle_factura_nueva_df_descuento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_form_detalle_factura_nueva_event_df_descuento_onchange();
}

function sc_form_detalle_factura_nueva_df_descuento_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detalle_factura_nueva_df_base_iva_onblur(oThis, iSeqRow) {
  do_ajax_form_detalle_factura_nueva_validate_df_base_iva();
  scCssBlur(oThis);
}

function sc_form_detalle_factura_nueva_df_base_iva_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_detalle_factura_nueva_df_base_iva_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detalle_factura_nueva_df_porcentaje_iva_onblur(oThis, iSeqRow) {
  do_ajax_form_detalle_factura_nueva_validate_df_porcentaje_iva();
  scCssBlur(oThis);
}

function sc_form_detalle_factura_nueva_df_porcentaje_iva_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_detalle_factura_nueva_df_porcentaje_iva_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detalle_factura_nueva_df_valor_iva_onblur(oThis, iSeqRow) {
  do_ajax_form_detalle_factura_nueva_validate_df_valor_iva();
  scCssBlur(oThis);
}

function sc_form_detalle_factura_nueva_df_valor_iva_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_detalle_factura_nueva_df_valor_iva_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detalle_factura_nueva_df_base_ice_onblur(oThis, iSeqRow) {
  do_ajax_form_detalle_factura_nueva_validate_df_base_ice();
  scCssBlur(oThis);
}

function sc_form_detalle_factura_nueva_df_base_ice_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_detalle_factura_nueva_df_base_ice_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detalle_factura_nueva_df_porcentaje_ice_onblur(oThis, iSeqRow) {
  do_ajax_form_detalle_factura_nueva_validate_df_porcentaje_ice();
  scCssBlur(oThis);
}

function sc_form_detalle_factura_nueva_df_porcentaje_ice_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_detalle_factura_nueva_df_porcentaje_ice_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detalle_factura_nueva_df_valor_ice_onblur(oThis, iSeqRow) {
  do_ajax_form_detalle_factura_nueva_validate_df_valor_ice();
  scCssBlur(oThis);
}

function sc_form_detalle_factura_nueva_df_valor_ice_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_detalle_factura_nueva_df_valor_ice_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detalle_factura_nueva_df_base_irbpnr_onblur(oThis, iSeqRow) {
  do_ajax_form_detalle_factura_nueva_validate_df_base_irbpnr();
  scCssBlur(oThis);
}

function sc_form_detalle_factura_nueva_df_base_irbpnr_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_detalle_factura_nueva_df_base_irbpnr_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detalle_factura_nueva_df_porcentaje_irbpnr_onblur(oThis, iSeqRow) {
  do_ajax_form_detalle_factura_nueva_validate_df_porcentaje_irbpnr();
  scCssBlur(oThis);
}

function sc_form_detalle_factura_nueva_df_porcentaje_irbpnr_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_detalle_factura_nueva_df_porcentaje_irbpnr_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detalle_factura_nueva_df_valor_irbpnr_onblur(oThis, iSeqRow) {
  do_ajax_form_detalle_factura_nueva_validate_df_valor_irbpnr();
  scCssBlur(oThis);
}

function sc_form_detalle_factura_nueva_df_valor_irbpnr_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_detalle_factura_nueva_df_valor_irbpnr_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detalle_factura_nueva_df_total_onblur(oThis, iSeqRow) {
  do_ajax_form_detalle_factura_nueva_validate_df_total();
  scCssBlur(oThis);
}

function sc_form_detalle_factura_nueva_df_total_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_detalle_factura_nueva_df_total_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detalle_factura_nueva_df_estado_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_detalle_factura_nueva_df_cantidad_nc_onblur(oThis, iSeqRow) {
  do_ajax_form_detalle_factura_nueva_validate_df_cantidad_nc();
  scCssBlur(oThis);
}

function sc_form_detalle_factura_nueva_df_cantidad_nc_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_detalle_factura_nueva_df_cantidad_nc_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detalle_factura_nueva_df_precio_sin_subsidio_onblur(oThis, iSeqRow) {
  do_ajax_form_detalle_factura_nueva_validate_df_precio_sin_subsidio();
  scCssBlur(oThis);
}

function sc_form_detalle_factura_nueva_df_precio_sin_subsidio_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_detalle_factura_nueva_df_precio_sin_subsidio_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_detalle_factura_nueva_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_detalle_factura_nueva')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
