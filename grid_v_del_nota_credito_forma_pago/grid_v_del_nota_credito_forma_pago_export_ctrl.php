<?php
@session_start() ;
$_SESSION['scriptcase']['grid_v_del_nota_credito_forma_pago']['sc_process_barr'] = true;
require_once('../grid_v_del_nota_credito_forma_pago/index.php');
unset($_SESSION['scriptcase']['grid_v_del_nota_credito_forma_pago']['sc_process_barr']);
$ExportCtrl = new grid_v_del_nota_credito_forma_pago_export_control;
$ExportCtrl->Export_barr();

class grid_v_del_nota_credito_forma_pago_export_control
{
