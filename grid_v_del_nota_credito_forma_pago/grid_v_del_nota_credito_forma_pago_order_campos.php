...
<?php
   ...
   $Ord_Cmp = new grid_v_del_nota_credito_forma_pago_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_v_del_nota_credito_forma_pago_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_del_nota_credito_forma_pago']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_del_nota_credito_forma_pago']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['nc_fecha'] = "nc_fecha";
   $tab_labels["nc_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_nota_credito_forma_pago']['labels']["nc_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_nota_credito_forma_pago']['labels']["nc_fecha"] : "" . $this->Nm_lang['lang_fecha'] . "";
   $tab_ger_campos['nc_serie'] = "on";
   $tab_def_campos['nc_serie'] = "nc_serie";
   $tab_labels["nc_serie"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_nota_credito_forma_pago']['labels']["nc_serie"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_nota_credito_forma_pago']['labels']["nc_serie"] : "" . $this->Nm_lang['lang_serie_sri'] . "";
   $tab_ger_campos['nc_secuencial'] = "on";
   $tab_def_campos['nc_secuencial'] = "nc_secuencial";
   $tab_labels["nc_secuencial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_nota_credito_forma_pago']['labels']["nc_secuencial"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_nota_credito_forma_pago']['labels']["nc_secuencial"] : "" . $this->Nm_lang['lang_secuencial'] . "";
   $tab_ger_campos['cl_nombre'] = "on";
   $tab_def_campos['cl_nombre'] = "cl_nombre";
   $tab_labels["cl_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_nota_credito_forma_pago']['labels']["cl_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_nota_credito_forma_pago']['labels']["cl_nombre"] : "" . $this->Nm_lang['lang_nombre'] . "";
   $tab_ger_campos['cl_identificacion'] = "on";
   $tab_def_campos['cl_identificacion'] = "cl_identificacion";
   $tab_labels["cl_identificacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_nota_credito_forma_pago']['labels']["cl_identificacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_nota_credito_forma_pago']['labels']["cl_identificacion"] : "" . $this->Nm_lang['lang_lot_identificacion'] . "";
   $tab_ger_campos['nc_total'] = "on";
   $tab_def_campos['nc_total'] = "nc_total";
   $tab_labels["nc_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_nota_credito_forma_pago']['labels']["nc_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_nota_credito_forma_pago']['labels']["nc_total"] : "" . $this->Nm_lang['lang_othr_chrt_totl'] . " Nota Credito";
   $tab_ger_campos['fp_descripcion'] = "on";
   $tab_def_campos['fp_descripcion'] = "fp_descripcion";
   $tab_labels["fp_descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_nota_credito_forma_pago']['labels']["fp_descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_nota_credito_forma_pago']['labels']["fp_descripcion"] : "" . $this->Nm_lang['lang_forma_pago'] . "";
   $tab_ger_campos['fp_valor'] = "on";
   $tab_def_campos['fp_valor'] = "fp_valor";
   $tab_labels["fp_valor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_nota_credito_forma_pago']['labels']["fp_valor"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_nota_credito_forma_pago']['labels']["fp_valor"] : "" . $this->Nm_lang['lang_valor'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_nota_credito_forma_pago']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_v_del_nota_credito_forma_pago']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_v_del_nota_credito_forma_pago']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_del_nota_credito_forma_pago']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_del_nota_credito_forma_pago']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_v_del_nota_credito_forma_pago']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_v_del_nota_credito_forma_pago']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_v_del_nota_credito_forma_pago']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_nota_credito_forma_pago']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_v_del_nota_credito_forma_pago']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_v_del_nota_credito_forma_pago']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_v_del_nota_credito_forma_pago']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_v_del_nota_credito_forma_pago_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_v_del_nota_credito_forma_pago']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_v_del_nota_credito_forma_pago']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_v_del_nota_credito_forma_pago']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_v_del_nota_credito_forma_pago']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_v_del_nota_credito_forma_pago']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
