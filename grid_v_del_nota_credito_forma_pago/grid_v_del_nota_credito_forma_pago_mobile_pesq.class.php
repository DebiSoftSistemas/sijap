...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "nc_fecha";$Nm_numeric[] = "nc_numero";$Nm_numeric[] = "nc_ambiente";$Nm_numeric[] = "cl_id";$Nm_numeric[] = "nc_total";$Nm_numeric[] = "fp_valor";
...
?>
   <span id="idAjaxSelect_nc_serie">
      <SELECT class="scFilterObjectEven" id="SC_nc_serie" name="nc_serie[]"  size="7" multiple>
<?php
...
?>
 ...
 function limpa_form()
 {
   ...
   {
      if (document.F1.elements[i].name == 'nc_serie[]')
      {
