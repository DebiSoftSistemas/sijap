...
class grid_v_del_nota_credito_forma_pago_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_v_del_nota_credito_forma_pago_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_v_del_nota_credito_forma_pago_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_v_del_nota_credito_forma_pago_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         $nome_sum = "v_del_nota_credito_forma_pago.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_forma_pago'] ?> <?php echo $this->Ini->Nm_lang['lang_notas_credito'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_v_del_nota_credito_forma_pago/grid_v_del_nota_credito_forma_pago_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_v_del_nota_credito_forma_pago_ajax_search.js"></script>
 <script type="text/javascript" src="grid_v_del_nota_credito_forma_pago_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_v_del_nota_credito_forma_pago_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_v_del_nota_credito_forma_pago']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_v_del_nota_credito_forma_pago']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_nc_serie#NMF#' + search_get_Dselelect('SC_nc_serie_dest') + '@NMF@';
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $nc_fecha_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['nc_fecha_dia']; 
          $nc_fecha_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['nc_fecha_mes']; 
          $nc_fecha_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['nc_fecha_ano']; 
          $nc_fecha_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['nc_fecha_input_2_dia']; 
          $nc_fecha_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['nc_fecha_input_2_mes']; 
          $nc_fecha_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['nc_fecha_input_2_ano']; 
          $nc_fecha_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['nc_fecha_cond']; 
          $nc_serie = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['nc_serie']; 
          $nc_serie_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['nc_serie_cond']; 
          $fp_descripcion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['fp_descripcion']; 
          $fp_descripcion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['fp_descripcion_cond']; 
          $cl_nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['cl_nombre']; 
          $cl_nombre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['cl_nombre_cond']; 
          $cl_identificacion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['cl_identificacion']; 
          $cl_identificacion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['cl_identificacion_cond']; 
          $nc_usuario = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['nc_usuario']; 
          $nc_usuario_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['nc_usuario_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['NM_operador']; 
      } 
      ...
      if (is_array($nc_serie) && !empty($nc_serie))
      {
         $tmp_array = array();
         $nc_serie_val_str = "";
         foreach ($nc_serie as $tmp_val_cmp)
         {
            if ("" != $nc_serie_val_str)
            {
               $nc_serie_val_str .= ",";
...
?>
   <table style="padding: 0px; spacing: 0px; border-width: 0px;"><tr><td>
    <SELECT class="scFilterObjectEven" id="SC_nc_serie_orig" name="nc_serie_orig" size=7 multiple onDblClick="nm_add_sel('nc_serie_orig', 'nc_serie_dest', 'N' , '')">
<?php
...
<?php
      ...
      echo nmButtonOutput($this->arr_buttons, "bpassfld_rightall", "nm_add_all('nc_serie_orig', 'nc_serie_dest', 'N', '');", "nm_add_all('nc_serie_orig', 'nc_serie_dest', 'N', '');", "Bbpassfld_rightall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_right", "nm_add_sel('nc_serie_orig', 'nc_serie_dest', 'N', '');", "nm_add_sel('nc_serie_orig', 'nc_serie_dest', 'N', '');", "Bbpassfld_righ", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_left", "nm_del_sel('nc_serie_dest', 'nc_serie_orig', 'N', '');", "nm_del_sel('nc_serie_dest', 'nc_serie_orig', 'N', '');", "Bbpassfld_left", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_leftall", "nm_del_all('nc_serie_dest', 'nc_serie_orig', 'N', '');", "nm_del_all('nc_serie_dest', 'nc_serie_orig', 'N', '');", "Bbpassfld_leftall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
?>
   </td>
   <td>
    <SELECT class="scFilterObjectEven" id="SC_nc_serie_dest" name="nc_serie_dest" size=7 multiple  onDblClick="nm_del_sel('nc_serie_dest', 'nc_serie_orig', 'N' , '')">"
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
    ...
    <input type="hidden" id="SC_nc_serie" name="nc_serie" value="">
   </td></tr></table>
   <script type="text/javascript">document.F1.nc_serie_dest.selectedIndex = -1;</script>
<?php
?>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_v_del_nota_credito_forma_pago_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_v_del_nota_credito_forma_pago']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_v_del_nota_credito_forma_pago']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
   nm_pack('nc_serie_dest', 'nc_serie');
 ...
 function limpa_form()
 {
   ...
   nm_del_all('nc_serie_dest', 'nc_serie_orig', 'N', '');
 ...
 {
    $('#SC_nc_fecha_dia').bind('change', function() {sc_grid_v_del_nota_credito_forma_pago_valida_dia(this)});
    $('#SC_nc_fecha_input_2_dia').bind('change', function() {sc_grid_v_del_nota_credito_forma_pago_valida_dia(this)});
    $('#SC_nc_fecha_input_2_mes').bind('change', function() {sc_grid_v_del_nota_credito_forma_pago_valida_mes(this)});
    $('#SC_nc_fecha_mes').bind('change', function() {sc_grid_v_del_nota_credito_forma_pago_valida_mes(this)});
 }
 function sc_grid_v_del_nota_credito_forma_pago_valida_dia(obj)
 {
 ...
 function sc_grid_v_del_nota_credito_forma_pago_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_v_del_nota_credito_forma_pago/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function trata_campos()
   {
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca'] as $Cmps => $Vals)
          {
              if ($Cmps == 'nc_serie' || $Cmps == 'fp_descripcion' || $Cmps == 'nc_usuario')
              {
                  $$Cmps = implode("@?@", $Vals);
              }
              else
      ...
      if (is_array($nc_serie)) {
          foreach ($nc_serie as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['psq_check_ret']['nc_serie'])) {
      ...
      if (is_array($fp_descripcion)) {
          foreach ($fp_descripcion as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['psq_check_ret']['fp_descripcion'])) {
      ...
      if (is_array($nc_usuario)) {
          foreach ($nc_usuario as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['psq_check_ret']['nc_usuario'])) {
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['nc_fecha_dia'] = $nc_fecha_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['nc_fecha_mes'] = $nc_fecha_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['nc_fecha_ano'] = $nc_fecha_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['nc_fecha_input_2_dia'] = $nc_fecha_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['nc_fecha_input_2_mes'] = $nc_fecha_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['nc_fecha_input_2_ano'] = $nc_fecha_input_2_ano; 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $nc_fecha_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $nc_fecha_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $nc_fecha_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $nc_fecha_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $nc_fecha_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $nc_fecha_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['nc_fecha_cond'] = $nc_fecha_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['Grid_search'][$I_Grid]['cmp'] = "nc_fecha"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['Grid_search'][$I_Grid]['opc'] = $nc_fecha_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq']['nc_fecha'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['nc_serie'] = $nc_serie; 
      if (is_array($nc_serie) && !empty($nc_serie))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['Grid_search'][$I_Grid]['val'][0] = $nc_serie;
      }
      elseif ($nc_serie_cond_salva == "nu" || $nc_serie_cond_salva == "nn" || $nc_serie_cond_salva == "ep" || $nc_serie_cond_salva == "ne" || !empty($nc_serie))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['Grid_search'][$I_Grid]['val'][0][0] = $nc_serie;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['nc_serie_cond'] = $nc_serie_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['Grid_search'][$I_Grid]['cmp'] = "nc_serie"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['Grid_search'][$I_Grid]['opc'] = $nc_serie_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq']['nc_serie'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['fp_descripcion'] = $fp_descripcion; 
      if (is_array($fp_descripcion) && !empty($fp_descripcion))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['Grid_search'][$I_Grid]['val'][0] = $fp_descripcion;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['Grid_search'][$I_Grid]['val'][0][0] = $fp_descripcion;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['fp_descripcion_cond'] = $fp_descripcion_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['Grid_search'][$I_Grid]['cmp'] = "fp_descripcion"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['Grid_search'][$I_Grid]['opc'] = $fp_descripcion_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq']['fp_descripcion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['cl_nombre'] = $cl_nombre; 
      if (is_array($cl_nombre) && !empty($cl_nombre))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['Grid_search'][$I_Grid]['val'][0] = $cl_nombre;
      }
      elseif ($cl_nombre_cond_salva == "nu" || $cl_nombre_cond_salva == "nn" || $cl_nombre_cond_salva == "ep" || $cl_nombre_cond_salva == "ne" || !empty($cl_nombre))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['Grid_search'][$I_Grid]['val'][0][0] = $cl_nombre;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['cl_nombre_cond'] = $cl_nombre_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['Grid_search'][$I_Grid]['cmp'] = "cl_nombre"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['Grid_search'][$I_Grid]['opc'] = $cl_nombre_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq']['cl_nombre'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['cl_identificacion'] = $cl_identificacion; 
      if (is_array($cl_identificacion) && !empty($cl_identificacion))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['Grid_search'][$I_Grid]['val'][0] = $cl_identificacion;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['Grid_search'][$I_Grid]['val'][0][0] = $cl_identificacion;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['cl_identificacion_cond'] = $cl_identificacion_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['Grid_search'][$I_Grid]['cmp'] = "cl_identificacion"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['Grid_search'][$I_Grid]['opc'] = $cl_identificacion_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq']['cl_identificacion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['nc_usuario'] = $nc_usuario; 
      if (is_array($nc_usuario) && !empty($nc_usuario))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['Grid_search'][$I_Grid]['val'][0] = $nc_usuario;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['Grid_search'][$I_Grid]['val'][0][0] = $nc_usuario;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['nc_usuario_cond'] = $nc_usuario_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['Grid_search'][$I_Grid]['cmp'] = "nc_usuario"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['Grid_search'][$I_Grid]['opc'] = $nc_usuario_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq']['nc_usuario'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $this->cmp_formatado['nc_serie'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['nc_serie'];
      $this->cmp_formatado['nc_serie_input_2'] = $nc_serie_input_2;
      $this->cmp_formatado['fp_descripcion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['fp_descripcion'];
    ...
    if ($cl_identificacion != '') {
      ...
      $this->cmp_formatado['nc_usuario'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['nc_usuario'];
      ...
      if ($nc_fecha_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['nc_fecha'] = $val[0];
          ...
          if ($nc_fecha_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']['nc_fecha_input_2'] = $val[1];
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq']['nc_fecha']['label'] = $nmgp_tab_label['nc_fecha'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq']['nc_fecha']['descr'] = $nmgp_tab_label['nc_fecha'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq']['nc_fecha']['hint']  = $nmgp_tab_label['nc_fecha'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }

      //----- $nc_serie
      $this->Date_part = false;
      $nm_aspas = "'";
      if ($nc_serie_cond == "nu" || $nc_serie_cond == "nn" || $nc_serie_cond == "ep" || $nc_serie_cond == "ne")
      {
          $nc_serie = array();
      }
      if (is_array($nc_serie) && count($nc_serie) != 0)
      {
         foreach ($nc_serie as $i => $dados)
         {
      ...
      if (is_array($nc_serie) && count($nc_serie) != 0)
      {
         ...
         $lim_descr   = 15;
         $lang_descr  = strlen($this->Ini->Nm_lang['lang_srch_orr_cond']);
         if ($nc_serie_cond == "df" || $nc_serie_cond == "np")
         {
             $this->comando        .= " nc_serie not in (";
             $this->comando_sum    .= " v_del_nota_credito_forma_pago.nc_serie not in (";
             $this->comando_filtro .= " nc_serie not in (";
         }
         else
         {
             $this->comando        .= " nc_serie in (";
             $this->comando_sum    .= " v_del_nota_credito_forma_pago.nc_serie in (";
             $this->comando_filtro .= " nc_serie in (";
         }
         $x                     = count($nc_serie);
         $xx                    = 0;
         $nm_cond               = "";
         foreach ($nc_serie as $i => $dados)
         {
            ...
            elseif (!$end_descr)
            {
                 $cond_descr .= " +" . (count($nc_serie) - $count_descr);
                 $end_descr = true;
            };
            if ($xx != ($x - 1))
            {
         ...
         $Lang_descr_final = isset($Lang_descr[$nc_serie_cond]) ? $Lang_descr[$nc_serie_cond] : $this->Ini->Nm_lang['lang_srch_like'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['cond_pesq'] .= $nmgp_tab_label['nc_serie'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq']['nc_serie']['label'] = $nmgp_tab_label['nc_serie'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq']['nc_serie']['descr'] = $nmgp_tab_label['nc_serie'] . ": " . $Lang_descr_final . " " . $cond_descr;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq']['nc_serie']['hint'] = $nmgp_tab_label['nc_serie'] . ": " . $Lang_descr_final . " " . $nm_cond;
      }
      elseif (isset($nc_serie) && ($nc_serie_cond == "nu" || $nc_serie_cond == "nn" || $nc_serie_cond == "ep" || $nc_serie_cond == "ne"))
      {
         $this->monta_condicao("nc_serie", $nc_serie_cond, "", "", "nc_serie", "TEXT", false);
      }
      ...
      if (is_array($fp_descripcion) && count($fp_descripcion) != 0)
      {
         ...
         {
             $this->comando        .= " fp_descripcion not in (";
             $this->comando_sum    .= " v_del_nota_credito_forma_pago.fp_descripcion not in (";
             $this->comando_filtro .= " fp_descripcion not in (";
         }
         else
         {
             $this->comando        .= " fp_descripcion in (";
             $this->comando_sum    .= " v_del_nota_credito_forma_pago.fp_descripcion in (";
             $this->comando_filtro .= " fp_descripcion in (";
         }
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['cond_pesq'] .= $nmgp_tab_label['fp_descripcion'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq']['fp_descripcion']['label'] = $nmgp_tab_label['fp_descripcion'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq']['fp_descripcion']['descr'] = $nmgp_tab_label['fp_descripcion'] . ": " . $Lang_descr_final . " " . $cond_descr;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq']['fp_descripcion']['hint'] = $nmgp_tab_label['fp_descripcion'] . ": " . $Lang_descr_final . " " . $nm_cond;
      }
      ...
      if (is_array($nc_usuario) && count($nc_usuario) != 0)
      {
         ...
         if ($nc_usuario_cond == "df" || $nc_usuario_cond == "np")
         {
             ...
             $this->comando_sum    .= " v_del_nota_credito_forma_pago.nc_usuario not in (";
             $this->comando_filtro .= " nc_usuario not in (";
         }
         else
         {
             $this->comando        .= " nc_usuario in (";
             $this->comando_sum    .= " v_del_nota_credito_forma_pago.nc_usuario in (";
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['cond_pesq'] .= $nmgp_tab_label['nc_usuario'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq']['nc_usuario']['label'] = $nmgp_tab_label['nc_usuario'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq']['nc_usuario']['descr'] = $nmgp_tab_label['nc_usuario'] . ": " . $Lang_descr_final . " " . $cond_descr;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['grid_pesq']['nc_usuario']['hint'] = $nmgp_tab_label['nc_usuario'] . ": " . $Lang_descr_final . " " . $nm_cond;
      }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_del_nota_credito_forma_pago']['cond_pesq'] .= $this->NM_operador;
