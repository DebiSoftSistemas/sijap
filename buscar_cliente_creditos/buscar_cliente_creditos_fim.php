...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIJAP_____buscar_cliente_creditos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIJAP_____buscar_cliente_creditos"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['buscar_cliente_creditos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['buscar_cliente_creditos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['buscar_cliente_creditos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['buscar_cliente_creditos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['buscar_cliente_creditos']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>buscar_cliente_creditos</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['buscar_cliente_creditos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['buscar_cliente_creditos']['embutida_filho'] as $ind => $sc_init)
          {
