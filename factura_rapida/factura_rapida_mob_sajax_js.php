  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_factura_rapida_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_factura_rapida_mob_form();
	}
...
?>
  ...
  // ---------- Validate imagen
  function do_ajax_factura_rapida_mob_validate_imagen()
  {
  } // do_ajax_factura_rapida_mob_validate_imagen

  function do_ajax_factura_rapida_mob_validate_imagen_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_factura_rapida_mob_validate_imagen_cb

  // ---------- Validate login
  function do_ajax_factura_rapida_mob_validate_login()
  {
    var nomeCampo_login = "login";
    var var_login = scAjaxGetFieldText(nomeCampo_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_factura_rapida_mob_validate_login(var_login, var_script_case_init, do_ajax_factura_rapida_mob_validate_login_cb);
  } // do_ajax_factura_rapida_mob_validate_login

  function do_ajax_factura_rapida_mob_validate_login_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "login";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_factura_rapida_mob_validate_login_cb

  // ---------- Validate vacio
  function do_ajax_factura_rapida_mob_validate_vacio()
  {
    var nomeCampo_vacio = "vacio";
    var var_vacio = scAjaxGetFieldHidden(nomeCampo_vacio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_factura_rapida_mob_validate_vacio(var_vacio, var_script_case_init, do_ajax_factura_rapida_mob_validate_vacio_cb);
  } // do_ajax_factura_rapida_mob_validate_vacio

  function do_ajax_factura_rapida_mob_validate_vacio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "vacio";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_factura_rapida_mob_validate_vacio_cb

  // ---------- Validate password
  function do_ajax_factura_rapida_mob_validate_password()
  {
    var nomeCampo_password = "password";
    var var_password = scAjaxGetFieldText(nomeCampo_password);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_factura_rapida_mob_validate_password(var_password, var_script_case_init, do_ajax_factura_rapida_mob_validate_password_cb);
  } // do_ajax_factura_rapida_mob_validate_password

  function do_ajax_factura_rapida_mob_validate_password_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_factura_rapida_mob_validate_password_cb

  // ---------- Validate mostrar
  function do_ajax_factura_rapida_mob_validate_mostrar()
  {
    var nomeCampo_mostrar = "mostrar";
    var var_mostrar = scAjaxGetFieldCheckbox(nomeCampo_mostrar, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_factura_rapida_mob_validate_mostrar(var_mostrar, var_script_case_init, do_ajax_factura_rapida_mob_validate_mostrar_cb);
  } // do_ajax_factura_rapida_mob_validate_mostrar

  function do_ajax_factura_rapida_mob_validate_mostrar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mostrar";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_factura_rapida_mob_validate_mostrar_cb

  // ---------- Validate idioma
  function do_ajax_factura_rapida_mob_validate_idioma()
  {
    var nomeCampo_idioma = "idioma";
    var var_idioma = scAjaxGetFieldText(nomeCampo_idioma);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_factura_rapida_mob_validate_idioma(var_idioma, var_script_case_init, do_ajax_factura_rapida_mob_validate_idioma_cb);
  } // do_ajax_factura_rapida_mob_validate_idioma

  function do_ajax_factura_rapida_mob_validate_idioma_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idioma";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_factura_rapida_mob_validate_idioma_cb

  // ---------- Event onclick mostrar
  function do_ajax_factura_rapida_mob_event_mostrar_onclick()
  {
    var var_mostrar = scAjaxGetFieldCheckbox("mostrar", ";");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_factura_rapida_mob_event_mostrar_onclick(var_mostrar, var_script_case_init, do_ajax_factura_rapida_mob_event_mostrar_onclick_cb);
  } // do_ajax_factura_rapida_mob_event_mostrar_onclick

  function do_ajax_factura_rapida_mob_event_mostrar_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "mostrar";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_factura_rapida_mob_event_mostrar_onclick_cb_after_alert);
  } // do_ajax_factura_rapida_mob_event_mostrar_onclick_cb
  function do_ajax_factura_rapida_mob_event_mostrar_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_factura_rapida_mob_event_mostrar_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_factura_rapida_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_factura_rapida_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_factura_rapida_mob_submit_form(var_imagen, var_login, var_vacio, var_password, var_mostrar, var_idioma, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_factura_rapida_mob_submit_form_cb);
  } // do_ajax_factura_rapida_mob_submit_form

  function do_ajax_factura_rapida_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_factura_rapida_mob_submit_form_cb_after_alert);
  } // do_ajax_factura_rapida_mob_submit_form_cb
  function do_ajax_factura_rapida_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_factura_rapida_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_factura_rapida_mob_navigate_form()
  {
    perform_ajax_factura_rapida_mob_navigate_form();
  }

  function perform_ajax_factura_rapida_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_factura_rapida_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['factura_rapida_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_factura_rapida_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_factura_rapida_mob_navigate_form_cb_after_alert);
  } // do_ajax_factura_rapida_mob_navigate_form_cb
  function do_ajax_factura_rapida_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scFocusField('login');
...
{
?>
    do_ajax_factura_rapida_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_factura_rapida_mob_navigate_form_cb_after_alert

  function sc_hide_factura_rapida_mob_form()
  {
  ...
  var ajax_error_list = {
    ...
    "mostrar": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
