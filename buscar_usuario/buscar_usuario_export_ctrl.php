<?php
@session_start() ;
$_SESSION['scriptcase']['buscar_usuario']['sc_process_barr'] = true;
require_once('../buscar_usuario/index.php');
unset($_SESSION['scriptcase']['buscar_usuario']['sc_process_barr']);
$ExportCtrl = new buscar_usuario_export_control;
$ExportCtrl->Export_barr();

class buscar_usuario_export_control
{
