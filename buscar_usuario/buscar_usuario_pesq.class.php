...
class buscar_usuario_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . buscar_usuario_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . buscar_usuario_pack_protect_string($Tipo_filter[0]) . "\">.." . buscar_usuario_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_usu_usuario')
      {
          $usu_usuario = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_usu_usuario($usu_usuario);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_usu_nombre')
      {
          $usu_nombre = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_usu_nombre($usu_nombre);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_usu_cedula')
      {
          $usu_cedula = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_usu_cedula($usu_cedula);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_usu_email')
      {
          $usu_email = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_usu_email($usu_email);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_usuario'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>buscar_usuario/buscar_usuario_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="buscar_usuario_ajax_search.js"></script>
 <script type="text/javascript" src="buscar_usuario_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="buscar_usuario_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['buscar_usuario']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['buscar_usuario']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_usu_usuario_cond#NMF#' + search_get_sel_txt('SC_usu_usuario_cond') + '@NMF@';
  str_out += 'SC_usu_usuario#NMF#' + search_get_text('SC_usu_usuario') + '@NMF@';
  str_out += 'id_ac_usu_usuario#NMF#' + search_get_title('select2-id_ac_usu_usuario-container') + '@NMF@';
  str_out += 'SC_usu_nombre_cond#NMF#' + search_get_sel_txt('SC_usu_nombre_cond') + '@NMF@';
  str_out += 'SC_usu_nombre#NMF#' + search_get_text('SC_usu_nombre') + '@NMF@';
  str_out += 'id_ac_usu_nombre#NMF#' + search_get_title('select2-id_ac_usu_nombre-container') + '@NMF@';
  str_out += 'SC_usu_cedula_cond#NMF#' + search_get_sel_txt('SC_usu_cedula_cond') + '@NMF@';
  str_out += 'SC_usu_cedula#NMF#' + search_get_text('SC_usu_cedula') + '@NMF@';
  str_out += 'id_ac_usu_cedula#NMF#' + search_get_title('select2-id_ac_usu_cedula-container') + '@NMF@';
  str_out += 'SC_usu_email_cond#NMF#' + search_get_sel_txt('SC_usu_email_cond') + '@NMF@';
  str_out += 'SC_usu_email#NMF#' + search_get_text('SC_usu_email') + '@NMF@';
  str_out += 'id_ac_usu_email#NMF#' + search_get_title('select2-id_ac_usu_email-container') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-usu_usuario").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_usu_usuario",
      max_itens: "10",
   ...
   $("#SC_usu_usuario").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-usu_nombre").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_usu_nombre",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_usu_nombre").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-usu_cedula").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_usu_cedula",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_usu_cedula").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-usu_email").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_usu_email",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_usu_email").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $usu_usuario_cond, $usu_usuario, $usu_usuario_autocomp,
             $usu_nombre_cond, $usu_nombre, $usu_nombre_autocomp,
             $usu_cedula_cond, $usu_cedula, $usu_cedula_autocomp,
             $usu_email_cond, $usu_email, $usu_email_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $usu_usuario = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['campos_busca']['usu_usuario']; 
          $usu_usuario_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['campos_busca']['usu_usuario_cond']; 
          $usu_nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['campos_busca']['usu_nombre']; 
          $usu_nombre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['campos_busca']['usu_nombre_cond']; 
          $usu_cedula = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['campos_busca']['usu_cedula']; 
          $usu_cedula_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['campos_busca']['usu_cedula_cond']; 
          $usu_email = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['campos_busca']['usu_email']; 
          $usu_email_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['campos_busca']['usu_email_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['campos_busca']['NM_operador']; 
      } 
      if (!isset($usu_usuario_cond) || empty($usu_usuario_cond))
      {
         $usu_usuario_cond = "qp";
      }
      if (!isset($usu_nombre_cond) || empty($usu_nombre_cond))
      {
         $usu_nombre_cond = "qp";
      }
      if (!isset($usu_cedula_cond) || empty($usu_cedula_cond))
      {
         $usu_cedula_cond = "qp";
      }
      if (!isset($usu_email_cond) || empty($usu_email_cond))
      {
         $usu_email_cond = "qp";
      }
      ...
      $str_hide_usu_usuario = (in_array($usu_usuario_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_usu_nombre = (in_array($usu_nombre_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_usu_cedula = (in_array($usu_cedula_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_usu_email = (in_array($usu_email_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($usu_usuario) || $usu_usuario == "")
      {
          $usu_usuario = "";
      }
      if (isset($usu_usuario) && !empty($usu_usuario))
      {
         $tmp_pos = (is_string($usu_usuario)) ? strpos($usu_usuario, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $usu_usuario = substr($usu_usuario, 0, $tmp_pos);
         }
      }
      if (!isset($usu_nombre) || $usu_nombre == "")
      {
          $usu_nombre = "";
      }
      if (isset($usu_nombre) && !empty($usu_nombre))
      {
         $tmp_pos = (is_string($usu_nombre)) ? strpos($usu_nombre, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $usu_nombre = substr($usu_nombre, 0, $tmp_pos);
         }
      }
      if (!isset($usu_cedula) || $usu_cedula == "")
      {
          $usu_cedula = "";
      }
      if (isset($usu_cedula) && !empty($usu_cedula))
      {
         $tmp_pos = (is_string($usu_cedula)) ? strpos($usu_cedula, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $usu_cedula = substr($usu_cedula, 0, $tmp_pos);
         }
      }
      if (!isset($usu_email) || $usu_email == "")
      {
          $usu_email = "";
      }
      if (isset($usu_email) && !empty($usu_email))
      {
         $tmp_pos = (is_string($usu_email)) ? strpos($usu_email, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $usu_email = substr($usu_email, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_usu_usuario_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['usu_usuario'])) ? $this->New_label['usu_usuario'] : "Usu Usuario"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_usu_usuario_cond" name="usu_usuario_cond" onChange="nm_campos_between(document.getElementById('id_vis_usu_usuario'), this, 'usu_usuario')">
       <OPTION value="qp" <?php if ("qp" == $usu_usuario_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $usu_usuario_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $usu_usuario_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $usu_usuario_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_usu_usuario" <?php echo $str_hide_usu_usuario?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['usu_usuario'])) ? $this->New_label['usu_usuario'] : "Usu Usuario";
 $nmgp_tab_label .= "usu_usuario?#?" . $SC_Label . "?@?";
...
<?php
      ...
      {
          $sAutocompValue = $usu_usuario;
      }
?>
<INPUT  type="text" id="SC_usu_usuario" name="usu_usuario" value="<?php echo NM_encode_input($usu_usuario) ?>"  size=35 alt="{datatype: 'text', maxLength: 35, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-usu_usuario" id="id_ac_usu_usuario" name="usu_usuario_autocomp"><?php if ('' !=  $usu_usuario) { ?><option value="<?php echo $usu_usuario ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_usu_nombre_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['usu_nombre'])) ? $this->New_label['usu_nombre'] : "Usu Nombre"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_usu_nombre_cond" name="usu_nombre_cond" onChange="nm_campos_between(document.getElementById('id_vis_usu_nombre'), this, 'usu_nombre')">
       <OPTION value="qp" <?php if ("qp" == $usu_nombre_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $usu_nombre_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $usu_nombre_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $usu_nombre_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_usu_nombre" <?php echo $str_hide_usu_nombre?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['usu_nombre'])) ? $this->New_label['usu_nombre'] : "Usu Nombre";
 $nmgp_tab_label .= "usu_nombre?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $usu_nombre;
      }
?>
<INPUT  type="text" id="SC_usu_nombre" name="usu_nombre" value="<?php echo NM_encode_input($usu_nombre) ?>"  size=50 alt="{datatype: 'text', maxLength: 200, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-usu_nombre" id="id_ac_usu_nombre" name="usu_nombre_autocomp"><?php if ('' !=  $usu_nombre) { ?><option value="<?php echo $usu_nombre ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_usu_cedula_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['usu_cedula'])) ? $this->New_label['usu_cedula'] : "Usu Cedula"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_usu_cedula_cond" name="usu_cedula_cond" onChange="nm_campos_between(document.getElementById('id_vis_usu_cedula'), this, 'usu_cedula')">
       <OPTION value="qp" <?php if ("qp" == $usu_cedula_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $usu_cedula_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $usu_cedula_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $usu_cedula_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_usu_cedula" <?php echo $str_hide_usu_cedula?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['usu_cedula'])) ? $this->New_label['usu_cedula'] : "Usu Cedula";
 $nmgp_tab_label .= "usu_cedula?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $usu_cedula;
      }
?>
<INPUT  type="text" id="SC_usu_cedula" name="usu_cedula" value="<?php echo NM_encode_input($usu_cedula) ?>"  size=13 alt="{datatype: 'text', maxLength: 13, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-usu_cedula" id="id_ac_usu_cedula" name="usu_cedula_autocomp"><?php if ('' !=  $usu_cedula) { ?><option value="<?php echo $usu_cedula ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_usu_email_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['usu_email'])) ? $this->New_label['usu_email'] : "Usu Email"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_usu_email_cond" name="usu_email_cond" onChange="nm_campos_between(document.getElementById('id_vis_usu_email'), this, 'usu_email')">
       <OPTION value="qp" <?php if ("qp" == $usu_email_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $usu_email_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $usu_email_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $usu_email_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_usu_email" <?php echo $str_hide_usu_email?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['usu_email'])) ? $this->New_label['usu_email'] : "Usu Email";
 $nmgp_tab_label .= "usu_email?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $usu_email;
      }
?>
<INPUT  type="text" id="SC_usu_email" name="usu_email" value="<?php echo NM_encode_input($usu_email) ?>"  size=50 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-usu_email" id="id_ac_usu_email" name="usu_email_autocomp"><?php if ('' !=  $usu_email) { ?><option value="<?php echo $usu_email ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("buscar_usuario_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['buscar_usuario']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['buscar_usuario']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.usu_usuario_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_usu_usuario'), document.F1.usu_usuario_cond, 'usu_usuario');
   document.F1.usu_usuario.value = "";
   document.F1.usu_usuario_autocomp.value = "";
   $('#select2-id_ac_usu_usuario-container').html('<?php echo $this->Val_init_usu_usuario['desc'] ?>');;
   document.F1.usu_nombre_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_usu_nombre'), document.F1.usu_nombre_cond, 'usu_nombre');
   document.F1.usu_nombre.value = "";
   document.F1.usu_nombre_autocomp.value = "";
   $('#select2-id_ac_usu_nombre-container').html('<?php echo $this->Val_init_usu_nombre['desc'] ?>');;
   document.F1.usu_cedula_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_usu_cedula'), document.F1.usu_cedula_cond, 'usu_cedula');
   document.F1.usu_cedula.value = "";
   document.F1.usu_cedula_autocomp.value = "";
   $('#select2-id_ac_usu_cedula-container').html('<?php echo $this->Val_init_usu_cedula['desc'] ?>');;
   document.F1.usu_email_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_usu_email'), document.F1.usu_email_cond, 'usu_email');
   document.F1.usu_email.value = "";
   document.F1.usu_email_autocomp.value = "";
   $('#select2-id_ac_usu_email-container').html('<?php echo $this->Val_init_usu_email['desc'] ?>');;
   Sc_carga_select2('all');
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_usu_usuario_cond'] = 'cond';
      $tp_fields['SC_usu_usuario'] = 'text_aut';
      $tp_fields['id_ac_usu_usuario'] = 'select2_aut';
      $tp_fields['SC_usu_nombre_cond'] = 'cond';
      $tp_fields['SC_usu_nombre'] = 'text_aut';
      $tp_fields['id_ac_usu_nombre'] = 'select2_aut';
      $tp_fields['SC_usu_cedula_cond'] = 'cond';
      $tp_fields['SC_usu_cedula'] = 'text_aut';
      $tp_fields['id_ac_usu_cedula'] = 'select2_aut';
      $tp_fields['SC_usu_email_cond'] = 'cond';
      $tp_fields['SC_usu_email'] = 'text_aut';
      $tp_fields['id_ac_usu_email'] = 'select2_aut';
   ...
   {
      global $usu_usuario_cond, $usu_usuario, $usu_usuario_autocomp,
             $usu_nombre_cond, $usu_nombre, $usu_nombre_autocomp,
             $usu_cedula_cond, $usu_cedula, $usu_cedula_autocomp,
             $usu_email_cond, $usu_email, $usu_email_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($usu_usuario_autocomp) && empty($usu_usuario))
      {
          $usu_usuario = $usu_usuario_autocomp;
      }
      if (!empty($usu_nombre_autocomp) && empty($usu_nombre))
      {
          $usu_nombre = $usu_nombre_autocomp;
      }
      if (!empty($usu_cedula_autocomp) && empty($usu_cedula))
      {
          $usu_cedula = $usu_cedula_autocomp;
      }
      if (!empty($usu_email_autocomp) && empty($usu_email))
      {
          $usu_email = $usu_email_autocomp;
      }
      $usu_usuario_cond_salva = $usu_usuario_cond; 
      if (!isset($usu_usuario_input_2) || $usu_usuario_input_2 == "")
      {
          $usu_usuario_input_2 = $usu_usuario;
      }
      $usu_nombre_cond_salva = $usu_nombre_cond; 
      if (!isset($usu_nombre_input_2) || $usu_nombre_input_2 == "")
      {
          $usu_nombre_input_2 = $usu_nombre;
      }
      $usu_cedula_cond_salva = $usu_cedula_cond; 
      if (!isset($usu_cedula_input_2) || $usu_cedula_input_2 == "")
      {
          $usu_cedula_input_2 = $usu_cedula;
      }
      $usu_email_cond_salva = $usu_email_cond; 
      if (!isset($usu_email_input_2) || $usu_email_input_2 == "")
      {
          $usu_email_input_2 = $usu_email;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['campos_busca']['usu_usuario'] = $usu_usuario; 
      if (is_array($usu_usuario) && !empty($usu_usuario))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['Grid_search'][$I_Grid]['val'][0] = $usu_usuario;
      }
      elseif ($usu_usuario_cond_salva == "nu" || $usu_usuario_cond_salva == "nn" || $usu_usuario_cond_salva == "ep" || $usu_usuario_cond_salva == "ne" || !empty($usu_usuario))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['Grid_search'][$I_Grid]['val'][0][0] = $usu_usuario;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['campos_busca']['usu_usuario_cond'] = $usu_usuario_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['Grid_search'][$I_Grid]['cmp'] = "usu_usuario"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['Grid_search'][$I_Grid]['opc'] = $usu_usuario_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq']['usu_usuario'] = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['campos_busca']['usu_nombre'] = $usu_nombre; 
      if (is_array($usu_nombre) && !empty($usu_nombre))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['Grid_search'][$I_Grid]['val'][0] = $usu_nombre;
      }
      elseif ($usu_nombre_cond_salva == "nu" || $usu_nombre_cond_salva == "nn" || $usu_nombre_cond_salva == "ep" || $usu_nombre_cond_salva == "ne" || !empty($usu_nombre))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['Grid_search'][$I_Grid]['val'][0][0] = $usu_nombre;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['campos_busca']['usu_nombre_cond'] = $usu_nombre_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['Grid_search'][$I_Grid]['cmp'] = "usu_nombre"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['Grid_search'][$I_Grid]['opc'] = $usu_nombre_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq']['usu_nombre'] = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['campos_busca']['usu_cedula'] = $usu_cedula; 
      if (is_array($usu_cedula) && !empty($usu_cedula))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['Grid_search'][$I_Grid]['val'][0] = $usu_cedula;
      }
      elseif ($usu_cedula_cond_salva == "nu" || $usu_cedula_cond_salva == "nn" || $usu_cedula_cond_salva == "ep" || $usu_cedula_cond_salva == "ne" || !empty($usu_cedula))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['Grid_search'][$I_Grid]['val'][0][0] = $usu_cedula;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['campos_busca']['usu_cedula_cond'] = $usu_cedula_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['Grid_search'][$I_Grid]['cmp'] = "usu_cedula"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['Grid_search'][$I_Grid]['opc'] = $usu_cedula_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq']['usu_cedula'] = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['campos_busca']['usu_email'] = $usu_email; 
      if (is_array($usu_email) && !empty($usu_email))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['Grid_search'][$I_Grid]['val'][0] = $usu_email;
      }
      elseif ($usu_email_cond_salva == "nu" || $usu_email_cond_salva == "nn" || $usu_email_cond_salva == "ep" || $usu_email_cond_salva == "ne" || !empty($usu_email))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['Grid_search'][$I_Grid]['val'][0][0] = $usu_email;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['campos_busca']['usu_email_cond'] = $usu_email_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['Grid_search'][$I_Grid]['cmp'] = "usu_email"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['Grid_search'][$I_Grid]['opc'] = $usu_email_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['grid_pesq']['usu_email'] = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($usu_usuario != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['usu_usuario'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['usu_usuario'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['usu_usuario'] = $usu_usuario;
      }
      $nmgp_def_dados = array();
    if ($usu_nombre != '') {
      $usu_nombre_look = (is_string($usu_nombre) ? substr($this->Db->qstr($usu_nombre), 1, -1) : $usu_nombre); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['usu_nombre'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['usu_nombre'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['usu_nombre'] = $usu_nombre;
      }
      $nmgp_def_dados = array();
    if ($usu_cedula != '') {
      $usu_cedula_look = (is_string($usu_cedula) ? substr($this->Db->qstr($usu_cedula), 1, -1) : $usu_cedula); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['usu_cedula'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['usu_cedula'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['usu_cedula'] = $usu_cedula;
      }
      $nmgp_def_dados = array();
    if ($usu_email != '') {
      $usu_email_look = (is_string($usu_email) ? substr($this->Db->qstr($usu_email), 1, -1) : $usu_email); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['usu_email'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['usu_email'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['usu_email'] = $usu_email;
      }

      //----- $usu_usuario
      $this->Date_part = false;
      if (isset($usu_usuario) || $usu_usuario_cond == "nu" || $usu_usuario_cond == "nn" || $usu_usuario_cond == "ep" || $usu_usuario_cond == "ne")
      {
         $this->monta_condicao("usu_usuario", $usu_usuario_cond, $usu_usuario, "", "usu_usuario", "VARCHAR", false);
      }

      //----- $usu_nombre
      $this->Date_part = false;
      if (isset($usu_nombre) || $usu_nombre_cond == "nu" || $usu_nombre_cond == "nn" || $usu_nombre_cond == "ep" || $usu_nombre_cond == "ne")
      {
         $this->monta_condicao("usu_nombre", $usu_nombre_cond, $usu_nombre, "", "usu_nombre", "VARCHAR", false);
      }

      //----- $usu_cedula
      $this->Date_part = false;
      if (isset($usu_cedula) || $usu_cedula_cond == "nu" || $usu_cedula_cond == "nn" || $usu_cedula_cond == "ep" || $usu_cedula_cond == "ne")
      {
         $this->monta_condicao("usu_cedula", $usu_cedula_cond, $usu_cedula, "", "usu_cedula", "VARCHAR", false);
      }

      //----- $usu_email
      $this->Date_part = false;
      if (isset($usu_email) || $usu_email_cond == "nu" || $usu_email_cond == "nn" || $usu_email_cond == "ep" || $usu_email_cond == "ne")
      {
         $this->monta_condicao("usu_email", $usu_email_cond, $usu_email, "", "usu_email", "VARCHAR", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
    $this->Sel_case_sensitive($this->comando);
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['buscar_usuario']['cond_pesq'] .= $this->NM_operador;
