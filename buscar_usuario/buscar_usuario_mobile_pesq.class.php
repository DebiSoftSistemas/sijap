...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_usu_usuario_cond" name="usu_usuario_cond" onChange="nm_campos_between(document.getElementById('id_vis_usu_usuario'), this, 'usu_usuario')">
      ...
      <br><span id="id_hide_usu_usuario"  <?php echo $str_hide_usu_usuario?>><?php
      if ($usu_usuario != "")
      {
      $usu_usuario_look = (is_string($usu_usuario) ? substr($this->Db->qstr($usu_usuario), 1, -1) : $usu_usuario); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_usu_nombre_cond" name="usu_nombre_cond" onChange="nm_campos_between(document.getElementById('id_vis_usu_nombre'), this, 'usu_nombre')">
      ...
      <br><span id="id_hide_usu_nombre"  <?php echo $str_hide_usu_nombre?>><?php
      if ($usu_nombre != "")
      {
      $usu_nombre_look = (is_string($usu_nombre) ? substr($this->Db->qstr($usu_nombre), 1, -1) : $usu_nombre); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_usu_cedula_cond" name="usu_cedula_cond" onChange="nm_campos_between(document.getElementById('id_vis_usu_cedula'), this, 'usu_cedula')">
      ...
      <br><span id="id_hide_usu_cedula"  <?php echo $str_hide_usu_cedula?>><?php
      if ($usu_cedula != "")
      {
      $usu_cedula_look = (is_string($usu_cedula) ? substr($this->Db->qstr($usu_cedula), 1, -1) : $usu_cedula); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_usu_email_cond" name="usu_email_cond" onChange="nm_campos_between(document.getElementById('id_vis_usu_email'), this, 'usu_email')">
      ...
      <br><span id="id_hide_usu_email"  <?php echo $str_hide_usu_email?>><?php
      if ($usu_email != "")
      {
      $usu_email_look = (is_string($usu_email) ? substr($this->Db->qstr($usu_email), 1, -1) : $usu_email); 
      $nmgp_def_dados = array(); 
