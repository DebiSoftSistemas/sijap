  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_detalle_catalogo_configurador" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sis_detalle_catalogo_configurador_form();
	}
...
?>
  ...
  // ---------- Validate dec_id_
  function do_ajax_form_sis_detalle_catalogo_configurador_validate_dec_id_(iNumLinha)
  {
    var nomeCampo_dec_id_ = "dec_id_" + iNumLinha;
    var var_dec_id_ = scAjaxGetFieldText(nomeCampo_dec_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_detalle_catalogo_configurador_validate_dec_id_(var_dec_id_, iNumLinha, var_script_case_init, do_ajax_form_sis_detalle_catalogo_configurador_validate_dec_id__cb);
  } // do_ajax_form_sis_detalle_catalogo_configurador_validate_dec_id_

  function do_ajax_form_sis_detalle_catalogo_configurador_validate_dec_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "dec_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "dec_id_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "dec_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "dec_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_detalle_catalogo_configurador_validate_dec_id__cb

  // ---------- Validate dec_nombre_
  function do_ajax_form_sis_detalle_catalogo_configurador_validate_dec_nombre_(iNumLinha)
  {
    var nomeCampo_dec_nombre_ = "dec_nombre_" + iNumLinha;
    var var_dec_nombre_ = scAjaxGetFieldText(nomeCampo_dec_nombre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_detalle_catalogo_configurador_validate_dec_nombre_(var_dec_nombre_, iNumLinha, var_script_case_init, do_ajax_form_sis_detalle_catalogo_configurador_validate_dec_nombre__cb);
  } // do_ajax_form_sis_detalle_catalogo_configurador_validate_dec_nombre_

  function do_ajax_form_sis_detalle_catalogo_configurador_validate_dec_nombre__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "dec_nombre_" + iLineNumber;
    }
    else
    {
      sFieldValid = "dec_nombre_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "dec_nombre_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "dec_nombre_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_detalle_catalogo_configurador_validate_dec_nombre__cb

  // ---------- Validate dec_catalogo_
  function do_ajax_form_sis_detalle_catalogo_configurador_validate_dec_catalogo_(iNumLinha)
  {
    var nomeCampo_dec_catalogo_ = "dec_catalogo_" + iNumLinha;
    var var_dec_catalogo_ = scAjaxGetFieldText(nomeCampo_dec_catalogo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_detalle_catalogo_configurador_validate_dec_catalogo_(var_dec_catalogo_, iNumLinha, var_script_case_init, do_ajax_form_sis_detalle_catalogo_configurador_validate_dec_catalogo__cb);
  } // do_ajax_form_sis_detalle_catalogo_configurador_validate_dec_catalogo_

  function do_ajax_form_sis_detalle_catalogo_configurador_validate_dec_catalogo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "dec_catalogo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "dec_catalogo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "dec_catalogo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "dec_catalogo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_detalle_catalogo_configurador_validate_dec_catalogo__cb

  // ---------- Validate dec_estado_
  function do_ajax_form_sis_detalle_catalogo_configurador_validate_dec_estado_(iNumLinha)
  {
    var nomeCampo_dec_estado_ = "dec_estado_" + iNumLinha;
    var var_dec_estado_ = scAjaxGetFieldSelect(nomeCampo_dec_estado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_detalle_catalogo_configurador_validate_dec_estado_(var_dec_estado_, iNumLinha, var_script_case_init, do_ajax_form_sis_detalle_catalogo_configurador_validate_dec_estado__cb);
  } // do_ajax_form_sis_detalle_catalogo_configurador_validate_dec_estado_

  function do_ajax_form_sis_detalle_catalogo_configurador_validate_dec_estado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "dec_estado_" + iLineNumber;
    }
    else
    {
      sFieldValid = "dec_estado_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "dec_estado_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "dec_estado_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_detalle_catalogo_configurador_validate_dec_estado__cb

  // ---------- Validate dec_secuencial_
  function do_ajax_form_sis_detalle_catalogo_configurador_validate_dec_secuencial_(iNumLinha)
  {
    var nomeCampo_dec_secuencial_ = "dec_secuencial_" + iNumLinha;
    var var_dec_secuencial_ = scAjaxGetFieldHidden(nomeCampo_dec_secuencial_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_detalle_catalogo_configurador_validate_dec_secuencial_(var_dec_secuencial_, iNumLinha, var_script_case_init, do_ajax_form_sis_detalle_catalogo_configurador_validate_dec_secuencial__cb);
  } // do_ajax_form_sis_detalle_catalogo_configurador_validate_dec_secuencial_

  function do_ajax_form_sis_detalle_catalogo_configurador_validate_dec_secuencial__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "dec_secuencial_" + iLineNumber;
    }
    else
    {
      sFieldValid = "dec_secuencial_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "dec_secuencial_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "dec_secuencial_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_detalle_catalogo_configurador_validate_dec_secuencial__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_sis_detalle_catalogo_configurador_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_sis_detalle_catalogo_configurador_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sis_detalle_catalogo_configurador_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_sis_detalle_catalogo_configurador_add_new_line_cb);
  } // do_ajax_form_sis_detalle_catalogo_configurador_add_new_line

  function do_ajax_form_sis_detalle_catalogo_configurador_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_sis_detalle_catalogo_configurador_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_sis_detalle_catalogo_configurador_backup_line(iNumLinha)
  {
    var var_dec_secuencial_ = scAjaxGetFieldHidden("dec_secuencial_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_detalle_catalogo_configurador_backup_line(var_dec_secuencial_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_sis_detalle_catalogo_configurador_backup_line_cb);
  } // do_ajax_form_sis_detalle_catalogo_configurador_backup_line

  function do_ajax_form_sis_detalle_catalogo_configurador_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_sis_detalle_catalogo_configurador_backup_line_cb

  function do_ajax_form_sis_detalle_catalogo_configurador_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_sis_detalle_catalogo_configurador_cancel_insert

  function do_ajax_form_sis_detalle_catalogo_configurador_cancel_update(iSeqVert)
  {
    do_ajax_form_sis_detalle_catalogo_configurador_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_sis_detalle_catalogo_configurador_cancel_update

  function do_ajax_form_sis_detalle_catalogo_configurador_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_sis_detalle_catalogo_configurador_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_sis_detalle_catalogo_configurador_table_refresh()
  {
    var var_dec_secuencial_ = document.F2.dec_secuencial_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_sis_detalle_catalogo_configurador_table_refresh(var_dec_secuencial_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_detalle_catalogo_configurador_table_refresh_cb);
  } //  do_ajax_form_sis_detalle_catalogo_configurador_table_refresh

  function do_ajax_form_sis_detalle_catalogo_configurador_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.dec_secuencial_.value = scAjaxGetKeyValue("dec_secuencial_");
    ...
    scAjaxAlert(do_ajax_form_sis_detalle_catalogo_configurador_table_refresh_cb_after_alert);
  } // do_ajax_form_sis_detalle_catalogo_configurador_table_refresh_cb
  function do_ajax_form_sis_detalle_catalogo_configurador_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_sis_detalle_catalogo_configurador_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_sis_detalle_catalogo_configurador_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_sis_detalle_catalogo_configurador_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_dec_id_ = scAjaxGetFieldText("dec_id_" + iNumLinha);
    var var_dec_nombre_ = scAjaxGetFieldText("dec_nombre_" + iNumLinha);
    var var_dec_catalogo_ = scAjaxGetFieldText("dec_catalogo_" + iNumLinha);
    var var_dec_estado_ = scAjaxGetFieldSelect("dec_estado_" + iNumLinha);
    var var_dec_secuencial_ = scAjaxGetFieldHidden("dec_secuencial_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_sis_detalle_catalogo_configurador_submit_form(var_dec_id_, var_dec_nombre_, var_dec_catalogo_, var_dec_estado_, var_dec_secuencial_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_detalle_catalogo_configurador_submit_form_cb);
  } // do_ajax_form_sis_detalle_catalogo_configurador_submit_form

  function do_ajax_form_sis_detalle_catalogo_configurador_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("dec_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("dec_nombre_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("dec_catalogo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("dec_estado_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("dec_secuencial_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sis_detalle_catalogo_configurador_submit_form_cb_after_alert);
  } // do_ajax_form_sis_detalle_catalogo_configurador_submit_form_cb
  function do_ajax_form_sis_detalle_catalogo_configurador_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_detalle_catalogo_configurador_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sis_detalle_catalogo_configurador_navigate_form()
  {
    perform_ajax_form_sis_detalle_catalogo_configurador_navigate_form();
  }

  function perform_ajax_form_sis_detalle_catalogo_configurador_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_sis_detalle_catalogo_configurador_cancel_insert(sc_form_sis_detalle_catalogo_configurador_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("dec_id_" + iNavForm);
      scAjaxHideErrorDisplay("dec_nombre_" + iNavForm);
      scAjaxHideErrorDisplay("dec_catalogo_" + iNavForm);
      scAjaxHideErrorDisplay("dec_estado_" + iNavForm);
      scAjaxHideErrorDisplay("dec_secuencial_" + iNavForm);
    }
    var var_dec_secuencial_ = document.F2.dec_secuencial_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sis_detalle_catalogo_configurador_navigate_form(var_dec_secuencial_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_detalle_catalogo_configurador_navigate_form_cb);
  } // do_ajax_form_sis_detalle_catalogo_configurador_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_detalle_catalogo_configurador']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_detalle_catalogo_configurador_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.dec_secuencial_.value = scAjaxGetKeyValue("dec_secuencial_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_detalle_catalogo_configurador_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_detalle_catalogo_configurador_navigate_form_cb
  function do_ajax_form_sis_detalle_catalogo_configurador_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_sis_detalle_catalogo_configurador_navigate_form_cb_after_alert

    function sc_form_sis_detalle_catalogo_configurador_get_last_line_number()
    {
    ...
    } //sc_form_sis_detalle_catalogo_configurador_get_last_line_number

  function sc_hide_form_sis_detalle_catalogo_configurador_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "dec_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "dec_nombre_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "dec_catalogo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "dec_estado_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "dec_secuencial_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["dec_id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["dec_nombre_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_descripcion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["dec_catalogo_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_catalogo'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["dec_estado_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["dec_secuencial_" + iNumLinha] = {"label": "Dec Secuencial<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["dec_id_"][iNumLinha] = "dec_id_" + iNumLinha;
    ajax_field_mult["dec_nombre_"][iNumLinha] = "dec_nombre_" + iNumLinha;
    ajax_field_mult["dec_catalogo_"][iNumLinha] = "dec_catalogo_" + iNumLinha;
    ajax_field_mult["dec_estado_"][iNumLinha] = "dec_estado_" + iNumLinha;
    ajax_field_mult["dec_secuencial_"][iNumLinha] = "dec_secuencial_" + iNumLinha;
    ajax_field_id["dec_id_" + iNumLinha] = new Array("hidden_field_label_dec_id_", "hidden_field_data_dec_id_" + iNumLinha);
    ajax_field_id["dec_nombre_" + iNumLinha] = new Array("hidden_field_label_dec_nombre_", "hidden_field_data_dec_nombre_" + iNumLinha);
    ajax_field_id["dec_estado_" + iNumLinha] = new Array("hidden_field_label_dec_estado_", "hidden_field_data_dec_estado_" + iNumLinha);
    ajax_error_count["dec_id_" + iNumLinha] = "off";
    ajax_error_count["dec_nombre_" + iNumLinha] = "off";
    ajax_error_count["dec_catalogo_" + iNumLinha] = "off";
    ajax_error_count["dec_estado_" + iNumLinha] = "off";
    ajax_error_count["dec_secuencial_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["dec_id_" + iNumLinha] = "on";
    ajax_read_only["dec_nombre_" + iNumLinha] = "on";
    ajax_read_only["dec_catalogo_" + iNumLinha] = "on";
    ajax_read_only["dec_estado_" + iNumLinha] = "off";
    ajax_read_only["dec_secuencial_" + iNumLinha] = "on";
<?php
}
else
{
?>
    ...
    ajax_read_only["dec_nombre_" + iNumLinha] = "on";
    ajax_read_only["dec_catalogo_" + iNumLinha] = "on";
    ajax_read_only["dec_estado_" + iNumLinha] = "on";
    ajax_read_only["dec_secuencial_" + iNumLinha] = "on";
<?php
}
?>
  ...
  {
    ajax_error_list["dec_id_" + iNumLinha] = null;
    ajax_error_list["dec_nombre_" + iNumLinha] = null;
    ajax_error_list["dec_catalogo_" + iNumLinha] = null;
    ajax_error_list["dec_estado_" + iNumLinha] = null;
    ajax_error_list["dec_secuencial_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "dec_id_": new Array(),
    "dec_nombre_": new Array(),
    "dec_catalogo_": new Array(),
    "dec_estado_": new Array(),
    "dec_secuencial_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["dec_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["dec_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["dec_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["dec_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["dec_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["dec_nombre_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["dec_nombre_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["dec_nombre_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["dec_nombre_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["dec_nombre_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["dec_catalogo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["dec_catalogo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["dec_catalogo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["dec_catalogo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["dec_catalogo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["dec_estado_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["dec_estado_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["dec_estado_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["dec_estado_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["dec_estado_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["dec_secuencial_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["dec_secuencial_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["dec_secuencial_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["dec_secuencial_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["dec_secuencial_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['dec_id_'])) ? $this->nmgp_cmp_readonly['dec_id_'] : 'on';
?>
    scAjaxFieldRead("dec_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['dec_nombre_'])) ? $this->nmgp_cmp_readonly['dec_nombre_'] : 'on';
?>
    scAjaxFieldRead("dec_nombre_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['dec_catalogo_'])) ? $this->nmgp_cmp_readonly['dec_catalogo_'] : 'on';
?>
    scAjaxFieldRead("dec_catalogo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['dec_estado_'])) ? $this->nmgp_cmp_readonly['dec_estado_'] : 'off';
?>
    scAjaxFieldRead("dec_estado_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['dec_secuencial_'])) ? $this->nmgp_cmp_readonly['dec_secuencial_'] : 'on';
?>
    scAjaxFieldRead("dec_secuencial_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("dec_id_" + iSeq, "on");
    scAjaxFieldRead("dec_nombre_" + iSeq, "on");
    scAjaxFieldRead("dec_catalogo_" + iSeq, "on");
    scAjaxFieldRead("dec_estado_" + iSeq, "on");
    scAjaxFieldRead("dec_secuencial_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["dec_id_" + iRow] || "on" == ajax_error_count["dec_nombre_" + iRow] || "on" == ajax_error_count["dec_catalogo_" + iRow] || "on" == ajax_error_count["dec_estado_" + iRow] || "on" == ajax_error_count["dec_secuencial_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_dec_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_dec_nombre_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_dec_catalogo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_dec_estado_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_dec_secuencial_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["dec_id_" + iRow] && "off" == ajax_error_count["dec_nombre_" + iRow] && "off" == ajax_error_count["dec_catalogo_" + iRow] && "off" == ajax_error_count["dec_estado_" + iRow] && "off" == ajax_error_count["dec_secuencial_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["dec_id_" + iRow] = "off";
        ajax_error_count["dec_nombre_" + iRow] = "off";
        ajax_error_count["dec_catalogo_" + iRow] = "off";
        ajax_error_count["dec_estado_" + iRow] = "off";
        ajax_error_count["dec_secuencial_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_dec_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_dec_nombre_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_dec_catalogo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_dec_estado_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_dec_secuencial_" + iRow).removeClass("scFormErrorLine");
    }
  }
