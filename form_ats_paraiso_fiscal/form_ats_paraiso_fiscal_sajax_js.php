  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_ats_paraiso_fiscal" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_ats_paraiso_fiscal_form();
	}
...
?>
  ...
  // ---------- Validate pf_codigo_
  function do_ajax_form_ats_paraiso_fiscal_validate_pf_codigo_(iNumLinha)
  {
    var nomeCampo_pf_codigo_ = "pf_codigo_" + iNumLinha;
    var var_pf_codigo_ = scAjaxGetFieldText(nomeCampo_pf_codigo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ats_paraiso_fiscal_validate_pf_codigo_(var_pf_codigo_, iNumLinha, var_script_case_init, do_ajax_form_ats_paraiso_fiscal_validate_pf_codigo__cb);
  } // do_ajax_form_ats_paraiso_fiscal_validate_pf_codigo_

  function do_ajax_form_ats_paraiso_fiscal_validate_pf_codigo__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "pf_codigo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pf_codigo_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "pf_codigo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pf_codigo_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ats_paraiso_fiscal_validate_pf_codigo__cb

  // ---------- Validate pf_descripcion_
  function do_ajax_form_ats_paraiso_fiscal_validate_pf_descripcion_(iNumLinha)
  {
    var nomeCampo_pf_descripcion_ = "pf_descripcion_" + iNumLinha;
    var var_pf_descripcion_ = scAjaxGetFieldText(nomeCampo_pf_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ats_paraiso_fiscal_validate_pf_descripcion_(var_pf_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_ats_paraiso_fiscal_validate_pf_descripcion__cb);
  } // do_ajax_form_ats_paraiso_fiscal_validate_pf_descripcion_

  function do_ajax_form_ats_paraiso_fiscal_validate_pf_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "pf_descripcion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pf_descripcion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "pf_descripcion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pf_descripcion_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ats_paraiso_fiscal_validate_pf_descripcion__cb

  // ---------- Validate pf_ats_pais_
  function do_ajax_form_ats_paraiso_fiscal_validate_pf_ats_pais_(iNumLinha)
  {
    var nomeCampo_pf_ats_pais_ = "pf_ats_pais_" + iNumLinha;
    var var_pf_ats_pais_ = scAjaxGetFieldSelect(nomeCampo_pf_ats_pais_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ats_paraiso_fiscal_validate_pf_ats_pais_(var_pf_ats_pais_, iNumLinha, var_script_case_init, do_ajax_form_ats_paraiso_fiscal_validate_pf_ats_pais__cb);
  } // do_ajax_form_ats_paraiso_fiscal_validate_pf_ats_pais_

  function do_ajax_form_ats_paraiso_fiscal_validate_pf_ats_pais__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "pf_ats_pais_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pf_ats_pais_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "pf_ats_pais_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pf_ats_pais_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ats_paraiso_fiscal_validate_pf_ats_pais__cb

  // ---------- Validate pf_fecha_inicio_
  function do_ajax_form_ats_paraiso_fiscal_validate_pf_fecha_inicio_(iNumLinha)
  {
    var nomeCampo_pf_fecha_inicio_ = "pf_fecha_inicio_" + iNumLinha;
    var var_pf_fecha_inicio_ = scAjaxGetFieldText(nomeCampo_pf_fecha_inicio_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ats_paraiso_fiscal_validate_pf_fecha_inicio_(var_pf_fecha_inicio_, iNumLinha, var_script_case_init, do_ajax_form_ats_paraiso_fiscal_validate_pf_fecha_inicio__cb);
  } // do_ajax_form_ats_paraiso_fiscal_validate_pf_fecha_inicio_

  function do_ajax_form_ats_paraiso_fiscal_validate_pf_fecha_inicio__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "pf_fecha_inicio_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pf_fecha_inicio_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "pf_fecha_inicio_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pf_fecha_inicio_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ats_paraiso_fiscal_validate_pf_fecha_inicio__cb

  // ---------- Validate pf_fecha_fin_
  function do_ajax_form_ats_paraiso_fiscal_validate_pf_fecha_fin_(iNumLinha)
  {
    var nomeCampo_pf_fecha_fin_ = "pf_fecha_fin_" + iNumLinha;
    var var_pf_fecha_fin_ = scAjaxGetFieldText(nomeCampo_pf_fecha_fin_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ats_paraiso_fiscal_validate_pf_fecha_fin_(var_pf_fecha_fin_, iNumLinha, var_script_case_init, do_ajax_form_ats_paraiso_fiscal_validate_pf_fecha_fin__cb);
  } // do_ajax_form_ats_paraiso_fiscal_validate_pf_fecha_fin_

  function do_ajax_form_ats_paraiso_fiscal_validate_pf_fecha_fin__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "pf_fecha_fin_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pf_fecha_fin_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "pf_fecha_fin_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pf_fecha_fin_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ats_paraiso_fiscal_validate_pf_fecha_fin__cb

  // ---------- Validate pf_estado_
  function do_ajax_form_ats_paraiso_fiscal_validate_pf_estado_(iNumLinha)
  {
    var nomeCampo_pf_estado_ = "pf_estado_" + iNumLinha;
    var var_pf_estado_ = scAjaxGetFieldSelect(nomeCampo_pf_estado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ats_paraiso_fiscal_validate_pf_estado_(var_pf_estado_, iNumLinha, var_script_case_init, do_ajax_form_ats_paraiso_fiscal_validate_pf_estado__cb);
  } // do_ajax_form_ats_paraiso_fiscal_validate_pf_estado_

  function do_ajax_form_ats_paraiso_fiscal_validate_pf_estado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "pf_estado_" + iLineNumber;
    }
    else
    {
      sFieldValid = "pf_estado_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "pf_estado_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pf_estado_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ats_paraiso_fiscal_validate_pf_estado__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_ats_paraiso_fiscal_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_ats_paraiso_fiscal_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_ats_paraiso_fiscal_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_ats_paraiso_fiscal_add_new_line_cb);
  } // do_ajax_form_ats_paraiso_fiscal_add_new_line

  function do_ajax_form_ats_paraiso_fiscal_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_ats_paraiso_fiscal_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_ats_paraiso_fiscal_backup_line(iNumLinha)
  {
    var var_pf_codigo_ = scAjaxGetFieldText("pf_codigo_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ats_paraiso_fiscal_backup_line(var_pf_codigo_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_ats_paraiso_fiscal_backup_line_cb);
  } // do_ajax_form_ats_paraiso_fiscal_backup_line

  function do_ajax_form_ats_paraiso_fiscal_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_ats_paraiso_fiscal_backup_line_cb

  function do_ajax_form_ats_paraiso_fiscal_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_ats_paraiso_fiscal_cancel_insert

  function do_ajax_form_ats_paraiso_fiscal_cancel_update(iSeqVert)
  {
    do_ajax_form_ats_paraiso_fiscal_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_ats_paraiso_fiscal_cancel_update

  function do_ajax_form_ats_paraiso_fiscal_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_ats_paraiso_fiscal_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_ats_paraiso_fiscal_table_refresh()
  {
    var var_pf_codigo_ = document.F2.pf_codigo_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_ats_paraiso_fiscal_table_refresh(var_pf_codigo_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_ats_paraiso_fiscal_table_refresh_cb);
  } //  do_ajax_form_ats_paraiso_fiscal_table_refresh

  function do_ajax_form_ats_paraiso_fiscal_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.pf_codigo_.value = scAjaxGetKeyValue("pf_codigo_");
    ...
    scAjaxAlert(do_ajax_form_ats_paraiso_fiscal_table_refresh_cb_after_alert);
  } // do_ajax_form_ats_paraiso_fiscal_table_refresh_cb
  function do_ajax_form_ats_paraiso_fiscal_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_ats_paraiso_fiscal_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_ats_paraiso_fiscal_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_ats_paraiso_fiscal_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_pf_codigo_ = scAjaxGetFieldText("pf_codigo_" + iNumLinha);
    var var_pf_descripcion_ = scAjaxGetFieldText("pf_descripcion_" + iNumLinha);
    var var_pf_ats_pais_ = scAjaxGetFieldSelect("pf_ats_pais_" + iNumLinha);
    var var_pf_fecha_inicio_ = scAjaxGetFieldText("pf_fecha_inicio_" + iNumLinha);
    var var_pf_fecha_fin_ = scAjaxGetFieldText("pf_fecha_fin_" + iNumLinha);
    var var_pf_estado_ = scAjaxGetFieldSelect("pf_estado_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_ats_paraiso_fiscal_submit_form(var_pf_codigo_, var_pf_descripcion_, var_pf_ats_pais_, var_pf_fecha_inicio_, var_pf_fecha_fin_, var_pf_estado_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_ats_paraiso_fiscal_submit_form_cb);
  } // do_ajax_form_ats_paraiso_fiscal_submit_form

  function do_ajax_form_ats_paraiso_fiscal_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("pf_codigo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("pf_descripcion_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("pf_ats_pais_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("pf_fecha_inicio_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("pf_fecha_fin_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("pf_estado_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_ats_paraiso_fiscal_submit_form_cb_after_alert);
  } // do_ajax_form_ats_paraiso_fiscal_submit_form_cb
  function do_ajax_form_ats_paraiso_fiscal_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_ats_paraiso_fiscal_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_ats_paraiso_fiscal_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_ats_paraiso_fiscal_navigate_form, function() {});
    } else {
      perform_ajax_form_ats_paraiso_fiscal_navigate_form();
    }
  }

  function perform_ajax_form_ats_paraiso_fiscal_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_ats_paraiso_fiscal_cancel_insert(sc_form_ats_paraiso_fiscal_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("pf_codigo_" + iNavForm);
      scAjaxHideErrorDisplay("pf_descripcion_" + iNavForm);
      scAjaxHideErrorDisplay("pf_ats_pais_" + iNavForm);
      scAjaxHideErrorDisplay("pf_fecha_inicio_" + iNavForm);
      scAjaxHideErrorDisplay("pf_fecha_fin_" + iNavForm);
      scAjaxHideErrorDisplay("pf_estado_" + iNavForm);
    }
    var var_pf_codigo_ = document.F2.pf_codigo_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_ats_paraiso_fiscal_navigate_form(var_pf_codigo_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_ats_paraiso_fiscal_navigate_form_cb);
  } // do_ajax_form_ats_paraiso_fiscal_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ats_paraiso_fiscal']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_ats_paraiso_fiscal_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.pf_codigo_.value = scAjaxGetKeyValue("pf_codigo_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_ats_paraiso_fiscal_navigate_form_cb_after_alert);
  } // do_ajax_form_ats_paraiso_fiscal_navigate_form_cb
  function do_ajax_form_ats_paraiso_fiscal_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_ats_paraiso_fiscal_navigate_form_cb_after_alert

    function sc_form_ats_paraiso_fiscal_get_last_line_number()
    {
    ...
    } //sc_form_ats_paraiso_fiscal_get_last_line_number

  function sc_hide_form_ats_paraiso_fiscal_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "pf_codigo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pf_descripcion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pf_ats_pais_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pf_fecha_inicio_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pf_fecha_fin_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "pf_estado_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["pf_codigo_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_codigo'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pf_descripcion_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_descripcion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pf_ats_pais_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_pais'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pf_fecha_inicio_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_fecha_inicio'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pf_fecha_fin_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_fecha_fin'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["pf_estado_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["pf_codigo_"][iNumLinha] = "pf_codigo_" + iNumLinha;
    ajax_field_mult["pf_descripcion_"][iNumLinha] = "pf_descripcion_" + iNumLinha;
    ajax_field_mult["pf_ats_pais_"][iNumLinha] = "pf_ats_pais_" + iNumLinha;
    ajax_field_mult["pf_fecha_inicio_"][iNumLinha] = "pf_fecha_inicio_" + iNumLinha;
    ajax_field_mult["pf_fecha_fin_"][iNumLinha] = "pf_fecha_fin_" + iNumLinha;
    ajax_field_mult["pf_estado_"][iNumLinha] = "pf_estado_" + iNumLinha;
    ajax_field_id["pf_codigo_" + iNumLinha] = new Array("hidden_field_label_pf_codigo_", "hidden_field_data_pf_codigo_" + iNumLinha);
    ajax_field_id["pf_descripcion_" + iNumLinha] = new Array("hidden_field_label_pf_descripcion_", "hidden_field_data_pf_descripcion_" + iNumLinha);
    ajax_field_id["pf_ats_pais_" + iNumLinha] = new Array("hidden_field_label_pf_ats_pais_", "hidden_field_data_pf_ats_pais_" + iNumLinha);
    ajax_field_id["pf_fecha_inicio_" + iNumLinha] = new Array("hidden_field_label_pf_fecha_inicio_", "hidden_field_data_pf_fecha_inicio_" + iNumLinha);
    ajax_field_id["pf_fecha_fin_" + iNumLinha] = new Array("hidden_field_label_pf_fecha_fin_", "hidden_field_data_pf_fecha_fin_" + iNumLinha);
    ajax_field_id["pf_estado_" + iNumLinha] = new Array("hidden_field_label_pf_estado_", "hidden_field_data_pf_estado_" + iNumLinha);
    ajax_error_count["pf_codigo_" + iNumLinha] = "off";
    ajax_error_count["pf_descripcion_" + iNumLinha] = "off";
    ajax_error_count["pf_ats_pais_" + iNumLinha] = "off";
    ajax_error_count["pf_fecha_inicio_" + iNumLinha] = "off";
    ajax_error_count["pf_fecha_fin_" + iNumLinha] = "off";
    ajax_error_count["pf_estado_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["pf_codigo_" + iNumLinha] = "on";
    ajax_read_only["pf_descripcion_" + iNumLinha] = "off";
    ajax_read_only["pf_ats_pais_" + iNumLinha] = "off";
    ajax_read_only["pf_fecha_inicio_" + iNumLinha] = "off";
    ajax_read_only["pf_fecha_fin_" + iNumLinha] = "off";
    ajax_read_only["pf_estado_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["pf_codigo_" + iNumLinha] = "on";
    ajax_read_only["pf_descripcion_" + iNumLinha] = "on";
    ajax_read_only["pf_ats_pais_" + iNumLinha] = "on";
    ajax_read_only["pf_fecha_inicio_" + iNumLinha] = "on";
    ajax_read_only["pf_fecha_fin_" + iNumLinha] = "on";
    ajax_read_only["pf_estado_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["pf_codigo_" + iNumLinha] = null;
    ajax_error_list["pf_descripcion_" + iNumLinha] = null;
    ajax_error_list["pf_ats_pais_" + iNumLinha] = null;
    ajax_error_list["pf_fecha_inicio_" + iNumLinha] = null;
    ajax_error_list["pf_fecha_fin_" + iNumLinha] = null;
    ajax_error_list["pf_estado_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "pf_codigo_": new Array(),
    "pf_descripcion_": new Array(),
    "pf_ats_pais_": new Array(),
    "pf_fecha_inicio_": new Array(),
    "pf_fecha_fin_": new Array(),
    "pf_estado_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["pf_codigo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pf_codigo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pf_codigo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pf_codigo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pf_codigo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["pf_descripcion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pf_descripcion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pf_descripcion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pf_descripcion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pf_descripcion_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["pf_ats_pais_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pf_ats_pais_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pf_ats_pais_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pf_ats_pais_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pf_ats_pais_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["pf_fecha_inicio_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pf_fecha_inicio_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pf_fecha_inicio_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pf_fecha_inicio_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pf_fecha_inicio_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["pf_fecha_fin_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pf_fecha_fin_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pf_fecha_fin_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pf_fecha_fin_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pf_fecha_fin_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["pf_estado_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pf_estado_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pf_estado_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pf_estado_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pf_estado_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pf_codigo_'])) ? $this->nmgp_cmp_readonly['pf_codigo_'] : 'on';
?>
    scAjaxFieldRead("pf_codigo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pf_descripcion_'])) ? $this->nmgp_cmp_readonly['pf_descripcion_'] : 'off';
?>
    scAjaxFieldRead("pf_descripcion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pf_ats_pais_'])) ? $this->nmgp_cmp_readonly['pf_ats_pais_'] : 'off';
?>
    scAjaxFieldRead("pf_ats_pais_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pf_fecha_inicio_'])) ? $this->nmgp_cmp_readonly['pf_fecha_inicio_'] : 'off';
?>
    scAjaxFieldRead("pf_fecha_inicio_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pf_fecha_fin_'])) ? $this->nmgp_cmp_readonly['pf_fecha_fin_'] : 'off';
?>
    scAjaxFieldRead("pf_fecha_fin_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pf_estado_'])) ? $this->nmgp_cmp_readonly['pf_estado_'] : 'off';
?>
    scAjaxFieldRead("pf_estado_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("pf_codigo_" + iSeq, "on");
    scAjaxFieldRead("pf_descripcion_" + iSeq, "on");
    scAjaxFieldRead("pf_ats_pais_" + iSeq, "on");
    scAjaxFieldRead("pf_fecha_inicio_" + iSeq, "on");
    scAjaxFieldRead("pf_fecha_fin_" + iSeq, "on");
    scAjaxFieldRead("pf_estado_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["pf_codigo_" + iRow] || "on" == ajax_error_count["pf_descripcion_" + iRow] || "on" == ajax_error_count["pf_ats_pais_" + iRow] || "on" == ajax_error_count["pf_fecha_inicio_" + iRow] || "on" == ajax_error_count["pf_fecha_fin_" + iRow] || "on" == ajax_error_count["pf_estado_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pf_codigo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pf_descripcion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pf_ats_pais_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pf_fecha_inicio_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pf_fecha_fin_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pf_estado_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["pf_codigo_" + iRow] && "off" == ajax_error_count["pf_descripcion_" + iRow] && "off" == ajax_error_count["pf_ats_pais_" + iRow] && "off" == ajax_error_count["pf_fecha_inicio_" + iRow] && "off" == ajax_error_count["pf_fecha_fin_" + iRow] && "off" == ajax_error_count["pf_estado_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["pf_codigo_" + iRow] = "off";
        ajax_error_count["pf_descripcion_" + iRow] = "off";
        ajax_error_count["pf_ats_pais_" + iRow] = "off";
        ajax_error_count["pf_fecha_inicio_" + iRow] = "off";
        ajax_error_count["pf_fecha_fin_" + iRow] = "off";
        ajax_error_count["pf_estado_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_pf_codigo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_pf_descripcion_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_pf_ats_pais_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_pf_fecha_inicio_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_pf_fecha_fin_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_pf_estado_" + iRow).removeClass("scFormErrorLine");
    }
  }
