...
$old_error_handler = set_error_handler("form_ats_paraiso_fiscal_scriptcase_error_handler");

function form_ats_paraiso_fiscal_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['form_ats_paraiso_fiscal']['contr_erro']) && $_SESSION['scriptcase']['form_ats_paraiso_fiscal']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_ats_paraiso_fiscal->contr_form_ats_paraiso_fiscal->Apl_com_erro = true;
            if ($inicial_form_ats_paraiso_fiscal->contr_form_ats_paraiso_fiscal->NM_ajax_flag)
            {
                $inicial_form_ats_paraiso_fiscal->contr_form_ats_paraiso_fiscal->NM_ajax_info['errList']['geral_form_ats_paraiso_fiscal'][] = $msg;
                return;
            }
            form_ats_paraiso_fiscal_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_ats_paraiso_fiscal_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_ats_paraiso_fiscal'])  && '' != $_SESSION['scriptcase']['error_icon']['form_ats_paraiso_fiscal'])  ? $_SESSION['scriptcase']['error_icon']['form_ats_paraiso_fiscal']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_ats_paraiso_fiscal']) && '' != $_SESSION['scriptcase']['error_span_title']['form_ats_paraiso_fiscal']) ? $_SESSION['scriptcase']['error_span_title']['form_ats_paraiso_fiscal'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_ats_paraiso_fiscal']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_ats_paraiso_fiscal']) ? $_SESSION['scriptcase']['error_icon_title']['form_ats_paraiso_fiscal'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_ats_paraiso_fiscal']['error_buffer'] .= ob_get_flush();
}
