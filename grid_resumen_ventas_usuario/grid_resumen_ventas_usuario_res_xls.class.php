...
class grid_resumen_ventas_usuario_res_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_xls()
   {
      ...
      $this->grava_arquivo();
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['xls_res_grid']))
      {
          return;
      }
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['xls_res_grid']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resumen_ventas_usuario']['xls_res_sheet'] = $this->Xls_f;
      }
