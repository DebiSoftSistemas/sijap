...
class grid_del_nota_credito_ind_xls
{
   var $Db;
   var $Erro;
   var $Ini;
...
function sc_actionbar_disable($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_credito_ind']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_credito_ind']['SC_Gb_Free_cmp']))
          {
              $this->Tem_xls_res  = false;
          }
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_del_nota_credito_ind/grid_del_nota_credito_ind_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "grid_del_nota_credito_ind_res_xls.class.php");
              $this->Res_xls = new grid_del_nota_credito_ind_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_del_nota_credito_ind.zip";
          $this->Arquivo   .= "_grid_del_nota_credito_ind" . $this->Xls_tp;
          $this->Tit_doc    = "grid_del_nota_credito_ind" . $this->Xls_tp;
          $this->Tit_zip    = "grid_del_nota_credito_ind.zip";
      ...
      require_once($this->Ini->path_aplicacao . "grid_del_nota_credito_ind_total.class.php"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_credito_ind']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_credito_ind']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_credito_ind']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_credito_ind']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_credito_ind']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_credito_ind']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_credito_ind']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_credito_ind']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_credito_ind']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_credito_ind']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_credito_ind']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_credito_ind']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_credito_ind']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_credito_ind']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_credito_ind']['where_pesq'];
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_credito_ind']['order_grid'];
      ...
      while (!$rs->EOF)
      {
         ...
         $this->nc_secuencial_docmod = $rs->fields[1] ;  
         $this->cl_nombre = $rs->fields[2] ;  
         $this->cl_identificacion = $rs->fields[3] ;  
         $this->nc_total = $rs->fields[4] ;  
         $this->nc_total = (string)$this->nc_total;
         $this->nc_estado_sri = $rs->fields[5] ;  
         $this->cl_direccion = $rs->fields[6] ;  
         $this->nc_autorizacion = $rs->fields[7] ;  
         $this->nc_error_sri = $rs->fields[8] ;  
         $this->nc_numero = $rs->fields[9] ;  
...
$_SESSION['scriptcase']['grid_del_nota_credito_ind']['contr_erro'] = 'off'; 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_credito_ind']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_credito_ind']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_credito_ind']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_credito_ind']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_credito_ind']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_credito_ind']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_credito_ind']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_credito_ind']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   { 
      ...
      { 
          ...
          if ($Cada_col == "nc_autorizacion" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "nc_error_sri" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
   ...
   function NM_export_nc_secuencial_docmod()
   {
         ...
         if (is_numeric($this->nc_secuencial_docmod))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->nc_secuencial_docmod);
         $this->Xls_col++;
   }
   //----- cl_nombre
   ...
   //----- nc_autorizacion
   function NM_export_nc_autorizacion()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
             $this->NM_ctrl_style[$current_cell_ref]['ini'] = $this->Xls_row;
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->nc_autorizacion = html_entity_decode($this->nc_autorizacion, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->nc_autorizacion = strip_tags($this->nc_autorizacion);
         $this->nc_autorizacion = NM_charset_to_utf8($this->nc_autorizacion);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->nc_autorizacion, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->nc_autorizacion, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- nc_error_sri
   function NM_export_nc_error_sri()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
             $this->NM_ctrl_style[$current_cell_ref]['ini'] = $this->Xls_row;
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->nc_error_sri = html_entity_decode($this->nc_error_sri, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->nc_error_sri = strip_tags($this->nc_error_sri);
         $this->nc_error_sri = NM_charset_to_utf8($this->nc_error_sri);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->nc_error_sri, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->nc_error_sri, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- nc_fecha
   ...
   //----- nc_autorizacion
   function NM_sub_cons_nc_autorizacion()
   {
         $this->nc_autorizacion = html_entity_decode($this->nc_autorizacion, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->nc_autorizacion = strip_tags($this->nc_autorizacion);
         $this->nc_autorizacion = NM_charset_to_utf8($this->nc_autorizacion);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->nc_autorizacion;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- nc_error_sri
   function NM_sub_cons_nc_error_sri()
   {
         $this->nc_error_sri = html_entity_decode($this->nc_error_sri, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->nc_error_sri = strip_tags($this->nc_error_sri);
         $this->nc_error_sri = NM_charset_to_utf8($this->nc_error_sri);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->nc_error_sri;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_credito_ind']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_credito_ind']['nolabel'])
       {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_credito_ind']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_credito_ind']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_credito_ind'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_credito_ind'][$path_doc_md5][1] = $this->Tit_doc;
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> del_nota_credito :: Excel</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_nota_credito_ind']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
