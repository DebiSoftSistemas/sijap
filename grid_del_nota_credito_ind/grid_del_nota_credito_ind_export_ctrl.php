<?php
@session_start() ;
$_SESSION['scriptcase']['grid_del_nota_credito_ind']['sc_process_barr'] = true;
require_once('../grid_del_nota_credito_ind/index.php');
unset($_SESSION['scriptcase']['grid_del_nota_credito_ind']['sc_process_barr']);
$ExportCtrl = new grid_del_nota_credito_ind_export_control;
$ExportCtrl->Export_barr();

class grid_del_nota_credito_ind_export_control
{
