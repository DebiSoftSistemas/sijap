...
class grid_v_cartera_general_OLD_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_v_cartera_general_OLD']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_v_cartera_general_OLD']['campos_busca']))
      { 
   ...
   function Calc_resumo_sc_free_group_by($destino_resumo, $res_export=false)
   {
      global $nm_lang;
      $this->nm_data = new nm_data("es");
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general_OLD']['sql_tot_res']);
      ...
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general_OLD']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('periodo' => "periodo",'mes' => "mes",'cl_identificacion' => "cl_identificacion",'pro_descripcion' => "pro_descripcion",'op_estado' => "op_estado");
      $cmps_quebra_atual = array();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general_OLD']['SC_Gb_Free_cmp'] as $cmp => $resto)
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general_OLD']['arr_total'] = array();
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general_OLD']['arr_total'][$cmp_gb] = $this->$Arr_tot_name;
      }
   }
   ...
   function Res_Totaliza_sc_free_group_by($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def, $res_export)
   {
      ...
      $cmp_sql_tp_num = array('op_operacion' => 'N','periodo' => 'N','do_subtotal' => 'N','do_descuento' => 'N','do_valor_iva' => 'N','do_total' => 'N');
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general_OLD']['sql_tot_res']))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general_OLD']['sql_tot_res'] = str_replace("#@#cmps_quebras#@#", "", $comando);
      }
      $comando  = str_replace("#@#cmps_quebras#@#", "," . $cmps_quebras, $comando);
      $comando .= " group by " . $cmps_quebras . " order by " .  $cmps_quebras;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general_OLD']['Res_search_metric_use']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general_OLD']['Res_search_metric_use']))
      {
          $comando = $cmd_simp;
          $cmps_S  = "";
      ...
      while (!$rt->EOF)
      {
          ...
          nmgp_Form_Num_Val($$Cada_dim, "", ",", "0", "S", "2", "", "N:", "-") ; 
              ...
              if ($Cada_dim == "cl_identificacion") {
                  $this->Lookup->lookup_sc_free_group_by_cl_identificacion($$Cada_dim,  $cl_identificacion);
              }
   ...
   function Calc_resumo_Mensual($destino_resumo, $res_export=false)
   {
      ...
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general_OLD']['where_pesq'];
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general_OLD']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('periodo' => "periodo",'mes' => "mes");
      $cmps_quebra_atual = array("periodo","mes");
      $ult_cmp_quebra_atual = $cmps_quebra_atual[(count($cmps_quebra_atual) - 1)];
      $arr_tots = "";
      $join     = "";
      $group    = "";
   ...
   function Res_Totaliza_Mensual($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def, $res_export)
   {
      ...
      while (!$rt->EOF)
      {
          ...
          nmgp_Form_Num_Val($$Cada_dim, "", ",", "0", "S", "2", "", "N:", "-") ; 
              ...
              if ($Cada_dim == "mes") {
                  $this->Lookup->lookup_Mensual_mes($$Cada_dim,  $mes);
              }
              if (null === $$Cada_dim)
              {
                  $$Cada_dim = '';
   ...
   {
      global $nada, $nm_lang , $mes, $op_estado;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general_OLD']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general_OLD']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(do_subtotal), sum(do_valor_iva), sum(do_total) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general_OLD']['where_pesq']; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*), sum(do_subtotal), sum(do_valor_iva), sum(do_total) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general_OLD']['where_pesq']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general_OLD']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general_OLD']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $rt->fields[1] = (string)$rt->fields[1]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general_OLD']['tot_geral'][2] = $rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $rt->fields[2] = (string)$rt->fields[2]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general_OLD']['tot_geral'][3] = $rt->fields[2]; 
      $rt->fields[3] = str_replace(",", ".", $rt->fields[3]);
      $rt->fields[3] = (string)$rt->fields[3]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general_OLD']['tot_geral'][4] = $rt->fields[3]; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general_OLD']['contr_total_geral'] = "OK";
   } 
   ...
   function quebra_periodo_sc_free_group_by($periodo, $Where_qb, $Cmp_Name) 
   {
      ...
      global $$Var_name_gb, $mes, $op_estado;
      $tot_periodo = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(do_subtotal), sum(do_valor_iva), sum(do_total) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general_OLD']['where_pesq']; 
   ...
   //-----  periodo
   function quebra_periodo_Mensual($periodo, $arg_sum_periodo) 
   {
      global $tot_periodo, $mes, $op_estado;
      $tot_periodo = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(do_subtotal), sum(do_valor_iva), sum(do_total) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general_OLD']['where_pesq']; 
   ...
   //-----  mes
   function quebra_mes_Mensual($periodo, $mes, $arg_sum_periodo, $arg_sum_mes) 
   {
      global $tot_mes, $mes, $op_estado;
      $tot_mes = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(do_subtotal), sum(do_valor_iva), sum(do_total) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general_OLD']['where_pesq']; 
      ...
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_cartera_general_OLD']['where_pesq'])) 
      { 
         $nm_comando .= " where periodo" . $arg_sum_periodo . " and mes" . $arg_sum_mes ; 
      } 
      else 
      { 
         $nm_comando .= " and periodo" . $arg_sum_periodo . " and mes" . $arg_sum_mes ; 
      } 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = '';
      if (!$rt = $this->Db->Execute($nm_comando)) 
