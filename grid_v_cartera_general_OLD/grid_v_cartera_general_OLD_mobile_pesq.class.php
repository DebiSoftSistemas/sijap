...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "op_operacion";$Nm_numeric[] = "periodo";$Nm_numeric[] = "do_subtotal";$Nm_numeric[] = "do_descuento";$Nm_numeric[] = "do_valor_iva";$Nm_numeric[] = "do_total";$Nm_numeric[] = "op_operacion";$Nm_numeric[] = "periodo";$Nm_numeric[] = "do_subtotal";$Nm_numeric[] = "do_descuento";$Nm_numeric[] = "do_valor_iva";$Nm_numeric[] = "do_total";
...
?>
   <span id="idAjaxSelect_pro_descripcion">
      <SELECT class="scFilterObjectOdd" id="SC_pro_descripcion" name="pro_descripcion[]"  size="7" multiple>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
<?php
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "periodo" : return ('class="scFilterObjectOdd"'); break;
         ...
         case "pro_descripcion" : return ('class="scFilterObjectOdd"'); break;
