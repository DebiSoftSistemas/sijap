  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_ats_tipo_pago" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_ats_tipo_pago_form();
	}
...
?>
  ...
  // ---------- Validate tp_codigo_
  function do_ajax_form_ats_tipo_pago_validate_tp_codigo_(iNumLinha)
  {
    var nomeCampo_tp_codigo_ = "tp_codigo_" + iNumLinha;
    var var_tp_codigo_ = scAjaxGetFieldText(nomeCampo_tp_codigo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ats_tipo_pago_validate_tp_codigo_(var_tp_codigo_, iNumLinha, var_script_case_init, do_ajax_form_ats_tipo_pago_validate_tp_codigo__cb);
  } // do_ajax_form_ats_tipo_pago_validate_tp_codigo_

  function do_ajax_form_ats_tipo_pago_validate_tp_codigo__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ats_tipo_pago_validate_tp_codigo__cb

  // ---------- Validate tp_descripcion_
  function do_ajax_form_ats_tipo_pago_validate_tp_descripcion_(iNumLinha)
  {
    var nomeCampo_tp_descripcion_ = "tp_descripcion_" + iNumLinha;
    var var_tp_descripcion_ = scAjaxGetFieldText(nomeCampo_tp_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ats_tipo_pago_validate_tp_descripcion_(var_tp_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_ats_tipo_pago_validate_tp_descripcion__cb);
  } // do_ajax_form_ats_tipo_pago_validate_tp_descripcion_

  function do_ajax_form_ats_tipo_pago_validate_tp_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tp_descripcion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tp_descripcion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tp_descripcion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tp_descripcion_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ats_tipo_pago_validate_tp_descripcion__cb

  // ---------- Validate tp_estado_
  function do_ajax_form_ats_tipo_pago_validate_tp_estado_(iNumLinha)
  {
    var nomeCampo_tp_estado_ = "tp_estado_" + iNumLinha;
    var var_tp_estado_ = scAjaxGetFieldSelect(nomeCampo_tp_estado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ats_tipo_pago_validate_tp_estado_(var_tp_estado_, iNumLinha, var_script_case_init, do_ajax_form_ats_tipo_pago_validate_tp_estado__cb);
  } // do_ajax_form_ats_tipo_pago_validate_tp_estado_

  function do_ajax_form_ats_tipo_pago_validate_tp_estado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tp_estado_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tp_estado_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tp_estado_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tp_estado_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ats_tipo_pago_validate_tp_estado__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_ats_tipo_pago_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_ats_tipo_pago_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_ats_tipo_pago_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_ats_tipo_pago_add_new_line_cb);
  } // do_ajax_form_ats_tipo_pago_add_new_line

  function do_ajax_form_ats_tipo_pago_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_ats_tipo_pago_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_ats_tipo_pago_backup_line(iNumLinha)
  {
    var var_tp_codigo_ = scAjaxGetFieldText("tp_codigo_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ats_tipo_pago_backup_line(var_tp_codigo_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_ats_tipo_pago_backup_line_cb);
  } // do_ajax_form_ats_tipo_pago_backup_line

  function do_ajax_form_ats_tipo_pago_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_ats_tipo_pago_backup_line_cb

  function do_ajax_form_ats_tipo_pago_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_ats_tipo_pago_cancel_insert

  function do_ajax_form_ats_tipo_pago_cancel_update(iSeqVert)
  {
    do_ajax_form_ats_tipo_pago_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_ats_tipo_pago_cancel_update

  function do_ajax_form_ats_tipo_pago_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_ats_tipo_pago_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_ats_tipo_pago_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_ats_tipo_pago_table_refresh(var_tp_codigo_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_ats_tipo_pago_table_refresh_cb);
  } //  do_ajax_form_ats_tipo_pago_table_refresh

  function do_ajax_form_ats_tipo_pago_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_ats_tipo_pago_table_refresh_cb_after_alert);
  } // do_ajax_form_ats_tipo_pago_table_refresh_cb
  function do_ajax_form_ats_tipo_pago_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_ats_tipo_pago_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_ats_tipo_pago_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_ats_tipo_pago_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_tp_codigo_ = scAjaxGetFieldText("tp_codigo_" + iNumLinha);
    var var_tp_descripcion_ = scAjaxGetFieldText("tp_descripcion_" + iNumLinha);
    var var_tp_estado_ = scAjaxGetFieldSelect("tp_estado_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_ats_tipo_pago_submit_form(var_tp_codigo_, var_tp_descripcion_, var_tp_estado_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_ats_tipo_pago_submit_form_cb);
  } // do_ajax_form_ats_tipo_pago_submit_form

  function do_ajax_form_ats_tipo_pago_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("tp_descripcion_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tp_estado_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_ats_tipo_pago_submit_form_cb_after_alert);
  } // do_ajax_form_ats_tipo_pago_submit_form_cb
  function do_ajax_form_ats_tipo_pago_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_ats_tipo_pago_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_ats_tipo_pago_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_ats_tipo_pago_navigate_form, function() {});
    } else {
      perform_ajax_form_ats_tipo_pago_navigate_form();
    }
  }

  function perform_ajax_form_ats_tipo_pago_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_ats_tipo_pago_cancel_insert(sc_form_ats_tipo_pago_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("tp_descripcion_" + iNavForm);
      scAjaxHideErrorDisplay("tp_estado_" + iNavForm);
    }
    var var_tp_codigo_ = document.F2.tp_codigo_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_ats_tipo_pago_navigate_form(var_tp_codigo_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_ats_tipo_pago_navigate_form_cb);
  } // do_ajax_form_ats_tipo_pago_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ats_tipo_pago']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_ats_tipo_pago_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_ats_tipo_pago_navigate_form_cb_after_alert);
  } // do_ajax_form_ats_tipo_pago_navigate_form_cb
  function do_ajax_form_ats_tipo_pago_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_ats_tipo_pago_navigate_form_cb_after_alert

    function sc_form_ats_tipo_pago_get_last_line_number()
    {
    ...
    } //sc_form_ats_tipo_pago_get_last_line_number

  function sc_hide_form_ats_tipo_pago_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tp_descripcion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tp_estado_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["tp_descripcion_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_descripcion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tp_estado_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["tp_codigo_"][iNumLinha] = "tp_codigo_" + iNumLinha;
    ajax_field_mult["tp_descripcion_"][iNumLinha] = "tp_descripcion_" + iNumLinha;
    ajax_field_mult["tp_estado_"][iNumLinha] = "tp_estado_" + iNumLinha;
    ajax_field_id["tp_codigo_" + iNumLinha] = new Array("hidden_field_label_tp_codigo_", "hidden_field_data_tp_codigo_" + iNumLinha);
    ajax_field_id["tp_descripcion_" + iNumLinha] = new Array("hidden_field_label_tp_descripcion_", "hidden_field_data_tp_descripcion_" + iNumLinha);
    ajax_field_id["tp_estado_" + iNumLinha] = new Array("hidden_field_label_tp_estado_", "hidden_field_data_tp_estado_" + iNumLinha);
    ajax_error_count["tp_codigo_" + iNumLinha] = "off";
    ajax_error_count["tp_descripcion_" + iNumLinha] = "off";
    ajax_error_count["tp_estado_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["tp_codigo_" + iNumLinha] = "on";
    ajax_read_only["tp_descripcion_" + iNumLinha] = "off";
    ajax_read_only["tp_estado_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["tp_codigo_" + iNumLinha] = "on";
    ajax_read_only["tp_descripcion_" + iNumLinha] = "on";
    ajax_read_only["tp_estado_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["tp_descripcion_" + iNumLinha] = null;
    ajax_error_list["tp_estado_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    ...
    "tp_descripcion_": new Array(),
    "tp_estado_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["tp_descripcion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tp_descripcion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tp_descripcion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tp_descripcion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tp_descripcion_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tp_estado_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tp_estado_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tp_estado_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tp_estado_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tp_estado_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tp_descripcion_'])) ? $this->nmgp_cmp_readonly['tp_descripcion_'] : 'off';
?>
    scAjaxFieldRead("tp_descripcion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tp_estado_'])) ? $this->nmgp_cmp_readonly['tp_estado_'] : 'off';
?>
    scAjaxFieldRead("tp_estado_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("tp_codigo_" + iSeq, "on");
    scAjaxFieldRead("tp_descripcion_" + iSeq, "on");
    scAjaxFieldRead("tp_estado_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["tp_codigo_" + iRow] || "on" == ajax_error_count["tp_descripcion_" + iRow] || "on" == ajax_error_count["tp_estado_" + iRow]))
    {
      ...
      $("#hidden_field_data_tp_descripcion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tp_estado_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["tp_codigo_" + iRow] && "off" == ajax_error_count["tp_descripcion_" + iRow] && "off" == ajax_error_count["tp_estado_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["tp_codigo_" + iRow] = "off";
        ajax_error_count["tp_descripcion_" + iRow] = "off";
        ajax_error_count["tp_estado_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_tp_descripcion_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tp_estado_" + iRow).removeClass("scFormErrorLine");
    }
  }
