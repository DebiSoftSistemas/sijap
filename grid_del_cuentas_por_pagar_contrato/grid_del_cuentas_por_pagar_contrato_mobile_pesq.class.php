...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "cxp_fecha";$Nm_numeric[] = "cxp_cliente";$Nm_numeric[] = "cxp_id";$Nm_numeric[] = "cxp_valor";$Nm_numeric[] = "cxp_contrato";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_cxp_contrato_cond" name="cxp_contrato_cond" onChange="nm_campos_between(document.getElementById('id_vis_cxp_contrato'), this, 'cxp_contrato')">
      ...
      <br><span id="id_hide_cxp_contrato"  <?php echo $str_hide_cxp_contrato?>>
<?php
