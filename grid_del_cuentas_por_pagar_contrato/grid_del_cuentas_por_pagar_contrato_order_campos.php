...
<?php
   ...
   $Ord_Cmp = new grid_del_cuentas_por_pagar_contrato_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_del_cuentas_por_pagar_contrato_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_del_cuentas_por_pagar_contrato']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_del_cuentas_por_pagar_contrato']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['cxp_fecha'] = "cxp_fecha";
   $tab_labels["cxp_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_del_cuentas_por_pagar_contrato']['labels']["cxp_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_del_cuentas_por_pagar_contrato']['labels']["cxp_fecha"] : "" . $this->Nm_lang['lang_fecha'] . "";
   $tab_ger_campos['cxp_tipo_documento'] = "on";
   $tab_def_campos['cxp_tipo_documento'] = "cxp_tipo_documento";
   $tab_labels["cxp_tipo_documento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_del_cuentas_por_pagar_contrato']['labels']["cxp_tipo_documento"])) ? $_SESSION['sc_session'][$sc_init]['grid_del_cuentas_por_pagar_contrato']['labels']["cxp_tipo_documento"] : "" . $this->Nm_lang['lang_tipo_comprobante'] . "";
   $tab_ger_campos['cxp_documento'] = "on";
   $tab_def_campos['cxp_documento'] = "cxp_documento";
   $tab_labels["cxp_documento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_del_cuentas_por_pagar_contrato']['labels']["cxp_documento"])) ? $_SESSION['sc_session'][$sc_init]['grid_del_cuentas_por_pagar_contrato']['labels']["cxp_documento"] : "" . $this->Nm_lang['lang_documento'] . "";
   $tab_ger_campos['cxp_valor'] = "on";
   $tab_def_campos['cxp_valor'] = "cxp_valor";
   $tab_labels["cxp_valor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_del_cuentas_por_pagar_contrato']['labels']["cxp_valor"])) ? $_SESSION['sc_session'][$sc_init]['grid_del_cuentas_por_pagar_contrato']['labels']["cxp_valor"] : "" . $this->Nm_lang['lang_valor'] . "";
   $tab_ger_campos['cxp_estado'] = "on";
   $tab_def_campos['cxp_estado'] = "cxp_estado";
   $tab_labels["cxp_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_del_cuentas_por_pagar_contrato']['labels']["cxp_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_del_cuentas_por_pagar_contrato']['labels']["cxp_estado"] : "" . $this->Nm_lang['lang_estado'] . "";
   $tab_ger_campos['cxp_contrato'] = "on";
   $tab_def_campos['cxp_contrato'] = "cxp_contrato";
   $tab_labels["cxp_contrato"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_del_cuentas_por_pagar_contrato']['labels']["cxp_contrato"])) ? $_SESSION['sc_session'][$sc_init]['grid_del_cuentas_por_pagar_contrato']['labels']["cxp_contrato"] : "" . $this->Nm_lang['lang_contrato'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_del_cuentas_por_pagar_contrato']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_del_cuentas_por_pagar_contrato']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_del_cuentas_por_pagar_contrato']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_del_cuentas_por_pagar_contrato']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_del_cuentas_por_pagar_contrato']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_del_cuentas_por_pagar_contrato']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_del_cuentas_por_pagar_contrato']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_del_cuentas_por_pagar_contrato']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_del_cuentas_por_pagar_contrato']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_del_cuentas_por_pagar_contrato']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_del_cuentas_por_pagar_contrato']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_del_cuentas_por_pagar_contrato']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_del_cuentas_por_pagar_contrato_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_del_cuentas_por_pagar_contrato']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_del_cuentas_por_pagar_contrato']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_del_cuentas_por_pagar_contrato']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_del_cuentas_por_pagar_contrato']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_del_cuentas_por_pagar_contrato']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
