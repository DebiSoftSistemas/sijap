  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sis_aplicacion" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sis_aplicacion_form();
	}
...
?>
  ...
  // ---------- Validate apl_nombre_
  function do_ajax_form_sis_aplicacion_validate_apl_nombre_(iNumLinha)
  {
    var nomeCampo_apl_nombre_ = "apl_nombre_" + iNumLinha;
    var var_apl_nombre_ = scAjaxGetFieldText(nomeCampo_apl_nombre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_aplicacion_validate_apl_nombre_(var_apl_nombre_, iNumLinha, var_script_case_init, do_ajax_form_sis_aplicacion_validate_apl_nombre__cb);
  } // do_ajax_form_sis_aplicacion_validate_apl_nombre_

  function do_ajax_form_sis_aplicacion_validate_apl_nombre__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "apl_nombre_" + iLineNumber;
    }
    else
    {
      sFieldValid = "apl_nombre_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "apl_nombre_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "apl_nombre_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_aplicacion_validate_apl_nombre__cb

  // ---------- Validate apl_descripcion_
  function do_ajax_form_sis_aplicacion_validate_apl_descripcion_(iNumLinha)
  {
    var nomeCampo_apl_descripcion_ = "apl_descripcion_" + iNumLinha;
    var var_apl_descripcion_ = scAjaxGetFieldText(nomeCampo_apl_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_aplicacion_validate_apl_descripcion_(var_apl_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_sis_aplicacion_validate_apl_descripcion__cb);
  } // do_ajax_form_sis_aplicacion_validate_apl_descripcion_

  function do_ajax_form_sis_aplicacion_validate_apl_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "apl_descripcion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "apl_descripcion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "apl_descripcion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "apl_descripcion_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_aplicacion_validate_apl_descripcion__cb

  // ---------- Validate apl_tipo_
  function do_ajax_form_sis_aplicacion_validate_apl_tipo_(iNumLinha)
  {
    var nomeCampo_apl_tipo_ = "apl_tipo_" + iNumLinha;
    var var_apl_tipo_ = scAjaxGetFieldSelect(nomeCampo_apl_tipo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_aplicacion_validate_apl_tipo_(var_apl_tipo_, iNumLinha, var_script_case_init, do_ajax_form_sis_aplicacion_validate_apl_tipo__cb);
  } // do_ajax_form_sis_aplicacion_validate_apl_tipo_

  function do_ajax_form_sis_aplicacion_validate_apl_tipo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "apl_tipo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "apl_tipo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "apl_tipo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "apl_tipo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sis_aplicacion_validate_apl_tipo__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_sis_aplicacion_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_sis_aplicacion_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sis_aplicacion_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_sis_aplicacion_add_new_line_cb);
  } // do_ajax_form_sis_aplicacion_add_new_line

  function do_ajax_form_sis_aplicacion_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_sis_aplicacion_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_sis_aplicacion_backup_line(iNumLinha)
  {
    var var_apl_nombre_ = scAjaxGetFieldText("apl_nombre_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sis_aplicacion_backup_line(var_apl_nombre_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_sis_aplicacion_backup_line_cb);
  } // do_ajax_form_sis_aplicacion_backup_line

  function do_ajax_form_sis_aplicacion_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_sis_aplicacion_backup_line_cb

  function do_ajax_form_sis_aplicacion_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_sis_aplicacion_cancel_insert

  function do_ajax_form_sis_aplicacion_cancel_update(iSeqVert)
  {
    do_ajax_form_sis_aplicacion_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_sis_aplicacion_cancel_update

  function do_ajax_form_sis_aplicacion_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_sis_aplicacion_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_sis_aplicacion_table_refresh()
  {
    var var_apl_nombre_ = document.F2.apl_nombre_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_sis_aplicacion_table_refresh(var_apl_nombre_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_aplicacion_table_refresh_cb);
  } //  do_ajax_form_sis_aplicacion_table_refresh

  function do_ajax_form_sis_aplicacion_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.apl_nombre_.value = scAjaxGetKeyValue("apl_nombre_");
    ...
    scAjaxAlert(do_ajax_form_sis_aplicacion_table_refresh_cb_after_alert);
  } // do_ajax_form_sis_aplicacion_table_refresh_cb
  function do_ajax_form_sis_aplicacion_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_sis_aplicacion_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_sis_aplicacion_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_sis_aplicacion_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_apl_nombre_ = scAjaxGetFieldText("apl_nombre_" + iNumLinha);
    var var_apl_descripcion_ = scAjaxGetFieldText("apl_descripcion_" + iNumLinha);
    var var_apl_tipo_ = scAjaxGetFieldSelect("apl_tipo_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_sis_aplicacion_submit_form(var_apl_nombre_, var_apl_descripcion_, var_apl_tipo_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sis_aplicacion_submit_form_cb);
  } // do_ajax_form_sis_aplicacion_submit_form

  function do_ajax_form_sis_aplicacion_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("apl_nombre_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("apl_descripcion_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("apl_tipo_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sis_aplicacion_submit_form_cb_after_alert);
  } // do_ajax_form_sis_aplicacion_submit_form_cb
  function do_ajax_form_sis_aplicacion_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sis_aplicacion_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sis_aplicacion_navigate_form()
  {
    perform_ajax_form_sis_aplicacion_navigate_form();
  }

  function perform_ajax_form_sis_aplicacion_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_sis_aplicacion_cancel_insert(sc_form_sis_aplicacion_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("apl_nombre_" + iNavForm);
      scAjaxHideErrorDisplay("apl_descripcion_" + iNavForm);
      scAjaxHideErrorDisplay("apl_tipo_" + iNavForm);
    }
    var var_apl_nombre_ = document.F2.apl_nombre_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sis_aplicacion_navigate_form(var_apl_nombre_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sis_aplicacion_navigate_form_cb);
  } // do_ajax_form_sis_aplicacion_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sis_aplicacion']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sis_aplicacion_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.apl_nombre_.value = scAjaxGetKeyValue("apl_nombre_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sis_aplicacion_navigate_form_cb_after_alert);
  } // do_ajax_form_sis_aplicacion_navigate_form_cb
  function do_ajax_form_sis_aplicacion_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_sis_aplicacion_navigate_form_cb_after_alert

    function sc_form_sis_aplicacion_get_last_line_number()
    {
    ...
    } //sc_form_sis_aplicacion_get_last_line_number

  function sc_hide_form_sis_aplicacion_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "apl_nombre_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "apl_descripcion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "apl_tipo_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["apl_nombre_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_aplicacion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["apl_descripcion_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_descripcion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["apl_tipo_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tipo'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["apl_nombre_"][iNumLinha] = "apl_nombre_" + iNumLinha;
    ajax_field_mult["apl_descripcion_"][iNumLinha] = "apl_descripcion_" + iNumLinha;
    ajax_field_mult["apl_tipo_"][iNumLinha] = "apl_tipo_" + iNumLinha;
    ajax_field_id["apl_nombre_" + iNumLinha] = new Array("hidden_field_label_apl_nombre_", "hidden_field_data_apl_nombre_" + iNumLinha);
    ajax_field_id["apl_descripcion_" + iNumLinha] = new Array("hidden_field_label_apl_descripcion_", "hidden_field_data_apl_descripcion_" + iNumLinha);
    ajax_field_id["apl_tipo_" + iNumLinha] = new Array("hidden_field_label_apl_tipo_", "hidden_field_data_apl_tipo_" + iNumLinha);
    ajax_error_count["apl_nombre_" + iNumLinha] = "off";
    ajax_error_count["apl_descripcion_" + iNumLinha] = "off";
    ajax_error_count["apl_tipo_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["apl_nombre_" + iNumLinha] = "on";
    ajax_read_only["apl_descripcion_" + iNumLinha] = "off";
    ajax_read_only["apl_tipo_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["apl_nombre_" + iNumLinha] = "on";
    ajax_read_only["apl_descripcion_" + iNumLinha] = "on";
    ajax_read_only["apl_tipo_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["apl_nombre_" + iNumLinha] = null;
    ajax_error_list["apl_descripcion_" + iNumLinha] = null;
    ajax_error_list["apl_tipo_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "apl_nombre_": new Array(),
    "apl_descripcion_": new Array(),
    "apl_tipo_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["apl_nombre_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["apl_nombre_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["apl_nombre_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["apl_nombre_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["apl_nombre_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["apl_descripcion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["apl_descripcion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["apl_descripcion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["apl_descripcion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["apl_descripcion_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["apl_tipo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["apl_tipo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["apl_tipo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["apl_tipo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["apl_tipo_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['apl_nombre_'])) ? $this->nmgp_cmp_readonly['apl_nombre_'] : 'on';
?>
    scAjaxFieldRead("apl_nombre_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['apl_descripcion_'])) ? $this->nmgp_cmp_readonly['apl_descripcion_'] : 'off';
?>
    scAjaxFieldRead("apl_descripcion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['apl_tipo_'])) ? $this->nmgp_cmp_readonly['apl_tipo_'] : 'off';
?>
    scAjaxFieldRead("apl_tipo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("apl_nombre_" + iSeq, "on");
    scAjaxFieldRead("apl_descripcion_" + iSeq, "on");
    scAjaxFieldRead("apl_tipo_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["apl_nombre_" + iRow] || "on" == ajax_error_count["apl_descripcion_" + iRow] || "on" == ajax_error_count["apl_tipo_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_apl_nombre_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_apl_descripcion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_apl_tipo_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["apl_nombre_" + iRow] && "off" == ajax_error_count["apl_descripcion_" + iRow] && "off" == ajax_error_count["apl_tipo_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["apl_nombre_" + iRow] = "off";
        ajax_error_count["apl_descripcion_" + iRow] = "off";
        ajax_error_count["apl_tipo_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_apl_nombre_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_apl_descripcion_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_apl_tipo_" + iRow).removeClass("scFormErrorLine");
    }
  }
