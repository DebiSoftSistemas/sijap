  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_inv_recepcion_transferencia_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_inv_recepcion_transferencia_mob_form();
	}
...
?>
  ...
  // ---------- Validate tr_fecha
  function do_ajax_form_inv_recepcion_transferencia_mob_validate_tr_fecha()
  {
    var nomeCampo_tr_fecha = "tr_fecha";
    var var_tr_fecha = scAjaxGetFieldText(nomeCampo_tr_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_recepcion_transferencia_mob_validate_tr_fecha(var_tr_fecha, var_script_case_init, do_ajax_form_inv_recepcion_transferencia_mob_validate_tr_fecha_cb);
  } // do_ajax_form_inv_recepcion_transferencia_mob_validate_tr_fecha

  function do_ajax_form_inv_recepcion_transferencia_mob_validate_tr_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tr_fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_recepcion_transferencia_mob_validate_tr_fecha_cb

  // ---------- Validate tr_bodega_origen
  function do_ajax_form_inv_recepcion_transferencia_mob_validate_tr_bodega_origen()
  {
    var nomeCampo_tr_bodega_origen = "tr_bodega_origen";
    var var_tr_bodega_origen = scAjaxGetFieldSelect(nomeCampo_tr_bodega_origen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_recepcion_transferencia_mob_validate_tr_bodega_origen(var_tr_bodega_origen, var_script_case_init, do_ajax_form_inv_recepcion_transferencia_mob_validate_tr_bodega_origen_cb);
  } // do_ajax_form_inv_recepcion_transferencia_mob_validate_tr_bodega_origen

  function do_ajax_form_inv_recepcion_transferencia_mob_validate_tr_bodega_origen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tr_bodega_origen";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_recepcion_transferencia_mob_validate_tr_bodega_origen_cb

  // ---------- Validate tr_info_adicional
  function do_ajax_form_inv_recepcion_transferencia_mob_validate_tr_info_adicional()
  {
    var nomeCampo_tr_info_adicional = "tr_info_adicional";
    var var_tr_info_adicional = scAjaxGetFieldText(nomeCampo_tr_info_adicional);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_recepcion_transferencia_mob_validate_tr_info_adicional(var_tr_info_adicional, var_script_case_init, do_ajax_form_inv_recepcion_transferencia_mob_validate_tr_info_adicional_cb);
  } // do_ajax_form_inv_recepcion_transferencia_mob_validate_tr_info_adicional

  function do_ajax_form_inv_recepcion_transferencia_mob_validate_tr_info_adicional_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tr_info_adicional";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_recepcion_transferencia_mob_validate_tr_info_adicional_cb

  // ---------- Validate tr_fecha_recibe
  function do_ajax_form_inv_recepcion_transferencia_mob_validate_tr_fecha_recibe()
  {
    var nomeCampo_tr_fecha_recibe = "tr_fecha_recibe";
    var var_tr_fecha_recibe = scAjaxGetFieldText(nomeCampo_tr_fecha_recibe);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_recepcion_transferencia_mob_validate_tr_fecha_recibe(var_tr_fecha_recibe, var_script_case_init, do_ajax_form_inv_recepcion_transferencia_mob_validate_tr_fecha_recibe_cb);
  } // do_ajax_form_inv_recepcion_transferencia_mob_validate_tr_fecha_recibe

  function do_ajax_form_inv_recepcion_transferencia_mob_validate_tr_fecha_recibe_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tr_fecha_recibe";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_recepcion_transferencia_mob_validate_tr_fecha_recibe_cb

  // ---------- Validate tr_establecimiento
  function do_ajax_form_inv_recepcion_transferencia_mob_validate_tr_establecimiento()
  {
    var nomeCampo_tr_establecimiento = "tr_establecimiento";
    var var_tr_establecimiento = scAjaxGetFieldSelect(nomeCampo_tr_establecimiento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_recepcion_transferencia_mob_validate_tr_establecimiento(var_tr_establecimiento, var_script_case_init, do_ajax_form_inv_recepcion_transferencia_mob_validate_tr_establecimiento_cb);
  } // do_ajax_form_inv_recepcion_transferencia_mob_validate_tr_establecimiento

  function do_ajax_form_inv_recepcion_transferencia_mob_validate_tr_establecimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tr_establecimiento";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_recepcion_transferencia_mob_validate_tr_establecimiento_cb

  // ---------- Validate tr_bodega_destino
  function do_ajax_form_inv_recepcion_transferencia_mob_validate_tr_bodega_destino()
  {
    var nomeCampo_tr_bodega_destino = "tr_bodega_destino";
    var var_tr_bodega_destino = scAjaxGetFieldSelect(nomeCampo_tr_bodega_destino);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_recepcion_transferencia_mob_validate_tr_bodega_destino(var_tr_bodega_destino, var_script_case_init, do_ajax_form_inv_recepcion_transferencia_mob_validate_tr_bodega_destino_cb);
  } // do_ajax_form_inv_recepcion_transferencia_mob_validate_tr_bodega_destino

  function do_ajax_form_inv_recepcion_transferencia_mob_validate_tr_bodega_destino_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tr_bodega_destino";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_recepcion_transferencia_mob_validate_tr_bodega_destino_cb

  // ---------- Validate tr_estado
  function do_ajax_form_inv_recepcion_transferencia_mob_validate_tr_estado()
  {
    var nomeCampo_tr_estado = "tr_estado";
    var var_tr_estado = scAjaxGetFieldText(nomeCampo_tr_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_recepcion_transferencia_mob_validate_tr_estado(var_tr_estado, var_script_case_init, do_ajax_form_inv_recepcion_transferencia_mob_validate_tr_estado_cb);
  } // do_ajax_form_inv_recepcion_transferencia_mob_validate_tr_estado

  function do_ajax_form_inv_recepcion_transferencia_mob_validate_tr_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tr_estado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_recepcion_transferencia_mob_validate_tr_estado_cb

  // ---------- Validate productos
  function do_ajax_form_inv_recepcion_transferencia_mob_validate_productos()
  {
    var nomeCampo_productos = "productos";
    var var_productos = scAjaxGetFieldText(nomeCampo_productos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inv_recepcion_transferencia_mob_validate_productos(var_productos, var_script_case_init, do_ajax_form_inv_recepcion_transferencia_mob_validate_productos_cb);
  } // do_ajax_form_inv_recepcion_transferencia_mob_validate_productos

  function do_ajax_form_inv_recepcion_transferencia_mob_validate_productos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_recepcion_transferencia_mob_validate_productos_cb

  // ---------- Refresh tr_bodega_origen
  function do_ajax_form_inv_recepcion_transferencia_mob_refresh_tr_bodega_origen()
  {
    var var_tr_bodega_origen = scAjaxGetFieldSelect("tr_bodega_origen");
    var var_tr_establecimiento = scAjaxGetFieldSelect("tr_establecimiento");
    var var_nmgp_refresh_fields = "tr_bodega_destino_#fld#_tr_establecimiento";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_inv_recepcion_transferencia_mob_refresh_tr_bodega_origen(var_tr_bodega_origen, var_tr_establecimiento, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_inv_recepcion_transferencia_mob_refresh_tr_bodega_origen_cb);
  } // do_ajax_form_inv_recepcion_transferencia_mob_refresh_tr_bodega_origen

  function do_ajax_form_inv_recepcion_transferencia_mob_refresh_tr_bodega_origen_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    do_ajax_form_inv_recepcion_transferencia_mob_refresh_tr_establecimiento();
    scAjaxShowDebug();
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_recepcion_transferencia_mob_refresh_tr_bodega_origen_cb

  // ---------- Refresh tr_establecimiento
  function do_ajax_form_inv_recepcion_transferencia_mob_refresh_tr_establecimiento()
  {
    var var_tr_establecimiento = scAjaxGetFieldSelect("tr_establecimiento");
    var var_tr_bodega_origen = scAjaxGetFieldSelect("tr_bodega_origen");
    var var_nmgp_refresh_fields = "tr_bodega_destino";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_inv_recepcion_transferencia_mob_refresh_tr_establecimiento(var_tr_establecimiento, var_tr_bodega_origen, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_inv_recepcion_transferencia_mob_refresh_tr_establecimiento_cb);
  } // do_ajax_form_inv_recepcion_transferencia_mob_refresh_tr_establecimiento

  function do_ajax_form_inv_recepcion_transferencia_mob_refresh_tr_establecimiento_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inv_recepcion_transferencia_mob_refresh_tr_establecimiento_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_inv_recepcion_transferencia_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_inv_recepcion_transferencia_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_tr_fecha = scAjaxGetFieldText("tr_fecha");
    var var_tr_bodega_origen = scAjaxGetFieldSelect("tr_bodega_origen");
    var var_tr_info_adicional = scAjaxGetFieldText("tr_info_adicional");
    var var_tr_fecha_recibe = scAjaxGetFieldText("tr_fecha_recibe");
    var var_tr_establecimiento = scAjaxGetFieldSelect("tr_establecimiento");
    var var_tr_bodega_destino = scAjaxGetFieldSelect("tr_bodega_destino");
    var var_tr_estado = scAjaxGetFieldText("tr_estado");
    var var_tr_id = scAjaxGetFieldText("tr_id");
    ...
    scAjaxProcOn();
    x_ajax_form_inv_recepcion_transferencia_mob_submit_form(var_tr_fecha, var_tr_bodega_origen, var_tr_info_adicional, var_tr_fecha_recibe, var_tr_establecimiento, var_tr_bodega_destino, var_tr_estado, var_tr_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_inv_recepcion_transferencia_mob_submit_form_cb);
  } // do_ajax_form_inv_recepcion_transferencia_mob_submit_form

  function do_ajax_form_inv_recepcion_transferencia_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("tr_fecha");
      scAjaxHideErrorDisplay("tr_bodega_origen");
      scAjaxHideErrorDisplay("tr_info_adicional");
      scAjaxHideErrorDisplay("tr_fecha_recibe");
      scAjaxHideErrorDisplay("tr_establecimiento");
      scAjaxHideErrorDisplay("tr_bodega_destino");
      scAjaxHideErrorDisplay("tr_estado");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_inv_recepcion_transferencia_mob_submit_form_cb_after_alert);
  } // do_ajax_form_inv_recepcion_transferencia_mob_submit_form_cb
  function do_ajax_form_inv_recepcion_transferencia_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_inv_recepcion_transferencia_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_inv_productos_transferencia_recibir_mob"] = "off";

  function do_ajax_form_inv_recepcion_transferencia_mob_navigate_form()
  {
    perform_ajax_form_inv_recepcion_transferencia_mob_navigate_form();
  }

  function perform_ajax_form_inv_recepcion_transferencia_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_inv_productos_transferencia_recibir_mob"] = "on";
    x_ajax_form_inv_recepcion_transferencia_mob_navigate_form(var_tr_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_inv_recepcion_transferencia_mob_navigate_form_cb);
  } // do_ajax_form_inv_recepcion_transferencia_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_inv_recepcion_transferencia_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_inv_recepcion_transferencia_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_inv_productos_transferencia_recibir_mob"] && "nmsc_iframe_liga_form_inv_productos_transferencia_recibir_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_inv_productos_transferencia_recibir_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_inv_productos_transferencia_recibir_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_inv_productos_transferencia_recibir_mob').contentWindow.nm_move('apl_detalhe', true, '400');
        document.getElementById('nmsc_iframe_liga_form_inv_productos_transferencia_recibir_mob').style.height = "400";
        document.getElementById('nmsc_iframe_liga_form_inv_productos_transferencia_recibir_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_inv_recepcion_transferencia_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_inv_recepcion_transferencia_mob_navigate_form_cb
  function do_ajax_form_inv_recepcion_transferencia_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_inv_recepcion_transferencia_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_inv_recepcion_transferencia_mob_navigate_form_cb_after_alert

  function sc_hide_form_inv_recepcion_transferencia_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_inv_productos_transferencia_recibir_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "tr_fecha";
  ajax_field_list[1] = "tr_bodega_origen";
  ajax_field_list[2] = "tr_info_adicional";
  ajax_field_list[3] = "tr_fecha_recibe";
  ajax_field_list[4] = "tr_establecimiento";
  ajax_field_list[5] = "tr_bodega_destino";
  ajax_field_list[6] = "tr_estado";
  ajax_field_list[7] = "productos";
  ...
  var ajax_error_list = {
    "tr_fecha": {"label": "<?php echo $this->Ini->Nm_lang['lang_fecha'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tr_bodega_origen": {"label": "<?php echo $this->Ini->Nm_lang['lang_bodega_origen'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tr_info_adicional": {"label": "<?php echo $this->Ini->Nm_lang['lang_comentario'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tr_fecha_recibe": {"label": "<?php echo $this->Ini->Nm_lang['lang_fecha_recepcion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tr_establecimiento": {"label": "<?php echo $this->Ini->Nm_lang['lang_establecimiento'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tr_bodega_destino": {"label": "<?php echo $this->Ini->Nm_lang['lang_bodega_destino'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tr_estado": {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "tr_fecha": new Array(),
    "tr_bodega_origen": new Array(),
    "tr_info_adicional": new Array(),
    "tr_fecha_recibe": new Array(),
    "tr_establecimiento": new Array(),
    "tr_bodega_destino": new Array(),
    "tr_estado": new Array(),
    "productos": new Array()
  };
  ajax_field_mult["tr_fecha"][1] = "tr_fecha";
  ajax_field_mult["tr_bodega_origen"][1] = "tr_bodega_origen";
  ajax_field_mult["tr_info_adicional"][1] = "tr_info_adicional";
  ajax_field_mult["tr_fecha_recibe"][1] = "tr_fecha_recibe";
  ajax_field_mult["tr_establecimiento"][1] = "tr_establecimiento";
  ajax_field_mult["tr_bodega_destino"][1] = "tr_bodega_destino";
  ajax_field_mult["tr_estado"][1] = "tr_estado";
  ajax_field_mult["productos"][1] = "productos";

  var ajax_field_id = {
    "tr_fecha": new Array("hidden_field_label_tr_fecha", "hidden_field_data_tr_fecha"),
    "tr_bodega_origen": new Array("hidden_field_label_tr_bodega_origen", "hidden_field_data_tr_bodega_origen"),
    "tr_info_adicional": new Array("hidden_field_label_tr_info_adicional", "hidden_field_data_tr_info_adicional"),
    "tr_fecha_recibe": new Array("hidden_field_label_tr_fecha_recibe", "hidden_field_data_tr_fecha_recibe"),
    "tr_establecimiento": new Array("hidden_field_label_tr_establecimiento", "hidden_field_data_tr_establecimiento"),
    "tr_bodega_destino": new Array("hidden_field_label_tr_bodega_destino", "hidden_field_data_tr_bodega_destino"),
  ...
  var ajax_read_only = {
    "tr_fecha": "on",
    "tr_bodega_origen": "on",
    "tr_info_adicional": "on",
    "tr_fecha_recibe": "off",
    "tr_establecimiento": "on",
    "tr_bodega_destino": "on",
    "tr_estado": "on",
    "productos": "off"
  };
