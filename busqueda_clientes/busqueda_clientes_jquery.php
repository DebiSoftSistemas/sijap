...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_grupo' + iSeqRow).bind('blur', function() { sc_busqueda_clientes_grupo_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_busqueda_clientes_grupo_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_busqueda_clientes_grupo_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_busqueda_clientes_grupo_onblur(oThis, iSeqRow) {
  do_ajax_busqueda_clientes_validate_grupo();
  scCssBlur(oThis);
}

function sc_busqueda_clientes_grupo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_busqueda_clientes_grupo_onfocus(oThis, iSeqRow) {
...
function scHidePage(pageNo) {
	$("#id_busqueda_clientes_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'busqueda_clientes')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
