...
<?php
   ...
   $Ord_Cmp = new grid_jap_materiales_contrato_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_jap_materiales_contrato_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_jap_materiales_contrato']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_jap_materiales_contrato']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['mc_producto'] = "mc_producto";
   $tab_labels["mc_producto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_materiales_contrato']['labels']["mc_producto"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_materiales_contrato']['labels']["mc_producto"] : "" . $this->Nm_lang['lang_producto'] . "";
   $tab_ger_campos['mc_unidad'] = "on";
   $tab_def_campos['mc_unidad'] = "mc_unidad";
   $tab_labels["mc_unidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_materiales_contrato']['labels']["mc_unidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_materiales_contrato']['labels']["mc_unidad"] : "" . $this->Nm_lang['lang_unidad'] . "";
   $tab_ger_campos['mc_cantidad'] = "on";
   $tab_def_campos['mc_cantidad'] = "mc_cantidad";
   $tab_labels["mc_cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_materiales_contrato']['labels']["mc_cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_materiales_contrato']['labels']["mc_cantidad"] : "" . $this->Nm_lang['lang_cantidad'] . "";
   $tab_ger_campos['mc_precio_unitario'] = "on";
   $tab_def_campos['mc_precio_unitario'] = "mc_precio_unitario";
   $tab_labels["mc_precio_unitario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_materiales_contrato']['labels']["mc_precio_unitario"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_materiales_contrato']['labels']["mc_precio_unitario"] : "" . $this->Nm_lang['lang_precio_unitario'] . "";
   $tab_ger_campos['mc_subtotal'] = "on";
   $tab_def_campos['mc_subtotal'] = "mc_subtotal";
   $tab_labels["mc_subtotal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_materiales_contrato']['labels']["mc_subtotal"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_materiales_contrato']['labels']["mc_subtotal"] : "" . $this->Nm_lang['lang_subtotal'] . "";
   $tab_ger_campos['mc_iva'] = "on";
   $tab_def_campos['mc_iva'] = "mc_iva";
   $tab_labels["mc_iva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_materiales_contrato']['labels']["mc_iva"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_materiales_contrato']['labels']["mc_iva"] : "" . $this->Nm_lang['lang_iva'] . "";
   $tab_ger_campos['mc_total'] = "on";
   $tab_def_campos['mc_total'] = "mc_total";
   $tab_labels["mc_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_materiales_contrato']['labels']["mc_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_materiales_contrato']['labels']["mc_total"] : "" . $this->Nm_lang['lang_total'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_jap_materiales_contrato']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_jap_materiales_contrato']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_jap_materiales_contrato']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_jap_materiales_contrato']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_jap_materiales_contrato']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_jap_materiales_contrato']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_jap_materiales_contrato']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_jap_materiales_contrato']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_jap_materiales_contrato']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_jap_materiales_contrato']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_jap_materiales_contrato']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_jap_materiales_contrato']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_jap_materiales_contrato_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_jap_materiales_contrato']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_jap_materiales_contrato']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_jap_materiales_contrato']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_jap_materiales_contrato']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_jap_materiales_contrato']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
