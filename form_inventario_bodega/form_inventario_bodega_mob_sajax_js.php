  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_inventario_bodega_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_inventario_bodega_mob_form();
	}
...
?>
  ...
  // ---------- Validate bo_id
  function do_ajax_form_inventario_bodega_mob_validate_bo_id()
  {
    var nomeCampo_bo_id = "bo_id";
    var var_bo_id = scAjaxGetFieldText(nomeCampo_bo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inventario_bodega_mob_validate_bo_id(var_bo_id, var_script_case_init, do_ajax_form_inventario_bodega_mob_validate_bo_id_cb);
  } // do_ajax_form_inventario_bodega_mob_validate_bo_id

  function do_ajax_form_inventario_bodega_mob_validate_bo_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inventario_bodega_mob_validate_bo_id_cb

  // ---------- Validate bo_establecimiento
  function do_ajax_form_inventario_bodega_mob_validate_bo_establecimiento()
  {
    var nomeCampo_bo_establecimiento = "bo_establecimiento";
    var var_bo_establecimiento = scAjaxGetFieldText(nomeCampo_bo_establecimiento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inventario_bodega_mob_validate_bo_establecimiento(var_bo_establecimiento, var_script_case_init, do_ajax_form_inventario_bodega_mob_validate_bo_establecimiento_cb);
  } // do_ajax_form_inventario_bodega_mob_validate_bo_establecimiento

  function do_ajax_form_inventario_bodega_mob_validate_bo_establecimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inventario_bodega_mob_validate_bo_establecimiento_cb

  // ---------- Validate bo_nombre
  function do_ajax_form_inventario_bodega_mob_validate_bo_nombre()
  {
    var nomeCampo_bo_nombre = "bo_nombre";
    var var_bo_nombre = scAjaxGetFieldText(nomeCampo_bo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inventario_bodega_mob_validate_bo_nombre(var_bo_nombre, var_script_case_init, do_ajax_form_inventario_bodega_mob_validate_bo_nombre_cb);
  } // do_ajax_form_inventario_bodega_mob_validate_bo_nombre

  function do_ajax_form_inventario_bodega_mob_validate_bo_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inventario_bodega_mob_validate_bo_nombre_cb

  // ---------- Validate productos
  function do_ajax_form_inventario_bodega_mob_validate_productos()
  {
    var nomeCampo_productos = "productos";
    var var_productos = scAjaxGetFieldText(nomeCampo_productos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inventario_bodega_mob_validate_productos(var_productos, var_script_case_init, do_ajax_form_inventario_bodega_mob_validate_productos_cb);
  } // do_ajax_form_inventario_bodega_mob_validate_productos

  function do_ajax_form_inventario_bodega_mob_validate_productos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inventario_bodega_mob_validate_productos_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_inventario_bodega_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_inventario_bodega_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_bo_id = scAjaxGetFieldText("bo_id");
    var var_bo_establecimiento = scAjaxGetFieldText("bo_establecimiento");
    ...
    scAjaxProcOn();
    x_ajax_form_inventario_bodega_mob_submit_form(var_bo_id, var_bo_establecimiento, var_bo_nombre, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_inventario_bodega_mob_submit_form_cb);
  } // do_ajax_form_inventario_bodega_mob_submit_form

  function do_ajax_form_inventario_bodega_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_inventario_bodega_mob_submit_form_cb_after_alert);
  } // do_ajax_form_inventario_bodega_mob_submit_form_cb
  function do_ajax_form_inventario_bodega_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_inventario_bodega_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_inv_inventario_mob"] = "off";

  function do_ajax_form_inventario_bodega_mob_navigate_form()
  {
    perform_ajax_form_inventario_bodega_mob_navigate_form();
  }

  function perform_ajax_form_inventario_bodega_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_inv_inventario_mob"] = "on";
    x_ajax_form_inventario_bodega_mob_navigate_form(var_bo_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_inventario_bodega_mob_navigate_form_cb);
  } // do_ajax_form_inventario_bodega_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_inventario_bodega_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_inventario_bodega_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_inv_inventario_mob"] && "nmsc_iframe_liga_form_inv_inventario_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_inv_inventario_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_inv_inventario_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_inv_inventario_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_inv_inventario_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_inv_inventario_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_inventario_bodega_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_inventario_bodega_mob_navigate_form_cb
  function do_ajax_form_inventario_bodega_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_inventario_bodega_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_inventario_bodega_mob_navigate_form_cb_after_alert

  function sc_hide_form_inventario_bodega_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_inv_inventario_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[1] = "bo_establecimiento";
  ajax_field_list[2] = "bo_nombre";
