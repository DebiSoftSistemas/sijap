  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_fac_operaciones_anular" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_fac_operaciones_anular_form();
	}
...
?>
  ...
  // ---------- Validate oa_solicitud_
  function do_ajax_form_fac_operaciones_anular_validate_oa_solicitud_(iNumLinha)
  {
    var nomeCampo_oa_solicitud_ = "oa_solicitud_" + iNumLinha;
    var var_oa_solicitud_ = scAjaxGetFieldText(nomeCampo_oa_solicitud_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operaciones_anular_validate_oa_solicitud_(var_oa_solicitud_, iNumLinha, var_script_case_init, do_ajax_form_fac_operaciones_anular_validate_oa_solicitud__cb);
  } // do_ajax_form_fac_operaciones_anular_validate_oa_solicitud_

  function do_ajax_form_fac_operaciones_anular_validate_oa_solicitud__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "oa_solicitud_" + iLineNumber;
    }
    else
    {
      sFieldValid = "oa_solicitud_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "oa_solicitud_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "oa_solicitud_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operaciones_anular_validate_oa_solicitud__cb

  // ---------- Validate oa_operacion_
  function do_ajax_form_fac_operaciones_anular_validate_oa_operacion_(iNumLinha)
  {
    var nomeCampo_oa_operacion_ = "oa_operacion_" + iNumLinha;
    var var_oa_operacion_ = scAjaxGetFieldText(nomeCampo_oa_operacion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operaciones_anular_validate_oa_operacion_(var_oa_operacion_, iNumLinha, var_script_case_init, do_ajax_form_fac_operaciones_anular_validate_oa_operacion__cb);
  } // do_ajax_form_fac_operaciones_anular_validate_oa_operacion_

  function do_ajax_form_fac_operaciones_anular_validate_oa_operacion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "oa_operacion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "oa_operacion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "oa_operacion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "oa_operacion_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operaciones_anular_validate_oa_operacion__cb

  // ---------- Validate oa_tipo_cartera_
  function do_ajax_form_fac_operaciones_anular_validate_oa_tipo_cartera_(iNumLinha)
  {
    var nomeCampo_oa_tipo_cartera_ = "oa_tipo_cartera_" + iNumLinha;
    var var_oa_tipo_cartera_ = scAjaxGetFieldText(nomeCampo_oa_tipo_cartera_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operaciones_anular_validate_oa_tipo_cartera_(var_oa_tipo_cartera_, iNumLinha, var_script_case_init, do_ajax_form_fac_operaciones_anular_validate_oa_tipo_cartera__cb);
  } // do_ajax_form_fac_operaciones_anular_validate_oa_tipo_cartera_

  function do_ajax_form_fac_operaciones_anular_validate_oa_tipo_cartera__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "oa_tipo_cartera_" + iLineNumber;
    }
    else
    {
      sFieldValid = "oa_tipo_cartera_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "oa_tipo_cartera_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "oa_tipo_cartera_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operaciones_anular_validate_oa_tipo_cartera__cb

  // ---------- Validate oa_comentario_
  function do_ajax_form_fac_operaciones_anular_validate_oa_comentario_(iNumLinha)
  {
    var nomeCampo_oa_comentario_ = "oa_comentario_" + iNumLinha;
    var var_oa_comentario_ = scAjaxGetFieldText(nomeCampo_oa_comentario_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operaciones_anular_validate_oa_comentario_(var_oa_comentario_, iNumLinha, var_script_case_init, do_ajax_form_fac_operaciones_anular_validate_oa_comentario__cb);
  } // do_ajax_form_fac_operaciones_anular_validate_oa_comentario_

  function do_ajax_form_fac_operaciones_anular_validate_oa_comentario__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "oa_comentario_" + iLineNumber;
    }
    else
    {
      sFieldValid = "oa_comentario_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "oa_comentario_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "oa_comentario_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operaciones_anular_validate_oa_comentario__cb

  // ---------- Validate oa_referencia_
  function do_ajax_form_fac_operaciones_anular_validate_oa_referencia_(iNumLinha)
  {
    var nomeCampo_oa_referencia_ = "oa_referencia_" + iNumLinha;
    var var_oa_referencia_ = scAjaxGetFieldText(nomeCampo_oa_referencia_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operaciones_anular_validate_oa_referencia_(var_oa_referencia_, iNumLinha, var_script_case_init, do_ajax_form_fac_operaciones_anular_validate_oa_referencia__cb);
  } // do_ajax_form_fac_operaciones_anular_validate_oa_referencia_

  function do_ajax_form_fac_operaciones_anular_validate_oa_referencia__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "oa_referencia_" + iLineNumber;
    }
    else
    {
      sFieldValid = "oa_referencia_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "oa_referencia_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "oa_referencia_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operaciones_anular_validate_oa_referencia__cb

  // ---------- Validate oa_saldo_
  function do_ajax_form_fac_operaciones_anular_validate_oa_saldo_(iNumLinha)
  {
    var nomeCampo_oa_saldo_ = "oa_saldo_" + iNumLinha;
    var var_oa_saldo_ = scAjaxGetFieldText(nomeCampo_oa_saldo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operaciones_anular_validate_oa_saldo_(var_oa_saldo_, iNumLinha, var_script_case_init, do_ajax_form_fac_operaciones_anular_validate_oa_saldo__cb);
  } // do_ajax_form_fac_operaciones_anular_validate_oa_saldo_

  function do_ajax_form_fac_operaciones_anular_validate_oa_saldo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "oa_saldo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "oa_saldo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "oa_saldo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "oa_saldo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operaciones_anular_validate_oa_saldo__cb

  // ---------- Validate oa_estado_
  function do_ajax_form_fac_operaciones_anular_validate_oa_estado_(iNumLinha)
  {
    var nomeCampo_oa_estado_ = "oa_estado_" + iNumLinha;
    var var_oa_estado_ = scAjaxGetFieldText(nomeCampo_oa_estado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operaciones_anular_validate_oa_estado_(var_oa_estado_, iNumLinha, var_script_case_init, do_ajax_form_fac_operaciones_anular_validate_oa_estado__cb);
  } // do_ajax_form_fac_operaciones_anular_validate_oa_estado_

  function do_ajax_form_fac_operaciones_anular_validate_oa_estado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "oa_estado_" + iLineNumber;
    }
    else
    {
      sFieldValid = "oa_estado_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "oa_estado_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "oa_estado_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operaciones_anular_validate_oa_estado__cb

  // ---------- Validate oa_id_
  function do_ajax_form_fac_operaciones_anular_validate_oa_id_(iNumLinha)
  {
    var nomeCampo_oa_id_ = "oa_id_" + iNumLinha;
    var var_oa_id_ = scAjaxGetFieldText(nomeCampo_oa_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operaciones_anular_validate_oa_id_(var_oa_id_, iNumLinha, var_script_case_init, do_ajax_form_fac_operaciones_anular_validate_oa_id__cb);
  } // do_ajax_form_fac_operaciones_anular_validate_oa_id_

  function do_ajax_form_fac_operaciones_anular_validate_oa_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "oa_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "oa_id_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "oa_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "oa_id_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_operaciones_anular_validate_oa_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_fac_operaciones_anular_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_fac_operaciones_anular_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_fac_operaciones_anular_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_fac_operaciones_anular_add_new_line_cb);
  } // do_ajax_form_fac_operaciones_anular_add_new_line

  function do_ajax_form_fac_operaciones_anular_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_fac_operaciones_anular_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_fac_operaciones_anular_backup_line(iNumLinha)
  {
    var var_oa_id_ = scAjaxGetFieldText("oa_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_operaciones_anular_backup_line(var_oa_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_fac_operaciones_anular_backup_line_cb);
  } // do_ajax_form_fac_operaciones_anular_backup_line

  function do_ajax_form_fac_operaciones_anular_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_fac_operaciones_anular_backup_line_cb

  function do_ajax_form_fac_operaciones_anular_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_fac_operaciones_anular_cancel_insert

  function do_ajax_form_fac_operaciones_anular_cancel_update(iSeqVert)
  {
    do_ajax_form_fac_operaciones_anular_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_fac_operaciones_anular_cancel_update

  function do_ajax_form_fac_operaciones_anular_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_fac_operaciones_anular_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_fac_operaciones_anular_table_refresh()
  {
    var var_oa_id_ = document.F2.oa_id_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_fac_operaciones_anular_table_refresh(var_oa_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_operaciones_anular_table_refresh_cb);
  } //  do_ajax_form_fac_operaciones_anular_table_refresh

  function do_ajax_form_fac_operaciones_anular_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.oa_id_.value = scAjaxGetKeyValue("oa_id_");
    ...
    scAjaxAlert(do_ajax_form_fac_operaciones_anular_table_refresh_cb_after_alert);
  } // do_ajax_form_fac_operaciones_anular_table_refresh_cb
  function do_ajax_form_fac_operaciones_anular_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_fac_operaciones_anular_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_fac_operaciones_anular_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_fac_operaciones_anular_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_oa_solicitud_ = scAjaxGetFieldText("oa_solicitud_" + iNumLinha);
    var var_oa_operacion_ = scAjaxGetFieldText("oa_operacion_" + iNumLinha);
    var var_oa_tipo_cartera_ = scAjaxGetFieldText("oa_tipo_cartera_" + iNumLinha);
    var var_oa_comentario_ = scAjaxGetFieldText("oa_comentario_" + iNumLinha);
    var var_oa_referencia_ = scAjaxGetFieldText("oa_referencia_" + iNumLinha);
    var var_oa_saldo_ = scAjaxGetFieldText("oa_saldo_" + iNumLinha);
    var var_oa_estado_ = scAjaxGetFieldText("oa_estado_" + iNumLinha);
    var var_oa_id_ = scAjaxGetFieldText("oa_id_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_fac_operaciones_anular_submit_form(var_oa_solicitud_, var_oa_operacion_, var_oa_tipo_cartera_, var_oa_comentario_, var_oa_referencia_, var_oa_saldo_, var_oa_estado_, var_oa_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_fac_operaciones_anular_submit_form_cb);
  } // do_ajax_form_fac_operaciones_anular_submit_form

  function do_ajax_form_fac_operaciones_anular_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("oa_solicitud_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("oa_operacion_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("oa_tipo_cartera_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("oa_comentario_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("oa_referencia_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("oa_saldo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("oa_estado_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("oa_id_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_fac_operaciones_anular_submit_form_cb_after_alert);
  } // do_ajax_form_fac_operaciones_anular_submit_form_cb
  function do_ajax_form_fac_operaciones_anular_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_fac_operaciones_anular_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_fac_operaciones_anular_navigate_form()
  {
    perform_ajax_form_fac_operaciones_anular_navigate_form();
  }

  function perform_ajax_form_fac_operaciones_anular_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_fac_operaciones_anular_cancel_insert(sc_form_fac_operaciones_anular_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("oa_solicitud_" + iNavForm);
      scAjaxHideErrorDisplay("oa_operacion_" + iNavForm);
      scAjaxHideErrorDisplay("oa_tipo_cartera_" + iNavForm);
      scAjaxHideErrorDisplay("oa_comentario_" + iNavForm);
      scAjaxHideErrorDisplay("oa_referencia_" + iNavForm);
      scAjaxHideErrorDisplay("oa_saldo_" + iNavForm);
      scAjaxHideErrorDisplay("oa_estado_" + iNavForm);
      scAjaxHideErrorDisplay("oa_id_" + iNavForm);
    }
    var var_oa_id_ = document.F2.oa_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_fac_operaciones_anular_navigate_form(var_oa_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_operaciones_anular_navigate_form_cb);
  } // do_ajax_form_fac_operaciones_anular_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_operaciones_anular']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_fac_operaciones_anular_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.oa_id_.value = scAjaxGetKeyValue("oa_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_fac_operaciones_anular_navigate_form_cb_after_alert);
  } // do_ajax_form_fac_operaciones_anular_navigate_form_cb
  function do_ajax_form_fac_operaciones_anular_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_fac_operaciones_anular_navigate_form_cb_after_alert

    function sc_form_fac_operaciones_anular_get_last_line_number()
    {
    ...
    } //sc_form_fac_operaciones_anular_get_last_line_number

  function sc_hide_form_fac_operaciones_anular_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "oa_solicitud_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "oa_operacion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "oa_tipo_cartera_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "oa_comentario_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "oa_referencia_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "oa_saldo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "oa_estado_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "oa_id_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["oa_solicitud_" + iNumLinha] = {"label": "lang_solicitud}<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["oa_operacion_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_operacion'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["oa_tipo_cartera_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tipo_cartera'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["oa_comentario_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_comentario'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["oa_referencia_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_referencia'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["oa_saldo_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_saldo'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["oa_estado_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["oa_id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["oa_solicitud_"][iNumLinha] = "oa_solicitud_" + iNumLinha;
    ajax_field_mult["oa_operacion_"][iNumLinha] = "oa_operacion_" + iNumLinha;
    ajax_field_mult["oa_tipo_cartera_"][iNumLinha] = "oa_tipo_cartera_" + iNumLinha;
    ajax_field_mult["oa_comentario_"][iNumLinha] = "oa_comentario_" + iNumLinha;
    ajax_field_mult["oa_referencia_"][iNumLinha] = "oa_referencia_" + iNumLinha;
    ajax_field_mult["oa_saldo_"][iNumLinha] = "oa_saldo_" + iNumLinha;
    ajax_field_mult["oa_estado_"][iNumLinha] = "oa_estado_" + iNumLinha;
    ajax_field_mult["oa_id_"][iNumLinha] = "oa_id_" + iNumLinha;
    ajax_field_id["oa_operacion_" + iNumLinha] = new Array("hidden_field_label_oa_operacion_", "hidden_field_data_oa_operacion_" + iNumLinha);
    ajax_field_id["oa_tipo_cartera_" + iNumLinha] = new Array("hidden_field_label_oa_tipo_cartera_", "hidden_field_data_oa_tipo_cartera_" + iNumLinha);
    ajax_field_id["oa_comentario_" + iNumLinha] = new Array("hidden_field_label_oa_comentario_", "hidden_field_data_oa_comentario_" + iNumLinha);
    ajax_field_id["oa_referencia_" + iNumLinha] = new Array("hidden_field_label_oa_referencia_", "hidden_field_data_oa_referencia_" + iNumLinha);
    ajax_field_id["oa_saldo_" + iNumLinha] = new Array("hidden_field_label_oa_saldo_", "hidden_field_data_oa_saldo_" + iNumLinha);
    ajax_field_id["oa_estado_" + iNumLinha] = new Array("hidden_field_label_oa_estado_", "hidden_field_data_oa_estado_" + iNumLinha);
    ajax_error_count["oa_solicitud_" + iNumLinha] = "off";
    ajax_error_count["oa_operacion_" + iNumLinha] = "off";
    ajax_error_count["oa_tipo_cartera_" + iNumLinha] = "off";
    ajax_error_count["oa_comentario_" + iNumLinha] = "off";
    ajax_error_count["oa_referencia_" + iNumLinha] = "off";
    ajax_error_count["oa_saldo_" + iNumLinha] = "off";
    ajax_error_count["oa_estado_" + iNumLinha] = "off";
    ajax_error_count["oa_id_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["oa_solicitud_" + iNumLinha] = "off";
    ajax_read_only["oa_operacion_" + iNumLinha] = "off";
    ajax_read_only["oa_tipo_cartera_" + iNumLinha] = "off";
    ajax_read_only["oa_comentario_" + iNumLinha] = "off";
    ajax_read_only["oa_referencia_" + iNumLinha] = "off";
    ajax_read_only["oa_saldo_" + iNumLinha] = "off";
    ajax_read_only["oa_estado_" + iNumLinha] = "off";
    ajax_read_only["oa_id_" + iNumLinha] = "on";
<?php
}
else
{
?>
    ajax_read_only["oa_solicitud_" + iNumLinha] = "on";
    ajax_read_only["oa_operacion_" + iNumLinha] = "on";
    ajax_read_only["oa_tipo_cartera_" + iNumLinha] = "on";
    ajax_read_only["oa_comentario_" + iNumLinha] = "on";
    ajax_read_only["oa_referencia_" + iNumLinha] = "on";
    ajax_read_only["oa_saldo_" + iNumLinha] = "on";
    ajax_read_only["oa_estado_" + iNumLinha] = "on";
    ajax_read_only["oa_id_" + iNumLinha] = "on";
<?php
}
?>
  ...
  {
    ajax_error_list["oa_solicitud_" + iNumLinha] = null;
    ajax_error_list["oa_operacion_" + iNumLinha] = null;
    ajax_error_list["oa_tipo_cartera_" + iNumLinha] = null;
    ajax_error_list["oa_comentario_" + iNumLinha] = null;
    ajax_error_list["oa_referencia_" + iNumLinha] = null;
    ajax_error_list["oa_saldo_" + iNumLinha] = null;
    ajax_error_list["oa_estado_" + iNumLinha] = null;
    ajax_error_list["oa_id_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "oa_solicitud_": new Array(),
    "oa_operacion_": new Array(),
    "oa_tipo_cartera_": new Array(),
    "oa_comentario_": new Array(),
    "oa_referencia_": new Array(),
    "oa_saldo_": new Array(),
    "oa_estado_": new Array(),
    "oa_id_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["oa_solicitud_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["oa_solicitud_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["oa_solicitud_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["oa_solicitud_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["oa_solicitud_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["oa_operacion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["oa_operacion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["oa_operacion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["oa_operacion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["oa_operacion_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["oa_tipo_cartera_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["oa_tipo_cartera_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["oa_tipo_cartera_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["oa_tipo_cartera_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["oa_tipo_cartera_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["oa_comentario_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["oa_comentario_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["oa_comentario_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["oa_comentario_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["oa_comentario_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["oa_referencia_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["oa_referencia_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["oa_referencia_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["oa_referencia_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["oa_referencia_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["oa_saldo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["oa_saldo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["oa_saldo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["oa_saldo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["oa_saldo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["oa_estado_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["oa_estado_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["oa_estado_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["oa_estado_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["oa_estado_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["oa_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["oa_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["oa_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["oa_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["oa_id_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['oa_solicitud_'])) ? $this->nmgp_cmp_readonly['oa_solicitud_'] : 'off';
?>
    scAjaxFieldRead("oa_solicitud_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['oa_operacion_'])) ? $this->nmgp_cmp_readonly['oa_operacion_'] : 'off';
?>
    scAjaxFieldRead("oa_operacion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['oa_tipo_cartera_'])) ? $this->nmgp_cmp_readonly['oa_tipo_cartera_'] : 'off';
?>
    scAjaxFieldRead("oa_tipo_cartera_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['oa_comentario_'])) ? $this->nmgp_cmp_readonly['oa_comentario_'] : 'off';
?>
    scAjaxFieldRead("oa_comentario_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['oa_referencia_'])) ? $this->nmgp_cmp_readonly['oa_referencia_'] : 'off';
?>
    scAjaxFieldRead("oa_referencia_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['oa_saldo_'])) ? $this->nmgp_cmp_readonly['oa_saldo_'] : 'off';
?>
    scAjaxFieldRead("oa_saldo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['oa_estado_'])) ? $this->nmgp_cmp_readonly['oa_estado_'] : 'off';
?>
    scAjaxFieldRead("oa_estado_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['oa_id_'])) ? $this->nmgp_cmp_readonly['oa_id_'] : 'on';
?>
    scAjaxFieldRead("oa_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("oa_solicitud_" + iSeq, "on");
    scAjaxFieldRead("oa_operacion_" + iSeq, "on");
    scAjaxFieldRead("oa_tipo_cartera_" + iSeq, "on");
    scAjaxFieldRead("oa_comentario_" + iSeq, "on");
    scAjaxFieldRead("oa_referencia_" + iSeq, "on");
    scAjaxFieldRead("oa_saldo_" + iSeq, "on");
    scAjaxFieldRead("oa_estado_" + iSeq, "on");
    scAjaxFieldRead("oa_id_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["oa_solicitud_" + iRow] || "on" == ajax_error_count["oa_operacion_" + iRow] || "on" == ajax_error_count["oa_tipo_cartera_" + iRow] || "on" == ajax_error_count["oa_comentario_" + iRow] || "on" == ajax_error_count["oa_referencia_" + iRow] || "on" == ajax_error_count["oa_saldo_" + iRow] || "on" == ajax_error_count["oa_estado_" + iRow] || "on" == ajax_error_count["oa_id_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_oa_solicitud_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_oa_operacion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_oa_tipo_cartera_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_oa_comentario_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_oa_referencia_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_oa_saldo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_oa_estado_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_oa_id_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["oa_solicitud_" + iRow] && "off" == ajax_error_count["oa_operacion_" + iRow] && "off" == ajax_error_count["oa_tipo_cartera_" + iRow] && "off" == ajax_error_count["oa_comentario_" + iRow] && "off" == ajax_error_count["oa_referencia_" + iRow] && "off" == ajax_error_count["oa_saldo_" + iRow] && "off" == ajax_error_count["oa_estado_" + iRow] && "off" == ajax_error_count["oa_id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["oa_solicitud_" + iRow] = "off";
        ajax_error_count["oa_operacion_" + iRow] = "off";
        ajax_error_count["oa_tipo_cartera_" + iRow] = "off";
        ajax_error_count["oa_comentario_" + iRow] = "off";
        ajax_error_count["oa_referencia_" + iRow] = "off";
        ajax_error_count["oa_saldo_" + iRow] = "off";
        ajax_error_count["oa_estado_" + iRow] = "off";
        ajax_error_count["oa_id_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_oa_solicitud_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_oa_operacion_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_oa_tipo_cartera_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_oa_comentario_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_oa_referencia_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_oa_saldo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_oa_estado_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_oa_id_" + iRow).removeClass("scFormErrorLine");
    }
  }
