...
class grid_corte_inventario_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
...
SCEOT;
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_corte_inventario']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_corte_inventario']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['where_resumo'] = "";
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['contr_total_geral'] == "OK")
      {
          $this->array_total_kar_bodega = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['arr_total']['kar_bodega'];
      }
      else
      {
          $this->array_total_kar_bodega = array();
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['arr_total']['kar_bodega'] = $this->array_total_kar_bodega;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['json_use_label'])
       {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['labels']['pro_codigo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['labels']['pro_codigo'] = "" . $this->Ini->Nm_lang['lang_codigo'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['labels']['pro_descripcion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['labels']['pro_descripcion'] = "" . $this->Ini->Nm_lang['lang_descripcion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['labels']['kar_unidad']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['labels']['kar_unidad'] = "" . $this->Ini->Nm_lang['lang_unidad'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['labels']['cant_inicial']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['labels']['cant_inicial'] = "" . $this->Ini->Nm_lang['lang_cantidad_inicial'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['labels']['valor_inicial']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['labels']['valor_inicial'] = "Valor Inicial"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['labels']['total_ingreso']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['labels']['total_ingreso'] = "Cant. Ingreso"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['labels']['valor_ingreso']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['labels']['valor_ingreso'] = "Valor Ingreso"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['labels']['total_salida']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['labels']['total_salida'] = "Total Salida"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['labels']['valor_salida']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['labels']['valor_salida'] = "Valor Salida"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['labels']['cant_existencia']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['labels']['cant_existencia'] = "Cant. Existencia"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['labels']['valor_existencia']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['labels']['valor_existencia'] = "Valor Existencia"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['labels']['kar_bodega']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['labels']['kar_bodega'] = "" . $this->Ini->Nm_lang['lang_bodega'] . ""; 
       }
       //-----
       $this->comp_field_nm = array(
           'kar_bodega' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['summarizing_fields_order']['kar_bodega']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['summarizing_fields_order']['kar_bodega'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['summarizing_fields_order']['kar_bodega'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['summarizing_fields_display']['kar_bodega'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['summarizing_fields_display']['kar_bodega'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['summarizing_fields_display']['kar_bodega'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['summarizing_fields_display']['kar_bodega'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['summarizing_fields_display']['kar_bodega'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['summarizing_fields_display']['kar_bodega'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['summarizing_fields_display']['kar_bodega'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_kar_bodega as $i_kar_bodega => $d_kar_bodega) {
           if (!isset($i_kar_bodega, $this->comp_label[0]) || !in_array($i_kar_bodega, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_kar_bodega[10] ] = $d_kar_bodega[9];
               $this->comp_label[0][ $d_kar_bodega[10] ] = $d_kar_bodega[9];
           }
       }
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_corte_inventario@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialOrderFA = '';
                       ...
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['proc_pdf_vert']){ 
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_corte_inventario_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['dashboard_refresh_after_chart'] = 'resumo';
...
$nm_saida->saida("    </style>\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_corte_inventario_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_corte_inventario_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_corte_inventario_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_corte_inventario/grid_corte_inventario_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_corte_inventario/grid_corte_inventario_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_corte_inventario&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid&nm_all_modules=grid&password=n&summary_export_columns=S&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_corte_inventario_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_corte_inventario']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_corte_inventario']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_corte_inventario_config_pivot.php?nome_apl=grid_corte_inventario&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"grid_corte_inventario_iframe.php\";\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_corte_inventario_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_corte_inventario/grid_corte_inventario_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corte_inventario']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
   ...
   //---- 
   function adiciona_registro($sum_cant_inicial, $sum_valor_inicial, $sum_total_ingreso, $sum_valor_ingreso, $sum_total_salida, $sum_valor_salida, $sum_cant_existencia, $sum_valor_existencia, $quebra_kar_bodega, $quebra_kar_bodega_orig)
   {
      //----- kar_bodega
      if (!isset($this->array_total_kar_bodega[$quebra_kar_bodega_orig]))
      {
         $this->array_total_kar_bodega[$quebra_kar_bodega_orig][0] = 1;
         $this->array_total_kar_bodega[$quebra_kar_bodega_orig][1] = $sum_cant_inicial;
         $this->array_total_kar_bodega[$quebra_kar_bodega_orig][2] = $sum_valor_inicial;
         $this->array_total_kar_bodega[$quebra_kar_bodega_orig][3] = $sum_total_ingreso;
         $this->array_total_kar_bodega[$quebra_kar_bodega_orig][4] = $sum_valor_ingreso;
         $this->array_total_kar_bodega[$quebra_kar_bodega_orig][5] = $sum_total_salida;
         $this->array_total_kar_bodega[$quebra_kar_bodega_orig][6] = $sum_valor_salida;
         $this->array_total_kar_bodega[$quebra_kar_bodega_orig][7] = $sum_cant_existencia;
         $this->array_total_kar_bodega[$quebra_kar_bodega_orig][8] = $sum_valor_existencia;
         $this->array_total_kar_bodega[$quebra_kar_bodega_orig][9] = $quebra_kar_bodega;
         $this->array_total_kar_bodega[$quebra_kar_bodega_orig][10] = $quebra_kar_bodega_orig;
      }
      else
      {
         $this->array_total_kar_bodega[$quebra_kar_bodega_orig][0]++;
         $this->array_total_kar_bodega[$quebra_kar_bodega_orig][1] = bcadd($this->array_total_kar_bodega[$quebra_kar_bodega_orig][1], $sum_cant_inicial, 10);
         $this->array_total_kar_bodega[$quebra_kar_bodega_orig][2] = bcadd($this->array_total_kar_bodega[$quebra_kar_bodega_orig][2], $sum_valor_inicial, 10);
         $this->array_total_kar_bodega[$quebra_kar_bodega_orig][3] = bcadd($this->array_total_kar_bodega[$quebra_kar_bodega_orig][3], $sum_total_ingreso, 10);
         $this->array_total_kar_bodega[$quebra_kar_bodega_orig][4] = bcadd($this->array_total_kar_bodega[$quebra_kar_bodega_orig][4], $sum_valor_ingreso, 10);
         $this->array_total_kar_bodega[$quebra_kar_bodega_orig][5] = bcadd($this->array_total_kar_bodega[$quebra_kar_bodega_orig][5], $sum_total_salida, 10);
         $this->array_total_kar_bodega[$quebra_kar_bodega_orig][6] = bcadd($this->array_total_kar_bodega[$quebra_kar_bodega_orig][6], $sum_valor_salida, 10);
         $this->array_total_kar_bodega[$quebra_kar_bodega_orig][7] = bcadd($this->array_total_kar_bodega[$quebra_kar_bodega_orig][7], $sum_cant_existencia, 10);
         $this->array_total_kar_bodega[$quebra_kar_bodega_orig][8] = bcadd($this->array_total_kar_bodega[$quebra_kar_bodega_orig][8], $sum_valor_existencia, 10);
      }
   }
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->kar_unidad = $rs_res->fields[2] ;  
            $this->cant_inicial = $rs_res->fields[3] ;  
            $this->valor_inicial = $rs_res->fields[4] ;  
            $this->total_ingreso = $rs_res->fields[5] ;  
            $this->valor_ingreso = $rs_res->fields[6] ;  
            $this->total_salida = $rs_res->fields[7] ;  
            $this->valor_salida = $rs_res->fields[8] ;  
            $this->cant_existencia = $rs_res->fields[9] ;  
            $this->valor_existencia = $rs_res->fields[10] ;  
            $this->kar_bodega = $rs_res->fields[11] ;  
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->cant_inicial, $this->valor_inicial, $this->total_ingreso, $this->valor_ingreso, $this->total_salida, $this->valor_salida, $this->cant_existencia, $this->valor_existencia, $this->kar_bodega, $this->kar_bodega_orig);
            }
   }
//
