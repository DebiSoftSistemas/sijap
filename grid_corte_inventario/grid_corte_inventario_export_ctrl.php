<?php
@session_start() ;
$_SESSION['scriptcase']['grid_corte_inventario']['sc_process_barr'] = true;
require_once('../grid_corte_inventario/index.php');
unset($_SESSION['scriptcase']['grid_corte_inventario']['sc_process_barr']);
$ExportCtrl = new grid_corte_inventario_export_control;
$ExportCtrl->Export_barr();

class grid_corte_inventario_export_control
{
