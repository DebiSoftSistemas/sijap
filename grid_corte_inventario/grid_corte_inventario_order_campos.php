<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_corte_inventario']['glo_nm_path_imag_temp'] . "/sc_apl_default_SIJAP.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_corte_inventario_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_corte_inventario_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['pro_codigo'] = "pro_codigo";
   $tab_labels["pro_codigo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['labels']["pro_codigo"])) ? $_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['labels']["pro_codigo"] : "" . $this->Nm_lang['lang_codigo'] . "";
   $tab_ger_campos['pro_descripcion'] = "on";
   $tab_def_campos['pro_descripcion'] = "pro_descripcion";
   $tab_labels["pro_descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['labels']["pro_descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['labels']["pro_descripcion"] : "" . $this->Nm_lang['lang_descripcion'] . "";
   $tab_ger_campos['kar_unidad'] = "on";
   $tab_def_campos['kar_unidad'] = "kar_unidad";
   $tab_labels["kar_unidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['labels']["kar_unidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['labels']["kar_unidad"] : "" . $this->Nm_lang['lang_unidad'] . "";
   $tab_ger_campos['cant_inicial'] = "on";
   $tab_def_campos['cant_inicial'] = "cant_inicial";
   $tab_labels["cant_inicial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['labels']["cant_inicial"])) ? $_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['labels']["cant_inicial"] : "" . $this->Nm_lang['lang_cantidad_inicial'] . "";
   $tab_ger_campos['valor_inicial'] = "on";
   $tab_def_campos['valor_inicial'] = "valor_inicial";
   $tab_labels["valor_inicial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['labels']["valor_inicial"])) ? $_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['labels']["valor_inicial"] : "Valor Inicial";
   $tab_ger_campos['total_ingreso'] = "on";
   $tab_def_campos['total_ingreso'] = "total_ingreso";
   $tab_labels["total_ingreso"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['labels']["total_ingreso"])) ? $_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['labels']["total_ingreso"] : "Cant. Ingreso";
   $tab_ger_campos['valor_ingreso'] = "on";
   $tab_def_campos['valor_ingreso'] = "valor_ingreso";
   $tab_labels["valor_ingreso"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['labels']["valor_ingreso"])) ? $_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['labels']["valor_ingreso"] : "Valor Ingreso";
   $tab_ger_campos['total_salida'] = "on";
   $tab_def_campos['total_salida'] = "total_salida";
   $tab_labels["total_salida"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['labels']["total_salida"])) ? $_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['labels']["total_salida"] : "Total Salida";
   $tab_ger_campos['valor_salida'] = "on";
   $tab_def_campos['valor_salida'] = "valor_salida";
   $tab_labels["valor_salida"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['labels']["valor_salida"])) ? $_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['labels']["valor_salida"] : "Valor Salida";
   $tab_ger_campos['cant_existencia'] = "on";
   $tab_def_campos['cant_existencia'] = "cant_existencia";
   $tab_labels["cant_existencia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['labels']["cant_existencia"])) ? $_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['labels']["cant_existencia"] : "Cant. Existencia";
   $tab_ger_campos['valor_existencia'] = "on";
   $tab_def_campos['valor_existencia'] = "valor_existencia";
   $tab_labels["valor_existencia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['labels']["valor_existencia"])) ? $_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['labels']["valor_existencia"] : "Valor Existencia";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_cortes_inventario'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_corte_inventario_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_corte_inventario']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
