...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_corte_inventario"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_corte_inventario"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_corte_inventario']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_corte_inventario']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_corte_inventario']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_corte_inventario']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_corte_inventario']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_corte_inventario</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_corte_inventario']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_corte_inventario']['embutida_filho'] as $ind => $sc_init)
          {
