  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_frm_CambioClave_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_frm_CambioClave_mob_form();
	}
...
?>
  ...
  function do_ajax_frm_CambioClave_mob_validate_pass_actual()
  {
    var nomeCampo_pass_actual = "pass_actual";
    var var_pass_actual = scAjaxGetFieldText(nomeCampo_pass_actual);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_CambioClave_mob_validate_pass_actual(var_pass_actual, var_script_case_init, do_ajax_frm_CambioClave_mob_validate_pass_actual_cb);
  } // do_ajax_frm_CambioClave_mob_validate_pass_actual

  function do_ajax_frm_CambioClave_mob_validate_pass_actual_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_CambioClave_mob_validate_pass_actual_cb

  // ---------- Validate pass_nuevo
  function do_ajax_frm_CambioClave_mob_validate_pass_nuevo()
  {
    var nomeCampo_pass_nuevo = "pass_nuevo";
    var var_pass_nuevo = scAjaxGetFieldText(nomeCampo_pass_nuevo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_CambioClave_mob_validate_pass_nuevo(var_pass_nuevo, var_script_case_init, do_ajax_frm_CambioClave_mob_validate_pass_nuevo_cb);
  } // do_ajax_frm_CambioClave_mob_validate_pass_nuevo

  function do_ajax_frm_CambioClave_mob_validate_pass_nuevo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_CambioClave_mob_validate_pass_nuevo_cb

  // ---------- Validate pas_confirma
  function do_ajax_frm_CambioClave_mob_validate_pas_confirma()
  {
    var nomeCampo_pas_confirma = "pas_confirma";
    var var_pas_confirma = scAjaxGetFieldText(nomeCampo_pas_confirma);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_CambioClave_mob_validate_pas_confirma(var_pas_confirma, var_script_case_init, do_ajax_frm_CambioClave_mob_validate_pas_confirma_cb);
  } // do_ajax_frm_CambioClave_mob_validate_pas_confirma

  function do_ajax_frm_CambioClave_mob_validate_pas_confirma_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_CambioClave_mob_validate_pas_confirma_cb

  // ---------- Validate mensaje
  function do_ajax_frm_CambioClave_mob_validate_mensaje()
  {
    var nomeCampo_mensaje = "mensaje";
    var var_mensaje = scAjaxGetFieldHidden(nomeCampo_mensaje);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_frm_CambioClave_mob_validate_mensaje(var_mensaje, var_script_case_init, do_ajax_frm_CambioClave_mob_validate_mensaje_cb);
  } // do_ajax_frm_CambioClave_mob_validate_mensaje

  function do_ajax_frm_CambioClave_mob_validate_mensaje_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mensaje";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_frm_CambioClave_mob_validate_mensaje_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_frm_CambioClave_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_frm_CambioClave_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_frm_CambioClave_mob_submit_form(var_pass_actual, var_pass_nuevo, var_pas_confirma, var_mensaje, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_frm_CambioClave_mob_submit_form_cb);
  } // do_ajax_frm_CambioClave_mob_submit_form

  function do_ajax_frm_CambioClave_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_frm_CambioClave_mob_submit_form_cb_after_alert);
  } // do_ajax_frm_CambioClave_mob_submit_form_cb
  function do_ajax_frm_CambioClave_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_frm_CambioClave_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_frm_CambioClave_mob_navigate_form()
  {
    perform_ajax_frm_CambioClave_mob_navigate_form();
  }

  function perform_ajax_frm_CambioClave_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_frm_CambioClave_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['frm_CambioClave_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_frm_CambioClave_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_frm_CambioClave_mob_navigate_form_cb_after_alert);
  } // do_ajax_frm_CambioClave_mob_navigate_form_cb
  function do_ajax_frm_CambioClave_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_frm_CambioClave_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_frm_CambioClave_mob_navigate_form_cb_after_alert

  function sc_hide_frm_CambioClave_mob_form()
  {
