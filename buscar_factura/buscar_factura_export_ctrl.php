<?php
@session_start() ;
$_SESSION['scriptcase']['buscar_factura']['sc_process_barr'] = true;
require_once('../buscar_factura/index.php');
unset($_SESSION['scriptcase']['buscar_factura']['sc_process_barr']);
$ExportCtrl = new buscar_factura_export_control;
$ExportCtrl->Export_barr();

class buscar_factura_export_control
{
