  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_fac_solicitud_anulacion_deuda_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_fac_solicitud_anulacion_deuda_mob_form();
	}
...
?>
  ...
  // ---------- Validate sad_id
  function do_ajax_form_fac_solicitud_anulacion_deuda_mob_validate_sad_id()
  {
    var nomeCampo_sad_id = "sad_id";
    var var_sad_id = scAjaxGetFieldHidden(nomeCampo_sad_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_anulacion_deuda_mob_validate_sad_id(var_sad_id, var_script_case_init, do_ajax_form_fac_solicitud_anulacion_deuda_mob_validate_sad_id_cb);
  } // do_ajax_form_fac_solicitud_anulacion_deuda_mob_validate_sad_id

  function do_ajax_form_fac_solicitud_anulacion_deuda_mob_validate_sad_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_anulacion_deuda_mob_validate_sad_id_cb

  // ---------- Validate sad_fecha
  function do_ajax_form_fac_solicitud_anulacion_deuda_mob_validate_sad_fecha()
  {
    var nomeCampo_sad_fecha = "sad_fecha";
    var var_sad_fecha = scAjaxGetFieldHidden(nomeCampo_sad_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_anulacion_deuda_mob_validate_sad_fecha(var_sad_fecha, var_script_case_init, do_ajax_form_fac_solicitud_anulacion_deuda_mob_validate_sad_fecha_cb);
  } // do_ajax_form_fac_solicitud_anulacion_deuda_mob_validate_sad_fecha

  function do_ajax_form_fac_solicitud_anulacion_deuda_mob_validate_sad_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sad_fecha";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_anulacion_deuda_mob_validate_sad_fecha_cb

  // ---------- Validate sad_propietario
  function do_ajax_form_fac_solicitud_anulacion_deuda_mob_validate_sad_propietario()
  {
    var nomeCampo_sad_propietario = "sad_propietario";
    var var_sad_propietario = scAjaxGetFieldSelect(nomeCampo_sad_propietario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_anulacion_deuda_mob_validate_sad_propietario(var_sad_propietario, var_script_case_init, do_ajax_form_fac_solicitud_anulacion_deuda_mob_validate_sad_propietario_cb);
  } // do_ajax_form_fac_solicitud_anulacion_deuda_mob_validate_sad_propietario

  function do_ajax_form_fac_solicitud_anulacion_deuda_mob_validate_sad_propietario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sad_propietario";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_anulacion_deuda_mob_validate_sad_propietario_cb

  // ---------- Validate sad_motivo_anulacion
  function do_ajax_form_fac_solicitud_anulacion_deuda_mob_validate_sad_motivo_anulacion()
  {
    var nomeCampo_sad_motivo_anulacion = "sad_motivo_anulacion";
    var var_sad_motivo_anulacion = scAjaxGetFieldText(nomeCampo_sad_motivo_anulacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_anulacion_deuda_mob_validate_sad_motivo_anulacion(var_sad_motivo_anulacion, var_script_case_init, do_ajax_form_fac_solicitud_anulacion_deuda_mob_validate_sad_motivo_anulacion_cb);
  } // do_ajax_form_fac_solicitud_anulacion_deuda_mob_validate_sad_motivo_anulacion

  function do_ajax_form_fac_solicitud_anulacion_deuda_mob_validate_sad_motivo_anulacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sad_motivo_anulacion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_anulacion_deuda_mob_validate_sad_motivo_anulacion_cb

  // ---------- Validate sad_estado
  function do_ajax_form_fac_solicitud_anulacion_deuda_mob_validate_sad_estado()
  {
    var nomeCampo_sad_estado = "sad_estado";
    var var_sad_estado = scAjaxGetFieldHidden(nomeCampo_sad_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_anulacion_deuda_mob_validate_sad_estado(var_sad_estado, var_script_case_init, do_ajax_form_fac_solicitud_anulacion_deuda_mob_validate_sad_estado_cb);
  } // do_ajax_form_fac_solicitud_anulacion_deuda_mob_validate_sad_estado

  function do_ajax_form_fac_solicitud_anulacion_deuda_mob_validate_sad_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sad_estado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_anulacion_deuda_mob_validate_sad_estado_cb

  // ---------- Validate operaciones
  function do_ajax_form_fac_solicitud_anulacion_deuda_mob_validate_operaciones()
  {
    var nomeCampo_operaciones = "operaciones";
    var var_operaciones = scAjaxGetFieldText(nomeCampo_operaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_anulacion_deuda_mob_validate_operaciones(var_operaciones, var_script_case_init, do_ajax_form_fac_solicitud_anulacion_deuda_mob_validate_operaciones_cb);
  } // do_ajax_form_fac_solicitud_anulacion_deuda_mob_validate_operaciones

  function do_ajax_form_fac_solicitud_anulacion_deuda_mob_validate_operaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_anulacion_deuda_mob_validate_operaciones_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_fac_solicitud_anulacion_deuda_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_fac_solicitud_anulacion_deuda_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_sad_id = scAjaxGetFieldHidden("sad_id");
    var var_sad_fecha = scAjaxGetFieldHidden("sad_fecha");
    var var_sad_propietario = scAjaxGetFieldSelect("sad_propietario");
    var var_sad_motivo_anulacion = scAjaxGetFieldText("sad_motivo_anulacion");
    var var_sad_estado = scAjaxGetFieldHidden("sad_estado");
    ...
    scAjaxProcOn();
    x_ajax_form_fac_solicitud_anulacion_deuda_mob_submit_form(var_sad_id, var_sad_fecha, var_sad_propietario, var_sad_motivo_anulacion, var_sad_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_fac_solicitud_anulacion_deuda_mob_submit_form_cb);
  } // do_ajax_form_fac_solicitud_anulacion_deuda_mob_submit_form

  function do_ajax_form_fac_solicitud_anulacion_deuda_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("sad_id");
      scAjaxHideErrorDisplay("sad_fecha");
      scAjaxHideErrorDisplay("sad_propietario");
      scAjaxHideErrorDisplay("sad_motivo_anulacion");
      scAjaxHideErrorDisplay("sad_estado");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_fac_solicitud_anulacion_deuda_mob_submit_form_cb_after_alert);
  } // do_ajax_form_fac_solicitud_anulacion_deuda_mob_submit_form_cb
  function do_ajax_form_fac_solicitud_anulacion_deuda_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_fac_solicitud_anulacion_deuda_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_fac_operaciones_anular_mob"] = "off";

  function do_ajax_form_fac_solicitud_anulacion_deuda_mob_navigate_form()
  {
    perform_ajax_form_fac_solicitud_anulacion_deuda_mob_navigate_form();
  }

  function perform_ajax_form_fac_solicitud_anulacion_deuda_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("sad_estado");
    scAjaxHideErrorDisplay("operaciones");
    var var_sad_id = document.F2.sad_id.value;
    ...
    scAjaxProcOn();
    scStatusDetail["form_fac_operaciones_anular_mob"] = "on";
    x_ajax_form_fac_solicitud_anulacion_deuda_mob_navigate_form(var_sad_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_solicitud_anulacion_deuda_mob_navigate_form_cb);
  } // do_ajax_form_fac_solicitud_anulacion_deuda_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_anulacion_deuda_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_fac_solicitud_anulacion_deuda_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.sad_id.value = scAjaxGetKeyValue("sad_id");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_fac_operaciones_anular_mob"] && "nmsc_iframe_liga_form_fac_operaciones_anular_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_fac_operaciones_anular_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_fac_operaciones_anular_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_fac_operaciones_anular_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_fac_operaciones_anular_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_fac_operaciones_anular_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_fac_solicitud_anulacion_deuda_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_fac_solicitud_anulacion_deuda_mob_navigate_form_cb
  function do_ajax_form_fac_solicitud_anulacion_deuda_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_fac_solicitud_anulacion_deuda_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_fac_solicitud_anulacion_deuda_mob_navigate_form_cb_after_alert

  function sc_hide_form_fac_solicitud_anulacion_deuda_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_fac_operaciones_anular_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "sad_id";
  ajax_field_list[1] = "sad_fecha";
  ajax_field_list[2] = "sad_propietario";
  ajax_field_list[3] = "sad_motivo_anulacion";
  ajax_field_list[4] = "sad_estado";
  ajax_field_list[5] = "operaciones";
  ...
  var ajax_error_list = {
    "sad_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sad_fecha": {"label": "<?php echo $this->Ini->Nm_lang['lang_fecha'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sad_propietario": {"label": "<?php echo $this->Ini->Nm_lang['lang_propietario'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sad_motivo_anulacion": {"label": "<?php echo $this->Ini->Nm_lang['lang_motivo_anulacion'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sad_estado": {"label": "<?php echo $this->Ini->Nm_lang['lang_estado'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "sad_id": new Array(),
    "sad_fecha": new Array(),
    "sad_propietario": new Array(),
    "sad_motivo_anulacion": new Array(),
    "sad_estado": new Array(),
    "operaciones": new Array()
  };
  ajax_field_mult["sad_id"][1] = "sad_id";
  ajax_field_mult["sad_fecha"][1] = "sad_fecha";
  ajax_field_mult["sad_propietario"][1] = "sad_propietario";
  ajax_field_mult["sad_motivo_anulacion"][1] = "sad_motivo_anulacion";
  ajax_field_mult["sad_estado"][1] = "sad_estado";
  ajax_field_mult["operaciones"][1] = "operaciones";

  var ajax_field_id = {
    "sad_fecha": new Array("hidden_field_label_sad_fecha", "hidden_field_data_sad_fecha"),
    "sad_propietario": new Array("hidden_field_label_sad_propietario", "hidden_field_data_sad_propietario"),
    "sad_motivo_anulacion": new Array("hidden_field_label_sad_motivo_anulacion", "hidden_field_data_sad_motivo_anulacion"),
    "sad_estado": new Array("hidden_field_label_sad_estado", "hidden_field_data_sad_estado"),
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("sad_motivo_anulacion" == sIndex)
    {
