  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_fac_solicitud_anulacion_deuda" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_fac_solicitud_anulacion_deuda_form();
	}
...
?>
  ...
  // ---------- Validate sad_id
  function do_ajax_form_fac_solicitud_anulacion_deuda_validate_sad_id()
  {
    var nomeCampo_sad_id = "sad_id";
    var var_sad_id = scAjaxGetFieldHidden(nomeCampo_sad_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_anulacion_deuda_validate_sad_id(var_sad_id, var_script_case_init, do_ajax_form_fac_solicitud_anulacion_deuda_validate_sad_id_cb);
  } // do_ajax_form_fac_solicitud_anulacion_deuda_validate_sad_id

  function do_ajax_form_fac_solicitud_anulacion_deuda_validate_sad_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_anulacion_deuda_validate_sad_id_cb

  // ---------- Validate sad_fecha
  function do_ajax_form_fac_solicitud_anulacion_deuda_validate_sad_fecha()
  {
    var nomeCampo_sad_fecha = "sad_fecha";
    var var_sad_fecha = scAjaxGetFieldHidden(nomeCampo_sad_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_anulacion_deuda_validate_sad_fecha(var_sad_fecha, var_script_case_init, do_ajax_form_fac_solicitud_anulacion_deuda_validate_sad_fecha_cb);
  } // do_ajax_form_fac_solicitud_anulacion_deuda_validate_sad_fecha

  function do_ajax_form_fac_solicitud_anulacion_deuda_validate_sad_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_anulacion_deuda_validate_sad_fecha_cb

  // ---------- Validate sad_propietario
  function do_ajax_form_fac_solicitud_anulacion_deuda_validate_sad_propietario()
  {
    var nomeCampo_sad_propietario = "sad_propietario";
    var var_sad_propietario = scAjaxGetFieldSelect(nomeCampo_sad_propietario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_anulacion_deuda_validate_sad_propietario(var_sad_propietario, var_script_case_init, do_ajax_form_fac_solicitud_anulacion_deuda_validate_sad_propietario_cb);
  } // do_ajax_form_fac_solicitud_anulacion_deuda_validate_sad_propietario

  function do_ajax_form_fac_solicitud_anulacion_deuda_validate_sad_propietario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_anulacion_deuda_validate_sad_propietario_cb

  // ---------- Validate sad_motivo_anulacion
  function do_ajax_form_fac_solicitud_anulacion_deuda_validate_sad_motivo_anulacion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_anulacion_deuda_validate_sad_motivo_anulacion(var_sad_motivo_anulacion, var_script_case_init, do_ajax_form_fac_solicitud_anulacion_deuda_validate_sad_motivo_anulacion_cb);
  } // do_ajax_form_fac_solicitud_anulacion_deuda_validate_sad_motivo_anulacion

  function do_ajax_form_fac_solicitud_anulacion_deuda_validate_sad_motivo_anulacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_anulacion_deuda_validate_sad_motivo_anulacion_cb

  // ---------- Validate sad_estado
  function do_ajax_form_fac_solicitud_anulacion_deuda_validate_sad_estado()
  {
    var nomeCampo_sad_estado = "sad_estado";
    var var_sad_estado = scAjaxGetFieldHidden(nomeCampo_sad_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_anulacion_deuda_validate_sad_estado(var_sad_estado, var_script_case_init, do_ajax_form_fac_solicitud_anulacion_deuda_validate_sad_estado_cb);
  } // do_ajax_form_fac_solicitud_anulacion_deuda_validate_sad_estado

  function do_ajax_form_fac_solicitud_anulacion_deuda_validate_sad_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_anulacion_deuda_validate_sad_estado_cb

  // ---------- Validate operaciones
  function do_ajax_form_fac_solicitud_anulacion_deuda_validate_operaciones()
  {
    var nomeCampo_operaciones = "operaciones";
    var var_operaciones = scAjaxGetFieldText(nomeCampo_operaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_fac_solicitud_anulacion_deuda_validate_operaciones(var_operaciones, var_script_case_init, do_ajax_form_fac_solicitud_anulacion_deuda_validate_operaciones_cb);
  } // do_ajax_form_fac_solicitud_anulacion_deuda_validate_operaciones

  function do_ajax_form_fac_solicitud_anulacion_deuda_validate_operaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_fac_solicitud_anulacion_deuda_validate_operaciones_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_fac_solicitud_anulacion_deuda_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_fac_solicitud_anulacion_deuda_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_fac_solicitud_anulacion_deuda_submit_form(var_sad_id, var_sad_fecha, var_sad_propietario, var_sad_motivo_anulacion, var_sad_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_fac_solicitud_anulacion_deuda_submit_form_cb);
  } // do_ajax_form_fac_solicitud_anulacion_deuda_submit_form

  function do_ajax_form_fac_solicitud_anulacion_deuda_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_fac_solicitud_anulacion_deuda_submit_form_cb_after_alert);
  } // do_ajax_form_fac_solicitud_anulacion_deuda_submit_form_cb
  function do_ajax_form_fac_solicitud_anulacion_deuda_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_fac_solicitud_anulacion_deuda_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_fac_operaciones_anular"] = "off";

  function do_ajax_form_fac_solicitud_anulacion_deuda_navigate_form()
  {
    perform_ajax_form_fac_solicitud_anulacion_deuda_navigate_form();
  }

  function perform_ajax_form_fac_solicitud_anulacion_deuda_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_fac_operaciones_anular"] = "on";
    x_ajax_form_fac_solicitud_anulacion_deuda_navigate_form(var_sad_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_fac_solicitud_anulacion_deuda_navigate_form_cb);
  } // do_ajax_form_fac_solicitud_anulacion_deuda_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fac_solicitud_anulacion_deuda']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_fac_solicitud_anulacion_deuda_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_fac_operaciones_anular"] && "nmsc_iframe_liga_form_fac_operaciones_anular" != scMasterDetailIframe["nmsc_iframe_liga_form_fac_operaciones_anular"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_fac_operaciones_anular"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_fac_operaciones_anular').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_fac_operaciones_anular').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_fac_operaciones_anular').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_fac_solicitud_anulacion_deuda_navigate_form_cb_after_alert);
  } // do_ajax_form_fac_solicitud_anulacion_deuda_navigate_form_cb
  function do_ajax_form_fac_solicitud_anulacion_deuda_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_fac_solicitud_anulacion_deuda_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_fac_solicitud_anulacion_deuda_navigate_form_cb_after_alert

  function sc_hide_form_fac_solicitud_anulacion_deuda_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_fac_operaciones_anular"])
    {
      return true;
    }
    return false;
