<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_jap_aportaciones']['glo_nm_path_imag_temp'] . "/sc_apl_default_SIJAP.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_jap_aportaciones_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_jap_aportaciones_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['ap_descripcion'] = "on";
   $tab_def_campos['ap_descripcion'] = "ap_descripcion";
   $tab_labels["ap_descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['labels']["ap_descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['labels']["ap_descripcion"] : "" . $this->Nm_lang['lang_descripcion'] . "";
   $tab_ger_campos['ap_tipo_cartera'] = "on";
   $tab_def_campos['ap_tipo_cartera'] = "ap_tipo_cartera";
   $tab_labels["ap_tipo_cartera"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['labels']["ap_tipo_cartera"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['labels']["ap_tipo_cartera"] : "" . $this->Nm_lang['lang_tipo_cartera'] . "";
   $tab_ger_campos['ap_tipo_comprobante'] = "on";
   $tab_def_campos['ap_tipo_comprobante'] = "ap_tipo_comprobante";
   $tab_labels["ap_tipo_comprobante"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['labels']["ap_tipo_comprobante"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['labels']["ap_tipo_comprobante"] : "" . $this->Nm_lang['lang_tipo_comprobante'] . "";
   $tab_ger_campos['ap_periodicidad'] = "on";
   $tab_def_campos['ap_periodicidad'] = "ap_periodicidad";
   $tab_labels["ap_periodicidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['labels']["ap_periodicidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['labels']["ap_periodicidad"] : "" . $this->Nm_lang['lang_periodicidad_aportes'] . "";
   $tab_ger_campos['ap_contrato'] = "on";
   $tab_def_campos['ap_contrato'] = "ap_contrato";
   $tab_labels["ap_contrato"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['labels']["ap_contrato"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['labels']["ap_contrato"] : "" . $this->Nm_lang['lang_contrato'] . "";
   $tab_ger_campos['ap_servicio'] = "on";
   $tab_def_campos['ap_servicio'] = "ap_servicio";
   $tab_labels["ap_servicio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['labels']["ap_servicio"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['labels']["ap_servicio"] : "" . $this->Nm_lang['lang_servicio'] . "";
   $tab_ger_campos['ap_personalizada'] = "on";
   $tab_def_campos['ap_personalizada'] = "ap_personalizada";
   $tab_labels["ap_personalizada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['labels']["ap_personalizada"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['labels']["ap_personalizada"] : "" . $this->Nm_lang['lang_otras_emisiones'] . "";
   $tab_ger_campos['ap_libre'] = "on";
   $tab_def_campos['ap_libre'] = "ap_libre";
   $tab_labels["ap_libre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['labels']["ap_libre"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['labels']["ap_libre"] : "" . $this->Nm_lang['lang_personalizada'] . "";
   $tab_ger_campos['ap_reconexion'] = "on";
   $tab_def_campos['ap_reconexion'] = "ap_reconexion";
   $tab_labels["ap_reconexion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['labels']["ap_reconexion"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['labels']["ap_reconexion"] : "" . $this->Nm_lang['lang_reconexion'] . "";
   $tab_ger_campos['ap_materiales'] = "on";
   $tab_def_campos['ap_materiales'] = "ap_materiales";
   $tab_labels["ap_materiales"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['labels']["ap_materiales"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['labels']["ap_materiales"] : "" . $this->Nm_lang['lang_materiales'] . "";
   $tab_ger_campos['ap_estado'] = "on";
   $tab_def_campos['ap_estado'] = "ap_estado";
   $tab_labels["ap_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['labels']["ap_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['labels']["ap_estado"] : "" . $this->Nm_lang['lang_estado'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_config_deudas'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_jap_aportaciones_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_jap_aportaciones']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
