...
function actionBar_displayState($buttonName)
{
    switch ($buttonName) {
        ...
        case 'contabilizar':
            return $this->actionBar_displayState_contabilizar();
    }
}
...
function actionBar_displayState_contabilizar()
{
    switch ($this->sc_actionbar_states['contabilizar']) {
        case 'state1':
            return "<i class=\"icon_fa sc-actb-contabilizar sc-acts-state1 fas fa-bible\"></i>";
    }
}
...
function actionBar_getStateHint($buttonName)
{
    switch ($buttonName) {
        ...
        case 'contabilizar':
            return $this->actionBar_getStateHint_contabilizar();
    }
}
...
function actionBar_getStateHint_contabilizar()
{
    switch ($this->sc_actionbar_states['contabilizar']) {
        case 'state1':
            return "Contabilizar";
...
function actionBar_getStateConfirm($buttonName)
{
    switch ($buttonName) {
        ...
        case 'contabilizar':
            return $this->actionBar_getStateConfirm_contabilizar();
    }
}
...
function actionBar_getStateConfirm_contabilizar()
{
    switch ($this->sc_actionbar_states['contabilizar']) {
        case 'state1':
            return "";
...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   { 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['print_all'] && empty($this->nm_grid_sem_reg) && ($Gera_res || $Gera_graf) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['SC_Ind_Groupby'] != "sc_free_total")
       { 
...
//
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       ...
       { 
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['ordem_select']['fac_numero'] = 'desc'; 
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       { 
           ...
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_del_factura_jquery_4128.js\"></script>\r\n");
        ...
        <link rel='stylesheet' href='../_lib/lib/css/nm_mobile.css' type='text/css'/>
          <?php }
           ...
           $nm_saida->saida("            break;\r\n");
           $nm_saida->saida("        case 'contabilizar':\r\n");
           $nm_saida->saida("            stateHtml = actionBar_displayState_contabilizar(buttonState);\r\n");
           $nm_saida->saida("            buttonId = \"sc-actionbar-actbtn_contabilizar\" + buttonRow;\r\n");
           $nm_saida->saida("            break;\r\n");
           $nm_saida->saida("    }\r\n");
           ...
           $nm_saida->saida("    }\r\n");
           $nm_saida->saida("}\r\n");
           $nm_saida->saida("function actionBar_displayState_contabilizar(buttonState)\r\n");
           $nm_saida->saida("{\r\n");
           $nm_saida->saida("    switch (buttonState) {\r\n");
           $nm_saida->saida("        case 'state1':\r\n");
           $nm_saida->saida("            return \"<i class=\\\"icon_fa sc-actb-contabilizar sc-acts-state1 fas fa-bible\\\"></i>\";\r\n");
           $nm_saida->saida("    }\r\n");
           $nm_saida->saida("}\r\n");
           ...
           $nm_saida->saida("        case 'contabilizar':\r\n");
           $nm_saida->saida("            return actionBar_getStateHint_contabilizar(buttonState);\r\n");
           $nm_saida->saida("    }\r\n");
           $nm_saida->saida("}\r\n");
           ...
           $nm_saida->saida("    }\r\n");
           $nm_saida->saida("}\r\n");
           $nm_saida->saida("function actionBar_getStateHint_contabilizar(buttonState)\r\n");
           $nm_saida->saida("{\r\n");
           $nm_saida->saida("    switch (buttonState) {\r\n");
           $nm_saida->saida("        case 'state1':\r\n");
           $nm_saida->saida("            return \"Contabilizar\";\r\n");
           $nm_saida->saida("    }\r\n");
           $nm_saida->saida("}\r\n");
           ...
           $nm_saida->saida("        case 'contabilizar':\r\n");
           $nm_saida->saida("            return actionBar_getStateConfirm_contabilizar(buttonState);\r\n");
           $nm_saida->saida("    }\r\n");
           $nm_saida->saida("}\r\n");
           ...
           $nm_saida->saida("    }\r\n");
           $nm_saida->saida("}\r\n");
           $nm_saida->saida("function actionBar_getStateConfirm_contabilizar(buttonState)\r\n");
           $nm_saida->saida("{\r\n");
           $nm_saida->saida("    switch (buttonState) {\r\n");
           $nm_saida->saida("        case 'state1':\r\n");
           $nm_saida->saida("            return \"\";\r\n");
...
// 
  ...
  if($this->fac_estado_sri <>'AUTORIZADO'and $this->fac_estado_sri <>'ANULADO' ){
	...
	$this->sc_actionbar_disable("contabilizar");
}else{
	$this->sc_actionbar_disable("btn_autorizar");
	$this->sc_actionbar_enable("contabilizar");
}
...
function SC_grid_rightActionBar()
{
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['mostra_edit'] != "N"){ 
   ...
   $nm_saida->saida("</script>\r\n");
              ...
              $buttonHint = $this->actionBar_getStateHint('contabilizar');
              if ('' != $buttonHint) {
   $nm_saida->saida("<script>\r\n");
   $nm_saida->saida("$(function() {\r\n");
   $nm_saida->saida("    tippy(\"#sc-actionbar-actbtn_contabilizar_" . $this->SC_seq_page . "\", {\r\n");
   $nm_saida->saida("        content: \"" . $buttonHint . "\",\r\n");
   $nm_saida->saida("        theme: \"light\",\r\n");
   $nm_saida->saida("    });\r\n");
   $nm_saida->saida("    $(\"#sc-actionbar-actbtn_contabilizar_" . $this->SC_seq_page . "\").attr(\"title\", \"\");\r\n");
   $nm_saida->saida("});\r\n");
   $nm_saida->saida("</script>\r\n");
              }
   ...
   $nm_saida->saida("<td style=\"padding: 0\"><span class=\"scButton_fontawesome sc-actionbar-fa" . $this->actionBar_getStateDisable('contabilizar') . $this->actionBar_getStateHide('contabilizar') . "\" id=\"sc-actionbar-actbtn_contabilizar_" . $this->SC_seq_page . "\" title=\"" . $this->actionBar_getStateHint('contabilizar') . "\" data-actionbar-pos=\"" . $dataActionbarPos . "\" data-actionbar-row=\"_" . $this->SC_seq_page . "\" data-actionbar-state=\"" . $this->sc_actionbar_states['contabilizar'] . "\" data-actionbar-confirm=\"" . $this->actionBar_getStateConfirm('contabilizar') . "\">" . $this->actionBar_displayState('contabilizar') . "</span></td>\r\n");
...
$nm_saida->saida("    </style>\r\n");
   ...
   function grid_search_add_tag()
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq']) && count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_del_factura']['grid_pesq']) < 6)
       {
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "SIJAP/grid_del_factura";
