...
function scJQAddEvents(seqRow) {
  ...
  $("#sc-actionbar-actbtn_contabilizar" + seqRow).click(function () {
    let actionBarButtonRow = "", actionBarButtonState = "", actionBarButtonConfirm = "";
    if ($(this).hasClass("disabled")) {
        return;
    }
    ...
    actionBarButtonConfirm = $(this).data("actionbarConfirm");
    if ("" != actionBarButtonConfirm) {
      scJs_confirm(actionBarButtonConfirm, function() { scAjaxCall_actbtn_contabilizar_onClick(seqRow, actionBarButtonRow, actionBarButtonState, actionBarButtonConfirm); }, function() {});
      return;
    }
    scAjaxCall_actbtn_contabilizar_onClick(seqRow, actionBarButtonRow, actionBarButtonState, actionBarButtonConfirm);
  }).mouseover(function() { $(this).css("cursor", "pointer"); })
    .mouseout(function() { $(this).css("cursor", "pointer"); })
    .addClass(($("#sc-actionbar-actbtn_contabilizar" + seqRow).parent().hasClass("scGridFieldOddFont") ? "scGridFieldOddLink" : "scGridFieldEvenLink"));
}
function scAjaxCall_actbtn_btn_anular_onClick(seqRow, actionBarButtonRow, actionBarButtonState, actionBarButtonConfirm) {
  ...
  $.ajax({
    type: "POST",
    url: "index.php",
    data: "nmgp_opcao=ajax_event&nmgp_event=actbtn_btn_anular_onClick&script_case_init=" + document.F3.script_case_init.value + "&fac_numero=" + grid_del_factura_getValue("fac_numero", seqRow) + "&fac_empresa=" + grid_del_factura_getValue("fac_empresa", seqRow) + "&lang_doc_anulado=" + grid_del_factura_getValue("lang_doc_anulado", seqRow) + "&actionbar_clicked_state=" + actionBarButtonState + ""
   })
...
function scAjaxCall_actbtn_contabilizar_onClick(seqRow, actionBarButtonRow, actionBarButtonState, actionBarButtonConfirm) {
  nmAjaxProcOn();
  $.ajax({
    type: "POST",
    url: "index.php",
    data: "nmgp_opcao=ajax_event&nmgp_event=actbtn_contabilizar_onClick&script_case_init=" + document.F3.script_case_init.value + "&fac_numero=" + grid_del_factura_getValue("fac_numero", seqRow) + "&fac_empresa=" + grid_del_factura_getValue("fac_empresa", seqRow) + "&actionbar_clicked_state=" + actionBarButtonState + ""
   })
   .done(function(jsonReturn) {
      var i, fieldDisplay, oResp;
      Tst_integrid = jsonReturn.trim();
      ...
      if ("function" == typeof applyGroupButtons) {
        let buttonObject = $("#sc-actionbar-actbtn_contabilizar" + seqRow);
        applyGroupButtons($(".sc-actbtn-group-" + buttonObject.data("actionbarPos") + buttonObject.data("actionbarRow")));
      }
  });
}
