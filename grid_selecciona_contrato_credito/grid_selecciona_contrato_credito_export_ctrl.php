<?php
@session_start() ;
$_SESSION['scriptcase']['grid_selecciona_contrato_credito']['sc_process_barr'] = true;
require_once('../grid_selecciona_contrato_credito/index.php');
unset($_SESSION['scriptcase']['grid_selecciona_contrato_credito']['sc_process_barr']);
$ExportCtrl = new grid_selecciona_contrato_credito_export_control;
$ExportCtrl->Export_barr();

class grid_selecciona_contrato_credito_export_control
{
