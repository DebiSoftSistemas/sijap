...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_selecciona_contrato_credito"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_selecciona_contrato_credito"]);
   }
   ...
   $fecha_janela = false;
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_selecciona_contrato_credito']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_selecciona_contrato_credito']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_selecciona_contrato_credito']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_selecciona_contrato_credito']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_selecciona_contrato_credito']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_selecciona_contrato_credito</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_selecciona_contrato_credito']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_selecciona_contrato_credito']['embutida_filho'] as $ind => $sc_init)
          {
