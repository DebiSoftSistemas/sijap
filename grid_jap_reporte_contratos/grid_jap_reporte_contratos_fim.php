...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_jap_reporte_contratos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_jap_reporte_contratos"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_jap_modificar_contrato'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_jap_reporte_contratos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_jap_reporte_contratos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_jap_reporte_contratos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_jap_reporte_contratos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_jap_reporte_contratos']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_jap_reporte_contratos</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_jap_reporte_contratos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_jap_reporte_contratos']['embutida_filho'] as $ind => $sc_init)
          {
