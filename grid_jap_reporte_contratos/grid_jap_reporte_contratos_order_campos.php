...
<?php
   ...
   $Ord_Cmp = new grid_jap_reporte_contratos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_jap_reporte_contratos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['con_fecha'] = "on";
   $tab_def_campos['con_fecha'] = "con_fecha";
   $tab_labels["con_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['labels']["con_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['labels']["con_fecha"] : "" . $this->Nm_lang['lang_fecha'] . "";
   $tab_ger_campos['con_numero_contrato'] = "on";
   $tab_def_campos['con_numero_contrato'] = "con_numero_contrato";
   $tab_labels["con_numero_contrato"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['labels']["con_numero_contrato"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['labels']["con_numero_contrato"] : "Nro. " . $this->Nm_lang['lang_contrato'] . "";
   $tab_ger_campos['con_cedula'] = "on";
   $tab_def_campos['con_cedula'] = "con_cedula";
   $tab_labels["con_cedula"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['labels']["con_cedula"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['labels']["con_cedula"] : "" . $this->Nm_lang['lang_cedula'] . "";
   $tab_ger_campos['con_nombre'] = "on";
   $tab_def_campos['con_nombre'] = "con_nombre";
   $tab_labels["con_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['labels']["con_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['labels']["con_nombre"] : "" . $this->Nm_lang['lang_lot_nombre_completo'] . "";
   $tab_ger_campos['con_condicion_contrato'] = "on";
   $tab_def_campos['con_condicion_contrato'] = "con_condicion_contrato";
   $tab_labels["con_condicion_contrato"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['labels']["con_condicion_contrato"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['labels']["con_condicion_contrato"] : "" . $this->Nm_lang['lang_condicion_contrato'] . "";
   $tab_ger_campos['con_tipo_servicio'] = "on";
   $tab_def_campos['con_tipo_servicio'] = "con_tipo_servicio";
   $tab_labels["con_tipo_servicio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['labels']["con_tipo_servicio"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['labels']["con_tipo_servicio"] : "" . $this->Nm_lang['lang_tipo_servicio'] . "";
   $tab_ger_campos['con_numero_medidor'] = "on";
   $tab_def_campos['con_numero_medidor'] = "con_numero_medidor";
   $tab_labels["con_numero_medidor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['labels']["con_numero_medidor"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['labels']["con_numero_medidor"] : "" . $this->Nm_lang['lang_numero_medidor'] . "";
   $tab_ger_campos['con_ruta'] = "on";
   $tab_def_campos['con_ruta'] = "con_ruta";
   $tab_labels["con_ruta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['labels']["con_ruta"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['labels']["con_ruta"] : "" . $this->Nm_lang['lang_ruta'] . "";
   $tab_ger_campos['con_direccion_predio'] = "on";
   $tab_def_campos['con_direccion_predio'] = "con_direccion_predio";
   $tab_labels["con_direccion_predio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['labels']["con_direccion_predio"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['labels']["con_direccion_predio"] : "" . $this->Nm_lang['lang_direccion_predio'] . "";
   $tab_ger_campos['con_numero_censo'] = "on";
   $tab_def_campos['con_numero_censo'] = "con_numero_censo";
   $tab_labels["con_numero_censo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['labels']["con_numero_censo"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['labels']["con_numero_censo"] : "" . $this->Nm_lang['lang_numero_censo'] . "";
   $tab_ger_campos['con_lectura_actual'] = "on";
   $tab_def_campos['con_lectura_actual'] = "con_lectura_actual";
   $tab_labels["con_lectura_actual"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['labels']["con_lectura_actual"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['labels']["con_lectura_actual"] : "" . $this->Nm_lang['lang_lectura_actual'] . "";
   $tab_ger_campos['con_estado'] = "on";
   $tab_def_campos['con_estado'] = "con_estado";
   $tab_labels["con_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['labels']["con_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['labels']["con_estado"] : "" . $this->Nm_lang['lang_estado'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_jap_reporte_contratos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_jap_reporte_contratos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
