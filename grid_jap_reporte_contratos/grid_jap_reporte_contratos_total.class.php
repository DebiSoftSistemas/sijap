...
class grid_jap_reporte_contratos_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_jap_reporte_contratos']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_jap_reporte_contratos']['campos_busca']))
      { 
   ...
   function Calc_resumo_sc_free_group_by($destino_resumo, $res_export=false)
   {
      global $nm_lang;
      $this->nm_data = new nm_data("es");
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_reporte_contratos']['sql_tot_res']);
      ...
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_reporte_contratos']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('con_fecha' => "con_fecha",'con_cedula' => "con_cedula",'con_condicion_contrato' => "con_condicion_contrato",'con_tipo_servicio' => "con_tipo_servicio",'con_ruta' => "con_ruta",'con_estado' => "con_estado");
      $cmps_quebra_atual = array();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_reporte_contratos']['SC_Gb_Free_cmp'] as $cmp => $resto)
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_reporte_contratos']['arr_total'] = array();
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_reporte_contratos']['arr_total'][$cmp_gb] = $this->$Arr_tot_name;
      }
   }
   ...
   function Res_Totaliza_sc_free_group_by($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def, $res_export)
   {
      ...
      $cmp_sql_tp_num = array('con_id' => 'N','con_propietario' => 'N','con_toma_administrativa' => 'N','con_toma_operativa' => 'N','con_tipo_servicio' => 'N','con_condicion_contrato' => 'N','con_lectura_actual' => 'N','con_ruta' => 'N');
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
         $cmd_simp = "select count(*), count(con_numero_contrato)#@#cmps_quebras#@# from " . $this->Ini->nm_tabela . " " . $where_ok;
         $comando  = "select count(*), count(SC_metric1)#@#cmps_quebras#@# from (";
         $comando .= "select con_numero_contrato as SC_metric1, " . $cmps_quebras1 . " from " . $this->Ini->nm_tabela . " " .  $where_ok . ") SC_sel1 INNER JOIN (";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_reporte_contratos']['sql_tot_res']))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_reporte_contratos']['sql_tot_res'] = str_replace("#@#cmps_quebras#@#", "", $comando);
      }
      $comando  = str_replace("#@#cmps_quebras#@#", "," . $cmps_quebras, $comando);
      $comando .= " group by " . $cmps_quebras . " order by " .  $cmps_quebras;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_reporte_contratos']['Res_search_metric_use']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_reporte_contratos']['Res_search_metric_use']))
      {
          $comando = $cmd_simp;
          $cmps_S  = "";
      ...
      $format_dimensions['con_fecha']['reg'] = "N";
      $format_dimensions['con_fecha']['msk'] = "F/Y";
      $format_dimensions['con_cedula']['reg'] = "S";
      $format_dimensions['con_cedula']['msk'] = "";
      $format_dimensions['con_condicion_contrato']['reg'] = "S";
      $format_dimensions['con_condicion_contrato']['msk'] = "";
      ...
      $format_dimensions['con_estado']['reg'] = "S";
      $format_dimensions['con_estado']['msk'] = "";
      while (!$rt->EOF)
      {
          $sql_where = "";
          foreach ($Cmp_dim as $Cada_dim => $Ind_sql)
          {
              ...
              if ($Cada_dim == "con_cedula") {
              }
              if ($Cada_dim == "con_condicion_contrato") {
                  $this->Lookup->lookup_sc_free_group_by_con_condicion_contrato($$Cada_dim,  $con_condicion_contrato,  $_SESSION['Igtech_RucEmpresa']);
              }
              ...
              if ($Cada_dim == "con_estado") {
                  $this->Lookup->lookup_sc_free_group_by_con_estado($$Cada_dim,  $con_estado);
              }
              if (null === $$Cada_dim)
              {
                  $$Cada_dim = '';
   ...
   {
      global $nada, $nm_lang , $con_condicion_contrato, $con_tipo_servicio, $con_ruta, $con_estado, $con_toma_administrativa, $con_toma_operativa;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_reporte_contratos']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_reporte_contratos']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), count(con_numero_contrato) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_reporte_contratos']['where_pesq']; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*), count(con_numero_contrato) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_reporte_contratos']['where_pesq']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_reporte_contratos']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_reporte_contratos']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $rt->fields[1] = (string)$rt->fields[1]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_reporte_contratos']['tot_geral'][2] = $rt->fields[1]; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_reporte_contratos']['contr_total_geral'] = "OK";
   } 

   //-----  con_fecha
   function quebra_con_fecha_sc_free_group_by($con_fecha, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb, $con_condicion_contrato, $con_tipo_servicio, $con_ruta, $con_estado, $con_toma_administrativa, $con_toma_operativa;
      $tot_con_fecha = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), count(con_numero_contrato) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_reporte_contratos']['where_pesq']; 
      ...
      $tot_con_fecha[0] = NM_encode_input(sc_strip_script($con_fecha)) ; 
      $tot_con_fecha[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_con_fecha[2] = (string)$rt->fields[1]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_con_fecha;
   } 

   //-----  con_cedula
   function quebra_con_cedula_sc_free_group_by($con_cedula, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb, $con_condicion_contrato, $con_tipo_servicio, $con_ruta, $con_estado, $con_toma_administrativa, $con_toma_operativa;
      $tot_con_cedula = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), count(con_numero_contrato) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_reporte_contratos']['where_pesq']; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_reporte_contratos']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
          $tot_con_cedula[0] = NM_encode_input(sc_strip_script($con_cedula));
      }
      else {
          $tot_con_cedula[0] = sc_strip_script($con_cedula) ; 
      }
      $tot_con_cedula[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_con_cedula[2] = (string)$rt->fields[1]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_con_cedula;
   } 

   //-----  con_condicion_contrato
   function quebra_con_condicion_contrato_sc_free_group_by($con_condicion_contrato, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb, $con_condicion_contrato, $con_tipo_servicio, $con_ruta, $con_estado, $con_toma_administrativa, $con_toma_operativa;
      $tot_con_condicion_contrato = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), count(con_numero_contrato) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_reporte_contratos']['where_pesq']; 
      } 
      ...
      $tot_con_condicion_contrato[0] = NM_encode_input(sc_strip_script($con_condicion_contrato)) ; 
      $tot_con_condicion_contrato[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_con_condicion_contrato[2] = (string)$rt->fields[1]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_con_condicion_contrato;
   } 
   ...
   //-----  con_estado
   function quebra_con_estado_sc_free_group_by($con_estado, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb, $con_condicion_contrato, $con_tipo_servicio, $con_ruta, $con_estado, $con_toma_administrativa, $con_toma_operativa;
      $tot_con_estado = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), count(con_numero_contrato) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_reporte_contratos']['where_pesq']; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_reporte_contratos']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
          $tot_con_estado[0] = NM_encode_input(sc_strip_script($con_estado));
      }
      else {
          $tot_con_estado[0] = sc_strip_script($con_estado) ; 
      }
      $tot_con_estado[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_con_estado[2] = (string)$rt->fields[1]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_con_estado;
   } 
