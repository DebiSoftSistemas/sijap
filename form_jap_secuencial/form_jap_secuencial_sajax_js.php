  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_jap_secuencial" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_jap_secuencial_form();
	}
...
?>
  ...
  // ---------- Validate sec_id_
  function do_ajax_form_jap_secuencial_validate_sec_id_(iNumLinha)
  {
    var nomeCampo_sec_id_ = "sec_id_" + iNumLinha;
    var var_sec_id_ = scAjaxGetFieldHidden(nomeCampo_sec_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_secuencial_validate_sec_id_(var_sec_id_, iNumLinha, var_script_case_init, do_ajax_form_jap_secuencial_validate_sec_id__cb);
  } // do_ajax_form_jap_secuencial_validate_sec_id_

  function do_ajax_form_jap_secuencial_validate_sec_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "sec_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "sec_id_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "sec_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "sec_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_secuencial_validate_sec_id__cb

  // ---------- Validate sec_empresa_
  function do_ajax_form_jap_secuencial_validate_sec_empresa_(iNumLinha)
  {
    var nomeCampo_sec_empresa_ = "sec_empresa_" + iNumLinha;
    var var_sec_empresa_ = scAjaxGetFieldText(nomeCampo_sec_empresa_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_secuencial_validate_sec_empresa_(var_sec_empresa_, iNumLinha, var_script_case_init, do_ajax_form_jap_secuencial_validate_sec_empresa__cb);
  } // do_ajax_form_jap_secuencial_validate_sec_empresa_

  function do_ajax_form_jap_secuencial_validate_sec_empresa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "sec_empresa_" + iLineNumber;
    }
    else
    {
      sFieldValid = "sec_empresa_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "sec_empresa_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "sec_empresa_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_secuencial_validate_sec_empresa__cb

  // ---------- Validate sec_secuencial_
  function do_ajax_form_jap_secuencial_validate_sec_secuencial_(iNumLinha)
  {
    var nomeCampo_sec_secuencial_ = "sec_secuencial_" + iNumLinha;
    var var_sec_secuencial_ = scAjaxGetFieldSelect(nomeCampo_sec_secuencial_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_secuencial_validate_sec_secuencial_(var_sec_secuencial_, iNumLinha, var_script_case_init, do_ajax_form_jap_secuencial_validate_sec_secuencial__cb);
  } // do_ajax_form_jap_secuencial_validate_sec_secuencial_

  function do_ajax_form_jap_secuencial_validate_sec_secuencial__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "sec_secuencial_" + iLineNumber;
    }
    else
    {
      sFieldValid = "sec_secuencial_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "sec_secuencial_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "sec_secuencial_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_secuencial_validate_sec_secuencial__cb

  // ---------- Validate sec_valor_
  function do_ajax_form_jap_secuencial_validate_sec_valor_(iNumLinha)
  {
    var nomeCampo_sec_valor_ = "sec_valor_" + iNumLinha;
    var var_sec_valor_ = scAjaxGetFieldText(nomeCampo_sec_valor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_secuencial_validate_sec_valor_(var_sec_valor_, iNumLinha, var_script_case_init, do_ajax_form_jap_secuencial_validate_sec_valor__cb);
  } // do_ajax_form_jap_secuencial_validate_sec_valor_

  function do_ajax_form_jap_secuencial_validate_sec_valor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "sec_valor_" + iLineNumber;
    }
    else
    {
      sFieldValid = "sec_valor_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "sec_valor_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "sec_valor_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_secuencial_validate_sec_valor__cb

  // ---------- Validate sec_incremento_
  function do_ajax_form_jap_secuencial_validate_sec_incremento_(iNumLinha)
  {
    var nomeCampo_sec_incremento_ = "sec_incremento_" + iNumLinha;
    var var_sec_incremento_ = scAjaxGetFieldText(nomeCampo_sec_incremento_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_secuencial_validate_sec_incremento_(var_sec_incremento_, iNumLinha, var_script_case_init, do_ajax_form_jap_secuencial_validate_sec_incremento__cb);
  } // do_ajax_form_jap_secuencial_validate_sec_incremento_

  function do_ajax_form_jap_secuencial_validate_sec_incremento__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "sec_incremento_" + iLineNumber;
    }
    else
    {
      sFieldValid = "sec_incremento_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "sec_incremento_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "sec_incremento_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_jap_secuencial_validate_sec_incremento__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_jap_secuencial_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_jap_secuencial_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_jap_secuencial_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_jap_secuencial_add_new_line_cb);
  } // do_ajax_form_jap_secuencial_add_new_line

  function do_ajax_form_jap_secuencial_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_jap_secuencial_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_jap_secuencial_backup_line(iNumLinha)
  {
    var var_sec_id_ = scAjaxGetFieldHidden("sec_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_jap_secuencial_backup_line(var_sec_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_jap_secuencial_backup_line_cb);
  } // do_ajax_form_jap_secuencial_backup_line

  function do_ajax_form_jap_secuencial_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_jap_secuencial_backup_line_cb

  function do_ajax_form_jap_secuencial_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_jap_secuencial_cancel_insert

  function do_ajax_form_jap_secuencial_cancel_update(iSeqVert)
  {
    do_ajax_form_jap_secuencial_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_jap_secuencial_cancel_update

  function do_ajax_form_jap_secuencial_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_jap_secuencial_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_jap_secuencial_table_refresh()
  {
    var var_sec_id_ = document.F2.sec_id_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_jap_secuencial_table_refresh(var_sec_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jap_secuencial_table_refresh_cb);
  } //  do_ajax_form_jap_secuencial_table_refresh

  function do_ajax_form_jap_secuencial_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.sec_id_.value = scAjaxGetKeyValue("sec_id_");
    ...
    scAjaxAlert(do_ajax_form_jap_secuencial_table_refresh_cb_after_alert);
  } // do_ajax_form_jap_secuencial_table_refresh_cb
  function do_ajax_form_jap_secuencial_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_jap_secuencial_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_jap_secuencial_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_jap_secuencial_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_sec_id_ = scAjaxGetFieldHidden("sec_id_" + iNumLinha);
    var var_sec_empresa_ = scAjaxGetFieldText("sec_empresa_" + iNumLinha);
    var var_sec_secuencial_ = scAjaxGetFieldSelect("sec_secuencial_" + iNumLinha);
    var var_sec_valor_ = scAjaxGetFieldText("sec_valor_" + iNumLinha);
    var var_sec_incremento_ = scAjaxGetFieldText("sec_incremento_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_jap_secuencial_submit_form(var_sec_id_, var_sec_empresa_, var_sec_secuencial_, var_sec_valor_, var_sec_incremento_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_jap_secuencial_submit_form_cb);
  } // do_ajax_form_jap_secuencial_submit_form

  function do_ajax_form_jap_secuencial_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("sec_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("sec_empresa_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("sec_secuencial_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("sec_valor_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("sec_incremento_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_jap_secuencial_submit_form_cb_after_alert);
  } // do_ajax_form_jap_secuencial_submit_form_cb
  function do_ajax_form_jap_secuencial_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_jap_secuencial_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_jap_secuencial_navigate_form()
  {
    perform_ajax_form_jap_secuencial_navigate_form();
  }

  function perform_ajax_form_jap_secuencial_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_jap_secuencial_cancel_insert(sc_form_jap_secuencial_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("sec_id_" + iNavForm);
      scAjaxHideErrorDisplay("sec_empresa_" + iNavForm);
      scAjaxHideErrorDisplay("sec_secuencial_" + iNavForm);
      scAjaxHideErrorDisplay("sec_valor_" + iNavForm);
      scAjaxHideErrorDisplay("sec_incremento_" + iNavForm);
    }
    var var_sec_id_ = document.F2.sec_id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_jap_secuencial_navigate_form(var_sec_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_jap_secuencial_navigate_form_cb);
  } // do_ajax_form_jap_secuencial_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_jap_secuencial']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_jap_secuencial_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.sec_id_.value = scAjaxGetKeyValue("sec_id_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_jap_secuencial_navigate_form_cb_after_alert);
  } // do_ajax_form_jap_secuencial_navigate_form_cb
  function do_ajax_form_jap_secuencial_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_jap_secuencial_navigate_form_cb_after_alert

    function sc_form_jap_secuencial_get_last_line_number()
    {
    ...
    } //sc_form_jap_secuencial_get_last_line_number

  function sc_hide_form_jap_secuencial_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "sec_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "sec_empresa_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "sec_secuencial_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "sec_valor_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "sec_incremento_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["sec_id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_id'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["sec_empresa_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_empresa'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["sec_secuencial_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_secuencial'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["sec_valor_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_valor'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["sec_incremento_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_incremento'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["sec_id_"][iNumLinha] = "sec_id_" + iNumLinha;
    ajax_field_mult["sec_empresa_"][iNumLinha] = "sec_empresa_" + iNumLinha;
    ajax_field_mult["sec_secuencial_"][iNumLinha] = "sec_secuencial_" + iNumLinha;
    ajax_field_mult["sec_valor_"][iNumLinha] = "sec_valor_" + iNumLinha;
    ajax_field_mult["sec_incremento_"][iNumLinha] = "sec_incremento_" + iNumLinha;
    ajax_field_id["sec_secuencial_" + iNumLinha] = new Array("hidden_field_label_sec_secuencial_", "hidden_field_data_sec_secuencial_" + iNumLinha);
    ajax_field_id["sec_valor_" + iNumLinha] = new Array("hidden_field_label_sec_valor_", "hidden_field_data_sec_valor_" + iNumLinha);
    ajax_field_id["sec_incremento_" + iNumLinha] = new Array("hidden_field_label_sec_incremento_", "hidden_field_data_sec_incremento_" + iNumLinha);
    ajax_error_count["sec_id_" + iNumLinha] = "off";
    ajax_error_count["sec_empresa_" + iNumLinha] = "off";
    ajax_error_count["sec_secuencial_" + iNumLinha] = "off";
    ajax_error_count["sec_valor_" + iNumLinha] = "off";
    ajax_error_count["sec_incremento_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["sec_id_" + iNumLinha] = "on";
    ajax_read_only["sec_empresa_" + iNumLinha] = "off";
    ajax_read_only["sec_secuencial_" + iNumLinha] = "off";
    ajax_read_only["sec_valor_" + iNumLinha] = "off";
    ajax_read_only["sec_incremento_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["sec_id_" + iNumLinha] = "on";
    ajax_read_only["sec_empresa_" + iNumLinha] = "on";
    ajax_read_only["sec_secuencial_" + iNumLinha] = "on";
    ajax_read_only["sec_valor_" + iNumLinha] = "on";
    ajax_read_only["sec_incremento_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["sec_id_" + iNumLinha] = null;
    ajax_error_list["sec_empresa_" + iNumLinha] = null;
    ajax_error_list["sec_secuencial_" + iNumLinha] = null;
    ajax_error_list["sec_valor_" + iNumLinha] = null;
    ajax_error_list["sec_incremento_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "sec_id_": new Array(),
    "sec_empresa_": new Array(),
    "sec_secuencial_": new Array(),
    "sec_valor_": new Array(),
    "sec_incremento_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["sec_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["sec_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["sec_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["sec_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["sec_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["sec_empresa_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["sec_empresa_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["sec_empresa_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["sec_empresa_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["sec_empresa_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["sec_secuencial_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["sec_secuencial_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["sec_secuencial_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["sec_secuencial_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["sec_secuencial_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["sec_valor_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["sec_valor_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["sec_valor_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["sec_valor_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["sec_valor_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["sec_incremento_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["sec_incremento_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["sec_incremento_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["sec_incremento_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["sec_incremento_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['sec_id_'])) ? $this->nmgp_cmp_readonly['sec_id_'] : 'on';
?>
    scAjaxFieldRead("sec_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['sec_empresa_'])) ? $this->nmgp_cmp_readonly['sec_empresa_'] : 'off';
?>
    scAjaxFieldRead("sec_empresa_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['sec_secuencial_'])) ? $this->nmgp_cmp_readonly['sec_secuencial_'] : 'off';
?>
    scAjaxFieldRead("sec_secuencial_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['sec_valor_'])) ? $this->nmgp_cmp_readonly['sec_valor_'] : 'off';
?>
    scAjaxFieldRead("sec_valor_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['sec_incremento_'])) ? $this->nmgp_cmp_readonly['sec_incremento_'] : 'off';
?>
    scAjaxFieldRead("sec_incremento_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("sec_id_" + iSeq, "on");
    scAjaxFieldRead("sec_empresa_" + iSeq, "on");
    scAjaxFieldRead("sec_secuencial_" + iSeq, "on");
    scAjaxFieldRead("sec_valor_" + iSeq, "on");
    scAjaxFieldRead("sec_incremento_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["sec_id_" + iRow] || "on" == ajax_error_count["sec_empresa_" + iRow] || "on" == ajax_error_count["sec_secuencial_" + iRow] || "on" == ajax_error_count["sec_valor_" + iRow] || "on" == ajax_error_count["sec_incremento_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sec_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sec_empresa_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sec_secuencial_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sec_valor_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sec_incremento_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["sec_id_" + iRow] && "off" == ajax_error_count["sec_empresa_" + iRow] && "off" == ajax_error_count["sec_secuencial_" + iRow] && "off" == ajax_error_count["sec_valor_" + iRow] && "off" == ajax_error_count["sec_incremento_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["sec_id_" + iRow] = "off";
        ajax_error_count["sec_empresa_" + iRow] = "off";
        ajax_error_count["sec_secuencial_" + iRow] = "off";
        ajax_error_count["sec_valor_" + iRow] = "off";
        ajax_error_count["sec_incremento_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_sec_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_sec_empresa_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_sec_secuencial_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_sec_valor_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_sec_incremento_" + iRow).removeClass("scFormErrorLine");
    }
  }
