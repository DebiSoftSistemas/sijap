...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "con_propietario";$Nm_numeric[] = "con_sector";$Nm_numeric[] = "con_propietario";$Nm_numeric[] = "con_sector";
...
?>
   <span id="idAjaxSelect_con_sector">
      <SELECT class="scFilterObjectOdd" id="SC_con_sector" name="con_sector[]"  size="7" multiple>
<?php
...
?>
 ...
 function limpa_form()
 {
   ...
   {
      if (document.F1.elements[i].name == 'con_sector[]')
      {
