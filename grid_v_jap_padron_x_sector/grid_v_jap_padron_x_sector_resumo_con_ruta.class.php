...
SCEOT;
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_sector']['pesq_tab_label']))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_sector']['pesq_tab_label'] .= "con_ruta?#?" . "" . $this->Ini->Nm_lang['lang_ruta'] . "" . "?@?";
      }
      ...
      {
          $this->array_total_con_ruta = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_sector']['arr_total']['con_ruta'];
      }
      else
      {
          $this->array_total_con_ruta = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_sector']['arr_total']['con_ruta'] = $this->array_total_con_ruta;
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_sector']['labels']['con_ruta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_sector']['labels']['con_ruta'] = "" . $this->Ini->Nm_lang['lang_ruta'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_sector']['labels']['cl_tipo_identificacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_sector']['labels']['cl_tipo_identificacion'] = "" . $this->Ini->Nm_lang['lang_tipo_identificacion'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_sector']['labels']['cl_identificacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_sector']['labels']['cl_identificacion'] = "" . $this->Ini->Nm_lang['lang_lot_tipoid'] . ""; 
       }
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_sector']['labels']['cl_email'] = "" . $this->Ini->Nm_lang['lang_email'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_sector']['labels']['cl_telefono']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_sector']['labels']['cl_telefono'] = "" . $this->Ini->Nm_lang['lang_lot_telefono'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_sector']['labels']['cl_celular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_sector']['labels']['cl_celular'] = "" . $this->Ini->Nm_lang['lang_celular'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_sector']['labels']['con_empresa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_sector']['labels']['con_empresa'] = "" . $this->Ini->Nm_lang['lang_empresa'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_sector']['labels']['con_propietario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_sector']['labels']['con_propietario'] = "" . $this->Ini->Nm_lang['lang_id'] . ""; 
       }
       //-----
       $this->comp_field_nm = array(
           'con_ruta' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_sector']['summarizing_fields_order']['con_ruta']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_sector']['summarizing_fields_order']['con_ruta'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_sector']['summarizing_fields_order']['con_ruta'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_sector']['summarizing_fields_display']['con_ruta'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_sector']['summarizing_fields_display']['con_ruta'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_sector']['summarizing_fields_display']['con_ruta'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_sector']['summarizing_fields_display']['con_ruta'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_sector']['summarizing_fields_display']['con_ruta'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_sector']['summarizing_fields_display']['con_ruta'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_sector']['summarizing_fields_display']['con_ruta'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_con_ruta as $i_con_ruta => $d_con_ruta) {
           if (!isset($i_con_ruta, $this->comp_label[0]) || !in_array($i_con_ruta, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_con_ruta[2] ] = $d_con_ruta[1];
               $this->comp_label[0][ $d_con_ruta[2] ] = $d_con_ruta[1];
           }
       }
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_con_ruta => $l_con_ruta) {
           if (isset($this->array_total_con_ruta[$i_con_ruta])) {
               $this->comp_group[$i_con_ruta] = array();
           }
       }
     }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_con_ruta;
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_sector']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_sector']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_con_ruta("res", $this->NM_export);
      ...
      if (is_array($this->array_total_con_ruta)) {
          ksort($this->array_total_con_ruta);
      }
   }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_sector']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_v_jap_padron_x_sector_jquery_5200.js\"></script>\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "grid_v_jap_padron_x_sector/grid_v_jap_padron_x_sector_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid&nm_all_modules=grid&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + P)", "thickbox", "" . $this->Ini->path_link . "grid_v_jap_padron_x_sector/grid_v_jap_padron_x_sector_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid&nm_all_modules=grid&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
...
{ 
   ...
   {
      //----- con_ruta
      if (!isset($this->array_total_con_ruta[$quebra_con_ruta_orig]))
      {
         $this->array_total_con_ruta[$quebra_con_ruta_orig][0] = 1;
         $this->array_total_con_ruta[$quebra_con_ruta_orig][1] = $quebra_con_ruta;
         $this->array_total_con_ruta[$quebra_con_ruta_orig][2] = $quebra_con_ruta_orig;
      }
      else
      {
         $this->array_total_con_ruta[$quebra_con_ruta_orig][0]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('con_ruta', 'con_ruta');
     $campos_order = $this->Ini->Get_date_order_groupby("con_ruta", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->cl_email = $rs_res->fields[6] ;  
            $this->cl_telefono = $rs_res->fields[7] ;  
            $this->cl_celular = $rs_res->fields[8] ;  
...
//
   ...
   function grid_search_con_ruta($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_sector']['psq_check_ret']['con_ruta'] = array();
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_jap_padron_x_sector']['psq_check_ret']['con_ruta'][] = trim($rs->fields[0]);
