<?php
@session_start() ;
$_SESSION['scriptcase']['grid_v_jap_padron_x_sector']['sc_process_barr'] = true;
require_once('../grid_v_jap_padron_x_sector/index.php');
unset($_SESSION['scriptcase']['grid_v_jap_padron_x_sector']['sc_process_barr']);
$ExportCtrl = new grid_v_jap_padron_x_sector_export_control;
$ExportCtrl->Export_barr();

class grid_v_jap_padron_x_sector_export_control
{
