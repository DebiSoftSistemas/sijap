...
class grid_jap_rutas_medicion_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_jap_rutas_medicion_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_jap_rutas_medicion_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_jap_rutas_medicion_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_rut_empresa')
      {
          $rut_empresa = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_rut_empresa($rut_empresa);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_rut_nombre')
      {
          $rut_nombre = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_rut_nombre($rut_nombre);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_rut_estado')
      {
          $rut_estado = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_rut_estado($rut_estado);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$campo_join]);
              return;
          }
         $nm_ini_lower = "";
         $nm_fim_lower = "";
      ...
      else
      {
         ...
         $nome_sum = "jap_rutas_medicion.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_ruta'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_jap_rutas_medicion/grid_jap_rutas_medicion_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_jap_rutas_medicion_ajax_search.js"></script>
 <script type="text/javascript" src="grid_jap_rutas_medicion_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_jap_rutas_medicion_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_jap_rutas_medicion']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_jap_rutas_medicion']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_rut_id_cond#NMF#' + search_get_sel_txt('SC_rut_id_cond') + '@NMF@';
  str_out += 'SC_rut_id#NMF#' + search_get_text('SC_rut_id') + '@NMF@';
  str_out += 'SC_rut_empresa_cond#NMF#' + search_get_sel_txt('SC_rut_empresa_cond') + '@NMF@';
  str_out += 'SC_rut_empresa#NMF#' + search_get_text('SC_rut_empresa') + '@NMF@';
  str_out += 'id_ac_rut_empresa#NMF#' + search_get_title('select2-id_ac_rut_empresa-container') + '@NMF@';
  str_out += 'SC_rut_nombre_cond#NMF#' + search_get_sel_txt('SC_rut_nombre_cond') + '@NMF@';
  str_out += 'SC_rut_nombre#NMF#' + search_get_text('SC_rut_nombre') + '@NMF@';
  str_out += 'id_ac_rut_nombre#NMF#' + search_get_title('select2-id_ac_rut_nombre-container') + '@NMF@';
  str_out += 'SC_rut_estado_cond#NMF#' + search_get_sel_txt('SC_rut_estado_cond') + '@NMF@';
  str_out += 'SC_rut_estado#NMF#' + search_get_text('SC_rut_estado') + '@NMF@';
  str_out += 'id_ac_rut_estado#NMF#' + search_get_title('select2-id_ac_rut_estado-container') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-rut_nombre").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_rut_nombre",
      max_itens: "10",
   ...
   $("#SC_rut_nombre").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-rut_estado").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_rut_estado",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_rut_estado").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-rut_empresa").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_rut_empresa",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_rut_empresa").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      global 
             $rut_id_cond, $rut_id,
             $rut_empresa_cond, $rut_empresa, $rut_empresa_autocomp,
             $rut_nombre_cond, $rut_nombre, $rut_nombre_autocomp,
             $rut_estado_cond, $rut_estado, $rut_estado_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $rut_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['campos_busca']['rut_id']; 
          $rut_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['campos_busca']['rut_id_cond']; 
          $rut_empresa = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['campos_busca']['rut_empresa']; 
          $rut_empresa_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['campos_busca']['rut_empresa_cond']; 
          $rut_nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['campos_busca']['rut_nombre']; 
          $rut_nombre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['campos_busca']['rut_nombre_cond']; 
          $rut_estado = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['campos_busca']['rut_estado']; 
          $rut_estado_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['campos_busca']['rut_estado_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['campos_busca']['NM_operador']; 
          if (strtoupper($rut_id_cond) != "II" && strtoupper($rut_id_cond) != "QP" && strtoupper($rut_id_cond) != "NP" && strtoupper($rut_id_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($rut_id, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($rut_id_cond) || empty($rut_id_cond))
      {
         $rut_id_cond = "gt";
      }
      ...
      if (!isset($rut_nombre_cond) || empty($rut_nombre_cond))
      {
         $rut_nombre_cond = "qp";
      }
      if (!isset($rut_estado_cond) || empty($rut_estado_cond))
      {
         $rut_estado_cond = "qp";
      }
      ...
      $str_hide_rut_id = (in_array($rut_id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_rut_empresa = (in_array($rut_empresa_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_rut_nombre = (in_array($rut_nombre_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_rut_estado = (in_array($rut_estado_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($rut_id) || $rut_id == "")
      {
          $rut_id = "";
      }
      if (isset($rut_id) && !empty($rut_id))
      {
         $tmp_pos = (is_string($rut_id)) ? strpos($rut_id, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $rut_id = substr($rut_id, 0, $tmp_pos);
         }
      }
      if (!isset($rut_empresa) || $rut_empresa == "")
      {
          $rut_empresa = "";
      }
      if (isset($rut_empresa) && !empty($rut_empresa))
      {
         $tmp_pos = (is_string($rut_empresa)) ? strpos($rut_empresa, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $rut_empresa = substr($rut_empresa, 0, $tmp_pos);
         }
      }
      if (!isset($rut_nombre) || $rut_nombre == "")
      {
          $rut_nombre = "";
      }
      if (isset($rut_nombre) && !empty($rut_nombre))
      {
         $tmp_pos = (is_string($rut_nombre)) ? strpos($rut_nombre, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $rut_nombre = substr($rut_nombre, 0, $tmp_pos);
         }
      }
      if (!isset($rut_estado) || $rut_estado == "")
      {
          $rut_estado = "";
      }
      if (isset($rut_estado) && !empty($rut_estado))
      {
         $tmp_pos = (is_string($rut_estado)) ? strpos($rut_estado, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $rut_estado = substr($rut_estado, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_rut_id_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['rut_id'])) ? $this->New_label['rut_id'] : "" . $this->Ini->Nm_lang['lang_id'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_rut_id_cond" name="rut_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_rut_id'), this, 'rut_id')">
       <OPTION value="gt" <?php if ("gt" == $rut_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $rut_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $rut_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_rut_id" <?php echo $str_hide_rut_id?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['rut_id'])) ? $this->New_label['rut_id'] : "" . $this->Ini->Nm_lang['lang_id'] . "";
 $nmgp_tab_label .= "rut_id?#?" . $SC_Label . "?@?";
...
?>
<INPUT  type="text" id="SC_rut_id" name="rut_id" value="<?php echo NM_encode_input($rut_id) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_rut_empresa_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['rut_empresa'])) ? $this->New_label['rut_empresa'] : "" . $this->Ini->Nm_lang['lang_empresa'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_rut_empresa_cond" name="rut_empresa_cond" onChange="nm_campos_between(document.getElementById('id_vis_rut_empresa'), this, 'rut_empresa')">
       <OPTION value="qp" <?php if ("qp" == $rut_empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $rut_empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $rut_empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $rut_empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_rut_empresa" <?php echo $str_hide_rut_empresa?> valign="top">
 ...
 $nmgp_tab_label .= "rut_empresa?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $rut_empresa;
      }
?>
<INPUT  type="text" id="SC_rut_empresa" name="rut_empresa" value="<?php echo NM_encode_input($rut_empresa) ?>"  size=13 alt="{datatype: 'text', maxLength: 13, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-rut_empresa" id="id_ac_rut_empresa" name="rut_empresa_autocomp"><?php if ('' !=  $rut_empresa) { ?><option value="<?php echo $rut_empresa ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_rut_nombre_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['rut_nombre'])) ? $this->New_label['rut_nombre'] : "" . $this->Ini->Nm_lang['lang_ruta'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_rut_nombre_cond" name="rut_nombre_cond" onChange="nm_campos_between(document.getElementById('id_vis_rut_nombre'), this, 'rut_nombre')">
       <OPTION value="qp" <?php if ("qp" == $rut_nombre_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $rut_nombre_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $rut_nombre_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $rut_nombre_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_rut_nombre" <?php echo $str_hide_rut_nombre?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['rut_nombre'])) ? $this->New_label['rut_nombre'] : "" . $this->Ini->Nm_lang['lang_ruta'] . "";
 $nmgp_tab_label .= "rut_nombre?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $rut_nombre;
      }
?>
<INPUT  type="text" id="SC_rut_nombre" name="rut_nombre" value="<?php echo NM_encode_input($rut_nombre) ?>"  size=50 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-rut_nombre" id="id_ac_rut_nombre" name="rut_nombre_autocomp"><?php if ('' !=  $rut_nombre) { ?><option value="<?php echo $rut_nombre ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_rut_estado_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['rut_estado'])) ? $this->New_label['rut_estado'] : "" . $this->Ini->Nm_lang['lang_estado'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_rut_estado_cond" name="rut_estado_cond" onChange="nm_campos_between(document.getElementById('id_vis_rut_estado'), this, 'rut_estado')">
       <OPTION value="qp" <?php if ("qp" == $rut_estado_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $rut_estado_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $rut_estado_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $rut_estado_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_rut_estado" <?php echo $str_hide_rut_estado?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['rut_estado'])) ? $this->New_label['rut_estado'] : "" . $this->Ini->Nm_lang['lang_estado'] . "";
 $nmgp_tab_label .= "rut_estado?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $rut_estado;
      }
?>
<INPUT  type="text" id="SC_rut_estado" name="rut_estado" value="<?php echo NM_encode_input($rut_estado) ?>"  size=2 alt="{datatype: 'text', maxLength: 2, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-rut_estado" id="id_ac_rut_estado" name="rut_estado_autocomp"><?php if ('' !=  $rut_estado) { ?><option value="<?php echo $rut_estado ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_jap_rutas_medicion_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_jap_rutas_medicion']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_jap_rutas_medicion']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.rut_id_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_rut_id'), document.F1.rut_id_cond, 'rut_id');
   document.F1.rut_id.value = "";
   document.F1.rut_empresa_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_rut_empresa'), document.F1.rut_empresa_cond, 'rut_empresa');
   document.F1.rut_empresa.value = "";
   document.F1.rut_empresa_autocomp.value = "";
   $('#select2-id_ac_rut_empresa-container').html('<?php echo $this->Val_init_rut_empresa['desc'] ?>');;
   document.F1.rut_nombre_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_rut_nombre'), document.F1.rut_nombre_cond, 'rut_nombre');
   document.F1.rut_nombre.value = "";
   document.F1.rut_nombre_autocomp.value = "";
   $('#select2-id_ac_rut_nombre-container').html('<?php echo $this->Val_init_rut_nombre['desc'] ?>');;
   document.F1.rut_estado_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_rut_estado'), document.F1.rut_estado_cond, 'rut_estado');
   document.F1.rut_estado.value = "";
   document.F1.rut_estado_autocomp.value = "";
   $('#select2-id_ac_rut_estado-container').html('<?php echo $this->Val_init_rut_estado['desc'] ?>');;
   Sc_carga_select2('all');
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_jap_rutas_medicion/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_rut_id_cond'] = 'cond';
      $tp_fields['SC_rut_id'] = 'text';
      $tp_fields['SC_rut_empresa_cond'] = 'cond';
      $tp_fields['SC_rut_empresa'] = 'text_aut';
      $tp_fields['id_ac_rut_empresa'] = 'select2_aut';
      $tp_fields['SC_rut_nombre_cond'] = 'cond';
      $tp_fields['SC_rut_nombre'] = 'text_aut';
      $tp_fields['id_ac_rut_nombre'] = 'select2_aut';
      $tp_fields['SC_rut_estado_cond'] = 'cond';
      $tp_fields['SC_rut_estado'] = 'text_aut';
      $tp_fields['id_ac_rut_estado'] = 'select2_aut';
   ...
   {
      global $rut_id_cond, $rut_id,
             $rut_empresa_cond, $rut_empresa, $rut_empresa_autocomp,
             $rut_nombre_cond, $rut_nombre, $rut_nombre_autocomp,
             $rut_estado_cond, $rut_estado, $rut_estado_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($rut_empresa_autocomp) && empty($rut_empresa))
      {
          $rut_empresa = $rut_empresa_autocomp;
      }
      if (!empty($rut_nombre_autocomp) && empty($rut_nombre))
      {
          $rut_nombre = $rut_nombre_autocomp;
      }
      if (!empty($rut_estado_autocomp) && empty($rut_estado))
      {
          $rut_estado = $rut_estado_autocomp;
      }
      $rut_id_cond_salva = $rut_id_cond; 
      if (!isset($rut_id_input_2) || $rut_id_input_2 == "")
      {
          $rut_id_input_2 = $rut_id;
      }
      $rut_empresa_cond_salva = $rut_empresa_cond; 
      if (!isset($rut_empresa_input_2) || $rut_empresa_input_2 == "")
      {
          $rut_empresa_input_2 = $rut_empresa;
      }
      $rut_nombre_cond_salva = $rut_nombre_cond; 
      if (!isset($rut_nombre_input_2) || $rut_nombre_input_2 == "")
      {
          $rut_nombre_input_2 = $rut_nombre;
      }
      $rut_estado_cond_salva = $rut_estado_cond; 
      if (!isset($rut_estado_input_2) || $rut_estado_input_2 == "")
      {
          $rut_estado_input_2 = $rut_estado;
      }
      if ($rut_id_cond != "in")
      {
          nm_limpa_numero($rut_id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['campos_busca']['rut_id'] = $rut_id; 
      if (is_array($rut_id) && !empty($rut_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['Grid_search'][$I_Grid]['val'][0] = $rut_id;
      }
      elseif ($rut_id_cond_salva == "nu" || $rut_id_cond_salva == "nn" || $rut_id_cond_salva == "ep" || $rut_id_cond_salva == "ne" || !empty($rut_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['Grid_search'][$I_Grid]['val'][0][0] = $rut_id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['campos_busca']['rut_id_cond'] = $rut_id_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['Grid_search'][$I_Grid]['cmp'] = "rut_id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['Grid_search'][$I_Grid]['opc'] = $rut_id_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq']['rut_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['campos_busca']['rut_empresa'] = $rut_empresa; 
      if (is_array($rut_empresa) && !empty($rut_empresa))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['Grid_search'][$I_Grid]['val'][0] = $rut_empresa;
      }
      elseif ($rut_empresa_cond_salva == "nu" || $rut_empresa_cond_salva == "nn" || $rut_empresa_cond_salva == "ep" || $rut_empresa_cond_salva == "ne" || !empty($rut_empresa))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['Grid_search'][$I_Grid]['val'][0][0] = $rut_empresa;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['campos_busca']['rut_empresa_cond'] = $rut_empresa_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['Grid_search'][$I_Grid]['cmp'] = "rut_empresa"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['Grid_search'][$I_Grid]['opc'] = $rut_empresa_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq']['rut_empresa'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['campos_busca']['rut_nombre'] = $rut_nombre; 
      if (is_array($rut_nombre) && !empty($rut_nombre))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['Grid_search'][$I_Grid]['val'][0] = $rut_nombre;
      }
      elseif ($rut_nombre_cond_salva == "nu" || $rut_nombre_cond_salva == "nn" || $rut_nombre_cond_salva == "ep" || $rut_nombre_cond_salva == "ne" || !empty($rut_nombre))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['Grid_search'][$I_Grid]['val'][0][0] = $rut_nombre;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['campos_busca']['rut_nombre_cond'] = $rut_nombre_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['Grid_search'][$I_Grid]['cmp'] = "rut_nombre"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['Grid_search'][$I_Grid]['opc'] = $rut_nombre_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq']['rut_nombre'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['campos_busca']['rut_estado'] = $rut_estado; 
      if (is_array($rut_estado) && !empty($rut_estado))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['Grid_search'][$I_Grid]['val'][0] = $rut_estado;
      }
      elseif ($rut_estado_cond_salva == "nu" || $rut_estado_cond_salva == "nn" || $rut_estado_cond_salva == "ep" || $rut_estado_cond_salva == "ne" || !empty($rut_estado))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['Grid_search'][$I_Grid]['val'][0][0] = $rut_estado;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['campos_busca']['rut_estado_cond'] = $rut_estado_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['Grid_search'][$I_Grid]['cmp'] = "rut_estado"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['Grid_search'][$I_Grid]['opc'] = $rut_estado_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['grid_pesq']['rut_estado'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $this->cmp_formatado['rut_id'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($rut_empresa != '') {
      $rut_empresa_look = (is_string($rut_empresa) ? substr($this->Db->qstr($rut_empresa), 1, -1) : $rut_empresa); 
      $nmgp_def_dados = array(); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['rut_empresa'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['rut_empresa'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['rut_empresa'] = $rut_empresa;
      }
      $nmgp_def_dados = array();
    if ($rut_nombre != '') {
      $rut_nombre_look = (is_string($rut_nombre) ? substr($this->Db->qstr($rut_nombre), 1, -1) : $rut_nombre); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['rut_nombre'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['rut_nombre'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['rut_nombre'] = $rut_nombre;
      }
      $nmgp_def_dados = array();
    if ($rut_estado != '') {
      $rut_estado_look = (is_string($rut_estado) ? substr($this->Db->qstr($rut_estado), 1, -1) : $rut_estado); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['rut_estado'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['rut_estado'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['rut_estado'] = $rut_estado;
      }

      //----- $rut_id
      $this->Date_part = false;
      if (isset($rut_id) || $rut_id_cond == "nu" || $rut_id_cond == "nn" || $rut_id_cond == "ep" || $rut_id_cond == "ne")
      {
         $this->monta_condicao("rut_id", $rut_id_cond, $rut_id, "", "rut_id", "INT4", false);
      }

      //----- $rut_empresa
      $this->Date_part = false;
      if (isset($rut_empresa) || $rut_empresa_cond == "nu" || $rut_empresa_cond == "nn" || $rut_empresa_cond == "ep" || $rut_empresa_cond == "ne")
      {
         $this->monta_condicao("rut_empresa", $rut_empresa_cond, $rut_empresa, "", "rut_empresa", "VARCHAR", false);
      }

      //----- $rut_nombre
      $this->Date_part = false;
      if (isset($rut_nombre) || $rut_nombre_cond == "nu" || $rut_nombre_cond == "nn" || $rut_nombre_cond == "ep" || $rut_nombre_cond == "ne")
      {
         $this->monta_condicao("rut_nombre", $rut_nombre_cond, $rut_nombre, "", "rut_nombre", "VARCHAR", false);
      }

      //----- $rut_estado
      $this->Date_part = false;
      if (isset($rut_estado) || $rut_estado_cond == "nu" || $rut_estado_cond == "nn" || $rut_estado_cond == "ep" || $rut_estado_cond == "ne")
      {
         $this->monta_condicao("rut_estado", $rut_estado_cond, $rut_estado, "", "rut_estado", "VARCHAR", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
    $this->Sel_case_sensitive($this->comando);
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_jap_rutas_medicion']['cond_pesq'] .= $this->NM_operador;
