...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "rut_id";$Nm_numeric[] = "rut_id";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_rut_id_cond" name="rut_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_rut_id'), this, 'rut_id')">
      ...
      <br><span id="id_hide_rut_id"  <?php echo $str_hide_rut_id?>><INPUT  type="text" id="SC_rut_id" name="rut_id" value="<?php echo NM_encode_input($rut_id) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_rut_empresa_cond" name="rut_empresa_cond" onChange="nm_campos_between(document.getElementById('id_vis_rut_empresa'), this, 'rut_empresa')">
      ...
      <br><span id="id_hide_rut_empresa"  <?php echo $str_hide_rut_empresa?>><?php
      if ($rut_empresa != "")
      {
      $rut_empresa_look = (is_string($rut_empresa) ? substr($this->Db->qstr($rut_empresa), 1, -1) : $rut_empresa); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_rut_nombre_cond" name="rut_nombre_cond" onChange="nm_campos_between(document.getElementById('id_vis_rut_nombre'), this, 'rut_nombre')">
      ...
      <br><span id="id_hide_rut_nombre"  <?php echo $str_hide_rut_nombre?>><?php
      if ($rut_nombre != "")
      {
      $rut_nombre_look = (is_string($rut_nombre) ? substr($this->Db->qstr($rut_nombre), 1, -1) : $rut_nombre); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_rut_estado_cond" name="rut_estado_cond" onChange="nm_campos_between(document.getElementById('id_vis_rut_estado'), this, 'rut_estado')">
      ...
      <br><span id="id_hide_rut_estado"  <?php echo $str_hide_rut_estado?>><?php
      if ($rut_estado != "")
      {
      $rut_estado_look = (is_string($rut_estado) ? substr($this->Db->qstr($rut_estado), 1, -1) : $rut_estado); 
      $nmgp_def_dados = array(); 
