...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_del_factura_anulacion"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIJAP_____grid_del_factura_anulacion"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_del_factura_anulacion']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_del_factura_anulacion']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_del_factura_anulacion']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_del_factura_anulacion']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_del_factura_anulacion']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_del_factura_anulacion</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_del_factura_anulacion']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_del_factura_anulacion']['embutida_filho'] as $ind => $sc_init)
          {
