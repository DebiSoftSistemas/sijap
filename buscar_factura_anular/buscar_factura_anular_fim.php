...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIJAP_____buscar_factura_anular"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIJAP_____buscar_factura_anular"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['buscar_factura_anular']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['buscar_factura_anular']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['buscar_factura_anular']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['buscar_factura_anular']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['buscar_factura_anular']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>buscar_factura_anular</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['buscar_factura_anular']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['buscar_factura_anular']['embutida_filho'] as $ind => $sc_init)
          {
